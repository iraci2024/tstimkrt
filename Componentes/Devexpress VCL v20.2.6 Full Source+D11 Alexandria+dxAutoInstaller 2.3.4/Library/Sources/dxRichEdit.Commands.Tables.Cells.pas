...
type
  ...
  protected
    ...
    procedure ChangeSelection(ACellToSelect: TdxTableCell);
  ...
  protected
    ...
    function GetUpdateCaretPositionBeforeChangeSelectionDetailsLevel
      : TdxDocumentLayoutDetailsLevel; override;
    function GetTreatStartPositionAsCurrent: Boolean; override;
    function CalculateNewPosition(AFirstCell: TdxTableCell)
      : TdxDocumentLogPosition;
    procedure SplitTableCellsHorizontally(ASelectedCells
      : TdxSelectedCellsCollection);
    procedure SplitTableCellsVertically(ASelectedCells
      : TdxSelectedCellsCollection);
    function GetColumnsCountForSplitVertically
      (AInterval: TdxSelectedCellsIntervalInRow): Integer;
    function CanChangePosition(const APos: TdxDocumentModelPosition)
      : Boolean; override;
    function ChangePosition(const APos: TdxDocumentModelPosition)
      : TdxDocumentLogPosition; override;
  ...
  public
    ...
    property CellsParameters: TdxSplitTableCellsParameters read FCellsParameters
      write FCellsParameters;
  end;
  ...
  private type
    TdxMask = (FirstSelectedRow, LastSelectedRow, FirstSelectedColumn,
      LastSelectedColumn);
  ...
  public
    ...
    property FirstSelectedRow: Boolean index TdxMask.FirstSelectedRow
      read GetItem write SetItem;
    property LastSelectedRow: Boolean index TdxMask.LastSelectedRow read GetItem
      write SetItem;
    property FirstSelectedColumn: Boolean index TdxMask.FirstSelectedColumn
      read GetItem write SetItem;
    property LastSelectedColumn: Boolean index TdxMask.LastSelectedColumn
      read GetItem write SetItem;
  ...
  private
    ...
    procedure CheckInsideTableBorder(ATable: TdxTable;
      AIsCheckingVerticalBorder: Boolean; AInsideBorder: TdxBorderBase;
      AStyleBorderInfo: TdxBorderInfo); overload;
    procedure SetInsideTableBorder(AInsideBorder: TdxBorderBase;
      AStyle: TdxBorderLineStyle; AWidth: Integer; AColor: TdxAlphaColor);
  protected
    function GetExtendSelection: Boolean; override;
    function GetTreatStartPositionAsCurrent: Boolean; override;
    function GetTryToKeepCaretX: Boolean; override;
    ...
    procedure CollectCells(ACellsInRow: TdxSelectedCellsIntervalInRow;
      var ACellPositionInfo: TdxSelectedTableCellPositionInfo;
      ATarget: TdxTableCellList); overload; virtual;
    procedure CollectCell(ACell: TdxTableCell;
      var ACellPositionInfo: TdxSelectedTableCellPositionInfo;
      ATarget: TdxTableCellList); overload; virtual;
    procedure CollectCellsCore(ACells: TdxSelectedCellsCollection;
      ATarget: TdxTableCellList); virtual;
    function PerformChangeSelection: Boolean; override;
    procedure PerformModifyModelCore(const AState: IdxCommandUIState); virtual;
    procedure ModifyCells(ACells: TdxTableCellList;
  ...
  TdxToggleTableCellsBordersCommandBaseClass = class of
    TdxToggleTableCellsBordersCommandBase;

  TdxToggleTableCellsBordersCommandBase = class abstract
    (TdxChangeTableCellsCommandBase)
  private
  ...
  protected
    ...
    procedure CollectBorders(const ACellBorders: IdxTableCellBorders;
      ACellPositionInfo: TdxSelectedTableCellPositionInfo;
      ABorders: TdxBorderBaseList); virtual; abstract;
    procedure CollectCells(ATarget: TdxTableCellList); overload; override;
    procedure CollectCells(ACellsInRow: TdxSelectedCellsIntervalInRow;
      var ACellPositionInfo: TdxSelectedTableCellPositionInfo;
      ATarget: TdxTableCellList); overload; override;
    procedure CollectCell(ATableCell: TdxTableCell;
      var ACellPositionInfo: TdxSelectedTableCellPositionInfo;
      ATarget: TdxTableCellList); override;
    procedure CollectCellsCore(ACells: TdxSelectedCellsCollection;
      ATarget: TdxTableCellList); override;
    procedure CollectCellsCoreWithMultipleItems(ASelectedCells
      : TdxSelectedCellsCollection; ATarget: TdxTableCellList);
    procedure CollectBottomNeighbourBorders(ACellsInRow
      : TdxSelectedCellsIntervalInRow; ABorders: TdxBorderBaseList); virtual;
    procedure CollectLeftNeighbourBorders(ACellsInRow
      : TdxSelectedCellsIntervalInRow; ABorders: TdxBorderBaseList); virtual;
    procedure CollectLeftNeighbourBordersInMergedCells(ACell: TdxTableCell;
      ABorders: TdxBorderBaseList);
    procedure CollectNeighbourRowCells(ARow: TdxTableRow;
      ACellsInRow: TdxSelectedCellsIntervalInRow; ATarget: TdxTableCellList);
    procedure CollectRightNeighbourBorders(ACellsInRow
      : TdxSelectedCellsIntervalInRow; ABorders: TdxBorderBaseList); virtual;
    procedure CollectRightNeighbourBordersInMergedCells(ACell: TdxTableCell;
      ABorders: TdxBorderBaseList);
    procedure CollectTableBorders(ATableBorders: TdxTableBorders;
      ABorders: TdxBorderBaseList); virtual; abstract;
    procedure CollectTopAndBottomNeighbourBorders(ASelectedCells
      : TdxSelectedCellsCollection; ATarget: TdxTableCellList);
    procedure CollectTopAndBottomNeighbourBordersCore
      (ACells: TdxSelectedCellsCollection; ATarget: TdxTableCellList;
      AFirst, ALast: TdxSelectedCellsIntervalInRow);
    procedure CollectTopNeighbourBorders(ACellsInRow
      : TdxSelectedCellsIntervalInRow; ABorders: TdxBorderBaseList); virtual;
    procedure ModifyBorder(ABorder: TdxBorderBase); virtual;
    procedure ModifyCells(ACells: TdxTableCellList;
      const AState: IdxCommandUIState); override;
  ...
  TdxToggleTableCellsBottomBorderCommand = class
    (TdxToggleTableCellsBordersCommandBase)
  protected
    procedure CollectLeftNeighbourBorders(ACellsInRow
      : TdxSelectedCellsIntervalInRow; ABorders: TdxBorderBaseList); override;
    procedure CollectRightNeighbourBorders(ACellsInRow
      : TdxSelectedCellsIntervalInRow; ABorders: TdxBorderBaseList); override;
    procedure CollectTopNeighbourBorders(ACellsInRow
      : TdxSelectedCellsIntervalInRow; ABorders: TdxBorderBaseList); override;
  ...
  TdxToggleTableCellsTopBorderCommand = class
    (TdxToggleTableCellsBordersCommandBase)
  protected
    procedure CollectBorders(const ACellBorders: IdxTableCellBorders;
      ACellPositionInfo: TdxSelectedTableCellPositionInfo;
  ...
  TdxToggleTableCellsInsideHorizontalBorderCommand = class
    (TdxToggleTableCellsBordersCommandBase)
  protected
    procedure CollectBorders(const ACellBorders: IdxTableCellBorders;
      ACellPositionInfo: TdxSelectedTableCellPositionInfo;
  ...
  TdxToggleTableCellsLeftBorderCommand = class
    (TdxToggleTableCellsBordersCommandBase)
  protected
    procedure CollectBorders(const ACellBorders: IdxTableCellBorders;
      ACellPositionInfo: TdxSelectedTableCellPositionInfo;
  ...
  TdxToggleTableCellsRightBorderCommand = class
    (TdxToggleTableCellsBordersCommandBase)
  protected
    procedure CollectBorders(const ACellBorders: IdxTableCellBorders;
      ACellPositionInfo: TdxSelectedTableCellPositionInfo;
  ...
  TdxToggleTableCellsInsideVerticalBorderCommand = class
    (TdxToggleTableCellsBordersCommandBase)
  protected
    procedure CollectBorders(const ACellBorders: IdxTableCellBorders;
      ACellPositionInfo: TdxSelectedTableCellPositionInfo;
  ...
  TdxToggleTableCellsAllBordersCommand = class
    (TdxToggleTableCellsBordersCommandBase)
  protected
    procedure CollectBorders(const ACellBorders: IdxTableCellBorders;
      ACellPositionInfo: TdxSelectedTableCellPositionInfo;
  ...
  TdxToggleTableCellsOutsideBorderCommand = class
    (TdxToggleTableCellsBordersCommandBase)
  protected
    procedure CollectBorders(const ACellBorders: IdxTableCellBorders;
      ACellPositionInfo: TdxSelectedTableCellPositionInfo;
  ...
  TdxToggleTableCellsInsideBorderCommand = class
    (TdxToggleTableCellsBordersCommandBase)
  protected
    procedure CollectBorders(const ACellBorders: IdxTableCellBorders;
      ACellPositionInfo: TdxSelectedTableCellPositionInfo;
  ...
  TdxToggleTableCellsContentAlignmentCommandBase = class abstract
    (TdxChangeTableCellsCommandBase)
  strict private
  ...
  protected
    ...
    property CellsContentIntervals: TdxSelectionItems
      read FCellsContentIntervals;
    property ParagraphAlignment: TdxParagraphAlignment
      read GetParagraphAlignment;
    property CellVerticalAlignment: TdxVerticalAlignment
      read GetCellVerticalAlignment;
  public
    destructor Destroy; override;
  end;
  ...
  TdxToggleTableCellsParagraphAlignmentCommand = class
    (TdxToggleChangeParagraphFormattingCommandBase<TdxParagraphAlignment>)
  strict private
  ...
  protected
    ...
    function CreateModifier(const AState: IdxCommandUIState)
      : TdxParagraphPropertyModifier<TdxParagraphAlignment>; override;
  ...
  public
    constructor Create(const AControl: IdxRichEditControl;
      AOwnerCommand: TdxToggleTableCellsContentAlignmentCommandBase);
      reintroduce;
  ...
  TdxChangeTableCellsContentAlignmentPlaceholderCommand = class
    (TdxChangeTableCellsCommandBase)
  protected
    procedure ModifyCell(ATableCell: TdxTableCell); override;
    procedure UpdateUIStateCore(const AState: IdxCommandUIState); override;
  ...
  TdxToggleTableCellsTopLeftAlignmentCommand = class
    (TdxToggleTableCellsContentAlignmentCommandBase)
  protected
  ...
  TdxToggleTableCellsTopCenterAlignmentCommand = class
    (TdxToggleTableCellsContentAlignmentCommandBase)
  protected
    function GetCellVerticalAlignment: TdxVerticalAlignment; override;
    function GetParagraphAlignment: TdxParagraphAlignment; override;
  ...
  TdxToggleTableCellsTopRightAlignmentCommand = class
    (TdxToggleTableCellsContentAlignmentCommandBase)
  protected
    function GetCellVerticalAlignment: TdxVerticalAlignment; override;
    function GetParagraphAlignment: TdxParagraphAlignment; override;
  ...
  TdxToggleTableCellsMiddleLeftAlignmentCommand = class
    (TdxToggleTableCellsContentAlignmentCommandBase)
  protected
    function GetCellVerticalAlignment: TdxVerticalAlignment; override;
    function GetParagraphAlignment: TdxParagraphAlignment; override;
  ...
  TdxToggleTableCellsMiddleCenterAlignmentCommand = class
    (TdxToggleTableCellsContentAlignmentCommandBase)
  protected
    function GetCellVerticalAlignment: TdxVerticalAlignment; override;
    function GetParagraphAlignment: TdxParagraphAlignment; override;
  ...
  TdxToggleTableCellsMiddleRightAlignmentCommand = class
    (TdxToggleTableCellsContentAlignmentCommandBase)
  protected
    function GetCellVerticalAlignment: TdxVerticalAlignment; override;
    function GetParagraphAlignment: TdxParagraphAlignment; override;
  ...
  TdxToggleTableCellsBottomLeftAlignmentCommand = class
    (TdxToggleTableCellsContentAlignmentCommandBase)
  protected
    function GetCellVerticalAlignment: TdxVerticalAlignment; override;
    function GetParagraphAlignment: TdxParagraphAlignment; override;
  ...
  TdxToggleTableCellsBottomCenterAlignmentCommand = class
    (TdxToggleTableCellsContentAlignmentCommandBase)
  protected
    function GetCellVerticalAlignment: TdxVerticalAlignment; override;
    function GetParagraphAlignment: TdxParagraphAlignment; override;
  ...
  TdxToggleTableCellsBottomRightAlignmentCommand = class
    (TdxToggleTableCellsContentAlignmentCommandBase)
  protected
    function GetCellVerticalAlignment: TdxVerticalAlignment; override;
    function GetParagraphAlignment: TdxParagraphAlignment; override;
...
function TdxMergeTableElementCommandBase.GetTreatStartPositionAsCurrent
  : Boolean;
begin
  Result := False;
end;
...
function TdxMergeTableElementCommandBase.
...
procedure TdxMergeTableElementCommandBase.UpdateUIStateCore
...
procedure TdxMergeTableElementCommandBase.UpdateUIStateEnabled
  (const AState: IdxCommandUIState);
var
...
begin
  ...
  begin
    ...
    AState.Enabled := ACells.IsSquare and
      ((ACells.NormalizedFirst.NormalizedLength > 0) or (ACells.RowsCount > 1))
      and TdxSelectionAccess(DocumentModel.Selection).IsValidSelectedCells;
  end;
end;
...
function TdxMergeTableElementCommandBase.CanChangePosition
...
begin
  if FSelectedCellsCollection.NormalizedFirst <> nil then
    ChangeSelection(FSelectedCellsCollection.NormalizedFirst.
      NormalizedStartCell)
  else
...
procedure TdxMergeTableElementCommandBase.ChangeSelection
  (ACellToSelect: TdxTableCell);
var
...
function TdxMergeTableElementCommandBase.ChangePosition
...
procedure TdxMergeTableElementMenuCommand.UpdateUIStateCore
  (const AState: IdxCommandUIState);
begin
...
procedure TdxMergeTableCellsCommand.UpdateUIStateCore
  (const AState: IdxCommandUIState);
begin
  inherited UpdateUIStateCore(AState);
...
function TdxSplitTableCellsCommand.
  GetUpdateCaretPositionBeforeChangeSelectionDetailsLevel
  : TdxDocumentLayoutDetailsLevel;
begin
  Result := TdxDocumentLayoutDetailsLevel.None;
...
procedure TdxSplitTableCellsCommand.ForceExecute(const AState
  : IdxCommandUIState);
var
  AValueState: TdxDefaultValueBasedCommandUIState<TdxSplitTableCellsParameters>;
begin
  AValueState :=
    AState as TdxDefaultValueBasedCommandUIState<TdxSplitTableCellsParameters>;
...
function TdxSplitTableCellsCommand.CalculateNewPosition
  (AFirstCell: TdxTableCell): TdxDocumentLogPosition;
begin
  Result := ActivePieceTable.Paragraphs[AFirstCell.EndParagraphIndex]
    .EndLogPosition;
end;

procedure TdxSplitTableCellsCommand.SplitTableCellsHorizontally
  (ASelectedCells: TdxSelectedCellsCollection);
var
...
begin
  ADocumentServerOwner :=
    RichEditControl as IdxInnerRichEditDocumentServerOwner;
  if CellsParameters.MergeCellsBeforeSplit then
  begin
    AStartCell := ASelectedCells.NormalizedFirst.NormalizedStartCell;
    ActivePieceTable.SplitTableCellsHorizontally(AStartCell,
      CellsParameters.ColumnsCount, GetForceVisible, ADocumentServerOwner);
    Exit;
  end;
  ...
  begin
    ...
    for J := ACurrentSelectedRow.NormalizedEndCellIndex downto
      AStartCellIndex do
    begin
      ACurrentCell := ACells[J];
      if ACurrentCell.VerticalMerging = TdxMergingState.Continue then
        Continue;
      ActivePieceTable.SplitTableCellsHorizontally(ACurrentCell,
        CellsParameters.ColumnsCount, AForceVisible, ADocumentServerOwner);
    end;
  end;
end;

procedure TdxSplitTableCellsCommand.SplitTableCellsVertically
  (ASelectedCells: TdxSelectedCellsCollection);
var
...
begin
  ...
  ActivePieceTable.SplitTableCellsVertically
    (ASelectedFirstInterval.NormalizedStartCell, ARowsCount, AColumnsCount,
    GetForceVisible);
end;

function TdxSplitTableCellsCommand.GetColumnsCountForSplitVertically
  (AInterval: TdxSelectedCellsIntervalInRow): Integer;
begin
  if CellsParameters.MergeCellsBeforeSplit then
...
function TdxSplitTableCellsCommand.CanChangePosition
  (const APos: TdxDocumentModelPosition): Boolean;
begin
  Result := True;
end;

function TdxSplitTableCellsCommand.ChangePosition
  (const APos: TdxDocumentModelPosition): TdxDocumentLogPosition;
begin
  Result := FNewPosition;
end;

procedure TdxSplitTableCellsCommand.UpdateUIStateCore
  (const AState: IdxCommandUIState);
begin
...
procedure TdxSelectedTableCellPositionInfo.CopyFrom(const ASource
  : TdxSelectedTableCellPositionInfo);
begin
  FMask := ASource.FMask;
end;
...
function TdxSelectedTableCellPositionInfo.GetItem(const Index: TdxMask)
  : Boolean;
begin
  Result := Index in FMask;
end;

procedure TdxSelectedTableCellPositionInfo.SetItem(const Index: TdxMask;
  const Value: Boolean);
begin
  if Value then
    Include(FMask, Index)
...
procedure TdxChangeTableCellsCommandBase.SetInsideTableBorder
  (AInsideBorder: TdxBorderBase; AStyle: TdxBorderLineStyle; AWidth: Integer;
...
function TdxChangeTableCellsCommandBase.CanChangePosition
  (const APos: TdxDocumentModelPosition): Boolean;
begin
  Result := False;
end;

function TdxChangeTableCellsCommandBase.ChangePosition
  (const APos: TdxDocumentModelPosition): Integer;
begin
  Result := APos.LogPosition;
end;

procedure TdxChangeTableCellsCommandBase.CheckInsideTableBorder
  (ATable: TdxTable; AIsCheckingVerticalBorder: Boolean;
...
begin
  ...
  begin
    ...
    begin
      ...
      if not ACurrentRow.IsFirstRowInTable and
        (ACurrentCellBorder.Style <> TdxBorderLineStyle.None) then
      begin
        SetInsideTableBorder(AInsideBorder, AStyleBorderInfo.Style,
          AStyleBorderInfo.Width, AStyleBorderInfo.Color);
        Exit;
      end;
    end;
  end;
  SetInsideTableBorder(AInsideBorder, TdxBorderLineStyle.None, 0,
...
begin
  ...
  try
    CheckInsideTableBorder(ATable, False, ABorders.InsideHorizontalBorder,
      ATableStyleProperties.Info.Borders.InsideHorizontalBorder);
    CheckInsideTableBorder(ATable, True, ABorders.InsideVerticalBorder,
      ATableStyleProperties.Info.Borders.InsideVerticalBorder);
  finally
    ATableStyleProperties.Free;
  end;
end;

procedure TdxChangeTableCellsCommandBase.CollectCells
  ...
  begin
    ...
    begin
      ...
      try
        ...
        begin
          ACellPositionInfoForMergedCells :=
            TdxSelectedTableCellPositionInfo.Create(nil);
          ACellPositionInfoForMergedCells.CopyFrom(ACellPositionInfo);
          ACellPositionInfoForMergedCells.FirstSelectedRow :=
            ACellPositionInfoForMergedCells.FirstSelectedRow and (J = 0);
          ACellPositionInfoForMergedCells.LastSelectedRow :=
            ACellPositionInfoForMergedCells.LastSelectedRow or
...
procedure TdxChangeTableCellsCommandBase.CollectCellsCore
  (ACells: TdxSelectedCellsCollection; ATarget: TdxTableCellList);
var
  ACellPositionInfo: TdxSelectedTableCellPositionInfo;
...
begin
  ...
  begin
    if AInvert then
      ...
      AIndex := I;
    ACellPositionInfo.FirstSelectedRow := not ACellsIsSquare or
      (ACells[AIndex].Row.IndexInTable = ATopRowIndex);
    ACellPositionInfo.LastSelectedRow := not ACellsIsSquare or
      (ACells[AIndex].Row.IndexInTable = ABottomRowIndex);
...
procedure TdxChangeTableCellsCommandBase.ForceExecute
  (const AState: IdxCommandUIState);
begin
...
function TdxChangeTableCellsCommandBase.
  GetUpdateCaretPositionBeforeChangeSelectionDetailsLevel
  : TdxDocumentLayoutDetailsLevel;
begin
  Result := TdxDocumentLayoutDetailsLevel.None;
...
procedure TdxChangeTableCellsCommandBase.ModifyCells(ACells: TdxTableCellList;
  const AState: IdxCommandUIState);
var
  I: Integer;
begin
...
procedure TdxChangeTableCellsCommandBase.PerformModifyModelCore
  (const AState: IdxCommandUIState);
begin
...
procedure TdxChangeTableCellsCommandBase.UpdateUIStateCore
  (const AState: IdxCommandUIState);
begin
...
begin
  ApplyCommandRestrictionOnEditableControl(AState,
    ...
    DocumentModel.Selection.IsWholeSelectionInOneTable);
  ApplyDocumentProtectionToSelectedParagraphs(AState);
end;
...
function TdxToggleTableCellsBordersCommandBase.GetActualNewBorder
  : TdxBorderInfo;
begin
...
procedure TdxToggleTableCellsBordersCommandBase.ModifyBorder
...
procedure TdxToggleTableCellsBordersCommandBase.ModifyCells
  (ACells: TdxTableCellList; const AState: IdxCommandUIState);
var
  I: Integer;
begin
...
procedure TdxToggleTableCellsBordersCommandBase.ResetBorder
  (ABorder: TdxBorderBase);
begin
  ABorder.ReplaceInfo(TdxBorderInfo.Empty, ABorder.BatchUpdateChangeActions);
end;

procedure TdxToggleTableCellsBordersCommandBase.UpdateUIStateCore
  (const AState: IdxCommandUIState);
var
...
begin
  ...
  Result := ACells.IsSelectedEntireTable and
    ASelection.IsWholeSelectionInOneTable;
end;

procedure TdxToggleTableCellsBordersCommandBase.CollectCells
  (ATarget: TdxTableCellList);
var
...
begin
  ...
  begin
    ATableBorders := DocumentModel.Selection.SelectedCells.FirstSelectedCell.
      Table.TableProperties.Borders;
    CollectTableBorders(ATableBorders, FBorders);
  end;
  inherited CollectCells(ATarget);
end;

function TdxToggleTableCellsBordersCommandBase.CalculateIsChecked
  (ABorders: TdxBorderBaseList): Boolean;
var
  ACount: Integer;
...
procedure TdxToggleTableCellsBordersCommandBase.CollectCell
...
procedure TdxToggleTableCellsBordersCommandBase.CollectCellsCore
  (ACells: TdxSelectedCellsCollection; ATarget: TdxTableCellList);
var
...
begin
  if not ACells.IsNotEmpty then
    Exit;
  AItems := TdxDocumentModel(ACells.FirstSelectedCell.DocumentModel)
    .Selection.Items;
  if AItems[0].Generation = AItems[AItems.Count - 1].Generation then
  begin
    CollectTopAndBottomNeighbourBordersCore(ACells, ATarget,
      ACells.NormalizedFirst, ACells.NormalizedLast);
...
procedure TdxToggleTableCellsBordersCommandBase.
  CollectCellsCoreWithMultipleItems(ASelectedCells: TdxSelectedCellsCollection;
  ATarget: TdxTableCellList);
begin
...
procedure TdxToggleTableCellsBordersCommandBase.CollectLeftNeighbourBorders
  (ACellsInRow: TdxSelectedCellsIntervalInRow; ABorders: TdxBorderBaseList);
var
...
procedure TdxToggleTableCellsBordersCommandBase.
  CollectLeftNeighbourBordersInMergedCells(ACell: TdxTableCell;
  ABorders: TdxBorderBaseList);
var
  ASpanCells: TdxTableCellList;
  ASpanCellsCount: Integer;
  ...
  I: Integer;
begin
  ASpanCells := TdxTableCellVerticalBorderCalculator.GetVerticalSpanCells(ACell,
    ACell.GetStartColumnIndexConsiderRowGrid, False);
  try
    ASpanCellsCount := ASpanCells.Count;
...
procedure TdxToggleTableCellsBordersCommandBase.CollectNeighbourRowCells
  (ARow: TdxTableRow; ACellsInRow: TdxSelectedCellsIntervalInRow;
  ATarget: TdxTableCellList);
var
  ...
  ACount: Integer;
begin
  AStartColumnIndex := ACellsInRow.NormalizedStartCell.
    GetStartColumnIndexConsiderRowGrid;
  AEndColumnIndex := ACellsInRow.NormalizedEndCell.
    GetEndColumnIndexConsiderRowGrid;
  ACells := TdxTableCellVerticalBorderCalculator.GetCellsByIntervalColumnIndex
    (ARow, AStartColumnIndex, AEndColumnIndex);
  try
    ACount := ACells.Count;
    if ACount <= 0 then
      Exit;
...
procedure TdxToggleTableCellsBordersCommandBase.CollectRightNeighbourBorders
  (ACellsInRow: TdxSelectedCellsIntervalInRow; ABorders: TdxBorderBaseList);
var
...
procedure TdxToggleTableCellsBordersCommandBase.
  CollectRightNeighbourBordersInMergedCells(ACell: TdxTableCell;
  ABorders: TdxBorderBaseList);
var
  ASpanCells: TdxTableCellList;
...
procedure TdxToggleTableCellsBordersCommandBase.
  CollectTopAndBottomNeighbourBorders(ASelectedCells
  : TdxSelectedCellsCollection; ATarget: TdxTableCellList);
var
  AItems: TdxSelectionItemList;
...
begin
  ...
  for I := 0 to ACount - 1 do
    if (I = ACount - 1) or (AItems[I].Generation <> AItems[I + 1].Generation)
    then
    begin
      CollectTopAndBottomNeighbourBordersCore(ASelectedCells, ATarget,
        ASelectedCells[AGenerationStartCellIndex], ASelectedCells[I]);
      AGenerationStartCellIndex := I + 1;
    end;
end;

procedure TdxToggleTableCellsBordersCommandBase.
  CollectTopAndBottomNeighbourBordersCore(ACells: TdxSelectedCellsCollection;
  ATarget: TdxTableCellList; AFirst, ALast: TdxSelectedCellsIntervalInRow);
begin
...
procedure TdxToggleTableCellsBordersCommandBase.CollectTopNeighbourBorders
  (ACellsInRow: TdxSelectedCellsIntervalInRow; ABorders: TdxBorderBaseList);
var
  ACells: TdxTableCellList;
  I: Integer;
...
procedure TdxToggleTableCellsBottomBorderCommand.CollectBorders
  (const ACellBorders: IdxTableCellBorders;
  ACellPositionInfo: TdxSelectedTableCellPositionInfo;
  ABorders: TdxBorderBaseList);
begin
...
procedure TdxToggleTableCellsBottomBorderCommand.CollectLeftNeighbourBorders
  (ACellsInRow: TdxSelectedCellsIntervalInRow; ABorders: TdxBorderBaseList);
begin
end;
...
procedure TdxToggleTableCellsBottomBorderCommand.CollectTableBorders
  (ATableBorders: TdxTableBorders; ABorders: TdxBorderBaseList);
begin
  ABorders.Add(ATableBorders.BottomBorder);
end;

procedure TdxToggleTableCellsBottomBorderCommand.CollectTopNeighbourBorders
  (ACellsInRow: TdxSelectedCellsIntervalInRow; ABorders: TdxBorderBaseList);
begin
end;
...
procedure TdxToggleTableCellsTopBorderCommand.CollectBorders(const ACellBorders
  : IdxTableCellBorders; ACellPositionInfo: TdxSelectedTableCellPositionInfo;
  ABorders: TdxBorderBaseList);
begin
...
procedure TdxToggleTableCellsTopBorderCommand.CollectBottomNeighbourBorders
  (ACellsInRow: TdxSelectedCellsIntervalInRow; ABorders: TdxBorderBaseList);
begin
end;

procedure TdxToggleTableCellsTopBorderCommand.CollectLeftNeighbourBorders
  (ACellsInRow: TdxSelectedCellsIntervalInRow; ABorders: TdxBorderBaseList);
begin
end;

procedure TdxToggleTableCellsTopBorderCommand.CollectRightNeighbourBorders
  (ACellsInRow: TdxSelectedCellsIntervalInRow; ABorders: TdxBorderBaseList);
begin
end;

procedure TdxToggleTableCellsTopBorderCommand.CollectTableBorders
  (ATableBorders: TdxTableBorders; ABorders: TdxBorderBaseList);
begin
...
procedure TdxToggleTableCellsInsideHorizontalBorderCommand.CollectBorders
  (const ACellBorders: IdxTableCellBorders;
  ACellPositionInfo: TdxSelectedTableCellPositionInfo;
  ABorders: TdxBorderBaseList);
begin
...
procedure TdxToggleTableCellsInsideHorizontalBorderCommand.
  CollectBottomNeighbourBorders(ACellsInRow: TdxSelectedCellsIntervalInRow;
  ABorders: TdxBorderBaseList);
begin
end;

procedure TdxToggleTableCellsInsideHorizontalBorderCommand.
  CollectLeftNeighbourBorders(ACellsInRow: TdxSelectedCellsIntervalInRow;
  ABorders: TdxBorderBaseList);
begin
end;

procedure TdxToggleTableCellsInsideHorizontalBorderCommand.
  CollectRightNeighbourBorders(ACellsInRow: TdxSelectedCellsIntervalInRow;
  ABorders: TdxBorderBaseList);
begin
end;

procedure TdxToggleTableCellsInsideHorizontalBorderCommand.CollectTableBorders
  (ATableBorders: TdxTableBorders; ABorders: TdxBorderBaseList);
begin
end;

procedure TdxToggleTableCellsInsideHorizontalBorderCommand.
  CollectTopNeighbourBorders(ACellsInRow: TdxSelectedCellsIntervalInRow;
  ABorders: TdxBorderBaseList);
begin
end;

class function TdxToggleTableCellsInsideHorizontalBorderCommand.
...
class function TdxToggleTableCellsInsideHorizontalBorderCommand.Id
...
procedure TdxToggleTableCellsLeftBorderCommand.CollectBorders(const ACellBorders
  : IdxTableCellBorders; ACellPositionInfo: TdxSelectedTableCellPositionInfo;
  ABorders: TdxBorderBaseList);
begin
...
procedure TdxToggleTableCellsLeftBorderCommand.CollectBottomNeighbourBorders
  (ACellsInRow: TdxSelectedCellsIntervalInRow; ABorders: TdxBorderBaseList);
begin
end;

procedure TdxToggleTableCellsLeftBorderCommand.CollectRightNeighbourBorders
  (ACellsInRow: TdxSelectedCellsIntervalInRow; ABorders: TdxBorderBaseList);
begin
end;

procedure TdxToggleTableCellsLeftBorderCommand.CollectTableBorders
  (ATableBorders: TdxTableBorders; ABorders: TdxBorderBaseList);
begin
  ABorders.Add(ATableBorders.LeftBorder);
end;

procedure TdxToggleTableCellsLeftBorderCommand.CollectTopNeighbourBorders
  (ACellsInRow: TdxSelectedCellsIntervalInRow; ABorders: TdxBorderBaseList);
begin
end;
...
procedure TdxToggleTableCellsRightBorderCommand.CollectBorders
  (const ACellBorders: IdxTableCellBorders;
  ACellPositionInfo: TdxSelectedTableCellPositionInfo;
  ABorders: TdxBorderBaseList);
begin
...
procedure TdxToggleTableCellsRightBorderCommand.CollectLeftNeighbourBorders
  (ACellsInRow: TdxSelectedCellsIntervalInRow; ABorders: TdxBorderBaseList);
begin
end;

procedure TdxToggleTableCellsRightBorderCommand.CollectTableBorders
  (ATableBorders: TdxTableBorders; ABorders: TdxBorderBaseList);
begin
  ABorders.Add(ATableBorders.RightBorder);
end;

procedure TdxToggleTableCellsRightBorderCommand.CollectTopNeighbourBorders
  (ACellsInRow: TdxSelectedCellsIntervalInRow; ABorders: TdxBorderBaseList);
begin
end;
...
class function TdxToggleTableCellsInsideVerticalBorderCommand.
  GetDescription: string;
begin
  Result := cxGetResourceString
...
class function TdxToggleTableCellsInsideVerticalBorderCommand.Id
  : TdxRichEditCommandId;
begin
...
procedure TdxToggleTableCellsInsideVerticalBorderCommand.CollectBorders
  (const ACellBorders: IdxTableCellBorders;
  ACellPositionInfo: TdxSelectedTableCellPositionInfo;
  ABorders: TdxBorderBaseList);
begin
...
procedure TdxToggleTableCellsInsideVerticalBorderCommand.
  CollectBottomNeighbourBorders(ACellsInRow: TdxSelectedCellsIntervalInRow;
  ABorders: TdxBorderBaseList);
begin
end;
...
procedure TdxToggleTableCellsInsideVerticalBorderCommand.CollectTableBorders
  (ATableBorders: TdxTableBorders; ABorders: TdxBorderBaseList);
begin
end;
...
procedure TdxToggleTableCellsAllBordersCommand.CollectBorders(const ACellBorders
  : IdxTableCellBorders; ACellPositionInfo: TdxSelectedTableCellPositionInfo;
  ABorders: TdxBorderBaseList);
begin
  ABorders.Add(ACellBorders.LeftBorder);
...
procedure TdxToggleTableCellsAllBordersCommand.CollectTableBorders
  (ATableBorders: TdxTableBorders; ABorders: TdxBorderBaseList);
begin
  ABorders.Add(ATableBorders.LeftBorder);
  ABorders.Add(ATableBorders.TopBorder);
...
function TdxResetTableCellsBordersCommand.CalculateIsChecked
  (ABorders: TdxBorderBaseList): Boolean;
begin
  Result := True;
end;
...
procedure TdxToggleTableCellsOutsideBorderCommand.CollectBorders
  (const ACellBorders: IdxTableCellBorders;
  ACellPositionInfo: TdxSelectedTableCellPositionInfo;
  ABorders: TdxBorderBaseList);
begin
...
procedure TdxToggleTableCellsOutsideBorderCommand.CollectTableBorders
  (ATableBorders: TdxTableBorders; ABorders: TdxBorderBaseList);
begin
  ABorders.Add(ATableBorders.LeftBorder);
  ABorders.Add(ATableBorders.TopBorder);
...
procedure TdxToggleTableCellsInsideBorderCommand.CollectBorders
  (const ACellBorders: IdxTableCellBorders;
  ACellPositionInfo: TdxSelectedTableCellPositionInfo;
  ABorders: TdxBorderBaseList);
begin
...
procedure TdxToggleTableCellsInsideBorderCommand.CollectLeftNeighbourBorders
  (ACellsInRow: TdxSelectedCellsIntervalInRow; ABorders: TdxBorderBaseList);
begin
end;
...
procedure TdxToggleTableCellsInsideBorderCommand.CollectTableBorders
  (ATableBorders: TdxTableBorders; ABorders: TdxBorderBaseList);
begin
end;

procedure TdxToggleTableCellsInsideBorderCommand.CollectTopNeighbourBorders
  (ACellsInRow: TdxSelectedCellsIntervalInRow; ABorders: TdxBorderBaseList);
begin
end;
...
procedure TdxToggleTableCellsContentAlignmentCommandBase.CollectCellsCore
  (ACells: TdxSelectedCellsCollection; ATarget: TdxTableCellList);
begin
...
procedure TdxToggleTableCellsContentAlignmentCommandBase.CollectCell
  (ACell: TdxTableCell; var ACellPositionInfo: TdxSelectedTableCellPositionInfo;
  ATarget: TdxTableCellList);
var
...
begin
  ...
  try
    ...
    AItem.Start := ActivePieceTable.Paragraphs[ACell.StartParagraphIndex]
      .LogPosition;
...
procedure TdxToggleTableCellsContentAlignmentCommandBase.PerformModifyModelCore
  (const AState: IdxCommandUIState);
var
...
begin
  ...
  ACommand := TdxToggleTableCellsParagraphAlignmentCommand.Create
...
procedure TdxToggleTableCellsContentAlignmentCommandBase.ModifyCell
  (ATableCell: TdxTableCell);
begin
  ATableCell.VerticalAlignment := CellVerticalAlignment;
end;

procedure TdxToggleTableCellsContentAlignmentCommandBase.UpdateUIStateCore
  (const AState: IdxCommandUIState;
  const ASelectedCellsCollection: TdxSelectedTableStructureBase);
var
  ACells: TdxTableCellList;
...
constructor TdxToggleTableCellsParagraphAlignmentCommand.Create
...
class function TdxToggleTableCellsParagraphAlignmentCommand.
  GetMenuCaption: string;
begin
...
function TdxToggleTableCellsParagraphAlignmentCommand.GetSelectionItems
  : TdxSelectionItems;
begin
  Result := FOwnerCommand.CellsContentIntervals;
end;

function TdxToggleTableCellsParagraphAlignmentCommand.CreateModifier
  (const AState: IdxCommandUIState)
...
function TdxToggleTableCellsParagraphAlignmentCommand.IsCheckedValue
...
class function TdxChangeTableCellsContentAlignmentPlaceholderCommand.
  GetDescription: string;
begin
  Result := cxGetResourceString
...
class function TdxChangeTableCellsContentAlignmentPlaceholderCommand.Id
  : TdxRichEditCommandId;
begin
  Result := TdxRichEditCommandId.ChangeTableCellsContentAlignmentPlaceholder;
end;

procedure TdxChangeTableCellsContentAlignmentPlaceholderCommand.ForceExecute
  (const AState: IdxCommandUIState);
begin
end;

function TdxChangeTableCellsContentAlignmentPlaceholderCommand.
  CreateDefaultCommandUIState: IdxCommandUIState;
begin
  Result := TdxDefaultCommandUIState.Create;
end;

procedure TdxChangeTableCellsContentAlignmentPlaceholderCommand.ModifyCell
  (ATableCell: TdxTableCell);
begin
end;

procedure TdxChangeTableCellsContentAlignmentPlaceholderCommand.
  UpdateUIStateCore(const AState: IdxCommandUIState);
begin
  inherited UpdateUIStateCore(AState);
  AState.Visible := AState.Enabled;
end;
...
class function TdxToggleTableCellsTopLeftAlignmentCommand.
  GetDescription: string;
begin
  Result := cxGetResourceString
...
class function TdxToggleTableCellsTopLeftAlignmentCommand.Id
  : TdxRichEditCommandId;
begin
...
function TdxToggleTableCellsTopLeftAlignmentCommand.GetCellVerticalAlignment
  : TdxVerticalAlignment;
begin
  Result := TdxVerticalAlignment.Top;
end;

function TdxToggleTableCellsTopLeftAlignmentCommand.GetParagraphAlignment
...
class function TdxToggleTableCellsTopCenterAlignmentCommand.
  GetDescription: string;
begin
  Result := cxGetResourceString
...
class function TdxToggleTableCellsTopCenterAlignmentCommand.Id
  : TdxRichEditCommandId;
begin
...
function TdxToggleTableCellsTopCenterAlignmentCommand.GetParagraphAlignment
  : TdxParagraphAlignment;
begin
  Result := TdxParagraphAlignment.Center;
end;

function TdxToggleTableCellsTopCenterAlignmentCommand.GetCellVerticalAlignment
  : TdxVerticalAlignment;
begin
  Result := TdxVerticalAlignment.Top;
end;
...
class function TdxToggleTableCellsTopRightAlignmentCommand.
  GetDescription: string;
begin
  Result := cxGetResourceString
...
class function TdxToggleTableCellsTopRightAlignmentCommand.Id
  : TdxRichEditCommandId;
begin
...
function TdxToggleTableCellsTopRightAlignmentCommand.GetParagraphAlignment
  : TdxParagraphAlignment;
begin
  Result := TdxParagraphAlignment.Right;
end;

function TdxToggleTableCellsTopRightAlignmentCommand.GetCellVerticalAlignment
  : TdxVerticalAlignment;
begin
  Result := TdxVerticalAlignment.Top;
end;
...
class function TdxToggleTableCellsMiddleLeftAlignmentCommand.
  GetDescription: string;
begin
  Result := cxGetResourceString
...
class function TdxToggleTableCellsMiddleLeftAlignmentCommand.Id
  : TdxRichEditCommandId;
begin
...
function TdxToggleTableCellsMiddleLeftAlignmentCommand.GetParagraphAlignment
  : TdxParagraphAlignment;
begin
  Result := TdxParagraphAlignment.Left;
end;

function TdxToggleTableCellsMiddleLeftAlignmentCommand.GetCellVerticalAlignment
  : TdxVerticalAlignment;
begin
...
class function TdxToggleTableCellsMiddleCenterAlignmentCommand.
  GetDescription: string;
begin
  Result := cxGetResourceString
...
class function TdxToggleTableCellsMiddleCenterAlignmentCommand.Id
  : TdxRichEditCommandId;
begin
...
function TdxToggleTableCellsMiddleCenterAlignmentCommand.
  GetCellVerticalAlignment: TdxVerticalAlignment;
begin
  Result := TdxVerticalAlignment.Center;
end;

function TdxToggleTableCellsMiddleCenterAlignmentCommand.GetParagraphAlignment
  : TdxParagraphAlignment;
begin
  Result := TdxParagraphAlignment.Center;
end;
...
class function TdxToggleTableCellsMiddleRightAlignmentCommand.
  GetDescription: string;
begin
  Result := cxGetResourceString
...
class function TdxToggleTableCellsMiddleRightAlignmentCommand.Id
  : TdxRichEditCommandId;
begin
...
function TdxToggleTableCellsMiddleRightAlignmentCommand.GetCellVerticalAlignment
  : TdxVerticalAlignment;
begin
  Result := TdxVerticalAlignment.Center;
end;

function TdxToggleTableCellsMiddleRightAlignmentCommand.GetParagraphAlignment
  : TdxParagraphAlignment;
begin
  Result := TdxParagraphAlignment.Right;
end;
...
class function TdxToggleTableCellsBottomLeftAlignmentCommand.
  GetDescription: string;
begin
  Result := cxGetResourceString
...
class function TdxToggleTableCellsBottomLeftAlignmentCommand.Id
  : TdxRichEditCommandId;
begin
...
function TdxToggleTableCellsBottomLeftAlignmentCommand.GetCellVerticalAlignment
  : TdxVerticalAlignment;
begin
  Result := TdxVerticalAlignment.Bottom;
end;

function TdxToggleTableCellsBottomLeftAlignmentCommand.GetParagraphAlignment
  : TdxParagraphAlignment;
begin
  Result := TdxParagraphAlignment.Left;
end;
...
class function TdxToggleTableCellsBottomCenterAlignmentCommand.
  GetDescription: string;
begin
  Result := cxGetResourceString
...
class function TdxToggleTableCellsBottomCenterAlignmentCommand.Id
  : TdxRichEditCommandId;
begin
...
function TdxToggleTableCellsBottomCenterAlignmentCommand.
  GetCellVerticalAlignment: TdxVerticalAlignment;
begin
  Result := TdxVerticalAlignment.Bottom;
end;

function TdxToggleTableCellsBottomCenterAlignmentCommand.GetParagraphAlignment
  : TdxParagraphAlignment;
begin
  Result := TdxParagraphAlignment.Center;
end;
...
class function TdxToggleTableCellsBottomRightAlignmentCommand.
  GetDescription: string;
begin
  Result := cxGetResourceString
...
class function TdxToggleTableCellsBottomRightAlignmentCommand.Id
  : TdxRichEditCommandId;
begin
...
function TdxToggleTableCellsBottomRightAlignmentCommand.GetCellVerticalAlignment
  : TdxVerticalAlignment;
begin
  Result := TdxVerticalAlignment.Bottom;
end;

function TdxToggleTableCellsBottomRightAlignmentCommand.GetParagraphAlignment
  : TdxParagraphAlignment;
begin
  Result := TdxParagraphAlignment.Right;
end;
