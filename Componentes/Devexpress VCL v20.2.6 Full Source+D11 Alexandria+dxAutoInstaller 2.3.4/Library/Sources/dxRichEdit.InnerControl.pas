...
{$IFDEF DELPHI16}
  System.UITypes,
{$ENDIF}
  Types, Classes, SysUtils, Graphics, Controls, Generics.Defaults,
  Generics.Collections, Rtti, Forms,
  cxControls, dxCore, dxCoreClasses, dxCoreGraphics, dxGDIPlusClasses,
  cxGeometry,
...
type
  ...
  TdxRichEditControlDeferredChanges = class // for internal use
  private
    FResize: Boolean;
    FRedraw: Boolean;
  ...
  public
    ...
    property RedrawAction: TdxRefreshAction read FRedrawAction
      write FRedrawAction;
  end;

  { TdxDocumentDeferredChanges }

  TdxDocumentDeferredChanges = class // for internal use
  private
  ...
  public
    ...
    property StartRunIndex: TdxRunIndex read FStartRunIndex
      write FStartRunIndex;
  ...
  IdxInnerRichEditControlOwner = interface(IdxInnerRichEditDocumentServerOwner)
    ...
    procedure RedrawEnsureSecondaryFormattingComplete
      (AAction: TdxRefreshAction); overload;
    ...
    procedure ApplyFont(ACharacterProperties: TdxCharacterProperties;
      AFont: TFont);
    ...
    procedure ApplyChangesCorePlatformSpecific(AChangeActions
  ...
  public
    ...
    property SuppressBindingNotifications: Boolean
      read FSuppressBindingNotifications;
  end;

  TdxDocumentContentChangedEvent = procedure(Sender: TObject;
    E: TdxDocumentContentChangedEventArgs) of object;

  { TdxExplicitBoxMeasurerProvider }

  TdxExplicitBoxMeasurerProvider = class(TInterfacedObject,
    IdxBoxMeasurerProvider) // for internal use
  strict private
  ...
  TdxHeaderFooterEditingEvent = procedure(Sender: TObject;
    E: TdxHeaderFooterEditingEventArgs) of object;
  TdxHeaderFooterEditingEventHandler =
    TdxMulticastMethod<TdxHeaderFooterEditingEvent>;

  TdxBeforePagePaintEvent = procedure(Sender: TObject;
    E: TdxRichEditBeforePagePaintEventArgs) of object;
  TdxBeforePagePaintEventHandler = TdxMulticastMethod<TdxBeforePagePaintEvent>;

  { TdxInnerRichEditDocumentServer }

  TdxInnerRichEditDocumentServer = class(TcxIUnknownObject, IdxBatchUpdatable,
    IdxBatchUpdateHandler, IdxBoxMeasurerProvider, IdxServiceContainer,
  ...
  strict private
    ...
    procedure AddCalculateDocumentVariableHandler(const AHandler
      : TdxCalculateDocumentVariableEvent);
    procedure RemoveCalculateDocumentVariableHandler(const AHandler
      : TdxCalculateDocumentVariableEvent);
    ...
    function GetDocumentLayoutInvalidated
      : TdxDocumentLayoutInvalidatedEventHandler;
    ...
    function TryLoadDocument(AStream: TStream;
      ADocumentFormat: TdxRichEditDocumentFormat;
      const ASourceUri: string): Boolean;
  protected
    // IdxServiceProvider
    function GetService(const AServiceType: TdxServiceType)
      : IInterface; overload;
    // IdxServiceContainer
    procedure AddService(const AServiceType: TdxServiceType;
      const AServiceInstance: IInterface); overload;
    procedure AddService(const AServiceType: TdxServiceType;
      const AServiceInstance: IInterface; APromote: Boolean); overload;
    procedure AddService(const AServiceType: TdxServiceType;
      const ACallback: IdxServiceCreatorCallback); overload;
    procedure AddService(const AServiceType: TdxServiceType;
      const ACallback: IdxServiceCreatorCallback; APromote: Boolean); overload;
    procedure RemoveService(const AServiceType: TdxServiceType); overload;
    procedure RemoveService(const AServiceType: TdxServiceType;
      APromote: Boolean); overload;
    ...
    procedure InitializeEmptyDocumentModel(ADocumentModel
    ...
    procedure OnDocumentLayoutChanged(ASender: TObject;
      E: TdxDocumentUpdateCompleteEventArgs); virtual;
    function NotifyDocumentLayoutChanged(APieceTable: TdxCustomPieceTable;
    ...
    function CreateNativeSubDocument(APieceTable: TdxPieceTable)
      : IdxRichEditSubDocument; virtual;
    function GetActualReadOnly: Boolean; virtual;
    function GetEncryptionPassword(Sender: TObject; var APassword: string)
      : Boolean; virtual;
    procedure InitializeDocumentLayout;
    function CreateDocumentLayout: TdxRichEditDocumentLayout; virtual;
    procedure RaiseContentChanged(ASuppressBindingNotifications
      : Boolean); virtual;
    ...
    function RaiseCalculateDocumentVariable
      (AArgs: TdxCalculateDocumentVariableEventArgs): Boolean; virtual;
    ...
    function RaiseCustomizeMergeFields(AArgs: TdxCustomizeMergeFieldsEventArgs)
      : TArray<IdxRichEditMergeFieldName>; virtual;
    procedure RaiseMailMergeStarted
      (AArgs: TdxMailMergeStartedEventArgs); virtual;
    procedure RaiseMailMergeRecordStarted
      (AArgs: TdxMailMergeRecordStartedEventArgs); virtual;
    procedure RaiseMailMergeRecordFinished
      (AArgs: TdxMailMergeRecordFinishedEventArgs); virtual;
    procedure RaiseMailMergeFinished
      (AArgs: TdxMailMergeFinishedEventArgs); virtual;
    procedure RaiseMailMergeGetTargetDocument
      (AArgs: TdxMailMergeGetTargetDocumentEventArgs); virtual;
    procedure RaisePageBackgroundChanged; virtual;
    procedure RaiseBeforePagePaint
      (AArgs: TdxRichEditBeforePagePaintEventArgs); virtual;
    ...
    procedure OnEndDocumentUpdate(ASender: TObject;
      E: TdxDocumentUpdateCompleteEventArgs); virtual;
    procedure OnBeginDocumentUpdateCore; virtual;
    function ProcessEndDocumentUpdateCore(ASender: TObject;
      E: TdxDocumentUpdateCompleteEventArgs)
      : TdxDocumentModelChangeActions; virtual;
    function OnEndDocumentUpdateCore(ASender: TObject;
      E: TdxDocumentUpdateCompleteEventArgs)
      : TdxDocumentModelChangeActions; virtual;
    ...
    procedure OnContentChangedCore(ASuppressBindingNotifications: Boolean;
      ASuppressUpdateUI: Boolean); virtual;
    procedure RaiseBindingNotifications; virtual;
    procedure OnModifiedChanged(ASender: TObject; E: TdxEventArgs); virtual;
    procedure OnCalculateDocumentVariable(ASender: TObject;
      E: TdxCalculateDocumentVariableEventArgs); virtual;
    procedure OnMailMergeStarted(ASender: TObject;
      const E: TdxMailMergeStartedEventArgs); virtual;
    procedure OnMailMergeRecordStarted(ASender: TObject;
      const E: TdxMailMergeRecordStartedEventArgs); virtual;
    procedure OnMailMergeRecordFinished(ASender: TObject;
      const E: TdxMailMergeRecordFinishedEventArgs); virtual;
    procedure OnMailMergeFinished(ASender: TObject;
      const E: TdxMailMergeFinishedEventArgs); virtual;
    procedure OnMailMergeGetTargetDocument(ASender: TObject;
      const E: TdxMailMergeGetTargetDocumentEventArgs); virtual;
    procedure OnPageBackgroundChanged(ASender: TObject;
      E: TdxEventArgs); virtual;
    procedure OnAfterExport(Sender: TObject);
    procedure OnBeforeExport(ASender: TObject;
      E: TdxBeforeExportEventArgs); virtual;
    procedure OnBeforeImport(ASender: TObject;
      E: TdxBeforeImportEventArgs); virtual;
    procedure OnDocumentCleared(ASender: TObject; E: TdxEventArgs); virtual;
    procedure OnInvalidFormatException(ASender: TObject;
      E: TdxRichEditInvalidFormatExceptionEventArgs); virtual;
    procedure OnEmptyDocumentCreated; virtual;
    procedure OnDocumentLoaded; virtual;
    procedure OnActivePieceTableChanged(ASender: TObject;
      E: TdxEventArgs); virtual;
    procedure ApplyChangesCore(const AChangeActions
      : TdxDocumentModelChangeActions); virtual;
    procedure ApplyFontAndForeColorCore(ACharacterProperties
      : TdxCharacterProperties); virtual;
    procedure PerformRaiseDeferredEventsCore(const AChangeActions
      : TdxDocumentModelChangeActions); virtual;

    procedure RaiseDeferredEvents(const AChangeActions
      : TdxDocumentModelChangeActions); virtual;
    function CreateMeasurementAndDrawingStrategy
      : TdxMeasurementAndDrawingStrategy; virtual;
    ...
    procedure OnOptionsChanged(ASender: TObject;
      E: TdxRichEditNotificationOptionsChangedArgs); virtual;
    ...
    procedure SetDocumentModelLayoutUnitCore
      (AUnit: TdxDocumentLayoutUnit); virtual;
    ...
    function LoadDocumentCore(AStream: TStream;
    ...
    procedure LoadDocument(const AFileName: string;
      ADocumentFormat: TdxRichEditDocumentFormat; ALoadAsTemplate: Boolean);
      overload; virtual;
    ...
    procedure MailMerge(const AOptions: IdxRichEditMailMergeOptions;
      ATargetModel: TdxDocumentModel); overload;
    function GetMailMergeOptions(const AOptions: IdxRichEditMailMergeOptions)
      : TdxMailMergeOptions; virtual;
    ...
    property PredefinedFontSizeCollection: TdxPredefinedFontSizeCollection
      read FPredefinedFontSizeCollection;
    property NumberingListsTemplate: TdxAbstractNumberingListCollection
      read GetNumberingListsTemplate;
    property Measurer: TdxBoxMeasurer read GetMeasurer;
    property DocumentDeferredChanges: TdxDocumentDeferredChanges
      read FDocumentDeferredChanges;
    property ActualReadOnly: Boolean read GetActualReadOnly;
    property BeforePagePaint: TdxBeforePagePaintEventHandler
      read FOnBeforePagePaint;
    property Control: TWinControl read GetControl;
  public
    constructor Create(const AOwner: IdxInnerRichEditDocumentServerOwner);
      overload; virtual;
    constructor Create(const AOwner: IdxInnerRichEditDocumentServerOwner;
      ADpiX: Single; ADpiY: Single); overload;
    constructor Create(const AOwner: IdxInnerRichEditDocumentServerOwner;
      ADocumentModel: TdxDocumentModel); overload;
    ...
    function CalculatePrintDocumentLayout
      (Server: TObject { TdxInternalRichEditDocumentServer } )
      : TdxDocumentLayout;
    class function CalculateDocumentLayoutResetType
      (AChanges: TdxDocumentModelDeferredChanges)
      : TdxDocumentLayoutResetType; static;
    procedure RaiseDocumentLayoutInvalidated
      (AArgs: TdxDocumentLayoutInvalidatedEventArgs);
    procedure RaiseDocumentFormatted;
    procedure RaiseDeferredEventsCore(const AChangeActions
      : TdxDocumentModelChangeActions); virtual;
    ...
    function CreateNewDocument(ARaiseDocumentClosing: Boolean)
      : Boolean; virtual;
    procedure LoadDocument(AStream: TStream;
      ADocumentFormat: TdxRichEditDocumentFormat); overload; virtual;
    ...
    procedure LoadDocumentTemplate(const AFileName: string;
      ADocumentFormat: TdxRichEditDocumentFormat); overload; virtual;
    procedure LoadDocumentTemplate(AStream: TStream;
      ADocumentFormat: TdxRichEditDocumentFormat); overload; virtual;
    ...
    procedure SaveDocument(const AFileName: string;
      ADocumentFormat: TdxRichEditDocumentFormat;
      const AOptions: TdxDocumentSaveOptions); overload;

    procedure SaveDocumentCore(const AFileName: string;
      ADocumentFormat: TdxRichEditDocumentFormat;
      const AOptions: TdxDocumentSaveOptions); overload;
    ...
    property BackgroundFormatter: TdxBackgroundFormatter read FFormatter
      write FFormatter;
    property FormattingController: TdxDocumentFormattingController
      read GetFormattingController;
    ...
    property LayoutCalculationMode: TdxCalculationModeType
      read FLayoutCalculationMode write SetLayoutCalculationMode;
    ...
    property MeasurementUnit: TdxMeasurementUnit read FMeasurementUnit
      write SetMeasurementUnitProperty;
    ...
    property DocumentLayoutInvalidated: TdxDocumentLayoutInvalidatedEventHandler
      read GetDocumentLayoutInvalidated;
    ...
    property PageBackgroundChanged: TdxNotifyEventHandler
    ...
    property OpenXmlBytesChanged: TdxNotifyEventHandler
      read FOnOpenXmlBytesChanged;
    ...
    property UnhandledException: TdxRichEditUnhandledExceptionEventHandler
      read FOnUnhandledException;
    property SelectionChanged: TdxNotifyEventHandler read FOnSelectionChanged;
    property StartHeaderFooterEditing: TdxHeaderFooterEditingEventHandler
      read FOnStartHeaderFooterEditing;
    property FinishHeaderFooterEditing: TdxHeaderFooterEditingEventHandler
      read FOnFinishHeaderFooterEditing;
    property DocumentProtectionChanged: TdxNotifyEventHandler
      read FOnDocumentProtectionChanged;
    ...
    property EmptyDocumentCreated: TdxNotifyEventHandler
      read FOnEmptyDocumentCreated;
    ...
    property CustomizeMergeFields: TdxCustomizeMergeFieldsEventHandler
      read FOnCustomizeMergeFields;
  ...
  public
    class procedure SaveDocumentCore(ADocumentModel: TdxDocumentModel;
      AStream: TStream; AFormat: TdxRichEditDocumentFormat;
      const ATargetUri: string); overload; static;
  end;
  ...
  strict private
    ...
    FActiveViewTypeBeforeActiveViewCreation
      : TdxNullableValue<TdxRichEditViewType>;
    FReadOnly: Boolean;
    ...
    FCommandTable: TdxEnumeratedDictionary<TdxRichEditCommandId,
      TdxRichEditCommandClass>;
  ...
  protected
    ...
    function CreateSpellCheckerController
      : TdxSpellCheckerCustomController; virtual;
    function CreateSpellCheckerManager(APieceTable: TdxPieceTable)
    ...
    procedure ActivateMainPieceTable(const AControl: IdxRichEditControl;
      AStart: TdxDocumentLogPosition);
    procedure PerformRaiseDeferredEventsCore(const AChangeActions
      : TdxDocumentModelChangeActions); override;
    procedure OnOptionsChanged(ASender: TObject;
      E: TdxRichEditNotificationOptionsChangedArgs); override;
    ...
    procedure DocumentModelApplyChanges(AChangeActions
      : TdxDocumentModelChangeActions);
    procedure RedrawEnsureSecondaryFormattingComplete; overload; virtual;
    procedure RedrawEnsureSecondaryFormattingComplete(const AAction
      : TdxRefreshAction); overload; virtual;
    ...
    procedure ActivateView(AView: TdxRichEditView;
      const AViewBounds: TRect); virtual;
    ...
    function CreateBackgroundFormatter(AController
      : TdxDocumentFormattingController): TdxBackgroundFormatter; virtual;
    procedure SubscribeActiveViewEvents; virtual;
    procedure UnsubscribeActiveViewEvents; virtual;
    procedure OnActiveViewZoomChanging(ASender: TObject;
      E: TdxEventArgs); virtual;
    procedure OnActiveViewZoomChanged(ASender: TObject;
      E: TdxEventArgs); virtual;
    procedure OnActiveViewBackColorChanged(ASender: TObject;
      E: TdxEventArgs); virtual;
    ...
    function CalculateActualViewBounds(const APreviousViewBounds: TRect)
      : TRect; virtual;
    procedure OnUpdateUICore; virtual;
    procedure OnApplicationIdle; override;
    procedure OnOptionsChangedPlatformSpecific
      (E: TdxOptionChangedEventArgs); virtual;
    function ShouldApplyForeColor: Boolean;
    function ShouldApplyFont: Boolean;
    procedure ApplyFont(ACharacterProperties: TdxCharacterProperties;
      AFont: TFont); virtual;
    procedure ApplyFontAndForeColorCore(ACharacterProperties
      : TdxCharacterProperties); override;
    ...
    function GetHyperlinkCollection(AField: TdxField)
      : IdxRichEditHyperlinkCollection;
    function OnHyperlinkClick(AField: TdxField; AAllowForModifiers: Boolean)
      : Boolean; virtual;
    ...
    procedure SetDocumentModelLayoutUnitCore
      (AUnit: TdxDocumentLayoutUnit); override;
    procedure BeginScrollbarUpdate(const AScrollbar
      : IdxOfficeScrollbar); virtual;
    procedure EndScrollbarUpdate(const AScrollbar: IdxOfficeScrollbar); virtual;
    procedure LoadDocumentCore(const AParent
      : IdxInnerRichEditDocumentServerOwner); virtual;
    function ExportDocumentCore(const AParent
      : IdxInnerRichEditDocumentServerOwner; ACalc: TdxExportersCalculator)
      : Boolean; overload;
    function ExportDocumentCore(const AParent
      : IdxInnerRichEditDocumentServerOwner; ACalc: TdxExportersCalculator;
    ...
    function CreateKeyboardController: TdxCustomKeyboardController;
      virtual; abstract;
    function CreateMouseController: TdxRichEditCustomMouseController;
      virtual; abstract;
    procedure PopulateCommands; virtual;
    procedure RaiseDocumentProtectionChanged; override;
    property CommandTable: TdxEnumeratedDictionary<TdxRichEditCommandId,
      TdxRichEditCommandClass> read FCommandTable;

    property ForceUpdateUIOnIdle: Boolean read FForceUpdateUIOnIdle
      write FForceUpdateUIOnIdle;
  ...
  public
    ...
    constructor Create(const AOwner: IdxInnerRichEditControlOwner;
      ADpiX: Single; ADpiY: Single); overload;
    destructor Destroy; override;
    ...
    procedure LoadDocument(const AParent: IdxInnerRichEditDocumentServerOwner);
      overload; virtual;
    function SaveDocumentAs: Boolean; overload; virtual;
    function SaveDocumentAs(const AParent: IdxInnerRichEditDocumentServerOwner)
      : Boolean; overload; virtual;
    function SaveDocument: Boolean; overload; virtual;
    function SaveDocument(const AParent: IdxInnerRichEditDocumentServerOwner)
      : Boolean; overload; virtual;
    ...
    property BackgroundThreadUIUpdater: TdxBackgroundThreadUIUpdater
      read FBackgroundThreadUIUpdater write FBackgroundThreadUIUpdater;
    property ControlDeferredChanges: TdxRichEditControlDeferredChanges
    ...
    property KeyboardController: TdxCustomKeyboardController
      read FKeyboardController;
    property MouseController: TdxRichEditCustomMouseController
      read FMouseController;
    ...
    property VerticalScrollPosition: Int64 read GetVerticalScrollPosition
      write SetVerticalScrollPosition;
    property VerticalScrollValue: Int64 read GetVerticalScrollValue
      write SetVerticalScrollValue;
    ...
    property HyperlinkClick: TdxHyperlinkClickEventHandler
      read FOnHyperlinkClick;
    property VisiblePagesChanged: TdxNotifyEventHandler
      read FOnVisiblePagesChanged;
  end;
  ...
  public
    ...
    property Visibility: TdxRichEditScrollbarVisibility read FVisibility
      write SetVisibility default TdxRichEditScrollbarVisibility.Auto;
  end;
  ...
  public
    constructor Create(const ADocumentServer
      : IdxRichEditDocumentServer); override;
  protected
  published
    property Behavior;
  ...
  strict private
    ...
    procedure SetHorizontalScrollbar(const Value
      : TdxHorizontalScrollbarOptions);
  ...
  public
    ...
    property Fields;
    property HorizontalRuler;
    property HorizontalScrollBar: TdxHorizontalScrollbarOptions
      read FHorizontalScrollbar write SetHorizontalScrollbar;
    property Hyperlinks;
    property Layout;
    property MailMerge;
    property Bookmarks;
    property TableOptions;
    property VerticalRuler;
    property VerticalScrollBar: TdxVerticalScrollbarOptions
      read FVerticalScrollbar write SetVerticalScrollbar;
  end;

  { TdxDocumentChangesHandler }

  TdxDocumentChangesHandler = class abstract // for internal use
  strict private
    FFormattingController: TdxDocumentFormattingController;
    FFormatter: TdxBackgroundFormatter;
  protected
    ...
    procedure ProcessSelectionChanges(AChangeActions
      : TdxDocumentModelChangeActions); virtual; abstract;
    procedure ProcessSpellChanges(AChangeActions
      : TdxDocumentModelChangeActions); virtual; abstract;
  ...
  public
    ...
    function NotifyDocumentChanged(APieceTable: TdxCustomPieceTable;
      const AChanges: TdxDocumentModelDeferredChanges;
      ADebugSuppressControllerReset: Boolean;
      ADocumentLayoutResetType: TdxDocumentLayoutResetType)
      : TdxDocumentModelPosition; virtual;
    class function SetNewPosition(const APos: TdxDocumentModelPosition;
      AParagraph: TdxParagraphBase): TdxDocumentModelPosition; static;
    class function CalculateResetFromPosition(AFormattingController
      : TdxDocumentFormattingController; APieceTable: TdxCustomPieceTable;
      AChanges: TdxDocumentModelDeferredChanges;
      AResetType: TdxDocumentLayoutResetType): TdxDocumentModelPosition; static;
    ...
    class function EnsurePositionNotBeforeSectionBreakAfterParagraphBreak
      (const AModelPosition: TdxDocumentModelPosition)
      : TdxDocumentModelPosition; static;
    class function EnsureTopLevelParagraph(const APos: TdxDocumentModelPosition)
      : TdxDocumentModelPosition; static;
...
type
  ...
  TdxDocumentServerLayoutService = class(TInterfacedObject,
  ...
  strict private
    ...
    procedure OnDocumentModelBeforeEndDocumentUpdate(ASender: TObject;
      E: TdxDocumentUpdateCompleteEventArgs);
  protected
  ...
  public
    ...
    function CreateService(ADocumentModel: TdxDocumentModel)
      : IdxDocumentLayoutService;
...
constructor TdxDocumentServerLayoutService.Create
...
begin
  FServer.DocumentModel.BeforeEndDocumentUpdate.Add
    (OnDocumentModelBeforeEndDocumentUpdate);
end;

procedure TdxDocumentServerLayoutService.UnsubscribeEvents;
begin
  FServer.DocumentModel.BeforeEndDocumentUpdate.Remove
    (OnDocumentModelBeforeEndDocumentUpdate);
end;

procedure TdxDocumentServerLayoutService.OnDocumentModelBeforeEndDocumentUpdate
...
begin
  ...
  if AChanges * [TdxDocumentModelChangeAction.ResetAllPrimaryLayout,
    ...
    TdxDocumentModelChangeAction.ResetSecondaryLayout] <> [] then
    FreeAndNil(FCachedLayout);
end;

function TdxDocumentServerLayoutService.CalculateDocumentLayout
  : TdxDocumentLayout;
var
...
function TdxDocumentServerLayoutService.CreateService(ADocumentModel
  : TdxDocumentModel): IdxDocumentLayoutService;
var
  AServer: TdxInnerRichEditDocumentServer;
begin
  AServer := TdxInnerRichEditDocumentServer.Create(Server.Owner,
    ADocumentModel);
...
procedure TdxDocumentServerLayoutService.RemoveService(ADocumentModel
  : TdxDocumentModel);
var
...
begin
  ...
  AService := Safe<TdxDocumentServerLayoutService>.Cast
    (TObject(AContainer.GetService(IdxDocumentLayoutService)));
...
constructor TdxDocumentChangesHandler.Create(AFormatter
...
function TdxDocumentChangesHandler.NotifyDocumentChanged
...
begin
  ...
  AFrom := CalculateResetFromPosition(FormattingController, APieceTable,
    AChanges, ADocumentLayoutResetType);
  ATo := AChanges.ChangeEnd;
  if ATo < AFrom then
    ATo := AFrom;
  ProcessSpellChanges(AChanges.ChangeActions);

  if (ADocumentLayoutResetType = TdxDocumentLayoutResetType.AllPrimaryLayout)
    and not ADebugSuppressControllerReset then
  begin
    ResetPages;
  ...
  if ADocumentLayoutResetType = TdxDocumentLayoutResetType.PrimaryLayoutFormPosition
  then
  begin
...
class function TdxDocumentChangesHandler.SetNewPosition
  (const APos: TdxDocumentModelPosition; AParagraph: TdxParagraphBase)
  : TdxDocumentModelPosition;
begin
  Result := APos;
...
class function TdxDocumentChangesHandler.CalculateResetFromPosition
  (AFormattingController: TdxDocumentFormattingController;
  APieceTable: TdxCustomPieceTable; AChanges: TdxDocumentModelDeferredChanges;
...
begin
  ...
  begin
    ...
    if TdxSimplePieceTable(APieceTable).Paragraphs[AParagraphIndex]
      .ContextualSpacing and (AParagraphIndex > 0) then
      Dec(AParagraphIndex, 1);
    if AFormattingController.RowsController.TablesController.IsInsideTable then
    begin
      AState := Safe<TdxTablesControllerTableState>.Cast
        (AFormattingController.RowsController.TablesController.State);
      ATable := AState.TableViewInfoManager.TopLevelTableViewInfoManager.
        ColumnController.CurrentCell.TableViewInfo.Table;
    ...
    AModelPosition := TdxDocumentModelPosition.FromParagraphStart(APieceTable,
      AParagraphIndex);
    AModelPosition := EnsurePositionVisibleWhenHiddenTextNotShown
      (APieceTable.DocumentModel, AModelPosition);
...
class function TdxDocumentChangesHandler.
  EnsurePositionVisibleWhenHiddenTextNotShown(ADocumentModel
  : TdxCustomDocumentModel; const AModelPosition: TdxDocumentModelPosition)
  : TdxDocumentModelPosition;
var
...
class function TdxDocumentChangesHandler.
  EnsurePositionNotBeforeSectionBreakAfterParagraphBreak(const AModelPosition
  : TdxDocumentModelPosition): TdxDocumentModelPosition;
var
...
begin
  ...
  while (Result.RunIndex > 0) and (AParagraph.Length = 1) and
    (ARuns[Result.RunIndex] is TdxSectionRun) do
  begin
...
class function TdxDocumentChangesHandler.EnsureTopLevelParagraph
...
function TdxControlDocumentChangesHandler.NotifyDocumentChanged
  (APieceTable: TdxCustomPieceTable;
  const AChanges: TdxDocumentModelDeferredChanges;
  ADebugSuppressControllerReset: Boolean;
  ADocumentLayoutResetType: TdxDocumentLayoutResetType)
  : TdxDocumentModelPosition;
begin
  if TdxDocumentModelChangeAction.ActivePieceTableChanged in AChanges.ChangeActions
  then
    View.OnActivePieceTableChanged;

  Result := inherited NotifyDocumentChanged(APieceTable, AChanges,
    ADebugSuppressControllerReset, ADocumentLayoutResetType);
end;

procedure TdxControlDocumentChangesHandler.ProcessSelectionChanges
  (AChangeActions: TdxDocumentModelChangeActions);
begin
  View.ProcessSelectionChanges(AChangeActions);
end;

procedure TdxControlDocumentChangesHandler.ProcessSpellChanges
  (AChangeActions: TdxDocumentModelChangeActions);
begin
...
function TdxServerDocumentChangesHandler.NotifyDocumentChanged
  (APieceTable: TdxCustomPieceTable;
  const AChanges: TdxDocumentModelDeferredChanges;
  ADebugSuppressControllerReset: Boolean;
  ADocumentLayoutResetType: TdxDocumentLayoutResetType)
...
procedure TdxServerDocumentChangesHandler.ProcessSelectionChanges
  (AChangeActions: TdxDocumentModelChangeActions);
begin
end;

procedure TdxServerDocumentChangesHandler.ProcessSpellChanges
  (AChangeActions: TdxDocumentModelChangeActions);
begin
end;
...
constructor TdxDocumentContentChangedEventArgs.Create
  (ASuppressBindingNotifications: Boolean);
begin
  inherited Create;
...
constructor TdxInnerRichEditDocumentServer.Create(const AOwner
  : IdxInnerRichEditDocumentServerOwner; ADocumentModel: TdxDocumentModel);
begin
  Assert(AOwner <> nil);
  Assert(ADocumentModel <> nil);
...
constructor TdxInnerRichEditDocumentServer.Create(const AOwner
  : IdxInnerRichEditDocumentServerOwner; ADpiX: Single; ADpiY: Single);
begin
  Assert(AOwner <> nil);
  inherited Create;
...
function TdxInnerRichEditDocumentServer.GetService(const AServiceType
  : TdxServiceType): IInterface;
begin
  if DocumentModel <> nil then
...
procedure TdxInnerRichEditDocumentServer.AddService(const AServiceType
  : TdxServiceType; const AServiceInstance: IInterface);
begin
  if DocumentModel <> nil then
    (DocumentModel as IdxServiceContainer).AddService(AServiceType,
      AServiceInstance);
end;

procedure TdxInnerRichEditDocumentServer.AddService(const AServiceType
  : TdxServiceType; const AServiceInstance: IInterface; APromote: Boolean);
begin
  if DocumentModel <> nil then
    (DocumentModel as IdxServiceContainer).AddService(AServiceType,
      AServiceInstance, APromote);
end;

procedure TdxInnerRichEditDocumentServer.AddService(const AServiceType
  : TdxServiceType; const ACallback: IdxServiceCreatorCallback);
begin
  if DocumentModel <> nil then
...
procedure TdxInnerRichEditDocumentServer.RemoveService(const AServiceType
  : TdxServiceType);
begin
  if DocumentModel <> nil then
...
procedure TdxInnerRichEditDocumentServer.RemoveService(const AServiceType
  : TdxServiceType; APromote: Boolean);
begin
  if DocumentModel <> nil then
    (DocumentModel as IdxServiceContainer).RemoveService(AServiceType,
      APromote);
...
function TdxInnerRichEditDocumentServer.GetFormattingController
  : TdxDocumentFormattingController;
begin
  Result := FFormattingController;
end;

function TdxInnerRichEditDocumentServer.GetModelDocumentLayout
  : TdxDocumentLayout;
begin
...
function TdxInnerRichEditDocumentServer.GetBatchUpdateHelper
...
procedure TdxInnerRichEditDocumentServer.AddAfterExportHandler
  (const AHandler: TNotifyEvent);
begin
  FOnAfterExport.Add(AHandler);
end;

procedure TdxInnerRichEditDocumentServer.RemoveAfterExportHandler
  (const AHandler: TNotifyEvent);
begin
  FOnAfterExport.Remove(AHandler);
end;

procedure TdxInnerRichEditDocumentServer.AddSelectionChangedHandler
  (const AHandler: TNotifyEvent);
begin
  FOnSelectionChanged.Add(AHandler);
end;

procedure TdxInnerRichEditDocumentServer.RemoveSelectionChangedHandler
  (const AHandler: TNotifyEvent);
begin
  FOnSelectionChanged.Remove(AHandler);
end;

procedure TdxInnerRichEditDocumentServer.AddDocumentLoadedHandler
  (const AHandler: TNotifyEvent);
begin
  FOnDocumentLoaded.Add(AHandler);
end;

procedure TdxInnerRichEditDocumentServer.RemoveDocumentLoadedHandler
  (const AHandler: TNotifyEvent);
begin
  FOnDocumentLoaded.Remove(AHandler);
end;

procedure TdxInnerRichEditDocumentServer.AddEmptyDocumentCreatedHandler
  (const AHandler: TNotifyEvent);
begin
  FOnEmptyDocumentCreated.Add(AHandler);
end;

procedure TdxInnerRichEditDocumentServer.RemoveEmptyDocumentCreatedHandler
  (const AHandler: TNotifyEvent);
begin
  FOnEmptyDocumentCreated.Remove(AHandler);
end;

procedure TdxInnerRichEditDocumentServer.AddDocumentClosingHandler
  (const AHandler: TdxCloseQueryEvent);
begin
  FOnDocumentClosing.Add(AHandler);
end;

procedure TdxInnerRichEditDocumentServer.RemoveDocumentClosingHandler
  (const AHandler: TdxCloseQueryEvent);
begin
  FOnDocumentClosing.Remove(AHandler);
end;

procedure TdxInnerRichEditDocumentServer.AddContentChangedHandler
  (const AHandler: TNotifyEvent);
begin
  FOnContentChanged.Add(AHandler);
end;

procedure TdxInnerRichEditDocumentServer.RemoveContentChangedHandler
  (const AHandler: TNotifyEvent);
begin
  FOnContentChanged.Remove(AHandler);
end;

procedure TdxInnerRichEditDocumentServer.AddModifiedChangedHandler
  (const AHandler: TNotifyEvent);
begin
  FOnModifiedChanged.Add(AHandler);
end;

procedure TdxInnerRichEditDocumentServer.RemoveModifiedChangedHandler
  (const AHandler: TNotifyEvent);
begin
  FOnModifiedChanged.Remove(AHandler);
end;

procedure TdxInnerRichEditDocumentServer.AddUnitChangingHandler
  (const AHandler: TNotifyEvent);
begin
  FOnUnitChanging.Add(AHandler);
end;

procedure TdxInnerRichEditDocumentServer.RemoveUnitChangingHandler
  (const AHandler: TNotifyEvent);
begin
  FOnUnitChanging.Remove(AHandler);
end;

procedure TdxInnerRichEditDocumentServer.AddUnitChangedHandler
  (const AHandler: TNotifyEvent);
begin
  FOnUnitChanged.Add(AHandler);
end;

procedure TdxInnerRichEditDocumentServer.RemoveUnitChangedHandler
  (const AHandler: TNotifyEvent);
begin
  FOnUnitChanged.Remove(AHandler);
end;

procedure TdxInnerRichEditDocumentServer.AddCalculateDocumentVariableHandler
  (const AHandler: TdxCalculateDocumentVariableEvent);
begin
  FOnCalculateDocumentVariable.Add(AHandler);
end;

procedure TdxInnerRichEditDocumentServer.RemoveCalculateDocumentVariableHandler
  (const AHandler: TdxCalculateDocumentVariableEvent);
begin
  FOnCalculateDocumentVariable.Remove(AHandler);
end;

procedure TdxInnerRichEditDocumentServer.AddBeforeImportHandler
  (const AHandler: TdxBeforeImportEvent);
begin
  FOnBeforeImport.Add(AHandler);
end;

procedure TdxInnerRichEditDocumentServer.RemoveBeforeImportHandler
  (const AHandler: TdxBeforeImportEvent);
begin
  FOnBeforeImport.Remove(AHandler);
end;

procedure TdxInnerRichEditDocumentServer.AddBeforeExportHandler
  (const AHandler: TdxBeforeExportEvent);
begin
  FOnBeforeExport.Add(AHandler);
end;

procedure TdxInnerRichEditDocumentServer.RemoveBeforeExportHandler
  (const AHandler: TdxBeforeExportEvent);
begin
  FOnBeforeExport.Remove(AHandler);
end;

procedure TdxInnerRichEditDocumentServer.AddInitializeDocumentHandler
  (const AHandler: TdxEvent);
begin
  FOnInitializeDocument.Add(AHandler);
end;

procedure TdxInnerRichEditDocumentServer.RemoveInitializeDocumentHandler
  (const AHandler: TdxEvent);
begin
  FOnInitializeDocument.Remove(AHandler);
end;

procedure TdxInnerRichEditDocumentServer.AddRtfTextChangedHandler
  (const AHandler: TNotifyEvent);
begin
  FOnRtfTextChanged.Add(AHandler);
end;

procedure TdxInnerRichEditDocumentServer.RemoveRtfTextChangedHandler
  (const AHandler: TNotifyEvent);
begin
  FOnRtfTextChanged.Remove(AHandler);
end;

procedure TdxInnerRichEditDocumentServer.AddHtmlTextChangedHandler
  (const AHandler: TNotifyEvent);
begin
  FOnHtmlTextChanged.Add(AHandler);
end;

procedure TdxInnerRichEditDocumentServer.RemoveHtmlTextChangedHandler
  (const AHandler: TNotifyEvent);
begin
  FOnHtmlTextChanged.Remove(AHandler);
end;

procedure TdxInnerRichEditDocumentServer.SetLayoutCalculationMode
  (const AValue: TdxCalculationModeType);
begin
...
function TdxInnerRichEditDocumentServer.GetDefaultLayoutCalculationMode
  : TdxCalculationModeType;
begin
...
begin
  ...
  FModelDocumentLayout := TdxDocumentLayout.Create(DocumentModel,
    TdxExplicitBoxMeasurerProvider.Create(FMeasurer));
  FFormattingController := TdxPrintLayoutViewDocumentFormattingController.Create
    (ModelDocumentLayout, DocumentModel.MainPieceTable);
  FFormatter := TdxBackgroundFormatter.Create(FFormattingController,
    TdxCommentPadding.GetDefaultCommentPadding(DocumentModel));
  FFormatter.PageFormattingComplete.Add(OnPageFormattingComplete);
  FFormatter.Start;
end;

procedure TdxInnerRichEditDocumentServer.InitializeEmptyDocumentModel
...
procedure TdxInnerRichEditDocumentServer.OnPageFormattingComplete
  (ASender: TObject; E: TdxPageFormattingCompleteEventArgs);
var
...
procedure TdxInnerRichEditDocumentServer.OnDocumentLayoutChanged
  (ASender: TObject; E: TdxDocumentUpdateCompleteEventArgs);
var
  ADocumentLayoutResetType: TdxDocumentLayoutResetType;
...
begin
  if ModelDocumentLayout = nil then
    Exit;
  ADocumentLayoutResetType := CalculateDocumentLayoutResetType
    (E.DeferredChanges);
  ...
  begin
    ...
    AInvalidateFrom := NotifyDocumentLayoutChanged(AChangeStart.PieceTable,
      E.DeferredChanges, ADocumentLayoutResetType);

    AChangedPageIndex := ModelDocumentLayout.Pages.BinarySearchBoxIndex
      (AChangeStart.PieceTable, AInvalidateFrom.LogPosition);
...
function TdxInnerRichEditDocumentServer.NotifyDocumentLayoutChanged
  (APieceTable: TdxCustomPieceTable;
  const AChanges: TdxDocumentModelDeferredChanges;
  ADocumentLayoutResetType: TdxDocumentLayoutResetType)
  : TdxDocumentModelPosition;
...
begin
  ...
  try
    Result := AHandler.NotifyDocumentChanged(APieceTable, AChanges, False,
      ADocumentLayoutResetType);
  finally
    AHandler.Free;
  end;
end;
...
procedure TdxInnerRichEditDocumentServer.RaiseDocumentLayoutInvalidated
  (AArgs: TdxDocumentLayoutInvalidatedEventArgs);
begin
...
procedure TdxInnerRichEditDocumentServer.RaisePageFormatted
  (AArgs: TdxPageFormattedEventArgs);
begin
...
function TdxInnerRichEditDocumentServer.GetDocumentModelTemplate
  : TdxDocumentModel;
begin
...
function TdxInnerRichEditDocumentServer.GetNumberingListsTemplate
...
procedure TdxInnerRichEditDocumentServer.SetLayoutUnitProperty
  (const AValue: TdxDocumentLayoutUnit);
begin
...
function TdxInnerRichEditDocumentServer.CreateNativeDocument
  : IdxRichEditDocument;
begin
  Result := nil;
end;

function TdxInnerRichEditDocumentServer.CreateNativeSubDocument
...
procedure TdxInnerRichEditDocumentServer.SetMeasurementUnitProperty
  (AValue: TdxMeasurementUnit);
begin
...
function TdxInnerRichEditDocumentServer.GetOwner
  : IdxInnerRichEditDocumentServerOwner;
begin
  Result := FOwner;
end;

function TdxInnerRichEditDocumentServer.GetDocumentLayout
...
function TdxInnerRichEditDocumentServer.CreateDocumentLayout
  : TdxRichEditDocumentLayout;
var
...
procedure TdxInnerRichEditDocumentServer.RaiseContentChanged
  (ASuppressBindingNotifications: Boolean);
var
...
begin
  if FOnContentChanged.Empty then
    Exit;
  AArgs := TdxDocumentContentChangedEventArgs.Create
    (ASuppressBindingNotifications);
  try
...
function TdxInnerRichEditDocumentServer.RaiseCalculateDocumentVariable
  (AArgs: TdxCalculateDocumentVariableEventArgs): Boolean;
begin
...
procedure TdxInnerRichEditDocumentServer.RaiseBeforeImport
  (AArgs: TdxBeforeImportEventArgs);
begin
...
procedure TdxInnerRichEditDocumentServer.RaiseBeforeExport
  (AArgs: TdxBeforeExportEventArgs);
begin
...
procedure TdxInnerRichEditDocumentServer.RaiseInitializeDocument
  (AArgs: TdxEventArgs);
begin
...
procedure TdxInnerRichEditDocumentServer.RaiseInvalidFormatException
  (E: Exception);
var
...
function TdxInnerRichEditDocumentServer.RaiseUnhandledException
  (E: Exception): Boolean;
var
...
function TdxInnerRichEditDocumentServer.RaiseCustomizeMergeFields
  (AArgs: TdxCustomizeMergeFieldsEventArgs): TArray<IdxRichEditMergeFieldName>;
begin
...
procedure TdxInnerRichEditDocumentServer.RaiseMailMergeStarted
  (AArgs: TdxMailMergeStartedEventArgs);
begin
  if not FOnMailMergeStarted.Empty then
    FOnMailMergeStarted.Invoke(Owner.Control, AArgs);
end;

procedure TdxInnerRichEditDocumentServer.RaiseMailMergeRecordStarted
  (AArgs: TdxMailMergeRecordStartedEventArgs);
begin
  if not FOnMailMergeRecordStarted.Empty then
    FOnMailMergeRecordStarted.Invoke(Owner.Control, AArgs);
end;

procedure TdxInnerRichEditDocumentServer.RaiseMailMergeRecordFinished
  (AArgs: TdxMailMergeRecordFinishedEventArgs);
begin
  if not FOnMailMergeRecordFinished.Empty then
    FOnMailMergeRecordFinished.Invoke(Owner.Control, AArgs);
end;

procedure TdxInnerRichEditDocumentServer.RaiseMailMergeFinished
  (AArgs: TdxMailMergeFinishedEventArgs);
begin
  if not FOnMailMergeFinished.Empty then
    FOnMailMergeFinished.Invoke(Owner.Control, AArgs);
end;

procedure TdxInnerRichEditDocumentServer.RaiseMailMergeGetTargetDocument
...
procedure TdxInnerRichEditDocumentServer.RaiseBeforePagePaint
...
begin
  AddService(IdxDocumentLayoutService,
    TdxDocumentServerLayoutService.Create(Self));
end;
...
function TdxInnerRichEditDocumentServer.GetDocumentLayoutInvalidated
  : TdxDocumentLayoutInvalidatedEventHandler;
begin
...
function TdxInnerRichEditDocumentServer.GetPageFormatted
  : TdxPageFormattedEventHandler;
begin
...
begin
  ...
  try
    TdxDefaultNumberingListHelper.InsertNumberingLists(FDocumentModelTemplate,
      DocumentModel.UnitConverter,
      DocumentModel.DocumentProperties.DefaultTabWidth);
  finally
    FDocumentModelTemplate.EndSetContent(TdxDocumentModelChangeType.None,
      False, nil);
  end;
end;
...
function TdxInnerRichEditDocumentServer.CreateDocumentModelCore
  : TdxDocumentModel;
begin
...
procedure TdxInnerRichEditDocumentServer.OnInnerSelectionChanged
  (ASender: TObject);
begin
end;

procedure TdxInnerRichEditDocumentServer.OnBeginDocumentUpdate(ASender: TObject;
  E: TdxEventArgs);
begin
...
procedure TdxInnerRichEditDocumentServer.OnEndDocumentUpdate(ASender: TObject;
  E: TdxDocumentUpdateCompleteEventArgs);
begin
...
function TdxInnerRichEditDocumentServer.ProcessEndDocumentUpdateCore
  (ASender: TObject; E: TdxDocumentUpdateCompleteEventArgs)
  : TdxDocumentModelChangeActions;
begin
  ...
  begin
    ...
    FDocumentDeferredChangesOnIdle.ChangeActions :=
      FDocumentDeferredChangesOnIdle.ChangeActions + Result;
    FDocumentDeferredChangesOnIdle.ChangeActions :=
      FDocumentDeferredChangesOnIdle.ChangeActions -
      [TdxDocumentModelChangeAction.PerformActionsOnIdle];
    FDocumentDeferredChangesOnIdle.StartRunIndex :=
      Min(E.DeferredChanges.ChangeStart.RunIndex,
      FDocumentDeferredChangesOnIdle.StartRunIndex);
    FDocumentDeferredChangesOnIdle.EndRunIndex :=
      Max(E.DeferredChanges.ChangeEnd.RunIndex,
      FDocumentDeferredChangesOnIdle.EndRunIndex);
    Result := [];
  end;

  if [TdxDocumentModelChangeAction.RaiseEmptyDocumentCreated,
    TdxDocumentModelChangeAction.RaiseDocumentLoaded] * Result <> [] then
    ApplyFontAndForeColor;
end;

function TdxInnerRichEditDocumentServer.OnEndDocumentUpdateCore
  (ASender: TObject; E: TdxDocumentUpdateCompleteEventArgs)
  : TdxDocumentModelChangeActions;
begin
...
procedure TdxInnerRichEditDocumentServer.OnInnerContentChanged(ASender: TObject;
  E: TdxEventArgs);
begin
end;

procedure TdxInnerRichEditDocumentServer.OnContentChanged(ASender: TObject;
  E: TdxEventArgs);
begin
  OnContentChangedCore(False, False);
end;

procedure TdxInnerRichEditDocumentServer.OnContentChangedCore
  (ASuppressBindingNotifications: Boolean; ASuppressUpdateUI: Boolean);
begin
...
procedure TdxInnerRichEditDocumentServer.OnModifiedChanged(ASender: TObject;
  E: TdxEventArgs);
begin
...
procedure TdxInnerRichEditDocumentServer.OnCalculateDocumentVariable
  (ASender: TObject; E: TdxCalculateDocumentVariableEventArgs);
begin
  RaiseCalculateDocumentVariable(E);
end;

procedure TdxInnerRichEditDocumentServer.OnMailMergeStarted(ASender: TObject;
  const E: TdxMailMergeStartedEventArgs);
begin
  RaiseMailMergeStarted(E);
end;

procedure TdxInnerRichEditDocumentServer.OnMailMergeRecordStarted
  (ASender: TObject; const E: TdxMailMergeRecordStartedEventArgs);
begin
  RaiseMailMergeRecordStarted(E);
end;

procedure TdxInnerRichEditDocumentServer.OnMailMergeRecordFinished
  (ASender: TObject; const E: TdxMailMergeRecordFinishedEventArgs);
begin
  RaiseMailMergeRecordFinished(E);
end;

procedure TdxInnerRichEditDocumentServer.OnMailMergeFinished(ASender: TObject;
  const E: TdxMailMergeFinishedEventArgs);
begin
  RaiseMailMergeFinished(E);
end;

procedure TdxInnerRichEditDocumentServer.OnMailMergeGetTargetDocument
  (ASender: TObject; const E: TdxMailMergeGetTargetDocumentEventArgs);
begin
  RaiseMailMergeGetTargetDocument(E);
end;

procedure TdxInnerRichEditDocumentServer.OnPageBackgroundChanged
...
procedure TdxInnerRichEditDocumentServer.OnBeforeExport(ASender: TObject;
  E: TdxBeforeExportEventArgs);
begin
  RaiseBeforeExport(E);
end;

procedure TdxInnerRichEditDocumentServer.OnBeforeImport(ASender: TObject;
  E: TdxBeforeImportEventArgs);
begin
  RaiseBeforeImport(E);
end;

procedure TdxInnerRichEditDocumentServer.OnDocumentCleared(ASender: TObject;
  E: TdxEventArgs);
begin
  RaiseInitializeDocument(E);
end;

procedure TdxInnerRichEditDocumentServer.OnInvalidFormatException
  (ASender: TObject; E: TdxRichEditInvalidFormatExceptionEventArgs);
begin
...
procedure TdxInnerRichEditDocumentServer.OnActivePieceTableChanged
  (ASender: TObject; E: TdxEventArgs);
begin
...
function TdxInnerRichEditDocumentServer.GetDefaultCharacterProperties
...
procedure TdxInnerRichEditDocumentServer.ApplyFontAndForeColorCore
  (ACharacterProperties: TdxCharacterProperties);
begin
end;

procedure TdxInnerRichEditDocumentServer.ApplyChangesCore(const AChangeActions
  : TdxDocumentModelChangeActions);
begin
  if DocumentModel.IsUpdateLocked then
    DocumentDeferredChanges.ChangeActions :=
      DocumentDeferredChanges.ChangeActions + AChangeActions
  else
    RaiseDeferredEvents(AChangeActions);
end;

procedure TdxInnerRichEditDocumentServer.PerformRaiseDeferredEventsCore
  (const AChangeActions: TdxDocumentModelChangeActions);
var
  ASuppressBindingNotifications, ASuppressUpdateUI: Boolean;
begin
  if TdxDocumentModelChangeAction.RaiseEmptyDocumentCreated in AChangeActions
  then
  ...
  begin
    ASuppressBindingNotifications :=
      TdxDocumentModelChangeAction.SuppressBindingsNotifications
      in AChangeActions;
    ASuppressUpdateUI := TdxDocumentModelChangeAction.RaiseSelectionChanged
      in AChangeActions;
  ...
  if TdxDocumentModelChangeAction.RaiseDocumentProtectionChanged in AChangeActions
  then
    RaiseDocumentProtectionChanged;
end;

procedure TdxInnerRichEditDocumentServer.RaiseDeferredEventsCore
  (const AChangeActions: TdxDocumentModelChangeActions);
begin
...
procedure TdxInnerRichEditDocumentServer.RaiseDeferredEvents
  (const AChangeActions: TdxDocumentModelChangeActions);
begin
  Owner.RaiseDeferredEvents(AChangeActions);
end;

function TdxInnerRichEditDocumentServer.CreateMeasurementAndDrawingStrategy
...
function TdxInnerRichEditDocumentServer.CreateOptions
...
procedure TdxInnerRichEditDocumentServer.OnOptionsChanged(ASender: TObject;
  E: TdxRichEditNotificationOptionsChangedArgs);
begin
  if [TdxRichEditOptionsAction.DataSource,
    TdxRichEditOptionsAction.ViewMergedData] * E.Actions <> [] then
...
begin
  ...
  try
    ...
    try
      ...
      DocumentModel.MailMergeProperties.ViewMergedData :=
        AOptions.ViewMergedData;
...
procedure TdxInnerRichEditDocumentServer.SetMeasurementUnit
  (AValue: TdxMeasurementUnit);
begin
  RaiseUnitChanging;
...
procedure TdxInnerRichEditDocumentServer.SetLayoutUnit
  (AUnit: TdxDocumentLayoutUnit);
begin
  BeginUpdate;
  try
...
procedure TdxInnerRichEditDocumentServer.SetLayoutUnitCore
  (AUnit: TdxDocumentLayoutUnit);
begin
  SetDocumentModelLayoutUnit(AUnit);
end;

procedure TdxInnerRichEditDocumentServer.SetDocumentModelLayoutUnit
  (AUnit: TdxDocumentLayoutUnit);
begin
  DocumentModel.BeginUpdate;
  try
...
procedure TdxInnerRichEditDocumentServer.SetDocumentModelLayoutUnitCore
  (AUnit: TdxDocumentLayoutUnit);
begin
...
function TdxInnerRichEditDocumentServer.CreateNewDocument(ARaiseDocumentClosing
  : Boolean): Boolean;
begin
  if Modified then
...
procedure TdxInnerRichEditDocumentServer.LoadDocument(AStream: TStream;
  ADocumentFormat: TdxRichEditDocumentFormat);
begin
  LoadDocumentCore(AStream, ADocumentFormat, '');
end;

procedure TdxInnerRichEditDocumentServer.LoadDocumentTemplate(AStream: TStream;
  ADocumentFormat: TdxRichEditDocumentFormat);
begin
  LoadDocumentCore(AStream, ADocumentFormat, '');
end;

function TdxInnerRichEditDocumentServer.LoadDocumentCore(AStream: TStream;
  ADocumentFormat: TdxRichEditDocumentFormat; const ASourceUri: string)
  : Boolean;
var
...
begin
  ...
  if ADocumentFormat <> TdxRichEditDocumentFormat.Undefined then
    if TryLoadDocument(AStream, ADocumentFormat, ASourceUri) then
      Exit(True);
  if Supports(AImportManagerService, IdxDocumentFormatRating, AFormatDetector)
  then
  begin
  ...
  ARatings := AFormatDetector.CalculateDocumentFormatRating(AStream,
    ADocumentFormat);
...
procedure TdxInnerRichEditDocumentServer.LoadDocumentTemplate
  (const AFileName: string);
begin
  LoadDocumentTemplate(AFileName, TdxRichEditDocumentFormat.Undefined);
end;

procedure TdxInnerRichEditDocumentServer.LoadDocumentTemplate(const AFileName
  : string; ADocumentFormat: TdxRichEditDocumentFormat);
begin
...
function TdxInnerRichEditDocumentServer.TryLoadDocument(AStream: TStream;
  ADocumentFormat: TdxRichEditDocumentFormat; const ASourceUri: string)
  : Boolean;
var
  ASuccess: Boolean;
...
procedure TdxInnerRichEditDocumentServer.SaveDocument(AStream: TStream;
  ADocumentFormat: TdxRichEditDocumentFormat);
begin
...
procedure TdxInnerRichEditDocumentServer.SaveDocument(const AFileName: string;
  ADocumentFormat: TdxRichEditDocumentFormat);
begin
  SaveDocumentCore(AFileName, ADocumentFormat,
    DocumentModel.DocumentSaveOptions);
end;
...
procedure TdxInnerRichEditDocumentServer.SaveDocumentCore(const AFileName
  : string; ADocumentFormat: TdxRichEditDocumentFormat;
  const AOptions: TdxDocumentSaveOptions);
var
...
function TdxInnerRichEditDocumentServer.GetEncryptionPassword(Sender: TObject;
...
function TdxInnerRichEditDocumentServer.CreateMailMergeOptions
  : IdxRichEditMailMergeOptions;
begin
  Result := nil;
end;

procedure TdxInnerRichEditDocumentServer.MailMerge(const ADocument
  : IdxRichEditDocument);
var
...
procedure TdxInnerRichEditDocumentServer.MailMerge(const AOptions
...
procedure TdxInnerRichEditDocumentServer.MailMerge(const AFileName: string;
  AFormat: TdxRichEditDocumentFormat);
begin
  MailMerge(CreateMailMergeOptions, AFileName, AFormat);
end;

procedure TdxInnerRichEditDocumentServer.MailMerge(AStream: TStream;
  AFormat: TdxRichEditDocumentFormat);
var
  AOptions: IdxRichEditMailMergeOptions;
begin
...
begin
  ...
  try
    ...
    try
      AEventRouter := TdxCalculateDocumentVariableEventRouter.Create
        (DocumentModel);
      AResultDocumentModel.CalculateDocumentVariable.Add
        (AEventRouter.OnCalculateDocumentVariable);
      try
        AResultDocumentModel.DocumentExportOptions.CopyFrom
          (DocumentModel.DocumentExportOptions);
        MailMerge(AOptions, AResultDocumentModel);
        SaveDocumentCore(AResultDocumentModel, AStream, AFormat, AFileName);
        AStream.SaveToFile(AFileName);
      finally
        AResultDocumentModel.CalculateDocumentVariable.Remove
          (AEventRouter.OnCalculateDocumentVariable);
      end;
    finally
...
procedure TdxInnerRichEditDocumentServer.MailMerge(const AOptions
  : IdxRichEditMailMergeOptions; ATargetModel: TdxDocumentModel);
var
...
begin
  ...
  try
    ...
    ATargetModel.DocumentSaveOptions.CurrentFileName :=
      DocumentModel.DocumentSaveOptions.CurrentFileName;
    AInnerOptions := GetMailMergeOptions(AOptions);
    try
      AHasDataSet := (AInnerOptions.DataSource <> nil) and
        (AInnerOptions.DataSource.DataSet <> nil);
      if AHasDataSet then
        AInnerOptions.DataSource.DataSet.DisableControls;
      try
        AMergeHelper := TdxMailMergeHelper.Create(FOwner, DocumentModel,
          AInnerOptions);
        try
...
function TdxInnerRichEditDocumentServer.GetMailMergeOptions(const AOptions
  : IdxRichEditMailMergeOptions): TdxMailMergeOptions;
begin
  Result := nil;
end;

class procedure TdxInnerRichEditDocumentServer.SaveDocumentCore
  (ADocumentModel: TdxDocumentModel; AStream: TStream;
...
begin
  AExportManagerService :=
    ADocumentModel.GetService<IdxDocumentExportManagerService>;
  if AExportManagerService = nil then
    TdxRichEditExceptions.ThrowInvalidOperationException
      ('Could not find service: IdxDocumentExportManagerService');

  AExportHelper := ADocumentModel.CreateDocumentExportHelper(AFormat)
    as TdxExportHelper;
  try
...
function TdxInnerRichEditDocumentServer.CreateCopySelectionManager
...
constructor TdxInnerRichEditControl.Create(const AOwner
  : IdxInnerRichEditControlOwner; ADpiX: Single; ADpiY: Single);
begin
  inherited Create(AOwner, ADpiX, ADpiY);
  FGestureActivated := False;
  FCommandTable := TdxEnumeratedDictionary<TdxRichEditCommandId,
    TdxRichEditCommandClass>.Create;
  PopulateCommands;
...
function TdxInnerRichEditControl.CreateCopySelectionManager
  : TdxCopySelectionManager;
begin
  Result := TdxCopySelectionManager.Create(Self);
end;

function TdxInnerRichEditControl.CreateMouseCursorCalculator
...
function TdxInnerRichEditControl.GetMouseController
...
function TdxInnerRichEditControl.GetPredefinedFontSizeCollection
...
procedure TdxInnerRichEditControl.SetOnSearchComplete
  (const Value: TdxSearchCompleteEvent);
begin
  FOnSearchComplete := Value;
end;

procedure TdxInnerRichEditControl.DoSearchComplete
  (E: TdxSearchCompleteEventArgs);
begin
...
function TdxInnerRichEditControl.CreateSpellCheckerController
...
function TdxInnerRichEditControl.CreateSpellCheckerManager
...
function TdxInnerRichEditControl.GetFormattingController
  : TdxDocumentFormattingController;
begin
...
begin
  ...
  else if FActiveViewTypeBeforeActiveViewCreation.HasValue then
    Result := FActiveViewTypeBeforeActiveViewCreation.Value
  else
    Result := DefaultViewType;
end;

procedure TdxInnerRichEditControl.SetActiveViewType(const AValue
  : TdxRichEditViewType);
begin
  if ActiveView = nil then
  begin
...
procedure TdxInnerRichEditControl.SetMeasurementUnit
  (AValue: TdxMeasurementUnit);
begin
...
begin
  ...
  begin
    ...
    begin
      if TdxDocumentModelChangeAction.ResetSelectionLayout in AChangeActions
      then
        ActiveView.SelectionLayout.Invalidate;
      if TdxDocumentModelChangeAction.ScrollToBeginOfDocument in AChangeActions
      then
...
procedure TdxInnerRichEditControl.ApplyChangesCore(const AChangeActions
  : TdxDocumentModelChangeActions);
begin
  if not DocumentModel.IsUpdateLocked then
  begin
...
procedure TdxInnerRichEditControl.ActivateMainPieceTable(const AControl
  : IdxRichEditControl; AStart: TdxDocumentLogPosition);
var
...
begin
  ...
  try
    ACommand := TdxChangeActivePieceTableCommand.Create(AControl,
      DocumentModel.MainPieceTable, nil, -1);
    try
      ACommand.Execute;
...
procedure TdxInnerRichEditControl.PerformRaiseDeferredEventsCore
  (const AChangeActions: TdxDocumentModelChangeActions);
begin
  ...
  begin
    if TdxDocumentModelChangeAction.ResetRuler in AChangeActions then
      UpdateRulers;
    if TdxDocumentModelChangeAction.ForceResetHorizontalRuler in AChangeActions
    then
      UpdateHorizontalRuler;
    if TdxDocumentModelChangeAction.ForceResetVerticalRuler in AChangeActions
    then
      UpdateVerticalRuler;
  end;
...
procedure TdxInnerRichEditControl.OnOptionsChanged(ASender: TObject;
  E: TdxRichEditNotificationOptionsChangedArgs);
begin
  ...
  if [TdxRichEditOptionsAction.ParagraphMark,
    TdxRichEditOptionsAction.TabCharacter, TdxRichEditOptionsAction.Space] *
    E.Actions <> [] then
  ...
  if [TdxRichEditOptionsAction.ShowLeftIndent,
    TdxRichEditOptionsAction.ShowRightIndent, TdxRichEditOptionsAction.ShowTabs]
    * E.Actions <> [] then
    OnOptionsHorizontalRulerChanged;

  if [TdxRichEditOptionsAction.ParagraphTabs, TdxRichEditOptionsAction.Sections,
...
begin
  ...
  try
    ...
    begin
      ...
      DocumentModel.ResetSpellCheck(APieceTable,
        APieceTable.Runs.First.GetRunIndex,
        APieceTable.Runs.Last.GetRunIndex, False);
    end;
  finally
    APieceTables.Free;
  end;
...
procedure TdxInnerRichEditControl.DocumentModelApplyChanges(AChangeActions
  : TdxDocumentModelChangeActions);
var
  APieceTable: TdxPieceTable;
begin
...
procedure TdxInnerRichEditControl.RedrawEnsureSecondaryFormattingComplete
  (const AAction: TdxRefreshAction);
begin
...
function TdxInnerRichEditControl.CreateViewRepository
...
begin
  ...
  if FActiveViewTypeBeforeActiveViewCreation.HasValue then
    SetActiveViewCore(FViews.GetViewByType
      (FActiveViewTypeBeforeActiveViewCreation.Value))
  else
...
procedure TdxInnerRichEditControl.DeactivateViewAndClearActiveView
...
procedure TdxInnerRichEditControl.ActivateView(AView: TdxRichEditView;
  const AViewBounds: TRect);
begin
...
function TdxInnerRichEditControl.GetDefaultLayoutCalculationMode
  : TdxCalculationModeType;
begin
  Result := TdxCalculationModeType.Automatic;
end;

function TdxInnerRichEditControl.NotifyDocumentLayoutChanged
  (APieceTable: TdxCustomPieceTable;
  const AChanges: TdxDocumentModelDeferredChanges;
  ADocumentLayoutResetType: TdxDocumentLayoutResetType)
  : TdxDocumentModelPosition;
...
begin
  InitializeDocumentLayout;
  BackgroundFormatter := CreateBackgroundFormatter
    (ActiveView.FormattingController);
...
procedure TdxInnerRichEditControl.OnActiveViewZoomChanging(ASender: TObject;
  E: TdxEventArgs);
begin
  BeginUpdate;
...
procedure TdxInnerRichEditControl.OnActiveViewZoomChanged(ASender: TObject;
  E: TdxEventArgs);
begin
  OnResizeCore;
...
procedure TdxInnerRichEditControl.OnActiveViewBackColorChanged(ASender: TObject;
  E: TdxEventArgs);
begin
  Owner.OnActiveViewBackColorChanged;
end;

procedure TdxInnerRichEditControl.ActivateViewPlatformSpecific
  (AView: TdxRichEditView);
begin
  Owner.ActivateViewPlatformSpecific(AView);
end;

procedure TdxInnerRichEditControl.DeactivateViewPlatformSpecific
  (AView: TdxRichEditView);
begin
end;
...
function TdxInnerRichEditControl.CalculateActualViewBounds
...
procedure TdxInnerRichEditControl.OnOptionsChangedPlatformSpecific
  (E: TdxOptionChangedEventArgs);
begin
  Owner.OnOptionsChangedPlatformSpecific(E);
end;

procedure TdxInnerRichEditControl.ApplyFontAndForeColorCore(ACharacterProperties
  : TdxCharacterProperties);
begin
...
procedure TdxInnerRichEditControl.ApplyFont(ACharacterProperties
  : TdxCharacterProperties; AFont: TFont);
begin
...
procedure TdxInnerRichEditControl.ApplyChangesCorePlatformSpecific
  (AChangeActions: TdxDocumentModelChangeActions);
begin
...
function TdxInnerRichEditControl.GetHyperlinkCollection(AField: TdxField)
  : IdxRichEditHyperlinkCollection;
var
    ...
    begin
      ...
      begin
        ...
        if AShape.TextBox = nil then
          Continue;
        ADocument := Safe<TdxNativeSubDocumentBase>.Cast
          (TObject(AShape.TextBox.Document));
...
function TdxInnerRichEditControl.OnHyperlinkClick(AField: TdxField;
...
begin
  ...
  Result := (AHyperlinks <> nil) and AHyperlinks.FindHyperlink(AField.Index,
    AHyperlink);
  if not Result then
    Exit;

  E := TdxHyperlinkClickEventArgs.Create(AHyperlink,
    TdxKeyboardHelper.ModifierKeys);
  try
  ...
  if not Result and (not AAllowForModifiers or IsHyperlinkModifierKeysPress)
  then
  begin
...
begin
  ...
  AModifierKeys := (AModifierKeys or AShortCut) and
    (scShift or scCtrl or scAlt);
...
function TdxInnerRichEditControl.UnitsToLayoutUnits(const APoint
  : TdxPointF): TPoint;
begin
end;

function TdxInnerRichEditControl.LayoutUnitsToUnits(const ASize: TSize)
  : TdxSizeF;
begin
end;

function TdxInnerRichEditControl.LayoutUnitsToUnits(const ABounds: TRect)
  : TdxRectF;
begin
end;

function TdxInnerRichEditControl.CreateCommand(ACommandId: TdxRichEditCommandId)
  : TdxRichEditCommand;
var
...
procedure TdxInnerRichEditControl.ScrollToCaret
  (ARelativeVerticalPosition: Single);
var
...
begin
  BeginUpdate;
  try
    AScrollVertically := TdxEnsureCaretVisibleVerticallyCommand.Create
      (Owner.RichEditControl);
    try
    ...
    AScrollHorizontally := TdxEnsureCaretVisibleHorizontallyCommand.Create
      (Owner.RichEditControl);
    try
...
begin
  if AAvoidJump then
    ActiveView.VerticalScrollController.ScrollBarAdapter.
...
procedure TdxInnerRichEditControl.DoShortCut
...
procedure TdxInnerRichEditControl.SetLayoutUnitCore
  (AUnit: TdxDocumentLayoutUnit);
begin
...
procedure TdxInnerRichEditControl.SetDocumentModelLayoutUnitCore
  (AUnit: TdxDocumentLayoutUnit);
begin
  if ActiveView <> nil then
...
procedure TdxInnerRichEditControl.BeginScrollbarUpdate(const AScrollbar
  : IdxOfficeScrollbar);
begin
...
procedure TdxInnerRichEditControl.EndScrollbarUpdate(const AScrollbar
  : IdxOfficeScrollbar);
begin
  if AScrollbar <> nil then
...
procedure TdxInnerRichEditControl.LoadDocument(const AParent
  : IdxInnerRichEditDocumentServerOwner);
begin
  LoadDocumentCore(AParent);
end;

procedure TdxInnerRichEditControl.LoadDocumentCore(const AParent
  : IdxInnerRichEditDocumentServerOwner);
var
  AImportManagerService: IdxDocumentImportManagerService;
...
begin
  ...
  try
    AImportSource := AImportHelper.InvokeImportDialog(AParent.Control,
...
function TdxInnerRichEditControl.SaveDocumentAs(const AParent
  : IdxInnerRichEditDocumentServerOwner): Boolean;
begin
  Result := ExportDocumentCore(AParent, nil);
end;

function TdxInnerRichEditControl.ExportDocumentCore(const AParent
  : IdxInnerRichEditDocumentServerOwner; ACalc: TdxExportersCalculator)
  : Boolean;
var
...
function TdxInnerRichEditControl.ExportDocumentCore(const AParent
  : IdxInnerRichEditDocumentServerOwner; ACalc: TdxExportersCalculator;
  const AOptions: IdxDocumentSaveOptions): Boolean;
var
  AExportManagerService: IdxDocumentExportManagerService;
...
begin
  ...
  try
    ATarget := AExportHelper.InvokeExportDialog(AParent.Control,
      AExportManagerService, ACalc);
    try
      if ATarget = nil then
        Exit(False);
      AOldCursor := Screen.Cursor;
...
function TdxInnerRichEditControl.SaveDocument(const AParent
  : IdxInnerRichEditDocumentServerOwner): Boolean;
var
  ADocumentSaveOptions: TdxDocumentSaveOptions;
begin
  ADocumentSaveOptions := DocumentModel.DocumentSaveOptions;
  if not ADocumentSaveOptions.CanSaveToCurrentFileName or
    (ADocumentSaveOptions.CurrentFileName = '') or
    (ADocumentSaveOptions.CurrentFormat = TdxRichEditDocumentFormat.Undefined)
  then
    Result := SaveDocumentAs(AParent)
  else
  begin
    SaveDocument(ADocumentSaveOptions.CurrentFileName,
      ADocumentSaveOptions.CurrentFormat);
    Result := True;
  end;
end;
...
procedure TdxInnerRichEditControl.RaiseSearchComplete
  (E: TdxSearchCompleteEventArgs);
begin
end;
...
procedure TdxInnerRichEditControl.RaiseHyperlinkClick
...
procedure TdxInnerRichEditControl.RegisterCommand(ACommandClass
  : TdxRichEditCommandClass);
begin
  CommandTable.AddOrSetValue(ACommandClass.Id, ACommandClass);
end;

procedure TdxInnerRichEditControl.UnregisterCommand(ACommandClass
  : TdxRichEditCommandClass);
begin
...
procedure TdxRichEditScrollbarOptions.SetVisibility
  (const Value: TdxRichEditScrollbarVisibility);
begin
...
constructor TdxRichEditDocumentServerOptions.Create(const ADocumentServer
  : IdxRichEditDocumentServer);
begin
...
procedure TdxRichEditControlCustomOptions.SetHorizontalScrollbar
  (const Value: TdxHorizontalScrollbarOptions);
begin
  FHorizontalScrollbar.Assign(Value);
end;

procedure TdxRichEditControlCustomOptions.SetVerticalScrollbar
  (const Value: TdxVerticalScrollbarOptions);
begin
