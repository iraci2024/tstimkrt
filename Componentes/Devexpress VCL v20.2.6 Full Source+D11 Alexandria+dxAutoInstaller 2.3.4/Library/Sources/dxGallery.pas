...
type
  ...
  TdxGalleryItemEvent = procedure(Sender: TObject; AItem: TdxGalleryItem)
    of object;
  TdxGalleryItemCheckMode = (icmNone, icmSingleCheck, icmSingleRadio,
    icmMultiple { ,
      icmSingleCheckInGroup, icmSingleRadioInGroup, icmMultipleInGroup } );
  TdxGalleryChangeType = (gctLight, gctHard);
  TdxGalleryChangeEvent = procedure(Sender: TObject;
    AChangeType: TdxGalleryChangeType) of object;
  ...
  IdxGallery2 = interface
    ...
    property OnItemClick: TdxGalleryItemEvent read GetOnItemClick
  ...
  TdxCustomGalleryItems = class(TcxInterfacedComponentCollection,
    IdxGalleryItems)
  strict private
    // IdxGalleryItems
  ...
  public
    ...
    property Items[AIndex: Integer]: TdxCustomGalleryItem read GetItem
  ...
  TdxCustomGalleryGroups = class(TcxInterfacedComponentCollection,
    IdxGalleryGroups)
  strict private
  ...
  public
    ...
    //
    property Groups[AIndex: Integer]: TdxCustomGalleryGroup read GetGroup
  ...
  public
    ...
    property Items[AIndex: Integer]: TdxGalleryItem read GetItem
      write SetItem; default;
  end;
  ...
  public
    ...
    function FindByCaption(const ACaption: string;
      out AGroup: TdxGalleryGroup): Boolean;
    //
    property Groups[AIndex: Integer]: TdxGalleryGroup read GetGroup
      write SetGroup; default;
  end;
  ...
  strict private
    ...
    procedure GroupsChangeHandler(Sender: TObject;
      AItem: TcxComponentCollectionItem;
      AAction: TcxComponentCollectionNotification);
  protected
...
begin
  inherited;
  Filer.DefineProperty('ActionIndex', ReadActionIndex, WriteActionIndex,
    FActionIndex <> Null);
end;
...
procedure TdxCustomGalleryItems.SetItem(AIndex: Integer;
  AValue: TdxCustomGalleryItem);
begin
...
function TdxCustomGalleryItems.InsertGalleryItem(AIndex: Integer)
  : IdxGalleryItem;
begin
...
function TdxGalleryItem.GetCollectionFromParent(AParent: TComponent)
...
begin
  if Collection <> nil then
    Result := ((Collection as TdxGalleryItems)
      .GetOwner as TdxGalleryGroup).Gallery
  else
    Result := nil;
end;
...
function TdxCustomGalleryGroup.GetGalleryGroupHeaderClass
...
function TdxGalleryGroup.GetCollectionFromParent(AParent: TComponent)
  : TcxComponentCollection;
var
  AGallery: IdxGallery2;
...
begin
  ...
  else if Supports(AParent, IdxGalleryOwner, AGalleryOwner) then
...
function TdxGalleryGroups.FindByCaption(const ACaption: string;
  out AGroup: TdxGalleryGroup): Boolean;
var
  I: Integer;
begin
...
function TdxCustomGalleryGroups.GetGroup(AIndex: Integer)
  : TdxCustomGalleryGroup;
begin
  Result := inherited Items[AIndex] as TdxCustomGalleryGroup;
end;

procedure TdxCustomGalleryGroups.SetGroup(AIndex: Integer;
  AValue: TdxCustomGalleryGroup);
begin
  inherited Items[AIndex] := AValue;
end;
...
function TdxCustomGalleryGroups.GetGalleryGroup(AIndex: Integer)
  : IdxGalleryGroup;
begin
  Result := Groups[AIndex];
end;

function TdxCustomGalleryGroups.InsertGalleryGroup(AIndex: Integer)
  : IdxGalleryGroup;
begin
...
function TdxCustomGallery.GetAllowedCustomizationActions
