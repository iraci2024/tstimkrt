...
type
  ...
  public
    function Add(const AKeys: TArray<TValue>; AObject: TObject): Boolean;
      overload; virtual; abstract;
    function Add(AObject: TObject; AIsLoaded: Boolean = False): Boolean;
      overload; virtual; abstract;
  ...
  public
    function Add(const AKeys: TArray<TValue>; AObject: TObject)
      : Boolean; override;
    function Add(AObject: TObject; AIsLoaded: Boolean = False)
      : Boolean; override;
  ...
  public
    constructor Create(AOwnsObjects: Boolean = True);
    destructor Destroy; override;
    function AppendObject(const AKeys: TArray<TValue>; AObject: TObject;
      AIsLoaded: Boolean = False): Boolean; overload;
    function AppendObject(AObject: TObject; AIsLoaded: Boolean = False)
      : Boolean; overload;
    procedure ExtractObject(AObject: TObject);
    function FindObjectByKey(AClass: TClass;
  ...
  public
    ...
    function HasKey<TKey>(AObject: TObject; const AKey: TKey): Boolean;
      overload;
    function HasKey(AObject: TObject; const AKey: TValue): Boolean; overload;
    function HasKey(AObject: TObject; const AKeys: array of TValue)
      : Boolean; overload;
...
begin
  if FObjectFinder = nil then
    FObjectFinder := TObjectDictionary<TClass, TdxObjectFinder>.Create
      ([doOwnsValues]);
...
function TdxObjectFinder.HasKey(AObject: TObject;
  const AKeys: array of TValue): Boolean;
var
  I, ACount: Integer;
  AMemberInfo: TdxMappingMemberInfo;
  AValue: TValue;
...
function TdxObjectFinder.HasKey<TKey>(AObject: TObject;
...
begin
  inherited Create;
  FObjectPool := TObjectDictionary<T, TObject>.Create(Ownerships[AOwnsObjects],
    GetComparer);
...
function TdxIntegerKeyEntityPool.Add(const AKeys: TArray<TValue>;
...
function TdxIntegerKeyEntityPool.Add(AObject: TObject;
  AIsLoaded: Boolean): Boolean;
var
  APoolKey: Integer;
begin
...
function TdxInt64KeyEntityPool.Add(const AKeys: TArray<TValue>;
  AObject: TObject): Boolean;
var
  APoolKey: Int64;
begin
...
function TdxInt64KeyEntityPool.Add(AObject: TObject;
  AIsLoaded: Boolean): Boolean;
var
  APoolKey: Int64;
begin
...
function TdxSimpleKeyEntityPool<T>.Add(AObject: TObject;
  AIsLoaded: Boolean): Boolean;
var
  APoolKey: T;
begin
...
function TdxSimpleKeyEntityPool<T>.Add(const AKeys: TArray<TValue>;
  AObject: TObject): Boolean;
var
  APoolKey: T;
begin
...
function TdxSimpleKeyEntityPool<T>.GetByKey(const AKeys
...
function TdxEntityPool.Add(const AKeys: TArray<TValue>;
  AObject: TObject): Boolean;
var
  APoolKey: TBytes;
begin
...
function TdxEntityPool.Add(AObject: TObject;
  AIsLoaded: Boolean = False): Boolean;
var
  APoolKey: TBytes;
begin
  if ObjectKeys.ContainsKey(AObject) then
...
class procedure TdxEntityPool.SaveToStream(AStream: TStream;
  const AValue: TValue);
var
  ALength: Integer;
  ABuffer: TBytes;
  ...
  case AValue.Kind of
    ...
    tkRecord{$IFDEF DELPHI103}, tkMRecord{$ENDIF}:
      begin
        ...
        if (ATypeInfo = System.TypeInfo(TGUID)) or
          (ATypeInfo = System.TypeInfo(TTimeSpan)) or
...
begin
  inherited Create;
  FPool := TObjectDictionary<TClass, TdxCustomEntityPool>.Create
    ([doOwnsValues]);
...
function TdxEntityPoolClasses.CreatePool(AEntityInfo: TdxEntityInfo)
  : TdxCustomEntityPool;
begin
...
function TdxEntityPoolClasses.AppendObject(const AKeys: TArray<TValue>;
  AObject: TObject; AIsLoaded: Boolean): Boolean;
var
...
function TdxEntityPoolClasses.AppendObject(AObject: TObject;
  AIsLoaded: Boolean = False): Boolean;
var
  APool: TdxCustomEntityPool;
begin
...
function TdxEntityPoolClasses.FindObjectByKey(AClass: TClass;
  const AKeys: TArray<TValue>): TObject;
begin
