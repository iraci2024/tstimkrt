...
uses
  Types, Classes, SysUtils, Generics.Defaults, Generics.Collections, dxCore,
  dxCoreClasses,
...
type
  ...
  protected
    ...
    class procedure ShapeHandler(AImporter: TdxRtfImporter;
      AParameterValue: Integer; AHasParameter: Boolean); static;
    procedure BeforeNestedGroupFinishedCore(ANestedDestination
...
class function TdxPageBackgroundDestination.CreateKeywordHT
...
class function TdxPageBackgroundDestination.GetKeywordHT
  : TdxKeywordTranslatorTable;
begin
  Result := FKeywordHT;
end;

class function TdxPageBackgroundDestination.GetControlCharHT
  : TdxControlCharTranslatorTable;
begin
  Result := nil;
end;

function TdxPageBackgroundDestination.CreateClone
...
class procedure TdxPageBackgroundDestination.ShapeHandler
...
procedure TdxPageBackgroundDestination.BeforeNestedGroupFinishedCore
...
begin
  ...
  if TdxShapeInstanceDestinationAccess(ADestination)
    .HasColorProperty('fillColor') then
    Importer.DocumentModel.DocumentProperties.PageBackColor :=
      TdxShapeInstanceDestinationAccess(ADestination).GetColorPropertyValue
      ('fillColor');
end;
