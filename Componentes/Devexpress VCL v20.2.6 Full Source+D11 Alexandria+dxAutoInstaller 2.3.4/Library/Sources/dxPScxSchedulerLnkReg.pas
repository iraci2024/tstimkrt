...
{$IFDEF DELPHIXE3}
  Actions,
{$ENDIF}
  cxStyles, cxStyleSheetEditor, dxPSCore, dxPScxSchedulerLnk,
  cxSchedulerCustomControls, dxPSReg, cxScheduler,
...
type
  ...
  TcxSchedulerReportLinkResourceCountPerPagePropertyEditor = class
    (TIntegerProperty)
  public
  ...
  TcxSchedulerReportLinkTaskPadReportLinkPropertyEditor = class
    (TComponentProperty)
  private
...
function TcxSchedulerReportLinkResourceCountPerPagePropertyEditor.
  GetValue: string;
begin
...
function TcxSchedulerReportLinkTaskPadReportLinkPropertyEditor.GetAttributes
  : TPropertyAttributes;
begin
  Result := inherited GetAttributes - [paMultiSelect];
end;

procedure TcxSchedulerReportLinkTaskPadReportLinkPropertyEditor.GetValues
  (Proc: TGetStrProc);
var
  I: Integer;
begin
...
function TcxSchedulerReportLinkTaskPadReportLinkPropertyEditor.GetReportLink
  : TBasedxReportLink;
begin
  Result := TBasedxReportLink(GetComponent(0));
end;

procedure TcxSchedulerReportLinkTaskPadReportLinkPropertyEditor.AddComponent
  (const AName: string);
begin
...
begin
  FComponents.Clear;
  Designer.GetComponentNames(GetTypeData(PTypeInfo(TBasedxReportLink.ClassInfo)
    ), AddComponent);
end;

function TcxSchedulerReportLinkTaskPadReportLinkPropertyEditor.IsComponentValid
  (AComponent: TComponent): Boolean;
begin
  Result := (AComponent <> GetComponent(0)) and TBasedxReportLink(AComponent)
    .Aggregable;
end;
...
begin
  ...
  begin
    ACategory := AComponent.Add(sdxSchedulerTabFile, sdxSchedulerBarFilePrint,
      'Print\Print_16x16.png', 0);
    ...
    RegisterActions(TdxUIGeneratorHelper.GenerateCategoryName(ACategory),
      [TdxSchedulerShowPrintForm, TdxSchedulerShowPrintPreviewForm,
      TdxSchedulerShowPageSetupForm], nil);
  end;
end;
...
begin
  ...
  RegisterPropertyEditor(TypeInfo(Integer),
    TcxCustomSchedulerReportLinkPrintStyle, 'ResourceCountPerPage',
    TcxSchedulerReportLinkResourceCountPerPagePropertyEditor);
