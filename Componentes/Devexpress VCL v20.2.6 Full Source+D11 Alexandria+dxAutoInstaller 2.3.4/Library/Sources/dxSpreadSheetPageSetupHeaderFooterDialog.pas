...
{$ENDIF}
  ...
  cxLookAndFeels, cxLookAndFeelPainters, dxLayoutLookAndFeels, cxClasses,
  ...
  dxSpreadSheetTypes, dxSpreadSheetCore, dxForms, dxSpreadSheetPrinting,
  cxTextEdit, cxMemo, cxEditRepositoryItems,
  ImgList, cxImageList;
...
type
  ...
  TdxSpreadSheetPageSetupHeaderFooterDialogFormClass = class of
    TdxSpreadSheetPageSetupHeaderFooterDialogForm;
  ...
  protected
    ...
    procedure Load(AOptions
      : TdxSpreadSheetTableViewOptionsPrintHeaderFooter); virtual;
    procedure Save(AOptions
      : TdxSpreadSheetTableViewOptionsPrintHeaderFooter); virtual;
    // Messages
...
var
  SpreadSheetPageSetupHeaderFooterDialogClass
    : TdxSpreadSheetPageSetupHeaderFooterDialogFormClass =
    TdxSpreadSheetPageSetupHeaderFooterDialogForm;
...
begin
  ADialog := SpreadSheetPageSetupHeaderFooterDialogClass.Create
...
begin
  ...
  lgCommonHeaderFooter.Caption := cxGetResourceString
    (@sdxPageSetupHeaderFooterDialogCaption);
  btnInsertDate.Hint := cxGetResourceString
    (@sdxPageSetupHeaderFooterDialogHintInsertDate);
  btnInsertPageNumber.Hint := cxGetResourceString
    (@sdxPageSetupHeaderFooterDialogHintInsertPageNumber);
  btnInsertPageTotal.Hint := cxGetResourceString
    (@sdxPageSetupHeaderFooterDialogHintInsertPageTotal);
  btnInsertSheetName.Hint := cxGetResourceString
    (@sdxPageSetupHeaderFooterDialogHintInsertSheetName);
  btnInsertTime.Hint := cxGetResourceString
    (@sdxPageSetupHeaderFooterDialogHintInsertTime);
  liFooterCenter.Caption := cxGetResourceString
    (@sdxPageSetupHeaderFooterDialogCenterFooter);
  liHeaderCenter.Caption := cxGetResourceString
    (@sdxPageSetupHeaderFooterDialogCenterHeader);
  lliDescription.Caption := cxGetResourceString
    (@sdxPageSetupHeaderFooterDialogDescription);

  if IsRightToLeft then
  begin
    liFooterLeft.Caption := cxGetResourceString
      (@sdxPageSetupHeaderFooterDialogRightFooter);
    liFooterRight.Caption := cxGetResourceString
      (@sdxPageSetupHeaderFooterDialogLeftFooter);
    liHeaderLeft.Caption := cxGetResourceString
      (@sdxPageSetupHeaderFooterDialogRightHeader);
    liHeaderRight.Caption := cxGetResourceString
...
procedure TdxSpreadSheetPageSetupHeaderFooterDialogForm.btnInsertSheetNameClick
  (Sender: TObject);
var
  AControl: TControl;
  AMacro: string;
...
procedure TdxSpreadSheetPageSetupHeaderFooterDialogForm.Initialize
...
procedure TdxSpreadSheetPageSetupHeaderFooterDialogForm.Load
...
procedure TdxSpreadSheetPageSetupHeaderFooterDialogForm.Save
  (AOptions: TdxSpreadSheetTableViewOptionsPrintHeaderFooter);
begin
...
procedure TdxSpreadSheetPageSetupHeaderFooterDialogForm.CMBiDiModeChanged
