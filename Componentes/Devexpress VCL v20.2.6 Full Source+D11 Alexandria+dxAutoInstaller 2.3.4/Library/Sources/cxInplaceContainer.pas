...
{$IFDEF DELPHI16}
  System.UITypes,
{$ENDIF}
  Classes, SysUtils, Windows, Messages, Variants, Types, dxCore, Forms,
  Controls, StdCtrls, Graphics,
  dxCoreClasses, cxVariants, cxClasses, cxControls, cxGraphics, cxStyles,
  cxContainer, cxCustomData,
  cxData, cxDataUtils, cxDataStorage, cxLookAndFeels, cxLookAndFeelPainters,
  dxUIElementPopupWindow,
  cxGeometry, cxLibraryConsts, dxCustomHint, cxFindPanel, dxDateRanges,
  cxDateUtils, cxFilter,
  dxFilterPopupWindow, cxEdit, cxTextEdit, cxEditDataRegisteredRepositoryItems,
  cxNavigator,
...
type
  ...
  TcxCustomControlDragAndDropObjectClass = class of
  ...
  public
    constructor Create(AFilterBox: TcxControlOptionsFilterBox);
      reintroduce; virtual;
  end;
  ...
  TcxControlFilterBoxMRUItemsPopupClass = class of
    TcxControlFilterBoxMRUItemsPopup;
  ...
  public
    constructor Create(AController: TcxCustomControlController);
      reintroduce; virtual;
  ...
  published
    ...
    property FocusContentOnApplyFilter: Boolean
      read GetFocusContentOnApplyFilter write SetFocusContentOnApplyFilter
      default False;
    ...
    property MRUItemsListCount: Integer read GetMRUItemsListCount
      write SetMRUItemsListCount default cxFindPanelDefaultMRUItemsListCount;
    property MRUItemsListDropDownCount: Integer
      read GetMRUItemsListDropDownCount write SetMRUItemsListDropDownCount
      default cxFindPanelDefaultMRUItemsListDropDownCount;
  ...
  protected
    procedure AddDateTimeAbsoluteFilters(ADateRange: TdxCustomDateRange;
      AIgnoreTime: Boolean); overload; virtual;
    procedure AddDateTimeAbsoluteFilters(AItem: TcxCustomInplaceEditContainer);
      overload; virtual;
    procedure AddDateTimeRelativeFilters
      (AItem: TcxCustomInplaceEditContainer); virtual;
    procedure AddDateTimeRelativeFilter(AFilter: TdxDateTimeFilter);
      overload; virtual;
    procedure AddDateTimeRelativeFilter(AKind: TcxFilterOperatorKind);
      overload; virtual;
    ...
    function IsSpecialOperatorKindSupported(AKind: TcxFilterOperatorKind)
      : Boolean; virtual;
    procedure Load(AItem: TcxCustomInplaceEditContainer;
  ...
  TcxContainerItemDefaultValuesProvider = class
  ...
  protected
    ...
    function GetDefaultValuesProvider(AProperties: TcxCustomEditProperties)
      : IcxEditDefaultValuesProvider; virtual;
    ...
    function AddToFilter(AParent: TcxFilterCriteriaItemList;
      ...
      : TcxFilterCriteriaItem; virtual;
    procedure GetFilterStrings(AStrings: TStrings;
      AValueList: TcxControlFilterValueList; AValuesOnly: Boolean;
      AUniqueOnly: Boolean);
    procedure GetFilterValues(AValueList: TcxControlFilterValueList;
      AValuesOnly: Boolean; AInitSortByDisplayText: Boolean;
      ACanUseFilteredValues: Boolean; AUniqueOnly: Boolean);
    procedure GetFilterActiveValueIndexes(AValueList: TcxControlFilterValueList;
    ...
    procedure SetFilterActiveValueIndex(AValueList: TcxControlFilterValueList;
      AIndex: Integer; AFilterList: TcxFilterCriteriaItemList;
      AReplaceExistent, AAddToMRUItemsList: Boolean);
    procedure SetFilterActiveValueIndexes(AValueList: TcxControlFilterValueList;
    ...
    property FilterMRUValueItems: TcxFilterMRUValueItems
  ...
  public
    ...
    property StoredExpression: string read GetStoredExpression
      write SetStoredExpression; // for internal use only
  ...
  TcxCustomEditContainerItemFilterPopupIncrementalFilteringOptionsClass = class
    of TcxCustomEditContainerItemFilterPopupIncrementalFilteringOptions;

  TcxCustomEditContainerItemFilterPopupIncrementalFilteringOptions = class
  ...
  protected
    ...
    property Options: TcxTextEditIncrementalFilteringOptions read FOptions
      write SetOptions default [ifoHighlightSearchText, ifoUseContainsOperator];
  public
    constructor Create(AOwner: TPersistent); override;
  ...
  protected
    ...
    property EditContainer: TcxCustomInplaceEditContainer read GetEditContainer;
    property FilteredItemsList: Boolean read FFilteredItemsList
      write SetFilteredItemsList default True;
    property FilteredItemsListShowFilteredItemsOnly: Boolean
      read FFilteredItemsListShowFilteredItemsOnly
  ...
  TcxCustomEditContainerItemFilterPopupOptionsClass = class of
    TcxCustomEditContainerItemFilterPopupOptions;

  TcxCustomEditContainerItemFilterPopupOptions = class
    (TcxCustomEditContainerItemCustomFilterPopupOptions)
  private
    FAddValueItems: Boolean;
    FEnabled: Boolean;
    FIncrementalFiltering
      : TcxCustomEditContainerItemFilterPopupIncrementalFilteringOptions;
    ...
    procedure SetIncrementalFiltering
      (AValue: TcxCustomEditContainerItemFilterPopupIncrementalFilteringOptions);
  ...
  protected
    ...
    property AddValueItems: Boolean read FAddValueItems write SetAddValueItems
      default True;
  ...
  TcxCustomEditContainerItemExcelFilterPopupOptionsClass = class of
    TcxCustomEditContainerItemExcelFilterPopupOptions;
  ...
  TcxCustomEditContainerItemOptionsClass = class of
    TcxCustomEditContainerItemOptions;
  ...
  private
    ...
    procedure SetExcelFilterPopup
      (AValue: TcxCustomEditContainerItemExcelFilterPopupOptions);
    procedure SetFiltering(Value: Boolean);
    procedure SetFilteringWithFindPanel(AValue: Boolean);
    procedure SetFilterPopup(AValue
      : TcxCustomEditContainerItemFilterPopupOptions);
  ...
  protected
    ...
    function GetFilterPopupWindowIncrementalFilteringOptions
      : TcxTextEditIncrementalFilteringOptions; virtual;
    ...
    function GetExcelFilterPopupOptionsClass
      : TcxCustomEditContainerItemExcelFilterPopupOptionsClass; virtual;
    function GetFilterPopupOptionsClass
      : TcxCustomEditContainerItemFilterPopupOptionsClass; virtual;
    ...
    property ExcelFilterPopup: TcxCustomEditContainerItemExcelFilterPopupOptions
      read FExcelFilterPopup write SetExcelFilterPopup;
    ...
    property FilterPopup: TcxCustomEditContainerItemFilterPopupOptions
      read FFilterPopup write SetFilterPopup;
    property FilterPopupMode: TdxFilterPopupWindowMode read FFilterPopupMode
      write SetFilterPopupMode default fpmDefault;
  ...
  protected
    ...
    function CreateTokenCriteria
      : TcxControlOptionsFilterBoxTokenCriteria; virtual;
  ...
  published
    property CriteriaDisplayStyle: TcxFilterCriteriaDisplayStyle
      ...
      default fcdsDefault;
    property CustomizeButtonAlignment: TcxFilterBoxButtonAlignment
    ...
    property Position: TcxFilterBoxPosition read FPosition write SetPosition
      default fpBottom;
    property Visible: TcxFilterBoxVisible read FVisible write SetVisible
      default fvNever;
    property TokenCriteria: TcxControlOptionsFilterBoxTokenCriteria
  ...
  protected
    property FilteredItemsList: Boolean read FFilteredItemsList
      write SetFilteredItemsList default False;
    property FilteredItemsListShowFilteredItemsOnly: Boolean
      read FFilteredItemsListShowFilteredItemsOnly
      write SetFilteredItemsListShowFilteredItemsOnly default True;
  public
  ...
  TcxControlOptionsFilteringItemPopupClass = class of
    TcxControlOptionsFilteringItemPopup;
  ...
  protected
    ...
    property AddValueItems: Boolean read FAddValueItems write SetAddValueItems
      default True;
    property ApplyMultiSelectChanges: TdxFilterApplyChangesMode
    ...
    property MaxDropDownItemCount: Integer read FMaxDropDownItemCount
      ...
      default cxControlFilterDefaultItemPopupMaxDropDownItemCount;
    property MRUItemsList: Boolean read FMRUItemsList write SetMRUItemsList
      default True;
    property MRUItemsListCount: Integer read FMRUItemsListCount
      write SetMRUItemsListCount
      default cxControlFilterDefaultItemMRUItemsListCount;
    property MultiSelect: Boolean read FMultiSelect write SetMultiSelect
      default True;
  public
    constructor Create(AOwner: TPersistent); override;
  ...
  TcxControlOptionsFilteringItemExcelPopupClass = class of
    TcxControlOptionsFilteringItemExcelPopup;
  ...
  private
    ...
    procedure SetItemExcelPopup
      (Value: TcxControlOptionsFilteringItemExcelPopup);
  ...
  protected
    ...
    function GetItemExcelPopupClass
      : TcxControlOptionsFilteringItemExcelPopupClass; virtual;
    function GetItemPopupClass
      : TcxControlOptionsFilteringItemPopupClass; virtual;

    property ItemExcelPopup: TcxControlOptionsFilteringItemExcelPopup
      read FItemExcelPopup write SetItemExcelPopup;
    property ItemPopup: TcxControlOptionsFilteringItemPopup read FItemPopup
      write SetItemPopup;
  ...
  public
    ...
    procedure RunCustomizeDialog
      (AItem: TcxCustomInplaceEditContainer = nil); virtual;
  published
  ...
  TcxControlOptionsDateTimeHandlingClass = class of
    TcxControlOptionsDateTimeHandling;
  ...
  protected
    ...
    property Filters: TdxDateTimeFilters read FFilters write SetFilters
      default [];
  ...
  protected
    procedure ChangeScale(M, D: Integer); override;
    function GetDefaultShowEditButtons
      : TcxEditingControlEditShowButtons; virtual;
    function IsItemFilterButtonShowedAlways: Boolean; virtual;
    function IsItemFilterSmartTag: Boolean; virtual;

    property ItemFilterButtonShowMode: TcxFilterButtonShowMode
      read FItemFilterButtonShowMode write SetItemFilterButtonShowMode
      default fbmDefault;
    property NavigatorOffset: Integer read FNavigatorOffset
      write SetNavigatorOffset default cxInplaceNavigatorDefaultOffset;
    property ShowItemFilterButtons: TcxShowFilterButtons
  ...
  published
    ...
    property ScrollBars: TcxScrollStyle read GetScrollBars write SetScrollBars
      default ssBoth;
    property ShowEditButtons: TcxEditingControlEditShowButtons
      read FShowEditButtons write SetShowEditButtons
      stored IsShowEditButtonsStored;
  end;
  ...
  protected
    procedure Changed; override;
    property DragDropText: Boolean read FDragDropText write FDragDropText
      default False;
    ...
    property IncSearch: Boolean read FIncSearch write SetIncSearch
      default False;
    property IncSearchItem: TcxCustomInplaceEditContainer read FIncSearchItem
      write SetIncSearchItem;
    property ItemFiltering: TdxDefaultBoolean read FItemFiltering
      write SetItemFiltering default bDefault;
    property NavigatorHints: Boolean read FNavigatorHints write FNavigatorHints
      default False;
  public
    constructor Create(AOwner: TPersistent); override;
    procedure Assign(Source: TPersistent); override;
  published
    ...
    property GoToNextCellOnTab: Boolean read FGoToNextCellOnTab
      write SetGoToNextCellOnTab default False;
  ...
  TcxControlScrollbarAnnotationOptionsHelper = class
  ...
  public
    constructor Create(AOwner: TPersistent); override;
    destructor Destroy; override;
    function GetStyle(AKind: TdxScrollbarAnnotationKind)
  ...
  TcxExtEditingControlNavigatorButtonsClass = class of
    TcxExtEditingControlNavigatorButtons;
  ...
  protected
    ...
    function GetNavigatorButtonsClass
      : TcxExtEditingControlNavigatorButtonsClass; virtual;
  public
    constructor Create(AOwner: TPersistent); override;
    destructor Destroy; override;
    procedure Assign(Source: TPersistent); override;
  ...
  published
    property Buttons: TcxExtEditingControlNavigatorButtons read FButtons
      write SetButtons;
    property InfoPanel: TcxControlNavigatorInfoPanel read FInfoPanel
      write SetInfoPanel;
  ...
  TcxCustomInplaceEditContainer = class(TComponent,
    IcxEditRepositoryItemListener, IcxEditorPropertiesContainer, IdxScaleFactor,
    IdxDateTimeHandling, IdxExcelFilterableComponent,
    IdxFilteringDateTimeHandling, IdxFilterableComponent)
  private
    FData: Pointer;
  ...
  protected
    ...
    function CreateEditViewData(AProperties: TcxCustomEditProperties;
      AEditStyleData: Pointer): TcxCustomEditViewData; virtual;
    procedure DataChanged; virtual;
    procedure DoCalculateEditViewInfo(AEditViewInfo
      : TcxEditCellViewInfo); virtual;
    procedure DoGetDisplayText(ARecordIndex: TdxNativeInt;
      var AText: string); virtual;
    function DoGetEditProperties(AData: Pointer)
      : TcxCustomEditProperties; virtual;
    procedure DoGetEditingProperties(AData: Pointer;
      var AProperties: TcxCustomEditProperties); virtual;
    procedure DoGetFilterValues(AValueList: TcxDataFilterValueList); virtual;
    function DoGetPropertiesFromEvent(AEvent: TcxGetEditPropertiesEvent;
      AData: Pointer; AProperties: TcxCustomEditProperties)
      : TcxCustomEditProperties; virtual;
    ...
    function GetDisplayValue(AProperties: TcxCustomEditProperties;
      ARecordIndex: Integer): Variant; virtual;
    ...
    function GetEditHeight(AEditViewInfo: TcxEditCellViewInfo)
      : Integer; virtual;
    ...
    procedure ValidateDrawValue(const AValue: Variant;
      AEditViewInfo: TcxEditCellViewInfo); virtual;
    ...
    property DataBinding: TcxCustomItemDataBinding read FDataBinding
    ...
    property Filtered: Boolean read GetFiltered write SetFiltered;
    property FilteringDateRanges: TdxFilteringDateRanges
      read FFilteringDateRanges;
    property FilterLinkName: string read GetFilterLinkName;
    property Focused: Boolean read GetFocused write SetFocused;
    property FocusedCellViewInfo: TcxEditCellViewInfo
      read GetFocusedCellViewInfo;
    property Options: TcxCustomEditContainerItemOptions read FOptions
      write SetOptions;
    ...
    property Values[ARecordIndex: Integer]: Variant read GetValue
      write SetValue;

    property OnGetEditProperties: TcxGetEditPropertiesEvent
      read FOnGetEditProperties write FOnGetEditProperties;
    property OnGetEditingProperties: TcxGetEditPropertiesEvent
      read FOnGetEditingProperties write FOnGetEditingProperties;
    property OnGetFilterDisplayText: TcxGetFilterDisplayTextEvent
      read FOnGetFilterDisplayText write FOnGetFilterDisplayText;
    property OnGetFilterValues: TcxGetFilterValuesEvent read FOnGetFilterValues
      write FOnGetFilterValues;
    property OnInitFilteringDateRanges: TdxInitDateRangesEvent
      read FOnInitFilteringDateRanges write FOnInitFilteringDateRanges;
    property OnUserFiltering: TcxUserFilteringEvent read FOnUserFiltering
      write FOnUserFiltering;
    property OnUserFilteringEx: TcxUserFilteringExEvent read FOnUserFilteringEx
      write FOnUserFilteringEx;
  public
  ...
  TcxDragDropObjectAutoScrollingObject = class
    (TcxAutoScrollingEditingControlObject)
  protected
    function GetControl: TcxControl; override;
  end;
  ...
  public
    constructor CreateArrows(AColor: TColor;
      ABorderColor: TColor = clDefault); virtual;
    destructor Destroy; override;
  ...
  protected
    procedure AddAutoScrollingObject(const ARect: TRect; AKind: TScrollBarKind;
      ACode: TScrollCode);
    procedure BeginDragAndDrop; override;
    ...
    function GetAutoScrollingObjectClass
      : TcxCustomAutoScrollingObjectClass; virtual;
    ...
    property AutoScrollObjects[Index: Integer]: TcxCustomAutoScrollingObject
      read GetAutoScrollObject;
    property CanDrop: Boolean read FCanDrop;
    property Canvas: TcxCanvas read GetCanvas;
    property DisplayRect: TRect read GetDisplayRect;
    property DragImage: TcxDragImage read FDragImage;
    property HitTestController: TcxCustomHitTestController
      read GetHitTestController;
  ...
  public
    ...
    property DragImageVisible: Boolean read FDragImageVisible
      write SetDragImageVisible;
  end;
  ...
  protected
    ...
    function AllowDesignMouseEvents(const P: TPoint; AShift: TShiftState)
      : Boolean; overload;
    ...
    property Control: TcxEditingControl read GetControl;
    property Controller: TcxCustomControlController read FController;
    property HotTrackController: TcxHotTrackController
      read GetHotTrackController;
  ...
  public
    ...
    property HitCode[ACode: TcxHitCode]: Boolean read GetHasCode
      write SetHasCode;
  ...
  protected
    ...
    procedure CalcNextRow(AForward: Boolean;
      var ARowIndex, ACellIndex: Integer); virtual;
  ...
  protected
    ...
    procedure HandleNonContentMouseDown(Button: TMouseButton;
    ...
    function GetFilterBoxMRUItemsPopupClass
      : TcxControlFilterBoxMRUItemsPopupClass; virtual;
    ...
    function GetFocusedCellViewInfo(AEditContainer
      : TcxCustomInplaceEditContainer): TcxEditCellViewInfo; virtual;
    ...
    procedure RefreshFocusedCellViewInfo
      (AItem: TcxCustomInplaceEditContainer); virtual;
    ...
    property DesignSelectionHelper: TcxCustomDesignSelectionHelper
      read GetDesignSelectionHelper;
    property DisableCellsRefresh: Boolean read FDisableCellsRefresh
      write FDisableCellsRefresh;
    property DragAndDropObject: TcxCustomControlDragAndDropObject
    ...
    property EditingItem: TcxCustomInplaceEditContainer read GetEditingItem
      write SetEditingItem;
    property EditingViewInfo: TcxEditCellViewInfo read GetEditingViewInfo;
    property FilterBoxMRUItemsPopup: TcxControlFilterBoxMRUItemsPopup
      read GetFilterBoxMRUItemsPopup;
    ...
    property HitTestController: TcxCustomHitTestController
      read FHitTestController;
    property IncSearchingText: string read GetIncSearchingText
      write SetIncSearchingText;
    property IncSearchingItem: TcxCustomInplaceEditContainer
      read GetIncSearchingItem;
    property IsHandleTabStop: Boolean read FIsHandleTabStop
      write FIsHandleTabStop;
    property IsDragging: Boolean read GetIsDragging;
    property IsIncSearching: Boolean read GetIsIncSearching;
    property ItemForIncSearching: TcxCustomInplaceEditContainer
  ...
  public
    ...
    property DataController: TcxCustomDataController read GetDataController;
    property Focused: Boolean read GetFocused write SetFocused;
    property FocusedItem: TcxCustomInplaceEditContainer read FFocusedItem
      write SetFocusedItem;
    property FocusedRecordIndex: TdxNativeInt read GetFocusedRecordIndex
  ...
  protected
    ...
    function PrepareEdit(AItem: TcxCustomInplaceEditContainer;
    ...
    property Controller: TcxCustomControlController read FController;
    property EditingCellViewInfo: TcxEditCellViewInfo
  ...
  public
    ...
    procedure ShowEdit(AItem: TcxCustomInplaceEditContainer);
      reintroduce; overload;
    procedure ShowEdit(AItem: TcxCustomInplaceEditContainer; Key: Char);
      reintroduce; overload;
    procedure ShowEdit(AItem: TcxCustomInplaceEditContainer; Shift: TShiftState;
      X, Y: Integer); reintroduce; overload;

    procedure StartEditShowingTimer(AItem: TcxCustomInplaceEditContainer);

    property EditingItem: TcxCustomInplaceEditContainer read FEditingItem
      write SetEditingItem;
    property IsDragging: Boolean read GetIsDragging;
  end;
  ...
  protected
    ...
    function GetFilterBoxViewInfoClass
      : TcxControlFilterBoxViewInfoClass; virtual;
    function GetFindPanelViewInfoClass
      : TcxControlFindPanelViewInfoClass; virtual;
    ...
    property FilterBoxViewInfo: TcxControlFilterBoxViewInfo
      read FFilterBoxViewInfo;
    ...
    property FindPanelViewInfo: TcxControlFindPanelViewInfo
  ...
  public
    ...
    procedure Paint(ACanvas: TcxCanvas;
      AHandler: TcxCustomDrawCellEvent); virtual;
  ...
  protected
    ...
    function GetNavigatorSiteViewInfoClass
      : TcxCustomNavigatorSiteViewInfoClass; virtual;
    function IsNavigatorSupported: Boolean; virtual;
    procedure SetFullPaintRegion(ACanvas: TcxCanvas); override;

    property NavigatorSiteViewInfo: TcxCustomNavigatorSiteViewInfo
  ...
  protected
    ...
    function DrawBackgroundHandler(ACanvas: TcxCanvas;
  ...
  public
    ...
    procedure Invalidate(const R: TRect; AEraseBackground: Boolean = False);
      overload; virtual;
    procedure RightToLeftConversion(const AClientBounds: TRect);
    ...
    property LookAndFeelPainterClass: TcxCustomLookAndFeelPainter
      read GetPainter; // todo: deprecated, for backward capability only
    property ScaleFactor: TdxScaleFactor read GetScaleFactor;
    property Transparent: Boolean read FTransparent write FTransparent;
    property Visible: Boolean read ItemVisible;
    property VisibleInfoCalculated: Boolean read FVisibleInfoCalculated
      write FVisibleInfoCalculated;
  ...
  TcxEditCellViewInfo = class(TcxCustomViewInfoItem, IcxHotTrackElement,
    IcxHintableObject, IcxEditOwner)
  private
  ...
  protected
    ...
    // IcxEditOwner
    function GetViewData(out AIsViewDataCreated: Boolean)
  ...
  public
    constructor Create(AOwnerControl: TcxExtEditingControl);
      reintroduce; virtual;
  end;

  TcxCustomNavigatorSiteViewInfo = class(TcxCustomViewInfoItem,
    IcxHotTrackElement, IcxMouseTrackingCaller, IcxMouseTrackingCaller2)
  private
  ...
  TcxControlItemViewInfo = class(TcxCustomViewInfoItem, IcxMouseCaptureObject,
  ...
  protected
    ...
    function GetHitTest(AHitTest: TcxCustomHitTestController): Boolean;
      override;
    function GetItemFromPoint(const APoint: TPoint)
      : TcxControlItemViewInfo; virtual;
  ...
  public
    constructor Create(AFindPanelViewInfo: TcxControlFindPanelViewInfo);
      reintroduce; virtual;
  end;

  { TcxControlFindPanelFindButtonViewInfo }

  TcxControlFindPanelFindButtonViewInfo = class
    (TcxControlFindPanelButtonViewInfo)
  protected
  ...
  TcxControlFindPanelClearButtonViewInfo = class
    (TcxControlFindPanelButtonViewInfo)
  protected
    function GetKind: TcxFindPanelItemKind; override;
  end;
  ...
  TcxControlFindPanelNextButtonViewInfo = class
    (TcxControlFindPanelButtonViewInfo)
  protected
    function GetKind: TcxFindPanelItemKind; override;
  end;
  ...
  TcxControlFindPanelPreviousButtonViewInfo = class
    (TcxControlFindPanelButtonViewInfo)
  protected
    function GetKind: TcxFindPanelItemKind; override;
  end;
  ...
  protected
    ...
    procedure CheckClipping(const ADisplayRect: TRect;
      const AAvailableRect: TRect); override;
    procedure DoCalculate; override;
    procedure DoDraw(ACanvas: TcxCanvas); override;
    procedure DoRightToLeftConversion(const AClientBounds: TRect); override;
    ...
    function GetItemFromPoint(const APoint: TPoint)
      : TcxControlItemViewInfo; override;
    procedure GetViewParams(var AParams: TcxViewParams); override;
    ...
    property ClearButtonViewInfo: TcxControlFindPanelClearButtonViewInfo
      read FClearButtonViewInfo;
    property CloseButtonViewInfo: TcxControlFindPanelCloseButtonViewInfo
      read FCloseButtonViewInfo;
    ...
    property FindButtonViewInfo: TcxControlFindPanelFindButtonViewInfo
      read FFindButtonViewInfo;
    property FindPanel: TcxControlFindPanel read GetFindPanel;
    property NextButtonViewInfo: TcxControlFindPanelNextButtonViewInfo
      read FNextButtonViewInfo;
    property PreviousButtonViewInfo: TcxControlFindPanelPreviousButtonViewInfo
      read FPreviousButtonViewInfo;
  public
    constructor Create(AOwner: TObject); override;
    destructor Destroy; override;
  end;
  ...
  protected
    ...
    property FilterBoxViewInfo: TcxControlFilterBoxViewInfo
      read FFilterBoxViewInfo;
  public
    constructor Create(AFilterBoxViewInfo: TcxControlFilterBoxViewInfo);
      reintroduce; virtual;
  end;
  ...
  TcxControlFilterBoxDropDownButtonViewInfo = class
    (TcxControlFilterBoxItemViewInfo, IdxUIElementPopupWindowOwner)
  private
  ...
  protected
    ...
    function IdxUIElementPopupWindowOwner.ClosePopupWhenSetNil =
      CloseDropDownWindowOnDestruction;
    ...
    property DropDownWindow: TcxControlFilterBoxMRUItemsPopup
      read GetDropDownWindow;
  public
    destructor Destroy; override;
  end;
  ...
  protected
    ...
    procedure CalculateDropDownButton(out ANeedAdjustTextBounds
      : Boolean); virtual;
    ...
    property CheckBoxViewInfo: TcxControlFilterBoxCheckBoxViewInfo
      read FCheckBoxViewInfo;
    property CloseButtonViewInfo: TcxControlFilterBoxCloseButtonViewInfo
      read FCloseButtonViewInfo;
    property CustomizeButtonViewInfo: TcxControlFilterBoxCustomizeButtonViewInfo
      read FCustomizeButtonViewInfo;
    property DropDownButtonViewInfo: TcxControlFilterBoxDropDownButtonViewInfo
  ...
  strict private
    ...
    function GetViewInfo: TcxCustomControlViewInfo;
  protected
    procedure AfterCustomDraw(AViewInfo: TcxCustomViewInfoItem);
      overload; virtual;
    procedure BeforeCustomDraw(AViewInfo: TcxCustomViewInfoItem);
      overload; virtual;
    function DoCustomDraw(AViewInfoItem: TcxCustomViewInfoItem;
      AEvent: TcxCustomDrawViewInfoItemEvent): Boolean;
    procedure DoPaintEditCell(ACellViewInfo: TcxEditCellViewInfo;
      AIsExcludeRect: Boolean = True); virtual;
  ...
  protected
    ...
    property Navigator: TcxStyle index ecs_Navigator read GetValue
      write SetValue;
    property NavigatorInfoPanel: TcxStyle index ecs_NavigatorInfoPanel
  ...
  published
    property Background: TcxStyle index ecs_Background read GetValue
      write SetValue;
    property Content: TcxStyle index ecs_Content read GetValue write SetValue;
    property FilterBox: TcxStyle index ecs_FilterBox read GetValue
      write SetValue;
    property FindPanel: TcxStyle index ecs_FindPanel read GetValue
      write SetValue;
    property Inactive: TcxStyle index ecs_Inactive read GetValue write SetValue;
    property SearchResultHighlight: TcxStyle index ecs_SearchResultHighlight
      read GetValue write SetValue;
    property Selection: TcxStyle index ecs_Selection read GetValue
      write SetValue;
    property OnGetContentStyle: TcxOnGetContentStyleEvent
  ...
  IcxEditingControlOptions = interface
    ...
    property OptionsDateTimeHandling: TcxControlOptionsDateTimeHandling
      read GetOptionsDateTimeHandling;
    property OptionsFilterBox: TcxControlOptionsFilterBox
      read GetOptionsFilterBox;
    property OptionsFiltering: TcxControlOptionsFiltering
      read GetOptionsFiltering;
    property OptionsFindPanel: TcxControlOptionsFindPanel
      read GetOptionsFindPanel;
    property OptionsView: TcxControlOptionsView read GetOptionsView;
  end;

  TcxecEditingEvent = procedure(Sender, AItem: TObject; var Allow: Boolean)
    of object;
  TcxecInitEditEvent = procedure(Sender, AItem: TObject; AEdit: TcxCustomEdit)
    of object;
  TcxecInitEditValueEvent = procedure(Sender, AItem: TObject;
    AEdit: TcxCustomEdit; var AValue: TcxEditValue) of object;
  TcxecItemEvent = procedure(Sender: TObject;
    AItem: TcxCustomInplaceEditContainer) of object;
  TcxecFilterCustomizationEvent = procedure(Sender: TObject; var ADone: Boolean)
    of object;
  TcxecFilterDialogShowEvent = procedure(Sender, AItem: TObject;
    var ADone: Boolean) of object;
  TcxecFindPanelVisibilityChangedEvent = procedure(Sender: TObject;
    const AVisible: Boolean) of object;

  TcxEditingControlScrollbarAnnotations = class(TdxScrollbarAnnotations)
  // for internal use
  strict private
    FOwner: TcxExtEditingControl;
  protected
  ...
  private
    ...
    FOnPopulateCustomScrollbarAnnotationRowIndexList
      : TdxPopulateCustomScrollbarAnnotationRowIndexList;
  ...
  protected
    ...
    function DoFilterDialogShow(AItem: TcxCustomInplaceEditContainer)
      : Boolean; virtual;
    procedure DoFindPanelVisibilityChanged(AVisible: Boolean); virtual;
    procedure DoGetCellHint(ACell: TObject; var AText: string;
      var ANeedShow: Boolean); virtual;
    procedure DoInitEdit(AItem: TcxCustomInplaceEditContainer;
      AEdit: TcxCustomEdit); virtual;
    procedure DoInitEditValue(AItem: TcxCustomInplaceEditContainer;
      AEdit: TcxCustomEdit; var AValue: TcxEditValue); virtual;
    procedure DoInitFilteringDateRanges
      (AItem: TcxCustomInplaceEditContainer); virtual;
    ...
    function NeedCallChangedOnItemRemoved(AItem: TcxCustomInplaceEditContainer)
      : Boolean; virtual;
    ...
    procedure RunFilterCustomizeDialog
      (AItem: TcxCustomInplaceEditContainer = nil); virtual;
    procedure SetCurrentScrollbarAnnotationRecordIndex
      (AIndex: Integer); virtual;
    procedure UpdateFilterBoxTokenCriteria; virtual;
    function GetControllerClass: TcxCustomControlControllerClass; virtual;
    // TODO: need overriding
    ...
    property Containers[AIndex: Integer]: TcxCustomInplaceEditContainer
      read GetContainer;
    property Controller: TcxCustomControlController read FController;
    ...
    property ScrollbarAnnotationHelper: TcxEditingControlScrollbarAnnotations
      read FScrollbarAnnotationHelper;
    ...
    property OnCustomDrawCell: TcxCustomDrawViewInfoItemEvent
      read FOnCustomDrawCell write FOnCustomDrawCell;
    property OnEditChanged: TcxecItemEvent read FOnEditChanged
    ...
    property OnEditValueChanged: TcxecItemEvent read FOnEditValueChanged
    ...
    property OnFilterCustomization: TcxecFilterCustomizationEvent
      read FOnFilterCustomization write FOnFilterCustomization;
    property OnFilterDialogShow: TcxecFilterDialogShowEvent
      read FOnFilterDialogShow write FOnFilterDialogShow;
    property OnFindPanelVisibilityChanged: TcxecFindPanelVisibilityChangedEvent
      read FOnFindPanelVisibilityChanged write FOnFindPanelVisibilityChanged;
    property OnGetScrollbarAnnotationHint: TdxGetScrollbarAnnotationHint
      read FOnGetScrollbarAnnotationHint write FOnGetScrollbarAnnotationHint;
    property OnInitEdit: TcxecInitEditEvent read FOnInitEdit write FOnInitEdit;
    property OnInitEditValue: TcxecInitEditValueEvent read FOnInitEditValue
      write FOnInitEditValue;
    property OnInitFilteringDateRanges: TdxInitDateRangesEvent
      read FOnInitFilteringDateRanges write FOnInitFilteringDateRanges;
    property OnPopulateCustomScrollbarAnnotationRowIndexList
      : TdxPopulateCustomScrollbarAnnotationRowIndexList
      read FOnPopulateCustomScrollbarAnnotationRowIndexList
      write FOnPopulateCustomScrollbarAnnotationRowIndexList;
  public
    constructor Create(AOwner: TComponent); override;
    destructor Destroy; override;
  ...
  private
    ...
    procedure SetScrollbarAnnotations
      (Value: TcxControlScrollbarAnnotationOptions);
  protected
    ...
    function CreateScrollbarAnnotationHelper
      : TcxEditingControlScrollbarAnnotations; virtual;
    function CreateScrollbarAnnotations
      : TcxControlScrollbarAnnotationOptions; virtual;
    procedure CreateSubClasses; override;
    procedure DestroySubClasses; override;

    function GetDateTimeHandlingClass
      : TcxControlOptionsDateTimeHandlingClass; virtual;
    ...
    property DateTimeHandling: TcxControlOptionsDateTimeHandling
      read FDateTimeHandling write SetDateTimeHandling;
    property FilterBox: TcxControlOptionsFilterBox read FFilterBox
      write SetFilterBox;
    property Filtering: TcxControlOptionsFiltering read FFiltering
      write SetFiltering;
    property FindPanel: TcxControlOptionsFindPanel read FFindPanel
      write SetFindPanel;
    property Navigator: TcxControlNavigator read FNavigator write SetNavigator;
    property NavigatorEvents: TNotifyEvent read FNavigatorEvents
      write FNavigatorEvents;
    property OptionsBehavior: TcxControlOptionsBehavior read FOptionsBehavior
      write SetOptionsBehavior;
    property OptionsData: TcxControlOptionsData read FOptionsData
      write SetOptionsData;
    property OptionsView: TcxControlOptionsView read FOptionsView
      write SetOptionsView;
    property ScrollbarAnnotations: TcxControlScrollbarAnnotationOptions
      read FScrollbarAnnotations write SetScrollbarAnnotations;
    property ViewInfo: TcxExtEditingControlViewInfo read GetViewInfo;
  end;

procedure cxAssignEditStyle(AViewInfo: TcxEditCellViewInfo);
function cxPtInViewInfoItem(AItem: TcxCustomViewInfoItem;
...
function cxSetValue(Condition: Boolean;
  ATrueValue, AFalseValue: Integer): Integer;
...
uses
  Math, cxFormats, dxHooks, dxDPIAwareUtils, cxFilterConsts, cxFilterDialog,
  cxFilterControlDialog,
  cxDrawTextUtils, cxDropDownEdit, RTLConsts, dxCoreGraphics, dxScrollAnimation,
  dxThreading;
...
begin
  ...
  with AViewInfo do
  begin
    AStyle.FAssignedValues := AStyle.FAssignedValues - [svFont] +
      [svColor, svButtonTransparency];
...
procedure cxDragMouseHook(ACode: Integer; wParam: wParam; lParam: lParam;
...
constructor TcxControlFilterBoxMRUItems.Create
  (AFilterBox: TcxControlOptionsFilterBox);
begin
  inherited Create;
...
procedure TcxControlFilterBoxMRUItems.VisibleCountChanged(APrevVisibleCount
  : Integer);
begin
...
procedure TcxControlFindPanel.GetControlContentViewParams
...
procedure TcxControlOptionsFindPanel.SetBehavior
  (AValue: TcxDataFindCriteriaBehavior);
begin
  Options.Behavior := AValue;
end;

procedure TcxControlOptionsFindPanel.SetClearFindFilterTextOnClose
  (AValue: Boolean);
begin
  Options.ClearOnClose := AValue;
end;

procedure TcxControlOptionsFindPanel.SetDisplayMode
  (AValue: TcxFindPanelDisplayMode);
begin
  Options.DisplayMode := AValue;
end;

procedure TcxControlOptionsFindPanel.SetFocusContentOnApplyFilter
  (AValue: Boolean);
begin
...
procedure TcxControlOptionsFindPanel.SetMRUItemsListDropDownCount
  (AValue: Integer);
begin
...
procedure TcxControlFilterValueList.AddDateTimeAbsoluteFilters
  (ADateRange: TdxCustomDateRange; AIgnoreTime: Boolean);
var
  I: Integer;
  ADateTime: TDateTime;
...
procedure TcxControlFilterValueList.AddDateTimeRelativeFilters
  (AItem: TcxCustomInplaceEditContainer);
var
...
procedure TcxControlFilterValueList.AddDateTimeRelativeFilter
  (AFilter: TdxDateTimeFilter);
begin
  case AFilter of
    dtfRelativeDays:
...
function TcxControlFilterValueList.GetDateTimeRelativeFilterDisplayText
...
function TcxControlFilterValueList.IsSpecialOperatorKindSupported
...
begin
  inherited Load(AItem.ItemIndex, AInitSortByDisplayText, AUseFilteredValues,
...
procedure TcxControlFilterValueList.ApplyFilter
  (AItem: TcxCustomInplaceEditContainer; AIndex: Integer;
  AFilterList: TcxFilterCriteriaItemList;
  AReplaceExistent, AAddToMRUItemsList: Boolean);
    ...
    case AListItem.Kind of
      ...
      fviCustom:
        TdxUIThreadSyncService.EnqueueInvokeInUIThread(Self, procedure
          begin
            AItem.EditingControl.Options.OptionsFiltering.
              RunCustomizeDialog(AItem);
          end);
      fviBlanks:
...
function TcxControlFilterValueList.GetIndexByCriteriaItem
  (ACriteriaItem: TcxFilterCriteriaItem): Integer;
begin
  Result := -1;
...
begin
  FilterMRUValueItems.MaxCount := EditContainer.EditingControl.Options.
    OptionsFiltering.ItemPopup.MRUItemsListCount;
...
function TcxCustomItemDataBinding.GetDefaultValuesProviderClass
...
function TcxCustomItemDataBinding.GetFilterMRUValueItemsClass
  : TcxFilterMRUValueItemsClass;
begin
...
begin
  Result := DataController.IsDisplayFormatDefined(EditContainer.ItemIndex,
    not AIsCurrencyValueAccepted) or EditContainer.HasDataTextHandler;
end;
...
function TcxCustomItemDataBinding.AddToFilter
  (AParent: TcxFilterCriteriaItemList; AOperatorKind: TcxFilterOperatorKind;
const AValue: Variant; const ADisplayText: string = '';
...
begin
  ...
  Result := Filter.AddItem(AParent, EditContainer, AOperatorKind,
    AValue, AText);
end;

procedure TcxCustomItemDataBinding.GetFilterStrings(AStrings: TStrings;
AValueList: TcxControlFilterValueList; AValuesOnly: Boolean;
AUniqueOnly: Boolean);
var
  I: Integer;
...
procedure TcxCustomItemDataBinding.GetFilterValues
  (AValueList: TcxControlFilterValueList; AValuesOnly: Boolean;
...
begin
  AValueList.Load(EditContainer, AInitSortByDisplayText,
    ...
    EditContainer.ShowFilteredItemsOnlyForFilteredValues);
  ...
  if AValuesOnly then
    ...
    else if EditContainer.CanFilterMRUValueItems then
      FilterMRUValueItems.AddItemsTo(AValueList);
end;

procedure TcxCustomItemDataBinding.GetFilterActiveValueIndexes
  (AValueList: TcxControlFilterValueList; var AIndexes: TdxIntegerIndexes);

  procedure CheckFilterItem(AFilterItem: TcxFilterCriteriaItem);
  var
    AValueIndex: Integer;
  begin
    if AFilterItem.ItemLink <> EditContainer then
      Exit;
...
procedure TcxCustomItemDataBinding.SetFilterActiveValue(AOperatorKind
...
procedure TcxCustomItemDataBinding.SetFilterActiveValueIndex
  (AValueList: TcxControlFilterValueList; AIndex: Integer;
AFilterList: TcxFilterCriteriaItemList;
AReplaceExistent, AAddToMRUItemsList: Boolean);
begin
  AValueList.ApplyFilter(EditContainer, AIndex, AFilterList, AReplaceExistent,
    AAddToMRUItemsList);
end;

procedure TcxCustomItemDataBinding.SetFilterActiveValueIndexes
  (AValueList: TcxControlFilterValueList; const AIndexes: TdxIntegerIndexes;
...
procedure TcxCustomItemDataBinding.SetFilterActiveValues
...
function TcxCustomItemDataBinding.GetEditContainer
  : TcxCustomInplaceEditContainer;
begin
...
function TcxControlDataController.GetFilterItemFieldCaption
...
function TcxControlDataController.GetItemValueSource(AItemIndex: Integer)
  : TcxDataEditValueSource;
begin
  Result := GetControl.Containers[AItemIndex]
    .PropertiesValue.GetEditValueSource(True);
end;

function TcxControlDataController.CreateExpressionProvider
...
constructor TcxCustomEditContainerItemFilterPopupIncrementalFilteringOptions.
...
procedure TcxCustomEditContainerItemFilterPopupIncrementalFilteringOptions.
  Assign(Source: TPersistent);
var
  ASource: TcxCustomEditContainerItemFilterPopupIncrementalFilteringOptions;
begin
  if Source is TcxCustomEditContainerItemFilterPopupIncrementalFilteringOptions
  then
  begin
    ASource :=
      TcxCustomEditContainerItemFilterPopupIncrementalFilteringOptions(Source);
...
function TcxCustomEditContainerItemFilterPopupIncrementalFilteringOptions.
  GetEditContainer: TcxCustomInplaceEditContainer;
begin
  Result := TcxCustomInplaceEditContainer(Owner);
end;

procedure TcxCustomEditContainerItemFilterPopupIncrementalFilteringOptions.
  SetEnabled(AValue: Boolean);
begin
...
procedure TcxCustomEditContainerItemFilterPopupIncrementalFilteringOptions.
  SetOptions(AValue: TcxTextEditIncrementalFilteringOptions);
begin
...
constructor TcxCustomEditContainerItemCustomFilterPopupOptions.Create
  (AOwner: TPersistent);
begin
  inherited Create(AOwner);
...
procedure TcxCustomEditContainerItemCustomFilterPopupOptions.Assign
  (Source: TPersistent);
var
...
begin
  ...
  begin
    ...
    FilteredItemsListShowFilteredItemsOnly :=
      ASource.FilteredItemsListShowFilteredItemsOnly;
  end;
end;
...
function TcxCustomEditContainerItemCustomFilterPopupOptions.GetEditContainer
  : TcxCustomInplaceEditContainer;
begin
  Result := TcxCustomInplaceEditContainer(Owner);
end;

procedure TcxCustomEditContainerItemCustomFilterPopupOptions.
  SetFilteredItemsList(Value: Boolean);
begin
...
procedure TcxCustomEditContainerItemCustomFilterPopupOptions.
  SetFilteredItemsListShowFilteredItemsOnly(Value: Boolean);
begin
...
constructor TcxCustomEditContainerItemFilterPopupOptions.Create
  (AOwner: TPersistent);
begin
  inherited Create(AOwner);
  FAddValueItems := True;
  FEnabled := True;
  FIncrementalFiltering := GetIncrementalFilteringOptionsClass.Create
    (EditContainer);
  FMRUItemsList := True;
  FMultiSelect := True;
end;
...
procedure TcxCustomEditContainerItemFilterPopupOptions.Assign
  (Source: TPersistent);
var
...
function TcxCustomEditContainerItemFilterPopupOptions.
  GetIncrementalFilteringOptionsClass
  : TcxCustomEditContainerItemFilterPopupIncrementalFilteringOptionsClass;
begin
  Result := TcxCustomEditContainerItemFilterPopupIncrementalFilteringOptions;
end;

procedure TcxCustomEditContainerItemFilterPopupOptions.SetAddValueItems
  (Value: Boolean);
begin
...
procedure TcxCustomEditContainerItemFilterPopupOptions.SetMRUItemsList
  (Value: Boolean);
begin
...
procedure TcxCustomEditContainerItemFilterPopupOptions.SetEnabled
  (Value: Boolean);
begin
...
procedure TcxCustomEditContainerItemFilterPopupOptions.SetIncrementalFiltering
  (AValue: TcxCustomEditContainerItemFilterPopupIncrementalFilteringOptions);
begin
  IncrementalFiltering.Assign(AValue);
end;

procedure TcxCustomEditContainerItemFilterPopupOptions.SetMultiSelect
  (Value: Boolean);
begin
...
procedure TcxCustomEditContainerItemExcelFilterPopupOptions.Assign
  (ASource: TPersistent);
var
...
procedure TcxCustomEditContainerItemExcelFilterPopupOptions.SetApplyChanges
  (AValue: TdxExcelFilterValueContainerApplyChangesMode);
begin
...
procedure TcxCustomEditContainerItemExcelFilterPopupOptions.
  SetDateTimeValuesPageType(const AValue
  : TdxExcelFilterValueContainerDateTimeValuesPageType);
begin
...
procedure TcxCustomEditContainerItemExcelFilterPopupOptions.
  SetNumericValuesPageType(const AValue
  : TdxExcelFilterValueContainerNumericValuesPageType);
begin
...
function TcxCustomEditContainerItemOptions.GetFilterPopupWindowApplyMode
  : TdxFilterApplyChangesMode;
begin
  Result := EditContainer.EditingControl.Options.OptionsFiltering.ItemPopup.
    ApplyMultiSelectChanges;
end;

function TcxCustomEditContainerItemOptions.
...
function TcxCustomEditContainerItemOptions.GetExcelFilterPopupApplyChanges
  : TdxExcelFilterValueContainerApplyChangesMode;
begin
  Result := ExcelFilterPopup.ApplyChanges;
  if Result = efacDefault then
    Result := EditContainer.EditingControl.Options.OptionsFiltering.
      ItemExcelPopup.ApplyChanges;
end;
...
begin
  ...
  if Result = dvptDefault then
    Result := EditContainer.EditingControl.Options.OptionsFiltering.
      ItemExcelPopup.DateTimeValuesPageType;
end;

function TcxCustomEditContainerItemOptions.GetExcelFilterPopupDefaultPage
  : TdxExcelFilterValueContainerDefaultPage;
begin
  Result := ExcelFilterPopup.DefaultPage;
  if Result = dpDefault then
    Result := EditContainer.EditingControl.Options.OptionsFiltering.
      ItemExcelPopup.DefaultPage;
end;
...
begin
  ...
  if Result = nvptDefault then
    Result := EditContainer.EditingControl.Options.OptionsFiltering.
      ItemExcelPopup.NumericValuesPageType;
end;
...
begin
  ...
  begin
    FEditing := Value;
    if not Value then
      EditContainer.Editing := False;
  end;
end;

procedure TcxCustomEditContainerItemOptions.SetExcelFilterPopup
  (AValue: TcxCustomEditContainerItemExcelFilterPopupOptions);
begin
...
procedure TcxCustomEditContainerItemOptions.SetFilteringWithFindPanel
  (AValue: Boolean);
begin
...
procedure TcxCustomEditContainerItemOptions.SetFilterPopup
  (AValue: TcxCustomEditContainerItemFilterPopupOptions);
begin
  FilterPopup.Assign(AValue);
end;

procedure TcxCustomEditContainerItemOptions.SetFilterPopupMode
...
begin
  ...
  begin
    FFocusing := Value;
    if not Value then
      EditContainer.Focused := False;
  end;
end;

procedure TcxCustomEditContainerItemOptions.SetIgnoreTimeForFiltering
  (Value: Boolean);
begin
...
procedure TcxControlOptionsFilterBoxTokenCriteria.SetItemRemoval
  (AValue: Boolean);
begin
...
function TcxControlOptionsFilterBox.CreateTokenCriteria
  : TcxControlOptionsFilterBoxTokenCriteria;
begin
...
function TcxControlOptionsFilterBox.GetMRUItemsClass
  : TcxControlFilterBoxMRUItemsClass;
begin
...
procedure TcxControlOptionsFilterBox.MRUItemsVisibleCountChanged(AOldCount,
  ANewCount: Integer);
begin
...
procedure TcxControlOptionsFilterBox.SetButtonPosition
  (const Value: TcxFilterBoxButtonAlignment);
begin
...
procedure TcxControlOptionsFilterBox.SetCriteriaDisplayStyle
...
procedure TcxControlOptionsFilterBox.SetMRUItemsListDropDownCount
  (Value: Integer);
begin
  if Value < 0 then
    Value := 0;
...
procedure TcxControlOptionsFilterBox.SetTokenCriteria
  (Value: TcxControlOptionsFilterBoxTokenCriteria);
begin
...
constructor TcxControlOptionsFilteringItemCustomPopup.Create
  (AOwner: TPersistent);
begin
  inherited Create(AOwner);
  FFilteredItemsListShowFilteredItemsOnly := True;
...
procedure TcxControlOptionsFilteringItemCustomPopup.Assign
  (ASource: TPersistent);
var
...
begin
  ...
  begin
    ...
    FilteredItemsListShowFilteredItemsOnly :=
      AOptions.FilteredItemsListShowFilteredItemsOnly;
  end;
end;

procedure TcxControlOptionsFilteringItemCustomPopup.SetFilteredItemsList
  (AValue: Boolean);
begin
...
procedure TcxControlOptionsFilteringItemCustomPopup.
  SetFilteredItemsListShowFilteredItemsOnly(AValue: Boolean);
begin
...
procedure TcxControlOptionsFilteringItemPopup.ChangeScale(M: Integer;
D: Integer);
begin
  inherited;
...
begin
  for I := 0 to EditingControl.ContainerCount - 1 do
    EditingControl.Containers[I].DataBinding.FilterMRUValueItems.MaxCount :=
      MRUItemsListCount;
  Changed;
end;
...
procedure TcxControlOptionsFilteringItemPopup.SetApplyMultiSelectChanges
  (AValue: TdxFilterApplyChangesMode);
begin
...
procedure TcxControlOptionsFilteringItemPopup.SetMaxDropDownItemCount
  (AValue: Integer);
begin
  AValue := Max(AValue, 0);
...
procedure TcxControlOptionsFilteringItemPopup.SetMRUItemsListCount
  (Value: Integer);
begin
  if Value < 0 then
    Value := 0;
...
procedure TcxControlOptionsFilteringItemExcelPopup.SetApplyChanges
  (AValue: TdxExcelFilterValueContainerApplyChangesMode);
begin
  if AValue <> ApplyChanges then
  begin
...
procedure TcxControlOptionsFilteringItemExcelPopup.SetDefaultPage
  (const AValue: TdxExcelFilterValueContainerDefaultPage);
begin
  if AValue <> DefaultPage then
  begin
...
procedure TcxControlOptionsFiltering.SetItemExcelPopup
  (Value: TcxControlOptionsFilteringItemExcelPopup);
begin
  FItemExcelPopup.Assign(Value);
end;

procedure TcxControlOptionsFiltering.SetItemPopup
  (Value: TcxControlOptionsFilteringItemPopup);
begin
  FItemPopup.Assign(Value);
end;

procedure TcxControlOptionsFiltering.SetItemPopupMode
...
function TcxControlOptionsFiltering.GetItemExcelPopupClass
  : TcxControlOptionsFilteringItemExcelPopupClass;
begin
  Result := TcxControlOptionsFilteringItemExcelPopup;
end;

function TcxControlOptionsFiltering.GetItemPopupClass
...
procedure TcxControlOptionsFiltering.RunCustomizeDialog
  (AItem: TcxCustomInplaceEditContainer);
begin
...
procedure TcxControlOptionsDateTimeHandling.SetFilters
  (Value: TdxDateTimeFilters);
begin
...
procedure TcxControlOptionsDateTimeHandling.SetIgnoreTimeForFiltering
  (Value: Boolean);
begin
  if FIgnoreTimeForFiltering <> Value then
  begin
...
procedure TcxControlOptionsDateTimeHandling.SetUseLongDateFormat
  (Value: Boolean);
begin
...
procedure TcxControlOptionsDateTimeHandling.SetUseShortTimeFormat
  (Value: Boolean);
begin
...
function TcxControlOptionsView.GetDefaultShowEditButtons
...
begin
  Result := (ShowItemFilterButtons = sfbAlways) or
    (ShowItemFilterButtons = sfbDefault) and cxIsTouchModeEnabled;
end;

function TcxControlOptionsView.IsItemFilterSmartTag: Boolean;
begin
  Result := (ItemFilterButtonShowMode = fbmSmartTag) or
    (ItemFilterButtonShowMode = fbmDefault) and not cxIsTouchModeEnabled;
end;
...
procedure TcxControlOptionsView.SetCellTextMaxLineCount(const Value: Integer);
begin
...
procedure TcxControlOptionsView.SetItemFilterButtonShowMode
...
procedure TcxControlOptionsView.SetShowItemFilterButtons
...
procedure TcxControlOptionsBehavior.SetIncSearchItem
...
constructor TcxControlScrollbarAnnotationOptionsHelper.Create
  (AOwner: TcxExtEditingControl);
begin
  inherited Create;
  FOwner := AOwner;
end;
...
function TcxControlScrollbarAnnotationOptionsHelper.IsVisible
...
function TcxControlScrollbarAnnotationOptions.CreateHelper
  : TcxControlScrollbarAnnotationOptionsHelper;
begin
  Result := TcxControlScrollbarAnnotationOptionsHelper.Create
    (EditingControl as TcxExtEditingControl);
end;
...
function TcxControlScrollbarAnnotationOptions.GetCustomScrollbarAnnotations
  : TdxCustomScrollbarAnnotations;
begin
...
function TcxControlScrollbarAnnotationOptions.IsValueStored
...
constructor TcxControlNavigatorInfoPanel.Create(AControl: TcxExtEditingControl);
begin
  inherited Create(AControl);
  FControl := AControl;
end;
...
function TcxControlNavigator.GetInfoPanelClass
  : TcxControlNavigatorInfoPanelClass;
begin
  Result := TcxControlNavigatorInfoPanel;
end;

function TcxControlNavigator.GetNavigatorButtonsClass
  : TcxExtEditingControlNavigatorButtonsClass;
begin
...
procedure TcxControlNavigator.SetButtons
  (Value: TcxExtEditingControlNavigatorButtons);
begin
...
function TcxCustomInplaceEditContainer.GetDateTimeHandlingFilters
  : TdxDateTimeFilters;
begin
...
procedure TcxCustomInplaceEditContainer.GetFilterActiveValueIndexes
...
function TcxCustomInplaceEditContainer.GetFilterSelectedValueIndex
  (AValues: TcxFilterValueList): Integer;
begin
  Result := AValues.GetIndexByCriteriaItem(DataBinding.FilterCriteriaItem);
end;

function TcxCustomInplaceEditContainer.GetFilterValuesClass
  : TcxFilterValueListClass;
begin
  Result := EditingControl.GetFilterValueListClass;
end;

procedure TcxCustomInplaceEditContainer.PopulateFilterValues
...
procedure TcxCustomInplaceEditContainer.SetFilterActiveValueIndex
...
procedure TcxCustomInplaceEditContainer.SetFilterActiveValueIndexes
...
function TcxCustomInplaceEditContainer.GetFilterProperties
  : TcxCustomEditProperties;
begin
  Result := PropertiesValue;
end;

function TcxCustomInplaceEditContainer.GetFilterValueTypeClass
  : TcxValueTypeClass;
begin
  Result := GetEditDataValueTypeClass;
end;

procedure TcxCustomInplaceEditContainer.SetFilterActiveValue
  (AOperatorKind: TcxFilterOperatorKind; const AValue: Variant;
...
procedure TcxCustomInplaceEditContainer.SetFilterActiveValues
  (AValueInfos: TdxFastObjectList; ABoolOperator: TcxFilterBoolOperatorKind);
begin
...
procedure TcxCustomInplaceEditContainer.CalculateEditViewInfo
  (const AValue: Variant; AEditViewInfo: TcxEditCellViewInfo;
const APoint: TPoint);
var
  ACanvas: TcxCanvas;
begin
  ...
  begin
    ...
    ViewData.CalculateEx(ACanvas, ContentRect, APoint, cxmbNone, [],
      ViewInfo, False);
  end;
end;
...
begin
  Result := EditingControl.Options.OptionsFiltering.ItemPopup.MRUItemsList and
    FOptions.FilterPopup.MRUItemsList and not CanFilterUsingChecks;
end;

function TcxCustomInplaceEditContainer.CanFilterUsingChecks: Boolean;
begin
  Result := EditingControl.Options.OptionsFiltering.ItemPopup.MultiSelect and
    FOptions.FilterPopup.MultiSelect;
end;
...
begin
  Result := IsDateTimeValueTypeClass(GetEditDataValueTypeClass) and
    Options.IgnoreTimeForFiltering and
...
function TcxCustomInplaceEditContainer.CreateEditViewData
  (AProperties: TcxCustomEditProperties; AEditStyleData: Pointer)
  : TcxCustomEditViewData;
begin
...
procedure TcxCustomInplaceEditContainer.DoCalculateEditViewInfo
...
function TcxCustomInplaceEditContainer.DoGetEditProperties(AData: Pointer)
  : TcxCustomEditProperties;
begin
  Result := DoGetPropertiesFromEvent(FOnGetEditProperties, AData,
    FPropertiesValue);
end;
...
begin
  AProperties := DoGetPropertiesFromEvent(FOnGetEditingProperties, AData,
    AProperties);
end;

procedure TcxCustomInplaceEditContainer.DoGetFilterValues
...
procedure TcxCustomInplaceEditContainer.DoUserFiltering(const AValue: Variant;
const ADisplayText: string);
begin
...
procedure TcxCustomInplaceEditContainer.DoUserFilteringEx
...
function TcxCustomInplaceEditContainer.GetDefaultEditProperties
  : TcxCustomEditProperties;
begin
  if FRepositoryItem <> nil then
    Result := FRepositoryItem.Properties
  else if FProperties <> nil then
    Result := FProperties
  else
...
function TcxCustomInplaceEditContainer.GetController
  : TcxCustomControlController;
begin
...
function TcxCustomInplaceEditContainer.GetDataBindingClass
  : TcxItemDataBindingClass;
begin
...
function TcxCustomInplaceEditContainer.GetEditDataValueTypeClass
  : TcxValueTypeClass;
begin
  Result := FDataBinding.ValueTypeClass;
end;

function TcxCustomInplaceEditContainer.GetEditDefaultHeight
  (AFont: TFont): Integer;
var
...
function TcxCustomInplaceEditContainer.GetEditHeight(AEditViewInfo
  : TcxEditCellViewInfo): Integer;
var
  ASizeProp: TcxEditSizeProperties;
begin
  ASizeProp := cxDefaultEditSizeProperties;
  ...
  begin
    ...
    Result := ViewData.GetEditSize(GetControlCanvas, DisplayValue,
      ASizeProp).cy;
...
function TcxCustomInplaceEditContainer.GetEditWidth(AEditViewInfo
  : TcxEditCellViewInfo): Integer;
var
  ASizeProp: TcxEditSizeProperties;
begin
...
begin
  Result := Filterable and Options.FilterPopup.Enabled and
    dxDefaultBooleanToBoolean
    (EditingControl.Options.OptionsBehavior.ItemFiltering,
    cxControlDefaultItemFiltering);
end;

procedure TcxCustomInplaceEditContainer.GetFilterDisplayText
...
function TcxCustomInplaceEditContainer.GetFilteringDateRangesClass
  : TdxFilteringDateRangesClass;
begin
...
function TcxCustomInplaceEditContainer.GetFilterPopupMode
...
function TcxCustomInplaceEditContainer.GetOptionsClass
  : TcxCustomEditContainerItemOptionsClass;
begin
  Result := TcxCustomEditContainerItemOptions;
end;

function TcxCustomInplaceEditContainer.GetStylesClass
  : TcxEditContainerStylesClass;
begin
...
function TcxCustomInplaceEditContainer.
  HasInitFilteringDateRangesHandler: Boolean;
begin
  Result := Assigned(FOnInitFilteringDateRanges);
end;

function TcxCustomInplaceEditContainer.
  HasInitFilteringDateRangesHandlers: Boolean;
begin
  Result := EditingControl.HasInitFilteringDateRangesHandler or
...
function TcxCustomInplaceEditContainer.GetEditStyle(AData: Pointer)
  : TcxCustomEditStyle;
begin
...
procedure TcxCustomInplaceEditContainer.SetValue(ARecordIndex: Integer;
const Value: Variant);
begin
...
function TcxCustomInplaceEditContainer.
  ShowFilteredItemsOnlyForFilteredValues: Boolean;
var
...
begin
  ...
  begin
    AControlPopupOptions := EditingControl.Options.OptionsFiltering.
      ItemExcelPopup;
...
function TcxCustomInplaceEditContainer.
  UseFilteredValuesForFilterValueList: Boolean;
var
  AControlPopupOptions: TcxControlOptionsFilteringItemCustomPopup;
  AItemPopupOptions: TcxCustomEditContainerItemCustomFilterPopupOptions;
begin
  ...
  Result := AControlPopupOptions.FilteredItemsList and
    AItemPopupOptions.FilteredItemsList;
end;

function TcxCustomInplaceEditContainer.UseValueItemsForFilterValueList: Boolean;
begin
  Result := Options.FilterPopup.AddValueItems and
    EditingControl.Options.OptionsFiltering.ItemPopup.AddValueItems;
end;
...
procedure TcxCustomInplaceEditContainer.ValidateEditData(AEditProperties
  : TcxCustomEditProperties);
begin
...
function TcxCustomInplaceEditContainer.GetDataController
...
begin
  Result := Options.Filtering and
    (esoFiltering in PropertiesValue.GetSupportedOperations);
end;
...
function TcxCustomInplaceEditContainer.GetFocusedCellViewInfo
  : TcxEditCellViewInfo;
begin
...
function TcxCustomInplaceEditContainer.GetPropertiesClass
...
function TcxCustomInplaceEditContainer.GetPropertiesValue
  : TcxCustomEditProperties;
begin
...
procedure TcxCustomInplaceEditContainer.SetDataBinding
  (Value: TcxCustomItemDataBinding);
begin
...
begin
  ...
  else if Focused and not(Controller.Navigator.FocusNextCell(True, False) or
...
procedure TcxCustomInplaceEditContainer.InitEditViewInfo(AEditViewInfo
  : TcxEditCellViewInfo);
  ...
  begin
    ...
    begin
      try
        ...
        ViewInfo.OnAfterDrawBackground :=
          AEditViewInfo.AfterDrawCellBackgroundHandler;
        ...
        ViewInfo.OnCalculateEditorBounds :=
          AEditViewInfo.CalculateCellEditorBounds;
        if not IsViewDataCreated then
          TcxCustomEditViewDataAccess(ViewData).InitCacheData;
      end;
    end
    else if not IsViewDataCreated then
      ViewData := EditViewData;
...
begin
  ...
  if not Controller.IsEditing and not Controller.FEditingController.EditHiding
  then
    FreeAndNil(FEditData);
  FreeAndNil(FEditViewData);
...
function TcxCustomInplaceEditContainer.
  IsDefaultVisibleForExpressionEditor: Boolean;
begin
  Result := IsVisible;
end;
...
procedure TcxCustomInplaceEditContainer.RepositoryItemRemoved
  (Sender: TcxEditRepositoryItem);
begin
  RepositoryItem := nil;
end;
...
constructor TcxInplaceContainerHintHelper.Create(AController
  : TcxHotTrackController);
begin
  inherited Create;
  FController := AController;
...
begin
  if Control.IsLocked then
    ...
    try
      ...
      else if Int64(PrevHitPoint) <> Int64(APoint) then
        CalculateHotState(AElement, APoint);
    finally
      PrevHitPoint := APoint;
...
begin
  ...
  if Result then
  begin
    Result := cxCanShowHint(Control) and not Control.IsDesigning and
      not Control.Dragging and (Control.DragAndDropState = ddsNone) and
...
procedure TcxHotTrackController.CheckHint;
  ...
  begin
    ATextOffsets := Rect(ATextRect.Left - AHintBounds.Left,
      ATextRect.Top - AHintBounds.Top, AHintBounds.Right - ATextRect.Right,
      AHintBounds.Bottom - ATextRect.Bottom);
...
var
  ...
  AHintBounds: TRect;
begin
  if Supports(PrevElement, IcxHotTrackElement, AIHotTrackElement) and CanShowHint
  then
  begin
    ...
    begin
      ...
      FHintHelper.ShowHint(AHintBounds, ATextRect, AHintText, AHintIsMultiLine,
        HintElement, cxScreenCanvas.Font);
    end;
...
constructor TcxEditingController.Create(AController
  : TcxCustomControlController);
begin
...
procedure TcxEditingController.SetEditingItem
  (Value: TcxCustomInplaceEditContainer);
begin
  ...
  begin
    ...
    try
      if Value <> nil then
      begin
        if not Value.CanEdit or not EditingControl.DoEditing(Value) then
          Exit;
        Value.Focused := True;
      end;
      HideEdit(False);
...
begin
  ...
  begin
    ...
    AEditViewInfo := EditingCellViewInfo;
    if (AEditViewInfo = nil) or not AEditViewInfo.Visible or
      cxRectIsEmpty(AEditViewInfo.EditRect) then
...
begin
  Result := not Controller.GetAlwaysShowEditor or
    Controller.EditingControl.IsFocused;
end;

function TcxEditingController.GetHideEditOnFocusedRecordChange: Boolean;
begin
  // TODO
  Result := not FController.GetAlwaysShowEditor or (FEditingItem <> nil) and
    Assigned(FEditingItem.OnGetEditProperties)
  { or FEditingItem.ShowButtons(False) } or
...
begin
  Result := not(Controller.IsFindPanelVisible and
...
begin
  ...
  if EditPreparing or EditHiding or (AItem = nil) or IsDragging then
    Exit;
...
begin
  ...
  begin
    ...
    if not EditingControl.IsScrollingContent and IsKeyForController(Key, Shift)
    then
...
procedure TcxEditingController.EditKeyUp(Sender: TObject; var Key: Word;
Shift: TShiftState);
begin
...
procedure TcxEditingController.StartEditShowingTimer
  (AItem: TcxCustomInplaceEditContainer);
begin
...
begin
  if not DynamicUpdate and cxRectIntersect(GetSizingMarkBounds,
    Control.ClientBounds) then
    Canvas.InvertRect(GetSizingMarkBounds);
  inherited DirtyChanged;
end;

procedure TcxSizingDragAndDropObject.DragAndDrop(const P: TPoint;
...
begin
  ...
  with FDragBounds do
    if (DragCoord[P] < DragCoord[TopLeft]) or
      (DragCoord[P] > DragCoord[BottomRight]) then
      Exit;
  ...
  if (FDelta = 0) and (DragCoord[ADragPos] = DragCoord[DragPos]) then
    Exit;
  Dirty := True;
  FDragPos := ADragPos;
...
begin
  ...
  if Accepted and not DynamicUpdate and (Delta <> 0) and not Controller.FDragCancel
  then
    DragSizing.SetSizeDelta(Direction, Delta);
end;
...
begin
  if IsHorzSizing then
    Result := cxRectSetLeft(FDragBounds, DragPos.X - cxSizingMarkWidth div 1,
      cxSizingMarkWidth)
  else
    Result := cxRectSetTop(FDragBounds, DragPos.Y - cxSizingMarkWidth div 1,
      cxSizingMarkWidth);
end;
...
procedure TcxCustomAutoScrollingObject.SetParams(const Area: TRect;
AKind: TScrollBarKind; ACode: TScrollCode; AIncrement: Integer);
begin
  FArea := Area;
  FCode := ACode;
  FKind := AKind;
...
function TcxCustomAutoScrollingObject.GetScrollBar(AKind: TScrollBarKind)
  : IcxControlScrollBar;
begin
...
procedure TcxCustomAutoScrollingObject.GetScrollBarParams(var AMin, AMax,
  APos: Integer);
begin
...
procedure TcxCustomAutoScrollingObject.Scroll(AKind: TScrollBarKind;
...
procedure TcxAutoScrollingEditingControlObject.Scroll(AKind: TScrollBarKind;
ACode: TScrollCode; var APosition: Integer);
begin
...
procedure TcxControllerAutoScrollingObject.SetBoundsParams(const AClientArea
  : TRect; ACheckHorz, ACheckVert: Boolean; AIncrement: Integer);
begin
  FArea := AClientArea;
    ...
    begin
      ...
      begin
        ...
        if ANewPos <> APos then
          TcxEditingControl(Self.Control).Controller.Scroll(AKind,
            ACode, ANewPos);
      end;
    end;
  end;
...
constructor TcxPlaceArrows.CreateArrows(AColor: TColor;
ABorderColor: TColor = clDefault);
begin
  inherited Create;
...
var
  ...
  AVertical: Boolean;
begin
  Result := not EqualRect(ARect, FPrevRect) or (ASide <> FPrevSide) or
    not Visible;
  if Result then
  begin
    FPrevRect := ARect;
...
procedure TcxCustomControlDragAndDropObject.DrawImage(const APoint: TPoint);
begin
  DragImage.MoveTo(APoint);
  DragImage.Show;
end;

procedure TcxCustomControlDragAndDropObject.EndDragAndDrop(Accepted: Boolean);
begin
  StopScrolling;
  inherited EndDragAndDrop(Accepted);
end;
...
function TcxCustomControlDragAndDropObject.GetAutoScrollingObjectClass
  : TcxCustomAutoScrollingObjectClass;
begin
...
function TcxCustomControlDragAndDropObject.GetAutoScrollObject(Index: Integer)
  : TcxCustomAutoScrollingObject;
begin
...
function TcxCustomControlDragAndDropObject.GetHitTestController
  : TcxCustomHitTestController;
begin
...
procedure TcxDragImageHelper.DrawImage(const APoint: TPoint);
begin
  DragImage.MoveTo(APoint);
...
constructor TcxCustomHitTestController.Create
...
function TcxCustomHitTestController.AllowDesignMouseEvents(const P: TPoint;
AShift: TShiftState): Boolean;
begin
  Result := AllowDesignMouseEvents(P.X, P.Y, AShift);
end;

function TcxCustomHitTestController.AllowDesignMouseEvents(X, Y: Integer;
AShift: TShiftState): Boolean;
begin
...
procedure TcxCustomHitTestController.HitTestItemChanged(APrevHitTestItem
  : TObject);
begin
end;

procedure TcxCustomHitTestController.RecalculateOnMouseEvent(X, Y: Integer;
AShift: TShiftState);
begin
  FShift := AShift;
  IsMouseEvent := True;
...
function TcxCustomHitTestController.GetHotTrackController
  : TcxHotTrackController;
begin
...
procedure TcxCustomHitTestController.SetCoordinate(AIndex: Integer;
Value: Integer);
begin
...
procedure TcxCustomHitTestController.SetHasCode(ACode: TcxHitCode;
AValue: Boolean);
var
...
constructor TcxCustomCellNavigator.Create(AController
  : TcxCustomControlController);
begin
  FController := AController;
end;
...
begin
  ...
  repeat
    ...
    begin
      ...
      if (ARow <> ACurRow) and
        not((Count[ACurRow] = 0) and MayFocusedEmptyRow(ACurRow)) then
        ACurCell := cxSetValue(AForward, 0, Count[ACurRow] - 1)
      else
        break;
    end
    else if MayFocusedEmptyRow(ARowIndex) then
      break;
  until Result <> nil;
  ARowIndex := ACurRow;
  ACellIndex := ACurCell;
...
function TcxCustomCellNavigator.GetCellContainer(ARowIndex, ACellIndex: Integer)
  : TcxCustomInplaceEditContainer;
begin
  Result := nil;
  dxAbstractError;
...
procedure TcxCustomCellNavigator.Init(var ARowIndex, ACellIndex,
  ARowCount: Integer);
begin
  dxAbstractError;
end;
...
procedure TcxCustomCellNavigator.SetFocusCell(ARowIndex, ACellIndex: Integer;
AShift: TShiftState);
begin
  dxAbstractError;
end;
...
function TcxCustomDesignSelectionHelper.GetController
  : TcxCustomControlController;
begin
  ...
  case Key of
    ...
    VK_RETURN, VK_TAB:
      if ((Shift = []) or (Shift = [ssShift])) and
        ((Key = VK_RETURN) and GetGoToNextCellOnEnter or (Key = VK_TAB) and
        (GetGoToNextCellOnTab or IsFindPanelVisible)) then
      begin
        ARemoveFocus := False;
        if (Key = VK_TAB) and IsFindPanelVisible and not GetGoToNextCellOnTab
        then
          ARemoveFocus := not IsEditing
        else if Shift + [ssShift] = [ssShift] then
          if Navigator.FocusNextCell(Shift = [], Navigator.DownOnTab, Shift)
          then
            Key := 0
          else
        ...
        if ARemoveFocus and EditingControl.IsFocused then
          PostMessage(GetParentForm(EditingControl).Handle, WM_NEXTDLGCTL,
            wParam(ssShift in Shift), lParam(False));
      end;
    VK_F3:
...
begin
  ...
  if IsIncSearchStartChar(Key) and (ItemForIncSearching <> nil) and
    ItemForIncSearching.CanIncSearch and
...
procedure TcxCustomControlController.MouseMove(Shift: TShiftState;
X, Y: Integer);
begin
  if HitTestController.HitAtFindPanel then
...
begin
  ...
  if HitTestController.HitAtNavigator then
    (HitTestController.HitTestItem as TcxCustomNavigatorSiteViewInfo)
      .MouseUp(Button, X, Y);
end;
...
function TcxCustomControlController.HandleMessage
...
procedure TcxCustomControlController.DragAndDrop(const P: TPoint;
var Accepted: Boolean);
begin
end;
...
function TcxCustomControlController.StartDragAndDrop(const P: TPoint): Boolean;
begin
  Result := False;
end;
...
procedure TcxCustomControlController.BeforeMouseDown(Button: TMouseButton;
Shift: TShiftState; X, Y: Integer);
begin
...
function TcxCustomControlController.GetIncSearchingItem
  : TcxCustomInplaceEditContainer;
begin
  if IsIncSearching then
...
procedure TcxCustomControlController.DoMouseDown(Button: TMouseButton;
Shift: TShiftState; X, Y: Integer);
var
...
begin
  ...
  begin
    AButtonClick := HitTestController.IsItemEditCell and
      EditCellViewInfo.ViewInfo.IsHotTrack(Point(X, Y))
    { and (EditingControl.DragMode = dmManual) };
    if AButtonClick then
  ...
  begin
    ...
    if IsEditing and (AEditViewInfo = EditingViewInfo) then
      Exit;
    SetFocusedRecordItem(AEditViewInfo.RecordIndex,
      AEditViewInfo.EditContainer);
    HitTestController.RecalculateOnMouseEvent(X, Y, Shift);
    ...
    begin
      ...
      begin
        ...
        begin
          FWasFocusedBeforeClick := (APrevFocusedRecord = FocusedRecordIndex)
            and (APrevFocusedItem = FocusedItem) and (FocusedItem <> nil);
...
procedure TcxCustomControlController.DoMouseMove(Shift: TShiftState;
X, Y: Integer);
begin
  MouseMove(Shift, X, Y);
  HitTestController.RecalculateOnMouseEvent(X, Y, Shift);
...
procedure TcxCustomControlController.DoMouseUp(Button: TMouseButton;
Shift: TShiftState; X, Y: Integer);
begin
  ...
  begin
    with HitTestController do
      if not IsEditing and not IsDblClick and IsItemEditCell and
        (Button = mbLeft) then
        FEditingController.StartEditShowingTimer
          (EditCellViewInfo.EditContainer);
  end;
  HitTestController.RecalculateOnMouseEvent(X, Y, Shift);
  with HitTestController do
  begin
    if not IsEditing and not IsDblClick and IsItemEditCell and GetImmediateEditor
    then
    begin
...
procedure TcxCustomControlController.DoNextPage(AForward: Boolean;
Shift: TShiftState);
begin
end;
...
function TcxCustomControlController.GetFilterBoxMRUItemsPopupClass
  : TcxControlFilterBoxMRUItemsPopupClass;
begin
  Result := TcxControlFilterBoxMRUItemsPopup;
end;

function TcxCustomControlController.GetFilterPopupClass
  : TdxFilterPopupWindowClass;
begin
...
function TcxCustomControlController.GetFocusedCellViewInfo(AEditContainer
...
procedure TcxCustomControlController.FocusedItemChanged(APrevFocusedItem
  : TcxCustomInplaceEditContainer);

  procedure RefreshCells(APrevViewInfo, ACurViewInfo: TcxEditCellViewInfo);
  begin
    if (APrevViewInfo = ACurViewInfo) or DisableCellsRefresh then
      Exit;
...
begin
  if EditingControl.ComponentState * [csLoading, csDestroying] <> [] then
    Exit;
  CancelIncSearching;
...
begin
  Result := (EditingController.Edit <> nil) and
    EditingController.Edit.IsFocused or IsFindPanelVisible and
    FindPanel.IsEditFocused or HasFilterPopup and FilterPopup.Visible;
end;
...
function TcxCustomControlController.IncSearchKeyDown(AKey: Word;
...
function TcxCustomControlController.IsKeyForController(AKey: Word;
AShift: TShiftState): Boolean;
begin
  Result := ((AKey = VK_TAB) and GetGoToNextCellOnTab) or (AKey = VK_UP) or
    (AKey = VK_DOWN) or (AKey = VK_PRIOR) or (AKey = VK_NEXT) or
    (AKey = VK_INSERT) or (AKey = VK_ESCAPE) or (AKey = VK_LEFT) or
    (AKey = VK_RIGHT) or (AKey = Ord('F')) and (AShift = [ssCtrl]) and
    FindPanel.CanShow;
end;
...
begin
  ...
  try
    ...
    begin
      ...
      ANeedUpdate := ANeedUpdate or
        ((ACellViewInfo <> nil) and ACellViewInfo.Refresh(True));
    end;
  finally
...
procedure TcxCustomControlController.SetFocusedRecordIndex(Value: TdxNativeInt);
var
...
begin
  ...
  begin
    if cxInRange(Value, 0, RecordCount - 1) and
      not(CanFocusedRecordIndex(Value) and ChangeFocusedRowIndex(Value)) then
      Exit;
  end;
...
begin
  with EditingControl.Options.OptionsBehavior do
    Result := (ImmediateEditor or AlwaysShowEditor) and
      (EditingControl.DragMode = dmManual);
end;
...
procedure TcxCustomControlController.DragOver(Source: TObject; X, Y: Integer;
...
begin
  ...
  if FEditingBeforeDrag or EditingControl.Options.OptionsBehavior.AlwaysShowEditor
  then
    EditingController.ShowEdit;
end;

function TcxCustomControlController.GetDragAndDropObject
  : TcxCustomControlDragAndDropObject;
begin
  Result := EditingControl.DragAndDropObject as
    TcxCustomControlDragAndDropObject;
end;

function TcxCustomControlController.GetDragAndDropObjectClass
...
function TcxCustomControlController.GetNavigatorClass
  : TcxCustomCellNavigatorClass;
begin
...
procedure TcxCustomControlController.SetScrollBarInfo(AScrollBarKind
  : TScrollBarKind; AMin, AMax, AStep, APage, APos: Integer;
AAllowShow, AAllowHide: Boolean);
begin
  EditingControl.SetScrollBarInfo(AScrollBarKind, AMin, AMax, AStep, APage,
    APos, AAllowShow, AAllowHide);
end;
...
begin
  ...
  begin
    ...
    begin
      CheckEdit;
      if IsEditing and (Edit <> nil) and GetAlwaysShowEditor and
        not Edit.Focused and Edit.CanFocus then
        Edit.SetFocus
      else if (Edit <> nil) and not Edit.Focused and not GetAlwaysShowEditor
      then
        HideEdit(True)
      else if GetAlwaysShowEditor and not IsEditing and GetImmediateEditor then
        ShowEdit;
    end;
  end;
...
begin
  Result := not EditingControl.IsFocused or not IsEditing or
    (not GetAlwaysShowEditor and not(HitTestController.HitAtNavigator) and
...
begin
  with EditingController do
    if not Self.Focused and HideEditOnExit then
      HideEdit(True);
  EditingControl.ViewInfo.UpdateSelection;
  if IsFindPanelVisible then
...
function TcxCustomControlController.GetDesignSelectionHelper
  : TcxCustomDesignSelectionHelper;
begin
  Result := EditingControl.DesignSelectionHelper;
end;

function TcxCustomControlController.GetEditingItem
  : TcxCustomInplaceEditContainer;
begin
  Result := FEditingController.EditingItem;
end;

function TcxCustomControlController.GetFilterBoxMRUItemsPopup
  : TcxControlFilterBoxMRUItemsPopup;
begin
  if not HasFilterBoxMRUItemsPopup then
    FFilterBoxMRUItemsPopup := GetFilterBoxMRUItemsPopupClass.Create
      (EditingControl);
...
function TcxCustomControlController.GetItemForIncSearching
  : TcxCustomInplaceEditContainer;
begin
  Result := nil;
...
begin
  if (IncSearchingText = Value) or (GetItemIndex = -1) then
    Exit;
  if Value = '' then
    CancelIncSearching
  else
    SearchLocate(AItem, Value);
  if (ItemForIncSearching <> nil) and
    (ItemForIncSearching.FocusedCellViewInfo <> nil) then
...
function TcxCustomControlViewInfo.AddEditCellViewInfo(AViewInfoClass
...
begin
  ...
  if FilterBoxPosition = fpTop then
    if FindPanelPosition = fppTop then
      ...
      ATop := Bounds.Top
  else if FindPanelPosition = fppBottom then
...
function TcxCustomControlViewInfo.GetFilterBoxViewInfoClass
  : TcxControlFilterBoxViewInfoClass;
begin
  Result := TcxControlFilterBoxViewInfo;
end;

function TcxCustomControlViewInfo.GetFindPanelViewInfoClass
...
begin
  Result := (Control.Options.OptionsFilterBox.Visible = fvAlways) or
    (Control.Options.OptionsFilterBox.Visible = fvNonEmpty) and
    not FilterBoxViewInfo.Filter.IsEmpty;
end;
...
function TcxCustomControlViewInfo.GetLookAndFeelPainter
...
procedure TcxCustomControlCells.RightToLeftConversion
...
procedure TcxExtEditingControlViewInfo.Invalidate(ARecalculate
  : Boolean = False);
begin
...
procedure TcxExtEditingControlViewInfo.AddNavigatorSiteToPaintRegion
  (ACanvas: TcxCanvas);
begin
...
begin
  ...
  else if not Control.IsPopupScrollBars and Control.IsScrollBarActive
    (sbHorizontal) then
...
begin
  if not Control.IsPopupScrollBars and Control.IsScrollBarActive(sbVertical)
  then
...
function TcxExtEditingControlViewInfo.GetNavigatorSiteViewInfoClass
...
begin
  if (Control <> nil) and
    (Control.Controller.HotTrackController.HintElement = Self) then
...
function TcxCustomViewInfoItem.DrawBackgroundHandler(ACanvas: TcxCanvas;
const ABounds: TRect): Boolean;
begin
...
procedure TcxCustomViewInfoItem.DoRightToLeftConversion
  (const AClientBounds: TRect);
begin
  ClipRect := TdxRightToLeftLayoutConverter.ConvertRect(ClipRect,
    AClientBounds);
  DisplayRect := TdxRightToLeftLayoutConverter.ConvertRect(DisplayRect,
    AClientBounds);
  VisibleBounds := TdxRightToLeftLayoutConverter.ConvertRect(VisibleBounds,
    AClientBounds);
end;

procedure TcxCustomViewInfoItem.RightToLeftConversion
  (const AClientBounds: TRect);
begin
...
function TcxCustomViewInfoItem.ExcludeFromPaint(ACanvas: TcxCanvas): Boolean;
begin
  Result := Visible;
  if Result then
...
procedure TcxCustomViewInfoItem.Invalidate(const R: TRect;
...
var IsNeedOffsetHint: Boolean): Boolean;
begin
  Result := Visible and ViewInfo.NeedShowHint(ACanvas, P,
    GetControl.ClientBounds, AText, AIsMultiLine, ATextRect, GetMaxLineCount);
  IsNeedOffsetHint := False;
end;
...
begin
  if not IsSupportedHotTrack or IsEditing then
    Exit;
  ...
  try
    ...
    ViewData.CalculateEx(EditContainer.GetControlCanvas, ContentRect,
      cxPointOffset(APoint, cxPointInvert(GetCellOrg)), cxmbNone, [],
      ViewInfo, False);
    P := ViewInfo.SetOrigin(cxPointOffset(BoundsRect.TopLeft, GetCellOrg));
    if (EditContainer <> nil) and
      (EditContainer.EditingControl.DragAndDropState = ddsNone) then
...
function TcxEditCellViewInfo.ChangedHeight(APrevHeight,
...
procedure TcxEditCellViewInfo.CheckClipping(const ADisplayRect,
  AAvailableRect: TRect);
begin
...
function TcxEditCellViewInfo.CorrectHotTrackPoint(const APoint: TPoint): TPoint;
begin
  Result := APoint;
end;
...
procedure TcxEditCellViewInfo.DoRightToLeftConversion
  (const AClientBounds: TRect);
begin
  inherited DoRightToLeftConversion(AClientBounds);
  CellBorders := TdxRightToLeftLayoutConverter.ConvertBorders(CellBorders);
  CellContentRect := TdxRightToLeftLayoutConverter.ConvertRect(CellContentRect,
    AClientBounds);
  CellEditRect := TdxRightToLeftLayoutConverter.ConvertRect(CellEditRect,
    AClientBounds);
  EditViewInfo.Left := ContentRect.Left;
  cxAssignEditStyle(Self);
  EditContainer.DoCalculateEditViewInfo(Self);
  ViewData.CalculateEx(EditContainer.GetControlCanvas, ContentRect,
    cxInvalidPoint, cxmbNone, [], EditViewInfo, False);
end;

procedure TcxEditCellViewInfo.EditOwnerInvalidate(const R: TRect;
AEraseBackground: Boolean);
begin
...
procedure TcxEditCellViewInfo.CalculateCellEditorBounds
...
begin
  cxRectIntersect(Result, CellEditRect,
    EditContainer.FEditingControl.ClientBounds);
end;
...
begin
  with EditContainer do
    Result := (FocusedCellViewInfo = Self) and
      (DataController.FocusedRecordIndex = RecordIndex);
end;
...
function TcxEditCellViewInfo.GetViewData(out AIsViewDataCreated: Boolean)
  : TcxCustomEditViewData;
begin
...
var
  ATextEdit: TcxCustomTextEditAccess;
  AViewData: TcxCustomEditViewData;
begin
  if not((AEdit is TcxCustomTextEdit) and AEdit.HandleAllocated and
    ViewInfo.InheritsFrom(AEdit.ActiveProperties.GetViewInfoClass)) then
    Exit;
  ATextEdit := TcxCustomTextEditAccess(AEdit);
  AViewData := ATextEdit.CreateViewData;
  try
    ATextEdit.InitializeViewData(AViewData);
    AViewData.Focused := True;
    if AViewData.Properties.UseLeftAlignmentOnEditing then
      AViewData.HorzAlignment := taLeftJustify;
    AViewData.EditValueToDrawValue(ATextEdit.EditingValue, ViewInfo);
    AViewData.SelStart := ATextEdit.SelStart;
    AViewData.SelLength := ATextEdit.SelLength;
    AViewData.SelBackgroundColor := clHighlight;
    AViewData.SelTextColor := clHighlightText;
    AViewData.ContentOffset := ContentOffset;
    AViewData.CalculateEx(EditContainer.GetControlCanvas, ContentRect,
      cxNullPoint, cxmbNone, [], ViewInfo, False);
    TcxCustomTextEditViewInfo(ViewInfo).IsEditClass := False;
    TcxCustomTextEditViewData(AViewData).PrepareSelection(ViewInfo);
  finally
    AViewData.Free;
  end;
end;
...
begin
  ...
  else if NeedHighlightFindText then
...
begin
  Result := EditContainer.Editing and
    (RecordIndex = EditContainer.Controller.FocusedRecordIndex);
end;
...
procedure TcxEditCellViewInfo.SetBounds(const ABounds: TRect;
...
procedure TcxEditCellViewInfo.AfterDrawCellBackgroundHandler
  (Sender: TcxCustomEditViewInfo; ACanvas: TcxCanvas);
begin
  AfterDrawCellBackground(ACanvas);
end;

procedure TcxEditCellViewInfo.AfterDrawCellValueHandler
  (Sender: TcxCustomEditViewInfo; ACanvas: TcxCanvas);
begin
  AfterDrawCellValue(ACanvas);
end;

procedure TcxEditCellViewInfo.CanDrawEditValueHandler
...
constructor TcxExtEditingControlNavigatorViewInfo.Create(AOwnerControl
  : TcxExtEditingControl);
begin
...
procedure TcxExtEditingControlNavigatorViewInfo.UpdateNavigatorSiteBounds
  (const ABounds: TRect);
begin
...
begin
  inherited Create(AOwner);
  FNavigatorViewInfo := TcxExtEditingControlNavigatorViewInfo.Create
    (GetOwnerControl);
end;
...
function TcxCustomNavigatorSiteViewInfo.GetHitTest
  (AHitTest: TcxCustomHitTestController): Boolean;
begin
...
procedure TcxCustomNavigatorSiteViewInfo.MouseDown(AButton: TMouseButton;
X, Y: Integer);
begin
...
procedure TcxCustomNavigatorSiteViewInfo.MouseMove(Shift: TShiftState;
X, Y: Integer);
begin
...
procedure TcxCustomNavigatorSiteViewInfo.MouseUp(AButton: TMouseButton;
X, Y: Integer);
begin
...
procedure TcxControlItemViewInfo.MouseDown(Button: TMouseButton;
Shift: TShiftState; X, Y: Integer);
begin
  if not Enabled then
    Exit;
...
procedure TcxControlItemViewInfo.MouseUp(Button: TMouseButton;
Shift: TShiftState; X, Y: Integer);
var
  AIsClick: Boolean;
begin
...
begin
  if Enabled and not MouseCapture and ((State = cxbsHot) or not IsCheck and
    (State = cxbsPressed)) then
    State := cxbsNormal;
end;
...
begin
  Result := ((AValue <> cxbsHot) or CanTracked) and
    ((AValue <> cxbsPressed) or CanPressed);
end;
...
function TcxControlPanelViewInfo.GetHitTest
  (AHitTest: TcxCustomHitTestController): Boolean;
begin
...
function TcxControlPanelViewInfo.GetItemFromPoint(const APoint: TPoint)
  : TcxControlItemViewInfo;
begin
  Result := nil;
end;
...
procedure TcxControlPanelViewInfo.MouseDown(Button: TMouseButton;
Shift: TShiftState; X, Y: Integer);
var
...
procedure TcxControlPanelViewInfo.MouseUp(Button: TMouseButton;
Shift: TShiftState; X, Y: Integer);
var
  AItem: TcxControlItemViewInfo;
begin
...
constructor TcxControlFindPanelButtonViewInfo.Create(AFindPanelViewInfo
  : TcxControlFindPanelViewInfo);
begin
...
begin
  Result := Max(inherited GetHeight, FindPanel.ButtonMinHeight);
end;
...
begin
  Result := Max(inherited GetWidth, FindPanel.ButtonMinWidth);
end;
...
function TcxControlFindPanelPreviousButtonViewInfo.GetKind
  : TcxFindPanelItemKind;
begin
...
constructor TcxControlFindPanelCloseButtonViewInfo.Create(AFindPanelViewInfo
  : TcxControlFindPanelViewInfo);
begin
  FFindPanelViewInfo := AFindPanelViewInfo;
  inherited Create(FindPanelViewInfo.Owner);
...
function TcxControlFindPanelCloseButtonViewInfo.GetFindPanel
  : TcxControlFindPanel;
begin
  Result := FindPanelViewInfo.FindPanel;
end;
...
constructor TcxControlFindPanelEditViewInfo.Create(AFindPanelViewInfo
  : TcxControlFindPanelViewInfo);
begin
  FFindPanelViewInfo := AFindPanelViewInfo;
  inherited Create(FindPanelViewInfo.Owner);
...
procedure TcxControlFindPanelViewInfo.CheckClipping(const ADisplayRect: TRect;
const AAvailableRect: TRect);
begin
  inherited CheckClipping(ADisplayRect, AAvailableRect);
  if not Visible then
...
procedure TcxControlFindPanelViewInfo.DoRightToLeftConversion
  (const AClientBounds: TRect);
begin
  inherited DoRightToLeftConversion(AClientBounds);
  if IsCloseButtonVisible then
...
begin
  Painter.DrawFindPanel(ACanvas, BoundsRect, ViewParams.Bitmap <> nil,
    ViewParams.Color, ViewParams.Bitmap);
end;
...
function TcxControlFindPanelViewInfo.GetItemFromPoint(const APoint: TPoint)
  : TcxControlItemViewInfo;
begin
...
constructor TcxControlFilterBoxCustomizeButtonViewInfo.Create(AFilterBoxViewInfo
  : TcxControlFilterBoxViewInfo);
begin
...
function TcxControlFilterBoxCustomizeButtonViewInfo.GetFilterBox
  : TcxControlOptionsFilterBox;
begin
...
constructor TcxControlFilterBoxCloseButtonViewInfo.Create(AFilterBoxViewInfo
  : TcxControlFilterBoxViewInfo);
begin
  FFilterBoxViewInfo := AFilterBoxViewInfo;
  inherited Create(FilterBoxViewInfo.Owner);
...
function TcxControlFilterBoxCloseButtonViewInfo.GetFilterBox
  : TcxControlOptionsFilterBox;
begin
  Result := FilterBoxViewInfo.FilterBox;
end;
...
constructor TcxControlFilterBoxItemViewInfo.Create(AFilterBoxViewInfo
  : TcxControlFilterBoxViewInfo);
begin
  FFilterBoxViewInfo := AFilterBoxViewInfo;
  inherited Create(FilterBoxViewInfo.Owner);
...
function TcxControlFilterBoxItemViewInfo.GetFilterBox
  : TcxControlOptionsFilterBox;
begin
  Result := FilterBoxViewInfo.FilterBox;
end;
...
begin
  inherited Click;
  FilterBoxViewInfo.MainFilter.Active :=
    not FilterBoxViewInfo.MainFilter.Active;
end;

procedure TcxControlFilterBoxCheckBoxViewInfo.DoDraw(ACanvas: TcxCanvas);
begin
  Painter.DrawScaledFilterActivateButton(ACanvas, BoundsRect, State, Checked,
    ScaleFactor);
  inherited DoDraw(ACanvas);
end;
...
function TcxControlFilterBoxDropDownButtonViewInfo.
...
begin
  Painter.DrawScaledFilterDropDownButton(ACanvas, BoundsRect, State, False,
    ScaleFactor);
  inherited DoDraw(ACanvas);
end;
...
begin
  Result := BoundsRect;
  Result.Left := FilterBoxViewInfo.TextViewInfo.BoundsRect.Left -
...
function TcxControlFilterBoxDropDownButtonViewInfo.
  IsDropDownWindowExists: Boolean;
begin
  Result := Control.Controller.HasFilterBoxMRUItemsPopup;
end;

function TcxControlFilterBoxDropDownButtonViewInfo.
  IsDropDownWindowOwner: Boolean;
begin
  Result := IsDropDownWindowExists and (DropDownWindow.Owner = Self);
end;

procedure TcxControlFilterBoxDropDownButtonViewInfo.InitDropDownWindow
...
function TcxControlFilterBoxDropDownButtonViewInfo.GetDropDownWindow
  : TcxControlFilterBoxMRUItemsPopup;
begin
...
begin
  ...
  try
    AUnderline := (State in [cxbsHot, cxbsPressed]) and
      not(fsUnderline in ACanvas.Font.Style);
    if AUnderline then
...
begin
  Result := CXTO_LEFT or CXTO_CENTER_VERTICALLY or CXTO_SINGLELINE or
    CXTO_END_ELLIPSIS;
end;
...
begin
  ...
  if IsCloseButtonVisible then
    ABounds.Left := CloseButtonViewInfo.BoundsRect.Right + ItemsOffset
  else if IsCustomizeButtonVisible and
    (FilterBox.CustomizeButtonAlignment = fbaLeft) then
...
begin
  ABounds := cxRectCenterVertically(BoundsRect, CloseButtonViewInfo.Height);
  if IsCustomizeButtonVisible and (FilterBox.CustomizeButtonAlignment = fbaLeft)
  then
    ABounds.Left := CustomizeButtonViewInfo.BoundsRect.Right + ItemsOffset
  else
    ABounds.Left := BoundsRect.Left + FirstOffset;
...
begin
  ...
  if IsCustomizeButtonVisible and (FilterBox.CustomizeButtonAlignment = fbaLeft)
  then
    ABounds := cxRectSetLeft(ABounds, BoundsRect.Left + FirstOffset,
      CustomizeButtonViewInfo.Width)
  else
    ABounds := cxRectSetRight(ABounds, BoundsRect.Right - FirstOffset,
      CustomizeButtonViewInfo.Width);
...
procedure TcxControlFilterBoxViewInfo.CalculateDropDownButton
  (out ANeedAdjustTextBounds: Boolean);
var
  ABounds: TRect;
...
begin
  ...
  ALeft := TextViewInfo.BoundsRect.Right + ItemsOffset + cxControlTextOffset +
    cxControlFilterBoxTextOffset;
  ABounds := cxRectSetLeft(ABounds, ALeft, DropDownButtonViewInfo.Width);
  if IsCustomizeButtonVisible and (FilterBox.CustomizeButtonAlignment = fbaRight)
  then
  ...
  begin
    ABounds := cxRectSetRight(ABounds, ARightRestriction,
      DropDownButtonViewInfo.Width);
...
function TcxControlFilterBoxViewInfo.CreateTokenCriteriaViewInfo
...
procedure TcxControlFilterBoxViewInfo.DoRightToLeftConversion
  (const AClientBounds: TRect);
begin
  inherited DoRightToLeftConversion(AClientBounds);
  if IsCustomizeButtonVisible then
...
begin
  Painter.DrawFilterPanel(ACanvas, BoundsRect, ViewParams.Bitmap <> nil,
    ViewParams.Color, ViewParams.Bitmap);
end;
...
begin
  ...
  Inc(Result, 2 * FirstOffset);
  Result := Max(Result, TextViewInfo.Height + 2 * cxControlTextOffset + 2 *
    cxControlFilterBoxTextOffset);
end;

function TcxControlFilterBoxViewInfo.GetItemFromPoint(const APoint: TPoint)
  : TcxControlItemViewInfo;
begin
  Result := inherited GetItemFromPoint(APoint);
...
begin
  ...
  else if IsCloseButtonVisible then
...
procedure TcxControlFilterBoxViewInfo.MouseDown(Button: TMouseButton;
...
procedure TcxControlFilterBoxViewInfo.MouseMove(Shift: TShiftState; X: Integer;
Y: Integer);
begin
  if IsTokenCriteriaVisible and TokenCriteriaViewInfo.HasMouse(Point(X, Y)) then
...
procedure TcxControlFilterBoxViewInfo.MouseUp(Button: TMouseButton;
Shift: TShiftState; X: Integer; Y: Integer);
begin
  if IsTokenCriteriaVisible and TokenCriteriaViewInfo.HasMouse(Point(X, Y)) then
...
function TcxControlFilterBoxViewInfo.GetTokenCriteria
...
function TcxControlFilterBoxViewInfo.GetTokenCriteriaOptions
  : IdxFilterBoxTokenCriteriaOptions;
begin
  Result := FilterBox.TokenCriteria;
end;

procedure TcxControlFilterBoxViewInfo.GetTokenCriteriaParams
  (var AParams: TcxViewParams);
begin
...
procedure TcxCustomControlPainter.BeforeCustomDraw
  (AViewInfo: TcxCustomViewInfoItem);
begin
  with AViewInfo do
  begin
...
function TcxCustomControlPainter.DoCustomDraw(AViewInfoItem
  : TcxCustomViewInfoItem; AEvent: TcxCustomDrawViewInfoItemEvent): Boolean;
begin
  if (AViewInfoItem <> nil) and AViewInfoItem.Visible and
    Canvas.RectVisible(AViewInfoItem.VisibleRect) then
  begin
    Result := False;
    if Assigned(AEvent) then
    begin
...
procedure TcxCustomControlPainter.DoPaintEditCell(ACellViewInfo
  : TcxEditCellViewInfo; AIsExcludeRect: Boolean = True);
begin
...
begin
  GetViewParams(AStyleIndexes[Control.Controller.Focused or Control.IsFocused],
    nil, nil, Result);
end;
...
procedure TcxCustomControlStyles.GetDefaultViewParams(Index: Integer;
...
constructor TcxEditingControlScrollbarAnnotations.Create
  (AOwner: TcxExtEditingControl);
begin
  inherited Create;
  FOwner := AOwner;
...
procedure TcxEditingControlScrollbarAnnotations.GetHint(AAnnotationRowIndexLists
  : TdxScrollbarAnnotationRowIndexLists; var AHint: string);
begin
  FOwner.GetScrollbarAnnotationHint(AAnnotationRowIndexLists, AHint);
end;

function TcxEditingControlScrollbarAnnotations.GetRecordPixelScrollPosition
  (ARecordIndex: Integer): Integer;
begin
  Result := FOwner.GetRecordPixelScrollPosition(ARecordIndex);
end;

function TcxEditingControlScrollbarAnnotations.GetScrollableRecordCount
  : Integer;
begin
  Result := FOwner.GetScrollableRecordCount;
end;

function TcxEditingControlScrollbarAnnotations.
  IsRecordIndexBasedRendering: Boolean;
begin
...
function TcxEditingControlScrollbarAnnotations.GetOptions
  : TdxScrollbarAnnotationOptions;
begin
  Result := FOwner.ScrollbarAnnotations.Helper;
end;

procedure TcxEditingControlScrollbarAnnotations.Populate
...
procedure TcxEditingControlScrollbarAnnotations.SetCurrentRecordIndex
  (AIndex: Integer);
begin
...
begin
  if (FDesignSelectionHelper = nil) and (cxDesignSelectionHelperClass <> nil)
    and IsDesigning then
    FDesignSelectionHelper := cxDesignSelectionHelperClass.Create(Self);
end;

function TcxEditingControl.CreateFilterBoxTokenCriteria
  : TdxFilterBoxTokenCriteria;
begin
...
begin
  ...
  else if AInfo is TcxFindCriteriaChangedInfo then
  begin
...
function TcxEditingControl.DoFilterDialogShow
  (AItem: TcxCustomInplaceEditContainer): Boolean;
begin
  Result := False;
...
procedure TcxEditingControl.DoInitEdit(AItem: TcxCustomInplaceEditContainer;
AEdit: TcxCustomEdit);
begin
...
procedure TcxEditingControl.DoInitEditValue
...
procedure TcxEditingControl.DoInitFilteringDateRanges
  (AItem: TcxCustomInplaceEditContainer);
begin
  if HasInitFilteringDateRangesHandler then
...
function TcxEditingControl.GetRecordPixelScrollPosition
  (ARecordIndex: Integer): Integer;
begin
  Result := 0;
end;
...
procedure TcxEditingControl.GetScrollbarAnnotationHint(AAnnotationRowIndexLists
  : TdxScrollbarAnnotationRowIndexLists; var AHint: string);
begin
...
function TcxEditingControl.
  IsRecordIndexBasedScrollbarAnnotationRendering: Boolean;
begin
  Result := True;
end;

function TcxEditingControl.NeedCallChangedOnItemRemoved
  (AItem: TcxCustomInplaceEditContainer): Boolean;
begin
  Result := True;
end;
...
begin
  Result := DataController.FindCriteria.IsActive and
    Options.OptionsFindPanel.HighlightSearchResults;
end;

procedure TcxEditingControl.PopulateScrollbarAnnotations
  (AKind: TdxScrollbarAnnotationKind;
AList: TdxScrollbarAnnotationRowIndexList);
var
  I: Integer;
...
procedure TcxEditingControl.RunFilterCustomizeDialog
  (AItem: TcxCustomInplaceEditContainer = nil);
begin
  ...
  begin
    if not DoFilterCustomization then
      ExecuteFilterControlDialog(Self, LookAndFeel, ApplyFilterHandler,
        OnFilterControlDialogShow)
  end
  else if ShowFilterDialog(DataController.Filter, AItem, AItem.PropertiesValue,
    AItem.FilterCaption, AItem.GetEditDataValueTypeClass, LookAndFeel, Font)
  then
    ApplyFilter;
end;

procedure TcxEditingControl.SetCurrentScrollbarAnnotationRecordIndex
  (AIndex: Integer);
begin
end;
...
function TcxEditingControl.GetFilterValueListClass
...
function TcxEditingControl.GetHotTrackControllerClass
  : TcxHotTrackControllerClass;
begin
...
begin
  Result := (FLockUpdate <> 0) or IsLoading or IsDestroying or
    not HandleAllocated;
end;
...
procedure TcxEditingControl.MouseDown(Button: TMouseButton; Shift: TShiftState;
X, Y: Integer);
begin
  with Controller do
  begin
...
procedure TcxEditingControl.MouseUp(Button: TMouseButton; Shift: TShiftState;
X, Y: Integer);
begin
  Controller.HitTestController.RecalculateOnMouseEvent(X, Y, Shift);
  if DragAndDropState = ddsNone then
...
function TcxEditingControl.GetDesignHitTest(X, Y: Integer;
...
function TcxEditingControl.GetMouseWheelScrollingKind
  : TcxMouseWheelScrollingKind;
begin
  if IsScrollBarActive(sbVertical) then
    Result := mwskVertical
  else if IsScrollBarActive(sbHorizontal) then
...
procedure TcxEditingControl.DrawDragDropImage(ADragBitmap: TBitmap;
ACanvas: TcxCanvas);
begin
end;
...
function TcxEditingControl.GetMainScrollBarsClass
...
procedure TcxEditingControl.DragAndDrop(const P: TPoint; var Accepted: Boolean);
begin
  inherited DragAndDrop(P, Accepted);
...
function TcxEditingControl.GetFilterContainer(AIndex: Integer)
  : TcxCustomInplaceEditContainer;
var
...
function TcxEditingControl.GetFilterProperties(Index: Integer)
  : TcxCustomEditProperties;
begin
  Result := GetFilterContainer(Index).GetFilterProperties;
end;

function TcxEditingControl.GetFilterValueType(Index: Integer)
  : TcxValueTypeClass;
begin
...
procedure TcxEditingControl.RegisterFilterControl
...
procedure TcxEditingControl.UnregisterFilterControl
  (AControl: TcxCustomFilterControl);
begin
...
function TcxEditingControl.GetContainer(AIndex: Integer)
  : TcxCustomInplaceEditContainer;
begin
...
function TcxEditingControl.GetScrollbarAnnotationHelper
...
begin
  if IsDesigning and (DragAndDropState = ddsNone) and
    Controller.HitTestController.AllowDesignMouseEvents
    (ScreenToClient(GetMouseCursorPos), [ssLeft]) then
...
procedure TcxExtEditingControl.ChangeScaleEx(M, D: Integer;
isDpiChange: Boolean);
begin
...
function TcxExtEditingControl.IsScrollbarAnnotationVisible
  (AKind: Integer): Boolean;
begin
  case AKind of
    dxFirstScrollbarAnnotationID .. dxFirstPredefinedScrollbarAnnotationID - 1:
...
procedure TcxExtEditingControl.Notification(AComponent: TComponent;
...
begin
  AIsNavigatorSiteVisible := Canvas.RectVisible
    (ViewInfo.NavigatorSiteVisibleRect);
...
// IcxNavigatorOwner
procedure TcxExtEditingControl.NavigatorChanged(AChangeType
  : TcxNavigatorChangeType);
begin
  LayoutChanged; // to do
end;
...
// IcxNavigatorOwner2
function TcxExtEditingControl.GetNavigatorInfoPanel
...
function TcxExtEditingControl.CreateScrollbarAnnotationHelper
  : TcxEditingControlScrollbarAnnotations;
begin
  Result := TcxEditingControlScrollbarAnnotations.Create(Self);
end;

function TcxExtEditingControl.CreateScrollbarAnnotations
  : TcxControlScrollbarAnnotationOptions;
begin
...
function TcxExtEditingControl.GetDateTimeHandlingClass
  : TcxControlOptionsDateTimeHandlingClass;
begin
  Result := TcxControlOptionsDateTimeHandling;
end;

function TcxExtEditingControl.GetOptionsFilterBoxClass
  : TcxControlOptionsFilterBoxClass;
begin
  Result := TcxControlOptionsFilterBox;
end;

function TcxExtEditingControl.GetOptionsFilteringClass
  : TcxControlOptionsFilteringClass;
begin
  Result := TcxControlOptionsFiltering;
end;

function TcxExtEditingControl.GetFindPanelOptionsClass
  : TcxControlOptionsFindPanelClass;
begin
...
function TcxExtEditingControl.GetOptionsBehaviorClass
...
function TcxExtEditingControl.GetOptionsDateTimeHandling
  : TcxControlOptionsDateTimeHandling;
begin
...
procedure TcxExtEditingControl.SetDateTimeHandling
  (AValue: TcxControlOptionsDateTimeHandling);
begin
...
procedure TcxExtEditingControl.SetOptionsData(Value: TcxControlOptionsData);
begin
  FOptionsData.Assign(Value);
end;

procedure TcxExtEditingControl.SetOptionsView(Value: TcxControlOptionsView);
begin
  FOptionsView.Assign(Value);
end;

procedure TcxExtEditingControl.SetScrollbarAnnotations
  (Value: TcxControlScrollbarAnnotationOptions);
begin
...
begin
  Result := (AItem <> nil) and AItem.Visible and
    cxRectPtIn(AItem.ClipRect, APoint);
end;
