...
type
  ...
  protected
    ...
    class function OnAutoHyphenation(AImporter
      : TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
      : TdxDestination; static;
    class function OnDefaultTabStop(AImporter
      : TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
      : TdxDestination; static;
    class function OnDifferentOddAndEvenPages
      (AImporter: TdxRichEditDestinationAndXmlBasedImporter;
      AReader: TdxXmlReader): TdxDestination; static;
    class function OnDocumentProtection(AImporter
      : TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
      : TdxDestination; static;
    class function OnDocumentVariables(AImporter
      : TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
      : TdxDestination; static;
    ...
    class function OnEndNoteProperties(AImporter
      : TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
      : TdxDestination; static;
    class function OnDisplayBackgroundShape
      (AImporter: TdxRichEditDestinationAndXmlBasedImporter;
      AReader: TdxXmlReader): TdxDestination; static;
  end;
  ...
  TdxDocumentSettingsAutoHyphenationDestination = class
  ...
  TdxDocumentSettingsDefaultTabStopDestination = class
    (TdxLeafElementDestination)
  public
    procedure ProcessElementOpen(AReader: TdxXmlReader); override;
  end;
  ...
  TdxDocumentSettingsDifferentOddAndEvenPagesDestination = class
    (TdxLeafElementDestination)
  public
    procedure ProcessElementOpen(AReader: TdxXmlReader); override;
  end;
  ...
  protected
    function GetElementHandlerTable: TdxElementHandlerTable; override;
    class function OnDocumentVariable(AImporter
      : TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
      : TdxDestination; static;
  end;
...
class function TdxDocumentSettingsDestination.CreateElementHandlerTable
...
function TdxDocumentSettingsDestination.GetElementHandlerTable
  : TdxElementHandlerTable;
begin
...
class function TdxDocumentSettingsDestination.OnDifferentOddAndEvenPages
  ...
  : TdxDestination;
begin
  Result := TdxDocumentSettingsDifferentOddAndEvenPagesDestination.Create
    (AImporter);
end;
...
class function TdxDocumentSettingsDestination.OnFootNoteProperties
  ...
  : TdxDestination;
begin
  Result := TdxDocumentLevelFootNotePropertiesDestination.Create(AImporter,
    AImporter.DocumentModel.Sections.First.FootNote);
end;
...
class function TdxDocumentSettingsDestination.OnEndNoteProperties
  ...
  : TdxDestination;
begin
  Result := TdxDocumentLevelEndNotePropertiesDestination.Create(AImporter,
    AImporter.DocumentModel.Sections.First.EndNote);
end;
...
procedure TdxDocumentSettingsAutoHyphenationDestination.ProcessElementOpen
  (AReader: TdxXmlReader);
begin
  Importer.DocumentModel.DocumentProperties.HyphenateDocument :=
    Importer.GetWpSTOnOffValue(AReader, 'val', False);
end;

{ TdxDocumentSettingsDefaultTabStopDestination }

procedure TdxDocumentSettingsDefaultTabStopDestination.ProcessElementOpen
  (AReader: TdxXmlReader);
var
  AValue: Integer;
begin
  ...
  if AValue > 0 then
    Importer.DocumentModel.DocumentProperties.DefaultTabWidth :=
      Max(1, UnitConverter.TwipsToModelUnits(AValue));
end;

{ TdxDocumentSettingsDifferentOddAndEvenPagesDestination }

procedure TdxDocumentSettingsDifferentOddAndEvenPagesDestination.
  ProcessElementOpen(AReader: TdxXmlReader);
begin
  Importer.DocumentModel.DocumentProperties.DifferentOddAndEvenPages :=
    Importer.GetWpSTOnOffValue(AReader, 'val');
end;

{ TdxDocumentProtectionDestination }

procedure TdxDocumentProtectionDestination.ProcessElementOpen
  (AReader: TdxXmlReader);
var
...
begin
  ...
  try
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          AHash := Integer(((AValue shl 24) and $FF000000) or
            ((AValue shl 8) and $00FF0000) or ((AValue shr 8) and $0000FF00) or
    ...
    AProperties.EnforceProtection := Importer.GetWpSTOnOffValue(AReader,
      'enforcement', False);
    AProperties.HashAlgorithmType :=
      TdxHashAlgorithmType(Importer.GetWpSTIntegerValue(AReader,
      'cryptAlgorithmSid', 0));
    AProperties.HashIterationCount := Importer.GetWpSTIntegerValue(AReader,
      'cryptSpinCount', 1);
  finally
    AProperties.EndInit;
  end;
...
class function TdxDocumentVariablesDestination.CreateElementHandlerTable
  : TdxElementHandlerTable;
begin
  Result := TdxElementHandlerTable.Create;
...
function TdxDocumentVariablesDestination.GetElementHandlerTable
  : TdxElementHandlerTable;
begin
  Result := FHandlerTable;
end;
...
procedure TdxDocumentVariableDestination.ProcessElementOpen
  (AReader: TdxXmlReader);
var
  AName, AVal: string;
begin
...
procedure TdxDisplayBackgroundShapeDestination.ProcessElementOpen
  (AReader: TdxXmlReader);
begin
  Importer.DocumentModel.DocumentProperties.DisplayBackgroundShape :=
    Importer.GetWpSTOnOffValue(AReader, 'val', True);
end;
