...
type
  ...
  CubeDef = interface(CubeDef25)
    ...
    function GetSchemaObject(eObjType: SchemaObjectTypeEnum;
      const bsUniqueName: WideString): IDispatch; safecall;
  end;
  ...
  ICellset = interface(IDispatch)
    ...
    procedure Open(DataSource: OleVariant;
      ActiveConnection: OleVariant); safecall;
...
{$ENDIF}
  ...
  public
    ...
    procedure Open(DataSource: OleVariant;
      ActiveConnection: OleVariant); overload;
    procedure Close;
...
const
  CServerData: TServerData = (ClassID: '{228136B0-8BD3-11D0-B4EF-00A0C9138CA4}';
    IntfIID: '{228136B1-8BD3-11D0-B4EF-00A0C9138CA4}'; EventIID: '';
...
const
  CServerData: TServerData = (ClassID: '{228136B8-8BD3-11D0-B4EF-00A0C9138CA4}';
    IntfIID: '{2281372A-8BD3-11D0-B4EF-00A0C9138CA4}'; EventIID: '';
    LicenseKey: nil; Version: 500);
begin
  ServerData := @CServerData;
end;
