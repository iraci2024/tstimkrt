...
type
  ...
  TdxLayoutDependentTextRunInsertedHistoryItem = class
  ...
  protected
    function CreateTextRun(AParagraph: TdxParagraphBase)
      : TdxTextRunBase; override;
    function CreateTextRunCore(AParagraph: TdxParagraphBase)
  ...
  TdxFloatingObjectAnchorRunInsertedHistoryItem = class
    (TdxTextRunInsertedBaseHistoryItem)
  private
    FNewRun: TdxFloatingObjectAnchorRun;
    FNotificationId: Integer;
    FOwnsNewRun: Boolean;
    procedure AfterInsertRun(ADocumentModel: TdxDocumentModel;
  ...
  TdxFootNoteRunInsertedHistoryItemBase = class abstract
    (TdxLayoutDependentTextRunInsertedHistoryItem)
  strict private
    FNoteIndex: Integer;
  protected
    procedure UndoCore; override;
    function CreateTextRun(AParagraph: TdxParagraphBase): TdxTextRunBase;
      override;
  ...
  TdxFootNoteRunInsertedHistoryItem = class
    (TdxFootNoteRunInsertedHistoryItemBase)
  protected
    function CreateTextRunCore(AParagraph: TdxParagraphBase): TdxTextRunBase;
      override;
  ...
  TdxEndNoteRunInsertedHistoryItem = class
    (TdxFootNoteRunInsertedHistoryItemBase)
  protected
    function CreateTextRunCore(AParagraph: TdxParagraphBase): TdxTextRunBase;
      override;
  ...
  public
    ...
    property OriginalParagraphCount: Integer read FOriginalParagraphCount
      write FOriginalParagraphCount;
  end;

  { TdxFixLastParagraphOfLastSectionHistoryItem }

  TdxFixLastParagraphOfLastSectionHistoryItem = class
...
begin
  ...
  TdxDocumentModelStructureChangedNotifier.NotifyRunRemoved(DocumentModel,
    PieceTable, AParagraphIndex, ARunIndex, 1, FNotificationId);
end;
...
constructor TdxFixLastParagraphOfLastSectionHistoryItem.Create
...
function TdxFixLastParagraphOfLastSectionHistoryItem.GetDocumentModel
  : TdxDocumentModel;
begin
...
begin
  ...
  begin
    ...
    DocumentModel.UnsafeEditor.ReplaceSectionRunWithParagraphRun(PieceTable,
      FLastRun, ARuns.Count - 1);
  end;
end;
...
begin
  ...
  if FLastRun <> nil then
    DocumentModel.UnsafeEditor.ReplaceParagraphRunWithSectionRun(PieceTable,
      FLastRun, PieceTable.Runs.Count - 1);
end;
...
function TdxFootNoteRunInsertedHistoryItemBase.CreateTextRun
...
function TdxFootNoteRunInsertedHistoryItem.CreateTextRunCore
  (AParagraph: TdxParagraphBase): TdxTextRunBase;
begin
  Result := TdxFootNoteRun.Create(AParagraph, StartIndex, NewLength);
end;

function TdxFootNoteRunInsertedHistoryItem.GetNote(ANoteIndex: Integer)
  : TdxFootNoteBase;
begin
...
function TdxEndNoteRunInsertedHistoryItem.CreateTextRunCore
  (AParagraph: TdxParagraphBase): TdxTextRunBase;
begin
  Result := TdxEndNoteRun.Create(AParagraph, StartIndex, NewLength);
end;

function TdxEndNoteRunInsertedHistoryItem.GetNote(ANoteIndex: Integer)
  : TdxFootNoteBase;
begin
  if ANoteIndex < 0 then
    Exit(nil);
...
function TdxLayoutDependentTextRunInsertedHistoryItem.CreateTextRun
  (AParagraph: TdxParagraphBase): TdxTextRunBase;
begin
  Result := CreateTextRunCore(AParagraph);
  TdxLayoutDependentTextRun(Result).FieldResultFormatting :=
    FFieldResultFormatting.Clone;
end;

function TdxLayoutDependentTextRunInsertedHistoryItem.CreateTextRunCore
  (AParagraph: TdxParagraphBase): TdxTextRunBase;
begin
  Result := TdxLayoutDependentTextRun.Create(AParagraph, StartIndex, NewLength);
end;

function TdxLayoutDependentTextRunInsertedHistoryItem.GetDocumentModel
  : TdxDocumentModel;
begin
  Result := TdxDocumentModel(inherited DocumentModel);
end;

procedure TdxLayoutDependentTextRunInsertedHistoryItem.SetFieldResultFormatting
...
function TdxFieldSymbolResultInsertedHistoryItem.CreateTextRun
  (AParagraph: TdxParagraphBase): TdxTextRunBase;
begin
...
procedure TdxFloatingObjectAnchorRunInsertedHistoryItem.AfterInsertRun
  (ADocumentModel: TdxDocumentModel; ARun: TdxTextRunBase;
  ARunIndex: TdxRunIndex);
var
...
function TdxFloatingObjectAnchorRunInsertedHistoryItem.GetDocumentModel
  : TdxDocumentModel;
begin
  Result := TdxDocumentModel(inherited DocumentModel);
end;

function TdxFloatingObjectAnchorRunInsertedHistoryItem.GetPieceTable
  : TdxPieceTable;
begin
...
begin
  FNewRun := TdxFloatingObjectAnchorRun.Create
    (PieceTable.Runs[RunIndex].Paragraph);
