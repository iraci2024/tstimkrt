...
type
  ...
  TdxSortedDictionaryOfCollections<TKey; T;
  TCollection: TList<T>, constructor> = class
  strict private
  ...
  TdxSortedDictionaryOfList<TKey, T> = class(TdxSortedDictionaryOfCollections <
    TKey, T, TList < T >> )
  public
  ...
  public
    class function ToDictionary<T, TKey, TValue>(AEnumerable: TEnumerable<T>;
      const AGetKey: TFunc<T, TKey>; const AGetValue: TFunc<T, TValue>;
      AOwnerships: TDictionaryOwnerships = []): TDictionary<TKey, TValue>;
      overload; static;
    class function ToDictionary<T, TKey, TValue>(const AEnumerable: TArray<T>;
      const AGetKey: TFunc<T, TKey>; const AGetValue: TFunc<T, TValue>;
      AOwnerships: TDictionaryOwnerships = []): TDictionary<TKey, TValue>;
      overload; static;
    class procedure ForEach<T>(AEnumerable: TEnumerable<T>;
      const AAction: TProc<T>); overload; static;
    class procedure ForEach<T>(const AEnumerable: TArray<T>;
      const AAction: TProc<T>); overload; static;
    class function Select<TFrom, TTo>(AEnumerable: TEnumerable<TFrom>;
      const AConvert: TFunc<TFrom, TTo>): TList<TTo>; overload; static;
    class function Select<TFrom, TTo>(const AEnumerable: TArray<TFrom>;
      const AConvert: TFunc<TFrom, TTo>): TArray<TTo>; overload; static;
    class function Where<T>(AEnumerable: TEnumerable<T>;
      const ACondition: TFunc<T, Boolean>): TList<T>; overload; static;
    class function Where<T>(const AEnumerable: TArray<T>;
      const ACondition: TFunc<T, Boolean>): TArray<T>; overload; static;
    class function ToArray<T>(AEnumerable: TEnumerable<T>): TArray<T>;
      overload; static;
    class function ToArray<T>(const AEnumerable: array of T): TArray<T>;
      overload; static;
    class function ToGroupsDictionary<T, TKey, TValue>(AItems: TList<T>;
      const AKeySelector: TFunc<T, TKey>; const AGetValue: TFunc < TList<T>,
      TList < TValue >> ): TDictionary<TKey, TList<TValue>>; overload; static;
  end;
...
constructor TdxSortedDictionaryOfCollections<TKey, T, TCollection>.Create
  (AGetKey: TFunc<T, TKey>);
begin
...
function TdxSortedDictionaryOfCollections<TKey, T, TCollection>.GetAllKeys
  : TArray<TKey>;
{$IFNDEF DELPHIXE}
var
  AKey: TKey;
...
procedure TdxSortedDictionaryOfCollections<TKey, T, TCollection>.Remove
  (AItem: T);
var
  AKey: TKey;
  ACollection: TCollection;
...
procedure TdxSortedDictionaryOfCollections<TKey, T, TCollection>.RemoveCore
  (AItem: T; AKey: TKey; ACollection: TCollection);
begin
  ACollection.Remove(AItem);
  ClearIfEmptyCollection(AKey);
end;

procedure TdxSortedDictionaryOfCollections<TKey, T, TCollection>.
  ClearIfEmptyCollection(AKey: TKey);
begin
...
function TdxSortedDictionaryOfCollections<TKey, T, TCollection>.GetCollection
  (AKey: TKey): TCollection;
begin
  Result := FDictionary[AKey];
end;

function TdxSortedDictionaryOfCollections<TKey, T, TCollection>.
  GetFirstKey: TKey;
var
  AKeys: TArray<TKey>;
  AMinKey: TKey;
...
constructor TdxSortedDictionaryOfList<TKey, T>.Create(const AGetKey
  : TFunc<T, TKey>);
begin
  inherited Create(AGetKey);
end;

procedure TdxSortedDictionaryOfList<TKey, T>.RemoveWhere(const APredicate
  : TFunc<T, Boolean>);
var
  AKey: TKey;
  ACollection: TList<T>;
...
class procedure TEnumerableHelper.ForEach<T>(AEnumerable: TEnumerable<T>;
  const AAction: TProc<T>);
var
  AItem: T;
begin
...
class procedure TEnumerableHelper.ForEach<T>(const AEnumerable: TArray<T>;
  const AAction: TProc<T>);
var
  AItem: T;
begin
...
class function TEnumerableHelper.Select<TFrom, TTo>
  (AEnumerable: TEnumerable<TFrom>; const AConvert: TFunc<TFrom, TTo>)
  : TList<TTo>;
var
  AItem: TFrom;
begin
...
class function TEnumerableHelper.Select<TFrom, TTo>(const AEnumerable
  : TArray<TFrom>; const AConvert: TFunc<TFrom, TTo>): TArray<TTo>;
var
  I: Integer;
begin
...
class function TEnumerableHelper.ToDictionary<T; TKey; TValue>
  (AEnumerable: TEnumerable<T>; const AGetKey: TFunc<T, TKey>;
  const AGetValue: TFunc<T, TValue>; AOwnerships: TDictionaryOwnerships = [])
...
class function TEnumerableHelper.ToArray<T>(const AEnumerable: array of T)
  : TArray<T>;
var
  I, ALength: Integer;
begin
...
class function TEnumerableHelper.ToDictionary<T, TKey, TValue>(const AEnumerable
  : TArray<T>; const AGetKey: TFunc<T, TKey>; const AGetValue: TFunc<T, TValue>;
  AOwnerships: TDictionaryOwnerships = []): TDictionary<TKey, TValue>;
var
  AItem: T;
begin
...
class function TEnumerableHelper.ToArray<T>(AEnumerable: TEnumerable<T>)
  : TArray<T>;
var
...
class function TEnumerableHelper.ToGroupsDictionary<T, TKey, TValue>
  (AItems: TList<T>; const AKeySelector: TFunc<T, TKey>;
  const AGetValue: TFunc < TList<T>, TList < TValue >> )
  : TDictionary<TKey, TList<TValue>>;
var
  AItem: T;
  AKey: TKey;
...
class function TEnumerableHelper.Where<T>(AEnumerable: TEnumerable<T>;
  const ACondition: TFunc<T, Boolean>): TList<T>;
var
  AItem: T;
begin
...
class function TEnumerableHelper.Where<T>(const AEnumerable: TArray<T>;
  const ACondition: TFunc<T, Boolean>): TArray<T>;
var
  AItem: T;
  I, AIndex: Integer;
begin
