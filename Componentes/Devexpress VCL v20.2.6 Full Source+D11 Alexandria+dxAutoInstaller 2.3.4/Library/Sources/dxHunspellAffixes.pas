...
uses
  StrUtils, Math, SysUtils, Classes, cxClasses, dxHunspellUtils,
  dxHunspellWords,
...
type
  ...
  TdxAffixOption = (aoPrefixSuffixUnion, aoAffixFlagAliasTable,
    aoAffixMorphologyTable, aoCompoundMiddle, aoCompoundEnd, aoInCompoundOnly,
    aoNeedAffix, aoCompoundForbid, aoCompoundPermit, aoCircumfix);
  ...
  protected
    FData: Pointer;
    function AddDataPiece(const APiece: PWideChar;
      ADataIndex, APieceIndex: Integer): Boolean; virtual;
    ...
    function ParseHeader(ALine: PWideChar; out ATableSize: Integer)
      : Boolean; virtual;
  ...
  public
    ...
    function ReadData(ALine: PWideChar;
  ...
  public
    ...
    property WordStemManager: TdxHunspellWordStemManager
      read GetWordStemManager;
  end;
  ...
  private
    ...
    procedure AddLineRemainderToMorphologicDescription(ALine: PWideChar;
      ADataIndex: Integer);
    function CheckFlag(ALine: PWideChar): Boolean;
    function ConditionLength(ALine: PWideChar): Integer;
    function EncodeAffixCondition(ALine: PWideChar;
    ...
    function ParseAppendStringWithAffixes(const ALine: PWideChar;
      ADataIndex: Integer): Boolean;
    function ParseCompatibleFlags(const ALine: PWideChar;
      ADataIndex: Integer): Boolean;
    function ParseCondition(ALine: PWideChar; ADataIndex: Integer): Boolean;
    function ParseFlag(ALine: PWideChar): Boolean;
    function ParseMorphologicDescription(ALine: PWideChar;
      ADataIndex: Integer): Boolean;
  ...
  protected
    function AddDataPiece(const APiece: PWideChar;
      ADataIndex, APieceIndex: Integer): Boolean; override;
    ...
    function ConditionContainsDuplicateInformation(AStripString: PWideChar;
      AStripStringLen: Integer; const ACondition: PWideChar;
      out Contains: Boolean): Boolean; virtual; abstract;
  ...
  protected
    function ConditionContainsDuplicateInformation(AStripString: PWideChar;
      AStripStringLen: Integer; const ACondition: PWideChar;
      out AContains: Boolean): Boolean; override;
  ...
  protected
    function ConditionContainsDuplicateInformation(AStripString: PWideChar;
      AStripStringLength: Integer; const ACondition: PWideChar;
      out Contains: Boolean): Boolean; override;
    function IsPrefix: Boolean; override;
  public
    procedure BuildAffixes; override;
  end;
  ...
  public
    ...
    property Items[Index: Integer]: TdxCompoundForbidPattern
  ...
  public
    destructor Destroy; override;
    function Phonetic(const AWord: PWideChar; ADest: PWideChar;
  ...
  protected
    function CanUseInCompoundWordPart(ACompoundWordPart: TdxCompoundWordPart)
      : Boolean; virtual; abstract;
    function GetAppendString: PWideChar; virtual;
    function IsCompatibleWithFlag(AFlag: Word;
      CompatibleIfNull: Boolean = False): Boolean;
    function IsPrefixSuffixUnion(const AOptions: TdxAffixOptions): Boolean;
    function IsWithoutAffixWordLengthCorrect(ALengthWithoutAffix
      : Integer): Boolean;
  ...
  public
    ...
    destructor Destroy; override;
    function CanUseInSimpleWordsOrIsFogemorpheme(ACompoundWordPart
      : TdxCompoundWordPart): Boolean;
    function CanUseInTheMiddleOfCompoundWords(ACompoundWordPart
      : TdxCompoundWordPart): Boolean;
    ...
    property AppendStringLength: Byte read FAppendStringLength
      write FAppendStringLength;
    property CompatibleFlags: TdxHunspellFlags read FCompatibleFlags
      write FCompatibleFlags;
  ...
  public
    ...
    function GetWordWithAffix(const AWord: PWideChar; AWordLength: Integer)
      : PWideChar;
    function MakeInitialWordFormAndProcessTwoSuffixCheck(const AWord: PWideChar;
  ...
  public
    ...
    function MakeInitialWordFormAndProcessSuffixCheck(const AWord: PWideChar;
      ...
      var ATakenSuffix: TdxSuffix; const ACompoundFlag: Word = dxNullFlag)
      : TdxHunspellWordStem;
    function GetWordWithAffix(const AWord: PWideChar; AWordLength: Integer)
      : PWideChar;
    function IsWordSuitableForCondition(AWordEnd,
      AWordBegin: PWideChar): Boolean;
  end;
  ...
  TdxBackTrackingTable = array [0 .. dxMaxWordLength - 1]
    of TdxBackTrackingItem;
  ...
  private
    ...
    function ParseAffix(ALine: PWideChar; AAffixFileReader: TdxHunspellReader;
      AAffixType: TdxAffixType): Boolean;
    function ParseCompoundSyllable(ALine: PWideChar;
      AAffixFileReader: TdxHunspellReader): Boolean;
    function ParseRep(ALine: PWideChar;
      AAffixFileReader: TdxHunspellReader): Boolean;

    function AreAffixesBothCircumfixesOrNot(APrefix, ASuffix: TdxAffix)
      : Boolean;
    function CanBeFirstPartInCompoundWord(AWordStem: TdxHunspellWordStem;
      AWordPartIndex: Cardinal): Boolean;
    procedure CheckHungarianSyllableCount(AWord: PWideChar;
      AWordStem: TdxHunspellWordStem; var ASyllableCount: SmallInt);
    procedure CheckWordsCompatibilityWithCompoundRule
      (const AWords: PdxWordStemTable;
      var ABackTrackingTable: TdxBackTrackingTable; AWordCount: SmallInt;
      ACompoundRuleTableIndex: Integer; var AFlagIndex, AWordIndex,
      ABackTrackingIndex: SmallInt; var AIsWordStemCompatibleWithCompoundRule,
      AIsAllWordsCompatibleWithCompoundRule: Boolean);
    function CompoundPartAffixCheck(const AInitialWordForm: TWordFormArray;
      const AInitialWordJoint: Integer; var AWordStem: TdxHunspellWordStem;
      const AWordPartIndex: SmallInt;
      const ACompoundWordPart: TdxCompoundWordPart; var ATakenPrefix: TdxPrefix;
      var ATakenSuffix: TdxSuffix): Boolean;
    procedure CorrectBackTrackingIndex(var ABackTrackingTable
      : TdxBackTrackingTable; var AFlagIndex, AWordIndex, ABackTrackingIndex
      : SmallInt);
    procedure CompoundRootCheck(AWordStem: TdxHunspellWordStem;
      var AWordPartIndex: SmallInt);
    function EndOfCompoundRulePattern(ACompoundRuleTableIndex: Integer;
      AFlagIndex: Integer): Boolean;
    function FindSuitableCheckCompoundPatternTableIndex(var ATableIndex
      : Integer; AWordSecondPart: PWideChar): Boolean;
    function GetIsAllWordsCompatibleWithCompoundRule(const AWords
      : PdxWordStemTable; var AWordIndex: SmallInt; AWordIndexMax: Integer;
      AFlag: Word): Boolean;
    function IsWordStemCompatibleWithCompoundRule
      (AWordStem: TdxHunspellWordStem): Boolean;
    procedure GetWordStemSuitableForAffixAndCompoundRules
      (var AWordStem: TdxHunspellWordStem; AWordPartIndex: SmallInt;
      ATableIndex: Integer; var AWords: PdxWordStemTable; AWordIndex: SmallInt;
      ACompoundRuleWords: PdxWordStemTable; AIsFirstWordPart: Boolean);
    procedure GenerateCompoundFirstPartWithAffixes(var AWordStem
      : TdxHunspellWordStem; const AInitialWordForm: TWordFormArray;
      AInitialWordJoint: Integer; var ATakenPrefix: TdxPrefix;
      var ATakenSuffix: TdxSuffix; ACompoundWordPart: TdxCompoundWordPart);
    function IsAffixesForbidden(ATakenPrefix: TdxPrefix;
      ATakenSuffix: TdxSuffix): Boolean;
    function IsAffixesIncompatibleWithCompoundParts(ATakenPrefix: TdxPrefix;
      ATakenSuffix: TdxSuffix; AIsAffixChecked: Boolean;
      AWordPartIndex: SmallInt): Boolean;
    function IsWordPartSuitsCheckCompoundPatternTable
      (AWordStem: TdxHunspellWordStem; ATableIndex: Integer;
      AIsFirstWordPart: Boolean): Boolean;
    function IsWordPartSuitsCompoundFlags(AWordStem: TdxHunspellWordStem;
      AWordPartIndex: SmallInt; AIsFirstWordPart: Boolean;
      AWords: PdxWordStemTable): Boolean;
    function IsSyllablesAndCompoundPartsWithinLimits(AWordPartIndex,
      ASyllableCount: SmallInt): Boolean;
    function IsTripleLettersExistAndForbid(AWord: PWideChar;
      AJoint: Cardinal): Boolean;
    ...
    function CheckHungarianFlagsCompatibilityWithSuffix(var AWordStem
      : TdxHunspellWordStem; const AInitialWordForm: TWordFormArray;
      ACompoundWordJoint: Integer; AIsHungarianMoveRule: Boolean;
      var ATakenPrefix: TdxPrefix; var ATakenSuffix: TdxSuffix): Boolean;

    procedure BuildAffixTree(AAffix: TdxAffix;
      var AAffixTableArrangedByAppendString: TAffixTable;
      var AAffixTableIndexedByFlag: TAffixTable);
    function ProcessSuffixOrPrefixCheck(const AWord: PWideChar;
      AWordLength: Integer; ACompoundFlag: Word;
      ACompoundWordPart: TdxCompoundWordPart;
      var AWordStem: TdxHunspellWordStem; var ATakenPrefix: TdxPrefix;
      var ATakenSuffix: TdxSuffix): Boolean;
    procedure LinkAffixesIntoSubsets(const AAffixTableArrangedByAppendString
      : TAffixTable);
    ...
    procedure ProcessPrefixes(const ARoot: PWideChar; ARootLength: Integer;
      const AFlags: TdxHunspellFlags; AWords: PdxGuessWordArray;
      AWordCount: Integer; var AIndex: Integer; ABad: PWideChar;
      ABadLength: Integer);
    procedure ProcessSuffixes(const ARoot: PWideChar; ARootLength: Integer;
      const AFlags: TdxHunspellFlags; var AIndex: Integer;
      AWords: PdxGuessWordArray; AWordCount: Integer; ABad: PWideChar;
      ABadLength: Integer; APhonetic: PWideChar);
  ...
  public
    ...
    function AffixCheck(const AWord: PWideChar; AWordLength: Integer;
      var ATakenPrefix: TdxPrefix; var ATakenSuffix: TdxSuffix;
      const ACompoundFlag: Word = 0;
    ...
    function ProcessPrefixCheck(const AWord: PWideChar; AWordLength: Integer;
      ...
      ACompoundWordPart: TdxCompoundWordPart;
      const ACompoundFlag: Word = dxNullFlag): TdxHunspellWordStem;
    function IsForbiddenOrNoSuggestWord(AWordStem: TdxHunspellWordStem;
      ASuggest: Boolean): Boolean;
    function IsLeadingSubset(ASubset: PWideChar; ASet: PWideChar)
      : Boolean; inline;
    function IsTrailingReversedSubset(AReversedSubset: PWideChar;
      AEndOfSet: PWideChar; ASetLength: Integer): Boolean;
    function ProcessPrefixWithSuffixesCheck(const AWord: PWideChar;
      AWordLength: Integer; var ATakenPrefix: TdxPrefix;
      var ATakenSuffix: TdxSuffix; ACompoundWordPart: TdxCompoundWordPart;
      const ACompoundFlag: Word = dxNullFlag): TdxHunspellWordStem;
    function ProcessSuffixCheck(const AWord: PWideChar; AWordLength: Integer;
      const AOptions: TdxAffixOptions; APrefix: TdxPrefix;
      var ATakenSuffix: TdxSuffix; const ACompatibleFlag: Word = dxNullFlag;
      const ACompoundFlag: Word = dxNullFlag;
      ACompoundWordPart: TdxCompoundWordPart = cwpNone): TdxHunspellWordStem;
    function ProcessTwoSuffixCheck(const AWord: PWideChar; AWordLength: Integer;
      ...
      var ATakenSuffix: TdxSuffix; const ACompoundFlag: Word = dxNullFlag)
      : TdxHunspellWordStem;
    function GetSyllableCount(const AWord: PWideChar; AWordLength: Integer)
      : SmallInt;
    function IsSimpleWordWithReplacedCharacters(const AWord: PWideChar;
      AWordLength: Integer; var ATakenPrefix: TdxPrefix;
      var ATakenSuffix: TdxSuffix): Boolean;
    function IsForbiddenByCheckCompoundPattern(const AWord: PWideChar;
      AJoint: Integer; AFirstPartWordStem, ASecondPartWordStem
      : TdxHunspellWordStem): Boolean;
    function IsWordPartsSuitCompoundRule(var AWords: PdxWordStemTable;
      AWordCount: SmallInt; AWordStem: TdxHunspellWordStem;
      ADefaultWords: PdxWordStemTable; AIsFirstWordPart: Boolean): Boolean;
    function IsJointUpperCaseExistAndForbid(const AWord: PWideChar;
      AJoint: Integer): Boolean;
    function CompoundWordWithReplacedCharactersExists(const AWord: PWideChar;
      AWordLength: Integer; var ATakenPrefix: TdxPrefix;
      var ATakenSuffix: TdxSuffix): Boolean;
    procedure GetCompoundWordJointRange(var ACompoundWordJointMin,
      ACompoundWordJointMax: Integer; const AWord: PWideChar;
      AWordLength: Integer);
    function CompoundCheck(const AWord: PWideChar;
      AWordPartIndex, ASyllableCount, AWordPartMaxCount, AWordIndex: SmallInt;
      AWords: PdxWordStemTable = nil; AIsHungarianMoveRule: Boolean = False;
      ASuggest: Boolean = False): TdxHunspellWordStem;
    ...
    function ExpandWordStem(AWords: PdxGuessWordArray; AWordCount: Integer;
      const ARoot: PWideChar; ARootLength: Integer;
    ...
    property CompatibleFlagsExist: Boolean read FCompatibleFlagsExist
      write FCompatibleFlagsExist;
    property ComplexPrefixes: Boolean read GetComplexPrefixes
      write SetComplexPrefixes;
  ...
  protected
    function GetDataIdentifier: PWideChar; virtual; abstract;
    function Process(ALine: PWideChar; AReader: TdxHunspellReader): Boolean;
      virtual; abstract;
    function ParseFlag(ALine: PWideChar; var ADecodedFlag: Word;
  ...
  public
    ...
    property Items[Index: Integer]: TdxAffixFileAttributeReader
      read GetItem; default;
  end;
...
type
  ...
  protected
    function GetDataIdentifier: PWideChar; override;
    function Process(ALine: PWideChar; AReader: TdxHunspellReader)
      : Boolean; override;
  end;
...
constructor TdxHunspellAffixManager.Create(AWordStemManager
...
function TdxHunspellAffixManager.ProcessSuffixOrPrefixCheck
  (const AWord: PWideChar; AWordLength: Integer; ACompoundFlag: Word;
  ACompoundWordPart: TdxCompoundWordPart; var AWordStem: TdxHunspellWordStem;
  var ATakenPrefix: TdxPrefix; var ATakenSuffix: TdxSuffix): Boolean;
begin
...
function TdxHunspellAffixManager.OrderAffixTree(AAffix, ANextAffix: TdxAffix)
  : TdxAffix;
begin
  if AAffix <> nil then
  begin
...
procedure TdxHunspellAffixManager.LinkAffixesIntoSubsets
  (const AAffixTableArrangedByAppendString: TAffixTable);
var
...
begin
  ...
  begin
    ...
    begin
      ...
      begin
        if not IsLeadingSubset(AAffix.AppendString, ANextAffix.AppendString)
        then
          Break;
      ...
      AAffix.NextSimilar := nil;
      if (AAffix.Next <> nil) and IsLeadingSubset(AAffix.AppendString,
        AAffix.Next.AppendString) then
...
function TdxHunspellAffixManager.IsLeadingSubset(ASubset: PWideChar;
  ASet: PWideChar): Boolean;
begin
...
function TdxHunspellAffixManager.IsTrailingReversedSubset(AReversedSubset
  : PWideChar; AEndOfSet: PWideChar; ASetLength: Integer): Boolean;
begin
...
function TdxHunspellAffixManager.ProcessPrefixCheck(const AWord: PWideChar;
  AWordLength: Integer; var ATakenPrefix: TdxPrefix;
  var ATakenSuffix: TdxSuffix; ACompoundWordPart: TdxCompoundWordPart;
  const ACompoundFlag: Word = dxNullFlag): TdxHunspellWordStem;
var
...
begin
  ...
  begin
    ...
    begin
      Result := APrefix.CheckWord(AWord, AWordLength, ATakenSuffix,
...
function TdxHunspellAffixManager.ProcessPrefixWithSuffixesCheck
...
begin
  Result := False;
  if (AWordLength < 2) or (FReplaceTable.Count = 0) or not FCheckCompoundRep
  then
    Exit;
  ...
  begin
    ...
    begin
      ...
      StrCopy(ATemp + AReplaceLength, AWordCursor + AInitialLength);
...
function TdxHunspellAffixManager.IsForbiddenByCheckCompoundPattern
  (const AWord: PWideChar; AJoint: Integer;
...
begin
  ...
  begin
    ...
    if IsLeadingSubset(FCheckCompoundPatternTable[I].Pattern2, AWord + AJoint)
      and ((AFirstPartWordStem = nil) or
      (FCheckCompoundPatternTable[I].Condition = 0) or
      AFirstPartWordStem.IsCompatibleWithFlag(FCheckCompoundPatternTable[I]
      .Condition)) and ((ASecondPartWordStem = nil) or
      (FCheckCompoundPatternTable[I].Condition2 = 0) or
      ASecondPartWordStem.IsCompatibleWithFlag(FCheckCompoundPatternTable[I]
      .Condition2)) and (ALength <> 0) and (AJoint > ALength) and
      (StrLComp(AWord + AJoint - ALength, FCheckCompoundPatternTable[I].Pattern,
      ALength) = 0) then
    begin
      Result := True;
      Break;
...
function TdxHunspellAffixManager.IsJointUpperCaseExistAndForbid
  (const AWord: PWideChar; AJoint: Integer): Boolean;
var
  A, B: WideChar;
begin
  Result := False;
...
function TdxHunspellAffixManager.IsWordPartsSuitCompoundRule
  (var AWords: PdxWordStemTable; AWordCount: SmallInt;
  AWordStem: TdxHunspellWordStem; ADefaultWords: PdxWordStemTable;
  AIsFirstWordPart: Boolean): Boolean;
var
  ...
  begin
    Result := AIsWordStemCompatibleWithCompoundRule and
      AIsAllWordsCompatibleWithCompoundRule;
  end;

begin
  Result := False;
  if (AWordStem.AffixFlags.Length = 0) or
    ((AWords = nil) and (ADefaultWords = nil)) then
    Exit;

  AIsWordStemCompatibleWithCompoundRule := IsWordStemCompatibleWithCompoundRule
    (AWordStem);
...
function TdxHunspellAffixManager.GetSyllableCount(const AWord: PWideChar;
  AWordLength: Integer): SmallInt;
var
  I: Integer;
begin
  Result := 0;
...
procedure TdxHunspellAffixManager.GetCompoundWordJointRange
  (var ACompoundWordJointMin, ACompoundWordJointMax: Integer;
  const AWord: PWideChar; AWordLength: Integer);
begin
...
var
  ...
  ASyllableCountStore, ASyllableCountStore2, AWordPartIndexStore,
    AWordPartIndexStore2: SmallInt;
  ...
  begin
    if IsSimpleWordWithReplacedCharacters(AWord, AWordLength, ATakenPrefix,
      ATakenSuffix) then
      Result := nil
    else
  ...
  procedure HungarianSyllableProcess(var ASyllableCount, AWordPartIndex
    : SmallInt);
  begin
    if IsHungarian then
    begin
      Inc(ASyllableCount, GetSyllableCount(AInitialWordForm,
        AInitialWordJoint));
      if (ATakenPrefix <> nil) and
        (GetSyllableCount(ATakenPrefix.AppendString,
        StrLen(ATakenPrefix.AppendString)) > 1) then
        Inc(AWordPartIndex);
    end;
  end;
  ...
  begin
    if (AWordStem <> nil) and IsHungarian and AWordStem.IsCompatibleWithFlag
      (Ord(dxHungarianFlagI)) and not AWordStem.IsCompatibleWithFlag
      (Ord(dxHungarianFlagJ)) then
      Dec(ASyllableCount);
  end;
...
begin
  ...
  ATableIndex := 0;
  GetCompoundWordJointRange(ACompoundWordJointMin, ACompoundWordJointMax, AWord,
    AWordLength);
  ...
  begin
    ...
    repeat
      ...
      begin
        ...
        AIsAffixChecked := CompoundPartAffixCheck(AInitialWordForm,
          AInitialWordJoint, AWordStem, AWordPartIndex, ACompoundWordPart,
          ATakenPrefix, ATakenSuffix);
      end
      else if AWordStem.NeedAffix or IsForbiddenOrNoSuggestWord(AWordStem,
        ASuggest) then
      begin
      ...
      if (AWordStem <> nil) and not AIsHungarianMoveRule and
        ...
        IsAffixesIncompatibleWithCompoundParts(ATakenPrefix, ATakenSuffix,
        AIsAffixChecked, AWordPartIndex)) then
        AWordStem := nil;
      ...
      if ((AWordStem <> nil) and (AIsAffixChecked or ((AWords <> nil) and
        (AWords[AWordIndex] <> nil)) or CanBeFirstPartInCompoundWord(AWordStem,
        AWordPartIndexStore) or CheckHungarianFlagsCompatibility(AWordStem,
        AIsHungarianMoveRule)) and IsWordPartSuitsCheckCompoundPatternTable
        (AWordStem, ATableIndex, True) and not((ATableIndex = 0) and
        (AWords = nil) and (IsTripleLettersExistAndForbid(AWord,
        AInitialWordJoint) or IsJointUpperCaseExistAndForbid(AWord,
        AInitialWordJoint)))) or CheckHungarianFlagsCompatibilityWithSuffix
        (AWordStem, AInitialWordForm, ACompoundWordJoint, AIsHungarianMoveRule,
        ATakenPrefix, ATakenSuffix) then
      begin
        ...
        repeat
          ...
          begin
            ...
            else if (AInitialWordJoint > 2) and
              ((AWord + AInitialWordJoint - 1)^ = (AWord + AInitialWordJoint
              - 2)^) then
              ADoubleCharacter := True;
          end;
          AWordStem := Lookup(AInitialWordForm + AInitialWordJoint);
          GetWordStemSuitableForAffixAndCompoundRules(AWordStem, 0, ATableIndex,
            AWords, AWordIndex + 1, nil, False);
          if (AWordStem <> nil) and (AWords <> nil) and
            (AWords[AWordIndex + 1] <> nil) then
          begin
            Result := AFirstPartWordStem;
            Exit;
          end;
          ...
          if (AWordStem <> nil) and
            ...
            ((ATableIndex <> 0) or not IsForbiddenByCheckCompoundPattern(AWord,
            ACompoundWordJoint, AFirstPartWordStem, AWordStem)) and
            (not FCheckCompoundDup or (AWordStem <> AFirstPartWordStem)) and
            IsWordPartSuitsCheckCompoundPatternTable(AWordStem, ATableIndex,
            False) then
          begin
            Result := AFirstPartWordStem;
            Exit;
          ...
          if FCompoundFlag <> 0 then
            AWordStem := AffixCheck(AWord + AInitialWordJoint,
              StrLen(AWord + AInitialWordJoint), ATakenPrefix, ATakenSuffix,
              FCompoundFlag, cwpLast)
          else
            AWordStem := nil;
          ...
          begin
            ...
            AWordStem := AffixCheck(AWord + AInitialWordJoint,
              StrLen(AWord + AInitialWordJoint), ATakenPrefix, ATakenSuffix,
              FCompoundEnd, cwpLast);
          end;
          if (AWordStem = nil) and (FCompoundRuleTable.Count <> 0) and
            (AWords <> nil) then
          begin
            AWordStem := AffixCheck(AWord + AInitialWordJoint,
              StrLen(AWord + AInitialWordJoint), ATakenPrefix, ATakenSuffix,
              0, cwpLast);
            if (AWordStem <> nil) and IsWordPartsSuitCompoundRule(AWords,
              AWordIndex + 1, AWordStem, nil, True) then
            begin
              Result := AFirstPartWordStem;
              Exit;
            end;
          ...
          if (AWordStem <> nil) and
            ((ATableIndex <> 0) and not AWordStem.IsCompatibleWithFlag
            (FCheckCompoundPatternTable[ATableIndex - 1].Condition2) or
            (ATableIndex = 0) and IsForbiddenByCheckCompoundPattern(AWord,
            AInitialWordJoint, AFirstPartWordStem, AWordStem) or
          ...
          if IsHungarian then
          begin
            CheckHungarianSyllableCount(AWord + AInitialWordJoint, AWordStem,
              ASyllableCount);
            if (ATakenPrefix <> nil) and
              (GetSyllableCount(ATakenPrefix.AppendString,
              StrLen(ATakenPrefix.AppendString)) > 1) then
          ...
          CompoundRootCheck(AWordStem, AWordPartIndex);
          if (AWordStem <> nil) and IsSyllablesAndCompoundPartsWithinLimits
            (AWordPartIndex + 1, ASyllableCount) and
          ...
          begin
            AWordStem := CompoundCheck(AInitialWordForm + AInitialWordJoint,
              AWordPartIndex + 1, ASyllableCount, AWordPartMaxCount,
              AWordIndex + 1, AWords, False, ASuggest);
            if (AWordStem <> nil) and
              (not((ATableIndex = 0) xor IsForbiddenByCheckCompoundPattern
              (AWord, AInitialWordJoint, AFirstPartWordStem, AWordStem))) then
              AWordStem := nil;
          end
          else
            AWordStem := nil;
      ...
      Inc(ATableIndex);
    until not(FCheckCompoundPatternTable.IsSimplified and
      (ATableIndex <= FCheckCompoundPatternTable.Count));
    ATableIndex := 0;
...
function TdxHunspellAffixManager.ProcessSuffixCheck(const AWord: PWideChar;
  AWordLength: Integer; const AOptions: TdxAffixOptions; APrefix: TdxPrefix;
  var ATakenSuffix: TdxSuffix; const ACompatibleFlag: Word = dxNullFlag;
  const ACompoundFlag: Word = dxNullFlag;
  ACompoundWordPart: TdxCompoundWordPart = cwpNone): TdxHunspellWordStem;
...
begin
  Result := nil;
  AIncompatibleFlag := IfThen(ACompoundWordPart <> cwpNone, dxNullFlag,
    FInCompoundOnly);
  ...
  if Result = nil then
  begin
    ASuffix := TdxSuffix(FSuffixTableArrangedByAppendString
      [Ord((AWord + AWordLength - 1)^)]);
    while (ASuffix <> nil) and (Result = nil) do
    begin
      if IsTrailingReversedSubset(ASuffix.AppendString, AWord + AWordLength - 1,
        AWordLength) then
      begin
        if ASuffix.CanUseInTheMiddleOfCompoundWords(ACompoundWordPart) and
          AreAffixesBothCircumfixesOrNot(APrefix, ASuffix) and
          ASuffix.CanUseInSimpleWordsOrIsFogemorpheme(ACompoundWordPart) and
          ((ACompatibleFlag <> 0) or not ASuffix.NeedAffix or (APrefix <> nil)
          and not APrefix.NeedAffix) then
        begin
          Result := ASuffix.CheckWord(AWord, AWordLength, AOptions, APrefix,
            ACompatibleFlag, ACompoundFlag, AIncompatibleFlag);
          if Result <> nil then
...
function TdxHunspellAffixManager.AffixCheck(const AWord: PWideChar;
  AWordLength: Integer; var ATakenPrefix: TdxPrefix;
...
begin
  ...
  begin
    ...
    begin
      ...
      if Result = nil then
      begin
        Result := ProcessTwoSuffixCheck(AWord, AWordLength, [], nil,
          ATakenSuffix, ACompoundFlag);
        if Result = nil then
...
procedure TdxHunspellAffixManager.SetCompatibleFlags(AIndex: Integer;
  AValue: Boolean);
begin
  FCompatibleFlags[AIndex] := AValue;
end;

procedure SetupGuessByIndex(AWords: PdxGuessWordArray; AIndex: Integer;
  AWord, AOrig: PWideChar; AAllow: Boolean);
var
  AItem: PdxGuessWord;
begin
  AItem := @AWords[AIndex];
...
begin
  AIndex := 0;
  if (AIndex < AWordCount) and
    not((NeedAffix <> 0) and AFlags.ContainsFlag(NeedAffix) or
  ...
  begin
    ...
    begin
      SetupGuessByIndex(AWords, AIndex, StrNew(APhonetic),
        StrNew(ARoot), False);
      Inc(AIndex);
    end;
  end;
  ProcessSuffixes(ARoot, ARootLength, AFlags, AIndex, AWords, AWordCount, ABad,
    ABadLength, APhonetic);
  K := AIndex;
  for I := 1 to K - 1 do
      ...
      begin
        ...
        begin
          if (APrefix.Flag = AFlags[J]) and APrefix.PrefixSuffixUnion and
            ((APrefix.AppendStringLength = 0) or
            ((ABadLength > APrefix.AppendStringLength) and
            (StrLComp(APrefix.AppendString, ABad, APrefix.AppendStringLength)
            = 0))) then
          begin
            AWord := AWords[I].Word;
            ...
            begin
              ...
              begin
                SetupGuessByIndex(AWords, AIndex, ANewWord, nil,
                  APrefix.PrefixSuffixUnion);
                Inc(AIndex);
              end
              else
                StrDispose(ANewWord);
  ...
  ProcessPrefixes(ARoot, ARootLength, AFlags, AWords, AWordCount, AIndex, ABad,
    ABadLength);
  Result := AIndex;
end;

procedure TdxHunspellAffixManager.ProcessSuffixes(const ARoot: PWideChar;
  ARootLength: Integer; const AFlags: TdxHunspellFlags; var AIndex: Integer;
  AWords: PdxGuessWordArray; AWordCount: Integer; ABad: PWideChar;
  ABadLength: Integer; APhonetic: PWideChar);
var
  I: Integer;
...
begin
  ...
  begin
    ...
    begin
      if (ASuffix.Flag = AFlags[I]) and
        ((ASuffix.AppendStringLength = 0) or
        ((ABadLength > ASuffix.AppendStringLength) and
        StrEquals(ASuffix.ReverseAppendString, ABad + ABadLength -
        ASuffix.AppendStringLength))) and
        not(ASuffix.NeedAffix or ASuffix.Circumfix or ASuffix.InCompoundOnly)
      then
      begin
        ...
        begin
          ...
          begin
            ...
            begin
              ...
              SetupGuessByIndex(AWords, AIndex, StrNew(ATemp),
                StrNew(ANewWord), False);
              Inc(AIndex);
            end;
          end
          else
...
procedure TdxHunspellAffixManager.ProcessPrefixes(const ARoot: PWideChar;
  ARootLength: Integer; const AFlags: TdxHunspellFlags;
  AWords: PdxGuessWordArray; AWordCount: Integer; var AIndex: Integer;
  ABad: PWideChar; ABadLength: Integer);
var
  I: Integer;
  APrefix: TdxPrefix;
  ANewWord: PWideChar;
begin
  ...
  begin
    ...
    while APrefix <> nil do
    begin
      if (APrefix.Flag = AFlags[I]) and
        ((APrefix.AppendStringLength = 0) or
        ((ABadLength > APrefix.AppendStringLength) and
        (StrLComp(APrefix.AppendString, ABad, APrefix.AppendStringLength) = 0)))
        and not(APrefix.NeedAffix or APrefix.Circumfix or APrefix.InCompoundOnly)
      then
      begin
...
function TdxHunspellAffixManager.IsAffixKeyUnique(AFlag: Word;
  IsPrefix: Boolean): Boolean;
begin
  Result := (IsPrefix and (FExistentAffixFlags[AFlag] and
    dxExistentPrefixFlag = 0)) or
...
begin
  if IsPrefix then
    FExistentAffixFlags[AFlag] := FExistentAffixFlags[AFlag] or
      dxExistentPrefixFlag
  else
    FExistentAffixFlags[AFlag] := FExistentAffixFlags[AFlag] or
      dxExistentSuffixFlag;
end;
...
function TdxHunspellAffixManager.Lookup(const AWord: PWideChar)
  : TdxHunspellWordStem;
begin
...
function TdxHunspellAffixManager.ParseRep(ALine: PWideChar;
  AAffixFileReader: TdxHunspellReader): Boolean;
begin
  Result := FReplaceTable.ReadData(ALine, AAffixFileReader);
end;

function TdxHunspellAffixManager.AreAffixesBothCircumfixesOrNot(APrefix,
  ASuffix: TdxAffix): Boolean;
begin
...
begin
  ...
  if FSavedSuffixInfo.AppendString <> nil then
    Dec(ASyllableCount, GetSyllableCount(FSavedSuffixInfo.AppendString,
      StrLen(FSavedSuffixInfo.AppendString)));
  if FSyllableNum <> nil then
    case Chr(FSavedSuffixInfo.Flag) of
      dxHungarianFlagC:
        Inc(ASyllableCount, 2);
      dxHungarianFlagJ:
        Inc(ASyllableCount, 1);
      dxHungarianFlagI:
        if AWordStem.IsCompatibleWithFlag(Ord(dxHungarianFlagJ)) then
          Inc(ASyllableCount, 1);
    end;
end;
...
procedure TdxHunspellAffixManager.CheckWordsCompatibilityWithCompoundRule
  ...
  AWordCount: SmallInt; ACompoundRuleTableIndex: Integer;
...
var
  ...
  AFlag: Word;
begin
  while (AFlagIndex < FCompoundRuleTable[ACompoundRuleTableIndex].Length) and
    (AWordIndex <= AWordCount) do
  begin
    AMetacharacterIndex := AFlagIndex + 1;
    AFlag := 0;
    if AMetacharacterIndex < FCompoundRuleTable[ACompoundRuleTableIndex].Length
    then
      AFlag := FCompoundRuleTable[ACompoundRuleTableIndex].Pattern
        [AMetacharacterIndex];
    if (AMetacharacterIndex < FCompoundRuleTable[ACompoundRuleTableIndex]
      .Length) and FCompoundRuleTable.IsPartOfCompoundWordFlag(AFlag) then
    begin

      AMaxWordIndex := IfThen(AFlag = Ord(dxCompoundRuleOneWordFlag),
        AWordIndex, AWordCount);

      Inc(AFlagIndex, 2);
      ABackTrackingTable[ABackTrackingIndex].MetacharacterPosition :=
        AFlagIndex;
      ABackTrackingTable[ABackTrackingIndex].WordsIndex := AWordIndex;
      AIsAllWordsCompatibleWithCompoundRule :=
        GetIsAllWordsCompatibleWithCompoundRule(AWords, AWordIndex,
        AMaxWordIndex, FCompoundRuleTable[ACompoundRuleTableIndex].Pattern
        [AFlagIndex - 2]);
      if AWordIndex <= AWordCount then
        AIsAllWordsCompatibleWithCompoundRule := False;
      ABackTrackingTable[ABackTrackingIndex].MatchedWordCount := AWordIndex -
        ABackTrackingTable[ABackTrackingIndex].WordsIndex;
    ...
    begin
      AIsAllWordsCompatibleWithCompoundRule := True;
      if (AWords[AWordIndex] = nil) or not AWords[AWordIndex]
        .IsCompatibleWithFlag(FCompoundRuleTable[ACompoundRuleTableIndex]
        .Pattern[AFlagIndex]) then
      begin
      ...
      Inc(AFlagIndex);
      Inc(AWordIndex);
      if (FCompoundRuleTable[ACompoundRuleTableIndex].Length = AFlagIndex) and
        not(AWordIndex > AWordCount) then
        AIsWordStemCompatibleWithCompoundRule := False;
    end;
  end;
end;

function TdxHunspellAffixManager.CompoundPartAffixCheck(const AInitialWordForm
  : TWordFormArray; const AInitialWordJoint: Integer;
...
begin
  Result := (AWordStem <> nil) or
    ...
    FCompoundBegin, ACompoundWordPart, AWordStem, ATakenPrefix, ATakenSuffix))
    or ((AWordPartIndex > 0) and (FCompoundMiddle <> 0) and
    ProcessSuffixOrPrefixCheck(AInitialWordForm, AInitialWordJoint,
    FCompoundMiddle, ACompoundWordPart, AWordStem, ATakenPrefix,
    ATakenSuffix)));
end;

procedure TdxHunspellAffixManager.CorrectBackTrackingIndex
  (var ABackTrackingTable: TdxBackTrackingTable;
  var AFlagIndex, AWordIndex, ABackTrackingIndex: SmallInt);
begin
  repeat
    Dec(ABackTrackingTable[ABackTrackingIndex - 1].MatchedWordCount);
    AFlagIndex := ABackTrackingTable[ABackTrackingIndex - 1]
      .MetacharacterPosition;
...
function TdxHunspellAffixManager.EndOfCompoundRulePattern
  (ACompoundRuleTableIndex: Integer; AFlagIndex: Integer): Boolean;
begin
  while (AFlagIndex + 1 < FCompoundRuleTable[ACompoundRuleTableIndex].Length)
    and FCompoundRuleTable.IsPartOfCompoundWordFlag
    (FCompoundRuleTable[ACompoundRuleTableIndex].Pattern[AFlagIndex + 1]) do
    Inc(AFlagIndex, 2);
...
begin
  while (ATableIndex <= FCheckCompoundPatternTable.Count) and
    ...
    (StrLComp(AWordSecondPart, FCheckCompoundPatternTable[ATableIndex - 1]
    .Pattern3, StrLen(FCheckCompoundPatternTable[ATableIndex - 1].Pattern3)
    ) <> 0)) do
    Inc(ATableIndex);
...
function TdxHunspellAffixManager.GetIsAllWordsCompatibleWithCompoundRule
  (const AWords: PdxWordStemTable; var AWordIndex: SmallInt;
  AWordIndexMax: Integer; AFlag: Word): Boolean;
begin
  Result := True;
...
begin
  while (AWordStem <> nil) and
    (AWordStem.NeedAffix or not((IsWordPartSuitsCompoundFlags(AWordStem,
    AWordPartIndex, AIsFirstWordPart, AWords) or ((AWords <> nil) or
    (AWordPartIndex = 0)) and IsWordPartsSuitCompoundRule(AWords, AWordIndex,
    AWordStem, ACompoundRuleWords, AIsFirstWordPart)) and
    IsWordPartSuitsCheckCompoundPatternTable(AWordStem, ATableIndex,
    AIsFirstWordPart))) do
...
begin
  ...
  begin
    ...
    begin
      ...
      if (AWordStem <> nil) and (ACompoundWordPart = cwpFirst)
      { not AIsHungarianMoveRule } and
...
function TdxHunspellAffixManager.IsWordPartSuitsCompoundFlags
  (AWordStem: TdxHunspellWordStem; AWordPartIndex: SmallInt;
  AIsFirstWordPart: Boolean; AWords: PdxWordStemTable): Boolean;
begin
...
begin
  Result := ((FCompoundWordMax = -1) or (AWordPartIndex < FCompoundWordMax)) or
    ((FMaxCompoundSyllable <> 0) and (ASyllableCount <= FMaxCompoundSyllable));
end;

function TdxHunspellAffixManager.IsTripleLettersExistAndForbid(AWord: PWideChar;
  AJoint: Cardinal): Boolean;
begin
  Result := FCheckCompoundTriple and (AWord[AJoint - 1] = AWord[AJoint]) and
    (((AJoint > 1) and (AWord[AJoint - 1] = AWord[AJoint - 2])) or
    ((AJoint + 1 < StrLen(AWord)) and (AWord[AJoint - 1] = AWord[AJoint + 1])));
end;

procedure TdxHunspellAffixManager.MakeWordWithCheckCompoundPatternTable
  (const AWord: PWideChar; AInitialWordForm: PWideChar;
  ACompoundWordJoint: Integer; var AInitialWordJoint, AWordLength: Integer;
  ATableIndex: Integer);
begin
  StrCopy(AInitialWordForm + ACompoundWordJoint,
    FCheckCompoundPatternTable[ATableIndex].Pattern);
  Inc(AInitialWordJoint, StrLen(FCheckCompoundPatternTable[ATableIndex]
    .Pattern));
  StrCopy(AInitialWordForm + AInitialWordJoint,
    FCheckCompoundPatternTable[ATableIndex].Pattern2);
  StrCopy(AInitialWordForm + AInitialWordJoint +
    StrLen(FCheckCompoundPatternTable[ATableIndex].Pattern2),
    AWord + ACompoundWordJoint + StrLen(FCheckCompoundPatternTable[ATableIndex]
    .Pattern3));
...
function TdxHunspellAffixManager.CheckHungarianFlagsCompatibilityWithSuffix
  (var AWordStem: TdxHunspellWordStem; const AInitialWordForm: TWordFormArray;
  ACompoundWordJoint: Integer; AIsHungarianMoveRule: Boolean;
  var ATakenPrefix: TdxPrefix; var ATakenSuffix: TdxSuffix): Boolean;
  ...
  begin
    AWordStem := AffixCheck(AInitialWordForm, ACompoundWordJoint, ATakenPrefix,
      ATakenSuffix);
    Result := AWordStem <> nil;
  end;
...
begin
  if AFlag = 0 then
    Result := nil
  else if AffixFlagMode = afmNumber then
    Result := IntStr(AFlag)
  else
  begin
...
begin
  ...
  if (FMorphologicalDescription <> nil) and
    not(aoAffixMorphologyTable in FOptions) then
    StrDispose(FMorphologicalDescription);
  FreeAndNil(FCompatibleFlags);
  inherited Destroy;
end;

function TdxAffix.CanUseInSimpleWordsOrIsFogemorpheme(ACompoundWordPart
  : TdxCompoundWordPart): Boolean;
begin
  Result := (ACompoundWordPart <> cwpNone) or not InCompoundOnly;
end;

function TdxAffix.CanUseInTheMiddleOfCompoundWords(ACompoundWordPart
  : TdxCompoundWordPart): Boolean;
begin
...
function TdxAffix.IsCompatibleWithFlag(AFlag: Word;
  CompatibleIfNull: Boolean = False): Boolean;
begin
...
function TdxAffix.IsWithoutAffixWordLengthCorrect(ALengthWithoutAffix
  : Integer): Boolean;
begin
  Result := ((ALengthWithoutAffix > 0) or (ALengthWithoutAffix = 0) and
    AffixManager.FullStrip) and (ALengthWithoutAffix + FStripStringLength >=
    FConditionLength);
end;
...
function TdxPrefix.CanUseInCompoundWordPart(ACompoundWordPart
  : TdxCompoundWordPart): Boolean;
begin
  Result := ACompoundWordPart <> cwpLast;
end;

function TdxPrefix.CheckWord(const AWord: PWideChar; AWordLength: Integer;
  var ATakenSuffix: TdxSuffix; ACompoundWordPart: TdxCompoundWordPart;
  const ACompoundFlag: Word = dxNullFlag): TdxHunspellWordStem;
var
...
function TdxPrefix.GetWordWithAffix(const AWord: PWideChar;
  AWordLength: Integer): PWideChar;
var
  ATempWord: TdxLineBuffer;
  AWordCursor: PWideChar;
begin
  Result := nil;
  if ((AWordLength > FStripStringLength) or ((AWordLength = 0) and
    AffixManager.FullStrip)) and (AWordLength >= FConditionLength) and
    IsWordSuitableForCondition(AWord) and
    ((FStripStringLength = 0) or (StrLComp(AWord, FStripString,
    FStripStringLength) = 0)) and
    (dxMaxWordLength > AWordLength + FAppendStringLength - FStripStringLength)
  then
  begin
...
function TdxPrefix.MakeInitialWordFormAndProcessTwoSuffixCheck
  (const AWord: PWideChar; AWordLength: Integer; var ATakenSuffix: TdxSuffix;
  ACompoundWordPart: TdxCompoundWordPart;
  const ACompoundFlag: Word = dxNullFlag): TdxHunspellWordStem;
var
  AInitialWordFormLength: Integer;
...
function TdxSuffix.CanUseInCompoundWordPart(ACompoundWordPart
  : TdxCompoundWordPart): Boolean;
begin
  Result := ACompoundWordPart <> cwpFirst;
end;

function TdxSuffix.GetWordWithAffix(const AWord: PWideChar;
  AWordLength: Integer): PWideChar;
var
  ATempWord: TdxLineBuffer;
begin
  ...
  if ((AWordLength > FStripStringLength) or (AWordLength = 0) and
    (AffixManager.FullStrip)) and (AWordLength >= FConditionLength) and
    IsWordSuitableForCondition(AWord + AWordLength, AWord) and
    ((FStripStringLength = 0) or StrEquals(AWord + AWordLength -
    FStripStringLength, FStripString)) and
    (dxMaxWordLength > AWordLength + AppendStringLength - FStripStringLength)
  then
  begin
...
function TdxSuffix.CheckWord(const AWord: PWideChar; AWordLength: Integer;
  ...
  function IsIncompatibleWithFlag(AWordStem: TdxHunspellWordStem;
    AFlag: Word): Boolean;
  begin
...
begin
  ...
  begin
    ...
    begin
      ...
      begin
        repeat
          if (AWordStem.IsCompatibleWithFlag(FFlag) or (APrefix <> nil) and
            APrefix.IsCompatibleWithFlag(FFlag)) and
            (not IsPrefixSuffixUnion(AOptions) or AWordStem.IsCompatibleWithFlag
            (APrefix.Flag) or IsCompatibleWithFlag(APrefix.Flag)) and
...
function TdxSuffix.MakeInitialWordFormAndProcessSuffixCheck
  (const AWord: PWideChar; AWordLength: Integer;
  const AOptions: TdxAffixOptions; APrefix: TdxPrefix;
  var ATakenSuffix: TdxSuffix; const ACompoundFlag: Word = 0)
  : TdxHunspellWordStem;
    ...
    begin
      ...
      begin
        if IsCompatibleWithFlag(APrefix.Flag) then
          Result := AffixManager.ProcessSuffixCheck(AInitialWordForm,
            AInitialWordFormLength, [], nil, ATakenSuffix, FFlag, ACompoundFlag)
        else
          Result := AffixManager.ProcessSuffixCheck(AInitialWordForm,
            AInitialWordFormLength, AOptions, APrefix, ATakenSuffix, FFlag,
            ACompoundFlag);
      end
      else
        Result := AffixManager.ProcessSuffixCheck(AInitialWordForm,
...
function TdxSuffix.IsWordSuitableForCondition(AWordEnd,
  AWordBegin: PWideChar): Boolean;
var
    ...
    case AConditionCursor^ of
      ...
      begin
        ...
        begin
          if ANegative then
            Exit
          else if I = FConditionLength then
          begin
            Result := True;
            Exit;
          end;
        ...
        if (AWordEnd < AWordBegin) and (AConditionCursor^ <> #0) and
...
function TdxCustomHunspellDataTable.ReadData(ALine: PWideChar;
  AAffixFileReader: TdxHunspellReader): Boolean;
begin
...
function TdxCustomHunspellDataTable.AddDataPiece(const APiece: PWideChar;
...
function TdxCustomHunspellDataTable.IsAllPiecesFound
  (APieceIndex: Integer): Boolean;
begin
  Result := APieceIndex >= GetPieceQuantity;
end;

function TdxCustomHunspellDataTable.CheckDataType(const APiece
  : PWideChar): Boolean;
begin
...
function TdxCustomHunspellDataTable.ParseHeader(ALine: PWideChar;
...
function TdxCustomHunspellDataTable.ParseData(AAffixReader
  : TdxHunspellReader): Boolean;
var
  ALineBuffer: TdxLineBuffer;
...
constructor TdxHunspellDataLinkedTable.Create(AAffixManager
  : TdxHunspellAffixManager);
begin
  inherited Create;
  FAffixManager := AAffixManager;
...
function TdxHunspellDataLinkedTable.GetWordStemManager
  : TdxHunspellWordStemManager;
begin
...
function TdxAffixItemTable.AddDataPiece(const APiece: PWideChar;
  ADataIndex, APieceIndex: Integer): Boolean;
begin
  ...
  if Result then
    case APieceIndex of
      1:
        Result := CheckFlag(APiece);
      2:
        ParseStripString(APiece, ADataIndex);
      3:
        Result := ParseAppendStringWithAffixes(APiece, ADataIndex);
      4:
        Result := ParseCondition(APiece, ADataIndex);
      5:
        Result := ParseMorphologicDescription(APiece, ADataIndex);
      6:
        AddLineRemainderToMorphologicDescription(APiece, ADataIndex);
    end;
end;
...
function TdxAffixItemTable.ParseHeader(ALine: PWideChar;
  out ATableSize: Integer): Boolean;
var
  I: Integer;
  APiece: PWideChar;
begin
  ...
  begin
    ...
    begin
      case I of
        1:
          Result := ParseFlag(APiece);
        2:
          ParsePrefixSuffixUnion(APiece);
        3:
          Result := ParseTableSize(APiece, ATableSize);
      end;
      Inc(I);
    end;
    APiece := StrSeparate(@ALine, #0);
...
begin
  if not HasAffixMorphologicAliases then
  begin
    ALength := StrLen(Data[ADataIndex].MorphologicalDescription) +
      StrLen(ALine) + 2;
...
begin
  ...
  for I := 0 to Count - 1 do
    AffixManager.BuildAffixTree(TdxSuffix.Create(AffixManager, @Data[I],
      ...
      AffixManager.FSuffixTableArrangedByAppendString,
      AffixManager.FSuffixTableIndexedByFlag);
end;

function TdxSuffixItemTable.ConditionContainsDuplicateInformation
  (AStripString: PWideChar; AStripStringLength: Integer;
  const ACondition: PWideChar; out Contains: Boolean): Boolean;
var
...
begin
  ...
  if (AStripStringLength >= AConditionLength) and
    StrEquals(AStripString + AStripStringLength - AConditionLength, ACondition)
  then
    Contains := True;
...
begin
  ...
  begin
    ...
    begin
      ...
      AInGroup := False
    else if not AInGroup then
      Inc(Result);
    Inc(ALine);
  end;
end;

function TdxAffixItemTable.EncodeAffixCondition(ALine: PWideChar;
  ADataIndex: Integer): Boolean;
begin
  Result := True;
...
function TdxAffixItemTable.GetOptions(const AItem: TdxAffixItem)
  : TdxAffixOptions;
begin
  Result := [];
...
procedure TdxAffixItemTable.ParseAppendString(const ALine: PWideChar;
  ADataIndex: Integer);
begin
...
function TdxAffixItemTable.ParseAppendStringWithAffixes(const ALine: PWideChar;
  ADataIndex: Integer): Boolean;
var
...
function TdxAffixItemTable.ParseCompatibleFlags(const ALine: PWideChar;
  ADataIndex: Integer): Boolean;
begin
  Result := True;
  Data[ADataIndex].CompatibleFlags := TdxHunspellFlags.Create
    (AffixManager.AffixFlagMode);
  if HasAffixFlagAliases then
    Result := Data[ADataIndex].CompatibleFlags.InitializeByAlias
      (WordStemManager, ALine)
  else
  begin
...
function TdxAffixItemTable.ParseCondition(ALine: PWideChar;
  ADataIndex: Integer): Boolean;
var
  AContains: Boolean;
begin
  ...
  if (Data[ADataIndex].StripStringLength <> 0) and not StrEquals(ALine, '.')
  then
  begin
    Result := ConditionContainsDuplicateInformation
      (Data[ADataIndex].StripString, Data[ADataIndex].StripStringLength, ALine,
      AContains);
...
function TdxAffixItemTable.ParseMorphologicDescription(ALine: PWideChar;
  ADataIndex: Integer): Boolean;
begin
  Result := True;
  if HasAffixMorphologicAliases then
    Data[ADataIndex].MorphologicalDescription :=
      WordStemManager.GetAffixMorphologyByAlias(StrInt(ALine))
  else
  begin
    ProcessReverseString(ALine);
...
procedure TdxAffixItemTable.ParseStripString(const ALine: PWideChar;
  ADataIndex: Integer);
var
  ATempStringData: TdxStringData;
begin
...
function TdxAffixItemTable.ParseTableSize(ALine: PWideChar;
  out ATableSize: Integer): Boolean;
begin
...
begin
  ...
  for I := 0 to Count - 1 do
    AffixManager.BuildAffixTree(TdxPrefix.Create(AffixManager, @Data[I],
      FDecodedFlag, GetOptions(Data[I])),
      AffixManager.FPrefixTableArrangedByAppendString,
      AffixManager.FPrefixTableIndexedByFlag);
end;

function TdxPrefixItemTable.ConditionContainsDuplicateInformation
  (AStripString: PWideChar; AStripStringLen: Integer;
  const ACondition: PWideChar; out AContains: Boolean): Boolean;
var
  AConditionLength, I, J: Integer;
  ANegative, AIsCharactersAgreed: Boolean;
begin
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        Result := not((J = AConditionLength - 1) and
          ((ACondition + J)^ <> ']'));
        if Result then
          Result := ANegative xor AIsCharactersAgreed;
      end;
...
function TdxBreakTable.AddDataPiece(const APiece: PWideChar;
  ADataIndex, APieceIndex: Integer): Boolean;
begin
  Result := inherited AddDataPiece(APiece, ADataIndex, APieceIndex);
    ...
    case APieceIndex of
      1:
        begin
          ...
          ExtractCondition(Data[ADataIndex].Pattern,
            Data[ADataIndex].Condition);
        end;
      2:
        begin
          Data[ADataIndex].Pattern2 := StrNew(APiece);
          ExtractCondition(Data[ADataIndex].Pattern2,
            Data[ADataIndex].Condition2);
        end;
      3:
        begin
...
function TdxCheckCompoundPatternTable.GetItem(Index: Integer)
  : TdxCompoundForbidPattern;
begin
  Result := Data[Index];
end;
...
function TdxCompoundRuleTable.IsPartOfCompoundWordFlag
  (AFlag: PWideChar): Boolean;
begin
...
function TdxCompoundRuleTable.AddDataPiece(const APiece: PWideChar;
  ADataIndex, APieceIndex: Integer): Boolean;
begin
  Result := inherited AddDataPiece(APiece, ADataIndex, APieceIndex);
  if Result and (APieceIndex = 1) then
...
function TdxCompoundRuleTable.ParseFlags(APiece: PWideChar;
...
begin
  ...
  begin
    ...
    repeat
      ...
      while (ABracketPosition^ <> '(') and (ABracketPosition^ <> ')') and
        (ABracketPosition^ <> #0) do
...
function TdxMapTable.AddDataPiece(const APiece: PWideChar;
  ADataIndex, APieceIndex: Integer): Boolean;
begin
  Result := inherited AddDataPiece(APiece, ADataIndex, APieceIndex);
  if Result and (APieceIndex = 1) then
...
function TdxPhoneTable.Phonetic(const AWord: PWideChar; ADest: PWideChar;
  ALength: Integer): Integer;
const
  SpecialSymbols: PWideChar = '(-<^$';
var
  ACharIndex, J, AFoundLetters, ARuleIndex, APriority, z, k0, n0, p0,
    z0: Integer;
  AChar, C0: WideChar;
  S: PWideChar;
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        if S^ = '(' then
          if dxWideIsAlpha(ATempWord[ACharIndex + AFoundLetters]) and
            (StrScan(S + 1, ATempWord[ACharIndex + AFoundLetters]) <> nil) then
          begin
            Inc(AFoundLetters);
            while S^ <> ')' do
              Inc(S);
        ...
        if (S^ = #0) or
          ((S^ = '^') and ((ACharIndex = 0) or
          not dxWideIsAlpha(ATempWord[ACharIndex - 1]) and ((S + 1)^ <> '$') or
          not dxWideIsAlpha(ATempWord[ACharIndex + k0]))) or
          ((S^ = '$') and (ACharIndex > 0) and
          dxWideIsAlpha(ATempWord[ACharIndex - 1]) and
          not dxWideIsAlpha(ATempWord[ACharIndex + k0])) then
        begin
          C0 := ATempWord[ACharIndex + AFoundLetters - 1];
          n0 := FHash[Ord(C0)];

          if (AFoundLetters > 1) and (n0 >= 0) and (p0 <> Ord('-')) and
            (ATempWord[ACharIndex + AFoundLetters] <> #0) then
          begin
            ...
            begin
              ...
              S := Rules[n0];
              Inc(S);
              while (S^ <> #0) and (ATempWord[ACharIndex + k0] = S^) and
                not IsDigit(S^) and
              ...
              if S^ = '(' then
                if dxWideIsAlpha(ATempWord[ACharIndex + k0]) and
                  (StrScan(S + 1, ATempWord[ACharIndex + k0]) <> nil) then
                begin
                  Inc(k0);
                  while (S^ <> ')') and (S^ <> #0) do
                    Inc(S);
          ...
          p0 := 0;
          if (Rules[ARuleIndex]^ <> #0) and
            (StrScan(Rules[ARuleIndex] + 1, '<') <> nil) then
            p0 := 1;
          if (p0 = 1) and (z = 0) then
          begin
            if (J > 0) and (S^ <> #0) and
              ((ADest[J - 1] = AChar) or (ADest[J - 1] = S^)) then
              Dec(J);
            z0 := 1;
            z := 1;
            k0 := 0;
            ...
            if AFoundLetters > k0 then
              StrCopy(PWideChar(@ATempWord[ACharIndex + k0]),
                PWideChar(@ATempWord[ACharIndex + AFoundLetters]));
            AChar := ATempWord[ACharIndex];
          end
          else
          begin
            ...
            AChar := S^;
            if (Rules[ARuleIndex]^ <> #0) and
              (StrPos(Rules[ARuleIndex] + 1, '^^') <> nil) then
            begin
              if AChar <> #0 then
              begin
                ADest[J] := AChar;
              ...
              StrCopy(PWideChar(@ATempWord[0]),
                PWideChar(@ATempWord[ACharIndex + 1]));
              ACharIndex := 0;
              z0 := 1;
            end;
          end;
    ...
    if z0 = 0 then
    begin
      if (AFoundLetters <> 0) and (p0 = 0) and (J < ALength) and (AChar <> #0)
      then
      begin
        ADest[J] := AChar;
        Inc(J);
...
function TdxPhoneTable.AddDataPiece(const APiece: PWideChar;
  ADataIndex, APieceIndex: Integer): Boolean;
begin
  Result := inherited AddDataPiece(APiece, ADataIndex, APieceIndex);
  if Result then
    case APieceIndex of
      1:
        Rules[2 * ADataIndex] := StrReplace(StrNew(APiece), '_', '');
      2:
        Rules[2 * ADataIndex + 1] := StrReplace(StrNew(APiece), '_', '');
    end;
end;
...
function TdxReplaceTable.AddDataPiece(const APiece: PWideChar;
  ADataIndex, APieceIndex: Integer): Boolean;
begin
  Result := inherited AddDataPiece(APiece, ADataIndex, APieceIndex);
  if Result then
    case APieceIndex of
      1:
        Data[ADataIndex].Text := StrReplace(StrNew(APiece), '_', ' ');
      2:
        Data[ADataIndex].Replacement := StrReplace(StrNew(APiece), '_', ' ');
    end;
end;
...
function TdxConvertTable.Convert(const AWord: PWideChar;
  ADest: PWideChar): Boolean;
var
...
function TdxConvertTable.AddDataPiece(const APiece: PWideChar;
  ADataIndex, APieceIndex: Integer): Boolean;
begin
  Result := inherited AddDataPiece(APiece, ADataIndex, APieceIndex);
...
function TdxConvertTable.Match(const AWord: PWideChar; AIndex: Integer)
  : Integer;
var
...
constructor TdxAffixFileAttributeReader.Create(AAffixManager
  : TdxHunspellAffixManager);
begin
  FAffixManager := AAffixManager;
end;

function TdxAffixFileAttributeReader.ParseFlag(ALine: PWideChar;
  var ADecodedFlag: Word; AReader: TdxHunspellReader): Boolean;
var
  AFlag: PWideChar;
begin
  Result := True;
...
function TdxAffixFileAttributeReader.ParseNumber(ALine: PWideChar;
...
function TdxAffixFileAttributeReader.GetWordStemManager
  : TdxHunspellWordStemManager;
begin
  Result := AffixManager.WordStemManager;
end;
...
function TTryReader.Process(ALine: PWideChar;
  AReader: TdxHunspellReader): Boolean;
begin
...
function TSetReader.Process(ALine: PWideChar;
  AReader: TdxHunspellReader): Boolean;
var
  AEncoding: PWideChar;
begin
...
function TRepReader.Process(ALine: PWideChar;
  AReader: TdxHunspellReader): Boolean;
begin
...
function TMapReader.Process(ALine: PWideChar;
  AReader: TdxHunspellReader): Boolean;
begin
...
function TPhoneReader.Process(ALine: PWideChar;
  AReader: TdxHunspellReader): Boolean;
begin
...
function TLangReader.Process(ALine: PWideChar;
  AReader: TdxHunspellReader): Boolean;
var
  ALanguage: PWideChar;
  ALanguageID: Integer;
...
function TNoSplitSuggestionsReader.Process(ALine: PWideChar;
  AReader: TdxHunspellReader): Boolean;
begin
  Result := True;
...
procedure TdxAffixReaderList.Add(AReaderClass
  : TdxAffixFileAttributeReaderClass);
begin
  inherited Add(AReaderClass.Create(FAffixManager));
end;

function TdxAffixReaderList.GetItem(Index: Integer)
  : TdxAffixFileAttributeReader;
begin
  Result := TdxAffixFileAttributeReader(inherited Items[Index]);
end;

procedure TdxAffixReaderList.ProcessLine(ALine: PWideChar;
    ...
    begin
      if not AItem.Process(ALine, AReader) then
        HunspellError(Format('Error: attribute %s has wrong data',
          [dxWideStringToAnsiString(AItem.GetDataIdentifier)]),
          AReader.LineIndex);
