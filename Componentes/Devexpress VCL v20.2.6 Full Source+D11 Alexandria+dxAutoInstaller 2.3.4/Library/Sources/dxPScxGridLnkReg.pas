...
class function TdxGridReportLinkStyleSheetEditorPreview.GetStyleSheetClass
  : TcxCustomStyleSheetClass;
begin
  Result := TdxGridReportLinkStyleSheet;
end;

procedure TdxGridReportLinkStyleSheetEditorPreview.SetStyleSheet
...
function TdxGridReportLinkStyleSheetEditorPreview.AddItem
  (AView: TcxCustomGridTableView; const ACaption: string;
  AValueTypeClass: TcxValueTypeClass): TcxCustomGridTableItem;
begin
...
procedure TdxGridReportLinkStyleSheetEditorPreview.AddItems
...
procedure TdxGridReportLinkStyleSheetEditorPreview.CreateBandedTableView;
  ...
  begin
    ...
    begin
      Column := AddItem(BandedTableView, '', TcxStringValueType)
        as TcxGridColumn;
...
function TdxGridReportLinkStyleSheetEditorPreview.GetBandedTableView
