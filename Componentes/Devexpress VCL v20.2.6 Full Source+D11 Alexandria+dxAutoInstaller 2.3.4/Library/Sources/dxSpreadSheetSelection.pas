...
{$IFDEF DELPHI16}
  System.UITypes,
{$ENDIF}
  Types, Variants, Windows, Classes, Graphics, Dialogs, Messages, Controls,
  Generics.Defaults, Generics.Collections,
  cxGeometry, dxCore, cxGraphics, cxControls, cxEdit, cxTextEdit, cxRichEdit,
  cxClasses, cxCustomCanvas,
  dxSpreadSheetCore, dxSpreadSheetGraphics, dxCoreClasses,
  dxSpreadSheetCoreStyles, dxSpreadSheetFormulas;
...
type
  ...
  TdxSpreadSheetCustomTableViewDragAndDropObject = class
  ...
  TdxSpreadSheetTableViewReferenceHighlighter = class
  ...
  public
    ...
    property References
      : TObjectList<TdxSpreadSheetTableViewReferenceHighlighterItem>
      read FReferences;
    property View: TdxSpreadSheetTableView read GetView;
  end;
  ...
  TdxSpreadSheetTableViewReferenceHighlighterCustomDragAndDropObject = class
    (TdxSpreadSheetCustomTableViewDragAndDropObject)
  strict private
    FCursor: TCursor;
    FPrevCellArea: TRect;
  ...
  protected
    ...
    procedure AdjustRowAndColumnIndexesByMergedCells(var ARowIndex,
      AColumnIndex: Integer);
    procedure BeforeBeginDragAndDrop; override;
    procedure BeginDragAndDrop; override;
    function CheckForContentRect(const P: TPoint): TPoint;
    procedure CheckRowAndColumnIndexes(var ARowIndex,
      AColumnIndex: Integer); virtual;
    procedure DragAndDrop(const P: TPoint; var Accepted: Boolean); override;
    procedure EndDragAndDrop(Accepted: Boolean); override;
    function GetCellAtAbsolutePoint(const P: TPoint;
      out ARowIndex, AColumnIndex: Integer): Boolean; overload; override;
  ...
  public
    ...
    property Highlighter: TdxSpreadSheetTableViewReferenceHighlighter
      read GetHighlighter;
    property Reference: TdxSpreadSheetTableViewReferenceHighlighterItem
      read FReference;
  ...
  protected
    ...
    procedure AdjustRowAndColumnIndexes(P: TPoint;
      var ARowIndex, AColumnIndex: Integer); virtual;
    procedure BeforeBeginDragAndDrop; override;
  ...
  protected
    procedure AdjustRowAndColumnIndexes(P: TPoint;
      var ARowIndex, AColumnIndex: Integer); override;
    procedure BeforeBeginDragAndDrop; override;
    procedure BeginDragAndDrop; override;
  ...
  TdxSpreadSheetTableViewEditingCellReferenceHighlighter = class
    (TdxSpreadSheetTableViewReferenceHighlighter)
  strict private
  ...
  TdxSpreadSheetTableViewCustomSelectionDragAndDropObject = class
    (TdxSpreadSheetCustomTableViewDragAndDropObject)
  strict private
  ...
  protected
    ...
    procedure HistoryActionBegin(AActionClass
  ...
  TdxSpreadSheetTableViewAutoFillDragAndDropObject = class
    (TdxSpreadSheetTableViewCustomSelectionDragAndDropObject)
  protected
    ...
    function GetDragAndDropCursor(Accepted: Boolean): TCursor; override;
  public
    class function CalculateDirection(const ASourceArea, ATargetArea: TRect)
      : TcxDirection; overload;
    class function CalculateDirection(const ASourceArea: TRect;
      ARow, AColumn: Integer): TcxDirection; overload;
  end;

  { TdxSpreadSheetTableViewMoveSelectionDragAndDropObject }

  TdxSpreadSheetTableViewMoveSelectionDragAndDropObject = class
    (TdxSpreadSheetTableViewCustomSelectionDragAndDropObject)
  protected
    procedure ApplyChanges; override;
  ...
  TdxSpreadSheetTableViewCustomSelectionViewInfo = class
  ...
  TdxSpreadSheetTableViewSelectionFrameViewInfo = class
    (TdxSpreadSheetTableViewCustomSelectionViewInfo)
  strict private
    FCorner: TdxCorner;
  protected
  ...
  TdxSpreadSheetTableViewCustomPrintAreaViewInfo = class
    (TdxSpreadSheetTableViewCustomSelectionViewInfo)
  protected
    procedure DrawCore(ACanvas: TcxCanvas; const R: TRect;
      AStage: TdxSpreadSheetDrawingStage); virtual; abstract;
  ...
  TdxSpreadSheetTableViewPageBreakViewInfo = class
    (TdxSpreadSheetTableViewCustomPrintAreaViewInfo)
  strict private
  ...
  TdxSpreadSheetTableViewPrintAreaViewInfo = class
    (TdxSpreadSheetTableViewCustomPrintAreaViewInfo)
  protected
    procedure CalculateBounds; override;
    function InitHitTest(AHitTest: TdxSpreadSheetCustomHitTest)
...
uses
  SysUtils, Math,
  dxSpreadSheetUtils, dxSpreadSheetTypes, dxSpreadSheetClasses,
  dxSpreadSheetStrs, Forms,
  dxTypeHelpers, dxHashUtils, dxSpreadSheetCoreHelpers, cxLibraryConsts,
  dxSpreadSheetAutoFilling,
  dxSpreadSheetCoreFormulas, dxSpreadSheetCoreStrs, cxLookAndFeelPainters,
...
type
  ...
  TdxSpreadSheetTableViewEditingControllerAccess = class
    (TdxSpreadSheetTableViewEditingController);
  TWinControlAccess = class(TWinControl);

  { TdxSpreadSheetCustomTableViewDragAndDropObject }

function TdxSpreadSheetCustomTableViewDragAndDropObject.GetHitTest
  : TdxSpreadSheetTableViewHitTest;
begin
  Result := View.HitTest;
end;

function TdxSpreadSheetCustomTableViewDragAndDropObject.GetView
...
begin
  ...
  FReferences :=
    TObjectList<TdxSpreadSheetTableViewReferenceHighlighterItem>.Create;
...
procedure TdxSpreadSheetTableViewReferenceHighlighter.Calculate
  (const AEdit: TcxCustomEdit);
begin
  if AEdit.HandleAllocated and not TWinControlAccess(AEdit.InnerControl).FInImeComposition
  then
  begin
...
begin
  ...
  for I := 0 to References.Count - 1 do
    ReferenceColors.AddOrSetValue(References[I].Area,
      Colors[ReferenceColors.Keys.Count]);
end;
...
function TdxSpreadSheetTableViewReferenceHighlighter.GetCursor
...
procedure TdxSpreadSheetTableViewReferenceHighlighter.HighlightReferences
  (AEdit: TcxCustomRichEdit);

  procedure ApplyColor(const AItem
    : TdxSpreadSheetTableViewReferenceHighlighterItem);
  begin
...
begin
  ...
  try
    ...
    try
      AEdit.SelectAll;
      AEdit.SelAttributes.Color := TcxCustomRichEditAccess(AEdit)
...
begin
  FColorPalette.Clear;
  AValue := TdxColorSpaceConverter.ColorToHSL
    (View.SpreadSheet.LookAndFeel.Painter.SpreadSheetSelectionColor);
  ...
  begin
    AValue.H := TdxColorSpaceConverter.ColorToHSL
      (dxSpreadSheetSelectionColors[I]).H;
    FColorPalette.Add(TdxColorSpaceConverter.HSLToColor(AValue));
  end;
end;

function TdxSpreadSheetTableViewReferenceHighlighter.CanDraw(ACanvas: TcxCanvas;
  AStage: TdxSpreadSheetDrawingStage): Boolean;
begin
  Result := (AStage = dsSecond) and (References.Count > 0);
end;

procedure TdxSpreadSheetTableViewReferenceHighlighter.DoDraw
  (ACanvas: TcxCanvas);
var
...
begin
  ...
  try
    ABackgroundColor := TdxSpreadSheetTableViewAccess(View)
      .ViewInfo.ContentParams.Color;
    for I := 0 to References.Count - 1 do
    begin
      AReference := References[I];
      TdxSpreadSheetSelectionHelper.Draw(ACanvas, AReference.DisplayBounds,
        ReferenceColors.Items[AReference.Area], ABackgroundColor, [ssseCorners],
        [coTopLeft .. coBottomRight]);
    end;
    for I := 0 to References.Count - 1 do
    begin
      AReference := References[I];
      TdxSpreadSheetSelectionHelper.Draw(ACanvas, AReference.DisplayBounds,
        ReferenceColors.Items[AReference.Area], ABackgroundColor,
        [ssseFrame, ssseBackground], []);
    end;
  finally
...
function TdxSpreadSheetTableViewReferenceHighlighter.GetAreaBounds
  (const AArea: TRect): TRect;
begin
  Result := TdxSpreadSheetTableViewInfoAccess
    (TdxSpreadSheetTableViewAccess(View).ViewInfo).GetAreaBounds(AArea);
end;
...
function TdxSpreadSheetTableViewReferenceHighlighter.GetSpreadSheet
  : TdxCustomSpreadSheet;
begin
  Result := View.SpreadSheet;
end;

function TdxSpreadSheetTableViewReferenceHighlighter.InitHitTest
...
begin
  ...
  begin
    ...
    if PtInRect(cxRectInflate(ARect, FrameHitTestZoneSize div 2),
      AHitTest.ActualHitPoint) and
      not PtInRect(cxRectInflate(ARect, -FrameHitTestZoneSize div 2),
      AHitTest.ActualHitPoint) then
    begin
...
function TdxSpreadSheetTableViewReferenceHighlighter.GetColor
  (Index: Integer): TColor;
begin
  Result := FColorPalette[Index mod FColorPalette.Count];
end;

function TdxSpreadSheetTableViewReferenceHighlighter.GetView
  : TdxSpreadSheetTableView;
begin
...
procedure TdxSpreadSheetTableViewReferenceHighlighterCustomDragAndDropObject.
  AdjustRowAndColumnIndexesByMergedCells(var ARowIndex, AColumnIndex: Integer);
begin
...
function TdxSpreadSheetTableViewReferenceHighlighterCustomDragAndDropObject.
  CheckForContentRect(const P: TPoint): TPoint;
begin
...
procedure TdxSpreadSheetTableViewReferenceHighlighterCustomDragAndDropObject.
  CheckRowAndColumnIndexes(var ARowIndex, AColumnIndex: Integer);
begin
...
procedure TdxSpreadSheetTableViewReferenceHighlighterCustomDragAndDropObject.
  DragAndDrop(const P: TPoint; var Accepted: Boolean);
begin
  inherited DragAndDrop(P, Accepted);
  TdxSpreadSheetTableViewControllerAccess(View.Controller)
    .CheckScrollArea(cxPointScale(GetClientCursorPos, 100, ZoomFactor));
end;

procedure TdxSpreadSheetTableViewReferenceHighlighterCustomDragAndDropObject.
  EndDragAndDrop(Accepted: Boolean);
begin
...
function TdxSpreadSheetTableViewReferenceHighlighterCustomDragAndDropObject.
  GetCellAtAbsolutePoint(const P: TPoint;
...
function TdxSpreadSheetTableViewReferenceHighlighterCustomDragAndDropObject.
  TranslateCoords(const P: TPoint): TPoint;
begin
  Result := cxPointOffset(inherited TranslateCoords(P), ContentOrigin);
end;

procedure TdxSpreadSheetTableViewReferenceHighlighterCustomDragAndDropObject.
  UpdateReference(AReference: TRect; AForce: Boolean = False);
var
  AFormulaText: string;
  AIndexDelta: Integer;
...
begin
  ...
  begin
    AReferenceAsString := dxReferenceToString(AReference,
      Control.OptionsView.R1C1Reference, Highlighter.Cell.RowIndex,
      Highlighter.Cell.ColumnIndex);

    AIndexDelta := Length(AReferenceAsString) - Reference.Length;
    AFormulaText := TdxSpreadSheetTableViewEditingController.
      GetEditingText(Edit);
    AFormulaText := Copy(AFormulaText, 1, Reference.PositionInText - 1) +
      AReferenceAsString + Copy(AFormulaText, Reference.PositionInText +
      Reference.Length, MaxInt);
    ...
    try
      ...
      if Edit is TcxCustomTextEdit then
        TcxCustomTextEdit(Edit).SelStart := Reference.PositionInText +
          Reference.Length - 1;
      ...
      TdxSpreadSheetTableViewEditingControllerAccess
        (TdxSpreadSheetTableViewAccess(View).EditingController)
        .UpdateEditPosition;
    end;
...
function TdxSpreadSheetTableViewReferenceHighlighterCustomDragAndDropObject.
  GetEdit: TcxCustomEdit;
begin
  Result := TdxSpreadSheetTableViewAccess(View).EditingController.Edit;
end;

function TdxSpreadSheetTableViewReferenceHighlighterCustomDragAndDropObject.
  GetHighlighter: TdxSpreadSheetTableViewReferenceHighlighter;
begin
  Result := TdxSpreadSheetTableViewAccess(View)
    .ViewInfo.ReferenceHighlighter as
    TdxSpreadSheetTableViewReferenceHighlighter;
end;

{ TdxSpreadSheetTableViewReferenceHighlighterMoveDragAndDropObject }

procedure TdxSpreadSheetTableViewReferenceHighlighterMoveDragAndDropObject.
  BeginDragAndDrop;
var
  ACellRef: TPoint;
begin
  inherited BeginDragAndDrop;
  ACellRef := EnsureCellInArea(GetCellAtAbsolutePoint(CapturePoint),
    Reference.Area);
...
begin
  ...
  ARowIndex := Min(ARowIndex, dxSpreadSheetMaxRowCount - dxSpreadSheetAreaHeight
    (Reference.Area));
  AColumnIndex := Min(AColumnIndex, dxSpreadSheetMaxColumnCount -
    dxSpreadSheetAreaWidth(Reference.Area));
end;
...
procedure TdxSpreadSheetTableViewReferenceHighlighterResizeDragAndDropObject.
  AdjustRowAndColumnIndexes(P: TPoint; var ARowIndex, AColumnIndex: Integer);

  procedure AdjustIndex(var AIndex: Integer; X, ACenterX: Integer;
    AIsForwardCorner: Boolean);
  begin
...
begin
  ...
  AdjustIndex(AColumnIndex, P.X, ACellCenter.X,
    (Corner in [coTopRight, coBottomRight]) = (FCellsArea.Width >= 0));
  AdjustIndex(ARowIndex, P.Y, ACellCenter.Y,
    (Corner in [coBottomLeft, coBottomRight]) = (FCellsArea.Height >= 0));
  AdjustRowAndColumnIndexesByMergedCells(ARowIndex, AColumnIndex);
end;
...
function TdxSpreadSheetTableViewReferenceHighlighterResizeDragAndDropObject.
  CalculateReference(ARowIndex, AColumnIndex: Integer): TRect;
const
  HorzMirror: array [TdxCorner] of TdxCorner = (coBottomLeft, coBottomRight,
    coTopLeft, coTopRight);
  VertMirror: array [TdxCorner] of TdxCorner = (coTopRight, coTopLeft,
...
procedure TdxSpreadSheetTableViewReferenceHighlighterAddAreaDragAndDropObject.
  AdjustRowAndColumnIndexes(P: TPoint; var ARowIndex, AColumnIndex: Integer);
begin
  // do nothing
end;
...
begin
  ...
  while (AIndex >= 0) and (Highlighter.References[AIndex].PositionInText >=
    ACursorPos) do
    Dec(AIndex);
  ...
  begin
    ...
    if InRange(ACursorPos, AItem.PositionInText, AItem.PositionInText +
      AItem.Length - 1) then
  ...
  if (AColumn < 0) or (ARow < 0) then
    raise EdxSpreadSheetError.CreateFmt(cxGetResourceString(@sdxErrorInternal),
      [ClassName]);
...
function TdxSpreadSheetTableViewEditingCellReferenceHighlighter.GetCell
  : TdxSpreadSheetCell;
begin
...
function TdxSpreadSheetTableViewEditingCellReferenceHighlighter.
  GetEditingController: TdxSpreadSheetTableViewEditingController;
begin
...
function TdxSpreadSheetTableViewCustomSelectionDragAndDropObject.
  DoProcessKeyDown(var Message: TWMKey): Boolean;
begin
  case Message.CharCode of
    VK_MENU, VK_LMENU, VK_RMENU, VK_SHIFT, VK_LSHIFT, VK_RSHIFT, VK_CONTROL,
...
procedure TdxSpreadSheetTableViewCustomSelectionDragAndDropObject.
  HistoryActionBegin(AActionClass: TdxSpreadSheetHistoryActionClass);
var
...
function TdxSpreadSheetTableViewCustomSelectionDragAndDropObject.HasDataInArea
...
procedure TdxSpreadSheetTableViewCustomSelectionDragAndDropObject.EndDragAndDrop
  (Accepted: Boolean);
begin
  try
...
function TdxSpreadSheetTableViewCustomSelectionDragAndDropObject.
  GetClipboardArea: TdxSpreadSheetClipboardArea;
begin
  Result := TdxCustomSpreadSheetAccess(Control).ClipboardArea;
end;

function TdxSpreadSheetTableViewCustomSelectionDragAndDropObject.
  GetOriginalArea: TRect;
begin
...
class function TdxSpreadSheetTableViewAutoFillDragAndDropObject.
  CalculateDirection(const ASourceArea, ATargetArea: TRect): TcxDirection;
begin
  ...
  else if cxPointIsEqual(ASourceArea.TopLeft, ATargetArea.TopLeft) then
    Result := CalculateDirection(ASourceArea, ATargetArea.Bottom,
      ATargetArea.Right)
  else
    Result := dirNone;
end;
...
class function TdxSpreadSheetTableViewAutoFillDragAndDropObject.
  CalculateDirection(const ASourceArea: TRect; ARow, AColumn: Integer)
  : TcxDirection;
...
begin
  ...
  else if ARow < ASourceArea.Top then
    Result := dirUp
  else
    Result := dirDown
end;
...
function TdxSpreadSheetTableViewAutoFillDragAndDropObject.
  CalculateTargetSelection(ARow, AColumn: Integer): TRect;
begin
  Result := OriginalArea;
  case FDirection of
    dirLeft:
...
procedure TdxSpreadSheetTableViewAutoFillDragAndDropObject.DragAndDrop
  (const P: TPoint; var Accepted: Boolean);
var
  ACursorPos: TPoint;
begin
  ACursorPos := GetClientCursorPos;
  CheckScrollArea(ACursorPos);
  HitTest.Calculate(ACursorPos);
  ...
  begin
    ...
    UpdateSelection(CalculateTargetSelection(TdxSpreadSheetTableViewCellViewInfo
      (HitTest.HitObject).Row, TdxSpreadSheetTableViewCellViewInfo
      (HitTest.HitObject).Column));
  end;
...
function TdxSpreadSheetTableViewAutoFillDragAndDropObject.GetDragAndDropCursor
...
procedure TdxSpreadSheetTableViewMoveSelectionDragAndDropObject.
  CheckCanApplyChanges(AMoveMode: Boolean);
  ...
  begin
    if (View.Controller.FocusedContainer <> nil) or (View.Selection.Count <> 1)
    then
...
begin
  ...
  begin
    if MessageDlg(cxGetResourceString(@sdxReplaceCellsDataConfirmation),
      mtConfirmation, [mbOK, mbCancel], 0) = mrCancel then
      Abort;
  end;
end;

procedure TdxSpreadSheetTableViewMoveSelectionDragAndDropObject.DragAndDrop
  (const P: TPoint; var Accepted: Boolean);
var
  AArea: TRect;
  ADelta: TPoint;
begin
  ...
  if Accepted then
  begin
    ADelta := cxPointOffset(GetCellAtAbsolutePoint(ToAbsolutePoint(P)),
      CapturedCell, False);
    ...
    AArea := cxRectBounds(AArea.Left, AArea.Top, cxRectWidth(OriginalArea),
      cxRectHeight(OriginalArea));
...
function TdxSpreadSheetTableViewMoveSelectionDragAndDropObject.
  GetDragAndDropCursor(Accepted: Boolean): TCursor;
begin
  Result := crSizeAll;
end;
...
function TdxSpreadSheetTableViewCustomSelectionViewInfo.GetView
...
constructor TdxSpreadSheetTableViewSelectionFrameViewInfo.Create
  (AOwner: TObject);
begin
  inherited;
  FCorner := coBottomRight;
...
procedure TdxSpreadSheetTableViewSelectionFrameViewInfo.Draw(ACanvas: TcxCanvas;
...
function TdxSpreadSheetTableViewSelectionFrameViewInfo.GetCursor
  (AHitTest: TdxSpreadSheetCustomHitTest): TCursor;
begin
  if (AHitTest.HitObjectData = 0) and CanMoveSelection then
    Result := crSizeAll
  else if (AHitTest.HitObjectData <> 0) and CanFillData then
    Result := crdxSpreadSheetCross
  else
    Result := inherited GetCursor(AHitTest);
end;

function TdxSpreadSheetTableViewSelectionFrameViewInfo.CanDraw
  (ACanvas: TcxCanvas; AStage: TdxSpreadSheetDrawingStage): Boolean;
begin
  Result := inherited CanDraw(ACanvas, AStage) and TdxSpreadSheetTableViewAccess
    (View).ViewInfo.CanDrawCellSelection;
end;

function TdxSpreadSheetTableViewSelectionFrameViewInfo.CanFillData: Boolean;
begin
  Result := TdxSpreadSheetTableViewAccess(View).CanFillData and
    SpreadSheet.OptionsBehavior.DragFilling;
end;

function TdxSpreadSheetTableViewSelectionFrameViewInfo.CanMoveSelection
  : Boolean;
begin
  Result := SpreadSheet.OptionsBehavior.DragMoving and
    SpreadSheet.OptionsBehavior.Editing and
...
function TdxSpreadSheetTableViewSelectionFrameViewInfo.InitHitTest
  (AHitTest: TdxSpreadSheetCustomHitTest): Boolean;
var
  ACornerBounds: TRect;
begin
  ...
  begin
    ...
    begin
      ...
      ACornerBounds := cxRectCenter(ACornerBounds,
        dxSpreadSheetCornetHitTestZoneSize, dxSpreadSheetCornetHitTestZoneSize);
      TdxSpreadSheetCustomHitTestAccess(AHitTest).HitObject := Self;
      TdxSpreadSheetCustomHitTestAccess(AHitTest).HitObjectData :=
        Ord(PtInRect(ACornerBounds, AHitTest.ActualHitPoint));
      TdxSpreadSheetCustomHitTestAccess(AHitTest)
        .SetHitCode(hcSelectionFrame, True);
    end;
  end;
end;

procedure TdxSpreadSheetTableViewSelectionFrameViewInfo.RightToLeftConversion
...
procedure TdxSpreadSheetTableViewCustomPrintAreaViewInfo.Draw
  (ACanvas: TcxCanvas; AStage: TdxSpreadSheetDrawingStage);
var
  ABounds: TRect;
  APrevForm: TXForm;
begin
...
function TdxSpreadSheetTableViewCustomPrintAreaViewInfo.
  GetBackgroundColor: TColor;
begin
...
begin
  Result := cxGetActualColor(SpreadSheet.OptionsView.PrintAreaColor,
    LookAndFeelPainter.SpreadSheetContentTextColor);
end;

function TdxSpreadSheetTableViewCustomPrintAreaViewInfo.GetBorderStyle
...
procedure TdxSpreadSheetTableViewPageBreakViewInfo.DrawCore(ACanvas: TcxCanvas;
const R: TRect; AStage: TdxSpreadSheetDrawingStage);
begin
  dxSpreadSheetDrawBorder(ACanvas, R, Color, BackgroundColor, BorderStyle,
    Horizontal);
end;
...
function TdxSpreadSheetTableViewPrintAreaViewInfo.InitHitTest
  (AHitTest: TdxSpreadSheetCustomHitTest): Boolean;
begin
  Result := TdxSpreadSheetSelectionHelper.IsInFrame(Bounds,
    AHitTest.ActualHitPoint);
...
procedure TdxSpreadSheetTableViewPrintAreaViewInfo.DrawCore(ACanvas: TcxCanvas;
const R: TRect; AStage: TdxSpreadSheetDrawingStage);
begin
