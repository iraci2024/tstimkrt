...
uses
  ...
  dxLayoutControlAdapters, dxLayoutContainer, cxRadioGroup, cxLabel, cxCheckBox,
  dxLayoutControl,
...
type
  ...
  TcxGridWizardTableViewOptionsInplaceEditFormPageFrame = class
...
procedure TcxGridWizardTableViewOptionsInplaceEditFormPageFrame.
  ApplyLocalization;
begin
  lbStretch.Caption := cxGetResourceString
  ...
  rbHorizontal.Caption := cxGetResourceString
    (@scxgwInplaceEditFormPageHorizontal);
  ...
  lbMasterRowDblClickAction.Caption :=
    cxGetResourceString(@scxgwInplaceEditFormPageMasterRowDblClickAction);

  rbShowEditForm.Caption := cxGetResourceString
    (@scxgwInplaceEditFormPageShowEditForm);
  rbShowEditForm.Hint := cxGetResourceString
    (@scxgwInplaceEditFormPageShowEditFormHint);

  rbSwitchExpandedState.Caption :=
    cxGetResourceString(@scxgwInplaceEditFormPageSwitchExpandedState);
  rbSwitchExpandedState.Hint := cxGetResourceString
    (@scxgwInplaceEditFormPageSwitchExpandedStateHint);

  chbUseDefaultLayout.Caption := cxGetResourceString
    (@scxgwInplaceEditFormPageUseDefaultLayout);
  chbUseDefaultLayout.Hint := cxGetResourceString
    (@scxgwInplaceEditFormPageUseDefaultLayoutHint);

  lciDefaultColumnCount.Caption :=
    cxGetResourceString(@scxgwInplaceEditFormPageDefaultColumnCount);
  seDefaultColumnCount.Hint := cxGetResourceString
...
begin
  ...
  else if rbHorizontal.Checked then
...
begin
  Visible := TcxGridTableView(Helper.GridView).OptionsBehavior.EditMode <>
    emInplace;
end;
...
begin
  ...
  rbShowEditForm.Checked := AView.EditForm.MasterRowDblClickAction =
    dcaShowEditForm;
  rbSwitchExpandedState.Checked := AView.EditForm.MasterRowDblClickAction =
...
function TcxGridWizardTableViewOptionsInplaceEditFormPageFrame.
...
procedure TcxGridWizardTableViewOptionsInplaceEditFormPageFrame.
  chbUseDefaultLayoutPropertiesChange(Sender: TObject);
begin
  RefreshPreviewGridContent;
  seDefaultColumnCount.Enabled := chbUseDefaultLayout.Checked;
end;
