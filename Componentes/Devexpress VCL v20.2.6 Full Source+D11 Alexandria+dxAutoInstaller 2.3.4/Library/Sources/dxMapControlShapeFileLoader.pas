...
uses
  Types, Classes, Graphics, SysUtils, Math, RTLConsts, Generics.Defaults,
  Generics.Collections,
  cxGraphics, cxGeometry, dxCore, dxCoreClasses, dxGDIPlusClasses,
  dxCoreGraphics,
  dxMapItem, dxMapControlTypes, dxMapItemFileLayer, dxShapeFileInfo,
  dxDbfFileInfo;
...
type
  ...
  protected
    procedure CreateAttributes(AMapItem: TdxMapItem;
  ...
  public
    ...
    procedure Convert(AShapeFileRecord: TdxShapeFileRecord;
      ADbfFileRecord: TdxDbfFileRecord); virtual; abstract;
  end;

  TdxMapControlShapeFileRecordConverterClass = class of
    TdxMapControlShapeFileRecordConverter;

  TdxMapControlShapeFilePointRecordConverter = class
    (TdxMapControlShapeFileRecordConverter)
  protected
    class function GetRecordClass: TdxShapeFileRecordClass; override;
    function GetPointLocation(ARecord: TdxShapeFileRecord)
      : TdxMapControlGeoPoint; virtual;
  public
    procedure Convert(AShapeFileRecord: TdxShapeFileRecord;
      ADbfFileRecord: TdxDbfFileRecord); override;
  end;

  TdxMapControlShapeFileMultiPointRecordConverter = class
    (TdxMapControlShapeFileRecordConverter)
  protected
    function GetPointCount(ARecord: TdxShapeFileRecord): Integer; virtual;
    function GetPointLocation(ARecord: TdxShapeFileRecord; APointIndex: Integer)
      : TdxMapControlGeoPoint; virtual;
    class function GetRecordClass: TdxShapeFileRecordClass; override;
  public
    procedure Convert(AShapeFileRecord: TdxShapeFileRecord;
  ...
  TdxMapControlShapeFilePolylineRecordConverter = class
    (TdxMapControlShapeFileRecordConverter)
  protected
    function GetPointCount(ARecord: TdxShapeFileRecord): Integer; virtual;
    function GetPointLocation(ARecord: TdxShapeFileRecord; APointIndex: Integer)
    ...
    function GetPart(ARecord: TdxShapeFileRecord; AIndex: Integer)
      : Integer; virtual;
    class function GetRecordClass: TdxShapeFileRecordClass; override;
  ...
  TdxMapControlShapeFilePolygonRecordConverter = class
  ...
  TdxMapControlShapeFilePointMRecordConverter = class
    (TdxMapControlShapeFilePointRecordConverter)
  protected
    function GetPointLocation(ARecord: TdxShapeFileRecord)
      : TdxMapControlGeoPoint; override;
    class function GetRecordClass: TdxShapeFileRecordClass; override;
  end;

  TdxMapControlShapeFileMultiPointMRecordConverter = class
  ...
  TdxMapControlShapeFilePolylineMRecordConverter = class
    (TdxMapControlShapeFilePolylineRecordConverter)
  protected
    function GetPointCount(ARecord: TdxShapeFileRecord): Integer; override;
    function GetPointLocation(ARecord: TdxShapeFileRecord; APointIndex: Integer)
  ...
  TdxMapControlShapeFilePolygonMRecordConverter = class
...
type
  ...
  private
    FItems: TdxFastList;
    FConvertersCache: TObjectDictionary<TdxShapeFileRecordClass,
      TdxMapControlShapeFileRecordConverter>;
    procedure RegisterConverter(AConverterClass
      : TdxMapControlShapeFileRecordConverterClass);
  public
    constructor Create;
    destructor Destroy; override;
    function GetConverter(ARecord: TdxShapeFileRecord)
      : TdxMapControlShapeFileRecordConverter;
    procedure InitializeConverters(ALoader: TdxMapControlShapeFileLoader);
    procedure FinalizeConverters;
    procedure RegisterConverters(AConverterClasses
      : array of TdxMapControlShapeFileRecordConverterClass);
  end;
...
begin
  if not FConvertersCache.TryGetValue
    (TdxShapeFileRecordClass(ARecord.ClassType), Result) then
    Result := nil;
end;
...
begin
  FConvertersCache := TObjectDictionary<TdxShapeFileRecordClass,
    TdxMapControlShapeFileRecordConverter>.Create([doOwnsValues]);
  for I := 0 to FItems.Count - 1 do
  begin
    AConverterClass := TdxMapControlShapeFileRecordConverterClass(FItems[I]);
    FConvertersCache.Add(AConverterClass.GetRecordClass,
      AConverterClass.Create(ALoader));
  end;
end;
...
var
  FShapeFileRecordsConverterFactory
    : TdxMapControlShapeFileRecordsConverterFactory;

function dxMapControlShapeFileRecordsConverters
  : TdxMapControlShapeFileRecordsConverterFactory;
begin
  if FShapeFileRecordsConverterFactory = nil then
    FShapeFileRecordsConverterFactory :=
      TdxMapControlShapeFileRecordsConverterFactory.Create;
...
begin
  ...
  try
    ...
    try
      ...
      begin
        AConverter := dxMapControlShapeFileRecordsConverters.GetConverter
          (AShapeFileRecord);
        if AConverter <> nil then
        begin
          ADbfFileRecord := ADbfFileInfo.Records
            [AShapeFileRecord.RecordNumber - 1];
...
procedure TdxMapControlShapeFilePointRecordConverter.Convert(AShapeFileRecord
  : TdxShapeFileRecord; ADbfFileRecord: TdxDbfFileRecord);
var
  AMapDot: TdxMapDot;
begin
...
class function TdxMapControlShapeFilePointRecordConverter.GetRecordClass
  : TdxShapeFileRecordClass;
begin
    ...
    case Char(AField.FieldType) of
      ...
      'N':
        begin
          ...
          else if AField.FieldLengthInBytes > 9 then
          begin
...
class function TdxMapControlShapeFileRecordConverter.GetRecordClass
  : TdxShapeFileRecordClass;
begin
  Result := nil;
end;
...
procedure TdxMapControlShapeFilePolylineRecordConverter.Convert(AShapeFileRecord
  : TdxShapeFileRecord; ADbfFileRecord: TdxDbfFileRecord);
var
...
begin
  ...
  begin
    ...
    AEndPointIndex := IfThen(I < APartCount - 1, GetPart(AShapeFileRecord,
      I + 1) - 1, APointCount - 1);
...
class function TdxMapControlShapeFilePolylineRecordConverter.GetRecordClass
  : TdxShapeFileRecordClass;
begin
  Result := TdxShapeFilePolylineRecord;
end;

function TdxMapControlShapeFilePolylineRecordConverter.GetSegmentType
  : TdxMapSegmentType;
begin
  Result := mstPolyline;
end;
...
class function TdxMapControlShapeFilePolygonRecordConverter.GetRecordClass
  : TdxShapeFileRecordClass;
begin
  Result := TdxShapeFilePolygonRecord;
end;

function TdxMapControlShapeFilePolygonRecordConverter.GetSegmentType
  : TdxMapSegmentType;
begin
  Result := mstPolygon;
end;
...
function TdxMapControlShapeFileMultiPointRecordConverter.GetPointCount
  (ARecord: TdxShapeFileRecord): Integer;
begin
...
class function TdxMapControlShapeFileMultiPointRecordConverter.GetRecordClass
  : TdxShapeFileRecordClass;
begin
...
class function TdxMapControlShapeFilePointMRecordConverter.GetRecordClass
  : TdxShapeFileRecordClass;
begin
...
class function TdxMapControlShapeFileMultiPointMRecordConverter.GetRecordClass
  : TdxShapeFileRecordClass;
begin
...
class function TdxMapControlShapeFilePolylineMRecordConverter.GetRecordClass
  : TdxShapeFileRecordClass;
begin
...
class function TdxMapControlShapeFilePolygonMRecordConverter.GetRecordClass
  : TdxShapeFileRecordClass;
begin
...
dxMapControlShapeFileRecordsConverters.RegisterConverters
  ([TdxMapControlShapeFilePointRecordConverter,
  TdxMapControlShapeFileMultiPointRecordConverter,
  TdxMapControlShapeFilePolylineRecordConverter,
  TdxMapControlShapeFilePolygonRecordConverter,
