...
{$ENDIF}
  ...
  dxLayoutControl, dxLayoutContainer, dxBase, dxPrnPg, dxPSCore,
  dxPSContainerLnk, cxDrawTextUtils,
...
type
  ...
  TdxLCCacheItemKind = (ikLayoutItem, ikLayoutGroup, ikLayoutItemCaption,
    ikControl);
  ...
  protected
    ...
    procedure DoDrawByFormattedText
  ...
  TdxReportLayoutCaptionImageCellClass = class of
    TdxReportLayoutCaptionImageCell;
  ...
  protected
    ...
    function CreateImageCell(AReportLink: TBasedxReportLink)
      : TdxReportLayoutCaptionImageCell; virtual;
    function CreateTextCell(AReportLink: TBasedxReportLink)
      : TdxReportLayoutCaptionTextCell; virtual;
    function GetReportLayoutCaptionImageCellClass
      : TdxReportLayoutCaptionImageCellClass; virtual;
    function GetReportLayoutCaptionTextCellClass
      : TdxReportLayoutCaptionTextCellClass; virtual;
  ...
  TdxReportCustomLayoutCaptionCellClass = class of
    TdxReportCustomLayoutCaptionCell;

  TdxCustomReportLayoutItemClass = class of TdxCustomReportLayoutItem;

  TdxLCGetLayoutItemViewInfoEvent = procedure(AItem: TdxCustomLayoutItem;
    var AViewInfo: TdxCustomLayoutItemViewInfo) of object;
  ...
  protected
    procedure AdjustBounds(ACanvas: TdxPSReportRenderCustomCanvas); virtual;
    procedure Initialize(AReportLink: TBasedxReportLink); virtual;
    function GetCaptionCellClass
      : TdxReportCustomLayoutCaptionCellClass; virtual;
    function CreateCaptionCell(AReportLink: TBasedxReportLink)
      : TdxReportCustomLayoutCaptionCell; virtual;
  ...
  public
    ...
    property OnGetLayoutItemViewInfo: TdxLCGetLayoutItemViewInfoEvent
      read FOnGetLayoutItemViewInfo write FOnGetLayoutItemViewInfo;
  end;
  ...
  protected
    function CreateTextCell(AReportLink: TBasedxReportLink)
      : TdxReportLayoutCaptionTextCell; override;
    function CreateImageCell(AReportLink: TBasedxReportLink)
      : TdxReportLayoutCaptionImageCell; override;
    function GetReportLayoutCaptionImageCellClass
      : TdxReportLayoutCaptionImageCellClass; override;
    function GetReportLayoutCaptionTextCellClass
      : TdxReportLayoutCaptionTextCellClass; override;
  public
  ...
  TdxPSReportLayoutGroupStandardLookAndFeelPainter = class
    (TdxPSReportGroupStandardLookAndFeelPainter)
  protected
    procedure DrawCaptionText(ACanvas: TdxPSReportRenderCustomCanvas); override;
  public
    function LookAndFeel: TdxPSReportLayoutGroupStandardLookAndFeel;
      overload; virtual;
  end;
  ...
  TdxPSReportLayoutGroupOfficeLookAndFeel = class
  ...
  protected
    ...
    function GetCaptionCellClass
      : TdxReportCustomLayoutCaptionCellClass; override;
  ...
  protected
    ...
    procedure Initialize(AReportLink: TBasedxReportLink); override;
    function NeedCreateCaptionCell: Boolean; override;
    function CreateSeparatorCell(AReportLink: TBasedxReportLink)
  ...
  TdxReportLayoutLabeledItemCaptionCell = class
    (TdxReportCustomLayoutCaptionCell)
  private
  ...
  TdxReportLayoutSeparatorCaptionTextCell = class
    (TdxReportLayoutCaptionTextCell)
  private
    FIsVertical: Boolean;
  ...
  TdxReportLayoutSeparatorItemCaptionCell = class
    (TdxReportCustomLayoutCaptionCell)
  protected
    function CreateTextCell(AReportLink: TBasedxReportLink)
      : TdxReportLayoutCaptionTextCell; override;
  ...
  protected
    ...
    function CreateControlCell(AReportLink: TdxLayoutControlReportLink)
  ...
  public
    function OptionsPagination: TdxLayoutControlReportLinkOptionsPagination;
  ...
  protected
    ...
    procedure InitializeReportLookAndFeel(ALookAndFeel
      : TdxPSReportGroupLookAndFeel); virtual;
    class function ReportLookAndFeelClass
      : TdxPSReportGroupLookAndFeelClass; virtual;

    property GroupCaptionColor: TColor read GetGroupCaptionColor;
    property IsGroupCaptionTransparent: Boolean
      read GetIsGroupCaptionTransparent;
  public
    function LayoutLookAndFeel: TdxCustomLayoutLookAndFeel; overload; virtual;
    class function LayoutLookAndFeelClass
      : TdxCustomLayoutLookAndFeelClass; virtual;
  ...
  protected
    ...
    class function ReportLookAndFeelClass
      : TdxPSReportGroupLookAndFeelClass; override;
  public
    function LayoutLookAndFeel: TdxLayoutStandardLookAndFeel;
      reintroduce; overload;
    class function LayoutLookAndFeelClass
      : TdxCustomLayoutLookAndFeelClass; override;
  end;

  TdxPSLayoutOfficeLookAndFeelProducer = class
    (TdxPSLayoutStandardLookAndFeelProducer)
  protected
    class function ReportLookAndFeelClass
      : TdxPSReportGroupLookAndFeelClass; override;
  public
    function LayoutLookAndFeel: TdxLayoutOfficeLookAndFeel;
      reintroduce; overload;
    class function LayoutLookAndFeelClass
      : TdxCustomLayoutLookAndFeelClass; override;
  end;
  ...
  protected
    ...
    function GetTransparentColor: TColor; override;
    procedure InitializeReportLookAndFeel(ALookAndFeel
      : TdxPSReportGroupLookAndFeel); override;
    class function ReportLookAndFeelClass
      : TdxPSReportGroupLookAndFeelClass; override;
  public
  ...
  protected
    ...
    function OptionsTransparent: TdxLayoutControlReportLinkOptionsTransparent;
      reintroduce; overload;
  ...
  public
    ...
    property LayoutLookAndFeelProducer: TdxPSLayoutLookAndFeelProducer
      read GetLayoutLookAndFeelProducer;
  end;
  ...
  TdxPSLayoutRadioButtonItemProducer = class
    (TdxPSLayoutCustomLabeledItemProducer)
  protected
    class function ReportItemClass: TdxReportCellClass; override;
  public
    class function LayoutItemClass: TdxCustomLayoutItemClass; override;
  ...
  TdxPSCustomLayoutObjectProducerCache = class
  ...
  public
    property Producers[AProducerClass: TdxPSCustomLayoutItemProducerClass;
      ALayoutItem: TdxCustomLayoutItem]: TdxPSCustomLayoutItemProducer
      read GetProducer; default;
  end;

  TdxPSLayoutLookAndFeelProducerCache = class
  ...
  private
    ...
    function GetProducer(AProducerClass: TdxPSLayoutLookAndFeelProducerClass;
      ALayoutLookAndFeel: TdxCustomLayoutLookAndFeel)
  ...
  public
    property Producers[AProducerClass: TdxPSLayoutLookAndFeelProducerClass;
      ALayoutLookAndFeel: TdxCustomLayoutLookAndFeel]
      : TdxPSLayoutLookAndFeelProducer read GetProducer; default;
  end;
  ...
  private
    ...
    function GetProducer(LayoutItem: TdxCustomLayoutItem)
  ...
  protected
    ...
    property Producers[LayoutItem: TdxCustomLayoutItem]
      : TdxPSCustomLayoutItemProducer read GetProducer;
  public
  ...
  TdxLayoutControlReportLinkOptionsBehaviorClass = class of
  ...
  published
    property ActiveTabToTop: Boolean read FActiveTabToTop
      write SetActiveTabToTop default True;
    property ExpandGroups: Boolean read FExpandGroups write SetExpandGroups
      default True;
    property SkipEmptyGroups: Boolean read FSkipEmptyGroups
      write SetSkipEmptyGroups default True;
    property UnwrapTabs: Boolean read FUnwrapTabs write SetUnwrapTabs
      default False;
  end;

  TdxLayoutControlReportLinkOptionsPaginationClass = class of
  ...
  TdxLayoutControlReportLinkOptionsSizeClass = class of
  ...
  TdxLayoutControlReportLink = class(TdxCustomContainerReportLink, IUnknown,
  ...
  private
    ...
    function GetLayoutItemProducer(LayoutItem: TdxCustomLayoutItem)
      : TdxPSCustomLayoutItemProducer;
    function GetLayoutLookAndFeelProducer(LayoutLookAndFeel
      : TdxCustomLayoutLookAndFeel): TdxPSLayoutLookAndFeelProducer;
    function GetOptionsPagination: TdxLayoutControlReportLinkOptionsPagination;
    function GetOptionsTransparent
      : TdxLayoutControlReportLinkOptionsTransparent;
    function GetRootLayoutGroup: TdxLayoutGroup;
    procedure SetOptionsBehavior
      (Value: TdxLayoutControlReportLinkOptionsBehavior);
    procedure SetOptionsPagination
      (Value: TdxLayoutControlReportLinkOptionsPagination);
    procedure SetOptionsSize(Value: TdxLayoutControlReportLinkOptionsSize);
    procedure SetOptionsTransparent
      (Value: TdxLayoutControlReportLinkOptionsTransparent);
  protected
    ...
    procedure AddHiddenItem(ATreeView: TTreeView; AParent: TTreeNode;
      AnItem: TdxCustomLayoutItem);
    procedure AddItem(ATreeView: TTreeView; AParent: TTreeNode;
      AnItem: TdxCustomLayoutItem);
    ...
    function AddBoundsToCache(AComponent: TComponent;
      const ABounds: TRect): Integer;
    function AddCaptionOptionsFontToCache(ACaptionOptions
      : TdxLayoutLookAndFeelCaptionOptions): Integer;
    procedure ClearCachedBounds;
    procedure ClearCachedFonts;
    function FindBoundsByComponent(AComponent: TComponent; var ABounds: TRect;
      ASetEmbedded: Boolean): Boolean;
    function FindFontIndexByCaptionOptions(ACaptionOptions
      : TdxLayoutLookAndFeelCaptionOptions): Integer;
    ...
    function GetOptionsPaginationClass
      : TdxCustomContainerReportLinkOptionsPaginationClass; override;
    function GetOptionsSizeClass
      : TdxLayoutControlReportLinkOptionsSizeClass; virtual;
    function GetOptionsTransparentClass
      : TdxCustomContainerReportLinkOptionsTransparentClass; override;

    function FindReportGroupLookAndFeel(ALayoutLookAndFeel
      : TdxCustomLayoutLookAndFeel): TdxPSReportGroupLookAndFeel;
    function FindReportItemByLayoutItem(ALayoutItem: TdxCustomLayoutItem)
      : TdxReportCell;
    ...
    property CachedBoundsItem[Index: Integer]: TdxLCBoundsCacheItem
      read GetCachedBoundsItem;
    property CachedBounds: TList read FCachedBounds;

    property CachedFontItemCount: Integer read GetCachedFontItemCount;
    property CachedFontItems[Index: Integer]: PdxPSLayoutCacheFontItem
      read GetCachedFontItem;
    property CachedFonts: TList read FCachedFonts;

    property CurrentHost: TdxReportCell read GetCurrentHost;
    property CurrentLayoutItem: TdxCustomLayoutItem read FCurrentLayoutItem
      Write FCurrentLayoutItem;
    property LayoutItemProducerCache: TdxPSLayoutItemProducerCache
      read FLayoutItemProducerCache;
    property LayoutItemProducers[LayoutItem: TdxCustomLayoutItem]
      : TdxPSCustomLayoutItemProducer read GetLayoutItemProducer;
    property LayoutLookAndFeelProducerCache: TdxPSLayoutLookAndFeelProducerCache
      read FLayoutLookAndFeelProducerCache;
    property LayoutLookAndFeelProducers
      [LayoutLookAndFeel: TdxCustomLayoutLookAndFeel]
      : TdxPSLayoutLookAndFeelProducer read GetLayoutLookAndFeelProducer;
  ...
  published
    property OptionsBehavior: TdxLayoutControlReportLinkOptionsBehavior
      read FOptionsBehavior write SetOptionsBehavior;
    property OptionsPagination: TdxLayoutControlReportLinkOptionsPagination
      read GetOptionsPagination write SetOptionsPagination;
    property OptionsSize: TdxLayoutControlReportLinkOptionsSize
      read FOptionsSize write SetOptionsSize;
    property OptionsTransparent: TdxLayoutControlReportLinkOptionsTransparent
      read GetOptionsTransparent write SetOptionsTransparent;
  end;
  ...
  protected
    ...
    procedure SetOptionsPaginationByIndex(AnIndex: Integer;
      AValue: Boolean); override;
    procedure SetOptionsSizeByIndex(AnIndex: Integer; AValue: Boolean);
      override;
    procedure SetOptionsTabsByIndex(AnIndex: Integer; AValue: Boolean);
      override;
  ...
  public
    property LayoutReportLink: TdxLayoutControlReportLink
      read GetLayoutReportLink;
  end;
...
const
  ...
  LayoutCaptionAlignHorzMap: array [TAlignment] of TcxTextAlignX = (taLeft,
    taRight, taCenterX);
  LayoutCaptionAlignVertMap: array [TdxAlignmentVert] of TcxTextAlignY = (taTop,
    taCenterY, taBottom);
  LayoutGroupCaptionAlignHorzMap: array [TAlignment] of TcxTextAlignX = (taLeft,
    taRight, taCenterX);
...
type
  ...
  TdxCustomLayoutItemCaptionViewInfoAccess = class
    (TdxCustomLayoutItemCaptionViewInfo);
  TdxCustomLayoutItemCaptionOptionsAccess = class
    (TdxCustomLayoutItemCaptionOptions);
  TdxLayoutLabeledItemCustomCaptionOptionsAccess = class
    (TdxLayoutLabeledItemCustomCaptionOptions);
  TdxCustomLayoutItemImageOptionsAccess = class
...
function dxGetPreparedFontIndex(ACaptionOptions
  : TdxLayoutLookAndFeelCaptionOptions; AReportLink: TBasedxReportLink;
  AContainer: TdxLayoutContainer): Integer;
begin
  FPreparationFont.Assign(ACaptionOptions.GetFont(AContainer));
  FPreparationFont.Color := ACaptionOptions.GetTextColor;
  if ACaptionOptions.HotTrack and
    (htsUnderlineCold in ACaptionOptions.HotTrackStyles) then
    FPreparationFont.Style := FPreparationFont.Style + [fsUnderline];
  if not dxIsTrueTypeFont(FPreparationFont) then
    FPreparationFont.Name := TdxLayoutContainerAccess(AContainer)
      .GetDefaultFont.Name;
...
function GetLayoutItemRelativeBounds(ALayoutItemViewInfo
...
begin
  ...
  begin
    ...
    if IsRoot(ALayoutItemViewInfo) or IsRoot(ALayoutItemViewInfo.ParentViewInfo)
    then
...
type
  ...
  private
    function GetProducerClass(LayoutItem: TdxCustomLayoutItem)
      : TdxPSCustomLayoutItemProducerClass;
  public
    class function Instance: TdxPSLayoutItemProducerFactory;
      reintroduce; overload;
    property ProducerClasses[LayoutItem: TdxCustomLayoutItem]
      : TdxPSCustomLayoutItemProducerClass read GetProducerClass; default;
  end;

  TdxPSLayoutLookAndFeelProducerFactory = class(TdxCustomClassMaps)
  private
    function GetProducerClass(LayoutLookAndFeel: TdxCustomLayoutLookAndFeel)
      : TdxPSLayoutLookAndFeelProducerClass;
  public
    class function Instance: TdxPSLayoutLookAndFeelProducerFactory;
      reintroduce; overload;
    property ProducerClasses[LayoutLookAndFeel: TdxCustomLayoutLookAndFeel]
      : TdxPSLayoutLookAndFeelProducerClass read GetProducerClass; default;
  end;
...
class function TdxPSLayoutItemProducerFactory.Instance
  : TdxPSLayoutItemProducerFactory;
begin
  Result := inherited Instance as TdxPSLayoutItemProducerFactory;
end;

function TdxPSLayoutItemProducerFactory.GetProducerClass
  (LayoutItem: TdxCustomLayoutItem): TdxPSCustomLayoutItemProducerClass;
begin
  Result := TdxPSCustomLayoutItemProducerClass
    (PairClasses[LayoutItem.ClassType]);
end;

{ TdxPSLayoutLookAndFeelProducerFactory }

function dxPSLayoutLookAndFeelProducerFactory
  : TdxPSLayoutLookAndFeelProducerFactory;
begin
  Result := TdxPSLayoutLookAndFeelProducerFactory.Instance;
end;

class function TdxPSLayoutLookAndFeelProducerFactory.Instance
  : TdxPSLayoutLookAndFeelProducerFactory;
begin
  Result := inherited Instance as TdxPSLayoutLookAndFeelProducerFactory;
end;

function TdxPSLayoutLookAndFeelProducerFactory.GetProducerClass
  (LayoutLookAndFeel: TdxCustomLayoutLookAndFeel)
  : TdxPSLayoutLookAndFeelProducerClass;
begin
  Result := TdxPSLayoutLookAndFeelProducerClass
    (PairClasses[LayoutLookAndFeel.ClassType]);
end;
...
procedure TdxReportLayoutCaptionTextCell.DrawText
...
function TdxReportLayoutCaptionTextCell.MeasureTextHeight
...
function TdxReportLayoutCaptionTextCell.MeasureTextWidth
  (ACanvas: TdxPSReportRenderCustomCanvas): Integer;
begin
  if CanDrawByFormattedText then
...
function TdxReportLayoutCaptionTextCell.MeasureHeight
  (ACanvas: TdxPSReportRenderCustomCanvas): Integer;
begin
...
function TdxReportLayoutCaptionTextCell.MeasureWidth
  (ACanvas: TdxPSReportRenderCustomCanvas): Integer;
begin
...
begin
  Result := TdxCustomLayoutItemCaptionOptionsAccess(Item.CaptionOptions)
    .FormattedText.HasFormatting;
end;

procedure TdxReportLayoutCaptionTextCell.DoDrawByFormattedText
  (ACanvas: TdxPSReportRenderCustomCanvas);
...
begin
  Result := AlignmentsHorzToFlag[TextAlignX] or AlignmentsVertToFlag[TextAlignY]
    ...
    CharbreakToFlag[BreakByChars] or NoClipToFlag[NoClip];
end;
...
procedure TdxReportCustomLayoutCaptionCell.AdjustBounds
  (ACanvas: TdxPSReportRenderCustomCanvas);
begin
...
procedure TdxReportCustomLayoutCaptionCell.Initialize
...
function TdxReportCustomLayoutCaptionCell.CreateImageCell
  (AReportLink: TBasedxReportLink): TdxReportLayoutCaptionImageCell;
var
...
begin
  ...
  TdxCustomLayoutItemImageOptionsAccess(ImageOptions).GetCurrentImage(ABitmap,
...
function TdxReportCustomLayoutCaptionCell.CreateTextCell
  (AReportLink: TBasedxReportLink): TdxReportLayoutCaptionTextCell;
begin
  ...
  if Result.CanDrawByFormattedText then
    ...
    Result.Text := TdxCustomLayoutItemCaptionViewInfoAccess
      (ViewInfo.CaptionViewInfo).FormattedText.GetDisplayText;
  Result.HidePrefix := True;
  Result.Multiline := False;
  Result.TextAlignY := taTop;
  Result.FontIndex := Parent.FontIndex;
  Result.EndEllipsis := TdxLayoutLabeledItemCustomCaptionOptionsAccess
    (CaptionOptions).EllipsisPosition <> epNone;
end;

function TdxReportCustomLayoutCaptionCell.GetReportLayoutCaptionImageCellClass
  : TdxReportLayoutCaptionImageCellClass;
begin
  Result := TdxReportLayoutCaptionImageCell;
end;

function TdxReportCustomLayoutCaptionCell.GetReportLayoutCaptionTextCellClass
  : TdxReportLayoutCaptionTextCellClass;
begin
...
function TdxReportCustomLayoutCaptionCell.GetViewInfo
...
begin
  Result := cxRectOffset(ViewInfo.CaptionViewInfo.Bounds,
    ViewInfo.Bounds.TopLeft, False);
end;

function TdxReportCustomLayoutCaptionCell.GetCaptionOptions
  : TdxCustomLayoutItemCaptionOptions;
begin
...
begin
  Result := cxRectOffset(ViewInfo.CaptionViewInfo.ImageAreaBounds,
    ViewInfo.CaptionViewInfo.Bounds.TopLeft, False);
end;

function TdxReportCustomLayoutCaptionCell.GetImageItem
  : TdxReportLayoutCaptionImageCell;
var
  I: Integer;
begin
...
function TdxReportCustomLayoutCaptionCell.GetImageOptions
  : TdxCustomLayoutItemImageOptions;
begin
  Result := TdxCustomLayoutItemCaptionOptionsAccess(CaptionOptions)
    .ImageOptions;
end;

function TdxReportCustomLayoutCaptionCell.GetTextBounds: TRect;
begin
  Result := cxRectOffset(ViewInfo.CaptionViewInfo.TextAreaBounds,
    ViewInfo.CaptionViewInfo.Bounds.TopLeft, False);
end;

function TdxReportCustomLayoutCaptionCell.GetTextItem
  : TdxReportLayoutCaptionTextCell;
var
  I: Integer;
begin
...
procedure TdxCustomReportLayoutItem.AdjustBounds
  (ACanvas: TdxPSReportRenderCustomCanvas);
begin
...
function TdxCustomReportLayoutItem.GetCaptionCellClass
  : TdxReportCustomLayoutCaptionCellClass;
begin
  Result := TdxReportCustomLayoutCaptionCell;
end;

function TdxCustomReportLayoutItem.CreateCaptionCell
  (AReportLink: TBasedxReportLink): TdxReportCustomLayoutCaptionCell;
begin
...
begin
  if FontIndex = 0 then
    Result := dxGetPreparedFontIndex(ViewInfo.CaptionViewInfo.Options,
      ReportLink, Item.Container)
  else
    Result := FontIndex;
end;

function TdxCustomReportLayoutItem.GetCaptionItem
  : TdxReportCustomLayoutCaptionCell;
var
  I: Integer;
begin
...
procedure TdxReportLayoutGroupCaptionTextCell.DrawContent
...
begin
  ...
  begin
    ...
    begin
      ACanvas.SaveState;
      try
        ACanvas.RotatedTextOut(BoundsRect, Text, Font, TextAlignX, TextAlignY,
          False, GetDirection);
      finally
        ACanvas.RestoreState;
      end;
...
function TdxReportLayoutGroupCaptionTextCell.HasLayoutProperty
...
procedure TdxReportLayoutGroupCaptionTextCell.ReadData
...
procedure TdxReportLayoutGroupCaptionTextCell.WriteData
...
function TdxReportLayoutGroupCaptionCell.CreateTextCell
  (AReportLink: TBasedxReportLink): TdxReportLayoutCaptionTextCell;
begin
  ...
  TdxReportLayoutGroupCaptionTextCell(Result).FLayout :=
    Group.CaptionOptions.Layout;
end;

function TdxReportLayoutGroupCaptionCell.CreateImageCell
  (AReportLink: TBasedxReportLink): TdxReportLayoutCaptionImageCell;
const
  ARotationAngleMap: array [TdxCaptionLayout] of TcxRotationAngle = (raPlus90,
    ra0, raMinus90, ra0);
var
...
begin
  ...
  if TdxCustomLayoutItemImageOptionsAccess(ImageOptions).GetCurrentImage(AGlyph,
    AImageList, AImageIndex) then
  begin
    with TdxCustomLayoutItemImageOptionsAccess(ImageOptions).GetImageSize do
      ABitmap := TcxAlphaBitmap.CreateSize(cx, cy);
    try
      dxDrawItemGlyph(ABitmap.cxCanvas, Group, ABitmap.ClientRect,
        ARotationAngleMap[Group.CaptionOptions.Layout]);
...
function TdxReportLayoutGroupCaptionCell.GetReportLayoutCaptionImageCellClass
  : TdxReportLayoutCaptionImageCellClass;
begin
  Result := TdxReportLayoutGroupCaptionImageCell;
end;

function TdxReportLayoutGroupCaptionCell.GetReportLayoutCaptionTextCellClass
  : TdxReportLayoutCaptionTextCellClass;
begin
...
function TdxReportLayoutGroupCaptionCell.GetTextItem
  : TdxReportLayoutGroupCaptionTextCell;
begin
...
procedure TdxPSReportLayoutGroupStandardLookAndFeelPainter.DrawCaptionText
  (ACanvas: TdxPSReportRenderCustomCanvas);
begin
  // do nothing;
end;

function TdxPSReportLayoutGroupStandardLookAndFeelPainter.LookAndFeel
  : TdxPSReportLayoutGroupStandardLookAndFeel;
begin
...
function TdxPSReportLayoutGroupStandardLookAndFeel.GetBorderEdgeThickness
...
begin
  ...
  begin
    ...
    Result := TdxReportLayoutGroup(AGroup)
      .InternalGetBorderEdgeThickness(ASide);
end;

function TdxPSReportLayoutGroupStandardLookAndFeel.GetCaptionHeight
...
function TdxPSReportLayoutGroupStandardLookAndFeel.GetCaptionTextBounds
...
class function TdxPSReportLayoutGroupStandardLookAndFeel.GetPainterClass
...
function TdxPSReportLayoutGroupWebLookAndFeel.GetCaptionBounds
  (AGroup: TdxReportGroup): TRect;
var
  ALayoutGroup: TdxReportLayoutGroup;
begin
  ...
  begin
    ...
    case ALayoutGroup.Side of
      csLeft:
        Result.Right := Result.Left + GetCaptionHeight(AGroup);
      csTop:
        Result.Bottom := Result.Top + GetCaptionHeight(AGroup);
      csRight:
        Result.Left := Result.Right - GetCaptionHeight(AGroup);
      csBottom:
        Result.Top := Result.Bottom - GetCaptionHeight(AGroup);
    end;
  end
  else
    Result := cxNullRect;
...
class function TdxPSReportLayoutGroupOfficeLookAndFeel.DefaultBorderSides
  : TdxCellSides;
begin
...
function TdxPSReportLayoutGroupOfficeLookAndFeel.GetBorderSides
  (AGroup: TdxReportGroup): TdxCellSides;
begin
...
begin
  if ShowCaption and (LookAndFeel <> nil) then
    case Side of
      csLeft:
        Inc(R.Left, TdxPSReportGroupLookAndFeelAccess(LookAndFeel)
          .GetCaptionHeight(Self) div 2);
      csTop:
        Inc(R.Top, TdxPSReportGroupLookAndFeelAccess(LookAndFeel)
          .GetCaptionHeight(Self) div 2);
      csRight:
        Dec(R.Right, TdxPSReportGroupLookAndFeelAccess(LookAndFeel)
          .GetCaptionHeight(Self) div 2);
      csBottom:
        Dec(R.Bottom, TdxPSReportGroupLookAndFeelAccess(LookAndFeel)
          .GetCaptionHeight(Self) div 2);
    end;
end;

function TdxReportLayoutGroup.GetCaptionCellClass
  : TdxReportCustomLayoutCaptionCellClass;
begin
...
const
  SideMap: array [TdxCaptionLayout] of TdxCellSide = (csLeft, csTop, csRight,
    csBottom);
begin
  inherited;
...
function TdxReportLayoutGroup.HasSideProperty(const AVersion
...
procedure TdxReportLayoutDirectionalItem.AdjustBounds
  (ACanvas: TdxPSReportRenderCustomCanvas);
begin
  inherited;
...
procedure TdxReportLayoutDirectionalItem.Initialize
  (AReportLink: TBasedxReportLink);
begin
  inherited;
...
function TdxReportLayoutDirectionalItem.CreateSeparatorCell
  (AReportLink: TBasedxReportLink): TdxReportCell;
const
...
function TdxReportLayoutLabeledItemCaptionCell.CreateTextCell
  (AReportLink: TBasedxReportLink): TdxReportLayoutCaptionTextCell;
begin
  Result := inherited CreateTextCell(AReportLink);
  // todo: ?  Result.TextAlignY := LayoutCaptionAlignVertMap[CaptionOptions.AlignVert];
  Result.Multiline := (CaptionOptions.Width <> 0) or
    TdxLayoutLabeledItemCustomCaptionOptionsAccess(CaptionOptions).WordWrap;
  Result.AdjustFont := True;
end;

function TdxReportLayoutLabeledItemCaptionCell.GetCaptionOptions
  : TdxLayoutLabeledItemCustomCaptionOptions;
begin
  Result := inherited CaptionOptions as
    TdxLayoutLabeledItemCustomCaptionOptions;
end;

{ TdxReportLayoutLabeledItem }

function TdxReportLayoutLabeledItem.GetCaptionCellClass
  : TdxReportCustomLayoutCaptionCellClass;
begin
...
procedure TdxReportLayoutSeparatorCaptionTextCell.DrawContent
  (ACanvas: TdxPSReportRenderCustomCanvas; AStage: TdxPSRenderStages);
begin
  if IsVertical then
  begin
...
function TdxReportLayoutSeparatorCaptionTextCell.CanDrawByFormattedText
  : Boolean;
begin
  Result := False;
end;

procedure TdxReportLayoutSeparatorCaptionTextCell.ReadData
  (AReader: TdxPSDataReader);
begin
  inherited;
  if HasLayoutProperty(AReader.PSVersion) then
...
procedure TdxReportLayoutSeparatorCaptionTextCell.WriteData
  (AWriter: TdxPSDataWriter);
begin
  inherited;
  if HasLayoutProperty(AWriter.PSVersion) then
...
function TdxReportLayoutSeparatorCaptionTextCell.HasLayoutProperty
  (const AVersion: TdxPSVersion): Boolean;
begin
...
function TdxReportLayoutSeparatorItemCaptionCell.CreateTextCell
  (AReportLink: TBasedxReportLink): TdxReportLayoutCaptionTextCell;
begin
  Result := inherited CreateTextCell(AReportLink);
  (Result as TdxReportLayoutSeparatorCaptionTextCell).IsVertical :=
    (Item as TdxLayoutSeparatorItem).IsVertical;
end;

function TdxReportLayoutSeparatorItemCaptionCell.
  GetReportLayoutCaptionTextCellClass: TdxReportLayoutCaptionTextCellClass;
begin
...
procedure TdxReportLayoutSeparatorItem.AdjustBounds
  (ACanvas: TdxPSReportRenderCustomCanvas);
begin
  inherited;
...
procedure TdxReportLayoutSeparatorItem.CreateSeparatorCells
  (AReportLink: TBasedxReportLink);
...
function TdxReportLayoutSeparatorItem.GetCaptionCellClass
  : TdxReportCustomLayoutCaptionCellClass;
begin
  Result := TdxReportLayoutSeparatorItemCaptionCell;
end;

function TdxReportLayoutSeparatorItem.HasSeparatorItem(ASeparatorPartCell
  : TdxReportCell): Boolean;
begin
...
function TdxReportLayoutSeparatorItem.GetViewInfo
...
begin
  ASeparatorBounds := TdxLayoutSeparatorItemViewInfoAccess(ViewInfo)
    .SeparatorBounds;
  ACaptionBounds := ViewInfo.CaptionViewInfo.Bounds;
  if HasCaptionItem and IsVertical and
    (ViewInfo.CaptionViewInfo.AlignVert = tavCenter) then
  begin
    if HasSeparatorItem(FSeparatorPart1Cell) then
      FSeparatorPart1Cell.BoundsRect := GetSeparatorPartCellBounds
        (Rect(ASeparatorBounds.Left, ASeparatorBounds.Top,
        ASeparatorBounds.Right, ACaptionBounds.Top - cxTextSpace));
    if HasSeparatorItem(FSeparatorPart2Cell) then
      FSeparatorPart2Cell.BoundsRect := GetSeparatorPartCellBounds
        (Rect(ASeparatorBounds.Left, ACaptionBounds.Bottom + cxTextSpace,
        ASeparatorBounds.Right, ASeparatorBounds.Bottom));
  end
  else if HasCaptionItem and not IsVertical and
    (ViewInfo.CaptionViewInfo.AlignHorz = taCenter) then
  begin
    if HasSeparatorItem(FSeparatorPart1Cell) then
      FSeparatorPart1Cell.BoundsRect := GetSeparatorPartCellBounds
        (Rect(ASeparatorBounds.Left, ASeparatorBounds.Top,
        ACaptionBounds.Left - cxTextSpace, ASeparatorBounds.Bottom));
    if HasSeparatorItem(FSeparatorPart2Cell) then
      FSeparatorPart2Cell.BoundsRect := GetSeparatorPartCellBounds
        (Rect(ACaptionBounds.Right + cxTextSpace, ASeparatorBounds.Top,
        ASeparatorBounds.Right, ASeparatorBounds.Bottom));
  end
  else if HasSeparatorItem(FSeparatorPart1Cell) then
    FSeparatorPart1Cell.BoundsRect := GetSeparatorPartCellBounds
      (ASeparatorBounds);
end;

procedure TdxReportLayoutSeparatorItem.Initialize
  (AReportLink: TBasedxReportLink);
begin
  inherited;
...
procedure TdxReportLayoutItem.AdjustBounds
  (ACanvas: TdxPSReportRenderCustomCanvas);
begin
  inherited;
...
function TdxReportLayoutItem.CreateControlCell(AReportLink
  : TdxLayoutControlReportLink): TdxReportVisualItem;
  ...
  begin
    ...
    if not Result and AControl.HandleAllocated then
      Result := (GetWindowLong(AControl.Handle, GWL_STYLE) and
        WS_BORDER = WS_BORDER) or (GetWindowLong(AControl.Handle, GWL_EXSTYLE)
        and WS_EX_CLIENTEDGE = WS_EX_CLIENTEDGE);
...
begin
  ...
  begin
    Result := AReportLink.ActiveBuilder.BuildNestedContainer
      (TWinControl(Control), Self);
    ...
    begin
      ...
      AWinControlHost.ControlItem.BorderClass := LayoutBorderStyleMap
        [AItemOptions.ControlBorderStyle];
      AWinControlHost.ControlItem.BorderColor :=
        AItemOptions.ControlBorderColor;
      if not(AWinControlHost.ControlItem is TdxReportCellGraphic) then
        AWinControlHost.ControlItem.CellSides :=
          CellSidesMap[LayoutItem.ControlOptions.ShowBorder or
          HasBorder(TWinControl(Control))];
    end;
  end
  else
...
begin
  ...
  if NeedCreateControlCell then
    FControlItem := CreateControlCell
      (AReportLink as TdxLayoutControlReportLink);
end;
...
begin
  Result := cxRectOffset(ViewInfo.ControlViewInfo.ControlBounds,
    ViewInfo.Bounds.TopLeft, False);
end;
...
begin
  ...
  FContentImageCell.Image := (ViewInfo as TdxLayoutImageItemViewInfo)
    .Item.Image;
end;

function TdxReportLayoutImageItem.GetContentImageBounds: TRect;
begin
  Result := cxRectOffset((ViewInfo as TdxLayoutImageItemViewInfo)
    .ImageAreaBounds, ViewInfo.Bounds.TopLeft, False);
end;

{ TdxReportLayoutCheckBoxItem }

procedure TdxReportLayoutCheckBoxItem.Initialize(AReportLink
  : TBasedxReportLink);
var
...
begin
  ...
  FCheckBoxCell.BoundsRect :=
    cxRectOffset((ViewInfo as TdxLayoutCheckBoxItemViewInfo).CheckAreaBounds,
    ViewInfo.Bounds.TopLeft, False);
...
procedure TdxReportLayoutRadioButtonItem.Initialize
  (AReportLink: TBasedxReportLink);
var
...
begin
  ...
  FRadioButtonCell.BoundsRect :=
    cxRectOffset((ViewInfo as TdxLayoutRadioButtonItemViewInfo).CheckAreaBounds,
    ViewInfo.Bounds.TopLeft, False);
...
function TdxPSCustomLayoutItemDefinition.OptionsPagination
  : TdxLayoutControlReportLinkOptionsPagination;
begin
...
procedure TdxPSCustomLayoutItemDefinition.AdjustBounds
  (ACanvas: TdxPSReportRenderCustomCanvas);
begin
...
function TdxPSCustomLayoutItemDefinition.GetReportItem
  : TdxCustomReportLayoutItem;
begin
  Result := inherited ReportItem as TdxCustomReportLayoutItem;
end;

procedure TdxPSCustomLayoutItemDefinition.SetLayoutItem
...
begin
  inherited;
  if OptionsPagination.Groups then
...
begin
  inherited;
  if OptionsPagination.Items then
    AddReportItemToDelimitersHorz(AList);
end;
...
constructor TdxPSLayoutItemDefinition.Create(AReportLink
  : TdxCustomContainerReportLink; AComponent: TComponent;
...
begin
  if ReportItem.HasControlItem then
    ReportItem.LayoutItem.OriginalControlSize :=
      Point(ReportItem.ControlItem.Width, ReportItem.ControlItem.Height);
end;

procedure TdxPSLayoutItemDefinition.StoreOriginalItemSize;
begin
  if LayoutItem.Control <> nil then
    FOriginalControlSize := cxSize(LayoutItem.ControlOptions.OriginalWidth,
      LayoutItem.ControlOptions.OriginalHeight);
end;
...
function TdxPSLayoutControlObjectProducer.ReportLink
...
function TdxPSLayoutLookAndFeelProducer.LayoutLookAndFeel
  : TdxCustomLayoutLookAndFeel;
begin
  Result := inherited ProducingObject as TdxCustomLayoutLookAndFeel;
end;

class function TdxPSLayoutLookAndFeelProducer.LayoutLookAndFeelClass
...
procedure TdxPSLayoutLookAndFeelProducer.InitializeReportLookAndFeel
...
begin
  ...
  ALookAndFeel.FontIndex := ReportLink.FindFontIndexByCaptionOptions
    (LayoutLookAndFeel.GroupOptions.CaptionOptions);
  ALookAndFeel.CaptionFontIndex := ALookAndFeel.FontIndex;
end;

class function TdxPSLayoutLookAndFeelProducer.ReportLookAndFeelClass
...
function TdxPSLayoutStandardLookAndFeelProducer.LayoutLookAndFeel
  : TdxLayoutStandardLookAndFeel;
begin
  Result := inherited LayoutLookAndFeel as TdxLayoutStandardLookAndFeel;
end;

class function TdxPSLayoutStandardLookAndFeelProducer.LayoutLookAndFeelClass
  : TdxCustomLayoutLookAndFeelClass;
begin
...
class function TdxPSLayoutStandardLookAndFeelProducer.ReportLookAndFeelClass
  : TdxPSReportGroupLookAndFeelClass;
begin
  Result := TdxPSReportLayoutGroupStandardLookAndFeel;
end;
...
function TdxPSLayoutOfficeLookAndFeelProducer.LayoutLookAndFeel
  : TdxLayoutOfficeLookAndFeel;
begin
  Result := inherited LayoutLookAndFeel as TdxLayoutOfficeLookAndFeel;
end;

class function TdxPSLayoutOfficeLookAndFeelProducer.LayoutLookAndFeelClass
  : TdxCustomLayoutLookAndFeelClass;
begin
  Result := TdxLayoutOfficeLookAndFeel;
end;

class function TdxPSLayoutOfficeLookAndFeelProducer.ReportLookAndFeelClass
  : TdxPSReportGroupLookAndFeelClass;
begin
...
function TdxPSLayoutWebLookAndFeelProducer.LayoutLookAndFeel
  : TdxLayoutWebLookAndFeel;
begin
  Result := inherited LayoutLookAndFeel as TdxLayoutWebLookAndFeel;
end;

class function TdxPSLayoutWebLookAndFeelProducer.LayoutLookAndFeelClass
  : TdxCustomLayoutLookAndFeelClass;
begin
...
procedure TdxPSLayoutWebLookAndFeelProducer.InitializeReportLookAndFeel
  (ALookAndFeel: TdxPSReportGroupLookAndFeel);
var
...
begin
  ...
  AWebLookAndFeel.CaptionColor :=
    LayoutLookAndFeel.GroupOptions.CaptionOptions.GetColor;
  AWebLookAndFeel.CaptionSeparatorColor :=
    LayoutLookAndFeel.GroupOptions.GetFrameColor;
  AWebLookAndFeel.CaptionSeparatorThickness :=
    LayoutLookAndFeel.GroupOptions.CaptionOptions.SeparatorWidth;
end;

class function TdxPSLayoutWebLookAndFeelProducer.ReportLookAndFeelClass
  : TdxPSReportGroupLookAndFeelClass;
begin
...
function TdxPSCustomLayoutItemProducer.Definition
  : TdxPSCustomLayoutItemDefinition;
begin
  Result := inherited Definition as TdxPSCustomLayoutItemDefinition;
end;

class function TdxPSCustomLayoutItemProducer.DefinitionClass
...
class function TdxPSCustomLayoutItemProducer.LayoutItemClass
...
function TdxPSCustomLayoutItemProducer.GetLayoutLookAndFeel
  : TdxCustomLayoutLookAndFeel;
begin
  Result := LayoutItem.ViewInfo.LayoutLookAndFeel;
end;

function TdxPSCustomLayoutItemProducer.GetLayoutLookAndFeelProducer
  : TdxPSLayoutLookAndFeelProducer;
begin
  Result := ReportLink.LayoutLookAndFeelProducers[LayoutLookAndFeel];
end;

procedure TdxPSCustomLayoutItemProducer.InitializeReportItem
  (AnItem: TdxReportCell);
begin
...
class function TdxPSCustomLayoutItemProducer.ReportItemClass
  : TdxReportCellClass;
begin
  Result := TdxCustomReportLayoutItem;
end;

function TdxPSCustomLayoutItemProducer.OptionsTransparent
  : TdxLayoutControlReportLinkOptionsTransparent;
begin
  Result := inherited OptionsTransparent as
    TdxLayoutControlReportLinkOptionsTransparent;
end;
...
class function TdxPSLayoutGroupProducer.DefinitionClass
  : TdxPSCustomContainerItemDefinitionClass;
begin
...
class function TdxPSLayoutGroupProducer.LayoutItemClass
  : TdxCustomLayoutItemClass;
begin
...
begin
  ...
  AGroup.LookAndFeel := Self.ReportLink.FindReportGroupLookAndFeel
    (LayoutLookAndFeel);
  AGroup.Transparent := OptionsTransparent.Groups;
  AGroup.CellSides := [];
  if TdxCustomLayoutItemViewInfoAccess(LayoutItem.ViewInfo).HasBorder then
    AGroup.CellSides := TdxPSReportGroupLookAndFeelAccess(AGroup.LookAndFeel)
      .GetBorderSides(AGroup);
...
class function TdxPSLayoutBasicItemProducer.DefinitionClass
  : TdxPSCustomContainerItemDefinitionClass;
begin
  Result := TdxPSLayoutBasicItemDefinition;
end;

class function TdxPSLayoutBasicItemProducer.LayoutItemClass
  : TdxCustomLayoutItemClass;
begin
...
begin
  Result := ReportLink.LayoutLookAndFeelProducers
    [LayoutItem.ViewInfo.LayoutLookAndFeel].ContentColor;
end;

procedure TdxPSLayoutBasicItemProducer.InitializeReportItem
  (AnItem: TdxReportCell);
begin
  inherited;
...
class function TdxPSLayoutEmptySpaceItemProducer.LayoutItemClass
  : TdxCustomLayoutItemClass;
begin
  Result := TdxLayoutEmptySpaceItem;
end;

class function TdxPSLayoutEmptySpaceItemProducer.ReportItemClass
  : TdxReportCellClass;
begin
...
class function TdxPSLayoutSeparatorItemProducer.LayoutItemClass
  : TdxCustomLayoutItemClass;
begin
  Result := TdxLayoutSeparatorItem;
end;

class function TdxPSLayoutSeparatorItemProducer.ReportItemClass
  : TdxReportCellClass;
begin
...
class function TdxPSLayoutSplitterItemProducer.LayoutItemClass
  : TdxCustomLayoutItemClass;
begin
  Result := TdxLayoutSplitterItem;
end;

class function TdxPSLayoutSplitterItemProducer.ReportItemClass
  : TdxReportCellClass;
begin
...
class function TdxPSLayoutLabeledItemProducer.DefinitionClass
  : TdxPSCustomContainerItemDefinitionClass;
begin
...
class function TdxPSLayoutLabeledItemProducer.LayoutItemClass
  : TdxCustomLayoutItemClass;
begin
  Result := TdxLayoutLabeledItem;
end;

class function TdxPSLayoutLabeledItemProducer.ReportItemClass
  : TdxReportCellClass;
begin
...
constructor TdxPSLayoutItemProducer.Create(AReportLink
...
class function TdxPSLayoutItemProducer.DefinitionClass
  : TdxPSCustomContainerItemDefinitionClass;
begin
...
class function TdxPSLayoutItemProducer.LayoutItemClass
  : TdxCustomLayoutItemClass;
begin
...
class function TdxPSLayoutImageItemProducer.LayoutItemClass
  : TdxCustomLayoutItemClass;
begin
...
class function TdxPSLayoutCheckBoxItemProducer.LayoutItemClass
  : TdxCustomLayoutItemClass;
begin
  Result := TdxLayoutCheckBoxItem;
end;

class function TdxPSLayoutCheckBoxItemProducer.ReportItemClass
  : TdxReportCellClass;
begin
...
class function TdxPSLayoutRadioButtonItemProducer.LayoutItemClass
  : TdxCustomLayoutItemClass;
begin
  Result := TdxLayoutRadioButtonItem;
end;

class function TdxPSLayoutRadioButtonItemProducer.ReportItemClass
  : TdxReportCellClass;
begin
...
function TdxPSCustomLayoutObjectProducerCache.ReportLink
  : TdxLayoutControlReportLink;
begin
  Result := inherited ReportLink as TdxLayoutControlReportLink;
end;
...
function TdxPSLayoutItemProducerCache.GetItem(Index: Integer)
  : TdxPSCustomLayoutItemProducer;
begin
  Result := TdxPSCustomLayoutItemProducer(inherited Items[Index]);
end;

function TdxPSLayoutItemProducerCache.GetProducer(AProducerClass
  : TdxPSCustomLayoutItemProducerClass; ALayoutItem: TdxCustomLayoutItem)
  : TdxPSCustomLayoutItemProducer;
var
  Index: Integer;
begin
...
function TdxPSLayoutLookAndFeelProducerCache.GetItem(Index: Integer)
  : TdxPSLayoutLookAndFeelProducer;
begin
  Result := TdxPSLayoutLookAndFeelProducer(inherited Items[Index]);
end;

function TdxPSLayoutLookAndFeelProducerCache.GetProducer(AProducerClass
  : TdxPSLayoutLookAndFeelProducerClass;
  ALayoutLookAndFeel: TdxCustomLayoutLookAndFeel)
  : TdxPSLayoutLookAndFeelProducer;
var
...
class function TdxPSNativeLayoutControlProducer.
  ...
  begin
    ...
    begin
      ...
      if ReportLink.IsComponentProcessed(Item) then
        if (Item is TdxCustomLayoutGroup) or
          ReportLink.FindDefinition(TdxLayoutItem(Item).Control, Index) then
...
procedure TdxPSLayoutControlProducer.CreateLayoutItems
  (AnItem: TdxReportVisualItem);

  function CreateReportItem(AParent: TdxReportCell;
    ALayoutItem: TdxCustomLayoutItem): TdxReportCell;
  begin
  ...
  procedure ProduceItem(AParent: TdxReportCell;
  ...
  begin
    ...
    if ALayoutItem is TdxCustomLayoutGroup then
      ...
      begin
        ...
        if not AVisibleItem.ActuallyVisible then
          Continue;
...
procedure TdxPSLayoutControlProducer.InitializeItem
  (AnItem: TdxReportVisualItem);
begin
  inherited;
...
procedure TdxPSLayoutControlProducer.ReportLinkInitializeItem
  (AnItem: TdxReportVisualItem);
begin
...
function TdxPSLayoutControlProducer.GetProducer(LayoutItem: TdxCustomLayoutItem)
  : TdxPSCustomLayoutItemProducer;
begin
...
begin
  ...
  begin
    Self.ActiveTabToTop := TdxLayoutControlReportLinkOptionsBehavior(Source)
      .ActiveTabToTop;
    Self.ExpandGroups := TdxLayoutControlReportLinkOptionsBehavior(Source)
      .ExpandGroups;
    Self.SkipEmptyGroups := TdxLayoutControlReportLinkOptionsBehavior(Source)
      .SkipEmptyGroups;
    Self.UnwrapTabs := TdxLayoutControlReportLinkOptionsBehavior(Source)
      .UnwrapTabs;
  end;
end;
...
procedure TdxLayoutControlReportLinkOptionsBehavior.SetItemStates
  (AContainer: TdxLayoutContainer);
begin
  dxLayoutSetItemStates(AContainer, UnwrapTabs, ActiveTabToTop, SkipEmptyGroups,
    ExpandGroups);
end;

procedure TdxLayoutControlReportLinkOptionsBehavior.SetActiveTabToTop
  (Value: Boolean);
begin
...
procedure TdxLayoutControlReportLinkOptionsBehavior.SetExpandGroups
  (Value: Boolean);
begin
...
procedure TdxLayoutControlReportLinkOptionsBehavior.SetSkipEmptyGroups
  (Value: Boolean);
begin
...
procedure TdxLayoutControlReportLinkOptionsBehavior.SetUnwrapTabs
  (Value: Boolean);
begin
...
procedure TdxLayoutControlReportLinkOptionsPagination.Assign
  (Source: TPersistent);
begin
  inherited;
...
procedure TdxLayoutControlReportLinkOptionsTransparent.Assign
  (Source: TPersistent);
begin
  inherited;
...
procedure TdxLayoutControlReportLinkOptionsTransparent.SetGroups
  (Value: Boolean);
begin
  if FGroups <> Value then
  begin
...
function TdxLayoutControlReportLink.DoIsComponentProcessed
  (AComponent: TComponent): Boolean;
begin
  Result := inherited DoIsComponentProcessed(AComponent) and
    (not(AComponent is TdxLayoutItem) or inherited DoIsComponentProcessed
    ((AComponent as TdxLayoutItem).Control));
end;

function TdxLayoutControlReportLink.GetRebuildOnPageParamsChange
  (AUpdateCodes: TdxPrinterPageUpdateCodes): Boolean;
begin
  Result := ([ucMarginLeft, ucMarginRight] * AUpdateCodes <> []) and
...
procedure TdxLayoutControlReportLink.CacheControlsBounds;
  ...
  begin
    for I := 0 to AGroup.ItemViewInfoCount - 1 do
      ...
      begin
        ControlViewInfo := TdxLayoutItemViewInfo(AGroup.ItemViewInfos[I])
          .ControlViewInfo;
        if ControlViewInfo <> nil then
          AddBoundsToCache(ControlViewInfo.Control,
            ControlViewInfo.ControlBounds);
      end
      else if AGroup.ItemViewInfos[I] is TdxLayoutGroupViewInfo then
...
procedure TdxLayoutControlReportLink.ConstructReport(AReportCells
  : TdxReportCells);
var
...
begin
  ...
  begin
    ...
    ANeedLockRedraw := LayoutControl.Visible and (LayoutControl.Parent <> nil)
      and LayoutControl.Parent.Visible and LayoutControl.Parent.HandleAllocated;
    ...
    try
      ...
      begin
        LayoutControl.Parent.Perform(WM_SETREDRAW, 1, 0);
        cxRedrawWindow(LayoutControl.Parent.Handle, RDW_INVALIDATE or
          RDW_ALLCHILDREN);
      end;
    end;
  end;
...
begin
  ...
  begin
    ADataItem := nil;
    NeedAddBorder := False;
    if not CachedBoundsItem[I].EmbeddedLink then
      Continue;
    LayoutItem := LayoutControl.FindItem
      (TControl(CachedBoundsItem[I].Component));
    ...
    begin
      ACellString := ReportItem.AddDataItem(TdxReportCellString)
        as TdxReportCellString;
...
procedure TdxLayoutControlReportLink.PrepareLookAndFeels;
  ...
  procedure CreateReportLookAndFeel(ALayoutLookAndFeel
    : TdxCustomLayoutLookAndFeel);
  var
    AReportLookAndFeel: TdxPSReportGroupLookAndFeel;
    AProducer: TdxPSLayoutLookAndFeelProducer;
  begin
    if ALayoutLookAndFeel = nil then
      Exit;

    AddCaptionOptionsFontToCache
      (ALayoutLookAndFeel.GroupOptions.CaptionOptions);
    ...
    AReportLookAndFeel := CreateGroupLookAndFeel
      (AProducer.ReportLookAndFeelClass, False);
...
var
  Index, I: Integer;
begin
  AParent := AddNode(ATreeView, AParent, AnItem,
    not FindHiddenComponent(AnItem, Index));
  if AnItem is TdxCustomLayoutGroup then
    for I := 0 to TdxCustomLayoutGroup(AnItem).VisibleCount - 1 do
      AddHiddenItem(ATreeView, AParent, TdxCustomLayoutGroup(AnItem)
        .VisibleItems[I]);
end;
...
begin
  ...
  begin
    AParent := AddNode(ATreeView, AParent, AnItem,
      not FindExcludedComponent(AnItem, Index));
    if AnItem is TdxCustomLayoutGroup then
      for I := 0 to TdxCustomLayoutGroup(AnItem).VisibleCount - 1 do
        AddItem(ATreeView, AParent, TdxCustomLayoutGroup(AnItem)
          .VisibleItems[I]);
  end;
end;

function TdxLayoutControlReportLink.IsComponentEditable
  (AComponent: TComponent): Boolean;
begin
  Result := inherited IsComponentEditable(AComponent) and
    (AComponent <> LayoutControl.Items);
end;
...
begin
  ...
  if Container <> nil then
    AddItem(ATreeView, AddNode(ATreeView, nil, Container, True),
      RootLayoutGroup);
end;

procedure TdxLayoutControlReportLink.LoadHiddenControlsTree
  (ATreeView: TTreeView);
begin
  ATreeView.Items.Clear;
  if Container <> nil then
    AddHiddenItem(ATreeView, AddNode(ATreeView, nil, Container, True),
      RootLayoutGroup);
end;

function TdxLayoutControlReportLink.AddBoundsToCache(AComponent: TComponent;
  const ABounds: TRect): Integer;
var
...
function TdxLayoutControlReportLink.AddCaptionOptionsFontToCache(ACaptionOptions
  : TdxLayoutLookAndFeelCaptionOptions): Integer;
var
...
begin
  ...
  Item^.FontIndex := dxGetPreparedFontIndex(ACaptionOptions, Self,
...
function TdxLayoutControlReportLink.FindFontIndexByCaptionOptions
  (ACaptionOptions: TdxLayoutLookAndFeelCaptionOptions): Integer;
var
  I: Integer;
  Item: PdxPSLayoutCacheFontItem;
begin
...
function TdxLayoutControlReportLink.GetOptionsPaginationClass
  : TdxCustomContainerReportLinkOptionsPaginationClass;
begin
  Result := TdxLayoutControlReportLinkOptionsPagination;
end;

function TdxLayoutControlReportLink.GetOptionsSizeClass
  : TdxLayoutControlReportLinkOptionsSizeClass;
begin
  Result := TdxLayoutControlReportLinkOptionsSize;
end;

function TdxLayoutControlReportLink.GetOptionsTransparentClass
  : TdxCustomContainerReportLinkOptionsTransparentClass;
begin
  Result := TdxLayoutControlReportLinkOptionsTransparent;
end;

function TdxLayoutControlReportLink.FindReportGroupLookAndFeel
  (ALayoutLookAndFeel: TdxCustomLayoutLookAndFeel): TdxPSReportGroupLookAndFeel;
begin
  Result := ReportCells.FindGroupLookAndFeelByData(ALayoutLookAndFeel)
end;

function TdxLayoutControlReportLink.FindReportItemByLayoutItem
  (ALayoutItem: TdxCustomLayoutItem): TdxReportCell;
  ...
  begin
    Result := ACell;
    if TObject(Result.Data) = ALayoutItem then
      Exit;
...
procedure TdxLayoutControlReportLink.GetLayoutItemList
  (AControl: TdxLayoutControl; AnItems: TList);
...
function TdxLayoutControlReportLink.GetControlSiteBounds
...
function TdxLayoutControlReportLink.GetCachedBoundsItem(Index: Integer)
  : TdxLCBoundsCacheItem;
begin
  Result := TdxLCBoundsCacheItem(CachedBounds[Index]);
end;

function TdxLayoutControlReportLink.GetCachedFontItem(Index: Integer)
  : PdxPSLayoutCacheFontItem;
begin
...
function TdxLayoutControlReportLink.GetLayoutItemProducer
  (LayoutItem: TdxCustomLayoutItem): TdxPSCustomLayoutItemProducer;
begin
  Result := LayoutItemProducerCache[dxPSLayoutItemProducerFactory[LayoutItem],
    LayoutItem];
end;

function TdxLayoutControlReportLink.GetLayoutLookAndFeelProducer
  (LayoutLookAndFeel: TdxCustomLayoutLookAndFeel)
  : TdxPSLayoutLookAndFeelProducer;
begin
  Result := LayoutLookAndFeelProducerCache
    [dxPSLayoutLookAndFeelProducerFactory[LayoutLookAndFeel],
    LayoutLookAndFeel];
end;

function TdxLayoutControlReportLink.GetOptionsPagination
  : TdxLayoutControlReportLinkOptionsPagination;
begin
  Result := inherited OptionsPagination as
    TdxLayoutControlReportLinkOptionsPagination;
...
function TdxLayoutControlReportLink.GetOptionsTransparent
  : TdxLayoutControlReportLinkOptionsTransparent;
begin
  Result := inherited OptionsTransparent as
    TdxLayoutControlReportLinkOptionsTransparent;
...
procedure TdxLayoutControlReportLink.SetOptionsBehavior
  (Value: TdxLayoutControlReportLinkOptionsBehavior);
begin
  FOptionsBehavior.Assign(Value);
end;

procedure TdxLayoutControlReportLink.SetOptionsPagination
  (Value: TdxLayoutControlReportLinkOptionsPagination);
begin
  inherited OptionsPagination := Value;
end;

procedure TdxLayoutControlReportLink.SetOptionsSize
  (Value: TdxLayoutControlReportLinkOptionsSize);
begin
  OptionsSize.Assign(Value);
end;

procedure TdxLayoutControlReportLink.SetOptionsTransparent
  (Value: TdxLayoutControlReportLinkOptionsTransparent);
begin
...
begin
  ...
  chbxSkipEmptyGroups.Checked := LayoutReportLink.OptionsBehavior.
    SkipEmptyGroups;
  chbxUnwrapTabs.Checked := LayoutReportLink.OptionsBehavior.UnwrapTabs;
  chbxRiseActiveTabOntoTop.Checked :=
    LayoutReportLink.OptionsBehavior.ActiveTabToTop;
...
procedure TdxPSLayoutControlDesignWindow.SetOptionsGroupsByIndex
...
begin
  ...
  begin
    case AnIndex of
      0:
        LayoutReportLink.OptionsBehavior.ExpandGroups := AValue;
      1:
        LayoutReportLink.OptionsBehavior.SkipEmptyGroups := AValue;
    end;
    Modified := True;
  end
  else
...
procedure TdxPSLayoutControlDesignWindow.SetOptionsPaginationByIndex
  (AnIndex: Integer; AValue: Boolean);
begin
  if LockControlsUpdate then
    Exit;
  ...
  begin
    case AnIndex of
      2:
        LayoutReportLink.OptionsPagination.Groups := AValue;
      3:
        LayoutReportLink.OptionsPagination.Items := AValue;
    end;
    Modified := True;
  end
  else
...
procedure TdxPSLayoutControlDesignWindow.SetOptionsTabsByIndex(AnIndex: Integer;
  AValue: Boolean);
begin
  if LockControlsUpdate then
    Exit;
  ...
  begin
    case AnIndex of
      0:
        LayoutReportLink.OptionsBehavior.UnwrapTabs := AValue;
      1:
        LayoutReportLink.OptionsBehavior.ActiveTabToTop := AValue;
    end;
    Modified := True;
  end
  else
...
procedure TdxPSLayoutControlDesignWindow.SetOptionsTransparentByIndex
  (AnIndex: Integer; AValue: Boolean);
begin
  if LockControlsUpdate then
    Exit;
  ...
  begin
    case AnIndex of
      4:
        LayoutReportLink.OptionsTransparent.Groups := AValue;
      5:
        LayoutReportLink.OptionsTransparent.Items := AValue;
    end;
    Modified := True;
  end
  else
...
begin
  Result := inherited IsBoldNode(ANode) or
    (TreeView_GetNodeObject(ANode).Component is TdxCustomLayoutGroup);
end;

function TdxPSLayoutControlDesignWindow.GetLayoutReportLink
  : TdxLayoutControlReportLink;
begin
...
dxPSRegisterReportLink(TdxLayoutControlReportLink, TdxLayoutControl,
  TdxPSLayoutControlDesignWindow);

finalization

dxPSUnregisterReportLink(TdxLayoutControlReportLink, TdxLayoutControl,
  TdxPSLayoutControlDesignWindow);
