...
dxPSRegisterReportLink(TdxTreeViewExReportLink, TdxTreeView,
  TdxfmTVReportLinkDesignWindow);
dxPSRegisterReportLink(TdxDBTreeViewReportLink, TdxDBTreeView,
  TdxfmTVReportLinkDesignWindow);

finalization

dxPSUnRegisterReportLink(TdxTreeViewReportLink, TdxDBTreeView,
  TdxfmTVReportLinkDesignWindow);
dxPSUnRegisterReportLink(TdxTreeViewExReportLink, TdxTreeView,
  TdxfmTVReportLinkDesignWindow);
