...
{$ENDIF}
  ...
  Menus, ImgList, cxClasses, dxCore, cxControls, cxGraphics, cxLookAndFeels,
  cxStyles,
  cxCustomData, cxInplaceContainer, cxVGrid, cxDBVGrid, cxOI, cxEdit,
  cxTextEdit,
  cxMemo, cxImage, dxBase, dxPSSngltn, dxPSGlbl, dxPScxCommon, dxPSCore,
  dxPrnPg,
  ...
  dxLayoutControl,
  dxLayoutcxEditAdapters, cxImageList, dxSpreadSheetStyles,
...
type
  ...
  TcxCustomVerticalGridReportLinkBuilderClass = class of
    TcxCustomVerticalGridReportLinkBuilder;
  TcxCustomVerticalGridReportLinkBuilder = class;
  TcxCustomVerticalGridReportLinkFormatterClass = class of
  ...
  protected
    procedure AddDelimiters(AReportLink
      : TcxCustomVerticalGridReportLink); virtual;
    ...
    property Formatter: TcxCustomVerticalGridReportLinkFormatter
      read FFormatter;
    ...
    property ValueAvailableWidths[RecordIndex: Integer]: Integer
      read GetValueAvailableWidth;
  public
    constructor Create(AFormatter: TcxCustomVerticalGridReportLinkFormatter;
      ARow: TcxCustomRow; AWrapIndex: Integer); virtual;
  ...
  public
    constructor Create(AFormatter: TcxCustomVerticalGridReportLinkFormatter;
      ARow: TcxCustomRow; AWrapIndex: Integer); override;
  ...
  private
    ...
    function GetValuePlace(RecordIndex: Integer)
  ...
  protected
    procedure AddDelimiters(AReportLink
      : TcxCustomVerticalGridReportLink); override;
    ...
    function DoesItemParticipateInBestFitCalculation(ARecordIndex
      : Integer): Boolean;
    function MeasureWidth(ARecordIndex: Integer): Integer;

    function Row: TcxCustomEditorRow; reintroduce; overload;
    function RowHelper: TcxVerticalGridCustomEditorRowHelper;
      reintroduce; overload;

    property HeaderFont: TFont read GetHeaderFont;
    property Properties[RecordIndex: Integer]: TcxCustomEditProperties
      read GetProperty;
  ...
  public
    ...
    property ValuePlaces[RecordIndex: Integer]: TcxVerticalGridRowElementPlace
      read GetValuePlace;
  end;

  TcxVerticalGridCustomMultiEditorRowPlace = class
  ...
  private
    ...
    function GetHeaderSeparatorPlace(CellIndex: Integer)
      : TcxVerticalGridRowElementPlace;
    ...
    function GetProperty(CellIndex, RecordIndex: Integer)
    ...
    function GetValuePlace(CellIndex, RecordIndex: Integer)
      : TcxVerticalGridRowElementPlace;
    function GetValuePlaceCount: Integer;
    function GetValueSeparatorCount: Integer;
    function GetValueSeparatorFlatIndex(CellIndex,
      RecordIndex: Integer): Integer;
    function GetValueSeparatorPlace(CellIndex, RecordIndex: Integer)
      : TcxVerticalGridRowElementPlace;
  ...
  protected
    ...
    procedure CalculatePartWidths(AnAutoWidthObject: TcxAutoWidthObject;
    ...
    function DoesItemParticipateInBestFitCalculation(ACellIndex,
    ...
    function RowHelper: TcxVerticalGridCustomMultiEditorRowHelper;
      reintroduce; overload;
    ...
    property HeaderSeparatorsFonts[Index: Integer]: TFont
      read GetHeaderSeparatorsFont;
    property Properties[CellIndex, RecordIndex: Integer]
      : TcxCustomEditProperties read GetProperty;
    property ValueFlatIndexes[CellIndex, RecordIndex: Integer]: Integer
      read GetValueFlatIndex;
    property ValueFonts[CellIndex, RecordIndex: Integer]: TFont
      read GetValueFont;
    property Values[CellIndex, RecordIndex: Integer]: TcxEditValue
      read GetValue;
    property ValueSeparatorCount: Integer read GetValueSeparatorCount;
    property ValueSeparatorFlatIndexes[CellIndex, RecordIndex: Integer]: Integer
      read GetValueSeparatorFlatIndex;
    property ValueSeparatorsAreas[RecordIndex: Integer]: Integer
      read GetValueSeparatorsArea;
    property ValueSeparatorsFonts[CellIndex, RecordIndex: Integer]: TFont
      read GetValueSeparatorsFont;
    property ValuesOffset: Integer read GetValuesOffset;
  public
    constructor Create(AFormatter: TcxCustomVerticalGridReportLinkFormatter;
      ARow: TcxCustomRow; AWrapIndex: Integer); override;
    ...
    property HeaderPlaces[CellIndex: Integer]: TcxVerticalGridRowElementPlace
      read GetHeaderPlace;
    property HeaderSeparatorPlaceCount: Integer
      read GetHeaderSeparatorPlaceCount;
    property HeaderSeparatorPlaces[CellIndex: Integer]
      : TcxVerticalGridRowElementPlace read GetHeaderSeparatorPlace;
    property ValuePlaceCount: Integer read GetValuePlaceCount;
    property ValuePlaces[CellIndex, RecordIndex: Integer]
      : TcxVerticalGridRowElementPlace read GetValuePlace;
    property ValueSeparatorPlaceCount: Integer read GetValueSeparatorPlaceCount;
    property ValueSeparatorPlaces[CellIndex, RecordIndex: Integer]
      : TcxVerticalGridRowElementPlace read GetValueSeparatorPlace;
  end;

  { Row Producers }

  TcxVerticalGridReportLinkCustomElementProducerClass = class of
  ...
  protected
    ...
    property WrapIndex: Integer read FWrapIndex;
  public
    constructor Create(ABuilder
      : TcxCustomVerticalGridReportLinkBuilder); virtual;
    ...
    function Formatter: TcxCustomVerticalGridReportLinkFormatter;
      overload; virtual;

    function Produce(AHostInfo: TcxVerticalGridHostInfo; AWrapIndex: Integer)
  ...
  TcxVerticalGridReportLinkWrapSeparatorProducerClass = class of
    TcxVerticalGridReportLinkWrapSeparatorProducer;

  TcxVerticalGridReportLinkWrapSeparatorProducer = class
    (TcxVerticalGridReportLinkCustomElementProducer)
  private
  ...
  TcxVerticalGridReportLinkCustomRowProducerClass = class of
    TcxVerticalGridReportLinkCustomRowProducer;

  TcxVerticalGridReportLinkCustomRowProducer = class
    (TcxVerticalGridReportLinkCustomElementProducer)
  private
  ...
  protected
    ...
    function DoesItemParticipateInRowAutoHeightCalculation
      (AnItem: TAbstractdxReportCellData): Boolean; virtual;
    procedure FixupRowDataHeight; virtual;
    procedure FixupRowHeight; virtual;
    procedure FixupRowItselfHeight; virtual;
    procedure InitializeRow; override;
    procedure InitializeRowIndent(AnItem: TdxReportCellExpandButton;
  ...
  public
    constructor Create(ABuilder
      : TcxCustomVerticalGridReportLinkBuilder); override;
    destructor Destroy; override;
  ...
  TcxVerticalGridReportLinkCategoryRowProducer = class
    (TcxVerticalGridReportLinkCustomRowProducer)
  private
  ...
  public
    ...
    function GridRowHelper: TcxVerticalGridCategoryRowHelper;
      reintroduce; overload;
    function GridRowPlace: TcxVerticalGridCategoryRowPlace;
      reintroduce; overload;

    property CategoryBounds: TRect read GetCategoryBounds;
  end;

  TcxVerticalGridReportLinkCustomEditableRowProducer = class
    (TcxVerticalGridReportLinkCustomRowProducer)
  private
    FHeaders: TList;
    FValues: TList;
  ...
  protected
    ...
    function CreateHeaderItem(AParent: TdxReportCell; ACellIndex: Integer)
      : TdxReportCellImage;
    function CreateValueItem(AParent: TdxReportCell;
      ACellIndex, ARecordIndex: Integer): TAbstractdxReportCellData;
    procedure DoInitializeHeader(AnItem: TdxReportCellImage;
      AnIndex: Integer); virtual;
    procedure DoInitializeValue(AnItem: TAbstractdxReportCellData;
      ACellIndex, ARecordIndex: Integer); virtual;
    function DoesItemParticipateInRowAutoHeightCalculation
      (AnItem: TAbstractdxReportCellData): Boolean; override;
  ...
  TcxVerticalGridReportLinkCustomEditorRowProducer = class
  ...
  public
    ...
    function GridRowHelper: TcxVerticalGridCustomEditorRowHelper;
      reintroduce; overload;
    function GridRowPlace: TcxVerticalGridCustomEditorRowPlace;
      reintroduce; overload;
  ...
  TcxVerticalGridReportLinkCustomMultiEditorRowProducer = class
    (TcxVerticalGridReportLinkCustomEditableRowProducer)
  private
    ...
    function GetValue(CellIndex, RecordIndex: Integer)
  ...
  protected
    ...
    procedure DoInitializeHeaderSeparator(AnItem: TdxReportCellString;
      AnIndex: Integer); virtual;
    procedure DoInitializeValueSeparator(AnItem: TdxReportCellString;
      AnIndex, ARecordIndex: Integer); virtual;

    property HasHeaderSeparators: Boolean read GetHasHeaderSeparators;
    property HasValueSeparators: Boolean read GetHasValueSeparators;
    property HeaderBounds[Index: Integer]: TRect read GetHeaderBounds;
    property HeaderSeparatorBounds[Index: Integer]: TRect
      read GetHeaderSeparatorBounds;
    property HeaderSeparatorTexts[Index: Integer]: string
      read GetHeaderSeparatorText;
    property ValueSeparatorBounds[Index, RecordIndex: Integer]: TRect
      read GetValueSeparatorBounds;
    property ValueBounds[CellIndex, RecordIndex: Integer]: TRect
      read GetValueBounds;
    property ValueSeparatorTexts[Index: Integer]: string
      read GetValueSeparatorText;
  public
    constructor Create(ABuilder
      : TcxCustomVerticalGridReportLinkBuilder); override;
    destructor Destroy; override;
    ...
    function GridRowHelper: TcxVerticalGridCustomMultiEditorRowHelper;
      reintroduce; overload;
    function GridRowPlace: TcxVerticalGridCustomMultiEditorRowPlace;
      reintroduce; overload;

    property HeaderCount;
    property Headers;
    property HeaderSeparatorCount: Integer read GetHeaderSeparatorCount;
    property HeaderSeparators[Index: Integer]: TdxReportCellString
      read GetHeaderSeparator;
    property ValueCount;
    property Values[CellIndex, RecordIndex: Integer]: TAbstractdxReportCellData
      read GetValue;
    property ValueSeparatorCount: Integer read GetValueSeparatorCount;
    property ValueSeparators[Index: Integer]: TdxReportCellString
      read GetValueSeparator;
  end;
  ...
  protected
    ...
    function GetEditProperties(Index, RecordIndex: Integer)
    ...
    property SeparatorsAlignmentVert: TcxAlignmentVert
      read GetSeparatorsAlignmentVert;
  public
    ...
    class function ProducerClass
      : TcxVerticalGridReportLinkCustomRowProducerClass; virtual;
    function Properties(Index: Integer): TcxCustomRowProperties;
      overload; virtual;
    function Row: TcxCustomRow; overload; virtual;
    class function RowClass: TcxCustomRowClass; virtual;
    class function RowPlaceClass: TcxVerticalGridCustomRowPlaceClass; virtual;

    property DisplayTexts[Index, RecordIndex: Integer]: string
      read GetDisplayText;
    property EditProperties[Index, RecordIndex: Integer]
      : TcxCustomEditProperties read GetEditProperties;
    property HasHeaderImages[Index: Integer]: Boolean read GetHasHeaderImage;
    property HeaderAlignmentHorzs[Index: Integer]: TcxTextAlignX
      read GetHeaderAlignmentHorz;
    property HeaderAlignmentVerts[Index: Integer]: TcxTextAlignY
      read GetHeaderAlignmentVert;
  ...
  public
    class function ProducerClass
      : TcxVerticalGridReportLinkCustomRowProducerClass; override;
    function Properties(Index: Integer): TcxCaptionRowProperties;
      reintroduce; overload;
    function Row: TcxCategoryRow; reintroduce; overload;
  ...
  public
    class function ProducerClass
      : TcxVerticalGridReportLinkCustomRowProducerClass; override;
    function Properties(Index: Integer): TcxCustomEditorRowProperties;
      reintroduce; overload;
    function Row: TcxCustomEditorRow; reintroduce; overload;
    class function RowClass: TcxCustomRowClass; override;
    class function RowPlaceClass: TcxVerticalGridCustomRowPlaceClass; override;
  ...
  public
    function Properties(Index: Integer): TcxEditorRowProperties;
      reintroduce; overload;
  ...
  public
    function Properties(Index: Integer): TcxDBEditorRowProperties;
      reintroduce; overload;
  ...
  public
    class function ProducerClass
      : TcxVerticalGridReportLinkCustomRowProducerClass; override;
    function Properties(Index: Integer): TcxEditorRowItemProperties;
      reintroduce; overload;
  ...
  public
    ...
    property Helpers[Row: TcxCustomRow]: TcxVerticalGridCustomRowHelper
  ...
  private
    ...
    function GetItem(Index: Integer)
      : TcxVerticalGridReportLinkCustomRowProducer;
    function GetProducer(ProducerClass
      : TcxVerticalGridReportLinkCustomRowProducerClass)
      : TcxVerticalGridReportLinkCustomRowProducer;
  protected
    function IndexOf(AProducerClass
      : TcxVerticalGridReportLinkCustomRowProducerClass): Integer;
    property Items[Index: Integer]: TcxVerticalGridReportLinkCustomRowProducer
      read GetItem;
  public
    ...
    property Producers[ProducerClass
      : TcxVerticalGridReportLinkCustomRowProducerClass]
      : TcxVerticalGridReportLinkCustomRowProducer read GetProducer; default;
  end;
  ...
  protected
    ...
    function GetRowProducer(ARow: TcxCustomRow)
      : TcxVerticalGridReportLinkCustomRowProducer;
    function GetRowProducerClass(ARow: TcxCustomRow)
      : TcxVerticalGridReportLinkCustomRowProducerClass; virtual;
    function GetWrapSeparatorProducer(AWrapIndex: Integer)
      : TcxVerticalGridReportLinkWrapSeparatorProducer;
    function GetWrapSeparatorProducerClass
      : TcxVerticalGridReportLinkWrapSeparatorProducerClass; virtual;

    function AreWrapSeparatorsNeeded: Boolean;
    procedure DoBuild; virtual;
    function IsAborted: Boolean;

    property ProducerCache: TcxVerticalGridReportLinkProducerCache
      read FProducerCache;
  ...
  public
    ...
    function Formatter: TcxCustomVerticalGridReportLinkFormatter;
      overload; virtual;
    class function FormatterClass
      : TcxCustomVerticalGridReportLinkFormatterClass; virtual;
  ...
  protected
    ...
    { properties }
    function GetProperties(ARow: TcxCustomRow; AnIndex, ARecordIndex: Integer)
      : TcxCustomEditProperties;
    function GetPropertiesClass(ARow: TcxCustomRow;
    ...
    function GetContentViewParams(ARow: TcxCustomRow;
      AnIndex, ARecordIndex: Integer): TcxViewParams; virtual;
    ...
    function TryGetAdvancedStyle(ARow: TcxCustomRow;
      ACellIndex, ARecordIndex: Integer;
      out AStyle: TdxSpreadSheetCellDisplayStyle): Boolean; virtual;
    { backgrounds }
    function GetBackgroundBitmap(Index: Integer): TBitmap;
    function GetRowIndentBackgroundBitmapIndex(ARow: TcxCustomRow;
    ...
    function GetRowParentAtLevel(ARow: TcxCustomRow; Alevel: Integer)
      : TcxCustomRow;
    function HasCategoryRowAsParentAtLevel(ARow: TcxCustomRow; Alevel: Integer;
      ACheckFollow: Boolean): Boolean;
    function HasRowImage(ARow: TcxCustomRow; AnIndex: Integer): Boolean;
    function IsRowLastChildAtLevel(ARow: TcxCustomRow; Alevel: Integer)
      : Boolean;
  ...
  public
    ...
    property HeaderAvailableWidths[Row: TcxCustomRow]: Integer
      read GetHeaderAvailableWidth;
    ...
    property RecordCount: Integer read GetRecordCount;
    property RecordMinWidths[RecordIndex: Integer]: Integer
      read GetRecordMinWidth;
  ...
  TcxCustomVerticalGridReportLinkFormatter = class
    (TcxVerticalGridReportLinkBuilderHandler, IUnknown, IdxPSCellParams,
    IdxPSCellParams2)
  private
    FFont: TFont;
    ...
    function GetRowPlace(WrapIndex, Index: Integer)
      : TcxVerticalGridCustomRowPlace;
    function GetRowPlaceByRow(Row: TcxCustomRow; WrapIndex: Integer)
      : TcxVerticalGridCustomRowPlace;
  ...
  protected
    ...
    function CreateRowPlace(ARow: TcxCustomRow; AWrapIndex: Integer)
      : TcxVerticalGridCustomRowPlace; virtual;
    ...
    function GetRowHeaderSeparatorsFont(ARow: TcxCustomRow;
      AnIndex: Integer): TFont;
    function GetRowValueFont(ARow: TcxCustomRow;
      AnIndex, ARecordIndex: Integer): TFont;
    function GetRowValueSeparatorsFont(ARow: TcxCustomRow;
      AnIndex, ARecordIndex: Integer): TFont;

    procedure ClearRowPlaces;
    function FixupHorzCellSides(ARow: TcxCustomRow; ACellSides: TdxCellSides)
      : TdxCellSides;
    ...
    property AreRecordsNeededUnloading: Boolean
      read GetAreRecordsNeededUnloading;
    property DataController: TcxCustomDataController read GetDataController;
    property ScreenCanvas: TdxPSReportRenderCustomCanvas read GetScreenCanvas;
    ...
    property HeaderAvailableWidths[Row: TcxCustomRow]: Integer
      read GetHeaderAvailableWidth;
    property IndentAreas[Row: TcxCustomRow]: Integer read GetIndentArea;
    property InternalIndexesByRecordIndex[RecordIndex: Integer]: Integer
      read GetInternalIndexByRecordIndex;
    ...
    property RowHelpers[Row: TcxCustomRow]: TcxVerticalGridCustomRowHelper
      read GetRowHelper;
    property RowPlaceCount: Integer read GetRowPlaceCount;
    property RowPlaceFlatIndexes[WrapIndex, Index: Integer]: Integer
      read GetRowPlaceFlatIndex;
    property RowPlaces[WrapIndex, Index: Integer]: TcxVerticalGridCustomRowPlace
      read GetRowPlace;
    property RowPlacesByRow[Row: TcxCustomRow; WrapIndex: Integer]
      : TcxVerticalGridCustomRowPlace read GetRowPlaceByRow;
    property ViewWidths[WrapIndex: Integer]: Integer read GetViewWidth
      write SetViewWidth;
    property WrappedRecordStartIndexes[Index: Integer]: Integer
      read GetWrappedRecordStartIndex;
    property WrappedRecordStopIndexes[Index: Integer]: Integer
      read GetWrappedRecordStopIndex;
  public
    constructor Create(ABuilder
      : TcxCustomVerticalGridReportLinkBuilder); override;
    destructor Destroy; override;
    ...
    { Images }
    procedure DoInitializeRowImage(ARow: TcxCustomRow;
      AnItem: TdxReportCellGraphic; AnIndex: Integer); virtual;
    ...
    function GetRowImageViewParams(ARow: TcxCustomRow; AnIndex: Integer)
      : TdxReportItemViewParams; virtual;
    { Indents and Expand Buttons }
    procedure DoInitializeRowIndent(ARow: TcxCustomRow;
      AnItem: TdxReportCellExpandButton;
      AnIndex, AnIndentCount: Integer); virtual;
    procedure DoInitializeExpandButton(ARow: TcxCustomRow;
      AnItem: TdxReportCellExpandButton;
      AnIndex, AnIndentCount: Integer); virtual;
    procedure DoReportLinkInitializeRowIndent(ARow: TcxCustomRow;
      AnItem: TdxReportCellExpandButton; AnIndex: Integer); virtual;
    function GetRowIndentCellSides(ARow: TcxCustomRow;
      AnIndex, AnIndentCount: Integer): TdxCellSides; virtual;
    function GetRowIndentClass: TdxReportCellExpandButtonClass; virtual;
    function GetRowIndentViewParams(ARow: TcxCustomRow;
      AnIndex, AnIndentCount: Integer): TdxReportItemViewParams; virtual;
    { Rows }
    procedure DoInitializeCategoryRow(ARow: TcxCategoryRow;
      AnItem: TdxReportCellImage); virtual;
    procedure DoInitializeRowReportRow(ARow: TcxCustomRow;
      AReportRow: TdxReportCell); virtual;
    procedure DoInitializeRowHeader(ARow: TcxCustomRow;
      AnItem: TdxReportCellImage; AnIndex: Integer); virtual;
    procedure DoInitializeRowValue(ARow: TcxCustomRow;
      AnItem: TAbstractdxReportCellData;
      AnIndex, ARecordIndex: Integer); virtual;
    procedure DoReportLinkInitializeRowHeader(ARow: TcxCustomRow;
      AnItem: TdxReportCellImage; AnIndex: Integer); virtual;
    procedure DoReportLinkInitializeRowValue(ARow: TcxCustomRow;
      AnItem: TAbstractdxReportCellData;
      AnIndex, ARecordIndex: Integer); virtual;
    function GetCategoryRowCellSides(ARow: TcxCustomRow): TdxCellSides; virtual;
    function GetCategoryRowClass(ARow: TcxCustomRow)
      : TdxReportCellImageClass; virtual;
    function GetCategoryRowViewParams(ARow: TcxCustomRow)
      : TdxReportItemViewParams; virtual;
    function GetCellValue(ARow: TcxCustomRow;
      AProperties: TcxCustomEditProperties; AnIndex, ARecordIndex: Integer)
      : TcxEditValue; virtual;
    function GetRowHeaderCellSides(ARow: TcxCustomRow; AnIndex: Integer)
      : TdxCellSides; virtual;
    function GetRowHeaderClass(ARow: TcxCustomRow)
      : TdxReportCellImageClass; virtual;
    function GetRowHeaderViewParams(ARow: TcxCustomRow; AnIndex: Integer)
      : TdxReportItemViewParams; virtual;
    function GetRowValueCellSides(ARow: TcxCustomRow;
      AnIndex, ARecordIndex: Integer): TdxCellSides; virtual;
    function GetRowValueClass(ARow: TcxCustomRow; AIndex, ARecordIndex: Integer)
      : TdxReportCellDataClass; virtual;
    function GetRowValueViewParams(ARow: TcxCustomRow;
      AIndex, ARecordIndex: Integer): TdxReportItemViewParams; virtual;
    { Value and Header Separators }
    procedure DoInitializeRowHeaderSeparator(ARow: TcxCustomMultiEditorRow;
      AnItem: TdxReportCellString; AnIndex: Integer); virtual;
    procedure DoInitializeRowValueSeparator(ARow: TcxCustomMultiEditorRow;
      AnItem: TdxReportCellString; AnIndex, ARecordIndex: Integer); virtual;
    procedure DoReportLinkInitializeRowHeaderSeparator
      (ARow: TcxCustomMultiEditorRow; AnItem: TdxReportCellString;
      AnIndex: Integer); virtual;
    procedure DoReportLinkInitializeRowValueSeparator
      (ARow: TcxCustomMultiEditorRow; AnItem: TdxReportCellString;
      AnIndex, ARecordIndex: Integer); virtual;
    function GetRowHeaderSeparatorCellSides(ARow: TcxCustomMultiEditorRow)
      : TdxCellSides;
    function GetRowHeaderSeparatorClass(ARow: TcxCustomMultiEditorRow)
      : TdxReportCellStringClass; virtual;
    function GetRowHeaderSeparatorViewParams(ARow: TcxCustomMultiEditorRow;
      AnIndex: Integer): TdxReportItemViewParams; virtual;
    function GetRowValueSeparatorCellSides(ARow: TcxCustomMultiEditorRow)
      : TdxCellSides;
    function GetRowValueSeparatorClass(ARow: TcxCustomMultiEditorRow)
      : TdxReportCellStringClass; virtual;
    function GetRowValueSeparatorViewParams(ARow: TcxCustomMultiEditorRow;
      AnIndex, ARecordIndex: Integer): TdxReportItemViewParams; virtual;
    { Wrap Separators }
    procedure DoInitializeWrapSeparatorItem(AnItem: TdxReportCellString;
      AWrapIndex: Integer); virtual;
    ...
    property ExpandButtonColors[Row: TcxCustomRow]: TColor
      read GetExpandButtonColor;
    ...
    property InterRecordsSpace: Integer read GetInterRecordsSpace
      write SetInterRecordsSpace;
    property OptionsView: TcxVerticalGridReportLinkOptionsView
      read GetOptionsView;
    property RecordCounts[Index: Integer]: Integer read GetRecordCount;
    property RecordMinWidths[RecordIndex: Integer]: Integer
      read GetRecordMinWidth;
    property RecordWidths[RecordIndex: Integer]: Integer read GetRecordWidth
      write SetRecordWidth;
    property RowCount: Integer read GetRowCount;
    property RowHeights[Row: TcxCustomRow]: Integer read GetRowHeight
      write SetRowHeight;
    property Rows[Index: Integer]: TcxCustomRow read GetRow;
    ...
    property TransparentColor: TColor read FTransparentColor
      write FTransparentColor default clWindow;
  ...
  public
    ...
    property ReportLink: TcxCustomVerticalGridReportLink read GetReportLink;
  published
    property AutoExpandRows: Boolean read FAutoExpandRows
      write SetAutoExpandRows default False;
  end;

  TcxVerticalGridReportLinkOptionsFormatting = class
  ...
  published
    ...
    property ByWrapping: Boolean read FByWrapping write SetByWrapping
      default True;
    property OneWrappingPerPage: Boolean read FOneWrappingPerPage
      write SetOneWrappingPerPage default False;
  end;
  ...
  published
    ...
    property SuppressBackgroundBitmaps: Boolean
      read GetSuppressBackgroundBitmaps write SetSuppressBackgroundBitmaps
      stored False;
  end;
  ...
  published
    ...
    property KeepSameRecordWidths: Boolean read FKeepSameRecordWidths
      write SetKeepSameRecordWidths default True;
    property WrapRecords: Boolean read FWrapRecords write SetWrapRecords
      default True;
    property WrapSeparatorHeight: Integer read FWrapSeparatorHeight
      write SetWrapSeparatorHeight default 20;
  end;
  ...
  protected
    ...
    property Mode: TcxVerticalGridReportLinkPrintMode read FMode write SetMode
      default vpmLoadedRecords;
  public
    procedure Assign(Source: TPersistent); override;
    procedure RestoreDefaults; override;
  ...
  published
    ...
    property ExpandButtons: Boolean read FExpandButtons write SetExpandButtons
      default True;
  ...
  TcxVerticalGridReportLinkStylesClass = class of
  ...
  public
    ...
    procedure GetCategoryParams(ARow: TcxCustomRow;
      out AParams: TcxViewParams); virtual;
    procedure GetContentParams(ARow: TcxCustomRow;
      AnIndex, ARecordIndex: Integer; out AParams: TcxViewParams); virtual;
    procedure GetHeaderParams(ARow: TcxCustomRow;
      out AParams: TcxViewParams); virtual;
    procedure GetIndentParams(ARow: TcxCustomRow;
      out AParams: TcxViewParams); virtual;

    property ReportLink: TcxCustomVerticalGridReportLink read GetReportLink;
  published
    property Category: TcxStyle Index vspsVGridCategory read GetValue
      write SetValue;
    property Content: TcxStyle Index vspsVGridContent read GetValue
      write SetValue;
    property Header: TcxStyle Index vspsVGridHeader read GetValue
      write SetValue;
    property StyleSheet;
  end;
  ...
  published
    property Styles: TcxVerticalGridReportLinkStyles read GetStylesValue
  ...
  TcxVerticalGridReportLinkCustomDrawRowHeaderCellEvent = procedure
    (Sender: TcxCustomVerticalGridReportLink; ACanvas: TCanvas;
    ARow: TcxCustomRow; ACellIndex: Integer; AnItem: TdxReportCellImage;
    var ADone: Boolean) of object;

  TcxVerticalGridReportLinkCustomDrawRowHeaderSeparatorCellEvent = procedure
    (Sender: TcxCustomVerticalGridReportLink; ACanvas: TCanvas;
    ARow: TcxCustomRow; AnIndex: Integer; AnItem: TdxReportCellString;
    var ADone: Boolean) of object;

  TcxVerticalGridReportLinkCustomDrawRowIndentCellEvent = procedure
    (Sender: TcxCustomVerticalGridReportLink; ACanvas: TCanvas;
    ARow: TcxCustomRow; AnIndex: Integer; AnItem: TdxReportCellExpandButton;
    var ADone: Boolean) of object;

  TcxVerticalGridReportLinkCustomDrawRowValueCellEvent = procedure
    (Sender: TcxCustomVerticalGridReportLink; ACanvas: TCanvas;
    ARow: TcxCustomRow; ACellIndex, ARecordIndex: Integer;
    AnItem: TAbstractdxReportCellData; var ADone: Boolean) of object;

  TcxVerticalGridReportLinkCustomDrawRowValueSeparatorCellEvent = procedure
    (Sender: TcxCustomVerticalGridReportLink; ACanvas: TCanvas;
    ARow: TcxCustomRow; ACellIndex, ARecordIndex: Integer;
  ...
  TcxVerticalGridReportLinkInitializeRowHeaderCellEvent = procedure
    (Sender: TcxCustomVerticalGridReportLink; ARow: TcxCustomRow;
    ACellIndex: Integer; AnItem: TdxReportCellImage) of object;

  TcxVerticalGridReportLinkInitializeRowHeaderSeparatorCellEvent = procedure
    (Sender: TcxCustomVerticalGridReportLink; ARow: TcxCustomRow;
    AnIndex: Integer; AnItem: TdxReportCellString) of object;

  TcxVerticalGridReportLinkInitializeRowIndentCellEvent = procedure
    (Sender: TcxCustomVerticalGridReportLink; ARow: TcxCustomRow;
    AnIndex: Integer; AnItem: TdxReportCellExpandButton) of object;

  TcxVerticalGridReportLinkInitializeRowValueCellEvent = procedure
    (Sender: TcxCustomVerticalGridReportLink; ARow: TcxCustomRow;
    ACellIndex, ARecordIndex: Integer; AnItem: TAbstractdxReportCellData)
    of object;

  TcxVerticalGridReportLinkInitializeRowValueSeparatorCellEvent = procedure
    (Sender: TcxCustomVerticalGridReportLink; ARow: TcxCustomRow;
    ACellIndex, ARecordIndex: Integer; AnItem: TdxReportCellString) of object;
  ...
  private
    ...
    FOnCustomDrawRowHeaderCell
      : TcxVerticalGridReportLinkCustomDrawRowHeaderCellEvent;
    FOnCustomDrawRowHeaderSeparatorCell
      : TcxVerticalGridReportLinkCustomDrawRowHeaderSeparatorCellEvent;
    FOnCustomDrawRowIndentCell
      : TcxVerticalGridReportLinkCustomDrawRowIndentCellEvent;
    FOnCustomDrawRowValueCell
      : TcxVerticalGridReportLinkCustomDrawRowValueCellEvent;
    FOnCustomDrawRowValueSeparatorCell
      : TcxVerticalGridReportLinkCustomDrawRowValueSeparatorCellEvent;
    FOnInitializeRowHeaderCell
      : TcxVerticalGridReportLinkInitializeRowHeaderCellEvent;
    FOnInitializeRowHeaderSeparatorCell
      : TcxVerticalGridReportLinkInitializeRowHeaderSeparatorCellEvent;
    FOnInitializeRowIndentCell
      : TcxVerticalGridReportLinkInitializeRowIndentCellEvent;
    FOnInitializeRowValueCell
      : TcxVerticalGridReportLinkInitializeRowValueCellEvent;
    FOnInitializeRowValueSeparatorCell
    ...
    procedure SetOnCustomDrawRowHeaderCell
      (Value: TcxVerticalGridReportLinkCustomDrawRowHeaderCellEvent);
    procedure SetOnCustomDrawRowHeaderSeparatorCell
      (Value: TcxVerticalGridReportLinkCustomDrawRowHeaderSeparatorCellEvent);
    procedure SetOnCustomDrawRowIndentCell
      (Value: TcxVerticalGridReportLinkCustomDrawRowIndentCellEvent);
    procedure SetOnCustomDrawRowValueCell
      (Value: TcxVerticalGridReportLinkCustomDrawRowValueCellEvent);
    procedure SetOnCustomDrawRowValueSeparatorCell
      (Value: TcxVerticalGridReportLinkCustomDrawRowValueSeparatorCellEvent);
    procedure SetOptionsExpanding
      (Value: TcxVerticalGridReportLinkOptionsExpanding);
    procedure SetOptionsFormatting
      (Value: TcxVerticalGridReportLinkOptionsFormatting);
    procedure SetOptionsPagination
      (Value: TcxVerticalGridReportLinkOptionsPagination);
    procedure SetOptionsRefinements
      (Value: TcxVerticalGridReportLinkOptionsRefinements);
  ...
  protected
    ...
    procedure DoCustomDrawRowHeaderCell(ACanvas: TCanvas; ARow: TcxCustomRow;
      AnIndex: Integer; AnItem: TdxReportCellImage;
      var ADone: Boolean); dynamic;
    procedure DoCustomDrawRowHeaderSeparatorCell(ACanvas: TCanvas;
      ARow: TcxCustomRow; AnIndex: Integer; AnItem: TdxReportCellString;
      var ADone: Boolean); dynamic;
    ...
    procedure DoCustomDrawRowValueCell(ACanvas: TCanvas; ARow: TcxCustomRow;
      ACellIndex, ARecordIndex: Integer; AnItem: TAbstractdxReportCellData;
      var ADone: Boolean); dynamic;
    procedure DoCustomDrawRowValueSeparatorCell(ACanvas: TCanvas;
      ARow: TcxCustomRow; ACellIndex, ARecordIndex: Integer;
    ...
    procedure DoInitializeRowHeaderSeparatorCell(ARow: TcxCustomRow;
      AnIndex: Integer; AnItem: TdxReportCellString); dynamic;
    procedure DoInitializeRowIndentCell(ARow: TcxCustomRow; AnIndex: Integer;
      AnItem: TdxReportCellExpandButton); dynamic;
    procedure DoInitializeRowValueCell(ARow: TcxCustomRow;
      ACellIndex, ARecordIndex: Integer;
    ...
    class function GetBuilderClass
      : TcxCustomVerticalGridReportLinkBuilderClass; virtual;

    // CustomDraw
    procedure ExtractCustomDrawCodeDataValues(ACode: Integer;
      var AnAttribute: TcxVerticalGridAttributeID;
      var ACellIndex, ARecordIndex: Integer);
    function GetItemCustomDrawInfo(AnItem: TdxReportVisualItem;
      out ADrawInfo: TcxVerticalGridCellCustomDrawInfo)
      : TcxVerticalGridAttributeID; virtual;
    function IsCustomDrawn(AnAttributeID: TcxVerticalGridAttributeID)
      : Boolean; virtual;
    function MakeCustomDrawCodeData(AnAttribute: TcxVerticalGridAttributeID;
      ACellIndex, ARecordIndex: Integer): Integer;
    ...
    procedure UpdateStatePrintModeControl(AControl: TcxComboBox;
      ALayoutItem: TdxLayoutItem); virtual;
  ...
  public
    ...
    destructor Destroy; override;
    property DesignWindow: TcxfmVerticalGridReportLinkDesignWindow
      read GetDesignWindow;
  published
    property Color;
    property Font;
    property OptionsExpanding: TcxVerticalGridReportLinkOptionsExpanding
      read GetOptionsExpanding write SetOptionsExpanding;
    property OptionsFormatting: TcxVerticalGridReportLinkOptionsFormatting
      read GetOptionsFormatting write SetOptionsFormatting;
    property OptionsPagination: TcxVerticalGridReportLinkOptionsPagination
      read GetOptionsPagination write SetOptionsPagination;
    property OptionsRefinements: TcxVerticalGridReportLinkOptionsRefinements
      read GetOptionsRefinements write SetOptionsRefinements;
    property OptionsSize: TcxVerticalGridReportLinkOptionsSize
      read GetOptionsSize write SetOptionsSize;
    property OptionsView: TcxVerticalGridReportLinkOptionsView
      read GetOptionsView write SetOptionsView;
    property ScaleFonts;
    property StyleRepository;
    property Styles: TcxVerticalGridReportLinkStyles read GetStyles
      write SetStyles;
    property SupportedCustomDraw;

    property OnCustomDrawRowHeaderCell
      : TcxVerticalGridReportLinkCustomDrawRowHeaderCellEvent
      read FOnCustomDrawRowHeaderCell write SetOnCustomDrawRowHeaderCell;
    property OnCustomDrawRowHeaderSeparatorCell
      : TcxVerticalGridReportLinkCustomDrawRowHeaderSeparatorCellEvent
      read FOnCustomDrawRowHeaderSeparatorCell
      write SetOnCustomDrawRowHeaderSeparatorCell;
    property OnCustomDrawRowIndentCell
      : TcxVerticalGridReportLinkCustomDrawRowIndentCellEvent
      read FOnCustomDrawRowIndentCell write SetOnCustomDrawRowIndentCell;
    property OnCustomDrawRowValueCell
      : TcxVerticalGridReportLinkCustomDrawRowValueCellEvent
      read FOnCustomDrawRowValueCell write SetOnCustomDrawRowValueCell;
    property OnCustomDrawRowValueSeparatorCell
      : TcxVerticalGridReportLinkCustomDrawRowValueSeparatorCellEvent
      read FOnCustomDrawRowValueSeparatorCell
      write SetOnCustomDrawRowValueSeparatorCell;
    property OnInitializeRowHeaderCell
      : TcxVerticalGridReportLinkInitializeRowHeaderCellEvent
      read FOnInitializeRowHeaderCell write FOnInitializeRowHeaderCell;
    property OnInitializeRowHeaderSeparatorCell
      : TcxVerticalGridReportLinkInitializeRowHeaderSeparatorCellEvent
      read FOnInitializeRowHeaderSeparatorCell
      write FOnInitializeRowHeaderSeparatorCell;
    property OnInitializeRowIndentCell
      : TcxVerticalGridReportLinkInitializeRowIndentCellEvent
      read FOnInitializeRowIndentCell write FOnInitializeRowIndentCell;
    property OnInitializeRowValueCell
      : TcxVerticalGridReportLinkInitializeRowValueCellEvent
      read FOnInitializeRowValueCell write FOnInitializeRowValueCell;
    property OnInitializeRowValueSeparatorCell
      : TcxVerticalGridReportLinkInitializeRowValueSeparatorCellEvent
      read FOnInitializeRowValueSeparatorCell
      write FOnInitializeRowValueSeparatorCell;
  end;

  TcxUnboundVerticalGridReportLinkBuilder = class
    (TcxCustomVerticalGridReportLinkBuilder)
  public
  ...
  protected
    class function GetBuilderClass
      : TcxCustomVerticalGridReportLinkBuilderClass; override;
  end;
  ...
  TcxVirtualVerticalGridReportLinkBuilder = class
    (TcxCustomVerticalGridReportLinkBuilder)
  public
    class function AdapterClass: TcxCustomVerticalGridAdapterClass; override;
    class function FormatterClass
      : TcxCustomVerticalGridReportLinkFormatterClass; override;
  end;
  ...
  TcxVirtualVerticalGridReportLinkFormatter = class
    (TcxCustomVerticalGridReportLinkFormatter)
  protected
  ...
  TcxVirtualVerticalGridReportLinkOptionsView = class
  ...
  private
    ...
    procedure SetOptionsView
      (Value: TcxVirtualVerticalGridReportLinkOptionsView);
  protected
    procedure InternalRestoreFromOriginal; override;
    ...
    procedure UpdateStatePrintModeControl(AControl: TcxComboBox;
      ALayoutItem: TdxLayoutItem); override;
  public
    property VirtualVerticalGrid: TcxVirtualVerticalGrid
      read GetVirtualVerticalGrid;
  published
    property OptionsView: TcxVirtualVerticalGridReportLinkOptionsView
      read GetOptionsView write SetOptionsView;
  end;

  { DBVericalGrid }

  TcxDBVerticalGridReportLinkBuilder = class
  ...
  TcxDBVerticalGridReportLinkFormatter = class
  ...
  public
    property DataController: TcxDBVerticalGridDataController
      read GetDataController;
  end;
  ...
  protected
    class function GetBuilderClass: TcxCustomVerticalGridReportLinkBuilderClass;
      override;
  public
  ...
  private
    ...
    procedure CustomDrawTextRect(ACanvas: TcxCanvas; AViewInfo: TcxRowValueInfo;
      const AText: string);
    ...
    procedure UpdatePreviewVerticalGridStyles(const ACaption: string;
      AStyle: TcxStyle);
...
uses
  ...
  cxGeometry, cxDataUtils, cxDataStorage, dxPSRes, dxPSImgs, dxPSUtl, dxBkgnd,
  dxPSPopupMan, dxPSdxSpreadSheetLnk,
...
type
  ...
  private
    function GetHelperClass(Row: TcxCustomRow)
      : TcxVerticalGridCustomRowHelperClass;
  public
    class function Instance: TcxVerticalGridRowHelperFactory;
      reintroduce; overload;
    property HelperClasses[Row: TcxCustomRow]
      : TcxVerticalGridCustomRowHelperClass read GetHelperClass; default;
  end;
...
function CustomMultiEditorRow_GetProperties(AInstance: TcxCustomMultiEditorRow)
...
function CustomRow_GetProperties(AInstance: TcxCustomRow)
...
function CustomVerticalGrid_GetCategoryFont
  (AInstance: TcxCustomVerticalGrid): TFont;
begin
  Result := TcxCustomVerticalGridAccess(AInstance).CategoryFont;
end;

function CustomVerticalGrid_GetDataController(AInstance: TcxCustomVerticalGrid)
  : TcxCustomDataController;
begin
  Result := TcxCustomVerticalGridAccess(AInstance).DataController;
end;

function CustomVerticalGrid_GetRecordCount
  (AInstance: TcxCustomVerticalGrid): Integer;
begin
...
function UnboundVerticalGrid_GetLayoutStyle(AInstance: TcxUnboundVerticalGrid)
...
function DefaultdxPScxVerticalGridLinkStyleSheet
...
begin
  ...
  begin
    FDefaultdxPScxVerticalGridLinkStyleSheet :=
      TcxVerticalGridReportLinkStyleSheet.Create(nil);
    with FDefaultdxPScxVerticalGridLinkStyleSheet.Styles as
      TcxVerticalGridReportLinkStyles do
    begin
      Category := CreateStyle(dxPSCore.dxDefaultFixedColor,
...
class function TcxVerticalGridRowHelperFactory.Instance
  : TcxVerticalGridRowHelperFactory;
begin
  Result := inherited Instance as TcxVerticalGridRowHelperFactory;
end;

function TcxVerticalGridRowHelperFactory.GetHelperClass(Row: TcxCustomRow)
  : TcxVerticalGridCustomRowHelperClass;
begin
...
constructor TcxVerticalGridCustomRowPlace.Create
  (AFormatter: TcxCustomVerticalGridReportLinkFormatter; ARow: TcxCustomRow;
  AWrapIndex: Integer);
begin
  inherited Create;
...
procedure TcxVerticalGridCustomRowPlace.AddDelimiters
  (AReportLink: TcxCustomVerticalGridReportLink);
begin
end;
...
function TcxVerticalGridCustomRowPlace.CalculatedRecordWidth
  (ARecordIndex: Integer): Integer;
begin
  Result := 0;
end;

function TcxVerticalGridCustomRowPlace.CalculatedTextPatternHeight
  (AFont: TFont): Integer;
begin
...
function TcxVerticalGridCustomRowPlace.GetValueAvailableWidth
  (RecordIndex: Integer): Integer;
begin
...
function TcxVerticalGridCustomRowPlace.RowHelper
  : TcxVerticalGridCustomRowHelper;
begin
  Result := Formatter.RowHelpers[Row];
end;

function TcxVerticalGridCustomRowPlace.GetScreenCanvas
...
function TcxVerticalGridCustomRowPlace.GetRecordWidth
  (RecordIndex: Integer): Integer;
begin
  Result := Formatter.RecordWidths[RecordIndex];
end;
...
constructor TcxVerticalGridCategoryRowPlace.Create
  (AFormatter: TcxCustomVerticalGridReportLinkFormatter; ARow: TcxCustomRow;
  AWrapIndex: Integer);
begin
  inherited;
...
function TcxVerticalGridCategoryRowPlace.RowHelper
...
constructor TcxVerticalGridCustomEditorRowPlace.Create
  (AFormatter: TcxCustomVerticalGridReportLinkFormatter; ARow: TcxCustomRow;
  AWrapIndex: Integer);
begin
  inherited;
...
procedure TcxVerticalGridCustomEditorRowPlace.AddDelimiters
  (AReportLink: TcxCustomVerticalGridReportLink);
var
  I: Integer;
begin
  ...
  begin
    ...
    AReportLink.AddHorizontalDelimiter(ValuePlaces[I].Offset + ValuePlaces
      [I].Width);
  end;
end;
...
begin
  ...
  for I := 0 to RecordCount - 1 do
    RowMinHeight := Max(RowMinHeight,
      CalculatedTextPatternHeight(ValueFonts[I]));
  Result := Max(Result, Max(HeaderMinHeight, RowMinHeight));
end;

function TcxVerticalGridCustomEditorRowPlace.CalculatedRecordWidth
  (ARecordIndex: Integer): Integer;
begin
...
function TcxVerticalGridCustomEditorRowPlace.
  DoesItemParticipateInBestFitCalculation(ARecordIndex: Integer): Boolean;
begin
  Result := dxPScxCommon.dxPSDataMaps.DoesItemParticipateInBestFitCalculation
    (Properties[ARecordIndex]);
end;

function TcxVerticalGridCustomEditorRowPlace.MeasureWidth
  (ARecordIndex: Integer): Integer;
begin
...
function TcxVerticalGridCustomEditorRowPlace.RowHelper
...
function TcxVerticalGridCustomEditorRowPlace.GetProperty(RecordIndex: Integer)
  : TcxCustomEditProperties;
begin
  Result := RowHelper.EditProperties[0, RecordIndex];
end;

function TcxVerticalGridCustomEditorRowPlace.GetValueFont
  (RecordIndex: Integer): TFont;
begin
  Result := Formatter.GetRowValueFont(Row, 0, RecordIndex);
end;

function TcxVerticalGridCustomEditorRowPlace.GetValuePlace(RecordIndex: Integer)
  : TcxVerticalGridRowElementPlace;
begin
...
function TcxVerticalGridCustomEditorRowPlace.GetValue(RecordIndex: Integer)
  : TcxEditValue;
begin
...
constructor TcxVerticalGridCustomMultiEditorRowPlace.Create
  (AFormatter: TcxCustomVerticalGridReportLinkFormatter; ARow: TcxCustomRow;
  AWrapIndex: Integer);
begin
  inherited;
...
procedure TcxVerticalGridCustomMultiEditorRowPlace.AddDelimiters
  (AReportLink: TcxCustomVerticalGridReportLink);
begin
  inherited;
...
begin
  ...
  CalculateValuePlaces;
  if HasHeaderSeparators then
    CalculateHeaderSeparatorPlaces;
  if HasValueSeparators then
    CalculateValueSeparatorPlaces;
end;

function TcxVerticalGridCustomMultiEditorRowPlace.CalculatedHeaderWidth
  : Integer;
var
  I: Integer;
begin
  ...
  begin
    ...
    Inc(Result, CalculatedTextWidth(RowHelper.HeaderCaptions[I],
      HeaderFonts[I]));
  end;
...
begin
  ...
  for I := 0 to RecordCount - 1 do
    ...
    begin
      RowMinHeight := Max(RowMinHeight,
        CalculatedTextPatternHeight(ValueFonts[J, I]));
...
function TcxVerticalGridCustomMultiEditorRowPlace.CalculatedRecordWidth
  (ARecordIndex: Integer): Integer;
var
  I, W: Integer;
begin
...
procedure TcxVerticalGridCustomMultiEditorRowPlace.
  CalculateHeaderSeparatorPlaces;
var
  CurrentOffset, I: Integer;
begin
...
begin
  ...
  try
    for I := 0 to HeaderSeparatorCount - 1 do
    begin
      HeaderSeparatorPlaces[I].Width :=
        CalculatedTextWidth(RowHelper.HeaderSeparatorTexts[I],
        HeaderSeparatorsFonts[I]);
    end;
  finally
    ScreenCanvas.RestoreState;
  end;
...
procedure TcxVerticalGridCustomMultiEditorRowPlace.CalculatePartWidths
  ...
  procedure AssignAutoWidthItem(AnItem: TcxAutoWidthItem;
    AProperties: TcxEditorRowItemProperties);
  begin
    AnItem.MinWidth := 0;
...
begin
  ...
  begin
    ...
    begin
      ...
      Inc(CurrentOffset, ValuePlaces[J + 1, I].Width + ValueSeparatorPlaces[J,
        I].Width);
    end;
    Inc(CurrentOffset, InterRecordsSpace);
  end;
...
begin
  ...
  try
    for I := StartRecordIndex to StopRecordIndex do
      for J := 0 to ValueSeparatorCount - 1 do
      begin
        ValueSeparatorPlaces[J, I].Width :=
          CalculatedTextWidth(RowHelper.ValueSeparatorTexts[J],
          ValueSeparatorsFonts[J, I]);
      end;
  finally
    ScreenCanvas.RestoreState;
  end;
...
function TcxVerticalGridCustomMultiEditorRowPlace.
  GetHeaderAvailableWidth: Integer;
begin
  Result := inherited GetHeaderAvailableWidth - HeaderSeparatorsArea;
end;

function TcxVerticalGridCustomMultiEditorRowPlace.GetValueAvailableWidth
  (RecordIndex: Integer): Integer;
begin
  Result := inherited GetValueAvailableWidth(RecordIndex) - ValueSeparatorsAreas
    [RecordIndex];
end;
...
function TcxVerticalGridCustomMultiEditorRowPlace.
  DoesItemParticipateInBestFitCalculation(ACellIndex,
  ARecordIndex: Integer): Boolean;
begin
  Result := dxPScxCommon.dxPSDataMaps.DoesItemParticipateInBestFitCalculation
    (Properties[ACellIndex, ARecordIndex]);
end;

function TcxVerticalGridCustomMultiEditorRowPlace.MeasureWidth(ACellIndex,
  ARecordIndex: Integer): Integer;
begin
  Result := dxPScxCommon.dxPSDataMaps.MeasureWidth
    (Properties[ACellIndex, ARecordIndex], Values[ACellIndex, ARecordIndex],
    Formatter, ValueFonts[ACellIndex, ARecordIndex], ARecordIndex);
end;
...
function TcxVerticalGridCustomMultiEditorRowPlace.RowHelper
...
function TcxVerticalGridCustomMultiEditorRowPlace.
  GetHasHeaderSeparators: Boolean;
begin
  Result := HasHeader and RowHelper.HasHeaderSeparators;
end;

function TcxVerticalGridCustomMultiEditorRowPlace.GetHasValueSeparators
  : Boolean;
begin
  Result := RowHelper.HasValueSeparators;
end;

function TcxVerticalGridCustomMultiEditorRowPlace.GetHeaderFont
  (CellIndex: Integer): TFont;
begin
  Result := Formatter.GetRowHeaderFont(Row, CellIndex);
end;

function TcxVerticalGridCustomMultiEditorRowPlace.GetHeaderPlace
  (CellIndex: Integer): TcxVerticalGridRowElementPlace;
begin
...
function TcxVerticalGridCustomMultiEditorRowPlace.
  GetHeaderSeparatorCount: Integer;
begin
  Result := RowHelper.HeaderSeparatorCount;
end;

function TcxVerticalGridCustomMultiEditorRowPlace.GetHeaderSeparatorPlace
  (CellIndex: Integer): TcxVerticalGridRowElementPlace;
begin
...
function TcxVerticalGridCustomMultiEditorRowPlace.
  GetHeaderSeparatorPlaceCount: Integer;
begin
  Result := FHeaderSeparatorPlaces.Count;
end;

function TcxVerticalGridCustomMultiEditorRowPlace.
  GetHeaderSeparatorsArea: Integer;
var
  I: Integer;
begin
  if HasHeaderSeparators then
...
function TcxVerticalGridCustomMultiEditorRowPlace.GetHeaderSeparatorsFont
  (CellIndex: Integer): TFont;
begin
  Result := Formatter.GetRowHeaderSeparatorsFont(Row, CellIndex);
end;

function TcxVerticalGridCustomMultiEditorRowPlace.GetProperty(CellIndex,
  RecordIndex: Integer): TcxCustomEditProperties;
begin
  Result := RowHelper.EditProperties[CellIndex, RecordIndex];
end;

function TcxVerticalGridCustomMultiEditorRowPlace.GetValue(CellIndex,
  RecordIndex: Integer): TcxEditValue;
begin
  Result := RowHelper.Values[CellIndex, RecordIndex];
end;

function TcxVerticalGridCustomMultiEditorRowPlace.GetValueFlatIndex(CellIndex,
  RecordIndex: Integer): Integer;
begin
  Result := RecordIndex * ItemCount + CellIndex;
end;

function TcxVerticalGridCustomMultiEditorRowPlace.GetValueFont(CellIndex,
  RecordIndex: Integer): TFont;
begin
  Result := Formatter.GetRowValueFont(Row, CellIndex, RecordIndex);
end;

function TcxVerticalGridCustomMultiEditorRowPlace.GetValuePlace(CellIndex,
  RecordIndex: Integer): TcxVerticalGridRowElementPlace;
begin
  Result := FValuePlaces[ValueFlatIndexes[CellIndex,
...
function TcxVerticalGridCustomMultiEditorRowPlace.GetValueSeparatorsArea
  (RecordIndex: Integer): Integer;
var
  I: Integer;
begin
...
function TcxVerticalGridCustomMultiEditorRowPlace.
  GetValueSeparatorCount: Integer;
begin
  Result := RowHelper.ValueSeparatorCount;
end;

function TcxVerticalGridCustomMultiEditorRowPlace.GetValueSeparatorFlatIndex
  (CellIndex, RecordIndex: Integer): Integer;
begin
  Result := RecordIndex * ValueSeparatorCount + CellIndex;
end;

function TcxVerticalGridCustomMultiEditorRowPlace.GetValueSeparatorPlace
  (CellIndex, RecordIndex: Integer): TcxVerticalGridRowElementPlace;
begin
  Result := FValueSeparatorPlaces[ValueSeparatorFlatIndexes[CellIndex,
    RecordIndex - StartRecordIndex]];
end;

function TcxVerticalGridCustomMultiEditorRowPlace.
  GetValueSeparatorPlaceCount: Integer;
begin
  Result := FValueSeparatorPlaces.Count;
end;

function TcxVerticalGridCustomMultiEditorRowPlace.GetValueSeparatorsFont
  (CellIndex, RecordIndex: Integer): TFont;
begin
...
constructor TcxVerticalGridReportLinkCustomElementProducer.Create
  (ABuilder: TcxCustomVerticalGridReportLinkBuilder);
begin
  inherited Create;
  FBuilder := ABuilder;
end;

function TcxVerticalGridReportLinkCustomElementProducer.Adapter
  : TcxCustomVerticalGridAdapter;
begin
  Result := Builder.Adapter;
end;

function TcxVerticalGridReportLinkCustomElementProducer.Builder
  : TcxCustomVerticalGridReportLinkBuilder;
begin
  Result := FBuilder;
end;

function TcxVerticalGridReportLinkCustomElementProducer.Formatter
  : TcxCustomVerticalGridReportLinkFormatter;
begin
  Result := Builder.Formatter;
end;

function TcxVerticalGridReportLinkCustomElementProducer.Produce
  (AHostInfo: TcxVerticalGridHostInfo; AWrapIndex: Integer): TdxReportCell;
begin
  FWrapIndex := AWrapIndex;
  CalculateRowHeight;
...
procedure TcxVerticalGridReportLinkCustomElementProducer.CreateRowHost
  (AHostInfo: TcxVerticalGridHostInfo);
begin
  FHost := TdxReportCell.Create(AHostInfo.Parent);
  FHost.BoundsRect := Bounds(AHostInfo.Origin.X, AHostInfo.Origin.Y, RowWidth,
    RowHeight);
...
function TcxVerticalGridReportLinkCustomElementProducer.GetScreenCanvas
  : TdxPSReportRenderCustomCanvas;
begin
  Result := Formatter.ScreenCanvas;
end;
...
procedure TcxVerticalGridReportLinkWrapSeparatorProducer.CreateSeparator
...
function TcxVerticalGridReportLinkWrapSeparatorProducer.
  GetSeparatorBounds: TRect;
begin
...
constructor TcxVerticalGridReportLinkCustomRowProducer.Create
  (ABuilder: TcxCustomVerticalGridReportLinkBuilder);
begin
  inherited;
...
function TcxVerticalGridReportLinkCustomRowProducer.GridRowHelper
  : TcxVerticalGridCustomRowHelper;
begin
  Result := Formatter.RowHelpers[GridRow];
end;

function TcxVerticalGridReportLinkCustomRowProducer.GridRowPlace
  : TcxVerticalGridCustomRowPlace;
begin
  Result := Formatter.RowPlacesByRow[GridRow, WrapIndex];
end;

function TcxVerticalGridReportLinkCustomRowProducer.Produce
  (AHostInfo: TcxVerticalGridHostInfo; AGridRow: TcxCustomRow;
...
begin
  inherited;
  if HasIndents then
    CreateRowIndents(Row);
end;

function TcxVerticalGridReportLinkCustomRowProducer.CreateRowIndent
...
procedure TcxVerticalGridReportLinkCustomRowProducer.CreateRowIndents
  (AParent: TdxReportCell);
var
  I: Integer;
...
function TcxVerticalGridReportLinkCustomRowProducer.
...
procedure TcxVerticalGridReportLinkCustomRowProducer.InitializeRowIndent
...
function TcxVerticalGridReportLinkCustomRowProducer.GetIndent(Index: Integer)
  : TdxReportCellExpandButton;
begin
  Result := TdxReportCellExpandButton(FIndents[Index]);
end;

function TcxVerticalGridReportLinkCustomRowProducer.GetIndentBounds
  (Index: Integer): TRect;
begin
...
function TcxVerticalGridReportLinkCustomRowProducer.GetStartRecordIndex
  : Integer;
begin
  Result := Formatter.WrappedRecordStartIndexes[WrapIndex];
end;
...
function TcxVerticalGridReportLinkCategoryRowProducer.GridRowHelper
  : TcxVerticalGridCategoryRowHelper;
begin
  Result := inherited GridRowHelper as TcxVerticalGridCategoryRowHelper;
end;

function TcxVerticalGridReportLinkCategoryRowProducer.GridRowPlace
  : TcxVerticalGridCategoryRowPlace;
begin
  Result := inherited GridRowPlace as TcxVerticalGridCategoryRowPlace;
end;

procedure TcxVerticalGridReportLinkCategoryRowProducer.CreateCategoryRow
  (AParent: TdxReportCell);
var
...
constructor TcxVerticalGridReportLinkCustomEditableRowProducer.Create
  (ABuilder: TcxCustomVerticalGridReportLinkBuilder);
begin
  inherited;
...
function TcxVerticalGridReportLinkCustomEditableRowProducer.CreateHeaderItem
  (AParent: TdxReportCell; ACellIndex: Integer): TdxReportCellImage;
begin
  Result := Formatter.GetRowHeaderClass(GridRow).Create(AParent);
  FHeaders.Add(Result);
end;

function TcxVerticalGridReportLinkCustomEditableRowProducer.CreateValueItem
  (AParent: TdxReportCell; ACellIndex, ARecordIndex: Integer)
  : TAbstractdxReportCellData;
begin
  Result := Formatter.GetRowValueClass(GridRow, ACellIndex, ARecordIndex)
    .Create(AParent);
  FValues.Add(Result);
end;

procedure TcxVerticalGridReportLinkCustomEditableRowProducer.DoInitializeHeader
...
procedure TcxVerticalGridReportLinkCustomEditableRowProducer.DoInitializeValue
  (AnItem: TAbstractdxReportCellData; ACellIndex, ARecordIndex: Integer);
begin
  Formatter.DoInitializeRowValue(GridRow, AnItem, ACellIndex, ARecordIndex);
  Formatter.DoReportLinkInitializeRowValue(GridRow, AnItem, ACellIndex,
    ARecordIndex);
end;

function TcxVerticalGridReportLinkCustomEditableRowProducer.
  DoesItemParticipateInRowAutoHeightCalculation
  (AnItem: TAbstractdxReportCellData): Boolean;
begin
  Result := True;
...
function TcxVerticalGridReportLinkCustomEditableRowProducer.GetHeader
  (Index: Integer): TdxReportCellImage;
begin
...
function TcxVerticalGridReportLinkCustomEditableRowProducer.GetValue
  (Index: Integer): TAbstractdxReportCellData;
begin
  Result := TAbstractdxReportCellData(FValues[Index]);
end;

function TcxVerticalGridReportLinkCustomEditableRowProducer.
  GetValueCount: Integer;
begin
...
function TcxVerticalGridReportLinkCustomEditorRowProducer.GridRow
  : TcxCustomEditorRow;
begin
  Result := inherited GridRow as TcxCustomEditorRow;
end;

function TcxVerticalGridReportLinkCustomEditorRowProducer.GridRowHelper
  : TcxVerticalGridCustomEditorRowHelper;
begin
  Result := inherited GridRowHelper as TcxVerticalGridCustomEditorRowHelper;
end;

function TcxVerticalGridReportLinkCustomEditorRowProducer.GridRowPlace
  : TcxVerticalGridCustomEditorRowPlace;
begin
...
procedure TcxVerticalGridReportLinkCustomEditorRowProducer.CreateHeader
  (AParent: TdxReportCell);
var
...
procedure TcxVerticalGridReportLinkCustomEditorRowProducer.CreateValues
  (AParent: TdxReportCell);
var
  I: Integer;
...
function TcxVerticalGridReportLinkCustomEditorRowProducer.GetHeader
  : TdxReportCellImage;
begin
  Result := Headers[0];
end;

function TcxVerticalGridReportLinkCustomEditorRowProducer.
  GetHeaderBounds: TRect;
begin
  with GridRowPlace.HeaderPlace do
    Result := Bounds(Offset, 0, Width, RowHeight);
end;

function TcxVerticalGridReportLinkCustomEditorRowProducer.GetValueBounds
  (Index: Integer): TRect;
begin
  with GridRowPlace do
    Result := Bounds(ValuePlaces[Index].Offset, 0, ValuePlaces[Index].Width,
      RowHeight);
end;

{ TcxVerticalGridReportLinkCustomMultiEditorRowProducer }

constructor TcxVerticalGridReportLinkCustomMultiEditorRowProducer.Create
  (ABuilder: TcxCustomVerticalGridReportLinkBuilder);
begin
  inherited;
...
function TcxVerticalGridReportLinkCustomMultiEditorRowProducer.GridRow
  : TcxCustomMultiEditorRow;
begin
  Result := inherited GridRow as TcxCustomMultiEditorRow;
end;

function TcxVerticalGridReportLinkCustomMultiEditorRowProducer.GridRowHelper
  : TcxVerticalGridCustomMultiEditorRowHelper;
begin
  Result := inherited GridRowHelper as
    TcxVerticalGridCustomMultiEditorRowHelper;
end;

function TcxVerticalGridReportLinkCustomMultiEditorRowProducer.GridRowPlace
  : TcxVerticalGridCustomMultiEditorRowPlace;
begin
...
begin
  ...
  CreateValues(Row);
  if HasHeaderSeparators then
    CreateHeaderSeparators(Row);
  if HasValueSeparators then
    CreateValueSeparators(Row);
end;

procedure TcxVerticalGridReportLinkCustomMultiEditorRowProducer.CreateHeaders
  (AParent: TdxReportCell);
var
  I: Integer;
  Header: TdxReportCellImage;
...
function TcxVerticalGridReportLinkCustomMultiEditorRowProducer.
  CreateHeaderSeparator(AParent: TdxReportCell): TdxReportCellString;
begin
  Result := Formatter.GetRowHeaderSeparatorClass(GridRow).Create(AParent);
  FValueSeparators.Add(Result);
end;

procedure TcxVerticalGridReportLinkCustomMultiEditorRowProducer.
  CreateHeaderSeparators(AParent: TdxReportCell);
var
  I: Integer;
...
procedure TcxVerticalGridReportLinkCustomMultiEditorRowProducer.CreateValues
  (AParent: TdxReportCell);
var
  I, J: Integer;
  Item: TAbstractdxReportCellData;
...
function TcxVerticalGridReportLinkCustomMultiEditorRowProducer.
  CreateValueSeparator(AParent: TdxReportCell): TdxReportCellString;
begin
...
procedure TcxVerticalGridReportLinkCustomMultiEditorRowProducer.
  CreateValueSeparators(AParent: TdxReportCell);
var
  I, J: Integer;
  Separator: TdxReportCellString;
begin
...
procedure TcxVerticalGridReportLinkCustomMultiEditorRowProducer.
  DoInitializeHeaderSeparator(AnItem: TdxReportCellString; AnIndex: Integer);
begin
...
procedure TcxVerticalGridReportLinkCustomMultiEditorRowProducer.
  DoInitializeValueSeparator(AnItem: TdxReportCellString;
  AnIndex, ARecordIndex: Integer);
begin
  Formatter.DoInitializeRowValueSeparator(GridRow, AnItem, AnIndex,
    ARecordIndex);
  Formatter.DoReportLinkInitializeRowValueSeparator(GridRow, AnItem, AnIndex,
    ARecordIndex);
end;
...
function TcxVerticalGridReportLinkCustomMultiEditorRowProducer.
  GetHasValueSeparators: Boolean;
begin
  Result := GridRowHelper.HasValueSeparators;
end;

function TcxVerticalGridReportLinkCustomMultiEditorRowProducer.GetHeaderBounds
  (Index: Integer): TRect;
begin
...
function TcxVerticalGridReportLinkCustomMultiEditorRowProducer.
  GetHeaderSeparator(Index: Integer): TdxReportCellString;
begin
  Result := TdxReportCellString(FHeaderSeparators[Index]);
end;

function TcxVerticalGridReportLinkCustomMultiEditorRowProducer.
  GetHeaderSeparatorBounds(Index: Integer): TRect;
begin
  with GridRowPlace do
    Result := Bounds(HeaderSeparatorPlaces[Index].Offset, 0,
      HeaderSeparatorPlaces[Index].Width, RowHeight);
end;
...
function TcxVerticalGridReportLinkCustomMultiEditorRowProducer.
  GetHeaderSeparatorText(Index: Integer): string;
begin
  Result := GridRowHelper.HeaderSeparatorTexts[Index];
end;

function TcxVerticalGridReportLinkCustomMultiEditorRowProducer.GetValue
  (CellIndex, RecordIndex: Integer): TAbstractdxReportCellData;
begin
  Result := FValues[RecordIndex * GridRowHelper.ItemCount + CellIndex];
end;

function TcxVerticalGridReportLinkCustomMultiEditorRowProducer.GetValueBounds
  (CellIndex, RecordIndex: Integer): TRect;
begin
  with GridRowPlace do
    Result := Bounds(ValuePlaces[CellIndex, RecordIndex].Offset, 0,
      ValuePlaces[CellIndex, RecordIndex].Width, RowHeight);
end;

function TcxVerticalGridReportLinkCustomMultiEditorRowProducer.GetValueSeparator
  (Index: Integer): TdxReportCellString;
begin
  Result := TdxReportCellString(FValueSeparators[Index]);
end;

function TcxVerticalGridReportLinkCustomMultiEditorRowProducer.
  GetValueSeparatorBounds(Index, RecordIndex: Integer): TRect;
begin
  with GridRowPlace do
    Result := Bounds(ValueSeparatorPlaces[Index, RecordIndex].Offset, 0,
      ValueSeparatorPlaces[Index, RecordIndex].Width, RowHeight);
end;
...
function TcxVerticalGridReportLinkCustomMultiEditorRowProducer.
  GetValueSeparatorText(Index: Integer): string;
begin
...
constructor TcxVerticalGridCustomRowHelper.Create
  (AnAdapter: TcxCustomVerticalGridAdapter);
begin
  inherited Create;
  FAdapter := AnAdapter;
end;
...
class function TcxVerticalGridCustomRowHelper.ProducerClass
  : TcxVerticalGridReportLinkCustomRowProducerClass;
begin
...
function TcxVerticalGridCustomRowHelper.Properties(Index: Integer)
  : TcxCustomRowProperties;
begin
...
class function TcxVerticalGridCustomRowHelper.RowPlaceClass
  : TcxVerticalGridCustomRowPlaceClass;
begin
...
function TcxVerticalGridCustomRowHelper.GetEditProperties(Index,
  RecordIndex: Integer): TcxCustomEditProperties;
begin
  Result := nil;
end;

function TcxVerticalGridCustomRowHelper.GetHasHeaderImage
  (Index: Integer): Boolean;
begin
  Result := (Adapter.Images <> nil) and (ImageIndexes[Index] > -1) and
    (ImageIndexes[Index] < Adapter.Images.Count);
end;
...
function TcxVerticalGridCustomRowHelper.GetHeaderAlignmentHorz(Index: Integer)
  : TcxTextAlignX;
begin
  Result := taLeft;
end;

function TcxVerticalGridCustomRowHelper.GetHeaderAlignmentVert(Index: Integer)
  : TcxTextAlignY;
begin
  Result := taCenterY;
end;

function TcxVerticalGridCustomRowHelper.GetHeaderCaption
...
function TcxVerticalGridCustomRowHelper.GetRowProperties(Index: Integer)
  : TcxCustomRowProperties;
begin
  Result := CustomRow_GetProperties(Row);
end;

function TcxVerticalGridCustomRowHelper.GetDisplayText(Index,
  RecordIndex: Integer): string;
begin
  Result := '';
end;

function TcxVerticalGridCustomRowHelper.GetSeparatorsAlignmentVert
  : TcxAlignmentVert;
begin
  Result := vaCenter;
end;

function TcxVerticalGridCustomRowHelper.GetValue(Index, RecordIndex: Integer)
  : TcxEditValue;
begin
  Result := '';
end;
...
class function TcxVerticalGridCategoryRowHelper.ProducerClass
  : TcxVerticalGridReportLinkCustomRowProducerClass;
begin
  Result := TcxVerticalGridReportLinkCategoryRowProducer;
end;

function TcxVerticalGridCategoryRowHelper.Properties(Index: Integer)
...
class function TcxVerticalGridCategoryRowHelper.RowPlaceClass
  : TcxVerticalGridCustomRowPlaceClass;
begin
...
function TcxVerticalGridCategoryRowHelper.GetHeaderAlignmentHorz(Index: Integer)
  : TcxTextAlignX;
begin
  Result := TextAlignXMap[Properties(Index).HeaderAlignmentHorz];
end;

function TcxVerticalGridCategoryRowHelper.GetHeaderAlignmentVert(Index: Integer)
  : TcxTextAlignY;
begin
  Result := TextAlignYMap[Properties(Index).HeaderAlignmentVert];
end;

function TcxVerticalGridCategoryRowHelper.GetHeaderCaption
  (Index: Integer): string;
begin
  Result := Properties(Index).Caption;
end;

function TcxVerticalGridCategoryRowHelper.GetImageIndex(Index: Integer)
  : Integer;
begin
...
class function TcxVerticalGridCustomEditorRowHelper.ProducerClass
  : TcxVerticalGridReportLinkCustomRowProducerClass;
begin
  Result := TcxVerticalGridReportLinkCustomEditorRowProducer;
end;

function TcxVerticalGridCustomEditorRowHelper.Properties(Index: Integer)
...
class function TcxVerticalGridCustomEditorRowHelper.RowPlaceClass
  : TcxVerticalGridCustomRowPlaceClass;
begin
  Result := TcxVerticalGridCustomEditorRowPlace;
end;

function TcxVerticalGridCustomEditorRowHelper.GetEditProperties(Index,
  RecordIndex: Integer): TcxCustomEditProperties;
begin
  Result := TcxCustomEditorRowProperties(Properties(Index))
    .DisplayEditProperties[RecordIndex];
end;

function TcxVerticalGridCustomEditorRowHelper.GetHeaderAlignmentHorz
  (Index: Integer): TcxTextAlignX;
begin
  Result := TextAlignXMap[Properties(Index).HeaderAlignmentHorz];
end;

function TcxVerticalGridCustomEditorRowHelper.GetHeaderAlignmentVert
  (Index: Integer): TcxTextAlignY;
begin
  Result := TextAlignYMap[Properties(Index).HeaderAlignmentVert];
end;

function TcxVerticalGridCustomEditorRowHelper.GetHeaderCaption
  (Index: Integer): string;
begin
  Result := Properties(Index).Caption;
end;

function TcxVerticalGridCustomEditorRowHelper.GetImageIndex
  (Index: Integer): Integer;
begin
  Result := Properties(Index).ImageIndex;
end;

function TcxVerticalGridCustomEditorRowHelper.GetDisplayText(Index,
  RecordIndex: Integer): string;
begin
...
function TcxVerticalGridCustomEditorRowHelper.GetValue(Index,
  RecordIndex: Integer): TcxEditValue;
begin
...
function TcxVerticalGridEditorRowHelper.Properties(Index: Integer)
...
function TcxVerticalGridDBEditorRowHelper.Properties(Index: Integer)
...
class function TcxVerticalGridCustomMultiEditorRowHelper.ProducerClass
  : TcxVerticalGridReportLinkCustomRowProducerClass;
begin
  Result := TcxVerticalGridReportLinkCustomMultiEditorRowProducer;
end;

function TcxVerticalGridCustomMultiEditorRowHelper.Properties(Index: Integer)
  : TcxEditorRowItemProperties;
begin
  Result := TcxEditorRowItemProperties(GetRowProperties(Index));
end;

function TcxVerticalGridCustomMultiEditorRowHelper.RootProperties
  : TcxMultiEditorRowProperties;
begin
...
class function TcxVerticalGridCustomMultiEditorRowHelper.RowClass
  : TcxCustomRowClass;
begin
  Result := TcxCustomMultiEditorRow;
end;

class function TcxVerticalGridCustomMultiEditorRowHelper.RowPlaceClass
  : TcxVerticalGridCustomRowPlaceClass;
begin
  Result := TcxVerticalGridCustomMultiEditorRowPlace;
end;

function TcxVerticalGridCustomMultiEditorRowHelper.GetEditProperties(Index,
  RecordIndex: Integer): TcxCustomEditProperties;
begin
  Result := TcxCustomEditorRowProperties(Properties(Index))
    .DisplayEditProperties[RecordIndex];
...
function TcxVerticalGridCustomMultiEditorRowHelper.
  GetHasHeaderSeparators: Boolean;
begin
...
function TcxVerticalGridCustomMultiEditorRowHelper.GetHeaderAlignmentHorz
  (Index: Integer): TcxTextAlignX;
begin
  Result := TextAlignXMap[Properties(Index).HeaderAlignmentHorz];
end;

function TcxVerticalGridCustomMultiEditorRowHelper.GetHeaderAlignmentVert
  (Index: Integer): TcxTextAlignY;
begin
  Result := TextAlignYMap[Properties(Index).HeaderAlignmentVert];
end;

function TcxVerticalGridCustomMultiEditorRowHelper.GetHeaderCaption
  (Index: Integer): string;
begin
  Result := Properties(Index).Caption;
end;

function TcxVerticalGridCustomMultiEditorRowHelper.GetImageIndex
  (Index: Integer): Integer;
begin
  Result := Properties(Index).ImageIndex;
end;
...
function TcxVerticalGridCustomMultiEditorRowHelper.GetRowProperties
  (Index: Integer): TcxCustomRowProperties;
begin
  Result := RootProperties.Editors[Index];
end;

function TcxVerticalGridCustomMultiEditorRowHelper.GetDisplayText(Index,
  RecordIndex: Integer): string;
begin
  Result := Properties(Index).DisplayTexts[RecordIndex];
end;
...
function TcxVerticalGridCustomMultiEditorRowHelper.GetHeaderSeparatorText
  (Index: Integer): string;
begin
  Result := RootProperties.SeparatorString;
end;

function TcxVerticalGridCustomMultiEditorRowHelper.GetSeparatorsAlignmentVert
  : TcxAlignmentVert;
begin
  Result := RootProperties.SeparatorAlignmentVert;
end;

function TcxVerticalGridCustomMultiEditorRowHelper.GetValue(Index,
  RecordIndex: Integer): TcxEditValue;
begin
  Result := Properties(Index).Values[RecordIndex];
end;
...
function TcxVerticalGridCustomMultiEditorRowHelper.GetValueSeparatorText
  (Index: Integer): string;
begin
  Result := RootProperties.SeparatorString;
end;
...
constructor TcxVerticalGridRowHelperCache.Create
  (AnAdapter: TcxCustomVerticalGridAdapter);
begin
  inherited Create;
  FAdapter := AnAdapter;
...
begin
  for Result := 0 to Count - 1 do
    if Items[Result].RowClass = Row.ClassType then
      Exit;

  Result := Add(dxVerticalGridRowHelperFactory.HelperClasses[Row]
    .Create(Adapter));
end;

function TcxVerticalGridRowHelperCache.GetHelper(Row: TcxCustomRow)
  : TcxVerticalGridCustomRowHelper;
begin
...
function TcxVerticalGridRowHelperCache.GetItem(Index: Integer)
  : TcxVerticalGridCustomRowHelper;
begin
...
constructor TcxVerticalGridReportLinkProducerCache.Create
  (ABuilder: TcxCustomVerticalGridReportLinkBuilder);
begin
  inherited Create;
  FBuilder := ABuilder;
...
function TcxVerticalGridReportLinkProducerCache.IndexOf(AProducerClass
  : TcxVerticalGridReportLinkCustomRowProducerClass): Integer;
begin
  for Result := 0 to Count - 1 do
...
function TcxVerticalGridReportLinkProducerCache.GetProducer
  (ProducerClass: TcxVerticalGridReportLinkCustomRowProducerClass)
  : TcxVerticalGridReportLinkCustomRowProducer;
begin
  Result := Items[IndexOf(ProducerClass)];
end;

function TcxVerticalGridReportLinkProducerCache.GetItem(Index: Integer)
  : TcxVerticalGridReportLinkCustomRowProducer;
begin
...
constructor TcxCustomVerticalGridReportLinkBuilder.Create
  (AReportLink: TcxCustomVerticalGridReportLink);
begin
  inherited Create;
...
procedure TcxCustomVerticalGridReportLinkBuilder.Progress
  (const APercentDone: Double);
begin
  ReportLink.DoProgress(APercentDone);
end;

function TcxCustomVerticalGridReportLinkBuilder.Adapter
  : TcxCustomVerticalGridAdapter;
begin
  Result := FAdapter;
end;

class function TcxCustomVerticalGridReportLinkBuilder.AdapterClass
  : TcxCustomVerticalGridAdapterClass;
begin
  Result := TcxCustomVerticalGridAdapter;
end;

function TcxCustomVerticalGridReportLinkBuilder.Formatter
  : TcxCustomVerticalGridReportLinkFormatter;
begin
  Result := FFormatter;
end;

class function TcxCustomVerticalGridReportLinkBuilder.FormatterClass
  : TcxCustomVerticalGridReportLinkFormatterClass;
begin
  Result := TcxCustomVerticalGridReportLinkFormatter;
end;

procedure TcxCustomVerticalGridReportLinkBuilder.AddReportRow
  (ARow: TdxReportCell);
begin
...
procedure TcxCustomVerticalGridReportLinkBuilder.CreateRow(ARow: TcxCustomRow;
  AWrapIndex: Integer);
var
  ReportRow: TdxReportCell;
begin
  ReportRow := GetRowProducer(ARow).Produce(ReportLink.HostInfo, ARow,
    AWrapIndex);
...
begin
  ...
  begin
    ...
    begin
      ...
      CreateRow(Row, I);
      Progress(100 * (I * Formatter.RowCount + J) /
        (Formatter.WrapCount * Formatter.RowCount));
      if IsAborted then
        Break;
    end;
    if IsAborted then
...
procedure TcxCustomVerticalGridReportLinkBuilder.CreateWrapSeparator
  (AWrapIndex: Integer);
var
  ReportRow: TdxReportCell;
begin
  ReportRow := GetWrapSeparatorProducer(AWrapIndex).Produce(ReportLink.HostInfo,
    AWrapIndex);
  AddReportRow(ReportRow);
end;

function TcxCustomVerticalGridReportLinkBuilder.GetRowProducer
  (ARow: TcxCustomRow): TcxVerticalGridReportLinkCustomRowProducer;
begin
  Result := ProducerCache[GetRowProducerClass(ARow)
    ] as TcxVerticalGridReportLinkCustomRowProducer;
end;

function TcxCustomVerticalGridReportLinkBuilder.GetRowProducerClass
  (ARow: TcxCustomRow): TcxVerticalGridReportLinkCustomRowProducerClass;
begin
  Result := Formatter.RowHelpers[ARow].ProducerClass;
end;

function TcxCustomVerticalGridReportLinkBuilder.GetWrapSeparatorProducer
  (AWrapIndex: Integer): TcxVerticalGridReportLinkWrapSeparatorProducer;
begin
...
function TcxCustomVerticalGridReportLinkBuilder.GetWrapSeparatorProducerClass
  : TcxVerticalGridReportLinkWrapSeparatorProducerClass;
begin
  Result := TcxVerticalGridReportLinkWrapSeparatorProducer;
end;

function TcxCustomVerticalGridReportLinkBuilder.AreWrapSeparatorsNeeded
  : Boolean;
begin
...
function TcxCustomVerticalGridReportLinkBuilder.GetReportRow(Index: Integer)
  : TdxReportCell;
begin
...
function TcxCustomVerticalGridReportLinkBuilder.GetVerticalGrid
...
constructor TcxVerticalGridReportLinkBuilderHandler.Create
  (ABuilder: TcxCustomVerticalGridReportLinkBuilder);
begin
  inherited Create;
  FBuilder := ABuilder;
...
function TcxVerticalGridReportLinkBuilderHandler.Builder
  : TcxCustomVerticalGridReportLinkBuilder;
begin
  Result := FBuilder;
end;

function TcxVerticalGridReportLinkBuilderHandler.GetReportLink
  : TcxCustomVerticalGridReportLink;
begin
...
constructor TcxCustomVerticalGridAdapter.Create
  (ABuilder: TcxCustomVerticalGridReportLinkBuilder);
var
...
begin
  ...
  if Supports(VerticalGrid, IcxDataControllerConditionalFormattingProviderOwner,
...
function TcxCustomVerticalGridAdapter.GetPropertiesClass(ARow: TcxCustomRow;
  AnIndex, ARecordIndex: Integer): TcxCustomEditPropertiesClass;
begin
  Result := TcxCustomEditPropertiesClass(GetProperties(ARow, AnIndex,
    ARecordIndex).ClassType);
end;

function TcxCustomVerticalGridAdapter.GetCategoryViewParams(ARow: TcxCustomRow)
  : TcxViewParams;
begin
...
begin
  Properties := TcxCustomEditorRowProperties
    (Helpers[ARow].GetRowProperties(AnIndex));
...
function TcxCustomVerticalGridAdapter.GetHeaderViewParams(ARow: TcxCustomRow)
  : TcxViewParams;
begin
...
function TcxCustomVerticalGridAdapter.GetImageViewParams(ARow: TcxCustomRow)
  : TcxViewParams;
begin
  Result := GetHeaderViewParams(ARow);
end;

function TcxCustomVerticalGridAdapter.GetIndentViewParams(ARow: TcxCustomRow)
  : TcxViewParams;
begin
...
function TcxCustomVerticalGridAdapter.TryGetAdvancedStyle(ARow: TcxCustomRow;
  ACellIndex, ARecordIndex: Integer;
...
function TcxCustomVerticalGridAdapter.GetBackgroundBitmap
  (Index: Integer): TBitmap;
begin
  Result := Styles.GetBitmap(Index);
end;

function TcxCustomVerticalGridAdapter.GetRowIndentBackgroundBitmapIndex
  (ARow: TcxCustomRow; Alevel: Integer): Integer;
const
  BackgroundBitmapIndexes: array [Boolean] of Integer = (vgs_Header,
    vgs_Category);
begin
  Result := BackgroundBitmapIndexes[GetRowParentAtLevel(ARow, Alevel)
    is TcxCategoryRow];
end;

function TcxCustomVerticalGridAdapter.HasBackgroundBitmap
  (Index: Integer): Boolean;
begin
...
function TcxCustomVerticalGridAdapter.GetImageHeight(ARow: TcxCustomRow;
...
function TcxCustomVerticalGridAdapter.GetImageWidth(ARow: TcxCustomRow;
  AnIndex: Integer): Integer;
begin
  if HasRowImage(ARow, AnIndex) then
...
function TcxCustomVerticalGridAdapter.HasCategoryRowAsParentAtLevel
  (ARow: TcxCustomRow; Alevel: Integer; ACheckFollow: Boolean): Boolean;
begin
  while Alevel > 0 do
  begin
    ARow := ARow.Parent;
...
function TcxCustomVerticalGridAdapter.HasRowImage(ARow: TcxCustomRow;
...
begin
  ...
  begin
    Helper := Helpers[ARow];
    Result := (Helper.ImageIndexes[AnIndex] > -1) and
      (Helper.ImageIndexes[AnIndex] < Images.Count);
  end;
end;

function TcxCustomVerticalGridAdapter.IsRowLastChildAtLevel(ARow: TcxCustomRow;
...
function TcxCustomVerticalGridAdapter.GetDataController
  : TcxCustomDataController;
begin
...
function TcxCustomVerticalGridAdapter.GetHeaderAvailableWidth
  (Row: TcxCustomRow): Integer;
begin
...
function TcxCustomVerticalGridAdapter.GetHelper(Row: TcxCustomRow)
  : TcxVerticalGridCustomRowHelper;
begin
...
function TcxCustomVerticalGridAdapter.GetIndentCount(Row: TcxCustomRow)
  : Integer;
begin
...
function TcxCustomVerticalGridAdapter.GetRecordMinWidth
  (RecordIndex: Integer): Integer;
var
  I, V: Integer;
  Row: TcxCustomRow;
...
function TcxCustomVerticalGridAdapter.GetRecordWidth
  (RecordCount: Integer): Integer;
begin
  Result := TcxvgCustomViewInfoAccess(VerticalGrid.ViewInfo).ViewValueWidth + 1;
  // autoheight correction
end;
...
constructor TcxCustomVerticalGridReportLinkFormatter.Create
  (ABuilder: TcxCustomVerticalGridReportLinkBuilder);
begin
  inherited;
  FFont := TFont.Create;
...
function TcxCustomVerticalGridReportLinkFormatter.Adapter
  : TcxCustomVerticalGridAdapter;
begin
  Result := Builder.Adapter;
end;

procedure TcxCustomVerticalGridReportLinkFormatter.DoInitializeHost
  (AHost: TdxReportCell);
begin
  AHost.CellSides := [];
...
procedure TcxCustomVerticalGridReportLinkFormatter.DoInitializeRowImage
  (ARow: TcxCustomRow; AnItem: TdxReportCellGraphic; AnIndex: Integer);
begin
...
function TcxCustomVerticalGridReportLinkFormatter.GetRowImageCellSides
  (ARow: TcxCustomRow): TdxCellSides;
begin
  Result := csTopBottom;
  Result := FixupHorzCellSides(ARow, Result);
end;

function TcxCustomVerticalGridReportLinkFormatter.GetRowImageClass
  : TdxReportCellGraphicClass;
begin
  Result := TdxReportCellGraphic;
end;

function TcxCustomVerticalGridReportLinkFormatter.GetRowImageViewParams
...
procedure TcxCustomVerticalGridReportLinkFormatter.DoInitializeRowIndent
  (ARow: TcxCustomRow; AnItem: TdxReportCellExpandButton;
...
begin
  ...
  BackgroundBitmapIndex := Adapter.GetRowIndentBackgroundBitmapIndex(ARow,
    AnIndentCount - AnIndex - 1);
  if HasBackgroundBitmap(BackgroundBitmapIndex) then
    AnItem.BackgroundBitmapIndex := GetBackgroundBitmapIndex
      (BackgroundBitmapIndex);

  AnItem.Data := MakeCustomDrawCodeData(cxVerticalGridRowIndentID, AnIndex, 0);
  AnItem.ShowButton := (AnIndex = AnIndentCount - 1) and
    OptionsView.ExpandButtons and ARow.HasChildren;
...
procedure TcxCustomVerticalGridReportLinkFormatter.
  DoReportLinkInitializeRowIndent(ARow: TcxCustomRow;
  AnItem: TdxReportCellExpandButton; AnIndex: Integer);
begin
  ReportLink.DoInitializeRowIndentCell(ARow, AnIndex, AnItem);
end;

function TcxCustomVerticalGridReportLinkFormatter.GetRowIndentCellSides
  (ARow: TcxCustomRow; AnIndex, AnIndentCount: Integer): TdxCellSides;
var
  Level: Integer;
...
begin
  ...
  begin
    ...
    if (ARow is TcxCategoryRow) and
      ((AnIndex = AnIndentCount - 1) or ((AnIndex = AnIndentCount - 2) and
      not Adapter.HasCategoryRowAsParentAtLevel(ARow, Level, False))) then
      Include(Result, csTop);
    if not(ARow is TcxCategoryRow) and not Adapter.HasCategoryRowAsParentAtLevel
      (ARow, Level, True) then
      Result := Result + csTopBottom;
    if not(ARow is TcxCategoryRow) and Adapter.IsRowLastChildAtLevel(ARow,
      Level) and Adapter.HasCategoryRowAsParentAtLevel(ARow, Level, False) then
      Include(Result, csBottom);
    if IsLastRow(ARow) then
      Include(Result, csBottom);

    if (AnIndex = 0) or ((ARow is TcxCategoryRow) and
      (AnIndex = AnIndentCount - 1)) then
      Include(Result, csLeft);
    if (AnIndex <> AnIndentCount - 1) and Adapter.HasCategoryRowAsParentAtLevel
      (ARow, Level, False) then
...
function TcxCustomVerticalGridReportLinkFormatter.GetRowIndentClass
  : TdxReportCellExpandButtonClass;
begin
  Result := TdxReportCellExpandButton;
end;

function TcxCustomVerticalGridReportLinkFormatter.GetRowIndentViewParams
  (ARow: TcxCustomRow; AnIndex, AnIndentCount: Integer)
...
procedure TcxCustomVerticalGridReportLinkFormatter.DoInitializeCategoryRow
  (ARow: TcxCategoryRow; AnItem: TdxReportCellImage);
var
...
begin
  ...
  AImageItem.EndEllipsis := Adapter.CellEndEllipsis and
    not ReportLink.OptionsSize.BestFit;
...
procedure TcxCustomVerticalGridReportLinkFormatter.DoInitializeRowReportRow
  (ARow: TcxCustomRow; AReportRow: TdxReportCell);
begin
...
procedure TcxCustomVerticalGridReportLinkFormatter.DoInitializeRowHeader
  (ARow: TcxCustomRow; AnItem: TdxReportCellImage; AnIndex: Integer);
var
  AImageItem: TdxReportCellImage;
  Helper: TcxVerticalGridCustomRowHelper;
begin
  ...
  Helper := RowHelpers[ARow];
  AImageItem := AnItem as TdxReportCellImage;
  AImageItem.Data := MakeCustomDrawCodeData(cxVerticalGridRowHeaderID,
    AnIndex, 0);
  AImageItem.EndEllipsis := Adapter.CellEndEllipsis and
    not ReportLink.OptionsSize.BestFit;
...
procedure TcxCustomVerticalGridReportLinkFormatter.DoInitializeRowValue
  (ARow: TcxCustomRow; AnItem: TAbstractdxReportCellData;
  AnIndex, ARecordIndex: Integer);
var
...
begin
  ...
  dxPScxCommon.dxPSDataMaps.InitializeItem(AnItem, Properties, CellValue, Self,
    ViewParams, False, ARecordIndex, TcxCustomRowAccess(ARow)
    .GetEditContainer(AnIndex));
  dxPScxCommon.dxPSDataMaps.GetImageLists(Properties,
    ReportLink.AppendImageList);

  SetViewParams(AnItem, ViewParams);
  if HasBackgroundBitmap(vgs_Content) then
    AnItem.BackgroundBitmapIndex := GetBackgroundBitmapIndex(vgs_Content);

  AnItem.Data := MakeCustomDrawCodeData(cxVerticalGridRowValueID, AnIndex,
    ARecordIndex);
end;

procedure TcxCustomVerticalGridReportLinkFormatter.
  DoReportLinkInitializeRowHeader(ARow: TcxCustomRow;
  AnItem: TdxReportCellImage; AnIndex: Integer);
begin
...
procedure TcxCustomVerticalGridReportLinkFormatter.
  DoReportLinkInitializeRowValue(ARow: TcxCustomRow;
...
function TcxCustomVerticalGridReportLinkFormatter.GetCategoryRowCellSides
  (ARow: TcxCustomRow): TdxCellSides;
begin
...
function TcxCustomVerticalGridReportLinkFormatter.GetCategoryRowClass
  (ARow: TcxCustomRow): TdxReportCellImageClass;
begin
  Result := TdxReportCellImage;
end;

function TcxCustomVerticalGridReportLinkFormatter.GetCategoryRowViewParams
  (ARow: TcxCustomRow): TdxReportItemViewParams;
begin
...
function TcxCustomVerticalGridReportLinkFormatter.GetCellValue
  (ARow: TcxCustomRow; AProperties: TcxCustomEditProperties;
  AnIndex, ARecordIndex: Integer): TcxEditValue;
var
  Helper: TcxVerticalGridCustomRowHelper;
begin
  Helper := RowHelpers[ARow];
...
function TcxCustomVerticalGridReportLinkFormatter.GetRowHeaderCellSides
  (ARow: TcxCustomRow; AnIndex: Integer): TdxCellSides;
var
  Helper: TcxVerticalGridCustomRowHelper;
begin
  Helper := RowHelpers[ARow];
...
function TcxCustomVerticalGridReportLinkFormatter.GetRowHeaderClass
  (ARow: TcxCustomRow): TdxReportCellImageClass;
begin
  Result := TdxReportCellImage;
end;

function TcxCustomVerticalGridReportLinkFormatter.GetRowHeaderViewParams
  (ARow: TcxCustomRow; AnIndex: Integer): TdxReportItemViewParams;
begin
  FillChar(Result, 0, SizeOf(Result));
  if ReportLink.OptionsFormatting.UseNativeStyles then
...
function TcxCustomVerticalGridReportLinkFormatter.GetRowValueCellSides
  (ARow: TcxCustomRow; AnIndex, ARecordIndex: Integer): TdxCellSides;
var
  Helper: TcxVerticalGridCustomRowHelper;
begin
  Helper := RowHelpers[ARow];
...
begin
  Result := dxPScxCommon.dxPSDataMaps.ItemClass(Adapter.GetProperties(ARow,
    AIndex, ARecordIndex), GetRowValueViewParams(ARow, AIndex, ARecordIndex));
end;
...
begin
  FillChar(Result, 0, SizeOf(Result));
  if ReportLink.OptionsFormatting.UseNativeStyles then
    ReportLink.Styles.GetContentParams(ARow, AIndex, ARecordIndex,
      Result.NativeParams)
  else
    Result.NativeParams := Adapter.GetContentViewParams(ARow, AIndex,
      ARecordIndex);
  ...
  if Adapter.TryGetAdvancedStyle(ARow, AIndex, ARecordIndex, AStyle) and
    (AStyle <> nil) then
...
procedure TcxCustomVerticalGridReportLinkFormatter.
  DoInitializeRowHeaderSeparator(ARow: TcxCustomMultiEditorRow;
...
begin
  ...
  begin
    Data := MakeCustomDrawCodeData(cxVerticalGridRowHeaderSeparatorID,
      AnIndex, 0);
    EndEllipsis := False;
    Multiline := False;
    TextAlignX := taLeft;
    TextAlignY := dxPScxCommon.TextAlignYMap
      [RowHelpers[ARow].SeparatorsAlignmentVert];
  end;
end;

procedure TcxCustomVerticalGridReportLinkFormatter.DoInitializeRowValueSeparator
  (ARow: TcxCustomMultiEditorRow; AnItem: TdxReportCellString;
  AnIndex, ARecordIndex: Integer);
begin
  SetViewParams(AnItem, GetRowValueSeparatorViewParams(ARow, AnIndex,
    ARecordIndex));
  if HasBackgroundBitmap(vgs_Content) then
    AnItem.BackgroundBitmapIndex := GetBackgroundBitmapIndex(vgs_Content);
  ...
  with TdxReportCellString(AnItem) do
  begin
    Data := MakeCustomDrawCodeData(cxVerticalGridRowValueSeparatorID, AnIndex,
      ARecordIndex);
    EndEllipsis := False;
    Multiline := False;
    TextAlignX := taLeft;
...
procedure TcxCustomVerticalGridReportLinkFormatter.
  DoReportLinkInitializeRowHeaderSeparator(ARow: TcxCustomMultiEditorRow;
  AnItem: TdxReportCellString; AnIndex: Integer);
begin
...
procedure TcxCustomVerticalGridReportLinkFormatter.
  DoReportLinkInitializeRowValueSeparator(ARow: TcxCustomMultiEditorRow;
  AnItem: TdxReportCellString; AnIndex, ARecordIndex: Integer);
begin
  ReportLink.DoInitializeRowValueSeparatorCell(ARow, AnIndex,
    ARecordIndex, AnItem);
end;

function TcxCustomVerticalGridReportLinkFormatter.GetRowHeaderSeparatorCellSides
  (ARow: TcxCustomMultiEditorRow): TdxCellSides;
begin
  Result := FixupHorzCellSides(ARow, csTopBottom);
end;

function TcxCustomVerticalGridReportLinkFormatter.GetRowHeaderSeparatorClass
  (ARow: TcxCustomMultiEditorRow): TdxReportCellStringClass;
begin
  Result := TdxReportCellString;
end;

function TcxCustomVerticalGridReportLinkFormatter.
  GetRowHeaderSeparatorViewParams(ARow: TcxCustomMultiEditorRow;
...
function TcxCustomVerticalGridReportLinkFormatter.GetRowValueSeparatorCellSides
  (ARow: TcxCustomMultiEditorRow): TdxCellSides;
begin
  Result := FixupHorzCellSides(ARow, csTopBottom);
end;

function TcxCustomVerticalGridReportLinkFormatter.GetRowValueSeparatorClass
  (ARow: TcxCustomMultiEditorRow): TdxReportCellStringClass;
begin
  Result := TdxReportCellString;
end;

function TcxCustomVerticalGridReportLinkFormatter.GetRowValueSeparatorViewParams
  (ARow: TcxCustomMultiEditorRow; AnIndex, ARecordIndex: Integer)
  : TdxReportItemViewParams;
begin
  FillChar(Result, 0, SizeOf(Result));
  if ReportLink.OptionsFormatting.UseNativeStyles then
    ReportLink.Styles.GetContentParams(ARow, AnIndex, ARecordIndex,
      Result.NativeParams)
  else
    Result.NativeParams := Adapter.GetContentViewParams(ARow, AnIndex,
      ARecordIndex);
...
procedure TcxCustomVerticalGridReportLinkFormatter.DoInitializeWrapSeparatorItem
  (AnItem: TdxReportCellString; AWrapIndex: Integer);
begin
  AnItem.CellSides := [];
...
procedure TcxCustomVerticalGridReportLinkFormatter.DoInitializeWrapSeparatorRow
  (ARow: TdxReportCell);
begin
  ARow.CellSides := [];
...
function TcxCustomVerticalGridReportLinkFormatter.GetWrapSeparatorClass
  : TdxReportCellStringClass;
begin
  Result := TdxReportCellString;
end;

function TcxCustomVerticalGridReportLinkFormatter.QueryInterface
...
function TcxCustomVerticalGridReportLinkFormatter.
  IdxPSCellParams_GetAutoHeight: Boolean;
begin
  Result := Adapter.CellAutoHeight;
end;

function TcxCustomVerticalGridReportLinkFormatter.IdxPSCellParams_GetCanvas
  : TdxPSReportRenderCustomCanvas;
begin
  Result := ScreenCanvas;
end;
...
function TcxCustomVerticalGridReportLinkFormatter.
  IdxPSCellParams_GetEndEllipsis: Boolean;
begin
...
function TcxCustomVerticalGridReportLinkFormatter.
  IdxPSCellParams_GetMultiline: Boolean;
begin
...
begin
  ...
  begin
    ...
    if ReportLink.OptionsPagination.ByWrapping and
      IsLastRow(GetRowByReportRow(Row)) then
...
function TcxCustomVerticalGridReportLinkFormatter.
  GetAreRecordsNeededLoading: Boolean;
begin
  Result := False;
end;

function TcxCustomVerticalGridReportLinkFormatter.
  GetAreRecordsNeededUnloading: Boolean;
begin
  Result := False;
end;

function TcxCustomVerticalGridReportLinkFormatter.
  GetFirstInternalRecordIndex: Integer;
begin
  Result := 0;
end;

function TcxCustomVerticalGridReportLinkFormatter.
  GetInternalRecordCount: Integer;
begin
...
procedure TcxCustomVerticalGridReportLinkFormatter.AddWrappedRecordStartIndex
  (Value: Integer);
begin
...
begin
  ...
  if ReportLink.OptionsSize.BestFit and not ReportLink.OptionsSize.AutoWidth
  then
    CalculateBestFit;
...
begin
  ...
  ARecordMaxWidth := 0;
  for I := WrappedRecordStartIndexes[0] to WrappedRecordStopIndexes
    [WrapCount - 1] do
  begin
    for J := 0 to RowCount - 1 do
      RecordWidths[I] := Max(RecordWidths[I],
        RowPlaces[0, J].CalculatedRecordWidth(I));
...
begin
  AHeight := Max(AHeight, Renderer.CalcTextPatternHeight(ScreenCanvas,
    AParams.NativeParams.Font));
end;
...
procedure TcxCustomVerticalGridReportLinkFormatter.CalculateRecordAutoWidths;
  ...
  begin
    Result := Builder.AvailableSiteWidth - InterRecordsSpace *
      (ARecordCount - 1) - HeaderWidth;
  end;
...
begin
  if InternalRecordCount <> 1 then
    ...
    begin
      ...
      try
        for J := WrappedRecordStartIndexes[I] to WrappedRecordStopIndexes[I] do
          AssignAutoWidthItem(AutoWidthObject.AddItem, RecordMinWidths[J],
            RecordWidths[J]);

        AutoWidthObject.AvailableWidth :=
          GetAvailableSiteWidth(RecordCounts[I]);
        AutoWidthObject.Calculate;

        for J := WrappedRecordStartIndexes[I] to WrappedRecordStopIndexes[I] do
          RecordWidths[J] := AutoWidthObject[J - WrappedRecordStartIndexes[I]]
            .AutoWidth;
      finally
        AutoWidthObject.Free;
      end;
    ...
    for I := WrappedRecordStartIndexes[0] to WrappedRecordStopIndexes
      [WrapCount - 1] do // v3.03 {0 to InternalRecordCount - 1}
...
begin
  ...
  begin
    Row := Adapter.Rows[I];
    if Adapter.IsRowVisible(Row) then
      FRows.Add(Row);
  end;
end;
...
function TcxCustomVerticalGridReportLinkFormatter.CreateRowPlace
  (ARow: TcxCustomRow; AWrapIndex: Integer): TcxVerticalGridCustomRowPlace;
begin
...
function TcxCustomVerticalGridReportLinkFormatter.GetBackgroundBitmap
  (Index: Integer): TBitmap;
begin
  if ReportLink.OptionsFormatting.UseNativeStyles then
...
function TcxCustomVerticalGridReportLinkFormatter.GetBackgroundBitmapIndex
  (Index: Integer): Integer;
begin
  Result := ReportLink.AddBackgroundBitmapToPool(GetBackgroundBitmap(Index));
end;

function TcxCustomVerticalGridReportLinkFormatter.HasBackgroundBitmap
  (Index: Integer): Boolean;
var
  Bitmap: TBitmap;
begin
...
function TcxCustomVerticalGridReportLinkFormatter.MapStyleBackgroundBitmapIndex
  (AVerticalGridBackgroundBitmapIndex: Integer): Integer;
begin
...
function TcxCustomVerticalGridReportLinkFormatter.GetCategoryRowFont
  (ARow: TcxCustomRow): TFont;
begin
  Result := GetCategoryRowViewParams(ARow).NativeParams.Font;
end;

function TcxCustomVerticalGridReportLinkFormatter.GetRowHeaderFont
  (ARow: TcxCustomRow; AnIndex: Integer): TFont;
begin
  Result := GetRowHeaderViewParams(ARow, AnIndex).NativeParams.Font;
end;

function TcxCustomVerticalGridReportLinkFormatter.GetRowHeaderSeparatorsFont
  (ARow: TcxCustomRow; AnIndex: Integer): TFont;
begin
  Result := GetRowHeaderViewParams(ARow, AnIndex).NativeParams.Font;
end;

function TcxCustomVerticalGridReportLinkFormatter.GetRowValueFont
  (ARow: TcxCustomRow; AnIndex, ARecordIndex: Integer): TFont;
begin
  Result := GetRowValueViewParams(ARow, AnIndex, ARecordIndex)
    .NativeParams.Font;
end;

function TcxCustomVerticalGridReportLinkFormatter.GetRowValueSeparatorsFont
  (ARow: TcxCustomRow; AnIndex, ARecordIndex: Integer): TFont;
begin
  Result := GetRowValueViewParams(ARow, AnIndex, ARecordIndex)
    .NativeParams.Font;
...
function TcxCustomVerticalGridReportLinkFormatter.FixupHorzCellSides
  (ARow: TcxCustomRow; ACellSides: TdxCellSides): TdxCellSides;
begin
  Result := ACellSides;
  if not ShowHorzGridLines then
  begin
    if not IsFirstRow(ARow) then
      Exclude(Result, csTop);
    if not IsLastRow(ARow) then
      Exclude(Result, csBottom);
  end;
  if not ShowBorders then
  begin
    if IsFirstRow(ARow) then
      Exclude(Result, csTop);
    if IsLastRow(ARow) then
      Exclude(Result, csBottom);
  end;
...
function TcxCustomVerticalGridReportLinkFormatter.GetImageHeight
  (ARow: TcxCustomRow; ACellIndex: Integer): Integer;
begin
  Result := Adapter.GetImageHeight(ARow, ACellIndex);
end;

function TcxCustomVerticalGridReportLinkFormatter.GetImageWidth
  (ARow: TcxCustomRow; ACellIndex: Integer): Integer;
begin
  Result := Adapter.GetImageWidth(ARow, ACellIndex);
end;

function TcxCustomVerticalGridReportLinkFormatter.GetNextRow(ARow: TcxCustomRow)
  : TcxCustomRow;
var
  Index: Integer;
begin
...
function TcxCustomVerticalGridReportLinkFormatter.GetRowByReportRow
  (ARow: TdxReportCell): TcxCustomRow;
begin
  Result := TcxCustomRow(ARow.Cells[0].Data);
end;

function TcxCustomVerticalGridReportLinkFormatter.GetPrevRow(ARow: TcxCustomRow)
  : TcxCustomRow;
var
  Index: Integer;
begin
...
function TcxCustomVerticalGridReportLinkFormatter.GetStyleFontIndex
  (const AParams: TdxReportItemViewParams): Integer;
begin
...
function TcxCustomVerticalGridReportLinkFormatter.IndexOfRow
  (ARow: TcxCustomRow): Integer;
begin
  Result := FRows.IndexOf(ARow);
end;

function TcxCustomVerticalGridReportLinkFormatter.IsColorTransparent
  (AColor: TColor): Boolean;
begin
  Result := ColorToRGB(AColor) = ColorToRGB(TransparentColor);
end;

function TcxCustomVerticalGridReportLinkFormatter.IsFirstRow(ARow: TcxCustomRow)
  : Boolean;
begin
  Result := ARow = FRows.First;
end;

function TcxCustomVerticalGridReportLinkFormatter.IsLastRow(ARow: TcxCustomRow)
  : Boolean;
begin
  Result := ARow = FRows.Last;
end;

function TcxCustomVerticalGridReportLinkFormatter.MakeCustomDrawCodeData
  (AnAttribute: TcxVerticalGridAttributeID;
  ACellIndex, ARecordIndex: Integer): Integer;
begin
  Result := ReportLink.MakeCustomDrawCodeData(AnAttribute, ACellIndex,
    ARecordIndex);
end;

procedure TcxCustomVerticalGridReportLinkFormatter.RegisterLookAndFeelItem
...
procedure TcxCustomVerticalGridReportLinkFormatter.SetViewParams
  (AnItem: TdxReportVisualItem; const AParams: TdxReportItemViewParams);
begin
  with AnItem do
  begin
...
function TcxCustomVerticalGridReportLinkFormatter.GetDataController
  : TcxCustomDataController;
begin
  Result := Adapter.DataController;
end;

function TcxCustomVerticalGridReportLinkFormatter.GetScreenCanvas
  : TdxPSReportRenderCustomCanvas;
begin
  Result := ReportLink.ScreenCanvas;
end;

function TcxCustomVerticalGridReportLinkFormatter.GetExpandButtonColor
  (Row: TcxCustomRow): TColor;
begin
...
function TcxCustomVerticalGridReportLinkFormatter.GetHeaderAvailableWidth
  (Row: TcxCustomRow): Integer;
begin
  if ShowHeaders then
...
function TcxCustomVerticalGridReportLinkFormatter.GetIndentArea
  (Row: TcxCustomRow): Integer;
begin
  if ShowHeaders then
...
function TcxCustomVerticalGridReportLinkFormatter.
  GetInternalRecordWidth: Integer;
begin
...
function TcxCustomVerticalGridReportLinkFormatter.GetLookAndFeelItem
  (Index: Integer): TdxReportVisualItem;
begin
  Result := TdxReportVisualItem(FLookAndFeelItems[Index]);
end;

function TcxCustomVerticalGridReportLinkFormatter.
  GetLookAndFeelItemCount: Integer;
begin
  Result := FLookAndFeelItems.Count;
end;

function TcxCustomVerticalGridReportLinkFormatter.GetOptionsView
  : TcxVerticalGridReportLinkOptionsView;
begin
  Result := ReportLink.OptionsView;
end;

function TcxCustomVerticalGridReportLinkFormatter.GetRecordCount
  (Index: Integer): Integer;
begin
  Result := WrappedRecordStopIndexes[Index] - WrappedRecordStartIndexes
    [Index] + 1;
end;

function TcxCustomVerticalGridReportLinkFormatter.GetInternalIndexByRecordIndex
  (RecordIndex: Integer): Integer;
begin
  Result := RecordIndex - FirstInternalRecordIndex;
end;

function TcxCustomVerticalGridReportLinkFormatter.GetRecordMinWidth
  (RecordIndex: Integer): Integer;
begin
  Result := Adapter.RecordMinWidths[RecordIndex];
end;

function TcxCustomVerticalGridReportLinkFormatter.GetRecordWidth
  (RecordIndex: Integer): Integer;
begin
...
function TcxCustomVerticalGridReportLinkFormatter.GetRow(Index: Integer)
  : TcxCustomRow;
begin
...
function TcxCustomVerticalGridReportLinkFormatter.GetRowHeight
  (Row: TcxCustomRow): Integer;
begin
  Result := Integer(FRowHeights[IndexOfRow(Row)]);
end;

function TcxCustomVerticalGridReportLinkFormatter.GetRowHelper
  (Row: TcxCustomRow): TcxVerticalGridCustomRowHelper;
begin
  Result := Adapter.Helpers[Row];
end;

function TcxCustomVerticalGridReportLinkFormatter.GetRowPlace(WrapIndex,
  Index: Integer): TcxVerticalGridCustomRowPlace;
begin
  Result := FRowPlaces[RowPlaceFlatIndexes[WrapIndex, Index]];
end;

function TcxCustomVerticalGridReportLinkFormatter.GetRowPlaceByRow
  (Row: TcxCustomRow; WrapIndex: Integer): TcxVerticalGridCustomRowPlace;
begin
  Result := RowPlaces[WrapIndex, IndexOfRow(Row)];
end;

function TcxCustomVerticalGridReportLinkFormatter.GetRowPlaceFlatIndex
  (WrapIndex, Index: Integer): Integer;
begin
...
function TcxCustomVerticalGridReportLinkFormatter.GetRenderer
  : TdxPSReportRenderer;
begin
...
function TcxCustomVerticalGridReportLinkFormatter.GetViewWidth
  (WrapIndex: Integer): Integer;
begin
...
function TcxCustomVerticalGridReportLinkFormatter.GetWrappedRecordStartIndex
  (Index: Integer): Integer;
begin
  Result := Integer(FWrappedRecordStartIndexes[Index]);
end;

function TcxCustomVerticalGridReportLinkFormatter.GetWrappedRecordStopIndex
  (Index: Integer): Integer;
begin
...
function TcxCustomVerticalGridReportLinkFormatter.
  GetWrapSeparatorHeight: Integer;
begin
  Result := ReportLink.OptionsSize.WrapSeparatorHeight;
end;

procedure TcxCustomVerticalGridReportLinkFormatter.SetInterRecordsSpace
  (Value: Integer);
begin
  if Value < 0 then
    Value := 0;
...
procedure TcxCustomVerticalGridReportLinkFormatter.SetRecordWidth
  (RecordIndex: Integer; Value: Integer);
begin
  FRecordWidths[InternalIndexesByRecordIndex[RecordIndex]] := TObject(Value);
end;

procedure TcxCustomVerticalGridReportLinkFormatter.SetRowHeight
  (Row: TcxCustomRow; Value: Integer);
begin
  FRowHeights[IndexOfRow(Row)] := TObject(Value);
end;

procedure TcxCustomVerticalGridReportLinkFormatter.SetViewWidth
  (WrapIndex: Integer; Value: Integer);
begin
...
function TcxVerticalGridReportLinkOptionsExpanding.GetReportLink
  : TcxCustomVerticalGridReportLink;
begin
  Result := inherited ReportLink as TcxCustomVerticalGridReportLink;
end;

procedure TcxVerticalGridReportLinkOptionsExpanding.SetAutoExpandRows
  (Value: Boolean);
begin
...
function TcxVerticalGridReportLinkOptionsFormatting.GetReportLink
  : TcxCustomVerticalGridReportLink;
begin
  Result := inherited ReportLink as TcxCustomVerticalGridReportLink;
end;
...
procedure TcxVerticalGridReportLinkOptionsPagination.Assign
  (Source: TPersistent);
begin
...
function TcxVerticalGridReportLinkOptionsPagination.GetReportLink
  : TcxCustomVerticalGridReportLink;
begin
  Result := inherited ReportLink as TcxCustomVerticalGridReportLink;
end;
...
procedure TcxVerticalGridReportLinkOptionsPagination.SetByWrapping
  (Value: Boolean);
begin
...
procedure TcxVerticalGridReportLinkOptionsPagination.SetOneWrappingPerPage
  (Value: Boolean);
begin
...
function TcxVerticalGridReportLinkOptionsRefinements.GetReportLink
  : TcxCustomVerticalGridReportLink;
begin
  Result := inherited ReportLink as TcxCustomVerticalGridReportLink;
end;

function TcxVerticalGridReportLinkOptionsRefinements.
  GetSuppressBackgroundBitmaps: Boolean;
begin
  Result := ReportLink.OptionsFormatting.SuppressBackgroundBitmaps;
end;

procedure TcxVerticalGridReportLinkOptionsRefinements.
  SetSuppressBackgroundBitmaps(Value: Boolean);
begin
...
function TcxVerticalGridReportLinkOptionsSize.GetReportLink
  : TcxCustomVerticalGridReportLink;
begin
  Result := inherited ReportLink as TcxCustomVerticalGridReportLink;
end;
...
procedure TcxVerticalGridReportLinkOptionsSize.SetKeepSameRecordWidths
  (Value: Boolean);
begin
...
procedure TcxVerticalGridReportLinkOptionsSize.SetWrapSeparatorHeight
  (Value: Integer);
begin
  if Value < 0 then
    Value := 0;
...
function TcxVerticalGridReportLinkOptionsView.GetActualMode
  : TcxVerticalGridReportLinkPrintMode;
begin
  Result := vpmLoadedRecords;
  // i.e. always equals 1 record for non Virtual(DB)VerticalGrid
end;

function TcxVerticalGridReportLinkOptionsView.GetReportLink
  : TcxCustomVerticalGridReportLink;
begin
  Result := inherited ReportLink as TcxCustomVerticalGridReportLink;
end;
...
procedure TcxVerticalGridReportLinkOptionsView.SetMode
  (Value: TcxVerticalGridReportLinkPrintMode);
begin
  if FMode <> Value then
  begin
    FMode := Value;
...
procedure TcxVerticalGridReportLinkStyles.GetIndentParams(ARow: TcxCustomRow;
  out AParams: TcxViewParams);
const
  StyleIndexes: array [Boolean] of Integer = (vspsVGridHeader,
    vspsVGridCategory);
begin
...
procedure TcxVerticalGridReportLinkStyles.GetDefaultViewParams(Index: Integer;
...
class function TcxVerticalGridReportLinkStyles.GetStyleCaption
...
function TcxVerticalGridReportLinkStyles.GetStyleIndexByCaption
...
function TcxVerticalGridReportLinkStyles.GetReportLink
  : TcxCustomVerticalGridReportLink;
begin
  Result := inherited ReportLink as TcxCustomVerticalGridReportLink;
end;
...
class function TcxVerticalGridReportLinkStyleSheet.GetStylesClass
  : TcxCustomStylesClass;
begin
  Result := TcxVerticalGridReportLinkStyles;
end;

function TcxVerticalGridReportLinkStyleSheet.GetStylesValue
  : TcxVerticalGridReportLinkStyles;
begin
...
procedure TcxVerticalGridReportLinkStyleSheet.SetStylesValue
  (Value: TcxVerticalGridReportLinkStyles);
begin
  SetStyles(Value);
end;
...
procedure TcxCustomVerticalGridReportLink.ConstructReport
  ...
  procedure CalculateSizes;
    ...
    begin
      ...
      begin
        ...
        ACell.BoundsRect := Rect(0, 0, Width,
          ACell[ACell.CellCount - 1].BoundsRect.Bottom);
      end;
    end;
...
procedure TcxCustomVerticalGridReportLink.CustomDraw
  (AItem: TAbstractdxReportCellData; ACanvas: TCanvas;
  ...
  with DrawInfo do
    case AttributeID of
      cxVerticalGridCategoryRowID:
        DoCustomDrawRowHeaderCell(ACanvas, Row, CellIndex,
          TdxReportCellImage(AItem), ADone);
      cxVerticalGridRowHeaderID:
        DoCustomDrawRowHeaderCell(ACanvas, Row, CellIndex,
          TdxReportCellImage(AItem), ADone);
      cxVerticalGridRowHeaderSeparatorID:
        DoCustomDrawRowHeaderSeparatorCell(ACanvas, Row, CellIndex,
          TdxReportCellString(AItem), ADone);
      cxVerticalGridRowValueID:
        DoCustomDrawRowValueCell(ACanvas, Row, CellIndex, RecordIndex,
          AItem, ADone);
      cxVerticalGridRowValueSeparatorID:
        DoCustomDrawRowValueSeparatorCell(ACanvas, Row, CellIndex, RecordIndex,
          TdxReportCellString(AItem), ADone);
      cxVerticalGridRowIndentID:
        DoCustomDrawRowIndentCell(ACanvas, Row, CellIndex,
          TdxReportCellExpandButton(AItem), ADone);
    end;
end;

procedure TcxCustomVerticalGridReportLink.FontChanged(Sender: TObject);
begin
  if CategoryFont <> nil then
    CategoryFont := Font;
  inherited;
end;
...
procedure TcxCustomVerticalGridReportLink.GetImageLists
...
function TcxCustomVerticalGridReportLink.GetRebuildOnPageParamsChange
  (AUpdateCodes: TdxPrinterPageUpdateCodes): Boolean;
begin
  Result := (AUpdateCodes * uaMarginsVert <> []) and
    (OptionsSize.AutoWidth or OptionsSize.WrapRecords);
end;
...
function TcxCustomVerticalGridReportLink.IsSupportedCustomDraw
...
procedure TcxCustomVerticalGridReportLink.DoCustomDrawRowHeaderCell
  (ACanvas: TCanvas; ARow: TcxCustomRow; AnIndex: Integer;
  AnItem: TdxReportCellImage; var ADone: Boolean);
begin
  if Assigned(FOnCustomDrawRowHeaderCell) then
    FOnCustomDrawRowHeaderCell(Self, ACanvas, ARow, AnIndex, AnItem, ADone);
end;

procedure TcxCustomVerticalGridReportLink.DoCustomDrawRowHeaderSeparatorCell
  (ACanvas: TCanvas; ARow: TcxCustomRow; AnIndex: Integer;
  AnItem: TdxReportCellString; var ADone: Boolean);
begin
  if Assigned(FOnCustomDrawRowHeaderSeparatorCell) then
    FOnCustomDrawRowHeaderSeparatorCell(Self, ACanvas, ARow, AnIndex,
      AnItem, ADone);
end;

procedure TcxCustomVerticalGridReportLink.DoCustomDrawRowIndentCell
  (ACanvas: TCanvas; ARow: TcxCustomRow; AnIndex: Integer;
...
procedure TcxCustomVerticalGridReportLink.DoCustomDrawRowValueCell
...
begin
  if Assigned(FOnCustomDrawRowValueCell) then
    FOnCustomDrawRowValueCell(Self, ACanvas, ARow, ACellIndex, ARecordIndex,
      AnItem, ADone);
end;

procedure TcxCustomVerticalGridReportLink.DoCustomDrawRowValueSeparatorCell
  (ACanvas: TCanvas; ARow: TcxCustomRow; ACellIndex, ARecordIndex: Integer;
  AnItem: TdxReportCellString; var ADone: Boolean);
begin
  if Assigned(FOnCustomDrawRowValueSeparatorCell) then
    FOnCustomDrawRowValueSeparatorCell(Self, ACanvas, ARow, ACellIndex,
      ARecordIndex, AnItem, ADone);
end;

procedure TcxCustomVerticalGridReportLink.DoInitializeRowHeaderCell
  (ARow: TcxCustomRow; ACellIndex: Integer; AnItem: TdxReportCellImage);
begin
...
procedure TcxCustomVerticalGridReportLink.DoInitializeRowHeaderSeparatorCell
  (ARow: TcxCustomRow; AnIndex: Integer; AnItem: TdxReportCellString);
begin
...
procedure TcxCustomVerticalGridReportLink.DoInitializeRowIndentCell
  (ARow: TcxCustomRow; AnIndex: Integer; AnItem: TdxReportCellExpandButton);
begin
...
procedure TcxCustomVerticalGridReportLink.DoInitializeRowValueCell
  (ARow: TcxCustomRow; ACellIndex, ARecordIndex: Integer;
  AnItem: TAbstractdxReportCellData);
begin
...
function TcxCustomVerticalGridReportLink.GetStylesClass
  : TdxCustomReportLinkStylesClass;
begin
  Result := TcxVerticalGridReportLinkStyles;
end;

function TcxCustomVerticalGridReportLink.GetStyleSheetClass
  : TdxCustomReportLinkStyleSheetClass;
begin
  Result := TcxVerticalGridReportLinkStyleSheet;
end;

function TcxCustomVerticalGridReportLink.GetStyleSheetPrototype
...
procedure TcxCustomVerticalGridReportLink.AddHorizontalHardDelimiter
  (ADelimiter: Integer);
begin
  DelimitersHardHorz.Add(Pointer(ADelimiter));
end;

procedure TcxCustomVerticalGridReportLink.AddVerticalHardDelimiter
  (ADelimiter: TdxReportCell);
begin
...
function TcxCustomVerticalGridReportLink.CreateBuilder
  : TcxCustomVerticalGridReportLinkBuilder;
begin
  Result := GetBuilderClass.Create(Self);
end;

class function TcxCustomVerticalGridReportLink.GetBuilderClass
  : TcxCustomVerticalGridReportLinkBuilderClass;
begin
  Result := TcxCustomVerticalGridReportLinkBuilder;
end;

procedure TcxCustomVerticalGridReportLink.ExtractCustomDrawCodeDataValues
...
function TcxCustomVerticalGridReportLink.GetItemCustomDrawInfo
  ...
  try
    try
      ...
      begin
        ...
        ExtractCustomDrawCodeDataValues(AnItem.Data, AttributeID, CellIndex,
          RecordIndex);
      end;
    except
      FillChar(ADrawInfo, SizeOf(ADrawInfo), 0);
...
function TcxCustomVerticalGridReportLink.IsCustomDrawn(AnAttributeID
  : TcxVerticalGridAttributeID): Boolean;
begin
  Result := False;
...
procedure TcxCustomVerticalGridReportLink.InitializePrintModeControl
...
function TcxCustomVerticalGridReportLink.GetActiveStyles
  : TcxVerticalGridReportLinkStyles;
begin
  Result := inherited ActiveStyles as TcxVerticalGridReportLinkStyles;
end;

function TcxCustomVerticalGridReportLink.GetDesignWindow
  : TcxfmVerticalGridReportLinkDesignWindow;
begin
  Result := inherited DesignWindow as TcxfmVerticalGridReportLinkDesignWindow;
end;

function TcxCustomVerticalGridReportLink.GetOptionsExpanding
  : TcxVerticalGridReportLinkOptionsExpanding;
begin
  Result := inherited OptionsExpanding as
    TcxVerticalGridReportLinkOptionsExpanding;
end;
...
function TcxCustomVerticalGridReportLink.GetOptionsFormatting
  : TcxVerticalGridReportLinkOptionsFormatting;
begin
  Result := inherited OptionsFormatting as
    TcxVerticalGridReportLinkOptionsFormatting;
end;

function TcxCustomVerticalGridReportLink.GetOptionsPagination
  : TcxVerticalGridReportLinkOptionsPagination;
begin
  Result := inherited OptionsPagination as
    TcxVerticalGridReportLinkOptionsPagination;
end;

function TcxCustomVerticalGridReportLink.GetOptionsRefinements
  : TcxVerticalGridReportLinkOptionsRefinements;
begin
  Result := inherited OptionsRefinements as
    TcxVerticalGridReportLinkOptionsRefinements;
end;

function TcxCustomVerticalGridReportLink.GetOptionsSize
  : TcxVerticalGridReportLinkOptionsSize;
begin
  Result := inherited OptionsSize as TcxVerticalGridReportLinkOptionsSize;
end;

function TcxCustomVerticalGridReportLink.GetOptionsView
  : TcxVerticalGridReportLinkOptionsView;
begin
  Result := inherited OptionsView as TcxVerticalGridReportLinkOptionsView;
end;

function TcxCustomVerticalGridReportLink.GetStyles
  : TcxVerticalGridReportLinkStyles;
begin
...
procedure TcxCustomVerticalGridReportLink.SetOptionsExpanding
  (Value: TcxVerticalGridReportLinkOptionsExpanding);
begin
  inherited OptionsExpanding := Value;
end;

procedure TcxCustomVerticalGridReportLink.SetOptionsFormatting
  (Value: TcxVerticalGridReportLinkOptionsFormatting);
begin
  inherited OptionsFormatting := Value;
end;

procedure TcxCustomVerticalGridReportLink.SetOptionsPagination
  (Value: TcxVerticalGridReportLinkOptionsPagination);
begin
  inherited OptionsPagination := Value;
end;

procedure TcxCustomVerticalGridReportLink.SetOptionsRefinements
  (Value: TcxVerticalGridReportLinkOptionsRefinements);
begin
  inherited OptionsRefinements := Value;
end;

procedure TcxCustomVerticalGridReportLink.SetOptionsSize
  (Value: TcxVerticalGridReportLinkOptionsSize);
begin
  inherited OptionsSize := Value;
end;

procedure TcxCustomVerticalGridReportLink.SetOptionsView
  (Value: TcxVerticalGridReportLinkOptionsView);
begin
  inherited OptionsView := Value;
end;

procedure TcxCustomVerticalGridReportLink.SetStyles
  (Value: TcxVerticalGridReportLinkStyles);
begin
...
class function TcxUnboundVerticalGridReportLinkBuilder.AdapterClass
  : TcxCustomVerticalGridAdapterClass;
begin
...
class function TcxUnboundVerticalGridReportLink.GetBuilderClass
  : TcxCustomVerticalGridReportLinkBuilderClass;
begin
...
class function TcxVirtualVerticalGridReportLinkBuilder.AdapterClass
  : TcxCustomVerticalGridAdapterClass;
begin
  Result := TcxVirtualVerticalGridAdapter;
end;

class function TcxVirtualVerticalGridReportLinkBuilder.FormatterClass
  : TcxCustomVerticalGridReportLinkFormatterClass;
begin
...
function TcxVirtualVerticalGridAdapter.GetOptionsView
...
function TcxVirtualVerticalGridReportLinkFormatter.
  GetFirstInternalRecordIndex: Integer;
begin
  Result := inherited GetFirstInternalRecordIndex;
  if (Adapter.LayoutStyle <> lsMultiRecordView) and (InternalRecordCount = 1)
    and (ReportLink.OptionsView.ActualMode = vpmLoadedRecords) then
...
function TcxVirtualVerticalGridReportLinkOptionsView.GetActualMode
  : TcxVerticalGridReportLinkPrintMode;
begin
  Result := Mode;
  if ReportLink.VirtualVerticalGrid <> nil then
    with ReportLink.VirtualVerticalGrid do
      if not DataController.IsGridMode and (LayoutStyle = lsMultiRecordView)
      then
        Result := vpmAllRecords;
end;

function TcxVirtualVerticalGridReportLinkOptionsView.GetReportLink
...
begin
  ...
  if VirtualVerticalGrid <> nil then
    ...
    else if VirtualVerticalGrid.LayoutStyle = lsMultiRecordView then
      OptionsView.Mode := vpmAllRecords
    else
      OptionsView.Mode := vpmLoadedRecords;
end;

class function TcxVirtualVerticalGridReportLink.GetBuilderClass
  : TcxCustomVerticalGridReportLinkBuilderClass;
begin
  Result := TcxVirtualVerticalGridReportLinkBuilder;
end;

function TcxVirtualVerticalGridReportLink.GetOptionsViewClass
  : TdxCustomReportLinkOptionsViewClass;
begin
...
procedure TcxVirtualVerticalGridReportLink.InitializePrintModeControl
  ...
  begin
    if (VirtualVerticalGrid = nil) or
      (VirtualVerticalGrid.LayoutStyle = lsMultiRecordView) then
      if AMode = vpmLoadedRecords then
        Result := cxGetResourceString(@sdxLoadedRecords)
      else
        Result := cxGetResourceString(@sdxAllRecords)
    else if AMode = vpmLoadedRecords then
...
begin
  ...
  try
    AItems.Clear;
    for I := Low(TcxVerticalGridReportLinkPrintMode)
      to High(TcxVerticalGridReportLinkPrintMode) do
...
function TcxVirtualVerticalGridReportLink.GetOptionsView
  : TcxVirtualVerticalGridReportLinkOptionsView;
begin
  Result := inherited OptionsView as
    TcxVirtualVerticalGridReportLinkOptionsView;
end;

function TcxVirtualVerticalGridReportLink.GetVirtualVerticalGrid
  : TcxVirtualVerticalGrid;
begin
  Result := Component as TcxVirtualVerticalGrid;
end;

procedure TcxVirtualVerticalGridReportLink.SetOptionsView
  (Value: TcxVirtualVerticalGridReportLinkOptionsView);
begin
  inherited OptionsView := Value;
end;
...
class function TcxDBVerticalGridReportLinkBuilder.FormatterClass
  : TcxCustomVerticalGridReportLinkFormatterClass;
begin
...
function TcxDBVerticalGridReportLinkFormatter.
  GetAreRecordsNeededLoading: Boolean;
begin
...
function TcxDBVerticalGridReportLinkFormatter.GetDataController
...
class function TcxDBVerticalGridReportLink.GetBuilderClass
  : TcxCustomVerticalGridReportLinkBuilderClass;
begin
...
procedure TcxfmVerticalGridReportLinkDesignWindow.LookAndFeelChange
  (Sender: TObject);
begin
...
procedure TcxfmVerticalGridReportLinkDesignWindow.OptionsExpandingClick
  (Sender: TObject);
begin
...
procedure TcxfmVerticalGridReportLinkDesignWindow.OptionsFormattingClick
  (Sender: TObject);
begin
  with TcxCheckBox(Sender) do
...
procedure TcxfmVerticalGridReportLinkDesignWindow.OptionsRefinementsClick
  (Sender: TObject);
begin
  with TcxCheckBox(Sender) do
...
procedure TcxfmVerticalGridReportLinkDesignWindow.OptionsSizeClick
  (Sender: TObject);
begin
  with TcxCheckBox(Sender) do
...
procedure TcxfmVerticalGridReportLinkDesignWindow.OptionsViewClick
  (Sender: TObject);
begin
  with TcxCheckBox(Sender) do
...
procedure TcxfmVerticalGridReportLinkDesignWindow.cbxPrintModeChange
  (Sender: TObject);
begin
  if not LockControlsUpdate then
  begin
    ReportLink.OptionsView.Mode := TcxVerticalGridReportLinkPrintMode
      (TcxComboBox(Sender).ItemObject);
    Modified := True;
  end;
end;

procedure TcxfmVerticalGridReportLinkDesignWindow.pmStylesPopup
  (Sender: TObject);
begin
...
procedure TcxfmVerticalGridReportLinkDesignWindow.StyleColorClick
  (Sender: TObject);
begin
  PerformStylesChangeColor;
end;

procedure TcxfmVerticalGridReportLinkDesignWindow.StyleFontClick
  (Sender: TObject);
begin
...
procedure TcxfmVerticalGridReportLinkDesignWindow.
  StyleBackgroundBitmapClearClick(Sender: TObject);
begin
...
begin
  ...
  chbxKeepSameRecordWidths.Caption :=
    cxGetResourceString(@sdxKeepSameRecordWidths);
...
begin
  ...
  chbxKeepSameRecordWidths.Enabled := chbxBestFit.Enabled and
    chbxBestFit.Checked;
...
begin
  ...
  CustomVerticalGrid_GetCategoryFont(PreviewVGrid)
    .Assign(ReportLink.CategoryFont);
...
procedure TcxfmVerticalGridReportLinkDesignWindow.SetDesignerTabIndex
  (Value: Integer);
begin
  if Value < 0 then
    Value := 0;
...
procedure TcxfmVerticalGridReportLinkDesignWindow.DoFormActivated
  (AnActive: Boolean);
begin
  inherited;
...
procedure TcxfmVerticalGridReportLinkDesignWindow.DoStyleChanged
...
procedure TcxfmVerticalGridReportLinkDesignWindow.DoStylesChanged
  (AStrings: TStrings; ARecreate: Boolean);
begin
  if ARecreate then
...
procedure TcxfmVerticalGridReportLinkDesignWindow.GetSelectedStyleNames
  (AStrings: TStrings);
var
  I: Integer;
begin
...
procedure TcxfmVerticalGridReportLinkDesignWindow.GetStyleSheetNames
  (out AStrings: TStrings);
begin
  AStrings := cbxStyleSheets.Properties.Items;
end;

procedure TcxfmVerticalGridReportLinkDesignWindow.GetStyleNames
  (out AStrings: TStrings);
begin
...
function TcxfmVerticalGridReportLinkDesignWindow.GetComponent
  : TcxCustomVerticalGrid;
begin
...
function TcxfmVerticalGridReportLinkDesignWindow.GetReportLink
  : TcxCustomVerticalGridReportLink;
begin
  Result := inherited ReportLink as TcxCustomVerticalGridReportLink;
end;
...
procedure TcxfmVerticalGridReportLinkDesignWindow.CustomDrawTextRect
  (ACanvas: TcxCanvas; AViewInfo: TcxRowValueInfo; const AText: string);
const
...
begin
  ...
  begin
    ...
    begin
      ...
      cxBkgndDrawPicture(ViewParams.Bitmap, ACanvas.Canvas, R, ppmTile, 1, 1,
        -R.Left, -R.Top);
...
const
  ...
  RowHeights: array [0 .. RowCount - 1] of Integer = (-1, -1, 116, 57, -1, 44);

  function RowCaptionString(Index: Integer): string;
  begin
    case Index of
      0:
        Result := cxGetResourceString(@sdxCarManufacturer);
      1:
        Result := cxGetResourceString(@sdxCarModel);
      2:
        Result := cxGetResourceString(@sdxPicture);
      3:
        Result := cxGetResourceString(@sdxCarEngine);
      4:
        Result := cxGetResourceString(@sdxCarTransmission);
    else
  ...
  begin
    case Index of
      0:
        Result := cxGetResourceString(@sdx760V12Manufacturer);
      1:
        Result := cxGetResourceString(@sdx760V12Model);
      2:
        Result := '';
      3:
        Result := cxGetResourceString(@sdx760V12Engine);
      4:
        Result := cxGetResourceString(@sdx760V12Transmission);
    else
...
procedure TcxfmVerticalGridReportLinkDesignWindow.RestoreSelectedStyles
  (AList: TList);
var
  I: Integer;
begin
...
procedure TcxfmVerticalGridReportLinkDesignWindow.SaveSelectedStyles
  (AList: TList);
var
  I: Integer;
begin
...
procedure TcxfmVerticalGridReportLinkDesignWindow.
  UpdatePreviewVerticalGridStyles(const ACaption: string; AStyle: TcxStyle);
begin
  with PreviewVGrid.Styles do
  begin
...
procedure TcxfmVerticalGridReportLinkDesignWindow.SetOptionsExpandingByIndex
...
begin
  ...
  with ReportLink.OptionsExpanding do
    case Index of
      0:
        AutoExpandRows := Value;
    end;
  Modified := True;
end;

procedure TcxfmVerticalGridReportLinkDesignWindow.SetOptionsFormattingByIndex
  (Index: Integer; Value: Boolean);
begin
  if LockControlsUpdate then
    Exit;
...
procedure TcxfmVerticalGridReportLinkDesignWindow.SetOptionsPaginationByIndex
  (Index: Integer; Value: Boolean);
begin
  if LockControlsUpdate then
    Exit;
  with ReportLink.OptionsPagination do
    case Index of
      ...
      1:
        ByWrapping := Value;
      2:
        OneWrappingPerPage := Value;
    end;
  Modified := True;
end;

procedure TcxfmVerticalGridReportLinkDesignWindow.SetOptionsRefinementsByIndex
  (Index: Integer; Value: Boolean);
begin
  if LockControlsUpdate then
    Exit;
...
procedure TcxfmVerticalGridReportLinkDesignWindow.SetOptionsSizeByIndex
  (Index: Integer; Value: Boolean);
begin
  if LockControlsUpdate then
    Exit;
...
procedure TcxfmVerticalGridReportLinkDesignWindow.SetOptionsViewByIndex
  (Index: Integer; Value: Boolean);
begin
  if LockControlsUpdate then
    Exit;
...
procedure TcxfmVerticalGridReportLinkDesignWindow.cbxStyleSheetsClick
  (Sender: TObject);
begin
  ActiveStyleSheet := TcxCustomStyleSheet(TcxComboBox(Sender).ItemObject);
end;

procedure TcxfmVerticalGridReportLinkDesignWindow.btnStyleSheetNewClick
  (Sender: TObject);
begin
...
procedure TcxfmVerticalGridReportLinkDesignWindow.btnStyleSheetDeleteClick
  (Sender: TObject);
begin
  PerformStyleSheetDelete;
end;

procedure TcxfmVerticalGridReportLinkDesignWindow.btnStyleSheetRenameClick
  (Sender: TObject);
begin
  PerformStyleSheetRename;
end;

procedure TcxfmVerticalGridReportLinkDesignWindow.miStylesSelectAllClick
  (Sender: TObject);
begin
  lbxStyles.SelectAll;
  UpdateControlsState;
...
procedure TcxfmVerticalGridReportLinkDesignWindow.StylesSaveAsClick
  (Sender: TObject);
begin
  PerformStylesSaveAsStyleSheet;
end;

procedure TcxfmVerticalGridReportLinkDesignWindow.cbxStyleSheetsKeyDown
  (Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  PerformStyleSheetKeyDown(Sender, Key, Shift);
end;

procedure TcxfmVerticalGridReportLinkDesignWindow.lbxStylesClick
  (Sender: TObject);
begin
  if not LockControlsUpdate then
    UpdateControlsState;
...
procedure TcxfmVerticalGridReportLinkDesignWindow.
  cbxStyleSheetsPropertiesDrawItem(AControl: TcxCustomComboBox;
  ACanvas: TcxCanvas; AIndex: Integer; const ARect: TRect;
  AState: TOwnerDrawState);
begin
...
procedure RegisterVGridReportLink(AReportLinkClass: TdxReportLinkClass;
  AVGridClass: TComponentClass);
begin
  dxPSRegisterReportLink(AReportLinkClass, AVGridClass,
    TcxfmVerticalGridReportLinkDesignWindow);
end;

procedure UnregisterVGridReportLink(AReportLinkClass: TdxReportLinkClass;
  AVGridClass: TComponentClass);
begin
  dxPSUnregisterReportLink(AReportLinkClass, AVGridClass,
    TcxfmVerticalGridReportLinkDesignWindow);
end;
...
RegisterVGridReportLink(TcxVirtualVerticalGridReportLink,
  TcxVirtualVerticalGrid);

finalization

UnregisterVGridReportLink(TcxVirtualVerticalGridReportLink,
  TcxVirtualVerticalGrid);
