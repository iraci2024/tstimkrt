...
uses
  Classes, SysUtils, Controls, ComCtrls, dxCore, cxClasses, dxPSUtl, dxPSRes,
  dxPSImgs,
...
constructor TdxfmPicturePreview.CreateNew(AOwner: TComponent;
  Dummy: Integer = 0);
begin
...
begin
  ...
  FPictureBox.BuiltInMenuItemsVisibility :=
    FPictureBox.BuiltInMenuItemsVisibility - [biiPreview];
end;
...
begin
  ...
  begin
    ...
    begin
      if Width > Right - Left then
        Width := Right - Left;
      if Height > Bottom - Top then
        Height := Bottom - Top;
