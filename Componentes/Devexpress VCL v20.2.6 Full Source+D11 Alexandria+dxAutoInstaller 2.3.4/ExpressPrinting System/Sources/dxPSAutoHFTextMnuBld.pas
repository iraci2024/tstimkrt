...
type
  ...
  public
    class function Instance: TdxPSAutoHFTextMenuBuilderFactory;
    ...
    property ActiveBuilder: TdxPSAutoHFTextMenuBuilderClass
      read GetActiveBuilder;
    property Builders[Index: Integer]: TdxPSAutoHFTextMenuBuilderClass
      read GetBuilder;
...
class function TdxPSAutoHFTextMenuBuilderFactory.Instance
  : TdxPSAutoHFTextMenuBuilderFactory;
begin
  Result := inherited Instance as TdxPSAutoHFTextMenuBuilderFactory;
end;

procedure TdxPSAutoHFTextMenuBuilderFactory.RegisterBuilder
  (ABuilder: TdxPSAutoHFTextMenuBuilderClass);
begin
  if ABuilder <> nil then
    FBuilders.Add(ABuilder);
end;

procedure TdxPSAutoHFTextMenuBuilderFactory.UnregisterBuilder
  (ABuilder: TdxPSAutoHFTextMenuBuilderClass);
begin
...
function TdxPSAutoHFTextMenuBuilderFactory.GetActiveBuilder
  : TdxPSAutoHFTextMenuBuilderClass;
begin
  if Count <> 0 then
...
function TdxPSAutoHFTextMenuBuilderFactory.GetBuilder(Index: Integer)
  : TdxPSAutoHFTextMenuBuilderClass;
begin
...
class function TAbstractdxPSAutoHFTextMenuBuilder.
...
procedure TdxStandardPSAutoHFTextMenuBuilder.BuildAutoHFTextEntriesMenu
...
class function TdxStandardPSAutoHFTextMenuBuilder.
  ExtractAutoHFTextEntryIndexFromObj(Obj: TObject): Integer;
begin
