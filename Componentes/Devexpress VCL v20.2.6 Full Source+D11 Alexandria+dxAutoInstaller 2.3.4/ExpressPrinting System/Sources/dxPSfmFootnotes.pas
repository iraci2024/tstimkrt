...
uses
  ...
  ImgList, Menus, IniFiles, dxCore, dxPSForm, cxControls, cxContainer, cxEdit,
  cxLabel, cxCheckBox, cxButtons, cxPC,
  cxTextEdit, cxMemo, cxGraphics, cxMaskEdit, cxDropDownEdit, cxColorComboBox,
  cxLookAndFeelPainters, cxGeometry,
  dxPSCore, cxLookAndFeels, dxLayoutcxEditAdapters, dxLayoutContainer,
...
function dxShowReportFootnotesPropertiesDlg(AReportFootnotes
  : TdxReportFootnotes): Boolean;
...
procedure TdxfmReportFootnotesProperties.FormClose(Sender: TObject;
...
procedure TdxfmReportFootnotesProperties.SetReportFootnotes
  (Value: TdxReportFootnotes);
begin
...
begin
  ...
  cbxMode.Properties.Items.Add
    (cxGetResourceString(@sdxFootnotesModeOnLastPage));
  cbxMode.Properties.Items.Add
    (cxGetResourceString(@sdxFootnotesModeOnEveryBottomPage));
...
procedure TdxfmReportFootnotesProperties.CMDialogChar
...
procedure TdxfmReportFootnotesProperties.SaveToIniFile(AIniFile: TCustomIniFile;
...
procedure TdxfmReportFootnotesProperties.btnRestoreDefaultsClick
  (Sender: TObject);
begin
...
begin
  ...
  AImageRect := cxRectCenter(AImageRect, dxGetImageSize(ilAlignments,
    ScaleFactor));
  cxDrawImage(ACanvas, AImageRect, nil, ilAlignments,
    3 * TTagToInt(AControl.Tag) + AIndex, True, nil, ScaleFactor);
