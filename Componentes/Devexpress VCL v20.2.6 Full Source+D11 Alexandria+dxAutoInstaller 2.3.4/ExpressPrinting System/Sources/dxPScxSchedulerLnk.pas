...
{$IFDEF DELPHI16}
  System.UITypes,
{$ENDIF}
  Windows, Classes, SysUtils, Messages, Forms, Graphics, Controls, StdCtrls,
  ExtCtrls, ComCtrls, ImgList, Menus,
  dxCore, dxCoreClasses, cxGraphics, cxClasses, cxControls, cxStyles,
  cxLookAndFeels, cxGeometry, cxContainer, cxLookAndFeelPainters,
  cxDateUtils, dxMessages, cxEdit, cxLabel, cxButtons, cxTextEdit, cxMaskEdit,
  cxGroupBox, cxDrawTextUtils,
  cxDropDownEdit, cxCalendar, cxCheckBox, cxImageComboBox, cxTimeEdit,
  cxSpinEdit, cxPC, cxScheduler, cxSchedulerUtils,
  cxSchedulerStorage, cxSchedulerCustomControls, cxSchedulerCustomResourceView,
  cxSchedulerDayView, cxSchedulerDateNavigator,
  cxSchedulerWeekView, cxSchedulerTimeGridView, cxSchedulerYearView,
  cxSchedulerGanttView, dxPSCore, dxPSGlbl,
  dxExtCtrls, dxPScxCommon, dxPrevw, dxPgsdlg, dxPrnPg, dxPSReportRenderCanvas,
  cxSchedulerRecurrence, dxPSActions,
...
type
  ...
  TcxCustomSchedulerReportLinkPrintStyleClass = class of
  ...
  TcxSchedulerReportDetailsEventCellClass = class of
  ...
  protected
    ...
    property ActiveStyle: TcxCustomSchedulerReportLinkPrintStyle
      read GetActiveStyle;
  ...
  published
    property PrintFrom: TDate index 0 read GetPrintDate write SetPrintDate
      stored IsDateStored;
    property PrintTo: TDate index 1 read GetPrintDate write SetPrintDate
      stored IsDateStored;
    property TimePrintFrom: TTime index 0 read GetPrintTime write SetPrintTime
      stored IsTimeStored;
    property TimePrintTo: TTime index 1 read GetPrintTime write SetPrintTime
      stored IsTimeStored;
  end;

  { TcxSchedulerReportLinkOptionsFormatting }

  TcxSchedulerReportLinkOptionsFormatting = class
  ...
  published
    property SuppressContentColoration: Boolean read FSuppressContentColoration
      write SetSuppressContentColoration default False;
    property UseLookAndFeelColors;
  end;

  { TcxSchedulerReportLinkStyles }

  TcxSchedulerReportLinkStyles = class(TdxCustomReportLinkStyles,
    IcxSchedulerStylesAdapter, IcxSchedulerTimeRulerParams)
  private
  ...
  public
    ...
    function GetDayHeaderParams(const ADateTime: TDateTime)
    ...
    function GetResourceHeaderParams(AResource: TcxSchedulerStorageResourceItem)
      : TcxViewParams; virtual;
    ...
    property ReportLink: TcxSchedulerReportLink read GetReportLink;
  published
    property SchedulerHeader: TcxStyle Index vspsSchedulerSchedulerHeader
      read GetValue write SetValue;
    property Content: TcxStyle Index vspsSchedulerContent read GetValue
      write SetValue;
    property DateNavigatorContent: TcxStyle
      Index vspsSchedulerDateNavigatorContent read GetValue write SetValue;
    property DateNavigatorHeader: TcxStyle
      Index vspsSchedulerDateNavigatorHeader read GetValue write SetValue;
    property DayHeader: TcxStyle Index vspsSchedulerDayHeader read GetValue
      write SetValue;
    property Event: TcxStyle Index vspsSchedulerEvent read GetValue
      write SetValue;
    property ResourceHeader: TcxStyle Index vspsSchedulerResourceHeader
      read GetValue write SetValue;
    property NotesAreaBlank: TcxStyle Index vspsSchedulerNotesAreaBlank
      read GetValue write SetValue;
    property NotesAreaLined: TcxStyle Index vspsSchedulerNotesAreaLined
      read GetValue write SetValue;
    property TaskPad: TcxStyle Index vspsSchedulerTaskPad read GetValue
      write SetValue;
    property TimeRuler: TcxStyle Index vspsSchedulerTimeRuler read GetValue
      write SetValue;
    property StyleSheet;
  end;
  ...
  published
    property Styles: TcxSchedulerReportLinkStyles read GetStylesValue
  ...
  TcxSchedulerReportLinkCanPrintEventEvent = procedure
    (Sender: TcxSchedulerReportLink; AEvent: TcxSchedulerEvent;
  ...
  TcxSchedulerReportLinkInitializeSchedulerHeaderEvent = procedure
    ...
    AItem: TcxSchedulerReportSchedulerHeaderCell) of object;
  TcxSchedulerReportLinkInitializeSchedulingAreaEvent = procedure
    (Sender: TcxSchedulerReportLink;
    AItem: TcxSchedulerReportSchedulingAreaCell) of object;
  TcxSchedulerReportLinkInitializeNotesEvent = procedure
    (Sender: TcxSchedulerReportLink; AItem: TcxSchedulerReportNotesAreaCell)
    of object;
  TcxSchedulerReportLinkInitializeTaskPadEvent = procedure
    (Sender: TcxSchedulerReportLink; AItem: TcxSchedulerReportTaskPadCell)
    of object;
  TcxSchedulerReportLinkInitializeEventCellEvent = procedure
    (Sender: TcxSchedulerReportLink; AItem: TcxSchedulerReportCustomEventCell)
    of object;

  { CustomDraw Events }

  TcxSchedulerReportLinkCustomDrawSchedulerHeaderCellEvent = procedure
    (Sender: TcxSchedulerReportLink; ACanvas: TCanvas;
    AItem: TcxSchedulerReportSchedulerHeaderDataCell; var ADone: Boolean)
    of object;
  TcxSchedulerReportLinkCustomDrawDateNavigatorHeaderCellEvent = procedure
    (Sender: TcxSchedulerReportLink; ACanvas: TCanvas;
    AItem: TcxSchedulerReportDateNavigatorHeader; var ADone: Boolean) of object;
  TcxSchedulerReportLinkCustomDrawDateNavigatorDayCellEvent = procedure
    (Sender: TcxSchedulerReportLink; ACanvas: TCanvas;
    AItem: TcxSchedulerReportDateNavigatorDay; var ADone: Boolean) of object;
  TcxSchedulerReportLinkCustomDrawDateNavigatorDayCaptionCellEvent = procedure
    (Sender: TcxSchedulerReportLink; ACanvas: TCanvas;
    AItem: TcxSchedulerReportDateNavigatorDayCaption; var ADone: Boolean)
    of object;
  TcxSchedulerReportLinkCustomDrawDateNavigatorWeekNumberCellEvent = procedure
    (Sender: TcxSchedulerReportLink; ACanvas: TCanvas;
    AItem: TcxSchedulerReportDateNavigatorWeekNumber; var ADone: Boolean)
    of object;
  TcxSchedulerReportLinkCustomDrawTimeRulerCellEvent = procedure
    (Sender: TcxSchedulerReportLink; ACanvas: TCanvas;
    AItem: TcxSchedulerReportDailyTimeRulerCell; var ADone: Boolean) of object;
  TcxSchedulerReportLinkCustomDrawNotesCellEvent = procedure
    (Sender: TcxSchedulerReportLink; ACanvas: TCanvas;
    AItem: TcxSchedulerReportNotesDataCell; var ADone: Boolean) of object;
  TcxSchedulerReportLinkCustomDrawContentCellEvent = procedure
    (Sender: TcxSchedulerReportLink; ACanvas: TCanvas;
    AItem: TcxSchedulerReportContentCell; var ADone: Boolean) of object;
  TcxSchedulerReportLinkCustomDrawHeaderCellEvent = procedure
    (Sender: TcxSchedulerReportLink; ACanvas: TCanvas;
    AItem: TcxSchedulerReportHeaderItemCell; var ADone: Boolean) of object;
  TcxSchedulerReportLinkCustomDrawEventPartCellEvent = procedure
    (Sender: TcxSchedulerReportLink; ACanvas: TCanvas;
    AItem: TAbstractdxReportCellData; APart: TcxSchedulerReportEventPartType;
    var ADone: Boolean) of object;

  TcxSchedulerReportLink = class(TdxCustomcxControlReportLink,
  ...
  private
    ...
    FOnCustomDrawSchedulerHeaderCell
      : TcxSchedulerReportLinkCustomDrawSchedulerHeaderCellEvent;
    FOnCustomDrawDateNavigatorHeaderCell
      : TcxSchedulerReportLinkCustomDrawDateNavigatorHeaderCellEvent;
    FOnCustomDrawDateNavigatorDayCell
      : TcxSchedulerReportLinkCustomDrawDateNavigatorDayCellEvent;
    FOnCustomDrawDateNavigatorDayCaptionCell
      : TcxSchedulerReportLinkCustomDrawDateNavigatorDayCaptionCellEvent;
    FOnCustomDrawDateNavigatorWeekNumberCell
      : TcxSchedulerReportLinkCustomDrawDateNavigatorWeekNumberCellEvent;
    FOnCustomDrawTimeRulerCell
      : TcxSchedulerReportLinkCustomDrawTimeRulerCellEvent;
    ...
    FOnCustomDrawEventPartCell
      : TcxSchedulerReportLinkCustomDrawEventPartCellEvent;
    ...
    FOnInitializeSchedulingAreaCell
      : TcxSchedulerReportLinkInitializeSchedulingAreaEvent;
    FOnInitializeEventCell: TcxSchedulerReportLinkInitializeEventCellEvent;
    FOnInitializeHeaderPrimaryCell
      : TcxSchedulerReportLinkInitializeSchedulerHeaderEvent;
    FOnInitializeHeaderSecondaryCell
      : TcxSchedulerReportLinkInitializeSchedulerHeaderEvent;
    ...
    procedure SetOptionsFormatting
      (Value: TcxSchedulerReportLinkOptionsFormatting);
  ...
  protected
    ...
    procedure DoCanPrintEvent(AEvent: TcxSchedulerEvent;
      var AllowPrint: Boolean); virtual;

    procedure DoCustomDrawSchedulerHeaderCell(ACanvas: TCanvas;
      AItem: TcxSchedulerReportSchedulerHeaderDataCell;
      var ADone: Boolean); virtual;
    procedure DoCustomDrawDateNavigatorHeaderCell(ACanvas: TCanvas;
      AItem: TcxSchedulerReportDateNavigatorHeader;
      var ADone: Boolean); virtual;
    ...
    procedure DoCustomDrawDateNavigatorDayCaptionCell(ACanvas: TCanvas;
      AItem: TcxSchedulerReportDateNavigatorDayCaption;
      var ADone: Boolean); virtual;
    procedure DoCustomDrawDateNavigatorWeekNumberCell(ACanvas: TCanvas;
      AItem: TcxSchedulerReportDateNavigatorWeekNumber;
      var ADone: Boolean); virtual;
    ...
    procedure RegisterLookAndFeelItem(AItem: TdxReportVisualItem;
      AEdgeStyle: TdxCellEdgeStyle);

    procedure DoInitializeSchedulingAreaCell
      (AItem: TcxSchedulerReportSchedulingAreaCell); virtual;
    procedure DoInitializeEventCell
      (AItem: TcxSchedulerReportCustomEventCell); virtual;
    procedure DoInitializeHeaderPrimaryCell
      (AItem: TcxSchedulerReportSchedulerHeaderCell); virtual;
    procedure DoInitializeHeaderSecondaryCell
      (AItem: TcxSchedulerReportSchedulerHeaderCell); virtual;
    procedure DoInitializeNotesAreaCell
      (AItem: TcxSchedulerReportNotesAreaCell); virtual;
    procedure DoInitializeTaskPadCell
      (AItem: TcxSchedulerReportTaskPadCell); virtual;

    procedure AssignTaskPadData(ATaskPad: TcxSchedulerReportTaskPadCell);
    procedure InitializeTaskPadCell(ATaskPad
      : TcxSchedulerReportTaskPadCell); virtual;

    procedure SetCellViewParams(ACell: TdxReportVisualItem;
      const AParams: TcxViewParams); overload;
    procedure SetCellViewParams(ACell: TdxReportVisualItem;
    ...
    property LinkInPreviewMode: Boolean read FLinkInPreviewMode
      write FLinkInPreviewMode;
  ...
  public
    ...
    property DesignWindow: TcxfmSchedulerReportLinkDesignWindow
  ...
  published
    ...
    property OptionsFormatting: TcxSchedulerReportLinkOptionsFormatting
      read GetOptionsFormatting write SetOptionsFormatting;
    property PrintRange: TcxSchedulerReportLinkPrintRange read FPrintRange
      write SetPrintRange;
    property PrintStyles: TcxSchedulerReportLinkPrintStyles read GetPrintStyles
      write SetPrintStyles;
    property ScaleFonts;
    property StyleRepository;
    property Styles: TcxSchedulerReportLinkStyles read GetStyles
      write SetStyles;
    property SupportedCustomDraw;
    property TaskPadReportLink: TBasedxReportLink read FTaskPadReportLink
      write SetTaskPadReportLink;

    property OnActivePrintStyleChanged: TNotifyEvent
      read FOnActivePrintStyleChanged write FOnActivePrintStyleChanged;
    property OnCanPrintEvent: TcxSchedulerReportLinkCanPrintEventEvent
      read FOnCanPrintEvent write FOnCanPrintEvent;

    property OnCustomDrawSchedulerHeaderCell
      : TcxSchedulerReportLinkCustomDrawSchedulerHeaderCellEvent
      read FOnCustomDrawSchedulerHeaderCell
      write FOnCustomDrawSchedulerHeaderCell;
    property OnCustomDrawDateNavigatorHeaderCell
      : TcxSchedulerReportLinkCustomDrawDateNavigatorHeaderCellEvent
      read FOnCustomDrawDateNavigatorHeaderCell
      write FOnCustomDrawDateNavigatorHeaderCell;
    property OnCustomDrawDateNavigatorDayCell
      : TcxSchedulerReportLinkCustomDrawDateNavigatorDayCellEvent
      read FOnCustomDrawDateNavigatorDayCell
      write FOnCustomDrawDateNavigatorDayCell;
    property OnCustomDrawDateNavigatorDayCaptionCell
      : TcxSchedulerReportLinkCustomDrawDateNavigatorDayCaptionCellEvent
      read FOnCustomDrawDateNavigatorDayCaptionCell
      write FOnCustomDrawDateNavigatorDayCaptionCell;
    property OnCustomDrawDateNavigatorWeekNumberCell
      : TcxSchedulerReportLinkCustomDrawDateNavigatorWeekNumberCellEvent
      read FOnCustomDrawDateNavigatorWeekNumberCell
      write FOnCustomDrawDateNavigatorWeekNumberCell;
    property OnCustomDrawTimeRulerCell
      : TcxSchedulerReportLinkCustomDrawTimeRulerCellEvent
      read FOnCustomDrawTimeRulerCell write FOnCustomDrawTimeRulerCell;
    property OnCustomDrawContentCell
      : TcxSchedulerReportLinkCustomDrawContentCellEvent
      read FOnCustomDrawContentCell write FOnCustomDrawContentCell;
    property OnCustomDrawHeaderCell
      : TcxSchedulerReportLinkCustomDrawHeaderCellEvent
      read FOnCustomDrawHeaderCell write FOnCustomDrawHeaderCell;
    property OnCustomDrawEventPartCell
      : TcxSchedulerReportLinkCustomDrawEventPartCellEvent
      read FOnCustomDrawEventPartCell write FOnCustomDrawEventPartCell;
    property OnCustomDrawNotesCell
      : TcxSchedulerReportLinkCustomDrawNotesCellEvent
      read FOnCustomDrawNotesCell write FOnCustomDrawNotesCell;
    property OnCustomDrawTaskPadCell
      : TcxSchedulerReportLinkCustomDrawNotesCellEvent
      read FOnCustomDrawTaskPadCell write FOnCustomDrawTaskPadCell;

    property OnInitializeSchedulingAreaCell
      : TcxSchedulerReportLinkInitializeSchedulingAreaEvent
      read FOnInitializeSchedulingAreaCell
      write FOnInitializeSchedulingAreaCell;
    property OnInitializeEventCell
      : TcxSchedulerReportLinkInitializeEventCellEvent
      read FOnInitializeEventCell write FOnInitializeEventCell;
    property OnInitializeHeaderPrimaryCell
      : TcxSchedulerReportLinkInitializeSchedulerHeaderEvent
      read FOnInitializeHeaderPrimaryCell write FOnInitializeHeaderPrimaryCell;
    property OnInitializeHeaderSecondaryCell
      : TcxSchedulerReportLinkInitializeSchedulerHeaderEvent
      read FOnInitializeHeaderSecondaryCell
      write FOnInitializeHeaderSecondaryCell;
    property OnInitializeNotesAreaCell
      : TcxSchedulerReportLinkInitializeNotesEvent
      read FOnInitializeNotesAreaCell write FOnInitializeNotesAreaCell;
    property OnInitializeTaskPadCell
      : TcxSchedulerReportLinkInitializeTaskPadEvent
  ...
  TcxCustomSchedulerReportLinkPrintStyle = class(TPersistent, IUnknown,
    IdxPSCellParams, IdxPSCellParams2, IdxLocalizerListener)
  private
  ...
  protected
    ...
    function AddPageSite(const ABounds: TRect)
      : TcxSchedulerReportPageSite; virtual;

    procedure AfterBuild; virtual;
    procedure BeforeBuild; virtual;
    procedure Build; virtual;
    procedure BuildPages; virtual;
    procedure BuildSchedulerCells
    ...
    function GetRebuildOnPageParamsChange(AnUpdateCodes
      : TdxPrinterPageUpdateCodes): Boolean; virtual;

    function CheckPrintRangeDate(const ADate: TDateTime; AIndex: Integer)
      : TDateTime; virtual;
    function CheckPrintRangeTime(const ATime: TDateTime; AIndex: Integer)
      : TDateTime; virtual;
    ...
    function CreateDateNavigatorCell(ASite: TdxReportCell; AYear, AMonth: Word)
      : TcxSchedulerReportDateNavigatorCell; virtual;
    function CreateHeaderCell(ASite: TdxReportCell)
      : TcxSchedulerReportSchedulerHeaderCell; virtual;
    function CreateNotesCell(ASite: TdxReportCell)
      : TcxSchedulerReportNotesAreaCell; virtual;
    function CreateNotesLinedCell(ASite: TdxReportCell)
      : TcxSchedulerReportNotesAreaCell; virtual;
    function CreateSchedulingAreaCell(ASite: TdxReportCell)
      : TcxSchedulerReportSchedulingAreaCell; virtual;
    function CreateSchedulingCellsProducer
      (ASite: TcxSchedulerReportSchedulingAreaCell)
      : TcxSchedulerReportCommonCellsProducer; virtual;
    function CreateTaskPadCell(ASite: TdxReportCell)
      : TcxSchedulerReportTaskPadCell; virtual;

    procedure InitHeaderCell
      (ACell: TcxSchedulerReportSchedulerHeaderCell); virtual;
    function InitReportCell(ACell: TdxReportCell; const ABounds: TRect)
      : TdxReportCell;

    procedure CorrectBoundsWithHeader
      (AHeader: TcxSchedulerReportSchedulerHeaderCell; var ABounds: TRect);
    procedure CreateAdditionalControls(ASite: TdxReportCell;
      AHasCalendar, AHasTaskPad, AHasNotes, AHasNotesLined, ARightSide: Boolean;
      var ABounds: TRect); virtual;
    ...
    procedure CreateControlsOnSecondPage(APageIndex: Integer;
      ASite, AHeader: TdxReportCell; ABounds: TRect); virtual;
    procedure CreateHeaderDateNavigator
      (AHeader: TcxSchedulerReportSchedulerHeaderCell; APageIndex: Integer;
      out ABounds: TRect); virtual;
    procedure CreateLayoutForPeriod(APeriodIndex: Integer); virtual;
    procedure CreatePageSiteWithHeader(APageIndex: Integer;
      out ASite: TcxSchedulerReportPageSite;
      out AHeader: TcxSchedulerReportSchedulerHeaderCell; out ABounds: TRect;
      AIsPrimary: Boolean = True);
    // items visibility
    ...
    function GetPageHeaderHeight(const ASiteBounds: TRect;
      APageIndex: Integer): Integer;
    function GetPageIndex(APeriodIndex, AIndex: Integer): Integer;
    procedure GetPagePeriodAndIndex(APageIndex: Integer;
      var APeriodIndex, ASubIndex: Integer);
    ...
    procedure GetPageDateNavigatorInfo(APageIndex: Integer;
      out AYear, AMonth: Word); virtual;
    ...
    property CompressWeekends: Boolean read FCompressWeekends
      write SetCompressWeekends default True;
    property DontPrintWeekends: Boolean read FDontPrintWeekends
      write SetDontPrintWeekends default False;
    property Events: TcxSchedulerCachedEventList read FEvents;
    property GlyphIndex: Integer read GetGlyphIndex;
    property Layout: TcxSchedulerReportLinkPeriodicPrintStyleLayout read FLayout
      write SetLayout stored IsLayoutStored;
    property PagesPerPeriod: Integer read FPagesPerPeriod;
    property PageSites[Index: Integer]: TcxSchedulerReportPageSite
      read GetPageSite;
    ...
    property ResourceCountPerPage: Integer read FResourceCountPerPage
      write SetResourceCountPerPage default 0;
    property ShowEventImages: Boolean read FShowEventImages
      write SetShowEventImages;
    property ShowNotesAreaBlank: Boolean read GetShowNotesAreaBlank
      write SetShowNotesAreaBlank stored IsShowNotesAreaBlankStored;
    property ShowNotesAreaLined: Boolean read FShowNotesAreaLined
      write SetShowNotesAreaLined default False;
    property ShowResourceImages: Boolean read FShowResourceImages
      write SetShowResourceImages;
    property ShowTaskPad: Boolean read FShowTaskPad write SetShowTaskPad
      default False;
    property StartOfWeekOffset: Integer read GetStartOfWeekOffset;
    property Storage: TcxCustomSchedulerStorage read GetStorage;
    property TimePrintFrom: TTime read GetTimePrintFrom write SetTimePrintFrom
      stored False;
    property TimePrintTo: TTime read GetTimePrintTo write SetTimePrintTo
      stored False;
  ...
  public
    ...
    property CorrespondedView: TcxSchedulerCustomResourceView
      read GetCorrespondedView;
  ...
  protected
    ...
    function CreateSchedulingCellsProducer
      (ASite: TcxSchedulerReportSchedulingAreaCell)
      : TcxSchedulerReportCommonCellsProducer; override;
    procedure FillDatesForPage(ADateList: TcxSchedulerDateList;
    ...
    procedure InitHeaderCell
      (ACell: TcxSchedulerReportSchedulerHeaderCell); override;
  ...
  TcxSchedulerReportLinkCustomDetailsPrintStyle = class
    (TcxCustomSchedulerReportLinkPrintStyle)
  private
    FTimeWidth: Integer;
  ...
  protected
    ...
    function AddPageSite(const ABounds: TRect)
      : TcxSchedulerReportPageSite; override;
    procedure BeforeBuild; override;
    function GetNextPage(APrevPage: TcxSchedulerReportPageSite;
      out ABounds: TRect): TcxSchedulerReportPageSite;
    function GetPageCount: Integer; override;
  ...
  TcxSchedulerReportLinkDetailsPrintStylePaginationMode = (dpmByDay, dpmByWeek,
    dpmByMonth);
  ...
  protected
    ...
    function GetSchedulerReportDetailsEventCellClass
      : TcxSchedulerReportDetailsEventCellClass; virtual;

    // layout calculation
    function AddEventCell(AEvent: TcxSchedulerEvent)
      : TcxSchedulerReportDetailsEventCell; virtual;
  ...
  published
    ...
    property PaginationMode
      ...
      read FPaginationMode write SetPaginationMode default dpmByDay;
    property UsePagination: Boolean read FUsePagination write SetUsePagination
      default False;
  end;
  ...
  protected
    ...
    procedure BuildPages; override;
    procedure DoCanPrintEvent(AEvent: TcxSchedulerEvent;
      var AllowPrint: Boolean); override;
    function GetGlyphIndex: Integer; override;
    function GetPreviewGlyphIndex: Integer; override;
  ...
  published
    property Active;
    property Caption;
    property SelectedEventsOnly: Boolean read FSelectedEventsOnly
      write FSelectedEventsOnly default True;
    property StartEachItemOnNewPage: Boolean read FStartEachItemOnNewPage
      write FStartEachItemOnNewPage default True;
  end;
  ...
  published
    ...
    property Layout;
    property PrintExactlyOneMonthPerPage: Boolean
      read FPrintExactlyOneMonthPerPage write SetPrintExactlyOneMonthPerPage
      default False;
    property ResourceCountPerPage;
  ...
  protected
    ...
    procedure BeforeBuild; override;
    procedure BuildSchedulerCells
      (ASite: TcxSchedulerReportSchedulingAreaCell); override;
    ...
    property LayoutBuilder: TcxSchedulerReportTimeLineLayoutBuilder
      read FLayoutBuilder;
  ...
  published
    property Active;
    property DontPrintWeekends;
    property PrimaryPageScalesOnly: Boolean read FPrimaryPageScalesOnly
      write SetPrimaryPageScalesOnly default False;
    property PrimaryPageHeadersOnly: Boolean read FPrimaryPageHeadersOnly
      write SetPrimaryPageHeadersOnly default False;
    property ResourceCountPerPage;
    property ShowEventImages default True;
    ...
    property ShowResourceImages default True;
    property ShowTaskPad;
    property WorkTimeOnly: Boolean read FWorkTimeOnly write SetWorkTimeOnly
      default False;
  end;

  { TcxSchedulerReportLinkTrifoldPrintStyle }

  TcxSchedulerReportLinkTrifoldPrintStyleSectionMode = (smDailyCalendar,
    smWeeklyCalendar, smMonthlyCalendar, smTaskPad, smNotesAreaBlank,
    smNotesAreaLined);
  ...
  private
    FSections: array [0 .. 2]
      of TcxSchedulerReportLinkTrifoldPrintStyleSectionMode;
    function GetHasDailySection: Boolean;
    function GetSection(Index: Integer)
      : TcxSchedulerReportLinkTrifoldPrintStyleSectionMode;
    procedure SetSection(Index: Integer;
      AValue: TcxSchedulerReportLinkTrifoldPrintStyleSectionMode);
  ...
  protected
    ...
    procedure CreateLayoutForSection(ASite: TdxReportCell;
      APeriodIndex: Integer; const ABounds: TRect;
      ASection: TcxSchedulerReportLinkTrifoldPrintStyleSectionMode); virtual;
    procedure CreateSchedulingAreaWithHeader(ASite: TdxReportCell;
  ...
  published
    property Active;
    property Caption;
    property LeftSection: TcxSchedulerReportLinkTrifoldPrintStyleSectionMode
      index 0 read GetSection write SetSection stored IsSectionStored;
    property MiddleSection: TcxSchedulerReportLinkTrifoldPrintStyleSectionMode
      index 1 read GetSection write SetSection stored IsSectionStored;
    property RightSection: TcxSchedulerReportLinkTrifoldPrintStyleSectionMode
      index 2 read GetSection write SetSection stored IsSectionStored;
  end;

  { TcxSchedulerReportLinkWeeklyPrintStyle }

  TcxSchedulerReportLinkWeeklyPrintStyleArrange = (wsaTopToBottom,
    wsaLeftToRight);
  ...
  public
    ...
    property DaysLayoutAssigned: Boolean read FDaysLayoutAssigned
      write FDaysLayoutAssigned;
  published
    property Active;
    property Arrange: TcxSchedulerReportLinkWeeklyPrintStyleArrange
      read FArrange write SetArrange stored IsArrangeStored;
    property Caption;
    property DaysLayout: TcxSchedulerWeekViewDaysLayout read GetDaysLayout
      write SetDaysLayout stored IsDaysLayoutStored;
    property DontPrintWeekends;
    property Layout;
    property ResourceCountPerPage;
    property ShowEventImages default False;
  ...
  published
    ...
    property Caption;
    property Layout;
    property MonthCountPerPage: Integer read FMonthCountPerPage
      write SetMonthCountPerPage default 12;
    property PrimaryPageHeadersOnly: Boolean read FPrimaryPageHeadersOnly
      write SetPrimaryPageHeadersOnly default False;
    property ShowEventImages default False;
    property ShowNotesAreaBlank;
  ...
  protected
    ...
    procedure ActiveStyleChanged; virtual;
    function CreateStyle(AStyleClass
      : TcxCustomSchedulerReportLinkPrintStyleClass)
      : TcxCustomSchedulerReportLinkPrintStyle; virtual;
    procedure CreateStyles; virtual;
    procedure DestroyStyles; virtual;
    procedure GetStyleByClassEx
    ...
    procedure StyleChanged(AStyle
      : TcxCustomSchedulerReportLinkPrintStyle); virtual;
  public
    procedure Assign(Source: TPersistent); override;
    procedure RestoreDefaults; override;

    function GetCorrespondingStyle
      : TcxCustomSchedulerReportLinkPrintStyle; virtual;
    function GetStyleByClass(AClass
      : TcxCustomSchedulerReportLinkPrintStyleClass)
      : TcxCustomSchedulerReportLinkPrintStyle;
    function GetStyleByName(const Name: string)
      : TcxCustomSchedulerReportLinkPrintStyle;
    ...
    property ActiveStyle: TcxCustomSchedulerReportLinkPrintStyle
      read FActiveStyle write SetActiveStyle stored False;
    property ActiveStyleAssigned: Boolean read FActiveStyleAssigned
      write SetActiveStyleAssigned;
    property Count: Integer read GetCount;
    property Items[Index: Integer]: TcxCustomSchedulerReportLinkPrintStyle
      read GetItem write SetItem; default;
  published
    property Agenda: TcxSchedulerReportLinkAgendaPrintStyle read GetStyleAgenda
      write SetStyleAgenda;
    property Daily: TcxSchedulerReportLinkDailyPrintStyle read GetStyleDaily
      write SetStyleDaily;
    property Details: TcxSchedulerReportLinkDetailsPrintStyle
      read GetStyleDetails write SetStyleDetails;
    property Memo: TcxSchedulerReportLinkMemoPrintStyle read GetStyleMemo
      write SetStyleMemo;
    property Monthly: TcxSchedulerReportLinkMonthlyPrintStyle
      read GetStyleMonthly write SetStyleMonthly;
    property Trifold: TcxSchedulerReportLinkTrifoldPrintStyle
      read GetStyleTrifold write SetStyleTrifold;
    property TimeLine: TcxSchedulerReportLinkTimeLinePrintStyle
      read GetStyleTimeLine write SetStyleTimeLine;
    property Weekly: TcxSchedulerReportLinkWeeklyPrintStyle read GetStyleWeekly
      write SetStyleWeekly;
    property Yearly: TcxSchedulerReportLinkYearlyPrintStyle read GetStyleYearly
      write SetStyleYearly;
  end;
  ...
  protected
    function GetSchedulerReportDetailsEventCellClass
      : TcxSchedulerReportDetailsEventCellClass; override;
    function MeasureTimeWidth: Integer; override;
  public
    function DefaultCaption: string; override;
    function IsCompatibleWith(AView: TcxSchedulerCustomView): Boolean; override;
  ...
  private
    ...
    procedure SetPrintStyleOptionsViewByIndex(AnIndex: Integer;
      AValue: Boolean);
    procedure SetPrintStyleRangeByIndex(AnIndex: Integer;
      const ATime: TDateTime);
    procedure SetPrintStyleResourceCountPerPageByIndex(AnIndex: Integer;
      AValue: TcxEditValue);
    procedure SetShowImagesCheckBoxes(AEventImages, AResourceImages
      : TcxCheckBox; APrintStyle: TcxCustomSchedulerReportLinkPrintStyle);

    procedure WMDXCONTAINERSETFOCUS(var AMessage: TMessage);
      message DXM_CONTAINERSETFOCUS;
  protected
    ...
    procedure LoadCaption(AItem: TdxCustomLayoutItem; StrPtr: Pointer);
      overload;
    procedure LoadCaption(AItem: TMenuItem; StrPtr: Pointer); overload;
    procedure LoadGroupsIcons; override;
    procedure LoadStrings; override;
    procedure LoadStringsCombo(ACombo: TcxComboBox;
      ACaptions: array of Pointer);
    ...
    procedure UpdateEnabledControls(AControls: array of TComponent;
      AEnabled: Boolean);
    procedure UpdatePreview; override;
    procedure UpdateVisibility(AComponent: TComponent; AVisible: Boolean);
    procedure UpdateVisibilityControls(AControls: array of TComponent;
      AVisible: Boolean);
    ...
    function FindTabIndexByPrintStyle(APrintStyle
      : TcxCustomSchedulerReportLinkPrintStyle): Integer; virtual;
    procedure RefreshPrintStyles; virtual;

    property ActivePrintStyle: TcxCustomSchedulerReportLinkPrintStyle
      read GetActivePrintStyle;
  ...
  protected
    ...
    procedure SetCellViewParams(AItem: TdxReportVisualItem;
      const AParams: TcxViewParams); overload;
    procedure SetCellViewParams(AItem: TdxReportVisualItem;
      const AParams: TdxReportItemViewParams); overload;
  ...
  TcxSchedulerReportNotesDataCellClass = class of
    TcxSchedulerReportNotesDataCell;
  ...
  protected
    ...
    function AddTextCell(AText: string; const ABounds: TRect;
      AMultiLine: Boolean): TdxReportCellString;
    function GetType: TcxSchedulerReportItemsType; override;

    property Date: TDateTime read FDate write FDate;
    property PrimaryText: string read FPrimaryText write FPrimaryText;
    // todo: remove
  ...
  public
    ...
    property DateNavigator: TcxSchedulerReportDateNavigatorCell
  ...
  protected
    ...
    procedure WriteData(AWriter: TdxPSDataWriter); override;
  public
    constructor CreateEx(AParent: TdxReportCell; ADay, ACol, ARow: Integer;
      ABold: Boolean); virtual;
    procedure Assign(Source: TPersistent); override;
  ...
  protected
    ...
    procedure WriteData(AWriter: TdxPSDataWriter); override;
  public
    constructor CreateEx(AParent: TdxReportCell; ADayOfWeek: TDay;
      ACol: Integer); virtual;
    procedure Assign(Source: TPersistent); override;
  ...
  public
    constructor CreateEx(AParent: TdxReportCell;
      AWeekNumber, ARow: Integer); virtual;
    procedure Assign(Source: TPersistent); override;
  ...
  protected
    ...
    procedure CreateWeekNumber(const ABounds: TRect; ADate: TDateTime;
      ARow: Integer); virtual;
    class procedure GetContentPartSizes(AFont: TFont;
      var AColWidth, ARowHeight, ADayCaptionsHeight: Integer;
    ...
    class procedure GetHeaderPartSizes(AFont: TFont; var AHeaderHeight: Integer;
      AFontSize: Integer = 0); virtual;
    function GetMonthSize(const AContentParams, AHeaderParams
      : TdxReportItemViewParams): TSize;
    function GetType: TcxSchedulerReportItemsType; override;
    procedure SetViewParams(const AContentParams, AHeaderParams
  ...
  public
    ...
    constructor CreateEx(AParent: TdxReportCell;
      ...
      AShowDatesContainingEventsInBold, AShowWeekNumbers: Boolean); virtual;

    procedure AdjustSize(var AContentParams, AHeaderParams
      : TdxReportItemViewParams; AHeight, AMaxHeight: Integer); virtual;
    function CalculateSize(const AContentParams, AHeaderParams
      : TdxReportItemViewParams): TSize;
    class function MeasureDateNavigatorHeight(const AContentParams,
      AHeaderParams: TcxViewParams): Integer; virtual;

    property FirstWeekOfYear: TcxFirstWeekOfYear read FFirstWeekOfYear
      write FFirstWeekOfYear;
    property Month: Word read FMonth write FMonth;
    property ShowDatesContainingEventsInBold: Boolean
      read FShowDatesContainingEventsInBold
      write FShowDatesContainingEventsInBold;
    ...
    property DayCaptions[Index: Integer]
      : TcxSchedulerReportDateNavigatorDayCaption read GetDayCaption;
    property DayCount: Integer read FDayCount;
    property Days[Index: Integer]: TcxSchedulerReportDateNavigatorDay
      read GetDay;
    ...
    property WeekNumbers[Index: Integer]
      : TcxSchedulerReportDateNavigatorWeekNumber read GetWeekNumber;
  end;
  ...
  protected
    ...
    procedure DrawCellState(ACanvas: TdxPSReportRenderCustomCanvas; R: TRect;
      AState: Integer; ABorders: TcxBorders = [];
      ABorderColor: TColor = clBlack);

    function AdjustTextRect(const ARect: TRect): TRect;
    function ExcludeBorders(const ARect: TRect; ABorders: TcxBorders;
      ABorderWidth: Integer = 1): TRect;
    function FixupWidth(AWidth: Integer): Integer;
    function GetFixupRect(ACanvas: TdxPSReportRenderCustomCanvas;
      const ARect: TRect): TRect;
    function InflateRect(const ARect: TRect; dX, dY: Integer): TRect;

    property ReportLink: TcxSchedulerReportLink read GetReportLink;
  public
    constructor CreateFrom(AParent: TdxReportCell;
      AViewInfo: TcxSchedulerCustomViewInfoItem); virtual;
    procedure DrawContent(ACanvas: TdxPSReportRenderCustomCanvas;
      AStage: TdxPSRenderStages); override;
    class procedure RegisterMirrorClass; virtual;
    class function SchedulerCellClass
      : TcxSchedulerCustomViewInfoItemClass; virtual;
  ...
  public
    constructor CreateFrom(AParent: TdxReportCell;
      AViewInfo: TcxSchedulerCustomViewInfoItem); override;
    procedure Assign(Source: TPersistent); override;
    procedure DrawContent(ACanvas: TdxPSReportRenderCustomCanvas;
      AStage: TdxPSRenderStages); override;
    class function SchedulerCellClass
      : TcxSchedulerCustomViewInfoItemClass; override;
  ...
  TcxSchedulerReportTimeLineMinorScaleCell = class
    (TcxSchedulerReportBackgroundSlotCell)
  public
    constructor CreateFrom(AParent: TdxReportCell;
      AViewInfo: TcxSchedulerCustomViewInfoItem); override;
  ...
  TcxSchedulerReportTimeLineMajorScaleCell = class
    (TcxSchedulerReportBackgroundSlotCell)
  public
    class function SchedulerCellClass
      : TcxSchedulerCustomViewInfoItemClass; override;
  ...
  public
    ...
    property DisplayTexts[ACurrentTimeZone: Boolean]: string
      read GetDisplayText;
    ...
    property TimeRulerSite: TcxSchedulerReportDailyTimeRulerCellsSite
      read GetTimeRulerSite;
  end;

  { TcxSchedulerReportDailyTimeRulerModernCell }

  TcxSchedulerReportDailyTimeRulerModernCell = class
    (TcxSchedulerReportDailyTimeRulerCell)
  protected
    procedure DrawTimeZone(ACanvas: TdxPSReportRenderCustomCanvas;
  ...
  public
    constructor CreateEx(AParent: TdxReportCell; ATriangle: Boolean;
      AState: Integer);
    procedure Assign(Source: TPersistent); override;
    procedure DrawContent(ACanvas: TdxPSReportRenderCustomCanvas;
      AStage: TdxPSRenderStages); override;
  ...
  protected
    ...
    function GetMessageClass(AProperties: TcxCustomEditProperties)
      : TdxReportCellDataClass; virtual;
    function GetValidMessage(const AMessage: Variant;
      AProperties: TcxCustomEditProperties): Variant; virtual;
    procedure InitializeMessageCell(AProperties: TcxCustomEditProperties;
      const AViewParams: TcxViewParams); virtual;
    function NeedExtractPlainTextForMessage(AProperties
      : TcxCustomEditProperties): Boolean; virtual;
    procedure SetViewParams(const AViewParams: TcxViewParams); virtual;
  public
    function CreateStringCell(const AText: string; AMultiLine: Boolean = True;
      AData: Integer = 0): TdxReportCellString; virtual;
    ...
    property PrintStyle: TcxCustomSchedulerReportLinkPrintStyle
      read GetPrintStyle;
    property ReportLink: TcxSchedulerReportLink read GetReportLink;
  ...
  protected
    procedure AdjustItemsHeight(ACanvas
      : TdxPSReportRenderCustomCanvas); virtual;
    procedure AdjustSomeCells(ACanvas: TdxPSReportRenderCustomCanvas); virtual;
    procedure CalculateCaptionCellRect(ACanvas: TdxPSReportRenderCustomCanvas;
      ACaptionRect: TRect); virtual;
    procedure CalculateLayout; virtual;
    procedure CalculateMessageCell
      (ACanvas: TdxPSReportRenderCustomCanvas); virtual;
    procedure CalculateTimeCells(ACanvas: TdxPSReportRenderCustomCanvas;
      var ACaptionRect: TRect); virtual;
    procedure CalculateTimeLine(ACanvas
      : TdxPSReportRenderCustomCanvas); virtual;
    function GetActualTimeRect: TRect; virtual;
    function GetCaption: string; virtual;
    procedure CorrectCaptionRectForMessage
      (ACanvas: TdxPSReportRenderCustomCanvas; var ARect: TRect); virtual;
    ...
    function CreateTimeTextCell(const ATimeText: string; AData: Integer = 0)
      : TdxReportCellString; virtual;
    procedure DoInitializeFromViewInfo(AEventViewInfo
      : TcxSchedulerEventCellViewInfo); virtual;
    function GetContentBounds(ACanvas: TdxPSReportRenderCustomCanvas)
      : TRect; virtual;
    function GetHasImages: Boolean; virtual;
    function GetHasMessage: Boolean; virtual;
    function GetMessage: Variant; override;
    function GetMessageRect(ACanvas: TdxPSReportRenderCustomCanvas)
      : TRect; virtual;
    function GetRelativeRect(const R: TRect): TRect;
    function GetTimeLineRect(ACanvas: TdxPSReportRenderCustomCanvas)
      : TRect; virtual;
    procedure InitializeFromViewInfo(AEventViewInfo
      : TcxSchedulerEventCellViewInfo);
    procedure InitializeMessageCell(AProperties: TcxCustomEditProperties;
      const AViewParams: TcxViewParams); override;
    function IsNeedCreateTimeLineCell: Boolean; virtual;
    procedure MeasureTimeCell(ACanvas: TdxPSReportRenderCustomCanvas;
      out AWidth, AHeight: Integer); virtual;
  ...
  public
    constructor CreateFrom(AParent: TdxReportCell;
      AEventViewInfo: TcxSchedulerEventCellViewInfo); virtual;
  ...
  protected
    ...
    procedure CalculateCaptionCellRect(ACanvas: TdxPSReportRenderCustomCanvas;
      ACaptionRect: TRect); override;
    procedure CalculateLocationCellRect; virtual;
    procedure CalculateTimeCells(ACanvas: TdxPSReportRenderCustomCanvas;
      var ACaptionRect: TRect); override;
    procedure CorrectCaptionRectForMessage
      (ACanvas: TdxPSReportRenderCustomCanvas; var ARect: TRect); override;
  ...
  public
    constructor CreateEx(AParent: TdxReportCell; AEvent: TcxSchedulerEvent;
      ADate: TDateTime; const AParams: TcxViewParams;
  ...
  protected
    ...
    procedure CalculateLabelAndData(ALabelCell,
      ADataCell: TAbstractdxReportCellData;
  ...
  public
    ...
    property RecurrencePatternCell: TdxReportCellString
      read FRecurrencePatternCell;
    property RecurrencePatternLabelCell: TdxReportCellString
      read FRecurrencePatternLabelCell;
  end;

  { TcxSchedulerReportDetailsAgendaEventCell }

  TcxSchedulerReportDetailsAgendaEventCell = class
    (TcxSchedulerReportDetailsEventCell)
  private
  ...
  public
    constructor CreateFrom(AParent: TdxReportCell;
      AViewInfo: TcxSchedulerCustomViewInfoItem); override;
    procedure Assign(Source: TPersistent); override;
    procedure DrawArrow(ACanvas: TdxPSReportRenderCustomCanvas;
      const ABounds: TRect);
    procedure DrawContent(ACanvas: TdxPSReportRenderCustomCanvas;
      AStage: TdxPSRenderStages); override;
    class function SchedulerCellClass
  ...
  protected
    ...
    procedure CreateDataItems; override;
    procedure DoInitializeFromViewInfo(AEventViewInfo
      : TcxSchedulerEventCellViewInfo); override;
  ...
  protected
    ...
    procedure ConvertSchedulerCellToPSCells
      (AItem: TcxSchedulerCustomViewInfoItem;
      AReportItemClass: TcxSchedulerReportCustomCellClass); virtual;
    function CreateEventCell(AEventViewInfo: TcxSchedulerEventCellViewInfo)
      : TcxSchedulerReportEventCell; virtual;
    procedure DoInitialize(var ASelectedDays: TcxSchedulerDateList;
      var AEvents: TcxSchedulerCachedEventList); override;
    // layout settings
    function GetCompressWeekends: Boolean; override;
    function GetDontPrintWeekEnds: Boolean; override;
    function GetEventCellClass(AEventViewInfo: TcxSchedulerEventCellViewInfo)
      : TcxSchedulerReportEventCellClass; virtual;
  ...
  TcxSchedulerReportCommonCellsProducerClass = class of
    TcxSchedulerReportCommonCellsProducer;

  { TcxSchedulerReportWeeksCellsProducer }

  TcxSchedulerReportWeeksCellsProducer = class
    (TcxSchedulerReportCommonCellsProducer)
  ...
  TcxSchedulerReportDailyCellsProducer = class
    (TcxSchedulerReportCommonCellsProducer)
  private
  ...
  protected
    ...
    function CreateTimeRulerSite
      : TcxSchedulerReportDailyTimeRulerCellsSite; virtual;
    procedure ConvertSchedulerCellToPSCells
      (AItem: TcxSchedulerCustomViewInfoItem;
  ...
  TcxSchedulerReportYearlyCellsProducer = class
    (TcxSchedulerReportCommonCellsProducer, IcxSchedulerYearViewAdapter)
  private
  ...
  public
    function AddPageInfo(ARow, AColumn: Integer;
    ...
    function GetStylesAdapter: IcxSchedulerStylesAdapter; override;
  public
    constructor CreateEx(AStyle
      : TcxSchedulerReportLinkTimeLinePrintStyle); virtual;
    destructor Destroy; override;
  ...
  TcxSchedulerReportTimeLineCellsProducer = class
    (TcxSchedulerReportCommonCellsProducer, IcxSchedulerTimeGridViewAdapter)
  private
    function GetPageIndex: Integer;
  ...
  protected
    function CreateEventCell(AEventViewInfo: TcxSchedulerEventCellViewInfo)
      : TcxSchedulerReportEventCell; override;
    function GetActualStart: TDateTime; override;
    function GetActualFinish: TDateTime; override;
...
uses
  ShlObj, Math, DateUtils, Types, ActiveX, CommCtrl, cxFormats, dxPSUtl,
  dxPSRes, dxPSPopupMan, dxPSImgs,
...
procedure ConvertRect(var R: TRect; APixelsNumerator, APixelsDenominator
  : Integer);
begin
  with R do
  begin
...
function cxCompareEventsOrder(AEvent1,
  AEvent2: TcxSchedulerControlEvent): Integer;
var
...
begin
  ...
  if AEvent1.Start < AEvent2.Start then
    Result := -1
  else if AEvent1.Start > AEvent2.Start then
    Result := 1
  else if AEvent1.Finish > AEvent2.Finish then
    Result := -1
  else if AEvent1.Finish < AEvent2.Finish then
    Result := 1
  else
...
function StartOfTheWeekEx(const AValue: TDateTime; AStartOfWeek: TDay)
  : TDateTime;
const
...
procedure SplitToRects(const ASource: TRect;
  AShowCalendar, AIsRightArea: Boolean; out R1, R2: TRect);
begin
  R1 := ASource;
  R2 := ASource;
...
begin
  ...
  begin
    ...
    begin
      SchedulerHeader := CreateStyle(dxPSCore.dxDefaultContentColor,
        dxPSCore.dxPSDefaultFontColor);
      Content := CreateStyle(dxPSCore.dxDefaultContentColor,
        dxPSCore.dxPSDefaultFontColor);
      DateNavigatorContent := CreateStyle(dxPSCore.dxDefaultContentColor,
        dxPSCore.dxPSDefaultFontColor);
      DateNavigatorHeader := CreateStyle(dxPSCore.dxDefaultContentColor,
        dxPSCore.dxPSDefaultFontColor);
      DayHeader := CreateStyle(dxPSCore.dxDefaultFixedColor,
        dxPSCore.dxPSDefaultFontColor);
      Event := CreateStyle(dxPSCore.dxDefaultContentColor,
        dxPSCore.dxPSDefaultFontColor);
      ResourceHeader := CreateStyle(dxPSCore.dxDefaultFixedColor,
        dxPSCore.dxPSDefaultFontColor);
      NotesAreaBlank := CreateStyle(dxPSCore.dxDefaultContentColor,
        dxPSCore.dxPSDefaultFontColor);
      NotesAreaLined := CreateStyle(dxPSCore.dxDefaultContentColor,
        dxPSCore.dxPSDefaultFontColor);
      TaskPad := CreateStyle(dxPSCore.dxDefaultContentColor,
        dxPSCore.dxPSDefaultFontColor);
      TimeRuler := CreateStyle(dxPSCore.dxDefaultFixedColor,
        dxPSCore.dxPSDefaultFontColor);
    end;
  end;
...
begin
  ...
  if (ReportLink = nil) or (ReportLink.ReportCells <> nil) and
    (ReportLink.ReportCells.Count > 0) then
  begin
...
function TcxSchedulerReportLinkRenderInfo.IsDrawReportFootnotesOnPage
  (APageIndex: Integer): Boolean;
begin
...
begin
  ...
  begin
    ...
    begin
      FSupportImages := ComparePSVersions(AStorageInfo.PrintingSystemVersion,
        SupportImagesVersion) >= 0;
      AStorageInfo.Free;
    end;
...
begin
  case AItem.GetCustomDrawID of
    cdidSchedulerContent:
      DoCustomDrawContentCell(ACanvas,
        TcxSchedulerReportContentCell(AItem), ADone);
    cdidSchedulerSchedulerHeader:
      DoCustomDrawSchedulerHeaderCell(ACanvas,
        TcxSchedulerReportSchedulerHeaderDataCell(AItem), ADone);
    cdidSchedulerDateNavigatorHeader:
      DoCustomDrawDateNavigatorHeaderCell(ACanvas,
        TcxSchedulerReportDateNavigatorHeader(AItem), ADone);
    cdidSchedulerDateNavigatorDay:
      DoCustomDrawDateNavigatorDayCell(ACanvas,
        TcxSchedulerReportDateNavigatorDay(AItem), ADone);
    cdidSchedulerDateNavigatorDayCaption:
      DoCustomDrawDateNavigatorDayCaptionCell(ACanvas,
        TcxSchedulerReportDateNavigatorDayCaption(AItem), ADone);
    cdidSchedulerDateNavigatorWeekNumber:
      DoCustomDrawDateNavigatorWeekNumberCell(ACanvas,
        TcxSchedulerReportDateNavigatorWeekNumber(AItem), ADone);
    cdidSchedulerTimeRuler:
      DoCustomDrawTimeRulerCell(ACanvas,
        TcxSchedulerReportDailyTimeRulerCell(AItem), ADone);
    cdidSchedulerEventCaption .. cdidSchedulerEventTimeLine:
      DoCustomDrawEventPartCell(ACanvas, AItem, ADone);
    cdidSchedulerNotesArea:
      DoCustomDrawNotesCell(ACanvas,
        TcxSchedulerReportNotesDataCell(AItem), ADone);
    cdidSchedulerTaskPad:
      DoCustomDrawTaskPadCell(ACanvas,
        TcxSchedulerReportNotesDataCell(AItem), ADone);
    cdidSchedulerHeader:
      DoCustomDrawHeaderCell(ACanvas,
        TcxSchedulerReportHeaderItemCell(AItem), ADone);
  end;
end;
...
procedure TcxSchedulerReportLink.DoCustomDrawSchedulerHeaderCell
  (ACanvas: TCanvas; AItem: TcxSchedulerReportSchedulerHeaderDataCell;
  var ADone: Boolean);
begin
...
procedure TcxSchedulerReportLink.DoCustomDrawTimeRulerCell(ACanvas: TCanvas;
  AItem: TcxSchedulerReportDailyTimeRulerCell; var ADone: Boolean);
begin
  if Assigned(FOnCustomDrawTimeRulerCell) then
    FOnCustomDrawTimeRulerCell(Self, ACanvas, AItem, ADone);
end;

procedure TcxSchedulerReportLink.DoCustomDrawContentCell(ACanvas: TCanvas;
  AItem: TcxSchedulerReportContentCell; var ADone: Boolean);
begin
  if Assigned(FOnCustomDrawContentCell) then
    FOnCustomDrawContentCell(Self, ACanvas, AItem, ADone);
end;

procedure TcxSchedulerReportLink.DoCustomDrawHeaderCell(ACanvas: TCanvas;
  AItem: TcxSchedulerReportHeaderItemCell; var ADone: Boolean);
begin
  if Assigned(FOnCustomDrawHeaderCell) then
    FOnCustomDrawHeaderCell(Self, ACanvas, AItem, ADone);
end;

procedure TcxSchedulerReportLink.DoCustomDrawEventPartCell(ACanvas: TCanvas;
...
begin
  if Assigned(FOnCustomDrawEventPartCell) then
    FOnCustomDrawEventPartCell(Self, ACanvas, AItem,
      TcxSchedulerReportEventPartType(AItem.GetCustomDrawID -
      cdidSchedulerEventCaption), ADone);
end;
...
procedure TcxSchedulerReportLink.DoCustomDrawTaskPadCell(ACanvas: TCanvas;
  AItem: TcxSchedulerReportNotesDataCell; var ADone: Boolean);
begin
...
function TcxSchedulerReportLink.GetRebuildOnPageParamsChange
...
function TcxSchedulerReportLink.GetOptionsFormattingClass
  : TdxCustomReportLinkOptionsFormattingClass;
begin
  Result := TcxSchedulerReportLinkOptionsFormatting;
end;

function TcxSchedulerReportLink.CreatePrintRange
  : TcxSchedulerReportLinkPrintRange;
begin
  Result := TcxSchedulerReportLinkPrintRange.Create(Self);
end;

function TcxSchedulerReportLink.CreatePrintStyles
  : TcxSchedulerReportLinkPrintStyles;
begin
...
begin
  Result := Assigned(Scheduler) and Assigned(Scheduler.Storage) and
    Assigned(Scheduler.Storage.Resources.Images);
end;
...
function TcxSchedulerReportLink.GetStyleSheetClass
  : TdxCustomReportLinkStyleSheetClass;
begin
  Result := TcxSchedulerReportLinkStyleSheet;
end;

function TcxSchedulerReportLink.GetStyleSheetPrototype
...
begin
  if Assigned(FOnActivePrintStyleChanged) then
    FOnActivePrintStyleChanged(Self);
end;
...
procedure TcxSchedulerReportLink.RegisterLookAndFeelItem
...
procedure TcxSchedulerReportLink.DoInitializeEventCell
...
procedure TcxSchedulerReportLink.AssignTaskPadData
  (ATaskPad: TcxSchedulerReportTaskPadCell);
...
procedure TcxSchedulerReportLink.InitializeTaskPadCell
  (ATaskPad: TcxSchedulerReportTaskPadCell);
begin
...
procedure TcxSchedulerReportLink.SetCellViewParams(ACell: TdxReportVisualItem;
...
begin
  ...
  try
    ...
    if OptionsFormatting.SuppressContentColoration and
      (ACell.BorderColor <> clDefault) then
...
function TcxSchedulerReportLink.AddPageSite(const ABounds: TRect)
  : TcxSchedulerReportPageSite;
begin
...
function TcxSchedulerReportLink.GetDesignWindow
...
function TcxSchedulerReportLink.GetLookAndFeelItem(Index: Integer)
  : TdxReportVisualItem;
begin
...
function TcxSchedulerReportLink.GetOptionsFormatting
  : TcxSchedulerReportLinkOptionsFormatting;
begin
...
function TcxSchedulerReportLink.GetPrintStyles
  : TcxSchedulerReportLinkPrintStyles;
begin
  Result := FPrintStyles;
end;
...
procedure TcxSchedulerReportLink.SetOptionsFormatting
  (Value: TcxSchedulerReportLinkOptionsFormatting);
begin
  inherited OptionsFormatting := Value;
end;

procedure TcxSchedulerReportLink.SetPrintRange
  (Value: TcxSchedulerReportLinkPrintRange);
begin
  PrintRange.Assign(Value);
end;

procedure TcxSchedulerReportLink.SetPrintStyles
  (Value: TcxSchedulerReportLinkPrintStyles);
begin
...
function TcxSchedulerReportLinkPrintRange.GetDateTimeIF(const AValue,
...
function TcxSchedulerReportLinkPrintRange.GetActiveStyle
  : TcxCustomSchedulerReportLinkPrintStyle;
begin
...
begin
  ...
  if ActiveStyle <> nil then
    Result := dxTimeOf(GetDateTimeIF(ActiveStyle.CheckPrintRangeTime(FTimePrint
      [AIndex], AIndex), DefaultTime))
  else
...
procedure TcxSchedulerReportLinkPrintRange.SetPrintDate(AIndex: Integer;
  const Value: TDate);
begin
...
procedure TcxSchedulerReportLinkPrintRange.SetPrintTime(AIndex: Integer;
  const Value: TTime);
begin
...
function TcxSchedulerReportLinkPrintRange.IsDateStored(AIndex: Integer)
  : Boolean;
begin
  Result := FDatePrint[AIndex] <> NullDate;
end;

function TcxSchedulerReportLinkPrintRange.IsTimeStored(AIndex: Integer)
  : Boolean;
begin
...
function TcxSchedulerReportLinkOptionsFormatting.GetReportLink
  : TcxSchedulerReportLink;
begin
  Result := inherited ReportLink as TcxSchedulerReportLink;
end;

procedure TcxSchedulerReportLinkOptionsFormatting.SetSuppressContentColoration
  (Value: Boolean);
begin
...
function TcxCustomSchedulerReportLinkOptions.GetReportLink
  : TcxSchedulerReportLink;
begin
  Result := inherited ReportLink as TcxSchedulerReportLink;
end;
...
function TcxSchedulerReportLinkStyles.GetContentParams(const ADateTime
  : TDateTime; AResource: TcxSchedulerStorageResourceItem): TcxViewParams;
begin
...
function TcxSchedulerReportLinkStyles.GetContentParams(const ADateTime
  : TDateTime; ALightColor: Boolean; AResource: TcxSchedulerStorageResourceItem)
  : TcxViewParams;
begin
  if UseSchedulerStyles then
...
function TcxSchedulerReportLinkStyles.GetDateNavigatorContentParams
  : TcxViewParams;
begin
  if UseSchedulerStyles then
  begin
    Result := TcxSchedulerDateNavigator(ExtStyles.Scheduler.DateNavigator)
      .Styles.GetContentParams
  end
  else
    GetViewParams(vspsSchedulerDateNavigatorContent, nil, nil, Result);
end;

function TcxSchedulerReportLinkStyles.GetDateNavigatorHeaderParams
  : TcxViewParams;
begin
  if UseSchedulerStyles then
  begin
    Result := TcxSchedulerDateNavigator(ExtStyles.Scheduler.DateNavigator)
      .Styles.GetHeaderParams
  end
  else
    GetViewParams(vspsSchedulerDateNavigatorHeader, nil, nil, Result);
end;

function TcxSchedulerReportLinkStyles.GetDayHeaderParams(const ADateTime
  : TDateTime): TcxViewParams;
begin
  if UseSchedulerStyles then
...
function TcxSchedulerReportLinkStyles.GetEventParams(AEvent: TcxSchedulerEvent)
  : TcxViewParams;
begin
  if UseSchedulerStyles then
...
const
  FixedParts = [vspsSchedulerDayHeader, vspsSchedulerResourceHeader,
    vspsSchedulerTimeRuler];
begin
  inherited;
  if ReportLink <> nil then
    with AParams do
...
class function TcxSchedulerReportLinkStyles.GetStyleCaption
...
function TcxSchedulerReportLinkStyles.GetStyleIndexByCaption
...
function TcxSchedulerReportLinkStyleSheet.GetStylesValue
  : TcxSchedulerReportLinkStyles;
begin
...
procedure TcxSchedulerReportLinkStyleSheet.SetStylesValue
  (Value: TcxSchedulerReportLinkStyles);
begin
  SetStyles(Value);
end;
...
function TcxSchedulerReportLinkPrintStyles.GetStyleByClass
  (AClass: TcxCustomSchedulerReportLinkPrintStyleClass)
  : TcxCustomSchedulerReportLinkPrintStyle;
var
  I: Integer;
begin
...
function TcxSchedulerReportLinkPrintStyles.GetCorrespondingStyle
  : TcxCustomSchedulerReportLinkPrintStyle;
begin
  Result := nil;
  if Scheduler = nil then
...
function TcxSchedulerReportLinkPrintStyles.GetStyleByName(const Name: string)
  : TcxCustomSchedulerReportLinkPrintStyle;
var
  I: Integer;
begin
  ...
  begin
    Result := Items[I];
    if CompareText(Result.Caption, Name) = 0 then
      Exit;
  end;
  Result := nil;
end;
...
begin
  ...
  begin
    Result := Items[I];
    if Result.IsCompatibleWith(View) then
      Exit;
  end;
  Result := nil;
end;

function TcxSchedulerReportLinkPrintStyles.IndexOf
  (AItem: TcxCustomSchedulerReportLinkPrintStyle): Integer;
begin
...
function TcxSchedulerReportLinkPrintStyles.CreateStyle
  (AStyleClass: TcxCustomSchedulerReportLinkPrintStyleClass)
  : TcxCustomSchedulerReportLinkPrintStyle;
begin
...
procedure TcxSchedulerReportLinkPrintStyles.StyleChanged
...
function TcxSchedulerReportLinkPrintStyles.GetItem(Index: Integer)
  : TcxCustomSchedulerReportLinkPrintStyle;
begin
  Result := TcxCustomSchedulerReportLinkPrintStyle(FItems[Index]);
end;

function TcxSchedulerReportLinkPrintStyles.GetStyleAgenda
  : TcxSchedulerReportLinkAgendaPrintStyle;
begin
  GetStyleByClassEx(TcxSchedulerReportLinkAgendaPrintStyle, Result);
end;

function TcxSchedulerReportLinkPrintStyles.GetStyleDaily
  : TcxSchedulerReportLinkDailyPrintStyle;
begin
  GetStyleByClassEx(TcxSchedulerReportLinkDailyPrintStyle, Result);
end;

function TcxSchedulerReportLinkPrintStyles.GetStyleDetails
  : TcxSchedulerReportLinkDetailsPrintStyle;
begin
  GetStyleByClassEx(TcxSchedulerReportLinkDetailsPrintStyle, Result);
end;

function TcxSchedulerReportLinkPrintStyles.GetStyleMemo
  : TcxSchedulerReportLinkMemoPrintStyle;
begin
  GetStyleByClassEx(TcxSchedulerReportLinkMemoPrintStyle, Result);
end;

function TcxSchedulerReportLinkPrintStyles.GetStyleMonthly
  : TcxSchedulerReportLinkMonthlyPrintStyle;
begin
  GetStyleByClassEx(TcxSchedulerReportLinkMonthlyPrintStyle, Result);
end;

function TcxSchedulerReportLinkPrintStyles.GetStyleTimeLine
  : TcxSchedulerReportLinkTimeLinePrintStyle;
begin
  GetStyleByClassEx(TcxSchedulerReportLinkTimeLinePrintStyle, Result);
end;

function TcxSchedulerReportLinkPrintStyles.GetStyleTrifold
  : TcxSchedulerReportLinkTrifoldPrintStyle;
begin
  GetStyleByClassEx(TcxSchedulerReportLinkTrifoldPrintStyle, Result);
end;

function TcxSchedulerReportLinkPrintStyles.GetStyleWeekly
  : TcxSchedulerReportLinkWeeklyPrintStyle;
begin
  GetStyleByClassEx(TcxSchedulerReportLinkWeeklyPrintStyle, Result);
end;

function TcxSchedulerReportLinkPrintStyles.GetStyleYearly
  : TcxSchedulerReportLinkYearlyPrintStyle;
begin
...
procedure TcxSchedulerReportDetailsAgendaEventCell.CalculateLayout(AWidth,
  ATimeWidth: Integer);
var
  AIndent, ALeft, ARight, ATop, ACellsCount, ASmallWidth: Integer;
...
begin
  ...
  try
    ...
    begin
      FMessageCell.BoundsRect := cxRect(FCaptionCell.Left, ATop,
        FCaptionCell.Right, ATop);
...
begin
  ...
  if Scheduler.ViewAgenda.ShowLocations then
    FLocationCell := CreateStringCell(GetLocationCellText, False,
      cdidSchedulerEventLocation);
end;

procedure TcxSchedulerReportDetailsAgendaEventCell.CreateMessageCell
...
begin
  ...
  if Scheduler.ViewAgenda.ShowResources then
    FResourceCell := CreateStringCell(GetResourceCellText, False,
      cdidSchedulerEventResource)
end;
...
begin
  Result := TcxSchedulerAgendaViewAccess(Scheduler.ViewAgenda)
    .ViewInfo.GetResourceText(Event.ResourceID);
end;
...
function TcxSchedulerReportLinkAgendaPrintStyle.
  GetSchedulerReportDetailsEventCellClass
  : TcxSchedulerReportDetailsEventCellClass;
begin
  Result := TcxSchedulerReportDetailsAgendaEventCell;
end;

function TcxSchedulerReportLinkAgendaPrintStyle.IsCompatibleWith
...
begin
  ...
  if (VisualStyles.Event <> nil) and
    (cxStyles.svFont in VisualStyles.Event.AssignedValues) then
...
constructor TcxCustomSchedulerReportLinkPrintStyle.Create
...
function TcxCustomSchedulerReportLinkPrintStyle.IsCompatibleWith
  (AView: TcxSchedulerCustomView): Boolean;
begin
  Result := False;
end;
...
// IdxReportLinkController
function TcxCustomSchedulerReportLinkPrintStyle.GetControlSiteBounds
  (AControl: TControl): TRect;
begin
  Result := cxNullRect;
end;
  ...
  try
    ...
    begin
      ...
      begin
        ...
        Events.DaylightSaving :=
          Scheduler.OptionsView.CurrentTimeZoneDaylightSaving;
      end;
      Events.UseTimeRange := (Scheduler = nil) or
        not Scheduler.ViewGantt.Active;
...
begin
  ...
  begin
    ...
    if ReportLink.AbortBuilding or ReportLink.LinkInPreviewMode then
      Break;
  end;
end;
...
function TcxCustomSchedulerReportLinkPrintStyle.QueryInterface(const IID: TGUID;
  out Obj): HResult;
begin
...
function TcxCustomSchedulerReportLinkPrintStyle.
  IdxPSCellParams_GetAutoHeight: Boolean;
begin
  Result := False;
end;

function TcxCustomSchedulerReportLinkPrintStyle.IdxPSCellParams_GetCanvas
...
function TcxCustomSchedulerReportLinkPrintStyle.GetCorrespondedView
...
function TcxCustomSchedulerReportLinkPrintStyle.GetSchedulerHeaderParams
...
procedure TcxCustomSchedulerReportLinkPrintStyle.DrawDesignWindowPreview
  (ACanvas: TCanvas; const ABounds: TRect; AScaleFactor: TdxScaleFactor = nil);
begin
  cxPaintCanvas.BeginPaint(ACanvas);
  try
    cxDrawImage(cxPaintCanvas, cxRectCenter(ABounds, StylePreviewImages.Width,
      StylePreviewImages.Height), nil, StylePreviewImages, PreviewGlyphIndex,
      True, nil, AScaleFactor);
  finally
...
function TcxCustomSchedulerReportLinkPrintStyle.
  SupportMessageEditProperties: Boolean;
begin
...
function TcxCustomSchedulerReportLinkPrintStyle.CreateDateNavigatorCell
  (ASite: TdxReportCell; AYear, AMonth: Word)
  : TcxSchedulerReportDateNavigatorCell;
begin
  with Scheduler.DateNavigator do
  begin
    Result := TcxSchedulerReportDateNavigatorCell.CreateEx(ASite,
      ActualFirstWeekOfYear, AYear, AMonth, ShowDatesContainingEventsInBold,
      ShowWeekNumbers);
...
function TcxCustomSchedulerReportLinkPrintStyle.InitReportCell
  ...
  begin
    ...
    ReportLink.SetCellViewParams(TcxSchedulerReportNotesAreaCell(ACell)
      .DataCell, AViewParams);
  end;
...
procedure TcxCustomSchedulerReportLinkPrintStyle.CreateAdditionalControls
  (ASite: TdxReportCell; AHasCalendar, AHasTaskPad, AHasNotes, AHasNotesLined,
  ARightSide: Boolean; var ABounds: TRect);
var
  R: array [0 .. 2] of TRect;
  C: Integer;

  function GetAreaBounds(AllowShow: Boolean; var ABounds: TRect;
...
begin
  ...
  begin
    ...
    begin
      ...
      CreateHeaderDateNavigator(TcxSchedulerReportSchedulerHeaderCell(AHeader),
        APageIndex, R);
    end;
...
function TcxCustomSchedulerReportLinkPrintStyle.
  CanSplitSchedulingOnTwoPages: Boolean;
begin
...
begin
  Result := 0;
  AMin := Round((ASiteBounds.Bottom - ASiteBounds.Top) *
    SchedulerHeaderMinHeight);
  AMax := Round((ASiteBounds.Bottom - ASiteBounds.Top) *
    SchedulerHeaderMaxHeight);
...
function TcxCustomSchedulerReportLinkPrintStyle.GetPageIndex(APeriodIndex,
...
var
  ...
  ADayCount: Integer;
begin
  ADayCount := APageIndex * GetDaysPerPeriod div ((Byte(Layout) + 1) *
...
procedure TcxCustomSchedulerReportLinkPrintStyle.FillDatesForPage
  (ADateList: TcxSchedulerDateList; APageIndex, APeriodIndex,
  ASubIndex: Integer);
begin
end;
...
function TcxCustomSchedulerReportLinkPrintStyle.GetPageSite(AIndex: Integer)
  : TcxSchedulerReportPageSite;
begin
  if ReportLink <> nil then
...
function TcxCustomSchedulerReportLinkPrintStyle.GetPrintRange
  : TcxSchedulerReportLinkPrintRange;
begin
  if ReportLink <> nil then
...
function TcxCustomSchedulerReportLinkPrintStyle.GetReportLink
  : TcxSchedulerReportLink;
begin
  if Styles <> nil then
...
function TcxCustomSchedulerReportLinkPrintStyle.GetStorage
...
function TcxCustomSchedulerReportLinkPrintStyle.GetVisualStyles
  : TcxSchedulerReportLinkStyles;
begin
  if ReportLink <> nil then
...
function TcxCustomSchedulerReportLinkPrintStyle.
  IsShowNotesAreaBlankStored: Boolean;
begin
...
procedure TcxCustomSchedulerReportLinkPrintStyle.SetCaption
  (const Value: string);
begin
...
procedure TcxCustomSchedulerReportLinkPrintStyle.SetShowEventImages
  (Value: Boolean);
begin
...
procedure TcxCustomSchedulerReportLinkPrintStyle.SetShowResourceImages
  (Value: Boolean);
begin
...
function TcxSchedulerReportLinkDailyPrintStyle.
  CanSplitSchedulingOnTwoPages: Boolean;
begin
  Result := False;
end;
...
begin
  if Layout = pslOnePage then
    CreateAdditionalControls(ASite, True, ShowTaskPad, ShowNotesAreaBlank,
...
procedure TcxSchedulerReportLinkDailyPrintStyle.CreateControlsOnSecondPage
  (APageIndex: Integer; ASite, AHeader: TdxReportCell; ABounds: TRect);
begin
  CreateAdditionalControls(ASite, False, ShowTaskPad, ShowNotesAreaBlank,
    ShowNotesAreaLined, True, ABounds);
end;
...
function TcxSchedulerReportLinkDailyPrintStyle.GetCorrespondedView
  : TcxSchedulerCustomResourceView;
begin
  if Scheduler <> nil then
...
function TcxSchedulerReportLinkCustomDetailsPrintStyle.GetNextPage
  (APrevPage: TcxSchedulerReportPageSite; out ABounds: TRect)
  : TcxSchedulerReportPageSite;
begin
  CellsOnPage := 0;
...
function TcxSchedulerReportLinkCustomDetailsPrintStyle.MeasureTimeWidth
  : Integer;
var
  AFont: TFont;
begin
...
begin
  ...
  begin
    PaginationMode := TcxSchedulerReportLinkDetailsPrintStyle(Source)
      .PaginationMode;
    UsePagination := TcxSchedulerReportLinkDetailsPrintStyle(Source)
      .UsePagination;
  end;
  inherited Assign(Source);
end;
...
function TcxSchedulerReportLinkDetailsPrintStyle.AddDayHeader(ADate: TDateTime;
  AContinue: Boolean; var ABounds: TRect)
  : TcxSchedulerReportSchedulerHeaderCell;
var
  R: TRect;
begin
  ...
  try
    ...
    begin
      ...
      begin
        ...
        if (CellsOnPage > 0) and
          (MeasureCellBounds.Bottom > CurrentPageBounds.Bottom) then
          PrepareNextPage;
        HeaderNeeded;
        SetCellPlace;
        Inc(EventIndex);
...
begin
  ...
  try
    Result := ReportLink.Renderer.CalcTextHeight(ARenderCanvas,
      dxMeasurePattern, False, GetSchedulerHeaderParams.NativeParams.Font) * 2;
  finally
    ARenderCanvas.Free;
  end
end;

function TcxSchedulerReportLinkDetailsPrintStyle.GetDayHeaderText
  (AContinue: Boolean): string;
begin
...
function TcxSchedulerReportLinkDetailsPrintStyle.GetSchedulerHeaderParams
  : TdxReportItemViewParams;
begin
  FillChar(Result, SizeOf(Result), 0);
...
function TcxSchedulerReportLinkDetailsPrintStyle.
  GetSchedulerReportDetailsEventCellClass
  : TcxSchedulerReportDetailsEventCellClass;
begin
...
begin
  if NeedAddDayHeader then
    PreviousHeader := AddDayHeader(CurrentDate, EventIndex > 0,
      CurrentPageBounds);
end;

function TcxSchedulerReportLinkDetailsPrintStyle.NeedAddDayHeader: Boolean;
begin
  Result := (CellsOnPage = 0) or (PreviousHeader = nil) or
    (PreviousHeader.Date <> CurrentDate);
end;
...
begin
  ...
  begin
    ...
    if (CellsOnPage > 0) and
      (StartEachItemOnNewPage or (GetCellBounds.Bottom > APageBounds.Bottom))
    then
      CurrentPage := GetNextPage(CurrentPage, APageBounds);
...
begin
  ...
  begin
    ...
    begin
      AllowPrint := Scheduler.SelectedEvents[I]
        .Source = TcxSchedulerControlEvent(AEvent).Source;
      if AllowPrint then
        Break;
    end;
  end;
...
begin
  if Source is TcxSchedulerReportLinkMonthlyPrintStyle then
    PrintExactlyOneMonthPerPage := TcxSchedulerReportLinkMonthlyPrintStyle
      (Source).PrintExactlyOneMonthPerPage;
  inherited Assign(Source);
end;
...
function TcxSchedulerReportLinkMonthlyPrintStyle.GetCorrespondedView
  : TcxSchedulerCustomResourceView;
begin
  if Scheduler <> nil then
...
begin
  CreateAdditionalControls(ASite, True, ShowTaskPad and
    IsFirstColumn(APageIndex), ShowNotesAreaBlank and IsFirstColumn(APageIndex),
    ShowNotesAreaLined and IsFirstColumn(APageIndex), False, ABounds);
  InitReportCell(CreateSchedulingAreaCell(ASite), ABounds);
end;

function TcxSchedulerReportLinkTimeLinePrintStyle.GetCorrespondedView
  : TcxSchedulerCustomResourceView;
begin
  if Scheduler <> nil then
  begin
...
function TcxSchedulerReportLinkTimeLinePrintStyle.IsFirstColumn
  (APageIndex: Integer): Boolean;
begin
...
function TcxSchedulerReportLinkTimeLinePrintStyle.GetPageWidth
...
begin
  ...
  if ShowTaskPad or ShowNotesAreaBlank or ShowNotesAreaLined then
    Result := AdditionalWidth(Rect(0, 0, ReportLink.PageWidth, 0)) +
      InterAreaSpace;
end;
...
function TcxSchedulerReportLinkTimeLinePrintStyle.GetTimeGridView
...
procedure TcxSchedulerReportLinkTimeLinePrintStyle.SetShowLinks
  (AValue: Boolean);
begin
...
procedure TcxSchedulerReportLinkTimeLinePrintStyle.SetWorkTimeOnly
  (AValue: Boolean);
begin
...
begin
  ...
  case FCurrentSection of
    ...
    smWeeklyCalendar:
      begin
        if HasDailySection then
          ADate := StartOfTheWeekEx(APageIndex + PrintRange.PrintFrom,
            PrintRange.StartOfWeek)
        else
    ...
    smMonthlyCalendar:
      begin
        ADate := StartOfTheMonth(PrintRange.PrintFrom + APageIndex *
          FPageRange);
...
function TcxSchedulerReportLinkTrifoldPrintStyle.GetCorrespondedView
  : TcxSchedulerCustomResourceView;
begin
  case FCurrentSection of
    smDailyCalendar:
...
function TcxSchedulerReportLinkTrifoldPrintStyle.GetSection(Index: Integer)
  : TcxSchedulerReportLinkTrifoldPrintStyleSectionMode;
begin
...
procedure TcxSchedulerReportLinkTrifoldPrintStyle.SetSection(Index: Integer;
  AValue: TcxSchedulerReportLinkTrifoldPrintStyleSectionMode);
begin
...
const
  Sections: array [0 .. 2]
    of TcxSchedulerReportLinkTrifoldPrintStyleSectionMode = (smDailyCalendar,
    smTaskPad, smWeeklyCalendar);
begin
...
function TcxSchedulerReportLinkWeeklyPrintStyle.CreateSchedulingCellsProducer
  ...
  : TcxSchedulerReportCommonCellsProducer;
const
  CellsProducers: array [Boolean]
    of TcxSchedulerReportCommonCellsProducerClass =
    (TcxSchedulerReportDailyCellsProducer,
    TcxSchedulerReportWeeksCellsProducer);
begin
...
function TcxSchedulerReportLinkWeeklyPrintStyle.GetCorrespondedView
  : TcxSchedulerCustomResourceView;
begin
  if Scheduler <> nil then
  begin
...
begin
  Result := StartOfTheWeekEx(PrintRange.PrintFrom +
    (APageIndex div GetResourcePageCount div (Byte(Layout) + 1)) * 7,
    PrintRange.StartOfWeek);
end;
...
procedure TcxSchedulerReportLinkWeeklyPrintStyle.FillDatesForPage
  ...
  ASubIndex: Integer);
const
  DayCount: array [TcxSchedulerReportLinkPeriodicPrintStyleLayout, Boolean]
    of Integer = ((7, 7), (3, 4));
var
  I: Integer;
...
function TcxSchedulerReportLinkWeeklyPrintStyle.GetDaysLayout
  : TcxSchedulerWeekViewDaysLayout;
begin
...
procedure TcxSchedulerReportLinkYearlyPrintStyle.CreateControlsOnFirstPage
  (APageIndex: Integer; ASite, AHeader: TdxReportCell; ABounds: TRect);
begin
...
procedure TcxSchedulerReportLinkYearlyPrintStyle.CreateControlsOnSecondPage
  (APageIndex: Integer; ASite, AHeader: TdxReportCell; ABounds: TRect);
var
  HasTaskPad: Boolean;
begin
...
function TcxSchedulerReportLinkYearlyPrintStyle.GetCorrespondedView
  : TcxSchedulerCustomResourceView;
begin
  if Scheduler <> nil then
...
function TcxSchedulerReportLinkYearlyPrintStyle.GetHasPageHeader
  (APageIndex: Integer): Boolean;
const
  Indexes: array [TcxSchedulerReportLinkPeriodicPrintStyleLayout]
    of Integer = (0, 1);
begin
...
begin
  ...
  if (ReportLink.PrintStyles.ActiveStyle = nil) or not FActiveStyleAssigned then
    with ReportLink.PrintStyles do
      SetActiveStyleEx(GetCorrespondingStyle);
...
begin
  ...
  sePrintStyleDailyResourceCountPerPage.Properties.MaxValue :=
    ADailyStyle.ResourceCount;
  sePrintStyleDailyResourceCountPerPage.Value :=
    ADailyStyle.ResourceCountPerPage;
...
begin
  ...
  cbxPrintStyleDetailsPagination.ItemIndex :=
    Integer(ADetailsStyle.PaginationMode);
end;
...
begin
  ...
  chbxPrintStyleMemoStartEachItemOnNewPage.Checked :=
    AMemoStyle.StartEachItemOnNewPage;
  chbxPrintStyleMemoPrintOnlySelectedEvents.Checked :=
    AMemoStyle.SelectedEventsOnly;
end;
...
begin
  ...
  sePrintStyleTimeLineResourceCountPerPage.Properties.MaxValue :=
    ATimeLineStyle.ResourceCount;
  sePrintStyleTimeLineResourceCountPerPage.Value :=
    ATimeLineStyle.ResourceCountPerPage;

  chbxPrintStyleTimeLineTaskPad.Checked := ATimeLineStyle.ShowTaskPad;
  chbxPrintStyleTimeLineNotesAreaBlank.Checked :=
    ATimeLineStyle.ShowNotesAreaBlank;
  chbxPrintStyleTimeLineNotesAreaLined.Checked :=
    ATimeLineStyle.ShowNotesAreaLined;
  ...
  chbxPrintStyleTimeLinePrimaryPageScalesOnly.Checked :=
    ATimeLineStyle.PrimaryPageScalesOnly;
  chbxPrintStyleTimeLinePrimaryPageHeadersOnly.Checked :=
    ATimeLineStyle.PrimaryPageHeadersOnly;
  chbxPrintStyleTimeLineDontPrintWeekends.Checked :=
    ATimeLineStyle.DontPrintWeekends;
...
begin
  ...
  sePrintStyleMonthlyResourceCountPerPage.Properties.MaxValue :=
    AMonthlyStyle.ResourceCount;
  sePrintStyleMonthlyResourceCountPerPage.Value :=
    AMonthlyStyle.ResourceCountPerPage;
  chbxPrintStyleMonthlyTaskPad.Checked := AMonthlyStyle.ShowTaskPad;
  chbxPrintStyleMonthlyNotesAreaBlank.Checked :=
    AMonthlyStyle.ShowNotesAreaBlank;
  chbxPrintStyleMonthlyNotesAreaLined.Checked :=
    AMonthlyStyle.ShowNotesAreaLined;
  chbxPrintStyleMonthlyDontPrintWeekends.Checked :=
    AMonthlyStyle.DontPrintWeekends;
  chbxPrintStyleMonthlyPrintExactlyOneMonthPerPage.Checked :=
    AMonthlyStyle.PrintExactlyOneMonthPerPage;
...
begin
  ...
  cbxPrintStyleTrifoldSectionMiddle.ItemIndex :=
    Byte(ATrifoldStyle.MiddleSection);
  cbxPrintStyleTrifoldSectionRight.ItemIndex :=
    Byte(ATrifoldStyle.RightSection);
end;
...
begin
  ...
  sePrintStyleWeeklyResourceCountPerPage.Properties.MaxValue :=
    AWeeklyStyle.ResourceCount;
  sePrintStyleWeeklyResourceCountPerPage.Value :=
    AWeeklyStyle.ResourceCountPerPage;
  ...
  chbxPrintStyleWeeklyDontPrintWeekends.Checked :=
    AWeeklyStyle.DontPrintWeekends;
...
const
  MontPerPageIndexes: array [0 .. 11] of Integer = (0, 1, 2, 3, 3, 4, 4, 4,
    4, 4, 4, 5);
var
...
begin
  ...
  cbxPrintStyleYearlyMonthPerPage.ItemIndex := MontPerPageIndexes
    [AYearlyStyle.MonthCountPerPage - 1];
  sePrintStyleYearlyResourceCountPerPage.Properties.MaxValue :=
    AYearlyStyle.ResourceCount;
  sePrintStyleYearlyResourceCountPerPage.Value :=
    AYearlyStyle.ResourceCountPerPage;
  ...
  SetShowImagesCheckBoxes(chbxPrintStyleYearlyShowEventImages, nil,
    AYearlyStyle);
end;
...
begin
  ...
  if not Result then
  begin
    MessageBox(Handle, PChar(cxGetResourceString(@sdxBadDatePrintRange)),
...
function TcxfmSchedulerReportLinkDesignWindow.CheckPrintStyleSettings: Boolean;
  ...
  begin
    MessageBox(Handle, PChar(cxGetResourceString(@sdxBadTimePrintRange)),
      PChar(cxGetResourceString(@sdxReportDesignerCaption)),
      MB_ICONINFORMATION or MB_OK);
  end;
...
begin
  ...
  begin
    Result := dxTimeOf(tePrintStyleDailyPrintFrom.Time) <=
      dxTimeOf(tePrintStyleDailyPrintTo.Time);
    if not Result then
    begin
      ShowWarning;
      pcMain.ItemIndex := tshPrintStyles.Index;
      pcPrintStyleOptions.ItemIndex := tshDaily.Index;
      PostMessage(Handle, DXM_CONTAINERSETFOCUS, 0,
        LPARAM(tePrintStyleDailyPrintTo));
    end;
  end
  else if pcPrintStyleOptions.ItemIndex = tshWeekly.Index then
  begin
    Result := dxTimeOf(tePrintStyleWeeklyPrintFrom.Time) <=
      dxTimeOf(tePrintStyleWeeklyPrintTo.Time);
    if not Result then
    begin
      ShowWarning;
      pcMain.ItemIndex := tshPrintStyles.Index;
      ...
      PostMessage(Handle, DXM_CONTAINERSETFOCUS, 0,
        LPARAM(tePrintStyleWeeklyPrintTo));
    end;
  end
  else
    Result := True;
...
procedure TcxfmSchedulerReportLinkDesignWindow.LoadCaption(AControl: TControl;
  StrPtr: Pointer);
begin
  TControlAccess(AControl).Caption := cxGetResourceString(StrPtr);
end;

procedure TcxfmSchedulerReportLinkDesignWindow.LoadCaption(AItem: TMenuItem;
  StrPtr: Pointer);
begin
...
procedure TcxfmSchedulerReportLinkDesignWindow.LoadCaption
  (AItem: TdxCustomLayoutItem; StrPtr: Pointer);
begin
  AItem.Caption := cxGetResourceString(StrPtr);
end;
...
begin
  ...
  LoadStringsCombo(cbxPrintStyleDailyLayout, [@sdxPrintStyleDailyLayout1PPD,
    @sdxPrintStyleDailyLayout2PPD]);
  LoadCaption(lblPrintStyleDailyResourceCountPerPage, @sdxResourceCountPerPage);
  LoadCaption(lblPrintStyleDailyInclude, @sdxPrintStyleInclude);
  LoadCaption(chbxPrintStyleDailyTaskPad, @sdxPrintStyleIncludeTaskPad);
  ...
  LoadCaption(chbxPrintStyleDailyShowEventImages,
    @sdxPrintStyleShowEventImages);
  LoadCaption(chbxPrintStyleDailyShowResourceImages,
...
begin
  ...
  LoadStringsCombo(cbxPrintStyleMonthlyLayout, [@sdxPrintStyleMonthlyLayout1PPM,
    @sdxPrintStyleMonthlyLayout2PPM]);
  LoadCaption(lblPrintStyleMonthlyResourceCountPerPage,
  ...
  LoadCaption(chbxPrintStyleMonthlyNotesAreaBlank,
    @sdxPrintStyleIncludeNotesAreaBlank);
  LoadCaption(chbxPrintStyleMonthlyNotesAreaLined,
    @sdxPrintStyleIncludeNotesAreaLined);

  LoadCaption(chbxPrintStyleMonthlyDontPrintWeekends,
    @sdxPrintStyleDontPrintWeekEnds);
  LoadCaption(chbxPrintStyleMonthlyPrintExactlyOneMonthPerPage,
    @sdxPrintStyleMonthlyPrintExactly1MPP);
  LoadCaption(chbxPrintStyleMonthlyShowEventImages,
    @sdxPrintStyleShowEventImages);
...
begin
  ...
  LoadCaption(lblPrintStyleTimeLineResourceCountPerPage,
    @sdxResourceCountPerPage);
  ...
  LoadCaption(chbxPrintStyleTimeLineNotesAreaBlank,
    @sdxPrintStyleIncludeNotesAreaBlank);
  LoadCaption(chbxPrintStyleTimeLineNotesAreaLined,
    @sdxPrintStyleIncludeNotesAreaLined);
  ...
  LoadCaption(chbxPrintStyleTimeLineDontPrintWeekends,
    @sdxPrintStyleDontPrintWeekEnds);
  LoadCaption(chbxPrintStyleTimeLineWorkTimeOnly, @sdxPrintStyleWorkTimeOnly);

  LoadCaption(chbxPrintStyleTimeLineShowEventImages,
    @sdxPrintStyleShowEventImages);
  LoadCaption(chbxPrintStyleTimeLineShowResourceImages,
    @sdxPrintStyleShowResourceImages);

  LoadCaption(chbxPrintStyleTimeLinePrimaryPageScalesOnly,
    @sdxPrintStylePrimaryPageScalesOnly);
  LoadCaption(chbxPrintStyleTimeLinePrimaryPageHeadersOnly,
    @sdxPrintStylePrimaryPageHeadersOnly);
end;
...
procedure TcxfmSchedulerReportLinkDesignWindow.LoadStringsTrifold;
  ...
  begin
    LoadStringsCombo(ACombobox, [@sdxPrintStyleTrifoldSectionModeDailyCalendar,
...
begin
  ...
  LoadCaption(lblPrintStyleTrifoldSectionLeft,
    @sdxPrintStyleTrifoldSectionLeft);
  FillTrifoldSectionStrings(cbxPrintStyleTrifoldSectionLeft);
  LoadCaption(lblPrintStyleTrifoldSectionMiddle,
    @sdxPrintStyleTrifoldSectionMiddle);
  FillTrifoldSectionStrings(cbxPrintStyleTrifoldSectionMiddle);
  LoadCaption(lblPrintStyleTrifoldSectionRight,
    @sdxPrintStyleTrifoldSectionRight);
...
begin
  ...
  LoadStringsCombo(cbxPrintStyleWeeklyArrange, [@sdxPrintStyleWeeklyArrangeT2B,
  ...
  LoadStringsCombo(cbxPrintStyleWeeklyLayout, [@sdxPrintStyleWeeklyLayout1PPW,
  ...
  LoadCaption(chbxPrintStyleWeeklyNotesAreaBlank,
    @sdxPrintStyleIncludeNotesAreaBlank);
  ...
  LoadCaption(chbxPrintStyleWeeklyDontPrintWeekends,
    @sdxPrintStyleDontPrintWeekEnds);
  LoadCaption(chbxPrintStyleWeeklyShowEventImages,
    @sdxPrintStyleShowEventImages);
  LoadCaption(chbxPrintStyleWeeklyShowResourceImages,
    @sdxPrintStyleShowResourceImages);
end;
...
begin
  ...
  LoadStringsCombo(cbxPrintStyleYearlyLayout, [@sdxPrintStyleMonthlyLayout1PPM,
    @sdxPrintStyleMonthlyLayout2PPM]);

  LoadStringsCombo(cbxPrintStyleYearlyMonthPerPage, [@sdxPrintStyleYearly1MPP,
    @sdxPrintStyleYearly2MPP, @sdxPrintStyleYearly3MPP,
    @sdxPrintStyleYearly4MPP, @sdxPrintStyleYearly6MPP,
    @sdxPrintStyleYearly12MPP]);

  LoadCaption(lblPrintStyleYearlyResourceCountPerPage,
    @sdxResourceCountPerPage);
  ...
  LoadCaption(chbxPrintStyleYearlyNotesAreaBlank,
    @sdxPrintStyleIncludeNotesAreaBlank);
  LoadCaption(chbxPrintStyleYearlyNotesAreaLined,
    @sdxPrintStyleIncludeNotesAreaLined);
  LoadCaption(chbxPrimaryPageHeadersOnly, @sdxPrintStylePrimaryPageHeadersOnly);
  LoadCaption(chbxPrintStyleYearlyShowEventImages,
    @sdxPrintStyleShowEventImages);
end;
...
const
  AMessageFlags = CXTO_CENTER_HORIZONTALLY or CXTO_CENTER_VERTICALLY or
    CXTO_WORDBREAK;
var
  AMsg: PChar;
  R, R1: TRect;
        ...
        if ALink.PageCount > 0 then
          ...
          begin
            if (FActiveStyle = Memo) and Memo.SelectedEventsOnly then
              ...
              AMsg := PChar
                (cxGetResourceString(@sdxCannotPrintNoItemsAvailable));
          end;
...
begin
  ...
  UpdateEnabledControls([lblPrintStyleDailyPrintFrom,
    tePrintStyleDailyPrintFrom, lblPrintStyleDailyPrintTo,
    tePrintStyleDailyPrintTo], ReportLink.PrintStyles.Daily.SupportTimeRange);
  UpdateEnabledControls([lblPrintStyleWeeklyPrintFrom,
    tePrintStyleWeeklyPrintFrom, lblPrintStyleWeeklyPrintTo,
    tePrintStyleWeeklyPrintTo], ReportLink.PrintStyles.Weekly.SupportTimeRange);
  ...
  UpdateEnabled(btnStyleBackgroundBitmap, AreNativeStylesAvailable and
    HasSelectedStyles);
  UpdateEnabled(btnStyleBackgroundBitmapClear, AreNativeStylesAvailable and
    HasSelectedStylesWithAssignedBitmap);
  UpdateEnabled(btnStyleRestoreDefaults, AreNativeStylesAvailable and
    HasSelectedStyles);
  ...
  UpdateVisibilityControls([liPrintRangesMiscellaneous,
    liHideDetailsOfPrivateAppointments, pcPrintStyleOptions, tshFormatting,
    tshStyles],
    not(ActivePrintStyle is TcxSchedulerReportLinkAgendaPrintStyle));
end;

procedure TcxfmSchedulerReportLinkDesignWindow.UpdateEnabled
  (AComponent: TComponent; AEnabled: Boolean);
begin
...
procedure TcxfmSchedulerReportLinkDesignWindow.UpdateEnabledControls
  (AControls: array of TComponent; AEnabled: Boolean);
var
  I: Integer;
begin
...
procedure TcxfmSchedulerReportLinkDesignWindow.UpdateVisibility
  (AComponent: TComponent; AVisible: Boolean);
begin
  if AComponent is TMenuItem then
...
procedure TcxfmSchedulerReportLinkDesignWindow.UpdateVisibilityControls
  (AControls: array of TComponent; AVisible: Boolean);
var
  I: Integer;
begin
  for I := 0 to High(AControls) do
...
procedure TcxfmSchedulerReportLinkDesignWindow.SetDesignerTabIndex
  (Value: Integer);
begin
  if Value < 0 then
    Value := 0;
...
procedure TcxfmSchedulerReportLinkDesignWindow.DoFormActivated
  (AnActive: Boolean);
begin
  inherited;
  ...
  try
    ...
    try
      ...
      try
        ...
        lbxStyles.Items.AddObject
          (cxGetResourceString(@sdxSchedulerSchedulerHeader),
          Styles.SchedulerHeader);
        lbxStyles.Items.AddObject(cxGetResourceString(@sdxSchedulerContent),
          Styles.Content);
        lbxStyles.Items.AddObject
          (cxGetResourceString(@sdxSchedulerDateNavigatorContent),
          Styles.DateNavigatorContent);
        lbxStyles.Items.AddObject
          (cxGetResourceString(@sdxSchedulerDateNavigatorHeader),
          Styles.DateNavigatorHeader);
        lbxStyles.Items.AddObject(cxGetResourceString(@sdxSchedulerDayHeader),
          Styles.DayHeader);
        lbxStyles.Items.AddObject(cxGetResourceString(@sdxSchedulerEvent),
          Styles.Event);
        lbxStyles.Items.AddObject
          (cxGetResourceString(@sdxSchedulerResourceHeader),
          Styles.ResourceHeader);
        lbxStyles.Items.AddObject
          (cxGetResourceString(@sdxSchedulerNotesAreaBlank),
          Styles.NotesAreaBlank);
        lbxStyles.Items.AddObject
          (cxGetResourceString(@sdxSchedulerNotesAreaLined),
          Styles.NotesAreaLined);
        lbxStyles.Items.AddObject(cxGetResourceString(@sdxSchedulerTaskPad),
          Styles.TaskPad);
        lbxStyles.Items.AddObject(cxGetResourceString(@sdxSchedulerTimeRuler),
          Styles.TimeRuler);
      finally
...
procedure TcxfmSchedulerReportLinkDesignWindow.DoStyleChanged
...
procedure TcxfmSchedulerReportLinkDesignWindow.DoStylesChanged
...
procedure TcxfmSchedulerReportLinkDesignWindow.GetSelectedStyleNames
  (AStrings: TStrings);
var
  I: Integer;
begin
...
procedure TcxfmSchedulerReportLinkDesignWindow.GetStyleNames
  (out AStrings: TStrings);
begin
  AStrings := lbxStyles.Items;
end;

procedure TcxfmSchedulerReportLinkDesignWindow.GetStyleSheetNames
  (out AStrings: TStrings);
begin
...
function TcxfmSchedulerReportLinkDesignWindow.FindTabIndexByPrintStyle
  (APrintStyle: TcxCustomSchedulerReportLinkPrintStyle): Integer;
var
  ATag: TdxNativeInt;
begin
...
var
  ...
  procedure CheckAndAddPrintStyle(APrintStyle
    : TcxCustomSchedulerReportLinkPrintStyle);
  begin
    ...
    if (ActiveStyleIndex = -1) and
      (APrintStyle = ReportLink.PrintStyles.ActiveStyle) then
...
function TcxfmSchedulerReportLinkDesignWindow.GetActivePrintStyle
  : TcxCustomSchedulerReportLinkPrintStyle;
begin
...
function TcxfmSchedulerReportLinkDesignWindow.
...
function TcxfmSchedulerReportLinkDesignWindow.GetReportLink
  : TcxSchedulerReportLink;
begin
  Result := inherited ReportLink as TcxSchedulerReportLink;
end;
...
procedure TcxfmSchedulerReportLinkDesignWindow.RestoreSelectedStyles
  (AList: TList);
var
  I: Integer;
begin
...
procedure TcxfmSchedulerReportLinkDesignWindow.SetOptionsFormattingByIndex
  (AnIndex: Integer; AValue: Boolean);
begin
  ...
  with ReportLink.OptionsFormatting do
    case AnIndex of
      ...
      1:
        SuppressBackgroundBitmaps := AValue;
      2:
        SuppressContentColoration := AValue;
    end;
  Modified := True;
  UpdatePreview;
end;

procedure TcxfmSchedulerReportLinkDesignWindow.SetPrintStyleOptionsViewByIndex
  (AnIndex: Integer; AValue: Boolean);
begin
  if not LockControlsUpdate then
  begin
...
procedure TcxfmSchedulerReportLinkDesignWindow.SetPrintStyleRangeByIndex
  (AnIndex: Integer; const ATime: TDateTime);
begin
  if not LockControlsUpdate then
  begin
    case AnIndex of
...
procedure TcxfmSchedulerReportLinkDesignWindow.
  SetPrintStyleResourceCountPerPageByIndex(AnIndex: Integer;
  AValue: TcxEditValue);
begin
  if LockControlsUpdate then
    Exit;
...
begin
  ...
  begin
    ...
    AEventImages.Checked := AEventImages.Enabled and
      APrintStyle.ShowEventImages;
  end;
  if AResourceImages <> nil then
  begin
    AResourceImages.Enabled := ReportLink.HasResourceImages;
    AResourceImages.Checked := AResourceImages.Enabled and
      APrintStyle.ShowResourceImages;
  end;
end;

procedure TcxfmSchedulerReportLinkDesignWindow.WMDXCONTAINERSETFOCUS
...
procedure TcxfmSchedulerReportLinkDesignWindow.PageControl1Change
  (Sender: TObject);
begin
...
procedure TcxfmSchedulerReportLinkDesignWindow.btnStyleFontClick
  (Sender: TObject);
begin
  PerformStylesChangeFont;
end;

procedure TcxfmSchedulerReportLinkDesignWindow.btnStyleColorClick
  (Sender: TObject);
begin
  PerformStylesChangeColor;
end;

procedure TcxfmSchedulerReportLinkDesignWindow.btnStyleBackgroundBitmapClick
  (Sender: TObject);
begin
...
procedure TcxfmSchedulerReportLinkDesignWindow.
  btnStyleBackgroundBitmapClearClick(Sender: TObject);
begin
  PerformStylesClearBitmap;
end;

procedure TcxfmSchedulerReportLinkDesignWindow.miStylesSelectAllClick
  (Sender: TObject);
begin
  lbxStyles.SelectAll;
  UpdateControlsState;
...
procedure TcxfmSchedulerReportLinkDesignWindow.btnStyleRestoreDefaultsClick
  (Sender: TObject);
begin
  PerformStylesRestoreDefaults;
end;

procedure TcxfmSchedulerReportLinkDesignWindow.btnStylesSaveAsClick
  (Sender: TObject);
begin
  PerformStylesSaveAsStyleSheet;
end;

procedure TcxfmSchedulerReportLinkDesignWindow.cbxStyleSheetsClick
  (Sender: TObject);
begin
...
procedure TcxfmSchedulerReportLinkDesignWindow.cbxStyleSheetsKeyDown
  (Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  PerformStyleSheetKeyDown(Sender, Key, Shift);
end;

procedure TcxfmSchedulerReportLinkDesignWindow.btnStyleSheetNewClick
  (Sender: TObject);
begin
  PerformStyleSheetNew;
end;

procedure TcxfmSchedulerReportLinkDesignWindow.btnStyleSheetCopyClick
  (Sender: TObject);
begin
  PerformStyleSheetCopy;
end;

procedure TcxfmSchedulerReportLinkDesignWindow.btnStyleSheetDeleteClick
  (Sender: TObject);
begin
  PerformStyleSheetDelete;
end;

procedure TcxfmSchedulerReportLinkDesignWindow.btnStyleSheetRenameClick
  (Sender: TObject);
begin
  PerformStyleSheetRename;
end;

procedure TcxfmSchedulerReportLinkDesignWindow.lblUseNativeStylesClick
  (Sender: TObject);
begin
...
procedure TcxfmSchedulerReportLinkDesignWindow.OptionsFormattingClick
  (Sender: TObject);
begin
...
procedure TcxfmSchedulerReportLinkDesignWindow.LookAndFeelChange
  (Sender: TObject);
begin
  if LockControlsUpdate then
    Exit;
...
begin
  ...
  UpdateEnabled(miStyleBackgroundBitmap, AreNativeStylesAvailable and
    HasSelectedStyles);
  UpdateEnabled(miStyleBackgroundBitmapClear, AreNativeStylesAvailable and
    HasSelectedStylesWithAssignedBitmap);
  UpdateEnabled(miStyleRestoreDefaults, AreNativeStylesAvailable and
    HasSelectedStyles);
...
begin
  ...
  ReportLink.PrintStyles.Yearly.Layout :=
    ...
    (TcxComboBox(Sender).ItemIndex);
  Modified := True;
  UpdatePreview;
end;

procedure TcxfmSchedulerReportLinkDesignWindow.
  cbxPrintStyleYearlyMonthPagesPerYearClick(Sender: TObject);
const
...
procedure TcxfmSchedulerReportLinkDesignWindow.dePrintRangeStartEditValueChanged
  (Sender: TObject);
begin
  if LockControlsUpdate then
    Exit;
...
procedure TcxfmSchedulerReportLinkDesignWindow.dePrintRangeEndEditValueChanged
  (Sender: TObject);
begin
  if LockControlsUpdate then
    Exit;
...
procedure TcxfmSchedulerReportLinkDesignWindow.cbxPrintStylesClick
  (Sender: TObject);
begin
  if LockControlsUpdate then
    Exit;
...
procedure TcxfmSchedulerReportLinkDesignWindow.
  sePrintStyleResourceCountPerPagePropertiesChanged(Sender: TObject);
begin
  Modified := True;
end;

procedure TcxfmSchedulerReportLinkDesignWindow.
  sePrintStyleResourceCountPerPagePropertiesEditValueChanged(Sender: TObject);
begin
...
procedure TcxfmSchedulerReportLinkDesignWindow.
  tePrintStylePrintRangePropertiesEditValueChanged(Sender: TObject);
begin
...
procedure TcxfmSchedulerReportLinkDesignWindow.
  tePrintStylePrintRangePropertiesChange(Sender: TObject);
begin
  Modified := True;
end;
...
procedure TcxfmSchedulerReportLinkDesignWindow.
  cbxPrintStyleWeeklyDaysLayoutClick(Sender: TObject);
begin
  if LockControlsUpdate then
    Exit;
  ReportLink.PrintStyles.Weekly.DaysLayout := TcxSchedulerWeekViewDaysLayout
    (TcxComboBox(Sender).ItemIndex);
  Modified := True;
  UpdatePreview;
end;
...
procedure TcxfmSchedulerReportLinkDesignWindow.
  chbxPrintStyleWeeklyDontPrintWeekendsClick(Sender: TObject);
begin
  if LockControlsUpdate then
    Exit;
  ReportLink.PrintStyles.Weekly.DontPrintWeekends :=
...
procedure TcxfmSchedulerReportLinkDesignWindow.
  chbxPrintStyleDontPrintWeekEndsClick(Sender: TObject);
begin
  if LockControlsUpdate then
    Exit;
  if ActivePrintStyle is TcxSchedulerReportLinkMonthlyPrintStyle then
    ReportLink.PrintStyles.Monthly.DontPrintWeekends :=
      TcxCheckBox(Sender).Checked
  else if ActivePrintStyle is TcxSchedulerReportLinkTimeLinePrintStyle then
    ReportLink.PrintStyles.TimeLine.DontPrintWeekends :=
      TcxCheckBox(Sender).Checked;
  Modified := True;
end;

procedure TcxfmSchedulerReportLinkDesignWindow.
  chbxPrintStyleMonthlyPrintExactlyOneMonthPerPageClick(Sender: TObject);
begin
  if LockControlsUpdate then
    Exit;
...
// Tri-fold
procedure TcxfmSchedulerReportLinkDesignWindow.
  cbxPrintStyleTrifoldSectionModeClick(Sender: TObject);
begin
  if LockControlsUpdate or
    not(ActivePrintStyle is TcxSchedulerReportLinkTrifoldPrintStyle) then
    Exit;
  with TcxSchedulerReportLinkTrifoldPrintStyle(ActivePrintStyle) do
    FSections[TTagToInt(TcxComboBox(Sender).Tag)] :=
      TcxSchedulerReportLinkTrifoldPrintStyleSectionMode
      (TcxComboBox(Sender).ItemIndex);
  Modified := True;
  UpdateControlsState;
...
// Details
procedure TcxfmSchedulerReportLinkDesignWindow.
  chbxPrintStyleDetailsUsePaginationClick(Sender: TObject);
begin
  if LockControlsUpdate then
    Exit;
...
procedure TcxfmSchedulerReportLinkDesignWindow.
  cbxPrintStyleDetailsPaginationClick(Sender: TObject);
begin
  if LockControlsUpdate then
    Exit;
...
// Memo
procedure TcxfmSchedulerReportLinkDesignWindow.
  chbxPrintStyleMemoStartEachItemOnNewPageClick(Sender: TObject);
begin
  if LockControlsUpdate then
    Exit;
  ReportLink.PrintStyles.Memo.StartEachItemOnNewPage :=
    TcxCheckBox(Sender).Checked;
  Modified := True;
end;

procedure TcxfmSchedulerReportLinkDesignWindow.
  chbxPrintStyleMemoPrintOnlySelectedEventsClick(Sender: TObject);
begin
  if LockControlsUpdate then
    Exit;
...
procedure TcxfmSchedulerReportLinkDesignWindow.pbxPrintStylesPreviewPaint
  (Sender: TObject);
begin
  if ActivePrintStyle <> nil then
    ActivePrintStyle.DrawDesignWindowPreview(TPaintBox(Sender).Canvas,
      TPaintBox(Sender).ClientRect, ScaleFactor);
end;
...
procedure TcxfmSchedulerReportLinkDesignWindow.pbPreviewPaint(Sender: TObject);
begin
...
begin
  ...
  if Caption <> '' then
  begin
    Renderer.DrawText(ACanvas, R, -1, cxTextOffset, cxTextOffset, Caption, Font,
...
procedure TcxSchedulerReportNotesDataCell.SetTextAlignX(Value: TcxTextAlignX);
begin
  inherited TextAlignX := Value;
end;

procedure TcxSchedulerReportNotesDataCell.SetTextAlignY(Value: TcxTextAlignY);
begin
...
constructor TcxSchedulerReportNotesAreaCell.CreateEx(AParent: TdxReportCell;
  ALined: Boolean);
begin
  Create(AParent);
  FLined := ALined;
...
procedure TcxSchedulerReportNotesAreaCell.ConvertCoords(APixelsNumerator,
  APixelsDenominator: Integer);
begin
  inherited ConvertCoords(APixelsNumerator, APixelsDenominator);
  DataCell.CaptionHeight := MulDiv(DataCell.CaptionHeight, APixelsNumerator,
    APixelsDenominator);
end;
...
function TcxSchedulerReportNotesAreaCell.GetDataCellClass
  : TcxSchedulerReportNotesDataCellClass;
begin
...
function TcxSchedulerReportNotesAreaCell.GetDataCell
  : TcxSchedulerReportNotesDataCell;
begin
  if (DataItemCount > 0) and (DataItems[0] is TcxSchedulerReportNotesDataCell)
  then
...
constructor TcxSchedulerReportTaskPadCell.CreateEx(AParent: TdxReportCell;
  ALined: Boolean);
begin
...
constructor TcxSchedulerReportSchedulerHeaderDataCell.Create
  (AParent: TdxReportCell);
begin
  inherited Create(AParent);
  CellSides := [];
...
constructor TcxSchedulerReportSchedulerHeaderCell.Create
  (AParent: TdxReportCell);
begin
  inherited Create(AParent);
...
function TcxSchedulerReportSchedulerHeaderCell.AddContentCell
  : TcxSchedulerReportSchedulerHeaderDataCell;
begin
  Result := TcxSchedulerReportSchedulerHeaderDataCell
...
begin
  ...
  while (AParams.FontSize > 3) and (cxTextWidth(Font, AText, AParams.FontSize) >
    ((ABounds.Right - ABounds.Left) - cxTextOffset * 2)) do
    Dec(AParams.FontSize, 2);
...
function TcxSchedulerReportSchedulerHeaderCell.GetType
  : TcxSchedulerReportItemsType;
begin
  Result := srHeader;
end;
...
function TcxSchedulerReportDateNavigatorItem.GetDateNavigator
  : TcxSchedulerReportDateNavigatorCell;
begin
...
constructor TcxSchedulerReportDateNavigatorHeader.CreateEx
  (AParent: TdxReportCell; AYear, AMonth: Word);
begin
  Create(AParent);
  Transparent := False;
  TextAlignX := taCenterX;
...
procedure TcxSchedulerReportDateNavigatorDay.WriteData
  (AWriter: TdxPSDataWriter);
var
  Value: Integer;
begin
...
constructor TcxSchedulerReportDateNavigatorDayCaption.CreateEx
  (AParent: TdxReportCell; ADayOfWeek: TDay; ACol: Integer);
begin
  inherited Create(AParent);
  RightIndent := 2;
  TextAlignX := taRight;
...
procedure TcxSchedulerReportDateNavigatorDayCaption.ReadData
  (AReader: TdxPSDataReader);
begin
  inherited ReadData(AReader);
...
procedure TcxSchedulerReportDateNavigatorDayCaption.WriteData
  (AWriter: TdxPSDataWriter);
begin
  inherited WriteData(AWriter);
...
constructor TcxSchedulerReportDateNavigatorWeekNumber.CreateEx
  (AParent: TdxReportCell; AWeekNumber, ARow: Integer);
begin
  Create(AParent);
  RightIndent := 4;
  TextAlignX := taRight;
...
procedure TcxSchedulerReportDateNavigatorWeekNumber.ReadData
  (AReader: TdxPSDataReader);
var
  Value: Integer;
begin
...
procedure TcxSchedulerReportDateNavigatorWeekNumber.WriteData
  (AWriter: TdxPSDataWriter);
var
  Value: Integer;
begin
...
begin
  ...
  repeat
    ...
    else if AContentParams.FontSize < AHeaderParams.FontSize then
...
function TcxSchedulerReportDateNavigatorCell.CalculateSize(const AContentParams,
  AHeaderParams: TdxReportItemViewParams): TSize;
begin
...
begin
  GetContentPartSizes(AContentParams.Font, AColWidth, ARowHeight,
    ADayCaptionsHeight);
  GetHeaderPartSizes(AHeaderParams.Font, AHeaderHeight);
  Result := GetMonthHeight(AHeaderHeight, ADayCaptionsHeight, ARowHeight) + 2 *
    ARowHeight;
end;
...
begin
  if FVertOffset < 0 then
    FVertOffset := RowHeight;
  for I := 0 to DataItemCount - 1 do
    with DataItems[I] do
      Top := Top + FVertOffset;
end;

function TcxSchedulerReportDateNavigatorCell.ColOfDate
...
begin
  ...
  begin
    ...
    if ADayOfWeek > 6 then
      Dec(ADayOfWeek, 7);
    ACaption := TcxSchedulerReportDateNavigatorDayCaption.CreateEx(Self,
      TDay(ADayOfWeek), I);
    with ACaption do
    begin
      R.Left := R.Right;
...
begin
  ADay := TcxSchedulerReportDateNavigatorDay.CreateEx(Self, DayOf(ADate), ACol,
    ARow, ShowDatesContainingEventsInBold and GetDayIsBold(ADate));
...
begin
  TcxSchedulerReportDateNavigatorHeader.CreateEx(Self, Year, Month).BoundsRect
    := GetHeaderBounds;
end;
...
function TcxSchedulerReportDateNavigatorCell.GetDayBoundsFromColAndRow(ACol,
  ARow: Integer): TRect;
begin
  with Result do
  begin
...
begin
  Result := cxRect(ColWidth, 0, MonthSize.cx - MulDiv(ColWidth, 2, 3),
    HeaderHeight);
end;
...
begin
  AHeaderHeight := MulDiv(cxTextHeight(AFont, dxMeasurePattern,
    AFontSize), 3, 2);
end;

function TcxSchedulerReportDateNavigatorCell.GetMonthSize(const AContentParams,
  AHeaderParams: TdxReportItemViewParams): TSize;
begin
...
function TcxSchedulerReportDateNavigatorCell.GetType
  : TcxSchedulerReportItemsType;
begin
...
procedure TcxSchedulerReportDateNavigatorCell.ReadData
  (AReader: TdxPSDataReader);
begin
  inherited ReadData(AReader);
...
procedure TcxSchedulerReportDateNavigatorCell.WriteData
  (AWriter: TdxPSDataWriter);
begin
  inherited WriteData(AWriter);
...
class function TcxSchedulerReportDateNavigatorCell.GetMonthHeight(AHeaderHeight,
  ADayCaptionsHeight, ARowHeight: Integer): Integer;
begin
  Result := (AHeaderHeight + ADayCaptionsHeight + 6 * ARowHeight);
end;

function TcxSchedulerReportDateNavigatorCell.GetDay(Index: Integer)
  : TcxSchedulerReportDateNavigatorDay;
begin
  Result := DataItems[Index + 1 + 7] as TcxSchedulerReportDateNavigatorDay;
end;

function TcxSchedulerReportDateNavigatorCell.GetDayCaption(Index: Integer)
  : TcxSchedulerReportDateNavigatorDayCaption;
begin
  Result := DataItems[Index + 1] as TcxSchedulerReportDateNavigatorDayCaption;
end;

function TcxSchedulerReportDateNavigatorCell.GetHeader
  : TcxSchedulerReportDateNavigatorHeader;
begin
  Result := DataItems[0] as TcxSchedulerReportDateNavigatorHeader;
end;

function TcxSchedulerReportDateNavigatorCell.GetWeekNumber(Index: Integer)
  : TcxSchedulerReportDateNavigatorWeekNumber;
begin
  Result := DataItems[Index + 1 + 7 + FDayCount]
    as TcxSchedulerReportDateNavigatorWeekNumber;
end;
...
function TcxSchedulerReportSchedulingAreaCell.GetType
  : TcxSchedulerReportItemsType;
begin
...
class function TcxSchedulerReportCustomCell.SchedulerCellClass
  : TcxSchedulerCustomViewInfoItemClass;
begin
  Result := nil;
end;
...
procedure TcxSchedulerReportCustomCell.DrawCellFrame
  ...
  ALineWidth: Integer = 1);
begin
  Renderer.FrameRect(ACanvas, GetFixupRect(ACanvas, ARect), ABorderColor,
    TdxCellSides(ABorders), ALineWidth);
end;
...
begin
  ...
  begin
    ...
    Renderer.FrameRect(ACanvas, R, ABorderColor, TdxCellSides(ABorders),
      ALineWidth);
  end;
end;
...
begin
  if Length(AText) = 0 then
    Exit;
  R := GetFixupRect(ACanvas, ARect);
  Flags := Renderer.MakeTextFormat(AlignHorz, AlignVert, AMultiLine, False,
    True, True, False);
  if FNoClip then
  ...
  try
    ...
    Renderer.DrawTextEx(ACanvas, R, -1, cxTextOffset, cxTextOffset, AText,
      AFont, Flags);
  finally
...
begin
  if Renderer.IsPrinting then
    Result := MulDiv(AWidth * Renderer.UnitsPerPixel, Renderer.PixelsPerInch *
      5, 72 * 7)
  else
...
function TcxSchedulerReportCustomCell.InflateRect(const ARect: TRect;
  dX, dY: Integer): TRect;
begin
  Result := ARect;
end;
...
constructor TcxSchedulerReportContentCell.CreateFrom(AParent: TdxReportCell;
  AViewInfo: TcxSchedulerCustomViewInfoItem);
begin
...
class function TcxSchedulerReportContentCell.SchedulerCellClass
  : TcxSchedulerCustomViewInfoItemClass;
begin
...
constructor TcxSchedulerReportHeaderItemCell.CreateFrom(AParent: TdxReportCell;
  AViewInfo: TcxSchedulerCustomViewInfoItem);

  function GetConvertedRect(ARotateHeader, ARotateText: Boolean;
    const R: TRect): TRect;
  begin
    ...
    begin
      with R do
        if ARotateText then
          Result := cxRectBounds(BoundsRect.Left + Top,
            BoundsRect.Bottom - Right, Bottom - Top, Right - Left)
        else
...
begin
  ...
  if FRotateText then
    DrawCellTextVert(ACanvas, R, FCaption, TextAlignX, TextAlignY, Font,
      MultiLine)
  else
    DrawCellText(ACanvas, R, FCaption, TextAlignX, TextAlignY, Font, clDefault,
      MultiLine);
...
procedure TcxSchedulerReportHeaderItemCell.DrawImage
...
class function TcxSchedulerReportHeaderItemCell.SchedulerCellClass
  : TcxSchedulerCustomViewInfoItemClass;
begin
  Result := TcxSchedulerHeaderCellViewInfo;
end;

procedure TcxSchedulerReportHeaderItemCell.ConvertCoords(APixelsNumerator,
  APixelsDenominator: Integer);
begin
  inherited ConvertCoords(APixelsNumerator, APixelsDenominator);
...
begin
  Result := (Images <> nil) and (ImageIndex > -1) and
...
procedure TcxSchedulerReportHeaderItemCell.SetTextAlignX(Value: TcxTextAlignX);
begin
  inherited TextAlignX := Value;
end;

procedure TcxSchedulerReportHeaderItemCell.SetTextAlignY(Value: TcxTextAlignY);
begin
  inherited TextAlignY := Value;
end;
...
class function TcxSchedulerReportGroupSeparatorCell.SchedulerCellClass
  : TcxSchedulerCustomViewInfoItemClass;
begin
...
class function TcxSchedulerReportContainerCell.SchedulerCellClass
  : TcxSchedulerCustomViewInfoItemClass;
begin
...
constructor TcxSchedulerReportTextCell.CreateFrom(AParent: TdxReportCell;
  AViewInfo: TcxSchedulerCustomViewInfoItem);
begin
  inherited CreateFrom(AParent, AViewInfo);
...
procedure TcxSchedulerReportTextCell.ConvertCoords(APixelsNumerator,
  APixelsDenominator: Integer);
begin
  inherited ConvertCoords(APixelsNumerator, APixelsDenominator);
  ConvertRect(FTextRect, APixelsNumerator, APixelsDenominator);
...
class function TcxSchedulerReportBackgroundSlotCell.SchedulerCellClass
  : TcxSchedulerCustomViewInfoItemClass;
begin
...
begin
  ...
  begin
    ...
    if (DisplayText <> '') and
      (Abs(AScaleCell.TimeStart - Int(AScaleCell.TimeStart)) <= 1 / 24 / 60 / 60)
    then
      FTextRect := cxRectOffsetHorz(FTextRect, cxTextOffset);
  end;
end;

class function TcxSchedulerReportTimeLineMinorScaleCell.SchedulerCellClass
  : TcxSchedulerCustomViewInfoItemClass;
begin
...
class function TcxSchedulerReportTimeLineMajorScaleCell.SchedulerCellClass
  : TcxSchedulerCustomViewInfoItemClass;
begin
...
constructor TcxSchedulerReportDailyTimeRulerCellsSite.Create
  (AParent: TdxReportCell);
begin
  inherited Create(AParent);
...
procedure TcxSchedulerReportDailyTimeRulerCellsSite.SetFontIndex
  (Index: Integer);
begin
...
class function TcxSchedulerReportDailyTimeRulerCell.SchedulerCellClass
  : TcxSchedulerCustomViewInfoItemClass;
begin
...
begin
  ...
  TextR := cxRectInflate(ExcludeBorders(ABounds, [bRight, bBottom]),
    -FixupWidth(3), -FixupWidth(cxTextOffset));
  FNoClip := True;
  if LineCount > 1 then
  begin
    J := Length(AText);

    DrawCellText(ACanvas, Rect(TextR.Left, TextR.Top,
      R.Left - FixupWidth(cxTextOffset), TextR.Bottom), Copy(AText, 1, J - 3),
      taRight, taTop, LargeFont, LargeFont.Color);
...
procedure TcxSchedulerReportDailyTimeRulerCell.ReadData
  (AReader: TdxPSDataReader);
begin
  inherited ReadData(AReader);
...
procedure TcxSchedulerReportDailyTimeRulerCell.WriteData
  (AWriter: TdxPSDataWriter);
begin
  inherited WriteData(AWriter);
...
begin
  DrawCellText(ACanvas, AdjustTextRect(ABounds), AText, taLeft, taBottom, Font,
    Font.Color);
end;

function TcxSchedulerReportDailyTimeRulerCell.GetBoundsRect
  (AType: Boolean): TRect;
begin
  Result := FBounds[AType];
end;

function TcxSchedulerReportDailyTimeRulerCell.GetDisplayText
...
function TcxSchedulerReportDailyTimeRulerCell.GetTimeRulerSite
  : TcxSchedulerReportDailyTimeRulerCellsSite;
begin
...
procedure TcxSchedulerReportDailyTimeRulerModernCell.DrawTimeZone
  (ACanvas: TdxPSReportRenderCustomCanvas; const ABounds: TRect;
  const AText: string; AIsCurrent: Boolean);
const
...
begin
  ...
  begin
    ...
    DrawCellText(ACanvas, R1, S1, AAlignX[ANeedRightAlignment], taTop,
      LargeFont, LargeFont.Color);
    R1 := Rect(R.Left, TextR.Top, TextR.Right, TextR.Top + LH - FixupWidth(3));
...
class function TcxSchedulerReportDailyTimeRulerModernCell.SchedulerCellClass
  : TcxSchedulerCustomViewInfoItemClass;
begin
...
constructor TcxSchedulerReportMonthDayCell.CreateFrom(AParent: TdxReportCell;
  AViewInfo: TcxSchedulerCustomViewInfoItem);
begin
  inherited CreateFrom(AParent, AViewInfo);
  if AViewInfo is TcxSchedulerMonthDayContentCellCustomViewInfo then
  begin
    FSmallFont := TcxSchedulerMonthDayContentCellCustomViewInfo(AViewInfo)
      .SmallFont;
    FDontPrint := TcxSchedulerMonthDayContentCellCustomViewInfo(AViewInfo)
      .DontPrint;
    if FDontPrint then
    begin
      Transparent := True;
      ...
      FDisplayText := TcxSchedulerMonthDayContentCellCustomViewInfo(AViewInfo)
        .DisplayText;
  end;
end;
...
begin
  ...
  begin
    ...
    if Renderer.IsRendering then
      ATextOffset := MulDiv(ATextOffset, Renderer.UnitsPerInch,
        Renderer.PixelsPerInch);
...
class function TcxSchedulerReportMonthDayCell.SchedulerCellClass
  : TcxSchedulerCustomViewInfoItemClass;
begin
...
class function TcxSchedulerReportMonthDayModernCell.SchedulerCellClass
  : TcxSchedulerCustomViewInfoItemClass;
begin
...
procedure TcxSchedulerReportTimeLineModernPart.DrawContent
  (ACanvas: TdxPSReportRenderCustomCanvas; AStage: TdxPSRenderStages);
var
  R: TRect;
  ...
  case FState of
    1:
      begin
        ...
        ACanvas.FillRegion(ARegion, ColorToRGB(clWhite),
          ColorToRGB(BorderColor), nil, StateBrushes[8]);
        DeleteObject(ARegion);
      end;
    2:
      ACanvas.FillRect(R, BorderColor);
  else
    Renderer.FillRectByBrush(ACanvas, R,
      StateBrushes[Max(0, Min(FState, High(StateBrushes)))]);
  end;
  DrawBorders(ACanvas);
end;

procedure TcxSchedulerReportTimeLineModernPart.ReadData
  (AReader: TdxPSDataReader);
begin
  inherited ReadData(AReader);
...
procedure TcxSchedulerReportTimeLineCell.SetTimeRect(const ABounds: TRect;
  AState: Integer);
var
  ATriangle: Boolean;
begin
  ATriangle := cxRectIsEmpty(ABounds);
  FCurrentValue := TcxSchedulerReportTimeLinePart.CreateEx(Self,
    ATriangle, AState);
  if ATriangle then
...
procedure TcxSchedulerReportTimeLineModernCell.DrawItself
  (ACanvas: TdxPSReportRenderCustomCanvas; AStage: TdxPSRenderStages);
var
...
function TcxSchedulerReportTimeLineModernCell.GetBorderOuterBounds
...
procedure TcxSchedulerReportTimeLineModernCell.SetTimeRect(const ABounds: TRect;
  AState: Integer);
begin
  FCurrentValue := TcxSchedulerReportTimeLineModernPart.CreateEx(Self,
    cxRectIsEmpty(ABounds), AState);
  FCurrentValue.BoundsRect := ABounds;
end;

procedure TcxSchedulerReportTimeLineModernCell.ReadData
  (AReader: TdxPSDataReader);
begin
  inherited ReadData(AReader);
...
function TcxSchedulerReportCustomEventCell.CreateStringCell(const AText: string;
  AMultiLine: Boolean = True; AData: Integer = 0): TdxReportCellString;
begin
...
begin
  Result := (AProperties <> nil) and
    not PrintStyle.SupportMessageEditProperties;
end;

procedure TcxSchedulerReportCustomEventCell.SetViewParams(const AViewParams
  : TcxViewParams);
var
  I: Integer;
...
begin
  ...
  else if (AParams.Color = clWindow) or (AParams.Color = ColorToRGB(clWindow))
  then
...
procedure TcxSchedulerReportCustomEventCell.CreateMessageCell
  (AProperties: TcxCustomEditProperties);
begin
...
function TcxSchedulerReportCustomEventCell.GetValidMessage(const AMessage
  : Variant; AProperties: TcxCustomEditProperties): Variant;
begin
  Result := AMessage;
...
function TcxSchedulerReportCustomEventCell.GetPrintStyle
  : TcxCustomSchedulerReportLinkPrintStyle;
begin
  Result := ReportLink.PrintStyles.ActiveStyle;
end;

function TcxSchedulerReportCustomEventCell.GetReportLink
  : TcxSchedulerReportLink;
begin
...
var
  AParams: TdxReportItemViewParams;
begin
  if (MessageCell = nil) or (AProperties = nil) then
    Exit;
  FillChar(AParams, SizeOf(AParams), 0);
  AParams.NativeParams := AViewParams;
  dxPScxCommon.dxPSDataMaps.InitializeItem(MessageCell, AProperties, GetMessage,
    PrintStyle, AParams);
end;
...
procedure TcxSchedulerReportEventCell.AdjustSomeCells
  (ACanvas: TdxPSReportRenderCustomCanvas);
begin
  // do nothing
end;
...
begin
  ...
  try
    ...
    ACaptionRect.Right := Min(ACaptionRect.Right,
      cxRectWidth(Parent.BoundsRect));
...
procedure TcxSchedulerReportEventCell.CalculateMessageCell
  (ACanvas: TdxPSReportRenderCustomCanvas);
begin
...
procedure TcxSchedulerReportEventCell.CalculateCaptionCellRect
  (ACanvas: TdxPSReportRenderCustomCanvas; ACaptionRect: TRect);
var
  ARect: TRect;
begin
  if HasImages then
...
procedure TcxSchedulerReportEventCell.CalculateTimeCells
...
begin
  ...
  FTimeLineCell.FCurrentValue.BorderColor := TcxSchedulerEventCellViewInfoAccess
    (EventViewInfo).GetTimeLineBorderColor;
end;
...
begin
  Result := CreateStringCell(GetCaption, FHasDetailInfo,
...
function TcxSchedulerReportEventCell.CreateTimeTextCell(const ATimeText: string;
  AData: Integer = 0): TdxReportCellString;
begin
  Result := CreateStringCell(ATimeText, False, AData);
  Result.TextAlignX := taRight;
end;

procedure TcxSchedulerReportEventCell.DoInitializeFromViewInfo
  (AEventViewInfo: TcxSchedulerEventCellViewInfo);
begin
  CellSides := TdxCellSides(AEventViewInfo.Borders);
  FIsHeaderEvent := TcxSchedulerEventCellViewInfoAccess(AEventViewInfo)
    .IsHeaderEvent;
  FHasDetailInfo := AEventViewInfo.IsDetailInfo;
  FIsNeedCreateTimeCells := (AEventViewInfo.ShowFinishTime or
    AEventViewInfo.ShowStartTime) and
...
function TcxSchedulerReportEventCell.CreateTimeLineCell
  : TcxSchedulerReportTimeLineCell;
const
  ClassMap: array [Boolean] of TcxSchedulerReportTimeLineCellClass =
    (TcxSchedulerReportTimeLineCell, TcxSchedulerReportTimeLineModernCell);
begin
...
function TcxSchedulerReportEventCell.GetContentBounds
  (ACanvas: TdxPSReportRenderCustomCanvas): TRect;
begin
  Result := cxRectOffset(EventViewInfo.Bounds,
    EventViewInfo.EventViewData.Bounds.TopLeft, False);
  Dec(Result.Right);
  Dec(Result.Bottom);
end;
...
procedure TcxSchedulerReportEventCell.InitializeFromViewInfo(AEventViewInfo
  : TcxSchedulerEventCellViewInfo);
var
  ARect: TRect;
begin
...
procedure TcxSchedulerReportEventCell.MeasureTimeCell
  (ACanvas: TdxPSReportRenderCustomCanvas; out AWidth, AHeight: Integer);
var
  AFont: TFont;
begin
  AFont := CaptionCell.Font;
  AWidth := Max(Renderer.CalcTextWidth(ACanvas,
    '00:00' + DateTimeHelper.TimeAMString, AFont),
    Renderer.CalcTextWidth(ACanvas,
    '00:00' + DateTimeHelper.TimePMString, AFont));
  AHeight := Renderer.CalcTextHeight(ACanvas, '0' + DateTimeHelper.TimeAMString
    + DateTimeHelper.TimePMString, False, AFont);
end;

procedure TcxSchedulerReportEventCell.SetViewParams(const AViewParams
  : TcxViewParams);
var
...
procedure TcxSchedulerReportEventModernCell.AdjustSomeCells
  (ACanvas: TdxPSReportRenderCustomCanvas);
var
...
begin
  ...
  begin
    ...
    begin
      ACaptionWidth := Renderer.CalcTextWidth(ACanvas, CaptionCell.Text,
        CaptionCell.Font);
      if CaptionCell.TextAlignX = taCenterX then
      begin
        ALocationWidth := Renderer.CalcTextWidth(ACanvas, LocationCell.Text,
          LocationCell.Font);
        ACaptionLeft := Max(ABounds.Left,
          (ABounds.Right + ABounds.Left - ACaptionWidth -
          ALocationWidth) div 2);
...
procedure TcxSchedulerReportEventModernCell.CalculateCaptionCellRect
  (ACanvas: TdxPSReportRenderCustomCanvas; ACaptionRect: TRect);
begin
...
begin
  if LocationCell <> nil then
    LocationCell.BoundsRect :=
      GetRelativeRect(TcxSchedulerEventCellViewInfoAccess(EventViewInfo)
      .LocationRect);
end;
...
begin
  ...
  begin
    if HasImages then
      R := cxRectBounds(GetRelativeRect(EventViewInfo.MessageRect).Left, 0,
        AWidth, AHeight)
    else
  ...
  begin
    FinishCell.BoundsRect := cxRectBounds(ACaptionRect.Right - AWidth, 0,
      AWidth, AHeight);
...
function TcxSchedulerReportEventModernCell.CreateLocationCell
  : TdxReportCellString;
var
  ALocation: string;
begin
  ...
  if ALocation <> '' then
  begin
    Result := CreateStringCell(ALocation,
      not IsCaptionAndLocationPlaceOneLineOnly);
...
function TcxSchedulerReportEventModernCell.GetBackgroundBounds
  (ACanvas: TdxPSReportRenderCustomCanvas): TRect;
var
  R: TRect;
begin
...
function TcxSchedulerReportEventModernCell.GetBorderOuterBounds
  (ACanvas: TdxPSReportRenderCustomCanvas): TRect;
begin
...
begin
  Result := EventViewInfo.Caption;
  if IsCaptionAndLocationPlaceOneLineOnly and (GetLocation <> '') and
...
function TcxSchedulerReportEventModernCell.GetMessageRect
  (ACanvas: TdxPSReportRenderCustomCanvas): TRect;
begin
...
function TcxSchedulerReportEventModernCell.GetTimeLineRect
  (ACanvas: TdxPSReportRenderCustomCanvas): TRect;
begin
  Result := cxRect(0, 0, Max(cxTimeLineWidth, ContentBounds.Left), Height);
end;

function TcxSchedulerReportEventModernCell.
  IsCaptionAndLocationPlaceOneLineOnly: Boolean;
begin
  Result := TcxSchedulerEventCellViewInfoAccess(EventViewInfo)
...
procedure TcxSchedulerReportEventModernCell.SetViewParams(const AViewParams
  : TcxViewParams);
var
  AFont: TFont;
begin
...
procedure TcxSchedulerReportDetailsEventCell.CalculateLayout(AWidth,
  ATimeWidth: Integer);
var
  ACanvas: TdxPSReportRenderCanvas;
  ATop: Integer;
...
begin
  ...
  for I := 0 to DataItemCount - 1 do
    with DataItems[I] do
      if Visible then
        Result := Max(Result, BoundsRect.Bottom);
end;

procedure TcxSchedulerReportDetailsEventCell.CreateCaptionCell;
begin
  FCaptionCell := CreateStringCell(GetCaptionCellText, IsMultilineCaption,
    cdidSchedulerEventCaption);
end;
...
begin
  if Continued or (AProperties = nil) then
    FMessageCell := CreateStringCell(GetMessage, True,
...
begin
  FStartCell := CreateStringCell(GetTimeCellText, False,
    cdidSchedulerEventStart);
end;
...
function TcxSchedulerReportDetailsEventCell.GetEditProperties
  : TcxCustomEditProperties;
begin
  Result := nil;
  if not Continued and Assigned(ReportLink.Scheduler.OnGetEventEditProperties)
  then
...
begin
  if Event.AllDayEvent or ((dxDateOf(Event.Start) < Date) and
    (dxDateOf(Event.Finish) > Date)) then
...
procedure TcxSchedulerReportDetailsEventCell.SetViewParams(const AViewParams
  : TcxViewParams);
var
  AParams: TdxReportItemViewParams;
begin
...
begin
  ACanvas := TdxPSReportRenderScreenCanvas.Create;
  try
    FLineHeight := Renderer.CalcTextHeight(ACanvas, dxMeasurePattern,
      False, Font);
    ASpace := FLineHeight div 2;
    ATop := FLineHeight * 2;
    HeaderCell.BoundsRect := Rect(0, 0, AWidth, ATop);
    Inc(ATop, ASpace);
    CalculateLabelAndData(CaptionLabelCell, CaptionCell, ACanvas, ATimeWidth,
      AWidth, ATop);
    CalculateLabelAndData(LocationLabelCell, LocationCell, ACanvas, ATimeWidth,
      AWidth, ATop);
    if Assigned(CaptionLabelCell) or Assigned(LocationLabelCell) then
      Inc(ATop, ASpace);
    CalculateLabelAndData(StartLabelCell, StartCell, ACanvas, ATimeWidth,
      AWidth, ATop);
    CalculateLabelAndData(FinishLabelCell, FinishCell, ACanvas, ATimeWidth,
      AWidth, ATop);
    CalculateLabelAndData(ShowTimeAsLabelCell, ShowTimeAsCell, ACanvas,
      ATimeWidth, AWidth, ATop);
    Inc(ATop, ASpace);
    CalculateLabelAndData(RecurrenceLabelCell, RecurrenceCell, ACanvas,
      ATimeWidth, AWidth, ATop);
    CalculateLabelAndData(RecurrencePatternLabelCell, RecurrencePatternCell,
      ACanvas, ATimeWidth, AWidth, ATop);
    if Assigned(MessageCell) then
    begin
      Inc(ATop, ASpace);
...
procedure TcxSchedulerReportMemoEventCell.SetViewParams(const AViewParams
  : TcxViewParams);
var
  AParams: TdxReportItemViewParams;
begin
...
procedure TcxSchedulerReportMemoEventCell.CalculateLabelAndData(ALabelCell,
  ADataCell: TAbstractdxReportCellData; ACanvas: TdxPSReportRenderCustomCanvas;
...
begin
  FRecurrencePatternLabelCell :=
    CreateStringCell(cxGetResourceString(@sdxRecurrencePatternLabelCaption));
end;

procedure TcxSchedulerReportMemoEventCell.CreateShowTimeAs;
begin
  if GetShowTimeAsCellText = '' then
    Exit;
...
constructor TcxSchedulerReportGanttLinkCell.CreateFrom(AParent: TdxReportCell;
  AViewInfo: TcxSchedulerCustomViewInfoItem);
var
  R: TRect;
  I: Integer;
  ...
  case ArrowDirection of
    ...
    adDown:
      begin
        ...
        APoints[1] := Point((ABounds.Right + ABounds.Left) div 2,
          ABounds.Bottom);
    ...
    adRight:
      begin
        APoints[0] := Point(ABounds.Right,
          (ABounds.Top + ABounds.Bottom) div 2);
...
class function TcxSchedulerReportGanttLinkCell.SchedulerCellClass
  : TcxSchedulerCustomViewInfoItemClass;
begin
  Result := TcxSchedulerGanttViewLinkViewInfo;
end;

procedure TcxSchedulerReportGanttLinkCell.AssignInfo(const ALines
  : TcxSchedulerGanttViewLinkLines; AArrowDirection: TcxArrowDirection;
...
procedure TcxSchedulerReportGanttLinkCell.ConvertCoords(APixelsNumerator,
  APixelsDenominator: Integer);
var
  I: Integer;
begin
...
procedure TcxSchedulerReportGanttMilestoneCell.DrawContent
  (ACanvas: TdxPSReportRenderCustomCanvas; DrawRect: TRect;
  const OriginRect: TRect; AStage: TdxPSRenderStages);
var
  APoints: TPoints;
...
procedure TcxSchedulerReportGanttMilestoneCell.DoInitializeFromViewInfo
  (AEventViewInfo: TcxSchedulerEventCellViewInfo);
begin
  CellSides := [];
  Transparent := True;
...
function TcxSchedulerReportGanttMilestoneCell.GetPolygone
  (ABounds: TRect): TPoints;
begin
...
begin
  ...
  APageIndex := (Site.PageIndex div PagesPerWeek)
    mod Style.GetResourcePageCount;
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        else if FindMirorClassForItem(AItem, AReportItemClass) then
...
procedure TcxSchedulerReportCommonCellsProducer.DoInitialize(var ASelectedDays
  : TcxSchedulerDateList; var AEvents: TcxSchedulerCachedEventList);
begin
...
function TcxSchedulerReportCommonCellsProducer.GetEventCellClass
  (AEventViewInfo: TcxSchedulerEventCellViewInfo)
  : TcxSchedulerReportEventCellClass;
const
  SimpleEventCellClass: array [Boolean] of TcxSchedulerReportEventCellClass =
    (TcxSchedulerReportEventCell, TcxSchedulerReportEventModernCell);
begin
  if AEventViewInfo.EventViewData.IsMilestone then
    Result := TcxSchedulerReportGanttMilestoneCell
  else if AEventViewInfo.EventViewData.IsGroup then
...
function TcxSchedulerReportCommonCellsProducer.GetPrintRange(Index: Integer)
  : TDateTime;
begin
  if Index = 0 then
...
function TcxSchedulerReportCommonCellsProducer.GetStyles
  : TcxSchedulerReportLinkStyles;
begin
...
procedure TcxSchedulerReportDailyCellsProducer.ConvertSchedulerCellToPSCells
  ...
  AReportItemClass: TcxSchedulerReportCustomCellClass);
begin
  if (AReportItemClass = TcxSchedulerReportDailyTimeRulerCell) or
    (AReportItemClass = TcxSchedulerReportDailyTimeRulerModernCell) then
    SetCellViewParams(AReportItemClass.CreateFrom(FRulerSite, AItem),
      AItem.ViewParams)
  else
    inherited ConvertSchedulerCellToPSCells(AItem, AReportItemClass);
end;

function TcxSchedulerReportDailyCellsProducer.CreateTimeRulerSite
  : TcxSchedulerReportDailyTimeRulerCellsSite;
begin
...
const
  Dividers: array [TcxSchedulerReportLinkPeriodicPrintStyleLayout]
    of Integer = (1, 2);
begin
...
function TcxSchedulerReportYearlyCellsProducer.GetStyle
  : TcxSchedulerReportLinkYearlyPrintStyle;
begin
...
begin
  AResources.Clear;
  if Style.ResourceCountPerPage = 0 then
    Exit;
  for I := 0 to Resources.VisibleResourceCount - 1 do
    AResources.Add(TcxSchedulerResourceViewInfo.Create
      (Resources.VisibleResources[I]));
...
function TcxSchedulerReportTimeLineLayoutBuilder.AddPageInfo(ARow,
  AColumn: Integer; const AStart, AFinish: TDateTime): TcxTimeLinePageInfo;
begin
  Result := TcxTimeLinePageInfo.Create;
  FCurrentPageIndex := FPagesInfo.Add(Result);
  Result.PageBounds := cxRectOffset(GetPageBounds, 0,
    FCurrentPageIndex * Style.PageHeight);
...
procedure TcxSchedulerReportTimeLineLayoutBuilder.AddRow(AStartIndex,
  AFinishIndex, AStartLine: Integer);
var
  ACol, I: Integer;
...
procedure TcxSchedulerReportTimeLineLayoutBuilder.CalculatePagination;
  ...
  procedure PrepareIndexes(var AStart, AFinish: Integer;
    APageLineCount: Integer);
  var
    I, AMaxCount: Integer;
  begin
...
begin
  ...
  try
    ATimeBuilder.Initialize
      (Style.GetCorrespondedView as TcxSchedulerTimeGridView,
...
function TcxSchedulerReportTimeLineLayoutBuilder.GetPageContentBounds(ARow,
...
begin
  ...
  begin
    Result.Left := Min(Result.Bottom - 1,
      Result.Left + ViewInfo.ResourceHeaderWidth);
  end;
end;
...
begin
  Result := Max(1, Max(0, cxRectHeight(GetPageContentBounds(ARow, 0)) -
    cxTextOffset * 2) div (ViewInfo.ContentLineHeight +
    ViewInfo.IndentBetweenLines));
end;

function TcxSchedulerReportTimeLineLayoutBuilder.GetPrintRange(Index: Integer)
  : TDateTime;
begin
  Result := 0; // todo:
end;

function TcxSchedulerReportTimeLineLayoutBuilder.GetStylesAdapter
  : IcxSchedulerStylesAdapter;
begin
  Result := Style.VisualStyles;
end;
...
function TcxSchedulerReportTimeLineLayoutBuilder.GetPageInfo(Index: Integer)
  : TcxTimeLinePageInfo;
begin
  Result := TcxTimeLinePageInfo(FPagesInfo[Index]);
end;

function TcxSchedulerReportTimeLineLayoutBuilder.GetViewInfo
...
function TcxSchedulerReportTimeLineCellsProducer.GetPrintRange(Index: Integer)
  : TDateTime;
begin
  if Index = 0 then
...
function TcxSchedulerReportTimeLineCellsProducer.GetShowResourceHeaders
  : Boolean;
begin
...
function TcxSchedulerReportTimeLineCellsProducer.GetPageInfo
  : TcxTimeLinePageInfo;
begin
  Result := Style.LayoutBuilder.PageInfo[PageIndex];
end;

function TcxSchedulerReportTimeLineCellsProducer.GetStyle
  : TcxSchedulerReportLinkTimeLinePrintStyle;
begin
...
begin
  Result := '';
  if ShGetSpecialFolderLocation(Application.Handle, CSIDL_FONTS, APIDL) = S_OK
  then
  begin
...
begin
  ...
  dxPSRegisterReportLink(TcxSchedulerReportLink, TcxScheduler,
    TcxfmSchedulerReportLinkDesignWindow);
end;

type
  TAddFontMemResource = function(p1: Pointer; p2: DWORD; p3: PDesignVector;
...
begin
  ...
  // images loading
  StyleImages := LoadImagesFromResource(32, 32,
    IDB_DXPSSCHEDULER_SMALLDESIGNPREVIEW);
  StylePreviewImages := LoadImagesFromResource(128, 76,
    IDB_DXPSSCHEDULER_STYLEDESIGNPREVIEW);
  ...
  try
    if IsWin2KOrLater then
      SchedulerFontHandle := AddFontMemResource(Res.Memory, Res.Size,
        nil, @Count)
    else
    begin
...
begin
  ...
  dxPSUnregisterReportLink(TcxSchedulerReportLink, TcxScheduler,
    TcxfmSchedulerReportLinkDesignWindow);
  ...
  with TcxCheckBox(Sender) do
    if ActivePrintStyle is TcxSchedulerReportLinkYearlyPrintStyle then
      TcxSchedulerReportLinkYearlyPrintStyle(ActivePrintStyle)
        .PrimaryPageHeadersOnly := Checked
    else if ActivePrintStyle is TcxSchedulerReportLinkTimeLinePrintStyle then
...
begin
  if LockControlsUpdate then
    Exit;
  TcxSchedulerReportLinkTimeLinePrintStyle(ActivePrintStyle).WorkTimeOnly :=
    TcxCheckBox(Sender).Checked;
  Modified := True;
  UpdatePreview;
end;
...
procedure TcxfmSchedulerReportLinkDesignWindow.
  chbxPrintStyleShowResourceImagesClick(Sender: TObject);
begin
  if LockControlsUpdate then
    Exit;
...
procedure TcxfmSchedulerReportLinkDesignWindow.
  chbxPrintStyleShowEventImagesClick(Sender: TObject);
begin
  if LockControlsUpdate then
    Exit;
