...
{$ENDIF}
  ...
  ImgList, Menus, dxCore, cxStyles, cxControls, dxPSUtl, cxLookAndFeels,
  cxLookAndFeelPainters, cxCustomPivotGrid,
  cxDBPivotGrid, dxPSCore, dxPSGlbl, dxPScxCommon, cxGraphics, cxContainer,
  cxEdit, cxTextEdit, cxMaskEdit,
  cxDropDownEdit, cxClasses, cxPivotGrid, cxCustomData, cxPC, cxCheckBox,
  cxButtons, cxLabel, dxPSReportRenderCanvas,
  cxGeometry, cxDataUtils, dxLayoutControlAdapters, dxLayoutLookAndFeels,
...
type
  ...
  TcxPivotGridReportLinkOptionsExpanding = class
  ...
  published
    property AutoExpandColumns: Boolean read FAutoExpandColumns
      write SetAutoExpandColumns default False;
  ...
  published
    ...
    property GridLines: TcxPivotGridLines read FGridLines write SetGridLines
      default pglBoth;
    property Prefilter: TcxPivotGridPrefilterVisible read FPrefilter
      write SetPrefilter default pfvAlways;
    property RowFields: Boolean read FRowFields write SetRowFields default True;
  end;

  { TcxPivotGridReportLinkOptionsFormatting }

  TcxPivotGridReportLinkOptionsFormatting = class
  ...
  published
    property ColumnHeaders: Boolean read FColumnHeaders write SetColumnHeaders
      default False;
    property FilterBar: Boolean read FFilterBar write SetFilterBar default True;
    property RowHeaders: Boolean read FRowHeaders write SetRowHeaders
      default False;
  end;

  TcxPivotGridReportLinkOptionsOnEveryPageClass = class of
    TcxPivotGridReportLinkOptionsOnEveryPage;

  { TcxPivotGridReportLinkStyles }

  TcxPivotGridReportLinkStyles = class(TdxCustomReportLinkStyles,
    IcxPivotGridBaseStyles)
  private
    function GetReportLink: TcxPivotGridReportLink;
  protected
    procedure AssignToPivot(AFromGrid, ADestGrid: TcxCustomPivotGrid;
      AUsePivotStyles: Boolean); virtual;
    function DesignerTabIndex: Integer; override;
  ...
  public
    ...
    property ReportLink: TcxPivotGridReportLink read GetReportLink;
  published
    property ColumnHeader: TcxStyle index vspsPGridColumnHeader read GetValue
      write SetValue;
    property Content: TcxStyle index vspsPGridContent read GetValue
      write SetValue;
    property FieldHeader: TcxStyle index vspsPGridFieldHeader read GetValue
      write SetValue;
    property HeaderBackground: TcxStyle index vspsPGridHeaderBackground
      read GetValue write SetValue;
    property Prefilter: TcxStyle index vspsPGridPrefilter read GetValue
      write SetValue;
    property RowHeader: TcxStyle index vspsPGridRowHeader read GetValue
      write SetValue;
    property StyleSheet;
  end;
  ...
  published
    property Styles: TcxPivotGridReportLinkStyles read GetStylesValue
      write SetStylesValue;
  end;

  { TcxPivotGridReportLink }

  TcxPivotGridReportLinkCustomDrawDataCellEventEvent = procedure
    (Sender: TcxPivotGridReportLink; ACanvas: TCanvas;
    AnItem: TAbstractdxReportCellData; var ADone: Boolean) of object;

  TcxPivotGridReportLinkCustomDrawFieldHeaderCellEvent = procedure
    (Sender: TcxPivotGridReportLink; ACanvas: TCanvas; AnItem: TdxReportCell;
    var ADone: Boolean) of object;

  TcxPivotGridReportLinkCustomDrawGroupHeaderCellEvent = procedure
    (Sender: TcxPivotGridReportLink; ACanvas: TCanvas; AnItem: TdxReportCell;
    var ADone: Boolean) of object;

  TcxPivotGridReportLinkCustomDrawHeaderBackgroundEvent = procedure
    (Sender: TcxPivotGridReportLink; ACanvas: TCanvas; AnItem: TdxReportCell;
    var ADone: Boolean) of object;

  TcxPivotGridReportLinkCustomDrawPrefilterEvent = procedure
    (Sender: TcxPivotGridReportLink; ACanvas: TCanvas;
    AnItem: TdxReportCellText; var ADone: Boolean) of object;

  TcxPivotGridReportLinkInitializeDataCellEvent = procedure
    (Sender: TcxPivotGridReportLink; ACell: TcxPivotGridDataCellViewInfo;
    AnItem: TAbstractdxReportCellData) of object;

  TcxPivotGridReportLinkInitializeFieldHeaderCellEvent = procedure
    (Sender: TcxPivotGridReportLink; ACell: TcxPivotGridFieldHeaderCellViewInfo;
    AnItem: TdxReportCell) of object;

  TcxPivotGridReportLinkInitializeGroupHeaderCellEvent = procedure
    (Sender: TcxPivotGridReportLink; ACell: TcxPivotGridHeaderCellViewInfo;
    AnItem: TdxReportCell) of object;

  TcxPivotGridReportLinkInitializeHeaderBackgroundEvent = procedure
    (Sender: TcxPivotGridReportLink;
    ACell: TcxPivotGridHeaderBackgroundCellViewInfo; AnItem: TdxReportCell)
    of object;

  TcxPivotGridReportLinkInitializePrefilterEvent = procedure
    (Sender: TcxPivotGridReportLink; ACell: TcxPivotGridPrefilterViewInfo;
    AnItem: TdxReportCellText) of object;
  ...
  private
    ...
    FOnCustomDrawFieldHeaderCell
      : TcxPivotGridReportLinkCustomDrawFieldHeaderCellEvent;
    FOnCustomDrawGroupHeaderCell
      : TcxPivotGridReportLinkCustomDrawGroupHeaderCellEvent;
    FOnCustomDrawHeaderBackground
      : TcxPivotGridReportLinkCustomDrawHeaderBackgroundEvent;
  ...
  protected
    ...
    procedure DoCustomDrawDataCell(ACanvas: TCanvas;
      AItem: TAbstractdxReportCellData; var ADone: Boolean); virtual;
    procedure DoCustomDrawFieldHeaderCell(ACanvas: TCanvas;
      AItem: TdxReportCell; var ADone: Boolean); virtual;
    procedure DoCustomDrawGroupHeaderCell(ACanvas: TCanvas;
      AItem: TdxReportCell; var ADone: Boolean); virtual;
    procedure DoCustomDrawHeaderBackground(ACanvas: TCanvas;
      AItem: TdxReportCell; var ADone: Boolean); virtual;
    procedure DoCustomDrawPrefilter(ACanvas: TCanvas;
      AItem: TdxReportCellString; var ADone: Boolean); virtual;
    procedure DoInitializeDataCell(AItem: TAbstractdxReportCellData;
      ACell: TcxPivotGridDataCellViewInfo); virtual;
    procedure DoInitializeFieldHeaderCell(AItem: TdxReportCell;
      ACell: TcxPivotGridFieldHeaderCellViewInfo); virtual;
    procedure DoInitializeGroupHeaderCell(AItem: TdxReportCell;
      ACell: TcxPivotGridHeaderCellViewInfo); virtual;
    procedure DoInitializeHeaderBackground(AItem: TdxReportCell;
      ACell: TcxPivotGridHeaderBackgroundCellViewInfo); virtual;
    procedure DoInitializePrefilter(AItem: TdxReportCellString;
      ACell: TcxPivotGridPrefilterViewInfo); virtual;
    ...
    function GetOptionsOnEveryPageClass
      : TcxPivotGridReportLinkOptionsOnEveryPageClass; virtual;
    ...
    procedure AddHeaderBackground
      (ACell: TcxPivotGridHeaderBackgroundCellViewInfo);
    procedure AddHeaderCell(Area: TcxPivotGridFieldArea;
      ACell: TcxPivotGridHeaderCellViewInfo);
    procedure AddPrefilter(ACell: TcxPivotGridPrefilterViewInfo);
    function CreateHeaderCell(AHost: TdxReportCell;
      ACell: TcxPivotGridHeaderCellViewInfo; AttributeID: Integer)
      : TdxReportCell;

    procedure InitializeOptionsBeforeBuildReport(AController
      : TcxPivotGridExportController); virtual;
    procedure ProcessCreateReportItems(AViewInfo
      : TcxPivotGridViewInfo); virtual;
    ...
    property HostByArea[Area: TcxPivotGridFieldArea]: TdxReportCell
      read GetHostByArea;
  ...
  public
    ...
    property DesignWindow: TcxfmPivotGridReportLinkDesignWindow
  ...
  published
    property Color;
    property Font;
    property OptionsExpanding: TcxPivotGridReportLinkOptionsExpanding
    ...
    property OptionsOnEveryPage: TcxPivotGridReportLinkOptionsOnEveryPage
      read GetOptionsOnEveryPage write SetOptionsOnEveryPage;
    property OptionsView: TcxPivotGridReportLinkOptionsView read GetOptionsView
      write SetOptionsView;
    property ScaleFonts;
    property StyleRepository;
    property Styles: TcxPivotGridReportLinkStyles read GetStyles
      write SetStyles;
    property SupportedCustomDraw;
    property OnCustomDrawDataCell
      : TcxPivotGridReportLinkCustomDrawDataCellEventEvent
      read FOnCustomDrawDataCell write FOnCustomDrawDataCell;
    property OnCustomDrawFieldHeaderCell
      : TcxPivotGridReportLinkCustomDrawFieldHeaderCellEvent
      read FOnCustomDrawFieldHeaderCell write FOnCustomDrawFieldHeaderCell;
    property OnCustomDrawGroupHeaderCell
      : TcxPivotGridReportLinkCustomDrawGroupHeaderCellEvent
      read FOnCustomDrawGroupHeaderCell write FOnCustomDrawGroupHeaderCell;
    property OnCustomDrawHeaderBackground
      : TcxPivotGridReportLinkCustomDrawHeaderBackgroundEvent
      read FOnCustomDrawHeaderBackground write FOnCustomDrawHeaderBackground;
    property OnCustomDrawPrefilter
      : TcxPivotGridReportLinkCustomDrawPrefilterEvent
      read FOnCustomDrawPrefilter write FOnCustomDrawPrefilter;
    property OnInitializeDataCell: TcxPivotGridReportLinkInitializeDataCellEvent
      read FOnInitializeDataCell write FOnInitializeDataCell;
    property OnInitializeFieldHeaderCell
      : TcxPivotGridReportLinkInitializeFieldHeaderCellEvent
      read FOnInitializeFieldHeaderCell write FOnInitializeFieldHeaderCell;
    property OnInitializeGroupHeaderCell
      : TcxPivotGridReportLinkInitializeGroupHeaderCellEvent
      read FOnInitializeGroupHeaderCell write FOnInitializeGroupHeaderCell;
    property OnInitializeHeaderBackground
      : TcxPivotGridReportLinkInitializeHeaderBackgroundEvent
      read FOnInitializeHeaderBackground write FOnInitializeHeaderBackground;
    property OnInitializePrefilter
      : TcxPivotGridReportLinkInitializePrefilterEvent
      read FOnInitializePrefilter write FOnInitializePrefilter;
  end;
  ...
  protected
    ...
    procedure UpdateEnabledControls(AControls: array of TControl;
      AEnabled: Boolean);
...
begin
  ...
  begin
    FDefaultdxPScxPivotGridLinkStyleSheet :=
      TcxPivotGridReportLinkStyleSheet.Create(nil);
    with FDefaultdxPScxPivotGridLinkStyleSheet.Styles as
      TcxPivotGridReportLinkStyles do
    begin
      ColumnHeader := CreateStyle(dxPSCore.dxDefaultFixedColor,
        dxPSCore.dxPSDefaultFontColor);
      FieldHeader := CreateStyle(dxPSCore.dxDefaultFixedColor,
        dxPSCore.dxPSDefaultFontColor);
      RowHeader := CreateStyle(dxPSCore.dxDefaultFixedColor,
        dxPSCore.dxPSDefaultFontColor);
      Content := CreateStyle(dxPSCore.dxDefaultFixedColor,
        dxPSCore.dxPSDefaultFontColor);
      HeaderBackground := CreateStyle(dxPSCore.dxDefaultFixedColor,
        dxPSCore.dxPSDefaultFontColor);
      Prefilter := CreateStyle(dxPSCore.dxDefaultFixedColor,
        dxPSCore.dxPSDefaultFontColor);
    end;
  end;
...
begin
  TcxPivotGridViewDataAccess(APivotGrid.ViewData).ExpandColumns :=
    AutoExpandColumns;
  TcxPivotGridViewDataAccess(APivotGrid.ViewData).ExpandRows := AutoExpandRows;
end;
...
procedure TcxPivotGridReportLinkOptionsView.SetBoolValue(var AField: Boolean;
  ANewValue: Boolean);
begin
...
procedure TcxPivotGridReportLinkOptionsView.SetPrefilter
...
procedure TcxPivotGridReportLinkStyles.AssignToPivot(AFromGrid,
  ADestGrid: TcxCustomPivotGrid; AUsePivotStyles: Boolean);
begin
  if (ADestGrid = nil) or (AFromGrid = nil) then
    Exit;
...
procedure TcxPivotGridReportLinkStyles.GetDefaultViewParams(Index: Integer;
  AData: TObject; out AParams: TcxViewParams);
begin
  inherited GetDefaultViewParams(Index, AData, AParams);
  if ReportLink <> nil then
  begin
    if Index in [vspsPGridColumnHeader, vspsPGridFieldHeader, vspsPGridRowHeader]
    then
...
begin
  if Source is TcxPivotGridReportLinkOptionsFormatting then
    SuppressContentColoration := TcxPivotGridReportLinkOptionsFormatting(Source)
...
begin
  ...
  begin
    FColumnHeaders := TcxPivotGridReportLinkOptionsOnEveryPage(Source)
      .ColumnHeaders;
...
function TcxPivotGridReportLinkOptionsOnEveryPage.GetReportLink
  : TcxPivotGridReportLink;
begin
  Result := inherited ReportLink as TcxPivotGridReportLink;
end;

procedure TcxPivotGridReportLinkOptionsOnEveryPage.SetColumnHeaders
  (AValue: Boolean);
begin
...
procedure TcxPivotGridReportLinkOptionsOnEveryPage.SetFilterBar
  (AValue: Boolean);
begin
...
procedure TcxPivotGridReportLinkOptionsOnEveryPage.SetRowHeaders
  (AValue: Boolean);
begin
...
class function TcxPivotGridReportLinkStyleSheet.GetStylesClass
  : TcxCustomStylesClass;
begin
  Result := TcxPivotGridReportLinkStyles;
end;

function TcxPivotGridReportLinkStyleSheet.GetStylesValue
  : TcxPivotGridReportLinkStyles;
begin
...
begin
  if Source is TcxPivotGridReportLink then
    FOptionsOnEveryPage.Assign(TcxPivotGridReportLink(Source)
      .OptionsOnEveryPage)
  else
    inherited Assign(Source);
end;
...
procedure TcxPivotGridReportLink.BuildReport;
  ...
  function CreateHostCell(AOwner: TdxReportCell; ANewHost: Boolean)
    : TdxReportCell;
  begin
...
begin
  ...
  FHostHeaderCell := CreateHostCell(ReportCells.HeaderCells,
    OptionsOnEveryPage.ColumnHeaders);
  ...
  FHostRowHeaderCell := CreateHostCell(ReportCells.RowHeaderCells,
    OptionsOnEveryPage.RowHeaders);
...
procedure TcxPivotGridReportLink.DoCustomDrawPrefilter(ACanvas: TCanvas;
...
procedure TcxPivotGridReportLink.DoInitializeHeaderBackground
  (AItem: TdxReportCell; ACell: TcxPivotGridHeaderBackgroundCellViewInfo);
begin
  if Assigned(FOnInitializeHeaderBackground) then
    FOnInitializeHeaderBackground(Self, ACell, AItem);
end;

procedure TcxPivotGridReportLink.DoInitializePrefilter
  (AItem: TdxReportCellString; ACell: TcxPivotGridPrefilterViewInfo);
begin
...
begin
  ...
  begin
    APSCell := CreateHeaderCell(HostHeaderCell, ACell,
      cxPivotGridFieldHeaderCellID);
    if not OptionsOnEveryPage.ColumnHeaders and OptionsOnEveryPage.RowHeaders
    then
      APSCell.Left := APSCell.Left + CellsOffset.X;
    DoInitializeFieldHeaderCell(APSCell, ACell);
  end
  else
    DoInitializeFieldHeaderCell(CreateHeaderCell(HostHeaderCornerCell, ACell,
      cxPivotGridFieldHeaderCellID), ACell)
end;

procedure TcxPivotGridReportLink.AddHeaderBackground
  (ACell: TcxPivotGridHeaderBackgroundCellViewInfo);
var
  AHost, ABackgroundCell: TdxReportCell;
const
  ABorders: array [TcxPivotGridFieldArea] of TdxCellSides = ([csTop, csBottom],
    [csLeft, csRight], [], [csTop, csLeft]);
begin
...
var
  ...
  AItem: TdxReportCell;
begin
  AItem := CreateHeaderCell(HostByArea[Area], ACell,
    cxPivotGridGroupHeaderCellID);
  R := cxRectOffset(AItem.AbsoluteRect, CellsOffset);
  if Area = faRow then
  begin
    if OptionsOnEveryPage.ColumnHeaders and not OptionsOnEveryPage.RowHeaders
    then
...
procedure TcxPivotGridReportLink.AddPrefilter
...
begin
  ...
  APSCell := APrefilterCell.AddDataItem
    (APSCellClass[ACell.Prefilter.Filter.IsEmpty]) as APSCellClass
    [ACell.Prefilter.Filter.IsEmpty];
...
begin
  ...
  begin
    APSCell := Result.AddDataItem
      (dxPSDataMaps.ItemClass(ACell.Properties, False));
  ...
  if ACell.HasButton and OptionsView.ExpandButtons and
    (ACell.Bounds.Right > ACell.ButtonRect.Right) then
  begin
    AButton := Result.AddDataItem(TdxReportCellExpandButton)
      as TdxReportCellExpandButton;
    ...
    AIndent.BoundsRect := Rect(0, 0, AButton.Left + AButton.Width +
      cxTextOffset, Result.Height);
...
begin
  ...
  if IsDrawHeaderCornersOnEveryPage then
    HostHeaderCornerCell.BoundsRect :=
      cxRect(cxNullPoint, ViewInfo.DataCellsBounds.TopLeft);
  ...
  for I := 0 to ViewInfo.CommonCells.Count - 1 do
    if (ViewInfo.CommonCells[I] is TcxPivotGridHeaderBackgroundCellViewInfo)
    then
      AddHeaderBackground(TcxPivotGridHeaderBackgroundCellViewInfo
        (ViewInfo.CommonCells[I]));
  for I := 0 to ViewInfo.RowHeaders.Count - 1 do
  begin
    AddHeaderCell(faRow, TcxPivotGridHeaderCellViewInfo
      (ViewInfo.RowHeaders[I]));
    DoProgress(100 * (AStart + I + 1) / ACount);
  end;
  Inc(AStart, ViewInfo.RowHeaders.Count);
  for I := 0 to ViewInfo.ColumnHeaders.Count - 1 do
  begin
    AddHeaderCell(faColumn, TcxPivotGridHeaderCellViewInfo
      (ViewInfo.ColumnHeaders[I]));
    DoProgress(100 * (AStart + I + 1) / ACount);
  end;
  Inc(AStart, ViewInfo.ColumnHeaders.Count);
  for I := 0 to ViewInfo.FieldHeaders.Count - 1 do
  begin
    AddFieldHeaderCell(TcxPivotGridFieldHeaderCellViewInfo
      (ViewInfo.FieldHeaders[I]));
    DoProgress(100 * (AStart + I + 1) / ACount);
  end;
...
procedure TcxPivotGridReportLink.SetCellViewParams(ACell: TdxReportVisualItem;
  const AParams: TcxViewParams);
var
...
procedure TcxPivotGridReportLink.SetCellViewParamsEx(ACell: TdxReportVisualItem;
  const AParams: TdxReportItemViewParams);
var
  AFont: TFont;
  AHasBitmap: Boolean;
begin
  ...
  try
    ...
    ACell.Transparent := OptionsFormatting.SuppressContentColoration or
      AParams.Transparent;
...
function TcxPivotGridReportLink.GetOptionsExpandingClass
  : TdxCustomReportLinkOptionsExpandingClass;
begin
  Result := TcxPivotGridReportLinkOptionsExpanding;
end;

function TcxPivotGridReportLink.GetOptionsFormattingClass
  : TdxCustomReportLinkOptionsFormattingClass;
begin
  Result := TcxPivotGridReportLinkOptionsFormatting;
end;

function TcxPivotGridReportLink.GetOptionsOnEveryPageClass
  : TcxPivotGridReportLinkOptionsOnEveryPageClass;
begin
  Result := TcxPivotGridReportLinkOptionsOnEveryPage;
end;

function TcxPivotGridReportLink.GetOptionsViewClass
...
function TcxPivotGridReportLink.GetStyleSheetClass
  : TdxCustomReportLinkStyleSheetClass;
begin
  Result := TcxPivotGridReportLinkStyleSheet;
end;

function TcxPivotGridReportLink.GetStyleSheetPrototype
...
function TcxPivotGridReportLink.IdxPSCellParams_GetCanvas
  : TdxPSReportRenderCustomCanvas;
begin
  Result := ScreenCanvas;
end;

function TcxPivotGridReportLink.
...
function TcxPivotGridReportLink.GetDesignWindow
...
function TcxPivotGridReportLink.GetHostByArea(Area: TcxPivotGridFieldArea)
  : TdxReportCell;
begin
  case Area of
    faRow:
...
function TcxPivotGridReportLink.GetOptionsExpanding
  : TcxPivotGridReportLinkOptionsExpanding;
begin
...
function TcxPivotGridReportLink.GetOptionsFormatting
  : TcxPivotGridReportLinkOptionsFormatting;
begin
...
function TcxPivotGridReportLink.GetOptionsOnEveryPage
  : TcxPivotGridReportLinkOptionsOnEveryPage;
begin
  Result := FOptionsOnEveryPage;
end;

function TcxPivotGridReportLink.GetOptionsView
  : TcxPivotGridReportLinkOptionsView;
begin
...
begin
  ...
  chbxColumnHeadersOnEveryPage.Checked :=
    ReportLink.OptionsOnEveryPage.ColumnHeaders;
...
procedure TcxfmPivotGridReportLinkDesignWindow.SaveSelectedStyles(AList: TList);
var
  I: Integer;
begin
  AList.Clear;
...
procedure TcxfmPivotGridReportLinkDesignWindow.UpdateEnabled(AControl: TControl;
  AEnabled: Boolean);
begin
  TControlAccess(AControl).Enabled := AEnabled;
end;

procedure TcxfmPivotGridReportLinkDesignWindow.UpdateEnabled(AItem: TMenuItem;
  AEnabled: Boolean);
begin
...
procedure TcxfmPivotGridReportLinkDesignWindow.DoFormActivated
  (AnActive: Boolean);
begin
  inherited;
  ...
  begin
    ...
    try
      ...
      try
        ...
        try
          Clear;
          AddObject(cxGetResourceString(@sdxPivotGridColumnHeader),
            Styles.ColumnHeader);
          AddObject(cxGetResourceString(@sdxPivotGridContent), Styles.Content);
          AddObject(cxGetResourceString(@sdxPivotGridFieldHeader),
            Styles.FieldHeader);
          AddObject(cxGetResourceString(@sdxPivotGridHeaderBackground),
            Styles.HeaderBackground);
          AddObject(cxGetResourceString(@sdxPivotGridPrefilter),
            Styles.Prefilter);
          AddObject(cxGetResourceString(@sdxPivotGridRowHeader),
            Styles.RowHeader);
        finally
          RestoreSelectedStyles(List);
        end;
...
procedure TcxfmPivotGridReportLinkDesignWindow.DoStyleChanged
...
procedure TcxfmPivotGridReportLinkDesignWindow.DoStylesChanged
...
procedure TcxfmPivotGridReportLinkDesignWindow.GetSelectedStyleNames
  (AStrings: TStrings);
var
  I: Integer;
begin
...
procedure TcxfmPivotGridReportLinkDesignWindow.GetStyleNames
  (out AStrings: TStrings);
begin
  AStrings := lbxStyles.Items;
end;

procedure TcxfmPivotGridReportLinkDesignWindow.GetStyleSheetNames
  (out AStrings: TStrings);
begin
...
begin
  ...
  chbxColumnHeadersOnEveryPage.Caption :=
    cxGetResourceString(@sdxColumnHeadersOnEveryPage);
  chbxRowHeadersOnEveryPage.Caption :=
    cxGetResourceString(@sdxRowHeadersOnEveryPage);
  ...
  cbxLookAndFeel.ItemIndex :=
    Integer(ReportLink.OptionsFormatting.LookAndFeelKind);
  ...
  chbxDisplayGraphicsAsText.Caption :=
    cxGetResourceString(@sdxDisplayGraphicsAsText);
  chbxDisplayTrackBarsAsText.Caption :=
    cxGetResourceString(@sdxDisplayTrackBarsAsText);
  ...
  chbxSuppressContentColoration.Caption :=
    cxGetResourceString(@sdxSuppressContentColoration);
  // styles
...
function TcxfmPivotGridReportLinkDesignWindow.
...
function TcxfmPivotGridReportLinkDesignWindow.GetReportLink
  : TcxPivotGridReportLink;
begin
...
begin
  ...
  case TControl(Sender).Tag of
    0:
      begin
        ReportLink.OptionsFormatting.UseNativeStyles :=
          chbxUseNativeStyles.Checked;
        RecreateStylesListBox;
      end;
    1:
      ReportLink.OptionsFormatting.SuppressBackgroundBitmaps :=
        chbxSuppressBackgroundBitmaps.Checked;
    2:
      ReportLink.OptionsFormatting.SuppressContentColoration :=
        chbxSuppressContentColoration.Checked;
    3:
      ReportLink.OptionsRefinements.TransparentGraphics :=
        chbxTransparentGraphics.Checked;
    4:
      ReportLink.OptionsRefinements.DisplayGraphicsAsText :=
        chbxDisplayGraphicsAsText.Checked;
    5:
      ReportLink.OptionsRefinements.FlatCheckMarks :=
        chbxFlatCheckMarks.Checked;
    6:
      ReportLink.OptionsRefinements.DisplayTrackBarsAsText :=
        chbxDisplayTrackBarsAsText.Checked;
  end;
  Modified := True;
  UpdatePreview;
end;

procedure TcxfmPivotGridReportLinkDesignWindow.btnStyleFontClick
  (Sender: TObject);
begin
  PerformStylesChangeFont;
end;

procedure TcxfmPivotGridReportLinkDesignWindow.btnStyleColorClick
  (Sender: TObject);
begin
  PerformStylesChangeColor;
end;

procedure TcxfmPivotGridReportLinkDesignWindow.btnStyleBackgroundBitmapClick
  (Sender: TObject);
begin
  PerformStylesChangeBitmap;
end;

procedure TcxfmPivotGridReportLinkDesignWindow.btnStyleClearClick
  (Sender: TObject);
begin
...
procedure TcxfmPivotGridReportLinkDesignWindow.btnStyleSheetNewClick
  (Sender: TObject);
begin
  PerformStyleSheetNew;
end;

procedure TcxfmPivotGridReportLinkDesignWindow.btnStyleSheetCopyClick
  (Sender: TObject);
begin
  PerformStyleSheetCopy;
end;

procedure TcxfmPivotGridReportLinkDesignWindow.btnStyleSheetDeleteClick
  (Sender: TObject);
begin
  PerformStyleSheetDelete;
end;

procedure TcxfmPivotGridReportLinkDesignWindow.btnStyleSheetRenameClick
  (Sender: TObject);
begin
...
procedure TcxfmPivotGridReportLinkDesignWindow.pmStylesPopup(Sender: TObject);
begin
  lbxStyles.HideToolTips;
...
procedure TcxfmPivotGridReportLinkDesignWindow.chbxOptionsViewClick
  (Sender: TObject);
const
  AVisible: array [Boolean] of TcxPivotGridPrefilterVisible = (pfvNever,
    pfvAlways);
begin
  if LockControlsUpdate then
    Exit;
      ...
      1, 2:
        begin
          if chbxHorizontalLines.Checked and chbxVerticalLines.Checked then
            GridLines := pglBoth
          else if chbxHorizontalLines.Checked then
            GridLines := pglHorz
          else if chbxVerticalLines.Checked then
            GridLines := pglVert
          else
            GridLines := pglNone;
        end;
...
begin
  dxPSRegisterReportLink(TcxPivotGridReportLink, TcxCustomPivotGrid,
    TcxfmPivotGridReportLinkDesignWindow);
end;

procedure UnregisterAssistants;
begin
  dxPSUnregisterReportLink(TcxPivotGridReportLink, TcxCustomPivotGrid,
    TcxfmPivotGridReportLinkDesignWindow);
end;
