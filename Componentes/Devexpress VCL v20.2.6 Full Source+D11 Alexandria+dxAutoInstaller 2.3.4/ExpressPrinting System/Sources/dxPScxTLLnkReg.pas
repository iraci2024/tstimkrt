...
type
  TcxTreeListReportLinkStyleSheetEditorPreview = class
...
constructor TcxTreeListReportLinkStyleSheetEditorPreview.Create
  (AOwner: TComponent);
begin
...
class function TcxTreeListReportLinkStyleSheetEditorPreview.GetStyleSheetClass
  : TcxCustomStyleSheetClass;
begin
  Result := TcxTreeListReportLinkStyleSheet;
end;

procedure TcxTreeListReportLinkStyleSheetEditorPreview.SetStyleSheet
...
const
  ...
  const
    BandCaptions: array [0 .. cBandCount - 1] of string =
      (sdxManufacturerBandCaption, sdxModelBandCaption);
  ...
  const
    ColumnBandIndexes: array [0 .. cColumnCount - 1] of Integer = (0,
      0, 1, 1, 1);
    ColumnCaptions: array [0 .. cColumnCount - 1] of string =
      (sdxManufacturerNameColumnCaption, sdxManufacturerLogoColumnCaption,
      sdxManufacturerCountryColumnCaption, sdxCarModelColumnCaption,
      sdxCarIsSUVColumnCaption);
    ...
    ColumnWidths: array [0 .. cColumnCount - 1] of Integer = (150, 150,
      0, 120, 80);
  var
    I: Integer;
  begin
    ...
    begin
      ...
      TcxImageProperties(Columns[1].Properties).GraphicTransparency :=
        gtTransparent;
  ...
  const
    ManufacturerNames: array [0 .. cNodeCount - 1] of string =
      (sdxCarManufacturerName5, sdxCarManufacturerName1,
      sdxCarManufacturerName2, sdxCarManufacturerName4);
    ManufacturerCountries: array [0 .. cNodeCount - 1] of string =
      (sdxCarManufacturerCountry5, sdxCarManufacturerCountry1,
      sdxCarManufacturerCountry2, sdxCarManufacturerCountry4);
    CarLogosIndexes: array [0 .. cNodeCount - 1] of Integer = (4, 0, 1, 3);
    CarModels: array [0 .. cNodeCount - 1] of string = (sdxCarModel5,
      sdxCarModel1, sdxCarModel2, sdxCarModel4);
    AreCarsSUV: array [0 .. cNodeCount - 1] of string = ('False', 'True',
      'True', 'True');
  var
    I: Integer;
  begin
    for I := 0 to cNodeCount - 1 do
      ...
      begin
        ...
        Values[1] := dxPScxCommon.dxPSPreviewCarLogosAsString
          (CarLogosIndexes[I]);
