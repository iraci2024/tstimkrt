...
type
  ...
  TcxPivotGridReportLinkStyleSheetEditorPreview = class
...
class function TcxPivotGridReportLinkStyleSheetEditorPreview.GetStyleSheetClass
...
begin
  ...
  RegisterClasses([TcxPivotGridReportLink, TcxPivotGridReportLinkStyles,
