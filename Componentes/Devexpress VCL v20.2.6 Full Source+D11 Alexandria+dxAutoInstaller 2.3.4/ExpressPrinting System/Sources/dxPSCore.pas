...
type
  ...
  TdxPreviewVisibleOption = (pvoHelp, pvoPageBackground, pvoPageSetup,
    ...
    pvoReportFileOperations, pvoPageMargins, pvoPrintDialog);
...
const
  ...
  dxDefaultPreviewVisibleOptions = [pvoPageBackground, pvoPageSetup,
    pvoPreferences, pvoPrint, pvoPrintDialog, pvoReportDesign, pvoPrintStyles,
...
type
  ...
  public
    constructor Create(AVersion: UINT;
      ADummy: Boolean = False { #AI: workaround for CBuilder } );
    //
  ...
  IdxPSExplorerContextCommandBuilder = interface
    ...
    procedure AddExplorerContextCommand
  ...
  TdxPSReportGroupLookAndFeelPainterClass = class of
  ...
  protected
    ...
    function CreatePrinterPage(ARenderInfo: TdxPSReportRenderInfo)
      : TdxPrinterPage; virtual;
    ...
    property IsEmptyPageCalculated: Boolean read FIsEmptyPageCalculated
      write FIsEmptyPageCalculated;
  public
    ContentBounds: TRect;
    DataOffset: TPoint;
    DetailBounds: TRect;
    ...
    constructor Create(ARenderInfo: TdxPSReportRenderInfo;
    ...
    property IndexPairs[Index: Integer]: TdxContinuedIndexPair read GetIndexPair
      write SetIndexPair;
  ...
  protected
    ...
    function CalculatePageDetailBounds(APageCol, APageRow: Integer)
      : TRect; virtual;
    ...
    function CreatePageRenderInfo(APageIndex: Integer)
      : TdxPSPageRenderInfo; virtual;
    ...
    function IsReportFitsToPages(APrinterPage: TdxPrinterPage)
      : Boolean; virtual;
  ...
  public
    ...
    function CalculateActualScaleFactor(AFitToPagesHorizontally,
      AFitToPagesVertically, AReportDPI: Integer): Integer; overload; virtual;
    function CalculateFootnotesHeight(AAdjustOnReportScale: Boolean): Integer;
      overload; virtual;
    function CalculateFootnotesHeight: Integer; overload;
    function CalculateTitleHeight(AAdjustOnReportScale: Boolean): Integer;
      overload; virtual;
    function CalculateTitleHeight: Integer; overload;
    function CalculateReportNotesTextHeight(const AText: string; AFont: TFont;
      AAdjustOnReportScale: Boolean): Integer; virtual;
    ...
    function GetCompositionInfo(APageIndex: Integer;
      out ARowInfo: TdxPSCompositionReportRenderRowInfo): Boolean; virtual;
    ...
    property BaseContentFont: TFont read FBaseContentFont
      write SetBaseContentFont;
    property BreakPagesByHardDelimiters: Boolean
      read GetBreakPagesByHardDelimiters;
    ...
    property FootnotesAdjustOnReportScale: Boolean
      read GetFootnotesAdjustOnReportScale;
    ...
    property PageRenderInfos[Index: Integer]: TdxPSPageRenderInfo
      read GetPageRenderInfo;
  ...
  TdxImageLayout = (ilImageTopLeft, ilImageTopCenter, ilImageTopRight,
...
{$ENDIF}
  ...
  TdxPSTreeLineMode = (tlmNone, tlmVertical, tlmCross, tlmTopRightCorner,
    tlmBottomRightCorner);
  ...
  protected
    class function GetBorderBounds(const R: TRect; ASide: TdxCellSide;
      ALineThickness: Integer): TRect; virtual;
    class function GetBottomShadowBounds(const R: TRect;
      AShadowDepth: Integer): TRect;
    class function GetBottomShadowRestSpaceBounds(const R: TRect;
      AShadowDepth: Integer): TRect;
    class function GetRightShadowBounds(const R: TRect;
      AShadowDepth: Integer): TRect;
    class function GetRightShadowRestSpaceBounds(const R: TRect;
      AShadowDepth: Integer): TRect;
    class procedure InflateRect(var R: TRect; ASides: TdxCellSides;
      ALineThickness: Integer);
  public
    constructor Create(ARenderer: TdxPSReportRenderer); virtual;

    procedure DrawBorders(ACanvas: TdxPSReportRenderCustomCanvas;
    ...
    class procedure DrawShadow(ACanvas: TdxPSReportRenderCustomCanvas;
      const R: TRect; AShadowDepth: Integer;
      AShadowColor, ARestSpaceColor: TColor);
  ...
  protected
    ...
    class function GetBorderEdgeSalient(ASide: TdxCellSide;
      ASalient: TdxPSCellBorderSalientType): Integer; virtual;
  ...
  public
    ...
    class procedure Draw3DFrame(ACanvas: TdxPSReportRenderCustomCanvas;
      R: TRect; ASides: TdxCellSides; AOuterTLColor, AOuterBRColor: TColor;
      AInnerTLColor, AInnerBRColor: TColor; ALineThickness: Integer);
      overload; virtual;
    class procedure Draw3DFrame(ACanvas: TdxPSReportRenderCustomCanvas;
      R: TRect; ASides: TdxCellSides; ACellBorders: TdxPSCell3DBorderClass;
  ...
  protected
    ...
    class function GetBorderEdgeSalient(ASide: TdxCellSide;
      ASalient: TdxPSCellBorderSalientType): Integer; override;
  ...
  public
    class procedure Draw3DFrame(ACanvas: TdxPSReportRenderCustomCanvas;
      R: TRect; ASides: TdxCellSides; ACellBorders: TdxPSCell3DBorderClass;
      ALineThickness: Integer); override;
    class procedure Draw3DFrame(ACanvas: TdxPSReportRenderCustomCanvas;
      R: TRect; ASides: TdxCellSides; AOuterTLColor, AOuterBRColor: TColor;
  ...
  public
    ...
    constructor Create(const AName: string; AColor: TColor; APitch: TFontPitch;
      AStyle: TFontStyles; AHeight, AFontPPI: Integer); overload;
    destructor Destroy; override;
  ...
  protected
    ...
    function CreateFont(const AName: string; AColor: TColor; APitch: TFontPitch;
      AStyle: TFontStyles; AHeight: Integer): Integer; overload;
  ...
  public
    ...
    function Add(const AName: string; AColor: TColor; APitch: TFontPitch;
      AStyle: TFontStyles; AHeight: Integer): Integer; overload;
    procedure Clear;
    function IndexOf(AFont: TFont): Integer; overload;
    function IndexOf(const AName: string; AColor: TColor; APitch: TFontPitch;
      AStyle: TFontStyles; AHeight: Integer): Integer; overload;
  ...
  public
    ...
    destructor Destroy; override;
    procedure Clear;
    procedure ValidateGraphicHelper(AGraphic: TGraphic;
      AImageList: TCustomImageList; AImageIndex: Integer;
      ABackgroundColor, ATransparentColor: TColor; AIsTransparent: Boolean);
  ...
  private
    ...
    function GetGroupLookAndFeelPainter(Index: Integer)
      : TdxPSReportGroupLookAndFeelPainter;
  ...
  protected
    ...
    procedure Get3DBorderBrushes(AnItem: TdxReportVisualItem;
      var AOuterTLBrush, AOuterBRBrush, AInnerTLBrush, AInnerBRBrush: HBRUSH);
    procedure Get3DBorderColors(AnItem: TdxReportVisualItem;
    ...
    function CreateBorderPainter(AClass: TdxPSCellBorderPainterClass)
      : TdxPSCellBorderPainter;
    function FindBorderPainter(AClass: TdxPSCellBorderPainterClass)
      : TdxPSCellBorderPainter;
    procedure FreeAndNilBorderPainters;

    function CreateReportGroupLookAndFeelPainter
      (AClass: TdxPSReportGroupLookAndFeelPainterClass)
      : TdxPSReportGroupLookAndFeelPainter;
    function FindReportGroupLookAndFeelPainter
      (AClass: TdxPSReportGroupLookAndFeelPainterClass)
      : TdxPSReportGroupLookAndFeelPainter;
    ...
    procedure RenderPageContentDetails(const ADetailsPosition: TPoint;
      out AOffset: Integer); virtual;
    procedure RenderPageContentFooter(ADetailsOffset: Integer); virtual;
    procedure RenderPageContentHeader(ACell: TdxReportCell; AAnchors: TAnchors;
      const R: TRect; const AOffset: TPoint); virtual;
    ...
    procedure RenderPageHeaderOrFooter(AHeaderOrFooter: TCustomdxPageObject;
    ...
    property BorderPainters[Index: Integer]: TdxPSCellBorderPainter
      read GetBorderPainterItem;
    ...
    property GroupLookAndFeelPainterCount: Integer
      read GetGroupLookAndFeelPainterCount;
    property GroupLookAndFeelPainters[Index: Integer]
      : TdxPSReportGroupLookAndFeelPainter read GetGroupLookAndFeelPainter;
  public
    constructor Create(AReportLink: TBasedxReportLink); virtual;
    destructor Destroy; override;
    ...
    function CalcTextLineCount(ACanvas: TdxPSReportRenderCustomCanvas;
      const AText: string; AFont: TFont = nil;
      ABaseWidth: Integer = -1): Integer;
    function CalcTextPatternHeight(ACanvas: TdxPSReportRenderCustomCanvas;
      AFont: TFont = nil): Integer;
    function CalcTextRect(ACanvas: TdxPSReportRenderCustomCanvas;
      const AText: string; var ARect: TRect; AWordBreak: Boolean;
      AFont: TFont = nil): Integer; overload;
    function CalcTextRect(ACanvas: TdxPSReportRenderCustomCanvas;
      const AText: string; var ARect: TRect; AFormat: DWORD; AFont: TFont = nil)
      : Integer; overload;
    ...
    procedure DrawCheckBox(ACanvas: TdxPSReportRenderCustomCanvas; var R: TRect;
      AChecked, AEnabled, AIsRadio: Boolean;
    ...
    procedure DrawEdge(ACanvas: TdxPSReportRenderCustomCanvas; var R: TRect;
      AEdgeMode: TdxCellEdgeMode; AEdge3DEdge: TdxCellEdgeStyle;
      ASides: TdxCellSides; ASoft: Boolean; ABorderColor: TColor = -1); virtual;
    ...
    procedure DrawExpandButton(ACanvas: TdxPSReportRenderCustomCanvas;
      var R: TRect; AExpanded, ADrawBorder, AEdge3D, AEdge3DSoft, AShadow,
      AFillInterior: Boolean; ABorderColor, AInteriorColor: TColor); virtual;
    procedure DrawGlyph(ACanvas: TdxPSReportRenderCustomCanvas; const R: TRect;
      AGlyph: Byte);
    ...
    procedure DrawGraphic(ACanvas: TdxPSReportRenderCustomCanvas; var R: TRect;
      const AClipRect: TRect; AImageList: TCustomImageList;
      AImageIndex: Integer; AGraphic: TGraphic;
    ...
    procedure DrawGraphicEx(ACanvas: TdxPSReportRenderCustomCanvas; R: TRect;
      ...
      ATransparentColor: TColor = clNone); virtual;
    ...
    procedure DrawText(ACanvas: TdxPSReportRenderCustomCanvas; var R: TRect;
      ...
      ATextAlignY: TcxTextAlignY; AFillBackground, AMultiline,
      AEndEllipsis: Boolean; APreventLeftTextExceed: Boolean = True;
    ...
    procedure DrawTextEx(ACanvas: TdxPSReportRenderCustomCanvas; var R: TRect;
      AMaxLineCount: Integer; const AText: string; AFont: TFont;
      AFormat: Cardinal; const AIndents: TRect;
      ALineSpacing: Single = 1.0); overload;
    function MakeTextFormat(ATextAlignX: TcxTextAlignX;
      ATextAlignY: TcxTextAlignY; AMultiline, AEndEllipsis,
      APreventLeftTextExceed, APreventTopTextExceed,
      AHidePrefix: Boolean): DWORD;
    ...
    procedure FillEllipseEx(ACanvas: TdxPSReportRenderCustomCanvas;
      const R: TRect; AForeColor, ABackColor: TColor;
      APattern: TdxPSFillPatternClass); virtual;
    procedure FillRect(ACanvas: TdxPSReportRenderCustomCanvas; const R: TRect;
      AColor: TColor); virtual;
    procedure FillRectByBrush(ACanvas: TdxPSReportRenderCustomCanvas;
      const R: TRect; ABrush: TBrush); virtual;
    ...
    procedure FillRoundRect(ACanvas: TdxPSReportRenderCustomCanvas;
      const R: TRect; AEllipseWidth, AEllipseHeight: Integer;
      AColor: TColor); virtual;
    procedure FillRoundRectEx(ACanvas: TdxPSReportRenderCustomCanvas;
      const R: TRect; AEllipseWidth, AEllipseHeight: Integer;
      AForeColor, ABackColor: TColor; APattern: TdxPSFillPatternClass); virtual;
    procedure FillRgn(ACanvas: TdxPSReportRenderCustomCanvas;
      Rgn: TcxRegionHandle; AColor: TColor); virtual;
    procedure FillRgnEx(ACanvas: TdxPSReportRenderCustomCanvas;
      Rgn: TcxRegionHandle; AForeColor, ABackColor: TColor;
      APattern: TdxPSFillPatternClass); virtual;
    ...
    procedure FrameRect(ACanvas: TdxPSReportRenderCustomCanvas; R: TRect;
      AColor: TColor; ASides: TdxCellSides = [csLeft .. csBottom];
    ...
    procedure Polyline(ACanvas: TdxPSReportRenderCustomCanvas;
      const APoints: array of TPoint; AColor: TColor;
      AThickness: Integer = 1); virtual;
    procedure Polygone(ACanvas: TdxPSReportRenderCustomCanvas;
      const APoints: array of TPoint; ABkColor, AFrameColor: TColor;
      AThickness: Integer = 1); virtual;

    function GetBorderPainter(AClass: TdxPSCellBorderPainterClass)
      : TdxPSCellBorderPainter;
    function GetBrushByColor(AColor: TColor): HBRUSH;
    function GetPatternBrush(APattern: TdxPSFillPatternClass;
      AColor: TColor): TBrush;
    function GetReportGroupLookAndFeelPainter
      (AClass: TdxPSReportGroupLookAndFeelPainterClass)
      : TdxPSReportGroupLookAndFeelPainter;
    ...
    procedure RenderPageEx(ACanvas: TdxPSReportRenderCustomCanvas;
      const APageBounds: TRect; APageIndex, AContinuousPageIndex,
      AZoomFactor: Integer); virtual;
  ...
  public
    ...
    procedure LoadFromIniFile(AIniFile: TCustomIniFile;
      const ASectionName: string); overload;
    procedure LoadFromIniFile(const AFileName: string); overload;
    procedure LoadFromRegistry(const APath: string);
    procedure SaveToIniFile(AIniFile: TCustomIniFile;
      const ASectionName: string); overload;
  ...
  published
    ...
    property CompressStreams: Boolean read FCompressStreams
      write FCompressStreams default False;
    property DefaultFileName: string read GetDefaultFileName
      write SetDefaultFileName stored GetDefaultFileNameIsStored;
    property DefaultFileNameAssigned: Boolean read FDefaultFileNameAssigned
      write FDefaultFileNameAssigned default False;
    ...
    property JPEGQuality: Integer read FJPEGQuality write FJPEGQuality
      default 90;
    property OpenDocumentAfterExport: Boolean read FOpenDocumentAfterExport
      write FOpenDocumentAfterExport default False;
    property SecurityOptions: TdxPSPDFSecurityOptions read FSecurityOptions
      write SetSecurityOptions;
    property SignatureOptions: TdxPSPDFSignatureOptions read FSignatureOptions
    ...
    property UseJPEGCompression: Boolean read FUseJPEGCompression
      write FUseJPEGCompression default True;
  end;
  ...
  public
    ...
    // GetPrevSibling conflicts with C++ macro
  ...
  protected
    ...
    function GetBackgroundBounds(ACanvas: TdxPSReportRenderCustomCanvas)
      : TRect; virtual;
    function GetBorderClass: TdxPSCellBorderClass; virtual;
    function GetBorderEdgeBounds(ASide: TdxCellSide; const AOuterRect: TRect)
      : TRect; virtual;
    function GetBorderEdgeClass(ASide: TdxCellSide)
      : TdxPSCellBorderClass; virtual;
    function GetBorderEdgeSalient(ASide: TdxCellSide;
      ASalient: TdxPSCellBorderSalientType): Integer; virtual;
    function GetBorderEdgeThickness(ASide: TdxCellSide): Integer; virtual;
    function GetBorderBounds(ACanvas: TdxPSReportRenderCustomCanvas)
      : TRect; virtual;

    function GetBorderOuterBoundsRelativeTo
      (ACanvas: TdxPSReportRenderCustomCanvas; const R: TRect): TRect;
    function GetInnerBoundsRelativeTo(ACanvas: TdxPSReportRenderCustomCanvas;
      const R: TRect): TRect;
    function GetOuterBoundsRelativeTo(ACanvas: TdxPSReportRenderCustomCanvas;
      const R: TRect): TRect;

    function GetBorderPainter: TdxPSCellBorderPainter;
    function GetBorderPainterClass: TdxPSCellBorderPainterClass; virtual;
    procedure InitBorderPainter(ABorderPainter
      : TdxPSCellBorderPainter); virtual;
    ...
    property BackgroundBitmapTileBounds[Col, Row: Integer]: TRect
      read GetBackgroundBitmapTileBounds;
    property BackgroundBitmapTileOrigin: TPoint
      read GetBackgroundBitmapTileOrigin;
    property BackgroundBitmapTileStartIndexX: Integer
      read GetBackgroundBitmapTileStartIndexX;
    property BackgroundBitmapTileStartIndexY: Integer
      read GetBackgroundBitmapTileStartIndexY;
    property BackgroundBitmapTileStopIndexX: Integer
      read GetBackgroundBitmapTileStopIndexX;
    property BackgroundBitmapTileStopIndexY: Integer
      read GetBackgroundBitmapTileStopIndexY;
  ...
  public
    ...
    procedure DrawBackground(ACanvas: TdxPSReportRenderCustomCanvas);
      overload; virtual;
    procedure DrawBackground(ACanvas: TdxPSReportRenderCustomCanvas;
      const R: TRect); overload; virtual;
    procedure DrawBackgroundBitmap(ACanvas: TdxPSReportRenderCustomCanvas;
      const R: TRect); virtual;
    procedure DrawBackgroundBitmapTile(ACanvas: TdxPSReportRenderCustomCanvas;
      const Rect: TRect); virtual;
    procedure DrawBackgroundRect(ACanvas: TdxPSReportRenderCustomCanvas;
      const R: TRect);
    procedure DrawBorders(ACanvas: TdxPSReportRenderCustomCanvas); virtual;

    function GetBorderOuterBounds(ACanvas: TdxPSReportRenderCustomCanvas)
      : TRect; virtual;
    function GetInnerBounds(ACanvas: TdxPSReportRenderCustomCanvas)
      : TRect; virtual;
    function GetOuterBounds(ACanvas: TdxPSReportRenderCustomCanvas)
      : TRect; virtual;
    procedure SetBounds(ALeft, ATop, AWidth, AHeight: Integer); virtual;

    function CalculateLineCount(ACanvas: TdxPSReportRenderCustomCanvas)
      : Integer; virtual;

    function MeasureBordersHeight(ACanvas: TdxPSReportRenderCustomCanvas)
      : Integer; virtual;
    function MeasureBordersWidth(ACanvas: TdxPSReportRenderCustomCanvas)
      : Integer; virtual;
    function MeasureContentHeight(ACanvas: TdxPSReportRenderCustomCanvas)
      : Integer; virtual;
    function MeasureContentWidth(ACanvas: TdxPSReportRenderCustomCanvas)
      : Integer; virtual;
    function MeasureFontHeight(ACanvas: TdxPSReportRenderCustomCanvas)
      : Integer; virtual;
    function MeasureHeight(ACanvas: TdxPSReportRenderCustomCanvas)
      : Integer; virtual;
    function MeasureWidth(ACanvas: TdxPSReportRenderCustomCanvas)
      : Integer; virtual;
    procedure Offset(AOffsetX, AOffsetY: Integer); virtual;

    // for backward compatibility
    class function MapBorderClass(AEdgeMode: TdxCellEdgeMode;
    ...
    property BackgroundBitmapIndex: Integer read FBackgroundBitmapIndex
      write SetBackgroundBitmapIndex;
    property BackgroundBitmapPool: TdxPSBackgroundBitmapPool
      read GetBackgroundBitmapPool;
    property BorderBrush: HBRUSH read GetBorderBrush;
    property BorderClass: TdxPSCellBorderClass read GetBorderClass
      write SetBorderClass;
    property BorderColor: TColor read GetBorderColor write FBorderColor;
    // clDefault;
    property BorderEdgeClasses[Side: TdxCellSide]: TdxPSCellBorderClass
      read GetBorderEdgeClass;
    property BorderEdgeSalients[Side: TdxCellSide;
      Salient: TdxPSCellBorderSalientType]: Integer read GetBorderEdgeSalient;
    property BorderEdgeThicknesses[Side: TdxCellSide]: Integer
      read GetBorderEdgeThickness;
    property BorderPainter: TdxPSCellBorderPainter read GetBorderPainter;
    property BorderPainterClass: TdxPSCellBorderPainterClass
      read GetBorderPainterClass;
    property Bottom: Integer read GetBottom write SetBottom;
    property BoundsRect: TRect read FBoundsRect write SetBoundsRect;
    property CellSideColors[ASide: TdxCellSide]: TColor read GetCellSideColors
      write SetCellSideColors;
    property CellSides: TdxCellSides read GetCellSides
      write SetCellSides; { csAll }
    property Color: TColor read FColor write SetColor;
    property ContentBkColor: TColor read GetContentBkColor
      write SetContentBkColor;
    property ContentBrush: HBRUSH read GetContentBrush;
    property ContentPattern: TdxPSFillPatternClass read GetContentPattern
      write SetContentPattern;
    property Edge3DSoft: Boolean read GetEdge3DSoft write SetEdge3DSoft;
    // obsolete - use BorderClass instead
    property Edge3DStyle: TdxCellEdgeStyle read GetEdge3DStyle
      write SetEdge3DStyle; // obsolete - use BorderClass instead
    property EdgeMode: TdxCellEdgeMode read GetEdgeMode write SetEdgeMode;
    // obsolete - use BorderClass instead
    property ExcludeFromClipRgn: Boolean read GetExcludeFromClipRgn
      write SetExcludeFromClipRgn;
  ...
  public
    ...
    procedure DrawContent(ACanvas: TdxPSReportRenderCustomCanvas;
      DrawRect: TRect; const OriginRect: TRect;
    ...
    procedure DrawNestedCells(ACanvas: TdxPSReportRenderCustomCanvas;
      ADrawRect: TRect; const AOriginRect: TRect;
      AStage: TdxPSRenderStages); virtual;
    ...
    function AddDataItem(AClass: TdxReportCellDataClass)
    ...
    function FindDataItemByData(const AData: Int64;
      var ADataItem: TAbstractdxReportCellData): Boolean;
    ...
    property DataItems[Index: Integer]: TAbstractdxReportCellData
      read GetDataItem;
  ...
  protected
    ...
    procedure Initialize(ALookAndFeel: TdxPSReportGroupLookAndFeel;
      AGroup: TdxReportGroup); virtual;
  ...
  protected
    procedure AdjustBorderOuterBounds(var R: TRect;
      AGroup: TdxReportGroup); virtual;
    procedure ConvertCoords(APixelsNumerator, APixelsDenominator
      : Integer); virtual;
    ...
    function GetBorderEdgeThickness(AGroup: TdxReportGroup; ASide: TdxCellSide)
      : Integer; virtual;
    ...
    function GetCaptionLeftRestSpaceBounds(AGroup: TdxReportGroup)
      : TRect; virtual;
    function GetCaptionRightRestSpaceBounds(AGroup: TdxReportGroup)
      : TRect; virtual;
    ...
    class function GetPainterClass
      : TdxPSReportGroupLookAndFeelPainterClass; virtual;

    property BorderThickness: Integer read GetBorderThickness
  ...
  public
    ...
    procedure Paint(ACanvas: TdxPSReportRenderCustomCanvas;
    ...
    property CaptionFontIndex: Integer read FCaptionFontIndex
      write SetCaptionFontIndex;
  ...
  TdxPSReportGroupNullLookAndFeelPainter = class
    (TdxPSReportGroupLookAndFeelPainter)
  public
  ...
  protected
    ...
    class function GetPainterClass
      : TdxPSReportGroupLookAndFeelPainterClass; override;
  public
  ...
  TdxPSReportGroupStandardLookAndFeelPainter = class
    (TdxPSReportGroupLookAndFeelPainter)
  protected
    procedure DrawBorders(ACanvas: TdxPSReportRenderCustomCanvas); override;
    procedure DrawCaptionRestSpace
      (ACanvas: TdxPSReportRenderCustomCanvas); virtual;
    function LookAndFeel: TdxPSReportGroupStandardLookAndFeel;
  ...
  TdxPSReportGroupPanelStyleLookAndFeel = class
    (TdxPSReportGroupStandardLookAndFeel)
  protected
    procedure AdjustBorderOuterBounds(var R: TRect;
      AGroup: TdxReportGroup); override;
    class function GetPainterClass
      : TdxPSReportGroupLookAndFeelPainterClass; override;
    function GetBorderEdgeThickness(AGroup: TdxReportGroup; ASide: TdxCellSide)
      : Integer; override;
  ...
  TdxPSReportGroupPanelStyleLookAndFeelPainter = class
    (TdxPSReportGroupStandardLookAndFeelPainter)
  public
    procedure Paint(ACanvas: TdxPSReportRenderCustomCanvas); override;
  end;
  ...
  public
    ...
    property CaptionFont;
    property CaptionSeparatorColor: TColor read GetCaptionSeparatorColor
      write FCaptionSeparatorColor;
    property CaptionSeparatorThickness: Integer read FCaptionSeparatorThickness
      write SetCaptionSeparatorThickness;
  end;

  { TdxPSReportGroupWebLookAndFeelPainter }

  TdxPSReportGroupWebLookAndFeelPainter = class
    (TdxPSReportGroupLookAndFeelPainter)
  protected
    procedure DrawBorders(ACanvas: TdxPSReportRenderCustomCanvas); override;
  ...
  public
    ...
    property CaptionAlignment: TcxTextAlignX read GetCaptionAlignment
      write SetCaptionAlignment;
    property CaptionText: string read FCaptionText write FCaptionText;
    property CaptionTransparent: Boolean read GetCaptionTransparent
      write SetCaptionTransparent;
    property CheckBoxVisible: Boolean read FCheckBoxVisible
      write FCheckBoxVisible;
    property CheckBoxChecked: Boolean read FCheckBoxChecked
      write FCheckBoxChecked;

    property LookAndFeel: TdxPSReportGroupLookAndFeel read GetLookAndFeel
      write SetLookAndFeel;
    property ShowCaption: Boolean read GetShowCaption write SetShowCaption;
    property UseOwnBorderClass: Boolean read GetUseOwnBorderClass
  ...
  protected
    ...
    procedure ConvertCoords(APixelsNumerator, APixelsDenominator
      : Integer); virtual;
    function GetCellTopLevelParent(AnItem: TdxReportItem)
      : TdxReportCell; virtual;
  ...
  public
    ...
    function CreateGroupLookAndFeel(AClass: TdxPSReportGroupLookAndFeelClass;
      ACheckExisting: Boolean = True): TdxPSReportGroupLookAndFeel;
    function FindGroupLookAndFeelByClass
      (AClass: TdxPSReportGroupLookAndFeelClass): TdxPSReportGroupLookAndFeel;
    function FindGroupLookAndFeelByData(AData: Pointer)
      : TdxPSReportGroupLookAndFeel;
    function IndexOfImageList(AnImageList: TCustomImageList): Integer;
    function IndexOfReportGroupLookAndFeel(ALookAndFeel
      : TdxPSReportGroupLookAndFeel): Integer;

    procedure DoProgress(const APercentDone: Double);

    function AddOverlay: TdxReportCell;
    procedure AppendOverlays(Source: TdxReportCells; AnOffsetX: Integer = 0;
      AnOffsetY: Integer = 0);
    procedure AssignOverlays(Source: TdxReportCells; AnOffsetX: Integer = 0;
      AnOffsetY: Integer = 0);
    ...
    property AreHeaderCornerCellsAllocated: Boolean
      read GetAreHeaderCornerCellsAllocated;
    property AreRowHeaderCellsAllocated: Boolean
      read GetAreRowHeaderCellsAllocated;
    property BorderColor: TColor read FBorderColor write SetBorderColor;
    property BorderWidth: Integer read FBorderWidth write FBorderWidth;
    property BoundsRect: TRect read GetBoundsRect;
    property Cells: TdxReportCell read FCells;
    property Count: Integer read GetCount;
    property ExpandButtonBorderColor: TColor read FExpandButtonBorderColor
      write FExpandButtonBorderColor default clBlack;
    ...
    property GroupBorderColor: TColor read FGroupBorderColor
      write FGroupBorderColor;
    property GroupCaptionColor: TColor read FGroupCaptionColor
      write FGroupCaptionColor;
    property GroupCaptionSeparatorColor: TColor read FGroupCaptionSeparatorColor
      write FGroupCaptionSeparatorColor;
    ...
    property LookAndFeel: TdxPSReportGroupLookAndFeel read FLookAndFeel
      write FLookAndFeel;
    property LookAndFeelCount: Integer read GetLookAndFeelCount;
    property LookAndFeels[Index: Integer]: TdxPSReportGroupLookAndFeel
      read GetLookAndFeel;
    property OverlayCount: Integer read GetOverlayCount;
    ...
    property TreeLineStyle: TdxPSTreeLineStyle read FTreeLineStyle
      write FTreeLineStyle default tlsDot;
  end;
  ...
  strict private
    ...
    //
    function HasPreventAutoIndentsProperty(const AVersion
      : TdxPSVersion): Boolean;
  protected
    function CustomDraw(ACanvas: TdxPSReportRenderCustomCanvas)
      : Boolean; virtual;
    ...
    property BreakByChars: Boolean read GetBreakByChars write SetBreakByChars
      default True;
    property EndEllipsis: Boolean read GetEndEllipsis write SetEndEllipsis
      default False;
    property HidePrefix: Boolean read GetHidePrefix write SetHidePrefix
      default False;
    ...
    property PreventAutoIndents: Boolean read FPreventAutoIndents
      write FPreventAutoIndents default False;
    property PreventLeftTextExceed: Boolean read GetPreventLeftTextExceed
      write SetPreventLeftTextExceed;
    property PreventTopTextExceed: Boolean read GetPreventTopTextExceed
      write SetPreventTopTextExceed;
    property SortOrder: TdxCellSortOrder read GetSortOrder write SetSortOrder
      default csoNone;
  ...
  protected
    ...
    procedure ConvertCoords(APixelsNumerator, APixelsDenominator
      : Integer); override;
    function GetSortMarkBounds(ACanvas: TdxPSReportRenderCustomCanvas)
      : TRect; virtual;
    function GetTextBounds(ACanvas: TdxPSReportRenderCustomCanvas)
      : TRect; virtual;
  ...
  public
    ...
    function MeasureFontHeight(ACanvas: TdxPSReportRenderCustomCanvas)
      : Integer; override;
    function MeasureTextHeight(ACanvas: TdxPSReportRenderCustomCanvas)
      : Integer; virtual;
    function MeasureTextWidth(ACanvas: TdxPSReportRenderCustomCanvas)
      : Integer; virtual;
  ...
  protected
    function GetImageAreaBounds(ACanvas: TdxPSReportRenderCustomCanvas)
      : TRect; virtual;
    function GetImageBounds(ACanvas: TdxPSReportRenderCustomCanvas)
      : TRect; virtual;
    ...
    property ImageTransparent: Boolean read GetImageTransparent
      write SetImageTransparent default True;
  public
    constructor Create(AParent: TdxReportCell); override;
    procedure Assign(Source: TPersistent); override;
    ...
    procedure DrawImageBackground
      (ACanvas: TdxPSReportRenderCustomCanvas); virtual;
    procedure DrawTextBackground(ACanvas
      : TdxPSReportRenderCustomCanvas); virtual;
  end;
  ...
  protected
    procedure ConvertCoords(APixelsNumerator: Integer;
      APixelsDenominator: Integer); override;
    function GetCheckBounds(ACanvas: TdxPSReportRenderCustomCanvas)
      : TRect; virtual;
    function GetImageAreaBounds(ACanvas: TdxPSReportRenderCustomCanvas)
      : TRect; override;
    function GetImageBounds(ACanvas: TdxPSReportRenderCustomCanvas)
    ...
    property BoldBorder: Boolean read GetBoldBorder write SetBoldBorder;
    // obsolete
    property FlatBorder: Boolean read GetFlatBorder write SetFlatBorder;
    // obsolete
  ...
  public
    ...
    property ButtonEdgeStyle: TdxCheckButtonEdgeStyle read GetButtonEdgeStyle
      write SetButtonEdgeStyle default cbesUltraFlat;
    property Checked: Boolean read GetChecked write SetChecked default False;
    property CheckPos: TdxCellCheckPos read GetCheckPos write SetCheckPos
      default ccpCenter;
  ...
  public
    ...
    property InterColumnsMinSpace: Integer read FInterColumnsMinSpace
      write SetInterColumnsMinSpace;
    property InterRowsMinSpace: Integer read FInterRowsMinSpace
      write SetInterRowsMinSpace;
  ...
  public
    ...
    property ItemsChecked[Index: Integer]: Boolean read GetItemChecked
      write SetItemChecked;
    property ItemsEnabled[Index: Integer]: Boolean read GetItemEnabled
  ...
  protected
    ...
    property ActualImageBuffering: TdxCellImageActualBuffering
      read GetActualImageBuffering;
    property ImageBuffering: TdxCellImageBuffering read GetImageBuffering
      write SetImageBuffering;
  ...
  public
    ...
    property ImageTransparentColor: TColor read FImageTransparentColor
      write FImageTransparentColor;
    property OverlayImageIndex: Integer read FOverlayImageIndex
      write FOverlayImageIndex;
  end;
  ...
  public
    ...
    property ImageLayout: TdxImageLayout read GetImageLayout
      write SetImageLayout default ilImageCenterLeft;
    property ImageTransparent;
    property IsTextDrawnForCenteredImage: Boolean
      read GetIsTextDrawnForCenteredImage write SetIsTextDrawnForCenteredImage
      default False;
    property IsTextShiftedForHorizontallyCenteredImage: Boolean
      read GetIsTextShiftedForHorizontallyCenteredImage
      write SetIsTextShiftedForHorizontallyCenteredImage default True;
    property MakeSpaceForEmptyImage: Boolean read GetMakeSpaceForEmptyImage
      write SetMakeSpaceForEmptyImage default True;
  end;
  ...
  public
    ...
    property DrawMode: TdxGraphicDrawMode read GetDrawMode write SetDrawMode
      default gdmNone;
  ...
  public
    constructor Create(AParent: TdxReportCell); override;
    //
    property ImageSourceDPI: Integer read FImageSourceDPI
      write SetImageSourceDPI;
  end;
  ...
  protected
    ...
    procedure SetButtonAlignHorz
      (Value: TdxReportCellExpandButtonAlignHorz); virtual;
    procedure SetButtonAlignVert
      (Value: TdxReportCellExpandButtonAlignVert); virtual;
  ...
  public
    ...
    function GetButtonBounds(ACanvas: TdxPSReportRenderCustomCanvas)
      : TRect; virtual;

    property ActualButtonSize: Integer read GetActualButtonSize;
    property ButtonAlignHorz: TdxReportCellExpandButtonAlignHorz
      read GetButtonAlignHorz write SetButtonAlignHorz default bahCenter;
    property ButtonAlignVert: TdxReportCellExpandButtonAlignVert
      read GetButtonAlignVert write SetButtonAlignVert default bavCenter;
    property ButtonBorder3D: Boolean read GetButtonBorder3D
      write SetButtonBorder3D default False;
    property ButtonBorder3DSoft: Boolean read GetButtonBorder3DSoft
      write SetButtonBorder3DSoft default False;
    property ButtonBorderShadow: Boolean read GetButtonBorderShadow
      write SetButtonBorderShadow default False;
    property ButtonExpanded: Boolean read GetButtonExpanded
      write SetButtonExpanded default False;
    property ButtonIndents: TRect read GetButtonIndents;
    property ButtonInteriorColor: TColor read FButtonInteriorColor
      write FButtonInteriorColor default clNone;
    ...
    property ButtonTransparent: Boolean read GetButtonTransparent
      write SetButtonTransparent default True;
    property KeepOddSize: Boolean read GetKeepOddSize write SetKeepOddSize
      default True;
    property ShowButton: Boolean read GetShowButton write SetShowButton
      default False;
    property ShowButtonBorder: Boolean read GetShowButtonBorder
      write SetShowButtonBorder default True;
    property TreeLineMode: TdxPSTreeLineMode read GetTreeLineMode
      write SetTreeLineMode default tlmNone;
  end;
  ...
  protected
    ...
    procedure SetButtonAlignHorz
      (Value: TdxReportCellExpandButtonAlignHorz); override;
    procedure SetButtonAlignVert
      (Value: TdxReportCellExpandButtonAlignVert); override;
  ...
  protected
    procedure ExplorerRefresh(AStage: TdxPSExplorerRefreshStage);
      virtual; abstract;
    ...
    procedure ItemParentChanged(AnItem: TCustomdxPSExplorerItem);
      virtual; abstract;
    procedure ItemPropertiesChanged(AnItem: TCustomdxPSExplorerItem);
      virtual; abstract;
  ...
  protected
    ...
    procedure ItemRenamed(AnItem: TCustomdxPSExplorerItem); override;
  public
    constructor Create(ATreeContainer: TCustomdxPSExplorerTreeContainer;
      ARegister: Boolean = True);
    property TreeContainer: TCustomdxPSExplorerTreeContainer
      read FTreeContainer;
  end;

  TCustomdxPSExplorerTreeContainerClass = class of
  ...
  protected
    ...
    procedure AddItem(AParent: TdxPSExplorerFolder;
      AnItem: TCustomdxPSExplorerItem); virtual; abstract;
    ...
    procedure SetSelectedItem(Value: TCustomdxPSExplorerItem); virtual;
      abstract;
    ...
    property ChangeNotifier: TdxPSExplorerTreeChangeNotifier
      read FChangeNotifier;
    property Host: IdxPSExplorerTreeContainerHost read FHost;
  public
    constructor Create(AnExplorer: TCustomdxPSExplorer;
      AHost: IdxPSExplorerTreeContainerHost); virtual;
    destructor Destroy; override;
    ...
    procedure CollapseItem(AnItem: TCustomdxPSExplorerItem;
      ARecursive: Boolean = False); virtual; abstract;
    procedure ExpandItem(AnItem: TCustomdxPSExplorerItem;
      ARecursive: Boolean = False); virtual; abstract;
    procedure ItemDataLoaded(AnItem: TCustomdxPSExplorerItem); virtual;
      abstract;
    procedure ItemDataUnloaded(AnItem: TCustomdxPSExplorerItem);
      virtual; abstract;
    procedure MakeItemVisible(AnItem: TCustomdxPSExplorerItem);
      virtual; abstract;
    ...
    function GetDropTarget(X, Y: Integer): TdxPSExplorerFolder;
      virtual; abstract;
    function GetItemAt(X, Y: Integer): TCustomdxPSExplorerItem;
      virtual; abstract;
    ...
    property FocusedItem: TCustomdxPSExplorerItem read GetFocusedItem
    ...
    property SelectedItem: TCustomdxPSExplorerItem read GetSelectedItem
      write SetSelectedItem;
    property SelectedItemText: string read GetSelectedItemText
      write SetSelectedItemText;
  end;
  ...
  protected
    ...
    class procedure CreateFolderNode(ATreeContainer
      : TCustomdxPSExplorerTreeContainer;
      AParent, AFolder: TdxPSExplorerFolder); virtual;
    class procedure CreateItemNode(ATreeContainer
      : TCustomdxPSExplorerTreeContainer; AParent: TdxPSExplorerFolder;
      AnItem: TCustomdxPSExplorerItem); virtual;
    class procedure PopulateTreeFolder(ATreeContainer
      : TCustomdxPSExplorerTreeContainer;
  ...
  TCustomdxPSExplorerItemPropertySheetsClass = class of
    TCustomdxPSExplorerItemPropertySheets;
  ...
  public
    class function GetHasChildren(AFolder: TdxPSExplorerFolder)
      : Boolean; virtual;
    class function GetImageIndex(AnItem: TCustomdxPSExplorerItem)
      : Integer; virtual;
    class function GetSelectedIndex(AnItem: TCustomdxPSExplorerItem)
      : Integer; virtual;
    class procedure SetHasChildren(AFolder: TdxPSExplorerFolder;
  ...
  public
    constructor Create(AnExplorer: TCustomdxPSExplorer;
      AParent: TdxPSExplorerFolder); virtual;
    destructor Destroy; override;
    ...
    function CanMoveTo(AParent: TCustomdxPSExplorerItem): Boolean;
      overload; virtual;
    ...
    // returns Length of needed memory
    ...
    class function PropertySheetsClass
      : TCustomdxPSExplorerItemPropertySheetsClass; virtual;
    function ShowPropertySheets: Boolean;

    function CannotRenameMessageText(const AOldName, ANewName: string)
      : string; virtual;
    function DeleteMessageText: string; virtual;
    function OverwriteMessageText(Dest: TCustomdxPSExplorerItem)
      : string; virtual;
  ...
  private
    ...
    function GetItemList(AnItemClass: TCustomdxPSExplorerItemClass)
      : TList; overload;
  ...
  public
    constructor Create(AnExplorer: TCustomdxPSExplorer;
      AParent: TdxPSExplorerFolder); override;
    destructor Destroy; override;
    ...
    function CreateItem(AReportLink: TBasedxReportLink)
      : TdxPSExplorerItem; virtual;
    procedure Populate;
    ...
    property Folders[Index: Integer]: TdxPSExplorerFolder
      read GetFolder; default;
  ...
  public
    ...
    class function PropertySheetsClass
      : TCustomdxPSExplorerItemPropertySheetsClass; override;

    property HasInvalidData: Boolean read FHasInvalidData
      write SetHasInvalidData;
  ...
  TCustomdxPSExplorerContextCommandClass = class of
  ...
  TdxPSExplorerContextCommandSeparator = class
    (TCustomdxPSExplorerContextCommand)
  public
  ...
  TdxPSExplorerState = (esItemCreating, esFolderCreating, esLoading,
    esRefreshing);
  ...
  TCustomdxPSExplorer = class(TComponent, IdxPSExplorerContextCommands,
  ...
  protected
    ...
    procedure BuildCommandSet(ABuilder
      : IdxPSExplorerContextCommandBuilder); virtual;
    { IdxPSExplorerContextCommands2 }
    procedure FinalizeCommand(ACommand
      : TCustomdxPSExplorerContextCommand); virtual;
    procedure InitializeCommand(ACommand
      : TCustomdxPSExplorerContextCommand); virtual;

    function AddCommand(ACommandClass: TCustomdxPSExplorerContextCommandClass)
      : TCustomdxPSExplorerContextCommand;
    function AddCommandSeparator: TdxPSExplorerContextCommandSeparator;
    procedure ClearCommands;
    function CreateCommand(ACommandClass
      : TCustomdxPSExplorerContextCommandClass)
      : TCustomdxPSExplorerContextCommand;
    function CreateCommandSeparator: TdxPSExplorerContextCommandSeparator;
    function FindCommand(ACommandClass: TCustomdxPSExplorerContextCommandClass)
      : TCustomdxPSExplorerContextCommand;
    procedure FreeAndNilCommands;

    class function AcceptItemNameChar(AnItem: TCustomdxPSExplorerItem; Ch: Char)
      : Boolean; virtual;
    function CreateItemDataStream(AnItem: TdxPSExplorerItem;
      AMode: TdxPSStreamMode): TStream; virtual; abstract;
    ...
    function CanMoveTo(AnItem, AParent: TCustomdxPSExplorerItem)
      : Boolean; virtual;
    function CanRename(AnItem: TCustomdxPSExplorerItem): Boolean; virtual;
    function CanRenameTo(AnItem: TCustomdxPSExplorerItem; const AName: string)
      : Boolean; virtual;
    procedure Delete(AnItem: TCustomdxPSExplorerItem); virtual;
    procedure MoveTo(AnItem: TCustomdxPSExplorerItem;
      AParent: TdxPSExplorerFolder); virtual;
    ...
    procedure PopulateTreeFolder(ATreeContainer
      : TCustomdxPSExplorerTreeContainer; AFolder: TdxPSExplorerFolder);
    ...
    property Commands[Index: Integer]: TCustomdxPSExplorerContextCommand
      read GetCommand;
    property NotifierCount: Integer read GetNotifierCount;
    property Notifiers[Index: Integer]: TdxPSExplorerChangeNotifier
      read GetNotifier;
  public
    ...
    function CanCreateFolder: Boolean; virtual;
    function CanCreateItem: Boolean; virtual;
    function CreateNewFolder(AParent: TdxPSExplorerFolder)
      : TdxPSExplorerFolder; virtual;
    function CreateNewItem(AParent: TdxPSExplorerFolder;
      AReportLink: TBasedxReportLink): TdxPSExplorerItem; virtual;

    procedure BuildTree(ATreeContainer: TCustomdxPSExplorerTreeContainer);
    function CreateTree(const AHost: IdxPSExplorerTreeContainerHost)
      : TCustomdxPSExplorerTreeContainer;

    function FindCustomItemByUniqueID(const AnUniqueID: TBytes)
      : TCustomdxPSExplorerItem; virtual;
    procedure LoadItemData(AnItem: TdxPSExplorerItem;
      AReportLink: TBasedxReportLink); overload;
    ...
    property ActiveFolder: TdxPSExplorerFolder read FActiveFolder
      write FActiveFolder;
    property FilterLinkClass: TComponentClass read FFilterLinkClass
      write FFilterLinkClass;
    property FilterLinkClassName: string read FFilterLinkClassName
      write FFilterLinkClassName;
  ...
  published
    ...
    property OnItemDataLoadError: TdxPSExplorerItemDataLoadErrorEvent
      read FOnItemDataLoadError write FOnItemDataLoadError;
  end;
  ...
  public
    ...
    //
    property AdjustOnReportScale: Boolean read FAdjustOnReportScale
      write SetAdjustOnReportScale default False;
    property Color: TColor read FColor write FColor default clWhite;
    property Font: TFont read FFont write SetFont stored IsFontStored;
    property ReportLink: TBasedxReportLink read FReportLink;
    property Text: string read FText write SetText;
    property TextAlignX: TcxTextAlignX read FTextAlignX write SetTextAlignX
      default taCenterX;
    property TextAlignY: TcxTextAlignY read FTextAlignY write SetTextAlignY
      default taCenterY;
  ...
  published
    ...
    property Color;
    property Font;
    property Mode: TdxReportTitleMode read FMode write SetMode
      default tmOnEveryTopPage;
    property Text;
    property TextAlignX;
    property TextAlignY;
  ...
  published
    ...
    property Color;
    property Font;
    property Mode: TdxReportFootnoteMode read FMode write SetMode
      default fnmOnEveryBottomPage;
    property Text;
    property TextAlignX;
    property TextAlignY;
    property Transparent;
  ...
  public
    ...
    procedure WriteData(AWriter: TdxPSDataWriter); virtual;
    //
    property Information: Longint read FTableInfo.Information
      write FTableInfo.Information;
    property Document: Longint read FTableInfo.Document
      write FTableInfo.Document;
    ...
    property Footnotes: Longint read FTableInfo.Footnotes
      write FTableInfo.Footnotes;
    property Reserved1: Longint read FTableInfo.Reserved1
      write FTableInfo.Reserved1;
    property Reserved2: Longint read FTableInfo.Reserved2
      write FTableInfo.Reserved2;
    property Reserved3: Longint read FTableInfo.Reserved3
      write FTableInfo.Reserved3;
  end;

  TdxPSDataStorageOffsetTableClass = class of TdxPSDataStorageOffsetTable;
  PdxPSDataStorageOffsetTable = TdxPSDataStorageOffsetTable;
  // for backward compatibility
  ...
  TdxReportLinkCapability = (rlcPageSetup, rlcHeaderFooter, rlcTitle,
    rlcFootnotes, rlcExportToPDF);
  ...
  TdxPSGetNewReportStorageNameEvent = procedure(Sender: TBasedxReportLink;
  ...
  protected
    ...
    function IsHeaderOrFooterCustomDrawn(AHFObject
      : TCustomdxPageObject): Boolean;
    ...
    procedure ReadData(AReader: TdxPSDataReader); virtual;
    class function ReadOffsetTable(AReader: TdxPSDataReader)
      : TdxPSDataStorageOffsetTable; virtual;
    class procedure ReadReportDocument(AReader: TdxPSDataReader;
      AReportDocument: TdxPSReportDocument); virtual;
    class function ReadStorageInfo(AReader: TdxPSDataReader)
      : TdxPSDataStorageInfo; virtual;
    class procedure SkipStorageInfo(AReader: TdxPSDataReader);
    procedure WriteData(AWriter: TdxPSDataWriter); virtual;
    class procedure WriteOffsetTable(AWriter: TdxPSDataWriter;
      AnOffsetTable: TdxPSDataStorageOffsetTable); virtual;
    class procedure WriteReportDocument(AWriter: TdxPSDataWriter;
      AReportDocument: TdxPSReportDocument); virtual;
    class procedure WriteStorageInfo(AWriter: TdxPSDataWriter;
      AStorageInfo: TdxPSDataStorageInfo); virtual;
    ...
    function DoBeforeExportToPDF(const AFileName: string;
      AOptions: TdxPSPDFReportExportOptions): Boolean; dynamic;
    ...
    function GetRebuildOnPageParamsChange(AUpdateCodes
      : TdxPrinterPageUpdateCodes): Boolean; virtual;
    ...
    function IsSupportedCustomDraw(Item: TAbstractdxReportCellData)
      : Boolean; virtual;
    ...
    procedure MakeHardDelimiters(AReportCells: TdxReportCells;
      AHorzDelimiters, AVertDelimiters: TList); virtual;
    procedure PageParamsChanged(Sender: TdxPrinterPage;
      AStyle: TBasedxPrintStyle;
      AUpdateCodes: TdxPrinterPageUpdateCodes); virtual;
    function PossibleCustomDraw(AnItem: TAbstractdxReportCellData)
      : Boolean; virtual;
    procedure PrepareReportGroupsLookAndFeels;
    procedure RetrievePageAsImage(APageIndex: Integer;
      AGraphicClass: TGraphicClass; AGraphic: TGraphic);
    procedure RetrievePageAsImageCallBack(AComponentPrinter
      : TCustomdxComponentPrinter; AReportLink: TBasedxReportLink;
    ...
    procedure DoCustomDrawEntirePage(ACanvas: TCanvas; R: TRect;
      ARealPageIndex: Integer); virtual;
    ...
    function IsComposable(AComposition: TdxCompositionReportLink)
      : Boolean; virtual;
    ...
    property AllowContinuousPageIndexes: Boolean
      read GetAllowContinuousPageIndexes;
    property AlwaysBufferedGraphics: Boolean read GetAlwaysBufferedGraphics;
    property BackgroundBitmapPool: TdxPSBackgroundBitmapPool
      read FBackgroundBitmapPool;
    property BreakPagesByHardDelimiters: Boolean
      read GetBreakPagesByHardDelimiters;
    property Color: TColor read FColor write SetColor default clWhite;
    property ContinuousPageIndexes: Boolean read GetContinuousPageIndexes
      write SetContinuousPageIndexes default False;
    property DataStream: TStream read FDataStream;
    property Font: TFont read FFont write SetFont stored IsFontStored;
    property FontPool: TdxPSReportFontPool read GetFontPool;
    property FootersOnEveryPage: Boolean read FFootersOnEveryPage
      write SetFootersOnEveryPage default False;
    property HeadersOnEveryPage: Boolean read FHeadersOnEveryPage
      write SetHeadersOnEveryPage default False;
    property InternalStreaming: Boolean read FInternalStreaming
      write FInternalStreaming;
    property IsBuilding: Boolean read GetIsBuilding;
    property IsInvalidReport: Boolean read FIsInvalidReport;
    ...
    property UseHardHorzDelimiters: Boolean read GetUseHardHorzDelimiters;
    property UseHardVertDelimiters: Boolean read GetUseHardVertDelimiters;
    property UseHorzDelimiters: Boolean read FUseHorzDelimiters
      write SetUseHorzDelimiters default True;
    property UseVertDelimiters: Boolean read FUseVertDelimiters
      write SetUseVertDelimiters default True;
  ...
  public
    ...
    procedure LoadFromIniFile(AIniFile: TCustomIniFile; const ASection: string);
      overload; virtual;
    procedure LoadFromIniFile(const AFileName: string); overload;
    procedure LoadFromRegistry(const APath: string);
    procedure SaveToIniFile(AIniFile: TCustomIniFile; const ASection: string);
      overload; virtual;
    procedure SaveToIniFile(const AFileName: string); overload;
    procedure SaveToRegistry(const APath: string);

    class function Aggregable: Boolean; virtual;
    class function CanBeUsedAsStub: Boolean; virtual;
    // when data loaded from external storage
    class function Serializable: Boolean; virtual;
    ...
    procedure GetPageColRowCount(out APageColCount, APageRowCount
      : Integer); virtual;
    procedure Initialize; virtual;
    ...
    class function IsSupportedCompClass(AComponentClass: TClass)
      : Boolean; virtual;
    class function LinkClass: TdxReportLinkClass;
    class function Supports(AnObject: TObject { TComponent } )
      : Boolean; overload;
    class function Supports(AClass: TClass): Boolean; overload;

    function Print(AShowDialog: Boolean): Boolean; overload;
    function Print(AShowDialog: Boolean; APrintDialogData: PdxPrintDlgData)
      : Boolean; overload;
    ...
    class function ExtractComponentClass(AStream: TStream;
      ARaiseException: Boolean = False): TComponentClass;
    class function ExtractComponentClassName(AStream: TStream;
      ARaiseException: Boolean = False): string;
    class function ExtractLinkClass(AStream: TStream;
      ARaiseException: Boolean = False): TdxReportLinkClass;
    class function ExtractOffsetTable(AStream: TStream;
      ARaiseException: Boolean = False): TdxPSDataStorageOffsetTable;
    class function ExtractReportDocument(AStream: TStream;
      ARaiseException: Boolean = False): TdxPSReportDocument;
    class function ExtractStorageInfo(AStream: TStream;
      ARaiseException: Boolean = False): TdxPSDataStorageInfo;
    class function ExtractStorageVersion(AStream: TStream;
      ARaiseException: Boolean = False): Integer;
    class procedure FinalizeStorageInfo(var AStorageInfo: TdxPSDataStorageInfo);
    class function PossibleDataStorage(AStream: TStream;
      ARaiseException: Boolean = False): Boolean; overload;
    class function PossibleDataStorage(const AFileName: string;
      ARaiseException: Boolean = False): Boolean; overload;

    function AddBackgroundBitmapToPool(ABitmap: TGraphic): Integer;
    function AddFontToPool(AFont: TFont): Integer; overload;
    function AddFontToPool(const AName: string; AColor: TColor;
      APitch: TFontPitch; AStyle: TFontStyles; ASize: Integer)
      : Integer; overload;
    ...
    procedure DrawCheckBox(Canvas: TCanvas; var R: TRect;
    ...
    procedure DrawGraphicEx(Canvas: TCanvas; var R: TRect;
    ...
    procedure DrawSortMark(Canvas: TCanvas; var R: TRect;
      SortOrder: TdxCellSortOrder; Mono: Boolean); virtual;
    procedure DrawText(Canvas: TCanvas; var R: TRect; AIndent: Integer;
      const Text: string; Font: TFont; BkColor: TColor;
      TextAlignX: TcxTextAlignX; TextAlignY: TcxTextAlignY;
      FillBackground, Multiline, EndEllipsis: Boolean); virtual;
    procedure DrawTextEx(Canvas: TCanvas; var R: TRect; MaxLineCount: Integer;
      ...
      PreventTopTextExceed: Boolean); virtual;
    procedure FillEllipse(Canvas: TCanvas; const R: TRect;
      Color: TColor); virtual;
    procedure FillEllipseEx(Canvas: TCanvas; const R: TRect;
      ForeColor, BkColor: TColor; Pattern: TdxPSFillPatternClass); virtual;
    procedure FillRectEx(Canvas: TCanvas; const R: TRect;
      ForeColor, BkColor: TColor; Pattern: TdxPSFillPatternClass); virtual;
    procedure FillRoundRect(Canvas: TCanvas; const R: TRect;
      CornerWidth, CornerHeight: Integer; Color: TColor); virtual;
    procedure FillRoundRectEx(Canvas: TCanvas; const R: TRect;
      CornerWidth, CornerHeight: Integer; ForeColor, BkColor: TColor;
      Pattern: TdxPSFillPatternClass); virtual;
    procedure FillRgnEx(Canvas: TCanvas; Rgn: TcxRegionHandle;
      ForeColor, BkColor: TColor; Pattern: TdxPSFillPatternClass); virtual;
    procedure FrameEllipse(Canvas: TCanvas; R: TRect; Color: TColor;
      Thickness: Integer = 1);
    procedure FrameRect(Canvas: TCanvas; R: TRect; Color: TColor;
      Sides: TdxCellSides = [csLeft .. csBottom]; Thickness: Integer = 1);
    procedure FrameRoundRect(Canvas: TCanvas; R: TRect;
      CornerWidth, CornerHeight: Integer; Color: TColor;
      Thickness: Integer = 1); virtual;

    property AbortBuilding: Boolean read GetAbortBuilding
      write SetAbortBuilding;
    ...
    property Data: Pointer read FData write FData;
    property DataSource: TdxReportLinkDataSource read FDataSource
      write SetDataSource;
    ...
    property RealPrinterPage: TdxPrinterPage read GetRealPrinterPage
      write SetRealPrinterPage;
  ...
  published
    ...
    property DateFormat: Integer read getDateFormat write SetDateFormat
      stored IsDateFormatStored;
    property DateTime: TDateTime read GetDateTime write SetDateTime
      stored False;
    property DesignerCaption: string read GetDesignerCaption
      write SetDesignerCaption stored IsDesignerCaptionStored;
    property DesignerHelpContext: THelpContext read FDesignerHelpContext
      write FDesignerHelpContext default 0;
    property Index: Integer read GetIndex write SetIndex stored False;
    property IsCurrentLink: Boolean read GetIsCurrentLink write SetIsCurrentLink
      stored False;
    property PageNumberFormat: TdxPageNumberFormat read GetPageNumberFormat
      write SetPageNumberFormat stored IsPageNumberFormatStored;
    property PDFExportOptions: TdxPSPDFReportExportOptions
      read FPDFExportOptions write SetPDFExportOptions;
    property PrinterPage: TdxPrinterPage read GetPrinterPage
      write SetPrinterPage;
    property ReportDocument: TdxPSReportDocument read FReportDocument
      write SetReportDocument;
    property ReportFootnotes: TdxReportFootnotes read FReportFootnotes
      write SetReportFootnotes;
    property ReportTitle: TdxReportTitle read FReportTitle write SetReportTitle;
    property ReportTitleMode: TdxReportTitleMode read GetReportTitleMode
      write SetReportTitleMode stored False default tmOnEveryTopPage;
    property ReportTitleText: string read GetReportTitleText
      write SetReportTitleText stored False;
    property ShowDesigner: Boolean read FShowDesigner write FShowDesigner
      stored False;
    property ShowPageFooter: Boolean read GetShowPageFooter
      write SetShowPageFooter default True;
    property ShowPageHeader: Boolean read GetShowPageHeader
      write SetShowPageHeader default True;
    property ShowPageRowHeader: Boolean read GetShowPageRowHeader
      write SetShowPageRowHeader default True;
    property ShrinkToPageWidth: Boolean read GetShrinkToPageWidth
      write SetShrinkToPageWidth default False;
    property StartPageIndex: Integer read GetStartPageIndex
      write SetStartPageIndex default 1;
    ...
    property StyleManager: TdxPrintStyleManager read FStyleManager
      write SetStyleManager;
    property TimeFormat: Integer read getTimeFormat write SetTimeFormat
      stored IsTimeFormatStored;
    property AssignedFormatValues: TdxAssignedFormatValues
      read FAssignedFormatValues write SetAssignedFormatValues stored False;
    // must be last

    property OnChangeComponent: TNotifyEvent read FOnChangeComponent
      write FOnChangeComponent;
    property OnCustomDrawPageFooter: TdxCustomDrawReportLinkHFEvent
      read FOnCustomDrawPageFooter write FOnCustomDrawPageFooter;
    property OnCustomDrawPageHeader: TdxCustomDrawReportLinkHFEvent
      read FOnCustomDrawPageHeader write FOnCustomDrawPageHeader;
    property OnCustomDrawReportLinkFootnotes: TdxCustomDrawReportLinkTitleEvent
      read FOnCustomDrawReportLinkFootnotes
      write FOnCustomDrawReportLinkFootnotes;
    property OnCustomDrawReportLinkTitle: TdxCustomDrawReportLinkTitleEvent
      read FOnCustomDrawReportLinkTitle write FOnCustomDrawReportLinkTitle;
    property OnDataSourceChanged: TNotifyEvent read FOnDataSourceChanged
      write FOnDataSourceChanged;
    property OnDestroy: TNotifyEvent read FOnDestroy write FOnDestroy;
    property OnFilterStyle: TdxFilterStyleEvent read FOnFilterStyle
      write FOnFilterStyle;
    property OnGetNewReportStorageName: TdxPSGetNewReportStorageNameEvent
      read FOnGetNewReportStorageName write FOnGetNewReportStorageName;
    property OnMeasureReportLinkFootnotes: TdxMeasureReportLinkTitleEvent
      read FOnMeasureReportLinkFootnotes write FOnMeasureReportLinkFootnotes;
    property OnMeasureReportLinkTitle: TdxMeasureReportLinkTitleEvent
      read FOnMeasureReportLinkTitle write FOnMeasureReportLinkTitle;
  end;
  ...
  public
    ...
    // returns first entry for AReportLink in Items
    function IsLinkComposable(AReportLink: TBasedxReportLink): Boolean;
    function LinkExists(AReportLink: TBasedxReportLink): Boolean;
    function NextAssignedItem(AnItem: TdxCompositionLinkItem)
      : TdxCompositionLinkItem;
    function NonBuiltInsExists: Boolean;
    function PrevAssignedItem(AnItem: TdxCompositionLinkItem)
      : TdxCompositionLinkItem;
  ...
  private
    ...
    function GetRenderInfo: TdxPSReportRenderInfo;
  protected
    procedure CalculateContentInfo(AReportLink: TBasedxReportLink;
      out AOffset, AHeight: Integer); virtual;
  public
    constructor Create(AItem: TdxCompositionLinkItem;
      APageIndex, APageAbsoluteIndex: Integer); virtual;
    destructor Destroy; override;
    function CalculateContentAreaHeight(AReportLink: TBasedxReportLink)
      : Integer;
    ...
    //
    property ComposedLinks[Index: Integer]: TBasedxReportLink
      read GetComposedLink;
  ...
  public
    ...
    destructor Destroy; override;
    function FindRowInfo(AAbsolutePageIndex: Integer;
      out ARowInfo: TdxPSCompositionReportRenderRowInfo): Boolean; overload;
    function FindRowInfo(AReportLink: TBasedxReportLink; APageIndex: Integer;
      out ARowInfo: TdxPSCompositionReportRenderRowInfo): Boolean; overload;
    function GetCompositionInfo(APageIndex: Integer;
      out ARowInfo: TdxPSCompositionReportRenderRowInfo): Boolean; override;

    property ReportLink: TdxCompositionReportLink read GetReportLink;
    property RowInfo[Index: Integer]: TdxPSCompositionReportRenderRowInfo
      read GetRowInfo;
  ...
  protected
    ...
    function GetRebuildOnPageParamsChange(AUpdateCodes
      : TdxPrinterPageUpdateCodes): Boolean; override;
  ...
  public
    ...
    property ReportDocument: TdxPSReportCompositionDocument
      read GetReportDocument write SetReportDocument;
  published
    property ContinuousPageIndexes default True;
    property DesignerOptions: TdxCompositionOptions read FDesignerOptions
      write FDesignerOptions default [coCanEdit, coShowDescription];
    property Items: TdxCompositionLinkItems read FItems write SetItems;
    property StartEachItemFromNewPage: Boolean read FStartEachItemFromNewPage
      write SetStartEachItemFromNewPage default True;

    property OnAfterBuildReport: TdxCompositionReportLinkEvent
      read FOnAfterBuildReport write FOnAfterBuildReport;
    property OnBeforeBuildReport: TdxCompositionReportLinkEvent
      read FOnBeforeBuildReport write FOnBeforeBuildReport;
  end;
  ...
  published
    property OnAfterGenerating: TNotifyEvent read FOnAfterGenerating
      write FOnAfterGenerating;
    property OnAfterPrinting: TNotifyEvent read FOnAfterPrinting
      write FOnAfterPrinting;
    property OnBeforeGenerating: TNotifyEvent read FOnBeforeGenerating
      write FOnBeforeGenerating;
    property OnBeforePrinting: TNotifyEvent read FOnBeforePrinting
      write FOnBeforePrinting;
  end;
  ...
  published
    property Font: TFont read FFont write SetFont stored IsFontStored;
    property ShowPageNumbers: Boolean read FShowPageNumbers
      write SetShowPageNumbers default True;
  end;
  ...
  protected
    function CreateThumbnailsOptions
      : TdxComponentPrinterThumbnailsOptions; virtual;
  ...
  public
    ...
    destructor Destroy; override;
  published
    property EnableOptions: TdxPreviewEnableOptions read FEnableOptions
      write SetEnableOptions default dxDefaultPreviewEnableOptions;
    property SaveZoomPosition: Boolean read FSaveZoomPosition
      write FSaveZoomPosition default True;
    property ShowExplorer: Boolean read FShowExplorer write SetShowExplorer
      default False;
    property ThumbnailsOptions: TdxComponentPrinterThumbnailsOptions
      read FThumbnailsOptions write SetThumbnailsOptions;
    property VisibleOptions: TdxPreviewVisibleOptions read FVisibleOptions
      write SetVisibleOptions default dxDefaultPreviewVisibleOptions;
  end;

  { TdxPreviewWindowThumbnailsOptions }

  TdxPreviewWindowThumbnailsOptions = class
    (TdxComponentPrinterThumbnailsOptions)
  strict private
  ...
  protected
    function CreateThumbnailsOptions
      : TdxComponentPrinterThumbnailsOptions; override;
  published
    property ThumbnailsOptions: TdxPreviewWindowThumbnailsOptions
      read GetThumbnailsOptions write SetThumbnailsOptions;
  end;
...
{$IFDEF OLEDRAGANDDROP}
    ...
    function IDropTarget_DragEnter(const DataObj: IDataObject;
...
{$ENDIF}
    procedure AddExplorerContextCommand
      (ACommand: TCustomdxPSExplorerContextCommand); virtual; abstract;
    ...
    procedure PaintPage(Sender: TObject; ACanvas: TCanvas; ARect: TRect;
      APageIndex: Integer); virtual;
    procedure PaintThumbnailPage(Sender: TObject; ACanvas: TCanvas;
      ARect: TRect; APageIndex: Integer); virtual;
...
{$ENDIF}
  ...
  public
    ...
    procedure LoadFromIniFile(AIniFile: TCustomIniFile;
      const ASectionName: string); overload; virtual;
    procedure LoadFromIniFile(const AFileName: string); overload;
    procedure LoadFromRegistry(const APath: string);
    procedure SaveToIniFile(AIniFile: TCustomIniFile;
      const ASectionName: string); overload; virtual;
    ...
    property ComponentPrinter: TCustomdxComponentPrinter read FComponentPrinter
      write SetComponentPrinter;
    property ExplorerTree: TCustomdxPSExplorerTreeContainer
      read GetExplorerTree;
    property HFEditPart: TdxPageTitlePart read GetHFEditPart
      write SetHFEditPart;
  ...
  published
    ...
    property Left: Integer index 1 read GetPosition write SetPosition
      stored False;
    property Top: Integer index 2 read GetPosition write SetPosition
      stored False;
    property Width: Integer index 3 read GetPosition write SetPosition
      stored False;
    property Height: Integer index 0 read GetPosition write SetPosition
      stored False;
  ...
  TdxBeforeDesignReportEvent = procedure(Sender: TObject;
    AReportLink: TBasedxReportLink;
    ADesignWindow: TAbstractdxReportLinkDesignWindow) of object;

  TdxCustomDrawPageEvent = procedure(Sender: TObject;
    AReportLink: TBasedxReportLink; ACanvas: TCanvas; APageIndex: Integer;
    ARect: TRect; ANom, ADenom: Integer) of object;

  TdxCustomDrawReportTitleEvent = procedure(Sender: TObject;
    AReportLink: TBasedxReportLink; ACanvas: TCanvas; ARect: TRect;
    ANom, ADenom: Integer; var TextAlignX: TcxTextAlignX;
    var TextAlignY: TcxTextAlignY; var AColor: TColor; AFont: TFont;
    var ADone: Boolean) of object;

  TdxCustomDrawPageHFEvent = procedure(Sender: TObject;
    AReportLink: TBasedxReportLink; ACanvas: TCanvas; APageIndex: Integer;
    var ARect: TRect; ANom, ADenom: Integer;
    var ADefaultDrawText, ADefaultDrawBackground: Boolean) of object;

  TdxDesignReportEvent = procedure(Sender: TObject;
    AReportLink: TBasedxReportLink; var ADone: Boolean) of object;

  TdxGenerateReportProgressEvent = procedure(Sender: TObject;
    AReportLink: TBasedxReportLink; APercentDone: Double { '##0.00' } )
    of object;

  TdxGetPrintTitleEvent = procedure(Sender: TObject;
    AReportLink: TBasedxReportLink; var ATitle: string) of object;

  TdxPrintDlgDataEvent = procedure(Sender: TObject;
    AReportLink: TBasedxReportLink; var APrintDlgData: TdxPrintDlgData)
    of object;

  TdxMeasureReportTitleEvent = procedure(Sender: TObject;
    AReportLink: TBasedxReportLink; var AHeight: Integer) of object;
  ...
  TdxPreviewEvent = procedure(Sender: TObject; AReportLink: TBasedxReportLink)
    of object;

  TdxPrintDeviceProblemEvent = procedure(Sender: TObject; var ADone: Boolean)
    of object;

  TdxReportLinkBeforeExportToPDFEvent = procedure(Sender: TObject;
    AReportLink: TBasedxReportLink; const AFileName: string;
    AOptions: TdxPSPDFReportExportOptions; var AAllow: Boolean) of object;
  TdxReportLinkNotifyEvent = procedure(Sender: TObject;
    AReportLink: TBasedxReportLink) of object;

  TdxStartPrintEvent = procedure(Sender: TObject;
    AReportLink: TBasedxReportLink; APageCount: Integer) of object;
  ...
  TdxCPState = (cpsBuilding, cpsDesigning, cpsPreviewing, cpsPrinting,
    cpsPrintDialog, cpsPageSetupDialog, cpsDefineStylesDialog, cpsCustomizing,
    cpsLoading, cpsSaving, cpsExplore);
  TdxCPStates = set of TdxCPState;

  TdxPSBuildStage = (bsStart, bsProgress, bsEnd);
  TdxPSPrintStage = (psStart, psProgress, psEnd);

  TdxPSComponentPrinterExplorerChangeNotifier = class
  ...
  public
    ...
    property PageIndexesAsString: string read GetPageIndexesAsString
      write SetPageIndexesAsString;
  ...
  private
    ...
    function BeginPrintPages(const Source: string;
      out APageIndexes: TdxPSPageIndexes): Boolean;
    ...
    procedure FinalizeDefaultPrintDlgData(AReportLink: TBasedxReportLink;
      var APrintDlgData: TdxPrintDlgData); virtual;
    ...
    function CreateLink(ALinkClass: TdxReportLinkClass; AComponent: TComponent;
  ...
  protected
    ...
    function DoBeforeExportToPDF(AReportLink: TBasedxReportLink;
      const AFileName: string; AOptions: TdxPSPDFReportExportOptions)
      : Boolean; dynamic;
    ...
    procedure DoCustomDrawEntirePage(AReportLink: TBasedxReportLink;
      ACanvas: TCanvas; APageIndex: Integer; ARect: TRect;
      ANom, ADenom: Integer); virtual;
    procedure DoCustomDrawPageHeaderOrFooter(AReportLink: TBasedxReportLink;
      AHFObject: TCustomdxPageObject; ACanvas: TCanvas; APageIndex: Integer;
      R: TRect; var ADefaultDrawText, ADefaultDrawBackground: Boolean;
      APixelsNumerator: Integer = 0); virtual;
    procedure DoCustomDrawReportFootnotes(AReportLink: TBasedxReportLink;
    ...
    procedure DoCustomDrawReportTitle(AReportLink: TBasedxReportLink;
      ACanvas: TCanvas; ARect: TRect; var ATextAlignX: TcxTextAlignX;
      var ATextAlignY: TcxTextAlignY; var AColor: TColor; AFont: TFont;
      var ADone: Boolean; APixelsNumerator: Integer = 0); virtual;
    procedure DoDeleteReportLink(AReportLink: TBasedxReportLink); dynamic;
    procedure DoDesignReport(AReportLink: TBasedxReportLink;
      ADone: Boolean); dynamic;
    procedure DoEndPrint(AReportLink: TBasedxReportLink); dynamic;
    procedure DoFinalizePrintDlgData(AReportLink: TBasedxReportLink;
      var APrintDlgData: TdxPrintDlgData); dynamic;
    procedure DoInitializePrintDlgData(AReportLink: TBasedxReportLink;
      var APrintDlgData: TdxPrintDlgData); dynamic;
    procedure DoMeasureReportFootnotes(AReportLink: TBasedxReportLink;
      var AHeight: Integer); virtual;
    procedure DoMeasureReportTitle(AReportLink: TBasedxReportLink;
      var AHeight: Integer); virtual;
    procedure DoNewPage(AReportLink: TBasedxReportLink;
    ...
    procedure DoPageSetup(AReportLink: TBasedxReportLink;
      ADone: Boolean); dynamic;
    procedure DoPrintDeviceBusy; dynamic;
    procedure DoPrintDeviceError; dynamic;
    procedure DoProgress(AReportLink: TBasedxReportLink;
      const PercentDone: Double); dynamic;
    procedure DoStartPrint(AReportLink: TBasedxReportLink;
      FullPageCount: Integer); dynamic;
    ...
    procedure InitializeDefaultPrintDlgData(AReportLink: TBasedxReportLink;
    ...
    procedure PaintPageCore(ACanvas: TCanvas; APageIndex: Integer;
      AZoomFactor: Integer; const APageBounds, AContentBounds: TRect;
    ...
    procedure PaintThumbnailPage(ACanvas: TCanvas; APageIndex: Integer;
      ...
      const APageBounds, AContentBounds: TRect;
      AReportLink: TBasedxReportLink = nil);
    function PrintPagesAsStringEx(const APages: string;
      APageNums: TdxPageNumbers; ACopyCount: Integer; ACollate: Boolean;
    ...
    procedure PrintPage(AReportLink: TBasedxReportLink;
      APageIndex: Integer); virtual;
    procedure UnprepareBuildReport(AReportLink: TBasedxReportLink);
    procedure UnprepareLongOperation;
    ...
    property ExplorerChangeNotifier: TdxPSComponentPrinterExplorerChangeNotifier
      read FExplorerChangeNotifier;
    property Listeners: TdxComponentPrinterListeners read FListeners;
    property PreviewCaption: string read GetPreviewCaption;

    property OnAfterPreview: TdxPreviewEvent read FOnAfterPreview
      write FOnAfterPreview;
    property OnBeforeDesignReport: TdxBeforeDesignReportEvent
      read FOnBeforeDesignReport write FOnBeforeDesignReport;
    property OnBeforeExportToPDF: TdxReportLinkBeforeExportToPDFEvent
      read FOnBeforeExportToPDF write FOnBeforeExportToPDF;
    property OnBeforePreview: TdxPreviewEvent read FOnBeforePreview
      write FOnBeforePreview;
    property OnChangeComponent: TdxReportLinkNotifyEvent read FOnChangeComponent
      write FOnChangeComponent;
    property OnChangeCurrentLink: TNotifyEvent read FOnChangeCurrentLink
      write FOnChangeCurrentLink;
    property OnCustomDrawPageFooter: TdxCustomDrawPageHFEvent
      read FOnCustomDrawPageFooter write FOnCustomDrawPageFooter;
    property OnCustomDrawPageHeader: TdxCustomDrawPageHFEvent
      read FOnCustomDrawPageHeader write FOnCustomDrawPageHeader;
    property OnCustomDrawReportFootnotes: TdxCustomDrawReportTitleEvent
      read FOnCustomDrawReportFootnotes write FOnCustomDrawReportFootnotes;
    property OnCustomDrawReportTitle: TdxCustomDrawReportTitleEvent
      read FOnCustomDrawReportTitle write FOnCustomDrawReportTitle;
    property OnDesignReport: TdxDesignReportEvent read FOnDesignReport
      write FOnDesignReport;
    property OnMeasureReportFootnotes: TdxMeasureReportTitleEvent
      read FOnMeasureReportFootnotes write FOnMeasureReportFootnotes;
    property OnMeasureReportTitle: TdxMeasureReportTitleEvent
      read FOnMeasureReportTitle write FOnMeasureReportTitle;
  public
    constructor Create(AOwner: TComponent); override;
    destructor Destroy; override;
    procedure AfterConstruction; override;
    ...
    function AddEmptyLinkEx(ALinkClass: TdxReportLinkClass; AOwner: TComponent)
      : TBasedxReportLink;
    function AddLink(AComponent: TComponent): TBasedxReportLink;
    function AddLinkEx(AComponent: TComponent; AOwner: TComponent)
      : TBasedxReportLink;
    ...
    function FindLinkByComponent(Value: TComponent; ACanCreate: Boolean = False)
      : TBasedxReportLink;
    ...
    class function IsSupportedCompClass(AComponentClass: TClass)
      : Boolean; overload;
    class function IsSupportedCompClass(AComponent: TObject { TComponent } )
      : Boolean; overload;

    { composition support }
    function CurrentCompositionByLink(AReportLink: TBasedxReportLink)
      : TdxCompositionReportLink;
    procedure GetCompositionsByLink(AReportLink: TBasedxReportLink;
      ACompositions: TList);
    procedure GetItems(AComposition: TdxCompositionReportLink;
      AStrings: TStrings; AExcludeAssigned: Boolean);
    function IsLinkInComposition(AReportLink: TBasedxReportLink;
      AComposition: TdxCompositionReportLink): Boolean;
    function IsLinkInCurrentComposition(AReportLink: TBasedxReportLink)
      : Boolean;
    ...
    procedure ExportToPDF(const AFileName: string;
      ...
      AReportLink: TBasedxReportLink = nil); overload;
    ...
    procedure DrawPageFooter(AReportLink: TBasedxReportLink;
      APageIndex: Integer; ARect: TRect; ATitleParts: TdxPageTitleParts;
      ADrawBackground: Boolean);
    procedure DrawPageHeader(AReportLink: TBasedxReportLink;
      APageIndex: Integer; ARect: TRect; ATitleParts: TdxPageTitleParts;
      ADrawBackground: Boolean);

    procedure GetPageColRowCount(out ACol, ARow: Integer;
      AReportLink: TBasedxReportLink = nil);
    ...
    function PageSetupEx(AActivePageIndex: Integer;
      ...
      AReportLink: TBasedxReportLink = nil): Boolean; overload;

    procedure PaintPage(ACanvas: TCanvas; APageIndex: Integer;
      const APageBounds, AContentBounds: TRect;
      AReportLink: TBasedxReportLink = nil);

    procedure Preview(AModal: Boolean = True;
      AReportLink: TBasedxReportLink = nil);
    function PreviewExists: Boolean;
    ...
    function Print(AShowDialog: Boolean; APrintDialogData: PdxPrintDlgData;
      AReportLink: TBasedxReportLink = nil): Boolean;
    procedure PrintEx(APageNums: TdxPageNumbers; ACopies: Integer;
      ACollate: Boolean; AReportLink: TBasedxReportLink = nil);
    procedure PrintPages(const APageIndexes: TdxPSPageIndexes;
      AReportLink: TBasedxReportLink = nil);
    procedure PrintPagesEx(const APageIndexes: TdxPSPageIndexes;
      APageNums: TdxPageNumbers; ACopyCount: Integer; ACollate: Boolean;
    ...
    property AutoUpdateDateTime: Boolean read FAutoUpdateDateTime
      write SetAutoUpdateDateTime default True;
    property BeepAfterLongOperations: Boolean read FBeepAfterLongOperations
      write FBeepAfterLongOperations default True;
    property CurrentLink: TBasedxReportLink read FCurrentLink
      write SetCurrentLink;
    property CurrentLinkIndex: Integer read GetCurrentLinkIndex
      write SetCurrentLinkIndex;
    property DateFormat: Integer read FDateFormat write SetDateFormat default 0;
    property Explorer: TCustomdxPSExplorer read FExplorer write SetExplorer;
    property ExplorerRealStubLink: TBasedxReportLink
      read GetExplorerRealStubLink;
    property ExplorerStubLink: TBasedxReportLink read FExplorerStubLink
      write SetExplorerStubLink;
    property IsExplorerMode: Boolean read GetIsExplorerMode;
    property LinkCount: Integer read GetLinkCount;
    property LongOperationTime: Integer read FLongOperationTime
      write SetLongOperationTime default 5000; { ms }
    property Options: TdxCPOptions read FOptions write FOptions
      default [Low(TdxCPOption) .. High(TdxCPOption)]; { dxDefaultCPOptions }
    property PageNumberFormat: TdxPageNumberFormat read FPageNumberFormat
      write SetPageNumberFormat default pnfNumeral;
    ...
    property ReportLink[Index: Integer]: TBasedxReportLink read GetReportLink
      write SetReportLink; default;
    ...
    property PreviewWindowDesigner: TAbstractdxPreviewWindowDesigner
      read FPreviewWindowDesigner;
    property ReportLinkDesigner: TAbstractdxReportLinkDesigner
      read FReportLinkDesigner;

    property OnAddReportLink: TdxReportLinkNotifyEvent read FOnAddReportLink
      write FOnAddReportLink;
    property OnCustomDrawPage: TdxCustomDrawPageEvent read FOnCustomDrawPage
      write FOnCustomDrawPage;
    property OnDeleteReportLink: TdxReportLinkNotifyEvent
      read FOnDeleteReportLink write FOnDeleteReportLink;
    property OnEndGenerateReport: TdxReportLinkNotifyEvent
      read FOnEndGenerateReport write FOnEndGenerateReport;
    property OnEndPrint: TdxReportLinkNotifyEvent read FOnEndPrint
      write FOnEndPrint;
    property OnFinalizePrintDlgData: TdxPrintDlgDataEvent
      read FOnFinalizePrintDlgData write FOnFinalizePrintDlgData;
    ...
    property OnGetPrintTitle: TdxGetPrintTitleEvent read FOnGetPrintTitle
      write FOnGetPrintTitle;
    property OnInitializePrintDlgData: TdxPrintDlgDataEvent
      read FOnInitializePrintDlgData write FOnInitializePrintDlgData;
    property OnNewPage: TdxNewPageEvent read FOnNewPage write FOnNewPage;
    property OnPageSetup: TdxPageSetupEvent read FOnPageSetup
      write FOnPageSetup;
    property OnPrintDeviceBusy: TdxPrintDeviceProblemEvent
      read FOnPrintDeviceBusy write FOnPrintDeviceBusy;
    property OnPrintDeviceError: TdxPrintDeviceProblemEvent
      read FOnPrintDeviceError write FOnPrintDeviceError;
    property OnStartGenerateReport: TdxReportLinkNotifyEvent
      read FOnStartGenerateReport write FOnStartGenerateReport;
    property OnStartPrint: TdxStartPrintEvent read FOnStartPrint
      write FOnStartPrint;
  end;

  TdxEnumPagesAsImagesProc = procedure(AComponentPrinter
    : TCustomdxComponentPrinter; AReportLink: TBasedxReportLink;
    AIndex, APageIndex: Integer; const AGraphic: TGraphic; AData: Pointer;
  ...
  TdxExportPrepareGraphicEvent = procedure(Sender: TCustomdxComponentPrinter;
    AReportLink: TBasedxReportLink; const AGraphic: TGraphic; AData: Pointer)
    of object;
  ...
  TdxOnFilterComponentEvent = procedure(Sender: TObject;
    var AComponent: TComponent; var ACaption, ADescription: string;
    var Accept: Boolean) of object;

  TdxOnGetSupportedComponentsEvent = procedure(Sender: TObject;
    AComponents: TStrings) of object;
  ...
  private
    ...
    procedure WritePageAsImageToDisk(AComponentPrinter
      : TCustomdxComponentPrinter; AReportLink: TBasedxReportLink;
      AIndex, APageIndex: Integer; const AGraphic: TGraphic; AData: Pointer;
      var AContinue: Boolean);
  protected
    function DoFilterComponent(AComponent: TComponent;
      var ACaption, ADescription: string): Boolean; dynamic;
    function GetSupportedComponents(AComponents: TStrings): Boolean; dynamic;
    procedure GetDefaultExportPageFileName(AIndex, APageIndex: Integer;
      var AFileName: string); dynamic;
    procedure GetExportPageFileName(AIndex, APageIndex: Integer;
      var AFileName: string); dynamic;
  ...
  public
    ...
    procedure EnumPagesAsImages(const APageIndexes: array of Integer;
      ...
      APrepareData: Pointer; AReportLink: TBasedxReportLink = nil);
    procedure SavePagesAsImagesToDisk(const APageIndexes: array of Integer;
      AGraphicClass: TGraphicClass; ADrawBackground: Boolean;
      const AFileMask: string; AProgressData, APrepareData: Pointer;
      AReportLink: TBasedxReportLink = nil);
  published
    property AutoUpdateDateTime;
    property BeepAfterLongOperations;
    property CurrentLink;
    property CustomizeDlgOptions: TdxCPCustomizeDlgOptions
      read FCustomizeDlgOptions write FCustomizeDlgOptions
    ...
    property Options;
    property OverWriteExistingFiles: Boolean read FOverWriteExistingFiles
      write FOverWriteExistingFiles default False;
    ...
    property OnEndPrint;
    property OnExportGetPageFileName: TdxExportGetPageFileNameEvent
      read FOnExportGetPageFileName write FOnExportGetPageFileName;
    property OnExportPrepareGraphic: TdxExportPrepareGraphicEvent
      read FOnExportPrepareGraphic write FOnExportPrepareGraphic;
    property OnExportProgress: TdxExportProgressEvent read FOnExportProgress
      write FOnExportProgress;
    property OnFilterComponent: TdxOnFilterComponentEvent
      read FOnFilterComponent write FOnFilterComponent;
    property OnFinalizePrintDlgData;
    property OnGetPrintTitle;
    property OnGenerateReportProgress;
    property OnGetSupportedComponents: TdxOnGetSupportedComponentsEvent
      read FOnGetSupportedComponents write FOnGetSupportedComponents;
  ...
  private
    ...
    procedure SetCurrentPreviewDialogStyle(const AValue
  ...
  public
    ...
    procedure RegisterPreviewDialog(APreviewDialogStyleInfo
      : TdxPSPreviewDialogStyleInfoClass);
    procedure UnregisterPreviewDialog(APreviewDialogStyleInfo
      : TdxPSPreviewDialogStyleInfoClass);
    //
    property Count: Integer read GetCount;
    property CurrentPreviewDialogStyle: TdxPSPreviewDialogStyle
      read GetCurrentPreviewDialogStyle write SetCurrentPreviewDialogStyle;
    property CurrentPreviewDialogStyleInfo: TdxPSPreviewDialogStyleInfoClass
      read GetCurrentPreviewDialogStyleInfo;
    property DefaultPreviewDialogStyleInfo: TdxPSPreviewDialogStyleInfoClass
      read GetDefaultPreviewDialogStyleInfo;
    property Items[Index: Integer]: TdxPSPreviewDialogStyleInfoClass
      read GetItem;
  ...
  protected
    ...
    procedure PageParamsChanged(AUpdateCodes
      : TdxPrinterPageUpdateCodes); override;
  public
...
procedure dxPSUnregisterReportLink(ALinkClass: TdxReportLinkClass;
  AComponentClass: TComponentClass;
  ADesignerClass: TdxReportLinkDesignWindowClass);
procedure dxPSUnregisterReportLinks(const ALinkClasses
  : array of TdxReportLinkClass);

function dxPSDesignerClassByCompClass(AComponentClass: TClass)
  : TdxReportLinkDesignWindowClass; overload;
function dxPSDesignerClassByCompClass(AComponent: TObject { TComponent } )
  : TdxReportLinkDesignWindowClass; overload;

function dxPSDesignerClassByLinkClass(ALinkClass: TClass)
  : TdxReportLinkDesignWindowClass; overload;
function dxPSDesignerClassByLinkClass(ALink: TObject { TBasedxReportLink } )
  : TdxReportLinkDesignWindowClass; overload;

function dxPSLinkClassByCompClass(AComponentClass: TClass)
  : TdxReportLinkClass; overload;
function dxPSLinkClassByCompClass(AComponent: TObject { TComponent } )
  : TdxReportLinkClass; overload;
...
procedure dxPSGetLinkSupportedComponentsList(AClassList: TdxClassList;
  ALinkClass: TClass); overload;
procedure dxPSGetLinkSupportedComponentsList(AClassList: TdxClassList;
  ALink: TObject { TBasedxReportLink } ); overload;
...
function dxPSIsSupportedCompClass(AComponent: TObject { TComponent } )
  : Boolean; overload;
...
const
  ...
  dxAlignment: array [TcxTextAlignX] of TAlignment = (taLeftJustify, taCenter,
    taRightJustify, taCenter, taCenter);
  dxCalcFormat: array [Boolean] of UINT = (CXTO_CALCRECT or
    CXTO_AUTOINDENTS { or CXTO_EXPANDTABS } or CXTO_CHARBREAK, CXTO_CALCRECT or
    CXTO_AUTOINDENTS or CXTO_EXPANDTABS or CXTO_CHARBREAK or CXTO_WORDBREAK);

  dxDrawTextTextAlignX: array [TcxTextAlignX] of UINT = (DT_LEFT, DT_CENTER,
    DT_RIGHT, DT_CENTER, DT_CENTER);
  dxDrawTextTextAlignY: array [TcxTextAlignY] of UINT = (DT_TOP, DT_VCENTER,
    DT_BOTTOM, DT_TOP);

  dxImageLayout: array [TAlignment] of TdxImageLayout = (ilImageCenterLeft,
    ilImageCenterRight, ilImageCenterCenter);
  dxMultilineTextAlignY: array [Boolean] of TcxTextAlignY = (taCenterY, taTop);
  dxTextAlignX: array [TAlignment] of TcxTextAlignX = (taLeft, taRight,
    taCenterX);
  dxTextAlignY: array [TTextLayout] of TcxTextAlignY = (taTop, taCenterY,
    taBottom);

  // TdxCellEdgeStyle = (cesRaised, cesSunken)
  dxCellBorderClassMap: array [TdxCellEdgeStyle, Boolean]
    of TdxPSCellBorderClass = ((TdxPSCellRaisedBorder,
    TdxPSCellRaisedSoftBorder), (TdxPSCellSunkenBorder,
    TdxPSCellSunkenSoftBorder));
  dxDefaultCPOptions = [cpoAutoRebuildBeforePreview, cpoAutoRebuildBeforePrint,
    cpoGenerateReportProgressEvent, cpoShowHourGlass,
    cpoDropStorageModeAfterPreview];

  // Stretch, Proportional, Center
  dxGraphicDrawModeMap: array [Boolean, Boolean, Boolean]
    of TdxGraphicDrawMode = (((gdmNone, gdmCenter), (gdmProportional,
    gdmCenterProportional)), ((gdmStretch, gdmStretch), (gdmStretchProportional,
  ...
  dxDefaultReportGroupLookAndFeel: TdxPSReportGroupLookAndFeelClass =
    TdxPSReportGroupStandardLookAndFeel;
  ...
  dxPSReportFileLongExtension = 'ExpressPrinting System-Report';
  // Don't Localize
...
var
  ...
  iiDriveTypes: array [TdxDriveType] of Integer = (
    -1,
    -1,
    -1,
    -1,
...
function dxPSCalculateImageBounds(const R: TRect; AWidth, AHeight: Integer;
  ADrawMode: TdxGraphicDrawMode): TRect;
...
procedure dxPSScaleFont(AFont: TFont; AFontSize, ATargetDPI,
  ASourceDPI: Integer); overload;
...
const
  ...
  DriveTypeImageIndexMap: array [TdxDriveType] of Integer = (-1, -1, 7, 8,
    9, 11, 12);

  // Page "Update Codes" that force us to Rebuild Report or Recalculate ViewInfos
  SignificantPrinterPageUpdateCodes: TdxPrinterPageUpdateCodes = [ucMarginLeft,
    ucMarginTop, ucMarginRight, ucMarginBottom, ucScale];
...
type
  ...
  public
    ...
    LinkClass: TdxReportLinkClass;
    constructor Create(ALinkClass: TdxReportLinkClass;
      AComponentClass: TComponentClass;
      ADesignerClass: TdxReportLinkDesignWindowClass);
    destructor Destroy; override;

    function IsEqual(ALinkClass: TdxReportLinkClass;
      AComponentClass: TComponentClass = nil;
  ...
  public
    procedure Add(ALinkClass: TdxReportLinkClass;
      AComponentClass: TComponentClass;
      ADesignerClass: TdxReportLinkDesignWindowClass);

    function Find(out AIndex: Integer; ALinkClass: TdxReportLinkClass;
      AComponentClass: TComponentClass = nil;
      ADesignerClass: TdxReportLinkDesignWindowClass = nil): Boolean; overload;
    function Find(ALinkClass: TdxReportLinkClass;
      AComponentClass: TComponentClass = nil;
      ADesignerClass: TdxReportLinkDesignWindowClass = nil): Boolean; overload;

    function FindDesignerByLink(ALinkClass: TClass)
      : TdxReportLinkDesignWindowClass; overload;
    function FindDesignerByLink(ALink: TObject { TBasedxReportLink } )
      : TdxReportLinkDesignWindowClass; overload;

    function FindLinkByComponent(AComponentClass: TClass)
      : TdxReportLinkClass; overload;
    function FindLinkByComponent(AComponent: TObject { TComponent } )
      : TdxReportLinkClass; overload;
    function FindLinksByComponent(AComponentClass: TClass): TList; overload;

    procedure GetLinks(AClassList: TdxClassList;
      AExcludeInactive: Boolean = True);
    procedure GetSupportedComponents(AClassList: TdxClassList;
      ALinkClass: TClass = nil); overload;
    procedure GetSupportedComponents(AClassList: TdxClassList;
      ALink: TObject { TBasedxReportLink } ); overload;

    procedure UnregisterLink(ALinkClass: TdxReportLinkClass;
      AComponentClass: TComponentClass = nil;
  ...
  protected
    ...
    function CreateTreeLineRegion(const R: TRect; AIsVertical: Boolean)
      : TcxRegion;
    procedure CalculateRects(const ABounds, AButtonRect: TRect);
  public
    constructor Create(AMode: TdxPSTreeLineMode;
      ACellButton: TdxReportCellExpandButton); virtual;
  ...
  public
    class function Instance: TdxPSExplorerTreeContainerFactory;
      reintroduce; overload;
    property ActiveTreeContainerClass: TCustomdxPSExplorerTreeContainerClass
      read GetActiveTreeContainerClass;
  end;
  ...
  public
    class function Instance: TdxPSExplorerTreeBuilderFactory;
      reintroduce; overload;
    property ActiveBuilderClass: TdxPSExplorerTreeBuilderClass
  ...
  public
    ...
    property ReaderClasses[Version: Integer]: TdxPSDataReaderClass
      read GetReaderClass; default;
  end;
  ...
  public
    ...
    property WriterClasses[Version: Integer]: TdxPSDataWriterClass
      read GetWriterClass; default;
  end;
  ...
  public
    class procedure UpdateReportCells(AReportCells: TdxReportCells;
      AReader: TdxPSDataReader); static;
    class procedure UpdateReportRenderInfo(AReportRenderInfo
      : TdxPSReportRenderInfo; AReader: TdxPSDataReader); static;
  end;
...
var
  ...
  FPDFSecurityMapEntries: array [0 .. 5] of TdxPDFSecurityActionMapEntry = (
    ...
    (Action: pdaPrintHighResolution;
    Name: sdxPDFSecurityAllowPrintHiResolution));
...
function dxPSCalculateImageBounds(const R: TRect; AWidth, AHeight: Integer;
  ...
  function CalculateProportionalBounds(AWidth, AHeight: Integer;
    AStretch, ACenter: Boolean): TRect;
  begin
...
begin
  case ADrawMode of
    ...
    gdmCenter:
      Result := cxRectCenter(R, AWidth, AHeight);
    gdmProportional, gdmCenterProportional, gdmStretchProportional,
      gdmCenterAndStretchProportional:
...
procedure dxPSScaleFont(AFont: TFont; AFontSize, ATargetDPI,
  ASourceDPI: Integer);
begin
  AFont.Height := -MulDiv(MulDiv(AFontSize, ASourceDPI, PtPerInch), ATargetDPI,
    ASourceDPI);
end;

procedure dxPSScaleFontEx(AFont: TFont; AFontHeight, ATargetPPI,
  ASourcePPI: Integer);
var
  ASize: Integer;
begin
...
function dxCanPrintTransparentImages
  (ACanvas: TdxPSReportRenderCustomCanvas): Boolean;
begin
  Result := ACanvas.SupportsTransparentImagesDrawing and
    not FDontPrintTransparentImages;
end;
...
begin
  ...
  begin
    ...
    AItem := TdxReportLinkRegItem.Create(ALinkClass, AComponentClass,
      ADesignerClass);
...
function TdxLinkList.Find(out AIndex: Integer; ALinkClass: TdxReportLinkClass;
  AComponentClass: TComponentClass = nil;
  ADesignerClass: TdxReportLinkDesignWindowClass = nil): Boolean;
var
  I: Integer;
...
function TdxLinkList.Find(ALinkClass: TdxReportLinkClass;
  AComponentClass: TComponentClass = nil;
  ADesignerClass: TdxReportLinkDesignWindowClass = nil): Boolean;
var
  AIndex: Integer;
...
function TdxLinkList.FindDesignerByLink(ALinkClass: TClass)
  : TdxReportLinkDesignWindowClass;
var
  I: Integer;
begin
  Result := nil;
...
function TdxLinkList.FindDesignerByLink(ALink: TObject { TBasedxReportLink } )
  : TdxReportLinkDesignWindowClass;
begin
  if ALink <> nil then
...
function TdxLinkList.FindLinkByComponent(AComponentClass: TClass)
  : TdxReportLinkClass;
var
  AItem: TdxReportLinkRegItem;
  I: Integer;
...
function TdxLinkList.FindLinkByComponent(AComponent: TObject { TComponent } )
  : TdxReportLinkClass;
begin
...
procedure TdxLinkList.GetLinks(AClassList: TdxClassList;
  AExcludeInactive: Boolean = True);
var
...
begin
  ...
  try
    ...
    begin
      ...
      if not AExcludeInactive or (AComponentClass = nil) or
        (ABuffer.IndexOf(AComponentClass) = -1) then
      begin
...
procedure TdxLinkList.GetSupportedComponents(AClassList: TdxClassList;
  ALinkClass: TClass = nil);
var
  I: Integer;
...
procedure TdxLinkList.GetSupportedComponents(AClassList: TdxClassList;
  ALink: TObject { TBasedxReportLink } );
var
  LinkClass: TClass;
begin
  if ALink <> nil then
...
procedure TdxLinkList.UnregisterLinks(const ALinkClasses
  : array of TdxReportLinkClass);
var
  I: Integer;
begin
...
class function TdxPSExplorerTreeContainerFactory.Instance
  : TdxPSExplorerTreeContainerFactory;
begin
  Result := inherited Instance as TdxPSExplorerTreeContainerFactory;
end;

function TdxPSExplorerTreeContainerFactory.GetActiveTreeContainerClass
  : TCustomdxPSExplorerTreeContainerClass;
begin
...
function dxPSExplorerTreeBuilderFactory_ActiveBuilderClass
  : TdxPSExplorerTreeBuilderClass;
begin
  Result := dxPSExplorerTreeBuilderFactory.ActiveBuilderClass;
end;

class function TdxPSExplorerTreeBuilderFactory.Instance
  : TdxPSExplorerTreeBuilderFactory;
begin
...
// because of CLR :-(
function TdxPSExplorerTreeBuilderFactory.GetActiveBuilderClass
  : TdxPSExplorerTreeBuilderClass;
begin
...
function TdxPSReaderFactory.GetReaderClass(Version: Integer)
...
begin
  ...
  begin
    ...
    if Result.SupportsStorageVersion(Version) then
      Exit;
  end;
  Result := nil;
end;
...
function TdxPSWriterFactory.GetWriterClass(Version: Integer)
  : TdxPSDataWriterClass;
var
  I: Integer;
begin
  for I := Count - 1 to 0 do
...
function dxPSExplorerImages: TCustomImageList;
  ...
  begin
    ...
    try
      SHGetFileInfo('C:\Folder\', FILE_ATTRIBUTE_DIRECTORY, AFileInfo,
        SizeOf(AFileInfo), DefaultFlags or AExtraFlags);
    finally
...
type
  ...
  public
    procedure GetComponents(AComponentPrinter: TdxComponentPrinter;
      AReportLink: TBasedxReportLink; AComponents: TStrings;
      AnOptions: TdxPSGetComponentOptions); override;
  end;

procedure TdxPSRunTimeComponentsProvider.GetComponents(AComponentPrinter
  : TdxComponentPrinter; AReportLink: TBasedxReportLink; AComponents: TStrings;
  AnOptions: TdxPSGetComponentOptions);
...
constructor EdxInvalidStorageVersion.Create(AVersion: UINT;
  ADummy: Boolean = False);
begin
  FVersion := AVersion;
  inherited CreateFmt(cxGetResourceString(@sdxInvalidStorageVersion),
    [Version]);
end;
...
begin
  ...
  try
    ...
    begin
      ...
      if (AMemoryStream.Read(AHasMask, SizeOf(AHasMask)) = SizeOf(AHasMask)) and AHasMask
      then
      begin
...
class function TdxPSDataReader.SupportsStorageVersion
...
class function TdxPSDataWriter.SupportsStorageVersion
  (AVersion: Integer): Boolean;
begin
  Result := True;
end;
...
begin
  Result := not IsRectEmpty(HeaderCornerBounds) and
    (RenderInfo.CanUseHFOnEveryPageMode or IsTopPage);
end;
...
begin
  if R1.Top = R1.Bottom then
    Result := (R1.Top >= R2.Top) and (R1.Top <= R2.Bottom)
    // bear in mind that R.Top = R.Bottom
  else
...
begin
  ...
  ContentBounds.Bottom := ContentBounds.Top + Min(AContentHeight,
    cxRectHeight(ContentBounds));
end;
...
begin
  ...
  if IsCompositionPagePart then
    PageOffset := Point(0, MulDiv(ARowInfo.CalculateContentOffset(ReportLink),
      100, RenderInfo.ScaleFactor))
  else
...
begin
  Result := 1;
  if not ReportLink.ShrinkToPageWidth and ReportLink.SupportsGapsBetweenCells
  then
  begin
    AEndIndex := { AStartIndex } -1;
    Result := 0;
    ATopSide := DetailBounds.Top;
    while (ATopSide < DetailBounds.Bottom) and
      (AEndIndex < ReportCells.Count) do
    begin
      Inc(Result);
      ...
      repeat
        ...
        Inc(AStartIndex);
      until (AStartIndex = ReportCells.Count) or
        AreRectsIntersected(R, DetailBounds);
      Dec(AStartIndex);
      ...
      repeat
        ...
        Inc(AEndIndex);
      until (AEndIndex = ReportCells.Count) or
        not AreRectsIntersected(R, DetailBounds);
      Dec(AEndIndex);
  ...
  begin
    ...
    begin
      ...
      repeat
        ...
        Inc(StartIndex);
      until (StartIndex = ReportCells.Count) or
        AreRectsIntersected(R, DetailBounds);
      Dec(StartIndex);
      EndIndex := StartIndex;
      // fix 2.1
...
function TdxPSPageRenderInfo.CreatePrinterPage(ARenderInfo
  : TdxPSReportRenderInfo): TdxPrinterPage;
begin
...
procedure TdxPSPageRenderInfo.CalculateOffsets;
  ...
  procedure CalculateHorizontalOffsets(const AMarginsOffset: TPoint;
    const R: TRect);
  var
    AOffset: Integer;
  begin
  ...
  procedure CalculateVerticalOffsets(const AMarginsOffset: TPoint;
    const R: TRect);
  var
    APaintSize: Integer;
  begin
    ...
    begin
      ...
      Inc(DataOffset.Y, MulDiv(Max(0, APaintSize - cxRectHeight(R)) div 2, 100,
        RenderInfo.ScaleFactor));
    end;
  end;
...
procedure TdxPSPageRenderInfo.CalculateOverlayIndexes;
  ...
  function CreateOverlayIndexes(AnOverlay: TdxReportCell)
    : TdxPageOverlayIndexes;
  var
    I: Integer;
    R: TRect;
...
begin
  PageHeaderBounds := RenderInfo.LoMetricRectToInternalUnits
    (PrinterPage.HeaderRectLoMetric);
  PageFooterBounds := RenderInfo.LoMetricRectToInternalUnits
    (PrinterPage.FooterRectLoMetric);
end;
...
begin
  Result.X := MulDiv(cxRectWidth(PrinterPage.PaintRectLoMetric),
    RenderInfo.UnitsPerInch, 254);
  Result.Y := MulDiv(cxRectHeight(PrinterPage.PaintRectLoMetric),
    RenderInfo.UnitsPerInch, 254);
end;
...
function TdxPSPageRenderInfo.GetIndexPair(Index: Integer)
  : TdxContinuedIndexPair;
begin
...
begin
  Result := PageIndex >= RenderInfo.PageRenderInfoCount -
    RenderInfo.PageColCount;
end;
...
procedure TdxPSPageRenderInfo.SetIndexPair(Index: Integer;
  Value: TdxContinuedIndexPair);
begin
...
constructor TdxPSPageDelimitersCalculator.Create(AReportRenderInfo
  : TdxPSReportRenderInfo);
begin
  inherited Create;
...
class procedure TdxPSPageDelimitersCalculator.Calculate(AReportRenderInfo
  : TdxPSReportRenderInfo);
begin
...
function TdxPSPageDelimitersCalculator.GetPageDelimiters
  (Index: Integer): Integer;
begin
  Result := Integer(FPageDelimiters.Items[Index]);
end;

function TdxPSPageDelimitersCalculator.GetReportDelimiters
  (Index: Integer): Integer;
begin
  Result := Integer(FReportDelimiters.Items[Index]);
end;

function TdxPSPageDelimitersCalculator.CalculatePageContentSize
  (APageIndex: Integer): Integer;
begin
  Result := ReportRenderInfo.CalculatePageContentWidth(APageIndex);
end;

function TdxPSPageDelimitersCalculator.IsHardDelimiter(AValue: Integer)
  : Boolean;
begin
  Result := ReportRenderInfo.IsHardHorizontalDelimiter(AValue);
end;

function TdxPSPageDelimitersCalculator.ScaleValue(AValue: Integer;
  AScaleIn: Boolean = True): Integer;
begin
  if AScaleIn then
...
function TdxPSPageVerticalDelimitersCalculator.CalculatePageContentSize
  (APageIndex: Integer): Integer;
begin
  Result := ReportRenderInfo.CalculatePageContentHeight
    (ReportRenderInfo.PageColCount * APageIndex);
end;

function TdxPSPageVerticalDelimitersCalculator.IsHardDelimiter
...
class procedure TdxPSStorageVersionCompability.UpdateReportCells
  (AReportCells: TdxReportCells; AReader: TdxPSDataReader);
var
...
class procedure TdxPSStorageVersionCompability.UpdateReportRenderInfo
  (AReportRenderInfo: TdxPSReportRenderInfo; AReader: TdxPSDataReader);
  ...
  begin
    ...
    try
      ...
      repeat
        ...
        DoCalculate;
      until (APrinterPage.ScaleMode <> smFit) or
        IsReportFitsToPages(APrinterPage) or
        (FActualScaleFactor < TdxPrinterPage.MinScaleFactor);
    finally
      Unlock;
    end;
  end;
...
begin
  ...
  begin
    FActualScaleFactor := CalculateActualScaleFactor
      (PrinterPage.FitToPagesHorizontally, PrinterPage.FitToPagesVertically,
      UnitsPerInch);
  end;
...
function TdxPSReportRenderInfo.CalculateActualScaleFactor
  (AFitToPagesHorizontally, AFitToPagesVertically, AReportDPI: Integer)
  : Integer;
  ...
  begin
    Result := MulDiv(ReportWidth + RowHeaderWidth * GetTargetPageCountX,
      UnitsPerInch, AReportDPI);
  end;

  function CalculateActualReportHeight: Integer;
  begin
    CalculateHeaderAndFooterBounds;
    Result := MulDiv(ReportHeight + (HeaderHeight + FooterHeight) *
      GetTargetPageCountY, UnitsPerInch, AReportDPI);
  ...
  procedure CalculateScaleFactor(var AScaleFactor: Integer;
    APaintAreaSize, AReportSize: Integer);
  var
    AValue: Integer;
  begin
...
function TdxPSReportRenderInfo.GetActualPageRenderInfo(APageIndex: Integer)
  : TdxPSPageRenderInfo;
var
  ARowInfo: TdxPSCompositionReportRenderRowInfo;
begin
  if GetCompositionInfo(APageIndex, ARowInfo) then
    Result := ARowInfo.RenderInfo.PageRenderInfos
...
begin
  Result := (ReportLink.CurrentComposition <> nil) and
    ReportLink.CurrentComposition.RenderInfo.FindRowInfo(ReportLink, APageIndex,
    ARowInfo);
end;

function TdxPSReportRenderInfo.IsDrawPageFootnotesOnPage
...
function TdxPSReportRenderInfo.IsDrawPageTitleOnPage
  (APageIndex: Integer): Boolean;
begin
...
begin
  ...
  begin
    if ReportLink.IsDrawFootersOnEveryPage or
      (ReportLink.DataSource = rldsExternalStorage) then
      FooterBounds := ReportCells.FooterBoundsRect;
    if ReportLink.IsDrawHeadersOnEveryPage or
      (ReportLink.DataSource = rldsExternalStorage) then
      HeaderBounds := ReportCells.HeaderBoundsRect;
    if ReportLink.IsDrawRowHeadersOnEveryPage or
      (ReportLink.DataSource = rldsExternalStorage) then
      RowHeaderBounds := ReportCells.RowHeaderBoundsRect;
    if ReportLink.IsDrawHeaderCornersOnEveryPage or
      (ReportLink.DataSource = rldsExternalStorage) then
      HeaderCornerBounds := ReportCells.HeaderCornerBoundsRect;
  end;
end;

function TdxPSReportRenderInfo.CalculatePageContentHeight
  (APageIndex: Integer): Integer;
var
...
begin
  ...
  if APageIndex = 0 then
    CanUseHFOnEveryPageMode := Result > AHeaderHeight + AFooterHeight +
      AAddContentHeight;
  ...
  if (Result < AHeaderHeight + AAddContentHeight) and
    (APageIndex > FPageDelimitersX.Count - 1) then
  begin
    FInsufficientHeight := True;
    AHeaderHeight := 0;
  end;
...
function TdxPSReportRenderInfo.CalculatePageContentWidth
  (APageIndex: Integer): Integer;
var
...
procedure TdxPSReportRenderInfo.CalculatePages
  (AStage: TdxPSCalculatePagesStage);
begin
...
function TdxPSReportRenderInfo.CalculatePageDetailBounds(APageCol,
  APageRow: Integer): TRect;
begin
...
function TdxPSReportRenderInfo.CalculateFootnotesHeight(AAdjustOnReportScale
  : Boolean): Integer;
begin
  Result := CalculateReportNotesTextHeight(FootnotesText, FootnotesFont,
    AAdjustOnReportScale);
  ReportLink.DoMeasureReportLinkFootnotes(Result);
  Result := Max(0, Min(cxRectHeight(PrinterPage.PaintRectPixels) div 2,
    Result));
end;
...
function TdxPSReportRenderInfo.CalculateTitleHeight(AAdjustOnReportScale
  : Boolean): Integer;
begin
  Result := CalculateReportNotesTextHeight(TitleText, TitleFont,
    AAdjustOnReportScale);
...
begin
  FootnotesBounds := cxRectSetSize(cxNullRect, PaintSize.X,
    ConvertValue(CalculateFootnotesHeight));
  FootnotesBounds := cxRectScale(FootnotesBounds, 100, ScaleFactor);
end;

procedure TdxPSReportRenderInfo.CalculateTitleBounds;
begin
  TitleBounds := cxRectSetSize(cxNullRect, PaintSize.X,
    ConvertValue(CalculateTitleHeight));
...
begin
  Result := cxPointScale(cxPoint(cxRectSize(PrinterPage.PaintRectLoMetric)),
    UnitsPerInch, 254);
end;
...
function TdxPSReportRenderInfo.CreatePageRenderInfo(APageIndex: Integer)
  : TdxPSPageRenderInfo;
begin
...
begin
  Result := not IsRectEmpty(FootnotesBounds) and
    IsDrawPageFootnotesOnPage(APageIndex);
end;
...
function TdxPSReportRenderInfo.IsHardHorizontalDelimiter
  (AValue: Integer): Boolean;
begin
  Result := HardDelimiterXList.IndexOf(Pointer(AValue)) <> -1;
end;

function TdxPSReportRenderInfo.IsHardVerticalDelimiter(AValue: Integer)
  : Boolean;
begin
  Result := HardDelimiterYList.IndexOf(Pointer(AValue)) <> -1;
end;

procedure TdxPSReportRenderInfo.CheckStorageCompatibility
...
procedure TdxPSReportRenderInfo.EliminateDuplicatesAndSortDelimiters
  (AList: TList);
var
  ADuplicates: TList;
  I: Integer;
...
begin
  ReportLink.MakeHardDelimiters(ReportCells, HardDelimiterXList,
    HardDelimiterYList);
end;
...
function TBasedxReportLink.PossibleCustomDraw
...
procedure TdxPSReportRenderInfo.TruncateDelimiters(AList: TList;
  AValue: Integer);
var
  I: Integer;
begin
...
function TdxPSReportRenderInfo.LoMetricRectToInternalUnits
  (const R: TRect): TRect;
begin
...
function TdxPSReportRenderInfo.LoMetricValueToInternalUnits
...
function TdxPSReportRenderInfo.GetPageRenderInfo(Index: Integer)
  : TdxPSPageRenderInfo;
begin
...
function TdxPSReportRenderInfo.IsReportFitsToPages(APrinterPage
  : TdxPrinterPage): Boolean;

  function Check(ATargetValue, ACurrentValue: Integer;
    AInsufficientSpace: Boolean): Boolean;
  begin
    Result := (ATargetValue = 0) or (ACurrentValue <= ATargetValue) and
      not AInsufficientSpace;
  end;

begin
  Result := Check(APrinterPage.FitToPagesVertically, PageRowCount,
    FInsufficientHeight) and Check(APrinterPage.FitToPagesHorizontally,
    PageColCount, FInsufficientWidth);
end;
...
begin
  ...
  ACanvas.FillRect(GetBottomShadowRestSpaceBounds(R, AShadowDepth),
    ARestSpaceColor);
  ACanvas.FillRect(GetRightShadowBounds(R, AShadowDepth), AShadowColor);
  ACanvas.FillRect(GetRightShadowRestSpaceBounds(R, AShadowDepth),
    ARestSpaceColor);
end;
...
class procedure TdxPSCellBorderPainter.InflateRect(var R: TRect;
  ASides: TdxCellSides; ALineThickness: Integer);
begin
  if csLeft in ASides then
...
begin
  ...
  else if ASide in csTopLeft then
    Result := (Thickness - 1) div 2
  else
    Result := 1 + Thickness div 2
end;

class function TdxPSCustomCellBorder.GetPainterClass
  : TdxPSCellBorderPainterClass;
begin
...
class function TdxPSCustomCell3DBorder.GetPainterClass
  : TdxPSCellBorderPainterClass;
begin
...
class function TdxPSCellTwistedBorder.GetPainterClass
  : TdxPSCellBorderPainterClass;
begin
...
begin
  ...
  begin
    if ASide in Item.CellSides then
      ACanvas.FillRect(GetBorderBounds(R, ASide, Renderer.LineThickness),
        SideColor[ASide]);
  end;
end;
...
begin
  if not Find(ABitmap, Result) then
    Result := FItems.Add(ABitmap);
end;
...
function TdxPSBackgroundBitmapPool.Find(ABitmap: TGraphic;
...
begin
  ...
  for Result := 0 to Count - 1 do
    if Items[Result].Color = AColor then
      Exit;
  Result := -1;
end;
...
begin
  ...
  begin
    ...
    AWriter.WriteInteger(-MulDiv(FOriginalHeight, PtPerInch,
      FOriginalPixelsPerInch));
end;
...
begin
  ...
  begin
    if dxAreFontsEqual(AName, AColor, APitch, AStyle, AHeight, Fonts[Result])
    then
      Exit;
  end;
  Result := -1;
...
function TdxPSReportFontPool.CreateFont(const AName: string; AColor: TColor;
  APitch: TFontPitch; AStyle: TFontStyles; AHeight: Integer): Integer;
var
  Item: TdxPSFontPoolItem;
begin
  Result := Count;
  Item := TdxPSFontPoolItem.Create(AName, AColor, APitch, AStyle, AHeight,
    FOwner.PixelsPerInch);
  FItems.Add(Item);
  Item.Font.OnChange := FontChanged;
end;
...
procedure TdxPSCachedGraphicInfo.ValidateGraphicHelper(AGraphic: TGraphic;
  AImageList: TCustomImageList; AImageIndex: Integer;
  ABackgroundColor, ATransparentColor: TColor; AIsTransparent: Boolean);
begin
  ...
  begin
    if (FGraphicHelper.ImageList <> AImageList) or
      (FGraphicHelper.ImageIndex <> AImageIndex) then
      FGraphicHelper.Initialize(AImageList, AImageIndex, ABackgroundColor,
        ATransparentColor, AIsTransparent, Renderer.IsPrinting)
  end
  else if (FGraphicHelper.Graphic <> AGraphic) or not CheckRendererModeInfo then
  begin
    FGraphicHelper.Initialize(AGraphic, ABackgroundColor, ATransparentColor,
      AIsTransparent, Renderer.IsPrinting);
    SaveModeInfo;
  end;
end;
...
constructor TdxPSCustomReportExportProvider.Create
  (AReportLink: TBasedxReportLink);
begin
  inherited Create;
  FReportLink := AReportLink;
...
begin
  ...
  Filer.DefineProperty('IsCreatorAssigned', ReadIsCreatorAssigned,
    WriteIsCreatorAssigned, FIsCreatorAssigned);
  Filer.DefineProperty('IsTitleAssigned', ReadIsTitleAssigned,
    WriteIsTitleAssigned, FIsTitleAssigned);
end;
...
procedure TdxPSPDFReportExportOptions.LoadFromIniFile(AIniFile: TCustomIniFile;
...
begin
  ...
  begin
    ...
    CompressStreams := AIniFile.ReadBool(ASectionName,
      sdxCompressStreams, False);
    UseJPEGCompression := AIniFile.ReadBool(ASectionName,
      sdxUseJPEGCompression, True);
    OpenDocumentAfterExport := AIniFile.ReadBool(ASectionName,
      sdxOpenDocumentAfterExport, False);

    AAllowActions := [];
    for I := Low(FPDFSecurityMapEntries) to High(FPDFSecurityMapEntries) do
    begin
      if AIniFile.ReadBool(ASectionName, FPDFSecurityMapEntries[I].Name, True)
      then
        Include(AAllowActions, FPDFSecurityMapEntries[I].Action);
    end;
    SecurityOptions.KeyLength := TdxPSPDFEncryptKeyLength
      (AIniFile.ReadInteger(ASectionName, sdxPDFSecurityKeyLength,
      Ord(pekl128)));
  end;
end;
...
procedure TdxPSPDFReportExportOptions.SaveToIniFile(AIniFile: TCustomIniFile;
  const ASectionName: string);
var
  I: Integer;
begin
  ...
  AIniFile.WriteBool(ASectionName, sdxOpenDocumentAfterExport,
  ...
  AIniFile.WriteInteger(ASectionName, sdxPDFSecurityKeyLength,
    Ord(SecurityOptions.KeyLength));
  for I := Low(FPDFSecurityMapEntries) to High(FPDFSecurityMapEntries) do
  begin
    with FPDFSecurityMapEntries[I] do
      AIniFile.WriteBool(ASectionName, Name,
        Action in SecurityOptions.AllowActions);
  end;
end;
...
procedure TdxPSPDFReportExportOptions.SetSecurityOptions
  (AValue: TdxPSPDFSecurityOptions);
begin
  FSecurityOptions.Assign(AValue);
end;

procedure TdxPSPDFReportExportOptions.SetSignatureOptions
  (AValue: TdxPSPDFSignatureOptions);
begin
...
function TdxPSReportRenderer.CustomDrawReportItem
  (AItem: TAbstractdxReportCellData): Boolean;
var
  ACanvas: TCanvas;
  R: TRect;
begin
...
begin
  ...
  begin
    ...
    R := Rect(0, 0, ABaseWidth, 5);
    ACanvas.CalculateTextRect(AText, R, dxCalcFormat[True] or
      CXTO_CALCROWCOUNT, AFont);
  end;
end;
...
function TdxPSReportRenderer.CalcTextRect
  (ACanvas: TdxPSReportRenderCustomCanvas; const AText: string;
...
begin
  ...
  begin
    ...
    try
      ...
      ACanvas.MakeTextRows(PChar(AText), Length(AText), ARect, ATextParams,
        ATextRows, ALineCount);
      ARect.Bottom := ARect.Top + 3 * LineThickness * dxTextSpace + ALineCount *
        ATextParams.FullRowHeight;
...
procedure TdxPSReportRenderer.DrawCheckBox
  (ACanvas: TdxPSReportRenderCustomCanvas; var R: TRect;
  AChecked, AEnabled, AIsRadio: Boolean; AEdgeStyle: TdxCheckButtonEdgeStyle;
  ABorderColor: TColor = clWindowText);
begin
  ACanvas.DrawCheckBox(R, AChecked, AEnabled, AIsRadio, AEdgeStyle,
    MarlettFont10, LineThickness, ABorderColor);
end;
  ...
  case AEdgeMode of
    cem3DEffects:
      begin
        ...
        TdxPSCell3DBorderPainter.Draw3DFrame(ACanvas, R, ASides, ACellBorders,
          LineThickness);
      end;
    ...
    cemPattern:
      begin
        ...
        TdxPSCellBorderPainter.DrawFrame(ACanvas, R, ASides, ABorderColor,
          ABorderColor, LineThickness);
      end;
  end;
end;

procedure TdxPSReportRenderer.DrawEllipse
...
procedure TdxPSReportRenderer.DrawExpandButton
  (ACanvas: TdxPSReportRenderCustomCanvas; var R: TRect;
  AExpanded, ADrawBorder, AEdge3D, AEdge3DSoft: Boolean;
  AShadow, AFillInterior: Boolean; ABorderColor, AInteriorColor: TColor);

  function GetEdgeStyle: TdxCheckButtonEdgeStyle;
  const
    Edge3DStyleMap: array [Boolean] of TdxCheckButtonEdgeStyle = (cbes3D,
      cbesSoft3D);
  begin
    if not ADrawBorder then
      Result := cbesNone
    else if AEdge3D then
...
procedure TdxPSReportRenderer.DrawGlyph(ACanvas: TdxPSReportRenderCustomCanvas;
  const R: TRect; AGlyph: Byte);
begin
  ACanvas.DrawGlyph(R, nil, AGlyph, True);
end;

procedure TdxPSReportRenderer.DrawGraphic
  (ACanvas: TdxPSReportRenderCustomCanvas; var R: TRect; const AClipRect: TRect;
  AImageList: TCustomImageList; AImageIndex: Integer; AGraphic: TGraphic;
  AGraphicTransparent: Boolean; ATransparent: Boolean; AColor: TColor);
begin
...
procedure TdxPSReportRenderer.DrawGraphicEx
  (ACanvas: TdxPSReportRenderCustomCanvas; R: TRect; const AClipRect: TRect;
  AImageList: TCustomImageList; AImageIndex: Integer; AGraphic: TGraphic;
  AGraphicTransparent, ATransparent: Boolean; AColor, ABkColor: TColor;
  APattern: TdxPSFillPatternClass;
  AActualImageBuffering: TdxCellImageActualBuffering = cibAlways;
  ATransparentColor: TColor = clNone);

  function IsImageTransparent(AGraphic: TGraphic): Boolean;
  begin
    Result := AGraphicTransparent and
      not((AGraphic is TIcon) or (IsPrinting and not dxCanPrintTransparentImages
      (ACanvas)));
  end;
...
begin
  ...
  try
    if (cxRectWidth(R) > cxRectWidth(AClipRect)) or
      (cxRectHeight(R) > cxRectHeight(AClipRect)) then
    ...
    begin
      CachedGraphicInfo.ValidateGraphicHelper(AGraphic, AImageList, AImageIndex,
        ABkColor, ATransparentColor, IsImageTransparent(AGraphic));
...
procedure TdxPSReportRenderer.DrawRectangle
  (ACanvas: TdxPSReportRenderCustomCanvas; R: TRect;
  AForeColor, ABackColor: TColor; AContentPattern: TdxPSFillPatternClass;
  ABorderColor: TColor; ABorderThickness: Integer = 1);
begin
  FrameRect(ACanvas, R, ABorderColor, csAll, ABorderThickness);
  InflateRect(R, -ABorderThickness * LineThickness,
    -ABorderThickness * LineThickness);
  FillRectEx(ACanvas, R, AForeColor, ABackColor, AContentPattern);
end;

procedure TdxPSReportRenderer.DrawRoundRect
  (ACanvas: TdxPSReportRenderCustomCanvas; R: TRect;
  AEllipseWidth, AEllipseHeight: Integer; AForeColor, ABackColor: TColor;
  AContentPattern: TdxPSFillPatternClass; ABorderColor: TColor;
  ABorderThickness: Integer = 1);
begin
  FrameRoundRect(ACanvas, R, AEllipseWidth, AEllipseHeight, ABorderColor,
    ABorderThickness);

  AEllipseHeight := MulDiv(AEllipseHeight, R.Bottom - R.Top - 2 *
    ABorderThickness * LineThickness, R.Bottom - R.Top);
  AEllipseWidth := MulDiv(AEllipseWidth, R.Right - R.Left - 2 * ABorderThickness
    * LineThickness, R.Right - R.Left);
  InflateRect(R, -ABorderThickness * LineThickness,
    -ABorderThickness * LineThickness);

  FillRoundRectEx(ACanvas, R, AEllipseWidth, AEllipseHeight, AForeColor,
    ABackColor, AContentPattern);
end;

procedure TdxPSReportRenderer.DrawSortMark
  (ACanvas: TdxPSReportRenderCustomCanvas; var R: TRect;
  ASortOrder: TdxCellSortOrder; AMono: Boolean);
const
  GlyphIndexes: array [TdxCellSortOrder] of Byte = (0, SortUpMarkIndex,
    SortDownMarkIndex);
begin
...
procedure TdxPSReportRenderer.DrawText(ACanvas: TdxPSReportRenderCustomCanvas;
  ...
  const AText: string; AFont: TFont; ABkColor: TColor;
  ATextAlignX: TcxTextAlignX; ATextAlignY: TcxTextAlignY;
  AFillBackground, AMultiline, AEndEllipsis: Boolean;
...
begin
  ...
  DrawTextEx(ACanvas, R, AMaxLineCount, ALeftIndent, ARightIndent, AText, AFont,
    CXTO_AUTOINDENTS or CXTO_EXPANDTABS or CXTO_PATTERNEDTEXT or
    CXTO_CHARBREAK or MakeTextFormat(ATextAlignX, ATextAlignY, AMultiline,
    AEndEllipsis, APreventLeftTextExceed, APreventTopTextExceed, AHidePrefix));
end;
...
begin
  DrawTextEx(ACanvas, R, AMaxLineCount, AText, AFont, AFormat,
    Rect(ALeftIndent, 0, ARightIndent, 0));
end;

procedure TdxPSReportRenderer.DrawTextEx(ACanvas: TdxPSReportRenderCustomCanvas;
  var R: TRect; AMaxLineCount: Integer; const AText: string; AFont: TFont;
  AFormat: Cardinal; const AIndents: TRect; ALineSpacing: Single = 1.0);
...
begin
  Result := cxMakeFormat(ATextAlignX, ATextAlignY) or
    dxEndEllipsis[AEndEllipsis] or dxHidePrefix[AHidePrefix] or
    dxPreventLeftExceed[APreventLeftTextExceed] or dxPreventTopExceed
    [APreventTopTextExceed] or dxWordBreak[AMultiline];
end;
...
procedure TdxPSReportRenderer.FillEllipseEx
  (ACanvas: TdxPSReportRenderCustomCanvas; const R: TRect;
  AForeColor, ABackColor: TColor; APattern: TdxPSFillPatternClass);
begin
  ACanvas.FillEllipse(R, ABackColor, AForeColor, APattern,
    GetPatternBrush(APattern, AForeColor));
end;

procedure TdxPSReportRenderer.FillRect(ACanvas: TdxPSReportRenderCustomCanvas;
...
procedure TdxPSReportRenderer.FillRoundRect
  ...
  AEllipseWidth, AEllipseHeight: Integer; AColor: TColor);
begin
  FillRoundRectEx(ACanvas, R, AEllipseWidth, AEllipseHeight, AColor, clWhite,
...
procedure TdxPSReportRenderer.FillRoundRectEx
  ...
  APattern: TdxPSFillPatternClass);
begin
  ACanvas.FillRoundRect(R, AEllipseWidth, AEllipseHeight, ABackColor,
    AForeColor, APattern, GetPatternBrush(APattern, AForeColor));
end;

procedure TdxPSReportRenderer.FillRgn(ACanvas: TdxPSReportRenderCustomCanvas;
  Rgn: TcxRegionHandle; AColor: TColor);
begin
...
procedure TdxPSReportRenderer.FillRgnEx(ACanvas: TdxPSReportRenderCustomCanvas;
  ...
  APattern: TdxPSFillPatternClass);
begin
  ACanvas.FillRegion(Rgn, ABackColor, AForeColor, APattern,
    GetPatternBrush(APattern, AForeColor));
end;

procedure TdxPSReportRenderer.FrameEllipse
  (ACanvas: TdxPSReportRenderCustomCanvas; R: TRect; AColor: TColor;
  AThickness: Integer = 1);
begin
...
procedure TdxPSReportRenderer.FrameRoundRect
  ...
  AThickness: Integer = 1);
begin
  ACanvas.DrawRoundFrame(R, AEllipseWidth, AEllipseHeight, AColor,
    AThickness * LineThickness);
end;
...
function TdxPSReportRenderer.GetBorderPainter
  (AClass: TdxPSCellBorderPainterClass): TdxPSCellBorderPainter;
begin
...
function TdxPSReportRenderer.GetPatternBrush(APattern: TdxPSFillPatternClass;
  AColor: TColor): TBrush;
begin
...
function TdxPSReportRenderer.GetReportGroupLookAndFeelPainter
  (AClass: TdxPSReportGroupLookAndFeelPainterClass)
  : TdxPSReportGroupLookAndFeelPainter;
begin
...
begin
  ...
  try
    RenderPageEx(ARenderCanvas, APageBounds, APageIndex, AContinuousPageIndex,
      AZoomFactor);
  finally
    ARenderCanvas.Free;
  end;
...
procedure TdxPSReportRenderer.RenderPageEx
...
begin
  if RenderInfo.HasPageTitle(ARealPageIndex) then
    ReportLink.ReportTitle.Draw(Self, cxRectOffset(RenderInfo.TitleBounds,
      PageRenderInfo.TitleOffset));
...
begin
  for I := 0 to RenderInfo.DelimiterXCount - 1 do
    Canvas.FillRect(Bounds(RenderInfo.DelimitersX[I], 0, 2 * LineThickness,
      20 * LineThickness), clHighlight);
end;
...
begin
  ...
  begin
    ...
    ABackground.PaintEx(Canvas, ARect, PixelsNumerator * 100,
      PixelsDenominator * RenderInfo.ScaleFactor);
  end;
end;
...
var
  R: TRect;
begin
  if ReportLink.ShowPageFooter and (rlcHeaderFooter in ReportLink.Capabilities)
  then
  begin
    ...
    if not IsRectEmpty(R) and (IsPrinting or Canvas.IsRectVisible(R)) then
      RenderPageHeaderOrFooter(ReportLink.RealPrinterPage.PageFooter,
        ARealPageIndex, R);
  end;
end;
...
var
  R: TRect;
begin
  if ReportLink.ShowPageHeader and (rlcHeaderFooter in ReportLink.Capabilities)
  then
  begin
    R := RenderInfo.PageRenderInfos[ARealPageIndex].PageHeaderBounds;
    if not IsRectEmpty(R) and (IsPrinting or Canvas.IsRectVisible(R)) then
      RenderPageHeaderOrFooter(ReportLink.RealPrinterPage.PageHeader,
        ARealPageIndex, R);
  end;
end;

procedure TdxPSReportRenderer.RenderPageHeaderOrFooter(AHeaderOrFooter
  : TCustomdxPageObject; APageIndex: Integer; ARect: TRect);
const
...
begin
  ...
  try
    ...
    PrepareFont(AHeaderOrFooter.Font, TCustomdxPageObjectAccess(AHeaderOrFooter)
      .AdjustOnScale);
    Canvas.Font := AHeaderOrFooter.Font;
    if ReportLink.IsHeaderOrFooterCustomDrawn(AHeaderOrFooter) then
    begin
      ACustomDrawCanvas := Canvas.BeginCustomDraw(ARect, AHeaderOrFooter.Font,
        clDefault);
      try
        ADefaultDrawText := True;
        ADefaultDrawBackground := True;
        ReportLink.DoCustomDrawPageHeaderOrFooter(AHeaderOrFooter,
          ACustomDrawCanvas, APageIndex, ARect, ADefaultDrawText,
          ADefaultDrawBackground);
        if ADefaultDrawText or ADefaultDrawBackground then
          RenderPageHeaderOrFooterContent(AHeaderOrFooter, APageIndex, ARect,
            TitleParts[ADefaultDrawText], ADefaultDrawBackground);
      finally
...
begin
  if ADrawBackground then
    HF.Background.PaintEx(Canvas, ARect, PixelsNumerator * 100,
      PixelsDenominator * RenderInfo.ScaleFactor);
  if ATitleParts <> [] then
  begin
    ...
    try
      ...
      try
        ...
        ABuilder.Build(Canvas, APageObjectCells, ARect, ATitleParts, HF,
          ReportLink.RealPrinterPage.ReverseTitlesOnEvenPages and
          Odd(APageIndex));
...
procedure TdxPSReportRenderer.RenderCell(ACell: TdxReportCell;
  const OriginRect: TRect);
var
...
begin
  ...
  begin
    ...
    try
      ReportLink.DoCustomDrawEntirePage(ACustomDrawCanvas, ViewPortRect,
        ARealPageIndex);
    finally
      Canvas.EndCustomDraw(ACustomDrawCanvas);
    end;
...
begin
  APrevWindowOrg := Canvas.OffsetWindowOrg
    (cxPointInvert(cxPointOffset(PageRenderInfo.DataOffset, LineThickness,
    LineThickness)));
  try
    Canvas.SaveState;
    try
      Canvas.IntersectClipRgn(GetPageContentClipRect);
      RenderPageContentDetails(PageRenderInfo.DetailBounds.TopLeft,
        ADetailsOffset);
...
procedure TdxPSReportRenderer.RenderPageContentDetails(const ADetailsPosition
  : TPoint; out AOffset: Integer);
      ...
      begin
        ...
        begin
          ...
          RenderPageContentPart(PageRenderInfo.ReportCells.Cells,
            PageRenderInfo.IndexPairs[I].StartIndex, AEndIndex,
            PageRenderInfo.DetailBounds);
        end;

        for I := 0 to PageRenderInfo.OverlayCount - 1 do
          RenderPageOverlay(I, PageRenderInfo.Overlays[I],
            PageRenderInfo.DetailBounds);

        if not PageRenderInfo.IsBottomPage then
          AOffset := PageRenderInfo.DetailBounds.Bottom
        else if PageRenderInfo.ReportCells.Cells.CellCount > AEndIndex then
...
begin
  Canvas.OffsetWindowOrg(Point(0, -cxRectHeight(PageRenderInfo.HeaderBounds) -
    ADetailsOffset));
  if PageRenderInfo.HasFooter then
  begin
    RenderPageContentPart(ReportCells.FooterCells, 0, -1,
      cxRectOffset(PageRenderInfo.FooterBounds,
      PageRenderInfo.DetailBounds.Left, 0));
  end;
end;

procedure TdxPSReportRenderer.RenderPageContentHeader(ACell: TdxReportCell;
  AAnchors: TAnchors; const R: TRect; const AOffset: TPoint);

  function AdjustFixedPageHeaderClipRect(const R: TRect;
    AAnchors: TAnchors): TRect;
  begin
    Result := R;
...
procedure TdxPSReportRenderer.RenderPageContentHeaders
  (const ADetailsPosition: TPoint);
begin
  if PageRenderInfo.HasHeaderCorner then
    RenderPageContentHeader(ReportCells.HeaderCornerCells, [akLeft, akTop],
      PageRenderInfo.HeaderCornerBounds, cxNullPoint);
  if PageRenderInfo.HasHeader then
    RenderPageContentHeader(ReportCells.HeaderCells, [akLeft, akTop, akRight],
      PageRenderInfo.HeaderBounds, cxPoint(ADetailsPosition.X, 0));
  if PageRenderInfo.HasRowHeader then
    RenderPageContentHeader(ReportCells.RowHeaderCells,
      [akLeft, akTop, akBottom], PageRenderInfo.RowHeaderBounds,
      cxPoint(0, ADetailsPosition.Y));
end;
...
procedure TdxPSReportRenderer.RenderPageOverlay(AOverlayIndex: Integer;
  AOverlay: TdxPageOverlayIndexes; const OriginRect: TRect);
var
...
function TdxPSReportRenderer.GetUnitsPerInchEx(AAdjustOnReportScale
  : Boolean): Integer;
begin
  if AAdjustOnReportScale then
    Result := RenderInfo.UnitsPerInch
...
function TdxPSReportRenderer.CreateBorderPainter
  (AClass: TdxPSCellBorderPainterClass): TdxPSCellBorderPainter;
begin
...
function TdxPSReportRenderer.FindBorderPainter
  (AClass: TdxPSCellBorderPainterClass): TdxPSCellBorderPainter;
var
  I: Integer;
begin
...
function TdxPSReportRenderer.CreateReportGroupLookAndFeelPainter
  (AClass: TdxPSReportGroupLookAndFeelPainterClass)
  : TdxPSReportGroupLookAndFeelPainter;
begin
  Result := AClass.Create(Self);
...
function TdxPSReportRenderer.FindReportGroupLookAndFeelPainter
  (AClass: TdxPSReportGroupLookAndFeelPainterClass)
  : TdxPSReportGroupLookAndFeelPainter;
var
  I: Integer;
...
function TdxPSReportRenderer.GetBorderPainterItem(Index: Integer)
  : TdxPSCellBorderPainter;
begin
...
function TdxPSReportRenderer.GetGroupLookAndFeelPainter(Index: Integer)
  : TdxPSReportGroupLookAndFeelPainter;
begin
  Result := TdxPSReportGroupLookAndFeelPainter
    (FGroupLookAndFeelPainters[Index]);
end;
...
procedure TdxPSReportRenderer.PrepareFont(AFont: TFont;
  AAdjustOnScale: Boolean);
begin
  dxPSScaleFontEx(AFont, AFont.Height, GetUnitsPerInchEx(AAdjustOnScale),
    ReportLink.PixelsPerInch);
end;
...
begin
  Canvas.SetCanvasExts(PageRenderInfo.PageSize, MappingMode[FUseIsotropicMode],
    RenderInfo.WindowScalePair.Numerator,
    RenderInfo.WindowScalePair.Denominator, ViewPortRect);
end;
...
begin
  ...
  else if Index < Parent.DataItemCount - 1 then
...
procedure TdxReportVisualItem.AdjustContent
  (ACanvas: TdxPSReportRenderCustomCanvas);
begin
end;
...
begin
  ...
  begin
    ...
    else if IsBackgroundDrawn then
...
begin
  ...
  try
    ...
    for I := BackgroundBitmapTileStartIndexX to
      BackgroundBitmapTileStopIndexX do
      for J := BackgroundBitmapTileStartIndexY to
        BackgroundBitmapTileStopIndexY do
      begin
...
procedure TdxReportVisualItem.DrawBorders
  (ACanvas: TdxPSReportRenderCustomCanvas);
var
  ABorderBounds: TRect;
begin
  ...
  if IsShadowDrawn then
    BorderPainter.DrawShadow(ACanvas, ABorderBounds, ShadowDepth, ShadowColor,
      ParentColor);
end;
...
function TdxReportVisualItem.GetInnerBounds
  (ACanvas: TdxPSReportRenderCustomCanvas): TRect;
begin
  Result := GetInnerBoundsRelativeTo(ACanvas, BoundsRect);
end;

function TdxReportVisualItem.GetOuterBounds
  (ACanvas: TdxPSReportRenderCustomCanvas): TRect;
begin
...
begin
  if (ALeft <> Left) or (ATop <> Top) or (AWidth <> Width) or (AHeight <> Height)
  then
  begin
...
function TdxReportVisualItem.MeasureHeight
  (ACanvas: TdxPSReportRenderCustomCanvas): Integer;
begin
  Result := MeasureBordersHeight(ACanvas) + MeasureContentHeight(ACanvas);
end;

function TdxReportVisualItem.MeasureWidth
  (ACanvas: TdxPSReportRenderCustomCanvas): Integer;
begin
...
procedure TdxReportVisualItem.ConvertCoords(APixelsNumerator, APixelsDenominator
  : Integer);
begin
...
function TdxReportVisualItem.GetBackgroundBitmapTileBounds(Col,
  Row: Integer): TRect;
begin
  Result := Bounds(Left + BackgroundBitmapWidth * Col,
    Top + BackgroundBitmapHeight * Row, BackgroundBitmapWidth,
...
function TdxReportVisualItem.GetBorderEdgeClass(ASide: TdxCellSide)
  : TdxPSCellBorderClass;
begin
  Result := BorderClass;
end;

function TdxReportVisualItem.GetBorderEdgeBounds(ASide: TdxCellSide;
  const AOuterRect: TRect): TRect;
begin
  Result := AOuterRect;
  with Result do
    case ASide of
...
function TdxReportVisualItem.GetBorderEdgeSalient(ASide: TdxCellSide;
  ASalient: TdxPSCellBorderSalientType): Integer;
begin
  Result := BorderEdgeClasses[ASide].GetBorderEdgeSalient(ASide, ASalient);
end;

function TdxReportVisualItem.GetBorderEdgeThickness(ASide: TdxCellSide)
  : Integer;
begin
  Result := BorderEdgeClasses[ASide].Thickness;
end;

function TdxReportVisualItem.GetBorderBounds
  (ACanvas: TdxPSReportRenderCustomCanvas): TRect;
begin
  Result := FBoundsRect;
end;
...
procedure TdxReportVisualItem.InitBorderPainter(ABorderPainter
  : TdxPSCellBorderPainter);
begin
...
begin
  Result := (Width + Abs(BackgroundBitmapTileOrigin.X))
    div BackgroundBitmapWidth;
end;

function TdxReportVisualItem.GetBackgroundBitmapTileStopIndexY: Integer;
begin
  Result := (Height + Abs(BackgroundBitmapTileOrigin.Y))
    div BackgroundBitmapHeight;
end;
...
begin
  Result := dxPSFillPatternFactory.Items[ContentPattern, IsPrinting]
    .Brush.Handle;
end;
...
begin
  SetBounds(Value.Left, Value.Top, Value.Right - Value.Left,
...
procedure TdxReportVisualItem.SetCellSideColors(ASide: TdxCellSide;
  AValue: TColor);
begin
...
begin
  ...
  try
    ...
    begin
      R := DrawRect;
      Dec(R.Left, BorderClass.Thickness * LineThickness);
      // BorderClass.Thickness - v3.2
      Dec(R.Top, BorderClass.Thickness * LineThickness);
      // BorderClass.Thickness - v3.2
      ACanvas.IntersectClipRgn(R);
    end;
    ACanvas.SaveClipRgn;
...
procedure TdxReportCell.DrawNestedDataItems
  (ACanvas: TdxPSReportRenderCustomCanvas; const OriginRect: TRect;
  AStage: TdxPSRenderStages);
...
function TdxReportCell.ExcludeNestedItems
  ...
  function ExcludeNestedCells(ACanvas: TdxPSReportRenderCustomCanvas;
  ...
  function ExcludeNestedDataItems(ACanvas: TdxPSReportRenderCustomCanvas;
    const R: TRect): Integer;
  var
    I: Integer;
  begin
...
function TdxReportCell.GetBorderOuterBounds
  (ACanvas: TdxPSReportRenderCustomCanvas): TRect;
begin
  Result := BoundsRect;
  OffsetRect(Result, -Result.Left, -Result.Top);
  Result := GetBorderOuterBoundsRelativeTo(ACanvas,
    GetOuterBoundsRelativeTo(ACanvas, Result));
end;

function TdxReportCell.GetInnerBounds
  (ACanvas: TdxPSReportRenderCustomCanvas): TRect;
begin
  Result := BoundsRect;
  OffsetRect(Result, -Result.Left, -Result.Top);
...
function TdxReportCell.GetOuterBounds
  (ACanvas: TdxPSReportRenderCustomCanvas): TRect;
begin
  Result := BoundsRect;
  OffsetRect(Result, -Result.Left, -Result.Top);
...
function TdxReportCell.MeasureHeight
  (ACanvas: TdxPSReportRenderCustomCanvas): Integer;
begin
  Result := Height;
end;

function TdxReportCell.MeasureWidth
  (ACanvas: TdxPSReportRenderCustomCanvas): Integer;
begin
  Result := Width;
end;
...
procedure TdxReportCell.MoveItem(AnItem: TdxReportItem;
...
function TdxReportCell.AddDataItem(AClass: TdxReportCellDataClass)
  : TAbstractdxReportCellData;
begin
  Result := AClass.Create(Self);
end;
...
function TdxReportCell.FindDataItemByData(const AData: Int64;
  var ADataItem: TAbstractdxReportCellData): Boolean;
var
  I: Integer;
begin
...
procedure TdxReportCell.ConvertCoords(APixelsNumerator, APixelsDenominator
  : Integer);
var
  I: Integer;
begin
...
function TdxReportCell.GetBackgroundBounds
  (ACanvas: TdxPSReportRenderCustomCanvas): TRect;
var
  R: TRect;
begin
...
function TdxReportCell.GetBorderBounds
  (ACanvas: TdxPSReportRenderCustomCanvas): TRect;
begin
...
constructor TdxPSReportGroupLookAndFeelPainter.Create
  (ARenderer: TdxPSReportRenderer);
begin
  inherited Create;
  FRenderer := ARenderer;
end;

procedure TdxPSReportGroupLookAndFeelPainter.Paint
  (ACanvas: TdxPSReportRenderCustomCanvas);
begin
end;

procedure TdxPSReportGroupLookAndFeelPainter.DrawBorders
  (ACanvas: TdxPSReportRenderCustomCanvas);
begin
end;

procedure TdxPSReportGroupLookAndFeelPainter.DrawCaption
  (ACanvas: TdxPSReportRenderCustomCanvas);
begin
  ...
  begin
    ...
    if Group.CheckBoxVisible then
      case Group.CaptionAlignment of
        ...
        taCenterX:
          OffsetRect(R, (R.Right - R.Left - Group.CaptionTextWidth +
            ACheckWidth) div 2, 0);
        taRight:
        end;
      end;
    ...
    begin
      ...
      if ACanvas.IsRectVisible(R) then
        Renderer.DrawText(ACanvas, R, 1, 0, 0, Group.CaptionText,
          LookAndFeel.CaptionFont, LookAndFeel.GetCaptionColor,
          Group.CaptionAlignment, taCenterY, not Group.CaptionTransparent,
          False, False, False, False, True);
    end;

    procedure TdxPSReportGroupLookAndFeelPainter.DrawCheckBox
      (ACanvas: TdxPSReportRenderCustomCanvas);
    var
      R: TRect;
    begin
      R := LookAndFeel.GetCheckBounds(Group);
      Renderer.DrawCheckBox(ACanvas, R, Group.CheckBoxChecked, True, False,
        cbesUltraFlat);
    end;

    procedure TdxPSReportGroupLookAndFeelPainter.Initialize
      (ALookAndFeel: TdxPSReportGroupLookAndFeel; AGroup: TdxReportGroup);
    begin
      FGroup := AGroup;
    ...
    function TdxPSReportGroupLookAndFeelPainter.LookAndFeel
      : TdxPSReportGroupLookAndFeel;
    begin
      Result := FLookAndFeel;
    end;
    ...
    constructor TdxPSReportGroupLookAndFeel.Create(AReportCells
      : TdxReportCells);
    begin
      inherited Create;
    ...
    procedure TdxPSReportGroupLookAndFeel.AdjustBorderOuterBounds(var R: TRect;
      AGroup: TdxReportGroup);
    begin
    ...
    class function TdxPSReportGroupLookAndFeel.BorderClass
      : TdxPSCellBorderClass;
    begin
    ...
    procedure TdxPSReportGroupLookAndFeel.Prepare
      (ACanvas: TdxPSReportRenderCustomCanvas);
    begin
      FCaptionHeight := 2 * Renderer.CalcTextPatternHeight(ACanvas,
        CaptionFont) div 2;
    end;

    procedure TdxPSReportGroupLookAndFeel.ConvertCoords(APixelsNumerator,
      APixelsDenominator: Integer);
    begin
      FCaptionHeight := MulDiv(FCaptionHeight, APixelsNumerator,
        APixelsDenominator);
      FCaptionIndent := MulDiv(FCaptionIndent, APixelsNumerator,
        APixelsDenominator);
    end;
    ...
    function TdxPSReportGroupLookAndFeel.GetBorderEdgeThickness
    ...
    function TdxPSReportGroupLookAndFeel.GetCaptionAreaHeight
      (AGroup: TdxReportGroup): Integer;
    begin
      Result := GetCaptionHeight(AGroup);
    end;

    function TdxPSReportGroupLookAndFeel.GetCaptionBounds
      (AGroup: TdxReportGroup): TRect;
    begin
    ...
    function TdxPSReportGroupLookAndFeel.GetCaptionHeight
      (AGroup: TdxReportGroup): Integer;
    begin
    ...
    function TdxPSReportGroupLookAndFeel.GetCaptionLeftRestSpaceBounds
      (AGroup: TdxReportGroup): TRect;
    begin
    ...
    function TdxPSReportGroupLookAndFeel.GetCaptionRightRestSpaceBounds
      (AGroup: TdxReportGroup): TRect;
    begin
      if AGroup.Transparent then
        Result := cxNullRect
    ...
    function TdxPSReportGroupLookAndFeel.GetCaptionTextBounds
      (AGroup: TdxReportGroup): TRect;
    var
      TextWidth: Integer;
    begin
    ...
    function TdxPSReportGroupLookAndFeel.GetCheckBounds
      (AGroup: TdxReportGroup): TRect;
    begin
    ...
    begin
      Result := MulDiv(dxPSGlbl.CheckWidth, PixelsNumerator,
        Screen.PixelsPerInch);
    end;

    function TdxPSReportGroupLookAndFeel.GetBorderSides(AGroup: TdxReportGroup)
      : TdxCellSides;
    begin
      Result := DefaultBorderSides;
    end;

    function TdxPSReportGroupLookAndFeel.GetPainter
      : TdxPSReportGroupLookAndFeelPainter;
    begin
      Result := Renderer.GetReportGroupLookAndFeelPainter(GetPainterClass);
    end;

    class function TdxPSReportGroupLookAndFeel.GetPainterClass
      : TdxPSReportGroupLookAndFeelPainterClass;
    begin
      Result := nil;
      // Actually method must be declared as "abstract" but "C++" syntax does not allow us to use "static virtual abstract" methods
    end;
    ...
    class function TdxPSReportGroupNullLookAndFeel.BorderClass
      : TdxPSCellBorderClass;
    begin
      Result := TdxPSCellUltraFlatBorder;
    end;

    class function TdxPSReportGroupNullLookAndFeel.DefaultBorderSides
      : TdxCellSides;
    begin
      Result := [];
    end;
    ...
    function TdxPSReportGroupNullLookAndFeel.GetCaptionHeight
      (AGroup: TdxReportGroup): Integer;
    begin
      Result := 0;
    end;

    class function TdxPSReportGroupNullLookAndFeel.GetPainterClass
      : TdxPSReportGroupLookAndFeelPainterClass;
    begin
    ...
    function TdxPSReportGroupStandardLookAndFeelPainter.LookAndFeel
      : TdxPSReportGroupStandardLookAndFeel;
    begin
    ...
    class function TdxPSReportGroupStandardLookAndFeel.BorderClass
      : TdxPSCellBorderClass;
    begin
      Result := TdxPSCellEtchedBorder;
    end;
    ...
    class function TdxPSReportGroupStandardLookAndFeel.GetPainterClass
      : TdxPSReportGroupLookAndFeelPainterClass;
    begin
    ...
    procedure TdxPSReportGroupPanelStyleLookAndFeel.AdjustBorderOuterBounds
      (var R: TRect; AGroup: TdxReportGroup);
    begin
      // do nothing
    end;
    ...
    class function TdxPSReportGroupPanelStyleLookAndFeel.GetPainterClass
      : TdxPSReportGroupLookAndFeelPainterClass;
    begin
    ...
    procedure TdxPSReportGroupPanelStyleLookAndFeelPainter.Paint
      (ACanvas: TdxPSReportRenderCustomCanvas);
    begin
      DrawCaptionText(ACanvas);
      if Group.IsBordersDrawn then
    ...
    class function TdxPSReportGroupOfficeLookAndFeel.DefaultBorderSides
      : TdxCellSides;
    begin
      Result := [csTop];
    end;
    ...
    procedure TdxPSReportGroupWebLookAndFeelPainter.Paint
      (ACanvas: TdxPSReportRenderCustomCanvas);
    begin
      DrawBorders(ACanvas);
      DrawCaptionText(ACanvas);
    ...
    begin
      R := Group.BoundsRect;
      OffsetRect(R, -R.Left, -R.Top);
      Renderer.FrameRect(ACanvas, R, LookAndFeel.BorderColor, Group.CellSides,
        LookAndFeel.BorderThickness);
    end;
    ...
    function TdxPSReportGroupWebLookAndFeelPainter.LookAndFeel
      : TdxPSReportGroupWebLookAndFeel;
    begin
    ...
    constructor TdxPSReportGroupWebLookAndFeel.Create
    ...
    class function TdxPSReportGroupWebLookAndFeel.BorderClass
      : TdxPSCellBorderClass;
    begin
      Result := TdxPSCellUltraFlatBorder;
    end;
    ...
    procedure TdxPSReportGroupWebLookAndFeel.ConvertCoords(APixelsNumerator,
      APixelsDenominator: Integer);
    begin
      inherited;
      CaptionSeparatorThickness := MulDiv(CaptionSeparatorThickness,
    ...
    procedure TdxPSReportGroupWebLookAndFeel.WriteData
    ...
    function TdxPSReportGroupWebLookAndFeel.GetBorderEdgeThickness
      (AGroup: TdxReportGroup; ASide: TdxCellSide): Integer;
    begin
      if ASide = csTop then
    ...
    function TdxPSReportGroupWebLookAndFeel.GetCaptionAreaHeight
      (AGroup: TdxReportGroup): Integer;
    begin
      Result := inherited GetCaptionAreaHeight(AGroup) +
        CaptionSeparatorThickness;
    end;

    function TdxPSReportGroupWebLookAndFeel.GetCaptionBounds
      (AGroup: TdxReportGroup): TRect;
    begin
      if AGroup.ShowCaption then
      begin
        Result := AGroup.BoundsRect;
        OffsetRect(Result, -Result.Left, -Result.Top);
        InflateRect(Result, -BorderThickness * Renderer.LineThickness,
          -BorderThickness * Renderer.LineThickness);
        Result.Bottom := Result.Top + GetCaptionHeight(AGroup);
      end
      else
        Result := cxNullRect;
    ...
    function TdxPSReportGroupWebLookAndFeel.GetCaptionLeftRestSpaceBounds
      (AGroup: TdxReportGroup): TRect;
    begin
      Result := cxNullRect;
    end;

    function TdxPSReportGroupWebLookAndFeel.GetCaptionRightRestSpaceBounds
      (AGroup: TdxReportGroup): TRect;
    begin
      Result := cxNullRect;
    end;

    function TdxPSReportGroupWebLookAndFeel.GetCaptionSeparatorBounds
      (AGroup: TdxReportGroup): TRect;
    begin
      Result := GetCaptionBounds(AGroup);
      if AGroup.ShowCaption then
    ...
    function TdxPSReportGroupWebLookAndFeel.GetCaptionTextBounds
      (AGroup: TdxReportGroup): TRect;
    begin
      Result := GetCaptionBounds(AGroup);
    end;

    class function TdxPSReportGroupWebLookAndFeel.GetPainterClass
      : TdxPSReportGroupLookAndFeelPainterClass;
    begin
    ...
    begin
      Result := FBorderColor;
      if Result = clDefault then
        Result := ReportCells.GroupBorderColor;
    end;
    ...
    begin
      ...
      if Result = clDefault then
        Result := ReportCells.GroupCaptionColor;
    end;
    ...
    begin
      ...
      if Result = clDefault then
        Result := ReportCells.GroupCaptionSeparatorColor;
    end;

    procedure TdxPSReportGroupWebLookAndFeel.SetCaptionSeparatorThickness
      (Value: Integer);
    begin
      ...
      begin
        ...
        begin
          ...
          if FLookAndFeel <> nil then
            Self.FLookAndFeel := Self.ReportCells.FindGroupLookAndFeelByData
              (FLookAndFeel.Data)
          else
    ...
    procedure TdxReportGroup.DrawBorders
      (ACanvas: TdxPSReportRenderCustomCanvas);
    begin
    ...
    procedure TdxReportGroup.CalculateCaptionTextWidth
      (ACanvas: TdxPSReportRenderCustomCanvas);
    var
      AFont: TFont;
    begin
      ...
      begin
        ...
        FCaptionTextWidth := Renderer.CalcTextWidth(ACanvas,
          CaptionText, AFont);
    ...
    function TdxReportGroup.GetBorderOuterBounds
      (ACanvas: TdxPSReportRenderCustomCanvas): TRect;
    begin
    ...
    procedure TdxReportGroup.ConvertCoords(APixelsNumerator, APixelsDenominator
      : Integer);
    begin
      inherited ConvertCoords(APixelsNumerator, APixelsDenominator);
      FCaptionTextWidth := MulDiv(FCaptionTextWidth, APixelsNumerator,
        APixelsDenominator);
    end;

    procedure TdxReportGroup.InternalDrawBorders
      (ACanvas: TdxPSReportRenderCustomCanvas);
    begin
      inherited DrawBorders(ACanvas);
    end;
    ...
    function TdxReportGroup.GetBorderEdgeSalient(ASide: TdxCellSide;
      ASalient: TdxPSCellBorderSalientType): Integer;
    begin
      if LookAndFeel <> nil then
        if ASalient = bstOuter then
    ...
    function TdxReportGroup.InternalGetBorderEdgeThickness
    ...
    begin
      Result := TcxTextAlignX((Format and dxPSGlbl.dxFormatTextAlignXMask)
        shr dxPSGlbl.dxFormatTextAlignXOffset);
    end;
    ...
    begin
      Format := Format and not dxPSGlbl.dxFormatTextAlignXMask or
        (Byte(Value) shl dxPSGlbl.dxFormatTextAlignXOffset);
    end;
    ...
    function TdxReportCells.CreateGroupLookAndFeel
      (AClass: TdxPSReportGroupLookAndFeelClass; ACheckExisting: Boolean = True)
      : TdxPSReportGroupLookAndFeel;
    begin
    ...
    function TdxReportCells.FindGroupLookAndFeelByClass
      (AClass: TdxPSReportGroupLookAndFeelClass): TdxPSReportGroupLookAndFeel;
    var
      I: Integer;
    begin
    ...
    function TdxReportCells.FindGroupLookAndFeelByData(AData: Pointer)
      : TdxPSReportGroupLookAndFeel;
    var
      I: Integer;
    begin
    ...
    function TdxReportCells.IndexOfReportGroupLookAndFeel
      (ALookAndFeel: TdxPSReportGroupLookAndFeel): Integer;
    begin
    ...
    procedure TdxReportCells.AssignLookAndFeels(Source: TdxReportCells);
      ...
      begin
        if FindGroupLookAndFeelByData(Source.Data) <> nil then
          Exit;
        ADest := CreateGroupLookAndFeel
          (TdxPSReportGroupLookAndFeelClass(Source.ClassType));
        ADest.Assign(Source);
    ...
    procedure TdxReportCells.CheckStorageCompatibility
      (AReader: TdxPSDataReader);
    begin
    ...
    procedure TdxReportCells.ConvertCoords(APixelsNumerator, APixelsDenominator
      : Integer);
    var
      I: Integer;
    begin
    ...
    function TdxReportCells.GetCellTopLevelParent(AnItem: TdxReportItem)
      : TdxReportCell;
    ...
    begin
      ...
      if Result <> nil then
        while (Result.Parent <> nil) and not IsParentInTopLevels
          (Result.Parent) do
    ...
    function TdxReportCells.IndexOfImageList(AnImageList
      : TCustomImageList): Integer;
    begin
    ...
    function TdxReportCells.GetLookAndFeel(Index: Integer)
      : TdxPSReportGroupLookAndFeel;
    begin
    ...
    function TAbstractdxReportCellData.GetAbsoluteEffectiveBounds
      (ACanvas: TdxPSReportRenderCustomCanvas;
      AStage: TdxPSRenderStages): TRect;
    begin
    ...
    begin
      Result := CXTO_EXPANDTABS or CXTO_PATTERNEDTEXT or CXTO_CHARBREAK or
        CXTO_EDITCONTROL;
    end;
    ...
    const
      ...
      dxPreventLeftExceed: array [Boolean] of UINT = (0,
        CXTO_PREVENT_LEFT_EXCEED);
      dxPreventTopExceed: array [Boolean] of UINT = (0,
        CXTO_PREVENT_TOP_EXCEED);
      dxWordBreak: array [Boolean] of UINT = (0, CXTO_WORDBREAK);
    begin
      Result := DefaultDTFormat or dxPreventAutoIndents[PreventAutoIndents] or
        cxMakeFormat(TextAlignX, TextAlignY) or dxEndEllipsis[EndEllipsis] or
        dxHidePrefix[HidePrefix] or dxPreventLeftExceed[PreventLeftTextExceed]
        or dxPreventTopExceed[PreventTopTextExceed] or dxWordBreak[Multiline] or
        dxNoClip[NoClip];
    end;

    function TAbstractdxReportCellData.HasPreventAutoIndentsProperty
      (const AVersion: TdxPSVersion): Boolean;
    begin
    ...
    function TAbstractdxReportCellData.IsDrawn
      (ACanvas: TdxPSReportRenderCustomCanvas; AStage: TdxPSRenderStages;
      const ARect: TRect): Boolean;
    var
      R: TRect;
    begin
      Result := IntersectRect(R, GetAbsoluteEffectiveBounds(ACanvas,
        AStage), ARect);
    end;

    function TAbstractdxReportCellData.GetSortOrder: TdxCellSortOrder;
    begin
      Result := TdxCellSortOrder((Format and dxPSGlbl.dxFormatSortOrderMask)
        shr dxPSGlbl.dxFormatSortOrderOffset);
    end;
    ...
    begin
      Result := TcxTextAlignY((Format and dxPSGlbl.dxFormatTextAlignYMask)
        shr dxPSGlbl.dxFormatTextAlignYOffset);
    end;
    ...
    procedure TAbstractdxReportCellData.SetPreventLeftTextExceed
      (Value: Boolean);
    begin
    ...
    begin
      Format := Format and not dxPSGlbl.dxFormatSortOrderMask or
        (Byte(Value) shl dxPSGlbl.dxFormatSortOrderOffset);
    end;
    ...
    begin
      Format := Format and not dxPSGlbl.dxFormatTextAlignYMask or
        (Byte(Value) shl dxPSGlbl.dxFormatTextAlignYOffset);
    end;
    ...
    procedure TdxReportCellText.DrawSortMark
      (ACanvas: TdxPSReportRenderCustomCanvas);
    var
      R: TRect;
    begin
    ...
    procedure TdxReportCellText.DrawText
      (ACanvas: TdxPSReportRenderCustomCanvas);
    var
        ...
        begin
          ...
          try
            ...
            if ATextParams.PatternedText then
              Renderer.DrawTextEx(ACanvas, ARect, 0, AText, Font, DTFormat,
                Indents.Rect)
            else
            begin
              ...
              try
                ...
                AHelper.Calculate(cxSize(cxPrepareRect(ARect, ATextParams, 0, 0)
                  ), AText, Multiline, DTFormat);
                Renderer.DrawTextEx(ACanvas, ARect, 0, AText, AHelper.Font,
                  DTFormat, Indents.Rect, AHelper.LineSpacing);
              finally
                AHelper.Free;
              end;
            end;
    ...
    function TdxReportCellText.CalculateLineCount
      (ACanvas: TdxPSReportRenderCustomCanvas): Integer;
    begin
      Result := Renderer.CalcTextLineCount(ACanvas, Text, Font,
        Width - Indents.Left - Indents.Right);
    end;

    function TdxReportCellText.MeasureContentHeight
      (ACanvas: TdxPSReportRenderCustomCanvas): Integer;
    begin
      Result := Max(SortMarkRegionSize, cxMarginsHeight(Indents.Rect) +
        MeasureTextHeight(ACanvas));
      if Result > 0 then
      begin
        if csTop in CellSides then
    ...
    function TdxReportCellText.MeasureContentWidth
      (ACanvas: TdxPSReportRenderCustomCanvas): Integer;
    begin
    ...
    function TdxReportCellText.MeasureFontHeight
      (ACanvas: TdxPSReportRenderCustomCanvas): Integer;
    begin
      Result := Max(Renderer.CalcTextPatternHeight(ACanvas, Font),
        SortMarkRegionSize);
      if Result <> 0 then
    ...
    function TdxReportCellText.MeasureTextHeight
      (ACanvas: TdxPSReportRenderCustomCanvas): Integer;
    var
      R: TRect;
    begin
      R := Rect(0, 0, cxRectWidth(GetTextBounds(ACanvas)) -
        cxMarginsWidth(Indents.Rect), 5);
      Result := Renderer.CalcTextRect(ACanvas, Text, R, GetDTFormat or
        CXTO_CALCROWCOUNT or CXTO_AUTOINDENTS, Font)
    end;

    function TdxReportCellText.MeasureTextWidth
      (ACanvas: TdxPSReportRenderCustomCanvas): Integer;
    begin
      if Multiline then
        Result := Width
    ...
    procedure TdxReportCellText.ConvertCoords(APixelsNumerator,
      APixelsDenominator: Integer);
    begin
      inherited ConvertCoords(APixelsNumerator, APixelsDenominator);
      FSortMarkRegionSize := MulDiv(FSortMarkRegionSize, APixelsNumerator,
        APixelsDenominator);
      FIndents.Rect := cxRectScale(FIndents.Rect, APixelsNumerator,
        APixelsDenominator);
    end;

    function TdxReportCellText.GetSortMarkBounds
      (ACanvas: TdxPSReportRenderCustomCanvas): TRect;
    begin
      Result := GetInnerBounds(ACanvas);
    ...
    function TdxReportCellText.GetTextBounds
      (ACanvas: TdxPSReportRenderCustomCanvas): TRect;
    begin
      Result := GetInnerBounds(ACanvas);
      if IsSortMarkDrawn then
    ...
    begin
      ...
      if Source is TdxReportCellImageContainer then
        ImageTransparent := TdxReportCellImageContainer(Source)
          .ImageTransparent;
    end;
    ...
    procedure TdxReportCellImageContainer.DrawImage
      (ACanvas: TdxPSReportRenderCustomCanvas);
    begin
    end;
    ...
    procedure TdxReportCellImageContainer.GetImageSizes(var AImageWidth,
    ...
    begin
      Result := inherited IsBackgroundDrawn and not IsImageDrawn and
        not IsBackgroundBitmapDrawn;
    end;
    ...
    begin
      Result := (Format and dxPSGlbl.dxFormatImageTransparent)
        = dxPSGlbl.dxFormatImageTransparent;
    end;

    procedure TdxReportCellImageContainer.SetImageTransparent(Value: Boolean);
    const
      dxImageTransparent: array [Boolean] of DWORD = (0,
        dxPSGlbl.dxFormatImageTransparent);
    begin
      Format := Format and not dxPSGlbl.dxFormatImageTransparent or
        dxImageTransparent[Value];
    end;
    ...
    procedure TdxCustomReportCellCheck.DrawCheck
      (ACanvas: TdxPSReportRenderCustomCanvas);
    var
      R: TRect;
    begin
      R := GetCheckBounds(ACanvas);
      Renderer.DrawCheckBox(ACanvas, R, Checked, Enabled, IsRadio,
        ButtonEdgeStyle, BorderColor);
    end;

    procedure TdxCustomReportCellCheck.DrawImage
      (ACanvas: TdxPSReportRenderCustomCanvas);
    begin
      DrawCheck(ACanvas);
    end;
    ...
    function TdxCustomReportCellCheck.MeasureContentHeight
      (ACanvas: TdxPSReportRenderCustomCanvas): Integer;
    begin
      Result := Max(1 + CheckHeight + 1,
        inherited MeasureContentHeight(ACanvas));
    end;
    ...
    procedure TdxCustomReportCellCheck.ConvertCoords(APixelsNumerator,
      APixelsDenominator: Integer);
    begin
      inherited;
      FCheckSize := cxSizeScale(FCheckSize, APixelsNumerator,
        APixelsDenominator);
    end;
    ...
    procedure TdxCustomReportCellCheck.GetImageSizes(var AImageWidth,
      AImageHeight: Integer);
    begin
    ...
    function TdxCustomReportCellCheck.GetButtonEdgeStyle
      : TdxCheckButtonEdgeStyle;
    begin
      Result := TdxCheckButtonEdgeStyle
        ((Format and dxPSGlbl.dxFormatCheckButtonEdgeStyleMask)
        shr dxPSGlbl.dxFormatCheckButtonEdgeStyleOffset);
    end;
    ...
    begin
      Result := TdxCellCheckPos((Format and dxPSGlbl.dxFormatCheckPosMask)
        shr dxPSGlbl.dxFormatCheckPosOffset);
    end;
    ...
    procedure TdxCustomReportCellCheck.SetButtonEdgeStyle
      (Value: TdxCheckButtonEdgeStyle);
    begin
      Format := Format and not dxPSGlbl.dxFormatCheckButtonEdgeStyleMask or
        (Byte(Value) shl dxPSGlbl.dxFormatCheckButtonEdgeStyleOffset);
    end;
    ...
    begin
      if Value = ccpCenter then
        SetText('');
      Format := Format and not dxPSGlbl.dxFormatCheckPosMask or
        (Byte(Value) shl dxPSGlbl.dxFormatCheckPosOffset);
    end;
    ...
    procedure TdxCustomReportCellCheckImage.DrawCheck
      (ACanvas: TdxPSReportRenderCustomCanvas);
    begin
    ...
    begin
      ...
      begin
        ...
        Renderer.DrawGraphicEx(ACanvas, GetCheckBounds(ACanvas),
          GetImageAreaBounds(ACanvas), nil, 0, Renderer.FCheckBitmap, True,
          True, Color, ContentBkColor, ContentPattern, cibAlways);
      end;
    end;

    procedure TdxCustomReportCellCheckImage.GetImageSizes(var AImageWidth,
      AImageHeight: Integer);
    begin
      if HasGlyph and not Glyph.Empty and (GlyphCount <> 0) then
      begin
        AImageWidth := MulDiv(Glyph.Width div GlyphCount, PixelsNumerator,
          PixelsDenominator);
        AImageHeight := MulDiv(Glyph.Height, PixelsNumerator,
          PixelsDenominator);
      end
      else
        inherited;
    ...
    begin
      Result := (Format and dxPSGlbl.dxFormatCheckGlyphCountMask)
        shr dxPSGlbl.dxFormatCheckGlyphCountOffset;
    end;
    ...
    begin
      ...
      FIndents := Rect(dxRadioGroupBoundsIndent, dxRadioGroupBoundsIndent,
        dxRadioGroupBoundsIndent, dxRadioGroupBoundsIndent);
      ShowCaption := False;
    end;
    ...
    procedure TdxCustomReportButtonGroup.AdjustContent
      (ACanvas: TdxPSReportRenderCustomCanvas);
    type
      TViewInfo = record
        ColumnWidth: Integer;
    ...
    var
      ...
      begin
        ...
        for I := 0 to ItemCount - 1 do
          FItemSize.cX := Max(Items[I].MeasureContentWidth(ACanvas),
            FItemSize.cX);
      ...
      var
        R: TRect;
      begin
        AnItem.Visible := IntersectRect(R, AnItem.BoundsRect,
          ViewInfo.ItemsArea);
      end;
    ...
    function TdxCustomReportButtonGroup.MeasureContentHeight
      (ACanvas: TdxPSReportRenderCustomCanvas): Integer;
    begin
      Result := RowCount * (ItemSize.cy + InterRowsMinSpace) -
        InterRowsMinSpace;
    ...
    function TdxCustomReportButtonGroup.MeasureContentWidth
      (ACanvas: TdxPSReportRenderCustomCanvas): Integer;
    begin
      Result := ColumnCount * (ItemSize.cX + InterColumnsMinSpace) -
        InterColumnsMinSpace;
      Inc(Result, Indents.Left + Indents.Right);
    end;

    function TdxCustomReportButtonGroup.Add(const AText: string = '')
      : TdxCustomReportCellCheck;
    begin
    ...
    function TdxCustomReportButtonGroup.FindItem(const ACaption
      : string): Integer;
    begin
      for Result := 0 to ItemCount - 1 do
        if Items[Result].Text = ACaption then
          Exit;
      Result := -1;
    end;

    procedure TdxCustomReportButtonGroup.ConvertCoords(APixelsNumerator,
      APixelsDenominator: Integer);
    var
      R: TRect;
    begin
      ...
      InterColumnsMinSpace := MulDiv(InterColumnsMinSpace, APixelsNumerator,
        APixelsDenominator);
      InterRowsMinSpace := MulDiv(InterRowsMinSpace, APixelsNumerator,
        APixelsDenominator);
    end;
    ...
    procedure TdxCustomReportButtonGroup.ReadDataItems
      (AReader: TdxPSDataReader);
    begin
      FLocked := True;
      try
    ...
    class function TdxCustomReportButtonGroup.GetItemClass
      : TdxCustomReportCellCheckClass;
    begin
      Result := TdxCustomReportCellCheck;
    end;

    procedure TdxCustomReportButtonGroup.InitializeItem
      (AnItem: TdxCustomReportCellCheck);
    begin
    ...
    function TdxCustomReportButtonGroup.GetButtonEdgeStyle
      : TdxCheckButtonEdgeStyle;
    begin
      Result := TdxCheckButtonEdgeStyle
        ((Format and dxPSGlbl.dxFormatCheckButtonEdgeStyleMask)
    ...
    function TdxCustomReportButtonGroup.GetItem(Index: Integer)
      : TdxCustomReportCellCheck;
    begin
    ...
    procedure TdxCustomReportButtonGroup.SetButtonEdgeStyle
      (Value: TdxCheckButtonEdgeStyle);
    var
      I: Integer;
    begin
    ...
    procedure TdxCustomReportButtonGroup.SetInterColumnsMinSpace
      (Value: Integer);
    begin
    ...
    function TdxReportRadioGroup.Add(const AText: string = '')
      : TdxCustomReportCellRadio;
    begin
      Result := inherited Add(AText) as TdxCustomReportCellRadio;
    end;

    class function TdxReportRadioGroup.GetItemClass
      : TdxCustomReportCellCheckClass;
    begin
      Result := TdxReportCellRadioGroupButton;
    end;

    function TdxReportRadioGroup.GetItem(Index: Integer)
      : TdxCustomReportCellRadio;
    begin
    ...
    function TdxReportCheckGroup.Add(const AText: string = '')
      : TdxCustomReportCellCheckImage;
    begin
    ...
    class function TdxReportCheckGroup.GetItemClass
      : TdxCustomReportCellCheckClass;
    begin
      Result := TdxReportCellCheckGroupButton;
    end;

    procedure TdxReportCheckGroup.InitializeItem
      (AnItem: TdxCustomReportCellCheck);
    begin
      inherited;
    end;
    ...
    function TdxReportCheckGroup.GetItem(Index: Integer)
      : TdxCustomReportCellCheckImage;
    begin
    ...
    procedure TdxReportCheckGroup.SetItemChecked(Index: Integer;
      Value: Boolean);
    begin
      Items[Index].Checked := Value;
    end;

    procedure TdxReportCheckGroup.SetItemEnabled(Index: Integer;
      Value: Boolean);
    begin
    ...
    constructor TCustomdxReportCellImageContainer.Create
    ...
    function TCustomdxReportCellImageContainer.CreateImage
      (AGraphicClass: TGraphicClass): TGraphic;
    begin
    ...
    procedure TCustomdxReportCellImageContainer.DrawImage
      ...
      procedure DoDrawImage(AImage: TGraphic; AImageList: TCustomImageList;
        AImageIndex: Integer);
      begin
      ...
      procedure DoDrawOverlay(AImageList: TCustomImageList;
        AImageIndex: Integer);
      begin
        if (AImageList <> nil) and (AImageIndex <> -1) then
          Renderer.DrawGraphicEx(ACanvas, GetImageBounds(ACanvas),
            GetImageAreaBounds(ACanvas), AImageList, AImageIndex, nil, True,
            True, clNone, clNone, ContentPattern, ActualImageBuffering,
            ImageTransparentColor);
      end;
    ...
    function TCustomdxReportCellImageContainer.GetActualImageBuffering
      : TdxCellImageActualBuffering;
    const
      BufferingMap: array [Boolean] of TdxCellImageActualBuffering = (cibNone,
        cibAlways);
    begin
    ...
    function TCustomdxReportCellImageContainer.GetImageBuffering
      : TdxCellImageBuffering;
    begin
      Result := cibDefault;
    end;

    procedure TCustomdxReportCellImageContainer.GetImageSizes(var AImageWidth,
      AImageHeight: Integer);
    var
      ASize: TSize;
    begin
      ...
      begin
        ASize := cxSizeScale(GetOriginalImageSize, PixelsNumerator,
          PixelsDenominator);
    ...
    begin
      ...
      begin
        ...
        if ReportLink <> nil then
          Result := cxSizeScale(Result, ReportLink.PixelsPerInch,
            dxGetImageSourceDPI(ImageList));
      end
    ...
    begin
      if ImageListUsed then
        ...
        Result := Assigned(Image) and not(Image is TMetafile) and
          not(Image is TdxSmartImage);

      Result := Result and (IsTextBackgroundDrawn or IsImageBackgroundDrawn or
        not dxCanPrintTransparentImages(Renderer.Canvas));
    end;
    ...
    function TCustomdxReportCellImageContainer.PrepareImage: TcxBitmap;
      ...
      begin
        if ImageListUsed then
          Result := TcxBitmap.CreateSize(ImageList.Width,
            ImageList.Height, pf24Bit)
        else
          Result := TcxBitmap.CreateSize(cxRect(dxGetImageSize(Image)));
      end;
    ...
    begin
      ...
      begin
        ...
        Result.Canvas.StretchDraw(Result.ClientRect, Image);
      end;
    end;

    procedure TCustomdxReportCellImageContainer.PrepareImageBackground
    ...
    begin
      ARenderCanvas := TdxPSReportRenderCanvas.Create(ACanvas);
      try
        Renderer.FillRectEx(ARenderCanvas, R, Color, ContentBkColor,
          ContentPattern);
      finally
        ARenderCanvas.Free;
      end;
    ...
    procedure TCustomdxReportCellImageContainer.SetImageBuffering
      (Value: TdxCellImageBuffering);
    begin
    end;
    ...
    procedure TCustomdxReportCellImageContainer.DoReadData
      (AReader: TdxPSDataReader);
    var
    ...
    procedure TCustomdxReportCellImageContainer.DoWriteData
      (AWriter: TdxPSDataWriter);
      ...
      begin
        if ImageList <> nil then
          if (ImageList = dxPSUtl.ShellLargeImages) or
            (ImageList.HandleAllocated and
            (ImageList.Handle = dxPSUtl.ShellLargeImages.Handle)) then
            Result := imstShellLargeImageList
          else if (ImageList = dxPSUtl.ShellSmallImages) or
            (ImageList.HandleAllocated and
            (ImageList.Handle = dxPSUtl.ShellSmallImages.Handle)) then
      ...
      function RetrieveImage(ASourceType: Integer; AnImageIndex: Integer)
        : TGraphic;
      begin
        case ASourceType of
    ...
    procedure TCustomdxReportCellImageContainer.ReadData
      (AReader: TdxPSDataReader);
    begin
      inherited ReadData(AReader);
      DoReadData(AReader);
    ...
    procedure TCustomdxReportCellImageContainer.WriteData
      (AWriter: TdxPSDataWriter);
    begin
      inherited WriteData(AWriter);
      DoWriteData(AWriter);
    ...
    begin
      ...
      begin
        ...
        MakeSpaceForEmptyImage := TdxReportCellImage(Source)
          .MakeSpaceForEmptyImage;
      end;
    end;
    ...
    begin
      ...
      if ImageLayout in [ilImageTopLeft, ilImageCenterLeft, ilImageBottomLeft,
        ilImageTopRight, ilImageCenterRight, ilImageBottomRight] then
        Result := Max(inherited MeasureContentHeight(ACanvas), Result)
      else if ImageLayout in [ilImageTopCenter, ilImageBottomCenter] then
      begin
      ...
      else if IsTextDrawnForCenteredImage then
        Result := Max(Result, inherited MeasureContentHeight(ACanvas));
    end;
    ...
    begin
      ...
      if ImageLayout in [ilImageTopLeft, ilImageCenterLeft, ilImageBottomLeft,
        ilImageTopRight, ilImageCenterRight, ilImageBottomRight] then
        Inc(Result, inherited MeasureContentHeight(ACanvas))
      else if (ImageLayout in [ilImageTopCenter, ilImageBottomCenter]) or
        ((ImageLayout = ilImageCenterCenter) and IsTextDrawnForCenteredImage)
      then
        Result := Max(inherited MeasureContentWidth(ACanvas), Result);
    end;

    function TdxReportCellImage.GetImageAreaBounds
      (ACanvas: TdxPSReportRenderCustomCanvas): TRect;
    const
      MapTextAlign: array [TcxTextAlignY] of TdxImageLayout = (ilImageTopCenter,
        ilImageCenterCenter, ilImageBottomCenter, ilImageTopCenter);
    var
      R: TRect;
      W, H: Integer;
    begin
      ...
      begin
        ...
        case ImageLayout of
          ...
          begin
            ...
            begin
              Inc(Result.Left, (cxRectWidth(Result) - W) div 2 +
                Renderer.UnitsPerPixel);
            ...
            case ImageLayout of
              ...
              ilImageCenterCenter:
                if not IsTextShiftedForHorizontallyCenteredImage then
                begin
                  Inc(Result.Top, (cxRectHeight(Result) - H) div 2 +
                    Renderer.UnitsPerPixel);
          ...
          if IsTextDrawnForCenteredImage and
            not IsTextShiftedForHorizontallyCenteredImage and
            (TextAlignX = taCenterX) and
            ((MapTextAlign[TextAlignY] = ImageLayout) or
            (ImageLayout = ilImageCenterCenter)) then
            OffsetRect(Result, -(Renderer.CalcTextWidth(ACanvas, Text, Font) +
              W) div 2, 0);
    ...
    function TdxReportCellImage.GetImageBounds
      (ACanvas: TdxPSReportRenderCustomCanvas): TRect;
    var
      W, H: Integer;
    begin
    ...
    function TdxReportCellImage.GetTextBounds
      (ACanvas: TdxPSReportRenderCustomCanvas): TRect;
    var
      R: TRect;
    begin
      ...
      begin
        if not((ImageLayout in [ilImageTopCenter, ilImageCenterCenter,
          ilImageBottomCenter]) and
    ...
    begin
      Result := inherited IsImageBackgroundDrawn and MakeSpaceForEmptyImage and
        not((ImageLayout in [ilImageTopCenter, ilImageCenterCenter,
        ilImageBottomCenter]) and
    ...
    begin
      Result := inherited IsTextDrawn and
        ((ImageLayout <> ilImageCenterCenter) or IsTextDrawnForCenteredImage);
    end;
    ...
    begin
      Result := inherited IsTextBackgroundDrawn and
        (not(ImageLayout in [ilImageTopCenter, ilImageCenterCenter,
        ilImageBottomCenter]) or IsTextDrawnForCenteredImage or not HasImage);
    end;

    function TdxReportCellImage.GetImageLayout: TdxImageLayout;
    begin
      Result := TdxImageLayout((Format and dxPSGlbl.dxFormatImageLayoutMask)
        shr dxPSGlbl.dxFormatImageLayoutOffset);
    end;
    ...
    function TdxReportCellImage.
      GetIsTextShiftedForHorizontallyCenteredImage: Boolean;
    begin
      Result := GetFormatBit
        (dxPSGlbl.dxFormatIsTextShiftedForHorizontallyCenteredImage);
    end;
    ...
    begin
      Format := Format and not dxPSGlbl.dxFormatImageLayoutMask or
        (Byte(Value) shl dxPSGlbl.dxFormatImageLayoutOffset);
    end;
    ...
    procedure TdxReportCellImage.SetIsTextShiftedForHorizontallyCenteredImage
      (Value: Boolean);
    begin
      SetFormatBit
        (dxPSGlbl.dxFormatIsTextShiftedForHorizontallyCenteredImage, Value);
    end;
    ...
    function TdxReportCellGraphic.MeasureFontHeight
      (ACanvas: TdxPSReportRenderCustomCanvas): Integer;
    begin
      Result := Renderer.CalcTextPatternHeight(ACanvas,
        Renderer.RenderInfo.BaseContentFont);
    end;
    ...
    begin
      GetImageSizes(W, H);
      if (W <> 0) and (H <> 0) then
        Result := dxPSCalculateImageBounds(GetImageAreaBounds(ACanvas), W,
          H, DrawMode)
      else
        Result := cxNullRect;
    end;
    ...
    begin
      Result := TdxCellImageBuffering
        ((Format and dxPSGlbl.dxFormatGraphicBufferingMask)
        shr dxPSGlbl.dxFormatGraphicBufferingOffset);
    end;

    function TdxReportCellGraphic.GetTextBounds
      (ACanvas: TdxPSReportRenderCustomCanvas): TRect;
    begin
      Result := cxNullRect;
    end;

    procedure TdxReportCellGraphic.SetImageBuffering
      (Value: TdxCellImageBuffering);
    begin
    ...
    begin
      Result := TdxGraphicDrawMode
        ((Format and dxPSGlbl.dxFormatGraphicDrawModeMask)
        shr dxPSGlbl.dxFormatGraphicDrawModeOffset);
    end;
    ...
    begin
      Format := Format and not dxPSGlbl.dxFormatGraphicDrawModeMask or
        (Byte(Value) shl dxPSGlbl.dxFormatGraphicDrawModeOffset);
    end;
    ...
    constructor TdxPSReportCellTreeLineViewInfo.Create(AMode: TdxPSTreeLineMode;
      ACellButton: TdxReportCellExpandButton);
    begin
      FMode := AMode;
    ...
    procedure TdxPSReportCellTreeLineViewInfo.CalculateRects(const ABounds,
      AButtonRect: TRect);
    var
    ...
    begin
      ...
      FVerticalRect.Left := (VerticalRect.Left + VerticalRect.Right -
        LineThickness) div 2;
    ...
    begin
      ...
      begin
        ...
        R1 := Rect(R.Left, R.Top, R.Left + LineThickness,
          R.Top + LineThickness);
    ...
    procedure TdxPSReportCellTreeLineViewInfo.Draw
      (ACanvas: TdxPSReportRenderCustomCanvas);
    var
      ARegion: TcxRegion;
    begin
      ...
      try
        ...
        begin
          ARegion.Combine(cxRectInflate(ButtonRect, LineThickness,
            LineThickness), roSubtract);
        end;
        ARegion.Combine(CellButton.BoundsRect, roIntersect);
        Renderer.FillRgn(ACanvas, ARegion.Handle,
          CellButton.ReportCells.TreeLineColor);
      finally
        ARegion.Free;
      end;
    end;
    ...
    function TdxPSReportCellTreeLineViewInfo.GetTreeLineStyle
      : TdxPSTreeLineStyle;
    begin
    ...
    begin
      ...
      begin
        ...
        ButtonBorder3DSoft := TdxReportCellExpandButton(Source)
          .ButtonBorder3DSoft;
        ButtonBorderShadow := TdxReportCellExpandButton(Source)
          .ButtonBorderShadow;
        ButtonExpanded := TdxReportCellExpandButton(Source).ButtonExpanded;
        ButtonInteriorColor := TdxReportCellExpandButton(Source)
          .ButtonInteriorColor;
        ButtonSize := TdxReportCellExpandButton(Source).ButtonSize;
        ButtonTransparent := TdxReportCellExpandButton(Source)
          .ButtonTransparent;
    ...
    begin
      ...
      Renderer.DrawExpandButton(ACanvas, R, ButtonExpanded, ShowButtonBorder,
        ButtonBorder3D, ButtonBorder3DSoft, ButtonBorderShadow,
        not ButtonTransparent, ReportCells.ExpandButtonBorderColor,
        ButtonInteriorColor);
    end;

    procedure TdxReportCellExpandButton.DrawTreeLines
      (ACanvas: TdxPSReportRenderCustomCanvas);
    var
      ATreeLinesInfo: TdxPSReportCellTreeLineViewInfo;
    begin
      ATreeLinesInfo := TdxPSReportCellTreeLineViewInfo.Create
        (TreeLineMode, Self);
      try
    ...
    procedure TdxReportCellExpandButton.ConvertCoords(APixelsNumerator,
      APixelsDenominator: Integer);
    begin
      inherited ConvertCoords(APixelsNumerator, APixelsDenominator);
    ...
    function TdxReportCellExpandButton.GetButtonAlignHorz
      : TdxReportCellExpandButtonAlignHorz;
    begin
      Result := bahCenter;
    end;

    function TdxReportCellExpandButton.GetButtonAlignVert
    ...
    begin
      if Renderer <> nil then
        Result := Rect(LineThickness, LineThickness, LineThickness,
          LineThickness)
      else
        Result := cxNullRect;
    end;

    procedure TdxReportCellExpandButton.SetButtonAlignHorz
      (Value: TdxReportCellExpandButtonAlignHorz);
    begin
    end;

    procedure TdxReportCellExpandButton.SetButtonAlignVert
    ...
    begin
      Result := TdxPSTreeLineMode((Format and dxPSGlbl.dxFormatTreeLineModeMask)
        shr dxPSGlbl.dxFormatTreeLineModeOffset);
    end;
    ...
    procedure TdxReportCellExpandButton.SetTreeLineMode
      (Value: TdxPSTreeLineMode);
    begin
      Format := Format and not dxPSGlbl.dxFormatTreeLineModeMask or
        (Byte(Value) shl dxPSGlbl.dxFormatTreeLineModeOffset);
    end;

    { TdxReportCellExpandButtonEx }

    function TdxReportCellExpandButtonEx.GetButtonAlignHorz
      : TdxReportCellExpandButtonAlignHorz;
    begin
      Result := TdxReportCellExpandButtonAlignHorz
        ((FormatEx and dxPSGlbl.dxFormatExButtonAlignHorzMask)
        shr dxPSGlbl.dxFormatExButtonAlignHorzOffset);
    end;

    function TdxReportCellExpandButtonEx.GetButtonAlignVert
      : TdxReportCellExpandButtonAlignVert;
    begin
      Result := TdxReportCellExpandButtonAlignVert
        ((FormatEx and dxPSGlbl.dxFormatExButtonAlignVertMask)
        shr dxPSGlbl.dxFormatExButtonAlignVertOffset);
    end;
    ...
    procedure TdxReportCellExpandButtonEx.SetButtonAlignHorz
      (Value: TdxReportCellExpandButtonAlignHorz);
    begin
      FormatEx := FormatEx and not dxPSGlbl.dxFormatExButtonAlignHorzMask or
        (Byte(Value) shl dxPSGlbl.dxFormatExButtonAlignHorzOffset);
    end;

    procedure TdxReportCellExpandButtonEx.SetButtonAlignVert
      (Value: TdxReportCellExpandButtonAlignVert);
    begin
      FormatEx := FormatEx and not dxPSGlbl.dxFormatExButtonAlignVertMask or
        (Byte(Value) shl dxPSGlbl.dxFormatExButtonAlignVertOffset);
    end;
    ...
    constructor TdxPSExplorerChangeNotifier.Create
    ...
    procedure TdxPSExplorerChangeNotifier.SetExplorer
      (Value: TCustomdxPSExplorer);
    begin
    ...
    procedure TdxPSExplorerChangeNotifierAdapter.ExplorerRefresh
      (AStage: TdxPSExplorerRefreshStage);
    begin
    end;

    procedure TdxPSExplorerChangeNotifierAdapter.FolderPopulated
      (AFolder: TdxPSExplorerFolder);
    begin
    end;

    procedure TdxPSExplorerChangeNotifierAdapter.ItemAdded
      (AnItem: TCustomdxPSExplorerItem);
    begin
    end;

    procedure TdxPSExplorerChangeNotifierAdapter.ItemDataLoaded
      (AnItem: TdxPSExplorerItem);
    begin
    end;

    procedure TdxPSExplorerChangeNotifierAdapter.ItemDataUnloaded
      (AnItem: TdxPSExplorerItem);
    begin
    end;

    procedure TdxPSExplorerChangeNotifierAdapter.ItemDeleted
      (AnItem: TCustomdxPSExplorerItem);
    begin
    end;

    procedure TdxPSExplorerChangeNotifierAdapter.ItemParentChanged
      (AnItem: TCustomdxPSExplorerItem);
    begin
    end;

    procedure TdxPSExplorerChangeNotifierAdapter.ItemPropertiesChanged
      (AnItem: TCustomdxPSExplorerItem);
    begin
    end;

    procedure TdxPSExplorerChangeNotifierAdapter.ItemRenamed
      (AnItem: TCustomdxPSExplorerItem);
    begin
    end;
    ...
    constructor TdxPSExplorerTreeChangeNotifier.Create(ATreeContainer
      : TCustomdxPSExplorerTreeContainer; ARegister: Boolean = True);
    begin
    ...
    procedure TdxPSExplorerTreeChangeNotifier.ExplorerRefresh
      (AStage: TdxPSExplorerRefreshStage);
    begin
      case AStage of
        ersBefore:
        ...
        ersAfter:
          begin
            if Explorer <> nil then
              Explorer.BuildTree(TreeContainer);
    ...
    procedure TdxPSExplorerTreeChangeNotifier.FolderPopulated
      (AFolder: TdxPSExplorerFolder);
    begin
      if Explorer <> nil then
        Explorer.PopulateTreeFolder(TreeContainer, AFolder);
    end;

    procedure TdxPSExplorerTreeChangeNotifier.ItemAdded
      (AnItem: TCustomdxPSExplorerItem);
    begin
    ...
    procedure TdxPSExplorerTreeChangeNotifier.ItemDataLoaded
      (AnItem: TdxPSExplorerItem);
    begin
    ...
    procedure TdxPSExplorerTreeChangeNotifier.ItemDataUnloaded
      (AnItem: TdxPSExplorerItem);
    begin
      TreeContainer.ItemDataUnloaded(AnItem);
    end;

    procedure TdxPSExplorerTreeChangeNotifier.ItemDeleted
      (AnItem: TCustomdxPSExplorerItem);
    begin
      TreeContainer.DeleteItem(AnItem);
    end;

    procedure TdxPSExplorerTreeChangeNotifier.ItemParentChanged
      (AnItem: TCustomdxPSExplorerItem);
    begin
      TreeContainer.MoveItem(AnItem);
    end;

    procedure TdxPSExplorerTreeChangeNotifier.ItemPropertiesChanged
      (AnItem: TCustomdxPSExplorerItem);
    begin
    ...
    procedure TdxPSExplorerTreeChangeNotifier.ItemRenamed
      (AnItem: TCustomdxPSExplorerItem);
    begin
    ...
    constructor TCustomdxPSExplorerTreeContainer.Create
      (AnExplorer: TCustomdxPSExplorer; AHost: IdxPSExplorerTreeContainerHost);
    begin
    ...
    class function TCustomdxPSExplorerTreeContainer.ControlClass
      : TWinControlClass;
    begin
      Result := nil;
    end;
    ...
    function TCustomdxPSExplorerTreeContainer.
      CanShowPropertySheetsForSelectedItem: Boolean;
    begin
      Result := not IsEditing and (SelectedItem <> nil) and
        SelectedItem.HasPropertySheets;
    end;
    ...
    procedure TCustomdxPSExplorerTreeContainer.DeleteSelection
      (AShowMessage: Boolean = True);
    begin
      if CanDeleteSelection and
        (not AShowMessage or dxPSUtl.MessageQuestion
        (SelectedItem.DeleteMessageText)) then
        SelectedItem.Delete;
    end;

    function TCustomdxPSExplorerTreeContainer.
      IsSelectedItemCurrentlyLoaded: Boolean;
    var
      Item: TCustomdxPSExplorerItem;
    begin
      Item := SelectedItem;
      Result := (Item is TdxPSExplorerItem) and TdxPSExplorerItem(Item)
        .IsCurrentlyLoaded;
    end;
    ...
    begin
      if CanRenameSelectedItem then
        BeginEdit(True);
    end;

    function TCustomdxPSExplorerTreeContainer.
      ShowSelectedItemPropertySheets: Boolean;
    begin
      Result := CanShowPropertySheetsForSelectedItem and
        TdxPSExplorerItem(SelectedItem).ShowPropertySheets;
    end;
    ...
    begin
      if (Control <> nil) and Control.CanFocus and
        not IsRectEmpty(Control.ClientRect) then
        Control.SetFocus;
    end;
    ...
    procedure TCustomdxPSExplorerTreeContainer.RefreshSorting
      (AFolder: TdxPSExplorerFolder);
    begin

    end;

    procedure TCustomdxPSExplorerTreeContainer.DeleteItem
      (AnItem: TCustomdxPSExplorerItem);
    begin
      EndEdit(False);
    end;

    procedure TCustomdxPSExplorerTreeContainer.InvalidateItem
      (AnItem: TCustomdxPSExplorerItem);
    begin
    end;
    ...
    procedure TCustomdxPSExplorerTreeContainer.ProcessKeyDown(var Key: Word;
      Shift: TShiftState);
    var
    ...
    class procedure TdxPSExplorerTreeBuilder.BuildTree
      (AnExplorer: TCustomdxPSExplorer;
    ...
    class procedure TdxPSExplorerTreeBuilder.CreateFolderNode
      (ATreeContainer: TCustomdxPSExplorerTreeContainer;
    ...
    class procedure TdxPSExplorerTreeBuilder.CreateItemNode(ATreeContainer
      : TCustomdxPSExplorerTreeContainer; AParent: TdxPSExplorerFolder;
      AnItem: TCustomdxPSExplorerItem);
    begin
    ...
    class procedure TdxPSExplorerTreeBuilder.PopulateTreeFolder
      (ATreeContainer: TCustomdxPSExplorerTreeContainer;
      AFolder: TdxPSExplorerFolder);
    var
      I: Integer;
    ...
    constructor TCustomdxPSExplorerItemPropertySheets.CreateEx
      (AnExplorerItem: TCustomdxPSExplorerItem);
    begin
      Create(nil);
      FExplorerItem := AnExplorerItem;
    end;

    class function TCustomdxPSExplorerItemPropertySheets.Execute
      (AnExplorerItem: TCustomdxPSExplorerItem): Boolean;
    begin
    ...
    function TCustomdxPSExplorerItemPropertySheets.ExplorerItem
    ...
    class function TCustomdxPSExplorerItemPropertySheets.FormClass
    ...
    class function TCustomdxPSExplorerItemComparator.CompareItems(AnItem1,
      AnItem2: Pointer): Integer;
    begin
      Result := TCustomdxPSExplorerItem(AnItem1)
        .CompareTo(TCustomdxPSExplorerItem(AnItem2));
    end;

    { TCustomdxPSExplorerItemHelper }

    class function TCustomdxPSExplorerItemHelper.GetHasChildren
      (AFolder: TdxPSExplorerFolder): Boolean;
    begin
      Result := False;
    end;

    class function TCustomdxPSExplorerItemHelper.GetImageIndex
      (AnItem: TCustomdxPSExplorerItem): Integer;
    begin
      Result := AnItem.GetImageIndex;
    end;

    class function TCustomdxPSExplorerItemHelper.GetSelectedIndex
      (AnItem: TCustomdxPSExplorerItem): Integer;
    begin
      Result := AnItem.GetSelectedIndex;
    end;

    class procedure TCustomdxPSExplorerItemHelper.SetHasChildren
      (AFolder: TdxPSExplorerFolder; Value: Boolean);
    begin
    end;
    ...
    function TCustomdxPSExplorerItem.CanAccept
      (AnItem: TCustomdxPSExplorerItem): Boolean;
    begin
      Result := False;
    end;
    ...
    function TCustomdxPSExplorerItem.CanMoveTo
    ...
    function TCustomdxPSExplorerItem.GetUniqueID(out AnUniqueID
      : TBytes): Integer;
    begin
    ...
    function TCustomdxPSExplorerItem.HasAsParent
      (AnItem: TCustomdxPSExplorerItem): Boolean;
    var
    ...
    function TCustomdxPSExplorerItem.IsNameChanged(const ANewName
      : string): Boolean;
    begin
    ...
    class function TCustomdxPSExplorerItem.PropertySheetsClass
      : TCustomdxPSExplorerItemPropertySheetsClass;
    begin
      Result := nil;
    end;
    ...
    function TCustomdxPSExplorerItem.CannotRenameMessageText(const AOldName,
    ...
    function TCustomdxPSExplorerItem.OverwriteMessageText
      (Dest: TCustomdxPSExplorerItem): string;
    begin
      Result := '';
    end;
    ...
    function TCustomdxPSExplorerItem.CompareTo
      (AnItem: TCustomdxPSExplorerItem): Integer;
    begin
      Result := 0;
    end;
    ...
    function TCustomdxPSExplorerItem.DoMove
      (AParent: TdxPSExplorerFolder): Boolean;
    begin
      Result := True;
    end;
    ...
    function TCustomdxPSExplorerItem.GetNewName(AReportLink
      : TBasedxReportLink): string;
    begin
      Result := '';
    end;
    ...
    procedure TCustomdxPSExplorerItem.InternalMove
      (AParent: TdxPSExplorerFolder);
    begin
      if Parent <> nil then
        Parent.Remove(Self);
    ...
    function TCustomdxPSExplorerItem.GetItemStateInfo
      : TCustomdxPSExplorerItemStateInfo;
    var
      Bytes: TBytes;
    begin
    ...
    class function TdxPSExplorerFolderHelper.GetHasChildren
      (AFolder: TdxPSExplorerFolder): Boolean;
    begin
      Result := AFolder.HasChildren;
    end;

    class procedure TdxPSExplorerFolderHelper.SetHasChildren
      (AFolder: TdxPSExplorerFolder; Value: Boolean);
    begin
    ...
    function TdxPSExplorerFolder.CanAccept
      (AnItem: TCustomdxPSExplorerItem): Boolean;
    begin
      Result := (AnItem <> Self) and (AnItem.Parent <> Self) and
        not HasAsParent(AnItem);
    end;

    function TdxPSExplorerFolder.CanRenameTo(const AName: string): Boolean;
    begin
      Result := inherited CanRenameTo(AName) and
        ((Parent = nil) or (Parent.FolderByName(AName) = nil));
    end;
    ...
    function TdxPSExplorerFolder.CreateItem(AReportLink: TBasedxReportLink)
      : TdxPSExplorerItem;
    begin
    ...
    begin
      ...
      begin
        Result := True;
        for I := 0 to ItemCount - 1 do
          if Items[I] = Explorer.LoadedItem then
            Exit;
        for I := 0 to FolderCount - 1 do
          if Folders[I].HasLoadedItem then
            Exit;
        Result := False;
      end
      else
    ...
    function TdxPSExplorerFolder.FolderByName(const AName: string)
      : TdxPSExplorerFolder;
    var
      I: Integer;
    begin
    ...
    function TdxPSExplorerFolder.ItemByName(const AName: string)
      : TdxPSExplorerItem;
    var
      I: Integer;
    begin
    ...
    function TdxPSExplorerFolder.CannotRenameMessageText(const AOldName,
      ANewName: string): string;
    begin
      Result := Format(cxGetResourceString(@sdxCannotRenameFolderText),
        [AOldName, ANewName]);
    end;
    ...
    begin
      if HasFolders or HasItems then
        Result := Format
          (cxGetResourceString(@sdxDeleteNonEmptyFolderMessageText),
          [DisplayName])
      else
        Result := Format(cxGetResourceString(@sdxDeleteFolderMessageText),
          [DisplayName]);
    end;

    function TdxPSExplorerFolder.OverwriteMessageText
      (Dest: TCustomdxPSExplorerItem): string;
    begin
      Result := Format(cxGetResourceString(@sdxOverwriteFolderMessageText),
        [Dest.DisplayName, DisplayName]);
    end;

    function TdxPSExplorerFolder.CompareTo
      (AnItem: TCustomdxPSExplorerItem): Integer;
    begin
    ...
    function TdxPSExplorerFolder.GetItemStateInfo
      : TCustomdxPSExplorerItemStateInfo;
    begin
    ...
    function TdxPSExplorerFolder.GetNewName(AReportLink
      : TBasedxReportLink): string;
    var
      Index: Integer;
      Template: string;
    ...
    function TdxPSExplorerFolder.GetItemList
      (AnItem: TCustomdxPSExplorerItem): TList;
    begin
      Result := GetItemList(TCustomdxPSExplorerItemClass(AnItem.ClassType));
    end;

    function TdxPSExplorerFolder.GetItemList(AnItemClass
      : TCustomdxPSExplorerItemClass): TList;
    begin
      if AnItemClass.InheritsFrom(TdxPSExplorerItem) then
        Result := FItems
      else if AnItemClass.InheritsFrom(TdxPSExplorerFolder) then
        Result := FFolders
      else
        Result := nil;
    end;
    ...
    constructor TdxPSExplorerItem.Create(AnExplorer: TCustomdxPSExplorer;
      AParent: TdxPSExplorerFolder);
    begin
      inherited;
    ...
    begin
      Result := inherited CanRenameTo(AName) and
        ((Parent = nil) or (Parent.ItemByName(AName) = nil));
    end;

    function TdxPSExplorerItem.CannotRenameMessageText(const AOldName,
      ANewName: string): string;
    begin
      Result := Format(cxGetResourceString(@sdxCannotRenameItemText),
        [AOldName, ANewName]);
    end;
    ...
    begin
      Result := Format(cxGetResourceString(@sdxDeleteItemMessageText),
        [DisplayName]);
    end;

    function TdxPSExplorerItem.OverwriteMessageText
      (Dest: TCustomdxPSExplorerItem): string;
    begin
      Result := Format(cxGetResourceString(@sdxOverwriteItemMessageText),
        [Dest.DisplayName, DisplayName]);
    end;

    function TdxPSExplorerItem.CreateDataStream(AMode: TdxPSStreamMode)
      : TStream;
    begin
      Result := Explorer.CreateItemDataStream(Self, AMode);
    end;

    procedure TdxPSExplorerItem.RetrieveReportData
      (AReportLink: TBasedxReportLink);
    var
      Stream: TStream;
    begin
    ...
    class function TdxPSExplorerItem.PropertySheetsClass
      : TCustomdxPSExplorerItemPropertySheetsClass;
    begin
      Result := TdxfmPSReportProperties;
    end;

    function TdxPSExplorerItem.CompareTo
      (AnItem: TCustomdxPSExplorerItem): Integer;
    begin
    ...
    function TdxPSExplorerItem.GetNewName(AReportLink
      : TBasedxReportLink): string;
    var
      AIndex: Integer;
      ATemplate: string;
    ...
    constructor TCustomdxPSExplorerContextCommand.Create
      (AnExplorer: TCustomdxPSExplorer);
    begin
      inherited Create;
    ...
    constructor TdxPSExplorerContextCommandSeparator.Create
      (AnExplorer: TCustomdxPSExplorer);
    begin
      inherited;
    ...
    constructor TdxPSExplorerRefreshContextCommand.Create
      (AnExplorer: TCustomdxPSExplorer);
    begin
    ...
    function TCustomdxPSExplorer.CreateNewFolder(AParent: TdxPSExplorerFolder)
      : TdxPSExplorerFolder;
    begin
    ...
    procedure TCustomdxPSExplorer.BuildTree(ATreeContainer
      : TCustomdxPSExplorerTreeContainer);
    begin
      dxPSExplorerTreeBuilderFactory_ActiveBuilderClass.BuildTree(Self,
        ATreeContainer);
    ...
    function TCustomdxPSExplorer.CreateTree(const AHost
      : IdxPSExplorerTreeContainerHost): TCustomdxPSExplorerTreeContainer;
    begin
      Result := dxPSExplorerTreeContainerFactory.ActiveTreeContainerClass.Create
        (Self, AHost);
    end;

    function TCustomdxPSExplorer.FindCustomItemByUniqueID(const AnUniqueID
      : TBytes): TCustomdxPSExplorerItem;
    begin
      Result := nil;
    end;
    ...
    procedure TCustomdxPSExplorer.RegisterNotifier
    ...
    procedure TCustomdxPSExplorer.UnregisterNotifier
      (ANotifier: TdxPSExplorerChangeNotifier);
    begin
    ...
    procedure TCustomdxPSExplorer.BuildCommandSet
      (ABuilder: IdxPSExplorerContextCommandBuilder);
    begin
      Assert(ABuilder <> nil);
      ABuilder.AddExplorerContextCommand(AddCommandSeparator);
      ABuilder.AddExplorerContextCommand
        (AddCommand(TdxPSExplorerRefreshContextCommand));
    end;

    procedure TCustomdxPSExplorer.FinalizeCommand
      (ACommand: TCustomdxPSExplorerContextCommand);
    begin
    end;

    procedure TCustomdxPSExplorer.InitializeCommand
      (ACommand: TCustomdxPSExplorerContextCommand);
    begin
    end;

    function TCustomdxPSExplorer.AddCommand(ACommandClass
      : TCustomdxPSExplorerContextCommandClass)
      : TCustomdxPSExplorerContextCommand;
    begin
    ...
    function TCustomdxPSExplorer.AddCommandSeparator
      : TdxPSExplorerContextCommandSeparator;
    begin
      Result := AddCommand(TdxPSExplorerContextCommandSeparator)
        as TdxPSExplorerContextCommandSeparator;
    end;
    ...
    function TCustomdxPSExplorer.CreateCommand(ACommandClass
      : TCustomdxPSExplorerContextCommandClass)
      : TCustomdxPSExplorerContextCommand;
    begin
    ...
    function TCustomdxPSExplorer.CreateCommandSeparator
      : TdxPSExplorerContextCommandSeparator;
    begin
      Result := TdxPSExplorerContextCommandSeparator.Create(Self);
    end;

    function TCustomdxPSExplorer.FindCommand(ACommandClass
      : TCustomdxPSExplorerContextCommandClass)
      : TCustomdxPSExplorerContextCommand;
    var
      I: Integer;
    ...
    class function TCustomdxPSExplorer.AcceptItemNameChar
      (AnItem: TCustomdxPSExplorerItem; Ch: Char): Boolean;
    begin
      Result := True;
    end;
    ...
    class function TCustomdxPSExplorer.GetRootFolderClass
      : TdxPSExplorerFolderClass;
    begin
      Result := TdxPSExplorerFolder;
    end;
    ...
    function TCustomdxPSExplorer.CanDelete
      (AnItem: TCustomdxPSExplorerItem): Boolean;
    begin
      Result := (AnItem <> nil) and (AnItem <> Root);
    end;

    function TCustomdxPSExplorer.CanMove
      (AnItem: TCustomdxPSExplorerItem): Boolean;
    begin
    ...
    function TCustomdxPSExplorer.CanRename
      (AnItem: TCustomdxPSExplorerItem): Boolean;
    begin
      Result := (AnItem <> nil) and (AnItem <> Root) and (AnItem <> LoadedItem);
    end;
    ...
    begin
      if AFolder.HasChildren and (AFolder.FolderCount + AFolder.ItemCount = 0)
      then
      begin
        LoadData(AFolder);
    ...
    procedure TCustomdxPSExplorer.RenameTo(AnItem: TCustomdxPSExplorerItem;
      AName: string);
    begin
    ...
    procedure TCustomdxPSExplorer.DoItemDataLoadError
      (AnItem: TdxPSExplorerItem);
    var
      S: string;
      ShowError: Boolean;
    ...
    procedure TCustomdxPSExplorer.InternalSetLoadedItem
      (Value: TdxPSExplorerItem);
    begin
      if Value <> nil then // ?
        FLoadedItem := Value;
    end;

    procedure TCustomdxPSExplorer.PopulateTreeFolder(ATreeContainer
      : TCustomdxPSExplorerTreeContainer; AFolder: TdxPSExplorerFolder);
    begin
      dxPSExplorerTreeBuilderFactory_ActiveBuilderClass.PopulateTreeFolder
        (ATreeContainer, AFolder);
    ...
    procedure TCustomdxPSExplorer.NotifyFolderPopulated
      (AFolder: TdxPSExplorerFolder);
    var
      I: Integer;
    begin
    ...
    procedure TCustomdxPSExplorer.NotifyItemAdded
      (AnItem: TCustomdxPSExplorerItem);
    var
      I: Integer;
    begin
    ...
    procedure TCustomdxPSExplorer.NotifyItemDataLoaded
      (AnItem: TdxPSExplorerItem);
    var
      I: Integer;
    begin
    ...
    procedure TCustomdxPSExplorer.NotifyItemDataUnloaded
      (AnItem: TdxPSExplorerItem);
    var
      I: Integer;
    begin
    ...
    procedure TCustomdxPSExplorer.NotifyItemDeleted
      (AnItem: TCustomdxPSExplorerItem);
    var
      I: Integer;
    begin
    ...
    procedure TCustomdxPSExplorer.NotifyItemParentChanged
      (AnItem: TCustomdxPSExplorerItem);
    var
      I: Integer;
    begin
    ...
    procedure TCustomdxPSExplorer.NotifyItemPropertiesChanged
      (AnItem: TCustomdxPSExplorerItem);
    var
      I: Integer;
    begin
    ...
    procedure TCustomdxPSExplorer.NotifyItemRenamed
      (AnItem: TCustomdxPSExplorerItem);
    var
      I: Integer;
    begin
    ...
    procedure TCustomdxPSExplorer.NotifyRefresh
      (AStage: TdxPSExplorerRefreshStage);
    var
      I: Integer;
    begin
    ...
    function TCustomdxPSExplorer.IndexOfNotifier
      (ANotifier: TdxPSExplorerChangeNotifier): Integer;
    begin
    ...
    begin
      if FLoadingCounter = 0 then
        Include(FState, esLoading);
      Inc(FLoadingCounter);
    end;
    ...
    function TCustomdxPSExplorer.GetCommand(Index: Integer)
      : TCustomdxPSExplorerContextCommand;
    begin
    ...
    function TCustomdxPSExplorer.GetNotifier(Index: Integer)
      : TdxPSExplorerChangeNotifier;
    begin
    ...
    begin
      ...
      begin
        ReportLink.DoCustomDrawPageTitle(ACanvas, R, ATextAlignX, ATextAlignY,
          AColor, AFont, ADone);
      end;
    end;
    ...
    procedure TdxReportNote.Draw(ARenderer: TdxPSReportRenderer;
      const R: TRect);

      procedure DoDrawNoteText(ACanvas: TdxPSReportRenderCustomCanvas; R: TRect;
        AColor: TColor; AFont: TFont; ATextAlignX: TcxTextAlignX;
      ...
      begin
        ...
        ARenderer.DrawTextEx(ACanvas, R, 0, 0, 0, Text, AFont,
          CXTO_AUTOINDENTS or CXTO_EXPANDTABS or CXTO_PATTERNEDTEXT or
          CXTO_CHARBREAK or ARenderer.MakeTextFormat(ATextAlignX, ATextAlignY,
          True, False, True, True, False));
      end;

      procedure InternalCustomDraw(ACanvas: TdxPSReportRenderCustomCanvas;
        R: TRect);
      var
        AColor: TColor;
        ACustomDrawCanvas: TCanvas;
      ...
      begin
        ...
        try
          ...
          DoCustomDraw(ACustomDrawCanvas, R, ATextAlignX, ATextAlignY, AColor,
            ACustomDrawCanvas.Font, AHandled);
          if not AHandled then
          begin
            ARenderCanvas := TdxPSReportRenderCanvas.Create(ACustomDrawCanvas);
            try
              DoDrawNoteText(ARenderCanvas, R, AColor, ACustomDrawCanvas.Font,
                ATextAlignX, ATextAlignY);
            finally
              ARenderCanvas.Free;
            end;
          end;
      ...
      try
        ...
        try
          ...
          if IsCustomDrawn then
            ...
            DoDrawNoteText(ARenderer.Canvas, R, Color, ATempFont, TextAlignX,
              TextAlignY);
        finally
          ATempFont.Free;
        end;
    ...
    begin
      if Assigned(ReportLink) then
      begin
        ReportLink.DoCustomDrawPageFootnotes(ACanvas, R, ATextAlignX,
          ATextAlignY, AColor, AFont, ADone);
      end;
    end;
    ...
    begin
      ...
      Filer.DefineProperty('IsCaptionAssigned', ReadIsCaptionAssigned,
        WriteIsCaptionAssigned, FIsCaptionAssigned and (Caption = ''));
      Filer.DefineProperty('IsCreatorAssigned', ReadIsCreatorAssigned,
        WriteIsCreatorAssigned, FIsCreatorAssigned and (Creator = ''));
      Filer.DefineProperty('IsDescriptionAssigned', ReadIsDescriptionAssigned,
        WriteIsDescriptionAssigned, FIsDescriptionAssigned and
        (Description = ''));
    end;
    ...
    begin
      ...
      begin
        ...
        Result := Result + DropAmpersand(cxGetResourceString(@sdxCaption)) + ' '
          + Caption;
      end;
      ...
      begin
        if Result <> '' then
          Result := Result + dxCRLF;
        Result := Result + DropAmpersand(cxGetResourceString(@sdxCreator)) + ' '
          + Creator;
      end;

      if Result <> '' then
        Result := Result + dxCRLF;
      Result := Result + DropAmpersand(cxGetResourceString(@sdxCreationDate)) +
        ' ' + DateToStr(CreationDate);

      if Description <> '' then
      begin
        if Result <> '' then
          Result := Result + dxCRLF;
        Result := Result + DropAmpersand(cxGetResourceString(@sdxDescription)) +
          ' ' + Description;
      end;
    end;
    ...
    constructor TdxPSDataStorageOffsetTable.Create
      (ATemplate: TdxPSDataStorageOffsetTable = nil);
    begin
      inherited Create;
      Assign(ATemplate);
    end;

    procedure TdxPSDataStorageOffsetTable.Assign
      (Source: TdxPSDataStorageOffsetTable);
    begin
      Clear;
      if Source <> nil then
        DoAssign(Source);
    ...
    procedure TdxPSDataStorageOffsetTable.DoAssign
      (Source: TdxPSDataStorageOffsetTable);
    begin
    ...
    begin
      ...
      begin
        ...
        LinkClass := TdxReportLinkClass
          (Classes.GetClass(dxShortStringToString(LinkClassName)));
        if Assigned(AReportLink.Component) then
        begin
          ComponentClassName := dxStringToShortString
            (AReportLink.Component.ClassName);
          ComponentClass :=
            TComponentClass
            (Classes.GetClass(dxShortStringToString(ComponentClassName)));
        end;
      end;
    end;
    ...
    begin
      ...
      FSubscriber := TdxPageParamsChangedSubscriber.Create
        ([TdxSMPageParamsChangedEvent]);
      TdxPageParamsChangedSubscriber(FSubscriber).OnPageParamsChanged :=
        PageParamsChanged;
    ...
    begin
      ...
      else if Source is TBasedxPrintStyle then
    ...
    procedure TBasedxReportLink.LoadFromIniFile(AIniFile: TCustomIniFile;
    ...
    begin
      ...
      if AIniFile.ReadBool(ASection, sdxAssignedPageNumberFormat, False) then
        PageNumberFormat := TdxPageNumberFormat(AIniFile.ReadInteger(ASection,
          sdxPageNumberFormat, Ord(PageNumberFormat)));
      StartPageIndex := AIniFile.ReadInteger(ASection, sdxStartPageIndex,
        StartPageIndex);
    end;
    ...
    procedure TBasedxReportLink.SaveToIniFile(AIniFile: TCustomIniFile;
      const ASection: string);
    begin
      AIniFile.WriteBool(ASection, sdxAssignedDateFormat,
        fvDate in AssignedFormatValues);
      AIniFile.WriteInteger(ASection, sdxDateFormat, DateFormat);
      AIniFile.WriteBool(ASection, sdxAssignedTimeFormat,
        fvTime in AssignedFormatValues);
      AIniFile.WriteInteger(ASection, sdxTimeFormat, TimeFormat);
      AIniFile.WriteBool(ASection, sdxAssignedPageNumberFormat,
        fvPageNumber in AssignedFormatValues);
      AIniFile.WriteInteger(ASection, sdxPageNumberFormat,
        Integer(PageNumberFormat));
    ...
    begin
      if not(fvDate in AssignedFormatValues) and IsComponentPrinterAvailable
      then
    ...
    begin
      if not(fvPageNumber in AssignedFormatValues) and IsComponentPrinterAvailable
      then
    ...
    begin
      if not(fvTime in AssignedFormatValues) and IsComponentPrinterAvailable
      then
    ...
    function TBasedxReportLink.DesignerExists(AComponentClass
    ...
    procedure TBasedxReportLink.GetPageColRowCount(out APageColCount,
    ...
    begin
      ...
      if Active or FStreamedActive then
        try
          ...
          RebuildReport;
          if not IsLoading and IsComponentPrinterAvailable and
            not ComponentPrinter.AutoUpdateDateTime then
          begin
            DateTime := Now;
            DesignerModified;
          end;
    ...
    class procedure TBasedxReportLink.GetSupportedComponentList
      (AList: TdxClassList);
    begin
      dxPSGetLinkSupportedComponentsList(AList, LinkClass);
    end;

    class function TBasedxReportLink.IsSupportedCompClass(AComponentClass
      : TClass): Boolean;
    var
      AList: TList;
    begin
    ...
    begin
      Result := (AClass <> nil) and AClass.InheritsFrom(TComponent) and
        IsSupportedCompClass(AClass);
    end;
    ...
    procedure TBasedxReportLink.ExportToPDF(const AFileName: string;
      ACanShowDialog: Boolean = True;
      ASettings: TdxPSPDFReportExportOptions = nil);
    begin
    ...
    function TBasedxReportLink.Print(AShowDialog: Boolean;
      APrintDialogData: PdxPrintDlgData): Boolean;
    begin
      Result := False;
    ...
    procedure TBasedxReportLink.PrintPages(const APageIndexes
      : TdxPSPageIndexes);
    begin
    ...
    procedure TBasedxReportLink.PrintPagesEx(const APageIndexes
      : TdxPSPageIndexes; APageNums: TdxPageNumbers; ACopyCount: Integer;
      ACollate: Boolean);
    begin
      if IsComponentPrinterAvailable then
      begin
        IsCurrentLink := True;
        ComponentPrinter.PrintPagesEx(APageIndexes, APageNums, ACopyCount,
          ACollate, Self);
      end;
    end;
    ...
    begin
      ...
      begin
        ...
        if PrintBtnClicked then
          Print(True, nil)
        else if PreviewBtnClicked then
          Preview(True);
      end;
    end;
    ...
    begin
      ...
      try
        ...
        begin
          Assign(APrintStyle);
          if IsComponentPrinterAvailable then
            ComponentPrinter.InitDevModeFromPrinterPageSettings
              (RealPrinterPage);
        end;
        if IsComponentPrinterAvailable then
    ...
    begin
      ...
      if Result then
      begin
        if IsComponentPrinterAvailable and AData.SetPageNumberFormatAsDefault
        then
    ...
    begin
      Result := (rlcFootnotes in Capabilities) and not IsAggregated and
        (DataSource = rldsComponent) and
        ((ComponentPrinter = nil) or not ComponentPrinter.IsExplorerMode);
    end;

    function TBasedxReportLink.CanChangeTitle: Boolean;
    begin
      Result := (rlcTitle in Capabilities) and not IsAggregated and
        (DataSource = rldsComponent) and
        ((ComponentPrinter = nil) or not ComponentPrinter.IsExplorerMode);
    end;
    ...
    begin
      Result := Serializable and not IsEmptyReport and
    ...
    begin
      ...
      begin
        ...
        else if IsRebuildNeededAndAllowed then
          RebuildReport;
      end;
    end;
    ...
    class function TBasedxReportLink.ExtractComponentClassName(AStream: TStream;
      ARaiseException: Boolean = False): string;
    var
      AStorageInfo: TdxPSDataStorageInfo;
    begin
    ...
    class procedure TBasedxReportLink.FinalizeStorageInfo(var AStorageInfo
      : TdxPSDataStorageInfo);
    begin
    ...
    begin
      ...
      if Result then
        try
          ...
          Result := (AStorageVersion >= 1) and
            (AStorageVersion <= dxPSGlbl.dxPSStorageVersion);
        except
          Result := False;
          if ARaiseException then
            raise;
    ...
    class function TBasedxReportLink.PossibleDataStorage(const AFileName
      : string; ARaiseException: Boolean = False): Boolean;
    var
      AStream: TFileStream;
    begin
      ...
      if Result then
        try
          AStream := TFileStream.Create(AFileName, fmOpenRead or
            fmShareDenyWrite);
          try
    ...
    function TBasedxReportLink.AddBackgroundBitmapToPool
      (ABitmap: TGraphic): Integer;
    begin
    ...
    function TBasedxReportLink.AddFontToPool(const AName: string;
      AColor: TColor; APitch: TFontPitch; AStyle: TFontStyles;
      ASize: Integer): Integer;
    begin
      Result := FontPool.Add(AName, AColor, APitch, AStyle, ASize);
    end;

    function TBasedxReportLink.CreateGroupLookAndFeel
      (AClass: TdxPSReportGroupLookAndFeelClass; ACheckExisting: Boolean = True)
      : TdxPSReportGroupLookAndFeel;
    begin
      if ReportCells <> nil then
    ...
    function TBasedxReportLink.FindGroupLookAndFeelByClass
      (AClass: TdxPSReportGroupLookAndFeelClass): TdxPSReportGroupLookAndFeel;
    begin
      if ReportCells <> nil then
    ...
    function TBasedxReportLink.IndexOfReportGroupLookAndFeel
      (ALookAndFeel: TdxPSReportGroupLookAndFeel): Integer;
    begin
      if ReportCells <> nil then
    ...
    procedure TBasedxReportLink.DrawPageHeader(APageIndex: Integer;
    ...
    procedure TBasedxReportLink.DrawPageFooter(APageIndex: Integer;
      ARect: TRect; ATitleParts: TdxPageTitleParts; ADrawBackground: Boolean);
    begin
      if FPainting then
    ...
    begin
      ...
      begin
        ...
        try
          Renderer.DrawCheckBox(ARenderCanvas, R, Checked, Enabled, False,
            EdgeStyleMap[FlatBorder, BoldBorder]);
        finally
          ARenderCanvas.Free;
        end;
      end;
    ...
    begin
      ...
      begin
        ARenderCanvas := TdxPSReportRenderCanvas.Create(Canvas);
        try
          Renderer.DrawCheckBox(ARenderCanvas, R, Checked, Enabled, IsRadio,
            EdgeStyle, BorderColor);
        finally
          ARenderCanvas.Free;
        end;
      end;
    ...
    begin
      ...
      begin
        ARenderCanvas := TdxPSReportRenderCanvas.Create(Canvas);
        try
          Renderer.DrawEdge(ARenderCanvas, R, EdgeMode, OuterEdge, Sides,
            Soft, -1);
        finally
          ARenderCanvas.Free;
        end;
    ...
    procedure TBasedxReportLink.DrawEllipse(Canvas: TCanvas; R: TRect;
    ...
    begin
      ...
      begin
        ARenderCanvas := TdxPSReportRenderCanvas.Create(Canvas);
        try
          Renderer.DrawEllipse(ARenderCanvas, R, ForeColor, BkColor, Pattern,
      ...
      begin
        ...
        try
          Renderer.DrawExpandButton(ARenderCanvas, R, Expanded, DrawBorder,
            Edge3D, Edge3DSoft, Shadow, FillInterior, BorderColor,
            InteriorColor);
        finally
          ARenderCanvas.Free;
        end;
    ...
    procedure TBasedxReportLink.DrawGlyph(DC: HDC; const R: TRect;
      AGlyph: Byte);
    var
      ACanvas: TCanvas;
    ...
    begin
      ...
      begin
        ARenderCanvas := TdxPSReportRenderCanvas.Create(Canvas);
        try
          Renderer.DrawGraphic(ARenderCanvas, R, ClipRect, ImageList,
            ImageIndex, Graphic, GraphicTransparent, Transparent, BkColor);
        finally
          ARenderCanvas.Free;
        end;
      end;
    ...
    begin
      ...
      begin
        ARenderCanvas := TdxPSReportRenderCanvas.Create(Canvas);
        try
          Renderer.DrawGraphicEx(ARenderCanvas, R, ClipRect, ImageList,
            ImageIndex, Graphic, GraphicTransparent, Transparent, BkColor,
            ForeColor, Pattern, AActualImageBuffering);
        finally
          ARenderCanvas.Free;
        end;
      end;
    ...
    begin
      ...
      begin
        ARenderCanvas := TdxPSReportRenderCanvas.Create(Canvas);
        try
          Renderer.DrawRectangle(ARenderCanvas, R, ForeColor, BkColor,
            ContentPattern, BorderColor, BorderThickness);
        finally
          ARenderCanvas.Free;
        end;
      end;
    ...
    procedure TBasedxReportLink.DrawText(Canvas: TCanvas; var R: TRect;
      AIndent: Integer; const Text: string; Font: TFont; BkColor: TColor;
      TextAlignX: TcxTextAlignX; TextAlignY: TcxTextAlignY;
      FillBackground, Multiline, EndEllipsis: Boolean);
    var
      ARenderCanvas: TdxPSReportRenderCanvas;
    begin
      if FPainting then
      begin
        ARenderCanvas := TdxPSReportRenderCanvas.Create(Canvas);
        try
          Renderer.DrawText(ARenderCanvas, R, 0, AIndent, 0, Text, Font,
            BkColor, TextAlignX, TextAlignY, FillBackground, Multiline,
            EndEllipsis, True, True);
        finally
          ARenderCanvas.Free;
        end;
      end;
    ...
    procedure TBasedxReportLink.DrawTextEx(Canvas: TCanvas; var R: TRect;
      MaxLineCount: Integer; LeftIndent, RightIndent: Integer;
      const Text: string; Font: TFont; BkColor: TColor;
      TextAlignX: TcxTextAlignX; TextAlignY: TcxTextAlignY;
      FillBackground, Multiline, EndEllipsis, PreventLeftTextExceed,
    ...
    begin
      ...
      begin
        ARenderCanvas := TdxPSReportRenderCanvas.Create(Canvas);
        try
          Renderer.DrawText(ARenderCanvas, R, MaxLineCount, LeftIndent,
            RightIndent, Text, Font, BkColor, TextAlignX, TextAlignY,
            FillBackground, Multiline, EndEllipsis, PreventLeftTextExceed,
            PreventTopTextExceed);
        finally
          ARenderCanvas.Free;
        end;
      end;
    ...
    procedure TBasedxReportLink.FillEllipse(Canvas: TCanvas; const R: TRect;
      Color: TColor);
    var
      ARenderCanvas: TdxPSReportRenderCanvas;
    begin
    ...
    begin
      ...
      begin
        ARenderCanvas := TdxPSReportRenderCanvas.Create(Canvas);
        try
          Renderer.FillRoundRect(ARenderCanvas, R, CornerWidth,
            CornerHeight, Color);
        finally
          ARenderCanvas.Free;
        end;
    ...
    begin
      ...
      begin
        ARenderCanvas := TdxPSReportRenderCanvas.Create(Canvas);
        try
          Renderer.FillRoundRectEx(ARenderCanvas, R, CornerWidth, CornerHeight,
    ...
    procedure TBasedxReportLink.FrameEllipse(Canvas: TCanvas; R: TRect;
      Color: TColor; Thickness: Integer = 1);
    var
      ARenderCanvas: TdxPSReportRenderCanvas;
    begin
      if FPainting then
    ...
    procedure TBasedxReportLink.FrameRect(Canvas: TCanvas; R: TRect;
      Color: TColor; Sides: TdxCellSides = [csLeft .. csBottom];
      Thickness: Integer = 1);
    var
      ARenderCanvas: TdxPSReportRenderCanvas;
    begin
    ...
    begin
      ...
      begin
        ARenderCanvas := TdxPSReportRenderCanvas.Create(Canvas);
        try
          Renderer.FrameRoundRect(ARenderCanvas, R, CornerWidth, CornerHeight,
            Color, Thickness);
        finally
          ARenderCanvas.Free;
        end;
    ...
    begin
      inherited DefineProperties(Filer);
      Filer.DefineProperty('BuiltInReportLink', ReadBuiltIn,
        WriteBuiltIn, True);
      ...
      Filer.DefineProperty('LinkedComponentName', ReadComponentName,
        WriteComponentName, InternalStreaming and (Component <> nil));
      Filer.DefineProperty('StyleManagerName', ReadStyleManagerName,
        WriteStyleManagerName, InternalStreaming and (StyleManager <> nil));
    end;

    procedure TBasedxReportLink.Notification(AComponent: TComponent;
    ...
    function TBasedxReportLink.PrintDialog(var APrintDlgData
    ...
    begin
      ...
      try
        AStyle := dxPSPageSetupMenuBuilderFactory.ActiveBuilder.
          ExtractPrintStyleFromObj(Sender);
      except
        AStyle := nil;
        Application.HandleException(Self);
      end;
      ...
      if IsComponentPrinterAvailable and not ComponentPrinter.IsForegroundPreviewWindow
      then
      begin
        if not PageSetupEx(0, True, True, APreviewBtnClicked, APrintBtnClicked)
        then
          StyleManager.CurrentStyle := APrevCurrentStyle;

        if APrintBtnClicked then
          Print(True, nil)
        else if APreviewBtnClicked then
          Preview(True);
      end;
    end;
    ...
    procedure TBasedxReportLink.DoCustomDrawEntirePage(ACanvas: TCanvas;
      R: TRect; ARealPageIndex: Integer);
    const
      Denominator = 100;
    begin
      ComponentPrinter.DoCustomDrawEntirePage(Self, ACanvas, ARealPageIndex, R,
        MulDiv(Denominator, cxRectWidth(R), MulDiv(RenderInfo.PageSize.X,
        PixelsDenominator, PixelsNumerator)), Denominator);
    end;
        ...
        begin
          if Assigned(FOnCustomDrawPageHeader) then
            FOnCustomDrawPageHeader(Self, ACanvas, APageIndex, R,
              PixelsNumerator, PixelsDenominator, ADefaultDrawText,
              ADefaultDrawBackground)
        end
        else if Assigned(FOnCustomDrawPageFooter) then
          FOnCustomDrawPageFooter(Self, ACanvas, APageIndex, R, PixelsNumerator,
            PixelsDenominator, ADefaultDrawText, ADefaultDrawBackground);
      end;
    end;
    ...
    procedure TBasedxReportLink.DoCustomDrawPageFootnotes(ACanvas: TCanvas;
      ...
      var AColor: TColor; AFont: TFont; var ADone: Boolean);
    begin
      DoParentCustomDrawReportFootnotes(ACanvas, R, ATextAlignX, ATextAlignY,
    ...
    procedure TBasedxReportLink.DoCustomDrawPageTitle(ACanvas: TCanvas;
      R: TRect; var ATextAlignX: TcxTextAlignX; var ATextAlignY: TcxTextAlignY;
      var AColor: TColor; AFont: TFont; var ADone: Boolean);
    begin
    ...
    procedure TBasedxReportLink.DoParentCustomDrawReportFootnotes
      (ACanvas: TCanvas; R: TRect; var ATextAlignX: TcxTextAlignX;
      var ATextAlignY: TcxTextAlignY; var AColor: TColor; AFont: TFont;
      var ADone: Boolean; APixelsNumerator: Integer);
    begin
      ComponentPrinter.DoCustomDrawReportFootnotes(Self, ACanvas, R,
        ATextAlignX, ATextAlignY, AColor, AFont, ADone, APixelsNumerator);
    end;
    ...
    procedure TBasedxReportLink.DoParentCustomDrawReportTitle(ACanvas: TCanvas;
      ...
      APixelsNumerator: Integer);
    begin
      ComponentPrinter.DoCustomDrawReportTitle(Self, ACanvas, R, ATextAlignX,
        ATextAlignY, AColor, AFont, ADone, APixelsNumerator);
    end;
    ...
    begin
      ARenderCanvas := TdxPSReportRenderCanvas.Create(ACanvas);
      try
        PaintPageEx(ARenderCanvas, APageBounds, APageIndex,
    ...
    procedure TBasedxReportLink.PaintPageEx
      (ACanvas: TdxPSReportRenderCustomCanvas; const APageBounds: TRect;
      APageIndex, AContinuousPageIndex, AZoomFactor: Integer);
    begin
      FPainting := True;
      try
        Renderer.RenderPageEx(ACanvas, APageBounds, APageIndex,
          AContinuousPageIndex, AZoomFactor);
      finally
        FPainting := False;
      end;
    ...
    function TBasedxReportLink.IsHeaderOrFooterCustomDrawn
      (AHFObject: TCustomdxPageObject): Boolean;
    begin
      if AHFObject is TdxPageHeader then
        Result := Assigned(ComponentPrinter.FOnCustomDrawPageHeader) or
          Assigned(FOnCustomDrawPageHeader)
      else
        Result := Assigned(ComponentPrinter.FOnCustomDrawPageFooter) or
          Assigned(FOnCustomDrawPageFooter);
    end;

    function TBasedxReportLink.IsTitleCustomDrawn: Boolean;
    begin
      Result := Assigned(ComponentPrinter.FOnCustomDrawReportTitle) or
        Assigned(FOnCustomDrawReportLinkTitle);
    end;

    function TBasedxReportLink.IsFootnotesCustomDrawn: Boolean;
    begin
      Result := Assigned(ComponentPrinter.FOnCustomDrawReportFootnotes) or
    ...
    function TBasedxReportLink.IsComposable(AComposition
      : TdxCompositionReportLink): Boolean;
    begin
      Result := True;
    end;

    function TBasedxReportLink.IsSupportedStyle(APrintStyle
      : TBasedxPrintStyle): Boolean;
    begin
      Result := True;
    ...
    procedure TBasedxReportLink.DoMeasureReportLinkFootnotes
      (var AHeight: Integer);
    begin
      if Assigned(ComponentPrinter) then
    ...
    function TBasedxReportLink.GetCriticalSize(AReportCells
      : TdxReportCells): Integer;
    begin
    ...
    class function TBasedxReportLink.GetReportDocumentClass
      : TdxPSReportDocumentClass;
    begin
    ...
    function TBasedxReportLink.IsRealPrinterPage(APage: TdxPrinterPage)
      : Boolean;
    begin
      Result := RealPrinterPage = APage;
    end;

    function TBasedxReportLink.CreatePreviewWindowForm
      : TdxPSCustomPreviewWindow;
    begin
      Result := dxPSPreviewDialogManager.CreatePreviewWindow;
    end;

    class function TBasedxReportLink.CreateDataReader(AStream: TStream)
      : TdxPSDataReader;
    begin
      Result := GetDataReaderClass.Create(AStream, 4096);
    end;

    class function TBasedxReportLink.CreateDataWriter(AStream: TStream)
      : TdxPSDataWriter;
    begin
    ...
    begin
      ...
      try
        ...
        if (AOffsetTable.Footnotes <> 0) and
          (AStorageInfo.PrintingSystemVersion.Major > 3) then
        begin
    ...
    class function TBasedxReportLink.ReadOffsetTable(AReader: TdxPSDataReader)
      : TdxPSDataStorageOffsetTable;
    begin
    ...
    class procedure TBasedxReportLink.ReadReportDocument
      (AReader: TdxPSDataReader; AReportDocument: TdxPSReportDocument);
    begin
      AReportDocument.ReadData(AReader);
    end;

    class function TBasedxReportLink.ReadStorageInfo(AReader: TdxPSDataReader)
      : TdxPSDataStorageInfo;
    begin
    ...
    class procedure TBasedxReportLink.WriteReportDocument
      (AWriter: TdxPSDataWriter; AReportDocument: TdxPSReportDocument);
    begin
    ...
    procedure TBasedxReportLink.ReadBackgroundBitmapPool
      (AReader: TdxPSDataReader);
    begin
    ...
    procedure TBasedxReportLink.WriteBackgroundBitmapPool
      (AWriter: TdxPSDataWriter);
    begin
    ...
    begin
      ...
      else if (FActive <> Value) and Assigned(ComponentPrinter) then
      begin
        if Value then
    ...
    begin
      ...
      begin
        ...
        else if IsSupportedCompClass(TComponentClass(Value.ClassType)) then
    ...
    begin
      Result := IsComponentPrinterAvailable and
        (cpsBuilding in ComponentPrinter.State);
    end;
    ...
    begin
      APage := RealPrinterPage;
      Result := (APage.ScaleMode = smFit) and (APage.FitToPagesHorizontally = 1)
        and (APage.FitToPagesVertically = 0);
    end;
    ...
    begin
      Result := FIsDesignerCaptionAssigned and
        (DesignerCaption <> DefaultDesignerCaption);
    end;
    ...
    procedure TBasedxReportLink.SetAssignedFormatValues
      (Value: TdxAssignedFormatValues);
    begin
    ...
    begin
      Result := IsComponentPrinterAvailable and
        (ComponentPrinter.PreviewWindow <> nil);
    end;

    procedure TBasedxReportLink.RetrievePageAsImage(APageIndex: Integer;
      AGraphicClass: TGraphicClass; AGraphic: TGraphic);
    begin
      if IsComponentPrinterAvailable then
        TdxComponentPrinter(ComponentPrinter).EnumPagesAsImages([APageIndex],
          AGraphicClass, False, RetrievePageAsImageCallBack, AGraphic, nil,
          nil, Self);
    end;

    procedure TBasedxReportLink.RetrievePageAsImageCallBack(AComponentPrinter
      : TCustomdxComponentPrinter; AReportLink: TBasedxReportLink;
      AIndex, APageIndex: Integer; const AGraphic: TGraphic; AData: Pointer;
      var AContinue: Boolean);
    begin
    ...
    procedure TBasedxReportLink.TunePixelsNumerator(AReportCells
      : TdxReportCells);
    const
      MaxReportWidth = $7FFF;
      MinFactor = 2;
    ...
    begin
      ...
      begin
        RenderInfo.UnitsPerInch := MulDiv(PixelsDenominator,
          MaxReportWidth, Wo);
        RenderInfo.UnitsPerInch := RenderInfo.UnitsPerInch -
          RenderInfo.UnitsPerInch mod PixelsPerInch;
        RenderInfo.UnitsPerInch := Max(RenderInfo.UnitsPerInch,
          MinFactor * PixelsPerInch);
      end;
    end;
    ...
    procedure TBasedxReportLink.InternalGetDelimiters(ADelimitersHorz,
      ADelimitersVert: TList);
    begin
    ...
    function TBasedxReportLink.GetRebuildOnPageParamsChange
      (AUpdateCodes: TdxPrinterPageUpdateCodes): Boolean;
    begin
      Result := False;
    end;
    ...
    procedure TBasedxReportLink.SetPDFExportOptions
      (AValue: TdxPSPDFReportExportOptions);
    begin
    ...
    procedure TBasedxReportLink.SetComponentPrinter
      (Value: TCustomdxComponentPrinter);
    begin
    ...
    begin
      StyleManager := GetComponentByName(AReader.ReadString)
        as TdxPrintStyleManager;
    end;
    ...
    begin
      ...
      if not Result then
      begin
        Result := MessageQuestion
          (cxGetResourceString(@sdxOutsideMarginsMessage));
        if Result then
        begin
          Include(FState, rlsPagination);
          try
    ...
    procedure TBasedxReportLink.ComponentUnsupportedError
      (AComponent: TComponent);
    begin
      if not IsDesigning then
        raise EdxReportLink.CreateFmt
          (cxGetResourceString(@sdxComponentNotSupportedByLink),
    ...
    function TBasedxReportLink.DoBeforeExportToPDF(const AFileName: string;
      AOptions: TdxPSPDFReportExportOptions): Boolean;
    begin
      if IsComponentPrinterAvailable then
        Result := ComponentPrinter.DoBeforeExportToPDF(Self,
          AFileName, AOptions)
      else
        Result := True;
    end;
      ...
      case DataSource of
        ...
        rldsExternalStorage:
          try
            ...
            ReraiseException := IsComponentPrinterAvailable and
              (ComponentPrinter.Explorer <> nil);
            if not ReraiseException then
              MessageError(Format(cxGetResourceString(@sdxReportFileLoadError),
                [StorageName]));
    ...
    begin
      if (ComponentPrinter = nil) or
        (ComponentPrinter.CurrentCompositionByLink(Self) = nil) then
    ...
    begin
      ...
      else if DataSource = rldsComponent then
        DestroyReport;
    end;

    procedure TBasedxReportLink.CustomDraw(AnItem: TAbstractdxReportCellData;
    ...
    function TBasedxReportLink.IsSupportedCustomDraw
    ...
    procedure TdxCompositionLinkItem.Assign(Source: TPersistent);
      ...
      begin
        with Composition do
          Result := (csUpdating in ComponentState) or
            (csUpdating in ComponentPrinter.ComponentState) or
            ((ComponentPrinter.Owner <> nil) and
            (csUpdating in ComponentPrinter.Owner.ComponentState));
      end;

    begin
      if Source is TdxCompositionLinkItem then
        with TdxCompositionLinkItem(Source) do
          if (ReportLink <> nil) and (Self.Composition <> nil) and
            Self.Composition.IsComponentPrinterAvailable and IsInheritedForm
          then
            Self.ReportLink := Self.Composition.ComponentPrinter.LinkByName
              (ReportLink.Name)
          else
    ...
    begin
      if (FReportLink <> Value) and (Collection <> nil) and
        ((Value = nil) or TdxCompositionLinkItems(Collection)
        .IsLinkComposable(Value)) then
      begin
        if (FReportLink <> nil) and (Composition <> nil) and
          Composition.IsCurrentLink and Composition.PreviewExists and
          not TdxCompositionLinkItems(Collection).LinkExists(Value) then
    ...
    constructor TdxCompositionLinkItems.Create(AComposition
      : TdxCompositionReportLink);
    begin
    ...
    function TdxCompositionLinkItems.AddLink(AReportLink: TBasedxReportLink)
      : TdxCompositionLinkItem;
    begin
    ...
    procedure TdxCompositionLinkItems.DeleteItemsByLink
      (AReportLink: TBasedxReportLink);
    var
      List: TList;
      I: Integer;
    ...
    procedure TdxCompositionLinkItems.GetLinkEntries
      (AReportLink: TBasedxReportLink; AList: TList);
    var
      I: Integer;
      Item: TdxCompositionLinkItem;
    begin
    ...
    function TdxCompositionLinkItems.IndexOfLink(AReportLink
      : TBasedxReportLink): Integer;
    begin
      for Result := 0 to Count - 1 do
    ...
    function TdxCompositionLinkItems.IsLinkComposable
      (AReportLink: TBasedxReportLink): Boolean;
    begin
      Result := (AReportLink <> nil) and (Composition <> nil) and
        AReportLink.IsComposable(Composition) and
        (AReportLink.ComponentPrinter = Composition.ComponentPrinter) and
        not(AReportLink is TdxCompositionReportLink);
    end;

    function TdxCompositionLinkItems.LinkExists(AReportLink
      : TBasedxReportLink): Boolean;
    var
      List: TList;
    begin
      List := TList.Create;
    ...
    function TdxCompositionLinkItems.NextAssignedItem
      (AnItem: TdxCompositionLinkItem): TdxCompositionLinkItem;
    var
      Index: Integer;
    begin
      if AnItem <> nil then
    ...
    begin
      Result := True;
      for I := 0 to Count - 1 do
        if not Items[I].BuiltIn then
          Exit;
      Result := False;
    end;

    function TdxCompositionLinkItems.PrevAssignedItem
      (AnItem: TdxCompositionLinkItem): TdxCompositionLinkItem;
    var
      Index: Integer;
    begin
    ...
    begin
      for I := 0 to Count - 1 do
        Items[I].FReportLink := GetComponentByName
          (Items[I].FLoadingReportLinkName) as TBasedxReportLink;
    end;
    ...
    begin
      if (Composition <> nil) and
        not(Composition.IsDestroying or Composition.IsLoading) then
      begin
        ...
        else if Composition.DataProviderPresent then
        // TODO: Check non PreviewState
          Composition.RebuildReport;
      end;
    end;

    function TdxCompositionLinkItems.GetItem(Index: Integer)
      : TdxCompositionLinkItem;
    begin
      Result := TdxCompositionLinkItem(inherited Items[Index]);
    end;

    procedure TdxCompositionLinkItems.SetItem(Index: Integer;
      Value: TdxCompositionLinkItem);
    begin
    ...
    function TdxCompositionLinkItemList.GetObjectEx(Index: Integer)
      : TdxCompositionLinkItem;
    begin
      Result := TdxCompositionLinkItem(inherited Objects[Index]);
    end;

    function TdxCompositionLinkItemList.GetReportLink(Index: Integer)
      : TBasedxReportLink;
    begin
    ...
    function TdxPSCompositionReportRenderRowInfo.CalculateContentAreaHeight
      (AReportLink: TBasedxReportLink): Integer;
    var
      X: Integer;
    begin
    ...
    procedure TdxPSCompositionReportRenderRowInfo.CalculateContentInfo
      ...
      begin
        ...
        Result := MulDiv(Result, FUnitsPerInch,
          APageInfo.RenderInfo.UnitsPerInch);
        Result := Result + MulDiv(dxPSIndentBetweenComposedPages, FUnitsPerInch,
          PixelsDenominator);
      end;
      ...
      begin
        ...
        begin
          if AComposedLink.RenderInfo.PageRenderInfoCount > 0 then
            Inc(AOffset,
              GetPageContentHeight(AComposedLink.RenderInfo.PageRenderInfos[0]))
        end
        else
          Break;
      end;
      AHeight := MulDiv(APageInfo.PaintSize.Y, FUnitsPerInch,
        APageInfo.RenderInfo.UnitsPerInch) - AOffset;

      if AReportLink <> nil then
      begin
        AHeight := MulDiv(AHeight, AReportLink.RenderInfo.UnitsPerInch,
          FUnitsPerInch);
        AOffset := MulDiv(AOffset, AReportLink.RenderInfo.UnitsPerInch,
          FUnitsPerInch);
      end;
    end;

    function TdxPSCompositionReportRenderRowInfo.CalculateContentOffset
      (AReportLink: TBasedxReportLink): Integer;
    var
      X: Integer;
    begin
    ...
    function TdxPSCompositionReportRenderRowInfo.CanCompose
      (AReportLink: TBasedxReportLink): Boolean;

      function GetMinimalContentHeight(AReportLink: TBasedxReportLink): Integer;
      begin
        Result := AReportLink.RenderInfo.TitleHeight +
          Max(cxRectHeight(AReportLink.ReportCells.HeaderBoundsRect),
    ...
    begin
      Result := (ReportLink <> AReportLink) and (AReportLink.ReportCells <> nil)
        and (ReportLink.RenderInfo.PageRenderInfos[PageIndex].IsBottomPage) and
        (ReportLink.RenderInfo.FootnotesHeight = 0) and
        (ReportLink.RenderInfo.PageColCount >=
        AReportLink.RenderInfo.PageColCount) and
        (CalculateContentAreaHeight(AReportLink) > GetMinimalContentHeight
        (AReportLink));
    end;

    function TdxPSCompositionReportRenderRowInfo.Compose
      (AReportLink: TBasedxReportLink): Boolean;
    begin
    ...
    function TdxPSCompositionReportRenderRowInfo.ContainsPage
      (APageIndex: Integer): Boolean;
    begin
      Result := (PageAbsoluteIndex <= APageIndex) and
        (APageIndex < PageAbsoluteIndex + PageCount);
    end;

    function TdxPSCompositionReportRenderRowInfo.IsPartOfComposition
      (AReportLink: TBasedxReportLink): Boolean;
    begin
      Result := (FComposedLinks <> nil) and
        (FComposedLinks.IndexOf(AReportLink) >= 0);
    end;

    function TdxPSCompositionReportRenderRowInfo.GetComposedLink(Index: Integer)
      : TBasedxReportLink;
    begin
    ...
    function TdxPSCompositionReportRenderRowInfo.
      GetPageIndexRelativeToReportLink(APageIndex: Integer): Integer;
    begin
      Result := APageIndex - PageAbsoluteIndex + PageIndex;
    end;

    function TdxPSCompositionReportRenderRowInfo.GetRenderInfo
      : TdxPSReportRenderInfo;
    begin
      Result := ReportLink.RenderInfo;
    end;

    function TdxPSCompositionReportRenderRowInfo.GetReportLink
      : TBasedxReportLink;
    begin
    ...
    constructor TdxPSCompositionReportRenderInfo.Create
      (AReportLink: TBasedxReportLink);
    begin
    ...
    function TdxPSCompositionReportRenderInfo.FindRowInfo(AAbsolutePageIndex
      : Integer; out ARowInfo: TdxPSCompositionReportRenderRowInfo): Boolean;
    var
      I: Integer;
    begin
      ARowInfo := nil;
    ...
    function TdxPSCompositionReportRenderInfo.AddRowInfo
      (AItem: TdxCompositionLinkItem; AStartPageIndex, AStartPageAbsoluteIndex
      : Integer): TdxPSCompositionReportRenderRowInfo;
    begin
      Result := TdxPSCompositionReportRenderRowInfo.Create(AItem,
        AStartPageIndex, AStartPageAbsoluteIndex);
      FRowInfoList.Add(Result);
    end;

    function TdxPSCompositionReportRenderInfo.
      CalculateNonEmptyPageCount: Integer;
    var
    ...
    begin
      ...
      try
        ...
        begin
          ...
          Dec(Result, AItems.ReportLinks[I]
            .RenderInfo.CompositionPagePartCount);
        end;
      finally
        AItems.Free;
      end;
    ...
    procedure TdxPSCompositionReportRenderInfo.DoCalculate;
      ...
      procedure CalculateRowsInfo(AStartFromIndex: Integer;
        AItem: TdxCompositionLinkItem; var APageIndex: Integer;
        var APrevRowInfo: TdxPSCompositionReportRenderRowInfo);
      var
        APageInfo: TdxPSPageRenderInfo;
        APrevRowIndex, I: Integer;
      begin
        APrevRowIndex := -1;
        for I := AStartFromIndex to AItem.ReportLink.RenderInfo.
          PageRenderInfoCount - 1 do
        begin
    ...
    begin
      ...
      try
        ...
        begin
          ...
          begin
            if (APrevRowInfo <> nil) and APrevRowInfo.CanCompose
              (AItem.ReportLink) then
            begin
    ...
    function TdxPSCompositionReportRenderInfo.GetRowInfo(Index: Integer)
      : TdxPSCompositionReportRenderRowInfo;
    begin
    ...
    function TdxPSCompositionReportRenderInfo.GetItems
      : TdxCompositionLinkItemList;
    begin
    ...
    function TdxPSCompositionReportRenderInfo.GetReportLink
      : TdxCompositionReportLink;
    begin
      ...
      begin
        ...
        begin
          ...
          if ARelativePageIndex < AComposedLink.RenderInfo.PageColCount then
            AComposedLink.PaintPageEx(ACanvas, APageBounds, ARelativePageIndex,
              AContinuousPageIndex, AZoomFactor);
        end;
      end;
    end;

    function TdxPSCompositionReportRenderer.GetRenderInfo
      : TdxPSCompositionReportRenderInfo;
    begin
      Result := inherited RenderInfo as TdxPSCompositionReportRenderInfo;
    end;

    function TdxPSCompositionReportRenderer.GetReportLink
      : TdxCompositionReportLink;
    begin
      Result := inherited ReportLink as TdxCompositionReportLink;
    end;
    ...
    function TdxPSReportCompositionDocument.GetReportLink
      : TdxCompositionReportLink;
    begin
      Result := inherited ReportLink as TdxCompositionReportLink;
    end;
    ...
    begin
      ...
      begin
        ContinuousPageIndexes := TdxCompositionReportLink(Source)
          .ContinuousPageIndexes;
        DesignerOptions := TdxCompositionReportLink(Source).DesignerOptions;
        StartEachItemFromNewPage := TdxCompositionReportLink(Source)
          .StartEachItemFromNewPage;
      end;
      inherited Assign(Source);
    end;
    ...
    begin
      if RenderInfo.FindRowInfo(APageIndex, ARowInfo) then
        Result := ARowInfo.ReportLink.IsEmptyPage
          (ARowInfo.GetPageIndexRelativeToReportLink(APageIndex))
      else
        Result := False;
    end;

    procedure TdxCompositionReportLink.GetItems(AStrings: TStrings;
    ...
    procedure TdxCompositionReportLink.Notification(AComponent: TComponent;
    ...
    function TdxCompositionReportLink.GetCapabilities
      : TdxReportLinkCapabilities;
    var
    ...
    function TdxCompositionReportLink.GetRebuildOnPageParamsChange
      (AUpdateCodes: TdxPrinterPageUpdateCodes): Boolean;
    var
      I: Integer;
      ReportLink: TBasedxReportLink;
    begin
      ...
      begin
        ...
        if (ReportLink <> nil) and ReportLink.GetRebuildOnPageParamsChange
          (AUpdateCodes) then
          Exit;
      end;
      Result := False;
    ...
    procedure TdxCompositionReportLink.ConstructReport
      (AReportCells: TdxReportCells);
    begin
    end;
      ...
      try
        ...
        begin
          ...
          if (ReportLink <> nil) and ReportLink.DataProviderPresent and
            ((FInvalidatedLinks = nil) or (FInvalidatedLinks.IndexOf(ReportLink)
            <> -1)) then
          begin
    ...
    function TdxCompositionReportLink.GetRendererClass
      : TdxPSReportRendererClass;
    begin
      Result := TdxPSCompositionReportRenderer;
    end;

    function TdxCompositionReportLink.GetRenderInfoClass
      : TdxPSReportRenderInfoClass;
    begin
    ...
    procedure TdxCompositionReportLink.DoAfterBuildReport
      (AItem: TdxCompositionLinkItem);
    begin
      if Assigned(FOnAfterBuildReport) then
        FOnAfterBuildReport(Self, AItem);
    end;

    procedure TdxCompositionReportLink.DoBeforeBuildReport
      (AItem: TdxCompositionLinkItem);
    begin
      if Assigned(FOnBeforeBuildReport) then
        FOnBeforeBuildReport(Self, AItem);
    end;

    class function TdxCompositionReportLink.GetReportDocumentClass
      : TdxPSReportDocumentClass;
    begin
    ...
    function TdxCompositionReportLink.GetRenderer
      : TdxPSCompositionReportRenderer;
    begin
      Result := inherited Renderer as TdxPSCompositionReportRenderer;
    end;

    function TdxCompositionReportLink.GetRenderInfo
      : TdxPSCompositionReportRenderInfo;
    begin
      Result := inherited RenderInfo as TdxPSCompositionReportRenderInfo;
    end;

    function TdxCompositionReportLink.GetReportDocument
      : TdxPSReportCompositionDocument;
    begin
    ...
    procedure TdxCompositionReportLink.SetReportDocument
      (Value: TdxPSReportCompositionDocument);
    begin
      inherited ReportDocument := Value;
    end;

    procedure TdxCompositionReportLink.SetStartEachItemFromNewPage
      (AValue: Boolean);
    begin
    ...
    procedure TdxCompositionReportLink.ActivateLink
      (AReportLink: TBasedxReportLink);
    begin
      Include(FCompositionState, csRebuildReportLink);
      try
    ...
    procedure TdxCompositionReportLink.UpdateComposition
    ...
    begin
      ...
      Result := (ReportLink <> nil) and (ShowModal = mrOK);
      // and Modified and not Applyed;
    end;

    function TAbstractdxReportLinkDesignWindow.CanApply: Boolean;
    begin
      Result := (ReportLink <> nil) and ReportLink.DataProviderPresent and
        Modified and not(Applyed or ReportLink.IsAggregated);
    end;
    ...
    procedure TAbstractdxReportLinkDesignWindow.KeyDown(var Key: Word;
      Shift: TShiftState);
    begin
      if (ReportLink <> nil) and ReportLink.PreviewExists and
        ReportLink.IsBuilding and (Key = VK_ESCAPE) then
    ...
    function TdxPSPrintStyle.DefaultPageFooterText
      (APart: TdxPageTitlePart): string;
    var
      Index: Integer;
    begin
      Index := -1;
      if dxHFFunctionLibrary <> nil then
        case APart of
          tpCenter:
            Index := dxHFFunctionLibrary.IndexOfByClass
    ...
    constructor TdxComponentPrinterThumbnailsOptions.Create(APreviewOptions
      : TdxBasePreviewOptions);
    begin
      inherited Create;
    ...
    procedure TdxComponentPrinterThumbnailsOptions.DoAssign
      (Source: TdxComponentPrinterThumbnailsOptions);
    begin
      Font := Source.Font;
      ShowPageNumbers := Source.ShowPageNumbers;
    end;

    procedure TdxComponentPrinterThumbnailsOptions.InitializeDefaultFont
      (AFont: TFont);
    begin
    ...
    procedure TdxComponentPrinterThumbnailsOptions.FontChangeHandler
      (Sender: TObject);
    begin
    ...
    procedure TdxComponentPrinterThumbnailsOptions.SetShowPageNumbers
      (Value: Boolean);
    begin
    ...
    function TdxBasePreviewOptions.CreateThumbnailsOptions
      : TdxComponentPrinterThumbnailsOptions;
    begin
    ...
    procedure TdxBasePreviewOptions.SetEnableOptions
      (Value: TdxPreviewEnableOptions);
    begin
    ...
    procedure TdxBasePreviewOptions.SetThumbnailsOptions
      (Value: TdxComponentPrinterThumbnailsOptions);
    begin
      ThumbnailsOptions.Assign(Value);
      Changed;
    end;

    procedure TdxBasePreviewOptions.SetVisibleOptions
      (Value: TdxPreviewVisibleOptions);
    begin
    ...
    constructor TdxPreviewWindowThumbnailsOptions.Create(APreviewOptions
      : TdxBasePreviewOptions);
    begin
    ...
    procedure TdxPreviewWindowThumbnailsOptions.DoAssign
      (Source: TdxComponentPrinterThumbnailsOptions);
    begin
      inherited DoAssign(Source);
    ...
    procedure TdxPreviewWindowThumbnailsOptions.SetSize
    ...
    procedure TdxPreviewWindowThumbnailsOptions.SetVisible
      (const Value: Boolean);
    begin
    ...
    function TdxPreviewWindowOptions.CreateThumbnailsOptions
      : TdxComponentPrinterThumbnailsOptions;
    begin
      Result := TdxPreviewWindowThumbnailsOptions.Create(Self);
    end;

    function TdxPreviewWindowOptions.GetThumbnailsOptions
      : TdxPreviewWindowThumbnailsOptions;
    begin
      Result := inherited ThumbnailsOptions as
        TdxPreviewWindowThumbnailsOptions;
    end;

    procedure TdxPreviewWindowOptions.SetThumbnailsOptions
      (AValue: TdxPreviewWindowThumbnailsOptions);
    begin
    ...
    procedure TdxPSCustomPreviewWindow.LoadFromIniFile(AIniFile: TCustomIniFile;
      const ASectionName: string);
    begin
      // do nothing
    end;
    ...
    procedure TdxPSCustomPreviewWindow.SaveToIniFile(AIniFile: TCustomIniFile;
      const ASectionName: string);
    begin
      // do nothing
    end;
    ...
    begin
      if (ReportLink <> nil) and not ReportLink.Activating and ReportLink.DataProviderPresent
      then
        ReportLink.RebuildReport;
    end;
...
{$IFDEF OLEDRAGANDDROP}
    const
      DropEffects: array [Boolean] of Longint = (DROPEFFECT_NONE,
        DROPEFFECT_COPY);

    function TdxPSCustomPreviewWindow.IDropTarget_DragEnter
    ...
    begin
      ...
      try
        FDraggedFileName := '';
        if (DataObj.GetData(Format, Medium) = S_OK) and
          (DragQueryFile(Medium.hGlobal, $FFFFFFFF, nil, 0) <> 0) then
          try
            BufferSize := DragQueryFile(Medium.hGlobal, 0, nil, 0);
            Buffer := StrAlloc(BufferSize + 1);
            try
              if BufferSize = DragQueryFile(Medium.hGlobal, 0, Buffer,
                BufferSize) then
    ...
    function TdxPSCustomPreviewWindow.IDropTarget_DragOver(grfKeyState: Longint;
    ...
    function TdxPSCustomPreviewWindow.IDropTarget_Drop(const DataObj
...
{$ENDIF}
    ...
    function TdxPSCustomPreviewWindow.GetExplorerTree
      : TCustomdxPSExplorerTreeContainer;
    begin
      Result := nil;
    end;
    ...
    procedure TdxPSCustomPreviewWindow.Notification(AComponent: TComponent;
      Operation: TOperation);
    begin
      inherited Notification(AComponent, Operation);
    ...
    procedure TdxPSCustomPreviewWindow.PaintPage(Sender: TObject;
      ACanvas: TCanvas; ARect: TRect; APageIndex: Integer);
    begin
      ComponentPrinter.PaintPageCore(ACanvas, APageIndex, ZoomFactor,
        ARect, ARect);
    end;

    procedure TdxPSCustomPreviewWindow.PaintThumbnailPage(Sender: TObject;
      ACanvas: TCanvas; ARect: TRect; APageIndex: Integer);
    begin
      ACanvas.Font := Options.ThumbnailsOptions.Font;
      ComponentPrinter.PaintThumbnailPage(ACanvas, APageIndex,
        Options.ThumbnailsOptions.ShowPageNumbers,
        Options.ThumbnailsOptions.Size, ARect, ARect);
    end;
...
{$ENDIF}
    ...
    procedure TdxPSCustomPreviewWindow.SetComponentPrinter
      (AValue: TCustomdxComponentPrinter);
    begin
    ...
    procedure TdxPSCustomPreviewWindow.SetOptions
      (AValue: TdxPreviewWindowOptions);
    begin
    ...
    procedure TdxPreviewOptions.SetBounds(ALeft, ATop, AWidth,
      AHeight: Integer);
    begin
    ...
    begin
      inherited DefineProperties(Filer);
      Filer.DefineBinaryProperty('PreviewBoundsRect', ReadBoundsRect,
        WriteBoundsRect, IsBoundsStored);
      Filer.DefineProperty('IsCaptionAssigned', ReadIsCaptionAssigned,
        WriteIsCaptionAssigned, FIsCaptionAssigned and (Caption = ''));
      Filer.DefineProperty('IsIconAssigned', ReadIsIconAssigned,
        WriteIsIconAssigned, FIsIconAssigned and Icon.Empty);
    end;
    ...
    begin
      Result := FIsIconAssigned and not dxPSUtl.dxAreGraphicsEqual(FIcon,
        DefaultIcon);
    end;
    ...
    constructor TdxPSComponentPrinterExplorerChangeNotifier.Create
    ...
    procedure TdxPSComponentPrinterExplorerChangeNotifier.ItemDataUnloaded
      (AnItem: TdxPSExplorerItem);
    begin
      if (AnItem.Explorer = Explorer) and (ComponentPrinter.CurrentLink <> nil)
        and not ComponentPrinter.IsDestroying then
      begin
    ...
    procedure TdxPSPrintPageRangeInfo.SetPageIndexesAsString
      (const AValue: string);
    begin
    ...
    procedure TdxComponentPrinterListeners.BeforeDestroyReport
      (AReportLink: TBasedxReportLink);
    var
    ...
    procedure TdxComponentPrinterListeners.PageParamsChanged
      (AReportLink: TBasedxReportLink);
    var
      AIntf: IdxComponentPrinterListener;
      I: Integer;
    ...
    procedure TdxComponentPrinterListeners.CurrentLinkChanged
      (AReportLink: TBasedxReportLink);
    var
      AIntf: IdxComponentPrinterListener;
      I: Integer;
    ...
    procedure TdxComponentPrinterListeners.ExplorerChanged
      (AReportLink: TBasedxReportLink);
    var
      AIntf: IdxComponentPrinterListener;
      I: Integer;
    ...
    procedure TdxComponentPrinterListeners.LayoutChanged
      (AReportLink: TBasedxReportLink);
    var
      AIntf: IdxComponentPrinterListener;
      I: Integer;
    ...
    procedure TdxComponentPrinterListeners.PrepareBuildReport
      (AReportLink: TBasedxReportLink);
    var
      AIntf: IdxComponentPrinterListener;
      I: Integer;
    ...
    procedure TdxComponentPrinterListeners.UnprepareBuildReport
      (AReportLink: TBasedxReportLink);
    var
      AIntf: IdxComponentPrinterListener;
      I: Integer;
    ...
    begin
      ...
      FTimeFormat := 0;
      FHFTextEntryChooseSubscriber := TdxHFTextEntryChooseSubscriber.Create
        ([TdxHFTextEntryChooseEvent]);
      TdxHFTextEntryChooseSubscriber(FHFTextEntryChooseSubscriber)
        .OnHFTextEntryChoose := OnHFTextEntryChosen;
      FWindowHandle := dxPSUtl.dxAllocatehWnd(WndProc);
      FVersion := 0;
    end;
    ...
    procedure TCustomdxComponentPrinter.Notification(AComponent: TComponent;
      Operation: TOperation);
    begin
      inherited Notification(AComponent, Operation);
      if Operation = opRemove then
    ...
    procedure TCustomdxComponentPrinter.SetChildOrder(Child: TComponent;
      Order: Integer);
    begin
      inherited;
            ...
            begin
              ...
              if P = 0 then
                ...
                AName := Copy(Link.Name, 1, P - 1) + Name +
                  Copy(Link.Name, P + Length(OldName), Length(Link.Name) - P -
                  Length(OldName) + 1);
              Link.Name := AName;
            end;
          finally
    ...
    procedure TCustomdxComponentPrinter.SetExplorerStubLink
      (Value: TBasedxReportLink);
    begin
      if (FExplorerStubLink <> Value) and
        ((Value = nil) or Value.CanBeUsedAsStub) then
      begin
    ...
    procedure TCustomdxComponentPrinter.SetPreviewOptions
      (Value: TdxPreviewOptions);
    begin
    ...
    begin
      Result := not IsDesigning and not IsLoading and
        (cpoGenerateReportProgressEvent in Options);
    end;

    function TCustomdxComponentPrinter.IsRebuildBeforeOutput
      (AForceRebuild: Boolean): Boolean;
    begin
      Result := AForceRebuild or IsDesigning;
      if CurrentLink <> nil then
        Result := Result or CurrentLink.RebuildNeeded or
    ...
    procedure TCustomdxComponentPrinter.PaintPageCore(ACanvas: TCanvas;
      APageIndex: Integer; AZoomFactor: Integer;
      const APageBounds, AContentBounds: TRect;
      AReportLink: TBasedxReportLink = nil);
    begin
    ...
    procedure TCustomdxComponentPrinter.PaintThumbnailPage(ACanvas: TCanvas;
      APageIndex: Integer; AShowPageNumbers: Boolean;
      AThumbnailSize: TdxPSThumbnailsSize;
      const APageBounds, AContentBounds: TRect;
      AReportLink: TBasedxReportLink = nil);
    var
      AFontSize: Integer;
    begin
      ...
      begin
        AReportLink.PaintPage(ACanvas, APageBounds, APageIndex, APageIndex,
          dxThumbnailsZoomFactors[AThumbnailSize]);
        ...
        begin
          ...
          try
            ...
            dxPSUtl.DrawBlendedText(ACanvas, APageBounds,
              IntToStr(AReportLink.Renderer.PreparedPageIndex(APageIndex) + 1),
              ACanvas.Font);
          finally
    ...
    function TCustomdxComponentPrinter.GetExplorerRealStubLink
      : TBasedxReportLink;
    begin
    ...
    begin
      ...
      if (Explorer <> nil) and (Explorer.LoadedItem <> nil) then
        Result := Result + ' ' + sdxDocumentCaptionSeparator + ' ' +
          Explorer.LoadedItem.FormCaption
      else if (CurrentLink <> nil) and
        (CurrentLink.DataSource = rldsExternalStorage) and
        (CurrentLink.StorageName <> '') then
        Result := Result + ' ' + sdxDocumentCaptionSeparator + ' ' +
          CurrentLink.StorageName;
    end;

    function TCustomdxComponentPrinter.GetReportLink(Index: Integer)
      : TBasedxReportLink;
    begin
    ...
    procedure TCustomdxComponentPrinter.SetCurrentLink
      (Value: TBasedxReportLink);
    begin
    ...
    procedure TCustomdxComponentPrinter.SetPageNumberFormat
      (Value: TdxPageNumberFormat);
    begin
      FPageNumberFormat := Value;
    end;
    ...
    procedure TCustomdxComponentPrinter.SetReportLink(Index: Integer;
      Value: TBasedxReportLink);
    begin
    ...
    procedure TCustomdxComponentPrinter.EndPrintPages(var APageIndexes
      : TIntegers);
    begin
      SetLength(APageIndexes, 0);
    end;

    procedure TCustomdxComponentPrinter.CreatePreviewWindowForm
      (AReportLink: TBasedxReportLink);
    var
          ...
          if dxPSStoringManager.BeginStoring(AIniFile) then
            try
              if dxPSEngine.SaveFormsPosition then
                dxPSFormSavePositionToIniFile(PreviewWindowForm, AIniFile,
                  dxPSFormGetActualSectionName(PreviewWindowForm));
            finally
              dxPSStoringManager.EndStoring(AIniFile);
            end;
        finally
    ...
    begin
      ...
      begin
        ...
        ShowWindow(PreviewWindowForm.Handle,
          Flags[AWindowPlacement.ShowCmd = SW_SHOWMINIMIZED]);
        SetForegroundWindow(PreviewWindowForm.Handle);
      end
      else if AModal then
      begin
        PreviewWindowForm.BorderIcons := PreviewWindowForm.BorderIcons -
          [biMinimize];
    ...
    procedure TCustomdxComponentPrinter.InitDevModeFromPrinterPageSettings
      (APrinterPage: TdxPrinterPage);
    begin
      if (dxPrintDevice = nil) or (dxPrintDevice.DeviceMode = nil) then
        Exit;
      dxPrintDevice.Orientation := APrinterPage.Orientation;
      dxPrintDevice.DeviceMode^.dmColor :=
        Byte(not APrinterPage.GrayShading) + 1;
    end;

    function TCustomdxComponentPrinter.PrintDialog
      (AReportLink: TBasedxReportLink;
      var APrintDlgData: TdxPrintDlgData): Boolean;
    var
    ...
    begin
      ...
      try
        if not(rlcPageSetup in AReportLink.Capabilities) then
          APrintDlgData.ButtonsVisible := APrintDlgData.ButtonsVisible -
            [pdbPageSetup];
          ...
          if not PreviewBtnClicked then
            ...
            begin
              ...
              begin
                ...
                Result := PrintPagesAsStringEx(Pages, PageNums, Copies, Collate,
                  AReportLink);
              end
              else // prAll
    ...
    function TCustomdxComponentPrinter.PrintPagesAsStringEx
      (const APages: string; APageNums: TdxPageNumbers; ACopyCount: Integer;
      ACollate: Boolean; AReportLink: TBasedxReportLink = nil): Boolean;
    var
    ...
    begin
      ...
      if Result then
        try
          PrintPagesEx(PageIndexes, APageNums, ACopyCount, ACollate,
            AReportLink);
        finally
    ...
    begin
      ...
      ADone := (CurrentLink <> nil) and PageSetupEx(0, ShowPreviewBtn,
        ShowPrintBtn, PreviewBtnClicked, PrintBtnClicked, CurrentLink);
    ...
    procedure TCustomdxComponentPrinter.RaiseBuildingEvent
      (AReportLink: TBasedxReportLink; const APercentCompleted: Double;
      AStage: TdxPSBuildStage);
    var
      AEvent: TdxEvent;
    begin
      if CurrentCompositionByLink(AReportLink) = nil then
      begin
        AEvent := TdxPSBuildEvent.Create(Self, AReportLink,
          APercentCompleted, AStage);
        dxPSProcessEvent(AEvent)
      end;
    end;

    procedure TCustomdxComponentPrinter.RaisePrintingEvent
      (AReportLink: TBasedxReportLink; APageIndex, APageCount: Integer;
      AStage: TdxPSPrintStage);
    var
      Event: TdxEvent;
    begin
      Event := TdxPSPrintEvent.Create(Self, AReportLink, APageIndex,
        APageCount, AStage);
      dxPSProcessEvent(Event);
    end;

    procedure TCustomdxComponentPrinter.ActivateLink
      (AReportLink: TBasedxReportLink);

      function IsCompositionActivatation(AComposition
        : TdxCompositionReportLink): Boolean;
      begin
        Result := (AComposition <> nil) and
          not(csRebuildReportLink in AComposition.CompositionState);
      end;
    ...
    begin
      ...
      if (AReportLink is TdxCompositionReportLink) or (Composition = nil) or
        IsCompositionActivatation(Composition) then
      begin
      ...
      try
        ...
        begin
          if IsCompositionActivatation(Composition) and
            (Composition.DataSource = rldsComponent) then
            Composition.DateTime := Now
          else if AReportLink.DataSource = rldsComponent then
    ...
    function TCustomdxComponentPrinter.CheckLink(Value: TBasedxReportLink)
      : TBasedxReportLink;
    begin
      if Value <> nil then
        CurrentLink := Value;
    ...
    function TCustomdxComponentPrinter.CreateLink
      (ALinkClass: TdxReportLinkClass; AComponent: TComponent;
      AOwner: TComponent): TBasedxReportLink;
    var
      LinkClass: TdxReportLinkClass;
    begin
      ...
      if AComponent <> nil then
        if IsSupportedCompClass(AComponent) then
          LinkClass := dxPSLinkClassByCompClass
            (TComponentClass(AComponent.ClassType))
        else if IsDesigning then
          raise EdxComponentPrinter.Create
            (cxGetResourceString(@sdxComponentNotSupported));
    ...
    procedure TCustomdxComponentPrinter.DeactivateLink
      (AReportLink: TBasedxReportLink);
    begin
    ...
    procedure TCustomdxComponentPrinter.OnHFTextEntryChosen(Sender: TObject;
      const AEntry: string);
    var
      PagePart: TCustomdxPageObject;
      Part1, Part2, Part3: string;
    begin
      if (CurrentLink <> nil) and
        (TdxPrintStyleManager(Sender) = CurrentLink.StyleManager) then
      begin
        if PreviewExists then
          ...
          if (Part2 = '') and (Part3 = '') then
            ...
            begin
              if Part1 <> '' then
                LeftTitle.Add(Part1);
              if Part2 <> '' then
                CenterTitle.Add(Part2);
              if Part3 <> '' then
                RightTitle.Add(Part3);
            end;
    ...
    procedure TCustomdxComponentPrinter.PreviewOptionsChangeHandler
      (Sender: TObject);
    begin
      if PreviewExists then
      begin
    ...
    procedure TCustomdxComponentPrinter.DesignerUpdate
      (AnItem: TBasedxReportLink);
    begin
      if ReportLinkDesigner <> nil then
        ...
        case Msg of
          WM_SETTINGCHANGE:
            begin
              ...
              for I := 0 to LinkCount - 1 do
                TdxReportLinkPrinterPage(ReportLink[I].PrinterPage)
    ...
    procedure TCustomdxComponentPrinter.FormatChanged
      (AReportLink: TBasedxReportLink);
    begin
      dxHFFormatObject.DateFormat := dxPgsDlg.DateFormats
        [AReportLink.DateFormat];
      ...
      dxHFFormatObject.TimeFormat := dxPgsDlg.TimeFormats
        [AReportLink.TimeFormat];
    end;

    procedure TCustomdxComponentPrinter.AssignReportLinks
    ...
    function TCustomdxComponentPrinter.CreateLinkFromFile(const AFileName
      : string): TBasedxReportLink;
    var
      AStream: TFileStream;
    begin
      try
    ...
    function TCustomdxComponentPrinter.CreateLinkFromStream(AStream: TStream)
      : TBasedxReportLink;
    var
      AStorageInfo: TdxPSDataStorageInfo;
    begin
      try
        ...
        if AStorageInfo.StorageVersion = dxPSStorageVersion then
          ...
          begin
            ...
            raise EdxReportLink.CreateFmt
              (cxGetResourceString(@sdxLinkIsNotIncludedInUsesClause),
              [AStorageInfo.LinkClassName])
        else
    ...
    begin
      Result := AddEmptyLinkEx(TdxCompositionReportLink, Owner)
        as TdxCompositionReportLink;
    end;

    function TCustomdxComponentPrinter.AddEmptyLink
      (ALinkClass: TdxReportLinkClass): TBasedxReportLink;
    begin
      Result := AddEmptyLinkEx(ALinkClass, Owner);
    end;

    function TCustomdxComponentPrinter.AddEmptyLinkEx
      (ALinkClass: TdxReportLinkClass; AOwner: TComponent): TBasedxReportLink;
    begin
      Result := CreateLink(ALinkClass, nil, AOwner);
    end;

    function TCustomdxComponentPrinter.AddLink(AComponent: TComponent)
      : TBasedxReportLink;
    begin
    ...
    begin
      if Value <> nil then
        ...
        begin
          Result := ReportLink[I];
          if Result.Component = Value then
            Exit;
        end;
    ...
    function TCustomdxComponentPrinter.IndexOfLink
      (AReportLink: TBasedxReportLink): Integer;
    begin
      Result := FReportLinks.IndexOf(AReportLink);
    end;

    function TCustomdxComponentPrinter.IndexOfLink(const AName: string)
      : Integer;
    begin
      Result := IndexOfLinkByName(AName);
    end;

    function TCustomdxComponentPrinter.IndexOfLinkByName
      (const AName: string): Integer;
    begin
      Result := IndexOfLink(LinkByName(AName));
    end;

    function TCustomdxComponentPrinter.LinkByName(const AName: string)
      : TBasedxReportLink;
    var
      I: Integer;
    begin
    ...
    function TCustomdxComponentPrinter.CurrentCompositionByLink
      (AReportLink: TBasedxReportLink): TdxCompositionReportLink;
    var
      I: Integer;
      ALink: TBasedxReportLink;
    begin
    ...
    procedure TCustomdxComponentPrinter.GetCompositionsByLink
      (AReportLink: TBasedxReportLink; ACompositions: TList);
    var
      I: Integer;
      ALink: TBasedxReportLink;
    begin
    ...
    procedure TCustomdxComponentPrinter.GetItems(AComposition
      : TdxCompositionReportLink; AStrings: TStrings;
      AExcludeAssigned: Boolean);
    var
      I: Integer;
        ...
        try
          ...
          begin
            ...
            if not(AItem is TdxCompositionReportLink) and
              (not AExcludeAssigned or not IsLinkInComposition(AItem,
              AComposition)) then
    ...
    function TCustomdxComponentPrinter.IsLinkInComposition
      (AReportLink: TBasedxReportLink;
      AComposition: TdxCompositionReportLink): Boolean;
    var
      AList: TList;
    ...
    function TCustomdxComponentPrinter.IsLinkInCurrentComposition
      (AReportLink: TBasedxReportLink): Boolean;
    begin
    ...
    class function TCustomdxComponentPrinter.GetNewLinkName
      (AReportLink: TBasedxReportLink): string;
    begin
      Result := sdxNewLinkNameTemplate;
    end;

    class function TCustomdxComponentPrinter.IsSupportedCompClass
    ...
    class function TCustomdxComponentPrinter.IsSupportedCompClass
      (AComponent: TObject { TComponent } ): Boolean;
    begin
    ...
    procedure TCustomdxComponentPrinter.PrepareBuildReport
      (AReportLink: TBasedxReportLink);
    begin
    ...
    procedure TCustomdxComponentPrinter.UnprepareBuildReport
      (AReportLink: TBasedxReportLink);
    begin
      ...
      begin
        ...
        begin
          ...
          begin
            ...
            if FEndTime - FStartTime > DWORD(LongOperationTime) then
              Beep;
          end;
        end;
      end;
    ...
    procedure TCustomdxComponentPrinter.DoCustomDrawEntirePage
      (AReportLink: TBasedxReportLink; ACanvas: TCanvas; APageIndex: Integer;
      ARect: TRect; ANom, ADenom: Integer);
    begin
      if Assigned(FOnCustomDrawPage) then
        FOnCustomDrawPage(Self, AReportLink, ACanvas, APageIndex, ARect,
          ANom, ADenom);
    end;

    procedure TCustomdxComponentPrinter.DoNewPage
      (AReportLink: TBasedxReportLink; APageIndex: Integer);
    begin
      AReportLink := CheckLink(AReportLink);
      if AReportLink <> nil then
    ...
    procedure TCustomdxComponentPrinter.DoEndPrint
      (AReportLink: TBasedxReportLink);
    begin
      AReportLink := CheckLink(AReportLink);
      if AReportLink <> nil then
    ...
    procedure TCustomdxComponentPrinter.DoStartPrint
      (AReportLink: TBasedxReportLink; FullPageCount: Integer);
    begin
      AReportLink := CheckLink(AReportLink);
      if AReportLink <> nil then
      begin
    ...
    procedure TCustomdxComponentPrinter.DoAddReportLink
      (AReportLink: TBasedxReportLink);
    begin
    ...
    procedure TCustomdxComponentPrinter.DoAfterPreview
      (AReportLink: TBasedxReportLink);
    begin
    ...
    procedure TCustomdxComponentPrinter.DoBeforeDesignReport
      (AReportLink: TBasedxReportLink);
    begin
    ...
    procedure TCustomdxComponentPrinter.DoBeforeDestroyReport
      (AReportLink: TBasedxReportLink);
    begin
    ...
    procedure TCustomdxComponentPrinter.DoBeforePreview
      (AReportLink: TBasedxReportLink);
    begin
    ...
    procedure TCustomdxComponentPrinter.DoChangeComponent
      (AReportLink: TBasedxReportLink);
    begin
      if not IsLoading then
      begin
    ...
    procedure TCustomdxComponentPrinter.DoDeleteReportLink
      (AReportLink: TBasedxReportLink);
    begin
      if not IsLoading then
      begin
    ...
    procedure TCustomdxComponentPrinter.DoDesignReport
    ...
    procedure TCustomdxComponentPrinter.DoLayoutChanged
      (AReportLink: TBasedxReportLink);
    begin
      Listeners.LayoutChanged(AReportLink);
    end;

    procedure TCustomdxComponentPrinter.DoPageParamsChanged
      (AReportLink: TBasedxReportLink);
    begin
      Listeners.PageParamsChanged(AReportLink);
    end;

    procedure TCustomdxComponentPrinter.DoPageSetup
      (AReportLink: TBasedxReportLink; ADone: Boolean);
    begin
    ...
    begin
      if IsGenerateReportProgressEvent and Assigned(FOnGenerateReportProgress)
      then
    ...
    procedure TCustomdxComponentPrinter.DoStartUpdateReport
      (AReportLink: TBasedxReportLink);
    begin
    ...
    procedure TCustomdxComponentPrinter.DoEndUpdateReport
      (AReportLink: TBasedxReportLink);
    begin
    ...
    begin
      ...
      begin
        ...
        if DialogData.MaxRange = 0 then
          DialogData.MaxRange := -1;
        ...
        if not IsDesigning and (not(cpsPreviewing in State) or
          (pvoPrintStyles in PreviewOptions.VisibleOptions)) then
    ...
    function TCustomdxComponentPrinter.GetPrintTitle
      (AReportLink: TBasedxReportLink): string;
    begin
      Result := FPrintTitle;
    ...
    procedure TCustomdxComponentPrinter.Preview(AModal: Boolean = True;
      ...
      begin
        Result := True;
        if AReportLink.DataProviderPresent and
          (IsDesigning or IsRebuildBeforePreview) then
        begin
          AReportLink.PrinterPage.InitFromPrintDevice;
          try
        ...
        else if AutoUpdateDateTime then
          AReportLink.DateTime := Now;
      end;
    ...
    procedure TCustomdxComponentPrinter.PaintPage(ACanvas: TCanvas;
      ...
      AReportLink: TBasedxReportLink = nil);
    begin
      PaintPageCore(ACanvas, APageIndex, 100, APageBounds, AContentBounds,
        AReportLink);
    end;
    ...
    begin
      ...
      begin
        ...
        OnCustomDrawReportFootnotes(Self, AReportLink, ACanvas, ARect,
          APixelsNumerator, PixelsDenominator, ATextAlignX, ATextAlignY, AColor,
          AFont, ADone);
      end;
    end;

    procedure TCustomdxComponentPrinter.DoCustomDrawReportTitle
      (AReportLink: TBasedxReportLink; ACanvas: TCanvas; ARect: TRect;
      var ATextAlignX: TcxTextAlignX; var ATextAlignY: TcxTextAlignY;
      var AColor: TColor; AFont: TFont; var ADone: Boolean;
      APixelsNumerator: Integer = 0);
    begin
      ...
      begin
        if APixelsNumerator = 0 then
          APixelsNumerator := PixelsNumerator;
        OnCustomDrawReportTitle(Self, AReportLink, ACanvas, ARect,
          APixelsNumerator, PixelsDenominator, ATextAlignX, ATextAlignY, AColor,
          AFont, ADone);
      end;
    end;
    ...
    procedure TCustomdxComponentPrinter.PrintPages(const APageIndexes
      : TdxPSPageIndexes; AReportLink: TBasedxReportLink = nil);
    begin
      PrintPagesEx(APageIndexes, pnAll, 1, False, AReportLink);
    end;

    procedure TCustomdxComponentPrinter.PrintPagesEx(const APageIndexes
      : TdxPSPageIndexes; APageNums: TdxPageNumbers; ACopyCount: Integer;
      ACollate: Boolean; AReportLink: TBasedxReportLink = nil);
      ...
      begin
        ...
        IsRecombineNeeded := AReportLink.RealPrinterPage.PageOrder =
          poDownThenOver;
        if IsRecombineNeeded then
        begin
          AReportLink.GetPageColRowCount(ColCount, RowCount);
          IsRecombineNeeded := (ColCount <> 1) and (RowCount <> 1) and
            AreAllPagesInRange;
        end;
      ...
      begin
        Result := not((APageIndex < 0) or (APageIndex > AReportLink.PageCount -
          1) or ((APageNums = pnEven) and not Odd(AIndex)) or
      ...
      begin
        Result := (Integer(AErrorCode) <= 0) and (AErrorCode <> SP_APPABORT) and
          (AErrorCode <> SP_USERABORT) and
          ((dxPrintDevice.CurrentPort = nil) or
      ...
      procedure PreparePrintDevice(const AActualPageIndexes: TIntegers;
        out ACurrentPrinterPage: TdxPrinterPage);
      begin
        dxPSEdgePatternFactory.ResetPrintItems;
        dxPSFillPatternFactory.ResetPrintItems;
        ACurrentPrinterPage := AReportLink.RenderInfo.GetActualPageRenderInfo
          (AActualPageIndexes[0] - 1).PrinterPage;
      ...
      procedure DoPrintPage(var ACurrentPage: Integer; APageIndex: Integer;
        var ACurrentPrinterPage: TdxPrinterPage);
      var
        APrinterPage: TdxPrinterPage;
      begin
        APrinterPage := AReportLink.RenderInfo.GetActualPageRenderInfo
          (APageIndex).PrinterPage;
      ...
      procedure DoPrintPages(const AActualPageIndexes: TIntegers;
        ACollate: Boolean; ACopyCount: Integer);
      var
        ACopyIndex: Integer;
    ...
    function TCustomdxComponentPrinter.Print(AShowDialog: Boolean;
      ...
      procedure DonePrintDlgData(AReportLink: TBasedxReportLink;
    ...
    procedure TCustomdxComponentPrinter.PrepareReport
      (AReportLink: TBasedxReportLink);
    begin
    ...
    procedure TCustomdxComponentPrinter.UnprepareReport
      (AReportLink: TBasedxReportLink);
    begin
      AReportLink.FPrepared := False;
    end;
    ...
    procedure TCustomdxComponentPrinter.UnprepareLoadFromStream
      (AStream: TStream);
    begin
    ...
    procedure TCustomdxComponentPrinter.LoadVersionFromStream(AStream: TStream;
      ...
      begin
        ...
        try
          ...
          begin
            FPrintAll := True;
            try
              PrintPagesAsStringEx('1-' + Trim(IntToStr(AReportLink.PageCount)),
                APageNums, ACopies, ACollate, AReportLink);
            finally
              FPrintAll := False;
            end;
          end;
    ...
    procedure TCustomdxComponentPrinter.GetPageColRowCount(out ACol,
      ARow: Integer; AReportLink: TBasedxReportLink = nil);
    begin
      AReportLink := CheckLink(AReportLink);
      if AReportLink = nil then
      begin
    ...
    function TCustomdxComponentPrinter.GetPageCount
      (AReportLink: TBasedxReportLink = nil): Integer;
    begin
      AReportLink := CheckLink(AReportLink);
      if AReportLink <> nil then
    ...
    function TCustomdxComponentPrinter.PageSetup(AReportLink
      : TBasedxReportLink): Boolean;
    begin
      AReportLink := CheckLink(AReportLink);
    ...
    begin
      AReportLink := CheckLink(AReportLink);
      Result := (AReportLink <> nil) and AReportLink.PageSetupEx
        (AActivePageIndex, AShowPreviewBtn, AShowPrintBtn, APreviewBtnClicked,
        APrintBtnClicked);
    end;
      ...
      begin
        ...
        try
          ...
          try
            ...
            if ExplorerStubLink = nil
            then { Link had been created manually before }
              CurrentLink.Free;
    ...
    procedure TCustomdxComponentPrinter.ExportToPDF
      (AReportLink: TBasedxReportLink);
    begin
      AReportLink := CheckLink(AReportLink);
      if AReportLink <> nil then
    ...
    function TCustomdxComponentPrinter.DesignerExistsByComponent
      (AComponent: TComponent): Boolean;
    begin
      Result := (AComponent <> nil) and
        (dxPSDesignerClassByCompClass
        (TComponentClass(AComponent.ClassType)) <> nil);
    end;

    function TCustomdxComponentPrinter.DesignReport
      (AReportLink: TBasedxReportLink): Boolean;
    begin
      AReportLink := CheckLink(AReportLink);
      if AReportLink <> nil then
    ...
    procedure TCustomdxComponentPrinter.DrawPageHeader
      (AReportLink: TBasedxReportLink; APageIndex: Integer; ARect: TRect;
      ATitleParts: TdxPageTitleParts; ADrawBackground: Boolean);
    begin
      AReportLink.DrawPageHeader(APageIndex, ARect, ATitleParts,
        ADrawBackground);
    end;

    procedure TCustomdxComponentPrinter.DrawPageFooter
      (AReportLink: TBasedxReportLink; APageIndex: Integer; ARect: TRect;
      ATitleParts: TdxPageTitleParts; ADrawBackground: Boolean);
    begin
      AReportLink.DrawPageFooter(APageIndex, ARect, ATitleParts,
        ADrawBackground);
    end;
...
{$ENDIF}
    ...
    procedure TdxComponentPrinter.LoadFromIniFile(AIniFile: TCustomIniFile;
      const ASection: string);
    begin
      AutoUpdateDateTime := AIniFile.ReadBool(ASection, sdxAutoUpdateDateTime,
        AutoUpdateDateTime);
      DateFormat := AIniFile.ReadInteger(ASection, sdxDateFormat, DateFormat);
      TimeFormat := AIniFile.ReadInteger(ASection, sdxTimeFormat, TimeFormat);
      PageNumberFormat := TdxPageNumberFormat(AIniFile.ReadInteger(ASection,
        sdxPageNumberFormat, Ord(TimeFormat)));
      dxLoadStrings(AIniFile, dxValidatePath(ASection) + sdxPrintDlgFilesPath +
        '\' + Name, FPrintFileList);
    end;
    ...
    procedure TdxComponentPrinter.SaveToIniFile(AIniFile: TCustomIniFile;
      const ASection: string);
    begin
      ...
      AIniFile.WriteInteger(ASection, sdxPageNumberFormat,
        Integer(PageNumberFormat));
      dxSaveStrings(AIniFile, dxValidatePath(ASection) + sdxPrintDlgFilesPath +
        '\' + Name, FPrintFileList);
    end;
    ...
    procedure TdxComponentPrinter.GetExportPageFileName(AIndex,
      APageIndex: Integer; var AFileName: string);
    begin
    ...
    function TdxComponentPrinter.GetSupportedComponents
      (AComponents: TStrings): Boolean;
    begin
    ...
    procedure TdxComponentPrinter.EnumPagesAsImages(const APageIndexes
      : array of Integer; AGraphicClass: TGraphicClass;
      ADrawBackground: Boolean; ACallBackProc: TdxEnumPagesAsImagesProc;
    ...
    begin
      ...
      if AReportLink = nil then
        Exit;
      dxPSEnumReportPages(Self, AReportLink, APageIndexes, AGraphicClass,
        ADrawBackground, ACallBackProc, ACallBackData, OnExportProgress,
        AProgressData, OnExportPrepareGraphic, APrepareData);
    end;

    procedure TdxComponentPrinter.WritePageAsImageToDisk(AComponentPrinter
      : TCustomdxComponentPrinter; AReportLink: TBasedxReportLink;
      AIndex, APageIndex: Integer; const AGraphic: TGraphic; AData: Pointer;
      var AContinue: Boolean);
    const
      Buttons: TMsgDlgButtons = [mbYes, mbYesToAll, mbNo,
        mbCancel { , mbHelp } ];
    var
      FileName: string;
      MessageResult: Word;
    ...
    begin
      ...
      FOverWriteFile := True;
      if FileExists(FileName) and not OverWriteExistingFiles and not FOverWriteAll
      then
      begin
        Beep;
        FOverWriteFile := False;
        MessageText := Format(cxGetResourceString(@sdxConfirmOverWrite),
          [FileName]);
    ...
    procedure TdxComponentPrinter.SavePagesAsImagesToDisk(const APageIndexes
      : array of Integer; AGraphicClass: TGraphicClass;
      ADrawBackground: Boolean; const AFileMask: string;
    ...
    constructor TAbstractdxPreviewWindowDesigner.Create(AComponentPrinter
      : TCustomdxComponentPrinter);
    begin
      inherited Create;
      FComponentPrinter := AComponentPrinter;
    ...
    constructor TAbstractdxReportLinkDesigner.Create(AComponentPrinter
      : TCustomdxComponentPrinter);
    begin
      inherited Create;
      FComponentPrinter := AComponentPrinter;
    ...
    function TdxPSPreviewDialogManager.CreatePreviewWindow
      : TdxPSCustomPreviewWindow;
    begin
    ...
    procedure TdxPSPreviewDialogManager.PopulatePreviewDialogList
      (AStrings: TStrings);
    var
      I: Integer;
    begin
    ...
    function TdxPSPreviewDialogManager.GetCurrentPreviewDialogStyleInfo
      : TdxPSPreviewDialogStyleInfoClass;
    var
      AInfoClass: TdxPSPreviewDialogStyleInfoClass;
    begin
      if FindPreviewDialogStyleInfoByName(CurrentPreviewDialogStyle, AInfoClass)
      then
        Result := AInfoClass
      else
        raise EdxComponentPrinter.Create
          (cxGetResourceString(@sdxPreviewNotRegistered));
    end;

    function TdxPSPreviewDialogManager.GetCurrentPreviewDialogStyle
      : TdxPSPreviewDialogStyle;
    var
      AInfoClass: TdxPSPreviewDialogStyleInfoClass;
    begin
      if not FindPreviewDialogStyleInfoByName(FCurrentPreviewDialogStyle,
        AInfoClass) then
        FCurrentPreviewDialogStyle := DefaultPreviewDialogStyleInfo.GetName;
      Result := FCurrentPreviewDialogStyle;
    end;

    function TdxPSPreviewDialogManager.GetDefaultPreviewDialogStyleInfo
      : TdxPSPreviewDialogStyleInfoClass;
    begin
      if Count > 0 then
    ...
    function TdxPSPreviewDialogManager.GetItem(Index: Integer)
      : TdxPSPreviewDialogStyleInfoClass;
    begin
    ...
    var
      APreviewDialogStyleInfo: TdxPSPreviewDialogStyleInfoClass;
    begin
      if not FindPreviewDialogStyleInfoByName(AValue, APreviewDialogStyleInfo)
      then
    ...
    procedure TdxReportLinkPrinterPage.PageParamsChanged
      (AUpdateCodes: TdxPrinterPageUpdateCodes);
    begin
    ...
    class function TdxPSPreviewDialogStyleInfo.CreatePreviewWindow
      : TdxPSCustomPreviewWindow;
    begin
      Result := nil;
    end;
    ...
    procedure dxPSEnumReportPages(AComponentPrinter: TdxComponentPrinter;
      ...
      begin
        Result := (Low(APageIndexes) = High(APageIndexes)) and
          (APageIndexes[0] = -1);
      end;
      ...
      function CreatePageAsMetafile(const ABounds: TRect; const APPI: TPoint;
        APageIndex: Integer): TMetafile;
      var
        AMetaCanvas: TCanvas;
      ...
      begin
        ...
        try
          ...
          try
            ...
            if AGraphicClass.InheritsFrom(TMetafile) and
              Assigned(APrepareGraphicProc) then
              APrepareGraphicProc(AComponentPrinter, AReportLink, Result,
                APrepareData);

            if AnExportBackground and AReportLink.RealPrinterPage.Background.IsEmpty
            then
            ...
            if (-1 < APageIndex) and (APageIndex < AReportLink.PageCount) then
              AComponentPrinter.PaintPage(AMetaCanvas, APageIndex, ABounds,
                ABounds, AReportLink);
          finally
            if not FUseIsotropicMode then
            begin
      ...
      function CreatePageAsGraphic(const ABounds: TRect; const APPI: TPoint;
        APageIndex: Integer): TGraphic;
      var
        Metafile: TMetafile;
        Bitmap: TBitmap;
      begin
        ...
        try
          ...
          begin
            ...
            try
              ...
              if AGraphicClass.InheritsFrom(TBitmap) and
                Assigned(APrepareGraphicProc) then
                APrepareGraphicProc(AComponentPrinter, AReportLink, Bitmap,
                  APrepareData);
    ...
    var
      ...
      Graphic: TGraphic;
    begin
      if (AComponentPrinter = nil) or (AReportLink = nil) or
        not Assigned(ACallBackProc) then
        Exit;
      ...
      try
        ...
        begin
          ...
          try
            ACallBackProc(AComponentPrinter, AReportLink, I, PageIndex, Graphic,
              ACallBackData, ContinueExport);
          finally
            Graphic.Free;
          end;
          ...
          if Assigned(AProgressProc) then
            AProgressProc(AComponentPrinter, AReportLink, PageCount, I,
              PageIndex, AProgressData);
        end;
      finally
...
dxPSRegisterReportLink(TdxCompositionReportLink, nil,
