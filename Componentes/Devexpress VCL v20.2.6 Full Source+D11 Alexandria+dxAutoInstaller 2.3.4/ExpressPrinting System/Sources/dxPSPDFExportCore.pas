...
{$IFDEF DX_PDF_COMPRESS_STREAMS}
  ZLib,
{$ENDIF}
  Graphics, cxClasses, dxCore, cxGeometry, cxGraphics, dxPSPDFStrings, dxCrypto,
  dxHash, dxHashUtils, dxX509Certificate;

const
  dxPDFCanCompositeFonts: Boolean = True;
  dxPDFCanCompressStreams =
  {$IFDEF DX_PDF_COMPRESS_STREAMS}True{$ELSE}False{$ENDIF};
...
type
  ...
  public
    constructor Create(AStream: TStream;
      ...
      ACompressStreams, AUseJPEGCompression: Boolean;
      AJPEGQuality: Integer); virtual;
    destructor Destroy; override;
    function EncodeString(const S: string; AHexArray: Boolean = True): string;
    function GetStreamEncoding(AStreamType: TdxPSPDFStreamType)
      : TdxPSPDFStreamEncoding;
  ...
  strict private
    ...
    function CreateBitmap(AGraphic: TGraphic;
      var ANeedDestroy: Boolean): TBitmap;
  ...
  protected
    ...
    // SelectFont conflicts with C++ macro
  ...
  public
    ...
    procedure DrawRoundFrame(const R: TRect;
      ...
      AThickness: Integer);
    procedure DrawText(const AText: string; const AOffset: TdxPointF;
      const AAngle, ACharsSpacing, AWordSpacing: Double);
    procedure Fill;
    ...
    procedure FillRectByBrush(const R: TRect; AColor: TColor;
      AStyle: TBrushStyle = bsSolid);
    procedure FillRectByGraphic(const R: TRect; AWidth, AHeight: Integer;
      AGraphic: TGraphic);
    procedure FillRectByPattern(const R: TRect;
    ...
    procedure Polyline(const APoints: array of TPoint; const ALineWidth: Double;
    ...
    function AbsoluteTextWidth(const AText: PChar; ATextLength: Integer)
      : Double; overload; virtual;
    function AbsoluteTextWidth(const AText: string): Double; overload;
    procedure TextOut(const AText: string; const X, Y, ACharsSpacing,
      AWordSpacing: Double); overload;
    procedure TextOut(const X, Y: Double;
      AProc: TdxPSPDFPageContentTextOutProc); overload;
    function TextWidth(const AText: Char): Double; overload;
    function TextWidth(const AText: PChar; ATextLength: Integer)
      : Double; overload;
    ...
    procedure WriteRoundRect(const R: TRect;
      const AEllipseWidth, AEllipseHeight: Double);
  ...
  protected
    ...
    function CreateWidgetAnnotation(AField: TdxPSPDFCustomField)
  ...
  public
    constructor Create(AOwner: TdxPSPDFPatternList;
      const APatternWidth, APatternHeight: Double);
  ...
  public
    constructor Create(AOwner: TdxPSPDFPatternList; AStyle: TBrushStyle;
      AColor: TColor);
  ...
  public
    ...
    function AddPattern(ABrushStyle: TBrushStyle; AColor: TColor)
      : TdxPSPDFCustomPattern; overload;
    function AddPattern(AImageIndex: Integer;
      const APatternWidth, APatternHeight: Double)
      : TdxPSPDFCustomPattern; overload;
    function AddPattern(APattern: TdxPSPDFCustomPattern)
      : TdxPSPDFCustomPattern; overload;
  ...
  public
    constructor Create(AOwner: TdxPSPDFFontList; AEmbed: Boolean;
      AFont: TFont); virtual;
  ...
  public
    function Add(AFont: TFont; ACanUseCID, AEmbedFont: Boolean)
      : TdxPSPDFCustomFont;
  ...
  protected
    ...
    procedure WriteHeader(AWriter: TdxPSPDFWriter); override;
  public
    constructor Create(APage: TdxPSPDFPage; AField: TdxPSPDFCustomField);
      reintroduce;
    destructor Destroy; override;
    procedure PopulateExportList(AList: TdxPSPDFObjectList); override;
  end;
...
{$REGION 'private type'}
    ...
    public
      ...
      procedure Write(const AEntryName: string; AEntryLength: Integer;
...
{$ENDREGION}
  private
    ...
    procedure WriteEntry(AWriter: TdxPSPDFWriter; const AKey, AValue: string;
      AValueAsHex: Boolean = True);
  protected
    procedure WriteHeader(AWriter: TdxPSPDFWriter); override;
  ...
  published
    property AllowActions: TdxPSPDFDocumentActions read FAllowActions
      write FAllowActions stored GetIsAllowActionsStored;
    property Enabled: Boolean read FEnabled write FEnabled default False;
    property KeyLength: TdxPSPDFEncryptKeyLength read FKeyLength
      write FKeyLength default pekl128;
  ...
  private
    ...
    FUserKey: AnsiString;
  protected
    function CalculateEncryptionFlags(AAllowActions: TdxPSPDFDocumentActions)
      : Integer; virtual; abstract;
    function CalculateOwnerKey(AOptions: TdxPSPDFSecurityOptions): AnsiString;
      virtual; abstract;
    function CalculateUserKey(AOptions: TdxPSPDFSecurityOptions): AnsiString;
      virtual; abstract;
    function CreateEncryptInfo: TdxPSPDFEncryptCustomInfo; virtual; abstract;
    procedure CalculateFileKey; virtual;
    procedure CalculateKey(AOptions: TdxPSPDFSecurityOptions); virtual;
      abstract;
    procedure CalculateKeyMD5(AOptions: TdxPSPDFSecurityOptions;
      out ADigest: TdxMD5Byte16);
  public
    constructor Create(AOptions: TdxPSPDFSecurityOptions); virtual;
    destructor Destroy; override;
    procedure EncryptBuffer(ABuffer: PByteArray;
      ABufferSize, AObjectIndex: Integer); virtual; abstract;
  ...
  protected
    ...
    function CreateWriter(AOutStream: TStream;
      AEncryptHelper: TdxPSPDFEncryptCustomHelper): TdxPSPDFWriter; virtual;
    function GetFontClass: TdxPSPDFCustomFontClass; virtual;
    procedure CalculateObjectsIndexes(AList: TdxPSPDFObjectList;
      AWriter: TdxPSPDFWriter); virtual;
  public
    constructor Create; virtual;
    destructor Destroy; override;
  ...
  public
    ...
    class procedure ReverseString(var S: string;
      AStartPos, AFinishPos: Integer);
  end;
...
{$IFDEF DELPHI18}
  AnsiStrings,
{$ENDIF}
  Types, Math, StrUtils, DateUtils, cxDateUtils, dxProtectionUtils,
  dxPSPDFFonts, cxDrawTextUtils, dxGDIPlusClasses,
  dxCoreGraphics;
...
type
  ...
  protected
    function CalculateEncryptionFlags(AAllowActions: TdxPSPDFDocumentActions)
      : Integer; override;
    function CalculateOwnerKey(AOptions: TdxPSPDFSecurityOptions)
      : AnsiString; override;
    function CalculateUserKey(AOptions: TdxPSPDFSecurityOptions)
      : AnsiString; override;
  ...
  public
    procedure EncryptBuffer(ABuffer: PByteArray;
      ABufferSize, AObjectIndex: Integer); override;
  end;
...
const
  dxPDFPassKey: TdxPDFPassKey = ($28, $BF, $4E, $5E, $4E, $75, $8A, $41, $64,
...
function dxPSPDFDateTimeToStr(ADate: TDateTime; AIsUTC: Boolean): string;
  ...
  begin
    if TdxTimeZoneHelper.IsDaylightDateTime(TdxTimeZoneHelper.CurrentTimeZone,
      ADate) then
      Result := (DefaultTimeZoneInfo.TZI.Bias +
        DefaultTimeZoneInfo.TZI.StandardBias +
...
begin
  ...
  if AIsUTC then
    ...
    Result := Result + SignMap[AOffset > 0] + FormatFloat('00',
      Abs(AOffset) div 60) + #39 + FormatFloat('00', Abs(AOffset) mod 60) + #39;
end;
...
begin
  ...
  Result := dxPDFEncodeFloat(R) + sdxPDFSpace + dxPDFEncodeFloat(G) +
    sdxPDFSpace + dxPDFEncodeFloat(B);
end;

function dxPDFLineTo(const X, Y: Double): string;
begin
  Result := dxPDFEncodeFloat(X) + sdxPDFSpace + dxPDFEncodeFloat(Y) +
    sdxPDFSpace + 'l ';
end;
...
begin
  ...
  begin
    ...
    begin
      ...
      begin
        AChar := S[AIndex];
        if IsBiDiCharacter(AChar) or
          (dxGetWideCharCType1(AChar) and (C1_SPACE or C1_PUNCT) <> 0) then
          Inc(AIndex)
        else
          Break;
      end;
...
class procedure TdxPDFBiDiHelper.ReverseString(var S: string;
  AStartPos, AFinishPos: Integer);
var
  C: WideChar;
begin
...
begin
  ...
  begin
    ...
    Result := Result + '/' + AFont.Name + sdxPDFSpace + AWriter.MakeLinkToObject
      (AFont) + sdxPDFSpace;
  end;
end;
...
begin
  ...
  begin
    ...
    Result := Result + '/' + AImage.Name + sdxPDFSpace +
      AWriter.MakeLinkToObject(AImage) + sdxPDFSpace;
  end;
end;
...
begin
  ...
  AWriter.WriteString(sdxPDFXObject + ' << ' +
    GetUsedImageLinks(AWriter) + ' >>');
  ...
  begin
    ...
    try
      ...
      begin
        ...
        AWriter.WriteString(APattern.Name + sdxPDFSpace +
          AWriter.MakeLinkToObject(APattern));
      end;
    finally
...
constructor TdxPSPDFWriter.Create(AStream: TStream;
  AEncryptHelper: TdxPSPDFEncryptCustomHelper;
...
function TdxPSPDFWriter.EncodeString(const S: string;
  AHexArray: Boolean = True): string;
var
  ABuffer: AnsiString;
  ACharCode: Word;
  I: Integer;
begin
  ...
  begin
    ...
    begin
      ...
      EncryptHelper.EncryptBuffer(@ABuffer[1], Length(ABuffer),
        CurrentObject.Index);
  ...
  else if AHexArray then
    Result := '<' + StrToHexArray(sdxUnicodeBOM + S) + '>'
  else
    Result := '(' + CheckForSpecialChars(S) + ')';
end;

function TdxPSPDFWriter.GetStreamEncoding(AStreamType: TdxPSPDFStreamType)
  : TdxPSPDFStreamEncoding;
begin
...
const
  EncodeFilterMap: array [TdxPSPDFStreamEncoding] of string = ('/FlateDecode',
    '/DCTDecode');
var
...
procedure TdxPSPDFWriter.WriteString(const S: string;
  AWriteCrLf: Boolean = True);
begin
...
begin
  ...
  try
    ...
    begin
      ...
      WriteString(sdxPDFFileID + sdxPDFSpace + Format('[<%s><%s>]',
        [EncryptHelper.FileID, EncryptHelper.FileID]));
    end;
  finally
    EndParamsSet;
  end;
...
begin
  ...
  for I := 0 to ObjectsOffsets.Count - 1 do
    WriteString(FormatFloat('0000000000', Integer(ObjectsOffsets.Items[I])) +
      ' 00000 n');
end;

{ TdxPSPDFCustomFont }

constructor TdxPSPDFCustomFont.Create(AOwner: TdxPSPDFFontList; AEmbed: Boolean;
  AFont: TFont);
begin
  inherited Create;
  FOwner := AOwner;
...
begin
  Result := (GetFontCharset(AFont) = Charset) and (AFont.Style = Style) and
    SameText(AFont.Name, FamilyName);
end;
...
function TdxPSPDFFontList.Add(AFont: TFont; ACanUseCID, AEmbedFont: Boolean)
  : TdxPSPDFCustomFont;
const
...
begin
  ...
  if Result = nil then
  begin
    Result := FontClassMap[ACanUseCID and dxPDFCanCreateCIDFont(AFont)
      ].Create(Self, AEmbedFont, AFont);
...
procedure TdxPSPDFFile.CalculateObjectsIndexes(AList: TdxPSPDFObjectList;
  AWriter: TdxPSPDFWriter);
var
  I: Integer;
begin
...
const
  ClassMap: array [TdxPSPDFEncryptKeyLength]
    of TdxPSPDFEncryptCustomHelperClass = (TdxPSPDFEncrypt40Helper,
    TdxPSPDFEncrypt128Helper);
begin
...
begin
  Result := TdxPSPDFWriter.Create(AOutStream, AEncryptHelper, CompressStreams,
    UseJPEGCompression, JPEGQuality);
end;
...
begin
  ...
  try
    ...
    begin
      AWriter.WriteString(sdxPDFLength + sdxPDFSpace + AWriter.MakeLinkToObject
        (ContentStreamLength));
...
begin
  ...
  AWriter.WriteString(sdxPDFAuthor + sdxPDFSpace + AWriter.EncodeString
    (Author));
  AWriter.WriteString(sdxPDFSubject + sdxPDFSpace + AWriter.EncodeString
    (Subject));
  AWriter.WriteString(sdxPDFProducer + sdxPDFSpace + AWriter.EncodeString
    (Producer));
  AWriter.WriteString(sdxPDFKeywords + sdxPDFSpace + AWriter.EncodeString
    (Keywords));
  AWriter.WriteString(sdxPDFCreator + sdxPDFSpace + AWriter.EncodeString
    (Creator));
  if Created > 0 then
    AWriter.WriteString(sdxPDFCreationDate + sdxPDFSpace +
      AWriter.EncodeString(dxPSPDFDateTimeToStr(Created, False), False));
end;
...
begin
  inherited WriteHeader(AWriter);
  AWriter.WriteString(sdxPDFPages + sdxPDFSpace + AWriter.MakeLinkToObject
    (PageList));
  AWriter.WriteString('/AcroForm' + sdxPDFSpace + AWriter.MakeLinkToObject
    (FAcroForm));
end;

function TdxPSPDFCatalog.CanSign: Boolean;
begin
  Result := FParent.SignatureOptions.Enabled and
    (FParent.SignatureOptions.Certificate <> nil);
end;
...
procedure TdxPSPDFPageList.WriteHeader(AWriter: TdxPSPDFWriter);
  ...
  begin
    ...
    for APageIndex := 0 to PageCount - 1 do
      Result := Result + AWriter.MakeLinkToObject(Page[APageIndex]) +
        sdxPDFSpace;
  end;

begin
  inherited WriteHeader(AWriter);
  AWriter.WriteString('/Kids [' + GetPageIndexes + '] /Count ' +
    IntToStr(PageCount));
end;
...
procedure TdxPSPDFPage.WriteHeader(AWriter: TdxPSPDFWriter);
  ...
  begin
    ...
    for AIndex := 0 to FAnnotationList.Count - 1 do
      Result := Result + AWriter.MakeLinkToObject(FAnnotationList.Items[AIndex])
        + sdxPDFSpace;
  end;

begin
  inherited WriteHeader(AWriter);
  AWriter.WriteString(sdxPDFParent + sdxPDFSpace +
    AWriter.MakeLinkToObject(Parent));
  AWriter.WriteString(sdxPDFPageSize + Format(' [0 0 %d %d]',
    [PageWidth, PageHeight]));
  AWriter.WriteString(sdxPDFResources + sdxPDFSpace + AWriter.MakeLinkToObject
    (PageResources));
  AWriter.WriteString(sdxPDFContent + sdxPDFSpace + AWriter.MakeLinkToObject
    (Content));

  AWriter.WriteString('/Annots [' + GetAnnotationIndexes + ']');
end;

function TdxPSPDFPage.CreateWidgetAnnotation(AField: TdxPSPDFCustomField)
  : TdxPSPDFCustomAnnotation;
begin
...
function TdxPSPDFPageContent.AbsoluteTextWidth(const AText: PChar;
  ATextLength: Integer): Double;
const
  D2P = 72 / 96;
var
  AFont: TdxPSPDFCustomFont;
...
procedure TdxPSPDFPageContent.AdjustFontSize(const AText: string;
  const ATextWidth: Double);
var
  ATempWidth: Double;
begin
...
procedure TdxPSPDFPageContent.Clip(AClipMode
  : TdxPSPDFPageContentClipMode = pcmAdd);
const
...
function TdxPSPDFPageContent.CreateBitmap(AGraphic: TGraphic;
  var ANeedDestroy: Boolean): TBitmap;
begin
  ...
  begin
    ...
    Result.Canvas.Brush.Color := IfThen(ForeColor = clDefault, clWindow,
      ForeColor);
...
procedure TdxPSPDFPageContent.DrawEllipseFrame(const R: TRect; AColor: TColor;
  AThickness: Integer);
begin
  WriteEllipse(R);
...
procedure TdxPSPDFPageContent.DrawFrame(const R: TRect; ABorderWidth: Integer;
  ABorderColor: TColor; ABorders: TcxBorders);
begin
...
begin
  ...
  begin
    ...
    try
      ...
      try
        ModifyWorldTransform(TXForm.CreateMatrix(cxRectWidth(R), 0, 0,
...
begin
  ...
  try
    ...
    begin
      ModifyWorldTransform(TXForm.CreateTranslateMatrix(AOffset.X,
        PageHeight - AOffset.Y));
...
begin
  ...
  if ABackgroundColor <> clNone then
    WriteCommand(FillModeMap[AColor = clNone] + ModeSuffix
      [AFillMode = ALTERNATE])
  else
    WriteCommand('s');
end;

procedure TdxPSPDFPageContent.FillRect(const R: TRect;
  AColor: TColor = clDefault);
begin
...
procedure TdxPSPDFPageContent.FillRectByBrush(const R: TRect; AColor: TColor;
  AStyle: TBrushStyle = bsSolid);
begin
  case AStyle of
    bsClear:
...
procedure TdxPSPDFPageContent.FillRectByGraphic(const R: TRect;
  AWidth, AHeight: Integer; AGraphic: TGraphic);
var
  ABitmap: TBitmap;
  ANeedDestroy: Boolean;
begin
  ...
  begin
    ABitmap := CreateBitmap(AGraphic, ANeedDestroy);
    try
      FillRectByPattern(R, PatternList.AddPattern(AddBitmap(ABitmap), AWidth,
        AHeight));
    finally
      if ANeedDestroy then
        FreeAndNil(ABitmap);
...
procedure TdxPSPDFPageContent.FillRectByPattern(const R: TRect;
  APattern: TdxPSPDFCustomPattern);
begin
...
begin
  ...
  begin
    WriteCommand(dxPDFEncodeFloat(ATransform.eM11) + sdxPDFSpace +
...
procedure TdxPSPDFPageContent.TextOut(const AText: string;
...
procedure TdxPSPDFPageContent.TextOut(const X, Y: Double;
  AProc: TdxPSPDFPageContentTextOutProc);
...
function TdxPSPDFPageContent.TextWidth(const AText: PChar;
  ATextLength: Integer): Double;
begin
...
procedure TdxPSPDFPageContent.Polyline(const APoints: array of TPoint;
  const ALineWidth: Double; AColor: TColor);
begin
...
procedure TdxPSPDFPageContent.WriteCommand(const S: string;
  ANewLine: Boolean = True);
begin
...
procedure TdxPSPDFPageContent.WriteCurveTo(const X1, Y1, X2, Y2, X3,
  Y3: Double);
begin
  WriteCommand(dxPDFEncodeFloat(X1) + sdxPDFSpace + dxPDFEncodeFloat(PageHeight
    - Y1) + sdxPDFSpace + dxPDFEncodeFloat(X2) + sdxPDFSpace +
    dxPDFEncodeFloat(PageHeight - Y2) + sdxPDFSpace + dxPDFEncodeFloat(X3) +
    sdxPDFSpace + dxPDFEncodeFloat(PageHeight - Y3) + sdxPDFSpace + 'c');
end;
...
begin
  MoveTo(X, Y + H / 2);
  WriteCurveTo(X, Y + H / 2 * dxCurveAngle1, X + W / 2 * dxCurveAngle1, Y,
    X + W / 2, Y);
  WriteCurveTo(X + W / 2 * dxCurveAngle2, Y, X + W, Y + H / 2 * dxCurveAngle1,
    X + W, Y + H / 2);
  WriteCurveTo(X + W, Y + H / 2 * dxCurveAngle2, X + W / 2 * dxCurveAngle2,
    Y + H, X + W / 2, Y + H);
  WriteCurveTo(X + W / 2 * dxCurveAngle1, Y + H, X, Y + H / 2 * dxCurveAngle2,
    X, Y + H / 2);
end;
...
procedure TdxPSPDFPageContent.WritePie(const X1, Y1, X2, Y2, X3, Y3, X4,
  Y4: Double);

  procedure CalcPoint(var X, Y: Double; const ACenterX, ACenterY, ARadiusX,
    ARadiusY, AAngle: Double);
  begin
  ...
  procedure WriteArcPart(const ACenterX, ACenterY: Double;
    ARadiusX, ARadiusY, AStartAngle, ARotateAngle: Double);
  var
    X: array [0 .. 2] of Double;
    Y: array [0 .. 2] of Double;
  begin
    CalcPoint(X[0], Y[0], ACenterX, ACenterY, ARadiusX, ARadiusY,
      AStartAngle + ARotateAngle * 1 / 3);
    CalcPoint(X[1], Y[1], ACenterX, ACenterY, ARadiusX, ARadiusY,
      AStartAngle + ARotateAngle * 2 / 3);
    CalcPoint(X[2], Y[2], ACenterX, ACenterY, ARadiusX, ARadiusY,
      AStartAngle + ARotateAngle);
...
begin
  ...
  AStartAngle := CheckAngle(ArcTan2((ACenterY - Y3) * ARadiusX,
    (X3 - ACenterX) * ARadiusY));
  AFinishAngle := CheckAngle(ArcTan2((ACenterY - Y4) * ARadiusX,
    (X4 - ACenterX) * ARadiusY));
  ACounter := CheckAngle(AFinishAngle - AStartAngle);

  MoveTo(ACenterX + ARadiusX * Cos(AStartAngle), ACenterY - ARadiusY *
    Sin(AStartAngle));
  while ACounter >= 0 do
  begin
    ARotateAngle := Min(PI / 12, ACounter);
    WriteArcPart(ACenterX, ACenterY, ARadiusX, ARadiusY, AStartAngle,
      ARotateAngle);
...
procedure TdxPSPDFPageContent.WriteRoundRect(const R: TRect;
  const AEllipseWidth, AEllipseHeight: Double);
begin
  // TopLeft
  MoveTo(R.Left, R.Top + AEllipseHeight);
  WriteCurveTo(R.Left, R.Top + AEllipseHeight * dxCurveAngle1,
    R.Left + AEllipseWidth * dxCurveAngle1, R.Top,
    R.Left + AEllipseWidth, R.Top);
  LineTo(R.Right - AEllipseWidth, R.Top);
  // RightBottom
  WriteCurveTo(R.Right - AEllipseWidth * (dxCurveAngle2 - 1), R.Top, R.Right,
    R.Top + AEllipseHeight * dxCurveAngle1, R.Right, R.Top + AEllipseHeight);
  LineTo(R.Right, R.Bottom - AEllipseHeight);
  // BottomRight Corner
  WriteCurveTo(R.Right, R.Bottom - AEllipseHeight * (dxCurveAngle2 - 1),
    R.Right - AEllipseWidth * dxCurveAngle1, R.Bottom, R.Right - AEllipseWidth,
    R.Bottom);
  LineTo(R.Left + AEllipseWidth, R.Bottom);
  // BottomLeft
  WriteCurveTo(R.Left + AEllipseWidth * dxCurveAngle1, R.Bottom, R.Left,
    R.Bottom - AEllipseHeight * (dxCurveAngle2 - 1), R.Left,
    R.Bottom - AEllipseHeight);
...
begin
  WriteCommand(dxPDFEncodeFloat(X) + sdxPDFSpace + dxPDFEncodeFloat(Y) +
    sdxPDFSpace + 'Td');
end;
...
constructor TdxPSPDFPageContentTextOutHelper.Create
  (AContent: TdxPSPDFPageContent);
begin
  inherited Create;
  FContent := AContent;
end;
...
function TdxPSPDFPageContentTextOutHelper.Output: Double;
  ...
  begin
    SetString(Result, AStart, (TdxNativeInt(AEnd) - TdxNativeInt(AStart))
      div SizeOf(WideChar));
  end;
...
function TdxPSPDFPageContentTextOutHelper.OutputText
...
function TdxPSPDFPageContentTextOutHelper.OutputTextPart
  (const S: string): Double;
begin
...
function TdxPSPDFPageContentTextOutHelper.OutputTextPartCharByChar
  (const S: string): Double;
var
  AChar: Char;
...
procedure TdxPSPDFPageContentTextOutHelper.SetFontAndSelect
  (AFont: TdxPSPDFCustomFont);
begin
...
begin
  ...
  begin
    ...
    if TdxPSPDFSignatureOptions(ASource).Certificate <> nil then
      FCertificate := TdxX509Certificate.Create
        (TdxPSPDFSignatureOptions(ASource).Certificate);
  end;
end;
...
procedure TdxPSPDFSignature.WriteContents(AWriter: TdxPSPDFWriter;
  const AData: TBytes);
...
procedure TdxPSPDFSignature.WriteEntry(AWriter: TdxPSPDFWriter;
  const AKey, AValue: string; AValueAsHex: Boolean = True);
begin
  if AValue <> '' then
    AWriter.WriteString(AKey + sdxPDFSpace + AWriter.EncodeString(AValue,
      AValueAsHex));
end;
  ...
  begin
    ...
    try
      ...
      AWriter.WriteString('[ 0 ' + IntToStr(FContentPlaceHolder.Offset) +
        sdxPDFSpace + IntToStr(ASecondByteRangeOffset) + sdxPDFSpace +
        IntToStr(ASecondByteRangeLength) + ']', False);
...
procedure TdxPSPDFSignature.TPlaceHolder.Write(const AEntryName: string;
  AEntryLength: Integer; AWriter: TdxPSPDFWriter);
var
  ABuffer: TBytes;
begin
...
begin
  ...
  AWriter.WriteString(sdxPDFColorSpace + sdxPDFDeviceRGB +
    sdxPDFBitsPerComponent + ' 8');
  AWriter.WriteString(sdxPDFName + ' /' + Name);
end;
...
constructor TdxPSPDFCustomPattern.Create(AOwner: TdxPSPDFPatternList;
  const APatternWidth, APatternHeight: Double);
begin
  inherited Create;
  FOwner := AOwner;
...
function TdxPSPDFCustomPattern.Compare(APattern: TdxPSPDFCustomPattern)
  : Boolean;
begin
...
begin
  ...
  AWriter.WriteString(sdxPDFBBox + sdxPDFSpace + '[0 0' + sdxPDFSpace +
    dxPDFEncodeFloat(PatternWidth) + sdxPDFSpace +
    dxPDFEncodeFloat(PatternHeight) + ']');

  AWriter.WriteString(sdxPDFMatrix + sdxPDFSpace + '[' +
    dxPDFEncodeFloat(FScaleFactor) + sdxPDFSpace + dxPDFEncodeFloat(0) +
    sdxPDFSpace + dxPDFEncodeFloat(0) + sdxPDFSpace +
    dxPDFEncodeFloat(FScaleFactor) + sdxPDFSpace + dxPDFEncodeFloat(Origin.X) +
    sdxPDFSpace + dxPDFEncodeFloat(Origin.Y) + ']');

  AWriter.WriteString(sdxPDFXStep + sdxPDFSpace +
    dxPDFEncodeFloat(PatternWidth));
  AWriter.WriteString(sdxPDFYStep + sdxPDFSpace +
    dxPDFEncodeFloat(PatternHeight));
...
begin
  Result := 'q' + #13#10 + dxPDFEncodeFloat(PatternWidth) + sdxPDFSpace + '0 0'
    + sdxPDFSpace + dxPDFEncodeFloat(PatternHeight) + sdxPDFSpace + '0 0 cm' +
    #13#10 + sdxPDFImage + IntToStr(ImageIndex) + sdxPDFSpace + 'Do' +
    #13#10 + 'Q'
end;
...
begin
  AWriter.WriteString(sdxPDFXObject + sdxPDFSpace + '<<' + sdxPDFImage +
    IntToStr(ImageIndex) + sdxPDFSpace + AWriter.MakeLinkToObject
    (Image) + '>>');
end;

{ TdxPSPDFBrushPattern }

constructor TdxPSPDFBrushPattern.Create(AOwner: TdxPSPDFPatternList;
  AStyle: TBrushStyle; AColor: TColor);
begin
...
begin
  ...
  if Style in [bsHorizontal, bsCross] then
    Result := Result + Line(0, PatternHeight / 2, PatternWidth,
      PatternHeight / 2);
  if Style in [bsVertical, bsCross] then
    Result := Result + Line(PatternWidth / 2, 0, PatternWidth / 2,
      PatternHeight);
  ...
  Result := '0.5 w ' + dxPDFEncodeColor(Color) + sdxPDFSpace + ' RG ' +
    Result + 'S';
end;
...
function TdxPSPDFPatternList.AddPattern(ABrushStyle: TBrushStyle;
  AColor: TColor): TdxPSPDFCustomPattern;
begin
...
function TdxPSPDFPatternList.AddPattern(AImageIndex: Integer;
  const APatternWidth, APatternHeight: Double): TdxPSPDFCustomPattern;
begin
  Result := AddPattern(TdxPSPDFImagePattern.Create(Self, APatternWidth,
    APatternHeight, AImageIndex));
end;

function TdxPSPDFPatternList.AddPattern(APattern: TdxPSPDFCustomPattern)
  : TdxPSPDFCustomPattern;
var
...
function TdxPSPDFPatternList.FindPattern
  (APattern: TdxPSPDFCustomPattern): Integer;
var
  I: Integer;
begin
  Result := -1;
...
constructor TdxPSPDFEncryptCustomHelper.Create
  (AOptions: TdxPSPDFSecurityOptions);
begin
  inherited Create;
...
procedure TdxPSPDFEncryptCustomHelper.EncryptStream(AStream: TMemoryStream;
...
begin
  ...
  for I := 0 to 15 do
    FFileKey[I] := StrToInt('$' + ATempValue[2 * I + 1] + ATempValue
      [2 * (I + 1)]);
...
begin
  ...
  AUserPass := Copy(dxStringToAnsiString(AOptions.UserPassword), 1,
    Length(AKey));
...
procedure TdxPSPDFEncryptCustomHelper.PopulateExportList
...
constructor TdxPSPDFEncryptCustomInfo.Create(AEncryptHelper
  : TdxPSPDFEncryptCustomHelper);
begin
  inherited Create;
  FEncryptHelper := AEncryptHelper;
...
begin
  ...
  AWriter.WriteString('/P' + sdxPDFSpace +
    IntToStr(EncryptHelper.EncryptionFlags));
end;
...
procedure TdxPSPDFEncrypt40Helper.CalculateKey
  (AOptions: TdxPSPDFSecurityOptions);
var
...
function TdxPSPDFEncrypt40Helper.CalculateOwnerKey
  (AOptions: TdxPSPDFSecurityOptions): AnsiString;
var
  ADigest: TdxMD5Byte16;
  AKey: TdxRC4Key;
...
function TdxPSPDFEncrypt40Helper.CalculateUserKey
  (AOptions: TdxPSPDFSecurityOptions): AnsiString;
var
  AKey: TdxRC4Key;
  ATemp: TdxPDFPassKey;
...
procedure TdxPSPDFEncrypt40Helper.EncryptBuffer(ABuffer: PByteArray;
  ABufferSize, AObjectIndex: Integer);
var
  ADigest: TdxMD5Byte16;
...
procedure TdxPSPDFEncrypt128Helper.CalculateKey
  (AOptions: TdxPSPDFSecurityOptions);
var
  ADigest: TdxMD5Byte16;
  I: Integer;
...
function TdxPSPDFEncrypt128Helper.CalculateOwnerKey
  (AOptions: TdxPSPDFSecurityOptions): AnsiString;
var
  ADigest: TdxMD5Byte16;
  AKey: TdxRC4Key;
...
function TdxPSPDFEncrypt128Helper.CalculateUserKey
  (AOptions: TdxPSPDFSecurityOptions): AnsiString;
var
  AContext: TdxMD5Context;
  ADigest: TdxMD5Byte16;
...
procedure TdxPSPDFEncrypt128Helper.EncryptBuffer(ABuffer: PByteArray;
  ABufferSize, AObjectIndex: Integer);
var
  ADigest: TdxMD5Byte16;
  AFullKey: array [0 .. 20] of Byte;
...
procedure TdxPSPDFAcroForm.WriteHeader(AWriter: TdxPSPDFWriter);
  ...
  begin
    ...
    for AIndex := 0 to FFieldList.Count - 1 do
      Result := Result + AWriter.MakeLinkToObject(FFieldList.Items[AIndex]) +
        sdxPDFSpace;
  end;
...
constructor TdxPSPDFWidgetAnnotation.Create(APage: TdxPSPDFPage;
  AField: TdxPSPDFCustomField);
begin
  inherited Create;
  FPage := APage;
  FField := AField;
...
procedure TdxPSPDFWidgetAnnotation.PopulateExportList
  (AList: TdxPSPDFObjectList);
begin
  inherited PopulateExportList(AList);
