...
function TdxPScxPageControlProducer.CanProcessChild(AChildControl
  : TControl): Boolean;
begin
  Result := AChildControl = Control.ActivePage;
end;

class function TdxPScxPageControlProducer.IteratorClass
...
RegisterAssistants;
dxPSContainerLnk.dxPSRegisterContainers([TcxTabSheet, TcxTabControl,
  TcxPageControl]);

finalization

dxPSContainerLnk.dxPSUnregisterContainers([TcxTabSheet, TcxTabControl,
  TcxPageControl]);
