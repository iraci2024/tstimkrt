...
type
  TcxVerticalGridReportLinkStyleSheetEditorPreview = class
...
constructor TcxVerticalGridReportLinkStyleSheetEditorPreview.Create
  (AOwner: TComponent);
begin
...
class function TcxVerticalGridReportLinkStyleSheetEditorPreview.
  GetStyleSheetClass: TcxCustomStyleSheetClass;
begin
  Result := TcxVerticalGridReportLinkStyleSheet;
end;

procedure TcxVerticalGridReportLinkStyleSheetEditorPreview.SetStyleSheet
...
const
  RowCount = 7;
  RowCaptions: array [0 .. RowCount - 1] of string = (sdxLuxurySedans,
    sdxCarManufacturer, sdxCarModel, sdxPicture, sdxCarEngine,
    sdxCarTransmission, sdxCarTires);
  RowClasses: array [0 .. RowCount - 1] of TcxCustomRowClass = (TcxCategoryRow,
    TcxEditorRow, TcxEditorRow, TcxEditorRow, TcxEditorRow, TcxEditorRow,
    TcxEditorRow);
  ...
  RowHeights: array [0 .. RowCount - 1] of Integer = (-1, -1, -1, 116,
    57, -1, 44);
  RowValues: array [0 .. RowCount - 1] of string = ('', sdx760V12Manufacturer,
    sdx760V12Model, '', sdx760V12Engine, sdx760V12Transmission, sdx760V12Tires);
var
  I: Integer;
  Row: TcxCustomRow;
begin
...
begin
  ...
  dxPSRegisterReportLinkUnit('dxPScxVGridLnk',
