...
{$ENDIF}
  ...
  dxSpreadSheetCore, dxHashUtils, cxEdit, dxSpreadSheet, dxSpreadSheetTypes,
  dxSpreadSheetGraphics, dxPSCore, dxPSForm,
  dxPSBaseGridLnk, dxPSExcelEdgePatterns, dxPSExcelFillPatterns,
  dxPSEdgePatterns, dxPSFillPatterns, cxDrawTextUtils,
  cxPC, dxPSGlbl, cxControls, cxContainer, cxLabel, cxCheckBox, Menus,
  cxLookAndFeelPainters, cxTextEdit, cxButtons,
  cxGraphics, cxDropDownEdit, dxCore, cxMaskEdit, cxColorComboBox,
  dxPSReportRenderCanvas, cxLookAndFeels, dxPScxCommon,
  dxSpreadSheetUtils, cxClasses, dxPSReportLinkDesignWindow,
  dxLayoutControlAdapters, dxLayoutLookAndFeels,
  dxLayoutContainer, dxLayoutControl, dxLayoutcxEditAdapters,
  dxSpreadSheetStyles, dxGDIPlusClasses,
...
type
  ...
  TdxPSCellBorder = record
    ...
    constructor Create(APattern: TdxPSEdgePatternClass;
  ...
  TdxPSCellBorderCorner = (cbcTopLeft, cbcTopRight, cbcBottomRight,
    cbcBottomLeft);
  ...
  IdxSpreadSheetAdvancedViewParams = interface
    ...
    function GetFillStyle(out AColor1, AColor2: TColor)
  ...
  protected
    ...
    procedure ClipItemBounds(ACanvas: TdxPSReportRenderCustomCanvas;
      AOuterRect: TRect);
    procedure DrawBorder(ACanvas: TdxPSReportRenderCustomCanvas; const R: TRect;
      ASide: TdxCellSide);
  public
  ...
  public
    ...
    function GetNeighborCell(AItem: TdxReportCellSSString; ASide: TdxCellSide)
      : TdxReportCellSSString;

    property Cells[Col, Row: Integer]: TdxReportCellSSString
      read GetCell; default;
  ...
  TdxPSSpreadSheetCellDisplayStyleCache = class
  ...
  protected
    class procedure InitializeItem(AItem: TAbstractdxReportCellData;
      AProperties: TcxCustomEditProperties; const AValue: Variant;
      const ACellParams: IdxPSCellParams;
      var AViewParams: TdxReportItemViewParams; AIsPreview: Boolean = False;
  ...
  TdxSpreadSheetAdvancedViewParams = class(TInterfacedObject,
    IdxSpreadSheetAdvancedViewParams)
  protected
  ...
  public
    ...
    class function CreateFrom(AStyle: TdxSpreadSheetCellDisplayStyle)
      : IdxSpreadSheetAdvancedViewParams;
  end;
  ...
  protected
    ...
    procedure GetDataBarBounds(ACanvas: TdxPSReportRenderCustomCanvas;
      out AAxisBounds, ABarBounds: TRect);
  ...
  public
    ...
    property TextAlignHorzIndent: Integer read FTextAlignHorzIndent
      write FTextAlignHorzIndent;
    property TextExtentLeft: Integer read FTextExtentLeft write FTextExtentLeft;
    property TextExtentRight: Integer read FTextExtentRight
      write FTextExtentRight;
  end;

  { TdxReportCellSSString }

  TdxReportCellSSString = class(TdxReportCellBaseSSString, IUnknown,
    IdxPSCellParams)
  strict private
    ...
    function GetBorderSlant(ASide: TdxCellSide;
      ACorner: TdxPSCellBorderCorner): Integer;
    function GetBorderSlantOffset(ASide: TdxCellSide;
      ACorner: TdxPSCellBorderCorner): TDWORDBits;
    function GetBorderSub(ASide: TdxCellSide; AEnd: TdxPSCellBorderEnd)
      : TdxPSCellBorderSub;
    function GetBorderSubMask(ASide: TdxCellSide;
      AEnd: TdxPSCellBorderEnd): DWORD;
    function GetBorderSubOffset(ASide: TdxCellSide; AEnd: TdxPSCellBorderEnd)
      : TDWORDBits;
    ...
    procedure SetBorderSlant(ASide: TdxCellSide; ACorner: TdxPSCellBorderCorner;
      Value: Integer);
    procedure SetBorderSub(ASide: TdxCellSide; AEnd: TdxPSCellBorderEnd;
  ...
  protected
    ...
    procedure InitBorderPainter(ABordersPainter
      : TdxPSCellBorderPainter); override;
  ...
  public
    ...
    property Borders[ASide: TdxCellSide]: TdxPSCellBorder read GetBorder
      write SetBorder;
    property BordersBkColor: TColor read GetBordersBkColor;
    property BorderSlants[ASide: TdxCellSide; ACorner: TdxPSCellBorderCorner]
      : Integer read GetBorderSlant write SetBorderSlant;
    property BorderSubs[ASide: TdxCellSide; AEnd: TdxPSCellBorderEnd]
      : TdxPSCellBorderSub read GetBorderSub write SetBorderSub;
    ...
    property IsNearMostLeft: Boolean read GetIsNearMostLeft
      write SetIsNearMostLeft;
    property IsNearMostTop: Boolean read GetIsNearMostTop
      write SetIsNearMostTop;
  ...
  strict private
    ...
    function GetItemViewParams(AItem: TdxReportCellSSString)
  ...
  protected
    ...
    function GetDataItemClass(ACol: Integer; ARow: Integer = 0)
      : TdxReportCellDataClass; override;
    function GetDefaultCellBorderColor: TColor; virtual;
    function GetFlatIndex(ACol, ARow: Integer): Integer;
    function GetMinRowHeight(ACanvas: TdxPSReportRenderCustomCanvas;
      AFont: TFont): Integer; override;
    ...
    function GetSourceCellContentPattern(ACol, ARow: Integer)
      : TdxPSFillPatternClass; override;
    function GetSourceCellEdge3DSoft(ACol, ARow: Integer): Boolean; override;
    function GetSourceCellEdgeMode(ACol, ARow: Integer)
      : TdxCellEdgeMode; override;
    ...
    function GetSourceCellTextAlignX(ACol, ARow: Integer)
      : TcxTextAlignX; override;
    function GetSourceCellTextAlignY(ACol, ARow: Integer)
      : TcxTextAlignY; override;
    ...
    procedure AssignRtfStringData(AItem: TAbstractdxReportCellData;
      const AValue: TcxEditValue; const ACellParams: IdxPSCellParams;
      var AViewParams: TdxReportItemViewParams); virtual;
    ...
    function CalculateContainerBounds(AViewInfo
      : TdxSpreadSheetContainerViewInfo): TRect; virtual;
    function CanPrintContainer(AContainer: TdxSpreadSheetContainer)
      : Boolean; virtual;
    function CreateContainerImage(AViewInfo: TdxSpreadSheetContainerViewInfo)
      : TdxSmartImage; virtual;
    function CreateContainersHost(AReportCells: TdxReportCells)
      : TdxReportCell; virtual;
    procedure InitializeContainerCell(ACell: TdxReportCell;
      AViewInfo: TdxSpreadSheetContainerViewInfo); virtual;
    function GetContainerBoundsOffset: TPoint;
    function TranslateContainerBounds(AView: TdxSpreadSheetCustomView;
      var ABounds: TRect): Boolean; virtual;

    function GetCellBoundsInReport(ARow, AColumn: Integer;
      AConsiderMergedCells: Boolean; out ARect: TRect): Boolean;
    function ReportAreaToSpreadSheetArea(const R: TRect): TRect;
    function SpreadSheetAreaToReportArea(const R: TRect): TRect;

    function GetBorderStylePatternClass(AStyle: TdxSpreadSheetCellBorderStyle)
      : TdxPSEdgePatternClass; virtual;
    function OnlyEdgeIsAssigned(const ACell: TdxSpreadSheetCell;
    ...
    procedure SetupCellBorders(ACol, ARow: Integer;
      ADataItem: TdxReportCellSSString); virtual;
    //
    property ColCount: Integer read GetColCount;
...
var
  dxPSFillPatternClassMap: array [TdxSpreadSheetCellFillStyle]
    of TdxPSFillPatternClass = (
  ...
  dxCellEdgeSideOrientation: array [TdxCellSide]
    of TdxPSCellEdgePatternOrientation = (
    cepoVertical,
    cepoHorizontal,
    cepoVertical,
    cepoHorizontal
  ...
  dxPSEdgePatternClassMap: array [TdxSpreadSheetCellBorderStyle]
    of TdxPSEdgePatternClass = (
...
uses
  SysUtils, dxSpreadSheetConditionalFormattingIconSet, cxGeometry, Math,
  dxSpreadSheetCoreStyles, RTLConsts, dxCoreClasses,
  dxSpreadSheetContainers, dxPSRes, dxPSUtl, dxSmartImage, dxDPIAwareUtils,
  dxFormattedTextConverterRTF, dxCoreGraphics,
...
type
  ...
  TdxSpreadSheetEditingControllerAccess = class
...
function AreStylesEqual(AStyle1, AStyle2: TdxSpreadSheetCellStyle;
  AExclusion: TcxBorders = []): Boolean;

  function AreBordersEqual(AStyle1, AStyle2: TdxSpreadSheetCellStyle;
    AExclusion: TcxBorders = []): Boolean;
  var
  ...
  begin
    ...
    begin
      ACompareResult := (AStyle1.Handle.Borders.BorderColor[ASide]
        = AStyle2.Handle.Borders.BorderColor[ASide]) and
        (AStyle1.Handle.Borders.BorderStyle[ASide] = AStyle2.Handle.Borders.
        BorderStyle[ASide]);
...
begin
  ...
  Result := (AStyle1.Brush.BackgroundColor = AStyle2.Brush.BackgroundColor) and
    (AStyle1.Brush.ForegroundColor = AStyle2.Brush.ForegroundColor) and
    (AStyle1.Brush.Style = AStyle2.Brush.Style) and
    AreBordersEqual(AStyle1, AStyle2, AExclusion);
end;
...
constructor TdxPSCellBorder.Create(APattern: TdxPSEdgePatternClass;
  AColor: TColor);
begin
  Color := AColor;
  Pattern := APattern;
...
begin
  ...
  begin
    ...
    if IsNearMostLeft then
      Inc(AOuterRect.Left, LineThickness * BorderEdgeSalients[csLeft,
        bstOuter]);
  end;
...
begin
  ...
  ACanvas.FillEdge(ARegion, Item.BordersBkColor, ABorder.Color,
    ASide in [csLeft, csRight], ABorder.Pattern);
    ...
    for ASide := Low(TdxCellSide) to High(TdxCellSide) do
      ...
      begin
        ...
        begin
          ...
          try
            ABorder := Item.Borders[ASide];
            if (ABorder.Pattern <> nil) and ABorder.Pattern.RequiredBrushOrigin
            then
            begin
              ATempRect := ABorderRect;
              ACanvas.LogicalToDeviceCoordinates(ATempRect);
              ACanvas.BrushOrg := Point(ATempRect.Left mod 2,
                ATempRect.Top mod 2);
            end;
...
function TdxPSGridCellsAdapter.GetCell(Col, Row: Integer)
  : TdxReportCellSSString;
var
...
constructor TdxPSSpreadSheetCellDisplayStyleCache.Create
...
class procedure TdxPSSSStringDataMap.InitializeItem
  (AItem: TAbstractdxReportCellData; AProperties: TcxCustomEditProperties;
  const AValue: Variant; const ACellParams: IdxPSCellParams;
  var AViewParams: TdxReportItemViewParams; AIsPreview: Boolean;
...
begin
  inherited InitializeItem(AItem, AProperties, AValue, ACellParams, AViewParams,
    AIsPreview, ARecordIndex, AOwner);

  if AItem is TdxReportCellBaseSSString then
  begin
    if Supports(AViewParams.AdvancedViewParams,
      IdxSpreadSheetAdvancedViewParams, AAdvancedViewParams) then
    begin
      TdxReportCellBaseSSString(AItem)
        .DataBar.Assign(AAdvancedViewParams.GetDataBar);
      TdxReportCellBaseSSString(AItem).IconIndex :=
        AAdvancedViewParams.GetIconSetIndex;
      TdxReportCellBaseSSString(AItem).IconSize :=
        ConditionalFormattingIconSet.Icons.Width;
      ...
      TdxReportCellBaseSSString(AItem).ContentPattern :=
        dxPSFillPatternClassMap[AStyle];
...
class function TdxPSSSStringDataMap.ItemClass(AProperties
  : TcxCustomEditProperties; const AViewParams: TdxReportItemViewParams;
  AIsPreview: Boolean): TdxReportCellDataClass;
begin
  if Supports(AViewParams.AdvancedViewParams, IdxSpreadSheetAdvancedViewParams)
  then
...
class procedure TdxPSSSStringGridCellDataMap.InitializeCellData(ACol,
...
begin
  ...
  begin
    ...
    begin
      ...
      if ACell <> nil then
      begin
        TdxReportCellSSString(ADataItem).Fill :=
          ACell.Style.AlignHorz = ssahFill;
        TdxReportCellSSString(ADataItem).TextAlignHorzIndent :=
      ...
      begin
        TdxReportCellSSString(ADataItem).DataBar :=
          TdxSpreadSheetTableViewCellDisplayStyle(ACellStyle).DataBar;
        TdxReportCellSSString(ADataItem).IconIndex :=
          TdxSpreadSheetTableViewCellDisplayStyle(ACellStyle).IconIndex;
        TdxReportCellSSString(ADataItem).IconSize :=
          ConditionalFormattingIconSet.Icons.Width;
      end;
    end;
    ...
    TdxReportCellSSString(ADataItem).IsNearMostLeft :=
      IsNearMostLeftCell(ACol, ARow);
    TdxReportCellSSString(ADataItem).IsNearMostTop :=
      IsNearMostTopCell(ACol, ARow);
    TdxReportCellSSString(ADataItem).ClipContent :=
      IsShowRowAndColumnHeadings and TdxReportCellSSString(ADataItem)
      .IsNearMostTopOrLeft;
...
begin
  if (AStyle.IconIndex >= 0) or not AStyle.DataBar.IsEmpty or
    (AStyle.Brush.Style <> sscfsSolid) then
  begin
...
function TdxSpreadSheetAdvancedViewParams.GetFillStyle(out AColor1,
  AColor2: TColor): TdxSpreadSheetCellFillStyle;
begin
...
procedure TdxReportCellConnectionLine.DrawBackground
...
begin
  ...
  ACanvas.WindowOrg := cxPointOffset(ACanvas.WindowOrg,
    BoundsRect.TopLeft, False);
end;

procedure TdxReportCellConnectionLine.AdjustBounds;
begin
  CalculateArrow;
  BoundsRect := cxRect(Min(LinePoint1.X, LinePoint2.X),
    Min(LinePoint1.Y, LinePoint2.Y), Max(LinePoint1.X, LinePoint2.X),
...
var
  AAngle: Double;
begin
  AAngle := Pi / 2 - ArcTan2(LinePoint2.Y - LinePoint1.Y,
...
procedure TdxReportCellConnectionLine.ConvertCoords(APixelsNumerator,
  APixelsDenominator: Integer);
begin
  inherited;
  FArrowSize := MulDiv(FArrowSize, APixelsNumerator, APixelsDenominator);
  FLinePoints[0] := cxPointScale(FLinePoints[0], APixelsNumerator,
    APixelsDenominator);
  FLinePoints[1] := cxPointScale(FLinePoints[1], APixelsNumerator,
    APixelsDenominator);
  CalculateArrow;
end;
...
procedure TdxReportCellConnectionLine.SetLinePoint(Index: Integer;
  const Value: TPoint);
begin
...
begin
  ...
  begin
    ...
    FTextAlignHorzIndent := TdxReportCellBaseSSString(Source)
      .TextAlignHorzIndent;
...
procedure TdxReportCellBaseSSString.DrawContent
...
procedure TdxReportCellBaseSSString.ConvertCoords(APixelsNumerator,
  APixelsDenominator: Integer);
begin
  inherited ConvertCoords(APixelsNumerator, APixelsDenominator);
  TextAlignHorzIndent := MulDiv(TextAlignHorzIndent, APixelsNumerator,
    APixelsDenominator);
  TextExtentLeft := MulDiv(TextExtentLeft, APixelsNumerator,
    APixelsDenominator);
...
procedure TdxReportCellBaseSSString.DrawDataBar
  (ACanvas: TdxPSReportRenderCustomCanvas);

  function GetActualBarColor: TColor;
  begin
    if (DataBar.Position >= DataBar.AxisPosition) or (DataBar.Color2 = clNone)
    then
...
procedure TdxReportCellBaseSSString.DrawIcon
  (ACanvas: TdxPSReportRenderCustomCanvas);
begin
  Renderer.DrawGraphicEx(ACanvas, GetIconBounds(ACanvas), BoundsRect,
    ConditionalFormattingIconSet.Icons, IconIndex, nil, True, True, Color,
    Color, TdxPSSolidFillPattern);
end;
...
procedure TdxReportCellBaseSSString.SetContentPattern
  (Value: TdxPSFillPatternClass);
begin
  FContentPattern := Value;
end;

procedure TdxReportCellBaseSSString.GetDataBarBounds
  (ACanvas: TdxPSReportRenderCustomCanvas; out AAxisBounds, ABarBounds: TRect);

  function GetPointPosition(const AContentBounds: TRect;
    APosition: Single): Integer;
  begin
    Result := AContentBounds.Left +
      Round(APosition * cxRectWidth(AContentBounds));
  end;
...
function TdxReportCellBaseSSString.GetIconBounds
  (ACanvas: TdxPSReportRenderCustomCanvas): TRect;
begin
...
function TdxReportCellBaseSSString.GetTextBounds
  (ACanvas: TdxPSReportRenderCustomCanvas): TRect;
begin
...
procedure TdxReportCellBaseSSString.SetDataBar
  (AValue: TdxSpreadSheetCellDataBar);
begin
...
procedure TdxReportCellSSString.SetBorders(AColor: TColor;
  APattern: TdxPSEdgePatternClass);
var
  ABorder: TdxPSCellBorder;
  ASide: TdxCellSide;
begin
...
procedure TdxReportCellSSString.CalcBorderSubs
  ...
  function GetNeighborCellBorder(ASide, ABorderSide: TdxCellSide)
    : TdxPSCellBorder;
  var
  ...
  procedure GetBordersAtCorner(ACorner: TdxPSCellCorner;
    out ABorders: TdxPSCellBorders);
  begin
    case ACorner of
      ccTopLeft:
        begin
  ...
  function NeedCornerSubsCalculation(ACorner: TdxPSCellCorner;
    ABorders: TdxPSCellBorders): Boolean;
  var
    ABorder: TdxPSCellBorder;
    ABorderColor: TColor;
  ...
  begin
    ...
    begin
      ...
      if (ADoubleLineBorderCount <> 0) and
        (ADoubleLineBorderCount <> ABorderCount) then
        Exit(True);
  ...
  function GetFavoriteSides(ACorner: TdxPSCellCorner;
    const ABorders: TdxPSCellBorders): TdxCellSides;
  const
    CornerSideMaps: array [TdxPSCellCorner, TdxCellSide] of TdxCellSides =
      (([], [], [csTop], [csLeft]), ([csTop], [], [], [csRight]),
      ([csBottom], [csRight], [], []), ([], [csLeft], [csBottom], []));
  var
    ABorder: TdxPSCellBorder;
  ...
  begin
    ...
    begin
      ...
      begin
        AThicknessDelta := ABorder.Pattern.Thickness -
          AFavoriteBorder.Pattern.Thickness;
        if IsDoubleLineBorderPattern(AFavoriteBorder) or (AThicknessDelta > 0)
          or (AThicknessDelta = 0) and
          (Lightness(ABorder.Color) < Lightness(AFavoriteBorder.Color)) then
        begin
  ...
  const
    ConcurSides: array [TdxCellSide, TdxPSCellBorderEnd] of TdxCellSide =
      ((csTop, csBottom), (csLeft, csRight), (csTop, csBottom),
      (csLeft, csRight));
  var
    AConcurSide: TdxCellSide;
  begin
    AConcurSide := ConcurSides[ASide, AEnd];
    Result := Max(BorderEdgeSalients[AConcurSide, bstInner],
      GetNeighborCellBorderSalient(ASide, AConcurSide, bstInner));
...
const
  ...
  CornerSides: array [TdxPSCellCorner] of TdxCellSides = ([csLeft, csTop],
    [csTop, csRight], [csRight, csBottom], [csBottom, csLeft]);
var
...
begin
  ...
  begin
    ...
    begin
      AUnfavorableSides := CornerSides[ACorner] - GetFavoriteSides(ACorner,
        ABorders);
      for ASide := csLeft to csBottom do
...
procedure TdxReportCellSSString.CalcDoubleBorderSlants
  (AnAdapter: TdxPSGridCellsAdapter);
var
  Neighbor: TdxReportCellSSString;
begin
  ...
  begin
    ...
    BorderSlants[csLeft, cbcTopLeft] :=
      Ord((Neighbor <> nil) and Neighbor.IsDoubleLineBorderPattern(csTop));
    BorderSlants[csLeft, cbcTopRight] := Ord(IsDoubleLineBorderPattern(csTop));
    BorderSlants[csLeft, cbcBottomRight] :=
      Ord(IsDoubleLineBorderPattern(csBottom));
    BorderSlants[csLeft, cbcBottomLeft] :=
      Ord((Neighbor <> nil) and Neighbor.IsDoubleLineBorderPattern(csBottom));
  end;

  if IsDoubleLineBorderPattern(csTop) then
  begin
    Neighbor := AnAdapter.GetNeighborCell(Self, csTop);
    BorderSlants[csTop, cbcTopLeft] :=
      Ord((Neighbor <> nil) and Neighbor.IsDoubleLineBorderPattern(csLeft));
    BorderSlants[csTop, cbcTopRight] :=
      Ord((Neighbor <> nil) and Neighbor.IsDoubleLineBorderPattern(csRight));
    BorderSlants[csTop, cbcBottomRight] :=
      Ord(IsDoubleLineBorderPattern(csRight));
    BorderSlants[csTop, cbcBottomLeft] :=
      Ord(IsDoubleLineBorderPattern(csLeft));
  end;
  ...
  begin
    ...
    BorderSlants[csRight, cbcTopRight] :=
      Ord((Neighbor <> nil) and Neighbor.IsDoubleLineBorderPattern(csTop));
    BorderSlants[csRight, cbcBottomRight] :=
      Ord((Neighbor <> nil) and Neighbor.IsDoubleLineBorderPattern(csBottom));
    BorderSlants[csRight, cbcBottomLeft] :=
      Ord(IsDoubleLineBorderPattern(csBottom));
  end;
  ...
  begin
    ...
    BorderSlants[csBottom, cbcTopLeft] :=
      Ord(IsDoubleLineBorderPattern(csLeft));
    BorderSlants[csBottom, cbcTopRight] :=
      Ord(IsDoubleLineBorderPattern(csRight));
    BorderSlants[csBottom, cbcBottomRight] :=
      Ord((Neighbor <> nil) and Neighbor.IsDoubleLineBorderPattern(csRight));
    BorderSlants[csBottom, cbcBottomLeft] :=
      Ord((Neighbor <> nil) and Neighbor.IsDoubleLineBorderPattern(csLeft));
  end;
end;

function TdxReportCellSSString.GetBackgroundBounds
  (ACanvas: TdxPSReportRenderCustomCanvas): TRect;
var
...
function TdxReportCellSSString.GetBorderEdgeBounds(ASide: TdxCellSide;
...
begin
  AItem := dxPSEdgePatternFactory.Items
    [TdxPSEdgePatternClass(BorderEdgeClasses[ASide]), IsPrinting];
  Result := AItem.Brushes[dxCellEdgeSideOrientation[ASide]];
end;

function TdxReportCellSSString.GetBorderEdgeClass(ASide: TdxCellSide)
...
function TdxReportCellSSString.GetBorderPainterClass
...
procedure TdxReportCellSSString.InitBorderPainter(ABordersPainter
...
function TdxReportCellSSString.QueryInterface(const IID: TGUID;
  out Obj): HResult;
begin
...
function TdxReportCellSSString.GetAbsoluteInnerBounds
  (ACanvas: TdxPSReportRenderCustomCanvas): TRect;
begin
  Result := GetInnerBounds(ACanvas);
  if Parent <> nil then
...
function TdxReportCellSSString.GetDoubleBorderRgn(ASide: TdxCellSide;
  const R: TRect): HRGN;
const
  VertexCount = 4;
type
  ...
  TdxPSCellEdgeCoords = record
    case Byte of
      ...
      1:
        (Points: array [0 .. VertexCount - 1] of TPoint);
  end;
var
...
begin
  ...
  Result := CreatePolygonRgn(EdgeCoords.Points, SizeOf(TdxPSCellEdgeCoords)
    div SizeOf(TPoint), Windows.WINDING);
end;

function TdxReportCellSSString.IsDoubleLineBorderPattern
  (ABorder: TdxPSCellBorder): Boolean;
begin
  with ABorder do
    Result := (Pattern <> nil) and Pattern.InheritsFrom
      (TdxPSDoubleLineSolidEdgePattern);
end;
...
begin
  Result := (ASide in CellSides) and IsDoubleLineBorderPattern
    (Self.Borders[ASide]);
end;
...
function TdxReportCellSSString.GetBorderSlant(ASide: TdxCellSide;
  ACorner: TdxPSCellBorderCorner): Integer;
begin
  Result := (FBorderSlants shr GetBorderSlantOffset(ASide, ACorner)) and
    SlantMask;
end;

function TdxReportCellSSString.GetBorderSlantOffset(ASide: TdxCellSide;
  ACorner: TdxPSCellBorderCorner): TDWORDBits;
begin
  Result := Integer(ASide) * SlantBitsPerSide + Integer(ACorner);
end;

function TdxReportCellSSString.GetBorderSub(ASide: TdxCellSide;
  AEnd: TdxPSCellBorderEnd): TdxPSCellBorderSub;
begin
  Result := (FBorderSubs shr GetBorderSubOffset(ASide, AEnd)) and SubEndMask;
end;

function TdxReportCellSSString.GetBorderSubMask(ASide: TdxCellSide;
  AEnd: TdxPSCellBorderEnd): DWORD;
begin
  Result := 0 or (SubEndMask shl GetBorderSubOffset(ASide, AEnd));
end;

function TdxReportCellSSString.GetBorderSubOffset(ASide: TdxCellSide;
  AEnd: TdxPSCellBorderEnd): TDWORDBits;
begin
...
procedure TdxReportCellSSString.SetBorder(ASide: TdxCellSide;
  Value: TdxPSCellBorder);
begin
...
procedure TdxReportCellSSString.SetBorderSub(ASide: TdxCellSide;
  AEnd: TdxPSCellBorderEnd; Value: TdxPSCellBorderSub);
begin
...
function TdxSpreadSheetAbstractReportLink.
  CannotActivateReportErrorString: string;
begin
...
procedure TdxSpreadSheetAbstractReportLink.AfterConstruct
...
procedure TdxSpreadSheetAbstractReportLink.PrepareConstruct
  (AReportCells: TdxReportCells);
begin
  FExtraColumnCount := 0;
  ...
  FSourceHeaderFontIndex :=
    AddFontToPool(SpreadSheet.Styles.GetHeaderStyle(Sheet).Font);
  FCachedDisplayCellStyle := TdxPSSpreadSheetCellDisplayStyleCache.
    Create(Sheet);
...
procedure TdxSpreadSheetAbstractReportLink.ConstructReportContent
  (AReportCells: TdxReportCells);
begin
...
function TdxSpreadSheetAbstractReportLink.GetCellText(ACol,
  ARow: Integer): string;
var
  ACell: TdxSpreadSheetCell;
  ACellStyle: TdxSpreadSheetCellStyle;
begin
  ...
  begin
    ...
    if (ARow = 0) and (ACol <> 0) then
      Result := TdxSpreadSheetColumnHelper.NameByIndex(ACol - 1,
        SpreadSheet.OptionsView.R1C1Reference);
  end
  else if not FAppendingExtraColumns and
    (FProcessingMerges or not IsMergedCell(ACol, ARow)) then
  begin
    ACell := GetSSCellObject(ARow, ACol);
    if ACell <> nil then
    begin
      ...
      if ACellStyle is TdxSpreadSheetTableViewCellDisplayStyle then
      begin
        if not TdxSpreadSheetTableViewCellDisplayStyle(ACellStyle).ShowCellValue
        then
          Exit;
      end;
...
function TdxSpreadSheetAbstractReportLink.GetCellTextCore
  (ACell: TdxSpreadSheetCell): string;
begin
  Result := ACell.DisplayText;
end;

function TdxSpreadSheetAbstractReportLink.GetColumnOffset
...
function TdxSpreadSheetAbstractReportLink.GetDataItemClass(ACol: Integer;
...
function TdxSpreadSheetAbstractReportLink.GetCellSides(ACol, ARow: Integer)
  : TdxCellSides;
  ...
  begin
    case ASide of
      ...
      csRight:
        Result := (ACol = GetColCount - 1) or GetCellTransparent(ACol + 1, ARow)
          and GetCellTransparent(ACol, ARow);
    else // csBottom
      Result := (ARow = GetRowCount - 1) or GetCellTransparent(ACol, ARow + 1)
        and GetCellTransparent(ACol, ARow);
    end;
  end;
...
begin
  ...
  try
    ...
    begin
      ...
      if (ABorderStyle in [sscbsNone, sscbsDefault]) and
        not(IsShowGridLines and AreNeigborhoodsTransparent(ASide)) or
...
function TdxSpreadSheetAbstractReportLink.GetCellTextAlignY(ACol, ARow: Integer)
  : TcxTextAlignY;
begin
...
function TdxSpreadSheetAbstractReportLink.GetMinRowHeight
  (ACanvas: TdxPSReportRenderCustomCanvas; AFont: TFont): Integer;
begin
  Result := 1;
end;

function TdxSpreadSheetAbstractReportLink.GetSourceCellColor(ACol,
  ARow: Integer): TColor;
begin
  if IsFixedCell(ACol, ARow) then
    Result := ColorToRGB(SpreadSheet.Styles.GetHeaderStyle(Sheet).Color)
  else if GetSourceCellContentPattern(ACol, ARow)
    .InheritsFrom(TdxPSSolidFillPattern) then
    Result := GetRealColor(GetSSCellStyle(ARow, ACol)
      .Brush.BackgroundColor, clWindow)
  else
    Result := GetRealColor(GetSSCellStyle(ARow, ACol).Brush.ForegroundColor,
      clWindow);
end;

function TdxSpreadSheetAbstractReportLink.GetSourceCellContentBkColor(ACol,
  ARow: Integer): TColor;
begin
  if IsFixedCell(ACol, ARow) then
    Result := ColorToRGB(SpreadSheet.Styles.GetHeaderStyle(Sheet).Color)
  else
    Result := GetRealColor(GetSSCellStyle(ARow, ACol).Brush.BackgroundColor,
      clWindow);
end;

function TdxSpreadSheetAbstractReportLink.GetSourceCellContentPattern(ACol,
  ARow: Integer): TdxPSFillPatternClass;
begin
  if IsFixedCell(ACol, ARow) then
...
function TdxSpreadSheetAbstractReportLink.GetSourceCellEdge3DSoft(ACol,
  ARow: Integer): Boolean;
begin
  Result := True;
end;

function TdxSpreadSheetAbstractReportLink.GetSourceCellEdgeMode(ACol,
  ARow: Integer): TdxCellEdgeMode;
begin
  Result := cemPattern;
end;

function TdxSpreadSheetAbstractReportLink.GetSourceCellFont(ACol,
  ARow: Integer): TFont;
begin
  if IsFixedCell(ACol, ARow) then
    Result := inherited GetSourceCellFont(ACol, ARow)
  else
    Result := TdxSpreadSheetCellFontAccess(GetSSCellStyle(ARow, ACol).Font)
      .Handle.GraphicObject;
end;

function TdxSpreadSheetAbstractReportLink.GetSourceCellFontIndex(ACol,
...
function TdxSpreadSheetAbstractReportLink.GetSourceCellMultiline(ACol,
  ARow: Integer): Boolean;
begin
  Result := not IsFixedCell(ACol, ARow) and GetSSCellStyle(ARow, ACol).WordWrap;
end;

function TdxSpreadSheetAbstractReportLink.GetFlatIndex(ACol,
  ARow: Integer): Integer;
begin
  Result := ARow * (ColCount - 1) + ACol;
end;

function TdxSpreadSheetAbstractReportLink.GetSourceCellTextAlignX(ACol,
  ARow: Integer): TcxTextAlignX;
var
...
function TdxSpreadSheetAbstractReportLink.GetSourceCellTextAlignY(ACol,
  ARow: Integer): TcxTextAlignY;
begin
  if IsFixedCell(ACol, ARow) then
    Result := taBottom
  else
...
function TdxSpreadSheetAbstractReportLink.GetSourceCellTransparent(ACol,
  ARow: Integer): Boolean;
begin
  if IsFixedCell(ACol, ARow) then
...
function TdxSpreadSheetAbstractReportLink.GetSourceColWidth
  (ACol: Integer): Integer;
begin
  if IsFixedCol(ACol) then
    Result := 50
  else
    Result := TdxSpreadSheetTableItemsAccess(Sheet.Columns)
      .GetItemSize(ACol - 1);

  Result := ScaleFactor.Apply(Result);
end;

function TdxSpreadSheetAbstractReportLink.GetSourceRowHeight
  (ARow: Integer): Integer;
begin
...
function TdxSpreadSheetAbstractReportLink.GetSSCellObject(ARow, ACol: Integer)
  : TdxSpreadSheetCell;
var
  Index: Integer;
begin
...
function TdxSpreadSheetAbstractReportLink.GetSSCellStyle(ARow, ACol: Integer)
  : TdxSpreadSheetCellStyle;
var
  ACell: TdxSpreadSheetCell;
begin
  Result := GetSSDefaultStyle;
  if not FAppendingExtraColumns and IsProcessedCol(ACol) and IsProcessedRow(ARow)
  then
  begin
    Dec(ACol);
    Dec(ARow);
    if (Sheet.ConditionalFormatting.RuleCount > 0) and not IsSuppressSourceFormats
    then
    begin
      if (FCachedDisplayCellStyle.Row <> ARow) or
        (FCachedDisplayCellStyle.Column <> ACol) then
      begin
        ACell := GetSSCellObject(ARow + 1, ACol + 1);
        FCachedDisplayCellStyle.Reset;
        FCachedDisplayCellStyle.Assign(TdxSpreadSheetTableViewAccess(Sheet)
          .GetCellStyle(ARow, ACol, ACell));
        FCachedDisplayCellStyle.Column := ACol;
        FCachedDisplayCellStyle.Row := ARow;
        Sheet.ConditionalFormatting.CalculateStyle(FCachedDisplayCellStyle,
          ARow, ACol, ACell);
      end;
...
function TdxSpreadSheetAbstractReportLink.GetSSDefaultStyle
  : TdxSpreadSheetCellStyle;
begin
  Result := SpreadSheet.DefaultCellStyle;
end;

procedure TdxSpreadSheetAbstractReportLink.AssignRtfStringData
  (AItem: TAbstractdxReportCellData; const AValue: TcxEditValue;
  const ACellParams: IdxPSCellParams; var AViewParams: TdxReportItemViewParams);
begin
  // do nothing
end;

function TdxSpreadSheetAbstractReportLink.GetRtfStringDataClass
...
function TdxSpreadSheetAbstractReportLink.IsCellContainsRTFText(ACol,
  ARow: Integer): Boolean;
var
  ARTF: string;
  ACell: TdxSpreadSheetCellAccess;
begin
  Result := (ARow > 0) and (ACol > 0) and
    dxSpreadSheetTextService.IsRTFSupported;
  if Result then
  begin
    ACell := TdxSpreadSheetCellAccess(GetSSCellObject(ARow, ACol));
    Result := (ACell <> nil) and ACell.IsValueFormattedString and
      dxSpreadSheetTextService.GetAsRTF(ACell, ARTF);
  end;
end;
...
function TdxSpreadSheetAbstractReportLink.IsEmptyCell
  (const ACell: TdxSpreadSheetCell): Boolean;
begin
  Result := IsCellDataEmpty(ACell) and
    ((ACell = nil) or AreStylesEqual(SpreadSheet.DefaultCellStyle,
    ACell.Style));
end;
...
procedure TdxSpreadSheetAbstractReportLink.AddMergedCells
  (AReportCells: TdxReportCells);
...
begin
  ...
  try
    ...
    else if not IsShowRowAndColumnHeadings then
    begin
      Inc(LeftOffset, ColumnWidths[0]);
      Inc(TopOffset, RowHeights[0]);
    end
    else if HeadersOnEveryPage then
      Inc(TopOffset, RowHeights[0]);
      ...
      begin
        ...
        begin
          ...
          begin
            ...
            AssignRtfStringData(ARTFItem, AReportCell.Text, AReportCell,
              AViewParams);
            AReportCell.Text := '';
...
procedure TdxSpreadSheetAbstractReportLink.AppendAdditionalColumns
  (AAdapter: TdxPSGridCellsAdapter);

  function DoCalcExtraColumnCount(AAdapter: TdxPSGridCellsAdapter;
  ...
  begin
    ...
    repeat
      ...
      if (AColumn = nil) or AColumn.Visible then
        Break;
      Inc(Result);
    until False;
  end;

  procedure DoAppendExtraColumns(AAdapter: TdxPSGridCellsAdapter;
    ...
    begin
      ...
      begin
        ...
        if Item.IsFixed then
          Item.Text := TdxSpreadSheetColumnHelper.NameByIndex(RealCol - 1,
            SpreadSheet.OptionsView.R1C1Reference);
      end;
...
procedure TdxSpreadSheetAbstractReportLink.CalcTextExtents
  (AAdapter: TdxPSGridCellsAdapter);

  function GetTextWidth(ACanvas: TdxPSReportRenderCustomCanvas; AFont: TFont;
  ...
  begin
    Result := not(AItem.IsMerged or AItem.IsFixed or AItem.Multiline or
      AItem.Fill or AItem.IsRTF) and (AItem.Text <> '') and
      (AItem.TextAlignX in [taLeft, taCenterX, taRight]);
  end;

  procedure DoCalcItemTextExtents(AItem: TdxReportCellSSString;
    Col, Row: Integer);
    ...
    begin
      ...
      begin
        ...
        if CurrentColumnOffset < TextLeftEdge then
          Break;
        if (Item = nil) or Item.IsFixed or Item.IsMerged or (Item.Text <> '')
        then
        begin
  ...
  begin
    ...
    case AItem.TextAlignX of
      taLeft:
        AItem.TextExtentRight := CalcTextRightExtent(AItem.TextAlignHorzIndent +
          ATextWidth + 3 * dxTextSpace, Col, Row);
      taRight:
        AItem.TextExtentLeft := CalcTextLeftExtent(AItem.TextAlignHorzIndent +
          ATextWidth + 3 * dxTextSpace, Col, Row);
      taCenterX:
        begin
          Dec(ATextWidth, (ATextWidth - AItem.Width) div 2);
          AItem.TextExtentRight := CalcTextRightExtent(ATextWidth + dxTextSpace,
            Col, Row);
          AItem.TextExtentLeft := CalcTextLeftExtent(ATextWidth + dxTextSpace,
            Col, Row);
        end;
    end;
  end;
...
procedure TdxSpreadSheetAbstractReportLink.FixupRowWidths
  (AAdapter: TdxPSGridCellsAdapter);
var
  AMaxWidth: Integer;
  I: Integer;
...
procedure TdxSpreadSheetAbstractReportLink.DeleteUnneededCellSides
  (AAdapter: TdxPSGridCellsAdapter);

  procedure DoDeleteUnneededCellSidesFromRightSide(AItem: TdxReportCellSSString;
    ACol: Integer);
  var
  ...
  procedure DoDeleteUnneededCellSidesFromLeftSide(AItem: TdxReportCellSSString;
    ACol: Integer);
  var
...
procedure TdxSpreadSheetAbstractReportLink.PostProcessItems
  (AAdapter: TdxPSGridCellsAdapter);

  procedure CalculateRTFBounds(AReportCell: TdxReportCellSSString;
    ACol, ARow: Integer; var R: TRect);
  var
    ACell: TdxSpreadSheetCell;
  ...
  begin
    ...
    ALeft := 0;
    dxSpreadSheetTextService.CalculateSize(ACell, cxScreenCanvas, R,
      ACell.IsMerged, @ARight, nil);
...
procedure TdxSpreadSheetAbstractReportLink.AddContainers
  (AReportCells: TdxReportCells);
var
...
function TdxSpreadSheetAbstractReportLink.CalculateContainerBounds
  (AViewInfo: TdxSpreadSheetContainerViewInfo): TRect;
var
  AContainer: TdxSpreadSheetContainerAccess;
  AOrigin: TPoint;
begin
  AContainer := TdxSpreadSheetContainerAccess(AViewInfo.Owner);
  AOrigin := TdxSpreadSheetCustomViewAccess(AContainer.Parent)
    .ViewInfo.ContentOrigin;
  AViewInfo.SetBounds(cxRectOffset(AContainer.Calculator.CalculateBounds,
    AOrigin, False));
  AViewInfo.Calculate;
  Result := cxRectOffset(AViewInfo.RealBounds, AOrigin);
end;

function TdxSpreadSheetAbstractReportLink.CanPrintContainer
  (AContainer: TdxSpreadSheetContainer): Boolean;
begin
  Result := AContainer.Visible;
end;

function TdxSpreadSheetAbstractReportLink.CreateContainerImage
  (AViewInfo: TdxSpreadSheetContainerViewInfo): TdxSmartImage;
var
...
begin
  ...
  begin
    ...
    if cxRectIsNull(APictureContainer.Picture.CropMargins) and
      TdxSpreadSheetShapeAccess(APictureContainer.Shape).IsEmpty then
    begin
  ...
  try
    AImageCanvas.TranslateWorldTransform(-AViewInfo.RealDrawingBounds.Left,
      -AViewInfo.RealDrawingBounds.Top);
...
function TdxSpreadSheetAbstractReportLink.CreateContainersHost
  (AReportCells: TdxReportCells): TdxReportCell;
const
  HeadersBorderSize = 1;
var
  ARect: TRect;
...
procedure TdxSpreadSheetAbstractReportLink.InitializeContainerCell
...
function TdxSpreadSheetAbstractReportLink.TranslateContainerBounds
  (AView: TdxSpreadSheetCustomView; var ABounds: TRect): Boolean;
type
  TAnchorInfo = record
    Column: Integer;
    Row: Integer;
  ...
  function GetAnchorPositionInReport(const AAnchor: TAnchorInfo;
    out P: TPoint): Boolean;
  var
    ARect: TRect;
  begin
    Result := (AAnchor.Row >= 0) and (AAnchor.Column >= 0) and
      GetCellBoundsInReport(AAnchor.Row, AAnchor.Column, False, ARect);
    if Result then
    begin
...
begin
  Result := GetAnchorPositionInReport(CalculateAnchor(ABounds.TopLeft),
    ABounds.TopLeft) and GetAnchorPositionInReport
    (CalculateAnchor(ABounds.BottomRight), ABounds.BottomRight);
  if Result then
    ABounds := cxRectOffset(ABounds, GetContainerBoundsOffset);
end;

function TdxSpreadSheetAbstractReportLink.GetCellBoundsInReport(ARow,
  AColumn: Integer; AConsiderMergedCells: Boolean; out ARect: TRect): Boolean;
var
  ACell: TdxReportCellSSString;
...
begin
  ...
  begin
    ...
    if AMergedCell <> nil then
      if GetCellBoundsInReport(AMergedCell.Area.Top, AMergedCell.Area.Left,
        False, R) and GetCellBoundsInReport(AMergedCell.Area.Bottom,
        AMergedCell.Area.Right, False, ARect) then
      begin
  ...
  for I := 0 to FGridAdapter.RowCount - 1 do
    ...
    begin
      ...
      if (ACell <> nil) and (ACell.RealCol = AColumn) and (ACell.RealRow = ARow)
      then
      begin
...
function TdxSpreadSheetAbstractReportLink.ReportAreaToSpreadSheetArea
  (const R: TRect): TRect;
begin
  Result := cxRectOffset(R, -1, -1);
end;

function TdxSpreadSheetAbstractReportLink.SpreadSheetAreaToReportArea
  (const R: TRect): TRect;
begin
  Result := cxRectOffset(dxSpreadSheetGetRealArea(R), 1, 1);
end;

function TdxSpreadSheetAbstractReportLink.GetBorderStylePatternClass
  (AStyle: TdxSpreadSheetCellBorderStyle): TdxPSEdgePatternClass;
begin
  Result := dxPSEdgePatternClassMap[AStyle];
end;

function TdxSpreadSheetAbstractReportLink.OnlyEdgeIsAssigned
  (const ACell: TdxSpreadSheetCell; ASide: TcxBorder): Boolean;
begin
  Result := IsCellDataEmpty(ACell) and
    ((ACell = nil) or AreStylesEqual(SpreadSheet.DefaultCellStyle, ACell.Style,
    [ASide]));
end;

function TdxSpreadSheetAbstractReportLink.OnlyLeftEdgeIsAssigned
  (ACell: TdxSpreadSheetCell): Boolean;
begin
  Result := OnlyEdgeIsAssigned(ACell, bLeft);
end;

function TdxSpreadSheetAbstractReportLink.OnlyTopEdgeIsAssigned
  (ACell: TdxSpreadSheetCell): Boolean;
begin
  Result := OnlyEdgeIsAssigned(ACell, bTop);
end;

function TdxSpreadSheetAbstractReportLink.IsMergedBorder(ACol, ARow: Integer;
  ASide: TdxCellSide): Boolean;
var
  AArea: TRect;
begin
...
function TdxSpreadSheetAbstractReportLink.IsMergedCell(ACol,
  ARow: Integer): Boolean;
begin
  Result := not(IsFixedCell(ACol, ARow) or dxSpreadSheetIsSingleCellArea
    (MergedCells.ExpandArea(ACol - 1, ARow - 1)));
end;

function TdxSpreadSheetAbstractReportLink.IsNearMostLeftCell(ACol,
  ARow: Integer): Boolean;
begin
...
function TdxSpreadSheetAbstractReportLink.IsNearMostTopCell(ACol,
  ARow: Integer): Boolean;
begin
  if IsShowRowAndColumnHeadings and HasSelection then
...
function TdxSpreadSheetAbstractReportLink.IsProcessedCol(ACol: Integer)
  : Boolean;
var
...
function TdxSpreadSheetAbstractReportLink.IsProcessedRow(ARow: Integer)
  : Boolean;
var
  AItem: TdxSpreadSheetTableItem;
begin
...
procedure TdxSpreadSheetAbstractReportLink.SetupCellBorders(ACol, ARow: Integer;
  ADataItem: TdxReportCellSSString);
const
  OppositeSide: array [TdxCellSide] of TdxCellSide = (csRight, csBottom,
    csLeft, csTop);
...
begin
  ...
  begin
    ...
    begin
      for ASide := Low(TdxCellSide) to High(TdxCellSide) do
        ADataItem.Borders[ASide] := TdxPSCellBorder.Create
          (TdxPSSolidEdgePattern, ADefaultColor);
    end;
    Exit;
  end;
  ...
  try
    ...
    begin
      ...
      begin
        ...
        begin
          ANeighborStyle := GetSSCellStyle(ARow + VertOffset[ASide],
            ACol + HorzOffset[ASide]);
          if ANeighborStyle <> nil then
          begin
            ABorderColor := ANeighborStyle.Handle.Borders.BorderColor
              [TcxBorder(OppositeSide[ASide])];
            ABorderStyle := ANeighborStyle.Handle.Borders.BorderStyle
              [TcxBorder(OppositeSide[ASide])];
          end;
        end;
      end;
      ...
      if (ABorderStyle = sscbsDefault) and not(ASide in ADataItem.CellSides)
      then
      begin
        ABorderColor := clNone;
      ...
      ADataItem.Borders[ASide] := TdxPSCellBorder.Create
        (GetBorderStylePatternClass(ABorderStyle), ABorderColor);
    end;
  finally
    AStyle.Release;
  end;
...
function TdxSpreadSheetAbstractReportLink.GetMergedCells
  : TdxSpreadSheetMergedCellList;
begin
  Result := Sheet.MergedCells;
end;

function TdxSpreadSheetAbstractReportLink.GetRealColor(AColor,
  ADefaultColor: TColor): TColor;
begin
  Result := ColorToRGB(cxGetActualColor(AColor, ADefaultColor));
end;

function TdxSpreadSheetAbstractReportLink.GetEditProperties
  : TcxCustomEditProperties;
begin
  Result := TdxSpreadSheetEditingControllerAccess
    (Sheet.Controller.EditingController).DefaultEditProperties;
end;

function TdxSpreadSheetAbstractReportLink.GetItemViewParams
  (AItem: TdxReportCellSSString): TdxReportItemViewParams;
begin
...
begin
  ...
  begin
    ...
    begin
      AViewInfo := TdxSpreadSheetContainerViewInfo
        (ASheet.ViewInfo.Containers[I]);
      if CanPrintContainer(AViewInfo.Owner) then
      begin
        ARect := AViewInfo.RealBounds;
        if ATableView.GetCellAtAbsolutePoint(ARect.TopLeft, ARowIndex,
          AColumnIndex) then
        begin
          Result.Top := Min(Result.Top, ARowIndex);
          Result.Left := Min(Result.Left, AColumnIndex);
        end;
        if ATableView.GetCellAtAbsolutePoint(ARect.BottomRight, ARowIndex,
          AColumnIndex) then
        begin
