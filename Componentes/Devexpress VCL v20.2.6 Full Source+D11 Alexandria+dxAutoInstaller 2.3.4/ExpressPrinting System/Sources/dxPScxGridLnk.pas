...
{$ENDIF}
  ...
  ComCtrls, ExtCtrls, ImgList, Dialogs,
  dxLayoutControlAdapters, dxLayoutLookAndFeels, dxLayoutContainer,
  dxLayoutControl, dxLayoutcxEditAdapters,
  ExtDlgs, Menus, cxGraphics, cxClasses, cxControls, cxCustomData,
  cxDataStorage, cxData, cxDBData, cxGridDBDataDefinitions,
  cxGrid, cxGridCustomView, cxGridCustomTableView, cxGridTableView,
  cxGridDBTableView, cxGridCardView, cxGridDBCardView,
  cxGridBandedTableView, cxGridDBBandedTableView, cxGridChartView,
  cxGridDBChartView, cxGridWinExplorerView, cxEdit,
  cxGridDBWinExplorerView, cxGridLevel, cxStyles, cxLookAndFeels,
  cxGridCustomLayoutView, cxLookAndFeelPainters,
  cxFilter, cxTextEdit, cxCheckBox, cxImage, dxBase, dxPSSngltn, dxExtCtrls,
  dxPSCore, dxPrnPg, dxPScxCommon,
  dxCore, cxContainer, cxLabel, cxPC, cxMaskEdit, cxDropDownEdit, cxSpinEdit,
  cxColorComboBox, cxButtons,
  dxPSReportRenderCanvas, cxGeometry, cxNavigator, dxCoreClasses,
  dxServerModeData, cxGridServerModeTableView,
  cxGridServerModeBandedTableView, cxTrackBar, cxImageList,
...
type
  ...
  TdxGridViewDetailsSeparatorProducerClass = class of
  ...
  TdxGridCardViewCardsRowProducerClass = class of
    TdxGridCardViewCardsRowProducer;
  TdxGridCardViewCardsRowProducer = class;
  TdxGridCustomLayoutViewRecordProducerClass = class of
  ...
  protected
    class procedure AddAttribute(var AnAtributes: TdxGridAttributeClasses;
      AnAttribute: TdxGridAttributeClass);
    class function FilterPosition(AView: TcxCustomGridView)
      : TcxGridFilterPosition; virtual;

    class function IsFilterBarAtBottom(AView: TcxCustomGridView)
      : Boolean; virtual;
    class function IsFilterBarAtTop(AView: TcxCustomGridView): Boolean; virtual;
    class function IsOffice11StyleGrouping(AView: TcxCustomGridView)
      : Boolean; virtual;
  ...
  public
    ...
    class function ExtractCustomDrawID(AnItem: TdxReportVisualItem)
      : TdxGridAttributeID; virtual;
    class procedure ExtractCustomDrawInfo(AnItem: TdxReportVisualItem;
      out ACustomDrawInfo: TdxGridCellCustomDrawInfo); virtual;
    class function ExtractGridView(AnItem: TdxReportVisualItem)
      : TcxCustomGridView; virtual;
    class function HasData(AView: TcxCustomGridView): Boolean; virtual;
    class function IsAttributeSupported(AnAttribute: TdxGridAttributeClass)
      : Boolean; virtual;
  ...
  protected
    class function ExtractRecord(AnItem: TdxReportVisualItem)
      : TcxCustomGridRecord; virtual;
    class function FilterPosition(AView: TcxCustomGridView)
      : TcxGridFilterPosition; override;
    class function ViewClass: TcxCustomGridViewClass; override;
  public
    class function ExtractCustomDrawID(AnItem: TdxReportVisualItem)
      : TdxGridAttributeID; override;
  ...
  protected
    class function ExtractCard(AnItem: TdxReportVisualItem)
      : TcxGridCard; virtual;
    class function ExtractCardRow(AnItem: TdxReportVisualItem)
      : TcxGridCardViewRow; virtual;
    class function ExtractRecord(AnItem: TdxReportVisualItem)
  ...
  protected
    class function ExtractColumn(AnItem: TdxReportVisualItem)
      : TcxGridColumn; virtual;
    class function ExtractGroupLevel(AnItem: TdxReportVisualItem)
      : Integer; virtual;
    class function ExtractRecord(AnItem: TdxReportVisualItem)
      : TcxCustomGridRecord; override;
    class function IsOffice11StyleGrouping(AView: TcxCustomGridView)
  ...
  protected
    class function ExtractBand(AnItem: TdxReportVisualItem)
      : TcxGridBand; virtual;
    class function ViewClass: TcxCustomGridViewClass; override;
  public
    class function ExtractCustomDrawID(AnItem: TdxReportVisualItem)
  ...
  TdxGridWinExplorerViewDataRecordHelper = class
    (TdxGridWinExplorerViewRecordHelper)
  protected
    class function ProducerClass: TdxGridViewRowProducerClass; override;
    class function RecordClass: TcxCustomGridRecordClass; override;
  end;

  TdxGridWinExplorerViewGroupRecordHelper = class
    (TdxGridWinExplorerViewRecordHelper)
  protected
    class function ProducerClass: TdxGridViewRowProducerClass; override;
    class function RecordClass: TcxCustomGridRecordClass; override;
  ...
  public
    ...
    property Helpers[ARecord: TcxCustomGridRecord]: TdxCustomGridRecordHelper
      read GetHelper; default;
  end;
  ...
  private
    ...
    function GetProducer(ProducerClass: TdxGridViewRowProducerClass)
  ...
  public
    ...
    property Producers[ProducerClass: TdxGridViewRowProducerClass]
      : TdxGridViewRowProducer read GetProducer; default;
  end;
  ...
  protected
    ...
    function BackgroundBitmaps: TcxCustomGridBackgroundBitmaps;
      overload; virtual;
    ...
    function CreateCloneAdapter(AClone: TcxCustomGridView)
      : TdxCustomGridViewAdapter;
    procedure ExpandAllRowsInClones(AMasterRows, AGroupRows: Boolean); virtual;
    procedure ExpandAllRowsInGridView(AGridView: TcxCustomGridView;
      AMasterRows, AGroupRows: Boolean);
    procedure ExpandAllRowsInLevel(ALevel: TcxGridLevel;
  ...
  public
    constructor Create(AMasterAdapter: TdxCustomGridViewAdapter;
    ...
    procedure ExpandAllRows(AnOptionsExpanding
      : TdxGridReportLinkOptionsExpanding; ARecursive: Boolean); virtual;

    property AbsoluteLevel: Integer read GetAbsoluteLevel;
    property AreAllMasterRowsCollapsed: Boolean
      read GetAreAllMasterRowsCollapsed;
    ...
    property DetailsSeparatorThickness: Integer
      read GetDetailsSeparatorThickness;
  ...
  protected
    ...
    function GetViewWidthExtraAfter: Integer; virtual;
    // MD relation considering
    function GetViewWidthExtraBefore: Integer; virtual;
    // MD relation considering
    ...
    function MapStyleBackgroundBitmapIndex(AGridBackgroundBitmapIndex: Integer)
      : Integer; virtual;

    function CalculateFontHeight(const AParams
      : TdxReportItemViewParams): Integer;
    procedure CalculateHeight(const AParams: TdxReportItemViewParams;
      var AHeight: Integer);
    ...
    procedure RegisterLookAndFeelItem(AnItem: TdxReportVisualItem;
      AEdgeStyle: TdxCellEdgeStyle);
    procedure SetViewParams(AnItem: TdxReportVisualItem;
      AGridLines: TcxGridLines; const AParams: TcxViewParams); overload;
    procedure SetViewParams(AnItem: TdxReportVisualItem;
      const AParams: TdxReportItemViewParams); overload;
    ...
    property ExpandButtons[Index: Integer]: TdxReportCellExpandButton
      read GetExpandButton;
    property GridWidth: Integer read GetGridWidth;
    property LookAndFeelItemCount: Integer read GetLookAndFeelItemCount;
    property LookAndFeelItems[Index: Integer]: TdxReportVisualItem
      read GetLookAndFeelItem;
  ...
  public
    ...
    procedure DoReportLinkInitializeCaption
      (ACaption: TdxReportCellText); virtual;
    ...
    procedure DoReportLinkInitializeFilterBar
      (AFilterBar: TdxReportCellText); virtual;
    ...
    procedure DoInitializeHorzDetailsSeparator
      (ASeparator: TdxReportCellBox); virtual;
    procedure DoInitializeVertBottomDetailsSeparator
      (ASeparator: TdxReportCellBox;
    ...
    { Master Indent }
    procedure DoInitializeExpandButton(AnExpandButton
      : TdxReportCellExpandButton; ARecord: TcxCustomGridRecord;
      AnIsMasterIndent: Boolean);
    procedure DoInitializeMasterIndent(AnIndent: TdxReportCellExpandButton;
      AnIndex, AnIndentCount: Integer); virtual;
    function GetMasterIndentClass: TdxReportCellExpandButtonClass; virtual;

    { View Terminator }
    procedure DoInitializeViewTerminator(ATerminator
      : TdxReportCellBox); virtual;

    property AbsoluteLevel: Integer read GetAbsoluteLevel;
    property AutoWidth: Boolean read GetAutoWidth;
    property CaptionLineHeight: Integer read FCaptionLineHeight
      write FCaptionLineHeight;
    property DetailsSeparatorColor: TColor read GetDetailsSeparatorColor;
    property DetailsSeparatorThickness: Integer
      read GetDetailsSeparatorThickness;
    property FilterBarLineHeight: Integer read FFilterBarLineHeight
      write FFilterBarLineHeight;
    ...
    property ViewWidth: Integer read GetViewWidth;
    property ViewWidthExtra: Integer read GetViewWidthExtra;
    property ViewWidthExtraAfter: Integer read GetViewWidthExtraAfter;
    // MD relation considering
    property ViewWidthExtraBefore: Integer read GetViewWidthExtraBefore;
    // MD relation considering
  end;
  ...
  protected
    ...
    function GetDetailsBottomSeparatorProducer
      : TdxGridViewDetailsSeparatorProducer; virtual;
    function GetDetailsBottomSeparatorProducerClass
      : TdxGridViewDetailsSeparatorProducerClass; virtual;
    function GetDetailsTopSeparatorProducer
      : TdxGridViewDetailsSeparatorProducer; virtual;
    function GetDetailsTopSeparatorProducerClass
      : TdxGridViewDetailsSeparatorProducerClass; virtual;
    { Filter Box }
    procedure CreateFilterBar; virtual;
    function GetFilterBarProducer: TdxGridViewFilterBarProducer; virtual;
    function GetFilterBarProducerClass
      : TdxGridViewFilterBarProducerClass; virtual;
    { View Terminator }
    procedure CreateViewTerminator; virtual;
    function GetViewTerminatorProducer: TdxGridViewTerminatorProducer; virtual;
    function GetViewTerminatorProducerClass
      : TdxGridViewTerminatorProducerClass; virtual;

    function GridView: TcxCustomGridView; overload; virtual;
    class function GridViewClass: TcxCustomGridViewClass; virtual;

    property GridLevel: TcxGridLevel read GetGridLevel;
    property HostInfoServices: TdxGridAttributeHostInfoServices
      read GetHostInfoServices;
  ...
  public
    ...
    property AbsoluteBuilders[Index: Integer]: TdxCustomGridViewBuilder
  ...
  strict private
    FConditionalFormattingProvider
    ...
    function GetRecordHelper(ARecord: TcxCustomGridRecord)
  ...
  protected
    ...
    function GetContentViewParams(ARecord: TcxCustomGridRecord;
      ATableItem: TcxCustomGridTableItem; AIsDataCell: Boolean = False)
      : TcxViewParams; virtual;
    ...
    function TryGetAdvancedStyle(const ACell: TPoint;
      out AStyle: TdxSpreadSheetCellDisplayStyle): Boolean;
  ...
  public
    constructor Create(AMasterAdapter: TdxCustomGridViewAdapter;
      AGridView: TcxCustomGridView); override;
    destructor Destroy; override;

    function ForEachRecord(AProc: TdxGridTableAdapterForEachRecordProc;
    ...
    property DetailsLineCount: Integer read GetDetailsLineCount
    ...
    property RecordHelpers[Row: TcxCustomGridRecord]: TdxCustomGridRecordHelper
      read GetRecordHelper;
  ...
  TdxCustomGridTableViewFormatter = class(TdxCustomGridViewFormatter,
    IdxPSCellParams, IdxPSCellParams2)
  strict private
  ...
  protected
    ...
    function IdxPSCellParams.GetDisplayGraphicsAsText =
      IdxPSCellParams_GetDisplayGraphicsAsText;
    function IdxPSCellParams.GetDisplayTrackBarsAsText =
      IdxPSCellParams_GetDisplayTrackBarsAsText;
    function IdxPSCellParams.GetEndEllipsis = IdxPSCellParams_GetEndEllipsis;
    function IdxPSCellParams.GetFlatCheckMarks =
      IdxPSCellParams_GetFlatCheckMarks;
    ...
    function IdxPSCellParams.GetTransparentGraphics =
      IdxPSCellParams_GetTransparentGraphics;
    ...
    { IdxPSCellParams2 }
    function IdxPSCellParams2.GetPreviewMarginLeft =
      IdxPSCellParams2_GetPreviewMarginLeft;
    function IdxPSCellParams2.GetPreviewMarginRight =
      IdxPSCellParams2_GetPreviewMarginRight;
    function IdxPSCellParams2.GetPreviewMaxHeight =
      IdxPSCellParams2_GetPreviewMaxHeight;
    function IdxPSCellParams2.GetPreviewMaxLineCount =
      IdxPSCellParams2_GetPreviewMaxLineCount;
    function IdxPSCellParams2.GetRichEditGraphicClass =
      IdxPSCellParams2_GetRichEditGraphicClass;
    function IdxPSCellParams2.GetRichEditTransparent =
      IdxPSCellParams2_GetRichEditTransparent;
    ...
    function GetContentBackgroundBitmapStyleIndex
      (ATableItem: TcxCustomGridTableItem): Integer; virtual;
    function MapStyleBackgroundBitmapIndex(AGridBackgroundBitmapIndex: Integer)
      : Integer; override;
  ...
  public
    ...
    procedure DoInitializeItem(AItem: TAbstractdxReportCellData;
      ATableItem: TcxCustomGridTableItem; ARecord: TcxCustomGridRecord;
      AIsPreview: Boolean = False); virtual;
    function GetDataItemClass(ATableItem: TcxCustomGridTableItem;
      ARecord: TcxCustomGridRecord; AIsPreview: Boolean = False)
      : TdxReportCellDataClass; virtual;
    function GetItemClass(ATableItem: TcxCustomGridTableItem;
      ARecord: TcxCustomGridRecord; AIsPreview: Boolean = False)
      : TdxReportCellDataClass; virtual;
    function GetItemProperties(ATableItem: TcxCustomGridTableItem;
      ARecord: TcxCustomGridRecord): TcxCustomEditProperties; virtual;
    function GetItemValue(AProperties: TcxCustomEditProperties;
      ATableItem: TcxCustomGridTableItem; ARecord: TcxCustomGridRecord)
      : TcxEditValue; virtual;
    function GetItemViewParams(ATableItem: TcxCustomGridTableItem;
      ARecord: TcxCustomGridRecord; AnIsPreview: Boolean = False;
      AIsDataCell: Boolean = False): TdxReportItemViewParams; virtual;
    function GetSelectionViewParams: TdxReportItemViewParams;

    property GridLineColor: TColor read GetGridLineColor;
    property RecordCount: Integer read GetRecordCount;
    property RecordIndexes[ARecord: TcxCustomGridRecord]: Integer
      read GetRecordIndex;
    property Records[Index: Integer]: TcxCustomGridRecord read GetRecord;
    property SelectedRecordCount: Integer read GetSelectedRecordCount;
    property SelectedRecords[Index: Integer]: TcxCustomGridRecord
  ...
  protected
    ...
    function GetFooterViewParams(ARecord: TcxCustomGridRecord;
      AGroupLevel: Integer; AColumn: TcxGridColumn; AItem: TcxDataSummaryItem)
      : TcxViewParams; virtual;
    function GetGroupRowViewParams(ARecord: TcxCustomGridRecord;
      AGroupLevel: Integer): TcxViewParams; virtual;
    function GetHeaderViewParams(AColumn: TcxGridColumn)
      : TcxViewParams; virtual;
    function GetPreviewViewParams(ARecord: TcxCustomGridRecord;
      AnItem: TcxCustomGridTableItem): TcxViewParams; override;

    property InternalColumnMinWidths[Column: TcxGridColumn]: Integer
      read GetInternalColumnMinWidth;
    property InternalColumnWidths[Column: TcxGridColumn]: Integer
      read GetInternalColumnWidth;
  public
    constructor Create(AMasterAdapter: TdxCustomGridViewAdapter;
      AGridView: TcxCustomGridView); override;
    ...
    function CheckSummaryItemIndex(AItems: TcxDataSummaryItems; AIndex: Integer;
      AIsGroup: Boolean): Integer;
    function GetFooterItemCount(AItems: TcxDataSummaryItems;
      ACanMultiLine: Boolean; AIsGroup: Boolean): Integer;
    function GetFooterItemInfo(AItems: TcxDataSummaryItems; AIndex: Integer;
      var ARowIndex: Integer): Integer;
    function GetFooterLineCount(AItems: TcxDataSummaryItems;
      ACanMultiLine: Boolean): Integer;
    ...
    function HasGroupFooter(AGridRow: TcxCustomGridRow;
    ...
    property GroupFooterHeightAssigned: Boolean
      read GetGroupFooterHeightAssigned;
    property GroupFooterMultiSummaries: Boolean
      read GetGroupFooterMultiSummaries;
    ...
    property GroupRowSeparatorThickness: Integer
      read GetGroupRowSeparatorThickness;
    ...
    property HeaderMultilines[Column: TcxGridColumn]: Boolean
      read GetHeaderMultiline;
    ...
    property RecordHelpers[Row: TcxCustomGridRecord]: TdxCustomGridRowHelper
      read GetRecordHelper;
    ...
    property ShowExpandButtonsForEmptyDetails: Boolean
      read GetShowExpandButtonsForEmptyDetails;
    ...
    property ThemedFooterItemTextColor: TColor
      read GetThemedFooterItemTextColor;
    property ThemedHeaderItemColor: TColor read GetThemedHeaderItemColor;
    property ThemedHeaderItemTextColor: TColor
      read GetThemedHeaderItemTextColor;
  end;

  TdxCustomGridTableViewItemPlaceControllerClass = class of
  ...
  protected
    ...
    function GetItemByColumn(Column: TcxGridColumn)
      : TdxGridTableViewColumnPlace; virtual;
  ...
  public
    ...
    property ItemsByColumn[Column: TcxGridColumn]: TdxGridTableViewColumnPlace
      read GetItemByColumn; default;
  ...
  public
    constructor Create(AController: TdxGridTableViewColumnPlaceController;
  ...
  protected
    ...
    function GetItemByColumn(Column: TcxGridColumn)
      : TdxGridTableViewColumnPlace; override;

    procedure AddItems; virtual;
    procedure ClearItems;
    function CreateItem(AColumn: TcxGridColumn)
      : TdxGridTableViewColumnPlace; virtual;
    function GetItemClass(AColumn: TcxGridColumn)
      : TdxGridTableViewColumnPlaceClass; virtual;

    function CalculateItemLeftBound(AnItem: TdxGridTableViewColumnPlace)
      : Integer; virtual;
  ...
  public
    ...
    property Items[Index: Integer]: TdxGridTableViewColumnPlace
  ...
  private
    FBuilder: TdxCustomGridViewBuilder;
    function GetReportItem(Row: TcxCustomGridRow; Column: TcxGridColumn)
      : TdxReportVisualItem;
    function GetReportRow(Index: Integer): TdxReportCell;
  ...
  public
    ...
    property Builder: TdxCustomGridViewBuilder read FBuilder;
    property ReportItems[Row: TcxCustomGridRow; Column: TcxGridColumn]
      : TdxReportVisualItem read GetReportItem;
    property ReportRowCount: Integer read GetReportRowCount;
    property ReportRows[Index: Integer]: TdxReportCell
      read GetReportRow; default;
    property ReportRowsByGridRow[Row: TcxCustomGridRow]: TdxReportCell
      read GetReportRowByGridRow;
  end;
  ...
  protected
    ...
    function GetItemPlaceControllerClass
      : TdxCustomGridTableViewItemPlaceControllerClass; virtual;
    function MapStyleBackgroundBitmapIndex(AGridBackgroundBitmapIndex: Integer)
      : Integer; override;
    ...
    property ItemPlaceController: TdxCustomGridTableViewItemPlaceController
      read FItemPlaceController;
    property ReportDataAdapter: TdxGridTableViewReportDataAdapter
      read FReportDataAdapter;
  public
    constructor Create(ABuilder: TdxCustomGridViewBuilder); override;
    destructor Destroy; override;
    ...
    { Footers }
    procedure DoInitializeFooterItem(AnItem: TAbstractdxReportCellData;
      AnIndex: Integer; AItem: TcxDataSummaryItem); virtual;
    procedure DoInitializeFooterRow(ARow: TdxReportCell); virtual;
    procedure DoReportLinkInitializeFooterItem
      (AnItem: TAbstractdxReportCellData; AnIndex: Integer); virtual;
    function GetFooterItemBounds(AnIndex: Integer): TRect; virtual;
    function GetFooterItemClass(AnIndex: Integer)
      : TdxReportCellTextClass; virtual;
    function GetFooterItemViewParams(AColumn: TcxGridColumn;
      AItem: TcxDataSummaryItem): TdxReportItemViewParams; virtual;

    { Group Footers }
    procedure DoInitializeGroupFooterHost(AnItem: TdxReportVisualItem;
    ...
    procedure DoInitializeGroupFooterItem(AnItem: TAbstractdxReportCellData;
      ARecord: TcxCustomGridRecord; AGroupLevel: Integer; const AValue: Variant;
      AItem: TcxDataSummaryItem); virtual;
    procedure DoInitializeGroupFooterRow(ARow: TdxReportCell;
      ARecord: TcxCustomGridRecord; AGroupLevel: Integer); virtual;
    procedure DoReportLinkInitializeGroupFooterItem
      (AnItem: TAbstractdxReportCellData; AColumn: TcxGridColumn;
      ARecord: TcxCustomGridRecord; AGroupLevel: Integer); virtual;
    function GetGroupFooterItemClass(AnIndex: Integer)
      : TdxReportCellTextClass; virtual;
    function GetGroupFooterItemBounds(AnIndex, AGroupLevel: Integer)
      : TRect; virtual;
    function GetGroupFooterItemViewParams(ARecord: TcxCustomGridRecord;
      AGroupLevel: Integer; AColumn: TcxGridColumn; AItem: TcxDataSummaryItem)
      : TdxReportItemViewParams; virtual;

    { Group Row }
    procedure DoInitializeGroupRowItem(AnItem: TAbstractdxReportCellData;
      ARow: TcxGridGroupRow; AIndex: Integer; const AText: string); virtual;
    procedure DoInitializeGroupRow(ARow: TdxReportCell;
      ARecord: TcxCustomGridRecord); virtual;
    function GetGroupRowClass: TdxReportCellTextClass; virtual;
    function GetGroupRowViewParams(ARecord: TcxCustomGridRecord;
      ALevel: Integer): TdxReportItemViewParams; virtual;

    { Group Row Separator - Office11 Grouping Style }
    procedure DoInitializeGroupRowSeparator(ASeparator
      : TAbstractdxReportCellData); virtual;
    ...
    { Headers }
    procedure DoInitializeHeaderItem(AnItem: TAbstractdxReportCellData;
      AnIndex: Integer); virtual;
    procedure DoInitializeHeaderRow(ARow: TdxReportCell); virtual;
    procedure DoReportLinkInitializeHeaderItem
      (AnItem: TAbstractdxReportCellData; AnIndex: Integer); virtual;
    function GetHeaderItemBounds(AnIndex: Integer): TRect; virtual;
    function GetHeaderItemClass(AnIndex: Integer)
      : TdxReportCellTextClass; virtual;
    function GetHeaderItemViewParams(AColumn: TcxGridColumn)
      : TdxReportItemViewParams; virtual;

    { Indents and Expand Buttons }
    function CreateIndent(AParent: TdxReportCell)
      : TdxReportCellExpandButton; virtual;
    ...
    procedure DoInitializeGroupRowIndent(AnIndent: TdxReportCellExpandButton;
      AnIndex, AnIndentCount: Integer; ARecord: TcxCustomGridRecord); virtual;
    procedure DoInitializeMasterDataRowIndent
      (AnIndent: TdxReportCellExpandButton; AnIndex, AnIndentCount: Integer;
      ARecord: TcxCustomGridRecord); virtual;
    procedure DoInitializeRowSeparatorIndent
      (AnIndent: TdxReportCellExpandButton; AnIndex, AnIndentCount: Integer;
      ARecord: TcxCustomGridRecord); virtual;
    function GetIndentClass: TdxReportCellExpandButtonClass; virtual;
    function GetIndentViewParams(ARecord: TcxCustomGridRecord;
      AnIndex, AnIndentCount: Integer; ANonRecordIndent: Boolean)
      : TdxReportItemViewParams; virtual;
    function HasExpandButton(ARecord: TcxCustomGridRecord): Boolean; virtual;

    { Items }
    procedure DoInitializeDataRow(ARow: TdxReportCell;
      ARecord: TcxCustomGridRecord); virtual;
    ...
    { Preview }
    procedure DoInitializePreview(APreview: TAbstractdxReportCellData;
      AColumn: TcxGridColumn; ARecord: TcxCustomGridRecord); virtual;
    ...
    procedure DoInitializeRowSeparator(ASeparator
      : TAbstractdxReportCellData); virtual;
    function GetRowSeparatorClass: TdxReportCellDataClass; virtual;

    function GetReportItem(ARow: TcxCustomGridRow; AColumn: TcxGridColumn)
      : TdxReportVisualItem;

    property AlignSummaryWithColumns: Boolean read GetAlignSummaryWithColumns;
    property ColumnCount: Integer read GetColumnCount;
    property Columns[Index: Integer]: TcxGridColumn read GetColumn;
    property DetailsLineHeight: Integer read FDetailsLineHeight
      write FDetailsLineHeight;
    property FooterLineHeight: Integer read FFooterLineHeight
      write FFooterLineHeight;
    property GroupFooterLineHeight: Integer read FGroupFooterLineHeight
      write FGroupFooterLineHeight;
    property GroupRowLineHeight: Integer read FGroupRowLineHeight
      write FGroupRowLineHeight;
    property GroupRowSeparatorColor: TColor read GetGroupRowSeparatorColor;
    property GroupRowSeparatorThickness: Integer
      read GetGroupRowSeparatorThickness;
    property HasPreview: Boolean read GetHasPreview;
    ...
    property RowHeights[Index: Integer]: Integer read GetRowHeight
      write SetRowHeight;
    property RowHeightsByRow[Row: TcxCustomGridRow]: Integer
      read GetRowHeightByRow write SetRowHeightByRow;
    property Rows[Index: Integer]: TcxCustomGridRow read GetRow;
    property RowSeparatorColor: TColor read GetRowSeparatorColor;
    property RowSeparatorThickness: Integer read GetRowSeparatorThickness;
  ...
  protected
    ...
    function GetFootersProducerClass
      : TdxGridTableViewFootersProducerClass; virtual;

    { Group Footer }
    procedure CreateGroupFooters(AGridRow: TcxCustomGridRow); virtual;
    function GetGroupFooterProducer
      : TdxGridTableViewGroupFooterProducer; virtual;
    function GetGroupFooterProducerClass
      : TdxGridTableViewGroupFooterProducerClass; virtual;

    { Header }
    procedure CreateHeader; virtual;
    function GetHeadersProducer: TdxGridTableViewHeadersProducer; virtual;
    function GetHeadersProducerClass
      : TdxGridTableViewHeadersProducerClass; virtual;

    { Rows }
    procedure CreateRow(AGridRow: TcxCustomGridRow;
      ARowIndex: Integer); virtual;
    procedure CreateRows; virtual;
    function GetRowProducer(AGridRow: TcxCustomGridRow)
      : TdxGridTableViewCustomDataRowProducer; virtual;
    function GetRowProducerClass(AGridRow: TcxCustomGridRow)
      : TdxGridTableViewCustomDataRowProducerClass; virtual;

    { Row Separators }
    procedure CreateRowSeparator(AGridRow: TcxCustomGridRow;
      AnIsLast: Boolean = False); virtual;
    function GetRowSeparatorProducer
      : TdxGridTableViewRowSeparatorProducer; virtual;
    function GetRowSeparatorProducerClass
      : TdxGridTableViewRowSeparatorProducerClass; virtual;
    function GetShowRowSeparators: Boolean; virtual;

    { GroupRow Separators }
    procedure CreateGroupRowSeparator(AGridRow: TcxGridGroupRow); virtual;
    function GetGroupRowSeparatorProducer
      : TdxGridTableViewGroupRowSeparatorProducer; virtual;
    function GetGroupRowSeparatorProducerClass
      : TdxGridTableViewGroupRowSeparatorProducerClass; virtual;
    ...
    property ProcessedView: TcxCustomGridView read GetProcessedView
      write SetProcessedView;
  public
    function Adapter: TdxGridTableViewAdapter; reintroduce; overload;
    class function AdapterClass: TdxGridViewAdapterClass; override;
  ...
  protected
    ...
    function GetBandHeaderViewParams(ABand: TcxGridBand)
      : TcxViewParams; virtual;
  ...
  public
    ...
    property FooterLineCount: Integer read GetFooterLineCount
      write FFooterLineCount;
    property RootBandCount: Integer read GetRootBandCount;
    property RootBands[Index: Integer]: TcxGridBand read GetRootBand;
    property ThemedBandHeaderItemColor: TColor
      read GetThemedBandHeaderItemColor;
    property ThemedBandHeaderItemTextColor: TColor
      read GetThemedBandHeaderItemTextColor;
  end;
  ...
  public
    ...
    property Controller: TdxCustomGridBandedTableViewItemPlace
      read GetController;
    property Formatter: TdxGridBandedTableViewFormatter read GetFormatter;
  end;

  TdxCustomGridBandedTableViewItemPlaceClass = class of
  ...
  protected
    ...
    function CalculateWidth: Integer; override;
    function GetItemClass(AColumn: TcxGridColumn)
      : TdxGridTableViewColumnPlaceClass; override;
  ...
  public
    ...
    property Controller: TdxGridBandedTableViewItemPlaceController
      read FController;
    property Formatter: TdxGridBandedTableViewFormatter read GetFormatter;
  ...
  private
    FChildItems: TList;
    function GetChildItem(Index: Integer)
      : TdxCustomGridBandedTableViewItemPlace;
  ...
  public
    ...
    property ChildItems[Index: Integer]: TdxCustomGridBandedTableViewItemPlace
      read GetChildItem;
  end;

  TdxGridBandedTableViewBottomItemPlace = class
    (TdxCustomGridBandedTableViewItemPlace)
  protected
  ...
  protected
    ...
    procedure AddItems; virtual;
    procedure ClearItems;
    function CreateItem(ABand: TcxGridBand)
      : TdxCustomGridBandedTableViewItemPlace; virtual;
    function GetItemClass(ABand: TcxGridBand)
      : TdxCustomGridBandedTableViewItemPlaceClass; virtual;
    procedure RefreshBottomItems;
    procedure RefreshItems;
    procedure RefreshRootItems;

    function CalculateHeight: Integer; virtual;
    function CalculateItemHeight(AnItem: TdxCustomGridBandedTableViewItemPlace)
      : Integer; virtual;
    function CalculateItemLeftBound
      (AnItem: TdxCustomGridBandedTableViewItemPlace): Integer; virtual;
    function CalculateItemTopBound
      (AnItem: TdxCustomGridBandedTableViewItemPlace): Integer; virtual;
  ...
  public
    ...
    function IndexOf(AnItem: TdxCustomGridBandedTableViewItemPlace)
      : Integer; overload;
    function IndexOf(ABand: TcxGridBand): Integer; overload;
    function RootIndexOf(AnItem: TdxCustomGridBandedTableViewItemPlace)
      : Integer; overload;
    function RootIndexOf(ABand: TcxGridBand): Integer; overload;

    property BottomItemCount: Integer read GetBottomItemCount;
    property BottomItems[Index: Integer]: TdxCustomGridBandedTableViewItemPlace
      read GetBottomItem;
    property Formatter: TdxGridBandedTableViewFormatter read GetFormatter;
    ...
    property Items[Index: Integer]: TdxCustomGridBandedTableViewItemPlace
      read GetItem; default;
    property ItemsByBand[Band: TcxGridBand]
      : TdxCustomGridBandedTableViewItemPlace read GetItemByBand;
    property LevelCount: Integer read GetLevelCount;
    property LevelHeights[Index: Integer]: Integer read GetLevelHeight
      write SetLevelHeight;
    property RootItemCount: Integer read GetRootItemCount;
    property RootItems[Index: Integer]: TdxCustomGridBandedTableViewItemPlace
      read GetRootItem;
  end;
  ...
  protected
    ...
    function GetItemPlaceControllerClass
      : TdxCustomGridTableViewItemPlaceControllerClass; override;
    ...
    property ItemPlaceController: TdxGridBandedTableViewItemPlaceController
      read GetItemPlaceController;
  public
    constructor Create(ABuilder: TdxCustomGridViewBuilder); override;
    destructor Destroy; override;
    ...
    { Bands }
    procedure DoInitializeBandItem(AnItem: TAbstractdxReportCellData;
      AnIndex: Integer); virtual;
    procedure DoInitializeBandRow(ARow: TdxReportCell); virtual;
    procedure DoReportLinkInitializeBandItem(AnItem: TAbstractdxReportCellData;
      AnIndex: Integer); virtual;
    function GetBandItemBounds(AnIndex: Integer): TRect; virtual;
    function GetBandItemClass(AnIndex: Integer)
      : TdxReportCellTextClass; virtual;
    function GetBandItemViewParams(ABand: TcxGridBand)
      : TdxReportItemViewParams; virtual;
  ...
  protected
    class function GridViewClass: TcxCustomGridViewClass; override;
  public
    function Adapter: TdxGridServerModeBandedTableViewAdapter;
  ...
  protected
    ...
    procedure DoInitializeRecord(ARecord
      : TdxReportWinExplorerViewRecord); virtual;
    function GetCaptionItemViewParams(ATableItem: TcxCustomGridTableItem;
      ARecord: TcxCustomGridRecord; AnIsPreview: Boolean = False)
      : TdxReportItemViewParams; virtual;
    ...
    function GetRecordViewParams(ARecord: TdxReportWinExplorerViewRecord)
      : TdxReportItemViewParams; virtual;
    function GetViewWidth: Integer; override;
  public
    ...
    property Records[Index: Integer]: TcxGridWinExplorerViewCustomRecord
      read GetRecord;
  end;
  ...
  protected
    ...
    function GetGroupViewParams(ARecord: TcxCustomGridRecord;
      ATableItem: TcxCustomGridTableItem): TcxViewParams; virtual;
    function IsGridItemCaption(AGridItem: TcxGridWinExplorerViewItem)
      : Boolean; virtual;
    function IsGridItemDescription(AGridItem: TcxGridWinExplorerViewItem)
      : Boolean; virtual;
    function GetContentViewParams(ARecord: TcxCustomGridRecord;
      ATableItem: TcxCustomGridTableItem; AIsDataCell: Boolean = False)
      : TcxViewParams; override;
  public
  ...
  protected
    ...
    procedure CreateRecord(AGridRecord
      : TcxGridWinExplorerViewCustomRecord); virtual;
    procedure CreateRecords; virtual;
    procedure DoBuildViewBody; override;
    procedure DoResizeRecords; virtual;
    function GetRecordProducer(AGridRecord: TcxGridWinExplorerViewCustomRecord)
      : TdxGridWinExplorerViewRecordProducer; virtual;
    function GetRecordProducerClass(AGridRecord
      : TcxGridWinExplorerViewCustomRecord)
      : TdxGridViewRowProducerClass; virtual;
    function GridView: TcxGridWinExplorerView; reintroduce; overload;
    class function GridViewClass: TcxCustomGridViewClass; override;
    procedure InjectRecord(ARecord: TdxReportWinExplorerViewRecord;
      AParent: TdxReportCell; AIndex: Integer); virtual;
    procedure PlaceRecords; virtual;
    procedure ResizeGroups; virtual;
    procedure ResizeRecords; virtual;

    property Records[Index: Integer]: TdxReportWinExplorerViewRecord
      read GetRecord;
  ...
  protected
    ...
    procedure CheckNeedCategorySeparator(ANextLayer
      : TdxReportCardLayer); virtual;
    ...
    procedure InitAutoWidthItem(AnItem: TcxAutoWidthItem;
      var AAllFixed: Boolean);
    procedure PlaceSeparatorAndExcludeHeightFromHeight
      (var AValue: Integer); virtual;
    ...
    property InternalHeight: Integer read GetInternalHeight
      write SetInternalHeight;
    property InternalWidth: Integer read GetInternalWidth
      write SetInternalWidth;

    property NeedCategorySeparator: Boolean read FNeedCategorySeparator
      write FNeedCategorySeparator;
    property NeedLayerSeparator: Boolean read FNeedLayerSeparator
      write FNeedLayerSeparator;
  public
    constructor CreateEx(AParent: TdxReportCell;
      ABeginsLayerRow: TcxGridCardViewRow); virtual;
    destructor Destroy; override;
    procedure AdjustCellSides; virtual;
    function AddRow(AGridCardRow: TcxGridCardViewRow): TdxReportCardRow;
    function MeasureCaptionWidth(ACanvas: TdxPSReportRenderCustomCanvas)
      : Integer; virtual;
    function MeasureDataWidth(ACanvas: TdxPSReportRenderCustomCanvas): Integer;
    function MeasureLayerHeight(ACanvas: TdxPSReportRenderCustomCanvas;
      ACalculateLineHeight: Boolean; ABuilder: TdxGridCardViewBuilder)
      : Integer; virtual;
  ...
  protected
    ...
    procedure CheckNeedCategorySeparator(ANextLayer
      : TdxReportCardLayer); override;
    procedure PlaceSeparatorAndExcludeHeightFromHeight
      (var AValue: Integer); override;
  ...
  private
    ...
    procedure SetWidth(Value: Integer);
  protected
    procedure AdjustCellSides(AIsFirstItem, AIsLastItem, AIsLeftItem,
      AIsRightItem: Boolean); virtual;
    procedure CreateItems(ABuilder: TdxGridCardViewBuilder); virtual;
    function MeasureCaptionWidth(ACanvas
      : TdxPSReportRenderCustomCanvas): Integer;
    function MeasureDataWidth(ACanvas: TdxPSReportRenderCustomCanvas): Integer;
  ...
  public
    constructor CreateEx(AParent: TdxReportCell;
      AGridCardRow: TcxGridCardViewRow); virtual;

    function MeasureHeight(ACanvas: TdxPSReportRenderCustomCanvas;
      ACalculateLineHeight: Boolean; ABuilder: TdxGridCardViewBuilder): Integer;
      reintroduce; overload;
    function MeasureWidth(ACanvas: TdxPSReportRenderCustomCanvas)
      : Integer; override;
  ...
  TdxGridCardShadowPosition = (cspTopLeft, cspTopRight, cspBottomRight,
    cspBottomLeft);
  ...
  public
    constructor CreateEx(AParent: TdxReportCell;
      AGridRecord: TcxGridCustomLayoutRecord); virtual;
  end;
  ...
  protected
    ...
    procedure AdjustWidth(ACanvas: TdxPSReportRenderCustomCanvas);
      virtual; abstract;
    function MeasureCaptionWidth(ACanvas: TdxPSReportRenderCustomCanvas)
      : Integer; virtual; abstract;
    procedure SetCaptionWidth(ACanvas: TdxPSReportRenderCustomCanvas;
      ALayer, AValue, AMaxValue: Integer; ACaptionAutoWidths: Boolean); virtual;
    // layers
  ...
  public
    ...
    property Height: Integer read GetHeight write SetHeight;
    property LayerCaptionWidth: Integer read FLayerCaptionWidth
      write FLayerCaptionWidth;
    property LayerCount: Integer read GetLayerCount;
    property LayerHeights[Index: Integer]: Integer read GetLayerHeight
      write SetLayerHeight;
    ...
    property LayerWidths[Index: Integer]: Integer read GetLayerWidth
      write SetLayerWidth;
    property RowCount: Integer read GetRowCount;
    property RowHeight[AIndex: Integer]: Integer read GetRowHeight
      write SetRowHeight;
    property ShadowColor: TColor read FShadowColor write FShadowColor
      default clBlack;
    property ShadowDepth: Integer read FShadowDepth write SetShadowDepth2
      default dxDefaultCardsShadowDepth;
    property ShadowPosition: TdxGridCardShadowPosition read FShadowPosition
      write FShadowPosition default cspBottomRight;
  ...
  protected
    ...
    function MeasureCaptionWidth(ACanvas: TdxPSReportRenderCustomCanvas)
      : Integer; override;
    function MeasureDataWidth(ACanvas: TdxPSReportRenderCustomCanvas)
      : Integer; virtual;
    procedure SizeChanged; override;
  end;
  ...
  protected
    ...
    function GetLayerByAbsoluteRowIndex(var AIndex: Integer)
      : TdxReportCardLayer;
    ...
    function MeasureCaptionWidth(ACanvas: TdxPSReportRenderCustomCanvas)
      : Integer; override;
    procedure SetCaptionWidth(ACanvas: TdxPSReportRenderCustomCanvas;
      ALayer, AValue, AMaxValue: Integer; ACaptionAutoWidth: Boolean); override;
  ...
  public
    procedure ExpandAllRows(AnOptionsExpanding
      : TdxGridReportLinkOptionsExpanding; ARecursive: Boolean); override;
  end;
  ...
  protected
    ...
    function GetCardViewParams(ARecord: TcxCustomGridRecord)
      : TcxViewParams; virtual;
  ...
  public
    ...
    function GetRecordClass(AGridRecord: TcxGridCustomLayoutRecord)
      : TdxReportCustomLayoutRecordClass; virtual;
    procedure DoInitializeRecord(ARecord: TdxReportCustomLayoutRecord;
      AGridRecord: TcxGridCustomLayoutRecord); virtual;
  ...
  protected
    ...
    function GetContentBackgroundBitmapStyleIndex
      (ATableItem: TcxCustomGridTableItem): Integer; override;
  ...
  public
    ...
    { Cards }
    procedure DoInitializeRecord(ARecord: TdxReportCustomLayoutRecord;
      AGridRecord: TcxGridCustomLayoutRecord); override;
    function GetRecordClass(AGridRecord: TcxGridCustomLayoutRecord)
      : TdxReportCustomLayoutRecordClass; override;
    function GetCardViewParams(ARecord: TcxCustomGridRecord)
      : TdxReportItemViewParams; virtual;
    ...
    procedure DoReportLinkInitializeCardRowCaption(AnItem: TdxReportCellText;
      ACardRow: TcxGridCardViewRow; AGridCard: TcxGridCard); virtual;
    function GetCardRowCaptionClass(ACardRow: TcxGridCardViewRow)
      : TdxReportCellTextClass; virtual;
    ...
    { Cards Data }
    procedure DoReportLinkInitializeCardRowData
      (AnItem: TAbstractdxReportCellData; ACardRow: TcxGridCardViewRow;
      AGridCard: TcxGridCard); virtual;
    function GetItemViewParams(ATableItem: TcxCustomGridTableItem;
      ARecord: TcxCustomGridRecord; AnIsPreview: Boolean = False;
      AIsDataCell: Boolean = False): TdxReportItemViewParams; override;
  ...
  protected
    ...
    function GetRecordProducerClass
      : TdxGridCustomLayoutViewRecordProducerClass; virtual;

    function CreateRecord(AParent: TdxReportCell;
      ARecord: TcxGridCustomLayoutRecord): TdxReportCell; virtual;

    property RecordCount: Integer read GetRecordCount;
    property Records[Index: Integer]: TdxReportCustomLayoutRecord
      read GetRecord;
  public
    constructor Create(AReportLink: TdxGridReportLink;
      AMasterBuilder: TdxCustomGridViewBuilder;
  ...
  protected
    ...
    function GetRecordProducer: TdxGridCardViewCardsRowProducer;
      reintroduce; overload;
    function GetRecordProducerClass
      : TdxGridCustomLayoutViewRecordProducerClass; override;
  ...
  protected
    function CreateGraphic(AGraphicClass: TGraphicClass; AWidth: Integer)
      : TGraphic;
    function GetCanUseOnEveryPageMode: Boolean; override;
  public
  ...
  protected
    ...
    procedure DoInitializeChartItem
      (AItem: TdxReportCellDpiAwareGraphic); virtual;
    procedure DoReportLinkInitializeChartItem
      (AItem: TdxReportCellGraphic); virtual;
  ...
  protected
    ...
    procedure AddMasterIndents(AMasterFormatter: TdxCustomGridViewFormatter;
      AMasterAdapter: TdxCustomGridViewAdapter; ALevel: Integer;
      var ALeftPos: Integer);
    ...
    function CreateDetailsSeparator(AParent: TdxReportCell)
      : TdxReportCellBox; virtual;
    function CreateMasterIndent(AParent: TdxReportCell)
      : TdxReportCellExpandButton; virtual;
    procedure CreateRow; virtual;
    procedure CreateRowHost(const AHostInfo: TdxGridAttributeHostInfo); virtual;
    function DoesItemParticipateInRowAutoHeightCalculation
      (AnItem: TdxReportVisualItem): Boolean; virtual;
    function GetDetailsSeparatorClass: TdxReportCellBoxClass; virtual;
    function GetMasterIndentClass: TdxReportCellExpandButtonClass; virtual;
  ...
  public
    ...
    property MasterBuilders[Index: Integer]: TdxCustomGridViewBuilder
      read GetMasterBuilder;
    property MasterIndentCount: Integer read GetMasterIndentCount;
    property MasterIndents[Index: Integer]: TdxReportCellBox
      read GetMasterIndent;
  ...
  protected
    ...
    function CreateItem(AParent: TdxReportCell)
      : TAbstractdxReportCellData; virtual;
  ...
  TdxGridViewDetailsTopSeparatorProducer = class
    (TdxGridViewDetailsSeparatorProducer)
  protected
    procedure InitializeDetailsSeparator(AFormatter: TdxCustomGridViewFormatter;
      ASeparator: TdxReportCellBox;
      ASeparatorKind: TdxVerticalDetailsSeparatorKind); override;
  end;

  TdxGridViewDetailsBottomSeparatorProducer = class
    (TdxGridViewDetailsSeparatorProducer)
  protected
    procedure InitializeDetailsSeparator(AFormatter: TdxCustomGridViewFormatter;
      ASeparator: TdxReportCellBox;
  ...
  protected
    ...
    function CreateSubItem(AnIndex: Integer; AParent: TdxReportCell)
    ...
    procedure InitializeSubItem(ASubItem: TAbstractdxReportCellData;
    ...
    function GetSubItemClass(Index: Integer): TdxReportCellDataClass;
      virtual; abstract;
  ...
  public
    ...
    property SubItemClasses[Index: Integer]: TdxReportCellDataClass
      read GetSubItemClass;
    property SubItemCount: Integer read GetSubItemCount;
    property SubItems[Index: Integer]: TdxReportVisualItem
  ...
  protected
    ...
    function CreateIndent(AnIndex: Integer; AParent: TdxReportCell)
      : TdxReportCellExpandButton; virtual;
    procedure InitializeIndent(AIndent: TdxReportCellExpandButton;
      AIndex: Integer); virtual;
  ...
  TdxCustomGridTableViewRowSeparatorProducer = class
    (TdxGridTableViewCustomDataRowProducer)
  protected
    procedure InitializeIndent(AIndent: TdxReportCellExpandButton;
      AIndex: Integer); override;
  ...
  protected
    ...
    procedure CalculateRowAutoHeight; override;
    function DoesItemParticipateInRowAutoHeightCalculation
      (AnItem: TdxReportVisualItem): Boolean; override;
    function CreatePreview(AParent: TdxReportCell)
      : TdxReportVisualItem; virtual;
  ...
  public
    ...
    property PreviewItem: TdxReportVisualItem read FPreviewItem;
    // TAbstractdxReportCellData read FPreviewItem;
  ...
  TdxGridTableViewGroupRowProducer = class
    (TdxGridTableViewCustomDataRowProducer)
  private
  ...
  protected
    ...
    function AddSummaryGroupInfo(AItem: TcxDataSummaryItem;
      const ADisplayText: string): Boolean;
    procedure AddSubItems(AParent: TdxReportCell); override;
  ...
  public
    ...
    function Produce(AHostInfo: TdxGridAttributeHostInfo;
      AGridRow: TcxCustomGridRow; AGridRowIndex: Integer)
      : TdxReportCell; override;

    property SummaryItemInfos[Index: Integer]: TcxGridSummaryItemInfo
      read GetSummaryItemInfo;
  end;
  ...
  private
    ...
    function GetSubItemInfo(AIndex: Integer)
      : TdxGridTableViewGroupFooterSubItemInfo;
  protected
    procedure AddSubItems(AParent: TdxReportCell); override;
    procedure CalculateRowAutoHeight; override;
    procedure CalculateSubItemPosition(AIndex: Integer;
      out AColIndex, ARowIndex: Integer);
    function CanCreateSubItem(ASummaryItem: TcxDataSummaryItem)
      : Boolean; virtual;
    ...
    procedure InitializeSubItem(ASubItem: TAbstractdxReportCellData;
      AIndex: Integer); override;
    function GetAutoHeight: Boolean; override;
    function GetCorrectRowIndex(AGridRow: TcxCustomGridRow;
      AGroupLevel: Integer): Integer;
    function GetHasSubItem(Index: Integer): Boolean; override;
    function GetIndentCount: Integer; override;
    ...
    property SubItemInfos[AIndex: Integer]
      : TdxGridTableViewGroupFooterSubItemInfo read GetSubItemInfo;
  public
    function Produce(AHostInfo: TdxGridAttributeHostInfo;
  ...
  protected
    ...
    procedure CalculateRowHeight; override;
    function CreateRecord(AParent: TdxReportCell;
      AGridRecord: TcxGridWinExplorerViewCustomRecord)
      : TdxReportWinExplorerViewRecord; virtual;
  ...
  public
    ...
    function Builder: TdxGridWinExplorerViewBuilder; reintroduce; overload;
    function Formatter: TdxGridWinExplorerViewFormatter; reintroduce; overload;
    function Produce(AHostInfo: TdxGridAttributeHostInfo; ARowHeight: Integer)
      : TdxReportCell; reintroduce; virtual;
  end;

  TdxGridWinExplorerViewDataRecordProducer = class
  ...
  TdxGridWinExplorerViewGroupRecordProducer = class
    (TdxGridWinExplorerViewRecordProducer)
  protected
    procedure CreateRecordSubItems(ARecord: TdxReportWinExplorerViewRecord;
      ARecordViewInfo: TcxGridWinExplorerViewCustomRecordViewInfo); override;
  ...
  public
    ...
    function CreateRecord(AParent: TdxReportCell;
      AGridRecord: TcxGridCustomLayoutRecord)
      : TdxReportCustomLayoutRecord; virtual;
    function Produce(AHostInfo: TdxGridAttributeHostInfo; ARowHeight: Integer)
      : TdxReportCell; reintroduce; virtual;
    procedure InjectRecord(ARecord: TdxReportCustomLayoutRecord;
      AIndex: Integer); virtual;
  end;
  ...
  published
    ...
    property Depth: TdxGridCardShadowDepth read FDepth write SetDepth
      default dxDefaultCardsShadowDepth;
    property Position: TdxGridCardShadowPosition read FPosition
      write SetPosition default cspBottomRight;
  end;
  ...
  protected
    property AutoWidth: Boolean read FAutoWidth write SetAutoWidth
      default False;
    property InterRecordsSpaceHorz: Integer read FInterRecordsSpaceHorz
      write SetInterRecordsSpaceHorz default 4;
    property InterRecordsSpaceVert: Integer read FInterRecordsSpaceVert
      write SetInterRecordsSpaceVert default 4;
  public
    procedure Assign(Source: TPersistent); override;
  ...
  published
    ...
    property InterCardsSpaceHorz: Integer read GetInterCardsSpaceHorz
      write SetInterCardsSpaceHorz default 4;
    property InterCardsSpaceVert: Integer read GetInterCardsSpaceVert
      write SetInterCardsSpaceVert default 4;
    property KeepSameHeight: Boolean read FKeepSameHeight
      write SetKeepSameHeight default True;
    property KeepSameWidth: Boolean read FKeepSameWidth write SetKeepSameWidth
      default True;
    property RowBordersHorz: Boolean read FRowBordersHorz
      write SetRowBordersHorz default False;
    property RowBordersVert: Boolean read FRowBordersVert
      write SetRowBordersVert default False;
    property Shadow: TdxGridReportLinkCardsShadow read GetShadow
      write SetShadow;
  end;
  ...
  public
    ...
    function SupportsGraphicClass(AGraphicClass: TGraphicClass): Boolean;
      virtual; // excluding TIcon
  ...
  TdxGridReportLinkOptionsDetailsClass = class of
  ...
  public
    ...
    procedure RestoreDefaults; override;
  published
    property OnlyFocusedView: Boolean read FOnlyFocusedView
      write SetOnlyFocusedView default False;
    property StartFromFocusedView: Boolean read FStartFromFocusedView
      write SetStartFromFocusedView default False;
  end;
  ...
  public
    ...
    property ReportLink: TdxGridReportLink read GetReportLink;
  published
    property ExpandCards: Boolean read FExpandCards write SetExpandCards
      default False;
    property ExpandGroupRows: Boolean read FExpandGroupRows
      write SetExpandGroupRows default False;
    property ExpandMasterRows: Boolean read FExpandMasterRows
      write SetExpandMasterRows default False;
  end;
  ...
  public
    ...
    property ReportLink: TdxGridReportLink read GetReportLink;
  published
    property ConsumeSelectionStyle: Boolean read FConsumeSelectionStyle
      write SetConsumeSelectionStyle default False;
  ...
  public
    ...
    procedure RestoreDefaults; override;
  published
    property RiseActiveLevelOntoTop: Boolean read FRiseActiveLevelOntoTop
      write SetRiseActiveLevelOntoTop default True;
    property SkipEmptyViews: Boolean read FSkipEmptyViews
      write SetSkipEmptyViews default True;
    property Unwrap: Boolean read FUnwrap write SetUnwrap default False;
    property UnwrapTopLevel: Boolean read FUnwrapTopLevel
      write SetUnwrapTopLevel default True;
  end;
  ...
  public
    ...
    function HasInstalledAttribute(AnAttribute: TdxGridAttributeClass)
      : Boolean; virtual;
  ...
  published
    ...
    property Column;
    property Custom;
    property OneGroupPerPage: Boolean read FOneGroupPerPage
      write SetOneGroupPerPage default False;
    property Row;
    property TopLevelGroup: Boolean read FTopLevelGroup write SetTopLevelGroup
      default False;
  end;
  ...
  TdxGridAttributeHostInfoServicesClass = class of
  ...
  protected
    ...
    property ActiveViewHelper: TdxCustomGridViewHelperClass
      read GetActiveViewHelper;
    property OptionsOnEveryPage: TdxGridReportLinkOptionsOnEveryPage
      read GetOptionsOnEveryPage;
  ...
  public
    ...
    property BandHeadersHostInfo: TdxGridAttributeHostInfo
      read GetBandHeadersHostInfo;
    property CanUseBandHeadersOnEveyPage: Boolean
      read GetCanUseBandHeadersOnEveyPage;
    property CanUseCaptionOnEveryPage: Boolean read GetCanUseCaptionOnEveryPage;
    property CanUseFilterBarOnEveryPage: Boolean
      read GetCanUseFilterBarOnEveryPage;
    ...
    property FilterBarHostInfo: TdxGridAttributeHostInfo
      read GetFilterBarHostInfo;
    ...
    property IsInconsistentBandHeadersState: Boolean
      read GetIsInconsistentBandHeadersState;
    property IsInconsistentFilterBarState: Boolean
      read GetIsInconsistentFilterBarState;
    property IsInconsistentFootersState: Boolean
      read GetIsInconsistentFootersState;
    property IsInconsistentHeadersState: Boolean
      read GetIsInconsistentHeadersState;
    property IsInconsistentState: Boolean read GetIsInconsistentState;
    property LevelSeparatorBottomHostInfo: TdxGridAttributeHostInfo
      read GetLevelSeparatorBottomHostInfo;
    property LevelSeparatorTopHostInfo: TdxGridAttributeHostInfo
      read GetLevelSeparatorTopHostInfo;
    property PageDetailsHostInfo: TdxGridAttributeHostInfo
      read FPageDetailsHostInfo;
    property PageFootersHostInfo: TdxGridAttributeHostInfo
      read FPageFootersHostInfo;
    property PageHeadersHostInfo: TdxGridAttributeHostInfo
      read FPageHeadersHostInfo;
    property ReportLink: TdxGridReportLink read FReportLink;
  end;
  ...
  public
    ...
    procedure GetBandHeaderParams(ABand: TcxGridBand;
      out AParams: TcxViewParams); virtual;
    procedure GetCaptionParams(ATabLevel: TcxGridLevel;
      out AParams: TcxViewParams); virtual;
    procedure GetCardCaptionRowParams(ARecord: TcxCustomGridRecord;
      AItem: TcxCustomGridTableItem; out AParams: TcxViewParams); virtual;
    procedure GetCardRowCaptionParams(ARecord: TcxCustomGridRecord;
      AItem: TcxCustomGridTableItem; out AParams: TcxViewParams); virtual;
    procedure GetContentParams(ARecord: TcxCustomGridRecord;
      AItem: TcxCustomGridTableItem; out AParams: TcxViewParams); virtual;
    procedure GetFilterBarParams(out AParams: TcxViewParams); virtual;
    procedure GetFooterParams(ARecord: TcxCustomGridRecord;
      AGroupLevel: Integer; AItem: TcxGridColumn;
      out AParams: TcxViewParams); virtual;
    ...
    property ReportLink: TdxGridReportLink read GetReportLink;
  published
    property BandHeader: TcxStyle Index vspsGridBandHeader read GetValue
      write SetValue;
    property Caption: TcxStyle Index vspsGridCaption read GetValue
      write SetValue;
    property CardCaptionRow: TcxStyle Index vspsGridCardCaptionRow read GetValue
      write SetValue;
    property CardRowCaption: TcxStyle Index vspsGridCardRowCaption read GetValue
      write SetValue;
    property Content: TcxStyle Index vspsGridContent read GetValue
      write SetValue;
    property ContentEven: TcxStyle Index vspsGridContentEven read GetValue
      write SetValue;
    property ContentOdd: TcxStyle Index vspsGridContentOdd read GetValue
      write SetValue;
    property FilterBar: TcxStyle Index vspsGridFilterBar read GetValue
      write SetValue;
    ...
    property Preview: TcxStyle Index vspsGridPreview read GetValue
      write SetValue;
    property Selection: TcxStyle Index vspsGridSelection read GetValue
      write SetValue;
    property StyleSheet;
  end;
  ...
  published
    property Styles: TdxGridReportLinkStyles read GetStylesValue
  ...
  TdxGridGetCustomPageBreaksEvent = procedure(Sender: TdxGridReportLink)
    of object;
  ...
  TdxGridReportLinkCustomDrawBandCellEvent = procedure
    (Sender: TdxGridReportLink; ACanvas: TCanvas; AView: TcxGridBandedTableView;
    ABand: TcxGridBand; AnItem: TdxReportCellString; var ADone: Boolean)
    of object;
  ...
  TdxGridReportLinkCustomDrawCardRowCaptionCellEvent = procedure
    (Sender: TdxGridReportLink; ACanvas: TCanvas; AView: TcxGridCardView;
    ACard: TcxGridCard; ARow: TcxGridCardViewRow; AnItem: TdxReportCellString;
    var ADone: Boolean) of object;

  TdxGridReportLinkCustomDrawCardRowDataCellEvent = procedure
    (Sender: TdxGridReportLink; ACanvas: TCanvas; AView: TcxGridCardView;
    ACard: TcxGridCard; ARow: TcxGridCardViewRow;
    AnItem: TAbstractdxReportCellData; var ADone: Boolean) of object;

  TdxGridReportLinkCustomDrawFilterBarEvent = procedure
  ...
  TdxGridReportLinkCustomDrawFooterCellEvent = procedure
  ...
  TdxGridReportLinkCustomDrawHeaderCellEvent = procedure
    (Sender: TdxGridReportLink; ACanvas: TCanvas; AView: TcxGridTableView;
    AColumn: TcxGridColumn; AnItem: TdxReportCellString; var ADone: Boolean)
    of object;

  TdxGridReportLinkCustomDrawLevelCaptionEvent = procedure
    (Sender: TdxGridReportLink; ACanvas: TCanvas; AView: TcxCustomGridView;
    AnItem: TdxReportCellString; var ADone: Boolean) of object;

  { Initializtion Events }

  TdxGridReportLinkInitializeBandCellEvent = procedure
    (Sender: TdxGridReportLink; AView: TcxGridBandedTableView;
    ABand: TcxGridBand; AnItem: TdxReportCellString) of object;
  ...
  TdxGridReportLinkInitializeCardRowCaptionCellEvent = procedure
    (Sender: TdxGridReportLink; AView: TcxGridCardView; ACard: TcxGridCard;
    ARow: TcxGridCardViewRow; AnItem: TdxReportCellString) of object;

  TdxGridReportLinkInitializeCardRowDataCellEvent = procedure
    (Sender: TdxGridReportLink; AView: TcxGridCardView; ACard: TcxGridCard;
    ARow: TcxGridCardViewRow; AnItem: TAbstractdxReportCellData) of object;

  TdxGridReportLinkInitializeChartCellEvent = procedure
    (Sender: TdxGridReportLink; AView: TcxGridChartView;
    AnItem: TdxReportCellGraphic) of object;

  TdxGridReportLinkInitializeFilterBarEvent = procedure
    (Sender: TdxGridReportLink; AView: TcxCustomGridTableView;
    AnItem: TdxReportCellString) of object;

  TdxGridReportLinkInitializeFooterCellEvent = procedure
    (Sender: TdxGridReportLink; AView: TcxGridTableView;
    ARecord: TcxCustomGridRecord; AColumn: TcxGridColumn; ALevel: Integer;
    AnItem: TdxReportCellString) of object;

  TdxGridReportLinkInitializeHeaderCellEvent = procedure
    (Sender: TdxGridReportLink; AView: TcxGridTableView; AColumn: TcxGridColumn;
    AnItem: TdxReportCellString) of object;

  TdxGridReportLinkInitializeLevelCaptionEvent = procedure
  ...
  strict private
    ...
    FOnCustomDrawCardRowCaptionCell
      : TdxGridReportLinkCustomDrawCardRowCaptionCellEvent;
    FOnCustomDrawCardRowDataCell
      : TdxGridReportLinkCustomDrawCardRowDataCellEvent;
    ...
    FOnInitializeCardRowCaptionCell
      : TdxGridReportLinkInitializeCardRowCaptionCellEvent;
    FOnInitializeCardRowDataCell
    ...
    function GetOptionsView: TdxGridReportLinkOptionsView;
    function GetReportDataCellByGridColumn(AColumn: TcxGridColumn)
      : TAbstractdxReportCellData;
    function GetReportRow(Index: Integer): TdxReportCell;
    function GetReportRowByGridRecord(GridRecord: TcxCustomGridRecord)
      : TdxReportCell;
    function GetReportRowCount: Integer;
    function GetStyles: TdxGridReportLinkStyles;
    procedure SetOnCustomDrawBandCell
      (Value: TdxGridReportLinkCustomDrawBandCellEvent);
    procedure SetOnCustomDrawCell(Value: TdxGridReportLinkCustomDrawCellEvent);
    procedure SetOnCustomDrawCardRowCaptionCell
      (Value: TdxGridReportLinkCustomDrawCardRowCaptionCellEvent);
    procedure SetOnCustomDrawCardRowDataCell
      (Value: TdxGridReportLinkCustomDrawCardRowDataCellEvent);
    procedure SetOnCustomDrawFilterBar
      (Value: TdxGridReportLinkCustomDrawFilterBarEvent);
    procedure SetOnCustomDrawFooterCell
      (Value: TdxGridReportLinkCustomDrawFooterCellEvent);
    procedure SetOnCustomDrawHeaderCell
      (Value: TdxGridReportLinkCustomDrawHeaderCellEvent);
    procedure SetOnCustomDrawLevelCaption
      (Value: TdxGridReportLinkCustomDrawLevelCaptionEvent);
  ...
  protected
    ...
    function NeedExpandGroups(AGridView: TcxCustomGridView;
      ARecursive: Boolean = True): Boolean;
    ...
    procedure DoCustomDrawCell(ACanvas: TCanvas; AView: TcxCustomGridTableView;
      ARecord: TcxCustomGridRecord; AColumn: TcxGridColumn;
      AnItem: TAbstractdxReportCellData; var ADone: Boolean); dynamic;
    procedure DoCustomDrawFilterBar(ACanvas: TCanvas;
      AView: TcxCustomGridTableView; AnItem: TdxReportCellString;
    ...
    procedure DoCustomDrawHeaderCell(ACanvas: TCanvas; AView: TcxGridTableView;
      ...
      var ADone: Boolean); dynamic;
    procedure DoCustomDrawLevelCaption(ACanvas: TCanvas;
      AView: TcxCustomGridView; AnItem: TdxReportCellString;
      var ADone: Boolean); dynamic;
    procedure DoGetCellHeight(AView: TcxCustomGridTableView;
    ...
    procedure DoInitializeBandCell(AView: TcxGridBandedTableView;
      ABand: TcxGridBand; AnItem: TdxReportCellString); dynamic;
    procedure DoInitializeCardRowCaptionCell(AView: TcxGridCardView;
      ACard: TcxGridCard; ARow: TcxGridCardViewRow;
      AnItem: TdxReportCellString); dynamic;
    procedure DoInitializeCardRowDataCell(AView: TcxGridCardView;
      ACard: TcxGridCard; ARow: TcxGridCardViewRow;
      AnItem: TAbstractdxReportCellData); dynamic;
    procedure DoInitializeCell(AView: TcxCustomGridTableView;
      ARecord: TcxCustomGridRecord; AColumn: TcxGridColumn;
      AnItem: TAbstractdxReportCellData); dynamic;
    procedure DoInitializeChartCell(AView: TcxGridChartView;
      AnItem: TdxReportCellGraphic); dynamic;
    procedure DoInitializeFilterBar(AView: TcxCustomGridTableView;
      AnItem: TdxReportCellString); dynamic;
    procedure DoInitializeFooterCell(AView: TcxGridTableView;
      ARecord: TcxCustomGridRecord; AColumn: TcxGridColumn; ALevel: Integer;
      AnItem: TdxReportCellString); dynamic;
    procedure DoInitializeHeaderCell(AView: TcxGridTableView;
      AColumn: TcxGridColumn; AnItem: TdxReportCellString); dynamic;
    procedure DoInitializeLevelCaption(AView: TcxCustomGridView;
      AnItem: TdxReportCellString); dynamic;

    procedure CreateOptions; override;
    procedure DestroyOptions; override;
    function GetOptionsCardsClass: TdxGridReportLinkOptionsCardsClass; virtual;
    function GetOptionsChartsClass
      : TdxGridReportLinkOptionsChartsClass; virtual;
    function GetOptionsDetailsClass
      : TdxGridReportLinkOptionsDetailsClass; virtual;
    function GetOptionsExpandingClass
      : TdxCustomReportLinkOptionsExpandingClass; override;
    function GetOptionsFormattingClass
      : TdxCustomReportLinkOptionsFormattingClass; override;
    function GetOptionsLevelsClass
      : TdxGridReportLinkOptionsLevelsClass; virtual;
    function GetOptionsOnEveryPageClass
      : TdxCustomTableControlReportLinkOptionsOnEveryPageClass; override;
    function GetOptionsPaginationClass
      : TdxCustomReportLinkOptionsPaginationClass; override;
    function GetOptionsPreviewClass
      : TdxCustomTableControlReportLinkOptionsPreviewClass; override;
    function GetOptionsRefinementsClass
      : TdxCustomReportLinkOptionsRefinementsClass; override;
    function GetOptionsSelectionClass
      : TdxCustomTableControlReportLinkOptionsSelectionClass; override;
    ...
    procedure BuildView(AMasterBuilder: TdxCustomGridViewBuilder;
    ...
    function CreateViewBuilder(AMasterBuilder: TdxCustomGridViewBuilder;
    ...
    procedure ForEachView(AMasterRow: TcxGridMasterDataRow;
      AProc: TdxGridViewProc);

    function GetItemCustomDrawInfo(AnItem: TdxReportVisualItem;
      out ADrawInfo: TdxGridCellCustomDrawInfo): TdxGridAttributeID; virtual;
    ...
    function CanAttributeBeUsedOnEveryPage(AnAttribute
      : TdxGridAttributeClass): Boolean;
    function IsAttributeUsedOnEveryPage(AnAttribute
      : TdxGridAttributeClass): Boolean;
    ...
    property ActiveViewHelper: TdxCustomGridViewHelperClass
      read GetActiveViewHelper;
    property ActiveViewMasterRow: TcxGridMasterDataRow
  ...
  public
    ...
    // list of TcxCustomGridRecord

    procedure AddHorizontalPageBreak(AGridColumn: TcxGridColumn); overload;
    procedure AddHorizontalPageBreak(AGridColumns: TList); overload;
    // list of TcxGridColumn
    procedure AddHorizontalPageBreak(const AGridColumns
      : array of TcxGridColumn); overload;

    property Grid: TcxGrid read GetGrid;
    property DesignWindow: TdxfmGridReportLinkDesignWindow read GetDesignWindow;
    property ReportRows[Index: Integer]: TdxReportCell read GetReportRow;
    property ReportRowsByGridRecord[GridRow: TcxCustomGridRecord]: TdxReportCell
      read GetReportRowByGridRecord;
    property ReportRowCount: Integer read GetReportRowCount;
  published
    property Color;
    property Font;
    property OptionsCards: TdxGridReportLinkOptionsCards read FOptionsCards
      write SetOptionsCards;
    property OptionsCharts: TdxGridReportLinkOptionsCharts read FOptionsCharts
      write SetOptionsCharts;
    property OptionsDetails: TdxGridReportLinkOptionsDetails
      read FOptionsDetails write SetOptionsDetails;
    property OptionsExpanding: TdxGridReportLinkOptionsExpanding
      read GetOptionsExpanding write SetOptionsExpanding;
    property OptionsFormatting: TdxGridReportLinkOptionsFormatting
      read GetOptionsFormatting write SetOptionsFormatting;
    property OptionsLevels: TdxGridReportLinkOptionsLevels read FOptionsLevels
      write SetOptionsLevels;
    property OptionsOnEveryPage: TdxGridReportLinkOptionsOnEveryPage
      read GetOptionsOnEveryPage write SetOptionsOnEveryPage;
    property OptionsPagination: TdxGridReportLinkOptionsPagination
      read GetOptionsPagination write SetOptionsPagination;
    property OptionsPreview: TdxGridReportLinkOptionsPreview
      read GetOptionsPreview write SetOptionsPreview;
    property OptionsRefinements: TdxGridReportLinkOptionsRefinements
      read GetOptionsRefinements write SetOptionsRefinements;
    property OptionsSelection: TdxGridReportLinkOptionsSelection
      read GetOptionsSelection write SetOptionsSelection;
    property OptionsSize: TdxGridReportLinkOptionsSize read GetOptionsSize
    ...
    property OnCustomDrawBandCell: TdxGridReportLinkCustomDrawBandCellEvent
      read FOnCustomDrawBandCell write SetOnCustomDrawBandCell;
    property OnCustomDrawCell: TdxGridReportLinkCustomDrawCellEvent
      read FOnCustomDrawCell write SetOnCustomDrawCell;
    property OnCustomDrawCardRowCaptionCell
      : TdxGridReportLinkCustomDrawCardRowCaptionCellEvent
      read FOnCustomDrawCardRowCaptionCell
      write SetOnCustomDrawCardRowCaptionCell;
    property OnCustomDrawCardRowDataCell
      : TdxGridReportLinkCustomDrawCardRowDataCellEvent
      read FOnCustomDrawCardRowDataCell write SetOnCustomDrawCardRowDataCell;
    property OnCustomDrawFilterBar: TdxGridReportLinkCustomDrawFilterBarEvent
      read FOnCustomDrawFilterBar write SetOnCustomDrawFilterBar;
    property OnCustomDrawFooterCell: TdxGridReportLinkCustomDrawFooterCellEvent
      read FOnCustomDrawFooterCell write SetOnCustomDrawFooterCell;
    property OnCustomDrawHeaderCell: TdxGridReportLinkCustomDrawHeaderCellEvent
      read FOnCustomDrawHeaderCell write SetOnCustomDrawHeaderCell;
    property OnCustomDrawLevelCaption
      : TdxGridReportLinkCustomDrawLevelCaptionEvent
      read FOnCustomDrawLevelCaption write SetOnCustomDrawLevelCaption;
    property OnGetCellHeight: TdxGridReportLinkGetCellHeightEvent
      read FOnGetCellHeight write FOnGetCellHeight;
    property OnGetCustomPageBreaks: TdxGridGetCustomPageBreaksEvent
      read FOnGetCustomPageBreaks write FOnGetCustomPageBreaks;
    property OnInitializeBandCell: TdxGridReportLinkInitializeBandCellEvent
      read FOnInitializeBandCell write FOnInitializeBandCell;
    property OnInitializeCardRowCaptionCell
      : TdxGridReportLinkInitializeCardRowCaptionCellEvent
      read FOnInitializeCardRowCaptionCell
      write FOnInitializeCardRowCaptionCell;
    property OnInitializeCardRowDataCell
      : TdxGridReportLinkInitializeCardRowDataCellEvent
      read FOnInitializeCardRowDataCell write FOnInitializeCardRowDataCell;
    property OnInitializeCell: TdxGridReportLinkInitializeCellEvent
      read FOnInitializeCell write FOnInitializeCell;
    property OnInitializeChartCell: TdxGridReportLinkInitializeChartCellEvent
      read FOnInitializeChartCell write FOnInitializeChartCell;
    property OnInitializeFilterBar: TdxGridReportLinkInitializeFilterBarEvent
      read FOnInitializeFilterBar write FOnInitializeFilterBar;
    property OnInitializeFooterCell: TdxGridReportLinkInitializeFooterCellEvent
      read FOnInitializeFooterCell write FOnInitializeFooterCell;
    property OnInitializeHeaderCell: TdxGridReportLinkInitializeHeaderCellEvent
      read FOnInitializeHeaderCell write FOnInitializeHeaderCell;
    property OnInitializeLevelCaption
      : TdxGridReportLinkInitializeLevelCaptionEvent
      read FOnInitializeLevelCaption write FOnInitializeLevelCaption;
  end;
  ...
  published
    property CardBorders: Boolean read FCardBorders write SetCardBorders
      default False;
  ...
  public
    procedure Assign(Source: TPersistent); override;
    procedure GetCardShadowParams(ARecord: TcxCustomGridRecord;
      out AParams: TcxViewParams); virtual;
  published
    property CardShadow: TcxStyle index vsCardShadow read GetValue
      write SetValue;
    property OnGetCardShadowStyle: TcxGridGetRecordStyleEvent
      read FOnGetCardShadowStyle write FOnGetCardShadowStyle;
  end;
  ...
  TdxfmGridReportLinkDesignWindow = class
    ...
    procedure VendorLogoCustomDrawCell(Sender: TcxCustomGridTableView;
      ACanvas: TcxCanvas; AViewInfo: TcxGridTableDataCellViewInfo;
      var ADone: Boolean);
    procedure PreviewBandedViewCustomDrawColumnHeader(Sender: TcxGridTableView;
    ...
    procedure PreviewBandedViewCustomDrawFooterCell(Sender: TcxGridTableView;
      ACanvas: TcxCanvas; AViewInfo: TcxGridColumnHeaderViewInfo;
      var ADone: Boolean);
    ...
    procedure colSpeedCountCustomDrawCell(Sender: TcxCustomGridTableView;
      ACanvas: TcxCanvas; AViewInfo: TcxGridTableDataCellViewInfo;
      var ADone: Boolean);
  private
    ...
    procedure CustomDrawBorders(ACanvas: TcxCanvas;
      AViewInfo: TcxCustomGridCellViewInfo);
    procedure CustomDrawFooter(ACanvas: TcxCanvas; R: TRect;
      AViewInfo: TcxCustomGridCellViewInfo);
    procedure CustomDrawHeader(ACanvas: TcxCanvas; R: TRect;
      AViewInfo: TcxCustomGridCellViewInfo);
    procedure CustomDrawTextRect(ACanvas: TcxCanvas; R: TRect;
      AViewInfo: TcxCustomGridCellViewInfo; ABackgroundBitmap: TGraphic);
  ...
  protected
    ...
    procedure DoStyleChanged(const ACaption: string; AStyle: TcxStyle);
      override;
    ...
    property HasSelectedStylesWithAssignedBitmap: Boolean
      read GetHasSelectedStylesWithAssignedBitmap;
  public
    constructor Create(AOwner: TComponent); override;
    destructor Destroy; override;
...
uses
  ...
  dxDPIAwareUtils, dxPSdxSpreadSheetLnk,
  dxCoreGraphics, dxPSdxSpreadSheetLnkCore;

const
  SortOrderMap: array [TcxGridSortOrder] of TdxCellSortOrder = (csoNone, csoUp,
    csoDown);
...
type
  ...
  TcxDataControllerConditionalFormattingProviderAccess = class
    (TcxDataControllerConditionalFormattingProvider);

  TdxGridViewBuildersFactory = class(TdxCustomClassMaps)
  private
    function GetBuilderClass(GridView: TcxCustomGridView)
      : TdxGridViewBuilderClass;
  public
    class function Instance: TdxGridViewBuildersFactory; reintroduce; overload;
    function CreateViewAdapter(AMasterAdapter: TdxCustomGridViewAdapter;
      AGridView: TcxCustomGridView): TdxCustomGridViewAdapter;
    function CreateViewBuilder(AReportLink: TdxGridReportLink;
      AMasterBuilder: TdxCustomGridViewBuilder; AGridView: TcxCustomGridView)
      : TdxCustomGridViewBuilder;
    property BuilderClasses[GridView: TcxCustomGridView]
      : TdxGridViewBuilderClass read GetBuilderClass; default;
  end;

  TdxViewHelpersFactory = class(TdxCustomClassMaps)
  private
    function GetHelperClass(GridView: TcxCustomGridView)
      : TdxCustomGridViewHelperClass;
  public
    class function Instance: TdxViewHelpersFactory; reintroduce; overload;
    function HelperClassByItem(AnItem: TdxReportVisualItem)
      : TdxCustomGridViewHelperClass;
    property HelperClasses[GridView: TcxCustomGridView]
      : TdxCustomGridViewHelperClass read GetHelperClass; default;
  end;

  TdxRecordHelpersFactory = class(TdxCustomClassMaps)
  private
    function GetHelperClass(GridRecord: TcxCustomGridRecord)
      : TdxCustomGridRecordHelperClass;
  public
    class function Instance: TdxRecordHelpersFactory; reintroduce; overload;
    property HelperClasses[GridRecord: TcxCustomGridRecord]
      : TdxCustomGridRecordHelperClass read GetHelperClass; default;
  end;
...
begin
  case Index of
    0:
      Result := cxGetResourceString(@sdxCarManufacturerName1);
    1:
      Result := cxGetResourceString(@sdxCarManufacturerName2);
    2:
      Result := cxGetResourceString(@sdxCarManufacturerName3);
  else
...
begin
  case Index of
    0:
      Result := cxGetResourceString(@sdxCarManufacturerCountry1);
    1:
      Result := cxGetResourceString(@sdxCarManufacturerCountry2);
    2:
      Result := cxGetResourceString(@sdxCarManufacturerCountry3);
  else
...
begin
  case Index of
    0:
      Result := cxGetResourceString(@sdxCarModel1);
    1:
      Result := cxGetResourceString(@sdxCarModel2);
    2:
      Result := cxGetResourceString(@sdxCarModel3);
  else
...
procedure CustomGridCellPainter_DrawBorders
  (AInstance: TcxCustomGridCellPainter);
begin
...
function CustomGridCellViewInfo_GetPainterClass
  (AInstance: TcxCustomGridCellViewInfo): TcxCustomGridCellPainterClass;
begin
...
function CustomGridTableController_GetMultiSelect
  (AInstance: TcxCustomGridTableController): Boolean;
begin
...
function CustomGridTableFiltering_GetPosition
...
function CustomGridTableOptionsView_GetCellAutoHeight
...
function CustomGridView_GetBackgroundBitmaps(AInstance: TcxCustomGridView)
  : TcxCustomGridBackgroundBitmaps;
begin
  Result := TcxCustomGridViewAccess(AInstance).BackgroundBitmaps;
end;

function CustomGridView_GetDataController(AInstance: TcxCustomGridView)
  : TcxCustomDataController;
begin
  Result := TcxCustomGridViewAccess(AInstance).DataController;
end;

function CustomGridView_GetStyles(AInstance: TcxCustomGridView)
  : TcxCustomGridStyles;
begin
...
function GridColumn_DoCompareValuesForCellMerging(AInstance: TcxGridColumn;
  ...
  AProperties2: TcxCustomEditProperties; const AValue2: TcxEditValue): Boolean;
begin
  Result := TcxGridColumnAccess(AInstance).DoCompareValuesForCellMerging(ARow1,
    AProperties1, AValue1, ARow2, AProperties2, AValue2);
end;

{ GridMasterDataRow Helpers }

procedure GridMasterDataRow_DoExpand(AInstance: TcxGridMasterDataRow;
  ARecurse: Boolean);
begin
...
procedure GridTableViewInfo_CalculateExpandButtonParams
  (AInstance: TcxGridTableViewInfo);
begin
...
begin
  ...
  begin
    ...
    begin
      BandHeader := CreateStyle(dxPSCore.dxDefaultFixedColor,
        dxPSCore.dxPSDefaultFontColor);
      Caption := CreateStyle(dxPSCore.dxDefaultFixedColor,
        dxPSCore.dxPSDefaultFontColor);
      CardCaptionRow := CreateStyle(dxPSCore.dxDefaultFixedColor,
        dxPSCore.dxPSDefaultFontColor);
      CardRowCaption := CreateStyle(dxPSCore.dxDefaultFixedColor,
        dxPSCore.dxPSDefaultFontColor);
      Content := CreateStyle(dxPSCore.dxDefaultContentColor,
        dxPSCore.dxPSDefaultFontColor);
      ContentEven := CreateStyle(dxPSCore.dxDefaultContentColor,
        dxPSCore.dxPSDefaultFontColor);
      ContentOdd := CreateStyle(dxPSCore.dxDefaultContentColor,
        dxPSCore.dxPSDefaultFontColor);
      FilterBar := CreateStyle(clBtnShadow, dxPSCore.dxDefaultContentColor);
      Footer := CreateStyle(dxPSCore.dxDefaultFixedColor,
        dxPSCore.dxPSDefaultFontColor);
      Group := CreateStyle(dxPSCore.dxDefaultFixedColor,
        dxPSCore.dxPSDefaultFontColor);
      Header := CreateStyle(dxPSCore.dxDefaultFixedColor,
        dxPSCore.dxPSDefaultFontColor);
      Preview := CreateStyle(dxPSCore.dxDefaultContentColor,
        dxPSCore.dxPSDefaultFontColor);
      Selection := CreateStyle(dxPSCore.dxDefaultFixedColor,
        dxPSCore.dxPSDefaultFontColor);
    end;
  end;
...
function TdxGridViewBuildersFactory.CreateViewAdapter(AMasterAdapter
  : TdxCustomGridViewAdapter; AGridView: TcxCustomGridView)
  : TdxCustomGridViewAdapter;
begin
  Result := BuilderClasses[AGridView].CreateAdapter(AMasterAdapter, AGridView);
end;

function TdxGridViewBuildersFactory.CreateViewBuilder
  (AReportLink: TdxGridReportLink; AMasterBuilder: TdxCustomGridViewBuilder;
  AGridView: TcxCustomGridView): TdxCustomGridViewBuilder;
begin
  Result := BuilderClasses[AGridView].Create(AReportLink, AMasterBuilder,
    AGridView);
end;

function TdxGridViewBuildersFactory.GetBuilderClass(GridView: TcxCustomGridView)
  : TdxGridViewBuilderClass;
begin
...
function TdxViewHelpersFactory.HelperClassByItem(AnItem: TdxReportVisualItem)
  : TdxCustomGridViewHelperClass;
var
...
function TdxViewHelpersFactory.GetHelperClass(GridView: TcxCustomGridView)
  : TdxCustomGridViewHelperClass;
begin
...
function TdxRecordHelpersFactory.GetHelperClass(GridRecord: TcxCustomGridRecord)
  : TdxCustomGridRecordHelperClass;
begin
...
class function TdxCustomGridViewHelper.ExtractCustomDrawID
  (AnItem: TdxReportVisualItem): TdxGridAttributeID;
begin
...
class procedure TdxCustomGridViewHelper.ExtractCustomDrawInfo
...
class function TdxCustomGridViewHelper.ExtractGridView
  (AnItem: TdxReportVisualItem): TcxCustomGridView;
begin
  Result := TcxCustomGridView(AnItem.TopLevelParent.Data);
end;

class function TdxCustomGridViewHelper.HasData
  (AView: TcxCustomGridView): Boolean;
begin
  Result := True;
end;

class function TdxCustomGridViewHelper.IsAttributeSupported
  (AnAttribute: TdxGridAttributeClass): Boolean;
var
...
begin
  ...
  for I := Low(Attributes) to High(Attributes) do
    if Attributes[I] = AnAttribute then
      Exit;
  Result := False;
end;

class function TdxCustomGridViewHelper.SupportedAttributes
  : TdxGridAttributeClasses;
begin
  SetLength(Result, 0);
  AddAttribute(Result, TdxGridLevelCaption);
end;

class procedure TdxCustomGridViewHelper.AddAttribute(var AnAtributes
  : TdxGridAttributeClasses; AnAttribute: TdxGridAttributeClass);
begin
  SetLength(AnAtributes, Length(AnAtributes) + 1);
  AnAtributes[Length(AnAtributes) - 1] := AnAttribute;
end;

class function TdxCustomGridViewHelper.FilterPosition(AView: TcxCustomGridView)
  : TcxGridFilterPosition;
begin
  Result := fpBottom;
end;

class function TdxCustomGridViewHelper.IsFilterBarAtBottom
  (AView: TcxCustomGridView): Boolean;
begin
  Result := FilterPosition(AView) = fpBottom;
end;

class function TdxCustomGridViewHelper.IsFilterBarAtTop
  (AView: TcxCustomGridView): Boolean;
begin
  Result := FilterPosition(AView) = fpTop;
end;

class function TdxCustomGridViewHelper.IsOffice11StyleGrouping
  (AView: TcxCustomGridView): Boolean;
begin
  Result := False;
end;
...
class function TdxNullGridViewHelper.IsAttributeSupported
  (AnAttribute: TdxGridAttributeClass): Boolean;
begin
  Result := True;
end;
...
class function TdxCustomGridTableViewHelper.ExtractCustomDrawID
  (AnItem: TdxReportVisualItem): TdxGridAttributeID;
begin
...
class function TdxCustomGridTableViewHelper.HasData
  (AView: TcxCustomGridView): Boolean;
begin
  Result := (AView <> nil) and
    (TcxCustomGridTableView(AView).ViewData.RecordCount <> 0);
end;

class function TdxCustomGridTableViewHelper.SupportedAttributes
  : TdxGridAttributeClasses;
begin
...
class function TdxCustomGridTableViewHelper.ExtractRecord
  (AnItem: TdxReportVisualItem): TcxCustomGridRecord;
begin
  Result := nil;
end;

class function TdxCustomGridTableViewHelper.FilterPosition
  (AView: TcxCustomGridView): TcxGridFilterPosition;
begin
  Result := CustomGridTableFiltering_GetPosition(TcxCustomGridTableView(AView)
    .Filtering);
end;
...
class function TdxGridCardViewHelper.ExtractCustomDrawID
  (AnItem: TdxReportVisualItem): TdxGridAttributeID;
begin
  Result := inherited ExtractCustomDrawID(AnItem);
  if Result = dxGridUndefinedID then
...
class procedure TdxGridCardViewHelper.ExtractCustomDrawInfo
  (AnItem: TdxReportVisualItem; out ACustomDrawInfo: TdxGridCellCustomDrawInfo);
begin
  with ACustomDrawInfo do
    try
...
class function TdxGridCardViewHelper.ExtractCard(AnItem: TdxReportVisualItem)
  : TcxGridCard;
begin
  Result := ExtractRecord(AnItem) as TcxGridCard;
end;

class function TdxGridCardViewHelper.ExtractCardRow(AnItem: TdxReportVisualItem)
  : TcxGridCardViewRow;
begin
  Result := TdxReportCardRow(AnItem.Parent).GridCardRow;
end;

class function TdxGridCardViewHelper.ExtractRecord(AnItem: TdxReportVisualItem)
  : TcxCustomGridRecord;
begin
...
class function TdxGridTableViewHelper.ExtractCustomDrawID
  (AnItem: TdxReportVisualItem): TdxGridAttributeID;
begin
  Result := inherited ExtractCustomDrawID(AnItem);
  if Result = dxGridUndefinedID then
    if AnItem.Parent <> nil then
      ...
      else if TClass(AnItem.Parent.Data) = TdxGridFooter then
        Result := dxGridFooterID
      else if IsDelphiObject(AnItem.Data) and
        (TObject(AnItem.Data) is TcxCustomGridTableItem) then
        if (AnItem.Parent.Parent <> nil) and (AnItem.Parent.Parent.Data >= 0)
          and (AnItem.Parent.Parent.Data < High(Byte)) then
          Result := dxGridGroupFooterID
        else
          Result := dxGridRecordID;
end;

class procedure TdxGridTableViewHelper.ExtractCustomDrawInfo
  (AnItem: TdxReportVisualItem; out ACustomDrawInfo: TdxGridCellCustomDrawInfo);
begin
  with ACustomDrawInfo do
    try
      ...
      if GridAttributeID in [dxGridFooterID, dxGridGroupFooterID,
        dxGridHeaderID, dxGridRecordID] then
      begin
...
class function TdxGridTableViewHelper.SupportedAttributes
  : TdxGridAttributeClasses;
begin
  Result := inherited SupportedAttributes;
...
class function TdxGridTableViewHelper.ExtractColumn(AnItem: TdxReportVisualItem)
  : TcxGridColumn;
begin
  Result := TcxGridColumn(AnItem.Data);
end;

class function TdxGridTableViewHelper.ExtractGroupLevel
  (AnItem: TdxReportVisualItem): Integer;
begin
  Result := Integer(AnItem.Parent.Parent.Data);
end;

class function TdxGridTableViewHelper.ExtractRecord(AnItem: TdxReportVisualItem)
  : TcxCustomGridRecord;
begin
...
class function TdxGridTableViewHelper.IsOffice11StyleGrouping
  (AView: TcxCustomGridView): Boolean;
begin
...
class function TdxGridBandedTableViewHelper.ExtractCustomDrawID
  (AnItem: TdxReportVisualItem): TdxGridAttributeID;
begin
  Result := inherited ExtractCustomDrawID(AnItem);
  if Result = dxGridUndefinedID then
    if IsDelphiObject(AnItem.Data) and (TObject(AnItem.Data) is TcxGridBand)
    then
      Result := dxGridBandID;
end;

class procedure TdxGridBandedTableViewHelper.ExtractCustomDrawInfo
  (AnItem: TdxReportVisualItem; out ACustomDrawInfo: TdxGridCellCustomDrawInfo);
begin
  with ACustomDrawInfo do
    try
...
class function TdxGridBandedTableViewHelper.SupportedAttributes
  : TdxGridAttributeClasses;
begin
  Result := inherited SupportedAttributes;
...
class function TdxGridBandedTableViewHelper.ExtractBand
  (AnItem: TdxReportVisualItem): TcxGridBand;
begin
...
class function TdxGridChartViewHelper.HasData(AView: TcxCustomGridView)
  : Boolean;
begin
...
constructor TdxCustomGridRecordHelper.Create
  (AAdapter: TdxCustomGridTableViewAdapter);
begin
  inherited Create;
  FAdapter := AAdapter;
end;
...
class function TdxCustomGridRecordHelper.ProducerClass
  : TdxGridViewRowProducerClass;
begin
...
begin
  ...
  begin
    ...
    if CustomGridRecord_GetIsParent(Result) and (Result.Level < GridRecord.Level)
    then
      Exit;
  end;
  Result := nil;
...
class function TdxCustomGridRowHelper.ProducerClass
  : TdxGridViewRowProducerClass;
begin
...
class function TdxGridMasterDataRowHelper.ProducerClass
  : TdxGridViewRowProducerClass;
begin
...
begin
  ...
  // and MasterRow.ActiveDetailGridViewExists //!!!
end;
...
class function TdxGridWinExplorerViewDataRecordHelper.ProducerClass
  : TdxGridViewRowProducerClass;
begin
  Result := TdxGridWinExplorerViewDataRecordProducer;
end;

class function TdxGridWinExplorerViewDataRecordHelper.RecordClass
...
class function TdxGridWinExplorerViewGroupRecordHelper.ProducerClass
  : TdxGridViewRowProducerClass;
begin
  Result := TdxGridWinExplorerViewGroupRecordProducer;
end;

class function TdxGridWinExplorerViewGroupRecordHelper.RecordClass
  : TcxCustomGridRecordClass;
begin
...
constructor TdxRecordHelpersCache.Create
  (AAdapter: TdxCustomGridTableViewAdapter);
begin
  inherited Create;
  FAdapter := AAdapter;
...
function TdxRecordHelpersCache.GetHelper(ARecord: TcxCustomGridRecord)
  : TdxCustomGridRecordHelper;
begin
...
function TdxRecordHelpersCache.GetItem(Index: Integer)
  : TdxCustomGridRecordHelper;
begin
...
function TdxProducerCache.IndexOf(AProducerClass
  : TdxGridViewRowProducerClass): Integer;
begin
  for Result := 0 to Count - 1 do
    if Items[Result].ClassType = AProducerClass then
      Exit;

  Result := Add(AProducerClass.Create(Builder));
end;

function TdxProducerCache.GetProducer(ProducerClass
  : TdxGridViewRowProducerClass): TdxGridViewRowProducer;
begin
...
constructor TdxCustomGridViewAdapter.Create(AMasterAdapter
  : TdxCustomGridViewAdapter; AGridView: TcxCustomGridView);
begin
  inherited Create;
...
procedure TdxCustomGridViewAdapter.ExpandAllRows(AnOptionsExpanding
  : TdxGridReportLinkOptionsExpanding; ARecursive: Boolean);
begin
  Grid.BeginUpdate;
  try
...
function TdxCustomGridViewAdapter.BackgroundBitmaps
  : TcxCustomGridBackgroundBitmaps;
begin
...
begin
  Result := (BackgroundBitmaps.GetBitmap(Index) <> nil) and
    not BackgroundBitmaps.GetBitmap(Index).Empty;
end;

function TdxCustomGridViewAdapter.IsBackgroundBitmapSupported
...
function TdxCustomGridViewAdapter.CreateCloneAdapter(AClone: TcxCustomGridView)
  : TdxCustomGridViewAdapter;
begin
  Result := dxGridViewBuildersFactory.CreateViewAdapter(MasterAdapter, AClone);
end;

procedure TdxCustomGridViewAdapter.ExpandAllRowsInGridView
  (AGridView: TcxCustomGridView; AMasterRows, AGroupRows: Boolean);
begin
...
procedure TdxCustomGridViewAdapter.ExpandAllRowsInClones(AMasterRows,
  AGroupRows: Boolean);
var
  I: Integer;
...
begin
  ...
  if ARecursive then
    for I := 0 to ALevel.VisibleCount - 1 do
      ExpandAllRowsInLevel(ALevel.VisibleItems[I], AMasterRows, AGroupRows,
        ARecursive);
end;

procedure TdxCustomGridViewAdapter.ExpandAllRowsInItself(AMasterRows,
  AGroupRows: Boolean);
begin
end;
...
begin
  if MasterAdapter = nil then
    ...
    MasterAdapter.GridLevel.Styles.GetTabParams(MasterGridRecord,
      GridLevel, Result);
end;
...
begin
  Result := Grid.LookAndFeel.NativeStyle and
...
begin
  Result := GridView.ViewInfo.LookAndFeelPainter.ScaledExpandButtonSize
    (TcxCustomGridViewAccess(GridView).ScaleFactor);
end;
...
function TdxCustomGridViewAdapter.GetLookAndFeelPainter
...
constructor TdxCustomGridViewFormatter.Create
  (ABuilder: TdxCustomGridViewBuilder);
begin
  inherited Create;
  FBuilder := ABuilder;
...
procedure TdxCustomGridViewFormatter.DoInitializeCaption
  (ACaption: TdxReportCellText);
begin
...
procedure TdxCustomGridViewFormatter.DoInitializeCaptionRow
  (ARow: TdxReportCell);
begin
end;

procedure TdxCustomGridViewFormatter.DoReportLinkInitializeCaption
  (ACaption: TdxReportCellText);
begin
  ReportLink.DoInitializeLevelCaption(Adapter.GridView,
    TdxReportCellString(ACaption));
end;
...
function TdxCustomGridViewFormatter.GetCaptionViewParams
...
begin
  ...
  // ReportLink.FixedTransparent;
end;

procedure TdxCustomGridViewFormatter.DoInitializeFilterBar
  (AFilterBar: TdxReportCellText);
begin
...
procedure TdxCustomGridViewFormatter.DoInitializeFilterBarRow
  (ARow: TdxReportCell);
begin
end;

procedure TdxCustomGridViewFormatter.DoReportLinkInitializeFilterBar
  (AFilterBar: TdxReportCellText);
begin
  ReportLink.DoInitializeFilterBar(TcxCustomGridTableView(Adapter.GridView),
    TdxReportCellString(AFilterBar));
end;

function TdxCustomGridViewFormatter.GetFilterBarClass: TdxReportCellTextClass;
const
  CheckClasses: array [Boolean] of TdxReportCellTextClass = (TdxReportCellCheck,
    TdxReportCellString);
begin
  Result := CheckClasses[Adapter.FilterEmpty];
end;

function TdxCustomGridViewFormatter.GetFilterBarViewParams
  : TdxReportItemViewParams;
begin
  if ReportLink.OptionsFormatting.UseNativeStyles then
...
procedure TdxCustomGridViewFormatter.DoInitializeDetailsSeparatorRow
  (ARow: TdxReportCell);
begin
end;

procedure TdxCustomGridViewFormatter.DoInitializeHorzDetailsSeparator
  (ASeparator: TdxReportCellBox);
begin
  with ASeparator do
  begin
...
procedure TdxCustomGridViewFormatter.DoInitializeVertBottomDetailsSeparator
  (ASeparator: TdxReportCellBox;
  ASeparatorKind: TdxVerticalDetailsSeparatorKind);
begin
...
procedure TdxCustomGridViewFormatter.DoInitializeVertDetailsSeparator
  (ASeparator: TdxReportCellBox;
  ASeparatorKind: TdxVerticalDetailsSeparatorKind);
begin
  with ASeparator do
...
procedure TdxCustomGridViewFormatter.DoInitializeVertTopDetailsSeparator
  (ASeparator: TdxReportCellBox;
  ASeparatorKind: TdxVerticalDetailsSeparatorKind);
begin
  DoInitializeVertDetailsSeparator(ASeparator, ASeparatorKind);
...
function TdxCustomGridViewFormatter.GetDetailsSeparatorClass
  : TdxReportCellBoxClass;
begin
...
begin
  ...
  if (ReportLink.OptionsFormatting.LookAndFeelKind <> lfStandard) and
    not Odd(AnExpandButton.ButtonSize) then
    AnExpandButton.ButtonSize := AnExpandButton.ButtonSize - 1;
  AnExpandButton.ButtonInteriorColor := Adapter.ExpandButtonColor;
  AnExpandButton.ButtonTransparent :=
    IsColorTransparent(AnExpandButton.ButtonInteriorColor);
  RegisterExpandButton(AnExpandButton);
end;

procedure TdxCustomGridViewFormatter.DoInitializeMasterIndent
  (AnIndent: TdxReportCellExpandButton; AnIndex, AnIndentCount: Integer);
begin
end;

function TdxCustomGridViewFormatter.GetMasterIndentClass
  : TdxReportCellExpandButtonClass;
begin
  Result := TdxReportCellExpandButton;
end;

procedure TdxCustomGridViewFormatter.DoInitializeViewTerminator
  (ATerminator: TdxReportCellBox);
begin
  ATerminator.CellSides := [csBottom];
  ATerminator.Transparent := True;
end;

function TdxCustomGridViewFormatter.QueryInterface(const IID: TGUID;
  out Obj): HResult;
begin
...
begin
  CaptionLineHeight := 2 * ScaleFactor.Apply(TabsAreaOffset) +
    CalculateFontHeight(GetCaptionViewParams);
  FilterBarLineHeight := 2 * ScaleFactor.Apply(FilterBarTextOffset) +
    CalculateFontHeight(GetFilterBarViewParams);
end;
...
begin
  if ReportLink.IsAggregated and Supports(ReportLink.Controller,
    IdxReportLinkController, AIntf) then
...
begin
  if ReportLink.IsAggregated and Supports(TObject(ReportLink.Controller),
    IdxReportLinkController, ControllerIntf) then
    Result := cxRectWidth(ControllerIntf.GetControlSiteBounds
      (ReportLink.Grid)) - 1
  else
  ...
  for I := 0 to AbsoluteLevel - 1 do
    with Builder.AbsoluteBuilders[I].Adapter do
      if HasDetailsSeparator then
        Inc(Result, DetailsSeparatorThickness);
...
function TdxCustomGridViewFormatter.BackgroundBitmaps
  : TcxCustomGridBackgroundBitmaps;
begin
  Result := Adapter.BackgroundBitmaps;
end;

function TdxCustomGridViewFormatter.GetBackgroundBitmap(Index: Integer)
  : TGraphic;
begin
  if ReportLink.OptionsFormatting.UseNativeStyles then
...
function TdxCustomGridViewFormatter.GetBackgroundBitmapIndex
  (Index: Integer): Integer;
begin
  Result := ReportLink.AddBackgroundBitmapToPool(GetBackgroundBitmap(Index));
end;

function TdxCustomGridViewFormatter.HasBackgroundBitmap(Index: Integer)
  : Boolean;
begin
  Result := not ReportLink.OptionsFormatting.SuppressBackgroundBitmaps and
    (GetBackgroundBitmap(Index) <> nil) and
    not GetBackgroundBitmap(Index).Empty;
end;

function TdxCustomGridViewFormatter.MapStyleBackgroundBitmapIndex
  (AGridBackgroundBitmapIndex: Integer): Integer;
begin
...
function TdxCustomGridViewFormatter.CalculateFontHeight(const AParams
  : TdxReportItemViewParams): Integer;
begin
  Result := Renderer.CalcTextPatternHeight(Canvas, AParams.NativeParams.Font);
end;

procedure TdxCustomGridViewFormatter.CalculateHeight(const AParams
  : TdxReportItemViewParams; var AHeight: Integer);
begin
  AHeight := Max(AHeight, CalculateFontHeight(AParams));
end;

function TdxCustomGridViewFormatter.GetStyleFontIndex(const AParams
  : TdxReportItemViewParams): Integer;
begin
...
procedure TdxCustomGridViewFormatter.RegisterExpandButton
  (AExpandButton: TdxReportCellExpandButton);
begin
  FExpandButtons.Add(AExpandButton);
end;

procedure TdxCustomGridViewFormatter.RegisterLookAndFeelItem
  (AnItem: TdxReportVisualItem; AEdgeStyle: TdxCellEdgeStyle);
begin
...
begin
  ...
  AReportItemParams.CellSides := CellSidesMap[AGridLines] - [csLeft] +
    [csRight];
  AReportItemParams.FontStyle := [];
  AReportItemParams.Transparent :=
    IsColorTransparent(AReportItemParams.NativeParams.Color);
...
begin
  Result := EdgeModeMap[ReportLink.OptionsFormatting.LookAndFeelKind <>
    lfUltraFlat];
end;
...
function TdxCustomGridViewFormatter.GetExpandButton(Index: Integer)
...
function TdxCustomGridViewFormatter.GetLookAndFeelItem(Index: Integer)
  : TdxReportVisualItem;
begin
...
class function TdxCustomGridViewBuilder.CreateAdapter(AMasterAdapter
  : TdxCustomGridViewAdapter; AGridView: TcxCustomGridView)
  : TdxCustomGridViewAdapter;
begin
...
class function TdxCustomGridViewBuilder.FormatterClass
  : TdxGridViewFormatterClass;
begin
...
function TdxCustomGridViewBuilder.GetCaptionProducer
  : TdxGridViewCaptionProducer;
begin
  Result := ProducerCache[GetCaptionProducerClass]
    as TdxGridViewCaptionProducer;
end;

function TdxCustomGridViewBuilder.GetCaptionProducerClass
  : TdxGridViewCaptionProducerClass;
begin
...
begin
  AddReportRow(GetDetailsTopSeparatorProducer.Produce
    (HostInfoServices.LevelSeparatorTopHostInfo));
end;

function TdxCustomGridViewBuilder.GetDetailsBottomSeparatorProducer
  : TdxGridViewDetailsSeparatorProducer;
begin
  Result := ProducerCache[GetDetailsBottomSeparatorProducerClass]
    as TdxGridViewDetailsSeparatorProducer;
end;

function TdxCustomGridViewBuilder.GetDetailsBottomSeparatorProducerClass
  : TdxGridViewDetailsSeparatorProducerClass;
begin
  Result := TdxGridViewDetailsBottomSeparatorProducer;
end;

function TdxCustomGridViewBuilder.GetDetailsTopSeparatorProducer
  : TdxGridViewDetailsSeparatorProducer;
begin
  Result := ProducerCache[GetDetailsTopSeparatorProducerClass]
    as TdxGridViewDetailsSeparatorProducer;
end;

function TdxCustomGridViewBuilder.GetDetailsTopSeparatorProducerClass
  : TdxGridViewDetailsSeparatorProducerClass;
begin
...
begin
  AddReportRow(GetFilterBarProducer.Produce
    (HostInfoServices.FilterBarHostInfo));
end;

function TdxCustomGridViewBuilder.GetFilterBarProducer
  : TdxGridViewFilterBarProducer;
begin
  Result := ProducerCache[GetFilterBarProducerClass]
    as TdxGridViewFilterBarProducer;
end;

function TdxCustomGridViewBuilder.GetFilterBarProducerClass
  : TdxGridViewFilterBarProducerClass;
begin
...
begin
  AddReportRow(GetViewTerminatorProducer.Produce
    (HostInfoServices.PageDetailsHostInfo));
end;

function TdxCustomGridViewBuilder.GetViewTerminatorProducer
  : TdxGridViewTerminatorProducer;
begin
  Result := ProducerCache[GetViewTerminatorProducerClass]
    as TdxGridViewTerminatorProducer;
end;

function TdxCustomGridViewBuilder.GetViewTerminatorProducerClass
  : TdxGridViewTerminatorProducerClass;
begin
...
function TdxCustomGridViewBuilder.GetAbsoluteBuilder(AIndex: Integer)
  : TdxCustomGridViewBuilder;
begin
  Result := RootBuilder;
  while AIndex > 0 do
...
function TdxCustomGridViewBuilder.GetHostInfoServices
  : TdxGridAttributeHostInfoServices;
begin
...
constructor TdxCustomGridTableViewAdapter.Create(AMasterAdapter
  : TdxCustomGridViewAdapter; AGridView: TcxCustomGridView);
var
...
begin
  ...
  if Supports(GridView, IcxDataControllerConditionalFormattingProviderOwner,
    AConditionalFormatting) then
    FConditionalFormattingProvider :=
      AConditionalFormatting.GetConditionalFormattingProvider;
end;
...
function TdxCustomGridTableViewAdapter.ForEachRecord
  (AProc: TdxGridTableAdapterForEachRecordProc; AData: Integer;
...
class function TdxCustomGridTableViewAdapter.GridViewClass
...
function TdxCustomGridTableViewAdapter.GetContentViewParams
  (ARecord: TcxCustomGridRecord; ATableItem: TcxCustomGridTableItem;
  AIsDataCell: Boolean = False): TcxViewParams;
begin
...
function TdxCustomGridTableViewAdapter.GetPreviewViewParams
  (ARecord: TcxCustomGridRecord; ATableItem: TcxCustomGridTableItem)
  : TcxViewParams;
begin
...
function TdxCustomGridTableViewAdapter.TryGetAdvancedStyle(const ACell: TPoint;
  out AStyle: TdxSpreadSheetCellDisplayStyle): Boolean;
begin
  Result := (ConditionalFormattingProvider <> nil) and
    TcxDataControllerConditionalFormattingProviderAccess
    (ConditionalFormattingProvider).TryGetStyle(ACell, AStyle);
end;
...
procedure TdxCustomGridTableViewAdapter.ExpandAllMasterRows(AnExpandGroups
  : Boolean);
begin
  ForEachRecord(DoExpandMasterRow, Integer(AnExpandGroups), False);
end;

procedure TdxCustomGridTableViewAdapter.ExpandAllRowsInItself(AMasterRows,
  AGroupRows: Boolean);
begin
  if AGroupRows or GridView.DataController.MultiSelectionSyncGroupWithChildren
  then
    ExpandAllGroupRows;
  if AMasterRows then
...
class function TdxCustomGridTableViewAdapter.GetProperties
  (AnItem: TcxCustomGridTableItem; ARecord: TcxCustomGridRecord)
...
class function TdxCustomGridTableViewAdapter.GetPropertiesClass
  (AnItem: TcxCustomGridTableItem; ARecord: TcxCustomGridRecord)
  : TcxCustomEditPropertiesClass;
begin
  Result := TcxCustomEditPropertiesClass(GetProperties(AnItem, ARecord)
    .ClassType);
end;

class function TdxCustomGridTableViewAdapter.GetRepositoryItem
  (AnItem: TcxCustomGridTableItem; ARecord: TcxCustomGridRecord)
...
procedure TdxCustomGridTableViewAdapter.IsMasterRowCollapsed
  (ARecord: TcxCustomGridRecord; AData: Integer; var AContinue: Boolean);
begin
...
function TdxCustomGridTableViewAdapter.GetFiltering
...
function TdxCustomGridTableViewAdapter.GetRecord(Index: Integer)
  : TcxCustomGridRecord;
begin
  Result := GridView.ViewData.Records[Index];
end;

function TdxCustomGridTableViewAdapter.GetRecordHelper
  (ARecord: TcxCustomGridRecord): TdxCustomGridRecordHelper;
begin
  Result := RecordHelpersCache.Helpers[ARecord];
end;

function TdxCustomGridTableViewAdapter.GetSelectedRecord(Index: Integer)
  : TcxCustomGridRecord;
begin
...
constructor TdxCustomGridTableViewFormatter.Create
  (ABuilder: TdxCustomGridViewBuilder);
begin
  inherited;
...
function TdxCustomGridTableViewFormatter.IndexOfRecord
  (ARecord: TcxCustomGridRecord): Integer;
begin
  for Result := 0 to RecordCount - 1 do
    if Records[Result] = ARecord then
      Exit;
  Result := -1;
end;
...
var
  S: string;
begin
  if (ATableItem <> nil) and (ARecord <> nil) and (AnItem is TdxReportCellText)
    and (AProperties.GetEditValueSource(False) = evsValue) then
  begin
...
procedure TdxCustomGridTableViewFormatter.DoInitializeItem
  (AItem: TAbstractdxReportCellData; ATableItem: TcxCustomGridTableItem;
  ARecord: TcxCustomGridRecord; AIsPreview: Boolean = False);
var
...
begin
  ...
  dxPSDataMaps.InitializeItem(AItem, AProperties, ACellValue, Self, AViewParams,
    AIsPreview, ARecord.RecordIndex, ATableItem);
  ...
  if AIsPreview then
    ...
    AContentBackgroundBitmapStyleIndex := GetContentBackgroundBitmapStyleIndex
      (ATableItem);

  if HasBackgroundBitmap(AContentBackgroundBitmapStyleIndex) then
    AItem.BackgroundBitmapIndex := GetBackgroundBitmapIndex
      (AContentBackgroundBitmapStyleIndex);
...
function TdxCustomGridTableViewFormatter.GetDataItemClass
  (ATableItem: TcxCustomGridTableItem; ARecord: TcxCustomGridRecord;
  AIsPreview: Boolean = False): TdxReportCellDataClass;
begin
...
function TdxCustomGridTableViewFormatter.GetItemClass
  (ATableItem: TcxCustomGridTableItem; ARecord: TcxCustomGridRecord;
  AIsPreview: Boolean = False): TdxReportCellDataClass;
begin
  Result := dxPSDataMaps.ItemClass(GetItemProperties(ATableItem, ARecord),
...
function TdxCustomGridTableViewFormatter.GetItemValue
  (AProperties: TcxCustomEditProperties; ATableItem: TcxCustomGridTableItem;
  ARecord: TcxCustomGridRecord): TcxEditValue;
var
  S: string;
begin
...
function TdxCustomGridTableViewFormatter.GetItemViewParams
  (ATableItem: TcxCustomGridTableItem; ARecord: TcxCustomGridRecord;
  AnIsPreview: Boolean = False; AIsDataCell: Boolean = False)
  : TdxReportItemViewParams;
var
...
begin
  ...
  begin
    ...
    else if AnIsPreview then
      ReportLink.Styles.GetPreviewParams(ARecord, ATableItem,
        Result.NativeParams)
    else
      ReportLink.Styles.GetContentParams(ARecord, ATableItem,
        Result.NativeParams)
  end
  else if CanProcessSelectionStyle(ARecord) then
  ...
  if AIsDataCell then
  begin
    if Adapter.TryGetAdvancedStyle(Point(ATableItem.Index, ARecord.RecordIndex),
      AStyle) and (AStyle <> nil) then
      Result.AdvancedViewParams := TdxSpreadSheetAdvancedViewParams.
        CreateFrom(AStyle);
  end;
end;

function TdxCustomGridTableViewFormatter.GetSelectionViewParams
  : TdxReportItemViewParams;
begin
  ReportLink.Styles.GetSelectionParams(Result.NativeParams);
end;
...
function TdxCustomGridTableViewFormatter.IdxPSCellParams_GetCanvas
  : TdxPSReportRenderCustomCanvas;
begin
  Result := Canvas;
end;

function TdxCustomGridTableViewFormatter.
  IdxPSCellParams_GetDisplayGraphicsAsText: Boolean;
begin
  Result := ReportLink.OptionsRefinements.DisplayGraphicsAsText;
end;

function TdxCustomGridTableViewFormatter.
  IdxPSCellParams_GetDisplayTrackBarsAsText: Boolean;
begin
  Result := ReportLink.OptionsRefinements.DisplayTrackBarsAsText;
end;

function TdxCustomGridTableViewFormatter.IdxPSCellParams_GetEndEllipsis
  : Boolean;
begin
...
function TdxCustomGridTableViewFormatter.
  IdxPSCellParams_GetFlatCheckMarks: Boolean;
begin
  Result := ReportLink.OptionsRefinements.FlatCheckMarks;
end;

function TdxCustomGridTableViewFormatter.
  IdxPSCellParams_GetGraphicsText: string;
begin
...
function TdxCustomGridTableViewFormatter.
  IdxPSCellParams_GetTransparentGraphics: Boolean;
begin
...
{ IdxPSCellParams2 }
function TdxCustomGridTableViewFormatter.
  IdxPSCellParams2_GetPreviewMarginLeft: Integer;
begin
  Result := dxTextSpace;
end;

function TdxCustomGridTableViewFormatter.
  IdxPSCellParams2_GetPreviewMarginRight: Integer;
begin
  Result := dxTextSpace;
end;

function TdxCustomGridTableViewFormatter.
  IdxPSCellParams2_GetPreviewMaxHeight: Integer;
begin
  Result := -1;
end;

function TdxCustomGridTableViewFormatter.
  IdxPSCellParams2_GetPreviewMaxLineCount: Integer;
begin
  Result := -1;
end;

function TdxCustomGridTableViewFormatter.
  IdxPSCellParams2_GetRichEditGraphicClass: TGraphicClass;
const
...
function TdxCustomGridTableViewFormatter.
  IdxPSCellParams2_GetRichEditTransparent: Boolean;
begin
...
begin
  inherited;
  if ReportLink.OptionsSelection.ProcessSelection then
    BuildSelectedRecordList;
end;
  ...
  begin
    ...
    begin
      ...
      IsRecordIncluded := Helper.HasSelectedChildren or
        (not ReportLink.OptionsSelection.ProcessExactSelection and
        (SelectedRecordList.IndexOf(Helper.Parent) <> -1));
    end;
...
function TdxCustomGridTableViewFormatter.CanProcessSelectionStyle
  (ARecord: TcxCustomGridRecord): Boolean;
begin
  Result := (ARecord <> nil) and
    ReportLink.OptionsFormatting.ConsumeSelectionStyle and
    IsSelectedRecord(ARecord);
  if Result and not ReportLink.OptionsFormatting.UseNativeStyles then
    Result := Adapter.HasSelectionStyle;
end;

function TdxCustomGridTableViewFormatter.IsSelectedRecord
  (ARecord: TcxCustomGridRecord): Boolean;
begin
  Result := (SelectedRecordCount <> 0) or ARecord.Selected;
end;

function TdxCustomGridTableViewFormatter.GetContentBackgroundBitmapStyleIndex
  (ATableItem: TcxCustomGridTableItem): Integer;
begin
  Result := bbContent;
end;

function TdxCustomGridTableViewFormatter.MapStyleBackgroundBitmapIndex
  (AGridBackgroundBitmapIndex: Integer): Integer;
begin
  case AGridBackgroundBitmapIndex of
    bbContent:
  ...
  if Result = 0 then
    Result := inherited MapStyleBackgroundBitmapIndex
      (AGridBackgroundBitmapIndex);
end;
...
function TdxCustomGridTableViewFormatter.GetRecord(Index: Integer)
  : TcxCustomGridRecord;
begin
...
function TdxCustomGridTableViewFormatter.GetRecordIndex
  (ARecord: TcxCustomGridRecord): Integer;
var
...
function TdxCustomGridTableViewFormatter.GetSelectedRecord(Index: Integer)
  : TcxCustomGridRecord;
begin
...
class function TdxCustomGridTableViewBuilder.AdapterClass
  : TdxGridViewAdapterClass;
begin
  Result := TdxCustomGridTableViewAdapter;
end;

function TdxCustomGridTableViewBuilder.Formatter
  : TdxCustomGridTableViewFormatter;
begin
  Result := inherited Formatter as TdxCustomGridTableViewFormatter;
end;

class function TdxCustomGridTableViewBuilder.FormatterClass
  : TdxGridViewFormatterClass;
begin
...
class function TdxCustomGridTableViewBuilder.GridViewClass
  : TcxCustomGridViewClass;
begin
  Result := TcxCustomGridTableView;
end;
...
constructor TdxGridTableViewAdapter.Create(AMasterAdapter
  : TdxCustomGridViewAdapter; AGridView: TcxCustomGridView);
begin
  inherited;
  GridTableViewInfo_CalculateExpandButtonParams(GridView.ViewInfo);
  // because LevelIndent
end;
...
function TdxGridTableViewAdapter.HasDetails(AGridRow: TcxCustomGridRow)
  : Boolean;
begin
  Result := RecordHelpers[AGridRow].HasDetails;
end;

function TdxGridTableViewAdapter.IsSummaryHasSameLink(AItem1,
  AItem2: TcxDataSummaryItem): Boolean;
begin
  Result := (AItem1.ItemLink = AItem2.ItemLink) and (AItem1.Position = spFooter)
    and (AItem2.Position = spFooter);
end;

function TdxGridTableViewAdapter.GetFooterItemCount(AItems: TcxDataSummaryItems;
  ACanMultiLine: Boolean; AIsGroup: Boolean): Integer;
var
  I, J, ACount: Integer;
const
...
begin
  ...
  begin
    ...
    for J := 0 to AItems.Count - 1 do
      if (AItems[J].Position = APos[AIsGroup]) and
        (AItems[J].ItemLink = Columns[I]) then
      begin
        Inc(ACount);
        if not ACanMultiLine then
          Break;
      end;
    Inc(Result, ACount);
...
begin
  ...
  begin
    ...
    if (AColumn = nil) or (AColumn.VisibleIndex < 0) or
      (AItems[I].Position <> APos[AIsGroup]) then
      Inc(Result);
    Inc(I);
  end;
end;

function TdxGridTableViewAdapter.GetFooterItemInfo(AItems: TcxDataSummaryItems;
  AIndex: Integer; var ARowIndex: Integer): Integer;
var
  I: Integer;
  AColumn: TcxGridColumn;
begin
...
function TdxGridTableViewAdapter.GetFooterLineCount(AItems: TcxDataSummaryItems;
  ACanMultiLine: Boolean): Integer;
var
  ACount: Integer;
  I, J: Integer;
...
function TdxGridTableViewAdapter.GetGroupFooterCount
  (AGridRow: TcxCustomGridRow): Integer;
var
  I: Integer;
begin
  Result := 0;
...
function TdxGridTableViewAdapter.GetGroupFooterItemText(ARowIndex, ALevel,
...
function TdxGridTableViewAdapter.HasGroupFooter(AGridRow: TcxCustomGridRow;
  ALevel: Integer): Boolean;
begin
  ...
  begin
    ...
    Result := (0 <= ALevel) and (ALevel < AGridRow.Level) and
      ...
      TcxGridColumnAccess(GridView.GroupedColumns[AGridRow.Level - 1 - ALevel])
      .Options.GroupFooters;
  end;
  if not Result and (AGridRow is TcxGridGroupRow) then
  begin
    Result := Result or (GroupFootersMode = gfAlwaysVisible) and (ALevel = -1)
      and not AGridRow.Expanded and
      TcxGridColumnAccess(TcxGridGroupRow(AGridRow).GroupedColumn)
      .Options.GroupFooters;
  end;
end;

function TdxGridTableViewAdapter.HasGroupFooterItem(ALevel,
  AIndex: Integer): Boolean;
begin
  Result := Summary.GroupFooterIndexOfItemLink[ALevel, Columns[AIndex]] <> -1;
end;

function TdxGridTableViewAdapter.HasGroupFooters
  (AGridRow: TcxCustomGridRow): Boolean;
begin
...
begin
  Result := inherited GetCellAutoHeight and (DetailsLineCount = 1) and
    not DataRowHeightAssigned;
end;

function TdxGridTableViewAdapter.GetCellMultiline: Boolean;
begin
  Result := inherited GetCellAutoHeight;
  // {3.1} and not DataRowHeightAssigned;// and (DetailsLineCount <> 1);
end;
...
function TdxGridTableViewAdapter.GetHeaderMultiline
  (Column: TcxGridColumn): Boolean;
begin
...
begin
  Result := ScaleFactor.Apply(DefaultFooterLineHeight);
  // GridView.OptionsView.HeaderHeight; {PS 3.03}
end;
...
function TdxGridTableViewAdapter.GetFooterViewParams
  (ARecord: TcxCustomGridRecord; AGroupLevel: Integer; AColumn: TcxGridColumn;
  AItem: TcxDataSummaryItem): TcxViewParams;
begin
  if (AColumn <> nil) and (AColumn.Styles <> nil) then
    Styles.GetFooterCellParams(TcxCustomGridRow(ARecord), AColumn, AGroupLevel,
      AItem, Result)
  else
    Styles.GetFooterParams(TcxCustomGridRow(ARecord), AColumn, AGroupLevel,
      AItem, Result);
end;

function TdxGridTableViewAdapter.GetGroupRowViewParams
  (ARecord: TcxCustomGridRecord; AGroupLevel: Integer): TcxViewParams;
begin
  if (AGroupLevel >= 0) and (AGroupLevel < Styles.GridView.GroupedItemCount)
  then
...
function TdxGridTableViewAdapter.GetHeaderViewParams(AColumn: TcxGridColumn)
  : TcxViewParams;
begin
  if (AColumn <> nil) and (AColumn.Styles <> nil) then
...
function TdxGridTableViewAdapter.GetPreviewViewParams
  (ARecord: TcxCustomGridRecord; AnItem: TcxCustomGridTableItem): TcxViewParams;
begin
...
function TdxGridTableViewAdapter.GetGroupedColumn(Index: Integer)
  : TcxGridColumn;
begin
...
function TdxGridTableViewAdapter.GetInternalColumnMinWidth
  (Column: TcxGridColumn): Integer;
begin
...
function TdxGridTableViewAdapter.GetInternalColumnWidth
  (Column: TcxGridColumn): Integer;
begin
  Result := Column.Width;
  if Column.IsMostLeft then
...
function TdxGridTableViewAdapter.GetRecordHelper(ARecord: TcxCustomGridRecord)
  : TdxCustomGridRowHelper;
begin
...
constructor TdxCustomGridTableViewItemPlaceController.Create
  (AFormatter: TdxGridTableViewFormatter);
begin
  inherited Create;
...
function TdxCustomGridTableViewItemPlaceController.
  CalculateHeaderLineCount: Integer;
begin
  Result := 1;
end;
...
function TdxCustomGridTableViewItemPlaceController.GetItemByColumn
...
constructor TdxGridTableViewColumnPlace.Create(AController
  : TdxGridTableViewColumnPlaceController; AColumn: TcxGridColumn);
begin
  inherited Create;
...
procedure TdxGridTableViewColumnPlace.InitAutoWidthItem
...
begin
  ...
  InflateRect(Result, -Adapter.ScaleFactor.Apply(FooterItemInflateHorz),
    -Adapter.ScaleFactor.Apply(FooterItemInflateVert));
  if Column.IsMostLeft then
    Inc(Result.Left, 2);
end;
...
function TdxGridTableViewColumnPlace.GetGroupFooterCellBounds
...
constructor TdxGridTableViewColumnPlaceController.Create
  (AFormatter: TdxGridTableViewFormatter);
begin
  inherited;
...
function TdxGridTableViewColumnPlaceController.IndexOf
  (AnItem: TdxGridTableViewColumnPlace): Integer;
begin
...
function TdxGridTableViewColumnPlaceController.GetItemByColumn
  (Column: TcxGridColumn): TdxGridTableViewColumnPlace;
var
  Index: Integer;
begin
  ...
  if Index <> -1 then
  // might be -1 when we are in loading stage (Building report while loading form)
    Result := Items[Index]
  else
    Result := nil;
end;
...
function TdxGridTableViewColumnPlaceController.CreateItem
  (AColumn: TcxGridColumn): TdxGridTableViewColumnPlace;
begin
  Result := GetItemClass(AColumn).Create(Self, AColumn);
  FItems.Add(Result);
end;

function TdxGridTableViewColumnPlaceController.GetItemClass
  (AColumn: TcxGridColumn): TdxGridTableViewColumnPlaceClass;
begin
  Result := TdxGridTableViewColumnPlace;
end;

function TdxGridTableViewColumnPlaceController.CalculateItemLeftBound
  (AnItem: TdxGridTableViewColumnPlace): Integer;
var
  I: Integer;
begin
...
function TdxGridTableViewColumnPlaceController.GetAdapter
  : TdxGridTableViewAdapter;
begin
  Result := Formatter.Adapter;
end;

function TdxGridTableViewColumnPlaceController.GetColumnIndex
  (Column: TcxGridColumn): Integer;
var
...
function TdxGridTableViewColumnPlaceController.GetItem(Index: Integer)
  : TdxGridTableViewColumnPlace;
begin
...
constructor TdxGridTableViewReportDataAdapter.Create
  (ABuilder: TdxCustomGridViewBuilder);
begin
  inherited Create;
  FBuilder := ABuilder;
...
function TdxGridTableViewReportDataAdapter.GetReportRow(Index: Integer)
  : TdxReportCell;
begin
  Result := Builder.ReportRows[Index];
end;

function TdxGridTableViewReportDataAdapter.GetReportRowByGridRow
  (Row: TcxCustomGridRow): TdxReportCell;
var
  I: Integer;
begin
...
constructor TdxGridTableViewFormatter.Create
  (ABuilder: TdxCustomGridViewBuilder);
begin
  inherited;
...
procedure TdxGridTableViewFormatter.DoInitializeFooterItem
  (AnItem: TAbstractdxReportCellData; AnIndex: Integer;
...
begin
  ...
  begin
    ...
    Text := AItem.FormatValue(Adapter.Summary.FooterSummaryValues
      [AnIndex], True);
...
procedure TdxGridTableViewFormatter.DoReportLinkInitializeFooterItem
  (AnItem: TAbstractdxReportCellData; AnIndex: Integer);
begin
  ReportLink.DoInitializeFooterCell(Adapter.GridView, nil, Columns[AnIndex], 0,
...
function TdxGridTableViewFormatter.GetFooterItemClass(AnIndex: Integer)
...
procedure TdxGridTableViewFormatter.DoInitializeGroupFooterHost
  (AnItem: TdxReportVisualItem; ARecord: TcxCustomGridRecord;
  AGroupLevel: Integer);
begin
  SetViewParams(AnItem, GetGroupFooterItemViewParams(nil, AGroupLevel,
    nil, nil));
  if HasBackgroundBitmap(bbFooter) then
    AnItem.BackgroundBitmapIndex := GetBackgroundBitmapIndex(bbFooter);
...
procedure TdxGridTableViewFormatter.DoInitializeGroupFooterItem
  (AnItem: TAbstractdxReportCellData; ARecord: TcxCustomGridRecord;
  AGroupLevel: Integer; const AValue: Variant; AItem: TcxDataSummaryItem);
var
  AColumn: TcxGridColumn;
begin
  AColumn := TcxGridColumn(AItem.ItemLink);
  SetViewParams(AnItem, GetGroupFooterItemViewParams(ARecord, AGroupLevel,
    AColumn, AItem));
  if HasBackgroundBitmap(bbFooter) then
    AnItem.BackgroundBitmapIndex := GetBackgroundBitmapIndex(bbFooter);
  RegisterLookAndFeelItem(AnItem, cesSunken);
...
procedure TdxGridTableViewFormatter.DoInitializeGroupFooterRow
  (ARow: TdxReportCell; ARecord: TcxCustomGridRecord; AGroupLevel: Integer);
begin
...
procedure TdxGridTableViewFormatter.DoReportLinkInitializeGroupFooterItem
  (AnItem: TAbstractdxReportCellData; AColumn: TcxGridColumn;
...
function TdxGridTableViewFormatter.GetGroupFooterItemBounds(AnIndex,
  AGroupLevel: Integer): TRect;
var
  Item: TdxGridTableViewColumnPlace;
begin
  Item := ItemPlaceController[Columns[AnIndex]];
...
function TdxGridTableViewFormatter.GetGroupFooterItemClass(AnIndex: Integer)
  : TdxReportCellTextClass;
begin
  Result := TdxReportCellString;
end;

function TdxGridTableViewFormatter.GetGroupFooterItemViewParams
  (ARecord: TcxCustomGridRecord; AGroupLevel: Integer; AColumn: TcxGridColumn;
  AItem: TcxDataSummaryItem): TdxReportItemViewParams;
begin
  if ReportLink.OptionsFormatting.UseNativeStyles then
    ReportLink.Styles.GetFooterParams(ARecord, AGroupLevel, AColumn,
      Result.NativeParams)
  else
    Result.NativeParams := Adapter.GetFooterViewParams(ARecord, AGroupLevel,
      AColumn, AItem);
...
procedure TdxGridTableViewFormatter.DoInitializeGroupRowItem
  (AnItem: TAbstractdxReportCellData; ARow: TcxGridGroupRow; AIndex: Integer;
  const AText: string);
begin
  if not ReportLink.OptionsFormatting.UseNativeStyles and
    IsDelphiObject(AnItem.Data) and
    (TObject(AnItem.Data) is TcxGridSummaryItemInfo) then
    SetViewParams(AnItem, Adapter.GridLines, TcxGridSummaryItemInfo(AnItem.Data)
      .ViewParams)
  else
...
function TdxGridTableViewFormatter.GetGroupRowViewParams
...
procedure TdxGridTableViewFormatter.DoInitializeGroupRowSeparator
  (ASeparator: TAbstractdxReportCellData);
begin
  ASeparator.CellSides := csAll;
  ASeparator.Color := GroupRowSeparatorColor;
  ASeparator.Transparent := IsColorTransparent(ASeparator.Color);
  // ReportLink.Transparent;
end;

procedure TdxGridTableViewFormatter.DoInitializeGroupSeparatorRow
  (ARow: TdxReportCell);
begin
  ARow.CellSides := csLeftRight;
  ARow.Transparent := True;
...
function TdxGridTableViewFormatter.GetGroupRowSeparatorClass
  : TdxReportCellDataClass;
begin
  Result := TdxReportCellBox;
end;

procedure TdxGridTableViewFormatter.DoInitializeHeaderItem
  (AnItem: TAbstractdxReportCellData; AnIndex: Integer);
var
  Column: TcxGridColumn;
begin
  ...
  begin
    ...
    begin
      ...
      ImageLayout := HeaderImageLayoutMap[Column.HeaderGlyphAlignmentHorz,
        Column.HeaderGlyphAlignmentVert];
...
procedure TdxGridTableViewFormatter.DoReportLinkInitializeHeaderItem
  (AnItem: TAbstractdxReportCellData; AnIndex: Integer);
begin
  ReportLink.DoInitializeHeaderCell(Adapter.GridView, Columns[AnIndex],
    TdxReportCellString(AnItem));
end;
...
function TdxGridTableViewFormatter.GetHeaderItemClass(AnIndex: Integer)
  : TdxReportCellTextClass;
begin
  Result := TdxReportCellImage;
end;

function TdxGridTableViewFormatter.GetHeaderItemViewParams
  (AColumn: TcxGridColumn): TdxReportItemViewParams;
begin
  if ReportLink.OptionsFormatting.UseNativeStyles then
...
function TdxGridTableViewFormatter.CreateIndent(AParent: TdxReportCell)
  : TdxReportCellExpandButton;
begin
  Result := GetIndentClass.Create(AParent);
end;

procedure TdxGridTableViewFormatter.DoInitializeDataRowIndent
  (AnIndent: TdxReportCellExpandButton; AnIndex, AnIndentCount: Integer;
  ARecord: TcxCustomGridRecord);
begin
  SetViewParams(AnIndent, GetIndentViewParams(ARecord, AnIndex,
    AnIndentCount, False));
  if HasBackgroundBitmap(bbGroup) then
    AnIndent.BackgroundBitmapIndex := GetBackgroundBitmapIndex(bbGroup);
end;

procedure TdxGridTableViewFormatter.DoInitializeGroupFooterIndent
  (AnIndent: TdxReportCellExpandButton; AnIndex, AnIndentCount: Integer;
  ARecord: TcxCustomGridRecord);
begin
  SetViewParams(AnIndent, GetIndentViewParams(ARecord, AnIndex,
...
procedure TdxGridTableViewFormatter.DoInitializeGroupRowIndent
  (AnIndent: TdxReportCellExpandButton; AnIndex, AnIndentCount: Integer;
  ARecord: TcxCustomGridRecord);
begin
  SetViewParams(AnIndent, GetIndentViewParams(ARecord, AnIndex,
...
procedure TdxGridTableViewFormatter.DoInitializeMasterDataRowIndent
  (AnIndent: TdxReportCellExpandButton; AnIndex, AnIndentCount: Integer;
  ARecord: TcxCustomGridRecord);
begin
  ...
  else if HasBackgroundBitmap(bbGroup) then
    AnIndent.BackgroundBitmapIndex := GetBackgroundBitmapIndex(bbGroup);
  ...
  begin
    ...
    AnIndent.ShowButton := ReportLink.OptionsView.ExpandButtons and
      ARecord.Expandable;
    if AnIndent.ShowButton then
...
procedure TdxGridTableViewFormatter.DoInitializeRowSeparatorIndent
  (AnIndent: TdxReportCellExpandButton; AnIndex, AnIndentCount: Integer;
  ARecord: TcxCustomGridRecord);
begin
  SetViewParams(AnIndent, GetIndentViewParams(ARecord, AnIndex,
...
function TdxGridTableViewFormatter.GetIndentClass
  : TdxReportCellExpandButtonClass;
begin
  if Adapter.IsOffice11StyleGrouping then
...
function TdxGridTableViewFormatter.GetIndentViewParams
  (ARecord: TcxCustomGridRecord; AnIndex, AnIndentCount: Integer;
  ANonRecordIndent: Boolean): TdxReportItemViewParams;

  function IsMasterDataRowIndent: Boolean;
  begin
    with Adapter do
      Result := AnIndex >= GroupedLevelCount -
        Ord(IsOffice11StyleGrouping and not(ARecord is TcxGridGroupRow));
  end;

  function GetRecord: TcxCustomGridRecord;
  begin
    if not ANonRecordIndent and (ARecord is TcxGridGroupRow) and
      (AnIndex = AnIndentCount - 1) then
      Result := ARecord
    else
      Result := nil;
  end;
...
begin
  if ReportLink.OptionsFormatting.UseNativeStyles then
    if IsMasterDataRowIndent then
      ReportLink.Styles.GetContentParams(Adapter.MasterGridRecord, nil,
        Result.NativeParams)
    else
      ReportLink.Styles.GetGroupParams(GetRecord, AnIndex, Result.NativeParams)
  else if IsMasterDataRowIndent then
    Result.NativeParams := Adapter.GetContentViewParams
      (Adapter.MasterGridRecord, nil)
  else
    Result.NativeParams := Adapter.GetGroupRowViewParams(GetRecord, AnIndex);

  Result.CellSides := VertGridLinesMap[Adapter.ShowHorzGridLines];
  // PS3.1  (it was Adapter.ShowVertGridLines)
  if AnIndex = 0 then
...
function TdxGridTableViewFormatter.HasExpandButton
  (ARecord: TcxCustomGridRecord): Boolean;
begin
  Result := ReportLink.OptionsView.ExpandButtons{$IFDEF VER500} and
    Adapter.RecordHelpers[ARecord].HasExpandButton{$ENDIF};
end;
...
procedure TdxGridTableViewFormatter.DoReportLinkInitializeItem
  (AnItem: TAbstractdxReportCellData; AColumn: TcxGridColumn;
  ARecord: TcxCustomGridRecord);
begin
  ReportLink.DoInitializeCell(Adapter.GridView, ARecord, AColumn,
    TdxReportCellString(AnItem));
end;
...
function TdxGridTableViewFormatter.GetItemViewParams
  (ATableItem: TcxCustomGridTableItem; ARecord: TcxCustomGridRecord;
  AnIsPreview: Boolean = False; AIsDataCell: Boolean = False)
  : TdxReportItemViewParams;
var
...
begin
  ...
  begin
    ...
    if TcxGridColumn(ATableItem).IsTop and (ARecord <> nil) and
      (ARecord.Index = 0) then
      Include(ACellSides, csTop);
    if TcxGridColumn(ATableItem).IsMostRight then
      Include(ACellSides, csRight);
    if TcxGridColumn(ATableItem).IsMostLeft and (ARecord <> nil) and ARecord.Expandable
    then
...
procedure TdxGridTableViewFormatter.DoInitializeMasterIndent
  (AnIndent: TdxReportCellExpandButton; AnIndex, AnIndentCount: Integer);
begin
  DoInitializeMasterDataRowIndent(AnIndent, AnIndex, AnIndentCount, nil);
  // Adapter.GroupedColumnCount + 1, nil); //PS3.1 changed
end;

procedure TdxGridTableViewFormatter.DoInitializePreview
  (APreview: TAbstractdxReportCellData; AColumn: TcxGridColumn;
  ARecord: TcxCustomGridRecord);
begin
...
procedure TdxGridTableViewFormatter.DoInitializeSeparatorRow
  (ARow: TdxReportCell);
begin
  ARow.CellSides := csLeftRight;
  ARow.Transparent := True;
...
procedure TdxGridTableViewFormatter.DoInitializeRowSeparator
  (ASeparator: TAbstractdxReportCellData);
begin
  ASeparator.CellSides := csAll;
...
{ IdxPSCellParams2 }
function TdxGridTableViewFormatter.
  IdxPSCellParams2_GetPreviewMarginLeft: Integer;
begin
...
function TdxGridTableViewFormatter.IdxPSCellParams2_GetPreviewMaxHeight
  : Integer;
begin
...
begin
  ...
  begin
    ...
    if not Adapter.GroupFooterHeightAssigned then
      CalculateHeight(GetGroupFooterItemViewParams(nil, -1, Column, nil),
        FGroupFooterLineHeight);
    if not Adapter.DataRowHeightAssigned and not Column.IsPreview then
      CalculateHeight(GetItemViewParams(Column, nil, False),
        FDetailsLineHeight);
  end;
  ...
  if HasPreview then
    CalculateHeight(GetItemViewParams( { PreviewColumn } nil, nil, True),
      FPreviewLineHeight);

  Inc(FFooterLineHeight, 2 * Adapter.ScaleFactor.Apply(FooterItemInflateVert) -
    Adapter.ScaleFactor.Apply(1));
  Inc(FGroupFooterLineHeight, 2 * Adapter.ScaleFactor.Apply
    (FooterItemInflateVert) - Adapter.ScaleFactor.Apply(1));
...
function TdxGridTableViewFormatter.GetItemPlaceControllerClass
  : TdxCustomGridTableViewItemPlaceControllerClass;
begin
  Result := TdxGridTableViewColumnPlaceController;
end;

function TdxGridTableViewFormatter.MapStyleBackgroundBitmapIndex
  (AGridBackgroundBitmapIndex: Integer): Integer;
begin
  case AGridBackgroundBitmapIndex of
    bbFooter:
...
function TdxGridTableViewFormatter.CanColumnCellMerging
...
begin
  ...
  begin
    Column := Columns[I];
    if CanColumnCellMerging(Column) then
    // because Column.CanCellMerging also performs GridView.CellMerging validation
      PerformColumnCellMerging(Column);
  end;
end;

procedure TdxGridTableViewFormatter.PerformColumnCellMerging
  (AColumn: TcxGridColumn);
  ...
  function CompareCellsForMerging(ARow1: TcxGridDataRow;
    AProperties1: TcxCustomEditProperties; const AValue1: TcxEditValue;
    ARow2: TcxGridDataRow; AProperties2: TcxCustomEditProperties;
    const AValue2: TcxEditValue): Boolean;
  begin
    Result := GridColumn_DoCompareValuesForCellMerging(AColumn, ARow1,
      AProperties1, AValue1, ARow2, AProperties2, AValue2);
  end;
  ...
  begin
    ...
    begin
      ...
      ASlaveReportItem.BackgroundBitmapIndex :=
        AMasterReportItem.BackgroundBitmapIndex;
      ...
      repeat
        ...
        begin
          ...
          AAreCellsMerged := CompareCellsForMerging(TcxGridDataRow(ARow1),
            AProperties1, AValue1, TcxGridDataRow(ARow2), AProperties2,
            AValue2);
...
begin
  ...
  begin
    ...
    if IsColumnActuallyVisible(Column) then
      FColumns.Add(Column);
  end;
end;
...
function TdxGridTableViewFormatter.IsColumnActuallyVisible
  (AColumn: TcxGridColumn): Boolean;
begin
...
function TdxGridTableViewFormatter.GetRowHeightByRow
  (Row: TcxCustomGridRow): Integer;
begin
...
procedure TdxGridTableViewFormatter.SetRowHeight(Index: Integer;
  Value: Integer);
begin
  FRowHeights[Index] := TObject(Value);
end;

procedure TdxGridTableViewFormatter.SetRowHeightByRow(Row: TcxCustomGridRow;
  Value: Integer);
begin
...
class function TdxGridTableViewBuilder.FormatterClass
  : TdxGridViewFormatterClass;
begin
  Result := TdxGridTableViewFormatter;
end;

procedure TdxGridTableViewBuilder.AddDelimitersHardVert
...
procedure TdxGridTableViewBuilder.CreateDetails
  (AMasterRow: TcxGridMasterDataRow);
var
...
begin
  ...
  try
    ...
    // Q276990 need for TcxGridDBDataController.DataModeController.DetailInSQLMode = true
  end;
end;

procedure TdxGridTableViewBuilder.CreateDetailView
  (AGridView: TcxCustomGridView);
begin
...
function TdxGridTableViewBuilder.GetFootersProducer
  : TdxGridTableViewFootersProducer;
begin
  Result := ProducerCache[GetFootersProducerClass]
    as TdxGridTableViewFootersProducer;
end;

function TdxGridTableViewBuilder.GetFootersProducerClass
  : TdxGridTableViewFootersProducerClass;
begin
  Result := TdxGridTableViewFootersProducer;
end;

procedure TdxGridTableViewBuilder.CreateGroupFooters
  (AGridRow: TcxCustomGridRow);
var
...
begin
  ...
  for I := 0 to AGridRow.Level do
    ...
    begin
      AddReportRow(Producer.Produce(HostInfo, AGridRow,
        AGridRow.Level - I, Index));
      Inc(Index);
    end;
end;

function TdxGridTableViewBuilder.GetGroupFooterProducer
  : TdxGridTableViewGroupFooterProducer;
begin
  Result := ProducerCache[GetGroupFooterProducerClass]
    as TdxGridTableViewGroupFooterProducer;
end;

function TdxGridTableViewBuilder.GetGroupFooterProducerClass
...
function TdxGridTableViewBuilder.GetHeadersProducer
  : TdxGridTableViewHeadersProducer;
begin
  Result := ProducerCache[GetHeadersProducerClass]
    as TdxGridTableViewHeadersProducer;
end;

function TdxGridTableViewBuilder.GetHeadersProducerClass
  : TdxGridTableViewHeadersProducerClass;
begin
  Result := TdxGridTableViewHeadersProducer;
end;

procedure TdxGridTableViewBuilder.CreateRow(AGridRow: TcxCustomGridRow;
  ARowIndex: Integer);
begin
  AddReportRow(GetRowProducer(AGridRow)
    .Produce(HostInfoServices.PageDetailsHostInfo, AGridRow, ARowIndex));
end;

function TdxGridTableViewBuilder.GetRowProducer(AGridRow: TcxCustomGridRow)
  : TdxGridTableViewCustomDataRowProducer;
begin
  Result := ProducerCache[GetRowProducerClass(AGridRow)
    ] as TdxGridTableViewCustomDataRowProducer;
end;
...
begin
  ...
  begin
    ...
    if (ShowRowSeparators and (I > 0)) and
      (not(PrevGridRow is TcxGridGroupRow) or not ShowGroupRowSeparators) then
    ...
    // Last Row Separator
    if (ShowRowSeparators and (I = Formatter.RowCount - 1)) and
      (not(GridRow is TcxGridGroupRow) or not ShowGroupRowSeparators) then
...
function TdxGridTableViewBuilder.GetRowProducerClass(AGridRow: TcxCustomGridRow)
...
begin
  ...
  if (AProducerClass = nil) or not AProducerClass.InheritsFrom
    (TdxGridTableViewCustomDataRowProducer) then
...
function TdxGridTableViewBuilder.GetRowSeparatorProducer
  : TdxGridTableViewRowSeparatorProducer;
begin
  Result := ProducerCache[GetRowSeparatorProducerClass]
    as TdxGridTableViewRowSeparatorProducer;
end;

function TdxGridTableViewBuilder.GetRowSeparatorProducerClass
  : TdxGridTableViewRowSeparatorProducerClass;
begin
...
procedure TdxGridTableViewBuilder.CreateGroupRowSeparator
  (AGridRow: TcxGridGroupRow);
begin
  AddReportRow(GetGroupRowSeparatorProducer.Produce
    (HostInfoServices.PageDetailsHostInfo, AGridRow));
end;

function TdxGridTableViewBuilder.GetGroupRowSeparatorProducer
  : TdxGridTableViewGroupRowSeparatorProducer;
begin
  Result := ProducerCache[GetGroupRowSeparatorProducerClass]
    as TdxGridTableViewGroupRowSeparatorProducer;
end;

function TdxGridTableViewBuilder.GetGroupRowSeparatorProducerClass
  : TdxGridTableViewGroupRowSeparatorProducerClass;
begin
...
function TdxGridDBTableViewAdapter.DBDataModeController
...
class function TcxGridServerModeTableViewAdapter.GridViewClass
  : TcxCustomGridViewClass;
begin
  Result := TcxGridServerModeTableView;
end;

function TcxGridServerModeTableViewAdapter.DataController
...
function TcxGridServerModeTableViewBuilder.Adapter
  : TcxGridServerModeTableViewAdapter;
begin
  Result := inherited Adapter as TcxGridServerModeTableViewAdapter;
end;

class function TcxGridServerModeTableViewBuilder.AdapterClass
  : TdxGridViewAdapterClass;
begin
  Result := TcxGridServerModeTableViewAdapter;
end;

class function TcxGridServerModeTableViewBuilder.GridViewClass
  : TcxCustomGridViewClass;
begin
  Result := TcxGridServerModeTableView;
end;
...
constructor TdxGridBandedTableViewAdapter.Create(AMasterAdapter
  : TdxCustomGridViewAdapter; AGridView: TcxCustomGridView);
begin
  inherited;
  FFooterLineCount := -1;
...
class function TdxGridBandedTableViewAdapter.GridViewClass
  : TcxCustomGridViewClass;
begin
  Result := TcxGridBandedTableView;
end;
...
function TdxGridBandedTableViewAdapter.GetBandHeaderViewParams
  (ABand: TcxGridBand): TcxViewParams;
begin
...
function TdxGridBandedTableViewAdapter.GetHeaderMultiline
  (Column: TcxGridColumn): Boolean;
begin
...
begin
  Result := BandHeaderHeightAssigned;
  // or (BandHeaderLineCount > 1); {!!! v3.03}
end;

function TdxGridBandedTableViewAdapter.GetBottomBand(Index: Integer)
  : TcxGridBand;
begin
...
function TdxGridBandedTableViewAdapter.GetColumn(Index: Integer)
  : TcxGridBandedColumn;
begin
  Result := GridView.VisibleColumns[Index];
end;
...
function TdxGridBandedTableViewColumnPlace.GetController
  : TdxCustomGridBandedTableViewItemPlace;
begin
  Result := inherited Controller as TdxCustomGridBandedTableViewItemPlace;
end;

function TdxGridBandedTableViewColumnPlace.GetFormatter
...
constructor TdxCustomGridBandedTableViewItemPlace.Create
  (AController: TdxGridBandedTableViewItemPlaceController;
  AParent: TdxGridBandedTableViewItemPlace; ABand: TcxGridBand);
begin
...
function TdxCustomGridBandedTableViewItemPlace.CalculateHeaderLineCount
  : Integer;
var
  I: Integer;
begin
...
function TdxCustomGridBandedTableViewItemPlace.GetItemClass
  (AColumn: TcxGridColumn): TdxGridTableViewColumnPlaceClass;
begin
...
begin
  Result := InternalCalculateMinWidth;
  if Result < Band.MinWidth then
    Result := Band.MinWidth;
end;
...
function TdxCustomGridBandedTableViewItemPlace.
  InternalCalculateMinWidth: Integer;
begin
  Result := 0;
end;
...
procedure TdxCustomGridBandedTableViewItemPlace.InitAutoWidthItem
  (AnItem: TcxAutoWidthItem);
begin
  AnItem.Fixed := IsFixed;
  AnItem.MinWidth := MinWidth;
...
function TdxCustomGridBandedTableViewItemPlace.GetAdapter
  : TdxGridBandedTableViewAdapter;
begin
...
function TdxCustomGridBandedTableViewItemPlace.GetFormatter
  : TdxGridBandedTableViewFormatter;
begin
  Result := inherited Formatter as TdxGridBandedTableViewFormatter;
end;
...
function TdxCustomGridBandedTableViewItemPlace.GetViewParams
  : TdxReportItemViewParams;
begin
...
constructor TdxGridBandedTableViewItemPlace.Create
  (AnOwner: TdxGridBandedTableViewItemPlaceController;
  AParent: TdxGridBandedTableViewItemPlace; ABand: TcxGridBand);
begin
  inherited;
...
function TdxGridBandedTableViewItemPlace.IndexOf
  (AnItem: TdxCustomGridBandedTableViewItemPlace): Integer;
begin
...
function TdxGridBandedTableViewItemPlace.GetChildItem(Index: Integer)
  : TdxCustomGridBandedTableViewItemPlace;
begin
...
function TdxGridBandedTableViewBottomItemPlace.CalculateItemLeftBound
  (AnItem: TdxGridTableViewColumnPlace): Integer;
var
  Row: TcxGridBandRow;
  I: Integer;
...
begin
  ...
  for I := 0 to TdxGridBandedTableViewColumnPlace(AnItem)
    .Column.Position.VisibleColIndex - 1 do
  begin
...
begin
  ...
  begin
    ...
    try
      for J := 0 to Row.VisibleCount - 1 do
        ItemsByColumn[Row.VisibleItems[J]].InitAutoWidthItem
          (AutoWidthObject.AddItem);
      AutoWidthObject.AvailableWidth := ItemsAvailableWidth;
      AutoWidthObject.Calculate;
...
function TdxGridBandedTableViewBottomItemPlace.
  InternalCalculateMinWidth: Integer;
var
  I, V, J: Integer;
  Row: TcxGridBandRow;
...
constructor TdxGridBandedTableViewItemPlaceController.Create
  (AFormatter: TdxGridTableViewFormatter);
begin
  inherited;
...
function TdxGridBandedTableViewItemPlaceController.IndexOf
  (AnItem: TdxCustomGridBandedTableViewItemPlace): Integer;
begin
  Result := FItems.IndexOf(AnItem);
end;
...
function TdxGridBandedTableViewItemPlaceController.RootIndexOf
  (AnItem: TdxCustomGridBandedTableViewItemPlace): Integer;
begin
...
function TdxGridBandedTableViewItemPlaceController.GetItemByColumn
  (Column: TcxGridColumn): TdxGridTableViewColumnPlace;
var
...
function TdxGridBandedTableViewItemPlaceController.CalculateItemHeight
  (AnItem: TdxCustomGridBandedTableViewItemPlace): Integer;
var
  I: Integer;
begin
...
function TdxGridBandedTableViewItemPlaceController.CalculateItemLeftBound
  (AnItem: TdxCustomGridBandedTableViewItemPlace): Integer;
var
  I: Integer;
begin
...
function TdxGridBandedTableViewItemPlaceController.CalculateItemTopBound
  (AnItem: TdxCustomGridBandedTableViewItemPlace): Integer;
var
  I: Integer;
begin
...
function TdxGridBandedTableViewItemPlaceController.CreateItem
  (ABand: TcxGridBand): TdxCustomGridBandedTableViewItemPlace;
begin
  Result := GetItemClass(ABand).Create(Self, nil, ABand);
end;

function TdxGridBandedTableViewItemPlaceController.GetItemClass
  (ABand: TcxGridBand): TdxCustomGridBandedTableViewItemPlaceClass;
begin
...
function TdxGridBandedTableViewItemPlaceController.GetAdapter
  : TdxGridBandedTableViewAdapter;
begin
  Result := Formatter.Adapter;
end;
...
function TdxGridBandedTableViewItemPlaceController.GetBottomItem(Index: Integer)
  : TdxCustomGridBandedTableViewItemPlace;
begin
...
function TdxGridBandedTableViewItemPlaceController.GetFormatter
  : TdxGridBandedTableViewFormatter;
begin
  Result := inherited Formatter as TdxGridBandedTableViewFormatter;
end;
...
function TdxGridBandedTableViewItemPlaceController.GetItem(Index: Integer)
  : TdxCustomGridBandedTableViewItemPlace;
begin
  Result := TdxCustomGridBandedTableViewItemPlace(FItems[Index]);
end;

function TdxGridBandedTableViewItemPlaceController.GetItemByBand
  (Band: TcxGridBand): TdxCustomGridBandedTableViewItemPlace;
var
  Index: Integer;
begin
  Index := IndexOf(Band);
...
function TdxGridBandedTableViewItemPlaceController.GetLevelHeight
  (Index: Integer): Integer;
begin
  Result := Integer(FLevelHeights[Index]);
end;

function TdxGridBandedTableViewItemPlaceController.GetRootItem(Index: Integer)
  : TdxCustomGridBandedTableViewItemPlace;
begin
...
procedure TdxGridBandedTableViewItemPlaceController.SetLevelHeight
...
constructor TdxGridBandedTableViewFormatter.Create
  (ABuilder: TdxCustomGridViewBuilder);
begin
  inherited;
  FBands := TList.Create;
...
procedure TdxGridBandedTableViewFormatter.DoInitializeBandItem
  (AnItem: TAbstractdxReportCellData; AnIndex: Integer);
var
  Band: TcxGridBand;
begin
...
procedure TdxGridBandedTableViewFormatter.DoInitializeBandRow
  (ARow: TdxReportCell);
begin
...
procedure TdxGridBandedTableViewFormatter.DoReportLinkInitializeBandItem
  (AnItem: TAbstractdxReportCellData; AnIndex: Integer);
begin
  ReportLink.DoInitializeBandCell(Adapter.GridView, Bands[AnIndex],
    TdxReportCellString(AnItem));
end;

function TdxGridBandedTableViewFormatter.GetBandItemBounds
...
function TdxGridBandedTableViewFormatter.GetBandItemClass(AnIndex: Integer)
  : TdxReportCellTextClass;
begin
  Result := TdxReportCellString;
end;

function TdxGridBandedTableViewFormatter.GetBandItemViewParams
  (ABand: TcxGridBand): TdxReportItemViewParams;
begin
  if ReportLink.OptionsFormatting.UseNativeStyles then
...
function TdxGridBandedTableViewFormatter.CanColumnCellMerging
  (AColumn: TcxGridColumn): Boolean;
begin
  Result := inherited CanColumnCellMerging(AColumn) and
    (TcxGridBandedColumn(AColumn).Position.LineCount = ItemPlaceController.
    HeaderLineCount);
end;

function TdxGridBandedTableViewFormatter.IsColumnActuallyVisible
  (AColumn: TcxGridColumn): Boolean;
begin
...
function TdxGridBandedTableViewFormatter.GetItemPlaceControllerClass
  : TdxCustomGridTableViewItemPlaceControllerClass;
begin
...
begin
  ...
  begin
    ...
    if IsBandActuallyVisible(Band) then
      FBands.Add(Band);
  end;
end;
...
function TdxGridBandedTableViewFormatter.IsBandActuallyVisible
  (ABand: TcxGridBand): Boolean;
begin
  Result := ABand.ActuallyVisible;
end;

function TdxGridBandedTableViewFormatter.MapStyleBackgroundBitmapIndex
  (AGridBackgroundBitmapIndex: Integer): Integer;
begin
  case AGridBackgroundBitmapIndex of
    bbBandHeader:
...
function TdxGridBandedTableViewFormatter.GetColumn(Index: Integer)
  : TcxGridBandedColumn;
begin
  Result := inherited Columns[Index] as TcxGridBandedColumn;
end;

function TdxGridBandedTableViewFormatter.GetItemPlaceController
  : TdxGridBandedTableViewItemPlaceController;
begin
  Result := inherited ItemPlaceController as
    TdxGridBandedTableViewItemPlaceController;
end;
...
class function TdxGridBandedTableViewBuilder.AdapterClass
  : TdxGridViewAdapterClass;
begin
  Result := TdxGridBandedTableViewAdapter;
end;

function TdxGridBandedTableViewBuilder.Formatter
  : TdxGridBandedTableViewFormatter;
begin
  Result := inherited Formatter as TdxGridBandedTableViewFormatter;
end;

class function TdxGridBandedTableViewBuilder.FormatterClass
  : TdxGridViewFormatterClass;
begin
...
begin
  if Formatter.ShowBandHeaders then
    CreateBands;
  if Formatter.ShowHeaders then
    CreateHeader;
  CreateRows;
  if Formatter.ShowFooters then
    CreateFooter;
end;
...
function TdxGridBandedTableViewBuilder.GetBandsProducer
  : TdxGridTableViewBandsProducer;
begin
  Result := ProducerCache[GetBandsProducerClass]
    as TdxGridTableViewBandsProducer;
end;

function TdxGridBandedTableViewBuilder.GetBandsProducerClass
  : TdxGridTableViewBandsProducerClass;
begin
...
class function TdxGridBandedTableViewBuilder.GridViewClass
  : TcxCustomGridViewClass;
begin
  Result := TcxGridBandedTableView;
end;
...
class function TdxGridDBBandedTableViewAdapter.GridViewClass
  : TcxCustomGridViewClass;
begin
  Result := TcxGridDBBandedTableView;
end;

function TdxGridDBBandedTableViewAdapter.DataController
  : TcxGridDBDataController;
begin
  Result := TcxGridDBDataController(inherited DataController);
end;

function TdxGridDBBandedTableViewAdapter.DBDataModeController
  : TcxDBDataModeController;
begin
  Result := DataController.DataModeController;
end;
...
function TdxGridDBBandedTableViewBuilder.Adapter
  : TdxGridDBBandedTableViewAdapter;
begin
  Result := inherited Adapter as TdxGridDBBandedTableViewAdapter;
end;

class function TdxGridDBBandedTableViewBuilder.AdapterClass
  : TdxGridViewAdapterClass;
begin
  Result := TdxGridDBBandedTableViewAdapter;
end;

class function TdxGridDBBandedTableViewBuilder.GridViewClass
  : TcxCustomGridViewClass;
begin
  Result := TcxGridDBBandedTableView;
end;
...
function TdxGridServerModeBandedTableViewAdapter.GridView
  : TcxGridServerModeBandedTableView;
begin
  Result := inherited GridView as TcxGridServerModeBandedTableView;
end;

class function TdxGridServerModeBandedTableViewAdapter.GridViewClass
  : TcxCustomGridViewClass;
begin
  Result := TcxGridServerModeBandedTableView;
end;

function TdxGridServerModeBandedTableViewAdapter.DataController
  : TdxServerModeDataController;
begin
  Result := TdxServerModeDataController(inherited DataController);
end;
...
function TdxGridServerModeBandedTableViewBuilder.Adapter
  : TdxGridServerModeBandedTableViewAdapter;
begin
  Result := inherited Adapter as TdxGridServerModeBandedTableViewAdapter;
end;

class function TdxGridServerModeBandedTableViewBuilder.AdapterClass
  : TdxGridViewAdapterClass;
begin
  Result := TdxGridServerModeBandedTableViewAdapter;
end;

class function TdxGridServerModeBandedTableViewBuilder.GridViewClass
  : TcxCustomGridViewClass;
begin
  Result := TcxGridServerModeBandedTableView;
end;
...
procedure TdxReportWinExplorerViewRecord.CalculateSize
...
function TdxReportWinExplorerViewRecord.GetGridRecord
  : TcxGridWinExplorerViewCustomRecord;
begin
...
function TdxReportWinExplorerViewDataRecord.GetGridRecord
  : TcxGridWinExplorerViewDataRecord;
begin
...
function TdxReportWinExplorerViewGroupRecord.GetGridRecord
...
function TdxGridWinExplorerViewFormatter.GetItemViewParams
  (ATableItem: TcxCustomGridTableItem; ARecord: TcxCustomGridRecord;
  AnIsPreview: Boolean = False; AIsDataCell: Boolean = False)
  : TdxReportItemViewParams;
begin
...
procedure TdxGridWinExplorerViewFormatter.DoInitializeItem
  (AnItem: TAbstractdxReportCellData; ATableItem: TcxCustomGridTableItem;
  ARecord: TcxCustomGridRecord; AnIsPreview: Boolean = False);
var
...
begin
  ...
  if (AnItem is TdxReportCellString) and (AItem <> nil) and
    (Adapter.IsGridItemCaption(AItem) or Adapter.IsGridItemDescription(AItem))
  then
  begin
...
function TdxGridWinExplorerViewFormatter.CreateDataCell
  (AParent: TdxReportWinExplorerViewRecord; AItem: TcxGridWinExplorerViewItem)
  : TAbstractdxReportCellData;
begin
...
procedure TdxGridWinExplorerViewFormatter.DoInitializeRecord
  (ARecord: TdxReportWinExplorerViewRecord);
begin
  SetViewParams(ARecord, GetRecordViewParams(ARecord));
end;

function TdxGridWinExplorerViewFormatter.GetCaptionItemViewParams
  (ATableItem: TcxCustomGridTableItem; ARecord: TcxCustomGridRecord;
  AnIsPreview: Boolean = False): TdxReportItemViewParams;
begin
  if not(ReportLink.OptionsFormatting.UseNativeStyles or
    CanProcessSelectionStyle(ARecord) or AnIsPreview) then
  begin
    FillChar(Result, 0, SizeOf(Result));
    Result.NativeParams := Adapter.GetCaptionItemViewParams(ARecord,
      TcxGridWinExplorerViewItem(ATableItem));
    Result.CellSides := [];
    Result.FontStyle := [];
  end
  else
...
function TdxGridWinExplorerViewFormatter.GetRecordViewParams
  (ARecord: TdxReportWinExplorerViewRecord): TdxReportItemViewParams;
begin
...
function TdxGridWinExplorerViewFormatter.GetRecord(Index: Integer)
  : TcxGridWinExplorerViewCustomRecord;
begin
...
function TdxGridWinExplorerViewAdapter.GetCaptionItemViewParams
  (ARecord: TcxCustomGridRecord; ATableItem: TcxGridWinExplorerViewItem)
  : TcxViewParams;
begin
  if (ATableItem <> nil) and (ATableItem.Styles <> nil) then
...
function TdxGridWinExplorerViewAdapter.IsGridItemCaption
  (AGridItem: TcxGridWinExplorerViewItem): Boolean;
begin
  Result := GridView.ItemSet.TextItem = AGridItem;
end;

function TdxGridWinExplorerViewAdapter.IsGridItemDescription
  (AGridItem: TcxGridWinExplorerViewItem): Boolean;
begin
  Result := GridView.ItemSet.DescriptionItem = AGridItem;
end;

function TdxGridWinExplorerViewAdapter.GetContentViewParams
  (ARecord: TcxCustomGridRecord; ATableItem: TcxCustomGridTableItem;
  AIsDataCell: Boolean = False): TcxViewParams;
var
  AItem: TcxGridWinExplorerViewItem;
...
class function TdxGridWinExplorerViewBuilder.AdapterClass
  : TdxGridViewAdapterClass;
begin
  Result := TdxGridWinExplorerViewAdapter;
end;

function TdxGridWinExplorerViewBuilder.Formatter
  : TdxGridWinExplorerViewFormatter;
begin
  Result := inherited Formatter as TdxGridWinExplorerViewFormatter;
end;

class function TdxGridWinExplorerViewBuilder.FormatterClass
  : TdxGridViewFormatterClass;
begin
...
procedure TdxGridWinExplorerViewBuilder.CreateRecord
  (AGridRecord: TcxGridWinExplorerViewCustomRecord);
var
  ARecord: TdxReportWinExplorerViewRecord;
...
function TdxGridWinExplorerViewBuilder.GetRecordProducer
  ...
  : TdxGridWinExplorerViewRecordProducer;
begin
  Result := ProducerCache[GetRecordProducerClass(AGridRecord)
    ] as TdxGridWinExplorerViewRecordProducer;
end;

function TdxGridWinExplorerViewBuilder.GetRecordProducerClass
  (AGridRecord: TcxGridWinExplorerViewCustomRecord)
  : TdxGridViewRowProducerClass;
begin
...
class function TdxGridWinExplorerViewBuilder.GridViewClass
  : TcxCustomGridViewClass;
begin
  Result := TcxGridWinExplorerView;
end;

procedure TdxGridWinExplorerViewBuilder.InjectRecord
  (ARecord: TdxReportWinExplorerViewRecord; AParent: TdxReportCell;
  AIndex: Integer);
...
procedure TdxGridWinExplorerViewBuilder.PlaceRecords;
  ...
  begin
    ...
    begin
      ...
      ARowHeight := GetMaxRecordHeight(AStartIndex, AEndIndex) +
        Formatter.GetInterRecordsSpaceVert;
      AReportRow := AProducer.Produce(HostInfoServices.PageDetailsHostInfo,
        ARowHeight);
...
function TdxGridWinExplorerViewBuilder.GetRecord(Index: Integer)
  : TdxReportWinExplorerViewRecord;
begin
...
function TdxGridDBWinExplorerViewAdapter.DataController
  : TcxGridDBDataController;
begin
  Result := inherited DataController as TcxGridDBDataController;
end;

function TdxGridDBWinExplorerViewAdapter.DBDataModeController
  : TcxDBDataModeController;
begin
  Result := DataController.DataModeController;
end;
...
class function TdxGridDBWinExplorerViewBuilder.AdapterClass
  : TdxGridViewAdapterClass;
begin
  Result := TdxGridDBWinExplorerViewAdapter;
end;

class function TdxGridDBWinExplorerViewBuilder.GridViewClass
  : TcxCustomGridViewClass;
begin
...
procedure TdxGridCustomLayoutViewAdapter.ExpandAllRows(AnOptionsExpanding
  : TdxGridReportLinkOptionsExpanding; ARecursive: Boolean);
begin
  if AnOptionsExpanding.ExpandCards then
...
procedure TdxGridCardViewAdapter.GetVisibleCardRows(ACard: TcxGridCard;
  AList: TList);
begin
  ACard.GetVisibleRows(AList);
end;

function TdxGridCardViewAdapter.IsFirstRow(ACardRow: TcxGridCardViewRow)
  : Boolean;
begin
  Result := ACardRow.VisibleIndex = 0;
end;

function TdxGridCardViewAdapter.IsLastRow(ACardRow: TcxGridCardViewRow)
  : Boolean;
begin
...
function TdxGridCardViewAdapter.GetCaptionRowViewParams
  (ARecord: TcxCustomGridRecord; ACardRow: TcxGridCardViewRow): TcxViewParams;
begin
...
function TdxGridCardViewAdapter.GetCardViewParams(ARecord: TcxCustomGridRecord)
  : TcxViewParams;
begin
  Styles.GetContentParams(ARecord, nil, Result);
end;

function TdxGridCardViewAdapter.GetContentViewParams
  (ARecord: TcxCustomGridRecord; ATableItem: TcxCustomGridTableItem;
  AIsDataCell: Boolean = False): TcxViewParams;
begin
...
function TdxGridCardViewAdapter.GetRowCaptionViewParams
  (ARecord: TcxCustomGridRecord; ACardRow: TcxGridCardViewRow): TcxViewParams;
begin
...
function TdxGridCustomLayoutViewFormatter.Adapter
  : TdxGridCustomLayoutViewAdapter;
begin
  Result := inherited Adapter as TdxGridCustomLayoutViewAdapter;
end;

function TdxGridCustomLayoutViewFormatter.Builder
...
procedure TdxGridCustomLayoutViewFormatter.DoInitializeRecord
  (ARecord: TdxReportCustomLayoutRecord;
  AGridRecord: TcxGridCustomLayoutRecord);
begin
  ARecord.Data := TdxNativeInt(AGridRecord);
end;

procedure TdxGridCustomLayoutViewFormatter.DoInitializeRecordRow
  (ARecord: TdxReportCell);
begin
...
begin
  ...
  if AMasterBuilder <> nil then
  begin
    Result := AMasterBuilder.Formatter.ViewWidth -
      AMasterBuilder.Adapter.ViewWidthExtra;
    if HasDetailsSeparator then
...
function TdxGridCustomLayoutViewFormatter.GetItemViewParams
  (ATableItem: TcxCustomGridTableItem; ARecord: TcxCustomGridRecord;
  AnIsPreview: Boolean = False; AIsDataCell: Boolean = False)
  : TdxReportItemViewParams;
begin
  if ReportLink.OptionsFormatting.UseNativeStyles then
    if AIsDataCell then
      ...
      ReportLink.Styles.GetCardCaptionRowParams(ARecord, ATableItem,
        Result.NativeParams)
  else if AIsDataCell then
    Result := inherited GetItemViewParams(ATableItem, ARecord, AnIsPreview,
      AIsDataCell)
  else if CanProcessSelectionStyle(ARecord) then
    Result.NativeParams := Adapter.GetSelectionViewParams
...
function TdxGridCustomLayoutViewFormatter.GetRecord(Index: Integer)
...
function TdxGridCardViewFormatter.GetRecordClass(AGridRecord
  : TcxGridCustomLayoutRecord): TdxReportCustomLayoutRecordClass;
begin
...
function TdxGridCardViewFormatter.GetCardViewParams
  (ARecord: TcxCustomGridRecord): TdxReportItemViewParams;
begin
...
procedure TdxGridCardViewFormatter.DoInitializeCardRowIndent
  (AnItem: TdxReportCellExpandButton; ACardRow: TcxGridCardViewRow;
...
begin
  ...
  if HasBackgroundBitmap(BackgroundBitmapIndexes[ACardRow.Kind]) then
    AnItem.BackgroundBitmapIndex := GetBackgroundBitmapIndex
      (BackgroundBitmapIndexes[ACardRow.Kind]);
end;

procedure TdxGridCardViewFormatter.DoInitializeCardRowCaption
  (AnItem: TdxReportCellText; ACardRow: TcxGridCardViewRow;
  AGridCard: TcxGridCard);
const
  BackgroundBitmapIndexes: array [TcxGridCardViewRowKind] of Integer =
    (bbRowCaption, bbCaptionRow, bbCaptionRow);
...
begin
  ...
  ACaption.Multiline := not ACaption.EndEllipsis and not CaptionAutoWidth and
    Adapter.RowCaptionAutoHeight;
...
procedure TdxGridCardViewFormatter.DoReportLinkInitializeCardRowCaption
  (AnItem: TdxReportCellText; ACardRow: TcxGridCardViewRow;
  AGridCard: TcxGridCard);
begin
  ReportLink.DoInitializeCardRowCaptionCell(Adapter.GridView, AGridCard,
    ACardRow, TdxReportCellString(AnItem));
end;

function TdxGridCardViewFormatter.GetCardRowCaptionClass
  (ACardRow: TcxGridCardViewRow): TdxReportCellTextClass;
begin
  Result := TdxReportCellString;
end;

function TdxGridCardViewFormatter.GetCardRowCaptionViewParams
  (ARecord: TcxCustomGridRecord; ACardRow: TcxGridCardViewRow)
  : TdxReportItemViewParams;
begin
  if ReportLink.OptionsFormatting.UseNativeStyles then
    if ACardRow.Kind = rkData then
      ReportLink.Styles.GetCardRowCaptionParams(ARecord, ACardRow,
        Result.NativeParams)
    else if CanProcessSelectionStyle(ARecord) then
      Result := GetSelectionViewParams
    else
      ReportLink.Styles.GetCardCaptionRowParams(ARecord, ACardRow,
        Result.NativeParams)
  else if (ACardRow.Kind = rkCaption) and CanProcessSelectionStyle(ARecord) then
    Result.NativeParams := Adapter.GetSelectionViewParams
  else
...
procedure TdxGridCardViewFormatter.DoReportLinkInitializeCardRowData
  (AnItem: TAbstractdxReportCellData; ACardRow: TcxGridCardViewRow;
  AGridCard: TcxGridCard);
begin
  ReportLink.DoInitializeCardRowDataCell(Adapter.GridView, AGridCard, ACardRow,
    TdxReportCellString(AnItem));
end;

function TdxGridCardViewFormatter.GetItemViewParams
  (ATableItem: TcxCustomGridTableItem; ARecord: TcxCustomGridRecord;
  AnIsPreview: Boolean = False; AIsDataCell: Boolean = False)
  : TdxReportItemViewParams;
var
...
begin
  ...
  if ReportLink.OptionsFormatting.UseNativeStyles then
    if (CardRow.Kind = rkData) or AIsDataCell then
      ...
      ReportLink.Styles.GetCardCaptionRowParams(ARecord, CardRow,
        Result.NativeParams)
  else if (CardRow.Kind = rkData) or AIsDataCell then
    Result := inherited GetItemViewParams(ATableItem, ARecord, AnIsPreview,
      AIsDataCell)
  else if CanProcessSelectionStyle(ARecord) then
    Result.NativeParams := Adapter.GetSelectionViewParams
...
function TdxGridCardViewFormatter.IsHorizontalLayout
  (AGridCard: TcxGridCard): Boolean;
begin
  Result := AGridCard.GridView.RowLayout = rlHorizontal;
end;

function TdxGridCardViewFormatter.MapStyleBackgroundBitmapIndex
  (AGridBackgroundBitmapIndex: Integer): Integer;
begin
  case AGridBackgroundBitmapIndex of
    bbCaptionRow:
...
function TdxGridCardViewFormatter.GetContentBackgroundBitmapStyleIndex
  (ATableItem: TcxCustomGridTableItem): Integer;
const
  BackgroundBitmapIndexes: array [TcxGridCardViewRowKind] of Integer =
...
constructor TdxReportCardLayer.CreateEx(AParent: TdxReportCell;
  ABeginsLayerRow: TcxGridCardViewRow);
begin
...
begin
  ...
  begin
    Rows[I].AdjustCellSides(IsFirstItem, IsLastItem and
      not(NeedCategorySeparator or NeedLayerSeparator), I = 0,
      I = RowCount - 1);
...
function TdxReportCardLayer.AddRow(AGridCardRow: TcxGridCardViewRow)
  : TdxReportCardRow;
begin
...
function TdxReportCardLayer.MeasureCaptionWidth
...
function TdxReportCardLayer.MeasureDataWidth
  (ACanvas: TdxPSReportRenderCustomCanvas): Integer;
var
  I: Integer;
begin
...
function TdxReportCardLayer.MeasureLayerHeight
  (ACanvas: TdxPSReportRenderCustomCanvas; ACalculateLineHeight: Boolean;
...
begin
  Result := 0;
  for I := 0 to RowCount - 1 do
    Result := Max(Result, Rows[I].MeasureHeight(ACanvas, ACalculateLineHeight,
      ABuilder));
  if LayerSeparator <> nil then
...
function TdxReportCardLayer.MeasureWidth
  (ACanvas: TdxPSReportRenderCustomCanvas): Integer;
var
  I: Integer;
begin
...
procedure TdxReportCardLayer.CheckNeedCategorySeparator
  ...
  begin
    ...
    for I := 0 to RowCount - 1 do
      with Rows[I].GridCardRow do
        FNeedCategorySeparator := FNeedCategorySeparator or
          (HasExpandButton or (CategoryRow <> nil));
  end;
end;
...
begin
  ...
  FCategorySeparator.BoundsRect :=
    Rect(0, 0, Width, ACardView.OptionsView.CategorySeparatorWidth);
...
begin
  ...
  ACardView := TcxGridCardView(BeginsLayerRow.GridView);
  FLayerSeparator.BoundsRect :=
    Rect(0, 0, Width, ACardView.OptionsView.LayerSeparatorWidth);
...
procedure TdxReportCardLayer.InitAutoWidthItem(AnItem: TcxAutoWidthItem;
  var AAllFixed: Boolean);
var
  I, AWidth: Integer;
const
...
begin
  for I := 0 to RowCount - 1 do
    Rows[I].AdjustCellSides(I = 0, False, Index = 0,
      Index = Card.LayerCount - 1);
  if (LayerSeparator <> nil) and Card.ReportLink.OptionsCards.RowBordersVert
  then
...
function TdxReportCardVerticalLayer.MeasureWidth
  (ACanvas: TdxPSReportRenderCustomCanvas): Integer;
var
  I: Integer;
begin
...
function TdxReportCardVerticalLayer.CanHaveIndent
  (ARow: TdxReportCardRow): Boolean;
begin
  Result := True;
end;
...
constructor TdxReportCardRow.CreateEx(AParent: TdxReportCell;
  AGridCardRow: TcxGridCardViewRow);
begin
  inherited Create(AParent);
  CellSides := [];
...
function TdxReportCardRow.MeasureHeight(ACanvas: TdxPSReportRenderCustomCanvas;
  ACalculateLineHeight: Boolean; ABuilder: TdxGridCardViewBuilder): Integer;
  ...
  begin
    ...
    Result := Max(Result, ABuilder.Adapter.ScaleFactor.Apply
      (DefaultDataRowLineHeight));
  end;
  ...
  begin
    Result := ABuilder.Adapter.ScaleFactor.Apply(DefaultDataRowLineHeight) *
      GridCardRow.Position.LineCount;
    if HasData then
    begin
...
function TdxReportCardRow.MeasureWidth
  (ACanvas: TdxPSReportRenderCustomCanvas): Integer;
begin
...
function TdxReportCardRow.MeasureCaptionWidth
  (ACanvas: TdxPSReportRenderCustomCanvas): Integer;
begin
  if HasCaption then
  begin
...
function TdxReportCardRow.MeasureDataWidth
  (ACanvas: TdxPSReportRenderCustomCanvas): Integer;
begin
  if HasData and dxPSDataMaps.DoesItemParticipateInAutoWidthCalculation
    (Properties) then
...
procedure TdxReportCardRow.AdjustCellSides(AIsFirstItem, AIsLastItem,
  AIsLeftItem, AIsRightItem: Boolean);
var
  ReportLink: TdxGridReportLink;
  Sides: TdxCellSides;
begin
  ...
  begin
    Sides := [];
    if AIsFirstItem then
      Include(Sides, csTop);
    if AIsLastItem then
      Include(Sides, csBottom);
    if HasIndent then
    ...
    else if not HasData and AIsRightItem then
...
const
  ...
  begin
    FRowCaption := ABuilder.Formatter.GetCardRowCaptionClass(GridCardRow)
      .Create(Self);
    if HasIndent then
    begin
      ...
      begin
        ABuilder.Formatter.DoInitializeExpandButton(FRowIndent,
          Card.GridCard, True);
        FRowIndent.ButtonExpanded := GridCardRow.Expanded;
      end;
      ABuilder.Formatter.DoInitializeCardRowIndent(FRowIndent, GridCardRow,
        Card.GridCard);
    end;
    ...
    ABuilder.Formatter.DoInitializeCardRowCaption(RowCaption, GridCardRow,
      Card.GridCard);
    ABuilder.Formatter.DoReportLinkInitializeCardRowCaption(RowCaption,
      GridCardRow, Card.GridCard);
  end;

  procedure CreateRowData;
  begin
    FRowData := ABuilder.Formatter.GetDataItemClass(GridCardRow, Card.GridCard)
      .Create(Self);
    ...
    RowData.Height := ABuilder.Adapter.ScaleFactor.Apply
      (DefaultDataRowLineHeight);
    ABuilder.Formatter.DoInitializeItem(RowData, GridCardRow,
      Card.GridCard, False);
    ABuilder.Formatter.DoReportLinkInitializeCardRowData(RowData, GridCardRow,
      Card.GridCard);
  end;
  ...
  begin
    ...
    FRowSeparator.BoundsRect :=
      Rect(0, 0, Width, AGridView.OptionsView.CategorySeparatorWidth);
...
procedure TdxCardBorderPainter.DrawShadow
...
constructor TdxReportCustomLayoutRecord.CreateEx(AParent: TdxReportCell;
  AGridRecord: TcxGridCustomLayoutRecord);
begin
  Create(AParent);
...
function TdxReportCard.GetBorderOuterBounds
...
procedure TdxReportCard.ConvertCoords(APixelsNumerator, APixelsDenominator
  : Integer);
begin
  inherited;
...
procedure TdxReportCard.SetCaptionWidth(ACanvas: TdxPSReportRenderCustomCanvas;
  ALayer, AValue, AMaxValue: Integer; ACaptionAutoWidths: Boolean);
var
  I: Integer;
begin
  AValue := Max(AValue, 0);
...
begin
  ...
  try
    ...
    begin
      ...
      Layers[I].NeedLayerSeparator := ANeedLayerSeparator and
        HasLayerSeparator(I);
...
begin
  for I := 0 to LayerCount - 1 do
    LayerHeights[I] := Layers[I].MeasureLayerHeight(ACanvas, not AAutoHeight,
      ABuilder);
end;
...
function TdxReportCardHorz.MeasureCaptionWidth
  (ACanvas: TdxPSReportRenderCustomCanvas): Integer;
var
  I: Integer;
begin
...
function TdxReportCardHorz.MeasureDataWidth
  (ACanvas: TdxPSReportRenderCustomCanvas): Integer;
var
  I: Integer;
begin
...
function TdxReportCardVert.GetLayerByAbsoluteRowIndex(var AIndex: Integer)
  : TdxReportCardLayer;
var
  I: Integer;
begin
...
function TdxReportCardVert.GetLayerIndexByRow(ARow: TcxGridCardViewRow)
  : Integer;
begin
...
function TdxReportCardVert.MeasureCaptionWidth
  (ACanvas: TdxPSReportRenderCustomCanvas): Integer;
var
  I: Integer;
begin
...
procedure TdxReportCardVert.SetCaptionWidth
  (ACanvas: TdxPSReportRenderCustomCanvas; ALayer, AValue, AMaxValue: Integer;
  ACaptionAutoWidth: Boolean);
var
  I: Integer;
begin
  for I := 0 to LayerCount - 1 do
...
constructor TdxGridCustomLayoutViewBuilder.Create
  (AReportLink: TdxGridReportLink; AMasterBuilder: TdxCustomGridViewBuilder;
  AGridView: TcxCustomGridView);
begin
  inherited;
...
class function TdxGridCustomLayoutViewBuilder.AdapterClass
  : TdxGridViewAdapterClass;
begin
  Result := TdxGridCustomLayoutViewAdapter;
end;

function TdxGridCustomLayoutViewBuilder.Formatter
  : TdxGridCustomLayoutViewFormatter;
begin
  Result := inherited Formatter as TdxGridCustomLayoutViewFormatter;
end;

class function TdxGridCustomLayoutViewBuilder.FormatterClass
  : TdxGridViewFormatterClass;
begin
...
begin
  ...
  begin
    ARecordColCount := Max((Formatter.ViewAvailableWidth - 4)
      div FMaxRecordWidth, 1);
    FMaxRecordWidth := (Formatter.ViewAvailableWidth - (4 * ARecordColCount))
      div ARecordColCount;
...
function TdxGridCustomLayoutViewBuilder.GetRecordProducer
  : TdxGridCustomLayoutViewRecordProducer;
begin
  Result := ProducerCache[GetRecordProducerClass]
    as TdxGridCustomLayoutViewRecordProducer;
end;

function TdxGridCustomLayoutViewBuilder.GetRecordProducerClass
  : TdxGridCustomLayoutViewRecordProducerClass;
begin
  Result := TdxGridCustomLayoutViewRecordProducer;
end;

function TdxGridCustomLayoutViewBuilder.CreateRecord(AParent: TdxReportCell;
  ARecord: TcxGridCustomLayoutRecord): TdxReportCell;
begin
  Result := nil;
end;

function TdxGridCustomLayoutViewBuilder.GetRecord(Index: Integer)
  : TdxReportCustomLayoutRecord;
begin
...
procedure TdxGridCardViewBuilder.DoResizeRecords;
      ...
      begin
        ...
        for J := 0 to ACard.LayerCount - 1 do
          ALayerCaptionWidths[J] := Max(ALayerCaptionWidths[J],
            ACard.Layers[J].MeasureCaptionWidth(ACanvas));
      end;
    end
    else
    ...
    for I := 0 to CardCount - 1 do
      for J := 0 to Length(ALayerCaptionWidths) - 1 do
        Cards[I].SetCaptionWidth(ACanvas, J, Min(ALayerCaptionWidths[J],
          ARowCaptionWidth), ARowCaptionWidth, Formatter.CaptionAutoWidth);
  end;
  ...
  procedure SetCardsRowHeight(ACanvas: TdxPSReportRenderCustomCanvas;
    AAutoHeight: Boolean);
  var
    I: Integer;
  begin
...
function TdxGridCardViewBuilder.GetRecordProducer
  : TdxGridCardViewCardsRowProducer;
begin
  Result := inherited GetRecordProducer as TdxGridCardViewCardsRowProducer;
end;

function TdxGridCardViewBuilder.GetRecordProducerClass
  : TdxGridCustomLayoutViewRecordProducerClass;
begin
...
var
  AGraphic: TGraphic;
begin
  if not(AGraphicClass.InheritsFrom(TBitmap) or
    AGraphicClass.InheritsFrom(TMetafile)) then
  begin
...
procedure TdxGridChartViewFormatter.DoInitializeChartItem
  (AItem: TdxReportCellDpiAwareGraphic);
begin
...
procedure TdxGridChartViewFormatter.DoReportLinkInitializeChartItem
...
class function TdxGridChartViewBuilder.FormatterClass
  : TdxGridViewFormatterClass;
begin
...
function TdxGridChartViewBuilder.GetChartProducer
  : TdxGridChartViewChartProducer;
begin
  Result := ProducerCache[GetChartProducerClass]
    as TdxGridChartViewChartProducer;
end;

function TdxGridChartViewBuilder.GetChartProducerClass
  : TdxGridChartViewChartProducerClass;
begin
...
function TdxGridViewRowProducer.Produce(AHostInfo: TdxGridAttributeHostInfo)
  : TdxReportCell;
begin
...
procedure TdxGridViewRowProducer.AddMasterIndents(AMasterFormatter
  : TdxCustomGridViewFormatter; AMasterAdapter: TdxCustomGridViewAdapter;
  ALevel: Integer; var ALeftPos: Integer);
var
  I: Integer;
...
begin
  ...
  begin
    ...
    Indent.BoundsRect := Bounds(ALeftPos, 0, AMasterAdapter.IndentWidth,
      RowHeight);
...
procedure TdxGridViewRowProducer.AddMasterSeparator(AMasterFormatter
  : TdxCustomGridViewFormatter; AMasterAdapter: TdxCustomGridViewAdapter;
  var ALeftPos: Integer; ASeparatorKind: TdxVerticalDetailsSeparatorKind);
var
...
begin
  ...
  begin
    ...
    Separator.BoundsRect := Bounds(ALeftPos, 0,
      AMasterFormatter.DetailsSeparatorThickness, RowHeight);
...
function TdxGridViewRowProducer.CalculateItemHeight
  (ACanvas: TdxPSReportRenderCustomCanvas; AnItem: TdxReportVisualItem)
  : Integer;
begin
...
function TdxGridViewRowProducer.CreateDetailsSeparator(AParent: TdxReportCell)
  : TdxReportCellBox;
begin
...
function TdxGridViewRowProducer.CreateMasterIndent(AParent: TdxReportCell)
  : TdxReportCellExpandButton;
begin
...
procedure TdxGridViewRowProducer.CreateRowHost(const AHostInfo
  : TdxGridAttributeHostInfo);
begin
  FHost := HostClass.Create(AHostInfo.Parent);
  FHost.BoundsRect := Bounds(AHostInfo.Origin.X, AHostInfo.Origin.Y, Width,
    RowHeight);
  InitializeHost;
  AddLeadingMasterIndentsAndSeparators;
end;

function TdxGridViewRowProducer.DoesItemParticipateInRowAutoHeightCalculation
...
function TdxGridViewRowProducer.GetMasterIndentClass
  : TdxReportCellExpandButtonClass;
begin
...
procedure TdxGridViewRowProducer.FixupRowDataItemHeight
...
procedure TdxGridViewRowProducer.InitializeDetailsSeparator
...
procedure TdxGridViewRowProducer.InitializeMasterIndent
  (AFormatter: TdxCustomGridViewFormatter; AIndent: TdxReportCellExpandButton;
  AIndex, ALevel: Integer);
begin
  AFormatter.DoInitializeMasterIndent(AIndent, AIndex,
    MasterBuilders[ALevel].Adapter.IndentCount);
end;
...
function TdxGridViewRowProducer.GetMasterBuilder(Index: Integer)
  : TdxCustomGridViewBuilder;
begin
  Result := Builder.AbsoluteBuilders[Index];
end;

function TdxGridViewRowProducer.GetMasterIndent(Index: Integer)
  : TdxReportCellBox;
begin
...
function TdxGridViewCustomRowProducer.Produce
  (AHostInfo: TdxGridAttributeHostInfo): TdxReportCell;
begin
...
function TdxGridViewCustomRowProducer.CreateItem(AParent: TdxReportCell)
  : TAbstractdxReportCellData;
begin
...
function TdxGridViewDetailsSeparatorProducer.GetItemClass
  : TdxReportCellDataClass;
begin
  Result := Formatter.GetDetailsSeparatorClass;
end;
...
begin
  if AFormatter = Formatter then
    AFormatter.DoInitializeVertBottomDetailsSeparator(ASeparator,
      ASeparatorKind)
  else
    inherited;
end;
...
constructor TdxGridTableViewRowSubItemsProducer.Create
  (ABuilder: TdxCustomGridViewBuilder);
begin
  inherited;
...
function TdxGridTableViewRowSubItemsProducer.Produce
  (AHostInfo: TdxGridAttributeHostInfo): TdxReportCell;
begin
...
procedure TdxGridTableViewRowSubItemsProducer.AddIndents
  (AParent: TdxReportCell);
begin
end;

procedure TdxGridTableViewRowSubItemsProducer.AddSubItems
  (AParent: TdxReportCell);
var
  I: Integer;
...
function TdxGridTableViewRowSubItemsProducer.IsItemIndent
  (AnItem: TdxReportVisualItem): Boolean;
begin
...
procedure TdxGridTableViewRowSubItemsProducer.InitializeSubItem
...
function TdxGridTableViewRowSubItemsProducer.GetHasSubItem
  (Index: Integer): Boolean;
begin
  Result := True;
end;
...
function TdxGridTableViewRowSubItemsProducer.GetSubItemBound
  (Index: Integer): TRect;
begin
  Result := Rect(0, 0, -1, -1);
end;
...
function TdxGridTableViewRowSubItemsProducer.GetColumn(Index: Integer)
  : TcxGridColumn;
begin
  Result := Formatter.Columns[Index];
end;

function TdxGridTableViewRowSubItemsProducer.GetIndent(Index: Integer)
  : TdxReportCellExpandButton;
begin
  Result := TdxReportCellExpandButton(FIndents[Index]);
end;

function TdxGridTableViewRowSubItemsProducer.GetSubItem(Index: Integer)
  : TdxReportVisualItem;
begin
...
procedure TdxGridTableViewHeadersProducer.InitializeSubItem
  (ASubItem: TAbstractdxReportCellData; AIndex: Integer);
begin
  inherited;
...
function TdxGridTableViewHeadersProducer.GetSubItemClass(Index: Integer)
  : TdxReportCellDataClass;
begin
...
procedure TdxGridTableViewFootersProducer.FixupRowDataItemHeight
  (AnItem: TdxReportVisualItem);
begin
  with AnItem do
    Height := Parent.Height - 2 * Adapter.ScaleFactor.Apply
      (FooterItemInflateVert);
end;
...
procedure TdxGridTableViewFootersProducer.InitializeSubItem
  (ASubItem: TAbstractdxReportCellData; AIndex: Integer);
var
...
begin
  ...
  Formatter.DoInitializeFooterItem(ASubItem, ARealIndex,
    SummaryItems[ARealIndex]);
...
var
  I: Integer;
begin
  Result := inherited GetAutoHeight and Adapter.FooterMultiline and
    Adapter.FooterMultiSummaries;
  if Result then
  begin
...
begin
  Result := Adapter.GetFooterLineCount(SummaryItems,
    Adapter.FooterMultiSummaries);
end;
...
function TdxGridTableViewFootersProducer.GetSubItemClass(Index: Integer)
  : TdxReportCellDataClass;
begin
...
function TdxGridTableViewCustomDataRowProducer.Produce
  (AHostInfo: TdxGridAttributeHostInfo; AGridRow: TcxCustomGridRow;
  AGridRowIndex: Integer): TdxReportCell;
begin
  FGridRow := AGridRow;
...
procedure TdxGridTableViewCustomDataRowProducer.AddIndents
  (AParent: TdxReportCell);
var
  I: Integer;
  Indent: TdxReportCellExpandButton;
...
procedure TdxGridTableViewCustomDataRowProducer.InitializeIndent
...
function TdxGridTableViewCustomDataRowProducer.GetIndentBounds
  (Index: Integer): TRect;
begin
...
function TdxCustomGridTableViewRowSeparatorProducer.Produce
  (AHostInfo: TdxGridAttributeHostInfo; AGridRow: TcxCustomGridRow)
  : TdxReportCell;
begin
...
procedure TdxCustomGridTableViewRowSeparatorProducer.InitializeIndent
  (AIndent: TdxReportCellExpandButton; AIndex: Integer);
begin
  inherited;
  Formatter.DoInitializeRowSeparatorIndent(AIndent, AIndex,
    IndentCount, GridRow);
end;
...
function TdxCustomGridTableViewRowSeparatorProducer.GetSubItemBound
  (Index: Integer): TRect;
begin
...
function TdxGridTableViewRowSeparatorProducer.Produce
  (AHostInfo: TdxGridAttributeHostInfo; AGridRow: TcxCustomGridRow;
  AnIsLast: Boolean): TdxReportCell;
begin
  FIsLast := AnIsLast;
...
procedure TdxGridTableViewRowSeparatorProducer.InitializeSubItem
  (ASubItem: TAbstractdxReportCellData; AIndex: Integer);
begin
...
begin
  ...
  begin
    ...
    if (Result <> 0) and Adapter.IsOffice11StyleGrouping and
      not(GridRow is TcxGridGroupRow) then { .2 }
      Dec(Result);
  end
  else
    Result := 0;
...
function TdxGridTableViewRowSeparatorProducer.GetSubItemClass(Index: Integer)
  : TdxReportCellDataClass;
begin
...
procedure TdxGridTableViewGroupRowSeparatorProducer.InitializeSubItem
  (ASubItem: TAbstractdxReportCellData; AIndex: Integer);
begin
  inherited;
...
function TdxGridTableViewGroupRowSeparatorProducer.GetSubItemClass
  (Index: Integer): TdxReportCellDataClass;
begin
...
begin
  ...
  Formatter.DoInitializePreview(TAbstractdxReportCellData(PreviewItem),
    PreviewColumn, GridRow);
...
function TdxGridTableViewDataRowProducer.CreatePreview(AParent: TdxReportCell)
  : TdxReportVisualItem;
begin
...
function TdxGridTableViewDataRowProducer.
  DoesItemParticipateInRowAutoHeightCalculation
  (AnItem: TdxReportVisualItem): Boolean;
var
...
begin
  ...
  begin
    ...
    Result := dxPScxCommon.dxPSDataMaps.
      DoesItemParticipateInAutoHeightCalculation(Properties);
  end;
end;

function TdxGridTableViewDataRowProducer.GetPreviewClass
  : TdxReportCellDataClass;
begin
  ...
  begin
    ...
    if Item = PreviewItem then
      if PreviewPlace = cxGridTableView.ppTop then
        ...
        Item.Top := NewHeight
    else if IsItemIndent(Item) then
    begin
      Item.Top := 0;
...
procedure TdxGridTableViewDataRowProducer.InitializeIndent
  (AIndent: TdxReportCellExpandButton; AIndex: Integer);
begin
  inherited;
...
procedure TdxGridTableViewDataRowProducer.InitializeSubItem
  (ASubItem: TAbstractdxReportCellData; AIndex: Integer);
begin
  inherited;
...
function TdxGridTableViewDataRowProducer.GetSubItemClass(Index: Integer)
  : TdxReportCellDataClass;
begin
...
function TdxGridTableViewGroupRowProducer.Produce
  (AHostInfo: TdxGridAttributeHostInfo; AGridRow: TcxCustomGridRow;
  AGridRowIndex: Integer): TdxReportCell;
begin
...
begin
  ...
  begin
    ...
    if not Formatter.AlignSummaryWithColumns or
      ((AInfo.Column <> nil) and (AInfo.Column.VisibleIndex < 0)) then
      AInfo.Column := nil;
    if AInfo.Column <> nil then
    begin
      Formatter.Adapter.Styles.GetGroupSummaryCellContentParams(GridRow, AItem,
        AInfo.ViewParams);
...
procedure TdxGridTableViewGroupRowProducer.InitializeSubItem
  (ASubItem: TAbstractdxReportCellData; AIndex: Integer);
const
  Alignment2TextAlign: array [TAlignment] of TcxTextAlignX = (taLeft, taRight,
    taCenterX);
begin
  inherited;
  Formatter.DoInitializeGroupRowItem(ASubItem, GridRow, AIndex,
    SummaryItemInfos[AIndex].DisplayText);
  if AIndex <> 0 then
  begin
    ASubItem.CellSides := [];
    TdxReportCellString(ASubItem).TextAlignX := Alignment2TextAlign
      [SummaryItemInfos[AIndex].Column.GroupSummaryAlignment];
...
begin
  Result := Formatter.RowHeights[GridRowIndex];
  // }Formatter.GroupRowLineHeight; {3.1}
end;

function TdxGridTableViewGroupRowProducer.GetSubItemBound
  (Index: Integer): TRect;
begin
  Result := SummaryItemInfos[Index].Bounds;
end;

function TdxGridTableViewGroupRowProducer.GetSubItemClass(Index: Integer)
  : TdxReportCellDataClass;
begin
  Result := Formatter.GetGroupRowClass;
end;

function CompareSummaryItemsInfo(AInfo1,
  AInfo2: TcxGridSummaryItemInfo): Integer;
begin
  if AInfo1.Column = AInfo2.Column then
    Result := AInfo1.SummaryIndex - AInfo2.SummaryIndex
  else if AInfo1.Column = nil then
    Result := -1
  else if AInfo2.Column = nil then
    Result := 1
  else
...
begin
  Formatter.Adapter.Styles.GetGroupParams(GridRow, GridRow.Level,
    RowViewParams);
  if GridRow.GroupedColumnCount = 1 then
  begin
    if not GridRow.GetGroupSummaryInfo(AItems, AValues) then
      Exit;
    for I := 0 to AItems.Count - 1 do
      if AItems[I].Position = spGroup then
        AddSummaryGroupInfo(AItems[I],
          AItems[I].FormatValue(AValues^[I], False));
    ...
    begin
      ...
      begin
        with SummaryItemInfos[I] do
        begin
          if (I < (SubItemCount - 1)) and
            (Column = SummaryItemInfos[I + 1].Column) then
          begin
            DisplayText := DisplayText + Separator + ' ' + SummaryItemInfos
              [I + 1].DisplayText;
            DeleteInfo(I + 1);
            Continue;
          end
      ...
      begin
        with GridRow.GroupSummaryItems do
          SummaryItemInfos[0].DisplayText := GridRow.DisplayCaption + ' ' +
            BeginText + SummaryItemInfos[0].DisplayText + EndText;
...
begin
  ...
  AMinLeft := AItem.Bounds.Left + cxTextWidth(AItem.ViewParams.Font,
    AItem.DisplayText) + cxTextOffset * 2;
  I := 1;
  while I < SubItemCount do
  begin
    AItem := SummaryItemInfos[I];
    with Formatter.GetHeaderItemBounds
      (SummaryItemInfos[I].Column.VisibleIndex) do
    begin
...
function TdxGridTableViewGroupRowProducer.GetSummaryItemInfo(Index: Integer)
  : TcxGridSummaryItemInfo;
begin
...
procedure TdxGridTableViewMasterRowProducer.InitializeIndent
  (AIndent: TdxReportCellExpandButton; AIndex: Integer);
begin
  // inherited;
  Formatter.DoInitializeMasterDataRowIndent(AIndent, AIndex,
    IndentCount, GridRow);
end;

procedure TdxGridTableViewMasterRowProducer.InitializeSubItem
  (ASubItem: TAbstractdxReportCellData; AIndex: Integer);
begin
  inherited;
  if AIndex = 0 then
...
constructor TdxGridTableViewGroupFooterSubItemInfo.Create
  (ASummaryItem: TcxDataSummaryItem; ASummaryValue: Variant);
begin
  inherited Create;
...
function TdxGridTableViewGroupFooterProducer.Produce
  (AHostInfo: TdxGridAttributeHostInfo; AGridRow: TcxCustomGridRow;
  AGroupLevel, AnIndex: Integer): TdxReportCell;
var
  AGroupIndex: Integer;
begin
  FIndex := AnIndex;
...
procedure TdxGridTableViewGroupFooterProducer.AddSubItems
  (AParent: TdxReportCell);
...
procedure TdxGridTableViewGroupFooterProducer.CalculateSubItemPosition
  (AIndex: Integer; out AColIndex, ARowIndex: Integer);
var
  AInfoIndex: Integer;
...
function TdxGridTableViewGroupFooterProducer.CanCreateSubItem
  (ASummaryItem: TcxDataSummaryItem): Boolean;
var
  AColumn: TcxGridColumn;
begin
  AColumn := TcxGridColumn(ASummaryItem.ItemLink);
  Result := (ASummaryItem.Position = spFooter) and (AColumn <> nil) and
    (AColumn.VisibleIndex > -1);
end;

function TdxGridTableViewGroupFooterProducer.CreateSubItemInfo
  (ASummaryItem: TcxDataSummaryItem; ASummaryValue: Variant)
  : TdxGridTableViewGroupFooterSubItemInfo;
begin
  Result := TdxGridTableViewGroupFooterSubItemInfo.Create(ASummaryItem,
    ASummaryValue);
end;
...
procedure TdxGridTableViewGroupFooterProducer.FixupRowDataItemHeight
  (AnItem: TdxReportVisualItem);
begin
  with AnItem do
    Height := Parent.Height - 2 * Adapter.ScaleFactor.Apply
...
procedure TdxGridTableViewGroupFooterProducer.InitializeIndent
  (AIndent: TdxReportCellExpandButton; AIndex: Integer);
begin
  inherited;
  Formatter.DoInitializeGroupFooterIndent(AIndent, AIndex, IndentCount,
    GridRow);
end;
...
procedure TdxGridTableViewGroupFooterProducer.InitializeSubItem
  (ASubItem: TAbstractdxReportCellData; AIndex: Integer);
var
  ASummaryItem: TcxDataSummaryItem;
begin
  ...
  Formatter.DoInitializeGroupFooterItem(ASubItem, GridRow, GroupLevel,
    SubItemInfos[AIndex].SummaryValue, ASummaryItem);
  Formatter.DoReportLinkInitializeGroupFooterItem(ASubItem,
    TcxGridColumn(ASummaryItem.ItemLink), GridRow, GroupLevel);
end;
...
function TdxGridTableViewGroupFooterProducer.GetHasSubItem
  (Index: Integer): Boolean;
begin
  Result := True;
end;
...
begin
  ...
  begin
    Inc(Result);
    if Adapter.IsOffice11StyleGrouping and (Index = 0) and
      not(GridRow is TcxGridGroupRow) then
      Dec(Result);
  end
end;
...
function TdxGridTableViewGroupFooterProducer.GetSubItemBound
  (Index: Integer): TRect;
var
  AColIndex, ARowIndex: Integer;
begin
...
function TdxGridTableViewGroupFooterProducer.GetSubItemClass(Index: Integer)
  : TdxReportCellDataClass;
begin
...
procedure TdxGridTableViewGroupFooterProducer.PopulateSubItemInfos
  (AGroupIndex: Integer);
var
...
begin
  ...
  begin
    Adapter.Summary.GetGroupSummaryInfo(AGroupIndex, ASummaryItems,
    ...
    begin
      ...
      if CanCreateSubItem(ASummaryItem) then
        SubItemInfoList.Add(CreateSubItemInfo(ASummaryItem,
          ASummaryValues^[ASummaryItemIndex]));
    end;
  end;
end;
...
function TdxGridTableViewGroupFooterProducer.GetSubItemInfo(AIndex: Integer)
  : TdxGridTableViewGroupFooterSubItemInfo;
begin
...
function TdxGridTableViewBandsProducer.Formatter
  : TdxGridBandedTableViewFormatter;
begin
  Result := inherited Formatter as TdxGridBandedTableViewFormatter;
end;
...
procedure TdxGridTableViewBandsProducer.InitializeSubItem
  (ASubItem: TAbstractdxReportCellData; AIndex: Integer);
begin
  inherited;
...
function TdxGridTableViewBandsProducer.GetSubItemClass(Index: Integer)
  : TdxReportCellDataClass;
begin
...
function TdxGridWinExplorerViewRecordProducer.Adapter
  : TdxGridWinExplorerViewAdapter;
begin
  Result := inherited Adapter as TdxGridWinExplorerViewAdapter;
end;

function TdxGridWinExplorerViewRecordProducer.Builder
  : TdxGridWinExplorerViewBuilder;
begin
  Result := inherited Builder as TdxGridWinExplorerViewBuilder;
end;

function TdxGridWinExplorerViewRecordProducer.Formatter
  : TdxGridWinExplorerViewFormatter;
begin
  Result := Builder.Formatter;
end;

function TdxGridWinExplorerViewRecordProducer.Produce
  (AHostInfo: TdxGridAttributeHostInfo; ARowHeight: Integer): TdxReportCell;
begin
...
function TdxGridWinExplorerViewRecordProducer.CreateRecord
  (AParent: TdxReportCell; AGridRecord: TcxGridWinExplorerViewCustomRecord)
  : TdxReportWinExplorerViewRecord;
begin
...
function TdxGridWinExplorerViewRecordProducer.GetRecordClass
  : TdxReportWinExplorerViewRecordClass;
begin
...
begin
  ...
  ARecordViewInfo := AGridRecordAccess.GetViewInfoClass.Create(ARecordsViewInfo,
    AGridRecord);
  try
    ...
    CreateRecordSubItems(ARecord, TcxGridWinExplorerViewCustomRecordViewInfo
      (ARecordViewInfo));
  finally
...
procedure TdxGridWinExplorerViewDataRecordProducer.CreateDataCell
  (AParent: TdxReportWinExplorerViewRecord;
  ACellViewInfo: TcxGridWinExplorerViewCustomCellViewInfo);
var
...
begin
  ...
  AReportItem.BoundsRect := cxRectOffset(ACellViewInfo.Bounds,
    -ARecordBounds.Left, -ARecordBounds.Top);
end;

procedure TdxGridWinExplorerViewDataRecordProducer.CreateRecordSubItems
  (ARecord: TdxReportWinExplorerViewRecord;
  ARecordViewInfo: TcxGridWinExplorerViewCustomRecordViewInfo);
var
...
function TdxGridWinExplorerViewDataRecordProducer.GetRecordClass
  : TdxReportWinExplorerViewRecordClass;
begin
...
begin
  ...
  AReportItem.BoundsRect := cxRectOffset(ARecordViewInfo.Bounds, -ABounds.Left,
    -ABounds.Top);
...
function TdxGridWinExplorerViewGroupRecordProducer.GetRecordClass
  : TdxReportWinExplorerViewRecordClass;
begin
...
function TdxGridCustomLayoutViewRecordProducer.Builder
  : TdxGridCustomLayoutViewBuilder;
begin
  Result := inherited Builder as TdxGridCustomLayoutViewBuilder;
end;

function TdxGridCustomLayoutViewRecordProducer.Formatter
  : TdxGridCustomLayoutViewFormatter;
begin
  Result := inherited Formatter as TdxGridCustomLayoutViewFormatter;
end;

function TdxGridCustomLayoutViewRecordProducer.CreateRecord
  (AParent: TdxReportCell; AGridRecord: TcxGridCustomLayoutRecord)
  : TdxReportCustomLayoutRecord;
begin
  Result := Formatter.GetRecordClass(AGridRecord)
    .CreateEx(AParent, AGridRecord);
  Formatter.DoInitializeRecord(Result, AGridRecord);
end;

function TdxGridCustomLayoutViewRecordProducer.Produce
  (AHostInfo: TdxGridAttributeHostInfo; ARowHeight: Integer): TdxReportCell;
begin
  FRowHeight := ARowHeight;
  Result := inherited Produce(AHostInfo);
...
procedure TdxGridCustomLayoutViewRecordProducer.InjectRecord
  (ARecord: TdxReportCustomLayoutRecord; AIndex: Integer);
...
function TdxGridChartViewChartProducer.Produce
  (AHostInfo: TdxGridAttributeHostInfo): TdxReportCell;
begin
  try
    Result := inherited Produce(AHostInfo);
...
constructor TdxGridReportLinkCardsShadow.Create(AnOptionsCards
...
begin
  if OptionsCards <> nil then
    OptionsCards.Changed;
end;
...
procedure TdxGridReportLinkCardsShadow.SetPosition
  (Value: TdxGridCardShadowPosition);
begin
...
procedure TdxGridReportLinkOptionsCustomLayoutView.SetInterRecordsSpaceHorz
  (Value: Integer);
begin
  if Value < 0 then
    Value := 0;
...
procedure TdxGridReportLinkOptionsCustomLayoutView.SetInterRecordsSpaceVert
  (Value: Integer);
begin
  if Value < 0 then
    Value := 0;
...
function TdxGridReportLinkOptionsCards.GetShadowClass
  : TdxGridReportLinkCardsShadowClass;
begin
...
procedure TdxGridReportLinkOptionsCards.SetShadow
  (Value: TdxGridReportLinkCardsShadow);
begin
  Shadow.Assign(Value);
end;
...
function TdxGridReportLinkOptionsCharts.SupportsGraphicClass
...
procedure TdxGridReportLinkOptionsCharts.SetGraphicClassName
  (const Value: string);
var
  AClass: TClass;
begin
...
begin
  ...
  begin
    ...
    if StartFromFocusedView then
      Changed;
  end;
end;

procedure TdxGridReportLinkOptionsDetails.SetStartFromFocusedView
  (Value: Boolean);
begin
...
procedure TdxGridReportLinkOptionsFormatting.SetConsumeSelectionStyle
  (Value: Boolean);
begin
...
procedure TdxGridReportLinkOptionsLevels.SetRiseActiveLevelOntoTop
  (Value: Boolean);
begin
...
function TdxGridReportLinkOptionsOnEveryPage.HasInstalledAttribute
  (AnAttribute: TdxGridAttributeClass): Boolean;
begin
  if AnAttribute.InheritsFrom(TdxGridLevelCaption) then
    Result := Caption
  else if AnAttribute.InheritsFrom(TdxGridBandHeader) then
    Result := BandHeaders
  else if AnAttribute.InheritsFrom(TdxGridHeader) then
    Result := Headers
  else if AnAttribute.InheritsFrom(TdxGridFooter) then
    Result := Footers
  else if AnAttribute.InheritsFrom(TdxGridFilterBar) then
    Result := FilterBar
  else
    Result := False;
end;
...
function TdxGridReportLinkOptionsView.HasInstalledAttribute
  (AnAttribute: TdxGridAttributeClass): Boolean;
begin
  if AnAttribute.InheritsFrom(TdxGridLevelCaption) then
    Result := Caption
...
constructor TdxGridAttributeHostInfoServices.Create
  (AReportLink: TdxGridReportLink);
begin
  inherited Create;
  FReportLink := AReportLink;
  CreateHostInfos;
...
function TdxGridAttributeHostInfoServices.GetBandHeadersHostInfo
  : TdxGridAttributeHostInfo;
begin
...
function TdxGridAttributeHostInfoServices.GetCaptionHostInfo
  : TdxGridAttributeHostInfo;
begin
...
function TdxGridAttributeHostInfoServices.GetFilterBarHostInfo
  : TdxGridAttributeHostInfo;
begin
...
function TdxGridAttributeHostInfoServices.GetFootersHostInfo
  : TdxGridAttributeHostInfo;
begin
...
function TdxGridAttributeHostInfoServices.GetHeadersHostInfo
  : TdxGridAttributeHostInfo;
begin
...
begin
  Result := ReportLink.IsAggregated or ReportLink.ProcessParams.HasMasterDetails
    or IsInconsistentFilterBarState or IsInconsistentBandHeadersState or
...
function TdxGridAttributeHostInfoServices.IsAttributeSupported
  (AnAttribute: TdxGridAttributeClass): Boolean;
begin
...
function TdxGridAttributeHostInfoServices.GetActiveViewHelper
  : TdxCustomGridViewHelperClass;
begin
...
begin
  with ReportLink.ReportCells do
    Result := (FootersHostInfo.Parent = FooterCells) or
      (FilterBarHostInfo.Parent = FooterCells);
end;

function TdxGridAttributeHostInfoServices.GetArePageHeadersAssigned: Boolean;
begin
  with ReportLink.ReportCells do
    Result := (CaptionHostInfo.Parent = HeaderCells) or
      (FilterBarHostInfo.Parent = HeaderCells) or
      (BandHeadersHostInfo.Parent = HeaderCells) or
      (HeadersHostInfo.Parent = HeaderCells);
end;

function TdxGridAttributeHostInfoServices.
  GetCanUseBandHeadersOnEveyPage: Boolean;
begin
  Result := ReportLink.CanAttributeBeUsedOnEveryPage(TdxGridBandHeader) and
    ...
    (ActiveViewHelper.IsFilterBarAtBottom(ActiveView) or
    ReportLink.IsAttributeUsedOnEveryPage(TdxGridFilterBar));
end;
...
function TdxGridAttributeHostInfoServices.GetCanUseFilterBarOnEveryPage
  : Boolean;
begin
...
begin
  Result := ReportLink.CanAttributeBeUsedOnEveryPage(TdxGridFooter) and
    (ActiveViewHelper.IsFilterBarAtTop(ActiveView) or
    ReportLink.IsAttributeUsedOnEveryPage(TdxGridFilterBar));
end;
...
begin
  Result := ReportLink.CanAttributeBeUsedOnEveryPage(TdxGridHeader) and
    ReportLink.IsAttributeUsedOnEveryPage(TdxGridLevelCaption) and
    (ActiveViewHelper.IsFilterBarAtBottom(ActiveView) or
    ReportLink.IsAttributeUsedOnEveryPage(TdxGridFilterBar)) and
    ReportLink.IsAttributeUsedOnEveryPage(TdxGridBandHeader);
end;

function TdxGridAttributeHostInfoServices.
  GetIsInconsistentBandHeadersState: Boolean;
begin
  Result := IsAttributeSupported(TdxGridBandHeader) and
    OptionsOnEveryPage.BandHeaders and OptionsView.BandHeaders and
    ((IsAttributeSupported(TdxGridLevelCaption) and OptionsView.Caption and
    not OptionsOnEveryPage.Caption) or (IsAttributeSupported(TdxGridFilterBar)
    and ActiveViewHelper.IsFilterBarAtTop(ActiveView) and
    OptionsView.FilterBar and not OptionsOnEveryPage.FilterBar));
end;

function TdxGridAttributeHostInfoServices.
  GetIsInconsistentFilterBarState: Boolean;
begin
  Result := ActiveViewHelper.IsFilterBarAtTop(ActiveView) and
    (IsAttributeSupported(TdxGridFilterBar) and OptionsView.FilterBar and
    OptionsOnEveryPage.FilterBar and IsAttributeSupported(TdxGridLevelCaption)
    and OptionsView.Caption and not OptionsOnEveryPage.Caption);
end;

function TdxGridAttributeHostInfoServices.GetIsInconsistentFootersState
  : Boolean;
begin
  Result := IsAttributeSupported(TdxGridFooter) and OptionsView.Footers and
    OptionsOnEveryPage.Footers and IsAttributeSupported(TdxGridFilterBar) and
    ActiveViewHelper.IsFilterBarAtBottom(ActiveView) and
    OptionsView.FilterBar and not OptionsOnEveryPage.FilterBar;
end;

function TdxGridAttributeHostInfoServices.GetIsInconsistentHeadersState
  : Boolean;
begin
  Result := IsAttributeSupported(TdxGridHeader) and OptionsView.Headers and
    OptionsOnEveryPage.Headers and
    ((IsAttributeSupported(TdxGridLevelCaption) and OptionsView.Caption and
    not OptionsOnEveryPage.Caption) or (IsAttributeSupported(TdxGridFilterBar)
    and ActiveViewHelper.IsFilterBarAtTop(ActiveView) and
    OptionsView.FilterBar and not OptionsOnEveryPage.FilterBar) or
    (IsAttributeSupported(TdxGridBandHeader) and OptionsView.BandHeaders and
    not OptionsOnEveryPage.BandHeaders));
end;

function TdxGridAttributeHostInfoServices.GetLevelSeparatorBottomHostInfo
  : TdxGridAttributeHostInfo;
begin
...
function TdxGridAttributeHostInfoServices.GetLevelSeparatorTopHostInfo
  : TdxGridAttributeHostInfo;
begin
...
function TdxGridAttributeHostInfoServices.GetOptionsOnEveryPage
  : TdxGridReportLinkOptionsOnEveryPage;
begin
  Result := ReportLink.OptionsOnEveryPage;
end;

function TdxGridAttributeHostInfoServices.GetOptionsView
  : TdxGridReportLinkOptionsView;
begin
...
procedure TdxGridReportLinkStyles.GetCaptionParams(ATabLevel: TcxGridLevel;
  out AParams: TcxViewParams);
begin
  GetViewParams(vspsGridCaption, ATabLevel, nil, AParams);
end;

procedure TdxGridReportLinkStyles.GetCardCaptionRowParams
...
procedure TdxGridReportLinkStyles.GetCardRowCaptionParams
  (ARecord: TcxCustomGridRecord; AItem: TcxCustomGridTableItem;
  out AParams: TcxViewParams);
var
  DataCellPos: TdxPSGridDataCellPos;
...
const
  StyleIndexes: array [Boolean] of Integer = (vspsGridContentEven,
    vspsGridContentOdd);
var
  DataCellPos: TdxPSGridDataCellPos;
begin
  if (ARecord <> nil) and (GetValue(StyleIndexes[Odd(ARecord.Index)]) <> nil)
  then
  begin
    DataCellPos := CreatePSDataCellPos;
    try
      ...
      GetViewParams(StyleIndexes[Odd(ARecord.Index)], DataCellPos, nil,
        AParams);
    finally
      FreePSDataCellPos(DataCellPos);
    end;
...
procedure TdxGridReportLinkStyles.GetFilterBarParams
  (out AParams: TcxViewParams);
begin
...
procedure TdxGridReportLinkStyles.GetSelectionParams
  (out AParams: TcxViewParams);
begin
...
procedure TdxGridReportLinkStyles.GetDefaultViewParams(Index: Integer;
  AData: TObject; out AParams: TcxViewParams);
const
  FixedParts = [vspsGridBandHeader, vspsGridCaption, vspsGridFooter,
    vspsGridHeader, vspsGridSelection];
begin
  inherited;
...
class function TdxGridReportLinkStyles.GetStyleCaption
...
function TdxGridReportLinkStyles.GetStyleIndexByCaption(const Caption
  : string): Integer;
begin
...
begin
  Result := (AStyle <> nil) and
    ((AStyle = CardRowCaption) or (AStyle = CardCaptionRow));
end;
...
procedure TdxGridReportLinkStyleSheet.SetStylesValue
  (Value: TdxGridReportLinkStyles);
begin
  SetStyles(Value);
end;
...
procedure TdxGridReportLink.AddHorizontalPageBreak(const AGridColumns
  : array of TcxGridColumn);
var
  I: Integer;
begin
...
procedure TdxGridReportLink.AddPageBreak(const AGridRecords
  : array of TcxCustomGridRecord);
var
  I: Integer;
begin
...
procedure TdxGridReportLink.ConstructReport(AReportCells: TdxReportCells);
  ...
  begin
    Result := RenderInfo.CalculateActualScaleFactor(0,
      RealPrinterPage.FitToPagesVertically, PixelsPerInch);
  end;
  ...
  begin
    Result := OptionsSize.AutoWidth and (RealPrinterPage.ScaleMode = smFit) and
      (RealPrinterPage.FitToPagesVertically > 0);
  end;
...
begin
  ...
  with DrawInfo do
    case GridAttributeID of
      dxGridBandID:
        DoCustomDrawBandCell(ACanvas, TcxGridBandedTableView(GridView),
          GridBand, TdxReportCellString(AItem), ADone);
      dxGridCardRowCaptionID:
        DoCustomDrawCardRowCaptionCell(ACanvas, TcxGridCardView(GridView),
          GridCard, GridCardRow, TdxReportCellString(AItem), ADone);
      dxGridCardRowDataID:
        DoCustomDrawCardRowDataCell(ACanvas, TcxGridCardView(GridView),
          GridCard, GridCardRow, AItem, ADone);
      dxGridFilterBarID:
        DoCustomDrawFilterBar(ACanvas, TcxCustomGridTableView(GridView),
          TdxReportCellString(AItem), ADone);
      dxGridFooterID, dxGridGroupFooterID:
      ...
      dxGridLevelCaptionID:
        DoCustomDrawLevelCaption(ACanvas, GridView,
          TdxReportCellString(AItem), ADone);
    end;
end;
...
function TdxGridReportLink.GetRebuildOnPageParamsChange
  (AUpdateCodes: TdxPrinterPageUpdateCodes): Boolean;
begin
  Result := (AUpdateCodes * uaMarginsVert <> []) and
    (ProcessParams.HasOnlyCards or ProcessParams.HasCardsInDetail or
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        OptionsPreview.MaxLineCount := TcxGridTableView(View)
          .Preview.MaxLineCount;
        OptionsPreview.Visible := TcxGridTableView(View).Preview.Visible;

        if View is TcxGridBandedTableView then
          OptionsView.BandHeaders := TcxGridBandedTableView(View)
            .OptionsView.BandHeaders;
        OptionsView.FilterBar :=
          (TcxGridTableView(View).Filtering.Visible = fvAlways) or
...
function TdxGridReportLink.IsSupportedCustomDraw
  (Item: TAbstractdxReportCellData): Boolean;
var
  DrawInfo: TdxGridCellCustomDrawInfo;
begin
  Result := inherited IsSupportedCustomDraw(Item) and (Item <> nil) and
    IsCustomDrawn(GetItemCustomDrawInfo(Item, DrawInfo));
end;
...
function TdxGridReportLink.NeedExpandGroups(AGridView: TcxCustomGridView;
  ARecursive: Boolean = True): Boolean;
var
  I: Integer;
  ALevel: TcxGridLevel;
...
function TdxGridReportLink.GetStyleSheetClass
  : TdxCustomReportLinkStyleSheetClass;
begin
  Result := TdxGridReportLinkStyleSheet;
end;

function TdxGridReportLink.GetStyleSheetPrototype
...
begin
  ...
  // ReportCells.CreateGroupLookAndFeel(TdxPSReportGroupNullLookAndFeel);

  if OptionsExpanding.HasAny or NeedExpandGroups(ActiveView,
    not OptionsDetails.OnlyFocusedView) then
    DoExpandRows;
...
begin
  if Assigned(FOnCustomDrawCardRowCaptionCell) then
    FOnCustomDrawCardRowCaptionCell(Self, ACanvas, AView, ACard, ARow,
      AnItem, ADone);
end;
...
begin
  if Assigned(FOnCustomDrawCardRowDataCell) then
    FOnCustomDrawCardRowDataCell(Self, ACanvas, AView, ACard, ARow,
      AnItem, ADone);
end;
...
begin
  if Assigned(FOnCustomDrawFooterCell) then
    FOnCustomDrawFooterCell(Self, ACanvas, AView, ARecord, AColumn, ALevel,
      AnItem, ADone);
end;
...
begin
  if Assigned(FOnGetCustomPageBreaks) then
    FOnGetCustomPageBreaks(Self);
end;
...
procedure TdxGridReportLink.DoInitializeCardRowCaptionCell
  (AView: TcxGridCardView; ACard: TcxGridCard; ARow: TcxGridCardViewRow;
...
function TdxGridReportLink.GetOptionsCardsClass
  : TdxGridReportLinkOptionsCardsClass;
begin
  Result := TdxGridReportLinkOptionsCards;
end;

function TdxGridReportLink.GetOptionsChartsClass
  : TdxGridReportLinkOptionsChartsClass;
begin
  Result := TdxGridReportLinkOptionsCharts;
end;

function TdxGridReportLink.GetOptionsDetailsClass
  : TdxGridReportLinkOptionsDetailsClass;
begin
  Result := TdxGridReportLinkOptionsDetails;
end;

function TdxGridReportLink.GetOptionsExpandingClass
  : TdxCustomReportLinkOptionsExpandingClass;
begin
  Result := TdxGridReportLinkOptionsExpanding;
end;

function TdxGridReportLink.GetOptionsFormattingClass
  : TdxCustomReportLinkOptionsFormattingClass;
begin
  Result := TdxGridReportLinkOptionsFormatting;
end;

function TdxGridReportLink.GetOptionsLevelsClass
  : TdxGridReportLinkOptionsLevelsClass;
begin
  Result := TdxGridReportLinkOptionsLevels;
end;

function TdxGridReportLink.GetOptionsOnEveryPageClass
  : TdxCustomTableControlReportLinkOptionsOnEveryPageClass;
begin
  Result := TdxGridReportLinkOptionsOnEveryPage;
end;

function TdxGridReportLink.GetOptionsPaginationClass
  : TdxCustomReportLinkOptionsPaginationClass;
begin
  Result := TdxGridReportLinkOptionsPagination;
end;

function TdxGridReportLink.GetOptionsPreviewClass
  : TdxCustomTableControlReportLinkOptionsPreviewClass;
begin
  Result := TdxGridReportLinkOptionsPreview;
end;

function TdxGridReportLink.GetOptionsRefinementsClass
  : TdxCustomReportLinkOptionsRefinementsClass;
begin
  Result := TdxGridReportLinkOptionsRefinements;
end;

function TdxGridReportLink.GetOptionsSelectionClass
  : TdxCustomTableControlReportLinkOptionsSelectionClass;
begin
  Result := TdxGridReportLinkOptionsSelection;
end;

function TdxGridReportLink.GetOptionsSizeClass
  : TdxCustomReportLinkOptionsSizeClass;
begin
  Result := TdxGridReportLinkOptionsSize;
end;

function TdxGridReportLink.GetOptionsViewClass
  : TdxCustomReportLinkOptionsViewClass;
begin
...
procedure TdxGridReportLink.BuildView(AMasterBuilder: TdxCustomGridViewBuilder;
  AGridView: TcxCustomGridView);
begin
  if OptionsLevels.Unwrap and OptionsLevels.SkipEmptyViews and
    not dxViewHelpersFactory[AGridView].HasData(AGridView) then
    Exit;
...
function TdxGridReportLink.CreateViewAdapter(AMasterAdapter
  : TdxCustomGridViewAdapter; AGridView: TcxCustomGridView)
  : TdxCustomGridViewAdapter;
begin
  Result := dxGridViewBuildersFactory.CreateViewAdapter(AMasterAdapter,
    AGridView);
end;

function TdxGridReportLink.CreateViewBuilder(AMasterBuilder
  : TdxCustomGridViewBuilder; AGridView: TcxCustomGridView)
  : TdxCustomGridViewBuilder;
begin
  Result := dxGridViewBuildersFactory.CreateViewBuilder(Self, AMasterBuilder,
    AGridView);
end;
...
procedure TdxGridReportLink.ForEachView(AMasterRow: TcxGridMasterDataRow;
  AProc: TdxGridViewProc);
var
  I: Integer;
  GridView: TcxCustomGridView;
...
begin
  dxViewHelpersFactory.HelperClassByItem(AnItem).ExtractCustomDrawInfo(AnItem,
    ADrawInfo);
...
function TdxGridReportLink.IsCustomDrawn(AnAttributeID
  : TdxGridAttributeID): Boolean;
begin
  Result := False;
...
procedure TdxGridReportLink.CalculateProcessParams;
  ...
  function CalculateHasUnwrapableData(ALevel: TComponent; ARecursive: Boolean)
    : Boolean; overload;
  var
    ViewCount, I: Integer;
    GridView: TcxCustomGridView;
  ...
  begin
    if OptionsDetails.StartFromFocusedView and (Grid.FocusedView <> nil) then
      Result := CalculateHasUnwrapableData(TcxGridLevel(Grid.FocusedView.Level)
        .Parent, not OptionsDetails.OnlyFocusedView)
    else
...
begin
  ...
  with FProcessParams do
    ...
    begin
      ...
      try
        HasUnwrapableData := CalculateHasUnwrapableData;
        // Grid.ActiveLevel.GridView);
        ...
        HasMasterDetails := (HasUnwrapableData and OptionsLevels.Unwrap) or
          ...
          not(OptionsDetails.StartFromFocusedView and
          OptionsDetails.OnlyFocusedView));
        HasCardsInDetail := False;
        for I := 0 to Grid.ViewCount - 1 do
          if Grid.Views[I].IsDetail and
            (Grid.Views[I] is TcxGridCustomLayoutView) then
...
function TdxGridReportLink.CanAttributeBeUsedOnEveryPage
  (AnAttribute: TdxGridAttributeClass): Boolean;
begin
  Result := ProcessParams.CanUseOnEveryPageMode and
    OptionsOnEveryPage.HasInstalledAttribute(AnAttribute);
end;

function TdxGridReportLink.IsAttributeUsedOnEveryPage
  (AnAttribute: TdxGridAttributeClass): Boolean;
begin
  Result := CanAttributeBeUsedOnEveryPage(AnAttribute) or
...
begin
  ...
  with ActiveView do
    if MasterGridRecordIndex <> -1 then
      Result := (MasterGridView as TcxGridTableView).ViewData.Rows
        [MasterGridRecordIndex] as TcxGridMasterDataRow;
end;
...
function TdxGridReportLink.GetOptionsRefinements
  : TdxGridReportLinkOptionsRefinements;
begin
  Result := inherited OptionsRefinements as TdxGridReportLinkOptionsRefinements;
end;

function TdxGridReportLink.GetOptionsSelection
  : TdxGridReportLinkOptionsSelection;
begin
...
function TdxGridReportLink.GetReportDataCellByGridColumn(AColumn: TcxGridColumn)
  : TAbstractdxReportCellData;
begin
  if (ReportRowCount = 0) or not ReportRows[0].FindDataItemByData
    (TdxNativeInt(AColumn), Result) then
    Result := nil;
end;
...
function TdxGridReportLink.GetReportRowByGridRecord
  (GridRecord: TcxCustomGridRecord): TdxReportCell;
var
  I: Integer;
begin
...
procedure TdxGridReportLink.SetOnCustomDrawBandCell
  (Value: TdxGridReportLinkCustomDrawBandCellEvent);
begin
...
procedure TdxGridReportLink.SetOnCustomDrawCell
  (Value: TdxGridReportLinkCustomDrawCellEvent);
begin
...
procedure TdxGridReportLink.SetOnCustomDrawCardRowCaptionCell
  (Value: TdxGridReportLinkCustomDrawCardRowCaptionCellEvent);
begin
...
procedure TdxGridReportLink.SetOnCustomDrawCardRowDataCell
  (Value: TdxGridReportLinkCustomDrawCardRowDataCellEvent);
begin
...
procedure TdxGridReportLink.SetOnCustomDrawFilterBar
  (Value: TdxGridReportLinkCustomDrawFilterBarEvent);
begin
...
procedure TdxGridReportLink.SetOnCustomDrawFooterCell
  (Value: TdxGridReportLinkCustomDrawFooterCellEvent);
begin
...
procedure TdxGridReportLink.SetOnCustomDrawHeaderCell
  (Value: TdxGridReportLinkCustomDrawHeaderCellEvent);
begin
...
procedure TdxGridReportLink.SetOnCustomDrawLevelCaption
  (Value: TdxGridReportLinkCustomDrawLevelCaptionEvent);
begin
...
procedure TdxGridReportLink.SetOptionsCards
  (Value: TdxGridReportLinkOptionsCards);
begin
  OptionsCards.Assign(Value);
end;

procedure TdxGridReportLink.SetOptionsCharts
  (Value: TdxGridReportLinkOptionsCharts);
begin
  OptionsCharts.Assign(Value);
end;

procedure TdxGridReportLink.SetOptionsDetails
  (Value: TdxGridReportLinkOptionsDetails);
begin
  OptionsDetails.Assign(Value);
end;

procedure TdxGridReportLink.SetOptionsExpanding
  (Value: TdxGridReportLinkOptionsExpanding);
begin
  OptionsExpanding.Assign(Value);
end;

procedure TdxGridReportLink.SetOptionsFormatting
  (Value: TdxGridReportLinkOptionsFormatting);
begin
  inherited OptionsFormatting := Value;
end;

procedure TdxGridReportLink.SetOptionsLevels
  (Value: TdxGridReportLinkOptionsLevels);
begin
  OptionsLevels.Assign(Value);
end;

procedure TdxGridReportLink.SetOptionsOnEveryPage
  (Value: TdxGridReportLinkOptionsOnEveryPage);
begin
  inherited OptionsOnEveryPage := Value;
end;

procedure TdxGridReportLink.SetOptionsPagination
  (Value: TdxGridReportLinkOptionsPagination);
begin
  inherited OptionsPagination := Value;
end;

procedure TdxGridReportLink.SetOptionsPreview
  (Value: TdxGridReportLinkOptionsPreview);
begin
  inherited OptionsPreview := Value;
end;

procedure TdxGridReportLink.SetOptionsRefinements
  (Value: TdxGridReportLinkOptionsRefinements);
begin
  inherited OptionsRefinements := Value;
end;

procedure TdxGridReportLink.SetOptionsSelection
  (Value: TdxGridReportLinkOptionsSelection);
begin
...
procedure TcxGridCardView2Styles.GetCardShadowParams
...
procedure TcxGridCardView2Styles.GetDefaultViewParams(Index: Integer;
  AData: TObject; out AParams: TcxViewParams);
begin
  inherited;
  if Index = vsCardShadow then
    AParams.Color := clWindowText;
end;
...
type
  ...
  protected
    class function GetCaptionViewInfoClass
      : TcxGridCardRowCaptionViewInfoClass; override;
    class function GetDataViewInfoClass
      : TcxGridCardRowDataViewInfoClass; override;
  end;
  ...
  protected
    ...
    class function GetRowViewInfoClass(ARow: TcxGridCardViewRow)
      : TcxGridCardRowViewInfoClass; override;

    function GetBottomShadowRect: TRect; virtual;
    function GetBottomShadowRestRect: TRect; virtual;
    function GetCardRowCaptionBorders(ARowCaption
      : TcxGridCardRowCaptionViewInfo2): TcxBorders; virtual;
    function GetCardRowDataBorders(ARowData: TcxGridCardRowDataViewInfo2)
      : TcxBorders; virtual;
    function GetGridLineColor: TColor; virtual;
...
function TcxGridCardRowCaptionViewInfo2.GetBorderColor
...
function TcxGridCardRowCaptionViewInfo2.GetBorderWidth
...
class function TcxGridCardDataRowViewInfo2.GetCaptionViewInfoClass
  : TcxGridCardRowCaptionViewInfoClass;
begin
  Result := TcxGridCardRowCaptionViewInfo2;
end;

class function TcxGridCardDataRowViewInfo2.GetDataViewInfoClass
  : TcxGridCardRowDataViewInfoClass;
begin
...
class function TcxGridCardCaptionRowViewInfo2.GetCaptionViewInfoClass
  : TcxGridCardRowCaptionViewInfoClass;
begin
  Result := TcxGridCardRowCaptionViewInfo2;
end;

class function TcxGridCardCaptionRowViewInfo2.GetDataViewInfoClass
  : TcxGridCardRowDataViewInfoClass;
begin
  Result := TcxGridCardRowDataViewInfo2;
end;
...
begin
  ...
  if RecordsViewInfo.AutoDataRecordHeight or (RecordsViewInfo.RecordHeight = -1)
  then
...
class function TcxGridCardViewInfo2.GetRowViewInfoClass
  (ARow: TcxGridCardViewRow): TcxGridCardRowViewInfoClass;
const
  RowViewInfoClasses: array [TcxGridCardViewRowKind]
    of TcxGridCardRowViewInfoClass = (TcxGridCardDataRowViewInfo2,
    TcxGridCardCaptionRowViewInfo2, TcxGridCardCaptionRowViewInfo2);
begin
...
function TcxGridCardViewInfo2.GetCardRowCaptionBorders
  (ARowCaption: TcxGridCardRowCaptionViewInfo2): TcxBorders;
begin
  Result := [bLeft, bTop];
  ...
  begin
    ...
    if not(GridLines in [glBoth, glHorizontal]) and
      (ARowCaption.Row.VisibleIndex > 0) then
      Exclude(Result, bTop);
  end;
end;

function TcxGridCardViewInfo2.GetCardRowDataBorders
  (ARowData: TcxGridCardRowDataViewInfo2): TcxBorders;
begin
  ...
  begin
    ...
    if not(GridLines in [glBoth, glHorizontal]) and
      (ARowData.Row.VisibleIndex > 0) then
      Exclude(Result, bTop);
...
begin
  TcxGridCardView2Styles(GridView.Styles).GetCardShadowParams
    (GridRecord, Params);
  Result := Params.Color;
  if Result = clDefault then
    Result := clWindowText;
...
var
  Params: TcxViewParams;
begin
  TcxGridCardView2Styles(GridView.Styles).GetViewParams(vsBackground, nil,
    nil, Params);
  Result := Params.Color;
end;
...
function TcxGridCardViewViewData2.GetRecordClass(const ARecordInfo: TcxRowInfo)
  : TcxCustomGridRecordClass;
begin
  Result := TcxGridCard2;
end;
...
function TcxGridCardViewViewInfo2.GetRecordsViewInfoClass
...
begin
  ...
  LoadDataIntoPreviewGridView(PreviewGrid.Levels[0]
  ...
  begin
    ...
    Items.AddObject(cxGetResourceString(@sdxLookAndFeelStandard),
      TObject(lfStandard));
    Items.AddObject(cxGetResourceString(@sdxLookAndFeelUltraFlat),
      TObject(lfUltraFlat));

    cbxLookAndFeel.ItemIndex := Items.IndexOfObject
      (TObject(ReportLink.OptionsFormatting.LookAndFeelKind));
  end;
...
begin
  ...
  chbxCaptionsOnEveryPage.Caption :=
    DropAmpersand(cxGetResourceString(@sdxLevelCaption));
  chbxBandsOnEveryPage.Caption := DropAmpersand(cxGetResourceString(@sdxBands));
  chbxHeadersOnEveryPage.Caption :=
    DropAmpersand(cxGetResourceString(@sdxHeaders));
  chbxFootersOnEveryPage.Caption :=
    DropAmpersand(cxGetResourceString(@sdxFooters));
  chbxFilterBarOnEveryPage.Caption :=
    DropAmpersand(cxGetResourceString(@sdxFilterBar));
  ...
  chbxProcessExactSelection.Caption :=
    cxGetResourceString(@sdxProcessExactSelection);
  ...
  chbxStartFromActiveView.Caption :=
    cxGetResourceString(@sdxStartFromActiveDetails);
  ...
  chbxLevelsRiseActiveLevelOntoTop.Caption :=
    cxGetResourceString(@sdxRiseActiveToTop);
  ...
  chbxTransparentGraphics.Caption :=
    cxGetResourceString(@sdxTransparentGraphics);
  chbxDisplayGraphicsAsText.Caption :=
    DropAmpersand(cxGetResourceString(@sdxDisplayGraphicsAsText));
  chbxDisplayTrackBarsAsText.Caption :=
    DropAmpersand(cxGetResourceString(@sdxDisplayTrackBarsAsText));
  ...
  chbxSuppressBackgroundBitmaps.Caption :=
    cxGetResourceString(@sdxSuppressBackgroundBitmaps);
  chbxConsumeSelectionStyle.Caption :=
    cxGetResourceString(@sdxConsumeSelectionStyle);

  lblPagination.Caption := cxGetResourceString(@sdxPagination);
  chbxPaginateByTopLevelGroups.Caption :=
    cxGetResourceString(@sdxByTopLevelGroups);
  chbxPaginateOneGroupPerPage.Caption :=
    cxGetResourceString(@sdxOneGroupPerPage);
  ...
  btnStyleBackgroundBitmapClear.Caption :=
    cxGetResourceString(@sdxBtnTextureClear);
  btnStyleRestoreDefaults.Caption :=
    cxGetResourceString(@sdxBtnRestoreDefaults);
  ...
  miStyleBackgroundBitmapClear.Caption :=
    cxGetResourceString(@sdxBtnTextureClear);
  ...
  lblPreviewMaxLineCount.Caption :=
    cxGetResourceString(@sdxPreviewMaxLineCount);
...
begin
  ...
  if View <> nil then
    ...
    begin
      ...
      chbxShowExpandButtons.Enabled :=
        IsAttributeSupported(TdxGridExpandButton);
      ...
      chbxCaptionsOnEveryPage.Enabled :=
        IsAttributeSupported(TdxGridLevelCaption) and
        not ReportLink.IsAggregated;
      chbxBandsOnEveryPage.Enabled := IsAttributeSupported(TdxGridBandHeader)
        and not ReportLink.IsAggregated;
      chbxHeadersOnEveryPage.Enabled := IsAttributeSupported(TdxGridHeader) and
        not ReportLink.IsAggregated;
      chbxFilterBarOnEveryPage.Enabled := IsAttributeSupported(TdxGridFilterBar)
        and not ReportLink.IsAggregated;
      chbxFootersOnEveryPage.Enabled := IsAttributeSupported(TdxGridFooter) and
        not ReportLink.IsAggregated;
      ...
      lgDetails.Visible := IsDesigning or HasMasterDetailsInTopView or
        HasUnwrapableData;
      ...
      lgPagination.Visible := IsDesigning or
        IsAttributeSupported(TdxGridGroupRow);
    end;
  ...
  btnStyleBackgroundBitmap.Enabled := AreNativeStylesAvailable and
    HasSelectedStyles;
  btnStyleBackgroundBitmapClear.Enabled := AreNativeStylesAvailable and
    HasSelectedStylesWithAssignedBitmap;
  btnStyleRestoreDefaults.Enabled := AreNativeStylesAvailable and
    HasSelectedStyles;
...
const
  DetailTabsPositionMap: array [Boolean] of TcxGridDetailTabsPosition =
    (dtpNone, dtpTop);
  GroupFootersMap: array [Boolean] of TcxGridGroupFootersMode = (gfInvisible,
    gfAlwaysVisible);
  FilteringMap: array [Boolean] of TcxGridFilterVisible = (fvNonEmpty,
    fvAlways);
  TransparentsMap: array [Boolean] of TcxImageTransparency = (gtOpaque,
    gtTransparent);
  ...
  begin
    ...
    if View is TcxCustomGridTableView then
      Result := CustomGridTableFiltering_GetPosition
        (TcxCustomGridTableView(View).Filtering)
    else
      Result := fpBottom;
  end;
  ...
  begin
    ...
    begin
      ...
      OptionsView.GroupFooters := GroupFootersMap
        [ReportLink.OptionsView.GroupFooters];
  ...
  begin
    ...
    PreviewCardView.Filtering.Visible :=
      FilteringMap[ReportLink.OptionsView.FilterBar];
...
begin
  ...
  dxAssignFont(PreviewGrid.Font, ReportLink.Font, ScaleFactor,
    ReportLink.ScaleFactor);

  PreviewGrid.RootLevelOptions.DetailTabsPosition := DetailTabsPositionMap
    [ReportLink.OptionsView.Caption];

  for I := 0 to FGridLinkPreviewStyles.Count - 1 do
    FGridLinkPreviewStyles.Values[FGridLinkPreviewStyles.Items[I].Index]
      .Font.Height := ScaleFactor.Apply(ReportLink.ActiveStyles.Values
      [ReportLink.ActiveStyles.Items[I].Index].Font.Height,
      ReportLink.ScaleFactor);
...
begin
  lbxStyles.ReportLinkStyles := ReportLink.ActiveStyles;
  inherited;
  cbxStyleSheets.ItemIndex := cbxStyleSheets.Properties.Items.IndexOfObject
    (ActiveStyleSheet);
  ...
  begin
    ...
    try
      ...
      try
        ...
        try
          Clear;
          AddObject(cxGetResourceString(@sdxBandHeaderStyle),
            Styles.BandHeader);
          AddObject(cxGetResourceString(@sdxCaptionStyle), Styles.Caption);
          AddObject(cxGetResourceString(@sdxCardCaptionRowStyle),
            Styles.CardCaptionRow);
          AddObject(cxGetResourceString(@sdxCardRowCaptionStyle),
            Styles.CardRowCaption);
          AddObject(cxGetResourceString(@sdxContentStyle), Styles.Content);
          AddObject(cxGetResourceString(@sdxContentEvenStyle),
            Styles.ContentEven);
          AddObject(cxGetResourceString(@sdxContentOddStyle),
            Styles.ContentOdd);
...
procedure TdxfmGridReportLinkDesignWindow.GetSelectedStyleNames
  (AStrings: TStrings);
var
  I: Integer;
begin
...
procedure TdxfmGridReportLinkDesignWindow.GetStyleSheetNames
  (out AStrings: TStrings);
begin
...
function TdxfmGridReportLinkDesignWindow.
  GetHasSelectedStylesWithAssignedBitmap: Boolean;
var
  Strings: TStrings;
  I: Integer;
  cxStyle: TcxStyle;
begin
  ...
  try
    ...
    begin
      ...
      if (cxStyle <> nil) and (cxStyle.Bitmap <> nil) and not cxStyle.Bitmap.Empty
      then
        Exit;
    end;
  finally
...
procedure TdxfmGridReportLinkDesignWindow.CardShadowColorChanged
  (Sender: TObject);
begin
  if LockControlsUpdate then
    Exit;
...
procedure TdxfmGridReportLinkDesignWindow.CardShadowDepthChanged
  (Sender: TObject);
begin
  if LockControlsUpdate then
    Exit;
...
procedure TdxfmGridReportLinkDesignWindow.PreviewMaxLineCountChanged
  (Sender: TObject);
begin
  if LockControlsUpdate then
    Exit;
...
begin
  ...
  begin
    for I := 0 to lbxStyles.Items.Count - 1 do
      if not lbxStyles.Selected[I] then
        Exit;
    Result := False;
  end;
end;

procedure TdxfmGridReportLinkDesignWindow.ChangeActiveView
  (AView: TcxCustomGridView);
var
  ALevel: TcxGridLevel;
begin
...
procedure TdxfmGridReportLinkDesignWindow.CreateCardView;
  ...
  function CreateRow(APropertiesClass: TcxCustomEditPropertiesClass = nil;
    AOnCustomDraw: TcxGridTableDataCellCustomDrawEvent = nil)
    : TcxGridCardViewRow;
  begin
...
begin
  PreviewCardView := PreviewGrid.CreateView(TcxGridCardView2)
    as TcxGridCardView2;
  ...
  rowSpeedCount := CreateRow(TcxTrackBarProperties,
    colSpeedCountCustomDrawCell);
end;

procedure TdxfmGridReportLinkDesignWindow.CreateChartView;
begin
  PreviewCharView := PreviewGrid.CreateView(TcxGridChartView)
    as TcxGridChartView;
...
begin
  ...
  begin
    ...
    ACanvas.DrawComplexFrame(R, clBtnHighlight,
      BottomRightColors[ReportLink.OptionsFormatting.LookAndFeelKind =
      lfStandard]);
  end;
...
const
  AlignmentHorzMap: array [TAlignment] of Integer = (cxAlignLeft, cxAlignRight,
    cxAlignCenter);
  AlignmentVertMap: array [TcxAlignmentVert] of Integer = (cxAlignTop,
    cxAlignBottom, cxAlignVCenter);
begin
  with AViewInfo do
  begin
    ...
    begin
      ...
      cxBkgndDrawPicture(ABackgroundBitmap, ACanvas.Canvas, R, ppmTile, 1, 1,
        -R.Left, -R.Top);
    ...
    ACanvas.DrawText(Text, R, AlignmentHorzMap[AlignmentHorz] or
      AlignmentVertMap[AlignmentVert] or cxSingleLine);
...
procedure TdxfmGridReportLinkDesignWindow.InitializePreviewGrid;
  ...
  procedure SetupDataBindings(AView: TcxCustomGridTableView);
    ...
    begin
      case Index of
        0:
          Result := cxGetResourceString(@sdxManufacturerNameColumnCaption);
        1:
          Result := cxGetResourceString(@sdxManufacturerLogoColumnCaption);
        2:
          Result := cxGetResourceString(@sdxManufacturerCountryColumnCaption);
        3:
          Result := cxGetResourceString(@sdxCarModelColumnCaption);
        4:
  ...
  const
    ColumnTypes: array [0 .. 5] of TcxValueTypeClass = (TcxStringValueType,
      TcxStringValueType, TcxStringValueType, TcxStringValueType,
      TcxBooleanValueType, TcxStringValueType);
  var
    I: Integer;
  begin
...
begin
  ...
  PreviewBandedView.Bands[0].Caption :=
    cxGetResourceString(@sdxManufacturerBandCaption);
  PreviewBandedView.Bands[1].Caption :=
    cxGetResourceString(@sdxModelBandCaption);
  PreviewBandedView.DataController.Summary.FooterSummaryItems[0].Format :=
    cxGetResourceString(@sdxSummaryFormat);
...
begin
  ...
  begin
    ...
    PreviewGrid.RootLevelStyles.TabsBackground :=
      FGridLinkPreviewStyles.Caption;
  ...
  begin
    ...
    begin
      ...
      PreviewGrid.RootLevelStyles.TabsBackground :=
        ReportLink.Grid.RootLevelStyles.TabsBackground;
    end
    else
    ...
    if PreviewBandedView <> nil then
      if ReportLink.ActiveView is TcxGridBandedTableView then
        PreviewBandedView.Styles := TcxGridBandedTableView
          (ReportLink.ActiveView).Styles
      else
        dxPScxCommon.dxPSResetStyles(PreviewBandedView.Styles);
...
procedure TdxfmGridReportLinkDesignWindow.LoadDataIntoPreviewGridView
  (AView: TcxCustomGridTableView);

  procedure AddRecord(ARecordIndex: Integer;
...
const
  RecordCount = 4;
  // CarSalesCount: array[0..RecordCount - 1] of Integer = (10, 6, 3, 5);
  IsCarSUV: array [0 .. RecordCount - 1] of string = ('True', 'True',
    'False', 'True');
...
begin
  ...
  for I := 0 to RecordCount - 1 do
    AddRecord(I, [dxStringToAnsiString(CarVendorName(I)),
      dxPScxCommon.dxPSPreviewCarLogosAsString(I),
      dxStringToAnsiString(CarVendorCountry(I)),
      dxStringToAnsiString(CarModel(I)), dxStringToAnsiString(IsCarSUV[I]),
      dxStringToAnsiString(SpeedCount[I])]); // , CarSalesCount[I]]);
end;
...
procedure TdxfmGridReportLinkDesignWindow.UpdatePreviewGridStyles
  (const ACaption: string; AStyle: TcxStyle);
begin
  ...
  with PreviewBandedView.Styles do
  begin
    if dxPSUtl.dxSameText(ACaption, cxGetResourceString(@sdxBandHeaderStyle))
    then
      BandHeader := AStyle
    else if dxPSUtl.dxSameText(ACaption, cxGetResourceString(@sdxContentStyle))
    then
      Content := AStyle
    else if dxPSUtl.dxSameText(ACaption,
      cxGetResourceString(@sdxContentEvenStyle)) then
      ContentEven := AStyle
    else if dxPSUtl.dxSameText(ACaption,
      cxGetResourceString(@sdxContentOddStyle)) then
      ContentOdd := AStyle
    else if dxPSUtl.dxSameText(ACaption, cxGetResourceString(@sdxFooterStyle))
    then
      Footer := AStyle
    else if dxPSUtl.dxSameText(ACaption, cxGetResourceString(@sdxGroupStyle))
    then
      Group := AStyle
    else if dxPSUtl.dxSameText(ACaption, cxGetResourceString(@sdxHeaderStyle))
    then
      Header := AStyle
    else if dxPSUtl.dxSameText(ACaption, cxGetResourceString(@sdxPreviewStyle))
    then
      Preview := AStyle;
  end;
  ...
  with PreviewCardView.Styles do
  begin
    if dxPSUtl.dxSameText(ACaption, cxGetResourceString(@sdxCardCaptionRowStyle))
    then
      CaptionRow := AStyle
    else if dxPSUtl.dxSameText(ACaption,
      cxGetResourceString(@sdxCardRowCaptionStyle)) then
      RowCaption := AStyle
    else if dxPSUtl.dxSameText(ACaption, cxGetResourceString(@sdxContentStyle))
    then
      Content := AStyle
...
begin
  with ReportLink.HostInfoServices do
    wpIncorrectOnEveryPageState.SetStateAndHint(IsInconsistentState,
      InconsistentStateText);
end;
  ...
  with ReportLink.OptionsCards do
    case Index of
      ...
      1:
        KeepSameWidth := Value;
      2:
        KeepSameHeight := Value;
      3:
        Borders := Value;
      4:
        RowBordersHorz := Value;
      5:
        RowBordersVert := Value;
    end;
  Modified := True;
end;

procedure TdxfmGridReportLinkDesignWindow.SetOptionsChartsByIndex
...
procedure TdxfmGridReportLinkDesignWindow.SetOptionsDetailsByIndex
  (Index: Integer; Value: Boolean);
begin
  if LockControlsUpdate then
    Exit;
  ...
  with ReportLink.OptionsDetails do
    case Index of
      0:
        StartFromFocusedView := Value;
      1:
        OnlyFocusedView := Value;
    end;
  ReportLink.CalculateProcessParams;
  Modified := True;
end;

procedure TdxfmGridReportLinkDesignWindow.SetOptionsExpandingByIndex
  (Index: Integer; Value: Boolean);
begin
  if LockControlsUpdate then
    Exit;
...
procedure TdxfmGridReportLinkDesignWindow.SetOptionsFormattingByIndex
  (Index: Integer; Value: Boolean);
begin
  if LockControlsUpdate then
    Exit;
  ...
  with ReportLink.OptionsFormatting do
    case Index of
      ...
      1:
        SuppressBackgroundBitmaps := Value;
      2:
        ConsumeSelectionStyle := Value;
    end;
  Modified := True;
  UpdatePreview;
end;

procedure TdxfmGridReportLinkDesignWindow.SetOptionsLevelsByIndex
  (Index: Integer; Value: Boolean);
begin
  if LockControlsUpdate then
    Exit;
  ...
  with ReportLink.OptionsLevels do
    case Index of
      0:
        Unwrap := Value;
      1:
        UnwrapTopLevel := Value;
      2:
        RiseActiveLevelOntoTop := Value;
      3:
        SkipEmptyViews := Value;
    end;
  ReportLink.CalculateProcessParams;
  Modified := True;
end;

procedure TdxfmGridReportLinkDesignWindow.SetOptionsOnEveryPageByIndex
  (Index: Integer; Value: Boolean);
begin
  if LockControlsUpdate then
    Exit;
...
procedure TdxfmGridReportLinkDesignWindow.SetOptionsPaginationByIndex
  (Index: Integer; Value: Boolean);
begin
  if LockControlsUpdate then
    Exit;
  ...
  with ReportLink.OptionsPagination do
    case Index of
      0:
        TopLevelGroup := Value;
      1:
        OneGroupPerPage := Value;
    end;
  Modified := True;
end;

procedure TdxfmGridReportLinkDesignWindow.SetOptionsRefinementsByIndex
  (Index: Integer; Value: Boolean);
begin
  if LockControlsUpdate then
    Exit;
  ...
  with ReportLink.OptionsRefinements do
    case Index of
      0:
        TransparentGraphics := Value;
      1:
        DisplayGraphicsAsText := Value;
      2:
        FlatCheckMarks := Value;
      3:
        TransparentRichEdits := Value;
      4:
        DisplayTrackBarsAsText := Value;
    end;
  Modified := True;
  UpdatePreview;
end;

procedure TdxfmGridReportLinkDesignWindow.SetOptionsSelectionByIndex
  (Index: Integer; Value: Boolean);
begin
  if LockControlsUpdate then
    Exit;
...
procedure TdxfmGridReportLinkDesignWindow.OptionsOnEveryPageClick
  (Sender: TObject);
begin
  with TcxCheckBox(Sender) do
...
procedure TdxfmGridReportLinkDesignWindow.OptionsSelectionClick
  (Sender: TObject);
begin
  with TcxCheckBox(Sender) do
...
procedure TdxfmGridReportLinkDesignWindow.OptionsExpandingClick
  (Sender: TObject);
begin
  with TcxCheckBox(Sender) do
...
procedure TdxfmGridReportLinkDesignWindow.OptionsRefinementClick
  (Sender: TObject);
begin
  with TcxCheckBox(Sender) do
...
procedure TdxfmGridReportLinkDesignWindow.OptionsFormatingClick
  (Sender: TObject);
begin
  with TcxCheckBox(Sender) do
...
procedure TdxfmGridReportLinkDesignWindow.lblUseNativeStylesClick
  (Sender: TObject);
begin
...
procedure TdxfmGridReportLinkDesignWindow.OptionsPaginationClick
  (Sender: TObject);
begin
  with TcxCheckBox(Sender) do
...
procedure TdxfmGridReportLinkDesignWindow.PreviewAutoHeightClick
  (Sender: TObject);
begin
  if LockControlsUpdate then
    Exit;
...
begin
  ...
  with TcxGridCardView2OptionsView(PreviewCardView.OptionsView),
    ReportLink.OptionsCards do
  begin
    CardBorders := Borders;
    GridLines := dxPScxCommon.dxPSMakecxGridLines(RowBordersHorz,
      RowBordersVert);
  end;
  // UpdatePreview;
end;

procedure TdxfmGridReportLinkDesignWindow.chbxChartsTransparentClick
  (Sender: TObject);
begin
  with TcxCheckBox(Sender) do
...
procedure TdxfmGridReportLinkDesignWindow.colSpeedCountCustomDrawCell
  ...
  begin
    ...
    ATrackBarViewInfo := TcxCustomTrackBarViewInfo
      (AProperties.GetViewInfoClass.Create);
    try
      AViewData := TcxCustomTrackBarViewData
        (AProperties.CreateViewData(DefaultEditStyleController.Style, True));
      try
        AProperties.PrepareDisplayValue(AViewInfo.Value, ADisplayValue, False);
        ATrackBarViewInfo.Position := ADisplayValue;
        AViewData.Calculate(ACanvas, cxRectInflate(AViewInfo.Bounds, -2, -2),
          Point(0, 0), cxmbNone, [], ATrackBarViewInfo, False);
...
begin
  if ((Sender is TcxGridTableView) or (AViewInfo is TcxGridCardRowDataViewInfo))
  then
  begin
    ...
    begin
      ...
      CustomDrawTextRect(ACanvas, AViewInfo.Bounds, AViewInfo,
        AViewInfo.RecordViewInfo.BackgroundBitmap);
    end
    else
...
begin
  ...
  miStyleBackgroundBitmap.Enabled := AreNativeStylesAvailable and
    HasSelectedStyles;
  miStyleBackgroundBitmapClear.Enabled := AreNativeStylesAvailable and
    HasSelectedStylesWithAssignedBitmap;
  miStyleRestoreDefaults.Enabled := AreNativeStylesAvailable and
    HasSelectedStyles;
...
procedure TdxfmGridReportLinkDesignWindow.IsSUVModelCustomDrawCell
  ...
  procedure DrawBackground(const R: TRect);
    ...
    begin
      if AViewInfo is TcxGridCardRowDataViewInfo then
        PreviewCardView.Styles.GetContentParams(AViewInfo.GridRecord,
          AViewInfo.Item, Result)
      else
        PreviewBandedView.Styles.GetContentParams(AViewInfo.GridRecord,
          AViewInfo.Item, Result);
    end;
  ...
  var
    ...
    PrevColor: TColor;
  begin
    BackgroundBitmap := cxGetAsBitmap
      (CustomGridView_GetBackgroundBitmaps(AViewInfo.GridRecord.GridView)
      .GetBitmap(bbContent));
    try
      ...
      begin
        ...
        cxBkgndDrawPicture(BackgroundBitmap, ACanvas.Canvas, R, ppmTile, 1, 1,
          -R.Left, -R.Top);
    finally
  ...
  const
    CheckStateMap: array [Boolean] of TcxCheckBoxState = (cbsChecked,
      cbsUnchecked);
    StylesMap: array [Boolean] of TcxLookAndFeelStyle = (lfsStandard,
      lfsUltraFlat);
  var
    X, Y: Integer;
    CheckState: Variant;
  begin
    X := R.Left + (R.Right - R.Left - ScaleFactor.Apply
      (dxPSGlbl.CheckWidth)) div 2;
    Y := R.Top + (R.Bottom - R.Top - ScaleFactor.Apply
      (dxPSGlbl.CheckHeight)) div 2;
    R := Bounds(X, Y, ScaleFactor.Apply(dxPSGlbl.CheckWidth),
      ScaleFactor.Apply(dxPSGlbl.CheckHeight));

    CheckState :=
      Variant(CheckStateMap[AViewInfo.RecordViewInfo.GridRecord.
      RecordIndex = 2]);
    cxLookAndFeelPaintersManager.GetPainter
      (StylesMap[ReportLink.OptionsRefinements.FlatCheckMarks])
      .DrawScaledCheckButton(ACanvas, R, cxbsDefault,
      CheckState = Variant(cbsChecked), ScaleFactor);
  end;
...
begin
  if ReportLink.OptionsRefinements.DisplayGraphicsAsText and
    ((Sender is TcxGridTableView) or (AViewInfo is TcxGridCardRowDataViewInfo))
  then
  begin
...
procedure TdxfmGridReportLinkDesignWindow.
  PreviewBandedViewCustomDrawColumnHeader(Sender: TcxGridTableView;
  ACanvas: TcxCanvas; AViewInfo: TcxGridColumnHeaderViewInfo;
  var ADone: Boolean);
var
  R: TRect;
...
procedure TdxfmGridReportLinkDesignWindow.StyleBackgroundBitmapClick
  (Sender: TObject);
begin
  PerformStylesChangeBitmap;
end;

procedure TdxfmGridReportLinkDesignWindow.StyleBackgroundBitmapClearClick
  (Sender: TObject);
begin
  PerformStylesClearBitmap;
end;

procedure TdxfmGridReportLinkDesignWindow.StyleRestoreDefaultsClick
  (Sender: TObject);
begin
  PerformStylesRestoreDefaults;
end;

procedure TdxfmGridReportLinkDesignWindow.miStylesSelectAllClick
  (Sender: TObject);
begin
  lbxStyles.SelectAll;
  UpdateControlsState;
...
procedure TdxfmGridReportLinkDesignWindow.StyleSheetDeleteClick
  (Sender: TObject);
begin
  PerformStyleSheetDelete;
end;

procedure TdxfmGridReportLinkDesignWindow.StyleSheetRenameClick
  (Sender: TObject);
begin
...
begin
  PerformStyleSheetDrawItem(ACanvas.Canvas, AIndex, ARect, AState,
    AControl.Enabled);
end;
...
dxPSRegisterReportLink(TdxGridReportLink, TcxGrid,
  TdxfmGridReportLinkDesignWindow);

finalization

dxPSUnregisterReportLink(TdxGridReportLink, TcxGrid,
  TdxfmGridReportLinkDesignWindow);
