...
{$IFDEF DELPHI16}
  System.UITypes,
{$ENDIF}
  Types, Windows, Messages, Classes, Controls, Graphics, StdCtrls, ExtCtrls,
  ComCtrls,
  TabNotBk, Forms, ImgList, Menus, dxBase, dxPSCore, dxPSSngltn, dxPSShapes,
  dxPSForm,
  dxPSFillPatterns, dxPSStandardFillPatterns, Buttons, cxDrawTextUtils, cxPC,
  cxControls,
  cxContainer, cxEdit, cxCheckBox, cxListBox, cxLabel, cxLookAndFeelPainters,
  cxButtons,
  cxGraphics, cxTreeView, cxGroupBox, dxPSReportRenderCanvas, cxGeometry,
  cxLookAndFeels,
  cxScrollBox, dxPSReportLinkDesignWindow, dxLayoutControlAdapters,
...
type
  ...
  TdxPSCustomContainerItemDefinitionClass = class of
  ...
  public
    constructor Create(AReportLink: TdxCustomContainerReportLink;
      AComponent: TComponent; AReportItem: TdxReportVisualItem); virtual;
    destructor Destroy; override;

    function OptionsPagination: TdxCustomContainerReportLinkOptionsPagination;
      overload; virtual;

    property Component: TComponent read FComponent write FComponent;
    property OptionsPlace: TdxCustomContainerReportLinkOptionsItemPlace
      read FOptionsPlace;
    ...
    property SizeChangeReportItem: TdxReportVisualItem
      read GetSizeChangeReportItem;
    property SizeMeasureReportItem: TdxReportVisualItem
      read GetSizeMeasureReportItem;
  end;
  ...
  public
    constructor Create(AReportLink: TdxCustomContainerReportLink;
      AComponent: TComponent; AReportItem: TdxReportVisualItem); override;
    destructor Destroy; override;
  end;
  ...
  private
    ...
    function GetDefinition(Component: TComponent)
      : TdxPSCustomContainerItemDefinition;
  ...
  protected
    ...
    procedure InitializeOptionsPlace(AnOptions
      : TdxCustomContainerReportLinkOptionsItemPlace); virtual;
    ...
    function OptionsTransparent: TdxCustomContainerReportLinkOptionsTransparent;
      overload; virtual;

    property Canvas: TdxPSReportRenderCustomCanvas read GetCanvas;
    property Definitions[Component: TComponent]
      : TdxPSCustomContainerItemDefinition read GetDefinition;
    property IsDesigning: Boolean read GetIsDesigning;
    property Producers[Component: TComponent]: TdxPSCustomProducer
      read GetProducer;
    property ScrollPosLeft: Integer read GetScrollPosLeft;
    property ScrollPosTop: Integer read GetScrollPosTop;
  public
    constructor Create(AReportLink: TdxCustomContainerReportLink;
      AnObject: TComponent); virtual;
    ...
    class function DefinitionClass: TdxPSCustomContainerItemDefinitionClass;
  ...
  TdxPSCustomContainerItemProducerClass = class of
  ...
  public
    ...
    class function DefinitionClass
      : TdxPSCustomContainerItemDefinitionClass; override;
  ...
  TdxPSNativePrintableControlProducerClass = class of
  ...
  public
    ...
    function Definition: TdxPSNativePrintableControlDefinition;
  ...
  TdxPSWinControlAsMetafileProducer = class
  ...
  TdxPSContainerWinControlProducer = class
    (TdxPSContainerCustomWinControlProducer)
  protected
    procedure InitializeItem(AnItem: TdxReportVisualItem); override;
    function ItemClass: TdxReportVisualItemClass; override;
  ...
  protected
    procedure InitializeItem(AnItem: TdxReportVisualItem); override;
    procedure InitializeLookAndFeel(AnItem: TdxReportVisualItem;
  ...
  protected
    ...
    procedure InitializeItem(AnItem: TdxReportVisualItem); override;
    procedure InitializeRadioItem(AnItem: TdxCustomReportCellRadio;
  ...
  TdxPSPageControlProducer = class(TdxPSRootContainerProducer)
  ...
  protected
    function GetScrollBarPos(AScrollBar: TcxScrollBoxScrollBarOptions)
      : Integer; virtual;
    function GetScrollPosLeft: Integer; override;
    function GetScrollPosTop: Integer; override;
  ...
  protected
    ...
    function CreateItemDefinition(AComponent: TComponent;
    ...
    property Producers[AControl: TControl]: TdxPSCustomContainerItemProducer
      read GetProducer;
  public
    constructor Create(AReportLink: TdxCustomContainerReportLink;
      AContainer: TWinControl; AParentBuilder: TdxPSContainerBuilder;
      AParentHost: TdxReportCell = nil); virtual;
    destructor Destroy; override;

    function Build: TdxReportCell; virtual;
    function BuildControl(AControl: TControl; AParentHost: TdxReportCell = nil)
      : TdxReportVisualItem;
    function BuildNestedContainer(AContainer: TWinControl;
  ...
  private
    ...
    function GetProducer(ProducerClass: TdxPSCustomProducerClass;
      Component: TComponent): TdxPSCustomProducer;
  protected
    property Items[Index: Integer]: TdxPSCustomProducer read GetItem;
  public
    property Producers[ProducerClass: TdxPSCustomProducerClass;
      Component: TComponent]: TdxPSCustomProducer read GetProducer; default;
  end;

  { TdxCustomContainerReportLinkOptions }

  TdxCustomContainerReportLinkOptionsClass = class of
    TdxCustomContainerReportLinkOptions;
  ...
  TdxCustomContainerReportLinkOptionsBehaviorClass = class of
    TdxCustomContainerReportLinkOptionsBehavior;

  TdxCustomContainerReportLinkOptionsBehavior = class
    (TdxCustomContainerReportLinkOptions)
  private
  ...
  published
    property ConsumeExistingLinks: Boolean read FConsumeExistingLinks
      write SetConsumeExistingLinks default True;
    // obsolete - Aggregated Links always consumed
    property LabelAutoHeight: Boolean read FLabelAutoHeight
      write SetLabelAutoHeight default True;
  end;

  { TdxCustomContainerReportLinkOptionsDesignerTabs }

  TdxCustomContainerReportLinkOptionsDesignerTabsClass = class of
    TdxCustomContainerReportLinkOptionsDesignerTabs;
  ...
  public
    ...
    procedure RestoreDefaults; override;
  published
    property AutoHideReportLinksIfEmpty: Boolean
      read FAutoHideReportLinksIfEmpty write FAutoHideReportLinksIfEmpty
      default True;
    ...
    property ReportLinks: Boolean read FReportLinks write FReportLinks
      default True;
  end;
  ...
  public
    ...
    procedure UnsetAll;
  published
    property ExpandHeight: Boolean read FExpandHeight write FExpandHeight
      default False;
    property ExpandWidth: Boolean read FExpandWidth write FExpandWidth
      default False;
    property ShrinkHeight: Boolean read FShrinkHeight write FShrinkHeight
      default False;
    property ShrinkWidth: Boolean read FShrinkWidth write FShrinkWidth
      default False;
  end;
  ...
  public
    ...
    procedure RestoreDefaults; override;
  published
    property ControlDetails: Boolean read FControlDetails
      write SetControlDetails default True;
    property Controls: Boolean read FControls write SetControls default True;
  end;

  TdxCustomContainerReportLinkOptionsRefinementsClass = class of
    TdxCustomContainerReportLinkOptionsRefinements;

  TdxCustomContainerReportLinkOptionsRefinements = class
    (TdxCustomContainerReportLinkOptions)
  private
  ...
  public
    ...
    procedure RestoreDefaults; override;
  published
    property RootBorders: Boolean read FRootBorders write SetRootBorders
      default False;
  end;
  ...
  public
    ...
    procedure RestoreDefaults; override;
  published
    property Containers: Boolean read FContainers write SetContainters
      default True;
    property Controls: Boolean read FControls write SetControls default True;
  ...
  TdxContainerReportLinkCustomDrawItemEvent = procedure
    (Sender: TdxCustomContainerReportLink; ACanvas: TCanvas;
    AnItem: TAbstractdxReportCellData; AComponent: TComponent;
    var ADone: Boolean) of object;

  TdxContainerReportLinkGetComponentReportLinkEvent = procedure
    (Sender: TdxCustomContainerReportLink; AComponent: TComponent;
    var AReportLink: TBasedxReportLink) of object;

  TdxContainerReportLinkGetComponentCaptionEvent = procedure
    (Sender: TdxCustomContainerReportLink; AComponent: TComponent;
    var ACaption: string) of object;

  TdxContainerReportLinkInitializeItemEvent = procedure
    (Sender: TdxCustomContainerReportLink; AnItem: TdxReportVisualItem;
    AComponent: TComponent) of object;

  TdxContainerReportLinkInitializeItemOptionsPlaceEvent = procedure
    (Sender: TdxCustomContainerReportLink; AnItem: TdxReportVisualItem;
    AComponent: TComponent;
    AOptionsPlace: TdxCustomContainerReportLinkOptionsItemPlace) of object;

  TdxContainerReportLinkInitializeReportLinkEvent = procedure
    (Sender: TdxCustomContainerReportLink; AReportLink: TBasedxReportLink;
    AStage: TdxPSReportLinkProcessingStage) of object;

  TdxContainerReportLinkIsComponentProcessedEvent = procedure
    (Sender: TdxCustomContainerReportLink; AComponent: TComponent;
  ...
  strict private
    ...
    FOnGetComponentReportLink
      : TdxContainerReportLinkGetComponentReportLinkEvent;
    FOnInitializeItem: TdxContainerReportLinkInitializeItemEvent;
    FOnInitializeItemOptionsPlace
      : TdxContainerReportLinkInitializeItemOptionsPlaceEvent;
    ...
    function GetDefinitionByContainerItem(Component: TComponent)
      : TdxPSCustomContainerItemDefinition;
    function GetDefinitionByReportItem(Item: TdxReportVisualItem)
      : TdxPSCustomContainerItemDefinition;
    ...
    function GetProducerByClass(ProducerClass: TdxPSCustomProducerClass;
      Component: TComponent): TdxPSCustomProducer;
    ...
    procedure SetOnCustomDrawItem
      (Value: TdxContainerReportLinkCustomDrawItemEvent);
    procedure SetOptionsBehavior
      (Value: TdxCustomContainerReportLinkOptionsBehavior);
    procedure SetOptionsDesignerTabs
      (Value: TdxCustomContainerReportLinkOptionsDesignerTabs);
    procedure SetOptionsPagination
      (Value: TdxCustomContainerReportLinkOptionsPagination);
    procedure SetOptionsRefinements
      (Value: TdxCustomContainerReportLinkOptionsRefinements);
    procedure SetOptionsTransparent
      (Value: TdxCustomContainerReportLinkOptionsTransparent);
  ...
  protected
    ...
    function BuildContainer(AContainer: TWinControl;
      AParentBuilder: TdxPSContainerBuilder; AParentHost: TdxReportCell = nil)
      : TdxReportCell;
    function CreateBuilder(AContainer: TWinControl;
      AParentBuilder: TdxPSContainerBuilder; AParentHost: TdxReportCell = nil)
    ...
    procedure DoGetComponentCaption(AComponent: TComponent;
      var ACaption: string); dynamic;
    function DoGetReportLink(AComponent: TComponent)
      : TBasedxReportLink; dynamic;
    procedure DoInitializeItem(AnItem: TdxReportVisualItem); dynamic;
    procedure DoInitializeItemOptionsPlace
      (AnItem: TdxReportVisualItem); dynamic;
    procedure DoInitializeReportLink(AReportLink: TBasedxReportLink;
      AStage: TdxPSReportLinkProcessingStage); dynamic;
    ...
    function GetOptionsBehaviorClass
      : TdxCustomContainerReportLinkOptionsBehaviorClass; dynamic;
    function GetOptionsDesignerTabsClass
      : TdxCustomContainerReportLinkOptionsDesignerTabsClass; dynamic;
    function GetOptionsItemPlaceClass
      : TdxCustomContainerReportLinkOptionsItemPlaceClass; dynamic;
    function GetOptionsPaginationClass
      : TdxCustomContainerReportLinkOptionsPaginationClass; dynamic;
    function GetOptionsRefinementsClass
      : TdxCustomContainerReportLinkOptionsRefinementsClass; dynamic;
    function GetOptionsTransparentClass
      : TdxCustomContainerReportLinkOptionsTransparentClass; dynamic;
    procedure OptionsModified(AnOptions
      : TdxCustomContainerReportLinkOptions); dynamic;
    ...
    function FindDefinition(AComponent: TComponent; out AnIndex: Integer)
      : Boolean; overload;
    function FindDefinition(AnItem: TdxReportVisualItem; out AnIndex: Integer)
      : Boolean; overload;
    procedure FreeAndNilDefinitions;

    procedure AddControl(ATreeView: TTreeView; AParent: TTreeNode;
      AControl: TControl);
    procedure AddHiddenControl(ATreeView: TTreeView; AParent: TTreeNode;
      AControl: TControl);
    function AddNode(ATreeView: TTreeView; AParent: TTreeNode;
      AComponent: TComponent; AChecked: Boolean): TTreeNode;
    function CreateNodeObject(AComponent: TComponent; AChecked: Boolean)
      : TdxNodeObject; virtual;
    ...
    function GetPreparedFontIndex(AFont: TFont; AIsFontSubstitutable: Boolean;
      const AFontName: string; AFontColor: TColor; AFontStyle: TFontStyles;
      AFontOrientation: Integer): Integer; overload;
    ...
    procedure HideDesignerTabs(ADesignWindow
      : TdxfmCustomContainerDesignWindow); virtual;
    ...
    property Controller: TdxCustomContainerReportLink read GetController
      write SetController;
    property DefinitionCount: Integer read GetDefinitionCount;
    property Definitions[Index: Integer]: TdxPSCustomContainerItemDefinition
      read GetDefinition;
    property DefinitionsByContainerItem[Component: TComponent]
      : TdxPSCustomContainerItemDefinition read GetDefinitionByContainerItem;
    property DefinitionsByReportItem[Item: TdxReportVisualItem]
      : TdxPSCustomContainerItemDefinition read GetDefinitionByReportItem;
    property DelimitersHorz: TList read FDelimitersHorz;
    property DelimitersHorzCount: Integer read GetDelimitersHorzCount;
    property DelimitersHorzItems[Index: Integer]: Integer
      read GetDelimitersHorzItem;
    property DelimitersVert: TList read FDelimitersVert;
    property DelimitersVertCount: Integer read GetDelimitersVertCount;
    property DelimitersVertItems[Index: Integer]: Integer
      read GetDelimitersVertItem;
  ...
  public
    ...
    function FindHiddenComponent(AComponent: TComponent; out AnIndex: Integer)
      : Boolean; overload;
    function FindHiddenComponent(AComponent: TComponent): Boolean; overload;
    function FindHiddenComponentByName(const AName: string;
    ...
    function FindExcludedComponent(AComponent: TComponent; out AnIndex: Integer)
      : Boolean; overload;
    function FindExcludedComponent(AComponent: TComponent): Boolean; overload;
    function FindExcludedComponentByName(const AName: string;
      out AnIndex: Integer): Boolean; overload;
    function FindExcludedComponentByName(const AName: string): Boolean;
      overload;
    ...
    function FindAggregatedLinkByComponent(AComponent: TComponent)
      : TBasedxReportLink;
    ...
    function IsLinkAggregatedConsistently(AReportLink: TBasedxReportLink)
      : Boolean;

    property AggregatedReportLinkCount: Integer
      read GetAggregatedReportLinkCount;
    property AggregatedReportLinks[Index: Integer]: TBasedxReportLink
      read GetAggregatedReportLink;
    property Container: TWinControl read GetContainer;
    property DesignWindow: TdxfmCustomContainerDesignWindow
      read GetDesignWindow;
    property ExcludedComponentCount: Integer read GetExcludedComponentCount;
    property ExcludedComponents[Index: Integer]: TComponent
      read GetExcludedComponent;
    property HiddenComponentCount: Integer read GetHiddenComponentCount;
    property HiddenComponents[Index: Integer]: TComponent
      read GetHiddenComponent;
    property ProducersByClass[ProducerClass: TdxPSCustomProducerClass;
      Component: TComponent]: TdxPSCustomProducer read GetProducerByClass;
    property TopLevelContainer: TWinControl read GetTopLevelContainer;
  published
    property Color;
    property Font;
    property OptionsBehavior: TdxCustomContainerReportLinkOptionsBehavior
      read FOptionsBehavior write SetOptionsBehavior;
    property OptionsDesignerTabs
      : TdxCustomContainerReportLinkOptionsDesignerTabs
      read FOptionsDesignerTabs write SetOptionsDesignerTabs;
    ...
    property OptionsPagination: TdxCustomContainerReportLinkOptionsPagination
      read FOptionsPagination write SetOptionsPagination;
    property OptionsRefinements: TdxCustomContainerReportLinkOptionsRefinements
      read FOptionsRefinements write SetOptionsRefinements;
    property OptionsTransparent: TdxCustomContainerReportLinkOptionsTransparent
      read FOptionsTransparent write SetOptionsTransparent;
    property ScaleFonts;
    property SupportedCustomDraw: Boolean read FSupportedCustomDraw
      write SetSupportedCustomDraw default False;

    property OnCustomDrawItem: TdxContainerReportLinkCustomDrawItemEvent
      read FOnCustomDrawItem write SetOnCustomDrawItem;
    property OnGetComponentCaption
      : TdxContainerReportLinkGetComponentCaptionEvent
      read FOnGetComponentCaption write FOnGetComponentCaption;
    property OnGetComponentReportLink
      : TdxContainerReportLinkGetComponentReportLinkEvent
      read FOnGetComponentReportLink write FOnGetComponentReportLink;
    property OnInitializeItem: TdxContainerReportLinkInitializeItemEvent
      read FOnInitializeItem write FOnInitializeItem;
    property OnInitializeItemOptionsPlace
      : TdxContainerReportLinkInitializeItemOptionsPlaceEvent
      read FOnInitializeItemOptionsPlace write FOnInitializeItemOptionsPlace;
    property OnInitializeReportLink
      : TdxContainerReportLinkInitializeReportLinkEvent
      read FOnInitializeReportLink write FOnInitializeReportLink;
    property OnIsComponentProcessed
      : TdxContainerReportLinkIsComponentProcessedEvent
      read FOnIsComponentProcessed write FOnIsComponentProcessed;
  end;
  ...
  TdxfmCustomContainerDesignWindow = class(TStandarddxReportLinkDesignWindow)
    ...
    procedure lbxAggregatedLinksDragDrop(Sender, Source: TObject;
      X, Y: Integer);
    procedure lbxAggregatedLinksDragOver(Sender, Source: TObject; X, Y: Integer;
    ...
    procedure lbxAvailableLinksDragOver(Sender, Source: TObject; X, Y: Integer;
      State: TDragState; var Accept: Boolean);
  ...
  protected
    ...
    procedure SetOptionsGroupsByIndex(AnIndex: Integer;
      AValue: Boolean); virtual;
    procedure SetOptionsPaginationByIndex(AnIndex: Integer;
      AValue: Boolean); virtual;
    ...
    procedure SetOptionsTransparentByIndex(AnIndex: Integer;
      AValue: Boolean); virtual;
    ...
    function TreeView_getRoot(ATreeView: TTreeView): TTreeNode;
    // API function TreeView_GetRoot already exists
    ...
    property AggregatedLinks[Index: Integer]: TBasedxReportLink
      read GetAggregatedLink;
    property AggregatedLinkSelected[Index: Integer]: Boolean
      read GetAggregatedLinkSelected;
    property AvailableLinkCount: Integer read GetAvailableLinkCount;
    property AvailableLinks[Index: Integer]: TBasedxReportLink
      read GetAvailableLink;
    property AvailableLinkSelected[Index: Integer]: Boolean
...
function dxPSIsComponentContainer(AComponent: TObject { TComponent } )
  : Boolean; overload;
procedure dxPSRegisterContainer(AContainerClass: TWinControlClass;
  ADesignerClass: TdxReportLinkDesignWindowClass =
  nil { TdxfmCustomContainerDesignWindow } );
procedure dxPSRegisterContainers(const AContainerClasses
  : array of TWinControlClass;
  ADesignerClass: TdxReportLinkDesignWindowClass =
  nil { TdxfmCustomContainerDesignWindow } );
procedure dxPSUnregisterContainer(AContainerClass: TWinControlClass;
  ADesignerClass: TdxReportLinkDesignWindowClass =
  nil { TdxfmCustomContainerDesignWindow } );
procedure dxPSUnregisterContainers(const AContainerClasses
  : array of TWinControlClass;
  ADesignerClass: TdxReportLinkDesignWindowClass =
  nil { TdxfmCustomContainerDesignWindow } );
...
const
  BevelShapeMap: array [TBevelShape] of TdxCellSides = (csAll, csAll, [csTop],
    [csBottom], [csLeft], [csRight], []);
  BevelStyleMap: array [TBevelStyle, TBevelShape] of TdxPSCellBorderClass =
    ((TdxPSCellSunkenSoftBorder, TdxPSCellEtchedBorder,
    TdxPSCellRaisedSoftBorder, TdxPSCellRaisedSoftBorder,
    TdxPSCellRaisedSoftBorder, TdxPSCellRaisedSoftBorder, TdxPSCellNullBorder),
    (TdxPSCellRaisedSoftBorder, TdxPSCellBumpedBorder, TdxPSCellRaisedBorder,
    TdxPSCellRaisedBorder, TdxPSCellRaisedBorder, TdxPSCellRaisedBorder,
    TdxPSCellNullBorder));
  BorderStyleMap: array [TBorderStyle] of TdxCellSides = ([], csAll);
  BrushStyleMap: array [TBrushStyle] of TdxPSFillPatternClass =
    (TdxPSSolidFillPattern, TdxPSSolidFillPattern, TdxPSHorizontalFillPattern,
    TdxPSVerticalFillPattern, TdxPSFDiagonalFillPattern,
    TdxPSBDiagonalFillPattern, TdxPSCrossFillPattern,
    TdxPSDiagCrossFillPattern);
  CheckAlignmentMap: array [TLeftRight] of TdxCellCheckPos = (ccpRight,
    ccpLeft);
  Ctl3DBorderClassMap: array [Boolean] of TdxPSCellBorderClass =
    (TdxPSCellUltraFlatBorder, TdxPSCellSunkenBorder);
  PanelBevelsMap: array [TPanelBevel, TPanelBevel] of TdxPSCellBorderClass =
    ((TdxPSCellNullBorder, TdxPSCellSunkenSoftBorder, TdxPSCellRaisedSoftBorder,
    TdxPSCellRaisedSoftBorder), (TdxPSCellSunkenSoftBorder,
    TdxPSCellSunkenBorder, TdxPSCellBumpedBorder, TdxPSCellBumpedBorder),
    (TdxPSCellRaisedSoftBorder, TdxPSCellEtchedBorder, TdxPSCellRaisedBorder,
    TdxPSCellRaisedBorder), (TdxPSCellRaisedSoftBorder, TdxPSCellEtchedBorder,
    TdxPSCellRaisedBorder, TdxPSCellRaisedBorder));
  PanelSingleBorderMap: array [Boolean] of TdxPSCellBorderClass =
    (TdxPSCellRaisedBorder, TdxPSCellEtchedBorder);
  ...
  StandardHiddenControls: array [0 .. StandardHiddenControlCount - 1]
    of string = ('TScrollBar', 'TSplitter', 'TControlBar', 'TToolBar',
...
const
  ...
  StandardContainers: array [0 .. StandardContainerCount - 1]
    of TWinControlClass = (TPanel, TScrollBox, TTabControl, TTabSheet,
    TPageControl, TTabPage, TTabbedNotebook, TPage, TNotebook, TCustomForm,
    TCustomFrame, TcxGroupBox, TcxScrollBox);
...
type
  ...
  private
    function GetProducerClass(Component: TComponent)
      : TdxPSNativePrintableControlProducerClass;
  public
    class function Instance: TdxPSNativePrintableControlProducerFactory;
      reintroduce; overload;
    class procedure ReleaseInstance; override;
    property ProducerClasses[Component: TComponent]
      : TdxPSNativePrintableControlProducerClass read GetProducerClass; default;
  end;

  TdxPSContainerItemProducerFactory = class(TdxCustomClassMaps)
  private
    function GetProducerClass(Component: TComponent; IsRoot: Boolean)
      : TdxPSCustomProducerClass;
  public
    class function Instance: TdxPSContainerItemProducerFactory;
      reintroduce; overload;
    class procedure ReleaseInstance; override;
    property ProducerClasses[Component: TComponent; IsRoot: Boolean]
      : TdxPSCustomProducerClass read GetProducerClass; default;
  end;

  TdxPSProducerHelperFactory = class(TdxCustomClassMaps)
  private
    function GetItem(Index: Integer): TdxPSCustomProducerClass;
    function GetProducerClass(ProducerClass: TdxPSCustomProducerClass)
      : TdxPSCustomProducerClass;
  public
    ...
    property ProducerClasses[ProducerClass: TdxPSCustomProducerClass]
      : TdxPSCustomProducerClass read GetProducerClass; default;
  end;
  ...
  protected
    function CreateBuilder(AReportLink: TdxCustomContainerReportLink;
      AContainer: TWinControl; AParentBuilder: TdxPSContainerBuilder;
      AParentHost: TdxReportCell = nil): TdxPSContainerBuilder;
  public
    class function Instance: TdxPSContainerBuilderFactory; reintroduce;
      overload;
    class procedure ReleaseInstance; override;
    property BuilderClasses[Control: TWinControl]: TdxPSContainerBuilderClass
      read GetBuilderClass; default;
  end;
...
begin
  ...
  dxPSRegisterReportLink(TdxCustomContainerReportLink, AContainerClass,
    ADesignerClass);
end;
...
begin
  if ADesignerClass = nil then
    ADesignerClass := TdxfmCustomContainerDesignWindow;
  dxPSUnregisterReportLink(TdxCustomContainerReportLink, AContainerClass,
    ADesignerClass);
end;
...
begin
  ...
  else if AControl.ItemIndex <> -1 then
...
function StaticText_GetBorderStyle(AControl: TCustomStaticText)
  : TStaticBorderStyle;
begin
...
class function TdxPSNativePrintableControlProducerFactory.Instance
  : TdxPSNativePrintableControlProducerFactory;
begin
...
begin
  Result := TdxPSNativePrintableControlProducerClass
    (PairClasses[Component.ClassType]);
end;
...
class function TdxPSContainerItemProducerFactory.Instance
...
function TdxPSContainerItemProducerFactory.GetProducerClass
  (Component: TComponent; IsRoot: Boolean): TdxPSCustomProducerClass;
begin
  if not IsRoot then
    Result := dxPSNativePrintableControlProducerFactory.ProducerClasses
      [Component]
  else
    Result := nil;

  if (Result = nil) or not TdxPSNativePrintableControlProducerClass(Result)
    .HasReportLink(Component) then
  begin
...
function TdxPSProducerHelperFactory.GetItem(Index: Integer)
  : TdxPSCustomProducerClass;
begin
  Result := TdxPSCustomProducerClass(inherited Items[Index]);
end;

function TdxPSProducerHelperFactory.GetProducerClass(ProducerClass
  : TdxPSCustomProducerClass): TdxPSCustomProducerClass;
var
  I: Integer;
begin
  ...
  begin
    Result := Items[I];
    if ProducerClass = Result.BuddyClass then
      Exit;
  end;
  Result := nil;
end;
...
class function TdxPSContainerBuilderFactory.Instance
  : TdxPSContainerBuilderFactory;
begin
...
function TdxPSContainerBuilderFactory.CreateBuilder
  (AReportLink: TdxCustomContainerReportLink; AContainer: TWinControl;
  AParentBuilder: TdxPSContainerBuilder; AParentHost: TdxReportCell = nil)
  : TdxPSContainerBuilder;
begin
  Result := BuilderClasses[AContainer].Create(AReportLink, AContainer,
    AParentBuilder, AParentHost);
end;

function TdxPSContainerBuilderFactory.GetBuilderClass(Control: TWinControl)
  : TdxPSContainerBuilderClass;
begin
...
function TdxReportWinControlHost.MeasureHeight
...
function TdxReportWinControlHost.MeasureWidth
  (ACanvas: TdxPSReportRenderCustomCanvas): Integer;
  ...
  begin
    ...
    begin
      Item := Cells[I];
      if Item <> ControlItem then
        MeasureItem(Item, Result);
    end;
  end;
...
begin
  if (DataItemCount <> 0) and (DataItems[0].Data <> 0) then
    Result := DataItems[0]
  else if (CellCount <> 0) and (Cells[0].Data <> 0) then
    Result := Cells[0]
  else
    Result := nil;
end;
...
function TdxReportNativePrintableControlHost.GetControlItem
  : TdxReportVisualItem;
begin
  if CellCount <> 0 then
    Result := Cells[0]
...
constructor TdxPSCustomContainerItemDefinition.Create
  (AReportLink: TdxCustomContainerReportLink; AComponent: TComponent;
...
function TdxPSCustomContainerItemDefinition.OptionsPagination
  : TdxCustomContainerReportLinkOptionsPagination;
begin
...
procedure TdxPSCustomContainerItemDefinition.AddReportItemToDelimitersHorz
  (AList: TList);
begin
  with ReportItem do
  begin
...
procedure TdxPSCustomContainerItemDefinition.AddReportItemToDelimitersVert
  (AList: TList);
begin
  with ReportItem do
  begin
...
function TdxPSCustomContainerItemDefinition.GetSizeChangeReportItem
  : TdxReportVisualItem;
begin
  Result := ReportItem;
end;

function TdxPSCustomContainerItemDefinition.GetSizeMeasureReportItem
  : TdxReportVisualItem;
begin
  Result := ReportItem;
end;
...
function TdxPSCustomContainerItemDefinition.GetTopLevelRootContainer
  : TWinControl;
begin
...
begin
  if OptionsPagination.Controls then
...
constructor TdxPSNativePrintableControlDefinition.Create
  (AReportLink: TdxCustomContainerReportLink; AComponent: TComponent;
  AReportItem: TdxReportVisualItem);
begin
  inherited;
...
procedure TdxPSNativePrintableControlDefinition.GetData
...
function TdxPSNativePrintableControlDefinition.GetSizeChangeReportItem
  : TdxReportVisualItem;
begin
...
function TdxPSContainerWinControlDefinition.GetSizeChangeReportItem
  : TdxReportVisualItem;
begin
  Result := ReportItem.Parent;
end;
...
constructor TdxPSCustomProducer.Create(AReportLink
  : TdxCustomContainerReportLink; AnObject: TComponent);
begin
  inherited Create;
  FReportLink := AReportLink;
  Initialize(AnObject);
...
class function TdxPSCustomProducer.DefinitionClass
  : TdxPSCustomContainerItemDefinitionClass;
begin
...
procedure TdxPSCustomProducer.InitializeOptionsPlace
  (AnOptions: TdxCustomContainerReportLinkOptionsItemPlace);
begin
  with AnOptions do
  begin
...
begin
  ...
  begin
    ...
    begin
      ...
      if OptionsPlace.ExpandHeight and (SizeChangeReportItem.Height < ItemHeight)
      then
        SizeChangeReportItem.Height := ItemHeight;
      if OptionsPlace.ShrinkHeight and
        (SizeChangeReportItem.Height > ItemHeight) and (ItemHeight <> 0) then
        SizeChangeReportItem.Height := ItemHeight;
    end;
    ...
    begin
      ...
      if OptionsPlace.ExpandWidth and (SizeChangeReportItem.Width < ItemWidth)
      then
        SizeChangeReportItem.Width := ItemWidth;
      if OptionsPlace.ShrinkWidth and (SizeChangeReportItem.Width > ItemWidth)
      then
        SizeChangeReportItem.Width := ItemWidth;
    end;
  end;
...
function TdxPSCustomProducer.MeasureItemHeight
  (AItem: TdxReportVisualItem): Integer;
begin
  Result := AItem.MeasureHeight(Canvas);
end;

function TdxPSCustomProducer.MeasureItemWidth
  (AItem: TdxReportVisualItem): Integer;
begin
...
function TdxPSCustomProducer.OptionsTransparent
  : TdxCustomContainerReportLinkOptionsTransparent;
begin
...
function TdxPSCustomProducer.GetDefinition(Component: TComponent)
  : TdxPSCustomContainerItemDefinition;
begin
...
function TdxPSCustomProducer.GetProducer(Component: TComponent)
  : TdxPSCustomProducer;
begin
...
function TdxPSCustomContainerItemProducer.Definition
  : TdxPSContainerControlDefinition;
begin
  Result := inherited Definition as TdxPSContainerControlDefinition;
end;

class function TdxPSCustomContainerItemProducer.DefinitionClass
  : TdxPSCustomContainerItemDefinitionClass;
begin
...
function TdxPSCustomContainerItemProducer.CanProcessChild
  (AChildControl: TControl): Boolean;
begin
  Result := ((csAcceptsControls in Control_GetControlStyle(Control)) and
    ((AChildControl.Owner <> Control)) or (Control is TCustomForm) or
    (Control is TCustomFrame));
end;

function TdxPSCustomContainerItemProducer.CreateIterator
  : IdxPSContainerIterator;
begin
  Result := nil;
end;
...
begin
  Result := ReportLink.GetPreparedFontIndex(Font, IsFontSubstitutable, FontName,
    FontColor, FontStyle, FontOrientation);
end;
...
procedure TdxPSCustomContainerItemProducer.InitializeItem
...
procedure TdxPSCustomDelegateProducer.InitializeItem
  (AnItem: TdxReportVisualItem);
begin
...
function TdxPSNativePrintableControlProducer.Definition
  : TdxPSNativePrintableControlDefinition;
begin
  Result := inherited Definition as TdxPSNativePrintableControlDefinition;
end;

class function TdxPSNativePrintableControlProducer.DefinitionClass
  : TdxPSCustomContainerItemDefinitionClass;
begin
  Result := TdxPSNativePrintableControlDefinition;
end;

class function TdxPSNativePrintableControlProducer.
  HasNativeSupportForBorders: Boolean;
begin
  Result := True;
end;
...
procedure TdxPSNativePrintableControlProducer.AdjustItemBounds
  (AnItem: TdxReportVisualItem);
var
  R: TRect;
begin
  ...
  begin
    R := BoundsRect;
    InflateRect(R, AnItem.BorderClass.Thickness - 1,
      AnItem.BorderClass.Thickness - 1);
    if ShowShadow then
    begin
...
begin
  ...
  try
    ...
    begin
      ...
      APoint := TopLevelRootContainer.ScreenToClient
...
procedure TdxPSNativePrintableControlProducer.DeinitializeReportLink
  (AControlReportLink: TBasedxReportLink);
begin
...
class function TdxPSNativePrintableControlProducer.GetLinkClass(AClass: TClass)
  : TdxReportLinkClass;
begin
  Result := dxPSLinkClassByCompClass(TComponentClass(AClass));
end;

procedure TdxPSNativePrintableControlProducer.InitializeReportLink
  (AControlReportLink: TBasedxReportLink);
begin
  with TBasedxReportLinkAccess(AControlReportLink) do
  begin
...
class function TdxPSNativePrintableControlProducer.HasReportLink
...
procedure TdxPSNativePrintableControlProducer.InitializeHost
  (ACell: TdxReportCell);
begin
  inherited;
...
procedure TdxPSNativePrintableControlProducer.InitializeItem
  (AnItem: TdxReportVisualItem);
begin
  inherited;
...
procedure TdxPSNativePrintableControlProducer.
  InitializeNativePrintableControlHost(AnItem: TdxReportVisualItem);
begin
...
function TdxPSNativePrintableControlProducer.ItemClass
  : TdxReportVisualItemClass;
begin
  Result := TdxReportCell;
end;

function TdxPSNativePrintableControlProducer.MeasureItemHeight
  (AnItem: TdxReportVisualItem): Integer;
begin
  Result := Definition.ReportDimension.Y;
end;

function TdxPSNativePrintableControlProducer.MeasureItemWidth
  (AnItem: TdxReportVisualItem): Integer;
begin
...
procedure TdxPSContainerControlProducer.InitializeItem
  (AnItem: TdxReportVisualItem);
begin
  inherited;
...
class function TdxPSControlAsMetafileProducer.BuddyClass
  : TdxPSCustomProducerClass;
begin
  Result := TdxPSContainerControlProducer;
end;

function TdxPSControlAsMetafileProducer.CreateControlImage
...
procedure TdxPSControlAsMetafileProducer.InitializeItem
  (AItem: TdxReportVisualItem);
begin
...
class function TdxPSContainerCustomWinControlProducer.ControlClass
  : TControlClass;
begin
  Result := TWinControl;
end;

function TdxPSContainerCustomWinControlProducer.CreateIterator
  : IdxPSContainerIterator;
begin
  IteratorClass.Create(Control).GetInterface(IdxPSContainerIterator, Result);
end;

class function TdxPSContainerCustomWinControlProducer.DefinitionClass
  : TdxPSCustomContainerItemDefinitionClass;
begin
...
procedure TdxPSContainerCustomWinControlProducer.InitializeItem
  (AnItem: TdxReportVisualItem);
begin
  inherited;
  AnItem.Left := 0;
...
class function TdxPSContainerCustomWinControlProducer.IteratorClass
...
class function TdxPSWinControlAsMetafileProducer.BuddyClass
  : TdxPSCustomProducerClass;
begin
...
procedure TdxPSWinControlAsMetafileProducer.InitializeItem
  (AItem: TdxReportVisualItem);
begin
  inherited;
  TdxReportCellGraphic(AItem).CellSides := [];
...
procedure TdxPSContainerWinControlProducer.InitializeItem
  (AnItem: TdxReportVisualItem);
begin
  inherited;
...
procedure TdxPSDateTimePickerProducer.InitializeItem
  (AnItem: TdxReportVisualItem);
begin
  inherited;
...
const
  ItemClasses: array [Boolean] of TdxReportVisualItemClass =
...
begin
  ...
  TdxReportCellString(AnItem).Text :=
    Menus.ShortCutToText(HotKey_GetHotKey(Control));
end;
...
procedure TdxPSCustomStaticTextProducer.InitializeItem
  (AnItem: TdxReportVisualItem);
const
...
begin
  inherited;
  TdxReportCellString(AnItem).BorderClass := BorderClassMap
    [StaticText_GetBorderStyle(Control)];
  TdxReportCellString(AnItem).CellSides :=
    CellSidesMap[StaticText_GetBorderStyle(Control)];
  TdxReportCellString(AnItem).HidePrefix := True;
  TdxReportCellString(AnItem).TextAlignX := dxPSCore.dxTextAlignX
    [StaticText_GetAlignment(Control)];
end;
...
begin
  inherited;
  TdxReportCellString(AnItem).CellSides := BorderStyleMap
    [Edit_GetBorderStyle(Control)];
...
procedure TdxPSCustomComboBoxProducer.InitializeItem
  (AnItem: TdxReportVisualItem);
begin
  inherited;
  // TdxReportCellString(AnItem).BorderClass := Ctl3DBorderClassMap[ControlGetCtl3D(Control)];
...
procedure TdxPSCustomComboBoxExProducer.GetImageLists
...
procedure TdxPSCustomComboBoxExProducer.InitializeItem
  (AnItem: TdxReportVisualItem);
begin
  inherited;
  ...
  begin
    ...
    else if Control.ItemIndex <> -1 then
...
procedure TdxPSCustomCheckBoxProducer.InitializeItem
  (AnItem: TdxReportVisualItem);
var
...
class function TdxPSCustomContainerProducer.DefinitionClass
  : TdxPSCustomContainerItemDefinitionClass;
begin
  Result := TdxPSContainerDefinition;
end;

procedure TdxPSCustomContainerProducer.InitializeItem
  (AnItem: TdxReportVisualItem);
const
...
begin
  ...
  begin
    AnItem.CellSides := CellsSidesMap
      [ReportLink.OptionsRefinements.RootBorders];
...
begin
  ...
  begin
    ...
    if (BevelInner = bvNone) and (BevelOuter = bvNone) then
      ...
      TdxReportCellString(AnItem).BorderClass :=
        PanelBevelsMap[BevelInner, BevelOuter];
  end
  else
    TdxReportCellString(AnItem).BorderClass := PanelSingleBorderMap
      [Control_GetCtl3D(Control)];

  TdxReportCellString(AnItem).Text := Control_GetText(Control);
  TdxReportCellString(AnItem).TextAlignX := dxPSCore.dxTextAlignX
    [Panel_GetAlignment(Control)];
...
procedure TdxPSCustomGroupBoxProducer.InitializeItem
  (AnItem: TdxReportVisualItem);
const
  BorderClasses: array [Boolean] of TdxPSCellBorderClass =
    (TdxPSCellUltraFlatBorder, TdxPSCellEtchedBorder);
begin
  inherited;
...
procedure TdxPSCustomGroupBoxProducer.InitializeLookAndFeel
  (AnItem: TdxReportVisualItem; ALookAndFeel: TdxPSReportGroupLookAndFeel);
begin
...
class function TdxPSCustomGroupBoxProducer.LookAndFeelClass
...
function TdxPSCustomRadioGroupProducer.CanProcessChild(AChildControl
  : TControl): Boolean;
begin
  Result := not AChildControl.ClassNameIs('TGroupButton');
  // RadioGroup's buttons are processed inside
end;

procedure TdxPSCustomRadioGroupProducer.CreateItems(AReportRadioGroup
  : TdxReportRadioGroup);
var
  Items: TStrings;
  I: Integer;
...
procedure TdxPSCustomRadioGroupProducer.InitializeItem
  (AnItem: TdxReportVisualItem);
begin
  inherited;
...
procedure TdxPSCustomRadioGroupProducer.InitializeRadioItem
  (AnItem: TdxCustomReportCellRadio; AnIndex: Integer);
begin
...
procedure TdxPSRootContainerProducer.InitializeItem
  (AnItem: TdxReportVisualItem);
begin
  inherited;
  AnItem.Left := 0;
...
function TdxPSPageControlProducer.CanProcessChild(AChildControl
  : TControl): Boolean;
begin
  Result := AChildControl = Control.ActivePage;
end;

class function TdxPSPageControlProducer.IteratorClass
  : TdxPSWinControlIteratorClass;
begin
...
function TdxPSNotebookProducer.CanProcessChild(AChildControl: TControl)
  : Boolean;
begin
  Result := AChildControl = Control.Pages.Objects[Control.PageIndex];
end;

class function TdxPSNotebookProducer.IteratorClass
  : TdxPSWinControlIteratorClass;
begin
...
function TdxPSTabbedNotebookProducer.CanProcessChild(AChildControl
  : TControl): Boolean;
begin
  Result := AChildControl = Control.Pages.Objects[Control.PageIndex];
end;

class function TdxPSTabbedNotebookProducer.IteratorClass
  : TdxPSWinControlIteratorClass;
begin
...
function TdxPSScrollingWinControlProducer.GetScrollBarPos
  (AScrollBar: TControlScrollBar): Integer;
begin
...
function TdxPScxScrollBoxProducer.GetScrollBarPos
  (AScrollBar: TcxScrollBoxScrollBarOptions): Integer;
begin
  if AScrollBar.Visible then
    Result := AScrollBar.Position
  else
...
constructor TdxPSContainerBuilder.Create(AReportLink
  : TdxCustomContainerReportLink; AContainer: TWinControl;
  AParentBuilder: TdxPSContainerBuilder; AParentHost: TdxReportCell = nil);
begin
  inherited Create;
  FReportLink := AReportLink;
...
function TdxPSContainerBuilder.BuildControl(AControl: TControl;
  AParentHost: TdxReportCell = nil): TdxReportVisualItem;
begin
...
begin
  if not FIsContainerBuilderFactoryReleased then
    dxContainerBuilderFactory.Unregister(Self);
end;
...
begin
  if HasAvailableChildren(Container) then
    ...
    begin
      ...
      begin
        Control := Prev;
        if not(Control is TWinControl) and ReportLink.DoIsComponentProcessed
          (Control) then
      ...
      begin
        Control := Next;
        if (Control is TWinControl) and ReportLink.DoIsComponentProcessed
          (Control) then
...
function TdxPSContainerBuilder.CreateNestedControlsIterator
  : IdxPSContainerIterator;
begin
...
function TdxPSContainerBuilder.HasAvailableChildren(AControl: TControl)
  : Boolean;
var
...
begin
  Result := False;
  if (AControl is TWinControl) and (TWinControl(AControl).ControlCount <> 0)
  then
  begin
    ...
    if Producer.CanHasAvailableChildren then
      with TWinControl(AControl) do
        ...
        begin
          Child := Controls[I];
          Result := Producer.CanProcessChild(Child) and
            ReportLink.DoIsComponentProcessed(Child);
          if Result then
            Exit;
        end;
  end;
...
function TdxPSContainerBuilder.GetProducer(AControl: TControl)
  : TdxPSCustomContainerItemProducer;
begin
...
constructor TdxPSContainerReportLinkCustomCache.Create
...
function TdxPSContainerReportLinkCustomCache.ReportLink
  : TdxCustomContainerReportLink;
begin
  Result := FReportLink;
end;
...
function TdxPSCustomProducerCache.GetProducer(ProducerClass
  : TdxPSCustomProducerClass; Component: TComponent): TdxPSCustomProducer;
var
  Index: Integer;
begin
  Index := IndexOfByClass(ProducerClass);
  if (Index = -1) or (not ProducerClass.Reenterable and
    (Items[Index].ProducingObject <> Component)) then
...
constructor TdxCustomContainerReportLinkOptions.Create
  (AReportLink: TdxCustomContainerReportLink);
begin
  inherited Create;
  FReportLink := AReportLink;
...
procedure TdxCustomContainerReportLinkOptionsBehavior.Assign
  (Source: TPersistent);
begin
...
procedure TdxCustomContainerReportLinkOptionsBehavior.SetConsumeExistingLinks
  (Value: Boolean);
begin
...
procedure TdxCustomContainerReportLinkOptionsBehavior.SetLabelAutoHeight
  (AValue: Boolean);
begin
...
procedure TdxCustomContainerReportLinkOptionsItemPlace.Assign
  (Source: TPersistent);
begin
...
procedure TdxCustomContainerReportLinkOptionsItemPlace.ReadData
  (AStream: TStream);
var
  Buffer: Integer;
begin
...
procedure TdxCustomContainerReportLinkOptionsItemPlace.WriteData
  (AStream: TStream);
var
  Buffer: Integer;
begin
...
procedure TdxCustomContainerReportLinkOptionsPagination.Assign
  (Source: TPersistent);
begin
...
procedure TdxCustomContainerReportLinkOptionsPagination.SetControlDetails
  (Value: Boolean);
begin
...
procedure TdxCustomContainerReportLinkOptionsPagination.SetControls
  (Value: Boolean);
begin
...
procedure TdxCustomContainerReportLinkOptionsRefinements.Assign
  (Source: TPersistent);
begin
...
procedure TdxCustomContainerReportLinkOptionsRefinements.SetRootBorders
  (Value: Boolean);
begin
...
procedure TdxCustomContainerReportLinkOptionsTransparent.Assign
  (Source: TPersistent);
begin
...
procedure TdxCustomContainerReportLinkOptionsTransparent.SetContainters
  (Value: Boolean);
begin
...
procedure TdxCustomContainerReportLinkOptionsTransparent.SetControls
  (Value: Boolean);
begin
  if FControls <> Value then
  begin
...
procedure TdxCustomContainerReportLinkOptionsTransparent.SetGraphics
  (Value: Boolean);
begin
...
procedure TdxCustomContainerReportLinkOptionsTransparent.SetRoot
  (Value: Boolean);
begin
  if FRoot <> Value then
  begin
...
function TdxCustomContainerReportLink.CanHideComponent
  (AComponent: TComponent): Boolean;
begin
  Result := (AComponent <> nil) and (Container <> nil) and
    (AComponent <> Container);
  if Result then
    if AComponent is TControl then
      Result := Container.ContainsControl(TControl(AComponent))
    else
      Result := (Container.Owner <> nil) and
        (Container.Owner = AComponent.Owner);
end;

function TdxCustomContainerReportLink.CanHideComponentByName
...
var
  Index: Integer;
begin
  if CanHideComponent(AComponent) and not FindHiddenComponent(AComponent, Index)
  then
...
var
  ...
  Component: TComponent;
begin
  if CanHideComponentByName(AName) and not FindHiddenComponentByName(AName,
    Index) then
  begin
...
procedure TdxCustomContainerReportLink.HideComponents(const AComponents
  : array of TComponent);
var
  I: Integer;
begin
...
procedure TdxCustomContainerReportLink.HideComponentsByName
...
function TdxCustomContainerReportLink.FindHiddenComponent
...
function TdxCustomContainerReportLink.FindHiddenComponentByName
...
procedure TdxCustomContainerReportLink.UnhideComponentByName
  (const AName: string);
var
  Index: Integer;
begin
...
procedure TdxCustomContainerReportLink.UnhideComponents(const AComponents
  : array of TComponent);
var
  I: Integer;
begin
...
procedure TdxCustomContainerReportLink.UnhideComponentsByName
  (const ANames: array of string);
var
  I: Integer;
begin
...
function TdxCustomContainerReportLink.CanExcludeComponent
  (AComponent: TComponent): Boolean;
begin
  Result := (AComponent <> nil) and (Container <> nil) and
    (AComponent <> Container);
...
function TdxCustomContainerReportLink.CanExcludeComponentByName
  (const AName: string): Boolean;
begin
  Result := (AName <> '') and (Container <> nil);
  if Result then
...
var
  Index: Integer;
begin
  if CanExcludeComponent(AComponent) and not FindExcludedComponent(AComponent,
    Index) then
    FExcludedComponents.AddObject(AComponent.Name, AComponent);
end;

procedure TdxCustomContainerReportLink.ExcludeComponentByName
  (const AName: string);
var
  Index: Integer;
  Component: TComponent;
begin
  if CanExcludeComponentByName(AName) and not FindExcludedComponentByName(AName,
    Index) then
  begin
    Component := GetComponentByName(AName);
    if Component <> nil then
...
procedure TdxCustomContainerReportLink.ExcludeComponents(const AComponents
  : array of TComponent);
var
  I: Integer;
begin
...
procedure TdxCustomContainerReportLink.ExcludeComponentsByName
  (const ANames: array of string);
var
  I: Integer;
begin
...
function TdxCustomContainerReportLink.FindExcludedComponent
  (AComponent: TComponent; out AnIndex: Integer): Boolean;
begin
...
function TdxCustomContainerReportLink.FindExcludedComponentByName
  (const AName: string; out AnIndex: Integer): Boolean;
begin
...
procedure TdxCustomContainerReportLink.UnexcludeComponent
  (AComponent: TComponent);
var
  Index: Integer;
begin
...
procedure TdxCustomContainerReportLink.UnexcludeComponentByName
  (const AName: string);
var
  Index: Integer;
begin
...
procedure TdxCustomContainerReportLink.UnexcludeComponents(const AComponents
  : array of TComponent);
var
  I: Integer;
begin
...
procedure TdxCustomContainerReportLink.UnexcludeComponentsByName
  (const ANames: array of string);
var
  I: Integer;
begin
...
procedure TdxCustomContainerReportLink.AggregateLink
  (AReportLink: TBasedxReportLink);
begin
...
begin
  ...
  begin
    ...
    if not IsLinkAggregatedConsistently(Link) then
      DisaggregateLink(Link);
  end;
end;

procedure TdxCustomContainerReportLink.DisaggregateLink
  (AReportLink: TBasedxReportLink);
var
  Index: Integer;
begin
...
function TdxCustomContainerReportLink.FindAggregatedLinkByComponent
  (AComponent: TComponent): TBasedxReportLink;
var
  I: Integer;
begin
...
function TdxCustomContainerReportLink.IsLinkAggregable
  (AReportLink: TBasedxReportLink): Boolean;
begin
  Result := (AReportLink <> nil) and (AReportLink <> Self) and
    AReportLink.Aggregable;
end;

function TdxCustomContainerReportLink.IsLinkAggregated
  (AReportLink: TBasedxReportLink): Boolean;
begin
  Result := FAggregatedReportLinks.IndexOfObject(AReportLink) <> -1;
end;

function TdxCustomContainerReportLink.IsLinkAggregatedConsistently
  (AReportLink: TBasedxReportLink): Boolean;
begin
  Result := IsLinkAggregated(AReportLink) and
    (AReportLink.Component is TControl) and (Container <> nil) and
    Container.ContainsControl(TControl(AReportLink.Component));
end;
...
procedure TdxCustomContainerReportLink.Notification(AComponent: TComponent;
...
procedure TdxCustomContainerReportLink.ConstructReport
  (AReportCells: TdxReportCells);
var
  Root: TdxReportCell;
begin
  inherited;
  if (Container = nil) or (csLoading in Container.ComponentState) then
    Exit;
...
function TdxCustomContainerReportLink.GetDesignerClass
...
procedure TdxCustomContainerReportLink.GetImageLists
  (AProc: TdxPSGetImageListProc);
var
  I: Integer;
begin
...
function TdxCustomContainerReportLink.IsSupportedCustomDraw
  (Item: TAbstractdxReportCellData): Boolean;
begin
  Result := SupportedCustomDraw and (Item <> nil) and (Item.Data <> 0);
end;

procedure TdxCustomContainerReportLink.MakeDelimiters
...
function TdxCustomContainerReportLink.CreateBuilder(AContainer: TWinControl;
  ...
  : TdxPSContainerBuilder;
begin
  Result := dxContainerBuilderFactory.CreateBuilder(Self, AContainer,
    AParentBuilder, AParentHost);
end;

function TdxCustomContainerReportLink.CreateItemDefinition
  (AComponent: TComponent; AnItem: TdxReportVisualItem)
  : TdxPSCustomContainerItemDefinition;
begin
...
function TdxCustomContainerReportLink.GetProducer(Component: TComponent)
  : TdxPSCustomProducer;
begin
  Result := ProducerCache[dxPSContainerItemProducerFactory[Component,
    Component = Container], Component];
end;

// IdxReportLinkController
function TdxCustomContainerReportLink.GetControlSiteBounds
...
begin
  if Assigned(FOnCustomDrawItem) then
    FOnCustomDrawItem(Self, ACanvas, AnItem,
      TComponent(TObject(AnItem.Data)), ADone);
end;

procedure TdxCustomContainerReportLink.DoGetComponentCaption
...
function TdxCustomContainerReportLink.DoGetReportLink(AComponent: TComponent)
  : TBasedxReportLink;
begin
  Result := nil;
...
procedure TdxCustomContainerReportLink.DoInitializeItem
  (AnItem: TdxReportVisualItem);
begin
...
procedure TdxCustomContainerReportLink.DoInitializeItemOptionsPlace
  (AnItem: TdxReportVisualItem);
begin
...
procedure TdxCustomContainerReportLink.DoInitializeReportLink
...
function TdxCustomContainerReportLink.DoIsComponentProcessed
  (AComponent: TComponent): Boolean;
var
  Index: Integer;
begin
  Result := (not(AComponent is TControl) or (TControl(AComponent).Visible and
    not IsRectEmpty(TControl(AComponent).BoundsRect))) and
    not FindHiddenComponent(AComponent, Index) and
    not FindExcludedComponent(AComponent, Index);
...
function TdxCustomContainerReportLink.GetOptionsBehaviorClass
  : TdxCustomContainerReportLinkOptionsBehaviorClass;
begin
  Result := TdxCustomContainerReportLinkOptionsBehavior;
end;

function TdxCustomContainerReportLink.GetOptionsDesignerTabsClass
  : TdxCustomContainerReportLinkOptionsDesignerTabsClass;
begin
  Result := TdxCustomContainerReportLinkOptionsDesignerTabs;
end;

function TdxCustomContainerReportLink.GetOptionsItemPlaceClass
  : TdxCustomContainerReportLinkOptionsItemPlaceClass;
begin
  Result := TdxCustomContainerReportLinkOptionsItemPlace;
end;

function TdxCustomContainerReportLink.GetOptionsPaginationClass
  : TdxCustomContainerReportLinkOptionsPaginationClass;
begin
  Result := TdxCustomContainerReportLinkOptionsPagination;
end;

function TdxCustomContainerReportLink.GetOptionsRefinementsClass
  : TdxCustomContainerReportLinkOptionsRefinementsClass;
begin
  Result := TdxCustomContainerReportLinkOptionsRefinements;
end;

function TdxCustomContainerReportLink.GetOptionsTransparentClass
  : TdxCustomContainerReportLinkOptionsTransparentClass;
begin
  Result := TdxCustomContainerReportLinkOptionsTransparent;
end;

procedure TdxCustomContainerReportLink.OptionsModified
  (AnOptions: TdxCustomContainerReportLinkOptions);
begin
  LinkModified(True);
end;
...
procedure TdxCustomContainerReportLink.AddDefinition
  (ADefinition: TdxPSCustomContainerItemDefinition);
begin
...
function TdxCustomContainerReportLink.FindDefinition
  (AnItem: TdxReportVisualItem; out AnIndex: Integer): Boolean;
begin
...
var
  ...
  Control: TControl;
begin
  AParent := AddNode(ATreeView, AParent, AControl,
    not FindExcludedComponent(AControl, Index));
  if AControl is TWinControl then
    for I := 0 to TWinControl(AControl).ControlCount - 1 do
    begin
      Control := TWinControl(AControl).Controls[I];
      if Producers[AControl].CanProcessChild(Control) and
        not FindHiddenComponent(Control, Index) then
...
begin
  AParent := AddNode(ATreeView, AParent, AControl,
    not FindHiddenComponent(AControl, Index));
  if AControl is TWinControl then
    for I := 0 to TWinControl(AControl).ControlCount - 1 do
    begin
      Control := TWinControl(AControl).Controls[I];
...
function TdxCustomContainerReportLink.IsComponentEditable
  (AComponent: TComponent): Boolean;
begin
...
procedure TdxCustomContainerReportLink.LoadHiddenControlsTree
  (ATreeView: TTreeView);
begin
  ATreeView.Items.Clear;
  if Container <> nil then
...
procedure TdxCustomContainerReportLink.InstallAggregatedReportLinksController
  (AnInstall: Boolean);
var
  I: Integer;
begin
...
function TdxCustomContainerReportLink.GetComponentByName(const AName: string)
  : TComponent;
begin
  if AName <> '' then
  begin
...
function TdxCustomContainerReportLink.GetPreparedFontIndex
  (AFont: TFont): Integer;
begin
  Result := GetPreparedFontIndex(AFont, True, AFont.Name, AFont.Color,
    AFont.Style, AFont.Orientation);
end;

function TdxCustomContainerReportLink.GetPreparedFontIndex(AFont: TFont;
  AIsFontSubstitutable: Boolean; const AFontName: string; AFontColor: TColor;
  AFontStyle: TFontStyles; AFontOrientation: Integer): Integer;
begin
...
function TdxCustomContainerReportLink.IsComponentProcessed
  (AComponent: TComponent): Boolean;
begin
...
begin
  ReportCells.LookAndFeel := CreateGroupLookAndFeel
...
procedure TdxCustomContainerReportLink.HideDesignerTabs(ADesignWindow
  : TdxfmCustomContainerDesignWindow);
begin
  if not IsDesigning then
    with OptionsDesignerTabs do
    begin
      ADesignWindow.tshReportLinks.Visible := ReportLinks and
        ((AggregatedReportLinkCount <> 0) or not AutoHideReportLinksIfEmpty);
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        if FindDefinition(Item, Index) then
...
function TdxCustomContainerReportLink.GetAggregatedReportLink(Index: Integer)
  : TBasedxReportLink;
begin
...
function TdxCustomContainerReportLink.GetController
  : TdxCustomContainerReportLink;
begin
  Result := inherited Controller as TdxCustomContainerReportLink;
end;

function TdxCustomContainerReportLink.GetDefinition(Index: Integer)
  : TdxPSCustomContainerItemDefinition;
begin
  Result := TdxPSCustomContainerItemDefinition(FDefinitions[Index]);
end;

function TdxCustomContainerReportLink.GetDefinitionByContainerItem
  (Component: TComponent): TdxPSCustomContainerItemDefinition;
var
  I: Integer;
begin
  for I := 0 to DefinitionCount - 1 do
  begin
    ...
    if Result.Component = Component then
      Exit;
  end;
  Result := nil;
end;

function TdxCustomContainerReportLink.GetDefinitionByReportItem
  (Item: TdxReportVisualItem): TdxPSCustomContainerItemDefinition;
var
  I: Integer;
begin
  for I := 0 to DefinitionCount - 1 do
  begin
    Result := Definitions[I];
    if Result.ReportItem = Item then
      Exit;
  end;
  Result := nil;
end;
...
function TdxCustomContainerReportLink.GetDelimitersHorzItem
...
function TdxCustomContainerReportLink.GetDelimitersVertItem
  (Index: Integer): Integer;
begin
  Result := Integer(DelimitersVert[Index]);
end;

function TdxCustomContainerReportLink.GetDesignWindow
  : TdxfmCustomContainerDesignWindow;
begin
  Result := inherited DesignWindow as TdxfmCustomContainerDesignWindow;
end;

function TdxCustomContainerReportLink.GetExcludedComponent(Index: Integer)
  : TComponent;
begin
...
function TdxCustomContainerReportLink.GetHiddenComponent(Index: Integer)
  : TComponent;
begin
...
function TdxCustomContainerReportLink.GetProducerByClass(ProducerClass
  : TdxPSCustomProducerClass; Component: TComponent): TdxPSCustomProducer;
begin
...
procedure TdxCustomContainerReportLink.SetController
  (Value: TdxCustomContainerReportLink);
begin
  inherited Controller := Value;
end;

procedure TdxCustomContainerReportLink.SetOnCustomDrawItem
  (Value: TdxContainerReportLinkCustomDrawItemEvent);
begin
...
procedure TdxCustomContainerReportLink.SetOptionsBehavior
  (Value: TdxCustomContainerReportLinkOptionsBehavior);
begin
  OptionsBehavior.Assign(Value);
end;

procedure TdxCustomContainerReportLink.SetOptionsDesignerTabs
  (Value: TdxCustomContainerReportLinkOptionsDesignerTabs);
begin
...
procedure TdxCustomContainerReportLink.SetOptionsPagination
  (Value: TdxCustomContainerReportLinkOptionsPagination);
begin
  OptionsPagination.Assign(Value);
end;

procedure TdxCustomContainerReportLink.SetOptionsRefinements
  (Value: TdxCustomContainerReportLinkOptionsRefinements);
begin
  OptionsRefinements.Assign(Value);
end;

procedure TdxCustomContainerReportLink.SetOptionsTransparent
  (Value: TdxCustomContainerReportLinkOptionsTransparent);
begin
...
procedure TdxCustomContainerReportLink.ReadAggregatedReportLinks
  (Stream: TStream);
begin
  FAggregatedReportLinks.LoadFromStream(Stream);
end;

procedure TdxCustomContainerReportLink.WriteAggregatedReportLinks
  (Stream: TStream);
begin
...
begin
  ...
  chbxPaginateByControlDetails.Checked :=
    ReportLink.OptionsPagination.ControlDetails;
...
begin
  ...
  chbxPaginateByControlDetails.Caption :=
    cxGetResourceString(@sdxPaginateByControlDetails);
  ...
  btnLinksRemoveInconsistents.Caption :=
    cxGetResourceString(@sdxBtnRemoveInconsistents);
  ...
  miControlsCheckAllChildren.Caption :=
    cxGetResourceString(@sdxCheckAllChildren);
  miControlsUncheckAllChildren.Caption :=
    cxGetResourceString(@sdxUncheckAllChildren);
...
begin
  ...
  btnControlsCheckAll.Enabled := (Root <> nil) and
    TreeView_HasUncheckedChildren(Root);
  ...
  btnHiddenControlsCheckAll.Enabled := (Root <> nil) and
    TreeView_HasUncheckedChildren(Root);
...
begin
  if not(dwsInitialize in State) then
    tvControls.Items.BeginUpdate;
  try
    InitializeControlsTree;
  finally
    if not(dwsInitialize in State) then
      tvControls.Items.EndUpdate;
  end;
end;
...
begin
  if not(dwsInitialize in State) then
    tvHiddenControls.Items.BeginUpdate;
  try
    InitializeHiddenControlsTree;
  finally
    if not(dwsInitialize in State) then
      tvHiddenControls.Items.EndUpdate;
  end;
end;
...
procedure TdxfmCustomContainerDesignWindow.SetOptionsGroupsByIndex
  (AnIndex: Integer; AValue: Boolean);
begin
end;

procedure TdxfmCustomContainerDesignWindow.SetOptionsPaginationByIndex
  (AnIndex: Integer; AValue: Boolean);
begin
...
procedure TdxfmCustomContainerDesignWindow.SetOptionsSizeByIndex
  (AnIndex: Integer; AValue: Boolean);
begin
end;

procedure TdxfmCustomContainerDesignWindow.SetOptionsTabsByIndex
  (AnIndex: Integer; AValue: Boolean);
begin
end;
...
procedure TdxfmCustomContainerDesignWindow.SetOptionsTransparentByIndex
  (AnIndex: Integer; AValue: Boolean);
begin
  if LockControlsUpdate then
    Exit;
...
begin
  if TBasedxReportLinkAccess(ReportLink).IsDesigning and (Stage = cdPostPaint)
    and (TreeView_GetNodeObject(Node) <> nil) then
  begin
    DrawNodeExtraText;
    DefaultDraw := False;
  end;
...
procedure TdxfmCustomContainerDesignWindow.TreeView_CheckAllChildren
  (ANode: TTreeNode; AChecked: Boolean);

  procedure DoCheckAllChildren(ANode: TTreeNode);
  const
    StateMap: array [Boolean, Boolean] of TCheckBoxState =
      ((cbGrayed, cbChecked), (cbUnchecked, cbChecked));
  var
    I: Integer;
    Node: TTreeNode;
  begin
    ...
    begin
      Node := ANode[I];
      TreeView_SetNodeState(Node, StateMap[TreeView_IsNodeEditable(Node),
        AChecked]);
...
procedure TdxfmCustomContainerDesignWindow.TreeView_FreeNodeObjects
  (ATreeView: TTreeView);
...
function TdxfmCustomContainerDesignWindow.TreeView_GetNodeObject
  (ANode: TTreeNode): TdxNodeObject;
begin
  Result := TdxNodeObject(ANode.Data);
end;

function TdxfmCustomContainerDesignWindow.TreeView_getRoot(ATreeView: TTreeView)
  : TTreeNode;
begin
  Result := ATreeView.Items.GetFirstNode;
end;

function TdxfmCustomContainerDesignWindow.TreeView_HasCheckedChildren
...
function TdxfmCustomContainerDesignWindow.TreeView_HasRoot
  (ATreeView: TTreeView): Boolean;
begin
  Result := TreeView_getRoot(ATreeView) <> nil;
end;

function TdxfmCustomContainerDesignWindow.TreeView_HasUncheckedChildren
  (ANode: TTreeNode): Boolean;
var
  I: Integer;
  Node: TTreeNode;
...
function TdxfmCustomContainerDesignWindow.TreeView_IsNodeEditable
  (ANode: TTreeNode): Boolean;
begin
  Result := (ANode <> nil) and ReportLink.IsComponentEditable
    (TreeView_GetNodeObject(ANode).Component);
end;

procedure TdxfmCustomContainerDesignWindow.TreeView_NormalizeNode
  (ANode: TTreeNode);
  ...
  begin
    ...
    if (NodeObject.State = cbChecked) and TreeView_HasUncheckedChildren(ANode)
    then
...
procedure TdxfmCustomContainerDesignWindow.TreeView_SetNodeState
  (ANode: TTreeNode; AState: TCheckBoxState);
var
  NodeObject: TdxNodeObject;
  Component: TComponent;
begin
...
procedure TdxfmCustomContainerDesignWindow.TreeView_ToggleNodeState
  (ANode: TTreeNode);
const
  StateToggles: array [TCheckBoxState] of TCheckBoxState = (cbChecked,
...
procedure TdxfmCustomContainerDesignWindow.TreeView_UpdateNodeImage
  (ANode: TTreeNode);
begin
  ANode.StateIndex := dxPSUtl.dxCheckStateImageIndexMap
    (TreeView_GetNodeObject(ANode).State);
end;

procedure TdxfmCustomContainerDesignWindow.TreeView_UpdateNodesState
  (ANode: TTreeNode);
...
function TdxfmCustomContainerDesignWindow.GetAggregatedLink(Index: Integer)
  : TBasedxReportLink;
begin
...
function TdxfmCustomContainerDesignWindow.GetAggregatedLinkSelected
  (Index: Integer): Boolean;
begin
  Result := lbxAggregatedLinks.Selected[Index];
end;

function TdxfmCustomContainerDesignWindow.GetAvailableLink(Index: Integer)
  : TBasedxReportLink;
begin
...
function TdxfmCustomContainerDesignWindow.GetAvailableLinkSelected
  (Index: Integer): Boolean;
begin
  Result := lbxAvailableLinks.Selected[Index];
end;

function TdxfmCustomContainerDesignWindow.GetReportLink
  : TdxCustomContainerReportLink;
begin
  Result := inherited ReportLink as TdxCustomContainerReportLink;
end;

function TdxfmCustomContainerDesignWindow.GetSelectedReportLink
  : TBasedxReportLink;
begin
  ...
  begin
    ...
    try
      ...
      begin
        ...
        if ReportLink.IsLinkAggregable(Link) and not ReportLink.IsLinkAggregated
          (Link) then
...
procedure TdxfmCustomContainerDesignWindow.TreeViewCheckAllClick
  (Sender: TObject);
begin
  DoCheckAllChildren(TreeView_getRoot(ActiveTreeView.InnerTreeView), True);
end;

procedure TdxfmCustomContainerDesignWindow.TreeViewCheckAllChildrenClick
  (Sender: TObject);
begin
  DoCheckAllChildren(ActiveTreeView.Selected, True);
end;

procedure TdxfmCustomContainerDesignWindow.TreeViewUncheckAllChildrenClick
  (Sender: TObject);
begin
  DoCheckAllChildren(ActiveTreeView.Selected, False);
end;

procedure TdxfmCustomContainerDesignWindow.TreeViewExpandAllClick
  (Sender: TObject);
begin
  ActiveTreeView.FullExpand;
end;

procedure TdxfmCustomContainerDesignWindow.HideStandardControlsClick
  (Sender: TObject);
begin
  ReportLink.HideStandardControls;
end;

procedure TdxfmCustomContainerDesignWindow.UnhideStandardControlsClick
  (Sender: TObject);
begin
...
begin
  if (Node = nil) or (TreeView_GetNodeObject(Node) = nil) then
    Exit;
  ...
  begin
    ...
    begin
      ...
      if Sender.Focused then
        Sender.Canvas.Font.Color := SelectedFontColors
          [TreeView_IsNodeEditable(Node)]
      else
...
begin
  ...
  miControlsCheckAll.Enabled := (Node <> nil) and
  ...
  miControlsCheckAllChildren.Enabled := (Node <> nil) and (Node.Count <> 0) and
    TreeView_HasUncheckedChildren(Node);
  miControlsUncheckAllChildren.Enabled := (Node <> nil) and (Node.Count <> 0)
    and TreeView_HasCheckedChildren(Node);
end;

procedure TdxfmCustomContainerDesignWindow.lbxAggregatedLinksClick
  (Sender: TObject);
begin
  UpdateControlsState;
end;
...
begin
  ...
  begin
    ...
    FLastActiveTab := PageControl.ItemIndex;
    if FAreHiddenControlsChanged and (FLastActiveTab = tshHiddenControls.Index)
    then
      RefreshControlsTree;
  end;
end;
...
procedure TdxfmCustomContainerDesignWindow.lbxAvailableLinksDragOver(Sender,
  Source: TObject; X, Y: Integer; State: TDragState; var Accept: Boolean);
begin
  Accept := (cxExtractDragObjectSource(Source) = lbxAggregatedLinks) and
    (lbxAggregatedLinks.SelCount <> 0);
end;

procedure TdxfmCustomContainerDesignWindow.lbxAvailableLinksDragDrop(Sender,
  Source: TObject; X, Y: Integer);
begin
  DoDisaggregateSelectedLinks;
end;

procedure TdxfmCustomContainerDesignWindow.lbxAggregatedLinksDragOver(Sender,
  Source: TObject; X, Y: Integer; State: TDragState; var Accept: Boolean);
begin
  Accept := (cxExtractDragObjectSource(Source) = lbxAvailableLinks) and
    (lbxAvailableLinks.SelCount <> 0);
end;

procedure TdxfmCustomContainerDesignWindow.lbxAggregatedLinksDragDrop(Sender,
  Source: TObject; X, Y: Integer);
begin
  DoAggregateSelectedLinks;
end;

procedure TdxfmCustomContainerDesignWindow.lbxAggregatedLinksDblClick
  (Sender: TObject);
begin
  if CanDisaggregate then
    DoDisaggregateSelectedLinks
  else if CanDesign then
    btnLinksDesign.Click;
end;

procedure TdxfmCustomContainerDesignWindow.lbxAvailableLinksDblClick
  (Sender: TObject);
begin
...
procedure TdxfmCustomContainerDesignWindow.lbxAvailableLinksDrawItem
  ...
  begin
    Result := (AControl = lbxAggregatedLinks) and
      not(ReportLink.IsLinkAggregatedConsistently(ALink) or
      (odSelected in AState));
  end;

  function IsAvailableLink(ALink: TBasedxReportLink): Boolean;
  begin
    Result := not(odSelected in AState) and
      ((AControl = lbxAvailableLinks) or
      ReportLink.IsLinkAggregatedConsistently(ALink));
  end;
