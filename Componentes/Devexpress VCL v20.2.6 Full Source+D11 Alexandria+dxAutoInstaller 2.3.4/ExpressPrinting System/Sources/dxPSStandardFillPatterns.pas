...
class procedure TdxPSHorizontalFillPattern.Bits(var APattern
  : TdxPSPatternBitRows);
const
  Bits: TdxPSPatternBitRows = ($FFFF, $0000, $FFFF, $FFFF, $FFFF, $FFFF,
    $FFFF, $FFFF);
begin
  APattern := Bits;
end;
...
class procedure TdxPSVerticalFillPattern.Bits(var APattern
  : TdxPSPatternBitRows);
const
  Bits: TdxPSPatternBitRows = ($FFBF, $FFBF, $FFBF, $FFBF, $FFBF, $FFBF,
    $FFBF, $FFBF);
begin
  APattern := Bits;
end;
...
class procedure TdxPSFDiagonalFillPattern.Bits(var APattern
  : TdxPSPatternBitRows);
const
  Bits: TdxPSPatternBitRows = ($FFFE, $FFFD, $FFFB, $FFF7, $FFEF, $FFDF,
    $FFBF, $FF7F);
begin
  APattern := Bits;
end;
...
class procedure TdxPSBDiagonalFillPattern.Bits(var APattern
  : TdxPSPatternBitRows);
const
  Bits: TdxPSPatternBitRows = ($FF7F, $FFBF, $FFDF, $FFEF, $FFF7, $FFFB,
    $FFFD, $FFFE);
begin
  APattern := Bits;
end;
...
const
  Bits: TdxPSPatternBitRows = ($FFBF, $0000, $FFBF, $FFBF, $FFBF, $FFBF,
    $FFBF, $FFBF);
begin
  APattern := Bits;
end;
...
class procedure TdxPSDiagCrossFillPattern.Bits(var APattern
  : TdxPSPatternBitRows);
const
  Bits: TdxPSPatternBitRows = ($FF7E, $FFBD, $FFDB, $FFE7, $FFE7, $FFDB,
    $FFBD, $FF7E);
begin
  APattern := Bits;
end;
