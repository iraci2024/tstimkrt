...
procedure TdxReportLinkLookAndFeelKindPropertyEditor.GetValues
  (Proc: TGetStrProc);
var
  I: Integer;
begin
...
begin
  if Supports(TObject(Options), IdxReportLinkOptionsDesignerSupport,
    DesignerSupport) then
  begin
...
function TdxReportLinkOptionsPropertyEditor.GetOptions
  : TdxCustomReportLinkOptions;
begin
  Result := TdxCustomReportLinkOptions(GetOrdValue);
end;

function TdxReportLinkOptionsPropertyEditor.GetReportLink
...
var
  DesignerSupport: IdxReportLinkOptionsDesignerSupport;
begin
  if Supports(TObject(Styles), IdxReportLinkOptionsDesignerSupport,
    DesignerSupport) then
  begin
    DesignerSupport.DesignerInitialize;
    try
...
function TdxReportLinkStylesPropertyEditor.GetReportLink
  : TdxCustomcxControlReportLink;
begin
  Result := TdxCustomcxControlReportLink(GetComponent(0));
end;
...
begin
  ...
  RegisterPropertyEditor(TypeInfo(TcxLookAndFeelKind),
    TdxCustomReportLinkOptionsFormatting, 'LookAndFeelKind',
    TdxReportLinkLookAndFeelKindPropertyEditor);
