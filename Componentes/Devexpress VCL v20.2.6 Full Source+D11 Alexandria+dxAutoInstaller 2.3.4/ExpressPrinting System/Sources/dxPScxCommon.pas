...
{$IFDEF DELPHI16}
  System.UITypes,
{$ENDIF}
  Types, Classes, Windows, Messages, Graphics, Controls, StdCtrls, ExtCtrls,
  ImgList, Menus,
  Dialogs, ExtDlgs, cxClasses, cxControls, cxGraphics, cxLookAndFeels, cxStyles,
  cxLookAndFeelPainters, cxEdit,
  cxTextEdit, cxMemo, cxCheckBox, cxRadioGroup, cxBlobEdit, cxGroupBox, cxImage,
  cxImageComboBox, cxHyperLinkEdit,
  cxCurrencyEdit, dxPSGlbl, dxBase, dxPSCore, dxPSRes, cxDrawTextUtils,
  cxListBox, dxCore, dxPSReportRenderCanvas,
  cxGeometry, dxToggleSwitch, dxSparkline, dxPSReportLinkDesignWindow,
  dxLayoutControlAdapters, cxButtons,
  dxLayoutLookAndFeels, dxLayoutContainer, dxLayoutControl, dxTokenEdit,
  dxGDIPlusClasses, dxInputDialogs,
  dxFormattedLabel, dxFormattedText, dxTextViewInfoCache;
...
type
  ...
  private
    function GetMapClass(Properties: TcxCustomEditProperties)
      : TdxPSDataMapClass;
  public
    class function Instance: TdxPSDataMaps; reintroduce; overload;

    function DoesItemParticipateInAutoHeightCalculation
      (AProperties: TcxCustomEditProperties): Boolean;
    function DoesItemParticipateInAutoWidthCalculation
      (AProperties: TcxCustomEditProperties): Boolean;
    function DoesItemParticipateInBestFitCalculation
      (AProperties: TcxCustomEditProperties): Boolean;
    procedure GetImageLists(AProperties: TcxCustomEditProperties;
      AProc: TdxPSGetImageListProc);
    procedure InitializeItem(AnItem: TAbstractdxReportCellData;
      AProperties: TcxCustomEditProperties; const AValue: TcxEditValue;
      const ACellParams: IdxPSCellParams;
      var AViewParams: TdxReportItemViewParams; AnIsPreview: Boolean = False;
      ARecordIndex: Integer = 0; AOwner: TObject = nil);
    function ItemClass(AProperties: TcxCustomEditProperties;
      AnIsPreview: Boolean = False): TdxReportCellDataClass; overload;
    function ItemClass(AProperties: TcxCustomEditProperties;
      const AViewParams: TdxReportItemViewParams; AIsPreview: Boolean = False)
      : TdxReportCellDataClass; overload;
    function MeasureWidth(AProperties: TcxCustomEditProperties;
      const AValue: TcxEditValue; const ACellParams: IdxPSCellParams;
      AFont: TFont; ARecordIndex: Integer = 0): Integer;
    property MapClasses[Properties: TcxCustomEditProperties]: TdxPSDataMapClass
      read GetMapClass; default;
  end;
  ...
  protected
    class function DoesItemParticipateInAutoHeightCalculation
      (AProperties: TcxCustomEditProperties): Boolean; virtual;
    class function DoesItemParticipateInAutoWidthCalculation
      (AProperties: TcxCustomEditProperties): Boolean; virtual;
    class function DoesItemParticipateInBestFitCalculation
      (AProperties: TcxCustomEditProperties): Boolean; virtual;
    class procedure GetImageLists(AProperties: TcxCustomEditProperties;
      AProc: TdxPSGetImageListProc); virtual;
    class function GetText(AProperties: TcxCustomEditProperties;
      const AValue: TcxEditValue): string; virtual;
    class function HasText(AProperties: TcxCustomEditProperties;
      const AValue: TcxEditValue): Boolean; virtual;
    class procedure InitializeItem(AnItem: TAbstractdxReportCellData;
      AProperties: TcxCustomEditProperties; const AValue: TcxEditValue;
      const ACellParams: IdxPSCellParams;
      var AViewParams: TdxReportItemViewParams; AnIsPreview: Boolean = False;
      ARecordIndex: Integer = 0; AOwner: TObject = nil); virtual;
    class function ItemClass(AProperties: TcxCustomEditProperties;
      AIsPreview: Boolean = False): TdxReportCellDataClass; overload; virtual;
    class function ItemClass(AProperties: TcxCustomEditProperties;
      const AViewParams: TdxReportItemViewParams; AIsPreview: Boolean = False)
      : TdxReportCellDataClass; overload; virtual;
    class function MeasureWidth(AProperties: TcxCustomEditProperties;
      const AValue: TcxEditValue; const ACellParams: IdxPSCellParams;
      AFont: TFont; ARecordIndex: Integer = 0): Integer; virtual;
  ...
  protected
    class procedure InitializeItem(AnItem: TAbstractdxReportCellData;
      ...
      const ACellParams: IdxPSCellParams;
      var AViewParams: TdxReportItemViewParams; AnIsPreview: Boolean = False;
      ARecordIndex: Integer = 0; AOwner: TObject = nil); override;
    class function GetText(AProperties: TcxCustomEditProperties;
      const AValue: TcxEditValue): string; override;
    class function ItemClass(AProperties: TcxCustomEditProperties;
      AnIsPreview: Boolean = False): TdxReportCellDataClass; override;
  ...
  protected
    class function DoesItemParticipateInAutoWidthCalculation
      (AProperties: TcxCustomEditProperties): Boolean; override;
    class function DoesItemParticipateInBestFitCalculation
      (AProperties: TcxCustomEditProperties): Boolean; override;
    class procedure InitializeItem(AnItem: TAbstractdxReportCellData;
      AProperties: TcxCustomEditProperties; const AValue: TcxEditValue;
  ...
  protected
    ...
    class function MeasureWidth(AProperties: TcxCustomEditProperties;
      const AValue: TcxEditValue; const ACellParams: IdxPSCellParams;
      AFont: TFont; ARecordIndex: Integer = 0): Integer; override;
    class function PropertiesClass: TcxCustomEditPropertiesClass; override;
  end;
  ...
  strict private
    class function CalculateViewInfo(AProperties: TcxCustomEditProperties;
      ABounds: TRect; const AValue: TcxEditValue): TdxTokenEditViewInfo;
  protected
    class procedure InitializeItem(AnItem: TAbstractdxReportCellData;
      AProperties: TcxCustomEditProperties; const AValue: TcxEditValue;
      const ACellParams: IdxPSCellParams;
  ...
  protected
    class function ButtonGroupClass(AProperties: TcxCustomEditProperties)
      : TdxCustomReportButtonGroupClass; virtual;
    class procedure InitializeGroupButton(AProperties: TcxCustomEditProperties;
      const AValue: TcxEditValue; AButton: TdxCustomReportCellCheck;
  ...
  protected
    class function ButtonGroupClass(AProperties: TcxCustomEditProperties)
      : TdxCustomReportButtonGroupClass; override;
    class procedure InitializeItem(AnItem: TAbstractdxReportCellData;
      AProperties: TcxCustomEditProperties; const AValue: TcxEditValue;
      const ACellParams: IdxPSCellParams;
      var AViewParams: TdxReportItemViewParams; AnIsPreview: Boolean = False;
  ...
  protected
    ...
    class function GetGraphic(AProperties: TcxCustomEditProperties;
      AGraphicClass: TGraphicClass; const AValue: TcxEditValue)
      : TGraphic; virtual;
    class function GetGraphicClass(AProperties: TcxCustomEditProperties;
      ARecordIndex: Integer; AOwner: TObject = nil): TGraphicClass; virtual;
  ...
  protected
    class function DoesItemParticipateInBestFitCalculation
      (AProperties: TcxCustomEditProperties): Boolean; override;
    class function GetComboBoxItem(AProperties: TcxCustomEditProperties;
      const AValue: TcxEditValue): TcxImageComboBoxItem; virtual;
    class function GetImageIndex(AProperties: TcxCustomEditProperties;
      const AValue: TcxEditValue): Integer; virtual;
    class procedure GetImageLists(AProperties: TcxCustomEditProperties;
      AProc: TdxPSGetImageListProc); override;
    class function GetImages(AProperties: TcxCustomEditProperties)
      : TCustomImageList; virtual;
    class function GetText(AProperties: TcxCustomEditProperties;
      const AValue: TcxEditValue): string; override;
    class function HasImages(AProperties: TcxCustomEditProperties)
      : Boolean; virtual;
    class procedure InitializeItem(AnItem: TAbstractdxReportCellData;
      AProperties: TcxCustomEditProperties; const AValue: TcxEditValue;
      const ACellParams: IdxPSCellParams;
      var AViewParams: TdxReportItemViewParams; AnIsPreview: Boolean = False;
      ARecordIndex: Integer = 0; AOwner: TObject = nil); override;
    class function IsMultilinedText(AProperties: TcxCustomEditProperties)
      : Boolean; virtual;
    class function ItemClass(AProperties: TcxCustomEditProperties;
      AnIsPreview: Boolean = False): TdxReportCellDataClass; override;
    class function MeasureWidth(AProperties: TcxCustomEditProperties;
  ...
  protected
    class function DataMapClass(AProperties: TcxCustomEditProperties)
      : TdxPSDataMapClass; virtual;
    class function DoesItemParticipateInAutoHeightCalculation
      (AProperties: TcxCustomEditProperties): Boolean; override;
    class function DoesItemParticipateInAutoWidthCalculation
      (AProperties: TcxCustomEditProperties): Boolean; override;
  ...
  public
    ...
    procedure ExtTextOut(const ABounds: TRect; AFontHandle: THandle;
      AFontColor: TColor; const AText: string; AGlyphs: PdxWordArray;
      AGlyphCount: Integer; AGlyphWidths: PdxIntegerArray); override;
  ...
  strict private
    ...
    procedure CalculateTextLayout(AFormattedText: TdxFormattedText;
      var ARect: TRect; AZoomFactor: Single);
  ...
  public
    ...
    property MeasureTrailingSpaces: Boolean read FMeasureTrailingSpaces
      write FMeasureTrailingSpaces;
  ...
  TdxCustomReportLinkStyles = class(TcxStyles,
    IdxReportLinkOptionsDesignerSupport)
  strict private
  ...
  protected
    ...
    procedure GetDefaultViewParamsByCaption(const ACaption: string;
      AData: Pointer; out AParams: TcxViewParams); virtual;
    ...
    function GetStyleIndexByCaption(const Caption: string): Integer;
      virtual; abstract;
    procedure SetStyleByCaption(const Caption: string;
      Value: TcxStyle); virtual;

    property StyleIndexesByCaption[const Caption: string]: Integer
      read GetStyleIndexByCaption;
  public
    property ReportLink: TdxCustomcxControlReportLink read GetReportLink;
    property StylesByCaption[const Caption: string]: TcxStyle
      read GetStyleByCaption write SetStyleByCaption;
  end;
  ...
  TdxCustomReportLinkOptions = class(TPersistent, IUnknown,
    IdxReportLinkOptionsDesignerSupport)
  private
  ...
  protected
    property UseLookAndFeelColors: Boolean read FUseLookAndFeelColors
      write SetUseLookAndFeelColors default False;
    // affects only in WinXP themed environment
  public
    procedure Assign(Source: TPersistent); override;
  ...
  published
    property GridLineColor: TColor read FGridLineColor write SetGridLineColor
      default clDefault;
    property LookAndFeelKind: TcxLookAndFeelKind read FLookAndFeelKind
      write SetLookAndFeelKind default lfUltraFlat;
    property SuppressBackgroundBitmaps: Boolean read FSuppressBackgroundBitmaps
      write SetSuppressBackgroundBitmaps default False;
    property UseNativeStyles: Boolean read FUseNativeStyles
      write SetUseNativeStyles default False;
  end;

  TdxCustomReportLinkOptionsPaginationClass = class of
    TdxCustomReportLinkOptionsPagination;

  TdxCustomReportLinkOptionsPagination = class(TdxCustomReportLinkOptions)
  end;

  TdxCustomReportLinkOptionsRefinementsClass = class of
  ...
  public
    ...
    procedure RestoreDefaults; override;
  published
    property DisplayGraphicsAsText: Boolean read FDisplayGraphicsAsText
      write SetDisplayGraphicsAsText default False;
    property DisplayTrackBarsAsText: Boolean read FDisplayTrackBarsAsText
      write SetDisplayTrackBarsAsText default True;
    property FlatCheckMarks: Boolean read FFlatCheckMarks
      write SetFlatCheckMarks default True;
    property GraphicsText: string read GetGraphicsText write SetGraphicsText
      stored IsGraphicsTextStored;
    property TransparentGraphics: Boolean read FTransparentGraphics
      write SetTransparentGraphics default False;
    property TransparentRichEdits: Boolean read FTransparentRichEdits
      write SetTransparentRichEdits default False;
    // you can expect slow painting when True
  end;
  ...
  TdxStyleSheetHasCaptionProc = function(const ACaption: string)
    : Boolean of object;
  ...
  private
    ...
    procedure SetOptionsRefinements
      (Value: TdxCustomReportLinkOptionsRefinements);
  ...
  protected
    ...
    function GetOptionsExpandingClass
      : TdxCustomReportLinkOptionsExpandingClass; virtual;
    function GetOptionsFormattingClass
      : TdxCustomReportLinkOptionsFormattingClass; virtual;
    function GetOptionsPaginationClass
      : TdxCustomReportLinkOptionsPaginationClass; virtual;
    function GetOptionsRefinementsClass
      : TdxCustomReportLinkOptionsRefinementsClass; virtual;
    ...
    function CreateStyleSheet(APrototype: TcxCustomStyleSheet;
      const ACaption: string; AUseStyles: Boolean)
      : TdxCustomReportLinkStyleSheet;
    function FindStyleRepositoryInStyles(AStyles: TcxStyles)
      : TcxStyleRepository;
    ...
    function GetStyleSheetCaption(ACheckProc: TdxStyleSheetHasCaptionProc;
      var ACaption: string): Boolean;
    function InitiateStyle(const ACaption: string; var AStyle: TcxStyle;
      AForceCreation: Boolean): Boolean;
    ...
    property DesignerTabIndex: Integer read FDesignerTabIndex
      write FDesignerTabIndex;
    ...
    property StyleRepository: TcxStyleRepository read FStyleRepository
      write SetStyleRepository;
  ...
  public
    ...
    property DesignWindow: TdxfmCustomcxControlReportLinkDesignWindow
      read GetDesignWindow;
    property OptionsExpanding: TdxCustomReportLinkOptionsExpanding
      read FOptionsExpanding write SetOptionsExpanding;
    property OptionsFormatting: TdxCustomReportLinkOptionsFormatting
      read FOptionsFormatting write SetOptionsFormatting;
    property OptionsPagination: TdxCustomReportLinkOptionsPagination
      read FOptionsPagination write SetOptionsPagination;
    property OptionsRefinements: TdxCustomReportLinkOptionsRefinements
      read FOptionsRefinements write SetOptionsRefinements;
    property OptionsSize: TdxCustomReportLinkOptionsSize read FOptionsSize
      write SetOptionsSize;
    property OptionsView: TdxCustomReportLinkOptionsView read FOptionsView
      write SetOptionsView;
    property SupportedCustomDraw: Boolean read FSupportedCustomDraw
      write SetSupportedCustomDraw default False;
  end;

  { TableReportLink Options }

  TdxCustomTableControlReportLinkOptionsClass = class of
  ...
  TdxCustomTableControlReportLinkOptionsOnEveryPageClass = class of
  ...
  TdxCustomTableControlReportLinkOptionsPaginationClass = class of
  ...
  TdxCustomTableControlReportLinkOptionsPreviewClass = class of
  ...
  TdxCustomTableControlReportLinkOptionsSelectionClass = class of
  ...
  public
    ...
    procedure RestoreDefaults; override;
  published
    property ProcessExactSelection: Boolean read FProcessExactSelection
      write SetProcessExactSelection default False;
    property ProcessSelection: Boolean read FProcessSelection
      write SetProcessSelection default False;
  end;

  TdxCustomTableControlReportLinkOptionsViewClass = class of
    TdxCustomTableControlReportLinkOptionsView;

  TdxCustomTableControlReportLinkOptionsView = class
  ...
  private
    ...
    procedure SetOptionsOnEveryPage
      (Value: TdxCustomTableControlReportLinkOptionsOnEveryPage);
    procedure SetOptionsPagination
      (Value: TdxCustomTableControlReportLinkOptionsPagination);
    procedure SetOptionsPreview
      (Value: TdxCustomTableControlReportLinkOptionsPreview);
    procedure SetOptionsSelection
      (Value: TdxCustomTableControlReportLinkOptionsSelection);
  ...
  protected
    ...
    function GetOptionsOnEveryPageClass
      : TdxCustomTableControlReportLinkOptionsOnEveryPageClass; virtual;
    function GetOptionsPaginationClass
      : TdxCustomReportLinkOptionsPaginationClass; override;
    function GetOptionsPreviewClass
      : TdxCustomTableControlReportLinkOptionsPreviewClass; virtual;
    function GetOptionsSelectionClass
      : TdxCustomTableControlReportLinkOptionsSelectionClass; virtual;
    function GetOptionsViewClass: TdxCustomReportLinkOptionsViewClass; override;
  public
    procedure Assign(Source: TPersistent); override;
    property OptionsOnEveryPage
      : TdxCustomTableControlReportLinkOptionsOnEveryPage
      read FOptionsOnEveryPage write SetOptionsOnEveryPage;
    ...
    property OptionsPreview: TdxCustomTableControlReportLinkOptionsPreview
      read FOptionsPreview write SetOptionsPreview;
    property OptionsSelection: TdxCustomTableControlReportLinkOptionsSelection
      read FOptionsSelection write SetOptionsSelection;
    property OptionsView: TdxCustomTableControlReportLinkOptionsView
  ...
  protected
    ...
    procedure InitiateStyle(const ACaption: string; var AStyle: TcxStyle;
      AForceCreation: Boolean);

    property ActiveStyleSheet: TcxCustomStyleSheet read GetActiveStyleSheet
      write SetActiveStyleSheet;
    property AreNativeStylesAvailable: Boolean read GetAreNativeStylesAvailable;
    property DesignerTabIndex: Integer read GetDesignerTabIndex
      write SetDesignerTabIndex;
    property ReportLink: TdxCustomcxControlReportLink read GetReportLink;
  ...
  protected
    ...
    procedure CalculateStyleBarViewInfo(const R: TRect;
  ...
  protected
    ...
    procedure DoMeasureItem(AControl: TcxListBox; AIndex: Integer;
    ...
    procedure CalculateStyleBarViewInfoSizes(AnIndex: Integer; const R: TRect;
      ...
      var AViewInfo: TdxStyleBarViewInfo); virtual;
    procedure CalculateStyleBarViewInfoViewParams(const ACaption: string;
      AStyle: TcxStyle; const R: TRect; ASelected: Boolean;
      var AViewInfo: TdxStyleBarViewInfo); virtual;
    procedure CalculateStyleBarViewInfo(const ACaption: string;
    ...
    function GetStyleBarItemTextColor(ASelected: Boolean;
      AColor, ABkColor: TColor): TColor; virtual;
    function GetStyleFontByText(const AText: string; out AFont: TFont;
      out AScaleFactor: TdxScaleFactor): Boolean;
    ...
    property HotTrackStyleIndex: Integer read FHotTrackStyleIndex
      write FHotTrackStyleIndex;
    property HotTrackStyleName: string read GetHotTrackStyleName;
    property ToolTipsBounds: TRect read GetToolTipsBounds;
    property ToolTipsWindow: TdxStylesListBoxToolTipsWindow
      read FToolTipsWindow;
  public
    constructor Create(AOwner: TComponent); override;
    function IndexOfStyle(AStyle: TcxStyle): Integer;
    procedure HideToolTips;
    //
    property ReportLinkStyles: TdxCustomReportLinkStyles read FReportLinkStyles
      write SetReportLinkStyles;
    property StyleLookAndFeelPainter: TcxCustomLookAndFeelPainter
      read GetStyleLookAndFeelPainter;
...
function cxBlobEditProperties_GetEditKind(AProperties: TcxCustomEditProperties)
  : TcxBlobEditKind;
function cxBlobEditProperties_GetPaintStyle(AProperties
  : TcxCustomEditProperties): TcxBlobPaintStyle;

function cxButtonGroupProperties_GetColumnCount(AProperties
  : TcxCustomEditProperties): Integer;
function cxButtonGroupProperties_GetItems(AProperties: TcxCustomEditProperties)
  : TcxButtonGroupItems;

function cxCheckBoxProperties_GetAlignment(AProperties: TcxCustomEditProperties)
  : TAlignment;
function cxCheckBoxProperties_GetGlyph(AProperties: TcxCustomEditProperties)
  : TdxSmartGlyph;
function cxCheckBoxProperties_GetGlyphCount(AProperties
  : TcxCustomEditProperties): Integer;
function cxCheckBoxProperties_GetIsMultilined(AProperties
  : TcxCustomEditProperties): Boolean;
function cxCheckBoxProperties_GetNullStyle(AProperties: TcxCustomEditProperties)
  : TcxCheckBoxNullValueShowingStyle;

function cxCurrencyProperties_GetNullString(AProperties
  : TcxCustomEditProperties): string;

function cxEditProperties_GetAlignment(AProperties: TcxCustomEditProperties)
  : TcxEditAlignment;

function cxHyperLinkEditProperties_GetLinkColor(AProperties
  : TcxCustomEditProperties): TColor;

function cxMemoProperties_GetAlignment(AProperties: TcxCustomEditProperties)
  : TAlignment;
function cxMemoProperties_GetWordWrap(AProperties
  : TcxCustomEditProperties): Boolean;

function cxImageComboBoxProperties_GetDefaultDescription
  (AProperties: TcxCustomEditProperties): string;
function cxImageComboBoxProperties_GetDefaultImageIndex
  (AProperties: TcxCustomEditProperties): Integer;
function cxImageComboBoxProperties_FindItemByValue
  (AProperties: TcxCustomEditProperties; const AValue: TcxEditValue)
  : TcxImageComboBoxItem;
function cxImageComboBoxProperties_GetImageAlignment
  (AProperties: TcxCustomEditProperties): TcxImageAlign;
function cxImageComboBoxProperties_GetImages(AProperties
  : TcxCustomEditProperties): TCustomImageList;
function cxImageComboBoxProperties_GetIsMultilined
  (AProperties: TcxCustomEditProperties): Boolean;
function cxImageComboBoxProperties_GetItems(AProperties
  : TcxCustomEditProperties): TcxImageComboBoxItems;
function cxImageComboBoxProperties_GetShowDescription
  (AProperties: TcxCustomEditProperties): Boolean;

function cxImageProperties_GetCaption(AProperties
  : TcxCustomEditProperties): string;
function cxImageProperties_GetCenter(AProperties
  : TcxCustomEditProperties): Boolean;
function cxImageProperties_GetProportional(AProperties
  : TcxCustomEditProperties): Boolean;
function cxImageProperties_GetStretch(AProperties
  : TcxCustomEditProperties): Boolean;
function cxImageProperties_GetGraphicClass(AProperties: TcxCustomEditProperties;
  ARecordIndex: Integer; AOwner: TObject = nil): TGraphicClass;

function cxRadioGroupProperties_GetDisplayText(AProperties
  : TcxCustomEditProperties; const AValue: TcxEditValue): string;

function cxTextEditProperties_GetDisplayText(AProperties
  : TcxCustomTextEditProperties; const AValue: TcxEditValue;
  AInplace: Boolean): string;

{ Utilities }

function dxPSDataMaps: TdxPSDataMaps;
procedure dxPSDrawStyleBar(ACanvas: TCanvas; R: TRect;
  const AViewInfo: TdxStyleBarViewInfo);
function dxPSMakecxGridLines(AHorizontal, AVertical: Boolean): TcxGridLines;
function dxPSMeasureTextWidth(ACanvas: TdxPSReportRenderCustomCanvas;
...
const
  ...
  CellSidesMap: array [TcxGridLines] of TdxCellSides = (csAll, [], csLeftRight,
    csTopBottom);
  EdgeStyleMap: array [Boolean] of TdxCheckButtonEdgeStyle = (cbes3D,
    cbesUltraFlat);
  EditTextAlignXMap: array [TcxEditHorzAlignment] of TcxTextAlignX = (taLeft,
    taRight, taCenterX);
  EditTextAlignYMap: array [TcxEditVertAlignment] of TcxTextAlignY = (taTop,
    taBottom, taCenterY);
  ...
  ImageLayoutMap: array [TcxImageAlign] of TdxImageLayout = (ilImageCenterLeft,
    ilImageCenterRight);
  TextAlignXMap: array [TAlignment] of TcxTextAlignX = (taLeft, taRight,
    taCenterX);
  TextAlignYMap: array [TcxAlignmentVert] of TcxTextAlignY = (taTop, taBottom,
    taCenterY);

implementation

uses
  Themes, Variants, SysUtils, Forms, Math, dxThemeManager, cxContainer,
  cxVariants,
  cxDataUtils, dxPSUtl, dxPSEngn, dxPSImgs, dxExtCtrls, dxDPIAwareUtils,
  dxCoreGraphics, cxEditUtils, StrUtils;
...
function cxStyles_GetStyleSheet(AInstance: TcxCustomStyles)
  : TcxCustomStyleSheet;
begin
  Result := TcxCustomStylesAccess(AInstance).StyleSheet;
end;

procedure cxStyles_SetStyleSheet(AInstance: TcxCustomStyles;
  Value: TcxCustomStyleSheet);
begin
...
function cxImageComboBoxProperties_GetDefaultDescription
  (AProperties: TcxCustomEditProperties): string;
begin
  Result := TcxCustomImageComboBoxPropertiesAccess(AProperties)
    .DefaultDescription;
end;
...
function cxImageProperties_GetTransparency(AProperties: TcxCustomEditProperties)
...
begin
  ...
  Result := TcxCustomImagePropertiesAccess(AProperties).GetGraphicClass(AOwner,
    ARecordIndex);
end;
...
function cxRadioGroupProperties_GetDisplayText(AProperties
  : TcxCustomEditProperties; const AValue: TcxEditValue): string;
begin
  Result := TcxCustomRadioGroupPropertiesAccess(AProperties)
    .GetDisplayText(AValue, True);
end;
...
function cxOffice11LookAndFeelPainter_GetHeaderTopColor
  (APainter: TcxCustomLookAndFeelPainter): TColor;
begin
...
procedure dxPSDrawStyleBar(ACanvas: TCanvas; R: TRect;
  ...
  begin
    ...
    Y := AViewInfo.StyleCaptionBoxBounds.Top +
      (cxRectHeight(AViewInfo.StyleCaptionBoxBounds) -
      cxTextHeight(ACanvas.Handle)) div 2;

    ACanvas.TextRect(AViewInfo.StyleCaptionBoxBounds, X, Y,
      AViewInfo.StyleCaption);
  end;
  ...
  begin
    ...
    begin
      ...
      SetBrushOrgEx(ACanvas.Handle, AViewInfo.StyleBitmapOrg.X,
        AViewInfo.StyleBitmapOrg.Y, @APrevBrushOrg);
    end;
    ...
    ARegion := dxPSUtl.ExcludeClipRect(ACanvas.Handle,
      AViewInfo.StyleColorBoxContentBounds);
    try
      ACanvas.Brush.Color := AViewInfo.BarColor;
  ...
  begin
    ...
    ACanvas.Font.Height := AViewInfo.ScaleFactor.Apply(ACanvas.Font.Height,
      AViewInfo.StyleFontScaleFactor);
    ACanvas.Font.Color := AViewInfo.StyleTextColor;

    X := AViewInfo.StyleFontInfoBoxBounds.Left + AViewInfo.ScaleFactor.Apply(1);
    Y := AViewInfo.StyleFontInfoBoxBounds.Top +
      (cxRectHeight(AViewInfo.StyleFontInfoBoxBounds) -
      cxTextHeight(ACanvas.Handle)) div 2;

    ACanvas.TextRect(AViewInfo.StyleFontInfoBoxBounds, X, Y,
      dxPSUtl.FormatFontInfo(AViewInfo.StyleFont));
  end;
...
procedure dxPSGetViewParams(AStyle: TcxStyle; const AStyleName: string;
  AStyles: TdxCustomReportLinkStyles; out AParams: TcxViewParams;
  out AParamsScaleFactor: TdxScaleFactor);
begin
...
function TdxPSDataMaps.DoesItemParticipateInAutoHeightCalculation
  (AProperties: TcxCustomEditProperties): Boolean;
begin
  Result := MapClasses[AProperties].DoesItemParticipateInAutoHeightCalculation
    (AProperties);
end;

function TdxPSDataMaps.DoesItemParticipateInAutoWidthCalculation
  (AProperties: TcxCustomEditProperties): Boolean;
begin
  Result := MapClasses[AProperties].DoesItemParticipateInAutoWidthCalculation
    (AProperties);
end;

function TdxPSDataMaps.DoesItemParticipateInBestFitCalculation
  (AProperties: TcxCustomEditProperties): Boolean;
begin
  Result := MapClasses[AProperties].DoesItemParticipateInBestFitCalculation
    (AProperties);
end;
...
procedure TdxPSDataMaps.InitializeItem(AnItem: TAbstractdxReportCellData;
  ...
  AnIsPreview: Boolean = False; ARecordIndex: Integer = 0;
  AOwner: TObject = nil);
begin
  MapClasses[AProperties].InitializeItem(AnItem, AProperties, AValue,
    ACellParams, AViewParams, AnIsPreview, ARecordIndex, AOwner);
end;
...
function TdxPSDataMaps.ItemClass(AProperties: TcxCustomEditProperties;
  const AViewParams: TdxReportItemViewParams; AIsPreview: Boolean)
  : TdxReportCellDataClass;
begin
  Result := MapClasses[AProperties].ItemClass(AProperties, AViewParams,
    AIsPreview);
end;
...
begin
  Result := MapClasses[AProperties].MeasureWidth(AProperties, AValue,
    ACellParams, AFont, ARecordIndex);
end;

function TdxPSDataMaps.GetMapClass(Properties: TcxCustomEditProperties)
  : TdxPSDataMapClass;
begin
...
class function TdxPSCustomDataMap.DoesItemParticipateInAutoHeightCalculation
  (AProperties: TcxCustomEditProperties): Boolean;
begin
  Result := True;
end;

class function TdxPSCustomDataMap.DoesItemParticipateInAutoWidthCalculation
  (AProperties: TcxCustomEditProperties): Boolean;
begin
  Result := True;
end;

class function TdxPSCustomDataMap.DoesItemParticipateInBestFitCalculation
  (AProperties: TcxCustomEditProperties): Boolean;
begin
  Result := True;
end;

class procedure TdxPSCustomDataMap.GetImageLists(AProperties
  : TcxCustomEditProperties; AProc: TdxPSGetImageListProc);
begin
end;
...
class procedure TdxPSCustomDataMap.InitializeItem
...
class function TdxPSCustomDataMap.ItemClass(AProperties
  : TcxCustomEditProperties; AIsPreview: Boolean = False)
  : TdxReportCellDataClass;
begin
...
class function TdxPSCustomDataMap.ItemClass(AProperties
  : TcxCustomEditProperties; const AViewParams: TdxReportItemViewParams;
  AIsPreview: Boolean = False): TdxReportCellDataClass;
begin
  Result := ItemClass(AProperties, AIsPreview);
end;

class function TdxPSCustomDataMap.MeasureWidth(AProperties
  : TcxCustomEditProperties; const AValue: TcxEditValue;
  const ACellParams: IdxPSCellParams; AFont: TFont;
  ARecordIndex: Integer = 0): Integer;
begin
  Result := 0;
  if HasText(AProperties, AValue) then
    Result := dxPSMeasureTextWidth(ACellParams.Canvas,
      GetText(AProperties, AValue), AFont);
end;
...
class function TdxPSTextDataMap.GetText(AProperties: TcxCustomEditProperties;
  const AValue: TcxEditValue): string;
begin
  Result := cxTextEditProperties_GetDisplayText
    (TcxCustomTextEditProperties(AProperties), AValue, True);
end;

class procedure TdxPSTextDataMap.InitializeItem
  (AnItem: TAbstractdxReportCellData; AProperties: TcxCustomEditProperties;
  const AValue: TcxEditValue; const ACellParams: IdxPSCellParams;
  var AViewParams: TdxReportItemViewParams; AnIsPreview: Boolean = False;
  ARecordIndex: Integer = 0; AOwner: TObject = nil);

  procedure GetPreviewParams(out ALeftIndent, ARightIndent,
...
begin
  ...
  begin
    ...
    TextAlignX := EditTextAlignXMap
      [cxEditProperties_GetAlignment(AProperties).Horz];
    if AnIsPreview then
      TextAlignY := taTop
    else
      TextAlignY := EditTextAlignYMap
        [cxEditProperties_GetAlignment(AProperties).Vert];
  end;
  if AnIsPreview then
  begin
...
class function TdxPSTextDataMap.ItemClass(AProperties: TcxCustomEditProperties;
  AnIsPreview: Boolean = False): TdxReportCellDataClass;
const
  ItemClasses: array [Boolean] of TdxReportCellDataClass = (TdxReportCellString,
    TdxReportCellPreviewText);
begin
...
class function TdxPSMemoDataMap.DoesItemParticipateInAutoWidthCalculation
  (AProperties: TcxCustomEditProperties): Boolean;
begin
  Result := not cxMemoProperties_GetWordWrap(AProperties);
end;

class function TdxPSMemoDataMap.DoesItemParticipateInBestFitCalculation
  (AProperties: TcxCustomEditProperties): Boolean;
begin
  Result := False;
end;

class procedure TdxPSMemoDataMap.InitializeItem
  (AnItem: TAbstractdxReportCellData; AProperties: TcxCustomEditProperties;
  const AValue: TcxEditValue; const ACellParams: IdxPSCellParams;
  var AViewParams: TdxReportItemViewParams; AnIsPreview: Boolean = False;
  ARecordIndex: Integer = 0; AOwner: TObject = nil);
...
class procedure TdxPSHyperLinkDataMap.InitializeItem
  (AnItem: TAbstractdxReportCellData; AProperties: TcxCustomEditProperties;
  const AValue: TcxEditValue; const ACellParams: IdxPSCellParams;
  var AViewParams: TdxReportItemViewParams; AnIsPreview: Boolean = False;
  ARecordIndex: Integer = 0; AOwner: TObject = nil);
begin
  ...
  AViewParams.NativeParams.TextColor := cxHyperLinkEditProperties_GetLinkColor
    (AProperties);
end;

class function TdxPSHyperLinkDataMap.PropertiesClass
...
class procedure TdxPSCheckDataMap.InitializeItem
  (AnItem: TAbstractdxReportCellData; AProperties: TcxCustomEditProperties;
  const AValue: TcxEditValue; const ACellParams: IdxPSCellParams;
  var AViewParams: TdxReportItemViewParams; AnIsPreview: Boolean = False;
  ARecordIndex: Integer = 0; AOwner: TObject = nil);
...
begin
  ...
  AImage.Checked := (ACheckDisplayValue = Integer(cbsChecked)) or
    ((ACheckDisplayValue = Integer(cbsGrayed)) and
    (ACheckNullStyle = nssGrayedChecked));
  AImage.Enabled := not((ACheckDisplayValue = Integer(cbsGrayed)) and
    (ACheckNullStyle in [nssInactive, nssGrayedChecked]));
  ...
  AImage.TextAlignX := dxTextAlignX
    [cxCheckBoxProperties_GetAlignment(AProperties)];
...
class function TdxPSCheckDataMap.MeasureWidth(AProperties
  : TcxCustomEditProperties; const AValue: TcxEditValue;
  const ACellParams: IdxPSCellParams; AFont: TFont;
  ARecordIndex: Integer = 0): Integer;
begin
...
class procedure TdxPSToggleSwitchDataMap.InitializeItem
  (AnItem: TAbstractdxReportCellData; AProperties: TcxCustomEditProperties;
  const AValue: TcxEditValue; const ACellParams: IdxPSCellParams;
  ...
  begin
    ...
    try
      ...
      try
        ...
        AViewData.Calculate(ABitmap.cxCanvas,
          cxRectInflate(cxRectSetNullOrigin(AnItem.BoundsRect), -2, -2),
          Point(0, 0), cxmbNone, [], AViewInfo, False);
...
class function TdxPSToggleSwitchDataMap.PropertiesClass
  : TcxCustomEditPropertiesClass;
begin
...
class procedure TdxSparklineDataMap.InitializeItem
  (AnItem: TAbstractdxReportCellData; AProperties: TcxCustomEditProperties;
  const AValue: TcxEditValue; const ACellParams: IdxPSCellParams;
  var AViewParams: TdxReportItemViewParams; AnIsPreview: Boolean = False;
  ARecordIndex: Integer = 0; AOwner: TObject = nil);
begin
  ...
  begin
    TdxReportCellSparklineImage(AnItem).ViewData :=
      AProperties.CreateViewData(DefaultEditStyleController.Style, True);
    TdxReportCellSparklineImage(AnItem).ViewInfo :=
      AProperties.GetViewInfoClass.Create as TdxSparkLineViewInfo;
    TdxReportCellSparklineImage(AnItem).Transparent := True;
    TdxReportCellSparklineImage(AnItem).ViewData.EditValueToDrawValue(AValue,
      TdxReportCellSparklineImage(AnItem).ViewInfo);
  end;
  inherited;
...
class function TdxSparklineDataMap.ItemClass(AProperties
  : TcxCustomEditProperties; AnIsPreview: Boolean): TdxReportCellDataClass;
begin
  Result := TdxReportCellSparklineImage;
end;

class function TdxSparklineDataMap.PropertiesClass
  : TcxCustomEditPropertiesClass;
begin
...
class procedure TdxTokenEditDataMap.InitializeItem
  (AnItem: TAbstractdxReportCellData; AProperties: TcxCustomEditProperties;
  const AValue: TcxEditValue; const ACellParams: IdxPSCellParams;
  var AViewParams: TdxReportItemViewParams; AnIsPreview: Boolean;
  ARecordIndex: Integer; AOwner: TObject);
...
begin
  ...
  begin
    ...
    try
      ...
      InitializeItem(AnItem, AProperties, AValue, ACellParams, AViewParams,
        AnIsPreview, ARecordIndex, AOwner);
    finally
      AProperties.Free;
    end;
  end
...
class function TdxTokenEditDataMap.ItemClass(AProperties
  : TcxCustomEditProperties; AnIsPreview: Boolean): TdxReportCellDataClass;
begin
  Result := TdxReportCellTokens;
end;

class function TdxTokenEditDataMap.PropertiesClass
  : TcxCustomEditPropertiesClass;
begin
...
class function TdxTokenEditDataMap.CalculateViewInfo
  (AProperties: TcxCustomEditProperties; ABounds: TRect;
  const AValue: TcxEditValue): TdxTokenEditViewInfo;
var
  AViewData: TdxTokenEditViewData;
begin
  AViewData := AProperties.CreateViewData(DefaultEditStyleController.Style,
    True) as TdxTokenEditViewData;
  try
    Result := AProperties.GetViewInfoClass.Create as TdxTokenEditViewInfo;
    Result.UpdateEditValue(AValue);
    try
      AViewData.Calculate(cxScreenCanvas, cxRectSetHeight(ABounds,
        cxMaxRectSize), cxInvalidPoint, cxmbNone, [], Result, False);
    finally
...
class function TdxPSCustomButtonGroupDataMap.ButtonGroupClass
  (AProperties: TcxCustomEditProperties): TdxCustomReportButtonGroupClass;
begin
  Result := TdxCustomReportButtonGroup;
end;

class procedure TdxPSCustomButtonGroupDataMap.InitializeGroupButton
  (AProperties: TcxCustomEditProperties; const AValue: TcxEditValue;
...
class function TdxPSCustomButtonGroupDataMap.ItemClass
  (AProperties: TcxCustomEditProperties; AnIsPreview: Boolean = False)
  : TdxReportCellDataClass;
begin
...
begin
  ...
  begin
    ...
    begin
      ...
      Inc(Result, (GroupColumnCount - 1) *
        dxPSCore.dxRadioGroupInterColumnsMinSpace);
      Inc(Result, dxPSCore.dxRadioGroupBoundsIndent +
        dxPSCore.dxRadioGroupBoundsIndent);
    end;
  end;
end;

class function TdxPSCustomButtonGroupDataMap.PropertiesClass
  : TcxCustomEditPropertiesClass;
begin
...
class function TdxPSRadioButtonGroupDataMap.ButtonGroupClass
  (AProperties: TcxCustomEditProperties): TdxCustomReportButtonGroupClass;
begin
  Result := TdxReportRadioGroup;
end;

class procedure TdxPSRadioButtonGroupDataMap.InitializeItem
  (AnItem: TAbstractdxReportCellData; AProperties: TcxCustomEditProperties;
  const AValue: TcxEditValue; const ACellParams: IdxPSCellParams;
  var AViewParams: TdxReportItemViewParams; AnIsPreview: Boolean = False;
  ARecordIndex: Integer = 0; AOwner: TObject = nil);
begin
  ...
  with TdxReportRadioGroup(AnItem) do
    ItemIndex := FindItem(cxRadioGroupProperties_GetDisplayText
      (AProperties, AValue));
end;

class function TdxPSRadioButtonGroupDataMap.PropertiesClass
  : TcxCustomEditPropertiesClass;
begin
...
class function TdxPSGraphicDataMap.DoesItemParticipateInAutoHeightCalculation
  (AProperties: TcxCustomEditProperties): Boolean;
begin
...
class function TdxPSGraphicDataMap.GetGraphic(AProperties
  : TcxCustomEditProperties; AGraphicClass: TGraphicClass;
  const AValue: TcxEditValue): TGraphic;
begin
...
class function TdxPSGraphicDataMap.GetGraphicClass
  (AProperties: TcxCustomEditProperties; ARecordIndex: Integer;
  AOwner: TObject = nil): TGraphicClass;
begin
  Result := cxImageProperties_GetGraphicClass(AProperties,
    ARecordIndex, AOwner);
  if Result = nil then
    Result := DefaultGraphicClass;
end;

class function TdxPSGraphicDataMap.HasGraphic(const AValue
  : TcxEditValue): Boolean;
begin
  Result := dxVarIsBlob(AValue);
end;

class procedure TdxPSGraphicDataMap.InitializeItem
  (AnItem: TAbstractdxReportCellData; AProperties: TcxCustomEditProperties;
  const AValue: TcxEditValue; const ACellParams: IdxPSCellParams;
  var AViewParams: TdxReportItemViewParams; AnIsPreview: Boolean = False;
  ARecordIndex: Integer = 0; AOwner: TObject = nil);
...
begin
  ...
  AItem.ImageTransparent := AIsIcon or ACellParams.TransparentGraphics or
    (cxImageProperties_GetTransparency(AProperties) = gtTransparent);
  AItem.Stretch := (AGraphicClass <> nil) and not AIsIcon and
    cxImageProperties_GetStretch(AProperties);
  AItem.Proportional := (AGraphicClass <> nil) and not AIsIcon and
    cxImageProperties_GetProportional(AProperties);
end;

class function TdxPSGraphicDataMap.MeasureWidth(AProperties
  : TcxCustomEditProperties; const AValue: TcxEditValue;
  const ACellParams: IdxPSCellParams; AFont: TFont;
  ARecordIndex: Integer = 0): Integer;
var
...
class function TdxPSGraphicDataMap.ItemClass(AProperties
  : TcxCustomEditProperties; AnIsPreview: Boolean = False)
  : TdxReportCellDataClass;
begin
  Result := TdxReportCellGraphic;
end;

class function TdxPSGraphicDataMap.PropertiesClass
  : TcxCustomEditPropertiesClass;
begin
...
class procedure TdxPSGraphicAsTextDataMap.InitializeItem
  (AnItem: TAbstractdxReportCellData; AProperties: TcxCustomEditProperties;
  const AValue: TcxEditValue; const ACellParams: IdxPSCellParams;
  var AViewParams: TdxReportItemViewParams; AnIsPreview: Boolean = False;
  ARecordIndex: Integer = 0; AOwner: TObject = nil);
...
class function TdxPSGraphicAsTextDataMap.ItemClass
  (AProperties: TcxCustomEditProperties; AnIsPreview: Boolean = False)
  : TdxReportCellDataClass;
begin
  Result := TdxReportCellString;
...
class function TdxPSGraphicAsTextDataMap.MeasureWidth
  (AProperties: TcxCustomEditProperties; const AValue: TcxEditValue;
  const ACellParams: IdxPSCellParams; AFont: TFont;
  ARecordIndex: Integer = 0): Integer;
begin
  Result := dxPSMeasureTextWidth(ACellParams.Canvas,
    ACellParams.GraphicsText, AFont);
end;

class function TdxPSGraphicAsTextDataMap.PropertiesClass
  : TcxCustomEditPropertiesClass;
begin
  Result := TcxCustomImageProperties;
end;
...
class function TdxPSImageDataMap.DoesItemParticipateInBestFitCalculation
  (AProperties: TcxCustomEditProperties): Boolean;
begin
  Result := not IsMultilinedText(AProperties);
end;

class function TdxPSImageDataMap.GetComboBoxItem(AProperties
  : TcxCustomEditProperties; const AValue: TcxEditValue): TcxImageComboBoxItem;
begin
  Result := cxImageComboBoxProperties_FindItemByValue(AProperties, AValue);
end;

class function TdxPSImageDataMap.GetImageIndex(AProperties
  : TcxCustomEditProperties; const AValue: TcxEditValue): Integer;
var
...
class procedure TdxPSImageDataMap.GetImageLists(AProperties
  : TcxCustomEditProperties; AProc: TdxPSGetImageListProc);
begin
  AProc(GetImages(AProperties));
end;

class function TdxPSImageDataMap.GetImages(AProperties: TcxCustomEditProperties)
  : TCustomImageList;
begin
...
class function TdxPSImageDataMap.HasImages(AProperties
  : TcxCustomEditProperties): Boolean;
begin
  Result := GetImages(AProperties) <> nil;
end;

class procedure TdxPSImageDataMap.InitializeItem
  (AnItem: TAbstractdxReportCellData; AProperties: TcxCustomEditProperties;
  const AValue: TcxEditValue; const ACellParams: IdxPSCellParams;
  var AViewParams: TdxReportItemViewParams; AnIsPreview: Boolean = False;
  ARecordIndex: Integer = 0; AOwner: TObject = nil);
begin
  ...
  begin
    ...
    ImageLayout := ImageLayoutMap
      [cxImageComboBoxProperties_GetImageAlignment(AProperties)];
...
class function TdxPSImageDataMap.IsMultilinedText
  (AProperties: TcxCustomEditProperties): Boolean;
begin
...
class function TdxPSImageDataMap.MeasureWidth(AProperties
  : TcxCustomEditProperties; const AValue: TcxEditValue;
  const ACellParams: IdxPSCellParams; AFont: TFont;
  ARecordIndex: Integer = 0): Integer;
begin
  Result := inherited MeasureWidth(AProperties, AValue, ACellParams, AFont,
    ARecordIndex);
...
class function TdxPSDelegateDataMap.DataMapClass(AProperties
  : TcxCustomEditProperties): TdxPSDataMapClass;
begin
  Result := nil;
  { actually should be an abstract method, but C++ syntax does not allow us "static virtual abstract" methods :-( }
end;

class function TdxPSDelegateDataMap.DoesItemParticipateInAutoHeightCalculation
  (AProperties: TcxCustomEditProperties): Boolean;
begin
  Result := DataMapClass(AProperties).DoesItemParticipateInAutoHeightCalculation
    (AProperties);
end;

class function TdxPSDelegateDataMap.DoesItemParticipateInAutoWidthCalculation
  (AProperties: TcxCustomEditProperties): Boolean;
begin
  Result := DataMapClass(AProperties).DoesItemParticipateInAutoWidthCalculation
    (AProperties);
end;

class function TdxPSDelegateDataMap.DoesItemParticipateInBestFitCalculation
  (AProperties: TcxCustomEditProperties): Boolean;
begin
  Result := DataMapClass(AProperties).DoesItemParticipateInBestFitCalculation
    (AProperties);
end;

class procedure TdxPSDelegateDataMap.GetImageLists
  (AProperties: TcxCustomEditProperties; AProc: TdxPSGetImageListProc);
begin
  DataMapClass(AProperties).GetImageLists(AProperties, AProc);
end;

class procedure TdxPSDelegateDataMap.InitializeItem
  (AnItem: TAbstractdxReportCellData; AProperties: TcxCustomEditProperties;
  const AValue: TcxEditValue; const ACellParams: IdxPSCellParams;
  var AViewParams: TdxReportItemViewParams; AnIsPreview: Boolean = False;
  ARecordIndex: Integer = 0; AOwner: TObject = nil);
begin
  DataMapClass(AProperties).InitializeItem(AnItem, AProperties, AValue,
    ACellParams, AViewParams, AnIsPreview, ARecordIndex, AOwner);
end;

class function TdxPSDelegateDataMap.ItemClass(AProperties
  : TcxCustomEditProperties; AnIsPreview: Boolean = False)
  : TdxReportCellDataClass;
begin
...
class function TdxPSDelegateDataMap.MeasureWidth(AProperties
  : TcxCustomEditProperties; const AValue: TcxEditValue;
  const ACellParams: IdxPSCellParams; AFont: TFont;
  ARecordIndex: Integer = 0): Integer;
begin
  Result := DataMapClass(AProperties).MeasureWidth(AProperties, AValue,
    ACellParams, AFont, ARecordIndex);
end;

{ TdxPSBlobDataMap }

class function TdxPSBlobDataMap.DataMapClass(AProperties
  : TcxCustomEditProperties): TdxPSDataMapClass;
const
...
class procedure TdxPSBlobDefaultDataMap.InitializeItem
  (AnItem: TAbstractdxReportCellData; AProperties: TcxCustomEditProperties;
  const AValue: TcxEditValue; const ACellParams: IdxPSCellParams;
  var AViewParams: TdxReportItemViewParams; AnIsPreview: Boolean = False;
  ARecordIndex: Integer = 0; AOwner: TObject = nil);
begin
  ...
  TdxReportCellString(AnItem).Text := cxBlobEdit.GetBlobText(AValue,
    TcxCustomBlobEditProperties(AProperties), False);
end;

{ TdxPSBlobPictureDataMap }

class procedure TdxPSBlobPictureDataMap.GetImageLists
  (AProperties: TcxCustomEditProperties; AProc: TdxPSGetImageListProc);
begin
  AProc(GetBlobImages);
end;

class procedure TdxPSBlobPictureDataMap.InitializeItem
  (AnItem: TAbstractdxReportCellData; AProperties: TcxCustomEditProperties;
  const AValue: TcxEditValue; const ACellParams: IdxPSCellParams;
  var AViewParams: TdxReportItemViewParams; AnIsPreview: Boolean = False;
  ARecordIndex: Integer = 0; AOwner: TObject = nil);
...
begin
  ...
  begin
    ...
    ImageIndex := ImageIndexes[cxBlobEditProperties_GetEditKind(AProperties)] +
      Ord(not cxVariants.VarIsSoftNull(AValue));
    Center := True;
  end;
end;

class function TdxPSBlobPictureDataMap.ItemClass(AProperties
  : TcxCustomEditProperties; AnIsPreview: Boolean = False)
  : TdxReportCellDataClass;
begin
  Result := TdxReportCellGraphic;
...
class function TdxPSBlobPictureDataMap.MeasureWidth
  (AProperties: TcxCustomEditProperties; const AValue: TcxEditValue;
  const ACellParams: IdxPSCellParams; AFont: TFont;
  ARecordIndex: Integer = 0): Integer;
begin
...
class function TdxPSBlobTextDataMap.DoesItemParticipateInAutoWidthCalculation
  (AProperties: TcxCustomEditProperties): Boolean;
begin
  Result := False;
end;

class function TdxPSBlobTextDataMap.DoesItemParticipateInBestFitCalculation
  (AProperties: TcxCustomEditProperties): Boolean;
begin
  Result := False;
end;

class procedure TdxPSBlobTextDataMap.InitializeItem
  (AnItem: TAbstractdxReportCellData; AProperties: TcxCustomEditProperties;
  const AValue: TcxEditValue; const ACellParams: IdxPSCellParams;
  var AViewParams: TdxReportItemViewParams; AnIsPreview: Boolean = False;
  ARecordIndex: Integer = 0; AOwner: TObject = nil);
...
procedure TdxReportCellPreviewText.DrawText
...
begin
  ...
  if not IsRectEmpty(R) then
    Renderer.DrawTextEx(ACanvas, R, MaxLineCount, GetText, Font, DTFormat,
      Indents.Rect);
end;
...
begin
  ...
  begin
    ...
    try
      ...
      ViewData.Calculate(AImage.cxCanvas, R, Point(0, 0), cxmbNone, [],
        ViewInfo, False);
...
constructor TdxPSFormattedTextPainter.Create
  (ACanvas: TdxPSReportRenderCustomCanvas);
begin
  inherited Create;
  FPSCanvas := ACanvas;
...
procedure TdxPSFormattedTextPainter.ExtTextOut(const ABounds: TRect;
  AFontHandle: THandle; AFontColor: TColor; const AText: string;
  AGlyphs: PdxWordArray; AGlyphCount: Integer; AGlyphWidths: PdxIntegerArray);
begin
  FFont.Handle := CreateFontIndirect(dxGetFontData(AFontHandle));
  FFont.Color := AFontColor;
  FPSCanvas.ExtTextOut(ABounds, FFont, AText, @AGlyphs[0], AGlyphCount,
    @AGlyphWidths[0]);
end;

procedure TdxPSFormattedTextPainter.FillRect(const ARect: TRect;
  AColor: TColor);
begin
...
procedure TdxReportCellFormattedLabel.DrawText
  (ACanvas: TdxPSReportRenderCustomCanvas);
var
...
begin
  ...
  try
    ...
    CalculateTextLayout(AFormattedText, ARect,
      PixelsNumerator / PixelsDenominator);
...
function TdxReportCellFormattedLabel.MeasureTextHeight
  (ACanvas: TdxPSReportRenderCustomCanvas): Integer;
begin
  Result := GetTextSize.cy;
end;

function TdxReportCellFormattedLabel.MeasureTextWidth
  (ACanvas: TdxPSReportRenderCustomCanvas): Integer;
begin
  Result := GetTextSize.cx;
end;

function TdxReportCellFormattedLabel.MeasureHeight
  (ACanvas: TdxPSReportRenderCustomCanvas): Integer;
begin
  Result := inherited MeasureHeight(ACanvas) + cxMarginsHeight(Indents.Rect);
end;

function TdxReportCellFormattedLabel.MeasureWidth
  (ACanvas: TdxPSReportRenderCustomCanvas): Integer;
begin
...
const
  ...
  AlignmentsHorzToFlag: array [TcxTextAlignX] of Integer = (CXTO_LEFT,
    CXTO_CENTER_HORIZONTALLY, CXTO_RIGHT, CXTO_JUSTIFY_HORIZONTALLY,
    CXTO_DISTRIBUTE_HORIZONTALLY);
  AlignmentsVertToFlag: array [TcxTextAlignY] of Integer = (CXTO_TOP,
    CXTO_CENTER_VERTICALLY, CXTO_BOTTOM, CXTO_DISTRIBUTE_VERTICALLY);
begin
  Result := AlignmentsHorzToFlag[TextAlignX] or AlignmentsVertToFlag[TextAlignY]
    or EndEllipsysToFlag[EndEllipsis] or MultilineToFlag[Multiline] or
    SingleLineToFlag[SingleLine] or CharbreakToFlag[BreakByChars] or
    NoClipToFlag[NoClip];
end;

procedure TdxReportCellFormattedLabel.CalculateTextLayout(AFormattedText
  : TdxFormattedText; var ARect: TRect; AZoomFactor: Single);
begin
  ...
  try
    AFormattedText.CalculateLayout(cxScreenCanvas.Canvas, Font, ARect,
      GetTextOutTextFlag, nil, AZoomFactor);
  finally
...
begin
  ...
  try
    ...
    ARect := cxRectContent(BoundsRect, Indents.Rect);
    AFormattedText.CalculateLayout(cxScreenCanvas.Canvas, Font, ARect,
      GetTextOutTextFlag or CXTO_NOCLIP);
    cxScreenCanvas.Dormant;
...
class procedure TdxPSFormattedLabelDataMap.InitializeItem
  (AnItem: TAbstractdxReportCellData; AProperties: TcxCustomEditProperties;
  const AValue: TcxEditValue; const ACellParams: IdxPSCellParams;
  var AViewParams: TdxReportItemViewParams; AnIsPreview: Boolean = False;
  ARecordIndex: Integer = 0; AOwner: TObject = nil);
const
  AlignmentHorzToTextAlignX: array [TcxEditHorzAlignment] of TcxTextAlignX =
    (taLeft, taRight, taCenterX);
  AlignmentVertToTextAlignY: array [TcxEditVertAlignment] of TcxTextAlignY =
...
begin
  ...
  begin
    ...
    AItem.TextAlignX := AlignmentHorzToTextAlignX
      [AFormattedLabelProperties.Alignment.Horz];
    AItem.TextAlignY := AlignmentVertToTextAlignY
      [AFormattedLabelProperties.Alignment.Vert];
...
class function TdxPSFormattedLabelDataMap.ItemClass
  (AProperties: TcxCustomEditProperties; AnIsPreview: Boolean = False)
  : TdxReportCellDataClass;
begin
...
class function TdxPSFormattedLabelDataMap.PropertiesClass
  : TcxCustomEditPropertiesClass;
begin
...
begin
  ...
  else if ASource is TdxTokenEditTokenViewInfo then
...
begin
  ...
  begin
    ...
    if (FGlyph <> nil) and not cxRectIsEmpty(FGlyphBounds) then
      ACanvas.DrawPicture(FGlyph, FGlyphBounds, ppmStretch, PixelsNumerator,
        PixelsDenominator);
    ...
    begin
      ...
      try
        ...
        ACanvas.DrawText(FTextBounds, FText, AHelper.Font,
          FOwner.DefaultDTFormat);
      finally
        AHelper.Free;
      end;
    end;
...
procedure TdxReportCellToken.AssignFromTokenItem
  (ASource: TdxTokenEditTokenViewInfo);
var
    ...
    try
      ...
      try
        ...
        try
          ...
          TdxTokenEditTokenViewInfoAccess(ASource).DrawGlyph(cxPaintCanvas,
            AImage.ClientRect);
        finally
...
procedure TdxReportCellTokens.ConvertCoords(APixelsNumerator, APixelsDenominator
  : Integer);
var
  I: Integer;
begin
...
procedure TdxReportCellTokens.DrawContent
...
begin
  ...
  begin
    ...
    try
      ...
      ADelta := MeasureContentHeight(ACanvas) -
        cxRectHeight(GetInnerBounds(ACanvas));
      if ADelta < 0 then
...
function TdxReportCellTokens.MeasureContentHeight
  (ACanvas: TdxPSReportRenderCustomCanvas): Integer;
begin
...
function TdxReportCellTokens.MeasureContentWidth
  (ACanvas: TdxPSReportRenderCustomCanvas): Integer;
var
  I: Integer;
begin
...
class function TdxCustomReportLinkStyles.GetStyleCaption
  (AnIndex: Integer): string;
begin
  Result := '';
end;

function TdxCustomReportLinkStyles.GetStyleByCaption(const Caption: string)
  : TcxStyle;
var
  Index: Integer;
begin
...
procedure TdxCustomReportLinkStyles.SetStyleByCaption(const Caption: string;
  Value: TcxStyle);
var
  Index: Integer;
begin
...
constructor TdxCustomReportLinkOptions.Create(AReportLink
...
{ IUnknown }
function TdxCustomReportLinkOptions.QueryInterface(const IID: TGUID;
  out Obj): HRESULT;
begin
...
begin
  if ReportLink <> nil then
    ReportLink.OptionsChanged(Self);
end;

procedure TdxCustomReportLinkOptions.Notification(AComponent: TComponent;
...
procedure TdxCustomReportLinkOptionsFormatting.SetLookAndFeelKind
  (Value: TcxLookAndFeelKind);
begin
  if Value = lfOffice11 then
    Value := lfFlat;
...
procedure TdxCustomReportLinkOptionsFormatting.SetSuppressBackgroundBitmaps
  (Value: Boolean);
begin
...
procedure TdxCustomReportLinkOptionsFormatting.SetUseLookAndFeelColors
  (Value: Boolean);
begin
  if FUseLookAndFeelColors <> Value then
  begin
    FUseLookAndFeelColors := Value;
    if dxThemeManager.AreVisualStylesAvailable then
      Changed;
  end;
end;

procedure TdxCustomReportLinkOptionsFormatting.SetUseNativeStyles
  (Value: Boolean);
begin
...
constructor TdxCustomReportLinkOptionsRefinements.Create
  (AReportLink: TdxCustomcxControlReportLink);
begin
  inherited;
...
begin
  inherited;
  Filer.DefineProperty('IsGraphicsAsTextAssigned', ReadIsGraphicsTextAssigned,
    WriteIsGraphicsTextAssigned, FIsGraphicsTextAssigned and
    (GraphicsText = ''));
end;
...
procedure TdxCustomReportLinkOptionsRefinements.SetDisplayGraphicsAsText
  (Value: Boolean);
begin
...
procedure TdxCustomReportLinkOptionsRefinements.SetDisplayTrackBarsAsText
  (Value: Boolean);
begin
...
procedure TdxCustomReportLinkOptionsRefinements.SetFlatCheckMarks
  (Value: Boolean);
begin
...
procedure TdxCustomReportLinkOptionsRefinements.SetGraphicsText
  (const Value: string);
begin
...
procedure TdxCustomReportLinkOptionsRefinements.SetTransparentGraphics
  (Value: Boolean);
begin
...
procedure TdxCustomReportLinkOptionsRefinements.SetTransparentRichEdits
  (Value: Boolean);
begin
...
procedure TdxCustomReportLinkOptionsRefinements.ReadIsGraphicsTextAssigned
  (Reader: TReader);
begin
  FIsGraphicsTextAssigned := Reader.ReadBoolean;
end;

procedure TdxCustomReportLinkOptionsRefinements.WriteIsGraphicsTextAssigned
  (Writer: TWriter);
begin
...
procedure TdxCustomcxControlReportLink.Notification(AComponent: TComponent;
  Operation: TOperation);
begin
  inherited;
  if not(csDestroying in ComponentState) and (Operation = opRemove) and
    (AComponent = StyleRepository) then
    StyleRepository := nil;
...
procedure TdxCustomcxControlReportLink.GetImageLists
  (AProc: TdxPSGetImageListProc);
var
  I: Integer;
begin
...
function TdxCustomcxControlReportLink.IsSupportedCustomDraw
  (Item: TAbstractdxReportCellData): Boolean;
begin
  Result := SupportedCustomDraw;
end;

procedure TdxCustomcxControlReportLink.MakeDelimiters
...
procedure TdxCustomcxControlReportLink.AddHorizontalDelimiter
...
procedure TdxCustomcxControlReportLink.AddVerticalDelimiter
  (ADelimiter: TdxReportCell);
var
  R: TRect;
begin
...
function TdxCustomcxControlReportLink.GetOptionsExpandingClass
  : TdxCustomReportLinkOptionsExpandingClass;
begin
  Result := TdxCustomReportLinkOptionsExpanding;
end;

function TdxCustomcxControlReportLink.GetOptionsFormattingClass
  : TdxCustomReportLinkOptionsFormattingClass;
begin
  Result := TdxCustomReportLinkOptionsFormatting;
end;

function TdxCustomcxControlReportLink.GetOptionsPaginationClass
  : TdxCustomReportLinkOptionsPaginationClass;
begin
  Result := TdxCustomReportLinkOptionsPagination;
end;

function TdxCustomcxControlReportLink.GetOptionsRefinementsClass
  : TdxCustomReportLinkOptionsRefinementsClass;
begin
  Result := TdxCustomReportLinkOptionsRefinements;
end;

function TdxCustomcxControlReportLink.GetOptionsSizeClass
  : TdxCustomReportLinkOptionsSizeClass;
begin
  Result := TdxCustomReportLinkOptionsSize;
end;

function TdxCustomcxControlReportLink.GetOptionsViewClass
  : TdxCustomReportLinkOptionsViewClass;
begin
  Result := TdxCustomReportLinkOptionsView;
end;

procedure TdxCustomcxControlReportLink.OptionsChanged
  (AnOptions: TdxCustomReportLinkOptions);
begin
  LinkModified(True);
end;

procedure TdxCustomcxControlReportLink.AddOptions
  (AnOptions: TdxCustomReportLinkOptions);
begin
  FOptions.Remove(AnOptions);
end;

procedure TdxCustomcxControlReportLink.NotifyOptions(AComponent: TComponent;
  AOperation: TOperation);
var
  I: Integer;
begin
...
procedure TdxCustomcxControlReportLink.RemoveOptions
  (AnOptions: TdxCustomReportLinkOptions);
begin
  FOptions.Add(AnOptions);
end;

procedure TdxCustomcxControlReportLink.AppendImageList
...
function TdxCustomcxControlReportLink.CreateStyle(const ACaption: string)
  : TcxStyle;
begin
  Result := GetStyleRepository.CreateItemEx(TcxStyle, GetChildComponentOwner)
    as TcxStyle;
  if IsDesigning then
    Result.Name := GetUniqueName(GetChildComponentOwner,
      DropT(TcxStyle.ClassName));
...
begin
  ...
  begin
    ...
    DesignerModified;
    MessageWarning(Format(cxGetResourceString(@sdxNewStyleRepositoryWasCreated),
      [Result.Name]));
  end;
end;

function TdxCustomcxControlReportLink.CreateStyleSheet
  (APrototype: TcxCustomStyleSheet; const ACaption: string; AUseStyles: Boolean)
  : TdxCustomReportLinkStyleSheet;
var
  ...
  I: Integer;
begin
  Result := GetStyleRepository.CreateStyleSheetEx(GetStyleSheetClass,
    GetChildComponentOwner) as TdxCustomReportLinkStyleSheet;
  if IsDesigning then
    Result.Name := GetUniqueName(GetChildComponentOwner,
      DropT(GetStyleSheetClass.ClassName));
  ...
  begin
    ...
    begin
      ...
      InitiateStyle(AStyleCaption, AStyle, AStyle = nil);
      // or (Style.AssignedValues = []));
    ...
    begin
      ...
      if IsDesigning then
        ...
        begin
          ...
          if AStyle <> nil then
            AStyle.Name := GetUniqueName(GetChildComponentOwner,
              DropT(TcxStyle.ClassName));
        end;
    end;
  end;
...
function TdxCustomcxControlReportLink.FindStyleRepositoryInStyles
  (AStyles: TcxStyles): TcxStyleRepository;
var
  I: Integer;
...
function TdxCustomcxControlReportLink.GetStyleConsumerCount
  ...
  begin
    ...
    begin
      I := GetStyleConsumerCountInStyles(cxStyles_GetStyleSheet(AStyles)
        .GetStyles);
      Inc(Result, I);
    end;
  end;
...
function TdxCustomcxControlReportLink.GetStyleSheetCaption
  ...
  begin
    Result := dxInputQuery(Application.Title,
      cxGetResourceString(@sdxCreateNewStyleQueryNamePrompt), ACaption);
  end;

  procedure Error(const ACaption: string);
  begin
    MessageError(Format(cxGetResourceString(@sdxStyleSheetNameAlreadyExists),
      [ACaption]));
  end;
...
begin
  Result := AForceCreation or (AStyle = nil) or
    (GetStyleConsumerCount(AStyle) > 1);
  if Result then
    AStyle := CreateStyle(ACaption);
end;

procedure TdxCustomcxControlReportLink.StyleRestoreDefaults(const ACaption
...
function TdxCustomcxControlReportLink.GetStylesClass
  : TdxCustomReportLinkStylesClass;
begin
  Result := TdxCustomReportLinkStyles;
end;

function TdxCustomcxControlReportLink.GetStyleSheetClass
  : TdxCustomReportLinkStyleSheetClass;
begin
  Result := TdxCustomReportLinkStyleSheet;
end;

function TdxCustomcxControlReportLink.GetStyleSheetPrototype
  : TdxCustomReportLinkStyleSheet;
begin
  Result := nil;
end;
...
function TdxCustomcxControlReportLink.GetActiveStyles
  : TdxCustomReportLinkStyles;
begin
  Result := Styles;
...
function TdxCustomcxControlReportLink.GetDesignWindow
  : TdxfmCustomcxControlReportLinkDesignWindow;
begin
  Result := inherited DesignWindow as
    TdxfmCustomcxControlReportLinkDesignWindow;
end;
...
function TdxCustomcxControlReportLink.GetImageList(Index: Integer)
  : TCustomImageList;
begin
...
function TdxCustomcxControlReportLink.GetOptions(Index: Integer)
  : TdxCustomReportLinkOptions;
begin
...
procedure TdxCustomcxControlReportLink.SetOptionsExpanding
  (Value: TdxCustomReportLinkOptionsExpanding);
begin
  OptionsExpanding.Assign(Value);
end;

procedure TdxCustomcxControlReportLink.SetOptionsFormatting
  (Value: TdxCustomReportLinkOptionsFormatting);
begin
  OptionsFormatting.Assign(Value);
end;

procedure TdxCustomcxControlReportLink.SetOptionsPagination
  (Value: TdxCustomReportLinkOptionsPagination);
begin
  OptionsPagination.Assign(Value);
end;

procedure TdxCustomcxControlReportLink.SetOptionsRefinements
  (Value: TdxCustomReportLinkOptionsRefinements);
begin
  OptionsRefinements.Assign(Value);
end;

procedure TdxCustomcxControlReportLink.SetOptionsSize
  (Value: TdxCustomReportLinkOptionsSize);
begin
  OptionsSize.Assign(Value);
end;

procedure TdxCustomcxControlReportLink.SetOptionsView
  (Value: TdxCustomReportLinkOptionsView);
begin
  OptionsView.Assign(Value);
end;

procedure TdxCustomcxControlReportLink.SetStyleRepository
  (Value: TcxStyleRepository);
begin
...
procedure TdxCustomcxControlReportLink.SetStyles
  (Value: TdxCustomReportLinkStyles);
begin
  Styles.Assign(Value);
end;
...
function TdxCustomTableControlReportLinkOptions.GetReportLink
...
procedure TdxCustomTableControlReportLinkOptionsOnEveryPage.Assign
  (Source: TPersistent);
begin
...
procedure TdxCustomTableControlReportLinkOptionsOnEveryPage.SetBandHeaders
  (Value: Boolean);
begin
...
procedure TdxCustomTableControlReportLinkOptionsOnEveryPage.SetFooters
  (Value: Boolean);
begin
...
procedure TdxCustomTableControlReportLinkOptionsOnEveryPage.SetHeaders
  (Value: Boolean);
begin
...
procedure TdxCustomTableControlReportLinkOptionsPagination.Assign
  (Source: TPersistent);
begin
...
procedure TdxCustomTableControlReportLinkOptionsPagination.SetBand
  (Value: Boolean);
begin
  if FBand <> Value then
  begin
...
procedure TdxCustomTableControlReportLinkOptionsPagination.SetColumn
  (Value: Boolean);
begin
...
procedure TdxCustomTableControlReportLinkOptionsPagination.SetCustom
  (Value: Boolean);
begin
...
procedure TdxCustomTableControlReportLinkOptionsPagination.SetRow
  (Value: Boolean);
begin
...
procedure TdxCustomTableControlReportLinkOptionsPreview.Assign
  (Source: TPersistent);
begin
...
procedure TdxCustomTableControlReportLinkOptionsPreview.SetAutoHeight
  (Value: Boolean);
begin
...
procedure TdxCustomTableControlReportLinkOptionsPreview.SetMaxLineCount
  (Value: Integer);
begin
  if Value < 0 then
    Value := 0;
...
procedure TdxCustomTableControlReportLinkOptionsPreview.SetVisible
  (Value: Boolean);
begin
...
procedure TdxCustomTableControlReportLinkOptionsSelection.Assign
  (Source: TPersistent);
begin
...
procedure TdxCustomTableControlReportLinkOptionsSelection.
  SetProcessExactSelection(Value: Boolean);
begin
...
procedure TdxCustomTableControlReportLinkOptionsSelection.SetProcessSelection
  (Value: Boolean);
begin
...
procedure TdxCustomTableControlReportLinkOptionsView.Assign
  (Source: TPersistent);
begin
...
procedure TdxCustomTableControlReportLinkOptionsView.SetBandHeaders
  (Value: Boolean);
begin
  if FBandHeaders <> Value then
  begin
...
procedure TdxCustomTableControlReportLinkOptionsView.SetExpandButtons
  (Value: Boolean);
begin
...
function TdxCustomTableControlReportLink.GetOptionsOnEveryPageClass
  : TdxCustomTableControlReportLinkOptionsOnEveryPageClass;
begin
  Result := TdxCustomTableControlReportLinkOptionsOnEveryPage;
end;

function TdxCustomTableControlReportLink.GetOptionsPaginationClass
  : TdxCustomReportLinkOptionsPaginationClass;
begin
  Result := TdxCustomReportLinkOptionsPagination;
end;

function TdxCustomTableControlReportLink.GetOptionsPreviewClass
  : TdxCustomTableControlReportLinkOptionsPreviewClass;
begin
  Result := TdxCustomTableControlReportLinkOptionsPreview;
end;

function TdxCustomTableControlReportLink.GetOptionsSelectionClass
  : TdxCustomTableControlReportLinkOptionsSelectionClass;
begin
  Result := TdxCustomTableControlReportLinkOptionsSelection;
end;

function TdxCustomTableControlReportLink.GetOptionsViewClass
  : TdxCustomReportLinkOptionsViewClass;
begin
  Result := TdxCustomTableControlReportLinkOptionsView;
end;

function TdxCustomTableControlReportLink.GetOptionsPagination
  : TdxCustomTableControlReportLinkOptionsPagination;
begin
...
function TdxCustomTableControlReportLink.GetOptionsView
  : TdxCustomTableControlReportLinkOptionsView;
begin
  Result := inherited OptionsView as TdxCustomTableControlReportLinkOptionsView;
end;

procedure TdxCustomTableControlReportLink.SetOptionsOnEveryPage
  (Value: TdxCustomTableControlReportLinkOptionsOnEveryPage);
begin
  OptionsOnEveryPage.Assign(Value);
end;

procedure TdxCustomTableControlReportLink.SetOptionsPagination
  (Value: TdxCustomTableControlReportLinkOptionsPagination);
begin
  inherited OptionsPagination := Value;
end;

procedure TdxCustomTableControlReportLink.SetOptionsPreview
  (Value: TdxCustomTableControlReportLinkOptionsPreview);
begin
  OptionsPreview.Assign(Value);
end;

procedure TdxCustomTableControlReportLink.SetOptionsSelection
  (Value: TdxCustomTableControlReportLinkOptionsSelection);
begin
  OptionsSelection.Assign(Value);
end;

procedure TdxCustomTableControlReportLink.SetOptionsView
  (Value: TdxCustomTableControlReportLinkOptionsView);
begin
...
function TdxfmCustomcxControlReportLinkDesignWindow.CanCreateStyleSheet
  : Boolean;
begin
  Result := AreNativeStylesAvailable and ReportLink.CanCreateComponent;
end;

function TdxfmCustomcxControlReportLinkDesignWindow.CanDeleteStyleSheet
  : Boolean;
begin
...
function TdxfmCustomcxControlReportLinkDesignWindow.CanRenameStyleSheet
  : Boolean;
begin
  Result := AreNativeStylesAvailable and (ActiveStyleSheet <> nil) and
    (IsDesigning or not ActiveStyleSheet.BuiltIn);
...
function TdxfmCustomcxControlReportLinkDesignWindow.
  PerformStyleSheetCopy: Boolean;
var
  Caption: string;
begin
  ...
  begin
    ...
    if Result then
    begin
      ActiveStyleSheet := ReportLink.CreateStyleSheet(ActiveStyleSheet,
        Caption, False);
      RefreshStyleSheetList;
    end;
  end;
...
function TdxfmCustomcxControlReportLinkDesignWindow.
  PerformStyleSheetDelete: Boolean;

  function QueryDeleteStyleSheet(AStyleSheet: TcxCustomStyleSheet): Boolean;
  begin
    Result := dxPSUtl.MessageQuestion
      (Format(cxGetResourceString(@sdxDeleteStyleSheet),
      [AStyleSheet.Caption]));
  end;
...
procedure TdxfmCustomcxControlReportLinkDesignWindow.PerformStyleSheetDrawItem
  (ACanvas: TCanvas; AnIndex: Integer; R: TRect; AState: TOwnerDrawState;
  AEnabled: Boolean);
...
function TdxfmCustomcxControlReportLinkDesignWindow.PerformStyleSheetKeyDown
  (Sender: TObject; var AKey: Word; AShift: TShiftState): Boolean;
begin
  Result := True;
  case AKey of
    VK_F2:
...
function TdxfmCustomcxControlReportLinkDesignWindow.
  PerformStyleSheetRename: Boolean;
var
  Caption: string;
begin
...
function TdxfmCustomcxControlReportLinkDesignWindow.
  PerformStylesChangeBitmap: Boolean;

  procedure ShowError(const AFileName: string);
  begin
    dxPSUtl.MessageError(Format(cxGetResourceString(@sdxCannotLoadImage),
      [AFileName]));
  end;
...
function TdxfmCustomcxControlReportLinkDesignWindow.
  PerformStylesChangeColor: Boolean;
var
  AParams: TcxViewParams;
...
begin
  ...
  try
    ...
    begin
      ...
      dxPSGetViewParams(AStyle, AStyles[0], ReportLink.Styles, AParams,
        AParamsScaleFactor);
...
function TdxfmCustomcxControlReportLinkDesignWindow.
  PerformStylesChangeFont: Boolean;
var
  AParams: TcxViewParams;
  AParamsScaleFactor: TdxScaleFactor;
  AStyle: TcxStyle;
...
function TdxfmCustomcxControlReportLinkDesignWindow.
  PerformStylesClearBitmap: Boolean;
var
  Names: TStrings;
  I: Integer;
  cxStyle: TcxStyle;
...
function TdxfmCustomcxControlReportLinkDesignWindow.
  PerformStylesRestoreDefaults: Boolean;
var
  Names: TStrings;
  I: Integer;
  cxStyle: TcxStyle;
...
function TdxfmCustomcxControlReportLinkDesignWindow.
  PerformStylesSaveAsStyleSheet: Boolean;
var
  Caption: string;
begin
  Caption := '';
...
procedure TdxfmCustomcxControlReportLinkDesignWindow.DoFormActivated
  (AnActive: Boolean);
begin
end;
...
procedure TdxfmCustomcxControlReportLinkDesignWindow.DoStyleChanged
  (const ACaption: string; AStyle: TcxStyle);
begin
end;

procedure TdxfmCustomcxControlReportLinkDesignWindow.DoStylesChanged
  (AStrings: TStrings; ARecreate: Boolean);
begin
end;

function TdxfmCustomcxControlReportLinkDesignWindow.GetDesignerTabIndex
  : Integer;
begin
  Result := 0;
end;

procedure TdxfmCustomcxControlReportLinkDesignWindow.SetDesignerTabIndex
  (Value: Integer);
begin
end;

procedure TdxfmCustomcxControlReportLinkDesignWindow.GetSelectedStyleNames
  (AStrings: TStrings);
begin
end;

procedure TdxfmCustomcxControlReportLinkDesignWindow.GetStyleNames
  (out AStrings: TStrings);
begin
  AStrings := nil;
end;

procedure TdxfmCustomcxControlReportLinkDesignWindow.GetStyleSheetNames
  (out AStrings: TStrings);
begin
  AStrings := nil;
end;

function TdxfmCustomcxControlReportLinkDesignWindow.GetStyleConsumerCount
  (AStyle: TcxStyle): Integer;
begin
  Result := ReportLink.GetStyleConsumerCount(AStyle);
end;

function TdxfmCustomcxControlReportLinkDesignWindow.GetStyleSheetCaption
  (var ACaption: string): Boolean;
begin
  Result := ReportLink.GetStyleSheetCaption(HasStyleSheetWithCaption, ACaption);
end;

function TdxfmCustomcxControlReportLinkDesignWindow.HasStyleSheetWithCaption
...
begin
  ...
  if Strings <> nil then
    for I := 0 to Strings.Count - 1 do
      if dxSameText(Strings[I], ACaption) then
        Exit;
  Result := False;
end;

procedure TdxfmCustomcxControlReportLinkDesignWindow.InitiateStyle
  (const ACaption: string; var AStyle: TcxStyle; AForceCreation: Boolean);
var
  Names: TStrings;
begin
...
function TdxfmCustomcxControlReportLinkDesignWindow.GetActiveStyleSheet
  : TcxCustomStyleSheet;
begin
...
function TdxfmCustomcxControlReportLinkDesignWindow.
  GetAreNativeStylesAvailable: Boolean;
begin
  Result := ReportLink.AreNativeStylesAvailable;
end;

function TdxfmCustomcxControlReportLinkDesignWindow.GetReportLink
  : TdxCustomcxControlReportLink;
begin
  Result := inherited ReportLink as TdxCustomcxControlReportLink;
end;

function TdxfmCustomcxControlReportLinkDesignWindow.GetStyleRepository
  : TcxStyleRepository;
begin
  Result := ReportLink.StyleRepository;
end;

procedure TdxfmCustomcxControlReportLinkDesignWindow.SetActiveStyleSheet
  (Value: TcxCustomStyleSheet);
begin
...
procedure TdxfmCustomcxControlReportLinkDesignWindow.WMActivate
...
procedure TdxStylesListBoxToolTipsWindow.Activate(const R: TRect;
  AnIndex: Integer);
const
...
const
  HideFlags = SWP_NOZORDER or SWP_NOMOVE or SWP_NOSIZE or SWP_NOACTIVATE or
    SWP_HIDEWINDOW;
begin
...
procedure TdxStylesListBoxToolTipsWindow.CreateParams
...
procedure TdxStylesListBoxToolTipsWindow.CalculateStyleBarViewInfo
...
begin
  ...
  begin
    ...
    CalculateStyleBarViewInfo(HotTrackStyleName, StyleIndex, cxStyle, R, False,
      ScaleFactor, AViewInfo);
  end;
  with AViewInfo do
  begin
    BarColor := clInfoBk;
...
procedure TdxStylesListBoxToolTipsWindow.WMEraseBkgnd
...
function TdxStylesListBox.CreateTimer(AInterval: Integer;
  ATimerEvent: TNotifyEvent): TTimer;
begin
...
begin
  ...
  try
    ...
    CalculateStyleBarViewInfo(AText, -1, AStyle, ARect, odSelected in AState,
      ScaleFactor, AViewInfo);
...
procedure TdxStylesListBox.CalculateStyleBarViewInfoSizes(AnIndex: Integer;
  ...
  begin
    ...
    if GetStyleFontByText(AText, AStyleFont, AStyleFontScaleFactor) then
      dxAssignFont(Canvas.Font, AStyleFont, ScaleFactor, AStyleFontScaleFactor);
    AFontInfoMaxWidth := Canvas.TextWidth(FormatFontInfo(Canvas.Font)) +
...
begin
  ...
  try
    ...
    AViewInfo.MaxWidth := ACaptionMaxWidth + AScaleFactor.Apply(ColorBarWidth) +
      GetMaxValue(AWidthList);
    ...
    AViewInfo.StyleColorBoxBounds :=
      cxRectSetWidth(AViewInfo.StyleColorBoxBounds,
      AScaleFactor.Apply(ColorBarWidth));
    AViewInfo.StyleColorBoxContentBounds :=
      cxRectInflate(AViewInfo.StyleColorBoxBounds, -ScaleFactor.Apply(2));

    AViewInfo.StyleFontInfoBoxBounds := R;
    AViewInfo.StyleFontInfoBoxBounds.Left :=
      AViewInfo.StyleColorBoxBounds.Right;
    AViewInfo.StyleFontInfoBoxBounds.Right :=
      AViewInfo.StyleFontInfoBoxBounds.Left + Integer(AWidthList[0]);
...
procedure TdxStylesListBox.CalculateStyleBarViewInfoViewParams
  (const ACaption: string; AStyle: TcxStyle; const R: TRect; ASelected: Boolean;
  var AViewInfo: TdxStyleBarViewInfo);
var
  AParams: TcxViewParams;
  AParamsScaleFactor: TdxScaleFactor;
begin
  ...
  dxPSGetViewParams(AStyle, ACaption, ReportLinkStyles, AParams,
    AParamsScaleFactor);

  AViewInfo.BarColor := GetStyleBarItemColor(ASelected);
  AViewInfo.BarStyleColorBoxFrameColor := clBtnShadow;
  if ColorToRGB(AViewInfo.BarStyleColorBoxFrameColor)
    = ColorToRGB(AViewInfo.BarColor) then
    AViewInfo.BarStyleColorBoxFrameColor := clHighlightText;
  AViewInfo.BarFont.Assign(Font);
  AViewInfo.BarFont.Color := GetStyleBarItemTextColor(ASelected,
    AViewInfo.BarFont.Color, AViewInfo.BarColor);
  AViewInfo.StyleTextColor := GetStyleBarItemTextColor(ASelected,
    AParams.TextColor, AViewInfo.BarColor);
...
begin
  ...
  CalculateStyleBarViewInfoViewParams(ACaption, AStyle, R, ASelected,
    AViewInfo);
end;
...
function TdxStylesListBox.GetStyleBarItemTextColor(ASelected: Boolean;
  AColor, ABkColor: TColor): TColor;
begin
  if ASelected then
...
function TdxStylesListBox.GetStyleFontByText(const AText: string;
  out AFont: TFont; out AScaleFactor: TdxScaleFactor): Boolean;
var
  AParams: TcxViewParams;
begin
  dxPSGetViewParams(ReportLinkStyles.StylesByCaption[AText], AText,
    ReportLinkStyles, AParams, AScaleFactor);
  AFont := AParams.Font;
  Result := AFont <> nil;
end;
...
begin
  Result := IsHotTrackStyleViolateControlBounds and GetParentForm(Self)
    .Active and dxPSGlbl.CanShowHints;
end;
...
begin
  ...
  try
    CalculateStyleBarViewInfoSizes(HotTrackStyleIndex, Result, ScaleFactor,
      ViewInfo);
...
function TdxStylesListBox.GetStyleLookAndFeelPainter
...
procedure TdxStylesListBox.SetReportLinkStyles
  (Value: TdxCustomReportLinkStyles);
begin
