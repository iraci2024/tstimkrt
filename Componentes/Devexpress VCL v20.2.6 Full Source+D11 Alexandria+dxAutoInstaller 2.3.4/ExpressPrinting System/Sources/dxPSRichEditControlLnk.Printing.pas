...
{$ENDIF}
  ...
  dxMessages, dxGDIPlusClasses, cxLookAndFeelPainters, dxPSCore, dxSkinsCore,
  dxSkinInfo,
...
type
  ...
  protected
    ...
    procedure InitializeEmptyDocumentModel(const ADocumentModel
      : TdxDocumentModel); virtual;
    function CreateDocumentPrinter(ADocumentModel: TdxDocumentModel)
      : TdxDocumentPrinter; virtual; abstract;

    property DocumentModel: TdxDocumentModel read FDocumentModel;
    property ExtensionCommentId: TDictionary<Integer, TdxExtensionCommentInfo>
      read FExtensionCommentId write FExtensionCommentId;
  ...
  protected
    ...
    function CreateDocumentExporter(ADocumentModel: TdxDocumentModel)
      : TdxPrintingDocumentExporter; virtual;
    function CreateDocumentPrinter(ADocumentModel: TdxDocumentModel)
      : TdxDocumentPrinter; override;
  ...
  public
    ...
    class function GetDocumentModel(AControl: TdxInnerRichEditControl)
      : TdxDocumentModel; static;
  end;
...
constructor TdxRichEditPrinterBase.Create
...
function TdxRichEditPrinterBase.CalculateDocumentDPI(ADocumentModel
  : TdxDocumentModel): Integer;
begin
...
begin
  ...
  try
    FExportDocumentModel := DocumentModel.CreateDocumentModelForExport
      (InitializeEmptyDocumentModel);
    FExportDocumentModel.EnsureImagesLoadComplete;
    FDocumentDPI := CalculateDocumentDPI(FExportDocumentModel);
    FFontScaleFactor := FExportDocumentModel.LayoutUnitConverter.
      FontSizeScaleForPrinting;
...
procedure TdxRichEditPrinterBase.InitializeEmptyDocumentModel
  (const ADocumentModel: TdxDocumentModel);
begin
end;
...
begin
  begin
    AExporter := CreateDocumentExporter
      (TdxDocumentModel(FDocumentLayout.DocumentModel));
    try
...
function TdxRichEditPrinter.CreateDocumentExporter(ADocumentModel
  : TdxDocumentModel): TdxPrintingDocumentExporter;
begin
  Result := TdxPrintingDocumentExporter.Create(ADocumentModel,
    TdxTextColors.Defaults);
end;
...
function TdxRichEditPrinter.CreateDocumentPrinter(ADocumentModel
  : TdxDocumentModel): TdxDocumentPrinter;
begin
...
class function TdxRichEditControlPrinter.GetDocumentModel
  (AControl: TdxInnerRichEditControl): TdxDocumentModel;
begin
  Assert(AControl <> nil);
