...
uses
  Types, Classes, Windows, Graphics, ExtCtrls, dxCore, dxPSGlbl, dxPSCore,
  dxBkgnd;
...
type
  ...
  protected
    ...
    property TransparentColor: TColor read FTransparentColor
      write SetTransparentColor default clWindow;
  public
...
function TCustomdxGraphicReportLink.GetCriticalSize(AReportCells
...
procedure TCustomdxGraphicReportLink.ConstructReport(AReportCells
  : TdxReportCells);
var
  Graphic: TGraphic;
  Cell: TdxReportCell;
...
procedure TCustomdxGraphicReportLink.InitializeGraphicItem
  (AnItem: TdxReportCellGraphic);
const
  ImageBufferingMap: array [Boolean] of TdxCellImageBuffering =
    (cibAlways, cibNone);
begin
  AnItem.Color := Color;
  AnItem.CellSides := CellSidesMap[DrawBorder];
  AnItem.ImageBuffering := ImageBufferingMap[(GetGraphicClass <> nil) and
    GetGraphicClass.InheritsFrom(TMetafile)];
...
procedure TCustomdxPictureReportLink.InitializeGraphicItem
  (AnItem: TdxReportCellGraphic);
begin
...
begin
  Result := (APicture = nil) or (APicture.Graphic = nil) or
    APicture.Graphic.Empty;
end;
