...
begin
  AGlyph := GetGlyph;
  try
    Result := dxBarPopupHelper.CreateMenuItem(AOwner, ACaption, ACommand,
      AEnabled, TdxBarBuiltInMenuItemType(AItemType), AChecked, AImageIndex,
      AWithSeparator, AGlyph, MenuItemClickHandler);
  finally
    AGlyph.Free;
  end;
end;
