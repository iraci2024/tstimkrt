...
type
  ...
  public
    ...
    function FindNextRuleByClass(var AIndex: Integer;
      ARuleClass: TdxSpellCheckerRuleClass): TdxSpellCheckerRule;
...
constructor TdxSpellCheckerRule.Create(ATextHelper
  : IdxSpellCheckerCheckModeHelper);
begin
  inherited Create;
...
function TdxSpellCheckerRules.FindNextRuleByClass(var AIndex: Integer;
  ARuleClass: TdxSpellCheckerRuleClass): TdxSpellCheckerRule;
var
  I: Integer;
begin
...
function TdxSpellCheckerRules.FindRule(const AWord: string)
  : TdxSpellCheckerRule;
var
  I: Integer;
begin
...
function TdxSpellCheckerRepeatedWordsRule.CanApply(const AWord: string)
  : Boolean;
begin
...
function TdxSpellCheckerRepeatedWordsRule.GetErrorCode
