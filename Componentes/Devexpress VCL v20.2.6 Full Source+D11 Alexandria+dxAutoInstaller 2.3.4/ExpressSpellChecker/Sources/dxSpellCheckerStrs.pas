...
resourcestring
  ...
  sdxSpellCheckerMoreThanOne =
    'An application should contain only a single TdxSpellChecker';
  ...
  sdxSpellCheckerNotUseChangeAll =
    'Change All option is not available because you modified ' +
  ...
  sdxSpellCheckerConfirmUseUnknownWord =
    'You have chosen a word that is not found in the ' +
    'main or custom dictionaries. Do you want to use this word and continue checking?';
  sdxSpellCheckerSelectionCheckIsFinished =
    'Selection check is finished. Do you want to continue checking the remainder of the document?';
  ...
  sdxSpellCheckerSpellingOptionsInternationalDictionariesGroupBox =
    'International dictionaries';
  sdxSpellCheckerSpellingOptionsInternationalDictionariesText =
    'Choose which dictionaries to use when checking your spelling.';
  sdxSpellCheckerSpellingOptionsEditCustomDictionaryGroupBox =
    'Edit custom dictionary';
  sdxSpellCheckerSpellingOptionsEditCustomDictionaryText =
    'Add, change or remove words from your custom dictionary.';
  ...
  sdxSpellCheckerAutoCorrectReplacementExistMessageFormat =
    'An AutoCorrect entry for %s already exists. Do you want to redefine it?';
  ...
  sdxSpellCheckerAutoCorrectCorrectSentenceCaps =
    'Capitalize first letter of &sentences';
  sdxSpellCheckerAutoCorrectCorrectInitialCaps =
    'Correct TWo &INitial CApitals';
  sdxSpellCheckerAutoCorrectCorrectCapsLock =
    'Correct accidental usage of cAPS &LOCK key';
  sdxSpellCheckerAutoCorrectDisableCapsLock = 'Disable Caps Lock';
  sdxSpellCheckerAutoCorrectAutomaticallyUseSuggestions =
  ...
  sdxSpellCheckerFirstLetterExceptions =
...
procedure AddExpressSpellCheckerResourceStringNames
...
begin
  ...
  InternalAdd('sdxSpellCheckerFileFormatMismatch',
    @sdxSpellCheckerFileFormatMismatch);
  InternalAdd('sdxSpellCheckerISpellDictionary',
    @sdxSpellCheckerISpellDictionary);
  InternalAdd('sdxSpellCheckerOpenOfficeDictionary',
    @sdxSpellCheckerOpenOfficeDictionary);
  InternalAdd('sdxSpellCheckerUserDictionary', @sdxSpellCheckerUserDictionary);
  InternalAdd('sdxSpellCheckerHunspellDictionary',
    @sdxSpellCheckerHunspellDictionary);
  ...
  InternalAdd('sdxSpellCheckerChangeAllButton',
    @sdxSpellCheckerChangeAllButton);
  ...
  InternalAdd('sdxSpellCheckerDeleteAllButton',
    @sdxSpellCheckerDeleteAllButton);
  InternalAdd('sdxSpellCheckerIgnoreButton', @sdxSpellCheckerIgnoreButton);
  InternalAdd('sdxSpellCheckerIgnoreAllButton',
    @sdxSpellCheckerIgnoreAllButton);
  ...
  InternalAdd('sdxSpellCheckerNotInDictionary',
    @sdxSpellCheckerNotInDictionary);
  InternalAdd('sdxSpellCheckerNoSuggestions', @sdxSpellCheckerNoSuggestions);
  InternalAdd('sdxSpellCheckerCustomDictionaryFormCaption',
    @sdxSpellCheckerCustomDictionaryFormCaption);
  InternalAdd('sdxSpellCheckerSpellingFormCaption',
    @sdxSpellCheckerSpellingFormCaption);
  InternalAdd('sdxSpellCheckerSpellingComplete',
    @sdxSpellCheckerSpellingComplete);
  InternalAdd('sdxSpellCheckerNoActiveDictionaries',
    @sdxSpellCheckerNoActiveDictionaries);
  InternalAdd('sdxSpellCheckerNotUseChangeAll',
    @sdxSpellCheckerNotUseChangeAll);
  InternalAdd('sdxSpellCheckerConfirmUseUnknownWord',
    @sdxSpellCheckerConfirmUseUnknownWord);
  InternalAdd('sdxSpellCheckerSelectionCheckIsFinished',
    @sdxSpellCheckerSelectionCheckIsFinished);
  InternalAdd('sdxSpellCheckerSpellingOptionsFormCaption',
    @sdxSpellCheckerSpellingOptionsFormCaption);
  InternalAdd('sdxSpellCheckerSpellingOptionsMainGroupBox',
    @sdxSpellCheckerSpellingOptionsMainGroupBox);
  InternalAdd('sdxSpellCheckerSpellingLanguage',
    @sdxSpellCheckerSpellingLanguage);
  InternalAdd('sdxSpellCheckerSpellingOptionsInternationalDictionariesGroupBox',
    @sdxSpellCheckerSpellingOptionsInternationalDictionariesGroupBox);
  InternalAdd('sdxSpellCheckerSpellingOptionsInternationalDictionariesText',
    @sdxSpellCheckerSpellingOptionsInternationalDictionariesText);
  InternalAdd('sdxSpellCheckerSpellingOptionsEditCustomDictionaryGroupBox',
    @sdxSpellCheckerSpellingOptionsEditCustomDictionaryGroupBox);
  InternalAdd('sdxSpellCheckerSpellingOptionsEditCustomDictionaryText',
    @sdxSpellCheckerSpellingOptionsEditCustomDictionaryText);
  InternalAdd('sdxSpellCheckerSpellingOptionsGeneralOptionsGroupBox',
    @sdxSpellCheckerSpellingOptionsGeneralOptionsGroupBox);
  InternalAdd('sdxSpellCheckerIgnoreUpperCaseWords',
    @sdxSpellCheckerIgnoreUpperCaseWords);
  InternalAdd('sdxSpellCheckerIgnoreMixedCaseWords',
    @sdxSpellCheckerIgnoreMixedCaseWords);
  InternalAdd('sdxSpellCheckerIgnoreWordsWithNumbers',
    @sdxSpellCheckerIgnoreWordsWithNumbers);
  InternalAdd('sdxSpellCheckerIgnoreRepeatedWords',
    @sdxSpellCheckerIgnoreRepeatedWords);
  ...
  InternalAdd('sdxSpellCheckerAutoCorrectOptionsFormCaption',
    @sdxSpellCheckerAutoCorrectOptionsFormCaption);
  InternalAdd('sdxSpellCheckerExceptionsButton',
    @sdxSpellCheckerExceptionsButton);
  InternalAdd('sdxSpellCheckerActive', @sdxSpellCheckerActive);
  InternalAdd('sdxSpellCheckerAutoInclude', @sdxSpellCheckerAutoInclude);
  InternalAdd('sdxSpellCheckerAutoCorrectReplacementExistMessageFormat',
    @sdxSpellCheckerAutoCorrectReplacementExistMessageFormat);
  InternalAdd('sdxSpellCheckerAutoCorrectCapitalize',
    @sdxSpellCheckerAutoCorrectCapitalize);
  InternalAdd('sdxSpellCheckerAutoCorrectCorrectSentenceCaps',
    @sdxSpellCheckerAutoCorrectCorrectSentenceCaps);
  InternalAdd('sdxSpellCheckerAutoCorrectCorrectInitialCaps',
    @sdxSpellCheckerAutoCorrectCorrectInitialCaps);
  InternalAdd('sdxSpellCheckerAutoCorrectCorrectCapsLock',
    @sdxSpellCheckerAutoCorrectCorrectCapsLock);
  InternalAdd('sdxSpellCheckerAutoCorrectDisableCapsLock',
    @sdxSpellCheckerAutoCorrectDisableCapsLock);
  InternalAdd('sdxSpellCheckerAutoCorrectReplaceTextAsYouType',
    @sdxSpellCheckerAutoCorrectReplaceTextAsYouType);
  InternalAdd('sdxSpellCheckerAutoCorrectAutomaticallyUseSuggestions',
    @sdxSpellCheckerAutoCorrectAutomaticallyUseSuggestions);
  InternalAdd('sdxSpellCheckerAutoCorrectReplace',
    @sdxSpellCheckerAutoCorrectReplace);
  InternalAdd('sdxSpellCheckerAutoCorrectWith',
    @sdxSpellCheckerAutoCorrectWith);
  InternalAdd('sdxSpellCheckerReplaceButton', @sdxSpellCheckerReplaceButton);
  InternalAdd('sdxSpellCheckerAutoCorrectExceptionsFormCaption',
    @sdxSpellCheckerAutoCorrectExceptionsFormCaption);
  InternalAdd('sdxSpellCheckerFirstLetterExceptions',
    @sdxSpellCheckerFirstLetterExceptions);
  InternalAdd('sdxSpellCheckerInitialCapsExceptions',
    @sdxSpellCheckerInitialCapsExceptions);
...
dxResourceStringsRepository.RegisterProduct('ExpressSpellChecker',
  @AddExpressSpellCheckerResourceStringNames);
