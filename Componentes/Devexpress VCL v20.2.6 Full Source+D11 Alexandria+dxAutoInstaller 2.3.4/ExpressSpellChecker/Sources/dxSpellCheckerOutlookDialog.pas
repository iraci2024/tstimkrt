...
{$ENDIF}
  ...
  Dialogs, Menus, StdCtrls, dxCore,
  cxLookAndFeelPainters, cxButtons, cxControls, cxContainer, cxEdit, cxTextEdit,
  cxMemo, dxSpellChecker, cxClasses,
  dxSpellCheckerBaseForm, cxListBox, cxGraphics, cxLookAndFeels,
...
constructor TdxCustomSpellCheckerForm.CreateEx(ASpellChecker
...
begin
  teMisspelledWord.ParentColor := teMisspelledWord.Style.LookAndFeel.
    SkinPainter = nil;
end;
...
begin
  SetMisspelledInfo;
  btnAdd.Enabled := SpellChecker.HasEnabledUserDictionary and
    (Trim(teSuggestion.Text) <> '');
end;
...
procedure TfmSpellCheckerOutlookForm.SetSuggestions(ASuggestions
