...
type
  ...
  private
    FIsModified: Boolean;
    function GetDictionaryLanguage(ADictionary
      : TdxCustomSpellCheckerDictionary): Integer;
  ...
  TfmSpellCheckerSpellingOptionsFormClass = class of
    TfmSpellCheckerSpellingOptionsForm;
...
begin
  ...
  cbIgnoreMixedCaseWords.Caption :=
    cxGetResourceString(@sdxSpellCheckerIgnoreMixedCaseWords);
  cbIgnoreUpperCaseWords.Caption :=
    cxGetResourceString(@sdxSpellCheckerIgnoreUpperCaseWords);
  cbIgnoreUrls.Caption := cxGetResourceString(@sdxSpellCheckerIgnoreUrls);
  cbIgnoreWordsWithNumbers.Caption :=
    cxGetResourceString(@sdxSpellCheckerIgnoreWordsWithNumbers);
  cbIgnoreRepeatedWords.Caption :=
    cxGetResourceString(@sdxSpellCheckerIgnoreRepeatedWords);
...
begin
  ...
  begin
    ...
    begin
      ...
      if (ADictionary is TdxUserSpellCheckerDictionary) or not ADictionary.Enabled
      then
        Continue;
      if GetDictionaryLanguage(ADictionary) = ccbLanguages.Properties.Items[I].Tag
      then
      begin
...
function TfmSpellCheckerSpellingOptionsForm.GetOptions
...
procedure TfmSpellCheckerSpellingOptionsForm.btnApplyClick(Sender: TObject);
begin
  Save;
end;
