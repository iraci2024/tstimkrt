...
{$ENDIF}
  ...
  Controls, Forms, StdCtrls, RichEdit, Menus, Generics.Defaults,
  ...
  dxSpellCheckerAlgorithms, dxHunspellTypes, dxSpellCheckerTextParsers,
  dxSpellCheckerAdapters, SyncObjs;
...
type
  ...
  public
    ...
    procedure Insert(AIndex: Integer; const AWord: string;
      ADictionary: TdxCustomSpellCheckerDictionary; ADistance: Integer);
    ...
    property Items[Index: Integer]: TdxSpellCheckerSuggestion
  ...
  public
    ...
    procedure Add(const AWord: string;
      ASuggestions: TdxSpellCheckerSuggestionList);
    function GetSuggestions(const AWord: string;
      ASuggestions: TdxSpellCheckerSuggestionList): Boolean;
    procedure Reset;

    property Items[Index: Integer]: TdxSpellCheckerSuggestionCacheItem
      read GetItem; default;
  end;

  { TdxSpellCheckerSingleWordParser }

  TdxSpellCheckerSingleWordParser = class(TcxIUnknownObject,
  ...
  public
    constructor Create(const AMisspelledWord, AReplacement, APrevWord: string;
      const AMisspelledWordStart, AMisspelledWordFinish, AReplacementFinish
      : IdxSpellCheckerPosition);

    property MisspelledWord: string read FMisspelledWord;
    property MisspelledWordFinish: IdxSpellCheckerPosition
      read FMisspelledWordFinish;
    property MisspelledWordStart: IdxSpellCheckerPosition
      read FMisspelledWordStart;
    ...
    property ReplacementStart: IdxSpellCheckerPosition
      read FMisspelledWordStart;
  end;
  ...
  public
    ...
    property Items[Index: Integer]: TdxSpellCheckerUndoItem
      read GetItem; default;
  end;

  { TdxSpellCheckerAbstractCheckMode }

  TdxSpellCheckerAbstractCheckMode = class(TInterfacedPersistent,
    IdxSpellCheckerCheckModeHelper)
  strict private
  ...
  protected
    ...
    function CheckWord(const AWord: string)
      : TdxSpellCheckerSpellingCode; virtual;
    function GetNextWord(out AWord: string): Boolean; virtual;
    function GetOwner: TPersistent; override;
    function InternalCheckWord(var AWord: string)
      : TdxSpellCheckerSpellingCode; virtual;
  ...
  protected
    ...
    function IsNeedChangeWord(const AWord: string; out AReplacement: string)
      : Boolean; virtual;
    function IsNeedDeleteWord(const AWord: string): Boolean; virtual;
    procedure ReplaceWord(var AStart, AFinish: IdxSpellCheckerPosition;
      const AWord, APrevWord: string);
    procedure RestoreSelection; virtual;
    procedure StoreSelection; virtual;
    procedure SelectMisspelledWord; virtual;
    procedure UpdateByDictionary(ADictionary
      : TdxCustomSpellCheckerDictionary); virtual;
    procedure UpdateTextInfo; virtual;

    property Adapter: IdxSpellCheckerAdapter read FAdapter;
  public
    constructor Create(AOwner: TdxCustomSpellChecker;
      AAdapter: IdxSpellCheckerAdapter); virtual;
    destructor Destroy; override;
    ...
    function GetSuggestions(const AWord: string)
      : TdxSpellCheckerSuggestionList; virtual;
  ...
  public
    constructor Create(AOwner: TdxCustomSpellChecker;
      AAdapter: IdxSpellCheckerAdapter); override;
    destructor Destroy; override;
  ...
  public
    ...
    property MisspelledSentence: TdxSpellCheckerSentence
      read GetMisspelledSentence;
  end;
  ...
  public
    ...
    procedure PopulateMetaphoneSuggestions(ASuggestionBuilder
      : TdxSpellCheckerSuggestionBuilder; const AWord: string);
    procedure SaveToStrings(AStrings: TStrings);

    property Count: Integer read FCount;
    property FindMostValidCapitalizationInDuplicates: Boolean
      read FFindMostValidCapitalizationInDuplicates
      write FFindMostValidCapitalizationInDuplicates;
    property LangID: Cardinal read FLangID write FLangID;
    property UseDoubleMetaphone: Boolean read FUseDoubleMetaphone
      write SetUseDoubleMetaphone;
  end;
  ...
  public
    ...
    procedure AddSuggestions(const AWord: string;
      ASuggestions: TdxSpellCheckerSuggestionList); virtual;
  end;
  ...
  TdxSpellCheckerDictionaryLoadingEvent = procedure
    (Sender: TdxCustomSpellCheckerDictionary; var AHandled: Boolean) of object;
  TdxSpellCheckerDictionaryLoadedEvent = procedure
    (Sender: TdxCustomSpellCheckerDictionary) of object;
  TdxSpellCheckerDictionaryLoadMode = (dlmDefault, dlmDirectLoad,
    dlmThreadedLoad);
  ...
  protected
    ...
    procedure PopulateCapitalizationSuggestions(ASuggestionBuilder
      : TdxSpellCheckerSuggestionBuilder; const AWord: string); virtual;
    procedure PopulateMetaphoneSuggestions(ASuggestionBuilder
      : TdxSpellCheckerSuggestionBuilder; const AWord: string); virtual;
    procedure Reload;
    procedure Terminate;
  ...
  public
    ...
    property OnLoaded: TdxSpellCheckerDictionaryLoadedEvent read FOnLoaded
      write FOnLoaded;
    property OnLoading: TdxSpellCheckerDictionaryLoadingEvent read FOnLoading
      write FOnLoading;
  end;

  TdxCustomSpellCheckerDictionaryClass = class of
    TdxCustomSpellCheckerDictionary;
  ...
  protected
    ...
    function IsCorrectCapitalization(const AWord, APattern: string)
      : Boolean; virtual;
    procedure LanguageChanged; override;
    procedure PopulateCapitalizationSuggestions(ASuggestionBuilder
      : TdxSpellCheckerSuggestionBuilder; const AWord: string); override;
    procedure PopulateMetaphoneSuggestions(ASuggestionBuilder
      : TdxSpellCheckerSuggestionBuilder; const AWord: string); override;
  ...
  public
    ...
    property Active;
    property Alphabet;
    property CheckCapitalization: Boolean read FCheckCapitalization
      write SetCheckCapitalization default False;
    property CodePage;
    property Enabled;
    property Language;
    property Loaded;
  ...
  TdxUserSpellCheckerDictionaryOptions = set of
  ...
  published
    ...
    property CodePage;
    property Enabled;
    property DictionaryPath: TFileName read FDictionaryPath
      write FDictionaryPath;
    property Options: TdxUserSpellCheckerDictionaryOptions read FOptions
      write FOptions default [udSaveOnUnload];
    property OnLoaded;
    property OnLoading;
  end;
  ...
  strict private
    ...
    procedure SetDictionaryTypeClass
  ...
  public
    ...
    property DictionaryTypeClass: TdxCustomSpellCheckerDictionaryClass
      read FDictionaryTypeClass write SetDictionaryTypeClass;
  published
    property DictionaryTypeClassName: string read GetDictionaryTypeClassName
      write SetDictionaryTypeClassName;
    property DictionaryType: TdxCustomSpellCheckerDictionary
      read FDictionaryType write SetDictionaryType;
    property DictionaryEvents: TNotifyEvent read FDictionaryEvents
  ...
  public
    ...
    property Items[Index: Integer]: TdxSpellCheckerDictionaryItem read GetItem
      write SetItem; default;
  end;

  { TdxSpellCheckerAutoCorrectOptions }

  TdxSpellCheckerAutoCorrectOptionsChangedEvent = procedure
    (Sender: TdxSpellCheckerAutoCorrectOptions) of object;
  ...
  public
    function GetReplacement(const AText: string; out AReplacement: string)
      : Boolean; virtual;

    property SpellChecker: TdxCustomSpellChecker read GetSpellChecker;
    property OnChanged: TdxSpellCheckerAutoCorrectOptionsChangedEvent
      read FOnChanged write FOnChanged;
  end;

  { TdxSpellCheckerSpellingOptions }

  TdxSpellCheckerSpellingOptionsChangedEvent = procedure
    (Sender: TdxSpellCheckerSpellingOptions) of object;
  ...
  protected
    ...
    procedure PopulateRules(ARules: TdxSpellCheckerRules;
      AHelper: IdxSpellCheckerCheckModeHelper); virtual;

    property IgnoreMarkupTags: Boolean read FIgnoreMarkupTags
      write SetIgnoreMarkupTags default True;
  public
    procedure Assign(Source: TPersistent); override;

    property OnChanged: TdxSpellCheckerSpellingOptionsChangedEvent
      read FOnChanged write FOnChanged;
  published
    property CheckFromCursorPos: Boolean read FCheckFromCursorPos
      write SetCheckFromCursorPos default False;
    property CheckSelectedTextFirst: Boolean read FCheckSelectedTextFirst
      write SetCheckSelectedTextFirst default True;
    property IgnoreEmails: Boolean read FIgnoreEmails write SetIgnoreEmails
      default True;
    property IgnoreMixedCaseWords: Boolean read FIgnoreMixedCaseWords
      write SetIgnoreMixedCaseWords default True;
    property IgnoreRepeatedWords: Boolean read FIgnoreRepeatedWords
      write SetIgnoreRepeatedWords default False;
    property IgnoreUpperCaseWords: Boolean read FIgnoreUpperCaseWords
      write SetIgnoreUpperCaseWords default True;
    property IgnoreUrls: Boolean read FIgnoreUrls write SetIgnoreUrls
      default True;
    property IgnoreWordsWithNumbers: Boolean read FIgnoreWordsWithNumbers
      write SetIgnoreWordsWithNumbers default True;
  end;
  ...
  protected
    ...
    function CreateAdapter(AControl: TWinControl;
      out AAdapter: IdxSpellCheckerAdapter): Boolean; virtual;
  ...
  IdxSpellCheckerAutoCorrectRule = interface
  ...
  TdxSpellCheckerAutoCorrectCustomRule = class(TInterfacedObject,
    IdxSpellCheckerAutoCorrectCustomRule, IdxSpellCheckerAutoCorrectRule)
  strict private
  ...
  public
    ...
    function IsCheckWord(const ATextController: IdxSpellCheckTextController;
      var AInfo: TdxSpellCheckerAutoCorrectWordInfo): Boolean; virtual;
      abstract;
  ...
  protected
    function CreateAdapter(AControl: TWinControl;
      out AAdapter: IdxSpellCheckerAdapter): Boolean; override;
  ...
  TdxSpellCheckerCustomCheckAsYouTypeManager = class
    (TdxSpellCheckerCustomManager)
  strict private
  ...
  TdxSpellCheckerIgnoreList = class(TInterfacedObject,
  ...
  public
    ...
    procedure Register(AControl: TControl;
      const AList: IdxSpellCheckerIgnoreList);
  ...
  TdxSpellCheckerCheckWordEvent = procedure(Sender: TdxCustomSpellChecker;
    const AWord: WideString; out AValid: Boolean; var AHandled: Boolean)
    of object;
  TdxSpellCheckerAddWordEvent = procedure(AUserDictionary
    : TdxUserSpellCheckerDictionary; const AWord: WideString;
    var AHandled: Boolean) of object;
  TdxSpellCheckerAutoCorrectEvent = procedure(Sender: TdxCustomSpellChecker;
    ARule: TdxSpellCheckerAutoCorrectCustomRule;
    var AWordRange: TdxSpellCheckerAutoCorrectWordRange; var AAllow: Boolean)
    of object;
  TdxSpellCheckerEnabledDictionariesLoadedEvent = procedure
    (Sender: TdxCustomSpellChecker; const AWord: WideString;
    var AHandled: Boolean) of object;
  ...
  TdxSpellCheckerCheckAsYouTypePopupEvent = procedure
    (ASender: TdxCustomSpellChecker; APopupMenu: TComponent;
    var AHandled: Boolean) of object;
  TdxSpellCheckerCheckControlInContainerEvent = procedure
    (Sender: TdxCustomSpellChecker; AControl: TWinControl; var AAllow: Boolean;
  ...
  TdxCustomSpellChecker = class(TcxCustomComponent, IdxSkinSupport,
    IdxSpellChecker, IdxSpellChecker2, IdxSpellChecker3)
  strict private
    ...
    function GetActiveDictionary(Index: Integer)
      : TdxCustomSpellCheckerDictionary;
    ...
    function GetEnabledDictionary(Index: Integer)
      : TdxCustomSpellCheckerDictionary;
    ...
    procedure SetCheckAsYouTypeOptions
  ...
  protected
    ...
    function CanCheckControlInContainer(AControl: TWinControl)
      : Boolean; virtual;
    procedure CheckCallEnabledDictionariesLoaded;
    procedure CheckControlInContainer(AControl: TWinControl); virtual;
    function CreateAutoCorrectManager
      : TdxSpellCheckerCustomAutoCorrectManager; virtual;
    function CreateAutoCorrectOptions
      : TdxSpellCheckerAutoCorrectOptions; virtual;
    function CreateCheckAsYouTypeManager
      : TdxSpellCheckerCustomCheckAsYouTypeManager; virtual;
    function CreateCheckAsYouTypeOptions
      : TdxSpellCheckerCheckAsYouTypeOptions; virtual;
    ...
    function DoAddWord(AUserDictionary: TdxUserSpellCheckerDictionary;
      const AWord: string): Boolean; virtual;
    ...
    procedure DoCheckContainer(AContainer: TWinControl;
      ARecursive: Boolean); virtual;
    function DoCheckControlInContainer(AControl: TWinControl;
      var AContinue: Boolean): Boolean; virtual;
    function DoCheckWord(const AWord: string; var AValid: Boolean)
      : Boolean; virtual;
    procedure DoDialogCheckModeChanged; virtual;
    procedure DoEnabledDictionariesLoaded; virtual;
    procedure DoGetSuggestions(const AWord: string;
      ASuggestions: TdxSpellCheckerSuggestionList); virtual;
    function DoSpellingComplete: Boolean; virtual;
    function GetDialogCheckModeClass
      : TdxSpellCheckerCustomCheckModeClass; virtual;
    function GetWordChars: string; virtual;
    procedure LoadDictionariesDirect(AIgnoreDisabled: Boolean = True); virtual;
    procedure LoadDictionariesUsingThread(AIgnoreDisabled
      : Boolean = True); virtual;
    procedure Loaded; override;
    procedure Notification(AComponent: TComponent;
      Operation: TOperation); override;
    procedure SpellingComplete;
    procedure SpellingOptionsChanged(AChangeType
      : TdxChangeType = ctMedium); virtual;
    procedure UpdateByDictionary(ADictionary
      : TdxCustomSpellCheckerDictionary); virtual;

    procedure InternalCheck(AAdapter: IdxSpellCheckerAdapter); virtual;
    function InternalIsValidWord(const AWord: string): Boolean;
      overload; virtual;
    function InternalIsValidWord(const AWord: string;
      AHelper: IdxSpellCheckerCheckModeHelper): Boolean; overload;
    procedure ReleaseCheckModeHelper
      (AHelper: IdxSpellCheckerCheckModeHelper); virtual;
    procedure SetCheckModeHelper(AHelper
      : IdxSpellCheckerCheckModeHelper); virtual;
    ...
    // IdxSpellChecker3
    function AutoCorrect(AControl: TWinControl;
      const AController: IdxSpellCheckTextController;
      var AInfo: TdxSpellCheckerAutoCorrectWordInfo): Boolean;
    function GetAutoCorrectOptions: TdxSpellCheckerCustomAutoCorrectOptions;
    function GetCheckAsYouTypeOptions
      : TdxSpellCheckerCustomCheckAsYouTypeOptions;
    function CheckAsync(AControl: TWinControl;
      const AController: IdxSpellCheckTextController;
      const AFrom, ATo: IdxSpellCheckerPosition;
      AProc: IdxSpellChecker3CheckCallbackProc;
    ...
    procedure IgnoreOnce(AControl: TControl; const AWord: string;
      const AStart, AEnd: IdxSpellCheckerPosition); overload;
    procedure IgnoreOnce(AList: IdxSpellCheckerIgnoreList; const AWord: string;
      const AStart, AEnd: IdxSpellCheckerPosition); overload;
    procedure RegisterIgnoreList(AControl: TControl;
      const AIgnoreList: IdxSpellCheckerIgnoreList);
    ...
    property AutoCorrectManager: TdxSpellCheckerCustomAutoCorrectManager
      read FAutoCorrectManager;
    property ChangeList: TdxSpellCheckerReplacementList read FChangeList;
    property CheckAsYouTypeManager: TdxSpellCheckerCustomCheckAsYouTypeManager
      read FCheckAsYouTypeManager;
    ...
    property IgnoreOnceLists: TdxSpellCheckerIgnoreOnceListsManager
      read FIgnoreOnceLists;
    property LastDialogResult: Integer read FLastDialogResult
      write FLastDialogResult;
    property Similarity: TdxStringSimilarityCalculator read FSimilarity;
    property SuggestionCache: TdxSpellCheckerSuggestionCache
      read FSuggestionCache;

    property OnAddWord: TdxSpellCheckerAddWordEvent read FOnAddWord
      write FOnAddWord;
    property OnAfterCheck: TdxSpellCheckerEvent read FOnAfterCheck
      write FOnAfterCheck;
    property OnAutoCorrect: TdxSpellCheckerAutoCorrectEvent read FOnAutoCorrect
      write FOnAutoCorrect;
    property OnAutoCorrectFinish: TdxSpellCheckerCheckFinishEvent
      read FOnAutoCorrectFinish write FOnAutoCorrectFinish;
    property OnAutoCorrectStart: TdxSpellCheckerCheckStartEvent
      read FOnAutoCorrectStart write FOnAutoCorrectStart;
    property OnBeforeCheck: TdxSpellCheckerEvent read FOnBeforeCheck
      write FOnBeforeCheck;
    ...
    property OnCheckWord: TdxSpellCheckerCheckWordEvent read FOnCheckWord
      write FOnCheckWord;
    ...
    property OnDialogCheckModeChanged: TdxMulticastMethod<TNotifyEvent>
      read FOnDialogCheckModeChanged;
    property OnSpellingOptionsChanged: TdxMulticastMethod<TNotifyEvent>
      read FOnSpellingOptionsChanged;
  public
    constructor Create(AOwner: TComponent); override;
    destructor Destroy; override;
    ...
    function FindDictionaryByWord(const AWord: string)
      : TdxCustomSpellCheckerDictionary;
    ...
    property ActiveDictionaries[Index: Integer]: TdxCustomSpellCheckerDictionary
      read GetActiveDictionary;
    property ActiveDictionaryCount: Integer read GetActiveDictionaryCount;
    property AutoCorrectOptions: TdxSpellCheckerAutoCorrectOptions
      read FAutoCorrectOptions write SetAutoCorrectOptions;
    property AutoLoadDictionaries: Boolean read FAutoLoadDictionaries
      write FAutoLoadDictionaries default False;
    property CheckMode: TdxSpellCheckerCustomCheckMode read GetCheckMode;
    property CheckAsYouTypeOptions: TdxSpellCheckerCheckAsYouTypeOptions
      read FCheckAsYouTypeOptions write SetCheckAsYouTypeOptions;
    property DialogLookAndFeel: TcxLookAndFeel read FDialogLookAndFeel
      write SetDialogLookAndFeel;
    property Dictionaries[Index: Integer]: TdxCustomSpellCheckerDictionary
      read GetDictionary;
    property DictionaryCount: Integer read GetDictionaryCount;
    property DictionaryItems: TdxSpellCheckerDictionaries read FDictionaryItems
      write SetDictionaryItems;
    property EnabledDictionaries[Index: Integer]
      : TdxCustomSpellCheckerDictionary read GetEnabledDictionary;
    property EnabledDictionaryCount: Integer read GetEnabledDictionaryCount;
    property MetaphoneDistance: Integer read FMetaphoneDistance
      write SetMetaphoneDistance default 3;
    property Rules: TdxSpellCheckerRules read FRules; // for internal use
    property SpellingFormType: TdxSpellCheckerSpellingFormType
      read FSpellingFormType write FSpellingFormType default sftOutlook;
    property SpellingOptions: TdxSpellCheckerSpellingOptions
      read FSpellingOptions write SetSpellingOptions;
    property ThreadedLoadPriority: TThreadPriority read FThreadedLoadPriority
      write FThreadedLoadPriority default tpLower;
    property UserDictionaries[Index: Integer]: TdxUserSpellCheckerDictionary
      read GetUserDictionary;
    property UserDictionaryCount: Integer read GetUserDictionaryCount;
    property UseThreadedLoad: Boolean read FUseThreadedLoad
      write FUseThreadedLoad default False;
  end;
...
uses
  ...
  AnsiStrings, ComCtrls, Dialogs, cxGeometry, dxOffice11, StrUtils, RTLConsts,
  dxHash, dxHashUtils, dxSpellCheckerStrs,
  dxSpellCheckerUtils, dxSpellCheckerDialogs, dxISpellDecompressor,
  dxSpellCheckerCheckAsYouType, dxHunspellDictionary,
...
function GetNextPart(const S: string; var APos: Integer; ADelimiter: WideChar;
  ACanBeSpace: Boolean = True): string;
var
  ALen: Integer;
begin
  ALen := Length(S);
  ...
  while (APos < ALen) and not((ADelimiter = S[APos]) or
    (ACanBeSpace and TdxCharacters.IsWhiteSpace(S[APos]))) do
  begin
...
function TdxSpellCheckerAutoCorrectCustomRule.GetOptions
  : TdxSpellCheckerAutoCorrectOptions;
begin
  Result := TdxSpellCheckerAutoCorrectOptions(FOptionsLink.Ref);
end;

procedure TdxSpellCheckerAutoCorrectCustomRule.SetWordDelimiters
  (const AWordDelimiters: string);
begin
...
procedure TdxSpellCheckerUndoManager.Add(const AMisspelledWord, AReplacement,
  APrevWord: string; const AMisspelledWordStart, AMisspelledWordFinish,
  AReplacementFinish: IdxSpellCheckerPosition);
begin
  FUndoList.Add(TdxSpellCheckerUndoItem.Create(AMisspelledWord, AReplacement,
    APrevWord, AMisspelledWordStart, AMisspelledWordFinish,
    AReplacementFinish));
end;
...
function TdxSpellCheckerUndoManager.GetItem(Index: Integer)
  : TdxSpellCheckerUndoItem;
begin
...
function SpellCheckerExists(AOwner: TComponent;
...
begin
  ...
  begin
    if (AOwner.Components[I] <> AInstance) and
      (AOwner.Components[I] is TdxCustomSpellChecker) then
      Exit(True);
  end;
  Result := False;
end;
...
begin
  ...
  else if TdxSpellCheckerAdapters.CreateAdapter(AEdit, AAdapter) then
    InternalCheck(AAdapter);
end;

procedure TdxCustomSpellChecker.CheckContainer(AContainer: TWinControl;
  ARecursive: Boolean);
begin
...
function TdxCustomSpellChecker.CanCheckControlInContainer
  (AControl: TWinControl): Boolean;
begin
  Result := TdxSpellCheckerAdapters.IsSupported(AControl);
end;

function TdxCustomSpellChecker.FindDictionaryByWord(const AWord: string)
  : TdxCustomSpellCheckerDictionary;
var
...
function TdxCustomSpellChecker.FindFirstEnabledUserDictionary
  : TdxUserSpellCheckerDictionary;
var
  I: Integer;
...
function TdxCustomSpellChecker.GetSuggestions(const AWord: string)
  : TdxSpellCheckerSuggestionList;
var
  ADictionary: TdxCustomSpellCheckerDictionary;
  I: Integer;
...
function TdxCustomSpellChecker.HasWordInDictionaries
...
procedure TdxCustomSpellChecker.LoadDictionaries(AIgnoreDisabled
  : Boolean = True);
begin
...
function TdxCustomSpellChecker.GetTwoWordsDistance(const AWord1,
  AWord2: string): Integer;
begin
  Result := Similarity.GetDistance(PWideChar(WideUpperCase(AWord1)),
    Length(AWord1), PWideChar(WideUpperCase(AWord2)), Length(AWord2)) div 2;
end;
...
function TdxCustomSpellChecker.CreateAutoCorrectManager
  : TdxSpellCheckerCustomAutoCorrectManager;
begin
  Result := TdxSpellCheckerAutoCorrectManager.Create(Self);
end;

function TdxCustomSpellChecker.CreateAutoCorrectOptions
  : TdxSpellCheckerAutoCorrectOptions;
begin
  Result := TdxSpellCheckerAutoCorrectOptions.Create(Self);
end;

function TdxCustomSpellChecker.CreateCheckAsYouTypeManager
  : TdxSpellCheckerCustomCheckAsYouTypeManager;
begin
  Result := TdxSpellCheckerCheckAsYouTypeManager.Create(Self);
end;

function TdxCustomSpellChecker.CreateCheckAsYouTypeOptions
  : TdxSpellCheckerCheckAsYouTypeOptions;
begin
...
function TdxCustomSpellChecker.CreateSingleWordParser
  : TdxSpellCheckerSingleWordParser;
begin
  Result := TdxSpellCheckerSingleWordParser.Create(Self);
end;

function TdxCustomSpellChecker.CreateSpellingOptions
  : TdxSpellCheckerSpellingOptions;
begin
  Result := TdxSpellCheckerSpellingOptions.Create(Self);
end;

function TdxCustomSpellChecker.DoAddWord(AUserDictionary
  : TdxUserSpellCheckerDictionary; const AWord: string): Boolean;
begin
  Result := False;
...
function TdxCustomSpellChecker.DoAutoCorrect
  (ARule: TdxSpellCheckerAutoCorrectCustomRule;
...
function TdxCustomSpellChecker.DoAutoCorrectStart
  (AControl: TWinControl): Boolean;
begin
...
function TdxCustomSpellChecker.DoCheckAsYouTypeStart
  (AControl: TWinControl): Boolean;
begin
  Result := Assigned(AControl);
...
begin
  ...
  try
    ...
    begin
      ...
      if not AControl.CanFocus or
        (not ARecursive and (AControl.Parent <> AContainer)) then
        Continue;
      AContinue := True;
...
function TdxCustomSpellChecker.DoCheckWord(const AWord: string;
  var AValid: Boolean): Boolean;
begin
  Result := False;
...
procedure TdxCustomSpellChecker.DoGetSuggestions(const AWord: string;
  ASuggestions: TdxSpellCheckerSuggestionList);
begin
...
function TdxCustomSpellChecker.GetDialogCheckModeClass
  : TdxSpellCheckerCustomCheckModeClass;
begin
...
procedure TdxCustomSpellChecker.LoadDictionariesDirect(AIgnoreDisabled
  : Boolean = True);
var
  ADictionary: TdxCustomSpellCheckerDictionary;
  I: Integer;
...
procedure TdxCustomSpellChecker.LoadDictionariesUsingThread(AIgnoreDisabled
  : Boolean = True);
var
  ADictionary: TdxCustomSpellCheckerDictionary;
  I: Integer;
...
procedure TdxCustomSpellChecker.Notification(AComponent: TComponent;
...
procedure TdxCustomSpellChecker.SpellingOptionsChanged
  (AChangeType: TdxChangeType = ctMedium);
begin
...
begin
  ...
  try
    if ActiveDictionaryCount = 0 then
      raise EdxSpellCheckerException.Create
        (cxGetResourceString(@sdxSpellCheckerNoActiveDictionaries));
    ...
    try
      ...
      try
        ...
        begin
          LastDialogResult := (CheckMode as TdxSpellCheckerDialogCheckMode)
            .ShowDialog;
...
function TdxCustomSpellChecker.InternalIsValidWord(const AWord: string)
  : Boolean;
begin
  CheckingLock.Enter;
  try
...
function TdxCustomSpellChecker.InternalIsValidWord(const AWord: string;
  AHelper: IdxSpellCheckerCheckModeHelper): Boolean;
begin
  CheckingLock.Enter;
  try
...
procedure TdxCustomSpellChecker.ReleaseCheckModeHelper
  (AHelper: IdxSpellCheckerCheckModeHelper);
begin
  CheckingLock.Enter;
  try
...
procedure TdxCustomSpellChecker.SetCheckModeHelper
  (AHelper: IdxSpellCheckerCheckModeHelper);
begin
  CheckingLock.Enter;
  try
...
function TdxCustomSpellChecker.IsSpellCheckerDialogControl
  (AWnd: THandle): Boolean;
begin
  Result := CheckAsYouTypeManager.Active and
    (CheckAsYouTypeManager.ManualCheckCount > 0);
end;
...
function TdxCustomSpellChecker.QueryPopup(APopup: TComponent;
...
// IdxSpellChecker3
function TdxCustomSpellChecker.AutoCorrect(AControl: TWinControl;
  const AController: IdxSpellCheckTextController;
  var AInfo: TdxSpellCheckerAutoCorrectWordInfo): Boolean;
var
...
function TdxCustomSpellChecker.GetAutoCorrectOptions
  : TdxSpellCheckerCustomAutoCorrectOptions;
begin
  Result := AutoCorrectOptions;
end;

function TdxCustomSpellChecker.GetCheckAsYouTypeOptions
  : TdxSpellCheckerCustomCheckAsYouTypeOptions;
begin
  Result := CheckAsYouTypeOptions;
end;

function TdxCustomSpellChecker.CheckAsync(AControl: TWinControl;
  const AController: IdxSpellCheckTextController;
  const AFrom, ATo: IdxSpellCheckerPosition;
  AProc: IdxSpellChecker3CheckCallbackProc;
  const APrevWord: string = ''): Boolean;
const
  Map: array [TdxSpellCheckerSpellingCode] of TdxSpellingError = (seUnknown,
    seMisspelling, seRepeating);
var
      ...
      try
        ...
        begin
          Result := AProc(TdxSpellingErrorInfo.Create(ACheckMode.MisspelledWord,
            ACheckMode.FMisspellingStart, ACheckMode.FMisspellingFinish,
            Map[ACheckMode.LastCode]));
          ACheckMode.Skip;
        end;
      finally
        ACheckMode.Free;
...
function TdxCustomSpellChecker.GetSuggestionsEx(const AWord: string)
  : TArray<string>;
var
...
procedure TdxCustomSpellChecker.IgnoreAll(AControl: TControl;
  const AWord: string);
begin
...
procedure TdxCustomSpellChecker.RegisterIgnoreList(AControl: TControl;
  const AIgnoreList: IdxSpellCheckerIgnoreList);
begin
...
procedure TdxCustomSpellChecker.AddDialogCheckModeChangeHandler
  (AEvent: TNotifyEvent);
begin
  OnDialogCheckModeChanged.Add(AEvent);
end;

procedure TdxCustomSpellChecker.RemoveDialogCheckModeChangeHandler
  (AEvent: TNotifyEvent);
begin
  OnDialogCheckModeChanged.Remove(AEvent);
end;

procedure TdxCustomSpellChecker.AddSpellingOptionsChangedHandler
  (AEvent: TNotifyEvent);
begin
  OnSpellingOptionsChanged.Add(AEvent);
end;

procedure TdxCustomSpellChecker.RemoveSpellingOptionsChangedHandler
  (AEvent: TNotifyEvent);
begin
...
procedure TdxCustomSpellChecker.AutoCorrectOptionsChangedHandler
  (Sender: TObject);
begin
...
procedure TdxCustomSpellChecker.CheckAsYouTypeOptionsChangedHandler
  (Sender: TObject);
begin
...
function TdxCustomSpellChecker.GetActiveDictionary(Index: Integer)
  : TdxCustomSpellCheckerDictionary;
var
  I, J: Integer;
  ADictionary: TdxCustomSpellCheckerDictionary;
...
begin
  Result := FCheckMode;
  if (Result = nil) and Assigned(CheckAsYouTypeManager) and
    CheckAsYouTypeManager.Active then
    Result := CheckAsYouTypeManager.CheckMode;
end;

function TdxCustomSpellChecker.GetDictionary(Index: Integer)
  : TdxCustomSpellCheckerDictionary;
var
  I, J: Integer;
  ADictionary: TdxCustomSpellCheckerDictionary;
...
function TdxCustomSpellChecker.GetEnabledDictionary(Index: Integer)
  : TdxCustomSpellCheckerDictionary;
var
  I, J: Integer;
  ADictionary: TdxCustomSpellCheckerDictionary;
...
function TdxCustomSpellChecker.GetUserDictionary(Index: Integer)
  : TdxUserSpellCheckerDictionary;
var
  I, J: Integer;
begin
  ...
  begin
    ...
    begin
      if J = Index then
      begin
        Result := TdxUserSpellCheckerDictionary
          (DictionaryItems[I].DictionaryType);
        Exit;
      end;
      Inc(J);
    end;
...
procedure TdxCustomSpellChecker.SetAutoCorrectOptions
  (AValue: TdxSpellCheckerAutoCorrectOptions);
begin
...
begin
  ...
  UndoManager.Add(MisspelledWord, AWord, '', AStart, AFinish,
    FMisspellingFinish);
end;
...
begin
  ...
  begin
    if SpellChecker.SpellingOptions.CheckFromCursorPos or IsCheckingSelectedText
    then
...
begin
  UndoManager.Add(MisspelledWord, MisspelledWord, PrevWord, FMisspellingStart,
    FMisspellingFinish, FMisspellingFinish);
  inherited Ignore;
end;
...
begin
  Result := SpellChecker.SpellingOptions.CheckSelectedTextFirst and
    (FSaveSelFinish.Compare(FSaveSelStart) > 0);
end;
...
begin
  ...
  begin
    ...
    FMisspellingFinish := Controller.CreatePosition
      (AMisspellingFinish + ADelta);
...
function TdxSpellCheckerDialogCheckMode.ValidateSpellingBounds: Boolean;
  ...
  begin
    Result := MessageDlg
      (cxGetResourceString(@sdxSpellCheckerSelectionCheckIsFinished),
      mtInformation, [mbYes, mbNo], 0) = mrYes;
  end;

  procedure SetBeforeSelectionBounds(const ASpellingStart
    : IdxSpellCheckerPosition);
  begin
    PrevWord := '';
...
begin
  Result := False;
  if (SpellChecker.SpellingOptions.CheckFromCursorPos or IsCheckingSelectedText)
    and not SpellChecker.CheckingContainer then
  begin
    ...
    begin
      ...
      begin
        if (FCheckedRange = dxAfterSelectionChecked) and
          (FMisspellingStart.Compare(ASpellingStart) > 0) then
        begin
          SetBeforeSelectionBounds(ASpellingStart);
          FCheckedRange := dxBeforeSelectionChecked;
          Result := True;
        end;
        if (FCheckedRange = dxSelectionChecked) and ShowCheckEntireDocumentConfirmation
        then
        begin
    ...
    else if (FSpellingStart.Compare(ASpellingStart) > 0) and
      ((FMisspellingStart.Compare(ASpellingEnd) >= 0) or
      (FMisspellingStart.Compare(FSpellingStart) < 0)) then
    begin
      SetBeforeSelectionBounds(ASpellingStart);
      Result := True;
    end;
...
begin
  ...
  if (FMisspellingStart.Compare(FSpellingFinish) >= 0) and
    (FSpellingFinish.Compare(ASpellingFinish) < 0) then
  begin
    FCheckedRange := dxAfterSelectionChecked;
...
begin
  ...
  UndoManager.Add(AMisspelledSentence.Text, ASentence, '',
    AMisspelledSentence.TextPositionStart,
    AMisspelledSentence.TextPositionFinish, FMisspellingFinish);
  UpdateTextInfo;
  FMisspellingStart := AMisspelledSentence.TextPositionStart;
end;
...
function TdxSpellCheckerWordCheckMode.GetMisspelledSentence
  : TdxSpellCheckerSentence;
begin
  Result.TextPositionStart := Controller.GetSentenceStartPosition
    (FMisspellingStart);
  Result.TextPositionFinish := Controller.GetSentenceFinishPosition
    (FMisspellingStart);
  Result.Text := Controller.GetWord(Result.TextPositionStart,
    Result.TextPositionFinish);
  Result.MisspelledWordPositionStart := FMisspellingStart;
  Result.MisspelledWordPositionFinish := FMisspellingFinish;
  Result.MisspelledWordPositionInText :=
    Length(Controller.GetWord(Result.TextPositionStart, FMisspellingStart));
end;
...
constructor TdxSpellCheckerSingleWordParser.Create(ASpellChecker
  : TdxCustomSpellChecker);
begin
  inherited Create;
...
function TdxSpellCheckerSingleWordParser.WordExists
  (const AWord: string): Boolean;
begin
...
constructor TdxSpellCheckerWordList.Create(ALangID: Cardinal;
  ATableSize: Integer);
begin
  inherited Create;
    ...
    begin
      repeat
        ...
        if (AWordLen = ASrcLen) and
          (CompareStringW(LangID, NORM_IGNORECASE, AWord, AWordLen, P, ASrcLen)
          = CSTR_EQUAL) then
        begin
          ...
          begin
            ...
            if (CT1 <> CT2) and
              ((CT2 = ctLower) or ((CT2 = ctCapitalized) and (CT1 = ctUpper)))
            then
...
begin
  ...
  if not UseDoubleMetaphone or (ASrcLen = 0) or (ASuggestionBuilder = nil) or
    Find(AWord) then
    Exit;
  ...
  begin
    ...
    begin
      ...
      ASuggestionBuilder.CheckAddMetaphoneSuggestion(ATestWord, @ABuffer,
        ATestLen, @FUpperCaseBuffer, ASrcLen);
    end;
...
function TdxSpellCheckerWordList.ElfHash(P: PWideChar;
  ALength: Integer): Integer;
begin
  Result := dxElfHash(P, ALength, @FUpperCaseBuffer, SizeOf(FUpperCaseBuffer)
    div SizeOf(WideChar));
end;
...
begin
  ...
  begin
    ...
    if (AResultLen = ASrcLen) and
      (CompareStringW(LangID, NORM_IGNORECASE, Result, AResultLen, P, ASrcLen)
      = CSTR_EQUAL) then
      Exit;
...
function TdxSpellCheckerWordList.NewWord(S: PWideChar; ALength: Integer)
  : PWideChar;
begin
...
function TdxSpellCheckerWordList.GetNextMetaphoneWord(AWord: PWideChar)
  : Pointer;
begin
  if AWord = nil then
    Result := nil
...
procedure TdxSpellCheckerWordList.SetNextMetaphoneWord(AWord: PWideChar;
  AValue: Pointer);
begin
  if AWord <> nil then
...
procedure TdxSpellCheckerWordList.SetNextWord(AWord: PWideChar;
  AValue: Pointer);
begin
  if AWord <> nil then
...
procedure TdxSpellCheckerWordList.UpdateMetaphoneInfo(ANewWord: PWideChar;
  ALength: Integer);
var
  AKey: Word;
  AWord, ATemp: PWideChar;
...
begin
  ...
  begin
    ...
    begin
      ...
      begin
        AWordLen := WordLength(AWord);
        LCMapStringW(LangID, LCMAP_UPPERCASE, AWord, AWordLen,
          @FUpperCaseBuffer, SizeOf(FUpperCaseBuffer) div SizeOf(WideChar));
...
begin
  ...
  begin
    DictionaryTypeClassName := TdxSpellCheckerDictionaryItem(Source)
      .DictionaryTypeClassName;
...
function TdxSpellCheckerDictionaryItem.GetCollection
  : TdxSpellCheckerDictionaries;
begin
...
begin
  ...
  begin
    with GetRegisteredDictionaryTypes do
      DictionaryTypeClass := TdxCustomSpellCheckerDictionaryClass
        (FindByClassName(AValue));
  end;
end;

{ TdxSpellCheckerDictionaries }

constructor TdxSpellCheckerDictionaries.Create(ASpellChecker
  : TdxCustomSpellChecker);
begin
...
function TdxSpellCheckerDictionaries.GetItem(Index: Integer)
  : TdxSpellCheckerDictionaryItem;
begin
...
begin
  ...
  begin
    ...
    FModifyControlPopupMenu := TdxSpellCheckerCheckAsYouTypeOptions(Source)
      .ModifyControlPopupMenu;
  end;
...
procedure TdxSpellCheckerCheckAsYouTypeOptions.Notification
...
function TdxSpellCheckerCheckAsYouTypeOptions.GetSpellChecker
  : TdxCustomSpellChecker;
begin
  Result := TdxCustomSpellChecker(Owner);
end;

procedure TdxSpellCheckerCheckAsYouTypeOptions.SetModifyControlPopupMenu
  (AValue: Boolean);
begin
...
function TdxSpellCheckerIgnoreOnceListsManager.Get(AControl: TControl)
  : IdxSpellCheckerIgnoreList;
begin
...
procedure TdxSpellCheckerIgnoreOnceListsManager.Register(AControl: TControl;
  const AList: IdxSpellCheckerIgnoreList);
begin
  AControl := CheckControl(AControl);
...
function TdxSpellCheckerIgnoreOnceListsManager.CheckControl(AControl: TControl)
  : TControl;
var
...
procedure TdxSpellCheckerIgnoreOnceListsManager.Notification
...
constructor TdxCustomSpellCheckerDictionary.Create(ASpellChecker
  : TdxCustomSpellChecker);
begin
...
function TdxCustomSpellCheckerDictionary.CreateSuggestionBuilder
  : TdxSpellCheckerSuggestionBuilder;
begin
...
procedure TdxCustomSpellCheckerDictionary.UpdateWordChars
  (var AWordChars: string);
begin
end;
...
begin
  ...
  if Source is TdxSpellCheckerDictionary then
    FCheckCapitalization := TdxSpellCheckerDictionary(Source)
      .CheckCapitalization;
end;
...
function TdxSpellCheckerDictionary.IsCorrectCapitalization(const AWord,
  APattern: string): Boolean;
begin
  case GetWordCapitalizationType(APattern) of
    ctLower:
      Result := GetWordCapitalizationType(AWord)
        in [ctLower, ctCapitalized, ctUpper];
    ctUpper:
      Result := GetWordCapitalizationType(AWord) = ctUpper;
    ctCapitalized:
      Result := GetWordCapitalizationType(AWord) in [ctCapitalized, ctUpper];
    ctMixed:
      Result := (AWord = APattern) or
        (GetWordCapitalizationType(AWord) = ctUpper);
  else
    Result := True;
  end;
end;
...
constructor TdxUserSpellCheckerDictionary.Create(ASpellChecker
  : TdxCustomSpellChecker);
begin
  inherited Create(ASpellChecker);
...
begin
  ...
  if not FileExists(DictionaryPath) then
    if not(udFileMustExist in Options) then
      Exit;
...
begin
  ...
  begin
    FIgnoreMixedCaseWords := TdxSpellCheckerSpellingOptions(Source)
      .IgnoreMixedCaseWords;
    FIgnoreUpperCaseWords := TdxSpellCheckerSpellingOptions(Source)
      .IgnoreUpperCaseWords;
    FIgnoreMarkupTags := TdxSpellCheckerSpellingOptions(Source)
      .IgnoreMarkupTags;
    FIgnoreRepeatedWords := TdxSpellCheckerSpellingOptions(Source)
      .IgnoreRepeatedWords;
    FCheckSelectedTextFirst := TdxSpellCheckerSpellingOptions(Source)
      .CheckSelectedTextFirst;
    FIgnoreUrls := TdxSpellCheckerSpellingOptions(Source).IgnoreUrls;
    FCheckFromCursorPos := TdxSpellCheckerSpellingOptions(Source)
      .CheckFromCursorPos;
    FIgnoreEmails := TdxSpellCheckerSpellingOptions(Source).IgnoreEmails;
    FIgnoreWordsWithNumbers := TdxSpellCheckerSpellingOptions(Source)
...
procedure TdxSpellCheckerSpellingOptions.PopulateRules
  (ARules: TdxSpellCheckerRules; AHelper: IdxSpellCheckerCheckModeHelper);
begin
  if AHelper = nil then
    Exit;
...
constructor TdxSpellCheckerCustomManager.Create(ASpellChecker
  : TdxCustomSpellChecker);
begin
  inherited Create(ASpellChecker);
  FContainer := nil;
...
function TdxSpellCheckerCustomManager.CreateAdapter(AControl: TWinControl;
  out AAdapter: IdxSpellCheckerAdapter): Boolean;
begin
...
function TdxSpellCheckerCustomManager.GetCheckModeClass
  : TdxSpellCheckerCustomCheckModeClass;
begin
...
procedure TdxSpellCheckerCustomManager.InitializeController
  (AControl: TWinControl);
...
procedure TdxSpellCheckerCustomCheckAsYouTypeManager.KeyDown(AKey: Word;
  Shift: TShiftState);
begin
end;

procedure TdxSpellCheckerCustomCheckAsYouTypeManager.KeyUp(AKey: Word;
  Shift: TShiftState);
begin
end;

procedure TdxSpellCheckerCustomCheckAsYouTypeManager.InnerShowPopupMenu
  (APopup: TComponent; const P: TPoint);
begin
...
function TdxSpellCheckerCustomCheckAsYouTypeManager.
  GetIsSpellCheckerReady: Boolean;
begin
  Result := SpellChecker.ActiveDictionaryCount > 0;
end;

function TdxSpellCheckerCustomCheckAsYouTypeManager.GetOptions
  : TdxSpellCheckerCheckAsYouTypeOptions;
begin
  Result := SpellChecker.CheckAsYouTypeOptions;
end;

procedure TdxSpellCheckerCustomCheckAsYouTypeManager.DoFinish
  (AControl: TWinControl);
begin
  SpellChecker.DoCheckAsYouTypeFinish(AControl);
end;

function TdxSpellCheckerCustomCheckAsYouTypeManager.DoStart
  (AControl: TWinControl): Boolean;
begin
...
procedure TdxSpellCheckerIgnoreList.Add(const AStart,
...
function TdxSpellCheckerIgnoreList.Contains(const AStart,
  AEnd: IdxSpellCheckerPosition; const AWord: string): Boolean;
begin
  Result := Contains(AWord)
end;

procedure TdxSpellCheckerIgnoreList.Remove(const AStart,
  AEnd: IdxSpellCheckerPosition; const AWord: string);
begin
  Remove(AWord)
end;
...
begin
  raise EdxSpellCheckerException.Create
    ('TdxSpellCheckerIgnoreList.Remove not implemented');
end;
...
begin
  Result := inherited CreateAdapter(AControl, AAdapter) and
    Supports(AAdapter, IdxSpellCheckerAutoCorrectAdapter);
end;
...
procedure TdxSpellCheckerCustomAutoCorrectManager.DoFinish
  (AControl: TWinControl);
begin
  SpellChecker.DoAutoCorrectFinish(AControl);
end;

function TdxSpellCheckerCustomAutoCorrectManager.DoStart
  (AControl: TWinControl): Boolean;
begin
...
function TdxSpellCheckerCustomAutoCorrectManager.GetOptions
  : TdxSpellCheckerAutoCorrectOptions;
begin
...
constructor TdxSpellCheckerSuggestionCacheItem.Create(const AWord: string;
  ASuggestions: TdxSpellCheckerSuggestionList);
begin
  inherited Create;
...
constructor TdxSpellCheckerPersistent.Create(ASpellChecker
  : TdxCustomSpellChecker);
begin
  inherited Create;
  FSpellChecker := ASpellChecker;
...
procedure TdxSpellCheckerSuggestionList.Add(const AWord: string;
  ADictionary: TdxCustomSpellCheckerDictionary; ADistance: Integer);
var
...
procedure TdxSpellCheckerSuggestionList.Assign(ASuggestions
  : TdxSpellCheckerSuggestionList);
var
  I: Integer;
  AItem: TdxSpellCheckerSuggestion;
...
procedure TdxSpellCheckerSuggestionList.Insert(AIndex: Integer;
  const AWord: string; ADictionary: TdxCustomSpellCheckerDictionary;
  ADistance: Integer);
var
  AItem: TdxSpellCheckerSuggestion;
begin
...
begin
  Result := TdxSpellCheckerSuggestion(Item1).Distance -
    TdxSpellCheckerSuggestion(Item2).Distance;
  if Result = 0 then
    Result := TdxSpellCheckerSuggestion(Item1).FOrder -
      TdxSpellCheckerSuggestion(Item2).FOrder;
end;
...
begin
  Result := WideCompareText(TdxSpellCheckerSuggestion(Item1).Word,
    TdxSpellCheckerSuggestion(Item2).Word);
  if Result = 0 then
    Result := TdxSpellCheckerSuggestion(Item1).FOrder -
      TdxSpellCheckerSuggestion(Item2).FOrder;
end;
...
function TdxSpellCheckerSuggestionList.GetItem(Index: Integer)
  : TdxSpellCheckerSuggestion;
begin
...
function TdxSpellCheckerAutoCorrectOptions.GetReplacement(const AText: string;
...
begin
  ...
  else if AutomaticallyUseSuggestions and WordContainsOnlyAlpha(AText) then
  begin
...
function TdxSpellCheckerAutoCorrectOptions.GetSpellChecker
  : TdxCustomSpellChecker;
begin
  Result := TdxCustomSpellChecker(Owner);
end;
...
constructor TdxSpellCheckerUndoItem.Create(const AMisspelledWord, AReplacement,
  APrevWord: string; const AMisspelledWordStart, AMisspelledWordFinish,
  AReplacementFinish: IdxSpellCheckerPosition);
begin
  inherited Create;
...
constructor TdxSpellCheckerAbstractCheckMode.Create
...
function TdxSpellCheckerAbstractCheckMode.CheckWord(const AWord: string)
...
function TdxSpellCheckerAbstractCheckMode.GetNextWord
  (out AWord: string): Boolean;
var
  ADelimiters: string;
...
function TdxSpellCheckerAbstractCheckMode.InternalCheckWord(var AWord: string)
  : TdxSpellCheckerSpellingCode;
var
  AWordLength: Integer;
...
begin
  ...
  begin
    ...
    if (Pos(AWord[AWordLength], MeaningfulCharacters) > 0) and
      not WideIsAlphaNumeric(AWord[AWordLength]) then
    begin
...
function TdxSpellCheckerAbstractCheckMode.InternalProcessWord
  (const AWord: string): Boolean;
begin
  Result := not Controller.IsRangeEditable(FMisspellingStart,
    FMisspellingFinish) or IsNeedIgnoreWord(AWord);
  if Result then
  begin
...
function TdxSpellCheckerAbstractCheckMode.IsNeedIgnoreWord
  (const AWord: string): Boolean;
var
  AActualWord: string;
  AWordLength: Integer;
...
function TdxSpellCheckerAbstractCheckMode.IsValidWord
  (const AWord: string): Boolean;
begin
...
function TdxSpellCheckerAbstractCheckMode.WordExists
  (const AWord: string): Boolean;
begin
  Result := SpellChecker.HasWordInDictionaries(AWord);
end;
...
function TdxSpellCheckerCustomCheckMode.GetSuggestions(const AWord: string)
  : TdxSpellCheckerSuggestionList;
begin
...
begin
  ...
  if not Result then
    ...
    else if IsNeedDeleteWord(AWord) then
    begin
      Delete;
      Result := True;
    end;
...
begin
  SpellChecker.IgnoreOnce(IgnoreOnceList, MisspelledWord, FMisspellingStart,
    FMisspellingFinish);
  Skip;
end;
...
procedure TdxSpellCheckerCustomCheckMode.ReplaceWord(var AStart,
  AFinish: IdxSpellCheckerPosition; const AWord, APrevWord: string);
begin
...
function TdxSpellCheckerCustomCheckMode.IsNeedChangeWord(const AWord: string;
  out AReplacement: string): Boolean;
var
  AItem: TdxSpellCheckerReplacement;
...
function TdxSpellCheckerCustomCheckMode.IsNeedDeleteWord
  (const AWord: string): Boolean;
begin
...
procedure TdxSpellCheckerSuggestionCache.Add(const AWord: string;
  ASuggestions: TdxSpellCheckerSuggestionList);
var
...
function TdxSpellCheckerSuggestionCache.Find(const AWord: string)
  : TdxSpellCheckerSuggestionCacheItem;
var
  I: Integer;
begin
...
function TdxSpellCheckerSuggestionCache.GetItem(Index: Integer)
  : TdxSpellCheckerSuggestionCacheItem;
begin
...
function TdxSpellCheckerSuggestionCache.GetSuggestions(const AWord: string;
  ASuggestions: TdxSpellCheckerSuggestionList): Boolean;
var
  AItem: TdxSpellCheckerSuggestionCacheItem;
begin
...
procedure TdxSpellCheckerSuggestionBuilder.AddSuggestions(const AWord: string;
  ASuggestions: TdxSpellCheckerSuggestionList);
begin
  if (ASuggestions = nil) or (Length(AWord) = 0) then
    Exit;
...
function TdxSpellCheckerSuggestionBuilder.CanAddToSuggestions(const ATestWord
  : string): Boolean;
begin
...
function TdxSpellCheckerSuggestionBuilder.GetSimilarity
...
GetRegisteredDictionaryTypes.Register(TdxUserSpellCheckerDictionary,
  cxGetResourceString(@sdxSpellCheckerUserDictionary));
