...
resourcestring
  ...
  sdxOrgChartEditorHintApplyForAllChildren =
    'Set properties for all children of selected item';
...
begin
  ...
  AProduct.Add('sdxOrgChartEditorHintAntialiasing',
    @sdxOrgChartEditorHintAntialiasing);
  AProduct.Add('sdxOrgChartEditorHintApplyForAllChildren',
    @sdxOrgChartEditorHintApplyForAllChildren);
  AProduct.Add('sdxOrgChartEditorHintDeleteItem',
    @sdxOrgChartEditorHintDeleteItem);
  AProduct.Add('sdxOrgChartEditorHintInsertItem',
    @sdxOrgChartEditorHintInsertItem);
  AProduct.Add('sdxOrgChartEditorHintInsertSubItem',
...
dxResourceStringsRepository.RegisterProduct('ExpressOrgChart',
  @AddOrgChartResourceStringNames);
