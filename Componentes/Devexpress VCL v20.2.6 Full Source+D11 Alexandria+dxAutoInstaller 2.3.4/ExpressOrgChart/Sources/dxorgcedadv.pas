...
uses
  ...
  StdCtrls, Buttons, ExtCtrls, Menus, dxCore,
  dxorgchr, cxGraphics, cxControls, cxLookAndFeels, cxLookAndFeelPainters,
  cxContainer, cxEdit, cxGroupBox, cxLabel,
...
begin
  ...
  MultiButton.Hint := cxGetResourceString
    (@sdxOrgChartEditorHintApplyForAllChildren);
  ...
  btnAntialiasing.Hint := cxGetResourceString
    (@sdxOrgChartEditorHintAntialiasing);
...
procedure TfrmOrgChartAdvEditor.FormClose(Sender: TObject;
...
procedure TfrmOrgChartAdvEditor.WidthEditKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure TfrmOrgChartAdvEditor.ColorEditKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure TfrmOrgChartAdvEditor.PreparePreview(APreview,
