...
begin
  ...
  try
    ...
    if (AComponent.ListSource <> nil) and (AComponent.ListSource.DataSet <> nil)
    then
    begin
...
begin
  ...
  RegisterPropertyEditor(TypeInfo(string), TdxBarLookupCombo, 'KeyField',
    TdxBarLookupComboFieldProperty);
  RegisterPropertyEditor(TypeInfo(string), TdxBarLookupCombo, 'ListField',
    TdxBarLookupComboFieldProperty);
end;
