...
{$ENDIF}
  ...
  cxStyles, cxLookAndFeels, dxCoreGraphics,
...
type
  ...
  TdxRibbonBackstageViewCustomViewInfo = class
    (TdxRibbonBackstageViewCustomObject)
  strict private
    FBounds: TRect;
  ...
  TdxRibbonBackstageViewMenuBarAccessibilityHelper = class
  ...
  protected
    ...
    function CanUnselectOnKeyDown(AKey: Word; AKeyTipsWereHidden: Boolean)
      : Boolean; override;
  ...
  public
    function GetDefaultSelectableObject(ADirection
    ...
    property MenuBarControl: TdxRibbonBackstageViewMenuBarControl
      read GetMenuBarControl;
  end;
  ...
  protected
    ...
    function CalcColumnItemRect(AItemLink: TdxBarItemLink;
      const AItemsRect: TRect): TRect; override;
    ...
    procedure NavigationHandler(var ACharCode: Word;
    ...
    //
    property BackstageView: TdxRibbonCustomBackstageView read GetBackstageView;
    property MenuViewInfo: TdxRibbonBackstageViewMenuViewInfo
      read GetMenuViewInfo;
  public
  ...
  protected
    procedure DoCalcSeparatorInfo(AItemLink: TdxBarItemLink;
  ...
  TdxRibbonBackstageViewPainter = class(TcxIUnknownObject,
  ...
  public
    ...
    procedure DockControlFillBackground(ADockControl: TdxDockControl; DC: HDC;
      ADestR: TRect; ASourceR: TRect; AWholeR: TRect; ABrush: HBRUSH;
    ...
    function MenuBarButtonTextColor(const ADrawParams
      : TdxBarButtonLikeControlDrawParams): TColor; virtual;

    // Tabs
    procedure DrawTabButtonBackground(DC: HDC; R: TRect;
      AState: Integer); virtual;
    function GetTabButtonState(const ADrawParams
      : TdxBarButtonLikeControlDrawParams): Integer; virtual;
    ...
    function TabButtonTextColor(const ADrawParams
      : TdxBarButtonLikeControlDrawParams): TColor; overload; virtual;
  ...
  protected
    ...
    procedure CMDesignHitTest(var Message: TCMDesignHitTest);
      message CM_DESIGNHITTEST;
  public
    constructor Create(AMenuViewInfo: TdxRibbonBackstageViewMenuViewInfo);
      reintroduce;
    //
    property BackstageView: TdxRibbonCustomBackstageView read GetBackstageView;
    property MenuViewInfo: TdxRibbonBackstageViewMenuViewInfo
  ...
  protected
    ...
    procedure Draw(const ADrawParams: TdxBarButtonLikeControlDrawParams;
      const R: TRect); virtual;
    procedure DrawBackground(const ADrawParams
      : TdxBarButtonLikeControlDrawParams; const R: TRect); virtual;
    procedure DrawContent(const ADrawParams: TdxBarButtonLikeControlDrawParams;
      R: TRect); virtual;
  ...
  protected
    ...
    procedure Changed(AChanges: TdxRibbonBackstageViewChanges = [rbvcTabsData]
      ); virtual;
    ...
    property Painter: TdxRibbonBackstageViewPainter read GetPainter
      implements IdxCustomSkinnedContainer;
  ...
  public
    ...
    //
    property BackstageView: TdxRibbonCustomBackstageView read FBackstageView
      write SetBackstageView;
    property Images: TCustomImageList read GetImages;
  published
    property Active: Boolean read GetActive write SetActive default False;
    property BeginGroup: Boolean read FBeginGroup write SetBeginGroup
      default False;
    ...
    property PageIndex: Integer read GetPageIndex write SetPageIndex
      stored False;
    property SizeOptions: TdxRibbonBackstageViewTabSheetSizeOptions
      read FSizeOptions write SetSizeOptions;
  ...
  public
    property Items[Index: Integer]: TdxRibbonBackstageViewTabSheet
  ...
  protected
    function GetControlClass(AIsVertical: Boolean)
      : TdxBarItemControlClass; override;
  public
    constructor Create(AOwner: TComponent); override;
  ...
  TdxRibbonBackstageViewTabSheetButtonControlAccessibilityHelper = class
  ...
  TdxRibbonBackstageViewTabSheetButtonControl = class
    (TdxRibbonBackstageViewMenuBarCustomButtonControl)
  strict private
    function GetItem: TdxRibbonBackstageViewTabSheetButton;
  protected
    procedure ActivateTab;
    procedure ControlActivate(AImmediately: Boolean;
      AByMouse: Boolean); override;
  ...
  public
    function GetItemByTab(ATab: TdxRibbonBackstageViewTabSheet)
      : TdxRibbonBackstageViewTabSheetButton;
    procedure RefreshInfo;
    procedure RemoveTab(ATab: TdxRibbonBackstageViewTabSheet);
    //
    property Items[Index: Integer]: TdxRibbonBackstageViewTabSheetButton
      read GetItem; default;
  end;
  ...
  public
    procedure RefreshInfo;
    //
    property Items[Index: Integer]: TdxRibbonBackstageViewMenuBarButton
      read GetItem; default;
  end;
  ...
  TdxRibbonBackstageViewMenuViewInfo = class
    (TdxRibbonBackstageViewCustomViewInfo, IdxBarLinksOwner)
  strict private
  ...
  protected
    procedure AddButton(AButton: TdxRibbonBackstageViewMenuButton;
      APosition: TdxRibbonBackstageViewMenuButtonPosition;
      var ABeginGroup: Boolean);
    procedure AddButtons(APosition: TdxRibbonBackstageViewMenuButtonPosition;
      ABeginGroup: Boolean);
    procedure AddTabButton(ATab: TdxRibbonBackstageViewTabSheet;
      var ABeginGroup: Boolean);
    procedure AddTabButtons(ABeginGroup: Boolean);

    function CreatePainter(AData: TdxNativeUInt)
      : TdxRibbonBackstageViewMenuPainter; virtual;
    ...
    property MenuButtonList: TdxRibbonBackstageViewMenuButtonList
      read FMenuButtonList;
    property Painter: TdxRibbonBackstageViewMenuPainter read FPainter;
    property TabButtonList: TdxRibbonBackstageViewTabSheetButtonList
      read FTabButtonList;
  public
    ...
    property BarControl: TdxRibbonBackstageViewMenuBarControl
      read GetBarControl;
    property DockControl: TdxRibbonBackstageViewMenuDockControl
      read FDockControl;
  ...
  strict private
    ...
    procedure CheckScrollPosition(var AValue: Integer;
      AContentSize, ADisplaySize: Integer);
  ...
  public
    ...
    //
    property ActiveTab: TdxRibbonBackstageViewTabSheet read GetActiveTab;
    property ActiveTabItemControl: TdxBarItemControl
      read GetActiveTabItemControl;
    ...
    property MenuViewInfo: TdxRibbonBackstageViewMenuViewInfo
      read FMenuViewInfo;
    property ScrollPositionX: Integer read FScrollPositionX
      write SetScrollPositionX;
    property ScrollPositionY: Integer read FScrollPositionY
      write SetScrollPositionY;
  end;
  ...
  public
    ...
    procedure RefreshInfo;
    //
    property MenuButton: TdxRibbonBackstageViewMenuButton read FMenuButton
      write SetMenuButton;
  end;
  ...
  published
    ...
    property Position: TdxRibbonBackstageViewMenuButtonPosition read FPosition
      write SetPosition default mbpBeforeTabs;
  end;
  ...
  public
    ...
    //
    property Items[Index: Integer]: TdxRibbonBackstageViewMenuButton
      read GetItem write SetItem; default;
  end;

  { TdxRibbonBackstageViewMenuBarButtonControl }

  TdxRibbonBackstageViewMenuBarButtonControl = class
    (TdxRibbonBackstageViewMenuBarCustomButtonControl)
  strict private
  ...
  TdxRibbonBackstageViewApplicationMenuHelper = class(TInterfacedObject,
  ...
  protected
    ...
    function Popup(ARibbon: TdxCustomRibbon; var AClosedByEscape: Boolean)
      : Boolean; virtual;
  ...
  TdxRibbonBackstageViewCustomButtonViewInfo = class
    (TdxRibbonBackstageViewCustomViewInfo)
  strict private
  ...
  TdxRibbonBackstageViewNonClientViewInfo = class
    (TdxRibbonBackstageViewCustomViewInfo)
  strict private
  ...
  protected
    ...
    function CreateBackButtonViewInfo
      : TdxRibbonBackstageViewBackButtonViewInfo; virtual;
    procedure DoRightToLeftConversion(const ABounds: TRect); override;
  ...
  public
    ...
    //
    property BackButtonViewInfo: TdxRibbonBackstageViewBackButtonViewInfo
    ...
    property DisplayMode: TdxRibbonApplicationMenuDisplayMode
      read GetDisplayMode;
    ...
    property MenuViewInfo: TdxRibbonBackstageViewMenuViewInfo
      read GetMenuViewInfo;
    property Ribbon: TdxCustomRibbon read GetRibbon;
    property RibbonFormCaptionHelper: TdxRibbonFormCaptionHelper
      read GetRibbonFormCaptionHelper;
  ...
  TdxRibbonBackstageViewNonClientController = class
    (TdxRibbonBackstageViewCustomObject, IcxMouseTrackingCaller,
  ...
  strict private
    ...
    procedure SetHoveredCell(AValue
      : TdxRibbonBackstageViewCustomButtonViewInfo);
    procedure SetPressedCell(AValue
      : TdxRibbonBackstageViewCustomButtonViewInfo);
  protected
  ...
  public
    ...
    function HitTest(const P: TPoint)
      : TdxRibbonBackstageViewCustomButtonViewInfo; virtual;
    ...
    //
    property HoveredCell: TdxRibbonBackstageViewCustomButtonViewInfo
      read FHoveredCell write SetHoveredCell;
    property PressedCell: TdxRibbonBackstageViewCustomButtonViewInfo
      read FPressedCell write SetPressedCell;
  ...
  protected
    ...
    property ActiveTabIsSolidBackground: Boolean
      read FActiveTabIsSolidBackground;
    ...
    property MenuViewInfo: TdxRibbonBackstageViewMenuViewInfo
      read GetMenuViewInfo;
    property NonClientViewInfo: TdxRibbonBackstageViewNonClientViewInfo
      read GetNonClientViewInfo;
  ...
  TdxRibbonBackstageViewAssignedFonts = set of
    TdxRibbonBackstageViewAssignedFont;
  ...
  protected
    ...
    procedure ResetFont(AFont: TFont;
      AIndex: TdxRibbonBackstageViewAssignedFont); virtual;
  ...
  published
    property AssignedFonts: TdxRibbonBackstageViewAssignedFonts
      read FAssignedFonts write SetAssignedFonts default [];
    property MainMenuButton: TFont index 0 read GetFont write SetFont
      stored IsFontStored;
    property MainMenuTab: TFont index 1 read GetFont write SetFont
      stored IsFontStored;
  end;

  { TdxRibbonBackstageViewDesignSelectorHelper }

  TdxRibbonBackstageViewDesignSelectorHelper = class
  ...
  TdxRibbonBackstageViewTabChanging = procedure(Sender: TObject;
    ANewTab: TdxRibbonBackstageViewTabSheet; var AAllowChange: Boolean)
    of object;
  TdxRibbonBackstageViewTabClickEvent = procedure(Sender: TObject;
    ATab: TdxRibbonBackstageViewTabSheet) of object;

  TdxRibbonCustomBackstageView = class(TcxControl, IdxRibbonListener,
    IdxRibbonBackstageViewSelectableItem, IdxRibbonMouseWheelReceiver)
  strict private
  ...
  protected
    ...
    function CreateApplicationMenuHelper
      : TdxRibbonBackstageViewApplicationMenuHelper; virtual;
    function CreateNonClientController
      : TdxRibbonBackstageViewNonClientController; virtual;
    function CreateNonClientViewInfo
      : TdxRibbonBackstageViewNonClientViewInfo; virtual;
    ...
    procedure ChangeScaleEx(M, D: Integer; isDpiChange: Boolean); override;
    procedure Changed(const AChanges: TdxRibbonBackstageViewChanges = []
      ); virtual;
    ...
    function GetNextTab(AIndex: Integer)
      : TdxRibbonBackstageViewTabSheet; overload;
    function GetNextTab(ATab: TdxRibbonBackstageViewTabSheet)
      : TdxRibbonBackstageViewTabSheet; overload;
    ...
    function GetScrollBarClass(AKind: TScrollBarKind)
      : TcxControlScrollBarClass; override;
    ...
    property DesignSelector: TdxRibbonBackstageViewDesignSelectorHelper
      read FDesignSelector;
    property IsBarManagerValid: Boolean read GetIsBarManagerValid;
    ...
    property MenuViewInfo: TdxRibbonBackstageViewMenuViewInfo
      read GetMenuViewInfo;
    property NonClientController: TdxRibbonBackstageViewNonClientController
      read FNonClientController;
    property NonClientViewInfo: TdxRibbonBackstageViewNonClientViewInfo
      read FNonClientViewInfo;
  ...
  public
    ...
    procedure RightToLeftConversion(const ABounds: TRect);
    //
    property ActiveTab: TdxRibbonBackstageViewTabSheet read FActiveTab
      write SetActiveTab;
    property Buttons: TdxRibbonBackstageViewMenuButtons read FButtons
      write SetButtons;
    ...
    property ShowMainMenu: Boolean read FShowMainMenu write SetShowMainMenu
      default True;
    ...
    property OnTabChanging: TdxRibbonBackstageViewTabChanging
      read FOnTabChanging write FOnTabChanging;
    property OnTabClick: TdxRibbonBackstageViewTabClickEvent read FOnTabClick
      write FOnTabClick;
  end;
...
constructor TdxRibbonBackstageViewCustomObject.Create(ABackstageView
  : TdxRibbonCustomBackstageView);
begin
  inherited Create;
...
function TdxRibbonBackstageViewCustomObject.GetPainter
  : TdxRibbonBackstageViewPainter;
begin
...
procedure TdxRibbonBackstageViewCustomViewInfo.DoRightToLeftConversion
  (const ABounds: TRect);
begin
  FBounds := TdxRightToLeftLayoutConverter.ConvertRect(FBounds, ABounds);
end;

procedure TdxRibbonBackstageViewCustomViewInfo.RightToLeftConversion
  (const ABounds: TRect);
begin
...
begin
  ...
  if FKeyTipWindowsManager = nil then
    FKeyTipWindowsManager := TdxRibbonBackstageViewKeyTipWindows.Create
      (BackstageView.Ribbon);
...
function TdxRibbonBackstageViewMenuBarAccessibilityHelper.HandleNavigationKey
...
procedure TdxRibbonBackstageViewMenuBarAccessibilityHelper.Select
  (ASetFocus: Boolean);
var
...
function TdxRibbonBackstageViewMenuBarAccessibilityHelper.
  GetDefaultSelectableObject(ADirection: TcxAccessibilityNavigationDirection)
...
begin
  AItemControl := MenuBarControl.BackstageView.ViewInfo.ActiveTabItemControl;
  if AItemControl <> nil then
    Result := AItemControl.IAccessibilityHelper.GetNextAccessibleObject
      (ADirection)
  else
    Result := inherited GetDefaultSelectableObject(ADirection);
end;

procedure TdxRibbonBackstageViewMenuBarAccessibilityHelper.
...
var
  ...
  R: TRect;
begin
  if Supports(AItemLinkHelper.ItemControl,
    IdxRibbonBackstageViewKeyTipPositionInfo, APositionInfo) then
  begin
    ...
    AKeyTipInfo.BasePoint := cxPointOffset(AKeyTipInfo.BasePoint,
      APositionInfo.GetKeyTipBasePoint,
...
function TdxRibbonBackstageViewMenuBarAccessibilityHelper.GetActiveTab
  : TdxRibbonBackstageViewTabSheet;
begin
  Result := MenuBarControl.BackstageView.ActiveTab;
end;

function TdxRibbonBackstageViewMenuBarAccessibilityHelper.GetMenuBarControl
  : TdxRibbonBackstageViewMenuBarControl;
begin
  Result := TdxRibbonBackstageViewMenuBarControl(FOwnerObject);
end;

function TdxRibbonBackstageViewMenuBarAccessibilityHelper.GetBackstageView
  : TdxRibbonCustomBackstageView;
begin
...
procedure TdxRibbonBackstageViewMenuBarControl.CalcColumnItemRects
...
begin
  ...
  begin
    ...
    AItemRect := CalcColumnItemRect(AItemLink, AItemsRect);
    AItemRect := cxRectOffset(AItemRect, 0, AItemsRect.Bottom -
      AItemRect.Bottom);
    AItemLink.ItemRect := AItemRect;
...
function TdxRibbonBackstageViewMenuBarControl.CanAlignControl
...
function TdxRibbonBackstageViewMenuBarControl.CanDrawClippedItem
  (AItemRect: TRect): Boolean;
begin
  Result := True;
end;

procedure TdxRibbonBackstageViewMenuBarControl.DoBarGetFocus
  (ASelectedItem: TdxBarItemControl);
begin
...
procedure TdxRibbonBackstageViewMenuBarControl.DoBarMouseDown
  ...
  begin
    if AItemControl is TdxRibbonBackstageViewMenuBarButtonControl then
      BackstageView.SelectPersistent(TdxRibbonBackstageViewMenuBarButtonControl
        (AItemControl).Item.MenuButton)
    else if AItemControl is TdxRibbonBackstageViewTabSheetButtonControl then
      BackstageView.SelectPersistent(TdxRibbonBackstageViewTabSheetButtonControl
        (AItemControl).Item.Tab);
  end;
...
function TdxRibbonBackstageViewMenuBarControl.GetAccessibilityHelperClass
  : TdxBarAccessibilityHelperClass;
begin
  Result := TdxRibbonBackstageViewMenuBarAccessibilityHelper;
end;

function TdxRibbonBackstageViewMenuBarControl.GetBackstageView
  : TdxRibbonCustomBackstageView;
begin
...
function TdxRibbonBackstageViewMenuBarControl.GetMenuViewInfo
  : TdxRibbonBackstageViewMenuViewInfo;
begin
...
begin
  Result := inherited GetItemControlOffset(AItemLink) +
    MenuViewInfo.Painter.MenuBarIndentBetweenItems;
end;
...
function TdxRibbonBackstageViewMenuBarControl.GetMaxWidth
  (AStyle: TdxBarDockingStyle): Integer;
begin
  Result := GetMinWidth(AStyle);
end;

function TdxRibbonBackstageViewMenuBarControl.GetMinWidth
  (AStyle: TdxBarDockingStyle): Integer;
var
...
begin
  ...
  Result := Max(Result + cxMarginsWidth(GetItemsRectOffset),
    MenuViewInfo.Painter.MenuBarGetMinWidth);
  Result := Max(Result, ScaleFactor.Apply(dxRibbonBackstageViewMinMenuWidth));
end;

function TdxRibbonBackstageViewMenuBarControl.GetNextBarControl
  (AForward: Boolean): TdxBarControl;
begin
  Result := nil;
end;
...
function TdxRibbonBackstageViewMenuBarControl.GetViewInfoClass
...
procedure TdxRibbonBackstageViewMenuBarControl.MakeItemControlFullyVisible
  (AItemControl: TdxBarItemControl);
begin
  if DockControl <> nil then
    BackstageView.MakeFullyVisible(dxMapWindowRect(Handle, BackstageView.Handle,
      AItemControl.ViewInfo.Bounds));
end;

procedure TdxRibbonBackstageViewMenuBarControl.NavigationHandler
  (var ACharCode: Word; AShiftState: TShiftState);
begin
  case ACharCode of
    VK_ESCAPE:
      begin
...
function TdxRibbonBackstageViewMenuBarControl.PreProcessKey(AKey: Word;
...
procedure TdxRibbonBackstageViewMenuBarControl.ShowPopup
...
begin
  if ((Message.Msg = WM_LBUTTONDOWN) or (Message.Msg = WM_LBUTTONDBLCLK)) and
    BackstageView.IsDesigning then
  begin
    if Perform(CM_DESIGNHITTEST, Message.WParam, Message.LParam) = 0 then
      inherited WndProc(Message)
    else if not IsControlMouseMsg(TWMMouse(Message)) then
    begin
...
procedure TdxRibbonBackstageViewMenuBarControl.CMDesignHitTest
...
begin
  Message.Result := 0;
  for I := 0 to ViewInfo.ItemControlCount - 1 do
    if PtInRect(ViewInfo.ItemControlViewInfos[I].Bounds,
...
procedure TdxRibbonBackstageViewMenuBarControl.WMMouseWheel
  (var Message: TWMMouseWheel);
begin
  BackstageView.DoMouseWheel(KeysToShiftState(Message.Keys), Message.WheelDelta,
...
constructor TdxRibbonBackstageViewPainter.Create(ABackstageView
  : TdxRibbonCustomBackstageView);
begin
  inherited Create;
  FBackstageView := ABackstageView;
...
begin
  Result := BackstageView.IsRibbonValid and
    BackstageView.Ribbon.ColorScheme.CanShowTabAreaToolbarInBackstageView;
end;

procedure TdxRibbonBackstageViewPainter.DrawBackButton(ACanvas: TcxCanvas;
  const R: TRect; AState: TcxButtonState);
const
  StateMap: array [TcxButtonState] of Integer = (DXBAR_ACTIVE, DXBAR_NORMAL,
    DXBAR_HOT, DXBAR_PRESSED, DXBAR_DISABLED);
begin
  if Skin <> nil then
    Skin.DrawBackground(ACanvas.Handle, R, DXBAR_BACKSTAGEVIEW_BACKBUTTON,
      StateMap[AState])
  else
    BackstageView.LookAndFeelPainter.DrawScaledBackButton(ACanvas, R, AState,
      BackstageView.ScaleFactor)
end;

procedure TdxRibbonBackstageViewPainter.DrawBackground(ACanvas: TcxCanvas;
  const R: TRect);
begin
  if Skin <> nil then
...
procedure TdxRibbonBackstageViewPainter.DrawMenuBarHeader(ACanvas: TcxCanvas;
  const R: TRect);
begin
  if Skin <> nil then
...
begin
  if Skin <> nil then
    ...
    Result := BackstageView.LookAndFeelPainter.GetScaledBackButtonSize
      (BackstageView.ScaleFactor)
end;
...
begin
  if not(BackstageView.IsRibbonValid and Supports(BackstageView.Ribbon, IdxSkin,
    Result)) then
    Result := nil;
end;

function TdxRibbonBackstageViewPainter.GetDefaultTextColor
  (AEnabled: Boolean): TColor;
begin
  if Skin <> nil then
    Result := Skin.GetPartColor(DXBAR_BACKSTAGEVIEW_TEXTCOLOR,
      IfThen(AEnabled, DXBAR_NORMAL, DXBAR_DISABLED))
  else
    Result := clDefault;
end;
...
begin
  Skin.DrawBackground(DC, ABeginGroupRect,
...
function TdxRibbonBackstageViewMenuPainter.MenuBarButtonTextColor
  (const ADrawParams: TdxBarButtonLikeControlDrawParams): TColor;
var
  AColor: TColor;
begin
  GetDefaultTextColors(ADrawParams.BarItemControl, ADrawParams.Enabled,
    ADrawParams.DrawSelected, True, Result, AColor);
end;

procedure TdxRibbonBackstageViewMenuPainter.DockControlFillBackground
  (ADockControl: TdxDockControl; DC: HDC; ADestR: TRect;
  ASourceR, AWholeR: TRect; ABrush: HBRUSH; AColor: TColor);
begin
  Skin.DrawBackground(DC, AWholeR, DXBAR_BACKSTAGEVIEW_MENUBAR);
end;

procedure TdxRibbonBackstageViewMenuPainter.DrawTabButtonBackground(DC: HDC;
  R: TRect; AState: Integer);
begin
  Skin.DrawBackground(DC, R, DXBAR_BACKSTAGEVIEW_MENUBAR_TAB, AState);
end;

function TdxRibbonBackstageViewMenuPainter.GetTabButtonState(const ADrawParams
  : TdxBarButtonLikeControlDrawParams): Integer;
begin
  if ADrawParams.IsPressed then
    Result := DXBAR_PRESSED
  else if not ADrawParams.Downed then
    Result := GetPartState(ADrawParams, icpControl)
  else if ADrawParams.HotPartIndex = icpControl then
...
function TdxRibbonBackstageViewMenuPainter.TabButtonTextColor
  (AState: Integer): TColor;
begin
  if Skin <> nil then
    Result := Skin.GetPartColor
      (DXBAR_BACKSTAGEVIEW_MENUBAR_TAB_TEXTCOLOR, AState)
  else
    Result := clWindowText;
end;

function TdxRibbonBackstageViewMenuPainter.TabButtonTextColor(const ADrawParams
  : TdxBarButtonLikeControlDrawParams): TColor;
...
begin
  Result := TabButtonTextColor
    (GetTextColorState(GetTabButtonState(ADrawParams)));
end;
...
begin
  ...
  try
    R := dxMapWindowRect(ABarControl.DockControl.Handle, ABarControl.Handle,
      ABarControl.DockControl.ClientRect);
...
begin
  AColor1 := Skin.GetPartColor(DXBAR_BACKSTAGEVIEW_MENUBAR_ITEM_TEXTCOLOR,
    StateMap[ASelected]);
  AColor2 := AColor1;
end;

function TdxRibbonBackstageViewMenuPainter.GetEnabledTextColor(ABarItemControl
  : TdxBarItemControl; ASelected: Boolean; AFlat: Boolean): TColor;

  function GetPartState: Integer;
  begin
    if not ABarItemControl.Enabled then
      Result := DXBAR_DISABLED
    else if TdxBarItemControlAccess(ABarItemControl).Pressed then
      Result := DXBAR_PRESSED
    else if ABarItemControl.IsSelected then
      Result := DXBAR_HOT
    else
      Result := DXBAR_NORMAL;
  end;
...
function TdxRibbonBackstageViewMenuPainter.GetGlyphColorPalette(ABarItemControl
...
function TdxRibbonBackstageViewMenuPainter.GetToolbarContentOffsets
  ...
  AScaleFactor: TdxScaleFactor; AHasSizeGrip: Boolean): TRect;
begin
  Result := cxNullRect;
end;
...
constructor TdxRibbonBackstageViewMenuDockControl.Create(AMenuViewInfo
  : TdxRibbonBackstageViewMenuViewInfo);
begin
...
procedure TdxRibbonBackstageViewMenuDockControl.CMDesignHitTest
  (var Message: TCMDesignHitTest);
begin
  Message.Result := 0;
end;

function TdxRibbonBackstageViewMenuDockControl.GetBackstageView
  : TdxRibbonCustomBackstageView;
begin
  Result := MenuViewInfo.BackstageView;
end;
...
function TdxRibbonBackstageViewMenuDockControl.GetDockedBarControlClass
  : TdxBarControlClass;
begin
  Result := TdxRibbonBackstageViewMenuBarControl;
end;

function TdxRibbonBackstageViewMenuDockControl.GetDockingStyle
  : TdxBarDockingStyle;
begin
  Result := dsLeft;
end;
...
procedure TdxRibbonBackstageViewMenuBarCustomButtonControl.CalcDrawParams
  (AFull: Boolean);
begin
  inherited;
...
function TdxRibbonBackstageViewMenuBarCustomButtonControl.
  CalculateContentOffsets: TRect;
begin
...
function TdxRibbonBackstageViewMenuBarCustomButtonControl.
  CanDestroyOnClick: Boolean;
begin
  Result := False;
end;

procedure TdxRibbonBackstageViewMenuBarCustomButtonControl.DoPaint(ARect: TRect;
...
begin
  if not dxFader.DrawFadeImage(ADrawParams.BarItemControl,
    ADrawParams.Canvas.Handle, R) then
...
begin
  if IsTabButtonStyle then
    MenuPainter.DrawTabButtonBackground(ADrawParams.Canvas.Handle, R,
      MenuPainter.GetTabButtonState(ADrawParams))
  else
...
begin
  ...
  if AIsRightToLeft then
    AContentOffset := TdxRightToLeftLayoutConverter.ConvertOffsets
      (ADrawParams.ContentOffset)
  else
  ...
  begin
    ...
    AImageSize := TdxBarItemControlAccess(ADrawParams.BarItemControl)
      .GetGlyphSize(ADrawParams.ViewSize);
    ...
    cxDrawImage(ADrawParams.Canvas.Handle, AImageRect, AImageRect, Glyph,
      Images, ImageIndex, idmNormal, True, 0, clDefault, True,
      MenuPainter.GetGlyphColorPalette(Self, ADrawParams.PaintType,
      ADrawParams.DrawSelected, ADrawParams.Downed, ADrawParams.DrawDowned,
      ADrawParams.DroppedDown, False));
  ...
  begin
    if IsTabButtonStyle then
      ADrawParams.Canvas.Font.Color := MenuPainter.TabButtonTextColor
        (ADrawParams)
    else
      ADrawParams.Canvas.Font.Color := MenuPainter.MenuBarButtonTextColor
        (ADrawParams);

    ATextFlags := CXTO_EDITCONTROL or CXTO_CENTER_VERTICALLY or
      CXTO_HIDEPREFIX or IfThen(IsWordWrapSupported, CXTO_WORDBREAK);
    if AIsRightToLeft then
...
begin
  ...
  if cpIcon in FDrawParams.ViewStructure then
    Result := Max(Result, GetGlyphAreaWidth +
      cxMarginsHeight(DrawParams.ContentOffset));
  ...
  begin
    ...
    begin
      ...
      try
        ARect := cxRect(DrawParams.ContentOffset.Left, 0,
          MenuViewInfo.MinWidth - DrawParams.ContentOffset.Right, 0);
        if cpIcon in FDrawParams.ViewStructure then
          Inc(ARect.Left, GetGlyphAreaWidth + 2 *
            ScaleFactor.Apply(cxTextOffset));
        cxTextOut(Canvas.Handle, Item.Caption, ARect, CXTO_EDITCONTROL or
          CXTO_CALCRECT or CXTO_WORDBREAK);
        Result := Max(Result, cxRectHeight(ARect) +
          cxMarginsHeight(DrawParams.ContentOffset));
      finally
...
begin
  Result := GetGlyphAreaWidth + GetCaptionAreaWidth +
    cxMarginsWidth(DrawParams.ContentOffset) + 2 *
    ScaleFactor.Apply(cxTextOffset);
end;

function TdxRibbonBackstageViewMenuBarCustomButtonControl.
  GetKeyTipBasePoint: TPoint;
begin
  Result := cxPointOffset(DrawParams.ContentOffset.TopLeft,
    -2 * cxTextOffset, 0);
  if cpIcon in DrawParams.ViewStructure then
    Result := cxPointOffset(Result, GetGlyphAreaWidth, 0);
end;

function TdxRibbonBackstageViewMenuBarCustomButtonControl.GetMenuPainter
  : TdxRibbonBackstageViewMenuPainter;
begin
  Result := MenuViewInfo.Painter;
end;

function TdxRibbonBackstageViewMenuBarCustomButtonControl.GetMenuViewInfo
  : TdxRibbonBackstageViewMenuViewInfo;
begin
  Result := BackstageView.MenuViewInfo;
end;

function TdxRibbonBackstageViewMenuBarCustomButtonControl.GetViewStructure
...
function TdxRibbonBackstageViewMenuBarCustomButtonControl.Images
  : TCustomImageList;
var
...
function TdxRibbonBackstageViewMenuBarCustomButtonControl.
  IsTabButtonStyle: Boolean;
begin
  Result := False;
end;

function TdxRibbonBackstageViewMenuBarCustomButtonControl.
  IsWordWrapSupported: Boolean;
begin
  Result := False;
end;
...
constructor TdxRibbonBackstageViewTabSheetViewInfo.Create
...
procedure TdxRibbonBackstageViewTabSheetViewInfo.ValidateWindowPos
  (var APos: TWindowPos);
begin
  APos.x := Bounds.Left;
  APos.y := Bounds.Top;
...
function TdxRibbonBackstageViewTabSheetViewInfo.
  GetFrameAreaVisibleBounds: TRect;
begin
...
constructor TdxRibbonBackstageViewTabSheetSizeOptions.Create
  (ATab: TdxRibbonBackstageViewTabSheet);
begin
  inherited Create;
  FTab := ATab;
...
procedure TdxRibbonBackstageViewTabSheetSizeOptions.SetAutoSize
  (AValue: Boolean);
begin
  FTab.AutoSize := AValue;
end;

procedure TdxRibbonBackstageViewTabSheetSizeOptions.SetMinHeight
  (AValue: Integer);
begin
  AValue := Max(AValue, 0);
...
procedure TdxRibbonBackstageViewTabSheetSizeOptions.SetMinWidth
  (AValue: Integer);
begin
  AValue := Max(AValue, 0);
...
procedure TdxRibbonBackstageViewTabSheet.AlignControls(AControl: TControl;
  var Rect: TRect);
begin
...
procedure TdxRibbonBackstageViewTabSheet.ChangeScaleEx(M, D: Integer;
  isDpiChange: Boolean);
begin
...
procedure TdxRibbonBackstageViewTabSheet.Changed
  (AChanges: TdxRibbonBackstageViewChanges);
begin
...
function TdxRibbonBackstageViewTabSheet.CanResize(var NewWidth,
...
function TdxRibbonBackstageViewTabSheet.CreateViewInfo
  : TdxRibbonBackstageViewTabSheetViewInfo;
begin
...
var
  R: TRect;
begin
  R := dxMapWindowRect(BackstageView.Handle, Handle,
    cxGetWindowBounds(BackstageView), False);
...
function TdxRibbonBackstageViewTabSheet.GetPainter
  : TdxRibbonBackstageViewPainter;
begin
  Result := BackstageView.Painter;
end;
...
procedure TdxRibbonBackstageViewTabSheet.SetBackstageView
  (AValue: TdxRibbonCustomBackstageView);
begin
...
procedure TdxRibbonBackstageViewTabSheet.SetBounds(ALeft, ATop, AWidth,
  AHeight: Integer);
begin
...
procedure TdxRibbonBackstageViewTabSheet.SetSizeOptions
  (AValue: TdxRibbonBackstageViewTabSheetSizeOptions);
begin
...
begin
  if (BackstageView <> nil) and BackstageView.IsPopupScrollBars and
    ScrollUIActivityHelper.CheckScrollActivity(Self, Message) then
...
function TdxRibbonBackstageViewTabSheets.GetItem(Index: Integer)
  : TdxRibbonBackstageViewTabSheet;
begin
...
function TdxRibbonBackstageViewTabSheetButton.GetControlClass
  (AIsVertical: Boolean): TdxBarItemControlClass;
begin
  Result := TdxRibbonBackstageViewTabSheetButtonControl;
end;

procedure TdxRibbonBackstageViewTabSheetButton.SetTab
  (AValue: TdxRibbonBackstageViewTabSheet);
begin
  FTab := AValue;
  RefreshInfo;
end;
...
constructor TdxRibbonBackstageViewTabSheetButtonControlAccessibilityHelper.
  Create(AOwnerObject: TObject);
begin
...
destructor
  TdxRibbonBackstageViewTabSheetButtonControlAccessibilityHelper.Destroy;
begin
  FreeAndNil(FAccessibilityChildren);
  inherited Destroy;
end;

function TdxRibbonBackstageViewTabSheetButtonControlAccessibilityHelper.
  GetBarManager: TdxBarManager;
begin
  Result := TabSheet.BackstageView.BarManager;
end;

function TdxRibbonBackstageViewTabSheetButtonControlAccessibilityHelper.
  GetDefaultAccessibleObject: IdxBarAccessibilityHelper;
begin
...
procedure TdxRibbonBackstageViewTabSheetButtonControlAccessibilityHelper.
  AddChild(AChild: TcxAccessibilityHelper);
begin
...
procedure TdxRibbonBackstageViewTabSheetButtonControlAccessibilityHelper.
  DeleteChild(AChild: TcxAccessibilityHelper);
begin
...
function TdxRibbonBackstageViewTabSheetButtonControlAccessibilityHelper.
  GetChildIndex(AChild: TcxAccessibilityHelper): Integer;
begin
...
function TdxRibbonBackstageViewTabSheetButtonControlAccessibilityHelper.
  ...
  : IdxBarKeyTipWindowsManager): Boolean;
begin
  Result := True;
  if FKeyTipWindowsManager = nil then
    FKeyTipWindowsManager := TdxRibbonBackstageViewKeyTipWindows.Create
      (TabSheet.BackstageView.Ribbon);
  AKeyTipWindowsManager := FKeyTipWindowsManager;
end;
...
function TdxRibbonBackstageViewTabSheetButtonControlAccessibilityHelper.
  GetTabSheet: TdxRibbonBackstageViewTabSheet;
begin
  Result := (FOwnerObject as
    TdxRibbonBackstageViewTabSheetButtonControl).Item.Tab;
end;
...
procedure TdxRibbonBackstageViewTabSheetButtonControl.ControlClick
  (AByMouse: Boolean; AKey: Char = #0);
begin
  inherited ControlClick(AByMouse, AKey);
  ActivateTab;
end;

procedure TdxRibbonBackstageViewTabSheetButtonControl.ControlUnclick
  (AByMouse: Boolean);
begin
...
function TdxRibbonBackstageViewTabSheetButtonControl.GetAccessibilityHelperClass
  : TdxBarAccessibilityHelperClass;
begin
  Result := TdxRibbonBackstageViewTabSheetButtonControlAccessibilityHelper;
end;

function TdxRibbonBackstageViewTabSheetButtonControl.GetBackstageView
  : TdxRibbonCustomBackstageView;
begin
...
function TdxRibbonBackstageViewTabSheetButtonControl.GetViewStructure
  : TdxBarItemControlViewStructure;
begin
  Result := inherited;
  if BackstageView.RibbonStyle < rs2019 then
...
function TdxRibbonBackstageViewTabSheetButtonControl.
  IsWordWrapSupported: Boolean;
begin
  Result := True;
end;
...
function TdxRibbonBackstageViewTabSheetButtonControl.GetItem
  : TdxRibbonBackstageViewTabSheetButton;
begin
...
procedure TdxRibbonBackstageViewTabSheetButtonList.RemoveTab
  (ATab: TdxRibbonBackstageViewTabSheet);
var
  I: Integer;
begin
...
function TdxRibbonBackstageViewTabSheetButtonList.GetItem(Index: Integer)
  : TdxRibbonBackstageViewTabSheetButton;
begin
...
function TdxRibbonBackstageViewMenuButtonList.GetItem(Index: Integer)
  : TdxRibbonBackstageViewMenuBarButton;
begin
...
constructor TdxRibbonBackstageViewMenuViewInfo.Create(ABackstageView
  : TdxRibbonCustomBackstageView);
begin
...
procedure TdxRibbonBackstageViewMenuViewInfo.AddButton
...
begin
  ...
  begin
    AItemLink := BarDesignController.AddInternalItem(ItemLinks,
      TdxRibbonBackstageViewMenuBarButton, BarManager, MenuButtonList);
    (AItemLink.Item as TdxRibbonBackstageViewMenuBarButton).MenuButton
      := AButton;
    AItemLink.BeginGroup := (AButton.BeginGroup or ABeginGroup) and
      (ItemLinks.Count > 1);
...
begin
  ...
  begin
    AItemLink := BarDesignController.AddInternalItem(ItemLinks,
      TdxRibbonBackstageViewTabSheetButton, BarManager, TabButtonList);
    (AItemLink.Item as TdxRibbonBackstageViewTabSheetButton).Tab := ATab;
    AItemLink.BeginGroup := (ATab.BeginGroup or ABeginGroup) and
      (ItemLinks.Count > 1);
    ABeginGroup := False;
  end;
end;

procedure TdxRibbonBackstageViewMenuViewInfo.AddTabButtons
  (ABeginGroup: Boolean);
var
  I: Integer;
begin
...
begin
  if Assigned(BarControl) and IsBarManagerValid and BackstageView.ShowMainMenu
  then
  begin
...
function TdxRibbonBackstageViewMenuViewInfo.CanContainItem(AItem: TdxBarItem;
  out AErrorText: string): Boolean;
begin
  Result := True;
end;

function TdxRibbonBackstageViewMenuViewInfo.CreateItemLinksBarControl
  : TCustomdxBarControl;
begin
  Result := TdxRibbonBackstageViewMenuBarControl.Create(BarManager);
end;

function TdxRibbonBackstageViewMenuViewInfo.CreatePainter(AData: TdxNativeUInt)
  : TdxRibbonBackstageViewMenuPainter;
begin
...
function TdxRibbonBackstageViewMenuViewInfo.GetAccessibilityHelper
  : IdxBarAccessibilityHelper;
begin
...
function TdxRibbonBackstageViewMenuViewInfo.
  ShowSeparatorBetweenTabsAndButtons: Boolean;
begin
  Result := BackstageView.RibbonStyle = rs2019;
end;

function TdxRibbonBackstageViewMenuViewInfo.GetBarControl
  : TdxRibbonBackstageViewMenuBarControl;
begin
  Result := TdxRibbonBackstageViewMenuBarControl(ItemLinks.BarControl);
end;

function TdxRibbonBackstageViewMenuViewInfo.GetFonts
  : TdxRibbonBackstageViewFonts;
begin
...
constructor TdxRibbonBackstageViewViewInfo.Create(ABackstageView
  : TdxRibbonCustomBackstageView);
begin
  inherited Create(ABackstageView);
...
function TdxRibbonBackstageViewViewInfo.CreateMenuViewInfo
  : TdxRibbonBackstageViewMenuViewInfo;
begin
  Result := TdxRibbonBackstageViewMenuViewInfo.Create(BackstageView);
end;

procedure TdxRibbonBackstageViewViewInfo.DoRightToLeftConversion
  (const ABounds: TRect);
var
  AMenuBounds: TRect;
begin
  inherited DoRightToLeftConversion(ABounds);
  FFrameAreaBounds := TdxRightToLeftLayoutConverter.ConvertRect
    (FFrameAreaBounds, ABounds);
  AMenuBounds := TdxRightToLeftLayoutConverter.ConvertRect
    (CalculateMenuBounds, ABounds);
  MenuViewInfo.Calculate(AMenuBounds);
end;

function TdxRibbonBackstageViewViewInfo.ProcessMouseWheel
  (ALineDown: Boolean): Boolean;
const
...
function TdxRibbonBackstageViewViewInfo.GetActiveTab
  : TdxRibbonBackstageViewTabSheet;
begin
  Result := BackstageView.ActiveTab;
end;

function TdxRibbonBackstageViewViewInfo.GetActiveTabItemControl
  : TdxBarItemControl;
var
  AItem: TdxRibbonBackstageViewTabSheetButton;
begin
  AItem := MenuViewInfo.TabButtonList.GetItemByTab(ActiveTab);
  if (AItem <> nil) and (AItem.LinkCount > 0) and (AItem.Links[0].Control <> nil)
  then
...
begin
  Result := TdxControlsDesignSelectorHelper.CalculateBounds(Bounds,
    BackstageView.ScaleFactor);
end;
...
procedure TdxRibbonBackstageViewMenuBarButton.SetMenuButton
  (AValue: TdxRibbonBackstageViewMenuButton);
begin
...
procedure TdxRibbonBackstageViewMenuBarButtonControl.DoPaint(ARect: TRect;
  PaintType: TdxBarPaintType);
begin
  inherited;
...
function TdxRibbonBackstageViewMenuBarButtonControl.GetBackstageView
  : TdxRibbonCustomBackstageView;
begin
...
begin
  Result := not HasImage and
    (BackstageView.RibbonStyle in [rs2013 .. rs2016Tablet]);
end;

function TdxRibbonBackstageViewMenuBarButtonControl.GetItem
  : TdxRibbonBackstageViewMenuBarButton;
begin
...
procedure TdxRibbonBackstageViewMenuButton.BarComponentChanged
  (AComponent: TdxBarComponent);
begin
...
procedure TdxRibbonBackstageViewMenuButton.Notification(AComponent: TComponent;
...
function TdxRibbonBackstageViewMenuButton.GetCollection
  : TdxRibbonBackstageViewMenuButtons;
begin
...
constructor TdxRibbonBackstageViewMenuButtons.Create(ABackstageView
  : TdxRibbonCustomBackstageView);
begin
...
function TdxRibbonBackstageViewMenuButtons.Add
  : TdxRibbonBackstageViewMenuButton;
begin
  Result := TdxRibbonBackstageViewMenuButton(inherited Add);
end;

function TdxRibbonBackstageViewMenuButtons.IndexOf
  (AItem: TdxRibbonBackstageViewMenuButton): Integer;
var
  I: Integer;
begin
  Result := -1;
...
function TdxRibbonBackstageViewMenuButtons.Insert(AIndex: Integer)
  : TdxRibbonBackstageViewMenuButton;
begin
...
procedure TdxRibbonBackstageViewMenuButtons.Notification(AComponent: TComponent;
  Operation: TOperation);
var
  I: Integer;
begin
...
function TdxRibbonBackstageViewMenuButtons.GetItem(Index: Integer)
  : TdxRibbonBackstageViewMenuButton;
begin
  Result := TdxRibbonBackstageViewMenuButton(inherited GetItem(Index));
end;

procedure TdxRibbonBackstageViewMenuButtons.SetItem(Index: Integer;
  Value: TdxRibbonBackstageViewMenuButton);
begin
...
constructor TdxRibbonBackstageViewMenuHelper.Create(ABackstageView
  : TdxRibbonCustomBackstageView);
begin
  inherited Create;
  FBackstageView := ABackstageView;
...
procedure TdxRibbonBackstageViewMenuHelper.PostClick
  (AButton: TdxRibbonBackstageViewMenuButton);
begin
  ...
  case Message.Msg of
    DXM_BAR_SHOWKEYTIPS:
      BarNavigationController.SetKeyTipsShowingState
        (BackstageView.Ribbon.IAccessibilityHelper, '');
...
function TdxRibbonBackstageViewApplicationMenuHelper.CanShowPopup
  (ARibbon: TdxCustomRibbon): Boolean;
begin
...
function TdxRibbonBackstageViewApplicationMenuHelper.GetDisplayMode
...
procedure TdxRibbonBackstageViewApplicationMenuHelper.
  SelectAppMenuFirstItemControl;
begin
  BarNavigationController.ChangeSelectedObject(False,
    BackstageView.MenuViewInfo.AccessibilityHelper.GetBarHelper.
...
begin
  BarNavigationController.SetKeyTipsShowingState
    (BackstageView.MenuViewInfo.AccessibilityHelper, '');
  SelectAppMenuFirstItemControl;
end;
...
function TdxRibbonBackstageViewApplicationMenuHelper.GetBackstageView
  : TdxRibbonCustomBackstageView;
begin
  Result := TdxRibbonCustomBackstageView(FLinkToBackstageView.Ref);
end;

function TdxRibbonBackstageViewApplicationMenuHelper.GetOrigin
  (AIsClientArea: Boolean): TPoint;
begin
  Result := cxNullPoint;
end;

function TdxRibbonBackstageViewApplicationMenuHelper.GetRootAccessibilityHelper
  : IdxBarAccessibilityHelper;
begin
  if Assigned(BackstageView.MenuViewInfo.BarControl) and BackstageView.ShowMainMenu
  then
...
procedure TdxRibbonBackstageViewApplicationMenuHelper.GetTabOrderList
  (AList: TList);
begin
...
begin
  if Self <> BackstageView.NonClientController.HoveredCell then
    Result := cxbsNormal
  else if Self <> BackstageView.NonClientController.PressedCell then
    Result := cxbsHot
  else
    Result := cxbsPressed;
end;
...
constructor TdxRibbonBackstageViewNonClientViewInfo.Create(ABackstageView
  : TdxRibbonCustomBackstageView);
begin
  inherited Create(ABackstageView);
...
procedure TdxRibbonBackstageViewNonClientViewInfo.Calculate
  (const ABounds: TRect);
begin
  inherited Calculate(ABounds);
...
function TdxRibbonBackstageViewNonClientViewInfo.
  CalculateBackButtonBounds: TRect;
var
  ASize: TSize;
begin
  ...
  Result := cxRectBounds(Bounds.Left + Painter.BackButtonOffset,
    TabsArea.Bottom - ASize.cy, ASize.cx, ASize.cy);
end;
...
begin
  ...
  begin
    AOffset := dxMapWindowPoint(Ribbon.Handle, BackstageView.Handle,
      cxNullPoint, False);
    FBorderIconsArea :=
      cxRectOffset(RibbonFormCaptionHelper.BorderIconsArea, AOffset);
    if Ribbon.ViewInfo.TabsAreaViewInfo.IsToolbarVisibleOnBackstageView then
      FTabAreaToolbarArea :=
        cxRectOffset(Ribbon.ViewInfo.TabsAreaViewInfo.ToolbarBounds, AOffset);
    FCaptionArea := cxRectOffset
      (RibbonFormCaptionHelper.FormCaptionDrawBounds, AOffset);
    FCaptionTextRect := FCaptionArea;
    if BackstageView.UseRightToLeftAlignment then
    begin
      FCaptionTextRect.Left := BorderIconsArea.Right;
      FCaptionTextRect.Right := Min(FCaptionTextRect.Right,
        Bounds.Right - MenuViewInfo.MinWidth - TdxCustomRibbonAccess(Ribbon)
        .ScaleFactor.Apply(dxRibbonFormCaptionTextSpace));
    end
    else
    begin
      FCaptionTextRect.Right := BorderIconsArea.Left;
      FCaptionTextRect.Left := Max(FCaptionTextRect.Left,
        Bounds.Left + MenuViewInfo.MinWidth + TdxCustomRibbonAccess(Ribbon)
        .ScaleFactor.Apply(dxRibbonFormCaptionTextSpace));
    end;
    FBackgroundImageRect :=
      cxRectOffset(Ribbon.ViewInfo.BackgroundImageBounds, AOffset);
    ...
    if BackstageView.RibbonStyle = rs2019 then
      FTabsArea.Bottom := Max(TabsArea.Bottom,
        TabsArea.Top + MenuViewInfo.Painter.TabButtonDefaultHeight);
  end
  else
  begin
...
begin
  FMenuBarHeaderRect := cxRectOffset(MenuViewInfo.Bounds,
    ClientOffsets.TopLeft);
  FMenuBarHeaderRect.Top := Bounds.Top;
  FMenuBarHeaderRect.Bottom := TabsArea.Bottom;
end;

function TdxRibbonBackstageViewNonClientViewInfo.CreateBackButtonViewInfo
  : TdxRibbonBackstageViewBackButtonViewInfo;
begin
  Result := TdxRibbonBackstageViewBackButtonViewInfo.Create(BackstageView);
end;

function TdxRibbonBackstageViewNonClientViewInfo.CreateWindowRegion
  : TcxRegionHandle;
...
procedure TdxRibbonBackstageViewNonClientViewInfo.DoRightToLeftConversion
  (const ABounds: TRect);
begin
  inherited DoRightToLeftConversion(ABounds);
...
procedure TdxRibbonBackstageViewNonClientViewInfo.DrawCaptionArea
  (ACanvas: TcxCanvas);
var
  R: TRect;
  ATextFlags: Cardinal;
begin
  ...
  begin
    ...
    R := CaptionTextRect;
    ACanvas.Font := Ribbon.ViewInfo.GetFormCaptionFont
      (RibbonFormCaptionHelper.FormPaintData.GetIsActive);
    ACanvas.Font.Color := Ribbon.ColorScheme.GetPartColor
      (DXBAR_BACKSTAGEVIEW_TEXTCOLOR);
    ATextFlags := CXTO_PREVENT_LEFT_EXCEED or CXTO_CENTER_HORIZONTALLY or
      CXTO_CENTER_VERTICALLY or CXTO_SINGLELINE or CXTO_END_ELLIPSIS;
    if BackstageView.UseRightToLeftReading then
      ATextFlags := ATextFlags or CXTO_RTLREADING;
    cxTextOut(ACanvas.Handle, Ribbon.ViewInfo.DocumentName +
      Ribbon.ViewInfo.Caption, R, ATextFlags);
  end;
end;

procedure TdxRibbonBackstageViewNonClientViewInfo.DrawBackground
  (ACanvas: TcxCanvas);
begin
  Painter.DrawBackground(ACanvas, Bounds);
end;

procedure TdxRibbonBackstageViewNonClientViewInfo.DrawMenuBarHeader
  (ACanvas: TcxCanvas);
begin
  if ACanvas.RectVisible(MenuBarHeaderRect) then
  begin
    if cxRectPtIn(ContentRect, MenuBarHeaderRect.TopLeft) and
      cxRectPtIn(ContentRect, MenuBarHeaderRect.BottomRight) then
...
function TdxRibbonBackstageViewNonClientViewInfo.GetDisplayMode
  : TdxRibbonApplicationMenuDisplayMode;
begin
  if (RibbonFormCaptionHelper <> nil) and
    not UseAeroNCPaint(RibbonFormCaptionHelper.FormPaintData) and
    (BackstageView.RibbonStyle >= rs2013) and not BackstageView.IsDesigning then
...
function TdxRibbonBackstageViewNonClientViewInfo.GetMenuViewInfo
  : TdxRibbonBackstageViewMenuViewInfo;
begin
  Result := BackstageView.MenuViewInfo;
end;
...
function TdxRibbonBackstageViewNonClientViewInfo.GetRibbonFormCaptionHelper
...
function TdxRibbonBackstageViewNonClientController.HitTest(const P: TPoint)
  : TdxRibbonBackstageViewCustomButtonViewInfo;
begin
...
procedure TdxRibbonBackstageViewNonClientController.MouseDown
  (AButton: TMouseButton; const P: TPoint);
begin
...
procedure TdxRibbonBackstageViewNonClientController.MouseUp
  (AButton: TMouseButton; const P: TPoint);
var
...
procedure TdxRibbonBackstageViewNonClientController.ProcessMessage
  ...
  case AMessage.Msg of
    ...
    WM_NCHITTEST:
      begin
        ...
        else if PtInRect(ViewInfo.CaptionTextRect, P) then
          AMessage.Result := HTTRANSPARENT;
      end;
  end;
end;

function TdxRibbonBackstageViewNonClientController.PtInCaller
...
function TdxRibbonBackstageViewNonClientController.ScreenToLocal
...
function TdxRibbonBackstageViewNonClientController.GetViewInfo
  : TdxRibbonBackstageViewNonClientViewInfo;
begin
...
constructor TdxRibbonBackstageViewAnimationTransition.Create(ABackstageView
  : TdxRibbonCustomBackstageView;
  AMode: TdxRibbonBackstageViewAnimationTransitionMode);
begin
  FMode := AMode;
...
begin
  ...
  begin
    AOffset := -AOffset;
    AMenuBounds := TdxRightToLeftLayoutConverter.ConvertRect(AMenuBounds,
      ViewInfo.Bounds);
  end;
...
begin
  ...
  DC := GetDCEx(BackstageView.Handle, 0, DCX_CACHE or DCX_WINDOW or
    DCX_LOCKWINDOWUPDATE);
  try
    cxBitBlt(DC, BackstageViewBuffer.Canvas.Handle, BackstageViewRect,
      cxNullPoint, SRCCOPY);
  finally
...
begin
  ...
  FBackstageViewMenuBuffer := TcxBitmap.CreateSize
    (BackstageView.MenuViewInfo.Bounds);
  cxPaintTo(BackstageView.MenuViewInfo.DockControl,
    BackstageViewMenuBuffer.cxCanvas, cxNullPoint,
    BackstageViewMenuBuffer.ClientRect);
...
procedure TdxRibbonBackstageViewAnimationTransition.PrepareBackstageViewBuffer
  (ACanvas: TcxCanvas);
var
  AControl: TControl;
  ASkipList: TList;
...
begin
  ...
  try
    ...
    try
      ...
      cxPaintTo(BackstageView, ACanvas, cxNullPoint, BackstageViewRect,
        ASkipList);
    finally
      ASkipList.Free;
    end;
    ...
    try
      ...
      begin
        ...
        if AControl.Visible and BackstageView.IsInternalControl(AControl) then
          ACanvas.ExcludeClipRect(cxRectOffset(AControl.BoundsRect,
            NonClientViewInfo.ClientRect.TopLeft));
      end;

      cxBitBlt(ACanvas.Handle, BackstageViewMenuBuffer.Canvas.Handle,
        cxRectOffset(BackstageView.MenuViewInfo.Bounds,
        NonClientViewInfo.ClientRect.TopLeft), cxNullPoint, SRCCOPY);

      if ActiveTab <> nil then
      begin
        if not ActiveTabIsSolidBackground then
          cxPaintTo(ActiveTab, ActiveTabBuffer.cxCanvas, cxNullPoint,
            ActiveTabRect);

        R := dxMapWindowRect(ActiveTab.Handle, BackstageView.Handle,
          ActiveTabRect, False);
        if not SystemAlphaBlend(ACanvas.Handle, ActiveTabBuffer.Canvas.Handle,
          R, ActiveTabBuffer.ClientRect, CalculateContentAlpha, False) then
          cxBitBlt(ACanvas.Handle, ActiveTabBuffer.Canvas.Handle, R,
            cxNullPoint, SRCCOPY);
      end;
    finally
      ACanvas.RestoreClipRegion;
...
function TdxRibbonBackstageViewAnimationTransition.GetActiveTab
  : TdxRibbonBackstageViewTabSheet;
begin
  Result := BackstageView.ActiveTab;
end;

function TdxRibbonBackstageViewAnimationTransition.GetMenuViewInfo
  : TdxRibbonBackstageViewMenuViewInfo;
begin
  Result := BackstageView.MenuViewInfo;
end;

function TdxRibbonBackstageViewAnimationTransition.GetNonClientViewInfo
  : TdxRibbonBackstageViewNonClientViewInfo;
begin
  Result := BackstageView.NonClientViewInfo;
end;

function TdxRibbonBackstageViewAnimationTransition.GetViewInfo
  : TdxRibbonBackstageViewViewInfo;
begin
...
constructor TdxRibbonBackstageViewFonts.Create(ABackstageView
  : TdxRibbonCustomBackstageView);
var
  AFontIndex: TdxRibbonBackstageViewAssignedFont;
begin
  FBackstageView := ABackstageView;
  for AFontIndex := Low(TdxRibbonBackstageViewAssignedFont)
    to High(TdxRibbonBackstageViewAssignedFont) do
  begin
...
begin
  ...
  begin
    for AFontIndex := Ord(Low(TdxRibbonBackstageViewAssignedFont))
      to Ord(High(TdxRibbonBackstageViewAssignedFont)) do
      SetFont(AFontIndex, TdxRibbonBackstageViewFonts(ASource)
        .GetFont(AFontIndex));
...
procedure TdxRibbonBackstageViewFonts.ResetFont(AFont: TFont;
  AIndex: TdxRibbonBackstageViewAssignedFont);
begin
...
procedure TdxRibbonBackstageViewFonts.FontChanged(Sender: TObject);
  ...
  function GetFontIndex(out AIndex: TdxRibbonBackstageViewAssignedFont)
    : Boolean;
  var
    I: TdxRibbonBackstageViewAssignedFont;
  begin
    Result := False;
    for I := Low(TdxRibbonBackstageViewAssignedFont)
      to High(TdxRibbonBackstageViewAssignedFont) do
...
procedure TdxRibbonBackstageViewFonts.SetAssignedFonts
  (AValue: TdxRibbonBackstageViewAssignedFonts);
begin
...
function TdxRibbonBackstageViewDesignSelectorHelper.IsHitTestTransparent
  (const P: TPoint): Boolean;
begin
  Result := False;
end;
...
function TdxRibbonCustomBackstageView.ApplicationWndProcHook
...
function TdxRibbonCustomBackstageView.CanShowPopup
  (ARibbon: TdxCustomRibbon): Boolean;
begin
...
procedure TdxRibbonCustomBackstageView.ColorSchemeChangeHandler(Sender: TObject;
  const AEventArgs);
begin
  FullRefresh;
end;

function TdxRibbonCustomBackstageView.CreateApplicationMenuHelper
  : TdxRibbonBackstageViewApplicationMenuHelper;
begin
  Result := TdxRibbonBackstageViewApplicationMenuHelper.Create(Self);
end;

function TdxRibbonCustomBackstageView.CreateNonClientController
  : TdxRibbonBackstageViewNonClientController;
begin
  Result := TdxRibbonBackstageViewNonClientController.Create(Self);
end;

function TdxRibbonCustomBackstageView.CreateNonClientViewInfo
  : TdxRibbonBackstageViewNonClientViewInfo;
begin
  Result := TdxRibbonBackstageViewNonClientViewInfo.Create(Self);
end;

function TdxRibbonCustomBackstageView.CreatePainter
  : TdxRibbonBackstageViewPainter;
begin
  Result := TdxRibbonBackstageViewPainter.Create(Self);
end;

function TdxRibbonCustomBackstageView.CreateViewInfo
  : TdxRibbonBackstageViewViewInfo;
begin
...
function TdxRibbonCustomBackstageView.Popup(ARibbon: TdxCustomRibbon;
...
begin
  ...
  AForm.Constraints.MinWidth := Max(AForm.Constraints.MinWidth,
    dxRibbonBackstageViewMinOwnerWidth);
  AForm.Constraints.MinHeight := Max(AForm.Constraints.MinHeight,
    dxRibbonBackstageViewMinOwnerHeight);
  CalculatePlace;
  NonClientViewInfo.Recalculate;
...
function TdxRibbonCustomBackstageView.QueryInterface(const IID: TGUID;
  out Obj): HRESULT;
begin
...
begin
  ...
  begin
    ...
    else if not TdxCustomRibbonAccess(Ribbon).UseExternalFormBorders then
      Inc(R.Top);
...
function TdxRibbonCustomBackstageView.CanActivateTab
  (ATab: TdxRibbonBackstageViewTabSheet): Boolean;
begin
  Result := ((ATab = nil) or ATab.CanBeActive) and
    (IsDesigning or DoTabChanging(ATab));
end;

procedure TdxRibbonCustomBackstageView.ChangeScaleEx(M, D: Integer;
  isDpiChange: Boolean);
begin
  BeginUpdate;
  try
...
procedure TdxRibbonCustomBackstageView.Changed(const AChanges
  : TdxRibbonBackstageViewChanges);
begin
  if FUpdateCount > 0 then
    FChanges := FChanges + AChanges
  else if not IsDestroying and HandleAllocated then
  begin
...
procedure TdxRibbonCustomBackstageView.CreateWindowHandle
...
procedure TdxRibbonCustomBackstageView.DoAddTab
  (ATab: TdxRibbonBackstageViewTabSheet);
begin
  FTabs.Add(ATab);
  if ActiveTab = nil then
...
procedure TdxRibbonCustomBackstageView.DoBeforeBarManagerChange
  (Sender: TObject);
begin
  if IsBarManagerValid then
...
function TdxRibbonCustomBackstageView.DoMouseWheelDown(Shift: TShiftState;
...
function TdxRibbonCustomBackstageView.DoMouseWheelUp(Shift: TShiftState;
  MousePos: TPoint): Boolean;
begin
...
procedure TdxRibbonCustomBackstageView.DoRemoveTab
  (ATab: TdxRibbonBackstageViewTabSheet);
...
function TdxRibbonCustomBackstageView.DoTabChanging
  (ANewTab: TdxRibbonBackstageViewTabSheet): Boolean;
begin
  Result := True;
...
procedure TdxRibbonCustomBackstageView.DoTabClick
  (ATab: TdxRibbonBackstageViewTabSheet);
begin
...
procedure TdxRibbonCustomBackstageView.DoRightToLeftConversion
  (const ABounds: TRect);
var
  I: Integer;
begin
...
function TdxRibbonCustomBackstageView.
  FluentDesignContainerControlCanBeOpaque: Boolean;
begin
  Result := True;
end;

procedure TdxRibbonCustomBackstageView.DoTabVisibleChanged
  (ATab: TdxRibbonBackstageViewTabSheet);
begin
  BeginUpdate;
  try
...
begin
  SetScrollBarInfo(sbHorizontal, 0, ViewInfo.ContentWidth,
    dxBackstageViewScrollLineSize, cxRectWidth(ViewInfo.Bounds) + 1,
    ViewInfo.ScrollPositionX, True, True);
  SetScrollBarInfo(sbVertical, 0, ViewInfo.ContentHeight,
    dxBackstageViewScrollLineSize, cxRectHeight(ViewInfo.Bounds) + 1,
    ViewInfo.ScrollPositionY, True, True);
end;

procedure TdxRibbonCustomBackstageView.Notification(AComponent: TComponent;
  Operation: TOperation);
begin
...
procedure TdxRibbonCustomBackstageView.MakeFullyVisible(R: TRect);
  ...
  begin
    ...
    else if ATargetBound2 > ASourceBound2 then
...
function TdxRibbonCustomBackstageView.GetScrollBarClass(AKind: TScrollBarKind)
...
function TdxRibbonCustomBackstageView.IsPersistentSelected
  (AObject: TPersistent): Boolean;
begin
  Result := Assigned(FDesignHelper) and FDesignHelper.IsObjectSelected
    (Self, AObject);
end;
...
procedure TdxRibbonCustomBackstageView.Scroll(AScrollBarKind: TScrollBarKind;
...
procedure TdxRibbonCustomBackstageView.SetChildOrder(Child: TComponent;
  Order: Integer);
begin
...
procedure TdxRibbonCustomBackstageView.SystemFontChanged(Sender: TObject;
  const AEventArgs);
begin
  FullRefresh;
end;
...
function TdxRibbonCustomBackstageView.CreateDesignSelector
  : TdxRibbonBackstageViewDesignSelectorHelper;
begin
...
begin
  if HandleAllocated then
    cxRedrawWindow(Handle, cxRectInflate(ViewInfo.DesignSelectorRect, 1),
      RDW_ALLCHILDREN or RDW_INVALIDATE or RDW_NOERASE);
end;
...
begin
  ...
  begin
    ...
    try
      ...
      begin
        inherited;
        AAnimationTransition := TdxRibbonBackstageViewAnimationTransition.Create
          (Self, bvatmShow);
      ...
      LockWindowUpdate(0);
      cxRedrawWindow(Handle, RDW_INVALIDATE or RDW_ALLCHILDREN or RDW_FRAME or
        RDW_UPDATENOW);
    end;
  end
  else
  ...
  begin
    ...
    try
      ...
      try
        ...
        try
          cxPaintCanvas.ExcludeClipRect(NonClientViewInfo.ClientRect);
          cxBitBlt(cxPaintCanvas.Handle, AMemDC, cxGetWindowBounds(Self),
            cxNullPoint, SRCCOPY);
        finally
          cxPaintCanvas.EndPaint;
        end;
...
procedure TdxRibbonCustomBackstageView.GetChildren(Proc: TGetChildProc;
  Root: TComponent);
var
  I: Integer;
begin
...
function TdxRibbonCustomBackstageView.GetMenuViewInfo
  : TdxRibbonBackstageViewMenuViewInfo;
begin
...
function TdxRibbonCustomBackstageView.GetNextTab
  (ATab: TdxRibbonBackstageViewTabSheet): TdxRibbonBackstageViewTabSheet;
var
  AIndex: Integer;
begin
  if ATab = nil then
...
function TdxRibbonCustomBackstageView.GetNextTab(AIndex: Integer)
  : TdxRibbonBackstageViewTabSheet;
var
  I: Integer;
begin
...
function TdxRibbonCustomBackstageView.GetTabs(Index: Integer)
  : TdxRibbonBackstageViewTabSheet;
begin
  Result := FTabs[Index];
end;
...
procedure TdxRibbonCustomBackstageView.RightToLeftConversion
  (const ABounds: TRect);
begin
  if not FIsRightToLeftConverted then
  begin
...
procedure TdxRibbonCustomBackstageView.SetActiveTab
  (AValue: TdxRibbonBackstageViewTabSheet);
begin
...
procedure TdxRibbonCustomBackstageView.SetButtons
  (AValue: TdxRibbonBackstageViewMenuButtons);
begin
  FButtons.Assign(AValue);
end;

procedure TdxRibbonCustomBackstageView.SetFonts
  (AValue: TdxRibbonBackstageViewFonts);
begin
