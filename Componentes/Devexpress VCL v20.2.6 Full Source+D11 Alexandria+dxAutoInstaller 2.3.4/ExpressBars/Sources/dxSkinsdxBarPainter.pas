...
{$IFDEF DELPHI16}
  System.UITypes,
{$ENDIF}
  Types, Windows, SysUtils, Classes, Controls, Graphics, Messages,
  cxLookAndFeels,
  cxLookAndFeelPainters, dxBar, cxControls,
  dxSkinsCore, cxGraphics, cxGeometry, dxScreenTip, dxCore, dxCoreGraphics,
  dxSkinInfo;
...
type
  ...
  private
    ...
    procedure SetupCacheControl(AElement: TdxSkinElement;
      ACacheCapacity: Integer = 0);
    ...
    function DrawSkinElementBorders(AElement: TdxSkinElement; DC: HDC;
      ...
      AState: TdxSkinElementState = esNormal): Boolean;
    procedure DrawSkinElementParentBackground(DC: HDC; const R: TRect;
      ABarControl: TCustomdxBarControl; AElement: TdxSkinElement);

    function GetSkinEditorsBackgroundColor
      (AState: TcxEditStateColorKind): TColor;
    function GetSkinEditorsTextColor(AState: TcxEditStateColorKind): TColor;
    function GetSkinElementSize(ASkinElement: TdxSkinElement;
      AScaleFactor: TdxScaleFactor): TSize;
    function GetSkinElementTextColor(ASkinElement: TdxSkinElement;
      AState: TcxButtonState): TColor;

    function GetBarElement(ABarControl: TCustomdxBarControl)
      : TdxSkinElement; overload;
    function GetBarElement(ABarControl: TCustomdxBarControl; AVertical: Boolean)
      : TdxSkinElement; overload;
    function GetBarMarkElement(AMainMenu, AVertical: Boolean): TdxSkinElement;
    function GetTextColorElement(ABarControl: TCustomdxBarControl)
      : TdxSkinElement;

    function IsBarElementSkinned(ABarControl: TCustomdxBarControl): Boolean;

    procedure DrawArrowButtonElement(AElement: TdxSkinElement;
      ACanvas: TcxCanvas; const ARect: TRect; AImageIndex: Integer = 0;
      AState: TdxSkinElementState = esNormal);

    // Bar
    procedure DrawFloatingBarCaptionButton(DC: HDC; ARect: TRect;
      AContentType: Integer; AState: TdxBarMarkState);
    procedure InternalDrawDockedBarBackground(ABarControl: TdxBarControl;
      DC: HDC; R: TRect; AClientArea: Boolean);

    // ButtonLikeControl
    function ButtonLikeControlGetState(const ADrawParams
      : TdxBarButtonLikeControlDrawParams): TdxSkinElementState;
    function ButtonLikeDrawArrowFadingElement(const ADrawParams
      : TdxBarButtonLikeControlDrawParams; var R: TRect): Boolean;
    function ButtonLikeDrawFadingElement(ABarItemControl: TdxBarItemControl;
      DC: HDC; const R: TRect; AIsSplit: Boolean): Boolean;
    procedure ButtonLikeDrawGlyphBorder(ABarItemControl: TdxBarItemControl;
      DC: HDC; ABrush: HBRUSH; NeedBorder: Boolean; R: TRect;
      PaintType: TdxBarPaintType; IsGlyphEmpty, Selected, Down, DrawDowned,
      ADroppedDown, IsSplit, AAllowFading: Boolean);
  protected
    ...
    procedure DrawBarMarkState(ABarControl: TdxBarControl; DC: HDC;
      const R: TRect; AState: TdxBarMarkState);
    ...
    procedure DrawGlyphBorder(ABarItemControl: TdxBarItemControl; DC: HDC;
      ...
      IsGlyphEmpty, Selected, Down, DrawDowned, ADroppedDown,
      IsSplit: Boolean); override;
    ...
    // SubMenuControl
    procedure SubMenuControlDrawMarkSelection(ABarSubMenuControl
      : TdxBarSubMenuControl; ADC: HDC; const AMarkRect: TRect); override;

    // Hints
    function CreateHintViewInfo(ABarManager: TdxBarManager; AHintText: string;
      const AShortCut: string; AScreenTip: TdxScreenTip)
      : TdxBarCustomHintViewInfo; override;

    property Bar[AIsVertical: Boolean]: TdxSkinElement read GetBar;
    property BarCustomize[AIsVertical: Boolean]: TdxSkinElement
      read GetBarCustomize;
    ...
    property BarSeparator[AIsVertical: Boolean]: TdxSkinElement
      read GetBarSeparator;
    property Dock: TdxSkinElement read GetDock;
    property DockControlWindowButton: TdxSkinElement
      read GetDockControlWindowButton;
    property DockControlWindowButtonGlyph: TdxSkinElement
      read GetDockControlWindowButtonGlyph;
    ...
    property MainMenuCustomize[AIsVertical: Boolean]: TdxSkinElement
      read GetMainMenuCustomize;
    ...
    property MDIButton[Button: TdxBarMDIButton]: TdxSkinElement
      read GetMDIButton;
    property PopupMenu: TdxSkinElement read GetPopupMenu;
    property PopupMenuCheck: TdxSkinElement read GetPopupMenuCheck;
    property PopupMenuExpandButton: TdxSkinElement
      read GetPopupMenuExpandButton;
    property PopupMenuLinkSelected: TdxSkinElement
      read GetPopupMenuLinkSelected;
    ...
    property PopupMenuSideStripNonRecent: TdxSkinElement
      read GetPopupMenuSideStripNonRecent;
    property PopupMenuSplitButton: TdxSkinElement read GetPopupMenuSplitButton;
    property PopupMenuSplitButton2: TdxSkinElement
      read GetPopupMenuSplitButton2;
  ...
  public
    ...
    function IsCustomSelectedTextColorExists(ABarItemControl: TdxBarItemControl)
      : Boolean; override;
    // Sizes
    class function GetPopupWindowBorderWidth: Integer; override;
    // Draw
    procedure DrawItemBackgroundInSubMenu(const ADrawParams
      : TdxBarButtonLikeControlDrawParams; R: TRect); override;
    function GetGlyphColorPalette(ABarItemControl: TdxBarItemControl;
      APaintType: TdxBarPaintType; ASelected, ADowned, ADrawDowned,
      ADroppedDown, AIsSplit: Boolean): IdxColorPalette; override;
    function GetState(ASelected, ADowned, ADrawDowned, ADroppedDown,
      AIsMenuItem: Boolean): TdxSkinElementState;
    ...
    procedure BarBorderPaintSizes(ABarControl: TdxBarControl;
      var R: TRect); override;
    procedure BarBorderSizes(ABar: TdxBar; AStyle: TdxBarDockingStyle;
      var R: TRect); override;
    ...
    function StatusBarGripSize(ABarManager: TdxBarManager;
    ...
    procedure BarDrawCloseButton(ABarControl: TdxBarControl; DC: HDC;
      R: TRect); override;
    procedure BarDrawDockedBarBorder(ABarControl: TdxBarControl; DC: HDC;
      R: TRect; AToolbarBrush: HBRUSH); override;
    ...
    procedure BarDrawMDIButton(ABarControl: TdxBarControl;
      AButton: TdxBarMDIButton; AState: Integer; DC: HDC; R: TRect); override;
    procedure BarDrawStatusBarBorder(ABarControl: TdxBarControl; DC: HDC;
      R: TRect; AToolbarBrush: HBRUSH); override;
    function BarLinkedOwnerHasShadow(ABarControl: TCustomdxBarControl)
      : Boolean; override;
    ...
    procedure StatusBarFillBackground(ABarControl: TdxBarControl; DC: HDC;
      ADestR, ASourceR, AWholeR: TRect; ABrush: HBRUSH;
      AColor: TColor); override;

    // Edit
    function EditGetDisabledBkColor(ABarItemControl: TdxBarCustomEditControl)
      : TColor; override;
    function EditGetDisabledTextColor: TColor; override;
    function EditGetEnabledBkColor(ABarItemControl: TdxBarCustomEditControl)
      : TColor; override;
    ...
    function ComboBoxArrowWidth(ABarControl: TCustomdxBarControl; cX: Integer)
      : Integer; override;
    // Draw
    ...
    procedure BarDrawFloatingBackground(ABarControl: TCustomdxBarControl;
      DC: HDC; ADestR, ASourceR: TRect; ABrush: HBRUSH;
      AColor: TColor); override;
    class procedure BarDrawOwnerLink(ABarControl: TCustomdxBarControl;
      DC: HDC); override;

    // DropDownListBox
    class function DropDownListBoxBorderSize: Integer; override;
    procedure DropDownListBoxDrawBorder(DC: HDC; AColor: TColor;
    ...
    function SubMenuControlBeginGroupRect(ABarSubMenuControl
      : TdxBarSubMenuControl; AControl: TdxBarItemControl;
    ...
    procedure SubMenuControlCalcDrawingConsts(ACanvas: TcxCanvas;
      ATextSize: Integer; AScaleFactor: TdxScaleFactor;
      out AMenuArrowWidth, AMarkSize: Integer); override;
    class function SubMenuControlDetachCaptionAreaSize(ABarSubMenuControl
      : TdxBarSubMenuControl): Integer; override;
    class procedure SubMenuControlOffsetDetachCaptionRect(ABarSubMenuControl
      : TdxBarSubMenuControl; var R: TRect); override;
    // Positions
    class function SubMenuControlGetItemTextIndent(const ADrawParams
      : TdxBarItemControlDrawParams): Integer; override;
    // Draw
    procedure SubMenuControlDrawBeginGroup(ABarSubMenuControl
      : TdxBarSubMenuControl; AControl: TdxBarItemControl; ACanvas: TcxCanvas;
      const ABeginGroupRect: TRect); override;
    procedure SubMenuControlDrawBorder(ABarSubMenuControl: TdxBarSubMenuControl;
      DC: HDC; R: TRect); override;
    procedure SubMenuControlDrawClientBorder(ABarSubMenuControl
      : TdxBarSubMenuControl; DC: HDC; const R: TRect; ABrush: HBRUSH);
      override;
    procedure SubMenuControlDrawBackground(ABarSubMenuControl
      : TdxBarSubMenuControl; ACanvas: TcxCanvas; ARect: TRect; ABrush: HBRUSH;
      AColor: TColor); override;
    procedure SubMenuControlDrawDetachCaption(ABarSubMenuControl
      : TdxBarSubMenuControl; DC: HDC; R: TRect); override;
    procedure SubMenuControlDrawMarkContent(ABarSubMenuControl
      : TdxBarSubMenuControl; DC: HDC; R: TRect; ASelected: Boolean); override;
    procedure SubMenuControlDrawSeparator(ACanvas: TcxCanvas;
      const ARect: TRect); override;
    procedure SubMenuControlDrawSeparatorBackground(ACanvas: TcxCanvas;
      const ARect: TRect);

    // Mark
    // Draw
    procedure BarDrawMark(ABarControl: TdxBarControl; DC: HDC;
      MarkR: TRect); override;
    ...
    // Button Control
    // Conditions
    function IsButtonControlArrowBackgroundOpaque(const ADrawParams
      : TdxBarButtonLikeControlDrawParams): Boolean; override;
    function IsButtonControlArrowDrawSelected(const ADrawParams
      : TdxBarButtonLikeControlDrawParams): Boolean; override;
    function IsDropDownRepaintNeeded: Boolean; override;
    // Sizes
    class procedure CorrectButtonControlDefaultHeight(var DefaultHeight
      : Integer); override;
    class procedure CorrectButtonControlDefaultWidth(var DefaultWidth
      : Integer); override;
    // Draw
    procedure DrawButtonControlArrowBackground(const ADrawParams
      : TdxBarButtonLikeControlDrawParams; var R1: TRect;
      ABrush: HBRUSH); override;

    // ColorCombo
    // Conditions
    function ColorComboHasCompleteFrame: Boolean; override;
    // Sizes
    function GetCustomColorButtonIndents(APaintType: TdxBarPaintType)
      : TRect; override;
    function GetCustomColorButtonWidth(APaintType: TdxBarPaintType;
      const ARect: TRect): Integer; override;
    // Draw
    procedure ColorComboDrawCustomButton(const ADrawParams
      : TdxBarColorComboControlDrawParams; ARect: TRect); override;
    procedure ColorComboDrawCustomButtonAdjacentZone(const ADrawParams
      : TdxBarColorComboControlDrawParams; ARect: TRect); override;

    // EditControl
    // Conditions
    class function EditControlCaptionBackgroundIsOpaque(const ADrawParams
      : TdxBarEditLikeControlDrawParams): Boolean; override;
    class function EditControlCaptionRightIndentIsOpaque(const ADrawParams
      : TdxBarEditLikeControlDrawParams): Boolean; override;
    // Sizes
    class function EditControlBorderOffsets(APaintType: TdxBarPaintType)
      : TRect; override;
    // Draw
    procedure EditControlDrawBackground(const ADrawParams
      : TdxBarEditLikeControlDrawParams); override;
    procedure EditControlDrawBorder(const ADrawParams
      : TdxBarEditLikeControlDrawParams; var ARect: TRect); override;
    procedure EditControlDrawSelectionFrame(const ADrawParams
      : TdxBarEditLikeControlDrawParams; const ARect: TRect); override;
    // Select EditControl indents
    class function EditControlCaptionSimpleIndent(const ADrawParams
      : TdxBarEditLikeControlDrawParams): Integer; override;
    ...
    procedure DateNavigatorDrawButton(ABarItem: TdxBarItem; DC: HDC; R: TRect;
      const ACaption: string; APressed: Boolean;
      AScaleFactor: TdxScaleFactor); override;

    // InPlaceSubItemControl
    // Conditions
    function InPlaceSubItemControlIsArrowSelected(const ADrawParams
      : TdxBarInPlaceSubItemControlDrawParams): Boolean; override;
    // Draw
    procedure InPlaceSubItemControlDrawBackground(const ADrawParams
      : TdxBarInPlaceSubItemControlDrawParams; ARect: TRect); override;

    // SpinEditControl
    // Sizes
    function GetSpinEditButtonWidth(APaintType: TdxBarPaintType;
      const ARect: TRect): Integer; override;
    function GetSpinEditButtonIndents(APaintType: TdxBarPaintType)
      : TRect; override;
    // Draw
    procedure SpinEditControlDrawButton(const ADrawParams
      : TdxBarSpinEditDrawParams; ARect: TRect; AButtonIndex: Integer);
      override;
    procedure SpinEditControlDrawButtonsAdjacentZone(const ADrawParams
      : TdxBarSpinEditDrawParams; const ARect: TRect); override;
    // Others
    procedure CalculateSpinEditParts(const ADrawParams
      : TdxBarSpinEditDrawParams;
      var AParts, AAreaParts: array of TRect); override;
    procedure SpinEditCorrectFrameRect(const ADrawParams
      : TdxBarItemControlDrawParams; var ARect: TRect); override;

    // ProgressControl
    // Sizes
    function ProgressControlBarHeight(ABarItemControl: TdxBarItemControl)
      : Integer; override;
    class function ProgressControlIndent(const ADrawParams
      : TdxBarItemControlDrawParams): Integer; override;
    // Draw
    procedure ProgressControlDrawBackground(const ADrawParams
      : TdxBarItemControlDrawParams; var BarR: TRect); override;
    procedure ProgressControlFillContent(const ADrawParams
      : TdxBarItemControlDrawParams; const R: TRect;
      ABarBrush: HBRUSH); override;

    // StaticControl
    // Sizes
    function StaticControlGetBorderOffsets(AParent: TCustomdxBarControl;
      ABorderStyle: TdxBarStaticBorderStyle): TRect; override;
    // Draw
    procedure DrawStaticBackground(const ADrawParams
      : TdxBarStaticLikeControlDrawParams; ARect: TRect); override;
    procedure DrawStaticBorder(const ADrawParams
      : TdxBarStaticLikeControlDrawParams; var ARect: TRect); override;
    ...
    procedure SeparatorControlGetTextColors(ABarItemControl: TdxBarItemControl;
      AEnabled, ASelected, AFlat: Boolean;
      var AColor1, AColor2: TColor); override;
    // Draw
    procedure DrawSeparatorGlyphAndCaption(const ADrawParams
      : TdxBarSeparatorControlDrawParams; const ARect: TRect); override;

    // Gallery
    procedure DropDownGalleryDrawBackground(DC: HDC; const R: TRect); override;
    procedure DropDownGalleryDrawBorder(ABarSubMenuControl
      : TdxBarSubMenuControl; DC: HDC; const R: TRect); override;
    procedure DropDownGalleryDrawBottomSizeGrip(DC: HDC;
      const R: TRect); override;
    procedure DropDownGalleryDrawBottomSizeGripEx(ABarSubMenuControl
      : TdxBarSubMenuControl; DC: HDC; const R: TRect); override;
    procedure DropDownGalleryDrawBottomSizingBand(DC: HDC;
      const R: TRect); override;
    procedure DropDownGalleryDrawBottomVerticalSizeGrip(DC: HDC;
      const R: TRect); override;
    procedure DropDownGalleryDrawFilterBand(DC: HDC; const R: TRect); override;
    procedure DropDownGalleryDrawGroupHeaderBackground(DC: HDC;
      const R: TRect); override;
    procedure DropDownGalleryDrawItem(DC: HDC; const R: TRect; AState: Integer;
      AScaleFactor: TdxScaleFactor); override;
    procedure DropDownGalleryDrawScrollBarBackgroundEx(ABarSubItemControl
      : TdxBarSubItemControl; DC: HDC; const R: TRect;
      AScaleFactor: TdxScaleFactor); override;
    procedure DropDownGalleryDrawSelectionFrame(ACanvas: TcxCanvas;
      const R: TRect; AState: Integer); override;
    procedure DropDownGalleryDrawTopSizeGrip(DC: HDC; const R: TRect); override;
    procedure DropDownGalleryDrawTopSizeGripEx(ABarSubMenuControl
      : TdxBarSubMenuControl; DC: HDC; const R: TRect); override;
    procedure DropDownGalleryDrawTopSizingBand(DC: HDC;
      const R: TRect); override;
    procedure DropDownGalleryDrawTopVerticalSizeGrip(DC: HDC;
      const R: TRect); override;
    ...
    function DropDownGalleryGetFilterBandTextColor(AState: Integer)
      : TColor; override;
    function DropDownGalleryGetGroupHeaderTextColor: TColor; override;
    function DropDownGalleryGetNCBorderSize: Integer; override;
    procedure DropDownGalleryItemGetTextColors(ABarItemControl
      : TdxBarItemControl; AEnabled, ASelected, AFlat: Boolean;
      var AColor1, AColor2: TColor); override;
  end;
...
function TdxBarSkinPainter.IsCustomSelectedTextColorExists(ABarItemControl
...
begin
  ...
  begin
    ...
    Result := (ASkinElement.TextColor <> GetSkinElementTextColor(ASkinElement,
      cxbsHot)) or (ASkinElement.TextColor <> GetSkinElementTextColor
      (ASkinElement, cxbsPressed));
  end;
end;
...
procedure TdxBarSkinPainter.DrawItemBackgroundInSubMenu(const ADrawParams
  : TdxBarButtonLikeControlDrawParams; R: TRect);
var
  ASkinElement: TdxSkinElement;
begin
  with ADrawParams do
  begin
    ...
    begin
      ...
      DrawSkinElement(ASkinElement, Canvas.Handle, R,
        dxGetScaleFactor(BarItemControl), 0,
...
begin
  ...
  if ABarControlAccess.IsMainMenu and not ABarControlAccess.IsRealVertical then
    ...
    Result := GetSkinElementSize(BarDrag[ABarControlAccess.IsRealVertical],
      ABarControlAccess.ScaleFactor).cX;
end;

class function TdxBarSkinPainter.BorderSizeX(AScaleFactor
  : TdxScaleFactor): Integer;
begin
  Result := AScaleFactor.Apply(2);
end;

class function TdxBarSkinPainter.BorderSizeY(AScaleFactor
  : TdxScaleFactor): Integer;
begin
  Result := AScaleFactor.Apply(2);
end;
...
procedure TdxBarSkinPainter.BarBorderPaintSizes(ABarControl: TdxBarControl;
  var R: TRect);
var
  ABarControlAccess: TdxBarControlAccess;
...
begin
  ...
  if ABarControlAccess.CanMoving then
    ...
    else if ABarControl.UseRightToLeftAlignment and ABarControlAccess.Horizontal
    then
...
procedure TdxBarSkinPainter.BarBorderSizes(ABar: TdxBar;
  AStyle: TdxBarDockingStyle; var R: TRect);
begin
  R := cxEmptyRect;
...
begin
  ...
  if (ABarControlAccess.DockingStyle <> dsNone) and not ABarAccess.IsStatusBar
  then
  begin
    ...
    begin
      ...
      Result := cxRectInflate(Result, ABorderOffsets.Left, 0,
        ABorderOffsets.Right, 0);
    end
    else
    begin
      if ABarControl.UseRightToLeftAlignment then
        ...
        OffsetRect(Result, ABorderOffsets.Right, 0);
      Result := cxRectInflate(Result, 0, ABorderOffsets.Top, 0,
        ABorderOffsets.Bottom);
    end;
  end;
...
begin
  ...
  begin
    ...
    begin
      ...
      else if ABarControl.UseRightToLeftAlignment then
...
begin
  ABarControlAccess := TdxBarControlAccess(ABarControl);
  Result := GetSkinElementSize(GetBarMarkElement(ABarControlAccess.IsMainMenu,
    False), ABarControlAccess.ScaleFactor).cX;
end;
...
function TdxBarSkinPainter.StatusBarGripSize(ABarManager: TdxBarManager;
  AScaleFactor: TdxScaleFactor): TSize;
begin
  Result := FSkinPainter.ScaledSizeGripSize(AScaleFactor);
end;

procedure TdxBarSkinPainter.BarCaptionFillBackground(ABarControl: TdxBarControl;
...
begin
  TdxBarControlAccess(ABarControl).FillBackground(DC, ABeginGroupRect, 0,
    clNone, True);
  DrawSkinElement(BarSeparator[AHorz], DC, ABeginGroupRect,
    dxGetScaleFactor(ABarControl));
end;

procedure TdxBarSkinPainter.BarDrawCloseButton(ABarControl: TdxBarControl;
  DC: HDC; R: TRect);
begin
  ...
  try
    ...
    DrawFloatingBarCaptionButton(cxPaintCanvas.Handle, R, 2,
      TdxBarControlAccess(ABarControl).CloseButtonState);
  finally
    cxPaintCanvas.EndPaint;
  end;
end;

procedure TdxBarSkinPainter.BarDrawDockedBarBorder(ABarControl: TdxBarControl;
  DC: HDC; R: TRect; AToolbarBrush: HBRUSH);
var
  ASaveIndex: Integer;
begin
...
procedure TdxBarSkinPainter.BarDrawFloatingBarBorder(ABarControl: TdxBarControl;
...
procedure TdxBarSkinPainter.BarDrawFloatingBarCaption
...
begin
  ...
  DrawSkinElement(AElement, DC, R, dxGetScaleFactor(ABarControl), 0,
    GetSkinElementState);
end;

procedure TdxBarSkinPainter.BarDrawStatusBarBorder(ABarControl: TdxBarControl;
  DC: HDC; R: TRect; AToolbarBrush: HBRUSH);
begin
  DrawSkinElementBorders(StatusBar, DC, R);
end;

function TdxBarSkinPainter.BarLinkedOwnerHasShadow
...
begin
  inherited;
  if TdxBarControlAccess(ABarControl).DockingStyle <> dsNone then
  // TdxOffice11Painter
    SendMessage(ABarControl.Handle, WM_NCPAINT, 0, 0);
end;

function TdxBarSkinPainter.EditGetDisabledBkColor(ABarItemControl
  : TdxBarCustomEditControl): TColor;
begin
...
function TdxBarSkinPainter.EditGetEnabledBkColor(ABarItemControl
  : TdxBarCustomEditControl): TColor;
begin
...
begin
  ...
  try
    ...
    OffsetRect(AWholeR, -(ASourceR.Left - ADestR.Left),
      -(ASourceR.Top - ADestR.Top));
    DrawSkinElementParentBackground(cxPaintCanvas.Handle, AWholeR, ABarControl,
      StatusBar);
...
procedure TdxBarSkinPainter.DockControlFillBackground
  (ADockControl: TdxDockControl; DC: HDC; ADestR, ASourceR, AWholeR: TRect;
...
begin
  ...
  cxBitBlt(DC, ADockControlAccess.BackgroundTempBitmap.Canvas.Handle, ADestR,
    ASourceR.TopLeft, SRCCOPY);
end;
...
function TdxBarSkinPainter.ComboBoxArrowWidth(ABarControl: TCustomdxBarControl;
  cX: Integer): Integer;
begin
  Result := cX + 11;
end;

procedure TdxBarSkinPainter.BarDrawDockedBackground(ABarControl: TdxBarControl;
...
begin
  ABarControlAccess := TdxBarControlAccess(ABarControl);
  if (ABarControlAccess.Bar.BorderStyle = bbsNone) or ABarControlAccess.IsBackgroundBitmap
  then
    inherited
  else
  begin
    ASaveIndex := SaveDC(DC);
    try
      IntersectClipRect(DC, ADestR.Left, ADestR.Top, ADestR.Right,
        ADestR.Bottom);
      AWholeR := cxRectBounds(ADestR.Left - ASourceR.Left,
        ADestR.Top - ASourceR.Top, ABarControl.Width, ABarControl.Height);
      InternalDrawDockedBarBackground(ABarControl, DC, AWholeR,
        not cxRectIsEqual(ASourceR, ADestR));
    finally
      RestoreDC(DC, ASaveIndex)
    end;
  end;
...
class procedure TdxBarSkinPainter.BarDrawOwnerLink
  (ABarControl: TCustomdxBarControl; DC: HDC);
begin
  // do nothing
end;

procedure TdxBarSkinPainter.DropDownGalleryDrawBackground(DC: HDC;
  const R: TRect);
var
...
procedure TdxBarSkinPainter.DropDownGalleryDrawBorder(ABarSubMenuControl
  : TdxBarSubMenuControl; DC: HDC; const R: TRect);
var
  ASkinInfo: TdxSkinInfo;
  ASkinElement: TdxSkinElement;
  ARect: TRect;
...
procedure TdxBarSkinPainter.DropDownGalleryDrawBottomSizeGrip(DC: HDC;
  const R: TRect);
var
  ASkinInfo: TdxSkinInfo;
  ASkinElement: TdxSkinElement;
...
procedure TdxBarSkinPainter.DropDownGalleryDrawBottomSizeGripEx
...
begin
  ...
  if ASkinElement = nil then
    ...
    DrawSkinElement(ASkinElement, DC, DropDownGalleryGetSizeGripRect(R,
      SizeGripCorner[ABarSubMenuControl.UseRightToLeftAlignment]),
      dxSystemScaleFactor, 1, esNormal,
      ABarSubMenuControl.UseRightToLeftAlignment);
end;

procedure TdxBarSkinPainter.DropDownGalleryDrawBottomSizingBand(DC: HDC;
  const R: TRect);
var
  ASkinInfo: TdxSkinInfo;
  ASkinElement: TdxSkinElement;
...
procedure TdxBarSkinPainter.DropDownGalleryDrawBottomVerticalSizeGrip(DC: HDC;
  const R: TRect);
var
  ASkinInfo: TdxSkinInfo;
  ASkinElement: TdxSkinElement;
...
procedure TdxBarSkinPainter.DropDownGalleryDrawFilterBand(DC: HDC;
  const R: TRect);
begin
  DropDownGalleryDrawGroupHeaderBackground(DC, R);
end;

procedure TdxBarSkinPainter.DropDownGalleryDrawGroupHeaderBackground(DC: HDC;
  const R: TRect);
var
  ASkinInfo: TdxSkinInfo;
  ASkinElement: TdxSkinElement;
...
procedure TdxBarSkinPainter.DropDownGalleryDrawItem(DC: HDC; const R: TRect;
  AState: Integer; AScaleFactor: TdxScaleFactor);
  ...
  const
    StateMap: array [0 .. 8] of TdxSkinElementState = (esNormal, esDisabled,
      esHot, esActive, esPressed, esChecked, esChecked, esHotCheck,
      esActiveDisabled);
  begin
...
begin
  ...
  begin
    ...
    ASkinElement.Draw(DC, R, 0, dxSkinElementCheckState(ASkinElement,
      GetSkinElementState(AState)));
  end;
end;

procedure TdxBarSkinPainter.DropDownGalleryDrawScrollBarBackgroundEx
  (ABarSubItemControl: TdxBarSubItemControl; DC: HDC; const R: TRect;
  AScaleFactor: TdxScaleFactor);
var
  ASkinInfo: TdxSkinInfo;
  ASkinElement: TdxSkinElement;
...
begin
  ...
  if ASkinElement = nil then
    inherited DropDownGalleryDrawScrollBarBackgroundEx(ABarSubItemControl, DC,
      R, AScaleFactor)
  else
  begin
    R1 := R;
    Dec(R1.Left, Max(ASkinElement.Size.cX, ASkinElement.Image.Margins.Left));
    AIsRightToLeft := (ABarSubItemControl <> nil) and
      ABarSubItemControl.UseRightToLeftAlignment;
    if AIsRightToLeft then
      R1 := TdxRightToLeftLayoutConverter.ConvertRect(R1, R);
    DrawSkinElement(ASkinElement, DC, R1, dxSystemScaleFactor, 0, esNormal,
      AIsRightToLeft);
  end;
end;

procedure TdxBarSkinPainter.DropDownGalleryDrawSelectionFrame
...
begin
  ...
  begin
    ...
    try
      ...
      DrawSkinElement(ASkinInfo.GalleryItem, ACanvas.Handle, R,
        dxDefaultScaleFactor, 0, dxSkinElementCheckState(ASkinInfo.GalleryItem,
        GetSkinElementState));
    finally
...
procedure TdxBarSkinPainter.DropDownGalleryDrawTopSizeGrip(DC: HDC;
  const R: TRect);
var
  ASkinInfo: TdxSkinInfo;
  ASkinElement: TdxSkinElement;
...
procedure TdxBarSkinPainter.DropDownGalleryDrawTopSizeGripEx(ABarSubMenuControl
  : TdxBarSubMenuControl; DC: HDC; const R: TRect);
const
...
begin
  ...
  if ASkinElement = nil then
    ...
    DrawSkinElement(ASkinElement, DC, DropDownGalleryGetSizeGripRect(R,
      SizeGripCorner[ABarSubMenuControl.UseRightToLeftAlignment]),
      dxSystemScaleFactor, 2, esNormal,
      ABarSubMenuControl.UseRightToLeftAlignment);
end;

procedure TdxBarSkinPainter.DropDownGalleryDrawTopSizingBand(DC: HDC;
  const R: TRect);
var
  ASkinInfo: TdxSkinInfo;
  ASkinElement: TdxSkinElement;
...
procedure TdxBarSkinPainter.DropDownGalleryDrawTopVerticalSizeGrip(DC: HDC;
  const R: TRect);
var
  ASkinInfo: TdxSkinInfo;
  ASkinElement: TdxSkinElement;
...
function TdxBarSkinPainter.DropDownGalleryGetContentOffsets
  (APart: Integer): TRect;
var
  ASkinInfo: TdxSkinInfo;
  ASkinElement: TdxSkinElement;
...
function TdxBarSkinPainter.DropDownGalleryGetFilterBandTextColor
...
procedure TdxBarSkinPainter.DropDownGalleryItemGetTextColors(ABarItemControl
  : TdxBarItemControl; AEnabled, ASelected, AFlat: Boolean;
...
var
  ...
  ASkinInfo: TdxSkinInfo;
begin
  if GetSkinPainterData(ASkinInfo) and not TdxBarSubItemControlAccess
    (ABarItemControl).GetCollapsed then
    if AEnabled then
    begin
      ADrawParams := TdxBarItemControlAccess(ABarItemControl).FDrawParams;
      if TdxBarSkinnedPainterAccess.GetPartState(ADrawParams, icpControl) <> DXBAR_NORMAL
      then
        AColor1 := GetSkinElementTextColor(ASkinInfo.RibbonSmallButton, cxbsHot)
      else
        AColor1 := clDefault;
      AColor1 := cxGetActualColor(AColor1,
        GetSkinElementTextColor(ASkinInfo.RibbonGalleryBackground, cxbsNormal));
      AColor2 := AColor1;
    end
    else
      GetDisabledTextColors(ABarItemControl, ASelected, AFlat, AColor1, AColor2)
  else
    inherited DropDownGalleryItemGetTextColors(ABarItemControl, AEnabled,
      ASelected, AFlat, AColor1, AColor2);
end;
...
procedure TdxBarSkinPainter.DropDownListBoxDrawBorder(DC: HDC; AColor: TColor;
  ARect: TRect);
begin
  cxPaintCanvas.BeginPaint(DC);
  try
...
function TdxBarSkinPainter.SubMenuControlBeginGroupRect(ABarSubMenuControl
  : TdxBarSubMenuControl; AControl: TdxBarItemControl;
  const AItemRect: TRect): TRect;
begin
  Result := AItemRect;
  Result.Bottom := Result.Top;
  Dec(Result.Top, TdxBarSubMenuControlAccess(ABarSubMenuControl)
    .BeginGroupSize); // TdxBarXPPainter
end;
...
procedure TdxBarSkinPainter.SubMenuControlCalcDrawingConsts(ACanvas: TcxCanvas;
  ATextSize: Integer; AScaleFactor: TdxScaleFactor;
  out AMenuArrowWidth, AMarkSize: Integer);
begin
  inherited;
  if PopupMenuExpandButton <> nil then
    AMarkSize := GetSkinElementSize(PopupMenuExpandButton,
      dxDefaultScaleFactor).cy;
end;

class function TdxBarSkinPainter.SubMenuControlDetachCaptionAreaSize
  (ABarSubMenuControl: TdxBarSubMenuControl): Integer;
begin
  Result := TdxBarSubMenuControlAccess(ABarSubMenuControl).DetachCaptionSize +
    1; // TdxBarXPPainter
end;

class procedure TdxBarSkinPainter.SubMenuControlOffsetDetachCaptionRect
  (ABarSubMenuControl: TdxBarSubMenuControl; var R: TRect);
begin
  R := cxRectInflate(R, TdxBarSubMenuControlAccess(ABarSubMenuControl)
    .ScaleFactor.Apply(-2)); // TdxBarXPPainter
end;

class function TdxBarSkinPainter.SubMenuControlGetItemTextIndent
  (const ADrawParams: TdxBarItemControlDrawParams): Integer;
begin
  Result := TdxBarFlatPainter.SubMenuControlGetItemTextIndent(ADrawParams);
end;

procedure TdxBarSkinPainter.SubMenuControlDrawBeginGroup(ABarSubMenuControl
  : TdxBarSubMenuControl; AControl: TdxBarItemControl; ACanvas: TcxCanvas;
  const ABeginGroupRect: TRect);
var
  ARect: TRect;
begin
  ARect := cxRect(ABeginGroupRect.Left + SubMenuBeginGroupIndent +
    TdxBarItemControlAccess(AControl).TextAreaOffset, ABeginGroupRect.Bottom -
    SubMenuGetSeparatorSize, ABeginGroupRect.Right, ABeginGroupRect.Bottom);
  ...
  DrawSkinElement(PopupMenuSeparator, ACanvas.Handle, ARect,
    dxGetScaleFactor(ABarSubMenuControl), 0, esNormal,
    ABarSubMenuControl.UseRightToLeftAlignment);
end;

procedure TdxBarSkinPainter.SubMenuControlDrawBorder(ABarSubMenuControl
  : TdxBarSubMenuControl; DC: HDC; R: TRect);
var
...
begin
  ...
  cxPaintCanvas.BeginPaint(DC);
  try
    cxPaintCanvas.ExcludeClipRect(cxRectContent(R,
      ABarSubMenuControlAccess.GetClientOffset));
    DrawSkinElement(PopupMenu, DC, R, dxGetScaleFactor(ABarSubMenuControl));
    SubMenuControlDrawDetachCaption(ABarSubMenuControl, DC,
      ABarSubMenuControlAccess.DetachCaptionRect);
  finally
    cxPaintCanvas.EndPaint;
  end;
end;

procedure TdxBarSkinPainter.SubMenuControlDrawClientBorder(ABarSubMenuControl
  : TdxBarSubMenuControl; DC: HDC; const R: TRect; ABrush: HBRUSH);
var
  ASaveIndex: Integer;
begin
  ...
  try
    ...
    DrawSkinElement(PopupMenu, DC,
      cxRectInflate(R, TdxBarSubMenuControlAccess(ABarSubMenuControl)
      .GetClientOffset), dxGetScaleFactor(ABarSubMenuControl));
  finally
    RestoreDC(DC, ASaveIndex);
  end;
end;

procedure TdxBarSkinPainter.SubMenuControlDrawBackground(ABarSubMenuControl
  : TdxBarSubMenuControl; ACanvas: TcxCanvas; ARect: TRect; ABrush: HBRUSH;
  AColor: TColor);
var
...
begin
  if not TdxBarSubMenuControlAccess(ABarSubMenuControl).GetBackgroundBitmap.Empty
  then
    inherited
  else
  begin
    ...
    if ABarSubMenuControl.UseRightToLeftAlignment then
    begin
      ABandRect := Rect(ABarRect.Left - ASubMenuControlAccess.BandSize -
        ASubMenuControlAccess.GetIndent2, AContentRect.Top, ABarRect.Left,
        AContentRect.Bottom);
    ...
    begin
      ABandRect := Rect(ABarRect.Right, AContentRect.Top,
        ABarRect.Right + ASubMenuControlAccess.BandSize +
        ASubMenuControlAccess.GetIndent2, AContentRect.Bottom);

      ASeparatorRect := Rect(ABandRect.Right, AContentRect.Top,
        ABandRect.Right + 2, AContentRect.Bottom);
      // dxBar.MenuSeparatorSize = 2
    ...
    DrawSkinElement(PopupMenu, ACanvas.Handle,
      cxRectInflate(ASubMenuControlAccess.ContentRect, SubMenuControlBorderSize,
      SubMenuControlBorderSize), dxGetScaleFactor(ABarSubMenuControl));
...
procedure TdxBarSkinPainter.SubMenuControlDrawDetachCaption(ABarSubMenuControl
  : TdxBarSubMenuControl; DC: HDC; R: TRect);
begin
...
procedure TdxBarSkinPainter.SubMenuControlDrawMarkContent(ABarSubMenuControl
  : TdxBarSubMenuControl; DC: HDC; R: TRect; ASelected: Boolean);
begin
  DrawSkinElement(PopupMenuExpandButton, DC, R,
    dxGetScaleFactor(ABarSubMenuControl));
end;

procedure TdxBarSkinPainter.SubMenuControlDrawSeparator(ACanvas: TcxCanvas;
  const ARect: TRect);
begin
  ...
  begin
    ...
    DrawSkinElement(PopupMenuSeparator, ACanvas.Handle, ARect,
      dxDefaultScaleFactor, 0, esNormal, ACanvas.UseRightToLeftAlignment);
  end;
end;
...
procedure TdxBarSkinPainter.BarDrawMark(ABarControl: TdxBarControl; DC: HDC;
  MarkR: TRect);
begin
  cxPaintCanvas.BeginPaint(DC);
  try
    ...
    DrawFloatingBarCaptionButton(cxPaintCanvas.Handle, MarkR, 6,
      TdxBarControlAccess(ABarControl).MarkState);
  finally
    cxPaintCanvas.EndPaint;
  end;
end;
...
function TdxBarSkinPainter.IsButtonControlArrowBackgroundOpaque
  (const ADrawParams: TdxBarButtonLikeControlDrawParams): Boolean;
begin
  Result := False;
end;

function TdxBarSkinPainter.IsButtonControlArrowDrawSelected(const ADrawParams
  : TdxBarButtonLikeControlDrawParams): Boolean;
begin
  Result := False;
end;
...
class procedure TdxBarSkinPainter.CorrectButtonControlDefaultHeight
  (var DefaultHeight: Integer);
begin
  Inc(DefaultHeight, 5);
end;

class procedure TdxBarSkinPainter.CorrectButtonControlDefaultWidth
  (var DefaultWidth: Integer);
begin
  Inc(DefaultWidth, 9);
end;

procedure TdxBarSkinPainter.DrawButtonControlArrowBackground(const ADrawParams
  : TdxBarButtonLikeControlDrawParams; var R1: TRect; ABrush: HBRUSH);
var
  ASkinElement: TdxSkinElement;
begin
...
function TdxBarSkinPainter.GetCustomColorButtonIndents
  (APaintType: TdxBarPaintType): TRect;
begin
  Result := EditControlBorderOffsets(APaintType);
  Result.Left := 0;
end;

function TdxBarSkinPainter.GetCustomColorButtonWidth
  (APaintType: TdxBarPaintType; const ARect: TRect): Integer;
begin
  Result := 17;
end;

procedure TdxBarSkinPainter.ColorComboDrawCustomButton(const ADrawParams
  : TdxBarColorComboControlDrawParams; ARect: TRect);
...
begin
  FSkinPainter.DrawScaledEditorButton(ADrawParams.Canvas, ARect,
    cxbkEllipsisBtn, GetState, ADrawParams.ScaleFactor);
  FSkinPainter.DrawScaledEditorButtonGlyph(ADrawParams.Canvas, ARect,
    cxbkEllipsisBtn, GetState, ADrawParams.ScaleFactor);
end;

procedure TdxBarSkinPainter.ColorComboDrawCustomButtonAdjacentZone
  (const ADrawParams: TdxBarColorComboControlDrawParams; ARect: TRect);
begin
  FillRectByColor(ADrawParams.Canvas.Handle,
    cxRectContent(ARect, GetCustomColorButtonIndents(ADrawParams.PaintType)),
    EditGetBkColor(ADrawParams));
end;

class function TdxBarSkinPainter.EditControlCaptionBackgroundIsOpaque
  (const ADrawParams: TdxBarEditLikeControlDrawParams): Boolean;
begin
  Result := False;
end;

class function TdxBarSkinPainter.EditControlCaptionRightIndentIsOpaque
  (const ADrawParams: TdxBarEditLikeControlDrawParams): Boolean;
begin
  Result := EditControlCaptionBackgroundIsOpaque(ADrawParams);
end;

class function TdxBarSkinPainter.EditControlBorderOffsets
  (APaintType: TdxBarPaintType): TRect;
begin
...
procedure TdxBarSkinPainter.EditControlDrawBackground(const ADrawParams
  : TdxBarEditLikeControlDrawParams);
begin
  with ADrawParams do
  begin
    Canvas.SaveClipRegion;
    Canvas.ExcludeClipRect(EditControlGetContentRect(PaintType,
      TdxBarEditControlAccess(BarEditControl).GetEditRect));
    DrawBackground(BarEditControl, Canvas.Handle, BarEditControl.ItemBounds,
      0, False);
    Canvas.RestoreClipRegion;
  end;
end;

procedure TdxBarSkinPainter.EditControlDrawBorder(const ADrawParams
  : TdxBarEditLikeControlDrawParams; var ARect: TRect);
begin
  with ADrawParams do
  begin
    ARect := cxRectContent(ARect, EditControlBorderOffsets(PaintType));
    // TODO cxProgress: TdxBarItemControlAccess(BarEditControl).CanSelect
    if not IsTransparent or (IsTransparent and DrawSelected and
      not(PaintType = ptMenu)) then
      FrameRectByColor(Canvas.Handle, cxRectInflate(ARect, 1, 1),
        FSkinPainter.GetContainerBorderColor(DrawSelected and
        (PaintType <> ptMenu)));
  end;
end;

procedure TdxBarSkinPainter.EditControlDrawSelectionFrame(const ADrawParams
  : TdxBarEditLikeControlDrawParams; const ARect: TRect);
const
...
begin
  ...
  begin
    Canvas.SaveClipRegion;
    AExcludedRect := EditControlGetContentRect(PaintType,
      TdxBarEditControlAccess(BarEditControl).GetEditRect);
    ...
    try
      DrawSkinElement(PopupMenuLinkSelected, Canvas.Handle, ARect,
        dxGetScaleFactor(BarItemControl), 0, State[Enabled]);
    finally
      Canvas.RestoreClipRegion;
    end;
  end;
...
class function TdxBarSkinPainter.EditControlCaptionSimpleIndent
...
class procedure TdxBarSkinPainter.CustomComboDrawItem(ABarCustomCombo
  : TdxBarCustomCombo; ACanvas: TCanvas; AIndex: Integer; ARect: TRect;
  AState: TOwnerDrawState; AInteriorIsDrawing: Boolean);
begin
  TdxBarFlatPainter.CustomComboDrawItem(ABarCustomCombo, ACanvas, AIndex, ARect,
    AState, AInteriorIsDrawing);
end;
...
procedure TdxBarSkinPainter.ComboControlDrawArrowButton(const ADrawParams
  : TdxBarEditLikeControlDrawParams; ARect: TRect; AInClientArea: Boolean);
...
begin
  FillRectByColor(ADrawParams.Canvas.Handle, ARect,
    EditGetBkColor(ADrawParams));
  if ADrawParams.Canvas.UseRightToLeftAlignment then
    AButtonPosition := cxbpLeft
  else
    AButtonPosition := cxbpRight;
  FSkinPainter.DrawScaledEditorButton(ADrawParams.Canvas, ARect, cxbkComboBtn,
    GetState, ADrawParams.ScaleFactor, AButtonPosition);
  FSkinPainter.DrawScaledEditorButtonGlyph(ADrawParams.Canvas, ARect,
    cxbkComboBtn, GetState, ADrawParams.ScaleFactor, AButtonPosition);
end;
...
begin
  ...
  try
    ...
    FSkinPainter.DrawScaledButton(cxPaintCanvas, R, ACaption, State[APressed],
      AScaleFactor);
  finally
    cxPaintCanvas.EndPaint;
  end;
...
function TdxBarSkinPainter.InPlaceSubItemControlIsArrowSelected
  (const ADrawParams: TdxBarInPlaceSubItemControlDrawParams): Boolean;
begin
  Result := False;
end;

procedure TdxBarSkinPainter.InPlaceSubItemControlDrawBackground
  (const ADrawParams: TdxBarInPlaceSubItemControlDrawParams; ARect: TRect);
begin
  if ADrawParams.DrawSelected then
    DrawItemBackgroundInSubMenu(ADrawParams, ARect)
  else
  begin
    DrawBackground(ADrawParams.BarItemControl, ADrawParams.Canvas.Handle, ARect,
      0, False);
    DrawSkinElementContent(PopupMenuSideStrip, ADrawParams.Canvas.Handle, ARect,
      dxGetScaleFactor(ADrawParams.BarItemControl));
  end;
end;

function TdxBarSkinPainter.GetSpinEditButtonWidth(APaintType: TdxBarPaintType;
  const ARect: TRect): Integer;
begin
  Result := 17;
end;

function TdxBarSkinPainter.GetSpinEditButtonIndents
  (APaintType: TdxBarPaintType): TRect;
begin
  Result := EditControlBorderOffsets(APaintType);
  Result.Left := 0;
...
procedure TdxBarSkinPainter.SpinEditControlDrawButton(const ADrawParams
  : TdxBarSpinEditDrawParams; ARect: TRect; AButtonIndex: Integer);
const
  ButtonKind: array [Boolean] of TcxEditBtnKind = (cxbkSpinDownBtn,
    cxbkSpinUpBtn);
begin
  FSkinPainter.DrawScaledEditorButton(ADrawParams.Canvas, ARect,
    ButtonKind[AButtonIndex = secButtonUp], GetSpinEditButtonState(ADrawParams,
    AButtonIndex), ADrawParams.ScaleFactor);
  FSkinPainter.DrawScaledEditorButtonGlyph(ADrawParams.Canvas, ARect,
    ButtonKind[AButtonIndex = secButtonUp], GetSpinEditButtonState(ADrawParams,
    AButtonIndex), ADrawParams.ScaleFactor);
end;

procedure TdxBarSkinPainter.SpinEditControlDrawButtonsAdjacentZone
  (const ADrawParams: TdxBarSpinEditDrawParams; const ARect: TRect);
begin
  FillRectByColor(ADrawParams.Canvas.Handle,
    cxRectContent(ARect, GetSpinEditButtonIndents(ADrawParams.PaintType)),
    EditGetBkColor(ADrawParams));
end;

procedure TdxBarSkinPainter.CalculateSpinEditParts(const ADrawParams
  : TdxBarSpinEditDrawParams; var AParts, AAreaParts: array of TRect);
begin
  inherited;
  AParts[ecpEdit].Right := AParts[secButtonUp].Left;
end;

procedure TdxBarSkinPainter.SpinEditCorrectFrameRect(const ADrawParams
  : TdxBarItemControlDrawParams; var ARect: TRect);
begin
  // do nothing
end;

function TdxBarSkinPainter.ProgressControlBarHeight(ABarItemControl
  : TdxBarItemControl): Integer;
begin
  Result := 24;
end;

class function TdxBarSkinPainter.ProgressControlIndent(const ADrawParams
  : TdxBarItemControlDrawParams): Integer;
begin
  Result := TdxBarOffice11Painter.ProgressControlIndent(ADrawParams);
end;

procedure TdxBarSkinPainter.ProgressControlDrawBackground(const ADrawParams
  : TdxBarItemControlDrawParams; var BarR: TRect);
begin
  DrawBackground(ADrawParams.BarItemControl, ADrawParams.Canvas.Handle, BarR,
    0, False);
  FSkinPainter.DrawProgressBarBorder(ADrawParams.Canvas, BarR,
    ADrawParams.PaintType = ptVert);
  BarR := cxRectContent(BarR, FSkinPainter.ProgressBarBorderSize
    (ADrawParams.PaintType = ptVert));
end;

procedure TdxBarSkinPainter.ProgressControlFillContent(const ADrawParams
  : TdxBarItemControlDrawParams; const R: TRect; ABarBrush: HBRUSH);
begin
  FSkinPainter.DrawProgressBarChunk(ADrawParams.Canvas, R,
    ADrawParams.PaintType = ptVert);
end;

function TdxBarSkinPainter.StaticControlGetBorderOffsets
  (AParent: TCustomdxBarControl; ABorderStyle: TdxBarStaticBorderStyle): TRect;
begin
  if (LinkBorderPainter <> nil) and TCustomdxBarControlAccess(AParent).IsStatusBar
  then
...
procedure TdxBarSkinPainter.DrawStaticBackground(const ADrawParams
  : TdxBarStaticLikeControlDrawParams; ARect: TRect);
begin
  inherited;
  with ADrawParams do
    if (LinkBorderPainter <> nil) and TCustomdxBarControlAccess
      (BarStaticControl.Parent).IsStatusBar then
      DrawSkinElementContent(LinkBorderPainter, Canvas.Handle, ARect,
        dxGetScaleFactor(BarItemControl));
end;

procedure TdxBarSkinPainter.DrawStaticBorder(const ADrawParams
  : TdxBarStaticLikeControlDrawParams; var ARect: TRect);
var
  AContentRect: TRect;
begin
  with ADrawParams do
    if not cxRectIsNull(BorderOffsets) and (LinkBorderPainter <> nil) and
      TCustomdxBarControlAccess(BarStaticControl.Parent).IsStatusBar then
    begin
      Canvas.SaveClipRegion;
      try
...
procedure TdxBarSkinPainter.SeparatorControlGetTextColors(ABarItemControl
  : TdxBarItemControl; AEnabled, ASelected, AFlat: Boolean;
  var AColor1, AColor2: TColor);
const
...
begin
  ...
  begin
    ...
    inherited SeparatorControlGetTextColors(ABarItemControl, AEnabled,
      ASelected, AFlat, AColor1, AColor2);
end;

procedure TdxBarSkinPainter.DrawSeparatorGlyphAndCaption(const ADrawParams
  : TdxBarSeparatorControlDrawParams; const ARect: TRect);
var
  ACaptionRect: TRect;
begin
  with ADrawParams do
  begin
    ...
    DrawSkinElement(ItemSeparator, Canvas.Handle, ARect,
      dxGetScaleFactor(BarItemControl));
    ACaptionRect := ARect;
    ACaptionRect.Left := ACaptionRect.Left + SeparatorControlGetIndents
      (ADrawParams, cpText).Left;
    if Canvas.UseRightToLeftAlignment then
      ACaptionRect := TdxRightToLeftLayoutConverter.ConvertRect
        (ACaptionRect, ARect);
    ...
    DrawItemText(BarItemControl, Canvas.Handle, Caption, ACaptionRect,
      SystemAlignmentsHorz[Alignment], Enabled, False, PaintType = ptVert,
      True, False);
  end;
end;

function TdxBarSkinPainter.GetDefaultEnabledTextColor(ABarItemControl
  : TdxBarItemControl; ASelected, AFlat: Boolean): TColor;
var
  ATextColorElement: TdxSkinElement;
begin
  ATextColorElement := GetTextColorElement(ABarItemControl.Parent);
  if IsBarElementSkinned(ABarItemControl.Parent) and (ATextColorElement <> nil)
  then
  begin
    Result := clDefault;
    if ASelected then
    begin
      if TCustomdxBarControlAccess(ABarItemControl.Parent).IsMainMenu and
        ABarItemControl.IsDroppedDown then
...
procedure TdxBarSkinPainter.GetDisabledTextColors(ABarItemControl
  : TdxBarItemControl; ASelected, AFlat: Boolean; var AColor1, AColor2: TColor);
begin
...
begin
  ABarControlAccess := TdxBarControlAccess(ABarControl);
  AElement := GetBarMarkElement(ABarControlAccess.IsMainMenu,
    ABarControlAccess.Vertical);
  DrawSkinElementParentBackground(DC, R, ABarControl, AElement);
  DrawSkinElement(AElement, DC, R, dxGetScaleFactor(ABarControl), 0,
    StatesMap[AState <> msNone], ABarControl.UseRightToLeftAlignment);
end;

procedure TdxBarSkinPainter.DrawButtonBackground(const ADrawParams
  : TdxBarButtonLikeControlDrawParams);
var
  R: TRect;
begin
  ...
  begin
    ...
    begin
      if Canvas.UseRightToLeftAlignment then
        Inc(R.Left, cxRectWidth(TdxBarItemControlAccess(BarItemControl)
          .FParts[bcpDropButton]))
      else
        Dec(R.Right, cxRectWidth(TdxBarItemControlAccess(BarItemControl)
          .FParts[bcpDropButton]));
    end;
    ButtonLikeDrawGlyphBorder(BarItemControl, Canvas.Handle, 0, False, R,
      PaintType, not(cpIcon in ViewStructure), DrawSelected, Downed, DrawDowned,
      DroppedDown, SplitDropDown and IsDropDown, False);
    if SplitDropDown and IsDropDown then
      DrawSplitControlArrow(ADrawParams, BarItemControl.ItemBounds);
  end;
end;

procedure TdxBarSkinPainter.DrawGlyphEmptyImage(ABarItemControl
  : TdxBarItemControl; DC: HDC; R: TRect; APaintType: TdxBarPaintType;
  ADown: Boolean);
begin
  if (APaintType = ptMenu) and ADown and (PopupMenuCheck <> nil) then
    DrawSkinElement(PopupMenuCheck, DC,
      cxRectCenter(R, cxSizeMax(PopupMenuCheck.Size,
      PopupMenuCheck.MinSize.Size)), dxGetScaleFactor(ABarItemControl),
      0, esNormal)
  else
    inherited;
end;
...
procedure TdxBarSkinPainter.DrawGlyphBorder(ABarItemControl: TdxBarItemControl;
  DC: HDC; ABrush: HBRUSH; NeedBorder: Boolean; R: TRect;
  PaintType: TdxBarPaintType; IsGlyphEmpty, Selected, Down, DrawDowned,
  ADroppedDown, IsSplit: Boolean);
begin
  ButtonLikeDrawGlyphBorder(ABarItemControl, DC, ABrush, NeedBorder, R,
    PaintType, IsGlyphEmpty, Selected, Down, DrawDowned, ADroppedDown,
    IsSplit, True);
end;

function TdxBarSkinPainter.GetGlyphColorPalette(ABarItemControl
  : TdxBarItemControl; APaintType: TdxBarPaintType;
  ASelected, ADowned, ADrawDowned, ADroppedDown, AIsSplit: Boolean)
  : IdxColorPalette;
var
  AElement: TdxSkinElement;
begin
  ...
  if AElement <> nil then
    Result := AElement.GetGlyphColorPalette(GetState(ASelected, ADowned,
      ADrawDowned, ADroppedDown, TdxBarItemControlAccess(ABarItemControl)
      .IsMenuItem))
  else
    Result := nil;
end;

function TdxBarSkinPainter.GetState(ASelected, ADowned, ADrawDowned,
  ADroppedDown, AIsMenuItem: Boolean): TdxSkinElementState;
const
  DownStates: array [Boolean] of TdxSkinElementState = (esHotCheck,
    esCheckPressed);
  DrawDownStates: array [Boolean] of TdxSkinElementState = (esHot, esPressed);
begin
  if not ASelected then
    Result := esChecked
  else if ADowned then
...
class procedure TdxBarSkinPainter.BarOffsetFloatingBarCaption
  (ABarControl: TdxBarControl; var X: Integer; var R: TRect);
begin
  if ABarControl.UseRightToLeftAlignment then
  begin
    Dec(X, 2);
    R.Left := TdxBarControlAccess(ABarControl).MarkNCRect.Right;
    // TdxBarXPPainter
  end
  else
  begin
    Inc(X, 2);
    R.Right := TdxBarControlAccess(ABarControl).MarkNCRect.Left;
    // TdxBarXPPainter
  end;
end;

procedure TdxBarSkinPainter.BarDrawGrip(ABarControl: TdxBarControl; DC: HDC;
...
begin
  ...
  try
    FSkinPainter.DrawSizeGrip(cxPaintCanvas, R, clNone,
      ACorner[ABarControl.UseRightToLeftAlignment]);
  finally
    cxPaintCanvas.EndPaint;
  end;
end;
...
begin
  DrawBarMarkState(ABarControl, DC, ItemRect, TdxBarControlAccess(ABarControl)
    .MarkState);
end;

procedure TdxBarSkinPainter.SubMenuControlDrawMarkSelection(ABarSubMenuControl
  : TdxBarSubMenuControl; ADC: HDC; const AMarkRect: TRect);
begin
  DrawSkinElement(PopupMenuLinkSelected, ADC, AMarkRect,
    dxGetScaleFactor(ABarSubMenuControl));
end;

function TdxBarSkinPainter.CreateHintViewInfo(ABarManager: TdxBarManager;
  AHintText: string; const AShortCut: string; AScreenTip: TdxScreenTip)
...
function TdxBarSkinPainter.GetBarCustomize(AIsVertical: Boolean)
  : TdxSkinElement;
var
  ASkinPainterInfo: TdxSkinInfo;
begin
...
function TdxBarSkinPainter.GetBarSeparator(AIsVertical: Boolean)
  : TdxSkinElement;
var
  ASkinPainterInfo: TdxSkinInfo;
begin
...
function TdxBarSkinPainter.GetMainMenuCustomize(AIsVertical: Boolean)
  : TdxSkinElement;
var
  ASkinPainterInfo: TdxSkinInfo;
begin
...
function TdxBarSkinPainter.GetMDIButton(AButton: TdxBarMDIButton)
  : TdxSkinElement;
var
  ASkinPainterInfo: TdxSkinInfo;
begin
...
procedure TdxBarSkinPainter.SetupCacheControl(AElement: TdxSkinElement;
  ACacheCapacity: Integer = 0);
begin
...
function TdxBarSkinPainter.DrawSkinElement(AElement: TdxSkinElement; DC: HDC;
  const ARect: TRect; AScaleFactor: TdxScaleFactor; AImageIndex: Integer = 0;
  AState: TdxSkinElementState = esNormal;
  AIsRightToLeft: Boolean = False): Boolean;
begin
  Result := AElement <> nil;
  if Result then
    AElement.RightToLeftDependentDraw(DC, ARect, AScaleFactor, AIsRightToLeft,
      Min(AImageIndex, AElement.ImageCount), AState);
end;
...
function TdxBarSkinPainter.DrawSkinElementContent(AElement: TdxSkinElement;
  DC: HDC; const ARect: TRect; AScaleFactor: TdxScaleFactor;
  AImageIndex: Integer = 0; AState: TdxSkinElementState = esNormal): Boolean;
begin
  Result := AElement <> nil;
  if Result then
  begin
...
function TdxBarSkinPainter.DrawSkinElementBorders(AElement: TdxSkinElement;
  DC: HDC; const ARect: TRect; AImageIndex: Integer = 0;
  AState: TdxSkinElementState = esNormal): Boolean;
begin
  cxPaintCanvas.BeginPaint(DC);
  try
    ...
    if Result then
    begin
      cxPaintCanvas.ExcludeClipRect(cxRectContent(ARect,
        AElement.ContentOffset.Rect));
      Result := DrawSkinElement(AElement, cxPaintCanvas.Handle, ARect,
        dxDefaultScaleFactor, AImageIndex, AState);
    end;
  finally
    cxPaintCanvas.EndPaint;
  end;
...
function TdxBarSkinPainter.GetSkinElementTextColor(ASkinElement: TdxSkinElement;
  AState: TcxButtonState): TColor;
begin
  Result := clDefault;
  if ASkinElement <> nil then
...
function TdxBarSkinPainter.GetSkinEditorsBackgroundColor
  (AState: TcxEditStateColorKind): TColor;
begin
...
function TdxBarSkinPainter.GetSkinEditorsTextColor
  (AState: TcxEditStateColorKind): TColor;
begin
  if Assigned(FSkinPainter) then
...
function TdxBarSkinPainter.GetSkinElementSize(ASkinElement: TdxSkinElement;
  AScaleFactor: TdxScaleFactor): TSize;
begin
  Result := cxNullSize;
  if ASkinElement <> nil then
...
function TdxBarSkinPainter.GetBarElement(ABarControl: TCustomdxBarControl;
  AVertical: Boolean): TdxSkinElement;
var
...
begin
  if ABarControl <> nil then
    Result := GetBarElement(ABarControl, TCustomdxBarControlAccess(ABarControl)
      .IsRealVertical)
  else
    Result := nil;
end;

function TdxBarSkinPainter.GetBarMarkElement(AMainMenu, AVertical: Boolean)
  : TdxSkinElement;
begin
  if AMainMenu then
...
function TdxBarSkinPainter.GetTextColorElement(ABarControl: TCustomdxBarControl)
  : TdxSkinElement;
begin
  Result := GetBarElement(ABarControl, False);
  if ((Result = Bar[ABarControl.IsRealVertical]) or
    (Result = MainMenu[ABarControl.IsRealVertical])) and
    (ABarControl is TdxBarControl) and
    (TdxBarControlAccess(ABarControl).Bar.BorderStyle = bbsNone) then
    Result := Dock;
end;

function TdxBarSkinPainter.IsBarElementSkinned(ABarControl
  : TCustomdxBarControl): Boolean;
begin
...
begin
  ...
  begin
    ...
    if cxRectWidth(ARect) < cxMarginsWidth(AElement.Image.Margins.Margin) then
      R.Left := ARect.Left + cxRectWidth(ARect) -
        cxMarginsWidth(AElement.Image.Margins.Margin);
    ACanvas.SaveClipRegion;
    try
      ACanvas.IntersectClipRect(ARect);
      DrawSkinElement(AElement, ACanvas.Handle, R, dxDefaultScaleFactor,
        0, AState);
    finally
      ACanvas.RestoreClipRegion;
    end;
...
procedure TdxBarSkinPainter.DrawFloatingBarCaptionButton(DC: HDC; ARect: TRect;
  AContentType: Integer; AState: TdxBarMarkState);
const
  MarkState2SkinState: array [TdxBarMarkState] of TdxSkinElementState =
    (esActive, esHot, esPressed);
begin
  DrawSkinElement(DockControlWindowButton, DC, ARect, dxDefaultScaleFactor, 0,
    MarkState2SkinState[AState]);
  DrawSkinElement(DockControlWindowButtonGlyph, DC, ARect, dxDefaultScaleFactor,
    AContentType);
end;
...
procedure TdxBarSkinPainter.InternalDrawDockedBarBackground
  ...
  function GetBarDragRect(ABarControlAccess: TdxBarControlAccess;
    const R: TRect): TRect;
  begin
    Result := R;
    if ABarControlAccess.Vertical then
      Result.Bottom := Result.Top + GripperSize(ABarControlAccess)
    else if ABarControlAccess.UseRightToLeftAlignment then
  ...
  var
    ANCMarkRect: TRect;
  begin
    ANCMarkRect := cxRectOffset(BarMarkItemRect(ABarControlAccess),
      ABarControlAccess.NCOffset);
  ...
  begin
    ...
    DrawSkinElementParentBackground(ACanvas.Handle, R, ABarControl, AElement);
    DrawSkinElement(AElement, ACanvas.Handle, R, dxDefaultScaleFactor, 0,
      esNormal, ABarControlAccess.UseRightToLeftAlignment);
  end;
  ...
  begin
    ...
    begin
      ...
      if ABarControlAccess.CanMoving then
        DrawBarDragElement(ABarControlAccess, ABitmap.cxCanvas,
...
begin
  ...
  cxBitBlt(DC, ABarControlAccess.BackgroundTempBitmap.Canvas.Handle, R,
    cxNullPoint, SRCCOPY);
end;

function TdxBarSkinPainter.ButtonLikeControlGetState(const ADrawParams
  : TdxBarButtonLikeControlDrawParams): TdxSkinElementState;
const
...
function TdxBarSkinPainter.ButtonLikeDrawArrowFadingElement(const ADrawParams
  : TdxBarButtonLikeControlDrawParams; var R: TRect): Boolean;
var
...
function TdxBarSkinPainter.ButtonLikeDrawFadingElement(ABarItemControl
  : TdxBarItemControl; DC: HDC; const R: TRect; AIsSplit: Boolean): Boolean;
var
  ABarItem: TdxBarItemControlAccess;
  AFadingElement: TdxFadingElement;
  R1: TRect;
...
procedure TdxBarSkinPainter.ButtonLikeDrawGlyphBorder(ABarItemControl
  : TdxBarItemControl; DC: HDC; ABrush: HBRUSH; NeedBorder: Boolean; R: TRect;
  PaintType: TdxBarPaintType; IsGlyphEmpty, Selected, Down, DrawDowned,
  ADroppedDown, IsSplit, AAllowFading: Boolean);
var
  AIsMenuItem: Boolean;
...
begin
  ...
  begin
    if not IsGlyphEmpty and Down then
      DrawSkinElement(PopupMenuCheck, DC, cxRectInflate(R, -2),
        dxGetScaleFactor(ABarItemControl), 1, esNormal);
  end
  else
  begin
    DrawBackground(ABarItemControl, DC, R, ABrush, False);
    if not(AAllowFading and ButtonLikeDrawFadingElement(ABarItemControl, DC, R,
      IsSplit)) then
    begin
      if Selected or Down then
      begin
        AIsMenuItem := TdxBarItemControlAccess(ABarItemControl).IsMenuItem;
        AState := GetState(Selected, Down, DrawDowned, ADroppedDown,
          AIsMenuItem);
        if AIsMenuItem then
          DrawSkinElement(MainMenuLinkSelected, DC, R,
            dxGetScaleFactor(ABarItemControl), 0, AState)
        else
          DrawSkinElement(LinkSelected, DC, R,
            dxGetScaleFactor(ABarItemControl), 0, AState,
            ABarItemControl.UseRightToLeftAlignment)
      end;
    end;
  end;
end;
