...
{$ENDIF}
  ...
  dxCore, dxCoreClasses, cxClasses, dxGDIPlusClasses, cxGraphics, cxGeometry,
  dxTouch, cxScrollBar,
  dxBar, cxAccessibility, dxBarAccessibility, dxRibbon, dxRibbonForm,
  cxControls,
...
type
  ...
  TdxRibbonGalleryGroupItemActionLinkClass = class of
  ...
  TdxRibbonGalleryGroupItemTextKind = (itkNone, itkCaption,
  ...
  TdxSelectionChangedEvent = procedure(Sender: TObject; DeselectAll: Boolean)
    of object;
  ...
  TdxRibbonGalleryItemPullHighlightingDirection = (gphdStartToFinish,
    gphdFinishToStart);
  TdxRibbonGalleryItemPullHighlightingMode = (iphmNone, iphmStartToFinish,
    iphmFinishToStart);
  ...
  protected
    ...
    property Parent: TdxRibbonGalleryItemPullHighlighting read FParent
      write FParent;
  public
  ...
  published
    ...
    property Direction: TdxRibbonGalleryItemPullHighlightingDirection
      read GetDirection write SetDirection stored IsDirectionStored;
  end;
  ...
  protected
    ...
    procedure SetItemImagePosition
      (Value: TdxRibbonGalleryImagePosition); virtual;
    procedure SetItemSize(Value: TcxItemSize); virtual;
    procedure SetItemTextAlignVert(Value: TcxAlignmentVert); virtual;
    procedure SetItemTextKind
      (Value: TdxRibbonGalleryGroupItemTextKind); virtual;
    ...
    property RemoveHorizontalItemPadding: Boolean
      read GetRemoveHorizontalItemPadding;
    property RemoveVerticalItemPadding: Boolean
      read GetRemoveVerticalItemPadding;
  ...
  public
    ...
    property ItemImagePosition: TdxRibbonGalleryImagePosition
      read GetItemImagePosition write SetItemImagePosition
      stored IsItemImagePositionStored;
    property ItemImageSize: TcxItemSize read FItemImageSize
      write SetItemImageSize stored IsItemImageSizeStored;
    property ItemTextAlignVert: TcxAlignmentVert read GetItemTextAlignVert
      write SetItemTextAlignVert stored False;
    property ItemTextKind: TdxRibbonGalleryGroupItemTextKind
      read GetItemTextKind write SetItemTextKind stored False;
    property ItemSize: TcxItemSize read GetItemSize write SetItemSize
      stored IsItemSizeStored;
    property ItemPullHighlighting: TdxRibbonGalleryItemPullHighlighting
      read FItemPullHighlighting write SetItemPullHighlighting stored False;
    property PopupMenu: TdxBarCustomPopupMenu read GetPopupMenu
      write SetPopupMenu stored IsPopupMenuStored;
    property SpaceAfterGroupHeader: Integer read GetSpaceAfterGroupHeader
      write SetSpaceAfterGroupHeader stored IsSpaceAfterGroupHeaderStored;
    property SpaceBetweenItemCaptionAndDescription: Integer
      read GetSpaceBetweenItemCaptionAndDescription
      write SetSpaceBetweenItemCaptionAndDescription
      stored IsSpaceBetweenItemCaptionAndDescriptionStored;
    property SpaceBetweenItemImageAndText: Integer
      read GetSpaceBetweenItemImageAndText write SetSpaceBetweenItemImageAndText
      stored IsSpaceBetweenItemImageAndTextStored;
    property SpaceBetweenItems: Integer read GetSpaceBetweenItems
      write SetSpaceBetweenItems;
    property SpaceBetweenItemsHorizontally: Integer
      read GetSpaceBetweenItemsHorizontally
      write SetSpaceBetweenItemsHorizontally
      stored IsSpaceBetweenItemsHorizontallyStored;
    property SpaceBetweenItemsVertically: Integer
      read GetSpaceBetweenItemsVertically write SetSpaceBetweenItemsVertically
      stored IsSpaceBetweenItemsVerticallyStored;
  end;

  { TdxRibbonGalleryGroupOptions }

  TdxRibbonGalleryGroupOptionsAssignedValue = (avItemImagePosition,
    avItemImageSize, avItemPullHighlighting, avItemPullHighlightingMode,
    avItemSize, avItemTextAlignVert, avItemTextKind, avPopupMenu,
    avSpaceAfterGroupHeader, avSpaceBetweenItemCaptionAndDescription,
    avSpaceBetweenItemImageAndText, avSpaceBetweenItems,
    avSpaceBetweenItemsHorizontally, avSpaceBetweenItemsVertically);
  TdxRibbonGalleryGroupOptionsAssignedValues = set of
  ...
  strict private
    ...
    function GetItemPullHighlightingMode
      : TdxRibbonGalleryItemPullHighlightingMode;
    ...
    procedure SetAssignedValues(const Value
      : TdxRibbonGalleryGroupOptionsAssignedValues);
    procedure SetItemPullHighlightingMode
      (Value: TdxRibbonGalleryItemPullHighlightingMode);
  protected
  ...
  public
    constructor Create(AParentOptions: TdxRibbonGalleryBaseOptions;
      AGroup: TdxRibbonGalleryGroup); overload; virtual;
    destructor Destroy; override;
    procedure Assign(Source: TPersistent); override;
  published
    ...
    property ItemPullHighlightingMode: TdxRibbonGalleryItemPullHighlightingMode
      read GetItemPullHighlightingMode write SetItemPullHighlightingMode
      stored IsItemPullHighlightingModeStored;
    property PopupMenu;
  ...
  protected
    ...
    property ShowItemHint: Boolean read GetShowItemHint write SetShowItemHint;
    // deprecated
    ...
    property ItemHintSource: TdxRibbonGalleryItemHintSource read FItemHintSource
      write SetItemHintSource default ghsItemHint;
    ...
    property ItemSizeInRibbon: TcxItemSize read GetItemSizeInRibbon
      write SetItemSizeInRibbon stored False;
    property LongDescriptionDefaultRowCount: Integer
      read FLongDescriptionDefaultRowCount
      write SetLongDescriptionDefaultRowCount;
    property SpaceBetweenGroups: Integer read FSpaceBetweenGroups
      write SetSpaceBetweenGroups default 0;
    property SpaceBetweenItemsAndBorder: Integer
      read FSpaceBetweenItemsAndBorder write SetSpaceBetweenItemsAndBorder
      default 1;
    property SubmenuResizing: TdxRibbonGallerySubmenuResizing
      read GetSubmenuResizing write SetSubmenuResizing stored False;

    property ColumnCount: Integer read FColumnCount write SetColumnCount
      default dxRibbonGalleryDefaultColumnCount;
    property MinColumnCount: Integer read GetMinColumnCount
      write SetMinColumnCount stored False;
    property RowCount: Integer read GetRowCount write SetRowCount stored False;

    property OnSelectionChanged: TdxSelectionChangedEvent
      read FOnSelectionChanged write FOnSelectionChanged;
    property OnColumnCountChanged: TNotifyEvent read FOnColumnCountChanged
      write FOnColumnCountChanged;
  public
  ...
  protected
    ...
    property OnChanged: TNotifyEvent read FOnChanged write FOnChanged;
    property OnMinColumnCountChanged: TNotifyEvent read FOnMinColumnCountChanged
      write FOnMinColumnCountChanged;
  public
    constructor Create;
    destructor Destroy; override;
    procedure Assign(Source: TPersistent); override;
  ...
  public
    ...
    procedure Assign(Source: TPersistent); override;
  published
    property CollapsedInSubmenu: Boolean read FCollapsedInSubmenu
      write SetCollapsedInSubmenu default True;
    property DropDownGalleryResizing: TdxRibbonGalleryDropDownResizing
      read FDropDownGalleryResizing write FDropDownGalleryResizing
      default gsrWidthAndHeight;
    property EqualItemSizeInAllGroups: Boolean read FEqualItemSizeInAllGroups
      write SetEqualItemSizeInAllGroups default True;
    property ItemPullHighlightingMode: TdxRibbonGalleryItemPullHighlightingMode
      read FItemPullHighlightingMode write SetItemPullHighlightingMode
      default iphmNone;
    property ItemSize: TcxItemSize read FItemSize write SetItemSize
      stored IsItemSizeStored;
    property ItemTextAlignVert: TcxAlignmentVert read FItemTextAlignVert
      write SetItemTextAlignVert default vaTop;
    property ItemTextKind: TdxRibbonGalleryGroupItemTextKind read FItemTextKind
      write SetItemTextKind default itkCaption;
  ...
  protected
    ...
    function GetActionLinkClass
      : TdxRibbonGalleryGroupItemActionLinkClass; dynamic;
    ...
    property GlyphInDropDown: TdxSmartGlyph read FGlyphInDropDown
      write SetGlyphInDropDown;
    property LoadedSelected: Boolean read FSelected write FSelected;
    property SelectionMode: TdxRibbonGalleryItemSelectionMode
      read GetSelectionMode;
  public
  ...
  public
    ...
    property Items[Index: Integer]: TdxRibbonGalleryGroupItem read GetItem
  ...
  published
    ...
    property Options: TdxRibbonGalleryGroupOptions read FOptions
      write SetOptions;
  ...
  public
    ...
    property Items[Index: Integer]: TdxRibbonGalleryGroup read GetItem
      write SetItem; default;
  end;
  ...
  public
    ...
    property FilterCategory: TdxRibbonGalleryFilterCategory
      read FFilterCategory;
  ...
  published
    ...
    property Groups: TdxRibbonGalleryFilterCategoryGroups read FGroups
      stored False;
  end;
  ...
  protected
    ...
    property CustomRibbonGalleryItem: TdxCustomRibbonGalleryItem
      read GetCustomRibbonGalleryItem;
  public
  ...
  TdxRibbonGalleryItemBarItemLinkPositionInDropDown = (ilpAfterGallery,
    ilpBeforeGallery);
  ...
  strict private
    ...
    procedure SetPositionInDropDown(const AValue
      : TdxRibbonGalleryItemBarItemLinkPositionInDropDown);

    function IsNotFirstVisible: Boolean;
    procedure PositionInDropDownCustomizationPopupItemClickHandler
      (Sender: TObject);
  protected
    ...
    procedure LoadFromIni(ASource: TCustomIniFile; const ABaseSection: string;
      ALinkIndex: Integer; AStoringKind: TdxBarStoringKind); override;
    procedure SaveToIni(ADestination: TCustomIniFile;
      const ABaseSection: string; ALinkIndex: Integer;
      AStoringKind: TdxBarStoringKind); override;

    procedure DoCalculateDragLineParameters(const ADragOverBeginGroup: Boolean;
      var ADragLineFirstPart: Boolean; out ADragLineRect: TRect); override;
    function GetNeedDragLine(const ADragOverBeginGroup, ADragOverFirstPart
      : Boolean; ADragOverItemLink: TdxBarItemLink): Boolean; override;
    procedure PopulateCustomizationPopup(AItemLinks: TdxBarItemLinks;
      ASupportedActions: TdxBarCustomizationActions); override;
    procedure UpdateByDragParameters(const ADragOverBeginGroup,
      ADragOverFirstPart: Boolean; ADragOverItemLink: TdxBarItemLink); override;
  public
    constructor Create(Collection: TCollection); override;
    procedure Assign(Source: TPersistent); override;
  published
    property PositionInDropDown
      : TdxRibbonGalleryItemBarItemLinkPositionInDropDown
      read FPositionInDropDown write SetPositionInDropDown
      default ilpAfterGallery;
  end;
  ...
  TdxRibbonGalleryHotTrackedItemChangedEvent = procedure
    (APrevHotTrackedGroupItem, ANewHotTrackedGroupItem
    : TdxRibbonGalleryGroupItem) of object;
  TdxRibbonGalleryShowPopupMenuEvent = procedure(Sender: TObject;
    var APopupMenu: TdxBarCustomPopupMenu; var APopupPoint: TPoint;
    AHotGroupItem: TdxRibbonGalleryGroupItem) of object;
  ...
  protected
    ...
    function GetGalleryOptionsClass
      : TCustomdxRibbonGalleryOptionsClass; virtual;
    ...
    property RecalculatingOnFilterChanged: Boolean
      read FRecalculatingOnFilterChanged;

    property ActionLink: TdxCustomRibbonGalleryItemActionLink
      read GetActionLink;
    property DropDownGallery: TdxRibbonDropDownGallery read FDropDownGallery
      write SetDropDownGallery;
    property GalleryCategories: TdxRibbonGalleryGroups read FGalleryGroups
      write SetGalleryGroups;
    property GalleryFilter: TdxRibbonGalleryFilter read FGalleryFilter
      write SetGalleryFilter;
    property GalleryInRibbonOptions: TdxInRibbonGalleryOptions
      read FGalleryInRibbonOptions write SetGalleryInRibbonOptions;
    property GalleryInMenuOptions: TdxInMenuGalleryOptions
      read FGalleryInMenuOptions write SetGalleryInMenuOptions;
    property GalleryOptions: TdxCustomRibbonGalleryOptions read FGalleryOptions
      write SetGalleryOptions;
    property OnHotTrackedItemChanged: TdxRibbonGalleryHotTrackedItemChangedEvent
      read FOnHotTrackedItemChanged write FOnHotTrackedItemChanged;
    property OnShowPopupMenu: TdxRibbonGalleryShowPopupMenuEvent
      read FOnShowPopupMenu write FOnShowPopupMenu;
  public
    constructor Create(AOwner: TComponent); override;
    destructor Destroy; override;
    procedure Assign(Source: TPersistent); override;
    function CopyGroupItem(AGroupItem: TdxRibbonGalleryGroupItem;
      ATargetGroup: TdxRibbonGalleryGroup; AIndex: Integer)
      : TdxRibbonGalleryGroupItem;
    ...
    property GalleryGroups: TdxRibbonGalleryGroups read FGalleryGroups
      write SetGalleryGroups;
  ...
  TdxRibbonGalleryFilterChangedEvent = procedure(Sender: TdxRibbonGalleryItem)
    of object;
  ...
  protected
    ...
    function GetGalleryOptionsClass
      : TCustomdxRibbonGalleryOptionsClass; override;
  ...
  protected
    ...
    function CheckEnabled(AGroupItem: TdxRibbonGalleryGroupItem)
      : TdxRibbonGalleryGroupItem;
    function GetGroupItem(AGroupIndex, AIndex: Integer)
      : TdxRibbonGalleryGroupItem;
    ...
    property GroupItemHotTrackEnabled: Boolean read FGroupItemHotTrackEnabled
  ...
  strict private
    ...
    procedure CustomPopupMenuCloseUpHandler(Sender: TObject;
  ...
  protected
    ...
    function DoHint(var ANeedDeactivate: Boolean; out AHintText: string;
      out AShortCut: string): Boolean; override;
    function GetHintText(AGroupItem: TdxRibbonGalleryGroupItem): string;
    function GetHintPosition(const ACursorPos: TPoint; AHeight: Integer)
      : TPoint; override;
    ...
    function CreateHintViewInfo(const AHintText, AShortCut: string)
      : TdxBarCustomHintViewInfo; override;
    ...
    procedure DoScrollBarScroll(Sender: TObject; ScrollCode: TScrollCode;
  ...
  TdxRibbonGalleryGroupHeaderViewInfo = class
    (TdxRibbonGalleryGroupElementViewInfo)
  strict private
    FTextBounds: TRect;
  ...
  protected
    ...
    function GetHeight(AWidth: Integer; AWithSpaceAfterHeader: Boolean)
      : Integer;
  ...
  private
    ...
    function ItemWidthWithoutImage(var ADescriptionRect: TRect;
  ...
  protected
    ...
    function GetDescriptionHeight(var ADescriptionRect: TRect)
      : Integer; virtual;
    function GetDescriptionWidth(var ADescriptionRect: TRect;
      AMaxWidth: Integer): Integer; virtual;
    ...
    procedure CheckTextVerticalAlignment(AVerticalAlignment
      : TcxAlignmentVert); virtual;
  ...
  TdxRibbonGalleryGroupRepaintPart = (ggrpAll, ggrpBefore, ggrpAfter,
    ggrpBetween);
  ...
  protected
    ...
    function GetColumnCountInRow(ARow: Integer; AGroupWidth: Integer)
      : Integer; virtual;
    function GetColumnLeft(AColumnIndex: Integer; AGroupLeft: Integer)
      : Integer; virtual;
    ...
    function GetItemIndex(ARow, AColumn: Integer; AGroupWidth: Integer)
      : Integer;
    function GetItemRow(AGroupItemIndex: Integer; AGroupWidth: Integer)
      : Integer;
    ...
    function GetRowTop(ARowIndex: Integer; AGroupTop: Integer;
      AGroupWidth: Integer): Integer; virtual;
  ...
  public
    ...
    destructor Destroy; override;
    procedure Calculate(AGroupTop, AGroupBottom: Integer;
      const AControlClientRect: TRect);
    ...
    property Items[Index: Integer]: TdxRibbonGalleryGroupItemViewInfo
      read GetItem; // for internal use
  ...
  private
    ...
    procedure RepaintChainOfGroups(ANewItem,
      AOldItem: TdxRibbonGalleryGroupItem);
  protected
    ...
    procedure DrawBackground(ACanvas: TcxCanvas; const R: TRect);
      virtual; abstract;
    procedure DrawSelectedGroupItem(ASelectedGroupItem, AOldSelectedGroupItem
      : TdxRibbonGalleryGroupItem);
    procedure GalleryChanged;
    function GetAbsoluteGroupTop(AGroupIndex: Integer; AWidth: Integer)
      : Integer;
    ...
    function GetLayoutWidth(AColumnCount: Integer;
      out AGroupItemWidthIsNull: Boolean): Integer; virtual; abstract;
    ...
    function GetGroupItemViewInfo(AGroupItem: TdxRibbonGalleryGroupItem)
      : TdxRibbonGalleryGroupItemViewInfo;
    ...
    function GetVisibleGroupIndex(AStartGroupIndex: Integer;
      AIncreaseIndex: Boolean): Integer;
    function GetVisibleNotEmptyGroupIndex(AStartGroupIndex: Integer;
      AIncreaseIndex: Boolean): Integer;
    ...
    property DontDisplayGroupHeaderWhenHotTrackingGroupItem: Integer
      read FDontDisplayGroupHeaderWhenHotTrackingGroupItem
      write FDontDisplayGroupHeaderWhenHotTrackingGroupItem;
    property DontDisplayHotTrackedGroupItem: Integer
      read FDontDisplayHotTrackedGroupItem
      write FDontDisplayHotTrackedGroupItem;
    ...
    property GalleryInMenuOptions: TdxInMenuGalleryOptions
      read GetGalleryInMenuOptions;
    property GalleryItem: TdxCustomRibbonGalleryItem read GetGalleryItem;
    property GalleryOptions: TdxCustomRibbonGalleryOptions
      read GetGalleryOptions;
    property GallerySize: TSize read GetGallerySize;
    property GlobalItemSize: TSize read FGlobalItemSize;
    property HotGroupItem: TdxRibbonGalleryGroupItem read FHotGroupItem
      write SetHotGroupItem;
  ...
  public
    ...
    destructor Destroy; override;
    procedure Calculate(ALayoutOffset: Integer;
      AScrollCode: TScrollCode); virtual;
    function IsCollapsed: Boolean; virtual; abstract;
    procedure Paint(ACanvas: TcxCanvas); virtual;
    property Control: TdxRibbonGalleryControl read GetControl;
    property GroupCount: Integer read GetGroupCount;
    property Groups[Index: Integer]: TdxRibbonGalleryGroupViewInfo
      read GetGroup; // for internal use
  ...
  private
    ...
    procedure PopulateGroupItemList(AFirstVisibleRow, ALastVisibleRow,
      AColumnCount: Integer; AList: TObjectList);
  ...
  protected
    ...
    procedure CalculateLayout(ALayoutOffset, AColumnCount: Integer;
    ...
    function GetLayoutWidth(AColumnCount: Integer;
      out AGroupItemWidthIsNull: Boolean): Integer; override;
  ...
  public
    constructor Create(AControl: TdxBarItemControl); override;
    procedure Calculate(ALayoutOffset: Integer;
      AScrollCode: TScrollCode); override;
  ...
  strict private
    ...
    function GetSpaceBetweenItems(AGroupIndex: Integer;
      AIsFlat: Boolean): Integer;
    procedure InitializeGroupItemDescriptionRectCache;
    function NeedsDrawSeparator(const APositionInDropDown
      : TdxRibbonGalleryItemBarItemLinkPositionInDropDown): Boolean;
  protected
    ...
    function GetGalleryMargins: TRect; override;
    function GetGroupItemDescriptionRect(AGroupIndex,
      AnItemIndex: Integer): TRect;
    ...
    function InternalGetScrollBarWidth: Integer; override;
    procedure Changed; override;
    procedure SetGroupItemDescriptionRect(AGroupIndex, AnItemIndex: Integer;
      ARect: TRect);
  public
    destructor Destroy; override;
    procedure Calculate(ALayoutOffset: Integer;
  ...
  TdxRibbonGalleryControlAccessibilityHelper = class
  ...
  protected
    ...
    procedure OnSubmenuHotTrack(ANavigationDirection
      : TdxRibbonDropDownGalleryNavigationDirection);
  ...
  TdxRibbonDropDownGalleryControlAccessibilityHelper = class
    (TdxBarSubMenuControlAccessibilityHelper)
  private
    function GetBarControl: TdxRibbonDropDownGalleryControl;
    function GetInternalGalleryItemControlAccessibilityHelper
      : TdxRibbonGalleryControlAccessibilityHelper;
  protected
    // IdxBarAccessibilityHelper
    function HandleNavigationKey(var AKey: Word): Boolean; override;
    ...
    procedure HandleVertNavigationKey(AUpKey, AFocusItemControl
      : Boolean); override;
    property BarControl: TdxRibbonDropDownGalleryControl read GetBarControl;
    property InternalGalleryItemControlAccessibilityHelper
      : TdxRibbonGalleryControlAccessibilityHelper
  ...
  protected
    ...
    function GetRibbonSkin: IdxSkin;
    function IsButtonEnabled(AButtonKind
      : TdxInRibbonGalleryScrollBarButtonKind): Boolean;
    ...
    property IsDropDownButtonPressed: Boolean read FIsDropDownButtonPressed
      write FIsDropDownButtonPressed;
  public
  ...
  TdxRibbonDropDownGalleryGalleryItemBarItemLinks = class
    (TdxBarSubMenuControlItemLinks)
  public
    function CanContainItem(AItem: TdxBarItem; out AErrorText: string)
      : Boolean; override;
  end;
  ...
  protected
    function HasSizingBand(AGalleryControl
      : TdxRibbonDropDownGalleryControl): Boolean;
  public
    constructor Create(APainter: TdxBarPainter); virtual;

    function GetSizingBandHeight(AGalleryControl
      : TdxRibbonDropDownGalleryControl): Integer; virtual;
  ...
  TdxRibbonDropDownGalleryControl = class(TdxRibbonPopupMenuControl,
    IdxGestureClient, IdxGestureOwner)
  private
    FGalleryItem: TdxCustomRibbonGalleryItem;
  ...
  protected
    ...
    function DoFindLinkWithAccel(AKey: Word; AShift: TShiftState;
      ACurrentLink: TdxBarItemLink): TdxBarItemLink; override;
    function GetAccessibilityHelperClass
      : TdxBarAccessibilityHelperClass; override;
    function GetClientOffset(AIncludeDetachCaption: Boolean = True)
      : TRect; override;
    ...
    function IsControlExists(ABarItemControl: TdxBarItemControl)
      : Boolean; override;
    ...
    property InternalGalleryItemLink: TdxBarItemLink
      read GetInternalGalleryItemLink;
...
uses
  Types, Math, Variants, cxContainer, dxBarSkinConsts, dxBarStrs, dxOffice11,
  cxLookAndFeels, dxCoreGraphics;
...
function cxDrawTextOpaque(ACanvas: TcxCanvas; const AText: string;
...
begin
  ...
  try
    ...
    Result := cxDrawText(ABitmap.cxCanvas, AText, ABitmap.ClientRect, AFormat,
      ATextColor);
...
begin
  Result := (IsPointOnLine(ABegin1, AEnd1, ABegin2)) or
    ...
    (IsPointOnLine(ABegin2, AEnd2, AEnd1)) or (ABegin1 = ABegin2) and
    (AEnd1 = AEnd2) or (ABegin1 = AEnd2) and (AEnd1 = ABegin2);
end;

function GetGroupViewInfo(AGalleryGroups: TdxRibbonGalleryGroups;
  AGalleryControlViewInfo: TdxRibbonGalleryControlViewInfo;
  AGroupIndex: Integer; out DestroyAfterUse: Boolean)
  : TdxRibbonGalleryGroupViewInfo;
var
  I: Integer;
begin
...
function GetOuterGroupItem(AItem1, AItem2: TdxRibbonGalleryGroupItem;
  ...
  begin
    ...
    begin
      if AItem1.Group.Index > AItem2.Group.Index then
        Result := AItem1
      else if AItem1.Group.Index < AItem2.Group.Index then
        Result := AItem2
      else
      begin
...
function GetItemPullHighlightingIdentifier(AGroupItem
  : TdxRibbonGalleryGroupItem): Integer;
var
  AGroup: TdxRibbonGalleryGroup;
begin
  AGroup := AGroupItem.Group;
  if AGroup.Options.ItemPullHighlightingMode = AGroup.GalleryItem.
    GalleryInMenuOptions.ItemPullHighlightingMode then
    Result := -1
  else
    Result := AGroup.Index;
end;
...
begin
  if (ShortLineBegin < LongLineBegin) then
    Result := rllBefore
  else if (LongLineEnd < ShortLineEnd) then
    Result := rllAfter
  else
    Result := rllInside;
end;
...
begin
  Result := ((Parent = nil) or IsAssigned) and
...
function TdxRibbonGalleryItemPullHighlighting.GetDirection
...
constructor TdxRibbonGalleryBaseOptions.Create
  (AOwner: TdxCustomRibbonGalleryItem);
begin
  inherited Create;
  FGalleryItem := AOwner;
...
begin
  ...
  begin
    ...
    SpaceAfterGroupHeader := TdxRibbonGalleryBaseOptions(Source)
      .SpaceAfterGroupHeader;
    SpaceBetweenItemsHorizontally := TdxRibbonGalleryBaseOptions(Source)
      .SpaceBetweenItemsHorizontally;
    SpaceBetweenItemsVertically := TdxRibbonGalleryBaseOptions(Source)
      .SpaceBetweenItemsVertically;
    SpaceBetweenItemCaptionAndDescription := TdxRibbonGalleryBaseOptions(Source)
      .SpaceBetweenItemCaptionAndDescription;
    SpaceBetweenItemImageAndText := TdxRibbonGalleryBaseOptions(Source)
...
function TdxRibbonGalleryBaseOptions.ObtainItemPullHighlightingMode
  : TdxRibbonGalleryItemPullHighlightingMode;
begin
  if not ItemPullHighlighting.Active then
    Result := iphmNone
  else if ItemPullHighlighting.Direction = gphdStartToFinish then
...
begin
  ...
  if IsSpaceBetweenItemCaptionAndDescriptionStored then
    SpaceBetweenItemCaptionAndDescription :=
      MulDiv(SpaceBetweenItemCaptionAndDescription, M, D);
  ...
  if IsSpaceBetweenItemsHorizontallyStored then
    SpaceBetweenItemsHorizontally :=
      MulDiv(SpaceBetweenItemsHorizontally, M, D);
...
procedure TdxRibbonGalleryBaseOptions.FreeNotificationHandler
  (ASender: TComponent);
begin
...
function TdxRibbonGalleryBaseOptions.
  GetSpaceBetweenItemCaptionAndDescription: Integer;
begin
...
function TdxRibbonGalleryBaseOptions.GetItemImagePosition
...
function TdxRibbonGalleryBaseOptions.GetItemTextKind
...
function TdxRibbonGalleryBaseOptions.
  IsSpaceBetweenItemCaptionAndDescriptionStored: Boolean;
begin
  Result := FSpaceBetweenItemCaptionAndDescription <> 0;
end;

function TdxRibbonGalleryBaseOptions.
  IsSpaceBetweenItemImageAndTextStored: Boolean;
begin
  Result := FSpaceBetweenItemImageAndText <> 0;
end;

function TdxRibbonGalleryBaseOptions.
  IsSpaceBetweenItemsHorizontallyStored: Boolean;
begin
  Result := FSpaceBetweenItemsHorizontally <> 0;
end;

function TdxRibbonGalleryBaseOptions.
  IsSpaceBetweenItemsVerticallyStored: Boolean;
begin
...
procedure TdxRibbonGalleryBaseOptions.ItemPullHighlightingChange
  (Sender: TObject);
begin
...
procedure TdxRibbonGalleryBaseOptions.SetItemTextAlignVert
  (Value: TcxAlignmentVert);
begin
  FGalleryItem.GalleryInMenuOptions.ItemTextAlignVert := Value;
end;

procedure TdxRibbonGalleryBaseOptions.SetItemTextKind
  (Value: TdxRibbonGalleryGroupItemTextKind);
begin
  FGalleryItem.GalleryInMenuOptions.ItemTextKind := Value;
end;

procedure TdxRibbonGalleryBaseOptions.SetPopupMenu
  (Value: TdxBarCustomPopupMenu);
begin
...
procedure TdxRibbonGalleryBaseOptions.SetSpaceAfterGroupHeader(Value: Integer);
begin
  CheckIntRange(Value);
...
procedure TdxRibbonGalleryBaseOptions.SetSpaceBetweenItems(Value: Integer);
begin
...
function TdxRibbonGalleryBaseOptions.GetInRibbonOptions
  : TdxInRibbonGalleryOptions;
begin
...
constructor TdxRibbonGalleryGroupOptions.Create(AParentOptions
  : TdxRibbonGalleryBaseOptions; AGroup: TdxRibbonGalleryGroup);
begin
...
begin
  ...
  begin
    ItemPullHighlightingMode := TdxRibbonGalleryGroupOptions(Source)
      .ItemPullHighlightingMode;
...
function TdxRibbonGalleryGroupOptions.GetItemImagePosition
  : TdxRibbonGalleryImagePosition;
begin
...
function TdxRibbonGalleryGroupOptions.GetItemTextKind
  : TdxRibbonGalleryGroupItemTextKind;
begin
...
function TdxRibbonGalleryGroupOptions.
  GetSpaceBetweenItemCaptionAndDescription: Integer;
begin
  if IsSpaceBetweenItemCaptionAndDescriptionStored then
...
procedure TdxRibbonGalleryGroupOptions.ItemPullHighlightingChange
  (Sender: TObject);
begin
...
procedure TdxRibbonGalleryGroupOptions.SetItemPullHighlightingMode
  (Value: TdxRibbonGalleryItemPullHighlightingMode);
begin
...
procedure TdxRibbonGalleryGroupOptions.SetItemTextAlignVert
  (Value: TcxAlignmentVert);
begin
...
procedure TdxRibbonGalleryGroupOptions.SetPopupMenu
  (Value: TdxBarCustomPopupMenu);
begin
...
procedure TdxRibbonGalleryGroupOptions.SetSpaceBetweenItemsHorizontally
  (Value: Integer);
begin
...
procedure TdxRibbonGalleryGroupOptions.SetSpaceBetweenItemsVertically
  (Value: Integer);
begin
...
function TdxRibbonGalleryGroupOptions.GetItemPullHighlightingMode
  : TdxRibbonGalleryItemPullHighlightingMode;
begin
...
constructor TdxCustomRibbonGalleryOptions.Create
  (AOwner: TdxCustomRibbonGalleryItem);
begin
...
begin
  ...
  begin
    ...
    EqualItemSizeInAllGroups := TdxCustomRibbonGalleryOptions(Source)
      .EqualItemSizeInAllGroups;
    ItemAllowDeselect := TdxCustomRibbonGalleryOptions(Source)
      .ItemAllowDeselect;
    ItemHintSource := TdxCustomRibbonGalleryOptions(Source).ItemHintSource;
    ItemSelectionMode := TdxCustomRibbonGalleryOptions(Source)
      .ItemSelectionMode;
    ItemSizeInRibbon := TdxCustomRibbonGalleryOptions(Source).ItemSizeInRibbon;
    LongDescriptionDefaultRowCount := TdxCustomRibbonGalleryOptions(Source)
      .LongDescriptionDefaultRowCount;
    ...
    SpaceBetweenGroups := TdxCustomRibbonGalleryOptions(Source)
      .SpaceBetweenGroups;
    SpaceBetweenItemsAndBorder := TdxCustomRibbonGalleryOptions(Source)
...
begin
  inherited DefineProperties(Filer);
  Filer.DefineProperty('LongDescriptionDefaultRowCount',
    ReadLongDescriptionDefaultRowCount, WriteLongDescriptionDefaultRowCount,
    LongDescriptionDefaultRowCount <> 2);
end;
...
procedure TdxCustomRibbonGalleryOptions.DoSelectionChanged
  (DeselectAll: Boolean);
begin
...
function TdxCustomRibbonGalleryOptions.GetSubmenuResizing
...
procedure TdxCustomRibbonGalleryOptions.SetEqualItemSizeInAllGroups
  (Value: Boolean);
begin
  InMenuOptions.EqualItemSizeInAllGroups := Value;
end;

procedure TdxCustomRibbonGalleryOptions.SetItemHintSource
  (Value: TdxRibbonGalleryItemHintSource);
begin
...
begin
  ...
  begin
    DoSelectionChanged((FItemSelectionMode <> gsmSingle) and
      (Value in [gsmSingle, gsmSingleInGroup]));
...
procedure TdxCustomRibbonGalleryOptions.SetLongDescriptionDefaultRowCount
  (Value: Integer);
begin
...
const
  ItemHintSourceMap: array [Boolean] of TdxRibbonGalleryItemHintSource =
    (ghsGalleryScreenTip, ghsItemHint);
begin
...
procedure TdxCustomRibbonGalleryOptions.SetSubmenuResizing
  (Value: TdxRibbonGallerySubmenuResizing);
begin
  InMenuOptions.DropDownGalleryResizing := Value;
end;

procedure TdxCustomRibbonGalleryOptions.ReadLongDescriptionDefaultRowCount
  (Reader: TReader);
begin
  LongDescriptionDefaultRowCount := Reader.ReadInteger;
end;

procedure TdxCustomRibbonGalleryOptions.WriteLongDescriptionDefaultRowCount
  (Writer: TWriter);
begin
...
begin
  ...
  begin
    AlwaysShowItemCaption := TdxInRibbonGalleryOptions(Source)
      .AlwaysShowItemCaption;
...
begin
  ...
  begin
    ...
    EqualItemSizeInAllGroups := TdxInMenuGalleryOptions(Source)
      .EqualItemSizeInAllGroups;
    DropDownGalleryResizing := TdxInMenuGalleryOptions(Source)
      .DropDownGalleryResizing;
    ItemPullHighlightingMode := TdxInMenuGalleryOptions(Source)
      .ItemPullHighlightingMode;
...
procedure TdxInMenuGalleryOptions.SetItemPullHighlightingMode
  (Value: TdxRibbonGalleryItemPullHighlightingMode);
begin
  if Value <> FItemPullHighlightingMode then
  begin
...
procedure TdxInMenuGalleryOptions.SetItemTextKind
  (Value: TdxRibbonGalleryGroupItemTextKind);
begin
  if FItemTextKind <> Value then
  begin
...
begin
  if GalleryItem.AreGroupItemClickEventsLocked then
    Exit;
  if Assigned(FOnClick) and ((Action = nil) or (@FOnClick <> @Action.OnExecute))
  then
    FOnClick(Self)
  else if not IsDesigning and (FActionLink <> nil) then
    FActionLink.Execute(GalleryItem);
end;

function TdxRibbonGalleryGroupItem.GetActionLinkClass
  : TdxRibbonGalleryGroupItemActionLinkClass;
begin
  Result := TdxRibbonGalleryGroupItemActionLink;
end;

function TdxRibbonGalleryGroupItem.GetCollectionFromParent(AParent: TComponent)
...
procedure TdxRibbonGalleryGroupItem.MouseMove(Shift: TShiftState;
  X, Y: Integer);
begin
...
function TdxRibbonGalleryGroupItem.GetSelectionMode
  : TdxRibbonGalleryItemSelectionMode;
begin
  ...
  if Action <> Value then
    ...
    begin
      ...
      try
        ...
        if csLoading in Value.ComponentState then
          TdxBarManagerAccess(GalleryItem.BarManager)
            .LockDesignerModified(False, False);
      end;
    end;
end;
...
function TdxRibbonGalleryGroupItems.Insert(Index: Integer)
  : TdxRibbonGalleryGroupItem;
begin
...
procedure TdxRibbonGalleryGroupItems.SetItemName
  (AItem: TcxComponentCollectionItem; ABaseIndex: Integer = -1);
begin
  AItem.Name := CreateUniqueName(nil, Group, AItem, 'TdxRibbonGalleryGroup',
    '', Count);
end;
...
function TdxRibbonGalleryGroupItems.GetItem(Index: Integer)
  : TdxRibbonGalleryGroupItem;
begin
...
begin
  ...
  CreateItems;
  FOptions := TdxRibbonGalleryGroupOptions.Create
    (GalleryItem.GalleryOptions, Self);
...
function TdxRibbonGalleryGroup.GetCollectionFromParent(AParent: TComponent)
  : TcxComponentCollection;
begin
...
procedure TdxRibbonGalleryGroup.GetChildren(Proc: TGetChildProc;
  Root: TComponent);
var
  I: Integer;
begin
...
function TdxRibbonGalleryGroup.GetGalleryGroupHeaderClass
  : TdxGalleryGroupHeaderClass;
begin
...
begin
  ...
  if (AAction = ccnExtracting) and
    not(csDestroying in GalleryItem.ComponentState) then
...
begin
  AItem.Name := CreateUniqueName(nil, GalleryItem, AItem, 'TdxRibbonGallery',
    '', Count);
end;
...
procedure TdxRibbonGalleryGroups.RemoveFromFilter
  (AItem: TcxComponentCollectionItem);
begin
  if AItem <> nil then
    GalleryItem.GalleryFilter.Categories.DeleteGroup
      (TdxRibbonGalleryGroup(AItem));
end;
...
constructor TdxRibbonGalleryFilterCategoryGroups.Create(AFilterCategory
  : TdxRibbonGalleryFilterCategory);
begin
  inherited Create;
...
begin
  if FilterCategory.GalleryItem.GalleryGroups.Count <>
    ...
    raise EdxException.Create
      ('Invalid GalleryGroups count in given instance of TdxRibbonGalleryFilterCategoryGroups');
  Clear;
  for I := 0 to ASource.Count - 1 do
    Add(FilterCategory.GalleryItem.GalleryGroups[ASource[I].Index]);
end;

function TdxRibbonGalleryFilterCategoryGroups.Add
  (AGroup: TdxRibbonGalleryGroup): Integer;
begin
...
function TdxRibbonGalleryFilterCategoryGroups.CanAddGroup
  ...
  begin
    Result := (AGroup <> nil) and
      (AGroup.GalleryItem = FilterCategory.GalleryItem);
  end;
...
function TdxRibbonGalleryFilterCategoryGroups.GetItem(Index: Integer)
  : TdxRibbonGalleryGroup;
begin
  Result := TdxRibbonGalleryGroup(inherited Items[Index]);
end;
...
begin
  inherited DefineProperties(Filer);
  Filer.DefineProperty('CategoryGroups', ReadCategoryGroups,
    WriteCategoryGroups, FGroups.Count > 0);
end;
...
function TdxRibbonGalleryFilterCategory.GetGalleryItem
  : TdxCustomRibbonGalleryItem;
begin
  Result := TdxRibbonGalleryFilterCategories(Collection)
    .GalleryFilter.GalleryItem;
end;
...
constructor TdxRibbonGalleryFilterCategories.Create(AGalleryFilter
  : TdxRibbonGalleryFilter);
begin
...
function TdxRibbonGalleryFilterCategories.GetItem(Index: Integer)
  : TdxRibbonGalleryFilterCategory;
begin
...
constructor TdxRibbonGalleryFilter.Create(AGalleryItem
  : TdxCustomRibbonGalleryItem);
begin
  inherited Create;
...
begin
  ...
  begin
    ...
    ActiveCategoryIndex := TdxRibbonGalleryFilter(Source).ActiveCategoryIndex;
    // must be after Categories
...
begin
  ...
  else if ActiveCategoryIndex <> -1 then
...
begin
  ...
  if Value < 0 then
    Value := -1
  else if Value >= Categories.Count then
    Exit;
...
function TdxCustomRibbonGalleryItemActionLink.FindGroupItem
  (AActionIndex: Variant): TdxRibbonGalleryGroupItem;
var
  I, J: Integer;
begin
  for I := 0 to CustomRibbonGalleryItem.GalleryCategories.Count - 1 do
    for J := 0 to CustomRibbonGalleryItem.GalleryCategories[I]
      .Items.Count - 1 do
    begin
...
function TdxCustomRibbonGalleryItemActionLink.GetCustomRibbonGalleryItem
  : TdxCustomRibbonGalleryItem;
begin
...
begin
  ...
  if Source is TdxRibbonGalleryItemBarItemLink then
    PositionInDropDown := TdxRibbonGalleryItemBarItemLink(Source)
      .PositionInDropDown;
end;
...
procedure TdxRibbonGalleryItemBarItemLink.LoadFromIni(ASource: TCustomIniFile;
  const ABaseSection: string; ALinkIndex: Integer;
  AStoringKind: TdxBarStoringKind);
begin
  inherited LoadFromIni(ASource, ABaseSection, ALinkIndex, AStoringKind);
  if Self <> nil then
    PositionInDropDown := TdxRibbonGalleryItemBarItemLinkPositionInDropDown
      (ASource.ReadInteger(GetIniSection(ABaseSection, ALinkIndex,
      AStoringKind), 'PositionInDropDown', Ord(ilpAfterGallery)));
end;

procedure TdxRibbonGalleryItemBarItemLink.SaveToIni(ADestination
  : TCustomIniFile; const ABaseSection: string; ALinkIndex: Integer;
  AStoringKind: TdxBarStoringKind);
begin
  inherited SaveToIni(ADestination, ABaseSection, ALinkIndex, AStoringKind);
  ADestination.WriteInteger(GetIniSection(ABaseSection, ALinkIndex,
    AStoringKind), 'PositionInDropDown', Ord(FPositionInDropDown));
end;

procedure TdxRibbonGalleryItemBarItemLink.DoCalculateDragLineParameters
  (const ADragOverBeginGroup: Boolean; var ADragLineFirstPart: Boolean;
  out ADragLineRect: TRect);
var
...
function TdxRibbonGalleryItemBarItemLink.GetNeedDragLine
  (const ADragOverBeginGroup, ADragOverFirstPart: Boolean;
  ADragOverItemLink: TdxBarItemLink): Boolean;
begin
  Result := inherited GetNeedDragLine(ADragOverBeginGroup, ADragOverFirstPart,
    ADragOverItemLink) or (not ADragOverBeginGroup and
    (ADragOverItemLink <> Self));
end;

procedure TdxRibbonGalleryItemBarItemLink.PopulateCustomizationPopup
  (AItemLinks: TdxBarItemLinks; ASupportedActions: TdxBarCustomizationActions);
var
  AItem: TdxBarItem;
...
begin
  ...
  ASubItem := TdxBarDesignControllerAccess(BarDesignController)
    .AddCustomizationSubItem(AItemLinks,
    cxGetResourceString(@dxSBAR_GALLERYITEMLINKPOSITIONINDROPDOWN), True);

  for APositionInDropDown :=
    Low(TdxRibbonGalleryItemBarItemLinkPositionInDropDown)
    to High(TdxRibbonGalleryItemBarItemLinkPositionInDropDown) do
  begin
    AItem := BarDesignController.AddInternalItem(ASubItem.ItemLinks,
      TdxBarButton,
      GetEnumName(TypeInfo(TdxRibbonGalleryItemBarItemLinkPositionInDropDown),
      Integer(APositionInDropDown)),
...
procedure TdxRibbonGalleryItemBarItemLink.UpdateByDragParameters
  (const ADragOverBeginGroup, ADragOverFirstPart: Boolean;
  ADragOverItemLink: TdxBarItemLink);
begin
  inherited UpdateByDragParameters(ADragOverBeginGroup, ADragOverFirstPart,
    ADragOverItemLink);
  if ADragOverItemLink is TdxRibbonGalleryItemBarItemLink then
    PositionInDropDown := TdxRibbonGalleryItemBarItemLink(ADragOverItemLink)
      .PositionInDropDown;
end;
...
begin
  ...
  for I := 0 to VisibleIndex - 1 do
    if (Owner.VisibleItems[I] is TdxRibbonGalleryItemBarItemLink) and
      (TdxRibbonGalleryItemBarItemLink(Owner.VisibleItems[I])
      .PositionInDropDown = PositionInDropDown) then
    begin
      Result := True;
      Break;
    end;
...
procedure TdxRibbonGalleryItemBarItemLink.
  PositionInDropDownCustomizationPopupItemClickHandler(Sender: TObject);
begin
...
begin
  ...
  begin
    ...
    GalleryInMenuOptions := TdxCustomRibbonGalleryItem(Source)
      .GalleryInMenuOptions;
    GalleryInRibbonOptions := TdxCustomRibbonGalleryItem(Source)
      .GalleryInRibbonOptions;
    GalleryOptions := TdxCustomRibbonGalleryItem(Source).GalleryOptions;
  end;
end;

function TdxCustomRibbonGalleryItem.CopyGroupItem
  (AGroupItem: TdxRibbonGalleryGroupItem; ATargetGroup: TdxRibbonGalleryGroup;
  AIndex: Integer): TdxRibbonGalleryGroupItem;
begin
    ...
    if FClickedGroupItem.Group.Options.ItemPullHighlightingMode <> iphmNone then
      ...
      case GalleryOptions.ItemSelectionMode of
        ...
        gsmSingle:
          ...
          else if GalleryOptions.ItemAllowDeselect then
...
begin
  Result := (AParentKind = pkSubItemOrPopupMenu) or
    (TdxBarManagerAccess(BarManager).IsInitializing or
...
procedure TdxCustomRibbonGalleryItem.DoGroupItemClick
  (AItem: TdxRibbonGalleryGroupItem);
var
  AIntf: IdxActionGalleryClient;
begin
  if not AreGroupItemClickEventsLocked and (AItem <> nil) and
    Supports(Action, IdxActionGalleryClient, AIntf) then
    AIntf.Value := AItem.FActionIndex;
end;

procedure TdxCustomRibbonGalleryItem.ColumnCountChanged(Sender: TObject);
begin
  GalleryOptions.MinColumnCount := Min(GalleryOptions.MinColumnCount,
    GalleryOptions.ColumnCount);
  OptionsChanged(Self);
end;

procedure TdxCustomRibbonGalleryItem.DoHotTrackedItemChanged
  (APrevHotTrackedGroupItem, ANewHotTrackedGroupItem
  : TdxRibbonGalleryGroupItem);
begin
...
procedure TdxCustomRibbonGalleryItem.DoInitFilterMenu
...
function TdxCustomRibbonGalleryItem.GetGalleryOptionsClass
  : TCustomdxRibbonGalleryOptionsClass;
begin
...
procedure TdxCustomRibbonGalleryItem.ItemSelectionModeChanged(Sender: TObject;
  DeselectAll: Boolean);
var
  AGroup: TdxRibbonGalleryGroup;
  I, J: Integer;
...
begin
  GalleryOptions.ColumnCount := Max(GalleryOptions.MinColumnCount,
    GalleryOptions.ColumnCount);
  OptionsChanged(Self);
end;
...
function TdxCustomRibbonGalleryItem.GetActionLinkClass
  : TdxBarItemActionLinkClass;
begin
  Result := TdxCustomRibbonGalleryItemActionLink;
end;

procedure TdxCustomRibbonGalleryItem.GetChildren(Proc: TGetChildProc;
  Root: TComponent);
var
  I: Integer;
begin
...
begin
  ...
  begin
    ...
    else if GalleryFilter.ActiveCategoryIndex <> -1 then
      Result := GalleryFilter.Categories
        [GalleryFilter.ActiveCategoryIndex].Caption;
    if Result = '' then
...
function TdxCustomRibbonGalleryItem.InternalCanMergeWith
...
begin
  Result := GalleryFilter.Visible and ((GalleryFilter.Categories.Count > 0) or
    HasVisibleGroups);
end;
...
begin
  ...
  else if FLockGroupItemClickEventsCount > 0 then
    Dec(FLockGroupItemClickEventsCount);
end;

function TdxCustomRibbonGalleryItem.MoveGroupItem
  (AGroupItem: TdxRibbonGalleryGroupItem; ATargetGroup: TdxRibbonGalleryGroup;
  AIndex: Integer): TdxRibbonGalleryGroupItem;
begin
...
procedure TdxCustomRibbonGalleryItem.ShowGroupItem
  (AGroupItem: TdxRibbonGalleryGroupItem);
var
  I: Integer;
begin
  for I := 0 to LinkCount - 1 do
    if (Links[I].Control <> nil) and
      ...
      TdxInRibbonGalleryControlViewInfo(Links[I].Control.ViewInfo)
...
begin
  ...
  begin
    ...
    else if AComponent is TdxBarCustomPopupMenu then
    begin
      if (GalleryOptions <> nil) and (AComponent = GalleryOptions.PopupMenu)
      then
        GalleryOptions.PopupMenu := nil;
      if GalleryCategories <> nil then
        for I := 0 to GalleryCategories.Count - 1 do
          if (GalleryCategories[I].Options <> nil) and
            (AComponent = GalleryCategories[I].Options.PopupMenu) then
            GalleryCategories[I].Options.PopupMenu := nil
    end;
  end;
end;

procedure TdxCustomRibbonGalleryItem.RemoveGroupItem
  (AItem: TdxRibbonGalleryGroupItem);
var
  I: Integer;
begin
...
procedure TdxCustomRibbonGalleryItem.UpdateEx(AParentKinds
  : TdxBarKinds = dxBarKindAny);
var
  AControl: TdxBarItemControl;
  I: Integer;
begin
...
function TdxCustomRibbonGalleryItem.GetActionLink
  : TdxCustomRibbonGalleryItemActionLink;
begin
...
procedure TdxCustomRibbonGalleryItem.SetDropDownGallery
  (Value: TdxRibbonDropDownGallery);
begin
...
procedure TdxCustomRibbonGalleryItem.SetGalleryFilter
  (Value: TdxRibbonGalleryFilter);
begin
  FGalleryFilter.Assign(Value);
end;

procedure TdxCustomRibbonGalleryItem.SetGalleryGroups
  (Value: TdxRibbonGalleryGroups);
begin
  FGalleryGroups.Assign(Value);
end;

procedure TdxCustomRibbonGalleryItem.SetGalleryInRibbonOptions
  (Value: TdxInRibbonGalleryOptions);
begin
  FGalleryInRibbonOptions.Assign(Value);
end;

procedure TdxCustomRibbonGalleryItem.SetGalleryInMenuOptions
  (Value: TdxInMenuGalleryOptions);
begin
  FGalleryInMenuOptions.Assign(Value);
end;

procedure TdxCustomRibbonGalleryItem.SetGalleryOptions
  (Value: TdxCustomRibbonGalleryOptions);
begin
...
procedure TdxRibbonGalleryItem.DoGroupItemClick
  (AItem: TdxRibbonGalleryGroupItem);
begin
...
function TdxRibbonGalleryItem.GetGalleryOptionsClass
  : TCustomdxRibbonGalleryOptionsClass;
begin
...
function TdxRibbonGalleryItem.GetAllowedCustomizationActions
  : TdxGalleryCustomizationActions;
begin
...
procedure TdxRibbonGalleryItem.SetGalleryOptions
  (Value: TdxRibbonGalleryOptions);
begin
...
function TdxRibbonGalleryController.GetGroupItem(AGroupIndex, AIndex: Integer)
  : TdxRibbonGalleryGroupItem;
var
  AGroup: TdxRibbonGalleryGroup;
begin
...
procedure TdxRibbonGalleryController.SetHintItem
  (AItem: TdxRibbonGalleryGroupItem);
var
  R: TRect;
...
procedure TdxRibbonGalleryController.MouseDown(Button: TMouseButton;
  ...
  function GetIsItemPullHighlighting(AGroupItem
    : TdxRibbonGalleryGroupItem): Boolean;
  begin
...
begin
  ...
  begin
    ...
    if FGroupItemHotTrackEnabled and not GetIsItemPullHighlighting(AGroupItem)
    then
...
function TdxRibbonGalleryController.GetFirstGroupItem
  : TdxRibbonGalleryGroupItem;
var
  AGroupIndex: Integer;
begin
...
function TdxRibbonGalleryController.GetKeyboardHotGroupItem
  : TdxRibbonGalleryGroupItem;
var
...
begin
  ...
  begin
    AGroupViewInfo := GetGroupViewInfo(FOwner.GetGroups, ViewInfo,
      FKeyboardHotGroupItem.Group.Index, ADestroyAfterUse);
    try
...
function TdxRibbonGalleryController.GetViewInfo
  : TdxRibbonGalleryControlViewInfo;
begin
  Result := FOwner.ViewInfo;
end;

procedure TdxRibbonGalleryController.GroupItemMouseMove
  (AGroupItem: TdxRibbonGalleryGroupItem; Shift: TShiftState; X, Y: Integer);
var
  AGroupItemViewInfo: TdxRibbonGalleryGroupItemViewInfo;
begin
  if AGroupItem = nil then
...
begin
  ...
  begin
    ...
    try
      ...
      if (AGroupItem <> nil) or not(FKeyboardHotGroupItem <> nil) or not FLastCommandFromKeyboard
      then
      begin
...
type
  ...
  begin
    ...
    begin
      ...
      repeat
        ANextRow := False;
        AColumnCountInRow := AGroupViewInfo.GetColumnCountInRow
          (ACurrentRowIndex, GetGalleryWidth);
        ACurrentColumnIndex := 0;
        ...
        repeat
          ...
          ACurrentColumnIntersected := AreLinesIntersectedStrictly(AColumnLeft,
            AColumnRight, AColumnRange.Left, AColumnRange.Right);
          ...
          begin
            ...
            if (ACurrentColumnIndex = AColumnCountInRow - 1) and ACurrentColumnIntersected
            then
              AColumnFind := True;
        ...
        begin
          ...
          begin
            ...
            ANextGroup := ACurrentRowIndex > AGroupViewInfo.GetRowCount
              (GetGalleryWidth) - 1;
          end
          else
          begin
    ...
    begin
      if ADownDirection then
        ...
        Dec(AGroupIndex);
      TransferToAnotherGroup(AGroupIndex, AColumnRange, ADownDirection,
        ARow, AColumn);
    end;
  end;
  ...
  procedure RightDirection(AGroupViewInfo: TdxRibbonGalleryGroupViewInfo;
    var ARow, AColumn: Integer);
  begin
    if AColumn < AGroupViewInfo.GetColumnCountInRow(ARow, GetGalleryWidth) - 1
    then
      Inc(AColumn)
    else
      AColumn := 0;
  ...
  function Navigate(AHotGroupItem: TdxRibbonGalleryGroupItem)
    : TdxRibbonGalleryGroupItem;
  var
    ADestroyAfterUse: Boolean;
  ...
  begin
    ...
    try
      ...
      AGroupItemRow := AGroupViewInfo.GetItemRow(AHotGroupItem.Index,
        GetGalleryWidth);
      AGroupItemColumn := AGroupViewInfo.GetItemColumn(AHotGroupItem.Index,
        GetGalleryWidth);
      case ADirection of
        andLeft:
          LeftDirection(AGroupViewInfo, AGroupItemRow, AGroupItemColumn);
        andUp:
          UpDirection(AGroupViewInfo, AGroupIndex, AGroupItemRow,
            AGroupItemColumn);
        andRight:
          RightDirection(AGroupViewInfo, AGroupItemRow, AGroupItemColumn);
        andDown:
          DownDirection(AGroupViewInfo, AGroupIndex, AGroupItemRow,
            AGroupItemColumn);
      end;
      ...
      begin
        if AGroupIndex < 0 then
          BarNavigationController.ChangeSelectedObject(False,
            TdxBarItemLinksAccess(FOwner.Parent.ItemLinks)
            .Last.Control.IAccessibilityHelper)
        else
          BarNavigationController.ChangeSelectedObject(False,
            TdxBarItemLinksAccess(FOwner.Parent.ItemLinks)
            .First.Control.IAccessibilityHelper);
        Result := nil;
      end
      else
      begin
        ...
        Result := GetGroupItem(AGroupIndex,
          AGroupViewInfo.GetItemIndex(AGroupItemRow, AGroupItemColumn,
          GetGalleryWidth));
...
begin
  Result := (FFilterMenuLinksOwner <> nil) and
    (FFilterMenuLinksOwner.ItemLinks.BarControl <> nil);
end;
...
begin
  ...
  else if (Button = mbLeft) and GalleryItem.IsFilterVisible and
...
var
  ...
  ACurrentGroupItem, AHotGroupItem, ARequiredGroupItem
    : TdxRibbonGalleryGroupItem;
...
begin
  ...
  ViewInfo.GroupItemYRange(AHotGroupItem, AHotTrackedGroupItemTop,
    AHotTrackedGroupItemBottom);
  AGroupIndex := AHotGroupItem.Group.Index;
    ...
    if AGroupViewInfo <> nil then
      try
        repeat
          ACurrentGroupItem := GetGroupItem(AGroupIndex,
            AGroupViewInfo.GetItemIndex(AGroupRowIndex,
            AGroupViewInfo.GetColumnCountInRow(AGroupRowIndex, AWidth) -
            1, AWidth));
          ViewInfo.GroupItemYRange(ACurrentGroupItem, ACurrentGroupItemTop,
            ACurrentGroupItemBottom);
...
var
  ...
  ACurrentGroupItem, ARequiredGroupItem, AHotGroupItem
    : TdxRibbonGalleryGroupItem;
...
begin
  ...
  AItemIsObtained := False;
  repeat
    AGroupViewInfo := GetGroupViewInfo(FOwner.GetGroups, ViewInfo, AGroupIndex,
      ADestroyAfterUse);
    if AGroupViewInfo <> nil then
      try
...
begin
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        if AGroupItem.Group.Index < FOwner.GetGroups.Count - 1 then
          AGroupIndex := ViewInfo.GetVisibleNotEmptyGroupIndex(AGroupItem.Group.
            Index + 1, True);
        if AGroupIndex = -1 then
          if TdxBarItemLinksAccess(FOwner.Parent.ItemLinks).First <> nil then
          begin
    ...
    else if AGroupItem.Index > 0 then
      AGroupItem := AGroupItem.Group.Items[AGroupItem.Index - 1]
    else
    begin
      AGroupIndex := -1;
      ...
      if AGroupIndex <> -1 then
        AGroupItem := FOwner.GetGroups[AGroupIndex].Items
          [FOwner.GetGroups[AGroupIndex].Items.Count - 1];
    end;
  end
  else
...
begin
  ViewInfo.SetFilterBandHotTrack((ActiveBarControl = FOwner.Parent) and
    not(ssLeft in KeyboardStateToShiftState) and
    ViewInfo.IsPtInFilterBandHotTrackArea(FOwner.Parent.ScreenToClient
    (GetMouseCursorPos)));
end;

procedure TdxRibbonOnSubmenuGalleryController.FilterMenuButtonClick
  (Sender: TObject);
begin
...
begin
  ...
  if GalleryItem.GalleryFilter.ActiveCategoryIndex <> ANewActiveCategoryIndex
  then
  begin
...
function TdxRibbonOnSubmenuGalleryController.GetFirstGroupItem
  : TdxRibbonGalleryGroupItem;
var
  AGroup: TdxRibbonGalleryGroup;
  I, Index: Integer;
begin
  ...
  for I := 0 to GalleryItem.GalleryGroups.Count - 1 do
    ...
    begin
      ...
      begin
        Index := 0;
        while (Index < AGroup.Items.Count - 1) and not AGroup.Items[Index]
          .Enabled do
          Inc(Index);
...
function TdxRibbonOnSubmenuGalleryController.GetLastGroupItem
  : TdxRibbonGalleryGroupItem;
var
  AGroup: TdxRibbonGalleryGroup;
  I: Integer;
...
function TdxRibbonOnSubmenuGalleryController.GetViewInfo
  : TdxRibbonOnMenuGalleryControlViewInfo;
begin
...
procedure TdxRibbonOnSubmenuGalleryController.InitFilterMenu
  ...
  procedure AddButton(const ACaption: string; AIsCheckable, AIsDown: Boolean;
    ATag: TcxTag; ABeginGroup: Boolean);
  var
    AButton: TdxBarButton;
  begin
...
begin
  ...
  begin
    ...
    AddButton(cxGetResourceString(@dxSBAR_SHOWALLGALLERYGROUPS), False, False,
      -1, True);
    AddButton(cxGetResourceString(@dxSBAR_HIDEALLGALLERYGROUPS), False, False,
      -2, False);
  end
  else
  begin
    ...
    AddButton(cxGetResourceString(@dxSBAR_CLEARGALLERYFILTER), False, False,
      -1, True);
  end;
...
begin
  ...
  Result := Assigned(AItem.OnClick) and dxSameMethods(AItem.OnClick,
    ATempEventHandler);
end;
...
begin
  if FFilterMenuLinksOwner = nil then
    FFilterMenuLinksOwner := TdxBarInternalLinksOwner.Create
      (GalleryItem.BarManager, TdxRibbonGalleryFilterMenuControl);
  FFilterMenuLinksOwner.ItemLinks.CreateBarControl;
  APopupControl := FFilterMenuLinksOwner.BarControl as
    TdxRibbonGalleryFilterMenuControl;
...
function TdxRibbonGalleryFilterMenuControl.GetBehaviorOptions
...
procedure TdxRibbonGalleryFilterMenuControl.
  ProcessMouseDownMessageForMeaningParent(AWnd: HWND; AMsg: UINT;
  const AMousePos: TPoint);
begin
  inherited ProcessMouseDownMessageForMeaningParent(AWnd, AMsg, AMousePos);
  if TdxRibbonOnMenuGalleryControlViewInfo(GalleryControl.ViewInfo)
    .IsPtInFilterBandHotTrackArea(RealOwnerControl.ScreenToClient(AMousePos))
  then
...
procedure TdxRibbonGalleryControl.ShowGroupItem
  (AGroupItem: TdxRibbonGalleryGroupItem);
begin
...
begin
  ...
  begin
    Result := (Item.GalleryOptions.ItemHintSource = ghsItemHint) or
      ((Item.GalleryOptions.ItemHintSource = ghsGalleryScreenTip) and
      (Item.ScreenTip <> nil));
    if Result then
...
function TdxRibbonGalleryControl.GetHintText(AGroupItem
  : TdxRibbonGalleryGroupItem): string;
var
  AGroupItemViewInfo: TdxRibbonGalleryGroupItemViewInfo;
begin
  ...
  begin
    if FHintItem <> nil then
      if UseRightToLeftAlignment then
        Result.X := Parent.ClientToScreen(cxPoint(FHintBounds.Right,
          FHintBounds.Top)).X
      else
...
procedure TdxRibbonGalleryControl.UpdateHint
  (AHintItem: TdxRibbonGalleryGroupItem; const ABounds: TRect);
begin
  FHintItem := AHintItem;
  FHintBounds := ABounds;
  if Parent <> nil then
...
function TdxRibbonGalleryControl.CalcDefaultWidth: Integer;
  ...
  begin
    if Parent.Kind = bkBarControl then
      Result := (ViewInfo as IdxBarMultiColumnItemControlViewInfo)
        .GetColumnCount
    else
...
begin
  ...
  begin
    ...
    AScrollbarAndIndents := ViewInfo.GetScrollBarWidth +
      ViewInfo.GetLeftLayoutIndent + ViewInfo.GetRightLayoutIndent;
    ...
    Result := Result + Max(0, ViewInfo.GetGalleryMargins.Left) +
...
begin
  ...
  if Parent is TdxRibbonDropDownGalleryControl then
    Result := TdxRibbonDropDownGalleryControl(Parent)
      .InternalGalleryItemControl <> Self;
end;
...
procedure TdxRibbonGalleryControl.ControlUnclick(ByMouse: Boolean);
  ...
  begin
    Result := nil;
    if (Parent.Kind <> bkBarControl) and (Parent.ParentBar <> nil) and
      (Parent.ParentBar.Kind = bkBarControl) then
    begin
      AItemControl := TdxRibbonDropDownGalleryControl(Parent).ParentItemControl;
      if not Collapsed and TdxBarItemControlAccess(AItemControl).IsExpandable
      then
...
begin
  ...
  try
    ...
    if ByMouse then
    begin
      Item.FClickedGroupItem := ViewInfo.GetGroupItem
        (Parent.ScreenToClient(GetMouseCursorPos));
    ...
    if (AInRibbonGalleryControlLink <> nil) and
      (AInRibbonGalleryControlLink.Ref <> nil) then
    begin
      AGalleryControl := TdxRibbonGalleryControl
        (AInRibbonGalleryControlLink.Ref);
...
begin
  if (Item.GalleryOptions.ItemHintSource <> ghsGalleryScreenTip) and
    (FHintItem <> nil) then
    Result := TCustomdxBarControlAccess(Parent).CreateHintViewInfo(AHintText,
      AShortCut, nil)
  else
...
begin
  ...
  if not Collapsed then
    Result := Max(Result, ViewInfo.GetHeight(GetDefaultWidthInSubMenu) +
      cxMarginsHeight(ViewInfo.GetGalleryMargins));
end;
...
procedure TdxRibbonGalleryControl.GetDefaultTextColors(AEnabled, ASelected,
  AFlat: Boolean; var AColor1, AColor2: TColor);
begin
  Painter.DropDownGalleryItemGetTextColors(Self, AEnabled, ASelected, AFlat,
    AColor1, AColor2);
end;
...
begin
  Result := not IsValidPainter or (ViewInfo <> nil) and
    (TCustomdxBarControlAccess(Parent).GetItemControlDefaultViewLevel(Self) <>
    ivlDefault);
  if not Result then
...
var
  R: TRect;
begin
  if not Collapsed and ScrollBar.IsDropDownStyle and not Parent.IsCustomizing
  then
  begin
    R := ViewInfo.GalleryBounds;
    if UseRightToLeftAlignment then
      P := Parent.ClientToScreen(cxPointOffset(cxPoint(R.Right, R.Top),
        DropDownOffsetX, -DropDownOffsetY))
    else
      P := Parent.ClientToScreen(cxPointOffset(R.TopLeft, -DropDownOffsetX,
        -DropDownOffsetY));
    AOwnerWidth := 0;
    AOwnerHeight := 1;
  end
...
procedure TdxRibbonGalleryControl.ControlActivate(AImmediately,
  AByMouse: Boolean);
...
procedure TdxRibbonGalleryControl.ControlClick(AByMouse: Boolean;
  AKey: Char = #0);
var
  R: TRect;
begin
...
begin
  ...
  if (Item.DropDownGallery <> nil) and Item.DropDownGallery.HasValidGalleryItem
  then
  begin
...
function TdxRibbonGalleryControl.GetAccessibilityHelperClass
...
begin
  ...
  if (Parent.Kind = bkBarControl) and (Result <> nil) and
    (Result.ParentItemControl <> Self) and not FIsCreatingSubmenuControl and not FIsClosingUpSubmenuControl
  then
    Result := nil;
end;

function TdxRibbonGalleryControl.GetViewInfoClass
  : TdxBarItemControlViewInfoClass;
begin
  case Parent.Kind of
    bkSubMenu:
...
begin
  ...
  begin
    if TdxRibbonOnMenuGalleryControlViewInfo(ViewInfo)
      .IsPtInFilterBandHotTrackArea(Parent.ScreenToClient(GetMouseCursorPos))
    then
      Exit(False);
    if Item.FClickedGroupItem = nil then
      Exit(False);
...
begin
  if not FIsNeedScrollBarLock and
    (ViewInfo.IsInRibbon or (SubMenuControl <> nil) or
    (Parent is TdxRibbonDropDownGalleryControl)) then
  begin
    FIsNeedScrollBarLock := True;
    try
      Result := not Collapsed and ((Parent.Kind = bkBarControl) or
        (Item.GalleryOptions.SubmenuResizing in [gsrHeight, gsrWidthAndHeight])
        or IsEnabledScrollBar);
    finally
...
begin
  Result := (Parent <> nil) and (not(Parent.Kind = bkBarControl) or
    (Painter is TdxBarSkinnedPainter));
end;
...
function TdxRibbonGalleryControl.ShowCustomPopupMenu: Boolean;
  ...
  begin
    ...
    begin
      ...
      APopupMenuControl := TdxBarCustomizingPopupAccess
        (FCustomPopupMenu.ItemLinks.BarControl);
      ...
      APopupMenuControl.FPopupAlignment := TdxBarCustomPopupMenuAccess
        (FCustomPopupMenu).PopupAlignment;
...
begin
  ...
  begin
    ...
    AHotGroupItem := ViewInfo.GetGroupItem(AClientPopupPoint.X,
      AClientPopupPoint.Y);
...
procedure TdxRibbonGalleryControl.DoScrollBarScroll(Sender: TObject;
  ...
  begin
    Result := not(ScrollBar.IsDropDownStyle and ((ScrollCode = scLineUp) and
      not ViewInfo.GetPreviousButtonEnabled or (ScrollCode = scLineDown) and
      not ViewInfo.GetNextButtonEnabled or (ScrollCode = scEndScroll)));
  end;
...
procedure TdxRibbonGalleryControl.DoScrollBarMouseMove(Sender: TObject;
  Shift: TShiftState; X, Y: Integer);
begin
...
procedure TdxRibbonGalleryControl.CustomPopupMenuCloseUpHandler(Sender: TObject;
  AReason: TdxBarCloseUpReason);
begin
...
begin
  ...
  begin
    ...
    SendMessage(Parent.Handle, WM_LBUTTONDOWN,
      ShiftStateToKeys(KeyboardStateToShiftState), MakeLParam(ScrollBar.Left,
      ScrollBar.Top));
end;
...
function TdxRibbonGalleryGroupElementViewInfo.GetGalleryItemControl
  : TdxRibbonGalleryControl;
begin
...
procedure TdxRibbonGalleryGroupHeaderViewInfo.Calculate(const ABounds: TRect);
begin
...
begin
  ...
  begin
    ...
    Owner.Painter.DropDownGalleryDrawGroupHeaderBackground
      (ACanvas.Handle, Bounds);
    cxDrawText(ACanvas, Caption, cxRectInflate(Bounds,
      -GroupHeaderCaptionOffset, 0), GetTextFlags(Owner.Group.Header.Alignment),
...
begin
  ...
  begin
    Result := MulDiv(TdxTextMeasurer.TextLineHeight(GetFont), 3, 2);
...
procedure TdxRibbonGalleryGroupItemViewInfo.Paint(ACanvas: TcxCanvas);
  ...
  begin
    Result := not IsMergeItemsImages and
      (GetDowned or GetHotTracked or GetSelected);
  end;
  ...
  begin
    Result := IsMergeItemsImages and IsImageVisible and
      (GetHotTracked or GetSelected);
  end;
  ...
  begin
    ...
    Result := cxRectSetBottom(Bounds,
      Min(Bounds.Bottom, AControlViewInfo.Bounds.Bottom -
      AControlViewInfo.GetGalleryMargins.Bottom));
  end;
...
begin
  ...
  try
    ...
    if IsSmallButtonSelected then
      Painter.DropDownGalleryDrawItem(ACanvas.Handle, Bounds,
        CalculateSmallButtonState, Owner.Owner.Control.ScaleFactor)
    else
  ...
  if IsDrawSelected then
    Painter.DropDownGalleryDrawSelectionFrame(ACanvas, FImageBounds,
...
function TdxRibbonGalleryGroupItemViewInfo.CalculateImageSize: TSize;
  ...
  begin
    ...
    begin
      ...
      else if (APlaceSize.cx < AImageSize.cx) or (APlaceSize.cy < AImageSize.cy)
      then
      begin
...
procedure TdxRibbonGalleryGroupItemViewInfo.DrawImage(DC: HDC;
  const ARect: TRect);
begin
...
procedure TdxRibbonGalleryGroupItemViewInfo.DrawItemText(ACanvas: TcxCanvas);
  ...
  procedure DrawText(ACanvas: TcxCanvas; const AText: string;
    const ARect: TRect; AFormat: UINT);
  begin
    if Owner.Owner.IsInRibbon and TdxInRibbonGalleryControlViewInfo(Owner.Owner)
      .DrawWithoutBackground then
  ...
  begin
    ...
    if Options.GetItemImagePosition in [gipLeft, gipRight] then
      Result := Result or TextAlignment
        [GetGalleryItemControl.UseRightToLeftAlignment]
    else
  ...
  begin
    ...
    else if HotGroupItem = GroupItem then
      Result := Owner.Owner.HotTextColor
    else if GroupItem.GetEnabled then
...
begin
  ...
  begin
    ...
    DrawText(ACanvas, Caption, FCaptionBounds, ATextAlignmentFlags +
      DT_END_ELLIPSIS);
  end;
...
function TdxRibbonGalleryGroupItemViewInfo.GetHotTracked: Boolean;
  ...
  function GetGeneralItemPullHighlightingMode
    : TdxRibbonGalleryItemPullHighlightingMode;
  begin
  ...
  begin
    Result := Options.ItemPullHighlightingMode =
      GetGeneralItemPullHighlightingMode;
  end;
  ...
  begin
    Result := ((GetOuterGroupItem(GroupItem, HotGroupItem,
      ...
      (GroupItem = HotGroupItem)) and
      (GetItemPullHighlightingIdentifier(GroupItem)
      = GetItemPullHighlightingIdentifier(HotGroupItem)) and
      ((GetGeneralItemPullHighlightingMode <> iphmNone) and
      AgreeWithGeneralItemPullHighlighting or
      (GetGeneralItemPullHighlightingMode = iphmNone) and
      (Options.ItemPullHighlightingMode <> iphmNone));
  end;
...
begin
  Result := dxGetImageSize(GetCurrentGlyph, GroupItem.Group.Images, 0,
    Owner.Owner.Control.ScaleFactor);
end;

function TdxRibbonGalleryGroupItemViewInfo.GetItemSize(AMaxWidth,
  AMaxHeight: Integer): TSize;
var
...
begin
  ...
  case Options.GetItemImagePosition of
    gipTop, gipBottom:
      begin
        ...
        AWidth := Max(Max(GetCaptionWidth, GetDescriptionWidth(ADescriptionRect,
          AMaxDescriptionWidth)), AImageSize.cx) + 2 * HorizontalImageIndent;
    ...
    AWidth := AImageSize.cx + ItemWidthWithoutImage(ADescriptionRect,
      AMaxDescriptionWidth);
    AHeight := Max(AImageSize.cy, GetCaptionHeight + GetDescriptionHeight
      (ADescriptionRect) + GetSpaceBetweenItemCaptionAndDescription) + 2 *
      VerticalImageIndent;
  end;
  if AMaxWidth > 0 then
...
function TdxRibbonGalleryGroupItemViewInfo.
  GetSpaceBetweenItemCaptionAndDescription: Integer;
begin
  if IsCaptionVisible and IsDescriptionVisible then
    Result := Options.GetSpaceBetweenItemCaptionAndDescription +
      GetActualGroupItemIndent
  else
    Result := 0;
end;

function TdxRibbonGalleryGroupItemViewInfo.
  GetSpaceBetweenItemImageAndText: Integer;
begin
...
begin
  Result := cxGraphics.IsImageAssigned(GetCurrentGlyph, GroupItem.Group.Images,
    GroupItem.ImageIndex);
end;
...
begin
  ...
  begin
    if CanUseSize(CalculateImageSize) then
      Inc(Result, CalculateImageSize.cx +
        Options.GetSpaceBetweenItemImageAndText + GetActualGroupItemIndent);
  end;
...
begin
  ...
  begin
    if CanUseSize(CalculateImageSize) then
      Dec(Result, CalculateImageSize.cx +
        Options.GetSpaceBetweenItemImageAndText + GetActualGroupItemIndent);
  end;
...
begin
  ...
  begin
    if CanUseSize(CalculateImageSize) then
      Inc(Result, CalculateImageSize.cy +
        Options.GetSpaceBetweenItemImageAndText + GetActualGroupItemIndent);
  end;
  Inc(Result, GetActualGroupItemIndent);
end;
...
procedure TdxRibbonGalleryGroupItemViewInfo.CheckTextVerticalAlignment
  (AVerticalAlignment: TcxAlignmentVert);
var
...
begin
  ...
  FDescriptionBounds := cxRectSetTop(FDescriptionBounds, FCaptionBounds.Bottom +
    GetActualGroupItemIndent);
end;
...
function TdxRibbonGalleryGroupItemViewInfo.GetDescriptionRect
  (AMaxWidth: Integer): TRect;
  ...
  begin
    R := Rect(0, 0, 1, 1);
    cxDrawText(GetGalleryItemControl.Canvas.Handle, Description, R,
      DT_WORDBREAK { or DT_NOFULLWIDTHCHARBREAK } or DT_CALCRECT);
    Result := R.Right;
  end;
...
begin
  ...
  if not IsInplaceGallery and not AIsDescriptionNeedRecalculation then
    Result := TdxRibbonOnMenuGalleryControlViewInfo(Owner.Owner)
      .GetGroupItemDescriptionRect(GroupItem.Group.Index, GroupItem.Index)
  else
    Result := cxNullRect;
  ...
  begin
    ...
    try
      ...
      repeat
        Result := cxGetTextRect(GetGalleryItemControl.Canvas.Handle,
          Description, FDescriptionRowCount, False, DT_EXPANDTABS);
        if GetMinDescriptionWidth > AMaxWidth then
          ASuccess := True
        else if AIsDescriptionNeedRecalculation then
        begin
    ...
    if not IsInplaceGallery then
      TdxRibbonOnMenuGalleryControlViewInfo(Owner.Owner)
        .SetGroupItemDescriptionRect(GroupItem.Group.Index,
        GroupItem.Index, Result);
  end;
end;
...
function TdxRibbonGalleryGroupItemViewInfo.GetHotGroupItem
  : TdxRibbonGalleryGroupItem;
begin
...
begin
  Result := FGroupItem.Enabled and
    (Options.ItemPullHighlightingMode <> iphmNone) and
    not Owner.Owner.IsInRibbon;
end;

function TdxRibbonGalleryGroupItemViewInfo.GetOptions
  : TdxRibbonGalleryGroupOptions;
begin
...
begin
  if Options.RemoveVerticalItemPadding then
    Result := 0
  else if IsInplaceGallery and
    (not IsCaptionVisible or (Options.ItemImagePosition in [gipLeft, gipRight])
    or not IsImageVisible) then
...
begin
  ...
  begin
    Result := (not IsInplaceGallery and (Options.ItemTextKind in [itkCaption,
      itkCaptionAndDescription]) or IsInplaceGallery and
      (GroupItem.Group.GalleryItem.GalleryInRibbonOptions.AlwaysShowItemCaption
      or not IsImageVisible)) and (Caption <> '') and
      (not IsMergeItemsImages or not IsImageVisible);
    if Result then
...
var
  ARowIndex, ARowTop, ARowHeight, AColumnCount, ARowCount, AItemIndex,
    AColumnIndex, AColumnLeft, AGroupWidth: Integer;
  AItemBounds: TRect;
begin
  ...
  begin
    ...
    begin
      AColumnIndex := 0;
      for AItemIndex := GetFirstItemInGroupRow(ARowIndex, AColumnCount)
        to GetLastItemInGroupRow(ARowIndex, AColumnCount) do
      begin
        AColumnLeft := GetColumnLeft(AColumnIndex, Bounds.Left);
        AItemBounds := Rect(AColumnLeft, ARowTop, AColumnLeft + FItemSize.cx,
          ARowTop + FItemSize.cy);
        if Owner.Control.UseRightToLeftAlignment then
          AItemBounds := TdxRightToLeftLayoutConverter.ConvertRect
            (AItemBounds, Bounds);
...
function TdxRibbonGalleryGroupViewInfo.CalculateItemSize
  (const APredefinedItemSize: TSize;
  AMaxItemWidth, AMaxItemHeight: Integer): TSize;
var
...
begin
  AMaxItemWidth := cxRectWidth(ABounds) -
...
function TdxRibbonGalleryGroupViewInfo.GetColumnLeft(AColumnIndex: Integer;
  AGroupLeft: Integer): Integer;
begin
...
function TdxRibbonGalleryGroupViewInfo.GetColumnCountInRow(ARow: Integer;
...
function TdxRibbonGalleryGroupViewInfo.GetHeaderBounds
  (AGroupBounds: TRect): TRect;
begin
  Result := AGroupBounds;
  Result.Bottom := Result.Top + Header.GetHeight(AGroupBounds.Right -
    AGroupBounds.Left, False);
end;

function TdxRibbonGalleryGroupViewInfo.GetItemColumn(AIndex: Integer;
  AGroupWidth: Integer): Integer;
var
...
function TdxRibbonGalleryGroupViewInfo.GetItemIndex(ARow, AColumn: Integer;
  AGroupWidth: Integer): Integer;
begin
  Result := ARow * GetColumnCount(AGroupWidth) + AColumn;
end;

function TdxRibbonGalleryGroupViewInfo.GetItemRow(AGroupItemIndex: Integer;
  AGroupWidth: Integer): Integer;
var
  AColumnCount: Integer;
begin
...
begin
  Result := AGroupTop + Header.GetHeight(AGroupWidth, True) + GetRowHeight *
    ARowIndex;
end;
...
function TdxRibbonGalleryGroupViewInfo.GetSpaceBetweenItems
  (AIsFlat: Boolean): Integer;
begin
  if (Options.RemoveHorizontalItemPadding and AIsFlat) or
    (Options.RemoveVerticalItemPadding and not AIsFlat) then
    Result := 0
  else if Owner.IsInRibbon then
  begin
    if AIsFlat then
...
function TdxRibbonGalleryGroupViewInfo.GetItem(Index: Integer)
  : TdxRibbonGalleryGroupItemViewInfo;
begin
...
function TdxRibbonGalleryGroupViewInfo.GetItemSize(AMaxItemWidth,
  AMaxItemHeight: Integer): TSize;
var
...
function TdxRibbonGalleryControlViewInfo.GetGroupItemCount(ALastGroupIndex
  : Integer): Integer;
var
  I: Integer;
begin
...
begin
  Result := TdxBarSkinnedPainterAccess(Painter).GetPartState(Control.DrawParams,
    icpControl);
end;
...
function TdxRibbonGalleryControlViewInfo.GetGroupItem(const P: TPoint)
  : TdxRibbonGalleryGroupItem;
begin
  Result := GetGroupItem(P.X, P.Y);
end;

function TdxRibbonGalleryControlViewInfo.GetGroupItem(X, Y: Integer)
  : TdxRibbonGalleryGroupItem;
var
  I, J: Integer;
...
function TdxRibbonGalleryControlViewInfo.GetGroupItemViewInfo
  ...
  function GetGroupViewInfo(AGroup: TdxRibbonGalleryGroup)
    : TdxRibbonGalleryGroupViewInfo;
  var
    I: Integer;
  begin
...
begin
  ...
  if AGroupItem = nil then
    Exit;
  AGroupViewInfo := GetGroupViewInfo(GalleryItem.GalleryGroups
...
begin
  ...
  begin
    ALastGroupIndex := GetVisibleNotEmptyGroupIndex(Control.GetGroups.Count -
      1, False);
    ...
    Result := (ALastGroupIndex <> ALastGroupViewInfo.Group.Index) or
      ...
      ALastGroupViewInfo.Items[ALastGroupViewInfo.ItemCount - 1].GroupItem.
      Index) or not cxRectContain(GalleryBounds,
...
function TdxRibbonGalleryControlViewInfo.GetVisibleGroupIndex(AStartGroupIndex
  : Integer; AIncreaseIndex: Boolean): Integer;
begin
  Result := AStartGroupIndex;
  if AIncreaseIndex then
  begin
    while (Result < Control.GetGroups.Count) and not GalleryItem.IsGroupVisible
      (Result) do
      Inc(Result);
...
function TdxRibbonGalleryControlViewInfo.IsGroupItemAtThisPlace(X,
  Y: Integer): Boolean;
begin
...
procedure TdxRibbonGalleryControlViewInfo.SetGroupItemStoredSize
  (const Value: TSize; AGroupIndex: Integer);
begin
  if AGroupIndex < Length(FGroupItemStoredSizes) then
...
procedure TdxRibbonGalleryControlViewInfo.SetHotGroupItem
  ...
  function HasGroupItemPullHighlighting(AGroupItem
    : TdxRibbonGalleryGroupItem): Boolean;
  begin
  ...
  begin
    ...
    try
      ...
      else if HasGroupItemPullHighlighting(AOldHotGroupItem) and
...
begin
  ...
  else if not Control.FIsCustomPopupMenuShown then
    DoSetHotGroupItem(Value);
end;
...
function TdxRibbonGalleryControlViewInfo.GetGroup(Index: Integer)
  : TdxRibbonGalleryGroupViewInfo;
begin
...
function TdxRibbonGalleryControlViewInfo.GetGalleryItem
  : TdxCustomRibbonGalleryItem;
begin
  if Control <> nil then
...
function TdxRibbonGalleryControlViewInfo.GetGalleryOptions
  : TdxCustomRibbonGalleryOptions;
begin
  Result := GalleryItem.GalleryOptions;
end;

function TdxRibbonGalleryControlViewInfo.GetGalleryInMenuOptions
  : TdxInMenuGalleryOptions;
begin
...
procedure TdxRibbonGalleryControlViewInfo.DrawGroupItem(const AGroupItem
  : TdxRibbonGalleryGroupItem);
var
...
procedure TdxRibbonGalleryControlViewInfo.RepaintChainOfGroups(ANewItem,
  AOldItem: TdxRibbonGalleryGroupItem);

  function IsGroupPullDirectionAgreeWithGeneral
    (AnItem: TdxRibbonGalleryGroupItem): Boolean;
  begin
    Result := (AnItem = nil) or (AnItem.Group.Options.ItemPullHighlightingMode
      <> iphmNone) and
      (AnItem.Group.Options.ItemPullHighlightingMode = GalleryInMenuOptions.
      ItemPullHighlightingMode);
  end;

  function UsePullDirectionOfGroup(out AMode
    : TdxRibbonGalleryItemPullHighlightingMode): Boolean;
  begin
  ...
  procedure DoRepaintChain(AStartGroupIndex, AStartGroupItemIndex,
    ...
    begin
      ...
      begin
        ...
        else if IsStartToFinishDirection and
          (ACurrentGroupIndex = GetVisibleGroupIndex(0, True)) then
          Result := ggrpAll
        else
          Result := ggrpAfter;
      end
      else if ACurrentGroupIndex = AEndGroupIndex then
      begin
        if not IsStartToFinishDirection and
          (ACurrentGroupIndex = GetVisibleGroupIndex
          (GalleryItem.GalleryGroups.Count - 1, False)) then
          Result := ggrpAll
        else
        begin
          Result := ggrpBefore;
      ...
      begin
        ...
        begin
          ...
          begin
            ...
            AGroupViewInfo.RepaintChainOfItems(AnItemIndex, IsHotTrack,
              Control.Canvas, APart, AnItemIndex2);
          end
          else
            AGroupViewInfo.Free;
        end;
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          AEndGroupItemIndex := GalleryItem.GalleryGroups[AEndGroupIndex]
            .Items.Count - 1;
        end;
      end;
    end
    ...
    begin
      ...
      begin
        AEndGroupIndex := GetVisibleGroupIndex
          (GalleryItem.GalleryGroups[GalleryItem.GalleryGroups.Count - 1].
          Index, False);
        AEndGroupItemIndex := GalleryItem.GalleryGroups[AEndGroupIndex]
          .Items.Count - 1;
      end;
...
var
  ...
  AStartGroupIndex, AEndGroupIndex, AStartGroupItemIndex,
    AEndGroupItemIndex: Integer;
begin
  ...
  begin
    ...
    ReturnRangeEnd(AEndGroupItem, IsHotTrack, AEndGroupIndex,
      AEndGroupItemIndex);
    DoRepaintChain(AStartGroupIndex, AStartGroupItemIndex, AEndGroupIndex,
      AEndGroupItemIndex, IsHotTrack);
  end;
end;

{ TdxInRibbonGalleryControlViewInfo }

constructor TdxInRibbonGalleryControlViewInfo.Create
  (AControl: TdxBarItemControl);
begin
  inherited Create(AControl);
...
procedure TdxInRibbonGalleryControlViewInfo.Calculate(ALayoutOffset: Integer;
  AScrollCode: TScrollCode);
...
procedure TdxInRibbonGalleryControlViewInfo.Paint(ACanvas: TcxCanvas);
  ...
  begin
    ...
    try
      ...
      cxBitBlt(ACanvas.Canvas.Handle, ABitmap.Canvas.Handle, GalleryBounds,
        cxNullPoint, SRCCOPY);
    finally
      ABitmap.Free;
    end;
...
begin
  ...
  SetLength(FWidthForColumnCountInfos, GetMaxColumnCount -
    GetMinColumnCount + 1);
...
begin
  ...
  begin
    AItemGroupIndex := TdxRibbonGalleryGroup
      (TdxRibbonGalleryGroupItem(AGroupItemsList.Items[I])
      .Collection.ParentComponent).Index;
    ...
    AGroupItemBounds.Bottom := AGroupItemBounds.Top +
      AGroupViewInfo.ItemSize.cy;
    AGroupItemBounds.Left := AGroupViewInfo.GetColumnLeft(AColumnIndex,
      Bounds.Left);
    AGroupItemBounds.Right := AGroupItemBounds.Left +
      AGroupViewInfo.ItemSize.cx;
    if Control.UseRightToLeftAlignment then
      AGroupItemBounds := TdxRightToLeftLayoutConverter.ConvertRect
        (AGroupItemBounds, AControlBounds);
    AGroupViewInfo.CreateGroupItem
      (TdxRibbonGalleryGroupItem(AGroupItemsList.Items[I]).Index,
      AGroupItemBounds);
    Inc(AColumnIndex);
  ...
  for I := 0 to Control.GetGroups.Count - 1 do
    ...
    begin
      AGroupViewInfo := GetGroupViewInfo(Control.GetGroups, Self, I,
        ADestroyAfterUse);
      try
        AWidth := AGroupViewInfo.CalculateItemSize(AGroupItemSize,
          AGroupItemSize.cx, AGroupItemSize.cy).cx;
      finally
        if ADestroyAfterUse then
          AGroupViewInfo.Free;
      end;
...
procedure TdxInRibbonGalleryControlViewInfo.DoDrawBackground(ACanvas: TcxCanvas;
  const R: TRect);
begin
  GetRibbonSkin.DrawBackground(ACanvas.Handle, R, DXBAR_INRIBBONGALLERY,
    GetInRibbonGalleryState);
end;

procedure TdxInRibbonGalleryControlViewInfo.DoScrolling(ARowDelta: Integer);

  procedure CalculateVisibleRows(AColumnCount: Integer;
    out AFirstVisibleRowIndex, ALastVisibleRowIndex: Integer);
  var
  ...
  begin
    ...
    try
      ABitmap.cxCanvas.WindowOrg := Point(GalleryBounds.Left,
        GalleryBounds.Top - AOffset * (RowCount - 1) *
        ABitmap.Height div RowCount + 1);
...
begin
  ...
  if (Control.GetVisibleGroupCount > 0) and (AColumnCount > 0) and
    IsScrollingPossible(ARowDelta) then
  begin
    CalculateVisibleRows(AColumnCount, AFirstVisibleRowIndex,
      ALastVisibleRowIndex);
    ...
    try
      if ARowDelta > 0 then
        PopulateGroupItemList(AFirstVisibleRowIndex, ALastVisibleRowIndex,
          AColumnCount, AGroupItemsList)
      else
        PopulateGroupItemList(AFirstVisibleRowIndex + 1, ALastVisibleRowIndex,
          AColumnCount, AGroupItemsList);
      DrawOnBitmap(AStartBitmap, AColumnCount, AGroupItemsList);

      if ARowDelta > 0 then
      begin
        PopulateGroupItemList(ALastVisibleRowIndex, ALastVisibleRowIndex,
          AColumnCount, AGroupItemsList);
        AAnimationMode := amScrollUp;
      end
      else
      begin
        PopulateGroupItemList(AFirstVisibleRowIndex, AFirstVisibleRowIndex,
          AColumnCount, AGroupItemsList);
        AAnimationMode := amScrollDown;
      end;
      DrawOnBitmap(AEndBitmap, AColumnCount, AGroupItemsList,
        Integer(ARowDelta < 0));

      FAnimation := TdxImageAnimationTransition.Create(AStartBitmap, AEndBitmap,
        350 div RowCount, AAnimationMode, ateLinear,
        AEndBitmap.Height div RowCount);
...
procedure TdxInRibbonGalleryControlViewInfo.DrawBackground(ACanvas: TcxCanvas;
  const R: TRect);
begin
...
function TdxInRibbonGalleryControlViewInfo.GetLayoutWidth(AColumnCount: Integer;
  out AGroupItemWidthIsNull: Boolean): Integer;
begin
  Result := AColumnCount * GetMaxGroupItemSize.cx + (AColumnCount - 1) *
    GetSpaceBetweenItems(True) + GetControlMargins.Left +
    GetControlMargins.Right;
...
begin
  ...
  begin
    ...
    begin
      ...
      Result.cy := (AHeight - GetSpaceBetweenItems(False) * (ARowCount - 1) -
        AIndent) div ARowCount;
...
begin
  ...
  AGroupItemsList := TObjectList.Create(False);
  try
    PopulateGroupItemList(FTopVisibleRow, FTopVisibleRow + (RowCount - 1),
      AColumnCount, AGroupItemsList);
...
begin
  ...
  begin
    ...
    FControlHeight := ARibbonBarPainter.GetGroupRowCount *
      ARibbonBarPainter.GetGroupRowHeight
      (Control.BarManager.ImageOptions.GlyphSize);
...
begin
  Result := (ARowDelta < 0) and GetPreviousButtonEnabled or (ARowDelta > 0) and
    GetNextButtonEnabled;
end;

procedure TdxInRibbonGalleryControlViewInfo.PopulateGroupItemList
  (AFirstVisibleRow, ALastVisibleRow, AColumnCount: Integer;
  AList: TObjectList);
...
begin
  ...
  begin
    while (J < GetGroupItemCount(I)) and
...
begin
  ...
  begin
    ...
    begin
      ...
      if -FLayoutOffset + GetGalleryHeight(AGallerySize.cx) < AGalleryVisibleHeight
      then
  ...
  begin
    ...
    begin
      ...
      AGroupBottom := ACurrentGroupTop + AGroupViewInfo.GetHeight
        (AGallerySize.cx) + GalleryOptions.SpaceBetweenGroups;
      AIsIntersected := AreLinesIntersectedStrictly(ACurrentGroupTop,
        AGroupBottom, AGalleryBounds.Top, AGalleryBounds.Bottom);
      if (AMode = 0) and AIsIntersected or (AMode = 1) and not AIsIntersected
      then
        Inc(AMode);
      if AMode = 1 then
      begin
        AGroupViewInfo.Calculate(ACurrentGroupTop, AGroupBottom,
          AGalleryBounds);
        FGroups.Add(AGroupViewInfo);
      end
      else
...
begin
  if Control.UseRightToLeftAlignment then
    APosition := Point(FFilterBandContentRect.Right -
      GroupHeaderCaptionOffset div 2 - FilterMenuLeftBoundCorrection,
      FFilterBandRect.Bottom)
  else
    APosition := Point(FFilterBandContentRect.Left +
      GroupHeaderCaptionOffset div 2 + FilterMenuLeftBoundCorrection,
      FFilterBandRect.Bottom);
...
begin
  ...
  begin
    ...
    case RelativeLocationOfLines(AGroupItemTop, AGroupItemBottom,
      ...
      rllBefore:
        MoveLayoutDown(AAbsoluteGroupItemTop, AAbsoluteGroupItemBottom,
          AGroupItem.Group.Index);
      rllInside:
        DisplayGroupHeaderIfPossible(AAbsoluteGroupItemBottom,
          AGroupItem.Group.Index);
      rllAfter:
...
procedure TdxRibbonOnMenuGalleryControlViewInfo.DrawBackground
...
begin
  if FGroupItemDescriptionRectCache <> nil then
    Result := TcxRect(TObjectList(FGroupItemDescriptionRectCache[AGroupIndex])
      .Items[AnItemIndex]).Rect
  else
    Result := cxNullRect;
end;
...
begin
  ...
  Result := Max(Result + cxMarginsHeight(GetGalleryMargins),
    Control.CalcMinHeight);
end;
...
procedure TdxRibbonOnMenuGalleryControlViewInfo.GroupItemYRange(const AGroupItem
  : TdxRibbonGalleryGroupItem; var ATop, ABottom: Integer);
var
  AGroupViewInfo: TdxRibbonGalleryGroupViewInfo;
  ADestroyAfterUse: Boolean;
  AGallerySize: TSize;
begin
  AGallerySize := GallerySize;
  ATop := -FLayoutOffset + GetAbsoluteGroupTop(AGroupItem.Group.Index,
    AGallerySize.cx);
  AGroupViewInfo := GetGroupViewInfo(Control.GetGroups, Self, AGroupItem.Group.
    Index, ADestroyAfterUse);
  try
    { if ADestroyAfterUse then
      AGroupViewInfo.SetBounds(GalleryBounds); }
    ATop := AGroupViewInfo.GetRowTop(AGroupViewInfo.GetItemRow(AGroupItem.Index,
      AGallerySize.cx), ATop, AGallerySize.cx);
...
function TdxRibbonOnMenuGalleryControlViewInfo.
  InternalGetScrollBarWidth: Integer;
begin
...
begin
  if FGroupItemDescriptionRectCache = nil then
    InitializeGroupItemDescriptionRectCache;
  TcxRect(TObjectList(FGroupItemDescriptionRectCache[AGroupIndex])
    .Items[AnItemIndex]).Rect := ARect;
end;
...
begin
  ...
  begin
    ...
    if NeedsDrawSeparator(ilpBeforeGallery) then
      FFilterBandRect := cxRectOffsetVert(FFilterBandRect,
        GetBottomSeparatorHeight);
    FFilterBandContentRect := cxRectContent(FFilterBandRect,
      Painter.DropDownGalleryGetContentOffsets(DXBAR_GALLERYFILTERBAND));
    if Control.UseRightToLeftAlignment then
      FFilterBandContentRect := TdxRightToLeftLayoutConverter.ConvertRect
...
begin
  ...
  begin
    FillRectByColor(Control.Canvas.Handle, cxRectInflate(FFilterBandRect, 0, 0,
      0, FilterBandOffset), Painter.DropDownGalleryGetFilterBandSeparatorColor);
    Painter.DropDownGalleryDrawFilterBand(Control.Canvas.Handle,
      FFilterBandRect);
    DrawFilterCaption;
  end;
end;
...
procedure TdxRibbonOnMenuGalleryControlViewInfo.DrawFilterCaption;
  ...
  begin
    if FFilterBandHotTrack and not TdxRibbonOnSubmenuGalleryController
      (Control.Controller).IsFilterMenuShowed then
      Result := DXBAR_HOT
    else
      Result := DXBAR_NORMAL;
  end;
...
begin
  ...
  ACanvas.Font.Color := Painter.DropDownGalleryGetFilterBandTextColor
    (GetFilterSkinState);
  ...
  cxDrawText(ACanvas.Handle, ACaption, ACaptionRect,
    GetDrawTextFlags + DT_CALCRECT);
  AArrowRect := cxRectBounds(ACaptionRect.Right + AArrowOffset,
    FFilterBandContentRect.Top + (cxRectHeight(FFilterBandContentRect) -
    AArrowSize) div 2, AArrowSize * 2 - 1, AArrowSize);
  if Control.UseRightToLeftAlignment then
  begin
    ACaptionRect := TdxRightToLeftLayoutConverter.ConvertRect(ACaptionRect,
      FFilterBandContentRect);
    AArrowRect := TdxRightToLeftLayoutConverter.ConvertRect(AArrowRect,
      FFilterBandContentRect);
  end;
  cxDrawText(ACanvas, ACaption, ACaptionRect, GetDrawTextFlags);
  cxLookAndFeelPaintersManager.GetPainter(lfsStandard)
    .CalculateArrowPoints(AArrowRect, P, adDown, False, AArrowSize);
  ACanvas.SetBrushColor(ACanvas.Font.Color);
  ACanvas.Pen.Color := ACanvas.Font.Color;
  ACanvas.Polygon(P);
end;

function TdxRibbonOnMenuGalleryControlViewInfo.GetBottomSeparatorHeight
  : Integer;
begin
...
begin
  Result := TdxTextMeasurer.TextLineHeight(Control.Parent.Font) +
    cxMarginsHeight(Painter.DropDownGalleryGetContentOffsets
...
begin
  if (Control.GetGroups[AGroupIndex].Options.RemoveHorizontalItemPadding and
    AIsFlat) or (Control.GetGroups[AGroupIndex]
    .Options.RemoveVerticalItemPadding and not AIsFlat) then
    Result := 0
  else
...
procedure TdxRibbonOnMenuGalleryControlViewInfo.
  InitializeGroupItemDescriptionRectCache;
  ...
  begin
    Result := False;
    for I := 0 to GalleryItem.GalleryGroups.Count - 1 do
      if GalleryItem.GalleryGroups[I].Options.ItemTextKind = itkCaptionAndDescription
      then
      begin
        Result := True;
        Break;
...
begin
  if (GalleryOptions.ItemTextKind <> itkCaptionAndDescription) and not IsGroupsWithDescription
  then
    Exit;
...
function TdxRibbonOnMenuGalleryControlViewInfo.NeedsDrawSeparator
  ...
  begin
    ...
    if APositionInDropDown = ilpBeforeGallery then
      Result := (AControl.Resizing <> gsrNone) and
        not AControl.IsSizingBandAtBottom
    else
    ...
    begin
      ...
      for I := 0 to AItemLinks.VisibleItemCount - 1 do
        if (AItemLinks.VisibleItems[I] is TdxRibbonGalleryItemBarItemLink) and
          (TdxRibbonGalleryItemBarItemLink(AItemLinks.VisibleItems[I])
          .PositionInDropDown = APositionInDropDown) then
          Exit(True);
    end;
  end;
  ...
  begin
    ...
    begin
      ...
      if AVisibleIndex < 0 then
        Result := False
      else if APositionInDropDown = ilpBeforeGallery then
        Result := AVisibleIndex > 0
      else
        Result := (AVisibleIndex + 1 <= AItemLinks.VisibleItemCount - 1) and
          not(AItemLinks.VisibleItems[AVisibleIndex + 1]
          .Item is TdxCustomRibbonGalleryItem);
    end;
  end;

begin
  if (Control.Parent is TdxRibbonDropDownGalleryControl) and
    (TdxRibbonDropDownGalleryControl(Control.Parent).GalleryItem = GalleryItem)
  then
...
begin
  ...
  if not Control.Collapsed then
    ...
    begin
      ...
      case AKey of
        VK_DOWN:
          OnSubmenuController.Navigation(andDown);
        VK_LEFT:
          OnSubmenuController.Navigation(andLeft);
        VK_RIGHT:
          OnSubmenuController.Navigation(andRight);
        VK_UP:
          OnSubmenuController.Navigation(andUp);
        VK_TAB:
          OnSubmenuController.Tabulation;
        VK_PRIOR:
          OnSubmenuController.PageUp;
        VK_NEXT:
          OnSubmenuController.PageDown;
        VK_HOME:
...
function TdxRibbonGalleryControlAccessibilityHelper.GetControl
  : TdxRibbonGalleryControl;
begin
  Result := TdxRibbonGalleryControl(FOwnerObject);
end;

function TdxRibbonGalleryControlAccessibilityHelper.GetOnSubmenuController
  : TdxRibbonOnSubmenuGalleryController;
begin
...
function TdxRibbonDropDownGalleryControlAccessibilityHelper.HandleNavigationKey
  ...
  begin
    TdxBarItemLinksAccess(ItemLinks).Last.Control.IAccessibilityHelper.Select
      (AKey = VK_TAB);
  end;
    ...
    case AKey of
      ...
      VK_NEXT:
        begin
          InternalGalleryItemControlAccessibilityHelper.Select(False);
          TdxRibbonOnSubmenuGalleryController
            (BarControl.InternalGalleryItemControl.Controller).PageDown;
        end;
    end;
  end
  else
...
procedure TdxRibbonDropDownGalleryControlAccessibilityHelper.
  HandleVertNavigationKey(AUpKey, AFocusItemControl: Boolean);
begin
  if AUpKey and (BarControl.SelectedLink = TdxBarItemLinksAccess(ItemLinks)
    .First) or not AUpKey and
    (BarControl.SelectedLink = TdxBarItemLinksAccess(ItemLinks).Last) then
  begin
...
function TdxRibbonDropDownGalleryControlAccessibilityHelper.GetBarControl
  : TdxRibbonDropDownGalleryControl;
begin
  Result := TdxRibbonDropDownGalleryControl(FOwnerObject);
end;

function TdxRibbonDropDownGalleryControlAccessibilityHelper.
  GetInternalGalleryItemControlAccessibilityHelper
  : TdxRibbonGalleryControlAccessibilityHelper;
begin
  Result := TdxRibbonGalleryControlAccessibilityHelper
...
begin
  ...
  PartInfo[sbpLineDown].Bounds :=
    cxRectBounds(0, PartInfo[sbpLineUp].Bounds.Bottom, AWidth,
    AArrowButtonHeight);
  CalculateThumbnailRect;
  FDropDownButtonRect := Rect(0, PartInfo[sbpLineDown].Bounds.Bottom,
    AWidth, AHeight);
end;
...
procedure TdxRibbonGalleryScrollBarPainter.Paint(ACanvas: TcxCanvas);
  ...
  begin
    Result := ScrollBar.IsDropDownButtonUnderMouse or
      (BarNavigationController.SelectedObject <> nil) and
      (BarNavigationController.SelectedObject.GetHelper = GetGalleryControl.
  ...
  begin
    if not ScrollBar.Enabled then
      Result := cxbsDisabled
    else if IsDropDownButtonHot then
      Result := cxbsHot
    else
      Result := cxbsNormal;
  end;
...
begin
  ...
  begin
    ScrollBar.GetRibbonSkin.DrawBackground(ACanvas.Handle,
      ViewInfo.DropDownButtonRect, PartID[ScrollBar.IsTouchMode],
      ScrollBar.GetButtonSkinState(GetDropDownButtonState));
  end;

  if (GetGalleryControl <> nil) and TdxBarItemLinkAccess
    (GetGalleryControl.ItemLink).IsComponentSelected then
  begin
    R := ViewInfo.Bounds;
    Dec(R.Left, 2);
  ...
  begin
    ...
    begin
      if not ScrollBar.IsButtonEnabled(GetButtonKind) then
        AState := cxbsDisabled;
      ScrollBar.GetRibbonSkin.DrawBackground(ACanvas.Handle, R,
        GetButtonSkinPart, ScrollBar.GetButtonSkinState(AState));
    end;
  end
  else
    ScrollBar.GetBarPainter.DropDownGalleryDrawScrollBarPartEx
      (GetGalleryControl, ACanvas.Handle, R, APart, AState, ScaleFactor);
end;
...
begin
  if ScrollBar.IsDropDownStyle then
  begin
    if ScrollBar.GetRibbonSkin.GetIsAlphaUsed
      (DXBAR_INRIBBONGALLERYSCROLLBAR_BACKGROUND) then
      cxDrawTransparentControlBackground(ScrollBar.FRibbonScrollBar, ACanvas,
        R, False);
    ScrollBar.GetRibbonSkin.DrawBackground(ACanvas.Handle, R,
      DXBAR_INRIBBONGALLERYSCROLLBAR_BACKGROUND);
  end
  else
    ScrollBar.GetBarPainter.DropDownGalleryDrawScrollBarBackgroundEx
      (GetGalleryControl, ACanvas.Handle, R, ScaleFactor);
end;

function TdxRibbonGalleryScrollBarPainter.GetGalleryControl
  : TdxRibbonGalleryControl;
begin
  Result := ScrollBar.GalleryControl;
end;

function TdxRibbonGalleryScrollBarPainter.GetScrollBar
  : TdxRibbonGalleryScrollBarHelper;
begin
  Result := TdxRibbonGalleryScrollBarHelper(inherited ScrollBar);
end;

function TdxRibbonGalleryScrollBarPainter.GetViewInfo
  : TdxRibbonGalleryScrollBarViewInfo;
begin
...
begin
  ...
  FRibbonScrollBar := AComponentReference.GetComponent as
    TdxRibbonGalleryScrollBar;
end;

procedure TdxRibbonGalleryScrollBarHelper.MouseDown(Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
begin
...
function TdxRibbonGalleryScrollBarHelper.GetPainterClass
  : TcxScrollBarPainterClass;
begin
  Result := TdxRibbonGalleryScrollBarPainter;
end;

function TdxRibbonGalleryScrollBarHelper.GetViewInfoClass
  : TcxScrollBarViewInfoClass;
begin
...
function TdxRibbonGalleryScrollBarHelper.GetButtonSkinState
...
function TdxRibbonGalleryScrollBarHelper.IsButtonEnabled
...
begin
  ...
  Result := (APainter is TdxRibbonBarPainter) and TdxRibbonBarPainter(APainter)
    .IsSimplifiedGroupsLayout;
end;

function TdxRibbonGalleryScrollBarHelper.GetGalleryControl
  : TdxRibbonGalleryControl;
begin
...
constructor TdxRibbonGalleryScrollBar.Create(AGalleryControl
  : TdxRibbonGalleryControl);
var
  ASkinName: string;
begin
...
begin
  Result := (Parent <> nil) and
    (TCustomdxBarControl(Parent).Kind = bkBarControl);
end;
...
constructor TdxRibbonDropDownGalleryControlPainter.Create
  (APainter: TdxBarPainter);
begin
  FPainter := APainter;
end;
...
begin
  ...
  begin
    AButtonHeight := Painter.DropDownGalleryGetSizingBandHeight
      (AGalleryControl.BarManager.ImageOptions.GlyphSize,
      TdxTextMeasurer.TextLineHeight(AGalleryControl.Font),
...
function TdxRibbonDropDownGalleryControlPainter.PtInSizingArea(AGalleryControl
  : TdxRibbonDropDownGalleryControl; const P: TPoint): Boolean;
var
  AOffsetX: Integer;
  R: TRect;
begin
    ...
    case AGalleryControl.Resizing of
      gsrHeight:
        begin
          ...
          R.Top := R.Bottom - (GetSizingBandHeight(AGalleryControl) +
            Painter.DropDownGalleryGetNCBorderSize);
          Result := PtInRect(R, P);
        end;
      gsrWidthAndHeight:
        begin
          if AGalleryControl.UseRightToLeftAlignment then
            ...
            AOffsetX := P.X -
              (AGalleryControl.Width - GetSizingBandHeight(AGalleryControl));
  ...
  begin
    case AGalleryControl.Resizing of
      gsrHeight:
        begin
          R := Rect(0, 0, AGalleryControl.Width, AGalleryControl.Height);
          R.Bottom := R.Top + (GetSizingBandHeight(AGalleryControl) +
            Painter.DropDownGalleryGetNCBorderSize);
          Result := PtInRect(R, P);
        end;
      gsrWidthAndHeight:
        begin
          if AGalleryControl.UseRightToLeftAlignment then
            ...
            AOffsetX := P.X -
              (AGalleryControl.Width - GetSizingBandHeight
              (AGalleryControl) - 1);
...
procedure TdxRibbonDropDownGalleryControlPainter.SubMenuControlDrawBorder
  ...
  procedure DrawBottomSizingBand(ADropDownGallery
    : TdxRibbonDropDownGalleryControl; DC: HDC; R: TRect);
  begin
  ...
  procedure DrawTopSizingBand(ADropDownGallery: TdxRibbonDropDownGalleryControl;
    DC: HDC; R: TRect);
  begin
...
function TdxRibbonDropDownGalleryControlPainter.HasSizingBand(AGalleryControl
  : TdxRibbonDropDownGalleryControl): Boolean;
begin
...
// IdxGestureClient
function TdxRibbonDropDownGalleryControl.AllowGesture
  (AGestureId: Integer): Boolean;
begin
  Result := (GetInteractiveGestureByGestureID(AGestureId)
    in Touch.InteractiveGestures);
end;

function TdxRibbonDropDownGalleryControl.AllowPan
...
procedure TdxRibbonDropDownGalleryControl.GestureScroll(ADeltaX,
  ADeltaY: Integer);
var
  ANewPos: Integer;
begin
  ANewPos := InternalGalleryItemControl.ScrollBar.Position - ADeltaY;
  FGestureHelper.CheckOverpan(InternalGalleryItemControl.ScrollBar.Kind,
    ANewPos, 0, InternalGalleryItemControl.GetScrollBarMaxPos, ADeltaX,
    ADeltaY);
  ANewPos := EnsureRange(ANewPos, 0,
    InternalGalleryItemControl.GetScrollBarMaxPos);
...
function TdxRibbonDropDownGalleryControl.IsPanArea(const APoint
  : TPoint): Boolean;
begin
  Result := PtInRect(InternalGalleryItemControl.ViewInfo.GalleryBounds, APoint);
end;

function TdxRibbonDropDownGalleryControl.NeedPanningFeedback
  (AScrollKind: TScrollBarKind): Boolean;
begin
  Result := True;
end;

function TdxRibbonDropDownGalleryControl.GetGestureClient(const APoint: TPoint)
  : IdxGestureClient;
begin
  Result := Self;
end;
...
function TdxRibbonDropDownGalleryControl.IsGestureTarget(AWnd: THandle)
  : Boolean;
begin
  Result := AWnd = Handle;
end;

procedure TdxRibbonDropDownGalleryControl.DoGesture(const EventInfo
  : TGestureEventInfo; var Handled: Boolean);
begin
  FGestureHelper.DoGesture(EventInfo, Handled);
end;

procedure TdxRibbonDropDownGalleryControl.DoGetGestureOptions
...
function TdxRibbonDropDownGalleryControl.GetDefaultInteractiveGestures
...
function TdxRibbonDropDownGalleryControl.GetDefaultInteractiveGestureOptions
  : TInteractiveGestureOptions;
begin
  Result := GetInteractiveGestureOptionsByPanOptions(GetDefaultPanOptions);
end;

function TdxRibbonDropDownGalleryControl.IsTouchPropertyStored
...
function TdxRibbonDropDownGalleryControl.IsDefaultGesture
  (AGestureId: Integer): Boolean;
begin
...
var
  AGalleryHeight, AGalleryTop, ATopItemIndex, ABottomItemIndex, APos,
    I: Integer;
...
begin
  ...
  InternalGalleryItemLink.ItemRect := cxRectSetTop(VisibleItemsRect,
    AGalleryTop, AGalleryHeight);
...
begin
  Result := False;
  ASize := cxNullSize;
  if InternalGalleryItemControl.Item.GalleryOptions.SubmenuResizing = gsrNone
  then
  begin
    ...
    if (InternalGalleryItemControl.GetDefaultWidthInSubMenu > Width) and
      (Screen.Width > Width + InternalGalleryItemControl.ViewInfo.
...
begin
  if FGalleryItemBarItemLinks = nil then
    FGalleryItemBarItemLinks := TdxRibbonDropDownGalleryGalleryItemBarItemLinks.
      Create(BarManager, TdxBarItemLinksAccess(ItemLinks).LinksOwner);
...
procedure TdxRibbonDropDownGalleryControl.DoNCPaint(DC: HDC;
  const ARect: TRect);
begin
...
function TdxRibbonDropDownGalleryControl.GetAccessibilityHelperClass
  : TdxBarAccessibilityHelperClass;
begin
...
begin
  Result := Painter.DropDownGalleryGetNCBorderSize +
    Painter.DropDownGalleryGetClientBorderSize;
end;

function TdxRibbonDropDownGalleryControl.GetClientOffset(AIncludeDetachCaption
  : Boolean = True): TRect;
var
  AOffset: Integer;
begin
...
function TdxRibbonDropDownGalleryControl.GetViewInfoClass
...
function TdxRibbonDropDownGalleryControl.IsControlExists(ABarItemControl
  : TdxBarItemControl): Boolean;
begin
...
procedure TdxRibbonDropDownGalleryControl.MouseMove(Shift: TShiftState;
  X, Y: Integer);
begin
  if IsResizing then
    DoResizing
...
function TdxRibbonDropDownGalleryControl.
  NeedsSelectFirstItemOnDropDownByKey: Boolean;
begin
  Result := False;
end;
...
procedure TdxRibbonDropDownGalleryControl.UpdateItem
  (AControl: TdxBarItemControl);
begin
...
procedure TdxRibbonDropDownGalleryControl.DoResizing;
  ...
  begin
    ...
    if cxRectHeight(ANewRect) < AMinSize.cy then
      if DontChangeOrigin or UseRightToLeftAlignment and
        not(FResizingState in [grsTopRight, grsTop]) then
...
begin
  ...
  case FResizingState of
    ...
    grsBottomRight:
      if UseRightToLeftAlignment then
        SetSize(Rect(P.X + FMouseResizingDelta.X, R.Top, R.Right,
          P.Y + FMouseResizingDelta.Y), False)
      else
        SetSize(Rect(R.Left, R.Top, P.X + FMouseResizingDelta.X,
          P.Y + FMouseResizingDelta.Y), True);
    grsTop:
      SetSize(Rect(R.Left, P.Y + FMouseResizingDelta.Y, R.Right,
        R.Bottom), False);
    grsTopRight:
      if UseRightToLeftAlignment then
        SetSize(Rect(P.X + FMouseResizingDelta.X, P.Y + FMouseResizingDelta.Y,
          R.Right, R.Bottom), False)
      else
        SetSize(Rect(R.Left, P.Y + FMouseResizingDelta.Y,
          P.X + FMouseResizingDelta.X, R.Bottom), False);
  end;
  UpdateWindow(Handle);
end;

function TdxRibbonDropDownGalleryControl.GetInternalGalleryItemControl
  : TdxRibbonGalleryControl;
begin
  Result := TdxRibbonGalleryControl(FGalleryItemBarItemLinks[0].Control);
end;

function TdxRibbonDropDownGalleryControl.GetInternalGalleryItemLink
  : TdxBarItemLink;
begin
  Result := FGalleryItemBarItemLinks[0];
end;

function TdxRibbonDropDownGalleryControl.GetInternalPainter
  : TdxRibbonDropDownGalleryControlPainter;
begin
...
function TdxRibbonDropDownGalleryControl.GetResizing
  : TdxRibbonGalleryDropDownResizing;
begin
...
function TdxRibbonDropDownGalleryControl.HitTestToResizingState
  : TdxDropDownGalleryResizingState;
begin
  case FHitTest of
    HTTOP:
      Result := grsTop;
    HTTOPRIGHT, HTTOPLEFT:
      Result := grsTopRight;
    HTBOTTOM:
      Result := grsBottom;
    HTBOTTOMRIGHT, HTBOTTOMLEFT:
      Result := grsBottomRight;
  else
    Result := grsNone;
  end;
end;
...
procedure TdxRibbonDropDownGalleryControl.WMGetMinMaxInfo
...
procedure TdxRibbonDropDownGalleryControl.WMNCHitTest
  (var Message: TWMNCHitTest);
const
  ANCHitTestConsts: array [Boolean, gsrHeight .. gsrWidthAndHeight]
    of Longint = ((HTTOP, HTTOPRIGHT), (HTBOTTOM, HTBOTTOMRIGHT));
  ANCHitTestConstsRTL: array [Boolean, gsrHeight .. gsrWidthAndHeight]
    of Longint = ((HTTOP, HTTOPLEFT), (HTBOTTOM, HTBOTTOMLEFT));
begin
  inherited;
...
procedure TdxRibbonDropDownGalleryControl.WMLButtonDown
...
procedure TdxRibbonDropDownGalleryControl.WMLButtonUp
...
procedure TdxRibbonDropDownGalleryControl.WMSetCursor
...
begin
  ...
  IdxBarItemControlViewInfo(AGalleryItemControl.ViewInfo)
    .SetBounds(BarControl.GetItemRect(AGalleryItemControl));
end;

function TdxRibbonDropDownGalleryControlViewInfo.GetBarControl
  : TdxRibbonDropDownGalleryControl;
begin
...
RegisterClasses([TdxRibbonDropDownGallery, TdxRibbonGalleryGroupItem,
  TdxRibbonGalleryGroup]);
