...
procedure dxBarConvertPopupMenu(APopupMenu: TPopupMenu;
  ABarPopupMenu: TdxBarCustomPopupMenu);
...
procedure ConvertItems(ABarManager: TdxBarManager; AItemLinks: TdxBarItemLinks;
  ...
  function AddItem(AItem: TMenuItem; AItemLinks: TdxBarItemLinks;
    ACategory: Integer): TdxBarItemLink;
  var
    ABarItem: TdxBarItem;
    AIsSubItem: Boolean;
    AItemName: string;
  begin
    ...
    begin
      ...
      ConvertItems(ABarManager, TdxBarSubItem(ABarItem).ItemLinks, AItem,
        AddCategory(ABarManager, GetTextOf(AItem.Caption)))
    end
    else
    begin
...
begin
  ...
  try
    ConvertItems(ABarManager, AItemLinks, AMenu.Items,
      AddCategory(ABarManager, AMenu.Name));
  finally
...
begin
  ...
  try
    ConvertItems(ABarPopupMenu.BarManager, AItemLinks, APopupMenu.Items,
      AddCategory(ABarPopupMenu.BarManager, APopupMenu.Name));
  finally
