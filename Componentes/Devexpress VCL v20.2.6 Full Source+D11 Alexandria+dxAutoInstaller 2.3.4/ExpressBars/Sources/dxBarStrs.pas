...
resourcestring
  ...
  dxSBAR_ONEOFTOOLBARSALREADYMERGED =
    'One of the toolbars of the specified bar manager is already merged';
  dxSBAR_ONEOFTOOLBARSHASMERGEDTOOLBARS =
  ...
  dxSBAR_TOOLBARSALREADYMERGED =
    'The ''%s'' toolbar is already merged with the ''%s'' toolbar';
  dxSBAR_TOOLBARSARENOTMERGED =
  ...
  dxSBAR_RIBBONCANTMERGEWITHOUTBARMANAGER =
  ...
  // is the same as dxSBAR_CP_NAME (at design time)
  ...
  dxSBAR_CANTFINDBARMANAGERFORSTATUSBAR =
  ...
  sdxRibbonCustomizationFormAddErrorMsg =
    'Commands need to be added to custom groups. ' +
  ...
  sdxRibbonCustomizationFormCaptionQuickAccessToolbar =
    'Customize &Quick Access Toolbar:';
  sdxRibbonCustomizationFormCaptionQuickAccessToolbarShowBelowRibbon =
    'Show Quick Access Toolbar below the Ribbon';
  sdxRibbonCustomizationFormCaptionQuickAccessToolbarTitle =
  ...
  sdxRibbonCustomizationFormCaptionResetAllCustomizations =
    'Reset a&ll customizations';
  sdxRibbonCustomizationFormCaptionResetOnlySelectedTab =
...
begin
  ...
  InternalAdd('dxSBAR_CXEDITVALUEDIALOGCAPTION',
    @dxSBAR_CXEDITVALUEDIALOGCAPTION);
  ...
  InternalAdd('dxSBAR_COMMANDNAMECANNOTBEBLANK',
    @dxSBAR_COMMANDNAMECANNOTBEBLANK);
  InternalAdd('dxSBAR_TOOLBAREXISTS', @dxSBAR_TOOLBAREXISTS);
  InternalAdd('dxSBAR_RECURSIVEGROUPS', @dxSBAR_RECURSIVEGROUPS);
  InternalAdd('dxSBAR_WANTTODELETECOMPLEXITEM',
    @dxSBAR_WANTTODELETECOMPLEXITEM);
  InternalAdd('dxSBAR_CANTPLACEQUICKACCESSGROUPBUTTON',
    @dxSBAR_CANTPLACEQUICKACCESSGROUPBUTTON);
  InternalAdd('dxSBAR_QUICKACCESSGROUPBUTTONTOOLBARNOTDOCKEDINRIBBON',
    @dxSBAR_QUICKACCESSGROUPBUTTONTOOLBARNOTDOCKEDINRIBBON);
  InternalAdd('dxSBAR_QUICKACCESSALREADYHASGROUPBUTTON',
    @dxSBAR_QUICKACCESSALREADYHASGROUPBUTTON);
  ...
  InternalAdd('dxSBAR_CANTPLACESKINCHOOSERGALLERY',
    @dxSBAR_CANTPLACESKINCHOOSERGALLERY);
  ...
  InternalAdd('dxSBAR_CANTMERGEWITHMERGEDTOOLBAR',
    @dxSBAR_CANTMERGEWITHMERGEDTOOLBAR);
  InternalAdd('dxSBAR_CANTUNMERGETOOLBAR', @dxSBAR_CANTUNMERGETOOLBAR);
  InternalAdd('dxSBAR_ONEOFTOOLBARSALREADYMERGED',
    @dxSBAR_ONEOFTOOLBARSALREADYMERGED);
  InternalAdd('dxSBAR_ONEOFTOOLBARSHASMERGEDTOOLBARS',
    @dxSBAR_ONEOFTOOLBARSHASMERGEDTOOLBARS);
  InternalAdd('dxSBAR_TOOLBARHASMERGEDTOOLBARS',
    @dxSBAR_TOOLBARHASMERGEDTOOLBARS);
  ...
  InternalAdd('dxSBAR_RIBBONCANTMERGEWITHOUTBARMANAGER',
    @dxSBAR_RIBBONCANTMERGEWITHOUTBARMANAGER);
  ...
  InternalAdd('dxSBAR_RIBBONONEOFTABGROUPSALREADYMERGED',
    @dxSBAR_RIBBONONEOFTABGROUPSALREADYMERGED);
  ...
  InternalAdd('dxSBAR_RIBBONFORM_DISPLAYOPTIONS',
    @dxSBAR_RIBBONFORM_DISPLAYOPTIONS);
  ...
  InternalAdd('dxSBAR_RIBBONDISPLAYOPTIONS_AUTOHIDERIBBON_CAPTION',
    @dxSBAR_RIBBONDISPLAYOPTIONS_AUTOHIDERIBBON_CAPTION);
  InternalAdd('dxSBAR_RIBBONDISPLAYOPTIONS_AUTOHIDERIBBON_DESCRIPTION',
    @dxSBAR_RIBBONDISPLAYOPTIONS_AUTOHIDERIBBON_DESCRIPTION);
  InternalAdd('dxSBAR_RIBBONDISPLAYOPTIONS_SHOWTABS_CAPTION',
    @dxSBAR_RIBBONDISPLAYOPTIONS_SHOWTABS_CAPTION);
  InternalAdd('dxSBAR_RIBBONDISPLAYOPTIONS_SHOWTABS_DESCRIPTION',
    @dxSBAR_RIBBONDISPLAYOPTIONS_SHOWTABS_DESCRIPTION);
  InternalAdd('dxSBAR_RIBBONDISPLAYOPTIONS_SHOWTABSANDCOMMANDS_CAPTION',
    @dxSBAR_RIBBONDISPLAYOPTIONS_SHOWTABSANDCOMMANDS_CAPTION);
  InternalAdd('dxSBAR_RIBBONDISPLAYOPTIONS_SHOWTABSANDCOMMANDS_DESCRIPTION',
    @dxSBAR_RIBBONDISPLAYOPTIONS_SHOWTABSANDCOMMANDS_DESCRIPTION);
  ...
  InternalAdd('dxSBAR_NEWRIBBONGALLERYITEMCAPTION',
  ...
  InternalAdd('dxSBAR_CP_BUTTONPAINTSTYLEMENU',
    @dxSBAR_CP_BUTTONPAINTSTYLEMENU);
  ...
  InternalAdd('dxSBAR_CP_SINGLEVIEWLEVELITEMSUFFIX',
    @dxSBAR_CP_SINGLEVIEWLEVELITEMSUFFIX);
  ...
  InternalAdd('dxSBAR_GALLERYEMPTYFILTERCAPTION',
    @dxSBAR_GALLERYEMPTYFILTERCAPTION);
  InternalAdd('dxSBAR_PIN', @dxSBAR_PIN);
  InternalAdd('dxSBAR_UNPIN', @dxSBAR_UNPIN);
  InternalAdd('dxSBAR_GALLERYITEMLINKPOSITIONINDROPDOWN',
    @dxSBAR_GALLERYITEMLINKPOSITIONINDROPDOWN);
  ...
  InternalAdd('dxSBAR_SHOWFULLMENUSAFTERDELAY',
    @dxSBAR_SHOWFULLMENUSAFTERDELAY);
  ...
  InternalAdd('dxSBAR_CANTFINDBARMANAGERFORSTATUSBAR',
    @dxSBAR_CANTFINDBARMANAGERFORSTATUSBAR);
  InternalAdd('dxSBAR_BUTTONDEFAULTACTIONDESCRIPTION',
  ...
  InternalAdd('dxSBAR_RIBBONADDGROUPWITHTOOLBAR',
    @dxSBAR_RIBBONADDGROUPWITHTOOLBAR);
  InternalAdd('dxSBAR_RIBBONDELETEGROUP', @dxSBAR_RIBBONDELETEGROUP);
  InternalAdd('dxSBAR_ACCESSIBILITY_RIBBONNAME',
    @dxSBAR_ACCESSIBILITY_RIBBONNAME);
  InternalAdd('dxSBAR_ACCESSIBILITY_RIBBONTABCOLLECTIONNAME',
    @dxSBAR_ACCESSIBILITY_RIBBONTABCOLLECTIONNAME);

  InternalAdd('dxSBAR_RIBBON_QUICKACCESSTOOLBARNAME',
    @dxSBAR_RIBBON_QUICKACCESSTOOLBARNAME);
  InternalAdd('dxSBAR_RIBBON_TABAREASEARCHTOOLBARNAME',
    @dxSBAR_RIBBON_TABAREASEARCHTOOLBARNAME);
  InternalAdd('dxSBAR_RIBBON_TABAREATOOLBARNAME',
    @dxSBAR_RIBBON_TABAREATOOLBARNAME);

  InternalAdd('sdxRibbonCustomizationFormAddErrorMsg',
    @sdxRibbonCustomizationFormAddErrorMsg);
  InternalAdd('sdxRibbonCustomizationFormAllCommands',
    @sdxRibbonCustomizationFormAllCommands);
  InternalAdd('sdxRibbonCustomizationFormAllTabs',
    @sdxRibbonCustomizationFormAllTabs);
  InternalAdd('sdxRibbonCustomizationFormBeginGroup',
    @sdxRibbonCustomizationFormBeginGroup);
  InternalAdd('sdxRibbonCustomizationFormCommandsNotInTheRibbon',
    @sdxRibbonCustomizationFormCommandsNotInTheRibbon);
  InternalAdd('sdxRibbonCustomizationFormCustomElementSuffix',
    @sdxRibbonCustomizationFormCustomElementSuffix);
  InternalAdd('sdxRibbonCustomizationFormCustomGroups',
    @sdxRibbonCustomizationFormCustomGroups);
  InternalAdd('sdxRibbonCustomizationFormCustomTabsAndGroups',
    @sdxRibbonCustomizationFormCustomTabsAndGroups);
  InternalAdd('sdxRibbonCustomizationFormDelimiterContextTab',
    @sdxRibbonCustomizationFormDelimiterContextTab);
  InternalAdd('sdxRibbonCustomizationFormDisplayName',
    @sdxRibbonCustomizationFormDisplayName);
  InternalAdd('sdxRibbonCustomizationFormMainTabs',
    @sdxRibbonCustomizationFormMainTabs);
  InternalAdd('sdxRibbonCustomizationFormNewContext',
    @sdxRibbonCustomizationFormNewContext);
  InternalAdd('sdxRibbonCustomizationFormNewGroup',
    @sdxRibbonCustomizationFormNewGroup);
  InternalAdd('sdxRibbonCustomizationFormNewTab',
    @sdxRibbonCustomizationFormNewTab);
  InternalAdd('sdxRibbonCustomizationFormRename',
    @sdxRibbonCustomizationFormRename);
  InternalAdd('sdxRibbonCustomizationFormTabSuffix',
    @sdxRibbonCustomizationFormTabSuffix);
  InternalAdd('sdxRibbonCustomizationFormToolTabs',
    @sdxRibbonCustomizationFormToolTabs);

  InternalAdd('sdxRibbonCustomizationFormCaptionAdd',
    @sdxRibbonCustomizationFormCaptionAdd);
  InternalAdd('sdxRibbonCustomizationFormCaptionAddNewContext',
    @sdxRibbonCustomizationFormCaptionAddNewContext);
  InternalAdd('sdxRibbonCustomizationFormCaptionAddNewGroup',
    @sdxRibbonCustomizationFormCaptionAddNewGroup);
  InternalAdd('sdxRibbonCustomizationFormCaptionAddNewTab',
    @sdxRibbonCustomizationFormCaptionAddNewTab);
  InternalAdd('sdxRibbonCustomizationFormCaptionCancel',
    @sdxRibbonCustomizationFormCaptionCancel);
  InternalAdd('sdxRibbonCustomizationFormCaptionCommandsSource',
    @sdxRibbonCustomizationFormCaptionCommandsSource);
  InternalAdd('sdxRibbonCustomizationFormCaptionMoveDown',
    @sdxRibbonCustomizationFormCaptionMoveDown);
  InternalAdd('sdxRibbonCustomizationFormCaptionMoveUp',
    @sdxRibbonCustomizationFormCaptionMoveUp);
  InternalAdd('sdxRibbonCustomizationFormCaptionNewElement',
    @sdxRibbonCustomizationFormCaptionNewElement);
  InternalAdd('sdxRibbonCustomizationFormCaptionOK',
    @sdxRibbonCustomizationFormCaptionOK);
  InternalAdd('sdxRibbonCustomizationFormCaptionQuickAccessToolbar',
    @sdxRibbonCustomizationFormCaptionQuickAccessToolbar);
  InternalAdd
    ('sdxRibbonCustomizationFormCaptionQuickAccessToolbarShowBelowRibbon',
    @sdxRibbonCustomizationFormCaptionQuickAccessToolbarShowBelowRibbon);
  InternalAdd('sdxRibbonCustomizationFormCaptionQuickAccessToolbarTitle',
    @sdxRibbonCustomizationFormCaptionQuickAccessToolbarTitle);
  InternalAdd('sdxRibbonCustomizationFormCaptionRemove',
    @sdxRibbonCustomizationFormCaptionRemove);
  InternalAdd('sdxRibbonCustomizationFormCaptionRename',
    @sdxRibbonCustomizationFormCaptionRename);
  InternalAdd('sdxRibbonCustomizationFormCaptionReset',
    @sdxRibbonCustomizationFormCaptionReset);
  InternalAdd('sdxRibbonCustomizationFormCaptionResetAllCustomizations',
    @sdxRibbonCustomizationFormCaptionResetAllCustomizations);
  InternalAdd('sdxRibbonCustomizationFormCaptionResetOnlySelectedTab',
    @sdxRibbonCustomizationFormCaptionResetOnlySelectedTab);
  InternalAdd('sdxRibbonCustomizationFormCaptionResetSelectedTab',
    @sdxRibbonCustomizationFormCaptionResetSelectedTab);
  InternalAdd('sdxRibbonCustomizationFormCaptionRibbonTitle',
    @sdxRibbonCustomizationFormCaptionRibbonTitle);
  InternalAdd('sdxRibbonCustomizationFormCaptionRibbonSource',
    @sdxRibbonCustomizationFormCaptionRibbonSource);
  InternalAdd('sdxRibbonCustomizationFormCaptionShowTab',
    @sdxRibbonCustomizationFormCaptionShowTab);

  InternalAdd('sdxRibbonColorGalleryAutoColor',
    @sdxRibbonColorGalleryAutoColor);
  InternalAdd('sdxRibbonColorGalleryMoreColors',
    @sdxRibbonColorGalleryMoreColors);
  InternalAdd('sdxRibbonColorGalleryGroupCustomColors',
    @sdxRibbonColorGalleryGroupCustomColors);
  InternalAdd('sdxRibbonColorGalleryGroupStandardColors',
    @sdxRibbonColorGalleryGroupStandardColors);
  InternalAdd('sdxRibbonColorGalleryGroupThemeColors',
    @sdxRibbonColorGalleryGroupThemeColors);
end;

initialization

dxResourceStringsRepository.RegisterProduct('ExpressBars',
  @AddBarsResourceStringNames);
