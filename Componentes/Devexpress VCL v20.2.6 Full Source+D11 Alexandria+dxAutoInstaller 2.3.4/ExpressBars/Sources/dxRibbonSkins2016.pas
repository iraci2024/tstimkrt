...
{$IFDEF DELPHI16}
  System.UITypes,
{$ENDIF}
  Windows, Types, Classes, Graphics, dxCore, dxGDIPlusAPI, dxGDIPlusClasses,
  cxGraphics, cxGeometry,
  dxBarSkin, dxBarSkinConsts, cxLookAndFeelPainters, dxRibbonSkins,
  dxRibbonSkins2013;
...
type
  ...
  protected
    ...
    function GetBackstageViewBackButtonGlyphColor(AState: Integer)
      : TColor; override;
    ...
    function GetFormBorderIconGlyphColor(AIcon: TdxRibbonBorderDrawIcon;
      AState: TdxRibbonBorderIconState): TColor; override;
    function GetFormCaptionAreaColor(AApplicationMenuState
      : TdxRibbonApplicationMenuState; AActive: Boolean): TColor; override;
    ...
    function GetLaunchButtonDefaultGlyphColor(AState: Integer): TColor;
      override;
    function GetMasterColor: TColor; override;
    function GetMenuBackgroundColor: TColor; override;
    function GetMinimizeRibbonButtonGlyphColor(AState: Integer)
      : TColor; override;
  ...
  public
    ...
    procedure DrawQuickAccessToolbarArrowDown(DC: HDC; const R: TRect;
      AState: Integer; ABelow: Boolean); override;
    procedure DrawQuickAccessToolbarMark(DC: HDC; const R: TRect;
      AState: Integer; AStatesArray: TStatesArray);
  ...
  protected
    function DoGetPartColor(APart: Integer; AState: Integer = 0)
      : TColor; override;
    procedure DrawFormBorderIconButton(DC: HDC; const R: TRect;
      AState: Integer); virtual;
    procedure DrawTabBackground(DC: HDC; const R: TRect;
      AColor, ABorderColor: TColor); virtual;
    function GetColorfulButtonColor(AState: Integer): TColor; override;
  ...
  public
    ...
    procedure DrawMinimizeRibbonButton(DC: HDC; const R: TRect;
      AState: TcxButtonState; AMinimized: Boolean); override;
  ...
  public
    ...
    function GetScrollBarPartBorderColor(APart: TcxScrollBarPart;
      AState: Integer): TColor; override;
    function GetScrollBarPartContentColor(APart: TcxScrollBarPart;
      AState: Integer): TColor; override;
  end;
...
procedure TdxColorfulRibbon2016Skin.AdjustContextFont(AFont: TFont;
...
procedure TdxColorfulRibbon2016Skin.AdjustContextTabFont(AFont: TFont;
...
procedure TdxColorfulRibbon2016Skin.DrawApplicationButton(DC: HDC;
  const R: TRect; AState: TdxRibbonApplicationButtonState);
var
  AColor: TColor;
begin
  if LowColors then
...
procedure TdxColorfulRibbon2016Skin.DrawBackstageViewGalleryBackground(DC: HDC;
  const R: TRect);
begin
  if LowColors then
...
procedure TdxColorfulRibbon2016Skin.DrawBackstageViewGalleryItem(DC: HDC;
  const R: TRect; AState: Integer);
begin
  if LowColors then
    inherited DrawBackstageViewGalleryItem(DC, R, AState)
  else if AState in [DXBAR_CHECKED, DXBAR_HOTCHECK] then
    FillRectByColor(DC, R, GetPartColor(rspTabHeaderText, DXBAR_HOT))
  else
    DrawColorfulButton(DC, R, AState);
end;

procedure TdxColorfulRibbon2016Skin.DrawBackstageViewGalleryItemPinButton
...
procedure TdxColorfulRibbon2016Skin.DrawBackstageViewMenuSeparator(DC: HDC;
  const R: TRect; AState: Integer);
begin
  if LowColors then
    inherited DrawBackstageViewMenuSeparator(DC, R, AState)
  else
    FillRectByColor(DC, cxRectInflate(cxRectCenterVertically(R, 1), -15, 0),
      GetMinimizeRibbonButtonGlyphColor(DXBAR_HOT));
end;

procedure TdxColorfulRibbon2016Skin.DrawBackstageViewTabButton(DC: HDC;
  const R: TRect; AState: Integer);
begin
  if LowColors then
    ...
    case AState of
      DXBAR_PRESSED, DXBAR_HOT, DXBAR_HOTCHECK, DXBAR_ACTIVE,
        DXBAR_ACTIVEDISABLED:
        FillRectByColor(DC, R, GetMinimizeRibbonButtonGlyphColor
          (DXBAR_PRESSED));
      DXBAR_CHECKED:
...
procedure TdxColorfulRibbon2016Skin.DrawCollapsedToolbarBackground(DC: HDC;
  const R: TRect; AState: Integer);
begin
  if LowColors then
...
procedure TdxColorfulRibbon2016Skin.DrawContextBackground(DC: HDC;
...
procedure TdxColorfulRibbon2016Skin.DrawContextTabBackground(DC: HDC;
...
begin
  ...
  begin
    R1 := cxRectSetHeight(R, cxRectHeight(R) -
      GetPartSize(DXBAR_TABSGROUPSOVERLAPHEIGHT));
    dxGpFillRect(DC, R1, $000000, 77);
    DrawTab(DC, R, AState);
  end;
end;

procedure TdxColorfulRibbon2016Skin.DrawDropDownGalleryBottomSizingBand(DC: HDC;
  const R: TRect);
begin
  if LowColors then
...
procedure TdxColorfulRibbon2016Skin.DrawDropDownGalleryTopSizingBand(DC: HDC;
  const R: TRect);
begin
  if LowColors then
...
procedure TdxColorfulRibbon2016Skin.DrawEditButton(DC: HDC; const R: TRect;
  AState: Integer);
begin
  if LowColors then
    ...
    case AState of
      ...
      DXBAR_PRESSED, DXBAR_DROPPEDDOWN:
        FillRectByColor(DC, R, GetPartColor(DXBAR_EDIT_BUTTON_BORDER,
          DXBAR_DROPPEDDOWN));
    end;
end;

procedure TdxColorfulRibbon2016Skin.DrawFormBorderIconBackground(DC: HDC;
...
procedure TdxColorfulRibbon2016Skin.DrawInRibbonGalleryScrollBarButton(DC: HDC;
  ...
  begin
    ...
    try
      ...
      if AState in [DXBAR_DISABLED, DXBAR_ACTIVEDISABLED] then
        DrawFrame(DC, R1, clNone, GetBorderColor(DXBAR_NORMAL),
          [bTop .. bBottom]);
...
procedure TdxColorfulRibbon2016Skin.DrawMarkArrow(DC: HDC; const R: TRect;
  AState: Integer);
begin
  if LowColors then
    inherited
  else
    InternalDrawGlyph(DC, R, FMarkArrow[AState],
      GetPartColor(DXBAR_ARROWDOWN, AState));
end;

procedure TdxColorfulRibbon2016Skin.DrawMarkTruncated(DC: HDC; const R: TRect;
  AState: Integer);
begin
  if LowColors then
    inherited DrawMarkTruncated(DC, R, AState)
  else
    InternalDrawGlyph(DC, R, FMarkTruncated[AState],
      GetMinimizeRibbonButtonGlyphColor(AState));
end;

procedure TdxColorfulRibbon2016Skin.DrawMenuSeparatorHorz(DC: HDC;
  const R: TRect);
begin
  if LowColors then
...
procedure TdxColorfulRibbon2016Skin.DrawQuickAccessToolbarArrowDown(DC: HDC;
...
procedure TdxColorfulRibbon2016Skin.DrawQuickAccessToolbarMark(DC: HDC;
  const R: TRect; AState: Integer; AStatesArray: TStatesArray);
var
  AColor: TColor;
begin
  if AState = DXBAR_NORMAL then
...
procedure TdxColorfulRibbon2016Skin.DrawQuickAccessToolbarMarkArrow(DC: HDC;
  const R: TRect; AState: Integer; ABelow: Boolean);
begin
  if ABelow then
    inherited
...
procedure TdxColorfulRibbon2016Skin.DrawQuickAccessToolbarMarkTruncated(DC: HDC;
  const R: TRect; AState: Integer; ABelow: Boolean);
begin
  if ABelow then
    inherited
...
procedure TdxColorfulRibbon2016Skin.DrawQuickAccessToolbarPopup(DC: HDC;
  const R: TRect);
begin
  if LowColors then
...
procedure TdxColorfulRibbon2016Skin.DrawQuickAccessToolbarSmallButton(DC: HDC;
  const R: TRect; AState: Integer);
begin
  if LowColors then
  ...
  begin
    ...
    case AState of
      DXBAR_CHECKED:
        FillRectByColor(DC, R, GetPartColor(rspTabHeaderText, DXBAR_HOT));
      DXBAR_HOTCHECK:
        DrawFrame(DC, R, GetColorfulButtonColor(DXBAR_HOT),
          GetColorfulButtonColor(DXBAR_PRESSED), [bLeft .. bBottom], 1, True);
    else
      DrawColorfulButton(DC, R, AState);
    end;
  end;
...
procedure TdxColorfulRibbon2016Skin.
  DrawQuickAccessToolbarSmallButtonDropButtonArrowPart(DC: HDC; const R: TRect;
  AState: Integer);
begin
  if LowColors then
    inherited DrawQuickAccessToolbarSmallButtonDropButtonArrowPart(DC,
      R, AState)
  else
...
procedure TdxColorfulRibbon2016Skin.DrawRibbonTopFrameArea(DC: HDC;
  const R: TRect; AUseAeroGlass: Boolean);
begin
  if AUseAeroGlass then
    Parts[FTabsAreaOnGlass].DrawColored(DC, cxRectInflate(R, 0, 0, 0, -1),
      GetAccentColor);
end;

procedure TdxColorfulRibbon2016Skin.DrawScrollArrow(DC: HDC; const R: TRect;
  AState: Integer = 0);
begin
  if LowColors then
    ...
    Parts[FScrollArrow].DrawColored(DC, R,
      GetInRibbonGalleryScrollBarButtonGlyphColor(gsbkLineUp, AState));
end;

procedure TdxColorfulRibbon2016Skin.DrawSmallButton(DC: HDC; const R: TRect;
  AState: Integer);
begin
...
procedure TdxColorfulRibbon2016Skin.DrawSmallButtonDropButtonArrowPart(DC: HDC;
  const R: TRect; AState: Integer);
begin
  if LowColors then
    inherited DrawSmallButtonDropButtonArrowPart(DC, R, AState)
  else if AState in [DXBAR_ACTIVE, DXBAR_ACTIVEDISABLED] then
    DrawFrame(DC, R, $E6E6E6, GetHighlightContentColor,
      [bTop .. bBottom], 1, True)
  else
    DrawSmallButton(DC, R, AState);
end;

procedure TdxColorfulRibbon2016Skin.DrawSmallButtonDropButtonMainPart(DC: HDC;
  const R: TRect; AState: Integer);
begin
  if LowColors then
...
procedure TdxColorfulRibbon2016Skin.DrawTabSeparator(DC: HDC; const R: TRect;
  Alpha: Byte);
begin
  if LowColors then
...
function TdxColorfulRibbon2016Skin.DoGetPartColor(APart: Integer;
  AState: Integer = 0): TColor;
const
  HotTabHeaderTextColorMap: array [TdxRibbonColorSchemeAccent]
    of TColor = ($9CD0F4, $F2D5C2, $B7D59F, $B6CDFC, $DEBFE0);
begin
  case APart of
...
procedure TdxColorfulRibbon2016Skin.DrawTabAreaArrowDown(DC: HDC;
  const R: TRect; AState: Integer);
begin
  DrawQuickAccessToolbarArrowDown(DC, R, AState, False);
end;

procedure TdxColorfulRibbon2016Skin.DrawTabAreaButton(DC: HDC; const R: TRect;
...
procedure TdxColorfulRibbon2016Skin.DrawTabAreaMarkArrow(DC: HDC;
  const R: TRect; AState: Integer);
begin
  DrawQuickAccessToolbarMarkArrow(DC, R, AState, False);
end;

procedure TdxColorfulRibbon2016Skin.DrawTabAreaMarkTruncated(DC: HDC;
  const R: TRect; AState: Integer);
begin
...
const
  ColorMap: array [TdxRibbonColorSchemeAccent] of TColor = ($3EA5EA, $9A572B,
    $467321, $2A47B7, $7B3980);
begin
  Result := ColorMap[ColorSchemeAccent];
end;

function TdxColorfulRibbon2016Skin.GetBackstageViewBackButtonGlyphColor
  (AState: Integer): TColor;
const
  ColorMap: array [TdxRibbonColorSchemeAccent] of TColor = ($9CD0F4, $D9B298,
    $B0CC99, $A2B0EB, $D1AED4);
begin
  if LowColors then
    Result := inherited GetBackstageViewBackButtonGlyphColor(AState)
  else if AState in [DXBAR_HOT, DXBAR_PRESSED] then
    Result := ColorMap[ColorSchemeAccent]
  else
    Result := $FFFFFF;
end;

function TdxColorfulRibbon2016Skin.GetFormCaptionAreaColor(AApplicationMenuState
  : TdxRibbonApplicationMenuState; AActive: Boolean): TColor;
begin
...
const
  DisabledStateColorMap: array [TdxRibbonColorSchemeAccent] of TColor =
    ($C8E3FD, $6B3D1D, $325118, $1E3280, $562859);
begin
  if AState in [rbisInactive, rbisHotInactive] then
    Result := DisabledStateColorMap[ColorSchemeAccent]
  else if PaintData.GetApplicationMenuState = ramsShownAsFullScreenFrame then
    Result := GetMinimizeRibbonButtonGlyphColor
      (BorderIconStateToBarState[AState])
  else
    Result := $FFFFFF;
end;
...
function TdxColorfulRibbon2016Skin.GetLaunchButtonDefaultGlyphColor
  (AState: Integer): TColor;
begin
  case AState of
    DXBAR_NORMAL:
...
function TdxColorfulRibbon2016Skin.GetMinimizeRibbonButtonGlyphColor
  (AState: Integer): TColor;
const
  HotStateColorMap: array [TdxRibbonColorSchemeAccent] of TColor = ($9CD0F4,
    $B56D3E, $679443, $3E62F0, $9E56A3);
  PressedStateColorMap: array [TdxRibbonColorSchemeAccent] of TColor = ($9CD0F4,
    $8A4719, $32630A, $1D3BB8, $682F6C);
begin
  case AState of
    DXBAR_HOT:
...
function TdxColorfulRibbon2016Skin.GetColorfulButtonColor
  (AState: Integer): TColor;
const
  HotStateColorMap: array [TdxRibbonColorSchemeAccent] of TColor = ($C8E3FD,
    $F2E1D5, $E0F0D3, $DCE4FC, $EEDAF0);
  PressedStateColorMap: array [TdxRibbonColorSchemeAccent] of TColor = ($9CD0F4,
    $E3BDA3, $A0BF86, $9DBAF5, $D1A9D4);
begin
  case AState of
...
procedure TdxColorfulRibbon2016TabletSkin.DrawBackstageViewGalleryItem(DC: HDC;
  const R: TRect; AState: Integer);
begin
  if LowColors then
    inherited DrawBackstageViewGalleryItem(DC, R, AState)
  else
    DrawFormBorderIconButton(DC, R,
      IfThen(AState in [DXBAR_CHECKED, DXBAR_HOTCHECK], DXBAR_PRESSED, AState));
end;

procedure TdxColorfulRibbon2016TabletSkin.DrawBackstageViewGalleryItemPinButton
  (DC: HDC; const R: TRect; AState: Integer);
begin
  if LowColors then
    inherited DrawBackstageViewGalleryItemPinButton(DC, R, AState)
  else
    DrawFormBorderIconButton(DC, R, IfThen(AState = DXBAR_HOTCHECK,
      DXBAR_HOT, AState));
end;

procedure TdxColorfulRibbon2016TabletSkin.DrawCollapsedToolbarGlyphBackground
  (DC: HDC; const R: TRect; AState: Integer);
begin
  if LowColors then
...
procedure TdxColorfulRibbon2016TabletSkin.DrawFormBorderIconBackground(DC: HDC;
  const R: TRect; AIcon: TdxRibbonBorderDrawIcon;
  AState: TdxRibbonBorderIconState);
begin
  if LowColors or (PaintData.GetApplicationMenuState <>
    ramsShownAsFullScreenFrame) then
    inherited
  else
    DrawFormBorderIconButton(DC, R, BorderIconStateToBarState[AState]);
end;

procedure TdxColorfulRibbon2016TabletSkin.DrawMinimizeRibbonButton(DC: HDC;
  const R: TRect; AState: TcxButtonState; AMinimized: Boolean);
begin
  if LowColors then
...
procedure TdxColorfulRibbon2016TabletSkin.DrawTab(DC: HDC; const R: TRect;
...
begin
  if LowColors then
    ...
    case AState of
      rtsHot:
        DrawTabBackground(DC, R, GetMinimizeRibbonButtonGlyphColor(DXBAR_HOT),
          GetMinimizeRibbonButtonGlyphColor(DXBAR_HOT));
      rtsActive, rtsActiveHot:
        DrawTabBackground(DC, R, GetTabGroupsAreaContentColor, GetFrameColor);
      rtsFocused:
        DrawTabBackground(DC, R, GetHighlightContentColor,
          GetHighlightBorderColor);
    end;
end;

function TdxColorfulRibbon2016TabletSkin.DoGetPartColor(APart: Integer;
  AState: Integer = 0): TColor;
begin
...
procedure TdxColorfulRibbon2016TabletSkin.DrawFormBorderIconButton(DC: HDC;
  const R: TRect; AState: Integer);
begin
...
procedure TdxColorfulRibbon2016TabletSkin.DrawTabBackground(DC: HDC;
  const R: TRect; AColor, ABorderColor: TColor);
const
  Radius = 2;
begin
  dxGpRoundRect(DC, R, ABorderColor, AColor, Radius);
  DrawFrame(DC, cxRectInflate(R, 0, -Radius, 0, 0), AColor, ABorderColor,
    [bLeft, bRight], 1, True);
end;
...
function TdxColorfulRibbon2016TabletSkin.GetFormBorderIconButtonColor
  (AState: Integer): TColor;
begin
  Result := inherited GetColorfulButtonColor(AState);
end;

function TdxColorfulRibbon2016TabletSkin.GetColorfulButtonColor
  (AState: Integer): TColor;
begin
  case AState of
    DXBAR_HOT:
      Result := GetMinimizeRibbonButtonGlyphColor(AState);
    DXBAR_PRESSED:
      Result := TdxColorHelper.ChangeLightness
        (GetMinimizeRibbonButtonGlyphColor(AState), -0.05);
  else
    Result := inherited;
  end;
end;
...
procedure TdxDarkGrayRibbon2016Skin.AdjustContextFont(AFont: TFont;
  AUseGlass: Boolean; AContextColor: TColor);
begin
  if LowColors then
    inherited AdjustContextFont(AFont, AUseGlass, AContextColor)
...
procedure TdxDarkGrayRibbon2016Skin.AdjustContextTabFont(AFont: TFont;
  AState: Integer; AContextColor: TColor);
begin
  if LowColors then
    inherited AdjustContextTabFont(AFont, AState, AContextColor)
...
function TdxDarkGrayRibbon2016Skin.CreateMajorColorPalette
  : IdxRibbonSkinColorPaletteSet;
begin
  Result := TdxRibbonSkinColorPaletteSet.Create;
  Result.Add(DXBAR_NORMAL, TdxRibbonSkinColorPalette.Create($2C4BBE, $758A4C,
    $E0E0E0, $333333, $A0D7F2, $8F5C29));
  Result.Add(DXBAR_DISABLED, TdxRibbonSkinColorPalette.Create($A1A1A1, $A1A1A1,
    $FFFFFF, $A1A1A1, $A1A1A1, $A1A1A1));
end;

procedure TdxDarkGrayRibbon2016Skin.DrawApplicationButton(DC: HDC;
  const R: TRect; AState: TdxRibbonApplicationButtonState);
begin
  if LowColors then
    inherited DrawApplicationButton(DC, R, AState)
  else
    DrawColorfulButton(DC, R, IfThen(AState = rabsHot, DXBAR_PRESSED,
      DXBAR_HOT));
end;

procedure TdxDarkGrayRibbon2016Skin.DrawBackstageViewGalleryBackground(DC: HDC;
  const R: TRect);
begin
  if LowColors then
    inherited DrawBackstageViewGalleryBackground(DC, R)
...
procedure TdxDarkGrayRibbon2016Skin.DrawBackstageViewGalleryGroupHeader(DC: HDC;
  const R: TRect);
begin
  if LowColors then
    inherited DrawBackstageViewGalleryGroupHeader(DC, R)
  else
    FillRectByColor(DC, R,
      GetPartColor(DXBAR_BACKSTAGEVIEW_GALLERYCONTROL_GROUPHEADER));
end;

procedure TdxDarkGrayRibbon2016Skin.DrawBackstageViewGalleryItem(DC: HDC;
  const R: TRect; AState: Integer);
begin
  if LowColors then
    inherited DrawBackstageViewGalleryItem(DC, R, AState)
...
procedure TdxDarkGrayRibbon2016Skin.DrawBackstageViewGalleryItemPinButton
  (DC: HDC; const R: TRect; AState: Integer);
begin
  if LowColors then
    inherited DrawBackstageViewGalleryItemPinButton(DC, R, AState)
...
procedure TdxDarkGrayRibbon2016Skin.DrawBackstageViewMenuSeparator(DC: HDC;
  const R: TRect; AState: Integer);
begin
  if LowColors then
    inherited DrawBackstageViewMenuSeparator(DC, R, AState)
    ...
    FillRectByColor(DC, cxRectInflate(cxRectCenterVertically(R, 1), -15, 0),
      GetPartColor(DXBAR_BACKSTAGEVIEW));
end;

procedure TdxDarkGrayRibbon2016Skin.DrawBackstageViewTabButton(DC: HDC;
  const R: TRect; AState: Integer);
begin
  if LowColors then
    inherited DrawBackstageViewTabButton(DC, R, AState)
...
procedure TdxDarkGrayRibbon2016Skin.DrawCollapsedToolbarBackground(DC: HDC;
  const R: TRect; AState: Integer);
begin
  if LowColors then
    inherited DrawCollapsedToolbarBackground(DC, R, AState)
...
procedure TdxDarkGrayRibbon2016Skin.DrawContextBackground(DC: HDC;
  const R: TRect; AContextColor: TColor);
var
  R1: TRect;
begin
...
procedure TdxDarkGrayRibbon2016Skin.DrawContextTabBackground(DC: HDC;
  const R: TRect; AState: TdxRibbonTabState; AContextColor: TColor);
const
...
begin
  ...
  begin
    R1 := cxRectSetHeight(R, cxRectHeight(R) -
      GetPartSize(DXBAR_TABSGROUPSOVERLAPHEIGHT));
    DrawFrame(DC, R1, BackgroundColorMap[AState = rtsHot], GetFrameColor,
      [bLeft .. bBottom], 1, True);
    DrawTab(DC, R, AState);
  end;
end;
...
procedure TdxDarkGrayRibbon2016Skin.DrawDropDownGalleryBackground(DC: HDC;
  const R: TRect);
begin
  if LowColors then
...
procedure TdxDarkGrayRibbon2016Skin.DrawDropDownGalleryBottomSizingBand(DC: HDC;
  const R: TRect);
begin
  if LowColors then
    inherited DrawDropDownGalleryBottomSizingBand(DC, R)
...
procedure TdxDarkGrayRibbon2016Skin.DrawDropDownGalleryTopSizingBand(DC: HDC;
  const R: TRect);
begin
  if LowColors then
    inherited DrawDropDownGalleryTopSizingBand(DC, R)
...
procedure TdxDarkGrayRibbon2016Skin.DrawEditButton(DC: HDC; const R: TRect;
  AState: Integer);
begin
  if LowColors then
    inherited DrawEditButton(DC, R, AState)
  else if AState in [DXBAR_HOT, DXBAR_PRESSED, DXBAR_DROPPEDDOWN] then
    DrawFrame(DC, cxRectInflate(R, 1), GetEditButtonContentColor(AState),
      GetEditButtonContentColor(DXBAR_PRESSED));
end;

procedure TdxDarkGrayRibbon2016Skin.DrawFormBorderIconBackground(DC: HDC;
  const R: TRect; AIcon: TdxRibbonBorderDrawIcon;
  AState: TdxRibbonBorderIconState);
begin
  if LowColors then
...
procedure TdxDarkGrayRibbon2016Skin.DrawInRibbonGalleryScrollBarButton(DC: HDC;
  const R: TRect; AButtonKind: TdxInRibbonGalleryScrollBarButtonKind;
  AState: Integer);
  ...
  begin
    case AState of
      ...
      DXBAR_DISABLED:
        Result := GetInRibbonGalleryScrollBarButtonGlyphColor
          (AButtonKind, AState);
    else
...
procedure TdxDarkGrayRibbon2016Skin.DrawLaunchButtonBackground(DC: HDC;
  const R: TRect; AState: Integer);
begin
  if LowColors then
...
procedure TdxDarkGrayRibbon2016Skin.DrawMarkArrow(DC: HDC; const R: TRect;
  AState: Integer);
var
  AColor: TColor;
begin
...
procedure TdxDarkGrayRibbon2016Skin.DrawMarkTruncated(DC: HDC; const R: TRect;
  AState: Integer);
var
  AColor: TColor;
begin
...
procedure TdxDarkGrayRibbon2016Skin.DrawMenuSeparatorHorz(DC: HDC;
  const R: TRect);
begin
  if LowColors then
    inherited DrawMenuSeparatorHorz(DC, R)
...
procedure TdxDarkGrayRibbon2016Skin.DrawQuickAccessToolbarPopup(DC: HDC;
  const R: TRect);
begin
  if LowColors then
    inherited DrawQuickAccessToolbarPopup(DC, R)
...
procedure TdxDarkGrayRibbon2016Skin.DrawQuickAccessToolbarSmallButton(DC: HDC;
  const R: TRect; AState: Integer);
begin
  if LowColors then
    inherited DrawQuickAccessToolbarSmallButton(DC, R, AState)
...
procedure TdxDarkGrayRibbon2016Skin.
  DrawQuickAccessToolbarSmallButtonDropButtonArrowPart(DC: HDC; const R: TRect;
  AState: Integer);
begin
  if LowColors then
...
begin
  if LowColors then
    ...
    case AState of
      DXBAR_ACTIVE:
        DrawFrame(DC, R, GetMasterColor, GetFrameColor,
          [bLeft .. bBottom], 1, True);
      DXBAR_DROPPEDDOWN:
        DrawColorfulButton(DC, R, DXBAR_HOT);
    else
...
procedure TdxDarkGrayRibbon2016Skin.DrawRibbonTopFrameArea(DC: HDC;
  const R: TRect; AUseAeroGlass: Boolean);
begin
  if AUseAeroGlass then
    Parts[FTabsAreaOnGlass].DrawColored(DC, cxRectInflate(R, 0, 0, 0, -1),
...
procedure TdxDarkGrayRibbon2016Skin.DrawScrollArrow(DC: HDC; const R: TRect;
  AState: Integer = 0);
var
  AColor: TColor;
begin
...
procedure TdxDarkGrayRibbon2016Skin.DrawSeparatorBackground(DC: HDC;
  const R: TRect);
begin
  if LowColors then
...
procedure TdxDarkGrayRibbon2016Skin.DrawSmallButton(DC: HDC; const R: TRect;
  AState: Integer);
const
  CheckedColorMap: array [TdxRibbonColorSchemeAccent] of TColor = ($9CD0F4,
    $F2D5C2, $B7D59F, $B6CDFC, $DEBFE0);
begin
  if LowColors or not(AState in [DXBAR_CHECKED, DXBAR_DROPPEDDOWN]) then
    inherited DrawSmallButton(DC, R, AState)
  else
...
procedure TdxDarkGrayRibbon2016Skin.DrawSmallButtonDropButtonArrowPart(DC: HDC;
  const R: TRect; AState: Integer);
begin
  if LowColors then
    inherited DrawSmallButtonDropButtonArrowPart(DC, R, AState)
  else if AState in [DXBAR_ACTIVE, DXBAR_ACTIVEDISABLED] then
    DrawFrame(DC, R, $FFFFFF, GetHighlightContentColor,
      [bTop .. bBottom], 1, True)
  else
    DrawSmallButton(DC, R, AState);
end;

procedure TdxDarkGrayRibbon2016Skin.DrawSmallButtonDropButtonMainPart(DC: HDC;
  const R: TRect; AState: Integer);
begin
  if LowColors then
    inherited DrawSmallButtonDropButtonMainPart(DC, R, AState)
...
procedure TdxDarkGrayRibbon2016Skin.DrawTabGroupBackground(DC: HDC;
...
begin
  if LowColors or not AIsInPopup then
    ...
    DrawFrame(DC, R, GetPartColor(DXBAR_MENUCONTENT), GetFrameColor,
      [bLeft .. bRight]);
end;

procedure TdxDarkGrayRibbon2016Skin.DrawTabGroupHeaderBackground(DC: HDC;
  const R: TRect; AState: Integer; AIsInPopup: Boolean);
begin
  if LowColors or not AIsInPopup then
...
procedure TdxDarkGrayRibbon2016Skin.DrawTabSeparator(DC: HDC; const R: TRect;
  Alpha: Byte);
begin
  if LowColors then
    inherited DrawTabSeparator(DC, R, Alpha)
...
function TdxDarkGrayRibbon2016Skin.DoGetPartColor(APart: Integer;
  AState: Integer = 0): TColor;
begin
  case APart of
...
function TdxDarkGrayRibbon2016Skin.GetScrollBarPartBorderColor
  (APart: TcxScrollBarPart; AState: Integer): TColor;
begin
  if AState in [DXBAR_HOT, DXBAR_PRESSED] then
    Result := $101010
  else
...
function TdxDarkGrayRibbon2016Skin.GetScrollBarPartContentColor
  (APart: TcxScrollBarPart; AState: Integer): TColor;
begin
...
procedure TdxDarkGrayRibbon2016Skin.DrawTabAreaButton(DC: HDC; const R: TRect;
  AState: TcxButtonState);
begin
  if LowColors then
    inherited DrawTabAreaButton(DC, R, AState)
...
const
  ColorMap: array [TdxRibbonColorSchemeAccent] of TColor = ($3EA5EA, $9A572B,
    $467321, $2647D2, $7B3980);
begin
  Result := ColorMap[ColorSchemeAccent];
end;

function TdxDarkGrayRibbon2016Skin.GetBackstageViewBackButtonGlyphColor
  (AState: Integer): TColor;
const
  ColorMap: array [TdxRibbonColorSchemeAccent] of TColor = ($9CD0F4, $B56D3E,
    $679443, $3E62F0, $9E56A3);
begin
  if LowColors then
    Result := inherited GetBackstageViewBackButtonGlyphColor(AState)
  else if AState in [DXBAR_HOT, DXBAR_PRESSED] then
...
function TdxDarkGrayRibbon2016Skin.GetFormCaptionAreaColor(AApplicationMenuState
  : TdxRibbonApplicationMenuState; AActive: Boolean): TColor;
begin
  Result := GetMasterColor;
end;

function TdxDarkGrayRibbon2016Skin.GetEditButtonContentColor
  (AState: Integer): TColor;
const
  HotColorMap: array [TdxRibbonColorSchemeAccent] of TColor = ($C8E3FD, $F3E3D7,
    $E2EED8, $D4E0FF, $F3E2F5);
  PressedColorMap: array [TdxRibbonColorSchemeAccent] of TColor = ($9CD0F4,
    $DBB5A0, $8DAA70, $88A6F1, $CBA4CE);
begin
  case AState of
    DXBAR_HOT:
...
const
  ColorMap: array [TdxRibbonColorSchemeAccent] of TColor = ($9CD0F4, $E3BDA3,
    $A0BF86, $9DBAF5, $D1A9D4);
begin
  Result := ColorMap[ColorSchemeAccent];
end;

function TdxDarkGrayRibbon2016Skin.GetLaunchButtonDefaultGlyphColor
  (AState: Integer): TColor;
begin
  case AState of
    DXBAR_NORMAL:
...
function TdxDarkGrayRibbon2016Skin.GetMinimizeRibbonButtonGlyphColor
  (AState: Integer): TColor;
begin
  Result := $444444;
end;
...
function TdxDarkGrayRibbon2016Skin.GetColorfulButtonColor
  (AState: Integer): TColor;
const
  PressedStateColorMap: array [TdxRibbonColorSchemeAccent] of TColor = ($9CD0F4,
    $8A4719, $32630A, $1D3BB8, $682F6C);
