...
uses
  Math, dxOffice11, dxTabbedMDIStrs, Types, dxMessages, dxDPIAwareUtils,
  dxForms;
...
begin
  ...
  try
    ...
    FInternalImages.SourceDPI := FTabbedMDIManager.ScaleFactor.Apply
      (dxDefaultDPI);
    FInternalImages.Height := dxGetSystemMetrics(SM_CYSMICON,
      FTabbedMDIManager.ScaleFactor);
    FInternalImages.Width := dxGetSystemMetrics(SM_CXSMICON,
      FTabbedMDIManager.ScaleFactor);
