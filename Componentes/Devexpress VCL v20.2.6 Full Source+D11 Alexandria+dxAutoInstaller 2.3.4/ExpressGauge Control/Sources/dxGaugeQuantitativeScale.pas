...
{$IFDEF DELPHI16}
  System.UITypes,
{$ENDIF}
  SysUtils, Classes, Graphics, Windows, Generics.Defaults, Generics.Collections,
  cxClasses, cxGeometry, dxCore, dxCoreGraphics, cxGraphics,
  dxGDIPlusAPI, dxGDIPlusClasses, dxAnimation, dxCompositeShape, dxXMLDoc,
  dxGaugeCustomScale;
...
type
  ...
  TdxGaugeQuantitativeScaleAnimationControllerClass = class of
  ...
  TdxGaugeQuantitativeScaleOptionsAnimateClass = class of
    TdxGaugeQuantitativeScaleOptionsAnimate;
  TdxGaugeQuantitativeScaleParameters = class;
  TdxGaugeQuantitativeScaleParametersClass = class of
    TdxGaugeQuantitativeScaleParameters;
  TdxGaugeQuantitativeScaleViewInfo = class;
  TdxGaugeQuantitativeScaleViewInfoClass = class of
    TdxGaugeQuantitativeScaleViewInfo;

  TdxGaugeQuantitativeScaleParameterValue = (spvFontColor, spvFontName,
    spvFontSize, spvShowFirstTick, spvShowLabels, spvShowLastTick, spvShowTicks,
    spvMajorTickCount, spvMinorTickCount);
  TdxGaugeQuantitativeScaleParameterValues = set of
    TdxGaugeQuantitativeScaleParameterValue;

  TdxGaugeScaleRangeValueLinkedWithScaleValue = (rlsvNone, rlsvValueStart,
    rlsvValueEnd);
  ...
  TdxGaugeQuantitativeScaleTickmarks = array of
    TdxGaugeQuantitativeScaleTickmark;

  TdxGaugeQuantitativeScaleGetTickmarkLabelDrawInfoEvent = procedure
    (ASender: TObject; const AValue: Single;
    var ADrawInfo: TdxGaugeQuantitativeScaleTickmarkLabelDrawInfo) of object;
  TdxGaugeQuantitativeScaleGetValuePositionFunc = function(AValue: Single)
    : Single of object;
  ...
  TdxGaugeQuantitativeScaleDefaultParameters = class
  ...
  TdxGaugeQuantitativeScaleCaptionParameters = class
  ...
  private
    ...
    function GetMinorValue(AValue, AMajorValue: Single;
    ...
    procedure CalculateLogarithmicMajorValues(AMaxValuePower, AMaxValueSign,
    ...
    procedure CalculateTickmarksPositions(AMajor: Boolean; ACount: Integer;
  ...
  protected
    ...
    property AllowOverlapping: Boolean read FAllowOverlapping
      write SetAllowOverlapping;
    property Bounds: TdxRectF read FBounds write SetBounds;
    property LogarithmicBase: Single read FLogarithmicBase
      write SetLogarithmicBase;
    property MaxValue: Single read FMaxValue write SetMaxValue;
    property MinValue: Single read FMinValue write SetMinValue;
    property MajorValueCount: Integer read FMajorValueCount
      write SetMajorValueCount;
    property MinorValueCount: Integer read FMinorValueCount
      write SetMinorValueCount;
  ...
  protected
    ...
    property LogarithmicBase: Single read GetLogarithmicBase
      write SetLogarithmicBase;
    property ShowValueIndicator: Boolean read GetShowValueIndicator
      write SetShowValueIndicator default True;
  published
    property Font: TFont read GetFont write SetFont stored IsFontStored;
    property MajorTickCount: Integer read GetMajorTickCount
      write SetMajorTickCount stored IsMajorTickCountStored;
    property MaxValue: Single read GetMaxValue write SetMaxValue
      stored IsMaxValueStored;
    property MinorTickCount: Integer read GetMinorTickCount
      write SetMinorTickCount stored IsMinorTickCountStored;
    property MinValue: Single read GetMinValue write SetMinValue;
    property ShowFirstTick: Boolean read GetShowFirstTick write SetShowFirstTick
      stored IsShowFirstTickStored;
    property ShowLabels: Boolean read GetShowLabels write SetShowLabels
      stored IsShowLabelsStored;
    property ShowLastTick: Boolean read GetShowLastTick write SetShowLastTick
      stored IsShowLastTickStored;
    property ShowTicks: Boolean read GetShowTicks write SetShowTicks
      stored IsShowTicksStored;
  end;
  ...
  private
    ...
    function GetTickmarkLabelText(AScaleParameters
      : TdxGaugeQuantitativeScaleParameters; AValue: Single): string;
    procedure AddTickmark(AValue, APosition: Single;
    ...
    procedure DrawTickmarkTick(AGPGraphics: TdxGPGraphics;
      const ATick: TdxGaugeQuantitativeScaleTickmark;
  ...
  protected
    ...
    procedure PopulateParameters(AParameters
      : TdxGaugeCustomScaleParameters); override;
    ...
    procedure DoDrawValueIndicator(AGPGraphics: TdxGPGraphics);
      virtual; abstract;
    ...
    function GetLabelTextRect(APosition: Single; const AText: string): TdxRectF;
      virtual; abstract;
    ...
    property MajorTicksDrawInfo: TdxGaugeQuantitativeScaleTickmarkTickDrawInfo
      read FMajorTicksDrawInfo;
    property ScaleValuePosition: Single read FScaleValuePosition;

    property OnGetTickmarkLabelDrawInfo
      : TdxGaugeQuantitativeScaleGetTickmarkLabelDrawInfoEvent
  ...
  private
    ...
    function GetMinorTickCount: Integer;
    function GetMinValue: Single;
    function GetOnGetTickmarkLabelDrawInfo
      : TdxGaugeQuantitativeScaleGetTickmarkLabelDrawInfoEvent;
    ...
    procedure SetOnGetTickmarkLabelDrawInfo(const AValue
      : TdxGaugeQuantitativeScaleGetTickmarkLabelDrawInfoEvent);
    procedure SetOptionsAnimate(const AValue
      : TdxGaugeQuantitativeScaleOptionsAnimate);
    ...
    procedure RangeChangeHandler(Sender: TObject;
  ...
  protected
    class function GetStyleReaderClass
      : TdxGaugeCustomScaleStyleReaderClass; override;
    ...
    function GetAnimationControllerClass
      : TdxGaugeQuantitativeScaleAnimationControllerClass; virtual;
    ...
    property AnimationController: TdxGaugeQuantitativeScaleAnimationController
      read FAnimationController;
    property Font: TFont read GetFont;
    property Ranges: TdxGaugeRangeCollection read FRanges write SetRanges;
    property OptionsAnimate: TdxGaugeQuantitativeScaleOptionsAnimate
  ...
  protected
    procedure ReadCustomQuantitativeScaleParameters(ANode: TdxXMLNode;
      AParameters: TdxGaugeQuantitativeScaleDefaultParameters);
    procedure ReadFontParameters(ANode: TdxXMLNode;
      AParameters: TdxGaugeCustomScaleDefaultParameters);
    procedure ReadLabelsParameters(ANode: TdxXMLNode;
      AParameters: TdxGaugeQuantitativeScaleDefaultParameters);
    procedure ReadMajorTicksParameters(ANode: TdxXMLNode;
      AParameters: TdxGaugeQuantitativeScaleDefaultParameters);
    procedure ReadMinorTicksParameters(ANode: TdxXMLNode;
      AParameters: TdxGaugeQuantitativeScaleDefaultParameters);
    procedure ReadTicksVisibility(ANode: TdxXMLNode;
      AParameters: TdxGaugeQuantitativeScaleDefaultParameters);
  protected
    function GetDefaultParametersClass
      : TdxGaugeCustomScaleDefaultParametersClass; override;
    procedure ReadParameters(ANode: TdxXMLNode;
      AParameters: TdxGaugeCustomScaleDefaultParameters); override;
  ...
  protected
    ...
    function GetValueRange: Single;
    procedure Calculate(AParameters: TdxGaugeCustomRangeParameters;
  ...
  private
    ...
    function GetLinkedWithScaleValue
    ...
    procedure SetLinkedWithScaleValue(const AValue
      : TdxGaugeScaleRangeValueLinkedWithScaleValue);
  ...
  protected
    ...
    property LinkedWithScaleValue: TdxGaugeScaleRangeValueLinkedWithScaleValue
      read GetLinkedWithScaleValue write SetLinkedWithScaleValue
      default rlsvNone;
  ...
  protected
    ...
    property Items[Index: Integer]: TdxGaugeCustomRange read GetRange
      write SetRange; default;
  public
    procedure Assign(ASource: TPersistent); override;
  end;
  ...
  TdxGaugeQuantitativeScaleCaptionViewInfo = class
  ...
  private
    ...
    procedure SetOptionsView(const AValue
      : TdxGaugeQuantitativeScaleCaptionOptionsView);
  protected
    function GetOptionsViewClass
      : TdxGaugeCustomCaptionOptionsViewClass; override;
    function GetParametersClass: TdxGaugeCustomCaptionParametersClass; override;
  ...
  published
    ...
    property OptionsView: TdxGaugeQuantitativeScaleCaptionOptionsView
  ...
  private
    ...
    procedure SetTransitionEffect(const AValue
      : TdxGaugeQuantitativeScaleAnimationTransitionEffect);
    procedure SetTransitionEffectMode(const AValue
  ...
  protected
    ...
    property Interval: Integer read FInterval write SetInterval
      default dxGaugeScaleDefaultAnimationInterval;
    property FrameCount: Integer read FFrameCount write SetFrameCount
      default dxGaugeScaleDefaultAnimationFrameCount;
    property TransitionEffect
      : TdxGaugeQuantitativeScaleAnimationTransitionEffect
      read FTransitionEffect write SetTransitionEffect
      default ateAccelerateDecelerate;
    property TransitionEffectMode: TdxAnimationTransitionEffectMode
      read FTransitionEffectMode write SetTransitionEffectMode default atmIn;
  ...
  private
    ...
    procedure AnimateHandler(ASender: TdxAnimationTransition;
      var APosition: Integer; var AFinished: Boolean);
    procedure OptionsAnimateChangeHandler(ASender: TObject);
  protected
    function GetOptionsAnimateClass
      : TdxGaugeQuantitativeScaleOptionsAnimateClass; virtual;
...
procedure TdxGaugeCustomRangeParameters.Assign
  (ASource: TdxGaugeCustomRangeParameters);
begin
  cxCopyData(ASource, Self, SizeOf(ASource), SizeOf(Self),
    ASource.InstanceSize - SizeOf(ASource));
end;
...
function TdxGaugeQuantitativeScaleTickmarksCalculator.ValueToPoint
...
procedure TdxGaugeQuantitativeScaleTickmarksCalculator.SetAllowOverlapping
...
procedure TdxGaugeQuantitativeScaleTickmarksCalculator.SetBounds
...
procedure TdxGaugeQuantitativeScaleTickmarksCalculator.SetLogarithmicBase
  (const AValue: Single);
begin
...
procedure TdxGaugeQuantitativeScaleTickmarksCalculator.SetMajorValueCount
...
procedure TdxGaugeQuantitativeScaleTickmarksCalculator.SetMaxValue
  (const AValue: Single);
begin
...
procedure TdxGaugeQuantitativeScaleTickmarksCalculator.SetMinorValueCount
  (const AValue: Integer);
begin
...
procedure TdxGaugeQuantitativeScaleTickmarksCalculator.SetMinValue
  (const AValue: Single);
begin
...
function TdxGaugeQuantitativeScaleTickmarksCalculator.GetLogarithm
...
function TdxGaugeQuantitativeScaleTickmarksCalculator.
  GetMajorValuesFirstIndex: Integer;
begin
  Result := Integer(FMinValue > FMajorValues.First);
end;

function TdxGaugeQuantitativeScaleTickmarksCalculator.
  GetMajorValuesLastIndex: Integer;
begin
...
function TdxGaugeQuantitativeScaleTickmarksCalculator.GetMinorValue(AValue,
  AMajorValue: Single; AMajorValueSign, AMajorValueIndex: Integer): Single;
begin
...
begin
  if GetMajorValuesLastIndex = FMajorValues.Count then
    ...
    Result := GetMinorValue(FMaxValue,
      FMajorValues[GetMajorValuesLastIndex], 1, 1);
end;

function TdxGaugeQuantitativeScaleTickmarksCalculator.
  GetStartValueOffset: Single;
begin
  if GetMajorValuesFirstIndex = 0 then
    Result := 0
  else
    Result := GetMinorValue(FMinValue,
      FMajorValues[GetMajorValuesFirstIndex - 1], 1, 1);
end;

function TdxGaugeQuantitativeScaleTickmarksCalculator.
  GetMajorValueCount: Integer;
begin
...
function TdxGaugeQuantitativeScaleTickmarksCalculator.IsValidValue
  (AValue: Single): Boolean;
begin
  Result := (FMinValue <= AValue) and (AValue <= FMaxValue);
end;

function TdxGaugeQuantitativeScaleTickmarksCalculator.ValuePercentToPoint
  (APercent: Single): TdxPointF;
var
...
function TdxGaugeQuantitativeScaleTickmarksCalculator.ValuePointOffset
  (AValueOffset: Single): TdxPointF;
begin
  if IsLogarithmic then
  begin
...
function TdxGaugeQuantitativeScaleTickmarksCalculator.ValueToPercent
  (AValue: Single): Single;
var
  I: Integer;
begin
  ...
  begin
    ...
    if Result = -1 then
      if AValue = FMajorValues.Last then
        Result := GetMinorValue(AValue, AValue, Sign(AValue),
          FMajorValues.Count - 1 + Integer(AValue >= 0))
      else
...
procedure TdxGaugeQuantitativeScaleTickmarksCalculator.
  CalculateLogarithmicMajorValues(AMaxValuePower, AMaxValueSign, AMinValuePower,
  AMinValueSign: Integer);

  procedure InternalCalculateMajorValues(AValueSign, AMinValuePower,
    AMaxValuePower: Integer);
  begin
...
begin
  ...
  begin
    InternalCalculateMajorValues(AMinValueSign,
      Min(AMinValuePower, AMaxValuePower), Max(AMinValuePower, AMaxValuePower));
...
begin
  FMajorValues.Clear;
  if IsLogarithmic then
    CalculateLogarithmicMajorValues(GetMaxValuePower, GetMaxValueSign,
      GetMinValuePower, GetMinValueSign)
  else
    InternalCalculateMajorValues;
end;

procedure TdxGaugeQuantitativeScaleTickmarksCalculator.
  CalculateMajorTicksPositions(var APositions: TdxPointsF);
...
begin
  ...
  for I := GetMajorValuesFirstIndex to GetMajorValuesLastIndex - 1 do
    APositions[GetPositionIndex(I)] :=
      ValuePercentToPoint(I / (FMajorValues.Count - 1));
end;
...
procedure TdxGaugeQuantitativeScaleTickmarksCalculator.CalculateMinorValues;
  ...
  begin
    if not IsLogarithmic or (AMajorValue <> 0) and (APreviousMajorValue <> 0)
    then
    begin
      ...
      begin
        AValue := ACurrentMajorValue + Sign(AMajorValue) * I *
          (AMajorValue - APreviousMajorValue) / FMinorValueCount;
        if IsValidValue(AValue) then
          FMinorValues.Add(GetMinorValue(AValue, ACurrentMajorValue,
            Sign(ACurrentMajorValue), FMajorValues.IndexOf(AMajorValue)));
      end;
    end;
  end;
...
procedure TdxGaugeQuantitativeScaleTickmarksCalculator.CalculateScaleVector;
  ...
  function GetScaleVector(const AStartPointOffset, AEndPointOffset: TdxPointF)
    : TdxPointF;
  begin
...
begin
  FLength := GetScaleVector(ValuePointOffset(GetStartValueOffset),
    ValuePointOffset(GetEndValueOffset));
end;

procedure TdxGaugeQuantitativeScaleTickmarksCalculator.
  CalculateTickmarksPositions(AMajor: Boolean; ACount: Integer;
  var APositions: TdxPointsF);
  ...
  begin
    for I := 0 to FMinorValues.Count - 1 do
      AddPosition(ValuePercentToPoint(FMinorValues[I] /
        (FMajorValues.Count - 1)));
  end;
...
begin
  if IsLogarithmic then
    ...
    for I := 0 to ACount - 1 do
      if AMajor or FAllowOverlapping or
        (not FAllowOverlapping and (I mod FMinorValueCount <> 0)) then
...
procedure TdxGaugeQuantitativeScaleTickmarksCalculator.
  PopulateMajorTickmarksPositions(const APositions: TdxPointsF);
var
  I: Integer;
  AIndex: Integer;
  AValue: Single;
...
procedure TdxGaugeQuantitativeScaleTickmarksCalculator.
  PopulateMinorTickmarksPositions(const APositions: TdxPointsF);
var
  I: Integer;
  ATickmarkValue: TdxGaugeQuantitativeScaleTickmarkValue;
begin
...
begin
  ...
  AFiler.DefineProperty('MaxValue', ReadMaxValue, WriteMaxValue,
    IsMaxValueStored);
end;
...
procedure TdxGaugeQuantitativeScaleOptionsView.SetShowValueIndicator
  (const AValue: Boolean);
begin
...
procedure TdxGaugeQuantitativeScaleOptionsView.SetLogarithmicBase
  (const AValue: Single);
begin
  GetScale.SetLogarithmicBase(AValue);
end;

procedure TdxGaugeQuantitativeScaleOptionsView.SetMajorTickCount
  (const AValue: Integer);
begin
  GetScale.SetMajorTickCount(AValue);
end;

procedure TdxGaugeQuantitativeScaleOptionsView.SetMaxValue
  (const AValue: Single);
begin
  GetScale.SetMaxValue(AValue);
end;

procedure TdxGaugeQuantitativeScaleOptionsView.SetMinorTickCount
  (const AValue: Integer);
begin
  GetScale.SetMinorTickCount(AValue);
end;

procedure TdxGaugeQuantitativeScaleOptionsView.SetMinValue
  (const AValue: Single);
begin
...
procedure TdxGaugeQuantitativeScaleOptionsView.SetShowFirstTick
  (const AValue: Boolean);
begin
  GetScale.SetShowFirstTick(AValue);
end;

procedure TdxGaugeQuantitativeScaleOptionsView.SetShowLabels
  (const AValue: Boolean);
begin
  GetScale.SetShowLabels(AValue);
end;

procedure TdxGaugeQuantitativeScaleOptionsView.SetShowLastTick
  (const AValue: Boolean);
begin
  GetScale.SetShowLastTick(AValue);
end;

procedure TdxGaugeQuantitativeScaleOptionsView.SetShowTicks
  (const AValue: Boolean);
begin
  GetScale.SetShowTicks(AValue);
end;

function TdxGaugeQuantitativeScaleOptionsView.GetScale
  : TdxGaugeQuantitativeScale;
begin
...
function TdxGaugeQuantitativeScaleViewInfo.GetParametersClass
  : TdxGaugeCustomScaleParametersClass;
begin
  Result := TdxGaugeQuantitativeScaleParameters;
end;

function TdxGaugeQuantitativeScaleViewInfo.GetScaleInfoClass
...
procedure TdxGaugeQuantitativeScaleViewInfo.DoDrawLayer
  (AGPGraphics: TdxGPGraphics; ALayerIndex: Integer);
begin
...
begin
  ...
  FMajorTick := TdxGaugeScaleStyleAccess(Style)
    .GetElement(GetDefaultParameters.MajorTickType);
  FMinorTick := TdxGaugeScaleStyleAccess(Style)
    .GetElement(GetDefaultParameters.MinorTickType);
end;

procedure TdxGaugeQuantitativeScaleViewInfo.PopulateParameters
...
procedure TdxGaugeQuantitativeScaleViewInfo.DrawElements
  (AGPGraphics: TdxGPGraphics);
begin
  DrawTickmarks(AGPGraphics);
end;

function TdxGaugeQuantitativeScaleViewInfo.GetLabelTextRectSize
  (const AText: string): TdxSizeF;
var
  R: TdxRectF;
begin
  if FGpFont <> nil then
...
function TdxGaugeQuantitativeScaleViewInfo.ValueToPosition
  (AValue: Single): Single;
begin
  Result := FTickmarksCalculator.ValueToPoint(AValue).Y;
end;

procedure TdxGaugeQuantitativeScaleViewInfo.TickmarksChangeHandler
  (ASender: TObject);
var
  I: Integer;
begin
  ...
  for I := 0 to FTickmarksCalculator.Ticks.Count - 1 do
    if FTickmarksCalculator.Ticks[I].IsMajor then
      AddTickmark(FTickmarksCalculator.Ticks[I].Value,
        FTickmarksCalculator.Ticks[I].Position.Y, FMajorTickmarks)
    else
      AddTickmark(FTickmarksCalculator.Ticks[I].Value,
        FTickmarksCalculator.Ticks[I].Position.Y, FMinorTickmarks);
end;

function TdxGaugeQuantitativeScaleViewInfo.GetDefaultParameters
  : TdxGaugeQuantitativeScaleDefaultParameters;
begin
  Result := DefaultParameters as TdxGaugeQuantitativeScaleDefaultParameters;
end;

function TdxGaugeQuantitativeScaleViewInfo.GetParameters
  : TdxGaugeQuantitativeScaleParameters;
begin
  Result := FParameters as TdxGaugeQuantitativeScaleParameters;
end;

function TdxGaugeQuantitativeScaleViewInfo.GetTickmarkLabelText(AScaleParameters
  : TdxGaugeQuantitativeScaleParameters; AValue: Single): string;
const
...
var
  ...
  ATemp: string;
begin
  AValue := Min(Max(AValue, AScaleParameters.MinValue),
    AScaleParameters.MaxValue);
  Result := Format('%*.*f', [Pos(dxFormatSettings.DecimalSeparator,
    dxFloatToStr(AValue, dxFormatSettings.DecimalSeparator)),
    dxGaugeQuantitativeScalePrecision, AValue]);
  ATemp := Result;
...
procedure TdxGaugeQuantitativeScaleViewInfo.AddTickmark(AValue,
  APosition: Single; var ATickmarks: TdxGaugeQuantitativeScaleTickmarks);
var
  L: Integer;
begin
  L := Length(ATickmarks);
...
begin
  ...
  FTickmarksCalculator.AllowOverlapping :=
    GetDefaultParameters.AllowOverlapMajorTicks and
    (AScaleParameters.MinorTickCount > 0);
...
begin
  ...
  begin
    ...
    FMajorTickmarks[High(FMajorTickmarks)].TickDrawInfo.Visible :=
      AScaleParameters.ShowLastTick;
    FMajorTickmarks[High(FMajorTickmarks)].LabelDrawInfo.Visible :=
      AScaleParameters.ShowLastTick;
    FGpFont := dxGpCreateFont(Font);
    try
      for I := Low(FMajorTickmarks) to High(FMajorTickmarks) do
      begin
        FMajorTickmarks[I].LabelDrawInfo.Color :=
          dxColorToAlphaColor(Font.Color);
        FMajorTickmarks[I].LabelDrawInfo.Text :=
          GetTickmarkLabelText(AScaleParameters, FMajorTickmarks[I].Value);
        FMajorTickmarks[I].LabelDrawInfo.Rect := cxRectF(cxInvalidRect);
        if Assigned(FOnGetTickmarkLabelDrawInfo) then
          OnGetTickmarkLabelDrawInfo(Self, FMajorTickmarks[I].Value,
            FMajorTickmarks[I].LabelDrawInfo);
        if FMajorTickmarks[I].LabelDrawInfo.Rect = cxRectF(cxInvalidRect) then
          FMajorTickmarks[I].LabelDrawInfo.Rect :=
            GetLabelTextRect(FMajorTickmarks[I].Position,
            FMajorTickmarks[I].LabelDrawInfo.Text);
      end;
    finally
...
procedure TdxGaugeQuantitativeScaleViewInfo.CalculateTickmarksParameters;
  ...
  begin
    ...
    Result.Size.cx := Result.Size.cx *
      ADefaultParameters.MajorTickScaleFactor.X;
    Result.Size.cy := Result.Size.cy *
      ADefaultParameters.MajorTickScaleFactor.Y;
    Result.Visible := True;
  end;
  ...
  begin
    ...
    Result.Size := GetElementImageOriginalSize(Result.Image);
    Result.Size.cx := Result.Size.cx *
      ADefaultParameters.MinorTickScaleFactor.X;
    Result.Size.cy := Result.Size.cy *
      ADefaultParameters.MinorTickScaleFactor.Y;
    Result.Visible := True;
  end;
...
procedure TdxGaugeQuantitativeScaleViewInfo.DrawTickmarkLabel
  (AGPGraphics: TdxGPGraphics; APosition: Single;
  const ADrawInfo: TdxGaugeQuantitativeScaleTickmarkLabelDrawInfo);
{$IFDEF DELPHIXE}
var
...
procedure TdxGaugeQuantitativeScaleViewInfo.DrawTickmarkLabels
  (AGPGraphics: TdxGPGraphics);
var
  I: Integer;
begin
  if GetParameters.ShowLabels then
    for I := Low(FMajorTickmarks) to High(FMajorTickmarks) do
      DrawTickmarkLabel(AGPGraphics, FMajorTickmarks[I].Position,
        FMajorTickmarks[I].LabelDrawInfo);
end;

procedure TdxGaugeQuantitativeScaleViewInfo.DrawTickmarkTick
  (AGPGraphics: TdxGPGraphics; const ATick: TdxGaugeQuantitativeScaleTickmark;
  const ADrawInfo: TdxGaugeQuantitativeScaleTickmarkTickDrawInfo);
begin
...
procedure TdxGaugeQuantitativeScaleViewInfo.DrawTickmarkTicks
  (AGPGraphics: TdxGPGraphics);
...
procedure TdxGaugeQuantitativeScaleViewInfo.DrawTickmarks
  (AGPGraphics: TdxGPGraphics);
begin
...
procedure TdxGaugeQuantitativeScaleViewInfo.DrawValueIndicator
  (AGPGraphics: TdxGPGraphics);
begin
...
class function TdxGaugeQuantitativeScale.GetStyleReaderClass
...
function TdxGaugeQuantitativeScale.GetOptionsViewClass
  : TdxGaugeCustomScaleOptionsViewClass;
begin
  Result := TdxGaugeQuantitativeScaleOptionsView;
end;

function TdxGaugeQuantitativeScale.GetParametersClass
  : TdxGaugeCustomScaleParametersClass;
begin
  Result := TdxGaugeQuantitativeScaleParameters;
end;

function TdxGaugeQuantitativeScale.GetViewInfoClass
  : TdxGaugeCustomScaleViewInfoClass;
begin
  Result := TdxGaugeQuantitativeScaleViewInfo;
end;

function TdxGaugeQuantitativeScale.GetValidValue(const AValue: Variant)
  : Variant;
var
  AScaleParameters: TdxGaugeQuantitativeScaleParameters;
begin
  AScaleParameters := GetParameters;
  Result := Min(Max(AValue, AScaleParameters.MinValue),
    AScaleParameters.MaxValue);
end;
...
procedure TdxGaugeQuantitativeScale.DrawScaleComponents
  (AGPGraphics: TdxGPGraphics; ALayerIndex: Integer);
begin
...
procedure TdxGaugeQuantitativeScale.GetChildren(AProc: TGetChildProc;
  ARoot: TComponent);
begin
...
function TdxGaugeQuantitativeScale.GetAnimationControllerClass
  : TdxGaugeQuantitativeScaleAnimationControllerClass;
begin
...
procedure TdxGaugeQuantitativeScale.SetShowValueIndicator
  (const AValue: Boolean);
begin
...
function TdxGaugeQuantitativeScale.GetOnGetTickmarkLabelDrawInfo
  : TdxGaugeQuantitativeScaleGetTickmarkLabelDrawInfoEvent;
begin
  Result := GetViewInfo.OnGetTickmarkLabelDrawInfo;
end;

function TdxGaugeQuantitativeScale.GetOptionsAnimate
  : TdxGaugeQuantitativeScaleOptionsAnimate;
begin
...
begin
  if (GetParameters.LogarithmicBase <> AValue) and (AValue >= 0) and
    (AValue <> 1) then
  begin
...
begin
  ...
  begin
    ...
    if (GetParameters.MajorTickCount = GetViewInfo.GetDefaultParameters.
      MajorTickCount) and not IsReading then
...
begin
  AParameters := GetParameters;
  if (AParameters.MaxValue <> AValue) and
    ((AValue > AParameters.MinValue) or IsReading) then
  begin
...
begin
  if (GetParameters.MinorTickCount <> AValue) and (AValue >= 0) or IsReading
  then
  begin
    GetParameters.MinorTickCount := AValue;
    if (GetParameters.MinorTickCount = GetViewInfo.GetDefaultParameters.
      MinorTickCount) and not IsReading then
...
begin
  AParameters := GetParameters;
  if (AParameters.MinValue <> AValue) and
    ((AValue < AParameters.MaxValue) or IsReading) then
  begin
...
procedure TdxGaugeQuantitativeScale.SetOnAnimationComplete
...
procedure TdxGaugeQuantitativeScale.SetOnGetTickmarkLabelDrawInfo
  (const AValue: TdxGaugeQuantitativeScaleGetTickmarkLabelDrawInfoEvent);
begin
...
procedure TdxGaugeQuantitativeScale.SetOptionsAnimate
  (const AValue: TdxGaugeQuantitativeScaleOptionsAnimate);
begin
  FAnimationController.OptionsAnimate.Assign(AValue);
end;

procedure TdxGaugeQuantitativeScale.SetRanges(const AValue
  : TdxGaugeRangeCollection);
begin
...
begin
  ...
  begin
    ...
    if GetParameters.ShowFirstTick = GetViewInfo.GetDefaultParameters.ShowFirstTick
    then
...
begin
  ...
  begin
    ...
    if GetParameters.ShowLabels = GetViewInfo.GetDefaultParameters.ShowLabels
    then
...
begin
  ...
  begin
    ...
    if GetParameters.ShowLastTick = GetViewInfo.GetDefaultParameters.ShowLastTick
    then
...
begin
  ...
  begin
    ...
    if GetParameters.ShowTicks = GetViewInfo.GetDefaultParameters.ShowLastTick
    then
...
procedure TdxGaugeQuantitativeScale.RangeChangeHandler(Sender: TObject;
  AItem: TcxComponentCollectionItem;
  AAction: TcxComponentCollectionNotification);
begin
  ScaleChanged([sclDynamicLayer]);
...
function TdxGaugeQuantitativeScale.GetParameters
  : TdxGaugeQuantitativeScaleParameters;
begin
  Result := Parameters as TdxGaugeQuantitativeScaleParameters;
end;

function TdxGaugeQuantitativeScale.GetViewInfo
  : TdxGaugeQuantitativeScaleViewInfo;
begin
...
begin
  AScaleParameters := GetParameters;
  AScaleParameters.Value :=
    Min(Max(AScaleParameters.Value, AScaleParameters.MinValue),
    AScaleParameters.MaxValue);
end;
...
procedure TdxGaugeQuantitativeScale.DrawRanges(AGPGraphics: TdxGPGraphics;
  ALayerIndex: Integer);
var
  I: Integer;
begin
...
begin
  Result := (spvFontColor in FAssignedValues) or
    (spvFontName in FAssignedValues) or (spvFontSize in FAssignedValues);
end;
...
function TdxGaugeQuantitativeScaleStyleReader.GetDefaultParametersClass
  : TdxGaugeCustomScaleDefaultParametersClass;
begin
...
procedure TdxGaugeQuantitativeScaleStyleReader.ReadCommonScaleParameters
  (ANode: TdxXMLNode; AParameters: TdxGaugeQuantitativeScaleDefaultParameters);
var
...
procedure TdxGaugeQuantitativeScaleStyleReader.
  ReadCustomQuantitativeScaleParameters(ANode: TdxXMLNode;
  AParameters: TdxGaugeQuantitativeScaleDefaultParameters);
begin
  ReadCommonScaleParameters(ANode, AParameters);
end;

procedure TdxGaugeQuantitativeScaleStyleReader.ReadFontParameters
  (ANode: TdxXMLNode; AParameters: TdxGaugeCustomScaleDefaultParameters);
var
...
begin
  ...
  begin
    AScaleDefaultParameters :=
      AParameters as TdxGaugeQuantitativeScaleDefaultParameters;
    AScaleDefaultParameters.FontColor := GetAttributeValueAsColor
      (GetChildNode(AFontNode, 'Color'), 'Value');
    AScaleDefaultParameters.FontName := GetAttributeValueAsString
      (GetChildNode(AFontNode, 'Name'), 'Value');
    AScaleDefaultParameters.FontSize := GetAttributeValueAsInteger
      (GetChildNode(AFontNode, 'Size'), 'Value');
  end;
end;

procedure TdxGaugeQuantitativeScaleStyleReader.ReadLabelsParameters
  (ANode: TdxXMLNode; AParameters: TdxGaugeQuantitativeScaleDefaultParameters);
var
...
begin
  ...
  begin
    AParameters.LabelOffset := GetAttributeValueAsDouble
      (GetChildNode(ALabelsNode, 'Offset'), 'Value');
    AParameters.ShowLabels := GetAttributeValueAsBoolean
      (GetChildNode(ALabelsNode, 'ShowLabels'), 'Value');
  end;
end;

procedure TdxGaugeQuantitativeScaleStyleReader.ReadMajorTicksParameters
  (ANode: TdxXMLNode; AParameters: TdxGaugeQuantitativeScaleDefaultParameters);
var
...
begin
  ...
  begin
    AParameters.MajorTickCount := GetAttributeValueAsInteger
      (GetChildNode(AMajorTicksNode, 'Count'), 'Value');
    AParameters.MajorTickOffset := GetAttributeValueAsDouble
      (GetChildNode(AMajorTicksNode, 'Offset'), 'Value');
    AParameters.MajorTickScaleFactor := GetAttributeValueAsPointF
      (GetChildNode(AMajorTicksNode, 'ScaleFactor'), 'Value');
    AParameters.MajorTickType := GetAttributeValueAsElementType
      (GetChildNode(AMajorTicksNode, 'TickType'), 'Value');
  end;
end;

procedure TdxGaugeQuantitativeScaleStyleReader.ReadMinorTicksParameters
  (ANode: TdxXMLNode; AParameters: TdxGaugeQuantitativeScaleDefaultParameters);
var
...
begin
  ...
  begin
    AParameters.MinorTickCount := GetAttributeValueAsInteger
      (GetChildNode(AMinorTicksNode, 'Count'), 'Value');
    AParameters.MinorTickOffset := GetAttributeValueAsDouble
      (GetChildNode(AMinorTicksNode, 'Offset'), 'Value');
    AParameters.MinorTickScaleFactor := GetAttributeValueAsPointF
      (GetChildNode(AMinorTicksNode, 'ScaleFactor'), 'Value');
    AParameters.MinorTickType := GetAttributeValueAsElementType
      (GetChildNode(AMinorTicksNode, 'TickType'), 'Value');
  end;
end;

procedure TdxGaugeQuantitativeScaleStyleReader.ReadTicksVisibility
  (ANode: TdxXMLNode; AParameters: TdxGaugeQuantitativeScaleDefaultParameters);
var
...
begin
  ...
  begin
    AParameters.AllowOverlapMajorTicks := GetAttributeValueAsBoolean
      (GetChildNode(ATicksVisibilityNode, 'AllowOverlapMajorTicks'), 'Value');
    AParameters.ShowFirstTick := GetAttributeValueAsBoolean
      (GetChildNode(ATicksVisibilityNode, 'ShowFirstTick'), 'Value');
    AParameters.ShowLastTick := GetAttributeValueAsBoolean
      (GetChildNode(ATicksVisibilityNode, 'ShowLastTick'), 'Value');
    AParameters.ShowTicks := GetAttributeValueAsBoolean
      (GetChildNode(ATicksVisibilityNode, 'ShowTicks'), 'Value');
  end;
end;
...
function TdxGaugeCustomRangeViewInfo.GetParametersClass
  : TdxGaugeCustomRangeParametersClass;
begin
...
procedure TdxGaugeCustomRangeViewInfo.Calculate(AParameters
  : TdxGaugeCustomRangeParameters; AScaleInfo: TdxGaugeCustomScaleInfo);
var
  AScaleValuePosition: Single;
begin
  FScaleInfo := AScaleInfo as TdxGaugeQuantitativeScaleInfo;
  FParameters.Assign(AParameters);
  FParameters.ValueEndPosition := FScaleInfo.GetValuePositionFunc
    (FParameters.ValueEnd);
  FParameters.ValueStartPosition := FScaleInfo.GetValuePositionFunc
    (FParameters.ValueStart);
...
function TdxGaugeCustomRange.GetCollectionFromParent(AParent: TComponent)
...
begin
  inherited DefineProperties(AFiler);
  AFiler.DefineProperty('WidthFactor', ReadWidthFactor, WriteWidthFactor,
    SameValue(WidthFactor, 0));
end;

function TdxGaugeCustomRange.GetParametersClass
  : TdxGaugeCustomRangeParametersClass;
begin
  Result := TdxGaugeCustomRangeParameters;
end;
...
begin
  ...
  FParameters.ValueEnd := Max(Min(FParameters.ValueEnd, AInfo.MaxValue),
    AInfo.MinValue);
  FParameters.ValueStart := Max(Min(FParameters.ValueStart, AInfo.MaxValue),
    AInfo.MinValue);
...
function TdxGaugeCustomRange.GetLinkedWithScaleValue
  : TdxGaugeScaleRangeValueLinkedWithScaleValue;
begin
...
procedure TdxGaugeCustomRange.SetLinkedWithScaleValue
  (const AValue: TdxGaugeScaleRangeValueLinkedWithScaleValue);
begin
...
begin
  Result := not SameValue(RoundTo(FParameters.WidthFactor, -5),
    dxGaugeCustomRangeWidthFactor);
end;
...
procedure TdxGaugeRangeCollection.SetRange(AIndex: Integer;
  const AValue: TdxGaugeCustomRange);
begin
...
procedure TdxGaugeQuantitativeScaleCaptionOptionsView.FontChangeHandler
  (ASender: TObject);
begin
...
procedure TdxGaugeQuantitativeScaleCaptionOptionsView.SetUseOwnFont
  (const AValue: Boolean);
begin
...
function TdxGaugeQuantitativeScaleCaptionOptionsView.GetParameters
  : TdxGaugeQuantitativeScaleCaptionParameters;
begin
...
function TdxGaugeQuantitativeScaleCaptionViewInfo.GetParametersClass
...
function TdxGaugeQuantitativeScaleCaption.GetOptionsViewClass
  : TdxGaugeCustomCaptionOptionsViewClass;
begin
  Result := TdxGaugeQuantitativeScaleCaptionOptionsView;
end;

function TdxGaugeQuantitativeScaleCaption.GetParametersClass
  : TdxGaugeCustomCaptionParametersClass;
begin
  Result := TdxGaugeQuantitativeScaleCaptionParameters;
end;

function TdxGaugeQuantitativeScaleCaption.GetViewInfoClass
  : TdxGaugeCustomCaptionViewInfoClass;
begin
  Result := TdxGaugeQuantitativeScaleCaptionViewInfo;
end;

function TdxGaugeQuantitativeScaleCaption.GetFont
  (AScaleInfo: TdxGaugeCustomScaleInfo): TFont;
begin
...
function TdxGaugeQuantitativeScaleCaption.GetOptionsView
  : TdxGaugeQuantitativeScaleCaptionOptionsView;
begin
...
procedure TdxGaugeQuantitativeScaleCaption.SetOptionsView
  (const AValue: TdxGaugeQuantitativeScaleCaptionOptionsView);
begin
...
constructor TdxGaugeQuantitativeScaleCustomOptionsAnimate.Create
  (AOwner: TPersistent);
begin
  inherited Create(AOwner);
...
procedure TdxGaugeQuantitativeScaleCustomOptionsAnimate.Assign
  (ASource: TPersistent);
begin
  if ASource is TdxGaugeQuantitativeScaleCustomOptionsAnimate then
  begin
    TransitionEffect :=
      (ASource as TdxGaugeQuantitativeScaleCustomOptionsAnimate)
      .TransitionEffect;
    TransitionEffectMode :=
      (ASource as TdxGaugeQuantitativeScaleCustomOptionsAnimate)
      .TransitionEffectMode;
    Enabled :=
      (ASource as TdxGaugeQuantitativeScaleCustomOptionsAnimate).Enabled;
    Interval :=
      (ASource as TdxGaugeQuantitativeScaleCustomOptionsAnimate).Interval;
  end
  else
    inherited Assign(ASource);
end;
...
procedure TdxGaugeQuantitativeScaleCustomOptionsAnimate.SetTransitionEffect
  (const AValue: TdxGaugeQuantitativeScaleAnimationTransitionEffect);
begin
...
procedure TdxGaugeQuantitativeScaleCustomOptionsAnimate.SetTransitionEffectMode
  (const AValue: TdxAnimationTransitionEffectMode);
begin
...
procedure TdxGaugeQuantitativeScaleCustomOptionsAnimate.SetEnabled
  (const AValue: Boolean);
begin
...
procedure TdxGaugeQuantitativeScaleCustomOptionsAnimate.SetFrameCount
  (const AValue: Integer);
begin
...
procedure TdxGaugeQuantitativeScaleCustomOptionsAnimate.SetInterval
  (const AValue: Integer);
begin
...
constructor TdxGaugeQuantitativeScaleAnimationController.Create
  (AOwner: TdxGaugeQuantitativeScale);
begin
  inherited Create;
  FScale := AOwner;
...
function TdxGaugeQuantitativeScaleAnimationController.GetOptionsAnimateClass
  : TdxGaugeQuantitativeScaleOptionsAnimateClass;
begin
  Result := TdxGaugeQuantitativeScaleOptionsAnimate;
end;

procedure TdxGaugeQuantitativeScaleAnimationController.Animate(ACurrentValue,
  ANextValue: Single);
begin
...
function TdxGaugeQuantitativeScaleAnimationController.IsFinished
  (AAnimation: TdxAnimationTransition): Boolean;
begin
  Result := TdxAnimationTransitionAccess(AAnimation)
    .Finish = TdxAnimationTransitionAccess(AAnimation).Current;
end;

procedure TdxGaugeQuantitativeScaleAnimationController.CreateTransition;
begin
  FTransition := TdxAnimationTransition.Create(OptionsAnimate.Interval,
    OptionsAnimate.TransitionEffect, OptionsAnimate.FrameCount,
    OptionsAnimate.TransitionEffectMode);
...
procedure TdxGaugeQuantitativeScaleAnimationController.AnimateHandler
  (ASender: TdxAnimationTransition; var APosition: Integer;
...
procedure TdxGaugeQuantitativeScaleAnimationController.
  OptionsAnimateChangeHandler(ASender: TObject);
begin
  RecreateTransition;
