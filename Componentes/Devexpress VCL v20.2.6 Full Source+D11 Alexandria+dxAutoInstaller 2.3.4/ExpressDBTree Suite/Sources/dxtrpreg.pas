...
begin
  ...
  RegisterPropertyEditor(TypeInfo(string), TdxDBTreePrintData, 'KeyField',
    TDBTreePrnDataFieldProperty);
  RegisterPropertyEditor(TypeInfo(string), TdxDBTreePrintData, 'ParentField',
    TDBTreePrnDataFieldProperty);
end;
