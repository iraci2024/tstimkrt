...
uses
  ...
  dxMapControlHttpRequest, dxBingMapRESTService, dxRESTService,
...
begin
  (Params as TdxBingMapRESTServiceImageryParams).ImagerySetKind :=
    AImagerySetKind;
  (Params as TdxBingMapRESTServiceImageryParams).ConnectionProtocol :=
    ConnectionProtocol;
  Execute;
end;
...
procedure TdxBingMapImageryDataServiceResponse.ParseResource(ANode: TdxXMLNode);
begin
...
begin
  ...
  begin
    ATempNode.ForEach(procedure(ANode: TdxXMLNode; AData: Pointer)
      begin
