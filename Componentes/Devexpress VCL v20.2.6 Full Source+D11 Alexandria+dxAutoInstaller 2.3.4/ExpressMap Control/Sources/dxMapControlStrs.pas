...
dxResourceStringsRepository.RegisterProduct('ExpressMapControl',
  @AddMapControlResourceStringNames);

finalization

dxResourceStringsRepository.UnRegisterProduct('ExpressMapControl',
  @AddMapControlResourceStringNames);
