...
type
  ...
  public
    ...
    function GetMapSizeInPixels(AZoomLevel: Double): TdxSizeDouble; virtual;
      abstract; // for internal use
    procedure PrepareData; virtual; // for internal use
    procedure StartLoadTiles; // for internal use

    property CacheOptions: TdxMapControlCacheOptions read FCacheOptions
      write SetCacheOptions;
    property MaxParallelConnectionCount: Integer
      read FMaxParallelConnectionCount write SetMaxParallelConnectionCount
      stored IsMaxParallelConnectionCountStored;
    property Projection: TdxMapControlCustomProjection read FProjection
      write SetProjection; // for internal use
...
function TdxMapControlImageTileProvider.CreateProjection
  : TdxMapControlCustomProjection;
begin
  Result := TdxMapControlSphericalMercatorProjection.Create(nil);
end;

function TdxMapControlImageTileProvider.CreateTileSource
...
begin
  ...
  begin
    ...
    MaxParallelConnectionCount := TdxMapControlImageTileProvider(Source)
...
function TdxMapControlImageTileProvider.
  IsMaxParallelConnectionCountStored: Boolean;
begin
