...
uses
  ...
  cxClasses, cxControls, cxGeometry, dxAnimation, dxCore, dxCoreClasses,
  cxLookAndFeels,
  dxCoreGraphics, cxGraphics, cxLookAndFeelPainters, dxGdiPlusClasses,
  dxTypeHelpers, dxScreenTip,
...
type
  ...
  published
    ...
    property CoordinateTextColor: TColor read FCoordinateTextColor
      write SetCoordinateTextColor default clDefault;
    property ElementColor: TdxAlphaColor read FElementColor
      write SetElementColor default dxacDefault;
    property ElementHotColor: TdxAlphaColor read FElementHotColor
      write SetElementHotColor default dxacDefault;
    property ElementPressedColor: TdxAlphaColor read FElementPressedColor
      write SetElementPressedColor default dxacDefault;
    property ScaleFont: TFont read FScaleFont write SetScaleFont;
    property ScaleTextColor: TColor read FScaleTextColor write SetScaleTextColor
      default clDefault;
  end;
  ...
  published
    ...
    property ShowCoordinates: Boolean read FShowCoordinates
      write SetShowCoordinates default True;
    property ShowKilometersScale: Boolean read FShowKilometersScale
      write SetShowKilometersScale default True;
    property ShowMilesScale: Boolean read FShowMilesScale
      write SetShowMilesScale default True;
    property ShowScrollButtons: Boolean read FShowScrollButtons
      write SetShowScrollButtons default True;
    property ShowZoomTrackBar: Boolean read FShowZoomTrackBar
      write SetShowZoomTrackBar default True;
    property Style: TdxMapControlNavigationPanelStyle read FStyle
      write SetStyle;
    property Visible: Boolean read FVisible write SetVisible default True;
    property XCoordinateDisplayMask: string read FXCoordinateDisplayMask
      write SetXCoordinateDisplayMask;
    property YCoordinateDisplayMask: string read FYCoordinateDisplayMask
      write SetYCoordinateDisplayMask;
  end;
  ...
  published
    ...
    property InertialScrolling: Boolean read FInertialScrolling
      write FInertialScrolling default True;
    property MapItemSelectMode: TdxMapItemSelectMode read FMapItemSelectMode
      write SetMapItemSelectMode default mismExtended;
  ...
  private
    ...
    procedure DoZoomAnimation(Sender: TdxAnimationTransition;
...
{$ENDREGION}
  ...
  TdxMapControlCenterPointChangingEvent = procedure(Sender: TObject;
    var ANewCenterPoint: TdxMapControlGeoPoint; var AAllow: Boolean) of object;
  TdxMapControlSelectionChangingEvent = procedure(Sender: TObject;
    AItem: TdxMapItem; var AAllow: Boolean) of object;
  TdxMapControlZoomLevelChangingEvent = procedure(Sender: TObject;
    ANewZoomLevel: Double; var AAllow: Boolean) of object;
  ...
  private
    ...
    function AllowCenterPointChanges(var AValue: TdxMapControlGeoPoint)
      : Boolean;
    ...
    procedure SetInformationProviders(const Value
  ...
  protected
    ...
    procedure CalculateZoomAndCenterPointForRegion(const ARect: TdxRectDouble;
      const APaddingFactor: Double; out AZoomLevel: Double;
      out ACenterPoint: TdxMapControlGeoPoint);
    ...
    function GetKilometersScale(ACenterPoint: TdxMapControlGeoPoint;
      AScreenDistance: Double): Double;
    ...
    function ScreenPointToGeoPoint(APoint: TdxPointDouble)
      : TdxMapControlGeoPoint;
    procedure ScrollMap(X, Y: Integer);
    procedure SelectMapItemsInRegion(const ARect: TRect);
    procedure UpdateViewPort;
    procedure Zoom(AZoomLevel: Double; const AAnchorPoint: TdxPointDouble;
      AAnimated: Boolean; AIsAsyncMode: Boolean = False); overload;
    procedure ZoomToRegion(const ARect: TRect); overload;
    procedure ZoomToRegion(const ARect: TdxRectDouble;
      const APaddingFactor
      : Double = dxMapControlDefaultZoomPaddingFactor); overload;
    ...
    function CreateAnimationController
      : TdxMapControlAnimationController; virtual;
    function CreateController: TdxMapControlController; virtual;
    function CreateMapItemsLayerSelectionController
      : TdxMapControlSelectionController; virtual;
    function CreateNavigationPanelOptions
      : TdxMapControlNavigationPanel; virtual;
    ...
    procedure DoSetCenterPoint(const AValue: TdxMapControlGeoPoint;
      AIsUserAction: Boolean = False);
  ...
  public
    ...
    procedure ZoomToFitItems(AItems: TdxMapItemList;
      const APaddingFactor: Double = dxMapControlDefaultZoomPaddingFactor);
    procedure ZoomToGeoRect(const ARect: TdxMapControlGeoRect); overload;
    procedure ZoomToGeoRect(const ARect: TdxMapControlGeoRect;
      const APaddingFactor: Double); overload;
    ...
    property CenterPoint: TdxMapControlGeoLocation read FCenterPoint
      write SetCenterPoint;
    property Color: TColor read FColor write SetColor default clDefault;
    property HitTest: TdxMapControlHitTest read GetHitTest; // for internal use
    property InformationProviders: TdxMapControlInformationProviders
      read FInformationProviders write SetInformationProviders;
    property Layers: TdxMapLayers read FLayers write SetLayers;
    property NavigationPanel: TdxMapControlNavigationPanel read FNavigationPanel
      write SetNavigationPanel;
    property OptionsBehavior: TdxMapControlOptionsBehavior read FOptionsBehavior
      write SetOptionsBehavior;
    property SelectedMapItemCount: Integer read GetSelectedMapItemCount;
    property SelectedMapItems[Index: Integer]: TdxMapItem
      read GetSelectedMapItems;
    property ZoomLevel: Double read FZoomLevel write SetZoomLevel
      stored IsZoomLevelStored;
    property OnCenterPointChanged: TNotifyEvent read FOnCenterPointChanged
      write FOnCenterPointChanged;
    property OnCenterPointChanging: TdxMapControlCenterPointChangingEvent
      read FOnCenterPointChanging write FOnCenterPointChanging;
    property OnSelectionChanged: TNotifyEvent read FOnSelectionChanged
      write FOnSelectionChanged;
    property OnSelectionChanging: TdxMapControlSelectionChangingEvent
      read FOnSelectionChanging write FOnSelectionChanging;
    property OnZoomLevelChanged: TNotifyEvent read FOnZoomLevelChanged
      write FOnZoomLevelChanged;
    property OnZoomLevelChanging: TdxMapControlZoomLevelChangingEvent
      read FOnZoomLevelChanging write FOnZoomLevelChanging;
  end;
...
procedure TdxMapControlNavigationPanelStyle.SetCoordinateTextColor
  (Value: TColor);
begin
...
procedure TdxMapControlNavigationPanelStyle.SetElementColor
  (Value: TdxAlphaColor);
begin
...
procedure TdxMapControlNavigationPanelStyle.SetElementHotColor
  (Value: TdxAlphaColor);
begin
...
procedure TdxMapControlNavigationPanelStyle.SetElementPressedColor
  (Value: TdxAlphaColor);
begin
...
procedure TdxMapControlNavigationPanel.SetStyle
  (AValue: TdxMapControlNavigationPanelStyle);
begin
...
procedure TdxMapControlNavigationPanel.SetXCoordinateDisplayMask
  (const AValue: string);
begin
...
procedure TdxMapControlNavigationPanel.SetYCoordinateDisplayMask
  (const AValue: string);
begin
...
begin
  ...
  begin
    ...
    FInertialScrolling := TdxMapControlOptionsBehavior(Source)
      .InertialScrolling;
    FMapItemSelectMode := TdxMapControlOptionsBehavior(Source)
      .MapItemSelectMode;
...
begin
  ...
  FZoomPositionScale := (FNewLevel - FZoomLevel) /
    dxMapControlZoomAnimationFrameCount;
  FreeAndNil(FZoomAnimation);
  FZoomAnimation := TdxAnimationTransition.Create
    (dxMapControlZoomAnimationInterval, ateAccelerateDecelerate,
    dxMapControlZoomAnimationFrameCount);
...
procedure TdxMapControlAnimationController.Zoom(ANewZoomValue: Double;
  const AAnchorPoint: TdxPointDouble; AAnimated: Boolean = True;
  AIsAsyncMode: Boolean = False);
begin
  ...
  begin
    ...
    try
      if FMapControl.GetBaseLayer <> nil then
        ANewCenterPoint := FMapControl.GetBaseLayer.MoveAndZoom
          (FMapControl.CenterPoint.GeoPoint, FAnchorPoint, FZoomLevel,
          AZoomLevel)
      else
...
procedure TdxMapControlAnimationController.DoZoomAnimationTerminate
  (Sender: TObject);
begin
...
begin
  if (FSelection.IndexOf(AItem) <> -1) and
    not FMapControl.AllowSelectionChanging(AItem) then
    Exit;
...
procedure TdxMapControlSelectionController.Select(AItem: TdxMapItem;
  AShift: TShiftState);
begin
  if ssCtrl in AShift then
    if FSelection.IndexOf(AItem) = -1 then
      ...
      Deselect(AItem)
  else if FSelection.IndexOf(AItem) = -1 then
  begin
    FMapControl.BeginSelection;
    try
      ClearSelection;
...
constructor TdxMapControlInertialScrollingController.Create
  (AOwner: TdxCustomMapControl);
begin
  inherited Create;
  FMapControl := AOwner;
...
begin
  ...
  if ASpeed > 0 then
  begin
    FDeceleration.X := -dxMapControlInertialScrollingDecelerationRatio *
      FSpeed.X / ASpeed;
    FDeceleration.Y := -dxMapControlInertialScrollingDecelerationRatio *
      FSpeed.Y / ASpeed;
...
procedure TdxMapControlInertialScrollingController.InertiaTimer
  (Sender: TObject);
var
  ATimeDelta: Double;
  AOffset: TPoint;
...
begin
  ...
  begin
    AOffset.X := -Round(FSpeed.X * ATimeDelta + FDeceleration.X *
      Sqr(ATimeDelta) / 2);
    AOffset.Y := -Round(FSpeed.Y * ATimeDelta + FDeceleration.Y *
      Sqr(ATimeDelta) / 2);
...
procedure TdxMapControlInertialScrollingController.TrackSpeedTimer
  (Sender: TObject);
begin
  CheckSpeedValue;
end;
...
procedure TdxMapControlInertialScrollingController.TInertiaCalculator.AddItem
  (const AItem: TdxPointDouble);
begin
  FItems.Add(AItem);
...
function TdxMapControlInertialScrollingController.TInertiaCalculator.GetValue
  : TdxPointDouble;
var
...
function TdxMapControlInertialScrollingController.TInertiaCalculator.
  GetCount: Integer;
begin
  Result := FItems.Count;
end;
...
function TdxMapControlInertialScrollingController.TSpeedCalculator.
  CheckSpeedValue(out AValue: TdxPointDouble): Boolean;
var
...
function TdxCustomMapControl.AllowCenterPointChanges
  (var AValue: TdxMapControlGeoPoint): Boolean;
begin
  Result := True;
...
procedure TdxCustomMapControl.Select(AMapItem: TdxMapItem;
  AShiftState: TShiftState = []; ACheckSelectionMode: Boolean = True);
begin
  if not ACheckSelectionMode or CanSelect then
  begin
    if ACheckSelectionMode and (OptionsBehavior.MapItemSelectMode = mismSingle)
    then
      AShiftState := [];
...
procedure TdxCustomMapControl.ZoomToFitLayerItems
...
procedure TdxCustomMapControl.ChangeScaleEx(M, D: Integer;
  isDpiChange: Boolean);
begin
  inherited;
  BeginUpdate;
...
function TdxCustomMapControl.DoMouseWheel(Shift: TShiftState;
  WheelDelta: Integer; MousePos: TPoint): Boolean;
begin
  Result := inherited DoMouseWheel(Shift, WheelDelta, MousePos);
  if not Result and (WheelDelta <> 0) and CanZoom and
    (DragAndDropState = ddsNone) then
  begin
    Zoom(ZoomLevel + WheelDelta / WHEEL_DELTA,
      dxPointDouble(ScreenToClient(MousePos)), CanAnimate, True);
    Result := True;
  end;
end;
...
procedure TdxCustomMapControl.DragAndDrop(const P: TPoint;
...
var
  ...
  ANewGeoPoint: TdxMapControlGeoPoint;
begin
  Accepted := (FDragMode = mcdaScroll) and CanScroll or
    (FDragMode in [mcdaSelect, mcdaZoom]);
  ...
  begin
    ...
    case FDragMode of
      ...
      cxRectIntersect(ASelectedRegion, cxPointsBox([MouseDownPos, P]),
        ClientBounds);
...
begin
  ...
  else if ADragMode = mcdaZoom then
...
function TdxCustomMapControl.GetDragAndDropObjectClass
...
begin
  Result := not Controller.HitTest.HitAtNavigationPanel and
    (GetBaseLayer <> nil);
  if Result then
  begin
    ...
    else if CanZoom and (FShift * [ssShift, ssCtrl] = [ssShift, ssCtrl]) then
      FDragMode := mcdaZoom
    else if CanScroll then
    begin
...
procedure TdxCustomMapControl.CalculateZoomAndCenterPointForRegion
  (const ARect: TdxRectDouble; const APaddingFactor: Double;
  out AZoomLevel: Double; out ACenterPoint: TdxMapControlGeoPoint);
var
  ALayer: TdxMapLayer;
...
begin
  ...
  begin
    ...
    begin
      ...
      ARectInPixels.BottomRight := ALayer.MapUnitToScreenPoint
        (ARect.BottomRight);
      ...
      AIsAdjustByHeight := ARectInPixels.Height / AViewPortInPixels.cy >
        ARectInPixels.Width / AViewPortInPixels.cx;
      if AIsAdjustByHeight then
        AZoomDelta := Log2(AViewPortInPixels.cy * (1 - APaddingFactor) /
          ARectInPixels.Height)
      else
        AZoomDelta := Log2(AViewPortInPixels.cx * (1 - APaddingFactor) /
          ARectInPixels.Width);
    end
    else
      AZoomDelta := 0;
    ACenterPoint := ALayer.ScreenPointToGeoPoint
      (ALayer.MapUnitToScreenPoint(dxPointDouble(ARect.Left + ARect.Width / 2,
...
function TdxCustomMapControl.GetKilometersScale(ACenterPoint
  : TdxMapControlGeoPoint; AScreenDistance: Double): Double;
begin
  if GetBaseLayer <> nil then
...
procedure TdxCustomMapControl.LayersChanged(Sender: TObject;
...
function TdxCustomMapControl.ScreenPointToGeoPoint(APoint: TdxPointDouble)
  : TdxMapControlGeoPoint;
begin
  if GetBaseLayer <> nil then
...
begin
  ...
  begin
    ...
    FAnimationController.Zoom(AZoomLevel, AAnchorPoint, AReallyAnimated,
      AIsAsyncMode);
...
begin
  ...
  begin
    AMapRect := dxRectDouble(ALayer.ScreenPointToMapUnit
      (dxPointDouble(ARect.TopLeft)),
...
var
  ...
  ACenterPoint: TdxMapControlGeoPoint;
begin
  CalculateZoomAndCenterPointForRegion(ARect, APaddingFactor, AZoomLevel,
    ACenterPoint);
...
function TdxCustomMapControl.CreateAnimationController
  : TdxMapControlAnimationController;
begin
...
function TdxCustomMapControl.CreateMapItemsLayerSelectionController
  : TdxMapControlSelectionController;
begin
  Result := TdxMapControlSelectionController.Create(Self);
end;

function TdxCustomMapControl.CreateNavigationPanelOptions
  : TdxMapControlNavigationPanel;
begin
  Result := TdxMapControlNavigationPanel.Create(Self);
end;

function TdxCustomMapControl.CreateOptionsBehavior
  : TdxMapControlOptionsBehavior;
begin
...
begin
  ...
  FInformationProviders := TdxMapControlInformationProviders.Create(Self,
...
procedure TdxCustomMapControl.DoSetCenterPoint(const AValue
  : TdxMapControlGeoPoint; AIsUserAction: Boolean = False);
  ...
  if not dxMapControlGeoPointIsEqual(FCenterPoint.GeoPoint, AValue) then
    ...
    begin
      ...
      if AllowCenterPointChanges(ANewGeoPoint) and
        not dxMapControlGeoPointIsEqual(FCenterPoint.GeoPoint, ANewGeoPoint)
      then
      begin
...
procedure TdxCustomMapControl.GetChildren(Proc: TGetChildProc;
  Root: TComponent);
var
  I: Integer;
begin
...
procedure TdxCustomMapControl.SetInformationProviders
  (const Value: TdxMapControlInformationProviders);
begin
...
procedure TdxCustomMapControl.SetNavigationPanel
  (AValue: TdxMapControlNavigationPanel);
begin
