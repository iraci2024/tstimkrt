...
uses
  ...
  dxMapControlTypes, dxMapControlHttpRequest, dxRESTService,
  dxBingMapRESTService,
  dxMapControlInformationProvider, dxBingMapLocationDataService,
  dxBingMapRouteDataService;

type
  TdxMapControlBingMapInformationProvider = class
  ...
  private
    ...
    procedure SetConnectionProtocol(const Value
  ...
  protected
    ...
    procedure DoResponse(Sender: TObject; AResponse: TdxRestServiceResponse;
      var ADestroyResponse: Boolean); virtual;
  ...
  published
    ...
    property ConnectionProtocol: TdxMapControlConnectionProtocol
      read FConnectionProtocol write SetConnectionProtocol default cpDefault;
    property UserIp: string read GetUserIp write SetUserIp;
    property UseLocation: Boolean read GetUseLocation write SetUseLocation
      default False;
    property UseMapView: Boolean read GetUseMapView write SetUseMapView
      default False;
    property UserLocation: TdxMapControlGeoLocation read FUserLocation
      write SetUserLocation;
    property UserMapView: TdxMapControlGeoRectPersistent read FUserMapView
      write SetUserMapView;
  end;

  TdxBingMapLocationDataProviderResponseEvent = procedure(Sender: TObject;
    AResponse: TdxBingMapLocationDataServiceResponse;
    var ADestroyResponse: Boolean) of object;

  TdxMapControlBingMapCustomLocationDataProvider = class
  ...
  protected
    procedure DoAssign(Source: TPersistent); override;
    procedure DoResponse(Sender: TObject; AResponse: TdxRestServiceResponse;
      var ADestroyResponse: Boolean); override;
    property Params: TdxBingMapRESTServiceLocationParams read GetParams;
  published
    property IncludeNeighborhood: Boolean read GetIncludeNeighborhood
      write SetIncludeNeighborhood default True;
    property OnResponse: TdxBingMapLocationDataProviderResponseEvent
      read FOnResponse write FOnResponse;
  end;

  TdxMapControlBingMapGeoCodingDataProvider = class
  ...
  TdxMapControlBingMapReverseGeoCodingDataProvider = class
    (TdxMapControlBingMapCustomLocationDataProvider)
  private
  ...
  published
    property IncludeEntityTypes: TdxBingMapIncludeEntityTypes
      read GetIncludeEntityTypes write SetIncludeEntityTypes default [];
  end;
  ...
  TdxMapControlBingMapCustomRouteDataProvider = class
    (TdxMapControlBingMapInformationProvider)
  private
  ...
  published
    property DistanceUnit: TdxBingMapDistanceUnit read GetDistanceUnit
      write SetDistanceUnit default bmduKilometers;
    property RoutePathOutput: Boolean read GetRoutePathOutput
      write SetRoutePathOutput default True;
    property OnResponse: TdxBingMapRouteDataProviderResponseEvent
      read FOnResponse write FOnResponse;
  end;

  TdxMapControlBingMapRouteDataProvider = class
  ...
  published
    ...
    property ExcludeHighways: TdxBingMapExcludeRoadType read GetExcludeHighways
      write SetExcludeHighways default bmetNone;
    property ExcludeTolls: TdxBingMapExcludeRoadType read GetExcludeTolls
      write SetExcludeTolls default bmetNone;
    property MaxSolutions: Integer read GetMaxSolutions write SetMaxSolutions
      default 1;
    property Optimize: TdxBingMapOptimizeRouteType read GetOptimize
      write SetOptimize default bmorTime;
    property TimeType: TdxBingMapTransitTimeType read GetTimeType
      write SetTimeType default bmttArrival;
    property TravelMode: TdxBingMapTravelMode read GetTravelMode
      write SetTravelMode default bmtmDriving;
  end;

  TdxMapControlBingMapMajorRoadRouteDataProvider = class
    (TdxMapControlBingMapCustomRouteDataProvider)
  private
  ...
  protected
    function CreateService: TdxBingMapRESTService; override;
    procedure DoAssign(Source: TPersistent); override;
    property Params: TdxBingMapRESTServiceRoutesFromMajorRoadsParams
      read GetParams;
  public
  ...
  published
    property ExcludeRoutes: Boolean read GetExcludeRoutes write SetExcludeRoutes
      default False;
  end;
...
constructor TdxMapControlBingMapInformationProvider.Create(AOwner: TComponent);
begin
...
procedure TdxMapControlBingMapInformationProvider.DoAssign(Source: TPersistent);
var
...
procedure TdxMapControlBingMapInformationProvider.DoResponse(Sender: TObject;
  AResponse: TdxRestServiceResponse; var ADestroyResponse: Boolean);
begin
end;

function TdxMapControlBingMapInformationProvider.CreateService
...
function TdxMapControlBingMapInformationProvider.GetParams
...
procedure TdxMapControlBingMapInformationProvider.SetConnectionProtocol
  (const Value: TdxMapControlConnectionProtocol);
begin
...
begin
  ...
  begin
    ABingMapLocationDataProvider :=
      TdxMapControlBingMapCustomLocationDataProvider(Source);
...
begin
  if Assigned(FOnResponse) then
    FOnResponse(Self, AResponse as TdxBingMapLocationDataServiceResponse,
      ADestroyResponse);
end;

function TdxMapControlBingMapCustomLocationDataProvider.
  GetIncludeNeighborhood: Boolean;
begin
  Result := Params.IncludeNeighborhood;
end;

function TdxMapControlBingMapCustomLocationDataProvider.GetParams
...
function TdxMapControlBingMapGeoCodingDataProvider.CreateService
  : TdxBingMapRESTService;
begin
...
begin
  ...
  begin
    ABingMapGeoCodingDataProvider :=
      TdxMapControlBingMapGeoCodingDataProvider(Source);
...
function TdxMapControlBingMapGeoCodingDataProvider.GetParams
...
function TdxMapControlBingMapReverseGeoCodingDataProvider.CreateService
  : TdxBingMapRESTService;
begin
...
procedure TdxMapControlBingMapReverseGeoCodingDataProvider.DoAssign
  (Source: TPersistent);
var
  ABingMapReverseGeoCodingDataProvider
    : TdxMapControlBingMapReverseGeoCodingDataProvider;
begin
  inherited DoAssign(Source);
  ...
  begin
    ABingMapReverseGeoCodingDataProvider :=
      TdxMapControlBingMapReverseGeoCodingDataProvider(Source);
    IncludeEntityTypes := ABingMapReverseGeoCodingDataProvider.
      IncludeEntityTypes;
  end;
end;

function TdxMapControlBingMapReverseGeoCodingDataProvider.GetIncludeEntityTypes
  : TdxBingMapIncludeEntityTypes;
begin
  Result := Params.IncludeEntityTypes;
end;

function TdxMapControlBingMapReverseGeoCodingDataProvider.GetParams
...
begin
  ...
  begin
    ABingMapCustomRouteDataProvider :=
      TdxMapControlBingMapCustomRouteDataProvider(Source);
...
begin
  if Assigned(FOnResponse) then
    FOnResponse(Self, AResponse as TdxBingMapRouteDataServiceResponse,
      ADestroyResponse);
end;

function TdxMapControlBingMapCustomRouteDataProvider.GetDistanceUnit
  : TdxBingMapDistanceUnit;
begin
  Result := Params.DistanceUnit;
end;

function TdxMapControlBingMapCustomRouteDataProvider.GetParams
  : TdxBingMapRESTServiceCustomRouteParams;
begin
  Result := inherited Params as TdxBingMapRESTServiceCustomRouteParams;
end;

function TdxMapControlBingMapCustomRouteDataProvider.GetRoutePathOutput
  : Boolean;
begin
...
procedure TdxMapControlBingMapRouteDataProvider.Calculate(ARouteWaypoints
...
procedure TdxMapControlBingMapRouteDataProvider.CalculateAsync(ARouteWaypoints
  : TdxBingMapRouteWaypoints);
begin
  Params.BuildRouteWayPointsParam(ARouteWaypoints);
  BingService.ExecuteAsync;
...
function TdxMapControlBingMapRouteDataProvider.CreateService
  : TdxBingMapRESTService;
begin
...
function TdxMapControlBingMapRouteDataProvider.GetExcludeHighways
  : TdxBingMapExcludeRoadType;
begin
  Result := Params.ExcludeHighways;
end;

function TdxMapControlBingMapRouteDataProvider.GetExcludeTolls
  : TdxBingMapExcludeRoadType;
begin
...
function TdxMapControlBingMapRouteDataProvider.GetOptimize
  : TdxBingMapOptimizeRouteType;
begin
  Result := Params.Optimize;
end;

function TdxMapControlBingMapRouteDataProvider.GetParams
  : TdxBingMapRESTServiceRouteParams;
begin
  Result := inherited Params as TdxBingMapRESTServiceRouteParams;
end;

function TdxMapControlBingMapRouteDataProvider.GetTimeType
  : TdxBingMapTransitTimeType;
begin
  Result := Params.TimeType;
end;

function TdxMapControlBingMapRouteDataProvider.GetTravelMode
  : TdxBingMapTravelMode;
begin
...
function TdxMapControlBingMapMajorRoadRouteDataProvider.CreateService
  : TdxBingMapRESTService;
begin
...
procedure TdxMapControlBingMapMajorRoadRouteDataProvider.DoAssign
  (Source: TPersistent);
var
  ABingMapMajorRoadRouteDataProvider
    : TdxMapControlBingMapMajorRoadRouteDataProvider;
begin
  inherited DoAssign(Source);
  ...
  begin
    ABingMapMajorRoadRouteDataProvider :=
      TdxMapControlBingMapMajorRoadRouteDataProvider(Source);
    ExcludeRoutes := ABingMapMajorRoadRouteDataProvider.ExcludeRoutes;
  end;
end;

function TdxMapControlBingMapMajorRoadRouteDataProvider.
  GetExcludeRoutes: Boolean;
begin
  Result := Params.ExcludeRoutes;
end;

function TdxMapControlBingMapMajorRoadRouteDataProvider.GetParams
