...
const
  AMapItemCount = 8;
  AMapItemClasses: array [0 .. AMapItemCount - 1] of TdxMapItemClass =
    (TdxMapDot, TdxMapRectangle, TdxMapEllipse, TdxMapPolyline, TdxMapPolygon,
    TdxMapPath, TdxMapPushpin, TdxMapCustomElement);
  AMapItemDisplayNames: array [0 .. AMapItemCount - 1] of string = ('Dot',
    'Rectangle', 'Ellipse', 'Polyline', 'Polygon', 'Path', 'Pushpin',
    'Custom Element');
