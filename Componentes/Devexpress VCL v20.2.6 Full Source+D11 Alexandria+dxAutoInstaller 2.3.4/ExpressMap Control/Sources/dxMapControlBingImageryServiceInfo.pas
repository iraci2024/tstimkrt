...
type
  ...
  public
    ...
    procedure DoOnResponse(Sender: TObject; AResponse: TdxRestServiceResponse;
...
begin
  ...
  if FIsValid then
  begin
    AMetaData := (AResponse as TdxBingMapImageryDataServiceResponse)
      .ImageryMetadata;
    FIsValid := (AMetaData <> nil) and (AMetaData.ImageUrl <> '') and
