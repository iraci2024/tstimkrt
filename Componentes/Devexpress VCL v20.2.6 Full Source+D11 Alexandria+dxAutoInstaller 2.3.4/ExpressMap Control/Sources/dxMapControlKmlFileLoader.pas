...
type
  ...
  protected
    procedure ConvertGeometryCoordinatesToGeoPoints
      (AGeometry: TdxKmlCoordinatesGeometry;
      AGeoPoints: TdxMapControlGeoPointCollection);
    procedure ConvertKmlStyleToMapStyle(AKmlStyle: TdxKmlStyle;
      AStyle: TdxMapItemStyle);
    function GetIconHotSpotInFractions(AImageDimension: Integer; AValue: Double;
      AUnit: TdxKmlUnits): Double;
  ...
  TdxMapControlCustomKmlGeometryConverterClass = class of
    TdxMapControlCustomKmlGeometryConverter;

  TdxMapControlKmlMultiGeometryConverter = class
    (TdxMapControlCustomKmlGeometryConverter)
  private
  ...
  TdxMapControlKmlPointConverter = class
    (TdxMapControlCustomKmlGeometryConverter)
  protected
    class function KmlElementClass: TdxKmlElementClass; override;
  public
  ...
  TdxMapControlKmlLineStringConverter = class
    (TdxMapControlCustomKmlGeometryConverter)
  protected
    class function KmlElementClass: TdxKmlElementClass; override;
  public
  ...
  TdxMapControlKmlLinearRingConverter = class
  ...
  TdxMapControlKmlPolygonConverter = class
    (TdxMapControlCustomKmlGeometryConverter)
  protected
    class function KmlElementClass: TdxKmlElementClass; override;
  public
...
type
  ...
  private
    ...
    procedure RegisterConverter(AConverterClass
      : TdxMapControlCustomKmlGeometryConverterClass);
  public
    constructor Create;
    destructor Destroy; override;
    function GetConverter(AKmlGeometry: TdxKmlGeometry)
      : TdxMapControlCustomKmlGeometryConverter;
    ...
    procedure RegisterConverters(AConverterClasses
      : array of TdxMapControlCustomKmlGeometryConverterClass);
  end;
...
begin
  ...
  if AKmlGeometry <> nil then
    for I := 0 to FConvertersCache.Count - 1 do
      if TdxMapControlCustomKmlGeometryConverter(FConvertersCache[I])
        .KmlElementClass = AKmlGeometry.ClassType then
      begin
...
begin
  ...
  for I := 0 to FItems.Count - 1 do
    FConvertersCache.Add(TdxMapControlCustomKmlGeometryConverterClass(FItems[I])
      .Create(ALoader));
end;
...
function dxMapControlKmlElementConverters
  : TdxMapControlKmlElementConverterFactory;
begin
  if FKmlElementConverterFactory = nil then
    FKmlElementConverterFactory :=
      TdxMapControlKmlElementConverterFactory.Create;
...
procedure TdxMapControlCustomKmlGeometryConverter.
  ConvertGeometryCoordinatesToGeoPoints(AGeometry: TdxKmlCoordinatesGeometry;
  AGeoPoints: TdxMapControlGeoPointCollection);
var
  I: Integer;
begin
...
class function TdxMapControlCustomKmlGeometryConverter.KmlElementClass
  : TdxKmlElementClass;
begin
  Result := nil;
end;
...
procedure TdxMapControlKmlMultiGeometryConverter.Convert
  (APlacemark: TdxKmlPlacemark; AGeometry: TdxKmlGeometry;
  AStyle, AStyleHot: TdxKmlStyle);
var
  I: Integer;
...
begin
  ...
  begin
    AConverter := dxMapControlKmlElementConverters.GetConverter
      (TdxKmlGeometry(AGeometries[I]));
    ...
    begin
      ...
      begin
        ...
        AConverter.Convert(APlacemark, TdxKmlGeometry(AGeometries[I]), AStyle,
          AStyleHot);
    end;
  end;
  Dec(FNestedLevel);
...
procedure TdxMapControlKmlMultiGeometryConverter.AddToPath
...
begin
  AMapPath := FPath;
  if (APolygon.InnerBoundaryIs <> nil) and
    (APolygon.InnerBoundaryIs.LinearRing <> nil) then
  begin
    ASegment := AMapPath.Segments.Add;
    ConvertGeometryCoordinatesToGeoPoints(APolygon.InnerBoundaryIs.LinearRing,
      ASegment.GeoPoints);
  end;
  if (APolygon.OuterBoundaryIs <> nil) and
    (APolygon.OuterBoundaryIs.LinearRing <> nil) then
  begin
    ASegment := AMapPath.Segments.Add;
    ConvertGeometryCoordinatesToGeoPoints(APolygon.OuterBoundaryIs.LinearRing,
      ASegment.GeoPoints);
  end;
end;

class function TdxMapControlKmlMultiGeometryConverter.KmlElementClass
  : TdxKmlElementClass;
begin
...
begin
  ...
  if APoint.CoordinatesCount = 0 then
    Exit;
  ACustomMapItem := Loader.MapItems.Add(TdxMapCustomElement)
    as TdxMapCustomElement;
    ...
    begin
      ...
      begin
        ...
        if not SameValue(AIconStyle.Scale, 1) then
          ACustomMapItem.Image.Resize
            (Round(ACustomMapItem.Image.Width * AIconStyle.Scale),
        ...
        if (AHotSpot <> nil) and (ACustomMapItem.Image <> nil) and
          ...
          ACustomMapItem.ImageOrigin.Point :=
            dxPointDouble(GetIconHotSpotInFractions(AImageWidth, AHotSpot.X,
            AHotSpot.XUnits), 1 - GetIconHotSpotInFractions(AImageHeight,
            AHotSpot.Y, AHotSpot.YUnits));
      end;
    end;
...
class function TdxMapControlKmlPointConverter.KmlElementClass
  : TdxKmlElementClass;
begin
  Result := TdxKmlPoint;
end;
...
begin
  ...
  ConvertGeometryCoordinatesToGeoPoints(TdxKmlCoordinatesGeometry(AGeometry),
    APolylineMapItem.GeoPoints);
  ConvertKmlStyleToMapStyle(AStyle, APolylineMapItem.Style);
end;

class function TdxMapControlKmlLineStringConverter.KmlElementClass
  : TdxKmlElementClass;
begin
...
class function TdxMapControlKmlLinearRingConverter.KmlElementClass
  : TdxKmlElementClass;
begin
...
class function TdxMapControlKmlPolygonConverter.KmlElementClass
  : TdxKmlElementClass;
begin
...
constructor TdxMapControlKmlFileLoader.Create(AOwner: TdxMapItemFileLayer);
begin
  inherited Create;
  FOwner := AOwner;
    ...
    try
      ...
      begin
        ...
        AConverter := dxMapControlKmlElementConverters.GetConverter
          (APlacemark.Geometry);
        if AConverter <> nil then
          AConverter.Convert(APlacemark, APlacemark.Geometry, AKmlStyle,
            AKmlStyleHot);
      end;
    finally
...
function TdxMapControlKmlFileLoader.GetIcon(const AIconHRef: string)
  : TdxSmartGlyph;
var
  AStream: TStream;
  AIconIndex: Integer;
...
dxMapControlKmlElementConverters.RegisterConverters
  ([TdxMapControlKmlPointConverter, TdxMapControlKmlLineStringConverter,
  TdxMapControlKmlLinearRingConverter, TdxMapControlKmlPolygonConverter,
  TdxMapControlKmlMultiGeometryConverter]);
