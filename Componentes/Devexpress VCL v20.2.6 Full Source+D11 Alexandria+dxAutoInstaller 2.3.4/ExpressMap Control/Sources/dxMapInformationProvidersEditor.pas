...
type
  TfrmMapControlInformationProvidersEditor = class
...
const
  ...
  AInformationProvidersClasses: array [0 .. AInformationProvidersCount - 1]
    of TdxMapControlInformationProviderClass =
  ...
  AProviderDisplayNames: array [0 .. AInformationProvidersCount - 1]
    of string = ('Bing Maps Geocoding Provider',
    'Bing Maps Reverse Geocoding Provider', 'Bing Maps Route Provider',
    'Bing Maps Major Road Route Provider');

{$R *.dfm}
  { TTfrmMapControlInformationProvidersEditor }

procedure TfrmMapControlInformationProvidersEditor.AddItem(AItemClassIndex
  : Integer);
begin
  InformationProviders.Add(AInformationProvidersClasses[AItemClassIndex]);
end;

function TfrmMapControlInformationProvidersEditor.GetInformationProviders
