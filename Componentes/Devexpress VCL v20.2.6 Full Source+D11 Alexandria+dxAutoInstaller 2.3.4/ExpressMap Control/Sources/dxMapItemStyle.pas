...
type
  TdxMapItemStyleValue = (mcsvColor, mcsvBorderWidth, mcsvBorderColor, mcsvFont,
    mcsvTextColor, mcsvTextGlowColor);
  ...
  protected
    ...
    property AssignedValues: TdxMapItemStyleValues read FAssignedValues
      write SetAssignedValues default [];
    property BorderColor: TdxAlphaColor read FBorderColor write SetBorderColor
      stored IsBorderColorStored;
    property BorderWidth: Integer read FBorderWidth write SetBorderWidth
      stored IsBorderWidthStored;
    property Color: TdxAlphaColor read FColor write SetColor
      stored IsColorStored;
    property Font: TFont read FFont write SetFont stored IsFontStored;
    property TextColor: TdxAlphaColor read FTextColor write SetTextColor
      stored IsTextColorStored;
    property TextGlowColor: TdxAlphaColor read FTextGlowColor
      write SetTextGlowColor stored IsTextGlowColorStored;
  public
