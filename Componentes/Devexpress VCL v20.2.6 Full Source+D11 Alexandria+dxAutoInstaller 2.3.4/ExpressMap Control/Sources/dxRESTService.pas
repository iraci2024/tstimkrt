...
type
  ...
  public
    property OnTaskFinished: TNotifyEvent read FOnTaskFinished
      write FOnTaskFinished;
  end;
  ...
  public
    procedure Parse(AStream: TStream; AFormat: TdxRestServiceOutputFormat);
  ...
  protected
    ...
    procedure ParseResponse(AStream: TStream;
      AResponse: TdxRestServiceResponse); virtual;
  ...
  public
    ...
    procedure Request(const AUrl: string;
      out AResponse: TdxRestServiceResponse); overload; virtual;
    procedure RequestAsync(const AUrl: string); virtual;
    property OnResponse: TdxRESTServiceResponseEvent read FOnResponse
      write FOnResponse;
  end;
...
constructor TdxRESTServiceTask.Create(AService: TdxRESTService;
  const AUrl: string);
begin
  inherited Create;
  FService := AService;
...
procedure TdxRESTService.DoRequest(const AUrl: string;
  out AResponse: TdxRestServiceResponse;
  AOnRequest: TdxMapControlHttpRequestEvent = nil);
var
