...
type
  TdxMapControlOpenStreetMapTileSource = class
    (TdxMapControlMultiScaleTileSource) // for internal use
  private
    FUrlTemplate: string;
  ...
  public
    constructor Create(AOwner: TPersistent; AMaxImageSize: Int64;
      const AUrlTemplate: string; ASubdomains: TStrings); reintroduce;
...
const
  OpenStreetDefaultTileUriTemplate =
...
begin
  inherited Create(AOwner, AMaxImageSize, AMaxImageSize, OpenStreetTileSize,
    OpenStreetTileSize);
...
constructor TdxMapControlOpenStreetMapImageryDataProvider.Create
  (AOwner: TPersistent);
begin
...
function TdxMapControlOpenStreetMapImageryDataProvider.GetMapSizeInPixels
...
function TdxMapControlOpenStreetMapImageryDataProvider.CreateTileSource
  : TdxMapControlMultiScaleTileSource;
var
  AMaxImageSize: Int64;
begin
  AMaxImageSize := Round(CalculateTotalImageSize(OpenStreetMaxZoomLevel));
  Result := TdxMapControlOpenStreetMapTileSource.Create(Self, AMaxImageSize,
    FUrlTemplate, Subdomains);
end;

procedure TdxMapControlOpenStreetMapImageryDataProvider.DoAssign
  (Source: TPersistent);
var
  AOpenStreetMapImageryDataProvider
    : TdxMapControlOpenStreetMapImageryDataProvider;
begin
...
function TdxMapControlOpenStreetMapImageryDataProvider.CalculateTotalImageSize
  (AZoomLevel: Double): Double;
begin
...
procedure TdxMapControlOpenStreetMapImageryDataProvider.SetSubdomains
...
dxMapControlImageryDataProviders.Register
  (TdxMapControlOpenStreetMapImageryDataProvider,
  'OpenStreetMapImageryDataProvider');
