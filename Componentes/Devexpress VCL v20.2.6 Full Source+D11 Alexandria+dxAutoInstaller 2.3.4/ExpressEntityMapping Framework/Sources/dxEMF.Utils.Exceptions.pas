...
type
  ...
  public
    ...
    constructor Create(const AObjectTypeName, AObjectName, AParentObjectName,
      AErrorMessage: string); overload;

    property ObjectTypeName: string read FObjectTypeName write FObjectTypeName;
    property ObjectName: string read FObjectName write FObjectName;
    property ParentObjectName: string read FParentObjectName
      write FParentObjectName;
  end;
...
constructor EdxSchemaCorrectionNeededException.Create
...
constructor EdxUnableToCreateDBObjectException.Create(const AObjectTypeName,
  AObjectName, AParentObjectName, AErrorMessage: string);
begin
  inherited CreateFmt(sdxConnectionProviderUnableToCreateDBObject,
    [AObjectTypeName, AObjectName, AParentObjectName, AErrorMessage]);
