...
type
  ...
  TdxProcessParameter = reference to function(const ACriteriaOperator
    : IdxCriteriaOperator): string;
  TdxConnectionParameterValues = array [TdxConnectionParameter] of string;

  TdxConvertParameter = function(const AParameterValue: TValue)
    : TValue of object;
  ...
  protected
    ...
    procedure PrepareParameters(AConvertParameter: TdxConvertParameter);
      virtual; abstract;
  ...
  TdxSchemaInfo = (Tables, Views, Procedures, Columns, Indexes, IndexFields,
    PrimaryKeyFields, ForeignKeys, ForeignKeyFields);
  ...
  protected
    ...
    function CreateCommand(AQuery: TdxQuery): TdxCustomDBCommand;
      virtual; abstract;
    ...
    function SelectData(AOwner: TComponent; AQuery: TdxQuery): TDataSet;
      virtual; abstract;
    property ConnectionString: string read GetConnectionString;
    property ProviderSQL: TdxSQLConnectionProvider read FProviderSQL
      write FProviderSQL;
  public
    ...
    function CreateDataSet(AQuery: TdxQuery; AOwner: TComponent = nil)
      : TDataSet; virtual; abstract;
    function Execute(const ACommandText: string): Integer; overload;
      virtual; abstract;
    function ExecuteScalar(const ACommandText: String): Variant;
      overload; virtual;
    function ExecuteScalar(AConnection: TCustomConnection;
      const ACommandText: String): Variant; overload; virtual; abstract;
    function GetDatabaseName(ASQLConnectionProvider: TdxSQLConnectionProvider)
      : string; virtual;
    function GetSchema(ASchemaInfo: TdxSchemaInfo;
      const ACatalogName, ASchemaName, ATableName: string;
      const AObjectName: string = ''): TDataSet; virtual; abstract;
    procedure GetTableSchema(ATable: TdxDBTable;
      ACheckIndexes, ACheckForeignKeys: Boolean); virtual; abstract;
  ...
  protected type
    ...
    public
      ...
      class operator Implicit(const A: TConnectionParameters)
        : TdxConnectionParameterValues;
    end;

  strict private
    class var FParametersAliasCache: TArray<string>;
  strict private
    ...
    function DoInsertRecord(ARoot: TdxInsertStatement;
      AIdentities: TdxTaggedParameterHolder): IdxParameterValue;
    function DoUpdateRecord(ARoot: TdxUpdateStatement;
      AIdentities: TdxTaggedParameterHolder): IdxParameterValue;
    function DoDeleteRecord(ARoot: TdxDeleteStatement;
      AIdentities: TdxTaggedParameterHolder): IdxParameterValue;
    ...
    function ForeignKeyExists(ATable: TdxDBTable;
      AForeignKey: TdxDBForeignKey): Boolean;
  ...
  protected
    ...
    procedure ExecuteSQLSchemaUpdate(const AObjectTypeName, AObjectName,
      AParentObjectName, ACommandText: string);
    ...
    function CollectTablesToCreate(const ATables: TArray<TdxDBTable>)
      : TArray<TdxDBTable>; virtual; abstract;
    function GetBraceJoin: Boolean; virtual;
    class function GetDBNameHashString(const ADBName: string): string; static;
    function GetForeignKeyName(AForeignKey: TdxDBForeignKey; ATable: TdxDBTable)
      : string; virtual;
    ...
    class function GetSafeObjectName(const AOriginalName, APatchedName: string;
      AMaxLength: Integer): string; static;
    function GetIndexName(AIndex: TdxDBIndex; ATable: TdxDBTable)
      : string; virtual;
    function GetSQLCreateColumnType(ATable: TdxDBTable;
      AColumn: TdxDBColumn): string;
    function GetSQLCreateColumnTypeForBoolean(ATable: TdxDBTable;
      AColumn: TdxDBColumn): string; virtual; abstract;
    ...
    function GetSQLCreateColumnTypeForGuid(ATable: TdxDBTable;
      AColumn: TdxDBColumn): string; virtual; abstract;
    function GetSQLCreateColumnTypeForTimeSpan(ATable: TdxDBTable;
      AColumn: TdxDBColumn): string; virtual;
    function GetSQLCreateColumnTypeForByteArray(ATable: TdxDBTable;
      AColumn: TdxDBColumn): string; virtual; abstract;
    function GetPrimaryKeyName(APrimaryKey: TdxDBPrimaryKey; ATable: TdxDBTable)
      : string; virtual;
    function GetIdentity(ASQL: TdxQuery): Int64; overload; virtual;
    function GetIdentity(ARoot: TdxInsertStatement;
      AIdentities: TdxTaggedParameterHolder): Int64; overload; virtual;
    ...
    class function GetSafeNameDefault(const AOriginalName: string)
      : string; static;
    class function IsSingleColumnPKColumn(ATable: TdxDBTable;
      AColumn: TdxDBColumn): Boolean; static;
    function ProcessModifyData(const ADMLStatements
      : TArray<TdxModificationStatement>): TdxModificationResult; virtual;
    function UpdateRecord(ARoot: TdxModificationStatement;
      AIdentities: TdxTaggedParameterHolder): IdxParameterValue;
    function NeedsIndexForForeignKey: Boolean; virtual;
    function TryCastVariant(const AValue: Variant;
      AExpectedType: TdxDBColumnType = TdxDBColumnType.Unknown)
      : Variant; virtual;
  ...
  public
    ...
    procedure CreateForeignKey(ATable: TdxDBTable;
      AForeignKey: TdxDBForeignKey); virtual;
    function ComposeSafeColumnName(const AColumnName: string): string; virtual;
    function ComposeSafeConstraintName(const AConstraintName: string)
      : string; virtual;
    ...
    function GetConnectionParameter(const AConnectionType: TdxConnectionType;
      AParameter: TdxConnectionParameter): string; virtual; abstract;
    function GetParameterName(const AParameter: IdxOperandValue;
      AIndex: Integer; var ACreateParameter: Boolean): string; virtual;
    procedure GetTableSchema(ATable: TdxDBTable;
      ACheckIndexes, ACheckForeignKeys: Boolean); virtual; abstract;
    function GetStorageTableNames(AIncludeViews: Boolean): TArray<string>;
      virtual; abstract;
    function ProcessUpdateSchema(ASkipIfFirstTableNotExists: Boolean;
      const ATables: TArray<TdxDBTable>): TdxUpdateSchemaResult; virtual;
    ...
    function FormatBinary(AOperatorType: TdxBinaryOperatorType;
      const ALeftOperand, ARightOperand: string): string; virtual;
    function FormatColumn(const AColumnName: string): string; overload;
      virtual; abstract;
    function FormatColumn(const AColumnName, ATableAlias: string): string;
      overload; virtual; abstract;
    function FormatColumnSafe(const AColumnName: string): string;
    function FormatConstraint(const AConstraintName: string): string;
      virtual; abstract;
    ...
    function FormatFunction(AOperatorType: TdxFunctionOperatorType;
      const AOperands: TArray<string>): string; overload; virtual;
    ...
    function FormatTable(const ASchemaName, ATableName: string): string;
      overload; virtual; abstract;
    function FormatTable(const ASchemaName, ATableName, ATableAlias: string)
      : string; overload; virtual; abstract;
    function FormatTableSafe(ATable: TdxDBTable): string;
    function FormatUnary(AOperatorType: TdxUnaryOperatorType;
      const AOperand: string): string; virtual;

    function FormatCreateTable(const ATableName, AColumns: string)
      : string; virtual;
    ...
    function FormatOrder(const ASortProperty: string;
      ASortDirection: TdxSortDirection): string; virtual;
    function FormatInsertDefaultValues(ATable: TdxDBTable): string;
      virtual; abstract;
    ...
    function FormatUpdate(const ATableName, ASetClause, AWhereClause: string)
      : string; virtual; abstract;
    function FormatDelete(const ATableName, AWhereClause: string): string;
      virtual; abstract;

    function FormatOuterApply(const ACommandText, AAlias: string)
      : string; virtual;
  ...
  strict private
    class var FProviderSQLs: TList<TdxSQLConnectionProviderClass>;
  ...
  public
    ...
    class function GetProviderSQL(const ADBEngine: TdxDBEngine)
      : TdxSQLConnectionProviderClass; static;
...
begin
  ...
  AListParameters :=
  {$IFDEF DELPHIXE3}ConnectionString.Split([';']){$ELSE}TdxStringHelper.Split
    (ConnectionString, [';']){$ENDIF};
  for AParam in AListParameters do
  begin
    APair := {$IFDEF DELPHIXE3}AParam.Split(['=']){$ELSE}TdxStringHelper.Split
      (AParam, ['=']){$ENDIF};
...
function TdxCustomConnectionVendor.ExecuteScalar(const ACommandText
  : String): Variant;
begin
  Result := ExecuteScalar(Self.Connection, ACommandText);
end;

procedure TdxCustomConnectionVendor.SetConnection(const AValue
  : TCustomConnection);
begin
  FConnection := AValue;
end;

function TdxCustomConnectionVendor.GetDatabaseName(ASQLConnectionProvider
  : TdxSQLConnectionProvider): string;
var
  ADatabaseParamName: string;
  AConnectionString: TStrings;
begin
  ADatabaseParamName := ASQLConnectionProvider.GetConnectionParameter
    (GetConnectionType, TdxConnectionParameter.Database);
...
procedure TdxSQLConnectionProvider.TCommandPool.Add
  (ACommand: TdxCustomDBCommand);
begin
  AddOrSetValue(ACommand.CommandText, ACommand);
end;

function TdxSQLConnectionProvider.TCommandPool.Get(const ACommandText: string)
  : TdxCustomDBCommand;
begin
...
constructor TdxSQLConnectionProvider.TConnectionParameters.Create
...
constructor TdxSQLConnectionProvider.Create(AConnectionVendor
...
function TdxSQLConnectionProvider.InternalExecSQL
  (ACommand: TdxCustomDBCommand): Integer;
begin
...
function TdxSQLConnectionProvider.ComposeSafeColumnName(const AColumnName
  : string): string;
begin
  Result := GetSafeObjectName(AColumnName, GetSafeNameRoot(AColumnName),
    GetSafeNameColumnMaxLength);
end;

function TdxSQLConnectionProvider.ComposeSafeConstraintName
  (const AConstraintName: string): string;
begin
  Result := GetSafeObjectName(AConstraintName, GetSafeNameRoot(AConstraintName),
    GetSafeNameConstraintMaxLength);
end;

function TdxSQLConnectionProvider.ComposeSafeSchemaName(const ATableName
  : string): string;
var
  ADot, AStart: Integer;
  ASchemaName: string;
...
{$ENDIF}
    Result := GetSafeObjectName(ASchemaName, GetSafeNameRoot(ASchemaName),
...
function TdxSQLConnectionProvider.ComposeSafeTableName(const ATableName
  : string): string;
var
  ADot: Integer;
begin
...
{$ELSE}
    Result := TdxStringHelper.Substring(ATableName, ADot + 1,
      Length(ATableName))
{$ENDIF}
  else
    Result := ATableName;
  Result := GetSafeObjectName(Result, GetSafeNameRoot(Result),
    GetSafeNameTableMaxLength);
end;
...
function TdxSQLConnectionProvider.ConvertToDBParameter(const AParameterValue
  : TValue): TValue;
begin
  ...
  try
    ...
    begin
      if AColumns.Length > 0 then
        AColumns.Append(', ');
      AColumns.Append(FormatColumnSafe(AColumn.Name)).Append(' ')
        .Append(GetSQLCreateColumnFullAttributes(ATable, AColumn));
    end;
    ExecuteSQLSchemaUpdate('Table', ATable.Name, '',
      FormatCreateTable(FormatTableSafe(ATable), AColumns.ToString));
  finally
    AColumns.Free;
  end;
end;
...
begin
  ...
  if (ARoot.AffectedRecordCount <> 0) and (ARoot.AffectedRecordCount <> ACount)
  then
  begin
    RollbackTransaction;
  ...
  begin
    ...
    case ARoot.IdentityColumnType of
      TdxDBColumnType.Int32:
        ARoot.IdentityParameter.Value :=
          Integer(GetIdentity(ARoot, AIdentities));
...
begin
  ...
  try
    ...
    try
      ...
      begin
        ACount := Execute(AQuery);
        if (ARoot.AffectedRecordCount <> 0) and
          (ARoot.AffectedRecordCount <> ACount) then
        begin
          RollbackTransaction;
          raise EdxLockingException.Create('');
        end;
...
procedure TdxSQLConnectionProvider.ExecuteSQLSchemaUpdate(const AObjectTypeName,
  AObjectName, AParentObjectName, ACommandText: string);
begin
  ...
  try
    ...
    on E: Exception do
    begin
      raise EdxUnableToCreateDBObjectException.Create(AObjectTypeName,
        AObjectName, AParentObjectName, E.Message);
    end
  end;
end;
...
begin
  ...
  AFormattedColumns := TdxFormatterHelper.Concat(ATable.PrimaryKey.Columns,
    FormatColumnSafe);
  ExecuteSQLSchemaUpdate('PrimaryKey', GetPrimaryKeyName(ATable.PrimaryKey,
    ATable), ATable.Name,
    Format('alter table %s add constraint %s primary key (%s)',
    [FormatTableSafe(ATable),
    FormatConstraintSafe(GetPrimaryKeyName(ATable.PrimaryKey, ATable)),
    AFormattedColumns]));
end;

procedure TdxSQLConnectionProvider.CreateColumn(ATable: TdxDBTable;
  AColumn: TdxDBColumn);
begin
  ExecuteSQLSchemaUpdate('Column', AColumn.Name, ATable.Name,
    Format('alter table %s add %s %s', [FormatTableSafe(ATable),
    FormatColumnSafe(AColumn.Name), GetSQLCreateColumnFullAttributes(ATable,
    AColumn)]));
end;

function TdxSQLConnectionProvider.CreateCommand(AQuery: TdxQuery)
  : TdxCustomDBCommand;
begin
...
procedure TdxSQLConnectionProvider.CreateDatabase(const ADatabaseName: string;
  const AValues: array of string);
begin
  ExecuteSQLSchemaUpdate('Database', ADatabaseName, '',
    Format('CREATE Database [%s]', [ADatabaseName]));
end;

procedure TdxSQLConnectionProvider.CreateIndex(ATable: TdxDBTable;
  AIndex: TdxDBIndex);
var
  AFormattedColumns: string;
begin
  AFormattedColumns := TdxFormatterHelper.Concat(AIndex.Columns,
    FormatColumnSafe);
  ExecuteSQLSchemaUpdate('Index', GetIndexName(AIndex, ATable), ATable.Name,
    Format(CreateIndexTemplate, [IfThen(AIndex.IsUnique, 'unique'),
    FormatConstraintSafe(GetIndexName(AIndex, ATable)), FormatTableSafe(ATable),
    AFormattedColumns]));
end;
...
procedure TdxSQLConnectionProvider.CreateForeignKey(ATable: TdxDBTable;
  AForeignKey: TdxDBForeignKey);
var
  AFormattedColumns, AFormattedRefColumns: string;
begin
  AFormattedColumns := TdxFormatterHelper.Concat(AForeignKey.Columns,
    FormatColumnSafe);
  AFormattedRefColumns := TdxFormatterHelper.Concat
    (AForeignKey.PrimaryKeyTableKeyColumns, FormatColumnSafe);
  ExecuteSQLSchemaUpdate('ForeignKey', GetForeignKeyName(AForeignKey, ATable),
    ATable.Name, Format(CreateForeignKeyTemplate, [FormatTableSafe(ATable),
    FormatConstraintSafe(GetForeignKeyName(AForeignKey, ATable)),
    AFormattedColumns, FormatTable(ComposeSafeSchemaName
    (AForeignKey.PrimaryKeyTable),
    ComposeSafeTableName(AForeignKey.PrimaryKeyTable)), AFormattedRefColumns]));
end;
...
function TdxSQLConnectionProvider.FormatBinary(AOperatorType
...
function TdxSQLConnectionProvider.FormatColumnSafe(const AColumnName
  : string): string;
begin
  Result := FormatColumn(ComposeSafeColumnName(AColumnName));
end;

function TdxSQLConnectionProvider.FormatConstraintSafe(const AConstraintName
  : string): string;
begin
  Result := FormatConstraint(ComposeSafeConstraintName(AConstraintName));
end;

function TdxSQLConnectionProvider.FormatCustomFunction(const AOperands
...
function TdxSQLConnectionProvider.FormatFunction(AProcessParameter
...
begin
  ...
  begin
    if (I = 0) and (AOperatorType in [TdxFunctionOperatorType.Custom,
      TdxFunctionOperatorType.CustomNonDeterministic]) then
      AStrings[I] := AOperands[I].AsString
    else
      AStrings[I] := AProcessParameter
        (Safe<TdxCriteriaOperator>.Cast(AOperands[I].AsObject));
  end;
  Result := FormatFunction(AOperatorType, AStrings);
end;

function TdxSQLConnectionProvider.FormatFunction(AOperatorType
  : TdxFunctionOperatorType; const AOperands: TArray<string>): string;
begin
  if AOperatorType in [TdxFunctionOperatorType.Custom,
    TdxFunctionOperatorType.CustomNonDeterministic] then
    Result := FormatCustomFunction(AOperands)
  else
    Result := TdxBaseFormatterHelper.DefaultFormatFunction(AOperatorType,
      AOperands);
end;

function TdxSQLConnectionProvider.FormatOrder(const ASortProperty: string;
...
function TdxSQLConnectionProvider.FormatOuterApply(const ACommandText,
  AAlias: string): string;
begin
  Result := Format('outer apply (%s) %s', [ACommandText, AAlias]);
end;

function TdxSQLConnectionProvider.FormatCreateTable(const ATableName,
  AColumns: string): string;
begin
  Result := Format('create table %s (%s)', [ATableName, AColumns]);
end;

function TdxSQLConnectionProvider.FormatSelect(const ASelectClause, AFromClause,
  AWhereClause, AOrderByClause, AGroupByClause, AHavingClause: string;
  ATopSelectedRecords: Integer): string;
begin
  Result := FormatSelect(ASelectClause, AFromClause, AWhereClause,
    AOrderByClause, AGroupByClause, AHavingClause, 0, ATopSelectedRecords);
end;
...
begin
  if not SupportsNativeSkipTake then
    raise ENotSupportedException.Create
      (sdxConnectionProviderUnableToCreateDBObject);
...
begin
  Result := FormatTable(ComposeSafeSchemaName(ATable.Name),
    ComposeSafeTableName(ATable.Name));
end;

function TdxSQLConnectionProvider.FormatUnary(AOperatorType
  : TdxUnaryOperatorType; const AOperand: string): string;
begin
...
function TdxSQLConnectionProvider.GetCommandFromPool(AQuery: TdxQuery)
  : TdxCustomDBCommand;
begin
...
class function TdxSQLConnectionProvider.GetDBNameHashString
...
class function TdxSQLConnectionProvider.GetDBTypes
  : TDictionary<string, TdxDBColumnType>;
begin
  Result := nil;
end;

function TdxSQLConnectionProvider.GetForeignKeyName
  (AForeignKey: TdxDBForeignKey; ATable: TdxDBTable): string;
var
...
function TdxSQLConnectionProvider.GetIdentity(ARoot: TdxInsertStatement;
...
function TdxSQLConnectionProvider.GetIndexName(AIndex: TdxDBIndex;
...
function TdxSQLConnectionProvider.TryCastVariant(const AValue: Variant;
  AExpectedType: TdxDBColumnType): Variant;
begin
  Result := AValue;
end;
...
function TdxSQLConnectionProvider.GetParameterName(const AParameter
  : IdxOperandValue; AIndex: Integer; var ACreateParameter: Boolean): string;
var
  AValue: TValue;
begin
  ...
  if Supports(AParameter, IdxConstantValue) and not AValue.IsNullOrEmpty then
    case AValue.Kind of
      ...
      tkString, tkLString, tkWString, tkUString:
        Exit(Concat('N'#$27, ReplaceText(AValue.AsString, #$27,
          #$27#$27), #$27));
    end;
...
function TdxSQLConnectionProvider.GetPrimaryKeyName
  (APrimaryKey: TdxDBPrimaryKey; ATable: TdxDBTable): string;
begin
...
class function TdxSQLConnectionProvider.GetSafeNameDefault(const AOriginalName
  : string): string;
var
  ASrc, ADest: PChar;
  AChar: Char;
...
{$ENDIF}
      TUnicodeCategory.ucControl, TUnicodeCategory.ucLineSeparator,
...
function TdxSQLConnectionProvider.GetSafeNameRoot(const AOriginalName
  : string): string;
begin
  Result := GetSafeNameDefault(AOriginalName);
end;

class function TdxSQLConnectionProvider.GetSafeObjectName(const AOriginalName,
  APatchedName: string; AMaxLength: Integer): string;
var
  ABuilder: TStringBuilder;
  APrevChar, ACh: Char;
  APatched, ASuffix, APrefix: string;
begin
  if (Length(AOriginalName) <= AMaxLength) and (AOriginalName = APatchedName)
  then
    Exit(AOriginalName);
...
{$ELSE}
    APrefix := TdxStringHelper.Substring(APrefix, 0,
      AMaxLength - Length(ASuffix));
{$ENDIF}
...
function TdxSQLConnectionProvider.GetSQLCreateColumnType(ATable: TdxDBTable;
  AColumn: TdxDBColumn): string;
begin
...
function TdxSQLConnectionProvider.GetSQLCreateColumnTypeForTimeSpan
...
function TdxSQLConnectionProvider.ColumnExists(ATable: TdxDBTable;
  AColumn: TdxDBColumn): Boolean;
var
  I: Integer;
begin
  for I := 0 to ATable.Columns.Count - 1 do
    if SameText(ATable.Columns[I].Name, ComposeSafeColumnName(AColumn.Name))
    then
      Exit(True);
  Result := False;
end;

function TdxSQLConnectionProvider.AreColumnsEqual(AFirst,
  ASecond: TList<string>): Boolean;
var
  I: Integer;
begin
  ...
  for I := 0 to AFirst.Count - 1 do
    if not SameText(ComposeSafeColumnName(AFirst[I]),
      ComposeSafeColumnName(ASecond[I])) then
      Exit(False);
  Result := True;
end;

function TdxSQLConnectionProvider.ForeignKeyExists(ATable: TdxDBTable;
  AForeignKey: TdxDBForeignKey): Boolean;
var
  AKey: TdxDBForeignKey;
begin
  for AKey in ATable.ForeignKeys do
    if SameText(ComposeSafeTableName(AForeignKey.PrimaryKeyTable),
      ComposeSafeTableName(AKey.PrimaryKeyTable)) and
      AreColumnsEqual(AKey.Columns, AForeignKey.Columns) and
      AreColumnsEqual(AKey.PrimaryKeyTableKeyColumns,
      AForeignKey.PrimaryKeyTableKeyColumns) then
      Exit(True);
  Result := False;
end;

function TdxSQLConnectionProvider.IndexExists(ATable: TdxDBTable;
  AIndex: TdxDBIndex): Boolean;
var
  I: Integer;
begin
...
class function TdxSQLConnectionProvider.IsSingleColumnPKColumn
  (ATable: TdxDBTable; AColumn: TdxDBColumn): Boolean;
var
  C: TdxDBColumn;
begin
...
function TdxSQLConnectionProvider.ModifyData(const ADMLStatements
...
function TdxSQLConnectionProvider.NeedCreateIndex(ATable: TdxDBTable;
  AIndex: TdxDBIndex): Boolean;
begin
  if (ATable.PrimaryKey <> nil) and
    (AreColumnsEqual(ATable.PrimaryKey.Columns, AIndex.Columns)) then
    Result := False
  else
    Result := True;
end;
...
function TdxSQLConnectionProvider.ProcessModifyData(const ADMLStatements
  : TArray<TdxModificationStatement>): TdxModificationResult;
var
...
function TdxSQLConnectionProvider.ProcessUpdateSchema(ASkipIfFirstTableNotExists
  : Boolean; const ATables: TArray<TdxDBTable>): TdxUpdateSchemaResult;
var
  ...
  try
    if not CanCreateSchema and (Length(ACollectedTables) > 0) then
      ...
      for ATable in ACollectedTables do
        CreateTable(ATable);
    ANewTables := TObjectDictionary<TdxDBTable, TdxDBTable>.Create
      ([doOwnsValues]);
    try
        ...
        begin
          ...
          begin
            if CanCreateSchema then
              ...
              raise EdxSchemaCorrectionNeededException.CreateFmt
                (sdxColumnNotFound, [ComposeSafeColumnName(AColumn.Name),
                ComposeSafeTableName(ATable.Name)]);
          end;
        end;
        if (CanCreateSchema and (not ANewTable.HasPrimaryKey)) and ATable.HasPrimaryKey
        then
        ...
        begin
          ...
          begin
            if not IndexExists(ANewTable, AIndex) and
              NeedCreateIndex(ATable, AIndex) then
            begin
          ...
          if NeedsIndexForForeignKey then
            ...
            begin
              ...
              try
                if not IndexExists(ANewTable, AIndex) and
                  ((ATable.PrimaryKey = nil) or
                  (not AreColumnsEqual(ATable.PrimaryKey.Columns,
                  AIndex.Columns))) then
                begin
                  CreateIndex(ATable, AIndex);
...
procedure TdxSQLConnectionProvider.ReleasePooledCommand
  (ACommand: TdxCustomDBCommand);
begin
  if FCommandPool <> nil then
...
function TdxSQLConnectionProvider.SelectData(ASelect: TdxSelectStatement)
  : TDataSet;
var
...
class function TdxSQLConnectionProviderFactory.GetProviderSQL(const ADBEngine
  : TdxDBEngine): TdxSQLConnectionProviderClass;
var
  I: Integer;
begin
  Result := nil;
...
class function TdxSQLConnectionProviderFactory.HasProvider(const ADBEngine
  : TdxDBEngine): Boolean;
var
  I: Integer;
begin
...
class procedure TdxSQLConnectionProviderFactory.Register
  (AClass: TdxSQLConnectionProviderClass);
begin
  if FProviderSQLs = nil then
...
class procedure TdxSQLConnectionProviderFactory.Unregister
  (AClass: TdxSQLConnectionProviderClass);
begin
  if FProviderSQLs = nil then
    Exit;
...
class procedure TdxSQLConnectionProviderFactory.PopulateDBEngines
  (const AList: TList<TdxDBEngine>);
var
  I: Integer;
begin
  if FProviderSQLs = nil then
