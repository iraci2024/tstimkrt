...
{$IFDEF DELPHIXE4}
    property Fields[const AName: string]: TdxLinqExpression
      read FieldByName; default;
{$ENDIF}
  end;
  ...
  IdxLinqCollectionExpression<T: IdxEntityInfo> = interface
    (IdxLinqCollectionExpression)
    function Fields: T;
  end;
  ...
  strict private
    FQueryable: IdxQueryable;
  public
    class operator Implicit(const AQueryable: IdxQueryable)
      : TdxSelectTupleQueryable;
    class operator Implicit(const AOperator: TdxSelectTupleQueryable)
      : IdxQueryable;
  end;
  ...
  IdxLinqFrom = interface(IdxLinq)
    ...
    function Where(const AExpression: TdxLinqExpression): IdxLinqWhere;
      overload;
    function OrderBy(const AExpression: TdxLinqExpression)
      : IdxLinqOrderBy; overload;
    function OrderBy(const AExpression1, AExpression2: TdxLinqExpression)
      : IdxLinqOrderBy; overload;
    function OrderBy(const AExpression1, AExpression2,
      AExpression3: TdxLinqExpression): IdxLinqOrderBy; overload;
    function OrderBy(const AExpression1, AExpression2, AExpression3,
      AExpression4: TdxLinqExpression): IdxLinqOrderBy; overload;
    function OrderBy(const AExpression1, AExpression2, AExpression3,
      AExpression4, AExpression5: TdxLinqExpression): IdxLinqOrderBy; overload;
    function OrderBy(const AExpression1, AExpression2, AExpression3,
      AExpression4, AExpression5, AExpression6: TdxLinqExpression)
      : IdxLinqOrderBy; overload;
    function OrderBy(const AExpression1, AExpression2, AExpression3,
      AExpression4, AExpression5, AExpression6, AExpression7: TdxLinqExpression)
      : IdxLinqOrderBy; overload;
    function OrderBy(const AExpressions: array of TdxLinqExpression)
      : IdxLinqOrderBy; overload;
  ...
  IdxLinqFrom<T> = interface(IdxLinq)
    function Where(const AExpression: TdxLinqExpression)
      : IdxLinqWhere<T>; overload;
    function OrderBy(const AExpression: TdxLinqExpression)
      : IdxLinqOrderBy<T>; overload;
    function OrderBy(const AExpression1, AExpression2: TdxLinqExpression)
      : IdxLinqOrderBy<T>; overload;
    function OrderBy(const AExpression1, AExpression2,
      AExpression3: TdxLinqExpression): IdxLinqOrderBy<T>; overload;
    function OrderBy(const AExpression1, AExpression2, AExpression3,
      AExpression4: TdxLinqExpression): IdxLinqOrderBy<T>; overload;
    function OrderBy(const AExpression1, AExpression2, AExpression3,
      AExpression4, AExpression5: TdxLinqExpression)
      : IdxLinqOrderBy<T>; overload;
    function OrderBy(const AExpression1, AExpression2, AExpression3,
      AExpression4, AExpression5, AExpression6: TdxLinqExpression)
      : IdxLinqOrderBy<T>; overload;
  ...
  IdxLinqSimpleFrom<T> = interface(IdxLinq)
    ...
    function OrderBy(const AIndex1, AIndex2: Integer)
      : IdxLinqIndexOrderBy<T>; overload;
    function OrderBy(const AIndex1, AIndex2, AIndex3: Integer)
      : IdxLinqIndexOrderBy<T>; overload;
    function OrderBy(const AIndex1, AIndex2, AIndex3, AIndex4: Integer)
      : IdxLinqIndexOrderBy<T>; overload;
    function OrderBy(const AIndex1, AIndex2, AIndex3, AIndex4, AIndex5: Integer)
      : IdxLinqIndexOrderBy<T>; overload;
    function OrderBy(const AIndex1, AIndex2, AIndex3, AIndex4, AIndex5,
      AIndex6: Integer): IdxLinqIndexOrderBy<T>; overload;
    function OrderBy(const AIndex1, AIndex2, AIndex3, AIndex4, AIndex5, AIndex6,
      AIndex7: Integer): IdxLinqIndexOrderBy<T>; overload;
    function OrderBy(const AIndexes: array of Integer)
      : IdxLinqIndexOrderBy<T>; overload;
    function Select: IdxLinqSelect<T>; overload;
  end;
  ...
  IdxLinqOrderBy<T> = interface(IdxLinq)
    function OrderBy(const AExpression1: TdxLinqExpression)
      : IdxLinqOrderBy<T>; overload;
    function OrderBy(const AExpression1, AExpression2: TdxLinqExpression)
      : IdxLinqOrderBy<T>; overload;
    function OrderBy(const AExpression1, AExpression2,
  ...
  IdxLinqIndexOrderBy<T> = interface(IdxLinq)
    function OrderBy(const AExpression1: Integer)
      : IdxLinqIndexOrderBy<T>; overload;
    function OrderBy(const AExpression1, AExpression2: Integer)
      : IdxLinqIndexOrderBy<T>; overload;
    function OrderBy(const AExpression1, AExpression2, AExpression3: Integer)
      : IdxLinqIndexOrderBy<T>; overload;
    function OrderBy(const AExpression1, AExpression2, AExpression3,
      AExpression4: Integer): IdxLinqIndexOrderBy<T>; overload;
    function OrderBy(const AExpression1, AExpression2, AExpression3,
      AExpression4, AExpression5: Integer): IdxLinqIndexOrderBy<T>; overload;
    function OrderBy(const AExpression1, AExpression2, AExpression3,
      AExpression4, AExpression5, AExpression6: Integer)
      : IdxLinqIndexOrderBy<T>; overload;
    function OrderBy(const AExpression1, AExpression2, AExpression3,
      AExpression4, AExpression5, AExpression6, AExpression7: Integer)
      : IdxLinqIndexOrderBy<T>; overload;
    function OrderBy(const AExpressions: array of Integer)
      : IdxLinqIndexOrderBy<T>; overload;
  ...
  TdxLinqQueryBuilder = class(TInterfacedObject, IEnumerable, IdxQueryable,
    IdxLinq, IdxLinqFrom, IdxLinqWhere, IdxLinqOrderBy, IdxLinqSkip,
    IdxLinqTake, IdxLinqSelect, IdxFromClause, IdxExpression,
    IdxLinqQueryBuilder)
  private type
  ...
  protected
    ...
    function From<T: class>(var A: TdxLinqExpression)
      : TdxLinqQueryBuilder; overload;
  ...
  TdxLinqQueryBuilder<T: class> = class(TdxLinqQueryBuilder, IEnumerable<T>,
    IdxQueryable<T>, IdxLinqFrom<T>, IdxLinqSimpleFrom<T>, IdxLinqWhere<T>,
    IdxLinqOrderBy<T>, IdxLinqIndexOrderBy<T>, IdxLinqSkip<T>, IdxLinqTake<T>,
    IdxLinqSelect<T>)
  strict private
  type
  ...
  TdxLinqBuilder<T> = class(TdxLinqBuilder, IEnumerable<T>, IdxQueryProvider<T>,
    IdxQueryable<T>)
  strict private
  type
  ...
  public
    constructor Create(AOwner: TdxLinqQueryBuilder;
      const ANewFunc: TdxFunc<T>); overload;
    constructor Create(AOwner: TdxLinqQueryBuilder;
      const ANewFunc: TdxFunc<TArray<Variant>, T>); overload;
  end;
  ...
  public
    ...
    function From(const AEntityInfo: IdxEntityInfo): IdxLinqFrom; overload;
    function From<T: class>(const AEntityInfo: IdxEntityInfo)
      : IdxLinqFrom<T>; overload;
  ...
  protected
    ...
    class function DataContextEntityClasses(ADataContext: PTypeInfo)
      : TArray<TClass>; static;
    class procedure RegisterExpression(AClass: TClass; AExpression: PTypeInfo);
      overload; static;
    class procedure RegisterDataContext(ADataContext: PTypeInfo);
      overload; static;
    class function TryGetExpression(AClass: TClass;
      out AExpression: PTypeInfo): Boolean;

    class property Expressions: TDictionary<TClass, PTypeInfo>
      read FExpressions;
    class property DataContexts: TList<PTypeInfo> read FDataContexts;
  public
    class function GetDataContext(const ASession: IdxSession)
      : IdxDataContext; overload;
    class function GetDataContext(ADataContext: PTypeInfo;
      const ASession: IdxSession): IdxDataContext; overload;
    class function GetDataContexts: TArray<PTypeInfo>;
    class function GetEntityMetadata(AClass: TClass;
      const AOwner: IdxQueryProvider): IdxEntityInfo;
    class function FindClass(AExpression: PTypeInfo): TClass; overload;
    class function FindClass(const AIID: TGUID): TClass; overload;

    class procedure Register<TEntity: class;
    TExpression: IdxEntityInfo>; overload;
...
function TdxLinqQueryBuilder.From(const AEntityInfo: IdxEntityInfo)
  : IdxLinqFrom;
var
  AClass: TClass;
begin
...
function TdxLinqQueryBuilder.From<T>(var A: TdxLinqExpression)
  : TdxLinqQueryBuilder;
begin
  Result := Self;
  FFromClass := T;
...
function TdxLinqQueryBuilder.OrderBy(const AExpression: TdxLinqExpression)
  : IdxLinqOrderBy;
var
  AOrderBy: TOrderBy;
begin
...
function TdxLinqQueryBuilder.OrderBy(const AExpression1,
  AExpression2: TdxLinqExpression): IdxLinqOrderBy;
begin
  Result := OrderBy([AExpression1, AExpression2]);
end;

function TdxLinqQueryBuilder.OrderBy(const AExpression1, AExpression2,
  AExpression3: TdxLinqExpression): IdxLinqOrderBy;
begin
  Result := OrderBy([AExpression1, AExpression2, AExpression3]);
end;

function TdxLinqQueryBuilder.OrderBy(const AExpression1, AExpression2,
  AExpression3, AExpression4: TdxLinqExpression): IdxLinqOrderBy;
begin
  Result := OrderBy([AExpression1, AExpression2, AExpression3, AExpression4]);
end;

function TdxLinqQueryBuilder.OrderBy(const AExpression1, AExpression2,
  AExpression3, AExpression4, AExpression5: TdxLinqExpression): IdxLinqOrderBy;
begin
  Result := OrderBy([AExpression1, AExpression2, AExpression3, AExpression4,
    AExpression5]);
end;
...
function TdxLinqQueryBuilder.OrderBy(const AExpression1, AExpression2,
  AExpression3, AExpression4, AExpression5, AExpression6: TdxLinqExpression)
  : IdxLinqOrderBy;
begin
  Result := OrderBy([AExpression1, AExpression2, AExpression3, AExpression4,
    AExpression5, AExpression6]);
end;

function TdxLinqQueryBuilder.OrderBy(const AExpression1, AExpression2,
  AExpression3, AExpression4, AExpression5, AExpression6,
  AExpression7: TdxLinqExpression): IdxLinqOrderBy;
begin
  Result := OrderBy([AExpression1, AExpression2, AExpression3, AExpression4,
    AExpression5, AExpression6, AExpression7]);
end;

function TdxLinqQueryBuilder.OrderBy(const AExpressions
  : array of TdxLinqExpression): IdxLinqOrderBy;
var
  AOrderBy: TOrderBy;
...
function TdxLinqQueryBuilder.Where(const AExpression: TdxLinqExpression)
  : IdxLinqWhere;
begin
  Result := Self;
...
function TdxLinqQueryBuilder.Where(const AExpression: TdxPredicate)
  : IdxLinqWhere;
begin
...
class operator TdxSelectQueryable.Implicit(const AQueryable: IdxQueryable)
  : TdxSelectQueryable;
begin
  Result.FQueryable := AQueryable;
end;

class operator TdxSelectQueryable.Implicit(const AOperator: TdxSelectQueryable)
  : IdxQueryable;
begin
...
class operator TdxSelectTupleQueryable.Implicit(const AQueryable: IdxQueryable)
  : TdxSelectTupleQueryable;
begin
  Result.FQueryable := AQueryable;
end;

class operator TdxSelectTupleQueryable.Implicit(const AOperator
  : TdxSelectTupleQueryable): IdxQueryable;
begin
  Result := AOperator.FQueryable;
end;
...
class operator TdxSelectTake.Implicit(const AQueryable: IdxQueryable)
  : TdxSelectTake;
begin
  Result.FQueryable := AQueryable;
end;

class operator TdxSelectTake.Implicit(const AOperator: TdxSelectTake)
  : IdxQueryable;
begin
  Result := AOperator.FQueryable;
end;
...
class operator TdxSelectTupleTake.Implicit(const AQueryable: IdxQueryable)
  : TdxSelectTupleTake;
begin
  Result.FQueryable := AQueryable;
end;

class operator TdxSelectTupleTake.Implicit(const AOperator: TdxSelectTupleTake)
  : IdxQueryable;
begin
  Result := AOperator.FQueryable;
end;
...
class operator TdxSelectSkip.Implicit(const AQueryable: IdxQueryable)
  : TdxSelectSkip;
begin
  Result.FQueryable := AQueryable;
end;

class operator TdxSelectSkip.Implicit(const AOperator: TdxSelectSkip)
  : IdxQueryable;
begin
  Result := AOperator.FQueryable;
end;
...
class operator TdxSelectTupleSkip.Implicit(const AQueryable: IdxQueryable)
  : TdxSelectTupleSkip;
begin
  Result.FQueryable := AQueryable;
end;

class operator TdxSelectTupleSkip.Implicit(const AOperator: TdxSelectTupleSkip)
  : IdxQueryable;
begin
  Result := AOperator.FQueryable;
end;
...
class operator TdxSelectTuple.Implicit(const AQueryable: IdxQueryable)
  : TdxSelectTuple;
begin
  Result.FQueryable := AQueryable;
end;

class operator TdxSelectTuple.Implicit(const AOperator: TdxSelectTuple)
  : IdxQueryable;
begin
  Result := AOperator.FQueryable;
end;
...
function TdxLinqQueryBuilder<T>.GetMemberExpression(AIndex: Integer)
  : TdxLinqExpression;
var
...
begin
  ...
  if (AIndex < 1) or (AIndex > AEntityInfo.MemberAttributes.Count) then
    raise Exception.CreateFmt(sdxOrderByTermOutOfRange,
      [AEntityInfo.MemberAttributes.Count]);
  Result := TdxLinqExpression(AEntityInfo.MemberAttributes[AIndex - 1]
    .MemberName);
end;

{$REGION 'IdxLinqIndexOrderBy<T>'}

function TdxLinqQueryBuilder<T>.OrderBy(const AIndex: Integer)
  : IdxLinqIndexOrderBy<T>;
begin
...
function TdxLinqQueryBuilder<T>.OrderBy(const AIndex1, AIndex2: Integer)
  : IdxLinqIndexOrderBy<T>;
begin
  inherited OrderBy([GetMemberExpression(AIndex1),
    GetMemberExpression(AIndex2)]);
  Result := Self;
end;

function TdxLinqQueryBuilder<T>.OrderBy(const AIndex1, AIndex2,
  AIndex3: Integer): IdxLinqIndexOrderBy<T>;
begin
  inherited OrderBy([GetMemberExpression(AIndex1), GetMemberExpression(AIndex2),
    GetMemberExpression(AIndex3)]);
  Result := Self;
end;
...
begin
  inherited OrderBy([GetMemberExpression(AIndex1), GetMemberExpression(AIndex2),
    GetMemberExpression(AIndex3), GetMemberExpression(AIndex4)]);
  Result := Self;
end;

function TdxLinqQueryBuilder<T>.OrderBy(const AIndex1, AIndex2, AIndex3,
  AIndex4, AIndex5: Integer): IdxLinqIndexOrderBy<T>;
begin
  inherited OrderBy([GetMemberExpression(AIndex1), GetMemberExpression(AIndex2),
    GetMemberExpression(AIndex3), GetMemberExpression(AIndex4),
    GetMemberExpression(AIndex5)]);
  Result := Self;
end;

function TdxLinqQueryBuilder<T>.OrderBy(const AIndex1, AIndex2, AIndex3,
  AIndex4, AIndex5, AIndex6: Integer): IdxLinqIndexOrderBy<T>;
begin
  inherited OrderBy([GetMemberExpression(AIndex1), GetMemberExpression(AIndex2),
    GetMemberExpression(AIndex3), GetMemberExpression(AIndex4),
    GetMemberExpression(AIndex5), GetMemberExpression(AIndex6)]);
  Result := Self;
end;

function TdxLinqQueryBuilder<T>.OrderBy(const AIndex1, AIndex2, AIndex3,
  AIndex4, AIndex5, AIndex6, AIndex7: Integer): IdxLinqIndexOrderBy<T>;
begin
  inherited OrderBy([GetMemberExpression(AIndex1), GetMemberExpression(AIndex2),
    GetMemberExpression(AIndex3), GetMemberExpression(AIndex4),
    GetMemberExpression(AIndex5), GetMemberExpression(AIndex6),
    GetMemberExpression(AIndex7)]);
  Result := Self;
end;

function TdxLinqQueryBuilder<T>.OrderBy(const AIndexes: array of Integer)
  : IdxLinqIndexOrderBy<T>;
var
...
begin
  if FQueryProvider = nil then
    FQueryProvider := (FDataContext.Session as TdxEMFCustomSession)
      .GetQueryProvider<T>;
...
function TdxLinqQueryBuilder<T>.OrderBy(const AExpression: TdxLinqExpression)
  : IdxLinqOrderBy<T>;
begin
...
function TdxLinqQueryBuilder<T>.OrderBy(const AExpression1,
  AExpression2: TdxLinqExpression): IdxLinqOrderBy<T>;
begin
  inherited OrderBy(AExpression1, AExpression2);
  Result := Self;
end;

function TdxLinqQueryBuilder<T>.OrderBy(const AExpression1, AExpression2,
  AExpression3: TdxLinqExpression): IdxLinqOrderBy<T>;
begin
...
function TdxLinqQueryBuilder<T>.OrderBy(const AExpression1, AExpression2,
  AExpression3, AExpression4: TdxLinqExpression): IdxLinqOrderBy<T>;
begin
...
function TdxLinqQueryBuilder<T>.OrderBy(const AExpression1, AExpression2,
  AExpression3, AExpression4, AExpression5: TdxLinqExpression)
  : IdxLinqOrderBy<T>;
begin
  inherited OrderBy(AExpression1, AExpression2, AExpression3, AExpression4,
    AExpression5);
...
function TdxLinqQueryBuilder<T>.OrderBy(const AExpression1, AExpression2,
  AExpression3, AExpression4, AExpression5, AExpression6,
  AExpression7: TdxLinqExpression): IdxLinqOrderBy<T>;
begin
  inherited OrderBy(AExpression1, AExpression2, AExpression3, AExpression4,
    AExpression5, AExpression6, AExpression7);
  Result := Self;
...
function TdxLinqQueryBuilder<T>.OrderBy(const AExpressions
  : array of TdxLinqExpression): IdxLinqOrderBy<T>;
begin
  inherited OrderBy(AExpressions);
  Result := Self;
end;
...
function TdxLinqQueryBuilder<T>.Where(const AExpression: TdxLinqExpression)
  : IdxLinqWhere<T>;
begin
...
begin
  for I := FLastIndex to Count - 1 do
    (Items[I] as TdxSortByExpression).SortDirection :=
      TdxSortDirection.Descending;
end;
...
function TdxLinqBuilder.CreateQuery(const AExpression: IdxExpression)
  : IdxQueryable;
begin
  NotImplemented;
  Result := nil;
...
constructor TdxLinqBuilder<T>.TEnumerator.Create(ALinqBuilder
  : TdxLinqBuilder<T>);
var
...
begin
  ...
  if FIsClass then
    FHasDispose := EntityManager.GetEntityInfo
      (ATypeInfo.TypeData.ClassType) = nil;
end;
...
constructor TdxLinqBuilder<T>.Create(AOwner: TdxLinqQueryBuilder;
  const ANewFunc: TdxFunc<T>);
begin
...
constructor TdxLinqBuilder<T>.Create(AOwner: TdxLinqQueryBuilder;
  const ANewFunc: TdxFunc<TArray<Variant>, T>);
begin
  inherited Create(AOwner);
...
begin
  if Assigned(FOnNew) then
    Result := FOnNew
  else if Assigned(FOnNewFromVariants) then
...
function TdxLinqBuilder<T>.CreateQueryGeneric(const AExpression: IdxExpression)
  : IdxQueryable<T>;
begin
  Result := nil;
end;
...
class operator TdxLinqFrom.Implicit(const ADataContext: IdxDataContext)
  : TdxLinqFrom;
begin
...
type
  ...
  private
    ...
    procedure RawCallback(AUserData: Pointer; const AArgs: TArray<TValue>;
      out AResult: TValue); virtual;
    procedure ErrorProc;
  protected
    function QueryInterface(const IID: TGUID; out AObject): HResult;
      virtual; stdcall;
  public
...
begin
  ...
  for I := 0 to FIntercepts.Count - 1 do
    PVTablePtr(VTable)[FIntercepts[I].VirtualIndex] :=
      FIntercepts[I].CodeAddress;
...
procedure TVirtualInterface.RawCallback(AUserData: Pointer;
...
begin
  Result := TVirtualInterface(PByte(Self) - (PByte(@Self.VTable) - PByte(Self)
    ))._AddRef;
end;
...
begin
  Result := TVirtualInterface(PByte(Self) - (PByte(@Self.VTable) - PByte(Self)))
    .QueryInterface(IID, AObject);
end;

function TVirtualInterface.QueryInterface(const IID: TGUID;
  out AObject): HResult;
begin
  if IID = FIID then
  begin
...
type
  ...
  TdxEntityMetadataInfo = class(TInterfacedObject, IdxEntityMetadataInfo,
    IdxEntityInfo)
  strict private
    FClass: TClass;
    FOwner: IdxQueryProvider;
  ...
  public
    constructor Create(AClass: TClass; const AOwner: IdxQueryProvider);
      overload;
  end;

  { TdxEntityMetadata }

  TdxEntityMetadata = class(TVirtualInterface, IdxEntityMetadataInfo,
    IdxEntityInfo)
  strict private
  type
    ...
    public
      constructor Create(AEntityMetadata: TdxEntityMetadata;
    ...
    TCollectionExpression = class(TVirtualInterface,
      IdxLinqCollectionExpression)
    strict private
      class var FAggregateFunctionTypes
        : TDictionary<string, TdxAggregateFunctionType>;
      class destructor Destroy;
    ...
    protected
      procedure InvokeEvent(Method: TRttiMethod; const Args: TArray<TValue>;
        out Result: TValue);
      // aggregate expressions
      function Average(const AValue: TdxLinqExpression): TdxLinqExpression;
      function Count: TdxLinqExpression; overload;
      function Count(const AValue: TdxLinqExpression)
        : TdxLinqExpression; overload;
      ...
      property MemberName: string read GetMemberName;
    public
      constructor Create(PIID: PTypeInfo; AEntityMetadata: TdxEntityMetadata;
        AMemberInfo: TdxMappingMemberInfo); overload;
      constructor Create(AEntityMetadata: TdxEntityMetadata;
        AMemberInfo: TdxMappingMemberInfo); overload;
    end;
  ...
  protected
    procedure EntityMetadataInvokeEvent(Method: TRttiMethod;
      const Args: TArray<TValue>; out Result: TValue);
    procedure CaptureInstance(AInstance: Pointer);
    procedure ReleaseInstance;
    function GetEntityClass: TClass;
  ...
  public
    constructor Create(PIID: PTypeInfo; AClass: TClass;
      const AOwner: IdxQueryProvider); overload;
    destructor Destroy; override;
  ...
  protected
    procedure DataContextInvokeEvent(Method: TRttiMethod;
      const Args: TArray<TValue>; out Result: TValue);
    function GetSession: IdxSession;
...
constructor TdxEntityMetadata.TCustomEntityMember.Create(AEntityMetadata
  : TdxEntityMetadata; AMemberInfo: TdxMappingMemberInfo);
begin
  inherited Create;
...
constructor TdxEntityMetadata.TCollectionExpression.Create(PIID: PTypeInfo;
  AEntityMetadata: TdxEntityMetadata; AMemberInfo: TdxMappingMemberInfo);
begin
...
constructor TdxEntityMetadata.TCollectionExpression.Create(AEntityMetadata
  : TdxEntityMetadata; AMemberInfo: TdxMappingMemberInfo);
begin
  inherited Create;
  FEntityMetadata := AEntityMetadata;
...
class procedure TdxEntityMetadata.TCollectionExpression.
...
function TdxEntityMetadata.TCollectionExpression.Average
  (const AValue: TdxLinqExpression): TdxLinqExpression;
begin
...
begin
  ...
  Result := TdxAggregateOperand.Create(AOperandProperty, nil,
    TdxAggregateFunctionType.Count, nil);
end;

function TdxEntityMetadata.TCollectionExpression.Count
  (const AValue: TdxLinqExpression): TdxLinqExpression;
begin
  raise ENotImplemented.Create('');
end;

procedure TdxEntityMetadata.TCollectionExpression.InvokeEvent
  (Method: TRttiMethod; const Args: TArray<TValue>; out Result: TValue);
...
begin
  ...
  begin
    FAggregateFunctionTypes :=
      TDictionary<string, TdxAggregateFunctionType>.Create;
    PopulateAggregateFunctionTypes;
  end;
  if FAggregateFunctionTypes.TryGetValue(LowerCase(Method.Name), AAggregateFunc)
  then
  begin
...
function TdxEntityMetadata.TCollectionExpression.Max(const AValue
  : TdxLinqExpression): TdxLinqExpression;
begin
  raise ENotImplemented.Create('');
end;

function TdxEntityMetadata.TCollectionExpression.Min(const AValue
  : TdxLinqExpression): TdxLinqExpression;
begin
  raise ENotImplemented.Create('');
end;

function TdxEntityMetadata.TCollectionExpression.Sum(const AValue
  : TdxLinqExpression): TdxLinqExpression;
begin
  raise ENotImplemented.Create('');
end;
...
constructor TdxEntityMetadata.Create(PIID: PTypeInfo; AClass: TClass;
  const AOwner: IdxQueryProvider);
begin
...
procedure TdxEntityMetadata.EntityMetadataInvokeEvent(Method: TRttiMethod;
  const Args: TArray<TValue>; out Result: TValue);
...
begin
  ...
  begin
    ...
    begin
      ...
      begin
        ALinqCollectionExpression := TCollectionExpression.Create(Self,
          AMember);
      ...
      begin
        ...
        begin
          Supports(TCollectionExpression.Create(AReturnType.Handle, Self,
            AMember), AReturnType.Handle.TypeData.GUID,
  ...
  begin
    ...
    begin
      if not FEntityInfo.Members.TryGetValue(AName, AMember) then
        raise Exception.CreateFmt(sdxLinqExpressionFieldNotFound,
          [AName, FEntityInfo.ClassAttributes.EntityName]);
...
class function TdxLinqExpressionFactory.FindClass
  (AExpression: PTypeInfo): TClass;
var
...
class function TdxLinqExpressionFactory.GetDataContext(const ASession
  : IdxSession): IdxDataContext;
begin
  Result := TdxDataContext.Create(ASession);
end;

class function TdxLinqExpressionFactory.GetDataContext(ADataContext: PTypeInfo;
  const ASession: IdxSession): IdxDataContext;
begin
...
class function TdxLinqExpressionFactory.DataContextEntityClasses
  (ADataContext: PTypeInfo): TArray<TClass>;
var
  AType: TRttiType;
  AMethods: TArray<TRttiMethod>;
  AMethod: TRttiMethod;
...
class function TdxLinqExpressionFactory.GetEntityMetadata(AClass: TClass;
  const AOwner: IdxQueryProvider): IdxEntityInfo;
var
...
begin
  ...
  Supports(TdxEntityMetadata.Create(AExpression, AClass, AOwner),
    AExpression.TypeData.GUID, Result);
end;
...
class procedure TdxLinqExpressionFactory.RegisterDataContext
  (ADataContext: PTypeInfo);
begin
  if FDataContexts = nil then
    FDataContexts := TList<PTypeInfo>.Create;
...
class procedure TdxLinqExpressionFactory.RegisterExpression(AClass: TClass;
  AExpression: PTypeInfo);
var
  AEntityInfo: TdxEntityInfo;
begin
...
class function TdxLinqExpressionFactory.TryGetExpression(AClass: TClass;
  out AExpression: PTypeInfo): Boolean;
begin
  if FExpressions = nil then
    Result := False
...
constructor TdxEntityMetadataInfo.Create(AClass: TClass;
  const AOwner: IdxQueryProvider);
begin
  inherited Create;
  FClass := AClass;
...
function TdxEntityMetadataInfo.FieldByName(const AIndex: string)
  : TdxLinqExpression;
begin
...
procedure TdxDataContext.DataContextInvokeEvent(Method: TRttiMethod;
  const Args: TArray<TValue>; out Result: TValue);
var
  AInfo: TInfo;
  ASource: Pointer;
begin
  ...
  else if SameText(Method.Name, 'EntityByName') then
    Result := TValue.From<IdxEntityInfo>(EntityByName(Args[1].AsString))
  else if SameText(Method.Name, 'GetEntityInfo') then
