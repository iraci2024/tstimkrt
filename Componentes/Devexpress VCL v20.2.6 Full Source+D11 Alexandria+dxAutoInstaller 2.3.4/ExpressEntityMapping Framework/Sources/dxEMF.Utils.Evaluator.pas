...
type
  ...
  TdxEvaluateCustomFunctionHandler = reference to function(const AFunctionName
    : string; const AOperands: array of TValue): TValue;

  { TdxClientCriteriaVisitorBase }

  TdxClientCriteriaVisitorBase = class(TcxIUnknownObject,
    IdxCriteriaOperatorVisitor)
  // IdxClientCriteriaVisitor<TdxCriteriaOperator>)
  protected
    function DoVisit(const AOperand: IdxAggregateOperand;
      AProcessCollectionProperty: Boolean): IdxCriteriaOperator;
      overload; virtual;
    function DoVisit(const AOperand: IdxOperandProperty): IdxCriteriaOperator;
      overload; virtual;
    function DoVisit(const AOperand: IdxJoinOperand): IdxCriteriaOperator;
      overload; virtual;

    function Process(const AInput: IdxCriteriaOperator)
      : IdxCriteriaOperator; overload;
    function ProcessCollection(const AOperands: IdxCriteriaOperatorCollection;
  ...
  TdxNodeCriteriaFinder = class(TcxIUnknownObject, IdxCriteriaVisitorListString,
    IQueryCriteriaToStringListVisitor)
  strict private
  ...
  public
    class function FindCriteria(const ACurrentNodeAlias: string;
      ...
      : TDictionary<string, TdxPlanAliasCriteriaInfo>; overload; static;
    ...
    function Find(const ACurrentNodeAlias: string;
      const ACriteria: IdxCriteriaOperator)
      : TDictionary<string, TdxPlanAliasCriteriaInfo>; overload;
    procedure Find(const ACurrentNodeAlias: string;
      const ACriteria: IdxCriteriaOperator;
      APreviousDictionary: TDictionary<string,
      TdxPlanAliasCriteriaInfo>); overload;
    ...
    function ProcessAddOperands(const AOperands: TArray<IdxCriteriaOperator>)
      : TList<string>;
    function ProcessOperands(const AOperands: IdxCriteriaOperatorCollection)
      : TList<string>;
    ...
    function Visit(const AOperator: IdxBetweenOperator): TList<string>;
      overload;
  end;

  { TdxIsLogicalCriteriaChecker }

  TdxIsLogicalCriteriaChecker = class(TcxIUnknownObject,
    IdxClientCriteriaVisitor<TdxBooleanCriteriaState>)
  strict private
    class var FInstance: TdxIsLogicalCriteriaChecker;
    class destructor Finalize;
    class function GetInstance: TdxIsLogicalCriteriaChecker; static;
  public
    class function GetBooleanState(const AOperand: IdxCriteriaOperator)
      : TdxBooleanCriteriaState; static;
    function Visit(const AOperand: IdxAggregateOperand)
      : TdxBooleanCriteriaState; overload;
    function Visit(const AOperand: IdxJoinOperand)
      : TdxBooleanCriteriaState; overload;
    function Visit(const AOperand: IdxOperandProperty)
      : TdxBooleanCriteriaState; overload;
    ...
    function Visit(const AOperator: IdxFunctionOperator)
      : TdxBooleanCriteriaState; overload;
    function Process(AOperand: TdxCriteriaOperator)
      : TdxBooleanCriteriaState; overload;
  ...
  public
    ...
    class function Create(const AProperty: IdxOperandProperty)
      : TdxEvaluatorProperty; overload; static;
    class function CalcCollectionPropertyDepth(const AProp: string)
      : Integer; static;
    class function GetPropertySeparatorDotPos(const AProperty: string): Integer;
      overload; static;
    class function GetPropertySeparatorDotPos(const AProperty: string;
      AStartPos: Integer): Integer; overload; static;
    class function GetIsThisProperty(const APropertyName: string)
      : Boolean; static;
    ...
    property PropertyPathTokenized: TArray<string>
      read GetPropertyPathTokenized;
  end;
  ...
  strict private
    ...
    FSource: TObject;
  public
    constructor Create(ADescriptor: TdxEvaluatorContextDescriptor;
      ASource: TObject);
    ...
    function GetQueryContexts(const AQueryTypeName: string;
      const ACondition: IdxCriteriaOperator; ATop: Integer)
      : TEnumerable<TdxEvaluatorContext>;
  ...
  public
    function GetPropertyValue(ASource: TObject;
      APropertyPath: TdxEvaluatorProperty): TObject; virtual; abstract;
    function GetNestedContext(ASource: TObject; const APropertyPath: string)
      : TdxEvaluatorContext; virtual; abstract;
    function GetCollectionContexts(ASource: TObject;
      const ACollectionName: string): IEnumerable; virtual; abstract;
    function GetQueryContexts(ASource: TObject; const AQueryTypeName: string;
      const ACondition: IdxCriteriaOperator; ATop: Integer)
      : TEnumerable<TdxEvaluatorContext>; virtual;

    property IsTopLevelCollectionSource: Boolean
      read GetIsTopLevelCollectionSource;
  end;
  ...
  public
    constructor Create(AFnType: TdxFunctionOperatorType;
      ACaseSensitive: Boolean; AArgumentCount: Integer);
  ...
  public
    constructor Create(AProperty: TdxEvaluatorProperty;
      const APropertyNameInCriteria: string);
  ...
  public
    constructor Create(AProperties: TDictionary<TdxJoinContextPropertyInfo,
      Boolean>);
    function GetJoinContextValueInfoSet(AContext: TdxEvaluatorContext)
      : TdxJoinContextValueInfoSet;
...
{$REGION 'Evaluation Cache types'}
    ...
    public
      ...
      procedure Fill(AContext: TdxEvaluatorContext;
    ...
    public
      constructor Create(AChunks: TList<TJoinEvaluationCacheChunk>;
        AAllChunksObjects: TDictionary<TObject, Integer>);

      property Chunks: TList<TJoinEvaluationCacheChunk> read FChunks;
      property AllChunksObjects: TDictionary<TObject, Integer>
        read FAllChunksObjects;
    end;
    ...
    public
      constructor Create(const AQueryTypeName: string;
...
{$ENDREGION}
  strict private
    ...
    FCacheStack: TStack<TDictionary<TJoinEvaluationContextCacheKey,
      TJoinEvaluationCacheInfo>>;
    FCacheDictionary: TDictionary<TJoinEvaluationContextCacheKey,
      TJoinEvaluationCacheInfo>;
  public
    constructor Create;
    ...
    function GetQueryContexts(const AContexts: TArray<TdxEvaluatorContext>;
      const AQueryTypeName: string; const ACondition: IdxCriteriaOperator;
      ATop: Integer; out AFiltered: Boolean): TEnumerable<TdxEvaluatorContext>;
  end;

  { TdxExpressionEvaluatorCoreBase }

  TdxExpressionEvaluatorCoreBase = class abstract(TcxIUnknownObject,
    IdxCriteriaVisitor<TValue>)
  strict private
  type
...
{$ENDREGION}
  ...
  protected
    ...
    function Compare(const ALeftValue, ARightValue: TValue;
      AIsEqualityCompare: Boolean): Integer; overload;
    function Compare(const ALeftValue, ARightValue: TValue): Integer; overload;
    class function GetBool(const AValue: TdxNullableValue<Boolean>): TValue;
      overload; static;
    class function GetBool(const AValue: TValue): TdxNullableValue<Boolean>;
      overload; static;
    class function GetValueAsBool(const AValue: TValue): Boolean;
      overload; static;
    ...
    class function EvaluateLambdaFunction(AFnType: TdxFunctionOperatorType;
      ACaseSensitive: Boolean; AArgs: TArray<TObject>): TValue; static;
    function UnaryNumericPromotions(const AOperand: TValue): TValue;
    procedure DoAggregate(AParam: TAggregateProcessingParam;
      const AContextsCollection: TEnumerable<TdxEvaluatorContext>;
      const AFilterExpression: IdxCriteriaOperator;
      const AExpression: IdxCriteriaOperator); overload;
    function DoAggregate(AAggregateFunctionType: TdxAggregateFunctionType;
      const AContextsCollection: TEnumerable<TdxEvaluatorContext>;
      const AFilterExpression: IdxCriteriaOperator;
      const AExpression: IdxCriteriaOperator): TValue; overload;
    ...
    function GetContext(AUpDepth: Integer): TdxEvaluatorContext; overload;
      virtual; abstract;
    procedure PushCollectionContext(AContext
      : TEnumerable<TdxEvaluatorContext>); virtual;
  ...
  public
    ...
    constructor Create(ACaseSensitive: Boolean;
      AEvaluateCustomFunction: TdxEvaluateCustomFunctionHandler); overload;
    function Evaluate(AEvaluationContext: TdxEvaluatorContext;
      const AEvaluatorCriteria: IdxCriteriaOperator): TValue; overload;
    function Evaluate(AEvaluationContext: TdxEvaluatorContext;
      const AEvaluatorCriteria: IdxCriteriaOperator;
      const ACustomComparer: IdxComparer): TValue; overload;
    function EvaluateOnObjects(AEvaluatorContextCollection
      : TEnumerable<TdxEvaluatorContext>; AFilterCriteria: TdxCriteriaOperator;
      const ACustomComparer: IdxComparer = nil): TArray<TValue>;
    function Filter(const AEvaluatorContextCollection
      : TEnumerable<TdxEvaluatorContext>; AFilterCriteria: TdxCriteriaOperator)
      : TEnumerable<TdxEvaluatorContext>;
    function Fit(AEvaluationContext: TdxEvaluatorContext;
      const AFilterCriteria: IdxCriteriaOperator): Boolean; overload;
  end;
  ...
  public
    ...
    property Store[AIndex: TdxOperandProperty]: TdxEvaluatorProperty
      read GetStore; default;
  end;

  { TdxExpressionEvaluatorCore }

  TdxExpressionEvaluatorCore = class(TdxExpressionEvaluatorCoreBase,
    IdxClientCriteriaVisitor<TValue>)
  strict private
  ...
  protected
    ...
    procedure PushCollectionContext(AContext
      : TEnumerable<TdxEvaluatorContext>); override;
    function PopCollectionContext: TEnumerable<TdxEvaluatorContext>; override;
    function CreateNestedJoinContext(const AJoinTypeName: string;
      ACondition: TdxCriteriaOperator; ATop: Integer; out AFiltered: Boolean)
      : TEnumerable<TdxEvaluatorContext>;
    function CreateNestedContext(ACollectionProperty: TdxEvaluatorProperty)
      : TEnumerable<TdxEvaluatorContext>;
  ...
  protected
    ...
    function PrepareContext(AValuesSource: TObject)
      : TdxEvaluatorContext; virtual;
    function EvaluateCustomFunction(const AFunctionName: string;
      const AOperands: TArray<TValue>): TValue; virtual;

    property EvaluatorCore: TdxExpressionEvaluatorCoreBase
      read GetEvaluatorCore;
  public
    constructor Create(ADescriptor: TdxEvaluatorContextDescriptor;
      const ACriteria: IdxCriteriaOperator; ACaseSensitive: Boolean;
      ADoCreateEvaluatorCore: Boolean); overload;
    constructor Create(ADescriptor: TdxEvaluatorContextDescriptor;
      const ACriteria: IdxCriteriaOperator; ACaseSensitive: Boolean); overload;
    constructor Create(ADescriptor: TdxEvaluatorContextDescriptor;
      const ACriteria: IdxCriteriaOperator); overload;
    constructor Create(AProperties: TdxPropertyDescriptorCollection;
      const ACriteria: IdxCriteriaOperator; ACaseSensitive: Boolean;
      ADoCreateEvaluatorCore: Boolean); overload;
    constructor Create(AProperties: TdxPropertyDescriptorCollection;
      const ACriteria: IdxCriteriaOperator; ACaseSensitive: Boolean); overload;
    constructor Create(AProperties: TdxPropertyDescriptorCollection;
      const ACriteria: IdxCriteriaOperator); overload;
    constructor Create(AProperties: TdxPropertyDescriptorCollection;
      const ACriteria: string; ACaseSensitive: Boolean); overload;
    constructor Create(AProperties: TdxPropertyDescriptorCollection;
      const ACriteria: string); overload;
    function Evaluate(AObject: TObject): TObject; overload;
    function Evaluate(AObject: TObject; const ACustomComparer: IdxComparer)
      : TObject; overload;
    function EvaluateOnObjects(const AObjects: IEnumerable)
      : TArray<TObject>; overload;
    function EvaluateOnObjects(const AObjects: IEnumerable;
      const ACustomComparer: IdxComparer): TArray<TObject>; overload;
    ...
    property ThrowExceptionIfNotFoundCustomFunction: Boolean
      read FThrowExceptionIfNotFoundCustomFunction
      write FThrowExceptionIfNotFoundCustomFunction;
  end;
  ...
  protected
    class function MakeTypicalOutlookInterval(const AOp: IdxCriteriaOperator;
      ALowerBound, AUpperBound: TdxFunctionOperatorType)
      : IdxCriteriaOperator; static;
    class function MakeIsSameDayInterval(const AOp: IdxCriteriaOperator;
      ALowerBound, AUpperBound: TDateTime): IdxCriteriaOperator; static;
    class function MakeIsSameDayCriteria(const AOperator: IdxFunctionOperator)
      : IdxCriteriaOperator; static;
    class function MakeMonthCriteria(const AOp: IdxCriteriaOperator;
      AMonth: Integer): TdxBinaryOperator; static;
  ...
  public
    class function ExpandIsOutlookInterval(const AOperator: IdxFunctionOperator)
      : IdxCriteriaOperator; static;
    class function EvaluateLocalDateTime(AType: TdxFunctionOperatorType)
      : TDateTime; static;
    class function IsLocalDateTime(AFunctionOperatorType
      : TdxFunctionOperatorType): Boolean; static;
    class function IsOutlookInterval(AFunctionOperatorType
      : TdxFunctionOperatorType): Boolean; static;
  end;
...
type
  ...
  protected
    function DoVisit(const AOperand: IdxOperandProperty)
      : IdxCriteriaOperator; override;
    function DoVisit(const AOperand: IdxAggregateOperand;
      AProcessCollectionProperty: Boolean): IdxCriteriaOperator; override;
  public
    constructor Create(AValueInfoSet: TdxJoinContextValueInfoSet);
    class function Process(AValueInfoSet: TdxJoinContextValueInfoSet;
  ...
  protected
    ...
    function DoVisit(const AOperand: IdxOperandProperty)
      : IdxCriteriaOperator; override;
    function DoVisit(const AOperand: IdxJoinOperand)
      : IdxCriteriaOperator; override;
  public
    constructor Create(const AContexts: TArray<TdxEvaluatorContext>); overload;
    constructor Create(const AContexts: TArray<TdxEvaluatorContext>;
      AZeroLevelLeave: Boolean); overload;
    destructor Destroy; override;
    class function ProcessZeroLevelLeave(const AContexts
      : TArray<TdxEvaluatorContext>; const ACriteria: IdxCriteriaOperator;
      out AZeroLevelProperties: TdxJoinContextPropertyInfoSet)
      : IdxCriteriaOperator; static;
    class function Process(const AContexts: TArray<TdxEvaluatorContext>;
      const ACriteria: IdxCriteriaOperator): IdxCriteriaOperator;
      overload; static;
    function GetProperty(const APropertyPath: string): TdxEvaluatorProperty;
    property ZeroLevelLeave: Boolean read FZeroLevelLeave;
    property ZeroLevelProperties
      : TDictionary<TdxJoinContextPropertyInfo, Boolean>
      read FZeroLevelProperties;
  end;

  { TdxJoinContextCriteriaPatcher }

constructor TdxJoinContextCriteriaPatcher.Create(AValueInfoSet
  : TdxJoinContextValueInfoSet);
begin
  inherited Create;
...
class function TdxJoinContextCriteriaPatcher.Process(AValueInfoSet
  : TdxJoinContextValueInfoSet; const ACriteria: IdxCriteriaOperator)
  : IdxCriteriaOperator;
begin
...
function TdxJoinContextCriteriaPatcher.DoVisit(const AOperand
  : IdxOperandProperty): IdxCriteriaOperator;
var
  AValue: TValue;
begin
...
function TdxJoinContextCriteriaPatcher.DoVisit(const AOperand
  : IdxAggregateOperand; AProcessCollectionProperty: Boolean)
  : IdxCriteriaOperator;
begin
...
constructor TdxJoinContextCriteriaCreator.Create(const AContexts
  : TArray<TdxEvaluatorContext>);
begin
  inherited Create;
  FLevel := 1;
...
constructor TdxJoinContextCriteriaCreator.Create(const AContexts
  : TArray<TdxEvaluatorContext>; AZeroLevelLeave: Boolean);
begin
  Create(AContexts);
  FZeroLevelProperties := TDictionary<TdxJoinContextPropertyInfo,
    Boolean>.Create;
...
class function TdxJoinContextCriteriaCreator.ProcessZeroLevelLeave
  (const AContexts: TArray<TdxEvaluatorContext>;
  const ACriteria: IdxCriteriaOperator;
  out AZeroLevelProperties: TdxJoinContextPropertyInfoSet): IdxCriteriaOperator;
var
  AJoinContextCriteriaCreator: TdxJoinContextCriteriaCreator;
begin
  AJoinContextCriteriaCreator := TdxJoinContextCriteriaCreator.Create
    (AContexts, True);
  try
    Result := AJoinContextCriteriaCreator.Process
      (ACriteria as TdxCriteriaOperator);
    AZeroLevelProperties := TdxJoinContextPropertyInfoSet.Create
      (AJoinContextCriteriaCreator.ZeroLevelProperties);
  finally
    AJoinContextCriteriaCreator.Free;
  end;
end;

class function TdxJoinContextCriteriaCreator.Process(const AContexts
  : TArray<TdxEvaluatorContext>; const ACriteria: IdxCriteriaOperator)
  : IdxCriteriaOperator;
begin
...
function TdxJoinContextCriteriaCreator.GetProperty(const APropertyPath: string)
  : TdxEvaluatorProperty;
var
...
begin
  ...
  begin
    AResult := TdxEvaluatorProperty.Create
      (TdxOperandProperty.Create(APropertyPath));
    FPropertyCache.Add(APropertyPath, AResult);
  end;
  Result := AResult;
end;

function TdxJoinContextCriteriaCreator.DoVisit(const AOperand
  : IdxAggregateOperand; AProcessCollectionProperty: Boolean)
  : IdxCriteriaOperator;
begin
  Inc(FLevel);
...
begin
  ...
  while {$IFDEF DELPHIXE3}APropertyPath.StartsWith('^.'){$ELSE}TdxStringHelper.
    StartsWith(APropertyPath, '^.'){$ENDIF} do
  begin
    APropertyPath :=
    {$IFDEF DELPHIXE3}APropertyPath.Substring(2){$ELSE}TdxStringHelper.Substring
      (APropertyPath, 2){$ENDIF};
    Dec(ACurrentLevel);
  end;
  ...
  begin
    ...
    begin
      ...
      FZeroLevelProperties.AddOrSetValue
        (TdxJoinContextPropertyInfo.Create(GetProperty(APropertyPath),
        APropertyIdName), True);
      Exit(TdxOperandProperty.Create(APropertyIdName));
    end;
    Exit(TdxOperandValue.Create(FContexts[1 - ACurrentLevel].GetPropertyValue
      (GetProperty(APropertyPath))));
  end;
  Result := AOperand;
end;

function TdxJoinContextCriteriaCreator.DoVisit(const AOperand: IdxJoinOperand)
  : IdxCriteriaOperator;
begin
  Inc(FLevel);
  try
...
function TdxClientCriteriaVisitorBase.Visit(const AOperand: IdxOperandProperty)
  : IdxCriteriaOperator;
begin
  Result := DoVisit(AOperand);
end;

function TdxClientCriteriaVisitorBase.DoVisit(const AOperand
  : IdxAggregateOperand; AProcessCollectionProperty: Boolean)
  : IdxCriteriaOperator;
var
...
begin
  if AProcessCollectionProperty then
    ACollectionProperty := TdxOperandProperty
      (Process(AOperand.CollectionProperty))
  else
  ...
  if ((ACollectionProperty = AOperand.CollectionProperty) and
    (AAggregatedExpression = AOperand.AggregatedExpression)) and
    (ACondition = AOperand.Condition) then
    Result := AOperand
  else
    Result := TdxAggregateOperand.Create(ACollectionProperty,
      AAggregatedExpression, AOperand.AggregateFunctionType, ACondition);
end;

function TdxClientCriteriaVisitorBase.Visit(const AOperand: IdxJoinOperand)
  : IdxCriteriaOperator;
begin
  Result := DoVisit(AOperand);
end;

function TdxClientCriteriaVisitorBase.Visit(const AOperator
  : IdxFunctionOperator): IdxCriteriaOperator;
var
  AModified: Boolean;
...
begin
  ...
  if AModified then
    Result := TdxFunctionOperator.Create(AOperator.OperatorType,
      AResultOperands)
  else
    Result := AOperator;
end;

function TdxClientCriteriaVisitorBase.Visit(const AOperand: IdxOperandValue)
  : IdxCriteriaOperator;
begin
  Result := AOperand;
end;

function TdxClientCriteriaVisitorBase.Visit(const AOperator: IdxGroupOperator)
  : IdxCriteriaOperator;
var
  AModified: Boolean;
  AResultOperands: IdxCriteriaOperatorCollection;
...
function TdxClientCriteriaVisitorBase.Visit(const AOperator: IdxInOperator)
  : IdxCriteriaOperator;
var
  AModified: Boolean;
...
function TdxClientCriteriaVisitorBase.Visit(const AOperator: IdxUnaryOperator)
  : IdxCriteriaOperator;
var
...
function TdxClientCriteriaVisitorBase.Visit(const AOperator: IdxBinaryOperator)
  : IdxCriteriaOperator;
var
...
begin
  ...
  if (ALeftOperand = AOperator.LeftOperand) and
    (ARightOperand = AOperator.RightOperand) then
    Result := AOperator
  else
    Result := TdxBinaryOperator.Create(ALeftOperand, ARightOperand,
      AOperator.OperatorType);
end;

function TdxClientCriteriaVisitorBase.Visit(const AOperator: IdxBetweenOperator)
  : IdxCriteriaOperator;
var
...
begin
  ...
  if ((ATest = AOperator.TestExpression) and
    (ABegin = AOperator.BeginExpression)) and (AEnd = AOperator.EndExpression)
  then
    Result := AOperator
  else
...
function TdxClientCriteriaVisitorBase.DoVisit(const AOperand: IdxJoinOperand)
  : IdxCriteriaOperator;
var
  AAggregatedExpression, ACondition: IdxCriteriaOperator;
begin
  AAggregatedExpression := Process(AOperand.AggregatedExpression);
  ACondition := Process(AOperand.Condition);
  if (AAggregatedExpression = AOperand.AggregatedExpression) and
    (ACondition = AOperand.Condition) then
    Exit(AOperand);
  Result := TdxJoinOperand.Create(AOperand.JoinTypeName,
    Process(AOperand.Condition), AOperand.AggregateFunctionType,
    Process(AOperand.AggregatedExpression));
end;

function TdxClientCriteriaVisitorBase.Process(const AInput: IdxCriteriaOperator)
  : IdxCriteriaOperator;
begin
  if AInput = nil then
    Result := nil
...
function TdxClientCriteriaVisitorBase.ProcessCollection(const AOperands
  : IdxCriteriaOperatorCollection; out AModified: Boolean)
...
function TdxClientCriteriaVisitorBase.Visit(const AOperand: IdxAggregateOperand)
  : IdxCriteriaOperator;
begin
...
class function TdxNodeCriteriaFinder.FindCriteria(const ACurrentNodeAlias
  : string; const ACriteria: IdxCriteriaOperator)
  : TDictionary<string, TdxPlanAliasCriteriaInfo>;
var
...
class procedure TdxNodeCriteriaFinder.FindCriteria(const ACurrentNodeAlias
  : string; const ACriteria: IdxCriteriaOperator;
  APreviousDictionary: TDictionary<string, TdxPlanAliasCriteriaInfo>);
var
  AFinder: TdxNodeCriteriaFinder;
...
function TdxNodeCriteriaFinder.Find(const ACurrentNodeAlias: string;
  const ACriteria: IdxCriteriaOperator)
  : TDictionary<string, TdxPlanAliasCriteriaInfo>;
begin
  Find(ACurrentNodeAlias, ACriteria,
    TDictionary<string, TdxPlanAliasCriteriaInfo>.Create);
  Result := FCriteriaDictionary;
end;

procedure TdxNodeCriteriaFinder.Find(const ACurrentNodeAlias: string;
  const ACriteria: IdxCriteriaOperator;
  APreviousDictionary: TDictionary<string, TdxPlanAliasCriteriaInfo>);
begin
...
function TdxNodeCriteriaFinder.Process(const ACriteria: IdxCriteriaOperator)
  : TList<string>;
begin
...
function TdxNodeCriteriaFinder.Visit(const AOperand: IdxQuerySubQueryContainer)
  : TList<string>;
begin
  Result := nil;
  NotImplemented;
...
function TdxNodeCriteriaFinder.Visit(const AOperand: IdxQueryOperand)
  : TList<string>;
var
  AList: TList<string>;
begin
...
function TdxNodeCriteriaFinder.Visit(const AOperator: IdxFunctionOperator)
  : TList<string>;
begin
...
function TdxNodeCriteriaFinder.Visit(const AOperand: IdxOperandValue)
  : TList<string>;
begin
  Result := nil;
end;

function TdxNodeCriteriaFinder.Visit(const AOperator: IdxGroupOperator)
  : TList<string>;
begin
  ...
  begin
    if FInAtomicGroupLevel > 0 then
      ...
      Result := ProcessAddOperands
        ((AOperator.Operands as TdxCriteriaOperatorCollection).ToArray);
  end;
end;

function TdxNodeCriteriaFinder.ProcessAddOperands(const AOperands
  : TArray<IdxCriteriaOperator>): TList<string>;
var
  ACount, I: Integer;
...
begin
  ...
  begin
    ...
    begin
      AList := TdxPlanAliasCriteriaInfo.Create
        ({$IFDEF DELPHIXE3}ANodesString.Split(['.']){$ELSE}TdxStringHelper.Split
        (ANodesString, ['.']){$ENDIF}, TdxCriteriaOperatorList.Create);
...
class function TdxNodeCriteriaFinder.GetNodesString
  (AList: TList<string>): string;
var
  ASb: TStringBuilder;
  ACount, I: Integer;
  APrevNode: string;
...
function TdxNodeCriteriaFinder.ProcessOperands(const AOperands
  : IdxCriteriaOperatorCollection): TList<string>;
var
...
function TdxNodeCriteriaFinder.Visit(const AOperator: IdxInOperator)
  : TList<string>;
var
...
function TdxNodeCriteriaFinder.Visit(const AOperator: IdxUnaryOperator)
  : TList<string>;
begin
  Inc(FInAtomicGroupLevel);
  try
...
function TdxNodeCriteriaFinder.Visit(const AOperator: IdxBinaryOperator)
  : TList<string>;
var
...
function TdxNodeCriteriaFinder.Visit(const AOperator: IdxBetweenOperator)
  : TList<string>;
var
...
class function TdxIsLogicalCriteriaChecker.GetInstance
  : TdxIsLogicalCriteriaChecker;
begin
...
class function TdxIsLogicalCriteriaChecker.GetBooleanState(const AOperand
  : IdxCriteriaOperator): TdxBooleanCriteriaState;
begin
  Result := Instance.Process(AOperand as TdxCriteriaOperator);
end;

function TdxIsLogicalCriteriaChecker.Visit(const AOperand: IdxAggregateOperand)
...
function TdxIsLogicalCriteriaChecker.Visit(const AOperand: IdxJoinOperand)
  : TdxBooleanCriteriaState;
begin
  if AOperand.AggregateFunctionType = TdxAggregateFunctionType.Exists then
    Result := TdxBooleanCriteriaState.Logical
...
function TdxIsLogicalCriteriaChecker.Visit(const AOperand: IdxOperandProperty)
  : TdxBooleanCriteriaState;
begin
  Result := TdxBooleanCriteriaState.Value;
end;

function TdxIsLogicalCriteriaChecker.Visit(const AOperator: IdxBetweenOperator)
  : TdxBooleanCriteriaState;
begin
  Result := TdxBooleanCriteriaState.Logical;
end;

function TdxIsLogicalCriteriaChecker.Visit(const AOperator: IdxBinaryOperator)
  : TdxBooleanCriteriaState;
begin
  case AOperator.OperatorType of
    TdxBinaryOperatorType.Equal, TdxBinaryOperatorType.Greater,
      TdxBinaryOperatorType.GreaterOrEqual, TdxBinaryOperatorType.Less,
      TdxBinaryOperatorType.LessOrEqual, TdxBinaryOperatorType.NotEqual:
      Result := TdxBooleanCriteriaState.Logical;
  else
    Result := TdxBooleanCriteriaState.Value;
  end;
...
function TdxIsLogicalCriteriaChecker.Visit(const AOperator: IdxUnaryOperator)
  : TdxBooleanCriteriaState;
begin
...
function TdxIsLogicalCriteriaChecker.Visit(const AOperator: IdxInOperator)
  : TdxBooleanCriteriaState;
begin
  Result := TdxBooleanCriteriaState.Logical;
end;

function TdxIsLogicalCriteriaChecker.Visit(const AOperator: IdxGroupOperator)
  : TdxBooleanCriteriaState;
begin
  Result := TdxBooleanCriteriaState.Logical;
end;

function TdxIsLogicalCriteriaChecker.Visit(const AOperand: IdxOperandValue)
  : TdxBooleanCriteriaState;
begin
  Result := TdxBooleanCriteriaState.Value;
end;

function TdxIsLogicalCriteriaChecker.Visit(const AOperator: IdxFunctionOperator)
  : TdxBooleanCriteriaState;
begin
  ...
  case AOperator.OperatorType of
    TdxFunctionOperatorType.IsOutlookIntervalBeyondThisYear,
      ...
      TdxFunctionOperatorType.IsNullOrEmpty, TdxFunctionOperatorType.StartsWith,
      TdxFunctionOperatorType.EndsWith, TdxFunctionOperatorType.Contains,
      TdxFunctionOperatorType.IsThisMonth, TdxFunctionOperatorType.IsThisWeek,
      TdxFunctionOperatorType.IsThisYear, TdxFunctionOperatorType.IsNextMonth,
      TdxFunctionOperatorType.IsNextYear, TdxFunctionOperatorType.IsLastMonth,
      TdxFunctionOperatorType.IsLastYear, TdxFunctionOperatorType.IsYearToDate,
      TdxFunctionOperatorType.IsJanuary, TdxFunctionOperatorType.IsFebruary,
      TdxFunctionOperatorType.IsMarch, TdxFunctionOperatorType.IsApril,
      TdxFunctionOperatorType.IsMay, TdxFunctionOperatorType.IsJune,
      TdxFunctionOperatorType.IsJuly, TdxFunctionOperatorType.IsAugust,
      TdxFunctionOperatorType.IsSeptember, TdxFunctionOperatorType.IsOctober,
      TdxFunctionOperatorType.IsNovember, TdxFunctionOperatorType.IsDecember,
...
function TdxIsLogicalCriteriaChecker.Process(AOperand: TdxCriteriaOperator)
  : TdxBooleanCriteriaState;
begin
...
begin
  ...
  while {$IFDEF DELPHIXE3}FPropertyPath.StartsWith('^.'){$ELSE}TdxStringHelper.
    StartsWith(FPropertyPath, '^.'){$ENDIF} do
  begin
    Inc(FUpDepth);
    FPropertyPath :=
    {$IFDEF DELPHIXE3}FPropertyPath.Substring(2){$ELSE}TdxStringHelper.Substring
      (FPropertyPath, 2){$ENDIF};
  end;
...
class function TdxEvaluatorProperty.GetPropertySeparatorDotPos(const AProperty
  : string): Integer;
begin
...
class function TdxEvaluatorProperty.GetPropertySeparatorDotPos(const AProperty
  : string; AStartPos: Integer): Integer;
var
  APos: Integer;
begin
  if AProperty = '' then
...
class function TdxEvaluatorProperty.CalcCollectionPropertyDepth
  (const AProp: string): Integer;
var
  ARv, APos: Integer;
begin
  ARv := 1;
...
{$ELSE}
      ARv.Add(TdxStringHelper.Substring(AProp, ASubPropertyStart,
        ADotPos - ASubPropertyStart));
{$ENDIF}
...
{$IFDEF DELPHIXE3}
    FSubProperty := TdxEvaluatorProperty.Create
      (string.Join('.', PropertyPathTokenized, 1,
      Length(PropertyPathTokenized) - 1));
{$ELSE}
    FSubProperty := TdxEvaluatorProperty.Create(TdxStringHelper.Join('.',
      PropertyPathTokenized, 1, Length(PropertyPathTokenized) - 1));
{$ENDIF}
  Result := FSubProperty;
end;
...
class function TdxEvaluatorProperty.Create(const AProperty: IdxOperandProperty)
  : TdxEvaluatorProperty;
begin
  Result := TdxEvaluatorProperty.Create(AProperty.PropertyName);
end;

class function TdxEvaluatorProperty.GetIsThisProperty(const APropertyName
  : string): Boolean;
const
...
begin
  if APropertyName = '' then
    Exit(True);
  Result := (Length(APropertyName) = Length(ThisLowerString)) and
    (LowerCase(APropertyName) = ThisLowerString)
end;

{ TdxEvaluatorContext }

constructor TdxEvaluatorContext.Create(ADescriptor
  : TdxEvaluatorContextDescriptor; ASource: TObject);
begin
  inherited Create;
...
function TdxEvaluatorContext.GetPropertyValue(APropertyPath
  : TdxEvaluatorProperty): TObject;
begin
  Result := Descriptor.GetPropertyValue(Source, APropertyPath);
end;

function TdxEvaluatorContext.GetNestedContext(const APropertyPath: string)
  : TdxEvaluatorContext;
begin
  Result := Descriptor.GetNestedContext(Source, APropertyPath);
end;

function TdxEvaluatorContext.GetCollectionContexts(const ACollectionName
  : string): IEnumerable;
begin
...
function TdxEvaluatorContext.GetQueryContexts(const AQueryTypeName: string;
  ...
  : TEnumerable<TdxEvaluatorContext>;
begin
  Result := Descriptor.GetQueryContexts(Source, AQueryTypeName,
    ACondition, ATop);
end;

{ TdxEvaluatorContextDescriptor }

function TdxEvaluatorContextDescriptor.GetQueryContexts(ASource: TObject;
  const AQueryTypeName: string; const ACondition: IdxCriteriaOperator;
  ATop: Integer): TEnumerable<TdxEvaluatorContext>;
begin
...
constructor TdxFnFuncKey.Create(AFnType: TdxFunctionOperatorType;
  ACaseSensitive: Boolean; AArgumentCount: Integer);
begin
  FFnType := AFnType;
...
begin
  Result := ((FFnType = AOther.FFnType) and
    (FArgumentCount = AOther.FArgumentCount)) and
    (FCaseSensitive = AOther.FCaseSensitive);
end;

{ TdxJoinContextPropertyInfo }

constructor TdxJoinContextPropertyInfo.Create(AProperty: TdxEvaluatorProperty;
  const APropertyNameInCriteria: string);
begin
  FProperty := AProperty;
...
begin
  ...
  Result := (FProperty = AOther.FProperty) and
    (FPropertyNameInCriteria = AOther.FPropertyNameInCriteria);
end;
...
constructor TdxJoinContextValueInfoSet.Create(AProperties
...
constructor TdxJoinContextPropertyInfoSet.Create(AProperties
  : TDictionary<TdxJoinContextPropertyInfo, Boolean>);
begin
  FProperties := AProperties;
end;
...
function TdxJoinContextPropertyInfoSet.GetJoinContextValueInfoSet
  (AContext: TdxEvaluatorContext): TdxJoinContextValueInfoSet;
var
...
begin
  ...
  for APropertyInfo in FProperties.Keys do
    AResult.AddOrSetValue(APropertyInfo.PropertyNameInCriteria,
      AContext.GetPropertyValue(APropertyInfo.&Property));
  Result := TdxJoinContextValueInfoSet.Create(AResult);
end;

{ TdxExpressionEvaluatorCoreBase.TAggregateProcessingParam }

constructor TdxExpressionEvaluatorCoreBase.TAggregateProcessingParam.Create
  (AEvaluator: TdxExpressionEvaluatorCoreBase);
begin
...
constructor TdxJoinEvaluationContextCache.TJoinEvaluationCacheChunk.Create
  (const ACriteria: IdxCriteriaOperator);
begin
  FCriteria := ACriteria;
...
procedure TdxJoinEvaluationContextCache.TJoinEvaluationCacheChunk.Fill
  (AContext: TdxEvaluatorContext; const AQueryTypeName: string);
begin
...
constructor TdxJoinEvaluationContextCache.TJoinEvaluationCacheInfo.Create
...
constructor TdxJoinEvaluationContextCache.TJoinEvaluationContextCacheKey.Create
  (const AQueryTypeName: string; const ACondition: IdxCriteriaOperator);
begin
...
function TdxJoinEvaluationContextCache.TJoinEvaluationContextCacheKey.Equals
...
begin
  ...
  if AOther = nil then
    Exit(False);
  Result := (FQueryTypeName = AOther.FQueryTypeName) and
    TdxCriteriaOperator.Equals(FCondition, AOther.FCondition);
end;

function TdxJoinEvaluationContextCache.TJoinEvaluationContextCacheKey.
  GetHashCode: Integer;
begin
...
constructor TdxJoinEvaluationContextCache.TCriteriaOperatorKey.Create
  (const ACondition: IdxCriteriaOperator);
begin
  FCondition := ACondition;
end;

function TdxJoinEvaluationContextCache.TCriteriaOperatorKey.Equals
  (AObj: TObject): Boolean;
var
...
function TdxJoinEvaluationContextCache.TCriteriaOperatorKey.GetHashCode
  : Integer;
begin
  if FCondition = nil then
    Result := $73423562
...
begin
  FCollectionContextStack := TStack < TEnumerable < TdxEvaluatorContext
    >>.Create;
  FCacheStack := TStack < TDictionary < TJoinEvaluationContextCacheKey,
    TJoinEvaluationCacheInfo >>.Create;
  FCacheDictionary := TDictionary<TJoinEvaluationContextCacheKey,
    TJoinEvaluationCacheInfo>.Create;
end;

procedure TdxJoinEvaluationContextCache.PushCollectionContext
  (AContext: TEnumerable<TdxEvaluatorContext>);
begin
...
function TdxJoinEvaluationContextCache.PopCollectionContext
  : TEnumerable<TdxEvaluatorContext>;
begin
...
function TdxJoinEvaluationContextCache.GetQueryContexts(const AContexts
  : TArray<TdxEvaluatorContext>; const AQueryTypeName: string;
  const ACondition: IdxCriteriaOperator; ATop: Integer; out AFiltered: Boolean)
  : TEnumerable<TdxEvaluatorContext>;
var
...
begin
  ...
  begin
    AFiltered := True;
    Exit(AContexts[1].GetQueryContexts(AQueryTypeName,
      TdxJoinContextCriteriaCreator.Process(AContexts, ACondition), ATop));
  end;
  ACacheCondition := TdxJoinContextCriteriaCreator.ProcessZeroLevelLeave
    (AContexts, ACondition, AZeroLevelProperties);
  ACacheKey := TJoinEvaluationContextCacheKey.Create(AQueryTypeName,
    ACacheCondition);
  ...
  begin
    ...
    begin
      if AContext.Source = nil then
        Continue;
      ACurrentCondition := TdxJoinContextCriteriaPatcher.Process
        (AZeroLevelProperties.GetJoinContextValueInfoSet(AContext),
        ACacheCondition);
      ...
      begin
        AChunks.Add(TJoinEvaluationCacheChunk.Create
          (TdxGroupOperator.Create(TdxGroupOperatorType.Or,
          TdxArray<TCriteriaOperatorKey>.Select<IdxCriteriaOperator>
          (AChunkGroup.Keys.ToArray,
  ...
  AFiltered := False;
  if not ACacheInfo.AllChunksObjects.TryGetValue(AContexts[1].Source,
    AFoundChunkIndex) then
...
begin
  FFnFunctions := TDictionary < TdxFnFuncKey, TFunc < TArray<TObject>,
    TObject >>.Create;
end;
...
AEvaluateCustomFunction: TdxEvaluateCustomFunctionHandler);
begin
  FCaseSensitive := ACaseSensitive;
end;
...
function TdxExpressionEvaluatorCoreBase.Process(const AOperand
  : IdxCriteriaOperator): TValue;
begin
  if AOperand = nil then
    Exit(nil);
  NotImplemented;
...
function TdxExpressionEvaluatorCoreBase.Visit(const AOperator
  : IdxBetweenOperator): TValue;
var
  AVal: TValue;
begin
  AVal := Process(AOperator.TestExpression as TdxCriteriaOperator);
  if Compare(AVal, Process(AOperator.BeginExpression as TdxCriteriaOperator)) < 0
  then
    Exit(False);
  if Compare(AVal, Process(AOperator.EndExpression as TdxCriteriaOperator)) > 0
  then
    Exit(False);
  Result := True;
end;

function TdxExpressionEvaluatorCoreBase.Compare(const ALeftValue,
  ARightValue: TValue; AIsEqualityCompare: Boolean): Integer;
begin
  NotImplemented;
  Result := 0;
end;
...
function TdxExpressionEvaluatorCoreBase.Compare(const ALeftValue,
  ARightValue: TValue): Integer;
begin
  Result := Compare(ALeftValue, ARightValue, False);
end;

class function TdxExpressionEvaluatorCoreBase.GetBool
  (const AValue: TdxNullableValue<Boolean>): TValue;
begin
  if AValue = True then
    Result := FTrueValue
  else
...
begin
  ...
  begin
    ...
    if not AProcessed.HasValue then
      ANullsDetected := True
    else if AProcessed.Value = AShortCircuitValue then
...
function TdxExpressionEvaluatorCoreBase.Visit(const AOperator
  : IdxFunctionOperator): TValue;
begin
  NotImplemented;
end;

function TdxExpressionEvaluatorCoreBase.FnIsSameDay
  (AOperator: TdxFunctionOperator): TValue;
var
  AOperands: IdxCriteriaOperatorCollection;
...
class function TdxExpressionEvaluatorCoreBase.GetBool(const AValue: TValue)
  : TdxNullableValue<Boolean>;
begin
...
class function TdxExpressionEvaluatorCoreBase.GetValueAsBool
...
function TdxExpressionEvaluatorCoreBase.FnIif
  (AOperator: TdxFunctionOperator): TValue;
var
  AIndex: Integer;
  AIifDiscriminator: TdxNullableValue<Boolean>;
begin
  if (AOperator.Operands.Count < 3) or (((AOperator.Operands.Count mod 2) = 0))
  then
    raise EArgumentException.Create('');
  AIndex := -2;
  repeat
    Inc(AIndex, 2);
    AIifDiscriminator :=
      GetBool(Process(TdxCriteriaOperator(AOperator.Operands[AIndex])));
...
function TdxExpressionEvaluatorCoreBase.FnIsNull
  (AOperator: TdxFunctionOperator): TValue;
var
  AOp: IdxCriteriaOperator;
  AObj: TValue;
...
class function TdxExpressionEvaluatorCoreBase.EvaluateLambdaFunction
  (AFnType: TdxFunctionOperatorType; ACaseSensitive: Boolean;
AArgs: TArray<TObject>): TValue;
begin
  NotImplemented;
end;

function TdxExpressionEvaluatorCoreBase.Visit(const AOperand
  : IdxOperandValue): TValue;
begin
  Result := AOperand.Value;
end;

function TdxExpressionEvaluatorCoreBase.UnaryNumericPromotions
  (const AOperand: TValue): TValue;
begin
  NotImplemented;
end;

function TdxExpressionEvaluatorCoreBase.Visit(const AOperator
  : IdxUnaryOperator): TValue;
var
...
begin
  ...
  case AOperator.OperatorType of
    ...
    raise ENotImplemented.Create
      ('ExpressionEvaluatorOperatorSubtypeNotImplemented');
  end;
end;

procedure TdxExpressionEvaluatorCoreBase.DoAggregate
  (AParam: TAggregateProcessingParam;
const AContextsCollection: TEnumerable<TdxEvaluatorContext>;
const AFilterExpression: IdxCriteriaOperator;
const AExpression: IdxCriteriaOperator);
var
...
function TdxExpressionEvaluatorCoreBase.DoAggregate(AAggregateFunctionType
...
begin
  case AAggregateFunctionType of
    ...
    raise ENotImplemented.Create
      (Format('ExpressionEvaluatorOperatorSubtypeNotImplemented',
      [] { , TypeOf(AggregateOperand).Name, AAggregateFunctionType.ToString) } )
      );
  end;
  try
...
function TdxExpressionEvaluatorCoreBase.Evaluate(AEvaluationContext
  : TdxEvaluatorContext; const AEvaluatorCriteria: IdxCriteriaOperator): TValue;
begin
  Result := Evaluate(AEvaluationContext, AEvaluatorCriteria, nil);
end;

function TdxExpressionEvaluatorCoreBase.Evaluate(AEvaluationContext
  : TdxEvaluatorContext; const AEvaluatorCriteria: IdxCriteriaOperator;
const ACustomComparer: IdxComparer): TValue;
begin
...
function TdxExpressionEvaluatorCoreBase.EvaluateOnObjects
  (AEvaluatorContextCollection: TEnumerable<TdxEvaluatorContext>;
AFilterCriteria: TdxCriteriaOperator; const ACustomComparer: IdxComparer = nil)
  : TArray<TValue>;
var
  ...
  try
    ...
    try
      for AEvaluatorContext in AEvaluatorContextCollection do
        AResult.Add(Evaluate(AEvaluatorContext, AFilterCriteria,
          ACustomComparer));
...
procedure TdxExpressionEvaluatorCoreBase.PushCollectionContext
  (AContext: TEnumerable<TdxEvaluatorContext>);
begin
end;

function TdxExpressionEvaluatorCoreBase.PopCollectionContext
  : TEnumerable<TdxEvaluatorContext>;
begin
  Result := nil;
end;

function TdxExpressionEvaluatorCoreBase.Filter(const AEvaluatorContextCollection
  : TEnumerable<TdxEvaluatorContext>; AFilterCriteria: TdxCriteriaOperator)
  : TEnumerable<TdxEvaluatorContext>;
var
...
function TdxExpressionEvaluatorCoreBase.Fit(AEvaluationContext
  : TdxEvaluatorContext; const AFilterCriteria: IdxCriteriaOperator): Boolean;
begin
...
function TdxExpressionEvaluatorCoreBase.Fit(const AFilterCriteria
...
function TdxEvaluatorPropertyCache.GetStore(AIndex: TdxOperandProperty)
  : TdxEvaluatorProperty;
begin
...
function TdxExpressionEvaluatorCore.GetContext(AUpDepth: Integer)
  : TdxEvaluatorContext;
begin
  Result := FContexts[AUpDepth];
end;

procedure TdxExpressionEvaluatorCore.PushCollectionContext
  (AContext: TEnumerable<TdxEvaluatorContext>);
begin
  FJoinCache.PushCollectionContext(AContext);
end;

function TdxExpressionEvaluatorCore.PopCollectionContext
  : TEnumerable<TdxEvaluatorContext>;
begin
  Result := FJoinCache.PopCollectionContext;
end;

function TdxExpressionEvaluatorCore.CreateNestedJoinContext(const AJoinTypeName
  : string; ACondition: TdxCriteriaOperator; ATop: Integer;
...
begin
  ...
  TArray.Copy<TdxEvaluatorContext>(AParentContext, FContexts, 0, 1,
    Length(AParentContext));
  Result := FJoinCache.GetQueryContexts(FContexts, AJoinTypeName, ACondition,
    ATop, AFiltered);
end;

function TdxExpressionEvaluatorCore.CreateNestedContext(ACollectionProperty
  : TdxEvaluatorProperty): TEnumerable<TdxEvaluatorContext>;
begin
  NotImplemented;
  Result := nil;
end;

function TdxExpressionEvaluatorCore.Visit(const AOperand
  : IdxAggregateOperand): TValue;
begin
  NotImplemented;
  Result := TValue.Empty;
end;
...
constructor TdxExpressionEvaluator.Create(ADescriptor
  : TdxEvaluatorContextDescriptor; const ACriteria: IdxCriteriaOperator;
ACaseSensitive: Boolean; ADoCreateEvaluatorCore: Boolean);
begin
  inherited Create;
...
constructor TdxExpressionEvaluator.Create(AProperties
  : TdxPropertyDescriptorCollection; const ACriteria: string);
begin
...
constructor TdxExpressionEvaluator.Create(AProperties
  : TdxPropertyDescriptorCollection; const ACriteria: IdxCriteriaOperator);
begin
  Create(AProperties, ACriteria, True);
end;
...
function TdxExpressionEvaluator.GetEvaluatorCore
  : TdxExpressionEvaluatorCoreBase;
begin
  Result := FEvaluatorCore;
end;

procedure TdxExpressionEvaluator.SetDataAccess(const AValue
  : IdxEvaluatorDataAccess);
begin
  NotImplemented;
end;

function TdxExpressionEvaluator.PrepareContext(AValuesSource: TObject)
  : TdxEvaluatorContext;
begin
...
function TdxExpressionEvaluator.Evaluate(AObject: TObject;
const ACustomComparer: IdxComparer): TObject;
begin
  Result := NotImplemented;
end;

function TdxExpressionEvaluator.EvaluateOnObjects(const AObjects: IEnumerable)
  : TArray<TObject>;
begin
...
function TdxExpressionEvaluator.EvaluateOnObjects(const AObjects: IEnumerable;
const ACustomComparer: IdxComparer): TArray<TObject>;
var
...
function TdxExpressionEvaluator.Filter(const AObjects: IEnumerable)
  : IEnumerable;
begin
  NotImplemented
end;

function TdxExpressionEvaluator.EvaluateCustomFunction(const AFunctionName
  : string; const AOperands: TArray<TValue>): TValue;
begin
end;

{ TdxExpressionEvaluatorCoreBase.TExistsProcessingParam }

function TdxExpressionEvaluatorCoreBase.TExistsProcessingParam.
  GetResult: TValue;
begin
  Result := FResult;
end;

function TdxExpressionEvaluatorCoreBase.TExistsProcessingParam.Process
  (const AOperand: TValue): Boolean;
begin
  FResult := True;
  Result := True;
end;
...
function TdxExpressionEvaluatorCoreBase.TSingleProcessingParam.
  GetResult: TValue;
begin
  Result := FResult;
end;

function TdxExpressionEvaluatorCoreBase.TSingleProcessingParam.Process
  (const AOperand: TValue): Boolean;
begin
  if FProcessed then
    raise EInvalidOperation.Create
      ('The collection to which the Single aggregate is applied must be empty or contain exactly one item');
  FResult := AOperand;
  FProcessed := True;
  Result := False;
end;
...
function TdxExpressionEvaluatorCoreBase.TCountProcessingParam.Process
  (const AOperand: TValue): Boolean;
begin
  Inc(FResult);
  Result := False;
...
function TdxExpressionEvaluatorCoreBase.TMinProcessingParam.Process
  (const AOperand: TValue): Boolean;
begin
  if AOperand.IsNullOrEmpty then
...
function TdxExpressionEvaluatorCoreBase.TMaxProcessingParam.Process
  (const AOperand: TValue): Boolean;
begin
  if AOperand.IsNullOrEmpty then
  begin
...
function TdxExpressionEvaluatorCoreBase.TSumProcessingParam.Process
  (const AOperand: TValue): Boolean;
begin
  if AOperand.IsNullOrEmpty then
  begin
    if FResult.IsEmpty then
      ...
      FResult := Evaluator.Process
        (TdxBinaryOperator.Create(TdxOperandValue.Create(FResult),
        TdxOperandValue.Create(AOperand), TdxBinaryOperatorType.Plus));
  end;
  Result := False;
end;
...
function TdxExpressionEvaluatorCoreBase.TAvgProcessingParam.Process
  (const AOperand: TValue): Boolean;
begin
  NotImplemented;
  Result := False;
...
class function TdxEvalHelpers.MakeTypicalOutlookInterval
  (const AOp: IdxCriteriaOperator;
ALowerBound, AUpperBound: TdxFunctionOperatorType): IdxCriteriaOperator;
begin
  Result := TdxGroupOperator.Create(TdxGroupOperatorType.&And,
    [TdxBinaryOperator.Create(AOp, TdxFunctionOperator.Create(ALowerBound, []),
    TdxBinaryOperatorType.GreaterOrEqual), TdxBinaryOperator.Create(AOp,
    TdxFunctionOperator.Create(AUpperBound, []), TdxBinaryOperatorType.Less)]);
end;

class function TdxEvalHelpers.ExpandIsOutlookInterval(const AOperator
  : IdxFunctionOperator): IdxCriteriaOperator;
var
  AOp: IdxCriteriaOperator;
begin
  ...
  case AOperator.OperatorType of
    TdxFunctionOperatorType.IsThisMonth:
      Result := MakeTypicalOutlookInterval(AOp,
    ...
    TdxFunctionOperatorType.IsOutlookIntervalBeyondThisYear:
      Result := TdxBinaryOperator.Create(AOp,
    ...
    raise EInvalidOperation.Create
      ('theOperator.OperatorType is not IsOutlookInterval* or internal error');
  end;
end;

class function TdxEvalHelpers.MakeIsSameDayInterval
  (const AOp: IdxCriteriaOperator; ALowerBound, AUpperBound: TDateTime)
  : IdxCriteriaOperator;
begin
  Result := TdxGroupOperator.Create(TdxGroupOperatorType.&And,
    [TdxBinaryOperator.Create(AOp, TdxOperandValue.Create(ALowerBound),
    TdxBinaryOperatorType.GreaterOrEqual), TdxBinaryOperator.Create(AOp,
    TdxOperandValue.Create(AUpperBound), TdxBinaryOperatorType.Less)]);
end;

class function TdxEvalHelpers.MakeIsSameDayCriteria(const AOperator
  : IdxFunctionOperator): IdxCriteriaOperator;
var
  AOperands: IdxCriteriaOperatorCollection;
  ...
  try
    ...
    begin
      ...
      if ARightOperator = nil then
        Continue;
      ARightConstant := Safe<TdxOperandValue>.Cast
    ...
    try
      ...
      begin
        ...
        AResultOperands.Add(MakeIsSameDayInterval(AOp, AIntervalStart.Value,
          AIntervalEnd.Value));
        AIntervalStart := AConstant;
        AIntervalEnd := IncDay(AConstant);
      end;
      ...
      for AOperand in ANonConstants do
        AResultOperands.Add(TdxGroupOperator.Create(TdxGroupOperatorType.&And,
          [TdxBinaryOperator.Create(AOp,
          TdxFunctionOperator.Create(TdxFunctionOperatorType.DateOf, AOperand),
          TdxBinaryOperatorType.GreaterOrEqual), TdxBinaryOperator.Create(AOp,
          TdxFunctionOperator.Create(TdxFunctionOperatorType.IncDay,
          [TdxFunctionOperator.Create(TdxFunctionOperatorType.DateOf, AOperand),
          TdxConstantValue.Create(1)]), TdxBinaryOperatorType.Less)]));
...
class function TdxEvalHelpers.MakeMonthCriteria(const AOp: IdxCriteriaOperator;
AMonth: Integer): TdxBinaryOperator;
begin
...
class function TdxEvalHelpers.EvaluateLocalDateTime
  (AType: TdxFunctionOperatorType): TDateTime;
begin
  case AType of
    TdxFunctionOperatorType.LocalDateTimeThisYear:
    ...
    raise EInvalidOperation.Create
      ('theOperator.OperatorType is not LocalDateTime* or internal error');
  end;
end;
...
class function TdxEvalHelpers.IsLocalDateTime(AFunctionOperatorType
  : TdxFunctionOperatorType): Boolean;
begin
  Result := AFunctionOperatorType
    in [TdxFunctionOperatorType.LocalDateTimeThisYear,
    TdxFunctionOperatorType.LocalDateTimeThisMonth,
    TdxFunctionOperatorType.LocalDateTimeLastWeek,
    TdxFunctionOperatorType.LocalDateTimeThisWeek,
    TdxFunctionOperatorType.LocalDateTimeYesterday,
...
class function TdxEvalHelpers.IsOutlookInterval(AFunctionOperatorType
  : TdxFunctionOperatorType): Boolean;
begin
  Result := AFunctionOperatorType in [TdxFunctionOperatorType.IsSameDay,
    TdxFunctionOperatorType.IsThisMonth, TdxFunctionOperatorType.IsThisWeek,
    TdxFunctionOperatorType.IsThisYear, TdxFunctionOperatorType.IsNextMonth,
    TdxFunctionOperatorType.IsNextYear, TdxFunctionOperatorType.IsLastMonth,
    TdxFunctionOperatorType.IsLastYear, TdxFunctionOperatorType.IsYearToDate,
