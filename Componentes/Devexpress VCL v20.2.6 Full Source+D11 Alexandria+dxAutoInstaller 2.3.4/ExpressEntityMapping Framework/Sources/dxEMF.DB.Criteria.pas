...
type
  ...
  IdxCriteriaOperatorVisitor = interface
    (IdxClientCriteriaVisitor<IdxCriteriaOperator>)
  end;
  ...
  TdxCriteriaPriorityClass = (Atom, Neg, Mul, Add, BinaryNot, BinaryAnd,
    BinaryXor, BinaryOr, InBetween, CmpGt, CmpEq, IsNull, &Not, &And, &Or);
  ...
  public
    constructor Create(const AResult: string;
      APriorityClass: TdxCriteriaPriorityClass); overload;
    constructor Create(const AResult: string); overload;
    function GetEnclosedResult: string;
    function GetEnclosedResultOnGreaterOrEqual(ABasePriority
      : TdxCriteriaPriorityClass): string;
    function GetEnclosedResultOnGreater(ABasePriority
      : TdxCriteriaPriorityClass): string;
  ...
  TdxCriteriaOperator = class(TInterfacedObject, IdxExpression,
    IdxCriteriaOperator)
  strict private
    class function GetCustomFunctionCount: Integer; static;
  protected
    class function ToBasicStyleString(ACriteria: TdxCriteriaOperator)
      : string; static;
    class function ObjectToCriteriaSafe(AObject: TObject)
      : TdxCriteriaOperator; static;
    class property CustomFunctionCount: Integer read GetCustomFunctionCount;
  public

    procedure Accept(const AVisitor: IdxCriteriaVisitor); overload;
      virtual; abstract;
    function Accept(const AVisitor: IdxCriteriaOperatorVisitor)
      : IdxCriteriaOperator; overload; virtual; abstract;
    function Accept(const AVisitor: IdxSQLGeneratorVisitor): string; overload;
      virtual; abstract;
    function Accept(const AVisitor: IdxClientCriteriaToStringVisitor)
      : TdxCriteriaToStringVisitResult; overload; virtual; abstract;
    function Accept(const AVisitor: IdxCriteriaVisitorListString)
      : TList<string>; overload; virtual; abstract;
    function Accept(const AVisitor
      : IdxClientCriteriaVisitor<TdxBooleanCriteriaState>)
      : TdxBooleanCriteriaState; overload; virtual; abstract;
    class function Equals(AObjectA, AObjectB: TObject): Boolean; reintroduce;
      overload; static;
    class function Equals(const ACriteriaA, ACriteriaB: IdxCriteriaOperator)
      : Boolean; reintroduce; overload; static;
    ...
    class function Parse(const ACriteria: string;
      const AParameters: array of TValue): IdxCriteriaOperator;
      overload; static;
    class function Parse(const ACriteria: string): IdxCriteriaOperator;
      overload; static;
    class function ParseList(const ACriteriaList: string;
      out ACriteriaParametersList: TArray<IdxOperandValue>)
      : TArray<IdxCriteriaOperator>; overload; static;
    class function ParseList(const ACriteriaList: string;
      const AParameters: array of TValue): TArray<IdxCriteriaOperator>;
      overload; static;
    class function ParseList(const ACriteriaList: string)
      : TArray<IdxCriteriaOperator>; overload; static;
    class function ToString(const ACriteria: IdxCriteriaOperator): string;
      reintroduce; overload; static;
    function ToString: string; overload; override;
    class function &And(const ALeftOperator, ARightOperator
      : IdxCriteriaOperator): IdxCriteriaOperator; overload; static;
    class function &And(const AOperands: TArray<IdxCriteriaOperator>)
      : IdxCriteriaOperator; overload; static;
    class function &And(AOperands: TdxCriteriaOperatorList)
      : IdxCriteriaOperator; overload; static;
    class function &Or(const ALeftOperator, ARightOperator: IdxCriteriaOperator)
      : IdxCriteriaOperator; overload; static;
    class function &Or(AOperands: TdxCriteriaOperatorList): IdxCriteriaOperator;
      overload; static;
    function &Not: IdxUnaryOperator;
    class function CriterionEquals(const ALeftOperator, ARightOperator
      : IdxCriteriaOperator): Boolean; static;
  end;
  ...
  TdxCriteriaOperatorCollection = class(TInterfacedObject,
    IdxCriteriaOperatorCollection)
  strict private
  type
    ...
    public
      constructor Create(ACriteriaOperatorCollection
        : TdxCriteriaOperatorCollection);
  ...
  public
    ...
    procedure AddRange(const AOperands
      : IEnumerable<IdxCriteriaOperator>); overload;
    ...
    property Items[AIndex: Integer]: IdxCriteriaOperator read GetItems
  ...
  public
    ...
    function Accept(const AVisitor: IdxClientCriteriaToStringVisitor)
      : TdxCriteriaToStringVisitResult; override;
    function Accept(const AVisitor: IdxCriteriaVisitorListString)
      : TList<string>; override;
    function Accept(const AVisitor
      : IdxClientCriteriaVisitor<TdxBooleanCriteriaState>)
      : TdxBooleanCriteriaState; override;
  ...
  strict private
    ...
    function GetParameterName: string;
  public
    constructor Create(const AParameterName: string;
  ...
  strict private
    ...
    function GetRightOperand: IdxCriteriaOperator;
  public
    constructor Create(const ALeftOperator, ARightOperator: IdxCriteriaOperator;
      AType: TdxBinaryOperatorType); overload;
    constructor Create(const APropertyName: string; const AValue: TValue;
      AType: TdxBinaryOperatorType = TdxBinaryOperatorType.Equal); overload;
    constructor Create(const APropertyName: string; const AValue: string;
      AType: TdxBinaryOperatorType = TdxBinaryOperatorType.Equal); overload;
    constructor Create(const APropertyName: string; AValue: Double;
      AType: TdxBinaryOperatorType = TdxBinaryOperatorType.Equal); overload;
    constructor Create(const APropertyName: string; AValue: Integer;
      AType: TdxBinaryOperatorType = TdxBinaryOperatorType.Equal); overload;
    ...
    property LeftOperand: IdxCriteriaOperator read FLeftOperand
      write FLeftOperand;
    property RightOperand: IdxCriteriaOperator read FRightOperand
      write FRightOperand;
  end;
  ...
  public
    constructor Create; overload;
    constructor Create(AOperatorType: TdxUnaryOperatorType;
      const AOperand: IdxCriteriaOperator); overload;
  ...
  protected
    constructor Create; overload;
  public
    constructor Create(const ATestPropertyName: string;
      const ABeginValue, AEndValue: TValue); overload;
    constructor Create(const ATestExpression, ABeginExpression,
      AEndExpression: IdxCriteriaOperator); overload;
    constructor Create(const ATestPropertyName: string;
      const ABeginExpression, AEndExpression: IdxCriteriaOperator); overload;
    ...
    property BeginExpression: IdxCriteriaOperator read FBeginExpression
      write FBeginExpression;
    property EndExpression: IdxCriteriaOperator read FEndExpression
      write FEndExpression;
    property TestExpression: IdxCriteriaOperator read FTestExpression
      write FTestExpression;
  end;
  ...
  strict private
    ...
    function GetOperands: IdxCriteriaOperatorCollection;
  protected
    class function ObjectsToCriteriaSafe(const AOperands: TArray<TObject>)
      : TArray<IdxCriteriaOperator>; static;
  ...
  public
    ...
    constructor Create(const APropertyName: string;
      const AOperands: TArray<TObject>); overload;
    constructor Create(const APropertyName: string;
      const AOperands: array of const); overload;
    class function Create<T>(const APropertyName: string;
      const AOperands: array of T): TdxInOperator; overload;
    constructor Create(const ALeftOperand: IdxCriteriaOperator;
      const AOperands: TArray<IdxCriteriaOperator>); overload;
    constructor Create(const ALeftOperand: IdxCriteriaOperator;
      const AOperands: array of IdxCriteriaOperator); overload;
    constructor Create(const ALeftOperand: IdxCriteriaOperator;
      const AOperands: array of const); overload;
    constructor Create(const ALeftOperand: IdxCriteriaOperator;
      AOperands: TEnumerable<IdxCriteriaOperator>); overload;
    constructor Create(const ALeftOperand: IdxCriteriaOperator;
      const AOperands: IEnumerable<IdxCriteriaOperator>); overload;
  ...
  IdxAggregateOperand = interface(IdxCriteriaOperator)
    ...
    property AggregatedExpression: IdxCriteriaOperator
      read GetAggregatedExpression;
    property AggregateFunctionType: TdxAggregateFunctionType
      read GetAggregateFunctionType;
  ...
  strict private
    ...
    class function GetPropertyByName(const APropertyName: string)
      : IdxOperandProperty; static;
    function GetIsTopLevel: Boolean;
  private
    function GetAggregatedExpression: IdxCriteriaOperator;
    function GetAggregateFunctionType: TdxAggregateFunctionType;
  ...
  public
    constructor Create; overload;
    constructor Create(const ACollectionProperty: IdxOperandProperty;
    ...
    constructor Create(const ACollectionProperty: string;
      const AAggregatedExpression: string;
      AAggregateFunctionType: TdxAggregateFunctionType;
      const ACondition: IdxCriteriaOperator); overload;
    constructor Create(const ACollectionProperty: string;
      AAggregateFunctionType: TdxAggregateFunctionType;
    ...
    constructor Create(const ACollectionProperty: string;
      const AAggregatedExpression: string;
      AAggregateFunctionType: TdxAggregateFunctionType); overload;
    constructor Create(const ACollectionProperty: string;
      AAggregateFunctionType: TdxAggregateFunctionType); overload;
    ...
    function GetHashCode: Integer; override;
    function Exists(const AAggregatedExpression: IdxCriteriaOperator = nil)
      : IdxAggregateOperand;
    function Count(const AAggregatedExpression: IdxCriteriaOperator = nil)
      : IdxAggregateOperand;
    function Avg(const AAggregatedExpression: IdxCriteriaOperator)
      : IdxAggregateOperand;
    function Max(const AAggregatedExpression: IdxCriteriaOperator)
      : IdxAggregateOperand;
    function Min(const AAggregatedExpression: IdxCriteriaOperator)
      : IdxAggregateOperand;
    function Sum(const AAggregatedExpression: IdxCriteriaOperator)
      : IdxAggregateOperand;
    function Single(const AAggregatedExpression: IdxCriteriaOperator)
      : IdxAggregateOperand;

    property Condition: IdxCriteriaOperator read FCondition write FCondition;
    property CollectionProperty: IdxOperandProperty read FProperty
      write FProperty;
    property AggregatedExpression: IdxCriteriaOperator
      read FAggregatedExpression write FAggregatedExpression;
    property AggregateFunctionType: TdxAggregateFunctionType
      read FAggregateFunctionType write FAggregateFunctionType;
    property IsTopLevel: Boolean read GetIsTopLevel;
  end;
  ...
  strict private
    ...
    function GetJoinTypeName: string;
  public
    constructor Create(const AJoinTypeName: string;
      const ACondition: IdxCriteriaOperator; AType: TdxAggregateFunctionType;
      const AAggregatedExpression: IdxCriteriaOperator); overload;
    constructor Create(const AJoinTypeName: string;
      const ACondition: IdxCriteriaOperator); overload;
    constructor Create(AJoinType: TClass; const ACondition: IdxCriteriaOperator;
      AType: TdxAggregateFunctionType;
      const AAggregatedExpression: IdxCriteriaOperator); overload;
    constructor Create(AJoinType: TClass;
      const ACondition: IdxCriteriaOperator); overload;
    function Accept(const AVisitor: IdxCriteriaOperatorVisitor)
      : IdxCriteriaOperator; override;
    function Accept(const AVisitor: IdxSQLGeneratorVisitor): string; override;
  ...
  protected
    class function CombineCore(AOperatorType: TdxGroupOperatorType;
      const AOperands: array of IdxCriteriaOperator)
      : TArray<IdxCriteriaOperator>; overload; static;
  public
    constructor Create(AType: TdxGroupOperatorType = TdxGroupOperatorType.
      &And); overload;
    constructor Create(AType: TdxGroupOperatorType;
      const AOperands: TArray<IdxCriteriaOperator>); overload;
    constructor Create(AType: TdxGroupOperatorType;
      const AOperands: array of IdxCriteriaOperator); overload;
    constructor Create(AType: TdxGroupOperatorType;
      const AOperands: TEnumerable<IdxCriteriaOperator>); overload;
    constructor Create(AType: TdxGroupOperatorType;
      const AOperands: IEnumerable<IdxCriteriaOperator>); overload;
    ...
    function Equals(Obj: TObject): Boolean; override;
    function GetHashCode: Integer; override;
    class function Combine(AOperatorType: TdxGroupOperatorType;
      const ALeftOperator, ARightOperator: IdxCriteriaOperator)
      : IdxCriteriaOperator; overload; static;
    class function Combine(AOperatorType: TdxGroupOperatorType;
      const AOperands: array of IdxCriteriaOperator): IdxCriteriaOperator;
      overload; static;
    class function Combine(AOperatorType: TdxGroupOperatorType;
    ...
    property Operands: IdxCriteriaOperatorCollection read FOperands;
    property OperatorType: TdxGroupOperatorType read FOperatorType
      write FOperatorType;
  end;
  ...
  public
    constructor Create; overload;
    constructor Create(AType: TdxFunctionOperatorType;
      const AOperands: TArray<IdxCriteriaOperator>); overload;
    constructor Create(AType: TdxFunctionOperatorType;
      const AOperands: array of IdxCriteriaOperator); overload;
    constructor Create(AType: TdxFunctionOperatorType;
    ...
    class function GuessIsLogicalCustomFunction(const AOperator
      : IdxFunctionOperator): Boolean; static;

    property Operands: IdxCriteriaOperatorCollection read FOperands;
    property OperatorType: TdxFunctionOperatorType read FOperatorType
      write FOperatorType;
  end;
  ...
  public
    constructor Create(const AProperty: IdxCriteriaOperator;
      ASortDirection: TdxSortDirection = TdxSortDirection.Ascending); overload;
    constructor Create(const APropertyName: string;
      ASortDirection: TdxSortDirection = TdxSortDirection.Ascending); overload;
    constructor Create; overload;
    function Equals(Obj: TObject): Boolean; override;
    ...
    property SortDirection: TdxSortDirection read FSortDirection
  ...
  public
    constructor Create; overload;
    constructor Create(const ASortProperties
      : TArray<IdxSortByExpression>); overload;
    constructor Create(const ASortProperties
      : array of IdxSortByExpression); overload;
    destructor Destroy; override;
    ...
    function Add(const AProperty: IdxCriteriaOperator;
      ASortDirection: TdxSortDirection = TdxSortDirection.Ascending)
      : Integer; overload;
    function Add(const APropertyName: string;
      ASortDirection: TdxSortDirection = TdxSortDirection.Ascending)
      : Integer; overload;
    procedure Clear;
  ...
  public
    ...
    constructor Create(const AColumnName: string;
      const ANodeAlias: string); overload;
    constructor Create(const AColumnName: string; const ANodeAlias: string;
  ...
  public
    constructor Create;
    destructor Destroy; override;
    function TryGetCriteria(const ATableName: string;
      out ACriteria: IdxCriteriaOperator): Boolean;
    function GetCompleteCriteria(const ATableName: string): IdxCriteriaOperator;
    procedure UpdateCriteria(const ATableName: string;
      const ACriteria: IdxCriteriaOperator);
    procedure UpdateCommonCriteria(const ACriteria: IdxCriteriaOperator);
    class function GetCommonCriteriaSet(const ACommonCriteria
      : IdxCriteriaOperator): TdxObjectGeneratorCriteriaSet; static;
    class function GetCriteriaSet(const ATableName: string;
      const ACriteria: IdxCriteriaOperator): TdxObjectGeneratorCriteriaSet;
      overload; static;
    class function GetCriteriaSet(const ATableName: string;
      const ACriteria, ACommonCriteria: IdxCriteriaOperator)
      : TdxObjectGeneratorCriteriaSet; overload; static;
  ...
  public type
    TCriteria = (TBetweenOperator, TBinaryOperator, TUnaryOperator, TInOperator,
      TGroupOperator, TOperandValue, TFunctionOperator,

      TOperandProperty, TAggregateOperand, TJoinOperand);
  strict private
    class var FCriteria: TDictionary<TClass, TCriteria>;
    class constructor Create;
    class destructor Destroy;
  public
    class function Accept<T>(const ACriteriaOperator: IdxCriteriaOperator;
      const AVisitor: IdxCriteriaVisitor<T>): T; overload;
    class function Accept<T>(const ACriteriaOperator: IdxCriteriaOperator;
      const AVisitor: IdxClientCriteriaVisitor<T>): T; overload;
    class function GetCriteriaType(const ACriteriaOperator: IdxCriteriaOperator)
      : TCriteria;
  end;
...
type
  ...
  protected
    function ProcessToCommaDelimitedList(const AOperands
      : IEnumerable<IdxCriteriaOperator>): string;
    function GetBetweenText: string; inline;
    function GetIsNotNullText: string; inline;
    function CreateIsNotNull(ANullOp: TdxUnaryOperator)
      : TdxCriteriaToStringVisitResult;
    function GetNotLikeText: string; inline;
    function CreateNotLike(const ALikeOp: IdxBinaryOperator)
      : TdxCriteriaToStringVisitResult;
    function GetIsNullText: string; inline;
    function GetInText: string; inline;
    function GetFunctionText(AOperandType: TdxFunctionOperatorType)
      : string; virtual;
    function GetCustomFunctionText(const P: string): string; virtual;
    function GetOperatorString(AOperandType: TdxAggregateFunctionType)
      : string; overload;
    function Process(const AOperand: IdxCriteriaOperator)
      : TdxCriteriaToStringVisitResult;
  public
    function GetOperatorString(AOperatorType: TdxBinaryOperatorType): string;
      overload; virtual; abstract;
    function GetOperatorString(AOperatorType: TdxGroupOperatorType): string;
      overload; virtual; abstract;
    function GetOperatorString(AOperatorType: TdxUnaryOperatorType): string;
      overload; virtual; abstract;
    function Visit(const AOperand: IdxBetweenOperator)
      : TdxCriteriaToStringVisitResult; overload;
    function Visit(const AOperand: IdxBinaryOperator)
      : TdxCriteriaToStringVisitResult; overload;
    function Visit(const AOperand: IdxUnaryOperator)
      : TdxCriteriaToStringVisitResult; overload;
    function Visit(const AOperand: IdxInOperator)
      : TdxCriteriaToStringVisitResult; overload;
    function Visit(const AOperand: IdxGroupOperator)
      : TdxCriteriaToStringVisitResult; overload;
    function Visit(const AOperand: IdxOperandValue)
      : TdxCriteriaToStringVisitResult; overload; virtual; abstract;
    function Visit(const AOperand: IdxFunctionOperator)
      : TdxCriteriaToStringVisitResult; overload;
    function Visit(const AOperand: IdxAggregateOperand)
      : TdxCriteriaToStringVisitResult; overload;
    function Visit(const AOperand: IdxJoinOperand)
      : TdxCriteriaToStringVisitResult; overload;
    function Visit(const AOperand: IdxOperandProperty)
      : TdxCriteriaToStringVisitResult; overload;

    function Visit(const AOperand: IdxQueryOperand)
      : TdxCriteriaToStringVisitResult; overload;
    function Visit(const AOperand: IdxQuerySubQueryContainer)
      : TdxCriteriaToStringVisitResult; overload;
  end;

  { TdxCriteriaToStringWithParametersProcessor }

  TdxCriteriaToStringWithParametersProcessor = class abstract
    (TdxCriteriaToStringBase)
  public const
  ...
  TdxCriteriaToStringParameterlessProcessor = class abstract
    (TdxCriteriaToStringBase)
  public const
    NullString = 'null';
  public
    class function ValueToString(AValue: TValue): string; overload; static;
    class function ValueToString(const AValue: TValue; AIsLegacy: Boolean)
      : string; overload; static;
    class function UserTypeToString(const AValue: TValue; AIsLegacy: Boolean)
      : string; static;
    class function OperandValueOrParameterToString(const AVal: IdxOperandValue;
      AIsLegacy: Boolean): string; static;
    class function FixNonFixedText(const AToFix: string; AIsLegacy: Boolean;
      const AValue: TValue): string; static;
    class function GetSuffix(const AValue: TValue): string; static;
    class function ValueToCriteriaToStringVisitResult(const AOperand
      : IdxOperandValue): TdxCriteriaToStringVisitResult; static;
    function Visit(const AOperand: IdxOperandValue)
      : TdxCriteriaToStringVisitResult; override;
  end;
  ...
  TdxCriteriaToBasicStyleParameterlessProcessor = class
    (TdxCriteriaToStringParameterlessProcessor)
  strict private
    class var FInstance: TdxCriteriaToBasicStyleParameterlessProcessor;
    class constructor Initialize;
    class destructor Finalize;
  public
    class function GetBasicOperatorString(AOperatorType: TdxBinaryOperatorType)
      : string; overload; static;
    class function GetBasicOperatorString(AOperatorType: TdxUnaryOperatorType)
      : string; overload; static;
    class function GetBasicOperatorString(AOperatorType: TdxGroupOperatorType)
      : string; overload; static;
    function GetOperatorString(AOperatorType: TdxUnaryOperatorType): string;
      overload; override;
    function GetOperatorString(AOperatorType: TdxBinaryOperatorType): string;
    ...
    function GetOperatorString(AOperatorType: TdxGroupOperatorType): string;
      overload; override;
    class function ToString(const AOperand: IdxCriteriaOperator): string;
      reintroduce; overload; static;
  end;
  ...
  public const
    Name = 'Like';
  public
    class function Create(const AValue, APattern: IdxCriteriaOperator)
      : TdxFunctionOperator; static;
    class function IsName(const AName: string): Boolean; static;
    class function Convert(const ALike: IdxFunctionOperator): IdxBinaryOperator;
      overload; static;
    class function Convert(const ALike: IdxBinaryOperator): IdxFunctionOperator;
      overload; static;
    class function IsBinaryCompatibleLikeFunction
      (const AFunc: IdxFunctionOperator): Boolean; static;
  end;
...
constructor TdxCriteriaToStringVisitResult.Create(const AResult: string;
  APriorityClass: TdxCriteriaPriorityClass);
begin
  FResult := AResult;
...
begin
  FNull := TdxCriteriaToStringVisitResult.Create(NullCriteriaResult,
    TdxCriteriaPriorityClass.Atom);
end;
...
class function TdxCriteriaToStringVisitResult.GetNull
  : TdxCriteriaToStringVisitResult;
begin
  Result := FNull;
end;
...
function TdxCriteriaToStringVisitResult.GetEnclosedResultOnGreaterOrEqual
  (ABasePriority: TdxCriteriaPriorityClass): string;
begin
...
function TdxCriteriaToStringVisitResult.GetEnclosedResultOnGreater
  (ABasePriority: TdxCriteriaPriorityClass): string;
begin
  if Priority > ABasePriority then
    Result := GetEnclosedResult
...
function TdxCriteriaToStringBase.ProcessToCommaDelimitedList(const AOperands
  : IEnumerable<IdxCriteriaOperator>): string;
var
...
function TdxCriteriaToStringBase.Visit(const AOperand: IdxBetweenOperator)
  : TdxCriteriaToStringVisitResult;
var
...
begin
  ...
  try
    AResult.Append(AVisitResult.GetEnclosedResultOnGreaterOrEqual
      (TdxCriteriaPriorityClass.InBetween));
    AResult.Append(' ').Append(GetBetweenText).Append('(');
    AOperands := TdxCriteriaOperatorCollection.Create;
    TdxCriteriaOperatorCollection(AOperands)
      .AddRange([AOperand.BeginExpression, AOperand.EndExpression]);
...
function TdxCriteriaToStringBase.Visit(const AOperand: IdxBinaryOperator)
  : TdxCriteriaToStringVisitResult;
var
...
begin
  ...
  case AOperand.OperatorType of
    TdxBinaryOperatorType.Divide, TdxBinaryOperatorType.Multiply,
      TdxBinaryOperatorType.Modulo:
      APriority := TdxCriteriaPriorityClass.Mul;
    TdxBinaryOperatorType.Plus, TdxBinaryOperatorType.Minus:
    ...
    TdxBinaryOperatorType.Greater, TdxBinaryOperatorType.GreaterOrEqual,
      TdxBinaryOperatorType.Less, TdxBinaryOperatorType.LessOrEqual:
      APriority := TdxCriteriaPriorityClass.CmpGt;
    TdxBinaryOperatorType.Equal, TdxBinaryOperatorType.NotEqual:
  ...
  AResult := Format('%s %s %s',
    [ALeftVisitResult.GetEnclosedResultOnGreater(APriority), AOperatorString,
...
function TdxCriteriaToStringBase.CreateIsNotNull(ANullOp: TdxUnaryOperator)
  : TdxCriteriaToStringVisitResult;
var
...
begin
  ...
  AResult := AInnerResult.GetEnclosedResultOnGreaterOrEqual
    (TdxCriteriaPriorityClass.IsNull) + ' ' + GetIsNotNullText;
  Result := TdxCriteriaToStringVisitResult.Create(AResult,
    TdxCriteriaPriorityClass.IsNull);
end;
...
function TdxCriteriaToStringBase.CreateNotLike(const ALikeOp: IdxBinaryOperator)
  : TdxCriteriaToStringVisitResult;
var
...
begin
  ...
  AResult := ALeftResult.GetEnclosedResultOnGreaterOrEqual
    (TdxCriteriaPriorityClass.CmpEq) + ' ' + GetNotLikeText + ' ' +
    ARightResult.GetEnclosedResultOnGreaterOrEqual
    (TdxCriteriaPriorityClass.CmpEq);
  Result := TdxCriteriaToStringVisitResult.Create(AResult,
    TdxCriteriaPriorityClass.CmpEq);
end;

function TdxCriteriaToStringBase.Visit(const AOperand: IdxUnaryOperator)
  : TdxCriteriaToStringVisitResult;
var
...
begin
  ...
  begin
    ANullOp := Safe<TdxUnaryOperator>.Cast
      (AOperand.Operand as TdxCriteriaOperator);
    if (ANullOp <> nil) and (ANullOp.OperatorType = TdxUnaryOperatorType.IsNull)
    then
      Exit(CreateIsNotNull(ANullOp));

    AFnLikeOp := Safe<TdxFunctionOperator>.Cast
      (AOperand.Operand as TdxCriteriaOperator);
    if TdxLikeCustomFunction.IsBinaryCompatibleLikeFunction(AFnLikeOp) then
    begin
      AOperator := TdxUnaryOperator.Create(TdxUnaryOperatorType.Not,
        TdxLikeCustomFunction.Convert(AFnLikeOp));
      try
  ...
  case AOperand.OperatorType of
    ...
    TdxUnaryOperatorType.Minus, TdxUnaryOperatorType.Plus:
...
function TdxCriteriaToStringBase.Visit(const AOperand: IdxInOperator)
  : TdxCriteriaToStringVisitResult;
var
...
begin
  ...
  AStrRes := AResult.GetEnclosedResultOnGreaterOrEqual
    (TdxCriteriaPriorityClass.InBetween) + ' ' + GetInText + ' (' +
    ProcessToCommaDelimitedList(AOperand.Operands) + ')';
  Result := TdxCriteriaToStringVisitResult.Create(AStrRes,
    TdxCriteriaPriorityClass.InBetween);
end;

function TdxCriteriaToStringBase.Visit(const AOperand: IdxGroupOperator)
  : TdxCriteriaToStringVisitResult;
var
  ADelimiter: string;
...
begin
  ...
  AResult := TStringBuilder.Create(ACurrentResult.GetEnclosedResultOnGreater
    (ABasePriority));
  try
...
function TdxCriteriaToStringBase.GetFunctionText(AOperandType
  : TdxFunctionOperatorType): string;
begin
  Result := GetEnumName(TypeInfo(TdxFunctionOperatorType), Ord(AOperandType));
end;

function TdxCriteriaToStringBase.Visit(const AOperand: IdxFunctionOperator)
  : TdxCriteriaToStringVisitResult;
var
...
begin
  ...
  begin
    ...
    AFunctionName := GetCustomFunctionText
      ((TdxOperandValue(AOperand.Operands[0])).Value.AsString);
    ...
    AResult := AResult + '(' + ProcessToCommaDelimitedList(AOperands) + ')';
    Result := TdxCriteriaToStringVisitResult.Create(AResult);
  end
  else
  begin
...
function TdxCriteriaToStringBase.GetOperatorString(AOperandType
  : TdxAggregateFunctionType): string;
begin
  Result := GetEnumName(TypeInfo(TdxAggregateFunctionType), Ord(AOperandType));
end;

function TdxCriteriaToStringBase.Visit(const AOperand: IdxAggregateOperand)
  : TdxCriteriaToStringVisitResult;
var
  AToStringProperty: IdxOperandProperty;
  AResult: TStringBuilder;
  AOperandVisitResult, AAggregatedPropertyVisitResult
    : TdxCriteriaToStringVisitResult;
begin
  ...
  try
    ...
    AResult.Append(']');
    if (AOperand.AggregateFunctionType <> TdxAggregateFunctionType.Exists) or
      (AOperand.AggregatedExpression <> nil) then
    begin
...
function TdxCriteriaToStringBase.Visit(const AOperand: IdxJoinOperand)
  : TdxCriteriaToStringVisitResult;
var
  AToStringProperty: IdxOperandProperty;
  AResult: TStringBuilder;
...
begin
  ...
  try
    ...
    begin
      AResult.Append('.')
        .Append(GetOperatorString(AOperand.AggregateFunctionType)).Append('(');
      AAggregatedPropertyVisitResult := Process(AOperand.AggregatedExpression);
      if not AAggregatedPropertyVisitResult.IsNull then
        AResult.Append(AAggregatedPropertyVisitResult.Result);
      AResult.Append(')');
...
function TdxCriteriaToStringBase.Visit(const AOperand: IdxOperandProperty)
  : TdxCriteriaToStringVisitResult;
var
  AResult: string;
begin
...
{$IFDEF DELPHIXE3}
  AResult := '[' + AResult.Replace('\', '\\').Replace(']', '\]')
...
function TdxCriteriaToStringBase.Process(const AOperand: IdxCriteriaOperator)
  : TdxCriteriaToStringVisitResult;
begin
...
function TdxCriteriaToStringBase.Visit(const AOperand: IdxQueryOperand)
  : TdxCriteriaToStringVisitResult;
var
  AColumnType, AResult: string;
begin
  if AOperand.ColumnType <> TdxDBColumnType.Unknown then
    AColumnType := ',' + GetEnumName(TypeInfo(TdxDBColumnType),
      Ord(AOperand.ColumnType))
  else
    AColumnType := '';
  AResult := AOperand.NodeAlias + '.{' + AOperand.ColumnName +
    AColumnType + '}';
  Result := TdxCriteriaToStringVisitResult.Create(AResult);
end;

function TdxCriteriaToStringBase.Visit(const AOperand
  : IdxQuerySubQueryContainer): TdxCriteriaToStringVisitResult;
var
  AResult: TStringBuilder;
begin
  AResult := TStringBuilder.Create;
  try
    AResult.Append('SubQuery(')
      .Append(GetEnumName(TypeInfo(TdxAggregateFunctionType),
      Ord(AOperand.AggregateFunctionType))).Append(',');
...
function TdxCriteriaToStringWithParametersProcessor.Visit(const AOperand
  : IdxOperandValue): TdxCriteriaToStringVisitResult;
var
...
begin
  ...
  if AParam <> nil then
    Result := TdxCriteriaToStringVisitResult.Create(NamedParameterPrefix +
...
class function TdxCriteriaToStringParameterlessProcessor.ValueToString
...
class function TdxCriteriaToStringParameterlessProcessor.ValueToString
  (const AValue: TValue; AIsLegacy: Boolean): string;
var
  ATc: TTypeKind;
    ...
    tkFloat:
      begin
        ...
        begin
          ...
          Result := '#' + FormatDateTime(ADateTimeFormatPattern,
            ADateTimeValue) + '#';
        end
        else
        begin
          if AValue.IsSingle then
            ...
            D := AValue.AsExtended;
          Result := FixNonFixedText(FloatToStr(D, dxInvariantFormatSettings),
            AIsLegacy, AValue); // ToString('r', CultureInfo.InvariantCulture)
        end;
      end;
...
{$ELSE}
      Result := #$27 + TdxStringHelper.Replace(AValue.AsString, #$27,
        #$27#$27) + #$27;
{$ENDIF}
    tkVariant:
      begin
    ...
    else if AValue.IsType<TTimeSpan> then
{$IFDEF DELPHIXE3}
...
class function TdxCriteriaToStringParameterlessProcessor.UserTypeToString
  (const AValue: TValue; AIsLegacy: Boolean): string;
begin
  Result := AValue.ToString;
end;

class function TdxCriteriaToStringParameterlessProcessor.
  OperandValueOrParameterToString(const AVal: IdxOperandValue;
  AIsLegacy: Boolean): string;
var
...
begin
  ...
  if P <> nil then
    Exit(TdxCriteriaToStringWithParametersProcessor.NamedParameterPrefix +
      P.ParameterName);
...
class function TdxCriteriaToStringParameterlessProcessor.FixNonFixedText
  (const AToFix: string; AIsLegacy: Boolean; const AValue: TValue): string;
begin
{$IFDEF DELPHIXE3}
...
class function TdxCriteriaToStringParameterlessProcessor.GetSuffix
...
begin
  ...
  if ATypeInfo = TypeInfo(Single) then
    Result := 'f'
  else if ATypeInfo = TypeInfo(Byte) then
    Result := 'b'
...
class function TdxCriteriaToStringParameterlessProcessor.
  ValueToCriteriaToStringVisitResult(const AOperand: IdxOperandValue)
  : TdxCriteriaToStringVisitResult;
begin
  Result := TdxCriteriaToStringVisitResult.Create
    (OperandValueOrParameterToString(AOperand, False));
end;

function TdxCriteriaToStringParameterlessProcessor.Visit(const AOperand
  : IdxOperandValue): TdxCriteriaToStringVisitResult;
begin
...
class function TdxCriteriaToBasicStyleParameterlessProcessor.
  GetBasicOperatorString(AOperatorType: TdxBinaryOperatorType): string;
begin
...
class function TdxCriteriaToBasicStyleParameterlessProcessor.
  GetBasicOperatorString(AOperatorType: TdxUnaryOperatorType): string;
begin
  case AOperatorType of
    TdxUnaryOperatorType.BitwiseNot:
      Exit('~');
...
class function TdxCriteriaToBasicStyleParameterlessProcessor.
  GetBasicOperatorString(AOperatorType: TdxGroupOperatorType): string;
begin
...
function TdxCriteriaToBasicStyleParameterlessProcessor.GetOperatorString
  (AOperatorType: TdxUnaryOperatorType): string;
begin
  Result := GetBasicOperatorString(AOperatorType);
end;

function TdxCriteriaToBasicStyleParameterlessProcessor.GetOperatorString
  (AOperatorType: TdxBinaryOperatorType): string;
begin
  Result := GetBasicOperatorString(AOperatorType);
end;

function TdxCriteriaToBasicStyleParameterlessProcessor.GetOperatorString
  (AOperatorType: TdxGroupOperatorType): string;
begin
  Result := GetBasicOperatorString(AOperatorType);
end;

class function TdxCriteriaToBasicStyleParameterlessProcessor.ToString
  (const AOperand: IdxCriteriaOperator): string;
begin
  if AOperand = nil then
    Result := ''
  else
...
class function TdxCriteriaOperator.Parse(const AStringCriteria: string;
...
class function TdxCriteriaOperator.ObjectToCriteriaSafe(AObject: TObject)
  : TdxCriteriaOperator;
begin
...
class function TdxCriteriaOperator.Parse(const ACriteria: string;
  const AParameters: array of TValue): IdxCriteriaOperator;
var
...
begin
  ...
  begin
    for I := 0 to Min(Length(AParameters),
      Length(ACriteriaParametersList)) - 1 do
...
class function TdxCriteriaOperator.ParseList(const ACriteriaList: string;
  ...
  : TArray<IdxCriteriaOperator>;
begin
  Result := TdxCriteriaParser.ParseList(ACriteriaList,
    ACriteriaParametersList, False);
end;
...
begin
  Result := ParseList(ACriteriaList, ACriteriaParametersList);
  if (Length(AParameters) <> 0) and (ACriteriaParametersList <> nil) then
    for I := 0 to Math.Min(Length(AParameters),
      Length(ACriteriaParametersList)) - 1 do
      ACriteriaParametersList[I].Value := AParameters[I];
end;

class function TdxCriteriaOperator.ToBasicStyleString
  (ACriteria: TdxCriteriaOperator): string;
begin
  Result := TdxCriteriaToBasicStyleParameterlessProcessor.ToString(ACriteria);
end;

class function TdxCriteriaOperator.ToString(const ACriteria
  : IdxCriteriaOperator): string;
begin
...
class function TdxCriteriaOperator.&Or(const ALeftOperator, ARightOperator
  : IdxCriteriaOperator): IdxCriteriaOperator;
begin
  Result := TdxGroupOperator.Combine(TdxGroupOperatorType.Or, ALeftOperator,
    ARightOperator) as TdxCriteriaOperator;
end;

class function TdxCriteriaOperator.&And(const ALeftOperator, ARightOperator
  : IdxCriteriaOperator): IdxCriteriaOperator;
begin
  Result := TdxGroupOperator.Combine(TdxGroupOperatorType.And, ALeftOperator,
    ARightOperator);
end;

class function TdxCriteriaOperator.&And(const AOperands
  : TArray<IdxCriteriaOperator>): IdxCriteriaOperator;
begin
  Result := TdxGroupOperator.Combine(TdxGroupOperatorType.And, AOperands);
end;

class function TdxCriteriaOperator.&And(AOperands: TdxCriteriaOperatorList)
  : IdxCriteriaOperator;
begin
  Result := TdxGroupOperator.Combine(TdxGroupOperatorType.And, AOperands);
end;

class function TdxCriteriaOperator.&Or(AOperands: TdxCriteriaOperatorList)
  : IdxCriteriaOperator;
begin
...
class function TdxCriteriaOperator.CriterionEquals(const ALeftOperator,
  ARightOperator: IdxCriteriaOperator): Boolean;
begin
  if ALeftOperator = ARightOperator then
    Exit(True);
  if ALeftOperator = nil then
    Exit(False);
  Result := TdxCriteriaOperator(ALeftOperator)
    .Equals(TdxCriteriaOperator(ARightOperator));
end;
...
class function TdxCriteriaOperator.Equals(const ACriteriaA,
  ACriteriaB: IdxCriteriaOperator): Boolean;
begin
  if (ACriteriaA = nil) and (ACriteriaB = nil) then
    Exit(True);
  if (ACriteriaA = nil) or (ACriteriaB = nil) then
    Exit(False);
  Result := (ACriteriaA as TdxCriteriaOperator)
    .Equals(ACriteriaB as TdxCriteriaOperator);
end;

{ TdxCriteriaOperatorCollection.TEnumerator }

constructor TdxCriteriaOperatorCollection.TEnumerator.Create
  (ACriteriaOperatorCollection: TdxCriteriaOperatorCollection);
begin
  inherited Create;
...
function TdxCriteriaOperatorCollection.TEnumerator.GetCurrentGeneric
  : IdxCriteriaOperator;
begin
  if FIndex >= 0 then
  ...
  try
    ...
    begin
      if AResult.Length > 0 then
        AResult.Append(', ');
      AResult.Append(TdxCriteriaOperator.ToString
        (AOperator as TdxCriteriaOperator));
    end;
...
constructor TdxCriteriaOperatorCollection.Create(const AOperands
  : array of IdxCriteriaOperator);
begin
...
function TdxCriteriaOperatorCollection.Add(const AValue
  : IdxCriteriaOperator): Integer;
begin
  Result := FList.Add(AValue);
end;

procedure TdxCriteriaOperatorCollection.AddRange(const AOperands
  : TArray<IdxCriteriaOperator>);
begin
...
procedure TdxCriteriaOperatorCollection.AddRange
  (AOperands: TEnumerable<IdxCriteriaOperator>);
begin
  FList.AddRange(AOperands);
end;

procedure TdxCriteriaOperatorCollection.AddRange(const AOperands
  : IEnumerable<IdxCriteriaOperator>);
begin
  FList.AddRange(AOperands);
end;

function TdxCriteriaOperatorCollection.Contains(const AValue
  : IdxCriteriaOperator): Boolean;
begin
...
begin
  ...
  for I := 0 to Count - 1 do
    if not TdxCriteriaOperator.Equals(Self[I] as TdxCriteriaOperator,
      AAnother[I] as TdxCriteriaOperator) then
      Exit(False);
  Result := True;
end;
...
function TdxCriteriaOperatorCollection.GetEnumeratorGeneric
  : IEnumerator<IdxCriteriaOperator>;
begin
...
function TdxCriteriaOperatorCollection.GetItems(AIndex: Integer)
  : IdxCriteriaOperator;
begin
  Result := FList.Items[AIndex];
end;

function TdxCriteriaOperatorCollection.IndexOf(const AItem
  : IdxCriteriaOperator): Integer;
begin
  Result := FList.IndexOf(AItem);
end;

procedure TdxCriteriaOperatorCollection.Insert(AIndex: Integer;
  const AItem: IdxCriteriaOperator);
begin
  FList.Insert(AIndex, AItem);
end;

procedure TdxCriteriaOperatorCollection.Remove(const AValue
  : IdxCriteriaOperator);
begin
  FList.Remove(AValue)
end;

procedure TdxCriteriaOperatorCollection.SetItems(AIndex: Integer;
  const Value: IdxCriteriaOperator);
begin
  FList[AIndex] := Value;
end;
...
begin
  if (Obj = nil) or (ClassType <> Obj.ClassType) then
    Exit(False);
  if (Value.Kind = AOperandValue.Value.Kind) or
    (Value.IsString and AOperandValue.Value.IsString) then
  begin
    if (Value.Kind = tkFloat) and
      (Value.IsDateTime xor AOperandValue.Value.IsDateTime) then
      Result := False
    else
...
function TdxOperandValue.Accept(const AVisitor: IdxCriteriaOperatorVisitor)
  : IdxCriteriaOperator;
begin
  Result := AVisitor.Visit(Self);
end;
...
function TdxOperandValue.Accept(const AVisitor
  : IdxClientCriteriaToStringVisitor): TdxCriteriaToStringVisitResult;
begin
  Result := AVisitor.Visit(Self);
end;

function TdxOperandValue.Accept(const AVisitor: IdxCriteriaVisitorListString)
  : TList<string>;
begin
  Result := AVisitor.Visit(Self);
end;
...
function TdxOperandValue.Accept(const AVisitor
  : IdxClientCriteriaVisitor<TdxBooleanCriteriaState>): TdxBooleanCriteriaState;
begin
  Result := AVisitor.Visit(Self);
end;
...
begin
  Result := inherited Equals(Obj) and
    (ParameterName = (TdxOperandParameter(Obj)).ParameterName);
end;
...
function TdxOperandProperty.Accept(const AVisitor: IdxCriteriaOperatorVisitor)
  : IdxCriteriaOperator;
begin
  Result := AVisitor.Visit(Self);
end;

function TdxOperandProperty.Accept(const AVisitor
  : IdxClientCriteriaToStringVisitor): TdxCriteriaToStringVisitResult;
begin
  Result := AVisitor.Visit(Self);
end;
...
constructor TdxBinaryOperator.Create(const APropertyName: string;
  AValue: Double; AType: TdxBinaryOperatorType);
begin
  Create(APropertyName, TValue.From<Double>(AValue), AType);
end;

constructor TdxBinaryOperator.Create(const APropertyName: string;
  AValue: Integer; AType: TdxBinaryOperatorType);
begin
  Create(APropertyName, TValue.From<Integer>(AValue), AType);
end;

constructor TdxBinaryOperator.Create(const APropertyName, AValue: string;
  AType: TdxBinaryOperatorType);
begin
  Create(APropertyName, TValue.From<string>(AValue), AType);
end;

constructor TdxBinaryOperator.Create(const ALeftOperator, ARightOperator
  : IdxCriteriaOperator; AType: TdxBinaryOperatorType);
begin
  inherited Create;
...
constructor TdxBinaryOperator.Create(const APropertyName: string;
  const AValue: TValue; AType: TdxBinaryOperatorType);
begin
  Create(TdxOperandProperty.Create(APropertyName),
    TdxOperandValue.Create(AValue), AType);
end;
...
function TdxBinaryOperator.Accept(const AVisitor: IdxCriteriaOperatorVisitor)
  : IdxCriteriaOperator;
begin
  Result := AVisitor.Visit(Self);
end;

function TdxBinaryOperator.Accept(const AVisitor
...
function TdxBinaryOperator.Accept(const AVisitor: IdxCriteriaVisitorListString)
  : TList<string>;
begin
  Result := AVisitor.Visit(Self);
end;
...
begin
  ...
  Result := (OperatorType = TdxBinaryOperator(Obj).OperatorType) and
    (LeftOperand as TdxCriteriaOperator)
    .Equals(TdxBinaryOperator(Obj).LeftOperand as TdxCriteriaOperator) and
    (RightOperand as TdxCriteriaOperator)
    .Equals(TdxBinaryOperator(Obj).RightOperand as TdxCriteriaOperator);
end;
...
constructor TdxUnaryOperator.Create(AOperatorType: TdxUnaryOperatorType;
  const AOperand: IdxCriteriaOperator);
begin
  inherited Create;
  FOperand := AOperand;
...
begin
  ...
  if ClassInfo <> Obj.ClassInfo then
    Exit(False);
  Result := (OperatorType = TdxUnaryOperator(Obj).OperatorType) and
    (Operand as TdxCriteriaOperator)
    .Equals(TdxUnaryOperator(Obj).Operand as TdxCriteriaOperator);
end;
...
function TdxUnaryOperator.Accept(const AVisitor: IdxCriteriaOperatorVisitor)
  : IdxCriteriaOperator;
begin
  Result := AVisitor.Visit(Self);
end;

function TdxUnaryOperator.Accept(const AVisitor
  : IdxSQLGeneratorVisitor): string;
begin
  Result := AVisitor.Visit(Self);
end;
...
function TdxUnaryOperator.Accept(const AVisitor: IdxCriteriaVisitorListString)
  : TList<string>;
begin
  Result := AVisitor.Visit(Self);
end;
...
constructor TdxBetweenOperator.Create(const ATestExpression, ABeginExpression,
...
constructor TdxBetweenOperator.Create(const ATestPropertyName: string;
  const ABeginExpression, AEndExpression: IdxCriteriaOperator);
begin
  Create(TdxOperandProperty.Create(ATestPropertyName), ABeginExpression,
    AEndExpression);
end;

constructor TdxBetweenOperator.Create(const ATestPropertyName: string;
  const ABeginValue, AEndValue: TValue);
begin
...
function TdxBetweenOperator.Accept(const AVisitor: IdxCriteriaOperatorVisitor)
  : IdxCriteriaOperator;
begin
  Result := AVisitor.Visit(Self);
end;

function TdxBetweenOperator.Accept(const AVisitor
  : IdxSQLGeneratorVisitor): string;
begin
  Result := AVisitor.Visit(Self);
end;
...
function TdxBetweenOperator.Accept(const AVisitor: IdxCriteriaVisitorListString)
  : TList<string>;
begin
  Result := AVisitor.Visit(Self);
end;
...
begin
  ...
  if ClassType <> Obj.ClassType then
    Exit(False);
  Result := (TestExpression as TdxCriteriaOperator)
    .Equals(TdxBetweenOperator(Obj).TestExpression as TdxCriteriaOperator) and
    (BeginExpression as TdxCriteriaOperator)
    .Equals(TdxBetweenOperator(Obj).BeginExpression as TdxCriteriaOperator) and
    (EndExpression as TdxCriteriaOperator)
    .Equals(TdxBetweenOperator(Obj).EndExpression as TdxCriteriaOperator);
end;
...
constructor TdxInOperator.Create(const ALeftOperand: IdxCriteriaOperator;
  const AOperands: TArray<IdxCriteriaOperator>);
begin
  Create(ALeftOperand);
...
class function TdxInOperator.Create<T>(const APropertyName: string;
  const AOperands: array of T): TdxInOperator;
var
  I: Integer;
begin
...
constructor TdxInOperator.Create(const APropertyName: string;
  const AOperands: array of const);
begin
...
constructor TdxInOperator.Create(const APropertyName: string;
  const AOperands: TArray<TObject>);
begin
  Create(TdxOperandProperty.Create(APropertyName));
  TdxCriteriaOperatorCollection(FOperands)
    .AddRange(ObjectsToCriteriaSafe(AOperands));
end;

function TdxInOperator.Accept(const AVisitor: IdxCriteriaOperatorVisitor)
  : IdxCriteriaOperator;
begin
  Result := AVisitor.Visit(Self);
end;
...
function TdxInOperator.Accept(const AVisitor: IdxClientCriteriaToStringVisitor)
  : TdxCriteriaToStringVisitResult;
begin
  Result := AVisitor.Visit(Self);
end;

function TdxInOperator.Accept(const AVisitor: IdxCriteriaVisitorListString)
  : TList<string>;
begin
  Result := AVisitor.Visit(Self);
end;

function TdxInOperator.Accept(const AVisitor
  : IdxClientCriteriaVisitor<TdxBooleanCriteriaState>): TdxBooleanCriteriaState;
begin
  Result := AVisitor.Visit(Self);
end;
...
class function TdxInOperator.ObjectsToCriteriaSafe(const AOperands
  : TArray<TObject>): TArray<IdxCriteriaOperator>;
var
  I: Integer;
begin
...
begin
  ...
  if Operands.Count <> ARightOperands.Count then
    Exit(False);
  if not(LeftOperand as TdxCriteriaOperator)
    .Equals(TdxInOperator(Obj).LeftOperand as TdxCriteriaOperator) then
    Exit(False);
  for I := 0 to ALeftOperands.Count - 1 do
    if not(ALeftOperands[I] as TdxCriteriaOperator)
      .Equals(ARightOperands[I] as TdxCriteriaOperator) then
      Exit(False);
  Result := True;
end;
...
constructor TdxAggregateOperand.Create(const ACollectionProperty: string;
  AAggregateFunctionType: TdxAggregateFunctionType);
begin
...
constructor TdxAggregateOperand.Create(const ACollectionProperty: string;
  ...
  AAggregateFunctionType: TdxAggregateFunctionType);
begin
  Create(ACollectionProperty, AAggregatedExpression,
    AAggregateFunctionType, nil);
end;
...
begin
  Create(GetPropertyByName(ACollectionProperty), nil, AAggregateFunctionType,
    ACondition);
end;
...
constructor TdxAggregateOperand.Create(const ACollectionProperty: string;
  ...
  const ACondition: IdxCriteriaOperator);
begin
  Create(GetPropertyByName(ACollectionProperty),
    GetPropertyByName(AAggregatedExpression), AAggregateFunctionType,
    ACondition);
end;

constructor TdxAggregateOperand.Create(const ACollectionProperty
  : IdxOperandProperty; const AAggregatedExpression: IdxCriteriaOperator;
  AAggregateFunctionType: TdxAggregateFunctionType;
  const ACondition: IdxCriteriaOperator);
begin
  inherited Create;
...
class function TdxAggregateOperand.GetPropertyByName(const APropertyName
  : string): IdxOperandProperty;
begin
...
begin
  ...
  if AAnother = nil then
    ...
    Result := (AggregateFunctionType = AAnother.AggregateFunctionType) and
      Equals(Condition, AAnother.Condition) and
      Equals(CollectionProperty, AAnother.CollectionProperty) and
      Equals(AggregatedExpression, AAnother.AggregatedExpression);
end;
...
function TdxAggregateOperand.Exists(const AAggregatedExpression
  : IdxCriteriaOperator): IdxAggregateOperand;
begin
  Result := TdxAggregateOperand.Create(CollectionProperty,
    AAggregatedExpression, TdxAggregateFunctionType.Exists, Condition);
end;

function TdxAggregateOperand.Count(const AAggregatedExpression
  : IdxCriteriaOperator): IdxAggregateOperand;
begin
  Result := TdxAggregateOperand.Create(CollectionProperty,
    AAggregatedExpression, TdxAggregateFunctionType.Count, Condition);
end;

function TdxAggregateOperand.Accept(const AVisitor: IdxCriteriaOperatorVisitor)
  : IdxCriteriaOperator;
begin
  Result := AVisitor.Visit(Self)
end;
...
function TdxAggregateOperand.Accept(const AVisitor
  : IdxClientCriteriaToStringVisitor): TdxCriteriaToStringVisitResult;
begin
  Result := AVisitor.Visit(Self)
end;
...
function TdxAggregateOperand.Avg(const AAggregatedExpression
  : IdxCriteriaOperator): IdxAggregateOperand;
begin
  Result := TdxAggregateOperand.Create(CollectionProperty,
    AAggregatedExpression, TdxAggregateFunctionType.Avg, Condition);
end;

function TdxAggregateOperand.Max(const AAggregatedExpression
  : IdxCriteriaOperator): IdxAggregateOperand;
begin
  Result := TdxAggregateOperand.Create(CollectionProperty,
    AAggregatedExpression, TdxAggregateFunctionType.Max, Condition);
end;

function TdxAggregateOperand.Min(const AAggregatedExpression
  : IdxCriteriaOperator): IdxAggregateOperand;
begin
  Result := TdxAggregateOperand.Create(CollectionProperty,
    AAggregatedExpression, TdxAggregateFunctionType.Min, Condition);
end;

function TdxAggregateOperand.Sum(const AAggregatedExpression
  : IdxCriteriaOperator): IdxAggregateOperand;
begin
  Result := TdxAggregateOperand.Create(CollectionProperty,
    AAggregatedExpression, TdxAggregateFunctionType.Sum, Condition);
end;

function TdxAggregateOperand.Single(const AAggregatedExpression
  : IdxCriteriaOperator): IdxAggregateOperand;
begin
  Result := TdxAggregateOperand.Create(CollectionProperty,
    AAggregatedExpression, TdxAggregateFunctionType.Single, Condition);
end;

{ TdxContainsOperator }

constructor TdxContainsOperator.Create(const ACollectionProperty: string;
  const ACondition: IdxCriteriaOperator);
begin
...
constructor TdxContainsOperator.Create(const ACollectionProperty
  : IdxOperandProperty; const ACondition: IdxCriteriaOperator);
begin
  inherited Create(ACollectionProperty, nil, TdxAggregateFunctionType.Exists,
    ACondition);
end;

{ TdxJoinOperand }

constructor TdxJoinOperand.Create(const AJoinTypeName: string;
  const ACondition: IdxCriteriaOperator);
begin
...
constructor TdxJoinOperand.Create(AJoinType: TClass;
  const ACondition: IdxCriteriaOperator);
begin
...
begin
  Assert(AJoinType <> nil);
  Create(dxGetQualifiedClassName(AJoinType), ACondition, AType,
...
begin
  ...
  if AAnother = nil then
    Exit(False);
  Result := (Condition as TdxCriteriaOperator)
    .Equals(AAnother.Condition as TdxCriteriaOperator) and
    (JoinTypeName = AAnother.JoinTypeName) and
    (AggregatedExpression as TdxCriteriaOperator)
    .Equals(AAnother.AggregatedExpression as TdxCriteriaOperator) and
...
function TdxJoinOperand.Count(const AAggregatedExpression: IdxCriteriaOperator)
  : IdxJoinOperand;
begin
  Result := TdxJoinOperand.Create(JoinTypeName, Condition,
    TdxAggregateFunctionType.Count, AAggregatedExpression);
end;

function TdxJoinOperand.Accept(const AVisitor: IdxCriteriaOperatorVisitor)
  : IdxCriteriaOperator;
begin
  Result := AVisitor.Visit(Self);
end;
...
function TdxJoinOperand.Accept(const AVisitor: IdxClientCriteriaToStringVisitor)
  : TdxCriteriaToStringVisitResult;
begin
  Result := AVisitor.Visit(Self);
end;

function TdxJoinOperand.Accept(const AVisitor
  : IdxClientCriteriaVisitor<TdxBooleanCriteriaState>): TdxBooleanCriteriaState;
begin
  Result := AVisitor.Visit(Self);
end;

function TdxJoinOperand.Avg(const AAggregatedExpression: IdxCriteriaOperator)
  : IdxJoinOperand;
begin
  Result := TdxJoinOperand.Create(JoinTypeName, Condition,
    TdxAggregateFunctionType.Avg, AAggregatedExpression);
end;

function TdxJoinOperand.Max(const AAggregatedExpression: IdxCriteriaOperator)
  : IdxJoinOperand;
begin
  Result := TdxJoinOperand.Create(JoinTypeName, Condition,
    TdxAggregateFunctionType.Max, AAggregatedExpression);
end;

function TdxJoinOperand.Min(const AAggregatedExpression: IdxCriteriaOperator)
  : IdxJoinOperand;
begin
  Result := TdxJoinOperand.Create(JoinTypeName, Condition,
    TdxAggregateFunctionType.Min, AAggregatedExpression);
end;

function TdxJoinOperand.Sum(const AAggregatedExpression: IdxCriteriaOperator)
  : IdxJoinOperand;
begin
  Result := TdxJoinOperand.Create(JoinTypeName, Condition,
    TdxAggregateFunctionType.Sum, AAggregatedExpression);
end;

{ TdxGroupOperator }

constructor TdxGroupOperator.Create
  (AType: TdxGroupOperatorType = TdxGroupOperatorType.&And);
begin
  inherited Create;
  FOperands := TdxCriteriaOperatorCollection.Create;
  FOperatorType := AType;
...
constructor TdxGroupOperator.Create(const AOperands
  : TArray<IdxCriteriaOperator>);
begin
...
constructor TdxGroupOperator.Create(AType: TdxGroupOperatorType;
  const AOperands: array of IdxCriteriaOperator);
begin
  Create(AType);
  TdxCriteriaOperatorCollection(FOperands).AddRange(AOperands);
...
constructor TdxGroupOperator.Create(AType: TdxGroupOperatorType;
  const AOperands: TEnumerable<IdxCriteriaOperator>);
begin
  Create(AType);
  TdxCriteriaOperatorCollection(FOperands).AddRange(AOperands);
end;
...
begin
  ...
  for I := 0 to Operands.Count - 1 do
    if not(Operands[I] as TdxCriteriaOperator)
      .Equals(TdxGroupOperator(Obj).Operands[I] as TdxCriteriaOperator) then
      Exit(False);
  Result := True;
end;
...
function TdxGroupOperator.Accept(const AVisitor: IdxCriteriaOperatorVisitor)
  : IdxCriteriaOperator;
begin
  Result := AVisitor.Visit(Self);
end;

function TdxGroupOperator.Accept(const AVisitor
  : IdxSQLGeneratorVisitor): string;
begin
  Result := AVisitor.Visit(Self);
end;
  ...
  try
    ...
    begin
      if AOperator = nil then
        Continue;
      AGroupOperator := Safe<TdxGroupOperator>.Cast
        (AOperator as TdxCriteriaOperator);
      if (AGroupOperator = nil) or (AGroupOperator.OperatorType <> AOperatorType)
      then
      begin
...
function TdxFunctionOperator.Accept(const AVisitor
  : IdxClientCriteriaToStringVisitor): TdxCriteriaToStringVisitResult;
begin
  Result := AVisitor.Visit(Self);
end;
...
function TdxFunctionOperator.Accept(const AVisitor
  : IdxCriteriaVisitorListString): TList<string>;
begin
  Result := AVisitor.Visit(Self);
end;
...
function TdxFunctionOperator.Accept(const AVisitor: IdxCriteriaOperatorVisitor)
  : IdxCriteriaOperator;
begin
  Result := AVisitor.Visit(Self);
end;
...
begin
  ...
  for I := 0 to Operands.Count - 1 do
    if not(Operands[I] as TdxCriteriaOperator)
      .Equals(TdxFunctionOperator(Obj).Operands[I] as TdxCriteriaOperator) then
      Exit(False);
  Result := True;
end;
...
class function TdxFunctionOperator.GuessIsLogicalCustomFunction(const AOperator
  : IdxFunctionOperator): Boolean;
begin
  Result := False;
end;
...
constructor TdxSortByExpression.Create(const APropertyName: string;
  ASortDirection: TdxSortDirection);
begin
  Create(TdxCriteriaOperator.Parse(APropertyName), ASortDirection);
end;

constructor TdxSortByExpression.Create(const AProperty: IdxCriteriaOperator;
  ASortDirection: TdxSortDirection);
begin
  inherited Create;
  FProperty := AProperty;
...
begin
  ...
  if ASortByExpression = nil then
    Exit(False);
  Result := TdxCriteriaOperator.CriterionEquals(FProperty,
    ASortByExpression.FProperty) and
...
begin
  Result := PropertyName +
    IfThen(FSortDirection = TdxSortDirection.Descending, ' DESC');
end;

{ TdxSortByExpressions.TEnumerator }

constructor TdxSortByExpressions.TEnumerator.Create(ASortByExpressions
  : TdxSortByExpressions);
begin
  inherited Create;
...
function TdxSortByExpressions.TEnumerator.GetCurrentGeneric
  : IdxSortByExpression;
begin
  if FIndex >= 0 then
...
constructor TdxSortByExpressions.Create(const ASortProperties
  : TArray<IdxSortByExpression>);
begin
  Create;
...
function TdxSortByExpressions.Add(const APropertyName: string;
  ASortDirection: TdxSortDirection): Integer;
begin
  Result := Add(TdxSortByExpression.Create(APropertyName, ASortDirection));
end;

function TdxSortByExpressions.Add(const AProperty: IdxCriteriaOperator;
  ASortDirection: TdxSortDirection): Integer;
begin
  Result := Add(TdxSortByExpression.Create(AProperty, ASortDirection));
end;

procedure TdxSortByExpressions.AddRange(const ASortProperties
  : TArray<IdxSortByExpression>);
var
...
begin
  ...
  if Count <> AAnother.Count then
    Exit(False);
  for I := 0 to Count - 1 do
    if not(Self[I] as TdxSortByExpression)
      .Equals(AAnother[I] as TdxSortByExpression) then
      Exit(False);
  Result := True;
end;
...
function TdxSortByExpressions.Contains(const AValue
  : IdxSortByExpression): Boolean;
begin
  Result := FList.Contains(AValue);
end;

function TdxSortByExpressions.IndexOf(const AValue
  : IdxSortByExpression): Integer;
begin
  Result := FList.IndexOf(AValue);
end;

procedure TdxSortByExpressions.Insert(AIndex: Integer;
  const AValue: IdxSortByExpression);
begin
...
function TdxSortByExpressions.GetEnumeratorGeneric
  : IEnumerator<IdxSortByExpression>;
begin
  Result := TEnumerator.Create(Self);
end;
...
class function TdxLikeCustomFunction.Create(const AValue,
  APattern: IdxCriteriaOperator): TdxFunctionOperator;
begin
...
class function TdxLikeCustomFunction.Convert(const ALike: IdxFunctionOperator)
  : IdxBinaryOperator;
begin
...
class function TdxLikeCustomFunction.Convert(const ALike: IdxBinaryOperator)
  : IdxFunctionOperator;
begin
...
class function TdxLikeCustomFunction.IsBinaryCompatibleLikeFunction
  (const AFunc: IdxFunctionOperator): Boolean;
var
...
begin
  ...
  if AFunc.Operands.Count <> 3 then
    Exit(False);
  AFunctionOperand := Safe<TdxOperandValue>.Cast
    (AFunc.Operands[0] as TdxCriteriaOperator);
...
constructor TdxQueryOperand.Create(const AColumnName: string;
  const ANodeAlias: string; AColumnType: TdxDBColumnType;
...
begin
  ...
  if AAnother = nil then
    Exit(False);
  Result := (ColumnName = AAnother.ColumnName) and
    (NodeAlias = AAnother.NodeAlias);
end;
...
function TdxQueryOperand.Accept(const AVisitor: IdxCriteriaOperatorVisitor)
  : IdxCriteriaOperator;
var
...
function TdxQueryOperand.Accept(const AVisitor
  : IdxClientCriteriaToStringVisitor): TdxCriteriaToStringVisitResult;
begin
  Result := (AVisitor as IQueryCriteriaToStringCriteriaVisitor).Visit(Self);
end;

function TdxQueryOperand.Accept(const AVisitor: IdxCriteriaVisitorListString)
  : TList<string>;
begin
...
function TdxObjectGeneratorCriteriaSet.TryGetCriteria(const ATableName: string;
  out ACriteria: IdxCriteriaOperator): Boolean;
begin
  Result := FCriteriaDictionary.TryGetValue(ATableName, ACriteria);
end;

function TdxObjectGeneratorCriteriaSet.GetCompleteCriteria(const ATableName
  : string): IdxCriteriaOperator;
var
...
procedure TdxObjectGeneratorCriteriaSet.UpdateCriteria(const ATableName: string;
  const ACriteria: IdxCriteriaOperator);
var
...
begin
  ...
  begin
    AGroup := Safe<TdxGroupOperator>.Cast
      (AGroupCriteria as TdxCriteriaOperator);
    if (AGroup <> nil) and (AGroup.OperatorType = TdxGroupOperatorType.And) then
      AGroup.Operands.Add(ACriteria)
    else
      FCriteriaDictionary.AddOrSetValue(ATableName, TdxGroupOperator.And
        (AGroupCriteria, ACriteria));
  end
  else
    FCriteriaDictionary.Add(ATableName, ACriteria);
end;

procedure TdxObjectGeneratorCriteriaSet.UpdateCommonCriteria(const ACriteria
  : IdxCriteriaOperator);
var
  AGroup: TdxGroupOperator;
begin
  ...
  begin
    AGroup := Safe<TdxGroupOperator>.Cast
      (FCommonCriteria as TdxCriteriaOperator);
    if (AGroup <> nil) and (AGroup.OperatorType = TdxGroupOperatorType.And) then
      AGroup.Operands.Add(ACriteria)
    else
...
class function TdxObjectGeneratorCriteriaSet.GetCommonCriteriaSet
  (const ACommonCriteria: IdxCriteriaOperator): TdxObjectGeneratorCriteriaSet;
begin
  Result := TdxObjectGeneratorCriteriaSet.Create;
  Result.UpdateCommonCriteria(ACommonCriteria);
end;

class function TdxObjectGeneratorCriteriaSet.GetCriteriaSet(const ATableName
  : string; const ACriteria: IdxCriteriaOperator)
  : TdxObjectGeneratorCriteriaSet;
begin
  Result := TdxObjectGeneratorCriteriaSet.Create;
...
class function TdxObjectGeneratorCriteriaSet.GetCriteriaSet(const ATableName
  : string; const ACriteria, ACommonCriteria: IdxCriteriaOperator)
  : TdxObjectGeneratorCriteriaSet;
begin
  Result := TdxObjectGeneratorCriteriaSet.Create;
  Result.UpdateCommonCriteria(ACommonCriteria);
...
class function TdxAcceptor.GetCriteriaType(const ACriteriaOperator
  : IdxCriteriaOperator): TCriteria;
begin
  Result := FCriteria[(ACriteriaOperator as TObject).ClassType];
end;

class function TdxAcceptor.Accept<T>(const ACriteriaOperator
  : IdxCriteriaOperator; const AVisitor: IdxCriteriaVisitor<T>): T;
begin
...
class function TdxAcceptor.Accept<T>(const ACriteriaOperator
  : IdxCriteriaOperator; const AVisitor: IdxClientCriteriaVisitor<T>): T;
begin
  case GetCriteriaType(ACriteriaOperator) of
    TCriteria.TBetweenOperator:
      Result := AVisitor.Visit(IdxBetweenOperator(ACriteriaOperator));
