...
type
  ...
  IdxMappingMemberInfo = interface
    ...
    function RegisterProperty(const APropertyName: string)
      : IdxMappingMemberInfo;

    function Aggregated: IdxMappingMemberInfo;
    function Association(const AAssociationName: string = '')
      : IdxMappingMemberInfo;
    function Blob: IdxMappingMemberInfo; overload;
    function Blob(ASerializerClass: TdxCustomBlobSerializerClass)
      : IdxMappingMemberInfo; overload;
    ...
    function Generator(AGeneratorType: TdxGeneratorType;
      const ASequenceName: string = ''): IdxMappingMemberInfo;
  ...
  IdxMappingClassInfo = interface
    ...
    function DiscriminatorColumn(const AColumnName: string)
      : IdxMappingClassInfo; overload;
    function DiscriminatorColumn(const AColumnName: string;
      ADiscriminatorType: TdxDiscriminatorType; ASize: Integer = 0)
      : IdxMappingClassInfo; overload;
    function Indexes(const AColumns: string): IdxMappingClassInfo;
    function Inheritance(AMapInheritance: TdxMapInheritanceType)
      : IdxMappingClassInfo;
  ...
  public
    ...
    ColumnName: string;
    ColumnSize: Integer;
    constructor Create(ADiscriminatorType: TdxDiscriminatorType;
      const AColumnName: string; AColumnSize: Integer = 0); overload;
  ...
  protected
    procedure Add(const AColumns: TArray<string>;
      AIsUnique: Boolean = False); overload;
  ...
  protected
    ...
    function FindAttribute(AClass: TCustomAttributeClass)
      : TCustomAttribute; override;
  ...
  public
    ...
    property DiscriminatorInfo: TdxDiscriminator read FDiscriminatorInfo
      write FDiscriminatorInfo;
    property DiscriminatorValue: Variant read FDiscriminatorValue
      write FDiscriminatorValue;
  ...
  TdxEMFAccessorSetter = reference to procedure(AObject: TObject;
    const AValue: Variant);
  TdxEMFAccessorGetter<T: class> = reference to function(AObject: T): Variant;
  TdxEMFAccessorSetter<T: class> = reference to procedure(AObject: T;
    const AValue: Variant);

  TdxMappingMemberInfo = class(TdxAttributeInfo, IdxMappingMemberInfo)
  public const
    OrdinalTypes = [tkInteger, tkChar, tkEnumeration, tkFloat, tkWChar,
      tkInt64];
  ...
  protected
    ...
    class function GetGenericIListTypeArgument(AElementType: TRttiType)
      : TRttiType; static;
  ...
  protected
    ...
    function SetLookupResultField(const AFieldNames: string)
      : IdxMappingMemberInfo;
  ...
  public
    ...
    property IsAssociationList: Boolean read FIsAssociationList
      write FIsAssociationList;
    ...
    property IsDynamicArrayType: Boolean read FIsDynamicArrayType
      write SetIsDynamicArrayType;
  ...
  public
    ...
    property DiscriminatorValue: TValue read FDiscriminatorValue
      write FDiscriminatorValue;
    property Discriminator: TdxDiscriminator read FDiscriminator
      write SetDiscriminator;
  end;
  ...
  protected
    procedure Notify(const Value: TdxServiceMember;
      Action: TCollectionNotification); override;
  public
    property DiscriminatorField: TdxDiscriminatorMember
      read FDiscriminatorField;
  end;
  ...
  public
    ...
    constructor Create(AEntityInfo: TdxEntityInfo;
      const AMembers: array of TdxMappingMemberInfo); overload;
    constructor Create(AEntityInfo: TdxEntityInfo;
      const APath: string); overload;
    constructor Create(AEntityInfo: TdxEntityInfo; const APath: string;
      AAddNonPersistent: Boolean); overload;
    constructor Create(AEntityInfo: TdxEntityInfo; const APath: string;
      AAddNonPersistent: Boolean; AThrowOnError: Boolean); overload;
    constructor Create(AEntityInfo: TdxEntityInfo;
      const AMatches: TArray<string>; AAddNonPersistent: Boolean;
      AThrowOnError: Boolean); overload;
    class function ParsePath(AEntityInfo: TdxEntityInfo; const APath: string)
      : TdxMemberInfoCollection; static;
    class function ParsePersistentPath(AEntityInfo: TdxEntityInfo;
      const APath: string): TdxMemberInfoCollection; static;
    class function FindMember(ACurrentEntityInfo: TdxEntityInfo;
      const AMatch: string): TdxMappingMemberInfo; static;
    class function SplitPath(const APath: string): TArray<string>; static;
    class function LastIndexOfSplittingDotInPath(const APath: string)
      : Integer; static;
    class function GetSplitPartCount(const APath: string): Integer; static;
    class function TryResolveType(const AClassName: string;
      ARootEntityInfo: TdxEntityInfo; out AEntityInfo: TdxEntityInfo)
      : Boolean; static;
    class function TryResolveTypeAlsoByShortName(const AClassName: string;
      ARootEntityInfo: TdxEntityInfo; out AEntityInfo: TdxEntityInfo)
      : Boolean; static;
  ...
  strict private
    ...
    function GetIsPersistent: Boolean;
  private
    function CreateMappingMemberInfo(AMember: TRttiMember)
      : TdxMappingMemberInfo;
    function GetEntityUnitName: string;
  protected
    class function GetQualifiedClassName(AClass: TClass): string; overload;
      static; inline;
  ...
  public
    ...
    function FindMemberByColumnName(const AColumnName: string)
      : TdxMappingMemberInfo;
    function TryGetValueByName(const AName: string;
      out AAttributeInfo: TdxAttributeInfo): Boolean;
    ...
    procedure InitAssociation(ASession: TComponent; AObject: TObject;
      const AQueryable: IdxQueryable; const AMemberName: string = '');
    procedure InitSession(ASession: TComponent; AObject: TObject);
    function IsAssignableTo(AEntityInfo: TdxEntityInfo): Boolean;

    property AssociationListProperties: TArray<TdxMappingMemberInfo>
      read FAssociationListProperties;
    ...
    property CollectionProperties: TArray<TdxMappingMemberInfo>
      read FAssociationListProperties;
    property Count: Integer read GetCount;
    ...
    property ObjectProperties: TArray<TdxMappingMemberInfo>
      read FObjectProperties;
    property OptimisticLockField: TdxMappingMemberInfo
      read GetOptimisticLockField;
    property OptimisticLockingBehavior: TdxOptimisticLockingBehavior
      read GetOptimisticLockingBehavior;
    property ParentEntity: TdxEntityInfo read GetParentEntity;
    property PersistentProperties: TMemberAttributes
      read GetPersistentProperties;
  ...
  protected
    ...
    procedure ProcessCreateEntityInfo(AEntityInfo: TdxEntityInfo;
      AClass: TClass);
    ...
    procedure AutoMappingAttributes(AType: TRttiType;
      AEntityInfo: TdxEntityInfo);
    procedure AppendInheritanceMembers(AEntityInfo: TdxEntityInfo);
    class function CheckAttributes(AMember: TRttiMember;
      AAttributeInfo: TdxMappingMemberInfo): Boolean; static;
    function CheckAutoMappingKeys(AMember: TRttiField;
      AMemberInfo: TdxMappingMemberInfo): Boolean;
    procedure CheckColumnAttribute(AAttribute: TCustomAttribute;
      AAttributeInfo: TdxMappingMemberInfo);
    function CheckIdentity(AMember: TRttiMember): Boolean;
    procedure CheckTableName(AType: TRttiType;
      var AAttributeInfo: TdxAttributeInfo);
    function CreateEntityInfo(AClass: TClass): TdxEntityInfo;
    class function GetMember(AClass: TClass; const AMemberName: string)
      : TRttiMember; static;
    class function SerializeMember(AAttributeInfo: TdxMappingMemberInfo)
      : Boolean; static;
    ...
    property ClassAttributes: TObjectDictionary<TClass, TdxEntityInfo>
      read FClassAttributes;
    ...
    class function GetTableName(AEntityInfo: TdxEntityInfo): string; overload;
      static; inline;
  ...
  public
    ...
    class procedure RegisterEntityClient(AEntityInfo: TdxEntityInfo;
      AClient: TObject; AEvent: TConnectChangeEvent = nil);
    class procedure UnregisterEntityClient(AEntityInfo: TdxEntityInfo;
      AClient: TObject);
    ...
    procedure RegisterEMFAccessor<T: class>(const AMemberName: string;
      AGetter: TdxEMFAccessorGetter<T>;
      ASetter: TdxEMFAccessorSetter<T>); overload;
    procedure RegisterEMFAccessor(AClass: TClass; const AMemberName: string;
      AGetter: TdxEMFAccessorGetter; ASetter: TdxEMFAccessorSetter); overload;
...
{$ENDIF}
    if (ATypeInfo = TypeInfo(IdxEMFCollection)) or
      (Pos('IdxEMFCollection', GetTypeName(ATypeInfo)) = 1) then
      Result := ATypeInfo
    else
    begin
...
begin
  Result := (FUnderlyingType.TypeKind = tkEnumeration) and
    (FUnderlyingType.Handle <> TypeInfo(Boolean));
end;
...
procedure TdxMappingNullableMemberInfo.SetValue(AObject: TObject;
  const AValue: TValue);
var
...
constructor TdxDiscriminator.Create(ADiscriminatorType: TdxDiscriminatorType;
  const AColumnName: string; AColumnSize: Integer);
begin
  HasValue := True;
  DiscriminatorType := ADiscriminatorType;
  ColumnName := AColumnName;
  if (ADiscriminatorType = TdxDiscriminatorType.String) and (AColumnSize = 0)
  then
...
begin
  Create(AAttribute.DiscriminatorType, AAttribute.DiscriminatorColumn,
    AAttribute.Size);
end;

class function TdxDiscriminator.CreateDefault: TdxDiscriminator;
begin
  Result := TdxDiscriminator.Create(TdxDiscriminatorType.Integer,
    ObjectTypePropertyName, 0);
end;
...
constructor TdxIndexes.TIndex.Create(const AColumns: TArray<string>;
  AIsUnique: Boolean);
begin
  Columns := AColumns;
  IsUnique := AIsUnique;
...
procedure TdxIndexes.Add(const AColumns: TArray<string>;
  AIsUnique: Boolean = False);
...
begin
  Result := AttributeType in [TdxAttributeType.&Property,
...
begin
  inherited Create;
  FClassAttributes := TObjectDictionary<TClass, TdxEntityInfo>.Create
    ([doOwnsValues]);
...
begin
  ...
  FEntityClients := TObjectDictionary<TdxEntityInfo, TEntityClients>.Create
    ([doOwnsValues]);
end;
...
procedure TdxEntityManager.AutoMappingAttributes(AType: TRttiType;
  AEntityInfo: TdxEntityInfo);
var
...
procedure TdxEntityManager.CheckColumnAttribute(AAttribute: TCustomAttribute;
  AAttributeInfo: TdxMappingMemberInfo);
begin
  if AAttribute is NonPersistentAttribute then
    AAttributeInfo.NonPersistent
  else if AAttribute is ColumnAttribute then
    AAttributeInfo.Column(ColumnAttribute(AAttribute).ColumnName)
  else if AAttribute is SizeAttribute then
    AAttributeInfo.Size(SizeAttribute(AAttribute).Size)
  else if AAttribute is ReadOnlyAttribute then
    AAttributeInfo.ReadOnly
  else if AAttribute is NullableAttribute then
    AAttributeInfo.Nullable
  else if AAttribute is DefaultAttribute then
    AAttributeInfo.Default(DefaultAttribute(AAttribute).Value)
  else if AAttribute is KeyAttribute then
    Include(AAttributeInfo.Attributes, TdxAttribute.Key)
  else if AAttribute is GeneratorAttribute then
    AAttributeInfo.Generator(GeneratorAttribute(AAttribute).GeneratorType,
      GeneratorAttribute(AAttribute).SequenceName)
  else if AAttribute is IndexedAttribute then
    AAttributeInfo.Indexed
  else if AAttribute is UniqueAttribute then
    AAttributeInfo.Unique
  else if AAttribute is AssociationAttribute then
    AAttributeInfo.Association(AssociationAttribute(AAttribute).AssociationName)
  else if AAttribute is NoForeignKeyAttribute then
    AAttributeInfo.NoForeignKey
  else if AAttribute is AggregatedAttribute then
    AAttributeInfo.Aggregated
  else if AAttribute is VirtualColumnAttribute then
    AAttributeInfo.VirtualColumn
  else if AAttribute is DBTypeAttribute then
    AAttributeInfo.DBType(DBTypeAttribute(AAttribute).DBColumnTypeName)
  else if AAttribute is BlobAttribute then
    AAttributeInfo.Blob(BlobAttribute(AAttribute).SerializerClass)
  else if AAttribute is LookupResultFieldAttribute then
    AAttributeInfo.SetLookupResultField(LookupResultFieldAttribute(AAttribute)
      .FieldName)
  else if AAttribute is MaxValueAttribute then
    AAttributeInfo.SetMaxValue(MaxValueAttribute(AAttribute).Value)
  else if AAttribute is MinValueAttribute then
    AAttributeInfo.SetMinValue(MinValueAttribute(AAttribute).Value)
  else if AAttribute is PrecisionAttribute then
    AAttributeInfo.SetPrecision(PrecisionAttribute(AAttribute).Value)
  else if AAttribute is DisplayFormatAttribute then
    AAttributeInfo.SetDisplayFormat(DisplayFormatAttribute(AAttribute).Value)
  else if AAttribute is DisplayLabelAttribute then
    AAttributeInfo.SetDisplayLabel(DisplayLabelAttribute(AAttribute).Value)
  else if AAttribute is DisplayWidthAttribute then
    AAttributeInfo.SetDisplayWidth(DisplayWidthAttribute(AAttribute).Value)
  else if AAttribute is EditFormatAttribute then
    AAttributeInfo.SetEditFormat(EditFormatAttribute(AAttribute).Value)
  else if AAttribute is EditMaskAttribute then
...
begin
  ...
  begin
    ...
    begin
      AMemberInfo := AEntityInfo.CreateMappingMemberInfo
        (ABaseMemberInfo.Member);
      AMemberInfo.Assign(ABaseMemberInfo);
      AEntityInfo.Add(AMemberInfo);
    end;
    AEntityInfo.ClassAttributes.KeyMemberNames.AddRange
      (ABaseEntityInfo.ClassAttributes.KeyMemberNames);
  end;
end;

procedure TdxEntityManager.BeginCreateEntityInfo(AClass: TClass;
  AEntityInfo: TdxEntityInfo);
begin
  FProcessingEntities.Add(AClass, AEntityInfo);
end;

class function TdxEntityManager.CheckAttributes(AMember: TRttiMember;
  AAttributeInfo: TdxMappingMemberInfo): Boolean;
var
...
begin
  ...
  if AAttributeInfo.TypeKind in (TdxMappingMemberInfo.OrdinalTypes +
    TdxMappingMemberInfo.StringTypes) then
    Result := True
  else if AAttributeInfo.TypeKind = tkDynArray then
  begin
  ...
  else if TdxAttribute.Association in AAttributeInfo.Attributes then
  begin
    ...
    else if AFieldType.IsInstance then
      Result := AAttributeInfo.Owner.ClassAttributes.FIsCodeRegistry or
        TdxEntityInfo.IsEntity(AFieldType)
    else
      Result := False;
    if Result then
      AAttributeInfo.UpdateReferenceType;
  end
  else if AFieldType.IsRecord then
  begin
    if (PTypeInfo(AFieldType.Handle) = TypeInfo(TGUID)) or
      (PTypeInfo(AFieldType.Handle) = TypeInfo(TBCD)) then
      Result := True
    else if IsNullableType(AFieldType.Handle) then
    begin
...
function TdxEntityManager.CheckAutoMappingKeys(AMember: TRttiField;
  AMemberInfo: TdxMappingMemberInfo): Boolean;
var
  AFieldType: TRttiType;
...
begin
  ...
  Result := SameText(AMemberInfo.ColumnName, DefaultKeyName) and
    ((AMemberInfo.TypeKind in [tkInteger, tkInt64]) or
    (IsRecord(AMemberInfo.TypeKind) and (PTypeInfo(AFieldType.Handle)
    = TypeInfo(TGUID))));
  if Result then
  begin
    ...
    for AProperty in AProperties do
      ...
      begin
        ...
        begin
          ...
          AMemberInfo.DBGenerator :=
            TdxGenerator.Create(TdxGeneratorType.IdEntity);
          AIsReadOnly := True;
        end;
      end;
    if AIsReadOnly then
...
procedure TdxEntityManager.CheckTableName(AType: TRttiType;
  var AAttributeInfo: TdxAttributeInfo);
begin
...
begin
  ...
  try
    ...
    try
      ...
      begin
        FreeAndNil(Result);
        raise EdxKeyPropertyAbsentException.CreateFmt
          (sdxMetadataKeyPropertyDoesNotExist, [AClass.ClassName]);
      end;
...
procedure TdxEntityManager.FieldsAttributes(AType: TRttiType;
  AEntityInfo: TdxEntityInfo);
var
  AAttribute: TCustomAttribute;
  AAttributes: TArray<TCustomAttribute>;
...
function TdxEntityManager.GetEntityInfo(const AClassName: string)
  : TdxEntityInfo;
var
...
begin
  ...
  for AItem in FClassAttributes do
    ...
    else if AnsiSameText(AItem.Value.ClassAttributes.PersistentClass.ClassName,
      AClassName) then
      Exit(AItem.Value);
  Result := nil;
end;
...
function TdxEntityManager.GetProcessingEntityInfo(AClass: TClass)
  : TdxEntityInfo;
begin
...
class function TdxEntityManager.GetQualifiedFieldName
...
class function TdxEntityManager.GetQualifiedTableName
  (const AName: string): string;
var
  ALength: Integer;
begin
...
class function TdxEntityManager.GetMember(AClass: TClass;
  const AMemberName: string): TRttiMember;
var
  AType: TRttiType;
begin
...
procedure TdxEntityManager.ProcessCreateEntityInfo(AEntityInfo: TdxEntityInfo;
  AClass: TClass);
var
...
begin
  ...
  begin
    ...
    else if AAttribute is AutomappingAttribute then
    begin
      Include(AAttributeInfo.Attributes, TdxAttribute.Automapping);
      AAutomapping := True;
    end
    else if AAttribute is SchemaNameAttribute then
      AAttributeInfo.TableSchemaName(SchemaNameAttribute(AAttribute).SchemaName)
    else if AAttribute is TableAttribute then
    begin
      ...
      AAttributeInfo.KeyMemberNames.AddRange(KeyAttribute(AAttribute)
        .MemberNames)
    else if AAttribute is IndexesAttribute then
      AAttributeInfo.Indexes.Add(IndexesAttribute(AAttribute).Columns)
    else if AAttribute is InheritanceAttribute then
      AAttributeInfo.Inheritance(InheritanceAttribute(AAttribute)
        .MapInheritance)
    else if AAttribute is DiscriminatorColumnAttribute then
      AAttributeInfo.DiscriminatorInfo :=
        TdxDiscriminator.Create(DiscriminatorColumnAttribute(AAttribute))
    else if AAttribute is DiscriminatorAttribute then
      AAttributeInfo.DiscriminatorValue :=
        DiscriminatorAttribute(AAttribute).Value;
  end;
...
procedure TdxEntityManager.PropertyAttributes(AType: TRttiType;
  AEntityInfo: TdxEntityInfo);
var
  AAttribute: TCustomAttribute;
  AAttributes: TArray<TCustomAttribute>;
...
class procedure TdxEntityManager.RegisterEntityClient
  (AEntityInfo: TdxEntityInfo; AClient: TObject; AEvent: TConnectChangeEvent);
var
...
begin
  FClassAttributes.Add(AEntityInfo.ClassAttributes.PersistentClass,
    AEntityInfo);
end;
...
class procedure TdxEntityManager.DisconnectEntityClients
  (AEntityInfo: TdxEntityInfo);
var
  AClients: TEntityClients;
begin
...
class function TdxEntityManager.SerializeMember(AAttributeInfo
  : TdxMappingMemberInfo): Boolean;
var
  AFieldType: TRttiType;
  AClass: TClass;
begin
...
class procedure TdxEntityManager.UnregisterEntityClient
  (AEntityInfo: TdxEntityInfo; AClient: TObject);
var
  AClients: TEntityClients;
begin
  if FEntityClients.TryGetValue(AEntityInfo, AClients) then
...
procedure TdxEntityManager.RegisterEMFAccessor(AClass: TClass;
  const AMemberName: string; AGetter: TdxEMFAccessorGetter;
...
procedure TdxEntityManager.RegisterEMFAccessor<T>(const AMemberName: string;
  AGetter: TdxEMFAccessorGetter<T>; ASetter: TdxEMFAccessorSetter<T>);
begin
  RegisterEMFAccessor(TClass(T), AMemberName, TdxEMFAccessorGetter(AGetter),
    TdxEMFAccessorSetter(ASetter));
end;

procedure TdxEntityManager.UnregisterEMFAccessor(AClass: TClass;
...
class function TdxEntityManager.GetTableName(AEntityInfo
  : TdxEntityInfo): string;
begin
...
begin { TODO : refactor CreateDiscriminator! }
  ...
  ADiscriminatorField.DiscriminatorValue :=
    TValue.FromVariant(ClassAttributes.DiscriminatorValue);
  ServiceFields.Add(ADiscriminatorField);
  Add(ADiscriminatorField);
end;

function TdxEntityInfo.CreateMappingMemberInfo(AMember: TRttiMember)
  : TdxMappingMemberInfo;
var
  AFieldType: TRttiType;
...
function TdxEntityInfo.FindMember(const AMemberName: string)
  : TdxMappingMemberInfo;
var
  AEntityInfo: TdxEntityInfo;
...
function TdxEntityInfo.FindMemberByColumnName(const AColumnName: string)
  : TdxMappingMemberInfo;
begin
    ...
    TdxDiscriminatorType.&String:
      begin
        ...
        if Length(AQualifiedClassName) > AMaxSize then
          Delete(AQualifiedClassName, 1, Length(AQualifiedClassName) -
            AMaxSize);
...
begin
  ...
  begin
    ...
    begin
      ...
      raise EdxDuplicateInheritedMemberNameFoundException.CreateFmt
        (sdxMetadataDuplicateInheritedMemberNameFound,
        [AMemberAttributes.MemberName, AMemberAttributes.Member.Parent.Name,
        AExistMemberAttributes.Member.Parent.Name]);
    end;
  ...
  else if AAttributeInfo is TdxMappingClassInfo then
...
begin
  ...
  if AKey = nil then
    Result := TValue.Empty
  else if AKey.IsCompositeKey then
...
begin
  ...
  for I := 0 to ACount - 1 do
    Result[I] := MemberAttributes{$IFDEF DELPHIXE3}.List{$ENDIF}[I]
      .GetAsVariant(AObject);
end;
...
function TdxEntityInfo.GetOptimisticLockingBehavior
...
begin
  ...
  begin
    if ClassAttributes.IsInheritance and
      (ClassAttributes.MapInheritance = TdxMapInheritanceType.OwnTable) then
    begin
      AClass := (ClassAttributes.RttiType as TRttiInstanceType)
...
function TdxEntityInfo.GetPropertiesListForUpdateInsert(AObject: TObject;
  AIsUpdate, AAddDelayedReference: Boolean): TdxMemberInfoCollection;
var
...
begin
  ...
  begin
    ...
    else if BaseEntityInfo <> nil then
...
begin
  if TryGetValueByName(TdxEntityManager.GetQualifiedFieldName(AMember.Name),
    AAttributeInfo) then
    Exit(True);
...
procedure TdxEntityInfo.InitAssociation(ASession: TComponent; AObject: TObject;
  const AQueryable: IdxQueryable; const AMemberName: string);
var
...
begin
  ...
  begin
    ...
    if TdxEntityManager.GetMember(AObject.ClassType, AMemberName) = nil then
      raise EdxAssociationInvalidException.CreateFmt
        (sdxMetadataFieldPropertyNotFound, [AMemberName, AObject.ClassName])
    else
      raise EdxAssociationInvalidException.CreateFmt
        (sdxMetadataFieldPropertyNotPersistent,
  ...
  begin
    ...
    for AAssociationMember in AssociationListProperties do
    begin
      if AAssociationClass = AAssociationMember.CollectionElementType.
        ClassAttributes.PersistentClass then
      begin
        if AFoundAssociation then
          raise EdxAssociationInvalidException.CreateFmt
            (sdxMetadataCannotResolveUnnamedAssociation,
...
procedure TdxEntityInfo.InitAssociations(ASession: TComponent;
  AObject: TObject);
var
  AAssociationMember: TdxMappingMemberInfo;
  AMemberValue: TValue;
...
begin
  ...
  begin
    ...
    case AAssociationMember.AttributeType of
      TdxAttributeType.&Property:
        AMemberValue := TRttiProperty(AAssociationMember.Member)
          .GetValue(AObject);
      TdxAttributeType.Field:
    ...
    if AMemberValue.IsNullOrEmpty then
      raise EdxAssociationInvalidException.CreateFmt
        (sdxMetadataAssociationNotCreated,
        [AObject.ClassName, AAssociationMember.MemberName]);
...
begin
  ...
  begin
    ...
    until (ABaseEntity = nil) or
      (ABaseEntity.ClassAttributes.DiscriminatorInfo.HasValue);
    if ABaseEntity = nil then
    begin
      if not ClassAttributes.IsParentTable then
        Exit;
      if BaseEntityInfo = nil then
        raise EdxNoEntityInfoException.CreateFmt(sdxMetadataBaseEntityNotFound,
          [FullName])
      else
        raise EdxBaseEntityNoDiscriminatorColumnException.CreateFmt
          (sdxMetadataBaseEntityNoDiscriminatorColumn, [FullName]);
    end;

    if ClassAttributes.IsParentTable and
      not ABaseEntity.ClassAttributes.DiscriminatorInfo.HasValue then
      ABaseEntity.CreateDiscriminator;

    ADiscriminatorField := TdxDiscriminatorMember.Create(Self);
    ADiscriminatorField.Discriminator :=
      ABaseEntity.ClassAttributes.DiscriminatorInfo;
    ServiceFields.Add(ADiscriminatorField);
    Add(ADiscriminatorField);

    if VarIsEmpty(ClassAttributes.DiscriminatorValue) or
      VarIsNull(ClassAttributes.DiscriminatorValue) then
...
begin
  if AEntityInfo = Self then
    Exit(True);
  ABaseClass := EntityManager.GetEntityInfo
    (ClassAttributes.PersistentBaseClass);
...
begin
  ...
  if AType is TRttiInstanceType then
    Result := EntityManager.HasClass(TRttiInstanceType(AType).MetaclassType) or
      EntityManager.IsProcessingEntityInfo(TRttiInstanceType(AType)
      .MetaclassType)
  else
    Result := False;
end;
...
begin
  if FCachedPaths = nil then
    FCachedPaths := TObjectDictionary<string, TdxMemberInfoCollection>.Create
      ([doOwnsValues]);
...
function TdxEntityInfo.ParsePersistentPath(const APath: string)
  : TdxMemberInfoCollection;
begin
...
procedure TdxEntityInfo.RegistrationFinalization;
  ...
  begin
    for AMemberInfo in MemberAttributes do
      if not AMemberInfo.IsKey and ([TdxAttribute.Indexed, TdxAttribute.Unique]
        * AMemberInfo.Attributes <> []) and AMemberInfo.IsMappingClass(Self)
      then
        ClassAttributes.Indexes.Add(AMemberInfo.ColumnName,
          AMemberInfo.IsUnique);
  end;

begin
  if ClassAttributes.AttributeName = '' then
    ClassAttributes.SetName(TdxEntityManager.GetQualifiedTableName
      (ClassAttributes.PersistentClass.ClassName));
...
function TdxEntityInfo.TryGetValueByName(const AName: string;
  out AAttributeInfo: TdxAttributeInfo): Boolean;
var
  I: Integer;
begin
...
function TdxMappingMemberInfo.SetDisplayFormat(const AValue: string)
  : IdxMappingMemberInfo;
begin
...
function TdxMappingMemberInfo.SetDisplayLabel(const AValue: string)
  : IdxMappingMemberInfo;
begin
...
function TdxMappingMemberInfo.SetDisplayWidth(AValue: Integer)
  : IdxMappingMemberInfo;
begin
...
function TdxMappingMemberInfo.SetEditFormat(const AValue: string)
  : IdxMappingMemberInfo;
begin
  FEditFormat := AValue;
  Result := Self;
...
function TdxMappingMemberInfo.SetEditMask(const AValue: string)
  : IdxMappingMemberInfo;
begin
  FEditMask := AValue;
  Result := Self;
...
function TdxMappingMemberInfo.Generator(AGeneratorType: TdxGeneratorType;
  const ASequenceName: string = ''): IdxMappingMemberInfo;
begin
...
begin
  ...
  if AMappingMember.FSerializer <> nil then
    FSerializer := TdxCustomBlobSerializerClass
      (AMappingMember.FSerializer.ClassType).Create;
  if Length(AMappingMember.FSubMembers) > 0 then
    TArray.Copy<TdxMappingMemberInfo>(AMappingMember.FSubMembers, FSubMembers,
      Length(AMappingMember.FSubMembers));
...
function TdxMappingMemberInfo.Association(const AAssociationName: string)
  : IdxMappingMemberInfo;
begin
  Include(Attributes, TdxAttribute.Association);
  if AAssociationName <> '' then
    FAssociationAttributeInfo := TdxAssociationAttributeInfo.Create
      (AAssociationName);
  Result := Self;
end;

function TdxMappingMemberInfo.Blob(ASerializerClass
  : TdxCustomBlobSerializerClass): IdxMappingMemberInfo;
begin
  Result := Blob;
...
function TdxMappingMemberInfo.CheckValidChar(ATypeKind: TTypeKind;
  InputChar: Char): Boolean;
begin
  case ATypeKind of
    TTypeKind.tkFloat:
      Result := CharInSet(InputChar, [FormatSettings.DecimalSeparator, '+', '-',
        '0' .. '9', 'E', 'e']);
    TTypeKind.tkClass, TTypeKind.tkDynArray, TTypeKind.tkInterface,
      TTypeKind.tkRecord
{$IFDEF DELPHI103}, TTypeKind.tkMRecord{$ENDIF}:
      Result := False;
    TTypeKind.tkInteger, TTypeKind.tkInt64:
      if FieldType in [TFieldType.ftByte, TFieldType.ftWord,
        TFieldType.ftLongWord] then
...
function TdxMappingMemberInfo.Column(const AColumnName: string)
  : IdxMappingMemberInfo;
begin
...
function TdxMappingMemberInfo.DBType(const ADBColumnTypeName: string)
  : IdxMappingMemberInfo;
begin
...
function TdxMappingMemberInfo.Default(const ADefaultValue: Variant)
  : IdxMappingMemberInfo;
begin
...
function TdxMappingMemberInfo.FindAttribute(AClass: TCustomAttributeClass)
  : TCustomAttribute;
var
  AAttributes: TArray<TCustomAttribute>;
begin
...
begin
  ...
  begin
    ...
    if not Owner.ClassAttributes.IsPersistent then
      raise EdxAssociationInvalidException.CreateFmt
        (sdxMetadataAssociationInvalidNonPersistentClassInTheAssociation,
        [Owner.ClassAttributes.EntityName, MemberName,
        Owner.ClassAttributes.EntityName]);
    if IsAssociationList then
      ARefEntityInfo := CollectionElementType
    else if (ReferenceType <> nil) and IsPersistent then
      ARefEntityInfo := ReferenceType
    else
      raise EdxAssociationInvalidException.CreateFmt
        (sdxMetadataAssociationInvalidAssociationAttributeOnlyForCollectionOrReference,
        [Owner.FullName, ActualName]);
    if not ARefEntityInfo.ClassAttributes.IsPersistent then
      raise EdxAssociationInvalidException.CreateFmt
        (sdxMetadataAssociationInvalidNonPersistentClassInTheAssociation,
        [ARefEntityInfo.ClassAttributes.EntityName, MemberName,
        ARefEntityInfo.ClassAttributes.EntityName]);
    AResult := nil;
    for AMemberInfo in ARefEntityInfo.MemberAttributes do
    begin
      if Self = AMemberInfo then
        Continue;
      if ((AMemberInfo.ReferenceType = nil) or (not AMemberInfo.IsPersistent))
        and not AMemberInfo.IsAssociationList then
        Continue;
      if not(TdxAttribute.Association in AMemberInfo.Attributes) then
        Continue;
      if AMemberInfo.FAssociationAttributeInfo.HasValue then
        ARelAssociationName := AMemberInfo.FAssociationAttributeInfo.Value.
          AssociationName
      else
        ARelAssociationName := '';
      ...
      if not((ARelRefEntityInfo = Owner) or
        Owner.ClassAttributes.PersistentClass.InheritsFrom
        (ARelRefEntityInfo.ClassAttributes.PersistentClass)) then
      begin
        if Length(AAssociationName) = 0 then
          Continue;
        raise EdxAssociationInvalidException.CreateFmt
          (sdxMetadataAssociationInvalidPropertyTypeMismatch,
          [AAssociationName, Owner.FullName, MemberName,
          AMemberInfo.Owner.FullName, AMemberInfo.MemberName,
          ARelRefEntityInfo.FullName]);
      end;
      if AResult <> nil then
        raise EdxAssociationInvalidException.CreateFmt
          (sdxMetadataAssociationInvalidMoreThanOneAssociatedMemberFound,
          [AAssociationName, AResult.MemberName, AMemberInfo.MemberName,
          ARefEntityInfo.FullName]);
      if not IsAssociationList and not AMemberInfo.IsAssociationList then
        raise EdxAssociationInvalidException.CreateFmt
          (sdxMetadataAssociationInvalidNoAssociationCollectionInAssociation,
          [AAssociationName, Owner.FullName, MemberName,
          AMemberInfo.Owner.FullName, AMemberInfo.MemberName]);
    ...
    if AResult = nil then
      raise EdxAssociationInvalidException.CreateFmt
        (sdxMetadataAssociationInvalidAssociatedMemberNotFound,
...
begin
  ...
  begin
    ...
    if AType <> nil then
      FCollectionElementType := EntityManager.GetEntityInfo
        (TRttiInstanceType(AType).MetaclassType);
  end;
...
class function TdxMappingMemberInfo.GetGenericIListTypeArgument
  (AElementType: TRttiType): TRttiType;
var
  ATypeInfo: PTypeInfo;
  APos: Integer;
...
begin
  ...
  if APos > 0 then
  begin
    AGenericArgumentName := Copy(ATypeInfoName, APos + 1,
      Pos('>', ATypeInfoName) - APos - 1);
...
begin
  if TdxAttribute.Generator in Attributes then
    Result := DBGenerator.GeneratorType in [TdxGeneratorType.IdEntity,
      TdxGeneratorType.Guid, TdxGeneratorType.SequentialGUID,
...
begin
  Result := [TdxAttribute.Column, TdxAttribute.Association,
    TdxAttribute.VirtualColumn] * Attributes <> [];
end;
...
begin
  Result := (TypeKind = tkEnumeration) and
    (FMemberType.Handle <> TypeInfo(Boolean));
end;
...
begin
  Result := [TdxAttribute.NonPersistent, TdxAttribute.VirtualColumn] *
    Attributes = [];
end;
...
begin
  Result := (AttributeType = TdxAttributeType.Field) or
    ((AttributeType = TdxAttributeType.&Property) and TRttiProperty(Member)
    .IsReadable);
end;
...
begin
  Result := not(IsNullable or IsIdentity or
    (FieldType in [Low(TBlobType) .. High(TBlobType)]));
end;
...
begin
  Result := (AttributeType = TdxAttributeType.Field) or (Member is TRttiField)
    or ((Member is TRttiProperty) and TRttiProperty(Member).IsWritable);
end;

function TdxMappingMemberInfo.GetMappingClass(ABranch: TdxEntityInfo)
  : TdxEntityInfo;
var
...
begin
  if ABranch = nil then
    Exit(nil);
  if not Owner.ClassAttributes.PersistentClass.InheritsFrom
    (ABranch.ClassAttributes.PersistentClass) then
    Exit(nil);
  ...
  repeat
    if AFirstPersistentOwnerDescendant.ClassAttributes.PersistentClass = GetPersistentClass
    then
      Exit(AFirstPersistentOwnerDescendant);
    ACurrentClass := AFirstPersistentOwnerDescendant.ClassAttributes.
      PersistentBaseClass;
    if (ACurrentClass = nil) and ABranch.ClassAttributes.IsInheritance and
      (not AFirstPersistentOwnerDescendant.ClassAttributes.IsInheritance) then
      Exit(AFirstPersistentOwnerDescendant);
    if (AFirstPersistentOwnerDescendant.ParentEntity = nil) or
      (not ACurrentClass.InheritsFrom
      (AFirstPersistentOwnerDescendant.ParentEntity.ClassAttributes.
      PersistentClass)) then
      Exit(AFirstPersistentOwnerDescendant);
    AFirstPersistentOwnerDescendant := EntityManager.GetEntityInfo
      (ACurrentClass);
...
function TdxMappingMemberInfo.GetValueAsDisplayText(const AValue
  : Variant): string;
var
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        if AMember <> nil then
          Result := AMember.GetValueAsDisplayText
            (AMember.GetAsVariant(AReferenceEntity))
        else
          Result := '';
      end;
    end;
...
begin
  if (FReferenceType = nil) and { (TdxAttribute.Association in Attributes) and }
    not FIsAssociationList then
    FReferenceType := EntityManager.GetEntityInfo
      (MemberType.Handle.TypeData.ClassType);
end;
...
begin
  case AttributeType of
    TdxAttributeType.Field:
      Result := SameText(TdxEntityManager.GetQualifiedFieldName(AMemberName),
        MemberName);
    TdxAttributeType.Property:
...
function TdxMappingMemberInfo.SetLookupResultField(const AFieldNames: string)
  : IdxMappingMemberInfo;
begin
...
function TdxMappingMemberInfo.SetPrecision(AValue: Integer)
  : IdxMappingMemberInfo;
begin
  FPrecision := AValue;
  Result := Self;
...
function TdxMappingMemberInfo.QueryInterface(const IID: TGUID; out Obj)
  : HResult;
begin
...
function TdxMappingMemberInfo.RegisterField(const AFieldName: string)
  : IdxMappingMemberInfo;
begin
  Result := Owner.ClassAttributes.RegisterField(AFieldName);
end;

function TdxMappingMemberInfo.RegisterProperty(const APropertyName: string)
  : IdxMappingMemberInfo;
begin
  Result := Owner.ClassAttributes.RegisterProperty(APropertyName);
end;

procedure TdxMappingMemberInfo.SetAsVariant(AObject: TObject;
  const AValue: Variant);
begin
...
procedure TdxMappingMemberInfo.SetMemberValue(AObject: TObject;
  const AValue: TValue);
begin
  case AttributeType of
    TdxAttributeType.&Property:
...
procedure TdxMappingMemberInfo.SetSerializer(ASerializerClass
  : TdxCustomBlobSerializerClass);
begin
...
procedure TdxMappingMemberInfo.SetSubMembers(const AMembers
...
begin
  ...
  begin
    ...
    while ((AMemberInfo <> nil) and AMemberInfo.IsStruct) and
      (I < Length(AMatches) - 1) do
    begin
      Inc(I);
      AMemberInfo := ACurrentEntityInfo.FindMember(AMemberInfo.MemberName + '.'
        + AMatches[I]);
    end;
    if (AMemberInfo = nil) or
      (not AAddNonPersistent and not AMemberInfo.IsExpandableToPersistent) or
    ...
    begin
      if AThrowOnError then
        raise EdxInvalidPropertyPathException.CreateFmt
          (sdxMetadataIncorrectPathMemberDoesNotExist,
          [TdxStringHelper.Join('.', AMatches),
          AEntityInfo.ClassAttributes.PersistentClass.ClassName,
...
constructor TdxMemberInfoCollection.Create(AEntityInfo: TdxEntityInfo;
  const APath: string; AAddNonPersistent: Boolean; AThrowOnError: Boolean);
begin
  Create(AEntityInfo, SplitPath(APath), AAddNonPersistent, AThrowOnError);
end;

constructor TdxMemberInfoCollection.Create(AEntityInfo: TdxEntityInfo;
  const APath: string; AAddNonPersistent: Boolean);
begin
...
constructor TdxMemberInfoCollection.Create(AEntityInfo: TdxEntityInfo;
  const AMembers: array of TdxMappingMemberInfo);
begin
  Create(AEntityInfo);
  AddRange(AMembers);
end;
...
class function TdxMemberInfoCollection.ParsePath(AEntityInfo: TdxEntityInfo;
  const APath: string): TdxMemberInfoCollection;
begin
  Result := AEntityInfo.ParsePath(APath);
end;

class function TdxMemberInfoCollection.ParsePersistentPath
  (AEntityInfo: TdxEntityInfo; const APath: string): TdxMemberInfoCollection;
begin
  Result := AEntityInfo.ParsePersistentPath(APath);
end;

procedure TdxMemberInfoCollection.Remove(ACollection
  : TEnumerable<TdxMappingMemberInfo>);
var
  AMappingMemberInfo: TdxMappingMemberInfo;
begin
...
class function TdxMemberInfoCollection.FindMember(ACurrentEntityInfo
  : TdxEntityInfo; const AMatch: string): TdxMappingMemberInfo;
var
...
begin
  ...
  begin
    if (AResolvedWithNamespace <> nil) and AResolvedWithNamespace.IsAssignableTo
      (ACurrentEntityInfo) then
    begin
  ...
  begin
    ...
    begin
      ...
      if (AShouldBeClassNameDelimiter <> '.') and
        (AShouldBeClassNameDelimiter <> '+') then
        Continue;
    end;
    ...
    if (AEntityInfo.IsPersistent and ACurrentEntityInfo.IsPersistent) and
      (AEntityInfo.ClassAttributes.PersistentClass <>
      ACurrentEntityInfo.ClassAttributes.PersistentClass) then
      Continue;
    if Result <> nil then
      raise EInvalidOperation.Create
        ('sdxMetadataAmbiguousClassName' { , AClassName, AResult.Owner.FullName, Result.Owner.FullName) } );
    Result := AResult;
  end;
end;
...
begin
  ...
  try
    ...
    begin
      ...
      if Self[I] <> nil then
      begin
        if (ACurrentEntityInfo <> nil) and not ACurrentEntityInfo.IsAssignableTo
          (Self[I].Owner) then
        begin
...
class function TdxMemberInfoCollection.SplitPath(const APath: string)
  : TArray<string>;
var
      ...
      case APath[I] of
        '.':
          begin
            if AInUpCast then
              Continue;
            AResult.Add(TdxStringHelper.Substring(APath, APrevCutPos,
              I - APrevCutPos - 1));
            APrevCutPos := I;
          end;
        '<':
...
class function TdxMemberInfoCollection.LastIndexOfSplittingDotInPath
  (const APath: string): Integer;
var
  ALastDotPos, AClosingAngBr, AOpeningAngBr: Integer;
begin
  ALastDotPos :=
  {$IFDEF DELPHIXE3}APath.LastIndexOf('.'){$ELSE}TdxStringHelper.LastIndexOf
    (APath, '.'){$ENDIF};
  if ALastDotPos < 0 then
    Exit(ALastDotPos);
  AClosingAngBr :=
  {$IFDEF DELPHIXE3}APath.IndexOf('>', ALastDotPos){$ELSE}TdxStringHelper.
    IndexOf(APath, '>', ALastDotPos){$ENDIF};
  if AClosingAngBr < 0 then
    Exit(ALastDotPos);
  AOpeningAngBr :=
  {$IFDEF DELPHIXE3}APath.LastIndexOf('<', AClosingAngBr){$ELSE}TdxStringHelper.
    LastIndexOf(APath, '<', AClosingAngBr){$ENDIF};
  if AOpeningAngBr < 0 then
    raise EInvalidOperation.Create('Unbalanced <UpCasting> within '#$27 + APath
      + #$27' property path');
  Result := {$IFDEF DELPHIXE3}APath.LastIndexOf('.', AOpeningAngBr){$ELSE}TdxStringHelper.LastIndexOf(APath, '.', AOpeningAngBr){$ENDIF};
end;

class function TdxMemberInfoCollection.GetSplitPartCount
  (const APath: string): Integer;
var
  ACount, APos: Integer;
  ACh: Char;
    ...
    begin
      ...
      begin
        ...
        if APos >= Length(APath) then
          raise EInvalidOperation.Create('Unbalanced UpCasting '#$27 +
            APath + #$27);
      end;
    end;
    Inc(APos);
...
class function TdxMemberInfoCollection.TryResolveType(const AClassName: string;
...
begin
  AEntityInfo := nil;
{$IFDEF DELPHIXE3}
  ANamespaceLenInCurrentClassInfo := ARootEntityInfo.FullName.LastIndexOfAny
    (NamespaceSplitters);
{$ELSE}
  ANamespaceLenInCurrentClassInfo := TdxStringHelper.LastIndexOfAny
    (ARootEntityInfo.FullName, NamespaceSplitters);
{$ENDIF}
  ...
  begin
    if {$IFDEF DELPHIXE3}AClassName.LastIndexOfAny(NamespaceSplitters){$ELSE}TdxStringHelper.LastIndexOfAny(AClassName, NamespaceSplitters){$ENDIF} >= 0 then
      AResolvedWithNamespace := EntityManager.GetEntityInfo
        (ARootEntityInfo.EntityUnitName + '.' + AClassName)
    else
      AResolvedWithNamespace := EntityManager.GetEntityInfo
        (ARootEntityInfo.EntityUnitName + '.' +
{$IFDEF DELPHIXE3}
        ARootEntityInfo.FullName.Substring(0, ANamespaceLenInCurrentClassInfo +
        1) + AClassName);
{$ELSE}
        TdxStringHelper.Substring(ARootEntityInfo.FullName, 0,
        ANamespaceLenInCurrentClassInfo + 1) + AClassName);
{$ENDIF}
...
class function TdxMemberInfoCollection.TryResolveTypeAlsoByShortName
  (const AClassName: string; ARootEntityInfo: TdxEntityInfo;
...
begin
  AEntityInfo := nil;
  if not TdxMemberInfoCollection.TryResolveType(AClassName, ARootEntityInfo,
    AEntityInfo) then
  begin
{$IFDEF DELPHIXE3}
    AIsFullClassName := AClassName.LastIndexOfAny(NamespaceSplitters) >= 0;
{$ELSE}
    AIsFullClassName := TdxStringHelper.LastIndexOfAny(AClassName,
      NamespaceSplitters) >= 0;
{$ENDIF}
...
{$ELSE}
            ADotIndex := TdxStringHelper.LastIndexOfAny(AEntity.FullName,
              NamespaceSplitters);
{$ENDIF}
...
{$ELSE}
              (TdxStringHelper.Substring(AEntity.FullName, ADotIndex)
              = AClassName))) or
{$ENDIF}
              (((ADotIndex < 0) and (AEntity.FullName = AClassName)))) then
              Continue;
          end
          else if not SameText(AEntity.ClassAttributes.EntityName, AClassName)
          then
            Continue;
        end;
      end;
...
begin
  ...
  begin
    EntityManager.AutoMappingAttributes
      (EntityManager.Context.GetType(PersistentClass), Owner);
  end;
  Include(Attributes, TdxAttribute.Automapping);
  Result := Self;
end;

function TdxMappingClassInfo.Discriminator(AValue: Integer)
  : IdxMappingClassInfo;
begin
...
function TdxMappingClassInfo.Discriminator(const AValue: string)
  : IdxMappingClassInfo;
begin
  FDiscriminatorValue := AValue;
  Result := Self;
...
function TdxMappingClassInfo.DiscriminatorColumn(const AColumnName: string)
  : IdxMappingClassInfo;
begin
  FDiscriminatorInfo := TdxDiscriminator.Create(TdxDiscriminatorType.Integer,
    AColumnName);
  Result := Self;
end;
...
function TdxMappingClassInfo.DiscriminatorColumn(const AColumnName: string;
  ...
  : IdxMappingClassInfo;
begin
  FDiscriminatorInfo := TdxDiscriminator.Create(ADiscriminatorType,
    AColumnName, ASize);
  Result := Self;
end;

function TdxMappingClassInfo.FindAttribute(AClass: TCustomAttributeClass)
  : TCustomAttribute;
var
  AAttributes: TArray<TCustomAttribute>;
begin
...
begin
  Result := IsInheritance and
    (MapInheritance = TdxMapInheritanceType.ParentTable);
end;
...
begin
  ...
  begin
    ...
    begin
      ...
      if not(AEntityInfo.ClassAttributes.IsPersistent and
        AEntityInfo.ClassAttributes.IsParentTable) then
...
begin
  ...
  begin
    ...
    if AEntityInfo.ClassAttributes.IsInheritance and
      (AEntityInfo.ClassAttributes.MapInheritance = TdxMapInheritanceType.
      ParentTable) then
    begin
      AEntityInfo := EntityManager.GetEntityInfo
        (AEntityInfo.ClassAttributes.PersistentBaseClass);
    end;
    if AEntityInfo.ClassAttributes.FTableName = '' then
      AEntityInfo.ClassAttributes.FTableName :=
        AEntityInfo.ClassAttributes.AttributeName;
    FTableName := AEntityInfo.ClassAttributes.TableName;
  end;
  Result := FTableName;
end;

function TdxMappingClassInfo.Inheritance(AMapInheritance: TdxMapInheritanceType)
  : IdxMappingClassInfo;
begin
...
function TdxMappingClassInfo.Key(const AFieldNames: string)
  : IdxMappingClassInfo;
begin
  KeyMemberNames.AddRange({$IFDEF DELPHIXE3}AFieldNames.Split([',', ';']
    ){$ELSE}TdxStringHelper.Split(AFieldNames, [',', ';']){$ENDIF});
  Result := Self;
end;
...
function TdxMappingClassInfo.RegisterField(const AFieldName: string)
  : IdxMappingMemberInfo;
var
  AMember: TRttiMember;
  AMemberInfo: TdxMappingMemberInfo;
...
begin
  ...
  if (AMember = nil) or not(AMember is TRttiField) then
    raise EdxEMFException.CreateFmt(sdxMetadataFieldPropertyNotFound,
      [AFieldName, PersistentClass.ClassName]);
...
function TdxMappingClassInfo.RegisterProperty(const APropertyName: string)
  : IdxMappingMemberInfo;
var
  AMember: TRttiMember;
  AMemberInfo: TdxMappingMemberInfo;
begin
  ...
  if (AMember = nil) or not(AMember is TRttiProperty) then
    raise EdxEMFException.CreateFmt(sdxMetadataFieldPropertyNotFound,
      [APropertyName, PersistentClass.ClassName]);
  AMemberInfo := Owner.CreateMappingMemberInfo(AMember);
  if AMemberInfo = nil then
    raise EdxEMFException.Create('');
  AMemberInfo.Member := AMember;
...
function TdxMappingClassInfo.Table(const ATableName: string)
  : IdxMappingClassInfo;
begin
  SetName(ATableName);
  Result := Self;
...
function TdxMappingClassInfo.TableIndexes(const AColumns: string)
  : IdxMappingClassInfo;
begin
  Indexes.Add({$IFDEF DELPHIXE3}AColumns.Split([',', ';']
    ){$ELSE}TdxStringHelper.Split(AColumns, [',', ';']){$ENDIF});
  Result := Self;
end;

function TdxMappingClassInfo.TableSchemaName(const ASchemaName: string)
  : IdxMappingClassInfo;
begin
...
begin
  for I := Count - 1 downto 0 do
    if SameText({$IFDEF DELPHIXE3}List{$ELSE}Items{$ENDIF}[I].MemberName,
      AMemberName) then
      Exit(I);
  Result := -1;
end;
...
function AddKeyMemberInfoNames(AKeyProperty: TdxKeyMemberInfo)
  : Integer; forward;
  ...
  begin
    ...
    begin
      ...
      begin
        if AMemberInfo.IsReference then
        begin
          if AMemberInfo.ReferenceType.ClassAttributes.PersistentClass.
            InheritsFrom(Owner.ClassAttributes.PersistentClass) then
            raise EdxInvalidKeyPropertyException.Create
              ('EdxInvalidKeyPropertyException');
          Inc(Result, AddKeyMemberInfoNames
            (AMemberInfo.ReferenceType.KeyProperty))
        end
        else
        begin
          ANames.Add(AMemberInfo.MemberName);
...
begin
  if Member.IsReference then
    Result := Member.ReferenceType.KeyProperty.GetValue
      (Member.GetValue(AObject).AsObject)
  else
...
var
  ...
  procedure SetResultValues(const AResult: TArray<TValue>;
    AMember: TdxMappingMemberInfo; var K: Integer);
  var
    J: Integer;
  begin
    if AMember.IsReference then
    begin
      AKeyValues := AMember.ReferenceType.KeyProperty.GetValues
...
procedure TdxDiscriminatorMember.SetDiscriminator
  (const Value: TdxDiscriminator);
begin
...
procedure TdxServiceFields.Notify(const Value: TdxServiceMember;
...
procedure TdxEntityManager.TEntityClients.Register(AClient: TObject;
