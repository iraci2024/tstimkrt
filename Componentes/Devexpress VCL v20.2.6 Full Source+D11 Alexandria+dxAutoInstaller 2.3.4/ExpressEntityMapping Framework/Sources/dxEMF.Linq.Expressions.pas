...
type
  ...
  private
    ...
    class function ToArray(const A: array of TdxLinqExpression)
  ...
  public
    ...
    class operator Equal(const A: TdxLinqExpression; const B: TGUID)
      : TdxLinqExpression;
    class operator Equal(const A: TGUID; const B: TdxLinqExpression)
      : TdxLinqExpression;
    // "<>"
    class operator NotEqual(const A, B: TdxLinqExpression): TdxLinqExpression;
    class operator NotEqual(const A: TdxLinqExpression; const B: TGUID)
      : TdxLinqExpression;
    class operator NotEqual(const A: TGUID; const B: TdxLinqExpression)
      : TdxLinqExpression;
    // ">"
    class operator GreaterThan(const A, B: TdxLinqExpression)
      : TdxLinqExpression;
    // ">="
    class operator GreaterThanOrEqual(const A, B: TdxLinqExpression)
      : TdxLinqExpression;
    // "<"
    class operator LessThan(const A, B: TdxLinqExpression): TdxLinqExpression;
    // "<="
    class operator LessThanOrEqual(const A, B: TdxLinqExpression)
      : TdxLinqExpression;
    // "and"
    ...
    // "in"
{$IFDEF DELPHIXE3}
    class operator In (const A: TdxLinqExpression;
      const B: array of TdxLinqExpression): TdxLinqExpression;
{$ENDIF}
    function &In<T>(const B: TArray<T>): TdxLinqExpression;
    // "between"
    function Between(const ABeginExpression, AEndExpression: TdxLinqExpression)
      : TdxLinqExpression;
    // "Is Null"
    function IsNull: TdxLinqExpression;
  end;

function IfThen(const AValue, ATrue, AFalse: TdxLinqExpression)
...
function Power(const ABase, AExponent: TdxLinqExpression)
  : TdxLinqExpression; overload;
function Round(const X: TdxLinqExpression): TdxLinqExpression; overload;
function Round(const AValue, ADigit: TdxLinqExpression)
  : TdxLinqExpression; overload;
...
// Date/Time functions
function MillisecondOf(const AValue: TdxLinqExpression)
  : TdxLinqExpression; overload;
...
function GetTimeOfDay(const AValue: TdxLinqExpression)
  : TdxLinqExpression; overload;
function DayOfTheWeek(const AValue: TdxLinqExpression)
  : TdxLinqExpression; overload;
function DayOfTheYear(const AValue: TdxLinqExpression)
  : TdxLinqExpression; overload;
function DateOf(const AValue: TdxLinqExpression): TdxLinqExpression; overload;
function IncTick(const AValue, ANumberOfTicks: TdxLinqExpression)
  : TdxLinqExpression; overload;
function IncMillisecond(const AValue, ANumberOfMilliseconds: TdxLinqExpression)
  : TdxLinqExpression; overload;
function IncSecond(const AValue, ANumberOfSeconds: TdxLinqExpression)
  : TdxLinqExpression; overload;
function IncMinute(const AValue, ANumberOfSeconds: TdxLinqExpression)
  : TdxLinqExpression; overload;
function IncHour(const AValue, ANumberOfHours: TdxLinqExpression)
  : TdxLinqExpression; overload;
function IncDay(const AValue, ANumberOfDays: TdxLinqExpression)
  : TdxLinqExpression; overload;
function IncMonth(const AValue, ANumberOfMonths: TdxLinqExpression)
  : TdxLinqExpression; overload;
function IncYear(const AValue, ANumberOfYears: TdxLinqExpression)
  : TdxLinqExpression; overload;
function MillisecondsBetween(const ANow, AThen: TdxLinqExpression)
  : TdxLinqExpression; overload;
function SecondsBetween(const ANow, AThen: TdxLinqExpression)
  : TdxLinqExpression; overload;
function MinutesBetween(const ANow, AThen: TdxLinqExpression)
  : TdxLinqExpression; overload;
function HoursBetween(const ANow, AThen: TdxLinqExpression)
  : TdxLinqExpression; overload;
function DaysBetween(const ANow, AThen: TdxLinqExpression)
  : TdxLinqExpression; overload;
function MonthsBetween(const ANow, AThen: TdxLinqExpression)
  : TdxLinqExpression; overload;
function YearsBetween(const ANow, AThen: TdxLinqExpression)
  : TdxLinqExpression; overload;
...
function UpperCase(const AValue: TdxLinqExpression): TdxLinqExpression;
  overload;
function Concat(const AValues: array of TdxLinqExpression)
  : TdxLinqExpression; overload;
function Replace(const AValue, AOldValue, ANewValue: TdxLinqExpression)
  : TdxLinqExpression; overload;
function Reverse(const AValue: TdxLinqExpression): TdxLinqExpression; overload;
function Insert(const AValue, AIndex, ASubValue: TdxLinqExpression)
  : TdxLinqExpression; overload;
function Remove(const AValue, AStartIndex: TdxLinqExpression)
  : TdxLinqExpression; overload;
function Remove(const AValue, AStartIndex, ACount: TdxLinqExpression)
  : TdxLinqExpression; overload;
function CharIndex(const ASubStr, AValue: TdxLinqExpression)
  : TdxLinqExpression; overload;
function CharIndex(const ASubStr, AValue, AOffset: TdxLinqExpression)
  : TdxLinqExpression; overload;
function CharIndex(const ASubStr, AValue, AOffset, ACount: TdxLinqExpression)
  : TdxLinqExpression; overload;
function Pos(const ASubStr, AValue: TdxLinqExpression): TdxLinqExpression;
  overload; inline;
function Pos(const ASubStr, AValue, AOffset: TdxLinqExpression)
  : TdxLinqExpression; overload; inline;
function Pos(const ASubStr, AValue, AOffset, ACount: TdxLinqExpression)
  : TdxLinqExpression; overload; inline;
function PadLeft(const AValue, ATotalWidth: TdxLinqExpression)
  : TdxLinqExpression; overload;
function PadLeft(const AValue, ATotalWidth, APaddingChar: TdxLinqExpression)
  : TdxLinqExpression; overload;
function PadRight(const AValue, ATotalWidth: TdxLinqExpression)
  : TdxLinqExpression; overload;
function PadRight(const AValue, ATotalWidth, APaddingChar: TdxLinqExpression)
  : TdxLinqExpression; overload;
function StartsWith(const AValue, ASubStr: TdxLinqExpression)
  : TdxLinqExpression; overload;
function EndsWith(const AValue, ASubStr: TdxLinqExpression)
  : TdxLinqExpression; overload;
function Contains(const AValue, ASubStr: TdxLinqExpression)
  : TdxLinqExpression; overload;
function Substring(const AValue, AStartIndex: TdxLinqExpression)
  : TdxLinqExpression; overload;
function Substring(const AValue, AStartIndex, ALength: TdxLinqExpression)
  : TdxLinqExpression; overload;
function Trim(const AValue: TdxLinqExpression): TdxLinqExpression; overload;
function IsNullOrEmpty(const AValue: TdxLinqExpression)
  : TdxLinqExpression; overload;
...
begin
  Result := TdxFunctionOperator.Create(TdxFunctionOperatorType.Abs,
    [X.GetOperator]);
end;

function Sqr(const X: TdxLinqExpression): TdxLinqExpression;
begin
  Result := TdxFunctionOperator.Create(TdxFunctionOperatorType.Sqr,
    [X.GetOperator]);
end;

function Random(const X: TdxLinqExpression): TdxLinqExpression;
begin
  Result := TdxFunctionOperator.Create(TdxFunctionOperatorType.Random,
    [X.GetOperator]);
end;

function Log(const X: TdxLinqExpression): TdxLinqExpression;
begin
  Result := TdxFunctionOperator.Create(TdxFunctionOperatorType.Log,
    [X.GetOperator]);
end;
...
begin
  Result := TdxFunctionOperator.Create(TdxFunctionOperatorType.Log,
    [X.GetOperator, Y.GetOperator]);
end;

function BigMul(const X, Y: TdxLinqExpression): TdxLinqExpression;
begin
  Result := TdxFunctionOperator.Create(TdxFunctionOperatorType.BigMul,
    [X.GetOperator, Y.GetOperator]);
end;

function Log10(const X: TdxLinqExpression): TdxLinqExpression;
begin
  Result := TdxFunctionOperator.Create(TdxFunctionOperatorType.Log10,
    [X.GetOperator]);
end;

function Sin(const X: TdxLinqExpression): TdxLinqExpression;
begin
  Result := TdxFunctionOperator.Create(TdxFunctionOperatorType.Sin,
    [X.GetOperator]);
end;

function Tan(const X: TdxLinqExpression): TdxLinqExpression;
begin
  Result := TdxFunctionOperator.Create(TdxFunctionOperatorType.Tan,
    [X.GetOperator]);
end;

function ArcTan(const X: TdxLinqExpression): TdxLinqExpression;
begin
  Result := TdxFunctionOperator.Create(TdxFunctionOperatorType.ArcTan,
    [X.GetOperator]);
end;

function ArcTan2(const X, Y: TdxLinqExpression): TdxLinqExpression;
begin
  Result := TdxFunctionOperator.Create(TdxFunctionOperatorType.ArcTan2,
    [X.GetOperator, Y.GetOperator]);
end;

function Cos(const X: TdxLinqExpression): TdxLinqExpression;
begin
  Result := TdxFunctionOperator.Create(TdxFunctionOperatorType.Cos,
    [X.GetOperator]);
end;

function ArcCos(const X: TdxLinqExpression): TdxLinqExpression;
begin
  Result := TdxFunctionOperator.Create(TdxFunctionOperatorType.ArcCos,
    [X.GetOperator]);
end;

function ArcSin(const X: TdxLinqExpression): TdxLinqExpression;
begin
  Result := TdxFunctionOperator.Create(TdxFunctionOperatorType.ArcSin,
    [X.GetOperator]);
end;

function Cosh(const X: TdxLinqExpression): TdxLinqExpression;
begin
  Result := TdxFunctionOperator.Create(TdxFunctionOperatorType.Cosh,
    [X.GetOperator]);
end;

function Sinh(const X: TdxLinqExpression): TdxLinqExpression;
begin
  Result := TdxFunctionOperator.Create(TdxFunctionOperatorType.Sinh,
    [X.GetOperator]);
end;

function Tanh(const X: TdxLinqExpression): TdxLinqExpression;
begin
  Result := TdxFunctionOperator.Create(TdxFunctionOperatorType.Tanh,
    [X.GetOperator]);
end;

function Exp(const X: TdxLinqExpression): TdxLinqExpression;
begin
  Result := TdxFunctionOperator.Create(TdxFunctionOperatorType.Exp,
    [X.GetOperator]);
end;

function Power(const ABase, AExponent: TdxLinqExpression): TdxLinqExpression;
begin
  Result := TdxFunctionOperator.Create(TdxFunctionOperatorType.Power,
    [ABase.GetOperator, AExponent.GetOperator]);
end;

function Round(const X: TdxLinqExpression): TdxLinqExpression;
begin
  Result := TdxFunctionOperator.Create(TdxFunctionOperatorType.Round,
    [X.GetOperator]);
end;
...
begin
  Result := TdxFunctionOperator.Create(TdxFunctionOperatorType.Round,
    [AValue.GetOperator, ADigit.GetOperator]);
end;

function Sign(const X: TdxLinqExpression): TdxLinqExpression;
begin
  Result := TdxFunctionOperator.Create(TdxFunctionOperatorType.Sign,
    [X.GetOperator]);
end;

function Floor(const X: TdxLinqExpression): TdxLinqExpression;
begin
  Result := TdxFunctionOperator.Create(TdxFunctionOperatorType.Floor,
    [X.GetOperator]);
end;

function Ceil(const X: TdxLinqExpression): TdxLinqExpression;
begin
  Result := TdxFunctionOperator.Create(TdxFunctionOperatorType.Ceil,
    [X.GetOperator]);
end;

function Max(const A, B: TdxLinqExpression): TdxLinqExpression;
begin
  Result := TdxFunctionOperator.Create(TdxFunctionOperatorType.Max,
    [A.GetOperator, B.GetOperator]);
end;

function Min(const A, B: TdxLinqExpression): TdxLinqExpression;
begin
  Result := TdxFunctionOperator.Create(TdxFunctionOperatorType.Min,
    [A.GetOperator, B.GetOperator]);
end;

function Ascii(const X: TdxLinqExpression): TdxLinqExpression;
begin
  Result := TdxFunctionOperator.Create(TdxFunctionOperatorType.Ascii,
    [X.GetOperator]);
end;

function MillisecondOf(const AValue: TdxLinqExpression): TdxLinqExpression;
begin
  Result := TdxFunctionOperator.Create(TdxFunctionOperatorType.MillisecondOf,
    [AValue.GetOperator]);
end;

function SecondOf(const AValue: TdxLinqExpression): TdxLinqExpression;
begin
  Result := TdxFunctionOperator.Create(TdxFunctionOperatorType.SecondOf,
    [AValue.GetOperator]);
end;

function MinuteOf(const AValue: TdxLinqExpression): TdxLinqExpression;
begin
  Result := TdxFunctionOperator.Create(TdxFunctionOperatorType.MinuteOf,
    [AValue.GetOperator]);
end;
...
begin
  Result := TdxFunctionOperator.Create(TdxFunctionOperatorType.DayOf,
    [AValue.GetOperator]);
end;

function MonthOf(const AValue: TdxLinqExpression): TdxLinqExpression;
begin
  Result := TdxFunctionOperator.Create(TdxFunctionOperatorType.MonthOf,
    [AValue.GetOperator]);
end;
...
begin
  Result := TdxFunctionOperator.Create(TdxFunctionOperatorType.GetTimeOfDay,
    [AValue.GetOperator]);
end;

function DayOfTheWeek(const AValue: TdxLinqExpression): TdxLinqExpression;
begin
  Result := TdxFunctionOperator.Create(TdxFunctionOperatorType.DayOfTheWeek,
    [AValue.GetOperator]);
end;

function DayOfTheYear(const AValue: TdxLinqExpression): TdxLinqExpression;
begin
  Result := TdxFunctionOperator.Create(TdxFunctionOperatorType.DayOfTheYear,
    [AValue.GetOperator]);
end;
...
begin
  Result := TdxFunctionOperator.Create(TdxFunctionOperatorType.Len,
    [AValue.GetOperator]);
end;

function LowerCase(const AValue: TdxLinqExpression): TdxLinqExpression;
begin
  Result := TdxFunctionOperator.Create(TdxFunctionOperatorType.LowerCase,
    [AValue.GetOperator]);
end;

function UpperCase(const AValue: TdxLinqExpression): TdxLinqExpression;
begin
  Result := TdxFunctionOperator.Create(TdxFunctionOperatorType.UpperCase,
    [AValue.GetOperator]);
end;

function Concat(const AValues: array of TdxLinqExpression): TdxLinqExpression;
begin
  Result := TdxFunctionOperator.Create(TdxFunctionOperatorType.Concat,
    TdxLinqExpression.ToArray(AValues));
end;
...
begin
  Result := TdxFunctionOperator.Create(TdxFunctionOperatorType.Reverse,
    [AValue.GetOperator]);
end;
...
begin
  Result := TdxFunctionOperator.Create(TdxFunctionOperatorType.Trim,
    [AValue.GetOperator]);
end;

function IsNullOrEmpty(const AValue: TdxLinqExpression): TdxLinqExpression;
begin
  Result := TdxFunctionOperator.Create(TdxFunctionOperatorType.IsNullOrEmpty,
    [AValue.GetOperator]);
end;

function ToChar(const AValue: TdxLinqExpression): TdxLinqExpression;
begin
  Result := TdxFunctionOperator.Create(TdxFunctionOperatorType.Char,
    [AValue.GetOperator]);
end;

function ToDecimal(const AValue: TdxLinqExpression): TdxLinqExpression;
begin
  Result := TdxFunctionOperator.Create(TdxFunctionOperatorType.ToDecimal,
    [AValue.GetOperator]);
end;

function ToDouble(const AValue: TdxLinqExpression): TdxLinqExpression;
begin
  Result := TdxFunctionOperator.Create(TdxFunctionOperatorType.ToDouble,
    [AValue.GetOperator]);
end;

function ToInt64(const AValue: TdxLinqExpression): TdxLinqExpression;
begin
  Result := TdxFunctionOperator.Create(TdxFunctionOperatorType.ToInt64,
    [AValue.GetOperator]);
end;

function ToInteger(const AValue: TdxLinqExpression): TdxLinqExpression;
begin
  Result := TdxFunctionOperator.Create(TdxFunctionOperatorType.ToInteger,
    [AValue.GetOperator]);
end;

function ToSingle(const AValue: TdxLinqExpression): TdxLinqExpression;
begin
  Result := TdxFunctionOperator.Create(TdxFunctionOperatorType.ToSingle,
    [AValue.GetOperator]);
end;

function ToStr(const AValue: TdxLinqExpression): TdxLinqExpression;
begin
  Result := TdxFunctionOperator.Create(TdxFunctionOperatorType.ToString,
    [AValue.GetOperator]);
end;

{ TdxLinqExpression.TFreeTheValue }

constructor TdxLinqExpression.TOperatorHolder.Create
  (AOperator: TdxCriteriaOperator);
begin
  inherited Create;
  // FOperator := AOperator;
end;
...
class operator TdxLinqExpression.Implicit(const A: IdxExpression)
  : TdxLinqExpression;
begin
  Result.FExpression := A;
end;

class operator TdxLinqExpression.Implicit(const A: TdxLinqExpression)
  : IdxExpression;
begin
...
class operator TdxLinqExpression.Equal(const A: TdxLinqExpression;
  const B: TGUID): TdxLinqExpression;
begin
  Result := TdxBinaryOperator.Create(A.GetOperator, TdxOperandValue.Create(B),
    TdxBinaryOperatorType.Equal);
end;

class operator TdxLinqExpression.Equal(const A, B: TdxLinqExpression)
  : TdxLinqExpression;
begin
  Result := TdxBinaryOperator.Create(A.GetOperator, B.GetOperator,
    TdxBinaryOperatorType.Equal);
end;

class operator TdxLinqExpression.Equal(const A: TGUID;
  const B: TdxLinqExpression): TdxLinqExpression;
begin
  Result := TdxBinaryOperator.Create(TdxOperandValue.Create(A), B.GetOperator,
    TdxBinaryOperatorType.Equal);
end;

class operator TdxLinqExpression.Explicit(const A: TdxLinqExpression)
  : IdxCriteriaOperator;
begin
  Result := A.GetOperator;
end;
...
class operator TdxLinqExpression.GreaterThan(const A, B: TdxLinqExpression)
  : TdxLinqExpression;
begin
  Result := TdxBinaryOperator.Create(A.GetOperator, B.GetOperator,
...
class operator TdxLinqExpression.GreaterThanOrEqual(const A,
  B: TdxLinqExpression): TdxLinqExpression;
begin
  Result := TdxBinaryOperator.Create(A.GetOperator, B.GetOperator,
...
class operator TdxLinqExpression.Implicit(AOperator: TdxCriteriaOperator)
  : TdxLinqExpression;
begin
  Result := TdxLinqExpression.Create(AOperator);
end;

function TdxLinqExpression.Between(const ABeginExpression, AEndExpression
  : TdxLinqExpression): TdxLinqExpression;
begin
  Result := TdxBetweenOperator.Create(Self.GetOperator,
    ABeginExpression.GetOperator, AEndExpression.GetOperator);
end;

class operator TdxLinqExpression.Divide(const A, B: TdxLinqExpression)
  : TdxLinqExpression;
begin
  Result := TdxBinaryOperator.Create(A.GetOperator, B.GetOperator,
...
class operator TdxLinqExpression.LessThan(const A, B: TdxLinqExpression)
  : TdxLinqExpression;
begin
  Result := TdxBinaryOperator.Create(A.GetOperator, B.GetOperator,
...
class operator TdxLinqExpression.LessThanOrEqual(const A, B: TdxLinqExpression)
  : TdxLinqExpression;
begin
  Result := TdxBinaryOperator.Create(A.GetOperator, B.GetOperator,
...
class operator TdxLinqExpression.LogicalAnd(const A, B: TdxLinqExpression)
  : TdxLinqExpression;
begin
  Result := TdxGroupOperator.Combine(TdxGroupOperatorType.&And, A.GetOperator,
    B.GetOperator);
end;

class operator TdxLinqExpression.LogicalNot(const A: TdxLinqExpression)
  : TdxLinqExpression;
begin
  Result := TdxUnaryOperator.Create(TdxUnaryOperatorType.&Not, A.GetOperator);
end;

class operator TdxLinqExpression.LogicalOr(const A, B: TdxLinqExpression)
  : TdxLinqExpression;
begin
  Result := TdxGroupOperator.Combine(TdxGroupOperatorType.&Or, A.GetOperator,
    B.GetOperator);
end;

class operator TdxLinqExpression.Modulus(const A, B: TdxLinqExpression)
  : TdxLinqExpression;
begin
  Result := TdxBinaryOperator.Create(A.GetOperator, B.GetOperator,
...
class operator TdxLinqExpression.Multiply(const A, B: TdxLinqExpression)
  : TdxLinqExpression;
begin
  Result := TdxBinaryOperator.Create(A.GetOperator, B.GetOperator,
...
class operator TdxLinqExpression.Negative(const A: TdxLinqExpression)
  : TdxLinqExpression;
begin
  Result := TdxUnaryOperator.Create(TdxUnaryOperatorType.Minus, A.GetOperator);
end;

class operator TdxLinqExpression.NotEqual(const A: TdxLinqExpression;
  const B: TGUID): TdxLinqExpression;
begin
  Result := TdxBinaryOperator.Create(A.GetOperator, TdxOperandValue.Create(B),
...
class operator TdxLinqExpression.NotEqual(const A: TGUID;
  const B: TdxLinqExpression): TdxLinqExpression;
begin
  Result := TdxBinaryOperator.Create(TdxOperandValue.Create(A), B.GetOperator,
    TdxBinaryOperatorType.NotEqual);
...
class operator TdxLinqExpression.Positive(const A: TdxLinqExpression)
  : TdxLinqExpression;
begin
  Result := TdxUnaryOperator.Create(TdxUnaryOperatorType.Plus, A.GetOperator);
end;

class operator TdxLinqExpression.Subtract(const A, B: TdxLinqExpression)
  : TdxLinqExpression;
begin
  Result := TdxBinaryOperator.Create(A.GetOperator, B.GetOperator,
...
class function TdxLinqExpression.ToArray(const A: array of TdxLinqExpression)
...
class operator TdxLinqExpression.NotEqual(const A, B: TdxLinqExpression)
  : TdxLinqExpression;
begin
  Result := TdxBinaryOperator.Create(A.GetOperator, B.GetOperator,
    TdxBinaryOperatorType.NotEqual);
...
class operator TdxLinqExpression.In(const A: TdxLinqExpression;
  const B: array of TdxLinqExpression): TdxLinqExpression;
begin
...
begin
  Result := TdxUnaryOperator.Create(TdxUnaryOperatorType.IsNull,
    Self.GetOperator);
end;

class operator TdxLinqExpression.Add(const A, B: TdxLinqExpression)
  : TdxLinqExpression;
begin
  Result := TdxBinaryOperator.Create(A.GetOperator, B.GetOperator,
