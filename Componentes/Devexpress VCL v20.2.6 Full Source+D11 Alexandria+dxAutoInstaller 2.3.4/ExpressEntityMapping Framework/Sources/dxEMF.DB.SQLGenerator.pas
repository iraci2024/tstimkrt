...
type
  ...
  public
    ...
    constructor Create(ANode: TdxBaseStatement;
  ...
  type
    ...
    TComparer = class(TcxIUnknownObject,
      IEqualityComparer<TdxOuterApplyAggregateInfo>)
    public
      function Equals(const ALeft, ARight: TdxOuterApplyAggregateInfo): Boolean;
        reintroduce;
      function GetHashCode(const AValue: TdxOuterApplyAggregateInfo): Integer;
        reintroduce;
    end;
  ...
  public
    constructor Create(const AAlias: string; ATargetNode: TdxBaseStatement;
      const AFirstSqlBody: string);
    destructor Destroy; override;

    function GetAggregateAlias(AAggregateNode: TdxBaseStatement;
      AAggregateType: TdxAggregateFunctionType): string;
    function GenerateOuterApplySqlBody(AParentGenerator: TdxBaseSQLGenerator;
  ...
  public type
    ...
    TComparer = class(TInterfacedObject,
      IEqualityComparer<TdxOuterApplyCacheItem>)
    public
      function Equals(const ALeftItem, ARightItem: TdxOuterApplyCacheItem)
        : Boolean; reintroduce;
      function GetHashCode(const AValue: TdxOuterApplyCacheItem): Integer;
        reintroduce;
    end;
  ...
  TdxBaseSQLGenerator = class abstract(TcxIUnknownObject,
    IdxSQLGeneratorVisitor, IdxQuerySQLGeneratorVisitor)
  strict private
  const
  ...
  private
    ...
    function GetOuterApplyCache
      : TDictionary<TdxOuterApplyCacheItem, TdxOuterApplyInfo>; inline;
  protected
    FFormatter: TdxSQLConnectionProvider;
    class function GetNodeSingleProperty(ANode: TdxBaseStatement)
    ...
    function ProcessParameter(const AOperand: IdxCriteriaOperator;
      ANullOnNull: Boolean): string;
    ...
    function Visit(const AContainer: IdxQuerySubQueryContainer)
      : string; overload;
    function Visit(const AOperand: IdxQueryOperand): string; overload;
    class function FormatSubQuery(AAggregateFunctionType
      : TdxAggregateFunctionType; const ASubQuery: string): string;
      overload; static;
    class function FormatSubQuery(const ASubQuery: string; const AAlias: string)
      : string; overload; static;
    property OuterApplyResultCounter: Integer read FOuterApplyResultCounter;
    property OuterApplyCache
      : TDictionary<TdxOuterApplyCacheItem, TdxOuterApplyInfo>
      read GetOuterApplyCache;
  ...
  public
    ...
    function GetNextParameterName(const AParameter: IdxOperandValue): string;
      virtual; abstract;
  ...
  protected
    function CreateQuery(const ACommandText: string;
  ...
  public
    ...
    destructor Destroy; override;
    function GetNextParameterName(const AParameter: IdxOperandValue)
      : string; override;
  ...
  protected
    ...
    function PatchProperty(const APropertyOperator: IdxCriteriaOperator;
      const APropertyString: string): string; virtual;
  ...
  public
    ...
    constructor Create(const AFormatter: TdxSQLConnectionProvider;
      AParentGenerator: TdxBaseSQLGenerator;
      const APropertyAliases: TArray<string>); overload;
    destructor Destroy; override;
  ...
  public
    function GenerateSQL(const ADMLStatements: TArray<TdxModificationStatement>)
      : TdxQueryCollection; overload;
  end;
...
type
  ...
  strict private
  const
    AggregateClause: array [TdxAggregateFunctionType] of string = ('%s',
      'count(%s)', 'max(%s)', 'min(%s)', 'avg(%s)', 'sum(%s)', '');
  strict private
    FParentGenerator: TdxBaseSQLGenerator;
  ...
  protected
    ...
    function GetForceOuterApply: Boolean; override;
  public
    constructor Create(AParentGenerator: TdxBaseSQLGenerator;
      AFormatter: TdxSQLConnectionProvider;
      const AAggregateProperty: IdxCriteriaOperator;
      AAggregate: TdxAggregateFunctionType;
      AForceOuterApply: Boolean = False); overload;
    constructor Create(AParentGenerator: TdxBaseSQLGenerator;
      AFormatter: TdxSQLConnectionProvider;
      const AAggregateProperties: TArray<TdxSubSelectAggregateInfo>;
      AForceOuterApply: Boolean); overload;
    function GenerateSelect(ANode: TdxBaseStatement;
      ASubSelectUseOnly: Boolean): string;
    class function GetSelectValue(const AAggregateProperty: IdxCriteriaOperator;
      AAggregate: TdxAggregateFunctionType; AGenerator: TdxBaseSQLGenerator;
      const AAlias: string): string; overload; static;
  ...
  protected
    class function GetHashCode(const AInterface: IInterface): Integer;
      reintroduce; static;
  public
    class function PrepareCacheForConversion(ACompareCache
      : TdxOuterApplyCompareCache; AFrom, ATo: TdxJoinNode): Boolean;
      overload; static;
    class function PrepareCacheForConversion(ACompareCache
      : TdxOuterApplyCompareCache; AFromSubNodes: TdxJoinNodeCollection;
      AToSubNodes: TdxJoinNodeCollection): Boolean; overload; static;
    class function AreEquals(ACompareCache: TdxOuterApplyCompareCache;
      X, Y: TdxJoinNode; AOperateAsJoinNode: Boolean = False): Boolean;
      overload; static;
    class function AreEquals(ACompareCache: TdxOuterApplyCompareCache;
      ATable1, ATable2: TdxDBTable): Boolean; overload; static;
    class function AreEquals(ACompareCache: TdxOuterApplyCompareCache;
      X, Y: TdxJoinNodeCollection): Boolean; overload; static;
    class function GetHash(AObject: TdxJoinNode;
      AOperateAsJoinNode: Boolean = False): Integer; overload; static;
    class function GetHash(ADbProjection: TdxDBProjection): Integer;
      overload; static;
    class function GetHash(AObject: TdxJoinNodeCollection): Integer;
      overload; static;
  end;

  { TdxOuterApplyCacheCriteriaPreprocessor }

  TdxOuterApplyCacheCriteriaPreprocessor = class(TdxClientCriteriaVisitorBase,
    IdxQueryCriteriaOperatorVisitor)
  strict private
  ...
  public
    constructor Create(ACompareCache: TdxOuterApplyCompareCache;
      ACollectNodes: Boolean; AConvertNodes: Boolean);
    ...
    function Process(ASrcNode: TdxJoinNode; ADestNode: TdxJoinNode)
      : Boolean; overload;
    class function Preprocess(ACompareCache: TdxOuterApplyCompareCache;
      const ACriteria: IdxCriteriaOperator): IdxCriteriaOperator; static;
    class function Convert(ACompareCache: TdxOuterApplyCompareCache;
      const ACriteria: IdxCriteriaOperator): IdxCriteriaOperator; static;
    class function CollectNodes(ACompareCache: TdxOuterApplyCompareCache;
      const ACriteria: IdxCriteriaOperator): TdxJoinNodeCollection; static;
...
constructor TdxSubSelectAggregateInfo.Create(const AProperty
  : IdxCriteriaOperator; AAggregateType: TdxAggregateFunctionType;
  const AAlias: string);
begin
  &Property := AProperty;
...
constructor TdxSubSelectSQLGenerator.Create(AParentGenerator
  : TdxBaseSQLGenerator; AFormatter: TdxSQLConnectionProvider;
  const AAggregateProperty: IdxCriteriaOperator;
  AAggregate: TdxAggregateFunctionType; AForceOuterApply: Boolean);
var
...
function TdxSubSelectSQLGenerator.GenerateSelect(ANode: TdxBaseStatement;
  ASubSelectUseOnly: Boolean): string;
var
...
class function TdxSubSelectSQLGenerator.GetSelectValue(const AAggregateProperty
  : IdxCriteriaOperator; AAggregate: TdxAggregateFunctionType;
  AGenerator: TdxBaseSQLGenerator; const AAlias: string): string;
var
  AProperty: string;
begin
...
function TdxSubSelectSQLGenerator.GetSelectValue(ASubSelectUseOnly
  : Boolean): string;
var
...
begin
  ...
  try
    ...
    begin
      ...
      ASelectString.Append(GetSelectValue(FAggregateProperties[I].&Property,
        FAggregateProperties[I].AggregateType, Self, IfThen(ASubSelectUseOnly,
        '', FAggregateProperties[I].Alias)));
    end;
...
function TdxSubSelectSQLGenerator.GetNextParameterName(const AParameter
  : IdxOperandValue): string;
begin
...
function TdxOuterApplyCompareCache.GetCacheAliasName(const AAlias
  : string): string;
var
  AResult: string;
begin
...
procedure TdxOuterApplyCompareCache.AddNode(const ANodeAlias: string;
  const ANodeCacheAlias: string);
begin
...
class function TdxOuterApplyCacheCompareHelper.PrepareCacheForConversion
  (ACompareCache: TdxOuterApplyCompareCache; AFrom, ATo: TdxJoinNode): Boolean;
var
  ABaseFrom, ABaseTo: TdxBaseStatement;
  ASelectX, ASelectY: TdxSelectStatement;
  AFromConditionSubNodes, AToConditionSubNodes, AXGroupConditionSubNodes,
    AYGroupConditionSubNodes: TdxJoinNodeCollection;
...
begin
  ...
  if ((ABaseFrom = nil) and (ABaseTo <> nil)) or
    ((ABaseFrom <> nil) and (ABaseTo = nil)) then
    Exit(False);
  ASelectX := Safe<TdxSelectStatement>.Cast(AFrom);
  ASelectY := Safe<TdxSelectStatement>.Cast(ATo);
  if ((ASelectX = nil) and (ASelectY <> nil)) or
    ((ASelectX <> nil) and (ASelectY = nil)) then
    Exit(False);
  if (AFrom.&Type = ATo.&Type) and AreEquals(ACompareCache, AFrom.Table,
    ATo.Table) then
  begin
    ACompareCache.AddNode(AFrom.Alias, ATo.Alias);
    if not PrepareCacheForConversion(ACompareCache, AFrom.SubNodes, ATo.SubNodes)
    then
      Exit(False);
    AFromConditionSubNodes := TdxOuterApplyCacheCriteriaPreprocessor.
      CollectNodes(ACompareCache, AFrom.Condition);
    try
      AToConditionSubNodes := TdxOuterApplyCacheCriteriaPreprocessor.
        CollectNodes(ACompareCache, ATo.Condition);
      try
        if not PrepareCacheForConversion(ACompareCache, AFromConditionSubNodes,
          AToConditionSubNodes) then
          Exit(False);
      finally
    ...
    begin
      ...
      begin
        AXOperandsSubNodes := TdxOuterApplyCacheCriteriaPreprocessor.
          CollectNodes(ACompareCache, ABaseFrom.Operands[I]);
        AYOperandsSubNodes := TdxOuterApplyCacheCriteriaPreprocessor.
          CollectNodes(ACompareCache, ABaseTo.Operands[I]);
        try
          if not PrepareCacheForConversion(ACompareCache, AXOperandsSubNodes,
            AYOperandsSubNodes) then
            Exit(False);
        finally
      ...
      begin
        if (ASelectX.TopSelectedRecords <> ASelectY.TopSelectedRecords) or
          (ASelectX.SkipSelectedRecords <> ASelectY.SkipSelectedRecords) then
          Exit(False);
        AXGroupConditionSubNodes := TdxOuterApplyCacheCriteriaPreprocessor.
          CollectNodes(ACompareCache, ASelectX.GroupCondition);
        try
          AYGroupConditionSubNodes := TdxOuterApplyCacheCriteriaPreprocessor.
            CollectNodes(ACompareCache, ASelectY.GroupCondition);
          try
            if not PrepareCacheForConversion(ACompareCache,
              AXGroupConditionSubNodes, AYGroupConditionSubNodes) then
              Exit(False);
          finally
        ...
        begin
          AYOperandsSubNodes := nil;
          AXOperandsSubNodes := TdxOuterApplyCacheCriteriaPreprocessor.
            CollectNodes(ACompareCache, ASelectX.GroupProperties[I]);
          AYOperandsSubNodes := TdxOuterApplyCacheCriteriaPreprocessor.
            CollectNodes(ACompareCache, ASelectY.GroupProperties[I]);
          try
            if not PrepareCacheForConversion(ACompareCache, AXOperandsSubNodes,
              AYOperandsSubNodes) then
              Exit(False);
        ...
        begin
          AYOperandsSubNodes := nil;
          AXOperandsSubNodes := TdxOuterApplyCacheCriteriaPreprocessor.
            CollectNodes(ACompareCache, ASelectX.SortProperties[I].&Property);
          AYOperandsSubNodes := TdxOuterApplyCacheCriteriaPreprocessor.
            CollectNodes(ACompareCache, ASelectY.SortProperties[I].&Property);
          try
            if not PrepareCacheForConversion(ACompareCache, AXOperandsSubNodes,
              AYOperandsSubNodes) then
              Exit(False);
...
class function TdxOuterApplyCacheCompareHelper.PrepareCacheForConversion
  (ACompareCache: TdxOuterApplyCompareCache;
  AFromSubNodes: TdxJoinNodeCollection;
  AToSubNodes: TdxJoinNodeCollection): Boolean;
var
  I: Integer;
begin
  if AFromSubNodes <> AToSubNodes then
  begin
    if (AFromSubNodes = nil) or (AToSubNodes = nil) or
      (AFromSubNodes.Count <> AToSubNodes.Count) then
      Exit(False);
    for I := 0 to AFromSubNodes.Count - 1 do
      if not PrepareCacheForConversion(ACompareCache, AFromSubNodes[I],
        AToSubNodes[I]) then
        Exit(False);
  end;
  Result := True;
...
class function TdxOuterApplyCacheCompareHelper.AreEquals(ACompareCache
  : TdxOuterApplyCompareCache; X, Y: TdxJoinNode;
  AOperateAsJoinNode: Boolean): Boolean;
var
  ...
  AXConditionSubNodes, AYConditionSubNodes, AXOperandsSubNodes,
    AYOperandsSubNodes: TdxJoinNodeCollection;
  AOperandsCount, I, APropertiesCount, ASortPropertiesCount: Integer;
begin
  if X = Y then
    Exit(True);
  ...
  if (((ABaseX = nil) and (ABaseY <> nil))) or
    (((ABaseX <> nil) and (ABaseY = nil))) then
    Exit(False);
  ...
  if ((ASelectX = nil) and (ASelectY <> nil)) or
    ((ASelectX <> nil) and (ASelectY = nil)) then
    Exit(False);
  if not((X.&Type = Y.&Type) and AreEquals(ACompareCache, X.Table, Y.Table))
  then
    Exit(False);
  ...
  if not AreEquals(ACompareCache, X.SubNodes, Y.SubNodes) then
    Exit(False);
  AXConditionSubNodes := TdxOuterApplyCacheCriteriaPreprocessor.CollectNodes
    (ACompareCache, X.Condition);
  try
    AYConditionSubNodes := TdxOuterApplyCacheCriteriaPreprocessor.CollectNodes
      (ACompareCache, Y.Condition);
    try
      if (not AreEquals(ACompareCache, AXConditionSubNodes, AYConditionSubNodes)
        ) or (TdxOuterApplyCacheCriteriaPreprocessor.Preprocess(ACompareCache,
        X.Condition) <> TdxOuterApplyCacheCriteriaPreprocessor.Preprocess
        (ACompareCache, Y.Condition)) then
        Exit(False);
    finally
  ...
  begin
    ...
    for I := 0 to AOperandsCount - 1 do
    begin
      AXOperandsSubNodes := TdxOuterApplyCacheCriteriaPreprocessor.CollectNodes
        (ACompareCache, ABaseX.Operands[I]);
      try
        AYOperandsSubNodes := TdxOuterApplyCacheCriteriaPreprocessor.
          CollectNodes(ACompareCache, ABaseY.Operands[I]);
        try
          if (not AreEquals(ACompareCache, AXOperandsSubNodes,
            AYOperandsSubNodes)) or
            (TdxOuterApplyCacheCriteriaPreprocessor.Preprocess(ACompareCache,
            ABaseX.Operands[I]) <> TdxOuterApplyCacheCriteriaPreprocessor.
            Preprocess(ACompareCache, ABaseY.Operands[I])) then
            Exit(False);
        finally
          AYOperandsSubNodes.Free;
        end;
    ...
    begin
      ...
      try
        AYGroupConditionSubNodes := TdxOuterApplyCacheCriteriaPreprocessor.
          CollectNodes(ACompareCache, ASelectY.GroupCondition);
        try
          if (not AreEquals(ACompareCache, AXGroupConditionSubNodes,
            AYGroupConditionSubNodes)) or
            (TdxOuterApplyCacheCriteriaPreprocessor.Preprocess(ACompareCache,
            ASelectX.GroupCondition) <> TdxOuterApplyCacheCriteriaPreprocessor.
            Preprocess(ACompareCache, ASelectY.GroupCondition)) then
            Exit(False);
        finally
          AYGroupConditionSubNodes.Free;
        end;
        ...
        try
          ...
          try
            if (not AreEquals(ACompareCache, AXOperandsSubNodes,
              AYOperandsSubNodes)) or
              (TdxOuterApplyCacheCriteriaPreprocessor.Preprocess(ACompareCache,
              ASelectX.GroupProperties[I]) <>
              TdxOuterApplyCacheCriteriaPreprocessor.Preprocess(ACompareCache,
              ASelectY.GroupProperties[I])) then
              Exit(False);
          finally
            AYOperandsSubNodes.Free;
          end;
      ...
      begin
        ...
        try
          ...
          try
            if (not AreEquals(ACompareCache, AXOperandsSubNodes,
              AYOperandsSubNodes)) or
              (ASelectX.SortProperties[I].SortDirection <>
              ASelectY.SortProperties[I].SortDirection) or
              (TdxOuterApplyCacheCriteriaPreprocessor.Preprocess(ACompareCache,
              ASelectX.SortProperties[I].&Property) <>
              TdxOuterApplyCacheCriteriaPreprocessor.Preprocess(ACompareCache,
              ASelectY.SortProperties[I].&Property)) then
              Exit(False);
          finally
            AYOperandsSubNodes.Free;
          end;
...
class function TdxOuterApplyCacheCompareHelper.AreEquals(ACompareCache
  : TdxOuterApplyCompareCache; ATable1: TdxDBTable;
  ATable2: TdxDBTable): Boolean;
var
...
begin
  ...
  if (AProjection1 = nil) or (AProjection2 = nil) or
    (AProjection1.Columns.Count <> AProjection2.Columns.Count) then
    Exit(False);
  ...
  Result := AreEquals(ACompareCache, AProjection1.Projection,
    AProjection2.Projection);
end;

class function TdxOuterApplyCacheCompareHelper.GetHashCode(const AInterface
  : IInterface): Integer;
begin
...
class function TdxOuterApplyCacheCompareHelper.GetHash(AObject: TdxJoinNode;
  AOperateAsJoinNode: Boolean): Integer;
var
  AHash, I: Integer;
...
begin
  ...
  else if AObject.Table <> nil then
    AHash := AHash xor AObject.Table.GetHashCode;
  AHash := AHash xor GetHash(AObject.SubNodes);
  AJoinNodes := TdxOuterApplyCacheCriteriaPreprocessor.CollectNodes(nil,
    AObject.Condition);
  try
  ...
  AHash := AHash xor
    (GetHashCode(TdxOuterApplyCacheCriteriaPreprocessor.Preprocess(nil,
    AObject.Condition))) xor Integer(AObject.&Type);
  ...
  begin
    AJoinNodes := TdxOuterApplyCacheCriteriaPreprocessor.CollectNodes(nil,
      ABaseStatement.Operands[I]);
    try
      AHash := AHash xor GetHash(AJoinNodes);
    finally
      AJoinNodes.Free;
    end;
    AHash := AHash xor GetHashCode
      (TdxOuterApplyCacheCriteriaPreprocessor.Preprocess(nil,
      ABaseStatement.Operands[I]));
  end;
  ...
  begin
    ...
    for AOperand in ASelectStatement.GroupProperties do
      AHash := AHash xor GetHashCode
        (TdxOuterApplyCacheCriteriaPreprocessor.Preprocess(nil, AOperand));
  end;
  ...
  begin
    ...
    for ASortingColumn in ASelectStatement.SortProperties do
      AHash := AHash xor GetHashCode
        (TdxOuterApplyCacheCriteriaPreprocessor.Preprocess(nil,
        ASortingColumn.&Property)) xor Integer(ASortingColumn.SortDirection);
  end;
  AHash := AHash xor GetHashCode
    (TdxOuterApplyCacheCriteriaPreprocessor.Preprocess(nil,
    ASelectStatement.GroupCondition));
  Result := AHash xor ASelectStatement.SkipSelectedRecords xor ASelectStatement.
    TopSelectedRecords;
end;

class function TdxOuterApplyCacheCompareHelper.GetHash(ADbProjection
  : TdxDBProjection): Integer;
var
  AHash: Integer;
  AColumn: TdxDBColumn;
begin
  if ADbProjection = nil then
    Exit($78422058);
  AHash := (GetValueHash(ADbProjection.Name))
    xor (GetHash(ADbProjection.Projection));
...
class function TdxOuterApplyCacheCompareHelper.AreEquals(ACompareCache
  : TdxOuterApplyCompareCache; X, Y: TdxJoinNodeCollection): Boolean;
var
  I: Integer;
begin
  if X = Y then
...
class function TdxOuterApplyCacheCompareHelper.GetHash
  (AObject: TdxJoinNodeCollection): Integer;
var
  O: TdxJoinNode;
begin
  Result := $1259321;
...
constructor TdxOuterApplyCacheCriteriaPreprocessor.Create
  (ACompareCache: TdxOuterApplyCompareCache; ACollectNodes: Boolean;
  AConvertNodes: Boolean);
begin
  inherited Create;
  FSubNodes := nil;
...
function TdxOuterApplyCacheCriteriaPreprocessor.Visit(const AOperand
  : IdxQueryOperand): IdxCriteriaOperator;
var
...
begin
  ...
  if FCache = nil then
    Exit(TdxQueryOperand.Create(AOperand.ColumnName, '', AOperand.ColumnType,
      ACriteria));
  ACacheAliasName := FCache.GetCacheAliasName(AOperand.NodeAlias);
  if ACacheAliasName = AOperand.NodeAlias then
    Result := AOperand
  else
    Result := TdxQueryOperand.Create(AOperand.ColumnName, ACacheAliasName,
      AOperand.ColumnType, ACriteria);
end;

function TdxOuterApplyCacheCriteriaPreprocessor.Visit(const AOperand
  : IdxQuerySubQueryContainer): IdxCriteriaOperator;
var
...
begin
  ...
  if not FConvertNodes then
    Exit(TdxQuerySubQueryContainer.Create(nil, AAggregateProperty,
      AOperand.AggregateFunctionType));
  ANode := Process(AOperand.Node);
  if (ANode = AOperand.Node) and
    (AAggregateProperty = AOperand.AggregateProperty) then
    Result := AOperand
  else
    Result := TdxQuerySubQueryContainer.Create(ANode, AAggregateProperty,
      AOperand.AggregateFunctionType);
end;

function TdxOuterApplyCacheCriteriaPreprocessor.Process(ANode: TdxBaseStatement)
  : TdxBaseStatement;
var
...
function TdxOuterApplyCacheCriteriaPreprocessor.Process(ASrcNode: TdxJoinNode)
  : TdxJoinNode;
var
...
function TdxOuterApplyCacheCriteriaPreprocessor.Process(ASrcNode,
  ADestNode: TdxJoinNode): Boolean;
var
  AHasModifications: Boolean;
...
begin
  ...
  Result := AHasModifications or (ADestNode.Alias <> ASrcNode.Alias) or
    (ADestNode.Condition <> ASrcNode.Condition) or
    (ADestNode.&Type <> ASrcNode.&Type);
end;

class function TdxOuterApplyCacheCriteriaPreprocessor.Preprocess
  (ACompareCache: TdxOuterApplyCompareCache;
  const ACriteria: IdxCriteriaOperator): IdxCriteriaOperator;
var
  APreprocessor: TdxOuterApplyCacheCriteriaPreprocessor;
begin
  APreprocessor := TdxOuterApplyCacheCriteriaPreprocessor.Create(ACompareCache,
    False, False);
  try
...
class function TdxOuterApplyCacheCriteriaPreprocessor.Convert
  (ACompareCache: TdxOuterApplyCompareCache;
  const ACriteria: IdxCriteriaOperator): IdxCriteriaOperator;
var
  APreprocessor: TdxOuterApplyCacheCriteriaPreprocessor;
...
class function TdxOuterApplyCacheCriteriaPreprocessor.CollectNodes
  (ACompareCache: TdxOuterApplyCompareCache;
...
constructor TdxOuterApplyAggregateInfo.Create(ANode: TdxBaseStatement;
  AType: TdxAggregateFunctionType);
begin
  Node := ANode;
  &Type := AType;
...
function TdxOuterApplyInfo.TComparer.Equals(const ALeft,
  ARight: TdxOuterApplyAggregateInfo): Boolean;
begin
  Result := (ALeft.&Type = ARight.&Type) and
    TdxOuterApplyCacheCompareHelper.AreEquals(TdxOuterApplyCompareCache.Create,
    ALeft.Node, ARight.Node);
end;

function TdxOuterApplyInfo.TComparer.GetHashCode(const AValue
  : TdxOuterApplyAggregateInfo): Integer;
begin
  Result := TdxOuterApplyCacheCompareHelper.GetHash(AValue.Node)
    xor Integer(AValue.&Type);
end;

{ TdxOuterApplyInfo }

constructor TdxOuterApplyInfo.Create(const AAlias: string;
  ATargetNode: TdxBaseStatement; const AFirstSqlBody: string);
begin
  inherited Create;
  if FComparer = nil then
    FComparer := TComparer.Create;
  FAggregates := TDictionary<TdxOuterApplyAggregateInfo, string>.Create
    (FComparer);
  FAlias := AAlias;
...
function TdxOuterApplyInfo.GetAggregateAlias(AAggregateNode: TdxBaseStatement;
  AAggregateType: TdxAggregateFunctionType): string;
var
  APropertyInfo: TdxOuterApplyAggregateInfo;
  AAlias: string;
begin
  APropertyInfo := TdxOuterApplyAggregateInfo.Create(AAggregateNode,
    AAggregateType);
...
function TdxOuterApplyInfo.GenerateOuterApplySqlBody(AParentGenerator
  : TdxBaseSQLGenerator; AFormatter: TdxSQLConnectionProvider): string;
var
...
begin
  ...
  begin
    AAggregateProperty := TdxBaseSQLGenerator.GetNodeSingleProperty
      (AItem.Key.Node);
    if AAggregateProperty <> nil then
    begin
      ACache := TdxOuterApplyCompareCache.Create;
      try
        TdxOuterApplyCacheCompareHelper.PrepareCacheForConversion(ACache,
          AItem.Key.Node, FTargetNode);
        AAggregateProperty := TdxOuterApplyCacheCriteriaPreprocessor.Convert
          (ACache, AAggregateProperty);
      finally
        ACache.Free;
      end;
    end;
    ASubSelectAggregateInfos[I] := TdxSubSelectAggregateInfo.Create
      (AAggregateProperty, AItem.Key.&Type, AItem.Value);
    Inc(I);
  end;
  ASubSelectSqlGenerator := TdxSubSelectSQLGenerator.Create(AParentGenerator,
    AFormatter, ASubSelectAggregateInfos, True);
  try
...
constructor TdxOuterApplyCacheItem.Create(ANode: TdxJoinNode;
  AOperateAsJoinNode: Boolean);
begin
  FNode := ANode;
...
function TdxOuterApplyCacheItem.Equals(const AValue
  : TdxOuterApplyCacheItem): Boolean;
begin
  Result := TdxOuterApplyCacheCompareHelper.AreEquals
    (TdxOuterApplyCompareCache.Create, Node, AValue.Node, FOperateAsJoinNode);
end;

{ TdxOuterApplyCacheItem.TComparer }

function TdxOuterApplyCacheItem.TComparer.Equals(const ALeftItem,
  ARightItem: TdxOuterApplyCacheItem): Boolean;
begin
  Result := ALeftItem.Equals(ARightItem);
end;

function TdxOuterApplyCacheItem.TComparer.GetHashCode
  (const AValue: TdxOuterApplyCacheItem): Integer;
begin
  Result := AValue.Hash;
end;
...
constructor TdxBaseSQLGenerator.Create(const AFormatter
...
function TdxBaseSQLGenerator.GetOuterApplyCache
  : TDictionary<TdxOuterApplyCacheItem, TdxOuterApplyInfo>;
begin
  if FOuterApplyCache = nil then
    FOuterApplyCache := TDictionary<TdxOuterApplyCacheItem, TdxOuterApplyInfo>.
      Create(TdxOuterApplyCacheItem.TComparer.Create);
...
function TdxBaseSQLGenerator.ProcessParameter(const AOperand
  : IdxCriteriaOperator; ANullOnNull: Boolean): string;
begin
...
function TdxBaseSQLGenerator.Process(const AOperand
...
class function TdxBaseSQLGenerator.GetNodeSingleProperty
  (ANode: TdxBaseStatement): IdxCriteriaOperator;
begin
...
procedure TdxBaseSQLGenerator.AppendJoinNode(ANode: TdxJoinNode;
  AJoins: TStringBuilder);
var
...
begin
  ...
  begin
    AGenerator := TdxSelectSQLGenerator.Create(FFormatter, Self,
      AProjection.Columns.GetNames);
    try
    ...
    AJoins.Append(FFormatter.FormatTable(FFormatter.ComposeSafeSchemaName
      (ANode.Table.Name), FFormatter.ComposeSafeTableName(ANode.Table.Name),
      ANode.Alias));
  AJoins.Append(' on ');
  AOnStatement := Process(ANode.Condition);
  if AOnStatement = '' then
    AOnStatement := Process(TdxBinaryOperator.Create(TdxConstantValue.Create(1),
      TdxConstantValue.Create(1), TdxBinaryOperatorType.Equal));
...
begin
  ...
  begin
    ...
    FJoins.Append(FFormatter.FormatTable(FFormatter.ComposeSafeSchemaName
      (Root.Table.Name), FFormatter.ComposeSafeTableName(Root.Table.Name),
      Root.Alias));
    ...
    begin
      ...
      try
        for AOuterApply in OuterApplyCache.Values do
          AResult.Append(#10)
            .Append(FFormatter.FormatOuterApply
            (AOuterApply.GenerateOuterApplySqlBody(Self, FFormatter),
            AOuterApply.Alias)).Append(' ');
        AResult.Append(#10);
...
begin
  if AOperand.NodeAlias = '' then
    Result := FFormatter.FormatColumn
      (FFormatter.ComposeSafeColumnName(AOperand.ColumnName))
  else
    Result := FFormatter.FormatColumn
      (FFormatter.ComposeSafeColumnName(AOperand.ColumnName),
      AOperand.NodeAlias);
...
begin
  Result := Process(TdxGroupOperator.And
    (TdxBinaryOperator.Create(AOperator.BeginExpression,
    AOperator.TestExpression, TdxBinaryOperatorType.LessOrEqual),
    TdxBinaryOperator.Create(AOperator.TestExpression, AOperator.EndExpression,
    TdxBinaryOperatorType.LessOrEqual)) as TdxCriteriaOperator);
end;

function TdxBaseSQLGenerator.Visit(const AOperator: IdxBinaryOperator): string;
begin
  Result := FFormatter.FormatBinary(AOperator.OperatorType,
...
begin
  Result := FFormatter.FormatUnary(AOperator.OperatorType,
    Process(AOperator.Operand as TdxCriteriaOperator));
end;

function TdxBaseSQLGenerator.Visit(const AOperator
  : IdxFunctionOperator): string;
var
...
begin
  ...
  begin
    ...
    Exit(Process(TdxConstantValue.Create(TdxEvalHelpers.EvaluateLocalDateTime
  ...
  begin
    ...
    if AOperator.OperatorType in [TdxFunctionOperatorType.Custom,
      TdxFunctionOperatorType.CustomNonDeterministic] then
    begin
      if (Length(AOperands) < 1) or
        (not(AOperator.Operands[0] is TdxOperandValue)) or
        (not((TdxOperandValue(AOperator.Operands[0])).Value.IsString)) then
        raise Exception.Create('');
      AOperands[0] := (TdxOperandValue(AOperator.Operands[0])).Value;
    end;
    Result := FFormatter.FormatFunction(Process, AOperator.OperatorType,
      AOperands);
  end
  else
  begin
    ...
    begin
      I := 1;
      if (Length(AStringOperands) < 1) or
        (not(AOperator.Operands[0] is TdxOperandValue)) or
        (not(TdxOperandValue(AOperator.Operands[0])).Value.IsString) then
        raise Exception.Create('');
      AStringOperands[0] := TdxOperandValue(AOperator.Operands[0])
        .Value.AsString;
    end
    else
      I := 0;
    ...
    Result := FFormatter.FormatFunction(AOperator.OperatorType,
      AStringOperands);
  end;
end;

function TdxBaseSQLGenerator.Visit(const AContainer
  : IdxQuerySubQueryContainer): string;
var
...
begin
  ...
  begin
    ...
    try
      Exit(TdxSubSelectSQLGenerator.GetSelectValue(AContainer.AggregateProperty,
        AContainer.AggregateFunctionType, Self, ''));
    finally
      FOuterApplyResultCounter := AMemOuterApplyResultCounter;
      FInTopLevelAggregate := False;
    end;
  end;
  AIsExists := AContainer.AggregateFunctionType =
  ...
  begin
    ...
    begin
      ...
      begin
        AOuterGena := TdxSubSelectSQLGenerator.Create(Self, FFormatter, AProp,
          AContainer.AggregateFunctionType, not AIsExists);
        try
          ASubQuery := AOuterGena.GenerateSelect(AContainer.Node, False);
          if (not AOuterGena.HasSubQuery and not(IsSubQuery and not AIsExists))
            and not ForceOuterApply then
        ...
        if AIsExists then
          ASubQuery := '';
        AInfo := TdxOuterApplyInfo.Create(GetNextOuterApplyAlias,
          AContainer.Node, ASubQuery);
      ...
      APropertyAlias := AInfo.GetAggregateAlias(AContainer.Node,
        AAggregateType);
      if AIsExists then
  ...
  ASubSelectSqlGenerator := TdxSubSelectSQLGenerator.Create(Self, FFormatter,
    AProp, AContainer.AggregateFunctionType, not AIsExists);
  try
    Result := FormatSubQuery(AContainer.AggregateFunctionType,
      ASubSelectSqlGenerator.GenerateSelect(AContainer.Node, True));
  finally
    ASubSelectSqlGenerator.Free;
  end;
end;

class function TdxBaseSQLGenerator.FormatSubQuery(AAggregateFunctionType
  : TdxAggregateFunctionType; const ASubQuery: string): string;
begin
  Result := Format('%s(%s)',
    [IfThen(AAggregateFunctionType = TdxAggregateFunctionType.Exists, 'exists'),
    ASubQuery]);
end;

class function TdxBaseSQLGenerator.FormatSubQuery(const ASubQuery: string;
...
constructor TdxBaseSQLGeneratorWithParameters.Create(const AFormatter
  : TdxSQLConnectionProvider; AIdentitiesByTag: TdxTaggedParameterHolder);
begin
  inherited Create(AFormatter);
...
function TdxBaseSQLGeneratorWithParameters.GetNextParameterName(const AParameter
  : IdxOperandValue): string;
var
  AName: string;
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        AName := FFormatter.GetParameterName(AConsolidateParameter,
          FParameters.Count, ACreateParameter);
    ...
    begin
      ACreateParameter := True;
      AName := FFormatter.GetParameterName(AConsolidateParameter,
        FQueryParameters.Count, ACreateParameter);
      if ACreateParameter then
      begin
        FQueryParameters.Add(AConsolidateParameter);
        FQueryParameterNames.Add(AName);
...
function TdxBaseSQLGeneratorWithParameters.CreateQuery(const ACommandText
  : string; AParameters: TdxQueryParameterCollection;
  const AParameterNames: TArray<string>): TdxQuery;
begin
  Result := TdxQuery.Create(ACommandText, AParameters, AParameterNames);
end;

function TdxBaseSQLGeneratorWithParameters.GenerateSQL(ANode: TdxBaseStatement)
  : TdxQuery;
var
  ACommandText: string;
begin
  ...
  Result := CreateQuery(ACommandText, FQueryParameters,
    FQueryParameterNames.ToArray);
end;

{ TdxSelectSQLGenerator }

constructor TdxSelectSQLGenerator.Create(const AFormatter
  : TdxSQLConnectionProvider);
begin
...
constructor TdxSelectSQLGenerator.Create(const AFormatter
  : TdxSQLConnectionProvider; AParentGenerator: TdxBaseSQLGenerator;
  const APropertyAliases: TArray<string>);
begin
  Create(AFormatter);
  FParentGenerator := AParentGenerator;
...
begin
  ...
  try
    ...
    begin
      ...
      while J < I do
      begin
        if (ASortProperties{$IFDEF DELPHIXE3}.List{$ENDIF}[J]
          .&Property as TdxCriteriaOperator)
          .Equals(ASp.&Property as TdxCriteriaOperator) then
          Break;
        Inc(J);
      end;
      if J < I then
        Continue;
      AList.Append(FFormatter.FormatOrder(Process(ASp.&Property),
        ASp.SortDirection)).Append(',');
    end;
...
begin
  if ((FOAProperties <> nil) and (FGroupProperties <> nil)) and UseOuterApply
  then
  begin
    AResult := TStringBuilder.Create;
    try
...
function TdxSelectSQLGenerator.PatchProperty(const APropertyOperator
  : IdxCriteriaOperator; const APropertyString: string): string;
begin
      ...
      begin
        ...
        begin
          ...
          begin
            ...
            if (APropertyAlias = '') and
              (APropertyAlias <> AQueryOperand.ColumnName) then
              AAlias := AQueryOperand.ColumnName
            else
              AAlias := APropertyAlias;
          end;
          AList.Append(FFormatter.FormatColumn(FFormatter.ComposeSafeColumnName
            (AAlias)));
        end;
...
var
  ...
  AGroupByClause, APropertiesSQL, AWhereClause, AHavingClause,
    AOrderByClause: string;
...
begin
  ...
  begin
    ...
    if ASkipFormatter then
      Exit(FFormatter.FormatSelect(APropertiesSQL, AFromClause.ToString,
        AWhereClause, AOrderByClause, AGroupByClause, AHavingClause,
        ASkipSelectedRecords, ATopSelectedRecords))
    else if ATopSelectedRecords <> 0 then
    begin
  ...
  Result := FFormatter.FormatSelect(APropertiesSQL, AFromClause.ToString,
    AWhereClause, AOrderByClause, AGroupByClause, AHavingClause,
    ATopSelectedRecords);
end;

function TdxSelectSQLGenerator.CreateQuery(const ACommandText: string;
  AParameters: TdxQueryParameterCollection;
  const AParameterNames: TArray<string>): TdxQuery;
begin
  Result := TdxQuery.Create(ACommandText, AParameters, AParameterNames,
    SkipSelectedRecords, TopSelectedRecords, FConstantValues, FOperandIndexes);
end;

function TdxSelectSQLGenerator.GetNextParameterName(const AParameter
  : IdxOperandValue): string;
begin
...
function TdxBaseObjectSQLGenerator.GenerateSQL(const ADMLStatements
  : TArray<TdxModificationStatement>): TdxQueryCollection;
var
...
begin
  ...
  Result := FFormatter.FormatDelete(FFormatter.FormatTableSafe(Root.Table),
    BuildCriteria);
end;
...
begin
  ...
  try
    ...
    begin
      if I > 0 then
        AValues.Append(',');
      AValues.Append(Process(Root.Operands[I])).Append('=')
        .Append(GetNextParameterName((TdxUpdateStatement(Root)).Parameters[I]));
    end;
    Result := FFormatter.FormatUpdate(FFormatter.FormatTableSafe(Root.Table),
      AValues.ToString, BuildCriteria);
  finally
    AValues.Free;
  end;
end;
...
begin
  ...
  try
    ...
    begin
      ...
      AValues.Append(GetNextParameterName((TdxInsertStatement(Root))
        .Parameters[I]));
    end;
    Result := FFormatter.FormatInsert(FFormatter.FormatTableSafe(Root.Table),
