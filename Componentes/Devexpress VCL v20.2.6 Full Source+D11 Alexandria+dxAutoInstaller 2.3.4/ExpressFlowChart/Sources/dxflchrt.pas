...
{$IFDEF DELPHI16}
  System.UITypes,
{$ENDIF}
  Types, SysUtils, Classes, Windows, Graphics, Messages, StdCtrls, Forms,
  ImgList, Controls,
  Generics.Defaults, Generics.Collections,
  dxCore, dxCoreClasses, dxCoreGraphics, dxGDIPlusAPI, dxGDIPlusClasses,
  dxLines, cxGeometry, cxControls, cxGraphics, cxLookAndFeels,
  cxLookAndFeelPainters, dxTouch, dxForms, cxTextEdit, dxScrollAnimation,
...
type
  ...
  TdxFcaType = (fcaNone, fcaArrow, fcaEllipse, fcaRectangle, fcaClosedASMEarrow,
    fcaFilledASMEarrow, fcaClosedArrow, fcaFilledArrow, fcaIndentedClosedArrow,
    fcaIndentedFilledArrow, fcaOutdentedClosedArrow, fcaOutdentedFilledArrow,
    fcaClosedDoubleArrow, fcaFilledDoubleArrow, fcaDiamond, fcaFilledDiamond,
    fcaClosedDiamond, fcaFilledClosedDiamond, fcaDimensionLine, fcaBackslash,
    fcaOpenOneDash, fcaOpenTwoDash, fcaOpenThreeDash, fcaClosedOneDash,
    fcaClosedTwoDash, fcaClosedThreeDash, fcaFilledOneDash, fcaFilledTwoDash,
    fcaFilledThreeDash);

  TdxFcaSize = (fcasCustom, fcasSmall, fcasMedium, fcasLarge, fcasExtraLarge,
    fcasHuge);
  ...
  TdxFcHitTest = set of (htNowhere, htByObject, htOnObject, htOnConnection,
    htOnConLabel, htOnArrowSrc, htOnArrowDst, htOnSelPoint, htOnRotateMark,
    htOnParameter);
  ...
  TdxFcAllowEvent = procedure(Sender: TdxCustomFlowChart; Item: TdxFcItem;
  ...
  public
    ...
    property DefaultDrawText: Boolean read FDefaultDrawText
      write FDefaultDrawText;
    property DefaultDrawImage: Boolean read FDefaultDrawImage
      write FDefaultDrawImage;
  ...
  TdxFcDrawExEvent = procedure(Sender: TdxCustomFlowChart; AObject: TdxFcObject;
    ACanvas: TdxGPCanvas; APaintData: TdxFcDrawExEventPaintData) of object;
  ...
  protected
    class function FindAllUnions(AChart: TdxFlowChart; FromUnion: TdxFcObject)
      : TdxFcObject; static;
    class function FindUnions(AChart: TdxFlowChart; FromUnion, Obj: TdxFcObject)
      : TdxFcObject; static;
    class function GetNumberByUnion(AChart: TdxFlowChart; Obj: TdxFcObject)
      : Integer; static;
    class function IsChildItemInUnion(AChart: TdxFlowChart; Obj: TdxFcObject)
      : Boolean; static;
  end;
  ...
  public
    constructor Create(AOwner: TdxFlowChartGridOptions; AColor: TColor;
      AStyle: TPenStyle);
  ...
  protected
    ...
    function CreateLines(AColor: TColor; AStyle: TPenStyle)
      : TdxFlowChartGridLineOptions; virtual;
    function GetOwner: TPersistent; override;
    // paint
  ...
  public
    ...
    procedure Assign(Source: TPersistent); override;
  published
    property MajorLines: TdxFlowChartGridLineOptions read FMajorLines
      write SetMajorLines stored IsMajorLinesStored;
    property MinorLines: TdxFlowChartGridLineOptions read FMinorLines
      write SetMinorLines stored IsMinorLinesStored;
    property MinorLineStep: Integer read FMinorLineStep write SetMinorLineStep
      default DefaultMinorLineStep;
    property MinZoomThresholdForMinorLines: Integer
      read FMinZoomThresholdForMinorLines write SetMinZoomThresholdForMinorLines
      default DefaultMinZoomThresholdForMinorLines;
    property OriginLines: TdxFlowChartGridLineOptions read FOriginLines
      write SetOriginLines stored IsOriginLinesStored;
  ...
  strict private
    ...
    procedure PreparePen(ACanvas: TcxCanvas; AColor: TColor; AStyle: TPenStyle;
      AWidth: Integer);
  strict protected
    procedure DrawHorizontalLines(ACanvas: TcxCanvas;
      const AClientBounds: TRect; AEdgeSize, AGridSize: Integer;
      AIsMajorLines: Boolean; AScaleFactor: TdxScaleFactor);
    procedure DrawVerticalLines(ACanvas: TcxCanvas; const AClientBounds: TRect;
      AEdgeSize, AGridSize: Integer; AIsMajorLines: Boolean;
      AScaleFactor: TdxScaleFactor);
    procedure DrawGridOrigin(ACanvas: TcxCanvas; const AClientBounds: TRect;
      const AOrigin: TPoint);
  public
    procedure DrawEdge(ACanvas: TcxCanvas; const R: TRect;
      AEdgeStyle, ABorderStyle: Cardinal); virtual;
    procedure DrawEllipse(ACanvas: TcxCanvas; const R: TRect;
      ABackgroundColor: TColor; AFrameColor: TColor; AFrameStyle: TPenStyle;
      AFrameWidth: Integer); virtual;
    procedure DrawGrid(ACanvas: TcxCanvas; const AClientBounds: TRect;
      AGridOptions: TdxFlowChartGridOptions); virtual;
    ...
    procedure DrawPolyline(ACanvas: TcxCanvas; const P: array of TPoint;
      AColor: TColor; AStyle: TPenStyle; AWidth: Integer); overload; virtual;
    procedure DrawRectangle(ACanvas: TcxCanvas; const R: TRect;
      ABackgroundColor: TColor; AFrameColor: TColor; AFrameStyle: TPenStyle;
      AFrameWidth: Integer); virtual;
    procedure DrawRegion(ACanvas: TcxCanvas; ARegionHandle: TcxRegionHandle;
      ABackgroundColor: TColor; AFrameColor: TColor;
      AFrameWidth: Integer); virtual;
    procedure DrawRoundRect(ACanvas: TcxCanvas; const R: TRect;
      ABackgroundColor: TColor; AFrameColor: TColor; AFrameStyle: TPenStyle;
      AFrameWidth, ARadiusX, ARadiusY: Integer); virtual;
    // new paint
    procedure DrawPolyline(AGraphics: TdxGPGraphics; const P: array of TPoint;
      AColor: TColor; AStyle: TPenStyle; AWidth, AScale: Single);
      overload; virtual;
  end;
  ...
  public
    procedure DrawEllipse(ACanvas: TcxCanvas; const R: TRect;
      ABackgroundColor: TColor; AFrameColor: TColor; AFrameStyle: TPenStyle;
      AFrameWidth: Integer); override;
    procedure DrawPolygon(ACanvas: TcxCanvas; const P: array of TPoint;
      ABackgroundColor, AFrameColor: TColor; AFrameStyle: TPenStyle;
      AFrameWidth: Integer); override;
    procedure DrawPolyline(ACanvas: TcxCanvas; const P: array of TPoint;
  ...
  TdxFlowChartCustomSemitransparentDragHelper = class
  ...
  TdxFlowChartMovingDragHelper = class
    (TdxFlowChartCustomSemitransparentDragHelper)
  strict private
  ...
  TdxFlowChartSelectionDragHelper = class
    (TdxFlowChartCustomSemitransparentDragHelper)
  strict protected
    function GetSelectionBounds: TRect; override;
    procedure PaintControlSelection(ACanvas: TcxCanvas); override;
  ...
  public type
{$SCOPEDENUMS ON}
    TFlowChartDragKind = (None, Endpoint, IntermediatePoint, Move, Resize,
      Selection, Rotate, Parameter);
    ...
    strict protected
      ...
      function CreateGuideController(AExcludedObject: TdxFcObject)
        : TdxGuideController; virtual;
      ...
      property IsControlPressed: Boolean index VK_CONTROL
    ...
    public
      ...
      function CreateSemitransparentHelper
        : TdxFlowChartCustomSemitransparentDragHelper; virtual;
    ...
    strict protected
      procedure SetEndpointObject(AObject: TdxFcObject;
        ALinkedPointIndex: Integer); virtual;
    public
      procedure Enter(X, Y: Integer); override;
    ...
    strict protected
      ...
      procedure OffsetObjects(ADragStartPoint, ADragFinishPoint: TPoint;
        AChangeObjectBounds: Boolean);
      ...
      property InitialDragObjectLocation: TPoint
        read FInitialDragObjectLocation;
    public
      procedure Enter(X, Y: Integer); override;
      procedure Move(X, Y: Integer); override;
      procedure Leave(X, Y: Integer); override;
      function CreateSemitransparentHelper
        : TdxFlowChartCustomSemitransparentDragHelper; override;
    end;
    ...
    strict protected
      ...
      function CalculateResizingRectangle(const ADeltaX, ADeltaY: Single)
        : TdxRectF;
      ...
      function ConvertResizingRectangleToObjectBound(const ARectangle
        : TdxRectF): TRect;
      function GetDisplayedFixedPoint(const ABounds: TdxRectF;
        AMarker: TdxResizeMarker): TdxPointF;
      function NeedAlignWithGrid: Boolean; virtual;
      procedure ValidateBoundsAlignment(var ANewBounds: TdxRectF;
        AMarker: TdxResizeMarker);
...
{$SCOPEDENUMS OFF}
  ...
  protected
    ...
    procedure SetupDragConnection(AConnection: TdxFcConnection;
      AIndex: Integer);
    ...
    property SemitransparentHelper: TdxFlowChartCustomSemitransparentDragHelper
      read FSemitransparentHelper;
  public
    constructor Create(AOwner: TdxCustomFlowChart); virtual;
    destructor Destroy; override;
    procedure CheckDragStart(X, Y: Integer; const AShift: TShiftState;
      const AHitTest: TdxFcHitTest);
...
{$SCOPEDENUMS OFF}
  ...
  type
    ...
    protected
      ...
      procedure CreateViewData(const ASize: TdxSizeF;
        const AParameters: TArray<Single>);
...
{$ENDREGION}
  private
    ...
    function GetObjectValue(Index: Integer): TdxFcObject;
    // renamed because of C++Builder
  ...
  protected
    ...
    function CalculatePolygon(out APolygon: TPoints; AIndent: Integer)
      : Boolean; virtual;
    function CalculateRegion(const ARect: TRect; AShapeWidth: Integer)
      : TcxRegionHandle; virtual;
    ...
    class function GetBoundingRect(const APoints: array of TPoint;
      ACount: Integer): TRect; overload;
    ...
    procedure SelPoints(var APoints: TdxFcSelectionPoints;
    ...
    procedure PaintAdvancedShapeContent(AGraphics: TdxGPGraphics;
      const ABounds: TRect);

    procedure PaintBackground(ACanvas: TcxCanvas); virtual;
    procedure PaintConnectionPoints(AGraphics: TdxGPGraphics); virtual;
    procedure PaintHighlightedFrame(AGraphics: TdxGPGraphics;
      AColor: TdxAlphaColor); virtual;
    ...
    property HighlightedFrameMode: THighlightedFrameMode
      read FHighlightedFrameMode write FHighlightedFrameMode;
    property HighlightedLinkedPointIndex: Integer
      read FHighlightedLinkedPointIndex write SetHighlightedLinkedPointIndex;
    ...
    property ShowConnectionPoints: Boolean read FShowConnectionPoints
      write FShowConnectionPoints;
  public
    constructor Create(AOwner: TdxCustomFlowChart);
    destructor Destroy; override;
    ...
    property HorzImagePos: TdxFcHorzPos read FHorzImagePos
      write SetHorzImagePos;
    ...
    property VertImagePos: TdxFcVertPos read FVertImagePos
      write SetVertImagePos;
  ...
  strict private
    class var FRepository: TdxFlowChartArrowShapeRepository;
  private
  ...
  protected
    ...
    property Painter: TdxFlowChartPainter read GetPainter;
    class property Repository: TdxFlowChartArrowShapeRepository
      read FRepository;
  ...
  *)
  ...
  public
    ...
    //
    property ArrowSource: TdxFcConnectionArrow read FArrowSource
      write SetArrowSource;
    ...
    // is not saved in the stream/file
  ...
  public
    constructor Create(AChart: TdxCustomFlowChart;
      AItemMargin: Integer); virtual;
    function RouteConnection(AConnection: TdxFcConnection;
      const AStart, AEnd: TPoint): TArray<TPoint>; virtual; abstract;
  end;
...
{$SCOPEDENUMS OFF}
  strict private
    class var FRotationImage: TdxSmartImage;
  strict private
  ...
  strict protected
    procedure AdjustObjectSelectionBounds(AObject: TdxFcObject;
      var ABounds: TRect); virtual;
    function CanResize: Boolean;
    function CanRotate: Boolean;
    function ConnectionPointToDrawPoint(AConnection: TdxFcConnection;
      AIndex: Integer): TPoint;
    procedure CreateGraphicTools; virtual;
    procedure DestroyGraphicTools; virtual;
    procedure DrawObjectBoundingRect(AGraphics: TdxGPGraphics;
      ABounds: TRect); virtual;
    procedure DrawConnectionEndPointMark(AGraphics: TdxGPGraphics;
      const P: TPoint); virtual;
    procedure DrawConnectionIntermediatePointMark(AGraphics: TdxGPGraphics;
      const P: TPoint); virtual;
    procedure DrawConnectionSelection(AGraphics: TdxGPGraphics;
      AConnection: TdxFcConnection); virtual;
    procedure DrawEqualityArrows(AGraphics: TdxGPGraphics; const ASize: TSize;
      const ABounds: TRect; APen: TdxGPPen; ABrush: TdxGPBrush); virtual;
    procedure DrawEqualitySizes(AGraphics: TdxGPGraphics; ASize: TSize;
      ABounds: TList<TRect>); virtual;
    procedure DrawObjectSelection(AGraphics: TdxGPGraphics;
      AObject: TdxFcObject); virtual;
    procedure DrawResizingMark(AGraphics: TdxGPGraphics; const P: TPoint);
      overload; virtual;
    procedure DrawResizingMark(AGraphics: TdxGPGraphics; X, Y: Integer);
      overload; virtual;
    procedure DrawRotationMark(AGraphics: TdxGPGraphics;
      const ACenterPoint: TPoint); virtual;
    procedure DrawSelectionFrame(AGraphics: TdxGPGraphics;
  ...
  TdxFlowChartVerticalScrollAnimationHelper = class
  ...
  TdxFlowChartHorizontalScrollAnimationHelper = class
    (TdxFlowChartScrollAnimationHelper)
  protected
    procedure CheckPosition(var AValue: Integer); override;
    function GetOwnerPosition: Integer; override;
...
{$SCOPEDENUMS ON}
    ...
    strict private
      ...
      function GetSquareDistance(const AObject: TdxFcObject;
        ALinkedPointIndex: Integer; const APosition: TPoint): Int64;
    strict protected
...
{$SCOPEDENUMS OFF}
  strict private
    class var FRepository: TdxFlowChartAdvancedShapeRepository;
...
{$HINTS ON}
  private
    ...
    FHorizontalScrollAnimationHelper
    ...
    function GetObjectValue(Index: Integer): TdxFcObject; inline;
    // renamed because of C++Builder
    ...
    function CanScaleByMouseWheel(AShift: TShiftState;
  ...
  protected
    ...
    class function CreateArrowShapeRepository
      : TdxFlowChartArrowShapeRepository; virtual;
    ...
    function ScrollPoint(const P: TPoint;
      APositiveFactor: Boolean = True): TPoint;
    ...
    procedure DoDrawObjectEx(AObject: TdxFcObject; AGraphics: TdxGPGraphics;
      const APaintData: TdxFcDrawExEventPaintData); virtual;
    ...
    procedure StartExternalDrag(const AScreenPoint: TPoint;
      const ACreateObject: TCreateObjectReference);
    ...
    procedure ProcessMouseDown(Button: TMouseButton; Shift: TShiftState;
      X, Y: Integer); virtual;
    ...
    procedure ApplySugiyamaPositionInfo(AInfo: TdxSugiyamaPositionsInfo;
      AUseDummyEdges: Boolean); virtual;
    ...
    property ConnectionHighlights: TConnectionHighlights
      read FConnectionHighlights;
    property DragHelper: TdxFlowChartDragHelper read FDragHelper;
    property GridLineOptions: TdxFlowChartGridOptions read FGridLineOptions
      write SetGridLineOptions;
    property HighlightedObject: TdxFcItem read FHighlightedObject
      write SetHighlightedObject; // TODO: Hide property!
    ...
    property OnDrawObject: TdxFcDrawEvent read FOnDrawObject
      write FOnDrawObject;
    property OnDrawObjectEx: TdxFcDrawExEvent read FOnDrawObjectEx
      write FOnDrawObjectEx;
  ...
  public
    ...
    function CreateObject(L, T, W, H: Integer; AShape: TdxFcShapeType)
      : TdxFcObject; overload;
    function CreateObject(L, T, W, H: Integer;
      AAdvancedShape: TdxFlowChartObjectAdvancedShape): TdxFcObject; overload;
    ...
    property SelectedConnection: TdxFcConnection read GetSelConnect
      write SetSelConnect;
    property SelectedConnectionCount: Integer read GetSelectedConnectionCount;
    property SelectedConnections[Index: Integer]: TdxFcConnection
      read GetSelectedConnection;
    ...
    property SelectedObjects[Index: Integer]: TdxFcObject
      read GetSelectedObject;
    property TopEdge: Integer read FTopEdge write SetTopEdge;
    // repository
    class property Repository: TdxFlowChartAdvancedShapeRepository
      read FRepository;
  end;
  ...
  public
    function CanKeyEnter(Edit: TcxTextEdit; Key: Char;
      MinValue, MaxValue: Integer): Boolean;
    function Execute(AChart: TdxFlowChart): Boolean; virtual; abstract;
    function FindAllUnions(AChart: TdxFlowChart; FromUnion: TdxFcObject)
      : TdxFcObject;
    function FindUnions(AChart: TdxFlowChart; FromUnion, Obj: TdxFcObject)
      : TdxFcObject;
    function GetNumberByUnion(AChart: TdxFlowChart; Obj: TdxFcObject): Integer;
    function IntegerToStr(S: String): Integer;
    function IsChildItemInUnion(AChart: TdxFlowChart; Obj: TdxFcObject)
      : Boolean;
  end;
  ...
  public
    ...
    property UseAdvancedShapesOnly: Boolean read FUseAdvancedShapesOnly
      write FUseAdvancedShapesOnly;
  end;
  ...
  public
    ...
    function Customize(AChart: TdxFlowChart; AEditorCaption: string;
...
function ShowFlowChartEditor(AChart: TdxFlowChart; AEditorCaption: string;
  AOptions: TdxFlowChartEditorOptions = nil): Boolean;
...
uses
  Math, cxDrawTextUtils, cxScrollBar, dxDPIAwareUtils, dxTypeHelpers,
  dxGenerics, dxRightAngleRoutingStrategy, AnsiStrings,
  dxStringHelper;
...
type
  TdxFlowChartObjectAdvancedShapeHelper = class helper for
  ...
  TXMLFormatHelper = record
    class function GetNameIndex(const AName: string;
      const ALowerCaseNames: array of string): Integer; static;
    class procedure WriteObjectShapeType(AAttributes: TdxXMLNodeAttributes;
      AShapeType: TdxFcShapeType); static;
    class procedure WriteAlignment(AAttributes: TdxXMLNodeAttributes;
      const AName: TdxXMLString; AHorizontal: TdxFcHorzPos;
      AVertical: TdxFcVertPos); static;
    class procedure WriteColor(AAttributes: TdxXMLNodeAttributes;
      const AName: TdxXMLString; AColor: TColor); static;
    class procedure WriteAlphaColor(AAttributes: TdxXMLNodeAttributes;
      const AName: TdxXMLString; AColor: TdxAlphaColor); static;
    class procedure WriteConnectionStyle(AAttributes: TdxXMLNodeAttributes;
      AStyle: TdxFclStyle); static;

    class function ReadObjectShapeType(AAttributes: TdxXMLNodeAttributes)
      : TdxFcShapeType; static;
    class procedure ReadAlignment(AAttributes: TdxXMLNodeAttributes;
      const AName: TdxXMLString; out AHorizontal: TdxFcHorzPos;
      out AVertical: TdxFcVertPos); static;
    class function ReadColor(AAttributes: TdxXMLNodeAttributes;
      const AName: TdxXMLString; ADefaultColor: TColor = clDefault)
      : TColor; static;
    class function ReadAlphaColor(AAttributes: TdxXMLNodeAttributes;
      const AName: TdxXMLString): TdxAlphaColor; static;
    class function ReadConnectionStyle(AAttributes: TdxXMLNodeAttributes)
      : TdxFclStyle; static;
  end;

  { TdxFlowChartObjectAdvancedShapeHelper }

function TdxFlowChartObjectAdvancedShapeHelper.GetShapeDescription
  : TdxShapeDescription;
begin
  Result := FShape;
end;
...
class function TXMLFormatHelper.GetNameIndex(const AName: string;
  const ALowerCaseNames: array of string): Integer;
var
  S: string;
  I: Integer;
begin
...
class procedure TXMLFormatHelper.ReadAlignment(AAttributes
  : TdxXMLNodeAttributes; const AName: TdxXMLString;
  out AHorizontal: TdxFcHorzPos; out AVertical: TdxFcVertPos);
type
...
const
  AlignNames: array [0 .. 8] of string = ('topleft', 'topcenter', 'topright',
    'centerleft', 'centercenter', 'centerright', 'bottomleft', 'bottomcenter',
    'bottomright');
  AlignValues: array [0 .. 8] of TAlignmentValue = ((V: fcvpUp; H: fchpLeft),
    (V: fcvpUp; H: fchpCenter), (V: fcvpUp; H: fchpRight), (V: fcvpCenter;
    H: fchpLeft), (V: fcvpCenter; H: fchpCenter), (V: fcvpCenter; H: fchpRight),
    (V: fcvpDown; H: fchpLeft), (V: fcvpDown; H: fchpCenter), (V: fcvpDown;
    H: fchpRight));
var
...
class function TXMLFormatHelper.ReadAlphaColor(AAttributes
  : TdxXMLNodeAttributes; const AName: TdxXMLString): TdxAlphaColor;
begin
  Result := TdxAlphaColors.FromHexCode(AAttributes.GetValueAsString(AName));
end;

class function TXMLFormatHelper.ReadColor(AAttributes: TdxXMLNodeAttributes;
  const AName: TdxXMLString; ADefaultColor: TColor = clDefault): TColor;
var
  AValue: string;
begin
...
class function TXMLFormatHelper.ReadConnectionStyle
  (AAttributes: TdxXMLNodeAttributes): TdxFclStyle;
begin
  case GetNameIndex(AAttributes.GetValueAsString('Style'),
    ['straight', 'curved', 'recth', 'rectv']) of
    1:
      Result := fclCurved;
    2:
      Result := fclRectH;
...
class function TXMLFormatHelper.ReadObjectShapeType
  (AAttributes: TdxXMLNodeAttributes): TdxFcShapeType;
var
  AIndex: Integer;
begin
  AIndex := GetNameIndex(AAttributes.GetValueAsString('ShapeType'),
    ['none', 'rectangle', 'ellipse', 'roundrect', 'diamond', 'northtriangle',
    'southtriangle', 'easttriangle', 'westtriangle', 'hexagon', 'user',
    'advanced']);
  if AIndex < 0 then
    AIndex := 1;
...
class procedure TXMLFormatHelper.WriteAlignment(AAttributes
  : TdxXMLNodeAttributes; const AName: TdxXMLString; AHorizontal: TdxFcHorzPos;
  AVertical: TdxFcVertPos);
const
  VerticalAlignments: array [TdxFcVertPos] of string = ('Top', 'Center',
    'Bottom');
  HorizontalAlignments: array [TdxFcHorzPos] of string = ('Left',
    'Center', 'Right');
begin
  AAttributes.SetValueAsString(AName,
    Format('%s%s', [VerticalAlignments[AVertical],
    HorizontalAlignments[AHorizontal]]));
end;

class procedure TXMLFormatHelper.WriteAlphaColor(AAttributes
  : TdxXMLNodeAttributes; const AName: TdxXMLString; AColor: TdxAlphaColor);
begin
  AAttributes.SetValueAsString(AName, TdxAlphaColors.ToHexCode(AColor,
    True, '#'));
end;

class procedure TXMLFormatHelper.WriteColor(AAttributes: TdxXMLNodeAttributes;
  const AName: TdxXMLString; AColor: TColor);
begin
  AAttributes.SetValueAsString(AName,
    TdxAlphaColors.ToHexCode(TdxAlphaColors.FromColor(AColor), True, '#'));
end;

class procedure TXMLFormatHelper.WriteConnectionStyle
  (AAttributes: TdxXMLNodeAttributes; AStyle: TdxFclStyle);
const
  Styles: array [TdxFclStyle] of TdxXMLString = ('Straight', 'Curved',
    'RectH', 'RectV');
begin
  AAttributes.SetValue('Style', Styles[AStyle]);
end;

class procedure TXMLFormatHelper.WriteObjectShapeType
  (AAttributes: TdxXMLNodeAttributes; AShapeType: TdxFcShapeType);
const
  Styles: array [TdxFcShapeType] of TdxXMLString = ('None', 'Rectangle',
    'Ellipse', 'RoundRect', 'Diamond', 'NorthTriangle', 'SouthTriangle',
...
function AdjustRect(var R: TRect; const Bounds: TRect; HPos: TdxFcHorzPos;
  VPos: TdxFcVertPos): Boolean;
var
  DX, DY: Integer;
begin
...
function AdjustImageRect(var R: TRect; const Bounds: TRect; HPos: TdxFcHorzPos;
  VPos: TdxFcVertPos): Boolean;
var
  DX, DY: Integer;
  ARatio: Single;
...
procedure UpdateGraphicsForRotatedBounds(AGraphics: TdxGPGraphics;
  const ABounds: TRect; AAngle: Single);
var
...
function ShowFlowChartEditor(AChart: TdxFlowChart; AEditorCaption: string;
  AOptions: TdxFlowChartEditorOptions = nil): Boolean;
begin
  Result := dxFlowChartCustomizeFormManager.Customize(AChart, AEditorCaption,
    AOptions);
end;

{ TdxFlowChartUnionsHelper }

class function TdxFlowChartUnionsHelper.FindAllUnions(AChart: TdxFlowChart;
  FromUnion: TdxFcObject): TdxFcObject;
var
  I: Integer;
  FFind: Boolean;
begin
...
class function TdxFlowChartUnionsHelper.FindUnions(AChart: TdxFlowChart;
  FromUnion, Obj: TdxFcObject): TdxFcObject;
var
  I: Integer;
  FFind: Boolean;
begin
...
class function TdxFlowChartUnionsHelper.GetNumberByUnion(AChart: TdxFlowChart;
  Obj: TdxFcObject): Integer;
var
  I: Integer;
begin
  Result := 0;
...
class function TdxFlowChartUnionsHelper.IsChildItemInUnion(AChart: TdxFlowChart;
  Obj: TdxFcObject): Boolean;
var
  I: Integer;
begin
  Result := False;
...
function TdxFlowChartCustomCustomizeForm.CanKeyEnter(Edit: TcxTextEdit;
  Key: Char; MinValue, MaxValue: Integer): Boolean;
var
  Text: string;
  Value: Integer;
begin
...
function TdxFlowChartCustomCustomizeForm.FindAllUnions(AChart: TdxFlowChart;
  FromUnion: TdxFcObject): TdxFcObject;
begin
  Result := TdxFlowChartUnionsHelper.FindAllUnions(AChart, FromUnion);
end;

function TdxFlowChartCustomCustomizeForm.FindUnions(AChart: TdxFlowChart;
  FromUnion, Obj: TdxFcObject): TdxFcObject;
begin
  Result := TdxFlowChartUnionsHelper.FindUnions(AChart, FromUnion, Obj);
end;

function TdxFlowChartCustomCustomizeForm.GetNumberByUnion(AChart: TdxFlowChart;
  Obj: TdxFcObject): Integer;
begin
...
function TdxFlowChartCustomCustomizeForm.IsChildItemInUnion
  (AChart: TdxFlowChart; Obj: TdxFcObject): Boolean;
begin
...
function TdxFlowChartCustomizeFormManager.Customize(AChart: TdxFlowChart;
  AEditorCaption: string; AOptions: TdxFlowChartEditorOptions = nil): Boolean;
var
...
begin
  ...
  begin
    ...
    try
      ...
      if Result then
      begin
        if Supports(dxFlowChartEditor, IdxFlowChartEditorOptions, AIOptions)
        then
...
begin
  ...
  try
    APen := TdxGPPen.Create(TdxAlphaColors.FromColor(AFrameColor), AFrameWidth,
      AFrameStyle);
...
begin
  ...
  FParameters := ShapeDescription.GetParameters
    (ShapeDescription.DefaultSize, nil);
  ...
  for I := Low(FParameters) to High(FParameters) do
    FLocations[I] := ShapeDescription.GetParameterPoint(I,
      ShapeDescription.DefaultSize, FParameters, FParameters[I]);
  FViewData := ShapeDescription.CreateViewData(ShapeDescription.DefaultSize,
    FParameters);
  FConnectionPoints := ShapeDescription.GetConnectionPoints
    (ShapeDescription.DefaultSize, FParameters);
...
procedure TdxFcObject.TAdvancedShapeInfo.CreateViewData(const ASize: TdxSizeF;
  const AParameters: TArray<Single>);
begin
  FViewData.Free;
...
begin
  ...
  ANormalizedParameters := ShapeDescription.GetNormalizedParameters(ASize,
    FParameters);
  for I := Low(FLocations) to High(FLocations) do
    FLocations[I] := ShapeDescription.GetParameterPoint(I, ASize, FParameters,
      ANormalizedParameters[I]);
  FConnectionPoints := ShapeDescription.GetConnectionPoints(ASize,
    ANormalizedParameters);
  CreateViewData(ASize, ANormalizedParameters);
end;

procedure TdxFcObject.TAdvancedShapeInfo.ReadParameters
...
procedure TdxFcObject.TAdvancedShapeInfo.SetParameters
...
procedure TdxFcObject.TAdvancedShapeInfo.WriteParameters
  (AAttributes: TdxXMLNodeAttributes);
var
  AValue: string;
  I: Integer;
...
begin
  ...
  Result.Color := TdxAlphaColors.ChangeBrightness(AColor,
    ViewData[AIndex].FillBrightness);
end;

function TdxFcObject.TAdvancedShapeInfo.GetParameterIndex
...
begin
  ...
  begin
    AMatrix := TdxGPMatrix.Create;
    AMatrix.Rotate(Owner.Angle, TdxPointF.Create(ABounds.Left + ABounds.Width /
      2, ABounds.Top + ABounds.Height / 2));
  end
  else
    AMatrix := nil;
  ...
  try
    ...
    begin
      ...
      ABounds := TRect.Round(TdxRectF.Create(APoint.X - AIndent,
        APoint.Y - AIndent, APoint.X + AIndent, APoint.Y + AIndent));
...
{$ELSE}
  AStrokeColor := AElement.Properties.StrokeColor;
  AStrokeThickness := AElement.Properties.StrokeThickness;
{$ENDIF}
...
procedure TdxFcObject.TAdvancedShapeInfo.ChangeParameter(AIndex: Integer;
  const APoint: TdxPointF);
var
  AParameterValue: Single;
begin
  AParameterValue := ShapeDescription.GetParameterValue(AIndex,
    TdxSizeF.Create(FLastSize.cx, FLastSize.cy), FParameters, APoint);
...
begin
  for I := Low(FParameters) to High(FParameters) do
    if not SameValue(FParameters[I],
      ShapeDescription.GetParameterDefaultValue(I)) then
      Exit(False);
  Result := True;
end;

function TdxFcObject.TAdvancedShapeInfo.IsPointInsideShape
  (const P: TPoint): Boolean;
begin
  Result := True;
end;

procedure TdxFcObject.TAdvancedShapeInfo.Paint(AGraphics: TdxGPGraphics;
  const ABounds: TRect);
var
  APen: TdxGPPen;
  ABrush: TdxGPBrush;
...
procedure TdxFcObject.TAdvancedShapeInfo.PaintParameters
  (AGraphics: TdxGPGraphics);
  ...
  begin
    AIndent := Owner.Owner.ScaleFactor.Apply(4);
    Result := TdxRectF.Create(APoint.X - AIndent, APoint.Y - AIndent,
      APoint.X + AIndent, APoint.Y + AIndent);
  end;
...
begin
  ...
  for I := Low(PaintLocations) to High(PaintLocations) do
    AGraphics.Rectangle(GetParameterRectangle(PaintLocations[I]),
      TdxAlphaColors.SaddleBrown, TdxAlphaColors.NavajoWhite,
...
procedure TdxFcObject.TFontData.DrawText(AGraphics: TdxGPGraphics;
...
begin
  ...
  FFont := TdxGPFont.SafeCreate(Owner.RealFont.Name,
    Owner.Font.Size * Owner.Owner.RealZoom / 100, AStyle);
end;
...
begin
  case Owner.HorzTextPos of
    ...
    fchpCenter:
      FFormat.Alignment := StringAlignmentCenter;
    fchpRight:
      FFormat.Alignment := StringAlignmentFar;
  end;
  case Owner.VertTextPos of
    fcvpUp:
      FFormat.LineAlignment := StringAlignmentNear;
    fcvpCenter:
      FFormat.LineAlignment := StringAlignmentCenter;
    fcvpDown:
      FFormat.LineAlignment := StringAlignmentFar;
  end;
end;

{ TdxFcDrawExEventPaintData }

constructor TdxFcDrawExEventPaintData.Create(AObject: TdxFcObject;
  const ABounds: TRect);
begin
  FObject := AObject;
  FBounds := ABounds;
...
begin
  ...
  DX := AQuarterWidth shr 1;
  DY := AQuarterHeight shr 1;
  case ShapeType of
    fcsUser:
      UserLinkedPoints;
    fcsNorthTriangle:
...
begin
  ...
  begin
    ...
    begin
      AMatrix := TdxGPMatrix.Create;
      try
        AMatrix.Rotate(Angle, TdxPointF.Create(RealLeft + RealWidth / 2,
          RealTop + RealHeight / 2));
  ...
  begin
    CalculateLinkedPointsForBounds(TRect.CreateSize(RealLeft, RealTop,
...
class function TdxFcObject.GetBoundingRect(const APoints: array of TPoint;
  ACount: Integer): TRect;
var
  P: TPoint;
  I: Integer;
begin
...
begin
  ...
  begin
    ...
    if CanRotate then
      Dec(Result.Top, Ceil(Owner.Selection.RotationMarkOffset) +
        Ceil(Owner.Selection.RotationMarkSize / 2) + 1);
  end;
end;
...
begin
  ...
  begin
    ...
    try
      ABounds := DisplayRect;
      AMatrix.Rotate(-Angle, TdxPointF.Create(ABounds.Left + ABounds.Width / 2,
        ABounds.Top + ABounds.Height / 2));
...
function TdxFcObject.CalculatePolygon(out APolygon: TPoints;
  AIndent: Integer): Boolean;
  ...
  begin
    ...
    if (APointPosition >= 12) and (APointPosition <= 15) or (APointPosition = 0)
    then
...
function TdxFcObject.CalculateRegion(const ARect: TRect; AShapeWidth: Integer)
  : TcxRegionHandle;
var
  P: TPoints;
  R: TRect;
...
begin
  Result := (ShapeType = fcsAdvanced) and
    (fcoUseShapeParameters in Owner.Options);
end;

procedure TdxFcObject.ChangeScale(M, D: Integer);
begin
  inherited ChangeScale(M, D);
  SetBounds(MulDiv(Left, M, D), MulDiv(Top, M, D), MulDiv(Width, M, D),
    MulDiv(Height, M, D));
  CalculateRealBounds;
end;
...
const
  Cursors: array [0 .. 3] of TCursor = (crSizeNWSE, crSizeNS, crSizeNESW,
    crSizeWE);
var
  AIndex: Integer;
  A: Single;
...
begin
  SelPoints(APoints, TRect.CreateSize(FRealLeft, FRealTop, FRealWidth,
    FRealHeight));
end;
...
function TdxFcObject.GetPoint(const P: array of TPoint;
  X, Y, ACount: Integer): Integer;
var
  I: Integer;
...
begin
  ...
  ARotationMarkCenter.Init(ABounds.Left + ABounds.Width div 2,
    ABounds.Top - Ceil(Owner.Selection.RotationMarkOffset));
  Result := Sqr(ARotationMarkCenter.X - AObjectPoint.X) +
    Sqr(ARotationMarkCenter.Y - AObjectPoint.Y) <
...
begin
  if not HasInUnion(AObject) then
...
begin
  ...
  else if Owner.IsScrollAnimationActive then
...
function TdxFcObject.GetAdvancedShapeImageBounds(const AContentBounds
  : TRect): TRect;
var
...
procedure TdxFcObject.PaintAdvancedShapeImage(AGraphics: TdxGPGraphics;
  const R: TRect);
var
  AImageRect: TRect;
begin
  ...
  begin
    ...
    if not AImageRect.IsEmpty then
      TdxImageListPaintCache.Draw(AGraphics, AImageRect, Owner.Images,
        ImageIndex, idmNormal, False, nil);
  end;
end;

procedure TdxFcObject.PaintAdvancedShapeText(AGraphics: TdxGPGraphics;
  const R: TRect);
begin
  FontData.DrawText(AGraphics, R.ToRectF);
end;

procedure TdxFcObject.PaintAdvancedShapeContent(AGraphics: TdxGPGraphics;
  const ABounds: TRect);
var
...
begin
  ...
  try
    ...
    try
      ...
      AGraphics.TranslateWorldTransform(APaintShapeBounds.Left + AHalfWidth,
        APaintShapeBounds.Top + AHalfHeight);
...
begin
  if ShapeType in [fcsNone, fcsAdvanced] then
    Exit;
  ...
  case ShapeType of
    fcsUser:
      Painter.DrawRegion(ACanvas, UserRegion(R), GetBackgroundColor,
        GetFrameColor, RealShapeWidth);
    fcsEllipse:
      Painter.DrawEllipse(ACanvas, R, GetBackgroundColor, GetFrameColor,
        ShapeStyle, RealShapeWidth);
    fcsRectangle:
      Painter.DrawRectangle(ACanvas, R, GetBackgroundColor, GetFrameColor,
        ShapeStyle, RealShapeWidth);
    fcsRoundRect:
      Painter.DrawRoundRect(ACanvas, R, GetBackgroundColor, GetFrameColor,
        ShapeStyle, RealShapeWidth, RealWidth shr 1, RealHeight shr 1);
    fcsDiamond, fcsNorthTriangle, fcsSouthTriangle, fcsEastTriangle,
      fcsWestTriangle, fcsHexagon:
      if CalculatePolygon(P, RealContentIndent) then
        try
          Painter.DrawPolygon(ACanvas, P, GetBackgroundColor, GetFrameColor,
            ShapeStyle, RealShapeWidth);
        finally
          P := nil;
        end;
  ...
  try
    ...
    case HighlightedFrameMode of
      THighlightedFrameMode.Selected:
        PaintHighlightedFrame(AGraphics, TdxAlphaColors.FromArgb($24,
          $40, $8F));
...
procedure TdxFcObject.PaintHighlightedFrame(AGraphics: TdxGPGraphics;
  AColor: TdxAlphaColor);
var
  ABounds: TRect;
  APen: TdxGPPen;
...
begin
  ...
  begin
    APen := TdxGPPen.Create(TdxAlphaColors.LimeGreen,
      Owner.ScaleFactor.Apply(3));
    try
...
const
  Aligns: array [TdxFcHorzPos] of Word = (CXTO_LEFT, CXTO_CENTER_HORIZONTALLY,
    CXTO_RIGHT);
var
  AFlags: Cardinal;
  ATextRect: TRect;
begin
  ...
  begin
    cxTextOut(Owner.Canvas.Handle, Text, ATextRect, AFlags or CXTO_CALCRECT,
      RealFont);
    AdjustRect(ATextRect, R, HorzTextPos, VertTextPos);
  end;
  cxTextOut(Owner.Canvas.Handle, Text, ATextRect, AFlags + CXTO_NOCLIP,
    RealFont);
end;
...
begin
  ...
  SetBounds(Owner.ScaleFactor.Apply(ObjData.Left),
...
begin
  ...
  TXMLFormatHelper.ReadAlignment(AAttributes, 'TextAlignment', FHorzTextPos,
    FVertTextPos);
  UpdateFontFormat;

  TXMLFormatHelper.ReadAlignment(AAttributes, 'ImageAlignment', FHorzImagePos,
    FVertImagePos);
  ...
  AdvancedShape := TdxFlowChart.Repository.FindShapeByID
    (AAttributes.GetValueAsString('ShapeID'));
  Transparent := AAttributes.GetValueAsBoolean('Transparent', False);

  SetBounds(Owner.ScaleFactor.Apply(AAttributes.GetValueAsInteger('Left')),
...
begin
  AAttributes := ANode.Attributes;
  if Text <> '' then
    AAttributes.SetValueAsString('Text',
      TdxXMLHelper.EncodeString(Text, False));
  if CustomData <> '' then
  ...
  if (HorzTextPos <> fchpLeft) or (VertTextPos <> fcvpUp) then
    TXMLFormatHelper.WriteAlignment(AAttributes, 'TextAlignment', HorzTextPos,
      VertTextPos);
  if (HorzImagePos <> fchpLeft) or (VertImagePos <> fcvpUp) then
    TXMLFormatHelper.WriteAlignment(AAttributes, 'ImageAlignment', HorzImagePos,
      VertImagePos);
  ...
  begin
    ...
    for I := 0 to ObjectCount - 1 do
      AObjectsNode.AddChild('Object').Attributes.SetValueAsInteger('ZOrder',
        Objects[I].ZOrder);
  end;
...
function TdxFcObject.AdvancedShapePointToLinkedPoint
  (const P: TdxPointF): TPoint;
begin
...
constructor TdxDiagramRoutingStrategy.Create(AChart: TdxCustomFlowChart;
  AItemMargin: Integer);
begin
  FChart := AChart;
...
function TdxFcSelection.ConnectionPointToDrawPoint(AConnection: TdxFcConnection;
  AIndex: Integer): TPoint;
begin
...
begin
  ...
  FResizingMarkPen := TdxGPPen.Create(TdxAlphaColors.Gray,
    Owner.ScaleFactor.ApplyF(2));
  FResizingMarkBrush := TdxGPBrush.Create;
  FResizingMarkBrush.Color := TdxAlphaColors.White;
  FConnectionPointPen := TdxGPPen.Create(TdxAlphaColors.White,
    Owner.ScaleFactor.ApplyF(1.5));
  if CanResize then
    FSelectionFramePen := TdxGPPen.Create(TdxAlphaColors.Gray,
      Owner.ScaleFactor.ApplyF(1))
  else
    FSelectionFramePen := TdxGPPen.Create(TdxAlphaColors.FromArgb($24, $40,
      $8F), Owner.ScaleFactor.ApplyF(2), psDash);
end;
...
procedure TdxFcSelection.DrawObjectBoundingRect(AGraphics: TdxGPGraphics;
  ABounds: TRect);
var
  APen: TdxGPPen;
begin
...
procedure TdxFcSelection.DrawConnectionEndPointMark(AGraphics: TdxGPGraphics;
  const P: TPoint);
var
  R: TdxRectF;
begin
...
procedure TdxFcSelection.DrawConnectionIntermediatePointMark
  (AGraphics: TdxGPGraphics; const P: TPoint);
var
  R: TdxRectF;
begin
...
procedure TdxFcSelection.DrawConnectionSelection(AGraphics: TdxGPGraphics;
...
begin
  ...
  begin
    DrawConnectionEndPointMark(AGraphics,
      ConnectionPointToDrawPoint(AConnection, 0));
    DrawConnectionEndPointMark(AGraphics,
      ConnectionPointToDrawPoint(AConnection, AConnection.RealCount - 1));
  end;
  if Owner.CanDragConnectionIntermediatePoints then
  begin
    for I := 1 to AConnection.RealCount - 2 do
      DrawConnectionIntermediatePointMark(AGraphics,
        ConnectionPointToDrawPoint(AConnection, I));
  end;
end;

procedure TdxFcSelection.DrawEqualityArrows(AGraphics: TdxGPGraphics;
  const ASize: TSize; const ABounds: TRect; APen: TdxGPPen; ABrush: TdxGPBrush);
var
...
procedure TdxFcSelection.DrawEqualitySizes(AGraphics: TdxGPGraphics;
  ASize: TSize; ABounds: TList<TRect>);
var
  I: Integer;
  ABrush: TdxGPBrush;
  APen: TdxGPPen;
...
procedure TdxFcSelection.AdjustObjectSelectionBounds(AObject: TdxFcObject;
  var ABounds: TRect);
begin
  if not dxFlowChartSizeStandardObjectsAsAdvanced and
    (AObject.ShapeType <> fcsAdvanced) then
  begin
    Dec(ABounds.Right, 2);
...
procedure TdxFcSelection.DrawObjectSelection(AGraphics: TdxGPGraphics;
  AObject: TdxFcObject);
var
  ABounds: TRect;
...
begin
  ...
  try
    ...
    begin
      ARotationMark.Init(ABounds.Left + ABounds.Width div 2,
        Round(ABounds.Top - RotationMarkOffset));
...
procedure TdxFcSelection.DrawResizingMark(AGraphics: TdxGPGraphics;
  X, Y: Integer);
var
  R: TdxRectF;
begin
...
procedure TdxFcSelection.DrawRotationMark(AGraphics: TdxGPGraphics;
...
begin
  ...
  AGraphics.Line(ACenterPoint.X, ACenterPoint.Y + Ceil(AOffset * 0.75),
...
procedure TdxFcSelection.DrawSelectionFrame(AGraphics: TdxGPGraphics;
  const ABounds: TRect);
begin
  ...
  begin
    DrawResizingMark(AGraphics, ABounds.Left + ABounds.Width div 2,
      ABounds.Top);
    DrawResizingMark(AGraphics, ABounds.Left + ABounds.Width div 2,
      ABounds.Bottom);
  end;
  ...
  begin
    DrawResizingMark(AGraphics, ABounds.Left,
      ABounds.Top + ABounds.Height div 2);
    DrawResizingMark(AGraphics, ABounds.Right,
      ABounds.Top + ABounds.Height div 2);
  end;
  if (ABounds.Width > 4 * ResizingMarkRadius) and
    (ABounds.Height > 4 * ResizingMarkRadius) then
  begin
...
begin
  ...
  begin
    ...
    begin
      if AObject.HighlightedFrameMode <> TdxFcObject.THighlightedFrameMode.Connect
      then
        if (PaintMode = TPaintMode.MultiSelection) and AObject.Selected then
          AObject.HighlightedFrameMode :=
            TdxFcObject.THighlightedFrameMode.Selected
        else
          AObject.HighlightedFrameMode :=
            TdxFcObject.THighlightedFrameMode.None;
    end;
  end;
end;
...
begin
  AStream := TResourceStream.Create(HInstance, 'DXFCRotateIcon', RT_RCDATA);
  try
...
constructor TdxCustomFlowChart.TPointInfo.Create(AObject: TdxFcObject;
  AIndex: Integer);
begin
  &Object := AObject;
  Index := AIndex;
...
procedure TdxCustomFlowChart.TPointInfo.Update(AObject: TdxFcObject;
  AIndex: Integer);
begin
  &Object := AObject;
  Index := AIndex;
...
constructor TdxCustomFlowChart.TConnectionHighlights.Create
  (AChart: TdxCustomFlowChart; X, Y, ABaseTolerance: Integer);
begin
  FChart := AChart;
...
function TdxCustomFlowChart.TConnectionHighlights.CanHighlightObject
  (AObject: TdxFcObject): Boolean;
begin
  Result := AObject.Visible and (AObject.LinkedPointCount > 0);
end;

function TdxCustomFlowChart.TConnectionHighlights.CanHighlightObjectPoints
  (AObject: TdxFcObject): Boolean;
begin
...
function TdxCustomFlowChart.TConnectionHighlights.GetHighlightedObject(X, Y,
  ATolerance: Integer): TdxFcObject;
var
  I: Integer;
  AObject: TdxFcObject;
  APoint: TPoint;
begin
  ...
  begin
    ...
    if CanHighlightObject(AObject) and AObject.ContainsPoint(APoint.X, APoint.Y,
      ATolerance) then
      Exit(AObject);
  end;
end;

function TdxCustomFlowChart.TConnectionHighlights.GetDestinationPoint(X,
  Y: Integer): TPoint;
begin
...
procedure TdxCustomFlowChart.TConnectionHighlights.SetLinkedPointsVisibility
  (AHighlight: Boolean);
var
  I: Integer;
  AObject: TdxFcObject;
...
function TdxCustomFlowChart.TConnectionHighlights.GetSquareDistance
  (const AObject: TdxFcObject; ALinkedPointIndex: Integer;
  const APosition: TPoint): Int64;
begin
  Result := Sqr(AObject.LinkedPoints[ALinkedPointIndex].X - APosition.X) +
    Sqr(AObject.LinkedPoints[ALinkedPointIndex].Y - APosition.Y);
end;

procedure TdxCustomFlowChart.TConnectionHighlights.Populate(X, Y,
  ATolerance: Integer);
var
  I, J: Integer;
  AObject: TdxFcObject;
...
begin
  ...
  if (PointInfo <> nil) and
    (GetSquareDistance(PointInfo.&Object, PointInfo.Index, P) <
    AMinSquareDistance) then
  begin
  ...
  begin
    AObject := Chart.Objects[I];
    if CanHighlightObject(AObject) and AObject.ContainsPoint(X, Y, ATolerance)
    then
    begin
      FObjects.Add(AObject);
...
procedure TdxCustomFlowChart.TConnectionHighlights.UpdateHighlightedObject(X,
  Y: Integer);
begin
  ClearObjectHighlights;
...
begin
  ...
  FOptions := [fcoCanDelete, fcoCanDrag, fcoCanSelect, fcoMultiSelect,
    fcoHideSelection, fcoDelOnClick];
  ...
  FHorizontalScrollAnimationHelper :=
    TdxFlowChartHorizontalScrollAnimationHelper.Create(Self);
  FVerticalScrollAnimationHelper := TdxFlowChartVerticalScrollAnimationHelper.
    Create(Self);
  DoubleBuffered := True;
...
class function TdxCustomFlowChart.CreateArrowShapeRepository
...
begin
  ...
  begin
    ...
    if (AConnection.ObjectSource = nil) or (AConnection.ObjectDest = nil) then
      Continue;
    AEdges[I] := TdxEdge<TdxDiagramItem>.Create(AConnection.ObjectSource,
      AConnection.ObjectDest);
  end;
...
begin
  Result := TdxPageInfo.Create(TdxSizeDouble.Create(500, 500),
    TdxRectDouble.Null);
end;

function TdxCustomFlowChart.CreateSugiyamaLayoutSettings
  : TdxSugiyamaLayoutSettings;
begin
  Result := TdxSugiyamaLayoutSettings.Create
    (GridLineOptions.DefaultMinorLineStep * 3,
    GridLineOptions.DefaultMinorLineStep * 3, TopToBottom);
end;

procedure TdxCustomFlowChart.ApplySugiyamaPositionInfo
  (AInfo: TdxSugiyamaPositionsInfo; AUseDummyEdges: Boolean);
var
  I, J: Integer;
  AMinX, AMinY: Double;
  AObject: TdxFcObject;
...
begin
  ...
  try
    ...
    begin
      ...
      AObject.SetBounds(Round(APosition.X), Round(APosition.Y), AObject.Width,
        AObject.Height);
    end;
    ...
    begin
      ...
      begin
        ...
        AEdge := TdxEdge<TdxDiagramItem>.Create(AConnection.ObjectSource,
          AConnection.ObjectDest);
  ...
  begin
    if APoint.Y <= ACenter.Y then
      if APoint.X <= ACenter.X then
        ...
        Exit(1)
    else if APoint.X <= ACenter.X then
      Exit(2)
    else
      Exit(3)
  end;
...
begin
  ...
  ACenterOfGraph := TdxFcObject.GetBoundingRect(APoints, Length(APoints))
    .CenterPoint;
  for I := 0 to ConnectionCount - 1 do
  begin
    AConnection := Connections[I];
      ...
      case AQuadrantIndex1 of
        0:
          if (P1.X <= P2.X) <> (P1.Y <= P2.Y) then
            AConnection.AddPoint(TPoint.Create(Min(P1.X, P2.X),
              Min(P1.Y, P2.Y)));
        1:
          if (P1.X <= P2.X) = (P1.Y <= P2.Y) then
            AConnection.AddPoint(TPoint.Create(Max(P1.X, P2.X),
              Min(P1.Y, P2.Y)));
        2:
          if (P1.X <= P2.X) = (P1.Y <= P2.Y) then
            AConnection.AddPoint(TPoint.Create(Min(P1.X, P2.X),
...
begin
  ...
  AGraph := CreateGraph;
  try
    ASettings := TdxGraphSugiyamaLayoutSettings.Create(ASugiyamaLayoutSettings,
      CreateGraphPageInfo);
    try
      AInfo := TdxSugiyamaLayout.LayoutGraph(AGraph,
        ...
        begin
          Result.Init(TdxFcObject(AItem).Width + 2 * AMargin,
...
procedure TdxCustomFlowChart.Notification(AComponent: TComponent;
...
const
  BorderStyleMap: array [TcxControlBorderStyle] of TBorderStyle = (bsNone,
    bsSingle);
begin
...
const
  BorderStyleMap: array [TBorderStyle] of TcxControlBorderStyle = (cxcbsNone,
    cxcbsDefault);
begin
...
begin
  ...
  begin
    ...
    ANeedUpdateConnections := (fcoAutoRouteConnections in Options) <>
      (fcoAutoRouteConnections in Value);
    ANeedRepaintSelection := ([fcoCanDrag, fcoCanRotate] * Options) <>
      ([fcoCanDrag, fcoCanRotate] * Value);
    FOptions := Value;
...
procedure TdxCustomFlowChart.SetConnection(Index: Integer;
Value: TdxFcConnection);
begin
...
procedure TdxCustomFlowChart.CalculateChartSizes;
  ...
  procedure CombainRects(R: TRect; var AResult: TRect);
  begin
    R := ScrollRect(R);
    AResult.Init(Min(R.Left, AResult.Left), Min(R.Top, AResult.Top),
...
begin
  ...
  begin
    AObject := Objects[I];
    CombainRects(AObject.GetBoundsForRotatedRect(AObject.DisplayRect), ANewR);
  end;
  for I := 0 to ConnectionCount - 1 do
    CombainRects(Connections[I].DisplayRect, ANewR);
...
function TdxCustomFlowChart.ScrollPoint(const P: TPoint;
APositiveFactor: Boolean = True): TPoint;
begin
  Result := cxPointOffset(P, LeftEdge, TopEdge, APositiveFactor);
end;

function TdxCustomFlowChart.ScrollRect(const R: TRect;
APositiveFactor: Boolean = True): TRect;
begin
...
function TdxCustomFlowChart.CreateObject(L, T, W, H: Integer;
AShape: TdxFcShapeType): TdxFcObject;
begin
  Result := InternalCreateObject;
  if Assigned(OnCreateItem) then
    OnCreateItem(Self, Result);
  Result.FShapeType := AShape;
  Result.SetBounds(L, T, W, H);
end;

function TdxCustomFlowChart.CreateObject(L, T, W, H: Integer;
AAdvancedShape: TdxFlowChartObjectAdvancedShape): TdxFcObject;
begin
  Result := InternalCreateObject;
  if Assigned(OnCreateItem) then
    OnCreateItem(Self, Result);
...
function TdxCustomFlowChart.CreateConnection(OSrc, ODst: TdxFcObject;
PSrc, PDst: Byte): TdxFcConnection;
begin
...
begin
  if ObjectCount + ConnectionCount = 0 then
    Exit;
  BeginUpdate;
...
procedure TdxCustomFlowChart.DoDrawObjectEx(AObject: TdxFcObject;
AGraphics: TdxGPGraphics; const APaintData: TdxFcDrawExEventPaintData);
begin
  if HasDrawObjectEx then
    OnDrawObjectEx(Self, AObject, AGraphics, APaintData);
end;

function TdxCustomFlowChart.IsMultiSelectShiftState
...
procedure TdxCustomFlowChart.InitScrollBarsParameters;
  ...
  function DoSetScrollBarInfo(AKind: TScrollBarKind;
  APage, AMin, ASize: Integer): Integer;
  var
...
begin
  if HandleAllocated then
  begin
    ANewX := DoSetScrollBarInfo(sbHorizontal, ClientWidth, FChartLeft,
      FChartWidth);
    ANewY := DoSetScrollBarInfo(sbVertical, ClientHeight, FChartTop,
      FChartHeight);
...
function TdxCustomFlowChart.InternalMouseWheel(Shift: TShiftState;
...
function TdxCustomFlowChart.IsMouseWheelHandleNeeded(Shift: TShiftState;
WheelDelta: Integer; MousePos: TPoint): Boolean;
begin
...
procedure TdxCustomFlowChart.ProcessMouseDown(Button: TMouseButton;
Shift: TShiftState; X, Y: Integer);
begin
  if (htOnObject in FHitTestResult) and FObjectAt.Selected and
    not IsMultiSelectShiftState(Shift) then
    FObjectAt.SelectUnion
  else if FHitTestResult * [htOnObject, htOnConnection, htOnConLabel,
    htOnArrowSrc, htOnArrowDst] <> [] then
  begin
...
const
  ConnectionHitTest: TdxFcHitTest = [htOnConnection, htOnConLabel, htOnArrowSrc,
    htOnArrowDst];
  ...
  begin
    ...
    Result := (Sqr(ACursorPoint.X - P.X) + Sqr(ACursorPoint.Y - P.Y)) <
      ASquareDistance;
    if Result then
  ...
  begin
    Result := (SelectedObject <> nil) and SelectedObject.PointOnRotationMark(P);
  end;

  function IsPointInSelectedObjectParameterMark(const P: TPoint;
...
var
  ...
  P: TPoint;
begin
  if (FHitTestResult <> []) and (X = FHitX) and (Y = FHitY) then
    Exit;
  ...
  if (htOnObject in FHitTestResult) and
    (FHitTestResult * ConnectionHitTest <> []) then
  begin
  ...
  if (fcoUseShapeParameters in Options) and IsPointInSelectedObjectParameterMark
    (P, AParameterIndex) then
  begin
    FObjectAt := SelectedObject;
  ...
  begin
    ...
    begin
      if (I > AStartPointIndex) and (I < AEndPointIndex) and not CanDragConnectionIntermediatePoints
      then
        Continue;
...
begin
  ...
  if Result = 0 then
    Exit;
  Opt := Options;
  FOptions := Opt + [fcoCanSelect, fcoMultiSelect];
  Sel1 := OnSelected;
  OnSelected := nil;
  Sel2 := OnSelection;
  OnSelection := nil;
...
begin
  ...
  try
    ...
    begin
      AConnection := Connections[I];
      AConnection.Move(DX, DY, ChartPointToDisplayPoint(P));
    end;
    RestoreSel(EndSel);
  finally
    UnlockScrollBars;
...
procedure TdxCustomFlowChart.StartExternalDrag(const AScreenPoint: TPoint;
const ACreateObject: TCreateObjectReference);
var
  AObject: TdxFcObject;
...
begin
  ...
  AObject.SetBounds(AChartPoint.X - (ADefaultObjectSize.cx div 2),
    AChartPoint.Y - (ADefaultObjectSize.cy div 2), ADefaultObjectSize.cx,
  ...
  FHitTestResult := [htByObject, htOnObject];
  FObjectAt := AObject;
  DragHelper.DragStart(ALocalPoint.X, ALocalPoint.Y,
    TdxFlowChartDragHelper.TFlowChartDragKind.Move);
end;

procedure TdxCustomFlowChart.StartConnectionEndpointHighlight(X, Y: Integer);
begin
  StopConnectionEndpointHighlight;
  FConnectionHighlights := TConnectionHighlights.Create(Self, X, Y,
    ScaleFactor.Apply(24));
end;
...
procedure TdxCustomFlowChart.KeyDown(var Key: Word; Shift: TShiftState);
  ...
  begin
    ...
    for I := 0 to ObjectCount - 1 do
    begin
      if Objects[I].Selected or not Objects[I].Visible then
        Continue;
  ...
  if Shift = [ssCtrl] then
    case Key of
      ...
      VK_NEXT:
        TopEdge := TO_END;
      VK_HOME:
        SetLeftTop(TO_HOME, TO_HOME);
      VK_END:
        SetLeftTop(TO_END, TO_END);
    end;
  if Shift = [] then
    case Key of
      VK_DELETE:
        if fcoCanDelete in Options then
          DeleteSelection;
      VK_NEXT:
        ScrollVert(1);
      VK_PRIOR:
...
procedure TdxCustomFlowChart.LookAndFeelChanged(Sender: TcxLookAndFeel;
...
begin
  ...
  begin
    ...
    else if not IsScrollBarsArea(Point(X, Y)) and Focused and (ssLeft in Shift)
      and (Abs(X - FDragStartPoint.X) + Abs(Y - FDragStartPoint.Y) > 4) then
      DragHelper.CheckDragStart(X, Y, Shift, FHitTestResult);
  end
  else
  begin
...
procedure TdxCustomFlowChart.AdjustEdge(AMin, AMax: Integer;
var AValue: Integer);
begin
...
begin
  ...
  try
    ...
    begin
      if AFlowChartNode.Attributes.GetValueAsInteger('Version', 1) > CurrentXMLVersion
      then
        Exit;
...
begin
  ...
  try
    ...
    ARootNode.Attributes.SetValueAsBoolean('AutoRoute', fcoAutoRouteConnections
      in Options);
...
begin
  Result := FHorizontalScrollAnimationHelper.IsAnimationActive or
    FVerticalScrollAnimationHelper.IsAnimationActive;
end;

function TdxCustomFlowChart.CanCreateNewConnectionOnDrag: Boolean;
begin
  Result := (ObjectAt <> nil) and ObjectAt.Selected and
    ([htOnObject, htOnSelPoint, htOnRotateMark] * FHitTestResult = []);
end;
...
procedure TdxCustomFlowChart.ChangeScaleEx(M: Integer; D: Integer;
isDpiChange: Boolean);
var
  I: Integer;
begin
...
begin
  ...
  Result.X := MulDiv(P.X - LeftEdge, RealZoom, 100) + AOffset.X;
  Result.Y := MulDiv(P.Y - TopEdge, RealZoom, 100) + AOffset.Y;
end;
...
begin
  ...
  if AAnimationScrollHelper.IsAnimationActive and (AScrollCode in [scTrack])
  then
  ...
  else if AScrollBarKind = sbHorizontal then
    SetLeftEdge(APos)
  else
    SetTopEdge(APos);
...
procedure TdxCustomFlowChart.ValidateObjectsResizing(var ASelection
  : TdxFcSelectionPoints);
var
...
begin
  inherited;
  if fcoHideSelection in Options then
    InvalidateSel;
end;
...
begin
  ...
  if (csDesigning in ComponentState) and
    not(Msg.Result in [HTHSCROLL, HTVSCROLL]) then
    Msg.Result := HTCLIENT;
end;
...
constructor TdxFlowChartGridLineOptions.Create(AOwner: TdxFlowChartGridOptions;
AColor: TColor; AStyle: TPenStyle);
begin
  inherited Create;
  FOwner := AOwner;
  FColor := AColor;
...
begin
  ...
  begin
    ...
    FMinZoomThresholdForMinorLines := TdxFlowChartGridOptions(Source)
      .MinZoomThresholdForMinorLines;
  end
  else
    inherited Assign(Source);
end;
...
function TdxFlowChartGridOptions.CreateLines(AColor: TColor; AStyle: TPenStyle)
  : TdxFlowChartGridLineOptions;
begin
...
procedure TdxFlowChartGridOptions.SetMajorLines(const Value
  : TdxFlowChartGridLineOptions);
begin
  FMajorLines.Assign(Value);
end;

procedure TdxFlowChartGridOptions.SetMinorLines(const Value
  : TdxFlowChartGridLineOptions);
begin
  FMinorLines.Assign(Value);
end;

procedure TdxFlowChartGridOptions.SetMinZoomThresholdForMinorLines
  (Value: Integer);
begin
  Value := Max(Value, 1);
...
procedure TdxFlowChartGridOptions.SetOriginLines(const Value
  : TdxFlowChartGridLineOptions);
begin
...
begin
  ...
  begin
    ...
    FRealPoints[AIndex] := Owner.ChartPointToDisplayPoint(AValue);
    CalculateDisplayRect;
    Changed;
    Owner.SetChartSizes;
  end;
...
begin
  ...
  FRealPoints.Insert(AIndex, Owner.ChartPointToDisplayPoint(P));
end;
...
begin
  Owner.FHitTestResult := [];
  if Destroying or (FPoints.Count < 2) then
    Exit;
...
function TdxFcConnection.CalculatePrevDirectionBasedPoint
  (AForSource: Boolean): TPoint;
var
  AEndpoint: TPoint;
  APointCount: Integer;
begin
...
begin
  ...
  begin
    P := FPoints[I];
    FRealPoints[I] := Owner.ChartPointToDisplayPoint(P);
  end;
end;
...
procedure TdxFcConnection.SetObjectPoints;
  ...
  procedure SetPoint(AObject: TdxFcObject; Arrow: TdxFcConnectionArrow;
  ALinkedPointIndex, APointIndex: Integer);
  begin
...
begin
  if Destroying or (FPoints.Count < 1) then
    Exit;
  if (ObjectSource <> nil) and (ObjectDest <> nil) and Owner.NeedAdjustObjectsPoints
  then
...
procedure TdxFcConnection.AdjustObjectsPoints(var APointSource,
  APointDest: Byte);

  function IsValidLinkedPointIndex(AObject: TdxFcObject;
...
begin
  ...
  begin
    ...
    begin
      ...
      ASquareDistance := ASourcePoint.SquareOfDistance(ASourceCenter) +
        ASourcePoint.SquareOfDistance(ADestPoint) + ADestPoint.SquareOfDistance
        (ADestCenter);
...
begin
  ...
  begin
    ...
    FPoints[0] := ASource.Owner.DisplayPointToChartPoint(P);
  end;
  if ASource.ObjectDest <> nil then
  begin
    P := ASource.ObjectDest.LinkedPoints[ASource.PointDest];
    FPoints[FPoints.Count - 1] := ASource.Owner.DisplayPointToChartPoint(P);;
  end;
  Calculate;
end;
...
function FindNearestLinkedPointIndex(const P: TPoint;
AObject: TdxFcObject): Byte;
var
  AMinSquareDistance, ASquareDistance: Int64;
...
begin
  ...
  begin
    ...
    ASquareDistance := ALinkedPoint.SquareOfDistance(AObjectCenter) +
...
begin
  ...
  if RealCount > 2 then
  begin
    FPointSource := FindNearestLinkedPointIndex
      (CalculatePrevDirectionBasedPoint(True), ObjectSource);
    FPointDest := FindNearestLinkedPointIndex
      (CalculatePrevDirectionBasedPoint(False), ObjectDest);
  end
  else
    AdjustObjectsPoints(FPointSource, FPointDest);
  SetObjectPoints;
...
begin
  ...
  begin
    ...
    begin
      ...
      Dec(P2.X, X);
      Dec(P2.Y, Y);
      if (P0.X * P2.X) + (P0.Y * P2.Y) < (P0.X * P1.X) + (P0.Y * P1.Y) then
        Inc(I);
    end;
  end;
...
begin
  ...
  Owner.Painter.DrawPolyline(AGraphics, P, Color, PenStyle, GetActualPenWidth,
    Owner.PaintScaleFactor.ApplyF(1));
  P := nil;
  if Text <> '' then
    AGraphics.RestoreClipRegion;
end;
...
begin
  ...
  begin
    R := RealTextRect;
    R.Offset(0, -1);
    cxTextOut(ACanvas.Handle, Text, R, CXTO_CENTER_HORIZONTALLY or
      CXTO_CENTER_VERTICALLY, RealFont, 0);
  end;
end;
...
begin
  Result := not Owner.IsDestroying and not Owner.DragHelper.IsDraggingConnection
    (Self) and (FPoints.Count >= 2);
end;
...
begin
  ...
  SetObjectSource(Owner.Objects[AAttributes.GetValueAsInteger('Source')],
    AAttributes.GetValueAsInteger('SourcePoint'));
  SetObjectDest(Owner.Objects[AAttributes.GetValueAsInteger('Destination')],
    AAttributes.GetValueAsInteger('DestinationPoint'));
...
procedure TdxFlowChartPainter.DrawEdge(ACanvas: TcxCanvas; const R: TRect;
AEdgeStyle, ABorderStyle: Cardinal);
var
  R1: TRect;
begin
  R1 := R;
...
procedure TdxFlowChartPainter.DrawHorizontalLines(ACanvas: TcxCanvas;
const AClientBounds: TRect; AEdgeSize, AGridSize: Integer;
AIsMajorLines: Boolean; AScaleFactor: TdxScaleFactor);
var
...
procedure TdxFlowChartPainter.DrawVerticalLines(ACanvas: TcxCanvas;
const AClientBounds: TRect; AEdgeSize, AGridSize: Integer;
AIsMajorLines: Boolean; AScaleFactor: TdxScaleFactor);
var
...
procedure TdxFlowChartPainter.DrawGrid(ACanvas: TcxCanvas;
const AClientBounds: TRect; AGridOptions: TdxFlowChartGridOptions);
var
  AGridSize: Integer;
  AEdgeSizes: TSize;
  AScaleFactor: TdxScaleFactor;
begin
  ...
  begin
    ...
    DrawVerticalLines(ACanvas, AClientBounds, AEdgeSizes.cx, AGridSize, False,
      AScaleFactor);
    DrawHorizontalLines(ACanvas, AClientBounds, AEdgeSizes.cy, AGridSize, False,
      AScaleFactor);
  end;

  AGridOptions.MajorLines.SetupCanvas(ACanvas);
  DrawVerticalLines(ACanvas, AClientBounds, AEdgeSizes.cx, AGridSize, True,
    AScaleFactor);
  DrawHorizontalLines(ACanvas, AClientBounds, AEdgeSizes.cy, AGridSize, True,
    AScaleFactor);
...
procedure TdxFlowChartPainter.DrawGridOrigin(ACanvas: TcxCanvas;
const AClientBounds: TRect; const AOrigin: TPoint);
begin
...
procedure TdxFlowChartPainter.DrawRectangle(ACanvas: TcxCanvas; const R: TRect;
ABackgroundColor: TColor; AFrameColor: TColor; AFrameStyle: TPenStyle;
AFrameWidth: Integer);
begin
  ACanvas.SaveState;
...
ARegionHandle: TcxRegionHandle; ABackgroundColor: TColor; AFrameColor: TColor;
AFrameWidth: Integer);
begin
  ...
  begin
    ACanvas.SaveState;
    try
      ACanvas.DrawRegion(ARegionHandle, ABackgroundColor, AFrameColor,
        AFrameWidth, AFrameWidth);
    finally
      ACanvas.RestoreState;
    end;
  end;
...
procedure TdxFlowChartPainter.DrawRoundRect(ACanvas: TcxCanvas; const R: TRect;
ABackgroundColor: TColor; AFrameColor: TColor; AFrameStyle: TPenStyle;
AFrameWidth, ARadiusX, ARadiusY: Integer);
begin
  ACanvas.SaveState;
  try
    PrepareBrush(ACanvas, ABackgroundColor);
    PreparePen(ACanvas, AFrameColor, AFrameStyle, AFrameWidth);
    ACanvas.Canvas.RoundRect(R.Left, R.Top, R.Right, R.Bottom, ARadiusX,
      ARadiusY);
  finally
    ACanvas.RestoreState;
  end;
...
procedure TdxFlowChartPainter.PreparePen(ACanvas: TcxCanvas; AColor: TColor;
AStyle: TPenStyle; AWidth: Integer);
begin
  if AColor = clNone then
...
procedure TdxFlowChartPainter.DrawPolyline(AGraphics: TdxGPGraphics;
const P: array of TPoint; AColor: TColor; AStyle: TPenStyle;
AWidth, AScale: Single);
var
  APen: TdxGPPen;
begin
  if Length(P) > 1 then
  begin
    APen := TdxGPPen.Create(TdxAlphaColors.FromColor(AColor), AWidth,
      AStyle, AScale);
    try
      AGraphics.Polyline(P, APen);
    finally
...
constructor TdxFlowChartDragHelper.TDragOperation.Create
  (AOwner: TdxFlowChartDragHelper);
begin
  FOwner := AOwner;
end;
...
begin
  Result := TdxGuideController.Create(procedure(AController: TdxGuideController)
    var
      I: Integer;
      AObject: TdxFcObject;
    begin
    ...
    end, Chart.ObjectCount, Chart.ScaleFactor.Apply(6),
    Chart.ScaleFactor.Apply(10));
end;
...
function TdxFlowChartDragHelper.TDragOperation.CheckIsKeyPressed
...
function TdxFlowChartDragHelper.TDragOperation.CreateSemitransparentHelper
  : TdxFlowChartCustomSemitransparentDragHelper;
begin
  Result := nil;
end;
...
function TdxFlowChartDragHelper.TDragOperation.GetGuideController
  : TdxGuideController;
begin
  Result := nil;
end;
...
function TdxFlowChartDragHelper.TConnectionPointOperation.GetConnection
  : TdxFcConnection;
begin
...
begin
  ...
  Connection.FRealPoints[FDragPointIndex] :=
    Chart.ConnectionHighlights.GetDestinationPoint(X, Y);
  Connection.ConnectionChanged;
  Chart.Invalidate;
end;

procedure TdxFlowChartDragHelper.TEndpointOperation.SetEndpointObject
  (AObject: TdxFcObject; ALinkedPointIndex: Integer);
begin
...
procedure TdxFlowChartDragHelper.TIntermediatePointOperation.Enter(X,
  Y: Integer);
begin
  inherited Enter(X, Y);
  FBase.X := 0;
...
procedure TdxFlowChartDragHelper.TIntermediatePointOperation.Move(X,
  Y: Integer);
begin
  FBase.X := 1;
...
procedure TdxFlowChartDragHelper.TIntermediatePointOperation.Leave(X,
  Y: Integer);
      ...
      case Connection.Style of
        ...
        fclStraight:
          begin
            P[0] := FBase;
            P[1] := FMobile;
            Result := PtOnLine(liStraight, P[0], Length(P), Screen.Width shr 9,
              ACurPoint.X, ACurPoint.Y);
          end;
      end;
    end;
  end;
...
procedure TdxFlowChartDragHelper.TIntermediatePointOperation.
  SetConnectionIntermediatePoint(X, Y, AIndex: Integer);
begin
...
procedure TdxFlowChartDragHelper.TMoveOperation.OffsetObjects(ADragStartPoint,
  ADragFinishPoint: TPoint; AChangeObjectBounds: Boolean);
begin
  ...
  begin
    ...
    Chart.OffsetObjects(ADragFinishPoint.X - ADragStartPoint.X,
      ADragFinishPoint.Y - ADragStartPoint.Y);
    if GuideController <> nil then
      GuideController.UpdateGuides;
  end
  else
    Owner.SemitransparentHelper.Offset(ADragFinishPoint.X - ADragStartPoint.X,
      ADragFinishPoint.Y - ADragStartPoint.Y);
end;
...
begin
  ...
  FMouseOffset.Init(InitialDragObjectLocation.X - X,
    InitialDragObjectLocation.Y - Y);
...
begin
  ...
  begin
    ...
    if (not AlignWithGrid and (AGuideDeltaX <> MaxInt)) or
      (Abs(AGuideDeltaX) < Abs(ADeltaX)) then
      ADeltaX := AGuideDeltaX;
    if (not AlignWithGrid and (AGuideDeltaY <> MaxInt)) or
      (Abs(AGuideDeltaY) < Abs(ADeltaY)) then
...
procedure TdxFlowChartDragHelper.TMoveOperation.UpdateGuides
  (const ABounds: TRect);
begin
  if GuideController <> nil then
  begin
...
function TdxFlowChartDragHelper.TMoveOperation.CreateSemitransparentHelper
  : TdxFlowChartCustomSemitransparentDragHelper;
begin
  Result := TdxFlowChartMovingDragHelper.Create(Chart,
    cxDragAndDropWindowTransparency);
end;
...
function TdxFlowChartDragHelper.TMoveOperation.GetChartGridPoint
  (const P: TPoint): TPoint;
begin
  Result := GetChartGridPoint(P.X, P.Y)
end;

function TdxFlowChartDragHelper.TMoveOperation.GetChartGridPoint(X,
  Y: Integer): TPoint;
begin
...
function TdxFlowChartDragHelper.TMoveOperation.GetGuideController
  : TdxGuideController;
begin
...
var
  AAngle: Single;
begin
  AAngle := FSaveAngle + GetAngleABC(MouseDownPos, FCenterPoint,
    TPoint.Create(X, Y));
...
function TdxFlowChartDragHelper.TSelectionOperation.CreateSemitransparentHelper
  : TdxFlowChartCustomSemitransparentDragHelper;
begin
  Result := TdxFlowChartSelectionDragHelper.Create(Chart,
    cxDragAndDropWindowTransparency);
end;
...
constructor TdxFlowChartDragHelper.TResizeOperation.Create
  (AOwner: TdxFlowChartDragHelper);
begin
  inherited Create(AOwner);
...
function TdxFlowChartDragHelper.TResizeOperation.CreateSemitransparentHelper
  : TdxFlowChartCustomSemitransparentDragHelper;
begin
  Result := TdxFlowChartMovingDragHelper.Create(Chart,
    cxDragAndDropWindowTransparency);
...
const
  Markers: array [0 .. 7] of TdxResizeMarker = (TdxResizeMarker.TopLeft,
    TdxResizeMarker.Top, TdxResizeMarker.TopRight, TdxResizeMarker.Right,
    TdxResizeMarker.BottomRight, TdxResizeMarker.Bottom,
    TdxResizeMarker.BottomLeft, TdxResizeMarker.Left);
begin
...
begin
  ...
  begin
    if Marker in [TdxResizeMarker.TopLeft, TdxResizeMarker.TopRight,
      TdxResizeMarker.BottomRight, TdxResizeMarker.BottomLeft] then
...
function TdxFlowChartDragHelper.TResizeOperation.CalculateResizingRectangle
  (const ADeltaX, ADeltaY: Single): TdxRectF;
begin
  Result := Bounds;
  if Marker in [TdxResizeMarker.Right, TdxResizeMarker.TopRight,
    TdxResizeMarker.BottomRight] then
    Result.Right := Result.Right + ADeltaX;
  if Marker in [TdxResizeMarker.Top, TdxResizeMarker.TopLeft,
    TdxResizeMarker.TopRight] then
    Result.Top := Result.Top + ADeltaY;
  if Marker in [TdxResizeMarker.Left, TdxResizeMarker.TopLeft,
    TdxResizeMarker.BottomLeft] then
    Result.Left := Result.Left + ADeltaX;
  if Marker in [TdxResizeMarker.Bottom, TdxResizeMarker.BottomLeft,
    TdxResizeMarker.BottomRight] then
    Result.Bottom := Result.Bottom + ADeltaY;
end;

function TdxFlowChartDragHelper.TResizeOperation.
  ConvertResizingRectangleToObjectBound(const ARectangle: TdxRectF): TRect;
var
  ANewBounds: TdxRectF;
...
begin
  ...
  ANewBounds.Offset(FFixedPoint.X - ANewFixedPoint.X,
    FFixedPoint.Y - ANewFixedPoint.Y);
  Result := Chart.GetItemBounds(TRect.Round(ANewBounds));
end;

procedure TdxFlowChartDragHelper.TResizeOperation.CheckAspectUsingCornerHandles
  (var ADeltaX, ADeltaY: Single);
var
  ARatio: Single;
  ARect: TdxRectF;
  ASign: Integer;
begin
  ...
  ASign := IfThen(Marker in [TdxResizeMarker.BottomLeft,
    TdxResizeMarker.TopRight], -1, 1);
  ARect := CalculateResizingRectangle(ADeltaX, ASign * ADeltaX * ARatio);

  case Marker of
    TdxResizeMarker.TopLeft, TdxResizeMarker.TopRight:
      ARect.Top := ARect.Top + CapturePoint.Y - Bounds.Top;
    TdxResizeMarker.BottomLeft, TdxResizeMarker.BottomRight:
      ARect.Bottom := ARect.Bottom + CapturePoint.Y - Bounds.Bottom;
  end;

  if (CapturePoint.Y + ADeltaY < ARect.Top) or
    (CapturePoint.Y + ADeltaY > ARect.Bottom) then
    ADeltaX := ASign * ADeltaY / ARatio
  else
    ADeltaY := ASign * ADeltaX * ARatio;
end;

function TdxFlowChartDragHelper.TResizeOperation.GetActualMarker
  (const ABounds: TdxRectF): TdxResizeMarker;
begin
  Result := Marker;
  ...
  begin
    case Marker of
      TdxResizeMarker.TopLeft:
        Result := TdxResizeMarker.BottomRight;
      TdxResizeMarker.Top:
        Result := TdxResizeMarker.Bottom;
      TdxResizeMarker.TopRight:
        Result := TdxResizeMarker.BottomLeft;
      TdxResizeMarker.Left:
        Result := TdxResizeMarker.Right;
      TdxResizeMarker.Right:
        Result := TdxResizeMarker.Left;
      TdxResizeMarker.BottomRight:
        Result := TdxResizeMarker.TopLeft;
      TdxResizeMarker.Bottom:
        Result := TdxResizeMarker.Top;
      TdxResizeMarker.BottomLeft:
        Result := TdxResizeMarker.TopRight;
    end;
  end
  else
  begin
...
function TdxFlowChartDragHelper.TResizeOperation.GetDisplayedFixedPoint
  (const ABounds: TdxRectF; AMarker: TdxResizeMarker): TdxPointF;
begin
  case AMarker of
    TdxResizeMarker.TopLeft:
      Result := ABounds.BottomRight;
    TdxResizeMarker.Top:
      Result := TdxPointF.Create((ABounds.Left + ABounds.Right) / 2,
        ABounds.Bottom);
    TdxResizeMarker.TopRight:
      Result := ABounds.BottomLeft;
    TdxResizeMarker.Right:
      Result := TdxPointF.Create(ABounds.Left,
        (ABounds.Top + ABounds.Bottom) / 2);
    TdxResizeMarker.Left:
      Result := TdxPointF.Create(ABounds.Right,
        (ABounds.Top + ABounds.Bottom) / 2);
    TdxResizeMarker.BottomRight:
...
procedure TdxFlowChartDragHelper.TResizeOperation.ValidateBoundsAlignment
  (var ANewBounds: TdxRectF; AMarker: TdxResizeMarker);
var
...
begin
  ...
  begin
    ...
    if SnapToGuides then
      GuideController.GetSnappedResizePoints(ABounds, AMarker, ALeftTop,
        ABottomRight);
  end;
  case AMarker of
    TdxResizeMarker.Left:
  ...
  try
    ...
    begin
      if SnapToGuides then
        Chart.Selection.Guides.UpdateByResizing(GuideController,
          TRect.Round(ANewBounds), AMarker)
      else
        Chart.Selection.Guides.Reset;
    end;
  end;
...
function TdxFlowChartDragHelper.TResizeOperation.GetGuideController
  : TdxGuideController;
begin
  Result := FGuideController;
end;
...
begin
  ...
  begin
    AMatrix := TdxGPMatrix.Create;
    AMatrix.Rotate(-FObject.Angle, TdxPointF.Create(ABounds.Left + ABounds.Width
      / 2, ABounds.Top + ABounds.Height / 2));
  end
  else
    AMatrix := nil;
...
procedure TdxFlowChartDragHelper.DragStart(X, Y: Integer;
AKind: TFlowChartDragKind);
var
  ACursor: TCursor;
begin
  FCancelled := False;
...
procedure TdxFlowChartDragHelper.SetupDragConnection
  (AConnection: TdxFcConnection; AIndex: Integer);
begin
...
begin
  Result := not(fcoPreventAddingElbowConnections in Owner.Options) and
    not Owner.AutoRouting;
end;
...
const AShift: TShiftState; const AHitTest: TdxFcHitTest);
  ...
  begin
    ...
    begin
      ...
      FDragConnection := Owner.CreateConnection(ObjectAt, ObjectAt,
        APoint, APoint);
  ...
  begin
    ...
    begin
      ...
      if FDragConnection.ObjectSource <> nil then
        Inc(FDragPointIndex);
      if (FDragPointIndex = 0) or
        (FDragPointIndex = FDragConnection.RealCount - 1) then
        DragStart(X, Y, TFlowChartDragKind.Endpoint)
      else
...
begin
  ...
  begin
    ...
    else if (fcoCanDrag in Owner.Options) and not CheckNewConnectionDragMode
    then
    begin
      ...
      else if (htOnConnection in AHitTest) and
        (ConnectionAt = Owner.SelectedConnection) and CanAddNewPointToConnection
      then
        AddNewConnectionPoint
      else if (AHitTest = [htNowhere]) and
        ([fcoMultiSelect, fcoCanSelect] * Owner.Options = [fcoMultiSelect,
        fcoCanSelect]) then
...
function TdxFlowChartDragHelper.IsDraggingConnection
  (AConnection: TdxFcConnection): Boolean;
begin
  Result := (DragKind = TFlowChartDragKind.IntermediatePoint) and
    (DragConnection = AConnection);
end;
...
begin
  Result := (FSemitransparentHelper <> nil) and
    FSemitransparentHelper.SpecialControlPainting;
end;
...
begin
  if FShape <> nil then
    S := FShape.GetActualSize(TSize.Create(Width, Height), Owner.PenWidth,
      Owner.Owner.PaintScaleFactor.ApplyF(1), False)
  else
    S.Init(MulDiv(Width, Owner.Owner.RealZoom, 100),
      MulDiv(Height, Owner.Owner.RealZoom, 100));
  FRealWidth := S.cx;
  FRealHeight := S.cy;
end;
...
begin
  ...
  begin
    Result := FShape.GetActualSize(FShape.DefaultSize, 1,
      SizeScales[Value], True);
...
begin
  if not Active then
    Exit;
  FShape.Draw(AGraphics, FPoints[0], FPoints[1],
    TSize.Create(GetUnscaled(Width), GetUnscaled(Height)),
    Owner.Owner.PaintScaleFactor.ApplyF(1), Owner.PenWidth,
    TdxAlphaColors.FromColor(Owner.Color), TdxAlphaColors.FromColor(Color));
end;
...
begin
  ...
  if not ParentFont then
    dxAssignFont(Font, ASource.Font, Owner.ScaleFactor,
      ASource.Owner.ScaleFactor);
end;
...
begin
  ...
  try
    ...
    Font.Height := Owner.ScaleFactor.Apply
      (AAttributes.GetValueAsInteger('Height'));
...
procedure TdxFcItem.MouseDown(Button: TMouseButton; Shift: TShiftState;
X, Y: Integer);
begin
end;
...
procedure TdxFcItem.MouseUp(Button: TMouseButton; Shift: TShiftState;
X, Y: Integer);
begin
end;
...
begin
  ...
  AAttributes.SetValueAsInteger('Height',
    Owner.ScaleFactor.Revert(Font.Height));
...
procedure TdxFlowChartCustomSemitransparentDragHelper.AfterSelectionPaint
  (AGraphics: TdxGPGraphics);
begin
  inherited;
...
function TdxFlowChartCustomSemitransparentDragHelper.GetChart
  : TdxCustomFlowChart;
begin
  Result := TdxCustomFlowChart(Control);
end;

function TdxFlowChartCustomSemitransparentDragHelper.GetDragHelper
  : TdxFlowChartDragHelper;
begin
...
procedure TdxFlowChartMovingDragHelper.PaintControlSelection
  (ACanvas: TcxCanvas);
var
  AObject: TdxFcObject;
begin
...
procedure TdxFlowChartSelectionDragHelper.PaintControlSelection
  (ACanvas: TcxCanvas);
var
  AGraphics: TdxGPGraphics;
  APen: TdxGPPen;
...
begin
  ...
  dxRegisterCursor(crFlChartDrawFreeConnector, HInstance,
    'DXFCDRAWFREECONNECTOR');
  ...
  dxRegisterCursor(crFlChartDrawConnectedConnector, HInstance,
    'DXFCDRAWCONNECTEDCONNECTOR');
...
class function TdxFlowChartEditorOptions.CreateLegacyOptions
  : TdxFlowChartEditorOptions;
begin
...
class function TdxFlowChartEditorOptions.CreateOptions
  : TdxFlowChartEditorOptions;
begin
  Result := TdxFlowChartEditorOptions.Create;
