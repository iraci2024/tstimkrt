...
resourcestring
  ...
  sdxFlowChartEditorConnectionArrowDestinationSizeHint =
    'Destination Arrow Size';
  ...
  sdxFlowChartEditorConnectionLinkedPointDestinationHint =
    'Linked point of Destination object';
  sdxFlowChartEditorConnectionLinkedPointSourceHint =
    'Linked point of Source object';
  ...
  sdxFlowChart_BasicShapes_SingleSnipCornerRectangle =
    'Single Snip Corner Rectangle';
  sdxFlowChart_BasicShapes_SnipSameSideCornerRectangle =
    'Snip Same Side Corner Rectangle';
  sdxFlowChart_BasicShapes_SnipDiagonalCornerRectangle =
    'Snip Diagonal Corner Rectangle';

  sdxFlowChart_BasicShapes_SingleRoundCornerRectangle =
    'Single Round Corner Rectangle';
  sdxFlowChart_BasicShapes_RoundSameSideCornerRectangle =
    'Round Same Side Corner Rectangle';
  sdxFlowChart_BasicShapes_RoundDiagonalCornerRectangle =
    'Round Diagonal Corner Rectangle';

  sdxFlowChart_BasicShapes_SnipAndRoundSingleCornerRectangle =
  ...
  sdxFlowChart_BasicShapes_SnipAndRoundCornerRectangle =
  ...
  sdxFlowChart_SDLDiagramShapes_PrimitiveFromCallControl =
  ...
  sdxFlowChart_SDLDiagramShapes_PrimitiveToCallControl =
...
const
  dxFlowChartArrowStyleNamesMap: array [TdxFcaType] of Pointer =
    ...
    @sdxFlowChartArrowStyleFilledASMEarrow, @sdxFlowChartArrowStyleClosedArrow,
    ...
    @sdxFlowChartArrowStyleFilledDoubleArrow, @sdxFlowChartArrowStyleDiamond,
    @sdxFlowChartArrowStyleFilledDiamond, @sdxFlowChartArrowStyleClosedDiamond,
    @sdxFlowChartArrowStyleFilledClosedDiamond,
    @sdxFlowChartArrowStyleDimensionLine, @sdxFlowChartArrowStyleBackslash,
    @sdxFlowChartArrowStyleOpenOneDash, @sdxFlowChartArrowStyleOpenTwoDash,
    @sdxFlowChartArrowStyleOpenThreeDash, @sdxFlowChartArrowStyleClosedOneDash,
    @sdxFlowChartArrowStyleClosedTwoDash,
    @sdxFlowChartArrowStyleClosedThreeDash,
    @sdxFlowChartArrowStyleFilledOneDash, @sdxFlowChartArrowStyleFilledTwoDash,
  ...
  dxFlowChartConnectionStyleNamesMap: array [TdxFclStyle] of Pointer =
    ...
    @sdxFlowChartConnectionStyleRectVertical);
  ...
  dxFlowChartShapeNamesMap: array [TdxFcShapeType] of Pointer =
    ...
    @sdxFlowChartShapeTypeWestTriangle, @sdxFlowChartShapeTypeHexagon,
    nil, nil);

  dxFlowChartLayoutNamesMap: array [0 .. 8] of Pointer =
    (@sdxFlowChartLayoutTopLeft, @sdxFlowChartLayoutTop,
    @sdxFlowChartLayoutTopRight, @sdxFlowChartLayoutLeft,
    @sdxFlowChartLayoutCenter, @sdxFlowChartLayoutRight,
    @sdxFlowChartLayoutBottomLeft, @sdxFlowChartLayoutBottom,
    @sdxFlowChartLayoutBottomRight);

  dxFlowChartConnectionArrowSizeNamesMap: array [TdxFcaSize] of Pointer =
    (@sdxFlowChartArrowSizeCustom, @sdxFlowChartArrowSizeSmall,
    @sdxFlowChartArrowSizeMedium, @sdxFlowChartArrowSizeLarge,
    @sdxFlowChartArrowSizeExtraLarge, @sdxFlowChartArrowSizeHuge);
...
procedure AddFlowChartVisioResourceStringNames
  (AProduct: TdxProductResourceStrings);
begin
  AProduct.Add('sdxFlowChart_Search_Shapes_Null_Text',
    @sdxFlowChart_Search_Shapes_Null_Text);
  AProduct.Add('sdxFlowChart_QuickShapesCaption',
  ...
  AProduct.Add('sdxFlowChart_BasicShapesCaption',
    @sdxFlowChart_BasicShapesCaption);
  AProduct.Add('sdxFlowChart_BasicShapes_Rectangle',
    @sdxFlowChart_BasicShapes_Rectangle);
  AProduct.Add('sdxFlowChart_BasicShapes_Ellipse',
    @sdxFlowChart_BasicShapes_Ellipse);
  AProduct.Add('sdxFlowChart_BasicShapes_Triangle',
    @sdxFlowChart_BasicShapes_Triangle);
  AProduct.Add('sdxFlowChart_BasicShapes_RightTriangle',
    @sdxFlowChart_BasicShapes_RightTriangle);

  AProduct.Add('sdxFlowChart_BasicShapes_Pentagon',
    @sdxFlowChart_BasicShapes_Pentagon);
  AProduct.Add('sdxFlowChart_BasicShapes_Hexagon',
    @sdxFlowChart_BasicShapes_Hexagon);
  AProduct.Add('sdxFlowChart_BasicShapes_Heptagon',
    @sdxFlowChart_BasicShapes_Heptagon);
  AProduct.Add('sdxFlowChart_BasicShapes_Octagon',
    @sdxFlowChart_BasicShapes_Octagon);
  AProduct.Add('sdxFlowChart_BasicShapes_Decagon',
    @sdxFlowChart_BasicShapes_Decagon);

  AProduct.Add('sdxFlowChart_BasicShapes_Can', @sdxFlowChart_BasicShapes_Can);
  AProduct.Add('sdxFlowChart_BasicShapes_Parallelogram',
    @sdxFlowChart_BasicShapes_Parallelogram);
  AProduct.Add('sdxFlowChart_BasicShapes_Trapezoid',
    @sdxFlowChart_BasicShapes_Trapezoid);
  AProduct.Add('sdxFlowChart_BasicShapes_Diamond',
    @sdxFlowChart_BasicShapes_Diamond);
  AProduct.Add('sdxFlowChart_BasicShapes_Cross',
    @sdxFlowChart_BasicShapes_Cross);
  AProduct.Add('sdxFlowChart_BasicShapes_Chevron',
    @sdxFlowChart_BasicShapes_Chevron);
  AProduct.Add('sdxFlowChart_BasicShapes_Cube', @sdxFlowChart_BasicShapes_Cube);

  AProduct.Add('sdxFlowChart_BasicShapes_Star4',
    @sdxFlowChart_BasicShapes_Star4);
  AProduct.Add('sdxFlowChart_BasicShapes_Star5',
    @sdxFlowChart_BasicShapes_Star5);
  AProduct.Add('sdxFlowChart_BasicShapes_Star6',
    @sdxFlowChart_BasicShapes_Star6);
  AProduct.Add('sdxFlowChart_BasicShapes_Star7',
    @sdxFlowChart_BasicShapes_Star7);
  AProduct.Add('sdxFlowChart_BasicShapes_Star16',
    @sdxFlowChart_BasicShapes_Star16);
  AProduct.Add('sdxFlowChart_BasicShapes_Star24',
    @sdxFlowChart_BasicShapes_Star24);
  AProduct.Add('sdxFlowChart_BasicShapes_Star32',
    @sdxFlowChart_BasicShapes_Star32);

  AProduct.Add('sdxFlowChart_BasicShapes_RoundedRectangle',
    @sdxFlowChart_BasicShapes_RoundedRectangle);
  AProduct.Add('sdxFlowChart_BasicShapes_SingleSnipCornerRectangle',
    @sdxFlowChart_BasicShapes_SingleSnipCornerRectangle);
  AProduct.Add('sdxFlowChart_BasicShapes_SnipSameSideCornerRectangle',
    @sdxFlowChart_BasicShapes_SnipSameSideCornerRectangle);
  AProduct.Add('sdxFlowChart_BasicShapes_SnipDiagonalCornerRectangle',
    @sdxFlowChart_BasicShapes_SnipDiagonalCornerRectangle);

  AProduct.Add('sdxFlowChart_BasicShapes_SingleRoundCornerRectangle',
    @sdxFlowChart_BasicShapes_SingleRoundCornerRectangle);
  AProduct.Add('sdxFlowChart_BasicShapes_RoundSameSideCornerRectangle',
    @sdxFlowChart_BasicShapes_RoundSameSideCornerRectangle);
  AProduct.Add('sdxFlowChart_BasicShapes_RoundDiagonalCornerRectangle',
    @sdxFlowChart_BasicShapes_RoundDiagonalCornerRectangle);

  AProduct.Add('sdxFlowChart_BasicShapes_SnipAndRoundSingleCornerRectangle',
    @sdxFlowChart_BasicShapes_SnipAndRoundSingleCornerRectangle);
  AProduct.Add('sdxFlowChart_BasicShapes_SnipCornerRectangle',
    @sdxFlowChart_BasicShapes_SnipCornerRectangle);
  AProduct.Add('sdxFlowChart_BasicShapes_RoundCornerRectangle',
    @sdxFlowChart_BasicShapes_RoundCornerRectangle);
  AProduct.Add('sdxFlowChart_BasicShapes_SnipAndRoundCornerRectangle',
    @sdxFlowChart_BasicShapes_SnipAndRoundCornerRectangle);
  AProduct.Add('sdxFlowChart_BasicShapes_Plaque',
    @sdxFlowChart_BasicShapes_Plaque);

  AProduct.Add('sdxFlowChart_BasicShapes_Frame',
    @sdxFlowChart_BasicShapes_Frame);
  AProduct.Add('sdxFlowChart_BasicShapes_FrameCorner',
    @sdxFlowChart_BasicShapes_FrameCorner);

  AProduct.Add('sdxFlowChart_BasicShapes_LShape',
    @sdxFlowChart_BasicShapes_LShape);
  AProduct.Add('sdxFlowChart_BasicShapes_DiagonalStripe',
    @sdxFlowChart_BasicShapes_DiagonalStripe);

  AProduct.Add('sdxFlowChart_BasicShapes_Donut',
    @sdxFlowChart_BasicShapes_Donut);
  AProduct.Add('sdxFlowChart_BasicShapes_NoSymbol',
    @sdxFlowChart_BasicShapes_NoSymbol);

  AProduct.Add('sdxFlowChart_BasicShapes_LeftParenthesis',
    @sdxFlowChart_BasicShapes_LeftParenthesis);
  AProduct.Add('sdxFlowChart_BasicShapes_RightParenthesis',
    @sdxFlowChart_BasicShapes_RightParenthesis);
  AProduct.Add('sdxFlowChart_BasicShapes_LeftBrace',
    @sdxFlowChart_BasicShapes_LeftBrace);
  AProduct.Add('sdxFlowChart_BasicShapes_RightBrace',
    @sdxFlowChart_BasicShapes_RightBrace);

  AProduct.Add('sdxFlowChart_BasicFlowchartShapesCaption',
    @sdxFlowChart_BasicFlowchartShapesCaption);

  AProduct.Add('sdxFlowChart_BasicFlowchartShapes_Process',
    @sdxFlowChart_BasicFlowchartShapes_Process);
  AProduct.Add('sdxFlowChart_BasicFlowchartShapes_Decision',
    @sdxFlowChart_BasicFlowchartShapes_Decision);
  AProduct.Add('sdxFlowChart_BasicFlowchartShapes_Subprocess',
    @sdxFlowChart_BasicFlowchartShapes_Subprocess);
  AProduct.Add('sdxFlowChart_BasicFlowchartShapes_StartEnd',
    @sdxFlowChart_BasicFlowchartShapes_StartEnd);
  AProduct.Add('sdxFlowChart_BasicFlowchartShapes_Document',
    @sdxFlowChart_BasicFlowchartShapes_Document);
  AProduct.Add('sdxFlowChart_BasicFlowchartShapes_Data',
    @sdxFlowChart_BasicFlowchartShapes_Data);
  AProduct.Add('sdxFlowChart_BasicFlowchartShapes_Database',
    @sdxFlowChart_BasicFlowchartShapes_Database);
  AProduct.Add('sdxFlowChart_BasicFlowchartShapes_ExternalData',
    @sdxFlowChart_BasicFlowchartShapes_ExternalData);
  AProduct.Add('sdxFlowChart_BasicFlowchartShapes_Custom1',
    @sdxFlowChart_BasicFlowchartShapes_Custom1);
  AProduct.Add('sdxFlowChart_BasicFlowchartShapes_Custom2',
    @sdxFlowChart_BasicFlowchartShapes_Custom2);
  AProduct.Add('sdxFlowChart_BasicFlowchartShapes_Custom3',
    @sdxFlowChart_BasicFlowchartShapes_Custom3);
  AProduct.Add('sdxFlowChart_BasicFlowchartShapes_Custom4',
    @sdxFlowChart_BasicFlowchartShapes_Custom4);
  AProduct.Add('sdxFlowChart_BasicFlowchartShapes_OnPageReference',
    @sdxFlowChart_BasicFlowchartShapes_OnPageReference);
  AProduct.Add('sdxFlowChart_BasicFlowchartShapes_OffPageReference',
    @sdxFlowChart_BasicFlowchartShapes_OffPageReference);

  AProduct.Add('sdxFlowChart_SDLDiagramShapesCaption',
    @sdxFlowChart_SDLDiagramShapesCaption);
  AProduct.Add('sdxFlowChart_SDLDiagramShapes_Start',
    @sdxFlowChart_SDLDiagramShapes_Start);
  AProduct.Add('sdxFlowChart_SDLDiagramShapes_VariableStart',
    @sdxFlowChart_SDLDiagramShapes_VariableStart);
  AProduct.Add('sdxFlowChart_SDLDiagramShapes_Procedure',
    @sdxFlowChart_SDLDiagramShapes_Procedure);
  AProduct.Add('sdxFlowChart_SDLDiagramShapes_VariableProcedure',
    @sdxFlowChart_SDLDiagramShapes_VariableProcedure);
  AProduct.Add('sdxFlowChart_SDLDiagramShapes_CreateRequest',
    @sdxFlowChart_SDLDiagramShapes_CreateRequest);
  AProduct.Add('sdxFlowChart_SDLDiagramShapes_Alternative',
    @sdxFlowChart_SDLDiagramShapes_Alternative);
  AProduct.Add('sdxFlowChart_SDLDiagramShapes_Return',
    @sdxFlowChart_SDLDiagramShapes_Return);
  AProduct.Add('sdxFlowChart_SDLDiagramShapes_Decision1',
    @sdxFlowChart_SDLDiagramShapes_Decision1);
  AProduct.Add('sdxFlowChart_SDLDiagramShapes_MessageFromUser',
    @sdxFlowChart_SDLDiagramShapes_MessageFromUser);
  AProduct.Add('sdxFlowChart_SDLDiagramShapes_PrimitiveFromCallControl',
    @sdxFlowChart_SDLDiagramShapes_PrimitiveFromCallControl);
  AProduct.Add('sdxFlowChart_SDLDiagramShapes_Decision2',
    @sdxFlowChart_SDLDiagramShapes_Decision2);
  AProduct.Add('sdxFlowChart_SDLDiagramShapes_MessageToUser',
    @sdxFlowChart_SDLDiagramShapes_MessageToUser);
  AProduct.Add('sdxFlowChart_SDLDiagramShapes_PrimitiveToCallControl',
    @sdxFlowChart_SDLDiagramShapes_PrimitiveToCallControl);
  AProduct.Add('sdxFlowChart_SDLDiagramShapes_Save',
    @sdxFlowChart_SDLDiagramShapes_Save);
  AProduct.Add('sdxFlowChart_SDLDiagramShapes_OnPageReference',
    @sdxFlowChart_SDLDiagramShapes_OnPageReference);
  AProduct.Add('sdxFlowChart_SDLDiagramShapes_OffPageReference',
    @sdxFlowChart_SDLDiagramShapes_OffPageReference);
  AProduct.Add('sdxFlowChart_SDLDiagramShapes_Document',
    @sdxFlowChart_SDLDiagramShapes_Document);
  AProduct.Add('sdxFlowChart_SDLDiagramShapes_DiskStorage',
    @sdxFlowChart_SDLDiagramShapes_DiskStorage);
  AProduct.Add('sdxFlowChart_SDLDiagramShapes_DividedProcess',
    @sdxFlowChart_SDLDiagramShapes_DividedProcess);
  AProduct.Add('sdxFlowChart_SDLDiagramShapes_DividedEvent',
    @sdxFlowChart_SDLDiagramShapes_DividedEvent);
  AProduct.Add('sdxFlowChart_SDLDiagramShapes_Terminator',
    @sdxFlowChart_SDLDiagramShapes_Terminator);

  AProduct.Add('sdxFlowChart_SoftwareIconsCaption',
    @sdxFlowChart_SoftwareIconsCaption);
  AProduct.Add('sdxFlowChart_SoftwareIcons_Back',
    @sdxFlowChart_SoftwareIcons_Back);
  AProduct.Add('sdxFlowChart_SoftwareIcons_Forward',
    @sdxFlowChart_SoftwareIcons_Forward);
  AProduct.Add('sdxFlowChart_SoftwareIcons_Expand',
    @sdxFlowChart_SoftwareIcons_Expand);
  AProduct.Add('sdxFlowChart_SoftwareIcons_Collapse',
    @sdxFlowChart_SoftwareIcons_Collapse);
  AProduct.Add('sdxFlowChart_SoftwareIcons_Add',
    @sdxFlowChart_SoftwareIcons_Add);
  AProduct.Add('sdxFlowChart_SoftwareIcons_Remove',
    @sdxFlowChart_SoftwareIcons_Remove);
  AProduct.Add('sdxFlowChart_SoftwareIcons_ZoomIn',
    @sdxFlowChart_SoftwareIcons_ZoomIn);
  AProduct.Add('sdxFlowChart_SoftwareIcons_ZoomOut',
    @sdxFlowChart_SoftwareIcons_ZoomOut);
  AProduct.Add('sdxFlowChart_SoftwareIcons_Lock',
    @sdxFlowChart_SoftwareIcons_Lock);
  AProduct.Add('sdxFlowChart_SoftwareIcons_Permission',
    @sdxFlowChart_SoftwareIcons_Permission);
  AProduct.Add('sdxFlowChart_SoftwareIcons_Sort',
    @sdxFlowChart_SoftwareIcons_Sort);
  AProduct.Add('sdxFlowChart_SoftwareIcons_Filter',
    @sdxFlowChart_SoftwareIcons_Filter);
  AProduct.Add('sdxFlowChart_SoftwareIcons_Tools',
    @sdxFlowChart_SoftwareIcons_Tools);
  AProduct.Add('sdxFlowChart_SoftwareIcons_Properties',
    @sdxFlowChart_SoftwareIcons_Properties);
  AProduct.Add('sdxFlowChart_SoftwareIcons_Calendar',
    @sdxFlowChart_SoftwareIcons_Calendar);
  AProduct.Add('sdxFlowChart_SoftwareIcons_Document',
    @sdxFlowChart_SoftwareIcons_Document);
  AProduct.Add('sdxFlowChart_SoftwareIcons_Database',
    @sdxFlowChart_SoftwareIcons_Database);
  AProduct.Add('sdxFlowChart_SoftwareIcons_HardDrive',
    @sdxFlowChart_SoftwareIcons_HardDrive);
  AProduct.Add('sdxFlowChart_SoftwareIcons_Network',
    @sdxFlowChart_SoftwareIcons_Network);

  AProduct.Add('sdxFlowChart_DecorativeShapesCaption',
    @sdxFlowChart_DecorativeShapesCaption);
  AProduct.Add('sdxFlowChart_DecorativeShapes_LightningBolt',
    @sdxFlowChart_DecorativeShapes_LightningBolt);
  AProduct.Add('sdxFlowChart_DecorativeShapes_Moon',
    @sdxFlowChart_DecorativeShapes_Moon);
  AProduct.Add('sdxFlowChart_DecorativeShapes_Wave',
    @sdxFlowChart_DecorativeShapes_Wave);
  AProduct.Add('sdxFlowChart_DecorativeShapes_DoubleWave',
    @sdxFlowChart_DecorativeShapes_DoubleWave);
  AProduct.Add('sdxFlowChart_DecorativeShapes_VerticalScroll',
    @sdxFlowChart_DecorativeShapes_VerticalScroll);
  AProduct.Add('sdxFlowChart_DecorativeShapes_HorizontalScroll',
    @sdxFlowChart_DecorativeShapes_HorizontalScroll);
  AProduct.Add('sdxFlowChart_DecorativeShapes_Heart',
    @sdxFlowChart_DecorativeShapes_Heart);
  AProduct.Add('sdxFlowChart_DecorativeShapes_DownRibbon',
    @sdxFlowChart_DecorativeShapes_DownRibbon);
  AProduct.Add('sdxFlowChart_DecorativeShapes_UpRibbon',
    @sdxFlowChart_DecorativeShapes_UpRibbon);
  AProduct.Add('sdxFlowChart_DecorativeShapes_Cloud',
    @sdxFlowChart_DecorativeShapes_Cloud);

  AProduct.Add('sdxFlowChart_ArrowShapesCaption',
    @sdxFlowChart_ArrowShapesCaption);
  AProduct.Add('sdxFlowChart_ArrowShapes_SimpleArrow',
    @sdxFlowChart_ArrowShapes_SimpleArrow);
  AProduct.Add('sdxFlowChart_ArrowShapes_SimpleDoubleArrow',
    @sdxFlowChart_ArrowShapes_SimpleDoubleArrow);
  AProduct.Add('sdxFlowChart_ArrowShapes_ModernArrow',
    @sdxFlowChart_ArrowShapes_ModernArrow);
  AProduct.Add('sdxFlowChart_ArrowShapes_FlexibleArrow',
    @sdxFlowChart_ArrowShapes_FlexibleArrow);
  AProduct.Add('sdxFlowChart_ArrowShapes_BentArrow',
    @sdxFlowChart_ArrowShapes_BentArrow);
  AProduct.Add('sdxFlowChart_ArrowShapes_UTurnArrow',
    @sdxFlowChart_ArrowShapes_UTurnArrow);
  AProduct.Add('sdxFlowChart_ArrowShapes_SharpBentArrow',
    @sdxFlowChart_ArrowShapes_SharpBentArrow);
  AProduct.Add('sdxFlowChart_ArrowShapes_CurvedRightArrow',
    @sdxFlowChart_ArrowShapes_CurvedRightArrow);
  AProduct.Add('sdxFlowChart_ArrowShapes_CurvedLeftArrow',
    @sdxFlowChart_ArrowShapes_CurvedLeftArrow);
  AProduct.Add('sdxFlowChart_ArrowShapes_NotchedArrow',
    @sdxFlowChart_ArrowShapes_NotchedArrow);
  AProduct.Add('sdxFlowChart_ArrowShapes_StripedArrow',
    @sdxFlowChart_ArrowShapes_StripedArrow);
  AProduct.Add('sdxFlowChart_ArrowShapes_BlockArrow',
    @sdxFlowChart_ArrowShapes_BlockArrow);
  AProduct.Add('sdxFlowChart_ArrowShapes_CircularArrow',
    @sdxFlowChart_ArrowShapes_CircularArrow);
  AProduct.Add('sdxFlowChart_ArrowShapes_QuadArrow',
    @sdxFlowChart_ArrowShapes_QuadArrow);
  AProduct.Add('sdxFlowChart_ArrowShapes_LeftRightUpArrow',
    @sdxFlowChart_ArrowShapes_LeftRightUpArrow);
  AProduct.Add('sdxFlowChart_ArrowShapes_LeftRightArrowBlock',
    @sdxFlowChart_ArrowShapes_LeftRightArrowBlock);
  AProduct.Add('sdxFlowChart_ArrowShapes_QuadArrowBlock',
    @sdxFlowChart_ArrowShapes_QuadArrowBlock);
  ...
  AProduct.Add('sdxFlowChart_Arrow_FilledFletch',
    @sdxFlowChart_Arrow_FilledFletch);
  AProduct.Add('sdxFlowChart_Arrow_Diamond', @sdxFlowChart_Arrow_Diamond);
  AProduct.Add('sdxFlowChart_Arrow_FilledDiamond',
    @sdxFlowChart_Arrow_FilledDiamond);
  AProduct.Add('sdxFlowChart_Arrow_ClosedDiamond',
    @sdxFlowChart_Arrow_ClosedDiamond);
  AProduct.Add('sdxFlowChart_Arrow_IndentedFilledArrow',
    @sdxFlowChart_Arrow_IndentedFilledArrow);
  AProduct.Add('sdxFlowChart_Arrow_OutdentedFilledArrow',
    @sdxFlowChart_Arrow_OutdentedFilledArrow);
  AProduct.Add('sdxFlowChart_Arrow_FilledSquare',
    @sdxFlowChart_Arrow_FilledSquare);
  AProduct.Add('sdxFlowChart_Arrow_ClosedASMEArrow',
    @sdxFlowChart_Arrow_ClosedASMEArrow);
  AProduct.Add('sdxFlowChart_Arrow_FilledDoubleArrow',
    @sdxFlowChart_Arrow_FilledDoubleArrow);
  AProduct.Add('sdxFlowChart_Arrow_ClosedDoubleArrow',
    @sdxFlowChart_Arrow_ClosedDoubleArrow);
end;
...
begin
  ...
  AProduct.Add('sdxFlowChartArrowSizeExtraLarge',
  ...
  AProduct.Add('sdxFlowChartArrowStyleEllipseArrow',
    @sdxFlowChartArrowStyleEllipseArrow);
  AProduct.Add('sdxFlowChartArrowStyleRectArrow',
    @sdxFlowChartArrowStyleRectArrow);
  AProduct.Add('sdxFlowChartArrowStyleClosedASMEarrow',
    @sdxFlowChartArrowStyleClosedASMEarrow);
  AProduct.Add('sdxFlowChartArrowStyleFilledASMEarrow',
    @sdxFlowChartArrowStyleFilledASMEarrow);
  AProduct.Add('sdxFlowChartArrowStyleClosedArrow',
    @sdxFlowChartArrowStyleClosedArrow);
  AProduct.Add('sdxFlowChartArrowStyleFilledArrow',
    @sdxFlowChartArrowStyleFilledArrow);
  AProduct.Add('sdxFlowChartArrowStyleIndentedClosedArrow',
    @sdxFlowChartArrowStyleIndentedClosedArrow);
  AProduct.Add('sdxFlowChartArrowStyleIndentedFilledArrow',
    @sdxFlowChartArrowStyleIndentedFilledArrow);
  AProduct.Add('sdxFlowChartArrowStyleOutdentedClosedArrow',
    @sdxFlowChartArrowStyleOutdentedClosedArrow);
  AProduct.Add('sdxFlowChartArrowStyleOutdentedFilledArrow',
    @sdxFlowChartArrowStyleOutdentedFilledArrow);
  AProduct.Add('sdxFlowChartArrowStyleClosedDoubleArrow',
    @sdxFlowChartArrowStyleClosedDoubleArrow);
  AProduct.Add('sdxFlowChartArrowStyleFilledDoubleArrow',
    @sdxFlowChartArrowStyleFilledDoubleArrow);
  AProduct.Add('sdxFlowChartArrowStyleDiamond', @sdxFlowChartArrowStyleDiamond);
  AProduct.Add('sdxFlowChartArrowStyleFilledDiamond',
    @sdxFlowChartArrowStyleFilledDiamond);
  AProduct.Add('sdxFlowChartArrowStyleClosedDiamond',
    @sdxFlowChartArrowStyleClosedDiamond);
  AProduct.Add('sdxFlowChartArrowStyleFilledClosedDiamond',
    @sdxFlowChartArrowStyleFilledClosedDiamond);
  AProduct.Add('sdxFlowChartArrowStyleDimensionLine',
    @sdxFlowChartArrowStyleDimensionLine);
  AProduct.Add('sdxFlowChartArrowStyleBackslash',
    @sdxFlowChartArrowStyleBackslash);
  AProduct.Add('sdxFlowChartArrowStyleOpenOneDash',
    @sdxFlowChartArrowStyleOpenOneDash);
  AProduct.Add('sdxFlowChartArrowStyleOpenTwoDash',
    @sdxFlowChartArrowStyleOpenTwoDash);
  AProduct.Add('sdxFlowChartArrowStyleOpenThreeDash',
    @sdxFlowChartArrowStyleOpenThreeDash);
  AProduct.Add('sdxFlowChartArrowStyleClosedOneDash',
    @sdxFlowChartArrowStyleClosedOneDash);
  AProduct.Add('sdxFlowChartArrowStyleClosedTwoDash',
    @sdxFlowChartArrowStyleClosedTwoDash);
  AProduct.Add('sdxFlowChartArrowStyleClosedThreeDash',
    @sdxFlowChartArrowStyleClosedThreeDash);
  AProduct.Add('sdxFlowChartArrowStyleFilledOneDash',
    @sdxFlowChartArrowStyleFilledOneDash);
  AProduct.Add('sdxFlowChartArrowStyleFilledTwoDash',
    @sdxFlowChartArrowStyleFilledTwoDash);
  AProduct.Add('sdxFlowChartArrowStyleFilledThreeDash',
    @sdxFlowChartArrowStyleFilledThreeDash);

  AProduct.Add('sdxFlowChartConnectionEditorArrowColor',
    @sdxFlowChartConnectionEditorArrowColor);
  AProduct.Add('sdxFlowChartConnectionEditorArrowSize',
    @sdxFlowChartConnectionEditorArrowSize);
  AProduct.Add('sdxFlowChartConnectionEditorArrowStyle',
    @sdxFlowChartConnectionEditorArrowStyle);
  AProduct.Add('sdxFlowChartConnectionEditorCaption',
    @sdxFlowChartConnectionEditorCaption);
  AProduct.Add('sdxFlowChartConnectionEditorColor',
    @sdxFlowChartConnectionEditorColor);
  AProduct.Add('sdxFlowChartConnectionEditorDestination',
    @sdxFlowChartConnectionEditorDestination);
  AProduct.Add('sdxFlowChartConnectionEditorLinkedPoint',
    @sdxFlowChartConnectionEditorLinkedPoint);
  AProduct.Add('sdxFlowChartConnectionEditorSource',
    @sdxFlowChartConnectionEditorSource);
  AProduct.Add('sdxFlowChartConnectionEditorText',
    @sdxFlowChartConnectionEditorText);
  AProduct.Add('sdxFlowChartConnectionEditorTextFontHint',
    @sdxFlowChartConnectionEditorTextFontHint);

  AProduct.Add('sdxFlowChartDialogButtonOk', @sdxFlowChartDialogButtonOk);
  AProduct.Add('sdxFlowChartDialogButtonCancel',
    @sdxFlowChartDialogButtonCancel);
  ...
  AProduct.Add('sdxFlowChartBorderStyleDiagonal',
    @sdxFlowChartBorderStyleDiagonal);
  ...
  AProduct.Add('sdxFlowChartEditorConnectionArrowDestinationHint',
    @sdxFlowChartEditorConnectionArrowDestinationHint);
  AProduct.Add('sdxFlowChartEditorConnectionArrowDestinationSizeHint',
    @sdxFlowChartEditorConnectionArrowDestinationSizeHint);
  AProduct.Add('sdxFlowChartEditorConnectionArrowSourceHint',
    @sdxFlowChartEditorConnectionArrowSourceHint);
  AProduct.Add('sdxFlowChartEditorConnectionArrowSourceSizeHint',
    @sdxFlowChartEditorConnectionArrowSourceSizeHint);
  AProduct.Add('sdxFlowChartEditorConnectionLinkedPointDestinationHint',
    @sdxFlowChartEditorConnectionLinkedPointDestinationHint);
  AProduct.Add('sdxFlowChartEditorConnectionLinkedPointSourceHint',
    @sdxFlowChartEditorConnectionLinkedPointSourceHint);
  AProduct.Add('sdxFlowChartEditorConnectionStyleHint',
    @sdxFlowChartEditorConnectionStyleHint);
  AProduct.Add('sdxFlowChartEditorConnectionTextFontHint',
    @sdxFlowChartEditorConnectionTextFontHint);
  AProduct.Add('sdxFlowChartEditorCreate', @sdxFlowChartEditorCreate);
  AProduct.Add('sdxFlowChartEditorCreateConnectionHint',
    @sdxFlowChartEditorCreateConnectionHint);
  AProduct.Add('sdxFlowChartEditorCreateObjectHint',
    @sdxFlowChartEditorCreateObjectHint);
  AProduct.Add('sdxFlowChartEditorEdit', @sdxFlowChartEditorEdit);
  AProduct.Add('sdxFlowChartEditorEditBringToFront',
    @sdxFlowChartEditorEditBringToFront);
  AProduct.Add('sdxFlowChartEditorEditClearSelection',
    @sdxFlowChartEditorEditClearSelection);
  ...
  AProduct.Add('sdxFlowChartEditorEditSelectAll',
    @sdxFlowChartEditorEditSelectAll);
  AProduct.Add('sdxFlowChartEditorEditSendToBack',
    @sdxFlowChartEditorEditSendToBack);
  ...
  AProduct.Add('sdxFlowChartEditorHelpContents',
    @sdxFlowChartEditorHelpContents);
  AProduct.Add('sdxFlowChartEditorMainItemOfUnion',
    @sdxFlowChartEditorMainItemOfUnion);
  AProduct.Add('sdxFlowChartEditorObject', @sdxFlowChartEditorObject);
  AProduct.Add('sdxFlowChartEditorObjectImagePositionHint',
    @sdxFlowChartEditorObjectImagePositionHint);
  AProduct.Add('sdxFlowChartEditorObjectLineWidthHint',
    @sdxFlowChartEditorObjectLineWidthHint);
  AProduct.Add('sdxFlowChartEditorObjectShapeStyleHint',
    @sdxFlowChartEditorObjectShapeStyleHint);
  AProduct.Add('sdxFlowChartEditorObjectTextFontHint',
    @sdxFlowChartEditorObjectTextFontHint);
  AProduct.Add('sdxFlowChartEditorObjectTextPositionHint',
    @sdxFlowChartEditorObjectTextPositionHint);
  AProduct.Add('sdxFlowChartEditorOptions', @sdxFlowChartEditorOptions);
  AProduct.Add('sdxFlowChartEditorOptionsDynamicMoving',
    @sdxFlowChartEditorOptionsDynamicMoving);
  AProduct.Add('sdxFlowChartEditorOptionsDynamicSizing',
    @sdxFlowChartEditorOptionsDynamicSizing);
  ...
  AProduct.Add('sdxFlowChartEditorUnionsClearAll',
    @sdxFlowChartEditorUnionsClearAll);
  AProduct.Add('sdxFlowChartEditorUnionsNew', @sdxFlowChartEditorUnionsNew);
  AProduct.Add('sdxFlowChartEditorUnionsRemove',
    @sdxFlowChartEditorUnionsRemove);
  AProduct.Add('sdxFlowChartEditorView', @sdxFlowChartEditorView);
  AProduct.Add('sdxFlowChartEditorViewAntialiasing',
    @sdxFlowChartEditorViewAntialiasing);
  AProduct.Add('sdxFlowChartEditorViewActualSize',
    @sdxFlowChartEditorViewActualSize);
  ...
  AProduct.Add('sdxFlowChartObjectEditorBackgroundColor',
    @sdxFlowChartObjectEditorBackgroundColor);
  AProduct.Add('sdxFlowChartObjectEditorBorderStyle',
    @sdxFlowChartObjectEditorBorderStyle);
  AProduct.Add('sdxFlowChartObjectEditorCaption',
    @sdxFlowChartObjectEditorCaption);
  AProduct.Add('sdxFlowChartObjectEditorEdgeStyle',
    @sdxFlowChartObjectEditorEdgeStyle);
  AProduct.Add('sdxFlowChartObjectEditorFrameTab',
    @sdxFlowChartObjectEditorFrameTab);
  AProduct.Add('sdxFlowChartObjectEditorGeneralTab',
    @sdxFlowChartObjectEditorGeneralTab);
  AProduct.Add('sdxFlowChartObjectEditorHeight',
    @sdxFlowChartObjectEditorHeight);
  AProduct.Add('sdxFlowChartObjectEditorImageClear',
    @sdxFlowChartObjectEditorImageClear);
  AProduct.Add('sdxFlowChartObjectEditorImageLayout',
    @sdxFlowChartObjectEditorImageLayout);
  AProduct.Add('sdxFlowChartObjectEditorImageTab',
    @sdxFlowChartObjectEditorImageTab);
  AProduct.Add('sdxFlowChartObjectEditorLineWidth',
    @sdxFlowChartObjectEditorLineWidth);
  AProduct.Add('sdxFlowChartObjectEditorShapeColor',
    @sdxFlowChartObjectEditorShapeColor);
  AProduct.Add('sdxFlowChartObjectEditorShapeType',
    @sdxFlowChartObjectEditorShapeType);
  AProduct.Add('sdxFlowChartObjectEditorText', @sdxFlowChartObjectEditorText);
  AProduct.Add('sdxFlowChartObjectEditorTextLayout',
    @sdxFlowChartObjectEditorTextLayout);
  AProduct.Add('sdxFlowChartObjectEditorTransparent',
  ...
  AProduct.Add('sdxFlowChartShapeTypeRoundRect',
    @sdxFlowChartShapeTypeRoundRect);
  AProduct.Add('sdxFlowChartShapeTypeDiamond', @sdxFlowChartShapeTypeDiamond);
  AProduct.Add('sdxFlowChartShapeTypeNorthTriangle',
    @sdxFlowChartShapeTypeNorthTriangle);
  AProduct.Add('sdxFlowChartShapeTypeSouthTriangle',
    @sdxFlowChartShapeTypeSouthTriangle);
  AProduct.Add('sdxFlowChartShapeTypeEastTriangle',
    @sdxFlowChartShapeTypeEastTriangle);
  AProduct.Add('sdxFlowChartShapeTypeWestTriangle',
  ...
  AProduct.Add('sdxFlowChartUnionEditorCaption',
    @sdxFlowChartUnionEditorCaption);

  AProduct.Add('sdxFlowChartConnectionStyleStraight',
    @sdxFlowChartConnectionStyleStraight);
  AProduct.Add('sdxFlowChartConnectionStyleCurved',
    @sdxFlowChartConnectionStyleCurved);
  AProduct.Add('sdxFlowChartConnectionStyleRectHorizontal',
    @sdxFlowChartConnectionStyleRectHorizontal);
  AProduct.Add('sdxFlowChartConnectionStyleRectVertical',
    @sdxFlowChartConnectionStyleRectVertical);
  ...
  AProduct.Add('sdxFlowChartEditorLineDashDotted',
    @sdxFlowChartEditorLineDashDotted);
  AProduct.Add('sdxFlowChartEditorLineDashDoubleDotted',
    @sdxFlowChartEditorLineDashDoubleDotted);
end;

initialization

dxResourceStringsRepository.RegisterProduct('ExpressFlowChart',
  @AddFlowChartResourceStringNames);
