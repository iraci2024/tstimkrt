...
{$IFEND}
{$ENDIF}
  type TdxUseConnectionsMode = (OutgoingOnly, IncomingOnly);
...
type
  ...
  TdxPageInfo = record
    ...
    constructor Create(const APageSize: TdxSizeDouble;
      const APageMargin: TdxRectDouble); overload;
    constructor Create(const APageSize: TdxSizeDouble;
      const ACanvas: TdxRectDouble; APageMargin: TdxThicknessInfo;
      ABreadthAlignment: TdxAlignment = TdxAlignment.Center;
      ADepthAlignment: TdxAlignment = TdxAlignment.Near); overload;
    constructor Create(const APageSize: TdxSizeDouble;
      ABreadthAlignment: TdxAlignment; ADepthAlignment: TdxAlignment); overload;
  ...
  public
    constructor Create(const AOutgoingEdges, AIncomingEdges: TArray <
      TdxEdge < T >> );
  ...
  public
    constructor Create(const AViewNode: TProc<T>;
    ...
    property BeginIncomingAction: TProc < TdxEdge < T >>
      read FBeginIncomingAction;
  ...
  TdxGraph = class
  strict private
    class var FNull: TdxDiagramItem;
    class constructor Initialize;
  strict private
    FNodes: TArray<TdxDiagramItem>;
    FEdges: TList<TdxEdge<TdxDiagramItem>>;
    class function IsSameKey(const AKey: TdxDiagramItem;
      AEdge: TdxEdge<TdxDiagramItem>; AIsOutgoing: Boolean): Boolean;
      static; inline;
    function GetOrderedDictionary(const AEdges: TList<TdxEdge<TdxDiagramItem>>;
      AIsOutgoing: Boolean)
      : TdxSmartPointer<TDictionary<TdxDiagramItem,
      TList<TdxEdge<TdxDiagramItem>>>>;
  public
    constructor Create(const ANodes: TArray<TdxDiagramItem>;
      const AEdges: TList < TdxEdge < TdxDiagramItem >> ); overload;
    constructor Create(const ANodes: TArray<TdxDiagramItem>;
      const AEdges: TArray < TdxEdge < TdxDiagramItem >> ); overload;
    constructor Create; overload;
    destructor Destroy; override;
    function FindConnectedComponent(ARoot: TdxDiagramItem;
      const AGetAdjacentEdges: TFunc < TdxDiagramItem,
      TdxAdjacentEdges < TdxDiagramItem >> ): TdxGraph;
    function GetAdjacentEdges(AUseConnectionsModes
      : TdxUseConnectionsModes = DefaultUseConnectionsModes)
      : TFunc<TdxDiagramItem, TdxAdjacentEdges<TdxDiagramItem>>;
    function GetConnectedComponents: TList<TdxGraph>;
    function GetSpanningGraph(ARoot: TdxDiagramItem;
    ...
    class function IsNull(const AValue: TdxDiagramItem): Boolean;
      static; inline;
  ...
  strict private
    ...
    function GetLogicalDirection: TdxLogicalDirectionKind;
  public
    constructor Create(AColumnSpacing, ALayerSpacing: Double;
  ...
  strict private
    ...
    FPosition: Integer;
  public
    constructor Create(ANode: TdxDiagramItem; AIsDummy: Boolean;
      ALevel, APosition: Integer);
  ...
  public
    constructor Create(const ANodesInfo: TEnumerable<TdxNodeInfo>;
      const AEdgesInfo: TEnumerable<TdxEdgeInfo>); overload;
    constructor Create; overload;
    destructor Destroy; override;
  ...
  strict private
    ...
    FDummyEdgesRoutes: TdxEdgeDictionary<TdxDiagramItem,
      TArray<TdxPointDouble>>;
  public
    constructor Create(const APositionsInfo: TArray<TdxPositionInfo>;
      ADummyEdgeRoute: TdxEdgeDictionary < TdxDiagramItem,
      TArray < TdxPointDouble >> ); overload;
    constructor Create; overload;
    destructor Destroy; override;
    function GetEdgesRoutes(AEdge: TdxEdge<TdxDiagramItem>)
      : TArray<TdxPointDouble>;

    property PositionsInfo: TArray<TdxPositionInfo> read FPositionsInfo;
    property DummyEdgesRoutes: TdxEdgeDictionary < TdxDiagramItem,
      TArray < TdxPointDouble >> read FDummyEdgesRoutes;
  end;

  { TdxGraphSugiyamaLayoutSettings }

  TdxGraphSugiyamaLayoutSettings = class(TcxIUnknownObject,
    IdxGraphLayoutSettings)
  strict private
  ...
  protected
    ...
    property DepthSpacing: Double read GetDepthSpacing;
  public
    constructor Create(ASugiyamaLayout: TdxSugiyamaLayoutSettings;
  ...
  strict private
    ...
    FNodesOrdering: TFunc<TdxGraph, TDictionary<TdxDiagramItem, Integer>,
      TdxGraphInfo>;
    FCoordinateAssignment: TFunc<TList<TdxGraphInfo>, TdxSugiyamaPositionsInfo>;
    FChecks: TdxSugiyamaLayoutChecks;
  public
    constructor Create(ACycleRemoval: TFunc<TdxGraph, TdxGraph>;
      ALayerAssignment: TFunc<TdxGraph, TDictionary<TdxDiagramItem, Integer>>;
      ANodesOrdering: TFunc<TdxGraph, TDictionary<TdxDiagramItem, Integer>,
      TdxGraphInfo>; ACoordinateAssignment: TFunc<TList<TdxGraphInfo>,
      TdxSugiyamaPositionsInfo>; AChecks: TdxSugiyamaLayoutChecks);
    class function DefaultSugiyamaSteps
      (AGetSize: TFunc<TdxDiagramItem, TdxSizeDouble>;
      ASettings: TdxGraphSugiyamaLayoutSettings)
      : TdxSugiyamaLayoutAlgorithm; static;

    property CycleRemoval: TFunc<TdxGraph, TdxGraph> read FCycleRemoval;
    property LayerAssignment: TFunc < TdxGraph, TDictionary < TdxDiagramItem,
      Integer >> read FLayerAssignment;
    property NodesOrdering
      : TFunc<TdxGraph, TDictionary<TdxDiagramItem, Integer>, TdxGraphInfo>
      read FNodesOrdering;
    property CoordinateAssignment
      : TFunc<TList<TdxGraphInfo>, TdxSugiyamaPositionsInfo>
      read FCoordinateAssignment;
  ...
  public
    class function LayoutGraph(AGraph: TdxGraph;
      ALayoutSteps: TdxSugiyamaLayoutAlgorithm)
      : TdxSugiyamaPositionsInfo; static;
  end;
  ...
  protected
    class function GetNonTrivialStronglyConnectedComponents(AGraph: TdxGraph)
      : TList<TdxGraph>; static;
  public
    class function CycleRemoval(ACyclicGraph: TdxGraph): TdxGraph; static;
    class function GetFeedbackSet(ACyclicGraph: TdxGraph)
      : TdxHashSet<TdxEdge<TdxDiagramItem>>; static;
    class function GetMaxCyclicEdges(AStronglyConnectedComponent: TdxGraph)
      : TdxHashSet<TdxEdge<TdxDiagramItem>>; static;
    class function GetStronglyConnectedComponents(ACyclicGraph: TdxGraph)
      : TList<TdxGraph>; static;
    class function ReverseEdges(AGraph: TdxGraph;
      const AFeedbackSet: TdxHashSet < TdxEdge < TdxDiagramItem >> )
      : TdxGraph; static;
  end;
  ...
  public
    class function GetLayerAssignment(AAcyclicGraph: TdxGraph)
      : TDictionary<TdxDiagramItem, Integer>; static;
    class function GetFeasibleTree(AAcyclicGraph: TdxGraph): TdxGraph; static;
    class function InitLayerAssignment(AAcyclicGraph: TdxGraph)
      : TDictionary<TdxDiagramItem, Integer>; static;
    class function CalculateNodesLayers(ASpanningTree: TdxGraph)
      : TDictionary<TdxDiagramItem, Integer>; static;
  end;
  ...
  public
    class function OrderNodes(AAcyclicGraph: TdxGraph;
      ANodesLayers: TDictionary<TdxDiagramItem, Integer>): TdxGraphInfo; static;
    class function InitGraphInfo(AAcyclicGraph: TdxGraph;
      ANodesLayers: TDictionary<TdxDiagramItem, Integer>): TdxGraphInfo; static;
    class function InitOrder(const ANodesInfo: TList<TdxNodeInfo>)
      : TDictionary<Integer, TList<TdxNodeInfo>>; static;
    class function GetAdjacentNode(AGraphInfo: TdxGraphInfo)
      : TFunc<TdxNodeInfo, TdxTuple<TdxNodeInfo>>; static;
    class function GetOrderNodes(ALayers
      : TDictionary<Integer, TList<TdxNodeInfo>>;
      const AGetAdjacentNodes: TFunc<TdxNodeInfo, TdxTuple<TdxNodeInfo>>;
      AOrderMode: TOrderMode): TDictionary<Integer, TList<TdxNodeInfo>>; static;
    class function SortNodes(ANodesPosition: TDictionary<TdxNodeInfo, Integer>)
      : TList<TdxNodeInfo>; static;
    class function GetNodePosition(AAdjacentNodesPositions: TList<Integer>)
      : Integer; static;
    class function GetAdjacentNodesPositions(ANodesInfo: TdxNodeInfo;
      AOrderMode: TOrderMode; const AGetAdjacentNodes: TFunc < TdxNodeInfo,
      TdxTuple < TdxNodeInfo >> ): TList<Integer>; static;
    class function GetLayerCrossingCount(ALayer: TList<TdxNodeInfo>;
      const AGetAdjacentNodes: TFunc < TdxNodeInfo, TdxTuple < TdxNodeInfo >> )
      : Integer; static;
    class function GetCrossingCount
      (ALayers: TDictionary<Integer, TList<TdxNodeInfo>>;
      const AGetAdjacentNodes: TFunc < TdxNodeInfo, TdxTuple < TdxNodeInfo >> )
      : Integer; static;
  end;
  ...
  public
    constructor Create(const APositions: TArray<TdxPositionInfo>;
      const ATotalSize: TdxSizeDouble);
  ...
  public
    class procedure RecursiveSearch<T>(ACurrentNode: T;
      const AGetAdjacentEdges: TFunc<T, TdxAdjacentEdges<T>>;
      const ARecursiveSearchActions: TdxRecursiveSearchActions<T>); static;
    class function LayoutGraphCore(const ALayoutInfos: TArray<TdxLayoutInfo>;
      const ASettings: IdxGraphLayoutSettings;
      const APositionsOffsetCallback: TProc<TdxTuple<Double, TdxPointDouble>,
      Integer>): TArray<TdxPositionInfo>; static;
    class function GetOffset(ALocation, ATotalSize, ASize: Double;
      AAlignment: TdxAlignment; AMargin: Double): Double; static;
  end;
  ...
  strict private
    ...
    FDummyEdgesRoutes: TdxEdgeDictionary<TdxDiagramItem,
      TArray<TdxPointDouble>>;
  public
    constructor Create(APositionsInfo: TdxLayoutInfo;
      ADummyEdgesRoutes: TdxEdgeDictionary < TdxDiagramItem,
      TArray < TdxPointDouble >> );
    destructor Destroy; override;
  ...
  public
    class function GetCoordinate(const ADisconnectedGraphs
      : TEnumerable<TdxGraphInfo>;
      const AGetSize: TFunc<TdxDiagramItem, TdxSizeDouble>;
      ASettings: TdxGraphSugiyamaLayoutSettings): TArray<TdxPositionInfo>;
      overload; static;
    class function GetSugiyamaPositionsInfo(const ADisconnectedGraphs
      : TEnumerable<TdxGraphInfo>;
      const AGetSize: TFunc<TdxDiagramItem, TdxSizeDouble>;
      ASettings: TdxGraphSugiyamaLayoutSettings)
      : TdxSugiyamaPositionsInfo; static;
    class function GetCoordinate(AGraph: TdxGraphInfo;
      const AGetSize: TFunc<TdxDiagramItem, TdxSizeDouble>;
      ASettings: TdxSugiyamaLayoutSettings): TdxSugiyamaLayoutInfo;
      overload; static;
    class function GetDummyEdgesRoutes(AGraph: TdxGraphInfo)
      : TdxEdgeDictionary<TdxDiagramItem, TList<TdxNodeInfo>>; static;
    class function GetAbsolutePosition(const ANodesInfo
      : TEnumerable<TdxNodeInfo>;
      AAbsoluteCoordinates: TDictionary<TdxNodeInfo, Double>;
      const AGetBreadthSize: TFunc<TdxNodeInfo, Double>; AColumnSpacing: Double)
      : TFunc<Double, Double, Double>; static;
    class function GenerateAbsoluteOffsetMatrix(const ANodesInfo
      : TEnumerable<TdxNodeInfo>;
      AAbsoluteCoordinates: TDictionary<TdxNodeInfo, Double>;
      const AGetBreadthSize: TFunc<TdxNodeInfo, Double>)
      : TDictionary<Double, Double>; static;
    class function GenerateAbsoluteOffsetInfo(AAbsoluteOffsetMatrix
      : TDictionary<Double, Double>; AColumnSpacing: Double)
      : TDictionary<Double, TdxTuple<Double, Double>>; static;
    class function GetAbsoluteCoordinate(AGraphInfo: TdxGraphInfo)
      : TDictionary<TdxNodeInfo, Double>; static;
    class function GetPositionsByMedian(AGraphInfo: TdxGraphInfo;
      AMedianAlignmentMode: TMedianAlignmentMode)
      : TDictionary<TdxNodeInfo, Integer>; static;
    class function GetAdjacentEdges(AGraphInfo: TdxGraphInfo;
      AUseConnectionsModes: TdxUseConnectionsModes = DefaultUseConnectionsModes)
      : TFunc<TdxNodeInfo, TdxAdjacentEdges<TdxNodeInfo>>; static;
    class function GetSortedLayers(const ANodesInfo: TList<TdxNodeInfo>)
      : TDictionary<Integer, TList<TdxNodeInfo>>; static;
    class function GetMedians(const ANodesInfo: TEnumerable<TdxNodeInfo>;
      const AGetAdjacentEdges: TFunc<TdxNodeInfo,
      TdxAdjacentEdges<TdxNodeInfo>>;
      AMedianAlignmentMode: TMedianAlignmentMode)
      : TDictionary<TdxNodeInfo, TdxEdgeInfo>; static;
    class function GetActualAdjacentEdge(AAdjacentEdges
      : TdxAdjacentEdges<TdxNodeInfo>;
      AMedianAlignmentMode: TMedianAlignmentMode)
      : TObjectList<TdxEdgeInfo>; static;
    class function GetMedianPosition(AAdjacentEdgesCount: Integer;
      AMedianAlignmentMode: TMedianAlignmentMode): Integer; static;
    class function ResolveConflicts
      (ALayers: TDictionary<Integer, TList<TdxNodeInfo>>;
      AMedians: TDictionary<TdxNodeInfo, TdxEdgeInfo>;
      AMedianAlignmentMode: TMedianAlignmentMode)
      : TDictionary<TdxNodeInfo, TdxEdgeInfo>; static;
    class function GetSortedBlocks(const ANodesInfo: TList<TdxNodeInfo>;
      AMedians: TDictionary<TdxNodeInfo, TdxEdgeInfo>;
      AMedianAlignmentMode: TMedianAlignmentMode)
      : TList<TList<TdxNodeInfo>>; static;
    class function GetBlock(ARoot: TdxNodeInfo;
      AMedians: TDictionary<TdxNodeInfo, TdxEdgeInfo>;
      AMedianAlignmentMode: TMedianAlignmentMode): TList<TdxNodeInfo>; static;
  end;
...
type
  ...
  strict private
    ...
    class function IsSameKey(const AKey: TdxNodeInfo;
      AEdge: TdxEdge<TdxNodeInfo>; AIsOutgoing: Boolean): Boolean;
      static; inline;
    function GetOrderedDictionary(const AEdges: TList<TdxEdge<TdxNodeInfo>>;
      AIsOutgoing: Boolean)
      : TdxSmartPointer<TDictionary<TdxNodeInfo, TList<TdxEdge<TdxNodeInfo>>>>;
  public
    constructor Create(const ANodes: TArray<TdxNodeInfo>;
      const AEdges: TList < TdxEdge < TdxNodeInfo >> ); overload;
    destructor Destroy; override;
    function GetAdjacentEdges(AUseConnectionsModes
      : TdxUseConnectionsModes = DefaultUseConnectionsModes)
      : TFunc<TdxNodeInfo, TdxAdjacentEdges<TdxNodeInfo>>;
    class function IsEqual(const ALeft, ARight: TdxNodeInfo): Boolean;
      static; inline;
...
constructor TInfoGraph.Create(const ANodes: TArray<TdxNodeInfo>;
  const AEdges: TList < TdxEdge < TdxNodeInfo >> );
begin
  FNodes := ANodes;
  FEdges := AEdges;
end;
...
class function TInfoGraph.IsSameKey(const AKey: TdxNodeInfo;
  AEdge: TdxEdge<TdxNodeInfo>; AIsOutgoing: Boolean): Boolean;
begin
  if AIsOutgoing then
...
function TInfoGraph.GetOrderedDictionary(const AEdges
  : TList<TdxEdge<TdxNodeInfo>>; AIsOutgoing: Boolean)
  : TdxSmartPointer<TDictionary<TdxNodeInfo, TList<TdxEdge<TdxNodeInfo>>>>;
var
  AKey: TdxNodeInfo;
  ...
  I: Integer;
begin
  Result := TObjectDictionary < TdxNodeInfo, TList < TdxEdge<TdxNodeInfo> >>
    .Create([doOwnsValues]);
  // !!!!!!!!!!!!!!!!! TODO make TdxOrderedObjectDictionary
...
function TInfoGraph.GetAdjacentEdges(AUseConnectionsModes
  : TdxUseConnectionsModes = DefaultUseConnectionsModes)
  : TFunc<TdxNodeInfo, TdxAdjacentEdges<TdxNodeInfo>>;
var
...
begin
  ...
  try
    ...
    for AEdge in Edges do
      if (AEdge.From <> nil) and (AEdge.&To <> nil) and (AEdge.From <> AEdge.&To)
      then
...
{$ELSE}
    AComparer := TDelegatedComparer < TdxEdge < TdxNodeInfo >>
      .Construct(TComparison < TdxEdge < TdxNodeInfo >> (
...
{$ENDIF}
  ...
  Result := function(ANode: TdxNodeInfo): TdxAdjacentEdges<TdxNodeInfo>
    var
      AOutgoingEdges, AIncomingEdges: TArray<TdxEdge<TdxNodeInfo>>;
      AList: TList<TdxEdge<TdxNodeInfo>>;
    begin
      if (TdxUseConnectionsMode.OutgoingOnly in AUseConnectionsModes) and
        AOutgoing.Value.TryGetValue(ANode, AList) then
{$IFDEF DELPHIXE}
        AOutgoingEdges := AList.ToArray
{$ELSE}
        AOutgoingEdges := TEnumerableHelper.ToArray < TdxEdge < TdxNodeInfo
          >> (AList)
{$ENDIF}
      else
        AOutgoingEdges := nil;
      if (TdxUseConnectionsMode.IncomingOnly in AUseConnectionsModes) and
        AIncoming.Value.TryGetValue(ANode, AList) then
{$IFDEF DELPHIXE}
        AIncomingEdges := AList.ToArray
{$ELSE}
        AIncomingEdges := TEnumerableHelper.ToArray < TdxEdge < TdxNodeInfo
          >> (AList)
{$ENDIF}
      else
        AIncomingEdges := nil;
      Result := TdxAdjacentEdges<TdxNodeInfo>.Create(AOutgoingEdges,
        AIncomingEdges);
    end;
end;
...
constructor TdxPageInfo.Create(const APageSize: TdxSizeDouble;
const APageMargin: TdxRectDouble);
begin
...
const ACanvas: TdxRectDouble; APageMargin: TdxThicknessInfo;
ABreadthAlignment: TdxAlignment = TdxAlignment.Center;
ADepthAlignment: TdxAlignment = TdxAlignment.Near);
begin
  PageSize := APageSize;
  Canvas := ACanvas;
...
constructor TdxPageInfo.Create(const APageSize: TdxSizeDouble;
ABreadthAlignment, ADepthAlignment: TdxAlignment);
begin
  Create(APageSize, TdxRectDouble.Create(APageSize), TdxRectDouble.Null,
    ABreadthAlignment, ADepthAlignment);
end;

function TdxPageInfo.GetAlignment(AGraphViewKind: TdxGraphViewKind)
  : TdxAlignment;
begin
...
constructor TdxAdjacentEdges<T>.Create(const AOutgoingEdges, AIncomingEdges
  : TArray < TdxEdge < T >> );
begin
...
constructor TdxRecursiveSearchActions<T>.Create(const AViewNode: TProc<T>;
const ANodeIsViewed: TFunc<T, Boolean>;
const AEdgeIsViewed: TFunc<TdxEdge<T>, Boolean>;
const ABeginOutAction: TProc<TdxEdge<T>>;
const AEndOutAction: TProc<TdxEdge<T>>; const AAllChildrenAreViewed: TProc<T>;
const ABeginIncomingAction: TProc<TdxEdge<T>>;
const AEndIncomingAction: TProc<TdxEdge<T>>;
const AAllParentAreViewed: TProc<T>);
begin
...
class procedure TdxGraphOperationsCore.RecursiveSearch<T>(ACurrentNode: T;
const AGetAdjacentEdges: TFunc<T, TdxAdjacentEdges<T>>;
  ...
  try
    ...
    begin
      ...
      begin
        ...
        RecursiveSearch<T>(AEdge.&To, AGetAdjacentEdges,
          ARecursiveSearchActions);
  ...
  try
    for AEdge in AEdges.Incoming do
      ...
      begin
        ...
        RecursiveSearch<T>(AEdge.From, AGetAdjacentEdges,
          ARecursiveSearchActions);
...
function GetBreadth(const ASettings: IdxGraphLayoutSettings;
const ASize: TdxSizeDouble): Double;
begin
...
function GetDepth(const ASettings: IdxGraphLayoutSettings;
const ASize: TdxSizeDouble): Double;
begin
...
function GetDirectedValue(ALogicalDirection: TdxLogicalDirectionKind;
...
function GetValue(ADirection: TdxDirection;
const APageMargin: TdxRectDouble): Double;
begin
  case ADirection of
    TdxDirection.Left:
...
function GetPageMargin(const ASettings: IdxGraphLayoutSettings;
AGraphViewKind: TdxGraphViewKind): Double;
begin
  if AGraphViewKind = TdxGraphViewKind.Depth then
    Result := GetValue(ASettings.Direction, ASettings.PageInfo.PageMargin) +
      GetValue(InverseDirection(ASettings.Direction),
      ASettings.PageInfo.PageMargin)
  else
    Result := GetValue(RotateDirection(ASettings.Direction),
      ASettings.PageInfo.PageMargin) +
      GetValue(InverseDirection(RotateDirection(ASettings.Direction)),
      ASettings.PageInfo.PageMargin);
end;
...
function GetPagesSize(const ASettings: IdxGraphLayoutSettings;
AGraphViewKind: TdxGraphViewKind; ATotalSize: Double): Double; overload;
var
  APageSize: Double;
begin
  if AGraphViewKind = TdxGraphViewKind.Breadth then
  ...
  Result := GetPagesSize(APageSize, ATotalSize, GetPageMargin(ASettings,
    AGraphViewKind));
end;

function GetStartLocation(const ASettings: IdxGraphLayoutSettings;
AGraphViewKind: TdxGraphViewKind): Double;
begin
  if AGraphViewKind = TdxGraphViewKind.Breadth then
  begin
...
function GetAlignmentDirection(AAlignment: TdxAlignment;
ADirection: TdxDirection): TdxDirection;
begin
...
function GetMarginValue(ADirection: TdxDirection; AAlignment: TdxAlignment;
AKind: TdxGraphViewKind; APageMargin: TdxThicknessInfo): Double;
begin
  if AKind = TdxGraphViewKind.Depth then
    Result := GetValue(GetAlignmentDirection(AAlignment, ADirection),
      APageMargin)
  else
    Result := GetValue(GetAlignmentDirection(AAlignment,
      RotateDirection(ADirection)), APageMargin);
end;

function GetPoint(AOrientation: TdxOrientationKind;
const APoint: TPoint): Double;
begin
...
function ChooseDirectionStartValue(ADirection: TdxLogicalDirectionKind;
ANear, AFar: Double): Double;
begin
...
function GetDepthCorrection(ASettings: IdxGraphLayoutSettings;
ADepthOffset: Double): Double;
var
  ALocation, ADepth: Double;
begin
  ALocation := GetPoint(ASettings.DepthOrientation,
    ASettings.PageInfo.Canvas.TopLeft);
  ADepth := GetPoint(ASettings.DepthOrientation,
    ASettings.PageInfo.Canvas.BottomRight);
  Result := ChooseDirectionStartValue(ASettings.LogicalDirection,
    ALocation + ADepthOffset, ADepth - ADepthOffset);
end;

function GetOffset(ASettings: IdxGraphLayoutSettings;
AGraphViewKind: TdxGraphViewKind; ASize: Double; ATotalSize: Double): Double;
var
  AOffset: Double;
begin
  AOffset := TdxGraphOperationsCore.GetOffset(GetStartLocation(ASettings,
    AGraphViewKind), ATotalSize, ASize,
    ASettings.PageInfo.GetAlignment(AGraphViewKind),
    GetMarginValue(ASettings.Direction,
    ASettings.PageInfo.GetAlignment(AGraphViewKind), AGraphViewKind,
    ASettings.PageInfo.PageMargin));
  if AGraphViewKind = TdxGraphViewKind.Breadth then
    Result := AOffset
  else
...
function GetStartDepth(const ASettings: IdxGraphLayoutSettings;
ATotalDepth: Double): Double;
begin
  Result := GetOffset(ASettings, TdxGraphViewKind.Depth, ATotalDepth,
    GetPagesSize(ASettings, TdxGraphViewKind.Depth, ATotalDepth));
end;

function MakePoint(AOrientation: TdxOrientationKind;
APrimary, ASecondary: Double): TdxPointDouble;
begin
  if AOrientation = TdxOrientationKind.Horizontal then
...
function GetOffsetAndAdvanceDepth(const ASettings: IdxGraphLayoutSettings;
const ASize: TdxSizeDouble; ATotalDepth, ATotalBreadth: Double)
  : TdxTuple<Double, TdxPointDouble>;
var
  ADepthDelta: Double;
...
begin
  ...
  AOffset := MakePoint(ASettings.BreadthOrientation,
    GetOffset(ASettings, TdxGraphViewKind.Breadth, GetBreadth(ASettings, ASize),
    ATotalBreadth), ATotalDepth);

  if ASettings.LogicalDirection = TdxLogicalDirectionKind.Forward then
    ATotalDepth := ATotalDepth + ADepthDelta;

  ATotalDepth := ATotalDepth + GetDirectedValue(ASettings.LogicalDirection,
    ASettings.DepthSpacing);
  Result := TdxTuple<Double, TdxPointDouble>.Create(ATotalDepth, AOffset);
end;

{ TdxGraphOperationsCore }

class function TdxGraphOperationsCore.LayoutGraphCore(const ALayoutInfos
  : TArray<TdxLayoutInfo>; const ASettings: IdxGraphLayoutSettings;
const APositionsOffsetCallback: TProc<TdxTuple<Double, TdxPointDouble>,
  Integer>): TArray<TdxPositionInfo>;
var
...
begin
  ...
  begin
    AMaxBreadth := Max(AMaxBreadth, GetBreadth(ASettings,
      ALayoutInfo.TotalSize));
    ATotalDepth := ATotalDepth + GetDepth(ASettings, ALayoutInfo.TotalSize);
  end;

  ATotalBreadth := GetPagesSize(ASettings, TdxGraphViewKind.Breadth,
    AMaxBreadth);
  ...
  try
    ...
    begin
      AOffsetAndAdvanceDepth := GetOffsetAndAdvanceDepth(ASettings,
        ALayoutInfos[I].TotalSize, ACurrentDepth, ATotalBreadth);
...
class function TdxGraphOperationsCore.GetOffset(ALocation, ATotalSize,
  ASize: Double; AAlignment: TdxAlignment; AMargin: Double): Double;
var
  AOffset: Double;
begin
  AOffset := 0;
...
constructor TdxTuple<TFirst, TSecond>.Create(const AFirst: TFirst;
const ASecond: TSecond);
begin
  First := AFirst;
  Second := ASecond;
end;
...
constructor TdxPositionInfo.Create(AItem: TdxDiagramItem;
const APosition: TdxPointDouble);
begin
  FItem := AItem;
  FPosition := APosition;
end;
...
begin
  Result := Format('X=%g, Y=%g : %s', [FPosition.X, FPosition.Y,
    PString(@Item)^]);
end;
...
begin
  Result := TEqualityComparer<T>.Default.Equals(FFrom, AObj.From) and
    TEqualityComparer<T>.Default.Equals(FTo, AObj.&To);
end;

function TdxEdge<T>.GetHashCode: Integer;
begin
  Result := TEqualityComparer<T>.Default.GetHashCode(FFrom)
    xor TEqualityComparer<T>.Default.GetHashCode(FTo);
end;
...
constructor TdxEdgeDictionary<T, TValue>.Create(AOwnerships
...
constructor TdxGraph.Create(const ANodes: TArray<TdxDiagramItem>;
  const AEdges: TList < TdxEdge < TdxDiagramItem >> );
begin
  FNodes := ANodes;
  FEdges := AEdges;
end;
...
constructor TdxGraph.Create(const ANodes: TArray<TdxDiagramItem>;
  const AEdges: TArray < TdxEdge < TdxDiagramItem >> );
begin
  FNodes := ANodes;
  FEdges := TList < TdxEdge < TdxDiagramItem >>.Create;
...
function TdxGraph.FindConnectedComponent(ARoot: TdxDiagramItem;
  const AGetAdjacentEdges: TFunc < TdxDiagramItem,
  TdxAdjacentEdges < TdxDiagramItem >> ): TdxGraph;
var
...
begin
  ...
  try
    TdxGraphOperationsCore.RecursiveSearch<TdxDiagramItem>(ARoot,
      AGetAdjacentEdges, TdxRecursiveSearchActions<TdxDiagramItem>.Create(
      procedure(ACurrentNode: TdxDiagramItem)
      begin
        AViewedNodes.Include(ACurrentNode);
      end, function(ACurrentNode: TdxDiagramItem): Boolean
      begin
        Result := AViewedNodes.Contains(ACurrentNode);
      end, function(AEdge: TdxEdge<TdxDiagramItem>): Boolean
      begin
        Result := AViewedEdges.Contains(AEdge);
      end, procedure(AOutgoingEdge: TdxEdge<TdxDiagramItem>)
      begin
        AViewedEdges.Include(AOutgoingEdge);
      end, nil, nil, procedure(AIncomingEdge: TdxEdge<TdxDiagramItem>)
      begin
...
class function TdxGraph.IsSameKey(const AKey: TdxDiagramItem;
AEdge: TdxEdge<TdxDiagramItem>; AIsOutgoing: Boolean): Boolean;
begin
  if AIsOutgoing then
...
function TdxGraph.GetOrderedDictionary(const AEdges
  : TList<TdxEdge<TdxDiagramItem>>; AIsOutgoing: Boolean)
  : TdxSmartPointer<TDictionary<TdxDiagramItem,
  TList<TdxEdge<TdxDiagramItem>>>>;
var
  AKey: TdxDiagramItem;
  ...
  I: Integer;
begin
  Result := TObjectDictionary < TdxDiagramItem, TList < TdxEdge<TdxDiagramItem>
    >>.Create([doOwnsValues]);
  // !!!!!!!!!!!!!!!!! TODO make TdxOrderedObjectDictionary
  if AEdges.Count = 0 then
    Exit;
...
function TdxGraph.GetAdjacentEdges(AUseConnectionsModes
  : TdxUseConnectionsModes = DefaultUseConnectionsModes)
  : TFunc<TdxDiagramItem, TdxAdjacentEdges<TdxDiagramItem>>;
var
...
begin
  ...
  try
    AFullEdges.Capacity := Edges.Count;
    for AEdge in Edges do
      if not IsNull(AEdge.From) and not IsNull(AEdge.&To) and
        (AEdge.From <> AEdge.&To) then
        AFullEdges.Add(AEdge);
...
{$IFDEF DELPHIXE2}
    AComparer := TComparer < TdxEdge < TdxDiagramItem >>.Construct(
      ...
      begin
        Result := TComparer<TdxDiagramItem>.Default.Compare(Right.From,
          Left.From);
      end);
{$ELSE}
    AComparer := TComparer < TdxEdge < TdxDiagramItem >>
      .Construct(TComparison < TdxEdge < TdxDiagramItem >> (
...
{$IFDEF DELPHIXE2}
    AComparer := TComparer < TdxEdge < TdxDiagramItem >>.Construct(
      function(const Left, Right: TdxEdge<TdxDiagramItem>): Integer
      begin
        Result := TComparer<TdxDiagramItem>.Default.Compare(Right.&To,
          Left.&To);
      end);
{$ELSE}
    AComparer := TComparer < TdxEdge < TdxDiagramItem >>
...
{$ENDIF}
  ...
  Result := function(ANode: TdxDiagramItem): TdxAdjacentEdges<TdxDiagramItem>
    var
...
{$IFDEF DELPHIXE}
        AOutgoingEdges := AList.ToArray
{$ELSE}
        AOutgoingEdges := TEnumerableHelper.ToArray < TdxEdge < TdxDiagramItem
          >> (AList)
{$ENDIF}
      else
        AOutgoingEdges := nil;
...
{$IFDEF DELPHIXE}
        AIncomingEdges := AList.ToArray
{$ELSE}
        AIncomingEdges := TEnumerableHelper.ToArray < TdxEdge < TdxDiagramItem
          >> (AList)
{$ENDIF}
      else
        AIncomingEdges := nil;
      Result := TdxAdjacentEdges<TdxDiagramItem>.Create(AOutgoingEdges,
        AIncomingEdges);
    end;
end;
...
begin
  ...
  try
    ...
    begin
      AConnectedComponent := FindConnectedComponent(AAllNodes.ToArray[0],
        AGetAdjacentEdges);
...
var
  ...
  AGetAdjacentEdges: TFunc<TdxDiagramItem, TdxAdjacentEdges<TdxDiagramItem>>;
  ASortedAdjacentEdges: TdxSortedDictionaryOfList<Double,
    TdxEdge<TdxDiagramItem>>;
...
begin
  ...
  try
    ...
    begin
      AEdgeWeightDelegate := function(X: TdxEdge<TdxDiagramItem>): Double
        begin
          Result := 1;
        end;
    end
    ...
    ASortedAdjacentEdges := TdxSortedDictionaryOfList < Double,
      TdxEdge < TdxDiagramItem >>.Create(AEdgeWeightDelegate);
    try
      AAddAdjacentEdges := procedure(ANode: TdxDiagramItem)
        var
      ...
      AExceptIncorrectEdges := procedure()
        begin
          ASortedAdjacentEdges.RemoveWhere(
            function(AEdge: TdxEdge<TdxDiagramItem>): Boolean
            begin
              Result := ASpanningTreeNodes.Contains(AEdge.From) and
                ASpanningTreeNodes.Contains(AEdge.&To);
            end);
        end;
      AGetMinWeightedEdge := function(): TdxEdge<TdxDiagramItem>
        begin
          Result := ASortedAdjacentEdges.GetFirstMin;
          ASortedAdjacentEdges.RemoveFirstMin;
        end;
      AAddNode := procedure(ANode: TdxDiagramItem)
        begin
          ASpanningTreeNodes.Include(ANode);
          AAddAdjacentEdges(ANode);
        end;
      AAddEdge := procedure(AEdge: TdxEdge<TdxDiagramItem>)
        begin
      ...
      while ASortedAdjacentEdges.Any and
        (ASpanningTreeNodes.Count <> Length(Nodes)) do
      begin
        AAddEdge(AGetMinWeightedEdge);
        AExceptIncorrectEdges;
      end;
      Result := TdxGraph.Create(ASpanningTreeNodes.ToArray,
        ASpanningTreeEdges.ToList);
    finally
...
begin
  ...
  try
    ...
    begin
      AIsAcyclic := True;
      TdxGraphOperationsCore.RecursiveSearch<TdxDiagramItem>(ANode,
        AGetAdjacentEdges, TdxRecursiveSearchActions<TdxDiagramItem>.Create(
        procedure(ACurrentNode: TdxDiagramItem)
        begin
        ...
        begin
          if AGrayNodes.Contains(ACurrentNode) then
            AIsAcyclic := False;
          Result := not AIsAcyclic or AGrayNodes.Contains(ACurrentNode) or
            ABlackNodes.Contains(ACurrentNode);
        end, function(AEdge: TdxEdge<TdxDiagramItem>): Boolean
        begin
          Result := not AIsAcyclic;
        end, nil, nil, procedure(ACurrentNode: TdxDiagramItem)
        begin
...
constructor TdxNodeInfo.Create(ANode: TdxDiagramItem; AIsDummy: Boolean;
ALevel, APosition: Integer);
begin
  FNode := ANode;
  FIsDummy := AIsDummy;
...
begin
  Result := (FLayer = ANodeInfo.Layer) and (FPosition = ANodeInfo.Position) and
    (FNode = ANodeInfo.FNode);
end;
...
begin
  ...
  FDummyEdgesRoutes := TdxEdgeDictionary < TdxDiagramItem,
    TArray < TdxPointDouble >>.Create;
end;

constructor TdxSugiyamaPositionsInfo.Create(const APositionsInfo
  : TArray<TdxPositionInfo>; ADummyEdgeRoute: TdxEdgeDictionary <
  TdxDiagramItem, TArray < TdxPointDouble >> );
begin
  Assert(FDummyEdgesRoutes = nil);
...
function TdxSugiyamaPositionsInfo.GetEdgesRoutes(AEdge: TdxEdge<TdxDiagramItem>)
  : TArray<TdxPointDouble>;
begin
...
constructor TdxSugiyamaLayoutSettings.Create(AColumnSpacing,
  ALayerSpacing: Double; ALayoutDirection: TdxLayoutDirection);
begin
...
constructor TdxGraphSugiyamaLayoutSettings.Create(ASugiyamaLayout
  : TdxSugiyamaLayoutSettings; APageInfo: TdxPageInfo);
begin
...
function TdxGraphSugiyamaLayoutSettings.GetBreadthOrientation
  : TdxOrientationKind;
begin
  Result := SugiyamaLayout.BreadthOrientation;
end;

function TdxGraphSugiyamaLayoutSettings.GetLogicalDirection
  : TdxLogicalDirectionKind;
begin
...
constructor TdxSugiyamaLayoutAlgorithm.Create(ACycleRemoval
  : TFunc<TdxGraph, TdxGraph>;
ALayerAssignment: TFunc<TdxGraph, TDictionary<TdxDiagramItem, Integer>>;
ANodesOrdering: TFunc<TdxGraph, TDictionary<TdxDiagramItem, Integer>,
  TdxGraphInfo>; ACoordinateAssignment: TFunc<TList<TdxGraphInfo>,
  TdxSugiyamaPositionsInfo>; AChecks: TdxSugiyamaLayoutChecks);
...
begin
  Result := TdxSugiyamaLayoutAlgorithm.Create(
    ...
    end, function(ACyclicGraph: TdxGraph): TDictionary<TdxDiagramItem, Integer>
    begin
      Result := TdxLayerAssignment.GetLayerAssignment(ACyclicGraph);
    end, function(ACyclicGraph: TdxGraph;
      ANodesLayers: TDictionary<TdxDiagramItem, Integer>): TdxGraphInfo
    begin
      Result := TdxNodesOrderer.OrderNodes(ACyclicGraph, ANodesLayers);
    end, function(AGraphInfo: TList<TdxGraphInfo>): TdxSugiyamaPositionsInfo
    begin
...
class function TdxCycleRemover.GetNonTrivialStronglyConnectedComponents
  (AGraph: TdxGraph): TList<TdxGraph>;
var
...
class function TdxCycleRemover.GetFeedbackSet(ACyclicGraph: TdxGraph)
  : TdxHashSet<TdxEdge<TdxDiagramItem>>;
var
...
{$IFDEF DELPHIXE2}
  TEqualityComparer < TdxEdge < TdxDiagramItem >>.Construct(
    ...
    begin
      Result := Left.Equals(Right);
    end, function(const Value: TdxEdge<TdxDiagramItem>): Integer
    begin
      Result := Value.GetHashCode;
    end)
{$ELSE}
  TEqualityComparer < TdxEdge < TdxDiagramItem >>.Construct(TEqualityComparison
    < TdxEdge < TdxDiagramItem >> (
    function(Left, Right: TdxEdge<TdxDiagramItem>): Boolean
    begin
      Result := Left.Equals(Right);
    end), THasher < TdxEdge < TdxDiagramItem >> (
...
class function TdxCycleRemover.ReverseEdges(AGraph: TdxGraph;
const AFeedbackSet: TdxHashSet < TdxEdge < TdxDiagramItem >> ): TdxGraph;
var
...
begin
  AEdges := TdxHashSet < TdxEdge < TdxDiagramItem >>.Create(AGraph.Edges.Count,
    TEqualityComparer < TdxEdge < TdxDiagramItem >>.Construct(
{$IFDEF DELPHIXE2}
  function(const Left, Right: TdxEdge<TdxDiagramItem>): Boolean begin Result :=
    Left.Equals(Right) end
{$ELSE}
...
{$IFDEF DELPHIXE2}
  function(const Value: TdxEdge<TdxDiagramItem>): Integer begin Result :=
    Value.GetHashCode; end
{$ELSE}
...
{$ENDIF}));
  try
    ...
    begin
      ...
      else if not AEdges.Contains(AEdge) then
      begin
...
class function TdxCycleRemover.GetMaxCyclicEdges(AStronglyConnectedComponent
  : TdxGraph): TdxHashSet<TdxEdge<TdxDiagramItem>>;
var
  ABlackNodes, AGrayNodes: TdxHashSet<TdxDiagramItem>;
    ...
    try
      ...
      try
        ACycleFound :=
          ...
          ACycleWay: TList < TdxEdge < TdxDiagramItem >> )
          var
          ...
          begin
            ...
            begin
              ...
              ACycle.Add(AEdge);
              if TEqualityComparer<TdxDiagramItem>.
                Default.Equals(AEdge.From, ARootNode) then
                break;
            end;
            ACycles.Add(ACycle);
          end;
        ...
        TdxGraphOperationsCore.RecursiveSearch<TdxDiagramItem>
          ...
          AStronglyConnectedComponent.GetAdjacentEdges
          ([TdxUseConnectionsMode.OutgoingOnly]),
          ...
          begin
            ...
            Result := AGrayNodes.Contains(ACurrentNode) or
              ABlackNodes.Contains(ACurrentNode);
          end, function(ACurrentEdge: TdxEdge<TdxDiagramItem>): Boolean
          begin
            Result := False;
          end, procedure(AOutgoingEdge: TdxEdge<TdxDiagramItem>)
          begin
          ...
          end, procedure(ACurrentNode: TdxDiagramItem)
          begin
            ABlackNodes.Include(ACurrentNode);
            AGrayNodes.Exclude(ACurrentNode);
          end, nil, nil, nil))
...
class function TdxCycleRemover.GetStronglyConnectedComponents
  (ACyclicGraph: TdxGraph): TList<TdxGraph>;
var
...
begin
  ...
  try
    ...
    AGetAdjacentEdges := ACyclicGraph.GetAdjacentEdges
      ([TdxUseConnectionsMode.OutgoingOnly]);

    AAddConnectedComponent := procedure(ARootNode: TdxDiagramItem)
      var
      ...
      begin
        ...
        try
          ...
          try
            ...
            until TEqualityComparer<TdxDiagramItem>.
              Default.Equals(ATopStackNode, ARootNode);
...
{$ELSE}
            TEnumerableHelper.ToArray < TdxEdge < TdxDiagramItem >>
              (AComponentEdges)
{$ENDIF}));
          finally
      ...
      TdxGraphOperationsCore.RecursiveSearch<TdxDiagramItem>(ANode,
        ...
        begin
          ...
          if Result and AOnStack[ACurrentEdge.&To] then
            ALowLink[ACurrentEdge.From] := Min(ALowLink[ACurrentEdge.From],
              ALowIndex[ACurrentEdge.&To]);
        end, nil, procedure(AOutgoingEdge: TdxEdge<TdxDiagramItem>)
        begin
          ALowLink.AddOrSetValue(AOutgoingEdge.From,
            Min(ALowLink[AOutgoingEdge.From], ALowLink[AOutgoingEdge.&To]));
        end, procedure(ACurrentNode: TdxDiagramItem)
        begin
...
class function TdxLayerAssignment.GetLayerAssignment(AAcyclicGraph: TdxGraph)
  : TDictionary<TdxDiagramItem, Integer>;
var
...
class function TdxLayerAssignment.GetFeasibleTree(AAcyclicGraph: TdxGraph)
  : TdxGraph;
var
...
begin
  ...
  try
    Result := AAcyclicGraph.GetSpanningGraph(TdxGraph.Null,
      [OutgoingOnly, IncomingOnly], function(X: TdxEdge<TdxDiagramItem>): Double
      begin
...
class function TdxLayerAssignment.InitLayerAssignment(AAcyclicGraph: TdxGraph)
  : TDictionary<TdxDiagramItem, Integer>;
var
  AGetAdjacentEdges: TFunc<TdxDiagramItem, TdxAdjacentEdges<TdxDiagramItem>>;
...
begin
  ...
  try
    ...
    AUpdateActualNode := procedure(AAssignedNodes: TdxHashSet<TdxDiagramItem>)
      var
    ...
    AGetNonAssignedChild := function(): TdxHashSet<TdxDiagramItem>
      var
    ...
    AAssignNodesToLayer := procedure(ANodes: TdxHashSet<TdxDiagramItem>)
      var
        ANode: TdxDiagramItem;
      begin
        for ANode in ANodes do
...
class function TdxLayerAssignment.CalculateNodesLayers(ASpanningTree: TdxGraph)
  : TDictionary<TdxDiagramItem, Integer>;
var
  ANodesLayers: TDictionary<TdxDiagramItem, Integer>;
...
begin
  ...
  TdxGraphOperationsCore.RecursiveSearch<TdxDiagramItem>(ASpanningTree.Nodes[0],
    AGetAdjacentEdges, TdxRecursiveSearchActions<TdxDiagramItem>.Create(
    procedure(ACurrentNode: TdxDiagramItem)
    begin
    ...
    begin
      Result := ANodesLayers.ContainsKey(ACurrentEdge.From) and
        ANodesLayers.ContainsKey(ACurrentEdge.&To);
    end, procedure(AOutgoingEdge: TdxEdge<TdxDiagramItem>)
    begin
...
class function TdxNodesOrderer.OrderNodes(AAcyclicGraph: TdxGraph;
ANodesLayers: TDictionary<TdxDiagramItem, Integer>): TdxGraphInfo;
var
  ACurrentIteration, ABestCrossingCount, ACurrentCrossingCount: Integer;
  AGraphInfo: TdxGraphInfo;
  AOrderedLayers, AOrderedLayersToDestroy
    : TDictionary<Integer, TList<TdxNodeInfo>>;
...
begin
  ...
  try
    ...
    try
      ...
      AGetCrossingCount :=
          function(AOrder: TDictionary < Integer, TList < TdxNodeInfo >>
          ): Integer
        begin
      ...
      begin
        ...
        try
          AOrderedLayers := GetOrderNodes(AOrderedLayers, AGetAdjacentNodes,
            ACurrentOrderMode);
        finally
...
class function TdxNodesOrderer.InitGraphInfo(AAcyclicGraph: TdxGraph;
ANodesLayers: TDictionary<TdxDiagramItem, Integer>): TdxGraphInfo;
var
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          ADummyNodeInfo := TdxNodeInfo.Create(Default (TdxDiagramItem), True,
            ARootLayer + ADelta, APosition);
        ...
        AEdgesInfo.Add(TdxEdgeInfo.Create(ARootNodeInfo,
          ANodesInfoMap[AEdge.&To]));
      end
      else
        AEdgesInfo.Add(TdxEdgeInfo.Create(ANodesInfoMap[AEdge.From],
          ANodesInfoMap[AEdge.&To]));
    end;
...
class function TdxNodesOrderer.InitOrder(const ANodesInfo: TList<TdxNodeInfo>)
  : TDictionary<Integer, TList<TdxNodeInfo>>;
var
...
{$ENDIF}
  Result := TObjectDictionary < Integer, TList < TdxNodeInfo >>
    .Create([doOwnsValues], Length(ANodeInfos));
  ...
  begin
    ...
    for AList in Result.Values do
      AList.Sort(TComparer<TdxNodeInfo>.Construct(
        function(const Left, Right: TdxNodeInfo): Integer
        begin
...
class function TdxNodesOrderer.GetAdjacentNode(AGraphInfo: TdxGraphInfo)
  : TFunc<TdxNodeInfo, TdxTuple<TdxNodeInfo>>;
var
  AChildren, AParents
    : TdxSmartPointer<TDictionary<TdxNodeInfo, TList<TdxNodeInfo>>>;
begin
  AChildren := TEnumerableHelper.ToGroupsDictionary<TdxEdgeInfo, TdxNodeInfo,
    TdxNodeInfo>(AGraphInfo.EdgesInfo, function(X: TdxEdgeInfo): TdxNodeInfo
    begin
      Result := X.From;
    end, function(X: TList<TdxEdgeInfo>): TList<TdxNodeInfo>
    var
      AEdge: TdxEdgeInfo;
    begin
  ...
  AParents := TEnumerableHelper.ToGroupsDictionary<TdxEdgeInfo, TdxNodeInfo,
    TdxNodeInfo>(AGraphInfo.EdgesInfo, function(X: TdxEdgeInfo): TdxNodeInfo
    begin
      Result := X.&To;
    end, function(X: TList<TdxEdgeInfo>): TList<TdxNodeInfo>
  ...
  Result := function(ANode: TdxNodeInfo): TdxTuple<TdxNodeInfo>
    var
...
class function TdxNodesOrderer.GetOrderNodes
  (ALayers: TDictionary<Integer, TList<TdxNodeInfo>>;
const AGetAdjacentNodes: TFunc<TdxNodeInfo, TdxTuple<TdxNodeInfo>>;
AOrderMode: TOrderMode): TDictionary<Integer, TList<TdxNodeInfo>>;
var
...
begin
  ...
  AOrderedLayers := TObjectDictionary < Integer, TList < TdxNodeInfo >>
    .Create([doOwnsValues]);
  AOrderLayer := procedure(ACurrentLayer: Integer)
    var
    ...
    begin
      ...
      try
        TEnumerableHelper.ForEach<TdxNodeInfo>(ALayers[ACurrentLayer],
          ...
          begin
            AAdjacentNodesPositions := GetAdjacentNodesPositions(ANode,
              AOrderMode, AGetAdjacentNodes);
            try
              ANewNodesPosition.Add(ANode,
                GetNodePosition(AAdjacentNodesPositions));
            finally
              AAdjacentNodesPositions.Free;
            end;
          end);
        AOrderedLayers.AddOrSetValue(ACurrentLayer,
          SortNodes(ANewNodesPosition));
      finally
...
class function TdxNodesOrderer.SortNodes(ANodesPosition
  : TDictionary<TdxNodeInfo, Integer>): TList<TdxNodeInfo>;
var
...
{$ELSE}
  APairs := TEnumerableHelper.ToArray < TPair < TdxNodeInfo,
    Integer >> (ANodesPosition);
{$ENDIF}
{$IFDEF DELPHIXE2}
  TArray.Sort < TPair < TdxNodeInfo,
    Integer >> (APairs, TComparer < TPair < TdxNodeInfo, Integer >>.Construct(
...
{$ELSE}
  TArray.Sort < TPair < TdxNodeInfo,
    Integer >> (APairs, TComparer < TPair < TdxNodeInfo,
    Integer >>.Construct(TComparison < TPair < TdxNodeInfo, Integer >> (
...
class function TdxNodesOrderer.GetNodePosition(AAdjacentNodesPositions
  : TList<Integer>): Integer;
var
...
begin
  ...
  if (AAdjacentNodesPositions.Count = 2) or
    (AAdjacentNodesPositions.Count mod 2 = 1) then
    Exit(AAdjacentNodesPositions[AAdjacentNodesPositions.Count div 2]);

  AMedianIndex := AAdjacentNodesPositions.Count div 2;
  ALeftMedianPosition := AAdjacentNodesPositions[AMedianIndex - 1] -
    AAdjacentNodesPositions.First;
  ARightMedianPosition := AAdjacentNodesPositions.Last - AAdjacentNodesPositions
    [AMedianIndex];

  Result := Trunc((AAdjacentNodesPositions[AMedianIndex - 1] *
    ARightMedianPosition + AAdjacentNodesPositions[AMedianIndex] *
    ALeftMedianPosition) / (ALeftMedianPosition + ARightMedianPosition));
end;

class function TdxNodesOrderer.GetAdjacentNodesPositions
  (ANodesInfo: TdxNodeInfo; AOrderMode: TOrderMode;
const AGetAdjacentNodes: TFunc < TdxNodeInfo, TdxTuple < TdxNodeInfo >> )
  : TList<Integer>;
var
...
class function TdxNodesOrderer.GetLayerCrossingCount(ALayer: TList<TdxNodeInfo>;
const AGetAdjacentNodes: TFunc < TdxNodeInfo, TdxTuple < TdxNodeInfo >>
  ): Integer;
var
...
begin
  ...
  try
    TEnumerableHelper.ForEach<TdxNodeInfo>(ALayer, procedure(ANode: TdxNodeInfo)
      var
        AAdjacentNodesPositions: TList<Integer>;
      begin
        AAdjacentNodesPositions := GetAdjacentNodesPositions(ANode,
          TOrderMode.ParentToChildren, AGetAdjacentNodes);
        try
...
class function TdxNodesOrderer.GetCrossingCount
  (ALayers: TDictionary<Integer, TList<TdxNodeInfo>>;
const AGetAdjacentNodes: TFunc < TdxNodeInfo, TdxTuple < TdxNodeInfo >>
  ): Integer;
var
...
begin
  ...
  try
    ...
    try
      ...
      begin
        AAcyclicConnectedComponent := ALayoutSteps.CycleRemoval
          (AConnectedComponent);
        try
          if (TdxSugiyamaLayoutCheck.AllCyclesRemoved in ALayoutSteps.Checks)
            and not AAcyclicConnectedComponent.IsAcyclic then
            raise Exception.Create
              ('The '#$27'Cycle Removal'#$27' step should result in deleting all cycles in the graph');
          if (TdxSugiyamaLayoutCheck.SingleConnectedComponent
            in ALayoutSteps.Checks) and
            (AAcyclicConnectedComponent.GetConnectedComponents.Count <> 1) then
            raise Exception.Create
              ('Input graph in the '#$27'Layer Assignment'#$27' step should have only a single connected component');

          ALayerAssignment := ALayoutSteps.LayerAssignment
            (AAcyclicConnectedComponent);
          try

            ADisconnectedGraphs.Add
              (ALayoutSteps.NodesOrdering(AAcyclicConnectedComponent,
              ALayerAssignment));
          finally
...
constructor TdxLayoutInfo.Create(const APositions: TArray<TdxPositionInfo>;
const ATotalSize: TdxSizeDouble);
begin
...
class function TdxCoordinateAssignment.GetCoordinate(const ADisconnectedGraphs
  : TEnumerable<TdxGraphInfo>;
const AGetSize: TFunc<TdxDiagramItem, TdxSizeDouble>;
ASettings: TdxGraphSugiyamaLayoutSettings): TArray<TdxPositionInfo>;
begin
  Result := GetSugiyamaPositionsInfo(ADisconnectedGraphs, AGetSize, ASettings)
    .PositionsInfo;
end;

class function TdxCoordinateAssignment.GetSugiyamaPositionsInfo
  (const ADisconnectedGraphs: TEnumerable<TdxGraphInfo>;
const AGetSize: TFunc<TdxDiagramItem, TdxSizeDouble>;
ASettings: TdxGraphSugiyamaLayoutSettings): TdxSugiyamaPositionsInfo;
var
  ALayoutInfos: TList<TdxSugiyamaLayoutInfo>;
  ALayoutInfo: TdxSugiyamaLayoutInfo;
  AGraphInfo: TdxGraphInfo;
  ADummyEdgeRoutePoints: TdxEdgeDictionary<TdxDiagramItem,
    TArray<TdxPointDouble>>;
...
begin
  ...
  try
    ...
    begin
      ALayoutInfo := GetCoordinate(AGraphInfo, AGetSize,
        ASettings.SugiyamaLayout);
    ...
    APositionsInfos := TdxGraphOperationsCore.LayoutGraphCore(AInfos, ASettings,
      procedure(AOffsetAndAdvanceDepth: TdxTuple<Double, TdxPointDouble>;
        AIndex: Integer)
      var
    ...
    Result := TdxSugiyamaPositionsInfo.Create(APositionsInfos,
      ADummyEdgeRoutePoints);
  finally
    ALayoutInfos.Free;
  end;
end;

class function TdxCoordinateAssignment.GetCoordinate(AGraph: TdxGraphInfo;
const AGetSize: TFunc<TdxDiagramItem, TdxSizeDouble>;
ASettings: TdxSugiyamaLayoutSettings): TdxSugiyamaLayoutInfo;
var
  ALayer: Integer;
  ...
  ADummyEdgesRoutePoints: TdxEdgeDictionary<TdxDiagramItem,
    TArray<TdxPointDouble>>;
  ...
  ASize: TdxSizeDouble;
begin
  AGetSizeInternal := function(ANodeInfo: TdxNodeInfo): TdxSizeDouble
    begin
  ...
  AGetBreadthNodeSize := function(ANode: TdxNodeInfo): Double
    begin
      if ASettings.BreadthOrientation = TdxOrientationKind.Horizontal then
  ...
  AGetDepthNodeSize := function(ANode: TdxNodeInfo): Double
    begin
      if ASettings.DepthOrientation = TdxOrientationKind.Horizontal then
        Result := AGetSizeInternal(ANode).Width
      else
  ...
  AGetDirectedValue := function(AValue: Double): Double
    begin
      if ASettings.LogicalDirection = TdxLogicalDirectionKind.Forward then
        Result := AValue
      else
  ...
  AChooseDirectionValue := function(ANear, AFar: Double): Double
    begin
      if ASettings.LogicalDirection = TdxLogicalDirectionKind.Forward then
        Result := ANear
      else
  ...
  AGetBreadth := function(ANodePosition: TdxPointDouble): Double
    begin
      if ASettings.BreadthOrientation = TdxOrientationKind.Horizontal then
  ...
  AGetAbsolutePosition := GetAbsolutePosition(AGraph.NodesInfo,
    AAbsoluteCoordinates, AGetBreadthNodeSize, ASettings.ColumnSpacing);
...
{$ENDIF}
  ...
  begin
    ...
    begin
      ...
      ADirectionOffset := AChooseDirectionValue(0,
        AGetDepthNodeSize(ANodeInfo));

      ACurrentPosition := ASetBreadth(ACurrentPosition,
        AGetAbsolutePosition(AAbsoluteCoordinates[ANodeInfo],
        AGetBreadthNodeSize(ANodeInfo)));
      ...
      ARightEdge := Math.Max(ARightEdge, AGetBreadth(ANodePosition) +
        AGetBreadthNodeSize(ANodeInfo));
    ...
    ACurrentPosition := AOffsetDepth(ACurrentPosition,
      AGetDirectedValue(AMaxDepthLayer + ASettings.LayerSpacing));
  end;
  Assert(High(AKeys) = ASortedLayers.Keys.Count - 1);
  ATotalDepth := ATotalDepth + ASettings.LayerSpacing * High(AKeys);

  if ASettings.BreadthOrientation = TdxOrientationKind.Horizontal then
    AOffset := TdxPointDouble.Create(-ALeftEdge, AChooseDirectionValue(0,
      ATotalDepth))
  else
    AOffset := TdxPointDouble.Create(AChooseDirectionValue(0, ATotalDepth),
      -ALeftEdge);
  ...
  try
    for APositionPair in APositions do
      ...
      begin
        APosition := TdxPositionInfo.Create(APositionPair.Key.Node,
          APositionPair.Value);
...
class function TdxCoordinateAssignment.GetDummyEdgesRoutes(AGraph: TdxGraphInfo)
  : TdxEdgeDictionary<TdxDiagramItem, TList<TdxNodeInfo>>;
var
...
begin
  AResultRoutes := TdxEdgeDictionary < TdxDiagramItem,
    TList < TdxNodeInfo >>.Create([doOwnsValues]);
  ADummyEdgesRoutes := TObjectDictionary < TdxEdgeInfo,
    TList < TdxNodeInfo >>.Create([doOwnsValues],
    TEqualityComparer<TdxEdgeInfo>.Construct(
    function(const Left, Right: TdxEdgeInfo): Boolean
    begin
      Result := Left.Equals(Right);
    end, function(const Value: TdxEdgeInfo): Integer
    begin
      Result := Value.GetHashCode;
    end));
  AGetAdjacentEdges := GetAdjacentEdges(AGraph,
    [TdxUseConnectionsMode.OutgoingOnly]);
  ...
  TEnumerableHelper.ForEach<TdxEdgeInfo>(ARootEdges,
    ...
    begin
      ...
      TdxGraphOperationsCore.RecursiveSearch<TdxNodeInfo>(ARootEdge.&To,
        AGetAdjacentEdges, TdxRecursiveSearchActions<TdxNodeInfo>.Create(
        procedure(ANodeInfo: TdxNodeInfo)
        begin
          ADummyEdgesRoutes[ARootEdge].Add(ANodeInfo);
        end, function(ANodeInfo: TdxNodeInfo): Boolean
        begin
          Result := not ANodeInfo.IsDummy;
        end, function(AEdge: TdxEdge<TdxNodeInfo>): Boolean
        begin
          Result := False;
        end, procedure(AEdge: TdxEdge<TdxNodeInfo>)
        begin
          if not AEdge.&To.IsDummy then
            AResultRoutes.Add(TdxEdge<TdxDiagramItem>.Create
              (ARootEdge.From.Node, AEdge.&To.Node),
              TList<TdxNodeInfo>.Create(ADummyEdgesRoutes[ARootEdge]));
...
class function TdxCoordinateAssignment.GetAbsolutePosition(const ANodesInfo
  : TEnumerable<TdxNodeInfo>;
AAbsoluteCoordinates: TDictionary<TdxNodeInfo, Double>;
const AGetBreadthSize: TFunc<TdxNodeInfo, Double>; AColumnSpacing: Double)
  : TFunc<Double, Double, Double>;
var
  AAbsoluteOffsetInfo
    : TdxSmartPointer<TDictionary<Double, TdxTuple<Double, Double>>>;
  AAbsoluteOffsetMatrix: TdxSmartPointer<TDictionary<Double, Double>>;
begin
  AAbsoluteOffsetMatrix := GenerateAbsoluteOffsetMatrix(ANodesInfo,
    AAbsoluteCoordinates, AGetBreadthSize);
  AAbsoluteOffsetInfo := GenerateAbsoluteOffsetInfo(AAbsoluteOffsetMatrix,
    AColumnSpacing);

  Result := function(AAbsoluteCoordinate, AItemSize: Double): Double
    var
    ...
    begin
      ...
      if SameValue(Frac(AAbsoluteCoordinate), 0) then
        ...
        Result := AAbsoluteLeftOffset +
          (ACellWidth - (AItemSize - AColumnSpacing) / 2);
    end;
end;

class function TdxCoordinateAssignment.GenerateAbsoluteOffsetMatrix
  (const ANodesInfo: TEnumerable<TdxNodeInfo>;
AAbsoluteCoordinates: TDictionary<TdxNodeInfo, Double>;
const AGetBreadthSize: TFunc<TdxNodeInfo, Double>): TDictionary<Double, Double>;

  procedure AddCell(AAbsoluteOffsetMatrix: TDictionary<Double, Double>;
  ANodeInfo: TdxNodeInfo; AIntAbsCoord: Double);
  var
    ABreadthSize: Double;
  begin
    ...
    AAbsoluteOffsetMatrix[AIntAbsCoord] :=
      Max(ABreadthSize, AAbsoluteOffsetMatrix[AIntAbsCoord]);
  end;
...
class function TdxCoordinateAssignment.GenerateAbsoluteOffsetInfo
  (AAbsoluteOffsetMatrix: TDictionary<Double, Double>; AColumnSpacing: Double)
  : TDictionary<Double, TdxTuple<Double, Double>>;
var
...
class function TdxCoordinateAssignment.GetAbsoluteCoordinate
  (AGraphInfo: TdxGraphInfo): TDictionary<TdxNodeInfo, Double>;
var
...
begin
  AMediansPositions := TObjectList < TDictionary < TdxNodeInfo,
    Integer >>.Create;
...
class function TdxCoordinateAssignment.GetPositionsByMedian
  (AGraphInfo: TdxGraphInfo; AMedianAlignmentMode: TMedianAlignmentMode)
  : TDictionary<TdxNodeInfo, Integer>;
var
  ASortedLayers: TDictionary<Integer, TList<TdxNodeInfo>>; // was Sorted
...
begin
  ...
  AMedians := GetMedians(AGraphInfo.NodesInfo, GetAdjacentEdges(AGraphInfo,
    [TdxUseConnectionsMode.OutgoingOnly, TdxUseConnectionsMode.IncomingOnly]),
    AMedianAlignmentMode);

  AResolved := ResolveConflicts(ASortedLayers, AMedians, AMedianAlignmentMode);

  ABlocks := GetSortedBlocks(AGraphInfo.NodesInfo, AResolved,
    AMedianAlignmentMode);
  try
...
class function TdxCoordinateAssignment.GetAdjacentEdges
  (AGraphInfo: TdxGraphInfo;
AUseConnectionsModes: TdxUseConnectionsModes = DefaultUseConnectionsModes)
  : TFunc<TdxNodeInfo, TdxAdjacentEdges<TdxNodeInfo>>;
var
...
{$ENDIF}
  ...
  Result := function(ANodeInfo: TdxNodeInfo): TdxAdjacentEdges<TdxNodeInfo>
    var
...
{$IFDEF DELPHIXE2}
        TArray.Sort < TdxEdge < TdxNodeInfo >>
          (AOutgoings, TComparer < TdxEdge < TdxNodeInfo >>.Construct(
          function(const Left, Right: TdxEdge<TdxNodeInfo>): Integer
          begin
...
{$ELSE}
        TArray.Sort < TdxEdge < TdxNodeInfo >>
          (AOutgoings, TComparer < TdxEdge < TdxNodeInfo >>
          .Construct(TComparison < TdxEdge < TdxNodeInfo >> (
          function(Left, Right: TdxEdge<TdxNodeInfo>): Integer
          begin
            Result := Left.&To.Position - Right.&To.Position;
...
{$IFDEF DELPHIXE2}
        TArray.Sort < TdxEdge < TdxNodeInfo >>
          (AIncomings, TComparer < TdxEdge < TdxNodeInfo >>.Construct(
          function(const Left, Right: TdxEdge<TdxNodeInfo>): Integer
          begin
...
{$ELSE}
        TArray.Sort < TdxEdge < TdxNodeInfo >>
          (AIncomings, TComparer < TdxEdge < TdxNodeInfo >>
          .Construct(TComparison < TdxEdge < TdxNodeInfo >> (
          function(Left, Right: TdxEdge<TdxNodeInfo>): Integer
          begin
            Result := Left.From.Position - Right.From.Position;
...
class function TdxCoordinateAssignment.GetSortedLayers(const ANodesInfo
  : TList<TdxNodeInfo>): TDictionary<Integer, TList<TdxNodeInfo>>;
begin
  Result := TEnumerableHelper.ToGroupsDictionary<TdxNodeInfo, Integer,
    TdxNodeInfo>(ANodesInfo, function(ANodeInfo: TdxNodeInfo): Integer
    begin
      Result := ANodeInfo.Layer;
    end, function(ANodeInfos: TList<TdxNodeInfo>): TList<TdxNodeInfo>
    begin
...
class function TdxCoordinateAssignment.GetMedians(const ANodesInfo
  : TEnumerable<TdxNodeInfo>;
const AGetAdjacentEdges: TFunc<TdxNodeInfo, TdxAdjacentEdges<TdxNodeInfo>>;
AMedianAlignmentMode: TMedianAlignmentMode)
  : TDictionary<TdxNodeInfo, TdxEdgeInfo>;
begin
  Result := TEnumerableHelper.ToDictionary<TdxNodeInfo, TdxNodeInfo,
    TdxEdgeInfo>(ANodesInfo, function(ANodeInfo: TdxNodeInfo): TdxNodeInfo
    begin
      Result := ANodeInfo;
    end, function(ANodeInfo: TdxNodeInfo): TdxEdgeInfo
    var
      AAdjacentEdges: TdxAdjacentEdges<TdxNodeInfo>;
    ...
    begin
      AAdjacentEdges := AGetAdjacentEdges(ANodeInfo);
      try
        AActualAdjacentEdges := GetActualAdjacentEdge(AAdjacentEdges,
          AMedianAlignmentMode);
        try
          AMedianPosition := GetMedianPosition(AActualAdjacentEdges.Count,
            AMedianAlignmentMode);
...
class function TdxCoordinateAssignment.GetActualAdjacentEdge(AAdjacentEdges
  : TdxAdjacentEdges<TdxNodeInfo>; AMedianAlignmentMode: TMedianAlignmentMode)
  : TObjectList<TdxEdgeInfo>;
var
  AEdge: TdxEdge<TdxNodeInfo>;
begin
...
class function TdxCoordinateAssignment.GetMedianPosition(AAdjacentEdgesCount
  : Integer; AMedianAlignmentMode: TMedianAlignmentMode): Integer;
begin
...
class function TdxCoordinateAssignment.ResolveConflicts
  (ALayers: TDictionary<Integer, TList<TdxNodeInfo>>;
AMedians: TDictionary<TdxNodeInfo, TdxEdgeInfo>;
AMedianAlignmentMode: TMedianAlignmentMode)
  : TDictionary<TdxNodeInfo, TdxEdgeInfo>;
...
begin
  ...
  AGetMedianPosition := function(AMedian: TdxEdgeInfo): Integer
    begin
      if AMedianAlignmentMode in [TMedianAlignmentMode.TopLeft,
        TMedianAlignmentMode.TopRight] then
  ...
  AGetNodesInfoOrder :=
    ...
    begin
      ...
      if AMedianAlignmentMode in [TMedianAlignmentMode.TopRight,
        TMedianAlignmentMode.BottomRight] then
        Result.Sort(TComparer<TdxNodeInfo>.Construct(
          function(const Left, Right: TdxNodeInfo): Integer
          begin
  ...
  ACheckConflict :=
      function(AOccupiedPositions: TdxHashSet<Integer>;
    AMedianPosition: Integer): Boolean
    var
      I: Integer;
    begin
      if AOccupiedPositions.Count = 0 then
        Exit(False);
      if AMedianAlignmentMode in [TMedianAlignmentMode.TopLeft,
        TMedianAlignmentMode.BottomLeft] then
      begin
    ...
    try
      ...
      try
        ...
        begin
          ...
          if (AMedian = nil) or ACheckConflict(AOccupiedPositions,
            AGetMedianPosition(AMedian)) then
...
class function TdxCoordinateAssignment.GetSortedBlocks(const ANodesInfo
  : TList<TdxNodeInfo>; AMedians: TDictionary<TdxNodeInfo, TdxEdgeInfo>;
AMedianAlignmentMode: TMedianAlignmentMode): TList<TList<TdxNodeInfo>>;
var
  ABlocks: TList<TList<TdxNodeInfo>>;
...
begin
  ...
  if AMedianAlignmentMode in [TMedianAlignmentMode.BottomLeft,
    TMedianAlignmentMode.BottomRight] then
  ...
  ABlockComparer := TComparer < TList < TdxNodeInfo >>.Construct(
    ...
    var
      ANodeInfo, xMinNodeInfo, yOnMinXLayer, yMinNodeInfo,
        xOnMinYLayer: TdxNodeInfo;
      APosition: Integer;
    begin
      if X = Y then
        Exit(0);
...
class function TdxCoordinateAssignment.GetBlock(ARoot: TdxNodeInfo;
AMedians: TDictionary<TdxNodeInfo, TdxEdgeInfo>;
