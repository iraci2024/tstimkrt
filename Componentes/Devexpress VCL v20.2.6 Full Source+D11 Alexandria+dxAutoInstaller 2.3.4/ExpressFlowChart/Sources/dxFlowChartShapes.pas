...
type
  ...
  public
    ...
    property StrokeLineJoin: TdxGpLineJoin read FStrokeLineJoin
      write FStrokeLineJoin;
    property FillBrightness: Single read FFillBrightness write FFillBrightness;
    property FillColor: TdxNullableValue<TdxAlphaColor> read FFillColor
      write FFillColor;
    property StrokeColor: TdxNullableValue<TdxAlphaColor> read FStrokeColor
      write FStrokeColor;
    property StrokeThickness: TdxNullableValue<Single> read FStrokeThickness
      write FStrokeThickness;
    property StrokeDashArray: TArray<Single> read FStrokeDashArray
      write FStrokeDashArray;
...
{$ENDIF}
  ...
  public
    constructor Create(const AID: string; const ADefaultSize: TSize;
      AUseBackgroundAsForeground: Boolean); overload;

    function CreateViewData(const ASize: TdxSizeF;
      const AParameters: TArray<Single>): TdxShapeViewData; virtual; abstract;
    function GetConnectionPoints(const ASize: TdxSizeF;
      const AParameters: TArray<Single>): TArray<TdxPointF>; virtual; abstract;
    function GetNormalizedParameters(const ASize: TdxSizeF;
      const AParameters: TArray<Single>): TArray<Single>; virtual; abstract;
    function GetParameterDefaultValue(AParameterIndex: Integer): Single;
      virtual; abstract;
    ...
    function GetParameters(const ASize: TdxSizeF;
      const AParameters: TArray<Single>): TArray<Single>; virtual; abstract;
    procedure PaintDefaultShape(AGraphics: TdxGPCanvas; const ABounds: TRect;
      APenColor, ABrushColor: TdxAlphaColor); virtual;

    property DefaultSize: TdxSizeF read FDefaultSize write FDefaultSize;
    property ID: string read FID write FID;
    property UseBackgroundAsForeground: Boolean read FUseBackgroundAsForeground
      write FUseBackgroundAsForeground;
  end;
  ...
  protected
    constructor Create(AOwner: TdxFlowChartAdvancedShapeRepository;
      const AResourceName: string; ACaption: Pointer); overload;
    function AddPredefinedShape(const AShapeID: string; ACaption: Pointer;
      ALegacyReplacement: Boolean = False)
      : TdxFlowChartObjectAdvancedShape; overload;
    function AddPredefinedShape(AShapeDescription: TdxShapeDescription;
      ACaption: Pointer; ALegacyReplacement: Boolean = False)
      : TdxFlowChartObjectAdvancedShape; overload;
    function AddUserShape(AShapeID: string; const ACaption: string)
      : TdxFlowChartObjectAdvancedShape;
    ...
    property ShapeDescriptions: TObjectDictionary<string, TdxShapeDescription>
      read FShapeDescriptions;
  public
    ...
    property Shapes[Index: Integer]: TdxFlowChartObjectAdvancedShape
  ...
  public
    ...
    property RoundedRectangleShape: TdxFlowChartObjectAdvancedShape
      read FRoundedRectangleShape;
    property SingleSnipCornerRectangleShape: TdxFlowChartObjectAdvancedShape
      read FSingleSnipCornerRectangleShape;
    property SnipSameSideCornerRectangleShape: TdxFlowChartObjectAdvancedShape
      read FSnipSameSideCornerRectangleShape;
    property SnipDiagonalCornerRectangleShape: TdxFlowChartObjectAdvancedShape
      read FSnipDiagonalCornerRectangleShape;
    property SingleRoundCornerRectangleShape: TdxFlowChartObjectAdvancedShape
      read FSingleRoundCornerRectangleShape;
    property RoundSameSideCornerRectangleShape: TdxFlowChartObjectAdvancedShape
      read FRoundSameSideCornerRectangleShape;
    property RoundDiagonalCornerRectangleShape: TdxFlowChartObjectAdvancedShape
      read FRoundDiagonalCornerRectangleShape;
    property SnipAndRoundSingleCornerRectangleShape
      : TdxFlowChartObjectAdvancedShape
      read FSnipAndRoundSingleCornerRectangleShape;
    property SnipCornerRectangleShape: TdxFlowChartObjectAdvancedShape
      read FSnipCornerRectangleShape;
    property RoundCornerRectangleShape: TdxFlowChartObjectAdvancedShape
      read FRoundCornerRectangleShape;
    property SnipAndRoundCornerRectangleShape: TdxFlowChartObjectAdvancedShape
      read FSnipAndRoundCornerRectangleShape;
    ...
    property DiagonalStripe: TdxFlowChartObjectAdvancedShape
      read FDiagonalStripe;
    ...
    property LeftParenthesis: TdxFlowChartObjectAdvancedShape
      read FLeftParenthesis;
    property RightParenthesis: TdxFlowChartObjectAdvancedShape
      read FRightParenthesis;
  ...
  public
    ...
    property OnPageReference: TdxFlowChartObjectAdvancedShape
      read FOnPageReference;
    property OffPageReference: TdxFlowChartObjectAdvancedShape
      read FOffPageReference;
  end;
  ...
  public
    ...
    property SimpleDoubleArrow: TdxFlowChartObjectAdvancedShape
      read FSimpleDoubleArrow;
    ...
    property SharpBentArrow: TdxFlowChartObjectAdvancedShape
      read FSharpBentArrow;
    property CurvedRightArrow: TdxFlowChartObjectAdvancedShape
      read FCurvedRightArrow;
    property CurvedLeftArrow: TdxFlowChartObjectAdvancedShape
      read FCurvedLeftArrow;
    ...
    property LeftRightUpArrow: TdxFlowChartObjectAdvancedShape
      read FLeftRightUpArrow;
    property LeftRightArrowBlock: TdxFlowChartObjectAdvancedShape
      read FLeftRightArrowBlock;
    property QuadArrowBlock: TdxFlowChartObjectAdvancedShape
      read FQuadArrowBlock;
  end;
  ...
  public
    ...
    property VerticalScroll: TdxFlowChartObjectAdvancedShape
      read FVerticalScroll;
    property HorizontalScroll: TdxFlowChartObjectAdvancedShape
      read FHorizontalScroll;
  ...
  public
    ...
    property VariableProcedure: TdxFlowChartObjectAdvancedShape
      read FVariableProcedure;
    ...
    property MessageFromUser: TdxFlowChartObjectAdvancedShape
      read FMessageFromUser;
    property PrimitiveFromCallControl: TdxFlowChartObjectAdvancedShape
      read FPrimitiveFromCallControl;
    ...
    property PrimitiveToCallControl: TdxFlowChartObjectAdvancedShape
      read FPrimitiveToCallControl;
    ...
    property DividedProcess: TdxFlowChartObjectAdvancedShape
      read FDividedProcess;
  ...
  protected
    ...
    property Shapes: TDictionary<string, TdxFlowChartObjectAdvancedShape>
      read FShapes;
  public
    constructor Create;
    destructor Destroy; override;
    function FindShapeByID(const AID: string): TdxFlowChartObjectAdvancedShape;
    function FindStencilByID(const AID: string)
      : TdxFlowChartAdvancedShapeStencil;
    procedure LoadShapesFromFile(const AFileName, AStencilID: string;
      const AStencilCaption: string = '');
    procedure LoadShapesFromStream(const AStream: TStream;
      const AStencilID: string; const AStencilCaption: string = '');

    property Stencils[Index: Integer]: TdxFlowChartAdvancedShapeStencil
      read GetStencil;
    property StencilCount: Integer read GetStencilCount;
    // predefined stencils
    property ArrowShapes: TdxFlowChartArrowShapes read FArrowShapes;
    property BasicFlowchartShapes: TdxFlowChartBasicFlowchartShapes
      read FBasicFlowchartShapes;
    property BasicShapes: TdxFlowChartBasicShapes read FBasicShapes;
    property DecorativeShapes: TdxFlowChartDecorativeShapes
      read FDecorativeShapes;
    property SDLDiagramShapes: TdxFlowChartSDLDiagramShapes
      read FSDLDiagramShapes;
...
uses
  RTLConsts, Windows, Math, dxStringHelper, AnsiStrings, dxSVGCoreParsers,
  dxTypeHelpers, dxFcStrs,
...
type
  ...
  TdxFlowChartObjectPredefinedAdvancedShape = class
    (TdxFlowChartObjectAdvancedShape)
  strict private
    FCaption: Pointer;
  protected
    constructor Create(AStencil: TdxFlowChartAdvancedShapeStencil;
      AShape: TdxShapeDescription; ACaption: Pointer;
      ALegacyReplacement: Boolean = False);
...
constructor TdxFlowChartObjectAdvancedShape.Create
  (AStencil: TdxFlowChartAdvancedShapeStencil; AShape: TdxShapeDescription;
  ALegacyReplacement: Boolean = False);
begin
...
begin
  Result.Init(Round(FShape.DefaultSize.Width),
    Round(FShape.DefaultSize.Height));
end;
...
constructor TdxFlowChartObjectPredefinedAdvancedShape.Create
  (AStencil: TdxFlowChartAdvancedShapeStencil; AShape: TdxShapeDescription;
  ACaption: Pointer; ALegacyReplacement: Boolean = False);
begin
...
procedure TdxFlowChartObjectPredefinedAdvancedShape.SetCaption
  (const Value: string);
begin
...
constructor TFlowChartObjectUserAdvancedShape.Create
  (AStencil: TdxFlowChartAdvancedShapeStencil; AShape: TdxShapeDescription;
...
constructor TdxFlowChartAdvancedShapeStencil.Create
  (AOwner: TdxFlowChartAdvancedShapeRepository; const AResourceName: string;
  ACaption: Pointer);
var
...
begin
  ...
  FShapeDescriptions := TObjectDictionary<string, TdxShapeDescription>.Create
    ([doOwnsValues], TdxIStringComparer.Ordinal);
...
constructor TdxFlowChartAdvancedShapeStencil.Create(const AID,
  ACaption: string);
var
  I: Integer;
begin
...
function TdxFlowChartAdvancedShapeStencil.AddPredefinedShape(const AShapeID
  : string; ACaption: Pointer; ALegacyReplacement: Boolean = False)
  : TdxFlowChartObjectAdvancedShape;
var
...
begin
  ...
  begin
    Result := TdxFlowChartObjectPredefinedAdvancedShape.Create(Self,
      AShapeDescription, ACaption, ALegacyReplacement);
    FShapes.Add(Result);
    Owner.Shapes.Add(Result.ID, Result);
  end
  else
    raise EdxException.CreateFmt('Shape description with ID="%s" not found!',
      [AShapeDescription.ID]);
end;

function TdxFlowChartAdvancedShapeStencil.AddPredefinedShape(AShapeDescription
  : TdxShapeDescription; ACaption: Pointer; ALegacyReplacement: Boolean = False)
  : TdxFlowChartObjectAdvancedShape;
begin
  ...
  begin
    ...
    raise EdxException.CreateFmt
      ('Shape description with ID="%s" already exists!',
      [AShapeDescription.ID]);
end;
...
begin
  if FShapeDescriptions.TryGetValue(AShapeID, AShapeDescription) then
  begin
    Result := TFlowChartObjectUserAdvancedShape.Create(Self, AShapeDescription,
      ACaption);
    FShapes.Add(Result);
    Owner.Shapes.Add(Result.ID, Result);
  end
...
procedure TdxFlowChartAdvancedShapeStencil.RemoveShape
...
function TdxFlowChartAdvancedShapeStencil.GetShape(Index: Integer)
  : TdxFlowChartObjectAdvancedShape;
begin
...
begin
  FRectangle := AddPredefinedShape(TdxBasicCodeShapes.CreateRectangleShape,
    @sdxFlowChart_BasicShapes_Rectangle, True);
  FEllipse := AddPredefinedShape(TdxBasicCodeShapes.CreateEllipseShape,
    @sdxFlowChart_BasicShapes_Ellipse, True);
  FTriangle := AddPredefinedShape(TdxBasicCodeShapes.CreateTriangleShape,
    @sdxFlowChart_BasicShapes_Triangle, True);
  FRightTriangle := AddPredefinedShape
    (TdxBasicCodeShapes.CreateRightTriangleShape,
    @sdxFlowChart_BasicShapes_RightTriangle);
  FPentagon := AddPredefinedShape(TdxBasicCodeShapes.CreatePentagonShape,
    @sdxFlowChart_BasicShapes_Pentagon);
  FHexagon := AddPredefinedShape(TdxBasicCodeShapes.CreateHexagonShape,
    @sdxFlowChart_BasicShapes_Hexagon, True);
  FHeptagon := AddPredefinedShape(TdxBasicCodeShapes.CreateHeptagonShape,
    @sdxFlowChart_BasicShapes_Heptagon);
  FOctagon := AddPredefinedShape(TdxBasicCodeShapes.CreateOctagonShape,
    @sdxFlowChart_BasicShapes_Octagon);
  FDecagon := AddPredefinedShape(TdxBasicCodeShapes.CreateDecagonShape,
    @sdxFlowChart_BasicShapes_Decagon);
  FCan := AddPredefinedShape(TdxBasicCodeShapes.CreateCanShape,
    @sdxFlowChart_BasicShapes_Can);
  FParallelogram := AddPredefinedShape
    (TdxBasicCodeShapes.CreateParallelogramShape,
    @sdxFlowChart_BasicShapes_Parallelogram);
  FTrapezoid := AddPredefinedShape(TdxBasicCodeShapes.CreateTrapezoidShape,
    @sdxFlowChart_BasicShapes_Trapezoid);
  FDiamond := AddPredefinedShape(TdxBasicCodeShapes.CreateDiamondShape,
    @sdxFlowChart_BasicShapes_Diamond, True);
  FCross := AddPredefinedShape('Cross', @sdxFlowChart_BasicShapes_Cross);
  FCube := AddPredefinedShape(TdxBasicCodeShapes.CreateCubeShape,
    @sdxFlowChart_BasicShapes_Cube);
  FChevron := AddPredefinedShape(TdxBasicCodeShapes.CreateChevronShape,
    @sdxFlowChart_BasicShapes_Chevron);
  FStar4 := AddPredefinedShape(TdxBasicCodeShapes.CreateStar4Shape,
    @sdxFlowChart_BasicShapes_Star4);
  FStar5 := AddPredefinedShape(TdxBasicCodeShapes.CreateStar5Shape,
    @sdxFlowChart_BasicShapes_Star5);
  FStar6 := AddPredefinedShape(TdxBasicCodeShapes.CreateStar6Shape,
    @sdxFlowChart_BasicShapes_Star6);
  FStar7 := AddPredefinedShape(TdxBasicCodeShapes.CreateStar7Shape,
    @sdxFlowChart_BasicShapes_Star7);
  FStar16 := AddPredefinedShape(TdxBasicCodeShapes.CreateStar16Shape,
    @sdxFlowChart_BasicShapes_Star16);
  FStar24 := AddPredefinedShape(TdxBasicCodeShapes.CreateStar24Shape,
    @sdxFlowChart_BasicShapes_Star24);
  FStar32 := AddPredefinedShape(TdxBasicCodeShapes.CreateStar32Shape,
    @sdxFlowChart_BasicShapes_Star32);
  FRoundedRectangleShape := AddPredefinedShape
    (TdxBasicCodeShapes.CreateRoundedRectangleShape,
    @sdxFlowChart_BasicShapes_RoundedRectangle, True);
  FSingleSnipCornerRectangleShape :=
    AddPredefinedShape(TdxBasicCodeShapes.CreateSingleSnipCornerRectangleShape,
    @sdxFlowChart_BasicShapes_SingleSnipCornerRectangle);
  FSnipSameSideCornerRectangleShape :=
    AddPredefinedShape
    (TdxBasicCodeShapes.CreateSnipSameSideCornerRectangleShape,
    @sdxFlowChart_BasicShapes_SnipSameSideCornerRectangle);
  FSnipDiagonalCornerRectangleShape :=
    AddPredefinedShape
    (TdxBasicCodeShapes.CreateSnipDiagonalCornerRectangleShape,
    @sdxFlowChart_BasicShapes_SnipDiagonalCornerRectangle);
  FSingleRoundCornerRectangleShape :=
    AddPredefinedShape(TdxBasicCodeShapes.CreateSingleRoundCornerRectangleShape,
    @sdxFlowChart_BasicShapes_SingleRoundCornerRectangle);
  FRoundSameSideCornerRectangleShape :=
    AddPredefinedShape
    (TdxBasicCodeShapes.CreateRoundSameSideCornerRectangleShape,
    @sdxFlowChart_BasicShapes_RoundSameSideCornerRectangle);
  FRoundDiagonalCornerRectangleShape :=
    AddPredefinedShape
    (TdxBasicCodeShapes.CreateRoundDiagonalCornerRectangleShape,
    @sdxFlowChart_BasicShapes_RoundDiagonalCornerRectangle);
  FSnipAndRoundSingleCornerRectangleShape :=
    AddPredefinedShape
    (TdxBasicCodeShapes.CreateSnipAndRoundSingleCornerRectangleShape,
    @sdxFlowChart_BasicShapes_SnipAndRoundSingleCornerRectangle);
  FSnipCornerRectangleShape := AddPredefinedShape
    (TdxBasicCodeShapes.CreateSnipCornerRectangleShape,
    @sdxFlowChart_BasicShapes_SnipCornerRectangle);
  FRoundCornerRectangleShape := AddPredefinedShape
    (TdxBasicCodeShapes.CreateRoundCornerRectangleShape,
    @sdxFlowChart_BasicShapes_RoundCornerRectangle);
  FSnipAndRoundCornerRectangleShape :=
    AddPredefinedShape
    (TdxBasicCodeShapes.CreateSnipAndRoundCornerRectangleShape,
    @sdxFlowChart_BasicShapes_SnipAndRoundCornerRectangle);
  FPlaque := AddPredefinedShape(TdxBasicCodeShapes.CreatePlaqueShape,
    @sdxFlowChart_BasicShapes_Plaque);
  FFrame := AddPredefinedShape(TdxBasicCodeShapes.CreateFrameShape,
    @sdxFlowChart_BasicShapes_Frame);
  FFrameCorner := AddPredefinedShape(TdxBasicCodeShapes.CreateFrameCornerShape,
    @sdxFlowChart_BasicShapes_FrameCorner);
  FLShape := AddPredefinedShape(TdxBasicCodeShapes.CreateLShapeShape,
    @sdxFlowChart_BasicShapes_LShape);
  FDiagonalStripe := AddPredefinedShape
    (TdxBasicCodeShapes.CreateDiagonalStripeShape,
    @sdxFlowChart_BasicShapes_DiagonalStripe);
  FDonut := AddPredefinedShape(TdxBasicCodeShapes.CreateDonutShape,
    @sdxFlowChart_BasicShapes_Donut);
  FNoSymbol := AddPredefinedShape(TdxBasicCodeShapes.CreateNoSymbolShape,
    @sdxFlowChart_BasicShapes_NoSymbol);
  FLeftParenthesis := AddPredefinedShape('LeftParenthesis',
    @sdxFlowChart_BasicShapes_LeftParenthesis);
  FRightParenthesis := AddPredefinedShape('RightParenthesis',
    @sdxFlowChart_BasicShapes_RightParenthesis);
  FLeftBrace := AddPredefinedShape('LeftBrace',
    @sdxFlowChart_BasicShapes_LeftBrace);
  FRightBrace := AddPredefinedShape('RightBrace',
...
begin
  FProcess := AddPredefinedShape('Process',
    @sdxFlowChart_BasicFlowchartShapes_Process);
  FDecision := AddPredefinedShape('Decision',
    @sdxFlowChart_BasicFlowchartShapes_Decision);
  FSubprocess := AddPredefinedShape('Subprocess',
    @sdxFlowChart_BasicFlowchartShapes_Subprocess);
  FDocument := AddPredefinedShape('Document',
    @sdxFlowChart_BasicFlowchartShapes_Document);
  FOnPageReference := AddPredefinedShape('OnPageReference',
    @sdxFlowChart_BasicFlowchartShapes_OnPageReference);
  FOffPageReference := AddPredefinedShape('OffPageReference',
...
begin
  FSimpleArrow := AddPredefinedShape('SimpleArrow',
    @sdxFlowChart_ArrowShapes_SimpleArrow);
  FSimpleDoubleArrow := AddPredefinedShape('SimpleDoubleArrow',
    @sdxFlowChart_ArrowShapes_SimpleDoubleArrow);
  FModernArrow := AddPredefinedShape('ModernArrow',
    @sdxFlowChart_ArrowShapes_ModernArrow);
  FFlexibleArrow := AddPredefinedShape('FlexibleArrow',
    @sdxFlowChart_ArrowShapes_FlexibleArrow);
  FBentArrow := AddPredefinedShape('BentArrow',
    @sdxFlowChart_ArrowShapes_BentArrow);
  FUTurnArrow := AddPredefinedShape('UTurnArrow',
    @sdxFlowChart_ArrowShapes_UTurnArrow);
  FSharpBentArrow := AddPredefinedShape('SharpBentArrow',
    @sdxFlowChart_ArrowShapes_SharpBentArrow);
  FCurvedRightArrow := AddPredefinedShape('CurvedRightArrow',
    @sdxFlowChart_ArrowShapes_CurvedRightArrow);
  FCurvedLeftArrow := AddPredefinedShape('CurvedLeftArrow',
    @sdxFlowChart_ArrowShapes_CurvedLeftArrow);
  FNotchedArrow := AddPredefinedShape('NotchedArrow',
    @sdxFlowChart_ArrowShapes_NotchedArrow);
  FStripedArrow := AddPredefinedShape('StripedArrow',
    @sdxFlowChart_ArrowShapes_StripedArrow);
  FBlockArrow := AddPredefinedShape('BlockArrow',
    @sdxFlowChart_ArrowShapes_BlockArrow);
  FCircularArrow := AddPredefinedShape('CircularArrow',
    @sdxFlowChart_ArrowShapes_CircularArrow);
  FQuadArrow := AddPredefinedShape('QuadArrow',
    @sdxFlowChart_ArrowShapes_QuadArrow);
  FLeftRightUpArrow := AddPredefinedShape('LeftRightUpArrow',
    @sdxFlowChart_ArrowShapes_LeftRightUpArrow);
  FLeftRightArrowBlock := AddPredefinedShape('LeftRightArrowBlock',
    @sdxFlowChart_ArrowShapes_LeftRightArrowBlock);
  FQuadArrowBlock := AddPredefinedShape('QuadArrowBlock',
...
begin
  FLightningBolt := AddPredefinedShape('LightningBolt',
...
begin
  ...
  FVariableStart := AddPredefinedShape('VariableStart',
    @sdxFlowChart_SDLDiagramShapes_VariableStart);
  FProcedure := AddPredefinedShape('Procedure',
    @sdxFlowChart_SDLDiagramShapes_Procedure);
  FVariableProcedure := AddPredefinedShape('VariableProcedure',
    @sdxFlowChart_SDLDiagramShapes_VariableProcedure);
  FCreateRequest := AddPredefinedShape('CreateRequest',
    @sdxFlowChart_SDLDiagramShapes_CreateRequest);
  FAlternative := AddPredefinedShape('Alternative',
    @sdxFlowChart_SDLDiagramShapes_Alternative);
  FReturn := AddPredefinedShape('Return',
    @sdxFlowChart_SDLDiagramShapes_Return);
  FDecision1 := AddPredefinedShape('Decision1',
    @sdxFlowChart_SDLDiagramShapes_Decision1);
  FMessageFromUser := AddPredefinedShape('MessageFromUser',
    @sdxFlowChart_SDLDiagramShapes_MessageFromUser);
  FPrimitiveFromCallControl := AddPredefinedShape('PrimitiveFromCallControl',
    @sdxFlowChart_SDLDiagramShapes_PrimitiveFromCallControl);
  FDecision2 := AddPredefinedShape('Decision2',
    @sdxFlowChart_SDLDiagramShapes_Decision2);
  FMessageToUser := AddPredefinedShape('MessageToUser',
    @sdxFlowChart_SDLDiagramShapes_MessageToUser);
  FPrimitiveToCallControl := AddPredefinedShape('PrimitiveToCallControl',
  ...
  FDiskStorage := AddPredefinedShape('DiskStorage',
    @sdxFlowChart_SDLDiagramShapes_DiskStorage);
  FDividedProcess := AddPredefinedShape('DividedProcess',
    @sdxFlowChart_SDLDiagramShapes_DividedProcess);
  FDividedEvent := AddPredefinedShape('DividedEvent',
    @sdxFlowChart_SDLDiagramShapes_DividedEvent);
  FTerminator := AddPredefinedShape('Terminator',
...
begin
  ...
  FProperties := AddPredefinedShape('Properties',
    @sdxFlowChart_SoftwareIcons_Properties);
  FCalendar := AddPredefinedShape('Calendar',
    @sdxFlowChart_SoftwareIcons_Calendar);
  FDocument := AddPredefinedShape('Document',
    @sdxFlowChart_SoftwareIcons_Document);
  FDatabase := AddPredefinedShape('Database',
    @sdxFlowChart_SoftwareIcons_Database);
  FHardDrive := AddPredefinedShape('HardDrive',
    @sdxFlowChart_SoftwareIcons_HardDrive);
  FNetwork := AddPredefinedShape('Network',
...
begin
  ...
  FShapes := TDictionary<string, TdxFlowChartObjectAdvancedShape>.Create
...
function TdxFlowChartAdvancedShapeRepository.FindShapeByID(const AID: string)
  : TdxFlowChartObjectAdvancedShape;
begin
...
function TdxFlowChartAdvancedShapeRepository.FindStencilByID(const AID: string)
  : TdxFlowChartAdvancedShapeStencil;
var
  I: Integer;
begin
...
procedure TdxFlowChartAdvancedShapeRepository.AddStencil
...
begin
  FArrowShapes := TdxFlowChartArrowShapes.Create(Self, 'ArrowShapes',
    @sdxFlowChart_ArrowShapesCaption);
  FBasicFlowchartShapes := TdxFlowChartBasicFlowchartShapes.Create(Self,
    'BasicFlowchartShapes', @sdxFlowChart_BasicFlowchartShapesCaption);
  FBasicShapes := TdxFlowChartBasicShapes.Create(Self, 'BasicShapes',
    @sdxFlowChart_BasicShapesCaption);
  FDecorativeShapes := TdxFlowChartDecorativeShapes.Create(Self,
    'DecorativeShapes', @sdxFlowChart_DecorativeShapesCaption);
  FSDLDiagramShapes := TdxFlowChartSDLDiagramShapes.Create(Self,
    'SDLDiagramShapes', @sdxFlowChart_SDLDiagramShapesCaption);
  FSoftwareIcons := TdxFlowChartSoftwareIcons.Create(Self, 'SoftwareIcons',
    @sdxFlowChart_SoftwareIconsCaption);
end;

procedure TdxFlowChartAdvancedShapeRepository.RemoveUserShapeByID
  (const AID: string);
var
  AShape: TdxFlowChartObjectAdvancedShape;
begin
  ...
  begin
    if not(AShape is TFlowChartObjectUserAdvancedShape) then
      raise EdxException.CreateFmt
        ('Can''t remove a predefined shape with ID="%s" not found!', [AID]);
    FShapes.Remove(AID);
    AShape.Stencil.RemoveShape(AShape);
  end
  else
    raise EdxException.CreateFmt
      ('Shape description with ID="%s" not found!', [AID]);
end;

function TdxFlowChartAdvancedShapeRepository.GetStencil(Index: Integer)
  : TdxFlowChartAdvancedShapeStencil;
begin
...
procedure TdxFlowChartAdvancedShapeRepository.LoadShapesFromFile
  (const AFileName, AStencilID: string; const AStencilCaption: string = '');
var
  AStream: TStream;
begin
...
procedure TdxFlowChartAdvancedShapeRepository.LoadShapesFromStream
  (const AStream: TStream; const AStencilID: string;
const AStencilCaption: string = '');
var
  ALoader: TdxTemplateLoader;
  AStencil: TdxFlowChartAdvancedShapeStencil;
begin
  ...
  if AStencil = nil then
    AStencil := TdxFlowChartAdvancedShapeStencil.Create(AStencilID,
      AStencilCaption);
  ALoader := TdxTemplateLoader.Create;
  try
    ALoader.LoadFromStream(AStream, procedure(ATemplate: TdxShapeXmlDescription)
      begin
...
constructor TdxShapeElementViewData.Create(APath: TdxGPPath;
...
function TdxShapeElementViewData.GetStrokeColor
...
constructor TdxShapeDescription.Create(const AID: string;
const ADefaultSize: TSize; AUseBackgroundAsForeground: Boolean);
begin
  inherited Create;
...
procedure TdxShapeDescription.PaintDefaultShape(AGraphics: TdxGPCanvas;
