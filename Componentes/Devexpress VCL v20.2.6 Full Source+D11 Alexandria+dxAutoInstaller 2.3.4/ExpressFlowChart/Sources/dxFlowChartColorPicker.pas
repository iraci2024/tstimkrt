...
type
  ...
  private
    ...
    procedure ColorItemClick(Sender: TdxRibbonGalleryItem;
      AItem: TdxRibbonGalleryGroupItem);
    procedure ColorMapItemClick(Sender: TdxRibbonGalleryItem;
      AItem: TdxRibbonGalleryGroupItem);
  ...
  protected
    function AddColorItem(AGalleryGroup: TdxRibbonGalleryGroup; AColor: TColor)
      : TdxRibbonGalleryGroupItem;
    function CreateColorBitmap(AColor: TColor; AGlyphSize: Integer = 0)
      : TcxAlphaBitmap;
    procedure CreateColorRow(AGalleryGroup: TdxRibbonGalleryGroup;
  ...
  public
    constructor Create(APopupMenu: TdxBarCustomPopupMenu;
      AColorItem, AColorMapItem: TdxRibbonGalleryItem); virtual;
...
const
  ColorMaps: array [0 .. 5] of TColorMapInfo = ((Name: 'Default';
    Map: (clWindow, clWindowText, $D2B48C, $00008B, $0000FF, $FF0000, $556B2F,
    $800080, clAqua, $FFA500)), (Name: 'Theme1';
    Map: (clWindow, clWindowText, $7D491F, $E1ECEE, $BD814F, $4D50C0, $59BB9B,
    $A26480, $C6AC4B, $4696F7)), (Name: 'Theme2';
    Map: (clWindow, clWindowText, $6D6769, $D1C2C9, $66B9CE, $84B09C, $C9B16B,
    $CF8565, $C96B7E, $BB79A3)), (Name: 'Theme3';
    Map: (clWindow, clWindowText, $323232, $D1DEE3, $097FF0, $36299F, $7C581B,
    $42854E, $784860, $5998C1)), (Name: 'Theme4';
    Map: (clWindow, clWindowText, $866B64, $D7D1C5, $4963D1, $00B4CC, $AEAD8C,
    $707B8C, $8CB08F, $4990D1)), (Name: 'Theme5';
    Map: (clWindow, clWindowText, $464646, $FAF5DE, $BFA22D, $281FDA, $1B64EB,
    $9D6339, $784B47, $4A3C7D)));
  StandardColorMap: TdxFlowChartColorPickerColorMap = ($0000C0, $0000FF,
    $00C0FF, $00FFFF, $50D092, $50B000, $F0B000, $C07000, $602000, $A03070);
...
constructor TdxFlowChartColorPickerController.Create
...
function TdxFlowChartColorPickerController.AddColorItem(AGalleryGroup
  : TdxRibbonGalleryGroup; AColor: TColor): TdxRibbonGalleryGroupItem;
var
...
function TdxFlowChartColorPickerController.CreateColorBitmap(AColor: TColor;
...
procedure TdxFlowChartColorPickerController.CreateColorRow
...
const
  ...
  procedure GetAccentColorScheme(AColorMap: TdxFlowChartColorPickerColorMap;
    var AnAccentColorScheme: array of TdxFlowChartColorPickerColorMap);
  ...
  begin
    for I := Low(AColorMap) to High(AColorMap) do
      ...
      else if GetBrightness(ColorToRGB(AColorMap[I])) < 230 then
...
var
  I: Integer;
  AColorMap: TdxFlowChartColorPickerColorMap;
  AnAccentColorScheme: array [0 .. AnAccentCount - 1]
    of TdxFlowChartColorPickerColorMap;
begin
...
begin
  ...
  try
    ...
    ABitmap := TcxAlphaBitmap.CreateSize(FColorGlyphSize * AThemeColorCount +
      (AThemeColorCount - 1) * AGlyphOffset, FColorGlyphSize);
    try
      for I := High(ColorMaps) downto Low(ColorMaps) do
      begin
        AGroupItem := FColorMapItem.GalleryGroups[0].Items.Insert(0);
        for J := Low(ColorMaps[I].Map) + ASystemColorCount to High
          (ColorMaps[I].Map) do
        begin
          AColorBitmap := CreateColorBitmap(ColorMaps[I].Map[J]);
          try
            ARect := cxRectOffset(AColorBitmap.ClientRect,
              (AColorBitmap.Width + AGlyphOffset) * (J - ASystemColorCount), 0);
...
procedure TdxFlowChartColorPickerController.ColorMapChanged;
  ...
  begin
    ...
    FillRectByColor(ADC, ARect, ColorMaps[FColorMapItem.SelectedGroupItem.
      Index].Map[2]);
    FillRectByColor(ADC, cxRectOffset(ARect, cxRectWidth(ARect), 0),
      ColorMaps[FColorMapItem.SelectedGroupItem.Index].Map[3]);
    FillRectByColor(ADC, cxRectOffset(ARect, 0, cxRectHeight(ARect)),
      ColorMaps[FColorMapItem.SelectedGroupItem.Index].Map[4]);
    FillRectByColor(ADC, cxRectOffset(ARect, cxRectWidth(ARect),
      cxRectHeight(ARect)), ColorMaps[FColorMapItem.SelectedGroupItem.
      Index].Map[5]);
...
procedure TdxFlowChartColorPickerController.ColorItemClick
...
procedure TdxFlowChartColorPickerController.ColorMapItemClick
  (Sender: TdxRibbonGalleryItem; AItem: TdxRibbonGalleryGroupItem);
begin
...
begin
  ...
  begin
    ...
    AddColorItem(FCustomColorsGroup, dxAlphaColorToColor(FColorDialog.Color))
      .Selected := True;
  end;
end;
