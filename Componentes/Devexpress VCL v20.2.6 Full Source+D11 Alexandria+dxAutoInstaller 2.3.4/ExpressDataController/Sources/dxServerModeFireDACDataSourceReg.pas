...
function TdxServerModeSchemaNameProperty.GetDataSource
  : TdxServerModeCustomDataSource;
begin
  Result := (GetComponent(0) as TdxServerModeFireDACDataSourceOptions).Owner;
end;

function TdxServerModeSchemaNameProperty.GetDataSourceHelper
...
function TdxServerModeCatalogNameProperty.GetDataSource
  : TdxServerModeCustomDataSource;
begin
  Result := (GetComponent(0) as TdxServerModeFireDACDataSourceOptions).Owner;
end;

function TdxServerModeCatalogNameProperty.GetDataSourceHelper
  : TdxServerModeFireDACDataSourceHelper;
begin
  with TdxServerModeCustomDataSourceAccess(GetDataSource) do
    Result := Helper as TdxServerModeFireDACDataSourceHelper;
...
{$IFNDEF NONDB}
  RegisterComponents(dxCoreLibraryProductPage, [TdxServerModeFireDACDataSource,
    TdxServerModeFireDACQueryDataSource]);
  RegisterPropertyEditor(TypeInfo(string),
    TdxServerModeFireDACDataSourceOptions, 'SchemaName',
    TdxServerModeSchemaNameProperty);
  RegisterPropertyEditor(TypeInfo(string),
    TdxServerModeFireDACDataSourceOptions, 'CatalogName',
    TdxServerModeCatalogNameProperty);
{$ENDIF}
end;
