...
function TcxIBXProviderDetailFilterAdapter.GetParamValues
  (ASQLParams: TIBXSQLDA): Variant;
var
  I: Integer;
begin
...
procedure TcxIBXProviderDetailFilterAdapter.SetParamValues
  (ASQLParams: TIBXSQLDA; const AValues: Variant);
var
  I: Integer;
begin
  if ASQLParams.Count = 1 then
...
cxDetailFilterControllers.RegisterAdapter(TIBDataSet,
  TcxIBXProviderDetailFilterAdapter);
cxFilterOperatorAdapters.RegisterAdapter(TIBDataSet,
  TcxIBXFilterOperatorAdapter);

finalization

cxDetailFilterControllers.UnregisterAdapter(TIBDataSet,
  TcxIBXProviderDetailFilterAdapter);
cxFilterOperatorAdapters.UnregisterAdapter(TIBDataSet,
  TcxIBXFilterOperatorAdapter);
