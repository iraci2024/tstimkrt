...
{$ENDIF}
  ...
  MultiMon, ShellApi, StdCtrls, ExtCtrls,
  cxLookAndFeelPainters, cxClasses, cxDWMAPI, dxCore, dxCoreClasses,
  dxCoreGraphics, dxMessages, cxGraphics, cxControls, cxGeometry,
  cxContainer, dxSkinsLookAndFeelPainter, dxSkinsCore, cxScrollBar,
  cxLookAndFeels, dxSkinInfo, dxForms,
...
type
  ...
  public
    ...
    class procedure PostCheckRegion(AHandle: HWND;
      AForceCheck: Boolean = False);
    ...
    property LookAndFeelPainter: TdxSkinLookAndFeelPainter
  ...
  public
    function GetControllerByControl(AControl: TWinControl)
      : TdxSkinWinController;
  ...
  protected
    ...
    procedure ShowSystemMenu(const P: TPoint; const AExcludeRect: TRect;
      ABottomAlign: Boolean = False); overload;
  ...
  public
    ...
    property ScrollBarsController: TdxSkinFormScrollBarsController
      read FScrollBarsController;
  ...
  public
    constructor Create(AType: TdxSkinFormIcon;
      AOwner: TdxSkinFormIconInfoList); virtual;
    ...
    property NonClientAreaInfo: TdxSkinFormNonClientAreaInfo
      read GetNonClientAreaInfo;
  ...
  public
    ...
    function Find(AIcon: TdxSkinFormIcon;
      out AInfo: TdxSkinFormIconInfo): Boolean;
    function HitTest(const P: TPoint): TdxSkinFormIconInfo; overload;
    function HitTest(const P: TPoint; out AInfo: TdxSkinFormIconInfo)
      : Boolean; overload;
  ...
  protected
    ...
    FVisible: Boolean;
  public
    constructor Create(AOwner: TdxSkinFormScrollBarViewInfo;
      AKind: TcxScrollBarPart); virtual;
  ...
  protected
    ...
    function GetPartViewInfo(APart: TcxScrollBarPart)
      : TdxSkinFormScrollBarPartViewInfo;
    function GetScaleFactor: TdxScaleFactor;
  public
    constructor Create(AKind: TScrollBarKind;
      AController: TdxSkinFormScrollBarsController);
    destructor Destroy; override;
    ...
    function HitTest(const P: TPoint;
      out APart: TdxSkinFormScrollBarPartViewInfo): Boolean;
    //
    property Bounds: TRect read FBounds;
    property Controller: TdxSkinFormScrollBarsController read FController;
    property Info: TScrollBarInfo read FInfo;
    property Kind: TScrollBarKind read FKind;
    property PartViewInfo[APart: TcxScrollBarPart]
      : TdxSkinFormScrollBarPartViewInfo read GetPartViewInfo;
  ...
  strict private
    ...
    function GetScrollBarViewInfo(AKind: TScrollBarKind)
      : TdxSkinFormScrollBarViewInfo;
  ...
  protected
    ...
    //
    property HotPart: TdxSkinFormScrollBarPartViewInfo read FHotPart
      write SetHotPart;
    property IsTracking: Boolean read FIsTracking;
    property PressedPart: TdxSkinFormScrollBarPartViewInfo read FPressedPart
      write SetPressedPart;
    ...
    property TrackingScrollBarKind: TScrollBarKind
      read GetTrackingScrollBarKind;
  public
    constructor Create(AController: TdxSkinCustomFormController); virtual;
    destructor Destroy; override;
    function HitTest(const P: TPoint)
      : TdxSkinFormScrollBarPartViewInfo; overload;
    function HitTest(const P: TPoint;
      out AScrollBarPart: TdxSkinFormScrollBarPartViewInfo): Boolean; overload;
    ...
    property ScrollBarViewInfo[AKind: TScrollBarKind]
      : TdxSkinFormScrollBarViewInfo read GetScrollBarViewInfo;
  ...
  const
    ...
    DefaultShadowOffsets: TRect = (Left: 4; Top: 4; Right: 4; Bottom: 4);
  private
  ...
  protected
    ...
    function CalculateCaptionButtonSize(const ACaptionRect: TRect;
      AElement: TdxSkinElement): TSize; virtual;
    ...
    function GetBorderRect(ASide: TcxBorder;
      const ABounds, AWidths: TRect): TRect;
    function GetExtendedNavigationControlCaptionWidth: Integer;
  ...
  public
    ...
    property CaptionTextShadowColor: TColor read FCaptionTextShadowColor
      write FCaptionTextShadowColor;
    ...
    property ThemeActiveAssigned: Boolean read FThemeActiveAssigned
      write FThemeActiveAssigned;
  ...
  strict private
    ...
    procedure DrawBorderElement(DC: HDC; const R: TRect; ASide: TcxBorder);
  ...
  protected
    ...
    procedure DrawWindowCaption(DC: HDC; const R: TRect;
      AElement: TdxSkinElement); virtual;
    procedure DrawWindowCaptionBackground(DC: HDC; const R: TRect;
      AElement: TdxSkinElement); virtual;
    ...
    procedure DrawWindowIcon(DC: HDC; const R: TRect; AIcon: TdxSkinFormIcon;
      AElement: TdxSkinElement; AElementState: TdxSkinElementState);
      overload; virtual;
  ...
  public
    ...
    property IconElements[AIcon: TdxSkinFormIcon]: TdxSkinElement
      read GetIconElement;
  ...
  public
    property ShowFormShadow: TdxDefaultBoolean read FShowFormShadow
      write SetShowFormShadow default bDefault;
  end;
  ...
  protected
    ...
    function GetFocusRect: TRect; override;
    procedure DrawCheckMark(ACanvas: TcxCanvas; const R: TRect);
      virtual; abstract;
  ...
  TdxSkinPopupSysMenuEvent = procedure(Sender: TObject; AForm: TCustomForm;
    ASysMenu: HMENU) of object;

  TdxSkinGetControllerClassForWindowProc = function(AWnd: HWND)
    : TdxSkinWinControllerClass;
  ...
  protected
    ...
    procedure DoSkinControl(AControl: TWinControl;
      var AUseSkin: Boolean); virtual;
    procedure DoSkinForm(AForm: TCustomForm; var ASkinName: string;
      var AUseSkin: Boolean); virtual;
  ...
  public
    ...
    class function GetFormSkin(AForm: TCustomForm;
      var ASkinName: string): Boolean;
    class function GetPainterData(var AData): Boolean;
  published
    property Kind;
    property NativeStyle;
    property SkinName;
    property SkinPaletteName: string read GetSkinPaletteName
      write SetSkinPaletteName stored IsSkinPaletteNameStored;
    property ShowFormShadow: TdxDefaultBoolean read GetShowFormShadow
      write SetShowFormShadow default bDefault;
    property UseImageSet: TdxSkinImageSet read GetUseImageSet
      write SetUseImageSet default imsDefault;
    property UseSkins: Boolean read GetUseSkins write SetUseSkins default True;
    //
    property OnPopupSysMenu: TdxSkinPopupSysMenuEvent read FOnPopupSysMenu
      write FOnPopupSysMenu;
    property OnSkinControl: TdxSkinControlEvent read FOnSkinControl
      write FOnSkinControl;
  ...
  public
    ...
    function GetSkinPainter(const AName: string;
      out APainter: TdxSkinLookAndFeelPainter): Boolean;
    //
...
var
  ...
  dxSkinFormShadowClass: TdxShadowWindowClass = TdxShadowWindow;
  // for internal use
  dxSkinGetControllerClassForWindowProc: TdxSkinGetControllerClassForWindowProc;

function dxSkinGetControllerClassForWindow(AWnd: HWND)
  : TdxSkinWinControllerClass;

implementation

uses
  FlatSB, Math, dxUxTheme, dxHooks, cxDrawTextUtils, dxDPIAwareUtils,
  dxSkinsStrs, dxGdiPlusClasses, dxGdiPlusApi;
...
const
  ...
  // HitTests
  CornerHitTests: array [TdxCorner] of DWORD = (HTTOPLEFT, HTTOPRIGHT,
    HTBOTTOMLEFT, HTBOTTOMRIGHT);
  ResizeHitTests: array [TcxBorder] of DWORD = (HTLEFT, HTTOP, HTRIGHT,
    HTBOTTOM);

const
  CaptionFlags = DT_VCENTER or DT_SINGLELINE or DT_EDITCONTROL or
    DT_END_ELLIPSIS or DT_NOPREFIX;
  RTLDependentCaptionFlags: array [Boolean] of Integer = (CaptionFlags,
    CaptionFlags or DT_RIGHT or DT_RTLREADING);
  FrameStates: array [Boolean] of TdxSkinElementState = (esActiveDisabled,
    esActive);
...
begin
  ...
  APaintBuffer := BeginBufferedPaint(DC, @R, BPBF_COMPOSITED, @ABParams,
    ACachedDC);
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          R := dxMapWindowRect(TWinControl(AChildControl).Handle,
            AControl.Handle, R);
        end
        else
...
begin
  Result := dxDefaultBooleanToBoolean(dxSkinShowFormShadow,
    ViewInfo.AreBordersThin) and (WinControl <> nil) and
    (WinControl.Parent = nil);
end;
...
function TdxSkinFormController.FindLookAndFeelPainter
...
function TdxSkinFormMDIClientController.FindMasterController
  : TdxSkinWinController;
begin
...
begin
  Result := Assigned(AForm) and
    (SendMessage(AForm.Handle, DXM_SKINS_GETISSKINNED, 0, 0) = 0);
end;
...
begin
  ...
  if TdxSkinWinController.IsMDIClientWindow(AHandle) then
    Result := GetWindowLong(GetParent(AHandle), GWL_EXSTYLE) and
      WS_EX_LAYERED <> 0;
end;

{ TdxSkinFormNonClientAreaInfo }

constructor TdxSkinFormNonClientAreaInfo.Create(AController
  : TdxSkinCustomFormController);
begin
  inherited Create;
  ...
  UpdateFormCaption;
  FActive := True;
  if not Supports(FController.WinControl, IdxFluentDesignForm, FFluentDesignForm)
  then
...
begin
  FIsAcrylicEnabled := (FFluentDesignForm <> nil) and
    FFluentDesignForm.IsAcrylic or (FAcrylicForm <> nil) and
    FAcrylicForm.IsAcrylic;
...
procedure TdxSkinFormNonClientAreaInfo.CombineRectWithRegion(ADest: HRGN;
  const R: TRect);
var
  ARgn: HRGN;
begin
...
function TdxSkinFormNonClientAreaInfo.GetHitTest(AHitPoint: TPoint;
  AHitTest: Integer = 0): Integer;
var
  ASide: TcxBorder;
...
function TdxSkinFormNonClientAreaInfo.ScreenToClient
...
function TdxSkinFormNonClientAreaInfo.AreBordersThin: Boolean;
begin
  Result := cxMarginsWidth(BorderWidths) <= 2 * dxShadowWindowThinBorderSize;
end;
...
begin
  ...
  begin
    ...
    if RightToLeftLayout then
      FBorderBounds[ASide] := TdxRightToLeftLayoutConverter.ConvertRect
        (FBorderBounds[ASide], WindowBounds);
  end;
end;
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        FBorderWidths.Right := Min(FBorderWidths.Right,
          SystemBorderWidths.Right);
        FBorderWidths.Bottom := Min(FBorderWidths.Bottom,
          SystemBorderWidths.Bottom);
      end;
    end;
...
begin
  if IsIconic then
    ...
    Result := TdxSkinElementHelper.CalculateCaptionButtonSize
      (cxRectHeight(ACaptionRect), AElement);
end;
...
begin
  ...
  else if IsNativeBorderWidth(False) then
    Result := SystemBorderWidths.Top - WindowBounds.Top
  else
  begin
    Result := cxMarginsHeight
      (ScaleFactor.Apply(CaptionElement.ContentOffset.Rect)) +
      CalculateCaptionContentHeight;
    if IsZoomed then
...
function TdxSkinFormNonClientAreaInfo.CalculateMenuIconSize
  (AToolWindow: Boolean): TSize;
var
  ASysIconSize: Integer;
begin
  if AToolWindow then
    ASysIconSize := dxGetSystemMetrics(SM_CYSMCAPTION, ScaleFactor) - 2 *
      dxGetSystemMetrics(SM_CYEDGE, ScaleFactor)
  else
...
procedure TdxSkinFormNonClientAreaInfo.CalculateCaptionIconsInfo;
  ...
  function CalculateCaptionIconBounds(AIcon: TdxSkinFormIcon;
    var R: TRect): TRect;
  begin
    Result := R;
    if AIcon = sfiMenu then
  ...
  var
    AFluentDesignFormCaptionWidth: Integer;
  begin
    if HasCaption then
    begin
      Result := R;
      AFluentDesignFormCaptionWidth := GetExtendedNavigationControlCaptionWidth;
      if (FFluentDesignForm <> nil) and (AFluentDesignFormCaptionWidth > 0) and
        not FFluentDesignForm.IsNavigationControlCollapsed then
        Result.Right := Min(AFluentDesignFormCaptionWidth, Result.Right);
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        if AIcon = sfiMenu then
          AInfo.FHitBounds.Left := Min(AInfo.HitBounds.Left,
            SystemSizeFrame.cx);
        if AIcon = sfiClose then
          AInfo.FHitBounds.Right := Max(AInfo.FHitBounds.Right,
            WindowBounds.Right - SystemSizeFrame.cx);
      end;
      if RightToLeftLayout then
      begin
        AInfo.HitBounds := TdxRightToLeftLayoutConverter.ConvertRect
          (AInfo.HitBounds, AParentRect);
        AInfo.Bounds := TdxRightToLeftLayoutConverter.ConvertRect(AInfo.Bounds,
          AParentRect);
      end;
    end;
  end;
...
begin
  R := GetCaptionBounds;
  if (FFluentDesignForm <> nil) and FFluentDesignForm.IsNavigationControlCollapsed
  then
    Inc(R.Left, GetExtendedNavigationControlCaptionWidth);
...
var
  AIsFluentDesignCaptionBackground: Boolean;
  ATextColor: TColor;
begin
  if ToolWindow then
  ...
  begin
    ...
    begin
      FCaptionFont.Size := FCaptionFont.Size +
        (PainterInfo.FormCaptionFontDelta - 1);
      if (PainterInfo.FormCaptionFontIsBold <> nil) and
        PainterInfo.FormCaptionFontIsBold.Value then
        FCaptionFont.Style := FCaptionFont.Style + [fsBold];
    end;
  end;
  FCaptionFont.Height := ScaleFactor.Apply(FCaptionFont.Height,
    dxSystemScaleFactor);

  AIsFluentDesignCaptionBackground := (FFluentDesignForm <> nil) and
    not FFluentDesignForm.IsNavigationControlCollapsed and
    (GetExtendedNavigationControlCaptionWidth > 0);

  if AIsFluentDesignCaptionBackground then
  begin
    ATextColor := FFluentDesignForm.GetNavigationControlForegroundColor;
    FCaptionTextColor[True] := ATextColor;
    FCaptionTextColor[False] := ATextColor;
...
begin
  if HasClientEdge then
    FClientEdgeSize := Size(GetSystemMetrics(SM_CXEDGE),
...
begin
  ...
  if IsNativeBorderWidth and not IsIconic then
    InflateRect(FWindowBounds, Min(0, SizeFrame.cx - SystemSizeFrame.cx),
      Min(0, SizeFrame.cy - SystemSizeFrame.cy));
  UpdateSysMenuIcon;
  FMenuBarHeight := CalculateMenuBarHeight;
end;

function TdxSkinFormNonClientAreaInfo.GetBorderRect(ASide: TcxBorder;
  const ABounds, AWidths: TRect): TRect;
begin
  Result := ABounds;
  case ASide of
...
function TdxSkinFormNonClientAreaInfo.
  GetExtendedNavigationControlCaptionWidth: Integer;
begin
  if (FFluentDesignForm <> nil) and (PainterInfo <> nil) and
    ...
    Result := FFluentDesignForm.GetExtendedNavigationControlCaptionWidth
  else
    Result := 0;
end;
...
const
  MaximizeMenuIcons: array [Boolean] of TdxSkinFormIcon = (sfiMaximize,
    sfiRestore);
  MinimizeMenuIcons: array [Boolean] of TdxSkinFormIcon = (sfiMinimize,
    sfiRestore);
  SysMenuIcons: array [Boolean] of TdxSkinFormIcons = ([sfiMenu, sfiClose],
    [sfiClose]);
begin
  Result := [];
  if HasCaption then
...
function TdxSkinFormNonClientAreaInfo.GetIsMenuCommandEnabled
  (AMenuCommandId: Integer): Boolean;
var
  AMenu: HMENU;
...
function TdxSkinFormNonClientAreaInfo.IsNativeBorderWidth
  (ACheckZoomed: Boolean = True): Boolean;
begin
  Result := IsZoomed and (ACheckZoomed or FIsMDIChild) or FHasMenu or
    FIsMDIClient or not ThemeActive or IsIconic;
end;
...
begin
  ...
  begin
    ...
    cxModifySystemMenu(ASysMenu, Handle, IsDialog, ABorderIcons,
      WindowState, False);
  end;
end;
...
begin
  ...
  FSysMenuIcon := dxGetFormIcon(Handle, dxGetSystemMetrics(SM_CXSMICON,
    ScaleFactor), dxGetSystemMetrics(SM_CYSMICON, ScaleFactor));
...
function TdxSkinFormNonClientAreaInfo.GetCaptionIconSize
  (AIcon: TdxSkinFormIcon): TSize;
begin
  if AIcon = sfiMenu then
...
begin
  Result := ScrollBarsController.ScrollBarViewInfo[sbHorizontal].Visible or
...
begin
  Result := HasBorder and not(IsNativeBorderWidth(False) or IsZoomed and
    TdxSkinCustomFormController.IsMDIChildWindow(Handle));
end;
...
begin
  Result := GetMonitorWorkArea(MonitorFromWindow(Handle,
    MONITOR_DEFAULTTONEAREST));
end;

function TdxSkinFormNonClientAreaInfo.GetScrollBarsController
  : TdxSkinFormScrollBarsController;
begin
...
begin
  ...
  if ACorner in [coTopLeft, coBottomLeft] then
    Result.Right := Result.Left + Max(ScaleFactor.Apply(HitTestAreaMinSize),
      SizeFrame.cx)
  else
    Result.Left := Result.Right - Max(ScaleFactor.Apply(HitTestAreaMinSize),
      SizeFrame.cx);

  if ACorner in [coTopLeft, coTopRight] then
    Result.Bottom := Result.Top + BorderWidths.Top
  else
    Result.Top := Result.Bottom - Max(ScaleFactor.Apply(HitTestAreaMinSize),
      SizeFrame.cy);
end;

function TdxSkinFormNonClientAreaInfo.GetSkinBorderWidth
  (ASide: TcxBorder): Integer;
var
  AElement: TdxSkinElement;
begin
  Result := 0;
...
begin
  ...
  if not(HasCaption and Suppressed) or (ACaptionHeight <= 0) then
    ...
    Result := Max(1,
      cxMarginsHeight(ScaleFactor.Apply(CaptionElement.ContentOffset.Rect))) /
      ACaptionHeight;
end;

function TdxSkinFormNonClientAreaInfo.GetSystemBorderWidths: TRect;
begin
  Result := cxRect(SystemSizeFrame.cx, SystemSizeFrame.cy, SystemSizeFrame.cx,
    SystemSizeFrame.cy);
  if HasCaption then
    Inc(Result.Top, GetSystemMetrics(IfThen(ToolWindow, SM_CYSMCAPTION,
      SM_CYCAPTION)));
end;
...
begin
  ...
  if HasBorder then
  begin
    Result := cxSize(GetSystemMetrics(SM_CXSIZEFRAME),
...
begin
  Result := (AHandle <> 0) and AnsiSameText(cxGetClassName(AHandle),
    'MDICLIENT');
end;
...
begin
  ...
  Result := SameText(AWindowClass, 'TMessageForm') or
    SameText(AWindowClass, 'TForm');
end;
...
begin
  ...
  begin
    AController := SkinnedControlsControllers.GetControllerByControl
      (FindControl(AHandle));
    if AController <> nil then
...
class procedure TdxSkinWinController.PostCheckRegion(AHandle: HWND;
  AForceCheck: Boolean = False);
begin
...
begin
  ...
  begin
    ...
    if AParentForm <> nil then
      Result := SkinnedControlsControllers.GetControllerByHandle
        (AParentForm.Handle);
  end;
end;
...
function TdxSkinWinControllerList.GetControllerByControl(AControl: TWinControl)
  : TdxSkinWinController;
var
  I: Integer;
begin
...
function TdxSkinWinControllerList.GetControllerByHandle(AHandle: HWND)
  : TdxSkinWinController;
var
  I: Integer;
begin
...
function TdxSkinControllersList.CanSkinForm(AForm: TCustomForm)
  : TdxSkinLookAndFeelPainter;
var
  AController: TdxSkinController;
  ASkinName: string;
...
function TdxSkinControllersList.GetSkinPainter(const AName: string;
  out APainter: TdxSkinLookAndFeelPainter): Boolean;
var
  ATempPainter: TcxCustomLookAndFeelPainter;
begin
  Result := cxLookAndFeelPaintersManager.GetPainter(AName, ATempPainter) and
    (ATempPainter is TdxSkinLookAndFeelPainter);
  if Result then
...
procedure TdxSkinSkinnedControlsControllers.NotifyMasterDestroying
  (AMaster: TdxSkinWinController);
var
  I: Integer;
begin
  for I := 0 to Count - 1 do
...
procedure TdxSkinSkinnedControlsControllers.Refresh
  (AMaster: TdxSkinWinController);
var
...
procedure TdxSkinCustomFormController.DoPopupSystemMenu(AForm: TCustomForm;
  ASysMenu: HMENU);
var
  I: Integer;
begin
...
procedure TdxSkinCustomFormController.CheckWindowRgn(AForceUpdate
  : Boolean = False);
var
...
begin
  ...
  begin
    ...
    begin
      AScreenRegion := CreateRectRgnIndirect(cxRectOffset(ViewInfo.ScreenRect,
        ViewInfo.WindowRect.TopLeft, False));
...
function TdxSkinCustomFormController.HandleInternalMessages
...
function TdxSkinCustomFormController.HandleWindowMessage
  (var AMessage: TMessage): Boolean;
begin
  Result := True;
  if ForceRedraw then
  ...
  case AMessage.Msg of
    ...
    WM_MOUSEMOVE:
      begin
        ...
        if Result then
          ScrollBarsController.MouseMove
            (ViewInfo.GetRTLDependentClientCursorPos);
      end;
...
function TdxSkinCustomFormController.RefreshOnMouseEvent(AForceRefresh
...
begin
  ...
  else if ScrollBarsController.HotPart <> nil then
  begin
...
procedure TdxSkinCustomFormController.ShowSystemMenu(const P: TPoint;
  const AExcludeRect: TRect; ABottomAlign: Boolean);
const
...
begin
  ...
  ACommand := LongWord(TrackPopupMenuEx(GetSystemMenu(Handle, False),
    TPM_RETURNCMD or TPM_LEFTALIGN or AlignMap[ABottomAlign], P.X, P.Y, Handle,
    @AParams));
...
begin
  ...
  ShowSystemMenu(Point(R.Left, R.Bottom), Rect(Screen.DesktopRect.Left, R.Top,
    Screen.DesktopRect.Right, R.Bottom), ViewInfo.IsIconic);
end;
...
function TdxSkinCustomFormController.WMContextMenu
  (var Message: TWMContextMenu): Boolean;
var
  APoint: TPoint;
begin
  APoint := SmallPointToPoint(Message.Pos);
  Result := (APoint.X <> -1) and (APoint.Y <> -1) and
    (ViewInfo.GetHitTest(APoint) in [HTCAPTION, HTSYSMENU]);
  if Result then
  begin
...
begin
  ...
  begin
    AStyles := dxSetWindowStyle(Handle, WS_VISIBLE, soSubtract);
    Message.Result := DefWindowProc(Handle, WM_NCACTIVATE,
...
procedure TdxSkinCustomFormController.WMNCButtonDown
  (var Message: TWMNCHitMessage);
var
  AForm: TCustomForm;
  ALink: TcxObjectLink;
begin
  ...
  try
    ...
    begin
      if (IconsInfo.IconPressed = nil) or
        (IconsInfo.IconPressed.IconType = sfiMenu) then
        DefWndProc(Message);
    end;
...
procedure TdxSkinCustomFormController.WMNCMouseMove
  (var Message: TWMNCHitMessage);
begin
...
begin
  ...
  if ViewInfo.NeedCheckNonClientSize then
    Message.CalcSize_Params^.rgrc[0] :=
      cxRectContent(R, ViewInfo.CalculateMargins);
end;

function TdxSkinCustomFormController.WMNCHitTest(var Message
  : TWMNCHitTest): Boolean;
begin
  Message.Result := ViewInfo.GetHitTest(SmallPointToPoint(Message.Pos),
    Message.Result);
...
procedure TdxSkinCustomFormController.WMWindowPosChanged
...
begin
  ...
  ANeedRecalculateNC := AIsMoving and IsZoomed(Handle) and
...
function TdxSkinCustomFormController.CreateViewInfo
  : TdxSkinFormNonClientAreaInfo;
begin
...
begin
  case AMessage.Msg of
    ...
    if not UseSkin then
      DefWndProc(AMessage)
    else if not HandleWindowMessage(AMessage) then
    begin
...
constructor TdxSkinFormIconInfo.Create(AType: TdxSkinFormIcon;
  AOwner: TdxSkinFormIconInfoList);
begin
  inherited Create;
  FOwner := AOwner;
  FIconType := AType;
...
begin
  if (Owner.IconHot = Self) and Enabled then
    Result := PressedStateMap[(Owner.IconPressed = Self) and
      NonClientAreaInfo.ButtonPressed]
  else if NonClientAreaInfo.Active then
    Result := esNormal
  else
...
const
  CommandMap: array [TdxSkinFormIcon] of Integer = (SC_DEFAULT, SC_CONTEXTHELP,
...
const
  HitTestMap: array [TdxSkinFormIcon] of Integer = (HTSYSMENU, HTHELP,
    HTMINBUTTON, HTMAXBUTTON, HTMAXBUTTON, HTCLOSE);
begin
...
constructor TdxSkinFormIconInfoList.Create(ANonClientInfo
  : TdxSkinFormNonClientAreaInfo);
begin
  inherited Create;
...
function TdxSkinFormIconInfoList.Add(AIcon: TdxSkinFormIcon)
  : TdxSkinFormIconInfo;
begin
...
function TdxSkinFormIconInfoList.Find(AIcon: TdxSkinFormIcon;
  out AInfo: TdxSkinFormIconInfo): Boolean;
var
  I: Integer;
begin
...
function TdxSkinFormIconInfoList.HitTest(const P: TPoint;
  out AInfo: TdxSkinFormIconInfo): Boolean;
begin
  AInfo := HitTest(P);
...
procedure TdxSkinFormIconInfoList.MouseUp(const P: TPoint;
  out AIcon: TdxSkinFormIconInfo);
begin
...
begin
  ...
  begin
    Painter.BeginPaint(DC);
    try
      cxDrawTransparentControlBackground(WinControl, cxPaintCanvas,
        ViewInfo.ClientBounds, False);
    finally
      Painter.EndPaint;
    end;
  end;
...
procedure TdxSkinFrameController.WMWindowPosChanged
...
constructor TdxSkinFormScrollBarsController.Create
  (AController: TdxSkinCustomFormController);
var
...
begin
  ...
  for AKind := Low(TScrollBarKind) to High(TScrollBarKind) do
    FScrollBarViewInfo[AKind] := TdxSkinFormScrollBarViewInfo.Create
      (AKind, Self);
end;
...
begin
  if ScrollBarViewInfo[sbHorizontal].Visible then
    ViewInfo.CombineRectWithRegion(ARegion,
      ScrollBarViewInfo[sbHorizontal].Bounds);
  if ScrollBarViewInfo[sbVertical].Visible then
    ViewInfo.CombineRectWithRegion(ARegion,
      ScrollBarViewInfo[sbVertical].Bounds);
...
procedure TdxSkinFormScrollBarsController.CalculateScrollArea;
  ...
  const
    ScrollBarOBJIDs: array [TScrollBarKind] of DWORD = (OBJID_HSCROLL,
      OBJID_VSCROLL);
  var
  ...
  begin
    ...
    begin
      ...
      try
        SetScrollPos(Controller.Handle, Integer(AKind),
          AScrollInfo.nTrackPos, False);
        cxGetScrollBarInfo(Controller.Handle, Integer(ScrollBarOBJIDs[AKind]
          ), Result);
        SetScrollPos(Controller.Handle, Integer(AKind),
          AScrollInfo.nPos, False);
      finally
  ...
  procedure CalculateScrollBarBounds(const AClientBounds: TRect;
    AKind: TScrollBarKind);
  begin
    ScrollBarViewInfo[AKind].FInfo := DoGetScrollBarInfo(AKind);
    ScrollBarViewInfo[AKind].FVisible := IsScrollBarVisible(AKind);
    ScrollBarViewInfo[AKind].FBounds :=
      GetScrollBarBounds(AClientBounds, AKind);
  end;
...
begin
  ...
  if SizeGripVisible then
  begin
    ScrollBarViewInfo[sbHorizontal].FBounds.Right := ScrollBarViewInfo
      [sbVertical].Bounds.Left;
    ScrollBarViewInfo[sbVertical].FBounds.Bottom := ScrollBarViewInfo
      [sbHorizontal].Bounds.Top;
    FSizeGripBounds := cxRect(R.Right, R.Bottom,
      ScrollBarViewInfo[sbVertical].Bounds.Right,
      ScrollBarViewInfo[sbHorizontal].Bounds.Bottom);
  end;
...
begin
  Result := (PressedPart <> nil) and
    not PtInRect(PressedPart.Owner.PartViewInfo[sbpThumbnail].Bounds,
    ViewInfo.GetRTLDependentClientCursorPos);
end;
...
function TdxSkinFormScrollBarsController.HitTest(const P: TPoint)
  : TdxSkinFormScrollBarPartViewInfo;
begin
...
function TdxSkinFormScrollBarsController.HitTest(const P: TPoint;
  out AScrollBarPart: TdxSkinFormScrollBarPartViewInfo): Boolean;
var
...
begin
  ...
  begin
    ...
    if PtInRect(PressedPart.Bounds, ViewInfo.GetRTLDependentClientCursorPos)
    then
      Click;
  end;
end;
...
begin
  if PressedPart <> nil then
    SendMessage(Controller.Handle, MessageMap[PressedPart.Owner.Kind],
      AParam, 0);
end;
...
procedure TdxSkinFormScrollBarsController.TrackingBegin(const P: TPoint);
  ...
  begin
    if TrackingScrollBarKind = sbVertical then
      Result := cxRectHeight(PressedPart.Owner.PartViewInfo[sbpPageUp].Bounds) +
        cxRectHeight(PressedPart.Owner.PartViewInfo[sbpPageDown].Bounds)
    else
      Result := cxRectWidth(PressedPart.Owner.PartViewInfo[sbpPageUp].Bounds) +
...
begin
  ...
  GetScrollInfo(Controller.Handle, Integer(TrackingScrollBarKind),
    FTrackingAreaInfo);
...
procedure TdxSkinFormScrollBarsController.TrackingSetThumbPosition
  (APosition: Integer);
const
  ScrollBarsMap: array [TScrollBarKind] of Integer = (SB_HORZ, SB_VERT);
begin
  SetScrollPos(Controller.Handle, ScrollBarsMap[TrackingScrollBarKind],
    APosition, False);
end;

function TdxSkinFormScrollBarsController.GetHasScrollBars: Boolean;
begin
  Result := ScrollBarViewInfo[sbHorizontal].Visible or ScrollBarViewInfo
    [sbVertical].Visible;
end;
...
begin
  Result := ScrollBarViewInfo[sbHorizontal].Visible and
    ScrollBarViewInfo[sbVertical].Visible;
end;

function TdxSkinFormScrollBarsController.GetTrackingScrollBarKind
  : TScrollBarKind;
begin
  if IsTracking then
...
function TdxSkinFormScrollBarsController.GetViewInfo
  : TdxSkinFormNonClientAreaInfo;
begin
  Result := Controller.ViewInfo;
end;

procedure TdxSkinFormScrollBarsController.SetHotPart
  (AValue: TdxSkinFormScrollBarPartViewInfo);
begin
...
procedure TdxSkinFormScrollBarsController.SetPressedPart
  (AValue: TdxSkinFormScrollBarPartViewInfo);
begin
...
procedure dxSkinsWndProcHook(ACode: Integer; WPARAM: WPARAM; LParam: LParam;
...
var
  ...
  SetScrollPos: function(HWND: HWND; nBar, nPos: Integer; bRedraw: BOOL)
    : Integer stdcall;

function dxSkinsFormSetScrollPos(HWND: HWND; nBar, nPos: Integer; bRedraw: BOOL)
  : Integer; stdcall;
begin
  Result := SetScrollPos(HWND, nBar, nPos, bRedraw and
    not TdxSkinWinController.IsSkinActive(HWND));
end;

function dxSkinsFormSetScrollInfo(HWND: HWND; BarFlag: Integer;
  const ScrollInfo: TScrollInfo; Redraw: BOOL): Integer; stdcall;
begin
  Result := SetScrollInfo(HWND, BarFlag, ScrollInfo,
    Redraw and not TdxSkinWinController.IsSkinActive(HWND));
end;
...
procedure TdxSkinFormScrollBarPartViewInfo.Calculate(APos1, APos2: Integer;
  AState: Integer);
  ...
  begin
    if IsPartPressed then
      Result := cxbsPressed
    else if AState and STATE_SYSTEM_UNAVAILABLE <> 0 then
      Result := cxbsDisabled
    else if (AState and STATE_SYSTEM_HOTTRACKED <> 0) or
      (Self = Owner.Controller.HotPart) then
      Result := cxbsHot
    else
      Result := cxbsNormal;
  end;
...
constructor TdxSkinFormScrollBarViewInfo.Create(AKind: TScrollBarKind;
  AController: TdxSkinFormScrollBarsController);
var
...
procedure TdxSkinFormScrollBarViewInfo.CalculatePart(APos1, APos2: Integer;
  APart: TcxScrollBarPart);
const
  PartToStateIndex: array [TcxScrollBarPart] of Integer = (0, 1, 5, 3, 2, 4);
begin
  PartViewInfo[APart].Calculate(APos1, APos2,
    Info.rgState[PartToStateIndex[APart]]);
end;
...
begin
  ...
  begin
    ...
    CalculatePart(R.Left + Info.xyThumbTop, R.Left + Info.xyThumbBottom,
      sbpThumbnail);
    CalculatePart(R.Left + Info.dxyLineButton, R.Left + Info.xyThumbTop,
      sbpPageUp);
    CalculatePart(R.Left + Info.xyThumbBottom, R.Right - Info.dxyLineButton,
      sbpPageDown);
  end;
end;

function TdxSkinFormScrollBarViewInfo.HitTest(const P: TPoint;
  out APart: TdxSkinFormScrollBarPartViewInfo): Boolean;
var
...
begin
  ...
  begin
    ...
    begin
      Result := PartViewInfo[APartItem].Visible and
        PtInRect(PartViewInfo[APartItem].Bounds, P);
      if Result then
      begin
...
function TdxSkinFormScrollBarViewInfo.GetPartViewInfo(APart: TcxScrollBarPart)
  : TdxSkinFormScrollBarPartViewInfo;
begin
  Result := FParts[APart];
end;
...
class function TdxSkinController.GetFormSkin(AForm: TCustomForm;
  var ASkinName: string): Boolean;
var
  AController: TdxSkinWinController;
begin
...
begin
  Result := (RootLookAndFeel.SkinPainter <> nil) and
    RootLookAndFeel.SkinPainter.GetPainterData(AData);
end;
...
procedure TdxSkinController.DoPopupSystemMenu(AForm: TCustomForm;
  ASysMenu: HMENU);
begin
...
procedure TdxSkinController.DoSkinControl(AControl: TWinControl;
  var AUseSkin: Boolean);
begin
  if Assigned(OnSkinControl) then
    OnSkinControl(Self, AControl, AUseSkin);
end;

procedure TdxSkinController.DoSkinForm(AForm: TCustomForm;
  var ASkinName: string; var AUseSkin: Boolean);
begin
...
procedure TdxSkinController.MasterLookAndFeelChanged(Sender: TcxLookAndFeel;
...
begin
  if ViewInfo.HasMenu and not ViewInfo.IsIconic then
    FillRect(cxPaintCanvas.Handle, ViewInfo.MenuSeparatorBounds,
...
procedure TdxSkinFormPainter.DrawBackground(DC: HDC; const R: TRect);
  ...
  begin
    Result := IntersectClipRect(DC, R.Left, R.Top, R.Right, R.Bottom) <>
      NULLREGION;
  end;
...
procedure TdxSkinFormPainter.DrawCaptionText(DC: HDC; R: TRect;
  const AText: string);
begin
  if ViewInfo.HasAcrylicBackground then
    dxDrawTextOnGlass(DC, AText, nil, R, clDefault,
      RTLDependentCaptionFlags[ViewInfo.RightToLeftLayout], 0, True)
  else
    cxDrawText(DC, AText, R, RTLDependentCaptionFlags
      [ViewInfo.RightToLeftLayout]);
end;
...
procedure TdxSkinFormPainter.DrawScrollBar(AScrollBar
  : TdxSkinFormScrollBarViewInfo);
var
  AMemBitmap: HBITMAP;
  AMemDC: HDC;
...
begin
  ...
  begin
    ...
    try
      AMemBitmap := CreateCompatibleBitmap(cxPaintCanvas.Handle, cxRectWidth(R),
        cxRectHeight(R));
      ...
      try
        DrawBackground(cxPaintCanvas.Handle, R);
        Painter.DrawScaledScrollBarBackground(cxPaintCanvas, R,
          AScrollBar.Kind = sbHorizontal, AScrollBar.ScaleFactor);
        for APart := Low(TcxScrollBarPart) to High(TcxScrollBarPart) do
        begin
          if AScrollBar.PartViewInfo[APart].Visible then
            Painter.DrawScaledScrollBarPart(cxPaintCanvas,
              AScrollBar.Kind = sbHorizontal, AScrollBar.PartViewInfo[APart]
              .Bounds, APart, AScrollBar.PartViewInfo[APart].State,
...
var
  R1: TRect;
  AExtendedCaptionRect: TRect;
  AExtendedCaptionWidth: Integer;
  ASaveIndex: Integer;
begin
  R1 := R;
  if ViewInfo.IsIconic then
  ...
  AExtendedCaptionWidth := ViewInfo.GetExtendedNavigationControlCaptionWidth;
  if AExtendedCaptionWidth > 0 then
  begin
    ASaveIndex := SaveDC(DC);
    try
      AExtendedCaptionRect := R1;
      AExtendedCaptionRect.Left := ViewInfo.ClientBounds.Left;
      AExtendedCaptionRect.Top := ViewInfo.ScaleFactor.Apply
        (PainterInfo.FormFrames[True, bTop].Borders.Top.Thin);
      AExtendedCaptionRect.Right := AExtendedCaptionRect.Left +
        AExtendedCaptionWidth;
      if ViewInfo.RightToLeftLayout then
        AExtendedCaptionRect := TdxRightToLeftLayoutConverter.ConvertRect
          (AExtendedCaptionRect, R1);
      dxGPPaintCanvas.BeginPaint(DC, AExtendedCaptionRect);
      dxGPPaintCanvas.FillRectangle(AExtendedCaptionRect,
        ViewInfo.FFluentDesignForm.GetNavigationControlBackgroundColor);
      dxGPPaintCanvas.EndPaint;
      ExcludeClipRect(DC, AExtendedCaptionRect.Left, AExtendedCaptionRect.Top,
        AExtendedCaptionRect.Right, AExtendedCaptionRect.Bottom);
      FBordersCache[bTop].RightToLeftDependentDraw(DC,
        dxSkinCheckSkinElement(AElement), R1, dxDefaultScaleFactor,
        ViewInfo.RightToLeftLayout, FrameStates[ViewInfo.Active]);
    finally
...
begin
  ...
  begin
    ...
    begin
      APrevColor := SetTextColor(DC,
        ColorToRGB(ViewInfo.CaptionTextShadowColor));
      if ViewInfo.HasAcrylicBackground then
        dxDrawTextOnGlass(DC, ViewInfo.Caption, nil, R, clDefault,
          RTLDependentCaptionFlags[ViewInfo.RightToLeftLayout], 0, True)
      else
        cxDrawText(DC, ViewInfo.Caption, R,
          RTLDependentCaptionFlags[ViewInfo.RightToLeftLayout]);
...
procedure TdxSkinFormPainter.DrawWindowIcon(DC: HDC;
  AIconInfo: TdxSkinFormIconInfo);
begin
...
begin
  if ((AIcon = sfiMenu) and (ViewInfo.SysMenuIcon = 0)) or
    ((AIcon <> sfiMenu) and (AElement = nil)) then
    Exit;

  if RectVisible(DC, R) then
    if AElement <> nil then
      FIconsCache[AIcon].DrawEx(DC, AElement, R, ViewInfo.ScaleFactor,
        AElementState)
    else if ViewInfo.HasAcrylicBackground and not ViewInfo.IsSysMenuIconAlphaUsed
    then
    begin
...
begin
  if ViewInfo.HasAcrylicBackground then
  begin
    DrawAcrylicNCPart(DC, R, procedure(ACachedDC: HDC; const ARect: TRect)
      begin
        if not AFillBackground then
          DrawBorderElement(ACachedDC, ARect, ASide)
        else
        begin
          FormContent.Draw(ACachedDC, ARect, 0, FrameStates[Active]);
          DrawBorderElement(ACachedDC, GetBorderRect(ARect, ASide), ASide);
        end;
      end);
  end
  else
  begin
    ...
    try
      ...
      begin
        ...
        DrawBorderElement(ACachedDC, GetBorderRect(R1, ASide), ASide);
        BitBlt(DC, R.Left, R.Top, R1.Right, R1.Bottom, ACachedDC, 0, 0,
          SRCCOPY);
        AMemBmp := SelectObject(ACachedDC, AMemBmp);
...
begin
  if ViewInfo.HasAcrylicBackground then
  begin
    DrawAcrylicNCPart(cxPaintCanvas.Handle, R,
      procedure(ACachedDC: HDC; const ARect: TRect)
      begin
        DrawWindowCaption(ACachedDC, ARect, AElement);
      end);
  end
  else
  begin
    APrevLayoutMode := SetLayout(cxPaintCanvas.Handle, LAYOUT_LTR);
    try
      ACachedDC := CreateCompatibleDC(cxPaintCanvas.Handle);
      AMemBmp := CreateCompatibleBitmap(cxPaintCanvas.Handle, R.Right,
        R.Bottom);
      AMemBmp := SelectObject(ACachedDC, AMemBmp);
      DrawWindowCaption(ACachedDC, R, AElement);
      BitBlt(cxPaintCanvas.Handle, 0, 0, R.Right, R.Bottom, ACachedDC, 0,
        0, SRCCOPY);
      AMemBmp := SelectObject(ACachedDC, AMemBmp);
      DeleteObject(AMemBmp);
      DeleteDC(ACachedDC);
    finally
      SetLayout(cxPaintCanvas.Handle, APrevLayoutMode);
    end;
  end;
end;
...
var
  ...
  R: TRect;
begin
  InternalDrawBorder(cxPaintCanvas.Handle, ViewInfo.BorderBounds[bBottom],
    bBottom, True);
  for ASide := Low(TcxBorder) to High(TcxBorder) do
    if ASide in [bLeft, bRight] then
    begin
      ...
      begin
        R.Top := ViewInfo.BorderBounds[bTop].Bottom;
        R.Bottom := ViewInfo.WindowBounds.Bottom -
          ViewInfo.SkinBorderWidth[bBottom];
...
procedure TdxSkinFormPainter.DrawBorderElement(DC: HDC; const R: TRect;
ASide: TcxBorder);
begin
  FBordersCache[ASide].RightToLeftDependentDraw(DC,
    PainterInfo.FormFrames[not ViewInfo.ToolWindow, ASide], R,
    dxDefaultScaleFactor, ViewInfo.RightToLeftLayout, FrameStates[Active]);
end;
...
function TdxSkinFormPainter.GetBorderRect(const R: TRect;
...
begin
  if Painter <> nil then
    Result := cxGetActualColor(FormContent.TextColor,
      Painter.DefaultContentTextColor)
  else
    Result := clWindowText;
end;

function TdxSkinFormPainter.GetIconElement(AIcon: TdxSkinFormIcon)
  : TdxSkinElement;
begin
...
constructor TdxSkinCustomControlViewInfo.Create(AController
  : TdxSkinWinController);
begin
  FController := AController;
end;
...
function TdxSkinCustomControlViewInfo.GetLookAndFeelPainter
...
begin
  ...
  if ANeedReleaseDC then
    DC := GetDCEx(Handle, 0, DCX_CACHE or DCX_CLIPSIBLINGS or DCX_WINDOW or
      DCX_VALIDATE);
  try
    if DoubleBuffered then
    begin
      AMemDC := CreateCompatibleDC(DC);
      AMemBmp := CreateCompatibleBitmap(DC, ViewInfo.ClientWidth,
...
function TdxSkinCustomControlController.CreateViewInfo
  : TdxSkinCustomControlViewInfo;
begin
...
function TdxSkinCustomControlController.WMEraseBk(var AMessage
  : TWMEraseBkgnd): Boolean;
begin
  AMessage.Result := 1;
  Result := True;
end;

function TdxSkinCustomControlController.WMPaint(var AMessage: TWMPaint)
  : Boolean;
var
  ADC: HDC;
...
begin
  Result := SendMessage(Controller.Handle, BM_GETSTATE, 0, 0) and
    BST_PUSHED <> 0;
end;
...
begin
  inherited WndProc(AMessage);
  case AMessage.Msg of
    WM_ENABLE, BM_SETSTATE, WM_MOUSELEAVE, WM_MOUSEMOVE, CM_MOUSELEAVE,
      WM_MOUSEHOVER:
      ViewInfo.UpdateButtonState;
    WM_UPDATEUISTATE:
...
begin
  ...
  begin
    LookAndFeelPainter.DrawScaledCommandLinkBackground(ACanvas, ClientRect,
      State, ScaleFactor);
    LookAndFeelPainter.DrawScaledCommandLinkGlyph(ACanvas,
      GetCommandLinkGlyphPos, State, ScaleFactor);
  end
  else if IsSplitButton then
  begin
    LookAndFeelPainter.DrawScaledButton(ACanvas, GetDropDownLeftPartBounds,
      State, ScaleFactor, cxbpDropDownLeftPart);
    LookAndFeelPainter.DrawScaledButton(ACanvas, GetDropDownRightPartBounds,
      State, ScaleFactor, cxbpDropDownRightPart);
  end
  else
    LookAndFeelPainter.DrawScaledButton(ACanvas, ClientRect, State,
      ScaleFactor);
end;
...
procedure TdxSkinCustomCheckButtonViewInfo.Calculate(out ATextRect,
  ACheckMarkRect: TRect);
const
  TextOffset = 4;
var
...
begin
  ...
  ACheckMarkPosition.Y := cxRectCenterVertically(ClientRect,
    ACheckMarkSize.cy).Top;
  if AIsLeftText then
    ACheckMarkPosition.X := ClientRect.Right - ACheckMarkSize.cx
  else
    ACheckMarkPosition.X := ClientRect.Left;
  ACheckMarkRect := cxRectBounds(ACheckMarkPosition, ACheckMarkSize.cx,
    ACheckMarkSize.cy);
...
begin
  ...
  R := Result;
  cxTextOut(cxScreenCanvas.Handle, Caption, R, IfThen(WordWrap, CXTO_WORDBREAK)
    or CXTO_CALCRECT, Font);
...
procedure TdxSkinCustomCheckButtonViewInfo.DrawText(ACanvas: TcxCanvas;
const R: TRect);
const
  TextAlignFlagsMap: array [Boolean] of Integer = (cxSingleLine, cxWordBreak);
begin
  ACanvas.Font := Font;
  ACanvas.Font.Color := LookAndFeelPainter.DefaultEditorTextColor
    (not IsEnabled);
  ACanvas.DrawText(Caption, R, cxAlignVCenter or cxShowPrefix or
    TextAlignFlagsMap[WordWrap], True);
end;
...
procedure TdxSkinCheckBoxViewInfo.DrawCheckMark(ACanvas: TcxCanvas;
const R: TRect);
begin
  LookAndFeelPainter.DrawScaledCheckButton(ACanvas, R, State, CheckMarkState,
    ScaleFactor);
end;
...
function TdxSkinRadioButtonController.CreateViewInfo
  : TdxSkinCustomControlViewInfo;
begin
...
procedure TdxSkinRadioButtonViewInfo.DrawCheckMark(ACanvas: TcxCanvas;
const R: TRect);
begin
  LookAndFeelPainter.DrawScaledRadioButton(ACanvas, R.Left, R.Top, State,
    CheckMarkState = cbsChecked, IsFocused, clNone, ScaleFactor);
end;
...
begin
  ...
  else if APanel.Color = clBtnFace then
    LookAndFeelPainter.DrawPanelContent(ACanvas, ClientRect)
  else
    LookAndFeelPainter.DrawPanelBackground(ACanvas, APanel, ClientRect,
      APanel.Color);
...
const
  ...
  AlignVert: array [TVerticalAlignment] of Longint = (DT_TOP, DT_BOTTOM,
    DT_VCENTER);
var
  APanel: TCustomPanelAccess;
  R: TRect;
begin
  ...
  begin
    R := cxRectInflate(cxRectContent(ClientRect,
      LookAndFeelPainter.PanelBorderSize), -1);
    ACanvas.Brush.Style := bsClear;
    ACanvas.Font := Font;
    if (APanel.Font.Color = clWindowText) and
      (LookAndFeelPainter.PanelTextColor <> clDefault) then
      ACanvas.Font.Color := LookAndFeelPainter.PanelTextColor;
    cxDrawText(ACanvas.Handle, APanel.Caption, R,
      APanel.DrawTextBiDiModeFlags(DT_EXPANDTABS or DT_SINGLELINE or
      AlignHorz[APanel.Alignment] or AlignVert[APanel.VerticalAlignment]));
...
function TdxSkinPanelController.WMPrintClient(var AMessage
  : TWMPrintClient): Boolean;
begin
