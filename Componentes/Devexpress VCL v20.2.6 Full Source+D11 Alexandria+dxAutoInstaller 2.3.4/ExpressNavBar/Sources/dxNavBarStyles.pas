...
uses
  Windows, Classes, Graphics, dxCoreClasses, cxClasses, dxNavBarBase,
  cxGeometry;
...
type
  ...
  TdxBarStyleAssignedValue = (savAlphaBlending, savAlphaBlending2, savBackColor,
    savBackColor2, savFont, savGradientMode, savHAlignment, savVAlignment,
    savImage);
  TdxBarStyleAssignedValues = set of TdxBarStyleAssignedValue;
  TdxBarStyleGradientMode = (gmHorizontal, gmVertical, gmForwardDiagonal,
    gmBackwardDiagonal);
  ...
  public
    ...
    property AssignedValues: TdxBarStyleAssignedValues read FAssignedValues
      write SetAssignedValues default [];
    property OnChange: TdxNavBarChangeEvent read FOnChange write FOnChange;
    // for internal use
  published
    property AlphaBlending: Byte read FAlphaBlending write SetAlphaBlending
      stored IsAlphaBlendingStored;
    property AlphaBlending2: Byte read FAlphaBlending2 write SetAlphaBlending2
      stored IsAlphaBlending2Stored;
    ...
    property GradientMode: TdxBarStyleGradientMode read FGradientMode
      write SetGradientMode stored IsGradientModeStored;
    property Font: TFont read FFont write SetFont;
    property Image: TPicture read FImage write SetImage;
    property HAlignment: TdxBarStyleHAlignment read FHAlignment
      write SetHAlignment stored IsHAlignmentStored;
    property VAlignment: TdxBarStyleVAlignment read FVAlignment
      write SetVAlignment stored IsVAlignmentStored;
  end;
  ...
  strict private
    ...
    procedure SetDefaultStyle(Index: Integer;
      const Value: TdxNavBarDefaultStyle);
  ...
  public
    ...
    property DefaultStyles[Index: Integer]: TdxNavBarDefaultStyle
      read GetDefaultStyle;
    property OnChange: TdxNavBarChangeEvent read FOnChange write FOnChange;
    // for internal use
  published
    property Background: TdxNavBarDefaultStyle index 0 read GetDefaultStyle
      write SetDefaultStyle stored IsDefaultStyleStored;
    property Button: TdxNavBarDefaultStyle index 1 read GetDefaultStyle
      write SetDefaultStyle stored IsDefaultStyleStored;
    property ButtonPressed: TdxNavBarDefaultStyle index 2 read GetDefaultStyle
      write SetDefaultStyle stored IsDefaultStyleStored;
    property ButtonHotTracked: TdxNavBarDefaultStyle index 3
      read GetDefaultStyle write SetDefaultStyle stored IsDefaultStyleStored;
    property GroupBackground: TdxNavBarDefaultStyle index 4 read GetDefaultStyle
      write SetDefaultStyle stored IsDefaultStyleStored;
    property GroupControl: TdxNavBarDefaultStyle index 5 read GetDefaultStyle
      write SetDefaultStyle stored IsDefaultStyleStored;
    property GroupHeader: TdxNavBarDefaultStyle index 6 read GetDefaultStyle
      write SetDefaultStyle stored IsDefaultStyleStored;
    property GroupHeaderActive: TdxNavBarDefaultStyle index 7
      read GetDefaultStyle write SetDefaultStyle stored IsDefaultStyleStored;
    property GroupHeaderActiveHotTracked: TdxNavBarDefaultStyle index 8
      read GetDefaultStyle write SetDefaultStyle stored IsDefaultStyleStored;
    property GroupHeaderActivePressed: TdxNavBarDefaultStyle index 9
      read GetDefaultStyle write SetDefaultStyle stored IsDefaultStyleStored;
    property GroupHeaderHotTracked: TdxNavBarDefaultStyle index 10
      read GetDefaultStyle write SetDefaultStyle stored IsDefaultStyleStored;
    property GroupHeaderPressed: TdxNavBarDefaultStyle index 11
      read GetDefaultStyle write SetDefaultStyle stored IsDefaultStyleStored;
    property Hint: TdxNavBarDefaultStyle index 12 read GetDefaultStyle
      write SetDefaultStyle stored IsDefaultStyleStored;
    property Item: TdxNavBarDefaultStyle index 13 read GetDefaultStyle
      write SetDefaultStyle stored IsDefaultStyleStored;
    property ItemDisabled: TdxNavBarDefaultStyle index 14 read GetDefaultStyle
      write SetDefaultStyle stored IsDefaultStyleStored;
    property ItemHotTracked: TdxNavBarDefaultStyle index 15 read GetDefaultStyle
      write SetDefaultStyle stored IsDefaultStyleStored;
    property ItemPressed: TdxNavBarDefaultStyle index 16 read GetDefaultStyle
      write SetDefaultStyle stored IsDefaultStyleStored;
    property DropTargetGroup: TdxNavBarDefaultStyle index 17
      read GetDefaultStyle write SetDefaultStyle stored IsDefaultStyleStored;
    property DropTargetLink: TdxNavBarDefaultStyle index 18 read GetDefaultStyle
      write SetDefaultStyle stored IsDefaultStyleStored;
    property NavigationPaneHeader: TdxNavBarDefaultStyle index 19
      read GetDefaultStyle write SetDefaultStyle stored IsDefaultStyleStored;
    property ChildGroupCaption: TdxNavBarDefaultStyle index 20
      read GetDefaultStyle write SetDefaultStyle stored IsDefaultStyleStored;
    property ChildGroupCaptionHotTracked: TdxNavBarDefaultStyle index 21
      read GetDefaultStyle write SetDefaultStyle stored IsDefaultStyleStored;
    property ChildGroupCaptionPressed: TdxNavBarDefaultStyle index 22
      read GetDefaultStyle write SetDefaultStyle stored IsDefaultStyleStored;
  end;
  ...
  public
    ...
    property Items[Index: Integer]: TdxNavBarStyleItem read GetItem
  ...
  public
    ...
    destructor Destroy; override;
    procedure Assign(Source: TPersistent); override;
    property Styles[Index: Integer]: TdxNavBarStyleItem read GetStyle
      write SetStyle;
    property OnChange: TdxNavBarChangeEvent read FOnChange write FOnChange;
    // for internal use
  end;
  ...
  published
    property Background: TdxNavBarStyleItem index 0 read GetStyle
      write SetStyle;
    property Hint: TdxNavBarStyleItem index 1 read GetStyle write SetStyle;
    property DropTargetGroup: TdxNavBarStyleItem index 2 read GetStyle
      write SetStyle;
    property DropTargetLink: TdxNavBarStyleItem index 3 read GetStyle
      write SetStyle;
    property Button: TdxNavBarStyleItem index 4 read GetStyle write SetStyle;
    property ButtonHotTracked: TdxNavBarStyleItem index 5 read GetStyle
      write SetStyle;
    property ButtonPressed: TdxNavBarStyleItem index 6 read GetStyle
      write SetStyle;
    property NavigationPaneHeader: TdxNavBarStyleItem index 7 read GetStyle
      write SetStyle;
  end;
  ...
  published
    ...
    property HeaderActive: TdxNavBarStyleItem index 3 read GetStyle
      write SetStyle;
    property HeaderActiveHotTracked: TdxNavBarStyleItem index 4 read GetStyle
      write SetStyle;
    property HeaderActivePressed: TdxNavBarStyleItem index 5 read GetStyle
      write SetStyle;
    property HeaderHotTracked: TdxNavBarStyleItem index 6 read GetStyle
      write SetStyle;
    property HeaderPressed: TdxNavBarStyleItem index 7 read GetStyle
      write SetStyle;
    property ChildCaption: TdxNavBarStyleItem index 8 read GetStyle
      write SetStyle;
    property ChildCaptionHotTracked: TdxNavBarStyleItem index 9 read GetStyle
      write SetStyle;
    property ChildCaptionPressed: TdxNavBarStyleItem index 10 read GetStyle
      write SetStyle;
  end;
  ...
  published
    ...
    property ItemDisabled: TdxNavBarStyleItem index 1 read GetStyle
      write SetStyle;
    property ItemHotTracked: TdxNavBarStyleItem index 2 read GetStyle
      write SetStyle;
    property ItemPressed: TdxNavBarStyleItem index 3 read GetStyle
      write SetStyle;
  end;
  ...
  public
    ...
    // for internal use
  published
    property DefaultStyles: TdxNavBarDefaultStyles read FDefaultStyles
      write SetDefaultStyles;
    property CustomStyles: TdxNavBarCustomStyles read FCustomStyles
      write SetCustomStyles;
    property CustomStyleRepository: TdxNavBarStyleRepository
      read FCustomStyleRepository write SetCustomStyleRepository;
  end;
...
begin
  ...
  begin
    ...
    dxAssignFont(FFont, TdxNavBarBaseStyle(Source).Font, ScaleFactor,
      TdxNavBarBaseStyle(Source).ScaleFactor);
...
procedure TdxNavBarBaseStyle.SetAssignedValues(const Value
  : TdxBarStyleAssignedValues);
begin
...
procedure TdxNavBarBaseStyle.SetGradientMode(const Value
...
begin
  Result := inherited CanScaleFont or (Collection <> nil) and
    not Collection.IsDesigning;
end;
...
procedure TdxNavBarDefaultStyles.OnStyleChange(Sender: TObject;
...
function TdxNavBarDefaultStyles.GetDefaultStyle(Index: Integer)
  : TdxNavBarDefaultStyle;
begin
...
procedure TdxNavBarDefaultStyles.SetDefaultStyle(Index: Integer;
  const Value: TdxNavBarDefaultStyle);
begin
...
function TdxNavBarStyleItem.GetCollectionFromParent(AParent: TComponent)
  : TcxComponentCollection;
begin
  Result := (AParent as TdxCustomNavBar).Styles;
end;

procedure TdxNavBarStyleItem.OnStyleChange(Sender: TObject;
  AType: TdxNavBarChangeType);
begin
...
procedure TdxNavBarStyleRepository.SetItemName
  (AItem: TcxComponentCollectionItem; ABaseIndex: Integer = -1);
begin
  if TdxCustomNavBarAccess(ParentComponent).FDesignHelper <> nil then
    AItem.Name := TdxCustomNavBarAccess(ParentComponent)
      .FDesignHelper.UniqueName(ParentComponent,
...
procedure TdxNavBarStyleRepository.SetItem(Index: Integer;
  Value: TdxNavBarStyleItem);
begin
...
procedure TdxNavBarBaseCustomStyles.SetStyle(Index: Integer;
...
procedure TdxNavBarBaseCustomStyles.InternalStyleChange(Sender: TObject;
  const AEventArgs);
begin
  DoChange;
end;
...
begin
  inherited;
  FCustomStyleRepository := TdxNavBarStyleRepository.Create
    (AOwner as TComponent, TdxNavBarStyleItem);
...
procedure TdxNavBarStyleOptions.StyleChanged(Sender: TObject;
  AType: TdxNavBarChangeType);
begin
  CallNotify(OnChange, Self);
end;

procedure TdxNavBarStyleOptions.SetCustomStyleRepository
  (Value: TdxNavBarStyleRepository);
begin
