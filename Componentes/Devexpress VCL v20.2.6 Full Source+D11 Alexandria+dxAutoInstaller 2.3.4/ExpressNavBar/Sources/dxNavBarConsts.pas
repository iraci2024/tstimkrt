...
const
  ...
  dxNavBarDefaultView =
  {$IFDEF USENATIVELOOKANDFEELASDEFAULT}dxNavBarOffice12NavigatorPaneView{$ELSE}dxNavBarBaseView{$ENDIF};
...
resourcestring
  ...
  sdxInvalideGroupControl =
    'Invalid the TdxNavBarGroupControl parent or group.';
  sdxInvalidLink =
    'You cannot create a link to the ''%s'' item within the ''%s'' group because they belong to different NavBar controls';
...
begin
  InternalAdd('sdxNavigationPaneOverflowPanelCustomizeHint',
    @sdxNavigationPaneOverflowPanelCustomizeHint);
  InternalAdd('sdxNavigationPaneMinimizeNavPaneSignHint',
    @sdxNavigationPaneMinimizeNavPaneSignHint);
  InternalAdd('sdxNavigationPaneExpandNavPaneSignHint',
    @sdxNavigationPaneExpandNavPaneSignHint);
  InternalAdd('sdxNavigationPaneCollapseBarHint',
    @sdxNavigationPaneCollapseBarHint);
  ...
  InternalAdd('sdxNavBarOffice11ShowMoreButtons',
    @sdxNavBarOffice11ShowMoreButtons);
  InternalAdd('sdxNavBarOffice11ShowFewerButtons',
    @sdxNavBarOffice11ShowFewerButtons);
  InternalAdd('sdxNavBarOffice11AddRemoveButtons',
    @sdxNavBarOffice11AddRemoveButtons);
  ...
  // OfficeNavigationBar
  InternalAdd('sdxOfficeNavigationBarNavigationOptionsMenuItem',
    @sdxOfficeNavigationBarNavigationOptionsMenuItem);
  InternalAdd('sdxOfficeNavigationBarCustomizationDlgCaption',
    @sdxOfficeNavigationBarCustomizationDlgCaption);
  InternalAdd('sdxOfficeNavigationBarMaxVisibleItems',
    @sdxOfficeNavigationBarMaxVisibleItems);
  InternalAdd('sdxOfficeNavigationBarCompactNavigation',
    @sdxOfficeNavigationBarCompactNavigation);
  InternalAdd('sdxOfficeNavigationBarDisplayInThisOrder',
    @sdxOfficeNavigationBarDisplayInThisOrder);
...
dxResourceStringsRepository.RegisterProduct('ExpressNavBar',
  @AddNavBarResourceStringNames);
