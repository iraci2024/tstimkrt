...
type
  ...
  TdxNavBarSkinBasedPainterHelper = class(TcxIUnknownObject,
  ...
  public
    ...
    function NavBarScrollBarElements(AIsHorizontal: Boolean;
      APart: TcxScrollBarPart): TdxSkinScrollInfo; virtual;
    ...
    function NavPaneGroupButtonCaption(AIsSelected: Boolean)
      : TdxSkinElement; virtual;
  ...
  TdxNavBarSkinBasedPainterHelperClass = class of
  ...
  TdxNavBarSkinBasedNavPaneChildGroupViewInfo = class
  ...
  TdxNavBarSkinBasedNavPaneGroupViewInfo = class
  ...
  TdxNavBarSkinBasedOverflowPanelViewInfo = class
  ...
  protected
    ...
    function GetOverflowPanelViewInfoClass
      : TdxNavBarOverflowPanelViewInfoClass; override;
  ...
  TdxNavBarSkinBasedNavPanePainter = class(TdxNavBarNavigationPanePainter,
    IdxNavBarColorSchemes)
  private
  ...
  protected
    ...
    class function GetPopupControlViewInfoClass
      : TdxNavBarPopupControlViewInfoClass; override;
    class function GetSkinPainterHelperClass
      : TdxNavBarSkinBasedPainterHelperClass; virtual;
    ...
    function GetNavPaneElementState(const APart: TdxNavBarPart)
      : TdxSkinElementState;
    function GetSplitterState: TdxSkinElementState; virtual;
    function GetSplitterType: Integer; virtual;
    // Drawing
    function InternalCreateOverflowPainter
      : TdxNavBarOverflowPanelPainter; override;
    procedure DoDrawDropTargetLinkSelection(AItemGroup: TdxNavBarGroupViewInfo;
      AItem1, AItem2: TdxNavBarCustomItemViewInfo); override;
    procedure DoDrawSplitter; override;

    property ColorSchemeHelper: IdxNavBarColorSchemes read GetColorSchemeHelper
      implements IdxNavBarColorSchemes;
  public
    ...
    procedure DrawCollapseElementBackground(const ARect: TRect;
      AState: TdxNavBarNavPanePartState); override;
    ...
    procedure DrawPopupControl(ACanvas: TcxCanvas;
      AViewInfo: TdxNavBarPopupControlViewInfo); override;
    procedure DrawSeparator(ALinkViewInfo: TdxNavBarLinkViewInfo); override;
    procedure DrawTopScrollButton; override;

    property OverflowPanelViewInfo: TdxNavBarSkinBasedOverflowPanelViewInfo
      read GetOverflowPanelViewInfo;
    property ColorSchemeName: TdxSkinName read GetColorSchemeName
      write SetColorSchemeName;
  end;
  ...
  protected
    ...
    function IsActiveGroup(APanel: TdxNavBarCustomOverflowPanelViewInfo;
      AItemIndex: Integer): Boolean;

    function GetPartElementState(APanel: TdxNavBarCustomOverflowPanelViewInfo;
      const APart: TdxNavBarPart): TdxSkinElementState;
    function GetSkinElementState(APanel: TdxNavBarCustomOverflowPanelViewInfo;
  ...
  public
    ...
    procedure DrawSign(ACanvas: TCanvas;
      APanel: TdxNavBarCustomOverflowPanelViewInfo); override;
    procedure DrawPopupMenuItem(APanel: TdxNavBarCustomOverflowPanelViewInfo;
      ACanvas: TCanvas; ARect: TRect; AImageList: TCustomImageList;
      AImageIndex: Integer; AText: String;
      AState: TdxNavBarObjectStates); override;
  end;

  { TdxNavBarSkinBasedExplorerBarViewInfo }

  TdxNavBarSkinBasedExplorerBarViewInfo = class
  ...
  TdxNavBarSkinBasedExplorerBarPainter = class
    (TdxNavBarOffice11ExplorerBarPainter, IdxNavBarColorSchemes)
  protected
    FSkinBasedPainterHelper: TdxNavBarSkinBasedPainterHelper;
    ...
    procedure DoDrawDropTargetLinkSelection(AItemGroup: TdxNavBarGroupViewInfo;
      AItem1, AItem2: TdxNavBarCustomItemViewInfo); override;
    function GetLookAndFeelPainter: TcxCustomLookAndFeelPainter; override;
    function IsGroupCaptionButtonCompositeDraw(AGroupViewInfo
      : TdxNavBarGroupViewInfo): Boolean; virtual;
  ...
  TdxNavBarSkinBasedExplorerBarLinkViewInfo = class
  ...
  TdxNavBarSkinBasedExplorerBarGroupViewInfo = class
...
function DrawSkinElement(AElement: TdxSkinElement; ACanvas: TCanvas;
...
function GetNavBarColorSchemes(APainter: TdxNavBarPainter)
  : IdxNavBarColorSchemes;
function GetSkinElementOffsets(AElement: TdxSkinElement;
  AScaleFactor: TdxScaleFactor): TRect;
function NavBarObjectStateToSkinState(AState: TdxNavBarObjectStates)
  : TdxSkinElementState; overload;
function NavBarObjectStateToSkinState(AState: TdxNavBarNavPanePartState)
  : TdxSkinElementState; overload;
...
type
  ...
  TdxNavBarNavigationPaneControllerAccess = class
    (TdxNavBarNavigationPaneController);
  TdxNavBarNavigationPaneViewInfoAccess = class
...
begin
  ...
  if [sPressed, sSelected] * AState <> [] then
    ...
    Result := esHot
  else if sDisabled in AState then
    Result := esDisabled;
end;
...
begin
  NavBarDragDropItemTarget := GetElementByName(GroupNavBar,
...
function TdxNavBarSkinBasedPainterHelper.GetSkinPainterData
...
function TdxNavBarSkinBasedPainterHelper.TryCreateSkinInfo
  (var AData: TdxSkinInfo): Boolean;
begin
...
function TdxNavBarSkinBasedPainterHelper.NavBarDragDropItemTarget
  : TdxSkinElement;
var
  ASkinInfo: TdxSkinInfo;
begin
...
function TdxNavBarSkinBasedPainterHelper.NavBarChildGroupExpandButton
  (AIsClose: Boolean): TdxSkinElement;
begin
  Result := nil;
end;

function TdxNavBarSkinBasedPainterHelper.NavBarGroupButtonCaption
  : TdxSkinElement;
var
  ASkinInfo: TdxSkinInfo;
begin
...
function TdxNavBarSkinBasedPainterHelper.NavBarGroupSigns(AIsClose: Boolean)
  : TdxSkinElement;
var
  ASkinInfo: TdxSkinInfo;
begin
...
function TdxNavBarSkinBasedPainterHelper.NavPaneCaptionFontSize
...
function TdxNavBarSkinBasedPainterHelper.NavPaneCaptionHeight
  : TdxSkinIntegerProperty;
var
  ASkinInfo: TdxSkinInfo;
begin
...
function TdxNavBarSkinBasedPainterHelper.
  NavPaneDoesGroupCaptionButtonRequireOffset: Boolean;
begin
  Result := True;
end;
...
function TdxNavBarSkinBasedPainterHelper.NavePaneHeaderSign(ACollapse: Boolean)
  : TdxSkinElement;
var
  ASkinInfo: TdxSkinInfo;
begin
...
function TdxNavBarSkinBasedPainterHelper.NavPaneItem(AIsSelected: Boolean)
  : TdxSkinElement;
var
  ASkinInfo: TdxSkinInfo;
begin
...
function TdxNavBarSkinBasedPainterHelper.NavPaneOverflowPanelSign
  : TdxSkinElement;
var
  ASkinInfo: TdxSkinInfo;
begin
...
function TdxNavBarSkinBasedPainterHelper.NavPaneOverflowPanelItem
  : TdxSkinElement;
var
  ASkinInfo: TdxSkinInfo;
begin
...
function TdxNavBarSkinBasedPainterHelper.NavPanePopupMenuSelection
  : TdxSkinElement;
var
  ASkinInfo: TdxSkinInfo;
begin
...
function TdxNavBarSkinBasedPainterHelper.NavPanePopupMenuSeparator
  : TdxSkinElement;
var
  ASkinInfo: TdxSkinInfo;
begin
...
function TdxNavBarSkinBasedPainterHelper.NavPanePopupMenuSideStrip
  : TdxSkinElement;
var
  ASkinInfo: TdxSkinInfo;
begin
...
function TdxNavBarSkinBasedPainterHelper.NavPaneScrollButtons(AIsDown: Boolean)
  : TdxSkinElement;
var
  ASkinInfo: TdxSkinInfo;
begin
...
function TdxNavBarSkinBasedNavPaneGroupViewInfo.GetSkinHelper
  : TdxNavBarSkinBasedPainterHelper;
begin
...
function TdxNavBarSkinBasedNavPaneLinkViewInfo.GetSkinHelper
  : TdxNavBarSkinBasedPainterHelper;
begin
  Result := TdxNavBarSkinBasedNavPanePainter(Painter).FSkinBasedPainterHelper;
end;
...
function TdxNavBarSkinBasedOverflowPanelViewInfo.GetSkinHelper
  : TdxNavBarSkinBasedPainterHelper;
begin
  Result := TdxNavBarSkinBasedNavPanePainter(Painter).FSkinBasedPainterHelper;
end;
...
begin
  ...
  if AElement <> nil then
    NavBar.DefaultStyles.ItemHotTracked.Font.Color :=
      AElement.GetTextColor(cxbsHot);
end;
...
begin
  ...
  if AElement <> nil then
    NavBar.DefaultStyles.ItemPressed.Font.Color :=
      AElement.GetTextColor(cxbsPressed);
end;
...
procedure TdxNavBarSkinBasedNavPaneViewInfo.
...
begin
  ...
  if AElement <> nil then
    NavBar.DefaultStyles.NavigationPaneHeader.Font.Height :=
      dxGetFontHeight(AElement.Value, ScaleFactor);
end;
...
function TdxNavBarSkinBasedNavPaneViewInfo.GetSkinHelper
  : TdxNavBarSkinBasedPainterHelper;
begin
  Result := TdxNavBarSkinBasedNavPanePainter(Painter).FSkinBasedPainterHelper;
end;
...
function TdxNavBarSkinBasedNavPaneViewInfo.GetOverflowPanelViewInfoClass
...
function TdxNavBarSkinBasedPopupControlViewInfo.GetSkinHelper
  : TdxNavBarSkinBasedPainterHelper;
begin
  Result := TdxNavBarSkinBasedNavPanePainter(Painter).FSkinBasedPainterHelper;
end;
...
function TdxNavBarSkinBasedNavPanePainter.CreateSkinHelper
  : TdxNavBarSkinBasedPainterHelper;
begin
  Result := GetSkinPainterHelperClass.Create(GetDefaultColorSchemeName);
end;

class function TdxNavBarSkinBasedNavPanePainter.GetViewInfoClass
  : TdxNavBarViewInfoClass;
begin
  Result := TdxNavBarSkinBasedNavPaneViewInfo;
end;

class function TdxNavBarSkinBasedNavPanePainter.GetChildGroupViewInfoClass
  : TdxNavBarChildGroupViewInfoClass;
begin
  Result := TdxNavBarSkinBasedNavPaneChildGroupViewInfo;
end;

class function TdxNavBarSkinBasedNavPanePainter.GetGroupViewInfoClass
  : TdxNavBarGroupViewInfoClass;
begin
  Result := TdxNavBarSkinBasedNavPaneGroupViewInfo;
end;

class function TdxNavBarSkinBasedNavPanePainter.GetLinkViewInfoClass
  : TdxNavBarLinkViewInfoClass;
begin
  Result := TdxNavBarSkinBasedNavPaneLinkViewInfo;
end;

function TdxNavBarSkinBasedNavPanePainter.GetLookAndFeelPainter
  : TcxCustomLookAndFeelPainter;
begin
  Result := cxLookAndFeelPaintersManager.GetPainter(lfsNative);
end;

class function TdxNavBarSkinBasedNavPanePainter.GetSkinPainterHelperClass
  : TdxNavBarSkinBasedPainterHelperClass;
begin
  Result := TdxNavBarSkinBasedPainterHelper;
end;

class function TdxNavBarSkinBasedNavPanePainter.GetPopupControlViewInfoClass
...
function TdxNavBarSkinBasedNavPanePainter.GetColorSchemeHelper
  : IdxNavBarColorSchemes;
begin
  Supports(FSkinBasedPainterHelper, IdxNavBarColorSchemes, Result);
end;

function TdxNavBarSkinBasedNavPanePainter.GetDefaultColorSchemeName
  : TdxSkinName;
begin
  Result := '';
end;
...
procedure TdxNavBarSkinBasedNavPanePainter.SetColorSchemeName
  (const AValue: TdxSkinName);
begin
  FSkinBasedPainterHelper.SkinName := AValue;
end;

function TdxNavBarSkinBasedNavPanePainter.GetNavPaneElementState
  (const APart: TdxNavBarPart): TdxSkinElementState;
begin
...
begin
  ...
  if IsdxNavBarPartsEqual(AController.PressedPart, APart) or
    IsdxNavBarPartsEqual(AController.HotPart, APart) then
    Result := esHot
  else
    Result := esNormal;
end;
...
begin
  Result := Byte(not TdxNavBarNavigationPaneControllerAccess(Controller)
    .Collapsed);
end;

function TdxNavBarSkinBasedNavPanePainter.InternalCreateOverflowPainter
  : TdxNavBarOverflowPanelPainter;
begin
  Result := TdxNavBarSkinBasedOverflowPanelPainter.Create
    (FSkinBasedPainterHelper);
end;

procedure TdxNavBarSkinBasedNavPanePainter.DoDrawDropTargetLinkSelection
  (AItemGroup: TdxNavBarGroupViewInfo;
  AItem1, AItem2: TdxNavBarCustomItemViewInfo);
var
  ARect: TRect;
  AHeight: Integer;
begin
  AHeight := TdxNavBarSkinBasedNavPaneViewInfo(ViewInfo)
    .GetDragDropItemTargetHeight;
  if AItem1 <> nil then
    ARect := cxRectSetBottom(AItem1.Rect, AItem1.Rect.Bottom, AHeight)
  else
    ARect := cxRectSetTop(AItem2.Rect, AItem2.Rect.Top, AHeight);

  if not DrawSkinElement(FSkinBasedPainterHelper.NavBarDragDropItemTarget,
    Canvas, ARect, ScaleFactor) then
    inherited;
end;

procedure TdxNavBarSkinBasedNavPanePainter.DoDrawSplitter;
begin
  if not DrawSkinElement(FSkinBasedPainterHelper.NavPaneSplitter, Canvas,
    ViewInfo.SplitterRect, ScaleFactor, GetSplitterType, GetSplitterState) then
    inherited;
end;

function TdxNavBarSkinBasedNavPanePainter.
  GetGroupCaptionButtonDrawOffsets: TRect;
begin
  Result := cxNullRect;
  if FSkinBasedPainterHelper.NavPaneDoesGroupCaptionButtonRequireOffset then
    Inc(Result.Top, (ViewInfo as TdxNavBarSkinBasedNavPaneViewInfo)
      .GetGroupOverlapValue);
end;

function TdxNavBarSkinBasedNavPanePainter.GetOverflowPanelViewInfo
  : TdxNavBarSkinBasedOverflowPanelViewInfo;
begin
  Result := TdxNavBarSkinBasedOverflowPanelViewInfo
    (inherited OverflowPanelViewInfo);
end;

function TdxNavBarSkinBasedNavPanePainter.InternalDrawScrollButton
  (ADownButton: Boolean; const ARect: TRect;
  AState: TdxNavBarObjectStates): Boolean;
begin
  Result := DrawSkinElement(FSkinBasedPainterHelper.NavPaneScrollButtons
    (ADownButton), Canvas, ARect, ScaleFactor, 0,
...
begin
  with ViewInfo do
    if not InternalDrawScrollButton(True, BottomScrollButtonRect,
      BottomScrollButtonState) then
      inherited DrawBottomScrollButton;
end;

procedure TdxNavBarSkinBasedNavPanePainter.DrawCollapseElementBackground
  (const ARect: TRect; AState: TdxNavBarNavPanePartState);
begin
  if not DrawSkinElement(FSkinBasedPainterHelper.NavPaneItemPanel, Canvas,
    ARect, ScaleFactor, 0, NavBarObjectStateToSkinState(AState)) then
    inherited;
end;
...
begin
  ...
  if not DrawSkinElement(FSkinBasedPainterHelper.NavPaneItem([sSelected,
    sPressed] * AChildGroupViewInfo.State <> []), Canvas,
    AChildGroupViewInfo.SelectionRect, ScaleFactor, 0, AState) then
    inherited;
end;

procedure TdxNavBarSkinBasedNavPanePainter.DrawHeaderBackground;
begin
  if not DrawSkinElement(FSkinBasedPainterHelper.NavPaneHeader, Canvas,
    ViewInfo.HeaderRect, ScaleFactor) then
    inherited;
end;

procedure TdxNavBarSkinBasedNavPanePainter.DrawHeaderSign;
begin
  if not DrawSkinElement(FSkinBasedPainterHelper.NavePaneHeaderSign
    (ViewInfo.GetHeaderSignDirection = dirLeft), Canvas,
    ViewInfo.HeaderSignRect, ScaleFactor, 0,
    GetNavPaneElementState(dxNavBarPart(nbHeaderSign))) then
...
begin
  if not DrawSkinElement(FSkinBasedPainterHelper.NavPaneGroupButtonCaption
    (sActive in AGroupViewInfo.State), Canvas,
    cxRectInflate(AGroupViewInfo.CaptionRect, GetGroupCaptionButtonDrawOffsets),
    ScaleFactor, 0, NavBarObjectStateToSkinState(AGroupViewInfo.State)) then
    inherited;
end;
...
begin
  ...
  if not DrawSkinElement(FSkinBasedPainterHelper.NavPaneItem([sSelected,
    sPressed] * ALinkViewInfo.State <> []), Canvas, ALinkViewInfo.SelectionRect,
    ScaleFactor, 0, AState) then
    inherited;
end;

procedure TdxNavBarSkinBasedNavPanePainter.DrawPopupControl(ACanvas: TcxCanvas;
...
procedure TdxNavBarSkinBasedNavPanePainter.DrawSeparator(ALinkViewInfo
  : TdxNavBarLinkViewInfo);
begin
  if not DrawSkinElement(FSkinBasedPainterHelper.NavBarSeparator, Canvas,
    ALinkViewInfo.Rect, ScaleFactor) then
    inherited;
end;
...
function TdxNavBarSkinBasedExplorerBarViewInfo.GetSkinHelper
  : TdxNavBarSkinBasedPainterHelper;
begin
  Result := TdxNavBarSkinBasedExplorerBarPainter(Painter)
    .FSkinBasedPainterHelper;
end;

function TdxNavBarSkinBasedExplorerBarViewInfo.
  GetDragDropItemTargetHeight: Integer;
var
  AElement: TdxSkinElement;
begin
  AElement := GetSkinHelper.NavBarDragDropItemTarget;
...
function TdxNavBarSkinBasedExplorerBarViewInfo.
  GetScrollContentForegroundColor: TColor;
var
  AElement: TdxSkinElement;
begin
  AElement := GetSkinHelper.NavBarItem;
...
constructor TdxNavBarSkinBasedExplorerBarPainter.Create
...
procedure TdxNavBarSkinBasedExplorerBarPainter.DrawGroupBorder
  (AGroupViewInfo: TdxNavBarGroupViewInfo);
begin
  if not DrawSkinElement(FSkinBasedPainterHelper.NavBarGroupClient, Canvas,
    AGroupViewInfo.ItemsRect, ScaleFactor) then
    inherited;
end;
...
procedure TdxNavBarSkinBasedExplorerBarPainter.DrawGroupCaptionButton
  (AGroupViewInfo: TdxNavBarGroupViewInfo);
begin
  if not DrawSkinElement(FSkinBasedPainterHelper.NavBarGroupButtonCaption,
    Canvas, AGroupViewInfo.CaptionRect, ScaleFactor, 0,
    NavBarObjectStateToSkinState(AGroupViewInfo.State),
    IsGroupCaptionButtonCompositeDraw(AGroupViewInfo)) then
    inherited DrawGroupCaptionButton(AGroupViewInfo);
end;

procedure TdxNavBarSkinBasedExplorerBarPainter.DrawGroupCaptionSign
  (AGroupViewInfo: TdxNavBarGroupViewInfo);
var
  AElement: TdxSkinElement;
begin
  AElement := FSkinBasedPainterHelper.NavBarGroupSigns
    (sExpanded in AGroupViewInfo.State);
  if AElement = nil then
    inherited DrawGroupCaptionSign(AGroupViewInfo)
  else if AGroupViewInfo.Group.ShowExpandButton then
    AElement.Draw(Canvas.Handle, AGroupViewInfo.CaptionSignRect, ScaleFactor, 0,
      NavBarObjectStateToSkinState(AGroupViewInfo.State));
end;

procedure TdxNavBarSkinBasedExplorerBarPainter.DrawGroupControlSplitter
  (AGroupViewInfo: TdxNavBarExplorerBarGroupViewInfo);
begin
  if not DrawSkinElement(FSkinBasedPainterHelper.NavPaneSplitter, Canvas,
    AGroupViewInfo.SplitterRect, ScaleFactor, 0, esNormal, True) then
    inherited;
end;

procedure TdxNavBarSkinBasedExplorerBarPainter.DrawSeparator
  (ALinkViewInfo: TdxNavBarLinkViewInfo);
begin
  if not DrawSkinElement(FSkinBasedPainterHelper.NavBarSeparator, Canvas,
    ALinkViewInfo.Rect, ScaleFactor) then
...
function TdxNavBarSkinBasedExplorerBarPainter.CreateSkinHelper
  : TdxNavBarSkinBasedPainterHelper;
begin
  Result := GetSkinPainterHelperClass.Create(GetDefaultColorSchemeName);
end;

class function TdxNavBarSkinBasedExplorerBarPainter.GetViewInfoClass
  : TdxNavBarViewInfoClass;
begin
  Result := TdxNavBarSkinBasedExplorerBarViewInfo;
end;

class function TdxNavBarSkinBasedExplorerBarPainter.GetGroupViewInfoClass
  : TdxNavBarGroupViewInfoClass;
begin
  Result := TdxNavBarSkinBasedExplorerBarGroupViewInfo;
end;

class function TdxNavBarSkinBasedExplorerBarPainter.GetLinkViewInfoClass
  : TdxNavBarLinkViewInfoClass;
begin
  Result := TdxNavBarSkinBasedExplorerBarLinkViewInfo;
end;

function TdxNavBarSkinBasedExplorerBarPainter.GetLookAndFeelPainter
  : TcxCustomLookAndFeelPainter;
begin
  Result := cxLookAndFeelPaintersManager.GetPainter(lfsNative);
end;

class function TdxNavBarSkinBasedExplorerBarPainter.GetSkinPainterHelperClass
  : TdxNavBarSkinBasedPainterHelperClass;
begin
  Result := TdxNavBarSkinBasedPainterHelper;
end;

procedure TdxNavBarSkinBasedExplorerBarPainter.ColorSchemeChanged
  (ASender: TObject);
begin
  TdxCustomNavBarAccess(NavBar).PerformWithAnimationLocking(procedure
    begin
      NavBar.AssignDefaultStyles;
      NavBar.InvalidateAll(doRecreate);
    end);
...
function TdxNavBarSkinBasedExplorerBarPainter.GetColorSchemeHelper
  : IdxNavBarColorSchemes;
begin
  Supports(FSkinBasedPainterHelper, IdxNavBarColorSchemes, Result);
end;

function TdxNavBarSkinBasedExplorerBarPainter.GetDefaultColorSchemeName
  : TdxSkinName;
begin
  Result := '';
end;
...
procedure TdxNavBarSkinBasedExplorerBarPainter.SetColorSchemeName
  (const AValue: TdxSkinName);
begin
  FSkinBasedPainterHelper.SkinName := AValue;
end;
...
var
  ...
  AHeight: Integer;
begin
  AHeight := TdxNavBarSkinBasedExplorerBarViewInfo(ViewInfo)
    .GetDragDropItemTargetHeight;
  if AItem1 <> nil then
    ARect := cxRectSetBottom(AItem1.Rect, AItem1.Rect.Bottom, AHeight)
  else
...
function TdxNavBarSkinBasedExplorerBarLinkViewInfo.FontColor: TColor;
  ...
  function NavBarObjectStateToButtonState(AState: TdxNavBarObjectStates)
    : TcxButtonState;
  begin
    Result := cxbsNormal;
    if [sPressed, sSelected] * AState <> [] then
...
begin
  ...
  begin
    ...
    else if APainter.FSkinBasedPainterHelper.GetSkinPainterData(ASkinInfo) and
...
procedure TdxNavBarSkinBasedExplorerBarGroupViewInfo.CalculateBounds(var X,
  Y: Integer);
begin
  ...
  begin
    ...
    begin
      if not FImageRect.IsEmpty then
        OffsetRect(FImageRect, FSkinBasedPainterHelper.NavBarGroupButtonCaption.
          ContentOffset.Left, 0);
      Inc(FCaptionTextRect.Left,
        FSkinBasedPainterHelper.NavBarGroupButtonCaption.ContentOffset.Left);
    end;
  end;
end;
...
constructor TdxNavBarSkinBasedOverflowPanelPainter.Create
...
procedure TdxNavBarSkinBasedOverflowPanelPainter.DrawBackground
  (ACanvas: TCanvas; APanel: TdxNavBarCustomOverflowPanelViewInfo);
begin
  if not DrawSkinElement(FHelper.NavPaneOverflowPanel, ACanvas, APanel.Rect,
    APanel.ScaleFactor) then
...
begin
  if not DrawSkinElement(FHelper.NavPaneOverflowPanelSign, ACanvas,
    APanel.SignRect, APanel.ScaleFactor, 0, GetPartElementState(APanel,
    dxNavBarPart(nbOverflowPanelSign)), False,
    APanel.NavBar.UseRightToLeftAlignment) then
    inherited DrawSign(ACanvas, APanel);
end;

procedure TdxNavBarSkinBasedOverflowPanelPainter.DrawPopupMenuItem
  (APanel: TdxNavBarCustomOverflowPanelViewInfo; ACanvas: TCanvas; ARect: TRect;
...
var
  ...
  begin
    ...
    Result := (APopupMenu <> nil) and (ASelected <> nil) and (ASeparator <> nil)
      and (ASideStrip <> nil);
  end;

  procedure DrawImage(ACanvas: TCanvas; AIsActive: Boolean;
  AImageAreaWidth: Integer);
  var
    R, R1: TRect;
  begin
    ...
    cxDrawImage(ACanvas.Handle, R, R, nil, AImageList, AImageIndex,
      EnabledImageDrawModeMap[not(sDisabled in AState)]);
  end;
  ...
  begin
    ...
    cxDrawText(ACanvas, AText, R, APanel.NavBar.DrawTextBiDiModeFlags(DT_LEFT or
  ...
  begin
    ...
    if APanel.NavBar.UseRightToLeftAlignment then
      R := TdxRightToLeftLayoutConverter.ConvertRect(R, ARect);
    ASideStrip.RightToLeftDependentDraw(ABuf.Canvas.Handle, R,
      dxSystemScaleFactor, APanel.NavBar.UseRightToLeftAlignment);
  end;

begin
  if not InitializeElements then
    inherited DrawPopupMenuItem(APanel, ACanvas, ARect, AImageList, AImageIndex,
      AText, AState)
  else
  begin
    AImageAreaWidth := 2 * APanel.PopupMenuImageIndent + TdxNavBarViewInfoAccess
      (APanel.NavBar.ViewInfo).GetSmallImageWidth;
    ...
    try
      ...
      if AText = '-' then
      begin
        R := Rect(AImageAreaWidth + 4, cxRectHeight(ARect) div 2, ABuf.Width,
          cxRectHeight(ARect) div 2 + 1);
        if APanel.NavBar.UseRightToLeftAlignment then
          R := TdxRightToLeftLayoutConverter.ConvertRect(R, ARect);
...
procedure TdxNavBarSkinBasedOverflowPanelPainter.DrawOverflowPanelItemBackground
  (ACanvas: TCanvas; APanel: TdxNavBarCustomOverflowPanelViewInfo;
...
begin
  ...
  if AElement <> nil then
    AElement.Draw(ACanvas.Handle, ARect, APanel.ScaleFactor,
      Byte(IsActiveGroup(APanel, AItemIndex)),
      NavBarObjectStateToSkinState(AState))
  else
...
function TdxNavBarSkinBasedOverflowPanelPainter.IsActiveGroup
  (APanel: TdxNavBarCustomOverflowPanelViewInfo; AItemIndex: Integer): Boolean;
begin
  Result := InRange(AItemIndex, 0, APanel.ItemCount - 1) and
    (APanel.Items[AItemIndex].Group = APanel.NavBar.ActiveGroup)
end;

function TdxNavBarSkinBasedOverflowPanelPainter.GetPartElementState
  (APanel: TdxNavBarCustomOverflowPanelViewInfo; const APart: TdxNavBarPart)
  : TdxSkinElementState;
begin
  Result := NavBarObjectStateToSkinState
    (TdxNavBarControllerAccess(APanel.NavBar.Controller).GetPartState(APart));
end;

function TdxNavBarSkinBasedOverflowPanelPainter.GetSkinElementState
  (APanel: TdxNavBarCustomOverflowPanelViewInfo; AIndex: Integer)
  : TdxSkinElementState;
begin
  Result := GetPartElementState(APanel,
    dxNavBarPart(nbOverflowPanelItem, AIndex));
  case Result of
    esChecked:
      Result := esNormal;
    esHotCheck:
