...
type
  ...
  public
    ...
    procedure RegisterView(AID: Integer; AName: string;
    ...
    property PainterClasses[AIndex: Integer]: TdxNavBarPainterClass
      read GetPainterClasses;
  end;
...
begin
  Result := dxCompareValues(TdxNavBarPainterFactItem(AItem1).ID,
...
function TdxNavBarViewsFactory.GetPainterClasses(AIndex: Integer)
...
procedure TdxNavBarViewsFactory.RegisterView(AID: Integer; AName: string;
  APainterClass: TdxNavBarPainterClass);
var
...
begin
  if IndexOfID(AID) <> -1 then
    raise Exception.CreateFmt
      (cxGetResourceString(@sdxViewAlreadyExists), [AID]);
