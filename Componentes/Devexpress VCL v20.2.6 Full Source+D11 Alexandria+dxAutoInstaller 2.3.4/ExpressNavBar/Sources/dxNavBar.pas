...
{ ExpressNavBar }
{ }
{ Copyright (c) 2002-2021 Developer Express Inc. }
{ ALL RIGHTS RESERVED }
{ }
...
{$ENDIF}
  ...
  dxCore, dxCoreClasses, dxMessages, cxClasses, cxContainer, dxCoreGraphics,
  cxGraphics, cxGeometry,
  cxLookAndFeelPainters, dxThemeManager, dxAnimation, dxGdiPlusClasses,
  dxScrollAnimation,
  cxControls, cxLookAndFeels, cxAccessibility, cxLibraryConsts, dxCustomHint,
  cxScrollBar, dxForms, dxFluentDesignFormInterfaces,
...
type
  ...
  // for internal use
  TdxNavBarDragDropFlag = (fAllowDragLink, fAllowDropLink, fAllowDragGroup,
    fAllowDropGroup);
  ...
  TdxNavBarObjectState = (sActive, sDisabled, sExpanded, sHotTracked, sPressed,
    sSelected, sSpecial, sFocused);
  TdxNavBarObjectStates = set of TdxNavBarObjectState;
  TdxNavBarPartState = (oisNormal, oisHot, oisPressed, oisChecked, oisHotCheck,
    oisDroppedDown); // for internal use
...
const
  ...
  dxNavBarDefaultDragDropFlags = [fAllowDragLink, fAllowDropLink,
    fAllowDragGroup, fAllowDropGroup];
...
type
  ...
  TdxNavBarCustomPopupControlViewInfoClass = class of
  ...
  public
    constructor Create(AGroupViewInfo: TdxNavBarGroupViewInfo;
      ALink: TdxNavBarItemLink; ACaptionVisible, AImageVisible: Boolean);
  ...
  protected
    ...
    function CreateLinkViewInfo(ALink: TdxNavBarItemLink;
      ACaptionVisible, AImageVisible: Boolean): TdxNavBarLinkViewInfo; virtual;
    procedure AddChildGroup(AGroup: TdxNavBarGroup;
      ACaptionVisible, AItemsVisible: Boolean); virtual;
    procedure AddLink(AViewInfo: TdxNavBarViewInfo; ALink: TdxNavBarItemLink;
      ACaptionVisible, AImageVisible: Boolean); virtual;
  ...
  public
    ...
    function GetGroupViewInfoByGroup(AGroup: TdxNavBarGroup)
      : TdxNavBarGroupViewInfo;
    function GetLinkViewInfoByLink(ALink: TdxNavBarItemLink)
      : TdxNavBarLinkViewInfo;
  ...
  protected
    class function GetGroupCaptionSeparatorWidth(AGroupViewInfo
      : TdxNavBarGroupViewInfo): Integer; static;
    class procedure CalculateClientRect(AGroupViewInfo: TdxNavBarGroupViewInfo;
      var X, Y: Integer); static;
    class procedure CalculateFocusRect(AGroupViewInfo
      : TdxNavBarGroupViewInfo); static;
    class procedure CalculateItems(AGroupViewInfo: TdxNavBarGroupViewInfo;
      var X, Y: Integer; out AItemsRectBottom: Integer); static;
    class procedure CalculateItemsAsIconView(AGroupViewInfo
      : TdxNavBarGroupViewInfo; var X, Y: Integer;
      out AItemsRectBottom: Integer); static;
    class procedure CalculateItemsRect(AGroupViewInfo
      : TdxNavBarGroupViewInfo); static;
  public
    class procedure CalculateCaptionBounds(AGroupViewInfo
      : TdxNavBarGroupViewInfo; X, Y: Integer); static;
    class procedure CalculateExpandButtonRect(AGroupViewInfo
      : TdxNavBarGroupViewInfo); static;
  end;
  ...
  protected
    ...
    function UseLargeImages: Boolean; override;
  public
    constructor Create(AParentGroupViewInfo, AGroupViewInfo
      : TdxNavBarGroupViewInfo);
    function Font: TFont; override;
    function GetDesignSelectorSize: TSize; override;
  end;
  ...
  public
    constructor Create(AViewInfo: TdxNavBarViewInfo;
      ...
      ACaptionVisible, AItemsVisible: Boolean); reintroduce; virtual;
    destructor Destroy; override;
  ...
  TdxNavBarHeaderPanelSignAccessibilityHelper = class
    (TdxNavBarCustomAccessibilityHelper) // for internal use
  strict private
    function GetViewInfo: TdxNavBarViewInfo;
  protected
    function ChildIsSimpleElement(AIndex: Integer): Boolean; override;
    procedure DoDefaultAction(AChildID
      : TcxAccessibleSimpleChildElementID); override;
    function GetName(AChildID: TcxAccessibleSimpleChildElementID)
      : string; override;
    function GetParent: TcxAccessibilityHelper; override;
    function GetRole(AChildID: TcxAccessibleSimpleChildElementID)
      : Integer; override;
    function GetState(AChildID: TcxAccessibleSimpleChildElementID)
      : Integer; override;
    function GetSupportedProperties(AChildID: TcxAccessibleSimpleChildElementID)
      : TcxAccessibleObjectProperties; override;
  ...
  TdxNavBarCalcHintEvent = procedure(AItem: TObject; var ARect: TRect)
    of object;
  ...
  strict protected
    ...
    FSizeGripRect: TRect;
  protected
    class function InternalGetLinkViewInfoAtSelectedPos
      (AViewInfo: TdxNavBarViewInfo; const pt: TPoint): TdxNavBarLinkViewInfo;
    ...
    function GetLargeImageHeight(AItemViewInfo: TdxNavBarCustomItemViewInfo)
      : Integer; overload; virtual;
    function GetLargeImageWidth: Integer; overload;
    function GetLargeImageWidth(AItemViewInfo: TdxNavBarCustomItemViewInfo)
      : Integer; overload; virtual;
    function GetScrollButtonsBounds: TRect; virtual;
    function GetSmallImageHeight: Integer; overload;
    function GetSmallImageHeight(AItemViewInfo: TdxNavBarCustomItemViewInfo)
      : Integer; overload; virtual;
    function GetSmallImageWidth: Integer; overload;
    function GetSmallImageWidth(AItemViewInfo: TdxNavBarCustomItemViewInfo)
      : Integer; overload; virtual;
    ...
    function GetGroupAccessibilityHelperClass
      : TdxNavBarCustomAccessibilityHelperClass; virtual;
    function GetGroupCaptionPanelAccessibilityHelperClass
      : TdxNavBarCustomAccessibilityHelperClass; virtual;
    ...
    function CanHasVisibleItemsInGroup(AGroup: TdxNavBarGroup)
      : Boolean; virtual;
    ...
    function HasEnoughSpaceForScrollButtons(AScrollingAreaHeight
      : Integer): Boolean;
    ...
    procedure SetGroupControlWindowRegion(const AClipRect: TRect;
      AGroup: TdxNavBarGroupViewInfo);
    ...
    function GetHeaderSignAccessibilityHelperClass
      : TdxNavBarCustomAccessibilityHelperClass; virtual;
    function GetPartIAccessibilityHelper(const APart: TdxNavBarPart)
      : IdxNavBarAccessibilityHelper; virtual;
    ...
    property HeaderPanelViewInfo: TdxNavBarHeaderPanelViewInfo
      read FHeaderPanelViewInfo;
  ...
  public
    ...
    function GetGroupViewInfoByGroup(AGroup: TdxNavBarGroup)
      : TdxNavBarGroupViewInfo; virtual;
    function GetLinkViewInfoByLink(ALink: TdxNavBarItemLink)
      : TdxNavBarLinkViewInfo; virtual;
    function IndexOfGroupViewInfo(AViewInfo: TdxNavBarGroupViewInfo): Integer;
    // Hit tests
    function GetGroupViewInfoAtPos(const pt: TPoint)
      : TdxNavBarGroupViewInfo; virtual;
    function GetGroupViewInfoAtCaptionPos(const pt: TPoint)
      : TdxNavBarGroupViewInfo; virtual;
    function GetGroupViewInfoAtItemsPos(const pt: TPoint)
      : TdxNavBarGroupViewInfo; virtual;
    ...
    function GetLinkViewInfoAtPos(const pt: TPoint)
      : TdxNavBarLinkViewInfo; virtual;
    function GetLinkViewInfoAtSelectedPos(const pt: TPoint)
      : TdxNavBarLinkViewInfo; virtual;
    ...
    function GetViewInfoAtDragPosition(const pt: TPoint;
      var ItemGroup: TdxNavBarGroupViewInfo;
      var Item1, Item2: TdxNavBarLinkViewInfo): Integer; virtual;
    function GetViewInfoAtDragPositionWhenIconView(const pt: TPoint;
      var ItemGroup: TdxNavBarGroupViewInfo;
      var Item1, Item2: TdxNavBarLinkViewInfo): Integer; virtual;
    ...
    property TopScrollButtonState: TdxNavBarObjectStates
      read GetTopScrollButtonState;
    property BottomScrollButtonState: TdxNavBarObjectStates
      read GetBottomScrollButtonState;
    // Hint
  ...
  private
    class procedure CalculateImageRect(ACaptionViewInfo
      : TdxNavBarChildCaptionViewInfo; ALeft, ATop: Integer);
    class procedure CalculateLargeBounds(ACaptionViewInfo
      : TdxNavBarChildCaptionViewInfo; X, Y, ARightPosition: Integer);
    class procedure CalculateLeftPosition(ACaptionViewInfo
      : TdxNavBarChildCaptionViewInfo; X: Integer; out ALeft: Integer);
    class procedure CalculateSmallBounds(ACaptionViewInfo
      : TdxNavBarChildCaptionViewInfo; X, Y, ARightPosition: Integer);
    class procedure CalculateRect(ACaptionViewInfo
      : TdxNavBarChildCaptionViewInfo; ALeft, ATop, ARight, ABottom: Integer);
  protected
    class function HasScrollBar(ACaptionViewInfo: TdxNavBarChildCaptionViewInfo)
      : Boolean; virtual;
    class procedure CalculateCaptionRect(ACaptionViewInfo
      : TdxNavBarChildCaptionViewInfo;
      ALeft, ATop, ARightPosition: Integer); virtual;
  public
    class procedure CalculateBounds(X, Y: Integer; AScaleFactor: TdxScaleFactor;
      var AItemViewInfo); override;
    class procedure CalculateDesignRect(AItemViewInfo
      : TdxNavBarCustomItemViewInfo; const ARect: TRect); static;
    class function CalculateFocusRect(const ARect, ATextRect: TRect)
      : TRect; overload;
    class procedure CalculateFocusRect(AItemViewInfo
      : TdxNavBarCustomItemViewInfo); overload;
    class procedure CalculateFocusRect(AItemViewInfo
      : TdxNavBarCustomItemViewInfo; const ARect, ATextRect: TRect); overload;
  end;
  ...
  strict protected
    procedure DrawVerticalText(AFont: TFont; const AText: string;
      const ARect: TRect; AColor: TColor; AAngle: TcxRotationAngle);
  protected
    { IUnknown }
    ...
    function CreateChildGroupViewInfo(AViewInfo: TdxNavBarViewInfo;
      ...
      : TdxNavBarChildGroupViewInfo; virtual;
    function CreateGroupViewInfo(AViewInfo: TdxNavBarViewInfo;
    ...
    class function GetDropInfoCalculatorClass
      : TdxNavBarDropInfoCalculatorClass; virtual;
    ...
    class function GetHeaderPanelViewInfoClass
      : TdxNavBarHeaderPanelViewInfoClass; virtual;
    class function GetChildGroupViewInfoClass
      : TdxNavBarChildGroupViewInfoClass; virtual;
    ...
    // ScrollBar
    function CreatecxScrollBarHelper(AOwner: TdxNavBarScrollBar)
      : TcxControlScrollBarHelper; virtual;
  ...
  public
    ...
    procedure DrawChildGroupCaption(AChildGroupViewInfo
      : TdxNavBarChildGroupViewInfo); virtual;
    procedure DrawChildGroupExpandButton(AChildGroupViewInfo
      : TdxNavBarChildGroupViewInfo); virtual;
    procedure DrawChildGroupSelection(AChildGroupViewInfo
      : TdxNavBarChildGroupViewInfo); virtual;
    procedure DrawGroup(AGroupViewInfo: TdxNavBarGroupViewInfo); virtual;
    procedure DrawGroupBackground(AGroupViewInfo
      : TdxNavBarGroupViewInfo); virtual;
    ...
    procedure DrawGroupCaptionButton(AGroupViewInfo
      : TdxNavBarGroupViewInfo); virtual;
    procedure DrawGroupCaptionText(AGroupViewInfo
      : TdxNavBarGroupViewInfo); virtual;
    procedure DrawGroupCaptionImage(AGroupViewInfo
      : TdxNavBarGroupViewInfo); virtual;
    procedure DrawGroupCaptionSign(AGroupViewInfo
      : TdxNavBarGroupViewInfo); virtual;
    procedure DrawGroupControl(ACanvas: TCanvas; ARect: TRect;
      AGroupViewInfo: TdxNavBarGroupViewInfo); virtual;
    procedure DrawGroupDesignRect(AGroupViewInfo
      : TdxNavBarGroupViewInfo); virtual;
    procedure DrawGroupItems(AGroupViewInfo: TdxNavBarGroupViewInfo); virtual;
    procedure DrawGroupFocusRect(AGroupViewInfo
      : TdxNavBarGroupViewInfo); virtual;
    ...
    procedure DrawGroupHintWindow(ACanvas: TCanvas;
  ...
  published
    ...
    property DragCursor: TCursor read GetDragCursor write SetDragCursor
      default dxNavBarDragCursor;
    property DragCopyCursor: TCursor read FDragCopyCursor write FDragCopyCursor
      default dxNavBarDragCopyCursor;
    property HotTrackedGroupCursor: TCursor read FHotTrackedGroupCursor
      write FHotTrackedGroupCursor default crDefault;
    property HotTrackedLinkCursor: TCursor read FHotTrackedLinkCursor
      write FHotTrackedLinkCursor default dxNavBarLinksCursor;
  end;
  ...
  TdxNavBarCustomDrawGroupHintEvent = procedure(Sender: TObject;
  ...
  TdxNavBarCustomDrawLinkHintEvent = procedure(Sender: TObject;
  ...
  public
    procedure Assign(Source: TPersistent); override;
  published
    property Background: TdxNavBarCustomDrawEvent read FBackground
      write FBackground;
    property GroupCaption: TdxNavBarCustomDrawGroupEvent read FGroupCaption
      write FGroupCaption;
    property GroupClientBackground: TdxNavBarCustomDrawGroupEvent
      read FGroupClientBackground write FGroupClientBackground;
    property GroupClientForeground: TdxNavBarCustomDrawGroupEvent
      read FGroupClientForeground write FGroupClientForeground;
    property GroupHint: TdxNavBarCustomDrawGroupHintEvent read FGroupHint
      write FGroupHint;
    property HamburgerMenuHeader: TdxNavBarCustomDrawEvent
      read FHamburgerMenuHeader write FHamburgerMenuHeader;
    property HamburgerMenuNavigationPane: TdxNavBarCustomDrawEvent
      read FHamburgerMenuNavigationPane write FHamburgerMenuNavigationPane;
    property Link: TdxNavBarCustomDrawLinkEvent read FLink write FLink;
    property LinkHint: TdxNavBarCustomDrawLinkHintEvent read FLinkHint
      write FLinkHint;
    property LinkSelection: TdxNavBarCustomDrawLinkEvent read FLinkSelection
      write FLinkSelection;
    property BottomScrollButton: TdxNavBarCustomDrawEvent
      read FBottomScrollButton write FBottomScrollButton;
    property TopScrollButton: TdxNavBarCustomDrawEvent read FTopScrollButton
      write FTopScrollButton;
    property NavigationPaneHeader: TdxNavBarCustomDrawEvent
      read FNavigationPaneHeader write FNavigationPaneHeader;
    property NavigationPaneSplitter: TdxNavBarCustomDrawEvent
      read FNavigationPaneSplitter write FNavigationPaneSplitter;
    property NavigationPaneOverflowPanel: TdxNavBarCustomDrawEvent
      read FNavigationPaneOverflowPanel write FNavigationPaneOverflowPanel;
    property NavigationPaneOverflowPanelHint: TdxNavBarCustomDrawGroupHintEvent
      read FNavigationPaneOverflowPanelHint
      write FNavigationPaneOverflowPanelHint;
  end;

  { TdxNavBarCustomCustomizationForm }

  TdxNavBarCustomCustomizationForm = class(TForm) // for internal use
  private
    FNavBar: TdxCustomNavBar;
    FLockCount: Integer;
  ...
  protected
    ...
    procedure CreateLink(AItem: TdxNavBarItem; AGroup: TdxNavBarGroup;
      AIndex: Integer);
    procedure MoveLink(ALink: TdxNavBarItemLink; AGroup: TdxNavBarGroup;
      AIndex: Integer);
    procedure RemoveLink(ALink: TdxNavBarItemLink);

    procedure CalculateDropInfo(var ADropTargetInfo
      : TdxNavBarDropTargetInfo); virtual;
    function CanProcessDropItem(Target: TObject; X, Y: Integer)
      : Boolean; virtual;
  ...
  TdxNavBarCustomCustomizationFormClass = class of
    TdxNavBarCustomCustomizationForm;
  ...
  public
    ...
    procedure Assign(Source: TPersistent); override;
  published
    property AllowChildGroups: Boolean read FAllowChildGroups
      write SetAllowChildGroups default False;
    property AllowExpandAnimation: Boolean read FAllowExpandAnimation
      write SetAllowExpandAnimation default False;
    property AllowMultipleGroupExpansion: Boolean
      read FAllowMultipleGroupExpansion write SetAllowMultipleGroupExpansion
      default True;
    property AllowSelectLinks: Boolean read FAllowSelectLinks
      write SetAllowSelectLinks default False;
    property DragDropFlags: TdxNavBarDragDropFlags read FDragDropFlags
      write FDragDropFlags default dxNavBarDefaultDragDropFlags;
    property EachGroupHasSelectedLink: Boolean read FEachGroupHasSelectedLink
      write SetEachGroupHasSelectedLink default False;
    property RevealHighlight: Boolean read FRevealHighlight
      write SetRevealHighlight default True;
    property ShowGroupsHint: Boolean read FShowGroupsHint write FShowGroupsHint
      default False;
    property ShowLinksHint: Boolean read FShowLinksHint write FShowLinksHint
      default False;
  end;
  ...
  protected
    property AllowPopupResizing: Boolean read FAllowPopupResizing
      write FAllowPopupResizing default True;
  public
    constructor Create(ANavBar: TdxCustomNavBar); override;
    procedure Assign(Source: TPersistent); override;
  published
    property AdjustWidthByPopup: Boolean read FAdjustWidthByPopup
      write FAdjustWidthByPopup default False;
    property AllowCustomizing: Boolean read FAllowCustomizing
      write FAllowCustomizing default True;
    property Collapsible: Boolean read FCollapsible write SetCollapsible
      default False;
    property ShowOverflowPanelHints: Boolean read FShowOverflowPanelHints
      write FShowOverflowPanelHints default True;
  ...
  private
    ...
    procedure SetSelectedGroupPopupMode(const AValue
  ...
  protected
    ...
    property AllowCustomizing: Boolean read FAllowCustomizing
      write SetAllowCustomizing default False;
  public
    procedure Assign(Source: TPersistent); override;
  published
    property Collapsed: Boolean read GetCollapsed write SetCollapsed
      default False;
    property DisplayMode: TdxNavBarHamburgerMenuDisplayMode read FDisplayMode
      write SetDisplayMode default dmInline;
    property SelectedGroupPopupMode
      : TdxNavBarHamburgerMenuSelectedGroupPopupMode
      read FSelectedGroupPopupMode write SetSelectedGroupPopupMode
      default pmDocked;
  end;
  ...
  public
    procedure Assign(Source: TPersistent); override;
  published
    property AllowSelectLinks: Boolean read GetAllowSelectLinks
      write SetAllowSelectLinks stored False;
    property EachGroupHasSelectedLink: Boolean read GetEachGroupHasSelectedLink
      write SetEachGroupHasSelectedLink stored False;
  end;
  ...
  public
    ...
    procedure Assign(Source: TPersistent); override;
  published
    property Common: TdxNavBarCommonBehaviorOptions read FCommon
      write SetCommon;
    property HamburgerMenu: TdxNavBarHamburgerMenuBehaviorOptions
      read FHamburgerMenu write SetHamburgerMenu;
    property NavigationPane: TdxNavBarNavigationPaneBehaviorOptions
      read FNavigationPane write SetNavigationPane;
    property SideBar: TdxNavBarSideBarBehaviorOptions read FSideBar
      write SetSideBar stored False;
  end;
  ...
  public
    ...
    procedure Assign(Source: TPersistent); override;
  published
    property ShowGroupCaptions: Boolean read FShowGroupCaptions
      write SetShowGroupCaptions default True;
  end;
  ...
  public
    procedure Assign(Source: TPersistent); override;
  published
    property ShowSpecialGroup: Boolean read FShowSpecialGroup
      write SetShowSpecialGroup default False;
  ...
  public
    ...
    procedure Assign(Source: TPersistent); override;
  published
    property MaxVisibleGroups: Integer read FMaxVisibleGroups
      write SetMaxVisibleGroups default -1;
    property OverflowPanelUseSmallImages: Boolean
      read FOverflowPanelUseSmallImages write SetOverflowPanelUseSmallImages
      default True;
    property ShowActiveGroupCaptionWhenCollapsed: Boolean
      read FShowActiveGroupCaptionWhenCollapsed
      write SetShowActiveGroupCaptionWhenCollapsed default False;
    property ShowHeader: Boolean read FShowHeader write SetShowHeader
      default True;
    property ShowOverflowPanel: Boolean read FShowOverflowPanel
      write SetShowOverflowPanel default True;
  end;
  ...
  strict private
    ...
    procedure SetNavigationPaneMode(const AValue
  ...
  public
    ...
    procedure Assign(Source: TPersistent); override;
  published
    property ChildLevelIndent: Integer read FChildLevelIndent
      write SetChildLevelIndent default -1;
    property NavigationPaneMode: TdxNavBarHamburgerMenuNavigationPaneMode
      read FNavigationPaneMode write SetNavigationPaneMode default npmCompact;
    property ShowHeader: Boolean read FShowHeader write SetShowHeader
      default True;
    property ShowOverflowPanel: Boolean read FShowOverflowPanel
      write SetShowOverflowPanel default True;
    property SpaceBetweenGroups: Integer read FSpaceBetweenGroups
      write SetSpaceBetweenGroups default -1;
  end;
  ...
  published
    ...
    property HamburgerMenu: TdxNavBarHamburgerMenuViewOptions
      read FHamburgerMenu write SetHamburgerMenu;
    property ExplorerBar: TdxNavBarExplorerBarViewOptions read FExplorerBar
      write SetExplorerBar;
    property NavigationPane: TdxNavBarNavigationPaneViewOptions
      read FNavigationPane write SetNavigationPane;
  end;
  ...
  public
    ...
    procedure Assign(Source: TPersistent); override;
  published
    property DisabledLargeImages: TCustomImageList read FDisabledLargeImages
      write SetDisabledLargeImages;
    property DisabledSmallImages: TCustomImageList read FDisabledSmallImages
      write SetDisabledSmallImages;
    property HotLargeImages: TCustomImageList read FHotLargeImages
      write SetHotLargeImages;
    property HotSmallImages: TCustomImageList read FHotSmallImages
      write SetHotSmallImages;
  ...
  protected
    ...
    function GetItemHintRect(ANavBarItem: TObject;
      ACalcHintProc: TdxNavBarCalcHintEvent): TRect;
    function GetPartAtPos(const APoint: TPoint): TdxNavBarPart; virtual;
    function GetPartState(const APart: TdxNavBarPart)
      : TdxNavBarPartState; virtual;
    ...
    procedure DoLinkClick(ANavBar: TdxCustomNavBar;
      ALink: TdxNavBarItemLink); virtual;
    procedure DoLinkHotTrack(ANavBar: TdxCustomNavBar;
      ALink: TdxNavBarItemLink); virtual;
    procedure DoLinkPress(ANavBar: TdxCustomNavBar;
      ALink: TdxNavBarItemLink); virtual;
    procedure DoMouseDown(AButton: TMouseButton; AShift: TShiftState;
      const APoint: TPoint); virtual;
    procedure DoMouseUp(AButton: TMouseButton; AShift: TShiftState;
      const APoint: TPoint); virtual;
    ...
    procedure DoShowGroupHint(var AHintInfo: THintInfo;
      AGroupViewInfo: TdxNavBarGroupViewInfo); virtual;
    procedure DoShowLinkHint(var AHintInfo: THintInfo;
      ALinkViewInfo: TdxNavBarLinkViewInfo); virtual;
    ...
    function CreateGroupPopupControl: TdxNavBarCustomPopupControl; virtual;
    // for internal use
    function NeedClosePopupControlsOnLinkClick: Boolean; virtual;
    // for internal use
    procedure DestroyPopupControls; virtual; // for internal use

    function GetActualNavBar: TdxCustomNavBar; overload; virtual;
    function GetActualNavBar(AGroup: TdxNavBarGroup): TdxCustomNavBar;
      overload; virtual;
    ...
    procedure InternalShowPopupControl(AGroup: TdxNavBarGroup;
      const ADroppedDownPart: TdxNavBarPart); overload;
    procedure InternalShowPopupControl(const ADroppedDownPart: TdxNavBarPart);
      overload; virtual;
    ...
    property DroppedDownPart: TdxNavBarPart read FDroppedDownPart
      write SetDroppedDownPart;
    property NavBar: TdxCustomNavBar read FNavBar;
    property OriginalWidth: Integer read GetOriginalWidth
      write SetOriginalWidth;
    property PopupControl: TdxNavBarCustomPopupControl read FPopupControl;
    // for internal use
  ...
  public
    ...
    function MouseWheel(AShift: TShiftState; AWheelDelta: Integer;
  ...
  TdxNavBarGroupEvent = procedure(Sender: TObject; AGroup: TdxNavBarGroup)
    of object;
  TdxNavBarGroupChangingEvent = procedure(Sender: TObject;
    ANewGroup: TdxNavBarGroup; var AAllowChange: Boolean) of object;
  TdxNavBarLinkEvent = procedure(Sender: TObject; ALink: TdxNavBarItemLink)
    of object;
  TdxNavBarCalcGroupHintRectEvent = procedure(Sender: TObject;
    AGroup: TdxNavBarGroup; AViewInfo: TdxNavBarViewInfo; var R: TRect)
    of object;
  TdxNavBarCalcLinkHintRectEvent = procedure(Sender: TObject;
    ALink: TdxNavBarItemLink; AViewInfo: TdxNavBarViewInfo; var R: TRect)
    of object;
  TdxNavBarCalcGroupClientHeightEvent = procedure(Sender: TObject;
    AViewInfo: TdxNavBarGroupViewInfo; var AHeight: Integer) of object;
  TdxNavBarGetGroupHintEvent = procedure(Sender: TObject;
    AGroup: TdxNavBarGroup; var AHint: string) of object;
  TdxNavBarGetLinkHintEvent = procedure(Sender: TObject;
    ALink: TdxNavBarItemLink; var AHint: string) of object;
  TdxNavBarGetOverlaySizeEvent = procedure(Sender: TObject;
    var AWidth, AHeight: Integer) of object;
  TdxNavBarShowingPopupEvent = procedure(Sender: TObject; var AAllow: Boolean)
    of object;
  ...
  TdxNavBarInternalState = (nbisKeyDowned, nbisDragging, nbisAlreadyCollapsed,
    nbisAfterLoading, nbisGroupExpanding, nbisPrepareExpandAnimation,
    nbisResizing);
  ...
  public
    constructor Create(ANavBar: TdxCustomNavBar); override;
    procedure Assign(Source: TPersistent); override;
    property Views[Index: TcxLookAndFeelStyle]: Integer read GetView
      write SetView;
  published
    property Flat: Integer index lfsFlat read GetRealView write SetRealView
      default dxNavBarFlatView;
    property Standard: Integer index lfsStandard read GetRealView
      write SetRealView default dxNavBarBaseView;
    property UltraFlat: Integer index lfsUltraFlat read GetRealView
      write SetRealView default dxNavBarFlatView;
    property Native: Integer index lfsNative read GetRealView write SetRealView
      default dxNavBarOffice12NavigatorPaneView;
    property Office11: Integer index lfsOffice11 read GetRealView
      write SetRealView default dxNavBarOffice11NavigatorPaneView;
    property Skin: Integer index lfsSkin read GetRealView write SetRealView
      default dxNavBarSkinNavigatorPaneView;
  end;
  ...
  public
    ...
    property StartState: TdxNavBarGroupAnimatedImageState read FStartState
      write FStartState;
    property EndState: TdxNavBarGroupAnimatedImageState read FEndState
      write FEndState;
  end;
  ...
  protected
    ...
    property ImageInfo[AIndex: Integer]: TdxNavBarGroupAnimatedImageInfo
      read GetImageInfo;
  public
  ...
  strict private
    ...
    procedure OnAnimateHandler(Sender: TdxAnimationTransition;
      var APosition: Integer; var AFinished: Boolean);
  ...
  strict protected
    ...
    procedure CalculateBounds(var ASourceRect, ATargetRect: TRect);
      virtual; abstract;
    ...
    property AnimationTransition: TdxRectAnimationTransition
      read FAnimationTransition;
  ...
  TdxNavBarInlineExpandAnimationController = class
    (TdxNavBarCollapseStateAnimationController) // for internal use
  private
  ...
  private
    FNavBar: TdxCustomNavBar;
  strict protected
    procedure SetForbiddenDropInfo(var ADropTargetInfo
      : TdxNavBarDropTargetInfo);
  protected
    procedure CheckDropInfo(var ADropTargetInfo
      : TdxNavBarDropTargetInfo); virtual;
    ...
    function GetDropKind(const APoint: TPoint; const ARect: TRect;
      AForbiddenDropKinds: TdxNavBarDropKinds; AIsVerticalItemLayout: Boolean)
      : TdxNavBarDropKind; virtual;
    function GetDropTargetPoint: TPoint; virtual;
    function IsGroupCaptionTarget(const APoint: TPoint;
      var AGroup: TdxNavBarGroup; var ARect: TRect): Boolean; virtual;
    function IsTargetGroupVerticalLayout(const ATargetPoint: TPoint)
      : Boolean; virtual;
  ...
  TdxCustomNavBar = class(TcxControl, IcxDesignSelectionChanged,
    IdxNavigationClient, IdxFluentDesignNavigationControl,
  ...
  private
    ...
    FNavigationControlListeners
      : TList<IdxFluentDesignNavigationControlListener>;
    FPainter: TdxNavBarPainter;
    ...
    function GetGroupContainerIAccessibilityHelper
    ...
    function GetOnNavigationPanePopupShowing
      : TdxNavBarNavigationPaneShowingPopupEvent;
    ...
    procedure SetOnNavigationPanePopupShowing(const Value
      : TdxNavBarNavigationPaneShowingPopupEvent);

    function AllowActivateGroup(AValue: TdxNavBarGroup): Boolean;
    function CanScrollBarShow: Boolean;
    function GetSuitableForActivatingGroup(AAllowedOnly: Boolean)
      : TdxNavBarGroup;
    ...
    procedure SetNavigationPaneOverflowPanelUseSmallImages
      (const Value: Boolean);
    ...
    function GetOnCustomDrawGroupClientBackground
      : TdxNavBarCustomDrawGroupEvent;
    function GetOnCustomDrawGroupClientForeground
      : TdxNavBarCustomDrawGroupEvent;
    ...
    function GetOnCustomDrawNavigationPaneOverflowPanel
      : TdxNavBarCustomDrawEvent;
    function GetOnCustomDrawNavigationPaneOverflowPanelHint
    ...
    procedure SetOnCustomDrawBottomScrollButton(const Value
      : TdxNavBarCustomDrawEvent);
    procedure SetOnCustomDrawGroupCaption(const Value
      : TdxNavBarCustomDrawGroupEvent);
    procedure SetOnCustomDrawGroupClientBackground
      (const Value: TdxNavBarCustomDrawGroupEvent);
    procedure SetOnCustomDrawGroupClientForeground
      (const Value: TdxNavBarCustomDrawGroupEvent);
    procedure SetOnCustomDrawGroupHint(const Value
      : TdxNavBarCustomDrawGroupHintEvent);
    procedure SetOnCustomDrawLink(const Value: TdxNavBarCustomDrawLinkEvent);
    procedure SetOnCustomDrawLinkHint(const Value
      : TdxNavBarCustomDrawLinkHintEvent);
    procedure SetOnCustomDrawNavigationPaneHeader
      (const Value: TdxNavBarCustomDrawEvent);
    procedure SetOnCustomDrawNavigationPaneOverflowPanel
      (const Value: TdxNavBarCustomDrawEvent);
    procedure SetOnCustomDrawNavigationPaneOverflowPanelHint
      (const Value: TdxNavBarCustomDrawGroupHintEvent);
    procedure SetOnCustomDrawNavigationPaneSplitter
      (const Value: TdxNavBarCustomDrawEvent);
    procedure SetOnCustomDrawTopScrollButton(const Value
      : TdxNavBarCustomDrawEvent);
    ...
    procedure SetNavBarCustomStyle(Index: Integer;
      const Value: TdxNavBarStyleItem);
    ...
    // Notifications
    procedure OnGroupsChanged(Sender: TObject;
  ...
  strict protected
    procedure InternalDoLinkHotTrack(ANavBar: TdxCustomNavBar;
      ALink: TdxNavBarItemLink); virtual;
    procedure DoMouseDown(AButton: TMouseButton; AShift: TShiftState;
      const APoint: TPoint); virtual;
    procedure DoMouseMove(AShift: TShiftState; const APoint: TPoint); virtual;
  protected
    ...
    function GetActualGroupViewInfoByGroup(AGroup: TdxNavBarGroup)
      : TdxNavBarGroupViewInfo; virtual;
    function GetActualLinkViewInfoByLink(ALink: TdxNavBarItemLink)
      : TdxNavBarLinkViewInfo; virtual;
    ...
    procedure DoCustomDrawGroupClientBackground(Sender: TObject;
      ACanvas: TCanvas; AViewInfo: TdxNavBarGroupViewInfo;
      var AHandled: Boolean); virtual;
    procedure DoCustomDrawGroupClientForeground(Sender: TObject;
      ACanvas: TCanvas; AViewInfo: TdxNavBarGroupViewInfo;
      var AHandled: Boolean); virtual;
    procedure DoCustomDrawGroupHint(Sender: TObject; ACanvas: TCanvas;
      AGroup: TdxNavBarGroup; AHint: string; R: TRect;
      var AHandled: Boolean); virtual;
  protected
    ...
    function IdxNavigationClient.GetSelectedItem =
      GetNavigationClientSelectedItem;
    procedure IdxNavigationClient.SetSelectedItem =
      SetNavigationClientSelectedItem;
    procedure IdxNavigationClient.AddListener = AddNavigationClientListener;
    procedure IdxNavigationClient.RemoveListener =
      RemoveNavigationClientListener;

    // IdxFluentDesignNavigationControl
    function IdxFluentDesignNavigationControl.IsAdaptable =
      FluentDesignNavigationControlIsAdaptable;
    function IdxFluentDesignNavigationControl.IsCollapsed =
      FluentDesignNavigationControlIsCollapsed;
    function IdxFluentDesignNavigationControl.GetAcrylicEnabled =
      FluentDesignNavigationControlGetAcrylicEnabled;
    function IdxFluentDesignNavigationControl.GetBackgroundColor =
      FluentDesignNavigationControlGetBackgroundColor;
    function IdxFluentDesignNavigationControl.GetBorderColor =
      FluentDesignNavigationControlGetBorderColor;
    function IdxFluentDesignNavigationControl.GetDisplayMode =
      FluentDesignNavigationControlGetDisplayMode;
    function IdxFluentDesignNavigationControl.GetForegroundColor =
      FluentDesignNavigationControlGetForegroundColor;
    procedure IdxFluentDesignNavigationControl.SetDisplayMode =
      FluentDesignNavigationControlSetDisplayMode;
    procedure IdxFluentDesignNavigationControl.AddListener =
      FluentDesignNavigationControlAddListener;
    procedure IdxFluentDesignNavigationControl.RemoveListener =
      FluentDesignNavigationControlRemoveListener;
    ...
    function FluentDesignNavigationControlGetDisplayMode
      : TdxFluentDesignNavigationControlDisplayMode;
    function FluentDesignNavigationControlGetForegroundColor: TColor;
    procedure FluentDesignNavigationControlAddListener
      (AListener: IdxFluentDesignNavigationControlListener);
    procedure FluentDesignNavigationControlRemoveListener
      (AListener: IdxFluentDesignNavigationControlListener);
    procedure FluentDesignNavigationControlSetDisplayMode
      (AValue: TdxFluentDesignNavigationControlDisplayMode);

    // IdxAcrylicHostControlListener
    procedure IdxAcrylicHostControlListener.Changed = AcrylicHostControlChanged;
    procedure AcrylicHostControlChanged(AValue: IdxAcrylicHostControl;
      AHasAcrylicParent: Boolean);

    function GetAcrylicAlphaValue: Byte;
    function GetAcrylicBackgroundColor: TdxAlphaColor;
    function GetAcrylicHostColor: TdxAlphaColor;
    function IsAcrylicEnabled: Boolean;
    procedure NotifyNavigationControlListeners
    ...
    procedure AddNavigationClientListener
    ...
    procedure RemoveNavigationClientListener
      (AListener: IdxNavigationClientListener);
    ...
    procedure DoActiveGroupChanging(ANewGroup: TdxNavBarGroup;
      var AAllowChange: Boolean); virtual;
    ...
    procedure DoGroupDragOver(Group: TdxNavBarGroup;
    ...
    procedure DoLinkDragOver(Link: TdxNavBarItemLink;
      var Accept: Boolean); virtual;
    ...
    procedure InvalidateScrollButtons;
    // Load/Save layout
    procedure LoadFromRegIni(AStorage: TCustomIniFile;
      LoadStyles: Boolean); virtual;
    procedure SaveToRegIni(AStorage: TCustomIniFile;
      SaveStyles: Boolean); virtual;

    function CreatePainter: TdxNavBarPainter; virtual;
    function GetAccessibilityHelperClass
      : TdxNavBarCustomAccessibilityHelperClass; virtual;
    function GetGroupContainerAccessibilityHelperClass
      : TdxNavBarCustomAccessibilityHelperClass; virtual;
    ...
    procedure DrawContentWithChildren(ACanvas: TcxCanvas; const AOrigin: TPoint;
    ...
    property FocusedAccessibleObject: IdxNavBarAccessibilityHelper
      read FFocusedAccessibleObject write SetFocusedAccessibleObject;
    property UpdateLock: Integer read FUpdateLock;

    property ActiveGroupScrollBar: TdxNavBarScrollBar
      read FActiveGroupScrollBar;
    property ActiveGroupScrollBarPosition: Integer
      read GetActiveGroupScrollBarPosition;
    property ExpandAnimationController: TdxNavBarInlineExpandAnimationController
      read FExpandAnimationController;
    ...
    property OnCollapseStateChanged: TNotifyEvent read FOnCollapseStateChanged
      write FOnCollapseStateChanged;
    property OnGetOverlaySize: TdxNavBarGetOverlaySizeEvent
      read FOnGetOverlaySize write FOnGetOverlaySize;
    property OnNavigationPanePopupShowed: TNotifyEvent
      read GetOnNavigationPanePopupShowed write SetOnNavigationPanePopupShowed;
    property OnNavigationPanePopupShowing
      : TdxNavBarNavigationPaneShowingPopupEvent
      read GetOnNavigationPanePopupShowing
      write SetOnNavigationPanePopupShowing;
    property OnOverlayShowing: TdxNavBarShowingPopupEvent read FOnOverlayShowing
      write FOnOverlayShowing;
    property OnPopupShowed: TNotifyEvent read FOnPopupShowed
      write FOnPopupShowed;
    property OnPopupShowing: TdxNavBarShowingPopupEvent read FOnPopupShowing
      write FOnPopupShowing;
  public
    ...
    property IAccessibilityHelper: IdxNavBarAccessibilityHelper
      read GetIAccessibilityHelper; // for internal use
    property GroupContainerIAccessibilityHelper: IdxNavBarAccessibilityHelper
      read GetGroupContainerIAccessibilityHelper; // for internal use
    ...
    property NavigationPaneOverflowPanelItemCount: Integer
      read GetNavigationPaneOverflowPanelItemCount;
    ...
    property ActiveGroupIndex: Integer read GetActiveGroupIndex
      write SetActiveGroupIndex;
    property ActiveGroup: TdxNavBarGroup read GetActiveGroup
      write SetActiveGroup;
    ...
    property DragCopyCursor: TCursor read GetDragCopyCursor
      write SetDragCopyCursor;
    property HotTrackedGroupCursor: TCursor read GetHotTrackedGroupCursor
      write SetHotTrackedGroupCursor;
    property HotTrackedLinkCursor: TCursor read GetHotTrackedLinkCursor
      write SetHotTrackedLinkCursor;

    // ViewStyle
    property LookAndFeelSchemes: TdxNavBarLookAndFeelSchemes
      read FLookAndFeelSchemes write SetLookAndFeelSchemes;
    property View: Integer read FView write SetView stored IsViewStored;
    property ViewReal: Integer read FViewReal write SetViewReal
      stored IsViewRealStored;
    property ViewStyle: TdxNavBarPainter read GetViewStyle write SetViewStyle;

    // OptionsImage
    property OptionsImage: TdxNavBarImageOptions read FOptionsImage
      write SetOptionsImage;
    ...
    // OptionsStyle
    property OptionsStyle: TdxNavBarStyleOptions read FOptionsStyle
      write SetOptionsStyle;
    property DefaultStyles: TdxNavBarDefaultStyles read GetDefaultStyles
      write SetDefaultStyles;
    property Styles: TdxNavBarStyleRepository read GetStyles;
    property StyleBackground: TdxNavBarStyleItem index 0
      read GetNavBarCustomStyle write SetNavBarCustomStyle;
    property StyleHint: TdxNavBarStyleItem index 1 read GetNavBarCustomStyle
      write SetNavBarCustomStyle;
    property StyleDropTargetGroup: TdxNavBarStyleItem index 2
      read GetNavBarCustomStyle write SetNavBarCustomStyle;
    property StyleDropTargetLink: TdxNavBarStyleItem index 3
      read GetNavBarCustomStyle write SetNavBarCustomStyle;
    property StyleButton: TdxNavBarStyleItem index 4 read GetNavBarCustomStyle
      write SetNavBarCustomStyle;
    property StyleButtonHotTracked: TdxNavBarStyleItem index 5
      read GetNavBarCustomStyle write SetNavBarCustomStyle;
    property StyleButtonPressed: TdxNavBarStyleItem index 6
      read GetNavBarCustomStyle write SetNavBarCustomStyle;
    property StyleNavigationPaneHeader: TdxNavBarStyleItem index 7
      read GetNavBarCustomStyle write SetNavBarCustomStyle;

    // Options
    property OptionsView: TdxNavBarViewOptions read FOptionsView
      write SetOptionsView;
    property OptionsBehavior: TdxNavBarBehaviorOptions read FOptionsBehavior
      write SetOptionsBehavior;
    // Common
    property DragDropFlags: TdxNavBarDragDropFlags read GetDragDropFlags
      write SetDragDropFlags;
    property ShowGroupsHint: Boolean read GetShowGroupsHint
      write SetShowGroupsHint;
    property ShowLinksHint: Boolean read GetShowLinksHint
      write SetShowLinksHint;
    property ShowGroupCaptions: Boolean read GetShowGroupCaptions
      write SetShowGroupCaptions;
    // ExplorerStyle
    property ShowSpecialGroup: Boolean read GetShowSpecialGroup
      write SetShowSpecialGroup;
    property SpaceBetweenGroups: Integer read GetSpaceBetweenGroups
      write SetSpaceBetweenGroups;
    // NavigationStyle
    property AllowSelectLinks: Boolean read GetAllowSelectLinks
      write SetAllowSelectLinks;
    property EachGroupHasSelectedLink: Boolean read GetEachGroupHasSelectedLink
      write SetEachGroupHasSelectedLink;
    // NavigationPane
    property NavigationPaneMaxVisibleGroups: Integer
      read GetNavigationPaneMaxVisibleGroups
      write SetNavigationPaneMaxVisibleGroups;
    property NavigationPaneOverflowPanelUseSmallImages: Boolean
      read GetNavigationPaneOverflowPanelUseSmallImages
      write SetNavigationPaneOverflowPanelUseSmallImages;
    property ShowNavigationPaneOverflowPanelHints: Boolean
      read GetShowNavigationPaneOverflowPanelHints
      write SetShowNavigationPaneOverflowPanelHints;

    property OnActiveGroupChanged: TNotifyEvent read FOnActiveGroupChanged
      write FOnActiveGroupChanged;
    property OnActiveGroupChanging: TdxNavBarGroupChangingEvent
      read FOnActiveGroupChanging write FOnActiveGroupChanging;
    property OnCalcGroupClientHeight: TdxNavBarCalcGroupClientHeightEvent
      read FOnCalcGroupClientHeight write FOnCalcGroupClientHeight;
    property OnCalcGroupHintRect: TdxNavBarCalcGroupHintRectEvent
      read FOnCalcGroupHintRect write FOnCalcGroupHintRect;
    property OnCalcLinkHintRect: TdxNavBarCalcLinkHintRectEvent
      read FOnCalcLinkHintRect write FOnCalcLinkHintRect;
    property OnCalcNavigationPaneOverflowPanelHintRect
      : TdxNavBarCalcGroupHintRectEvent
      read FOnCalcNavigationPaneOverflowPanelHintRect
      write FOnCalcNavigationPaneOverflowPanelHintRect;

    property OnCustomDraw: TdxNavBarCustomDrawEvents read FOnCustomDraw
      write SetOnCustomDraw;
    property OnCustomDrawBackground: TdxNavBarCustomDrawEvent
      read GetOnCustomDrawBackground write SetOnCustomDrawBackground;
    property OnCustomDrawGroupCaption: TdxNavBarCustomDrawGroupEvent
      read GetOnCustomDrawGroupCaption write SetOnCustomDrawGroupCaption;
    property OnCustomDrawGroupClientBackground: TdxNavBarCustomDrawGroupEvent
      read GetOnCustomDrawGroupClientBackground
      write SetOnCustomDrawGroupClientBackground;
    property OnCustomDrawGroupClientForeground: TdxNavBarCustomDrawGroupEvent
      read GetOnCustomDrawGroupClientForeground
      write SetOnCustomDrawGroupClientForeground;
    property OnCustomDrawGroupHint: TdxNavBarCustomDrawGroupHintEvent
      read GetOnCustomDrawGroupHint write SetOnCustomDrawGroupHint;
    property OnCustomDrawLink: TdxNavBarCustomDrawLinkEvent
      read GetOnCustomDrawLink write SetOnCustomDrawLink;
    property OnCustomDrawLinkHint: TdxNavBarCustomDrawLinkHintEvent
      read GetOnCustomDrawLinkHint write SetOnCustomDrawLinkHint;
    property OnCustomDrawBottomScrollButton: TdxNavBarCustomDrawEvent
      read GetOnCustomDrawBottomScrollButton
      write SetOnCustomDrawBottomScrollButton;
    property OnCustomDrawTopScrollButton: TdxNavBarCustomDrawEvent
      read GetOnCustomDrawTopScrollButton write SetOnCustomDrawTopScrollButton;
    property OnCustomDrawNavigationPaneHeader: TdxNavBarCustomDrawEvent
      read GetOnCustomDrawNavigationPaneHeader
      write SetOnCustomDrawNavigationPaneHeader;
    property OnCustomDrawNavigationPaneSplitter: TdxNavBarCustomDrawEvent
      read GetOnCustomDrawNavigationPaneSplitter
      write SetOnCustomDrawNavigationPaneSplitter;
    property OnCustomDrawNavigationPaneOverflowPanel: TdxNavBarCustomDrawEvent
      read GetOnCustomDrawNavigationPaneOverflowPanel
      write SetOnCustomDrawNavigationPaneOverflowPanel;
    property OnCustomDrawNavigationPaneOverflowPanelHint
      : TdxNavBarCustomDrawGroupHintEvent
      read GetOnCustomDrawNavigationPaneOverflowPanelHint
      write SetOnCustomDrawNavigationPaneOverflowPanelHint;

    property OnNavigationPaneCollapsed: TNotifyEvent
      read GetOnNavigationPaneCollapsed write SetOnNavigationPaneCollapsed;
    property OnNavigationPaneExpanded: TNotifyEvent
      read GetOnNavigationPaneExpanded write SetOnNavigationPaneExpanded;

    property OnGetGroupHint: TdxNavBarGetGroupHintEvent read FOnGetGroupHint
      write FOnGetGroupHint;
    property OnGetLinkHint: TdxNavBarGetLinkHintEvent read FOnGetLinkHint
      write FOnGetLinkHint;
    property OnGroupClick: TdxNavBarGroupEvent read FOnGroupClick
      write FOnGroupClick;
    property OnGroupHotTrack: TdxNavBarGroupEvent read FOnGroupHotTrack
      write FOnGroupHotTrack;
    property OnGroupPress: TdxNavBarGroupEvent read FOnGroupPress
      write FOnGroupPress;
    property OnLinkClick: TdxNavBarLinkEvent read FOnLinkClick
      write FOnLinkClick;
    property OnLinkHotTrack: TdxNavBarLinkEvent read FOnLinkHotTrack
      write FOnLinkHotTrack;
    property OnLinkPress: TdxNavBarLinkEvent read FOnLinkPress
      write FOnLinkPress;
  published
    property Align;
    property Anchors;
  ...
  TdxNavBarScrollAnimationHelper = class(TdxScrollAnimationHelper)
  // for internal use
  strict private
  ...
  protected
    ...
    procedure DoSetScrollParams(AMin, AMax, APosition, APageSize: Integer;
      ARedraw: Boolean = True); virtual;
    ...
    procedure Scroll(Sender: TObject; AScrollCode: TScrollCode;
  ...
  public
    ...
    destructor Destroy; override;
    procedure SetScrollParams(AMin, AMax, APosition, APageSize: Integer;
  ...
  published
    ...
    property CustomDrawEvents: TNotifyEvent read FCustomDrawEvents
      write FCustomDrawEvents;
  ...
  protected
    ...
    procedure BeginResize(AControl: TControl; AButton: TMouseButton;
      AShift: TShiftState; const APoint: TPoint); virtual;
    ...
    property PopupViewInfo: TdxNavBarCustomPopupControlViewInfo
      read FPopupViewInfo;
  public
  ...
  strict protected
    procedure AssignGroupProperties(ASource, ADestination
      : TdxNavBarGroup); virtual;
    ...
    procedure SynchronizeGroupChildren(ASourceGroup, ADestinationGroup
      : TdxNavBarGroup);
  ...
  public
    ...
    property GroupMapping: TDictionary<TdxNavBarGroup, TdxNavBarGroup>
      read FGroupMapping;
    property MasterGroupMapping: TDictionary<TdxNavBarGroup, TdxNavBarGroup>
      read FMasterGroupMapping;
    property MasterItemLinkMapping
      : TDictionary<TdxNavBarItemLink, TdxNavBarItemLink>
      read FMasterItemLinkMapping;
  end;
  ...
  private
    ...
    function GetMasterItemLinkMapping
      : TDictionary<TdxNavBarItemLink, TdxNavBarItemLink>;
    procedure WMNCHitTest(var Message: TWMNCHitTest); message WM_NCHITTEST;
  strict protected
    ...
    procedure InternalDoLinkHotTrack(ANavBar: TdxCustomNavBar;
      ALink: TdxNavBarItemLink); override;
    procedure DoLinkClick(ANavBar: TdxCustomNavBar;
      ALink: TdxNavBarItemLink); override;
    procedure DoLinkPress(ANavBar: TdxCustomNavBar;
      ALink: TdxNavBarItemLink); override;
  ...
  protected
    ...
    property GroupMapping: TDictionary<TdxNavBarGroup, TdxNavBarGroup>
      read GetGroupMapping;
    property Master: TdxCustomNavBar read FMaster;
  protected
    function GetActualGroup(AGroup: TdxNavBarGroup): TdxNavBarGroup; override;
    function GetActualGroupViewInfoByGroup(AGroup: TdxNavBarGroup)
      : TdxNavBarGroupViewInfo; override;
    function GetActualLinkViewInfoByLink(ALink: TdxNavBarItemLink)
      : TdxNavBarLinkViewInfo; override;

    procedure UpdateData;
    procedure UpdateOriginalData;

    property MasterGroupMapping: TDictionary<TdxNavBarGroup, TdxNavBarGroup>
      read GetMasterGroupMapping;
    property MasterItemLinkMapping
      : TDictionary<TdxNavBarItemLink, TdxNavBarItemLink>
      read GetMasterItemLinkMapping;
  public
    constructor Create(APopupControl: TdxNavBarCustomPopupControl);
      reintroduce; virtual;
    destructor Destroy; override;
  ...
  TdxNavBarActiveGroupInnerControl = class(TdxNavBarPopupInnerControl)
  // for internal use
  strict private
    function ProcessMouseDown(AButton: TMouseButton;
      const APoint: TPoint): Boolean;
  protected
    function GetMapperClass: TdxNavBarCloneMapperClass; override;
    procedure DoMouseDown(AButton: TMouseButton; AShift: TShiftState;
      const APoint: TPoint); override;
  ...
  public
    class function CalculateBounds(AViewInfo: TdxNavBarViewInfo;
      AGroupViewInfoClass: TdxNavBarGroupViewInfoClass; AClientWidth: Integer;
      const ABorderOffsets: TRect): TRect; overload;
    class function CalculateBounds(AViewInfo: TdxNavBarViewInfo;
      AClientWidth: Integer; const ABorderOffsets: TRect): TRect; overload;
    class function CalculateClientRect(const ARect, ABorderOffsets: TRect)
      : TRect; static;
    class function CalculateMaxHeight(AViewInfo: TdxNavBarViewInfo)
      : Integer; static;
    class function CalculatePosition(AViewInfo: TdxNavBarViewInfo;
      const ARect: TRect): TPoint; static;
  end;
...
function dxNavBarPart(AMajorPartIndex: Integer;
  AMinorPartIndex: Integer = nbNone): TdxNavBarPart;
function IsdxNavBarPartsEqual(const APart1, APart2: TdxNavBarPart): Boolean;

procedure dxNavBarRegisterCustomizationFormClass
  (AClass: TdxNavBarCustomCustomizationFormClass);
procedure dxNavBarUnregisterCustomizationFormClass
  (AClass: TdxNavBarCustomCustomizationFormClass);
...
type
  ...
  public
    ...
    function GetDefaultCustomizationFormClass
      : TdxNavBarCustomCustomizationFormClass;
...
function IsdxNavBarPartsEqual(const APart1, APart2: TdxNavBarPart): Boolean;
begin
  Result := (APart1.MajorPartIndex = APart2.MajorPartIndex) and
    (APart1.MinorPartIndex = APart2.MinorPartIndex);
end;
...
begin
  ...
  FMasterItemLinkMapping :=
    TDictionary<TdxNavBarItemLink, TdxNavBarItemLink>.Create;
end;
...
procedure TdxNavBarCloneMapper.AssignGroupProperties(ASource,
  ADestination: TdxNavBarGroup);
var
...
begin
  ...
  ADestinationGroup.VisibleForCustomization :=
    ASourceGroup.VisibleForCustomization;
  ...
  ADestinationGroup.OnTopVisibleLinkChanged :=
    ASourceGroup.OnTopVisibleLinkChanged;
...
procedure TdxNavBarCloneMapper.CloneGroupChildren(ASource,
  ADestination: TdxNavBarGroup);
var
  I: Integer;
...
begin
  ...
  for I := 0 to ASource.ChildCount - 1 do
    ...
    else if ASource.Children[I] is TdxNavBarItemLink then
    begin
      ASourceLink := TdxNavBarItemLink(ASource.Children[I]);
      ADestinationLink := ADestination.CreateLink
        (NavBar.Items[ASourceLink.Item.Index]);
      ADestinationLink.Data := TdxNativeInt(ASourceLink);
      FMasterItemLinkMapping.Add(ASourceLink, ADestinationLink);
    end;
end;

procedure TdxNavBarCloneMapper.SynchronizeGroupChildren(ASourceGroup,
  ADestinationGroup: TdxNavBarGroup);
var
  I: Integer;
  ASourceLink, ADestinationLink: TdxNavBarItemLink;
  ASourceChildGroup, ADestinationChildGroup: TdxNavBarGroup;
begin
  for I := 0 to ASourceGroup.ChildCount - 1 do
    ...
    begin
      ...
      ADestinationChildGroup.MoveTo(ADestinationGroup,
        ASourceChildGroup.Position);
      SynchronizeGroupChildren(ASourceChildGroup, ADestinationChildGroup);
    end
    else if ASourceGroup.Children[I] is TdxNavBarItemLink then
    begin
      ...
      if ADestinationLink = nil then
        ADestinationLink := ADestinationGroup.CreateLink
          (FMaster.Items[ASourceLink.Item.Index]);
  ...
  for I := ADestinationGroup.ChildCount - 1 downto ASourceGroup.ChildCount do
    if ADestinationGroup.Children[I] is TdxNavBarItemLink then
      ADestinationGroup.RemoveLink
        (TdxNavBarItemLink(ADestinationGroup.Children[I]))
    else if ADestinationGroup.Children[I] is TdxNavBarGroup then
...
procedure TdxNavBarCloneMapper.AcceptActiveGroupControl(ASource,
  ADestination: TdxNavBarGroup);
...
procedure TdxNavBarControlMapper.AssignGroupProperties(ASource,
  ADestination: TdxNavBarGroup);
begin
...
procedure TdxNavBarControlMapper.CloneGroups;
  ...
  begin
    dxTestCheck(Master.Groups.Count = NavBar.Groups.Count,
      'Master.Groups.Count = NavBar.Groups.Count');
    dxTestCheck(Master.RootGroupCount = NavBar.RootGroupCount,
      'Master.RootGroupCount = NavBar.RootGroupCount');
...
constructor TdxNavBarPopupInnerControl.Create(APopupControl
  : TdxNavBarCustomPopupControl);
begin
...
function TdxNavBarPopupInnerControl.GetActualGroup(AGroup: TdxNavBarGroup)
  : TdxNavBarGroup;
begin
...
function TdxNavBarPopupInnerControl.GetActualGroupViewInfoByGroup
  (AGroup: TdxNavBarGroup): TdxNavBarGroupViewInfo;
begin
  Result := ViewInfo.GetGroupViewInfoByGroup(GetActualGroup(AGroup));
end;

function TdxNavBarPopupInnerControl.GetActualLinkViewInfoByLink
  (ALink: TdxNavBarItemLink): TdxNavBarLinkViewInfo;
var
  ATargetLink: TdxNavBarItemLink;
begin
  Result := nil;
  if FMapper.MasterItemLinkMapping.TryGetValue(ALink, ATargetLink) then
...
function TdxNavBarPopupInnerControl.GetLinkAtPos(const pt: TPoint)
  : TdxNavBarItemLink;
begin
...
procedure TdxNavBarPopupInnerControl.InternalDoLinkHotTrack
  (ANavBar: TdxCustomNavBar; ALink: TdxNavBarItemLink);
begin
  if ALink <> nil then
...
procedure TdxNavBarPopupInnerControl.DoLinkClick(ANavBar: TdxCustomNavBar;
...
begin
  ...
  if AOriginalLink = nil then
    AOriginalLink := AOriginalGroup.Children[ALinkPosition]
      as TdxNavBarItemLink;
  FMaster.DoLinkClick(FMaster, AOriginalLink)
end;

procedure TdxNavBarPopupInnerControl.DoLinkPress(ANavBar: TdxCustomNavBar;
ALink: TdxNavBarItemLink);
begin
  if ALink <> nil then
    ALink := TdxNavBarItemLink(ALink.Data);
...
procedure TdxNavBarPopupInnerControl.DoCustomDrawBackground(Sender: TObject;
ACanvas: TCanvas; AViewInfo: TdxNavBarViewInfo; var AHandled: Boolean);
begin
  FMaster.OnCustomDrawBackground(Self, ACanvas, AViewInfo, AHandled);
end;

procedure TdxNavBarPopupInnerControl.DoCustomDrawGroupCaption(Sender: TObject;
...
procedure TdxNavBarPopupInnerControl.DoCustomDrawGroupClientBackground
  (Sender: TObject; ACanvas: TCanvas; AViewInfo: TdxNavBarGroupViewInfo;
var AHandled: Boolean);
begin
  FMaster.OnCustomDrawGroupClientBackground(FMaster, ACanvas, AViewInfo,
    AHandled);
end;

procedure TdxNavBarPopupInnerControl.DoCustomDrawGroupClientForeground
  (Sender: TObject; ACanvas: TCanvas; AViewInfo: TdxNavBarGroupViewInfo;
var AHandled: Boolean);
begin
  FMaster.OnCustomDrawGroupClientForeground(FMaster, ACanvas, AViewInfo,
    AHandled);
end;

procedure TdxNavBarPopupInnerControl.DoCustomDrawGroupHint(Sender: TObject;
ACanvas: TCanvas; AGroup: TdxNavBarGroup; AHint: string; R: TRect;
var AHandled: Boolean);
var
  AOriginalGroup: TdxNavBarGroup;
begin
  ...
  FMaster.OnCustomDrawGroupHint(FMaster, ACanvas, AOriginalGroup, AHint, R,
    AHandled);
end;

function TdxNavBarPopupInnerControl.GetGroupMapping
  : TDictionary<TdxNavBarGroup, TdxNavBarGroup>;
begin
  Result := FMapper.GroupMapping;
end;

function TdxNavBarPopupInnerControl.GetMasterGroupMapping
  : TDictionary<TdxNavBarGroup, TdxNavBarGroup>;
begin
  Result := FMapper.MasterGroupMapping;
end;

function TdxNavBarPopupInnerControl.GetMasterItemLinkMapping
  : TDictionary<TdxNavBarItemLink, TdxNavBarItemLink>;
begin
...
class function TdxNavBarGroupPopupControlCalculator.CalculateBounds
...
begin
  ...
  try
    ...
    Result := cxRectSetHeight(AActiveGroupViewInfo.Rect,
      cxRectHeight(AActiveGroupViewInfo.Rect) + ABorderOffsets.Top +
      ABorderOffsets.Bottom + AViewInfo.GetGroupEdges.Y * 2);
    Result := cxRectSetWidth(Result, AClientWidth + ABorderOffsets.Left +
      ABorderOffsets.Right + AViewInfo.GetGroupEdges.X * 2);
    AMaxHeight := CalculateMaxHeight(AViewInfo);
    if (AActiveGroupViewInfo.Control <> nil) or
      (cxRectHeight(Result) > AMaxHeight) then
...
class function TdxNavBarGroupPopupControlCalculator.CalculateBounds
  (AViewInfo: TdxNavBarViewInfo; AClientWidth: Integer;
const ABorderOffsets: TRect): TRect;
begin
  Result := CalculateBounds(AViewInfo, AViewInfo.Painter.GetGroupViewInfoClass,
    AClientWidth, ABorderOffsets);
end;

class function TdxNavBarGroupPopupControlCalculator.CalculateClientRect
  (const ARect, ABorderOffsets: TRect): TRect;
begin
  Result := cxRectContent(ARect, ABorderOffsets);
end;

class function TdxNavBarGroupPopupControlCalculator.CalculateMaxHeight
  (AViewInfo: TdxNavBarViewInfo): Integer;
begin
  Result := AViewInfo.NavBar.ClientHeight - AViewInfo.GetHeaderHeight * 2;
end;

class function TdxNavBarGroupPopupControlCalculator.CalculatePosition
  (AViewInfo: TdxNavBarViewInfo; const ARect: TRect): TPoint;
var
  P: TPoint;
begin
...
begin
  ...
  if NavBar.Groups.Count > 0 then
    NavBar.TabStop := Master.TabStop and
      not(NavBar.Groups[0].UseControl and NavBar.Groups[0].ShowControl);
end;
...
constructor TdxNavBarActiveGroupInnerControl.Create(APopupControl
  : TdxNavBarCustomPopupControl);
begin
  inherited Create(APopupControl);
...
function TdxNavBarActiveGroupInnerControl.GetMapperClass
  : TdxNavBarCloneMapperClass;
begin
  Result := TdxNavBarActiveGroupMapper;
end;

procedure TdxNavBarActiveGroupInnerControl.DoMouseDown(AButton: TMouseButton;
...
procedure TdxNavBarActiveGroupInnerControl.DoMouseMove(AShift: TShiftState;
const APoint: TPoint);
begin
...
function TdxNavBarActiveGroupInnerControl.ProcessMouseDown
  (AButton: TMouseButton; const APoint: TPoint): Boolean;
begin
  Result := ViewInfo.IsPtSizeGrip(APoint);
  if Result then
    (Parent as TdxNavBarCustomPopupControl).BeginResize(Self, AButton,
      [], APoint)
end;
...
function TdxNavBarCustomizeFormManager.GetDefaultCustomizationFormClass
  : TdxNavBarCustomCustomizationFormClass;
begin
  Result := TdxNavBarCustomCustomizationFormClass(FList.Last);
end;

procedure TdxNavBarCustomizeFormManager.Register
  (AClass: TdxNavBarCustomCustomizationFormClass);
begin
  FList.Add(AClass);
end;

procedure TdxNavBarCustomizeFormManager.Unregister
  (AClass: TdxNavBarCustomCustomizationFormClass);
begin
  FList.Remove(AClass);
end;
...
begin
  ...
  begin
    ...
    NavigationPaneOverflowPanelHint :=
      ASourceEvents.NavigationPaneOverflowPanelHint;
...
procedure TdxNavBarCustomCustomizationForm.CreateParams
...
begin
  ...
  begin
    ...
    else if (NavBar <> nil) and not NavBar.IsDestroying then
...
procedure TdxNavBarCustomCustomizationForm.CreateLink(AItem: TdxNavBarItem;
AGroup: TdxNavBarGroup; AIndex: Integer);
begin
  AGroup.InsertLink(AItem, AIndex);
end;

procedure TdxNavBarCustomCustomizationForm.MoveLink(ALink: TdxNavBarItemLink;
AGroup: TdxNavBarGroup; AIndex: Integer);
begin
...
procedure TdxNavBarCustomCustomizationForm.CalculateDropInfo(var ADropTargetInfo
  : TdxNavBarDropTargetInfo);
begin
  // do nothing
end;

function TdxNavBarCustomCustomizationForm.CanProcessDropItem(Target: TObject;
X, Y: Integer): Boolean;
begin
  Result := False;
end;

procedure TdxNavBarCustomCustomizationForm.DoProcessDropItem(Target: TObject;
X, Y: Integer);
begin
  // do nothing
end;
...
procedure TdxNavBarCustomCustomizationForm.ProcessDropItem(Target: TObject;
X, Y: Integer);
begin
...
function TdxNavBarCustomization.GetFormClass
  : TdxNavBarCustomCustomizationFormClass;
begin
  Result := dxNavBarCustomizeFormManager.GetDefaultCustomizationFormClass;
end;

function TdxNavBarCustomization.IsDropTargetControl
  (AControl: TWinControl): Boolean;
begin
...
begin
  ...
  if ViewInfo.IsBottomScrollButtonVisible then
    Windows.InvalidateRect(NavBar.Handle,
      @ViewInfo.BottomScrollButtonRect, True);
end;
...
function TdxNavBarPainter.CreateChildGroupViewInfo(AViewInfo: TdxNavBarViewInfo;
AParentInfo: TdxNavBarGroupViewInfo; AGroup: TdxNavBarGroup;
ACaptionVisible, AItemsVisible: Boolean): TdxNavBarChildGroupViewInfo;
begin
  Result := GetChildGroupViewInfoClass.Create(AViewInfo, AParentInfo, AGroup,
    ACaptionVisible, AItemsVisible);
end;

function TdxNavBarPainter.CreateGroupViewInfo(AViewInfo: TdxNavBarViewInfo;
AGroup: TdxNavBarGroup; ACaptionVisible, AItemsVisible: Boolean)
  : TdxNavBarGroupViewInfo;
begin
  Result := GetGroupViewInfoClass.Create(AViewInfo, AGroup, ACaptionVisible,
    AItemsVisible)
end;

function TdxNavBarPainter.CreateLinkViewInfo(AViewInfo: TdxNavBarGroupViewInfo;
ALink: TdxNavBarItemLink; ACaptionVisible, AImageVisible: Boolean)
  : TdxNavBarLinkViewInfo;
begin
  Result := GetLinkViewInfoClass.Create(AViewInfo, ALink, ACaptionVisible,
    AImageVisible);
end;

class function TdxNavBarPainter.GetDropInfoCalculatorClass
  : TdxNavBarDropInfoCalculatorClass;
begin
...
class function TdxNavBarPainter.GetHeaderPanelViewInfoClass
  : TdxNavBarHeaderPanelViewInfoClass;
begin
  Result := TdxNavBarHeaderPanelViewInfo;
end;

class function TdxNavBarPainter.GetChildGroupViewInfoClass
  : TdxNavBarChildGroupViewInfoClass;
begin
  Result := TdxNavBarChildGroupViewInfo;
end;

class function TdxNavBarPainter.GetGroupViewInfoClass
  : TdxNavBarGroupViewInfoClass;
begin
  Result := TdxNavBarGroupViewInfo;
end;

class function TdxNavBarPainter.GetLinkViewInfoClass
  : TdxNavBarLinkViewInfoClass;
begin
...
function TdxNavBarPainter.CreatecxScrollBarHelper(AOwner: TdxNavBarScrollBar)
  : TcxControlScrollBarHelper;
begin
  Result := GetcxScrollBarHelperClass.Create(AOwner);
end;

function TdxNavBarPainter.GetcxScrollBarHelperClass
  : TcxControlScrollBarHelperClass;
begin
...
procedure TdxNavBarPainter.UpdateScrollBarLookAndFeel
...
procedure TdxNavBarPainter.DrawVerticalText(AFont: TFont; const AText: string;
const ARect: TRect; AColor: TColor; AAngle: TcxRotationAngle);
var
  AFlags: Cardinal;
begin
  cxCanvas.Font := AFont;
  AFlags := DT_CENTER or DT_VCENTER or DT_SINGLELINE or
    NavBar.DrawTextBiDiModeFlagsReadingOnly;
...
function TdxNavBarPainter.QueryInterface(const IID: TGUID; out Obj): HResult;
begin
...
begin
  ...
  begin
    ...
    if IsAcrylicEnabled then
      dxDrawTextOnGlass(cxCanvas, AText, R, HeaderDrawEdgeFlag or
        DT_NOPREFIX, True)
    else
...
procedure TdxNavBarPainter.DoDrawSizeGrip(ACanvas: TcxCanvas;
const ARect: TRect);
const
  ASpace = 4;
  ALineCount = 3;
...
begin
  ...
  AStartPoint := cxRectOffset(ARect, -ViewInfo.BorderWidth,
    -ViewInfo.BorderWidth).BottomRight;
  Dec(AStartPoint.Y);
...
begin
  ...
  begin
    ...
    try
      ...
      DrawFocusLine(ARect.Right - 1, ARect.Top, cxRectHeight(ARect),
        False, ABrush);
      DrawFocusLine(ARect.Left, ARect.Bottom - 1, cxRectWidth(ARect),
        True, ABrush);
    finally
      DeleteObject(ABrush);
    end;
...
procedure TdxNavBarPainter.DrawChildGroupCaption(AChildGroupViewInfo
  : TdxNavBarChildGroupViewInfo);
begin
...
procedure TdxNavBarPainter.DrawChildGroupExpandButton(AChildGroupViewInfo
  : TdxNavBarChildGroupViewInfo);
begin
  GetLookAndFeelPainter.DrawScaledSmallExpandButton(cxCanvas,
    AChildGroupViewInfo.ExpandButtonRect,
    sExpanded in AChildGroupViewInfo.State,
    AChildGroupViewInfo.CaptionFontColor, ScaleFactor);
end;

procedure TdxNavBarPainter.DrawChildGroupSelection(AChildGroupViewInfo
  : TdxNavBarChildGroupViewInfo);
begin
  // do nothing
end;
...
procedure TdxNavBarPainter.DrawGroupHintWindow(ACanvas: TCanvas;
const ARect: TRect);
var
  AHandled: Boolean;
begin
  ...
  if Assigned(NavBar.OnCustomDrawGroupHint) then
    NavBar.DoCustomDrawGroupHint(NavBar, ACanvas, NavBar.HotTrackedGroup,
      ViewInfo.HintText, ARect, AHandled);
  if not AHandled then
    DoDrawHint(ACanvas, ARect);
end;

procedure TdxNavBarPainter.DrawLinkHintWindow(ACanvas: TCanvas;
const ARect: TRect);
var
  AHandled: Boolean;
begin
...
procedure TdxNavBarPainter.DrawGroupBackground(AGroupViewInfo
  : TdxNavBarGroupViewInfo);
begin
  // do nothing
end;

procedure TdxNavBarPainter.DrawGroupBorder(AGroupViewInfo
  : TdxNavBarGroupViewInfo);
begin
  // do nothing
end;

procedure TdxNavBarPainter.DrawGroupCaption(AGroupViewInfo
  : TdxNavBarGroupViewInfo);
begin
...
procedure TdxNavBarPainter.DrawGroupCaptionButton(AGroupViewInfo
  : TdxNavBarGroupViewInfo);
begin
  // do nothing
end;

procedure TdxNavBarPainter.DrawGroupCaptionText(AGroupViewInfo
  : TdxNavBarGroupViewInfo);
begin
  ...
  begin
    ...
    dxDrawTextOnGlass(cxCanvas, AGroupViewInfo.Group.Caption,
      AGroupViewInfo.CaptionTextRect, AGroupViewInfo.GetDrawEdgeFlag, True);
  end
  else
  begin
    Canvas.Font.Color := AGroupViewInfo.CaptionFontColor;
    cxDrawText(Canvas, AGroupViewInfo.Group.Caption,
      AGroupViewInfo.CaptionTextRect, AGroupViewInfo.GetDrawEdgeFlag);
  end;
end;

procedure TdxNavBarPainter.DrawGroupCaptionImage(AGroupViewInfo
  : TdxNavBarGroupViewInfo);
begin
  // do nothing
end;

procedure TdxNavBarPainter.DrawGroupCaptionSign(AGroupViewInfo
  : TdxNavBarGroupViewInfo);
begin
  // do nothing
end;

procedure TdxNavBarPainter.DrawGroupControl(ACanvas: TCanvas; ARect: TRect;
AGroupViewInfo: TdxNavBarGroupViewInfo);
begin
  // do nothing
end;

procedure TdxNavBarPainter.DrawGroupDesignRect(AGroupViewInfo
  : TdxNavBarGroupViewInfo);
begin
  cxDrawDesignRect(cxCanvas, AGroupViewInfo.DesignRect,
    NavBar.DesignerIsSelected(AGroupViewInfo.Group));
end;

procedure TdxNavBarPainter.DrawGroupItems(AGroupViewInfo
  : TdxNavBarGroupViewInfo);
var
  I: Integer;
...
begin
  cxCanvas.SaveClipRegion;
  try
    cxCanvas.SetClipRegion(TcxRegion.Create(AGroupViewInfo.ItemsRect),
      roIntersect);
    ...
    begin
      ...
      else if AGroupViewInfo.FInfos[I] is TdxNavBarChildGroupViewInfo then
      begin
        AChildGroupViewInfo := TdxNavBarChildGroupViewInfo
          (AGroupViewInfo.FInfos[I]);
...
procedure TdxNavBarPainter.DrawGroupFocusRect(AGroupViewInfo
  : TdxNavBarGroupViewInfo);
begin
...
begin
  ...
  begin
    if Assigned(NavBar.OnCustomDraw.LinkSelection) then
      NavBar.OnCustomDraw.LinkSelection(NavBar, Canvas, ALinkViewInfo,
        AHandled);
    if not AHandled then
...
procedure TdxNavBarPainter.DrawItemCaption(ALinkViewInfo
  : TdxNavBarLinkViewInfo);
begin
  ...
  begin
    ...
    if IsAcrylicEnabled then
      dxDrawTextOnGlass(cxCanvas, Item.Caption, CaptionRect, GetDrawEdgeFlag or
        DT_END_ELLIPSIS, True)
    else
      cxDrawText(Canvas, Item.Caption, CaptionRect, GetDrawEdgeFlag or
        DT_END_ELLIPSIS);
  end;
end;

procedure TdxNavBarPainter.DrawItemDesignRect(ALinkViewInfo
  : TdxNavBarLinkViewInfo);
begin
  cxDrawDesignRect(cxCanvas, ALinkViewInfo.DesignRect,
    NavBar.DesignerIsSelected(ALinkViewInfo.Item));
end;

procedure TdxNavBarPainter.DrawItemFocusRect(ALinkViewInfo
  : TdxNavBarLinkViewInfo);
begin
...
procedure TdxNavBarPainter.DrawItemSelection(ALinkViewInfo
  : TdxNavBarLinkViewInfo);
begin
  // do nothing
end;

procedure TdxNavBarPainter.DrawItemsRect(AGroupViewInfo
  : TdxNavBarGroupViewInfo);
var
  AHandled: Boolean;
begin
  ...
  begin
    ...
    if Assigned(NavBar.OnCustomDrawGroupClientBackground) then
      NavBar.DoCustomDrawGroupClientBackground(NavBar, Canvas, AGroupViewInfo,
        AHandled);
    if not AHandled then
    begin
      if not IsAcrylicEnabled then
  ...
  begin
    ...
    if Assigned(NavBar.OnCustomDrawGroupClientForeground) then
      NavBar.DoCustomDrawGroupClientForeground(NavBar, Canvas, AGroupViewInfo,
        AHandled);
    if not AHandled then
...
begin
  ...
  try
    dxRotateSizeGrip(cxPaintCanvas, ARect, clNone, ViewInfo.GetGripSizeCorner,
      DoDrawSizeGrip);
  finally
...
procedure TdxNavBarController.CheckBounds(var ALeft, ATop, AWidth,
  AHeight: Integer);
begin
...
procedure TdxNavBarController.MouseDown(AButton: TMouseButton;
AShift: TShiftState; const APoint: TPoint);
begin
  DoMouseDown(AButton, AShift, APoint);
end;

procedure TdxNavBarController.MouseUp(AButton: TMouseButton;
AShift: TShiftState; const APoint: TPoint);
begin
  DoMouseUp(AButton, AShift, APoint);
end;

procedure TdxNavBarController.MouseMove(AShift: TShiftState;
const APoint: TPoint);
begin
...
function TdxNavBarController.MouseWheel(AShift: TShiftState;
AWheelDelta: Integer; const APoint: TPoint): Boolean;
begin
  Result := DoMouseWheel(AShift, AWheelDelta, APoint);
end;

procedure TdxNavBarController.ShowHint(var AHintInfo: THintInfo;
out ACanShow: Boolean);
begin
...
begin
  Result := not(NavBar.IsPtTopScrollButton(APoint) or
    NavBar.IsPtBottomScrollButton(APoint));
end;
...
begin
  ...
  cxDrawText(cxScreenCanvas.Handle, ViewInfo.HintText, Result,
    DT_CALCRECT or DT_LEFT or DT_NOPREFIX or AFlagsMap[ANavBarItem <> nil]);
...
function TdxNavBarController.GetPartState(const APart: TdxNavBarPart)
  : TdxNavBarPartState;
var
  AIAccessibilityHelpers: IdxNavBarAccessibilityHelper;
begin
  Result := oisNormal;
  if IsdxNavBarPartsEqual(DroppedDownPart, APart) or
    IsdxNavBarPartsEqual(PressedPart, APart) then
    Result := oisPressed
  else if IsdxNavBarPartsEqual(HotPart, APart) and
    IsdxNavBarPartsEqual(PressedPart, dxNavBarPart(nbNone)) then
    Result := oisHot
  else if (APart.MajorPartIndex in [nbHeaderSign, nbOverflowPanelSign,
    nbOverflowPanelItem]) then
  begin
...
procedure TdxNavBarController.DoCheckBounds(var ALeft, ATop, AWidth,
  AHeight: Integer);
begin
  if (AWidth <> FNavBar.Width) and not FNavBar.ExpandAnimationController.Active
  then
    if Collapsed then
    ...
    else if Collapsible and (AWidth < ViewInfo.GetNavBarMinExpandedWidth) then
    begin
      ChangeNavBarCollapseState;
      AWidth := ViewInfo.GetNavBarCollapsedWidth;
    end;
...
procedure TdxNavBarController.DoLinkClick(ANavBar: TdxCustomNavBar;
ALink: TdxNavBarItemLink);
var
  AItem: TdxNavBarItem;
begin
  ...
  if Assigned(AItem.OnClick) then
    AItem.OnClick(AItem)
  else if AItem.Action <> nil then
    AItem.ActionLink.Execute(AItem)
  else if Assigned(ANavBar.OnLinkClick) then
    ANavBar.OnLinkClick(ANavBar, ALink);
end;

procedure TdxNavBarController.DoLinkHotTrack(ANavBar: TdxCustomNavBar;
ALink: TdxNavBarItemLink);
begin
...
procedure TdxNavBarController.DoLinkPress(ANavBar: TdxCustomNavBar;
ALink: TdxNavBarItemLink);
begin
...
procedure TdxNavBarController.DoMouseDown(AButton: TMouseButton;
AShift: TShiftState; const APoint: TPoint);
  ...
  if not IsPopupJustClosed and not IsPressedPartDetermined then
    with FNavBar do
      ...
      begin
        ...
        else if IsPtBottomScrollButton(APoint) then
...
procedure TdxNavBarController.DoMouseUp(AButton: TMouseButton;
AShift: TShiftState; const APoint: TPoint);

  procedure InternalDoMouseUp;
  begin
    if NavBar.IsPtTopScrollButton(NavBar.SourcePoint) or NavBar.ScrollButtonUpIsDown
    then
      NavBar.DoTopScrollButtonUp
    else if NavBar.IsPtBottomScrollButton(NavBar.SourcePoint) or NavBar.ScrollButtonDownIsDown
    then
...
procedure TdxNavBarController.DoMouseMove(AShift: TShiftState;
const APoint: TPoint);
begin
...
function TdxNavBarController.DoMouseWheel(AShift: TShiftState;
AWheelDelta: Integer; const APoint: TPoint): Boolean;
  ...
  begin
    ...
    Result := (AScrollInfo.nPage > 0) and
      (AScrollInfo.nMax >= Integer(AScrollInfo.nPage));
  end;
  ...
  begin
    ...
    if (AControl <> nil) and (AControl <> NavBar) and
      IsScrollBarsPresent(AControl) then
    begin
  ...
  const
    AScrollCodes: array [Boolean, Boolean] of TScrollCode =
      ((scLineUp, scPageUp), (scLineDown, scPageDown));
  var
    AScrollPos: Integer;
  begin
    ...
    begin
      ...
      begin
        ...
        try
          AScrollBar.Scroll(AScrollBar, AScrollCodes[AWheelDelta < 0,
            ssCtrl in AShift], AScrollPos);
        finally
...
begin
  ...
  begin
    ...
    if not Result then
      ...
      else if not(sDisabled in ViewInfo.BottomScrollButtonState) then
        Result := DoScrollDown;
...
function TdxNavBarController.DoScrollDown: Boolean;
  ...
  begin
    ...
    ATopVisibleIndex := Min(AActiveGroup.TopVisibleLinkIndex,
      AActiveGroupViewInfo.Infos.Count - 1);
...
procedure TdxNavBarController.DoShowGroupHint(var AHintInfo: THintInfo;
AGroupViewInfo: TdxNavBarGroupViewInfo);
var
  AGroup: TdxNavBarGroup;
begin
...
procedure TdxNavBarController.DoShowLinkHint(var AHintInfo: THintInfo;
ALinkViewInfo: TdxNavBarLinkViewInfo);
var
  ALink: TdxNavBarItemLink;
begin
...
begin
  NavBar.ActiveGroup.TopVisibleLinkIndex :=
    NavBar.ActiveGroup.TopVisibleLinkIndex + 1;
end;
...
function TdxNavBarController.CreateGroupPopupControl
  : TdxNavBarCustomPopupControl;
begin
...
function TdxNavBarController.GetActualNavBar(AGroup: TdxNavBarGroup)
  : TdxCustomNavBar;
begin
  Result := NavBar;
  if IsPopupControlExists and IsPopupControlVisible and
    TdxNavBarPopupInnerControl(PopupControl.FInnerControl)
    .MasterGroupMapping.ContainsKey(AGroup) then
    Result := PopupControl.FInnerControl;
end;
...
procedure TdxNavBarController.InternalShowPopupControl(AGroup: TdxNavBarGroup;
const ADroppedDownPart: TdxNavBarPart);
begin
...
procedure TdxNavBarController.InternalShowPopupControl(const ADroppedDownPart
  : TdxNavBarPart);
...
begin
  ...
  else if NavBar.IsAlreadyCollapsed then
    SetSpecificWidth(NavBar.OriginalWidth)
  else if Collapsible and (NavBar.Width < ViewInfo.GetNavBarMinExpandedWidth)
  then
...
begin
  Result := (NavBar.SourceGroup <> nil) and
    ((NavBar.SourceGroup = NavBar.HotTrackedGroup) or NavBar.IsDesigning);
end;

function TdxNavBarController.CanDoLinkMouseUp: Boolean;
begin
  Result := (NavBar.SourceLink <> nil) and
    ((NavBar.SourceLink = NavBar.HotTrackedLink) or NavBar.IsDesigning);
end;
...
procedure TdxNavBarController.CalcGroupHintRect(AItem: TObject;
var ARect: TRect);
begin
...
procedure TdxNavBarController.CalcLinkHintRect(AItem: TObject;
var ARect: TRect);
begin
  if Assigned(NavBar.OnCalcLinkHintRect) then
    NavBar.OnCalcLinkHintRect(NavBar, TdxNavBarItemLink(AItem),
      ViewInfo, ARect);
end;
...
begin
  ...
  for ALookAndFeelStyle := Low(TcxLookAndFeelStyle)
    to High(TcxLookAndFeelStyle) do
...
function TdxNavBarLookAndFeelSchemes.GetView
  (Index: TcxLookAndFeelStyle): Integer;
begin
  Result := FViews[Index];
end;
...
procedure TdxNavBarLookAndFeelSchemes.SetView(Index: TcxLookAndFeelStyle;
const Value: Integer);
begin
...
var
  ...
  AOffset: TdxPointF;
begin
  ASize := dxSizeF(StartState.Size.cx + FSizeFactor.cx * APosition,
    StartState.Size.cy + FSizeFactor.cy * APosition);
  AOffset := dxPointF(StartState.Offset.X + FOffsetFactor.X * APosition,
    StartState.Offset.Y + FOffsetFactor.Y * APosition);
  FCurrentAlphaValue := Trunc(StartState.Alpha + FAlphaFactor * APosition);
  FCurrentClipRect := cxRectOffset
    (cxRect(cxSize(Round(ASize.cx), Round(ASize.cy))), cxPoint(AOffset, False));
...
begin
  FSizeFactor := dxSizeF((EndState.Size.cx - StartState.Size.cx) / ALength,
    (EndState.Size.cy - StartState.Size.cy) / ALength);
  FOffsetFactor := dxPointF((EndState.Offset.X - StartState.Offset.X) / ALength,
...
begin
  ...
  try
    ...
    AGpCanvas.Draw(FImage, FCurrentDestBounds, SourceBounds,
      FCurrentAlphaValue);
  finally
...
constructor TdxNavBarCollapseStateAnimationController.Create
  (AControl: TdxCustomNavBar);
begin
  inherited Create;
  FControl := AControl;
...
function TdxNavBarCollapseStateAnimationController.GetAnimationEffect
  : TdxAnimationTransitionEffect;
begin
...
function TdxNavBarCollapseStateAnimationController.GetAnimationEffectMode
  : TdxAnimationTransitionEffectMode;
begin
  Result := atmOut
end;
...
function TdxNavBarCollapseStateAnimationController.GetCollapseAnimationTime
  : Cardinal;
begin
  Result := GetExpandAnimationTime div 2;
end;

procedure TdxNavBarCollapseStateAnimationController.
  ChangeGroupControlsVisibility(AVisible: Boolean);
var
  I: Integer;
begin
...
procedure TdxNavBarCollapseStateAnimationController.CheckState
  (AActive: Boolean);

  procedure CreateTransition(const ASourceRect, ATargetRect: TRect);
  begin
    FAnimationTransition := TdxRectAnimationTransition.Create(ASourceRect,
      ATargetRect, GetAnimationTime, GetAnimationEffect,
      GetAnimationEffectMode);
...
function TdxNavBarCollapseStateAnimationController.GetExpandAnimationTime
  : Cardinal;
begin
  Result := 250;
end;
...
procedure TdxNavBarCollapseStateAnimationController.PrepareAnimationBuffer
  (AControl: TdxCustomNavBar);
begin
  FreeAndNil(FBuffer);
  FBuffer := TcxBitmap32.CreateSize(AControl.ViewInfo.ClientWidth,
    AControl.Height);
  FBuffer.Clear;
...
function TdxNavBarCollapseStateAnimationController.AllowAnimation
  (AIsExpandMode: Boolean): Boolean;
begin
  Result := Control.ViewInfo.UseControlExpandAnimation;
end;

function TdxNavBarCollapseStateAnimationController.
  GetAnimationBufferRect: TRect;
begin
...
function TdxNavBarCollapseStateAnimationController.DrawAnimationBuffer
  (ACanvas: TcxCanvas): Boolean;
begin
  Result := Active;
  if Result then
    cxBitBlt(ACanvas.Handle, FBuffer.cxCanvas.Handle,
      cxRectOffset(GetAnimationBufferRect, GetClientRectOffset),
      cxNullPoint, SRCCOPY);
end;
...
procedure TdxNavBarCollapseStateAnimationController.OnAnimateHandler
...
procedure TdxNavBarCollapseStateAnimationController.OnTerminatedHandler
  (Sender: TObject);
begin
  CheckState(False);
end;
...
procedure TdxNavBarInlineExpandAnimationController.CalculateBounds
  (var ASourceRect, ATargetRect: TRect);
begin
...
procedure TdxNavBarInlineExpandAnimationController.PrepareAnimationBuffer
  (AControl: TdxCustomNavBar);
begin
...
function TdxNavBarGroupAnimationController.AddImage
  : TdxNavBarGroupAnimatedImageInfo;
begin
...
begin
  ALength := 255;
  ATime := 255;
  AAnimation := TdxAnimationTransition.Create(ATime,
    ateAccelerateDecelerate, ALength);
...
procedure TdxNavBarGroupAnimationController.Animate(ACanvas: TCanvas;
const ARect: TRect);
var
...
function TdxNavBarGroupAnimationController.GetImageInfo(AIndex: Integer)
  : TdxNavBarGroupAnimatedImageInfo;
begin
  Result := FImageInfos[AIndex];
end;

function TdxNavBarDragControlObject.GetDragCursor(Accepted: Boolean;
X, Y: Integer): TCursor;
var
...
function TdxNavBarDragControlObject.GetNavBar(AControl: TWinControl)
  : TdxCustomNavBar;
begin
  if AControl is TdxCustomNavBar then
    Result := TdxCustomNavBar(AControl)
  else if (Control is TdxCustomNavBar) and TdxCustomNavBar(Control)
    .Customization.IsDropTargetControl(AControl) then
...
procedure TdxNavBarDropInfoCalculator.Calculate(var ADropTargetInfo
  : TdxNavBarDropTargetInfo);
var
  ATargetPoint: TPoint;
  AGroup: TdxNavBarGroup;
...
begin
  ...
  begin
    if (FNavBar.SourceGroup = nil) and (AGroup.Parent = nil) then
    // source is link and target is root group
    begin
    ...
    begin
      ...
      ADropTargetInfo.Kind := GetDropKind(ATargetPoint, ARect, AForbiddenStates,
        IsTargetGroupVerticalLayout(ATargetPoint));
  ...
  else if IsLinkTarget(ATargetPoint, ALink, ARect) then
  begin
    if (FNavBar.SourceGroup = nil) or FNavBar.OptionsBehavior.Common.AllowChildGroups
    then
    begin
      ADropTargetInfo.Group := ALink.Group;
      ADropTargetInfo.Kind := GetDropKind(ATargetPoint, ARect, [dkInside],
        IsTargetVerticalLayout(ADropTargetInfo.Group));
      case ADropTargetInfo.Kind of
        dkBefore:
  ...
  if (ADropTargetInfo.Group <> nil) and
    (ADropTargetInfo.Group.GetParentComponent = NavBar) then
    CheckDropInfo(ADropTargetInfo);
end;

procedure TdxNavBarDropInfoCalculator.CheckDropInfo(var ADropTargetInfo
  : TdxNavBarDropTargetInfo);
var
...
begin
  ...
  if (ASourceItem = nil) and (ASourceParent = ADropTargetInfo.Group) and
    (ASourcePosition < ADropTargetInfo.Position) then
    Dec(ATargetRealPosition);

  if (ASourceGroup <> nil) and ((ASourceGroup = ADropTargetInfo.Group) or
    ASourceGroup.HasAsChild(ADropTargetInfo.Group) or
    (ASourceGroup.Parent = ADropTargetInfo.Group) and
    (ASourcePosition = ATargetRealPosition)) or (ASourceLink <> nil) and
    (ASourceItem = nil) and (ASourceLink.Group = ADropTargetInfo.Group) and
...
function TdxNavBarDropInfoCalculator.GetDropKind(const APoint: TPoint;
const ARect: TRect; AForbiddenDropKinds: TdxNavBarDropKinds;
AIsVerticalItemLayout: Boolean): TdxNavBarDropKind;
var
...
begin
  ...
  begin
    ...
    ADropKindIndex :=
      EnsureRange(Trunc(ADropKindCount * APosition / (AMaxPosition + 1)), 0,
      ADropKindCount - 1);
...
function TdxNavBarDropInfoCalculator.IsTargetGroupVerticalLayout
  (const ATargetPoint: TPoint): Boolean;
begin
  Result := True;
end;
...
procedure TdxNavBarDropInfoCalculator.SetForbiddenDropInfo(var ADropTargetInfo
  : TdxNavBarDropTargetInfo);
begin
...
procedure TdxNavBarCustomItemViewInfo.OffsetCaptionAndImageRects(dX,
  dY: Integer);
begin
...
constructor TdxNavBarChildCaptionViewInfo.Create(AGroupViewInfo
  : TdxNavBarGroupViewInfo);
begin
...
const
  AFlagMap: array [Boolean] of Integer = (DT_CENTER or DT_WORDBREAK,
    DT_LEFT or DT_VCENTER or DT_SINGLELINE);
begin
  Result := AFlagMap[GroupViewInfo.IsLinksUseSmallImages] or
    NavBar.DrawTextBiDiModeFlagsReadingOnly;
end;
...
constructor TdxNavBarLinkViewInfo.Create(AGroupViewInfo: TdxNavBarGroupViewInfo;
ALink: TdxNavBarItemLink; ACaptionVisible, AImageVisible: Boolean);
begin
...
begin
  TdxNavBarItemAccess(Item).GetCalculatorClass.CalculateBounds(X, Y,
    ScaleFactor, Self);
end;
...
begin
  Result := FCaptionVisible and (FCaptionRect.Left > FRect.Left) and
    (FCaptionRect.Right < FRect.Right);
end;

function TdxNavBarLinkViewInfo.IsImageVisible: Boolean;
begin
  Result := FImageVisible and (FImageRect.Left > FRect.Left) and
    (FImageRect.Right < FRect.Right);
end;
...
begin
  ...
  else if sSelected in State then
    Result := NavBar.DefaultStyles.ItemPressed
  else
...
constructor TdxNavBarGroupViewInfo.Create(AViewInfo: TdxNavBarViewInfo;
AGroup: TdxNavBarGroup; ACaptionVisible, AItemsVisible: Boolean);
begin
...
function TdxNavBarGroupViewInfo.FindLinkWithAccel(AKey: Word)
  : TdxNavBarItemLink;
var
  I: Integer;
begin
...
function TdxNavBarGroupViewInfo.GetGroupViewInfoByGroup(AGroup: TdxNavBarGroup)
  : TdxNavBarGroupViewInfo;
var
  I: Integer;
begin
  ...
  if Group = AGroup then
    ...
    for I := 0 to Infos.Count - 1 do
      ...
      begin
        Result := TdxNavBarGroupViewInfo(Infos[I])
          .GetGroupViewInfoByGroup(AGroup);
        if Result <> nil then
          Break;
      end;
end;

function TdxNavBarGroupViewInfo.GetLinkViewInfoByLink(ALink: TdxNavBarItemLink)
  : TdxNavBarLinkViewInfo;
var
  I: Integer;
begin
...
function TdxNavBarGroupViewInfo.IndexOfLinkViewInfo
  (AViewInfo: TdxNavBarLinkViewInfo): Integer;
begin
...
begin
  if (Group.StyleBackground <> nil) and
    (savImage in Group.StyleBackground.Style.AssignedValues) then
    Result := Group.StyleBackground.Style.Image
  else
    Result := NavBar.DefaultStyles.GroupBackground.Image;
end;

function TdxNavBarGroupViewInfo.BgBackColor: TColor;
begin
  if (Group.StyleBackground <> nil) and
    (savBackColor in Group.StyleBackground.Style.AssignedValues) then
    Result := Group.StyleBackground.Style.BackColor
  else
    Result := NavBar.DefaultStyles.GroupBackground.BackColor;
end;

function TdxNavBarGroupViewInfo.BgBackColor2: TColor;
begin
  if (Group.StyleBackground <> nil) and
    (savBackColor2 in Group.StyleBackground.Style.AssignedValues) then
    Result := Group.StyleBackground.Style.BackColor2
  else
    Result := NavBar.DefaultStyles.GroupBackground.BackColor2;
end;

function TdxNavBarGroupViewInfo.BgAlphaBlend: Byte;
begin
  if (Group.StyleBackground <> nil) and
    (savAlphaBlending in Group.StyleBackground.Style.AssignedValues) then
    Result := Group.StyleBackground.Style.AlphaBlending
  else
    Result := NavBar.DefaultStyles.GroupBackground.AlphaBlending;
end;

function TdxNavBarGroupViewInfo.BgAlphaBlend2: Byte;
begin
  if (Group.StyleBackground <> nil) and
    (savAlphaBlending2 in Group.StyleBackground.Style.AssignedValues) then
...
begin
  if (Group.StyleBackground <> nil) and
    (savGradientMode in Group.StyleBackground.Style.AssignedValues) then
...
begin
  if (CaptionStyleItem <> nil) and
    (savImage in CaptionStyleItem.Style.AssignedValues) then
...
begin
  if (CaptionStyleItem <> nil) and
    (savBackColor in CaptionStyleItem.Style.AssignedValues) then
...
begin
  if (CaptionStyleItem <> nil) and
    (savBackColor2 in CaptionStyleItem.Style.AssignedValues) then
    Result := CaptionStyleItem.Style.BackColor2
  else
    Result := CaptionStyle.BackColor2;
end;

function TdxNavBarGroupViewInfo.CaptionAlphaBlend: Byte;
begin
  if (CaptionStyleItem <> nil) and
    (savAlphaBlending in CaptionStyleItem.Style.AssignedValues) then
    Result := CaptionStyleItem.Style.AlphaBlending
  else
    Result := CaptionStyle.AlphaBlending;
end;

function TdxNavBarGroupViewInfo.CaptionAlphaBlend2: Byte;
begin
  if (CaptionStyleItem <> nil) and
    (savAlphaBlending2 in CaptionStyleItem.Style.AssignedValues) then
    Result := CaptionStyleItem.Style.AlphaBlending2
  else
    Result := CaptionStyle.AlphaBlending2;
end;

function TdxNavBarGroupViewInfo.CaptionGradientMode: TdxBarStyleGradientMode;
begin
  if (CaptionStyleItem <> nil) and
    (savGradientMode in CaptionStyleItem.Style.AssignedValues) then
    Result := CaptionStyleItem.Style.GradientMode
  else
    Result := CaptionStyle.GradientMode;
end;
...
begin
  Result := FCaptionFont;
  if (CaptionStyleItem <> nil) and
    (savFont in CaptionStyleItem.Style.AssignedValues) then
    Result.Assign(CaptionStyleItem.Style.Font)
  else
    Result.Assign(CaptionStyle.Font);
end;
...
begin
  if (CaptionStyleItem <> nil) and
    (savHAlignment in CaptionStyleItem.Style.AssignedValues) then
    Result := CaptionStyleItem.Style.HAlignment
  else
    Result := CaptionStyle.HAlignment;
end;

function TdxNavBarGroupViewInfo.CaptionVAlignment: TdxBarStyleVAlignment;
begin
  if (CaptionStyleItem <> nil) and
    (savVAlignment in CaptionStyleItem.Style.AssignedValues) then
    Result := CaptionStyleItem.Style.VAlignment
  else
    Result := CaptionStyle.VAlignment;
end;

function TdxNavBarGroupViewInfo.ControlImage: TPicture;
begin
  if (Group.StyleControl <> nil) and
    (savImage in Group.StyleControl.Style.AssignedValues) then
    Result := Group.StyleControl.Style.Image
  else
    Result := NavBar.DefaultStyles.GroupControl.Image;
end;
...
begin
  if IsDefaultControlStyle then
    Result := BgAlphaBlend
  else if (Group.StyleControl <> nil) and
    (savAlphaBlending in Group.StyleControl.Style.AssignedValues) then
    Result := Group.StyleControl.Style.AlphaBlending
  else
    Result := NavBar.DefaultStyles.GroupControl.AlphaBlending;
end;
...
begin
  if IsDefaultControlStyle then
    ...
    (savAlphaBlending2 in Group.StyleControl.Style.AssignedValues) then
    Result := Group.StyleControl.Style.AlphaBlending2
  else
    Result := NavBar.DefaultStyles.GroupControl.AlphaBlending2;
end;
...
begin
  if IsDefaultControlStyle then
    ...
    (savGradientMode in Group.StyleControl.Style.AssignedValues) then
    Result := Group.StyleControl.Style.GradientMode
  else
    Result := NavBar.DefaultStyles.GroupControl.GradientMode;
end;
...
begin
  Result := inherited GetState;
  if (Group = NavBar.PressedGroup) and (Group = NavBar.HotTrackedGroup) or
    Group.CaptionPanelIAccessibilityHelper.IsPressed then
    Include(Result, sPressed);
  ...
  if (Group = NavBar.ActiveGroup) and ViewInfo.CanHasSpecialGroup and NavBar.ShowSpecialGroup
  then
...
begin
  Result := ViewInfo.HasClientAreaScrollbar or
    NavBar.ActiveGroupScrollBar.Visible and
...
const
  dxHAlignment: array [TdxBarStyleHAlignment] of Integer = (DT_LEFT, DT_CENTER,
    DT_RIGHT);
  dxVAlignment: array [TdxBarStyleVAlignment] of Integer = (DT_TOP, DT_VCENTER,
    DT_BOTTOM);
begin
  Result := dxHAlignment[CaptionHAlignment] or dxVAlignment[CaptionVAlignment]
...
begin
  Result := (not NavBar.IsNavigationClient or (Level <> 0)) and
    FCaptionVisible and NavBar.ShowGroupCaptions and
    (Group.ShowCaption or not ViewInfo.CanHasGroupWithNoCaption and (Level = 0)
    and not ViewInfo.IsInternal);
end;
...
begin
  ...
  begin
    ...
    FCaptionTextRect.Left := FImageRect.Right +
      ViewInfo.GetGroupCaptionTextIndent;
  end
  else
...
begin
  ...
  if IsItemsVisible and (Control = nil) then
    ...
    begin
      ...
      else if Group.Children[I] is TdxNavBarGroup then
      begin
        FHasGroups := True;
...
begin
  ...
  begin
    ...
    AMax := (FInfos[FInfos.Count - 1].Rect.Bottom - FInfos[0].Rect.Top) +
      ViewInfo.GetGroupCaptionSeparatorWidth;
  ...
  if not NavBar.IsPopupScrollBars and
    (AWasScrollBarVisible <> NavBar.ActiveGroupScrollBar.Visible) then
  begin
    X := FRect.Left;
    Y := FRect.Top;
    CalculateBounds(X, Y);
  ...
  if FInfos.Count > 0 then
    if NavBar.OptionsBehavior.Common.AllowChildGroups then
      ...
      AOffsetY := FInfos[Min(Group.TopVisibleLinkIndex, FInfos.Count - 1)
        ].Rect.Top - FInfos[0].Rect.Top;
  for I := 0 to FInfos.Count - 1 do
...
begin
  if (Group.StyleControl <> nil) and
    (savBackColor in Group.StyleControl.Style.AssignedValues) then
    Result := Group.StyleControl.Style.BackColor
  else
    Result := NavBar.DefaultStyles.GroupControl.BackColor;
end;

function TdxNavBarGroupViewInfo.GetControlBackColor2: TColor;
begin
  if (Group.StyleControl <> nil) and
    (savBackColor2 in Group.StyleControl.Style.AssignedValues) then
    Result := Group.StyleControl.Style.BackColor2
  else
    Result := NavBar.DefaultStyles.GroupControl.BackColor2;
end;
...
begin
  Result := Painter.CreateLinkViewInfo(Self, ALink, ACaptionVisible,
    AImageVisible);
end;

procedure TdxNavBarGroupViewInfo.AddChildGroup(AGroup: TdxNavBarGroup;
ACaptionVisible, AItemsVisible: Boolean);
var
  AChildGroupViewInfo: TdxNavBarChildGroupViewInfo;
begin
  AChildGroupViewInfo := Painter.CreateChildGroupViewInfo(ViewInfo, Self,
    AGroup, ACaptionVisible, AItemsVisible);
  FInfos.Add(AChildGroupViewInfo);
end;

procedure TdxNavBarGroupViewInfo.AddLink(AViewInfo: TdxNavBarViewInfo;
ALink: TdxNavBarItemLink; ACaptionVisible, AImageVisible: Boolean);
var
  ALinkInfo: TdxNavBarLinkViewInfo;
begin
...
function TdxNavBarGroupViewInfo.GetGroupViewInfoAtPos(const pt: TPoint)
  : TdxNavBarGroupViewInfo;
var
  I: Integer;
...
class procedure TdxNavBarGroupCalculator.CalculateCaptionBounds
  (AGroupViewInfo: TdxNavBarGroupViewInfo; X, Y: Integer);
  ...
  begin
    ...
    AActiveIndex := AGroupViewInfo.ViewInfo.IndexOfGroupViewInfo
      (AGroupViewInfo.ViewInfo.ActiveGroupViewInfo);
...
begin
  ...
  if AGroupViewInfo.HasScrollBarInGroupCaption then
    Dec(AGroupViewInfo.FCaptionRect.Right,
      AGroupViewInfo.ViewInfo.GetActiveGroupScrollBarWidth);
...
class procedure TdxNavBarGroupCalculator.CalculateExpandButtonRect
  (AGroupViewInfo: TdxNavBarGroupViewInfo);
var
...
begin
  ...
  begin
    ...
    ASignZoneWidth := AGroupCaptionSignSize.cx +
      AGroupViewInfo.FCaptionRect.Height - AGroupCaptionSignSize.cy;
    ASignZone.Left := ASignZone.Right - ASignZoneWidth;
    AGroupViewInfo.FCaptionSignRect := cxRectCenter(ASignZone,
      AGroupCaptionSignSize);
...
class function TdxNavBarGroupCalculator.GetGroupCaptionSeparatorWidth
  (AGroupViewInfo: TdxNavBarGroupViewInfo): Integer;
begin
  Result := IfThen(AGroupViewInfo.IsTopLevel,
    AGroupViewInfo.ViewInfo.GetGroupCaptionSeparatorWidth);
end;

class procedure TdxNavBarGroupCalculator.CalculateClientRect(AGroupViewInfo
  : TdxNavBarGroupViewInfo; var X, Y: Integer);
var
  ...
  begin
    if AGroupViewInfo.Control <> nil then
      AGroupViewInfo.FRect.Bottom := AGroupViewInfo.FCaptionRect.Bottom +
        Max(AGroupViewInfo.Control.OriginalHeight,
        AGroupViewInfo.Control.GetMinHeight) +
        AGroupViewInfo.GetBorderOffsets.Top +
        AGroupViewInfo.GetBorderOffsets.Bottom
    else
    begin
      ...
      AGroupViewInfo.FRect.Bottom := AItemsRectBottom +
        GetGroupCaptionSeparatorWidth(AGroupViewInfo);
    end;
  end
  else
    AGroupViewInfo.FRect.Bottom := AGroupViewInfo.FCaptionRect.Bottom;
  if AGroupViewInfo.Group.Expanded and
    Assigned(AGroupViewInfo.NavBar.OnCalcGroupClientHeight) then
  begin
    AClientHeight := cxRectHeight(AGroupViewInfo.FRect) -
      cxRectHeight(AGroupViewInfo.FCaptionRect);
    AGroupViewInfo.NavBar.OnCalcGroupClientHeight(AGroupViewInfo.NavBar,
      AGroupViewInfo, AClientHeight);
    AGroupViewInfo.FRect.Bottom := AGroupViewInfo.FRect.Top + AClientHeight +
      cxRectHeight(AGroupViewInfo.FCaptionRect);
  end;
end;

class procedure TdxNavBarGroupCalculator.CalculateFocusRect(AGroupViewInfo
  : TdxNavBarGroupViewInfo);
begin
  if AGroupViewInfo.IsFocused then
    AGroupViewInfo.FFocusRect := cxRectContent(AGroupViewInfo.CaptionRect,
      cxRect(2, 2, 2, 2))
  else
    SetRectEmpty(AGroupViewInfo.FFocusRect);
end;

class procedure TdxNavBarGroupCalculator.CalculateItems(AGroupViewInfo
  : TdxNavBarGroupViewInfo; var X, Y: Integer; out AItemsRectBottom: Integer);
var
  AItemStartX, AItemStartY, I: Integer;
  AItemViewInfo: TdxNavBarCustomItemViewInfo;
begin
  AItemsRectBottom := AGroupViewInfo.FCaptionRect.Bottom +
    GetGroupCaptionSeparatorWidth(AGroupViewInfo);
  AItemStartX := X;
  ...
  begin
    ...
    if AItemViewInfo is TdxNavBarLinkViewInfo then
      TdxNavBarLinkViewInfo(AItemViewInfo).CalculateBounds(AItemStartX,
        AItemStartY)
    else if AItemViewInfo is TdxNavBarChildGroupViewInfo then
      TdxNavBarChildGroupViewInfo(AItemViewInfo).CalculateBounds(AItemStartX,
        AItemStartY)
    else
...
class procedure TdxNavBarGroupCalculator.CalculateItemsAsIconView
  (AGroupViewInfo: TdxNavBarGroupViewInfo; var X, Y: Integer;
...
begin
  ...
  begin
    ...
    if AGroupViewInfo.IsViewAsIconView then
    begin
      if (ALinkViewInfo.Rect.Right > AGroupViewInfo.FCaptionRect.Right) and
        (I > 0) then
      begin
        AItemStartX := X;
...
class procedure TdxNavBarGroupCalculator.CalculateItemsRect(AGroupViewInfo
  : TdxNavBarGroupViewInfo);
begin
  ...
  if AGroupViewInfo.HasScrollBar and not AGroupViewInfo.NavBar.IsPopupScrollBars
  then
    Dec(AGroupViewInfo.FItemsRect.Right,
      AGroupViewInfo.ViewInfo.GetActiveGroupScrollBarWidth);
end;

{ TdxNavBarChildGroupCaptionViewInfo }

constructor TdxNavBarChildGroupCaptionViewInfo.Create(AParentGroupViewInfo,
  AGroupViewInfo: TdxNavBarGroupViewInfo);
begin
...
constructor TdxNavBarChildGroupViewInfo.Create(AViewInfo: TdxNavBarViewInfo;
AParentInfo: TdxNavBarGroupViewInfo; AGroup: TdxNavBarGroup;
ACaptionVisible, AItemsVisible: Boolean);
begin
...
begin
  Result := GetExpandButtonOffset.cx + GetExpandButtonSize.cx +
    GetExpandButtonRightIndent;
end;
...
begin
  ...
  begin
    ...
    FExpandButtonRect := cxRectContent(FCaptionRect,
      ViewInfo.GetItemCaptionOffsets);
    ...
    Dec(FExpandButtonRect.Bottom,
      (cxRectHeight(FExpandButtonRect) - ASize.cy) div 2);
...
begin
  Result := cxSize(Painter.GetLookAndFeelPainter.ScaledSmallExpandButtonSize
    (ScaleFactor));
end;

{ TdxNavBarScrollBar }

constructor TdxNavBarScrollBar.Create(AParent: TcxControl;
...
procedure TdxNavBarScrollBar.SetScrollParams(AMin, AMax, APosition,
...
begin
  ...
  if (Min <> AMin) or (Max <> AMax) or (PageSize <> APageSize) or
  ...
  begin
    ...
    DoSetScrollParams(FScrollInfo.nMin, FScrollInfo.nMax, APosition,
      APageSize, ARedraw);
    FLargeChange := FScrollInfo.nPage;
  end;
end;

procedure TdxNavBarScrollBar.UpdatePosition(AValue: Integer;
AAnimated: Boolean);
begin
  if AAnimated then
...
procedure TdxNavBarScrollBar.Scroll(Sender: TObject; AScrollCode: TScrollCode;
var AScrollPos: Integer);
var
  APos: Integer;
begin
  ...
  case AScrollCode of
    scLineUp:
      Dec(APos, SmallChange);
    scLineDown:
      Inc(APos, SmallChange);
    scPageUp:
      Dec(APos, LargeChange);
    scPageDown:
      Inc(APos, LargeChange);
    scPosition, scTrack:
      APos := AScrollPos;
    scTop:
      APos := Min;
  ...
  if IsScrollAnimationActive and (AScrollCode in [scPosition, scTrack]) then
    StopAnimation;
  if GetParent.IsScrollAnimationEnabled and
    (AScrollCode in [scLineUp .. scPageDown]) then
  begin
...
begin
  CheckScrollBarClass;
  if not NeedScrollBar or NavBarPainter.NavBar.FIsNonClientScrollBarChecking
  then
    Visible := False;
  case GetParent.GetViewReal of
    dxNavBarXP1View, dxNavBarXP2View, dxNavBarXPExplorerBarView,
      dxNavBarAdvExplorerBarView, dxNavBarOffice11ExplorerBarView,
      dxNavBarVistaExplorerBarView:
      LookAndFeel.NativeStyle := True;
    dxNavBarBaseView:
      SetLookAndFeelKind(lfStandard);
    dxNavBarOffice1View, dxNavBarOffice2View, dxNavBarOffice3View,
      dxNavBarFlatView:
...
procedure TdxNavBarScrollBar.CorrectPos(var APos: Integer;
...
procedure TdxNavBarScrollBar.DoScroll(AScrollCode: TScrollCode;
var AScrollPos: Integer);
begin
...
procedure TdxNavBarScrollBar.DoSetScrollParams(AMin, AMax, APosition,
  APageSize: Integer; ARedraw: Boolean = True);
begin
...
begin
  ...
  cxRedrawWindow(FParent.Handle, RDW_INVALIDATE or RDW_ERASE or
    RDW_ALLCHILDREN or RDW_FRAME or RDW_INTERNALPAINT);
end;
...
procedure TdxNavBarPopupScrollBar.DoSetScrollParams(AMin, AMax, APosition,
  APageSize: Integer; ARedraw: Boolean = True);
begin
...
procedure TdxNavBarPopupScrollBar.LookAndFeelChanged(Sender: TcxLookAndFeel;
AChangedValues: TcxLookAndFeelValues);
begin
end;
...
class procedure TdxNavBarItemCalculator.CalculateBounds(X, Y: Integer;
AScaleFactor: TdxScaleFactor; var AItemViewInfo);
var
...
begin
  ...
  begin
    ...
    CalculateRect(ACaptionViewInfo, X, Y, ACaptionViewInfo.FImageRect.Right +
      ACaptionViewInfo.ViewInfo.GetLinksImageEdges.Right,
      ACaptionViewInfo.FImageRect.Bottom +
      ACaptionViewInfo.ViewInfo.GetLinksImageEdges.Bottom);
  end
  else
  begin
    ...
    if HasScrollBar(ACaptionViewInfo) then
      Dec(ARightPosition,
        ACaptionViewInfo.ViewInfo.GetActiveGroupScrollBarWidth);
...
class procedure TdxNavBarItemCalculator.CalculateDesignRect
  (AItemViewInfo: TdxNavBarCustomItemViewInfo; const ARect: TRect);
var
  ADesignArea: TRect;
begin
  ...
  begin
    ...
    AItemViewInfo.FDesignRect := cxRectCenter(ADesignArea,
      AItemViewInfo.GetDesignSelectorSize);
  end
  else
    AItemViewInfo.FDesignRect := cxNullRect;
end;

class function TdxNavBarItemCalculator.HasScrollBar(ACaptionViewInfo
  : TdxNavBarChildCaptionViewInfo): Boolean;
begin
  Result := ACaptionViewInfo.GroupViewInfo.HasScrollBar and
    not ACaptionViewInfo.NavBar.IsPopupScrollBars;
end;

class procedure TdxNavBarItemCalculator.CalculateCaptionRect(ACaptionViewInfo
  : TdxNavBarChildCaptionViewInfo; ALeft, ATop, ARightPosition: Integer);
var
  ARect: TRect;
begin
  ...
  begin
    ...
    cxDrawText(cxScreenCanvas.Handle, Caption, ARect, GetDrawEdgeFlag or
      DT_CALCRECT);
    cxScreenCanvas.Dormant;
...
class function TdxNavBarItemCalculator.CalculateFocusRect(const ARect,
  ATextRect: TRect): TRect;
begin
  cxRectIntersect(Result, ARect, cxRectInflate(ATextRect, 2, 0, 2, 0))
end;

class procedure TdxNavBarItemCalculator.CalculateFocusRect
  (AItemViewInfo: TdxNavBarCustomItemViewInfo);
begin
  CalculateFocusRect(AItemViewInfo, AItemViewInfo.Rect,
    AItemViewInfo.CaptionRect);
end;

class procedure TdxNavBarItemCalculator.CalculateFocusRect
  (AItemViewInfo: TdxNavBarCustomItemViewInfo; const ARect, ATextRect: TRect);
begin
...
class procedure TdxNavBarItemCalculator.CalculateImageRect(ACaptionViewInfo
  : TdxNavBarChildCaptionViewInfo; ALeft, ATop: Integer);
begin
  ACaptionViewInfo.FImageRect := cxRectBounds(ALeft, ATop,
    ACaptionViewInfo.GetImageWidth, ACaptionViewInfo.GetImageHeight);
end;

class procedure TdxNavBarItemCalculator.CalculateLargeBounds(ACaptionViewInfo
  : TdxNavBarChildCaptionViewInfo; X, Y, ARightPosition: Integer);
var
  ALeft, AWidth: Integer;
begin
  CalculateLeftPosition(ACaptionViewInfo, X, ALeft);
  CalculateImageRect(ACaptionViewInfo, ALeft,
    Y + ACaptionViewInfo.ViewInfo.GetLinksLargeSeparatorWidth div 2);
  CalculateCaptionRect(ACaptionViewInfo, ALeft + 1,
    ACaptionViewInfo.FImageRect.Bottom +
    ACaptionViewInfo.ViewInfo.GetLinksImageEdges.Bottom, ARightPosition - 1);
  CalculateRect(ACaptionViewInfo, ALeft, Y, ARightPosition,
    ACaptionViewInfo.CaptionRect.Bottom +
    ACaptionViewInfo.ViewInfo.GetLinksLargeSeparatorWidth div 2);
  AWidth := cxRectWidth(ACaptionViewInfo.Rect);
  OffsetRect(ACaptionViewInfo.FImageRect,
    (AWidth - cxRectWidth(ACaptionViewInfo.ImageRect)) div 2, 0);
  OffsetRect(ACaptionViewInfo.FCaptionRect,
    (AWidth - cxRectWidth(ACaptionViewInfo.CaptionRect)) div 2, 0);
end;

class procedure TdxNavBarItemCalculator.CalculateLeftPosition(ACaptionViewInfo
  : TdxNavBarChildCaptionViewInfo; X: Integer; out ALeft: Integer);
begin
  ALeft := X + ACaptionViewInfo.GroupViewInfo.Level *
    ACaptionViewInfo.ViewInfo.GetChildItemOffset;
end;

class procedure TdxNavBarItemCalculator.CalculateSmallBounds(ACaptionViewInfo
  : TdxNavBarChildCaptionViewInfo; X, Y, ARightPosition: Integer);
var
...
begin
  ...
  begin
    CalculateImageRect(ACaptionViewInfo,
      ALeft + ACaptionViewInfo.ViewInfo.GetLinksImageEdges.Left, Y);
    ACaptionLeft := ACaptionViewInfo.FImageRect.Right +
      ACaptionViewInfo.ViewInfo.GetLinksImageEdges.Right;
  end
  else
  begin
    ACaptionViewInfo.FImageRect := cxNullRect;
    ACaptionLeft := ALeft + ACaptionViewInfo.ViewInfo.
      GetItemCaptionOffsets.Left;
  end;
  CalculateCaptionRect(ACaptionViewInfo, ACaptionLeft, Y, ARightPosition - 1);
  AHeight := Max(cxRectHeight(ACaptionViewInfo.ImageRect),
    cxRectHeight(ACaptionViewInfo.CaptionRect)) +
  ...
  if ACaptionViewInfo.GetImageWidth <> 0 then
    OffsetRect(ACaptionViewInfo.FImageRect, 0,
      (AHeight - cxRectHeight(ACaptionViewInfo.ImageRect)) div 2);
  OffsetRect(ACaptionViewInfo.FCaptionRect, 0,
    (AHeight div 2) - (cxRectHeight(ACaptionViewInfo.CaptionRect) div 2));
end;

class procedure TdxNavBarItemCalculator.CalculateRect(ACaptionViewInfo
  : TdxNavBarChildCaptionViewInfo; ALeft, ATop, ARight, ABottom: Integer);
begin
...
class procedure TdxNavBarSeparatorCalculator.CalculateBounds(X, Y: Integer;
AScaleFactor: TdxScaleFactor; var ALinkViewInfo);
var
...
begin
  ...
  begin
    FRect := cxRect(X, Y, X + ViewInfo.ClientWidth - 2 *
      ViewInfo.GetGroupEdges.X, Y + ASeparatorHeight);
    FImageRect := cxRectBounds(FRect.Left + ViewInfo.GetLinksImageEdges.Left,
      FRect.Top, GetImageWidth, ASeparatorHeight);
    FCaptionRect := FRect;
...
begin
  ...
  else if FTargetObject = NavBar.Customization.Form then
    NavBar.Customization.Form.CalculateDropInfo(FDropTargetInfo)
  else if FTargetObject is TdxCustomNavBar then
    (FTargetObject as TdxCustomNavBar).ViewInfo.CalculateDropInfo
      (FDropTargetInfo);
end;
...
function TdxNavBarHeaderPanelSignAccessibilityHelper.ChildIsSimpleElement
  (AIndex: Integer): Boolean;
begin
  Result := True;
end;

procedure TdxNavBarHeaderPanelSignAccessibilityHelper.DoDefaultAction
...
function TdxNavBarHeaderPanelSignAccessibilityHelper.GetName
  (AChildID: TcxAccessibleSimpleChildElementID): string;
begin
  if (TdxNavBarOffice11NavPaneViewInfo(OwnerObject)
    .Painter.Controller as TdxNavBarNavigationPaneController).Collapsed then
...
function TdxNavBarHeaderPanelSignAccessibilityHelper.GetParent
  : TcxAccessibilityHelper;
begin
  Result := TdxCustomNavBar(OwnerObjectControl).IAccessibilityHelper.GetHelper;
end;

function TdxNavBarHeaderPanelSignAccessibilityHelper.GetRole
  (AChildID: TcxAccessibleSimpleChildElementID): Integer;
begin
  Result := cxROLE_SYSTEM_PUSHBUTTON;
end;

function TdxNavBarHeaderPanelSignAccessibilityHelper.GetState
  (AChildID: TcxAccessibleSimpleChildElementID): Integer;
begin
...
function TdxNavBarHeaderPanelSignAccessibilityHelper.IsClickKey
  (AKey: Word): Boolean;
begin
...
function TdxNavBarHeaderPanelSignAccessibilityHelper.GetViewInfo
  : TdxNavBarViewInfo;
begin
...
begin
  Result := not Painter.Controller.Collapsed and (NavBar.ActiveGroup <> nil) and
    NavBar.ActiveGroup.Visible;
end;
...
function TdxNavBarHeaderPanelViewInfo.GetAccessibilityHelper
  : IdxNavBarAccessibilityHelper;
begin
  if FIAccessibilityHelper = nil then
    FIAccessibilityHelper := NavBarGetAccessibilityHelper
      (GetAccessibilityHelperClass.Create(ViewInfo, NavBar));
  Result := FIAccessibilityHelper;
end;

function TdxNavBarHeaderPanelViewInfo.GetAccessibilityHelperClass
  : TdxNavBarCustomAccessibilityHelperClass;
begin
...
function TdxNavBarViewInfo.GetGroupViewInfoByGroup(AGroup: TdxNavBarGroup)
  : TdxNavBarGroupViewInfo;
var
  I: Integer;
begin
...
function TdxNavBarViewInfo.GetLinkViewInfoByLink(ALink: TdxNavBarItemLink)
  : TdxNavBarLinkViewInfo;
var
  I: Integer;
begin
...
function TdxNavBarViewInfo.IndexOfGroupViewInfo
  (AViewInfo: TdxNavBarGroupViewInfo): Integer;
begin
  Result := FGroups.IndexOf(AViewInfo);
end;

function TdxNavBarViewInfo.GetGroupViewInfoAtPos(const pt: TPoint)
  : TdxNavBarGroupViewInfo;
var
  I: Integer;
begin
...
function TdxNavBarViewInfo.GetGroupViewInfoAtCaptionPos(const pt: TPoint)
  : TdxNavBarGroupViewInfo;
begin
...
begin
  if (AViewInfo <> nil) and (AViewInfo.Group <> nil) and not AViewInfo.Group.IsDestroying
  then
...
function TdxNavBarViewInfo.GetGroupViewInfoAtItemsPos(const pt: TPoint)
  : TdxNavBarGroupViewInfo;
begin
  Result := GetGroupViewInfoAtPos(pt);
...
function TdxNavBarViewInfo.GetGroupAtCaptionPos(const pt: TPoint)
  : TdxNavBarGroup;
begin
...
function TdxNavBarViewInfo.GetLinkViewInfoAtPos(const pt: TPoint)
  : TdxNavBarLinkViewInfo;
var
  I: Integer;
  AGroupViewInfo: TdxNavBarGroupViewInfo;
...
class function TdxNavBarViewInfo.InternalGetLinkViewInfoAtSelectedPos
  (AViewInfo: TdxNavBarViewInfo; const pt: TPoint): TdxNavBarLinkViewInfo;
var
  ACaptionRect: TRect;
begin
  ...
  if (Result <> nil) and not Result.Link.CanSelect then
    Result := nil
  else if (Result <> nil) and not AViewInfo.CanSelectLinkByRect then
  begin
...
function TdxNavBarViewInfo.GetLinkViewInfoAtSelectedPos(const pt: TPoint)
  : TdxNavBarLinkViewInfo;
begin
  Result := nil;
  if IsPtContentArea(pt) then
...
function TdxNavBarViewInfo.GetLinkAtSelectedPos(const pt: TPoint)
  : TdxNavBarItemLink;
begin
  Result := GetValidLink(GetLinkViewInfoAtSelectedPos(pt));
end;

function TdxNavBarViewInfo.GetViewInfoAtDragPosition(const pt: TPoint;
var ItemGroup: TdxNavBarGroupViewInfo;
...
begin
  ...
  begin
    if ItemGroup.IsViewAsIconView then
      Result := GetViewInfoAtDragPositionWhenIconView(pt, ItemGroup,
        Item1, Item2)
    else
    begin
      ...
      begin
        ...
        if (ALinkViewInfo.Rect.Top + ALinkViewInfo.Rect.Bottom) div 2 > pt.Y
        then
        begin
          if Index > 0 then
      ...
      else if ItemGroup.ItemCount > 0 then
...
function TdxNavBarViewInfo.GetViewInfoAtDragPositionWhenIconView
  (const pt: TPoint; var ItemGroup: TdxNavBarGroupViewInfo;
var Item1, Item2: TdxNavBarLinkViewInfo): Integer;
var
  I, Index: Integer;
  ALinkViewInfo: TdxNavBarLinkViewInfo;
begin
  ...
  begin
    ...
    begin
      Index := ItemGroup.IndexOfLinkViewInfo(ALinkViewInfo);
      if (ALinkViewInfo.Rect.Left + (ALinkViewInfo.Rect.Right -
        ALinkViewInfo.Rect.Left) div 2) > pt.X then
      begin
        if Index > 0 then
          Item1 := ItemGroup.Items[Index - 1];
        Item2 := ALinkViewInfo
    ...
    begin
      ...
      begin
        if pt.Y < ItemGroup.Items[0].Rect.Top then
          ...
          for I := 0 to ItemGroup.ItemCount - 1 do
            if (pt.Y > ItemGroup.Items[I].Rect.Top) and
              (pt.Y < ItemGroup.Items[I].Rect.Bottom) then
            begin
...
procedure TdxNavBarViewInfo.CalculateDropInfo(var ADropTargetInfo
  : TdxNavBarDropTargetInfo);
begin
...
begin
  Result := not cxRectIsEmpty(FTopScrollButtonRect) and
    (ActiveGroupViewInfo <> nil) and
    ActiveGroupViewInfo.HasEnoughSpaceForScrollButtons;
end;

function TdxNavBarViewInfo.IsBottomScrollButtonVisible: Boolean;
begin
  Result := not cxRectIsEmpty(FBottomScrollButtonRect) and
    (ActiveGroupViewInfo <> nil) and
    ActiveGroupViewInfo.HasEnoughSpaceForScrollButtons;
end;
...
begin
  if (NavBar.StyleBackground <> nil) and
    (savImage in NavBar.StyleBackground.Style.AssignedValues) then
    Result := NavBar.StyleBackground.Style.Image
  else
    Result := NavBar.DefaultStyles.Background.Image;
end;

function TdxNavBarViewInfo.BgBackColor: TColor;
begin
  if (NavBar.StyleBackground <> nil) and
    (savBackColor in NavBar.StyleBackground.Style.AssignedValues) then
    Result := NavBar.StyleBackground.Style.BackColor
  else
    Result := NavBar.DefaultStyles.Background.BackColor;
end;

function TdxNavBarViewInfo.BgBackColor2: TColor;
begin
  if (NavBar.StyleBackground <> nil) and
    (savBackColor2 in NavBar.StyleBackground.Style.AssignedValues) then
    Result := NavBar.StyleBackground.Style.BackColor2
  else
    Result := NavBar.DefaultStyles.Background.BackColor2;
end;

function TdxNavBarViewInfo.BgAlphaBlend: Byte;
begin
  if (NavBar.StyleBackground <> nil) and
    (savAlphaBlending in NavBar.StyleBackground.Style.AssignedValues) then
    Result := NavBar.StyleBackground.Style.AlphaBlending
  else
    Result := NavBar.DefaultStyles.Background.AlphaBlending;
end;

function TdxNavBarViewInfo.BgAlphaBlend2: Byte;
begin
  if (NavBar.StyleBackground <> nil) and
    (savAlphaBlending2 in NavBar.StyleBackground.Style.AssignedValues) then
    Result := NavBar.StyleBackground.Style.AlphaBlending2
  else
    Result := NavBar.DefaultStyles.Background.AlphaBlending2;
end;

function TdxNavBarViewInfo.BgGradientMode: TdxBarStyleGradientMode;
begin
  if (NavBar.StyleBackground <> nil) and
    (savGradientMode in NavBar.StyleBackground.Style.AssignedValues) then
    Result := NavBar.StyleBackground.Style.GradientMode
  else
    Result := NavBar.DefaultStyles.Background.GradientMode;
end;
...
begin
  if NavBar.ScrollButtonUpIsDown then
    ...
    Result := NavBar.DefaultStyles.Button;
end;

function TdxNavBarViewInfo.BottomScrollButtonImage: TPicture;
begin
  if (BottomScrollButtonStyleItem <> nil) and
    (savImage in BottomScrollButtonStyleItem.Style.AssignedValues) then
    Result := BottomScrollButtonStyleItem.Style.Image
  else
    Result := BottomScrollButtonStyle.Image;
end;

function TdxNavBarViewInfo.BottomScrollButtonBackColor: TColor;
begin
  if (BottomScrollButtonStyleItem <> nil) and
    (savBackColor in BottomScrollButtonStyleItem.Style.AssignedValues) then
    Result := BottomScrollButtonStyleItem.Style.BackColor
  else
    Result := BottomScrollButtonStyle.BackColor;
end;

function TdxNavBarViewInfo.BottomScrollButtonBackColor2: TColor;
begin
  if (BottomScrollButtonStyleItem <> nil) and
    (savBackColor2 in BottomScrollButtonStyleItem.Style.AssignedValues) then
    Result := BottomScrollButtonStyleItem.Style.BackColor2
  else
    Result := BottomScrollButtonStyle.BackColor2;
end;

function TdxNavBarViewInfo.BottomScrollButtonAlphaBlend: Byte;
begin
  if (BottomScrollButtonStyleItem <> nil) and
    (savAlphaBlending in BottomScrollButtonStyleItem.Style.AssignedValues) then
    Result := BottomScrollButtonStyleItem.Style.AlphaBlending
  else
    Result := BottomScrollButtonStyle.AlphaBlending;
end;

function TdxNavBarViewInfo.BottomScrollButtonAlphaBlend2: Byte;
begin
  if (BottomScrollButtonStyleItem <> nil) and
    (savAlphaBlending2 in BottomScrollButtonStyleItem.Style.AssignedValues) then
    Result := BottomScrollButtonStyleItem.Style.AlphaBlending2
  else
    Result := BottomScrollButtonStyle.AlphaBlending2;
end;

function TdxNavBarViewInfo.BottomScrollButtonGradientMode
  : TdxBarStyleGradientMode;
begin
  if (BottomScrollButtonStyleItem <> nil) and
    (savGradientMode in BottomScrollButtonStyleItem.Style.AssignedValues) then
    Result := BottomScrollButtonStyleItem.Style.GradientMode
  else
    Result := BottomScrollButtonStyle.GradientMode;
end;
...
begin
  if (TopScrollButtonStyleItem <> nil) and
    (savImage in TopScrollButtonStyleItem.Style.AssignedValues) then
    Result := TopScrollButtonStyleItem.Style.Image
  else
    Result := TopScrollButtonStyle.Image;
end;

function TdxNavBarViewInfo.TopScrollButtonBackColor: TColor;
begin
  if (TopScrollButtonStyleItem <> nil) and
    (savBackColor in TopScrollButtonStyleItem.Style.AssignedValues) then
    Result := TopScrollButtonStyleItem.Style.BackColor
  else
    Result := TopScrollButtonStyle.BackColor;
end;

function TdxNavBarViewInfo.TopScrollButtonBackColor2: TColor;
begin
  if (TopScrollButtonStyleItem <> nil) and
    (savBackColor2 in TopScrollButtonStyleItem.Style.AssignedValues) then
    Result := TopScrollButtonStyleItem.Style.BackColor2
  else
    Result := TopScrollButtonStyle.BackColor2;
end;

function TdxNavBarViewInfo.TopScrollButtonAlphaBlend: Byte;
begin
  if (TopScrollButtonStyleItem <> nil) and
    (savAlphaBlending in TopScrollButtonStyleItem.Style.AssignedValues) then
    Result := TopScrollButtonStyleItem.Style.AlphaBlending
  else
    Result := TopScrollButtonStyle.AlphaBlending;
end;

function TdxNavBarViewInfo.TopScrollButtonAlphaBlend2: Byte;
begin
  if (TopScrollButtonStyleItem <> nil) and
    (savAlphaBlending2 in TopScrollButtonStyleItem.Style.AssignedValues) then
    Result := TopScrollButtonStyleItem.Style.AlphaBlending2
  else
    Result := TopScrollButtonStyle.AlphaBlending2;
end;

function TdxNavBarViewInfo.TopScrollButtonGradientMode: TdxBarStyleGradientMode;
begin
  if (TopScrollButtonStyleItem <> nil) and
    (savGradientMode in TopScrollButtonStyleItem.Style.AssignedValues) then
    Result := TopScrollButtonStyleItem.Style.GradientMode
  else
    Result := TopScrollButtonStyle.GradientMode;
end;

function TdxNavBarViewInfo.HintImage: TPicture;
begin
  if (NavBar.StyleHint <> nil) and
    (savImage in NavBar.StyleHint.Style.AssignedValues) then
    Result := NavBar.StyleHint.Style.Image
  else
    Result := NavBar.DefaultStyles.Hint.Image
end;

function TdxNavBarViewInfo.HintBackColor: TColor;
begin
  if (NavBar.StyleHint <> nil) and
    (savBackColor in NavBar.StyleHint.Style.AssignedValues) then
    Result := NavBar.StyleHint.Style.BackColor
  else
    Result := NavBar.DefaultStyles.Hint.BackColor;
end;

function TdxNavBarViewInfo.HintBackColor2: TColor;
begin
  if (NavBar.StyleHint <> nil) and
    (savBackColor2 in NavBar.StyleHint.Style.AssignedValues) then
    Result := NavBar.StyleHint.Style.BackColor2
  else
    Result := NavBar.DefaultStyles.Hint.BackColor2;
end;

function TdxNavBarViewInfo.HintAlphaBlend: Byte;
begin
  if (NavBar.StyleHint <> nil) and
    (savAlphaBlending in NavBar.StyleHint.Style.AssignedValues) then
    Result := NavBar.StyleHint.Style.AlphaBlending
  else
    Result := NavBar.DefaultStyles.Hint.AlphaBlending;
end;

function TdxNavBarViewInfo.HintAlphaBlend2: Byte;
begin
  if (NavBar.StyleHint <> nil) and
    (savAlphaBlending2 in NavBar.StyleHint.Style.AssignedValues) then
    Result := NavBar.StyleHint.Style.AlphaBlending2
  else
    Result := NavBar.DefaultStyles.Hint.AlphaBlending2;
end;

function TdxNavBarViewInfo.HintGradientMode: TdxBarStyleGradientMode;
begin
  if (NavBar.StyleHint <> nil) and
    (savGradientMode in NavBar.StyleHint.Style.AssignedValues) then
    Result := NavBar.StyleHint.Style.GradientMode
  else
    Result := NavBar.DefaultStyles.Hint.GradientMode;
end;

function TdxNavBarViewInfo.HintFont: TFont;
begin
  if (NavBar.StyleHint <> nil) and
    (savFont in NavBar.StyleHint.Style.AssignedValues) then
    Result := NavBar.StyleHint.Style.Font
  else
    Result := NavBar.DefaultStyles.Hint.Font;
end;

function TdxNavBarViewInfo.DragDropItemTargetBackColor: TColor;
begin
  if (NavBar.StyleDropTargetLink <> nil) and
    (savBackColor in NavBar.StyleDropTargetLink.Style.AssignedValues) then
    Result := NavBar.StyleDropTargetLink.Style.BackColor
  else
    Result := NavBar.DefaultStyles.DropTargetLink.BackColor;
end;

function TdxNavBarViewInfo.DragDropGroupTargetBackColor: TColor;
begin
  if (NavBar.StyleDropTargetGroup <> nil) and
    (savBackColor in NavBar.StyleDropTargetGroup.Style.AssignedValues) then
    Result := NavBar.StyleDropTargetGroup.Style.BackColor
  else
    Result := NavBar.DefaultStyles.DropTargetGroup.BackColor;
end;

function TdxNavBarViewInfo.DragDropGroupTargetBackColor2: TColor;
begin
  if (NavBar.StyleDropTargetGroup <> nil) and
    (savBackColor2 in NavBar.StyleDropTargetGroup.Style.AssignedValues) then
    Result := NavBar.StyleDropTargetGroup.Style.BackColor2
  else
    Result := NavBar.DefaultStyles.DropTargetGroup.BackColor2;
end;

function TdxNavBarViewInfo.DragDropGroupTargetAlphaBlend: Byte;
begin
  if (NavBar.StyleDropTargetGroup <> nil) and
    (savAlphaBlending in NavBar.StyleDropTargetGroup.Style.AssignedValues) then
    Result := NavBar.StyleDropTargetGroup.Style.AlphaBlending
  else
    Result := NavBar.DefaultStyles.DropTargetGroup.AlphaBlending;
end;

function TdxNavBarViewInfo.DragDropGroupTargetAlphaBlend2: Byte;
begin
  if (NavBar.StyleDropTargetGroup <> nil) and
    (savAlphaBlending2 in NavBar.StyleDropTargetGroup.Style.AssignedValues) then
    Result := NavBar.StyleDropTargetGroup.Style.AlphaBlending2
  else
    Result := NavBar.DefaultStyles.DropTargetGroup.AlphaBlending2;
end;

function TdxNavBarViewInfo.DragDropGroupTargetGradient: TdxBarStyleGradientMode;
begin
  if (NavBar.StyleDropTargetGroup <> nil) and
    (savGradientMode in NavBar.StyleDropTargetGroup.Style.AssignedValues) then
    Result := NavBar.StyleDropTargetGroup.Style.GradientMode
  else
    Result := NavBar.DefaultStyles.DropTargetGroup.GradientMode;
end;

function TdxNavBarViewInfo.HeaderImage: TPicture;
begin
  if (NavBar.StyleNavigationPaneHeader <> nil) and
    (savImage in NavBar.StyleNavigationPaneHeader.Style.AssignedValues) then
    Result := NavBar.StyleNavigationPaneHeader.Style.Image
  else
    Result := NavBar.DefaultStyles.NavigationPaneHeader.Image
end;

function TdxNavBarViewInfo.HeaderBackColor: TColor;
begin
  if (NavBar.StyleNavigationPaneHeader <> nil) and
    (savBackColor in NavBar.StyleNavigationPaneHeader.Style.AssignedValues) then
    Result := NavBar.StyleNavigationPaneHeader.Style.BackColor
  else
    Result := NavBar.DefaultStyles.NavigationPaneHeader.BackColor;
end;

function TdxNavBarViewInfo.HeaderBackColor2: TColor;
begin
  if (NavBar.StyleNavigationPaneHeader <> nil) and
    (savBackColor2 in NavBar.StyleNavigationPaneHeader.Style.AssignedValues)
  then
    Result := NavBar.StyleNavigationPaneHeader.Style.BackColor2
  else
    Result := NavBar.DefaultStyles.NavigationPaneHeader.BackColor2;
end;

function TdxNavBarViewInfo.HeaderAlphaBlend: Byte;
begin
  if (NavBar.StyleNavigationPaneHeader <> nil) and
    (savAlphaBlending in NavBar.StyleNavigationPaneHeader.Style.AssignedValues)
  then
    Result := NavBar.StyleNavigationPaneHeader.Style.AlphaBlending
  else
    Result := NavBar.DefaultStyles.NavigationPaneHeader.AlphaBlending;
end;

function TdxNavBarViewInfo.HeaderAlphaBlend2: Byte;
begin
  if (NavBar.StyleNavigationPaneHeader <> nil) and
    (savAlphaBlending2 in NavBar.StyleNavigationPaneHeader.Style.AssignedValues)
  then
    Result := NavBar.StyleNavigationPaneHeader.Style.AlphaBlending2
  else
    Result := NavBar.DefaultStyles.NavigationPaneHeader.AlphaBlending2;
end;

function TdxNavBarViewInfo.HeaderGradientMode: TdxBarStyleGradientMode;
begin
  if (NavBar.StyleNavigationPaneHeader <> nil) and
    (savGradientMode in NavBar.StyleNavigationPaneHeader.Style.AssignedValues)
  then
    Result := NavBar.StyleNavigationPaneHeader.Style.GradientMode
  else
    Result := NavBar.DefaultStyles.NavigationPaneHeader.GradientMode;
end;
...
begin
  Result := FHeaderFont;
  if (NavBar.StyleNavigationPaneHeader <> nil) and
    (savFont in NavBar.StyleNavigationPaneHeader.Style.AssignedValues) then
...
begin
  if (NavBar.StyleNavigationPaneHeader <> nil) and
    (savHAlignment in NavBar.StyleNavigationPaneHeader.Style.AssignedValues)
  then
    Result := NavBar.StyleNavigationPaneHeader.Style.HAlignment
  else
    Result := NavBar.DefaultStyles.NavigationPaneHeader.HAlignment;
end;

function TdxNavBarViewInfo.HeaderVAlignment: TdxBarStyleVAlignment;
begin
  if (NavBar.StyleNavigationPaneHeader <> nil) and
    (savVAlignment in NavBar.StyleNavigationPaneHeader.Style.AssignedValues)
  then
    Result := NavBar.StyleNavigationPaneHeader.Style.VAlignment
  else
    Result := NavBar.DefaultStyles.NavigationPaneHeader.VAlignment;
end;
...
begin
  NavBar.DefaultStyles.GroupHeaderActive.Assign
    (NavBar.DefaultStyles.GroupHeader);
end;

procedure TdxNavBarViewInfo.AssignDefaultGroupHeaderActiveHotTrackedStyle;
begin
  NavBar.DefaultStyles.GroupHeaderActiveHotTracked.Assign
    (NavBar.DefaultStyles.GroupHeaderActive);
end;

procedure TdxNavBarViewInfo.AssignDefaultGroupHeaderActivePressedStyle;
begin
  NavBar.DefaultStyles.GroupHeaderActivePressed.Assign
    (NavBar.DefaultStyles.GroupHeaderActive);
end;

procedure TdxNavBarViewInfo.AssignDefaultGroupHeaderHotTrackedStyle;
begin
  NavBar.DefaultStyles.GroupHeaderHotTracked.Assign
    (NavBar.DefaultStyles.GroupHeader);
end;

procedure TdxNavBarViewInfo.AssignDefaultGroupHeaderPressedStyle;
begin
  NavBar.DefaultStyles.GroupHeaderPressed.Assign
    (NavBar.DefaultStyles.GroupHeader);
end;
...
begin
  NavBar.DefaultStyles.ChildGroupCaptionHotTracked.Assign
    (NavBar.DefaultStyles.ItemHotTracked);
end;

procedure TdxNavBarViewInfo.AssignDefaultChildGroupCaptionPressedStyle;
begin
  NavBar.DefaultStyles.ChildGroupCaptionPressed.Assign
    (NavBar.DefaultStyles.ItemPressed);
end;
...
function TdxNavBarViewInfo.GetLargeImageHeight(AItemViewInfo
  : TdxNavBarCustomItemViewInfo): Integer;
begin
...
function TdxNavBarViewInfo.GetLargeImageWidth(AItemViewInfo
  : TdxNavBarCustomItemViewInfo): Integer;
begin
...
function TdxNavBarViewInfo.GetSmallImageHeight(AItemViewInfo
  : TdxNavBarCustomItemViewInfo): Integer;
begin
...
function TdxNavBarViewInfo.GetSmallImageWidth(AItemViewInfo
  : TdxNavBarCustomItemViewInfo): Integer;
begin
...
function TdxNavBarViewInfo.GetGroupAccessibilityHelperClass
  : TdxNavBarCustomAccessibilityHelperClass;
begin
  Result := TdxNavBarGroupAccessibilityHelper;
end;

function TdxNavBarViewInfo.GetGroupCaptionPanelAccessibilityHelperClass
  : TdxNavBarCustomAccessibilityHelperClass;
begin
...
begin
  ...
  begin
    ...
    Inc(Result, Max(cxScreenCanvas.FontHeight(HeaderFont),
      GetGroupCaptionSignSize.cy));
  end;
end;
...
begin
  Result := (ActiveGroupViewInfo <> nil) and
    not NavBar.OptionsBehavior.Common.AllowChildGroups;
end;
...
function TdxNavBarViewInfo.CanHasVisibleItemsInGroup
  (AGroup: TdxNavBarGroup): Boolean;
begin
  Result := (AGroup = NavBar.ActiveGroup) or (AGroup.Parent <> nil) and
    AGroup.Expanded and CanHasVisibleItemsInGroup(AGroup.Parent);
end;
...
function TdxNavBarViewInfo.HasEnoughSpaceForScrollButtons(AScrollingAreaHeight
  : Integer): Boolean;
begin
  Result := AScrollingAreaHeight > 2 *
    (GetScrollButtonVerticalSize + GetScrollButtonVerticalEdge);
end;

function TdxNavBarViewInfo.IsBottomScrollButtonDisabled: Boolean;
begin
  Result := not((ActiveGroupViewInfo <> nil) and
    (ActiveGroupViewInfo.Infos.Count > 0) and
    (ActiveGroupViewInfo.Infos[ActiveGroupViewInfo.Infos.Count - 1].Rect.Bottom
    > ActiveGroupViewInfo.Rect.Bottom) and
    (ActiveGroupViewInfo.Group.TopVisibleLinkIndex <
    ActiveGroupViewInfo.Infos.Count - 1));
end;
...
begin
  Result := not((ActiveGroupViewInfo <> nil) and
    (ActiveGroupViewInfo.Infos.Count > 0) and
    (ActiveGroupViewInfo.Infos[0].Rect.Top < ActiveGroupViewInfo.ItemsRect.Top)
    and (ActiveGroupViewInfo.Group.TopVisibleLinkIndex > 0));
end;
...
begin
  Result := not NavBar.IsDesigning and not NavBar.IsAnimationLocked and
    NavBar.OptionsBehavior.Common.AllowExpandAnimation and
    AllowControlExpandAnimation;
end;
    ...
    case GetGripSizeCorner of
      coBottomRight:
        FSizeGripRect := cxRectSetOrigin(FSizeGripRect,
          cxPoint(ClientWidth - AGripSize, ClientHeight - AGripSize));
    else // coBottomLeft
      FSizeGripRect := cxRectSetOrigin(FSizeGripRect,
        cxPoint(0, ClientHeight - AGripSize));
    end;
  end
  else
...
begin
  ...
  else if AGroup.Expandable then
  begin
...
function TdxNavBarViewInfo.GetHeaderSignAccessibilityHelperClass
  : TdxNavBarCustomAccessibilityHelperClass;
begin
  Result := TdxNavBarNavigationPaneHeaderSignAccessibilityHelper;
end;

function TdxNavBarViewInfo.GetPartIAccessibilityHelper
...
begin
  Result := PtInRect(GroupsArea, pt) and
    not(IsPtBottomScrollButton(pt) or IsPtTopScrollButton(pt));
end;

function TdxNavBarViewInfo.IsPtSizeGrip(const pt: TPoint): Boolean;
begin
  Result := not(IsPtBottomScrollButton(pt) or IsPtTopScrollButton(pt)) and
    cxRectPtIn(SizeGripRect, pt);
end;
...
procedure TdxNavBarViewInfo.CheckControlWindowRegion
  (AGroup: TdxNavBarGroupViewInfo);
begin
  // do nothing
end;
...
procedure TdxNavBarViewInfo.CalculateScrollBarBoundsBySizeGrip
  (var ABounds: TRect);
begin
...
procedure TdxNavBarViewInfo.SetGroupControlWindowRegion(const AClipRect: TRect;
AGroup: TdxNavBarGroupViewInfo);
var
...
begin
  ...
  begin
    ...
    SetWindowRegion(AGroup.Control, cxRectOffset(AControlVisibleRect,
      AGroup.ControlRect.TopLeft, False));
  end
  else
...
begin
  ...
  OffsetRect(Result, -GetScrollButtonHorizontalEdge,
    IfThen(APosition = TcxAlignmentVert.vaTop, 1, -1) *
    GetScrollButtonVerticalEdge);
end;
...
begin
  ...
  begin
    ...
    OffsetRect(Result, 0, cxRectHeight(GetScrollButtonsBounds) -
      GetScrollButtonVerticalSize);
  end;
end;
...
procedure TdxNavBarViewInfo.AddGroup(AViewInfo: TdxNavBarViewInfo;
AGroup: TdxNavBarGroup; ACaptionVisible, AItemsVisible: Boolean);
begin
  FGroups.Add(Painter.CreateGroupViewInfo(AViewInfo, AGroup, ACaptionVisible,
    AItemsVisible));
end;
...
begin
  ...
  FActivateGroupTimer := cxCreateTimer(DoActivateGroupTimer,
    dxNavBarActivateGroupInterval, False);
  RecreateScrollTimer;
  ...
  FNavigationControlListeners :=
    TList<IdxFluentDesignNavigationControlListener>.Create;
  ...
  FGroupExpandAnimationController :=
    TdxNavBarGroupAnimationController.Create(Self);
  FExpandAnimationController := TdxNavBarInlineExpandAnimationController.
    Create(Self);
...
begin
  ...
  NavBarAccessibleObjectOwnerObjectDestroyed
    (FGroupContainerIAccessibilityHelper);
  NavBarAccessibleObjectOwnerObjectDestroyed(FIAccessibilityHelper);
...
procedure TdxCustomNavBar.InternalDoLinkHotTrack(ANavBar: TdxCustomNavBar;
ALink: TdxNavBarItemLink);
begin
  Controller.DoLinkHotTrack(ANavBar, ALink);
end;

procedure TdxCustomNavBar.DoMouseDown(AButton: TMouseButton;
AShift: TShiftState; const APoint: TPoint);
begin
  Controller.MouseDown(AButton, AShift, APoint);
end;

procedure TdxCustomNavBar.DoMouseMove(AShift: TShiftState;
const APoint: TPoint);
begin
...
function TdxCustomNavBar.GetActualGroupViewInfoByGroup(AGroup: TdxNavBarGroup)
  : TdxNavBarGroupViewInfo;
begin
  Result := ViewInfo.GetGroupViewInfoByGroup(AGroup);
end;

function TdxCustomNavBar.GetActualLinkViewInfoByLink(ALink: TdxNavBarItemLink)
  : TdxNavBarLinkViewInfo;
begin
  Result := ViewInfo.GetLinkViewInfoByLink(ALink);
end;

procedure TdxCustomNavBar.DoCustomDrawBackground(Sender: TObject;
ACanvas: TCanvas; AViewInfo: TdxNavBarViewInfo; var AHandled: Boolean);
begin
  OnCustomDrawBackground(Sender, ACanvas, AViewInfo, AHandled);
end;

procedure TdxCustomNavBar.DoCustomDrawGroupCaption(Sender: TObject;
ACanvas: TCanvas; AViewInfo: TdxNavBarGroupViewInfo; var AHandled: Boolean);
begin
  OnCustomDrawGroupCaption(Sender, ACanvas, AViewInfo, AHandled);
end;

procedure TdxCustomNavBar.DoCustomDrawGroupClientBackground(Sender: TObject;
ACanvas: TCanvas; AViewInfo: TdxNavBarGroupViewInfo; var AHandled: Boolean);
begin
  OnCustomDrawGroupClientBackground(Sender, ACanvas, AViewInfo, AHandled);
end;

procedure TdxCustomNavBar.DoCustomDrawGroupClientForeground(Sender: TObject;
ACanvas: TCanvas; AViewInfo: TdxNavBarGroupViewInfo; var AHandled: Boolean);
begin
  OnCustomDrawGroupClientForeground(Sender, ACanvas, AViewInfo, AHandled);
end;

procedure TdxCustomNavBar.DoCustomDrawGroupHint(Sender: TObject;
ACanvas: TCanvas; AGroup: TdxNavBarGroup; AHint: string; R: TRect;
var AHandled: Boolean);
begin
...
begin
  Result := not IsLoading and not IsUpdateLocked and
    OptionsBehavior.Common.AllowExpandAnimation and
    ViewInfo.AllowExpandAnimation and CheckGroupAlign and
    (ViewInfo.GroupCount > 0);
end;
...
procedure TdxCustomNavBar.CheckBounds(var ALeft, ATop, AWidth,
  AHeight: Integer);
begin
  LockBoundsChecking;
  try
...
begin
  dxTestCheck((Painter <> nil) and Painter.IsViewInfoValid,
    'CheckCollapseState');
...
begin
  if (FocusedAccessibleObject <> nil) and not FocusedAccessibleObject.CanFocus
    (False) then
...
procedure TdxCustomNavBar.DefineProperties(Filer: TFiler);
  ...
  begin
    ...
    if Filer.Ancestor is TdxCustomNavBar then
      Result := Result and (OriginalWidth <> TdxCustomNavBar(Filer.Ancestor)
        .OriginalWidth);
  end;
  ...
  begin
    ...
    if Filer.Ancestor is TdxCustomNavBar then
      Result := Result and (OriginalHeight <> TdxCustomNavBar(Filer.Ancestor)
        .OriginalHeight);
  end;
...
function TdxCustomNavBar.GetDesignHitTest(X, Y: Integer;
...
procedure TdxCustomNavBar.Notification(AComponent: TComponent;
Operation: TOperation);
begin
  inherited Notification(AComponent, Operation);
  if (Operation = opRemove) and (Customization <> nil) and
    (Customization.Form = AComponent) then
...
procedure TdxCustomNavBar.PaintNonClientArea(ACanvas: TcxCanvas);
  ...
  begin
    ...
    LookAndFeelPainter.DrawScaledScrollBarBackground(ACanvas, ABounds, False,
      ScaleFactor);
  end;
...
begin
  for AChildKind := Low(TdxNavBarChildKind) to High(TdxNavBarChildKind) do
    case AChildKind of
      ...
      nbckGroupControl:
        for I := 0 to Groups.Count - 1 do
          if (Groups[I].Control <> nil) and (Groups[I].Control.Owner = Root)
          then
...
begin
  ...
  begin
    ...
    else if (AValue = nil) or not AValue.Visible then
    begin
      AValue := GetSuitableForActivatingGroup(False);
      if AValue = nil then
        AllowActivateGroup(AValue);
    end
    else if not AllowActivateGroup(AValue) then
    begin
...
begin
  ...
  begin
    ...
    if ADeltaY <> 0 then
    begin
      GestureHelper.CheckOverpan(ScrollBar.Kind, ANewPos, ScrollBar.Min,
        ScrollBar.Max - ScrollBar.PageSize + 1, ADeltaX, ADeltaY);
...
function TdxCustomNavBar.FluentDesignNavigationControlGetBackgroundColor
  : TdxAlphaColor;
begin
  Result := GetAcrylicBackgroundColor;
end;

function TdxCustomNavBar.FluentDesignNavigationControlGetBorderColor
  : TdxAlphaColor;
begin
  Result := Painter.GetAcrylicBorderColor;
end;

function TdxCustomNavBar.FluentDesignNavigationControlGetDisplayMode
  : TdxFluentDesignNavigationControlDisplayMode;
begin
  Result := TdxFluentDesignNavigationControlDisplayMode
    (OptionsBehavior.HamburgerMenu.DisplayMode);
end;

function TdxCustomNavBar.
  FluentDesignNavigationControlGetForegroundColor: TColor;
begin
  Result := Painter.GetAcrylicForegroundColor;
end;

function TdxCustomNavBar.FluentDesignNavigationControlGetAcrylicEnabled
  : Boolean;
begin
  Result := Painter.AllowAcrylicBackground;
end;

procedure TdxCustomNavBar.FluentDesignNavigationControlAddListener
  (AListener: IdxFluentDesignNavigationControlListener);
begin
  FNavigationControlListeners.Add(AListener);
end;

procedure TdxCustomNavBar.FluentDesignNavigationControlRemoveListener
  (AListener: IdxFluentDesignNavigationControlListener);
begin
...
procedure TdxCustomNavBar.FluentDesignNavigationControlSetDisplayMode
  (AValue: TdxFluentDesignNavigationControlDisplayMode);
var
...
begin
  ...
  try
    ...
    OptionsBehavior.HamburgerMenu.DisplayMode :=
      TdxNavBarHamburgerMenuDisplayMode(AValue);
    if (AValue = ncdmInline) and (APreviousDisplayModeValue <> dmInline) then
...
procedure TdxCustomNavBar.AcrylicHostControlChanged
...
begin
  ...
  begin
    ...
    begin
      ...
      ABackgroundColor := dxColorToAlphaColor
        (Painter.GetBackgroundColorForComposition);
      A := Trunc(255 * (ACompositionLayerAlpha - TdxAlphaColors.Alpha
        (FAcrylicHostColor)) / (255 - TdxAlphaColors.Alpha(FAcrylicHostColor)));
      ABackOpacity := TdxAlphaColors.Alpha(FAcrylicHostColor);
      R := Trunc((255 * TdxAlphaColors.R(ABackgroundColor) -
        TdxAlphaColors.R(FAcrylicHostColor) * ABackOpacity) / A);
      G := Trunc((255 * TdxAlphaColors.G(ABackgroundColor) -
        TdxAlphaColors.G(FAcrylicHostColor) * ABackOpacity) / A);
      B := Trunc((255 * TdxAlphaColors.B(ABackgroundColor) -
        TdxAlphaColors.B(FAcrylicHostColor) * ABackOpacity) / A);
      ...
      FAcrylicBackgroundColor := TdxAlphaColors.FromArgb
        (Math.Max(0, Math.Min(255, A)), Math.Max(0, Math.Min(255, R)),
...
begin
  Result := FAcrylicHostEnabled and
    FluentDesignNavigationControlGetAcrylicEnabled;
end;

procedure TdxCustomNavBar.NotifyNavigationControlListeners
  (AChanges: TdxFluentDesignNavigationControlChangeTypes);
var
  AListener: IdxFluentDesignNavigationControlListener;
begin
...
function TdxCustomNavBar.GetNavigationClientItems
  : IEnumerable<IdxNavigationItem>;
begin
  Result := Groups;
end;

procedure TdxCustomNavBar.SetNavigationClientSelectedItem
...
procedure TdxCustomNavBar.AddNavigationClientListener
  (AListener: IdxNavigationClientListener);
begin
...
begin
  Result := inherited CanFocusOnClick(X, Y) and
    Controller.CanFocusOnClick(Point(X, Y));
end;
...
begin
  ...
  if not IsDesigning and (FocusedAccessibleObject = nil) then
    FocusedAccessibleObject :=
      IAccessibilityHelper.GetNextObjectForNavigation(dirNone);
end;
...
begin
  ...
  else if (Key <> 0) and (FocusedAccessibleObject <> nil) then
...
procedure TdxCustomNavBar.MouseDown(Button: TMouseButton; Shift: TShiftState;
X, Y: Integer);
var
...
begin
  ...
  begin
    if IsDesigning or IsPtBottomScrollButton(Point(X, Y)) or
      IsPtTopScrollButton(Point(X, Y)) then
    ...
    begin
      ...
      if (AAccessibleObject <> nil) and
        AAccessibleObject.GetHelper.IsOwnerObjectLive and
...
procedure TdxCustomNavBar.MouseUp(Button: TMouseButton; Shift: TShiftState;
X, Y: Integer);
var
  ALinkSelf: TcxObjectLink;
begin
  if EnableDragging then
    Exit;
...
procedure TdxCustomNavBar.DragOver(Source: TObject; X, Y: Integer;
...
begin
  ...
  if (State = dsDragLeave) and not(WindowFromPoint(GetMouseCursorPos)
    = Self.Handle) then
  begin
    FTargetPoint := cxInvalidPoint;
    UpdateTargets(Self);
...
begin
  if dxNavBarDragObject = nil then
    dxNavBarDragObject := TdxNavBarDragObject.Create(Self,
      DragObject { deprecated } , FSourceGroup, FSourceLink, nil);
...
begin
  ...
  begin
    if ScrollButtonUpIsDown and not(sDisabled in ViewInfo.TopScrollButtonState)
    then
      Controller.DoScrollUpByTimer;
    if ScrollButtonDownIsDown and
      not(sDisabled in ViewInfo.BottomScrollButtonState) then
...
procedure TdxCustomNavBar.DoGroupDragOver(Group: TdxNavBarGroup;
var Accept: Boolean);
begin
...
procedure TdxCustomNavBar.DoLinkClick(ANavBar: TdxCustomNavBar;
ALink: TdxNavBarItemLink);
begin
...
procedure TdxCustomNavBar.DoLinkDragOver(Link: TdxNavBarItemLink;
var Accept: Boolean);
begin
  Accept := CheckDragDropAccept;
end;
...
procedure TdxCustomNavBar.DoLinkPress(ANavBar: TdxCustomNavBar;
ALink: TdxNavBarItemLink);
begin
...
procedure TdxCustomNavBar.DrawContentWithChildren(ACanvas: TcxCanvas;
const AOrigin: TPoint; AChangeExpandStateGroups: TList<TdxNavBarGroup>);
...
begin
  ...
  try
    ...
    begin
      ...
      if (AControl <> nil) and
        (Groups[I].Expanded or (AChangeExpandStateGroups <> nil) and
        (AChangeExpandStateGroups.IndexOf(Groups[I]) <> -1)) and Groups[I].ShowControl
      then
      begin
        ...
        begin
          ...
          cxPaintControlTo(Groups[I].Control, ACanvas,
            AGroupInfo.ControlRect.TopLeft,
...
procedure TdxCustomNavBar.RecreateImage(var AImage: TdxSmartImage;
AChangeExpandStateGroups: TList<TdxNavBarGroup>);
var
  ABitmap: TcxBitmap;
  ACanvas: TcxCanvas;
...
begin
  ...
  try
    ...
    DrawContentWithChildren(ACanvas, ViewInfo.Groups[0].Rect.TopLeft,
      AChangeExpandStateGroups);
    FreeAndNil(AImage);
    AImage := TdxSmartImage.CreateFromBitmap(ABitmap);
  finally
    ABitmap.Free;
...
procedure TdxCustomNavBar.ExpandStateChanged(AGroup: TdxNavBarGroup);
  ...
  procedure FillStartImageInfoState(AImageInfo: TdxNavBarGroupAnimatedImageInfo;
  const ARect: TRect);
  var
  ...
  procedure FillEndImageInfoState(AImageInfo: TdxNavBarGroupAnimatedImageInfo;
  const ARect: TRect);
  ...
  begin
    ...
    begin
      ...
      AImageInfo.SourceBounds :=
        cxRectOffset(GetSourceBounds(AImageInfo.EndState),
        FNavBarGroupOffsetAfterExpanding, False);
    end
    else
    begin
      AImageInfo.Image := FNavBarImageBeforeExpanding;
      AImageInfo.SourceBounds :=
        cxRectOffset(GetSourceBounds(AImageInfo.StartState),
        FNavBarGroupOffsetBeforeExpanding, False);
    end;
  end;
  ...
  begin
    ...
    begin
      AGroupInfo := ViewInfo.GetGroupViewInfoByGroup
        (FChangeExpandStateGroups[I]);
...
procedure TdxCustomNavBar.DoItemDragOver(Item: TdxNavBarItem;
var Accept: Boolean);
begin
  Accept := CheckDragDropAccept;
end;
...
begin
  Result := (FDesignHelper <> nil) and FDesignHelper.IsObjectSelected
    (Self, AObject);
end;
...
procedure TdxCustomNavBar.OnGroupsChanged(Sender: TObject;
...
procedure TdxCustomNavBar.OnItemsChanged(Sender: TObject;
AItem: TcxComponentCollectionItem; AAction: TcxComponentCollectionNotification);
begin
  Customization.RefreshItems;
...
procedure TdxCustomNavBar.OnLinksChanged(Sender: TObject;
ALink: TdxNavBarItemLink);
begin
...
procedure TdxCustomNavBar.DoActiveGroupChanging(ANewGroup: TdxNavBarGroup;
...
begin
  Result := True;
  if IsPtTopScrollButton(FTargetPoint) or IsPtBottomScrollButton(FTargetPoint)
  then
    FScrollTimer.Enabled := True
  else
  begin
...
procedure TdxCustomNavBar.LoadFromRegIni(AStorage: TCustomIniFile;
LoadStyles: Boolean);
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        AlphaBlending2 := ReadInteger(ASection, 'AlphaBlending2',
          AlphaBlending2);
        ...
        Font.Pitch := TFontPitch(ReadInteger(ASection, 'FontPitch',
          Integer(Font.Pitch)));
        ...
        if ReadBool(ASection, 'FontStyleUnderline', fsUnderline in Font.Style)
        then
          Font.Style := Font.Style + [fsUnderline];
        if ReadBool(ASection, 'FontStyleStrikeOut', fsStrikeOut in Font.Style)
        then
          Font.Style := Font.Style + [fsStrikeOut];
        GradientMode := TdxBarStyleGradientMode
          (ReadInteger(ASection, 'GradientMode', Integer(GradientMode)));
        ...
        begin
          ...
          try
            AStream.Position := 0;
            AGraphicClass :=
              TGraphicClass(GetClass(ReadString(ASection, 'ImageClass', '')));
        ...
        HAlignment := TdxBarStyleHAlignment(ReadInteger(ASection, 'HAlignment',
          Integer(HAlignment)));
        VAlignment := TdxBarStyleVAlignment(ReadInteger(ASection, 'VAlignment',
          Integer(VAlignment)));
  ...
  function GetCustomItem(ACollection: TdxNavBarCustomItems;
  const ASection: string): TdxNavBarCustomItem;
  var
...
begin
  ...
  AActiveGroupIndex := AStorage.ReadInteger('Layout', 'ActiveGroup',
    ActiveGroupIndex);
  ...
  begin
    if AStorage.ValueExists('Layout', 'StyleBackgroundStyleIndex') then
      StyleBackground := Styles[AStorage.ReadInteger('Layout',
        'StyleBackgroundStyleIndex', 0)];
    if AStorage.ValueExists('Layout', 'StyleButtonStyleIndex') then
      StyleButton := Styles[AStorage.ReadInteger('Layout',
        'StyleButtonStyleIndex', 0)];
    if AStorage.ValueExists('Layout', 'StyleButtonHotTrackedStyleIndex') then
      StyleButtonHotTracked :=
        Styles[AStorage.ReadInteger('Layout',
        'StyleButtonHotTrackedStyleIndex', 0)];
    if AStorage.ValueExists('Layout', 'StyleButtonPressedStyleIndex') then
      StyleButtonPressed :=
        Styles[AStorage.ReadInteger('Layout',
        'StyleButtonPressedStyleIndex', 0)];
    if AStorage.ValueExists('Layout', 'StyleDropTargetGroupStyleIndex') then
      StyleDropTargetGroup :=
        Styles[AStorage.ReadInteger('Layout',
        'StyleDropTargetGroupStyleIndex', 0)];
    if AStorage.ValueExists('Layout', 'StyleDropTargetLinkStyleIndex') then
      StyleDropTargetLink :=
        Styles[AStorage.ReadInteger('Layout',
        'StyleDropTargetLinkStyleIndex', 0)];
    if AStorage.ValueExists('Layout', 'StyleHintStyleIndex') then
      StyleHint := Styles[AStorage.ReadInteger('Layout',
        'StyleHintPressedStyleIndex', 0)];
    if AStorage.ValueExists('Layout', 'StyleNavigationPaneHeaderStyleIndex')
    then
      StyleNavigationPaneHeader :=
        Styles[AStorage.ReadInteger('Layout',
        'StyleNavigationPaneHeaderStyleIndex', 0)];
  end;
end;

procedure TdxCustomNavBar.SaveToRegIni(AStorage: TCustomIniFile;
SaveStyles: Boolean);
      ...
      begin
        ...
        begin
          ...
          try
            ...
            BinToHex(PChar(AStream.DataString), PChar(AText),
              Length(AStream.DataString));
  ...
  begin
    ...
    begin
      ...
      if AItem.StyleDisabled <> nil then
        AStorage.WriteInteger(ASection, 'StyleDisabledStyleIndex',
          AItem.StyleDisabled.Index);
      if AItem.StyleHotTracked <> nil then
        AStorage.WriteInteger(ASection, 'StyleHotTrackedStyleIndex',
          AItem.StyleHotTracked.Index);
      if AItem.StylePressed <> nil then
        AStorage.WriteInteger(ASection, 'StylePressedStyleIndex',
          AItem.StylePressed.Index);
    end;
  ...
  begin
    ...
    try
      ...
      for I := 0 to ASections.Count - 1 do
        if (Pos('Layout', ASections[I]) > 0) or (Pos('Group', ASections[I]) > 0)
          or (Pos('Item', ASections[I]) > 0) or (Pos('Style', ASections[I]) > 0)
        then
    ...
    begin
      if StyleBackground <> nil then
        WriteInteger('Layout', 'StyleBackgroundStyleIndex',
      ...
      if StyleButtonHotTracked <> nil then
        WriteInteger('Layout', 'StyleButtonHotTrackedStyleIndex',
          StyleButtonHotTracked.Index);
      if StyleButtonPressed <> nil then
        WriteInteger('Layout', 'StyleButtonPressedStyleIndex',
          StyleButtonPressed.Index);
      if StyleDropTargetGroup <> nil then
        WriteInteger('Layout', 'StyleDropTargetGroupStyleIndex',
          StyleDropTargetGroup.Index);
      if StyleDropTargetLink <> nil then
        WriteInteger('Layout', 'StyleDropTargetLinkStyleIndex',
          StyleDropTargetLink.Index);
      if StyleHint <> nil then
        WriteInteger('Layout', 'StyleHintStyleIndex', StyleHint.Index);
      if StyleNavigationPaneHeader <> nil then
        WriteInteger('Layout', 'StyleNavigationPaneHeaderStyleIndex',
          StyleNavigationPaneHeader.Index);
    end;
    WriteInteger('Layout', 'ActiveGroup', ActiveGroupIndex);
    WriteInteger('Layout', 'NavigationPaneMaxVisibleGroups',
      NavigationPaneMaxVisibleGroups);
  end;
end;

function TdxCustomNavBar.CreatePainter: TdxNavBarPainter;
begin
  Result := dxNavBarViewsFactory.PainterClasses
    [dxNavBarViewsFactory.IndexOfID(GetViewReal)].Create(Self);
end;

function TdxCustomNavBar.GetAccessibilityHelperClass
  : TdxNavBarCustomAccessibilityHelperClass;
begin
  Result := TdxNavBarAccessibilityHelper;
end;

function TdxCustomNavBar.GetGroupContainerAccessibilityHelperClass
  : TdxNavBarCustomAccessibilityHelperClass;
begin
...
begin
  FreeAndNil(FScrollTimer);
  FScrollTimer := cxCreateTimer(DoScrollTimer,
    Controller.GetScrollButtonsTimerInterval, False);
end;
...
begin
  if IsLoading then
    Result := 0
  else if NavigationPaneMaxVisibleGroups = -1 then
    Result := 0
  else
...
function TdxCustomNavBar.GetGroupContainerIAccessibilityHelper
  : IdxNavBarAccessibilityHelper;
begin
  if FGroupContainerIAccessibilityHelper = nil then
    FGroupContainerIAccessibilityHelper := NavBarGetAccessibilityHelper
      (GetGroupContainerAccessibilityHelperClass.Create(Self, Self));
...
begin
  if (Value <> nil) and Value.Visible and (Value.Parent = nil) and
    AllowActivateGroup(Value) then
...
procedure TdxCustomNavBar.SetFocusedAccessibleObject
  ...
  function GetAccessibilityHelper(AAccessibleObject
    : IdxNavBarAccessibilityHelper): TdxNavBarAccessibilityHelper;
  begin
...
begin
  if GetAccessibilityHelper(FFocusedAccessibleObject) <> GetAccessibilityHelper
    (Value) then
  begin
...
function TdxCustomNavBar.GetOnNavigationPanePopupShowing
  : TdxNavBarNavigationPaneShowingPopupEvent;
begin
  Result := FOnPopupShowing;
end;

procedure TdxCustomNavBar.SetOnNavigationPaneCollapsed
  (const Value: TNotifyEvent);
begin
  FOnCollapsed := Value;
end;

procedure TdxCustomNavBar.SetOnNavigationPaneExpanded
  (const Value: TNotifyEvent);
begin
  FOnExpanded := Value;
end;

procedure TdxCustomNavBar.SetOnNavigationPanePopupShowed
  (const Value: TNotifyEvent);
begin
  FOnPopupShowed := Value;
end;

procedure TdxCustomNavBar.SetOnNavigationPanePopupShowing
  (const Value: TdxNavBarNavigationPaneShowingPopupEvent);
begin
...
function TdxCustomNavBar.GetSuitableForActivatingGroup(AAllowedOnly: Boolean)
  : TdxNavBarGroup;
var
  I: Integer;
...
procedure TdxCustomNavBar.SetNavigationPaneOverflowPanelUseSmallImages
  (const Value: Boolean);
begin
  OptionsView.NavigationPane.OverflowPanelUseSmallImages := Value;
end;

procedure TdxCustomNavBar.SetShowNavigationPaneOverflowPanelHints
  (const Value: Boolean);
begin
...
procedure TdxCustomNavBar.SetLookAndFeelSchemes(const Value
  : TdxNavBarLookAndFeelSchemes);
begin
...
function TdxCustomNavBar.GetOnCustomDrawBottomScrollButton
  : TdxNavBarCustomDrawEvent;
begin
  Result := OnCustomDraw.BottomScrollButton;
end;

function TdxCustomNavBar.GetOnCustomDrawGroupCaption
  : TdxNavBarCustomDrawGroupEvent;
begin
  Result := OnCustomDraw.GroupCaption;
end;

function TdxCustomNavBar.GetOnCustomDrawGroupClientBackground
  : TdxNavBarCustomDrawGroupEvent;
begin
  Result := OnCustomDraw.GroupClientBackground;
end;

function TdxCustomNavBar.GetOnCustomDrawGroupClientForeground
  : TdxNavBarCustomDrawGroupEvent;
begin
  Result := OnCustomDraw.GroupClientForeground;
end;

function TdxCustomNavBar.GetOnCustomDrawGroupHint
  : TdxNavBarCustomDrawGroupHintEvent;
begin
...
function TdxCustomNavBar.GetOnCustomDrawLinkHint
  : TdxNavBarCustomDrawLinkHintEvent;
begin
  Result := OnCustomDraw.LinkHint;
end;

function TdxCustomNavBar.GetOnCustomDrawNavigationPaneHeader
  : TdxNavBarCustomDrawEvent;
begin
  Result := OnCustomDraw.NavigationPaneHeader;
end;

function TdxCustomNavBar.GetOnCustomDrawNavigationPaneOverflowPanel
  : TdxNavBarCustomDrawEvent;
begin
  Result := OnCustomDraw.NavigationPaneOverflowPanel;
end;

function TdxCustomNavBar.GetOnCustomDrawNavigationPaneOverflowPanelHint
  : TdxNavBarCustomDrawGroupHintEvent;
begin
  Result := OnCustomDraw.NavigationPaneOverflowPanelHint;
end;

function TdxCustomNavBar.GetOnCustomDrawNavigationPaneSplitter
  : TdxNavBarCustomDrawEvent;
begin
  Result := OnCustomDraw.NavigationPaneSplitter;
end;

function TdxCustomNavBar.GetOnCustomDrawTopScrollButton
  : TdxNavBarCustomDrawEvent;
begin
...
procedure TdxCustomNavBar.SetOnCustomDrawLink(const Value
  : TdxNavBarCustomDrawLinkEvent);
begin
...
function TdxCustomNavBar.GetNavBarCustomStyle(Index: Integer)
  : TdxNavBarStyleItem;
begin
...
procedure TdxCustomNavBar.SetNavBarCustomStyle(Index: Integer;
const Value: TdxNavBarStyleItem);
begin
...
procedure TdxCustomNavBar.LoadFromIniFile(AFileName: string;
LoadStyles: Boolean = True);
var
  AStream: TFileStream;
begin
...
procedure TdxCustomNavBar.LoadFromRegistry(ARegistryPath: string;
LoadStyles: Boolean = True);
var
...
procedure TdxCustomNavBar.LoadFromStream(AStream: TStream;
LoadStyles: Boolean = True);
var
...
procedure TdxCustomNavBar.SaveToIniFile(AFileName: string;
SaveStyles: Boolean = True);
var
  AStream: TFileStream;
begin
  if AFileName = '' then
...
procedure TdxCustomNavBar.SaveToRegistry(ARegistryPath: string;
SaveStyles: Boolean = True);
var
  Storage: TRegistryIniFile;
begin
...
procedure TdxCustomNavBar.SaveToStream(AStream: TStream;
SaveStyles: Boolean = True);
var
  AStorage: TdxMemIniFile;
begin
...
function TdxCustomNavBar.GetLinkAtSelectedPos(const pt: TPoint)
  : TdxNavBarItemLink;
begin
...
begin
  Result := ShowGroupCaptions and
    (NavigationPaneOverflowPanelItemCount < VisibleGroupCount);
end;
...
begin
  ...
  else if (SourceLink <> nil) and (not ACheckAllowDragDrop or IsAllowDropLink)
  then
    DoLinkDragDrop(SourceLink)
  else if (SourceGroup <> nil) and (not ACheckAllowDragDrop or IsAllowDropGroup)
  then
...
begin
  ...
  begin
    ...
    if (AObjectID = OBJID_CLIENT) or (AObjectID = OBJID_WINDOW) then
      Message.Result := WMGetObjectResultFromIAccessibilityHelper(Message,
        IAccessibilityHelper)
    else if (AObjectID > 0) and (AObjectID <= Cardinal(FAccessibleObjects.Count))
    then
      Message.Result := WMGetObjectResultFromIAccessibilityHelper(Message,
        FAccessibleObjects.Items[AObjectID - 1])
    else
      inherited;
  end
  else
...
begin
  ...
  begin
    ...
    ScrollBar.Bounds := cxRectOffset(AScrollBarRect,
      Message.CalcSize_Params^.rgrc[0].TopLeft, False);
  end
  else
...
procedure TdxCustomNavBar.WMSetCursor(var Msg: TWMSetCursor);
  ...
  begin
    ...
    begin
      ...
      else if HotTrackedLink <> nil then
...
begin
  if IsDesigning or (Screen.Cursor <> crDefault) or EnableDragging or not IsCursorAssigned
  then
    inherited;
end;
...
procedure TdxCustomNavBar.WMWindowPosChanged(var Message: TWMWindowPosChanged);
  ...
  begin
    Result := Message.WindowPos.Flags and
      (SWP_SHOWWINDOW or SWP_HIDEWINDOW) <> 0;
  end;
...
procedure TdxCustomNavBar.WMWindowPosChanging(var Message
...
begin
  if (ComponentState * [csReading, csLoading] = []) and IsSizeChanging and
    (FPainter <> nil) then
...
begin
  ...
  begin
    ...
    FActiveGroupScrollBar := TdxNavBarGroupPopupScrollBar.Create(Self,
      sbVertical);
  end
  else
  begin
...
procedure TdxNavBarImageOptions.SetImageList(var ANewValue,
...
procedure TdxNavBarSideBarBehaviorOptions.SetEachGroupHasSelectedLink
  (Value: Boolean);
begin
...
procedure TdxNavBarBehaviorOptions.SetCommon
  (AValue: TdxNavBarCommonBehaviorOptions);
begin
  if FCommon <> AValue then
    FCommon.Assign(AValue);
end;

procedure TdxNavBarBehaviorOptions.SetHamburgerMenu
  (AValue: TdxNavBarHamburgerMenuBehaviorOptions);
begin
  if FHamburgerMenu <> AValue then
    FHamburgerMenu.Assign(AValue);
end;

procedure TdxNavBarBehaviorOptions.SetNavigationPane
  (AValue: TdxNavBarNavigationPaneBehaviorOptions);
begin
  if FNavigationPane <> AValue then
    FNavigationPane.Assign(AValue);
end;

procedure TdxNavBarBehaviorOptions.SetSideBar
  (AValue: TdxNavBarSideBarBehaviorOptions);
begin
...
begin
  ...
  begin
    ...
    ShowActiveGroupCaptionWhenCollapsed :=
      ASourceOptions.ShowActiveGroupCaptionWhenCollapsed;
...
procedure TdxNavBarNavigationPaneViewOptions.SetMaxVisibleGroups
  (Value: Integer);
begin
  Value := Max(Value, -1);
...
procedure TdxNavBarNavigationPaneViewOptions.SetOverflowPanelUseSmallImages
  (Value: Boolean);
begin
...
procedure TdxNavBarNavigationPaneViewOptions.
  SetShowActiveGroupCaptionWhenCollapsed(Value: Boolean);
begin
...
procedure TdxNavBarNavigationPaneViewOptions.SetShowHeader
...
procedure TdxNavBarNavigationPaneViewOptions.SetShowOverflowPanel
  (const AValue: Boolean);
begin
...
procedure TdxNavBarHamburgerMenuViewOptions.SetChildLevelIndent
...
procedure TdxNavBarHamburgerMenuViewOptions.SetNavigationPaneMode
  (const AValue: TdxNavBarHamburgerMenuNavigationPaneMode);
begin
...
procedure TdxNavBarHamburgerMenuViewOptions.SetShowHeader
  (const AValue: Boolean);
begin
  if ShowHeader <> AValue then
  begin
...
procedure TdxNavBarHamburgerMenuViewOptions.SetShowOverflowPanel
  (const AValue: Boolean);
begin
  if ShowOverflowPanel <> AValue then
  begin
...
procedure TdxNavBarHamburgerMenuViewOptions.SetSpaceBetweenGroups
  (const AValue: Integer);
begin
...
procedure TdxNavBarViewOptions.SetExplorerBar
  (AValue: TdxNavBarExplorerBarViewOptions);
begin
  if FExplorerBar <> AValue then
    FExplorerBar.Assign(AValue)
end;

procedure TdxNavBarViewOptions.SetHamburgerMenu
  (AValue: TdxNavBarHamburgerMenuViewOptions);
begin
  if FHamburgerMenu <> AValue then
    FHamburgerMenu.Assign(AValue)
end;

procedure TdxNavBarViewOptions.SetNavigationPane
...
procedure TdxNavBarCommonBehaviorOptions.SetAllowExpandAnimation
  (const Value: Boolean);
begin
...
procedure TdxNavBarCommonBehaviorOptions.SetEachGroupHasSelectedLink
  (Value: Boolean);
begin
...
constructor TdxNavBarNavigationPaneBehaviorOptions.Create
  (ANavBar: TdxCustomNavBar);
begin
  inherited;
...
procedure TdxNavBarNavigationPaneBehaviorOptions.SetCollapsed
  (const AValue: Boolean);
begin
  if (FCollapsed <> AValue) and (not AValue or Collapsible or NavBar.IsLoading)
  then
  begin
    FCollapsed := AValue;
...
begin
  ...
  begin
    ...
    if not NavBar.IsLoading then
    begin
      Collapsed := FCollapsible and
        (NavBar.Width < NavBar.ViewInfo.GetNavBarMinExpandedWidth);
      NavBar.DoUpdateScrollBarStyle;
      NavBar.Recalculate;
    end;
  end;
...
begin
  Result := not NavBar.IsDesigning and
    (DisplayMode in [dmOverlay, dmOverlayMinimal]) and
    not NavBar.IsBoundsChecking;
end;
...
procedure TdxNavBarHamburgerMenuBehaviorOptions.SetOverlayVisible
  (const AValue: Boolean);
begin
  FIsOverlayVisible := AValue;
end;

procedure TdxNavBarHamburgerMenuBehaviorOptions.SetAllowCustomizing
  (const AValue: Boolean);
begin
...
procedure TdxNavBarHamburgerMenuBehaviorOptions.SetCollapsed
  (const AValue: Boolean);
var
  ACollapsed, AActualValue: Boolean;
begin
  if IsOverlayMode or not(IsOverlayMode or
    NavBar.ExpandAnimationController.Active) then
  begin
...
procedure TdxNavBarHamburgerMenuBehaviorOptions.SetDisplayMode
  (const AValue: TdxNavBarHamburgerMenuDisplayMode);

  function CanChangeMode: Boolean;
  begin
    Result := not NavBar.ExpandAnimationController.Active and
      (FDisplayMode <> AValue) and not((AValue = dmOverlayMinimal) and
      (NavBar.View <> dxNavBarHamburgerMenu));
  end;
...
begin
  ...
  begin
    ...
    begin
      NavBar.BeginUpdate;
      try
        AHeight := IfThen(FDisplayMode = dmOverlayMinimal,
          Max(NavBar.OriginalHeight, NavBar.Height), NavBar.Height);
...
function TdxNavBarHintWindow.CalcHintRect(MaxWidth: Integer;
...
procedure TdxNavBarCustomPopupControlViewInfo.CalculateBounds
...
function TdxNavBarCustomPopupControl.CalculatePosition
...
function TdxNavBarCustomPopupControl.GetLinkAtPos(const pt: TPoint)
  : TdxNavBarItemLink;
begin
  Result := FInnerControl.GetLinkAtPos(pt);
end;

function TdxNavBarCustomPopupControl.NeedIgnoreMouseMessageAfterCloseUp
...
procedure TdxNavBarCustomPopupControl.KeyDown(var Key: Word;
Shift: TShiftState);
begin
...
function TdxNavBarCustomPopupControl.CreatePopupViewInfo
  : TdxNavBarCustomPopupControlViewInfo;
begin
...
procedure TdxNavBarCustomPopupControl.BeginResize(AControl: TControl;
AButton: TMouseButton; AShift: TShiftState; const APoint: TPoint);
begin
  // do nothing
end;
