...
uses
  ...
  dxCore, dxCoreClasses, cxAccessibility, cxControls, cxClasses, Themes,
  cxGraphics;
...
type
  ...
  TdxNavBarItemLink = class(TCollectionItem, IUnknown, IdxAdornerTargetElement)
  private
    FData: TdxNativeInt;
  ...
  public
    ...
    property Items[Index: Integer]: TdxNavBarItemLink read GetItem
  ...
  TdxNavBarGroupControl = class(TCustomPanel, IdxAdornerRootTargetElement,
...
{$ENDIF}
  ...
  public
    ...
    property LargeImageIndex: TcxImageIndex read FLargeImageIndex
      write SetLargeImageIndex default -1;
    property SmallImageIndex: TcxImageIndex read FSmallImageIndex
      write SetSmallImageIndex default -1;
  ...
  public
    procedure Assign(Source: TPersistent); override;
  published
    property AllowControlResizing: Boolean read FAllowControlResizing
      write SetAllowControlResizing default False;
  ...
  TdxNavBarGroup = class(TdxNavBarCustomItem, IdxNavigationItem,
    IdxAdornerTargetElement)
  private
    FAlign: TcxTopBottom;
  ...
  protected
    ...
    function GetCaptionPanelAccessibilityHelperClass
      : TdxNavBarCustomAccessibilityHelperClass; virtual;
    function GetLinkContainerAccessibilityHelperClass
      : TdxNavBarCustomAccessibilityHelperClass; virtual;
  ...
  public
    ...
    function InsertLink(AItem: TdxNavBarItem; APosition: Integer)
      : TdxNavBarItemLink;
    function HasAsChild(AGroup: TdxNavBarGroup;
      AIsRecursive: Boolean = True): Boolean;
    ...
    procedure LoadFromIniFile(AStorage: TCustomIniFile; const ASection: string;
      ALoadStyles: Boolean);
    procedure SaveToIniFile(AStorage: TCustomIniFile; const ASection: string;
      ASaveStyles: Boolean);
  ...
  published
    ...
    property LinksUseSmallImages: Boolean read FLinksUseSmallImages
      write SetLinksUseSmallImages default True;
    property SelectedLinkIndex: Integer read GetSelectedLinkIndex
      write SetSelectedLinkIndex;
    property ShowAsIconView: Boolean read FShowAsIconView
      write SetShowAsIconView default False;
    property ShowCaption: Boolean read FShowCaption write SetShowCaption
      default True;
    property SmallImageIndex;
    property TopVisibleLinkIndex: Integer read FTopVisibleLinkIndex
      write SetTopVisibleLinkIndex;
    property UseRestSpace: Boolean read FUseRestSpace write SetUseRestSpace
      default False;
    property UseSmallImages: Boolean read FUseSmallImages
      write SetUseSmallImages default True;
    property Visible;
    property VisibleForCustomization: Boolean read FVisibleForCustomization
      write FVisibleForCustomization default True;

    // OptionsGroupControl
    property OptionsGroupControl: TdxNavBarGroupControlOptions
      read FOptionsGroupControl write SetOptionsGroupControl;
    property ShowControl: Boolean read GetShowControl write SetShowControl
      stored False;
    property UseControl: Boolean read GetUseControl write SetUseControl
      stored False;

    // OptionsExpand
    property OptionsExpansion: TdxNavBarGroupExpansionOptions
      read FOptionsExpansion write SetOptionsExpansion;
    ...
    property ShowExpandButton: Boolean read GetShowExpandButton
      write SetShowExpandButton stored False;

    // Styles
    property CustomStyles: TdxNavBarGroupCustomStyles read FCustomStyles
      write SetCustomStyles;
    property StyleBackground: TdxNavBarStyleItem index 0 read GetCustomStyle
      write SetCustomStyle stored False;
    property StyleControl: TdxNavBarStyleItem index 1 read GetCustomStyle
      write SetCustomStyle stored False;
    property StyleHeader: TdxNavBarStyleItem index 2 read GetCustomStyle
      write SetCustomStyle stored False;
    property StyleHeaderActive: TdxNavBarStyleItem index 3 read GetCustomStyle
      write SetCustomStyle stored False;
    property StyleHeaderActiveHotTracked: TdxNavBarStyleItem index 4
      read GetCustomStyle write SetCustomStyle stored False;
    property StyleHeaderActivePressed: TdxNavBarStyleItem index 5
      read GetCustomStyle write SetCustomStyle stored False;
    property StyleHeaderHotTracked: TdxNavBarStyleItem index 6
      read GetCustomStyle write SetCustomStyle stored False;
    property StyleHeaderPressed: TdxNavBarStyleItem index 7 read GetCustomStyle
      write SetCustomStyle stored False;
    ...
    property OnSelectedLinkChanged: TNotifyEvent read FOnSelectedLinkChanged
      write FOnSelectedLinkChanged;
    property OnTopVisibleLinkChanged: TNotifyEvent read FOnTopVisibleLinkChanged
      write FOnTopVisibleLinkChanged;
  end;

  TdxNavBarGroupClass = class of TdxNavBarGroup;

  TdxNavBarLinksChangeEvent = procedure(Sender: TObject;
    ALink: TdxNavBarItemLink) of object;
  ...
  public
    ...
    property Items[Index: Integer]: TdxNavBarCustomItem read GetItem
      write SetItem;
  end;

  TdxNavBarGroups = class(TdxNavBarCustomItems, IUnknown,
    IEnumerable<IdxNavigationItem>, IEnumerable)
  private type
  ...
  public
    ...
    property Items[Index: Integer]: TdxNavBarGroup read GetItem
      write SetItem; default;
    property JustExpandedGroup: TdxNavBarGroup read FJustExpandedGroup
      write FJustExpandedGroup;
    ...
    property OnLinksChange: TdxNavBarLinksChangeEvent read FOnLinksChange
      write FOnLinksChange;
  end;
  ...
  protected
    ...
    class function GetCalculatorClass
      : TdxNavBarCustomGroupItemCalculatorClass; virtual;
  protected
    function GetCollectionFromParent(AParent: TComponent)
      : TcxComponentCollection; override;
    procedure StyleChanged(Sender: TObject; AType: TdxNavBarChangeType);
  ...
  published
    ...
    // Styles
    property CustomStyles: TdxNavBarItemCustomStyles read FCustomStyles
      write SetCustomStyles;
    property Style: TdxNavBarStyleItem index 0 read GetCustomStyle
      write SetCustomStyle stored False;
    property StyleDisabled: TdxNavBarStyleItem index 1 read GetCustomStyle
      write SetCustomStyle stored False;
    property StyleHotTracked: TdxNavBarStyleItem index 2 read GetCustomStyle
      write SetCustomStyle stored False;
    property StylePressed: TdxNavBarStyleItem index 3 read GetCustomStyle
      write SetCustomStyle stored False;
  ...
  public
    ...
    function Add(AItemClass
      : TcxComponentCollectionItemClass { TdxNavBarItemClass } )
      : TdxNavBarItem; overload;
    procedure LoadFromIniFile(AStorage: TCustomIniFile; ALoadStyles: Boolean);
    property Items[Index: Integer]: TdxNavBarItem read GetItem
      write SetItem; default;
  end;
...
function GetNavBar(AComponentCollectionItem: TcxComponentCollectionItem)
  : TdxCustomNavBar;
begin
...
begin
  ...
  if Result <> nil then
    Result := TdxNavBarControllerAccess(Result.Controller)
      .GetActualNavBar(AGroup);
end;
...
begin
  ...
  Filer.DefineProperty('Position', ReadPosition, WritePosition,
    NeedWritePosition);
end;

procedure TdxNavBarItemLink.InitiateAction;
begin
  if (Item <> nil) and (Item.ActionLink <> nil) then
    Item.ActionLink.Update;
end;

function TdxNavBarItemLink.IsAncestorEqual
  (AItemLink: TdxNavBarItemLink): Boolean;
begin
  Result := (AItemLink = Self) or (AItemLink <> nil) and
    ((Item = nil) and (AItemLink.Item = nil) or (Item <> nil) and
    (AItemLink.Item <> nil) and (Item.Name = AItemLink.Item.Name));
end;
...
begin
  AViewInfo := TdxCustomNavBarAccess(GetActualNavBar(Item))
    .GetActualLinkViewInfoByLink(Self);
...
begin
  ...
  Result := not ANavBar.ExpandAnimationController.Active and Item.Visible and
    (ANavBar.GetActualLinkViewInfoByLink(Self) <> nil);
end;
...
function TdxNavBarItemLink.GetIAccessibilityHelper
...
function TdxNavBarItemLinks.IsAncestorEqual(AItemLinks
  : TdxNavBarItemLinks): Boolean;
var
  I: Integer;
begin
...
begin
  ...
  case Action of
    cnAdded:
      Group.FChildren.Add(Item);
    cnExtracting:
      Group.FChildren.Remove(Item);
  end;
end;
...
procedure TdxNavBarGroupControl.BeginResize(AControl: TControl;
  AButton: TMouseButton; AShift: TShiftState; const APoint: TPoint);
begin
  if IsOnPopupControl then
    TdxNavBarPopupControlAccess(GetParentForm(Self)).BeginResize(AControl,
      AButton, AShift, APoint);
end;

procedure TdxNavBarGroupControl.ConstrainedResize(var MinWidth, MinHeight,
...
procedure TdxNavBarGroupControl.DrawSizeGrip(ACanvas: TCanvas;
  const ARect: TRect);
begin
  if GetInternalNavBar <> nil then
    TdxNavBarOffice11NavPanePainter(TdxCustomNavBar(GetInternalNavBar).Painter)
      .DrawSizeGrip(ACanvas, ARect);
end;
...
begin
  ...
  if GetInternalNavBar <> nil then
  begin
    Result := cxRectOffset(TdxNavBarOffice11NavPaneViewInfo
      (TdxCustomNavBar(GetInternalNavBar).Painter.ViewInfo).SizeGripRect,
      cxPointInvert(cxClientToParent(AControl, Result.TopLeft,
      TdxCustomNavBar(GetInternalNavBar))));
  end;
end;
...
procedure TdxNavBarGroupControl.SetBounds(ALeft, ATop, AWidth,
  AHeight: Integer);
begin
  FOriginalHeight := AHeight;
  if (Visible or (FUpdateLock > 0) and HandleAllocated) and
    ((ALeft <> Left) or (ATop <> Top) or (AWidth <> Width) or
    (AHeight <> Height)) then
  begin
...
procedure TdxNavBarGroupControl.DefineProperties(Filer: TFiler);
  ...
  begin
    Result := (Group <> nil) and (not(Filer.Ancestor is TdxNavBarGroupControl)
      or (TdxNavBarGroupControl(Filer.Ancestor).Group = nil) or
...
procedure TdxNavBarGroupControl.MouseDown(Button: TMouseButton;
...
begin
  inherited;
  MouseOverSizeGrip := IsOnPopupControl and
    PtInRect(SizeGripRect, cxPoint(X, Y));
end;
...
begin
  ...
  if (0 > FGroupIndex) or (FGroupIndex > TdxCustomNavBar(Reader.Parent)
    .Groups.Count - 1) then
    raise EdxException.Create(cxGetResourceString(@sdxInvalideGroupControl));
...
begin
  if (AParent = nil) or ((AParent is TdxCustomNavBar) and
...
begin
  if UseStyle then
  begin
    if TdxCustomNavBar(Parent).Painter.ViewInfo.GetGroupViewInfoByGroup(Group) = nil
    then
    begin
      TdxCustomNavBar(Parent).Painter.InvalidateViewInfo(doRecreate);
      TdxNavBarPainterAccess(TdxCustomNavBar(Parent).Painter)
        .CheckDrawParamChanges;
    end;
    if TdxCustomNavBar(Parent).Painter.ViewInfo.GetGroupViewInfoByGroup(Group)
      <> nil then
      TdxCustomNavBar(Parent).Painter.DrawGroupControl(Canvas, ClientRect,
        TdxCustomNavBar(Parent)
        .Painter.ViewInfo.GetGroupViewInfoByGroup(Group));
  end
...
begin
  ...
  begin
    ...
    while (AControl.Parent <> nil) and
      not(AControl.Parent is TdxNavBarPopupControl) do
      AControl := AControl.Parent;
    if (AControl.Parent is TdxNavBarPopupControl) and
      (AControl is TdxCustomNavBar) then
      Result := AControl;
  end;
end;
...
begin
  ...
  begin
    AllowMultipleGroupExpansion := TdxNavBarGroupExpansionOptions(Source)
      .AllowMultipleGroupExpansion;
...
begin
  ...
  begin
    AllowControlResizing := TdxNavBarGroupControlOptions(Source)
      .AllowControlResizing;
...
function TdxNavBarGroup.GetCollectionFromParent(AParent: TComponent)
...
begin
  ...
  begin
    ...
    raise EdxException.CreateFmt(cxGetResourceString(@sdxInvalidLink),
      [AItem.Name, Name]);
end;
...
function TdxNavBarGroup.InsertLink(AItem: TdxNavBarItem; APosition: Integer)
  : TdxNavBarItemLink;
begin
  FLinks.BeginUpdate;
  try
...
function TdxNavBarGroup.HasAsChild(AGroup: TdxNavBarGroup;
  AIsRecursive: Boolean = True): Boolean;
var
  I: Integer;
begin
  ...
  for I := 0 to ChildCount - 1 do
    if (Children[I] is TdxNavBarGroup) and
      ((Children[I] = AGroup) or AIsRecursive and TdxNavBarGroup(Children[I])
      .HasAsChild(AGroup, True)) then
    begin
      Result := True;
      Break;
    end;
...
begin
  ...
  OptionsExpansion.Expanded := AStorage.ReadBool(ASection, 'Expanded',
    Expanded);
  Hint := AStorage.ReadString(ASection, 'Hint', Hint);
  LargeImageIndex := AStorage.ReadInteger(ASection, 'LargeImageIndex',
    LargeImageIndex);
  LinksUseSmallImages := AStorage.ReadBool(ASection, 'LinksUseSmallImages',
    LinksUseSmallImages);
  ClearLinks;
  ALinkCount := AStorage.ReadInteger(ASection, 'LinkCount', 0);
  for I := 0 to ALinkCount - 1 do
  begin
    AItemIndex := AStorage.ReadInteger(ASection, 'Link' + IntToStr(I) +
      'ItemIndex', -1);
    if InRange(AItemIndex, 0, ANavBar.Items.Count - 1) then
    begin
      ALink := CreateLink(ANavBar.Items[AItemIndex]);
      if AllowChildGroups then
        ALink.FLoadedPosition := AStorage.ReadInteger(ASection,
          'Link' + IntToStr(I) + 'Position', -1);
    end;
  end;
  if AllowChildGroups then
  begin
    FLoadedPosition := AStorage.ReadInteger(ASection, 'Position', Position);
    FLoadedParentGroupIndex := AStorage.ReadInteger(ASection,
      'ParentGroupIndex', GetParentGroupIndex);
  end;
  SelectedLinkIndex := AStorage.ReadInteger(ASection, 'SelectedLinkIndex',
    SelectedLinkIndex);
  ShowAsIconView := AStorage.ReadBool(ASection, 'ShowAsIconView',
    ShowAsIconView);
  ShowExpandButton := AStorage.ReadBool(ASection, 'ShowExpandButton',
    ShowExpandButton);
  ...
  begin
    ...
    if AStorage.ValueExists(ASection, 'StyleBackgroundStyleIndex') then
      StyleBackground := AStyles[AStorage.ReadInteger(ASection,
        'StyleBackgroundStyleIndex', 0)];
    if AStorage.ValueExists(ASection, 'StyleHeaderStyleIndex') then
      StyleHeader := AStyles[AStorage.ReadInteger(ASection,
        'StyleHeaderStyleIndex', 0)];
    if AStorage.ValueExists(ASection, 'StyleHeaderActiveStyleIndex') then
      StyleHeaderActive := AStyles[AStorage.ReadInteger(ASection,
        'StyleHeaderActiveStyleIndex', 0)];
    if AStorage.ValueExists(ASection, 'StyleHeaderHotTrackedStyleIndex') then
      StyleHeaderHotTracked :=
        AStyles[AStorage.ReadInteger(ASection,
        'StyleHeaderHotTrackedStyleIndex', 0)];
    if AStorage.ValueExists(ASection, 'StyleHeaderPressedStyleIndex') then
      StyleHeaderPressed := AStyles[AStorage.ReadInteger(ASection,
        'StyleHeaderPressedStyleIndex', 0)];
    if AStorage.ValueExists(ASection, 'ChildCaption') then
      CustomStyles.ChildCaption :=
        AStyles[AStorage.ReadInteger(ASection, 'ChildCaptionStyleIndex', 0)];
    if AStorage.ValueExists(ASection, 'ChildCaptionHotTracked') then
      CustomStyles.ChildCaptionHotTracked :=
        AStyles[AStorage.ReadInteger(ASection,
        'ChildCaptionHotTrackedStyleIndex', 0)];
    if AStorage.ValueExists(ASection, 'ChildCaptionPressed') then
      CustomStyles.ChildCaptionPressed :=
        AStyles[AStorage.ReadInteger(ASection,
        'ChildCaptionPressedStyleIndex', 0)];
  end;
  Tag := AStorage.ReadInteger(ASection, 'Tag', Tag);
  TopVisibleLinkIndex := AStorage.ReadInteger(ASection, 'TopVisibleLinkIndex',
    TopVisibleLinkIndex);
  UseSmallImages := AStorage.ReadBool(ASection, 'UseSmallImages',
    UseSmallImages);
...
procedure TdxNavBarGroup.SaveToIniFile(AStorage: TCustomIniFile;
  const ASection: string; ASaveStyles: Boolean);
var
  I: Integer;
begin
  with AStorage do
  begin
    ...
    for I := 0 to LinkCount - 1 do
      ...
      begin
        WriteInteger(ASection, 'Link' + IntToStr(I) + 'ItemIndex',
          Links[I].Item.Index);
        if AllowChildGroups then
          WriteInteger(ASection, 'Link' + IntToStr(I) + 'Position',
            Links[I].Position);
      end;
    ...
    begin
      if StyleBackground <> nil then
        WriteInteger(ASection, 'StyleBackgroundStyleIndex',
      ...
      if StyleHeaderActive <> nil then
        WriteInteger(ASection, 'StyleHeaderActiveStyleIndex',
          StyleHeaderActive.Index);
      if StyleHeaderHotTracked <> nil then
        WriteInteger(ASection, 'StyleHeaderHotTrackedStyleIndex',
          StyleHeaderHotTracked.Index);
      if StyleHeaderPressed <> nil then
        WriteInteger(ASection, 'StyleHeaderPressedStyleIndex',
          StyleHeaderPressed.Index);
      if CustomStyles.ChildCaption <> nil then
        WriteInteger(ASection, 'ChildCaptionStyleIndex',
          CustomStyles.ChildCaption.Index);
      if CustomStyles.ChildCaptionHotTracked <> nil then
        WriteInteger(ASection, 'ChildCaptionHotTrackedStyleIndex',
          CustomStyles.ChildCaptionHotTracked.Index);
      if CustomStyles.ChildCaptionPressed <> nil then
        WriteInteger(ASection, 'ChildCaptionPressedStyleIndex',
          CustomStyles.ChildCaptionPressed.Index);
    end;
  ...
  begin
    ...
    begin
      ...
      Result := (AAncestorGroup.Parent = nil) and (Parent <> nil) or
        (AAncestorGroup.Parent <> nil) and (Parent = nil) or (Parent <> nil) and
        (Parent.Name <> AAncestorGroup.Parent.Name);
    end;
  end;

  function NeedWritePosition: Boolean;
  begin
    Result := AllowChildGroups and
      ((Filer.Ancestor = nil) or ((Filer.Ancestor as TdxNavBarGroup).Position <>
      Position));
  end;
...
begin
  ...
  Filer.DefineProperty('ParentGroupIndex', ReadParentGroupIndex,
    WriteParentGroupIndex, NeedWriteParentGroupIndex);
  Filer.DefineProperty('Position', ReadPosition, WritePosition,
    NeedWritePosition);
end;
...
begin
  ...
  NavBarAccessibleObjectOwnerObjectDestroyed
    (FLinkContainerIAccessibilityHelper);
end;
...
begin
  ...
  begin
    ...
    else if not FVisible and (AActiveGroup = Self) then
      TdxCustomNavBarAccess(ANavBar).TrySetActiveGroup(nil);
  end;
end;

function TdxNavBarGroup.GetAccessibilityHelperClass
  : TdxNavBarCustomAccessibilityHelperClass;
begin
  Result := TdxNavBarViewInfoAccess(GetActualNavBar(Self).ViewInfo)
    .GetGroupAccessibilityHelperClass;
end;

function TdxNavBarGroup.GetCaptionPanelAccessibilityHelperClass
  : TdxNavBarCustomAccessibilityHelperClass;
begin
  Result := TdxNavBarViewInfoAccess(GetActualNavBar(Self).ViewInfo)
...
function TdxNavBarGroup.GetLinkContainerAccessibilityHelperClass
  : TdxNavBarCustomAccessibilityHelperClass;
begin
...
procedure TdxNavBarGroup.Notification(AComponent: TComponent;
...
begin
  ...
  try
    for I := 0 to ChildCount - 1 do
      if (Children[I] is TdxNavBarGroup) and TdxNavBarGroup(Children[I]).CheckSiblingGroups
      then
        Break;
  finally
    Collection.EndUpdate;
...
procedure TdxNavBarGroup.StyleChanged(Sender: TObject;
  AType: TdxNavBarChangeType);
begin
  Changed(True);
end;
...
begin
  if (Collection = nil) or (AControl.Parent <> GetParentComponent) then
    Exit;
  FControl := AControl;
  FControl.Group := Self;
end;
...
begin
  Result := Expanded;
  if Result then
    if (Parent = nil) and not GetNavBar(Self)
      .OptionsBehavior.Common.AllowMultipleGroupExpansion or (Parent <> nil) and
      not Parent.OptionsExpansion.AllowMultipleGroupExpansion then
...
function TdxNavBarGroup.GetCaptionPanelIAccessibilityHelper
  : IdxNavBarAccessibilityHelper;
begin
...
function TdxNavBarGroup.GetLinkContainerIAccessibilityHelper
  : IdxNavBarAccessibilityHelper;
begin
...
function TdxNavBarGroup.GetAdornerTargetElementBounds: TRect;
  ...
  begin
    ...
    begin
      Result := ANavBar.ViewInfo.Groups[I].GetGroupViewInfoByGroup
        (AActualGroup);
...
begin
  ANavBar := TdxCustomNavBarAccess(GetActualNavBar(Self));
  Result := not ANavBar.ExpandAnimationController.Active and Visible and
    (ANavBar.GetActualGroupViewInfoByGroup(Self) <> nil);
end;
...
function TdxNavBarGroup.CompareChildren(AItem1, AItem2: Pointer): Integer;
  ...
  begin
    if AllowChildGroups then
      ...
      else if TObject(AItem) is TdxNavBarGroup then
...
begin
  ...
  if APosition1 = APosition2 then
    Result := 0
  else if APosition1 < APosition2 then
    Result := -1
  else
    Result := 1;
end;

procedure TdxNavBarGroup.DoSetTopVisibleLinkIndex(AValue: Integer;
  AIsCorrection: Boolean);
var
...
begin
  ...
  begin
    ...
    if not AIsCorrection then
      Changed(False);
    if not FIsSettingTopVisibleIndex or not AIsCorrection and
      (FTopVisibleLinkIndex <> APrevTopVisibleIndex) then
...
procedure TdxNavBarGroup.SetOptionsExpansion(const Value
...
begin
  ...
  begin
    if (Value < -1) or not GetNavBar(Self).AllowSelectLinks then
      Value := -1
    else if Value > LinkCount - 1 then
      Value := LinkCount - 1;
...
procedure TdxNavBarGroup.SetOptionsGroupControl(const Value
  : TdxNavBarGroupControlOptions);
begin
...
procedure TdxNavBarGroup.SetCustomStyle(Index: Integer;
...
function TdxNavBarCustomItems.ItemByCaption(const ACaption: string)
  : TdxNavBarCustomItem;
var
  I: Integer;
begin
...
procedure TdxNavBarCustomItems.SetItem(Index: Integer;
  Value: TdxNavBarCustomItem);
begin
  inherited SetItem(Index, Value);
end;

procedure TdxNavBarCustomItems.SetItemName(AItem: TcxComponentCollectionItem;
...
begin
  if FOwner.AllowChildGroups then
    if Left.FLoadedPosition = Right.FLoadedPosition then
      Result := 0
    else if Left.FLoadedPosition < Right.FLoadedPosition then
      Result := -1
    else
      Result := 1
...
constructor TdxNavBarGroups.TNavigationItemEnumerator.Create
  (AList: TList<TdxNavBarGroup>);
begin
  inherited Create;
  FList := AList;
  FIndex := -1;
...
function TdxNavBarGroups.TNavigationItemEnumerator.GetCurrentNavigationItem
  : IdxNavigationItem;
begin
...
procedure TdxNavBarGroups.LoadFromIniFile(AStorage: TCustomIniFile;
  ALoadStyles: Boolean);
...
begin
  if UpdateCount = 0 then
    if Assigned(FOnLinksChange) then
      FOnLinksChange(Self, ALink);
end;
...
begin
  ...
  begin
    ...
    begin
      ...
      else if FRootGroups <> nil then
        FRootGroups.Remove(AGroup);
    end;
  end
  else if AAction = ccnAdded then
...
function TdxNavBarGroups.GetNavigationItemEnumerator
...
procedure TdxNavBarGroups.SaveToIniFile(AStorage: TCustomIniFile;
  ASaveStyles: Boolean);
var
  I: Integer;
begin
  ...
  for I := 0 to Count - 1 do
    Items[I].SaveToIniFile(AStorage, 'Group' + IntToStr(Items[I].Index),
      ASaveStyles);
end;

function TdxNavBarGroups.AllowChildGroups: Boolean;
begin
  Result := (ParentComponent as TdxCustomNavBar)
    .OptionsBehavior.Common.AllowChildGroups;
end;
...
begin
  ...
  begin
    ...
    if AParentIndex >= 0 then
      AGroup.MoveTo(Items[AParentIndex], Min(AGroup.FLoadedPosition,
        Items[AParentIndex].ChildCount));
  end;
end;
...
class procedure TdxNavBarCustomGroupItemCalculator.CalculateBounds(X,
  Y: Integer; AScaleFactor: TdxScaleFactor; var ALinkViewInfo);
begin
  // do nothing
end;
...
function TdxNavBarItem.GetCollectionFromParent(AParent: TComponent)
  : TcxComponentCollection;
begin
...
begin
  ...
  begin
    ...
    if AStorage.ValueExists(ASection, 'StyleDisabledStyleIndex') then
      StyleDisabled := AStyles[AStorage.ReadInteger(ASection,
        'StyleDisabledStyleIndex', 0)];
    if AStorage.ValueExists(ASection, 'StyleHotTrackedStyleIndex') then
      StyleHotTracked := AStyles[AStorage.ReadInteger(ASection,
        'StyleHotTrackedStyleIndex', 0)];
    if AStorage.ValueExists(ASection, 'StylePressedStyleIndex') then
      StylePressed := AStyles[AStorage.ReadInteger(ASection,
        'StylePressedStyleIndex', 0)];
  end;
  Tag := AStorage.ReadInteger(ASection, 'Tag', Tag);
  Visible := AStorage.ReadBool(ASection, 'Visible', Visible);
end;
...
procedure TdxNavBarItem.Notification(AComponent: TComponent;
  Operation: TOperation);
begin
  inherited;
  ...
  if Action is TCustomAction then
    ...
    begin
      ...
      if not CheckDefaults or (Self.Hint = '') then
        Self.Hint := Hint;
      if not CheckDefaults or ((Self.LargeImageIndex = -1) and
        (Self.SmallImageIndex = -1)) then
      begin
...
class function TdxNavBarItem.GetCalculatorClass
  : TdxNavBarCustomGroupItemCalculatorClass;
begin
  Result := TdxNavBarItemCalculator;
end;

procedure TdxNavBarItem.StyleChanged(Sender: TObject;
  AType: TdxNavBarChangeType);
begin
  Changed(False);
end;
...
procedure TdxNavBarItem.SetCustomStyle(Index: Integer;
  const Value: TdxNavBarStyleItem);
begin
  CustomStyles.Styles[Index] := Value;
end;
...
begin
  Result := not Enabled and
    ((FActionLink = nil) or not FActionLink.IsEnabledLinked);
end;
...
function TdxNavBarItems.Add(AItemClass
  : TcxComponentCollectionItemClass { TdxNavBarItemClass } ): TdxNavBarItem;
begin
  Result := inherited Add(AItemClass) as TdxNavBarItem;
end;

procedure TdxNavBarItems.LoadFromIniFile(AStorage: TCustomIniFile;
  ALoadStyles: Boolean);
...
RegisterClasses([TdxNavBarItemLink, TdxNavBarItemLinks, TdxNavBarGroupControl,
  TdxNavBarGroup, TdxNavBarItem]);
