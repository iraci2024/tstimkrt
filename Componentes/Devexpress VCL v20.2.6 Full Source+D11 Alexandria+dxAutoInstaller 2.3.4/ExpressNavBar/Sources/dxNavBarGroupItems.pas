...
type
  ...
  protected
    ...
    class function GetCalculatorClass
      : TdxNavBarCustomGroupItemCalculatorClass; override;
  public
...
begin
  TdxNavBarPainter(APainter).DrawSeparator
    (TdxNavBarLinkViewInfo(ALinkViewInfo));
end;
...
class function TdxNavBarSeparator.GetCalculatorClass
