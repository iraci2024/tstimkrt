...
type
  ...
  public const
    CloudImageSizeMap: array [TdxCloudImageSize] of Integer = (16, 32, 64,
      128, 256);
  private type
{$REGION 'private type'}
...
{$ENDREGION}
  ...
  TdxCloudStorageItemPermissionDataList = class
    (TList<TdxCloudStorageItemPermissionData>);
  ...
  protected
    function Add(const AData: TdxCloudStorageItemPermissionData)
      : TdxCloudStorageItemPermission;
  ...
  public
    ...
    procedure CreateSharedLink(AReadOnly: Boolean = True;
      AScope: TdxCloudStorageItemPermissionScope =
      TdxCloudStorageItemPermissionScope.Anonymous);
    ...
    property Items[Index: Integer]: TdxCloudStorageItemPermission
  ...
  protected
    ...
    procedure CreateSharedLink(AReadOnly: Boolean;
      AScope: TdxCloudStorageItemPermissionScope); virtual;
    procedure DeletePermission(APermission
      : TdxCloudStorageItemPermission); virtual;
    procedure InviteUsers(const AUsers: TArray<string>;
  ...
  strict private
    ...
    FIsLoaded: Boolean;
  protected
    procedure AddChild(AChild: TdxCloudStorageItem); overload; virtual;
      abstract;
    function AddChild(const AData: TdxCloudStorageItemData)
      : TdxCloudStorageItem; overload;
  ...
  protected
    ...
    procedure CreateSharedLink(AReadOnly: Boolean;
      AScope: TdxCloudStorageItemPermissionScope); override;
    procedure DeletePermission(APermission
      : TdxCloudStorageItemPermission); override;
    procedure InviteUsers(const AUsers: TArray<string>;
      AReadOnly, ARequireSignIn, ASendInvitation: Boolean;
  ...
  public type
    TEnumProc = reference to procedure(const ASpecialFolder
      : TdxCloudStorageSpecialFolder);
  protected
    function AreOwnObjects: Boolean; override;
  public
    function GetByType(AType: TdxCloudStorageSpecialFolder.TType)
      : TdxCloudStorageSpecialFolder;
  ...
  TdxCloudStorageFolderList = class
    (TdxCloudStorageItemList<TdxCloudStorageFolder>)
  protected
    function AreOwnObjects: Boolean; override;
  end;
  ...
  TdxCloudStorageProviderCreateFolderTask = class abstract
    (TdxCloudStorageProviderCustomTask)
  strict private
  ...
  protected
    ...
    function DoRun(const ACancelStatus: TdxTaskCancelCallback)
      : TdxTaskCompletedStatus; override; final;

    function GetRequestObject: TdxJSONObject; virtual; abstract;
    function IsError(AObject: TdxJSONObject): Boolean; virtual; abstract;
    function PostRequest(AObject: TdxJSONObject): TdxJSONObject;
      virtual; abstract;
  ...
  public
    constructor Create(AProvider: TdxCloudStorageProvider;
      AParent: TdxCloudStorageFolder; const AName: string);
      reintroduce; virtual;
  end;

  { TdxCloudStorageProviderLoadImageTask }

  TdxCloudStorageProviderLoadImageTask = class
    (TdxCloudStorageProviderCustomTask)
  strict private
    FStream: TStream;
    FUri: string;
  protected
    function DoRun(const ACancelStatus: TdxTaskCancelCallback)
      : TdxTaskCompletedStatus; override;
    procedure DoComplete; override;

    property Stream: TStream read FStream;
    property Uri: string read FUri;
  public
    constructor Create(AProvider: TdxCloudStorageProvider; const AUri: string);
      reintroduce; virtual;
    destructor Destroy; override;
  ...
  TdxCloudStorageProviderItemCustomTask = class abstract
    (TdxCloudStorageProviderCustomTask)
  strict private
  ...
  public
    constructor Create(AProvider: TdxCloudStorageProvider;
      AItem: TdxCloudStorageItem); reintroduce; virtual;
    destructor Destroy; override;
  ...
  TdxCloudStorageProviderDeleteItemTask = class
    (TdxCloudStorageProviderItemCustomTask)
  protected
    procedure DoComplete; override;
  end;
  ...
  TdxCloudStorageProviderPermissionCustomTask = class abstract
    (TdxCloudStorageProviderItemCustomTask)
  strict private
  ...
  public
    constructor Create(AProvider: TdxCloudStorageProvider;
      APermission: TdxCloudStorageItemPermission); reintroduce;
    destructor Destroy; override;
  ...
  TdxCloudStorageProviderDeletePermissionTask = class
    (TdxCloudStorageProviderPermissionCustomTask)
  protected
    procedure DoComplete; override;
  end;
  ...
  TdxCloudStorageProviderCreatePermissionCustomTask = class
    (TdxCloudStorageProviderItemCustomTask)
  strict private
    FReadOnly: Boolean;
  protected
  ...
  public
    constructor Create(AProvider: TdxCloudStorageProvider;
      AItem: TdxCloudStorageItem; AReadOnly: Boolean); reintroduce;
  end;

  { TdxCloudStorageProviderCreateSharedLinkCustomTask }

  TdxCloudStorageProviderCreateSharedLinkCustomTask = class abstract
    (TdxCloudStorageProviderCreatePermissionCustomTask)
  strict private
  ...
  public
    constructor Create(AProvider: TdxCloudStorageProvider;
      ...
      AScope: TdxCloudStorageItemPermissionScope); reintroduce;
  end;

  { TdxCloudStorageProviderInviteUsersCustomTask }

  TdxCloudStorageProviderInviteUsersCustomTask = class abstract
    (TdxCloudStorageProviderCreatePermissionCustomTask)
  strict private
  ...
  public
    constructor Create(AProvider: TdxCloudStorageProvider;
      AItem: TdxCloudStorageItem; const AUsers: TArray<string>;
      AReadOnly, ARequireSignIn, ASendInvitation: Boolean;
  ...
  TdxCloudStorageProviderFetchPermissionsCustomTask = class
    (TdxCloudStorageProviderItemCustomTask)
  strict private
    FItems: TdxCloudStorageItemPermissionDataList;
  protected
  ...
  public
    constructor Create(AProvider: TdxCloudStorageProvider;
      AItem: TdxCloudStorageItem); override;
    destructor Destroy; override;
  end;

  { TdxCloudStorageProviderMoveItemToTrashTask }

  TdxCloudStorageProviderMoveItemToTrashTask = class
    (TdxCloudStorageProviderItemCustomTask)
  protected
    FData: TdxCloudStorageItemData;
  ...
  TdxCloudStorageProviderMoveItemToCustomTask = class abstract
    (TdxCloudStorageProviderItemCustomTask)
  strict private
    FData: TdxCloudStorageItemData;
  ...
  public
    constructor Create(AProvider: TdxCloudStorageProvider;
      AItem: TdxCloudStorageItem; AParent: TdxCloudStorageFolder); reintroduce;
    destructor Destroy; override;
  ...
  TdxCloudStorageProviderUpdateFolderCustomTask = class abstract
    (TdxCloudStorageProviderItemCustomTask)
  strict private
  ...
  protected
    function AssignData(const ACancelStatus: TdxTaskCancelCallback;
      var AData: TdxCloudStorageItemData): TdxTaskCompletedStatus;
      virtual; abstract;
    function PopulateItems(const ACancelStatus: TdxTaskCancelCallback)
      : TdxTaskCompletedStatus; virtual; abstract;
  ...
  public
    constructor Create(AProvider: TdxCloudStorageProvider;
      AFolder: TdxCloudStorageCustomFolder); reintroduce;
    destructor Destroy; override;
  ...
  TdxCloudStorageProviderFetchAllCustomTask = class abstract
    (TdxCloudStorageProviderCustomTask)
  strict private
  ...
  protected
    function BuildTree(const ACancelStatus: TdxTaskCancelCallback)
      : TdxTaskCompletedStatus;
    procedure DoComplete; override;
    function DoRun(const ACancelStatus: TdxTaskCancelCallback)
      : TdxTaskCompletedStatus; override; final;

    function AssignRoot(var ARoot: TdxCloudStorageItemData;
  ...
  protected
    ...
    function AddChild(const AParentID: string;
      const AChild: TdxCloudStorageItemData): TdxCloudStorageItem;
    ...
    procedure CreateSharedLink(AItem: TdxCloudStorageItem; AReadOnly: Boolean;
      AScope: TdxCloudStorageItemPermissionScope);
    procedure Clear(ACreateRoot: Boolean = True);
    procedure CopyItemTo(AItem: TdxCloudStorageItem;
    ...
    procedure InviteUsers(AItem: TdxCloudStorageItem;
      const AUsers: TArray<string>; AReadOnly, ARequireSignIn, ASendInvitation
      : Boolean; const AMessage: string);
    procedure MoveItemTo(AItem: TdxCloudStorageItem;
      AParent: TdxCloudStorageFolder);
  ...
  public
    ...
    property SpecialFolders: TdxCloudStorageSpecialFolderList
      read FSpecialFolders;
  ...
  protected
    function CreateDownloadFileStreamTask(AFile: TdxCloudStorageFile)
      : TdxCloudStorageFileDownloadStreamTask; virtual;
    function CreateUpdateFileStreamTask(AFile: TdxCloudStorageFile;
      AStream: TStream): TdxCloudStorageUploadTask; virtual; abstract;
    function CreateUploadFileTask(AParent: TdxCloudStorageFolder;
      const AFileName: string): TdxCloudStorageUploadTask; virtual; abstract;

    procedure DoDownload(const AProcessID: string;
      const APosition: Cardinal); override;
    procedure DoDownloaded(const AProcessID: string;
      const AStream: TStream); override;
    procedure DoError(const AErrorObject: TObject); override;
    procedure DoDownloading(const AProcessID: string;
      const AFileSize: Integer); override;
    procedure DoUploaded(const AProcessID, AFileID: string); override;
    procedure DoUploading(const AProcessID: string;
      const ASize: Integer); override;
    procedure DoUpload(const AProcessID: string;
      const APosition: Cardinal); override;
  ...
  public
    ...
    procedure UploadFile(AParent: TdxCloudStorageFolder;
  ...
  strict private
    class var FRegistryExtensionToMIMEType: TDictionary<string, string>;
  private
  ...
  protected
    ...
    function CreateFileTransferManager: TdxCloudStorageFileTransferManager;
      virtual; abstract;

    procedure RunTask(ATask: TdxCloudStorageProviderCustomTask);

    class procedure RaiseOperationNotSupportedException; static;
    function CreateCopyItemToTask(AItem: TdxCloudStorageItem;
      AParent: TdxCloudStorageFolder)
      : TdxCloudStorageProviderMoveItemToCustomTask; virtual;
    function CreateCreateFolderTask(AParent: TdxCloudStorageFolder;
      const AName: string): TdxCloudStorageProviderCreateFolderTask; virtual;
    function CreateCreateSharedLinkTask(AItem: TdxCloudStorageItem;
      AReadOnly: Boolean; AScope: TdxCloudStorageItemPermissionScope)
      : TdxCloudStorageProviderCreateSharedLinkCustomTask; virtual;
    function CreateDeleteItemTask(AItem: TdxCloudStorageItem)
      : TdxCloudStorageProviderDeleteItemTask; virtual;
    function CreateDeletePermissionTask(APermission
      : TdxCloudStorageItemPermission)
      : TdxCloudStorageProviderDeletePermissionTask; virtual;
    function CreateFetchAllTask
      : TdxCloudStorageProviderFetchAllCustomTask; virtual;
    function CreateFetchPermissionsTask(AItem: TdxCloudStorageItem)
      : TdxCloudStorageProviderFetchPermissionsCustomTask; virtual;
    function CreateInviteUsersTask(AItem: TdxCloudStorageItem;
      const AUsers: TArray<string>; AReadOnly, ARequireSignIn, ASendInvitation
      : Boolean; const AMessage: string)
      : TdxCloudStorageProviderInviteUsersCustomTask; virtual;
    function CreateLoadImageTask(const AUri: string)
      : TdxCloudStorageProviderLoadImageTask; virtual;
    function CreateMoveItemToTask(AItem: TdxCloudStorageItem;
      AParent: TdxCloudStorageFolder)
      : TdxCloudStorageProviderMoveItemToCustomTask; virtual;
    function CreateMoveItemToTrashTask(AItem: TdxCloudStorageItem)
      : TdxCloudStorageProviderMoveItemToTrashTask; virtual;
    function CreateRestoreItemFromTrashTask(AItem: TdxCloudStorageItem)
      : TdxCloudStorageProviderItemCustomTask; virtual;
    function CreateUpdateFolderTask(AFolder: TdxCloudStorageFolder)
      : TdxCloudStorageProviderUpdateFolderCustomTask; virtual;
    function CreateUpdateSpecialFolderTask
      (AFolder: TdxCloudStorageSpecialFolder)
      : TdxCloudStorageProviderUpdateFolderCustomTask; virtual;

    function CreateItem(const AMIMEType: string): TdxCloudStorageItem; overload;
      virtual; abstract;
    function CreateItem(const AData: TdxCloudStorageItemData)
      : TdxCloudStorageItem; overload;
    function CreateRoot(const AData: TdxCloudStorageItemData)
      : TdxCloudStorageItem; overload;
    function DoGetSpecialFolderData(const AType
      : TdxCloudStorageSpecialFolder.TType): TdxCloudStorageItemData; virtual;
    function GetSpecialFolderData(const AType
      : TdxCloudStorageSpecialFolder.TType): TdxCloudStorageItemData;
    function ObjectToData(const AObject: TObject): TdxCloudStorageItemData;
      virtual; abstract;
    ...
    procedure CopyItemTo(AItem: TdxCloudStorageItem;
      AParent: TdxCloudStorageFolder);
    procedure CopyItemToComplete(AItem: TdxCloudStorageItem;
      AParent: TdxCloudStorageFolder; const AData: TdxCloudStorageItemData);
    procedure CreateFolder(AParent: TdxCloudStorageFolder; const AName: string);
    procedure CreateFolderComplete(const AFolderData: TdxCloudStorageItemData);
    procedure CreatePermissionComplete(AItem: TdxCloudStorageItem;
      const APermissionData: TdxCloudStorageItemPermissionData);
    procedure CreateSharedLink(AItem: TdxCloudStorageItem; AReadOnly: Boolean;
      AScope: TdxCloudStorageItemPermissionScope);
    procedure DeleteItem(AItem: TdxCloudStorageItem);
    procedure DeleteItemComplete(AItem: TdxCloudStorageItem);
    procedure DeletePermission(APermission: TdxCloudStorageItemPermission);
    procedure DeletePermissionComplete(APermission
      : TdxCloudStorageItemPermission);
    function GetHttpHeaders: string; virtual;
    procedure FetchAll;
    procedure FetchAllComplete(AItems: TdxCloudStorageItemList);
    procedure FetchPermissions(AItem: TdxCloudStorageItem);
    procedure FetchPermissionsComplete(AItem: TdxCloudStorageItem;
      AItems: TdxCloudStorageItemPermissionDataList);
    procedure InviteUsers(AItem: TdxCloudStorageItem;
      const AUsers: TArray<string>; AReadOnly, ARequireSignIn, ASendInvitation
      : Boolean; const AMessage: string);
    procedure MoveItemTo(AItem: TdxCloudStorageItem;
      AParent: TdxCloudStorageFolder);
    procedure MoveItemToComplete(AItem: TdxCloudStorageItem;
      AParent: TdxCloudStorageFolder);
    procedure MoveItemToTrash(AItem: TdxCloudStorageItem);
    procedure MoveItemToTrashComplete(AItem: TdxCloudStorageItem;
      const ANewData: TdxCloudStorageItemData);
    procedure RestoreItemFromTrash(AItem: TdxCloudStorageItem);
    procedure RestoreItemFromTrashComplete(AItem: TdxCloudStorageItem;
      const ANewData: TdxCloudStorageItemData);
    ...
    property FileTransferManager: TdxCloudStorageFileTransferManager
      read FFileTransferManager;
    property RecentFileCountLimit: Integer read FRecentFileCountLimit
      write SetRecentFileCountLimit default DefaultRecentFileCountLimit;
    property RecentDayCountLimit: Integer read FRecentDayCountLimit
      write SetRecentDayCountLimit default DefaultRecentDayCountLimit;
    property Tasks: TdxWebTaskManager read FTasks;

    property ImageDictionary: TdxCloudStorageProviderImageDictionary
      read FImageDictionary;
    property UseCurrentThread: Boolean read GetUseCurrentThread
      write SetUseCurrentThread;
  public
    ...
    property AuthorizationAgent: TdxCustomAuthorizationAgent
      read FAuthorizationAgent write SetAuthorizationAgent;
    property Storage: TdxCloudStorage read GetStorage;
    class property RegistryExtensionToMIMEType: TDictionary<string, string>
      read FRegistryExtensionToMIMEType;
  end;
  ...
  strict private
    ...
    procedure SetAuthorizationAgent(const Value
      : TdxOAuth2AuthorizationAgent); inline;
  protected
  ...
  public
    property AuthorizationAgent: TdxOAuth2AuthorizationAgent
      read GetAuthorizationAgent write SetAuthorizationAgent;
  end;
  ...
  public type
    ...
    TFolderChangeEvent = procedure(Sender: TObject;
      AFolder: TdxCloudStorageCustomFolder) of object;
    TItemChangedEvent = procedure(Sender: TObject;
      const AItem: TdxCloudStorageItem) of object;
    TItemPermissionChangedEvent = procedure(Sender: TObject;
      const APermission: TdxCloudStorageItemPermission) of object;

    TItemDownloadedEvent = procedure(Sender: TObject;
      const AItem: TdxCloudStorageItem; AStream: TStream) of object;
    TItemDownloadEvent = procedure(Sender: TObject;
      const AItem: TdxCloudStorageItem; const APosition: Integer) of object;
    TItemDownloadingEvent = procedure(Sender: TObject;
      const AItem: TdxCloudStorageItem; const ASize: Integer) of object;
    TItemUploadedEvent = procedure(Sender: TObject;
      const AItem: TdxCloudStorageItem) of object;
    TItemUploadEvent = procedure(Sender: TObject; const AFileName: string;
      const APosition: Integer) of object;
    TItemUploadingEvent = procedure(Sender: TObject; const AFileName: string;
      const ASize: Integer) of object;

    TFileContentUploadedEvent = procedure(Sender: TObject;
      const AFile: TdxCloudStorageFile) of object;
    TFileContentUploadEvent = procedure(Sender: TObject;
      const AFile: TdxCloudStorageFile; const APosition: Integer) of object;
    TFileContentUploadingEvent = procedure(Sender: TObject;
      const AFile: TdxCloudStorageFile; const ASize: Integer) of object;
  protected type
    TImageLoadedEvent = procedure(Sender: TObject; const AUri: string)
      of object;
    ...
    TTaskErrorEvent = procedure(Sender: TObject;
      ATask: TdxCloudStorageProviderCustomTask; const AErrorObject: TObject)
      of object;
  private
  var
  ...
  protected
    ...
    procedure DoItemPermissionCreated(APermission
      : TdxCloudStorageItemPermission);
    procedure DoItemPermissionDeleted(APermission
      : TdxCloudStorageItemPermission);
    ...
    procedure DoTaskError(ATask: TdxCloudStorageProviderCustomTask;
      const AErrorObject: TObject);

    procedure DoFileContentUpload(const AFile: TdxCloudStorageFile;
      const APosition: Integer);
    procedure DoFileContentUploaded(const AFile: TdxCloudStorageFile);
    procedure DoFileContentUploading(const AFile: TdxCloudStorageFile;
      const ASize: Integer);
    procedure DoItemDownload(const AItem: TdxCloudStorageItem;
      const APosition: Integer);
    procedure DoItemDownloaded(const AItem: TdxCloudStorageItem;
      AStream: TStream);
    procedure DoItemDownloading(const AItem: TdxCloudStorageItem;
      const ASize: Integer);
    ...
    class procedure RegisterProvider(AProvider
      : TdxCloudStorageProviderClass); static;
    class procedure UnregisterProvider(AProvider
      : TdxCloudStorageProviderClass); static;

    function IsDestroying: Boolean;

    property ChangedHandlers: TdxNotifyEventHandler read FChangedHandlers;
    property ConnectedChangedHandlers: TdxNotifyEventHandler
      read FConnectedChangedHandlers;
    property FolderCreatedHandlers: TFolderChangeEventHandler
      read FFolderCreatedHandlers;
    property TreeDataLoadingHandlers: TFolderChangeEventHandler
      read FTreeDataLoadingHandlers;
    property TreeDataLoadedHandlers: TFolderChangeEventHandler
      read FTreeDataLoadedHandlers;
    property ImageLoadedHandlers: TImageLoadedEventHandler
      read FImageLoadedHandlers;
    property ItemCopiedHandlers: TItemChangedEventHandler
      read FItemCopiedHandlers;
    property ItemDeletedHandlers: TItemChangedEventHandler
      read FItemDeletedHandlers;
    property ItemMovedHandlers: TItemChangedEventHandler
      read FItemMovedHandlers;
    property ItemMovedToTrashHandlers: TItemChangedEventHandler
      read FItemMovedToTrashHandlers;
    property ItemRestoredFromTrashHandlers: TItemChangedEventHandler
      read FItemRestoredFromTrashHandlers;
  ...
  public
    ...
    class property RegisteredProviders: TcxRegisteredClasses
      read GetRegisteredProviders;

    property ProviderClass: TdxCloudStorageProviderClass read FProviderClass
      write SetProviderClass;
    property Files: TdxCloudStorageFiles read GetFiles;
  published
    property ProviderClassName: string read GetProviderClassName
      write SetProviderClassName;
    ...
    property OnFolderCreated: TFolderChangeEvent read FOnFolderCreated
      write FOnFolderCreated;
    property OnItemCopied: TItemChangedEvent read FOnItemCopied
      write FOnItemCopied;
    property OnItemDeleted: TItemChangedEvent read FOnItemDeleted
      write FOnItemDeleted;
    property OnItemMoved: TItemChangedEvent read FOnItemMoved
      write FOnItemMoved;
    property OnItemMovedToTrash: TItemChangedEvent read FOnItemMovedToTrash
      write FOnItemMovedToTrash;
    property OnItemPermissionCreated: TItemPermissionChangedEvent
      read FOnItemPermissionCreated write FOnItemPermissionCreated;
    property OnItemPermissionDeleted: TItemPermissionChangedEvent
      read FOnItemPermissionDeleted write FOnItemPermissionDeleted;
    property OnItemPermissionsLoaded: TItemChangedEvent
      read FOnItemPermissionsLoaded write FOnItemPermissionsLoaded;
    property OnItemRestoredFromTrash: TItemChangedEvent
      read FOnItemRestoredFromTrash write FOnItemRestoredFromTrash;
    property OnTreeDataLoading: TFolderChangeEvent read FOnTreeDataLoading
      write FOnTreeDataLoading;
    property OnTreeDataLoaded: TFolderChangeEvent read FOnTreeDataLoaded
      write FOnTreeDataLoaded;

    property OnFileContentUpload: TFileContentUploadEvent
      read FOnFileContentUpload write FOnFileContentUpload;
    property OnFileContentUploaded: TFileContentUploadedEvent
      read FOnFileContentUploaded write FOnFileContentUploaded;
    property OnFileContentUploading: TFileContentUploadingEvent
      read FOnFileContentUploading write FOnFileContentUploading;

    property OnItemDownload: TItemDownloadEvent read FOnItemDownload
      write FOnItemDownload;
    property OnItemDownloaded: TItemDownloadedEvent read FOnItemDownloaded
      write FOnItemDownloaded;
    property OnItemDownloading: TItemDownloadingEvent read FOnItemDownloading
      write FOnItemDownloading;
    property OnItemUpload: TItemUploadEvent read FOnItemUpload
      write FOnItemUpload;
    property OnItemUploaded: TItemUploadedEvent read FOnItemUploaded
      write FOnItemUploaded;
    property OnItemUploading: TItemUploadingEvent read FOnItemUploading
      write FOnItemUploading;
  end;
...
constructor TdxCloudStorageProviderImageDictionary.Create
...
function TdxCloudStorageProviderImageDictionary.GetIcon(const AUri: string)
  : TGraphic;
var
  AResult: Integer;
begin
...
function TdxCloudStorageProviderImageDictionary.AddImage(const AUri: string;
...
procedure TdxCloudStorageItemPermission.Assign(const AData
  : TdxCloudStorageItemPermissionData);
begin
  FID := AData.ID;
...
procedure TdxCloudStorageItemPermissions.CreateSharedLink
...
procedure TdxCloudStorageItemPermissions.InviteUsers(const AUsers
  : TArray<string>; AReadOnly: Boolean = True; ARequireSignIn: Boolean = False;
  ASendInvitation: Boolean = False; const AMessage: string = '');
begin
  Owner.InviteUsers(AUsers, AReadOnly, ARequireSignIn, ASendInvitation,
    AMessage);
end;

procedure TdxCloudStorageItemPermissions.DeletePermission
...
function TdxCloudStorageItemPermissions.FindByID(const AID: string)
  : TdxCloudStorageItemPermission;
var
  I: Integer;
begin
...
function TdxCloudStorageItemPermissions.GetItem(Index: Integer)
  : TdxCloudStorageItemPermission;
begin
  Result := TdxCloudStorageItemPermission(FList[Index]);
end;

function TdxCloudStorageItemPermissions.Add(const AData
  : TdxCloudStorageItemPermissionData): TdxCloudStorageItemPermission;
begin
...
procedure TdxCloudStorageItemPermissions.Assign(const AData
  : TdxCloudStorageItemPermissionDataList);
var
  I: Integer;
begin
  FList.Clear;
...
procedure TdxCloudStorageItemPermissions.ExtractPermission
  (APermission: TdxCloudStorageItemPermission);
begin
...
procedure TdxCloudStorageItem.CreateSharedLink(AReadOnly: Boolean;
  AScope: TdxCloudStorageItemPermissionScope);
begin
...
begin
  Owner.InviteUsers(Self, AUsers, AReadOnly, ARequireSignIn, ASendInvitation,
    AMessage);
end;

procedure TdxCloudStorageItem.DeletePermission(APermission
  : TdxCloudStorageItemPermission);
begin
  Owner.DeletePermission(APermission);
end;
...
begin
  ...
  begin
    Result := Items[I];
    if CompareText(Result.Name, Value) = 0 then
      Exit;
  end;
  Result := Default (T);
end;
...
function TdxCloudStorageCustomFolder.IndexOf
  (AItem: TdxCloudStorageItem): Integer;
begin
  Result := FChildren.IndexOf(AItem);
end;

function TdxCloudStorageCustomFolder.AddChild(const AData
  : TdxCloudStorageItemData): TdxCloudStorageItem;
begin
...
procedure TdxCloudStorageCustomFolder.AssignChildren
  (AList: TdxCloudStorageItemDataList);
begin
  Clear;
...
procedure TdxCloudStorageCustomFolder.DoAssignChildren
  (AList: TdxCloudStorageItemDataList);
var
...
constructor TdxCloudStorageSpecialFolder.Create(AOwner: TdxCloudStorageFiles;
  AType: TType);
begin
  inherited Create(AOwner);
  FType := AType;
...
begin
  raise Exception.Create
    (cxGetResourceString
    (@sdxCloudStorageSpecialFolderCannotBeDeletedOrMovedException));
end;
...
procedure TdxCloudStorageSpecialFolder.DoAssignChildren
  (AList: TdxCloudStorageItemDataList);
var
  AItem: TdxCloudStorageItemData;
...
procedure TdxCloudStorageSpecialFolder.CreateSharedLink(AReadOnly: Boolean;
  AScope: TdxCloudStorageItemPermissionScope);
begin
  raise Exception.Create
    (cxGetResourceString
    (@sdxCloudStorageSpecialFolderDoesNotSupportPermissionsException));
end;

procedure TdxCloudStorageSpecialFolder.DeletePermission
  (APermission: TdxCloudStorageItemPermission);
begin
  raise Exception.Create
    (cxGetResourceString
...
function TdxCloudStorageSpecialFolderList.GetByType
  (AType: TdxCloudStorageSpecialFolder.TType): TdxCloudStorageSpecialFolder;
var
  I: Integer;
begin
  for I := 0 to Count - 1 do
...
begin
  raise EArgumentException.Create
    (cxGetResourceString(@sdxCloudStorageRootShouldNotHaveParentException));
end;

procedure TdxCloudStorageRoot.CopyTo(AParent: TdxCloudStorageFolder);
begin
  raise Exception.Create
    (cxGetResourceString(@sdxCloudStorageRootCannotBeDeletedOrMovedException));
end;
...
constructor TdxCloudStorageProviderCustomTask.Create
  (AProvider: TdxCloudStorageProvider);
begin
...
function TdxCloudStorageProviderCustomTask.IsEqual
  (const ATask: TdxWebTask): Boolean;
begin
  Result := inherited IsEqual(ATask) and
    (TdxCloudStorageProviderCustomTask(ATask).Provider = Provider);
end;
...
function TdxCloudStorageProviderCreateFolderTask.DoRun(const ACancelStatus
  : TdxTaskCancelCallback): TdxTaskCompletedStatus;
var
...
constructor TdxCloudStorageProviderLoadImageTask.Create
  (AProvider: TdxCloudStorageProvider; const AUri: string);
begin
  inherited Create(AProvider);
  FUri := AUri;
...
function TdxCloudStorageProviderLoadImageTask.IsEqual
  (const ATask: TdxWebTask): Boolean;
begin
  Result := inherited IsEqual(ATask) and
    (TdxCloudStorageProviderLoadImageTask(ATask).Uri = Uri);
end;

function TdxCloudStorageProviderLoadImageTask.DoRun(const ACancelStatus
  : TdxTaskCancelCallback): TdxTaskCompletedStatus;
var
  AResult: Boolean;
begin
...
constructor TdxCloudStorageProviderItemCustomTask.Create
...
function TdxCloudStorageProviderItemCustomTask.IsEqual
  (const ATask: TdxWebTask): Boolean;
begin
  Result := inherited IsEqual(ATask) and
    (TdxCloudStorageProviderItemCustomTask(ATask).Item = Item);
end;
...
constructor TdxCloudStorageProviderPermissionCustomTask.Create
  (AProvider: TdxCloudStorageProvider;
APermission: TdxCloudStorageItemPermission);
begin
...
begin
  Result := inherited IsEqual(ATask) and
    (TdxCloudStorageProviderPermissionCustomTask(ATask)
...
begin
  Provider.CreatePermissionComplete(Item, FData);
end;
...
AReadOnly: Boolean; AScope: TdxCloudStorageItemPermissionScope);
begin
  inherited Create(AProvider, AItem, AReadOnly);
  FScope := AScope;
end;
...
begin
  for I := 0 to Items.Count - 1 do
    Provider.CreatePermissionComplete(Item, Items[I]);
end;

{ TdxCloudStorageProviderFetchPermissionsCustomTask }

constructor TdxCloudStorageProviderFetchPermissionsCustomTask.Create
  (AProvider: TdxCloudStorageProvider; AItem: TdxCloudStorageItem);
begin
  inherited Create(AProvider, AItem);
  FItems := TdxCloudStorageItemPermissionDataList.Create;
...
procedure TdxCloudStorageProviderMoveItemToTrashTask.AssignData
  (AObject: TdxJSONObject);
begin
...
constructor TdxCloudStorageProviderMoveItemToCustomTask.Create
  (AProvider: TdxCloudStorageProvider; AItem: TdxCloudStorageItem;
AParent: TdxCloudStorageFolder);
begin
  inherited Create(AProvider, AItem);
...
procedure TdxCloudStorageProviderMoveItemToCustomTask.AssignData
  (AObject: TdxJSONObject);
begin
  FData := Provider.ObjectToData(AObject);
end;
...
function TdxCloudStorageProviderMoveItemToCustomTask.IsEqual
  (const ATask: TdxWebTask): Boolean;
begin
  Result := inherited IsEqual(ATask) and
    (TdxCloudStorageProviderMoveItemToCustomTask(ATask).Parent = Parent);
end;

{ TdxCloudStorageProviderUpdateFolderCustomTask }

constructor TdxCloudStorageProviderUpdateFolderCustomTask.Create
  (AProvider: TdxCloudStorageProvider; AFolder: TdxCloudStorageCustomFolder);
begin
...
function TdxCloudStorageProviderUpdateFolderCustomTask.DoRun(const ACancelStatus
  : TdxTaskCancelCallback): TdxTaskCompletedStatus;
begin
...
function TdxCloudStorageProviderUpdateFolderCustomTask.GetFolder
  : TdxCloudStorageCustomFolder;
begin
...
constructor TdxCloudStorageProviderFetchAllCustomTask.Create
  (AProvider: TdxCloudStorageProvider);
begin
  inherited Create(AProvider);
...
function TdxCloudStorageProviderFetchAllCustomTask.BuildTree(const ACancelStatus
  : TdxTaskCancelCallback): TdxTaskCompletedStatus;
var
...
function TdxCloudStorageProviderFetchAllCustomTask.DoRun(const ACancelStatus
  : TdxTaskCancelCallback): TdxTaskCompletedStatus;
begin
  Result := PopulateItems(ACancelStatus);
  if Result = TdxTaskCompletedStatus.Success then
...
function TdxCloudStorageFiles.FindByID(const Value: string)
  : TdxCloudStorageItem;
begin
...
function TdxCloudStorageFiles.AddChild(const AParentID: string;
const AChild: TdxCloudStorageItemData): TdxCloudStorageItem;
var
  AParent: TdxCloudStorageItem;
...
procedure TdxCloudStorageFiles.AddSpecialFolder
  (AType: TdxCloudStorageSpecialFolder.TType);
begin
  FSpecialFolders.Add(TdxCloudStorageSpecialFolder.Create(Self, AType));
end;

procedure TdxCloudStorageFiles.CreateFolder(AParent: TdxCloudStorageFolder;
const AName: string);
begin
  FOwner.CreateFolder(AParent, AName);
end;

procedure TdxCloudStorageFiles.CreateSharedLink(AItem: TdxCloudStorageItem;
AReadOnly: Boolean; AScope: TdxCloudStorageItemPermissionScope);
begin
...
procedure TdxCloudStorageFiles.CopyItemTo(AItem: TdxCloudStorageItem;
AParent: TdxCloudStorageFolder);
begin
...
procedure TdxCloudStorageFiles.DeletePermission(APermission
  : TdxCloudStorageItemPermission);
begin
  Owner.DeletePermission(APermission);
end;
...
procedure TdxCloudStorageFiles.InviteUsers(AItem: TdxCloudStorageItem;
const AUsers: TArray<string>; AReadOnly, ARequireSignIn, ASendInvitation
  : Boolean; const AMessage: string);
begin
  Owner.InviteUsers(AItem, AUsers, AReadOnly, ARequireSignIn, ASendInvitation,
    AMessage);
end;

procedure TdxCloudStorageFiles.MoveItemTo(AItem: TdxCloudStorageItem;
AParent: TdxCloudStorageFolder);
begin
...
var
  AFolder: TdxCloudStorageSpecialFolder;
begin
  AFolder := SpecialFolders.GetByType
...
begin
  inherited Create(AManager, AManager.Provider.AuthorizationAgent, AFile.ID,
    AFile.DownloadLink);
end;

{ TdxCloudStorageUploadTask }

constructor TdxCloudStorageUploadTask.Create(AProvider: TdxCloudStorageProvider;
...
constructor TdxCloudStorageFileTransferManager.Create
  (AProvider: TdxCloudStorageProvider);
begin
  inherited Create;
  FProvider := AProvider;
...
procedure TdxCloudStorageFileTransferManager.DownloadFileStream
...
procedure TdxCloudStorageFileTransferManager.UploadFile
...
procedure TdxCloudStorageFileTransferManager.UpdateFileContent
...
function TdxCloudStorageFileTransferManager.CreateDownloadFileStreamTask
  (AFile: TdxCloudStorageFile): TdxCloudStorageFileDownloadStreamTask;
begin
  Result := TdxCloudStorageFileDownloadStreamTask.Create(Self, AFile);
end;

procedure TdxCloudStorageFileTransferManager.DoDownload(const AProcessID
  : string; const APosition: Cardinal);
begin
...
procedure TdxCloudStorageFileTransferManager.DoDownloaded(const AProcessID
  : string; const AStream: TStream);
begin
  inherited DoDownloaded(AProcessID, AStream);
  Storage.DoItemDownloaded(FindFile(AProcessID), AStream);
end;

procedure TdxCloudStorageFileTransferManager.DoDownloading(const AProcessID
  : string; const AFileSize: Integer);
var
  ASize: Integer;
  AItem: TdxCloudStorageItem;
begin
...
procedure TdxCloudStorageFileTransferManager.DoUploaded(const AProcessID,
  AFileID: string);
var
...
procedure TdxCloudStorageFileTransferManager.DoUploading(const AProcessID
  : string; const ASize: Integer);
var
  AItem: TdxCloudStorageFile;
begin
...
procedure TdxCloudStorageFileTransferManager.DoUpload(const AProcessID: string;
...
function TdxCloudStorageFileTransferManager.FindFile(const AProcessID: string)
  : TdxCloudStorageFile;
var
  AItem: TdxCloudStorageItem;
begin
...
begin
  ...
  try
    ...
    if ARegistry.OpenKeyReadOnly('\SOFTWARE\Classes\') and ARegistry.HasSubKeys
    then
    begin
      ...
      try
        ...
        begin
          ...
          if (Length(AExt) = 0) or (AExt[1] <> '.') then
            Continue;
          if ARegistry.OpenKeyReadOnly(Format('\SOFTWARE\Classes\%s\', [AExt]))
          then
            try
...
function TdxCloudStorageProvider.GetExtension
  (AItem: TdxCloudStorageItem): string;
begin
  if AItem = nil then
    Exit('');
...
function TdxCloudStorageProvider.CreateCopyItemToTask
  (AItem: TdxCloudStorageItem; AParent: TdxCloudStorageFolder)
  : TdxCloudStorageProviderMoveItemToCustomTask;
begin
  Result := nil;
...
function TdxCloudStorageProvider.CreateDeleteItemTask
  (AItem: TdxCloudStorageItem): TdxCloudStorageProviderDeleteItemTask;
begin
  Result := nil;
  RaiseOperationNotSupportedException;
end;

function TdxCloudStorageProvider.CreateDeletePermissionTask
  (APermission: TdxCloudStorageItemPermission)
  : TdxCloudStorageProviderDeletePermissionTask;
begin
  Result := nil;
...
function TdxCloudStorageProvider.CreateFetchAllTask
  : TdxCloudStorageProviderFetchAllCustomTask;
begin
  Result := nil;
  RaiseOperationNotSupportedException;
...
function TdxCloudStorageProvider.CreateFetchPermissionsTask
  (AItem: TdxCloudStorageItem)
  : TdxCloudStorageProviderFetchPermissionsCustomTask;
begin
  Result := nil;
...
function TdxCloudStorageProvider.CreateLoadImageTask(const AUri: string)
  : TdxCloudStorageProviderLoadImageTask;
begin
  Result := TdxCloudStorageProviderLoadImageTask.Create(Self, AUri);
end;

function TdxCloudStorageProvider.CreateMoveItemToTask
  (AItem: TdxCloudStorageItem; AParent: TdxCloudStorageFolder)
  : TdxCloudStorageProviderMoveItemToCustomTask;
begin
  Result := nil;
...
function TdxCloudStorageProvider.CreateMoveItemToTrashTask
  (AItem: TdxCloudStorageItem): TdxCloudStorageProviderMoveItemToTrashTask;
begin
  Result := nil;
  RaiseOperationNotSupportedException;
end;

function TdxCloudStorageProvider.CreateRestoreItemFromTrashTask
  (AItem: TdxCloudStorageItem): TdxCloudStorageProviderItemCustomTask;
begin
  Result := nil;
  RaiseOperationNotSupportedException;
end;

function TdxCloudStorageProvider.CreateUpdateFolderTask
...
function TdxCloudStorageProvider.CreateUpdateSpecialFolderTask
  (AFolder: TdxCloudStorageSpecialFolder)
  : TdxCloudStorageProviderUpdateFolderCustomTask;
begin
  Result := nil;
...
procedure TdxCloudStorageProvider.RunTask
  (ATask: TdxCloudStorageProviderCustomTask);
begin
  if ATask = nil then
    Exit;
...
begin
  raise Exception.Create
    (cxGetResourceString
    (@sdxCloudStorageProviderDoesNotSupportThisOperationException));
end;

function TdxCloudStorageProvider.CreateItem(const AData
  : TdxCloudStorageItemData): TdxCloudStorageItem;
begin
...
function TdxCloudStorageProvider.CreateRoot(const AData
  : TdxCloudStorageItemData): TdxCloudStorageItem;
begin
...
function TdxCloudStorageProvider.DoGetSpecialFolderData
  (const AType: TdxCloudStorageSpecialFolder.TType): TdxCloudStorageItemData;
begin
  Result.ID := '';
  case AType of
    TdxCloudStorageSpecialFolder.TType.Recent:
    ...
    TdxCloudStorageSpecialFolder.TType.SharedWithMe:
      Result.Name := cxGetResourceString
        (@sdxCloudStorageSharedWithMeFolderName);
...
function TdxCloudStorageProvider.GetSpecialFolderData
  (const AType: TdxCloudStorageSpecialFolder.TType): TdxCloudStorageItemData;
begin
  Result := DoGetSpecialFolderData(AType);
end;

procedure TdxCloudStorageProvider.LoadImageComplete(const AUri: string;
...
procedure TdxCloudStorageProvider.CopyItemTo(AItem: TdxCloudStorageItem;
AParent: TdxCloudStorageFolder);
begin
  if IsReady then
...
procedure TdxCloudStorageProvider.CopyItemToComplete(AItem: TdxCloudStorageItem;
AParent: TdxCloudStorageFolder; const AData: TdxCloudStorageItemData);
var
...
procedure TdxCloudStorageProvider.CreateFolder(AParent: TdxCloudStorageFolder;
const AName: string);
begin
  if IsReady then
...
procedure TdxCloudStorageProvider.CreateFolderComplete(const AFolderData
  : TdxCloudStorageItemData);
var
  AParentID: string;
...
begin
  ...
  TdxCloudStorageFolder(AFolder).Loaded;
...
procedure TdxCloudStorageProvider.CreatePermissionComplete
  (AItem: TdxCloudStorageItem;
const APermissionData: TdxCloudStorageItemPermissionData);
var
  APermission: TdxCloudStorageItemPermission;
begin
  APermission := AItem.Permissions.Add(APermissionData);
  AItem.UpdatePermissions;
  Storage.DoItemPermissionCreated(APermission);
end;
...
begin
  if IsReady then
    RunTask(CreateCreateSharedLinkTask(AItem, AReadOnly, AScope));
end;
...
procedure TdxCloudStorageProvider.DeleteItemComplete
  (AItem: TdxCloudStorageItem);
begin
  AItem.ClearParents;
...
procedure TdxCloudStorageProvider.DeletePermission
  (APermission: TdxCloudStorageItemPermission);
begin
  if APermission.InheritedFrom then
    raise Exception.Create
      (cxGetResourceString
      (@sdxCloudStorageUnableToDeleteInheritedPermissionException))
  else if IsReady then
    RunTask(CreateDeletePermissionTask(APermission));
end;

procedure TdxCloudStorageProvider.DeletePermissionComplete
  (APermission: TdxCloudStorageItemPermission);
begin
...
procedure TdxCloudStorageProvider.FetchAllComplete
  (AItems: TdxCloudStorageItemList);
var
  AItem: TdxCloudStorageItem;
begin
  ...
  try
    ...
    Files.SpecialFolders.Enum(
      procedure(const ASpecialFolder: TdxCloudStorageSpecialFolder)
      begin
...
procedure TdxCloudStorageProvider.FetchPermissions(AItem: TdxCloudStorageItem);
begin
  if IsReady then
    RunTask(CreateFetchPermissionsTask(AItem));
end;

procedure TdxCloudStorageProvider.FetchPermissionsComplete
  (AItem: TdxCloudStorageItem; AItems: TdxCloudStorageItemPermissionDataList);
begin
...
procedure TdxCloudStorageProvider.InviteUsers(AItem: TdxCloudStorageItem;
const AUsers: TArray<string>; AReadOnly, ARequireSignIn, ASendInvitation
  : Boolean; const AMessage: string);
begin
  if IsReady then
    RunTask(CreateInviteUsersTask(AItem, AUsers, AReadOnly, ARequireSignIn,
      ASendInvitation, AMessage));
end;

procedure TdxCloudStorageProvider.MoveItemTo(AItem: TdxCloudStorageItem;
AParent: TdxCloudStorageFolder);
begin
  if IsReady then
...
procedure TdxCloudStorageProvider.MoveItemToComplete(AItem: TdxCloudStorageItem;
AParent: TdxCloudStorageFolder);
begin
  AItem.ClearParents;
  if AParent.IsLoaded then
...
procedure TdxCloudStorageProvider.MoveItemToTrashComplete
  (AItem: TdxCloudStorageItem; const ANewData: TdxCloudStorageItemData);
var
...
procedure TdxCloudStorageProvider.RestoreItemFromTrash
  (AItem: TdxCloudStorageItem);
begin
  if IsReady then
...
procedure TdxCloudStorageProvider.RestoreItemFromTrashComplete
  (AItem: TdxCloudStorageItem; const ANewData: TdxCloudStorageItemData);
var
  ATrash: TdxCloudStorageSpecialFolder;
  AParentID: string;
...
begin
  ...
  begin
    ...
    if (AParent is TdxCloudStorageFolder) and TdxCloudStorageFolder(AParent).IsLoaded
    then
      AItem.AddParent(TdxCloudStorageFolder(AParent));
  end;
...
procedure TdxCloudStorageProvider.UpdateSpecialFolder
  (AFolder: TdxCloudStorageSpecialFolder);
begin
  if IsReady then
...
begin
  Result := Tasks.UseCurrentThread and
    FileTransferManager.Tasks.UseCurrentThread;
end;
...
procedure TdxCloudStorageProvider.SetAuthorizationAgent
  (const Value: TdxCustomAuthorizationAgent);
begin
...
begin
  Result := TdxHttpHelper.ConcatenateHeaders
    ([TdxHttpHelper.ContentTypeJSONHeader, inherited GetHttpHeaders]);
end;
...
function TdxCloudStorageOAuth2Provider.GetAuthorizationAgent
  : TdxOAuth2AuthorizationAgent;
begin
  Result := TdxOAuth2AuthorizationAgent(inherited AuthorizationAgent);
end;

procedure TdxCloudStorageOAuth2Provider.SetAuthorizationAgent
  (const Value: TdxOAuth2AuthorizationAgent);
begin
...
procedure TdxCloudStorage.DoTreeDataLoading
  (AFolder: TdxCloudStorageCustomFolder);
begin
...
procedure TdxCloudStorage.DoTreeDataLoaded
  (AFolder: TdxCloudStorageCustomFolder);
begin
...
procedure TdxCloudStorage.DoTaskError(ATask: TdxCloudStorageProviderCustomTask;
const AErrorObject: TObject);
begin
...
procedure TdxCloudStorage.DoItemPermissionCreated
  (APermission: TdxCloudStorageItemPermission);
begin
...
procedure TdxCloudStorage.DoItemPermissionDeleted
  (APermission: TdxCloudStorageItemPermission);
begin
...
procedure TdxCloudStorage.DoItemDownload(const AItem: TdxCloudStorageItem;
const APosition: Integer);
begin
...
procedure TdxCloudStorage.DoItemDownloaded(const AItem: TdxCloudStorageItem;
AStream: TStream);
begin
...
procedure TdxCloudStorage.DoItemDownloading(const AItem: TdxCloudStorageItem;
const ASize: Integer);
begin
...
procedure TdxCloudStorage.DoItemUploading(const AFileName: string;
const ASize: Integer);
begin
...
procedure TdxCloudStorage.DoItemUpload(const AFileName: string;
const APosition: Cardinal);
begin
...
procedure TdxCloudStorage.DoFileContentUploaded(const AFile
  : TdxCloudStorageFile);
begin
...
procedure TdxCloudStorage.DoFileContentUploading(const AFile
  : TdxCloudStorageFile; const ASize: Integer);
begin
  if Assigned(FOnFileContentUploading) then
    FOnFileContentUploading(Self, AFile, ASize);
end;

procedure TdxCloudStorage.DoFileContentUpload(const AFile: TdxCloudStorageFile;
const APosition: Integer);
begin
...
procedure TdxCloudStorage.SetProviderClass(const Value
...
begin
  if ProviderClassName <> Value then
    ProviderClass := TdxCloudStorageProviderClass
      (TdxCloudStorage.RegisteredProviders.FindByClassName(Value));
end;
