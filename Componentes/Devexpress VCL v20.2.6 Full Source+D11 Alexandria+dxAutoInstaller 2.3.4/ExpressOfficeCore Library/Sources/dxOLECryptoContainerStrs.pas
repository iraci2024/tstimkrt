...
resourcestring
  sdxOleCryptoContainerInternalError =
    'Internal error occurred while processing a password protected document.';
  sdxOleCryptoContainerInvalidPassword =
    'The password you supplied is not correct.';
  sdxOleCryptoContainerUnsupportedEncryptor =
    'Unsupported encryptor (Code: %d).';
...
begin
  AProduct.Add('sdxOleCryptoContainerInternalError',
    @sdxOleCryptoContainerInternalError);
  AProduct.Add('sdxOleCryptoContainerInvalidPassword',
    @sdxOleCryptoContainerInvalidPassword);
  AProduct.Add('sdxOleCryptoContainerUnsupportedEncryptor',
    @sdxOleCryptoContainerUnsupportedEncryptor);
end;
