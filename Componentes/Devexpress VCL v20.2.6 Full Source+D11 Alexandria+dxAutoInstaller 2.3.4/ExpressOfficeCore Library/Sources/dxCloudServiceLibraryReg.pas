...
begin
  ...
  RegisterComponentEditor(TdxCustomAuthorizationAgent,
    TdxExpressOfficeCoreComponentEditor);
  RegisterComponentEditor(TdxCloudStorage, TdxExpressOfficeCoreComponentEditor);
  RegisterPropertyEditor(TypeInfo(TdxCloudStorageProvider), TdxCloudStorage,
    'Provider', TdxCloudStorageProviderProperty);
