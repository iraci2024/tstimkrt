...
uses
  Types, Classes, Controls, Messages, Windows, Graphics, Forms, StdCtrls,
  SysUtils, IniFiles,
  dxCore, cxGraphics, cxGeometry, cxControls, cxLookAndFeels, cxClasses,
  dxTouch, Generics.Defaults, Generics.Collections;
...
type
  TdxPreviewOptionBehavior = (pobAllowDragMargins, pobHotTrack,
    pobKeyNavigation, pobStoreInRegistry, pobThumbTracking, pobAutoSwapMargins,
  ...
  TdxPreviewOptionView = (povAutoHideScrollBars, povDefaultDrawPageBackground,
    povMargins, povPageSelection);
  ...
  TdxPreviewMeasurementUnits = (pmuDefault, pmuInches, pmuMillimeters,
    pmuCentimeters, pmuPoints, pmuPicas);
...
const
  dxPreviewDefaultBehaviorOptions = [pobAllowDragMargins, pobKeyNavigation,
    pobThumbTracking, pobAutoSwapMargins];
  dxPreviewDefaultOptionsView = [povAutoHideScrollBars,
    povDefaultDrawPageBackground, povMargins, povPageSelection];
  dxPreviewDefaultOptionsHint = [pohShowForMargins, pohShowOnDrag,
    pohShowOnScroll];
...
type
  ...
  public
    ...
    constructor Create(APreview: TdxCustomPreview;
      const ADefaultSize: TPoint); overload;
    constructor Create(APreview: TdxCustomPreview;
      const AMaster: TdxPreviewPageSizeOptions); overload;
    ...
    property MarginsMinValues: TRect read GetMarginsMinValues
      write SetMarginsMinValues;
    ...
    property Orientation: TdxPreviewPaperOrientation read GetOrientation
      write SetOrientation default ppoPortrait;
  ...
  public
    function Add(StartIndex, FinishIndex: Integer; const Bounds: TRect)
      : TdxPreviewPagesRow;
  ...
  public
    procedure GetPartVisiblePageRanges(AStartIndex,
      AEndIndex: PInteger); overload;
    procedure GetPartVisiblePageRanges(out AStartIndex,
      AEndIndex: Integer); overload;
    procedure GetVisiblePageRanges(AStartIndex, AEndIndex: PInteger); overload;
    procedure GetVisiblePageRanges(out AStartIndex,
      AEndIndex: Integer); overload;
  ...
  strict private
    ...
    function Find(APage: TdxPreviewPage;
      out AItem: TdxPreviewPageContentCache): Boolean;
    function FindInvisible(APage: TdxPreviewPage;
      out AItem: TdxPreviewPageContentCache): Boolean;
  ...
  public
    ...
    property Items[Index: Integer]: TdxPreviewPageContentCache
  ...
  protected
    ...
    property IsForceRecalculatePageCount: Boolean
      read GetIsForceRecalculatePageCount;
  ...
  published
    ...
    // HIMETRIC
    property Value: Integer read FValue write SetValue stored IsValueStored;
    // HIMETRIC
  ...
  strict private
    ...
    function GetMarginByClass(Index: TdxPreviewPageMarginClass)
      : TdxPreviewPageMargin;
    ...
    procedure SetMarginByClass(Index: TdxPreviewPageMarginClass;
  ...
  protected
    ...
    function AddMargin(AClass: TdxPreviewPageMarginClass)
      : TdxPreviewPageMargin; virtual;
  ...
  public
    ...
    property Count: Integer read GetCount;
    property Margins[Index: Integer]: TdxPreviewPageMargin read GetMargin
      write SetMargin; default;
    property MarginsByCaption[const Caption: string]: TdxPreviewPageMargin
      read GetMarginByCaption;
    property MarginsByClass[Index: TdxPreviewPageMarginClass]
      : TdxPreviewPageMargin read GetMarginByClass write SetMarginByClass;
    property Preview: TdxCustomPreview read FPreview;
  published
    property Bottom: TdxPreviewPageMarginBottom read GetMarginBottom
      write SetMarginBottom;
    property Footer: TdxPreviewPageMarginFooter read GetMarginFooter
      write SetMarginFooter;
    property Header: TdxPreviewPageMarginHeader read GetMarginHeader
      write SetMarginHeader;
    property Left: TdxPreviewPageMarginLeft read GetMarginLeft
      write SetMarginLeft;
    property Right: TdxPreviewPageMarginRight read GetMarginRight
  ...
  TdxMarginEvent = procedure(Sender: TObject; AMargin: TdxPreviewPageMargin)
    of object;
  TdxPageBackgroundDrawEvent = procedure(Sender: TObject; ACanvas: TCanvas;
    const ARect: TRect; APageIndex: Integer) of object;
  TdxPreviewGetDefaultMeasurementUnitsEvent = procedure(Sender: TObject;
    var AMeasurementUnits: TdxPreviewMeasurementUnits) of object;
  TdxPreviewPageEvent = procedure(Sender: TObject; APageIndex: Integer)
    of object;
  ...
  strict protected
    function CanAddRow(AColumnIndex: Integer; const ABounds: TRect;
      const APageSize: TPoint): Boolean; virtual;
    ...
    procedure CalculateVisiblePageRange(out AFirstPageIndex, ALastPageIndex
      : Integer); virtual;
    procedure CalculateZoomFactorForPageWidthPreviewZoomMode(AFirstPageIndex,
      ALastPageIndex: Integer); virtual;
  ...
  private
    ...
    function IsEnabledBehaviorOption(AOption: TdxPreviewOptionBehavior)
      : Boolean;
  ...
  protected
    ...
    function GetActualPageSizeOptions(APage: TdxPreviewPage)
      : TdxPreviewPageSizeOptions;
    ...
    procedure ProcessClickBySelectedPage(Shift: TShiftState;
      X, Y: Integer); virtual;
    ...
    procedure DoDrawPageContent(ACanvas: TcxCanvas; const R: TRect;
    ...
    procedure DrawPage(ACanvas: TcxCanvas; APage: TdxPreviewPage;
      ASelected: Boolean);
    ...
    function MarginFromPoint(const Pt: TSmallPoint)
      : TdxPreviewPageMargin; overload;
    ...
    property PagesContentCache: TdxPreviewPageContentCachePool
      read FPagesContentCache;
    ...
    property ActualMeasurementUnits: TdxPreviewMeasurementUnits
      read GetActualMeasurementUnits;
    property DefaultMeasurementUnits: TdxPreviewMeasurementUnits
      read FDefaultMeasurementUnits write FDefaultMeasurementUnits
      default pmuDefault;
    ...
    property MinZoomFactor: Integer read FMinZoomFactor write SetMinZoomFactor
      default 10;
    property NoPagesText: string read GetNoPagesText write SetNoPagesText
      stored IsNoPagesTextStored;

    property OptionsHint: TdxPreviewOptionsHint read FOptionsHint
      write SetOptionsHint default dxPreviewDefaultOptionsHint;
    property OptionsStore: TdxPreviewOptionsStore read FOptionsStore
      write SetOptionsStore default [posZoom];

    property InternalOptionsBehavior: TdxPreviewOptionsBehavior
      read FInternalOptionsBehavior write SetInternalOptionsBehavior
      default dxPreviewDefaultBehaviorOptions;
    property InternalOptionsView: TdxPreviewOptionsView
      read FInternalOptionsView write SetInternalOptionsView
      default dxPreviewDefaultOptionsView;
    property InternalOptionsZoom: TdxPreviewOptionsZoom
      read FInternalOptionsZoom write SetInternalOptionsZoom
      default dxPreviewDefaultOptionsZoom;

    property LayoutCalculator: TdxCustomPreviewLayoutCalculator
    ...
    property SelPageSizeOptions: TdxPreviewPageSizeOptions
      read GetSelPageSizeOptions;
    ...
    property OnDrawPageBackground: TdxPageBackgroundDrawEvent
      read FOnDrawPageBackground write FOnDrawPageBackground;
    ...
    property OnGetPageNumberHint: TdxGetPageNumberHintEvent
      read FOnGetPageNumberHint write FOnGetPageNumberHint;
    property OnCanShowMarginHint: TdxCanShowMarginHintEvent
      read FOnCanShowMarginHint write FOnCanShowMarginHint;
    property OnChangePageCount: TNotifyEvent read FOnChangePageCount
      write FOnChangePageCount;
    property OnMarginChanged: TdxMarginEvent read FOnMarginChanged
      write FOnMarginChanged;
    property OnPostDrawPageContent: TdxDrawPageContentEvent
      read FOnPostDrawPageContent write FOnPostDrawPageContent;
    property OnSelectedPageChanged: TdxPreviewPageEvent
      read FOnSelectedPageChanged write FOnSelectedPageChanged;
    property OnSelectedPageChanging: TdxPreviewPageEvent
      read FOnSelectedPageChanging write FOnSelectedPageChanging;
...
const
  ...
  phtMarginsHorz: TdxPreviewHitTests = [phtMarginTop, phtMarginBottom,
    phtMarginHeader];
  phtMarginsVert: TdxPreviewHitTests = [phtMarginLeft, phtMarginRight];

procedure dxDrawDefaultPagePreview(const ACanvas: TCanvas;
  const AContentBounds: TRect; ACenterHorizontally, ACenterVertically: Boolean;
...
uses
  Themes, Math, Registry, dxCustomPreviewStrs, dxDPIAwareUtils, dxPrintUtils,
  dxMeasurementUnits, dxTypeHelpers,
  cxLibraryConsts;
...
begin
  ...
  ALineColor.L := IfThen(ALineColor.L > 0.5, ALineColor.L - 0.1,
    ALineColor.L + 0.1);
  ACanvas.Brush.Color := TdxColorSpaceConverter.HSLToColor(ALineColor);

  for I := 0 to ALineCountX do
  begin
    ALineBounds := Rect(ARect.Left + I * ALineStepX, ARect.Top,
      ARect.Left + I * ALineStepX + 1, ARect.Bottom);
  ...
  begin
    ALineBounds := Rect(ARect.Left, ARect.Top + I * ALineStepY, ARect.Right + 1,
      ARect.Top + I * ALineStepY + 1);
    if RectVisible(ACanvas.Handle, ALineBounds) then
      ACanvas.FillRect(ALineBounds);
  end;
end;
...
const
  Map: array [TdxMeasurementUnits] of TdxPreviewMeasurementUnits = (pmuDefault,
    pmuInches, pmuMillimeters);
begin
  Result := Map[dxGetDefaultMeasurementUnits];
end;

function LoMetricToAnother(AUnits: TdxPreviewMeasurementUnits;
  Value: Integer): TFloat;
begin
...
begin
  ...
  ExtTextOut(DC, R.Left + 2, R.Top + 2, ETO_OPAQUE, @R, PChar(Caption),
    Length(Caption), nil);
end;
...
constructor TdxPreviewPageSizeOptions.Create(APreview: TdxCustomPreview;
  const AMaster: TdxPreviewPageSizeOptions);
begin
  Create(APreview);
  FMaster := AMaster;
  FAssigned := False;
...
begin
  FMinUsefulSize.X := MinMax(Value.X, 0, ActualSize.X - Margins.Left -
    Margins.Right);
  FMinUsefulSize.Y := MinMax(Value.Y, 0, ActualSize.Y - Margins.Top -
    Margins.Bottom);
end;

procedure TdxPreviewPageSizeOptions.SetOrientation
  (AValue: TdxPreviewPaperOrientation);
begin
...
begin
  ...
  begin
    Assigned := True;
    FSize := cxPoint(Max(Value.X, FMinUsefulSize.X),
      Max(Value.Y, FMinUsefulSize.Y));
    Changed;
  end;
end;
...
var
  R: TRect;
begin
  Result := IntersectRect(R, SiteBounds, Preview.ClientRect) and
    PtInRect(R, Pt);
end;
...
var
  R: TRect;
begin
  Result := IntersectRect(R, Bounds, Preview.ClientRect) and
    EqualRect(R, Bounds);
end;
...
begin
  Result := PartVisible and
    (Bounds.Bottom >= (Preview.ClientRect.Bottom div 2));
end;
...
function TdxPreviewPagesRowList.Add(StartIndex, FinishIndex: Integer;
  const Bounds: TRect): TdxPreviewPagesRow;
begin
...
procedure TdxPreviewPageList.GetPartVisiblePageRanges(AStartIndex,
  AEndIndex: PInteger);
var
...
procedure TdxPreviewPageList.GetPartVisiblePageRanges(out AStartIndex,
  AEndIndex: Integer);
begin
  AEndIndex := -1;
  AStartIndex := -1;
...
procedure TdxPreviewPageList.GetVisiblePageRanges(AStartIndex,
  AEndIndex: PInteger);
var
  StartIndex, EndIndex: Integer;
begin
...
procedure TdxPreviewPageList.GetVisiblePageRanges(out AStartIndex,
  AEndIndex: Integer);
begin
  if Count <> 0 then
  begin
...
procedure TdxPreviewPageList.OffsetBounds(X, Y, AStartIndex,
...
function TdxPreviewPageList.GetBounds(AStartIndex, AFinishIndex
  : Integer): TRect;
var
  I: Integer;
begin
...
procedure TdxPreviewPageList.CenterPagesInRow(ARow: TdxPreviewPagesRow;
  AMaxWidth: Integer);
var
  ADelta: Integer;
...
begin
  ...
  begin
    APage := Items[I];
    APage.Bounds := cxRectOffset(APage.Bounds, ADelta,
      (cxRectHeight(ARow.Bounds) - cxRectHeight(APage.Bounds)) div 2);
  end
end;
...
begin
  ...
  Filer.DefineProperty('IsCaptionAssigned', ReadIsCaptionAssigned,
    WriteIsCaptionAssigned, FIsCaptionAssigned and (FCaption = ''));
end;
...
begin
  ...
  else if APos = PosFromValue(FValue) then
    Result := FValue
  else
  begin
...
procedure TdxPreviewPageMargin.SetDraggingPos(Value: Integer);
  ...
  begin
    ...
    begin
      with PageBounds do
        if IsVertical then
          BitBlt(BitmapDC, 0, 0, 1, Bottom - Top, DC, FDraggingPos,
            Top, SRCCOPY)
        else
          BitBlt(BitmapDC, 0, 0, Right - Left, 1, DC, Left,
            FDraggingPos, SRCCOPY);
    end;
  end;
  ...
  begin
    ...
    begin
      with PageBounds do
        if IsVertical then
          BitBlt(DC, FDraggingPos, Top, 1, Bottom - Top, BitmapDC, 0,
            0, SRCCOPY)
        else
          BitBlt(DC, Left, FDraggingPos, Right - Left, 1, BitmapDC, 0,
            0, SRCCOPY);
    end;
  end;
...
begin
  Result := ActualPageSize.ActualSize.Y -
    (ActualPageSize.MinUsefulSize.Y + MaxIntValue([Margins.Top.Value,
    Margins.Top.MinValue, Margins.Header.MinValue]));
end;
...
begin
  Result := ActualPageSize.ActualSize.Y -
    (Margins.Top.Value + ActualPageSize.MinUsefulSize.Y);
end;
...
begin
  Result := ActualPageSize.ActualSize.Y -
    (ActualPageSize.MinUsefulSize.Y + Margins.Bottom.Value);
end;

function TdxPreviewPageMarginHeader.DoGetMaxMinValue: Integer;
begin
  Result := ActualPageSize.ActualSize.Y -
    (Margins.Bottom.Value + ActualPageSize.MinUsefulSize.Y);
end;
...
begin
  Result := Max(ActualMinValue, ActualPageSize.ActualSize.X -
    (ActualPageSize.MinUsefulSize.X + Margins.Right.Value));
end;

function TdxPreviewPageMarginLeft.DoGetMaxMinValue: Integer;
begin
  Result := ActualPageSize.ActualSize.X -
    (Margins.Right.Value + ActualPageSize.MinUsefulSize.X);
end;
...
begin
  Result := Max(ActualMinValue, ActualPageSize.ActualSize.X -
    (Margins.Left.Value + ActualPageSize.MinUsefulSize.X));
end;
...
begin
  Result := ActualPageSize.ActualSize.Y -
    (ActualPageSize.MinUsefulSize.Y + MaxIntValue([Margins.Bottom.Value,
    Margins.Bottom.MinValue, Margins.Footer.MinValue]));
end;
...
function TdxPreviewPageMargins.AddMargin(AClass: TdxPreviewPageMarginClass)
  : TdxPreviewPageMargin;
begin
...
begin
  ...
  begin
    Preview.SelPageSizeOptions.Margins := Rect(Left.Value, Top.Value,
...
function TdxPreviewPageMargins.GetMarginByCaption(const Caption: string)
  : TdxPreviewPageMargin;
var
  I: Integer;
begin
...
function TdxPreviewPageMargins.GetMarginByClass
  (Index: TdxPreviewPageMarginClass): TdxPreviewPageMargin;
var
  I: Integer;
begin
  for I := 0 to Count - 1 do
...
begin
  Result := MarginsByClass[TdxPreviewPageMarginBottom]
    as TdxPreviewPageMarginBottom;
end;

function TdxPreviewPageMargins.GetMarginFooter: TdxPreviewPageMarginFooter;
begin
  Result := MarginsByClass[TdxPreviewPageMarginFooter]
    as TdxPreviewPageMarginFooter;
end;

function TdxPreviewPageMargins.GetMarginHeader: TdxPreviewPageMarginHeader;
begin
  Result := MarginsByClass[TdxPreviewPageMarginHeader]
    as TdxPreviewPageMarginHeader;
end;

function TdxPreviewPageMargins.GetMarginLeft: TdxPreviewPageMarginLeft;
begin
  Result := MarginsByClass[TdxPreviewPageMarginLeft]
    as TdxPreviewPageMarginLeft;
end;

function TdxPreviewPageMargins.GetMarginRight: TdxPreviewPageMarginRight;
begin
  Result := MarginsByClass[TdxPreviewPageMarginRight]
    as TdxPreviewPageMarginRight;
end;
...
procedure TdxPreviewPageMargins.SetMargin(Index: Integer;
  Value: TdxPreviewPageMargin);
begin
  Margins[Index].Assign(Value);
end;

procedure TdxPreviewPageMargins.SetMarginByClass
  (Index: TdxPreviewPageMarginClass; Value: TdxPreviewPageMargin);
var
  Margin: TdxPreviewPageMargin;
begin
...
procedure TdxPreviewPageMargins.SetMarginBottom
  (Value: TdxPreviewPageMarginBottom);
begin
  MarginsByClass[TdxPreviewPageMarginBottom] := Value;
end;

procedure TdxPreviewPageMargins.SetMarginFooter
  (Value: TdxPreviewPageMarginFooter);
begin
  MarginsByClass[TdxPreviewPageMarginFooter] := Value;
end;

procedure TdxPreviewPageMargins.SetMarginHeader
  (Value: TdxPreviewPageMarginHeader);
begin
...
procedure TdxPreviewPageMargins.SetMarginRight
  (Value: TdxPreviewPageMarginRight);
begin
...
function TdxCustomPreviewLayoutCalculator.GetPageSiteBounds
...
function TdxCustomPreviewLayoutCalculator.CanAddRow(AColumnIndex: Integer;
  const ABounds: TRect; const APageSize: TPoint): Boolean;
begin
  Result := (FPreview.ZoomMode = pzmPages) and
    (AColumnIndex = FPreview.PageXCount) or (FPreview.ZoomMode <> pzmPages) and
    (ABounds.Left + APageSize.X > ABounds.Right);
end;
...
procedure TdxCustomPreviewLayoutCalculator.CalculateVisiblePageRange
  (out AFirstPageIndex, ALastPageIndex: Integer);
begin
  Pages.GetPartVisiblePageRanges(AFirstPageIndex, ALastPageIndex);
end;

procedure TdxCustomPreviewLayoutCalculator.
...
begin
  ZoomFactor := MulDiv(100, cxRectWidth(GetPagesArea),
    GetMaxPageSize(AFirstPageIndex, ALastPageIndex));
end;
...
procedure TdxCustomPreviewLayoutCalculator.
  ...
  begin
    ...
    begin
      AZoom := Trunc(ZoomFactor * cxRectHeight(R) / (PagesRows[I].Bounds.Bottom
        - PagesRows[AIndex].Bounds.Top));
  ...
  function CalcZoomFactorX(AStartIndex, AFinishIndex,
    APagesCount: Integer): Integer;
  begin
    Result := 0;
    ...
    Result := Max(Trunc(ZoomFactor * cxRectWidth(GetPagesArea) / Result),
      FPreview.MinZoomFactor);
  end;

begin
  ZoomFactor := Min(CalcZoomFactorX(AFirstPageIndex, ALastPageIndex,
    FPreview.PageXCount), CalcZoomFactorY(GetPagesArea, AFirstPageIndex,
    FPreview.PageYCount));
end;
...
procedure TdxCustomPreviewLayoutCalculator.AlignPagesToHorizontalCenter
  (const ABounds: TRect);
var
...
procedure TdxCustomPreviewLayoutCalculator.AlignPagesToVerticalCenter
  (const ABounds: TRect);
var
  ADelta: Integer;
begin
...
procedure TdxCustomPreviewLayoutCalculator.CalculatePagesRows
  (const ABounds: TRect);
var
...
begin
  ...
  begin
    ...
    APageSize := cxPointScale(APage.PageSize.ActualSizeInPixels,
      FPreview.ActualZoomFactor, 100);
    if AFirstPageInRow <> I then
      if CanAddRow(AColumnIndex, ARect, APageSize) then
      begin
        FPreview.PagesRows.Add(AFirstPageInRow, I - 1,
          cxRect(ABounds.Left, ARect.Top, ARect.Left - FPreview.Indent,
          ARect.Bottom));
  ...
  FPreview.PagesRows.Add(AFirstPageInRow, FPreview.PageCount - 1,
    cxRect(ABounds.Left, ARect.Top, ARect.Left - FPreview.Indent,
    ARect.Bottom));
end;
...
procedure TdxCustomPreview.LoadFromIniFile(AIniFile: TCustomIniFile;
  const ASectionName: string);
begin
  OptionsHint := TdxPreviewOptionsHint(Byte(AIniFile.ReadInteger(ASectionName,
    sdxOptionsHint, Byte(OptionsHint))));
  InternalOptionsView := TdxPreviewOptionsView
    (Byte(AIniFile.ReadInteger(ASectionName, sdxOptionsView,
    Byte(InternalOptionsView))));
  InternalOptionsZoom := TdxPreviewOptionsZoom
    (Byte(AIniFile.ReadInteger(ASectionName, sdxOptionsZoom,
    Byte(InternalOptionsZoom))));

  ZoomStep := AIniFile.ReadInteger(ASectionName, sdxZoomStep, ZoomStep);
  MarginColor := AIniFile.ReadInteger(ASectionName, sdxMarginColor,
    MarginColor);
  MeasurementUnits := TdxPreviewMeasurementUnits
    (AIniFile.ReadInteger(ASectionName, sdxMeasurementUnits,
    Ord(MeasurementUnits)));
  PageSize.Orientation := TdxPreviewPaperOrientation
    (AIniFile.ReadInteger(ASectionName, sdxOrientation,
    Ord(PageSize.Orientation)));

  if NeedStoreZoomOptions then
  begin
    ZoomFactor := AIniFile.ReadInteger(ASectionName, sdxZoomFactor, ZoomFactor);
    ZoomMode := TdxPreviewZoomMode(AIniFile.ReadInteger(ASectionName,
      sdxZoomMode, Ord(ZoomMode)));
    if ZoomMode = pzmPages then
    begin
      PageXCount := AIniFile.ReadInteger(ASectionName, sdxPageXCount,
        PageXCount);
      PageYCount := AIniFile.ReadInteger(ASectionName, sdxPageYCount,
        PageYCount);
    end;
  end;
end;
...
procedure TdxCustomPreview.SaveToIniFile(AIniFile: TCustomIniFile;
  const ASectionName: string);
begin
  AIniFile.WriteInteger(ASectionName, sdxMeasurementUnits,
    Integer(MeasurementUnits));
  AIniFile.WriteInteger(ASectionName, sdxOptionsHint,
    Integer(Byte(OptionsHint)));
  AIniFile.WriteInteger(ASectionName, sdxOptionsView,
    Integer(Byte(InternalOptionsView)));
  AIniFile.WriteInteger(ASectionName, sdxOptionsZoom,
    Integer(Byte(InternalOptionsZoom)));
  AIniFile.WriteInteger(ASectionName, sdxOrientation,
    Integer(FPageSize.Orientation));
...
function TdxCustomPreview.GetHitInfoAt(const Pt: TSmallPoint)
  : TdxPreviewHitTests;
begin
...
begin
  Result := cxRectContent(ClientBounds, Rect(AbsoluteIndentLeft,
    AbsoluteIndentLeft, AbsoluteIndentRight, AbsoluteIndentRight));
end;
...
procedure TdxCustomPreview.MakePageVisible(APageIndex: Integer;
  AAnimated: Boolean);
...
begin
  MakePageVisible(APageIndex, IsScrollAnimationEnabled and
...
function TdxCustomPreview.MarginFromPoint(const Pt: TPoint)
  : TdxPreviewPageMargin;
var
  I: Integer;
begin
...
function TdxCustomPreview.MarginFromPoint(const Pt: TSmallPoint)
  : TdxPreviewPageMargin;
begin
...
begin
  ...
  APageWidth := LoMetricToAnother(ActualMeasurementUnits,
    SelPageSizeOptions.Size.X);
  APageHeight := LoMetricToAnother(ActualMeasurementUnits,
    SelPageSizeOptions.Size.Y);

  Result := FormatFloat(AMask, APageWidth) + ' ' + Result + ' x ' +
    FormatFloat(AMask, APageHeight) + ' ' + Result;
end;

function TdxCustomPreview.PageGetContentBounds(const APageBounds: TRect): TRect;
begin
  Result := Rect(APageBounds.Left + Margins.Left.VisibleValue,
...
function TdxCustomPreview.GetDesignHitTest(X, Y: Integer;
  Shift: TShiftState): Boolean;
begin
  Result := (DraggingMargin <> nil) or
    (GetHitInfoAt(cxPoint(X, Y)) * phtMargins <> []);
end;
...
function TdxCustomPreview.GetActualPageSizeOptions(APage: TdxPreviewPage)
  : TdxPreviewPageSizeOptions;
begin
...
function TdxCustomPreview.GetMainScrollBarsClass
...
begin
  case Key of
    ...
    VK_RIGHT:
      if ssCtrl in Shift then
        ScrollPage(psdRight)
      else if (SelPageIndex + 1 < PageCount) and
        (Pages[SelPageIndex + 1].Cell.Y = SelPage.Cell.Y) then
        SelectNextPage;
    ...
    VK_DOWN:
      if ssAlt in Shift then
        ...
        ScrollPage(psdDown)
      else if (SelPage <> nil) and (SelPage.Cell.Y + 1 < PagesRows.Count) then
      begin
        ARow := PagesRows[SelPage.Cell.Y + 1];
        SelPageIndex := Min(ARow.StartIndex + SelPage.Cell.X, ARow.FinishIndex);
      end;
...
procedure TdxCustomPreview.MouseDown(Button: TMouseButton; Shift: TShiftState;
  X, Y: Integer);
begin
...
procedure TdxCustomPreview.MouseUp(Button: TMouseButton; Shift: TShiftState;
  X, Y: Integer);
var
  Margin: TdxPreviewPageMargin;
  Pos: Integer;
...
procedure TdxCustomPreview.Scroll(AScrollBarKind: TScrollBarKind;
...
procedure TdxCustomPreview.ScrollHorizontal(AScrollCode: TScrollCode;
  AScrollPos: Integer);
begin
  case AScrollCode of
    scTrack:
...
procedure TdxCustomPreview.ScrollVertical(AScrollCode: TScrollCode;
  AScrollPos: Integer);
begin
  case AScrollCode of
    scEndScroll:
...
function TdxCustomPreview.ProcessMouseWheelMessage
...
procedure TdxCustomPreview.WndProc(var Message: TMessage);
  ...
  begin
    Result := not IsControlMouseMsg(AMouse) and
      (not AllowZoomOnClick or (FPages.PageIndexFromPoint(AMouse.Pos) = -1));
  end;

  function HandleWindowMessage(var Message: TMessage): Boolean;
  begin
    Result := (Message.Msg = WM_LBUTTONDOWN) or
      (Message.Msg = WM_LBUTTONDBLCLK);
    if Result then
    begin
      Result := not(IsDesigning or Dragging) and (DragMode = dmAutomatic) and
        (DragKind = dkDrag);
...
function TdxCustomPreview.CreateLayoutCalculator
  : TdxCustomPreviewLayoutCalculator;
begin
...
function TdxCustomPreview.GetPageSizeOptionsClass
...
begin
  Result := ScaleFactor.Apply(dxPreviewAbsoluteIndent) +
    Max(PageBorders.Left, PageBorders.Top);
end;

function TdxCustomPreview.GetAbsoluteIndentRight: Integer;
begin
  Result := ScaleFactor.Apply(dxPreviewAbsoluteIndent) + Max(PageBorders.Right,
    PageBorders.Bottom);
end;

procedure TdxCustomPreview.CalculatePageNumberHintText(AStartPage,
...
procedure TdxCustomPreview.ProcessClickBySelectedPage(Shift: TShiftState;
  X, Y: Integer);

  function CanDragMargin(AMargin: TdxPreviewPageMargin): Boolean;
  begin
    Result := AllowDragMargins and Assigned(AMargin) and AMargin.Enabled and
...
procedure TdxCustomPreview.ProcessLeftClickByPage(Shift: TShiftState;
  X, Y: Integer);
var
...
begin
  ...
  begin
    ...
    begin
      ...
      begin
        if not IsScrolling or IsScrolling and AllowMakeVisibleSelectedPageWhenScrolling
        then
        begin
          ResyncMargins;
...
const
  BarMap: array [TdxPreviewScrollDirection] of TScrollBarKind = (sbHorizontal,
    sbVertical, sbHorizontal, sbVertical);
  ScrollCodeMap: array [TdxPreviewScrollDirection] of TScrollCode = (scLineUp,
    scLineUp, scLineDown, scLineDown);
var
  AScrollPos: Integer;
begin
  if CanPageScrolling(ADirection) then
...
function TdxCustomPreview.CreateBackgroundRegion(APage: TdxPreviewPage)
  : TcxRegion;
var
  AMargins: TRect;
...
begin
  ...
  AMargins := cxRect(APageSize.Margins.Left, APageSize.Header,
    APageSize.Margins.Right, APageSize.Margins.Bottom);
...
begin
  ...
  FPagesContentCache := TdxPreviewPageContentCachePool.Create
    (GetDefaultCachedPagesCount);
  FHintHideLongTimer := cxCreateTimer(HintHideLongTimerHandler,
    dxPreviewHideHintLongTime);
  FHintHideShortTimer := cxCreateTimer(HintHideShortTimerHandler,
    dxPreviewHideHintShortTime);
...
procedure TdxCustomPreview.DoDrawPageContent(ACanvas: TcxCanvas; const R: TRect;
  APageIndex: Integer);
begin
...
procedure TdxCustomPreview.DrawPageBackground(ACanvas: TcxCanvas;
...
begin
  ...
  else if DefaultMeasurementUnits <> pmuDefault then
...
procedure TdxCustomPreview.SetInternalOptionsBehavior
  (Value: TdxPreviewOptionsBehavior);
var
  Changes: TdxPreviewOptionsBehavior;
  I: Integer;
begin
  Changes := FInternalOptionsBehavior + Value -
  ...
  begin
    ...
    begin
      if [povDefaultDrawPageBackground, povPageSelection] * Changes <> [] then
        InvalidatePages
      else if povAutoHideScrollBars in Changes then
        RecreateWnd;
    end;
...
begin
  ...
  begin
    ...
    if Assigned(FOnCalcPageCount) and
      ([csReading, csLoading] * ComponentState = []) then
    begin
      DoCalcPageCount;
      if HandleAllocated then
        Invalidate;
...
begin
  ...
  TdxPreviewHintWindow(FHintWindow).ActivateHint(Pt,
    AMargin.DisplayText, AMargin);
end;
...
begin
  ...
  TdxPreviewHintWindow(FHintWindowPageNumber).ActivateHint(GetMouseCursorPos,
    HintText, nil);
end;
...
procedure TdxCustomPreview.ChangeSelPageIndex(AStartPageIndex: Integer;
  ADirection: Integer);
var
  I: Integer;
begin
  ...
  repeat
    if SelectPage(AStartPageIndex + ADirection * I) then
      Break;
    Inc(I);
  until (AStartPageIndex + ADirection * I = PageCount + 1) or
    (AStartPageIndex - ADirection * I = -2);
end;

function TdxCustomPreview.IsEnabledBehaviorOption
  (AOption: TdxPreviewOptionBehavior): Boolean;
begin
  Result := AOption in InternalOptionsBehavior;
end;

function TdxCustomPreview.IsEnabledViewOption
  (AOption: TdxPreviewOptionView): Boolean;
begin
...
begin
  ...
  cxDrawText(ACanvas.Handle, NoPagesText, R, DT_CALCRECT or DT_CENTER or
    DT_WORDBREAK or DT_TOP);
  R := cxRectCenter(ClientRect, cxRectWidth(R), cxRectHeight(R));
  cxDrawText(ACanvas.Handle, NoPagesText, R, DT_WORDBREAK);
end;

procedure TdxCustomPreview.DrawPage(ACanvas: TcxCanvas; APage: TdxPreviewPage;
  ASelected: Boolean);
begin
...
procedure TdxCustomPreview.DrawViewerBackground(ACanvas: TcxCanvas;
  const R: TRect);
begin
  if TRANSPARENT then
    cxDrawTransparentControlBackground(Self, ACanvas, R)
  else
    LookAndFeelPainter.DrawPrintPreviewScaledBackground(ACanvas, R,
      ScaleFactor);
end;
...
function TdxCustomPreview.CanPageScrolling(ADirection
  : TdxPreviewScrollDirection): Boolean;
begin
...
begin
  CancelHintShow;
  if not IsDesigning and IsParentFormActive and
    (pohShowForMargins in OptionsHint) and
...
begin
  if not IsParentFormActive or
    (Time - FLongShowHintTime > dxPreviewHideHintLongTime) then
  begin
    DestroyHint;
...
begin
  ...
  if (Margin <> nil) and (not Margin.IsDragging or
    (pohShowOnDrag in OptionsHint)) then
  begin
    CreateHint;
    ActivateHint(Margin);
...
begin
  inherited;
  Message.Result := Message.Result or AllKeys[DraggingMargin <> nil] or
    ArrowKeys[AllowKeyNavigation];
end;
...
begin
  ...
  begin
    ...
    begin
      Pt := GetMouseCursorClientPos;
      if (FPages.PageIndexFromPoint(Pt) > -1)
      { and not Assigned(MarginFromPoint(APt)) } then
  ...
  begin
    ...
    begin
      ...
      if phtPage in HitInfo then
        ...
        else if not IsDesigning and AllowZoomOnClick and
          (FPages.PageIndexFromPoint(Pt) = SelPageIndex) then
...
begin
  ...
  Message.Result := Integer((DraggingMargin <> nil) and
    (FPages.PageIndexFromPoint(Message.HintInfo^.CursorPos) <> -1));
end;
...
begin
  if (cxRectWidth(Page.Bounds) <> Width) or (cxRectHeight(Page.Bounds) <> Height)
  then
  begin
    SetSize(Page.Bounds);
    Dirty := True;
...
function TdxPreviewPageContentCachePool.Add(APage: TdxPreviewPage)
  : TdxPreviewPageContentCache;
begin
  ...
  begin
    ...
    else if not FindInvisible(nil, Result) then
      Result := Items[0];
  end;
  Result.Page := APage;
  Result.CheckSize;
...
function TdxPreviewPageContentCachePool.Find(APage: TdxPreviewPage;
  out AItem: TdxPreviewPageContentCache): Boolean;
var
  I: Integer;
begin
...
function TdxPreviewPageContentCachePool.GetItem(Index: Integer)
  : TdxPreviewPageContentCache;
begin
...
dxRegisterCursor(crdxPreviewHorzResize, HInstance,
  IDC_DXPREVIEW_MARGINSMOVEHORZ);
dxRegisterCursor(crdxPreviewVertResize, HInstance,
  IDC_DXPREVIEW_MARGINSMOVEVERT);
