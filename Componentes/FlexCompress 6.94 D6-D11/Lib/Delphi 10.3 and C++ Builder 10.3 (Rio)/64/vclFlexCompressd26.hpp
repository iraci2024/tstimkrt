...
// (DO NOT EDIT: machine generated header) 'vclFlexCompressd26.dpk' rev: 33.00 (Windows)

#ifndef Vclflexcompressd26HPP
#define Vclflexcompressd26HPP
...
namespace Vclflexcompressd26
{
//-- forward type declarations -----------------------------------------------
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Vclflexcompressd26 */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_VCLFLEXCOMPRESSD26)
using namespace Vclflexcompressd26;
#endif
#pragma pack(pop)
#pragma option pop
