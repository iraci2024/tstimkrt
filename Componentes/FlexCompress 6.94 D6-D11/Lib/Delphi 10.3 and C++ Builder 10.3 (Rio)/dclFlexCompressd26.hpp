...
// (DO NOT EDIT: machine generated header) 'dclFlexCompressd26.dpk' rev: 33.00 (Windows)

#ifndef Dclflexcompressd26HPP
#define Dclflexcompressd26HPP
...
#include <FXCHash.hpp>	// (vclFlexCompressd26)
#include <FXCsha1.hpp>	// (vclFlexCompressd26)
#include <FXCDecUtil.hpp>	// (vclFlexCompressd26)
#include <FXCCipher.hpp>	// (vclFlexCompressd26)
#include <FXCRNG.hpp>	// (vclFlexCompressd26)
#include <FXCConst.hpp>	// (vclFlexCompressd26)
#include <FXCStrFunc.hpp>	// (vclFlexCompressd26)
#include <FlexCompress.hpp>	// (vclFlexCompressd26)
// PRG_EXT: .bpl
// OBJ_EXT: .obj

//-- user supplied -----------------------------------------------------------

namespace Dclflexcompressd26
{
//-- forward type declarations -----------------------------------------------
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Dclflexcompressd26 */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_DCLFLEXCOMPRESSD26)
using namespace Dclflexcompressd26;
#endif
#pragma pack(pop)
#pragma option pop
