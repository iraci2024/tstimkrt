...
// (DO NOT EDIT: machine generated header) 'dclFlexCompressd25.dpk' rev: 32.00 (Windows)

#ifndef Dclflexcompressd25HPP
#define Dclflexcompressd25HPP
...
#include <FXCHash.hpp>	// (vclFlexCompressd25)
#include <FXCsha1.hpp>	// (vclFlexCompressd25)
#include <FXCDecUtil.hpp>	// (vclFlexCompressd25)
#include <FXCCipher.hpp>	// (vclFlexCompressd25)
#include <FXCRNG.hpp>	// (vclFlexCompressd25)
#include <FXCConst.hpp>	// (vclFlexCompressd25)
#include <FXCStrFunc.hpp>	// (vclFlexCompressd25)
#include <FlexCompress.hpp>	// (vclFlexCompressd25)
// PRG_EXT: .bpl
// OBJ_EXT: .obj

//-- user supplied -----------------------------------------------------------

namespace Dclflexcompressd25
{
//-- forward type declarations -----------------------------------------------
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Dclflexcompressd25 */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_DCLFLEXCOMPRESSD25)
using namespace Dclflexcompressd25;
#endif
#pragma pack(pop)
#pragma option pop
