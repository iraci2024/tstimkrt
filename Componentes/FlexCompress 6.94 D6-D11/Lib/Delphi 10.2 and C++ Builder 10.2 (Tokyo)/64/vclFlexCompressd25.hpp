...
// (DO NOT EDIT: machine generated header) 'vclFlexCompressd25.dpk' rev: 32.00 (Windows)

#ifndef Vclflexcompressd25HPP
#define Vclflexcompressd25HPP
...
namespace Vclflexcompressd25
{
//-- forward type declarations -----------------------------------------------
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Vclflexcompressd25 */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_VCLFLEXCOMPRESSD25)
using namespace Vclflexcompressd25;
#endif
#pragma pack(pop)
#pragma option pop
