...
// (DO NOT EDIT: machine generated header) 'vclFlexCompressd19.pas' rev: 26.00 (Windows)

#ifndef Vclflexcompressd19HPP
#define Vclflexcompressd19HPP
...
namespace Vclflexcompressd19
{
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Vclflexcompressd19 */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_VCLFLEXCOMPRESSD19)
using namespace Vclflexcompressd19;
#endif
#pragma pack(pop)
#pragma option pop
