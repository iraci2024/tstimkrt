...
// (DO NOT EDIT: machine generated header) 'dclFlexCompressd19.pas' rev: 26.00 (Windows)

#ifndef Dclflexcompressd19HPP
#define Dclflexcompressd19HPP
...
namespace Dclflexcompressd19
{
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Dclflexcompressd19 */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_DCLFLEXCOMPRESSD19)
using namespace Dclflexcompressd19;
#endif
#pragma pack(pop)
#pragma option pop
