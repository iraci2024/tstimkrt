...
// (DO NOT EDIT: machine generated header) 'FXCRNG.pas' rev: 4.00
...
public:
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmt */ inline __fastcall ERandom(const AnsiString Msg, const System::TVarRec * Args
		, const int Args_Size) : Sysutils::Exception(Msg, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateRes */ inline __fastcall ERandom(int Ident, Extended Dummy) : Sysutils::Exception(
		Ident, Dummy) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmt */ inline __fastcall ERandom(int Ident, const System::TVarRec * Args, const 
		int Args_Size) : Sysutils::Exception(Ident, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateHelp */ inline __fastcall ERandom(const AnsiString Msg, int AHelpContext) : Sysutils::Exception(
		Msg, AHelpContext) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmtHelp */ inline __fastcall ERandom(const AnsiString Msg, const System::TVarRec 
		* Args, const int Args_Size, int AHelpContext) : Sysutils::Exception(Msg, Args, Args_Size, AHelpContext
		) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResHelp */ inline __fastcall ERandom(int Ident, int AHelpContext) : Sysutils::Exception(
		Ident, AHelpContext) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmtHelp */ inline __fastcall ERandom(int Ident, const System::TVarRec * Args, 
...
protected:
	...
	virtual AnsiString __fastcall GetState(void);
...
public:
	__fastcall virtual TRandom(const AnsiString APassword, int ASize, bool ARandomize, Fxcdecutil::TProtection* 
		AProtection);
...
public:
	#pragma option push -w-inl
	/* TRandom.Create */ inline __fastcall virtual TRandom_LFSR(const AnsiString APassword, int ASize, 
		bool ARandomize, Fxcdecutil::TProtection* AProtection) : TRandom(APassword, ASize, ARandomize, AProtection
		) { }
	#pragma option pop
	#pragma option push -w-inl
