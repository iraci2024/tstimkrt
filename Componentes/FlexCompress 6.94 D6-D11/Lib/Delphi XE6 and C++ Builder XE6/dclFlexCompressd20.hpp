...
// (DO NOT EDIT: machine generated header) 'dclFlexCompressd20.dpk' rev: 27.00 (Windows)

#ifndef Dclflexcompressd20HPP
#define Dclflexcompressd20HPP
...
namespace Dclflexcompressd20
{
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Dclflexcompressd20 */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_DCLFLEXCOMPRESSD20)
using namespace Dclflexcompressd20;
#endif
#pragma pack(pop)
#pragma option pop
