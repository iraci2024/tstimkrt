...
// (DO NOT EDIT: machine generated header) 'vclFlexCompressd20.dpk' rev: 27.00 (Windows)

#ifndef Vclflexcompressd20HPP
#define Vclflexcompressd20HPP
...
namespace Vclflexcompressd20
{
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Vclflexcompressd20 */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_VCLFLEXCOMPRESSD20)
using namespace Vclflexcompressd20;
#endif
#pragma pack(pop)
#pragma option pop
