...
// (DO NOT EDIT: machine generated header) 'vclFlexCompressd27.dpk' rev: 34.00 (Windows)

#ifndef Vclflexcompressd27HPP
#define Vclflexcompressd27HPP
...
namespace Vclflexcompressd27
{
//-- forward type declarations -----------------------------------------------
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Vclflexcompressd27 */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_VCLFLEXCOMPRESSD27)
using namespace Vclflexcompressd27;
#endif
#pragma pack(pop)
#pragma option pop
