...
// (DO NOT EDIT: machine generated header) 'FXCDecUtil.pas' rev: 34.00 (Windows)
...
public:
	...
	/* Exception.Destroy */ inline __fastcall virtual ~EProtection() { }
...
public:
	...
	/* Exception.Destroy */ inline __fastcall virtual ~EStringFormat() { }
...
private:
	...
	TPActions FActions;
	TProtection* __fastcall GetProtection();
...
public:
	/* TObject.Create */ inline __fastcall TStringFormat() : System::TObject() { }
	/* TObject.Destroy */ inline __fastcall virtual ~TStringFormat() { }
...
public:
	/* TObject.Create */ inline __fastcall TStringFormat_HEX() : TStringFormat() { }
	/* TObject.Destroy */ inline __fastcall virtual ~TStringFormat_HEX() { }
...
public:
	...
	__classmethod virtual char * __fastcall CharTable();
public:
	/* TObject.Create */ inline __fastcall TStringFormat_HEXL() : TStringFormat_HEX() { }
	/* TObject.Destroy */ inline __fastcall virtual ~TStringFormat_HEXL() { }
...
public:
	...
	__classmethod virtual char * __fastcall CharTable();
public:
	/* TObject.Create */ inline __fastcall TStringFormat_MIME64() : TStringFormat_HEX() { }
	/* TObject.Destroy */ inline __fastcall virtual ~TStringFormat_MIME64() { }
...
public:
	...
	__classmethod virtual char * __fastcall CharTable();
public:
	/* TObject.Create */ inline __fastcall TStringFormat_UU() : TStringFormat() { }
	/* TObject.Destroy */ inline __fastcall virtual ~TStringFormat_UU() { }
...
public:
	...
	__classmethod virtual char * __fastcall CharTable();
public:
	/* TObject.Create */ inline __fastcall TStringFormat_XX() : TStringFormat_UU() { }
	/* TObject.Destroy */ inline __fastcall virtual ~TStringFormat_XX() { }
