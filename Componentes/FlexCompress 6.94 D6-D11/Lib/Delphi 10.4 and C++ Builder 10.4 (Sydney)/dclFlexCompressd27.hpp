...
// (DO NOT EDIT: machine generated header) 'dclFlexCompressd27.dpk' rev: 34.00 (Windows)

#ifndef Dclflexcompressd27HPP
#define Dclflexcompressd27HPP
...
#include <FXCHash.hpp>	// (vclFlexCompressd27)
#include <FXCsha1.hpp>	// (vclFlexCompressd27)
#include <FXCDecUtil.hpp>	// (vclFlexCompressd27)
#include <FXCCipher.hpp>	// (vclFlexCompressd27)
#include <FXCRNG.hpp>	// (vclFlexCompressd27)
#include <FXCConst.hpp>	// (vclFlexCompressd27)
#include <FXCStrFunc.hpp>	// (vclFlexCompressd27)
#include <FlexCompress.hpp>	// (vclFlexCompressd27)
// PRG_EXT: .bpl
// OBJ_EXT: .obj

//-- user supplied -----------------------------------------------------------

namespace Dclflexcompressd27
{
//-- forward type declarations -----------------------------------------------
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Dclflexcompressd27 */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_DCLFLEXCOMPRESSD27)
using namespace Dclflexcompressd27;
#endif
#pragma pack(pop)
#pragma option pop
