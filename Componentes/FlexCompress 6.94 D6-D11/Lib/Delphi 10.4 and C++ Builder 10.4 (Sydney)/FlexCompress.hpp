...
// (DO NOT EDIT: machine generated header) 'FlexCompress.pas' rev: 34.00 (Windows)
...
#include <FXCFolderDialog.hpp>
#include <FXCPBKDF_2.hpp>
#include <FXChmac.hpp>
#include <FXCHash.hpp>
...
#include <FXCZLib.hpp>
#include <FXCBZip2.hpp>
#include <FXCPPM.hpp>
#include <FXCCipher.hpp>
#include <FXCRNG.hpp>
#include <FXCConst.hpp>
...
public:
	/* TObject.Destroy */ inline __fastcall virtual ~TFXCVolumeNumberInfo() { }
...
public:
	__fastcall TFXCSpanningOptions();
...
public:
	/* TPersistent.Destroy */ inline __fastcall virtual ~TFXCSpanningOptions() { }
...
public:
	/* TPersistent.Destroy */ inline __fastcall virtual ~TFXCOptions() { }
...
public:
	...
	__fastcall virtual ~TFXCStringHash();
...
public:
	__fastcall TFXCHashedStringList();
	__fastcall virtual ~TFXCHashedStringList();
...
public:
	__fastcall TFXCDirArray();
	__fastcall virtual ~TFXCDirArray();
	void __fastcall Clear();
...
private:
	...
	void __fastcall InitCentralDirEnd();
...
public:
	...
	__fastcall virtual ~TFXCDirManager();
	bool __fastcall IsEncrypted();
	void __fastcall SaveDir(bool RecreateCDirEnd, System::Classes::TStream* Stream = (System::Classes::TStream*)(0x0));
	void __fastcall LoadDir();
	void __fastcall ApplyStubOffset();
	bool __fastcall HasCentralDirEnd();
	bool __fastcall IsSFXArchive();
...
protected:
	...
	void __fastcall CheckInUpdate();
	void __fastcall CheckModifySpanning();
	void __fastcall SetActive(bool Value);
	bool __fastcall GetEncrypted();
	bool __fastcall GetExists();
	__int64 __fastcall GetArchiveSize();
	...
	int __fastcall GetMaxInitVectorSize();
	...
	bool __fastcall InternalDecompressFile(System::Classes::TStream* rfs, System::Classes::TStream* wfs, TDirItem &d, int SizeToDecompress = 0x0, __int64 StartPosition = 0LL);
	virtual void __fastcall SetCompMethod();
	...
	void __fastcall ExtractItem(int ItemNo, System::Classes::TStream* DestStream, int Count = 0x0, __int64 StartPosition = 0LL);
	...
	void __fastcall TagFiles()/* overload */;
	...
	int __fastcall WriteToStream(System::Classes::TStream* SrcStream, System::Classes::TStream* &DestStream, TFXCVolumeNumberInfo* VolumeNumberInfo, bool &Cancel, __int64 Size = -1LL, int RequiredFreeSpace = 0xffffffff, System::Classes::TStream* CacheStream = (System::Classes::TStream*)(0x0), bool IsCopyTempFile = false)/* overload */;
	...
	void __fastcall InternalCreateArchive();
	void __fastcall InternalOpenNonSFXArchive();
	void __fastcall InternalOpenSFXArchive();
	void __fastcall DetectSpanning();
	void __fastcall InternalOpenArchive();
...
public:
	...
	__fastcall virtual ~TBaseArchiver();
	void __fastcall OpenArchive()/* overload */;
	...
	void __fastcall AddFromStream(const System::UnicodeString FileName, System::Classes::TStream* Stream, bool CopyToBuffer = true, __int64 Position = 0LL, __int64 Count = 0LL, int Attr = 0x20, System::TDateTime DateTime = 0.000000E+00);
	...
	void __fastcall AddFiles()/* overload */;
	...
	void __fastcall MoveFiles()/* overload */;
	...
	void __fastcall DeleteFiles()/* overload */;
	...
	void __fastcall UpdateFiles()/* overload */;
	...
	void __fastcall TestFiles()/* overload */;
	...
	void __fastcall ExtractFiles()/* overload */;
	...
	bool __fastcall IsValidArchiveFile();
...
public:
	__fastcall TFXCCryptoTransform();
	...
	virtual System::Sysutils::PByteArray __fastcall GetKey() = 0 ;
	virtual System::AnsiString __fastcall GetPassword() = 0 ;
	...
	virtual Fxczlib::PByte __fastcall GetFileStorageStartBlock() = 0 ;
	virtual void __fastcall LoadFileStorageStartBlock(System::Classes::TStream* Stream, __int64 Offset) = 0 ;
	virtual int __fastcall GetFileStorageStartBlockSize() = 0 ;
	virtual Fxczlib::PByte __fastcall GetFileStorageEndBlock() = 0 ;
	virtual void __fastcall LoadFileStorageEndBlock(System::Classes::TStream* Stream, __int64 Offset) = 0 ;
	virtual int __fastcall GetFileStorageEndBlockSize() = 0 ;
	virtual bool __fastcall IsDirItemCorrupted(const TDirItem &Item, unsigned Crc32) = 0 ;
	virtual TFXCExtraFieldDataBlock __fastcall GetExtraFieldData() = 0 ;
public:
	/* TObject.Destroy */ inline __fastcall virtual ~TFXCCryptoTransform() { }
...
public:
	...
	__fastcall virtual ~TAESCryptoTransform();
...
public:
	...
	virtual System::Sysutils::PByteArray __fastcall GetKey();
	...
	virtual Fxczlib::PByte __fastcall GetFileStorageStartBlock();
	virtual void __fastcall LoadFileStorageStartBlock(System::Classes::TStream* Stream, __int64 Offset);
	virtual int __fastcall GetFileStorageStartBlockSize();
	virtual Fxczlib::PByte __fastcall GetFileStorageEndBlock();
	virtual void __fastcall LoadFileStorageEndBlock(System::Classes::TStream* Stream, __int64 Offset);
	virtual int __fastcall GetFileStorageEndBlockSize();
};
...
public:
	...
	__fastcall virtual ~TFlexCompress();
