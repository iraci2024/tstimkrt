...
// (DO NOT EDIT: machine generated header) 'dclFlexCompressd21.dpk' rev: 28.00 (Windows)

#ifndef Dclflexcompressd21HPP
#define Dclflexcompressd21HPP
...
#include <FXCReg.hpp>	// Pascal unit
...
namespace Dclflexcompressd21
{
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Dclflexcompressd21 */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_DCLFLEXCOMPRESSD21)
using namespace Dclflexcompressd21;
#endif
#pragma pack(pop)
#pragma option pop
