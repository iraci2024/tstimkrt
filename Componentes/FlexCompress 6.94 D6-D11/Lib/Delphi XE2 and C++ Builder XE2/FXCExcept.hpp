...
// (DO NOT EDIT: machine generated header) 'FXCExcept.pas' rev: 23.00 (Win32)
...
public:
	...
	/* Exception.CreateRes */ inline __fastcall EFXCException(int Ident)/* overload */ : System::Sysutils::Exception(Ident) { }
	/* Exception.CreateResFmt */ inline __fastcall EFXCException(int Ident, System::TVarRec const *Args, const int Args_Size)/* overload */ : System::Sysutils::Exception(Ident, Args, Args_Size) { }
	...
	/* Exception.CreateResHelp */ inline __fastcall EFXCException(int Ident, int AHelpContext)/* overload */ : System::Sysutils::Exception(Ident, AHelpContext) { }
