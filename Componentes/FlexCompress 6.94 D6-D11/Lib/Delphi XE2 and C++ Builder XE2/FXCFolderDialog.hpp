...
// (DO NOT EDIT: machine generated header) 'FXCFolderDialog.pas' rev: 23.00 (Win32)
...
enum TBrowseInfoFlags : unsigned char { OnlyComputers, OnlyPrinters, OnlyDomains, OnlyAncestors, OnlyFileSystem, ShowPath };
#pragma option pop

typedef System::Set<TBrowseInfoFlags, TBrowseInfoFlags::OnlyComputers, TBrowseInfoFlags::ShowPath>  TBrowseInfoFlagSet;

#pragma option push -b-
enum TSHFolders : unsigned char { foDesktop, foDesktopExpanded, foPrograms, foControlPanel, foPrinters, foPersonal, foFavorites, foStartup, foRecent, foSendto, foRecycleBin, foStartMenu, foDesktopFolder, foMyComputer, foNetwork, foNetworkNeighborhood, foFonts, foTemplates };
#pragma option pop
