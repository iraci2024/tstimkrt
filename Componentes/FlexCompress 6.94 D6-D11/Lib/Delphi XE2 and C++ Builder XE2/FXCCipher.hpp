...
// (DO NOT EDIT: machine generated header) 'FXCCipher.pas' rev: 23.00 (Win32)
...
enum TCipherMode : unsigned char { cmCTS, cmCBC, cmCFB, cmOFB, cmCTR, cmECB, cmCTSMAC, cmCBCMAC, cmCFBMAC };
#pragma option pop
...
public:
	...
	__classmethod System::AnsiString __fastcall CalcStream(const System::Classes::TStream* Stream, int StreamSize, Fxcdecutil::TProtection* Protection = (Fxcdecutil::TProtection*)(0x0), int Format = 0xffffffff)/* overload */;
...
extern PACKAGE System::Classes::TStrings* __fastcall CipherList(void);
extern PACKAGE void __fastcall CipherNames(System::Classes::TStrings* List);
...
extern PACKAGE System::Classes::TStrings* __fastcall HashList(void);
extern PACKAGE void __fastcall HashNames(System::Classes::TStrings* List);
