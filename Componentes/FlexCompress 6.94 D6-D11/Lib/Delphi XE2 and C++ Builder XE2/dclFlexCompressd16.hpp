...
// (DO NOT EDIT: machine generated header) 'dclFlexCompressd16.pas' rev: 23.00 (Win32)

#ifndef Dclflexcompressd16HPP
#define Dclflexcompressd16HPP
...
namespace Dclflexcompressd16
{
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------

}	/* namespace Dclflexcompressd16 */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_DCLFLEXCOMPRESSD16)
using namespace Dclflexcompressd16;
#endif
#pragma pack(pop)
#pragma option pop
