...
// (DO NOT EDIT: machine generated header) 'FXCBZip2.pas' rev: 23.00 (Win32)
...
enum TBlockSize100k : unsigned char { bs1, bs2, bs3, bs4, bs5, bs6, bs7, bs8, bs9 };
#pragma option pop
...
public:
	...
	/* Exception.CreateRes */ inline __fastcall EBZip2Error(int Ident)/* overload */ : System::Sysutils::Exception(Ident) { }
	/* Exception.CreateResFmt */ inline __fastcall EBZip2Error(int Ident, System::TVarRec const *Args, const int Args_Size)/* overload */ : System::Sysutils::Exception(Ident, Args, Args_Size) { }
	...
	/* Exception.CreateResHelp */ inline __fastcall EBZip2Error(int Ident, int AHelpContext)/* overload */ : System::Sysutils::Exception(Ident, AHelpContext) { }
