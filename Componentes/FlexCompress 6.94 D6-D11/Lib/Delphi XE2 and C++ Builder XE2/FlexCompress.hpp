...
// (DO NOT EDIT: machine generated header) 'FlexCompress.pas' rev: 23.00 (Win32)
...
enum TFXCCompressionLevel : unsigned char { clNone, clFastest, clNormal, clMax };
#pragma option pop

#pragma option push -b-
enum TFXCCompressionAlgorithm : unsigned char { caZLIB, caBZIP, caPPM };
#pragma option pop

#pragma option push -b-
enum TFXCCryptoAlgorithm : unsigned char { caRijndael_128, caRijndael_256, caDES_Single, caDES_Triple, caBlowfish, caTwofish_128, caTwofish_256, caSquare };
#pragma option pop

typedef System::StaticArray<System::Byte, 16> TInitVector;

#pragma option push -b-
enum TFXCProcessOperation : unsigned char { poAdd, poMove, poDelete, poUpdate, poExtract, poTest, poRename, poChangeAttr, poChangeComment, poMakeSFX, poMerge };
#pragma option pop

#pragma option push -b-
enum TFXCProgressPhase : unsigned char { ppStart, ppProcess, ppEnd };
#pragma option pop

#pragma option push -b-
enum TFXCAction : unsigned char { fxaRetry, fxaIgnore, fxaAbort };
#pragma option pop
...
#pragma option push -b-
enum TFXCOverwriteMode : unsigned char { omPrompt, omAlways, omNever, omIfNewer, omIfOlder };
#pragma option pop

#pragma option push -b-
enum TFXCFileShareMode : unsigned char { smShareCompat, smShareExclusive, smShareDenyWrite, smShareDenyRead, smShareDenyNone };
#pragma option pop
...
#pragma option push -b-
enum TFXCStorePathMode : unsigned char { spNoPath, spRelativePath, spFullPath, spFullPathWithDrive };
#pragma option pop

#pragma option push -b-
enum TZip64Mode : unsigned char { zmDisabled, zmAuto, zmAlways };
#pragma option pop

#pragma option push -b-
enum TFXCSpanningMode : unsigned char { smNone, smSpanning, smSplitting };
#pragma option pop

#pragma option push -b-
enum TFXCVolumeSize : unsigned char { vsAutoDetect, vsCustom, vs1_44MB, vs100MB, vs200MB, vs250MB, vs600MB, vs650MB, vs700MB, vs4700MB };
#pragma option pop

#pragma option push -b-
enum TFXCVolumeNumberKind : unsigned char { vnkFirst, vnkLast, vnkCustom, vnkUnknown };
#pragma option pop
...
protected:
	...
	bool __fastcall ZipInitPassword(System::Classes::TStream* rfs, const System::AnsiString FPassword, System::Word genPurposeFlag, System::Word lastModTime, unsigned crc32, __int64 *FKey);
...
public:
	...
	bool __fastcall FastFileAppend(const System::Classes::TFileStream* OuTFXCFileStream, const System::Classes::TFileStream* InFileStream, const System::UnicodeString FileName);
...
#pragma option push -b-
enum TCryptoTransformMode : unsigned char { Encryption, Decryption };
#pragma option pop
