...
// (DO NOT EDIT: machine generated header) 'dclFlexCompressd18.pas' rev: 25.00 (Windows)

#ifndef Dclflexcompressd18HPP
#define Dclflexcompressd18HPP
...
namespace Dclflexcompressd18
{
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Dclflexcompressd18 */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_DCLFLEXCOMPRESSD18)
using namespace Dclflexcompressd18;
#endif
#pragma pack(pop)
#pragma option pop
