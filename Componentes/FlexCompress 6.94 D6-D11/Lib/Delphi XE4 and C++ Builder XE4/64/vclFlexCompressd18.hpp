...
// (DO NOT EDIT: machine generated header) 'vclFlexCompressd18.pas' rev: 25.00 (Windows)

#ifndef Vclflexcompressd18HPP
#define Vclflexcompressd18HPP
...
namespace Vclflexcompressd18
{
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Vclflexcompressd18 */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_VCLFLEXCOMPRESSD18)
using namespace Vclflexcompressd18;
#endif
#pragma pack(pop)
#pragma option pop
