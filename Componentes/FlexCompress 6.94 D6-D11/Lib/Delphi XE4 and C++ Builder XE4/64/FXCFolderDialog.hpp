...
// (DO NOT EDIT: machine generated header) 'FXCFolderDialog.pas' rev: 25.00 (Windows)
...
public:
	...
	__property HWND ParentHandle = {read=FParentHandle, write=FParentHandle};
	__property HWND DialogHandle = {read=FDialogHandle, write=FDialogHandle};
	__property HWND NewFolderHandle = {read=FNewFolderHandle, write=FNewFolderHandle};
