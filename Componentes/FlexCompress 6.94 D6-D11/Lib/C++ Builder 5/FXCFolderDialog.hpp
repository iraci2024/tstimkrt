...
// (DO NOT EDIT: machine generated header) 'FXCFolderDialog.pas' rev: 5.00
...
#pragma option push -b-
enum TSHFolders { foDesktop, foDesktopExpanded, foPrograms, foControlPanel, foPrinters, foPersonal, 
	foFavorites, foStartup, foRecent, foSendto, foRecycleBin, foStartMenu, foDesktopFolder, foMyComputer, 
	foNetwork, foNetworkNeighborhood, foFonts, foTemplates };
#pragma option pop
...
typedef void __fastcall (__closure *TSelectionChangedEvent)(TPBFolderDialog* Sender, HWND DialogHandle
	, const Shlobj::PItemIDList ItemIDList, const AnsiString Folder);
