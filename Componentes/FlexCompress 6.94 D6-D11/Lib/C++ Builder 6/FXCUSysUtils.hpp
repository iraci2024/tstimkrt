...
// (DO NOT EDIT: machine generated header) 'FXCUSysUtils.pas' rev: 6.00

#ifndef FXCUSysUtilsHPP
#define FXCUSysUtilsHPP
...
extern PACKAGE wchar_t __fastcall TntWideLastChar(const WideString S);
...
extern PACKAGE bool __fastcall WideFileSetAttr(const WideString FileName, unsigned Attr);
