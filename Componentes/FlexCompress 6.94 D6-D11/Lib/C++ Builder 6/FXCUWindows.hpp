...
// (DO NOT EDIT: machine generated header) 'FXCUWindows.pas' rev: 6.00

#ifndef FXCUWindowsHPP
#define FXCUWindowsHPP
...
namespace Fxcuwindows
{
//-- type declarations -------------------------------------------------------
typedef _STARTUPINFOA  TStartupInfoA;

#pragma pack(push, 4)
struct TStartupInfoW
{
	unsigned cb;
	wchar_t *lpReserved;
	wchar_t *lpDesktop;
...
extern "C" BOOL __stdcall CreateProcessW(wchar_t * lpApplicationName, wchar_t * lpCommandLine, Windows::PSecurityAttributes lpProcessAttributes, Windows::PSecurityAttributes lpThreadAttributes, BOOL bInheritHandles, unsigned dwCreationFlags, void * lpEnvironment, wchar_t * lpCurrentDirectory, const TStartupInfoW &lpStartupInfo, _PROCESS_INFORMATION &lpProcessInformation);
...
extern PACKAGE BOOL __fastcall Tnt_GetVolumeInformationW(wchar_t * lpRootPathName, wchar_t * lpVolumeNameBuffer, unsigned nVolumeNameSize, PDWORD lpVolumeSerialNumber, unsigned &lpMaximumComponentLength, unsigned &lpFileSystemFlags, wchar_t * lpFileSystemNameBuffer, unsigned nFileSystemNameSize);
...
extern PACKAGE unsigned __fastcall Tnt_GetTempFileNameW(wchar_t * lpPathName, wchar_t * lpPrefixString, unsigned uUnique, wchar_t * lpTempFileName);
...
extern PACKAGE unsigned __fastcall Tnt_GetCurrentDirectoryW(unsigned nBufferLength, wchar_t * lpBuffer);
extern PACKAGE BOOL __fastcall Tnt_SetCurrentDirectoryW(wchar_t * lpPathName);
...
extern PACKAGE unsigned __fastcall Tnt_ExtractIconExW(wchar_t * lpszFile, int nIconIndex, HICON &phiconLarge, HICON &phiconSmall, unsigned nIcons);
