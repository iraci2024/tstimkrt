...
// (DO NOT EDIT: machine generated header) 'FXCUClasses.pas' rev: 6.00

#ifndef FXCUClassesHPP
#define FXCUClassesHPP
...
#include <FXCUWideStrings.hpp>	// Pascal unit
...
class PASCALIMPLEMENTATION TTntStrings : public Fxcuwidestrings::TWideStrings 
{
	typedef Fxcuwidestrings::TWideStrings inherited;
...
private:
	bool FUpdating;
	Fxcuwidestrings::TWideStringItem *FList;
	int FCount;
	int FCapacity;
	bool FSorted;
...
typedef DynamicArray<Byte >  FXCUClasses__11;
