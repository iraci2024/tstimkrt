...
// (DO NOT EDIT: machine generated header) 'vclFlexCompressd17.pas' rev: 24.00 (Windows)

#ifndef Vclflexcompressd17HPP
#define Vclflexcompressd17HPP
...
namespace Vclflexcompressd17
{
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Vclflexcompressd17 */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_VCLFLEXCOMPRESSD17)
using namespace Vclflexcompressd17;
#endif
#pragma pack(pop)
#pragma option pop
