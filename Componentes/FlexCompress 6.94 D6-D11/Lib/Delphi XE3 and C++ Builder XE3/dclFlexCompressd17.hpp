...
// (DO NOT EDIT: machine generated header) 'dclFlexCompressd17.pas' rev: 24.00 (Windows)

#ifndef Dclflexcompressd17HPP
#define Dclflexcompressd17HPP
...
namespace Dclflexcompressd17
{
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Dclflexcompressd17 */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_DCLFLEXCOMPRESSD17)
using namespace Dclflexcompressd17;
#endif
#pragma pack(pop)
#pragma option pop
