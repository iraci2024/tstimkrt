...
// (DO NOT EDIT: machine generated header) 'FlexCompress.pas' rev: 22.00
...
protected:
	...
	bool __fastcall InternalDecompressFile(Classes::TStream* rfs, Classes::TStream* wfs, TDirItem &d, int SizeToDecompress = 0x0, __int64 StartPosition = 0LL);
	...
	void __fastcall ExtractItem(int ItemNo, Classes::TStream* DestStream, int Count = 0x0, __int64 StartPosition = 0LL);
	...
	int __fastcall WriteToStream(Classes::TStream* SrcStream, Classes::TStream* &DestStream, TFXCVolumeNumberInfo* VolumeNumberInfo, bool &Cancel, __int64 Size = -1LL, int RequiredFreeSpace = 0xffffffff, Classes::TStream* CacheStream = (Classes::TStream*)(0x0), bool IsCopyTempFile = false)/* overload */;
...
public:
	...
	void __fastcall AddFromStream(const System::UnicodeString FileName, Classes::TStream* Stream, bool CopyToBuffer = true, __int64 Position = 0LL, __int64 Count = 0LL, int Attr = 0x20, System::TDateTime DateTime = 0.000000E+00);
...
static const System::ShortInt CustomHeaderSizeOffset = 0x17;
static const System::ShortInt FXCNormalFileAttr = 0x20;
static const System::ShortInt FXCDirectoryAttr = 0x10;
...
static const System::ShortInt ZipVersion = 0x14;
static const System::Word ZipVersionNoOEM = 0xb14;
static const System::Word FXCVersion = 0x4114;
static const System::ShortInt Zip64Version = 0x2d;
static const System::Word FXC64Version = 0x412d;
static const System::ShortInt ZipGenPurposeFlag = 0x0;
static const System::ShortInt ZIP_None = 0x0;
static const System::ShortInt ZIP_ZLIB = 0x8;
static const System::ShortInt ZIP_Deflate64 = 0x9;
static const System::Byte FXC_None = 0xff;
static const System::Byte FXC_ZLIB = 0xfe;
static const System::Byte FXC_BZIP = 0xfd;
static const System::Byte FXC_PPM = 0xfc;
static const System::Word caNone = 0xffff;
