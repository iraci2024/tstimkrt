...
// (DO NOT EDIT: machine generated header) 'FXCRNG.pas' rev: 35.00 (Windows)
...
public:
	...
	/* Exception.Destroy */ inline __fastcall virtual ~ERandom() { }
...
public:
	...
	/* TRandom.Destroy */ inline __fastcall virtual ~TRandom_LFSR() { }
