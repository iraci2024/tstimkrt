...
// (DO NOT EDIT: machine generated header) 'vclFlexCompressd28.dpk' rev: 35.00 (Windows)

#ifndef Vclflexcompressd28HPP
#define Vclflexcompressd28HPP
...
namespace Vclflexcompressd28
{
//-- forward type declarations -----------------------------------------------
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Vclflexcompressd28 */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_VCLFLEXCOMPRESSD28)
using namespace Vclflexcompressd28;
#endif
#pragma pack(pop)
#pragma option pop
