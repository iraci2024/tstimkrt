...
// (DO NOT EDIT: machine generated header) 'FXCCipher.pas' rev: 35.00 (Windows)
...
_DECLARE_METACLASS(System::TMetaClass, TCipherClass);
...
public:
	...
	virtual void * __fastcall DigestKey();
...
_DECLARE_METACLASS(System::TMetaClass, THashClass);
...
public:
	...
	/* TCipher.Destroy */ inline __fastcall virtual ~TCipher_Rijndael() { }
...
public:
	...
	/* TCipher.Destroy */ inline __fastcall virtual ~TCipher_RijndaelFXC() { }
...
public:
	...
	/* TCipher.Destroy */ inline __fastcall virtual ~TCipher_Blowfish() { }
...
protected:
	...
	virtual void __fastcall Encode(void * Data);
	virtual void __fastcall Decode(void * Data);
	void __fastcall MakeKey(const System::Byte *Data, const int Data_High, void * Key_1, bool Reverse);
...
public:
	...
	/* TCipher.Destroy */ inline __fastcall virtual ~TCipher_1DES() { }
...
public:
	...
	/* TCipher.Destroy */ inline __fastcall virtual ~TCipher_3DES() { }
...
public:
	...
	/* TCipher.Destroy */ inline __fastcall virtual ~TCipher_3TDES() { }
...
public:
	...
	/* TCipher.Destroy */ inline __fastcall virtual ~TCipher_Twofish() { }
...
public:
	...
	/* TCipher.Destroy */ inline __fastcall virtual ~TCipher_Square() { }
...
public:
	...
	virtual void * __fastcall DigestKey();
public:
	/* THash.Destroy */ inline __fastcall virtual ~THash_MD4() { }
...
protected:
	...
	virtual void __fastcall Transform(Fxcdecutil::PIntArray Buffer);
public:
	/* THash.Destroy */ inline __fastcall virtual ~THash_RipeMD128() { }
...
public:
	...
	virtual void __fastcall Init();
public:
	/* THash.Destroy */ inline __fastcall virtual ~THash_RipeMD256() { }
...
public:
	/* THash.Destroy */ inline __fastcall virtual ~TChecksum() { }
