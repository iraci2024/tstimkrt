...
// (DO NOT EDIT: machine generated header) 'dclFlexCompressd24.dpk' rev: 31.00 (Windows)

#ifndef Dclflexcompressd24HPP
#define Dclflexcompressd24HPP
...
#include <FXCHash.hpp>	// (vclFlexCompressd24)
#include <FXCsha1.hpp>	// (vclFlexCompressd24)
#include <FXCDecUtil.hpp>	// (vclFlexCompressd24)
#include <FXCCipher.hpp>	// (vclFlexCompressd24)
#include <FXCRNG.hpp>	// (vclFlexCompressd24)
#include <FXCConst.hpp>	// (vclFlexCompressd24)
#include <FXCStrFunc.hpp>	// (vclFlexCompressd24)
#include <FlexCompress.hpp>	// (vclFlexCompressd24)

//-- user supplied -----------------------------------------------------------

namespace Dclflexcompressd24
{
//-- forward type declarations -----------------------------------------------
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Dclflexcompressd24 */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_DCLFLEXCOMPRESSD24)
using namespace Dclflexcompressd24;
#endif
#pragma pack(pop)
#pragma option pop
