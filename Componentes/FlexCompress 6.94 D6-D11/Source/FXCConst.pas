...
const
  ...
  FXC_MAX_IVECTOR_SIZE = 16;
  FXC_MAX_SAVED_IVECTOR_SIZE = 16;
...
const
  ...
  FXCErrorMessages: array[0..FXCMaxError] of string =
    (
    'Unknown error',
    'Index out of bounds',
  ...
  FXCMaxNativeError = 67;
  FXCNativeToErrorCode: array[0..FXCMaxNativeError, 0..1] of integer =
    (
