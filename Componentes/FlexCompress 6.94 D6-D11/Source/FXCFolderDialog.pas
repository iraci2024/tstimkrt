...
uses
  Windows, Messages, Classes, SysUtils, ActiveX, Shlobj, Registry,
{$IFNDEF D16H}
  Forms, Dialogs, FileCtrl, Controls, Graphics;
{$ELSE}
  VCL.Forms, VCL.Dialogs, VCL.FileCtrl, VCL.Controls, VCL.Graphics;
{$ENDIF}
