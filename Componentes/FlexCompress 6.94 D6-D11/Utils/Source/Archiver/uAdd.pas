  ...
  if cbEncrypt.Enabled then //want to encrypt ?
   begin
    ...
    case cbEncrypt.ItemIndex of //Encryption algorithms
     0:Archiver.EncryptionAlgorithm := caBlowfish;
     1:Archiver.EncryptionAlgorithm := caDES_Single;
     2:Archiver.EncryptionAlgorithm := caDES_Triple;
     3:Archiver.EncryptionAlgorithm := caRijndael_128;
     4:Archiver.EncryptionAlgorithm := caRijndael_256;
     5:Archiver.EncryptionAlgorithm := caSquare;
     6:Archiver.EncryptionAlgorithm := caTwofish_128;
     7:Archiver.EncryptionAlgorithm := caTwofish_256;
    end;
   end;
{$ENDIF}
