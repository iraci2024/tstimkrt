...
type
  TMainForm = class(TForm)
    ...
    {$IFDEF FC}
    procedure ArchiverFileProgress(Sender: TObject; FileName: TFXCString;
    ...
    procedure ArchiverProcessFileFailure(Sender: TObject;
      FileName: TFXCString; Operation: TFXCProcessOperation; NativeError:	Integer;
      ErrorCode: Integer; ErrorMessage: TFXCString; var Action: TFXCAction);
    {$ENDIF}
    {$IFDEF ZF_int}
    procedure ArchiverFileProgress(Sender: TObject; FileName: TFXCString;
      Progress: Double; Operation: TFXCProcessOperation;
...
begin
 ...
 Label2.Caption := 'Information:';
   ...
   Archiver.SpanningOptions.AdvancedNaming := True;
   try
...
//------------------------------------------------------------------------------
procedure TMainForm.ArchiverFileProgress(Sender: TObject; FileName: TFXCString;
  Progress: Double; Operation: TFXCProcessOperation;
  ProgressPhase: TFXCProgressPhase; var Cancel: Boolean);
begin
