...
*)
  ...
  if ([csDestroying, csDesigning] * Self.ComponentState = []) and  Assigned(FBoundLabel) and Assigned(FBoundLabel.FTheLabel) and ([csDestroying, csDesigning] * FBoundLabel.FTheLabel.ComponentState = []) then
