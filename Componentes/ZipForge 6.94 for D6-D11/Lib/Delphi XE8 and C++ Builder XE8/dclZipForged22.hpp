...
// (DO NOT EDIT: machine generated header) 'dclZipForged22.dpk' rev: 29.00 (Windows)

#ifndef Dclzipforged22HPP
#define Dclzipforged22HPP
...
#include <ZFHash.hpp>	// (vclZipForged22)
#include <ZFsha1.hpp>	// (vclZipForged22)
#include <ZFDecUtil.hpp>	// (vclZipForged22)
#include <ZFCipher.hpp>	// (vclZipForged22)
#include <ZFConst.hpp>	// (vclZipForged22)
#include <ZFStrFunc.hpp>	// (vclZipForged22)
#include <ZipForge.hpp>	// (vclZipForged22)

//-- user supplied -----------------------------------------------------------

namespace Dclzipforged22
{
//-- forward type declarations -----------------------------------------------
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Dclzipforged22 */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_DCLZIPFORGED22)
using namespace Dclzipforged22;
#endif
#pragma pack(pop)
#pragma option pop
