...
// (DO NOT EDIT: machine generated header) 'vclZipForged22.dpk' rev: 29.00 (Windows)

#ifndef Vclzipforged22HPP
#define Vclzipforged22HPP
...
namespace Vclzipforged22
{
//-- forward type declarations -----------------------------------------------
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Vclzipforged22 */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_VCLZIPFORGED22)
using namespace Vclzipforged22;
#endif
#pragma pack(pop)
#pragma option pop
