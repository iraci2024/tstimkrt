...
// (DO NOT EDIT: machine generated header) 'dclZipForged20.dpk' rev: 27.00 (Windows)

#ifndef Dclzipforged20HPP
#define Dclzipforged20HPP
...
namespace Dclzipforged20
{
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Dclzipforged20 */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_DCLZIPFORGED20)
using namespace Dclzipforged20;
#endif
#pragma pack(pop)
#pragma option pop
