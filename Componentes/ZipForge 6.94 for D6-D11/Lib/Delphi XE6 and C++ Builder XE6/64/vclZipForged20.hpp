...
// (DO NOT EDIT: machine generated header) 'vclZipForged20.dpk' rev: 27.00 (Windows)

#ifndef Vclzipforged20HPP
#define Vclzipforged20HPP
...
#include <ZipForge.hpp>	// Pascal unit
#include <ZFZLib.hpp>	// Pascal unit
#include <ZFConst.hpp>	// Pascal unit
#include <ZFFolderDialog.hpp>	// Pascal unit
#include <ZFStrFunc.hpp>	// Pascal unit
#include <ZFExcept.hpp>	// Pascal unit
#include <ZFUClasses.hpp>	// Pascal unit
#include <ZFUFormatStrUtils.hpp>	// Pascal unit
#include <ZFUSystem.hpp>	// Pascal unit
#include <ZFUSysUtils.hpp>	// Pascal unit
#include <ZFUWideStrUtils.hpp>	// Pascal unit
#include <ZFUWindows.hpp>	// Pascal unit
...
#include <ZFDecConst.hpp>	// Pascal unit
#include <ZFDecUtil.hpp>	// Pascal unit
#include <ZFCipher.hpp>	// Pascal unit

//-- user supplied -----------------------------------------------------------

namespace Vclzipforged20
{
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Vclzipforged20 */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_VCLZIPFORGED20)
using namespace Vclzipforged20;
#endif
#pragma pack(pop)
#pragma option pop
