...
// (DO NOT EDIT: machine generated header) 'ZipForge.pas' rev: 22.00
...
protected:
	...
	int __fastcall WriteToStream(Classes::TStream* SrcStream, Classes::TStream* &DestStream, TZFVolumeNumberInfo* VolumeNumberInfo, bool &Cancel, __int64 Size = -1LL, int RequiredFreeSpace = 0xffffffff, Classes::TStream* CacheStream = (Classes::TStream*)(0x0), bool IsCopyTempFile = false)/* overload */;
...
static const System::ShortInt ZFNormalFileAttr = 0x20;
static const System::ShortInt ZFDirectoryAttr = 0x10;
...
static const System::Word ZFVersion = 0x4114;
static const System::ShortInt Zip64Version = 0x2d;
static const System::Word ZF64Version = 0x412d;
...
static const System::Byte ZF_None = 0xff;
static const System::Byte ZF_ZLIB = 0xfe;
static const System::Byte ZF_BZIP = 0xfd;
static const System::Byte ZF_PPM = 0xfc;
