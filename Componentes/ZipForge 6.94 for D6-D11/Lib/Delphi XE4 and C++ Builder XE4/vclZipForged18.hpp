...
// (DO NOT EDIT: machine generated header) 'vclZipForged18.pas' rev: 25.00 (Windows)

#ifndef Vclzipforged18HPP
#define Vclzipforged18HPP
...
namespace Vclzipforged18
{
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Vclzipforged18 */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_VCLZIPFORGED18)
using namespace Vclzipforged18;
#endif
#pragma pack(pop)
#pragma option pop
