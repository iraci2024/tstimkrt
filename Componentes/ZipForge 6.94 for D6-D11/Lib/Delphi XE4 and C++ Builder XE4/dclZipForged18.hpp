...
// (DO NOT EDIT: machine generated header) 'dclZipForged18.pas' rev: 25.00 (Windows)

#ifndef Dclzipforged18HPP
#define Dclzipforged18HPP
...
namespace Dclzipforged18
{
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Dclzipforged18 */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_DCLZIPFORGED18)
using namespace Dclzipforged18;
#endif
#pragma pack(pop)
#pragma option pop
