...
extern DELPHI_PACKAGE void __fastcall HashFile(const System::ShortString &fname, PHashDesc PHash, System::Byte *Digest, void *buf, NativeInt bsize, System::Word &Err);
}	/* namespace Zfhash */
