...
// (DO NOT EDIT: machine generated header) 'ZFHash.pas' rev: 24.00 (Windows)
...
extern DELPHI_PACKAGE void __fastcall HashFullXL(PHashDesc PHash, System::Byte *Digest, void * Msg, int Len);
extern DELPHI_PACKAGE void __fastcall HashFull(PHashDesc PHash, System::Byte *Digest, void * Msg, System::Word Len);
extern DELPHI_PACKAGE void __fastcall HashFile(const System::ShortString &fname, PHashDesc PHash, System::Byte *Digest, void *buf, System::Word bsize, System::Word &Err);
}	/* namespace Zfhash */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_ZFHASH)
