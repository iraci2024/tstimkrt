...
// (DO NOT EDIT: machine generated header) 'vclZipForged17.pas' rev: 24.00 (Windows)

#ifndef Vclzipforged17HPP
#define Vclzipforged17HPP
...
namespace Vclzipforged17
{
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Vclzipforged17 */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_VCLZIPFORGED17)
using namespace Vclzipforged17;
#endif
#pragma pack(pop)
#pragma option pop
