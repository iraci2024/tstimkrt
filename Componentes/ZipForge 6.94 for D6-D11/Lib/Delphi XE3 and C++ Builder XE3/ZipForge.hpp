...
// (DO NOT EDIT: machine generated header) 'ZipForge.pas' rev: 24.00 (Windows)
...
public:
	...
	virtual bool __fastcall CheckPassword(const System::AnsiString Password, const TDirItem &Item _ANNOT_ATTR_NC) = 0 ;
...
public:
	virtual bool __fastcall CheckPassword(const System::AnsiString Password, const TDirItem &Item _ANNOT_ATTR_NC);
...
extern DELPHI_PACKAGE System::Byte __fastcall ZipEncryptByte(System::Byte &c, __int64 *Key);
extern DELPHI_PACKAGE void __fastcall ZipDecryptBuffer(Zfzlib::PByte &Buffer, int size, __int64 *Key);
extern DELPHI_PACKAGE void __fastcall ZipEncryptBuffer(int size, int offset, Zfzlib::PByte &Buffer, __int64 *Key);
extern DELPHI_PACKAGE void __fastcall ZipKeyInit(const System::AnsiString Password, __int64 *Key, System::Byte *KeyHeader);
extern DELPHI_PACKAGE void __fastcall ZipEncryptKeyInit(const System::AnsiString Password, __int64 *Key);
}	/* namespace Zipforge */
