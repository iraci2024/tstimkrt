...
// (DO NOT EDIT: machine generated header) 'dclZipForged17.pas' rev: 24.00 (Windows)

#ifndef Dclzipforged17HPP
#define Dclzipforged17HPP
...
namespace Dclzipforged17
{
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Dclzipforged17 */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_DCLZIPFORGED17)
using namespace Dclzipforged17;
#endif
#pragma pack(pop)
#pragma option pop
