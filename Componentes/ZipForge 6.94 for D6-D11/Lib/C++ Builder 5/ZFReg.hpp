...
// (DO NOT EDIT: machine generated header) 'ZFReg.pas' rev: 5.00
...
protected:
	...
	/* TPropertyEditor.Create */ inline __fastcall virtual TZFArchiveFileName(const Dsgnintf::_di_IFormDesigner 
...
protected:
	#pragma option push -w-inl
	/* TPropertyEditor.Create */ inline __fastcall virtual TZFSFXFileName(const Dsgnintf::_di_IFormDesigner 
		ADesigner, int APropCount) : Dsgnintf::TStringProperty(ADesigner, APropCount) { }
	#pragma option pop
...
protected:
	#pragma option push -w-inl
	/* TPropertyEditor.Create */ inline __fastcall virtual TZFDirectory(const Dsgnintf::_di_IFormDesigner 
		ADesigner, int APropCount) : Dsgnintf::TStringProperty(ADesigner, APropCount) { }
	#pragma option pop
