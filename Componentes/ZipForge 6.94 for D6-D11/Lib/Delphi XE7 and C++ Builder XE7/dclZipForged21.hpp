...
// (DO NOT EDIT: machine generated header) 'dclZipForged21.dpk' rev: 28.00 (Windows)

#ifndef Dclzipforged21HPP
#define Dclzipforged21HPP
...
namespace Dclzipforged21
{
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Dclzipforged21 */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_DCLZIPFORGED21)
using namespace Dclzipforged21;
#endif
#pragma pack(pop)
#pragma option pop
