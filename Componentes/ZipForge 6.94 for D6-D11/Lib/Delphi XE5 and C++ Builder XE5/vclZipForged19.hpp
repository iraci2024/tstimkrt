...
// (DO NOT EDIT: machine generated header) 'vclZipForged19.pas' rev: 26.00 (Windows)

#ifndef Vclzipforged19HPP
#define Vclzipforged19HPP
...
namespace Vclzipforged19
{
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Vclzipforged19 */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_VCLZIPFORGED19)
using namespace Vclzipforged19;
#endif
#pragma pack(pop)
#pragma option pop
