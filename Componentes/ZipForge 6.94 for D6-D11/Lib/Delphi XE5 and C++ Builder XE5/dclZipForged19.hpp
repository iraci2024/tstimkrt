...
// (DO NOT EDIT: machine generated header) 'dclZipForged19.pas' rev: 26.00 (Windows)

#ifndef Dclzipforged19HPP
#define Dclzipforged19HPP
...
namespace Dclzipforged19
{
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Dclzipforged19 */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_DCLZIPFORGED19)
using namespace Dclzipforged19;
#endif
#pragma pack(pop)
#pragma option pop
