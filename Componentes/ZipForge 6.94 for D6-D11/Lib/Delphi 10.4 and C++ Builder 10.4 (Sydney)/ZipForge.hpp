...
// (DO NOT EDIT: machine generated header) 'ZipForge.pas' rev: 34.00 (Windows)
...
public:
	__fastcall TZFVolumeNumberInfo();
...
public:
	/* TObject.Destroy */ inline __fastcall virtual ~TZFVolumeNumberInfo() { }
...
public:
	/* TPersistent.Destroy */ inline __fastcall virtual ~TZFSpanningOptions() { }
...
public:
	/* TPersistent.Destroy */ inline __fastcall virtual ~TZFOptions() { }
...
public:
	...
	__fastcall virtual ~TZFStringHash();
...
public:
	__fastcall TZFHashedStringList();
	__fastcall virtual ~TZFHashedStringList();
...
public:
	__fastcall TZFDirArray();
	__fastcall virtual ~TZFDirArray();
	void __fastcall Clear();
...
public:
	...
	__fastcall virtual ~TZFDirManager();
...
protected:
	...
	int __fastcall WriteToStream(System::Classes::TStream* SrcStream, System::Classes::TStream* &DestStream, TZFVolumeNumberInfo* VolumeNumberInfo, bool &Cancel, __int64 Size = -1LL, int RequiredFreeSpace = 0xffffffff, System::Classes::TStream* CacheStream = (System::Classes::TStream*)(0x0), bool IsCopyTempFile = false)/* overload */;
...
public:
	...
	__fastcall virtual ~TZFBaseArchiver();
...
public:
	...
	virtual Zfzlib::PByte __fastcall GetFileStorageStartBlock() = 0 ;
	...
	virtual Zfzlib::PByte __fastcall GetFileStorageEndBlock() = 0 ;
	...
	virtual TZFExtraFieldDataBlock __fastcall GetExtraFieldData() = 0 ;
public:
	/* TObject.Destroy */ inline __fastcall virtual ~TZFCryptoTransform() { }
...
public:
	...
	virtual Zfzlib::PByte __fastcall GetFileStorageStartBlock();
	...
	virtual Zfzlib::PByte __fastcall GetFileStorageEndBlock();
