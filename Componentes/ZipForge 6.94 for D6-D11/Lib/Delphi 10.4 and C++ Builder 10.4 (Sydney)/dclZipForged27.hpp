...
// (DO NOT EDIT: machine generated header) 'dclZipForged27.dpk' rev: 34.00 (Windows)

#ifndef Dclzipforged27HPP
#define Dclzipforged27HPP
...
#include <ZFHash.hpp>	// (vclZipForged27)
#include <ZFsha1.hpp>	// (vclZipForged27)
#include <ZFDecUtil.hpp>	// (vclZipForged27)
#include <ZFCipher.hpp>	// (vclZipForged27)
#include <ZFConst.hpp>	// (vclZipForged27)
#include <ZFStrFunc.hpp>	// (vclZipForged27)
#include <ZipForge.hpp>	// (vclZipForged27)
// PRG_EXT: .bpl
// OBJ_EXT: .obj

//-- user supplied -----------------------------------------------------------

namespace Dclzipforged27
{
//-- forward type declarations -----------------------------------------------
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Dclzipforged27 */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_DCLZIPFORGED27)
using namespace Dclzipforged27;
#endif
#pragma pack(pop)
#pragma option pop
