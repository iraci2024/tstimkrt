...
// (DO NOT EDIT: machine generated header) 'vclZipForged27.dpk' rev: 34.00 (Windows)

#ifndef Vclzipforged27HPP
#define Vclzipforged27HPP
...
namespace Vclzipforged27
{
//-- forward type declarations -----------------------------------------------
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Vclzipforged27 */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_VCLZIPFORGED27)
using namespace Vclzipforged27;
#endif
#pragma pack(pop)
#pragma option pop
