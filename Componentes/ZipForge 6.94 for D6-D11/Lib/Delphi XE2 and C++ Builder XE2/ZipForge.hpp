...
// (DO NOT EDIT: machine generated header) 'ZipForge.pas' rev: 23.00 (Win32)
...
enum TZFCompressionLevel : unsigned char { clNone, clFastest, clNormal, clMax };
#pragma option pop

#pragma option push -b-
enum TZFCompressionAlgorithm : unsigned char { caZLIB, caBZIP, caPPM };
#pragma option pop

#pragma option push -b-
enum TZFCryptoAlgorithm : unsigned char { caPkzipClassic, caAES_128, caAES_192, caAES_256 };
#pragma option pop

#pragma option push -b-
enum TZFProcessOperation : unsigned char { poAdd, poMove, poDelete, poUpdate, poExtract, poTest, poRename, poChangeAttr, poChangeComment, poMakeSFX, poMerge };
#pragma option pop

#pragma option push -b-
enum TZFProgressPhase : unsigned char { ppStart, ppProcess, ppEnd };
#pragma option pop

#pragma option push -b-
enum TZFAction : unsigned char { fxaRetry, fxaIgnore, fxaAbort };
#pragma option pop
...
#pragma option push -b-
enum TZFOverwriteMode : unsigned char { omPrompt, omAlways, omNever, omIfNewer, omIfOlder };
#pragma option pop

#pragma option push -b-
enum TZFFileShareMode : unsigned char { smShareCompat, smShareExclusive, smShareDenyWrite, smShareDenyRead, smShareDenyNone };
#pragma option pop
...
#pragma option push -b-
enum TZFStorePathMode : unsigned char { spNoPath, spRelativePath, spFullPath, spFullPathWithDrive };
#pragma option pop
...
#pragma option push -b-
enum TZFSpanningMode : unsigned char { smNone, smSpanning, smSplitting };
#pragma option pop

#pragma option push -b-
enum TZFVolumeSize : unsigned char { vsAutoDetect, vsCustom, vs1_44MB, vs100MB, vs200MB, vs250MB, vs600MB, vs650MB, vs700MB, vs4700MB };
#pragma option pop

#pragma option push -b-
enum TZFVolumeNumberKind : unsigned char { vnkFirst, vnkLast, vnkCustom, vnkUnknown };
#pragma option pop
...
public:
	...
	bool __fastcall FastFileAppend(const System::Classes::TFileStream* OuTZFFileStream, const System::Classes::TFileStream* InFileStream, const System::UnicodeString FileName);
