...
// (DO NOT EDIT: machine generated header) 'dclZipForged16.pas' rev: 23.00 (Win32)

#ifndef Dclzipforged16HPP
#define Dclzipforged16HPP
...
namespace Dclzipforged16
{
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------

}	/* namespace Dclzipforged16 */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_DCLZIPFORGED16)
using namespace Dclzipforged16;
#endif
#pragma pack(pop)
#pragma option pop
