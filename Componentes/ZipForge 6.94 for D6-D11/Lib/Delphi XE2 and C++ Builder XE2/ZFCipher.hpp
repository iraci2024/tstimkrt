...
// (DO NOT EDIT: machine generated header) 'ZFCipher.pas' rev: 23.00 (Win32)
...
public:
	...
	__classmethod System::AnsiString __fastcall CalcStream(const System::Classes::TStream* Stream, int StreamSize, Zfdecutil::TProtection* Protection = (Zfdecutil::TProtection*)(0x0), int Format = 0xffffffff)/* overload */;
