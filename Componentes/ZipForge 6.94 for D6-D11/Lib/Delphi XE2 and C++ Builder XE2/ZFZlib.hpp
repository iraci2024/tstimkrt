...
// (DO NOT EDIT: machine generated header) 'ZFZLib.pas' rev: 23.00 (Win32)
...
extern PACKAGE System::StaticArray<char *, 10> z_errmsg;
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_ZFZLIB)
