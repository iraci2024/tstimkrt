...
// (DO NOT EDIT: machine generated header) 'vclZipForged16.pas' rev: 23.00 (Win32)

#ifndef Vclzipforged16HPP
#define Vclzipforged16HPP
...
namespace Vclzipforged16
{
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------

}	/* namespace Vclzipforged16 */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_VCLZIPFORGED16)
using namespace Vclzipforged16;
#endif
#pragma pack(pop)
#pragma option pop
