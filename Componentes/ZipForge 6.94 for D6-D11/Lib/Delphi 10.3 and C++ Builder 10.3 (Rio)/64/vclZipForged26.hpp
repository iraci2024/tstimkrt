...
// (DO NOT EDIT: machine generated header) 'vclZipForged26.dpk' rev: 33.00 (Windows)

#ifndef Vclzipforged26HPP
#define Vclzipforged26HPP
...
namespace Vclzipforged26
{
//-- forward type declarations -----------------------------------------------
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Vclzipforged26 */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_VCLZIPFORGED26)
using namespace Vclzipforged26;
#endif
#pragma pack(pop)
#pragma option pop
