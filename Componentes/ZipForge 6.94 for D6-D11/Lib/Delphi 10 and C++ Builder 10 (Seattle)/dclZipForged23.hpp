...
// (DO NOT EDIT: machine generated header) 'dclZipForged23.dpk' rev: 30.00 (Windows)

#ifndef Dclzipforged23HPP
#define Dclzipforged23HPP
...
#include <ZFHash.hpp>	// (vclZipForged23)
#include <ZFsha1.hpp>	// (vclZipForged23)
#include <ZFDecUtil.hpp>	// (vclZipForged23)
#include <ZFCipher.hpp>	// (vclZipForged23)
#include <ZFConst.hpp>	// (vclZipForged23)
#include <ZFStrFunc.hpp>	// (vclZipForged23)
#include <ZipForge.hpp>	// (vclZipForged23)

//-- user supplied -----------------------------------------------------------

namespace Dclzipforged23
{
//-- forward type declarations -----------------------------------------------
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Dclzipforged23 */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_DCLZIPFORGED23)
using namespace Dclzipforged23;
#endif
#pragma pack(pop)
#pragma option pop
