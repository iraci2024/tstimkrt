...
// (DO NOT EDIT: machine generated header) 'vclZipForged23.dpk' rev: 30.00 (Windows)

#ifndef Vclzipforged23HPP
#define Vclzipforged23HPP
...
namespace Vclzipforged23
{
//-- forward type declarations -----------------------------------------------
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Vclzipforged23 */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_VCLZIPFORGED23)
using namespace Vclzipforged23;
#endif
#pragma pack(pop)
#pragma option pop
