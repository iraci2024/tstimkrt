...
// (DO NOT EDIT: machine generated header) 'dclZipForged28.dpk' rev: 35.00 (Windows)

#ifndef Dclzipforged28HPP
#define Dclzipforged28HPP
...
#include <ZFHash.hpp>	// (vclZipForged28)
#include <ZFsha1.hpp>	// (vclZipForged28)
#include <ZFDecUtil.hpp>	// (vclZipForged28)
#include <ZFCipher.hpp>	// (vclZipForged28)
#include <ZFConst.hpp>	// (vclZipForged28)
#include <ZFStrFunc.hpp>	// (vclZipForged28)
#include <ZipForge.hpp>	// (vclZipForged28)
// PRG_EXT: .bpl
// OBJ_EXT: .obj

//-- user supplied -----------------------------------------------------------

namespace Dclzipforged28
{
//-- forward type declarations -----------------------------------------------
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Dclzipforged28 */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_DCLZIPFORGED28)
using namespace Dclzipforged28;
#endif
#pragma pack(pop)
#pragma option pop
