...
// (DO NOT EDIT: machine generated header) 'vclZipForged28.dpk' rev: 35.00 (Windows)

#ifndef Vclzipforged28HPP
#define Vclzipforged28HPP
...
#include <ZFStrFunc.hpp>
#include <ZFExcept.hpp>
#include <ZFUClasses.hpp>
#include <ZFUFormatStrUtils.hpp>
#include <ZFUSystem.hpp>
#include <ZFUSysUtils.hpp>
#include <ZFUWideStrUtils.hpp>
#include <ZFUWindows.hpp>
...
namespace Vclzipforged28
{
//-- forward type declarations -----------------------------------------------
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Vclzipforged28 */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_VCLZIPFORGED28)
using namespace Vclzipforged28;
#endif
#pragma pack(pop)
#pragma option pop
