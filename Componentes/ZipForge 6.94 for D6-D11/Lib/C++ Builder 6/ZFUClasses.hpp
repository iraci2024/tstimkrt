...
// (DO NOT EDIT: machine generated header) 'ZFUClasses.pas' rev: 6.00

#ifndef ZFUClassesHPP
#define ZFUClassesHPP
...
class PASCALIMPLEMENTATION TTntStrings : public Zfuwidestrings::TWideStrings 
{
	typedef Zfuwidestrings::TWideStrings inherited;
...
private:
	bool FUpdating;
	Zfuwidestrings::TWideStringItem *FList;
	int FCount;
	int FCapacity;
	bool FSorted;
...
typedef DynamicArray<Byte >  ZFUClasses__11;
