...
VERSION = BCB.06.00
# ---------------------------------------------------------------------------
PROJECT = dclZipForgeb6.bpl
OBJFILES = dclZipForgeb6.obj ZFReg.obj
RESFILES = dclZipForgeb6.res
MAINSOURCE = dclZipForgeb6.cpp
RESDEPEN = $(RESFILES)
LIBFILES = 
IDLFILES = 
IDLGENFILES = 
LIBRARIES = 
PACKAGES = vclZipForgeb6.bpi rtl.bpi vcl.bpi designide.bpi
SPARELIBS = rtl.lib
DEFFILE = 
OTHERFILES = 
# ---------------------------------------------------------------------------
...
RFLAGS = 
AFLAGS = /mx /w2 /zn
LFLAGS = -D"ZipForge Package" -aa -Tpp -Gpd -x -Gn -Gl -Gi
# ---------------------------------------------------------------------------
