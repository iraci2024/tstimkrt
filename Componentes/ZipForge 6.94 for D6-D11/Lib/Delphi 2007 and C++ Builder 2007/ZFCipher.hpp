...
// (DO NOT EDIT: machine generated header) 'Zfcipher.pas' rev: 11.00
...
public:
	...
	/*         class method */ static AnsiString __fastcall CalcBuffer(TMetaClass* vmt, const void *Buffer, int BufferSize, Zfdecutil::TProtection* Protection = (Zfdecutil::TProtection*)(0x0), int Format = 0xffffffff)/* overload */;
	/*         class method */ static AnsiString __fastcall CalcStream(TMetaClass* vmt, const Classes::TStream* Stream, int StreamSize, Zfdecutil::TProtection* Protection = (Zfdecutil::TProtection*)(0x0), int Format = 0xffffffff)/* overload */;
	/*         class method */ static AnsiString __fastcall CalcString(TMetaClass* vmt, const AnsiString Data, Zfdecutil::TProtection* Protection = (Zfdecutil::TProtection*)(0x0), int Format = 0xffffffff)/* overload */;
	/*         class method */ static AnsiString __fastcall CalcFile(TMetaClass* vmt, const AnsiString FileName, Zfdecutil::TProtection* Protection = (Zfdecutil::TProtection*)(0x0), int Format = 0xffffffff)/* overload */;
...
public:
	#pragma option push -w-inl
	/* TCipher.Create */ inline __fastcall TCipher_Rijndael(const AnsiString Password, Zfdecutil::TProtection* AProtection)/* overload */ : TCipher(Password, AProtection) { }
	#pragma option pop
	#pragma option push -w-inl
...
public:
	#pragma option push -w-inl
	/* TCipher.Create */ inline __fastcall TCipher_RijndaelZF(const AnsiString Password, Zfdecutil::TProtection* AProtection)/* overload */ : TCipher_Rijndael(Password, AProtection) { }
	#pragma option pop
	#pragma option push -w-inl
...
public:
	#pragma option push -w-inl
	/* TCipher.Create */ inline __fastcall TCipher_Blowfish(const AnsiString Password, Zfdecutil::TProtection* AProtection)/* overload */ : TCipher(Password, AProtection) { }
	#pragma option pop
	#pragma option push -w-inl
...
public:
	#pragma option push -w-inl
	/* TCipher.Create */ inline __fastcall TCipher_1DES(const AnsiString Password, Zfdecutil::TProtection* AProtection)/* overload */ : TCipher(Password, AProtection) { }
	#pragma option pop
	#pragma option push -w-inl
...
public:
	#pragma option push -w-inl
	/* TCipher.Create */ inline __fastcall TCipher_3DES(const AnsiString Password, Zfdecutil::TProtection* AProtection)/* overload */ : TCipher_1DES(Password, AProtection) { }
	#pragma option pop
	#pragma option push -w-inl
...
public:
	#pragma option push -w-inl
	/* TCipher.Create */ inline __fastcall TCipher_3TDES(const AnsiString Password, Zfdecutil::TProtection* AProtection)/* overload */ : TCipher_3DES(Password, AProtection) { }
	#pragma option pop
	#pragma option push -w-inl
...
public:
	#pragma option push -w-inl
	/* TCipher.Create */ inline __fastcall TCipher_Twofish(const AnsiString Password, Zfdecutil::TProtection* AProtection)/* overload */ : TCipher(Password, AProtection) { }
	#pragma option pop
	#pragma option push -w-inl
...
public:
	#pragma option push -w-inl
	/* TCipher.Create */ inline __fastcall TCipher_Square(const AnsiString Password, Zfdecutil::TProtection* AProtection)/* overload */ : TCipher(Password, AProtection) { }
	#pragma option pop
	#pragma option push -w-inl
