...
// (DO NOT EDIT: machine generated header) 'dclZipForged24.dpk' rev: 31.00 (Windows)

#ifndef Dclzipforged24HPP
#define Dclzipforged24HPP
...
#include <ZFHash.hpp>	// (vclZipForged24)
#include <ZFsha1.hpp>	// (vclZipForged24)
#include <ZFDecUtil.hpp>	// (vclZipForged24)
#include <ZFCipher.hpp>	// (vclZipForged24)
#include <ZFConst.hpp>	// (vclZipForged24)
#include <ZFStrFunc.hpp>	// (vclZipForged24)
#include <ZipForge.hpp>	// (vclZipForged24)

//-- user supplied -----------------------------------------------------------

namespace Dclzipforged24
{
//-- forward type declarations -----------------------------------------------
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Dclzipforged24 */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_DCLZIPFORGED24)
using namespace Dclzipforged24;
#endif
#pragma pack(pop)
#pragma option pop
