...
// (DO NOT EDIT: machine generated header) 'vclZipForged24.dpk' rev: 31.00 (Windows)

#ifndef Vclzipforged24HPP
#define Vclzipforged24HPP
...
namespace Vclzipforged24
{
//-- forward type declarations -----------------------------------------------
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Vclzipforged24 */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_VCLZIPFORGED24)
using namespace Vclzipforged24;
#endif
#pragma pack(pop)
#pragma option pop
