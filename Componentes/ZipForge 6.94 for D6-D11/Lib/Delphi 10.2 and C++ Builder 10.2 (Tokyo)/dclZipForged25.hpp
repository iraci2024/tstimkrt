...
// (DO NOT EDIT: machine generated header) 'dclZipForged25.dpk' rev: 32.00 (Windows)

#ifndef Dclzipforged25HPP
#define Dclzipforged25HPP
...
#include <ZFHash.hpp>	// (vclZipForged25)
#include <ZFsha1.hpp>	// (vclZipForged25)
#include <ZFDecUtil.hpp>	// (vclZipForged25)
#include <ZFCipher.hpp>	// (vclZipForged25)
#include <ZFConst.hpp>	// (vclZipForged25)
#include <ZFStrFunc.hpp>	// (vclZipForged25)
#include <ZipForge.hpp>	// (vclZipForged25)
// PRG_EXT: .bpl
// OBJ_EXT: .obj

//-- user supplied -----------------------------------------------------------

namespace Dclzipforged25
{
//-- forward type declarations -----------------------------------------------
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Dclzipforged25 */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_DCLZIPFORGED25)
using namespace Dclzipforged25;
#endif
#pragma pack(pop)
#pragma option pop
