...
// (DO NOT EDIT: machine generated header) 'vclZipForged25.dpk' rev: 32.00 (Windows)

#ifndef Vclzipforged25HPP
#define Vclzipforged25HPP
...
namespace Vclzipforged25
{
//-- forward type declarations -----------------------------------------------
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Vclzipforged25 */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_VCLZIPFORGED25)
using namespace Vclzipforged25;
#endif
#pragma pack(pop)
#pragma option pop
