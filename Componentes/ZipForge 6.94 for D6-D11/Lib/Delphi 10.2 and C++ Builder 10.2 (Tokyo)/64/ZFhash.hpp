...
// (DO NOT EDIT: machine generated header) 'ZFHash.pas' rev: 32.00 (Windows)
...
extern DELPHI_PACKAGE void __fastcall HashFile(const System::ShortString &fname, PHashDesc PHash, THashDigest &Digest, void *buf, NativeInt bsize, System::Word &Err);
}	/* namespace Zfhash */
