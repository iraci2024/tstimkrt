...
begin {= TRzStringGrid.Paint =}
  ...
  begin
    LStyle.GetElementColor(LStyle.GetElementDetails(tgCellNormal), ecBorderColor, ColorLine );
    if seClient in StyleElements then
      LStyle.GetElementColor(LStyle.GetElementDetails(tgCellNormal), ecFillColor, FInternalColor);
    LStyle.GetElementColor(LStyle.GetElementDetails(tgFixedCellNormal), ecBorderColor, ColorFixedBorder );
    LStyle.GetElementColor(LStyle.GetElementDetails(tgFixedCellNormal), ecFillColor, ColorFixed );
  end
  else
  begin
    ...
    begin
      ...
      begin
        if LStyle.GetElementColor( LStyle.GetElementDetails(tgGradientCellNormal), ecBorderColor, C ) and (C <> clNone) then
          ColorLine := C;
        if LStyle.GetElementColor(LStyle.GetElementDetails(tgGradientCellNormal), ecFillColor, C) and (C <> clNone) then
          FInternalColor := C;
        if LStyle.GetElementColor(LStyle.GetElementDetails(tgGradientFixedCellNormal), ecBorderColor, C) and (C <> clNone) then
          ColorFixedBorder := C;
        if LStyle.GetElementColor(LStyle.GetElementDetails(tgGradientFixedCellNormal), ecFillColor, C) and (C <> clNone) then
          ColorFixed := C;
      end;
    end
    else
    begin
      ...
      if LStyle.Enabled then
      begin
        if LStyle.GetElementColor(LStyle.GetElementDetails(tgClassicCellNormal), ecBorderColor, C) and (C <> clNone) then
          ColorLine := C;
        if LStyle.GetElementColor(LStyle.GetElementDetails(tgClassicCellNormal), ecFillColor, C) and (C <> clNone) then
          FInternalColor := C;
        if LStyle.GetElementColor(LStyle.GetElementDetails(tgClassicFixedCellNormal), ecBorderColor, C) and (C <> clNone) then
          ColorFixedBorder := C;
        if LStyle.GetElementColor(LStyle.GetElementDetails(tgClassicFixedCellNormal), ecFillColor, C) and (C <> clNone) then
          ColorFixed := C;
      end;
    end;
  end;
