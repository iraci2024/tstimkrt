...
begin
  ...
  case Index of
    ...
    2: // Add Control
    begin
      CreateAddControlMenu( 0, 'rzGroupBar' );
      CreateAddControlMenu( 1, 'rzToolbar' );
      CreateAddControlMenu( 2, 'rzStatusBar' );
      CreateAddControlMenu( 3, 'rzSplitter' );
      CreateAddControlMenu( 4, 'rzSizePanel' );
      CreateAddControlMenu( 5, 'rzPanel' );
      CreateAddControlMenu( 6, 'rzButton' );
      CreateAddControlMenu( 7, 'rzLabel' );
      CreateAddControlMenu( 8, 'Label' );
      CreateAddControlMenu( 9, 'Button' );
      CreateAddControlMenu( 10, 'Edit' );
      CreateAddControlMenu( 11, 'Panel' );
      CreateAddControlMenu( 12, 'ToolBar' );
      CreateAddControlMenu( 13, 'StatusBar' );
    end;
...
begin
  case TMenuItem( Sender ).Tag of
    ...
    7:
      begin
        LrzLabel := Designer.CreateComponent( TrzLabel, Form, 200, 100, 40, 15) as TrzLabel;
        LrzLabel.AutoSize := False;
        LrzLabel.AutoSize := True;
      end;
    8:
      begin
        LLabel := Designer.CreateComponent( TLabel, Form, 200, 100, 40, 15) as TLabel;
        LLabel.AutoSize := False;
        LLabel.AutoSize := True;
      end;
    9: Designer.CreateComponent( TButton, Form, 200, 100, 75, 25 );
    10: Designer.CreateComponent( TEdit, Form, 200, 100, 121, 21 );
    11: Designer.CreateComponent( TPanel, Form, 200, 128, 100, 100 );
    12: Designer.CreateComponent( TToolbar, Form, 10, 10, 0, 0 );
    13: Designer.CreateComponent( TStatusBar, Form, 10, 10, 0, 0 );
  end;
  if Designer <> nil then
    DesignerModified;
end;
  ...
  begin
    ...
    try
      ...
      begin
        ...
        PropInfo := System.TypInfo.GetPropInfo( Obj.ClassInfo, PropName );
        ...
        begin
          case PropInfo^.PropType^.Kind of
            ...
            tkSet, tkFloat, tkString, tkLString, tkWString, tkUString:
            begin
              Proc( PropName );
            end;
            ...
            tkClass:
            begin
              PropObj := TObject( System.TypInfo.GetOrdProp( Obj, PropInfo ) );
...
begin
  ...
  begin
    ...
    if FrameStyleEx <> fsFlatRounded then
      DrawBorder( nil, ACanvas, R, TFrameStyle( FrameStyleEx ) )
    else
...
begin
  FrameColor := GetGradientPanelFrameColor( Self, gcsMSOffice );
  GetGradientPanelColors( Self, gcsMSOffice, StartColor, StopColor );
...
var
  FrameColor, StartColor, StopColor: TColor;
begin
  GetGradientSelectionColors( Self, gcsMSOffice, FrameColor, StartColor, StopColor );
  Panel.FlatColor := FrameColor;
  Panel.GradientColorStart := StartColor;
  Panel.GradientColorStop := StopColor;
end;
...
begin
  ...
  begin
    ...
    try
      ...
      if FDrawingPropertyValue then
      begin
        DestRct := System.Classes.Rect( 0, 0, 11, 11 );
        SrcRct := DestRct;
      ...
      begin
        DestRct := System.Classes.Rect( 0, 0, 16, 16 );
        SrcRct := DestRct;
