...
begin
  if not FItemHeightChanged then
      ...
      begin
        ...
        begin
          ...
          if not UseCustomGlyphs then
            W := CalcRect.Right - CalcRect.Left + ScaleValue(FGlyphWidth) + 4 + ScaleValue(8)
          else
            W := CalcRect.Right - CalcRect.Left + FGlyphWidth + 4 + ScaleValue(8);
      ...
      begin
        ...
        begin
          ...
          if not UseRightToLeftAlignment then
            ...
            L := Self.ClientWidth - L - ColWidths[ BtnIdx div ButtonsPerCol ] - 4 + ScaleValue(8) - FStartXPos;
...
procedure TRzCustomRadioGroup.ChangeScale(M, D: Integer; isDpiChange: Boolean);
begin
  inherited;
      ...
      begin
        ...
        begin
          ...
          if not UseRightToLeftAlignment then
            ...
            L := Self.ClientWidth - L - ColWidths[ ChkIdx div ChecksPerCol ] - 4 + ScaleValue(8) - FStartXPos;
...
procedure TRzCustomCheckGroup.ChangeScale(M, D: Integer; isDpiChange: Boolean);
begin
  inherited;
  FItemHeight := MulDiv( FItemHeight, M, D );
  FItemHeightChanged := True;
