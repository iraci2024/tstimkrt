...
procedure TRzDialogButtons.ChangeScale(M, D: Integer; isDpiChange: Boolean);
var
  I: Integer;
begin
  inherited;
  ...
  begin
    case Align of
      alNone, alBottom, alClient:
        DrawBorderSides( Self, Canvas, ClientRect, fsGroove, [ sdTop ] );

      alTop:
        DrawBorderSides( Self, Canvas, ClientRect, fsGroove, [ sdBottom ] );

      alLeft:
        DrawBorderSides( Self, Canvas, ClientRect, fsGroove, [ sdRight ] );

      alRight:
        DrawBorderSides( Self, Canvas, ClientRect, fsGroove, [ sdLeft ] );
    end;
  end;
end;
