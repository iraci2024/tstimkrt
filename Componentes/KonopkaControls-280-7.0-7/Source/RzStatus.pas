{===============================================================================
  ...
  6.5.0  (28 Nov 2020)
    ...
    * Surfaced StyleElements property in TRzStatusPane and descendants and
...
begin
  ...
  begin
    FBlinkState := bsOn;
    FCurrentColor := ActiveStyleSystemColor( Self, FBlinkColor );
  end;
  Refresh;
end;
...
begin
  Result := ( Parent <> nil ) and ( Parent is TRzStatusBar ) and
            ...
            ActiveStyleServices( Self ).Enabled;
end;
...
begin
  if UsingSystemStyle( Self ) or not UseActiveStyleFontColor( Self ) then
    ...
    Result := ActiveStyleFontColor( Self, sfStatusPanelTextNormal );
end;
...
begin
  if UsingSystemStyle( Self ) or not UseActiveStyleFontColor( Self ) then
    ...
    Result := ActiveStyleFontColor( Self, sfStatusPanelTextDisabled );
end;


procedure TRzCustomStatusPane.UpdateStyleElements;
begin
  Invalidate;
  FFontColor := Font.Color;
  if not FBlinking then
...
begin
  ...
  Y := R.Top + ( R.Height - Canvas.TextHeight( 'Pp' ) ) div 2;
  ...
  begin
    ...
    try
      ...
      ActiveStyleServices( Self ).DrawElement( Bmp.Canvas.Handle, ElementDetails, ThemeRect );
  ...
  // Need to clear out the Font.Color because under VCL Styles, change the
  // StyleElements to remove seFont results in the Canvas.Font.Color not getting
  // updated correctly if the color is changed to the original color of the
  // control's Font.Color property.
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        GetGradientStatusBarColors( StatusBar, StatusBar.GradientColorStyle, StartColor,
    ...
    begin
      ...
      begin
        if UsingSystemStyle( Self ) then
          ...
          C := ActiveStyleFontColor( Self, sfStatusPanelTextDisabled );
        Canvas.Pen.Color := C;
        // Left side
        Canvas.MoveTo( R.Left, R.Top + 1 );
        Canvas.LineTo( R.Left, R.Bottom - 1 );
      ...
      begin
        ...
        DrawBorder( Self, Canvas, R, FFrameStyle );
    end;
  end;
...
begin
  ...
  begin
    ...
    begin
      BarColor := ActiveStyleSystemColor( Self, clHighlight );
    ...
    case FBarStyle of
      ...
      bsLED:
      begin
        DrawLEDBar( Self, Canvas, R, FOrientation, BarColor, BackColor, FNumSegments,
  ...
  begin
    ...
    begin
      ...
      try
        ...
        ElementDetails := ActiveStyleServices( Self ).GetElementDetails( tsStatusRoot );
        ActiveStyleServices( Self ).DrawElement( Bmp.Canvas.Handle, ElementDetails, BmpRect );
        SrcRect := Rect( BoundsRect.Left + R.Left, BoundsRect.Top + R.Top,
                         BoundsRect.Left + R.Right, BoundsRect.Top + R.Bottom );
        DestRect := R;
        ...
        try
          ...
          case StatusBar.VisualStyle of
            ...
            begin
              ...
              begin
                GetGradientStatusBarColors( StatusBar, StatusBar.GradientColorStyle,
...
begin
  ...
  begin
    ...
    begin
      ...
      Canvas.Font.Color := ActiveStyleFontColor( Self, sfStatusPanelTextDisabled );
    end;
...
begin
  ...
  case FBarStyle of
    ...
    bsLED:
    begin
      DrawLEDBar( Self, Canvas, R, orHorizontal, BarColor, BackColor, FNumSegments,
                  FPercent, False, True );
    end;
