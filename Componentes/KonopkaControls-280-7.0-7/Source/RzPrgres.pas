{===============================================================================
  ...
  6.5.0  (28 Nov 2020)
    ...
    * Surfaced StyleElements property in TRzProgressBar and modified the
...
begin
  Result := ActiveStyleServices( Self ).Enabled and FThemeAware;
...
begin
  ...
  try
    ...
    begin
      ...
      begin
        ...
        try
          ...
          ActiveStyleServices( Self ).DrawElement( MemImage.Canvas.Handle, ElementDetails, R );
        finally
          Bmp.Free;
        end;
        ...
        begin
          if FOrientation = orHorizontal then
            ElementDetails := ActiveStyleServices( Self ).GetElementDetails( tpBar )
          else
            ElementDetails := ActiveStyleServices( Self ).GetElementDetails( tpBarVert );
      ...
      begin
        MemImage.Canvas.Brush.Color := ActiveStyleSystemColor( Self, Self.Color );
    ...
    begin
      ...
      R := DrawInnerOuterBorders( Self, MemImage.Canvas, R, FBorderOuter, FBorderInner, BorderWidth, sdAllSides, BevelWidth,
    ...
    begin
      ...
      BackColor := ActiveStyleSystemColor( Self, clWindow );
    ...
    case FBarStyle of
      bsTraditional:
        DrawPercentBar( MemImage.Canvas, R, FOrientation, BarColor, BackColor,
                        ...
                        FPartsComplete, FTotalParts );
      bsLED:
        DrawLEDBar( Self, MemImage.Canvas, R, FOrientation, BarColor, BackColor,
