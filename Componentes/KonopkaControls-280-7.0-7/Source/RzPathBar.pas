{===============================================================================
  ...
  6.5.0  (28 Nov 2020)
    ...
    * Surfaced StyleElements property in TRzPathBar and modified the
...
procedure TRzPathBar.ChangeScale(M, D: Integer; isDpiChange: Boolean);
begin
  FSeparatorFont.Height := MulDiv(FSeparatorFont.Height, M, D);
  inherited;
end;
...
begin {= TRzPathBar.DrawItems =}
  ...
  begin
    GetGradientSelectionColors( Self, GradientColorStyle, SelectionBorderColor,
  ...
  try
    ...
    begin
      ...
      begin
        if UsingSystemStyle( Self ) and ( GradientColorStyle = gcsCustom ) then
        begin
      ...
      begin
        ...
        if not UseRightToLeftAlignment then
        begin
          R := Rect( ItemRect.Right, ItemRect.Top, ItemRect.Right +
            Canvas.TextWidth('>') + ScaleValue(10), ItemRect.Bottom );
        ...
        begin
          ...
          R := Rect( ItemRect.Left - Canvas.TextWidth('<') - ScaleValue(10), ItemRect.Top, ItemRect.Left, ItemRect.Bottom );
