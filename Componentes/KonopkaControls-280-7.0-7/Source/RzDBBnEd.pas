...
destructor TRzDBButtonEdit.Destroy;
begin
  FreeAndNil(FInternalButtonImages);
  inherited;
end;

procedure TRzDBButtonEdit.Notification( AComponent: TComponent; Operation: TOperation );
begin
  inherited;
...
procedure TRzDBButtonEdit.ChangeScale(M, D: Integer; isDpiChange: Boolean);
begin
...
procedure TRzDBButtonEdit.SetButtonImages(Value: TCustomImageList);
begin
...
procedure TRzDBButtonEdit.SetButtonImageIndex(Value: TImageIndex);
begin
...
procedure TRzDBButtonEdit.SetAltBtnImages(Value: TCustomImageList);
begin
...
procedure TRzDBButtonEdit.SetAltBtnImageIndex(Value: TImageIndex);
begin
...
function TRzDBButtonEdit.GetEditRectMargin: Integer;
begin
