...
begin
  ...
  begin
    ...
    GroupDescendentsWith( TRzFrameController, Vcl.Controls.TControl );
  end;
...
begin
  ...
  begin
    ...
    GroupDescendentsWith( TRzOpenDialog, Vcl.Controls.TControl );
  end;
  ...
  begin
    ...
    GroupDescendentsWith( TRzSaveDialog, Vcl.Controls.TControl );
  end;
  ...
  begin
    ...
    GroupDescendentsWith( TRzSelectFolderDialog, Vcl.Controls.TControl );
  end;
  ...
  begin
    ...
    GroupDescendentsWith( TRzSelDirDialog, Vcl.Controls.TControl );
  end;
...
begin
  ...
  begin
    ...
    GroupDescendentsWith( TRzLauncher, Vcl.Controls.TControl );
  end;
  ...
  begin
    ...
    GroupDescendentsWith( TRzTrayIcon, Vcl.Controls.TControl );
  end;

  if R.ReadBool( RegisterSection, 'TRzVersionInfo', True ) then
  begin
    RegisterComponents( PalettePage, [ TRzVersionInfo ] );
    GroupDescendentsWith( TRzVersionInfo, Vcl.Controls.TControl );
  end;
  ...
  begin
    ...
    GroupDescendentsWith( TRzBalloonHints, Vcl.Controls.TControl );
  end;
  ...
  begin
    ...
    GroupDescendentsWith( TRzLookupDialog, Vcl.Controls.TControl );
  end;

  if R.ReadBool( RegisterSection, 'TRzSendMessage', True ) then
  begin
    RegisterComponents( PalettePage, [ TRzSendMessage ] );
    GroupDescendentsWith( TRzSendMessage, Vcl.Controls.TControl );
  end;
