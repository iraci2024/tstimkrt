  ...
  try
    ...
    begin
      ...
      begin
        ...
        begin
          System.AnsiStrings.StrPCopy( RecipName, AnsiString( FToRecipients[ I ] ) );
          RecipClass := mapi_TO;
        end
        else if I < FToRecipients.Count + FCcRecipients.Count then
        begin
          System.AnsiStrings.StrPCopy( RecipName, AnsiString( FCcRecipients[ I - FToRecipients.Count ] ) );
          RecipClass := mapi_CC;
        end
        else
        begin
          System.AnsiStrings.StrPCopy( RecipName, AnsiString( FBccRecipients[ I - FToRecipients.Count - FCcRecipients.Count ] ) );
          RecipClass := mapi_BCC;
        end;
        ...
        begin
          TRecipArray( Recips^ )[ I ].ulRecipClass := RecipClass;
          TRecipArray( Recips^ )[ I ].lpszName := System.AnsiStrings.StrNew( System.AnsiStrings.StrPCopy( TempStz, RecipName ) );
          TRecipArray( Recips^ )[ I ].lpszAddress := System.AnsiStrings.StrNew( System.AnsiStrings.StrPCopy( TempStz, AnsiString( 'SMTP:' + RecipName ) ) );
        end;
      end;
      Msg.lpRecips := Recips;
    end;
    ...
    begin
      ...
      begin
        ...
        TFileArray(Files^)[ I ].lpszPathName := System.AnsiStrings.StrNew( System.AnsiStrings.StrPCopy( TempStz, AnsiString( FullPath ) ) );
    ...
    try
      ...
      begin
        ...
        begin
          ...
          begin
            System.AnsiStrings.StrDispose( TRecipArray( Recips^ )[ I ].lpszName );
            System.AnsiStrings.StrDispose( TRecipArray( Recips^ )[ I ].lpszAddress );
          end;
      ...
      begin
        for I := 0 to FAttachments.Count - 1 do
          System.AnsiStrings.StrDispose( TFileArray( Files^ )[ I ].lpszPathName );
