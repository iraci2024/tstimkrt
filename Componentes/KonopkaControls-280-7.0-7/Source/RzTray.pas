...
type
  ...
  protected
    ...
    property IconDataPreV5: Winapi.Shellapi.TNotifyIconData
      read FIconDataPreV5;
  public
...
begin
  Result := 0;
  ShModule := GetModuleHandle( Winapi.ShellAPI.Shell32 );
  if ShModule <> 0 then
  begin
...
begin
  ...
  FMsgWindow := System.Classes.AllocateHWnd( MsgWndProc );
...
begin
  ...
  // Classes prefix needed to eliminate Warning message under Delphi 6 and higher
  System.Classes.DeallocateHWnd( FMsgWindow );
