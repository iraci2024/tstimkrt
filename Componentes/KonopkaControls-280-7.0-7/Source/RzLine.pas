...
begin
  ...
  Canvas.Pen.Color := ActiveStyleSystemColor( Self, FLineColor );
  ...
  begin
    ...
    Canvas.Brush.Color := ActiveStyleSystemColor( Self, FLineColor );
    Canvas.Pen.Width := 1;
  ...
  begin
    Canvas.Font := Font;
    Canvas.Font.Color := ActiveStyleSystemColor( Self, Font.Color );
