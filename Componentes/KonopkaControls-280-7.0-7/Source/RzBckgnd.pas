...
begin
  ...
  begin
    ...
    System.Classes.FreeObjectInstance( FClientInstance );
  end;
  inherited;
end;
...
begin
  ...
  FClientInstance := System.Classes.MakeObjectInstance( EraseMDIClientBkgrnd );
      ...
      begin
        ...
        try
          ...
          if FFrameStyle = fsFlat then
            ...
            RzCommon.DrawBorder( Self, ACanvas, ClientRect, FFrameStyle );
        finally
          TempBitmap.Free;
          ACanvas.Free;
        end;
...
begin
  ...
  try
    ...
    if FFrameStyle = fsFlat then
      ...
      RzCommon.DrawBorder( Self, Canvas, ClientRect, FFrameStyle );
  finally
    TempBitmap.Free;
  end;
...
begin
  ...
  begin
    inherited;
    Canvas.Brush.Color := ActiveStyleSystemColor( Self, HighlightColor );
    Canvas.FillRect( ClientRect );
  end;
...
begin
  ...
  HC := ActiveStyleSystemColor( Self, FHighlightColor );
