...
begin
  case Msg.Msg of
    wm_SetFocus:
      Winapi.Windows.SetFocus( Msg.WParam );
...
begin
  ...
  if HandleAllocated then
    Canvas.Font.Height := MulDiv(Canvas.Font.Height, CurrentPPI, Screen.DefaultPixelsPerInch);
...
begin
  ...
  FHintRect := System.Types.Rect( TopLeft.X, TopLeft.Y, TopLeft.X + W, TopLeft.Y + H );
