...
begin
  ...
  begin
    ...
    begin
      if FrameStyle = fsFlat then
        ...
        DrawBorderSides( Self, Canvas, ClientRect, FrameStyle, FrameSides );
    end
    else
    begin
      if FrameStyle = fsFlat then
  ...
  begin
    ...
    begin
      R := ClientRect;
      InflateRect( R, 1, 1 );
      DrawThemeBackground( ActiveStyleServices( Self ).Theme[ teButton ], Canvas.Handle, BP_PUSHBUTTON, PBS_NORMAL, R, nil );
      DrawDropDownArrow( Self, Canvas, BtnRect, uiWindowsXP, False );
    end
    else
    begin
      DrawThemeBackground( ActiveStyleServices( Self ).Theme[ teComboBox ], Canvas.Handle, CP_BORDER, CBTBS_NORMAL, ClientRect, nil );
      DrawDropDownArrow( Self, Canvas, BtnRect, uiWindowsXP, False );
    end;
  end
  else
    DrawCtl3DBorder( Self, Canvas, ClientRect, True );
...
begin
  ...
  if UsingSystemStyle( Self ) then
    ...
    EditColor := ActiveStyleColor( Self, scEdit );
      ...
      begin
        ...
        begin
          ...
          if ActiveStyleServices( Self ).Enabled then
            DrawDropDownArrow( Self, FCanvas, BtnRect, uiWindowsXP, False, Enabled and ListActive )
          else
            DrawDropDownArrow( Self, FCanvas, BtnRect, uiWindows95, False, Enabled and ListActive );
        end
        else
        begin
          // Erase Button Border
          ...
          begin
            ...
            DrawDropDownArrow( Self, FCanvas, TempRect, uiWindows95, ListVisible, Enabled and ListActive );
          end;
        end;
      end
      else // No FlatButtons
    ...
    begin
      ...
      begin
        if FFrameHotStyle = fsFlat then
          ...
          DrawBorderSides( Self, FCanvas, R, FFrameHotStyle, FFrameSides )
        else
      ...
      begin
        if FFrameStyle = fsFlat then
          ...
          DrawBorderSides( Self, FCanvas, R, FFrameStyle, FFrameSides )
        else
