...
private:
	...
	HICON FHorzCursor;
	HICON FVertCursor;
	bool FShowThumbCursor;
	Vcl::Imglist::TCustomImageList* FThumbImages;
	System::Uitypes::TImageIndex FThumbImageIndex;
	System::Uitypes::TImageIndex FThumbHotImageIndex;
	System::Uitypes::TImageIndex FThumbDisabledImageIndex;
	Vcl::Imglist::TChangeLink* FThumbImagesChangeLink;
	System::Classes::TNotifyEvent FOnChange;
	Rzcommon::TPositionChangingEvent FOnChanging;
	TRzDrawTrackEvent FOnDrawTrack;
	TDrawTickEvent FOnDrawTick;
	void __fastcall SetThumbImages(Vcl::Imglist::TCustomImageList* Value);
	void __fastcall SetThumbImageIndex(System::Uitypes::TImageIndex Value);
	void __fastcall SetThumbHotImageIndex(System::Uitypes::TImageIndex Value);
	void __fastcall SetThumbDisabledImageIndex(System::Uitypes::TImageIndex Value);
	void __fastcall ThumbImagesChange(System::TObject* Sender);
...
protected:
	...
	virtual void __fastcall DrawTrack(Vcl::Graphics::TCanvas* Canvas);
	virtual void __fastcall DrawTicks(Vcl::Graphics::TCanvas* Canvas);
	virtual void __fastcall DrawThumb(Vcl::Graphics::TCanvas* Canvas);
	...
	virtual void __fastcall SetNormalColor(System::Uitypes::TColor Value);
...
__published:
	...
	__property System::Uitypes::TColor NormalColor = {read=FNormalColor, write=SetNormalColor, default=-16777203};
	...
	__property Vcl::Imglist::TCustomImageList* ThumbImages = {read=FThumbImages, write=SetThumbImages};
	__property System::Uitypes::TImageIndex ThumbImageIndex = {read=FThumbImageIndex, write=SetThumbImageIndex, default=-1};
	__property System::Uitypes::TImageIndex ThumbHotImageIndex = {read=FThumbHotImageIndex, write=SetThumbHotImageIndex, default=-1};
	__property System::Uitypes::TImageIndex ThumbDisabledImageIndex = {read=FThumbDisabledImageIndex, write=SetThumbDisabledImageIndex, default=-1};
	...
	__property bool ShowThumbCursor = {read=FShowThumbCursor, write=FShowThumbCursor, default=1};
