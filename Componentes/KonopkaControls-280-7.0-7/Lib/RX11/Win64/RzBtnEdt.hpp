...
public:
	...
	__fastcall virtual ~TRzCustomButtonEdit();
...
__published:
	...
	__property AltBtnImages;
	__property AltBtnImageIndex = {default=-1};
	__property ButtonImages;
	__property ButtonImageIndex = {default=-1};
...
public:
	...
	/* TRzCustomButtonEdit.Destroy */ inline __fastcall virtual ~TRzButtonEdit() { }
...
extern DELPHI_PACKAGE int __fastcall GetBtnEdtIndex(TButtonKind Kind);
extern DELPHI_PACKAGE Vcl::Imagecollection::TImageCollection* __fastcall GetBtnEdtCollection(void);
}	/* namespace Rzbtnedt */
