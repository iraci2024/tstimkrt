...
function sgcws_files() {
  if (arguments.length == 0) return;
  
  if (arguments.length == 1) {
    if (typeof arguments[0] == "object") {
      arguments[0]["subprotocol"] = "files.esegece.com";
    ...
    if (typeof arguments[0] == "object") {
      arguments[0]["subprotocol"] = arguments[1] + "files.esegece.com";
	  sgcWebSocket.call(this, arguments[0]);
    } else if (typeof arguments[0] == "string") { 
  ...
  this.sendfile = function() {
	...
	rawDataView =  new DataView(rawData);
	rawDataView.setInt16(1, 5);
    send_override.apply(this, rawDataView);
  }
...
sgcws_files.prototype = new sgcWebSocket();
sgcws_files.prototype.constructor = sgcws_files;
