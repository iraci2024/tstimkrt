...
{$ENDIF}
  ...
  TSecGetKeyFn = procedure(Arg: Pointer; // Argument passed in
  ...
  TSecPkgContext_ApplicationProtocol = record
    ProtoNegoStatus: Integer; // Application  protocol negotiation status
    ProtoNegoExt: Integer;
    // Protocol negotiation extension type corresponding to this protocol ID
    ProtocolIdSize: Byte; // Size in bytes of the application protocol ID
    ProtocolId: Array [0 .. MAX_PROTOCOL_ID_SIZE - 1] of Byte;
  ...
  TSecurityFunctionTable = record
    ...
    EnumerateSecurityPackages: function(out pcPackages: Cardinal;
      out ppPackageInfo: PSecPkgInfo): SECURITY_STATUS; stdcall;

    QueryCredentialsAttributes: function(phCredential: PCredHandle;
      ulAttribute: Cardinal; pBuffer: Pointer): SECURITY_STATUS; stdcall;

    AcquireCredentialsHandle: function(pszPrincipal: PWideChar; pszPackage: PWideChar;
      fCredentialUse: Cardinal; pvLogonId: Pointer; pAuthData: Pointer;
      pGetKeyFn: TSecGetKeyFn; pvGetKeyArgument: Pointer;
      phCredential: PCredHandle; ptsExpiry: PTimeStamp)
      : SECURITY_STATUS; stdcall;

    FreeCredentialsHandle: function(phCredential: PCredHandle)
      : SECURITY_STATUS; stdcall;
    ...
    InitializeSecurityContext: function(phCredential: PCredHandle;
      ...
      out pfContextAttr: Cardinal; ptsExpiry: PTimeStamp)
      : SECURITY_STATUS; stdcall;
    ...
    AcceptSecurityContext: function(phCredential: PCredHandle;
      ...
      pOutput: PSecBufferDesc; out pfContextAttr: Cardinal;
      ptsExpiry: PTimeStamp): SECURITY_STATUS; stdcall;

    CompleteAuthToken: function(phContext: PCtxtHandle; pToken: PSecBufferDesc)
      : SECURITY_STATUS; stdcall;

    DeleteSecurityContext: function(phContext: PCtxtHandle)
      : SECURITY_STATUS; stdcall;

    ApplyControlToken: function(phContext: PCtxtHandle; pInput: PSecBufferDesc)
      : SECURITY_STATUS; stdcall;

    QueryContextAttributes: function(phContext: PCtxtHandle;
      ulAttribute: Cardinal; pBuffer: Pointer): SECURITY_STATUS; stdcall;

    ImpersonateSecurityContext: function(phContext: PCtxtHandle)
      : SECURITY_STATUS; stdcall;

    RevertSecurityContext: function(phContext: PCtxtHandle)
      : SECURITY_STATUS; stdcall;

    MakeSignature: function(phContext: PCtxtHandle; fQOP: Cardinal;
      pMessage: PSecBufferDesc; MessageSeqNo: Cardinal)
      : SECURITY_STATUS; stdcall;

    VerifySignature: function(phContext: PCtxtHandle; pMessage: PSecBufferDesc;
      MessageSeqNo: Cardinal; out pfQOP: Cardinal): SECURITY_STATUS; stdcall;

    FreeContextBuffer: function(pvContextBuffer: PVOID)
      : SECURITY_STATUS; stdcall;

    QuerySecurityPackageInfo: function(pszPackageName: PChar;
      out ppPackageInfo: PSecPkgInfo): SECURITY_STATUS; stdcall;

    Reserved3: Pointer;
    Reserved4: Pointer;

    ExportSecurityContext: function(phContext: PCtxtHandle; fFlags: ULONG;
      pPackedContext: PSecBuffer; out pToken: PPointer)
      : SECURITY_STATUS; stdcall;

    ImportSecurityContext: function(pszPackage: PWideChar;
      pPackedContext: PSecBuffer; Token: Pointer; out phContext: PCtxtHandle)
      : SECURITY_STATUS; stdcall;

    AddCredentials: function(hCredentials: PCredHandle; pszPrincipal: PWideChar;
      pszPackage: PWideChar; fCredentialUse: Cardinal; pAuthData: Pointer;
      pGetKeyFn: TSecGetKeyFn; pvGetKeyArgument: Pointer; ptsExpiry: PTimeStamp)
      : SECURITY_STATUS; stdcall;

    Reserved8: Pointer;

    QuerySecurityContextToken: function(phContext: PCtxtHandle;
    ...
    DecryptMessage: function(phContext: PCtxtHandle; pMessage: PSecBufferDesc;
      MessageSeqNo: Cardinal; pfQOP: PCardinal): SECURITY_STATUS; stdcall;

    // Fields below this are available in OSes after w2k
    SetContextAttributes: function(phContext: PCtxtHandle;
      ulAttribute: Cardinal; pBuffer: Pointer; cbBuffer: Cardinal)
      : SECURITY_STATUS; stdcall;

    // Fields below this are available in OSes after W2k3SP1
    SetCredentialsAttributes: function(phCredential: PCredHandle;
      ulAttribute: Cardinal; pBuffer: Pointer; cbBuffer: Cardinal)
      : SECURITY_STATUS; stdcall;
...
function CertCreateCertificateContext(dwCertEncodingType: DWORD;
  pbCertEncoded: Pointer; cbCertEncoded: DWORD): PCCERT_CONTEXT; stdcall;
  external 'crypt32.dll';

function CryptImportPublicKeyInfo(HCRYPTPROV: HCRYPTPROV;
  dwCertEncodingType: DWORD; pInfo: PCERT_PUBLIC_KEY_INFO; var phKey: HCRYPTKEY)
...
function CryptCreateHash(hProv: HCRYPTPROV; Algid: Integer; hKey: HCRYPTKEY;
  dwFlags: Integer; var phHash: HCRYPTHASH): BOOL; stdcall; external advapi32;

function CryptHashData(hHash: HCRYPTHASH; Const pbData: Pointer;
  dwDataLen, dwFlags: Integer): BOOL; stdcall; external advapi32;

function CryptGetHashParam(hHash: HCRYPTHASH; dwParam: Integer; pbData: Pointer;
  Var pdwDataLen: Cardinal; dwFlags: Integer): BOOL; stdcall; external advapi32;

function CryptSignHash(hHash: HCRYPTHASH; dwKeySpec: Integer;
  sDescription: PWideChar; dwFlags: Integer; pbSignature: Pointer;
  var pdwSigLen: Cardinal): BOOL; stdcall;
  external advapi32 name 'CryptSignHashW';

function CryptExportKey(hKey, hExpKey: HCRYPTKEY; dwBlobType, dwFlags: Integer;
  pbData: Pointer; Var pdwDataLen: Cardinal): BOOL; stdcall; external advapi32;
...
Function CryptReleaseContext(hProv: HCRYPTPROV; dwFlags: Integer): BOOL;
...
const
  ...
  SECBUFFER_READONLY_WITH_CHECKSUM = $10000000;
  ...
  SP_PROT_NONE = 0;
  SP_PROT_CLIENTS = (SP_PROT_PCT1_CLIENT or SP_PROT_SSL2_CLIENT or
    SP_PROT_SSL3_CLIENT or SP_PROT_UNI_CLIENT or SP_PROT_TLS1_CLIENT);
  SP_PROT_SERVERS = (SP_PROT_PCT1_SERVER or SP_PROT_SSL2_SERVER or
    SP_PROT_SSL3_SERVER or SP_PROT_UNI_SERVER or SP_PROT_TLS1_SERVER);
  ...
  SCH_USE_PRESHAREDKEY_ONLY = $00800000;
...
Const
  ...
  CERT_SYSTEM_STORE_CURRENT_SERVICE = $00040000;
  CERT_SYSTEM_STORE_SERVICES = $00050000;
  CERT_SYSTEM_STORE_USERS = $00060000;
  CERT_SYSTEM_STORE_CURRENT_USER_GROUP_POLICY = $00070000;
  CERT_SYSTEM_STORE_LOCAL_MACHINE_GROUP_POLICY = $00080000;
  CERT_SYSTEM_STORE_LOCAL_MACHINE_ENTERPRISE = $00090000;
...
type
  ...
  PFN_CERT_CHAIN_FIND_BY_ISSUER_CALLBACK = function(pCert: PCCERT_CONTEXT;
    pvFindArg: Pointer): Integer; stdcall;
...
Type
  TsgcInitSecurityInterface = function: PSecurityFunctionTable; stdcall;
function InitSecurityInterface: PSecurityFunctionTable; stdcall;

Type
  TsgcCertNameToStr = function(dwCertEncodingType: DWORD;
    const pName: CERT_NAME_BLOB; dwStrType: DWORD; psz: PWideChar; csz: DWORD)
    : DWORD; stdcall;
function CertNameToStr(dwCertEncodingType: DWORD; const pName: CERT_NAME_BLOB;
  dwStrType: DWORD; psz: PWideChar; csz: DWORD): DWORD; stdcall;

Type
  TsgcCertGetIssuerCertificateFromStore = function(HCERTSTORE: HCERTSTORE;
...
Type
  TsgcCertFreeCertificateContext = function(pCertContext: PCCERT_CONTEXT)
    : BOOL; stdcall;
function CertFreeCertificateContext(pCertContext: PCCERT_CONTEXT)
  : BOOL; stdcall;

Type
  TsgcCertGetCertificateChain = function(hChainEngine: HCERTCHAINENGINE;
    pCertContext: PCCERT_CONTEXT; pTime: PFILETIME;
    hAdditionalStore: HCERTSTORE; const pChainPara: CERT_CHAIN_PARA;
...
function CertGetCertificateChain(hChainEngine: HCERTCHAINENGINE;
  pCertContext: PCCERT_CONTEXT; pTime: PFILETIME; hAdditionalStore: HCERTSTORE;
  const pChainPara: CERT_CHAIN_PARA; dwFlags: DWORD; pvReserved: Pointer;
  var ppChainContext: PCCERT_CHAIN_CONTEXT): BOOL; stdcall;

Type
  TsgcCertVerifyCertificateChainPolicy = function(pszPolicyOID: LPCSTR;
    pChainContext: PCCERT_CHAIN_CONTEXT;
    const pPolicyPara: CERT_CHAIN_POLICY_PARA;
    const pPolicyStatus: CERT_CHAIN_POLICY_STATUS): BOOL; stdcall;
...
Type
  TsgcCertFreeCertificateChainEngine = function(hChainEngine: HCERTCHAINENGINE)
    : BOOL; stdcall;
function CertFreeCertificateChainEngine(hChainEngine: HCERTCHAINENGINE)
  : BOOL; stdcall;

Type
  TsgcCertFreeCertificateChain = function(pChainContext: PCCERT_CHAIN_CONTEXT)
    : BOOL; stdcall;
function CertFreeCertificateChain(pChainContext: PCCERT_CHAIN_CONTEXT)
  : BOOL; stdcall;

Type
  TsgcCertOpenStore = function(lpszStoreProvider: LPCSTR; dwEncodingType: DWORD;
    hProv: HCRYPTPROV; dwFlags: DWORD; const pvPara: PVOID)
    : HCERTSTORE; stdcall;
function CertOpenStore(lpszStoreProvider: LPCSTR; dwEncodingType: DWORD;
  hProv: HCRYPTPROV; dwFlags: DWORD; const pvPara: PVOID): HCERTSTORE; stdcall;

Type
  TsgcCertOpenSystemStore = function(hProv: HCRYPTPROV;
    szSubsystemProtocol: LPWSTR): HCERTSTORE; stdcall;
function CertOpenSystemStore(hProv: HCRYPTPROV; szSubsystemProtocol: LPWSTR)
  : HCERTSTORE; stdcall;

Type
  TsgcCertFindCertificateInStore = function(HCERTSTORE: HCERTSTORE;
...
Type
  TsgcCertFindChainInStore = function(HCERTSTORE: HCERTSTORE;
    dwCertEncodingType: DWORD; dwFindFlags: DWORD; dwFindType: DWORD;
    const pvFindPara: Pointer; pPrevChainContext: PCCERT_CHAIN_CONTEXT)
    : PCCERT_CHAIN_CONTEXT; stdcall;
function CertFindChainInStore(HCERTSTORE: HCERTSTORE; dwCertEncodingType: DWORD;
  dwFindFlags: DWORD; dwFindType: DWORD; const pvFindPara: Pointer;
  pPrevChainContext: PCCERT_CHAIN_CONTEXT): PCCERT_CHAIN_CONTEXT; stdcall;

Type
  TsgcCertCloseStore = function(HCERTSTORE: HCERTSTORE; dwFlags: DWORD)
    : BOOL; stdcall;
function CertCloseStore(HCERTSTORE: HCERTSTORE; dwFlags: DWORD): BOOL; stdcall;

Type
  TsgcCryptProtectData = function(var pDataIn: DATA_BLOB; ppszDataDecr: PWideChar;
    pOptionalEntropy: PDATA_BLOB; pvReserved: Integer;
    pPromptStruct: PCRYPTPROTECT_PROMPTSTRUCT; dwFlags: DWORD;
    var pDataOut: DATA_BLOB): BOOL; stdcall;
function CryptProtectData(var pDataIn: DATA_BLOB; ppszDataDecr: PWideChar;
  pOptionalEntropy: PDATA_BLOB; pvReserved: Integer;
  pPromptStruct: PCRYPTPROTECT_PROMPTSTRUCT; dwFlags: DWORD;
  var pDataOut: DATA_BLOB): BOOL; stdcall;

Type
  TsgcCryptUnprotectData = function(var pDataIn: DATA_BLOB;
    ppszDataDecr: PPWideChar; pOptionalEntropy: PDATA_BLOB; pvReserved: Integer;
    pPromptStruct: PCRYPTPROTECT_PROMPTSTRUCT; dwFlags: DWORD;
    var pDataOut: DATA_BLOB): BOOL; stdcall;
function CryptUnprotectData(var pDataIn: DATA_BLOB; ppszDataDecr: PPWideChar;
  pOptionalEntropy: PDATA_BLOB; pvReserved: Integer;
  pPromptStruct: PCRYPTPROTECT_PROMPTSTRUCT; dwFlags: DWORD;
  var pDataOut: DATA_BLOB): BOOL; stdcall;

Type
  TsgcPFXImportCertStore = function(var pPFX: CRYPT_DATA_BLOB;
    szPassword: PWideChar; dwFlags: DWORD): HCERTSTORE; stdcall;
function PFXImportCertStore(var pPFX: CRYPT_DATA_BLOB; szPassword: PWideChar;
  dwFlags: DWORD): HCERTSTORE; stdcall;

Type
  TsgcCryptStringToBinary = function(pszString: PWideChar; cchString: DWORD;
    dwFlags: DWORD; pbBinary: PBYTE; var pcbBinary: DWORD; pdwSkip: PDWORD;
    pdwFlags: PDWORD): BOOL; stdcall;
function CryptStringToBinary(pszString: PWideChar; cchString: DWORD;
  dwFlags: DWORD; pbBinary: PBYTE; var pcbBinary: DWORD; pdwSkip: PDWORD;
  pdwFlags: PDWORD): BOOL; stdcall;
...
{$IFNDEF SGC_SCHANNEL_STATIC}

var
  oInitSecurityInterface: TsgcInitSecurityInterface;

  oCertNameToStr: TsgcCertNameToStr;
  oCertGetIssuerCertificateFromStore: TsgcCertGetIssuerCertificateFromStore;
  oCertFreeCertificateContext: TsgcCertFreeCertificateContext;
  oCertGetCertificateChain: TsgcCertGetCertificateChain;
  oCertVerifyCertificateChainPolicy: TsgcCertVerifyCertificateChainPolicy;
  oCertFreeCertificateChainEngine: TsgcCertFreeCertificateChainEngine;
  oCertFreeCertificateChain: TsgcCertFreeCertificateChain;
  oCertOpenStore: TsgcCertOpenStore;
  oCertOpenSystemStore: TsgcCertOpenSystemStore;
  oCertFindCertificateInStore: TsgcCertFindCertificateInStore;
  oCertFindChainInStore: TsgcCertFindChainInStore;
  oCertCloseStore: TsgcCertCloseStore;
  oCryptProtectData: TsgcCryptProtectData;
  oCryptUnprotectData: TsgcCryptUnprotectData;
  oPFXImportCertStore: TsgcPFXImportCertStore;
  oCryptStringToBinary: TsgcCryptStringToBinary;

var
  vInitialized: Boolean = False;
  vModuleCrypt32: HModule = 0;
  vModuleSecur32: HModule = 0;
...
begin
  ...
  begin
    vModuleCrypt32 := LoadLibrary(PChar(Crypt32));
    if (vModuleCrypt32 <= HINSTANCE_ERROR) then
    begin
      ZeroMemory(@oBuffer, SizeOf(oBuffer));
      FormatMessage(FORMAT_MESSAGE_FROM_SYSTEM, nil, GetLastError(), 0, oBuffer,
        SizeOf(oBuffer), nil);
      raise Exception.Create(oBuffer);
    end;

    vModuleSecur32 := LoadLibrary(PChar(Secur32));
    if (vModuleSecur32 <= HINSTANCE_ERROR) then
    begin
      ZeroMemory(@oBuffer, SizeOf(oBuffer));
      FormatMessage(FORMAT_MESSAGE_FROM_SYSTEM, nil, GetLastError(), 0, oBuffer,
        SizeOf(oBuffer), nil);
...
begin
  DoInitialize();
  if not Assigned(oInitSecurityInterface) then
    @oInitSecurityInterface := GetProcAddress(vModuleSecur32,
      'InitSecurityInterfaceW');

  Result := oInitSecurityInterface();
end;
...
begin
  DoInitialize();
  if not Assigned(oCertNameToStr) then
    @oCertNameToStr := GetProcAddress(vModuleCrypt32, 'CertNameToStrW');

  Result := oCertNameToStr(dwCertEncodingType, pName, dwStrType, psz, csz);
end;
...
begin
  DoInitialize();
  if not Assigned(oCertGetIssuerCertificateFromStore) then
    @oCertGetIssuerCertificateFromStore := GetProcAddress(vModuleCrypt32,
      'CertGetIssuerCertificateFromStore');

  Result := oCertGetIssuerCertificateFromStore(HCERTSTORE, pSubjectContext,
...
begin
  DoInitialize();
  if not Assigned(oCertFreeCertificateContext) then
    @oCertFreeCertificateContext := GetProcAddress(vModuleCrypt32,
      'CertFreeCertificateContext');

  Result := oCertFreeCertificateContext(pCertContext);
end;
...
begin
  DoInitialize();
  if not Assigned(oCertGetCertificateChain) then
    @oCertGetCertificateChain := GetProcAddress(vModuleCrypt32,
      'CertGetCertificateChain');

  Result := oCertGetCertificateChain(hChainEngine, pCertContext, pTime,
...
begin
  DoInitialize();
  if not Assigned(oCertVerifyCertificateChainPolicy) then
    @oCertVerifyCertificateChainPolicy := GetProcAddress(vModuleCrypt32,
      'CertVerifyCertificateChainPolicy');

  Result := oCertVerifyCertificateChainPolicy(pszPolicyOID, pChainContext,
...
begin
  DoInitialize();
  if not Assigned(oCertFreeCertificateChainEngine) then
    @oCertFreeCertificateChainEngine := GetProcAddress(vModuleCrypt32,
      'CertFreeCertificateChainEngine');

  Result := oCertFreeCertificateChainEngine(hChainEngine);
end;
...
begin
  DoInitialize();
  if not Assigned(oCertFreeCertificateChain) then
    @oCertFreeCertificateChain := GetProcAddress(vModuleCrypt32,
      'CertFreeCertificateChain');

  Result := oCertFreeCertificateChain(pChainContext);
end;
...
begin
  DoInitialize();
  if not Assigned(oCertOpenStore) then
    @oCertOpenStore := GetProcAddress(vModuleCrypt32, 'CertOpenStore');

  Result := oCertOpenStore(lpszStoreProvider, dwEncodingType, hProv,
    dwFlags, pvPara);
end;
...
begin
  DoInitialize();
  if not Assigned(oCertOpenSystemStore) then
    @oCertOpenSystemStore := GetProcAddress(vModuleCrypt32,
      'CertOpenSystemStoreW');

  Result := oCertOpenSystemStore(hProv, szSubsystemProtocol);
end;
...
begin
  DoInitialize();
  if not Assigned(oCertFindCertificateInStore) then
    @oCertFindCertificateInStore := GetProcAddress(vModuleCrypt32,
      'CertFindCertificateInStore');

  Result := oCertFindCertificateInStore(HCERTSTORE, dwCertEncodingType,
...
begin
  DoInitialize();
  if not Assigned(oCertFindChainInStore) then
    @oCertFindChainInStore := GetProcAddress(vModuleCrypt32,
      'CertFindChainInStore');

  Result := oCertFindChainInStore(HCERTSTORE, dwCertEncodingType, dwFindFlags,
...
begin
  DoInitialize();
  if not Assigned(oCertCloseStore) then
    @oCertCloseStore := GetProcAddress(vModuleCrypt32, 'CertCloseStore');

  Result := oCertCloseStore(HCERTSTORE, dwFlags);
end;
...
begin
  DoInitialize();
  if not Assigned(oCryptProtectData) then
    @oCryptProtectData := GetProcAddress(vModuleCrypt32, 'CryptProtectData');

  Result := oCryptProtectData(pDataIn, ppszDataDecr, pOptionalEntropy,
...
begin
  DoInitialize();
  if not Assigned(oCryptUnprotectData) then
    @oCryptUnprotectData := GetProcAddress(vModuleCrypt32,
      'CryptUnprotectData');

  Result := oCryptUnprotectData(pDataIn, ppszDataDecr, pOptionalEntropy,
    pvReserved, pPromptStruct, dwFlags, pDataOut);
end;
...
begin
  DoInitialize();
  if not Assigned(oPFXImportCertStore) then
    @oPFXImportCertStore := GetProcAddress(vModuleCrypt32,
      'PFXImportCertStore');

  Result := oPFXImportCertStore(pPFX, szPassword, dwFlags);
end;
...
begin
  DoInitialize();
  if not Assigned(oCryptStringToBinary) then
    @oCryptStringToBinary := GetProcAddress(vModuleCrypt32,
      'CryptStringToBinaryW');

  Result := oCryptStringToBinary(pszString, cchString, dwFlags, pbBinary,
...
var
  Len: Integer;
begin
  Len := CertNameToStr(Cert.dwCertEncodingType, Blob, CERT_X500_NAME_STR or
    CERT_NAME_STR_NO_PLUS_FLAG or CERT_NAME_STR_REVERSE_FLAG, nil, 0);
  if Len <= 0 then
  begin
    result := '';
    Exit;
  ...
  CertNameToStr(Cert.dwCertEncodingType, Blob, CERT_X500_NAME_STR or
    CERT_NAME_STR_NO_PLUS_FLAG or CERT_NAME_STR_REVERSE_FLAG,
    @Result[1], Len + 1);
end;

{$IFDEF SGC_SCHANNEL_STATIC}
...
function CertOpenStore; external Crypt32 name 'CertOpenSStore';
