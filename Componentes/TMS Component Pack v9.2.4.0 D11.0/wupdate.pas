...
uses
  StdCtrls, Messages, Classes, SysUtils, WinInet, Winapi.Windows, Forms, Registry,
...
begin
  ...
  if GetVersionEx(Winapi.Windows.POSVersionInfo(@osVerInfo)^) then
  begin
...
var
  ...
  lpFindFileData:_WIN32_FIND_DATAW;
  OpenFlags: DWORD;
