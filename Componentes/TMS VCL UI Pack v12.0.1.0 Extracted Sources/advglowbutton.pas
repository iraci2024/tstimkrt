...
function DrawVistaButton(Owner: TControl; Canvas: TCanvas; r: TRect; CFU, CTU, CFB, CTB, PC, PCF: TColor;
   ...
   Trimming: TStringTrimming; Notes: TStringList; NotesFont: TFont;Checked, Down, TranspHover, GDIPArrow: boolean; MargH,MargV: integer; NoDefBorder: boolean; AlwaysAccel: boolean; Frm: TCustomForm; ADropDownWidth: integer; Rotated: boolean): TSize;
var
  graphics : TGPGraphics;
  w,h,h2,h2d: Integer;
  ...
  //            PenColor := BlendColor(BorderColorDown, BorderColorChecked, FStepPush);
      ...
      begin
        ...
        sz := DrawVistaButton(Self, Canvas, drrect, GradColor, GradColorTo, GradColorMirror,GradColorMirrorTo,
          ...
          FSpacing, FTrimming, FNotes, FNotesFont, FDownChecked, FDroppedDown, TranspOffice and Transparent, InternalIsOnGlassQAT, MarginHorz, MarginVert, Appearance.NoBorderDefault, AlwaysShowAccel, GetParentForm(Self), DropDownWidth, IsRotated);
      ...
      sz := DrawVistaButton(Self, Canvas, drrect, GradColor, GradColorTo, GradColorMirror, GradColorMirrorTo,
        ...
        False, FRounded, FDropDownDirection, FSpacing, FTrimming, FNotes, FNotesFont, FDownChecked, FDroppedDown, TranspOffice and Transparent, InternalIsOnGlassQAT, MarginHorz,MarginVert,Appearance.NoBorderDefault, AlwaysShowAccel, GetParentForm(Self), DropDownWidth, IsRotated);
      DrawGlyphCaption;
  ...
  with Appearance do
    Result := DrawVistaButton(Self, Canvas,ClientRect,FColor, FColorTo, FColorMirror, FColorMirrorTo,
      BorderColor, BorderColorFocused, Gradient, GradientMirror, DCaption, DWideCaption, FDefaultCaptionDrawing, Font, ImgList, FDisabledImages, ImageIndex, EnabledImg, LayOt, FDropDownButton,
        ...
        FOverlappedText, FWordWrap, True, FRounded, FDropDownDirection, FSpacing, FTrimming, FNotes, FNotesFont, FDownChecked, FDroppedDown, TranspOffice and Transparent, InternalIsOnGlassQAT,MarginHorz,MarginVert,NoBorderDefault, AlwaysShowAccel, GetParentForm(Self), DropDownWidth, IsRotated);
