...
uses
  Classes, Math, DateUtils, Types, SysUtils, FMX.TMSFNCPDFGraphicsLib, FMX.TMSFNCGraphics, FMX.TMSFNCGraphicsTypes
  ,FMX.TMSFNCPDFLib, FMX.TMSFNCUtils, FMX.TMSFNCPDFCoreLibBase, FMX.Graphics, FMX.TMSFNCTypes,
  ...
  {$IFDEF MACOS}
  {$IFDEF IOS}
  ,FMX.TMSFNCPDFLib.General.iOS
  {$ELSE}
  ,FMX.TMSFNCPDFLib.General.Mac
  {$ENDIF}
  {$ENDIF}
  {$IFDEF ANDROID}
  ,FMX.TMSFNCPDFLib.General.Android
  {$ENDIF}
  {$IFDEF MSWINDOWS}
  ,FMX.TMSFNCPDFLib.General.Win
  {$ENDIF}
  {$IFDEF UNIX}
  ,FMX.TMSFNCPDFLib.General.Unix
  {$ENDIF}
  {$IFDEF WEBLIB}
  ,FMX.TMSFNCPDFLib.General.WEB
  {$ENDIF}
  {$IFDEF LCLLIB}
  {$IFNDEF MSWINDOWS}
  {$IFNDEF UNIX}
  ,FMX.TMSFNCPDFLib.General.Default
  {$ENDIF}
  {$ENDIF}
  {$ENDIF}
  ;
