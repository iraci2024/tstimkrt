...
uses
  ...
  {%H-}Windows,
  {$ENDIF}
  Classes, Controls, LCLTMSFNCGraphics, Graphics, LCLTMSFNCStyles
  ,LCLTMSFNCPersistence, LCLTMSFNCUndo
  {$IFNDEF WEBLIB}
  {$IFDEF FNCLIB}
  ,LCLTMSFNCHint
  {$ELSE}
  ...
  {$ENDIF}
  {$ENDIF}
  ,Types, LCLTMSFNCGraphicsTypes, LCLTMSFNCTypes, TypInfo, Forms
  {$IFDEF VCLLIB}
  ,Messages
  {$ENDIF}
  {$IFDEF WEBLIB}
...
type
  ...
  {$IFDEF FNCLIB}
  {$IFNDEF WEBLIB}
  TTMSFNCCustomControlShortCutWindowList = specialize TFPGObjectList<TTMSFNCHint>;
  {$ENDIF}
  {$ENDIF}
