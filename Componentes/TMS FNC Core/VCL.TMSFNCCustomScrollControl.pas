...
unit VCL.TMSFNCCustomScrollControl;
...
uses
  ...
  Windows,
  {$ENDIF}
  Classes, VCL.TMSFNCCustomControl, VCL.StdCtrls, VCL.TMSFNCScrollBar, VCL.TMSFNCGraphics,
  VCL.TMSFNCTypes, VCL.ExtCtrls
  {$IFNDEF LCLLIB}
  ,Types
  {$ENDIF}
  {$IFDEF FMXLIB}
...
uses
  ...
  {$ENDIF}
  VCL.Forms, Math,
  VCL.TMSFNCGraphicsTypes, SysUtils;
