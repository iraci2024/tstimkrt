...
uses
  Classes, FMX.TMSFNCPDFCoreLibBase, FMX.TMSFNCGraphicsTypes, FMX.TMSFNCTypes
  {$IFDEF WEBLIB}
  ,Contnrs
  {$ENDIF}
  {$IFNDEF LCLWEBLIB}
...
{$IFDEF MACOS}
{$IFDEF IOS}
  FMX.TMSFNCPDFRichTextLib.iOS,
{$ELSE}
  FMX.TMSFNCPDFRichTextLib.Mac,
{$ENDIF}
{$ENDIF}
{$IFDEF ANDROID}
  FMX.TMSFNCPDFRichTextLib.Android,
{$ENDIF}
{$IFNDEF MACOS}
{$IFNDEF ANDROID}
  FMX.TMSFNCPDFRichTextLib.General,
{$ENDIF}
{$ENDIF}
  SysUtils
  {$IFDEF FMXLIB}
