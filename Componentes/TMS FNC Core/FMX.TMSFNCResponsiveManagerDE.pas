...
unit FMX.TMSFNCResponsiveManagerDE;
...
uses
  Classes, FMX.TMSFNCResponsiveManager, FMX.TMSFNCGeneralDE, FMX.TMSFNCResponsiveManagerDimensionsEditor, TypInfo
  {$IFNDEF LCLWEBLIB}
...
uses
  ...
  Registry,
  {$ENDIF}
  FMX.Controls, SysUtils, FMX.Dialogs, FMX.TMSFNCUtils, FMX.TMSFNCTypes,
  FMX.TMSFNCPersistence, FMX.TMSFNCStateManager
  {$IFDEF FMXLIB}
  ,FMX.Forms, JSON
  {$ENDIF}
  {$IFDEF VCLLIB}
