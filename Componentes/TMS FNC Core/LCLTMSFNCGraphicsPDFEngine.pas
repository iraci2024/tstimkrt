...
unit LCLTMSFNCGraphicsPDFEngine;
...
uses
  Classes, LCLTMSFNCGraphics, LCLTMSFNCGraphicsTypes, LCLTMSFNCPDFLib,
  Graphics, LCLTMSFNCPDFIO, LCLTMSFNCTypes
  {$IFNDEF LCLLIB}
  ,Types
  {$IFNDEF WEBLIB}
  {$HINTS OFF}
...
uses
  LCLTMSFNCUtils, LCLTMSFNCHTMLEngine, SysUtils, LCLTMSFNCBitmapContainer, LCLTMSFNCStyles,
  LCLTMSFNCPDFCoreLibBase, LCLTMSFNCPDFGraphicsLib, Math
  {$IFNDEF WEBLIB}
  {$IFDEF SVGSUPPORT}
  ,LCLTMSFNCGraphicsSVGEngine
  {$ENDIF}
  {$ENDIF}
  ;
