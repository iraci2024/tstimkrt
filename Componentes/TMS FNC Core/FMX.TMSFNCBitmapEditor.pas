...
uses
  ...
  FMX.TMSFNCTypes, FMX.StdCtrls, FMX.ExtCtrls, FMX.TMSFNCBitmapContainer, FMX.Forms, FMX.TMSFNCGraphics, FMX.TMSFNCGraphicsTypes,
  FMX.TMSFNCEditorButton, FMX.TMSFNCEditorPanel
  {$IFDEF FMXLIB}
...
uses
  FMX.TMSFNCUtils, FMX.Graphics, SysUtils, FMX.Dialogs, FMX.TMSFNCEditorsTools
  {$IFDEF WEBLIB}
  ,WEBLib.WebTools
  {$ENDIF}
  {$IFNDEF FMXMOBILE}
