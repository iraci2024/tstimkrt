...
unit FMX.TMSFNCResponsiveManagerDimensionsEditor;
...
uses
  ...
  FMX.TMSFNCTypes, FMX.StdCtrls, FMX.ExtCtrls, FMX.Forms, FMX.TMSFNCResponsiveManager,
...
uses
  ...
  FMX.TMSFNCEditorsTools, FMX.TMSFNCGraphicsTypes, Math
  {$IFDEF FMXLIB}
  ,JSON
  {$ENDIF}
  {$IFDEF VCLLIB}
