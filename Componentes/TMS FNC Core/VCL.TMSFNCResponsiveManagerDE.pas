...
unit VCL.TMSFNCResponsiveManagerDE;
...
uses
  Classes, VCL.TMSFNCResponsiveManager, VCL.TMSFNCGeneralDE, VCL.TMSFNCResponsiveManagerDimensionsEditor, TypInfo
  {$IFNDEF LCLWEBLIB}
...
uses
  ...
  Registry,
  {$ENDIF}
  VCL.Controls, SysUtils, VCL.Dialogs, VCL.TMSFNCUtils, VCL.TMSFNCTypes,
  VCL.TMSFNCPersistence, VCL.TMSFNCStateManager
  {$IFDEF FMXLIB}
  ,VCL.Forms, JSON
  {$ENDIF}
  {$IFDEF VCLLIB}
