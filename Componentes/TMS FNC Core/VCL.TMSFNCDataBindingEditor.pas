...
unit VCL.TMSFNCDataBindingEditor;
...
uses
  Classes, VCL.TMSFNCCustomComponent, VCL.TMSFNCDataBinding, VCL.TMSFNCCustomControl, VCL.Controls,
  VCL.TMSFNCTypes, VCL.StdCtrls, VCL.Graphics, VCL.ExtCtrls, VCL.Forms, VCL.TMSFNCGraphics,
  VCL.TMSFNCGraphicsTypes, VCL.TMSFNCEditorButton, VCL.TMSFNCEditorPanel, VCL.TMSFNCEditorListView
  {$IFDEF FMXLIB}
...
uses
  Math, TypInfo, VCL.TMSFNCPersistence, VCL.TMSFNCUtils, SysUtils, VCL.Dialogs
  , VCL.TMSFNCEditorsTools
  {$IFDEF WEBLIB}
  ,WEBLib.WebTools
  {$ENDIF}
  {$IFNDEF FMXMOBILE}
