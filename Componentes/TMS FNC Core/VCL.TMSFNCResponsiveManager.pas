...
unit VCL.TMSFNCResponsiveManager;
...
uses
  Classes, VCL.TMSFNCStateManager, VCL.TMSFNCCustomControl, Types, VCL.TMSFNCTypes
  {$IFNDEF LCLLIB}
...
uses
  SysUtils, Math, VCL.Graphics, VCL.Forms, VCL.Controls,
