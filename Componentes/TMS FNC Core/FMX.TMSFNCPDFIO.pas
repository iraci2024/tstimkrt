...
uses
  Classes, FMX.TMSFNCCustomComponent, FMX.TMSFNCPDFLib, FMX.TMSFNCPDFCoreLibBase, FMX.TMSFNCTypes,
  FMX.TMSFNCPDFGraphicsLib, FMX.TMSFNCBitmapContainer, FMX.TMSFNCGraphicsTypes
  {$IFNDEF LCLLIB}
  , Types
  {$ENDIF}
  ;
