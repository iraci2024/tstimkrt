...
unit FMX.TMSFNCGraphicsAppearanceEditor;
...
uses
  ...
  FMX.TMSFNCTypes, FMX.StdCtrls, FMX.ExtCtrls, FMX.TMSFNCBitmapContainer, FMX.Forms, FMX.TMSFNCGraphics,
  FMX.TMSFNCGraphicsTypes, FMX.TMSFNCBitmapEditor, FMX.TMSFNCEditorButton, FMX.TMSFNCEditorPanel, FMX.TMSFNCEditorsTools
  {$IFDEF FMXLIB}
...
uses
  FMX.TMSFNCUtils, FMX.Graphics, SysUtils, FMX.Dialogs, Math
  {$IFDEF WEBLIB}
  ,WEBLib.WebTools
  {$ENDIF}
  {$IFNDEF FMXMOBILE}
...
procedure TTMSFNCGraphicsFillEditor.RepaintPreview;
begin
  if Assigned(FImage) then
    FImage.Repaint;
  if Assigned(FTextureImage) and FTextureImage.Visible then
    FTextureImage.Repaint;
end;
...
procedure TTMSFNCGraphicsStrokeEditor.RepaintPreview;
begin
  if Assigned(FImage) then
    FImage.Repaint;
end;
