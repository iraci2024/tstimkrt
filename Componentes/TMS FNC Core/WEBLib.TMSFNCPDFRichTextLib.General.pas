...
unit WEBLib.TMSFNCPDFRichTextLib.General;
...
uses
  Classes, WEBLib.TMSFNCPDFRichTextLib, SysUtils, WEBLib.TMSFNCTypes
  ,WEBLib.TMSFNCPDFCoreLibBase, WEBLib.TMSFNCGraphicsTypes
  {$IFNDEF LCLLIB}
  ,Types
  {$ENDIF}
  ;
