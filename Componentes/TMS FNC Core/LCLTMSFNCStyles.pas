...
uses
  Classes, Graphics, Controls, Forms, LCLTMSFNCTypes, LCLTMSFNCCustomComponent, LCLTMSFNCGraphicsTypes
  {$IFDEF FMXLIB}
  ,FMX.Types, UITypes
  {$ENDIF}
...
uses
  LCLTMSFNCUtils, SysUtils, LCLTMSFNCPersistence, LCLTMSFNCGraphics
  {$IFDEF FMXLIB}
