...
unit WEBLib.TMSFNCStylesEditor;
...
uses
  ...
  WEBLib.TMSFNCTypes, WEBLib.StdCtrls, WEBLib.ExtCtrls, WEBLib.Forms, WEBLib.TMSFNCGraphics,
  WEBLib.TMSFNCGraphicsTypes, WEBLib.TMSFNCStyles,
...
uses
  ...
  WEBLib.TMSFNCEditorsTools, Math;
