...
uses
  Classes, Types, VCL.TMSFNCTypes, VCL.TMSFNCGraphicsTypes, VCL.Graphics,
  VCL.TMSFNCEditorButton, VCL.TMSFNCEditorListView, VCL.TMSFNCEditorPanel,
...
implementation
uses
  VCL.TMSFNCGraphics, VCL.TMSFNCUtils
  , Math, SysUtils
  {$IFDEF FMXLIB}
