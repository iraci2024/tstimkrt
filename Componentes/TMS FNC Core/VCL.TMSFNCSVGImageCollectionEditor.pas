...
unit VCL.TMSFNCSVGImageCollectionEditor;
...
uses
  Classes, VCL.TMSFNCCustomComponent, VCL.TMSFNCCustomControl, VCL.Controls, VCL.Graphics,
  VCL.TMSFNCTypes, VCL.StdCtrls, VCL.ExtCtrls, VCL.TMSFNCBitmapContainer, VCL.TMSFNCURLBitmapContainer, VCL.Forms, VCL.TMSFNCGraphics,
  VCL.TMSFNCGraphicsTypes, VCL.TMSFNCEditorListView, VCL.TMSFNCEditorButton, VCL.TMSFNCEditorPanel, VCL.TMSFNCEditorsTools
  {$IFDEF FMXLIB}
...
type
  TTMSFNCSVGImageCollectionEditor = class;

  {$IFDEF FMXLIB}
  TTMSFNCSVGImageCollectionEditorParent = TFmxObject;
  TTMSFNCSVGImageCollectionEditorComboBox = class(TComboEdit);
  {$ENDIF}
  {$IFDEF CMNWEBLIB}
  TTMSFNCSVGImageCollectionEditorParent = TWinControl;
  TTMSFNCSVGImageCollectionEditorComboBox = class(TComboBox);
  {$ENDIF}

  {$IFNDEF LCLLIB}
  [ComponentPlatformsAttribute(TMSPlatformsDesktop)]
  {$ENDIF}
  TTMSFNCSVGImageCollectionEditor = class(TTMSFNCCustomComponent)
  private
    FImgMargin : Single;
    FListItemHeight: Single;
    frm: TTMSFNCCustomDesignerForm;
    FPanel, FListPanel, FTopPanel: TTMSFNCEditorPanel;
    FCopySVGCollection: TTMSFNCSVGImageCollection;
    ...
    FSVGImageCollection: TTMSFNCSVGImageCollection;
    {$IFNDEF FMXLIB}
    ...
    {$ENDIF}
    procedure SetSVGImageCollection(const Value: TTMSFNCSVGImageCollection);
    procedure AssignBitmapListItems;
    procedure AssignControlItems;
    procedure SetBitmapItemProperties(AFrom, ATo: TTMSFNCSVGImageCollectionItem); overload;
    procedure SetBitmapItemProperties(AFrom: TTMSFNCEditorListItem; ATo: TTMSFNCSVGImageCollectionItem); overload;
    procedure SetEditorListItemProperties(AFrom: TTMSFNCSVGImageCollectionItem; ATo: TTMSFNCEditorListItem);
  ...
  protected
    ...
    {$ENDIF}
    procedure SetControlProperties(AParent: TTMSFNCSVGImageCollectionEditorParent); virtual;
  public
  ...
  published
    property SVGImageCollection: TTMSFNCSVGImageCollection read FSVGImageCollection write SetSVGImageCollection;
  end;

  TTMSFNCSVGImageCollectionEditorForm = class(TTMSFNCCustomDesignerForm)
...
uses
  VCL.TMSFNCUtils, SysUtils, VCL.Dialogs, Math
  {$IFDEF WEBLIB}
  ,WEBLib.WebTools
  {$ENDIF}
  {$IFNDEF FMXMOBILE}
...
{ TTMSFNCSVGImageCollectionEditor }
...
procedure TTMSFNCSVGImageCollectionEditor.Notification(AComponent: TComponent; AOperation: TOperation);
begin
  inherited;
  if (AOperation = opRemove) and (AComponent = FSVGImageCollection) then
    FSVGImageCollection := nil;
end;

procedure TTMSFNCSVGImageCollectionEditor.RegisterRuntimeClasses;
begin
  inherited;
  RegisterClass(TTMSFNCSVGImageCollectionEditor);
end;

procedure TTMSFNCSVGImageCollectionEditor.Assign(Source: TPersistent);
begin
  if (Source is TTMSFNCSVGImageCollectionEditor) then
    FSVGImageCollection := (Source as TTMSFNCSVGImageCollectionEditor).SVGImageCollection;
end;

procedure TTMSFNCSVGImageCollectionEditor.AssignBitmapListItems;
var
...
begin
  ...
  for I := 0 to FSVGImageCollection.Images.Count - 1 do
  begin
    bli := FBitmapList.Items.Add;
    SetEditorListItemProperties(FSVGImageCollection.Images[i], bli);
  end;
  FBitmapList.EndUpdate;
end;

procedure TTMSFNCSVGImageCollectionEditor.AssignControlItems;
var
  bi: TTMSFNCSVGImageCollectionItem;
  I: Integer;
begin
  FSVGImageCollection.Images.Clear;
  for I := 0 to FBitmapList.Items.Count - 1 do
  begin
    bi := FSVGImageCollection.Images.Add;
    SetBitmapItemProperties(FBitmapList.Items[I], bi);
  end;
end;

procedure TTMSFNCSVGImageCollectionEditor.BuildEditor(AParent: TTMSFNCSVGImageCollectionEditorParent);
{$IFNDEF WEBLIB}
var
  bs: TBytesStream;
{$ENDIF}
...
constructor TTMSFNCSVGImageCollectionEditor.Create(AOwner: TComponent);
begin
  inherited;
  FListItemHeight := 60;
  FImgMargin := 5;
  FCopySVGCollection := TTMSFNCSVGImageCollection.Create(Self);
end;

destructor TTMSFNCSVGImageCollectionEditor.Destroy;
begin
  FreeAndNil(FSVGImageCollection);
  inherited;
end;

procedure TTMSFNCSVGImageCollectionEditor.DoAddItem(Sender: TObject);
var
  i: Integer;
  sy: single;
begin
  ...
  begin
    ...
    FSVGImageCollection.Images.Insert(i);
  end
  else
  begin
    FSVGImageCollection.Images.Add;
    i := FSVGImageCollection.Images.Count - 1;
  end;

  FSVGImageCollection.Images[i].Name := 'Image';
...
procedure TTMSFNCSVGImageCollectionEditor.DoBitmapListItemsChanged(Sender: TObject);
begin
  UpdateBitmapContainer;
end;

procedure TTMSFNCSVGImageCollectionEditor.DoBitmapListItemSelectChanged(Sender: TObject; AIndex: Integer; AItem: TTMSFNCEditorListItem; ASelected: Boolean);
begin
...
procedure TTMSFNCSVGImageCollectionEditor.DoClearItems(Sender: TObject);
begin
  FSVGImageCollection.Images.Clear;
  UpdateBitmapList;
end;

procedure TTMSFNCSVGImageCollectionEditor.DoCopyBitmapChange(Sender: TObject);
begin
  if Assigned(FBitmapList) then
    FBitmapList.Invalidate;
end;

procedure TTMSFNCSVGImageCollectionEditor.DoDeleteItems(Sender: TObject);
begin
...
procedure TTMSFNCSVGImageCollectionEditor.DoDuplicateItems(Sender: TObject);
var
  i, li, bi: integer;
  bci: TTMSFNCSVGImageCollectionItem;
begin
  li := -1;
  ...
  begin
    ...
    if (FBitmapList.LastSelectedItemIndex < FBitmapList.Items.Count - 1) then
      bci := (FSVGImageCollection.Images.Insert(li + 1) as TTMSFNCSVGImageCollectionItem)
    else
      bci := FSVGImageCollection.Images.Add;

    SetBitmapItemProperties(FSVGImageCollection.Images[li], bci);
    bci.Name := bci.Name + '1';
    inc(bi);
  end
  else
  ...
  begin
    ...
    begin
      bci := (FSVGImageCollection.Images.Insert(bi + 1) as TTMSFNCSVGImageCollectionItem);
...
procedure TTMSFNCSVGImageCollectionEditor.DoFillItems(Sender: TObject);
var
  od: TOpenDialog;
  I: Integer;
  str: string;
  bi: TTMSFNCSVGImageCollectionItem;
begin
  if not Assigned(FSVGImageCollection) then
    Exit;
  ...
  {$ENDIF}
  begin
//    FSVGImageCollection.BeginUpdate;
    FSVGImageCollection.Images.Clear;
    ...
    begin
      ...
      begin
        ...
        {$ENDIF}
        {$IFDEF WEBLIB}
        str := 'data:image/PNG;base64,' + AValue;
        bi.Bitmap.LoadFromResource(str);
        {$ENDIF}
        bi.Data.LoadFromFile(str);
...
{$IFNDEF FMXLIB}
procedure TTMSFNCSVGImageCollectionEditor.DoFormKeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
{$ENDIF}
{$IFDEF FMXLIB}
procedure TTMSFNCSVGImageCollectionEditor.DoFormKeyDown(Sender: TObject; var Key: Word; var KeyChar: Char; Shift: TShiftState);
{$ENDIF}
begin
  inherited;
...
procedure TTMSFNCSVGImageCollectionEditor.DoAppendItems(Sender: TObject);
var
  od: TOpenDialog;
  I: Integer;
  str: string;
...
procedure TTMSFNCSVGImageCollectionEditor.DoURLBitmapDownloadComplete(Sender: TObject; ItemIndex: integer);
begin
  UpdateBitmapList;
end;

procedure TTMSFNCSVGImageCollectionEditor.EnableItemButtons(AEnabled: Boolean);
begin
...
{$IFDEF LCLLIB}
procedure TTMSFNCSVGImageCollectionEditor.DoDropFiles(Sender: TObject; const FileNames: array of String);
begin
  if Assigned(FBitmapList) then
...
{$IFDEF WEBLIB}
procedure TTMSFNCSVGImageCollectionEditor.Execute(AProc: TModalResultProc = nil);
{$ELSE}
function TTMSFNCSVGImageCollectionEditor.Execute: TModalResult;
{$ENDIF}
begin
  FCopySVGCollection.Assign(FSVGImageCollection);
  {$IFDEF WEBLIB}
  frm := TTMSFNCSVGImageCollectionEditorForm.CreateDialogNew(Self, 'Bitmap Container Editor');
  {$ELSE}
  frm := TTMSFNCSVGImageCollectionEditorForm.CreateNew(Application);
  ...
  if (Result <> mrOk) and Assigned(SVGImageCollection) then
  begin
    SVGImageCollection.Assign(FCopySVGCollection);
  end;
  frm.Free;
  {$ELSE}
  frm.ShowModal(
  ...
  begin
    if (AResult <> mrOk) and Assigned(SVGImageCollection) then
    begin
      SVGImageCollection.Assign(FCopySVGCollection);
    end;
    frm := nil;
...
function TTMSFNCSVGImageCollectionEditor.GetInstance: NativeUInt;
begin
  Result := HInstance;
end;

procedure TTMSFNCSVGImageCollectionEditor.SetActionButtonAppearance(AButton: TTMSFNCEditorButton);
begin
  AButton.ShowHint := True;
  SetEditorTabButtonAppearance(AButton, EDITORPRIMCOLOR);
end;

procedure TTMSFNCSVGImageCollectionEditor.SetBitmapItemProperties(AFrom,
  ATo: TTMSFNCSVGImageCollectionItem);
begin

end;

procedure TTMSFNCSVGImageCollectionEditor.SetSVGImageCollection(const Value: TTMSFNCSVGImageCollection);
begin
  FSVGImageCollection := Value;
end;

procedure TTMSFNCSVGImageCollectionEditor.SetBitmapItemProperties(AFrom: TTMSFNCEditorListItem; ATo: TTMSFNCSVGImageCollectionItem);
begin
  ATo.Name := AFrom.Name;
  ATo.Data.Assign(AFrom.Bitmap);
end;

procedure TTMSFNCSVGImageCollectionEditor.SetControlProperties(AParent:TTMSFNCSVGImageCollectionEditorParent);
begin
  if Assigned(FButtonDelete) then
  begin
  ...
  begin
    ...
    FBitmapList.OnItemSelectedChanged := @DoBitmapListItemSelectChanged;
    {$ENDIF}
//    FBitmapList.AlwaysDrawDataString := False;

    SetEditorBitmapListAppearance(FBitmapList);
  end;
...
procedure TTMSFNCSVGImageCollectionEditor.SetEditorListItemProperties(AFrom: TTMSFNCSVGImageCollectionItem; ATo: TTMSFNCEditorListItem);
begin
  ATo.Name := AFrom.Name;
  ATo.Bitmap.Assign(AFrom.Data);
end;

procedure TTMSFNCSVGImageCollectionEditor.SetItemButtonAppearance(AButton: TTMSFNCEditorButton);
begin
  AButton.Text := '';
  AButton.Width := 27;
  AButton.ShowHint := True;

  SetEditorIconButtonAppearance(AButton, EDITORPRIMCOLOR, Round(AButton.Width / 2));
end;

procedure TTMSFNCSVGImageCollectionEditor.UpdateBitmapContainer;
begin
...
procedure TTMSFNCSVGImageCollectionEditor.UpdateBitmapList;
begin
