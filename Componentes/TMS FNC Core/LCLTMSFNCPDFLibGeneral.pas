...
uses
  Classes, Math, DateUtils, Types, SysUtils, LCLTMSFNCPDFGraphicsLib, LCLTMSFNCGraphics, LCLTMSFNCGraphicsTypes
  ,LCLTMSFNCPDFLib, LCLTMSFNCUtils, LCLTMSFNCPDFCoreLibBase, Graphics, LCLTMSFNCTypes,
  ...
  {$IFDEF MACOS}
  {$IFDEF IOS}
  ,LCLTMSFNCPDFLibGeneraliOS
  {$ELSE}
  ,LCLTMSFNCPDFLibGeneralMac
  {$ENDIF}
  {$ENDIF}
  {$IFDEF ANDROID}
  ,LCLTMSFNCPDFLibGeneralAndroid
  {$ENDIF}
  {$IFDEF MSWINDOWS}
  ,LCLTMSFNCPDFLibGeneralWin
  {$ENDIF}
  {$IFDEF UNIX}
  ,LCLTMSFNCPDFLibGeneralUnix
  {$ENDIF}
  {$IFDEF WEBLIB}
  ,LCLTMSFNCPDFLibGeneralWEB
  {$ENDIF}
  {$IFDEF LCLLIB}
  {$IFNDEF MSWINDOWS}
  {$IFNDEF UNIX}
  ,LCLTMSFNCPDFLibGeneralDefault
  {$ENDIF}
  {$ENDIF}
  {$ENDIF}
  ;
...
type
  ...
  {$ENDIF}
  {$IFNDEF WEBLIB}
  TTMSFNCGeneralPDFLibPageList = class(specialize TFPGList<TTMSFNCGeneralPDFLibPage>);
  {$ENDIF}
  ...
  {$ENDIF}
  {$IFNDEF WEBLIB}
  TTMSFNCGeneralPDFLibFonts = class(specialize TFPGList<TTMSFNCGeneralPDFLibFont>);
  {$ENDIF}
  ...
  {$ENDIF}
  {$IFNDEF WEBLIB}
  TTMSFNCGeneralPDFLibXObjects = class(specialize TFPGList<TTMSFNCGeneralPDFLibXObject>);
  {$ENDIF}
  ...
  {$ENDIF}
  {$IFNDEF WEBLIB}
  TTMSFNCGeneralPDFLibShadings = class(specialize TFPGList<TTMSFNCGeneralPDFLibShading>);
  {$ENDIF}
  ...
  {$ENDIF}
  {$IFNDEF WEBLIB}
  TTMSFNCGeneralPDFLibPatterns = class(specialize TFPGList<TTMSFNCGeneralPDFLibPattern>);
  {$ENDIF}
  ...
  {$ENDIF}
  {$IFNDEF WEBLIB}
  TTMSFNCGeneralPDFLibAnnotations = class(specialize TFPGList<TTMSFNCGeneralPDFLibAnnotation>);
  {$ENDIF}
  ...
  {$ENDIF}
  {$IFNDEF WEBLIB}
  TTMSFNCGeneralPDFLibBitmaps = class(specialize TFPGList<TTMSFNCGeneralPDFLibBitmap>);
  {$ENDIF}
  ...
  {$ENDIF}
  {$IFNDEF WEBLIB}
  TTMSFNCGeneralPDFLibAcroFormFields = class(specialize TFPGList<TTMSFNCGeneralPDFLibAcroForm>);
  {$ENDIF}
...
//  TTMSFNCGeneralPDFLibTextField = class(TTMSFNCGeneralPDFLibAcroFormField);
  ...
  {$ENDIF}
  {$IFNDEF WEBLIB}
  TTMSFNCGeneralPDFLibShadingSubFunctions = class(specialize TFPGList<TTMSFNCGeneralPDFLibShadingSubFunction>);
  {$ENDIF}
  ...
  {$ENDIF}
  {$IFNDEF WEBLIB}
  TTMSFNCGeneralPDFLibXRefObjects = class(specialize TFPGObjectList<TTMSFNCGeneralPDFLibXRefObject>)
  public
  {$ENDIF}
