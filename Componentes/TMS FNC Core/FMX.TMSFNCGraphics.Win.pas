...
uses
  Classes, Windows, ActiveX, FMX.TMSFNCGDIPlusApi, FMX.TMSFNCGraphicsTypes,
  {%H-}Types, FMX.TMSFNCGraphics, FMX.Graphics, FMX.TMSFNCUtils, FMX.TMSFNCTypes
  {$IFNDEF LCLLIB}
  {$HINTS OFF}
