...
uses
  Classes, FMX.TMSFNCPDFCoreLibBase, FMX.TMSFNCPDFRichTextLib, FMX.TMSFNCTypes, FMX.TMSFNCBitmapContainer,
...
type
  ...
  {$ENDIF}
  {$IFNDEF WEBLIB}
  TTMSFNCPDFGraphicsLibList = class(TList<TObject>);
  {$ENDIF}
...
{$IFDEF MACOS}
{$IFDEF IOS}
  FMX.TMSFNCPDFGraphicsLib.iOS,
{$ELSE}
  FMX.TMSFNCPDFGraphicsLib.Mac,
{$ENDIF}
{$ENDIF}
{$IFDEF ANDROID}
  FMX.TMSFNCPDFGraphicsLib.Android,
{$ENDIF}
  FMX.TMSFNCPDFGraphicsLib.General,
  SysUtils
  {$IFDEF FMXLIB}
  ,FMX.Types
  {$ENDIF}
