...
unit LCLTMSFNCResponsiveManagerDimensionsEditor;
...
uses
  ...
  LCLTMSFNCTypes, StdCtrls, ExtCtrls, Forms, LCLTMSFNCResponsiveManager,
...
type
  ...
  TTMSFNCResponsiveManagerDimensionsEditorDimensions = class(specialize TFPGObjectList<TTMSFNCResponsiveManagerDimensionsEditorDimension>);
...
uses
  ...
  LCLTMSFNCEditorsTools, LCLTMSFNCGraphicsTypes, Math
  {$IFDEF FMXLIB}
  ,JSON
  {$ENDIF}
  {$IFDEF VCLLIB}
