...
// (DO NOT EDIT: machine generated header) 'FMX.TMSFNCGraphics.pas' rev: 35.00 (Windows)
...
public:
	...
	virtual void __fastcall DrawProgressBar(const System::Types::TRect &ARect, float AValue, System::UnicodeString AFormat = L"%.0f%%", float AMax = 1.000000E+02f, System::Uitypes::TAlphaColor AColor = (System::Uitypes::TAlphaColor)(0xff9acd32), System::Uitypes::TAlphaColor ATextColor = (System::Uitypes::TAlphaColor)(0xff000000), bool AShowText = true, bool AEnabled = true, float AScaleFactor = 1.000000E+00f)/* overload */;
