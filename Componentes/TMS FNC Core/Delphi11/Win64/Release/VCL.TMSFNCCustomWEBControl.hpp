...
// (DO NOT EDIT: machine generated header) 'VCL.TMSFNCCustomWEBControl.pas' rev: 35.00 (Windows)

#ifndef Vcl_TmsfnccustomwebcontrolHPP
#define Vcl_TmsfnccustomwebcontrolHPP
...
public:
	/* {System_Generics_Collections}TObjectList<VCL_TMSFNCCustomWEBControl_TTMSFNCCustomWEBControlLink>.Create */ inline __fastcall TTMSFNCCustomWEBControlLinksList()/* overload */ : System::Generics::Collections::TObjectList__1<TTMSFNCCustomWEBControlLink*>() { }
	/* {System_Generics_Collections}TObjectList<VCL_TMSFNCCustomWEBControl_TTMSFNCCustomWEBControlLink>.Create */ inline __fastcall TTMSFNCCustomWEBControlLinksList(bool AOwnsObjects)/* overload */ : System::Generics::Collections::TObjectList__1<TTMSFNCCustomWEBControlLink*>(AOwnsObjects) { }
	/* {System_Generics_Collections}TObjectList<VCL_TMSFNCCustomWEBControl_TTMSFNCCustomWEBControlLink>.Create */ inline __fastcall TTMSFNCCustomWEBControlLinksList(const System::DelphiInterface<System::Generics::Defaults::IComparer__1<TTMSFNCCustomWEBControlLink*> > AComparer, bool AOwnsObjects)/* overload */ : System::Generics::Collections::TObjectList__1<TTMSFNCCustomWEBControlLink*>(AComparer, AOwnsObjects) { }
	/* {System_Generics_Collections}TObjectList<VCL_TMSFNCCustomWEBControl_TTMSFNCCustomWEBControlLink>.Create */ inline __fastcall TTMSFNCCustomWEBControlLinksList(System::Generics::Collections::TEnumerable__1<TTMSFNCCustomWEBControlLink*>* const Collection, bool AOwnsObjects)/* overload */ : System::Generics::Collections::TObjectList__1<TTMSFNCCustomWEBControlLink*>(Collection, AOwnsObjects) { }
	/* {System_Generics_Collections}TObjectList<VCL_TMSFNCCustomWEBControl_TTMSFNCCustomWEBControlLink>.Destroy */ inline __fastcall virtual ~TTMSFNCCustomWEBControlLinksList() { }
	
public:
	/* {System_Generics_Collections}TList<VCL_TMSFNCCustomWEBControl_TTMSFNCCustomWEBControlLink>.Create */ inline __fastcall TTMSFNCCustomWEBControlLinksList(const System::DelphiInterface<System::Generics::Defaults::IComparer__1<TTMSFNCCustomWEBControlLink*> > AComparer)/* overload */ : System::Generics::Collections::TObjectList__1<TTMSFNCCustomWEBControlLink*>(AComparer) { }
	/* {System_Generics_Collections}TList<VCL_TMSFNCCustomWEBControl_TTMSFNCCustomWEBControlLink>.Create */ inline __fastcall TTMSFNCCustomWEBControlLinksList(System::Generics::Collections::TEnumerable__1<TTMSFNCCustomWEBControlLink*>* const Collection)/* overload */ : System::Generics::Collections::TObjectList__1<TTMSFNCCustomWEBControlLink*>(Collection) { }
	/* {System_Generics_Collections}TList<VCL_TMSFNCCustomWEBControl_TTMSFNCCustomWEBControlLink>.Create */ inline __fastcall TTMSFNCCustomWEBControlLinksList(TTMSFNCCustomWEBControlLink* const *Values, const int Values_High)/* overload */ : System::Generics::Collections::TObjectList__1<TTMSFNCCustomWEBControlLink*>(Values, Values_High) { }
...
private:
	void *__ITMSFNCCustomWebBrowserBridge;	// Vcl::Tmsfncwebbrowser::ITMSFNCCustomWebBrowserBridge 
	
public:
	#if defined(MANAGED_INTERFACE_OPERATORS)
	// {AC2934EC-9397-4A99-8E0A-1EF58803C8EA}
	operator Vcl::Tmsfncwebbrowser::_di_ITMSFNCCustomWebBrowserBridge()
	{
		Vcl::Tmsfncwebbrowser::_di_ITMSFNCCustomWebBrowserBridge intf;
		this->GetInterface(intf);
		return intf;
	}
	#else
	operator Vcl::Tmsfncwebbrowser::ITMSFNCCustomWebBrowserBridge*(void) { return (Vcl::Tmsfncwebbrowser::ITMSFNCCustomWebBrowserBridge*)&__ITMSFNCCustomWebBrowserBridge; }
	#endif
...
class PASCALIMPLEMENTATION TTMSFNCCustomWEBControl : public Vcl::Tmsfncwebbrowser::TTMSFNCCustomWebBrowser
{
...
public:
	/* TWinControl.CreateParented */ inline __fastcall TTMSFNCCustomWEBControl(HWND ParentWindow) : Vcl::Tmsfncwebbrowser::TTMSFNCCustomWebBrowser(ParentWindow) { }
	
};


//-- var, const, procedure ---------------------------------------------------
static const System::WideChar LB = (System::WideChar)(0xd);
#define STARTHTMLTAG L"<html>"
#define STARTHEADTAG L"<head>"
#define STARTBODYTAG L"<body>"
#define STARTTITLETAG L"<title>"
#define STARTSCRIPTTAG L"<script>"
#define STARTSTYLETAG L"<style>"
#define ENDHTMLTAG L"</html>"
#define ENDHEADTAG L"</head>"
#define ENDBODYTAG L"</body>"
#define ENDTITLETAG L"</title>"
#define ENDSCRIPTTAG L"</script>"
#define ENDSTYLETAG L"</style>"
}	/* namespace Tmsfnccustomwebcontrol */
}	/* namespace Vcl */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_VCL_TMSFNCCUSTOMWEBCONTROL)
using namespace Vcl::Tmsfnccustomwebcontrol;
#endif
...
//-- end unit ----------------------------------------------------------------
#endif	// Vcl_TmsfnccustomwebcontrolHPP
