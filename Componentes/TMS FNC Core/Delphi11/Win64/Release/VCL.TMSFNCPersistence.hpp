...
// (DO NOT EDIT: machine generated header) 'VCL.TMSFNCPersistence.pas' rev: 35.00 (Windows)

#ifndef Vcl_TmsfncpersistenceHPP
#define Vcl_TmsfncpersistenceHPP
...
#include <VCL.TMSFNCJSONReader.hpp>
...
typedef void __fastcall (__closure *TTMSFNCWriterCustomWritePropertyEvent)(System::TObject* AObject, System::UnicodeString APropertyName, System::TTypeKind APropertyKind, Vcl::Tmsfncjsonwriter::TTMSFNCJSONWriter* AWriter, bool &ACanWrite);
...
private:
	Vcl::Tmsfncjsonwriter::TTMSFNCJSONWriter* FWriter;
	...
	__property Vcl::Tmsfncjsonwriter::TTMSFNCJSONWriter* Writer = {read=FWriter};
	...
	void __fastcall WriteBitmap(Vcl::Tmsfnctypes::TTMSFNCBitmap* ABitmap);
...
public:
	...
	__property Vcl::Tmsfncjsonwriter::TTMSFNCJSONWriter* JSONWriter = {read=FWriter};
...
typedef void __fastcall (__closure *TTMSFNCReaderCustomReadPropertyEvent)(System::TObject* AObject, System::UnicodeString APropertyName, System::TTypeKind APropertyKind, Vcl::Tmsfncjsonreader::TTMSFNCJSONReader* AReader, bool &ACanRead);
...
private:
	...
	Vcl::Tmsfncjsonreader::TTMSFNCJSONReader* FReader;
	System::TObject* FIOReference;
	...
	void __fastcall SetExcludeProperties(const TTMSFNCExcludePropertyListArray Value);
	void __fastcall SetIOReference(System::TObject* const Value);
	__property Vcl::Tmsfncjsonreader::TTMSFNCJSONReader* Reader = {read=FReader};
	...
	void __fastcall ReadBitmap(Vcl::Tmsfnctypes::TTMSFNCBitmap* ABitmap);
...
public:
	...
	__property Vcl::Tmsfncjsonreader::TTMSFNCJSONReader* JSONReader = {read=FReader};
	__property System::TObject* IOReference = {read=FIOReference, write=SetIOReference};
	__property System::TObject* RootObject = {read=FRootObject, write=SetRootObject};
	__property TTMSFNCExcludePropertyListArray ExcludeProperties = {read=FExcludeProperties, write=SetExcludeProperties};
...
private:
	...
	__classmethod void __fastcall DoCustomReadProperty(System::TObject* AObject, System::UnicodeString APropertyName, System::TTypeKind APropertyKind, Vcl::Tmsfncjsonreader::TTMSFNCJSONReader* AReader, bool &ACanRead);
	__classmethod void __fastcall DoCustomWriteProperty(System::TObject* AObject, System::UnicodeString APropertyName, System::TTypeKind APropertyKind, Vcl::Tmsfncjsonwriter::TTMSFNCJSONWriter* AWriter, bool &ACanWrite);
...
public:
	/* {System_Generics_Collections}TObjectList<VCL_TMSFNCPersistence_TTMSFNCJSONToClassProperty>.Create */ inline __fastcall TTMSFNCJSONToClassProperties()/* overload */ : System::Generics::Collections::TObjectList__1<TTMSFNCJSONToClassProperty*>() { }
	/* {System_Generics_Collections}TObjectList<VCL_TMSFNCPersistence_TTMSFNCJSONToClassProperty>.Create */ inline __fastcall TTMSFNCJSONToClassProperties(bool AOwnsObjects)/* overload */ : System::Generics::Collections::TObjectList__1<TTMSFNCJSONToClassProperty*>(AOwnsObjects) { }
	/* {System_Generics_Collections}TObjectList<VCL_TMSFNCPersistence_TTMSFNCJSONToClassProperty>.Create */ inline __fastcall TTMSFNCJSONToClassProperties(const System::DelphiInterface<System::Generics::Defaults::IComparer__1<TTMSFNCJSONToClassProperty*> > AComparer, bool AOwnsObjects)/* overload */ : System::Generics::Collections::TObjectList__1<TTMSFNCJSONToClassProperty*>(AComparer, AOwnsObjects) { }
	...
	/* {System_Generics_Collections}TObjectList<VCL_TMSFNCPersistence_TTMSFNCJSONToClassProperty>.Destroy */ inline __fastcall virtual ~TTMSFNCJSONToClassProperties() { }
	
public:
	/* {System_Generics_Collections}TList<VCL_TMSFNCPersistence_TTMSFNCJSONToClassProperty>.Create */ inline __fastcall TTMSFNCJSONToClassProperties(const System::DelphiInterface<System::Generics::Defaults::IComparer__1<TTMSFNCJSONToClassProperty*> > AComparer)/* overload */ : System::Generics::Collections::TObjectList__1<TTMSFNCJSONToClassProperty*>(AComparer) { }
	/* {System_Generics_Collections}TList<VCL_TMSFNCPersistence_TTMSFNCJSONToClassProperty>.Create */ inline __fastcall TTMSFNCJSONToClassProperties(System::Generics::Collections::TEnumerable__1<TTMSFNCJSONToClassProperty*>* const Collection)/* overload */ : System::Generics::Collections::TObjectList__1<TTMSFNCJSONToClassProperty*>(Collection) { }
	/* {System_Generics_Collections}TList<VCL_TMSFNCPersistence_TTMSFNCJSONToClassProperty>.Create */ inline __fastcall TTMSFNCJSONToClassProperties(TTMSFNCJSONToClassProperty* const *Values, const int Values_High)/* overload */ : System::Generics::Collections::TObjectList__1<TTMSFNCJSONToClassProperty*>(Values, Values_High) { }
...
public:
	/* {System_Generics_Collections}TObjectList<VCL_TMSFNCPersistence_TTMSFNCJSONToClassItem>.Create */ inline __fastcall TTMSFNCJSONToClassItems()/* overload */ : System::Generics::Collections::TObjectList__1<TTMSFNCJSONToClassItem*>() { }
	/* {System_Generics_Collections}TObjectList<VCL_TMSFNCPersistence_TTMSFNCJSONToClassItem>.Create */ inline __fastcall TTMSFNCJSONToClassItems(bool AOwnsObjects)/* overload */ : System::Generics::Collections::TObjectList__1<TTMSFNCJSONToClassItem*>(AOwnsObjects) { }
	/* {System_Generics_Collections}TObjectList<VCL_TMSFNCPersistence_TTMSFNCJSONToClassItem>.Create */ inline __fastcall TTMSFNCJSONToClassItems(const System::DelphiInterface<System::Generics::Defaults::IComparer__1<TTMSFNCJSONToClassItem*> > AComparer, bool AOwnsObjects)/* overload */ : System::Generics::Collections::TObjectList__1<TTMSFNCJSONToClassItem*>(AComparer, AOwnsObjects) { }
	/* {System_Generics_Collections}TObjectList<VCL_TMSFNCPersistence_TTMSFNCJSONToClassItem>.Create */ inline __fastcall TTMSFNCJSONToClassItems(System::Generics::Collections::TEnumerable__1<TTMSFNCJSONToClassItem*>* const Collection, bool AOwnsObjects)/* overload */ : System::Generics::Collections::TObjectList__1<TTMSFNCJSONToClassItem*>(Collection, AOwnsObjects) { }
	/* {System_Generics_Collections}TObjectList<VCL_TMSFNCPersistence_TTMSFNCJSONToClassItem>.Destroy */ inline __fastcall virtual ~TTMSFNCJSONToClassItems() { }
	
public:
	/* {System_Generics_Collections}TList<VCL_TMSFNCPersistence_TTMSFNCJSONToClassItem>.Create */ inline __fastcall TTMSFNCJSONToClassItems(const System::DelphiInterface<System::Generics::Defaults::IComparer__1<TTMSFNCJSONToClassItem*> > AComparer)/* overload */ : System::Generics::Collections::TObjectList__1<TTMSFNCJSONToClassItem*>(AComparer) { }
	/* {System_Generics_Collections}TList<VCL_TMSFNCPersistence_TTMSFNCJSONToClassItem>.Create */ inline __fastcall TTMSFNCJSONToClassItems(System::Generics::Collections::TEnumerable__1<TTMSFNCJSONToClassItem*>* const Collection)/* overload */ : System::Generics::Collections::TObjectList__1<TTMSFNCJSONToClassItem*>(Collection) { }
	/* {System_Generics_Collections}TList<VCL_TMSFNCPersistence_TTMSFNCJSONToClassItem>.Create */ inline __fastcall TTMSFNCJSONToClassItems(TTMSFNCJSONToClassItem* const *Values, const int Values_High)/* overload */ : System::Generics::Collections::TObjectList__1<TTMSFNCJSONToClassItem*>(Values, Values_High) { }
...
typedef System::StaticArray<System::UnicodeString, 53> Vcl_Tmsfncpersistence__71;

//-- var, const, procedure ---------------------------------------------------
extern DELPHI_PACKAGE Vcl_Tmsfncpersistence__71 ExcludePropertyList;
extern DELPHI_PACKAGE TTMSFNCJSONToClassOptions __fastcall DefaultJSONToClassOptions(void);
}	/* namespace Tmsfncpersistence */
}	/* namespace Vcl */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_VCL_TMSFNCPERSISTENCE)
using namespace Vcl::Tmsfncpersistence;
#endif
...
//-- end unit ----------------------------------------------------------------
#endif	// Vcl_TmsfncpersistenceHPP
