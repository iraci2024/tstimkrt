...
// (DO NOT EDIT: machine generated header) 'VCL.TMSFNCPDFGraphicsLibHTMLEngine.pas' rev: 35.00 (Windows)

#ifndef Vcl_TmsfncpdfgraphicslibhtmlengineHPP
#define Vcl_TmsfncpdfgraphicslibhtmlengineHPP
...
private:
	...
	bool FSuperscript;
	bool FSubscript;
	Vcl::Tmsfncgraphicstypes::TTMSFNCGraphicsTextAlign FTextAlign;
	float FOffset;
	bool FBullet;
...
public:
	...
	__property System::Uitypes::TColor LineColor = {read=FLineColor, write=FLineColor, nodefault};
	...
	__property Vcl::Tmsfncgraphicstypes::TTMSFNCGraphicsTextAlign TextAlign = {read=FTextAlign, write=FTextAlign, nodefault};
...
public:
	/* {System_Generics_Collections}TObjectList<VCL_TMSFNCPDFGraphicsLibHTMLEngine_TTMSFNCPDFGraphicsLibHTMLLine>.Create */ inline __fastcall TTMSFNCPDFGraphicsLibHTMLLines()/* overload */ : System::Generics::Collections::TObjectList__1<TTMSFNCPDFGraphicsLibHTMLLine*>() { }
	/* {System_Generics_Collections}TObjectList<VCL_TMSFNCPDFGraphicsLibHTMLEngine_TTMSFNCPDFGraphicsLibHTMLLine>.Create */ inline __fastcall TTMSFNCPDFGraphicsLibHTMLLines(bool AOwnsObjects)/* overload */ : System::Generics::Collections::TObjectList__1<TTMSFNCPDFGraphicsLibHTMLLine*>(AOwnsObjects) { }
	/* {System_Generics_Collections}TObjectList<VCL_TMSFNCPDFGraphicsLibHTMLEngine_TTMSFNCPDFGraphicsLibHTMLLine>.Create */ inline __fastcall TTMSFNCPDFGraphicsLibHTMLLines(const System::DelphiInterface<System::Generics::Defaults::IComparer__1<TTMSFNCPDFGraphicsLibHTMLLine*> > AComparer, bool AOwnsObjects)/* overload */ : System::Generics::Collections::TObjectList__1<TTMSFNCPDFGraphicsLibHTMLLine*>(AComparer, AOwnsObjects) { }
	/* {System_Generics_Collections}TObjectList<VCL_TMSFNCPDFGraphicsLibHTMLEngine_TTMSFNCPDFGraphicsLibHTMLLine>.Create */ inline __fastcall TTMSFNCPDFGraphicsLibHTMLLines(System::Generics::Collections::TEnumerable__1<TTMSFNCPDFGraphicsLibHTMLLine*>* const Collection, bool AOwnsObjects)/* overload */ : System::Generics::Collections::TObjectList__1<TTMSFNCPDFGraphicsLibHTMLLine*>(Collection, AOwnsObjects) { }
	/* {System_Generics_Collections}TObjectList<VCL_TMSFNCPDFGraphicsLibHTMLEngine_TTMSFNCPDFGraphicsLibHTMLLine>.Destroy */ inline __fastcall virtual ~TTMSFNCPDFGraphicsLibHTMLLines() { }
	
public:
	/* {System_Generics_Collections}TList<VCL_TMSFNCPDFGraphicsLibHTMLEngine_TTMSFNCPDFGraphicsLibHTMLLine>.Create */ inline __fastcall TTMSFNCPDFGraphicsLibHTMLLines(const System::DelphiInterface<System::Generics::Defaults::IComparer__1<TTMSFNCPDFGraphicsLibHTMLLine*> > AComparer)/* overload */ : System::Generics::Collections::TObjectList__1<TTMSFNCPDFGraphicsLibHTMLLine*>(AComparer) { }
	/* {System_Generics_Collections}TList<VCL_TMSFNCPDFGraphicsLibHTMLEngine_TTMSFNCPDFGraphicsLibHTMLLine>.Create */ inline __fastcall TTMSFNCPDFGraphicsLibHTMLLines(System::Generics::Collections::TEnumerable__1<TTMSFNCPDFGraphicsLibHTMLLine*>* const Collection)/* overload */ : System::Generics::Collections::TObjectList__1<TTMSFNCPDFGraphicsLibHTMLLine*>(Collection) { }
	/* {System_Generics_Collections}TList<VCL_TMSFNCPDFGraphicsLibHTMLEngine_TTMSFNCPDFGraphicsLibHTMLLine>.Create */ inline __fastcall TTMSFNCPDFGraphicsLibHTMLLines(TTMSFNCPDFGraphicsLibHTMLLine* const *Values, const int Values_High)/* overload */ : System::Generics::Collections::TObjectList__1<TTMSFNCPDFGraphicsLibHTMLLine*>(Values, Values_High) { }
...
public:
	__classmethod TTMSFNCPDFGraphicsLibHTMLLines* __fastcall ParseHTML(System::UnicodeString AHTML, Vcl::Tmsfncbitmapcontainer::TTMSFNCBitmapContainer* ABitmapContainer = (Vcl::Tmsfncbitmapcontainer::TTMSFNCBitmapContainer*)(0x0));
	__classmethod System::Types::TRectF __fastcall DrawHTMLText(Vcl::Tmsfncpdflib::_di_ITMSFNCCustomPDFLib APDFLib, System::UnicodeString Text, const System::Types::TRectF &Rect, Vcl::Tmsfncbitmapcontainer::TTMSFNCBitmapContainer* ABitmapContainer = (Vcl::Tmsfncbitmapcontainer::TTMSFNCBitmapContainer*)(0x0), bool Paging = false, float AScale = 1.000000E+00f, bool Calculate = false)/* overload */;
	__classmethod System::Types::TRectF __fastcall DrawHTMLText(Vcl::Tmsfncpdflib::_di_ITMSFNCCustomPDFLib APDFLib, System::UnicodeString Text, const System::Types::TPointF &Point, Vcl::Tmsfncbitmapcontainer::TTMSFNCBitmapContainer* ABitmapContainer = (Vcl::Tmsfncbitmapcontainer::TTMSFNCBitmapContainer*)(0x0), float AScale = 1.000000E+00f, bool Calculate = false)/* overload */;
	HIDESBASE System::UnicodeString __fastcall ToJSON()/* overload */;
	HIDESBASE void __fastcall FromJSON(const System::UnicodeString Value);
	__property System::UnicodeString JSON = {read=ToJSON, write=FromJSON};
	HIDESBASE System::UnicodeString __fastcall ToJSON(Vcl::Tmsfnctypes::TTMSFNCObjectExcludePropertyListArray AExcludedProperties)/* overload */;
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_VCL_TMSFNCPDFGRAPHICSLIBHTMLENGINE)
using namespace Vcl::Tmsfncpdfgraphicslibhtmlengine;
#endif
...
//-- end unit ----------------------------------------------------------------
#endif	// Vcl_TmsfncpdfgraphicslibhtmlengineHPP
