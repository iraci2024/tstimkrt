...
// (DO NOT EDIT: machine generated header) 'VCL.TMSFNCJSONReader.pas' rev: 35.00 (Windows)

#ifndef Vcl_TmsfncjsonreaderHPP
#define Vcl_TmsfncjsonreaderHPP
...
public:
	static const System::Byte MaxNumberBuffer = System::Byte(0xff);
	
	static const System::Byte MaxStackSize = System::Byte(0xff);
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_VCL_TMSFNCJSONREADER)
using namespace Vcl::Tmsfncjsonreader;
#endif
