...
// (DO NOT EDIT: machine generated header) 'VCL.TMSFNCPDFLib.pas' rev: 35.00 (Windows)

#ifndef Vcl_TmsfncpdflibHPP
#define Vcl_TmsfncpdflibHPP
...
#include <VCL.TMSFNCPDFGraphicsLib.hpp>
...
typedef void __fastcall (__closure *TTMSFNCPDFLibBeforeDrawHeaderEvent)(System::TObject* Sender, int APageIndex, System::UnicodeString AHeader, const System::Types::TRectF &ARect, Vcl::Tmsfncpdfgraphicslib::_di_ITMSFNCCustomPDFGraphicsLib AGraphics, bool &ADefaultDraw);

typedef void __fastcall (__closure *TTMSFNCPDFLibBeforeDrawFooterEvent)(System::TObject* Sender, int APageIndex, System::UnicodeString AFooter, const System::Types::TRectF &ARect, Vcl::Tmsfncpdfgraphicslib::_di_ITMSFNCCustomPDFGraphicsLib AGraphics, bool &ADefaultDraw);

typedef void __fastcall (__closure *TTMSFNCPDFLibBeforeDrawPageNumberEvent)(System::TObject* Sender, int APageIndex, System::UnicodeString APageNumber, const System::Types::TRectF &ARect, Vcl::Tmsfncpdfgraphicslib::_di_ITMSFNCCustomPDFGraphicsLib AGraphics, bool &ADefaultDraw);

typedef void __fastcall (__closure *TTMSFNCPDFLibAfterDrawHeaderEvent)(System::TObject* Sender, int APageIndex, System::UnicodeString AHeader, const System::Types::TRectF &ARect, Vcl::Tmsfncpdfgraphicslib::_di_ITMSFNCCustomPDFGraphicsLib AGraphics);

typedef void __fastcall (__closure *TTMSFNCPDFLibAfterDrawFooterEvent)(System::TObject* Sender, int APageIndex, System::UnicodeString AFooter, const System::Types::TRectF &ARect, Vcl::Tmsfncpdfgraphicslib::_di_ITMSFNCCustomPDFGraphicsLib AGraphics);

typedef void __fastcall (__closure *TTMSFNCPDFLibAfterDrawPageNumberEvent)(System::TObject* Sender, int APageIndex, System::UnicodeString APageNumber, const System::Types::TRectF &ARect, Vcl::Tmsfncpdfgraphicslib::_di_ITMSFNCCustomPDFGraphicsLib AGraphics);
...
__interface  INTERFACE_UUID("{69FD5F00-62C7-48D8-878A-B19F31C9537B}") ITMSFNCCustomPDFLib  : public System::IInterface 
{
	...
	virtual void __fastcall SetHeaderMargins(Vcl::Tmsfnctypes::TTMSFNCMargins* const Value) = 0 ;
	virtual void __fastcall SetFooterMargins(Vcl::Tmsfnctypes::TTMSFNCMargins* const Value) = 0 ;
	virtual void __fastcall SetPageNumberMargins(Vcl::Tmsfnctypes::TTMSFNCMargins* const Value) = 0 ;
	...
	virtual void __fastcall SetFooterAlignment(const Vcl::Tmsfncgraphicstypes::TTMSFNCGraphicsTextAlign Value) = 0 ;
	...
	virtual void __fastcall SetHeaderAlignment(const Vcl::Tmsfncgraphicstypes::TTMSFNCGraphicsTextAlign Value) = 0 ;
	...
	virtual void __fastcall SetPageNumberAlignment(const Vcl::Tmsfncgraphicstypes::TTMSFNCGraphicsTextAlign Value) = 0 ;
	...
	virtual void __fastcall SetFooterFont(Vcl::Tmsfncpdfcorelibbase::TTMSFNCPDFGraphicsLibFont* const Value) = 0 ;
	virtual void __fastcall SetHeaderFont(Vcl::Tmsfncpdfcorelibbase::TTMSFNCPDFGraphicsLibFont* const Value) = 0 ;
	...
	virtual void __fastcall SetPageNumberFont(Vcl::Tmsfncpdfcorelibbase::TTMSFNCPDFGraphicsLibFont* const Value) = 0 ;
	...
	virtual void __fastcall SetPDFGraphicsLib(const Vcl::Tmsfncpdfgraphicslib::_di_ITMSFNCCustomPDFGraphicsLib Value) = 0 ;
	virtual void __fastcall SetPDFGraphicsExLib(const Vcl::Tmsfncpdfgraphicslib::_di_ITMSFNCCustomPDFGraphicsExLib Value) = 0 ;
	virtual void __fastcall SetPDFInitializationLib(const Vcl::Tmsfncpdfgraphicslib::_di_ITMSFNCCustomPDFInitializationLib Value) = 0 ;
	virtual Vcl::Tmsfncpdfgraphicslib::_di_ITMSFNCCustomPDFGraphicsLib __fastcall GetPDFGraphicsLib() = 0 ;
	virtual Vcl::Tmsfncpdfgraphicslib::_di_ITMSFNCCustomPDFGraphicsExLib __fastcall GetPDFGraphicsExLib() = 0 ;
	virtual Vcl::Tmsfncpdfgraphicslib::_di_ITMSFNCCustomPDFInitializationLib __fastcall GetPDFInitializationLib() = 0 ;
	...
	virtual Vcl::Tmsfncgraphicstypes::TTMSFNCGraphicsTextAlign __fastcall GetFooterAlignment() = 0 ;
	virtual Vcl::Tmsfnctypes::TTMSFNCMargins* __fastcall GetFooterMargins() = 0 ;
	virtual float __fastcall GetFooterSize() = 0 ;
	virtual System::UnicodeString __fastcall GetHeader() = 0 ;
	virtual Vcl::Tmsfncgraphicstypes::TTMSFNCGraphicsTextAlign __fastcall GetHeaderAlignment() = 0 ;
	virtual Vcl::Tmsfnctypes::TTMSFNCMargins* __fastcall GetHeaderMargins() = 0 ;
	...
	virtual Vcl::Tmsfncgraphicstypes::TTMSFNCGraphicsTextAlign __fastcall GetPageNumberAlignment() = 0 ;
	virtual Vcl::Tmsfnctypes::TTMSFNCMargins* __fastcall GetPageNumberMargins() = 0 ;
	...
	virtual Vcl::Tmsfncpdfcorelibbase::TTMSFNCPDFGraphicsLibFont* __fastcall GetFooterFont() = 0 ;
	virtual Vcl::Tmsfncpdfcorelibbase::TTMSFNCPDFGraphicsLibFont* __fastcall GetHeaderFont() = 0 ;
	virtual Vcl::Tmsfncpdfcorelibbase::TTMSFNCPDFGraphicsLibFont* __fastcall GetPageNumberFont() = 0 ;
	...
	__property Vcl::Tmsfnctypes::TTMSFNCMargins* PageNumberMargins = {read=GetPageNumberMargins, write=SetPageNumberMargins};
	__property Vcl::Tmsfncgraphicstypes::TTMSFNCGraphicsTextAlign PageNumberAlignment = {read=GetPageNumberAlignment, write=SetPageNumberAlignment};
	__property Vcl::Tmsfncpdfcorelibbase::TTMSFNCPDFGraphicsLibFont* PageNumberFont = {read=GetPageNumberFont, write=SetPageNumberFont};
	...
	__property Vcl::Tmsfnctypes::TTMSFNCMargins* HeaderMargins = {read=GetHeaderMargins, write=SetHeaderMargins};
	__property Vcl::Tmsfncgraphicstypes::TTMSFNCGraphicsTextAlign HeaderAlignment = {read=GetHeaderAlignment, write=SetHeaderAlignment};
	__property Vcl::Tmsfncpdfcorelibbase::TTMSFNCPDFGraphicsLibFont* HeaderFont = {read=GetHeaderFont, write=SetHeaderFont};
	...
	__property Vcl::Tmsfnctypes::TTMSFNCMargins* FooterMargins = {read=GetFooterMargins, write=SetFooterMargins};
	__property Vcl::Tmsfncgraphicstypes::TTMSFNCGraphicsTextAlign FooterAlignment = {read=GetFooterAlignment, write=SetFooterAlignment};
	__property Vcl::Tmsfncpdfcorelibbase::TTMSFNCPDFGraphicsLibFont* FooterFont = {read=GetFooterFont, write=SetFooterFont};
	...
	__property Vcl::Tmsfncpdfgraphicslib::_di_ITMSFNCCustomPDFGraphicsLib Graphics = {read=GetPDFGraphicsLib, write=SetPDFGraphicsLib};
	__property Vcl::Tmsfncpdfgraphicslib::_di_ITMSFNCCustomPDFGraphicsExLib GraphicsEx = {read=GetPDFGraphicsExLib, write=SetPDFGraphicsExLib};
	__property Vcl::Tmsfncpdfgraphicslib::_di_ITMSFNCCustomPDFInitializationLib Initialization = {read=GetPDFInitializationLib, write=SetPDFInitializationLib};
...
class PASCALIMPLEMENTATION TTMSFNCCustomPDFLib : public Vcl::Tmsfnccustomcomponent::TTMSFNCCustomComponent
{
	typedef Vcl::Tmsfnccustomcomponent::TTMSFNCCustomComponent inherited;
	
private:
	_di_ITMSFNCCustomPDFLib FPDFLib;
	Vcl::Tmsfncpdfgraphicslib::TTMSFNCPDFGraphicsLib* FPDFGraphicsLib;
	...
	void __fastcall SetFooterAlignment(const Vcl::Tmsfncgraphicstypes::TTMSFNCGraphicsTextAlign Value);
	void __fastcall SetFooterSize(const float Value);
	void __fastcall SetHeader(const System::UnicodeString Value);
	void __fastcall SetHeaderAlignment(const Vcl::Tmsfncgraphicstypes::TTMSFNCGraphicsTextAlign Value);
	...
	void __fastcall SetFooterFont(Vcl::Tmsfncpdfcorelibbase::TTMSFNCPDFGraphicsLibFont* const Value);
	void __fastcall SetHeaderFont(Vcl::Tmsfncpdfcorelibbase::TTMSFNCPDFGraphicsLibFont* const Value);
	...
	Vcl::Tmsfncgraphicstypes::TTMSFNCGraphicsTextAlign __fastcall GetFooterAlignment();
	Vcl::Tmsfnctypes::TTMSFNCMargins* __fastcall GetFooterMargins();
	float __fastcall GetFooterSize();
	System::UnicodeString __fastcall GetHeader();
	Vcl::Tmsfncgraphicstypes::TTMSFNCGraphicsTextAlign __fastcall GetHeaderAlignment();
	Vcl::Tmsfnctypes::TTMSFNCMargins* __fastcall GetHeaderMargins();
	...
	Vcl::Tmsfncpdfcorelibbase::TTMSFNCPDFGraphicsLibFont* __fastcall GetFooterFont();
	Vcl::Tmsfncpdfcorelibbase::TTMSFNCPDFGraphicsLibFont* __fastcall GetHeaderFont();
	...
	Vcl::Tmsfncgraphicstypes::TTMSFNCGraphicsTextAlign __fastcall GetPageNumberAlignment();
	Vcl::Tmsfncpdfcorelibbase::TTMSFNCPDFGraphicsLibFont* __fastcall GetPageNumberFont();
	System::UnicodeString __fastcall GetPageNumberFormat();
	Vcl::Tmsfnctypes::TTMSFNCMargins* __fastcall GetPageNumberMargins();
	float __fastcall GetPageNumberSize();
	void __fastcall SetPageNumber(const TTMSFNCPDFLibPageNumber Value);
	void __fastcall SetPageNumberAlignment(const Vcl::Tmsfncgraphicstypes::TTMSFNCGraphicsTextAlign Value);
	void __fastcall SetPageNumberFont(Vcl::Tmsfncpdfcorelibbase::TTMSFNCPDFGraphicsLibFont* const Value);
...
protected:
	...
	Vcl::Tmsfncpdfrichtextlib::_di_ITMSFNCCustomPDFRichTextLib __fastcall RichText();
	bool __fastcall UnlockWithPassword(System::UnicodeString Password);
	bool __fastcall IsDocumentOpened();
	Vcl::Tmsfncpdfgraphicslib::_di_ITMSFNCCustomPDFInitializationLib __fastcall Initialization();
...
public:
	...
	Vcl::Tmsfncpdfgraphicslib::_di_ITMSFNCCustomPDFGraphicsLib __fastcall Graphics();
	...
	__property float HeaderSize = {read=GetHeaderSize, write=SetHeaderSize};
	__property Vcl::Tmsfnctypes::TTMSFNCMargins* HeaderMargins = {read=GetHeaderMargins, write=SetHeaderMargins};
	__property Vcl::Tmsfncgraphicstypes::TTMSFNCGraphicsTextAlign HeaderAlignment = {read=GetHeaderAlignment, write=SetHeaderAlignment, default=0};
	__property Vcl::Tmsfncpdfcorelibbase::TTMSFNCPDFGraphicsLibFont* HeaderFont = {read=GetHeaderFont, write=SetHeaderFont};
	__property TTMSFNCPDFLibPageNumber PageNumber = {read=GetPageNumber, write=SetPageNumber, nodefault};
	__property System::UnicodeString PageNumberFormat = {read=GetPageNumberFormat, write=SetPageNumberFormat};
	__property float PageNumberSize = {read=GetPageNumberSize, write=SetPageNumberSize};
	__property Vcl::Tmsfnctypes::TTMSFNCMargins* PageNumberMargins = {read=GetPageNumberMargins, write=SetPageNumberMargins};
	__property Vcl::Tmsfncgraphicstypes::TTMSFNCGraphicsTextAlign PageNumberAlignment = {read=GetPageNumberAlignment, write=SetPageNumberAlignment, default=0};
	__property Vcl::Tmsfncpdfcorelibbase::TTMSFNCPDFGraphicsLibFont* PageNumberFont = {read=GetPageNumberFont, write=SetPageNumberFont};
	__property System::UnicodeString Footer = {read=GetFooter, write=SetFooter};
	__property float FooterSize = {read=GetFooterSize, write=SetFooterSize};
	__property Vcl::Tmsfnctypes::TTMSFNCMargins* FooterMargins = {read=GetFooterMargins, write=SetFooterMargins};
	__property Vcl::Tmsfncgraphicstypes::TTMSFNCGraphicsTextAlign FooterAlignment = {read=GetFooterAlignment, write=SetFooterAlignment, default=0};
	__property Vcl::Tmsfncpdfcorelibbase::TTMSFNCPDFGraphicsLibFont* FooterFont = {read=GetFooterFont, write=SetFooterFont};
	__property System::UnicodeString Title = {read=GetTitle, write=SetTitle};
	__property System::UnicodeString Subject = {read=GetSubject, write=SetSubject};
	__property System::Classes::TStrings* Keywords = {read=GetKeywords, write=SetKeywords};
	...
	__property Vcl::Tmsfncbitmapcontainer::TTMSFNCBitmapContainer* BitmapContainer = {read=GetBitmapContainer, write=SetBitmapContainer};
public:
	/* TWinControl.CreateParented */ inline __fastcall TTMSFNCCustomPDFLib(HWND ParentWindow) : Vcl::Tmsfnccustomcomponent::TTMSFNCCustomComponent(ParentWindow) { }
...
public:
	/* {System_Generics_Collections}TList<VCL_TMSFNCPDFLib_ITMSFNCCustomPDFLib>.Create */ inline __fastcall TTMSFNCPDFLibList()/* overload */ : System::Generics::Collections::TList__1<_di_ITMSFNCCustomPDFLib>() { }
	/* {System_Generics_Collections}TList<VCL_TMSFNCPDFLib_ITMSFNCCustomPDFLib>.Create */ inline __fastcall TTMSFNCPDFLibList(const System::DelphiInterface<System::Generics::Defaults::IComparer__1<_di_ITMSFNCCustomPDFLib> > AComparer)/* overload */ : System::Generics::Collections::TList__1<_di_ITMSFNCCustomPDFLib>(AComparer) { }
	/* {System_Generics_Collections}TList<VCL_TMSFNCPDFLib_ITMSFNCCustomPDFLib>.Create */ inline __fastcall TTMSFNCPDFLibList(System::Generics::Collections::TEnumerable__1<_di_ITMSFNCCustomPDFLib>* const Collection)/* overload */ : System::Generics::Collections::TList__1<_di_ITMSFNCCustomPDFLib>(Collection) { }
	/* {System_Generics_Collections}TList<VCL_TMSFNCPDFLib_ITMSFNCCustomPDFLib>.Create */ inline __fastcall TTMSFNCPDFLibList(const _di_ITMSFNCCustomPDFLib *Values, const int Values_High)/* overload */ : System::Generics::Collections::TList__1<_di_ITMSFNCCustomPDFLib>(Values, Values_High) { }
	/* {System_Generics_Collections}TList<VCL_TMSFNCPDFLib_ITMSFNCCustomPDFLib>.Destroy */ inline __fastcall virtual ~TTMSFNCPDFLibList() { }
...
public:
	/* TWinControl.CreateParented */ inline __fastcall TTMSFNCPDFLib(HWND ParentWindow) : TTMSFNCCustomPDFLib(ParentWindow) { }
	
};


//-- var, const, procedure ---------------------------------------------------
#define TTMSFNCPDFLibDocURL L"https://download.tmssoftware.com/doc/tmsfnccore/components"\
	L"/pdflibrary/"
...
#define Vcl_Tmsfncpdflib_sTMSFNCPDFLibNoPages System::LoadResourceString(&Vcl::Tmsfncpdflib::_sTMSFNCPDFLibNoPages)
