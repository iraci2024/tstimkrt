...
// (DO NOT EDIT: machine generated header) 'VCL.TMSFNCGDIPlusApi.pas' rev: 35.00 (Windows)

#ifndef Vcl_TmsfncgdiplusapiHPP
#define Vcl_TmsfncgdiplusapiHPP
...
__interface DELPHIINTERFACE IImageBytes;
...
public:
	...
	System::LongBool __fastcall IsWmf();
	System::LongBool __fastcall IsWmfPlaceable();
	System::LongBool __fastcall IsEmf();
	System::LongBool __fastcall IsEmfOrEmfPlus();
	System::LongBool __fastcall IsEmfPlus();
	System::LongBool __fastcall IsEmfPlusDual();
	System::LongBool __fastcall IsEmfPlusOnly();
	System::LongBool __fastcall IsDisplay();
	Winapi::Windows::PMetaHeader __fastcall GetWmfHeader();
	PENHMETAHEADER3 __fastcall GetEmfHeader();
public:
	/* TObject.Create */ inline __fastcall TMetafileHeader() : System::TObject() { }
	/* TObject.Destroy */ inline __fastcall virtual ~TMetafileHeader() { }
...
static const double FLT_MAX = 3.402823E+38;
static const double FLT_MIN = 1.175494E-38;
static const double REAL_MAX = 3.402823E+38;
static const double REAL_MIN = 1.175494E-38;
static const double REAL_TOLERANCE = 1.175494E-36;
static const double REAL_EPSILON = 1.192093E-07;
...
extern DELPHI_PACKAGE Status __stdcall (*GdipAddPathPath)(void * path, void * addingPath, System::LongBool connect);
...
extern DELPHI_PACKAGE Status __stdcall (*GdipIsVisiblePathPoint)(void * path, float x, float y, void * graphics, /* out */ System::LongBool &result);
extern DELPHI_PACKAGE Status __stdcall (*GdipIsVisiblePathPointI)(void * path, int x, int y, void * graphics, /* out */ System::LongBool &result);
extern DELPHI_PACKAGE Status __stdcall (*GdipIsOutlineVisiblePathPoint)(void * path, float x, float y, void * pen, void * graphics, /* out */ System::LongBool &result);
extern DELPHI_PACKAGE Status __stdcall (*GdipIsOutlineVisiblePathPointI)(void * path, int x, int y, void * pen, void * graphics, /* out */ System::LongBool &result);
...
extern DELPHI_PACKAGE Status __stdcall (*GdipPathIterNextSubpath)(void * iterator, int &resultCount, int &startIndex, int &endIndex, /* out */ System::LongBool &isClosed);
extern DELPHI_PACKAGE Status __stdcall (*GdipPathIterNextSubpathPath)(void * iterator, int &resultCount, void * path, /* out */ System::LongBool &isClosed);
...
extern DELPHI_PACKAGE Status __stdcall (*GdipPathIterIsValid)(void * iterator, /* out */ System::LongBool &valid);
extern DELPHI_PACKAGE Status __stdcall (*GdipPathIterHasCurve)(void * iterator, /* out */ System::LongBool &hasCurve);
...
extern DELPHI_PACKAGE Status __stdcall (*GdipIsMatrixInvertible)(void * matrix, /* out */ System::LongBool &result);
extern DELPHI_PACKAGE Status __stdcall (*GdipIsMatrixIdentity)(void * matrix, /* out */ System::LongBool &result);
extern DELPHI_PACKAGE Status __stdcall (*GdipIsMatrixEqual)(void * matrix, void * matrix2, /* out */ System::LongBool &result);
...
extern DELPHI_PACKAGE Status __stdcall (*GdipIsEmptyRegion)(void * region, void * graphics, /* out */ System::LongBool &result);
extern DELPHI_PACKAGE Status __stdcall (*GdipIsInfiniteRegion)(void * region, void * graphics, /* out */ System::LongBool &result);
extern DELPHI_PACKAGE Status __stdcall (*GdipIsEqualRegion)(void * region, void * region2, void * graphics, /* out */ System::LongBool &result);
...
extern DELPHI_PACKAGE Status __stdcall (*GdipIsVisibleRegionPoint)(void * region, float x, float y, void * graphics, /* out */ System::LongBool &result);
extern DELPHI_PACKAGE Status __stdcall (*GdipIsVisibleRegionPointI)(void * region, int x, int y, void * graphics, /* out */ System::LongBool &result);
extern DELPHI_PACKAGE Status __stdcall (*GdipIsVisibleRegionRect)(void * region, float x, float y, float width, float height, void * graphics, /* out */ System::LongBool &result);
extern DELPHI_PACKAGE Status __stdcall (*GdipIsVisibleRegionRectI)(void * region, int x, int y, int width, int height, void * graphics, /* out */ System::LongBool &result);
...
extern DELPHI_PACKAGE Status __stdcall (*GdipCreateLineBrushFromRectWithAngle)(PGPRectF rect, unsigned color1, unsigned color2, float angle, System::LongBool isAngleScalable, WrapMode wrapMode, /* out */ void * &lineGradient);
extern DELPHI_PACKAGE Status __stdcall (*GdipCreateLineBrushFromRectWithAngleI)(PGPRect rect, unsigned color1, unsigned color2, float angle, System::LongBool isAngleScalable, WrapMode wrapMode, /* out */ void * &lineGradient);
...
extern DELPHI_PACKAGE Status __stdcall (*GdipSetLineGammaCorrection)(void * brush, System::LongBool useGammaCorrection);
extern DELPHI_PACKAGE Status __stdcall (*GdipGetLineGammaCorrection)(void * brush, /* out */ System::LongBool &useGammaCorrection);
...
extern DELPHI_PACKAGE Status __stdcall (*GdipSetPathGradientGammaCorrection)(void * brush, System::LongBool useGammaCorrection);
extern DELPHI_PACKAGE Status __stdcall (*GdipGetPathGradientGammaCorrection)(void * brush, System::LongBool &useGammaCorrection);
...
extern DELPHI_PACKAGE Status __stdcall (*GdipCreateAdjustableArrowCap)(float height, float width, System::LongBool isFilled, /* out */ void * &cap);
...
extern DELPHI_PACKAGE Status __stdcall (*GdipSetAdjustableArrowCapFillState)(void * cap, System::LongBool fillState);
extern DELPHI_PACKAGE Status __stdcall (*GdipGetAdjustableArrowCapFillState)(void * cap, System::LongBool &fillState);
...
extern DELPHI_PACKAGE Status __stdcall (*GdipSetImageAttributesColorMatrix)(void * imageattr, ColorAdjustType type_, System::LongBool enableFlag, PColorMatrix colorMatrix, PColorMatrix grayMatrix, ColorMatrixFlags flags);
extern DELPHI_PACKAGE Status __stdcall (*GdipSetImageAttributesThreshold)(void * imageattr, ColorAdjustType type_, System::LongBool enableFlag, float threshold);
extern DELPHI_PACKAGE Status __stdcall (*GdipSetImageAttributesGamma)(void * imageattr, ColorAdjustType type_, System::LongBool enableFlag, float gamma);
extern DELPHI_PACKAGE Status __stdcall (*GdipSetImageAttributesNoOp)(void * imageattr, ColorAdjustType type_, System::LongBool enableFlag);
extern DELPHI_PACKAGE Status __stdcall (*GdipSetImageAttributesColorKeys)(void * imageattr, ColorAdjustType type_, System::LongBool enableFlag, unsigned colorLow, unsigned colorHigh);
extern DELPHI_PACKAGE Status __stdcall (*GdipSetImageAttributesOutputChannel)(void * imageattr, ColorAdjustType type_, System::LongBool enableFlag, ColorChannelFlags channelFlags);
extern DELPHI_PACKAGE Status __stdcall (*GdipSetImageAttributesOutputChannelColorProfile)(void * imageattr, ColorAdjustType type_, System::LongBool enableFlag, System::WideChar * colorProfileFilename);
extern DELPHI_PACKAGE Status __stdcall (*GdipSetImageAttributesRemapTable)(void * imageattr, ColorAdjustType type_, System::LongBool enableFlag, unsigned mapSize, PColorMap map);
extern DELPHI_PACKAGE Status __stdcall (*GdipSetImageAttributesWrapMode)(void * imageAttr, WrapMode wrap, unsigned argb, System::LongBool clamp);
extern DELPHI_PACKAGE Status __stdcall (*GdipSetImageAttributesICMMode)(void * imageAttr, System::LongBool on_);
...
extern DELPHI_PACKAGE Status __stdcall (*GdipIsVisibleClipEmpty)(void * graphics, System::LongBool &result);
extern DELPHI_PACKAGE Status __stdcall (*GdipIsVisiblePoint)(void * graphics, float x, float y, System::LongBool &result);
extern DELPHI_PACKAGE Status __stdcall (*GdipIsVisiblePointI)(void * graphics, int x, int y, System::LongBool &result);
extern DELPHI_PACKAGE Status __stdcall (*GdipIsVisibleRect)(void * graphics, float x, float y, float width, float height, System::LongBool &result);
extern DELPHI_PACKAGE Status __stdcall (*GdipIsVisibleRectI)(void * graphics, int x, int y, int width, int height, System::LongBool &result);
...
extern DELPHI_PACKAGE Status __stdcall (*GdipCreateMetafileFromWmf)(HMETAFILE hWmf, System::LongBool deleteWmf, PWmfPlaceableFileHeader wmfPlaceableFileHeader, /* out */ void * &metafile);
extern DELPHI_PACKAGE Status __stdcall (*GdipCreateMetafileFromEmf)(HENHMETAFILE hEmf, System::LongBool deleteEmf, /* out */ void * &metafile);
...
extern DELPHI_PACKAGE Status __stdcall (*GdipIsStyleAvailable)(void * family, int style, System::LongBool &IsStyleAvailable);
...
extern DELPHI_PACKAGE NativeUInt GdipLibrary;
extern DELPHI_PACKAGE System::LongBool __fastcall ObjectTypeIsValid(ObjectType type_);
...
extern DELPHI_PACKAGE System::LongBool __fastcall GDIP_IS_WMF_RECORDTYPE(int n);
...
extern DELPHI_PACKAGE System::LongBool __fastcall IsIndexedPixelFormat(int pixfmt);
extern DELPHI_PACKAGE System::LongBool __fastcall IsAlphaPixelFormat(int pixfmt);
extern DELPHI_PACKAGE System::LongBool __fastcall IsExtendedPixelFormat(int pixfmt);
extern DELPHI_PACKAGE System::LongBool __fastcall IsCanonicalPixelFormat(int pixfmt);
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_VCL_TMSFNCGDIPLUSAPI)
using namespace Vcl::Tmsfncgdiplusapi;
#endif
