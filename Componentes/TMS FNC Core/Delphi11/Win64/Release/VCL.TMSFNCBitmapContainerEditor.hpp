...
// (DO NOT EDIT: machine generated header) 'VCL.TMSFNCBitmapContainerEditor.pas' rev: 35.00 (Windows)

#ifndef Vcl_TmsfncbitmapcontainereditorHPP
#define Vcl_TmsfncbitmapcontainereditorHPP
...
#include <VCL.TMSFNCURLBitmapContainer.hpp>
...
//-- type declarations -------------------------------------------------------
typedef Vcl::Controls::TWinControl TTMSFNCBitmapContainerEditorParent;

class PASCALIMPLEMENTATION TTMSFNCBitmapContainerEditorComboBox : public Vcl::Stdctrls::TComboBox
{
	typedef Vcl::Stdctrls::TComboBox inherited;
	
public:
	/* TCustomComboBox.Create */ inline __fastcall virtual TTMSFNCBitmapContainerEditorComboBox(System::Classes::TComponent* AOwner) : Vcl::Stdctrls::TComboBox(AOwner) { }
	/* TCustomComboBox.Destroy */ inline __fastcall virtual ~TTMSFNCBitmapContainerEditorComboBox() { }
	
public:
	/* TWinControl.CreateParented */ inline __fastcall TTMSFNCBitmapContainerEditorComboBox(HWND ParentWindow) : Vcl::Stdctrls::TComboBox(ParentWindow) { }
	
};


class PASCALIMPLEMENTATION TTMSFNCBitmapContainerEditor : public Vcl::Tmsfnccustomcomponent::TTMSFNCCustomComponent
{
...
private:
	...
	Vcl::Tmsfnceditorpanel::TTMSFNCEditorPanel* FListPanel;
	Vcl::Tmsfnceditorpanel::TTMSFNCEditorPanel* FTopPanel;
	Vcl::Tmsfncbitmapcontainer::TTMSFNCBitmapContainer* FCopyBitmapContainer;
	Vcl::Tmsfnceditorbutton::TTMSFNCEditorButton* FButtonOk;
	Vcl::Tmsfnceditorbutton::TTMSFNCEditorButton* FButtonCancel;
	Vcl::Tmsfnceditorbutton::TTMSFNCEditorButton* FButtonFill;
	Vcl::Tmsfnceditorbutton::TTMSFNCEditorButton* FButtonAppend;
	...
	Vcl::Tmsfnceditorbutton::TTMSFNCEditorButton* FButtonDuplicate;
	Vcl::Tmsfnceditorlistview::TTMSFNCBitmapEditorListView* FBitmapList;
	...
	void __fastcall SetBitmapItemProperties(Vcl::Tmsfncbitmapcontainer::TTMSFNCBitmapItem* AFrom, Vcl::Tmsfncbitmapcontainer::TTMSFNCBitmapItem* ATo)/* overload */;
	void __fastcall SetBitmapItemProperties(Vcl::Tmsfnceditorlistview::TTMSFNCEditorListItem* AFrom, Vcl::Tmsfncbitmapcontainer::TTMSFNCBitmapItem* ATo)/* overload */;
	void __fastcall SetEditorListItemProperties(Vcl::Tmsfncbitmapcontainer::TTMSFNCBitmapItem* AFrom, Vcl::Tmsfnceditorlistview::TTMSFNCEditorListItem* ATo);
	void __fastcall SetItemButtonAppearance(Vcl::Tmsfnceditorbutton::TTMSFNCEditorButton* AButton);
	void __fastcall SetActionButtonAppearance(Vcl::Tmsfnceditorbutton::TTMSFNCEditorButton* AButton);
...
protected:
	...
	void __fastcall DoBitmapListItemSelectChanged(System::TObject* Sender, int AIndex, Vcl::Tmsfnceditorlistview::TTMSFNCEditorListItem* AItem, bool ASelected);
	...
	virtual void __fastcall SetControlProperties(Vcl::Controls::TWinControl* AParent);
...
public:
	/* TWinControl.CreateParented */ inline __fastcall TTMSFNCBitmapContainerEditor(HWND ParentWindow) : Vcl::Tmsfnccustomcomponent::TTMSFNCCustomComponent(ParentWindow) { }
	
};


class PASCALIMPLEMENTATION TTMSFNCBitmapContainerEditorForm : public Vcl::Tmsfnccustomcontrol::TTMSFNCCustomDesignerForm
{
	typedef Vcl::Tmsfnccustomcontrol::TTMSFNCCustomDesignerForm inherited;
	
public:
	/* TCustomForm.Create */ inline __fastcall virtual TTMSFNCBitmapContainerEditorForm(System::Classes::TComponent* AOwner) : Vcl::Tmsfnccustomcontrol::TTMSFNCCustomDesignerForm(AOwner) { }
	/* TCustomForm.CreateNew */ inline __fastcall virtual TTMSFNCBitmapContainerEditorForm(System::Classes::TComponent* AOwner, int Dummy) : Vcl::Tmsfnccustomcontrol::TTMSFNCCustomDesignerForm(AOwner, Dummy) { }
	/* TCustomForm.Destroy */ inline __fastcall virtual ~TTMSFNCBitmapContainerEditorForm() { }
	
public:
	/* TWinControl.CreateParented */ inline __fastcall TTMSFNCBitmapContainerEditorForm(HWND ParentWindow) : Vcl::Tmsfnccustomcontrol::TTMSFNCCustomDesignerForm(ParentWindow) { }
...
#define Vcl_Tmsfncbitmapcontainereditor_sTMSFNCBitmapContainerEditorOK System::LoadResourceString(&Vcl::Tmsfncbitmapcontainereditor::_sTMSFNCBitmapContainerEditorOK)
extern DELPHI_PACKAGE System::ResourceString _sTMSFNCBitmapContainerEditorCancel;
#define Vcl_Tmsfncbitmapcontainereditor_sTMSFNCBitmapContainerEditorCancel System::LoadResourceString(&Vcl::Tmsfncbitmapcontainereditor::_sTMSFNCBitmapContainerEditorCancel)
extern DELPHI_PACKAGE System::ResourceString _sTMSFNCBitmapContainerEditorFill;
#define Vcl_Tmsfncbitmapcontainereditor_sTMSFNCBitmapContainerEditorFill System::LoadResourceString(&Vcl::Tmsfncbitmapcontainereditor::_sTMSFNCBitmapContainerEditorFill)
extern DELPHI_PACKAGE System::ResourceString _sTMSFNCBitmapContainerEditorAppend;
#define Vcl_Tmsfncbitmapcontainereditor_sTMSFNCBitmapContainerEditorAppend System::LoadResourceString(&Vcl::Tmsfncbitmapcontainereditor::_sTMSFNCBitmapContainerEditorAppend)
extern DELPHI_PACKAGE System::ResourceString _sTMSFNCBitmapContainerEditorClear;
#define Vcl_Tmsfncbitmapcontainereditor_sTMSFNCBitmapContainerEditorClear System::LoadResourceString(&Vcl::Tmsfncbitmapcontainereditor::_sTMSFNCBitmapContainerEditorClear)
extern DELPHI_PACKAGE System::ResourceString _sTMSFNCBitmapContainerEditorFillHint;
#define Vcl_Tmsfncbitmapcontainereditor_sTMSFNCBitmapContainerEditorFillHint System::LoadResourceString(&Vcl::Tmsfncbitmapcontainereditor::_sTMSFNCBitmapContainerEditorFillHint)
extern DELPHI_PACKAGE System::ResourceString _sTMSFNCBitmapContainerEditorAppendHint;
#define Vcl_Tmsfncbitmapcontainereditor_sTMSFNCBitmapContainerEditorAppendHint System::LoadResourceString(&Vcl::Tmsfncbitmapcontainereditor::_sTMSFNCBitmapContainerEditorAppendHint)
extern DELPHI_PACKAGE System::ResourceString _sTMSFNCBitmapContainerEditorClearHint;
#define Vcl_Tmsfncbitmapcontainereditor_sTMSFNCBitmapContainerEditorClearHint System::LoadResourceString(&Vcl::Tmsfncbitmapcontainereditor::_sTMSFNCBitmapContainerEditorClearHint)
extern DELPHI_PACKAGE System::ResourceString _sTMSFNCBitmapContainerEditorDeleteHint;
#define Vcl_Tmsfncbitmapcontainereditor_sTMSFNCBitmapContainerEditorDeleteHint System::LoadResourceString(&Vcl::Tmsfncbitmapcontainereditor::_sTMSFNCBitmapContainerEditorDeleteHint)
extern DELPHI_PACKAGE System::ResourceString _sTMSFNCBitmapContainerEditorAddHint;
#define Vcl_Tmsfncbitmapcontainereditor_sTMSFNCBitmapContainerEditorAddHint System::LoadResourceString(&Vcl::Tmsfncbitmapcontainereditor::_sTMSFNCBitmapContainerEditorAddHint)
extern DELPHI_PACKAGE System::ResourceString _sTMSFNCBitmapContainerEditorDuplicateHint;
#define Vcl_Tmsfncbitmapcontainereditor_sTMSFNCBitmapContainerEditorDuplicateHint System::LoadResourceString(&Vcl::Tmsfncbitmapcontainereditor::_sTMSFNCBitmapContainerEditorDuplicateHint)
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_VCL_TMSFNCBITMAPCONTAINEREDITOR)
using namespace Vcl::Tmsfncbitmapcontainereditor;
#endif
...
//-- end unit ----------------------------------------------------------------
#endif	// Vcl_TmsfncbitmapcontainereditorHPP
