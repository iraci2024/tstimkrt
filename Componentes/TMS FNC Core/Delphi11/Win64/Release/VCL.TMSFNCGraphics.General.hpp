...
// (DO NOT EDIT: machine generated header) 'VCL.TMSFNCGraphics.General.pas' rev: 35.00 (Windows)

#ifndef Vcl_Tmsfncgraphics_GeneralHPP
#define Vcl_Tmsfncgraphics_GeneralHPP
...
//-- type declarations -------------------------------------------------------
class PASCALIMPLEMENTATION TTMSFNCGraphicsContextGeneral : public Vcl::Tmsfncgraphics::TTMSFNCGraphicsContext
{
...
private:
	...
	NativeUInt FOldPenHandle;
	Vcl::Graphics::TPenStyle FOldPenStyle;
	int FOldPenWidth;
	
protected:
	virtual void * __fastcall GetNativeCanvas();
	void __fastcall DrawRotatedText(Vcl::Graphics::TCanvas* ACanvas, const System::Types::TRect &ARect, System::UnicodeString AText, float AAngle, Vcl::Tmsfncgraphicstypes::TTMSFNCGraphicsTextAlign AHorizontalAlign, Vcl::Tmsfncgraphicstypes::TTMSFNCGraphicsTextAlign AVerticalAlign);
...
public:
	/* TTMSFNCGraphicsContext.Create */ inline __fastcall virtual TTMSFNCGraphicsContextGeneral(Vcl::Tmsfncgraphics::TTMSFNCGraphics* const AGraphics) : Vcl::Tmsfncgraphics::TTMSFNCGraphicsContext(AGraphics) { }
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_VCL_TMSFNCGRAPHICS_GENERAL)
using namespace Vcl::Tmsfncgraphics::General;
#endif
...
//-- end unit ----------------------------------------------------------------
#endif	// Vcl_Tmsfncgraphics_GeneralHPP
