...
// (DO NOT EDIT: machine generated header) 'FMX.TMSFNCWebBrowser.Win.pas' rev: 35.00 (Windows)

#ifndef Fmx_Tmsfncwebbrowser_WinHPP
#define Fmx_Tmsfncwebbrowser_WinHPP
...
__interface  INTERFACE_UUID("{4D00C0D1-9434-4EB6-8078-8697A560334F}") ICoreWebView2Controller  : public System::IInterface 
{
	...
	virtual HRESULT __stdcall put_Bounds(const System::Types::TRect &bounds) = 0 ;
...
#define CoreWebView2DLL L"WebView2Loader_x64.dll"
...
#define EErrorMessageNoDLL L"Could not initialize Edge Chromium! Please check if WebVie"\
	L"w2Loader_x64.dll is correctly distributed and accessible."
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_FMX_TMSFNCWEBBROWSER_WIN)
using namespace Fmx::Tmsfncwebbrowser::Win;
#endif
...
//-- end unit ----------------------------------------------------------------
#endif	// Fmx_Tmsfncwebbrowser_WinHPP
