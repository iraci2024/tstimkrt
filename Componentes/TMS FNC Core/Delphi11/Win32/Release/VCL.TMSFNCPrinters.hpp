...
// (DO NOT EDIT: machine generated header) 'VCL.TMSFNCPrinters.pas' rev: 35.00 (Windows)

#ifndef Vcl_TmsfncprintersHPP
#define Vcl_TmsfncprintersHPP
...
private:
	Vcl::Tmsfncgraphics::TTMSFNCGraphics* FGraphics;
...
public:
	...
	__property Vcl::Tmsfncgraphics::TTMSFNCGraphics* Graphics = {read=FGraphics};
...
static const System::Int8 PRINTDPI = System::Int8(0x64);
extern DELPHI_PACKAGE TTMSFNCPrinter* __fastcall TMSFNCPrinter(void);
}	/* namespace Tmsfncprinters */
}	/* namespace Vcl */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_VCL_TMSFNCPRINTERS)
using namespace Vcl::Tmsfncprinters;
#endif
