...
// (DO NOT EDIT: machine generated header) 'VCL.TMSFNCDataBindingEditorDE.pas' rev: 35.00 (Windows)

#ifndef Vcl_TmsfncdatabindingeditordeHPP
#define Vcl_TmsfncdatabindingeditordeHPP
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_VCL_TMSFNCDATABINDINGEDITORDE)
using namespace Vcl::Tmsfncdatabindingeditorde;
#endif
...
//-- end unit ----------------------------------------------------------------
#endif	// Vcl_TmsfncdatabindingeditordeHPP
