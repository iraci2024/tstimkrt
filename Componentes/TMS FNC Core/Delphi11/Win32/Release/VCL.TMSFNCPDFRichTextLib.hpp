...
// (DO NOT EDIT: machine generated header) 'VCL.TMSFNCPDFRichTextLib.pas' rev: 35.00 (Windows)

#ifndef Vcl_TmsfncpdfrichtextlibHPP
#define Vcl_TmsfncpdfrichtextlibHPP
...
public:
	float Location;
	Vcl::Tmsfncgraphicstypes::TTMSFNCGraphicsTextAlign Alignment;
};
...
public:
	/* {System_Generics_Collections}TList<VCL_TMSFNCPDFRichTextLib_TTMSFNCPDFRichTextLibTabStop>.Create */ inline __fastcall TTMSFNCPDFRichTextLibTabStops()/* overload */ : System::Generics::Collections::TList__1<TTMSFNCPDFRichTextLibTabStop>() { }
	/* {System_Generics_Collections}TList<VCL_TMSFNCPDFRichTextLib_TTMSFNCPDFRichTextLibTabStop>.Create */ inline __fastcall TTMSFNCPDFRichTextLibTabStops(const System::DelphiInterface<System::Generics::Defaults::IComparer__1<TTMSFNCPDFRichTextLibTabStop> > AComparer)/* overload */ : System::Generics::Collections::TList__1<TTMSFNCPDFRichTextLibTabStop>(AComparer) { }
	...
	/* {System_Generics_Collections}TList<VCL_TMSFNCPDFRichTextLib_TTMSFNCPDFRichTextLibTabStop>.Create */ inline __fastcall TTMSFNCPDFRichTextLibTabStops(const TTMSFNCPDFRichTextLibTabStop *Values, const int Values_High)/* overload */ : System::Generics::Collections::TList__1<TTMSFNCPDFRichTextLibTabStop>(Values, Values_High) { }
	/* {System_Generics_Collections}TList<VCL_TMSFNCPDFRichTextLib_TTMSFNCPDFRichTextLibTabStop>.Destroy */ inline __fastcall virtual ~TTMSFNCPDFRichTextLibTabStops() { }
...
public:
	...
	Vcl::Tmsfncpdfcorelibbase::TTMSFNCPDFGraphicsLibLineBreakMode LineBreakMode;
...
public:
	...
	Vcl::Tmsfnctypes::TTMSFNCBitmap* Bitmap;
	...
	System::Uitypes::TColor StrikethroughColor;
	float BaselineOffset;
	System::Uitypes::TColor StrokeColor;
	float StrokeWidth;
...
__interface  INTERFACE_UUID("{E4E9AE27-E487-4D46-BA6C-33B6BA6E54E4}") ITMSFNCCustomPDFRichTextLib  : public System::IInterface 
{
	...
	virtual int __fastcall Draw(Vcl::Tmsfncpdfcorelibbase::TTMSFNCPDFGraphicsLibRectArray Rects, float Padding = 5.000000E+00f, bool DetectOverflow = false) = 0 /* overload */;
	...
	virtual void __fastcall AddBitmap(Vcl::Tmsfnctypes::TTMSFNCBitmap* AValue, float ALineHeight = -1.000000E+00f, int ALocation = 0xffffffff) = 0 ;
	...
	virtual System::Uitypes::TColor __fastcall GetStrokeColor(int AStart = 0xffffffff, int ALength = 0xffffffff) = 0 ;
	virtual void __fastcall SetStrokeColor(System::Uitypes::TColor AValue, int AStart = 0xffffffff, int ALength = 0xffffffff) = 0 ;
	...
	virtual System::Uitypes::TColor __fastcall GetUnderlineColor(int AStart = 0xffffffff, int ALength = 0xffffffff) = 0 ;
	virtual void __fastcall SetUnderlineColor(System::Uitypes::TColor AValue, int AStart = 0xffffffff, int ALength = 0xffffffff) = 0 ;
	...
	virtual System::Uitypes::TColor __fastcall GetStrikethroughColor(int AStart = 0xffffffff, int ALength = 0xffffffff) = 0 ;
	virtual void __fastcall SetStrikethroughColor(System::Uitypes::TColor AValue, int AStart = 0xffffffff, int ALength = 0xffffffff) = 0 ;
	...
	virtual System::Uitypes::TColor __fastcall GetBackgroundColor(int AStart = 0xffffffff, int ALength = 0xffffffff) = 0 ;
	virtual void __fastcall SetBackgroundColor(System::Uitypes::TColor AColor, int AStart = 0xffffffff, int ALength = 0xffffffff) = 0 ;
	virtual System::Uitypes::TColor __fastcall GetForegroundColor(int AStart = 0xffffffff, int ALength = 0xffffffff) = 0 ;
	virtual void __fastcall SetForegroundColor(System::Uitypes::TColor AColor, int AStart = 0xffffffff, int ALength = 0xffffffff) = 0 ;
...
public:
	/* {System_Generics_Collections}TList<VCL_TMSFNCPDFRichTextLib_ITMSFNCCustomPDFRichTextLib>.Create */ inline __fastcall TTMSFNCPDFRichTextLibList()/* overload */ : System::Generics::Collections::TList__1<_di_ITMSFNCCustomPDFRichTextLib>() { }
	/* {System_Generics_Collections}TList<VCL_TMSFNCPDFRichTextLib_ITMSFNCCustomPDFRichTextLib>.Create */ inline __fastcall TTMSFNCPDFRichTextLibList(const System::DelphiInterface<System::Generics::Defaults::IComparer__1<_di_ITMSFNCCustomPDFRichTextLib> > AComparer)/* overload */ : System::Generics::Collections::TList__1<_di_ITMSFNCCustomPDFRichTextLib>(AComparer) { }
	...
	/* {System_Generics_Collections}TList<VCL_TMSFNCPDFRichTextLib_ITMSFNCCustomPDFRichTextLib>.Destroy */ inline __fastcall virtual ~TTMSFNCPDFRichTextLibList() { }
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_VCL_TMSFNCPDFRICHTEXTLIB)
using namespace Vcl::Tmsfncpdfrichtextlib;
#endif
...
//-- end unit ----------------------------------------------------------------
#endif	// Vcl_TmsfncpdfrichtextlibHPP
