...
// (DO NOT EDIT: machine generated header) 'FMX.TMSFNCWebBrowser.pas' rev: 35.00 (Windows)
...
class PASCALIMPLEMENTATION TTMSFNCWebBrowserPopupForm : public Fmx::Forms::TCustomForm
{
...
public:
	/* TCustomForm.Create */ inline __fastcall virtual TTMSFNCWebBrowserPopupForm(System::Classes::TComponent* AOwner) : Fmx::Forms::TCustomForm(AOwner) { }
	/* TCustomForm.CreateNew */ inline __fastcall virtual TTMSFNCWebBrowserPopupForm(System::Classes::TComponent* AOwner, NativeInt Dummy) : Fmx::Forms::TCustomForm(AOwner, Dummy) { }
