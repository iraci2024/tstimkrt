...
// (DO NOT EDIT: machine generated header) 'VCL.TMSFNCCloudBase.pas' rev: 35.00 (Windows)

#ifndef Vcl_TmsfnccloudbaseHPP
#define Vcl_TmsfnccloudbaseHPP
...
public:
	/* {System_Generics_Collections}TObjectList<VCL_TMSFNCCloudBase_TTMSFNCCloudBaseRequestHeader>.Create */ inline __fastcall TTMSFNCCloudBaseRequestHeaders()/* overload */ : System::Generics::Collections::TObjectList__1<TTMSFNCCloudBaseRequestHeader*>() { }
	/* {System_Generics_Collections}TObjectList<VCL_TMSFNCCloudBase_TTMSFNCCloudBaseRequestHeader>.Create */ inline __fastcall TTMSFNCCloudBaseRequestHeaders(bool AOwnsObjects)/* overload */ : System::Generics::Collections::TObjectList__1<TTMSFNCCloudBaseRequestHeader*>(AOwnsObjects) { }
	/* {System_Generics_Collections}TObjectList<VCL_TMSFNCCloudBase_TTMSFNCCloudBaseRequestHeader>.Create */ inline __fastcall TTMSFNCCloudBaseRequestHeaders(const System::DelphiInterface<System::Generics::Defaults::IComparer__1<TTMSFNCCloudBaseRequestHeader*> > AComparer, bool AOwnsObjects)/* overload */ : System::Generics::Collections::TObjectList__1<TTMSFNCCloudBaseRequestHeader*>(AComparer, AOwnsObjects) { }
	/* {System_Generics_Collections}TObjectList<VCL_TMSFNCCloudBase_TTMSFNCCloudBaseRequestHeader>.Create */ inline __fastcall TTMSFNCCloudBaseRequestHeaders(System::Generics::Collections::TEnumerable__1<TTMSFNCCloudBaseRequestHeader*>* const Collection, bool AOwnsObjects)/* overload */ : System::Generics::Collections::TObjectList__1<TTMSFNCCloudBaseRequestHeader*>(Collection, AOwnsObjects) { }
	/* {System_Generics_Collections}TObjectList<VCL_TMSFNCCloudBase_TTMSFNCCloudBaseRequestHeader>.Destroy */ inline __fastcall virtual ~TTMSFNCCloudBaseRequestHeaders() { }
	
public:
	/* {System_Generics_Collections}TList<VCL_TMSFNCCloudBase_TTMSFNCCloudBaseRequestHeader>.Create */ inline __fastcall TTMSFNCCloudBaseRequestHeaders(const System::DelphiInterface<System::Generics::Defaults::IComparer__1<TTMSFNCCloudBaseRequestHeader*> > AComparer)/* overload */ : System::Generics::Collections::TObjectList__1<TTMSFNCCloudBaseRequestHeader*>(AComparer) { }
	/* {System_Generics_Collections}TList<VCL_TMSFNCCloudBase_TTMSFNCCloudBaseRequestHeader>.Create */ inline __fastcall TTMSFNCCloudBaseRequestHeaders(System::Generics::Collections::TEnumerable__1<TTMSFNCCloudBaseRequestHeader*>* const Collection)/* overload */ : System::Generics::Collections::TObjectList__1<TTMSFNCCloudBaseRequestHeader*>(Collection) { }
	/* {System_Generics_Collections}TList<VCL_TMSFNCCloudBase_TTMSFNCCloudBaseRequestHeader>.Create */ inline __fastcall TTMSFNCCloudBaseRequestHeaders(TTMSFNCCloudBaseRequestHeader* const *Values, const int Values_High)/* overload */ : System::Generics::Collections::TObjectList__1<TTMSFNCCloudBaseRequestHeader*>(Values, Values_High) { }
...
public:
	/* {System_Generics_Collections}TObjectList<VCL_TMSFNCCloudBase_TTMSFNCCloudBaseRequest>.Create */ inline __fastcall TTMSFNCCloudBaseRequests()/* overload */ : System::Generics::Collections::TObjectList__1<TTMSFNCCloudBaseRequest*>() { }
	/* {System_Generics_Collections}TObjectList<VCL_TMSFNCCloudBase_TTMSFNCCloudBaseRequest>.Create */ inline __fastcall TTMSFNCCloudBaseRequests(bool AOwnsObjects)/* overload */ : System::Generics::Collections::TObjectList__1<TTMSFNCCloudBaseRequest*>(AOwnsObjects) { }
	/* {System_Generics_Collections}TObjectList<VCL_TMSFNCCloudBase_TTMSFNCCloudBaseRequest>.Create */ inline __fastcall TTMSFNCCloudBaseRequests(const System::DelphiInterface<System::Generics::Defaults::IComparer__1<TTMSFNCCloudBaseRequest*> > AComparer, bool AOwnsObjects)/* overload */ : System::Generics::Collections::TObjectList__1<TTMSFNCCloudBaseRequest*>(AComparer, AOwnsObjects) { }
	/* {System_Generics_Collections}TObjectList<VCL_TMSFNCCloudBase_TTMSFNCCloudBaseRequest>.Create */ inline __fastcall TTMSFNCCloudBaseRequests(System::Generics::Collections::TEnumerable__1<TTMSFNCCloudBaseRequest*>* const Collection, bool AOwnsObjects)/* overload */ : System::Generics::Collections::TObjectList__1<TTMSFNCCloudBaseRequest*>(Collection, AOwnsObjects) { }
	/* {System_Generics_Collections}TObjectList<VCL_TMSFNCCloudBase_TTMSFNCCloudBaseRequest>.Destroy */ inline __fastcall virtual ~TTMSFNCCloudBaseRequests() { }
	
public:
	/* {System_Generics_Collections}TList<VCL_TMSFNCCloudBase_TTMSFNCCloudBaseRequest>.Create */ inline __fastcall TTMSFNCCloudBaseRequests(const System::DelphiInterface<System::Generics::Defaults::IComparer__1<TTMSFNCCloudBaseRequest*> > AComparer)/* overload */ : System::Generics::Collections::TObjectList__1<TTMSFNCCloudBaseRequest*>(AComparer) { }
	/* {System_Generics_Collections}TList<VCL_TMSFNCCloudBase_TTMSFNCCloudBaseRequest>.Create */ inline __fastcall TTMSFNCCloudBaseRequests(System::Generics::Collections::TEnumerable__1<TTMSFNCCloudBaseRequest*>* const Collection)/* overload */ : System::Generics::Collections::TObjectList__1<TTMSFNCCloudBaseRequest*>(Collection) { }
	/* {System_Generics_Collections}TList<VCL_TMSFNCCloudBase_TTMSFNCCloudBaseRequest>.Create */ inline __fastcall TTMSFNCCloudBaseRequests(TTMSFNCCloudBaseRequest* const *Values, const int Values_High)/* overload */ : System::Generics::Collections::TObjectList__1<TTMSFNCCloudBaseRequest*>(Values, Values_High) { }
...
class PASCALIMPLEMENTATION TTMSFNCCustomCloudBase : public Vcl::Tmsfnccustomcomponent::TTMSFNCCustomComponent
{
...
public:
	/* TWinControl.CreateParented */ inline __fastcall TTMSFNCCustomCloudBase(HWND ParentWindow) : Vcl::Tmsfnccustomcomponent::TTMSFNCCustomComponent(ParentWindow) { }
...
public:
	/* TWinControl.CreateParented */ inline __fastcall TTMSFNCCloudBase(HWND ParentWindow) : TTMSFNCCustomCloudBase(ParentWindow) { }
...
public:
	/* {System_Generics_Collections}TList<VCL_TMSFNCCloudBase_ITMSFNCCustomCloudBase>.Create */ inline __fastcall TTMSFNCCloudBaseList()/* overload */ : System::Generics::Collections::TList__1<_di_ITMSFNCCustomCloudBase>() { }
	/* {System_Generics_Collections}TList<VCL_TMSFNCCloudBase_ITMSFNCCustomCloudBase>.Create */ inline __fastcall TTMSFNCCloudBaseList(const System::DelphiInterface<System::Generics::Defaults::IComparer__1<_di_ITMSFNCCustomCloudBase> > AComparer)/* overload */ : System::Generics::Collections::TList__1<_di_ITMSFNCCustomCloudBase>(AComparer) { }
	/* {System_Generics_Collections}TList<VCL_TMSFNCCloudBase_ITMSFNCCustomCloudBase>.Create */ inline __fastcall TTMSFNCCloudBaseList(System::Generics::Collections::TEnumerable__1<_di_ITMSFNCCustomCloudBase>* const Collection)/* overload */ : System::Generics::Collections::TList__1<_di_ITMSFNCCustomCloudBase>(Collection) { }
	/* {System_Generics_Collections}TList<VCL_TMSFNCCloudBase_ITMSFNCCustomCloudBase>.Create */ inline __fastcall TTMSFNCCloudBaseList(const _di_ITMSFNCCustomCloudBase *Values, const int Values_High)/* overload */ : System::Generics::Collections::TList__1<_di_ITMSFNCCustomCloudBase>(Values, Values_High) { }
	/* {System_Generics_Collections}TList<VCL_TMSFNCCloudBase_ITMSFNCCustomCloudBase>.Destroy */ inline __fastcall virtual ~TTMSFNCCloudBaseList() { }
...
public:
	/* {System_Generics_Collections}TObjectList<VCL_TMSFNCCloudBase_TTMSFNCCloudPlatformServicesService>.Create */ inline __fastcall TTMSFNCCloudPlatformServicesList()/* overload */ : System::Generics::Collections::TObjectList__1<TTMSFNCCloudPlatformServicesService*>() { }
	/* {System_Generics_Collections}TObjectList<VCL_TMSFNCCloudBase_TTMSFNCCloudPlatformServicesService>.Create */ inline __fastcall TTMSFNCCloudPlatformServicesList(bool AOwnsObjects)/* overload */ : System::Generics::Collections::TObjectList__1<TTMSFNCCloudPlatformServicesService*>(AOwnsObjects) { }
	/* {System_Generics_Collections}TObjectList<VCL_TMSFNCCloudBase_TTMSFNCCloudPlatformServicesService>.Create */ inline __fastcall TTMSFNCCloudPlatformServicesList(const System::DelphiInterface<System::Generics::Defaults::IComparer__1<TTMSFNCCloudPlatformServicesService*> > AComparer, bool AOwnsObjects)/* overload */ : System::Generics::Collections::TObjectList__1<TTMSFNCCloudPlatformServicesService*>(AComparer, AOwnsObjects) { }
...
#define sRequestLineBreak L"\r\n"
#define sRequestBoundary L"AaB03x"
#define sRequestHeadBoundary L"--AaB03x"
#define sRequestTailBoundary L"--AaB03x--"
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_VCL_TMSFNCCLOUDBASE)
using namespace Vcl::Tmsfnccloudbase;
#endif
