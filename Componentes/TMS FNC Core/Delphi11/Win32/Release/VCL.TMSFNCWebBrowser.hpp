...
// (DO NOT EDIT: machine generated header) 'VCL.TMSFNCWebBrowser.pas' rev: 35.00 (Windows)

#ifndef Vcl_TmsfncwebbrowserHPP
#define Vcl_TmsfncwebbrowserHPP
...
public:
	/* {System_Generics_Collections}TObjectList<VCL_TMSFNCWebBrowser_TTMSFNCWebBrowserContextMenuItem>.Create */ inline __fastcall TTMSFNCWebBrowserContextMenuItemList()/* overload */ : System::Generics::Collections::TObjectList__1<TTMSFNCWebBrowserContextMenuItem*>() { }
	/* {System_Generics_Collections}TObjectList<VCL_TMSFNCWebBrowser_TTMSFNCWebBrowserContextMenuItem>.Create */ inline __fastcall TTMSFNCWebBrowserContextMenuItemList(bool AOwnsObjects)/* overload */ : System::Generics::Collections::TObjectList__1<TTMSFNCWebBrowserContextMenuItem*>(AOwnsObjects) { }
	/* {System_Generics_Collections}TObjectList<VCL_TMSFNCWebBrowser_TTMSFNCWebBrowserContextMenuItem>.Create */ inline __fastcall TTMSFNCWebBrowserContextMenuItemList(const System::DelphiInterface<System::Generics::Defaults::IComparer__1<TTMSFNCWebBrowserContextMenuItem*> > AComparer, bool AOwnsObjects)/* overload */ : System::Generics::Collections::TObjectList__1<TTMSFNCWebBrowserContextMenuItem*>(AComparer, AOwnsObjects) { }
...
private:
	...
	Vcl::Tmsfnctypes::TTMSFNCBitmap* FIcon;
...
protected:
	...
	__property Vcl::Tmsfnctypes::TTMSFNCBitmap* Icon = {read=FIcon, write=FIcon};
...
private:
	...
	Vcl::Tmsfnctypes::TTMSFNCBitmap* __fastcall GetIcon();
...
public:
	...
	__property Vcl::Tmsfnctypes::TTMSFNCBitmap* Icon = {read=GetIcon};
...
typedef void __fastcall (__closure *TTMSFNCWebBrowserOnGetPopupMenuForContextMenu)(System::TObject* Sender, const TTMSFNCWebBrowserTargetItem &ATarget, Vcl::Menus::TPopupMenu* &APopupMenu);
...
typedef void __fastcall (__closure *TTMSFNCCustomWebBrowserCaptureScreenShot)(System::TObject* Sender, Vcl::Tmsfnctypes::TTMSFNCBitmap* AScreenShot);
...
public:
	/* {System_Generics_Collections}TObjectList<VCL_TMSFNCWebBrowser_TTMSFNCScript>.Create */ inline __fastcall TTMSFNCScriptList()/* overload */ : System::Generics::Collections::TObjectList__1<TTMSFNCScript*>() { }
	/* {System_Generics_Collections}TObjectList<VCL_TMSFNCWebBrowser_TTMSFNCScript>.Create */ inline __fastcall TTMSFNCScriptList(bool AOwnsObjects)/* overload */ : System::Generics::Collections::TObjectList__1<TTMSFNCScript*>(AOwnsObjects) { }
	/* {System_Generics_Collections}TObjectList<VCL_TMSFNCWebBrowser_TTMSFNCScript>.Create */ inline __fastcall TTMSFNCScriptList(const System::DelphiInterface<System::Generics::Defaults::IComparer__1<TTMSFNCScript*> > AComparer, bool AOwnsObjects)/* overload */ : System::Generics::Collections::TObjectList__1<TTMSFNCScript*>(AComparer, AOwnsObjects) { }
	/* {System_Generics_Collections}TObjectList<VCL_TMSFNCWebBrowser_TTMSFNCScript>.Create */ inline __fastcall TTMSFNCScriptList(System::Generics::Collections::TEnumerable__1<TTMSFNCScript*>* const Collection, bool AOwnsObjects)/* overload */ : System::Generics::Collections::TObjectList__1<TTMSFNCScript*>(Collection, AOwnsObjects) { }
	/* {System_Generics_Collections}TObjectList<VCL_TMSFNCWebBrowser_TTMSFNCScript>.Destroy */ inline __fastcall virtual ~TTMSFNCScriptList() { }
	
public:
	/* {System_Generics_Collections}TList<VCL_TMSFNCWebBrowser_TTMSFNCScript>.Create */ inline __fastcall TTMSFNCScriptList(const System::DelphiInterface<System::Generics::Defaults::IComparer__1<TTMSFNCScript*> > AComparer)/* overload */ : System::Generics::Collections::TObjectList__1<TTMSFNCScript*>(AComparer) { }
	/* {System_Generics_Collections}TList<VCL_TMSFNCWebBrowser_TTMSFNCScript>.Create */ inline __fastcall TTMSFNCScriptList(System::Generics::Collections::TEnumerable__1<TTMSFNCScript*>* const Collection)/* overload */ : System::Generics::Collections::TObjectList__1<TTMSFNCScript*>(Collection) { }
	/* {System_Generics_Collections}TList<VCL_TMSFNCWebBrowser_TTMSFNCScript>.Create */ inline __fastcall TTMSFNCScriptList(TTMSFNCScript* const *Values, const int Values_High)/* overload */ : System::Generics::Collections::TObjectList__1<TTMSFNCScript*>(Values, Values_High) { }
...
class PASCALIMPLEMENTATION TTMSFNCCustomWebBrowser : public Vcl::Tmsfnccustomcontrol::TTMSFNCCustomControl
{
...
protected:
	...
	virtual void __fastcall DoCaptureScreenShot(Vcl::Tmsfnctypes::TTMSFNCBitmap* AScreenShot);
	...
	void __fastcall DoGetPopupMenuForContextMenu(const TTMSFNCWebBrowserTargetItem &ATarget, Vcl::Menus::TPopupMenu* &APopUpMenu);
...
public:
	/* TWinControl.CreateParented */ inline __fastcall TTMSFNCCustomWebBrowser(HWND ParentWindow) : Vcl::Tmsfnccustomcontrol::TTMSFNCCustomControl(ParentWindow) { }
...
public:
	/* {System_Generics_Collections}TList<VCL_TMSFNCWebBrowser_ITMSFNCCustomWebBrowser>.Create */ inline __fastcall TTMSFNCWebBrowserList()/* overload */ : System::Generics::Collections::TList__1<_di_ITMSFNCCustomWebBrowser>() { }
	/* {System_Generics_Collections}TList<VCL_TMSFNCWebBrowser_ITMSFNCCustomWebBrowser>.Create */ inline __fastcall TTMSFNCWebBrowserList(const System::DelphiInterface<System::Generics::Defaults::IComparer__1<_di_ITMSFNCCustomWebBrowser> > AComparer)/* overload */ : System::Generics::Collections::TList__1<_di_ITMSFNCCustomWebBrowser>(AComparer) { }
	/* {System_Generics_Collections}TList<VCL_TMSFNCWebBrowser_ITMSFNCCustomWebBrowser>.Create */ inline __fastcall TTMSFNCWebBrowserList(System::Generics::Collections::TEnumerable__1<_di_ITMSFNCCustomWebBrowser>* const Collection)/* overload */ : System::Generics::Collections::TList__1<_di_ITMSFNCCustomWebBrowser>(Collection) { }
	/* {System_Generics_Collections}TList<VCL_TMSFNCWebBrowser_ITMSFNCCustomWebBrowser>.Create */ inline __fastcall TTMSFNCWebBrowserList(const _di_ITMSFNCCustomWebBrowser *Values, const int Values_High)/* overload */ : System::Generics::Collections::TList__1<_di_ITMSFNCCustomWebBrowser>(Values, Values_High) { }
	/* {System_Generics_Collections}TList<VCL_TMSFNCWebBrowser_ITMSFNCCustomWebBrowser>.Destroy */ inline __fastcall virtual ~TTMSFNCWebBrowserList() { }
...
public:
	/* TWinControl.CreateParented */ inline __fastcall TTMSFNCWebBrowser(HWND ParentWindow) : TTMSFNCCustomWebBrowser(ParentWindow) { }
	
};


class PASCALIMPLEMENTATION TTMSFNCWebBrowserPopupForm : public Vcl::Forms::TCustomForm
{
...
public:
	/* TCustomForm.Create */ inline __fastcall virtual TTMSFNCWebBrowserPopupForm(System::Classes::TComponent* AOwner) : Vcl::Forms::TCustomForm(AOwner) { }
	/* TCustomForm.CreateNew */ inline __fastcall virtual TTMSFNCWebBrowserPopupForm(System::Classes::TComponent* AOwner, int Dummy) : Vcl::Forms::TCustomForm(AOwner, Dummy) { }
	/* TCustomForm.Destroy */ inline __fastcall virtual ~TTMSFNCWebBrowserPopupForm() { }
	
public:
	/* TWinControl.CreateParented */ inline __fastcall TTMSFNCWebBrowserPopupForm(HWND ParentWindow) : Vcl::Forms::TCustomForm(ParentWindow) { }
	
};


typedef System::TMetaClass* TTMSFNCCustomWebBrowserClass;

typedef Vcl::Forms::TPosition TTMSFNCWebBrowserFormPosition;
...
private:
	System::UnicodeString FLoadURL;
	bool FFirstLoad;
	bool FModal;
	TTMSFNCWebBrowserPopupForm* FWebBrowserForm;
	TTMSFNCCustomWebBrowser* FWebBrowser;
	TTMSFNCCustomWebBrowserNavigateComplete FOnNavigateComplete;
	TTMSFNCCustomWebBrowserBeforeNavigate FOnBeforeNavigate;
	System::UnicodeString FURL;
...
public:
	/* {System_Generics_Collections}TObjectList<VCL_TMSFNCWebBrowser_TTMSFNCWebBrowserPlatformServicesService>.Create */ inline __fastcall TTMSFNCWebBrowserPlatformServicesList()/* overload */ : System::Generics::Collections::TObjectList__1<TTMSFNCWebBrowserPlatformServicesService*>() { }
	/* {System_Generics_Collections}TObjectList<VCL_TMSFNCWebBrowser_TTMSFNCWebBrowserPlatformServicesService>.Create */ inline __fastcall TTMSFNCWebBrowserPlatformServicesList(bool AOwnsObjects)/* overload */ : System::Generics::Collections::TObjectList__1<TTMSFNCWebBrowserPlatformServicesService*>(AOwnsObjects) { }
	/* {System_Generics_Collections}TObjectList<VCL_TMSFNCWebBrowser_TTMSFNCWebBrowserPlatformServicesService>.Create */ inline __fastcall TTMSFNCWebBrowserPlatformServicesList(const System::DelphiInterface<System::Generics::Defaults::IComparer__1<TTMSFNCWebBrowserPlatformServicesService*> > AComparer, bool AOwnsObjects)/* overload */ : System::Generics::Collections::TObjectList__1<TTMSFNCWebBrowserPlatformServicesService*>(AComparer, AOwnsObjects) { }
	...
	/* {System_Generics_Collections}TObjectList<VCL_TMSFNCWebBrowser_TTMSFNCWebBrowserPlatformServicesService>.Destroy */ inline __fastcall virtual ~TTMSFNCWebBrowserPlatformServicesList() { }
	
public:
	/* {System_Generics_Collections}TList<VCL_TMSFNCWebBrowser_TTMSFNCWebBrowserPlatformServicesService>.Create */ inline __fastcall TTMSFNCWebBrowserPlatformServicesList(const System::DelphiInterface<System::Generics::Defaults::IComparer__1<TTMSFNCWebBrowserPlatformServicesService*> > AComparer)/* overload */ : System::Generics::Collections::TObjectList__1<TTMSFNCWebBrowserPlatformServicesService*>(AComparer) { }
...
#define DESIGNTIMEMESSAGE L"Selectable/Draggable area (only active at designtime)"
#define IID_ITMSFNCCustomWebBrowserGUID L"{F74562D0-56C7-4ED2-B01B-8C9C16DD9361}"
#define IID_ITMSFNCCustomWebBrowserExGUID L"{6B5D75C1-B5EC-463D-A602-1FFB97C8668C}"
#define IID_ITMSFNCCustomWebBrowserContextMenuGUID L"{04BD0560-104B-4D3B-8CB1-45628D16CB0D}"
#define IID_ITMSFNCCustomWebBrowserBridgeGUID L"{AC2934EC-9397-4A99-8E0A-1EF58803C8EA}"
#define IID_ITMSFNCCustomWebBrowserSettingsGUID L"{25142510-A807-4635-BAE7-CB261D00137E}"
#define IID_ITMSFNCCustomWebBrowserCookiesGUID L"{A50ABF08-0A6F-4877-AC92-FC834CF36AE6}"
#define IID_ITMSFNCCustomWebBrowserServiceGUID L"{4B7A5FE1-A889-47C6-B40F-A611BB6266E6}"
#define IID_ITMSFNCCustomWebBrowserPrintGUID L"{56EFC9E8-CD92-4FAC-B79C-084BF3DB0FBD}"
