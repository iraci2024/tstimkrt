...
// (DO NOT EDIT: machine generated header) 'VCL.TMSFNCPDFIO.pas' rev: 35.00 (Windows)

#ifndef Vcl_TmsfncpdfioHPP
#define Vcl_TmsfncpdfioHPP
...
private:
	...
	Vcl::Tmsfncpdfcorelibbase::TTMSFNCPDFGraphicsLibFont* FDefaultFont;
	System::UnicodeString FFooter;
	System::UnicodeString FHeader;
	Vcl::Tmsfnctypes::TTMSFNCMargins* FMargins;
	Vcl::Tmsfncpdfcorelibbase::TTMSFNCPDFGraphicsLibFont* FHeaderFont;
	Vcl::Tmsfncpdfcorelibbase::TTMSFNCPDFGraphicsLibFont* FFooterFont;
	float FHeaderSize;
	Vcl::Tmsfnctypes::TTMSFNCMargins* FFooterMargins;
	Vcl::Tmsfncgraphicstypes::TTMSFNCGraphicsTextAlign FFooterAlignment;
	float FFooterSize;
	Vcl::Tmsfnctypes::TTMSFNCMargins* FHeaderMargins;
	Vcl::Tmsfncgraphicstypes::TTMSFNCGraphicsTextAlign FHeaderAlignment;
	Vcl::Tmsfncpdflib::TTMSFNCPDFLibPageSize FPageSize;
	Vcl::Tmsfncpdflib::TTMSFNCPDFLibPageOrientation FPageOrientation;
	float FPageWidth;
	float FPageHeight;
	bool FExportImages;
	...
	Vcl::Tmsfncgraphicstypes::TTMSFNCGraphicsTextAlign FPageNumberAlignment;
	Vcl::Tmsfncpdflib::TTMSFNCPDFLibPageNumber FPageNumber;
	Vcl::Tmsfncpdfcorelibbase::TTMSFNCPDFGraphicsLibFont* FPageNumberFont;
	Vcl::Tmsfnctypes::TTMSFNCMargins* FPageNumberMargins;
	float FPageNumberSize;
	void __fastcall SetDefaultFont(Vcl::Tmsfncpdfcorelibbase::TTMSFNCPDFGraphicsLibFont* const Value);
	...
	void __fastcall SetPageOrientation(const Vcl::Tmsfncpdflib::TTMSFNCPDFLibPageOrientation Value);
	void __fastcall SetPageSize(const Vcl::Tmsfncpdflib::TTMSFNCPDFLibPageSize Value);
	...
	void __fastcall SetPageNumber(const Vcl::Tmsfncpdflib::TTMSFNCPDFLibPageNumber Value);
...
__published:
	...
	__property Vcl::Tmsfncpdfcorelibbase::TTMSFNCPDFGraphicsLibFont* DefaultFont = {read=FDefaultFont, write=SetDefaultFont};
	...
	__property Vcl::Tmsfncpdfcorelibbase::TTMSFNCPDFGraphicsLibFont* HeaderFont = {read=FHeaderFont, write=SetHeaderFont};
	__property Vcl::Tmsfncpdfcorelibbase::TTMSFNCPDFGraphicsLibFont* FooterFont = {read=FFooterFont, write=SetFooterFont};
	...
	__property Vcl::Tmsfncgraphicstypes::TTMSFNCGraphicsTextAlign HeaderAlignment = {read=FHeaderAlignment, write=SetHeaderAlignment, default=0};
	...
	__property Vcl::Tmsfncgraphicstypes::TTMSFNCGraphicsTextAlign FooterAlignment = {read=FFooterAlignment, write=SetFooterAlignment, default=0};
	...
	__property Vcl::Tmsfncpdflib::TTMSFNCPDFLibPageSize PageSize = {read=FPageSize, write=SetPageSize, default=34};
	__property Vcl::Tmsfncpdflib::TTMSFNCPDFLibPageOrientation PageOrientation = {read=FPageOrientation, write=SetPageOrientation, default=0};
	...
	__property Vcl::Tmsfncpdflib::TTMSFNCPDFLibPageNumber PageNumber = {read=FPageNumber, write=SetPageNumber, default=1};
	...
	__property Vcl::Tmsfncgraphicstypes::TTMSFNCGraphicsTextAlign PageNumberAlignment = {read=FPageNumberAlignment, write=SetPageNumberAlignment, default=2};
	__property Vcl::Tmsfncpdfcorelibbase::TTMSFNCPDFGraphicsLibFont* PageNumberFont = {read=FPageNumberFont, write=SetPageNumberFont};
...
typedef void __fastcall (__closure *TTMSFNCPDFIOBeforeDrawContentEvent)(System::TObject* Sender, System::TObject* AExportObject, int APageIndex, const System::Types::TRectF &ARect, Vcl::Tmsfncpdfgraphicslib::_di_ITMSFNCCustomPDFGraphicsLib AGraphics, bool &ADefaultDraw);

typedef void __fastcall (__closure *TTMSFNCPDFIOAfterDrawContentEvent)(System::TObject* Sender, System::TObject* AExportObject, int APageIndex, const System::Types::TRectF &ARect, Vcl::Tmsfncpdfgraphicslib::_di_ITMSFNCCustomPDFGraphicsLib AGraphics);

typedef void __fastcall (__closure *TTMSFNCPDFIOBeforeDrawHeaderEvent)(System::TObject* Sender, System::TObject* AExportObject, int APageIndex, System::UnicodeString AHeader, const System::Types::TRectF &ARect, Vcl::Tmsfncpdfgraphicslib::_di_ITMSFNCCustomPDFGraphicsLib AGraphics, bool &ADefaultDraw);

typedef void __fastcall (__closure *TTMSFNCPDFIOBeforeDrawPageNumberEvent)(System::TObject* Sender, System::TObject* AExportObject, int APageIndex, System::UnicodeString APageNumber, const System::Types::TRectF &ARect, Vcl::Tmsfncpdfgraphicslib::_di_ITMSFNCCustomPDFGraphicsLib AGraphics, bool &ADefaultDraw);

typedef void __fastcall (__closure *TTMSFNCPDFIOBeforeDrawFooterEvent)(System::TObject* Sender, System::TObject* AExportObject, int APageIndex, System::UnicodeString AFooter, const System::Types::TRectF &ARect, Vcl::Tmsfncpdfgraphicslib::_di_ITMSFNCCustomPDFGraphicsLib AGraphics, bool &ADefaultDraw);

typedef void __fastcall (__closure *TTMSFNCPDFIOAfterDrawHeaderEvent)(System::TObject* Sender, System::TObject* AExportObject, int APageIndex, System::UnicodeString AHeader, const System::Types::TRectF &ARect, Vcl::Tmsfncpdfgraphicslib::_di_ITMSFNCCustomPDFGraphicsLib AGraphics);

typedef void __fastcall (__closure *TTMSFNCPDFIOAfterDrawPageNumberEvent)(System::TObject* Sender, System::TObject* AExportObject, int APageIndex, System::UnicodeString APageNumber, const System::Types::TRectF &ARect, Vcl::Tmsfncpdfgraphicslib::_di_ITMSFNCCustomPDFGraphicsLib AGraphics);

typedef void __fastcall (__closure *TTMSFNCPDFIOAfterDrawEvent)(System::TObject* Sender, Vcl::Tmsfncpdflib::TTMSFNCPDFLib* APDFLib);

typedef void __fastcall (__closure *TTMSFNCPDFIOAfterDrawFooterEvent)(System::TObject* Sender, System::TObject* AExportObject, int APageIndex, System::UnicodeString AFooter, const System::Types::TRectF &ARect, Vcl::Tmsfncpdfgraphicslib::_di_ITMSFNCCustomPDFGraphicsLib AGraphics);
...
class PASCALIMPLEMENTATION TTMSFNCCustomPDFIO : public Vcl::Tmsfnccustomcomponent::TTMSFNCCustomComponent
{
...
protected:
	...
	virtual bool __fastcall NewPage(Vcl::Tmsfncpdflib::TTMSFNCPDFLib* const APDFLib, System::Classes::TComponent* const AExportObject);
	virtual System::Types::TRectF __fastcall GetContentRect(Vcl::Tmsfncpdflib::TTMSFNCPDFLib* const APDFLib);
	virtual Vcl::Tmsfncpdflib::TTMSFNCPDFLib* __fastcall InitializePDFLib();
	virtual void __fastcall Notification(System::Classes::TComponent* AComponent, System::Classes::TOperation Operation);
	virtual void __fastcall EndPage(Vcl::Tmsfncpdflib::TTMSFNCPDFLib* const APDFLib, System::Classes::TComponent* const AExportObject);
	...
	virtual void __fastcall DoPDFExport(Vcl::Tmsfncpdflib::TTMSFNCPDFLib* const APDFLib, System::Classes::TComponent* const AExportObject, const System::Types::TRectF &AExportRect) = 0 /* overload */;
	virtual void __fastcall DoAfterDraw(Vcl::Tmsfncpdflib::TTMSFNCPDFLib* APDFLib);
	virtual void __fastcall DoBeforeDrawHeader(System::TObject* Sender, int APageIndex, System::UnicodeString AHeader, const System::Types::TRectF &ARect, Vcl::Tmsfncpdfgraphicslib::_di_ITMSFNCCustomPDFGraphicsLib AGraphics, bool &ADefaultDraw);
	virtual void __fastcall DoBeforeDrawPageNumber(System::TObject* Sender, int APageIndex, System::UnicodeString APageNumber, const System::Types::TRectF &ARect, Vcl::Tmsfncpdfgraphicslib::_di_ITMSFNCCustomPDFGraphicsLib AGraphics, bool &ADefaultDraw);
	virtual void __fastcall DoBeforeDrawFooter(System::TObject* Sender, int APageIndex, System::UnicodeString AFooter, const System::Types::TRectF &ARect, Vcl::Tmsfncpdfgraphicslib::_di_ITMSFNCCustomPDFGraphicsLib AGraphics, bool &ADefaultDraw);
	virtual void __fastcall DoAfterDrawHeader(System::TObject* Sender, int APageIndex, System::UnicodeString AHeader, const System::Types::TRectF &ARect, Vcl::Tmsfncpdfgraphicslib::_di_ITMSFNCCustomPDFGraphicsLib AGraphics);
	virtual void __fastcall DoAfterDrawPageNumber(System::TObject* Sender, int APageIndex, System::UnicodeString APageNumber, const System::Types::TRectF &ARect, Vcl::Tmsfncpdfgraphicslib::_di_ITMSFNCCustomPDFGraphicsLib AGraphics);
	virtual void __fastcall DoAfterDrawFooter(System::TObject* Sender, int APageIndex, System::UnicodeString AFooter, const System::Types::TRectF &ARect, Vcl::Tmsfncpdfgraphicslib::_di_ITMSFNCCustomPDFGraphicsLib AGraphics);
	virtual void __fastcall DoBeforeDrawContent(System::Classes::TComponent* AExportObject, int APageIndex, const System::Types::TRectF &ARect, Vcl::Tmsfncpdfgraphicslib::_di_ITMSFNCCustomPDFGraphicsLib AGraphics, bool &ADefaultDraw);
	virtual void __fastcall DoAfterDrawContent(System::Classes::TComponent* AExportObject, int APageIndex, const System::Types::TRectF &ARect, Vcl::Tmsfncpdfgraphicslib::_di_ITMSFNCCustomPDFGraphicsLib AGraphics);
...
public:
	/* TWinControl.CreateParented */ inline __fastcall TTMSFNCCustomPDFIO(HWND ParentWindow) : Vcl::Tmsfnccustomcomponent::TTMSFNCCustomComponent(ParentWindow) { }
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_VCL_TMSFNCPDFIO)
using namespace Vcl::Tmsfncpdfio;
#endif
