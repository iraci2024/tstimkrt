...
// (DO NOT EDIT: machine generated header) 'VCL.TMSFNCDataBinding.pas' rev: 35.00 (Windows)

#ifndef Vcl_TmsfncdatabindingHPP
#define Vcl_TmsfncdatabindingHPP
...
#pragma pack(push,4)
class PASCALIMPLEMENTATION TTMSFNCDataBinderPropertyNames : public Vcl::Tmsfnctypes::TTMSFNCOwnedCollection__1<TTMSFNCDataBinderPropertyName*>
{
	typedef Vcl::Tmsfnctypes::TTMSFNCOwnedCollection__1<TTMSFNCDataBinderPropertyName*> inherited;
...
#pragma pack(push,4)
class PASCALIMPLEMENTATION TTMSFNCDataBinderFieldNames : public Vcl::Tmsfnctypes::TTMSFNCOwnedCollection__1<TTMSFNCDataBinderFieldName*>
{
	typedef Vcl::Tmsfnctypes::TTMSFNCOwnedCollection__1<TTMSFNCDataBinderFieldName*> inherited;
...
#pragma pack(push,4)
class PASCALIMPLEMENTATION TTMSFNCDataBinderItems : public Vcl::Tmsfnctypes::TTMSFNCOwnedCollection__1<TTMSFNCDataBinderItem*>
{
	typedef Vcl::Tmsfnctypes::TTMSFNCOwnedCollection__1<TTMSFNCDataBinderItem*> inherited;
...
class PASCALIMPLEMENTATION TTMSFNCDataBinder : public Vcl::Tmsfnccustomcomponent::TTMSFNCCustomComponent
{
...
public:
	...
	__classmethod void __fastcall BlobFieldToPicture(Data::Db::TBlobField* AField, Vcl::Tmsfnctypes::TTMSFNCBitmap* ABitmap);
...
public:
	/* TWinControl.CreateParented */ inline __fastcall TTMSFNCDataBinder(HWND ParentWindow) : Vcl::Tmsfnccustomcomponent::TTMSFNCCustomComponent(ParentWindow) { }
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_VCL_TMSFNCDATABINDING)
using namespace Vcl::Tmsfncdatabinding;
#endif
...
//-- end unit ----------------------------------------------------------------
#endif	// Vcl_TmsfncdatabindingHPP
