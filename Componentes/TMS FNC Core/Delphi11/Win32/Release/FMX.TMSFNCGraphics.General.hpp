...
// (DO NOT EDIT: machine generated header) 'FMX.TMSFNCGraphics.General.pas' rev: 35.00 (Windows)
...
protected:
	...
	virtual System::Types::TRectF __fastcall CalculateTextWin(System::UnicodeString AText, const System::Types::TRectF &ARect, bool AWordWrapping);
