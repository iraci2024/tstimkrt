...
// (DO NOT EDIT: machine generated header) 'VCL.TMSFNCJSONWriter.pas' rev: 35.00 (Windows)

#ifndef Vcl_TmsfncjsonwriterHPP
#define Vcl_TmsfncjsonwriterHPP
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_VCL_TMSFNCJSONWRITER)
using namespace Vcl::Tmsfncjsonwriter;
#endif
