...
// (DO NOT EDIT: machine generated header) 'FMX.TMSFNCUtils.pas' rev: 35.00 (Windows)
...
public:
	...
	__classmethod System::DynamicArray<System::Byte> __fastcall HexStrToBytes(const System::UnicodeString AValue);
	...
	__classmethod System::UnicodeString __fastcall Encode64(const System::DynamicArray<System::Byte> AValue, const bool AURL = false)/* overload */;
	...
	__classmethod System::DynamicArray<System::Byte> __fastcall Decode64ToBytes(const System::UnicodeString AValue, const bool AURL = false)/* overload */;
...
protected:
	__classmethod virtual bool __fastcall isTextFormat(unsigned AFormat);
	__classmethod virtual bool __fastcall isStreamFormat(unsigned AFormat);
	
public:
	__classmethod virtual unsigned __fastcall GetFormat(TTMSFNCClipBoardFormat AFormat);
	__classmethod virtual void __fastcall SetValues(System::DynamicArray<System::Rtti::TValue> AValues, System::DynamicArray<unsigned> AFormats);
	__classmethod virtual void __fastcall SetValue(const System::Rtti::TValue &AValue, unsigned AFormat);
	__classmethod virtual System::Rtti::TValue __fastcall GetValue(unsigned AFormat);
	__classmethod virtual System::Rtti::TValue __fastcall GetCustomValue(unsigned AFormat, void * AData);
	__classmethod virtual void __fastcall SetCustomValue(unsigned AFormat, const System::Rtti::TValue &AValue, void * &AData);
	__classmethod virtual NativeUInt __fastcall AllocateCustomValue(unsigned AFormat, const System::Rtti::TValue &AValue);
	__classmethod virtual void __fastcall SetBitmapWin(Fmx::Tmsfnctypes::TTMSFNCBitmap* ABitmap);
	__classmethod virtual Fmx::Tmsfnctypes::TTMSFNCBitmap* __fastcall GetBitmapWin();
	__classmethod virtual bool __fastcall HasFormat(unsigned AFormat)/* overload */;
