...
// (DO NOT EDIT: machine generated header) 'VCL.TMSFNCPDFCoreLibBase.pas' rev: 35.00 (Windows)

#ifndef Vcl_TmsfncpdfcorelibbaseHPP
#define Vcl_TmsfncpdfcorelibbaseHPP
...
class PASCALIMPLEMENTATION TTMSFNCPDFGraphicsFill : public Vcl::Tmsfncgraphicstypes::TTMSFNCCustomGraphicsFill
{
	typedef Vcl::Tmsfncgraphicstypes::TTMSFNCCustomGraphicsFill inherited;
...
__published:
	...
	__property ColorTo;
public:
	/* TTMSFNCCustomGraphicsFill.Create */ inline __fastcall virtual TTMSFNCPDFGraphicsFill(const Vcl::Tmsfncgraphicstypes::TTMSFNCGraphicsFillKind AKind, const System::Uitypes::TColor AColor, const System::Uitypes::TColor AColorTo, const System::Uitypes::TColor AColorMirror, const System::Uitypes::TColor AColorMirrorTo) : Vcl::Tmsfncgraphicstypes::TTMSFNCCustomGraphicsFill(AKind, AColor, AColorTo, AColorMirror, AColorMirrorTo) { }
	/* TTMSFNCCustomGraphicsFill.Destroy */ inline __fastcall virtual ~TTMSFNCPDFGraphicsFill() { }
	
};


class PASCALIMPLEMENTATION TTMSFNCPDFGraphicsStroke : public Vcl::Tmsfncgraphicstypes::TTMSFNCCustomGraphicsStroke
{
	typedef Vcl::Tmsfncgraphicstypes::TTMSFNCCustomGraphicsStroke inherited;
...
__published:
	...
	__property Width;
public:
	/* TTMSFNCCustomGraphicsStroke.Create */ inline __fastcall virtual TTMSFNCPDFGraphicsStroke(const Vcl::Tmsfncgraphicstypes::TTMSFNCGraphicsStrokeKind AKind, const System::Uitypes::TColor AColor) : Vcl::Tmsfncgraphicstypes::TTMSFNCCustomGraphicsStroke(AKind, AColor) { }
...
private:
	...
	Vcl::Tmsfncgraphicstypes::TTMSFNCGraphicsTextAlign FAlignment;
	...
	void __fastcall SetAlignment(const Vcl::Tmsfncgraphicstypes::TTMSFNCGraphicsTextAlign Value);
...
public:
	...
	__property Vcl::Tmsfncgraphicstypes::TTMSFNCGraphicsTextAlign Alignment = {read=FAlignment, write=SetAlignment, default=1};
...
public:
	/* {System_Generics_Collections}TObjectList<VCL_TMSFNCPDFCoreLibBase_TTMSFNCPDFPlatformServicesService>.Create */ inline __fastcall TTMSFNCPDFPlatformServicesList()/* overload */ : System::Generics::Collections::TObjectList__1<TTMSFNCPDFPlatformServicesService*>() { }
	/* {System_Generics_Collections}TObjectList<VCL_TMSFNCPDFCoreLibBase_TTMSFNCPDFPlatformServicesService>.Create */ inline __fastcall TTMSFNCPDFPlatformServicesList(bool AOwnsObjects)/* overload */ : System::Generics::Collections::TObjectList__1<TTMSFNCPDFPlatformServicesService*>(AOwnsObjects) { }
	/* {System_Generics_Collections}TObjectList<VCL_TMSFNCPDFCoreLibBase_TTMSFNCPDFPlatformServicesService>.Create */ inline __fastcall TTMSFNCPDFPlatformServicesList(const System::DelphiInterface<System::Generics::Defaults::IComparer__1<TTMSFNCPDFPlatformServicesService*> > AComparer, bool AOwnsObjects)/* overload */ : System::Generics::Collections::TObjectList__1<TTMSFNCPDFPlatformServicesService*>(AComparer, AOwnsObjects) { }
	...
	/* {System_Generics_Collections}TObjectList<VCL_TMSFNCPDFCoreLibBase_TTMSFNCPDFPlatformServicesService>.Destroy */ inline __fastcall virtual ~TTMSFNCPDFPlatformServicesList() { }
	
public:
	/* {System_Generics_Collections}TList<VCL_TMSFNCPDFCoreLibBase_TTMSFNCPDFPlatformServicesService>.Create */ inline __fastcall TTMSFNCPDFPlatformServicesList(const System::DelphiInterface<System::Generics::Defaults::IComparer__1<TTMSFNCPDFPlatformServicesService*> > AComparer)/* overload */ : System::Generics::Collections::TObjectList__1<TTMSFNCPDFPlatformServicesService*>(AComparer) { }
...
typedef void __fastcall (__closure *TTMSFNCPDFGraphicsLibOutputWriterNotifyBitmapEvent)(System::TObject* Sender, Vcl::Graphics::TPicture* AValue, TTMSFNCPDFGraphicsLibImageType AImageType, float AQuality, System::Uitypes::TColor ABackgroundColor, System::UnicodeString &ABitmapReference);

typedef void __fastcall (__closure *TTMSFNCPDFGraphicsLibOutputWriterNotifyShadingEvent)(System::TObject* Sender, System::Uitypes::TColor AFillColor, System::Uitypes::TColor AFillColorTo, Vcl::Tmsfncgraphicstypes::TTMSFNCGraphicsFillOrientation AFillOrientation, System::UnicodeString &AShadingReference);
...
public:
	...
	System::UnicodeString __fastcall ConvertColorToString(System::Uitypes::TColor AValue);
	...
	void __fastcall WriteFillColor(System::Uitypes::TColor AColor);
	void __fastcall WriteStrokeColor(System::Uitypes::TColor AColor);
	void __fastcall WriteStrokeKind(Vcl::Tmsfncgraphicstypes::TTMSFNCGraphicsStrokeKind AKind);
	...
	void __fastcall NotifyShading(System::Uitypes::TColor AFillColor, System::Uitypes::TColor AFillColorTo, Vcl::Tmsfncgraphicstypes::TTMSFNCGraphicsFillOrientation AFillOrientation, System::UnicodeString &AShadingReference);
	...
	void __fastcall NotifyBitmap(Vcl::Graphics::TPicture* AValue, TTMSFNCPDFGraphicsLibImageType AImageType, float AQuality, System::Uitypes::TColor ABackgroundColor, System::UnicodeString &ABitmapReference);
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_VCL_TMSFNCPDFCORELIBBASE)
using namespace Vcl::Tmsfncpdfcorelibbase;
#endif
...
//-- end unit ----------------------------------------------------------------
#endif	// Vcl_TmsfncpdfcorelibbaseHPP
