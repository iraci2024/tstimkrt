...
// (DO NOT EDIT: machine generated header) 'FMX.TMSFNCPopup.pas' rev: 35.00 (Windows)
...
typedef System::TMetaClass* TTMSFNCCustomPopupFormClass;

class PASCALIMPLEMENTATION TTMSFNCCustomPopupForm : public Fmx::Forms::TCustomForm
{
