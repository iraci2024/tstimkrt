...
// (DO NOT EDIT: machine generated header) 'VCL.TMSFNCResponsiveManagerDE.pas' rev: 35.00 (Windows)

#ifndef Vcl_TmsfncresponsivemanagerdeHPP
#define Vcl_TmsfncresponsivemanagerdeHPP
...
#include <VCL.TMSFNCResponsiveManagerDimensionsEditor.hpp>
...
//-- type declarations -------------------------------------------------------
#pragma pack(push,4)
class PASCALIMPLEMENTATION TTMSFNCResponsiveManagerEditor : public Vcl::Tmsfncgeneralde::TTMSFNCDefaultEditor
{
	typedef Vcl::Tmsfncgeneralde::TTMSFNCDefaultEditor inherited;
	
private:
	Vcl::Tmsfncresponsivemanagerdimensionseditor::TTMSFNCResponsiveManagerDimensionsEditorDimensions* FDimensions;
	Vcl::Tmsfncresponsivemanagerdimensionseditor::TTMSFNCResponsiveManagerDimensionsEditorDimensions* __fastcall GetDimensions();
	
protected:
	virtual void __fastcall LoadDimensions();
	__property Vcl::Tmsfncresponsivemanagerdimensionseditor::TTMSFNCResponsiveManagerDimensionsEditorDimensions* Dimensions = {read=GetDimensions};
...
public:
	...
	void __fastcall OpenSettings(Vcl::Tmsfncresponsivemanager::TTMSFNCResponsiveManager* AManager);
public:
	/* TComponentEditor.Create */ inline __fastcall virtual TTMSFNCResponsiveManagerEditor(System::Classes::TComponent* AComponent, Designintf::_di_IDesigner ADesigner) : Vcl::Tmsfncgeneralde::TTMSFNCDefaultEditor(AComponent, ADesigner) { }
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_VCL_TMSFNCRESPONSIVEMANAGERDE)
using namespace Vcl::Tmsfncresponsivemanagerde;
#endif
...
//-- end unit ----------------------------------------------------------------
#endif	// Vcl_TmsfncresponsivemanagerdeHPP
