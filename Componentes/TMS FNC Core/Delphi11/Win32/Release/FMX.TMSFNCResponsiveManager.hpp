...
// (DO NOT EDIT: machine generated header) 'FMX.TMSFNCResponsiveManager.pas' rev: 35.00 (Windows)

#ifndef Fmx_TmsfncresponsivemanagerHPP
#define Fmx_TmsfncresponsivemanagerHPP
...
#include <FMX.TMSFNCStateManager.hpp>
...
#pragma pack(push,4)
class PASCALIMPLEMENTATION TTMSFNCResponsiveManagerItem : public Fmx::Tmsfncstatemanager::TTMSFNCStateManagerItem
{
	typedef Fmx::Tmsfncstatemanager::TTMSFNCStateManagerItem inherited;
...
#pragma pack(push,4)
class PASCALIMPLEMENTATION TTMSFNCResponsiveManagerItems : public Fmx::Tmsfncstatemanager::TTMSFNCStateManagerItems
{
	typedef Fmx::Tmsfncstatemanager::TTMSFNCStateManagerItems inherited;
...
public:
	/* TTMSFNCStateManagerItems.Create */ inline __fastcall TTMSFNCResponsiveManagerItems(Fmx::Tmsfncstatemanager::TTMSFNCCustomStateManager* AOwner) : Fmx::Tmsfncstatemanager::TTMSFNCStateManagerItems(AOwner) { }
...
class PASCALIMPLEMENTATION TTMSFNCResponsiveManagerPaintBox : public Fmx::Tmsfnccustomcontrol::TTMSFNCCustomControl
{
...
public:
	/* TTMSFNCCustomControl.Create */ inline __fastcall virtual TTMSFNCResponsiveManagerPaintBox(System::Classes::TComponent* AOwner) : Fmx::Tmsfnccustomcontrol::TTMSFNCCustomControl(AOwner) { }
	/* TTMSFNCCustomControl.Destroy */ inline __fastcall virtual ~TTMSFNCResponsiveManagerPaintBox() { }
	
};


class PASCALIMPLEMENTATION TTMSFNCCustomResponsiveManager : public Fmx::Tmsfncstatemanager::TTMSFNCCustomStateManager
{
	typedef Fmx::Tmsfncstatemanager::TTMSFNCCustomStateManager inherited;
...
protected:
	...
	virtual Fmx::Tmsfncstatemanager::TTMSFNCStateManagerItems* __fastcall CreateStatesCollection();
	virtual void __fastcall InternalSetActiveState(Fmx::Tmsfncstatemanager::TTMSFNCStateManagerItem* AState);
	virtual void __fastcall SetConstraint(TTMSFNCResponsiveManagerItem* AState);
	virtual void __fastcall InternalSaveToState(Fmx::Tmsfncstatemanager::TTMSFNCStateManagerItem* AState, bool ANew);
	virtual void __fastcall BeforeAssignControl();
	virtual void __fastcall AfterAssignControl();
	virtual void __fastcall BeforeLoadState(Fmx::Tmsfncstatemanager::TTMSFNCStateManagerItem* AState);
...
public:
	/* TTMSFNCCustomStateManager.Create */ inline __fastcall virtual TTMSFNCCustomResponsiveManager()/* overload */ : Fmx::Tmsfncstatemanager::TTMSFNCCustomStateManager() { }
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_FMX_TMSFNCRESPONSIVEMANAGER)
using namespace Fmx::Tmsfncresponsivemanager;
#endif
...
//-- end unit ----------------------------------------------------------------
#endif	// Fmx_TmsfncresponsivemanagerHPP
