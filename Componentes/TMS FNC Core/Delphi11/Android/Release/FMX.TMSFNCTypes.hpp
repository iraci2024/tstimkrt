...
static constexpr System::Word TMSPlatformsDesktop = System::Word(0x1087);
static constexpr int TMSPlatforms = int(0x194df);
static constexpr int TMSPlatformsWeb = int(0x194df);
static constexpr int TMSPlatformsWebDesktop = int(0x11087);
