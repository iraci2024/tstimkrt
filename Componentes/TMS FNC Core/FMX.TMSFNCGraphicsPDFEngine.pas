...
unit FMX.TMSFNCGraphicsPDFEngine;
...
uses
  Classes, FMX.TMSFNCGraphics, FMX.TMSFNCGraphicsTypes, FMX.TMSFNCPDFLib,
  FMX.Graphics, FMX.TMSFNCPDFIO, FMX.TMSFNCTypes
  {$IFNDEF LCLLIB}
  ,Types
  {$IFNDEF WEBLIB}
  {$HINTS OFF}
...
uses
  FMX.TMSFNCUtils, FMX.TMSFNCHTMLEngine, SysUtils, FMX.TMSFNCBitmapContainer, FMX.TMSFNCStyles,
  FMX.TMSFNCPDFCoreLibBase, FMX.TMSFNCPDFGraphicsLib, Math
  {$IFNDEF WEBLIB}
  {$IFDEF SVGSUPPORT}
