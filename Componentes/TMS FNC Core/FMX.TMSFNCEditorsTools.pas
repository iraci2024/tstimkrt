...
uses
  Classes, Types, FMX.TMSFNCTypes, FMX.TMSFNCGraphicsTypes, FMX.Graphics,
  FMX.TMSFNCEditorButton, FMX.TMSFNCEditorListView, FMX.TMSFNCEditorPanel,
...
implementation
uses
  FMX.TMSFNCGraphics, FMX.TMSFNCUtils
  , Math, SysUtils
  {$IFDEF FMXLIB}
