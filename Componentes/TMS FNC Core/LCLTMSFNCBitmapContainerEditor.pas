...
unit LCLTMSFNCBitmapContainerEditor;
...
uses
  Classes, LCLTMSFNCCustomComponent, LCLTMSFNCCustomControl, Controls, Graphics,
  LCLTMSFNCTypes, StdCtrls, ExtCtrls, LCLTMSFNCBitmapContainer, LCLTMSFNCURLBitmapContainer, Forms, LCLTMSFNCGraphics,
  LCLTMSFNCGraphicsTypes, LCLTMSFNCEditorListView, LCLTMSFNCEditorButton, LCLTMSFNCEditorPanel, LCLTMSFNCEditorsTools
  {$IFDEF FMXLIB}
...
uses
  LCLTMSFNCUtils, SysUtils, Dialogs, Math
  {$IFDEF WEBLIB}
  ,WEBLib.WebTools
  {$ENDIF}
  {$IFNDEF FMXMOBILE}
