...
uses
  ...
  Windows,
  {$ENDIF}
  Classes, LCLTMSFNCGraphicsTypes, Graphics,
  {$IFDEF WEBLIB}
  JS,
  {$ENDIF}
...
uses
  ...
  ,LCLTMSFNCHTMLEngine
  {$ENDIF}
  ,LCLTMSFNCGraphicsGeneral
  {$IFDEF WEBLIB}
  ,LCLTMSFNCGraphics.WEB
  {$ENDIF}
  {$IFDEF MSWINDOWS}
  ,LCLTMSFNCGraphicsWin
  {$ENDIF}
  {$IFDEF MACOS}
  {$IFDEF IOS}
  ,LCLTMSFNCGraphics.iOS
  {$ENDIF}
  {$IFNDEF IOS}
  ,LCLTMSFNCGraphics.Mac
  {$ENDIF}
  {$ENDIF}
  {$IFDEF ANDROID}
  ,LCLTMSFNCGraphics.Android
  {$ENDIF}
  {$IFDEF UNIX}
  ,LCLTMSFNCGraphicsUnix
  {$ENDIF}
  {$IFDEF LCLLIB}
  {$IFNDEF MSWINDOWS}
  ,LCLIntF
