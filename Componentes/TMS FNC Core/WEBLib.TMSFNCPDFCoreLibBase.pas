...
unit WEBLib.TMSFNCPDFCoreLibBase;
...
uses
  Classes, Types, WEBLib.TMSFNCGraphics, WEBLib.TMSFNCBitmapContainer, WEBLib.TMSFNCGraphicsTypes, WEBLib.Graphics, WEBLib.TMSFNCTypes
  {$IFDEF WEBLIB}
  ,Contnrs
  {$ENDIF}
  {$IFNDEF LCLWEBLIB}
...
type
  ...
  {$ENDIF}
  {$IFNDEF WEBLIB}
  TTMSFNCPDFPlatformServicesList = class(TObjectList<TTMSFNCPDFPlatformServicesService>)
  {$ENDIF}
  private
...
{$ENDIF}
  ...
  {$ENDIF}
  {$IFNDEF WEBLIB}
  TTMSFNCPDFGraphicsLibUsedFontCharArray = class(TList<Integer>);
  {$ENDIF}
  ...
  {$ENDIF}
  {$IFNDEF WEBLIB}
  TTMSFNCPDFGraphicsLibOutputWriterStreams = class(TObjectList<TStream>);
  {$ENDIF}
...
uses
  SysUtils, WEBLib.TMSFNCUtils, Math, DateUtils
  {$IFNDEF LCLWEBLIB}
  ,zlib
  {$ENDIF}
  {$IFDEF LCLLIB}
