...
uses
  ...
  Windows,
  {$ENDIF}
  Classes, Types, VCL.TMSFNCTypes, VCL.Graphics
  {$IFNDEF LCLWEBLIB}
  {$HINTS OFF}
  {$IF COMPILERVERSION > 22}
  ,UITypes
...
constructor TTMSFNCGraphicsFillGradientItem.Create(Collection: TCollection);
begin
  inherited;
  FColor := gcWhite;
  FPosition := 0.0;
