...
uses
  Classes, Types, WEBLib.TMSFNCCustomComponent, WEBLib.TMSFNCUtils, WEBLib.TMSFNCTypes, SysUtils
  {$IFNDEF LCLWEBLIB}
...
type
  ...
  {$ENDIF}
  {$IFNDEF WEBLIB}
  TTMSFNCCloudBaseRequestHeaders = class(TObjectList<TTMSFNCCloudBaseRequestHeader>);

  TTMSFNCCloudBaseRequests = class(TObjectList<TTMSFNCCloudBaseRequest>);
  {$ENDIF}
  ...
  {$ENDIF}
  {$IFNDEF WEBLIB}
  TTMSFNCCloudBaseList = class(TList<ITMSFNCCustomCloudBase>);
  {$ENDIF}
  ...
  {$ENDIF}
  {$IFNDEF WEBLIB}
  TTMSFNCCloudPlatformServicesList = class(TObjectList<TTMSFNCCloudPlatformServicesService>)
  {$ENDIF}
  private
...
uses
  StrUtils
  {$IFDEF MSWINDOWS}
  ,WEBLib.TMSFNCCloudBase.Win
  {$ENDIF}
  {$IFDEF UNIX}
  ,WEBLib.TMSFNCCloudBase.Unix
  {$ENDIF}
  {$IFDEF MACOS}
  ,WEBLib.TMSFNCCloudBase.Mac
  {$ENDIF}
  {$IFDEF ANDROID}
  ,WEBLib.TMSFNCCloudBase.Android
  {$ENDIF}
  {$IFDEF WEBLIB}
  ,WEBLib.TMSFNCCloudBase.WEB
  {$ENDIF}
  ;
