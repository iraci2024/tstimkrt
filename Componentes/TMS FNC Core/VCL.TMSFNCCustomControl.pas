...
uses
  ...
  {%H-}Windows,
  {$ENDIF}
  Classes, VCL.Controls, VCL.TMSFNCGraphics, VCL.Graphics, VCL.TMSFNCStyles
  ,VCL.TMSFNCPersistence, VCL.TMSFNCUndo
  {$IFNDEF WEBLIB}
  {$IFDEF FNCLIB}
  ,VCL.TMSFNCHint
  {$ELSE}
  ...
  {$ENDIF}
  {$ENDIF}
  ,Types, VCL.TMSFNCGraphicsTypes, VCL.TMSFNCTypes, TypInfo, VCL.Forms
  {$IFDEF VCLLIB}
  ,Messages
  {$ENDIF}
  {$IFDEF WEBLIB}
