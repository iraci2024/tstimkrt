...
uses
  ...
  Windows,
  {$ENDIF}
  Classes, FMX.TMSFNCGraphicsTypes, FMX.Graphics,
  {$IFDEF WEBLIB}
  JS,
  {$ENDIF}
...
uses
  ...
  ,FMX.TMSFNCUtils
  {$IFNDEF LIMITEDGRAPHICSMODE}
  ,FMX.TMSFNCHTMLEngine
  {$ENDIF}
  ,FMX.TMSFNCGraphics.General
  {$IFDEF WEBLIB}
  ,FMX.TMSFNCGraphics.WEB
  {$ENDIF}
  {$IFDEF MSWINDOWS}
  ,FMX.TMSFNCGraphics.Win
  {$ENDIF}
  {$IFDEF MACOS}
  {$IFDEF IOS}
  ,FMX.TMSFNCGraphics.iOS
  {$ENDIF}
  {$IFNDEF IOS}
  ,FMX.TMSFNCGraphics.Mac
  {$ENDIF}
  {$ENDIF}
  {$IFDEF ANDROID}
  ,FMX.TMSFNCGraphics.Android
  {$ENDIF}
  {$IFDEF UNIX}
  ,FMX.TMSFNCGraphics.Unix
  {$ENDIF}
  {$IFDEF LCLLIB}
  {$IFNDEF MSWINDOWS}
  ,LCLIntF
