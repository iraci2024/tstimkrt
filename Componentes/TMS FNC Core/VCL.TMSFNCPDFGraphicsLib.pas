...
uses
  Classes, VCL.TMSFNCPDFCoreLibBase, VCL.TMSFNCPDFRichTextLib, VCL.TMSFNCTypes, VCL.TMSFNCBitmapContainer,
...
{$IFDEF MACOS}
{$IFDEF IOS}
  VCL.TMSFNCPDFGraphicsLib.iOS,
{$ELSE}
  VCL.TMSFNCPDFGraphicsLib.Mac,
{$ENDIF}
{$ENDIF}
{$IFDEF ANDROID}
  VCL.TMSFNCPDFGraphicsLib.Android,
{$ENDIF}
  VCL.TMSFNCPDFGraphicsLib.General,
  SysUtils
  {$IFDEF FMXLIB}
  ,FMX.Types
  {$ENDIF}
