...
unit WEBLib.TMSFNCGraphicsPDFEngine;
...
uses
  Classes, WEBLib.TMSFNCGraphics, WEBLib.TMSFNCGraphicsTypes, WEBLib.TMSFNCPDFLib,
  WEBLib.Graphics, WEBLib.TMSFNCPDFIO, WEBLib.TMSFNCTypes
  {$IFNDEF LCLLIB}
  ,Types
  {$IFNDEF WEBLIB}
  {$HINTS OFF}
...
uses
  WEBLib.TMSFNCUtils, WEBLib.TMSFNCHTMLEngine, SysUtils, WEBLib.TMSFNCBitmapContainer, WEBLib.TMSFNCStyles,
  WEBLib.TMSFNCPDFCoreLibBase, WEBLib.TMSFNCPDFGraphicsLib, Math
  {$IFNDEF WEBLIB}
  {$IFDEF SVGSUPPORT}
  ,WEBLib.TMSFNCGraphicsSVGEngine
  {$ENDIF}
  {$ENDIF}
  ;
