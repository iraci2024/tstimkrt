...
uses
  ...
  LCLTMSFNCTypes, StdCtrls, ExtCtrls, Forms, LCLTMSFNCGraphics,
  LCLTMSFNCGraphicsTypes, LCLTMSFNCStyles,
  LCLTMSFNCEditorButton, LCLTMSFNCEditorPanel, LCLTMSFNCEditorListView
  {$IFDEF FMXLIB}
...
type
  ...
  {$ENDIF}
  {$IFNDEF WEBLIB}
  TTMSFNCStylesListItems = class(specialize TFPGObjectList<TTMSFNCStylesListItem>);
  {$ENDIF}
  ...
  {$ENDIF}
  {$IFNDEF WEBLIB}
  TTMSFNCStylesListItemsRef = class(specialize TFPGList<TTMSFNCStylesListItem>);
  {$ENDIF}
...
uses
  LCLTMSFNCUtils, Graphics, SysUtils, Dialogs,
  LCLTMSFNCEditorsTools, Math;
