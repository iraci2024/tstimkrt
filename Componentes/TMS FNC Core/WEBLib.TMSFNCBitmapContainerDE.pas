...
unit WEBLib.TMSFNCBitmapContainerDE;
...
uses
  Classes, WEBLib.TMSFNCGeneralDE, WEBLib.TMSFNCBitmapContainer
  {$IFNDEF LCLWEBLIB}
...
uses
  SysUtils, WEBLib.Dialogs, WEBLib.TMSFNCBitmapContainerEditor
  {$IFDEF WEBLIB}
  ,WEBLib.WEBTools
  {$ENDIF}
  {$IFNDEF LCLLIB}
