...
unit WEBLib.TMSFNCResponsiveManager;
...
uses
  Classes, WEBLib.TMSFNCStateManager, WEBLib.TMSFNCCustomControl, Types, WEBLib.TMSFNCTypes
  {$IFNDEF LCLLIB}
...
uses
  SysUtils, Math, WEBLib.Graphics, WEBLib.Forms, WEBLib.Controls,
