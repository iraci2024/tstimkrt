...
uses
  Classes, LCLTMSFNCGraphics, LCLTMSFNCTypes, Forms, Types, SysUtils, LCLTMSFNCUtils,
  LCLTMSFNCWebBrowser, LCLTMSFNCPersistence, DateUtils
  {$IFNDEF LCLLIB}
...
type
  ...
  TTMSFNCWinWebBrowserCachedFolderList = specialize TFPGObjectList<TTMSFNCWinWebBrowserCachedFolderItem>;
  {$ENDIF}
