...
unit LCLTMSFNCResponsiveManager;
...
uses
  Classes, LCLTMSFNCStateManager, LCLTMSFNCCustomControl, Types, LCLTMSFNCTypes
  {$IFNDEF LCLLIB}
...
type
  ...
  TTMSFNCResponsiveManagerItemList = specialize TFPGList<TTMSFNCResponsiveManagerItem>;
...
uses
  ...
  LCLTMSFNCUtils, LCLTMSFNCGraphics, LCLTMSFNCGraphicsTypes;
...
constructor TTMSFNCResponsiveManagerItem.Create(ACollection: TCollection);
var
