...
unit WEBLib.TMSFNCPDFLib.General;
...
uses
  Classes, Math, DateUtils, Types, SysUtils, WEBLib.TMSFNCPDFGraphicsLib, WEBLib.TMSFNCGraphics, WEBLib.TMSFNCGraphicsTypes
  ,WEBLib.TMSFNCPDFLib, WEBLib.TMSFNCUtils, WEBLib.TMSFNCPDFCoreLibBase, WEBLib.Graphics, WEBLib.TMSFNCTypes,
  ...
  {$IFDEF MACOS}
  {$IFDEF IOS}
  ,WEBLib.TMSFNCPDFLib.General.iOS
  {$ELSE}
  ,WEBLib.TMSFNCPDFLib.General.Mac
  {$ENDIF}
  {$ENDIF}
  {$IFDEF ANDROID}
  ,WEBLib.TMSFNCPDFLib.General.Android
  {$ENDIF}
  {$IFDEF MSWINDOWS}
  ,WEBLib.TMSFNCPDFLib.General.Win
  {$ENDIF}
  {$IFDEF UNIX}
  ,WEBLib.TMSFNCPDFLib.General.Unix
  {$ENDIF}
  {$IFDEF WEBLIB}
  ,WEBLib.TMSFNCPDFLib.General.WEB
  {$ENDIF}
  {$IFDEF LCLLIB}
  {$IFNDEF MSWINDOWS}
  {$IFNDEF UNIX}
  ,WEBLib.TMSFNCPDFLib.General.Default
  {$ENDIF}
  {$ENDIF}
  {$ENDIF}
  ;
