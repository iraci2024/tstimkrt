...
uses
  Classes, FMX.Graphics, FMX.Controls, FMX.Forms, FMX.TMSFNCTypes, FMX.TMSFNCCustomComponent, FMX.TMSFNCGraphicsTypes
  {$IFDEF FMXLIB}
  ,FMX.Types, UITypes
  {$ENDIF}
...
uses
  FMX.TMSFNCUtils, SysUtils, FMX.TMSFNCPersistence, FMX.TMSFNCGraphics
  {$IFDEF FMXLIB}
