...
unit WEBLib.TMSFNCGraphicsAppearanceEditorDE;
...
uses
  WEBLib.TMSFNCUtils, WEBLib.TMSFNCTypes, SysUtils, WEBLib.TMSFNCGraphicsTypes, WEBLib.TMSFNCGraphicsAppearanceEditor
  {$IFNDEF LCLLIB}
  ,UITypes
  {$ENDIF}
  {$IFDEF FMXLIB}
