...
unit LCLTMSFNCCustomScrollControl;
...
uses
  ...
  Windows,
  {$ENDIF}
  Classes, LCLTMSFNCCustomControl, StdCtrls, LCLTMSFNCScrollBar, LCLTMSFNCGraphics,
  LCLTMSFNCTypes, ExtCtrls
  {$IFNDEF LCLLIB}
  ,Types
  {$ENDIF}
  {$IFDEF FMXLIB}
...
uses
  ...
  {$ENDIF}
  Forms, Math,
  LCLTMSFNCGraphicsTypes, SysUtils;
