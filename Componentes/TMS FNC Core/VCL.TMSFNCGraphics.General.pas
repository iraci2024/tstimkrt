...
unit VCL.TMSFNCGraphics.General;
...
uses
  ...
  Windows,
  {$ENDIF}
  Classes, VCL.TMSFNCGraphicsTypes,
  Types, VCL.Graphics, VCL.TMSFNCGraphics,
  VCL.TMSFNCTypes
  {$IFDEF FMXLIB}
...
procedure TTMSFNCGraphicsContextGeneral.BeginPrinting;
begin
  FPrinting := True;
end;
...
procedure TTMSFNCGraphicsContextGeneral.EndPrinting;
begin
  if FPrinting then
    FPrinting := False;
end;
...
function TTMSFNCGraphicsContextGeneral.GetMatrix: TTMSFNCGraphicsMatrix;
{$IFDEF FMXLIB}
var
  M: TMatrix;
{$ENDIF}
...
procedure TTMSFNCGraphicsContextGeneral.SetScale(AScale: Single);
begin
end;

procedure TTMSFNCGraphicsContextGeneral.SetMatrix(
