...
unit WEBLib.TMSFNCEditorListView;
...
uses
  Classes, Types , WEBLib.TMSFNCTypes, WEBLib.Controls, WEBLib.StdCtrls, WEBLib.TMSFNCCustomControl
  , WEBLib.TMSFNCGraphics, WEBLib.TMSFNCGraphicsTypes
  {$IFDEF FNCLIB}
  ,WEBLib.TMSFNCBitmapEditor
  {$ENDIF}
  {$IFDEF FMXLIB}
  ,FMX.Types, FMX.Edit
  {$ENDIF}
...
uses
  TypInfo, SysUtils, WEBLib.TMSFNCUtils, Math, WEBLib.Graphics
  {$IFNDEF LIMITEDGRAPHICSMODE}
  , WEBLib.TMSFNCBitmapContainer
  {$ENDIF}
  {$IFDEF FNCLIB}
  , WEBLib.TMSFNCURLBitmapContainer
  {$ENDIF}
  {$IFDEF VCLLIB}
...
begin
  if {$IFNDEF LCLWEBLIB}Assigned(ACollection) and {$ENDIF} (Collection is TTMSFNCEditorListCollection) and Assigned((Collection as TTMSFNCEditorListCollection).FOwner)
...
constructor TTMSFNCEditorListItem.Create(ACollection: TCollection);
begin
  inherited;
  ...
  if Assigned(ACollection) and (Collection is TTMSFNCEditorListCollection) and Assigned((Collection as TTMSFNCEditorListCollection).FOwner)
        and ((Collection as TTMSFNCEditorListCollection).FOwner is TTMSFNCEditorListView) then
  begin
