...
uses
  Classes, VCL.TMSFNCDataBinding, VCL.TMSFNCGeneralDE, VCL.TMSFNCDataBindingEditor, TypInfo
  {$IFNDEF LCLWEBLIB}
...
uses
  SysUtils, VCL.Dialogs, VCL.TMSFNCUtils, VCL.TMSFNCPersistence
  {$IFDEF FMXLIB}
  ,VCL.Forms
  {$ENDIF}
  {$IFDEF VCLLIB}
