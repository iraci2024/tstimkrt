...
uses
  Classes, LCLTMSFNCDataBinding, LCLTMSFNCGeneralDE, LCLTMSFNCDataBindingEditor, TypInfo
  {$IFNDEF LCLWEBLIB}
...
uses
  SysUtils, Dialogs, LCLTMSFNCUtils, LCLTMSFNCPersistence
  {$IFDEF FMXLIB}
  ,Forms
  {$ENDIF}
  {$IFDEF VCLLIB}
