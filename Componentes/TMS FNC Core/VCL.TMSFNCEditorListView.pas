...
uses
  Classes, Types , VCL.TMSFNCTypes, VCL.Controls, VCL.StdCtrls, VCL.TMSFNCCustomControl
  , VCL.TMSFNCGraphics, VCL.TMSFNCGraphicsTypes
  {$IFDEF FNCLIB}
  ,VCL.TMSFNCBitmapEditor
  {$ENDIF}
  {$IFDEF FMXLIB}
  ,FMX.Types, FMX.Edit
  {$ENDIF}
...
uses
  TypInfo, SysUtils, VCL.TMSFNCUtils, Math, VCL.Graphics
  {$IFNDEF LIMITEDGRAPHICSMODE}
  , VCL.TMSFNCBitmapContainer
  {$ENDIF}
  {$IFDEF FNCLIB}
  , VCL.TMSFNCURLBitmapContainer
  {$ENDIF}
  {$IFDEF VCLLIB}
