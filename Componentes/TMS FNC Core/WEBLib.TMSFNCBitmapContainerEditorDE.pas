...
unit WEBLib.TMSFNCBitmapContainerEditorDE;
...
uses
  WEBLib.TMSFNCBitmapContainerEditor, WEBLib.TMSFNCBitmapContainer, WEBLib.TMSFNCUtils, WEBLib.TMSFNCTypes, SysUtils
  {$IFNDEF LCLLIB}
  ,UITypes
  {$ENDIF}
  {$IFDEF FMXLIB}
