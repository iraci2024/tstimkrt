...
uses
  Classes, LCLTMSFNCCustomComponent, LCLTMSFNCPDFLib, LCLTMSFNCPDFCoreLibBase, LCLTMSFNCTypes,
  LCLTMSFNCPDFGraphicsLib, LCLTMSFNCBitmapContainer, LCLTMSFNCGraphicsTypes
  {$IFNDEF LCLLIB}
  , Types
  {$ENDIF}
  ;
