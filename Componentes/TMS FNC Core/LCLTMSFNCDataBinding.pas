...
uses
  Classes, LCLTMSFNCPersistence, LCLTMSFNCTypes, LCLTMSFNCCustomComponent,
  Controls, TypInfo
  {$IFNDEF LCLWEBLIB}
...
uses
  Graphics, Forms, LCLTMSFNCUtils, LCLTMSFNCCustomControl, SysUtils,
  LCLTMSFNCGraphics, LCLTMSFNCGraphicsTypes, LCLTMSFNCDataBindingEditor
  {$IFDEF VCLLIB}
  , JPEG
  {$ENDIF}
  ;
