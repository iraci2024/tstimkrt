...
unit WEBLib.TMSFNCPDFGraphicsLib.General;
...
uses
  Classes, WEBLib.TMSFNCPDFGraphicsLib, SysUtils, WEBLib.TMSFNCTypes, WEBLib.Graphics, WEBLib.TMSFNCPDFLib
  ,WEBLib.TMSFNCPDFRichTextLib, WEBLib.TMSFNCPDFCoreLibBase, WEBLib.TMSFNCPDFGraphicsLibHTMLEngine, WEBLib.TMSFNCUtils,
  WEBLib.TMSFNCBitmapContainer, WEBLib.TMSFNCGraphicsTypes
  {$IFNDEF WEBLIB}
  {$IFDEF SVGSUPPORT}
