...
type
  ...
  TTMSFNCObjectDictionary = class(specialize TFPGMap<string, TObject>);
  TTMSFNCObjectList = class(specialize TFPGObjectList<TObject>);
  TTMSFNCStringList = class(specialize TFPGList<string>);
  TTMSFNCIntegerList = class(specialize TFPGList<Integer>);
  TTMSFNCDoubleList = class(specialize TFPGList<Double>);
  ...
  TTMSFNCObjectReferences = specialize TFPGObjectList<TTMSFNCObjectReference>;
  ...
  TTMSFNCJSONToClassProperties = class(specialize TFPGObjectList<TTMSFNCJSONToClassProperty>);
  ...
  TTMSFNCJSONToClassItems = class(specialize TFPGObjectList<TTMSFNCJSONToClassItem>);
...
begin
  ...
  repeat
    cn := AClass.ClassName;
    if AnsiStartsStr('specialize TFPGMap<', cn) or AnsiStartsStr('TObjectDictionary<', cn) then
      Exit(True);
    AClass := AClass.ClassParent;
  until not Assigned(AClass);
  Result := False;
...
begin
  ...
  repeat
    cn := AClass.ClassName;
    if AnsiStartsStr('specialize TFPGList<', cn) or AnsiStartsStr('specialize TFPGObjectList<', cn) then
    begin
...
begin
  ...
  case t of
    ...
    cptObjectArray: Result := 'specialize TFPGObjectList<' + 'T' + DelphiName(ACallback, AOptions, False) + '>';
    cptDoubleArray: Result := 'specialize TFPGList<Double>';
    cptStringArray: Result := 'specialize TFPGList<string>';
    cptBooleanArray: Result := 'specialize TFPGList<Boolean>';
    cptDateTimeArray: Result := 'specialize TFPGList<TDateTime>';
    cptIntegerArray: Result := 'specialize TFPGList<Integer>';
    cptInteger64Array: Result := 'specialize TFPGList<Int64>';
  end;
end;
