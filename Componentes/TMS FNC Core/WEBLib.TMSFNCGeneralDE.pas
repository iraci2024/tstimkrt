...
uses
  ...
  SysUtils
  {$IFDEF FNCLIB}
  ,WEBLib.TMSFNCStylesEditor
  {$ENDIF}
  ,WEBLib.TMSFNCStyles, WEBLib.TMSFNCCustomComponent, WEBLib.TMSFNCTypes,
  WEBLib.TMSFNCPersistence, WEBLib.TMSFNCUtils, DateUtils, WEBLib.Dialogs
  {$IFNDEF LCLWEBLIB}
  {$HINTS OFF}
  ...
  {$ENDIF}
  {$IFDEF VCLLIB}
  ,WEBLib.TMSFNCGraphics, WEBLib.TMSFNCGraphicsTypes, VCL.Forms
  {$ENDIF}
  {$IFDEF FMXLIB}
  ,WEBLib.Forms
  {$ENDIF}
...
begin
  inherited;
  Proc('WEBLib.TMSFNCTypes');
  Proc('WEBLib.TMSFNCUtils');
  Proc('WEBLib.TMSFNCGraphics');
  Proc('WEBLib.TMSFNCGraphicsTypes');
end;
{$ENDIF}
