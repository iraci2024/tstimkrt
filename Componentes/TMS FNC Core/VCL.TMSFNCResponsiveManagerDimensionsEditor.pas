...
unit VCL.TMSFNCResponsiveManagerDimensionsEditor;
...
uses
  ...
  VCL.TMSFNCTypes, VCL.StdCtrls, VCL.ExtCtrls, VCL.Forms, VCL.TMSFNCResponsiveManager,
...
uses
  ...
  VCL.TMSFNCEditorsTools, VCL.TMSFNCGraphicsTypes, Math
  {$IFDEF FMXLIB}
  ,JSON
  {$ENDIF}
  {$IFDEF VCLLIB}
