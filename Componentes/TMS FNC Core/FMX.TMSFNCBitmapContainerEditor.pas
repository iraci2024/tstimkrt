...
unit FMX.TMSFNCBitmapContainerEditor;
...
uses
  Classes, FMX.TMSFNCCustomComponent, FMX.TMSFNCCustomControl, FMX.Controls, FMX.Graphics,
  FMX.TMSFNCTypes, FMX.StdCtrls, FMX.ExtCtrls, FMX.TMSFNCBitmapContainer, FMX.TMSFNCURLBitmapContainer, FMX.Forms, FMX.TMSFNCGraphics,
  FMX.TMSFNCGraphicsTypes, FMX.TMSFNCEditorListView, FMX.TMSFNCEditorButton, FMX.TMSFNCEditorPanel, FMX.TMSFNCEditorsTools
  {$IFDEF FMXLIB}
...
uses
  FMX.TMSFNCUtils, SysUtils, FMX.Dialogs, Math
  {$IFDEF WEBLIB}
  ,WEBLib.WebTools
  {$ENDIF}
  {$IFNDEF FMXMOBILE}
...
procedure TTMSFNCBitmapContainerEditor.Notification(AComponent: TComponent; AOperation: TOperation);
begin
  inherited;
