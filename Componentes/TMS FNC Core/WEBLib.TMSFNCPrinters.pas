...
uses
  Classes, Types, WEBLib.TMSFNCUtils, WEBLib.TMSFNCTypes, WEBLib.TMSFNCGraphics, WEBLib.Graphics, WEBLib.Printers
  {$IFDEF WEBLib}
  , web, JS
  {$ENDIF}
  {$IFNDEF LCLWEBLIB}
