...
uses
  ...
  VCL.TMSFNCTypes, VCL.StdCtrls, VCL.ExtCtrls, VCL.Forms, VCL.TMSFNCGraphics,
  VCL.TMSFNCGraphicsTypes, VCL.TMSFNCStyles,
  VCL.TMSFNCEditorButton, VCL.TMSFNCEditorPanel, VCL.TMSFNCEditorListView
  {$IFDEF FMXLIB}
...
uses
  VCL.TMSFNCUtils, VCL.Graphics, SysUtils, VCL.Dialogs,
  VCL.TMSFNCEditorsTools, Math;
