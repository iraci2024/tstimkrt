...
unit WEBLib.TMSFNCEditorButton;
...
uses
  Classes, Types , WEBLib.TMSFNCTypes, WEBLib.Controls, WEBLib.StdCtrls, WEBLib.Forms
  , WEBLib.TMSFNCCustomControl, WEBLib.TMSFNCGraphics, WEBLib.TMSFNCGraphicsTypes
  {$IFDEF FMXLIB}
  {$HINTS OFF}
...
uses
  TypInfo, SysUtils, WEBLib.TMSFNCUtils, Math
  {$IFDEF VCLLIB}
