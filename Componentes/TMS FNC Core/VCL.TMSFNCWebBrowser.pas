...
uses
  ...
  Menus,
  {$ENDIF}
  Types, VCL.TMSFNCCustomControl, VCL.TMSFNCGraphics, VCL.TMSFNCUtils, VCL.TMSFNCTypes,
  Classes, TypInfo,
  {$IFNDEF LCLLIB}
...
uses
  SysUtils, VCL.TMSFNCGraphicsTypes
{$IFDEF FMXLIB}
  ,FMX.Platform
{$ENDIF}
{$IFDEF WEBLIB}
  ,VCL.TMSFNCWebBrowser.WEB
{$ENDIF}
{$IFDEF MSWINDOWS}
  ,VCL.TMSFNCWebBrowser.Win
{$ENDIF}
{$IFDEF UNIX}
  ,VCL.TMSFNCWebBrowser.Unix
{$ENDIF}
{$IFDEF MACOS}
{$IFDEF IOS}
  ,VCL.TMSFNCWebBrowser.iOS
{$ELSE}
  ,VCL.TMSFNCWebBrowser.Mac
{$ENDIF}
{$ENDIF}
{$IFDEF ANDROID}
  ,VCL.TMSFNCWebBrowser.Android
{$ENDIF}
  ;
