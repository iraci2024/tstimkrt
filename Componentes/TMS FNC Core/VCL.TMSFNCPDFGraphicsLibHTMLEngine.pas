...
unit VCL.TMSFNCPDFGraphicsLibHTMLEngine;
...
uses
  VCL.TMSFNCTypes, VCL.Graphics, VCL.TMSFNCBitmapContainer, VCL.TMSFNCGraphics, VCL.TMSFNCPDFLib,
...
uses
  Classes, SysUtils, VCL.TMSFNCPDFCoreLibBase,
  VCL.TMSFNCUtils, Math
