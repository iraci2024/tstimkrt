...
uses
  ...
  {%H-}Windows,
  {$ENDIF}
  Classes, FMX.Controls, FMX.TMSFNCGraphics, FMX.Graphics, FMX.TMSFNCStyles
  ,FMX.TMSFNCPersistence, FMX.TMSFNCUndo
  {$IFNDEF WEBLIB}
  {$IFDEF FNCLIB}
  ,FMX.TMSFNCHint
  {$ELSE}
  ...
  {$ENDIF}
  {$ENDIF}
  ,Types, FMX.TMSFNCGraphicsTypes, FMX.TMSFNCTypes, TypInfo, FMX.Forms
  {$IFDEF VCLLIB}
  ,Messages
  {$ENDIF}
  {$IFDEF WEBLIB}
...
type
  ...
  public
    ...
    property BlockRepaint: Boolean read FBlockRepaint write FBlockRepaint;
  published
