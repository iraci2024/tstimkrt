...
uses
  ...
  Menus,
  {$ENDIF}
  Types, LCLTMSFNCCustomControl, LCLTMSFNCGraphics, LCLTMSFNCUtils, LCLTMSFNCTypes,
  Classes, TypInfo,
  {$IFNDEF LCLLIB}
...
type
  ...
  TTMSFNCWebBrowserContextMenuItemList = class(specialize TFPGObjectList<TTMSFNCWebBrowserContextMenuItem>);
  ...
  private
    ...
    function GetChildren: specialize TFPGObjectList<TTMSFNCWebBrowserContextMenuItem>;
  ...
  public
    ...
    property Children: specialize TFPGObjectList<TTMSFNCWebBrowserContextMenuItem> read GetChildren;
  ...
  TTMSFNCWebBrowserOnGetContextMenu = procedure(Sender: TObject; ATarget: TTMSFNCWebBrowserTargetItem; AContextMenu: specialize TFPGObjectList<TTMSFNCWebBrowserContextMenuItem>) of object;
  ...
  TTMSFNCScriptList = class(specialize TFPGObjectList<TTMSFNCScript>);
  {$ENDIF}
...
//    property EnableScript;
  ...
  protected
    ...
    procedure DoGetContextMenuItemEvent(ATarget: TTMSFNCWebBrowserTargetItem; AContextMenu: specialize TFPGObjectList<TTMSFNCWebBrowserContextMenuItem>);
  ...
  {$ENDIF}
  {$IFNDEF WEBLIB}
  TTMSFNCWebBrowserList = class(specialize TFPGList<ITMSFNCCustomWebBrowser>);
  {$ENDIF}
  ...
  {$ENDIF}
  {$IFNDEF WEBLIB}
  TTMSFNCWebBrowserPlatformServicesList = class(specialize TFPGObjectList<TTMSFNCWebBrowserPlatformServicesService>)
  {$ENDIF}
  private
...
uses
  SysUtils, LCLTMSFNCGraphicsTypes
{$IFDEF FMXLIB}
  ,FMX.Platform
{$ENDIF}
{$IFDEF WEBLIB}
  ,LCLTMSFNCWebBrowser.WEB
{$ENDIF}
{$IFDEF MSWINDOWS}
  ,LCLTMSFNCWebBrowserWin
{$ENDIF}
{$IFDEF UNIX}
  ,LCLTMSFNCWebBrowserUnix
{$ENDIF}
{$IFDEF MACOS}
{$IFDEF IOS}
  ,LCLTMSFNCWebBrowser.iOS
{$ELSE}
  ,LCLTMSFNCWebBrowser.Mac
{$ENDIF}
{$ENDIF}
{$IFDEF ANDROID}
  ,LCLTMSFNCWebBrowser.Android
{$ENDIF}
  ;
...
procedure TTMSFNCCustomWebBrowser.DoGetContextMenuItemEvent(ATarget: TTMSFNCWebBrowserTargetItem; AContextMenu: specialize TFPGObjectList<TTMSFNCWebBrowserContextMenuItem>);
begin
...
function TTMSFNCWebBrowserSystemContextMenuItem.GetChildren: specialize TFPGObjectList<TTMSFNCWebBrowserContextMenuItem>;
begin
