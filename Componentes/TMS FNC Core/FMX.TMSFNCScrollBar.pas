...
uses
  Classes, FMX.TMSFNCCustomControl, FMX.ExtCtrls,
  FMX.TMSFNCTypes, FMX.TMSFNCGraphics, FMX.Controls,
...
uses
  Math, FMX.TMSFNCStyles, FMX.TMSFNCUtils;
