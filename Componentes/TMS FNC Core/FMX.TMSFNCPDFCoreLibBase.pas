...
uses
  Classes, Types, FMX.TMSFNCGraphics, FMX.TMSFNCBitmapContainer, FMX.TMSFNCGraphicsTypes, FMX.Graphics, FMX.TMSFNCTypes
  {$IFDEF WEBLIB}
  ,Contnrs
  {$ENDIF}
  {$IFNDEF LCLWEBLIB}
...
uses
  SysUtils, FMX.TMSFNCUtils, Math, DateUtils
  {$IFNDEF LCLWEBLIB}
  ,zlib
  {$ENDIF}
  {$IFDEF LCLLIB}
