...
unit WEBLib.TMSFNCPDFRichTextLib;
...
uses
  Classes, WEBLib.TMSFNCPDFCoreLibBase, WEBLib.TMSFNCGraphicsTypes, WEBLib.TMSFNCTypes
  {$IFDEF WEBLIB}
  ,Contnrs
  {$ENDIF}
  {$IFNDEF LCLWEBLIB}
...
{$IFDEF MACOS}
{$IFDEF IOS}
  WEBLib.TMSFNCPDFRichTextLib.iOS,
{$ELSE}
  WEBLib.TMSFNCPDFRichTextLib.Mac,
{$ENDIF}
{$ENDIF}
{$IFDEF ANDROID}
  WEBLib.TMSFNCPDFRichTextLib.Android,
{$ENDIF}
{$IFNDEF MACOS}
{$IFNDEF ANDROID}
  WEBLib.TMSFNCPDFRichTextLib.General,
{$ENDIF}
{$ENDIF}
  SysUtils
  {$IFDEF FMXLIB}
