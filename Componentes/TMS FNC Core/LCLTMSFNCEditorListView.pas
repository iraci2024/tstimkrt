...
uses
  Classes, Types , LCLTMSFNCTypes, Controls, StdCtrls, LCLTMSFNCCustomControl
  , LCLTMSFNCGraphics, LCLTMSFNCGraphicsTypes
  {$IFDEF FNCLIB}
  ,LCLTMSFNCBitmapEditor
  {$ENDIF}
  {$IFDEF FMXLIB}
  ,FMX.Types, FMX.Edit
  {$ENDIF}
...
uses
  TypInfo, SysUtils, LCLTMSFNCUtils, Math, Graphics
  {$IFNDEF LIMITEDGRAPHICSMODE}
  , LCLTMSFNCBitmapContainer
  {$ENDIF}
  {$IFDEF FNCLIB}
  , LCLTMSFNCURLBitmapContainer
  {$ENDIF}
  {$IFDEF VCLLIB}
