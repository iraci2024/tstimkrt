...
unit LCLTMSFNCCustomWEBComponent;
...
uses
  Classes, Controls, LCLTMSFNCTypes, LCLTMSFNCCustomWEBControl;
...
uses
  LCLTMSFNCUtils, SysUtils, LCLTMSFNCGraphics,
  Graphics, LCLTMSFNCGraphicsTypes
  {$IFDEF WEBLIB}
  ,WEBLib.DesignIntf
  {$ENDIF}
  {$IFNDEF LCLLIB}
