...
uses
  Classes, VCL.TMSFNCGraphics, VCL.TMSFNCTypes, VCL.Forms, Types, SysUtils, VCL.TMSFNCUtils,
  VCL.TMSFNCWebBrowser, VCL.TMSFNCPersistence, DateUtils
  {$IFNDEF LCLLIB}
