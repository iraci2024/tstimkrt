...
uses
  Classes, VCL.TMSFNCCustomComponent, VCL.TMSFNCTypes,
  VCL.Forms, VCL.Controls, VCL.TMSFNCJSONWriter, VCL.TMSFNCPersistence
  {$IFDEF FMXLIB}
  ,FMX.Types
  {$ENDIF}
  ,TypInfo
...
uses
  VCL.TMSFNCGraphics, SysUtils, Math, Types, VCL.TMSFNCUtils,
  VCL.TMSFNCCustomControl, VCL.TMSFNCGraphicsTypes, VCL.Graphics
  {$IFDEF WEBLIB}
