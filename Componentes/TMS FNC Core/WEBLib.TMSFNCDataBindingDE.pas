...
unit WEBLib.TMSFNCDataBindingDE;
...
uses
  Classes, WEBLib.TMSFNCDataBinding, WEBLib.TMSFNCGeneralDE, WEBLib.TMSFNCDataBindingEditor, TypInfo
  {$IFNDEF LCLWEBLIB}
...
uses
  SysUtils, WEBLib.Dialogs, WEBLib.TMSFNCUtils, WEBLib.TMSFNCPersistence
  {$IFDEF FMXLIB}
  ,WEBLib.Forms
  {$ENDIF}
  {$IFDEF VCLLIB}
