...
uses
  Classes, FMX.TMSFNCGraphics, Types, FMX.Graphics,
  FMX.TMSFNCTypes, FMX.TMSFNCBitmapContainer, FMX.TMSFNCGraphicsTypes
  {$IFDEF CMNLIB}
  , FMX.ImgList
  {$ENDIF}
  {$IFNDEF LCLWEBLIB}
...
var
  ...
  OldPenKind: TTMSFNCGraphicsStrokeKind;
  ...
  blnkKind: TTMSFNCGraphicsFillKind;
      ...
      begin
                  ...
                  begin
                    ...
                    begin
                      ...
                      begin
                        ...
                        begin
                          bmp := TTMSFNCBitmap(BitmapContainer.FindBitmap(Prop));
                        end;
                  ...
                  begin
                    ...
                    begin
                      ...
                      begin
                        ...
                        bmp := TTMSFNCBitmap.Create;
                        TTMSFNCUtils.LoadBitmapFromBase64(Prop, bmp);
                        bmpcreated := true;
                      end;
                    end;
        ...
        'F':begin
              ...
              begin
                ...
                if (TTMSFNCUtils.VarPos('STYLE',TagProp,TagPos)>0) then
                begin
                  Prop := Copy(TagProp,TagPos+5,Length(TagProp));
                  Prop := Copy(Prop,Pos('=',Prop)+1,Length(Prop));
                  Prop := Copy(Prop,Pos('"',Prop)+1,Length(Prop));
...
begin
  ...
  if Pos('&',s) > 0 then
  begin
    s :=  TTMSFNCUtils.UnFixMarkup(s, true, true);
    repeat
      Foundtag := False;
