...
unit LCLTMSFNCPDFGraphicsLibHTMLEngine;
...
uses
  LCLTMSFNCTypes, Graphics, LCLTMSFNCBitmapContainer, LCLTMSFNCGraphics, LCLTMSFNCPDFLib,
...
type
  ...
  {$ENDIF}
  {$IFNDEF WEBLIB}
  TTMSFNCPDFGraphicsLibHTMLLines = class(specialize TFPGObjectList<TTMSFNCPDFGraphicsLibHTMLLine>);
  {$ENDIF}
...
uses
  Classes, SysUtils, LCLTMSFNCPDFCoreLibBase,
  LCLTMSFNCUtils, Math
