...
uses
  Classes, Types, VCL.TMSFNCGraphics, VCL.TMSFNCBitmapContainer, VCL.TMSFNCGraphicsTypes, VCL.Graphics, VCL.TMSFNCTypes
  {$IFDEF WEBLIB}
  ,Contnrs
  {$ENDIF}
  {$IFNDEF LCLWEBLIB}
...
uses
  SysUtils, VCL.TMSFNCUtils, Math, DateUtils
  {$IFNDEF LCLWEBLIB}
  ,zlib
  {$ENDIF}
  {$IFDEF LCLLIB}
