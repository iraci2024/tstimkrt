...
unit WEBLib.TMSFNCStateManager;
...
uses
  Classes, WEBLib.TMSFNCCustomComponent, WEBLib.TMSFNCTypes,
  WEBLib.Forms, WEBLib.Controls, WEBLib.TMSFNCJSONWriter, WEBLib.TMSFNCPersistence
  {$IFDEF FMXLIB}
  ,FMX.Types
  {$ENDIF}
  ,TypInfo
...
uses
  WEBLib.TMSFNCGraphics, SysUtils, Math, Types, WEBLib.TMSFNCUtils,
  WEBLib.TMSFNCCustomControl, WEBLib.TMSFNCGraphicsTypes, WEBLib.Graphics
  {$IFDEF WEBLIB}
