...
uses
  Classes, LCLTMSFNCPDFCoreLibBase, LCLTMSFNCGraphicsTypes, LCLTMSFNCTypes
  {$IFDEF WEBLIB}
  ,Contnrs
  {$ENDIF}
  {$IFNDEF LCLWEBLIB}
...
type
  ...
  {$ENDIF}
  {$IFNDEF WEBLIB}
  TTMSFNCPDFRichTextLibTabStops = class(specialize TFPGList<TTMSFNCPDFRichTextLibTabStop>);
  {$ENDIF}
  ...
  {$ENDIF}
  {$IFNDEF WEBLIB}
  TTMSFNCPDFRichTextLibList = class(specialize TFPGList<ITMSFNCCustomPDFRichTextLib>);
  {$ENDIF}
...
{$IFDEF MACOS}
{$IFDEF IOS}
  LCLTMSFNCPDFRichTextLib.iOS,
{$ELSE}
  LCLTMSFNCPDFRichTextLib.Mac,
{$ENDIF}
{$ENDIF}
{$IFDEF ANDROID}
  LCLTMSFNCPDFRichTextLib.Android,
{$ENDIF}
{$IFNDEF MACOS}
{$IFNDEF ANDROID}
  LCLTMSFNCPDFRichTextLibGeneral,
{$ENDIF}
{$ENDIF}
  SysUtils
  {$IFDEF FMXLIB}
