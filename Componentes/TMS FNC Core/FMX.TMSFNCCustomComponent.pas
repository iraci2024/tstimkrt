...
unit FMX.TMSFNCCustomComponent;
...
uses
  ...
  {%H-}Windows,
  {$ENDIF}
  Classes, FMX.Controls, FMX.TMSFNCTypes
...
uses
  FMX.TMSFNCUtils, FMX.Forms, SysUtils, FMX.TMSFNCGraphics,
  FMX.Graphics, FMX.TMSFNCGraphicsTypes
  {$IFNDEF LCLLIB}
  ,Types
  {$ENDIF}
  {$IFDEF VCLLIB}
  ...
  {$ENDIF}
  {$IFDEF FMXLIB}
  ,UITypes, FMX.Types, FMX.StdCtrls, FMX.Objects, UIConsts
  {$ENDIF}
  {$IFDEF VCLLIB}
