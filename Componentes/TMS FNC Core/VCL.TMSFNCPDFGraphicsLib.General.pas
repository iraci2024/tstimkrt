...
unit VCL.TMSFNCPDFGraphicsLib.General;
...
uses
  Classes, VCL.TMSFNCPDFGraphicsLib, SysUtils, VCL.TMSFNCTypes, VCL.Graphics, VCL.TMSFNCPDFLib
  ,VCL.TMSFNCPDFRichTextLib, VCL.TMSFNCPDFCoreLibBase, VCL.TMSFNCPDFGraphicsLibHTMLEngine, VCL.TMSFNCUtils,
  VCL.TMSFNCBitmapContainer, VCL.TMSFNCGraphicsTypes
  {$IFNDEF WEBLIB}
  {$IFDEF SVGSUPPORT}
