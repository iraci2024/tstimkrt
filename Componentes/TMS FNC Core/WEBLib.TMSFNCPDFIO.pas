...
uses
  Classes, WEBLib.TMSFNCCustomComponent, WEBLib.TMSFNCPDFLib, WEBLib.TMSFNCPDFCoreLibBase, WEBLib.TMSFNCTypes,
  WEBLib.TMSFNCPDFGraphicsLib, WEBLib.TMSFNCBitmapContainer, WEBLib.TMSFNCGraphicsTypes
  {$IFNDEF LCLLIB}
  , Types
  {$ENDIF}
  ;
