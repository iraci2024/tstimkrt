...
uses
  Classes, LCLTMSFNCTypes, LCLTMSFNCCustomComponent, Controls
  {$IFNDEF WEBLIB}
  {$IFNDEF LCLLIB}
...
type
  ...
  {$ENDIF}
  {$IFNDEF WEBLIB}
  TControlList = class(specialize TFPGList<TControl>);
  {$ENDIF}
...
uses
  TypInfo, Forms, SysUtils, LCLTMSFNCUtils
  {$IFDEF FMXLIB}
  ,FMX.Types
  {$ENDIF}
  ;
