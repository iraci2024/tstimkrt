...
uses
  ...
  ,web, LCLTMSFNCUtils
  {$ENDIF}
  ,LCLTMSFNCPDFGraphicsLib, LCLTMSFNCPDFCoreLibBase, LCLTMSFNCCustomComponent, LCLTMSFNCGraphicsTypes,
  LCLTMSFNCPDFRichTextLib, LCLTMSFNCTypes, LCLTMSFNCBitmapContainer;
...
type
  ...
  {$ENDIF}
  {$IFNDEF WEBLIB}
  TTMSFNCPDFLibList = class(specialize TFPGList<ITMSFNCCustomPDFLib>);
  {$ENDIF}
...
{$ENDIF}
{$IFDEF ANDROID}
  LCLTMSFNCPDFLib.Android,
{$ENDIF}
  LCLTMSFNCPDFLibGeneral,
  SysUtils
  {$IFDEF FMXLIB}
  ,FMX.Types
  {$ENDIF}
