...
uses
  Classes, Types, VCL.TMSFNCCustomComponent, VCL.TMSFNCUtils, VCL.TMSFNCTypes, SysUtils
  {$IFNDEF LCLWEBLIB}
...
uses
  StrUtils
  {$IFDEF MSWINDOWS}
  ,VCL.TMSFNCCloudBase.Win
  {$ENDIF}
  {$IFDEF UNIX}
  ,VCL.TMSFNCCloudBase.Unix
  {$ENDIF}
  {$IFDEF MACOS}
  ,VCL.TMSFNCCloudBase.Mac
  {$ENDIF}
  {$IFDEF ANDROID}
  ,VCL.TMSFNCCloudBase.Android
  {$ENDIF}
  {$IFDEF WEBLIB}
  ,VCL.TMSFNCCloudBase.WEB
  {$ENDIF}
  ;
