...
unit WEBLib.TMSFNCResponsiveManagerRegDE;
...
uses
  Classes, WEBLib.TMSFNCResponsiveManagerDE, WEBLib.TMSFNCResponsiveManager,
  WEBLib.TMSFNCTypes, WEBLib.TMSFNCStateManager
  {$IFNDEF LCLWEBLIB}
  ,DesignIntF
  {$ENDIF}
  {$IFDEF WEBLIB}
