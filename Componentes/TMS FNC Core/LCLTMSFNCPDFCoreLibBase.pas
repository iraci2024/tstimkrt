...
uses
  Classes, Types, LCLTMSFNCGraphics, LCLTMSFNCBitmapContainer, LCLTMSFNCGraphicsTypes, Graphics, LCLTMSFNCTypes
  {$IFDEF WEBLIB}
  ,Contnrs
  {$ENDIF}
  {$IFNDEF LCLWEBLIB}
...
type
  TTMSFNCPDFGraphicsLibPathDrawingMode = (dmPathFill, dmPathEOFill, dmPathStroke, dmPathEOStroke, dmPathFillStroke, dmPathEOFillStroke);
  TTMSFNCPDFGraphicsLibImageType = (itOriginal, itPNG, itJPG);
  TTMSFNCPDFGraphicsLibLineBreakMode = (bmLineBreakModeWordWrap, bmLineBreakModeCharacterWrap, bmLineBreakModeClip
    , bmLineBreakModeHeadTruncation, bmLineBreakModeMiddleTruncation, bmLineBreakModeTailTruncation);

  TTMSFNCPDFGraphicsLibPointArray = array of TPointF;
  TTMSFNCPDFGraphicsLibRectArray = array of TRectF;

  TTMSFNCPDFGraphicsLibTextRange = record
    location: Integer;
    length: Integer;
  end;
  ...
  TTMSFNCPDFGraphicsFill = class(TTMSFNCCustomGraphicsFill)
  published
    property Kind;
  ...
  TTMSFNCPDFGraphicsStroke = class(TTMSFNCCustomGraphicsStroke)
  published
    property Kind;
    property Color;
    property Width;
  ...
  private
    FFont: TTMSFNCPDFGraphicsLibFont;
    FLineBreakMode: TTMSFNCPDFGraphicsLibLineBreakMode;
    FAlignment: TTMSFNCGraphicsTextAlign;
    FURLFont: TTMSFNCPDFGraphicsLibFont;
    FFill: TTMSFNCPDFGraphicsFill;
    FStroke: TTMSFNCPDFGraphicsStroke;
  ...
  public
    ...
    property Fill: TTMSFNCPDFGraphicsFill read FFill write SetFill;
    property Stroke: TTMSFNCPDFGraphicsStroke read FStroke write SetStroke;
    property Font: TTMSFNCPDFGraphicsLibFont read FFont write SetFont;
    property URLFont: TTMSFNCPDFGraphicsLibFont read FURLFont write SetURLFont;
    property Alignment: TTMSFNCGraphicsTextAlign read FAlignment write SetAlignment default gtaLeading;
    property LineBreakMode: TTMSFNCPDFGraphicsLibLineBreakMode read FLineBreakMode write SetLineBreakMode default bmLineBreakModeWordWrap;
    property BitmapContainer: TTMSFNCBitmapContainer read FBitmapContainer write SetBitmapContainer;
  end;

  TTMSFNCPDFPlatformServicesService = class
  private
  ...
  private
    function GetItem(Index: Integer): TTMSFNCPDFPlatformServicesService;
    procedure SetItem(Index: Integer; const Value: TTMSFNCPDFPlatformServicesService);
  public
    property Items[Index: Integer]: TTMSFNCPDFPlatformServicesService read GetItem write SetItem; default;
  {$ENDIF}
  {$IFNDEF WEBLIB}
  TTMSFNCPDFPlatformServicesList = class(specialize TFPGObjectList<TTMSFNCPDFPlatformServicesService>)
  {$ENDIF}
  private
  ...
  private
    FServicesList: TTMSFNCPDFPlatformServicesList;
    class var FCurrent: TTMSFNCPDFLibPlatformServices;
...
{$ENDIF}
  public
    ...
    class function Current: TTMSFNCPDFLibPlatformServices;
  end;

  {$IFDEF WEBLIB}
  TTMSFNCPDFGraphicsLibUsedFontCharArray = class(TList)
  private
  ...
  {$ENDIF}
  {$IFNDEF WEBLIB}
  TTMSFNCPDFGraphicsLibUsedFontCharArray = class(specialize TFPGList<Integer>);
  {$ENDIF}
  ...
  TTMSFNCPDFGraphicsLibFontCharWidths = array of TTMSFNCPDFGraphicsLibFontCharWidth;

  TTMSFNCPDFGraphicsLibOutputWriterNotifyTextEvent = procedure(Sender: TObject; AValue: UnicodeString) of object;
  TTMSFNCPDFGraphicsLibOutputWriterNotifyURLEvent = procedure(Sender: TObject; ARect: TRectF; AURL: UnicodeString) of object;
  TTMSFNCPDFGraphicsLibOutputWriterNotifyGoToEvent = procedure(Sender: TObject; ARect: TRectF; ADestination: UnicodeString) of object;
  TTMSFNCPDFGraphicsLibOutputWriterNotifyUnicodeEvent = procedure(Sender: TObject; AValue: UnicodeString) of object;
  TTMSFNCPDFGraphicsLibOutputWriterNotifyBitmapEvent = procedure(Sender: TObject; AValue: TTMSFNCBitmapHelperClass; AImageType: TTMSFNCPDFGraphicsLibImageType; AQuality: Single; ABackgroundColor: TTMSFNCGraphicsColor; var ABitmapReference: string) of object;
  TTMSFNCPDFGraphicsLibOutputWriterNotifyShadingEvent = procedure(Sender: TObject; AFillColor: TTMSFNCGraphicsColor; AFillColorTo: TTMSFNCGraphicsColor; AFillOrientation: TTMSFNCGraphicsFillOrientation; var AShadingReference: String) of object;
  TTMSFNCPDFGraphicsLibOutputWriterNotifyShadingRectEvent = procedure(Sender: TObject; ARect: TRectF) of object;
  ...
  {$IFDEF WEBLIB}
  TTMSFNCPDFGraphicsLibOutputWriterStreams = class(TObjectList)
  private
  ...
  {$ENDIF}
  {$IFNDEF WEBLIB}
  TTMSFNCPDFGraphicsLibOutputWriterStreams = class(specialize TFPGObjectList<TStream>);
  {$ENDIF}
  ...
  private
    ...
    {$ENDIF}
    FStream, FContentStream: TTMSFNCPDFGraphicsLibOutputWriterStream;
    FStreams: TTMSFNCPDFGraphicsLibOutputWriterStreams;
    FFontRefName: String;
    FFontSize: Single;
    FFontName: String;
    ...
    FFontLeading: Single;
    FFontCharWidths: TTMSFNCPDFGraphicsLibFontCharWidths;
    FFontCharSpacing: Integer;
    FOnNotifyUnicode: TTMSFNCPDFGraphicsLibOutputWriterNotifyUnicodeEvent;
    FFontCharArray: TTMSFNCPDFGraphicsLibFontCharArray;
    FFontUsedCharArray: TTMSFNCPDFGraphicsLibUsedFontCharArray;
    FOnNotifyBitmap: TTMSFNCPDFGraphicsLibOutputWriterNotifyBitmapEvent;
    FOnNotifyShading: TTMSFNCPDFGraphicsLibOutputWriterNotifyShadingEvent;
    FOnNotifyShadingRect: TTMSFNCPDFGraphicsLibOutputWriterNotifyShadingRectEvent;
    FOnNotifyText: TTMSFNCPDFGraphicsLibOutputWriterNotifyTextEvent;
    FOnNotifyURL: TTMSFNCPDFGraphicsLibOutputWriterNotifyURLEvent;
    FFontUnicode: Boolean;
    FFontCapHeight: Integer;
    FFontUnitsPerEm: Integer;
    FFontEmbedding: Boolean;
    FFontGlyphRefName: String;
    FOnNotifyGoTo: TTMSFNCPDFGraphicsLibOutputWriterNotifyGoToEvent;
    function GetStreamPosition: Int64;
    procedure SetStreamPosition(const Value: Int64);
  public
    constructor Create;
    destructor Destroy; override;
    function Streams: TTMSFNCPDFGraphicsLibOutputWriterStreams;
    ...
    property Stream: TTMSFNCPDFGraphicsLibOutputWriterStream read FStream write FStream;
    property ContentStream: TTMSFNCPDFGraphicsLibOutputWriterStream read FContentStream write FContentStream;
    ...
    property FontCharWidths: TTMSFNCPDFGraphicsLibFontCharWidths read FFontCharWidths write FFontCharWidths;
    property FontCharArray: TTMSFNCPDFGraphicsLibFontCharArray read FFontCharArray write FFontCharArray;
    property FontUsedCharArray: TTMSFNCPDFGraphicsLibUsedFontCharArray read FFontUsedCharArray write FFontUsedCharArray;
    ...
    property OnNotifyText: TTMSFNCPDFGraphicsLibOutputWriterNotifyTextEvent read FOnNotifyText write FOnNotifyText;
    property OnNotifyUnicode: TTMSFNCPDFGraphicsLibOutputWriterNotifyUnicodeEvent read FOnNotifyUnicode write FOnNotifyUnicode;
    property OnNotifyURL: TTMSFNCPDFGraphicsLibOutputWriterNotifyURLEvent read FOnNotifyURL write FOnNotifyURL;
    property OnNotifyGoTo: TTMSFNCPDFGraphicsLibOutputWriterNotifyGoToEvent read FOnNotifyGoTo write FOnNotifyGoTo;
    property OnNotifyBitmap: TTMSFNCPDFGraphicsLibOutputWriterNotifyBitmapEvent read FOnNotifyBitmap write FOnNotifyBitmap;
    property OnNotifyShading: TTMSFNCPDFGraphicsLibOutputWriterNotifyShadingEvent read FOnNotifyShading write FOnNotifyShading;
    property OnNotifyShadingRect: TTMSFNCPDFGraphicsLibOutputWriterNotifyShadingRectEvent read FOnNotifyShadingRect write FOnNotifyShadingRect;
...
function ImageFromBitmap(ABitmap: TTMSFNCBitmapHelperClass): UIImage; overload;
function ImageFromBitmap(ABitmap: TTMSFNCBitmapHelperClass; ASize: Single): UIImage; overload;
...
function AlphaColorToUIColor(AColor: TTMSFNCGraphicsColor): UIColor;
function UIColorToAlphaColor(AColor: UIColor): TTMSFNCGraphicsColor;
...
function ImageFromBitmap(ABitmap: TTMSFNCBitmapHelperClass): NSImage; overload;
function ImageFromBitmap(ABitmap: TTMSFNCBitmapHelperClass; ASize: Single): NSImage; overload;
...
function AlphaColorToNSColor(AColor: TTMSFNCGraphicsColor): NSColor;
function NSColorToAlphaColor(AColor: NSColor): TTMSFNCGraphicsColor;
{$ENDIF}
...
procedure FontToJTextPaint(AFont: TTMSFNCPDFGraphicsLibFont; ATextPaint: JTextPaint);
function AlphaColorToJColor(AColor: TTMSFNCGraphicsColor): Integer;
function JColorToAlphaColor(AColor: Integer): TTMSFNCGraphicsColor;
function ImageFromBitmap(ABitmap: TTMSFNCBitmapHelperClass): JBitmap;
{$ENDIF}
...
function MakeTextRange(ALocation, ALength: Integer): TTMSFNCPDFGraphicsLibTextRange;
function MaxRange(ARange: TTMSFNCPDFGraphicsLibTextRange): Integer;
function CreateStringStream(AValue: string = ''): TTMSFNCPDFGraphicsLibOutputWriterStream;
...
uses
  SysUtils, LCLTMSFNCUtils, Math, DateUtils
  {$IFNDEF LCLWEBLIB}
  ,zlib
  {$ENDIF}
  {$IFDEF LCLLIB}
...
function CreateStringStream(AValue: string = ''): TTMSFNCPDFGraphicsLibOutputWriterStream;
begin
  Result := TTMSFNCPDFGraphicsLibOutputWriterStream.Create(AValue{$IFDEF WEBLIB}, TEncoding.Ansi{$ENDIF});
end;
...
function ImageFromBitmap(ABitmap: TTMSFNCBitmapHelperClass; ASize: Single): UIImage;
  type
    TBArray = TArray<Byte>;
...
function ImageFromBitmap(ABitmap: TTMSFNCBitmapHelperClass): UIImage;
var
  ms: TMemoryStream;
  dt: NSData;
begin
...
function ImageFromBitmap(ABitmap: TTMSFNCBitmapHelperClass; ASize: Single): NSImage;
  type
...
function ImageFromBitmap(ABitmap: TTMSFNCBitmapHelperClass): NSImage;
var
  ms: TMemoryStream;
  dt: NSData;
begin
...
procedure TTMSFNCPDFGraphicsLibFont.Assign(Source: TPersistent);
begin
  if Source is TTMSFNCPDFGraphicsLibFont then
  begin
    BeginUpdate;
    FName := (Source as TTMSFNCPDFGraphicsLibFont).Name;
    FSize := (Source as TTMSFNCPDFGraphicsLibFont).Size;
    FColor := (Source as TTMSFNCPDFGraphicsLibFont).Color;
    FStyle := (Source as TTMSFNCPDFGraphicsLibFont).Style;
    FFileName := (Source as TTMSFNCPDFGraphicsLibFont).FileName;
    EndUpdate;
  end;
end;

procedure TTMSFNCPDFGraphicsLibFont.BeginUpdate;
begin
  Inc(FUpdateCount);
end;

constructor TTMSFNCPDFGraphicsLibFont.Create;
begin
  inherited;
...
procedure TTMSFNCPDFGraphicsLibFont.DoChanged;
begin
...
procedure TTMSFNCPDFGraphicsLibFont.EndUpdate;
begin
  Dec(FUpdateCount);
  if FUpdateCount = 0 then
    DoChanged;
...
function TTMSFNCPDFGraphicsLibFont.IsSizeStored: Boolean;
begin
  Result := Size <> 12;
end;

procedure TTMSFNCPDFGraphicsLibFont.SetName(const Value: String);
begin
  FName := Value;
  DoChanged;
end;

procedure TTMSFNCPDFGraphicsLibFont.SetColor(const Value: TTMSFNCGraphicsColor);
begin
  FColor := Value;
  DoChanged;
end;

procedure TTMSFNCPDFGraphicsLibFont.SetFileName(const Value: String);
begin
  FFileName := Value;
  DoChanged;
end;

procedure TTMSFNCPDFGraphicsLibFont.SetSize(const Value: Single);
var
  v: Single;
begin
  v := Value;
...
procedure TTMSFNCPDFGraphicsLibFont.SetSizeNoScale(const Value: Single);
begin
  FSize := Value;
  DoChanged;
end;

procedure TTMSFNCPDFGraphicsLibFont.SetStyle(const Value: TFontStyles);
begin
  FStyle := Value;
  DoChanged;
end;
...
constructor TTMSFNCPDFGraphicsLibBase.Create;
begin
  CreateClasses;
  FFont := TTMSFNCPDFGraphicsLibFont.Create;
  FFont.OnChanged := @FontChanged;
  FURLFont := TTMSFNCPDFGraphicsLibFont.Create;
  FURLFont.Color := gcBlue;
  FURLFont.Style := [TFontStyle.fsUnderline];
  FLineBreakMode := bmLineBreakModeWordWrap;
  FAlignment := gtaLeading;
  FFill := TTMSFNCPDFGraphicsFill.Create;
  FFill.OnChanged := @FillChanged;
  FStroke := TTMSFNCPDFGraphicsStroke.Create;
  FStroke.OnChanged := @StrokeChanged;
  InitializeAppearance;
end;

procedure TTMSFNCPDFGraphicsLibBase.CreateClasses;
begin

end;

destructor TTMSFNCPDFGraphicsLibBase.Destroy;
begin
...
procedure TTMSFNCPDFGraphicsLibBase.FillChanged(Sender: TObject);
begin
  UpdateFill;
end;

procedure TTMSFNCPDFGraphicsLibBase.FontChanged(Sender: TObject);
begin
  UpdateFont;
end;

procedure TTMSFNCPDFGraphicsLibBase.InitializeAppearance;
begin

end;

procedure TTMSFNCPDFGraphicsLibBase.SetAlignment(const Value: TTMSFNCGraphicsTextAlign);
begin
  FAlignment := Value;
  UpdateAlignment;
end;

procedure TTMSFNCPDFGraphicsLibBase.SetBitmapContainer(
  const Value: TTMSFNCBitmapContainer);
begin
  FBitmapContainer := Value;
end;

procedure TTMSFNCPDFGraphicsLibBase.SetFill(
  const Value: TTMSFNCPDFGraphicsFill);
begin
  FFill.Assign(Value);
end;

procedure TTMSFNCPDFGraphicsLibBase.SetFont(const Value: TTMSFNCPDFGraphicsLibFont);
begin
  FFont.Assign(Value);
end;

procedure TTMSFNCPDFGraphicsLibBase.SetLineBreakMode(
...
procedure TTMSFNCPDFGraphicsLibBase.SetStroke(
  const Value: TTMSFNCPDFGraphicsStroke);
begin
  FStroke.Assign(Value);
end;

procedure TTMSFNCPDFGraphicsLibBase.SetURLFont(
  const Value: TTMSFNCPDFGraphicsLibFont);
begin
  FURLFont.Assign(Value);
end;

procedure TTMSFNCPDFGraphicsLibBase.StrokeChanged(Sender: TObject);
begin
  UpdateStroke;
end;

procedure TTMSFNCPDFGraphicsLibBase.UpdateAlignment;
begin

end;

procedure TTMSFNCPDFGraphicsLibBase.UpdateFill;
begin

end;

procedure TTMSFNCPDFGraphicsLibBase.UpdateFont;
begin

end;

procedure TTMSFNCPDFGraphicsLibBase.UpdateLineBreakMode;
begin

end;

procedure TTMSFNCPDFGraphicsLibBase.UpdateStroke;
begin
...
procedure TTMSFNCPDFLibPlatformServices.AddPlatformService(const AServiceGUID: TGUID; const AService: IInterface);
var
  LService: IInterface;
begin
  ...
  begin
    if Supports(AService, AServiceGUID, LService) then
      FServicesList.Add(TTMSFNCPDFPlatformServicesService.Create(GUIDToString(AServiceGUID), AService));
  end;
end;

constructor TTMSFNCPDFLibPlatformServices.Create;
begin
  inherited;
  FServicesList := TTMSFNCPDFPlatformServicesList.Create;
end;

destructor TTMSFNCPDFLibPlatformServices.Destroy;
begin
...
{$IFNDEF AUTOREFCOUNT}
class procedure TTMSFNCPDFLibPlatformServices.ReleaseCurrent;
begin
  FreeAndNil(FCurrent);
...
class function TTMSFNCPDFLibPlatformServices.Current: TTMSFNCPDFLibPlatformServices;
begin
  if (FCurrent = nil) and not FCurrentReleased then
    FCurrent := TTMSFNCPDFLibPlatformServices.Create;
  Result := FCurrent;
end;

function TTMSFNCPDFLibPlatformServices.GetPlatformService(const AServiceGUID: TGUID): IInterface;
var
  k: IInterface;
begin
...
procedure TTMSFNCPDFLibPlatformServices.RemovePlatformService(const AServiceGUID: TGUID);
begin
  FServicesList.RemoveByGUID(GUIDToString(AServiceGUID));
end;

function TTMSFNCPDFLibPlatformServices.SupportsPlatformService(const AServiceGUID: TGUID;
...
function TTMSFNCPDFLibPlatformServices.SupportsPlatformService(const AServiceGUID: TGUID): Boolean;
begin
...
procedure TTMSFNCPDFGraphicsLibOutputWriter.ClearProperties;
begin
  FFontBase := '';
  FFontName := '';
  FFontUnicode := False;
...
function TTMSFNCPDFGraphicsLibOutputWriter.IsUnicodeString(AValue: UnicodeString): Boolean;
var
  I: Integer;
begin
  Result := False;
...
function TTMSFNCPDFGraphicsLibOutputWriter.ConvertColorToString(AValue: TTMSFNCGraphicsColor): String;
begin
  Result := ConvertFloatToString(TTMSFNCGraphics.GetColorRed(AValue) / 255) + ' ' +
            ConvertFloatToString(TTMSFNCGraphics.GetColorGreen(AValue) / 255) + ' ' +
            ConvertFloatToString(TTMSFNCGraphics.GetColorBlue(AValue) / 255);
end;

function TTMSFNCPDFGraphicsLibOutputWriter.ConvertFloatToString(AValue: Extended): String;
var
  s: string;
begin
...
function TTMSFNCPDFGraphicsLibOutputWriter.ConvertStringToHex(AValue: UnicodeString): String;
var
  I: integer;
  v: Integer;
  idx: integer;
...
function TTMSFNCPDFGraphicsLibOutputWriter.AddHex4(
...
procedure TTMSFNCPDFGraphicsLibOutputWriter.AddText(AValue: UnicodeString);
var
  s: string;
begin
...
procedure TTMSFNCPDFGraphicsLibOutputWriter.BeginText;
begin
  WriteString('BT' + PDFLB);
end;

procedure TTMSFNCPDFGraphicsLibOutputWriter.EndText;
begin
  WriteString('ET' + PDFLB);
end;

function TTMSFNCPDFGraphicsLibOutputWriter.EscapeString(AValue: UnicodeString): string;
var
  I: Integer;
  K: Integer;
  f: Boolean;
...
function TTMSFNCPDFGraphicsLibOutputWriter.CompressStream(
...
function TTMSFNCPDFGraphicsLibOutputWriter.CompressString(AValue: string): TStringStream;
var
  vDest: TStringStream;
  vSource: TStringStream;
  vCompressor: TCompressionStream;
...
function TTMSFNCPDFGraphicsLibOutputWriter.FontCharArrayContainsValue(ACharValue: Integer): Boolean;
begin
  Result := False;
...
function TTMSFNCPDFGraphicsLibOutputWriter.FinishContentStream(AReference: String; ACompress: Boolean; AAdditionalFlags: String = ''): TStringStream;
var
  ls: Integer;
begin
  Result := nil;
...
procedure TTMSFNCPDFGraphicsLibOutputWriter.FontCharArrayAddValue(ACharValue: Integer);
begin
...
function TTMSFNCPDFGraphicsLibOutputWriter.GetFontCharWidth(AText: UnicodeString;
...
function TTMSFNCPDFGraphicsLibOutputWriter.GetStreamPosition: Int64;
begin
  Result := FStream.Position;
end;

procedure TTMSFNCPDFGraphicsLibOutputWriter.LineTo(APoint: TPointF);
begin
  WriteString(ConvertFloatToString(APoint.X) + ' ' + ConvertFloatToString(APoint.Y) + ' l' + PDFLB);
end;

procedure TTMSFNCPDFGraphicsLibOutputWriter.MoveTextTo(APoint: TPointF);
begin
  WriteString(ConvertFloatToString(APoint.X) + ' ' + ConvertFloatToString(APoint.Y) + ' Td' + PDFLB);
end;

procedure TTMSFNCPDFGraphicsLibOutputWriter.MoveTextToNextLine;
begin
  WriteString('T*'+PDFLB);
end;

procedure TTMSFNCPDFGraphicsLibOutputWriter.MoveTo(APoint: TPointF);
begin
  WriteString(ConvertFloatToString(APoint.X) + ' ' + ConvertFloatToString(APoint.Y) + ' m' + PDFLB);
end;

procedure TTMSFNCPDFGraphicsLibOutputWriter.NotifyBitmap(AValue: TTMSFNCBitmapHelperClass; AImageType: TTMSFNCPDFGraphicsLibImageType; AQuality: Single; ABackgroundColor: TTMSFNCGraphicsColor; var ABitmapReference: string);
begin
  if Assigned(OnNotifyBitmap) then
    OnNotifyBitmap(Self, AValue, AImageType, AQuality, ABackgroundColor, ABitmapReference);
end;

procedure TTMSFNCPDFGraphicsLibOutputWriter.NotifyShading(AFillColor: TTMSFNCGraphicsColor; AFillColorTo: TTMSFNCGraphicsColor; AFillOrientation: TTMSFNCGraphicsFillOrientation; var AShadingReference: String);
begin
  if Assigned(OnNotifyShading) then
    OnNotifyShading(Self, AFillColor, AFillColorTo, AFillOrientation, AShadingReference);
end;

procedure TTMSFNCPDFGraphicsLibOutputWriter.NotifyShadingRect(
  ARect: TRectF);
begin
...
procedure TTMSFNCPDFGraphicsLibOutputWriter.NotifyText(AValue: UnicodeString);
begin
  if Assigned(OnNotifyText) then
    OnNotifyText(Self, AValue);
end;

procedure TTMSFNCPDFGraphicsLibOutputWriter.NotifyUnicode(AValue: UnicodeString);
begin
  if Assigned(OnNotifyUnicode) then
    OnNotifyUnicode(Self, AValue);
end;

procedure TTMSFNCPDFGraphicsLibOutputWriter.NotifyURL(ARect: TRectF; AURL: UnicodeString);
begin
  if Assigned(OnNotifyURL) then
    OnNotifyURL(Self, ARect, AURL);
end;

procedure TTMSFNCPDFGraphicsLibOutputWriter.NotifyGoTo(ARect: TRectF; ADestination: UnicodeString);
begin
  if Assigned(OnNotifyGoTo) then
    OnNotifyGoTo(Self, ARect, ADestination);
end;

procedure TTMSFNCPDFGraphicsLibOutputWriter.ReplaceString(ASearchValue, AValue: String);
begin
  ReplaceStrings([ASearchValue], [AValue]);
end;

procedure TTMSFNCPDFGraphicsLibOutputWriter.ReplaceStrings(ASearchValues,
...
procedure TTMSFNCPDFGraphicsLibOutputWriter.Write(Buffer: Pointer; Count: Integer);
begin
  {$IFDEF WEBLIB}
...
procedure TTMSFNCPDFGraphicsLibOutputWriter.WriteFillColor(
  AColor: TTMSFNCGraphicsColor);
begin
  WriteString(ConvertColorToString(AColor) + ' rg' + PDFLB);
end;

procedure TTMSFNCPDFGraphicsLibOutputWriter.WriteFont;
begin
  WriteString(FontRefName + ' ' + IntToStr(Round(FontSize)) + ' Tf' + PDFLB)
end;

procedure TTMSFNCPDFGraphicsLibOutputWriter.WriteFontColor;
begin
  WriteString(ConvertColorToString(FontColor) + ' rg' + PDFLB);
end;

procedure TTMSFNCPDFGraphicsLibOutputWriter.WriteFontLeading;
begin
  WriteString(ConvertFloatToString(FontLeading) + ' TL' + PDFLB);
end;

procedure TTMSFNCPDFGraphicsLibOutputWriter.WriteMatrix(m11, m12, m21, m22, dx, dy: Double);
begin
...
procedure TTMSFNCPDFGraphicsLibOutputWriter.WriteMatrix(APoint: TPointF;
  ASize: TSizeF);
begin
...
procedure TTMSFNCPDFGraphicsLibOutputWriter.WriteRectangle(ARect: TRectF);
begin
...
procedure TTMSFNCPDFGraphicsLibOutputWriter.WriteString(AValue: String);
begin
  if Assigned(FContentStream) then
...
procedure TTMSFNCPDFGraphicsLibOutputWriter.WriteStrokeColor(
  AColor: TTMSFNCGraphicsColor);
begin
  WriteString(ConvertColorToString(AColor) + ' RG' + PDFLB);
end;

procedure TTMSFNCPDFGraphicsLibOutputWriter.WriteStrokeKind(
...
procedure TTMSFNCPDFGraphicsLibOutputWriter.WriteStrokeWidth(AWidth: Single);
begin
  WriteString(ConvertFloatToString(AWidth) + ' w' + PDFLB);
end;

procedure TTMSFNCPDFGraphicsLibOutputWriter.WriteTextMatrix(m11, m12, m21, m22, dx, dy: Double);
begin
  WriteString(ConvertFloatToString(m11) + ' ' +
              ConvertFloatToString(m12) + ' ' +
              ConvertFloatToString(m21) + ' ' +
...
procedure TTMSFNCPDFGraphicsLibOutputWriter.SetStreamPosition(
  const Value: Int64);
begin
  FStream.Position := Value;
end;

procedure TTMSFNCPDFGraphicsLibOutputWriter.StartContentStream(AReference: TObject = nil);
begin
  FContentStream := CreateStringStream;
  FContentStream.Reference := AReference;
end;

procedure TTMSFNCPDFGraphicsLibOutputWriter.StartNewStream(AReference: TObject = nil);
begin
...
function TTMSFNCPDFGraphicsLibOutputWriter.Streams: TTMSFNCPDFGraphicsLibOutputWriterStreams;
begin
  Result := FStreams;
end;

function TTMSFNCPDFGraphicsLibOutputWriter.TextHeight: Single;
begin
  Result := FontCapHeight * FontSize * 96 / (72 * FontUnitsPerEm);
end;

constructor TTMSFNCPDFGraphicsLibOutputWriter.Create;
begin
  {$IFNDEF LCLWEBLIB}
  ...
  {$ENDIF}
  FStreams := TTMSFNCPDFGraphicsLibOutputWriterStreams.Create;
  ClearProperties;
end;

procedure TTMSFNCPDFGraphicsLibOutputWriter.CurveTo(AX1, AX2, AX3, AX4, AX5,
  AX6: Single);
begin
...
procedure TTMSFNCPDFGraphicsLibOutputWriter.CurveTo2(AX1, AX2, AX3,
  AX4: Single);
begin
  WriteString(ConvertFloatToString(AX1) + ' ' +
              ConvertFloatToString(AX2) + ' ' +
...
destructor TTMSFNCPDFGraphicsLibOutputWriter.Destroy;
begin
...
function TTMSFNCPDFGraphicsLibFontCharArray.Add(AValue: Word): Integer;
begin
...
function TTMSFNCPDFGraphicsLibFontCharArray.FirstValue: Integer;
begin
  Result := v[0];
end;

function TTMSFNCPDFGraphicsLibFontCharArray.IndexOf(AValue: Word): Integer;
var
  L, R: Integer;
  cmp: integer;
begin
...
function TTMSFNCPDFGraphicsLibFontCharArray.LastValue: Integer;
begin
  Result := v[Length(v) - 1];
end;
...
destructor TTMSFNCPDFGraphicsLibOutputWriterStream.Destroy;
begin
  FReference := nil;
  inherited;
end;
...
constructor TTMSFNCPDFPlatformServicesService.Create(AGUID: string;
...
function TTMSFNCPDFPlatformServicesList.ContainsKey(AGUID: string): Boolean;
var
  I: Integer;
begin
  Result := False;
...
function TTMSFNCPDFPlatformServicesList.GetValue(AGUID: string): IInterface;
var
  I: Integer;
begin
  Result := nil;
...
procedure TTMSFNCPDFPlatformServicesList.RemoveByGUID(AGUID: string);
var
  I: Integer;
begin
...
{$IFDEF WEBLIB}
function TTMSFNCPDFPlatformServicesList.GetItem(Index: Integer): TTMSFNCPDFPlatformServicesService;
begin
  Result := TTMSFNCPDFPlatformServicesService(inherited Items[Index]);
end;

procedure TTMSFNCPDFPlatformServicesList.SetItem(Index: Integer; const Value: TTMSFNCPDFPlatformServicesService);
begin
  inherited Items[Index] := Value;
end;

function TTMSFNCPDFGraphicsLibUsedFontCharArray.GetItem(Index: Integer): Integer;
begin
  Result := Integer(inherited Items[Index]);
end;

procedure TTMSFNCPDFGraphicsLibUsedFontCharArray.SetItem(Index: Integer; const Value: Integer);
begin
  inherited Items[Index] := Value;
end;

function TTMSFNCPDFGraphicsLibUsedFontCharArray.HeadSetCount(AHigh: Integer): Integer;
var
  c, I: Integer;
begin
  c := 0;
...
function TTMSFNCPDFGraphicsLibUsedFontCharArray.SubSetCount(ALow, AHigh: Integer): Integer;
var
  c, I: Integer;
begin
  c := 0;
...
function TTMSFNCPDFGraphicsLibOutputWriterStreams.GetItem(Index: Integer): TStream;
begin
  Result := TStream(inherited Items[Index]);
end;

procedure TTMSFNCPDFGraphicsLibOutputWriterStreams.SetItem(Index: Integer; const Value: TStream);
begin
  inherited Items[Index] := Value;
end;
{$ENDIF}
...
initialization
begin
  TTMSFNCPDFLibPlatformServices.FCurrentReleased := False;
end;
...
begin
{$IFNDEF AUTOREFCOUNT}
  TTMSFNCPDFLibPlatformServices.ReleaseCurrent;
{$ENDIF}
end;
{$ENDIF}
