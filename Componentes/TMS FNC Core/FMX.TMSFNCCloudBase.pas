...
uses
  Classes, Types, FMX.TMSFNCCustomComponent, FMX.TMSFNCUtils, FMX.TMSFNCTypes, SysUtils
  {$IFNDEF LCLWEBLIB}
...
uses
  StrUtils
  {$IFDEF MSWINDOWS}
  ,FMX.TMSFNCCloudBase.Win
  {$ENDIF}
  {$IFDEF UNIX}
  ,FMX.TMSFNCCloudBase.Unix
  {$ENDIF}
  {$IFDEF MACOS}
  ,FMX.TMSFNCCloudBase.Mac
  {$ENDIF}
  {$IFDEF ANDROID}
  ,FMX.TMSFNCCloudBase.Android
  {$ENDIF}
  {$IFDEF WEBLIB}
  ,FMX.TMSFNCCloudBase.WEB
  {$ENDIF}
  ;
