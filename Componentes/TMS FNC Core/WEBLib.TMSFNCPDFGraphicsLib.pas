...
unit WEBLib.TMSFNCPDFGraphicsLib;
...
uses
  Classes, WEBLib.TMSFNCPDFCoreLibBase, WEBLib.TMSFNCPDFRichTextLib, WEBLib.TMSFNCTypes, WEBLib.TMSFNCBitmapContainer,
...
{$IFDEF MACOS}
{$IFDEF IOS}
  WEBLib.TMSFNCPDFGraphicsLib.iOS,
{$ELSE}
  WEBLib.TMSFNCPDFGraphicsLib.Mac,
{$ENDIF}
{$ENDIF}
{$IFDEF ANDROID}
  WEBLib.TMSFNCPDFGraphicsLib.Android,
{$ENDIF}
