...
uses
  Classes, VCL.TMSFNCPersistence, VCL.TMSFNCTypes, VCL.TMSFNCCustomComponent,
  VCL.Controls, TypInfo
  {$IFNDEF LCLWEBLIB}
...
uses
  VCL.Graphics, VCL.Forms, VCL.TMSFNCUtils, VCL.TMSFNCCustomControl, SysUtils,
  VCL.TMSFNCGraphics, VCL.TMSFNCGraphicsTypes, VCL.TMSFNCDataBindingEditor
  {$IFDEF VCLLIB}
  , JPEG
  {$ENDIF}
  ;
