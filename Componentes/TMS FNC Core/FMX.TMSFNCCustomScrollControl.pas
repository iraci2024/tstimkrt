...
unit FMX.TMSFNCCustomScrollControl;
...
uses
  ...
  Windows,
  {$ENDIF}
  Classes, FMX.TMSFNCCustomControl, FMX.StdCtrls, FMX.TMSFNCScrollBar, FMX.TMSFNCGraphics,
  FMX.TMSFNCTypes, FMX.ExtCtrls
  {$IFNDEF LCLLIB}
  ,Types
  {$ENDIF}
  {$IFDEF FMXLIB}
...
uses
  ...
  {$ENDIF}
  FMX.Forms, Math,
  FMX.TMSFNCGraphicsTypes, SysUtils;
