...
uses
  ...
  ,web, FMX.TMSFNCUtils
  {$ENDIF}
  ,FMX.TMSFNCPDFGraphicsLib, FMX.TMSFNCPDFCoreLibBase, FMX.TMSFNCCustomComponent, FMX.TMSFNCGraphicsTypes,
  FMX.TMSFNCPDFRichTextLib, FMX.TMSFNCTypes, FMX.TMSFNCBitmapContainer;
...
{$IFDEF MACOS}
{$IFDEF IOS}
  FMX.TMSFNCPDFLib.iOS,
{$ELSE}
  FMX.TMSFNCPDFLib.Mac,
{$ENDIF}
{$ENDIF}
{$IFDEF ANDROID}
  FMX.TMSFNCPDFLib.Android,
{$ENDIF}
  FMX.TMSFNCPDFLib.General,
  SysUtils
  {$IFDEF FMXLIB}
  ,FMX.Types
  {$ENDIF}
