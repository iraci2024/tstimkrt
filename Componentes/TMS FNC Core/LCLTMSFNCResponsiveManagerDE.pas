...
unit LCLTMSFNCResponsiveManagerDE;
...
uses
  Classes, LCLTMSFNCResponsiveManager, LCLTMSFNCGeneralDE, LCLTMSFNCResponsiveManagerDimensionsEditor, TypInfo
  {$IFNDEF LCLWEBLIB}
...
uses
  ...
  Registry,
  {$ENDIF}
  Controls, SysUtils, Dialogs, LCLTMSFNCUtils, LCLTMSFNCTypes,
  LCLTMSFNCPersistence, LCLTMSFNCStateManager
  {$IFDEF FMXLIB}
  ,Forms, JSON
  {$ENDIF}
  {$IFDEF VCLLIB}
