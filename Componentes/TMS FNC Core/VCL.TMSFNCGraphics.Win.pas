...
uses
  Classes, Windows, ActiveX, VCL.TMSFNCGDIPlusApi, VCL.TMSFNCGraphicsTypes,
  {%H-}Types, VCL.TMSFNCGraphics, VCL.Graphics, VCL.TMSFNCUtils, VCL.TMSFNCTypes
  {$IFNDEF LCLLIB}
  {$HINTS OFF}
