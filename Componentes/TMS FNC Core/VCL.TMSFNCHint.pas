...
uses
  ...
  {$ENDIF}
  {$ENDIF}
  Classes, VCL.Graphics, VCL.TMSFNCGraphics, VCL.Controls, VCL.TMSFNCCustomComponent,
  Types, VCL.Forms, VCL.TMSFNCTypes, VCL.TMSFNCBitmapContainer, VCL.TMSFNCGraphicsTypes
  {$IFDEF FMXLIB}
  ,FMX.Types, Messaging
  {$ENDIF}
  {$IFDEF FMXLIB}
