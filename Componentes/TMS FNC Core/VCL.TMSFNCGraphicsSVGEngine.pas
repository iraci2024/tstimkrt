...
unit VCL.TMSFNCGraphicsSVGEngine;
...
uses
  {$IFDEF MSWINDOWS}
  VCL.TMSFNCGDIPlusClasses, VCL.TMSFNCGDIPlusApi,
  {$ENDIF}
  VCL.TMSFNCPersistence, Classes, VCL.TMSFNCGraphics, VCL.TMSFNCGraphicsTypes,
  VCL.Graphics, VCL.TMSFNCTypes
  {$IFNDEF LCLLIB}
...
uses
  VCL.TMSFNCUtils, StrUtils, SysUtils, VCL.TMSFNCBitmapContainer,
  VCL.TMSFNCStyles, Math
  {$IFNDEF LCLLIB}
  {$HINTS OFF}
