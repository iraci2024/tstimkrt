...
uses
  ...
  ,web, VCL.TMSFNCUtils
  {$ENDIF}
  ,VCL.TMSFNCPDFGraphicsLib, VCL.TMSFNCPDFCoreLibBase, VCL.TMSFNCCustomComponent, VCL.TMSFNCGraphicsTypes,
  VCL.TMSFNCPDFRichTextLib, VCL.TMSFNCTypes, VCL.TMSFNCBitmapContainer;
...
{$IFDEF MACOS}
{$IFDEF IOS}
  VCL.TMSFNCPDFLib.iOS,
{$ELSE}
  VCL.TMSFNCPDFLib.Mac,
{$ENDIF}
{$ENDIF}
{$IFDEF ANDROID}
  VCL.TMSFNCPDFLib.Android,
{$ENDIF}
  VCL.TMSFNCPDFLib.General,
  SysUtils
  {$IFDEF FMXLIB}
  ,FMX.Types
  {$ENDIF}
