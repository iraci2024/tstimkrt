...
uses
  ...
  Windows,
  {$ENDIF}
  Classes, FMX.Controls, FMX.TMSFNCCustomComponent, FMX.TMSFNCGraphics, FMX.Graphics,
  FMX.TMSFNCTypes, FMX.TMSFNCGraphicsTypes, FMX.Forms, FMX.ExtCtrls
  {$IFNDEF LCLLIB}
  ,Types
  {$IFNDEF WEBLIB}
  {$HINTS OFF}
