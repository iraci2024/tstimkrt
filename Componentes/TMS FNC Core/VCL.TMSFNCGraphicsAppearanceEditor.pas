...
unit VCL.TMSFNCGraphicsAppearanceEditor;
...
uses
  ...
  VCL.TMSFNCTypes, VCL.StdCtrls, VCL.ExtCtrls, VCL.TMSFNCBitmapContainer, VCL.Forms, VCL.TMSFNCGraphics,
  VCL.TMSFNCGraphicsTypes, VCL.TMSFNCBitmapEditor, VCL.TMSFNCEditorButton, VCL.TMSFNCEditorPanel, VCL.TMSFNCEditorsTools
  {$IFDEF FMXLIB}
...
uses
  VCL.TMSFNCUtils, VCL.Graphics, SysUtils, VCL.Dialogs, Math
  {$IFDEF WEBLIB}
  ,WEBLib.WebTools
  {$ENDIF}
  {$IFNDEF FMXMOBILE}
