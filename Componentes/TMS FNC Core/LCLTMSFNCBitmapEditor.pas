...
uses
  ...
  LCLTMSFNCTypes, StdCtrls, ExtCtrls, LCLTMSFNCBitmapContainer, Forms, LCLTMSFNCGraphics, LCLTMSFNCGraphicsTypes,
  LCLTMSFNCEditorButton, LCLTMSFNCEditorPanel
  {$IFDEF FMXLIB}
...
uses
  LCLTMSFNCUtils, Graphics, SysUtils, Dialogs, LCLTMSFNCEditorsTools
  {$IFDEF WEBLIB}
  ,WEBLib.WebTools
  {$ENDIF}
  {$IFNDEF FMXMOBILE}
