...
unit WEBLib.TMSFNCPDFGraphicsLibHTMLEngine;
...
uses
  WEBLib.TMSFNCTypes, WEBLib.Graphics, WEBLib.TMSFNCBitmapContainer, WEBLib.TMSFNCGraphics, WEBLib.TMSFNCPDFLib,
...
uses
  Classes, SysUtils, WEBLib.TMSFNCPDFCoreLibBase,
  WEBLib.TMSFNCUtils, Math
