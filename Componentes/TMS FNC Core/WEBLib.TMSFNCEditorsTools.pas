...
unit WEBLib.TMSFNCEditorsTools;
...
uses
  ...
  WEBLib.TMSFNCEditorButton, WEBLib.TMSFNCEditorListView, WEBLib.TMSFNCEditorPanel,
  WEBLib.StdCtrls, WEBLib.Controls
  {$IFDEF FMXLIB}
  ,FMX.Edit, FMX.Memo
  {$ENDIF}
  {$IFDEF WEBLIB}
...
implementation
uses
  WEBLib.TMSFNCGraphics, WEBLib.TMSFNCUtils
  , Math, SysUtils
  {$IFDEF FMXLIB}
