...
unit LCLTMSFNCPDFGraphicsLibGeneral;
...
uses
  Classes, LCLTMSFNCPDFGraphicsLib, SysUtils, LCLTMSFNCTypes, Graphics, LCLTMSFNCPDFLib
  ,LCLTMSFNCPDFRichTextLib, LCLTMSFNCPDFCoreLibBase, LCLTMSFNCPDFGraphicsLibHTMLEngine, LCLTMSFNCUtils,
  LCLTMSFNCBitmapContainer, LCLTMSFNCGraphicsTypes
  {$IFNDEF WEBLIB}
  {$IFDEF SVGSUPPORT}
  ,LCLTMSFNCGraphicsPDFEngine
  {$ENDIF}
  {$ENDIF}
  {$IFNDEF LCLLIB}
  ,Types
