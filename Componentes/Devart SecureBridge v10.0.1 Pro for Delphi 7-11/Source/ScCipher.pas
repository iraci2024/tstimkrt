...
{$ELSE}
  EntityDAC.Common.DacClasses, EntityDAC.Common.Types, EntityDAC.Common.Consts,
  EntityDAC.Common.DECUtil, EntityDAC.Common.SymmetricAlgorithm, EntityDAC.Common.CryptoTransformIntf;
{$ENDIF}{$ELSE}
  ScCLRClasses, ScTypes, ScConsts,
  ScDECUtil, ScSymmetricAlgorithm, ScCryptoTransformIntf;
{$ENDIF}
