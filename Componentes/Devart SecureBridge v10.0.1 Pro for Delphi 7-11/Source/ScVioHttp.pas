...
{$ELSE}
  ScCLRClasses, ScTypes, ScFunctions, ScVio, ScHttp;
{$ENDIF}
...
type
  ...
  private
    ...
    FPortID: Integer;
    FClosed: Boolean;
    FStartServerScriptRequest: {$IFNDEF SBRIDGE}TCRHttpWebRequest{$ELSE}TScHttpWebRequest{$ENDIF};
    FLastReadResponse: {$IFNDEF SBRIDGE}TCRHttpWebResponse{$ELSE}TScHttpWebResponse{$ENDIF};
    ...
    function CreateRequest(const Url: string; const Command: Char; const Method: string): {$IFNDEF SBRIDGE}TCRHttpWebRequest{$ELSE}TScHttpWebRequest{$ENDIF};
    procedure CheckTestConnectionResponse(Response: {$IFNDEF SBRIDGE}TCRHttpWebResponse{$ELSE}TScHttpWebResponse{$ENDIF});
    procedure CheckResponseSuccess(Response: {$IFNDEF SBRIDGE}TCRHttpWebResponse{$ELSE}TScHttpWebResponse{$ENDIF});
    procedure CheckThreadException;

    function ExecuteGetRequest(const Url: string; const Command: Char; CheckLeaseException: Boolean = True): {$IFNDEF SBRIDGE}TCRHttpWebResponse{$ELSE}TScHttpWebResponse{$ENDIF};
...
var
  Response: {$IFNDEF SBRIDGE}TCRHttpWebResponse{$ELSE}TScHttpWebResponse{$ENDIF};
begin
...
function TCRVioHttp.CreateRequest(const Url: string; const Command: Char; const Method: string): {$IFNDEF SBRIDGE}TCRHttpWebRequest{$ELSE}TScHttpWebRequest{$ENDIF};
var
  CommandStr: string;
begin
  ...
  Result := {$IFNDEF SBRIDGE}TCRHttpWebRequest{$ELSE}TScHttpWebRequest{$ENDIF}.Create(Url + CommandStr + '&port=' + IntToStr(FPortID));
  try
  {$IFNDEF SBRIDGE}
...
procedure TCRVioHttp.CheckTestConnectionResponse(Response: {$IFNDEF SBRIDGE}TCRHttpWebResponse{$ELSE}TScHttpWebResponse{$ENDIF});
...
procedure TCRVioHttp.CheckResponseSuccess(Response: {$IFNDEF SBRIDGE}TCRHttpWebResponse{$ELSE}TScHttpWebResponse{$ENDIF});
var
...
function TCRVioHttp.ExecuteGetRequest(const Url: string; const Command: Char;
  CheckLeaseException: Boolean = True): {$IFNDEF SBRIDGE}TCRHttpWebResponse{$ELSE}TScHttpWebResponse{$ENDIF};
var
  Request: {$IFNDEF SBRIDGE}TCRHttpWebRequest{$ELSE}TScHttpWebRequest{$ENDIF};
begin
