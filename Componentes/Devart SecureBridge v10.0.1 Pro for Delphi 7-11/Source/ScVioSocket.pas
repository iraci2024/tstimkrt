...
{$IFNDEF SBRIDGE}
  ...
  {$ELSE}
  EntityDAC.Common.DacClasses, EntityDAC.Common.Types, EntityDAC.Common.Vio;
  {$ENDIF}
{$ELSE}
  ScCLRClasses, ScTypes, ScVio;
{$ENDIF}
...
begin
  ...
  FLockSd := TCriticalSection.Create;
end;
