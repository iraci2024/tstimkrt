...
{$ELSE}
  EntityDAC.Common.DacClasses, EntityDAC.Common.Types, EntityDAC.Common.Functions, EntityDAC.Common.DECUtil, EntityDAC.Common.HashAlgorithm;
{$ENDIF}{$ELSE}
  ScCLRClasses, ScTypes, ScFunctions, ScDECUtil, ScHashAlgorithm;
{$ENDIF}
