...
{$ELSE}
  EntityDAC.Common.DacClasses, EntityDAC.Common.Types, EntityDAC.Common.DECUtil, EntityDAC.Common.CryptoTransformIntf;
{$ENDIF}{$ELSE}
  ScCLRClasses, ScTypes, ScDECUtil, ScCryptoTransformIntf;
{$ENDIF}
...
{$ELSE}
  EntityDAC.Common.Consts, EntityDAC.Common.Functions;
{$ENDIF}{$ELSE}
  ScConsts, ScFunctions;
{$ENDIF}
