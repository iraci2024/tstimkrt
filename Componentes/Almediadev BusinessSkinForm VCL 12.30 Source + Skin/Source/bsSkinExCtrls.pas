...
procedure TbsSkinOfficeListBox.InitItemIndex(Value: Integer);
var
  I: Integer;
begin
  if Value < 0 then
...
procedure TbsSkinCustomOfficeComboBox.InitItemIndex(Value: Integer);
begin
...
procedure TbsSkinHorzListBox.InitItemIndex(Value: Integer);
var
  I: Integer;
begin
  if Value < 0 then
