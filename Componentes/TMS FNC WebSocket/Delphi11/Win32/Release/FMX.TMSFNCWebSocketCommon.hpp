...
public:
	template<typename T> __classmethod T __fastcall InTo(System::DynamicArray<System::Byte> Buffer, int Index);
	template<typename T> __classmethod void __fastcall From(T Value, System::DynamicArray<System::Byte> &Buffer);
public:
...
private:
	...
	System::DynamicArray<System::Byte> FUnmaskedPayload;
	int FMaskingKey;
	bool FIsMasked;
	System::Byte FRSV;
	
protected:
	virtual void __fastcall ReadFromBuffer(System::DynamicArray<System::Byte> &Buffer, Idiohandler::TIdIOHandler* aIOHandler);
	virtual void __fastcall ReadPayload(System::DynamicArray<System::Byte> &Content, Idiohandler::TIdIOHandler* aIOHandler, int aOffset);
	
public:
	__fastcall virtual TTMSFNCWebSocketFrame(TTMSFNCWebSocketFrameOpcode AOpcode, System::DynamicArray<System::Byte> APayload, bool AIsFin)/* overload */;
	...
	System::DynamicArray<System::Byte> __fastcall ToBuffer();
	__classmethod TTMSFNCWebSocketFrame* __fastcall FromBuffer(System::DynamicArray<System::Byte> &Buffer, Idiohandler::TIdIOHandler* aIOHandler);
	__classmethod System::DynamicArray<System::Byte> __fastcall UnMask(System::DynamicArray<System::Byte> &payload, int Key, int Offset = 0x0);
	...
	__property System::DynamicArray<System::Byte> UnmaskedPayload = {read=FUnmaskedPayload, write=FUnmaskedPayload};
...
typedef System::TMetaClass* TTMSFNCWebSocketFrameClass;

typedef System::DynamicArray<System::Byte> _dt_Fmx_Tmsfncwebsocketcommon_1;
typedef void __fastcall (__closure *TTMSFNCWebSocketBinDataEvent)(System::TObject* Sender, TTMSFNCWebSocketConnection* AConnection, const _dt_Fmx_Tmsfncwebsocketcommon_1 aData, TTMSFNCWebSocketFrameTypes AFrameType);

typedef System::DynamicArray<System::Byte> _dt_Fmx_Tmsfncwebsocketcommon_2;
typedef void __fastcall (__closure *TTMSFNCWebSocketControlEvent)(System::TObject* Sender, TTMSFNCWebSocketConnection* AConnection, const _dt_Fmx_Tmsfncwebsocketcommon_2 aData);
...
private:
	...
	System::DynamicArray<System::Byte> FMessageContent;
...
protected:
	...
	virtual bool __fastcall HandleAllPendingFrames(System::DynamicArray<System::Byte> ABuffer, Idiohandler::TIdIOHandler* aIOHandler);
...
public:
	...
	void __fastcall SendBytes(const System::DynamicArray<System::Byte> ABytes, const bool AMasked = false);
	...
	void __fastcall SendBytesInMultipleFrames(System::DynamicArray<System::Byte> &ABytes, unsigned __int64 AFrameLength, const bool AMasked = false);
	void __fastcall SendSimpleFrame(TTMSFNCWebSocketFrameOpcode AOpcode, System::DynamicArray<System::Byte> aData = System::DynamicArray<System::Byte>());
	void __fastcall SendClose(System::DynamicArray<System::Byte> aData = System::DynamicArray<System::Byte>())/* overload */;
