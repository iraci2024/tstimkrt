...
protected:
	...
	virtual void __fastcall BinaryDataReceived(System::TObject* Sender, Fmx::Tmsfncwebsocketcommon::TTMSFNCWebSocketConnection* AConnection, const System::TArray__1<System::Byte> AData, Fmx::Tmsfncwebsocketcommon::TTMSFNCWebSocketFrameTypes FrameType);
	virtual void __fastcall PingReceived(System::TObject* Sender, Fmx::Tmsfncwebsocketcommon::TTMSFNCWebSocketConnection* AConnection, const System::TArray__1<System::Byte> aData);
	virtual void __fastcall PongReceived(System::TObject* Sender, Fmx::Tmsfncwebsocketcommon::TTMSFNCWebSocketConnection* AConnection, const System::TArray__1<System::Byte> aData);
	virtual void __fastcall CloseReceived(System::TObject* Sender, Fmx::Tmsfncwebsocketcommon::TTMSFNCWebSocketConnection* AConnection, const System::TArray__1<System::Byte> aData);
...
public:
	...
	virtual void __fastcall SendDataTo(System::TArray__1<System::Byte> AData, _di_TTMSFNCWebSocketSendToCallBack ASelector);
	__classmethod System::Word __fastcall TransformCloseData(System::TArray__1<System::Byte> ABytes, /* out */ System::UnicodeString &AReason);
};
