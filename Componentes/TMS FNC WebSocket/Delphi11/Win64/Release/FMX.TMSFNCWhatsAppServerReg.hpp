...
// (DO NOT EDIT: machine generated header) 'FMX.TMSFNCWhatsAppServerReg.pas' rev: 35.00 (Windows)

#ifndef Fmx_TmsfncwhatsappserverregHPP
#define Fmx_TmsfncwhatsappserverregHPP
...
namespace Fmx
{
namespace Tmsfncwhatsappserverreg
{
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_FMX_TMSFNCWHATSAPPSERVERREG)
using namespace Fmx::Tmsfncwhatsappserverreg;
#endif
...
//-- end unit ----------------------------------------------------------------
#endif	// Fmx_TmsfncwhatsappserverregHPP
