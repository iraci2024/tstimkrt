...
// (DO NOT EDIT: machine generated header) 'FMX.TMSFNCWebSocketServerReg.pas' rev: 35.00 (Windows)

#ifndef Fmx_TmsfncwebsocketserverregHPP
#define Fmx_TmsfncwebsocketserverregHPP
...
namespace Fmx
{
namespace Tmsfncwebsocketserverreg
{
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_FMX_TMSFNCWEBSOCKETSERVERREG)
using namespace Fmx::Tmsfncwebsocketserverreg;
#endif
...
//-- end unit ----------------------------------------------------------------
#endif	// Fmx_TmsfncwebsocketserverregHPP
