...
// (DO NOT EDIT: machine generated header) 'FMX.TMSFNCWhatsAppReceiverReg.pas' rev: 35.00 (Windows)

#ifndef Fmx_TmsfncwhatsappreceiverregHPP
#define Fmx_TmsfncwhatsappreceiverregHPP
...
namespace Fmx
{
namespace Tmsfncwhatsappreceiverreg
{
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_FMX_TMSFNCWHATSAPPRECEIVERREG)
using namespace Fmx::Tmsfncwhatsappreceiverreg;
#endif
...
//-- end unit ----------------------------------------------------------------
#endif	// Fmx_TmsfncwhatsappreceiverregHPP
