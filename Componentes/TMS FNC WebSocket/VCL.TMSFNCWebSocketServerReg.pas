...
unit VCL.TMSFNCWebSocketServerReg;
...
{$R 'TMSFNCWebSocketServerComp.dcr'}
...
begin
  RegisterComponents('TMS FNC WebSocket', [TTMSFNCWebSocketServer]);
end;
...
begin
  lContext.GetType(TTMSFNCWebSocketServer).ReleaseCachedAttributes;
end;
