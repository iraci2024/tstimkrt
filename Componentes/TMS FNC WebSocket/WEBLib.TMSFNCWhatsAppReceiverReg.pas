...
unit WEBLib.TMSFNCWhatsAppReceiverReg;
...
{$R 'TMSFNCWhatsAppReceiverComp.dcr'}
...
begin
  RegisterComponents('TMS FNC WebSocket', [TTMSFNCWhatsAppReceiver]);
end;
...
begin
  lContext.GetType(TTMSFNCWhatsAppReceiver).ReleaseCachedAttributes;
end;
