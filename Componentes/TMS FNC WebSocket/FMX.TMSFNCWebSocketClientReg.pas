...
unit FMX.TMSFNCWebSocketClientReg;
...
{$R 'TMSFNCWebSocketClientComp.dcr'}
...
begin
  RegisterComponents('TMS FNC WebSocket', [TTMSFNCWebSocketClient]);
end;
...
begin
  lContext.GetType(TTMSFNCWebSocketClient).ReleaseCachedAttributes;
end;
