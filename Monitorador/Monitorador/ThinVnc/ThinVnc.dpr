...
uses
  ...
  ThinVnc.AdvHttp in 'ThinVnc.AdvHttp.pas',
  ThinVnc.Capture in 'ThinVnc.Capture.pas',
  ThinVnc.ClientSession in 'ThinVnc.ClientSession.pas',
  ThinVnc.Cursor in 'ThinVnc.Cursor.pas',
  ThinVNC.DigestAuth in 'ThinVNC.DigestAuth.pas',
  ThinVnc.HttpServer in 'ThinVnc.HttpServer.pas',
  ThinVnc.InputQueue in 'ThinVnc.InputQueue.pas',
  ThinVNC.LkJSON in 'ThinVNC.LkJSON.pas';
